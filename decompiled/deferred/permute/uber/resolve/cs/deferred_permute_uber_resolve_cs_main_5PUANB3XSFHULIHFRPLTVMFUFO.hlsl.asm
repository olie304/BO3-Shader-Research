...
sync_g_t
if_z r1.y
  or r0.x, vThreadIDInGroupFlattened.x, l(8)
  ld_structured r0.xy, r0.x, l(0), g0.xyxx
  min r0.z, r0.x, r0.z
  max r0.w, r0.y, r0.w
  store_structured g0.xy, vThreadIDInGroupFlattened.x, l(0), r0.zwzz
...
sync_g_t
if_z r1.z
  or r0.x, vThreadIDInGroupFlattened.x, l(2)
  ld_structured r0.xy, r0.x, l(0), g0.xyxx
  min r0.z, r0.x, r0.z
  max r0.w, r0.y, r0.w
  store_structured g0.xy, vThreadIDInGroupFlattened.x, l(0), r0.zwzz
...
sync_g_t
if_z r1.w
  or r0.x, vThreadIDInGroupFlattened.x, l(16)
  ld_structured r0.xy, r0.x, l(0), g0.xyxx
  min r0.z, r0.x, r0.z
  max r0.w, r0.y, r0.w
  store_structured g0.xy, vThreadIDInGroupFlattened.x, l(0), r0.zwzz
