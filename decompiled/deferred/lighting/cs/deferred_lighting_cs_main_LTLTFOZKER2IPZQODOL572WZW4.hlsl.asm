...
mul r6.w, r1.w, r2.z
mad r6.w, -r6.w, l(2.015905), r12.y
exp r6.w, r6.w
mul r6.w, r2.x, r6.w
...
loop 
  ...
  if_nz r13.w
    ...
    if_nz r1.z
      ...
      add r12.yzw, cb1[24].xxyz, cb10[r9.w + 0].xxyz
      store_structured u2.xyzw, cb2[52].x, r13.w, r12.xyzw
    endif 
    iadd r20.w, r19.w, l(1)
    add r12.yzw, r4.xxyw, -cb10[r9.w + 0].xxyz
    ...
    dp3 r21.x, cb11[r16.w + 1].xyzx, r12.yzwy
    add_sat r21.x, r21.x, cb11[r16.w + 1].w
    mul r17.w, r17.w, r21.x
    dp3 r21.x, cb11[r16.w + 2].xyzx, r12.yzwy
    add_sat r21.x, r21.x, cb11[r16.w + 2].w
    mul r17.w, r17.w, r21.x
    dp3 r21.x, cb11[r16.w + 3].xyzx, r12.yzwy
    add_sat r21.x, r21.x, cb11[r16.w + 3].w
    mul r17.w, r17.w, r21.x
    dp3 r21.x, cb11[r16.w + 4].xyzx, r12.yzwy
    add_sat r21.x, r21.x, cb11[r16.w + 4].w
    mul r17.w, r17.w, r21.x
    dp3 r21.x, cb11[r16.w + 5].xyzx, r12.yzwy
    add_sat r16.w, r21.x, cb11[r16.w + 5].w
    mul r13.x, r16.w, r17.w
    and r16.w, l(1), cb10[r9.w + 6].x
    movc r21.xy, r16.wwww, r13.xyxx, r13.zxzz
    ...
    loop 
      ...
      dp3 r21.z, cb11[r17.w + 0].xyzx, r12.yzwy
      add_sat r21.z, r21.z, cb11[r17.w + 0].w
      mul r21.z, r21.z, r22.x
      dp3 r21.w, cb11[r17.w + 1].xyzx, r12.yzwy
      add_sat r21.w, r21.w, cb11[r17.w + 1].w
      mul r21.z, r21.w, r21.z
      dp3 r21.w, cb11[r17.w + 2].xyzx, r12.yzwy
      add_sat r21.w, r21.w, cb11[r17.w + 2].w
      mul r21.z, r21.w, r21.z
      dp3 r21.w, cb11[r17.w + 3].xyzx, r12.yzwy
      add_sat r21.w, r21.w, cb11[r17.w + 3].w
      mul r21.z, r21.w, r21.z
      dp3 r21.w, cb11[r17.w + 4].xyzx, r12.yzwy
      add_sat r21.w, r21.w, cb11[r17.w + 4].w
      mul r21.z, r21.w, r21.z
      dp3 r21.w, cb11[r17.w + 5].xyzx, r12.yzwy
      add_sat r17.w, r21.w, cb11[r17.w + 5].w
      mul r22.x, r17.w, r21.z
      ushr r21.w, r13.x, l(2)
      ubfe r22.z, l(1), l(2), r13.x
      and r22.w, r21.w, l(2)
      max r23.x, r22.x, r22.y
      mad r17.w, -r21.z, r17.w, l(1.000000)
      mul r17.w, r17.w, r22.y
      movc r15.y, r22.w, r17.w, r23.x
      movc r22.xy, r22.zzzz, r22.xyxx, r15.xyxx
      iadd r16.w, r16.w, l(1)
      mov r13.x, r21.w
    endloop 
    mov_sat r22.y, r22.y
    mul r13.x, r22.y, cb10[r9.w + 6].y
    ...
    if_nz r13.w
      ...
      if_nz r14.w
        imad r21.xy, r13.wwww, l(20, 20, 0, 0), l(860, 876, 0, 0)
        ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r13.w, cb2[52].x, r21.x, u2.xxxx
        or r13.w, r13.w, l(32)
        store_structured u2.x, cb2[52].x, r21.x, r13.w
        store_structured u2.x, cb2[52].x, r21.y, r13.x
      endif 
      iadd r19.w, r19.w, l(257)
      mad r19.z, r22.y, cb10[r9.w + 6].y, r19.z
      mul r13.x, r13.x, cb10[r9.w + 7].y
      mov r21.x, cb10[r9.w + 7].w
      mov r21.yz, cb10[r9.w + 8].xxyx
      dp3 r13.w, r11.xyzx, r21.xyzx
      dp3 r14.w, r12.yzwy, r21.xyzx
      add r14.w, r14.w, -cb10[r9.w + 8].z
      ...
      mov r21.x, cb10[r9.w + 8].w
      mov r21.yz, cb10[r9.w + 9].xxyx
      dp3 r14.w, r11.xyzx, r21.xyzx
      dp3 r15.y, r12.yzwy, r21.xyzx
      add r15.y, r15.y, -cb10[r9.w + 9].z
      ge r16.w, r15.y, l(0.000000)
      max r15.y, r2.w, |r15.y|
      movc r15.y, r16.w, r15.y, -r15.y
      max r14.w, -r14.w, l(0.00000010)
      div r14.w, r15.y, r14.w
      min r13.w, r13.w, |r14.w|
      mov r21.x, cb10[r9.w + 9].w
      mov r21.yz, cb10[r9.w + 10].xxyx
      dp3 r14.w, r11.xyzx, r21.xyzx
      dp3 r15.y, r12.yzwy, r21.xyzx
      add r15.y, r15.y, -cb10[r9.w + 10].z
      ge r16.w, r15.y, l(0.000000)
      max r15.y, r2.w, |r15.y|
      movc r15.y, r16.w, r15.y, -r15.y
      max r14.w, -r14.w, l(0.00000010)
      div r14.w, r15.y, r14.w
      min r13.w, r13.w, |r14.w|
      mov r21.x, cb10[r9.w + 10].w
      mov r21.yz, cb10[r9.w + 11].xxyx
      dp3 r14.w, r11.xyzx, r21.xyzx
      dp3 r15.y, r12.yzwy, r21.xyzx
      add r15.y, r15.y, -cb10[r9.w + 11].z
      ge r16.w, r15.y, l(0.000000)
      max r15.y, r2.w, |r15.y|
      movc r15.y, r16.w, r15.y, -r15.y
      max r14.w, -r14.w, l(0.00000010)
      div r14.w, r15.y, r14.w
      min r13.w, r13.w, |r14.w|
      mov r21.x, cb10[r9.w + 11].w
      mov r21.yz, cb10[r9.w + 12].xxyx
      dp3 r14.w, r11.xyzx, r21.xyzx
      dp3 r15.y, r12.yzwy, r21.xyzx
      add r15.y, r15.y, -cb10[r9.w + 12].z
      ge r16.w, r15.y, l(0.000000)
      max r15.y, r2.w, |r15.y|
      movc r15.y, r16.w, r15.y, -r15.y
      max r14.w, -r14.w, l(0.00000010)
      div r14.w, r15.y, r14.w
      min r13.w, r13.w, |r14.w|
      mov r21.x, cb10[r9.w + 12].w
      mov r21.yz, cb10[r9.w + 13].xxyx
      dp3 r14.w, r11.xyzx, r21.xyzx
      dp3 r15.y, r12.yzwy, r21.xyzx
      add r15.y, r15.y, -cb10[r9.w + 13].z
      ge r16.w, r15.y, l(0.000000)
      max r15.y, r2.w, |r15.y|
      movc r15.y, r16.w, r15.y, -r15.y
      max r14.w, -r14.w, l(0.00000010)
      div r14.w, r15.y, r14.w
      min r13.w, r13.w, |r14.w|
      add r21.x, r12.y, cb10[r9.w + 3].w
      add r21.yz, r12.zzwz, cb10[r9.w + 4].xxyx
      mad r21.xyz, r11.xyzx, r13.wwww, r21.xyzx
      dp3 r14.w, r21.xyzx, r21.xyzx
      sqrt r14.w, r14.w
      div r13.w, r13.w, r14.w
      add r13.w, r13.w, r13.w
      sqrt r13.w, r13.w
      mad r13.w, r1.w, l(5.000000), r13.w
      ...
      ubfe r14.w, l(9), l(16), cb10[r9.w + 7].z
      utof r24.w, r14.w
      sample_l_indexable(texturecubearray)(float,float,float,float) r21.xyz, r24.xyzw, t8.xyzw, s2, r13.w
      and r22.xzw, r21.xxyz, l(0x7fffffff, 0, 0x7fffffff, 0x7fffffff)
      ieq r22.xzw, r22.xxzw, l(0x7f800000, 0, 0x7f800000, 0x7f800000)
      or r13.w, r22.z, r22.x
      or r13.w, r22.w, r13.w
      ...
      mad_sat r12.yzw, r27.xxyz, cb10[r9.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
      mul r27.xy, r12.yzyy, cb10[r9.w + 4].zwzz
      mul r27.z, r12.w, cb10[r9.w + 5].x
      add r12.yzw, r27.xxyz, cb10[r9.w + 5].yyzw
      ...
      or r9.w, r23.y, r23.x
      or r9.w, r23.z, r9.w
      movc r22.xzw, r9.wwww, l(1.000000,0,1.000000,0), r22.xxzw
      ...
      dp3 r12.z, r21.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r9.w, r5.w, r9.w, r12.z
      div r9.w, r12.y, r9.w
      mov r23.x, r18.w
      mov r23.yz, r19.xxyx
      mad r12.yzw, r21.xxyz, r9.wwww, r23.xxyz
      mov r18.w, r12.y
      mov r19.xy, r12.zwzz
    else 
...
loop 
  ...
  if_nz r13.w
    ...
    mul r13.x, r16.w, r17.w
    and r16.w, l(1), cb10[r9.w + 6].x
    movc r22.zw, r16.wwww, r13.xxxy, r13.zzzx
    mov r13.x, cb10[r9.w + 6].x
    mov r23.xy, r22.zwzz
    mov r16.w, l(1)
    loop 
      ...
      iadd r17.w, r13.w, r16.w
      imul null, r17.w, r17.w, l(6)
      dp3 r20.w, cb11[r17.w + 0].xyzx, r12.yzwy
      ...
      dp3 r21.w, cb11[r17.w + 5].xyzx, r12.yzwy
      add_sat r17.w, r21.w, cb11[r17.w + 5].w
      mul r23.x, r17.w, r20.w
      ushr r21.w, r13.x, l(2)
      ubfe r23.z, l(1), l(2), r13.x
      and r23.w, r21.w, l(2)
      max r24.x, r23.x, r23.y
      mad r17.w, -r20.w, r17.w, l(1.000000)
      mul r17.w, r17.w, r23.y
      movc r15.w, r23.w, r17.w, r24.x
      movc r23.xy, r23.zzzz, r23.xyxx, r15.zwzz
      iadd r16.w, r16.w, l(1)
      mov r13.x, r21.w
    endloop 
    add_sat r13.x, -r19.z, r23.y
    mul r13.w, r13.x, cb10[r9.w + 6].y
    lt r14.w, l(0.000000), r13.w
    if_nz r14.w
      and r14.w, r22.y, l(31)
      iadd r15.w, r14.w, l(-1)
      ult r15.w, r15.w, l(32)
      and r15.w, r1.z, r15.w
      if_nz r15.w
        imad r22.zw, r14.wwww, l(0, 0, 20, 20), l(0, 0, 860, 876)
      ...
      mad r15.x, r13.x, cb10[r9.w + 6].y, r15.x
      mul r13.x, r13.w, cb10[r9.w + 7].y
      ...
      div r14.w, r15.w, r14.w
      min r13.w, r13.w, |r14.w|
      add r24.x, r12.y, cb10[r9.w + 3].w
      add r24.yz, r12.zzwz, cb10[r9.w + 4].xxyx
      mad r23.xzw, r11.xxyz, r13.wwww, r24.xxyz
      dp3 r14.w, r23.xzwx, r23.xzwx
      sqrt r14.w, r14.w
      div r13.w, r13.w, r14.w
      add r13.w, r13.w, r13.w
      sqrt r13.w, r13.w
      ...
      ubfe r14.w, l(9), l(16), cb10[r9.w + 7].z
      utof r25.w, r14.w
      sample_l_indexable(texturecubearray)(float,float,float,float) r23.xzw, r25.xyzw, t8.xwyz, s2, r13.w
      ...
      movc r23.xzw, r13.wwww, l(1.000000,0,1.000000,0), r23.xxzw
      dp3 r28.x, r12.yzwy, r24.xyzx
      dp3 r28.y, r12.yzwy, r26.xyzx
      dp3 r28.z, r12.yzwy, r27.xyzx
      mad_sat r12.yzw, r28.xxyz, cb10[r9.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
      mul r28.xy, r12.yzyy, cb10[r9.w + 4].zwzz
      mul r28.z, r12.w, cb10[r9.w + 5].x
      add r12.yzw, r28.xxyz, cb10[r9.w + 5].yyzw
      ...
      mul r12.y, r5.w, r9.w
      mul r23.xzw, r13.xxxx, r23.xxzw
      dp3 r12.z, r23.xzwx, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r9.w, r5.w, r9.w, r12.z
      div r9.w, r12.y, r9.w
      mad r21.xyz, r23.xzwx, r9.wwww, r21.xyzx
    else 
      mov r22.x, r15.x
      mov r15.xy, r22.xyxx
    endif 
...
add r6.x, r3.y, r6.z
mul r3.xyw, r5.xyxz, r10.xyxz
mad r3.xyw, r11.xyxz, r6.xyxz, r3.xyxw
