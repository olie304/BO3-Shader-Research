...
r0.y = samplerLinear[]..swiz;
  ...
  while (true) {
    ...
    r10.y = cmp((uint)r8.w < numRefProbes);
    r9.w = r9.w ? r10.y : 0;
    if (r9.w != 0) {
      r8.w = (int)r8.w * 14;
      r10.yzw = -refProbeConstantsCB[r8.w].data[0].xyz + r11.xyz;
      r9.w = 0x0000ffff & (int)refProbeConstantsCB[r8.w].data[7].z;
      if (6 == 0) r13.w = 0; else if (6+25 < 32) {       r13.w = (uint)refProbeConstantsCB[r8.w].data[7].z << (32-(6 + 25)); r13.w = (uint)r13.w >> (32-6);      } else r13.w = (uint)refProbeConstantsCB[r8.w].data[7].z >> 25;
      r14.z = (int)r9.w * 6;
      r14.w = dot(refProbeAttenuationConstantsCB[r14.z].data[0].xyz, r10.yzw);
      r14.w = saturate(refProbeAttenuationConstantsCB[r14.z].data[0].w + r14.w);
      r15.w = dot(refProbeAttenuationConstantsCB[r14.z].data[1].xyz, r10.yzw);
      r15.w = saturate(refProbeAttenuationConstantsCB[r14.z].data[1].w + r15.w);
      r14.w = r15.w * r14.w;
      r15.w = dot(refProbeAttenuationConstantsCB[r14.z].data[2].xyz, r10.yzw);
      r15.w = saturate(refProbeAttenuationConstantsCB[r14.z].data[2].w + r15.w);
      r14.w = r15.w * r14.w;
      r15.w = dot(refProbeAttenuationConstantsCB[r14.z].data[3].xyz, r10.yzw);
      r15.w = saturate(refProbeAttenuationConstantsCB[r14.z].data[3].w + r15.w);
      r14.w = r15.w * r14.w;
      r15.w = dot(refProbeAttenuationConstantsCB[r14.z].data[4].xyz, r10.yzw);
      r15.w = saturate(refProbeAttenuationConstantsCB[r14.z].data[4].w + r15.w);
      r14.w = r15.w * r14.w;
      r15.w = dot(refProbeAttenuationConstantsCB[r14.z].data[5].xyz, r10.yzw);
      r14.z = saturate(refProbeAttenuationConstantsCB[r14.z].data[5].w + r15.w);
      r19.x = r14.w * r14.z;
      r14.z = 1 & (int)refProbeConstantsCB[r8.w].data[6].x;
      r14.zw = r14.zz ? r19.xy : r19.zx;
      r15.w = refProbeConstantsCB[r8.w].data[6].x;
      r26.xy = r14.zw;
      r16.y = 1;
      while (true) {
        r16.z = cmp((int)r16.y >= (int)r13.w);
        if (r16.z != 0) break;
        r16.z = (int)r9.w + (int)r16.y;
        r16.z = (int)r16.z * 6;
        ...
        r16.w = r26.x * r16.w;
        r17.y = dot(refProbeAttenuationConstantsCB[r16.z].data[1].xyz, r10.yzw);
        r17.y = saturate(refProbeAttenuationConstantsCB[r16.z].data[1].w + r17.y);
        r16.w = r17.y * r16.w;
        r17.y = dot(refProbeAttenuationConstantsCB[r16.z].data[2].xyz, r10.yzw);
        r17.y = saturate(refProbeAttenuationConstantsCB[r16.z].data[2].w + r17.y);
        r16.w = r17.y * r16.w;
        r17.y = dot(refProbeAttenuationConstantsCB[r16.z].data[3].xyz, r10.yzw);
        r17.y = saturate(refProbeAttenuationConstantsCB[r16.z].data[3].w + r17.y);
        r16.w = r17.y * r16.w;
        r17.y = dot(refProbeAttenuationConstantsCB[r16.z].data[4].xyz, r10.yzw);
        r17.y = saturate(refProbeAttenuationConstantsCB[r16.z].data[4].w + r17.y);
        r16.w = r17.y * r16.w;
        r17.y = dot(refProbeAttenuationConstantsCB[r16.z].data[5].xyz, r10.yzw);
        r16.z = saturate(refProbeAttenuationConstantsCB[r16.z].data[5].w + r17.y);
        r26.x = r16.w * r16.z;
        r17.y = (uint)r15.w >> 2;
        if (1 == 0) r17.z = 0; else if (1+2 < 32) {         r17.z = (uint)r15.w << (32-(1 + 2)); r17.z = (uint)r17.z >> (32-1);        } else r17.z = (uint)r15.w >> 2;
        r17.w = (int)r17.y & 2;
        r19.x = max(r26.y, r26.x);
        r16.z = -r16.w * r16.z + 1;
        r16.z = r26.y * r16.z;
        r21.y = r17.w ? r16.z : r19.x;
        r26.xy = r17.zz ? r26.xy : r21.xy;
        r16.y = (int)r16.y + 1;
        r15.w = r17.y;
      }
      r26.y = saturate(r26.y);
      r9.w = refProbeConstantsCB[r8.w].data[6].y * r26.y;
      r13.w = cmp(0 < r9.w);
      if (r13.w != 0) {
        r25.w = r26.y * refProbeConstantsCB[r8.w].data[6].y + r25.w;
        ...
        r13.w = dot(r18.xyz, r27.xyz);
        r14.z = dot(r10.yzw, r27.xyz);
        r14.z = -refProbeConstantsCB[r8.w].data[8].z + r14.z;
        r14.w = cmp(r14.z >= 0);
        ...
        r14.z = dot(r18.xyz, r27.xyz);
        r14.w = dot(r10.yzw, r27.xyz);
        ...
        r14.z = r14.w / r14.z;
        r13.w = min(abs(r14.z), r13.w);
        r27.x = refProbeConstantsCB[r8.w].data[3].w + r10.y;
        r27.yz = refProbeConstantsCB[r8.w].data[4].xy + r10.zw;
        r16.yzw = r18.xyz * r13.www + r27.xyz;
        r14.z = dot(r16.yzw, r16.yzw);
        r14.z = sqrt(r14.z);
        r13.w = r13.w / r14.z;
        r13.w = r13.w + r13.w;
        r13.w = sqrt(r13.w);
        ...
        if (9 == 0) r14.z = 0; else if (9+16 < 32) {         r14.z = (uint)refProbeConstantsCB[r8.w].data[7].z << (32-(9 + 16)); r14.z = (uint)r14.z >> (32-9);        } else r14.z = (uint)refProbeConstantsCB[r8.w].data[7].z >> 16;
        r28.w = (uint)r14.z;
        r16.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r28.xyzw, r13.w).xyz;
        r31.x = dot(r10.yzw, r27.xyz);
        r31.y = dot(r10.yzw, r29.xyz);
        r31.z = dot(r10.yzw, r30.xyz);
        r10.yzw = saturate(r31.xyz * refProbeConstantsCB[r8.w].data[3].xyz + float3(0.5,0.5,0.5));
        r31.xy = refProbeConstantsCB[r8.w].data[4].zw * r10.yz;
        r31.z = refProbeConstantsCB[r8.w].data[5].x * r10.w;
        r10.yzw = refProbeConstantsCB[r8.w].data[5].yzw + r31.xyz;
        r28.x = dot(r12.xyz, r27.xyz);
        r28.y = dot(r12.xyz, r29.xyz);
        r28.z = dot(r12.xyz, r30.xyz);
        r17.yzw = cmp(float3(0,0,0) < r28.xyz);
        r20.z = r17.y ? 0 : 0.5;
        r21.yzw = r20.xyz + r10.yzw;
        r21.yzw = gProbeXArray.SampleLevel(samplerLinearClamp_s, r21.yzw, 0).xyz;
        r26.xzw = r28.xyz * r28.xyz;
        r26.xzw = r26.xzw * r9.www;
        r22.z = r17.z ? 0 : 0.5;
        r27.xyz = r22.xyz + r10.yzw;
        r27.xyz = gProbeYArray.SampleLevel(samplerLinearClamp_s, r27.xyz, 0).xyz;
        r27.xyz = r27.xyz * r26.zzz;
        r21.yzw = r21.yzw * r26.xxx + r27.xyz;
        r23.z = r17.w ? 0 : 0.5;
        r10.yzw = r23.xyz + r10.yzw;
        r10.yzw = gProbeZArray.SampleLevel(samplerLinearClamp_s, r10.yzw, 0).xyz;
        r10.yzw = r10.yzw * r26.www + r21.yzw;
        r17.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r28.xyzw, 6).xyz;
        r21.yzw = r17.yzw * r10.yzw;
        r8.w = dot(r21.yzw, float3(0.212599993,0.715200007,0.0722000003));
        r24.xyz = r10.yzw * r17.yzw + r24.xyz;
        r10.y = r8.w * r3.w;
        ...
        r27.x = r24.w;
        r27.yz = r25.yz;
        r25.xyz = r16.yzw * r8.www + r27.xyz;
        r24.w = r25.x;
      }
    }
    r7.w = (int)r7.w + 1;
    ...
    while (true) {
      ...
      if (r9.w != 0) {
        ...
        while (true) {
          ...
          r17.w = r27.x * r17.w;
          r19.x = dot(refProbeAttenuationConstantsCB[r17.z].data[1].xyz, r16.yzw);
          r19.x = saturate(refProbeAttenuationConstantsCB[r17.z].data[1].w + r19.x);
          r17.w = r19.x * r17.w;
          r19.x = dot(refProbeAttenuationConstantsCB[r17.z].data[2].xyz, r16.yzw);
          r19.x = saturate(refProbeAttenuationConstantsCB[r17.z].data[2].w + r19.x);
          r17.w = r19.x * r17.w;
          r19.x = dot(refProbeAttenuationConstantsCB[r17.z].data[3].xyz, r16.yzw);
          r19.x = saturate(refProbeAttenuationConstantsCB[r17.z].data[3].w + r19.x);
          r17.w = r19.x * r17.w;
          r19.x = dot(refProbeAttenuationConstantsCB[r17.z].data[4].xyz, r16.yzw);
          r19.x = saturate(refProbeAttenuationConstantsCB[r17.z].data[4].w + r19.x);
          r17.w = r19.x * r17.w;
          r19.x = dot(refProbeAttenuationConstantsCB[r17.z].data[5].xyz, r16.yzw);
          r17.z = saturate(refProbeAttenuationConstantsCB[r17.z].data[5].w + r19.x);
          r27.x = r17.w * r17.z;
          r19.x = (uint)r15.w >> 2;
          if (1 == 0) r19.w = 0; else if (1+2 < 32) {           r19.w = (uint)r15.w << (32-(1 + 2)); r19.w = (uint)r19.w >> (32-1);          } else r19.w = (uint)r15.w >> 2;
          r20.w = (int)r19.x & 2;
          r21.z = max(r27.y, r27.x);
          r17.z = -r17.w * r17.z + 1;
          r17.z = r27.y * r17.z;
          r21.y = r20.w ? r17.z : r21.z;
          r27.xy = r19.ww ? r27.xy : r21.xy;
          r17.y = (int)r17.y + 1;
          r15.w = r19.x;
        }
        r9.w = saturate(r27.y + -r25.w);
        r13.w = refProbeConstantsCB[r8.w].data[6].y * r9.w;
        r14.z = cmp(0 < r13.w);
        if (r14.z != 0) {
          r26.w = r9.w * refProbeConstantsCB[r8.w].data[6].y + r26.w;
          r9.w = refProbeConstantsCB[r8.w].data[7].y * r13.w;
          r28.x = refProbeConstantsCB[r8.w].data[7].w;
          r28.yz = refProbeConstantsCB[r8.w].data[8].xy;
          r13.w = dot(r18.xyz, r28.xyz);
          r14.z = dot(r16.yzw, r28.xyz);
          r14.z = -refProbeConstantsCB[r8.w].data[8].z + r14.z;
          r14.w = cmp(r14.z >= 0);
          r14.z = max(abs(r14.z), r3.z);
          r14.z = r14.w ? r14.z : -r14.z;
          ...
          r17.yzw = r18.xyz * r13.www + r28.xyz;
          ...
          r16.yzw = r16.yzw * r28.zzz + r27.xzw;
          r21.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r29.xyzw, 6).xyz;
          r27.xzw = r21.yzw * r16.yzw;
          r8.w = dot(r27.xzw, float3(0.212599993,0.715200007,0.0722000003));
          r10.yzw = r16.yzw * r21.yzw + r10.yzw;
          r13.w = r8.w * r3.w;
          r16.yzw = r17.yzw * r9.www;
          r9.w = dot(r16.yzw, float3(0.212599993,0.715200007,0.0722000003));
          r8.w = r3.w * r8.w + r9.w;
          r8.w = r13.w / r8.w;
  ...
  if (r2.w != 0) {
    ...
    r18.w = 0;
    r17.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r18.xyzw, r3.y).xyz;
