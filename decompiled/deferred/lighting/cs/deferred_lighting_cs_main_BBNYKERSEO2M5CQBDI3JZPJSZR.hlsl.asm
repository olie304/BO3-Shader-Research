...
if_nz r7.w
  ...
  if_nz r7.w
    ...
    sample_l_indexable(texture2d)(float,float,float,float) r9.w, r20.xyxx, t28.yzwx, s1, r3.y
    min r7.w, |r7.w|, |r9.w|
    mul r7.w, r20.z, r7.w
    lt r7.w, r7.w, l(1.000000)
    bfi r3.z, l(1), l(0), r3.z, l(2)
    movc r3.z, r7.w, r3.z, r8.w
  ...
  max r3.y, r3.y, l(0.000000)
  mad r7.w, r3.y, l(-2.000000), l(3.000000)
  mul r3.y, r3.y, r3.y
  mul r3.y, r3.y, r7.w
  ...
  add r7.w, -r3.z, l(1.000000)
  mul r7.w, r1.w, r7.w
  add r3.y, r3.y, l(-1.000000)
  mad r3.y, r7.w, r3.y, l(1.000000)
  mul r1.w, r3.z, r1.w
...
mul r7.w, r3.z, l(5.000000)
mad r8.w, r3.z, l(5.000000), l(-2.500000)
...
mul r10.w, r3.z, r7.w
mad r10.w, -r10.w, l(2.015905), r15.y
exp r10.w, r10.w
...
ushr r15.xy, r0.yxyy, l(24, 24, 0, 0)
...
loop 
  ieq r12.w, r0.y, l(2)
  breakc_nz r12.w
  movc r12.w, r0.y, r0.x, r15.x
  uge r15.z, r12.w, r10.w
  ...
  if_nz r15.z
    ...
    if_nz r6.w
      ...
      store_structured u2.xyzw, cb2[52].x, r15.z, r16.xyzw
    endif 
    iadd r24.w, r23.w, l(1)
    add r16.yzw, r5.xxyz, -cb10[r12.w + 0].xxyz
    and r15.z, l(0x0000ffff), cb10[r12.w + 7].z
    ...
    and r17.w, l(1), cb10[r12.w + 6].x
    movc r17.xw, r17.wwww, r17.xxxy, r17.zzzx
    mov r18.w, cb10[r12.w + 6].x
    mov r25.xy, r17.xwxx
    mov r20.w, l(1)
    loop 
      ige r21.w, r20.w, r15.w
      breakc_nz r21.w
      iadd r21.w, r15.z, r20.w
    ...
    endloop 
    mov_sat r25.y, r25.y
    mul r15.z, r25.y, cb10[r12.w + 6].y
    lt r15.w, l(0.000000), r15.z
    if_nz r15.w
      and r15.w, r24.w, l(7)
      iadd r17.x, r15.w, l(-1)
      ult r17.x, r17.x, l(32)
      and r17.x, r6.w, r17.x
      if_nz r17.x
        imad r17.xw, r15.wwww, l(20, 0, 0, 20), l(860, 0, 0, 876)
      ...
      add r17.w, r17.w, -cb10[r12.w + 9].z
      ...
      dp3 r17.x, r14.xyzx, r26.xyzx
      dp3 r17.w, r16.yzwy, r26.xyzx
      add r17.w, r17.w, -cb10[r12.w + 10].z
      ge r18.w, r17.w, l(0.000000)
      max r17.w, r8.w, |r17.w|
      movc r17.w, r18.w, r17.w, -r17.w
      max r17.x, -r17.x, l(0.00000010)
      ...
      dp3 r17.x, r14.xyzx, r26.xyzx
      dp3 r17.w, r16.yzwy, r26.xyzx
      add r17.w, r17.w, -cb10[r12.w + 11].z
      ge r18.w, r17.w, l(0.000000)
      max r17.w, r8.w, |r17.w|
      movc r17.w, r18.w, r17.w, -r17.w
      max r17.x, -r17.x, l(0.00000010)
      ...
      dp3 r17.x, r14.xyzx, r26.xyzx
      dp3 r17.w, r16.yzwy, r26.xyzx
      add r17.w, r17.w, -cb10[r12.w + 12].z
      ge r18.w, r17.w, l(0.000000)
      max r17.w, r8.w, |r17.w|
      movc r17.w, r18.w, r17.w, -r17.w
      max r17.x, -r17.x, l(0.00000010)
      ...
      dp3 r17.x, r14.xyzx, r26.xyzx
      dp3 r17.w, r16.yzwy, r26.xyzx
      add r17.w, r17.w, -cb10[r12.w + 13].z
      ge r18.w, r17.w, l(0.000000)
      max r17.w, r8.w, |r17.w|
      movc r17.w, r18.w, r17.w, -r17.w
      max r17.x, -r17.x, l(0.00000010)
      div r17.x, r17.w, r17.x
      min r15.w, r15.w, |r17.x|
      add r26.x, r16.y, cb10[r12.w + 3].w
      add r26.yz, r16.zzwz, cb10[r12.w + 4].xxyx
      mad r25.xzw, r14.xxyz, r15.wwww, r26.xxyz
      ...
      ubfe r17.x, l(9), l(16), cb10[r12.w + 7].z
      utof r27.w, r17.x
      sample_l_indexable(texturecubearray)(float,float,float,float) r25.xzw, r27.xyzw, t8.xwyz, s2, r15.w
      ...
      movc r25.xzw, r15.wwww, l(1.000000,0,1.000000,0), r25.xxzw
      dp3 r30.x, r16.yzwy, r26.xyzx
      dp3 r30.y, r16.yzwy, r28.xyzx
      dp3 r30.z, r16.yzwy, r29.xyzx
      mad_sat r16.yzw, r30.xxyz, cb10[r12.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
      mul r30.xy, r16.yzyy, cb10[r12.w + 4].zwzz
      mul r30.z, r16.w, cb10[r12.w + 5].x
      add r16.yzw, r30.xxyz, cb10[r12.w + 5].yyzw
      ...
      mul r16.yzw, r15.zzzz, r25.xxzw
      dp3 r15.z, r16.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r12.w, r9.w, r12.w, r15.z
      div r12.w, r15.w, r12.w
      mov r26.x, r22.w
      mov r26.yz, r23.xxyx
      mad r16.yzw, r16.yyzw, r12.wwww, r26.xxyz
      mov r22.w, r16.y
      mov r23.xy, r16.zwzz
    else 
...
loop 
  ...
  breakc_nz r12.w
  movc r12.w, r0.y, r0.x, r15.x
  ult r17.w, r12.w, r10.w
  if_nz r17.w
    imul null, r12.w, r12.w, l(14)
    if_nz r6.w
      and r17.w, r15.w, l(15)
      imad r17.w, r17.w, l(20), l(880)
      add r16.yzw, cb1[24].xxyz, cb10[r12.w + 0].xxyz
      store_structured u2.xyzw, cb2[52].x, r17.w, r16.xyzw
    endif 
    iadd r19.y, r15.w, l(1)
    add r16.yzw, r5.xxyz, -cb10[r12.w + 0].xxyz
    and r17.w, l(0x0000ffff), cb10[r12.w + 7].z
    ubfe r18.w, l(6), l(25), cb10[r12.w + 7].z
    ...
    and r20.w, l(1), cb10[r12.w + 6].x
    movc r26.xy, r20.wwww, r17.xyxx, r17.zxzz
    ...
    loop 
      ...
      dp3 r25.w, cb11[r21.w + 5].xyzx, r16.yzwy
      add_sat r21.w, r25.w, cb11[r21.w + 5].w
      mul r27.x, r21.w, r24.w
      ushr r25.w, r17.x, l(2)
      ubfe r26.z, l(1), l(2), r17.x
      and r26.w, r25.w, l(2)
      max r27.z, r27.x, r27.y
      mad r21.w, -r24.w, r21.w, l(1.000000)
      mul r21.w, r21.w, r27.y
      movc r19.w, r26.w, r21.w, r27.z
      movc r27.xy, r26.zzzz, r27.xyxx, r19.zwzz
      iadd r20.w, r20.w, l(1)
      mov r17.x, r25.w
    endloop 
    add_sat r17.x, -r23.z, r27.y
    mul r17.w, r17.x, cb10[r12.w + 6].y
    lt r18.w, l(0.000000), r17.w
    if_nz r18.w
      and r18.w, r19.y, l(31)
      ...
      if_nz r19.w
        ...
        store_structured u2.x, cb2[52].x, r26.y, r17.w
      endif 
      iadd r15.w, r15.w, l(257)
      mad r15.z, r17.x, cb10[r12.w + 6].y, r15.z
      mul r17.x, r17.w, cb10[r12.w + 7].y
      mov r26.x, cb10[r12.w + 7].w
      mov r26.yz, cb10[r12.w + 8].xxyx
      dp3 r17.w, r14.xyzx, r26.xyzx
      dp3 r18.w, r16.yzwy, r26.xyzx
      add r18.w, r18.w, -cb10[r12.w + 8].z
      ...
      mov r26.x, cb10[r12.w + 8].w
      mov r26.yz, cb10[r12.w + 9].xxyx
      dp3 r18.w, r14.xyzx, r26.xyzx
      dp3 r19.w, r16.yzwy, r26.xyzx
      add r19.w, r19.w, -cb10[r12.w + 9].z
      ...
      dp3 r18.w, r14.xyzx, r26.xyzx
      dp3 r19.w, r16.yzwy, r26.xyzx
      add r19.w, r19.w, -cb10[r12.w + 10].z
      ge r20.w, r19.w, l(0.000000)
      max r19.w, r8.w, |r19.w|
      movc r19.w, r20.w, r19.w, -r19.w
      max r18.w, -r18.w, l(0.00000010)
      ...
      dp3 r18.w, r14.xyzx, r26.xyzx
      dp3 r19.w, r16.yzwy, r26.xyzx
      add r19.w, r19.w, -cb10[r12.w + 11].z
      ge r20.w, r19.w, l(0.000000)
      max r19.w, r8.w, |r19.w|
      movc r19.w, r20.w, r19.w, -r19.w
      max r18.w, -r18.w, l(0.00000010)
      ...
      dp3 r18.w, r14.xyzx, r26.xyzx
      dp3 r19.w, r16.yzwy, r26.xyzx
      add r19.w, r19.w, -cb10[r12.w + 12].z
      ge r20.w, r19.w, l(0.000000)
      max r19.w, r8.w, |r19.w|
      movc r19.w, r20.w, r19.w, -r19.w
      max r18.w, -r18.w, l(0.00000010)
      ...
      dp3 r18.w, r14.xyzx, r26.xyzx
      dp3 r19.w, r16.yzwy, r26.xyzx
      add r19.w, r19.w, -cb10[r12.w + 13].z
      ge r20.w, r19.w, l(0.000000)
      max r19.w, r8.w, |r19.w|
      movc r19.w, r20.w, r19.w, -r19.w
      max r18.w, -r18.w, l(0.00000010)
      ...
      add r26.x, r16.y, cb10[r12.w + 3].w
      add r26.yz, r16.zzwz, cb10[r12.w + 4].xxyx
      mad r26.xyz, r14.xyzx, r17.wwww, r26.xyzx
      dp3 r18.w, r26.xyzx, r26.xyzx
      sqrt r18.w, r18.w
      div r17.w, r17.w, r18.w
      add r17.w, r17.w, r17.w
      sqrt r17.w, r17.w
      mad r17.w, r3.z, l(5.000000), r17.w
      ...
      ubfe r18.w, l(9), l(16), cb10[r12.w + 7].z
      utof r29.w, r18.w
      sample_l_indexable(texturecubearray)(float,float,float,float) r26.xyz, r29.xyzw, t8.xyzw, s2, r17.w
      and r27.xzw, r26.xxyz, l(0x7fffffff, 0, 0x7fffffff, 0x7fffffff)
      ieq r27.xzw, r27.xxzw, l(0x7f800000, 0, 0x7f800000, 0x7f800000)
      or r17.w, r27.z, r27.x
      or r17.w, r27.w, r17.w
      movc r26.xyz, r17.wwww, l(1.000000,1.000000,0,0), r26.xyzx
      dp3 r32.x, r16.yzwy, r28.xyzx
      dp3 r32.y, r16.yzwy, r30.xyzx
      dp3 r32.z, r16.yzwy, r31.xyzx
      mad_sat r16.yzw, r32.xxyz, cb10[r12.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
      mul r32.xy, r16.yzyy, cb10[r12.w + 4].zwzz
      mul r32.z, r16.w, cb10[r12.w + 5].x
      add r16.yzw, r32.xxyz, cb10[r12.w + 5].yyzw
...
bfi r0.y, l(8), l(0), r15.w, r23.w
movc r0.x, r0.x, r0.y, r15.w
max r0.y, r15.z, l(1.000000)
rcp r0.y, r0.y
mov_sat r15.z, r15.z
mul r16.xyz, r0.yyyy, r24.xyzx
mul r17.xyz, r0.yyyy, r25.xyzx
lt r3.z, r15.z, l(0.990000)
if_nz r3.z
  iadd r0.x, r0.x, l(256)
  add r3.z, -r15.z, l(1.000000)
  mul r8.w, r3.z, cb2[19].x
  add r15.xzw, r5.xxyz, -cb2[35].xxyz
  mul r18.x, r15.x, cb2[35].w
  mul r18.yz, r15.zzwz, cb2[36].xxyx
  add_sat r15.xzw, r18.xxyz, l(0.500000, 0.000000, 0.500000, 0.500000)
  mul r18.xy, r15.xzxx, cb2[36].zwzz
  mul r18.z, r15.w, cb2[37].x
  add r15.xzw, r18.xxyz, cb2[37].yyzw
  lt r18.xyz, l(0.000000, 0.000000, 0.000000, 0.000000), r11.xyzx
  movc r18.xyz, r18.xyzx, l(0,0,0,0), l(0.500000,0.500000,0.500000,0)
  mov r18.w, l(0)
  add r19.xyz, r15.xzwx, r18.wwxw
  ...
  add r15.xzw, r15.xxzw, r18.wwwz
  sample_l_indexable(texture3d)(float,float,float,float) r15.xzw, r15.xzwx, t19.xwyz, s4, l(0.000000)
  mad r15.xzw, r15.xxzw, r20.zzzz, r19.xxyz
  mov r11.w, l(0)
  ...
  dp3 r8.w, r15.xzwx, l(0.212600, 0.715200, 0.072200, 0.000000)
  mad r16.xyz, r24.xyzx, r0.yyyy, r15.xzwx
  mov r14.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r15.xzw, r14.xyzw, t8.xwyz, s2, r7.w
  mad r0.y, cb2[19].x, r3.z, -r8.w
  mad r0.y, r2.y, r0.y, r8.w
  mad r17.xyz, r15.xzwx, r0.yyyy, r17.xyzx
endif 
add r0.y, -r1.w, l(1.000000)
mad r13.yzw, r17.xxyz, r0.yyyy, r13.yyzw
add r0.y, r4.z, r2.x
log r0.y, |r0.y|
mul r0.y, r0.y, r2.w
exp r0.y, r0.y
...
mul r0.y, r3.y, r0.y
mul r15.xzw, r4.zzzz, r16.xxyz
and r17.xyz, r3.wwww, r15.xzwx
...
mul r0.y, r0.y, r2.y
mul r1.w, r1.w, r2.y
imul null, r2.y, r15.y, l(15)
ubfe r3.y, l(3), l(24), cb9[r2.y + 1].w
switch r3.y
  case l(4)
  if_nz r6.w
    add r19.yzw, cb1[24].xxyz, cb9[r2.y + 0].xxyz
    mov r19.x, l(2)
    store_structured u2.xyzw, cb2[52].x, l(112), r19.xyzw
  endif 
  lt r3.z, l(0.000000), cb9[r2.y + 6].y
  mov r19.xy, cb9[r2.y + 5].zwzz
  mov r19.z, cb9[r2.y + 6].x
  mad r20.xyz, -r19.xyzx, l(0.500000, 0.500000, 0.500000, 0.000000), cb9[r2.y + 0].xyzx
  add r21.xyz, -r5.xyzx, r20.xyzx
  dp3 r7.w, r19.xyzx, r21.xyzx
  div_sat r8.w, -r7.w, cb9[r2.y + 6].y
  mad r22.xyz, r8.wwww, r19.xyzx, r20.xyzx
  movc r22.xyz, r3.zzzz, r22.xyzx, cb9[r2.y + 0].xyzx
  ...
  if_nz r12.w
    sqrt r12.w, r9.w
    mul r14.w, cb9[r2.y + 3].x, cb9[r2.y + 3].x
    div r9.w, r14.w, r9.w
    min r9.w, r9.w, l(1.000000)
    mad_sat r22.xy, r12.wwww, cb9[r2.y + 2].xzxx, cb9[r2.y + 2].ywyy
    ...
    if_nz r12.w
      ubfe r12.w, l(3), l(27), cb9[r2.y + 1].w
      if_nz r6.w
      ...
      if_nz r12.w
        ...
        add r22.yzw, r22.yyzw, -cb9[r2.y + 4].yyzw
        max r12.w, |r22.w|, |r22.z|
        max r12.w, r12.w, |r22.y|
        div r12.w, cb9[r2.y + 5].x, r12.w
        add r12.w, r12.w, cb9[r2.y + 5].y
        dp3 r14.w, r22.yzwy, r22.yzwy
        rsq r14.w, r14.w
        max r12.w, r12.w, l(0.00006104)
        and r15.y, l(0x0000ffff), cb9[r2.y + 1].w
        mov r24.x, -r3.x
        utof r25.w, r15.y
        mov r24.y, r13.x
        mov r24.z, r3.x
        ...
        loop 
          ...
          mul r26.yz, r23.yyzy, cb9[r2.y + 3].yyyy
      ...
      if_nz r12.w
        ...
        if_nz r8.w
          ...
          ubfe r7.w, l(4), l(20), cb9[r2.y + 1].w
          ult r8.w, l(0), r7.w
          not r14.w, r1.z
          and r8.w, r8.w, r14.w
          if_nz r8.w
        ...
        add r7.w, -r11.w, r7.w
        mad r7.w, r2.w, r7.w, r11.w
        mul r7.w, r9.w, r7.w
        mov r20.x, cb9[r2.y + 0].w
        mov r20.yz, cb9[r2.y + 1].xxyx
        ...
        mad r14.x, |r11.w|, r2.z, -|r11.w|
        mad r11.w, |r11.w|, r14.x, l(1.000000)
        mad r14.x, r10.w, r0.y, r1.w
        ...
        mad r14.xyz, r10.wwww, r20.xyzx, r13.yzwy
        add_sat r3.z, -r3.z, l(1.000000)
        mul r11.w, r3.z, r3.z
        mul r11.w, r11.w, r11.w
        mul r3.z, r3.z, r11.w
        mul r3.z, r3.z, r10.w
        mad r19.xyz, r3.zzzz, r20.xyzx, r18.xyzx
        mad r20.xyz, r7.wwww, r20.xyzx, r17.xyzx
        and r20.xyz, r3.wwww, r20.xyzx
        movc r15.xzw, r8.wwww, r21.xxyz, r15.xxzw
        movc r17.xyz, r8.wwww, r17.xyzx, r20.xyzx
        movc r18.xyz, r8.wwww, r19.xyzx, r18.xyzx
        movc r13.yzw, r8.wwww, r14.xxyz, r13.yyzw
        if_nz r6.w
  ...
  case l(2)
  if_nz r6.w
    add r14.yzw, cb1[24].xxyz, cb9[r2.y + 0].xxyz
    mov r14.x, l(2)
    store_structured u2.xyzw, cb2[52].x, l(112), r14.xyzw
  endif 
  add r14.xy, -r5.xyxx, cb9[r2.y + 3].zwzz
  add r14.z, -r5.z, cb9[r2.y + 4].x
  dp3 r3.z, r14.xyzx, r14.xyzx
  rsq r3.z, r3.z
  mul r19.xyz, r3.zzzz, r14.xyzx
  ...
  if_nz r10.w
    mov r19.xyz, cb9[r2.y + 7].yzwy
    mov r19.w, cb9[r2.y + 8].x
    mov r5.w, l(1.000000)
    ...
    if_nz r11.w
      ...
      add r21.xyz, -r5.xyzx, cb9[r2.y + 0].xyzx
      mul r12.w, cb9[r2.y + 3].x, cb9[r2.y + 3].x
      dp3 r14.w, r21.xyzx, r21.xyzx
      div r12.w, r12.w, r14.w
      min r12.w, r12.w, l(1.000000)
      mad_sat r21.xy, r10.wwww, cb9[r2.y + 2].xzxx, cb9[r2.y + 2].ywyy
      ...
      mov r21.xyz, cb9[r2.y + 4].yzwy
      mov r21.w, cb9[r2.y + 5].x
      dp4 r21.x, r21.xyzw, r5.xyzw
      mov r22.xyz, cb9[r2.y + 5].yzwy
      mov r22.w, cb9[r2.y + 6].x
      dp4 r21.y, r22.xyzw, r5.xyzw
      div r21.xy, r21.xyxx, r10.wwww
      lt r5.w, cb9[r2.y + 10].w, l(0.00048828)
      if_nz r5.w
        mad_sat r22.xy, |r21.xyxx|, cb9[r2.y + 12].xyxx, cb9[r2.y + 12].zwzz
        mul r22.zw, r22.xxxy, r22.xxxy
        mad r22.xy, r22.xyxx, l(-2.000000, -2.000000, 0.000000, 0.000000), l(3.000000, 3.000000, 0.000000, 0.000000)
        mul r22.xy, r22.xyxx, r22.zwzz
        mul r5.w, r22.y, r22.x
      else 
        mul_sat r22.xyzw, |r21.yyxx|, cb9[r2.y + 11].xyzw
        log r22.xyzw, r22.xyzw
        mul r22.xyzw, r22.xyzw, cb9[r2.y + 12].zzzz
        exp r22.xyzw, r22.xyzw
        add r22.xy, r22.zwzz, r22.xyxx
        log r22.xy, r22.xyxx
        mul r22.xy, r22.xyxx, cb9[r2.y + 12].wwww
        exp r22.xy, r22.xyxx
        mul r10.w, r22.x, cb9[r2.y + 12].x
        mad r14.w, cb9[r2.y + 12].y, r22.y, l(-1.000000)
        mad r10.w, cb9[r2.y + 12].y, r22.y, -r10.w
      ...
      and r5.w, l(255), cb9[r2.y + 14].w
      if_nz r5.w
        mov r21.z, l(1.000000)
        dp3 r10.w, cb9[r2.y + 13].xyzx, r21.xyzx
        mov r22.x, cb9[r2.y + 13].w
        mov r22.yz, cb9[r2.y + 14].xxyx
    ...
    mov r21.x, cb9[r2.y + 0].w
    mov r21.yz, cb9[r2.y + 1].xxyx
    mul r20.xyz, r20.xyzx, r21.xyzx
    lt r5.w, l(0.000000), r11.w
    if_nz r5.w
      ubfe r5.w, l(3), l(27), cb9[r2.y + 1].w
      if_nz r6.w
      ...
      if_nz r5.w
        ...
        mov r22.xyz, cb9[r2.y + 6].yzwy
        mov r22.w, cb9[r2.y + 7].x
        ...
        if_nz r12.w
          ...
          mad r21.x, r19.x, cb9[r2.y + 8].y, cb9[r2.y + 8].z
          mad r21.y, r19.y, cb9[r2.y + 8].w, cb9[r2.y + 9].x
          div r5.w, r5.w, r10.w
          max r5.w, r5.w, l(0.00006104)
          and r10.w, l(0x0000ffff), cb9[r2.y + 1].w
          if_nz cb2[58].y
            mov r19.x, -r3.x
            utof r22.z, r10.w
            mov r19.y, r13.x
            ...
            loop 
              ...
              mad r22.xy, r23.xyxx, cb9[r2.y + 3].yyyy, r21.xyxx
              sample_c_lz_indexable(texture2darray)(float,float,float,float) r15.y, r22.xyzx, t9.xxxx, s13, r5.w
      ...
      if_nz r10.w
        mul r10.w, r2.z, cb9[r2.y + 1].z
        mul r10.w, r8.w, r10.w
        ubfe r11.w, l(4), l(16), cb9[r2.y + 1].w
        ult r12.w, l(0), r11.w
        ...
        if_nz r12.w
          ...
          if_z r14.w
            ...
            if_nz cb2[58].y
              ...
              utof r21.z, r14.w
              sample_c_lz_indexable(texture2darray)(float,float,float,float) r15.y, r21.xyzx, t9.xxxx, s13, r12.w
            endif 
            mul r11.w, r15.y, r15.y
            mul r11.w, r15.y, r11.w
          else 
            mov r11.w, l(1.000000)
          endif 
          mul r5.w, r5.w, r11.w
        else 
          ubfe r2.y, l(4), l(20), cb9[r2.y + 1].w
          ult r11.w, l(0), r2.y
          not r1.z, r1.z
          and r1.z, r1.z, r11.w
          if_nz r1.z
            iadd r1.z, r2.y, cb2[0].x
            imad r1.z, r1.z, l(15), l(-15)
            mad r2.y, |r7.w|, l(-0.200000), l(0.400000)
            lt r11.w, r7.w, l(0.000000)
            and r11.w, r3.w, r11.w
            movc r2.y, r11.w, -r2.y, r2.y
            mad r19.xyz, r11.xyzx, r2.yyyy, r5.xyzx
            mov r21.xyz, cb9[r1.z + 6].yzwy
            mov r21.w, cb9[r1.z + 7].x
            mov r19.w, l(1.000000)
            dp4 r2.y, r21.xyzw, r19.xyzw
            mov r21.xyz, cb9[r1.z + 7].yzwy
            mov r21.w, cb9[r1.z + 8].x
            dp4 r11.w, r21.xyzw, r19.xyzw
            lt r12.w, r11.w, r2.y
            if_z r12.w
              mov r21.xyz, cb9[r1.z + 4].yzwy
              mov r21.w, cb9[r1.z + 5].x
              dp4 r21.x, r21.xyzw, r19.xyzw
              mov r22.xyz, cb9[r1.z + 5].yzwy
              mov r22.w, cb9[r1.z + 6].x
              dp4 r21.y, r22.xyzw, r19.xyzw
              div r19.xy, r21.xyxx, r11.wwww
              mad r19.xy, r19.xyxx, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
              add r21.x, r19.x, cb9[r1.z + 9].w
              add r21.y, r19.y, cb9[r1.z + 10].x
              mul r19.xy, r21.xyxx, cb9[r1.z + 9].yzyy
              div r19.zw, cb9[r1.z + 3].yyyy, cb9[r1.z + 8].yyyw
              add r21.xy, -r19.zwzz, l(1.000000, 1.000000, 0.000000, 0.000000)
              ge r21.xy, r19.xyxx, r21.xyxx
              ge r19.zw, r19.zzzw, r19.xxxy
              or r19.zw, r19.zzzw, r21.xxxy
              ...
              if_z r14.w
                mov_sat r19.xy, r19.xyxx
                mad r21.x, r19.x, cb9[r1.z + 8].y, cb9[r1.z + 8].z
                mad r21.y, r19.y, cb9[r1.z + 8].w, cb9[r1.z + 9].x
                mul r15.y, r11.w, cb9[r1.z + 10].z
                mad r2.y, cb9[r1.z + 10].y, r11.w, r2.y
                div r2.y, r2.y, r15.y
              endif 
            else 
              mov r14.w, l(-1)
            ...
            if_z r11.w
              max r2.y, r2.y, l(0.00006104)
              and r11.w, l(0x0000ffff), cb9[r1.z + 1].w
              if_nz cb2[58].y
                mov r19.x, -r3.x
                utof r22.z, r11.w
                mov r19.y, r13.x
                ...
                loop 
                  ...
                  mad r22.xy, r23.xyxx, cb9[r1.z + 3].yyyy, r21.xyxx
                  sample_c_lz_indexable(texture2darray)(float,float,float,float) r13.x, r22.xyzx, t9.xxxx, s13, r2.y
                  mad r3.x, r13.x, l(0.125000), r3.x
                  iadd r12.w, r12.w, l(1)
                endloop 
              else 
                utof r21.z, r11.w
                sample_c_lz_indexable(texture2darray)(float,float,float,float) r3.x, r21.xyzx, t9.xxxx, s13, r2.y
              endif 
              mul r1.z, r3.x, r3.x
              mul r1.z, r3.x, r1.z
            else 
        ...
        mad r1.z, -r9.w, r1.z, l(1.000000)
        mul r1.z, r1.z, r1.z
        mad r1.z, -r1.z, l(0.620000), l(0.620000)
        add r1.z, -r9.w, r1.z
        mad r1.z, r2.w, r1.z, r9.w
        mul r1.z, r5.w, r1.z
        mul r2.xyw, r20.xyxz, r1.zzzz
        lt r3.x, l(0.000000), r7.w
        mad r2.xyw, r16.xyxz, r4.zzzz, r2.xyxw
        mad r14.xyz, r14.xyzx, r3.zzzz, r12.xyzx
        dp3 r3.z, r14.xyzx, r14.xyzx
        rsq r3.z, r3.z
        mul r14.xyz, r3.zzzz, r14.xyzx
        dp3 r3.z, r14.xyzx, r12.xyzx
        dp3 r4.z, r11.xyzx, r14.xyzx
        mad r2.z, |r4.z|, r2.z, -|r4.z|
        mad r2.z, |r4.z|, r2.z, l(1.000000)
        mad r0.y, r8.w, r0.y, r1.w
        mul r1.w, r2.z, r2.z
        mul r0.y, r0.y, r1.w
        rcp r0.y, r0.y
        mul r0.y, r10.w, r0.y
        ...
        mad r11.xyz, r0.yyyy, r20.xyzx, r13.yzwy
        add_sat r1.w, -r3.z, l(1.000000)
        mul r2.z, r1.w, r1.w
        mul r2.z, r2.z, r2.z
        mul r1.w, r1.w, r2.z
        mul r0.y, r0.y, r1.w
        mad r12.xyz, r0.yyyy, r20.xyzx, r18.xyzx
        mad r14.xyz, r1.zzzz, r20.xyzx, r17.xyzx
        and r14.xyz, r3.wwww, r14.xyzx
        movc r15.xzw, r3.xxxx, r2.xxyw, r15.xxzw
        movc r17.xyz, r3.xxxx, r17.xyzx, r14.xyzx
        movc r18.xyz, r3.xxxx, r12.xyzx, r18.xyzx
        movc r13.yzw, r3.xxxx, r11.xxyz, r13.yyzw
        if_nz r6.w
...
ret 
// Approximately 2084 instruction slots used
