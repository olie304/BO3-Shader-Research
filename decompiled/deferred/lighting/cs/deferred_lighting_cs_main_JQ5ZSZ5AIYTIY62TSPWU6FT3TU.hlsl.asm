...
if_nz cb2[54].x
  ...
  mov r10.w, l(0)
  loop 
    uge r13.w, r10.w, cb2[0].y
    breakc_nz r13.w
    ushr r13.w, r10.w, l(5)
    ...
    loop 
      ...
      if_nz r43.x
        ...
        mov r39.xyz, cb10[r40.w + 0].xyzx
        mov r43.xy, cb10[r40.w + 13].yzyy
        mov r15.w, l(-1)
        mov r28.w, cb10[r40.w + 2].w
        mov r29.w, cb10[r40.w + 5].w
        mov r39.w, cb10[r40.w + 7].z
...
if_nz r8.w
  ...
  ubfe r10.w, l(6), l(25), r9.w
  imul null, r13.w, r7.w, l(6)
  dp3 r15.z, cb11[r13.w + 0].xyzx, r14.yzwy
  add_sat r15.z, r15.z, cb11[r13.w + 0].w
  dp3 r15.w, cb11[r13.w + 1].xyzx, r14.yzwy
  add_sat r15.w, r15.w, cb11[r13.w + 1].w
  mul r15.z, r15.w, r15.z
  dp3 r15.w, cb11[r13.w + 2].xyzx, r14.yzwy
  add_sat r15.w, r15.w, cb11[r13.w + 2].w
  mul r15.z, r15.w, r15.z
  dp3 r15.w, cb11[r13.w + 3].xyzx, r14.yzwy
  add_sat r15.w, r15.w, cb11[r13.w + 3].w
  mul r15.z, r15.w, r15.z
  dp3 r15.w, cb11[r13.w + 4].xyzx, r14.yzwy
  add_sat r15.w, r15.w, cb11[r13.w + 4].w
  mul r15.z, r15.w, r15.z
  dp3 r15.w, cb11[r13.w + 5].xyzx, r14.yzwy
  add_sat r13.w, r15.w, cb11[r13.w + 5].w
  mul r31.x, r13.w, r15.z
  and r13.w, r20.w, l(1)
  mov r31.yz, l(0,0,1.000000,0)
  movc r15.zw, r13.wwww, r31.xxxy, r31.zzzx
  mov r31.x, l(1.000000)
  mov r13.w, r20.w
  mov r32.xy, r15.zwzz
  mov r17.w, l(1)
  loop 
    ige r18.w, r17.w, r10.w
    breakc_nz r18.w
    iadd r18.w, r7.w, r17.w
    imul null, r18.w, r18.w, l(6)
    dp3 r19.w, cb11[r18.w + 0].xyzx, r14.yzwy
    add_sat r19.w, r19.w, cb11[r18.w + 0].w
    mul r19.w, r19.w, r32.x
    dp3 r21.z, cb11[r18.w + 1].xyzx, r14.yzwy
    add_sat r21.z, r21.z, cb11[r18.w + 1].w
    mul r19.w, r19.w, r21.z
    dp3 r21.z, cb11[r18.w + 2].xyzx, r14.yzwy
    add_sat r21.z, r21.z, cb11[r18.w + 2].w
    mul r19.w, r19.w, r21.z
    dp3 r21.z, cb11[r18.w + 3].xyzx, r14.yzwy
    add_sat r21.z, r21.z, cb11[r18.w + 3].w
    mul r19.w, r19.w, r21.z
    dp3 r21.z, cb11[r18.w + 4].xyzx, r14.yzwy
    add_sat r21.z, r21.z, cb11[r18.w + 4].w
    mul r19.w, r19.w, r21.z
    dp3 r21.z, cb11[r18.w + 5].xyzx, r14.yzwy
    add_sat r18.w, r21.z, cb11[r18.w + 5].w
    mul r32.x, r18.w, r19.w
    ushr r21.z, r13.w, l(2)
    ubfe r21.w, l(1), l(2), r13.w
    and r22.w, r21.z, l(2)
    max r28.w, r32.x, r32.y
    mad r18.w, -r19.w, r18.w, l(1.000000)
    mul r18.w, r18.w, r32.y
    movc r31.y, r22.w, r18.w, r28.w
  ...
  if_nz r7.w
    ...
    mul r7.w, r21.y, r31.w
    dp3 r10.w, r16.xyzx, r22.xyzx
    ...
    dp3 r13.w, r16.xyzx, r23.xyzx
    dp3 r15.z, r14.yzwy, r23.xyzx
    add r15.z, -r24.w, r15.z
    ...
    dp3 r13.w, r16.xyzx, r24.xyzx
    dp3 r15.z, r14.yzwy, r24.xyzx
    ...
    div r13.w, r15.z, r13.w
    min r10.w, r10.w, |r13.w|
    dp3 r13.w, r16.xyzx, r26.xyzx
    dp3 r15.z, r14.yzwy, r26.xyzx
    add r15.z, -r27.w, r15.z
    ge r15.w, r15.z, l(0.000000)
    max r15.z, r4.w, |r15.z|
    movc r15.z, r15.w, r15.z, -r15.z
    max r13.w, -r13.w, l(0.00000010)
    div r13.w, r15.z, r13.w
    min r10.w, r10.w, |r13.w|
    dp3 r13.w, r16.xyzx, r27.xyzx
    dp3 r15.z, r14.yzwy, r27.xyzx
    ...
    mad r15.yzw, r16.xxyz, r10.wwww, r15.yyzw
    ...
    utof r20.w, r9.w
    sample_l_indexable(texturecubearray)(float,float,float,float) r15.yzw, r20.xyzw, t8.wxyz, s2, r10.w
    and r21.xyz, r15.yzwy, l(0x7fffffff, 0x7fffffff, 0x7fffffff, 0)
    ieq r21.xyz, r21.xyzx, l(0x7f800000, 0x7f800000, 0x7f800000, 0)
    or r9.w, r21.y, r21.x
    or r9.w, r21.z, r9.w
    movc r15.yzw, r9.wwww, l(0,1.000000,1.000000,0), r15.yyzw
...
if_z r8.w
  ...
  loop 
    ...
    loop 
      ...
      ishl r18.w, l(1), r15.w
      not r18.w, r18.w
      and r15.z, r15.z, r18.w
      iadd r15.w, r14.w, r15.w
      imul null, r15.w, r15.w, l(14)
      and r18.w, r26.w, l(255)
      ...
      add r17.yzw, r11.xxyz, -cb10[r15.w + 0].xxyz
      ...
      dp3 r28.x, cb11[r21.w + 1].xyzx, r17.yzwy
      add_sat r28.x, r28.x, cb11[r21.w + 1].w
      mul r22.w, r22.w, r28.x
      dp3 r28.x, cb11[r21.w + 2].xyzx, r17.yzwy
      add_sat r28.x, r28.x, cb11[r21.w + 2].w
      mul r22.w, r22.w, r28.x
      dp3 r28.x, cb11[r21.w + 3].xyzx, r17.yzwy
      add_sat r28.x, r28.x, cb11[r21.w + 3].w
      mul r22.w, r22.w, r28.x
      dp3 r28.x, cb11[r21.w + 4].xyzx, r17.yzwy
      add_sat r28.x, r28.x, cb11[r21.w + 4].w
      mul r22.w, r22.w, r28.x
      dp3 r28.x, cb11[r21.w + 5].xyzx, r17.yzwy
      add_sat r21.w, r28.x, cb11[r21.w + 5].w
      ...
      loop 
        ...
        movc r20.y, r29.w, r22.w, r30.x
        movc r29.xy, r29.zzzz, r29.xyxx, r20.xyxx
        iadd r21.w, r21.w, l(1)
        mov r18.x, r28.w
      endloop 
      mov_sat r29.y, r29.y
      mul r18.x, r29.y, cb10[r15.w + 6].y
      ...
      if_nz r18.w
        ...
        div r19.w, r20.y, r19.w
        min r18.w, r18.w, |r19.w|
        add r28.x, r17.y, cb10[r15.w + 3].w
        add r28.yz, r17.zzwz, cb10[r15.w + 4].xxyx
        mad r28.xyz, r16.xyzx, r18.wwww, r28.xyzx
        ...
        mov r30.x, cb10[r15.w + 0].w
        mov r30.y, cb10[r15.w + 1].z
        mov r30.z, cb10[r15.w + 2].y
        dp3 r32.x, r28.xyzx, r30.xyzx
        mov r33.xy, cb10[r15.w + 1].xwxx
        mov r33.z, cb10[r15.w + 2].z
        dp3 r32.y, r28.xyzx, r33.xyzx
        mov r34.x, cb10[r15.w + 1].y
        mov r34.yz, cb10[r15.w + 2].xxwx
        dp3 r32.z, r28.xyzx, r34.xyzx
        ubfe r19.w, l(9), l(16), cb10[r15.w + 7].z
        utof r32.w, r19.w
        sample_l_indexable(texturecubearray)(float,float,float,float) r28.xyz, r32.xyzw, t8.xyzw, s2, r18.w
        and r29.xzw, r28.xxyz, l(0x7fffffff, 0, 0x7fffffff, 0x7fffffff)
        ieq r29.xzw, r29.xxzw, l(0x7f800000, 0, 0x7f800000, 0x7f800000)
        or r18.w, r29.z, r29.x
        or r18.w, r29.w, r18.w
        ...
        mad_sat r17.yzw, r35.xxyz, cb10[r15.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
        mul r35.xy, r17.yzyy, cb10[r15.w + 4].zwzz
        mul r35.z, r17.w, cb10[r15.w + 5].x
        add r17.yzw, r35.xxyz, cb10[r15.w + 5].yyzw
        ...
        movc r29.xzw, r15.wwww, l(1.000000,0,1.000000,0), r29.xxzw
  ...
  loop 
    ...
    loop 
      ...
      movc r29.zw, r25.wwww, r18.xxxy, r18.zzzx
      ...
      loop 
        ...
        movc r30.xy, r30.zzzz, r30.xyxx, r20.zwzz
      ...
      if_nz r21.w
        and r21.w, r29.y, l(255)
        iadd r22.w, r21.w, l(-1)
        ult r22.w, r22.w, l(32)
        and r22.w, r2.z, r22.w
        if_nz r22.w
          imad r29.zw, r21.wwww, l(0, 0, 20, 20), l(0, 0, 860, 876)
          ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r21.w, cb2[52].x, r29.z, u2.xxxx
          or r21.w, r21.w, l(32)
          store_structured u2.x, cb2[52].x, r29.z, r21.w
          store_structured u2.x, cb2[52].x, r29.w, r20.w
        endif 
        iadd r28.z, r28.z, l(257)
        mad r28.x, r18.x, cb10[r20.y + 6].y, r28.x
        mul r18.x, r20.w, cb10[r20.y + 7].y
        mov r32.x, cb10[r20.y + 7].w
        mov r32.yz, cb10[r20.y + 8].xxyx
        ...
        div r21.w, r22.w, r21.w
        min r20.w, r20.w, |r21.w|
        mov r32.x, cb10[r20.y + 10].w
        mov r32.yz, cb10[r20.y + 11].xxyx
        dp3 r21.w, r16.xyzx, r32.xyzx
        dp3 r22.w, r17.yzwy, r32.xyzx
        ...
        div r21.w, r22.w, r21.w
        min r20.w, r20.w, |r21.w|
        mov r32.x, cb10[r20.y + 11].w
        mov r32.yz, cb10[r20.y + 12].xxyx
        dp3 r21.w, r16.xyzx, r32.xyzx
        dp3 r22.w, r17.yzwy, r32.xyzx
        ...
        div r21.w, r22.w, r21.w
        min r20.w, r20.w, |r21.w|
        mov r32.x, cb10[r20.y + 12].w
        mov r32.yz, cb10[r20.y + 13].xxyx
        dp3 r21.w, r16.xyzx, r32.xyzx
        dp3 r22.w, r17.yzwy, r32.xyzx
        ...
        div r21.w, r22.w, r21.w
        min r20.w, r20.w, |r21.w|
        add r32.x, r17.y, cb10[r20.y + 3].w
        add r32.yz, r17.zzwz, cb10[r20.y + 4].xxyx
        mad r30.xzw, r16.xxyz, r20.wwww, r32.xxyz
        dp3 r21.w, r30.xzwx, r30.xzwx
        sqrt r21.w, r21.w
        ...
        mov r32.x, cb10[r20.y + 0].w
        mov r32.y, cb10[r20.y + 1].z
        mov r32.z, cb10[r20.y + 2].y
        dp3 r33.x, r30.xzwx, r32.xyzx
        mov r34.xy, cb10[r20.y + 1].xwxx
        mov r34.z, cb10[r20.y + 2].z
        dp3 r33.y, r30.xzwx, r34.xyzx
        mov r35.x, cb10[r20.y + 1].y
        mov r35.yz, cb10[r20.y + 2].xxwx
        dp3 r33.z, r30.xzwx, r35.xyzx
        ubfe r21.w, l(9), l(16), cb10[r20.y + 7].z
        utof r33.w, r21.w
        sample_l_indexable(texturecubearray)(float,float,float,float) r30.xzw, r33.xyzw, t8.xwyz, s2, r20.w
        and r36.xyz, r30.xzwx, l(0x7fffffff, 0x7fffffff, 0x7fffffff, 0)
        ieq r36.xyz, r36.xyzx, l(0x7f800000, 0x7f800000, 0x7f800000, 0)
        or r20.w, r36.y, r36.x
        or r20.w, r36.z, r20.w
        movc r30.xzw, r20.wwww, l(1.000000,0,1.000000,0), r30.xxzw
        dp3 r36.x, r17.yzwy, r32.xyzx
        dp3 r36.y, r17.yzwy, r34.xyzx
        dp3 r36.z, r17.yzwy, r35.xyzx
        mad_sat r17.yzw, r36.xxyz, cb10[r20.y + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
        mul r36.xy, r17.yzyy, cb10[r20.y + 4].zwzz
        mul r36.z, r17.w, cb10[r20.y + 5].x
        add r17.yzw, r36.xxyz, cb10[r20.y + 5].yyzw
        ...
        movc r19.z, r32.x, l(0), l(0.500000)
        ...
        movc r21.z, r32.y, l(0), l(0.500000)
        add r32.xyw, r17.yzyw, r21.xyxz
        ...
        movc r22.z, r32.z, l(0), l(0.500000)
        add r17.yzw, r17.yyzw, r22.xxyz
        sample_l_indexable(texture3d)(float,float,float,float) r17.yzw, r17.yzwy, t19.wxyz, s4, l(0.000000)
        mad r17.yzw, r17.yyzw, r35.zzzz, r32.xxyw
        ...
        movc r32.xyz, r19.zzzz, l(1.000000,1.000000,0,0), r32.xyzx
        mul r33.xyz, r17.yzwy, r32.xyzx
        dp3 r19.z, r33.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
        mad r26.xyz, r17.yzwy, r32.xyzx, r26.xyzx
        mul r17.y, r6.w, r19.z
        mul r30.xzw, r18.xxxx, r30.xxzw
        dp3 r17.z, r30.xzwx, l(0.212600, 0.715200, 0.072200, 0.000000)
        mad r17.z, r6.w, r19.z, r17.z
        div r17.y, r17.y, r17.z
        mad r27.xyz, r30.xzwx, r17.yyyy, r27.xyzx
      else 
        mov r29.x, r28.x
        mov r28.xz, r29.xxyx
      endif 
  ...
  and r4.w, r24.w, l(0x0000ff00)
  bfi r4.w, l(8), l(0), r15.z, r4.w
  movc r7.w, r2.w, r4.w, r15.z
  max r2.w, r15.y, l(1.000000)
  rcp r2.w, r2.w
  mov_sat r15.y, r15.y
  mul r17.xyz, r2.wwww, r14.yzwy
  mul r31.xyz, r2.wwww, r25.xyzx
  lt r4.w, r15.y, l(0.990000)
  if_nz r4.w
    iadd r7.w, r7.w, l(256)
    add r4.w, -r15.y, l(1.000000)
    ...
    mov r16.w, l(0)
    sample_l_indexable(texturecubearray)(float,float,float,float) r14.yzw, r16.xyzw, t8.wxyz, s2, r4.z
...
mad r2.xyw, r32.xyxz, r4.xyxz, r2.xyxw
...
ret 
// Approximately 2073 instruction slots used
