...
if_nz cb2[54].x
  ...
  loop 
    uge r29.w, r28.w, cb2[0].y
    breakc_nz r29.w
    ushr r29.w, r28.w, l(5)
    iadd r29.w, r10.w, r29.w
    ...
    loop 
      ...
      iadd r41.z, r28.w, r41.z
      imul null, r41.z, r41.z, l(14)
      add r44.xyz, r11.xyzx, -cb10[r41.z + 0].xyzx
      dp3 r41.w, r44.xyzx, r44.xyzx
      sqrt r41.w, r41.w
      ge r41.w, cb2[54].y, r41.w
      if_nz r41.w
        mov r30.yzw, cb10[r41.z + 1].xxyz
        mov r30.x, cb10[r41.z + 0].w
        mov r31.yzw, cb10[r41.z + 2].xxyz
        mov r31.x, cb10[r41.z + 1].w
        mov r32.xyz, cb10[r41.z + 3].xyzx
        mov r32.w, cb10[r41.z + 4].z
        mov r33.yz, cb10[r41.z + 4].xxyx
        mov r33.x, cb10[r41.z + 3].w
        mov r33.w, cb10[r41.z + 6].x
        mov r34.yzw, cb10[r41.z + 5].xxyz
        mov r34.x, cb10[r41.z + 4].w
        mov r35.yz, cb10[r41.z + 7].yywy
        mov r35.x, cb10[r41.z + 6].y
        mov r35.w, cb10[r41.z + 8].x
        mov r36.xyz, cb10[r41.z + 8].yzwy
        mov r36.w, cb10[r41.z + 9].x
        mov r37.xyz, cb10[r41.z + 10].yzwy
        mov r37.w, cb10[r41.z + 11].x
        mov r38.xyz, cb10[r41.z + 11].yzwy
        mov r38.w, cb10[r41.z + 12].x
        mov r39.xyz, cb10[r41.z + 0].xyzx
        mov r44.xy, cb10[r41.z + 13].yzyy
        mov r39.w, l(-1)
        mov r40.z, cb10[r41.z + 2].w
...
if_nz r13.w
  ...
  and r10.w, r15.w, l(0x0000ffff)
  ubfe r15.z, l(6), l(25), r15.w
  imul null, r17.w, r10.w, l(6)
  ...
  loop 
    ...
    breakc_nz r19.w
    iadd r19.w, r10.w, r18.w
    imul null, r19.w, r19.w, l(6)
    dp3 r22.w, cb11[r19.w + 0].xyzx, r14.yzwy
    add_sat r22.w, r22.w, cb11[r19.w + 0].w
    mul r22.w, r22.w, r32.x
    dp3 r28.w, cb11[r19.w + 1].xyzx, r14.yzwy
    add_sat r28.w, r28.w, cb11[r19.w + 1].w
    mul r22.w, r22.w, r28.w
    dp3 r28.w, cb11[r19.w + 2].xyzx, r14.yzwy
    add_sat r28.w, r28.w, cb11[r19.w + 2].w
    mul r22.w, r22.w, r28.w
    dp3 r28.w, cb11[r19.w + 3].xyzx, r14.yzwy
    add_sat r28.w, r28.w, cb11[r19.w + 3].w
    mul r22.w, r22.w, r28.w
    dp3 r28.w, cb11[r19.w + 4].xyzx, r14.yzwy
    add_sat r28.w, r28.w, cb11[r19.w + 4].w
    mul r22.w, r22.w, r28.w
    dp3 r28.w, cb11[r19.w + 5].xyzx, r14.yzwy
    add_sat r19.w, r28.w, cb11[r19.w + 5].w
    mul r32.x, r19.w, r22.w
    ushr r28.w, r17.w, l(2)
    ubfe r29.w, l(1), l(2), r17.w
    and r30.w, r28.w, l(2)
    max r31.z, r32.x, r32.y
    mad r19.w, -r22.w, r19.w, l(1.000000)
    mul r19.w, r19.w, r32.y
    movc r31.y, r30.w, r19.w, r31.z
    movc r32.xy, r29.wwww, r32.xyxx, r31.xyxx
    iadd r18.w, r18.w, l(1)
    mov r17.w, r28.w
  endloop 
  mov_sat r32.y, r32.y
  mul r31.w, r21.x, r32.y
  lt r10.w, l(0.000000), r31.w
  if_nz r10.w
    if_nz r2.w
    ...
    or r17.w, r20.y, r20.x
    or r17.w, r20.z, r17.w
    movc r15.yzw, r17.wwww, l(0,1.000000,1.000000,0), r15.yyzw
    ...
    dp3 r21.x, r12.xyzx, r30.xyzx
    dp3 r21.y, r12.xyzx, r17.xyzx
    dp3 r21.z, r12.xyzx, r28.xyzx
    ...
    mad r10.w, r9.w, r14.y, r10.w
    div r10.w, r14.z, r10.w
    mul r31.xyz, r10.wwww, r15.yzwy
    mov r10.w, l(257)
  else 
...
if_z r13.w
  ...
  loop 
    ...
    ieq r19.w, r14.z, r15.w
    bfi r21.w, r14.w, l(0), l(0), r18.w
    movc r18.w, r19.w, r21.w, r18.w
    ieq r19.w, r15.y, r15.w
    ubfe r21.w, r15.z, l(0), r18.w
    movc r18.w, r19.w, r21.w, r18.w
    ...
    loop 
      ...
      add r17.yzw, r11.xxyz, -cb10[r21.w + 0].xxyz
  ...
  loop 
    ...
    loop 
      ...
      add r17.yzw, r11.xxyz, -cb10[r20.y + 0].xxyz
      ...
      if_nz r21.w
        ...
        mad r32.xzw, r16.xxyz, r20.wwww, r33.xxyz
        ...
        utof r34.w, r21.w
        sample_l_indexable(texturecubearray)(float,float,float,float) r32.xzw, r34.xyzw, t8.xwyz, s2, r20.w
        ...
        movc r32.xzw, r20.wwww, l(1.000000,0,1.000000,0), r32.xxzw
        ...
        mul r17.y, r9.w, r19.z
        mul r32.xzw, r18.xxxx, r32.xxzw
        dp3 r17.z, r32.xzwx, l(0.212600, 0.715200, 0.072200, 0.000000)
        mad r17.z, r9.w, r19.z, r17.z
        div r17.y, r17.y, r17.z
        mad r28.xyz, r32.xzwx, r17.yyyy, r28.xyzx
      else 
        mov r30.x, r29.x
        mov r29.xz, r30.xxyx
      endif 
  ...
  if_nz r8.w
    ...
    mad r14.yzw, r15.yyzw, r4.wwww, r17.xxyz
    mov r16.w, l(0)
    ...
    mad r31.xyz, r15.yzwy, r4.wwww, r31.xyzx
  endif 
else 
  mov r14.yzw, l(0,0,0,0)
endif 
...
if_nz r5.x
  ...
  if_nz r5.x
    ...
    mad r19.xyz, r7.wwww, r15.yzwy, r17.xyzx
    ...
    mov r19.w, r21.z
    mov r17.w, r18.z
    movc r17.xyzw, r3.zzzz, r19.xyzw, r17.xyzw
    mov r21.zw, r20.xxxy
    mov r18.zw, r14.yyyz
    movc r19.xyzw, r3.zzzz, r21.xyzw, r18.xyzw
...
loop 
  ...
  switch r8.w
    ...
    mad r35.xyz, r13.wwww, r33.xyzx, r20.yzwy
    movc r35.xyz, r9.wwww, r35.xyzx, cb9[r7.w + 0].xyzx
    add r35.xyz, -r11.xyzx, r35.xyzx
    dp3 r16.w, r35.xyzx, r35.xyzx
    rsq r17.w, r16.w
    mul r35.xyz, r17.wwww, r35.xyzx
    ...
    if_nz r24.w
      ...
      mad_sat r35.xy, r24.wwww, cb9[r7.w + 2].xzxx, cb9[r7.w + 2].ywyy
      ...
      if_nz r24.w
        ...
        if_nz r29.w
          imad r35.xy, r28.wwww, l(24, 24, 0, 0), l(88, 104, 0, 0)
          ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r28.w, cb2[52].x, r35.x, u2.xxxx
          or r28.w, r28.w, l(4)
          store_structured u2.x, cb2[52].x, r35.x, r28.w
          store_structured u2.x, cb2[52].x, r35.y, r16.w
        endif 
        iadd r28.w, r5.x, l(257)
        ine r24.w, r24.w, l(1)
        if_nz r24.w
          mad r24.w, |r17.w|, l(-0.200000), l(0.400000)
          mad r35.xyz, r12.xyzx, r24.wwww, r11.xyzx
          ...
          loop 
            ige r32.w, r31.w, l(8)
            breakc_nz r32.w
            dp2 r37.y, icb[r31.w + 0].yxyy, r19.xyxx
            dp2 r37.z, icb[r31.w + 0].yxyy, r19.yzyy
            mul r37.yz, r37.yyzy, cb9[r7.w + 3].yyyy
            mul r37.x, r15.x, r37.y
            mul r37.w, r14.x, r37.y
            mad r36.xyz, r35.xyzx, r29.wwww, r37.xzwx
            sample_c_lz_indexable(texturecubearray)(float,float,float,float) r32.w, r36.xyzw, t10.xxxx, s13, r24.w
        ...
        lt r24.w, l(0.000000), r16.w
        if_nz r24.w
          mul r24.w, r1.w, cb9[r7.w + 1].z
          mul r24.w, r24.w, l(0.250000)
          dp3 r29.w, r33.xyzx, r16.xyzx
          dp3 r31.w, r16.xyzx, r34.xyzx
            ...
            if_z r22.x
              ...
              if_nz cb2[58].y
                ...
                loop 
                  ...
                  dp2 r36.y, icb[r22.z + 0].xyxx, r4.xyxx
                  mad r35.xy, r36.xyxx, cb9[r12.w + 3].yyyy, r34.xyxx
                  sample_c_lz_indexable(texture2darray)(float,float,float,float) r29.w, r35.xyzx, t9.xxxx, s13, r13.w
                  mad r22.y, r29.w, l(0.125000), r22.y
                  iadd r22.z, r22.z, l(1)
                endloop 
              else 
                utof r34.z, r22.x
                sample_c_lz_indexable(texture2darray)(float,float,float,float) r22.y, r34.xyzx, t9.xxxx, s13, r13.w
              endif 
            ...
            if_nz r13.w
              ...
              if_z r22.x
                ...
                if_nz cb2[58].y
                  ...
                  utof r34.z, r22.x
                  sample_c_lz_indexable(texture2darray)(float,float,float,float) r22.z, r34.xyzx, t9.xxxx, s13, r13.w
                endif 
          ...
          mad r34.xyz, r12.wwww, r23.xyzx, r15.yzwy
          dp3_sat r12.w, r12.xyzx, r33.xyzx
          ...
          mad r18.w, |r17.w|, r1.w, -|r17.w|
          mad r17.w, |r17.w|, r18.w, l(1.000000)
          mad r18.w, r12.w, r2.y, r4.w
          ...
          movc r15.yzw, r13.wwww, r34.xxyz, r15.yyzw
          movc r31.xyz, r13.wwww, r23.xyzx, r31.xyzx
          movc r32.xyz, r13.wwww, r20.yzwy, r32.xyzx
          and r9.w, r28.w, l(15)
          iadd r12.w, r9.w, l(-1)
      ...
      if_nz r16.w
          ...
          if_nz r21.z
            ...
            if_nz cb2[58].y
              ...
              loop 
                ...
                sample_c_lz_indexable(texture2darray)(float,float,float,float) r22.x, r33.xyzx, t9.xxxx, s13, r16.w
        ...
        if_nz r17.w
          ...
          if_nz r21.w
            ...
            mad r21.w, |r12.w|, l(-0.200000), l(0.400000)
            mad r26.xyz, r12.xyzx, r21.wwww, r11.xyzx
            mov r33.xyz, cb9[r21.y + 6].yzwy
            mov r33.w, cb9[r21.y + 7].x
            dp4 r21.w, r33.xyzw, r26.xyzw
            mov r33.xyz, cb9[r21.y + 7].yzwy
            mov r33.w, cb9[r21.y + 8].x
            dp4 r22.x, r33.xyzw, r26.xyzw
            lt r24.x, r22.x, r21.w
            if_z r24.x
              mov r33.xyz, cb9[r21.y + 4].yzwy
              mov r33.w, cb9[r21.y + 5].x
              dp4 r25.x, r33.xyzw, r26.xyzw
              mov r33.xyz, cb9[r21.y + 5].yzwy
              mov r33.w, cb9[r21.y + 6].x
              dp4 r25.y, r33.xyzw, r26.xyzw
            ...
            if_z r22.x
              ...
              if_nz cb2[58].y
                ...
                loop 
                  ige r24.w, r24.y, l(8)
                  breakc_nz r24.w
                  dp2 r33.x, icb[r24.y + 0].xyxx, r29.xyxx
                  dp2 r33.y, icb[r24.y + 0].yxyy, r29.xzxx
                  mad r25.xy, r33.xyxx, cb9[r21.y + 3].yyyy, r26.xyxx
            ...
            if_nz r21.y
              ...
              dp4 r21.y, r33.xyzw, r27.xyzw
              mov r33.xyz, cb9[r7.w + 7].yzwy
              mov r33.w, cb9[r7.w + 8].x
              dp4 r21.w, r33.xyzw, r27.xyzw
          ...
          mad r25.xyz, r7.wwww, r20.yzwy, r15.yzwy
          mad r23.xyz, r23.xyzx, r9.wwww, r5.yzwy
          dp3 r7.w, r23.xyzx, r23.xyzx
          rsq r7.w, r7.w
          mul r23.xyz, r7.wwww, r23.xyzx
          dp3 r7.w, r23.xyzx, r5.yzwy
          dp3 r9.w, r12.xyzx, r23.xyzx
          mad r21.y, |r9.w|, r1.w, -|r9.w|
          mad r9.w, |r9.w|, r21.y, l(1.000000)
          mad r13.w, r13.w, r2.y, r4.w
          mul r9.w, r9.w, r9.w
          mul r9.w, r13.w, r9.w
          rcp r9.w, r9.w
          mul r9.w, r17.w, r9.w
...
if_nz cb2[52].y
  if_nz cb2[53].y
    switch cb2[53].y
      ...
      break 
      case l(4)
      and r0.x, r10.w, l(255)
      break 
      case l(5)
      ubfe r0.x, l(8), l(8), r10.w
      break 
      default 
      mov r0.x, l(0)
      break 
...
if_nz cb2[52].y
  ...
  and r1.y, r10.w, l(255)
  atomic_iadd g1, l(12), r1.y
  ubfe r1.z, l(8), l(8), r10.w
...
ret 
// Approximately 2495 instruction slots used
