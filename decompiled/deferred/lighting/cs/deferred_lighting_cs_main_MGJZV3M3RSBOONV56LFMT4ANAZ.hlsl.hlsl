...
r0.y = samp0[]..swiz;
  ...
  r10.w = cmp((uint)r13.z < numRefProbes);
  r0.y = r0.y ? r10.w : 0;
  if (r0.y != 0) {
    r0.y = (int)r13.z * 14;
    if (r2.w != 0) {
    ...
    r18.x = r16.z * r16.y;
    r16.y = 1 & (int)refProbeConstantsCB[r0.y].data[6].x;
    r18.yz = float2(0,1);
    ...
    if (r14.w != 0) {
      ...
      r14.w = refProbeConstantsCB[r0.y].data[7].y * r10.w;
      ...
      r16.z = -refProbeConstantsCB[r0.y].data[8].z + r16.z;
      r16.w = cmp(r16.z >= 0);
      ...
      r16.w = -refProbeConstantsCB[r0.y].data[9].z + r16.w;
      r18.x = cmp(r16.w >= 0);
      ...
      r16.z = dot(r17.xyz, r18.xyz);
      r16.w = dot(r15.yzw, r18.xyz);
      r16.w = -refProbeConstantsCB[r0.y].data[10].z + r16.w;
      r18.x = cmp(r16.w >= 0);
      r16.w = max(abs(r16.w), r7.w);
      r16.w = r18.x ? r16.w : -r16.w;
      r16.z = max(1.00000001e-07, -r16.z);
      ...
      r16.z = dot(r17.xyz, r18.xyz);
      r16.w = dot(r15.yzw, r18.xyz);
      r16.w = -refProbeConstantsCB[r0.y].data[11].z + r16.w;
      r18.x = cmp(r16.w >= 0);
      r16.w = max(abs(r16.w), r7.w);
      r16.w = r18.x ? r16.w : -r16.w;
      r16.z = max(1.00000001e-07, -r16.z);
      ...
      r16.z = dot(r17.xyz, r18.xyz);
      r16.w = dot(r15.yzw, r18.xyz);
      r16.w = -refProbeConstantsCB[r0.y].data[12].z + r16.w;
      r18.x = cmp(r16.w >= 0);
      r16.w = max(abs(r16.w), r7.w);
      r16.w = r18.x ? r16.w : -r16.w;
      r16.z = max(1.00000001e-07, -r16.z);
      ...
      r16.z = dot(r17.xyz, r18.xyz);
      r16.w = dot(r15.yzw, r18.xyz);
      r16.w = -refProbeConstantsCB[r0.y].data[13].z + r16.w;
      r18.x = cmp(r16.w >= 0);
      r16.w = max(abs(r16.w), r7.w);
      r16.w = r18.x ? r16.w : -r16.w;
      r16.z = max(1.00000001e-07, -r16.z);
      ...
      if (9 == 0) r16.z = 0; else if (9+16 < 32) {       r16.z = (uint)refProbeConstantsCB[r0.y].data[7].z << (32-(9 + 16)); r16.z = (uint)r16.z >> (32-9);      } else r16.z = (uint)refProbeConstantsCB[r0.y].data[7].z >> 16;
      r20.w = (uint)r16.z;
  ...
  if (r9.w != 0) {
    ...
    r13.z = (int)r0.y + 1;
    r18.xyz = -refProbeConstantsCB[r9.w].data[0].xyz + r11.xyz;
    r14.w = 0x0000ffff & (int)refProbeConstantsCB[r9.w].data[7].z;
    if (6 == 0) r18.w = 0; else if (6+25 < 32) {     r18.w = (uint)refProbeConstantsCB[r9.w].data[7].z << (32-(6 + 25)); r18.w = (uint)r18.w >> (32-6);    } else r18.w = (uint)refProbeConstantsCB[r9.w].data[7].z >> 25;
    r19.x = (int)r14.w * 6;
    ...
    r19.x = r19.y * r19.x;
    r19.w = 1 & (int)refProbeConstantsCB[r9.w].data[6].x;
    r19.yz = float2(0,1);
    r19.xy = r19.ww ? r19.xy : r19.zx;
    r20.x = 1;
    r19.z = refProbeConstantsCB[r9.w].data[6].x;
    r21.xy = r19.xy;
    r19.w = 1;
    while (true) {
    ...
    r14.w = saturate(r21.y + -r10.w);
    r18.w = refProbeConstantsCB[r9.w].data[6].y * r14.w;
    r19.x = cmp(0 < r18.w);
    if (r19.x != 0) {
      r19.x = (int)r13.z & 3;
      r19.y = (int)r19.x + -1;
      ...
      r13.z = (int)r0.y + 257;
      r14.w = r14.w * refProbeConstantsCB[r9.w].data[6].y + r10.w;
      r18.w = refProbeConstantsCB[r9.w].data[7].y * r18.w;
      ...
      r19.x = -refProbeConstantsCB[r9.w].data[8].z + r19.x;
      r19.y = cmp(r19.x >= 0);
      ...
      r20.x = refProbeConstantsCB[r9.w].data[8].w;
      r20.yz = refProbeConstantsCB[r9.w].data[9].xy;
      r19.y = dot(r17.xyz, r20.xyz);
      r19.z = dot(r18.xyz, r20.xyz);
      r19.z = -refProbeConstantsCB[r9.w].data[9].z + r19.z;
      r19.w = cmp(r19.z >= 0);
      r19.z = max(abs(r19.z), r7.w);
      r19.z = r19.w ? r19.z : -r19.z;
      r19.y = max(1.00000001e-07, -r19.y);
      r19.y = r19.z / r19.y;
      r19.x = min(r19.x, abs(r19.y));
      r20.x = refProbeConstantsCB[r9.w].data[9].w;
      r20.yz = refProbeConstantsCB[r9.w].data[10].xy;
      r19.y = dot(r17.xyz, r20.xyz);
      r19.z = dot(r18.xyz, r20.xyz);
      r19.z = -refProbeConstantsCB[r9.w].data[10].z + r19.z;
      r19.w = cmp(r19.z >= 0);
      r19.z = max(abs(r19.z), r7.w);
      r19.z = r19.w ? r19.z : -r19.z;
      r19.y = max(1.00000001e-07, -r19.y);
      r19.y = r19.z / r19.y;
      r19.x = min(r19.x, abs(r19.y));
      r20.x = refProbeConstantsCB[r9.w].data[10].w;
      r20.yz = refProbeConstantsCB[r9.w].data[11].xy;
      r19.y = dot(r17.xyz, r20.xyz);
      r19.z = dot(r18.xyz, r20.xyz);
      r19.z = -refProbeConstantsCB[r9.w].data[11].z + r19.z;
      r19.w = cmp(r19.z >= 0);
      r19.z = max(abs(r19.z), r7.w);
      r19.z = r19.w ? r19.z : -r19.z;
      r19.y = max(1.00000001e-07, -r19.y);
      r19.y = r19.z / r19.y;
      r19.x = min(r19.x, abs(r19.y));
      r20.x = refProbeConstantsCB[r9.w].data[11].w;
      r20.yz = refProbeConstantsCB[r9.w].data[12].xy;
      r19.y = dot(r17.xyz, r20.xyz);
      r19.z = dot(r18.xyz, r20.xyz);
      r19.z = -refProbeConstantsCB[r9.w].data[12].z + r19.z;
      r19.w = cmp(r19.z >= 0);
      r19.z = max(abs(r19.z), r7.w);
      r19.z = r19.w ? r19.z : -r19.z;
      r19.y = max(1.00000001e-07, -r19.y);
      r19.y = r19.z / r19.y;
      r19.x = min(r19.x, abs(r19.y));
      r20.x = refProbeConstantsCB[r9.w].data[12].w;
      r20.yz = refProbeConstantsCB[r9.w].data[13].xy;
      r19.y = dot(r17.xyz, r20.xyz);
      r19.z = dot(r18.xyz, r20.xyz);
      r19.z = -refProbeConstantsCB[r9.w].data[13].z + r19.z;
      r19.w = cmp(r19.z >= 0);
      r7.w = max(abs(r19.z), r7.w);
      r7.w = r19.w ? r7.w : -r7.w;
      r19.y = max(1.00000001e-07, -r19.y);
      r7.w = r7.w / r19.y;
      r7.w = min(r19.x, abs(r7.w));
      ...
      r21.w = (uint)r7.w;
      r19.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r21.xyzw, r3.w).xyz;
      r24.xyz = (int3)r19.xyz & int3(-2147483648,-2147483648,-2147483648);
      r24.xyz = cmp((int3)r24.xyz == int3(2139095040,2139095040,2139095040));
      r3.w = (int)r24.y | (int)r24.x;
      r3.w = (int)r24.z | (int)r3.w;
      r19.xyz = r3.www ? float3(1,1,0) : r19.xyz;
      ...
      r3.w = (int)r21.y | (int)r21.x;
      r3.w = (int)r21.z | (int)r3.w;
      r20.xyz = r3.www ? float3(1,1,0) : r20.xyz;
      r21.xyz = r20.xyz * r18.xyz;
      r3.w = dot(r21.xyz, float3(0.212599993,0.715200007,0.0722000003));
      ...
      r3.w = r8.w * r3.w + r9.w;
      r3.w = r7.w / r3.w;
      r16.yzw = r18.xyz * r3.www + r16.yzw;
    } else {
      r14.w = r10.w;
    }
  } else {
  ...
  r3.w = cmp(r10.w >= 1);
  bitmask.y = ((~(-1 << 8)) << 0) & 0xffffffff;  r0.y = (((uint)r13.z << 0) & bitmask.y) | ((uint)r0.y & ~bitmask.y);
  r0.y = r3.w ? r0.y : r13.z;
  r3.w = max(1, r14.w);
  r3.w = rcp(r3.w);
  r14.w = saturate(r14.w);
  r18.xyz = r15.yzw * r3.www;
  r16.yzw = r16.yzw * r3.www;
  r7.w = cmp(r14.w < 0.99000001);
  if (r7.w != 0) {
    r0.y = (int)r0.y + 256;
    r7.w = 1 + -r14.w;
    ...
    r18.xyz = r15.yzw * r3.www + r19.xyz;
    r17.w = 0;
    ...
    r3.w = r2.y * r3.w + r8.w;
    r16.yzw = r15.yzw * r3.www + r16.yzw;
  }
  r3.w = r2.x + r5.z;
  r3.w = log2(abs(r3.w));
  r3.w = r3.w * r2.z;
