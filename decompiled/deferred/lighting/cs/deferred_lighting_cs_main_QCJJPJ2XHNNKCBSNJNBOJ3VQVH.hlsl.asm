...
uge r0.y, r9.x, r8.w
ult r9.w, r9.x, cb2[0].y
and r0.y, r0.y, r9.w
if_nz r0.y
  imul null, r0.y, r9.x, l(14)
  add r15.yzw, r10.xxyz, -cb10[r0.y + 0].xxyz
  and r9.w, l(0x0000ffff), cb10[r0.y + 7].z
  ubfe r12.w, l(6), l(25), cb10[r0.y + 7].z
  imul null, r13.z, r9.w, l(6)
  dp3 r13.w, cb11[r13.z + 0].xyzx, r15.yzwy
  add_sat r13.w, r13.w, cb11[r13.z + 0].w
  dp3 r14.w, cb11[r13.z + 1].xyzx, r15.yzwy
  add_sat r14.w, r14.w, cb11[r13.z + 1].w
  mul r13.w, r13.w, r14.w
  dp3 r14.w, cb11[r13.z + 2].xyzx, r15.yzwy
  add_sat r14.w, r14.w, cb11[r13.z + 2].w
  mul r13.w, r13.w, r14.w
  dp3 r14.w, cb11[r13.z + 3].xyzx, r15.yzwy
  add_sat r14.w, r14.w, cb11[r13.z + 3].w
  mul r13.w, r13.w, r14.w
  dp3 r14.w, cb11[r13.z + 4].xyzx, r15.yzwy
  add_sat r14.w, r14.w, cb11[r13.z + 4].w
  mul r13.w, r13.w, r14.w
  dp3 r14.w, cb11[r13.z + 5].xyzx, r15.yzwy
  add_sat r13.z, r14.w, cb11[r13.z + 5].w
  mul r17.x, r13.z, r13.w
  and r13.z, l(1), cb10[r0.y + 6].x
  ...
  loop 
    ...
    dp3 r18.z, cb11[r17.w + 0].xyzx, r15.yzwy
    add_sat r18.z, r18.z, cb11[r17.w + 0].w
    mul r18.z, r18.z, r18.x
    dp3 r18.w, cb11[r17.w + 1].xyzx, r15.yzwy
    add_sat r18.w, r18.w, cb11[r17.w + 1].w
    mul r18.z, r18.w, r18.z
    dp3 r18.w, cb11[r17.w + 2].xyzx, r15.yzwy
    add_sat r18.w, r18.w, cb11[r17.w + 2].w
    mul r18.z, r18.w, r18.z
    dp3 r18.w, cb11[r17.w + 3].xyzx, r15.yzwy
    add_sat r18.w, r18.w, cb11[r17.w + 3].w
    mul r18.z, r18.w, r18.z
    dp3 r18.w, cb11[r17.w + 4].xyzx, r15.yzwy
    add_sat r18.w, r18.w, cb11[r17.w + 4].w
    mul r18.z, r18.w, r18.z
    dp3 r18.w, cb11[r17.w + 5].xyzx, r15.yzwy
  ...
  endloop 
  mov_sat r18.y, r18.y
  mul r9.w, r18.y, cb10[r0.y + 6].y
  lt r12.w, l(0.000000), r9.w
  if_nz r12.w
    mul r12.w, r9.w, cb10[r0.y + 7].y
    ...
    mad r17.xyz, r16.xyzx, r13.zzzz, r17.xyzx
    ...
    utof r19.w, r13.w
    sample_l_indexable(texturecubearray)(float,float,float,float) r17.xyz, r19.xyzw, t8.xyzw, s2, r13.z
...
if_nz r0.y
  ...
  if_nz r0.y
    ...
    mov r14.w, l(1)
    loop 
      ige r17.w, r14.w, r9.x
      breakc_nz r17.w
      iadd r17.w, r8.w, r14.w
      imul null, r17.w, r17.w, l(6)
...
if_nz r2.w
  ...
  dp3 r6.w, r19.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
  mad r18.xyz, r15.yzwy, r0.yyyy, r19.xyzx
  mov r16.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r15.yzw, r16.xyzw, t8.wxyz, s2, r5.w
  mad r0.y, cb2[19].x, r2.w, -r6.w
