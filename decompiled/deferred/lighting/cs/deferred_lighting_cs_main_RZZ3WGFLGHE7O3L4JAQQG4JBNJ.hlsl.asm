...
max r2.w, r2.w, |r9.y|
max r2.w, r2.w, |r9.x|
eq r9.xyz, r2.zzzz, |r9.yzwy|
movc r2.z, r9.x, r18.y, r18.x
movc r2.z, r9.y, r18.z, r2.z
movc r2.z, r9.z, r18.w, r2.z
mul r0.w, r0.w, l(0.010000)
lt r0.w, r0.w, r2.w
movc r0.w, r0.w, r2.z, r1.w
mul r1.w, r0.w, r4.z
...
mad r2.z, r4.z, r0.w, r2.x
log r2.z, |r2.z|
mul r2.z, r1.z, r2.z
exp r2.z, r2.z
mad r0.w, r4.z, r0.w, r2.z
...
loop 
  ...
  switch r7.w
    ...
    mad r33.xyz, r9.wwww, r30.xyzx, r31.xyzx
    ...
    if_nz r13.w
      ...
      mad_sat r33.xy, r13.wwww, cb9[r6.w + 2].xzxx, cb9[r6.w + 2].ywyy
      ...
      if_nz r13.w
        ...
        if_nz r13.w
          ...
          mad r33.xyz, r11.xyzx, r13.wwww, r10.xyzx
        ...
        if_nz r13.w
          ...
          mad r25.w, -r14.w, r14.w, cb9[r6.w + 6].y
          mad r8.w, r14.w, r20.w, -r8.w
          div_sat r8.w, r8.w, r25.w
          div r14.w, r25.w, cb9[r6.w + 6].y
          mul r14.w, r14.w, l(10.000000)
          min r14.w, r14.w, l(1.000000)
          add r8.w, -r9.w, r8.w
          mad r8.w, r14.w, r8.w, r9.w
          ...
          if_nz r9.w
            ...
            if_z r20.w
              ...
              add r32.x, r19.x, cb9[r8.w + 9].w
              add r32.y, r19.y, cb9[r8.w + 10].x
              mul r19.xy, r32.xyxx, cb9[r8.w + 9].yzyy
              ...
              if_z r19.z
                ...
                mad r32.x, r19.x, cb9[r8.w + 8].y, cb9[r8.w + 8].z
                mad r32.y, r19.y, cb9[r8.w + 8].w, cb9[r8.w + 9].x
                mul r19.x, r14.w, cb9[r8.w + 10].z
                mad r9.w, cb9[r8.w + 10].y, r14.w, r9.w
                div r9.w, r9.w, r19.x
              endif 
            else 
              mov r19.z, l(-1)
            ...
            if_z r14.w
              ...
              and r14.w, l(0x0000ffff), cb9[r8.w + 1].w
              if_nz cb2[58].y
                utof r19.z, r14.w
                mov r20.w, l(0)
                mov r25.w, l(0)
                loop 
                  ...
                  mad r19.xy, r33.xyxx, cb9[r8.w + 3].yyyy, r32.xyxx
                  sample_c_lz_indexable(texture2darray)(float,float,float,float) r19.x, r19.xyzx, t9.xxxx, s13, r9.w
                  mad r20.w, r19.x, l(0.125000), r20.w
                  iadd r25.w, r25.w, l(1)
                endloop 
              else 
                utof r32.z, r14.w
                sample_c_lz_indexable(texture2darray)(float,float,float,float) r20.w, r32.xyzx, t9.xxxx, s13, r9.w
              endif 
              mul r8.w, r20.w, r20.w
              mul r8.w, r20.w, r8.w
            else 
              mov r8.w, l(1.000000)
            endif 
            ...
            if_nz r9.w
              ...
              if_z r19.x
                ...
                add r21.x, r19.y, cb9[r8.w + 9].w
                add r21.y, r19.z, cb9[r8.w + 10].x
                mul r19.yz, r21.xxyx, cb9[r8.w + 9].yyzy
                div r21.xy, cb9[r8.w + 3].yyyy, cb9[r8.w + 8].ywyy
                ...
                if_z r21.x
                  ...
                  mad r32.x, r19.y, cb9[r8.w + 8].y, cb9[r8.w + 8].z
                  mad r32.y, r19.z, cb9[r8.w + 8].w, cb9[r8.w + 9].x
                  mul r19.y, r14.w, cb9[r8.w + 10].z
                  mad r9.w, cb9[r8.w + 10].y, r14.w, r9.w
                  div r9.w, r9.w, r19.y
                endif 
              else 
              ...
              if_z r14.w
                ...
                if_nz cb2[58].y
                  ...
                  utof r32.z, r14.w
                  sample_c_lz_indexable(texture2darray)(float,float,float,float) r21.x, r32.xyzx, t9.xxxx, s13, r9.w
                endif 
          ...
          add r8.w, -r13.z, r8.w
          mad r8.w, r1.z, r8.w, r13.z
          mul r8.w, r11.w, r8.w
          mov r19.x, cb9[r6.w + 0].w
          mov r19.yz, cb9[r6.w + 1].xxyx
          lt r9.w, l(0.000000), r12.w
          mad r32.xyz, r8.wwww, r19.xyzx, r15.yzwy
          ...
          mul r8.w, r8.w, r12.w
          mul r8.w, r11.w, r8.w
          mad r30.xyz, r8.wwww, r19.xyzx, r29.xyzx
          add_sat r7.w, -r7.w, l(1.000000)
          mul r11.w, r7.w, r7.w
          mul r11.w, r11.w, r11.w
          mul r7.w, r7.w, r11.w
          mul r7.w, r7.w, r8.w
          mad r19.xyz, r7.wwww, r19.xyzx, r28.xyzx
          movc r15.yzw, r9.wwww, r32.xxyz, r15.yyzw
          movc r28.xyz, r9.wwww, r19.xyzx, r28.xyzx
          movc r29.xyz, r9.wwww, r30.xyzx, r29.xyzx
        endif 
      endif 
    endif 
    break 
    case l(2)
    add r19.xy, -r10.xyxx, cb9[r6.w + 3].zwzz
    add r19.z, -r10.z, cb9[r6.w + 4].x
    dp3 r7.w, r19.xyzx, r19.xyzx
    rsq r7.w, r7.w
    mul r30.xyz, r7.wwww, r19.xyzx
    ...
    if_nz r11.w
      ...
      if_nz r12.w
        ...
        mad_sat r21.yz, r11.wwww, cb9[r6.w + 2].xxzx, cb9[r6.w + 2].yywy
        ...
        div r20.xy, r32.xyxx, r11.wwww
        lt r11.w, cb9[r6.w + 10].w, l(0.00048828)
        if_nz r11.w
          mad_sat r21.yz, |r20.xxyx|, cb9[r6.w + 12].xxyx, cb9[r6.w + 12].zzwz
          mul r32.xy, r21.yzyy, r21.yzyy
          mad r21.yz, r21.yyzy, l(0.000000, -2.000000, -2.000000, 0.000000), l(0.000000, 3.000000, 3.000000, 0.000000)
          mul r21.yz, r21.yyzy, r32.xxyx
          mul r11.w, r21.z, r21.y
        else 
          mul_sat r32.xyzw, |r20.yyxx|, cb9[r6.w + 11].xyzw
          log r32.xyzw, r32.xyzw
          mul r32.xyzw, r32.xyzw, cb9[r6.w + 12].zzzz
          exp r32.xyzw, r32.xyzw
          add r21.yz, r32.zzwz, r32.xxyx
          log r21.yz, r21.yyzy
          mul r21.yz, r21.yyzy, cb9[r6.w + 12].wwww
          exp r21.yz, r21.yyzy
          mul r13.w, r21.y, cb9[r6.w + 12].x
          mad r14.w, cb9[r6.w + 12].y, r21.z, l(-1.000000)
          mad r13.w, cb9[r6.w + 12].y, r21.z, -r13.w
        ...
        if_nz r11.w
          dp3 r13.z, cb9[r6.w + 13].xyzx, r20.xyzx
      ...
      if_nz r11.w
        ...
        if_nz r11.w
          ...
          if_nz r13.w
            ...
            div r20.xy, r20.xyxx, r13.zzzz
            mad_sat r20.xy, r20.xyxx, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
            mad r22.x, r20.x, cb9[r6.w + 8].y, cb9[r6.w + 8].z
            mad r22.y, r20.y, cb9[r6.w + 8].w, cb9[r6.w + 9].x
            ...
            if_nz cb2[58].y
              ...
              loop 
                ...
                mad r30.xy, r20.xyxx, cb9[r6.w + 3].yyyy, r22.xyxx
                sample_c_lz_indexable(texture2darray)(float,float,float,float) r20.x, r30.xyzx, t9.xxxx, s13, r11.w
        ...
        if_nz r12.w
          ...
          if_nz r14.w
            ...
            mad r23.xyz, r11.xyzx, r14.wwww, r10.xyzx
            ...
            if_z r20.y
              ...
              add r22.x, r21.y, cb9[r13.z + 9].w
              add r22.y, r21.z, cb9[r13.z + 10].x
              mul r21.yz, r22.xxyx, cb9[r13.z + 9].yyzy
              div r22.xy, cb9[r13.z + 3].yyyy, cb9[r13.z + 8].ywyy
              ...
              if_z r22.x
                ...
                mad r23.x, r21.y, cb9[r13.z + 8].y, cb9[r13.z + 8].z
                mad r23.y, r21.z, cb9[r13.z + 8].w, cb9[r13.z + 9].x
                mul r21.y, r20.x, cb9[r13.z + 10].z
                mad r14.w, cb9[r13.z + 10].y, r20.x, r14.w
            ...
            if_z r20.x
              ...
              and r20.x, l(0x0000ffff), cb9[r13.z + 1].w
              if_nz cb2[58].y
                utof r22.z, r20.x
                mov r20.y, l(0)
                mov r21.y, l(0)
                loop 
                  ...
                  mad r22.xy, r30.xyxx, cb9[r13.z + 3].yyyy, r23.xyxx
            ...
            if_nz r13.z
              ...
              dp4 r13.z, r30.xyzw, r24.xyzw
              mov r30.xyz, cb9[r6.w + 7].yzwy
              mov r30.w, cb9[r6.w + 8].x
              dp4 r14.w, r30.xyzw, r24.xyzw
              lt r20.x, r14.w, r13.z
              if_z r20.x
                mov r30.xyz, cb9[r6.w + 4].yzwy
                mov r30.w, cb9[r6.w + 5].x
                ...
                mad r21.yz, r21.yyzy, l(0.000000, 0.500000, -0.500000, 0.000000), l(0.000000, 0.500000, 0.500000, 0.000000)
                add r22.x, r21.y, cb9[r6.w + 9].w
                add r22.y, r21.z, cb9[r6.w + 10].x
                mul r21.yz, r22.xxyx, cb9[r6.w + 9].yyzy
                ...
                if_z r22.x
                  mov_sat r21.yz, r21.yyzy
                  mad r23.x, r21.y, cb9[r6.w + 8].y, cb9[r6.w + 8].z
                  mad r23.y, r21.z, cb9[r6.w + 8].w, cb9[r6.w + 9].x
                  mul r21.y, r14.w, cb9[r6.w + 10].z
                  mad r13.z, cb9[r6.w + 10].y, r14.w, r13.z
              ...
              if_z r14.w
                ...
                if_nz cb2[58].y
                  ...
                  loop 
                    ...
                    mad r22.xy, r24.xyxx, cb9[r6.w + 3].yyyy, r23.xyxx
                    sample_c_lz_indexable(texture2darray)(float,float,float,float) r21.z, r22.xyzx, t9.xxxx, s13, r13.z
                    mad r20.x, r21.z, l(0.125000), r20.x
                    iadd r21.y, r21.y, l(1)
                  endloop 
                else 
                  utof r23.z, r14.w
                  sample_c_lz_indexable(texture2darray)(float,float,float,float) r20.x, r23.xyzx, t9.xxxx, s13, r13.z
                endif 
                mul r6.w, r20.x, r20.x
                mul r6.w, r20.x, r6.w
              else 
                mov r6.w, l(1.000000)
              endif 
          ...
          mad r22.xyz, r6.wwww, r31.xyzx, r15.yzwy
          mad r19.xyz, r19.xyzx, r7.wwww, r12.xyzx
          dp3 r6.w, r19.xyzx, r19.xyzx
          rsq r6.w, r6.w
          mul r19.xyz, r6.wwww, r19.xyzx
          dp3 r6.w, r19.xyzx, r12.xyzx
          dp3 r7.w, r11.xyzx, r19.xyzx
          mad r13.z, |r7.w|, r0.z, -|r7.w|
          mad r7.w, |r7.w|, r13.z, l(1.000000)
          mad r9.w, r9.w, r0.w, r1.w
          mul r7.w, r7.w, r7.w
          mul r7.w, r9.w, r7.w
          rcp r7.w, r7.w
          mul r7.w, r12.w, r7.w
          ...
          mad r19.xyz, r7.wwww, r31.xyzx, r29.xyzx
          add_sat r6.w, -r6.w, l(1.000000)
          mul r9.w, r6.w, r6.w
          mul r9.w, r9.w, r9.w
          mul r6.w, r6.w, r9.w
          mul r6.w, r6.w, r7.w
          mad r23.xyz, r6.wwww, r31.xyzx, r28.xyzx
          movc r15.yzw, r8.wwww, r22.xxyz, r15.yyzw
          movc r28.xyz, r8.wwww, r23.xyzx, r28.xyzx
