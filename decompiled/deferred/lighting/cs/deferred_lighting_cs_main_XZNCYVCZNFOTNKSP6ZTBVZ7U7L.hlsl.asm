...
if_nz r2.z
  ...
  if_nz r2.z
    ...
    max r3.w, r12.y, r12.x
    add r12.xyw, r14.xyxz, -r15.xyxz
    mad r12.xyw, r3.wwww, r12.xyxw, r15.xyxz
    ...
    mad r13.xyw, r3.wwww, r16.xyxz, r13.xyxw
    ...
    sample_l_indexable(texture2d)(float,float,float,float) r3.w, r17.xyxx, t28.yzwx, s1, r2.z
    min r2.w, |r2.w|, |r3.w|
    mul r2.w, r17.z, r2.w
  ...
  mad r3.w, r0.x, l(-2.000000), l(3.000000)
  mul r0.x, r0.x, r0.x
  mul r0.x, r0.x, r3.w
  mul r0.x, r0.x, r2.z
  mul r0.x, r13.y, r0.x
...
loop 
  ...
  if_nz r13.w
    ...
    add r20.xyz, r9.xyzx, -cb10[r12.w + 0].xyzx
    and r13.w, l(0x0000ffff), cb10[r12.w + 7].z
    ubfe r14.w, l(6), l(25), cb10[r12.w + 7].z
    imul null, r15.z, r13.w, l(6)
    dp3 r15.w, cb11[r15.z + 0].xyzx, r20.xyzx
    add_sat r15.w, r15.w, cb11[r15.z + 0].w
    dp3 r16.w, cb11[r15.z + 1].xyzx, r20.xyzx
    add_sat r16.w, r16.w, cb11[r15.z + 1].w
    mul r15.w, r15.w, r16.w
    dp3 r16.w, cb11[r15.z + 2].xyzx, r20.xyzx
    add_sat r16.w, r16.w, cb11[r15.z + 2].w
    mul r15.w, r15.w, r16.w
    dp3 r16.w, cb11[r15.z + 3].xyzx, r20.xyzx
    add_sat r16.w, r16.w, cb11[r15.z + 3].w
    mul r15.w, r15.w, r16.w
    dp3 r16.w, cb11[r15.z + 4].xyzx, r20.xyzx
    add_sat r16.w, r16.w, cb11[r15.z + 4].w
    mul r15.w, r15.w, r16.w
    dp3 r16.w, cb11[r15.z + 5].xyzx, r20.xyzx
    add_sat r15.z, r16.w, cb11[r15.z + 5].w
    mul r13.x, r15.z, r15.w
    and r15.z, l(1), cb10[r12.w + 6].x
    movc r15.zw, r15.zzzz, r13.xxxy, r13.zzzx
    mov r13.x, cb10[r12.w + 6].x
    mov r21.xy, r15.zwzz
    mov r16.w, l(1)
    loop 
      ...
      dp3 r20.w, cb11[r17.w + 0].xyzx, r20.xyzx
      add_sat r20.w, r20.w, cb11[r17.w + 0].w
      mul r20.w, r20.w, r21.x
      dp3 r21.z, cb11[r17.w + 1].xyzx, r20.xyzx
      add_sat r21.z, r21.z, cb11[r17.w + 1].w
      mul r20.w, r20.w, r21.z
      dp3 r21.z, cb11[r17.w + 2].xyzx, r20.xyzx
      add_sat r21.z, r21.z, cb11[r17.w + 2].w
      mul r20.w, r20.w, r21.z
      dp3 r21.z, cb11[r17.w + 3].xyzx, r20.xyzx
      add_sat r21.z, r21.z, cb11[r17.w + 3].w
      mul r20.w, r20.w, r21.z
      dp3 r21.z, cb11[r17.w + 4].xyzx, r20.xyzx
      add_sat r21.z, r21.z, cb11[r17.w + 4].w
      mul r20.w, r20.w, r21.z
      dp3 r21.z, cb11[r17.w + 5].xyzx, r20.xyzx
      add_sat r17.w, r21.z, cb11[r17.w + 5].w
      mul r21.x, r17.w, r20.w
      ...
      movc r15.y, r22.x, r17.w, r22.y
      movc r21.xy, r21.wwww, r21.xyxx, r15.xyxx
      iadd r16.w, r16.w, l(1)
      mov r13.x, r21.z
    endloop 
    mov_sat r21.y, r21.y
    mul r13.x, r21.y, cb10[r12.w + 6].y
    lt r13.w, l(0.000000), r13.x
    if_nz r13.w
      mad r19.w, r21.y, cb10[r12.w + 6].y, r19.w
      mul r13.x, r13.x, cb10[r12.w + 7].y
      ...
      dp3 r15.y, r20.xyzx, r22.xyzx
      add r15.y, r15.y, -cb10[r12.w + 9].z
      ...
      dp3 r14.w, r11.xyzx, r22.xyzx
      dp3 r15.y, r20.xyzx, r22.xyzx
      add r15.y, r15.y, -cb10[r12.w + 10].z
      ge r15.z, r15.y, l(0.000000)
      max r15.y, r5.w, |r15.y|
      movc r15.y, r15.z, r15.y, -r15.y
      max r14.w, -r14.w, l(0.00000010)
      ...
      dp3 r14.w, r11.xyzx, r22.xyzx
      dp3 r15.y, r20.xyzx, r22.xyzx
      add r15.y, r15.y, -cb10[r12.w + 11].z
      ge r15.z, r15.y, l(0.000000)
      max r15.y, r5.w, |r15.y|
      movc r15.y, r15.z, r15.y, -r15.y
      max r14.w, -r14.w, l(0.00000010)
      ...
      dp3 r14.w, r11.xyzx, r22.xyzx
      dp3 r15.y, r20.xyzx, r22.xyzx
      add r15.y, r15.y, -cb10[r12.w + 12].z
      ge r15.z, r15.y, l(0.000000)
      max r15.y, r5.w, |r15.y|
      movc r15.y, r15.z, r15.y, -r15.y
      max r14.w, -r14.w, l(0.00000010)
      ...
      dp3 r14.w, r11.xyzx, r22.xyzx
      dp3 r15.y, r20.xyzx, r22.xyzx
      add r15.y, r15.y, -cb10[r12.w + 13].z
      ge r15.z, r15.y, l(0.000000)
      max r15.y, r5.w, |r15.y|
      movc r15.y, r15.z, r15.y, -r15.y
      max r14.w, -r14.w, l(0.00000010)
      div r14.w, r15.y, r14.w
      min r13.w, r13.w, |r14.w|
      add r22.x, r20.x, cb10[r12.w + 3].w
      add r22.yz, r20.yyzy, cb10[r12.w + 4].xxyx
      mad r15.yzw, r11.xxyz, r13.wwww, r22.xxyz
      ...
      mov r22.x, cb10[r12.w + 0].w
      mov r22.y, cb10[r12.w + 1].z
      mov r22.z, cb10[r12.w + 2].y
      dp3 r23.x, r15.yzwy, r22.xyzx
      mov r24.xy, cb10[r12.w + 1].xwxx
      mov r24.z, cb10[r12.w + 2].z
      dp3 r23.y, r15.yzwy, r24.xyzx
      mov r25.x, cb10[r12.w + 1].y
      mov r25.yz, cb10[r12.w + 2].xxwx
      dp3 r23.z, r15.yzwy, r25.xyzx
      ubfe r14.w, l(9), l(16), cb10[r12.w + 7].z
      utof r23.w, r14.w
      sample_l_indexable(texturecubearray)(float,float,float,float) r15.yzw, r23.xyzw, t8.wxyz, s2, r13.w
      dp3 r26.x, r20.xyzx, r22.xyzx
      dp3 r26.y, r20.xyzx, r24.xyzx
      dp3 r26.z, r20.xyzx, r25.xyzx
      mad_sat r20.xyz, r26.xyzx, cb10[r12.w + 3].xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
      mul r26.xy, r20.xyxx, cb10[r12.w + 4].zwzz
      mul r26.z, r20.z, cb10[r12.w + 5].x
      add r20.xyz, r26.xyzx, cb10[r12.w + 5].yzwy
...
if_nz r9.w
  ...
  loop 
    ...
    breakc_nz r12.w
    movc r12.w, r9.w, r0.y, r8.w
    ult r13.w, r12.w, r7.w
    if_nz r13.w
      imul null, r12.w, r12.w, l(14)
      add r22.xyz, r9.xyzx, -cb10[r12.w + 0].xyzx
      and r13.w, l(0x0000ffff), cb10[r12.w + 7].z
      ubfe r14.w, l(6), l(25), cb10[r12.w + 7].z
      imul null, r15.z, r13.w, l(6)
      dp3 r15.w, cb11[r15.z + 0].xyzx, r22.xyzx
      add_sat r15.w, r15.w, cb11[r15.z + 0].w
      dp3 r16.w, cb11[r15.z + 1].xyzx, r22.xyzx
      add_sat r16.w, r16.w, cb11[r15.z + 1].w
      mul r15.w, r15.w, r16.w
      dp3 r16.w, cb11[r15.z + 2].xyzx, r22.xyzx
      add_sat r16.w, r16.w, cb11[r15.z + 2].w
      mul r15.w, r15.w, r16.w
      dp3 r16.w, cb11[r15.z + 3].xyzx, r22.xyzx
      add_sat r16.w, r16.w, cb11[r15.z + 3].w
      mul r15.w, r15.w, r16.w
      dp3 r16.w, cb11[r15.z + 4].xyzx, r22.xyzx
      add_sat r16.w, r16.w, cb11[r15.z + 4].w
      mul r15.w, r15.w, r16.w
      dp3 r16.w, cb11[r15.z + 5].xyzx, r22.xyzx
      add_sat r15.z, r16.w, cb11[r15.z + 5].w
      mul r13.x, r15.z, r15.w
      and r15.z, l(1), cb10[r12.w + 6].x
      movc r15.zw, r15.zzzz, r13.xxxy, r13.zzzx
      ...
      loop 
        ...
        iadd r17.w, r13.w, r16.w
        imul null, r17.w, r17.w, l(6)
        dp3 r21.w, cb11[r17.w + 0].xyzx, r22.xyzx
        add_sat r21.w, r21.w, cb11[r17.w + 0].w
        mul r21.w, r21.w, r23.x
        dp3 r22.w, cb11[r17.w + 1].xyzx, r22.xyzx
        add_sat r22.w, r22.w, cb11[r17.w + 1].w
        mul r21.w, r21.w, r22.w
        dp3 r22.w, cb11[r17.w + 2].xyzx, r22.xyzx
        add_sat r22.w, r22.w, cb11[r17.w + 2].w
        mul r21.w, r21.w, r22.w
        dp3 r22.w, cb11[r17.w + 3].xyzx, r22.xyzx
        add_sat r22.w, r22.w, cb11[r17.w + 3].w
        mul r21.w, r21.w, r22.w
        dp3 r22.w, cb11[r17.w + 4].xyzx, r22.xyzx
        add_sat r22.w, r22.w, cb11[r17.w + 4].w
        mul r21.w, r21.w, r22.w
        dp3 r22.w, cb11[r17.w + 5].xyzx, r22.xyzx
        add_sat r17.w, r22.w, cb11[r17.w + 5].w
        mul r23.x, r17.w, r21.w
        ushr r22.w, r13.x, l(2)
        ubfe r23.z, l(1), l(2), r13.x
        and r23.w, r22.w, l(2)
        max r24.x, r23.x, r23.y
        mad r17.w, -r21.w, r17.w, l(1.000000)
        mul r17.w, r17.w, r23.y
        movc r15.y, r23.w, r17.w, r24.x
        movc r23.xy, r23.zzzz, r23.xyxx, r15.xyxx
        iadd r16.w, r16.w, l(1)
        mov r13.x, r22.w
      endloop 
      add_sat r13.x, -r19.w, r23.y
      mul r13.w, r13.x, cb10[r12.w + 6].y
      lt r14.w, l(0.000000), r13.w
      if_nz r14.w
        mad r20.w, r13.x, cb10[r12.w + 6].y, r20.w
        mul r13.x, r13.w, cb10[r12.w + 7].y
        ...
        mad r15.yzw, r11.xxyz, r13.wwww, r24.xxyz
        dp3 r14.w, r15.yzwy, r15.yzwy
        sqrt r14.w, r14.w
        div r13.w, r13.w, r14.w
        add r13.w, r13.w, r13.w
        ...
        ubfe r14.w, l(9), l(16), cb10[r12.w + 7].z
        utof r25.w, r14.w
        sample_l_indexable(texturecubearray)(float,float,float,float) r15.yzw, r25.xyzw, t8.wxyz, s2, r13.w
        ...
        mad r12.w, r6.w, r12.w, r13.x
        div r12.w, r13.w, r12.w
        mad r20.xyz, r15.yzwy, r12.wwww, r20.xyzx
      endif 
    endif 
    iadd r9.w, r9.w, l(1)
  endloop 
...
if_nz r2.w
  ...
  mov r11.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r10.xyz, r11.xyzw, t8.xyzw, s2, r3.w
  mad r0.y, cb2[19].x, r2.w, -r5.w
...
add r4.x, r2.y, r4.z
mul r2.xyz, r3.xyzx, r11.xyzx
mad r2.xyz, r12.xyzx, r4.xyzx, r2.xyzx
mul r5.xyz, r10.xyzx, l(0.960000, 0.960000, 0.960000, 0.000000)
...
mad r0.xyw, r11.xyxz, r3.xyxz, r0.xyxw
...
ret 
// Approximately 1178 instruction slots used
