...
if_nz r2.w
  ...
  if_nz r2.w
    ...
    mad r17.yzw, r2.wwww, r17.yyzw, r20.xxyz
    ...
    mad r19.xyz, r2.wwww, r21.xyzx, r19.xyzx
    ...
    sample_l_indexable(texture2d)(float,float,float,float) r3.y, r19.xyxx, t28.yxzw, s1, r2.w
    mad r22.xyz, r20.xywx, l(0.031250, 0.031250, 0.031250, 0.000000), r19.xyzx
    sample_l_indexable(texture2d)(float,float,float,float) r3.z, r22.xyxx, t28.yzxw, s1, r2.w
    min r3.y, |r3.y|, |r3.z|
    mul r3.y, r22.z, r3.y
    ...
    mul r4.w, r22.z, r4.w
    lt r4.w, r4.w, l(1.000000)
    iadd r6.w, r3.y, l(0x40000000)
    movc r3.y, r4.w, r6.w, r3.y
    sample_l_indexable(texture2d)(float,float,float,float) r2.w, r14.zwzz, t28.yzwx, s1, r2.w
    min r2.w, |r3.z|, |r2.w|
    mul r2.w, r17.w, r2.w
    lt r2.w, r2.w, l(1.000000)
    iadd r3.z, r3.y, l(0x80000000)
    ...
    loop 
      ...
      mad r17.yzw, r20.xxyw, r10.zzzz, r19.xxyz
      sample_l_indexable(texture2d)(float,float,float,float) r10.z, r17.yzyy, t28.yzxw, s1, l(0.000000)
      mul r10.w, r17.w, |r10.z|
      ...
      if_nz r10.w
        if_nz r22.z
          ...
          movc r14.zw, r10.wwww, r17.yyyz, r3.yyyz
          mov r22.z, r17.w
          mov r24.x, r7.w
      ...
      loop 
        ...
        mad r25.xyz, r21.xyzx, r21.wwww, r17.yzwy
        ...
        if_nz r24.w
          lt r24.w, r3.w, |r21.w|
          add r25.w, -r16.y, r25.z
          add r26.x, -r16.z, |r21.w|
          mul r26.y, r16.y, r25.z
          mul r26.x, r26.y, |r26.x|
          lt r25.w, r26.x, |r25.w|
          and r26.x, r24.w, r25.w
          lt r26.y, r15.w, r25.z
          ...
          movc r25.w, r26.x, l(1.000000), r9.w
          movc r24.w, r24.w, r25.z, r15.w
  ...
  mul r2.w, r2.w, r3.w
  mul r2.w, r19.y, r2.w
  mad r10.yz, r3.yyzy, l(0.000000, 2.000000, 2.000000, 0.000000), l(0.000000, -1.000000, -1.000000, 0.000000)
  add r10.yz, |r10.yyzy|, l(0.000000, -0.500000, -0.500000, 0.000000)
  add_sat r10.yz, r10.yyzy, r10.yyzy
  mad r14.zw, r10.yyyz, l(0.000000, 0.000000, -2.000000, -2.000000), l(0.000000, 0.000000, 3.000000, 3.000000)
  mul r10.yz, r10.yyzy, r10.yyzy
  mad r10.yz, -r14.zzwz, r10.yyzy, l(0.000000, 1.000000, 1.000000, 0.000000)
  mul r3.w, r10.z, r10.y
  mul r2.w, r2.w, r3.w
  ...
  if_nz r4.w
    sample_l_indexable(texture2d)(float,float,float,float) r10.yz, r3.yzyy, t22.zxyw, s4, l(0.000000)
    add r14.zw, |r10.yyyz|, l(0.000000, 0.000000, -0.500000, -0.500000)
    ...
    movc r10.yz, r10.yyzy, r14.zzwz, -r14.zzwz
    mad r3.yz, -r10.yyzy, cb1[44].zzwz, r3.yyzy
    sample_l_indexable(texture2d)(float,float,float,float) r10.yzw, r3.yzyy, t21.wxyz, s4, l(0.000000)
...
mad r4.w, r3.y, l(5.000000), l(-2.500000)
mul r4.w, r4.w, l(0.400000)
max r4.w, r4.w, l(0.000000)
mul r4.w, r4.w, l(100.000000)
mad r14.zw, -r3.yyyy, l(0.000000, 0.000000, 10.000000, 5.000000), l(0.000000, 0.000000, 6.857410, 7.085000)
exp r6.w, r14.z
mul r6.w, r2.x, r6.w
mul r6.w, r6.w, l(9.136810)
mul r7.w, r3.y, r3.z
mad r7.w, -r7.w, l(2.015905), r14.w
exp r7.w, r7.w
mul r7.w, r2.x, r7.w
...
loop 
  ...
  ieq r15.w, r0.z, r14.z
  bfi r16.y, r8.w, l(0), l(0), r14.w
  movc r14.w, r15.w, r16.y, r14.w
  ieq r15.w, r9.w, r14.z
  ubfe r16.y, r13.w, l(0), r14.w
  movc r14.w, r15.w, r16.y, r14.w
  ...
  loop 
    ...
    iadd r16.y, r14.z, r16.y
    imul null, r16.y, r16.y, l(14)
    add r17.yzw, r11.xxyz, -cb10[r16.y + 0].xxyz
    and r16.z, l(0x0000ffff), cb10[r16.y + 7].z
    ubfe r16.w, l(6), l(25), cb10[r16.y + 7].z
    imul null, r19.w, r16.z, l(6)
    dp3 r20.w, cb11[r19.w + 0].xyzx, r17.yzwy
    add_sat r20.w, r20.w, cb11[r19.w + 0].w
    dp3 r21.z, cb11[r19.w + 1].xyzx, r17.yzwy
    add_sat r21.z, r21.z, cb11[r19.w + 1].w
    mul r20.w, r20.w, r21.z
    dp3 r21.z, cb11[r19.w + 2].xyzx, r17.yzwy
    add_sat r21.z, r21.z, cb11[r19.w + 2].w
    mul r20.w, r20.w, r21.z
    dp3 r21.z, cb11[r19.w + 3].xyzx, r17.yzwy
    add_sat r21.z, r21.z, cb11[r19.w + 3].w
    mul r20.w, r20.w, r21.z
    dp3 r21.z, cb11[r19.w + 4].xyzx, r17.yzwy
    add_sat r21.z, r21.z, cb11[r19.w + 4].w
    mul r20.w, r20.w, r21.z
    dp3 r21.z, cb11[r19.w + 5].xyzx, r17.yzwy
    add_sat r19.w, r21.z, cb11[r19.w + 5].w
    mul r19.x, r19.w, r20.w
    and r19.w, l(1), cb10[r16.y + 6].x
    movc r19.xw, r19.wwww, r19.xxxy, r19.zzzx
    mov r20.w, cb10[r16.y + 6].x
    mov r28.xy, r19.xwxx
    mov r21.z, l(1)
    loop 
      ige r21.w, r21.z, r16.w
      breakc_nz r21.w
      iadd r21.w, r16.z, r21.z
      imul null, r21.w, r21.w, l(6)
      dp3 r22.w, cb11[r21.w + 0].xyzx, r17.yzwy
      add_sat r22.w, r22.w, cb11[r21.w + 0].w
      mul r22.w, r22.w, r28.x
      dp3 r23.w, cb11[r21.w + 1].xyzx, r17.yzwy
      add_sat r23.w, r23.w, cb11[r21.w + 1].w
      mul r22.w, r22.w, r23.w
      dp3 r23.w, cb11[r21.w + 2].xyzx, r17.yzwy
      add_sat r23.w, r23.w, cb11[r21.w + 2].w
      mul r22.w, r22.w, r23.w
      dp3 r23.w, cb11[r21.w + 3].xyzx, r17.yzwy
      add_sat r23.w, r23.w, cb11[r21.w + 3].w
      mul r22.w, r22.w, r23.w
      dp3 r23.w, cb11[r21.w + 4].xyzx, r17.yzwy
      add_sat r23.w, r23.w, cb11[r21.w + 4].w
      mul r22.w, r22.w, r23.w
      dp3 r23.w, cb11[r21.w + 5].xyzx, r17.yzwy
      add_sat r21.w, r23.w, cb11[r21.w + 5].w
      mul r28.x, r21.w, r22.w
      ushr r23.w, r20.w, l(2)
      ubfe r28.z, l(1), l(2), r20.w
      and r28.w, r23.w, l(2)
      max r29.x, r28.x, r28.y
      mad r21.w, -r22.w, r21.w, l(1.000000)
      mul r21.w, r21.w, r28.y
      movc r21.y, r28.w, r21.w, r29.x
    ...
    if_nz r16.w
      mad r27.z, r28.y, cb10[r16.y + 6].y, r27.z
      mul r16.z, r16.z, cb10[r16.y + 7].y
      mov r29.x, cb10[r16.y + 7].w
      mov r29.yz, cb10[r16.y + 8].xxyx
      dp3 r16.w, r18.xyzx, r29.xyzx
      dp3 r19.x, r17.yzwy, r29.xyzx
      add r19.x, r19.x, -cb10[r16.y + 8].z
      ge r19.w, r19.x, l(0.000000)
      max r19.x, r4.w, |r19.x|
      ...
      add r19.w, r19.w, -cb10[r16.y + 9].z
      ...
      dp3 r19.x, r18.xyzx, r29.xyzx
      dp3 r19.w, r17.yzwy, r29.xyzx
      add r19.w, r19.w, -cb10[r16.y + 11].z
      ge r20.w, r19.w, l(0.000000)
      max r19.w, r4.w, |r19.w|
      movc r19.w, r20.w, r19.w, -r19.w
      max r19.x, -r19.x, l(0.00000010)
      ...
      dp3 r19.x, r18.xyzx, r29.xyzx
      dp3 r19.w, r17.yzwy, r29.xyzx
      add r19.w, r19.w, -cb10[r16.y + 12].z
      ge r20.w, r19.w, l(0.000000)
      max r19.w, r4.w, |r19.w|
      movc r19.w, r20.w, r19.w, -r19.w
      max r19.x, -r19.x, l(0.00000010)
      ...
      dp3 r19.x, r18.xyzx, r29.xyzx
      dp3 r19.w, r17.yzwy, r29.xyzx
      add r19.w, r19.w, -cb10[r16.y + 13].z
      ge r20.w, r19.w, l(0.000000)
      max r19.w, r4.w, |r19.w|
      movc r19.w, r20.w, r19.w, -r19.w
      max r19.x, -r19.x, l(0.00000010)
      div r19.x, r19.w, r19.x
      min r16.w, r16.w, |r19.x|
      add r29.x, r17.y, cb10[r16.y + 3].w
      add r29.yz, r17.zzwz, cb10[r16.y + 4].xxyx
      mad r21.yzw, r18.xxyz, r16.wwww, r29.xxyz
      dp3 r19.x, r21.yzwy, r21.yzwy
      sqrt r19.x, r19.x
      div r16.w, r16.w, r19.x
      add r16.w, r16.w, r16.w
      sqrt r16.w, r16.w
      mad r16.w, r3.y, l(5.000000), r16.w
      ...
      ubfe r19.x, l(9), l(16), cb10[r16.y + 7].z
      utof r30.w, r19.x
      sample_l_indexable(texturecubearray)(float,float,float,float) r21.yzw, r30.xyzw, t8.wxyz, s2, r16.w
      dp3 r33.x, r17.yzwy, r29.xyzx
      dp3 r33.y, r17.yzwy, r31.xyzx
      dp3 r33.z, r17.yzwy, r32.xyzx
      mad_sat r17.yzw, r33.xxyz, cb10[r16.y + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
      mul r33.xy, r17.yzyy, cb10[r16.y + 4].zwzz
      mul r33.z, r17.w, cb10[r16.y + 5].x
      add r17.yzw, r33.xxyz, cb10[r16.y + 5].yyzw
      ...
      mul r17.yzw, r16.zzzz, r21.yyzw
      dp3 r16.z, r17.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r16.y, r6.w, r16.y, r16.z
      div r16.y, r16.w, r16.y
      mov r29.x, r26.w
      mov r29.yz, r27.xxyx
      mad r27.xyw, r17.zwzy, r16.yyyy, r29.yzyx
      mov r26.w, r27.w
    endif 
  endloop 
...
if_nz r9.w
  ...
  mov r13.w, l(0)
  loop 
    uge r14.z, r13.w, r7.w
    breakc_nz r14.z
    ushr r14.z, r13.w, l(5)
    iadd r14.z, r0.y, r14.z
    ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r14.z, r14.z, l(0), t26.xxxx
    ieq r14.w, r0.z, r13.w
    ubfe r15.w, r8.w, l(0), r14.z
    movc r14.z, r14.w, r15.w, r14.z
    ...
    loop 
      ...
      loop 
        ...
        mov r19.x, r28.w
      endloop 
      add_sat r19.x, -r14.w, r30.y
      mul r20.w, r19.x, cb10[r19.w + 6].y
      lt r21.y, l(0.000000), r20.w
      if_nz r21.y
        mad r27.w, r19.x, cb10[r19.w + 6].y, r27.w
        ...
        sqrt r20.w, r20.w
        mad r20.w, r3.y, l(5.000000), r20.w
...
if_nz r0.z
  ...
  dp3 r3.y, r19.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
  mad r16.yzw, r24.xxyz, r0.yyyy, r19.xxyz
  mov r18.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r19.xyz, r18.xyzw, t8.xyzw, s2, r3.z
  mad r0.y, cb2[19].x, r0.z, -r3.y
  mad r0.y, r2.y, r0.y, r3.y
...
mul r0.y, r3.w, r0.y
mul r3.yzw, r2.zzzz, r16.yyzw
and r16.yzw, r3.yyzw, r3.xxxx
    ...
    if_nz r14.w
      ...
      if_nz r14.w
        ...
        if_nz r14.w
          ...
          mad r34.xyz, r8.wwww, r20.xyzx, r10.yzwy
          ...
          movc r10.yzw, r9.wwww, r34.xxyz, r10.yyzw
    ...
    if_nz r13.w
      ...
      if_nz r13.w
        ...
        if_nz r14.z
          ...
          mad r23.xyz, r6.wwww, r33.xyzx, r10.yzwy
          ...
          movc r10.yzw, r8.wwww, r23.xxyz, r10.yyzw
...
mad r2.xyz, r10.yzwy, r4.xyzx, r2.xyzx
