...
uge r0.y, r15.y, r14.z
ult r14.w, r15.y, cb2[0].y
and r0.y, r0.y, r14.w
if_nz r0.y
  ...
  if_nz r15.w
    if_nz r3.z
      ...
      store_structured u2.x, cb2[52].x, l(896), r14.w
    endif 
    mul r15.w, r14.w, cb10[r0.y + 7].y
    ...
    mad r18.xyz, r16.xyzx, r17.wwww, r18.xyzx
    ...
    utof r20.w, r18.x
    sample_l_indexable(texturecubearray)(float,float,float,float) r18.xyz, r20.xyzw, t8.xyzw, s2, r17.w
...
ult r14.z, r15.y, r14.z
if_nz r14.z
  imul null, r14.z, r15.y, l(14)
  if_nz r3.z
    and r15.y, r0.y, l(1)
    imad r15.y, r15.y, l(20), l(880)
    add r19.yzw, cb1[24].xxyz, cb10[r14.z + 0].xxyz
    mov r19.x, l(16)
    store_structured u2.xyzw, cb2[52].x, r15.y, r19.xyzw
  endif 
  iadd r15.y, r0.y, l(1)
  add r19.xyz, r5.xyzx, -cb10[r14.z + 0].xyzx
  and r15.w, l(0x0000ffff), cb10[r14.z + 7].z
  ...
  mov r18.w, cb10[r14.z + 6].x
  mov r22.xy, r20.xyxx
  mov r19.w, l(1)
  loop 
    ige r20.z, r19.w, r17.w
    breakc_nz r20.z
    iadd r20.z, r15.w, r19.w
    ...
    mov r18.w, r21.z
  endloop 
  add_sat r15.w, -r14.w, r22.y
  mul r17.w, r15.w, cb10[r14.z + 6].y
  ...
  if_nz r18.w
    ...
    iadd r15.y, r0.y, l(257)
    mad r15.w, r15.w, cb10[r14.z + 6].y, r14.w
    mul r17.w, r17.w, cb10[r14.z + 7].y
    mov r20.x, cb10[r14.z + 7].w
    mov r20.yz, cb10[r14.z + 8].xxyx
    dp3 r18.w, r16.xyzx, r20.xyzx
    dp3 r19.w, r19.xyzx, r20.xyzx
    add r19.w, r19.w, -cb10[r14.z + 8].z
    ...
    mov r20.x, cb10[r14.z + 8].w
    mov r20.yz, cb10[r14.z + 9].xxyx
    dp3 r19.w, r16.xyzx, r20.xyzx
    dp3 r20.x, r19.xyzx, r20.xyzx
    add r20.x, r20.x, -cb10[r14.z + 9].z
    ge r20.y, r20.x, l(0.000000)
    max r20.x, r13.w, |r20.x|
    movc r20.x, r20.y, r20.x, -r20.x
    max r19.w, -r19.w, l(0.00000010)
    div r19.w, r20.x, r19.w
    min r18.w, r18.w, |r19.w|
    mov r20.x, cb10[r14.z + 9].w
    mov r20.yz, cb10[r14.z + 10].xxyx
    dp3 r19.w, r16.xyzx, r20.xyzx
    dp3 r20.x, r19.xyzx, r20.xyzx
    add r20.x, r20.x, -cb10[r14.z + 10].z
    ge r20.y, r20.x, l(0.000000)
    max r20.x, r13.w, |r20.x|
    movc r20.x, r20.y, r20.x, -r20.x
    max r19.w, -r19.w, l(0.00000010)
    div r19.w, r20.x, r19.w
    min r18.w, r18.w, |r19.w|
    mov r20.x, cb10[r14.z + 10].w
    mov r20.yz, cb10[r14.z + 11].xxyx
    dp3 r19.w, r16.xyzx, r20.xyzx
    dp3 r20.x, r19.xyzx, r20.xyzx
    add r20.x, r20.x, -cb10[r14.z + 11].z
    ge r20.y, r20.x, l(0.000000)
    max r20.x, r13.w, |r20.x|
    movc r20.x, r20.y, r20.x, -r20.x
    max r19.w, -r19.w, l(0.00000010)
    div r19.w, r20.x, r19.w
    min r18.w, r18.w, |r19.w|
    mov r20.x, cb10[r14.z + 11].w
    mov r20.yz, cb10[r14.z + 12].xxyx
    dp3 r19.w, r16.xyzx, r20.xyzx
    dp3 r20.x, r19.xyzx, r20.xyzx
    add r20.x, r20.x, -cb10[r14.z + 12].z
    ge r20.y, r20.x, l(0.000000)
    max r20.x, r13.w, |r20.x|
    movc r20.x, r20.y, r20.x, -r20.x
    max r19.w, -r19.w, l(0.00000010)
    div r19.w, r20.x, r19.w
    min r18.w, r18.w, |r19.w|
    mov r20.x, cb10[r14.z + 12].w
    mov r20.yz, cb10[r14.z + 13].xxyx
    dp3 r19.w, r16.xyzx, r20.xyzx
    dp3 r20.x, r19.xyzx, r20.xyzx
    add r20.x, r20.x, -cb10[r14.z + 13].z
    ge r20.y, r20.x, l(0.000000)
    max r13.w, r13.w, |r20.x|
    movc r13.w, r20.y, r13.w, -r13.w
    max r19.w, -r19.w, l(0.00000010)
    div r13.w, r13.w, r19.w
    min r13.w, |r13.w|, r18.w
    add r20.x, r19.x, cb10[r14.z + 3].w
    add r20.yz, r19.yyzy, cb10[r14.z + 4].xxyx
    ...
    sqrt r13.w, r13.w
    mad r9.w, r9.w, l(5.000000), r13.w
    add r9.w, r9.w, l(-0.844800)
    mov r21.x, cb10[r14.z + 0].w
    mov r21.y, cb10[r14.z + 1].z
    mov r21.z, cb10[r14.z + 2].y
    dp3 r22.x, r20.xyzx, r21.xyzx
    mov r23.xy, cb10[r14.z + 1].xwxx
    mov r23.z, cb10[r14.z + 2].z
    dp3 r22.y, r20.xyzx, r23.xyzx
    mov r24.x, cb10[r14.z + 1].y
    mov r24.yz, cb10[r14.z + 2].xxwx
    dp3 r22.z, r20.xyzx, r24.xyzx
    ubfe r13.w, l(9), l(16), cb10[r14.z + 7].z
    utof r22.w, r13.w
    sample_l_indexable(texturecubearray)(float,float,float,float) r20.xyz, r22.xyzw, t8.xyzw, s2, r9.w
    and r25.xyz, r20.xyzx, l(0x7fffffff, 0x7fffffff, 0x7fffffff, 0)
    ieq r25.xyz, r25.xyzx, l(0x7f800000, 0x7f800000, 0x7f800000, 0)
    or r9.w, r25.y, r25.x
    or r9.w, r25.z, r9.w
    movc r20.xyz, r9.wwww, l(1.000000,1.000000,0,0), r20.xyzx
    dp3 r25.x, r19.xyzx, r21.xyzx
    dp3 r25.y, r19.xyzx, r23.xyzx
    dp3 r25.z, r19.xyzx, r24.xyzx
    mad_sat r19.xyz, r25.xyzx, cb10[r14.z + 3].xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
    mul r25.xy, r19.xyxx, cb10[r14.z + 4].zwzz
    mul r25.z, r19.z, cb10[r14.z + 5].x
    add r19.xyz, r25.xyzx, cb10[r14.z + 5].yzwy
    ...
    or r9.w, r22.y, r22.x
    or r9.w, r22.z, r9.w
    movc r21.xyz, r9.wwww, l(1.000000,1.000000,0,0), r21.xyzx
    mul r22.xyz, r19.xyzx, r21.xyzx
    dp3 r9.w, r22.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
    mad r17.xyz, r19.xyzx, r21.xyzx, r17.xyzx
    mul r13.w, r9.w, r14.y
    mul r19.xyz, r17.wwww, r20.xyzx
    dp3 r14.z, r19.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
    mad r9.w, r14.y, r9.w, r14.z
    div r9.w, r13.w, r9.w
...
ge r9.w, r14.w, l(1.000000)
bfi r0.y, l(8), l(0), r15.y, r0.y
movc r0.y, r9.w, r0.y, r15.y
max r9.w, r15.w, l(1.000000)
rcp r9.w, r9.w
mov_sat r15.w, r15.w
mul r14.yzw, r9.wwww, r17.xxyz
mul r18.xyz, r9.wwww, r18.xyzx
lt r13.w, r15.w, l(0.990000)
if_nz r13.w
  ...
  mad r14.yzw, r17.xxyz, r9.wwww, r19.xxyz
  mov r16.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r17.xyz, r16.xyzw, t8.xyzw, s2, r12.w
...
if_nz r11.w
  ...
  if_nz r11.w
    ...
    mad r23.yzw, r4.zzzz, r21.xxyz, r18.xxyz
    ...
    mov r22.w, r19.z
    mov r17.w, r21.z
    movc r17.xyzw, r6.wwww, r22.xyzw, r17.xyzw
    mov r19.zw, r14.yyyz
    mov r21.zw, r20.xxxy
    movc r21.xyzw, r6.wwww, r19.xyzw, r21.xyzw
    mov r23.x, r14.w
    mov r18.w, r20.z
    movc r18.xyzw, r6.wwww, r23.yzwx, r18.xyzw
    if_nz r3.z
