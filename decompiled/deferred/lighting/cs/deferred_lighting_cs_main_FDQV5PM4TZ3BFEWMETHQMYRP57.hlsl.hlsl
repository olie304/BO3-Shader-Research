// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:23:20 2021
...
r0.y = samp0[]..swiz;
  ...
  r0.y = (uint)r0.y >> 24;
  r13.w = cmp((uint)r0.y >= (uint)r10.w);
  r14.y = cmp((uint)r0.y < numRefProbes);
  r13.w = r13.w ? r14.y : 0;
  if (r13.w != 0) {
    r13.w = (int)r0.y * 14;
    if (r2.w != 0) {
      r17.yzw = refProbeConstantsCB[r13.w].data[0].xyz + eyeOffset.xyz;
      r17.x = 16;
      GBufferDiffuseColor[viewID].880 = u2.xyzw;
    }
    r14.yzw = -refProbeConstantsCB[r13.w].data[0].xyz + r11.xyz;
    r15.y = 0x0000ffff & (int)refProbeConstantsCB[r13.w].data[7].z;
    if (6 == 0) r15.z = 0; else if (6+25 < 32) {     r15.z = (uint)refProbeConstantsCB[r13.w].data[7].z << (32-(6 + 25)); r15.z = (uint)r15.z >> (32-6);    } else r15.z = (uint)refProbeConstantsCB[r13.w].data[7].z >> 25;
    r15.w = (int)r15.y * 6;
    r17.x = dot(refProbeAttenuationConstantsCB[r15.w].data[0].xyz, r14.yzw);
    r17.x = saturate(refProbeAttenuationConstantsCB[r15.w].data[0].w + r17.x);
    r17.y = dot(refProbeAttenuationConstantsCB[r15.w].data[1].xyz, r14.yzw);
    r17.y = saturate(refProbeAttenuationConstantsCB[r15.w].data[1].w + r17.y);
    r17.x = r17.x * r17.y;
    r17.y = dot(refProbeAttenuationConstantsCB[r15.w].data[2].xyz, r14.yzw);
    r17.y = saturate(refProbeAttenuationConstantsCB[r15.w].data[2].w + r17.y);
    r17.x = r17.x * r17.y;
    r17.y = dot(refProbeAttenuationConstantsCB[r15.w].data[3].xyz, r14.yzw);
    r17.y = saturate(refProbeAttenuationConstantsCB[r15.w].data[3].w + r17.y);
    r17.x = r17.x * r17.y;
    r17.y = dot(refProbeAttenuationConstantsCB[r15.w].data[4].xyz, r14.yzw);
    r17.y = saturate(refProbeAttenuationConstantsCB[r15.w].data[4].w + r17.y);
    r17.x = r17.x * r17.y;
    r17.y = dot(refProbeAttenuationConstantsCB[r15.w].data[5].xyz, r14.yzw);
    r15.w = saturate(refProbeAttenuationConstantsCB[r15.w].data[5].w + r17.y);
    r17.x = r17.x * r15.w;
    ...
    r17.z = 1;
    while (true) {
      r17.w = cmp((int)r17.z >= (int)r15.z);
      if (r17.w != 0) break;
      r17.w = (int)r15.y + (int)r17.z;
      r17.w = (int)r17.w * 6;
    ...
    r15.y = refProbeConstantsCB[r13.w].data[6].y * r19.y;
    r15.z = cmp(0 < r15.y);
    if (r15.z != 0) {
      if (r2.w != 0) {
      // Known bad code for instruction (needs manual fix):
      ...
      r15.z = refProbeConstantsCB[r13.w].data[7].y * r15.y;
      r17.x = refProbeConstantsCB[r13.w].data[7].w;
      r17.yz = refProbeConstantsCB[r13.w].data[8].xy;
      r15.w = dot(r16.xyz, r17.xyz);
      r17.x = dot(r14.yzw, r17.xyz);
      ...
      r17.x = dot(r14.yzw, r17.xyz);
      r17.x = -refProbeConstantsCB[r13.w].data[9].z + r17.x;
      r17.y = cmp(r17.x >= 0);
      r17.x = max(abs(r17.x), r8.w);
      r17.x = r17.y ? r17.x : -r17.x;
      ...
      r17.w = dot(r16.xyz, r17.xyz);
      r17.x = dot(r14.yzw, r17.xyz);
      r17.x = -refProbeConstantsCB[r13.w].data[10].z + r17.x;
      r17.y = cmp(r17.x >= 0);
      r17.x = max(abs(r17.x), r8.w);
      r17.x = r17.y ? r17.x : -r17.x;
      r17.y = max(1.00000001e-07, -r17.w);
      ...
      r17.w = dot(r16.xyz, r17.xyz);
      r17.x = dot(r14.yzw, r17.xyz);
      r17.x = -refProbeConstantsCB[r13.w].data[11].z + r17.x;
      r17.y = cmp(r17.x >= 0);
      r17.x = max(abs(r17.x), r8.w);
      r17.x = r17.y ? r17.x : -r17.x;
      r17.y = max(1.00000001e-07, -r17.w);
      ...
      r17.w = dot(r16.xyz, r17.xyz);
      r17.x = dot(r14.yzw, r17.xyz);
      r17.x = -refProbeConstantsCB[r13.w].data[12].z + r17.x;
      r17.y = cmp(r17.x >= 0);
      r17.x = max(abs(r17.x), r8.w);
      r17.x = r17.y ? r17.x : -r17.x;
      r17.y = max(1.00000001e-07, -r17.w);
      ...
      r17.w = dot(r16.xyz, r17.xyz);
      r17.x = dot(r14.yzw, r17.xyz);
      r17.x = -refProbeConstantsCB[r13.w].data[13].z + r17.x;
      r17.y = cmp(r17.x >= 0);
      r17.x = max(abs(r17.x), r8.w);
      r17.x = r17.y ? r17.x : -r17.x;
      r17.y = max(1.00000001e-07, -r17.w);
      r17.x = r17.x / r17.y;
      r15.w = min(abs(r17.x), r15.w);
      r17.x = refProbeConstantsCB[r13.w].data[3].w + r14.y;
      r17.yz = refProbeConstantsCB[r13.w].data[4].xy + r14.zw;
      r17.xyz = r16.xyz * r15.www + r17.xyz;
      ...
      r19.w = (uint)r17.x;
      r17.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r19.xyzw, r15.w).xyz;
      r22.xyz = (int3)r17.xyz & int3(-2147483648,-2147483648,-2147483648);
      r22.xyz = cmp((int3)r22.xyz == int3(2139095040,2139095040,2139095040));
      r15.w = (int)r22.y | (int)r22.x;
      r15.w = (int)r22.z | (int)r15.w;
      r17.xyz = r15.www ? float3(1,1,0) : r17.xyz;
      r22.x = dot(r14.yzw, r18.xyz);
      r22.y = dot(r14.yzw, r20.xyz);
      r22.z = dot(r14.yzw, r21.xyz);
      r14.yzw = saturate(r22.xyz * refProbeConstantsCB[r13.w].data[3].xyz + float3(0.5,0.5,0.5));
      r22.xy = refProbeConstantsCB[r13.w].data[4].zw * r14.yz;
      r22.z = refProbeConstantsCB[r13.w].data[5].x * r14.w;
      r14.yzw = refProbeConstantsCB[r13.w].data[5].yzw + r22.xyz;
      ...
      r21.xyz = r21.xyz * r15.zzz;
      r22.z = r18.y ? 0 : 0.5;
      r22.xy = float2(0,0);
      r18.xyw = r22.xyz + r14.yzw;
      ...
      r14.yzw = r14.yzw * r21.zzz + r18.xyw;
      ...
      r13.w = (int)r19.y | (int)r19.x;
      r13.w = (int)r19.z | (int)r13.w;
      r18.xyz = r13.www ? float3(1,1,0) : r18.xyz;
      r14.yzw = r18.xyz * r14.yzw;
      r13.w = dot(r14.yzw, float3(0.212599993,0.715200007,0.0722000003));
      r15.w = r13.w * r9.w;
      r17.xyz = r17.xyz * r15.zzz;
      r15.z = dot(r17.xyz, float3(0.212599993,0.715200007,0.0722000003));
      r13.w = r9.w * r13.w + r15.z;
      r13.w = r15.w / r13.w;
  ...
  r10.w = cmp((uint)r0.y < (uint)r10.w);
  if (r10.w != 0) {
    r0.y = (int)r0.y * 14;
    if (r2.w != 0) {
      r10.w = (int)r13.w & 1;
    ...
    r15.z = 0x0000ffff & (int)refProbeConstantsCB[r0.y].data[7].z;
    ...
    r19.x = dot(refProbeAttenuationConstantsCB[r17.w].data[1].xyz, r18.xyz);
    r19.x = saturate(refProbeAttenuationConstantsCB[r17.w].data[1].w + r19.x);
    r18.w = r19.x * r18.w;
    r19.x = dot(refProbeAttenuationConstantsCB[r17.w].data[2].xyz, r18.xyz);
    r19.x = saturate(refProbeAttenuationConstantsCB[r17.w].data[2].w + r19.x);
    r18.w = r19.x * r18.w;
    r19.x = dot(refProbeAttenuationConstantsCB[r17.w].data[3].xyz, r18.xyz);
    r19.x = saturate(refProbeAttenuationConstantsCB[r17.w].data[3].w + r19.x);
    r18.w = r19.x * r18.w;
    r19.x = dot(refProbeAttenuationConstantsCB[r17.w].data[4].xyz, r18.xyz);
    r19.x = saturate(refProbeAttenuationConstantsCB[r17.w].data[4].w + r19.x);
    r18.w = r19.x * r18.w;
    r19.x = dot(refProbeAttenuationConstantsCB[r17.w].data[5].xyz, r18.xyz);
    r17.w = saturate(refProbeAttenuationConstantsCB[r17.w].data[5].w + r19.x);
    r19.x = r18.w * r17.w;
    r17.w = 1 & (int)refProbeConstantsCB[r0.y].data[6].x;
    r19.yz = float2(0,1);
    r19.xy = r17.ww ? r19.xy : r19.zx;
    r20.x = 1;
    r17.w = refProbeConstantsCB[r0.y].data[6].x;
    r21.xy = r19.xy;
    r18.w = 1;
    while (true) {
      r19.z = cmp((int)r18.w >= (int)r15.w);
      if (r19.z != 0) break;
      ...
      r21.x = r19.w * r19.z;
      r20.z = (uint)r17.w >> 2;
      if (1 == 0) r20.w = 0; else if (1+2 < 32) {       r20.w = (uint)r17.w << (32-(1 + 2)); r20.w = (uint)r20.w >> (32-1);      } else r20.w = (uint)r17.w >> 2;
      r21.z = (int)r20.z & 2;
    ...
    r15.z = saturate(r21.y + -r15.y);
    r15.w = refProbeConstantsCB[r0.y].data[6].y * r15.z;
    r17.w = cmp(0 < r15.w);
    if (r17.w != 0) {
      r17.w = (int)r10.w & 3;
      r18.w = (int)r17.w + -1;
      ...
      r18.w = r18.w ? r2.w : 0;
      if (r18.w != 0) {
        r19.xy = mad((int2)r17.ww, int2(20,20), int2(860,876));
      // Known bad code for instruction (needs manual fix):
      ...
      r10.w = (int)r13.w + 257;
      r15.z = r15.z * refProbeConstantsCB[r0.y].data[6].y + r15.y;
      r15.w = refProbeConstantsCB[r0.y].data[7].y * r15.w;
      ...
      r4.w = (int)r24.y | (int)r24.x;
      r4.w = (int)r24.z | (int)r4.w;
      r19.xyz = r4.www ? float3(1,1,0) : r19.xyz;
      ...
      r14.yzw = r18.xyz * r20.xyz + r14.yzw;
      r4.w = r9.w * r0.y;
  ...
  r0.y = cmp(r15.y >= 1);
  bitmask.w = ((~(-1 << 8)) << 0) & 0xffffffff;  r4.w = (((uint)r10.w << 0) & bitmask.w) | ((uint)r13.w & ~bitmask.w);
  r0.y = r0.y ? r4.w : r10.w;
  r4.w = max(1, r15.z);
  r4.w = rcp(r4.w);
  r15.z = saturate(r15.z);
  r18.xyz = r14.yzw * r4.www;
  ...
  if (r8.w != 0) {
    ...
    r18.xyz = r14.yzw * r4.www + r15.yzw;
    r16.w = 0;
    ...
    r4.w = r2.y * r4.w + r9.w;
    r17.xyz = r14.yzw * r4.www + r17.xyz;
  }
  r4.w = r2.x + r5.x;
  r4.w = log2(abs(r4.w));
  r4.w = r4.w * r2.z;
  ...
  r15.yzw = r17.xyz * r4.www;
  r17.xyz = r15.zwy * r14.yyy;
  ...
  if (r5.x != 0) {
    ...
    if (r5.x != 0) {
      ...
      r7.w = r7.w * r6.w;
      r3.z = cmp(0 < r3.z);
      r19.xyz = r7.www * r15.yzw + r18.xyz;
      ...
      r0.w = r5.x * r0.w;
      r0.w = r4.z * r0.w;
      r21.xyz = r0.www * r15.zwy + r17.xyz;
      r19.w = r21.z;
      r18.w = r17.z;
      r18.xyzw = r3.zzzz ? r19.xyzw : r18.xyzw;
      r21.zw = r20.xy;
      r17.zw = r14.yz;
      r19.xyzw = r3.zzzz ? r21.xyzw : r17.xyzw;
