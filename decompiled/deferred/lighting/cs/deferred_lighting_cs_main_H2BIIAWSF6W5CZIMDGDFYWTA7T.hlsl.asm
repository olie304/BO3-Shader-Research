...
uge r0.y, r15.y, r10.w
ult r12.w, r15.y, cb2[0].y
and r0.y, r0.y, r12.w
if_nz r0.y
  ...
  add r17.xyz, r5.xyzx, -cb10[r0.y + 0].xyzx
  ...
  if_nz r13.w
    ...
    sqrt r15.w, r15.w
    mad r15.w, r3.w, l(5.000000), r15.w
    ...
    dp3 r13.w, r18.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
    mad r0.y, r9.w, r0.y, r13.w
    div r0.y, r15.w, r0.y
...
ult r10.w, r15.y, r10.w
if_nz r10.w
  imul null, r10.w, r15.y, l(14)
  if_nz r6.w
    and r13.w, r0.y, l(1)
    imad r13.w, r13.w, l(20), l(880)
    add r19.yzw, cb1[24].xxyz, cb10[r10.w + 0].xxyz
    mov r19.x, l(16)
    store_structured u2.xyzw, cb2[52].x, r13.w, r19.xyzw
  endif 
  iadd r13.w, r0.y, l(1)
  add r19.xyz, r5.xyzx, -cb10[r10.w + 0].xyzx
  and r15.y, l(0x0000ffff), cb10[r10.w + 7].z
  ubfe r15.w, l(6), l(25), cb10[r10.w + 7].z
  imul null, r17.w, r15.y, l(6)
  dp3 r18.w, cb11[r17.w + 0].xyzx, r19.xyzx
  add_sat r18.w, r18.w, cb11[r17.w + 0].w
  dp3 r19.w, cb11[r17.w + 1].xyzx, r19.xyzx
  add_sat r19.w, r19.w, cb11[r17.w + 1].w
  mul r18.w, r18.w, r19.w
  dp3 r19.w, cb11[r17.w + 2].xyzx, r19.xyzx
  add_sat r19.w, r19.w, cb11[r17.w + 2].w
  mul r18.w, r18.w, r19.w
  dp3 r19.w, cb11[r17.w + 3].xyzx, r19.xyzx
  add_sat r19.w, r19.w, cb11[r17.w + 3].w
  mul r18.w, r18.w, r19.w
  dp3 r19.w, cb11[r17.w + 4].xyzx, r19.xyzx
  add_sat r19.w, r19.w, cb11[r17.w + 4].w
  mul r18.w, r18.w, r19.w
  dp3 r19.w, cb11[r17.w + 5].xyzx, r19.xyzx
  add_sat r17.w, r19.w, cb11[r17.w + 5].w
  mul r20.x, r17.w, r18.w
  and r17.w, l(1), cb10[r10.w + 6].x
  mov r20.yz, l(0,0,1.000000,0)
  movc r20.xy, r17.wwww, r20.xyxx, r20.zxzz
  mov r21.x, l(1.000000)
  mov r17.w, cb10[r10.w + 6].x
  mov r22.xy, r20.xyxx
  mov r18.w, l(1)
  loop 
    ...
    mul r22.x, r19.w, r20.z
    ushr r20.w, r17.w, l(2)
    ubfe r21.z, l(1), l(2), r17.w
    and r21.w, r20.w, l(2)
    max r22.z, r22.x, r22.y
    mad r19.w, -r20.z, r19.w, l(1.000000)
    mul r19.w, r19.w, r22.y
    movc r21.y, r21.w, r19.w, r22.z
    movc r22.xy, r21.zzzz, r22.xyxx, r21.xyxx
    iadd r18.w, r18.w, l(1)
    mov r17.w, r20.w
  endloop 
  add_sat r15.y, -r12.w, r22.y
  mul r15.w, r15.y, cb10[r10.w + 6].y
  ...
  if_nz r17.w
    ...
    if_nz r18.w
      imad r20.xy, r17.wwww, l(20, 20, 0, 0), l(860, 876, 0, 0)
      ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r17.w, cb2[52].x, r20.x, u2.xxxx
      or r17.w, r17.w, l(32)
      store_structured u2.x, cb2[52].x, r20.x, r17.w
      store_structured u2.x, cb2[52].x, r20.y, r15.w
    endif 
    iadd r13.w, r0.y, l(257)
    mad r15.y, r15.y, cb10[r10.w + 6].y, r12.w
    mul r15.w, r15.w, cb10[r10.w + 7].y
    mov r20.x, cb10[r10.w + 7].w
    mov r20.yz, cb10[r10.w + 8].xxyx
    dp3 r17.w, r16.xyzx, r20.xyzx
    dp3 r18.w, r19.xyzx, r20.xyzx
    add r18.w, r18.w, -cb10[r10.w + 8].z
    ...
    mov r20.x, cb10[r10.w + 8].w
    mov r20.yz, cb10[r10.w + 9].xxyx
    dp3 r18.w, r16.xyzx, r20.xyzx
    dp3 r19.w, r19.xyzx, r20.xyzx
    add r19.w, r19.w, -cb10[r10.w + 9].z
    ...
    mov r20.x, cb10[r10.w + 9].w
    mov r20.yz, cb10[r10.w + 10].xxyx
    dp3 r18.w, r16.xyzx, r20.xyzx
    dp3 r19.w, r19.xyzx, r20.xyzx
    add r19.w, r19.w, -cb10[r10.w + 10].z
    ge r20.x, r19.w, l(0.000000)
    max r19.w, r8.w, |r19.w|
    movc r19.w, r20.x, r19.w, -r19.w
    max r18.w, -r18.w, l(0.00000010)
    div r18.w, r19.w, r18.w
    min r17.w, r17.w, |r18.w|
    mov r20.x, cb10[r10.w + 10].w
    mov r20.yz, cb10[r10.w + 11].xxyx
    dp3 r18.w, r16.xyzx, r20.xyzx
    dp3 r19.w, r19.xyzx, r20.xyzx
    add r19.w, r19.w, -cb10[r10.w + 11].z
    ge r20.x, r19.w, l(0.000000)
    max r19.w, r8.w, |r19.w|
    movc r19.w, r20.x, r19.w, -r19.w
    max r18.w, -r18.w, l(0.00000010)
    div r18.w, r19.w, r18.w
    min r17.w, r17.w, |r18.w|
    mov r20.x, cb10[r10.w + 11].w
    mov r20.yz, cb10[r10.w + 12].xxyx
    dp3 r18.w, r16.xyzx, r20.xyzx
    dp3 r19.w, r19.xyzx, r20.xyzx
    add r19.w, r19.w, -cb10[r10.w + 12].z
    ge r20.x, r19.w, l(0.000000)
    max r19.w, r8.w, |r19.w|
    movc r19.w, r20.x, r19.w, -r19.w
    max r18.w, -r18.w, l(0.00000010)
    div r18.w, r19.w, r18.w
    min r17.w, r17.w, |r18.w|
    mov r20.x, cb10[r10.w + 12].w
    mov r20.yz, cb10[r10.w + 13].xxyx
    dp3 r18.w, r16.xyzx, r20.xyzx
    dp3 r19.w, r19.xyzx, r20.xyzx
    add r19.w, r19.w, -cb10[r10.w + 13].z
    ge r20.x, r19.w, l(0.000000)
    max r8.w, r8.w, |r19.w|
    movc r8.w, r20.x, r8.w, -r8.w
    max r18.w, -r18.w, l(0.00000010)
    div r8.w, r8.w, r18.w
    min r8.w, |r8.w|, r17.w
    add r20.x, r19.x, cb10[r10.w + 3].w
    add r20.yz, r19.yyzy, cb10[r10.w + 4].xxyx
    ...
    add r8.w, r8.w, r8.w
    sqrt r8.w, r8.w
    mad r3.w, r3.w, l(5.000000), r8.w
    add r3.w, r3.w, l(-0.844800)
    mov r21.x, cb10[r10.w + 0].w
    mov r21.y, cb10[r10.w + 1].z
    mov r21.z, cb10[r10.w + 2].y
    dp3 r22.x, r20.xyzx, r21.xyzx
    mov r23.xy, cb10[r10.w + 1].xwxx
    mov r23.z, cb10[r10.w + 2].z
    dp3 r22.y, r20.xyzx, r23.xyzx
    mov r24.x, cb10[r10.w + 1].y
    mov r24.yz, cb10[r10.w + 2].xxwx
    dp3 r22.z, r20.xyzx, r24.xyzx
    ubfe r8.w, l(9), l(16), cb10[r10.w + 7].z
    utof r22.w, r8.w
    sample_l_indexable(texturecubearray)(float,float,float,float) r20.xyz, r22.xyzw, t8.xyzw, s2, r3.w
    ...
    mad_sat r19.xyz, r25.xyzx, cb10[r10.w + 3].xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
    mul r25.xy, r19.xyxx, cb10[r10.w + 4].zwzz
    mul r25.z, r19.z, cb10[r10.w + 5].x
    add r19.xyz, r25.xyzx, cb10[r10.w + 5].yzwy
    ...
    or r3.w, r22.y, r22.x
    or r3.w, r22.z, r3.w
    movc r21.xyz, r3.wwww, l(1.000000,1.000000,0,0), r21.xyzx
    mul r22.xyz, r19.xyzx, r21.xyzx
    dp3 r3.w, r22.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
...
ge r3.w, r12.w, l(1.000000)
bfi r0.y, l(8), l(0), r13.w, r0.y
movc r0.y, r3.w, r0.y, r13.w
max r3.w, r15.y, l(1.000000)
rcp r3.w, r3.w
mov_sat r15.y, r15.y
mul r19.xyz, r3.wwww, r17.xyzx
mul r18.xyz, r3.wwww, r18.xyzx
lt r8.w, r15.y, l(0.990000)
if_nz r8.w
  iadd r0.y, r0.y, l(256)
  add r8.w, -r15.y, l(1.000000)
  ...
  dp3 r9.w, r20.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
  mad r19.xyz, r17.xyzx, r3.wwww, r20.xyzx
  mov r16.w, l(0)
  ...
  mad r18.xyz, r17.xyzx, r3.wwww, r18.xyzx
endif 
...
ret 
// Approximately 2054 instruction slots used
