...
if_nz r6.w
  ...
  add r12.xyz, r9.xyzx, -cb10[r6.w + 0].xyzx
...
if_nz r6.w
  ...
  if_nz r5.w
    ...
    imul null, r8.w, r5.w, l(6)
    dp3 r9.w, cb11[r8.w + 0].xyzx, r14.xyzx
    add_sat r9.w, r9.w, cb11[r8.w + 0].w
    dp3 r12.w, cb11[r8.w + 1].xyzx, r14.xyzx
    add_sat r12.w, r12.w, cb11[r8.w + 1].w
    mul r9.w, r9.w, r12.w
    dp3 r12.w, cb11[r8.w + 2].xyzx, r14.xyzx
    add_sat r12.w, r12.w, cb11[r8.w + 2].w
    mul r9.w, r9.w, r12.w
    dp3 r12.w, cb11[r8.w + 3].xyzx, r14.xyzx
    add_sat r12.w, r12.w, cb11[r8.w + 3].w
    mul r9.w, r9.w, r12.w
    dp3 r12.w, cb11[r8.w + 4].xyzx, r14.xyzx
    add_sat r12.w, r12.w, cb11[r8.w + 4].w
    mul r9.w, r9.w, r12.w
    dp3 r12.w, cb11[r8.w + 5].xyzx, r14.xyzx
    add_sat r8.w, r12.w, cb11[r8.w + 5].w
    mul r15.x, r8.w, r9.w
    and r8.w, l(1), cb10[r0.y + 6].x
    mov r15.yz, l(0,0,1.000000,0)
    movc r15.xy, r8.wwww, r15.xyxx, r15.zxzz
    ...
    loop 
      ...
      ushr r14.w, r8.w, l(2)
      ubfe r15.z, l(1), l(2), r8.w
      and r15.w, r14.w, l(2)
      max r16.z, r17.x, r17.y
      mad r12.w, -r13.w, r12.w, l(1.000000)
      mul r12.w, r12.w, r17.y
      movc r16.y, r15.w, r12.w, r16.z
      movc r17.xy, r15.zzzz, r17.xyxx, r16.xyxx
      iadd r9.w, r9.w, l(1)
      mov r8.w, r14.w
    endloop 
    add_sat r5.w, -r7.w, r17.y
    mul r6.w, r5.w, cb10[r0.y + 6].y
    lt r8.w, l(0.000000), r6.w
    if_nz r8.w
      mad r7.w, r5.w, cb10[r0.y + 6].y, r7.w
      mul r5.w, r6.w, cb10[r0.y + 7].y
