...
r0.y = samp0[]..swiz;
  ...
  while (true) {
    ...
    if (r15.w != 0) break;
    r15.w = r14.w ? r0.x : r15.y;
    r18.w = cmp((uint)r15.w >= (uint)r14.z);
    r19.w = cmp((uint)r15.w < numRefProbes);
    r18.w = r18.w ? r19.w : 0;
    if (r18.w != 0) {
      r15.w = (int)r15.w * 14;
      if (r3.z != 0) {
      ...
      r25.w = (int)r24.w + 1;
      r17.yzw = -refProbeConstantsCB[r15.w].data[0].xyz + r5.xyz;
      ...
      r26.x = dot(refProbeAttenuationConstantsCB[r21.w].data[1].xyz, r17.yzw);
      r26.x = saturate(refProbeAttenuationConstantsCB[r21.w].data[1].w + r26.x);
      r22.w = r26.x * r22.w;
      r26.x = dot(refProbeAttenuationConstantsCB[r21.w].data[2].xyz, r17.yzw);
      r26.x = saturate(refProbeAttenuationConstantsCB[r21.w].data[2].w + r26.x);
      r22.w = r26.x * r22.w;
      r26.x = dot(refProbeAttenuationConstantsCB[r21.w].data[3].xyz, r17.yzw);
      r26.x = saturate(refProbeAttenuationConstantsCB[r21.w].data[3].w + r26.x);
      r22.w = r26.x * r22.w;
      r26.x = dot(refProbeAttenuationConstantsCB[r21.w].data[4].xyz, r17.yzw);
      r26.x = saturate(refProbeAttenuationConstantsCB[r21.w].data[4].w + r26.x);
      r22.w = r26.x * r22.w;
      r26.x = dot(refProbeAttenuationConstantsCB[r21.w].data[5].xyz, r17.yzw);
      r21.w = saturate(refProbeAttenuationConstantsCB[r21.w].data[5].w + r26.x);
      r18.x = r22.w * r21.w;
      r21.w = 1 & (int)refProbeConstantsCB[r15.w].data[6].x;
      r26.xy = r21.ww ? r18.xy : r18.zx;
      ...
      while (true) {
        ...
        r22.w = -r26.z * r22.w + 1;
        r22.w = r27.y * r22.w;
        r20.y = r27.w ? r22.w : r28.x;
        r27.xy = r27.zz ? r27.xy : r20.xy;
        r21.w = (int)r21.w + 1;
        r18.x = r26.w;
      }
      ...
      if (r18.w != 0) {
        ...
        r24.w = (int)r24.w + 257;
        r24.z = r27.y * refProbeConstantsCB[r15.w].data[6].y + r24.z;
        ...
        r20.y = dot(r17.yzw, r26.xyz);
        r20.y = -refProbeConstantsCB[r15.w].data[9].z + r20.y;
        r21.w = cmp(r20.y >= 0);
        r20.y = max(abs(r20.y), r13.w);
        ...
        r19.w = r20.y / r19.w;
        r18.w = min(abs(r19.w), r18.w);
        r26.x = refProbeConstantsCB[r15.w].data[3].w + r17.y;
        r26.yz = refProbeConstantsCB[r15.w].data[4].xy + r17.zw;
        r26.xyz = r16.xyz * r18.www + r26.xyz;
        ...
        r29.w = (uint)r19.w;
        r26.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r29.xyzw, r18.w).xyz;
        r27.xzw = (int3)r26.xyz & int3(-2147483648,-2147483648,-2147483648);
        r27.xzw = cmp((int3)r27.xzw == int3(2139095040,2139095040,2139095040));
        r18.w = (int)r27.z | (int)r27.x;
        r18.w = (int)r27.w | (int)r18.w;
        r26.xyz = r18.www ? float3(1,1,0) : r26.xyz;
        r32.x = dot(r17.yzw, r28.xyz);
        r32.y = dot(r17.yzw, r30.xyz);
        r32.z = dot(r17.yzw, r31.xyz);
        r17.yzw = saturate(r32.xyz * refProbeConstantsCB[r15.w].data[3].xyz + float3(0.5,0.5,0.5));
        r32.xy = refProbeConstantsCB[r15.w].data[4].zw * r17.yz;
        r32.z = refProbeConstantsCB[r15.w].data[5].x * r17.w;
        r17.yzw = refProbeConstantsCB[r15.w].data[5].yzw + r32.xyz;
  ...
  while (true) {
    ...
    if (r18.w != 0) {
      ...
      while (true) {
        ...
        r22.w = -r25.w * r22.w + 1;
        r22.w = r28.y * r22.w;
        r20.w = r28.w ? r22.w : r29.x;
        r28.xy = r28.zz ? r28.xy : r20.zw;
        r21.w = (int)r21.w + 1;
        r18.x = r26.w;
      }
      r18.x = saturate(r28.y + -r24.z);
      r18.w = refProbeConstantsCB[r15.w].data[6].y * r18.x;
      r19.w = cmp(0 < r18.w);
      if (r19.w != 0) {
        r19.w = (int)r27.y & 31;
        r20.w = (int)r19.w + -1;
        ...
        r20.y = (int)r20.y + 257;
        r20.x = r18.x * refProbeConstantsCB[r15.w].data[6].y + r20.x;
        r18.x = refProbeConstantsCB[r15.w].data[7].y * r18.w;
        r29.x = refProbeConstantsCB[r15.w].data[7].w;
        r29.yz = refProbeConstantsCB[r15.w].data[8].xy;
        ...
        r18.w = r19.w / r18.w;
        r18.w = min(131072, abs(r18.w));
        r29.x = refProbeConstantsCB[r15.w].data[8].w;
        r29.yz = refProbeConstantsCB[r15.w].data[9].xy;
        r19.w = dot(r16.xyz, r29.xyz);
        r20.w = dot(r17.yzw, r29.xyz);
        r20.w = -refProbeConstantsCB[r15.w].data[9].z + r20.w;
        r21.w = cmp(r20.w >= 0);
        r20.w = max(abs(r20.w), r13.w);
        r20.w = r21.w ? r20.w : -r20.w;
        r19.w = max(1.00000001e-07, -r19.w);
        r19.w = r20.w / r19.w;
        r18.w = min(abs(r19.w), r18.w);
        r29.x = refProbeConstantsCB[r15.w].data[9].w;
        r29.yz = refProbeConstantsCB[r15.w].data[10].xy;
        r19.w = dot(r16.xyz, r29.xyz);
        r20.w = dot(r17.yzw, r29.xyz);
        r20.w = -refProbeConstantsCB[r15.w].data[10].z + r20.w;
        r21.w = cmp(r20.w >= 0);
        r20.w = max(abs(r20.w), r13.w);
        r20.w = r21.w ? r20.w : -r20.w;
        r19.w = max(1.00000001e-07, -r19.w);
        r19.w = r20.w / r19.w;
        r18.w = min(abs(r19.w), r18.w);
        r29.x = refProbeConstantsCB[r15.w].data[10].w;
        r29.yz = refProbeConstantsCB[r15.w].data[11].xy;
        r19.w = dot(r16.xyz, r29.xyz);
        r20.w = dot(r17.yzw, r29.xyz);
        r20.w = -refProbeConstantsCB[r15.w].data[11].z + r20.w;
        r21.w = cmp(r20.w >= 0);
        r20.w = max(abs(r20.w), r13.w);
        r20.w = r21.w ? r20.w : -r20.w;
        r19.w = max(1.00000001e-07, -r19.w);
        r19.w = r20.w / r19.w;
        r18.w = min(abs(r19.w), r18.w);
        r29.x = refProbeConstantsCB[r15.w].data[11].w;
        r29.yz = refProbeConstantsCB[r15.w].data[12].xy;
        r19.w = dot(r16.xyz, r29.xyz);
        r20.w = dot(r17.yzw, r29.xyz);
        r20.w = -refProbeConstantsCB[r15.w].data[12].z + r20.w;
        r21.w = cmp(r20.w >= 0);
        r20.w = max(abs(r20.w), r13.w);
        r20.w = r21.w ? r20.w : -r20.w;
        r19.w = max(1.00000001e-07, -r19.w);
        r19.w = r20.w / r19.w;
        r18.w = min(abs(r19.w), r18.w);
        r29.x = refProbeConstantsCB[r15.w].data[12].w;
        r29.yz = refProbeConstantsCB[r15.w].data[13].xy;
        r19.w = dot(r16.xyz, r29.xyz);
        r20.w = dot(r17.yzw, r29.xyz);
        r20.w = -refProbeConstantsCB[r15.w].data[13].z + r20.w;
        r21.w = cmp(r20.w >= 0);
        r20.w = max(abs(r20.w), r13.w);
        r20.w = r21.w ? r20.w : -r20.w;
        r19.w = max(1.00000001e-07, -r19.w);
        r19.w = r20.w / r19.w;
        r18.w = min(abs(r19.w), r18.w);
        r29.x = refProbeConstantsCB[r15.w].data[3].w + r17.y;
        r29.yz = refProbeConstantsCB[r15.w].data[4].xy + r17.zw;
        r28.xzw = r16.xyz * r18.www + r29.xyz;
        ...
        if (9 == 0) r19.w = 0; else if (9+16 < 32) {         r19.w = (uint)refProbeConstantsCB[r15.w].data[7].z << (32-(9 + 16)); r19.w = (uint)r19.w >> (32-9);        } else r19.w = (uint)refProbeConstantsCB[r15.w].data[7].z >> 16;
        r30.w = (uint)r19.w;
        r28.xzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r30.xyzw, r18.w).xyz;
        r33.xyz = (int3)r28.xzw & int3(-2147483648,-2147483648,-2147483648);
        r33.xyz = cmp((int3)r33.xyz == int3(2139095040,2139095040,2139095040));
        r18.w = (int)r33.y | (int)r33.x;
        r18.w = (int)r33.z | (int)r18.w;
        r28.xzw = r18.www ? float3(1,1,0) : r28.xzw;
        r33.x = dot(r17.yzw, r29.xyz);
        r33.y = dot(r17.yzw, r31.xyz);
        r33.z = dot(r17.yzw, r32.xyz);
        r17.yzw = saturate(r33.xyz * refProbeConstantsCB[r15.w].data[3].xyz + float3(0.5,0.5,0.5));
        r33.xy = refProbeConstantsCB[r15.w].data[4].zw * r17.yz;
        r33.z = refProbeConstantsCB[r15.w].data[5].x * r17.w;
        r17.yzw = refProbeConstantsCB[r15.w].data[5].yzw + r33.xyz;
        r30.x = dot(r11.xyz, r29.xyz);
        r30.y = dot(r11.xyz, r31.xyz);
        r30.z = dot(r11.xyz, r32.xyz);
        r29.xyz = cmp(float3(0,0,0) < r30.xyz);
        r19.z = r29.x ? 0 : 0.5;
        r31.xyz = r19.xyz + r17.yzw;
        ...
        r17.yzw = r22.xyz + r17.yzw;
        r17.yzw = gProbeZArray.SampleLevel(samplerLinearClamp_s, r17.yzw, 0).xyz;
        r17.yzw = r17.yzw * r32.zzz + r29.xyw;
  ...
  r0.x = cmp(r24.z >= 1);
  bitmask.w = ((~(-1 << 8)) << 0) & 0xffffffff;  r9.w = (((uint)r20.y << 0) & bitmask.w) | ((uint)r24.w & ~bitmask.w);
  r0.x = r0.x ? r9.w : r20.y;
  r9.w = max(1, r20.x);
  r9.w = rcp(r9.w);
  r20.x = saturate(r20.x);
  r14.yzw = r25.xyz * r9.www;
  r17.xyz = r26.xyz * r9.www;
  r13.w = cmp(r20.x < 0.99000001);
  if (r13.w != 0) {
    r0.x = (int)r0.x + 256;
    r13.w = 1 + -r20.x;
    ...
    r14.yzw = r25.xyz * r9.www + r18.xyz;
    r16.w = 0;
    r18.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r16.xyzw, r12.w).xyz;
    r9.w = sunConstants.globalProbeExposure * r13.w + -r11.w;
    r9.w = r2.y * r9.w + r11.w;
    r17.xyz = r18.xyz * r9.www + r17.xyz;
  }
  r9.w = r2.x + r4.z;
  r9.w = log2(abs(r9.w));
  r9.w = r9.w * r2.w;
  ...
  r18.xyz = r14.yzw * r4.zzz;
  r19.xyz = r3.www ? r18.yzx : 0;
  ...
  if (r11.w != 0) {
    ...
    if (r11.w != 0) {
      ...
      r4.z = r10.w * r4.z;
      r4.z = 0.25 * r4.z;
      r23.yzw = r4.zzz * r21.xyz + r17.xyz;
      ...
      r22.w = r19.z;
      r18.w = r21.z;
      r18.xyzw = r6.wwww ? r22.xyzw : r18.xyzw;
      r19.zw = r14.yz;
      r21.zw = r20.xy;
      r21.xyzw = r6.wwww ? r19.xyzw : r21.xyzw;
      r23.x = r14.w;
      r17.w = r20.z;
      r17.xyzw = r6.wwww ? r23.yzwx : r17.xyzw;
      if (r3.z != 0) {
      // Known bad code for instruction (needs manual fix):
