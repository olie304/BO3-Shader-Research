// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:23:08 2021
...
r0.y = samplerLinear[]..swiz;
  ...
  r21.xz = r3.yz * r2.zw;
  r21.w = r2.z * r2.w;
  r1.w = dot(r19.xyzw, r21.xyzw);
  r20.xyzw = r20.xyzw + -r10.yyyy;
  r2.z = min(abs(r20.z), abs(r20.w));
  r2.z = min(abs(r20.y), r2.z);
  r2.z = min(abs(r20.x), r2.z);
  r2.w = max(abs(r20.z), abs(r20.w));
  r2.w = max(abs(r20.y), r2.w);
  r2.w = max(abs(r20.x), r2.w);
  r3.yzw = cmp(r2.zzz == abs(r20.yzw));
  r2.z = r3.y ? r19.y : r19.x;
  r2.z = r3.z ? r19.z : r2.z;
  r2.z = r3.w ? r19.w : r2.z;
  ...
  r0.y = (uint)r0.y >> 24;
  r6.w = cmp((uint)r0.y >= (uint)r4.w);
  r7.w = cmp((uint)r0.y < numRefProbes);
  r6.w = r6.w ? r7.w : 0;
  if (r6.w != 0) {
    r6.w = (int)r0.y * 14;
    r10.yzw = -refProbeConstantsCB[r6.w].data[0].xyz + r11.xyz;
    ...
    r9.w = (int)r7.w * 6;
    r13.w = dot(refProbeAttenuationConstantsCB[r9.w].data[0].xyz, r10.yzw);
    r13.w = saturate(refProbeAttenuationConstantsCB[r9.w].data[0].w + r13.w);
    r14.z = dot(refProbeAttenuationConstantsCB[r9.w].data[1].xyz, r10.yzw);
    r14.z = saturate(refProbeAttenuationConstantsCB[r9.w].data[1].w + r14.z);
    r13.w = r14.z * r13.w;
    r14.z = dot(refProbeAttenuationConstantsCB[r9.w].data[2].xyz, r10.yzw);
    r14.z = saturate(refProbeAttenuationConstantsCB[r9.w].data[2].w + r14.z);
    r13.w = r14.z * r13.w;
    r14.z = dot(refProbeAttenuationConstantsCB[r9.w].data[3].xyz, r10.yzw);
    r14.z = saturate(refProbeAttenuationConstantsCB[r9.w].data[3].w + r14.z);
    r13.w = r14.z * r13.w;
    r14.z = dot(refProbeAttenuationConstantsCB[r9.w].data[4].xyz, r10.yzw);
    r14.z = saturate(refProbeAttenuationConstantsCB[r9.w].data[4].w + r14.z);
    r13.w = r14.z * r13.w;
    r14.z = dot(refProbeAttenuationConstantsCB[r9.w].data[5].xyz, r10.yzw);
    r9.w = saturate(refProbeAttenuationConstantsCB[r9.w].data[5].w + r14.z);
    r19.x = r13.w * r9.w;
    r9.w = 1 & (int)refProbeConstantsCB[r6.w].data[6].x;
    r19.yz = float2(0,1);
    r14.zw = r9.ww ? r19.xy : r19.zx;
    r19.x = 1;
    r9.w = refProbeConstantsCB[r6.w].data[6].x;
    r20.xy = r14.zw;
    r13.w = 1;
    while (true) {
      r15.w = cmp((int)r13.w >= (int)r8.w);
      if (r15.w != 0) break;
      r15.w = (int)r7.w + (int)r13.w;
      r15.w = (int)r15.w * 6;
      r16.y = dot(refProbeAttenuationConstantsCB[r15.w].data[0].xyz, r10.yzw);
      r16.y = saturate(refProbeAttenuationConstantsCB[r15.w].data[0].w + r16.y);
      r16.y = r20.x * r16.y;
      r16.z = dot(refProbeAttenuationConstantsCB[r15.w].data[1].xyz, r10.yzw);
      r16.z = saturate(refProbeAttenuationConstantsCB[r15.w].data[1].w + r16.z);
      r16.y = r16.y * r16.z;
      r16.z = dot(refProbeAttenuationConstantsCB[r15.w].data[2].xyz, r10.yzw);
      r16.z = saturate(refProbeAttenuationConstantsCB[r15.w].data[2].w + r16.z);
      r16.y = r16.y * r16.z;
      r16.z = dot(refProbeAttenuationConstantsCB[r15.w].data[3].xyz, r10.yzw);
      r16.z = saturate(refProbeAttenuationConstantsCB[r15.w].data[3].w + r16.z);
      r16.y = r16.y * r16.z;
      r16.z = dot(refProbeAttenuationConstantsCB[r15.w].data[4].xyz, r10.yzw);
      r16.z = saturate(refProbeAttenuationConstantsCB[r15.w].data[4].w + r16.z);
      r16.y = r16.y * r16.z;
      r16.z = dot(refProbeAttenuationConstantsCB[r15.w].data[5].xyz, r10.yzw);
      r15.w = saturate(refProbeAttenuationConstantsCB[r15.w].data[5].w + r16.z);
      r20.x = r16.y * r15.w;
      r16.z = (uint)r9.w >> 2;
      if (1 == 0) r16.w = 0; else if (1+2 < 32) {       r16.w = (uint)r9.w << (32-(1 + 2)); r16.w = (uint)r16.w >> (32-1);      } else r16.w = (uint)r9.w >> 2;
      r17.y = (int)r16.z & 2;
      r17.z = max(r20.y, r20.x);
      r15.w = -r16.y * r15.w + 1;
      r15.w = r20.y * r15.w;
      r19.y = r17.y ? r15.w : r17.z;
      r20.xy = r16.ww ? r20.xy : r19.xy;
      r13.w = (int)r13.w + 1;
      r9.w = r16.z;
    }
    r20.y = saturate(r20.y);
    r7.w = refProbeConstantsCB[r6.w].data[6].y * r20.y;
    r8.w = cmp(0 < r7.w);
    if (r8.w != 0) {
      ...
      r9.w = dot(r18.xyz, r19.xyz);
      r13.w = dot(r10.yzw, r19.xyz);
      r13.w = -refProbeConstantsCB[r6.w].data[8].z + r13.w;
      r14.z = cmp(r13.w >= 0);
      ...
      r13.w = dot(r18.xyz, r19.xyz);
      r14.z = dot(r10.yzw, r19.xyz);
      r14.z = -refProbeConstantsCB[r6.w].data[11].z + r14.z;
      r14.w = cmp(r14.z >= 0);
      r14.z = max(abs(r14.z), r3.z);
      r14.z = r14.w ? r14.z : -r14.z;
      r13.w = max(1.00000001e-07, -r13.w);
      ...
      r13.w = dot(r18.xyz, r19.xyz);
      r14.z = dot(r10.yzw, r19.xyz);
      r14.z = -refProbeConstantsCB[r6.w].data[12].z + r14.z;
      r14.w = cmp(r14.z >= 0);
      r14.z = max(abs(r14.z), r3.z);
      r14.z = r14.w ? r14.z : -r14.z;
      r13.w = max(1.00000001e-07, -r13.w);
      ...
      r13.w = dot(r18.xyz, r19.xyz);
      r14.z = dot(r10.yzw, r19.xyz);
      r14.z = -refProbeConstantsCB[r6.w].data[13].z + r14.z;
      r14.w = cmp(r14.z >= 0);
      r14.z = max(abs(r14.z), r3.z);
      r14.z = r14.w ? r14.z : -r14.z;
      r13.w = max(1.00000001e-07, -r13.w);
      r13.w = r14.z / r13.w;
      r9.w = min(abs(r13.w), r9.w);
      r19.x = refProbeConstantsCB[r6.w].data[3].w + r10.y;
      r19.yz = refProbeConstantsCB[r6.w].data[4].xy + r10.zw;
      r16.yzw = r18.xyz * r9.www + r19.xyz;
      ...
      r19.x = refProbeConstantsCB[r6.w].data[0].w;
      r19.y = refProbeConstantsCB[r6.w].data[1].z;
      r19.z = refProbeConstantsCB[r6.w].data[2].y;
      r20.x = dot(r16.yzw, r19.xyz);
      r21.xy = refProbeConstantsCB[r6.w].data[1].xw;
      r21.z = refProbeConstantsCB[r6.w].data[2].z;
      r20.y = dot(r16.yzw, r21.xyz);
      r22.x = refProbeConstantsCB[r6.w].data[1].y;
      r22.yz = refProbeConstantsCB[r6.w].data[2].xw;
      r20.z = dot(r16.yzw, r22.xyz);
      if (9 == 0) r13.w = 0; else if (9+16 < 32) {       r13.w = (uint)refProbeConstantsCB[r6.w].data[7].z << (32-(9 + 16)); r13.w = (uint)r13.w >> (32-9);      } else r13.w = (uint)refProbeConstantsCB[r6.w].data[7].z >> 16;
      r20.w = (uint)r13.w;
      r16.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r20.xyzw, r9.w).xyz;
      r23.x = dot(r10.yzw, r19.xyz);
      r23.y = dot(r10.yzw, r21.xyz);
      r23.z = dot(r10.yzw, r22.xyz);
      r10.yzw = saturate(r23.xyz * refProbeConstantsCB[r6.w].data[3].xyz + float3(0.5,0.5,0.5));
      r23.xy = refProbeConstantsCB[r6.w].data[4].zw * r10.yz;
      r23.z = refProbeConstantsCB[r6.w].data[5].x * r10.w;
      r10.yzw = refProbeConstantsCB[r6.w].data[5].yzw + r23.xyz;
      r20.x = dot(r12.xyz, r19.xyz);
      r20.y = dot(r12.xyz, r21.xyz);
      r20.z = dot(r12.xyz, r22.xyz);
      r17.yzw = cmp(float3(0,0,0) < r20.xyz);
      r19.z = r17.y ? 0 : 0.5;
      r19.xy = float2(0,0);
      ...
      r10.yzw = r10.yzw * r21.zzz + r19.xyz;
      r17.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r20.xyzw, 6).xyz;
      r10.yzw = r17.yzw * r10.yzw;
      r6.w = dot(r10.yzw, float3(0.212599993,0.715200007,0.0722000003));
      r9.w = r6.w * r3.w;
  ...
  r6.w = cmp(r7.w < 1);
  if (r6.w != 0) {
    r4.w = cmp((uint)r0.y < (uint)r4.w);
    if (r4.w != 0) {
      r0.y = (int)r0.y * 14;
      r17.yzw = -refProbeConstantsCB[r0.y].data[0].xyz + r11.xyz;
      r4.w = 0x0000ffff & (int)refProbeConstantsCB[r0.y].data[7].z;
      ...
      r8.w = (int)r4.w * 6;
      r9.w = dot(refProbeAttenuationConstantsCB[r8.w].data[0].xyz, r17.yzw);
      r9.w = saturate(refProbeAttenuationConstantsCB[r8.w].data[0].w + r9.w);
      r13.w = dot(refProbeAttenuationConstantsCB[r8.w].data[1].xyz, r17.yzw);
      r13.w = saturate(refProbeAttenuationConstantsCB[r8.w].data[1].w + r13.w);
      r9.w = r13.w * r9.w;
      r13.w = dot(refProbeAttenuationConstantsCB[r8.w].data[2].xyz, r17.yzw);
      r13.w = saturate(refProbeAttenuationConstantsCB[r8.w].data[2].w + r13.w);
      r9.w = r13.w * r9.w;
      r13.w = dot(refProbeAttenuationConstantsCB[r8.w].data[3].xyz, r17.yzw);
      r13.w = saturate(refProbeAttenuationConstantsCB[r8.w].data[3].w + r13.w);
      r9.w = r13.w * r9.w;
      r13.w = dot(refProbeAttenuationConstantsCB[r8.w].data[4].xyz, r17.yzw);
      r13.w = saturate(refProbeAttenuationConstantsCB[r8.w].data[4].w + r13.w);
      r9.w = r13.w * r9.w;
      r13.w = dot(refProbeAttenuationConstantsCB[r8.w].data[5].xyz, r17.yzw);
      r8.w = saturate(refProbeAttenuationConstantsCB[r8.w].data[5].w + r13.w);
      r19.x = r9.w * r8.w;
      r8.w = 1 & (int)refProbeConstantsCB[r0.y].data[6].x;
      r19.yz = float2(0,1);
      r14.zw = r8.ww ? r19.xy : r19.zx;
      r19.x = 1;
      r8.w = refProbeConstantsCB[r0.y].data[6].x;
      r20.xy = r14.zw;
      r9.w = 1;
      while (true) {
        r13.w = cmp((int)r9.w >= (int)r6.w);
        if (r13.w != 0) break;
        r13.w = (int)r4.w + (int)r9.w;
        r13.w = (int)r13.w * 6;
        r15.w = dot(refProbeAttenuationConstantsCB[r13.w].data[0].xyz, r17.yzw);
        r15.w = saturate(refProbeAttenuationConstantsCB[r13.w].data[0].w + r15.w);
        r15.w = r20.x * r15.w;
        r19.z = dot(refProbeAttenuationConstantsCB[r13.w].data[1].xyz, r17.yzw);
        r19.z = saturate(refProbeAttenuationConstantsCB[r13.w].data[1].w + r19.z);
        r15.w = r19.z * r15.w;
        r19.z = dot(refProbeAttenuationConstantsCB[r13.w].data[2].xyz, r17.yzw);
        r19.z = saturate(refProbeAttenuationConstantsCB[r13.w].data[2].w + r19.z);
        r15.w = r19.z * r15.w;
        r19.z = dot(refProbeAttenuationConstantsCB[r13.w].data[3].xyz, r17.yzw);
        r19.z = saturate(refProbeAttenuationConstantsCB[r13.w].data[3].w + r19.z);
        r15.w = r19.z * r15.w;
        r19.z = dot(refProbeAttenuationConstantsCB[r13.w].data[4].xyz, r17.yzw);
        r19.z = saturate(refProbeAttenuationConstantsCB[r13.w].data[4].w + r19.z);
        r15.w = r19.z * r15.w;
        r19.z = dot(refProbeAttenuationConstantsCB[r13.w].data[5].xyz, r17.yzw);
        r13.w = saturate(refProbeAttenuationConstantsCB[r13.w].data[5].w + r19.z);
        r20.x = r15.w * r13.w;
        r19.z = (uint)r8.w >> 2;
        if (1 == 0) r19.w = 0; else if (1+2 < 32) {         r19.w = (uint)r8.w << (32-(1 + 2)); r19.w = (uint)r19.w >> (32-1);        } else r19.w = (uint)r8.w >> 2;
        r20.z = (int)r19.z & 2;
        r20.w = max(r20.y, r20.x);
        r13.w = -r15.w * r13.w + 1;
        r13.w = r20.y * r13.w;
        r19.y = r20.z ? r13.w : r20.w;
        r20.xy = r19.ww ? r20.xy : r19.xy;
        r9.w = (int)r9.w + 1;
        r8.w = r19.z;
      }
      r4.w = saturate(r20.y + -r7.w);
      r6.w = refProbeConstantsCB[r0.y].data[6].y * r4.w;
      r8.w = cmp(0 < r6.w);
      if (r8.w != 0) {
        r7.w = r4.w * refProbeConstantsCB[r0.y].data[6].y + r7.w;
        r4.w = refProbeConstantsCB[r0.y].data[7].y * r6.w;
        r19.x = refProbeConstantsCB[r0.y].data[7].w;
        r19.yz = refProbeConstantsCB[r0.y].data[8].xy;
        r6.w = dot(r18.xyz, r19.xyz);
        r8.w = dot(r17.yzw, r19.xyz);
        r8.w = -refProbeConstantsCB[r0.y].data[8].z + r8.w;
        r9.w = cmp(r8.w >= 0);
        r8.w = max(abs(r8.w), r3.z);
        r8.w = r9.w ? r8.w : -r8.w;
        ...
        r13.w = cmp(r9.w >= 0);
        r3.z = max(abs(r9.w), r3.z);
        r3.z = r13.w ? r3.z : -r3.z;
        r8.w = max(1.00000001e-07, -r8.w);
        r3.z = r3.z / r8.w;
        r3.z = min(r6.w, abs(r3.z));
        r19.x = refProbeConstantsCB[r0.y].data[3].w + r17.y;
        r19.yz = refProbeConstantsCB[r0.y].data[4].xy + r17.zw;
        r19.xyz = r18.xyz * r3.zzz + r19.xyz;
        ...
        r24.x = dot(r17.yzw, r20.xyz);
        r24.y = dot(r17.yzw, r22.xyz);
        r24.z = dot(r17.yzw, r23.xyz);
        r17.yzw = saturate(r24.xyz * refProbeConstantsCB[r0.y].data[3].xyz + float3(0.5,0.5,0.5));
        r24.xy = refProbeConstantsCB[r0.y].data[4].zw * r17.yz;
        r24.z = refProbeConstantsCB[r0.y].data[5].x * r17.w;
        r17.yzw = refProbeConstantsCB[r0.y].data[5].yzw + r24.xyz;
        ...
        r17.yzw = r17.yzw * r23.zzz + r20.xyw;
        r20.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r21.xyzw, 6).xyz;
        r21.xyz = r20.xyz * r17.yzw;
        r0.y = dot(r21.xyz, float3(0.212599993,0.715200007,0.0722000003));
        r10.yzw = r17.yzw * r20.xyz + r10.yzw;
        r2.w = r3.w * r0.y;
        r17.yzw = r19.xyz * r4.www;
        r3.z = dot(r17.yzw, float3(0.212599993,0.715200007,0.0722000003));
        r0.y = r3.w * r0.y + r3.z;
        r0.y = r2.w / r0.y;
  ...
  r0.y = rcp(r0.y);
  r7.w = saturate(r7.w);
  r17.yzw = r10.yzw * r0.yyy;
  r16.yzw = r16.yzw * r0.yyy;
  r2.w = cmp(r7.w < 0.99000001);
  if (r2.w != 0) {
    r2.w = 1 + -r7.w;
    ...
    r3.z = dot(r19.xyz, float3(0.212599993,0.715200007,0.0722000003));
    r17.yzw = r10.yzw * r0.yyy + r19.xyz;
    r18.w = 0;
    r10.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r18.xyzw, r3.y).xyz;
  ...
  r3.yzw = r17.yzw * r2.zzz;
  r10.yzw = r3.xxx ? r3.yzw : 0;
    ...
    while (true) {
      ...
      if (r13.w != 0) {
        ...
        if (r25.w != 0) {
          ...
          if (r20.x != 0) {
            ...
            if (r13.w != 0) {
              ...
              r21.xyz = r12.xyz * r13.www + r11.xyz;
            ...
            if (r20.x != 0) {
              ...
              if (r21.x != 0) {
                ...
                r21.x = abs(r15.w) * -0.200000003 + 0.400000006;
                r21.y = cmp(r15.w < 0);
                r21.y = r3.x ? r21.y : 0;
                ...
                if (r21.y == 0) {
                  ...
                  if (r7.w != 0) {
                    ...
                    while (true) {
                      ...
                      r39.y = dot(icb[r25.w+0].xy, r14.xy);
              ...
              r36.xyz = r36.xyz * r14.zzz + r13.xyz;
              r14.z = dot(r36.xyz, r36.xyz);
              r14.z = rsqrt(r14.z);
              r36.xyz = r36.xyz * r14.zzz;
              r14.z = dot(r36.xyz, r13.xyz);
              ...
              r32.xyz = r15.www ? r22.xyz : r32.xyz;
              r33.xyz = r15.www ? r33.xyz : r38.xyz;
              r34.xyz = r15.www ? r37.xyz : r34.xyz;
              r35.xyz = r15.www ? r36.xyz : r35.xyz;
            }
          }
        }
      } else {
        ...
        if (r12.w != 0) {
          ...
          r13.w = lightConstantsCB[r9.w].data[1].z * r0.w;
          r13.w = 0.25 * r13.w;
          ...
          r14.w = dot(r22.xyz, r18.xyz);
          r15.w = dot(r22.xyz, r37.xyz);
          r18.w = dot(r18.xyz, r37.xyz);
          ...
          r22.xyz = r15.www * r22.xyz + r36.xyz;
          r22.xyz = r14.zzz ? r22.xyz : lightConstantsCB[r9.w].data[0].xyz;
          r36.xyz = r14.zzz ? r37.xyz : lightConstantsCB[r9.w].data[0].xyz;
            ...
            if (r20.x != 0) {
              ...
              if (r12.w != 0) {
                ...
                while (true) {
                  ...
                  if (r21.y != 0) break;
                  r23.y = dot(icb[r21.x+0].xy, r15.xy);
                  r23.z = dot(icb[r21.x+0].yx, r15.xz);
              ...
              if (r14.w != 0) {
                ...
                r15.w = saturate(dot(r12.xyz, r37.xyz));
