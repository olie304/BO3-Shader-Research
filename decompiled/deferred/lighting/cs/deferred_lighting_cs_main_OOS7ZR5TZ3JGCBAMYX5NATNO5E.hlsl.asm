...
switch r2.w
  case l(4)
  lt r2.w, l(0.000000), cb9[r0.x + 6].y
  ...
  movc r21.xyz, r2.wwww, r21.xyzx, cb9[r0.x + 0].xyzx
  ...
  mov_sat r7.w, r6.w
  movc r7.w, r0.z, |r6.w|, r7.w
  lt r8.w, l(0.000000), r7.w
  if_nz r8.w
    sqrt r8.w, r5.w
    mul r9.w, cb9[r0.x + 3].x, cb9[r0.x + 3].x
    div r5.w, r9.w, r5.w
    min r5.w, r5.w, l(1.000000)
    mad_sat r21.xy, r8.wwww, cb9[r0.x + 2].xzxx, cb9[r0.x + 2].ywyy
    ...
    if_nz r8.w
      ...
      if_nz r8.w
        ...
        max r8.w, r8.w, |r21.y|
        div r8.w, cb9[r0.x + 5].x, r8.w
        add r8.w, r8.w, cb9[r0.x + 5].y
        dp3 r9.w, r21.yzwy, r21.yzwy
        rsq r9.w, r9.w
        ...
        loop 
          ...
          mad r24.xyz, r21.yzwy, r9.wwww, r25.xzwx
      ...
      lt r8.w, l(0.000000), r5.w
      if_nz r8.w
        mul r8.w, r1.z, cb9[r0.x + 1].z
        mul r8.w, r8.w, l(0.250000)
        dp3 r9.w, r18.xyzx, r15.xyzx
        dp3 r11.w, r15.xyzx, r20.xyzx
        mad r12.w, -r9.w, r9.w, cb9[r0.x + 6].y
        mad r3.w, r9.w, r11.w, -r3.w
        div_sat r3.w, r3.w, r12.w
        div r9.w, r12.w, cb9[r0.x + 6].y
        mul r9.w, r9.w, l(10.000000)
        min r9.w, r9.w, l(1.000000)
        add r3.w, -r4.z, r3.w
        mad r3.w, r9.w, r3.w, r4.z
        mad r15.xyz, r3.wwww, r18.xyzx, r19.xyzx
        movc r15.xyz, r2.wwww, r15.xyzx, cb9[r0.x + 0].xyzx
        add r15.xyz, -r10.xyzx, r15.xyzx
        dp3 r2.w, r15.xyzx, r15.xyzx
        rsq r2.w, r2.w
        mul r18.xyz, r2.wwww, r15.xyzx
        ...
        if_nz r4.z
          ...
          if_z r11.w
            ...
            div r19.xy, r20.xyxx, r9.wwww
            mad r19.xy, r19.xyxx, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
            add r20.x, r19.x, cb9[r3.w + 9].w
            add r20.y, r19.y, cb9[r3.w + 10].x
            mul r19.xy, r20.xyxx, cb9[r3.w + 9].yzyy
            div r19.zw, cb9[r3.w + 3].yyyy, cb9[r3.w + 8].yyyw
            ...
            if_z r12.w
              ...
              mad r20.x, r19.x, cb9[r3.w + 8].y, cb9[r3.w + 8].z
              mad r20.y, r19.y, cb9[r3.w + 8].w, cb9[r3.w + 9].x
              mul r15.w, r9.w, cb9[r3.w + 10].z
              mad r4.z, cb9[r3.w + 10].y, r9.w, r4.z
              div r4.z, r4.z, r15.w
            endif 
          else 
            mov r12.w, l(-1)
        ...
        add r3.w, -r7.w, r3.w
        mad r3.w, r1.w, r3.w, r7.w
        mul r3.w, r5.w, r3.w
        mov r19.x, cb9[r0.x + 0].w
        mov r19.yz, cb9[r0.x + 1].xxyx
        mul r20.xyz, r3.wwww, r19.xyzx
        lt r4.z, l(0.000000), r6.w
        mad r20.xyz, r9.xyzx, r2.zzzz, r20.xyzx
        dp3_sat r6.w, r11.xyzx, r18.xyzx
        mad r15.xyz, r15.xyzx, r2.wwww, r12.xyzx
        dp3 r2.w, r15.xyzx, r15.xyzx
        rsq r2.w, r2.w
        ...
        mul r6.w, r6.w, r7.w
        mul r5.w, r5.w, r6.w
        mad r15.xyz, r5.wwww, r19.xyzx, r13.yzwy
        add_sat r2.w, -r2.w, l(1.000000)
        mul r6.w, r2.w, r2.w
        mul r6.w, r6.w, r6.w
        mul r2.w, r2.w, r6.w
        mul r2.w, r2.w, r5.w
        mad r18.xyz, r2.wwww, r19.xyzx, r17.xyzx
        mad r19.xyz, r3.wwww, r19.xyzx, r16.xyzx
        and r19.xyz, r0.zzzz, r19.xyzx
        movc r14.yzw, r4.zzzz, r20.xxyz, r14.yyzw
        movc r16.xyz, r4.zzzz, r16.xyzx, r19.xyzx
        movc r17.xyz, r4.zzzz, r18.xyzx, r17.xyzx
        movc r13.yzw, r4.zzzz, r15.xxyz, r13.yyzw
      endif 
    endif 
  endif 
  break 
  ...
  rsq r2.w, r2.w
  mul r18.xyz, r2.wwww, r15.xyzx
  dp3 r3.w, r11.xyzx, r18.xyzx
  mov_sat r4.z, r3.w
  movc r5.w, r0.z, |r3.w|, r4.z
  ...
  if_nz r6.w
    ...
    if_nz r7.w
      ...
      add r20.xyz, -r10.xyzx, cb9[r0.x + 0].xyzx
      mul r8.w, cb9[r0.x + 3].x, cb9[r0.x + 3].x
      dp3 r9.w, r20.xyzx, r20.xyzx
      div r8.w, r8.w, r9.w
      min r8.w, r8.w, l(1.000000)
      mad_sat r20.xy, r6.wwww, cb9[r0.x + 2].xzxx, cb9[r0.x + 2].ywyy
      ...
      if_nz r6.w
        ...
        exp r21.xy, r21.xyxx
        mul r9.w, r21.x, cb9[r0.x + 12].x
        mad r10.w, cb9[r0.x + 12].y, r21.y, l(-1.000000)
        mad r9.w, cb9[r0.x + 12].y, r21.y, -r9.w
      ...
      if_nz r6.w
        ...
        dp3 r8.w, cb9[r0.x + 13].xyzx, r20.xyzx
        mov r21.x, cb9[r0.x + 13].w
        mov r21.yz, cb9[r0.x + 14].xxyx
        dp3 r9.w, r21.xyzx, r20.xyzx
        frc r20.x, r8.w
        frc r20.y, r9.w
        iadd r6.w, r6.w, l(-1)
        utof r20.z, r6.w
    ...
    if_nz r6.w
      ...
      if_nz r6.w
        ...
        if_nz r9.w
          ...
          if_nz cb2[58].y
            ...
            utof r20.z, r8.w
            sample_c_lz_indexable(texture2darray)(float,float,float,float) r9.w, r20.xyzx, t9.xxxx, s13, r6.w
          endif 
          mul r6.w, r9.w, r9.w
          mul r6.w, r9.w, r6.w
        else 
      ...
      if_nz r7.w
        ...
        if_nz r9.w
          ...
          if_z r10.w
            ...
            if_nz cb2[58].y
              ...
              utof r20.z, r10.w
              sample_c_lz_indexable(texture2darray)(float,float,float,float) r11.w, r20.xyzx, t9.xxxx, s13, r9.w
            endif 
            ...
            if_z r8.w
              ...
              if_nz cb2[58].y
                ...
                loop 
                  ...
                  dp2 r22.y, icb[r10.w + 0].yxyy, r18.yzyy
                  mad r21.xy, r22.xyxx, cb9[r0.x + 3].yyyy, r20.xyxx
                  sample_c_lz_indexable(texture2darray)(float,float,float,float) r11.w, r21.xyzx, t9.xxxx, s13, r0.y
                  mad r9.w, r11.w, l(0.125000), r9.w
                  iadd r10.w, r10.w, l(1)
                endloop 
              else 
                utof r20.z, r8.w
                sample_c_lz_indexable(texture2darray)(float,float,float,float) r9.w, r20.xyzx, t9.xxxx, s13, r0.y
              endif 
              mul r0.x, r9.w, r9.w
              mul r0.x, r9.w, r0.x
            else 
        ...
        mad r9.xyz, r9.xyzx, r2.zzzz, r18.xyzx
        mad r2.xzw, r15.xxyz, r2.wwww, r12.xxyz
        ...
        mad r2.xyz, r0.wwww, r19.xyzx, r13.yzwy
        add_sat r1.z, -r1.w, l(1.000000)
        mul r1.w, r1.z, r1.z
        mul r1.w, r1.w, r1.w
        mul r1.z, r1.w, r1.z
        mul r0.w, r0.w, r1.z
        mad r11.xyz, r0.wwww, r19.xyzx, r17.xyzx
        mad r12.xyz, r0.xxxx, r19.xyzx, r16.xyzx
        and r12.xyz, r0.zzzz, r12.xyzx
        movc r14.yzw, r0.yyyy, r9.xxyz, r14.yyzw
        movc r16.xyz, r0.yyyy, r16.xyzx, r12.xyzx
        movc r17.xyz, r0.yyyy, r11.xyzx, r17.xyzx
...
mad r0.xyw, r16.xyxz, r2.xyxz, r0.xyxw
...
ret 
// Approximately 968 instruction slots used
