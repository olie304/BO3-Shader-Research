...
r0.y = samplerLinear[]..swiz;
  ...
  r0.y = cmp((uint)r9.x >= (uint)r7.w);
  r8.w = cmp((uint)r9.x < numRefProbes);
  r0.y = r0.y ? r8.w : 0;
  if (r0.y != 0) {
    r0.y = (int)r9.x * 14;
    ...
    r17.yz = float2(0,1);
    r13.zw = r12.ww ? r17.xy : r17.zx;
    r17.x = 1;
    r12.w = refProbeConstantsCB[r0.y].data[6].x;
    r18.xy = r13.zw;
    r14.w = 1;
    while (true) {
      r17.z = cmp((int)r14.w >= (int)r9.w);
      if (r17.z != 0) break;
      r17.z = (int)r8.w + (int)r14.w;
      r17.z = (int)r17.z * 6;
    ...
    r8.w = refProbeConstantsCB[r0.y].data[6].y * r18.y;
    r9.w = cmp(0 < r8.w);
    if (r9.w != 0) {
      r9.w = refProbeConstantsCB[r0.y].data[7].y * r8.w;
      r17.x = refProbeConstantsCB[r0.y].data[7].w;
      r17.yz = refProbeConstantsCB[r0.y].data[8].xy;
      r12.w = dot(r16.xyz, r17.xyz);
      r13.z = dot(r15.yzw, r17.xyz);
      ...
      if (9 == 0) r13.z = 0; else if (9+16 < 32) {       r13.z = (uint)refProbeConstantsCB[r0.y].data[7].z << (32-(9 + 16)); r13.z = (uint)r13.z >> (32-9);      } else r13.z = (uint)refProbeConstantsCB[r0.y].data[7].z >> 16;
      r19.w = (uint)r13.z;
  ...
  if (r0.y != 0) {
    ...
    if (r0.y != 0) {
      ...
      r9.w = (int)r7.w * 6;
      r12.w = dot(refProbeAttenuationConstantsCB[r9.w].data[0].xyz, r18.xyz);
      r12.w = saturate(refProbeAttenuationConstantsCB[r9.w].data[0].w + r12.w);
      r13.z = dot(refProbeAttenuationConstantsCB[r9.w].data[1].xyz, r18.xyz);
      r13.z = saturate(refProbeAttenuationConstantsCB[r9.w].data[1].w + r13.z);
      r12.w = r13.z * r12.w;
      r13.z = dot(refProbeAttenuationConstantsCB[r9.w].data[2].xyz, r18.xyz);
      r13.z = saturate(refProbeAttenuationConstantsCB[r9.w].data[2].w + r13.z);
      r12.w = r13.z * r12.w;
      r13.z = dot(refProbeAttenuationConstantsCB[r9.w].data[3].xyz, r18.xyz);
      r13.z = saturate(refProbeAttenuationConstantsCB[r9.w].data[3].w + r13.z);
      r12.w = r13.z * r12.w;
      r13.z = dot(refProbeAttenuationConstantsCB[r9.w].data[4].xyz, r18.xyz);
      r13.z = saturate(refProbeAttenuationConstantsCB[r9.w].data[4].w + r13.z);
      r12.w = r13.z * r12.w;
      r13.z = dot(refProbeAttenuationConstantsCB[r9.w].data[5].xyz, r18.xyz);
      r9.w = saturate(refProbeAttenuationConstantsCB[r9.w].data[5].w + r13.z);
      r19.x = r12.w * r9.w;
      r9.w = 1 & (int)refProbeConstantsCB[r0.y].data[6].x;
      r19.yz = float2(0,1);
      r13.zw = r9.ww ? r19.xy : r19.zx;
      r19.x = 1;
      r9.w = refProbeConstantsCB[r0.y].data[6].x;
      r20.xy = r13.zw;
      r12.w = 1;
      while (true) {
        r14.w = cmp((int)r12.w >= (int)r9.x);
        if (r14.w != 0) break;
        r14.w = (int)r7.w + (int)r12.w;
        r14.w = (int)r14.w * 6;
      ...
      r7.w = saturate(r20.y + -r8.w);
      r9.x = refProbeConstantsCB[r0.y].data[6].y * r7.w;
      r9.w = cmp(0 < r9.x);
      if (r9.w != 0) {
        r8.w = r7.w * refProbeConstantsCB[r0.y].data[6].y + r8.w;
        r7.w = refProbeConstantsCB[r0.y].data[7].y * r9.x;
        ...
        r13.z = cmp(r12.w >= 0);
        r5.w = max(abs(r12.w), r5.w);
        r5.w = r13.z ? r5.w : -r5.w;
        r9.w = max(1.00000001e-07, -r9.w);
        r5.w = r5.w / r9.w;
        r5.w = min(r9.x, abs(r5.w));
        r19.x = refProbeConstantsCB[r0.y].data[3].w + r18.x;
        r19.yz = refProbeConstantsCB[r0.y].data[4].xy + r18.yz;
        r19.xyz = r16.xyz * r5.www + r19.xyz;
        ...
        if (9 == 0) r5.w = 0; else if (9+16 < 32) {         r5.w = (uint)refProbeConstantsCB[r0.y].data[7].z << (32-(9 + 16)); r5.w = (uint)r5.w >> (32-9);        } else r5.w = (uint)refProbeConstantsCB[r0.y].data[7].z >> 16;
        r21.w = (uint)r5.w;
  ...
  if (r2.z != 0) {
    ...
    r5.w = dot(r19.xyz, float3(0.212599993,0.715200007,0.0722000003));
    r18.xyz = r15.yzw * r0.yyy + r19.xyz;
    r16.w = 0;
    r15.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r16.xyzw, r2.w).xyz;
    r0.y = sunConstants.globalProbeExposure * r2.z + -r5.w;
    r0.y = r2.y * r0.y + r5.w;
