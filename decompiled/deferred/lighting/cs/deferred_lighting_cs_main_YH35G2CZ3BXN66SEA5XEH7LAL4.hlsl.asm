...
loop 
  ieq r14.w, r10.w, l(2)
  breakc_nz r14.w
  movc r14.w, r10.w, r0.x, r13.z
  uge r15.y, r14.w, r9.w
  ult r15.z, r14.w, cb2[0].y
  ...
  if_nz r15.y
    ...
    mul r19.x, r16.w, r18.y
    and r16.w, l(1), cb10[r14.w + 6].x
    movc r18.yz, r16.wwww, r19.xxyx, r19.zzxz
    mov r16.w, cb10[r14.w + 6].x
    mov r27.xy, r18.yzyy
    mov r18.w, l(1)
    loop 
      ige r19.x, r18.w, r16.z
      breakc_nz r19.x
      iadd r19.x, r16.y, r18.w
      imul null, r19.x, r19.x, l(6)
      dp3 r19.w, cb11[r19.x + 0].xyzx, r15.yzwy
      add_sat r19.w, r19.w, cb11[r19.x + 0].w
      mul r19.w, r19.w, r27.x
      dp3 r20.w, cb11[r19.x + 1].xyzx, r15.yzwy
      add_sat r20.w, r20.w, cb11[r19.x + 1].w
      mul r19.w, r19.w, r20.w
      dp3 r20.w, cb11[r19.x + 2].xyzx, r15.yzwy
      add_sat r20.w, r20.w, cb11[r19.x + 2].w
      mul r19.w, r19.w, r20.w
      dp3 r20.w, cb11[r19.x + 3].xyzx, r15.yzwy
      add_sat r20.w, r20.w, cb11[r19.x + 3].w
      mul r19.w, r19.w, r20.w
      dp3 r20.w, cb11[r19.x + 4].xyzx, r15.yzwy
      add_sat r20.w, r20.w, cb11[r19.x + 4].w
      mul r19.w, r19.w, r20.w
      dp3 r20.w, cb11[r19.x + 5].xyzx, r15.yzwy
      add_sat r19.x, r20.w, cb11[r19.x + 5].w
      mul r27.x, r19.x, r19.w
      ushr r20.w, r16.w, l(2)
      ubfe r22.w, l(1), l(2), r16.w
      and r23.w, r20.w, l(2)
      max r27.z, r27.x, r27.y
      mad r19.x, -r19.w, r19.x, l(1.000000)
      mul r19.x, r19.x, r27.y
      movc r21.y, r23.w, r19.x, r27.z
      movc r27.xy, r22.wwww, r27.xyxx, r21.xyxx
    ...
    if_nz r16.z
      and r16.z, r26.w, l(7)
      iadd r16.w, r16.z, l(-1)
      ult r16.w, r16.w, l(32)
      and r16.w, r2.w, r16.w
      if_nz r16.w
        imad r16.zw, r16.zzzz, l(0, 0, 20, 20), l(0, 0, 860, 876)
        ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r18.y, cb2[52].x, r16.z, u2.xxxx
        or r18.y, r18.y, l(32)
        store_structured u2.x, cb2[52].x, r16.z, r18.y
        store_structured u2.x, cb2[52].x, r16.w, r16.y
      endif 
      iadd r25.w, r25.w, l(257)
      mad r25.z, r27.y, cb10[r14.w + 6].y, r25.z
      ...
      ge r18.y, r16.w, l(0.000000)
      max r16.w, r7.w, |r16.w|
      movc r16.w, r18.y, r16.w, -r16.w
      ...
      dp3 r16.w, r17.xyzx, r28.xyzx
      dp3 r18.y, r15.yzwy, r28.xyzx
      add r18.y, r18.y, -cb10[r14.w + 11].z
      ge r18.z, r18.y, l(0.000000)
      max r18.y, r7.w, |r18.y|
      movc r18.y, r18.z, r18.y, -r18.y
      max r16.w, -r16.w, l(0.00000010)
      ...
      dp3 r16.w, r17.xyzx, r28.xyzx
      dp3 r18.y, r15.yzwy, r28.xyzx
      add r18.y, r18.y, -cb10[r14.w + 12].z
      ge r18.z, r18.y, l(0.000000)
      max r18.y, r7.w, |r18.y|
      movc r18.y, r18.z, r18.y, -r18.y
      max r16.w, -r16.w, l(0.00000010)
      ...
      dp3 r16.w, r17.xyzx, r28.xyzx
      dp3 r18.y, r15.yzwy, r28.xyzx
      add r18.y, r18.y, -cb10[r14.w + 13].z
      ge r18.z, r18.y, l(0.000000)
      max r18.y, r7.w, |r18.y|
      movc r18.y, r18.z, r18.y, -r18.y
      max r16.w, -r16.w, l(0.00000010)
      ...
      mad r18.yzw, r17.xxyz, r16.zzzz, r28.xxyz
      dp3 r16.w, r18.yzwy, r18.yzwy
      sqrt r16.w, r16.w
      div r16.z, r16.z, r16.w
      add r16.z, r16.z, r16.z
      sqrt r16.z, r16.z
      mad r16.z, r3.w, l(5.000000), r16.z
      ...
      utof r29.w, r16.w
      sample_l_indexable(texturecubearray)(float,float,float,float) r18.yzw, r29.xyzw, t8.wxyz, s2, r16.z
      and r27.xzw, r18.yyzw, l(0x7fffffff, 0, 0x7fffffff, 0x7fffffff)
      ieq r27.xzw, r27.xxzw, l(0x7f800000, 0, 0x7f800000, 0x7f800000)
      or r16.z, r27.z, r27.x
      or r16.z, r27.w, r16.z
      movc r18.yzw, r16.zzzz, l(0,1.000000,1.000000,0), r18.yyzw
      ...
      mad r24.xyz, r15.yzwy, r27.xzwx, r24.xyzx
      mul r15.y, r8.w, r14.w
      mul r16.yzw, r16.yyyy, r18.yyzw
      dp3 r15.z, r16.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r14.w, r8.w, r14.w, r15.z
      div r14.w, r15.y, r14.w
      mov r28.x, r24.w
      mov r28.yz, r25.xxyx
      mad r15.yzw, r16.yyzw, r14.wwww, r28.xxyz
      mov r24.w, r15.y
      mov r25.xy, r15.zwzz
    else 
...
loop 
  ...
  breakc_nz r14.w
  movc r14.w, r10.w, r0.x, r13.z
  ult r16.w, r14.w, r9.w
  if_nz r16.w
    imul null, r14.w, r14.w, l(14)
    if_nz r2.w
      and r16.w, r16.z, l(15)
      imad r16.w, r16.w, l(20), l(880)
      add r18.yzw, cb1[24].xxyz, cb10[r14.w + 0].xxyz
      store_structured u2.xyzw, cb2[52].x, r16.w, r18.xyzw
    endif 
    iadd r21.y, r16.z, l(1)
    add r18.yzw, r11.xxyz, -cb10[r14.w + 0].xxyz
    and r16.w, l(0x0000ffff), cb10[r14.w + 7].z
    ...
    loop 
      ...
      dp3 r26.w, cb11[r22.w + 1].xyzx, r18.yzwy
      add_sat r26.w, r26.w, cb11[r22.w + 1].w
      mul r23.w, r23.w, r26.w
      dp3 r26.w, cb11[r22.w + 2].xyzx, r18.yzwy
      add_sat r26.w, r26.w, cb11[r22.w + 2].w
      mul r23.w, r23.w, r26.w
      dp3 r26.w, cb11[r22.w + 3].xyzx, r18.yzwy
      add_sat r26.w, r26.w, cb11[r22.w + 3].w
      mul r23.w, r23.w, r26.w
      dp3 r26.w, cb11[r22.w + 4].xyzx, r18.yzwy
      add_sat r26.w, r26.w, cb11[r22.w + 4].w
      mul r23.w, r23.w, r26.w
      dp3 r26.w, cb11[r22.w + 5].xyzx, r18.yzwy
      add_sat r22.w, r26.w, cb11[r22.w + 5].w
      mul r28.x, r22.w, r23.w
      ushr r26.w, r19.x, l(2)
      ubfe r27.z, l(1), l(2), r19.x
      and r27.w, r26.w, l(2)
      max r28.z, r28.x, r28.y
      mad r22.w, -r23.w, r22.w, l(1.000000)
      mul r22.w, r22.w, r28.y
      movc r21.w, r27.w, r22.w, r28.z
      movc r28.xy, r27.zzzz, r28.xyxx, r21.zwzz
      iadd r20.w, r20.w, l(1)
      mov r19.x, r26.w
    endloop 
    add_sat r16.w, -r25.z, r28.y
    mul r19.x, r16.w, cb10[r14.w + 6].y
    lt r19.w, l(0.000000), r19.x
    if_nz r19.w
      and r19.w, r21.y, l(31)
      iadd r20.w, r19.w, l(-1)
      ult r20.w, r20.w, l(32)
      and r20.w, r2.w, r20.w
      if_nz r20.w
        imad r27.xy, r19.wwww, l(20, 20, 0, 0), l(860, 876, 0, 0)
        ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r19.w, cb2[52].x, r27.x, u2.xxxx
        or r19.w, r19.w, l(32)
        store_structured u2.x, cb2[52].x, r27.x, r19.w
        store_structured u2.x, cb2[52].x, r27.y, r19.x
      endif 
      iadd r16.z, r16.z, l(257)
      mad r16.y, r16.w, cb10[r14.w + 6].y, r16.y
      mul r16.w, r19.x, cb10[r14.w + 7].y
      mov r27.x, cb10[r14.w + 7].w
      mov r27.yz, cb10[r14.w + 8].xxyx
      dp3 r19.x, r17.xyzx, r27.xyzx
      ...
      mov r27.x, cb10[r14.w + 8].w
      mov r27.yz, cb10[r14.w + 9].xxyx
      dp3 r19.w, r17.xyzx, r27.xyzx
      ...
      mov r27.x, cb10[r14.w + 9].w
      mov r27.yz, cb10[r14.w + 10].xxyx
      dp3 r19.w, r17.xyzx, r27.xyzx
      dp3 r20.w, r18.yzwy, r27.xyzx
      ...
      div r19.w, r20.w, r19.w
      min r19.x, |r19.w|, r19.x
      mov r27.x, cb10[r14.w + 10].w
      mov r27.yz, cb10[r14.w + 11].xxyx
      dp3 r19.w, r17.xyzx, r27.xyzx
      dp3 r20.w, r18.yzwy, r27.xyzx
      ...
      div r19.w, r20.w, r19.w
      min r19.x, |r19.w|, r19.x
      mov r27.x, cb10[r14.w + 11].w
      mov r27.yz, cb10[r14.w + 12].xxyx
      dp3 r19.w, r17.xyzx, r27.xyzx
      dp3 r20.w, r18.yzwy, r27.xyzx
      ...
      div r19.w, r20.w, r19.w
      min r19.x, |r19.w|, r19.x
      mov r27.x, cb10[r14.w + 12].w
      mov r27.yz, cb10[r14.w + 13].xxyx
      dp3 r19.w, r17.xyzx, r27.xyzx
      dp3 r20.w, r18.yzwy, r27.xyzx
      ...
      div r19.w, r20.w, r19.w
      min r19.x, |r19.w|, r19.x
      add r27.x, r18.y, cb10[r14.w + 3].w
      add r27.yz, r18.zzwz, cb10[r14.w + 4].xxyx
      mad r27.xyz, r17.xyzx, r19.xxxx, r27.xyzx
      dp3 r19.w, r27.xyzx, r27.xyzx
      sqrt r19.w, r19.w
      div r19.x, r19.x, r19.w
      add r19.x, r19.x, r19.x
      sqrt r19.x, r19.x
      mad r19.x, r3.w, l(5.000000), r19.x
      ...
      mad_sat r18.yzw, r33.xxyz, cb10[r14.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
      mul r33.xy, r18.yzyy, cb10[r14.w + 4].zwzz
      mul r33.z, r18.w, cb10[r14.w + 5].x
      add r18.yzw, r33.xxyz, cb10[r14.w + 5].yyzw
...
bfi r3.w, l(8), l(0), r16.z, r25.w
movc r0.x, r0.x, r3.w, r16.z
max r3.w, r16.y, l(1.000000)
rcp r3.w, r3.w
mov_sat r16.y, r16.y
mul r18.xyz, r3.wwww, r15.yzwy
mul r19.xyz, r3.wwww, r26.xyzx
...
if_nz r7.w
  ...
  mad r18.xyz, r15.yzwy, r3.wwww, r16.yzwy
  mov r17.w, l(0)
  ...
  mad r19.xyz, r15.yzwy, r3.wwww, r19.xyzx
endif 
add r3.w, r5.z, r2.x
log r3.w, |r3.w|
mul r3.w, r2.z, r3.w
...
ret 
// Approximately 2110 instruction slots used
