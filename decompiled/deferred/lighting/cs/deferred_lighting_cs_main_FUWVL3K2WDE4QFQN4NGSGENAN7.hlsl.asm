...
loop 
  ...
  uge r10.y, r9.w, r6.w
  ult r10.z, r9.w, cb2[0].y
  and r10.y, r10.z, r10.y
  if_nz r10.y
    imul null, r9.w, r9.w, l(14)
    add r10.yzw, r11.xxyz, -cb10[r9.w + 0].xxyz
    and r13.w, l(0x0000ffff), cb10[r9.w + 7].z
    ubfe r14.w, l(6), l(25), cb10[r9.w + 7].z
    imul null, r15.y, r13.w, l(6)
    dp3 r15.z, cb11[r15.y + 0].xyzx, r10.yzwy
    add_sat r15.z, r15.z, cb11[r15.y + 0].w
    dp3 r15.w, cb11[r15.y + 1].xyzx, r10.yzwy
    add_sat r15.w, r15.w, cb11[r15.y + 1].w
    mul r15.z, r15.w, r15.z
    dp3 r15.w, cb11[r15.y + 2].xyzx, r10.yzwy
    add_sat r15.w, r15.w, cb11[r15.y + 2].w
    mul r15.z, r15.w, r15.z
    dp3 r15.w, cb11[r15.y + 3].xyzx, r10.yzwy
    add_sat r15.w, r15.w, cb11[r15.y + 3].w
    mul r15.z, r15.w, r15.z
    dp3 r15.w, cb11[r15.y + 4].xyzx, r10.yzwy
    add_sat r15.w, r15.w, cb11[r15.y + 4].w
    mul r15.z, r15.w, r15.z
    dp3 r15.w, cb11[r15.y + 5].xyzx, r10.yzwy
    add_sat r15.y, r15.w, cb11[r15.y + 5].w
    mul r18.x, r15.y, r15.z
    and r15.y, l(1), cb10[r9.w + 6].x
    movc r15.yz, r15.yyyy, r18.xxyx, r18.zzxz
    mov r15.w, cb10[r9.w + 6].x
    mov r25.xy, r15.yzyy
    mov r16.y, l(1)
    loop 
      ige r16.z, r16.y, r14.w
      breakc_nz r16.z
      iadd r16.z, r13.w, r16.y
      imul null, r16.z, r16.z, l(6)
      dp3 r16.w, cb11[r16.z + 0].xyzx, r10.yzwy
      add_sat r16.w, r16.w, cb11[r16.z + 0].w
      mul r16.w, r16.w, r25.x
      dp3 r18.x, cb11[r16.z + 1].xyzx, r10.yzwy
      add_sat r18.x, r18.x, cb11[r16.z + 1].w
      mul r16.w, r16.w, r18.x
      dp3 r18.x, cb11[r16.z + 2].xyzx, r10.yzwy
      add_sat r18.x, r18.x, cb11[r16.z + 2].w
      mul r16.w, r16.w, r18.x
      dp3 r18.x, cb11[r16.z + 3].xyzx, r10.yzwy
      add_sat r18.x, r18.x, cb11[r16.z + 3].w
      mul r16.w, r16.w, r18.x
      dp3 r18.x, cb11[r16.z + 4].xyzx, r10.yzwy
      add_sat r18.x, r18.x, cb11[r16.z + 4].w
      mul r16.w, r16.w, r18.x
      dp3 r18.x, cb11[r16.z + 5].xyzx, r10.yzwy
      add_sat r16.z, r18.x, cb11[r16.z + 5].w
      mul r25.x, r16.z, r16.w
      ushr r18.x, r15.w, l(2)
      ubfe r18.w, l(1), l(2), r15.w
      and r19.w, r18.x, l(2)
      max r20.z, r25.x, r25.y
      mad r16.z, -r16.w, r16.z, l(1.000000)
      mul r16.z, r16.z, r25.y
      movc r20.y, r19.w, r16.z, r20.z
      movc r25.xy, r18.wwww, r25.xyxx, r20.xyxx
      iadd r16.y, r16.y, l(1)
      mov r15.w, r18.x
    endloop 
    mov_sat r25.y, r25.y
    mul r13.w, r25.y, cb10[r9.w + 6].y
    lt r14.w, l(0.000000), r13.w
    if_nz r14.w
      mad r24.w, r25.y, cb10[r9.w + 6].y, r24.w
      mul r13.w, r13.w, cb10[r9.w + 7].y
      mov r26.x, cb10[r9.w + 7].w
      mov r26.yz, cb10[r9.w + 8].xxyx
      dp3 r14.w, r17.xyzx, r26.xyzx
      dp3 r15.y, r10.yzwy, r26.xyzx
      add r15.y, r15.y, -cb10[r9.w + 8].z
      ge r15.z, r15.y, l(0.000000)
      max r15.y, r3.w, |r15.y|
      ...
      dp3 r15.y, r17.xyzx, r26.xyzx
      dp3 r15.z, r10.yzwy, r26.xyzx
      ...
      div r15.y, r15.z, r15.y
      min r14.w, r14.w, |r15.y|
      add r26.x, r10.y, cb10[r9.w + 3].w
      add r26.yz, r10.zzwz, cb10[r9.w + 4].xxyx
      mad r15.yzw, r17.xxyz, r14.wwww, r26.xxyz
      dp3 r16.y, r15.yzwy, r15.yzwy
      sqrt r16.y, r16.y
      div r14.w, r14.w, r16.y
      ...
      dp3 r27.x, r15.yzwy, r26.xyzx
      mov r28.xy, cb10[r9.w + 1].xwxx
      mov r28.z, cb10[r9.w + 2].z
      dp3 r27.y, r15.yzwy, r28.xyzx
      mov r29.x, cb10[r9.w + 1].y
      mov r29.yz, cb10[r9.w + 2].xxwx
      dp3 r27.z, r15.yzwy, r29.xyzx
      ubfe r15.y, l(9), l(16), cb10[r9.w + 7].z
      utof r27.w, r15.y
      sample_l_indexable(texturecubearray)(float,float,float,float) r15.yzw, r27.xyzw, t8.wxyz, s2, r14.w
      dp3 r30.x, r10.yzwy, r26.xyzx
      dp3 r30.y, r10.yzwy, r28.xyzx
      dp3 r30.z, r10.yzwy, r29.xyzx
      mad_sat r10.yzw, r30.xxyz, cb10[r9.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
      mul r30.xy, r10.yzyy, cb10[r9.w + 4].zwzz
      mul r30.z, r10.w, cb10[r9.w + 5].x
      add r10.yzw, r30.xxyz, cb10[r9.w + 5].yyzw
      dp3 r27.x, r12.xyzx, r26.xyzx
      dp3 r27.y, r12.xyzx, r28.xyzx
      dp3 r27.z, r12.xyzx, r29.xyzx
      lt r16.yzw, l(0.000000, 0.000000, 0.000000, 0.000000), r27.xxyz
      movc r19.z, r16.y, l(0), l(0.500000)
      add r20.yzw, r10.yyzw, r19.xxyz
      sample_l_indexable(texture3d)(float,float,float,float) r20.yzw, r20.yzwy, t17.wxyz, s4, l(0.000000)
      mul r25.xzw, r27.xxyz, r27.xxyz
      mul r25.xzw, r13.wwww, r25.xxzw
      movc r21.z, r16.z, l(0), l(0.500000)
      add r26.xyz, r10.yzwy, r21.xyzx
      ...
      mad r20.yzw, r20.yyzw, r25.xxxx, r26.xxyz
      movc r22.z, r16.w, l(0), l(0.500000)
      add r10.yzw, r10.yyzw, r22.xxyz
      sample_l_indexable(texture3d)(float,float,float,float) r10.yzw, r10.yzwy, t19.wxyz, s4, l(0.000000)
      mad r10.yzw, r10.yyzw, r25.wwww, r20.yyzw
      sample_l_indexable(texturecubearray)(float,float,float,float) r16.yzw, r27.xyzw, t8.wxyz, s2, l(6.000000)
      mul r20.yzw, r10.yyzw, r16.yyzw
      dp3 r9.w, r20.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r23.xyz, r10.yzwy, r16.yzwy, r23.xyzx
      mul r10.y, r4.w, r9.w
      mul r15.yzw, r13.wwww, r15.yyzw
      dp3 r10.z, r15.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r9.w, r4.w, r9.w, r10.z
      div r9.w, r10.y, r9.w
      mov r26.x, r23.w
      mov r26.yz, r24.yyzy
      mad r24.xyz, r15.yzwy, r9.wwww, r26.xyzx
      mov r23.w, r24.x
    endif 
  endif 
  iadd r8.w, r8.w, l(1)
...
if_nz r8.w
  ...
  loop 
    ...
    if_nz r13.w
      ...
      and r16.y, l(1), cb10[r9.w + 6].x
      movc r16.yz, r16.yyyy, r18.xxyx, r18.zzxz
      mov r16.w, cb10[r9.w + 6].x
      mov r26.xy, r16.yzyy
      mov r18.x, l(1)
      loop 
        ...
        dp3 r20.z, cb11[r18.w + 1].xyzx, r15.yzwy
        add_sat r20.z, r20.z, cb11[r18.w + 1].w
        mul r19.w, r19.w, r20.z
        dp3 r20.z, cb11[r18.w + 2].xyzx, r15.yzwy
        add_sat r20.z, r20.z, cb11[r18.w + 2].w
        mul r19.w, r19.w, r20.z
        dp3 r20.z, cb11[r18.w + 3].xyzx, r15.yzwy
        add_sat r20.z, r20.z, cb11[r18.w + 3].w
        mul r19.w, r19.w, r20.z
        dp3 r20.z, cb11[r18.w + 4].xyzx, r15.yzwy
        add_sat r20.z, r20.z, cb11[r18.w + 4].w
        mul r19.w, r19.w, r20.z
        dp3 r20.z, cb11[r18.w + 5].xyzx, r15.yzwy
        add_sat r18.w, r20.z, cb11[r18.w + 5].w
        mul r26.x, r18.w, r19.w
        ushr r20.z, r16.w, l(2)
        ubfe r20.w, l(1), l(2), r16.w
        and r21.w, r20.z, l(2)
        max r22.w, r26.x, r26.y
        mad r18.w, -r19.w, r18.w, l(1.000000)
        mul r18.w, r18.w, r26.y
        movc r20.y, r21.w, r18.w, r22.w
        movc r26.xy, r20.wwww, r26.xyxx, r20.xyxx
        iadd r18.x, r18.x, l(1)
        mov r16.w, r20.z
      endloop 
      add_sat r13.w, -r24.w, r26.y
      mul r14.w, r13.w, cb10[r9.w + 6].y
      lt r16.y, l(0.000000), r14.w
      if_nz r16.y
        mad r25.w, r13.w, cb10[r9.w + 6].y, r25.w
        mul r13.w, r14.w, cb10[r9.w + 7].y
        mov r27.x, cb10[r9.w + 7].w
        mov r27.yz, cb10[r9.w + 8].xxyx
        dp3 r14.w, r17.xyzx, r27.xyzx
        dp3 r16.y, r15.yzwy, r27.xyzx
        add r16.y, r16.y, -cb10[r9.w + 8].z
        ge r16.z, r16.y, l(0.000000)
        max r16.y, r3.w, |r16.y|
        ...
        dp3 r16.y, r17.xyzx, r27.xyzx
        dp3 r16.z, r15.yzwy, r27.xyzx
        add r16.z, r16.z, -cb10[r9.w + 9].z
        ...
        dp3 r16.y, r17.xyzx, r27.xyzx
        dp3 r16.z, r15.yzwy, r27.xyzx
        add r16.z, r16.z, -cb10[r9.w + 10].z
        ge r16.w, r16.z, l(0.000000)
        max r16.z, r3.w, |r16.z|
        movc r16.z, r16.w, r16.z, -r16.z
        max r16.y, -r16.y, l(0.00000010)
        ...
        dp3 r16.y, r17.xyzx, r27.xyzx
        dp3 r16.z, r15.yzwy, r27.xyzx
        add r16.z, r16.z, -cb10[r9.w + 11].z
        ge r16.w, r16.z, l(0.000000)
        max r16.z, r3.w, |r16.z|
        movc r16.z, r16.w, r16.z, -r16.z
        max r16.y, -r16.y, l(0.00000010)
        ...
        dp3 r16.y, r17.xyzx, r27.xyzx
        dp3 r16.z, r15.yzwy, r27.xyzx
        add r16.z, r16.z, -cb10[r9.w + 12].z
        ge r16.w, r16.z, l(0.000000)
        max r16.z, r3.w, |r16.z|
        movc r16.z, r16.w, r16.z, -r16.z
        max r16.y, -r16.y, l(0.00000010)
        ...
        dp3 r16.y, r17.xyzx, r27.xyzx
        dp3 r16.z, r15.yzwy, r27.xyzx
        add r16.z, r16.z, -cb10[r9.w + 13].z
        ge r16.w, r16.z, l(0.000000)
        max r16.z, r3.w, |r16.z|
        movc r16.z, r16.w, r16.z, -r16.z
        max r16.y, -r16.y, l(0.00000010)
        ...
        mad r16.yzw, r17.xxyz, r14.wwww, r27.xxyz
        ...
        ubfe r16.y, l(9), l(16), cb10[r9.w + 7].z
        utof r28.w, r16.y
        sample_l_indexable(texturecubearray)(float,float,float,float) r16.yzw, r28.xyzw, t8.wxyz, s2, r14.w
        ...
        lt r20.yzw, l(0.000000, 0.000000, 0.000000, 0.000000), r28.xxyz
        movc r19.z, r20.y, l(0), l(0.500000)
        add r26.xzw, r15.yyzw, r19.xxyz
        ...
        mad r15.yzw, r15.yyzw, r27.zzzz, r26.xxzw
        sample_l_indexable(texturecubearray)(float,float,float,float) r20.yzw, r28.xyzw, t8.wxyz, s2, l(6.000000)
        mul r26.xzw, r15.yyzw, r20.yyzw
        dp3 r9.w, r26.xzwx, l(0.212600, 0.715200, 0.072200, 0.000000)
        mad r10.yzw, r15.yyzw, r20.yyzw, r10.yyzw
        mul r14.w, r4.w, r9.w
        mul r15.yzw, r13.wwww, r16.yyzw
...
ret 
// Approximately 1418 instruction slots used
