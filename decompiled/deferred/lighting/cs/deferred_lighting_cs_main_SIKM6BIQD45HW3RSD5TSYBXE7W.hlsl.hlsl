...
r0.y = samplerLinear[]..swiz;
  ...
  r2.x = r0.w ? -0.5 : -0.00146627566;
  r2.x = r2.z + r2.x;
  r2.y = saturate(2.00982332 * r2.x);
  r2.z = dot(-r9.xyz, -r9.xyz);
  r2.z = rsqrt(r2.z);
  r11.xyz = -r9.xyz * r2.zzz;
  r2.x = saturate(dot(r10.xyz, r11.xyz));
  r2.z = dot(-r11.xyz, r10.xyz);
  r2.z = r2.z + r2.z;
  r11.xyz = r10.xyz * -r2.zzz + -r11.xyz;
  r2.z = 17 * r2.y;
  r2.z = exp2(r2.z);
  r2.z = 2 + r2.z;
  r2.z = 2 / r2.z;
  r2.z = sqrt(r2.z);
  r12.xy = renderTargetSize.zw * r1.zw;
  r13.xyzw = gSSAOTexture.Gather(samplerLinearClamp_s, r12.xy).xyzw;
  r12.xyzw = gSSAODepthTexture.Gather(samplerLinearClamp_s, r12.xy).xyzw;
  r1.zw = float2(0.5,0.5) * r1.zw;
  r1.zw = frac(r1.zw);
  r14.xy = float2(1,1) + -r1.wz;
  r15.y = r14.y * r14.x;
  r15.xz = r14.xy * r1.zw;
  r15.w = r1.z * r1.w;
  r1.z = dot(r13.xyzw, r15.xyzw);
  r12.xyzw = r12.xyzw + -r0.zzzz;
  r1.w = min(abs(r12.z), abs(r12.w));
  r1.w = min(abs(r12.y), r1.w);
  r1.w = min(abs(r12.x), r1.w);
  r2.w = max(abs(r12.z), abs(r12.w));
  r2.w = max(abs(r12.y), r2.w);
  r2.w = max(abs(r12.x), r2.w);
  r12.xyz = cmp(r1.www == abs(r12.yzw));
  r1.w = r12.x ? r13.y : r13.x;
  r1.w = r12.y ? r13.z : r1.w;
  r1.w = r12.z ? r13.w : r1.w;
  ...
  r7.w = (int)r7.w + 7;
  r7.w = (uint)r7.w >> 3;
  r0.x = mad((int)r0.y, (int)r7.w, (int)r0.x);
  ...
  r13.w = samplerLinear[]..swiz;
    r14.z = cmp((int)r0.y == (int)r12.w);
    bitmask.w = ((~(-1 << r7.w)) << 0) & 0xffffffff;  r14.w = (((uint)0 << 0) & bitmask.w) | ((uint)r13.w & ~bitmask.w);
    r13.w = r14.z ? r14.w : r13.w;
    r14.z = cmp((int)r8.w == (int)r12.w);
    if (r9.w == 0) r14.w = 0; else if (r9.w+0 < 32) {     r14.w = (uint)r13.w << (32-(r9.w + 0)); r14.w = (uint)r14.w >> (32-r9.w);    } else r14.w = (uint)r13.w >> 0;
    r13.w = r14.z ? r14.w : r13.w;
    r19.xyzw = r17.xyzw;
    r20.xyz = r18.yzw;
    r14.z = r13.w;
    while (true) {
      ...
      r14.w = (int)r14.w * 14;
      r21.xyz = -refProbeConstantsCB[r14.w].data[0].xyz + r9.xyz;
      r15.w = 0x0000ffff & (int)refProbeConstantsCB[r14.w].data[7].z;
      if (6 == 0) r16.w = 0; else if (6+25 < 32) {       r16.w = (uint)refProbeConstantsCB[r14.w].data[7].z << (32-(6 + 25)); r16.w = (uint)r16.w >> (32-6);      } else r16.w = (uint)refProbeConstantsCB[r14.w].data[7].z >> 25;
      r21.w = (int)r15.w * 6;
      r22.x = dot(refProbeAttenuationConstantsCB[r21.w].data[0].xyz, r21.xyz);
      r22.x = saturate(refProbeAttenuationConstantsCB[r21.w].data[0].w + r22.x);
      r22.y = dot(refProbeAttenuationConstantsCB[r21.w].data[1].xyz, r21.xyz);
      r22.y = saturate(refProbeAttenuationConstantsCB[r21.w].data[1].w + r22.y);
      r22.x = r22.x * r22.y;
      r22.y = dot(refProbeAttenuationConstantsCB[r21.w].data[2].xyz, r21.xyz);
      r22.y = saturate(refProbeAttenuationConstantsCB[r21.w].data[2].w + r22.y);
      r22.x = r22.x * r22.y;
      r22.y = dot(refProbeAttenuationConstantsCB[r21.w].data[3].xyz, r21.xyz);
      r22.y = saturate(refProbeAttenuationConstantsCB[r21.w].data[3].w + r22.y);
      r22.x = r22.x * r22.y;
      r22.y = dot(refProbeAttenuationConstantsCB[r21.w].data[4].xyz, r21.xyz);
      r22.y = saturate(refProbeAttenuationConstantsCB[r21.w].data[4].w + r22.y);
      r22.x = r22.x * r22.y;
      r22.y = dot(refProbeAttenuationConstantsCB[r21.w].data[5].xyz, r21.xyz);
      r21.w = saturate(refProbeAttenuationConstantsCB[r21.w].data[5].w + r22.y);
      r12.x = r22.x * r21.w;
      r21.w = 1 & (int)refProbeConstantsCB[r14.w].data[6].x;
      r22.xy = r21.ww ? r12.xy : r12.zx;
      r12.x = refProbeConstantsCB[r14.w].data[6].x;
      r23.xy = r22.xy;
      r21.w = 1;
      while (true) {
        r22.z = cmp((int)r21.w >= (int)r16.w);
        if (r22.z != 0) break;
        r22.z = (int)r15.w + (int)r21.w;
        r22.z = (int)r22.z * 6;
        r22.w = dot(refProbeAttenuationConstantsCB[r22.z].data[0].xyz, r21.xyz);
        r22.w = saturate(refProbeAttenuationConstantsCB[r22.z].data[0].w + r22.w);
        r22.w = r23.x * r22.w;
        r23.z = dot(refProbeAttenuationConstantsCB[r22.z].data[1].xyz, r21.xyz);
        r23.z = saturate(refProbeAttenuationConstantsCB[r22.z].data[1].w + r23.z);
        r22.w = r23.z * r22.w;
        r23.z = dot(refProbeAttenuationConstantsCB[r22.z].data[2].xyz, r21.xyz);
        r23.z = saturate(refProbeAttenuationConstantsCB[r22.z].data[2].w + r23.z);
        r22.w = r23.z * r22.w;
        r23.z = dot(refProbeAttenuationConstantsCB[r22.z].data[3].xyz, r21.xyz);
        r23.z = saturate(refProbeAttenuationConstantsCB[r22.z].data[3].w + r23.z);
        r22.w = r23.z * r22.w;
        r23.z = dot(refProbeAttenuationConstantsCB[r22.z].data[4].xyz, r21.xyz);
        r23.z = saturate(refProbeAttenuationConstantsCB[r22.z].data[4].w + r23.z);
        r22.w = r23.z * r22.w;
        r23.z = dot(refProbeAttenuationConstantsCB[r22.z].data[5].xyz, r21.xyz);
        r22.z = saturate(refProbeAttenuationConstantsCB[r22.z].data[5].w + r23.z);
        r23.x = r22.w * r22.z;
        r23.z = (uint)r12.x >> 2;
        ...
        r22.z = -r22.w * r22.z + 1;
        r22.z = r23.y * r22.z;
        r14.y = r24.x ? r22.z : r24.y;
        r23.xy = r23.ww ? r23.xy : r14.xy;
        r21.w = (int)r21.w + 1;
        r12.x = r23.z;
      }
      r23.y = saturate(r23.y);
      r12.x = refProbeConstantsCB[r14.w].data[6].y * r23.y;
      r14.y = cmp(0 < r12.x);
      if (r14.y != 0) {
        r20.z = r23.y * refProbeConstantsCB[r14.w].data[6].y + r20.z;
        r12.x = refProbeConstantsCB[r14.w].data[7].y * r12.x;
        r22.x = refProbeConstantsCB[r14.w].data[7].w;
        r22.yz = refProbeConstantsCB[r14.w].data[8].xy;
        r14.y = dot(r11.xyz, r22.xyz);
        r15.w = dot(r21.xyz, r22.xyz);
        r15.w = -refProbeConstantsCB[r14.w].data[8].z + r15.w;
        r16.w = cmp(r15.w >= 0);
        r15.w = max(abs(r15.w), r3.x);
        r15.w = r16.w ? r15.w : -r15.w;
        r14.y = max(1.00000001e-07, -r14.y);
        r14.y = r15.w / r14.y;
        r14.y = min(131072, abs(r14.y));
        r22.x = refProbeConstantsCB[r14.w].data[8].w;
        r22.yz = refProbeConstantsCB[r14.w].data[9].xy;
        r15.w = dot(r11.xyz, r22.xyz);
        r16.w = dot(r21.xyz, r22.xyz);
        r16.w = -refProbeConstantsCB[r14.w].data[9].z + r16.w;
        r21.w = cmp(r16.w >= 0);
        r16.w = max(abs(r16.w), r3.x);
        r16.w = r21.w ? r16.w : -r16.w;
        r15.w = max(1.00000001e-07, -r15.w);
        r15.w = r16.w / r15.w;
        r14.y = min(abs(r15.w), r14.y);
        r22.x = refProbeConstantsCB[r14.w].data[9].w;
        r22.yz = refProbeConstantsCB[r14.w].data[10].xy;
        r15.w = dot(r11.xyz, r22.xyz);
        r16.w = dot(r21.xyz, r22.xyz);
        r16.w = -refProbeConstantsCB[r14.w].data[10].z + r16.w;
        r21.w = cmp(r16.w >= 0);
        r16.w = max(abs(r16.w), r3.x);
        r16.w = r21.w ? r16.w : -r16.w;
        r15.w = max(1.00000001e-07, -r15.w);
        r15.w = r16.w / r15.w;
        r14.y = min(abs(r15.w), r14.y);
        r22.x = refProbeConstantsCB[r14.w].data[10].w;
        r22.yz = refProbeConstantsCB[r14.w].data[11].xy;
        r15.w = dot(r11.xyz, r22.xyz);
        r16.w = dot(r21.xyz, r22.xyz);
        r16.w = -refProbeConstantsCB[r14.w].data[11].z + r16.w;
        r21.w = cmp(r16.w >= 0);
        r16.w = max(abs(r16.w), r3.x);
        r16.w = r21.w ? r16.w : -r16.w;
        r15.w = max(1.00000001e-07, -r15.w);
        r15.w = r16.w / r15.w;
        r14.y = min(abs(r15.w), r14.y);
        r22.x = refProbeConstantsCB[r14.w].data[11].w;
        r22.yz = refProbeConstantsCB[r14.w].data[12].xy;
        r15.w = dot(r11.xyz, r22.xyz);
        r16.w = dot(r21.xyz, r22.xyz);
        r16.w = -refProbeConstantsCB[r14.w].data[12].z + r16.w;
        r21.w = cmp(r16.w >= 0);
        r16.w = max(abs(r16.w), r3.x);
        r16.w = r21.w ? r16.w : -r16.w;
        r15.w = max(1.00000001e-07, -r15.w);
        r15.w = r16.w / r15.w;
        r14.y = min(abs(r15.w), r14.y);
        r22.x = refProbeConstantsCB[r14.w].data[12].w;
        r22.yz = refProbeConstantsCB[r14.w].data[13].xy;
        r15.w = dot(r11.xyz, r22.xyz);
        r16.w = dot(r21.xyz, r22.xyz);
        r16.w = -refProbeConstantsCB[r14.w].data[13].z + r16.w;
        r21.w = cmp(r16.w >= 0);
        r16.w = max(abs(r16.w), r3.x);
        r16.w = r21.w ? r16.w : -r16.w;
        r15.w = max(1.00000001e-07, -r15.w);
        r15.w = r16.w / r15.w;
        r14.y = min(abs(r15.w), r14.y);
        r22.x = refProbeConstantsCB[r14.w].data[3].w + r21.x;
        r22.yz = refProbeConstantsCB[r14.w].data[4].xy + r21.yz;
        ...
        r24.x = refProbeConstantsCB[r14.w].data[0].w;
        r24.y = refProbeConstantsCB[r14.w].data[1].z;
        r24.z = refProbeConstantsCB[r14.w].data[2].y;
        r25.x = dot(r22.xyz, r24.xyz);
        r26.xy = refProbeConstantsCB[r14.w].data[1].xw;
        r26.z = refProbeConstantsCB[r14.w].data[2].z;
        r25.y = dot(r22.xyz, r26.xyz);
        r27.x = refProbeConstantsCB[r14.w].data[1].y;
        r27.yz = refProbeConstantsCB[r14.w].data[2].xw;
        r25.z = dot(r22.xyz, r27.xyz);
        if (9 == 0) r15.w = 0; else if (9+16 < 32) {         r15.w = (uint)refProbeConstantsCB[r14.w].data[7].z << (32-(9 + 16)); r15.w = (uint)r15.w >> (32-9);        } else r15.w = (uint)refProbeConstantsCB[r14.w].data[7].z >> 16;
        r25.w = (uint)r15.w;
        ...
        r21.xyz = saturate(r28.xyz * refProbeConstantsCB[r14.w].data[3].xyz + float3(0.5,0.5,0.5));
        r28.xy = refProbeConstantsCB[r14.w].data[4].zw * r21.xy;
        r28.z = refProbeConstantsCB[r14.w].data[5].x * r21.z;
        r21.xyz = refProbeConstantsCB[r14.w].data[5].yzw + r28.xyz;
        r25.x = dot(r10.xyz, r24.xyz);
        r25.y = dot(r10.xyz, r26.xyz);
        r25.z = dot(r10.xyz, r27.xyz);
        r23.xzw = cmp(float3(0,0,0) < r25.xyz);
        r13.z = r23.x ? 0 : 0.5;
        r24.xyz = r21.xyz + r13.xyz;
        r24.xyz = gProbeXArray.SampleLevel(samplerLinearClamp_s, r24.xyz, 0).xyz;
        r26.xyz = r25.xyz * r25.xyz;
        r26.xyz = r26.xyz * r12.xxx;
        r15.z = r23.z ? 0 : 0.5;
        r27.xyz = r21.xyz + r15.xyz;
  ...
  if (r8.w != 0) {
    ...
    r12.w = samplerLinear[]..swiz;
      ...
      if (r7.w == 0) r14.z = 0; else if (r7.w+0 < 32) {       r14.z = (uint)r12.w << (32-(r7.w + 0)); r14.z = (uint)r14.z >> (32-r7.w);      } else r14.z = (uint)r12.w >> 0;
      ...
      while (true) {
        ...
        r14.w = (int)r14.w * 14;
        r23.xyz = -refProbeConstantsCB[r14.w].data[0].xyz + r9.xyz;
        r15.w = 0x0000ffff & (int)refProbeConstantsCB[r14.w].data[7].z;
        if (6 == 0) r16.w = 0; else if (6+25 < 32) {         r16.w = (uint)refProbeConstantsCB[r14.w].data[7].z << (32-(6 + 25)); r16.w = (uint)r16.w >> (32-6);        } else r16.w = (uint)refProbeConstantsCB[r14.w].data[7].z >> 25;
        r20.w = (int)r15.w * 6;
        ...
        r24.xy = r20.ww ? r12.xy : r12.zx;
        r12.x = refProbeConstantsCB[r14.w].data[6].x;
        r25.xy = r24.xy;
        r20.w = 1;
        while (true) {
          r22.w = cmp((int)r20.w >= (int)r16.w);
          if (r22.w != 0) break;
          r22.w = (int)r15.w + (int)r20.w;
          r22.w = (int)r22.w * 6;
          r23.w = dot(refProbeAttenuationConstantsCB[r22.w].data[0].xyz, r23.xyz);
          r23.w = saturate(refProbeAttenuationConstantsCB[r22.w].data[0].w + r23.w);
          r23.w = r25.x * r23.w;
          r24.z = dot(refProbeAttenuationConstantsCB[r22.w].data[1].xyz, r23.xyz);
          r24.z = saturate(refProbeAttenuationConstantsCB[r22.w].data[1].w + r24.z);
          r23.w = r24.z * r23.w;
          r24.z = dot(refProbeAttenuationConstantsCB[r22.w].data[2].xyz, r23.xyz);
          r24.z = saturate(refProbeAttenuationConstantsCB[r22.w].data[2].w + r24.z);
          r23.w = r24.z * r23.w;
          r24.z = dot(refProbeAttenuationConstantsCB[r22.w].data[3].xyz, r23.xyz);
          r24.z = saturate(refProbeAttenuationConstantsCB[r22.w].data[3].w + r24.z);
          r23.w = r24.z * r23.w;
          r24.z = dot(refProbeAttenuationConstantsCB[r22.w].data[4].xyz, r23.xyz);
          r24.z = saturate(refProbeAttenuationConstantsCB[r22.w].data[4].w + r24.z);
          r23.w = r24.z * r23.w;
          r24.z = dot(refProbeAttenuationConstantsCB[r22.w].data[5].xyz, r23.xyz);
          r22.w = saturate(refProbeAttenuationConstantsCB[r22.w].data[5].w + r24.z);
          r25.x = r23.w * r22.w;
          r24.z = (uint)r12.x >> 2;
          ...
          r22.w = -r23.w * r22.w + 1;
          r22.w = r25.y * r22.w;
          r14.y = r25.z ? r22.w : r25.w;
          r25.xy = r24.ww ? r25.xy : r14.xy;
          r20.w = (int)r20.w + 1;
          r12.x = r24.z;
        }
        r12.x = saturate(r25.y + -r13.w);
        r14.y = refProbeConstantsCB[r14.w].data[6].y * r12.x;
        r15.w = cmp(0 < r14.y);
        if (r15.w != 0) {
          r21.w = r12.x * refProbeConstantsCB[r14.w].data[6].y + r21.w;
          r12.x = refProbeConstantsCB[r14.w].data[7].y * r14.y;
          ...
          r15.w = r16.w / r15.w;
          r14.y = min(abs(r15.w), r14.y);
          r24.x = refProbeConstantsCB[r14.w].data[3].w + r23.x;
          r24.yz = refProbeConstantsCB[r14.w].data[4].xy + r23.yz;
          ...
          r23.xyz = saturate(r30.xyz * refProbeConstantsCB[r14.w].data[3].xyz + float3(0.5,0.5,0.5));
          r30.xy = refProbeConstantsCB[r14.w].data[4].zw * r23.xy;
          r30.z = refProbeConstantsCB[r14.w].data[5].x * r23.z;
          r23.xyz = refProbeConstantsCB[r14.w].data[5].yzw + r30.xyz;
          r27.x = dot(r10.xyz, r26.xyz);
          r27.y = dot(r10.xyz, r28.xyz);
          r27.z = dot(r10.xyz, r29.xyz);
          r25.xzw = cmp(float3(0,0,0) < r27.xyz);
          r13.z = r25.x ? 0 : 0.5;
          r26.xyz = r23.xyz + r13.xyz;
          r26.xyz = gProbeXArray.SampleLevel(samplerLinearClamp_s, r26.xyz, 0).xyz;
          r28.xyz = r27.xyz * r27.xyz;
          r28.xyz = r28.xyz * r12.xxx;
          r15.z = r25.z ? 0 : 0.5;
          r29.xyz = r23.xyz + r15.xyz;
  ...
  if (r0.y != 0) {
    ...
    r11.w = 0;
    r10.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r11.xyzw, r2.w).xyz;
  ...
  r0.yz = r2.xy * float2(0.984375,0.984375) + float2(0.0078125,0.0078125);
