...
r0.y = samp0[]..swiz;
  ...
  r9.y = dot(r15.yzw, float3(0.212599993,0.715200007,0.0722000003));
  r16.w = 0;
  r17.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r16.xyzw, r8.w).xyz;
  r8.w = sunConstants.globalProbeExposure + -r9.y;
  r8.w = r2.y * r8.w + r9.y;
  ...
  r9.yw = r2.xy * float2(0.984375,0.984375) + float2(0.0078125,0.0078125);
  r9.yw = gEnvBRDFGeneric.SampleLevel(samplerLinear_s, r9.yw, 0).xy;
  r17.xyz = r17.xyz * r2.zzz;
  r20.xyz = r17.xyz * r9.yyy;
  ...
  if (r4.z != 0) {
    ...
    if (r4.z != 0) {
      ...
      if (sunConstants.sunCookieIndex != 0) {
        ...
        r9.y = dot(sunConstants.sunCookieTransform[1].xyzw, r21.xyzw);
        r21.x = frac(r8.w);
        r21.y = frac(r9.y);
      ...
      r9.y = cmp(0 < (uint)r8.w);
      r9.y = r9.y ? r9.z : 0;
      if (r9.y != 0) {
        r8.w = (int)r8.w + numLights;
        r8.w = mad((int)r8.w, 15, -15);
        r9.y = abs(r5.w) * -0.200000003 + 0.400000006;
        r9.w = cmp(r5.w < 0);
        r9.w = r0.w ? r9.w : 0;
        r9.y = r9.w ? -r9.y : r9.y;
        r22.xyz = r11.xyz * r9.yyy + r10.xyz;
        r23.xyz = lightConstantsCB[r8.w].data[4].yzw;
        r23.w = lightConstantsCB[r8.w].data[5].x;
        r22.w = 1;
        r23.x = dot(r23.xyzw, r22.xyzw);
        r24.xyz = lightConstantsCB[r8.w].data[5].yzw;
        r24.w = lightConstantsCB[r8.w].data[6].x;
        r23.y = dot(r24.xyzw, r22.xyzw);
        r9.yw = r23.xy * float2(0.5,-0.5) + float2(0.5,0.5);
        r23.x = lightConstantsCB[r8.w].data[9].w + r9.y;
        r23.y = lightConstantsCB[r8.w].data[10].x + r9.w;
        r9.yw = lightConstantsCB[r8.w].data[9].yz * r23.xy;
        r13.zw = lightConstantsCB[r8.w].data[3].yy / lightConstantsCB[r8.w].data[8].yw;
        r23.xy = float2(1,1) + -r13.zw;
        r23.xy = cmp(r9.yw >= r23.xy);
        r13.zw = cmp(r13.zw >= r9.yw);
        r13.zw = (int2)r13.zw | (int2)r23.xy;
        r11.w = (int)r13.w | (int)r13.z;
        if (r11.w == 0) {
          r23.xyz = lightConstantsCB[r8.w].data[6].yzw;
          r23.w = lightConstantsCB[r8.w].data[7].x;
          r11.w = dot(r23.xyzw, r22.xyzw);
          r9.yw = saturate(r9.yw);
          r22.x = r9.y * lightConstantsCB[r8.w].data[8].y + lightConstantsCB[r8.w].data[8].z;
          r22.y = r9.w * lightConstantsCB[r8.w].data[8].w + lightConstantsCB[r8.w].data[9].x;
          r9.y = lightConstantsCB[r8.w].data[10].y + r11.w;
          r9.y = r9.y / lightConstantsCB[r8.w].data[10].z;
          r9.y = max(6.10351563e-05, r9.y);
          r9.w = 0x0000ffff & (int)lightConstantsCB[r8.w].data[1].w;
          if (enableDitheredShadow != 0) {
            r23.x = -r13.x;
            r24.z = (uint)r9.w;
            r23.y = r14.x;
            ...
            while (true) {
              ...
              if (r13.z != 0) break;
              r25.x = dot(icb[r12.w+0].yx, r23.xy);
              r25.y = dot(icb[r12.w+0].yx, r23.yz);
              r24.xy = r25.xy * lightConstantsCB[r8.w].data[3].yy + r22.xy;
              r13.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r24.xyz, r9.y).x;
              r11.w = r13.z * 0.125 + r11.w;
              r12.w = (int)r12.w + 1;
            }
          } else {
            r22.z = (uint)r9.w;
            r11.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r22.xyz, r9.y).x;
          }
          r8.w = r11.w * r11.w;
          r8.w = r8.w * r11.w;
        } else {
      ...
      r8.w = abs(r2.w) * r1.z + -abs(r2.w);
      r2.w = abs(r2.w) * r8.w + 1;
      r6.w = r6.w * r2.y + r2.z;
      r2.w = r2.w * r2.w;
      r2.w = r2.w * r6.w;
      r2.w = rcp(r2.w);
      ...
      r2.w = r9.x * r2.w;
      r2.w = 0.25 * r2.w;
      r23.yzw = r2.www * r21.xyz + r17.xyz;
      ...
      r15.yzw = r7.www * r21.xyz + r19.zxy;
