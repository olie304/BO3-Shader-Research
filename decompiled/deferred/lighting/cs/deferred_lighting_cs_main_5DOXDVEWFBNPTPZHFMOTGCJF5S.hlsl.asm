...
uge r8.w, r0.x, r7.w
ult r9.x, r0.x, cb2[0].y
and r8.w, r8.w, r9.x
if_nz r8.w
  imul null, r8.w, r0.x, l(14)
  add r9.xyw, r10.xyxz, -cb10[r8.w + 0].xyxz
  and r12.w, l(0x0000ffff), cb10[r8.w + 7].z
  ubfe r13.y, l(6), l(25), cb10[r8.w + 7].z
  imul null, r13.z, r12.w, l(6)
  dp3 r13.w, cb11[r13.z + 0].xyzx, r9.xywx
  add_sat r13.w, r13.w, cb11[r13.z + 0].w
  dp3 r15.x, cb11[r13.z + 1].xyzx, r9.xywx
  add_sat r15.x, r15.x, cb11[r13.z + 1].w
  mul r13.w, r13.w, r15.x
  dp3 r15.x, cb11[r13.z + 2].xyzx, r9.xywx
  add_sat r15.x, r15.x, cb11[r13.z + 2].w
  mul r13.w, r13.w, r15.x
  dp3 r15.x, cb11[r13.z + 3].xyzx, r9.xywx
  add_sat r15.x, r15.x, cb11[r13.z + 3].w
  mul r13.w, r13.w, r15.x
  dp3 r15.x, cb11[r13.z + 4].xyzx, r9.xywx
  add_sat r15.x, r15.x, cb11[r13.z + 4].w
  mul r13.w, r13.w, r15.x
  dp3 r15.x, cb11[r13.z + 5].xyzx, r9.xywx
  add_sat r13.z, r15.x, cb11[r13.z + 5].w
  mul r15.x, r13.z, r13.w
  and r13.z, l(1), cb10[r8.w + 6].x
  mov r15.yz, l(0,0,1.000000,0)
  movc r13.zw, r13.zzzz, r15.xxxy, r15.zzzx
  mov r15.x, l(1.000000)
  mov r15.z, cb10[r8.w + 6].x
  mov r16.xy, r13.zwzz
  mov r15.w, l(1)
  loop 
    ige r16.z, r15.w, r13.y
    breakc_nz r16.z
    iadd r16.z, r12.w, r15.w
    imul null, r16.z, r16.z, l(6)
    dp3 r16.w, cb11[r16.z + 0].xyzx, r9.xywx
    add_sat r16.w, r16.w, cb11[r16.z + 0].w
    mul r16.w, r16.w, r16.x
    dp3 r17.x, cb11[r16.z + 1].xyzx, r9.xywx
    add_sat r17.x, r17.x, cb11[r16.z + 1].w
    mul r16.w, r16.w, r17.x
    dp3 r17.x, cb11[r16.z + 2].xyzx, r9.xywx
    add_sat r17.x, r17.x, cb11[r16.z + 2].w
    mul r16.w, r16.w, r17.x
    dp3 r17.x, cb11[r16.z + 3].xyzx, r9.xywx
    add_sat r17.x, r17.x, cb11[r16.z + 3].w
    mul r16.w, r16.w, r17.x
    dp3 r17.x, cb11[r16.z + 4].xyzx, r9.xywx
    add_sat r17.x, r17.x, cb11[r16.z + 4].w
    mul r16.w, r16.w, r17.x
    dp3 r17.x, cb11[r16.z + 5].xyzx, r9.xywx
    add_sat r16.z, r17.x, cb11[r16.z + 5].w
    mul r16.x, r16.z, r16.w
    ushr r17.x, r15.z, l(2)
    ubfe r17.y, l(1), l(2), r15.z
    and r17.z, r17.x, l(2)
    max r17.w, r16.x, r16.y
    mad r16.z, -r16.w, r16.z, l(1.000000)
    mul r16.z, r16.z, r16.y
    movc r15.y, r17.z, r16.z, r17.w
    movc r16.xy, r17.yyyy, r16.xyxx, r15.xyxx
    iadd r15.w, r15.w, l(1)
    mov r15.z, r17.x
  endloop 
  mov_sat r16.y, r16.y
  mul r12.w, r16.y, cb10[r8.w + 6].y
  lt r13.y, l(0.000000), r12.w
  if_nz r13.y
    mul r13.y, r12.w, cb10[r8.w + 7].y
    mov r15.x, cb10[r8.w + 7].w
    mov r15.yz, cb10[r8.w + 8].xxyx
    dp3 r13.z, r14.xyzx, r15.xyzx
    dp3 r13.w, r9.xywx, r15.xyzx
    ...
    div r13.w, r15.x, r13.w
    min r13.z, |r13.w|, r13.z
    add r15.x, r9.x, cb10[r8.w + 3].w
    add r15.yz, r9.yywy, cb10[r8.w + 4].xxyx
    mad r15.xyz, r14.xyzx, r13.zzzz, r15.xyzx
    ...
    utof r17.w, r13.w
    sample_l_indexable(texturecubearray)(float,float,float,float) r15.xyz, r17.xyzw, t8.xyzw, s2, r13.z
    dp3 r20.x, r9.xywx, r16.xyzx
    dp3 r20.y, r9.xywx, r18.xyzx
    dp3 r20.z, r9.xywx, r19.xyzx
    mad_sat r9.xyw, r20.xyxz, cb10[r8.w + 3].xyxz, l(0.500000, 0.500000, 0.000000, 0.500000)
    mul r20.xy, r9.xyxx, cb10[r8.w + 4].zwzz
    mul r20.z, r9.w, cb10[r8.w + 5].x
    add r9.xyw, r20.xyxz, cb10[r8.w + 5].yzyw
    ...
    mov r18.xy, l(0,0,0,0)
    add r9.xyw, r9.xyxw, r18.xyxz
    sample_l_indexable(texture3d)(float,float,float,float) r9.xyw, r9.xywx, t19.xywz, s4, l(0.000000)
    mad r9.xyw, r9.xyxw, r19.zzzz, r16.xyxw
    sample_l_indexable(texturecubearray)(float,float,float,float) r16.xyz, r17.xyzw, t8.xyzw, s2, l(6.000000)
    mul r9.xyw, r9.xyxw, r16.xyxz
    dp3 r8.w, r9.xywx, l(0.212600, 0.715200, 0.072200, 0.000000)
    mul r13.z, r6.w, r8.w
    mul r15.xyz, r13.yyyy, r15.xyzx
    dp3 r13.y, r15.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
    mad r8.w, r6.w, r8.w, r13.y
    div r8.w, r13.z, r8.w
...
lt r8.w, r12.w, l(1.000000)
if_nz r8.w
  ult r7.w, r0.x, r7.w
  if_nz r7.w
    imul null, r0.x, r0.x, l(14)
    add r15.xyz, r10.xyzx, -cb10[r0.x + 0].xyzx
    and r7.w, l(0x0000ffff), cb10[r0.x + 7].z
    ubfe r8.w, l(6), l(25), cb10[r0.x + 7].z
    imul null, r15.w, r7.w, l(6)
    ...
    mov r16.z, l(1)
    loop 
      ige r16.w, r16.z, r8.w
      breakc_nz r16.w
      iadd r16.w, r7.w, r16.z
      ...
      mov r15.w, r17.w
    endloop 
    add_sat r7.w, -r12.w, r18.y
    mul r8.w, r7.w, cb10[r0.x + 6].y
    lt r15.w, l(0.000000), r8.w
    if_nz r15.w
      mad r12.w, r7.w, cb10[r0.x + 6].y, r12.w
      mul r7.w, r8.w, cb10[r0.x + 7].y
      mov r16.x, cb10[r0.x + 7].w
      mov r16.yz, cb10[r0.x + 8].xxyx
      dp3 r8.w, r14.xyzx, r16.xyzx
      dp3 r15.w, r15.xyzx, r16.xyzx
      ...
      mov r16.x, cb10[r0.x + 8].w
      mov r16.yz, cb10[r0.x + 9].xxyx
      dp3 r15.w, r14.xyzx, r16.xyzx
      dp3 r16.x, r15.xyzx, r16.xyzx
      add r16.x, r16.x, -cb10[r0.x + 9].z
      ...
      min r8.w, r8.w, |r15.w|
      mov r16.x, cb10[r0.x + 9].w
      mov r16.yz, cb10[r0.x + 10].xxyx
      dp3 r15.w, r14.xyzx, r16.xyzx
      dp3 r16.x, r15.xyzx, r16.xyzx
      add r16.x, r16.x, -cb10[r0.x + 10].z
      ge r16.y, r16.x, l(0.000000)
      max r16.x, r5.w, |r16.x|
      movc r16.x, r16.y, r16.x, -r16.x
      max r15.w, -r15.w, l(0.00000010)
      div r15.w, r16.x, r15.w
      min r8.w, r8.w, |r15.w|
      mov r16.x, cb10[r0.x + 10].w
      mov r16.yz, cb10[r0.x + 11].xxyx
      dp3 r15.w, r14.xyzx, r16.xyzx
      dp3 r16.x, r15.xyzx, r16.xyzx
      add r16.x, r16.x, -cb10[r0.x + 11].z
      ge r16.y, r16.x, l(0.000000)
      max r16.x, r5.w, |r16.x|
      movc r16.x, r16.y, r16.x, -r16.x
      max r15.w, -r15.w, l(0.00000010)
      div r15.w, r16.x, r15.w
      min r8.w, r8.w, |r15.w|
      mov r16.x, cb10[r0.x + 11].w
      mov r16.yz, cb10[r0.x + 12].xxyx
      dp3 r15.w, r14.xyzx, r16.xyzx
      dp3 r16.x, r15.xyzx, r16.xyzx
      add r16.x, r16.x, -cb10[r0.x + 12].z
      ge r16.y, r16.x, l(0.000000)
      max r16.x, r5.w, |r16.x|
      movc r16.x, r16.y, r16.x, -r16.x
      max r15.w, -r15.w, l(0.00000010)
      div r15.w, r16.x, r15.w
      min r8.w, r8.w, |r15.w|
      mov r16.x, cb10[r0.x + 12].w
      mov r16.yz, cb10[r0.x + 13].xxyx
      dp3 r15.w, r14.xyzx, r16.xyzx
      dp3 r16.x, r15.xyzx, r16.xyzx
      add r16.x, r16.x, -cb10[r0.x + 13].z
      ge r16.y, r16.x, l(0.000000)
      max r5.w, r5.w, |r16.x|
      movc r5.w, r16.y, r5.w, -r5.w
      max r15.w, -r15.w, l(0.00000010)
      div r5.w, r5.w, r15.w
      min r5.w, |r5.w|, r8.w
      add r16.x, r15.x, cb10[r0.x + 3].w
      add r16.yz, r15.yyzy, cb10[r0.x + 4].xxyx
      mad r16.xyz, r14.xyzx, r5.wwww, r16.xyzx
      ...
      mov r17.x, cb10[r0.x + 0].w
      mov r17.y, cb10[r0.x + 1].z
      mov r17.z, cb10[r0.x + 2].y
      dp3 r18.x, r16.xyzx, r17.xyzx
      mov r19.xy, cb10[r0.x + 1].xwxx
      mov r19.z, cb10[r0.x + 2].z
      dp3 r18.y, r16.xyzx, r19.xyzx
      mov r20.x, cb10[r0.x + 1].y
      mov r20.yz, cb10[r0.x + 2].xxwx
      dp3 r18.z, r16.xyzx, r20.xyzx
      ubfe r5.w, l(9), l(16), cb10[r0.x + 7].z
      utof r18.w, r5.w
      sample_l_indexable(texturecubearray)(float,float,float,float) r16.xyz, r18.xyzw, t8.xyzw, s2, r2.z
      dp3 r21.x, r15.xyzx, r17.xyzx
      dp3 r21.y, r15.xyzx, r19.xyzx
      dp3 r21.z, r15.xyzx, r20.xyzx
      mad_sat r15.xyz, r21.xyzx, cb10[r0.x + 3].xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
      mul r21.xy, r15.xyxx, cb10[r0.x + 4].zwzz
      mul r21.z, r15.z, cb10[r0.x + 5].x
      add r15.xyz, r21.xyzx, cb10[r0.x + 5].yzwy
      ...
      dp3 r0.x, r18.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r9.xyw, r15.xyxz, r17.xyxz, r9.xyxw
      mul r2.z, r0.x, r6.w
      mul r15.xyz, r7.wwww, r16.xyzx
      dp3 r5.w, r15.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r0.x, r6.w, r0.x, r5.w
      div r0.x, r2.z, r0.x
      mad r13.yzw, r15.xxyz, r0.xxxx, r13.yyzw
    endif 
  endif 
endif 
max r0.x, r12.w, l(1.000000)
rcp r0.x, r0.x
mov_sat r12.w, r12.w
mul r15.xyz, r0.xxxx, r9.xywx
mul r13.yzw, r0.xxxx, r13.yyzw
lt r2.z, r12.w, l(0.990000)
if_nz r2.z
  add r2.z, -r12.w, l(1.000000)
  ...
  dp3 r5.w, r16.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
  mad r15.xyz, r9.xywx, r0.xxxx, r16.xyzx
  mov r14.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r9.xyw, r14.xyzw, t8.xywz, s2, r2.w
  mad r0.x, cb2[19].x, r2.z, -r5.w
  mad r0.x, r2.y, r0.x, r5.w
  mad r13.yzw, r9.xxyw, r0.xxxx, r13.yyzw
endif 
...
mul r2.yzw, r0.xxxx, r13.yyzw
mul r13.yzw, r1.zzzz, r2.yyzw
  ...
  if_nz r11.w
    ...
    if_nz r11.w
      ...
      if_nz r11.w
        ...
        mad r17.xyz, r4.zzzz, r16.xyzx, r9.xywx
        ...
        mul r1.w, r1.w, r6.w
        mul r1.w, r1.w, r4.z
        mad r15.xyz, r1.wwww, r16.xyzx, r13.yzwy
        movc r9.xyw, r5.wwww, r17.xyxz, r9.xyxw
        movc r13.yzw, r5.wwww, r15.xxyz, r13.yyzw
  ...
  if_nz r6.w
    ...
    if_nz r6.w
      ...
      if_nz r7.w
        ...
        mad r15.xyz, r0.yyyy, r16.xyzx, r9.xywx
        mad r14.xyz, r14.xyzx, r1.wwww, r12.xyzx
        ...
        mul r0.y, r0.z, r0.y
        mul r0.x, r0.y, r0.x
        mad r0.xyz, r0.xxxx, r16.xyzx, r13.yzwy
        movc r9.xyw, r0.wwww, r15.xyxz, r9.xyxw
        movc r13.yzw, r0.wwww, r0.xxyz, r13.yyzw
...
ret 
// Approximately 1371 instruction slots used
