...
// unknown dcl_: dcl_thread_group 8, 8, 1
  r0.x = mad(permuteStride, 53, (int)vThreadGroupID.x);
...
r0.y = samplerLinear[]..swiz;
  ...
  r1.z = rsqrt(r1.z);
  r2.yzw = -r9.xyz * r1.zzz;
  r1.x = saturate(dot(r10.xyz, r2.yzw));
  r1.z = dot(-r2.yzw, r10.xyz);
  r1.z = r1.z + r1.z;
  r11.xyz = r10.xyz * -r1.zzz + -r2.yzw;
  r1.z = 17 * r1.y;
  r1.z = exp2(r1.z);
  r1.z = 2 + r1.z;
  r1.z = 2 / r1.z;
  r1.z = sqrt(r1.z);
  r2.yz = renderTargetSize.zw * r0.zw;
  r12.xyzw = gSSAOTexture.Gather(samplerLinearClamp_s, r2.yz).xyzw;
  r13.xyzw = gSSAODepthTexture.Gather(samplerLinearClamp_s, r2.yz).xyzw;
  r0.zw = float2(0.5,0.5) * r0.zw;
  r0.zw = frac(r0.zw);
  r2.yz = float2(1,1) + -r0.wz;
  r14.y = r2.z * r2.y;
  r14.xz = r2.yz * r0.zw;
  r14.w = r0.z * r0.w;
  ...
  r2.yzw = cmp(r0.www == abs(r13.yzw));
  r0.w = r2.y ? r12.y : r12.x;
  r0.w = r2.z ? r12.z : r0.w;
  r0.w = r2.w ? r12.w : r0.w;
  ...
  r1.w = 1 + -r1.y;
  r1.w = 5 * r1.w;
  r2.xyz = -globalProbeConstants.data[0].xyz + r9.xyz;
  r12.x = globalProbeConstants.data[0].w * r2.x;
  r12.yz = globalProbeConstants.data[1].xy * r2.yz;
  r2.xyz = saturate(float3(0.5,0.5,0.5) + r12.xyz);
  r12.xy = globalProbeConstants.data[1].zw * r2.xy;
  r12.z = globalProbeConstants.data[2].x * r2.z;
  r2.xyz = globalProbeConstants.data[2].yzw + r12.xyz;
  r12.xyz = cmp(float3(0,0,0) < r10.xyz);
  r12.xyz = r12.xyz ? float3(0,0,0) : float3(0.5,0.5,0.5);
  r12.w = 0;
  r13.xyz = r12.wwx + r2.xyz;
  ...
  r2.xyz = r12.wwz + r2.xyz;
  r2.xyz = gProbeZArray.SampleLevel(samplerLinearClamp_s, r2.xyz, 0).xyz;
  r2.xyz = r2.xyz * r14.zzz + r13.xyz;
  r10.w = 0;
  ...
  r1.w = sunConstants.globalProbeExposure + -r2.w;
  r1.w = r1.y * r1.w + r2.w;
