...
if_nz r2.z
  ...
  if_nz r2.z
    ...
    max r3.x, r12.y, r12.x
    add r12.xyw, r14.xyxz, -r15.xyxz
    mad r12.xyw, r3.xxxx, r12.xyxw, r15.xyxz
    ...
    mad r13.xyw, r3.xxxx, r16.xyxz, r13.xyxw
    ...
    sample_l_indexable(texture2d)(float,float,float,float) r3.x, r17.xyxx, t28.xyzw, s1, r2.z
    min r2.w, |r2.w|, |r3.x|
    mul r2.w, r17.z, r2.w
  ...
  mad r3.x, r0.z, l(-2.000000), l(3.000000)
  mul r0.z, r0.z, r0.z
  mul r0.z, r0.z, r3.x
  mul r0.z, r0.z, r2.z
  mul r0.z, r13.y, r0.z
...
loop 
  ...
  bfi r15.w, r8.w, l(0), l(0), r14.w
  movc r14.w, r15.z, r15.w, r14.w
  ieq r15.z, r9.w, r13.w
  ubfe r15.w, r12.w, l(0), r14.w
  movc r14.w, r15.z, r15.w, r14.w
  ...
  loop 
    ...
    add r22.xyz, r9.xyzx, -cb10[r15.w + 0].xyzx
    and r16.w, l(0x0000ffff), cb10[r15.w + 7].z
    ubfe r17.w, l(6), l(25), cb10[r15.w + 7].z
    imul null, r22.w, r16.w, l(6)
    dp3 r23.x, cb11[r22.w + 0].xyzx, r22.xyzx
    add_sat r23.x, r23.x, cb11[r22.w + 0].w
    dp3 r23.y, cb11[r22.w + 1].xyzx, r22.xyzx
    add_sat r23.y, r23.y, cb11[r22.w + 1].w
    mul r23.x, r23.y, r23.x
    dp3 r23.y, cb11[r22.w + 2].xyzx, r22.xyzx
    add_sat r23.y, r23.y, cb11[r22.w + 2].w
    mul r23.x, r23.y, r23.x
    dp3 r23.y, cb11[r22.w + 3].xyzx, r22.xyzx
    add_sat r23.y, r23.y, cb11[r22.w + 3].w
    mul r23.x, r23.y, r23.x
    dp3 r23.y, cb11[r22.w + 4].xyzx, r22.xyzx
    add_sat r23.y, r23.y, cb11[r22.w + 4].w
    mul r23.x, r23.y, r23.x
    dp3 r23.y, cb11[r22.w + 5].xyzx, r22.xyzx
    add_sat r22.w, r23.y, cb11[r22.w + 5].w
    mul r13.x, r22.w, r23.x
    and r22.w, l(1), cb10[r15.w + 6].x
    movc r23.xy, r22.wwww, r13.xyxx, r13.zxzz
    mov r13.x, cb10[r15.w + 6].x
    mov r24.xy, r23.xyxx
    mov r22.w, l(1)
    loop 
      ige r23.z, r22.w, r17.w
      breakc_nz r23.z
      iadd r23.z, r16.w, r22.w
      imul null, r23.z, r23.z, l(6)
      dp3 r23.w, cb11[r23.z + 0].xyzx, r22.xyzx
      add_sat r23.w, r23.w, cb11[r23.z + 0].w
      mul r23.w, r23.w, r24.x
      dp3 r24.z, cb11[r23.z + 1].xyzx, r22.xyzx
      add_sat r24.z, r24.z, cb11[r23.z + 1].w
      mul r23.w, r23.w, r24.z
      dp3 r24.z, cb11[r23.z + 2].xyzx, r22.xyzx
      add_sat r24.z, r24.z, cb11[r23.z + 2].w
      mul r23.w, r23.w, r24.z
      dp3 r24.z, cb11[r23.z + 3].xyzx, r22.xyzx
      add_sat r24.z, r24.z, cb11[r23.z + 3].w
      mul r23.w, r23.w, r24.z
      dp3 r24.z, cb11[r23.z + 4].xyzx, r22.xyzx
      add_sat r24.z, r24.z, cb11[r23.z + 4].w
      mul r23.w, r23.w, r24.z
      dp3 r24.z, cb11[r23.z + 5].xyzx, r22.xyzx
      add_sat r23.z, r24.z, cb11[r23.z + 5].w
      ...
      mul r23.z, r23.z, r24.y
      movc r15.y, r25.x, r23.z, r25.y
      movc r24.xy, r24.wwww, r24.xyxx, r15.xyxx
      iadd r22.w, r22.w, l(1)
      mov r13.x, r24.z
    endloop 
    mov_sat r24.y, r24.y
    mul r13.x, r24.y, cb10[r15.w + 6].y
    lt r15.y, l(0.000000), r13.x
    if_nz r15.y
      mad r21.z, r24.y, cb10[r15.w + 6].y, r21.z
      mul r13.x, r13.x, cb10[r15.w + 7].y
      mov r23.x, cb10[r15.w + 7].w
      mov r23.yz, cb10[r15.w + 8].xxyx
      dp3 r15.y, r11.xyzx, r23.xyzx
      dp3 r16.w, r22.xyzx, r23.xyzx
      add r16.w, r16.w, -cb10[r15.w + 8].z
      ...
      mad r23.xyz, r11.xyzx, r15.yyyy, r23.xyzx
      dp3 r16.w, r23.xyzx, r23.xyzx
      sqrt r16.w, r16.w
      div r15.y, r15.y, r16.w
      ...
      dp3 r26.x, r23.xyzx, r25.xyzx
      mov r27.xy, cb10[r15.w + 1].xwxx
      mov r27.z, cb10[r15.w + 2].z
      dp3 r26.y, r23.xyzx, r27.xyzx
      mov r28.x, cb10[r15.w + 1].y
      mov r28.yz, cb10[r15.w + 2].xxwx
      dp3 r26.z, r23.xyzx, r28.xyzx
      ubfe r16.w, l(9), l(16), cb10[r15.w + 7].z
      utof r26.w, r16.w
      sample_l_indexable(texturecubearray)(float,float,float,float) r23.xyz, r26.xyzw, t8.xyzw, s2, r15.y
      dp3 r29.x, r22.xyzx, r25.xyzx
      dp3 r29.y, r22.xyzx, r27.xyzx
      dp3 r29.z, r22.xyzx, r28.xyzx
      mad_sat r22.xyz, r29.xyzx, cb10[r15.w + 3].xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
      mul r29.xy, r22.xyxx, cb10[r15.w + 4].zwzz
      mul r29.z, r22.z, cb10[r15.w + 5].x
      add r22.xyz, r29.xyzx, cb10[r15.w + 5].yzwy
      ...
      movc r17.z, r24.w, l(0), l(0.500000)
...
if_nz r9.w
  ...
  loop 
    ...
    ieq r14.w, r0.y, r12.w
    ubfe r15.z, r8.w, l(0), r13.w
    ...
    loop 
      ...
      imul null, r15.w, r15.w, l(14)
      add r24.xyz, r9.xyzx, -cb10[r15.w + 0].xyzx
      and r16.w, l(0x0000ffff), cb10[r15.w + 7].z
      ubfe r17.w, l(6), l(25), cb10[r15.w + 7].z
      imul null, r21.w, r16.w, l(6)
      dp3 r23.w, cb11[r21.w + 0].xyzx, r24.xyzx
      add_sat r23.w, r23.w, cb11[r21.w + 0].w
      dp3 r24.w, cb11[r21.w + 1].xyzx, r24.xyzx
      add_sat r24.w, r24.w, cb11[r21.w + 1].w
      mul r23.w, r23.w, r24.w
      dp3 r24.w, cb11[r21.w + 2].xyzx, r24.xyzx
      add_sat r24.w, r24.w, cb11[r21.w + 2].w
      mul r23.w, r23.w, r24.w
      dp3 r24.w, cb11[r21.w + 3].xyzx, r24.xyzx
      add_sat r24.w, r24.w, cb11[r21.w + 3].w
      mul r23.w, r23.w, r24.w
      dp3 r24.w, cb11[r21.w + 4].xyzx, r24.xyzx
      add_sat r24.w, r24.w, cb11[r21.w + 4].w
      mul r23.w, r23.w, r24.w
      dp3 r24.w, cb11[r21.w + 5].xyzx, r24.xyzx
      add_sat r21.w, r24.w, cb11[r21.w + 5].w
      mul r13.x, r21.w, r23.w
      and r21.w, l(1), cb10[r15.w + 6].x
      movc r25.xy, r21.wwww, r13.xyxx, r13.zxzz
      mov r13.x, cb10[r15.w + 6].x
      mov r26.xy, r25.xyxx
      mov r21.w, l(1)
      loop 
        ige r23.w, r21.w, r17.w
        breakc_nz r23.w
        ...
        dp3 r25.z, cb11[r23.w + 1].xyzx, r24.xyzx
        add_sat r25.z, r25.z, cb11[r23.w + 1].w
        mul r24.w, r24.w, r25.z
        dp3 r25.z, cb11[r23.w + 2].xyzx, r24.xyzx
        add_sat r25.z, r25.z, cb11[r23.w + 2].w
        mul r24.w, r24.w, r25.z
        dp3 r25.z, cb11[r23.w + 3].xyzx, r24.xyzx
        add_sat r25.z, r25.z, cb11[r23.w + 3].w
        mul r24.w, r24.w, r25.z
        dp3 r25.z, cb11[r23.w + 4].xyzx, r24.xyzx
        add_sat r25.z, r25.z, cb11[r23.w + 4].w
        mul r24.w, r24.w, r25.z
        dp3 r25.z, cb11[r23.w + 5].xyzx, r24.xyzx
        add_sat r23.w, r25.z, cb11[r23.w + 5].w
        ...
        movc r15.y, r26.z, r23.w, r26.w
        movc r26.xy, r25.wwww, r26.xyxx, r15.xyxx
        iadd r21.w, r21.w, l(1)
        mov r13.x, r25.z
      endloop 
      add_sat r13.x, -r14.w, r26.y
      mul r15.y, r13.x, cb10[r15.w + 6].y
      lt r16.w, l(0.000000), r15.y
      if_nz r16.w
        mad r22.w, r13.x, cb10[r15.w + 6].y, r22.w
        mul r13.x, r15.y, cb10[r15.w + 7].y
        mov r25.x, cb10[r15.w + 7].w
        mov r25.yz, cb10[r15.w + 8].xxyx
        dp3 r15.y, r11.xyzx, r25.xyzx
        dp3 r16.w, r24.xyzx, r25.xyzx
        add r16.w, r16.w, -cb10[r15.w + 8].z
        ge r17.w, r16.w, l(0.000000)
        max r16.w, r5.w, |r16.w|
        movc r16.w, r17.w, r16.w, -r16.w
        ...
        mad_sat r24.xyz, r31.xyzx, cb10[r15.w + 3].xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
        mul r31.xy, r24.xyxx, cb10[r15.w + 4].zwzz
        mul r31.z, r24.z, cb10[r15.w + 5].x
        add r24.xyz, r31.xyzx, cb10[r15.w + 5].yzwy
...
mul r14.xyz, r0.xxxx, r19.xyzx
lt r0.y, r19.w, l(0.990000)
if_nz r0.y
  ...
  mad r13.xyz, r18.xyzx, r0.xxxx, r10.xyzx
  mov r11.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r10.xyz, r11.xyzw, t8.xyzw, s2, r3.x
...
mad r2.w, r4.z, r1.z, r2.x
log r2.w, |r2.w|
mul r0.w, r0.w, r2.w
exp r0.w, r0.w
mad r0.w, r4.z, r1.z, r0.w
