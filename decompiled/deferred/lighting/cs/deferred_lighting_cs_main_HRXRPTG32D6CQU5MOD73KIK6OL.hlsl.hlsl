...
r0.y = samp0[]..swiz;
  ...
  r1.z = r1.z + r1.z;
  r14.xyz = r12.xyz * -r1.zzz + -r10.yzw;
  r1.z = 17 * r2.y;
  r1.z = exp2(r1.z);
  r1.z = 2 + r1.z;
  r1.z = 2 / r1.z;
  ...
  if (r3.w == 0) {
    ...
    // Known bad code for instruction (needs manual fix):
        ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r15.w, r9.w, l(0), t23.xxxx
    r15.w = samp0[]..swiz;
    ...
    if (r8.w == 0) {
      if (enableDitheredShadow == 0) {
        ...
        r15.z = r8.w + r6.w;
        r8.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r15.xyz, r3.w).x;
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          if (r15.w != 0) break;
          r15.w = cmp((uint)r7.w < (uint)r13.w);
          r16.zw = r15.ww ? r13.yz : r16.xy;
          r17.x = r15.w ? sunConstants.splitPinTransform[r6.w].w : sunConstants.splitPinTransform[r8.w].w;
          r15.w = r15.w ? r6.w : r8.w;
          ...
          r17.z = (uint)r15.w;
          r15.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r17.xyz, r3.w).x;
  ...
  r16.w = samp0[]..swiz;
    ...
    while (true) {
      ...
      r17.w = (int)r17.w * 14;
      r24.xyz = -refProbeConstantsCB[r17.w].data[0].xyz + r11.xyz;
  ...
  if (r13.z != 0) {
    ...
    r13.w = 0;
    while (true) {
      r15.w = cmp((uint)r13.w >= (uint)r9.w);
      if (r15.w != 0) break;
      r15.w = (uint)r13.w >> 5;
  ...
  if (r0.z != 0) {
    ...
    r14.w = 0;
    r16.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r14.xyzw, r6.w).xyz;
    r0.y = sunConstants.globalProbeExposure * r0.z + -r3.w;
    r0.y = r2.y * r0.y + r3.w;
    r15.xyz = r16.xyz * r0.yyy + r15.xyz;
  }
  r0.y = r5.z * r2.z + r2.x;
  r0.y = log2(abs(r0.y));
  r0.y = r1.w * r0.y;
  ...
  if (r3.w != 0) {
    ...
    if (r3.w != 0) {
      ...
      if (sunConstants.sunCookieIndex != 0) {
        r17.xyz = eyeOffset.xyz + r11.xyz;
        r17.w = 1;
        r5.z = dot(sunConstants.sunCookieTransform[0].xyzw, r17.xyzw);
      ...
      if (r6.w != 0) {
        ...
        r18.xyz = lightConstantsCB[r5.z].data[4].yzw;
        r18.w = lightConstantsCB[r5.z].data[5].x;
        r17.w = 1;
        r18.x = dot(r18.xyzw, r17.xyzw);
        r19.xyz = lightConstantsCB[r5.z].data[5].yzw;
        r19.w = lightConstantsCB[r5.z].data[6].x;
        r18.y = dot(r19.xyzw, r17.xyzw);
        r18.xy = r18.xy * float2(0.5,-0.5) + float2(0.5,0.5);
        r19.x = lightConstantsCB[r5.z].data[9].w + r18.x;
        r19.y = lightConstantsCB[r5.z].data[10].x + r18.y;
        r18.xy = lightConstantsCB[r5.z].data[9].yz * r19.xy;
        r18.zw = lightConstantsCB[r5.z].data[3].yy / lightConstantsCB[r5.z].data[8].yw;
        ...
        if (r6.w == 0) {
          ...
          r17.x = r18.x * lightConstantsCB[r5.z].data[8].y + lightConstantsCB[r5.z].data[8].z;
          r17.y = r18.y * lightConstantsCB[r5.z].data[8].w + lightConstantsCB[r5.z].data[9].x;
          ...
          if (enableDitheredShadow != 0) {
            ...
            while (true) {
              ...
              r19.xy = r20.xy * lightConstantsCB[r5.z].data[3].yy + r17.xy;
              r12.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r19.xyz, r6.w).x;
      ...
      r5.z = r5.z * r4.w;
      r3.y = cmp(0 < r3.y);
      r17.xyz = r5.zzz * r13.yzw + r16.xyz;
      r18.xyz = -r11.xyz * r0.www + sunConstants.wldDir.xyz;
      r0.w = dot(r18.xyz, r18.xyz);
      r0.w = rsqrt(r0.w);
      r18.xyz = r18.xyz * r0.www;
      r0.w = dot(r18.xyz, r10.yzw);
      r5.z = dot(r12.xyz, r18.xyz);
      ...
      r3.z = r4.w * r3.z;
      r3.z = 0.25 * r3.z;
      r18.xyz = r3.zzz * r13.yzw + r2.yzw;
      r0.w = saturate(1 + -r0.w);
      r3.w = r0.w * r0.w;
      r3.w = r3.w * r3.w;
      r0.w = r3.w * r0.w;
      r0.w = r3.z * r0.w;
      r19.xyz = r0.www * r13.zwy + r15.xyz;
      r17.w = r19.z;
      r16.w = r15.z;
      r16.xyzw = r3.yyyy ? r17.xyzw : r16.xyzw;
      r19.zw = r18.xy;
      r15.zw = r2.yz;
      r17.xyzw = r3.yyyy ? r19.xyzw : r15.xyzw;
      r2.w = r3.y ? r18.z : r2.w;
      r15.z = r16.w;
      r15.xy = r17.xy;
      r2.yz = r17.zw;
    }
  ...
  switch (r0.w) {
    ...
    r3.yzw = -r17.xyz * float3(0.5,0.5,0.5) + lightConstantsCB[r0.x].data[0].xyz;
    r13.yzw = r3.yzw + -r11.xyz;
    r4.w = dot(r17.xyz, r13.yzw);
    r5.z = saturate(-r4.w / lightConstantsCB[r0.x].data[6].y);
    r18.xyz = r5.zzz * r17.xyz + r3.yzw;
    r18.xyz = r0.www ? r18.xyz : lightConstantsCB[r0.x].data[0].xyz;
    ...
    if (r9.w != 0) {
      ...
      if (r9.w != 0) {
        ...
        if (r9.w != 0) {
          ...
          r13.z = -r12.w * r12.w + lightConstantsCB[r0.x].data[6].y;
          r4.w = r12.w * r13.y + -r4.w;
          r4.w = saturate(r4.w / r13.z);
          r12.w = r13.z / lightConstantsCB[r0.x].data[6].y;
          r12.w = 10 * r12.w;
          r12.w = min(1, r12.w);
          r4.w = r4.w + -r5.z;
          r4.w = r12.w * r4.w + r5.z;
          r3.yzw = r4.www * r17.xyz + r3.yzw;
          r3.yzw = r0.www ? r3.yzw : lightConstantsCB[r0.x].data[0].xyz;
          r3.yzw = r3.yzw + -r11.xyz;
          r0.w = dot(r3.yzw, r3.yzw);
          r0.w = rsqrt(r0.w);
          r13.yzw = r3.yzw * r0.www;
          ...
          if (r5.z != 0) {
            ...
            if (r15.w == 0) {
              ...
              r17.x = lightConstantsCB[r4.w].data[9].w + r14.x;
              r17.y = lightConstantsCB[r4.w].data[10].x + r14.y;
              r14.xy = lightConstantsCB[r4.w].data[9].yz * r17.xy;
              r14.zw = lightConstantsCB[r4.w].data[3].yy / lightConstantsCB[r4.w].data[8].yw;
              ...
              if (r14.z == 0) {
                ...
                r17.x = r14.x * lightConstantsCB[r4.w].data[8].y + lightConstantsCB[r4.w].data[8].z;
                r17.y = r14.y * lightConstantsCB[r4.w].data[8].w + lightConstantsCB[r4.w].data[9].x;
                r14.x = lightConstantsCB[r4.w].data[10].z * r12.w;
          ...
          r4.w = r1.w * r4.w + r8.w;
          r4.w = r4.w * r6.w;
          r14.x = lightConstantsCB[r0.x].data[0].w;
          r14.yz = lightConstantsCB[r0.x].data[1].xy;
          r5.z = cmp(0 < r7.w);
          r17.xyz = r4.www * r14.xyz + r16.xyz;
          r4.w = saturate(dot(r12.xyz, r13.yzw));
          r3.yzw = r3.yzw * r0.www + r10.yzw;
          r0.w = dot(r3.yzw, r3.yzw);
          r0.w = rsqrt(r0.w);
          r3.yzw = r3.yzw * r0.www;
          r0.w = dot(r3.yzw, r10.yzw);
          ...
          r3.y = r3.y * r3.z;
          r3.y = r3.y * r6.w;
          r13.yzw = r3.yyy * r14.xyz + r2.yzw;
          r0.w = saturate(1 + -r0.w);
          r3.z = r0.w * r0.w;
          r3.z = r3.z * r3.z;
          r0.w = r3.z * r0.w;
          r0.w = r3.y * r0.w;
          r3.yzw = r0.www * r14.xyz + r15.zxy;
          r16.xyz = r5.zzz ? r17.xyz : r16.xyz;
          r15.xyz = r5.zzz ? r3.zwy : r15.xyz;
    ...
    if (r3.w != 0) {
      ...
      if (r4.w != 0) {
        ...
        r5.z = r5.z / r6.w;
        r5.z = min(1, r5.z);
        r18.xy = saturate(r3.ww * lightConstantsCB[r0.x].data[2].xz + lightConstantsCB[r0.x].data[2].yw);
        r18.zw = r18.xy * r18.xy;
        r18.xy = r18.xy * float2(-2,-2) + float2(3,3);
        r18.xy = r18.zw * r18.xy;
        r5.z = r18.x * r5.z;
        ...
        if (r3.w != 0) {
          ...
          r19.xy = exp2(r19.xy);
          r6.w = lightConstantsCB[r0.x].data[12].x * r19.x;
          r7.w = lightConstantsCB[r0.x].data[12].y * r19.y + -1;
          r6.w = lightConstantsCB[r0.x].data[12].y * r19.y + -r6.w;
        ...
        if (r3.w != 0) {
          r18.z = 1;
          r5.z = dot(lightConstantsCB[r0.x].data[13].xyz, r18.xyz);
      ...
      if (r3.w != 0) {
        ...
        if (r3.w != 0) {
          ...
          r18.xyz = r12.xyz * r3.www + r11.xyz;
          r19.xyz = lightConstantsCB[r0.x].data[6].yzw;
          r19.w = lightConstantsCB[r0.x].data[7].x;
          r18.w = 1;
          r3.w = dot(r19.xyzw, r18.xyzw);
          r5.z = dot(r17.xyzw, r18.xyzw);
          r6.w = cmp(r5.z >= r3.w);
          if (r6.w != 0) {
            ...
            if (enableDitheredShadow != 0) {
              ...
              while (true) {
                ...
                r8.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r19.xyz, r3.w).x;
        ...
        if (r4.w != 0) {
          ...
          if (r6.w != 0) {
            ...
            r6.w = abs(r3.y) * -0.200000003 + 0.400000006;
            r17.xyz = r12.xyz * r6.www + r11.xyz;
            r18.xyz = lightConstantsCB[r5.z].data[6].yzw;
            r18.w = lightConstantsCB[r5.z].data[7].x;
            r17.w = 1;
            r6.w = dot(r18.xyzw, r17.xyzw);
            r18.xyz = lightConstantsCB[r5.z].data[7].yzw;
            r18.w = lightConstantsCB[r5.z].data[8].x;
            ...
            if (r8.w == 0) {
              ...
              r18.x = lightConstantsCB[r5.z].data[9].w + r17.x;
              r18.y = lightConstantsCB[r5.z].data[10].x + r17.y;
              r17.xy = lightConstantsCB[r5.z].data[9].yz * r18.xy;
              r17.zw = lightConstantsCB[r5.z].data[3].yy / lightConstantsCB[r5.z].data[8].yw;
              r18.xy = float2(1,1) + -r17.zw;
              r18.xy = cmp(r17.xy >= r18.xy);
              r17.zw = cmp(r17.zw >= r17.xy);
              r17.zw = (int2)r17.zw | (int2)r18.xy;
              r9.w = (int)r17.w | (int)r17.z;
              if (r9.w == 0) {
                r17.xy = saturate(r17.xy);
                r18.x = r17.x * lightConstantsCB[r5.z].data[8].y + lightConstantsCB[r5.z].data[8].z;
                r18.y = r17.y * lightConstantsCB[r5.z].data[8].w + lightConstantsCB[r5.z].data[9].x;
            ...
            if (r7.w == 0) {
              ...
              if (enableDitheredShadow != 0) {
                ...
                while (true) {
                  ...
                  if (r11.w != 0) break;
                  r20.x = dot(icb[r9.w+0].yx, r17.xy);
                  r20.y = dot(icb[r9.w+0].yx, r17.yz);
                  r19.xy = r20.xy * lightConstantsCB[r5.z].data[3].yy + r18.xy;
              ...
              if (r6.w == 0) {
                ...
                if (enableDitheredShadow != 0) {
                  ...
                  while (true) {
                    ...
                    r20.y = dot(icb[r7.w+0].yx, r17.yz);
                    r19.xy = r20.xy * lightConstantsCB[r0.x].data[3].yy + r18.xy;
                    r8.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r19.xyz, r5.z).x;
          ...
          r0.x = r0.x * r3.w;
          r1.w = cmp(0 < r3.y);
          r17.xyz = r0.xxx * r13.yzw + r16.xyz;
          r14.xyz = r14.xyz * r0.www + r10.yzw;
          r0.x = dot(r14.xyz, r14.xyz);
          r0.x = rsqrt(r0.x);
          r14.xyz = r14.xyz * r0.xxx;
          r0.x = dot(r14.xyz, r10.yzw);
          r0.w = dot(r12.xyz, r14.xyz);
          ...
          r16.xyz = r1.www ? r17.xyz : r16.xyz;
          r15.xyz = r1.www ? r0.yzx : r15.xyz;
