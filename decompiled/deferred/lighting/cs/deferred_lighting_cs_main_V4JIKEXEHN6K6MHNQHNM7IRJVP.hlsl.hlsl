// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:24:03 2021
...
r0.y = samp0[]..swiz;
  ...
  r1.z = r1.z + r1.z;
  r16.xyz = r12.xyz * -r1.zzz + -r13.xyz;
  r1.z = 17 * r2.y;
  r1.z = exp2(r1.z);
  r1.z = 2 + r1.z;
  r1.z = 2 / r1.z;
  ...
  r3.y = max(abs(r18.z), abs(r18.w));
  r3.y = max(abs(r18.y), r3.y);
  r3.y = max(abs(r18.x), r3.y);
  r14.yzw = cmp(r2.www == abs(r18.yzw));
  r2.w = r14.y ? r17.y : r17.x;
  r2.w = r14.z ? r17.z : r2.w;
  r2.w = r14.w ? r17.w : r2.w;
  ...
  if (r4.w == 0) {
    ...
    if (r7.w != 0) {
      ...
      while (true) {
        ...
        if (r9.w != 0) break;
        r9.w = (uint)r7.w;
        r14.yz = -sunConstants.splitPinTransform[r9.w].xy + r10.yz;
    ...
    if (r9.w != 0) {
      ...
      r17.xz = rcp(r14.yy);
      r17.y = -r17.z;
      r14.yzw = r10.yzy * r17.xyz + r14.zwz;
      r15.yzw = sunConstants.sstLightingConstants.constants.dimensionInTiles.xyx + float3(-0.0078125,-0.0078125,-0.0078125);
      r14.yzw = max(float3(0,0,0), r14.yzw);
      r14.yzw = min(r14.yzw, r15.yzw);
      r15.yz = sunConstants.sstLightingConstants.coordScale * r14.wz;
      r15.yz = floor(r15.yz);
      r13.w = sunConstants.sstLightingConstants.constants.dimensionInTiles.x * r15.z;
      r13.w = r13.w * sunConstants.sstLightingConstants.coordScale + r15.y;
      r13.w = (uint)r13.w;
      r13.w = (int)r13.w + (int10)sunConstants.sstLightingConstants.rootOffset;
    // Known bad code for instruction (needs manual fix):
        ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r15.y, r13.w, l(0), t23.xxxx
    r15.y = samp0[]..swiz;
      r15.z = (int)r15.y & 0x40000000;
      r15.w = (uint)r15.y << 2;
      if (r15.z == 0) {
        r15.z = (int)r15.y & 0x01ffffff;
        r17.x = (int)r13.w + (int)r15.z;
        r13.w = (uint)r15.y >> 25;
        r13.w = (uint)r13.w;
      ...
      r17.w = samp0[]..swiz;
        r15.z = r15.z ? r17.z : r17.w;
        r17.w = (uint)r15.z >> 13;
        r15.y = r15.y ? r17.w : r15.z;
        r15.y = (int)r15.y & 8191;
      ...
      r18.z = samp0[]..swiz;
        r17.y = 0;
        r18.y = 1;
        r18.xyz = r13.www ? r17.xyz : r18.xyz;
        r19.yz = r13.ww ? float2(8.40779079e-45,1.40129846e-45) : float2(7.00649232e-45,2.80259693e-45);
        r15.yz = (uint2)r14.wz >> (uint2)r19.yy;
        r15.yz = (int2)r15.yz & int2(1,1);
      ...
      r18.w = samp0[]..swiz;
        r15.z = r15.z ? r18.z : r18.w;
        r18.w = (uint)r15.z >> 13;
        r15.y = r15.y ? r18.w : r15.z;
        r15.y = (int)r15.y & 8191;
        r19.x = (int)r15.y + (int)r18.x;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r19.w, r19.x, l(0), t23.xxxx
      r19.w = samp0[]..swiz;
        r18.xyz = r17.www ? r18.xyz : r19.xzw;
        r17.xyz = r13.www ? r17.xyz : r18.xyz;
        r13.w = (int)r17.z & 0xc0000000;
        if (r13.w == 0) {
          r13.w = (int)-r17.y + 6;
          r15.yz = (uint2)r14.wz >> (uint2)r13.ww;
          r13.w = (int)r17.z | 0x40000000;
        ...
        r19.z = samp0[]..swiz;
          ...
          r15.y = (int)-r19.y + 6;
          r15.yz = (uint2)r14.wz >> (uint2)r15.yy;
          r17.y = (int)r19.z & 0xc0000000;
          r17.w = (int)r19.z | 0x40000000;
          bitmask.z = ((~(-1 << 1)) << 1) & 0xffffffff;  r15.z = (((uint)r15.z << 1) & bitmask.z) | ((uint)0 & ~bitmask.z);
          bitmask.y = ((~(-1 << 1)) << 0) & 0xffffffff;  r15.y = (((uint)r15.y << 0) & bitmask.y) | ((uint)r15.z & ~bitmask.y);
          r15.y = (int)r15.y * 10;
          r15.y = (uint)r17.w >> (uint)r15.y;
          r15.y = (int)r15.y & 1023;
          r20.x = (int)r15.y + (int)r19.x;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r20.y, r20.x, l(0), t23.xxxx
        r20.y = samp0[]..swiz;
          r15.yz = r17.yy ? r19.xz : r20.xy;
          r17.xz = r13.ww ? r18.xw : r15.yz;
        }
        r13.w = (int)r17.z & 0xc0000000;
        if (r13.w == 0) {
          if (14 == 0) r15.y = 0; else if (14+15 < 32) {           r15.y = (uint)r17.z << (32-(14 + 15)); r15.y = (uint)r15.y >> (32-14);          } else r15.y = (uint)r17.z >> 15;
          r15.y = (uint)r15.y;
          ...
          r15.yz = float2(6.10388815e-05,3.05185094e-05) * r15.yz;
          r17.y = (int)r14.z & 3;
        ...
        r14.z = samp0[]..swiz;
          ...
          r15.w = r17.w ? r14.y : r14.z;
        } else {
          r14.y = (int)r17.z & 0x80000000;
          r14.z = (int)r17.x + 1;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r14.z, r14.z, l(0), t23.xxxx
        r14.z = samp0[]..swiz;
          ...
          r14.z = r10.y * r14.w + r14.z;
          r14.y = r10.z * r14.y + r14.z;
          r15.w = r13.w ? r14.y : r15.w;
        }
      }
    ...
    if (r9.w == 0) {
      if (enableDitheredShadow == 0) {
        ...
        r17.xy = r14.yz * float2(0.5,-0.5) + float2(0.5,0.5);
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          r15.yz = r14.ww ? r10.yz : r14.yz;
          r15.w = r14.w ? sunConstants.splitPinTransform[r7.w].w : sunConstants.splitPinTransform[r9.w].w;
          r14.w = r14.w ? r7.w : r9.w;
          r18.x = dot(icb[r13.w+0].yx, r17.xy);
          r18.y = dot(icb[r13.w+0].yx, r17.yz);
          r18.xy = r18.xy * r15.ww + r15.yz;
  ...
  r14.z = samp0[]..swiz;
    ...
    bitmask.y = ((~(-1 << r10.z)) << 0) & 0xffffffff;  r15.y = (((uint)0 << 0) & bitmask.y) | ((uint)r14.z & ~bitmask.y);
    r14.z = r14.w ? r15.y : r14.z;
    r14.w = cmp((int)r10.w == (int)r14.y);
    ...
    while (true) {
      ...
      r15.y = (int)r15.y * 14;
      r26.xyz = -refProbeConstantsCB[r15.y].data[0].xyz + r11.xyz;
      ...
      r17.w = (int)r15.z * 6;
      r18.w = dot(refProbeAttenuationConstantsCB[r17.w].data[0].xyz, r26.xyz);
      r18.w = saturate(refProbeAttenuationConstantsCB[r17.w].data[0].w + r18.w);
      r19.z = dot(refProbeAttenuationConstantsCB[r17.w].data[1].xyz, r26.xyz);
      r19.z = saturate(refProbeAttenuationConstantsCB[r17.w].data[1].w + r19.z);
      r18.w = r19.z * r18.w;
      r19.z = dot(refProbeAttenuationConstantsCB[r17.w].data[2].xyz, r26.xyz);
      r19.z = saturate(refProbeAttenuationConstantsCB[r17.w].data[2].w + r19.z);
      r18.w = r19.z * r18.w;
      r19.z = dot(refProbeAttenuationConstantsCB[r17.w].data[3].xyz, r26.xyz);
      r19.z = saturate(refProbeAttenuationConstantsCB[r17.w].data[3].w + r19.z);
      r18.w = r19.z * r18.w;
      r19.z = dot(refProbeAttenuationConstantsCB[r17.w].data[4].xyz, r26.xyz);
      r19.z = saturate(refProbeAttenuationConstantsCB[r17.w].data[4].w + r19.z);
      r18.w = r19.z * r18.w;
      r19.z = dot(refProbeAttenuationConstantsCB[r17.w].data[5].xyz, r26.xyz);
      r17.w = saturate(refProbeAttenuationConstantsCB[r17.w].data[5].w + r19.z);
      r17.x = r18.w * r17.w;
      r17.w = 1 & (int)refProbeConstantsCB[r15.y].data[6].x;
      r17.xw = r17.ww ? r17.xy : r17.zx;
      r18.w = refProbeConstantsCB[r15.y].data[6].x;
      r27.xy = r17.xw;
      r19.z = 1;
      while (true) {
        r19.w = cmp((int)r19.z >= (int)r15.w);
        if (r19.w != 0) break;
        r19.w = (int)r15.z + (int)r19.z;
        r19.w = (int)r19.w * 6;
        r20.w = dot(refProbeAttenuationConstantsCB[r19.w].data[0].xyz, r26.xyz);
        r20.w = saturate(refProbeAttenuationConstantsCB[r19.w].data[0].w + r20.w);
        r20.w = r27.x * r20.w;
        r21.w = dot(refProbeAttenuationConstantsCB[r19.w].data[1].xyz, r26.xyz);
        r21.w = saturate(refProbeAttenuationConstantsCB[r19.w].data[1].w + r21.w);
        r20.w = r21.w * r20.w;
        r21.w = dot(refProbeAttenuationConstantsCB[r19.w].data[2].xyz, r26.xyz);
        r21.w = saturate(refProbeAttenuationConstantsCB[r19.w].data[2].w + r21.w);
        r20.w = r21.w * r20.w;
        r21.w = dot(refProbeAttenuationConstantsCB[r19.w].data[3].xyz, r26.xyz);
        r21.w = saturate(refProbeAttenuationConstantsCB[r19.w].data[3].w + r21.w);
        r20.w = r21.w * r20.w;
        r21.w = dot(refProbeAttenuationConstantsCB[r19.w].data[4].xyz, r26.xyz);
        r21.w = saturate(refProbeAttenuationConstantsCB[r19.w].data[4].w + r21.w);
        r20.w = r21.w * r20.w;
        r21.w = dot(refProbeAttenuationConstantsCB[r19.w].data[5].xyz, r26.xyz);
        r19.w = saturate(refProbeAttenuationConstantsCB[r19.w].data[5].w + r21.w);
        r27.x = r20.w * r19.w;
        r21.w = (uint)r18.w >> 2;
        ...
        r19.w = -r20.w * r19.w + 1;
        r19.w = r27.y * r19.w;
        r19.y = r27.z ? r19.w : r27.w;
        r27.xy = r26.ww ? r27.xy : r19.xy;
        r19.z = (int)r19.z + 1;
        r18.w = r21.w;
      }
      r27.y = saturate(r27.y);
      r15.z = refProbeConstantsCB[r15.y].data[6].y * r27.y;
      r15.w = cmp(0 < r15.z);
      if (r15.w != 0) {
        r25.z = r27.y * refProbeConstantsCB[r15.y].data[6].y + r25.z;
        r15.z = refProbeConstantsCB[r15.y].data[7].y * r15.z;
        r28.x = refProbeConstantsCB[r15.y].data[7].w;
        r28.yz = refProbeConstantsCB[r15.y].data[8].xy;
        r15.w = dot(r16.xyz, r28.xyz);
        r17.x = dot(r26.xyz, r28.xyz);
        r17.x = -refProbeConstantsCB[r15.y].data[8].z + r17.x;
        r17.w = cmp(r17.x >= 0);
        ...
        r28.x = refProbeConstantsCB[r15.y].data[8].w;
        r28.yz = refProbeConstantsCB[r15.y].data[9].xy;
        r17.x = dot(r16.xyz, r28.xyz);
        r17.w = dot(r26.xyz, r28.xyz);
        r17.w = -refProbeConstantsCB[r15.y].data[9].z + r17.w;
        r18.w = cmp(r17.w >= 0);
        r17.w = max(abs(r17.w), r8.w);
        r17.w = r18.w ? r17.w : -r17.w;
        r17.x = max(1.00000001e-07, -r17.x);
        r17.x = r17.w / r17.x;
        r15.w = min(abs(r17.x), r15.w);
        r28.x = refProbeConstantsCB[r15.y].data[9].w;
        r28.yz = refProbeConstantsCB[r15.y].data[10].xy;
        r17.x = dot(r16.xyz, r28.xyz);
        r17.w = dot(r26.xyz, r28.xyz);
        r17.w = -refProbeConstantsCB[r15.y].data[10].z + r17.w;
        r18.w = cmp(r17.w >= 0);
        r17.w = max(abs(r17.w), r8.w);
        r17.w = r18.w ? r17.w : -r17.w;
        r17.x = max(1.00000001e-07, -r17.x);
        r17.x = r17.w / r17.x;
        r15.w = min(abs(r17.x), r15.w);
        r28.x = refProbeConstantsCB[r15.y].data[10].w;
        r28.yz = refProbeConstantsCB[r15.y].data[11].xy;
        r17.x = dot(r16.xyz, r28.xyz);
        r17.w = dot(r26.xyz, r28.xyz);
        r17.w = -refProbeConstantsCB[r15.y].data[11].z + r17.w;
        r18.w = cmp(r17.w >= 0);
        r17.w = max(abs(r17.w), r8.w);
        r17.w = r18.w ? r17.w : -r17.w;
        r17.x = max(1.00000001e-07, -r17.x);
        r17.x = r17.w / r17.x;
        r15.w = min(abs(r17.x), r15.w);
        r28.x = refProbeConstantsCB[r15.y].data[11].w;
        r28.yz = refProbeConstantsCB[r15.y].data[12].xy;
        r17.x = dot(r16.xyz, r28.xyz);
        r17.w = dot(r26.xyz, r28.xyz);
        r17.w = -refProbeConstantsCB[r15.y].data[12].z + r17.w;
        r18.w = cmp(r17.w >= 0);
        r17.w = max(abs(r17.w), r8.w);
        r17.w = r18.w ? r17.w : -r17.w;
        r17.x = max(1.00000001e-07, -r17.x);
        r17.x = r17.w / r17.x;
        r15.w = min(abs(r17.x), r15.w);
        r28.x = refProbeConstantsCB[r15.y].data[12].w;
        r28.yz = refProbeConstantsCB[r15.y].data[13].xy;
        r17.x = dot(r16.xyz, r28.xyz);
        r17.w = dot(r26.xyz, r28.xyz);
        r17.w = -refProbeConstantsCB[r15.y].data[13].z + r17.w;
        r18.w = cmp(r17.w >= 0);
        r17.w = max(abs(r17.w), r8.w);
        r17.w = r18.w ? r17.w : -r17.w;
        r17.x = max(1.00000001e-07, -r17.x);
        r17.x = r17.w / r17.x;
        r15.w = min(abs(r17.x), r15.w);
        r28.x = refProbeConstantsCB[r15.y].data[3].w + r26.x;
        r28.yz = refProbeConstantsCB[r15.y].data[4].xy + r26.yz;
        r19.yzw = r16.xyz * r15.www + r28.xyz;
        r17.x = dot(r19.yzw, r19.yzw);
        r17.x = sqrt(r17.x);
        r15.w = r15.w / r17.x;
        r15.w = r15.w + r15.w;
        r15.w = sqrt(r15.w);
        ...
        r28.x = refProbeConstantsCB[r15.y].data[0].w;
        r28.y = refProbeConstantsCB[r15.y].data[1].z;
        r28.z = refProbeConstantsCB[r15.y].data[2].y;
        r29.x = dot(r19.yzw, r28.xyz);
        r30.xy = refProbeConstantsCB[r15.y].data[1].xw;
        r30.z = refProbeConstantsCB[r15.y].data[2].z;
        r29.y = dot(r19.yzw, r30.xyz);
        r31.x = refProbeConstantsCB[r15.y].data[1].y;
        r31.yz = refProbeConstantsCB[r15.y].data[2].xw;
        r29.z = dot(r19.yzw, r31.xyz);
        if (9 == 0) r17.x = 0; else if (9+16 < 32) {         r17.x = (uint)refProbeConstantsCB[r15.y].data[7].z << (32-(9 + 16)); r17.x = (uint)r17.x >> (32-9);        } else r17.x = (uint)refProbeConstantsCB[r15.y].data[7].z >> 16;
        r29.w = (uint)r17.x;
        r19.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r29.xyzw, r15.w).xyz;
        r32.x = dot(r26.xyz, r28.xyz);
        r32.y = dot(r26.xyz, r30.xyz);
        r32.z = dot(r26.xyz, r31.xyz);
        r26.xyz = saturate(r32.xyz * refProbeConstantsCB[r15.y].data[3].xyz + float3(0.5,0.5,0.5));
        r32.xy = refProbeConstantsCB[r15.y].data[4].zw * r26.xy;
        r32.z = refProbeConstantsCB[r15.y].data[5].x * r26.z;
        r26.xyz = refProbeConstantsCB[r15.y].data[5].yzw + r32.xyz;
        ...
        r24.xyz = r26.xyz * r27.xzw + r24.xyz;
        r15.w = r15.y * r9.w;
        r19.yzw = r19.yzw * r15.zzz;
        r15.z = dot(r19.yzw, float3(0.212599993,0.715200007,0.0722000003));
        r15.y = r9.w * r15.y + r15.z;
        r15.y = r15.w / r15.y;
        r26.x = r24.w;
        r26.yz = r25.xy;
        r25.xyw = r19.zwy * r15.yyy + r26.yzx;
        r24.w = r25.w;
      }
    }
    r22.xyzw = r24.xyzw;
  ...
  if (r10.w != 0) {
    ...
    r13.w = 0;
    while (true) {
      r15.y = cmp((uint)r13.w >= (uint)r10.y);
      if (r15.y != 0) break;
      r15.y = (uint)r13.w >> 5;
    ...
    r15.y = samp0[]..swiz;
      r15.z = cmp((int)r0.z == (int)r13.w);
      if (r10.z == 0) r15.w = 0; else if (r10.z+0 < 32) {       r15.w = (uint)r15.y << (32-(r10.z + 0)); r15.w = (uint)r15.w >> (32-r10.z);      } else r15.w = (uint)r15.y >> 0;
      ...
      while (true) {
        ...
        r17.w = (int)r17.w * 14;
        r27.xyz = -refProbeConstantsCB[r17.w].data[0].xyz + r11.xyz;
        r18.w = 0x0000ffff & (int)refProbeConstantsCB[r17.w].data[7].z;
        if (6 == 0) r19.z = 0; else if (6+25 < 32) {         r19.z = (uint)refProbeConstantsCB[r17.w].data[7].z << (32-(6 + 25)); r19.z = (uint)r19.z >> (32-6);        } else r19.z = (uint)refProbeConstantsCB[r17.w].data[7].z >> 25;
        r19.w = (int)r18.w * 6;
        r20.w = dot(refProbeAttenuationConstantsCB[r19.w].data[0].xyz, r27.xyz);
        r20.w = saturate(refProbeAttenuationConstantsCB[r19.w].data[0].w + r20.w);
        r21.w = dot(refProbeAttenuationConstantsCB[r19.w].data[1].xyz, r27.xyz);
        r21.w = saturate(refProbeAttenuationConstantsCB[r19.w].data[1].w + r21.w);
        r20.w = r21.w * r20.w;
        r21.w = dot(refProbeAttenuationConstantsCB[r19.w].data[2].xyz, r27.xyz);
        r21.w = saturate(refProbeAttenuationConstantsCB[r19.w].data[2].w + r21.w);
        r20.w = r21.w * r20.w;
        r21.w = dot(refProbeAttenuationConstantsCB[r19.w].data[3].xyz, r27.xyz);
        r21.w = saturate(refProbeAttenuationConstantsCB[r19.w].data[3].w + r21.w);
        r20.w = r21.w * r20.w;
        r21.w = dot(refProbeAttenuationConstantsCB[r19.w].data[4].xyz, r27.xyz);
        r21.w = saturate(refProbeAttenuationConstantsCB[r19.w].data[4].w + r21.w);
        r20.w = r21.w * r20.w;
        r21.w = dot(refProbeAttenuationConstantsCB[r19.w].data[5].xyz, r27.xyz);
        r19.w = saturate(refProbeAttenuationConstantsCB[r19.w].data[5].w + r21.w);
        r17.x = r20.w * r19.w;
        r19.w = 1 & (int)refProbeConstantsCB[r17.w].data[6].x;
        r28.xy = r19.ww ? r17.xy : r17.zx;
        r17.x = refProbeConstantsCB[r17.w].data[6].x;
        r29.xy = r28.xy;
        r19.w = 1;
        while (true) {
          r20.w = cmp((int)r19.w >= (int)r19.z);
          if (r20.w != 0) break;
          r20.w = (int)r18.w + (int)r19.w;
          r20.w = (int)r20.w * 6;
          r21.w = dot(refProbeAttenuationConstantsCB[r20.w].data[0].xyz, r27.xyz);
          r21.w = saturate(refProbeAttenuationConstantsCB[r20.w].data[0].w + r21.w);
          r21.w = r29.x * r21.w;
          r26.w = dot(refProbeAttenuationConstantsCB[r20.w].data[1].xyz, r27.xyz);
          r26.w = saturate(refProbeAttenuationConstantsCB[r20.w].data[1].w + r26.w);
          r21.w = r26.w * r21.w;
          r26.w = dot(refProbeAttenuationConstantsCB[r20.w].data[2].xyz, r27.xyz);
          r26.w = saturate(refProbeAttenuationConstantsCB[r20.w].data[2].w + r26.w);
          r21.w = r26.w * r21.w;
          r26.w = dot(refProbeAttenuationConstantsCB[r20.w].data[3].xyz, r27.xyz);
          r26.w = saturate(refProbeAttenuationConstantsCB[r20.w].data[3].w + r26.w);
          r21.w = r26.w * r21.w;
          r26.w = dot(refProbeAttenuationConstantsCB[r20.w].data[4].xyz, r27.xyz);
          r26.w = saturate(refProbeAttenuationConstantsCB[r20.w].data[4].w + r26.w);
          r21.w = r26.w * r21.w;
          r26.w = dot(refProbeAttenuationConstantsCB[r20.w].data[5].xyz, r27.xyz);
          ...
          r29.xy = r27.ww ? r29.xy : r19.xy;
          r19.w = (int)r19.w + 1;
          r17.x = r26.w;
        }
        r17.x = saturate(r29.y + -r15.z);
        r18.w = refProbeConstantsCB[r17.w].data[6].y * r17.x;
        r19.y = cmp(0 < r18.w);
        if (r19.y != 0) {
          r25.w = r17.x * refProbeConstantsCB[r17.w].data[6].y + r25.w;
          r17.x = refProbeConstantsCB[r17.w].data[7].y * r18.w;
          r28.x = refProbeConstantsCB[r17.w].data[7].w;
          r28.yz = refProbeConstantsCB[r17.w].data[8].xy;
          r18.w = dot(r16.xyz, r28.xyz);
          r19.y = dot(r27.xyz, r28.xyz);
          r19.y = -refProbeConstantsCB[r17.w].data[8].z + r19.y;
          r19.z = cmp(r19.y >= 0);
          ...
          r28.x = refProbeConstantsCB[r17.w].data[8].w;
          r28.yz = refProbeConstantsCB[r17.w].data[9].xy;
          r19.y = dot(r16.xyz, r28.xyz);
          r19.z = dot(r27.xyz, r28.xyz);
          r19.z = -refProbeConstantsCB[r17.w].data[9].z + r19.z;
          r19.w = cmp(r19.z >= 0);
          r19.z = max(abs(r19.z), r8.w);
          r19.z = r19.w ? r19.z : -r19.z;
          r19.y = max(1.00000001e-07, -r19.y);
          r19.y = r19.z / r19.y;
          r18.w = min(abs(r19.y), r18.w);
          r28.x = refProbeConstantsCB[r17.w].data[9].w;
          r28.yz = refProbeConstantsCB[r17.w].data[10].xy;
          r19.y = dot(r16.xyz, r28.xyz);
          r19.z = dot(r27.xyz, r28.xyz);
          r19.z = -refProbeConstantsCB[r17.w].data[10].z + r19.z;
          r19.w = cmp(r19.z >= 0);
          r19.z = max(abs(r19.z), r8.w);
          r19.z = r19.w ? r19.z : -r19.z;
          r19.y = max(1.00000001e-07, -r19.y);
          r19.y = r19.z / r19.y;
          r18.w = min(abs(r19.y), r18.w);
          r28.x = refProbeConstantsCB[r17.w].data[10].w;
          r28.yz = refProbeConstantsCB[r17.w].data[11].xy;
          r19.y = dot(r16.xyz, r28.xyz);
          r19.z = dot(r27.xyz, r28.xyz);
          r19.z = -refProbeConstantsCB[r17.w].data[11].z + r19.z;
          r19.w = cmp(r19.z >= 0);
          r19.z = max(abs(r19.z), r8.w);
          r19.z = r19.w ? r19.z : -r19.z;
          r19.y = max(1.00000001e-07, -r19.y);
          r19.y = r19.z / r19.y;
          r18.w = min(abs(r19.y), r18.w);
          r28.x = refProbeConstantsCB[r17.w].data[11].w;
          r28.yz = refProbeConstantsCB[r17.w].data[12].xy;
          r19.y = dot(r16.xyz, r28.xyz);
          r19.z = dot(r27.xyz, r28.xyz);
          r19.z = -refProbeConstantsCB[r17.w].data[12].z + r19.z;
          r19.w = cmp(r19.z >= 0);
          r19.z = max(abs(r19.z), r8.w);
          r19.z = r19.w ? r19.z : -r19.z;
          r19.y = max(1.00000001e-07, -r19.y);
          r19.y = r19.z / r19.y;
          r18.w = min(abs(r19.y), r18.w);
          r28.x = refProbeConstantsCB[r17.w].data[12].w;
          r28.yz = refProbeConstantsCB[r17.w].data[13].xy;
          r19.y = dot(r16.xyz, r28.xyz);
          r19.z = dot(r27.xyz, r28.xyz);
          r19.z = -refProbeConstantsCB[r17.w].data[13].z + r19.z;
          r19.w = cmp(r19.z >= 0);
          r19.z = max(abs(r19.z), r8.w);
          r19.z = r19.w ? r19.z : -r19.z;
          r19.y = max(1.00000001e-07, -r19.y);
          r19.y = r19.z / r19.y;
          r18.w = min(abs(r19.y), r18.w);
          r28.x = refProbeConstantsCB[r17.w].data[3].w + r27.x;
          r28.yz = refProbeConstantsCB[r17.w].data[4].xy + r27.yz;
          r19.yzw = r16.xyz * r18.www + r28.xyz;
          r20.w = dot(r19.yzw, r19.yzw);
          r20.w = sqrt(r20.w);
          r18.w = r18.w / r20.w;
          r18.w = r18.w + r18.w;
          r18.w = sqrt(r18.w);
          ...
          r28.x = refProbeConstantsCB[r17.w].data[0].w;
          r28.y = refProbeConstantsCB[r17.w].data[1].z;
          r28.z = refProbeConstantsCB[r17.w].data[2].y;
          r30.x = dot(r19.yzw, r28.xyz);
          ...
          if (9 == 0) r19.y = 0; else if (9+16 < 32) {           r19.y = (uint)refProbeConstantsCB[r17.w].data[7].z << (32-(9 + 16)); r19.y = (uint)r19.y >> (32-9);          } else r19.y = (uint)refProbeConstantsCB[r17.w].data[7].z >> 16;
          r30.w = (uint)r19.y;
          r19.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r30.xyzw, r18.w).xyz;
          r33.x = dot(r27.xyz, r28.xyz);
          r33.y = dot(r27.xyz, r31.xyz);
          r33.z = dot(r27.xyz, r32.xyz);
          r27.xyz = saturate(r33.xyz * refProbeConstantsCB[r17.w].data[3].xyz + float3(0.5,0.5,0.5));
          r33.xy = refProbeConstantsCB[r17.w].data[4].zw * r27.xy;
          r33.z = refProbeConstantsCB[r17.w].data[5].x * r27.z;
          r27.xyz = refProbeConstantsCB[r17.w].data[5].yzw + r33.xyz;
          r30.x = dot(r12.xyz, r28.xyz);
          r30.y = dot(r12.xyz, r31.xyz);
          r30.z = dot(r12.xyz, r32.xyz);
          r28.xyz = cmp(float3(0,0,0) < r30.xyz);
          r18.z = r28.x ? 0 : 0.5;
          r29.xzw = r27.xyz + r18.xyz;
          r29.xzw = gProbeXArray.SampleLevel(samplerLinearClamp_s, r29.xzw, 0).xyz;
          r31.xyz = r30.xyz * r30.xyz;
          r31.xyz = r31.xyz * r17.xxx;
          r20.z = r28.y ? 0 : 0.5;
          r28.xyw = r27.xyz + r20.xyz;
          r28.xyw = gProbeYArray.SampleLevel(samplerLinearClamp_s, r28.xyw, 0).xyz;
          r28.xyw = r28.xyw * r31.yyy;
          r28.xyw = r29.xzw * r31.xxx + r28.xyw;
          r21.z = r28.z ? 0 : 0.5;
          r27.xyz = r27.xyz + r21.xyz;
          r27.xyz = gProbeZArray.SampleLevel(samplerLinearClamp_s, r27.xyz, 0).xyz;
          r27.xyz = r27.xyz * r31.zzz + r28.xyw;
          r28.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r30.xyzw, 6).xyz;
          r29.xzw = r28.xyz * r27.xyz;
          r17.w = dot(r29.xzw, float3(0.212599993,0.715200007,0.0722000003));
          r26.xyz = r27.xyz * r28.xyz + r26.xyz;
          r18.z = r17.w * r9.w;
          r19.yzw = r19.yzw * r17.xxx;
          r17.x = dot(r19.yzw, float3(0.212599993,0.715200007,0.0722000003));
          r17.x = r9.w * r17.w + r17.x;
          r17.x = r18.z / r17.x;
          r25.xyz = r19.yzw * r17.xxx + r25.xyz;
        }
      }
      r24.xyzw = r25.xyzw;
      r14.yzw = r26.xyz;
  ...
  if (r0.z != 0) {
    ...
    r0.y = r2.y * r0.y + r4.w;
    r14.yzw = r15.yzw * r0.yyy + r14.yzw;
  }
  r0.y = r5.z * r2.z + r2.x;
  r0.y = log2(abs(r0.y));
  r0.y = r1.w * r0.y;
  ...
  r17.xyz = r10.yzw * r2.www;
  r18.xyz = r3.xxx ? r17.yzx : 0;
  ...
  r15.yzw = r14.yzw * r2.yyy;
  r19.xyz = r14.yzw * r2.zzz;
  r0.y = sqrt(r1.w);
  r0.y = r0.y * 0.5 + 0.5;
  r0.y = r0.y * r0.y;
  r0.z = 0.5 * r0.y;
  ...
  if (r2.y != 0) {
    ...
    if (r2.y != 0) {
      ...
      if (sunConstants.sunCookieIndex != 0) {
        ...
        r20.w = 1;
        r2.z = dot(sunConstants.sunCookieTransform[0].xyzw, r20.xyzw);
        r4.w = dot(sunConstants.sunCookieTransform[1].xyzw, r20.xyzw);
        r20.x = frac(r2.z);
        r20.y = frac(r4.w);
      ...
      if (r4.w != 0) {
        ...
        r5.z = r3.x ? r5.z : 0;
        r4.w = r5.z ? -r4.w : r4.w;
        r20.xyz = r12.xyz * r4.www + r11.xyz;
        r21.xyz = lightConstantsCB[r2.z].data[4].yzw;
        r21.w = lightConstantsCB[r2.z].data[5].x;
        r20.w = 1;
        r21.x = dot(r21.xyzw, r20.xyzw);
        r22.xyz = lightConstantsCB[r2.z].data[5].yzw;
        r22.w = lightConstantsCB[r2.z].data[6].x;
        r21.y = dot(r22.xyzw, r20.xyzw);
        r21.xy = r21.xy * float2(0.5,-0.5) + float2(0.5,0.5);
        r22.x = lightConstantsCB[r2.z].data[9].w + r21.x;
        r22.y = lightConstantsCB[r2.z].data[10].x + r21.y;
        r21.xy = lightConstantsCB[r2.z].data[9].yz * r22.xy;
        r21.zw = lightConstantsCB[r2.z].data[3].yy / lightConstantsCB[r2.z].data[8].yw;
        r22.xy = float2(1,1) + -r21.zw;
        r22.xy = cmp(r21.xy >= r22.xy);
        r21.zw = cmp(r21.zw >= r21.xy);
        r21.zw = (int2)r21.zw | (int2)r22.xy;
        r4.w = (int)r21.w | (int)r21.z;
        if (r4.w == 0) {
          r22.xyz = lightConstantsCB[r2.z].data[6].yzw;
          r22.w = lightConstantsCB[r2.z].data[7].x;
          r4.w = dot(r22.xyzw, r20.xyzw);
          r21.xy = saturate(r21.xy);
          r20.x = r21.x * lightConstantsCB[r2.z].data[8].y + lightConstantsCB[r2.z].data[8].z;
          r20.y = r21.y * lightConstantsCB[r2.z].data[8].w + lightConstantsCB[r2.z].data[9].x;
          ...
          if (enableDitheredShadow != 0) {
            ...
            while (true) {
              r9.w = cmp((int)r8.w >= 8);
              if (r9.w != 0) break;
              r23.x = dot(icb[r8.w+0].yx, r21.xy);
              r23.y = dot(icb[r8.w+0].yx, r21.yz);
              r22.xy = r23.xy * lightConstantsCB[r2.z].data[3].yy + r20.xy;
              r9.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r22.xyz, r4.w).x;
              r7.w = r9.w * 0.125 + r7.w;
              r8.w = (int)r8.w + 1;
            }
          } else {
            r20.z = (uint)r5.z;
            r7.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r20.xyz, r4.w).x;
          }
          r2.z = r7.w * r7.w;
          r2.z = r2.z * r7.w;
        } else {
      ...
      r2.y = r6.w * r2.y;
      r2.y = 0.25 * r2.y;
      r21.yzw = r2.yyy * r14.yzw + r19.xyz;
      r0.w = saturate(1 + -r0.w);
      r2.w = r0.w * r0.w;
      r2.w = r2.w * r2.w;
      r0.w = r2.w * r0.w;
      r0.w = r2.y * r0.w;
      r10.yzw = r0.www * r14.yzw + r15.yzw;
      r2.yzw = r2.zzz * r14.yzw + r18.zxy;
      r22.xyz = r3.xxx ? r2.zwy : 0;
      r20.w = r18.z;
      r17.w = r22.z;
      r17.xyzw = r3.yyyy ? r20.xyzw : r17.xyzw;
      r18.zw = r10.yz;
      r22.zw = r15.yz;
      r20.xyzw = r3.yyyy ? r18.xyzw : r22.xyzw;
      r21.x = r10.w;
      r19.w = r15.w;
  ...
  r0.x = (uint)r0.x >> 24;
  r0.x = (int)r0.x * 15;
  if (3 == 0) r0.w = 0; else if (3+24 < 32) {   r0.w = (uint)lightConstantsCB[r0.x].data[1].w << (32-(3 + 24)); r0.w = (uint)r0.w >> (32-3);  } else r0.w = (uint)lightConstantsCB[r0.x].data[1].w >> 24;
  switch (r0.w) {
    case 4 :    r0.w = cmp(0 < lightConstantsCB[r0.x].data[6].y);
    r20.xy = lightConstantsCB[r0.x].data[5].zw;
    r20.z = lightConstantsCB[r0.x].data[6].x;
    r2.yzw = -r20.xyz * float3(0.5,0.5,0.5) + lightConstantsCB[r0.x].data[0].xyz;
    r3.yzw = r2.yzw + -r11.xyz;
    r4.w = dot(r20.xyz, r3.yzw);
    r5.z = saturate(-r4.w / lightConstantsCB[r0.x].data[6].y);
    r10.yzw = r5.zzz * r20.xyz + r2.yzw;
    r10.yzw = r0.www ? r10.yzw : lightConstantsCB[r0.x].data[0].xyz;
    r10.yzw = r10.yzw + -r11.xyz;
    r6.w = dot(r10.yzw, r10.yzw);
    r7.w = rsqrt(r6.w);
    r10.yzw = r10.yzw * r7.www;
    r7.w = dot(r12.xyz, r10.yzw);
    r8.w = saturate(r7.w);
    r8.w = r3.x ? abs(r7.w) : r8.w;
    r9.w = cmp(0 < r8.w);
    if (r9.w != 0) {
      r9.w = sqrt(r6.w);
      r10.y = lightConstantsCB[r0.x].data[3].x * lightConstantsCB[r0.x].data[3].x;
      r6.w = r10.y / r6.w;
      r6.w = min(1, r6.w);
      r10.yz = saturate(r9.ww * lightConstantsCB[r0.x].data[2].xz + lightConstantsCB[r0.x].data[2].yw);
      r14.yz = r10.yz * r10.yz;
      r10.yz = r10.yz * float2(-2,-2) + float2(3,3);
      r10.yz = r14.yz * r10.yz;
      r6.w = r10.y * r6.w;
      r6.w = r6.w * r10.z;
      r9.w = cmp(0 < r6.w);
      if (r9.w != 0) {
        ...
        if (r9.w != 0) {
          ...
          sincos(r9.w, r21.x, r22.x);
          r9.w = abs(r7.w) * -0.200000003 + 0.400000006;
          r10.y = cmp(r7.w < 0);
          r10.y = r3.x ? r10.y : 0;
          r9.w = r10.y ? -r9.w : r9.w;
          r10.yzw = r12.xyz * r9.www + r11.xyz;
          r10.yzw = -lightConstantsCB[r0.x].data[4].yzw + r10.yzw;
          r9.w = max(abs(r10.z), abs(r10.w));
          r9.w = max(abs(r10.y), r9.w);
          r9.w = lightConstantsCB[r0.x].data[5].x / r9.w;
          r9.w = lightConstantsCB[r0.x].data[5].y + r9.w;
          r12.w = dot(r10.yzw, r10.yzw);
          r12.w = rsqrt(r12.w);
          ...
          while (true) {
            ...
            if (r14.z != 0) break;
            r21.y = dot(icb[r14.y+0].yx, r23.xy);
            r21.z = dot(icb[r14.y+0].yx, r23.yz);
            r25.yz = lightConstantsCB[r0.x].data[3].yy * r21.yz;
            r25.x = r25.y * r22.x;
            r25.w = r25.y * r21.x;
            r24.xyz = r10.yzw * r12.www + r25.xzw;
            r14.z = gOmniShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r24.xyzw, r9.w).x;
        ...
        if (r9.w != 0) {
          ...
          r9.w = 0.25 * r9.w;
          r10.y = dot(r20.xyz, r16.xyz);
          r3.y = dot(r16.xyz, r3.yzw);
          r3.z = -r10.y * r10.y + lightConstantsCB[r0.x].data[6].y;
          r3.y = r10.y * r3.y + -r4.w;
          r3.y = saturate(r3.y / r3.z);
          r3.z = r3.z / lightConstantsCB[r0.x].data[6].y;
          r3.z = 10 * r3.z;
          r3.z = min(1, r3.z);
          r3.y = r3.y + -r5.z;
          r3.y = r3.z * r3.y + r5.z;
          r2.yzw = r3.yyy * r20.xyz + r2.yzw;
          r2.yzw = r0.www ? r2.yzw : lightConstantsCB[r0.x].data[0].xyz;
          r2.yzw = r2.yzw + -r11.xyz;
          r0.w = dot(r2.yzw, r2.yzw);
          r0.w = rsqrt(r0.w);
          r3.yzw = r2.yzw * r0.www;
          ...
          if (r5.z != 0) {
            ...
            r10.y = cmp(r7.w < 0);
            r10.y = r3.x ? r10.y : 0;
            r5.z = r10.y ? -r5.z : r5.z;
            r16.xyz = r12.xyz * r5.zzz + r11.xyz;
            r20.xyz = lightConstantsCB[r4.w].data[6].yzw;
            r20.w = lightConstantsCB[r4.w].data[7].x;
            r16.w = 1;
            r5.z = dot(r20.xyzw, r16.xyzw);
            r20.xyz = lightConstantsCB[r4.w].data[7].yzw;
            r20.w = lightConstantsCB[r4.w].data[8].x;
            r10.y = dot(r20.xyzw, r16.xyzw);
            r10.z = cmp(r10.y < r5.z);
            if (r10.z == 0) {
              r20.xyz = lightConstantsCB[r4.w].data[4].yzw;
              r20.w = lightConstantsCB[r4.w].data[5].x;
              r20.x = dot(r20.xyzw, r16.xyzw);
              r21.xyz = lightConstantsCB[r4.w].data[5].yzw;
              r21.w = lightConstantsCB[r4.w].data[6].x;
              r20.y = dot(r21.xyzw, r16.xyzw);
              r14.yz = r20.xy / r10.yy;
              r14.yz = r14.yz * float2(0.5,-0.5) + float2(0.5,0.5);
              r16.x = lightConstantsCB[r4.w].data[9].w + r14.y;
              r16.y = lightConstantsCB[r4.w].data[10].x + r14.z;
              r14.yz = lightConstantsCB[r4.w].data[9].yz * r16.xy;
              r16.xy = lightConstantsCB[r4.w].data[3].yy / lightConstantsCB[r4.w].data[8].yw;
              r16.zw = float2(1,1) + -r16.xy;
              r16.zw = cmp(r14.yz >= r16.zw);
              r16.xy = cmp(r16.xy >= r14.yz);
              r16.xy = (int2)r16.xy | (int2)r16.zw;
              r10.w = (int)r16.y | (int)r16.x;
              if (r10.w == 0) {
                r14.yz = saturate(r14.yz);
                r16.x = r14.y * lightConstantsCB[r4.w].data[8].y + lightConstantsCB[r4.w].data[8].z;
                r16.y = r14.z * lightConstantsCB[r4.w].data[8].w + lightConstantsCB[r4.w].data[9].x;
                r12.w = lightConstantsCB[r4.w].data[10].z * r10.y;
                r5.z = lightConstantsCB[r4.w].data[10].y * r10.y + r5.z;
                r5.z = r5.z / r12.w;
              }
            } else {
              r10.w = -1;
            }
            r10.y = (int)r10.z | (int)r10.w;
            if (r10.y == 0) {
              r5.z = max(6.10351563e-05, r5.z);
              r10.y = 0x0000ffff & (int)lightConstantsCB[r4.w].data[1].w;
              if (enableDitheredShadow != 0) {
                r20.x = -r14.x;
                r21.z = (uint)r10.y;
                r20.y = r15.x;
                ...
                while (true) {
                  ...
                  r21.xy = r22.xy * lightConstantsCB[r4.w].data[3].yy + r16.xy;
                  r12.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r21.xyz, r5.z).x;
                  r10.z = r12.w * 0.125 + r10.z;
                  r10.w = (int)r10.w + 1;
                }
              } else {
                r16.z = (uint)r10.y;
                r10.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r5.z).x;
              }
              r4.w = r10.z * r10.z;
              r4.w = r4.w * r10.z;
            } else {
          ...
          r5.z = cmp(0 < r7.w);
          r10.yzw = r4.www * r16.xyz + r17.xyz;
          r3.y = saturate(dot(r12.xyz, r3.yzw));
          r2.yzw = r2.yzw * r0.www + r13.xyz;
          r0.w = dot(r2.yzw, r2.yzw);
          r0.w = rsqrt(r0.w);
          r2.yzw = r2.yzw * r0.www;
          r0.w = dot(r2.yzw, r13.xyz);
          r2.y = dot(r12.xyz, r2.yzw);
          r2.z = abs(r2.y) * r1.z + -abs(r2.y);
          ...
          r2.y = r2.y * r2.z;
          r2.y = r2.y * r6.w;
          r3.yzw = r2.yyy * r16.xyz + r19.xyz;
          r0.w = saturate(1 + -r0.w);
          r2.z = r0.w * r0.w;
          r2.z = r2.z * r2.z;
          r0.w = r2.z * r0.w;
          r0.w = r2.y * r0.w;
          r2.yzw = r0.www * r16.xyz + r15.yzw;
          r14.yzw = r4.www * r16.xyz + r18.zxy;
          r14.yzw = r3.xxx ? r14.yzw : r18.zxy;
          r17.xyz = r5.zzz ? r10.yzw : r17.xyz;
          r18.xyz = r5.zzz ? r18.xyz : r14.zwy;
          r15.yzw = r5.zzz ? r2.yzw : r15.yzw;
          r19.xyz = r5.zzz ? r3.yzw : r19.xyz;
        }
      }
    }
    break;
    ...
    r0.w = rsqrt(r0.w);
    r2.yzw = r16.xyz * r0.www;
    r2.y = dot(r12.xyz, r2.yzw);
    r2.z = saturate(r2.y);
    r2.w = r3.x ? abs(r2.y) : r2.z;
    r3.y = cmp(0 < r2.w);
    if (r3.y != 0) {
      r20.xyz = lightConstantsCB[r0.x].data[7].yzw;
      r20.w = lightConstantsCB[r0.x].data[8].x;
      r11.w = 1;
      r3.y = dot(r20.xyzw, r11.xyzw);
      r3.z = cmp(r3.y < 1);
      if (r3.z != 0) {
        r10.yzw = float3(1,1,1);
        r3.z = 0;
      } else {
        r14.yzw = lightConstantsCB[r0.x].data[0].xyz + -r11.xyz;
        r3.w = lightConstantsCB[r0.x].data[3].x * lightConstantsCB[r0.x].data[3].x;
        r4.w = dot(r14.yzw, r14.yzw);
        r3.w = r3.w / r4.w;
        r3.w = min(1, r3.w);
        r14.yz = saturate(r3.yy * lightConstantsCB[r0.x].data[2].xz + lightConstantsCB[r0.x].data[2].yw);
        ...
        r21.xy = r21.xy / r3.yy;
        r3.y = cmp(lightConstantsCB[r0.x].data[10].w < 0.00048828125);
        if (r3.y != 0) {
          ...
          r14.yz = exp2(r14.yz);
          r4.w = lightConstantsCB[r0.x].data[12].x * r14.y;
          r5.z = lightConstantsCB[r0.x].data[12].y * r14.z + -1;
          r4.w = lightConstantsCB[r0.x].data[12].y * r14.z + -r4.w;
        ...
        r3.z = r3.w * r3.y;
        r3.y = 255 & (int)lightConstantsCB[r0.x].data[14].w;
        if (r3.y != 0) {
          r21.z = 1;
          r3.w = dot(lightConstantsCB[r0.x].data[13].xyz, r21.xyz);
          r22.x = lightConstantsCB[r0.x].data[13].w;
          r22.yz = lightConstantsCB[r0.x].data[14].xy;
          r4.w = dot(r22.xyz, r21.xyz);
          r21.x = frac(r3.w);
          r21.y = frac(r4.w);
          r3.y = (int)r3.y + -1;
          r21.z = (uint)r3.y;
          r10.yzw = gCookieArray.SampleLevel(samplerLinear_s, r21.xyz, 0).xyz;
        } else {
          r10.yzw = float3(1,1,1);
        }
      }
      ...
      r10.yzw = r21.xyz * r10.yzw;
      r3.y = cmp(0 < r3.z);
      if (r3.y != 0) {
        if (3 == 0) r3.y = 0; else if (3+27 < 32) {         r3.y = (uint)lightConstantsCB[r0.x].data[1].w << (32-(3 + 27)); r3.y = (uint)r3.y >> (32-3);        } else r3.y = (uint)lightConstantsCB[r0.x].data[1].w >> 27;
        r3.y = cmp((int)r3.y != 1);
        if (r3.y != 0) {
          r3.y = abs(r2.y) * -0.200000003 + 0.400000006;
          r3.w = cmp(r2.y < 0);
          r3.w = r3.w ? r3.x : 0;
          r3.y = r3.w ? -r3.y : r3.y;
          r21.xyz = r12.xyz * r3.yyy + r11.xyz;
          r22.xyz = lightConstantsCB[r0.x].data[6].yzw;
          r22.w = lightConstantsCB[r0.x].data[7].x;
          r21.w = 1;
          r3.y = dot(r22.xyzw, r21.xyzw);
          r3.w = dot(r20.xyzw, r21.xyzw);
          r4.w = cmp(r3.w >= r3.y);
          if (r4.w != 0) {
            ...
            r3.w = 0x0000ffff & (int)lightConstantsCB[r0.x].data[1].w;
            if (enableDitheredShadow != 0) {
              r21.x = -r14.x;
              r22.z = (uint)r3.w;
              r21.y = r15.x;
              ...
              while (true) {
                r6.w = cmp((int)r5.z >= 8);
                if (r6.w != 0) break;
                r23.x = dot(icb[r5.z+0].yx, r21.xy);
                r23.y = dot(icb[r5.z+0].yx, r21.yz);
                r22.xy = r23.xy * lightConstantsCB[r0.x].data[3].yy + r20.xy;
                r6.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r22.xyz, r3.y).x;
                r4.w = r6.w * 0.125 + r4.w;
                r5.z = (int)r5.z + 1;
              }
            } else {
              r20.z = (uint)r3.w;
              r4.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r20.xyz, r3.y).x;
            }
            r3.y = r4.w * r4.w;
            r3.y = r3.y * r4.w;
          } else {
        ...
        r3.z = cmp(0 < r3.y);
        if (r3.z != 0) {
          r3.z = lightConstantsCB[r0.x].data[1].z * r1.z;
          r3.z = r3.z * r2.z;
          ...
          r4.w = cmp(0 < (uint)r3.w);
          r4.w = r10.x ? r4.w : 0;
          if (r4.w != 0) {
            r3.w = (int)r3.w + numLights;
            r3.w = mad((int)r3.w, 15, -15);
            r4.w = abs(r2.y) * -0.200000003 + 0.400000006;
            r5.z = cmp(r2.y < 0);
            r5.z = r3.x ? r5.z : 0;
            r4.w = r5.z ? -r4.w : r4.w;
            r20.xyz = r12.xyz * r4.www + r11.xyz;
            r21.xyz = lightConstantsCB[r3.w].data[6].yzw;
            r21.w = lightConstantsCB[r3.w].data[7].x;
            r20.w = 1;
            r4.w = dot(r21.xyzw, r20.xyzw);
            r21.xyz = lightConstantsCB[r3.w].data[7].yzw;
            r21.w = lightConstantsCB[r3.w].data[8].x;
            r5.z = dot(r21.xyzw, r20.xyzw);
            r6.w = cmp(r5.z < r4.w);
            if (r6.w == 0) {
              r21.xyz = lightConstantsCB[r3.w].data[4].yzw;
              r21.w = lightConstantsCB[r3.w].data[5].x;
              r21.x = dot(r21.xyzw, r20.xyzw);
              r22.xyz = lightConstantsCB[r3.w].data[5].yzw;
              r22.w = lightConstantsCB[r3.w].data[6].x;
              r21.y = dot(r22.xyzw, r20.xyzw);
              r14.yz = r21.xy / r5.zz;
              r14.yz = r14.yz * float2(0.5,-0.5) + float2(0.5,0.5);
              r20.x = lightConstantsCB[r3.w].data[9].w + r14.y;
              r20.y = lightConstantsCB[r3.w].data[10].x + r14.z;
              r14.yz = lightConstantsCB[r3.w].data[9].yz * r20.xy;
              r20.xy = lightConstantsCB[r3.w].data[3].yy / lightConstantsCB[r3.w].data[8].yw;
              ...
              if (r7.w == 0) {
                r14.yz = saturate(r14.yz);
                r20.x = r14.y * lightConstantsCB[r3.w].data[8].y + lightConstantsCB[r3.w].data[8].z;
                r20.y = r14.z * lightConstantsCB[r3.w].data[8].w + lightConstantsCB[r3.w].data[9].x;
                r8.w = lightConstantsCB[r3.w].data[10].z * r5.z;
                r4.w = lightConstantsCB[r3.w].data[10].y * r5.z + r4.w;
                r4.w = r4.w / r8.w;
              }
            } else {
              r7.w = -1;
            }
            r5.z = (int)r6.w | (int)r7.w;
            if (r5.z == 0) {
              r4.w = max(6.10351563e-05, r4.w);
              r5.z = 0x0000ffff & (int)lightConstantsCB[r3.w].data[1].w;
              if (enableDitheredShadow != 0) {
                r21.x = -r14.x;
                r22.z = (uint)r5.z;
                r21.y = r15.x;
                ...
                while (true) {
                  r8.w = cmp((int)r7.w >= 8);
                  if (r8.w != 0) break;
                  r23.x = dot(icb[r7.w+0].yx, r21.xy);
                  r23.y = dot(icb[r7.w+0].yx, r21.yz);
                  r22.xy = r23.xy * lightConstantsCB[r3.w].data[3].yy + r20.xy;
                  r8.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r22.xyz, r4.w).x;
                  r6.w = r8.w * 0.125 + r6.w;
                  r7.w = (int)r7.w + 1;
                }
              } else {
                r20.z = (uint)r5.z;
                r6.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r20.xyz, r4.w).x;
              }
              r3.w = r6.w * r6.w;
              r3.w = r3.w * r6.w;
            } else {
            ...
            if (r3.w != 0) {
              ...
              if (r5.z == 0) {
                ...
                if (r6.w == 0) {
                  ...
                  r20.x = r14.y * lightConstantsCB[r0.x].data[8].y + lightConstantsCB[r0.x].data[8].z;
                  r20.y = r14.z * lightConstantsCB[r0.x].data[8].w + lightConstantsCB[r0.x].data[9].x;
                  r7.w = lightConstantsCB[r0.x].data[10].z * r4.w;
                  r3.w = lightConstantsCB[r0.x].data[10].y * r4.w + r3.w;
                  r3.w = r3.w / r7.w;
                }
              } else {
                r6.w = -1;
              }
              r4.w = (int)r5.z | (int)r6.w;
              if (r4.w == 0) {
                r3.w = max(6.10351563e-05, r3.w);
                r4.w = 0x0000ffff & (int)lightConstantsCB[r0.x].data[1].w;
                if (enableDitheredShadow != 0) {
                  r21.x = -r14.x;
                  r22.z = (uint)r4.w;
                  r21.y = r15.x;
                  ...
                  while (true) {
                    r7.w = cmp((int)r6.w >= 8);
                    if (r7.w != 0) break;
                    r14.x = dot(icb[r6.w+0].yx, r21.xy);
                    r14.y = dot(icb[r6.w+0].yx, r21.yz);
                    r22.xy = r14.xy * lightConstantsCB[r0.x].data[3].yy + r20.xy;
                    r7.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r22.xyz, r3.w).x;
                    r5.z = r7.w * 0.125 + r5.z;
                    r6.w = (int)r6.w + 1;
                  }
                } else {
                  r20.z = (uint)r4.w;
                  r5.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r20.xyz, r3.w).x;
                }
                r0.x = r5.z * r5.z;
                r0.x = r0.x * r5.z;
              } else {
          ...
          r0.x = r0.x * r3.y;
          r1.w = cmp(0 < r2.y);
          r2.xyw = r0.xxx * r10.yzw + r17.xyz;
          r14.xyz = r16.xyz * r0.www + r13.xyz;
          r0.w = dot(r14.xyz, r14.xyz);
          r0.w = rsqrt(r0.w);
          r14.xyz = r14.xyz * r0.www;
          r0.w = dot(r14.xyz, r13.xyz);
          ...
          r0.y = r3.y * r0.y;
          r0.y = 0.25 * r0.y;
          r3.yzw = r0.yyy * r10.yzw + r19.xyz;
          r0.z = saturate(1 + -r0.w);
          r0.w = r0.z * r0.z;
          r0.w = r0.w * r0.w;
          r0.z = r0.z * r0.w;
          r0.y = r0.y * r0.z;
          r0.yzw = r0.yyy * r10.yzw + r15.yzw;
          r10.xyz = r0.xxx * r10.yzw + r18.zxy;
          r10.xyz = r3.xxx ? r10.xyz : r18.zxy;
          r17.xyz = r1.www ? r2.xyw : r17.xyz;
          r18.xyz = r1.www ? r18.xyz : r10.yzx;
          r15.yzw = r1.www ? r0.yzw : r15.yzw;
          r19.xyz = r1.www ? r3.yzw : r19.xyz;
        }
      }
    }
    break;
  ...
  r2.z = -r0.y * 0.5 + r0.x;
  r2.x = r2.z + r0.y;
  r0.xyz = r17.xyz * r4.xyz;
  r0.xyz = r18.zxy * r2.xyz + r0.xyz;
  r3.yzw = float3(0.959999979,0.959999979,0.959999979) * r15.yzw;
  r3.yzw = r19.xyz * float3(0.0399999991,0.0399999991,0.0399999991) + r3.yzw;
  r0.xyz = r3.yzw + r0.xyz;
  r3.yzw = float3(1,1,1) + -r2.xyz;
  r3.yzw = r15.yzw * r3.yzw;
  r2.xyz = r19.xyz * r2.xyz + r3.yzw;
  r2.xyz = r17.xyz * r4.xyz + r2.xyz;
