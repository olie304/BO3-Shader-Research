...
r0.y = samp0[]..swiz;
  ...
  if (r14.w != 0) {
    ...
    r16.w = (int)r19.w & 1;
    r30.yz = float2(0,1);
    r20.zw = r16.ww ? r30.xy : r30.zx;
    r30.x = 1;
    r16.w = r19.w;
    r31.xy = r20.zw;
    r17.w = 1;
    while (true) {
      r18.w = cmp((int)r17.w >= (int)r14.z);
      if (r18.w != 0) break;
      r18.w = (int)r12.w + (int)r17.w;
      r18.w = (int)r18.w * 6;
      r21.w = dot(refProbeAttenuationConstantsCB[r18.w].data[0].xyz, r13.yzw);
      r21.w = saturate(refProbeAttenuationConstantsCB[r18.w].data[0].w + r21.w);
      r21.w = r31.x * r21.w;
      r28.w = dot(refProbeAttenuationConstantsCB[r18.w].data[1].xyz, r13.yzw);
      r28.w = saturate(refProbeAttenuationConstantsCB[r18.w].data[1].w + r28.w);
      r21.w = r28.w * r21.w;
      r28.w = dot(refProbeAttenuationConstantsCB[r18.w].data[2].xyz, r13.yzw);
      r28.w = saturate(refProbeAttenuationConstantsCB[r18.w].data[2].w + r28.w);
      r21.w = r28.w * r21.w;
      r28.w = dot(refProbeAttenuationConstantsCB[r18.w].data[3].xyz, r13.yzw);
      r28.w = saturate(refProbeAttenuationConstantsCB[r18.w].data[3].w + r28.w);
      r21.w = r28.w * r21.w;
      r28.w = dot(refProbeAttenuationConstantsCB[r18.w].data[4].xyz, r13.yzw);
      r28.w = saturate(refProbeAttenuationConstantsCB[r18.w].data[4].w + r28.w);
      r21.w = r28.w * r21.w;
      r28.w = dot(refProbeAttenuationConstantsCB[r18.w].data[5].xyz, r13.yzw);
      r18.w = saturate(refProbeAttenuationConstantsCB[r18.w].data[5].w + r28.w);
      r31.x = r21.w * r18.w;
      r28.w = (uint)r16.w >> 2;
      if (1 == 0) r29.w = 0; else if (1+2 < 32) {       r29.w = (uint)r16.w << (32-(1 + 2)); r29.w = (uint)r29.w >> (32-1);      } else r29.w = (uint)r16.w >> 2;
      r30.z = (int)r28.w & 2;
      r30.w = max(r31.y, r31.x);
      r18.w = -r21.w * r18.w + 1;
      r18.w = r31.y * r18.w;
      r30.y = r30.z ? r18.w : r30.w;
    ...
    if (r12.w != 0) {
      ...
      r17.w = dot(r13.yzw, r26.xyz);
      r14.y = r17.w + -r14.y;
      r17.w = cmp(r14.y >= 0);
      r14.y = max(abs(r14.y), r9.w);
      r14.y = r17.w ? r14.y : -r14.y;
      r16.w = max(1.00000001e-07, -r16.w);
      r14.y = r14.y / r16.w;
      r14.y = min(r14.z, abs(r14.y));
      r19.xyz = r19.xyz + r13.yzw;
      r19.xyz = r15.xyz * r14.yyy + r19.xyz;
      r14.z = dot(r19.xyz, r19.xyz);
      r14.z = sqrt(r14.z);
      r14.y = r14.y / r14.z;
      r14.y = r14.y + r14.y;
      r14.y = sqrt(r14.y);
      ...
      r20.x = dot(r19.xyz, r29.xyz);
      r20.y = dot(r19.xyz, r16.xyz);
      r20.z = dot(r19.xyz, r27.xyz);
      if (9 == 0) r14.z = 0; else if (9+16 < 32) {       r14.z = (uint)r27.w << (32-(9 + 16)); r14.z = (uint)r14.z >> (32-9);      } else r14.z = (uint)r27.w >> 16;
      r20.w = (uint)r14.z;
      r19.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r20.xyzw, r14.y).xyz;
      r21.xyz = (int3)r19.xyz & int3(-2147483648,-2147483648,-2147483648);
      r21.xyz = cmp((int3)r21.xyz == int3(2139095040,2139095040,2139095040));
      r14.y = (int)r21.y | (int)r21.x;
      r14.y = (int)r21.z | (int)r14.y;
      r19.xyz = r14.yyy ? float3(1,1,0) : r19.xyz;
      r21.x = dot(r13.yzw, r29.xyz);
      r21.y = dot(r13.yzw, r16.xyz);
      r21.z = dot(r13.yzw, r27.xyz);
      r13.yzw = saturate(r21.xyz * r17.xyz + float3(0.5,0.5,0.5));
      r13.yzw = r13.yzw * r18.xyz + r28.xyz;
      r20.x = dot(r11.xyz, r29.xyz);
      r20.y = dot(r11.xyz, r16.xyz);
      r20.z = dot(r11.xyz, r27.xyz);
      ...
      r14.y = (int)r17.y | (int)r17.x;
      r14.y = (int)r17.z | (int)r14.y;
      r16.xyz = r14.yyy ? float3(1,1,0) : r16.xyz;
      ...
      r12.w = r10.w * r13.y + r12.w;
      r12.w = r13.z / r12.w;
      r30.xyz = r16.xyz * r12.www;
      r12.w = 257;
    } else {
  ...
  if (r13.y == 0) {
    ...
    r13.z = (int)r13.z + 7;
    r13.z = (uint)r13.z >> 3;
    r13.z = mad((int)r0.z, (int)r13.z, (int)r0.y);
    bitmask.z = ((~(-1 << 27)) << 5) & 0xffffffff;  r13.z = (((uint)r13.z << 5) & bitmask.z) | ((uint)16 & ~bitmask.z);
    r13.w = (int)r13.y & -32;
    r14.y = (int)-r13.w + (int)r13.y;
    ...
    r18.w = samp0[]..swiz;
      r20.w = cmp((int)r13.w == (int)r17.w);
      bitmask.w = ((~(-1 << r14.y)) << 0) & 0xffffffff;  r21.w = (((uint)0 << 0) & bitmask.w) | ((uint)r18.w & ~bitmask.w);
      r18.w = r20.w ? r21.w : r18.w;
      r20.w = cmp((int)r14.z == (int)r17.w);
      if (r14.w == 0) r21.w = 0; else if (r14.w+0 < 32) {       r21.w = (uint)r18.w << (32-(r14.w + 0)); r21.w = (uint)r21.w >> (32-r14.w);      } else r21.w = (uint)r18.w >> 0;
      r18.w = r20.w ? r21.w : r18.w;
      r24.xyzw = r22.xyzw;
      r25.xyzw = r23.xyzw;
      r20.w = r18.w;
      while (true) {
        ...
        r26.w = (int)r25.w + 1;
        r16.yzw = -refProbeConstantsCB[r21.w].data[0].xyz + r5.xyz;
    ...
    r14.z = 0;
    while (true) {
      r14.w = cmp((uint)r14.z >= (uint)r13.y);
      if (r14.w != 0) break;
      r14.w = (uint)r14.z >> 5;
      r14.w = (int)r13.z + (int)r14.w;
    // Known bad code for instruction (needs manual fix):
    ...
    r14.w = samp0[]..swiz;
      ...
      while (true) {
        ...
        if (r20.w != 0) {
          ...
          r31.xyz = r15.xyz * r19.www + r31.xyz;
    ...
    r12.w = r6.w ? r9.w : r26.y;
    r6.w = max(1, r26.x);
    r6.w = rcp(r6.w);
    r26.x = saturate(r26.x);
    r13.yzw = r24.xyz * r6.www;
    ...
    if (r9.w != 0) {
      ...
      r13.yzw = r24.xyz * r6.www + r14.yzw;
      r15.w = 0;
      ...
      r30.xyz = r14.yzw * r6.www + r30.xyz;
    }
  } else {
    r13.yzw = float3(0,0,0);
  }
  ...
  if (r8.w != 0) {
    ...
    if (r8.w != 0) {
      ...
      r3.z = r7.w * r3.z;
      r3.z = 0.25 * r3.z;
      r21.yzw = r3.zzz * r14.yzw + r18.xyz;
      ...
      r21.x = r13.w;
      r18.w = r19.z;
      r18.xyzw = r3.yyyy ? r21.yzwx : r18.xyzw;
      if (r2.w != 0) {
      // Known bad code for instruction (needs manual fix):
    ...
    if (r10.w != 0) {
      ...
      if (r10.w != 0) {
        ...
        if (r10.w != 0) {
          ...
          r14.z = -r15.w * r15.w + lightConstantsCB[r0.x].data[6].y;
          r3.w = r15.w * r14.y + -r3.w;
          r3.w = saturate(r3.w / r14.z);
          r14.y = r14.z / lightConstantsCB[r0.x].data[6].y;
          r14.y = 10 * r14.y;
          r14.y = min(1, r14.y);
          r3.w = r3.w + -r4.z;
          r3.w = r14.y * r3.w + r4.z;
          ...
          if (r4.z != 0) {
            ...
            if (r17.w == 0) {
              ...
              if (r15.z == 0) {
                ...
                r4.z = lightConstantsCB[r3.w].data[10].y * r16.w + r4.z;
                r4.z = r4.z / r15.x;
              }
            } else {
              r15.z = -1;
            ...
            if (r15.x == 0) {
              ...
              if (enableDitheredShadow != 0) {
                ...
                while (true) {
                  ...
                  r15.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r22.xyz, r4.z).x;
                  r15.y = r15.w * 0.125 + r15.y;
                  r15.z = (int)r15.z + 1;
                }
              } else {
                r20.z = (uint)r15.x;
                r15.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r20.xyz, r4.z).x;
              }
              r3.w = r15.y * r15.y;
              r3.w = r3.w * r15.y;
            } else {
          ...
          r8.w = r9.w * r8.w;
          r8.w = r8.w * r7.w;
          r13.yzw = r8.www * r15.xyz + r18.xyz;
          ...
          r19.xyz = r4.zzz ? r14.yzw : r19.xyz;
          r18.xyz = r4.zzz ? r13.yzw : r18.xyz;
          if (r2.w != 0) {
          // Known bad code for instruction (needs manual fix):
          ...
          if (r11.w != 0) {
            ...
            if (enableDitheredShadow != 0) {
              ...
              while (true) {
                ...
                r14.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r22.xyz, r5.w).x;
                r11.w = r14.z * 0.125 + r11.w;
                r14.y = (int)r14.y + 1;
              }
            } else {
              r20.z = (uint)r10.w;
        ...
        if (r9.w != 0) {
          ...
          if (r11.w != 0) {
            ...
            if (r14.z == 0) {
              ...
              r21.x = lightConstantsCB[r10.w].data[9].w + r20.x;
              r21.y = lightConstantsCB[r10.w].data[10].x + r20.y;
              r20.xy = lightConstantsCB[r10.w].data[9].yz * r21.xy;
              r20.zw = lightConstantsCB[r10.w].data[3].yy / lightConstantsCB[r10.w].data[8].yw;
              ...
              if (r14.w == 0) {
                ...
                r21.x = r20.x * lightConstantsCB[r10.w].data[8].y + lightConstantsCB[r10.w].data[8].z;
                r21.y = r20.y * lightConstantsCB[r10.w].data[8].w + lightConstantsCB[r10.w].data[9].x;
                r15.w = lightConstantsCB[r10.w].data[10].z * r14.y;
                r11.w = lightConstantsCB[r10.w].data[10].y * r14.y + r11.w;
                r11.w = r11.w / r15.w;
              }
            } else {
              r14.w = -1;
            ...
            if (r14.y == 0) {
              ...
              r14.y = 0x0000ffff & (int)lightConstantsCB[r10.w].data[1].w;
              if (enableDitheredShadow != 0) {
                r20.x = -r13.x;
                r22.z = (uint)r14.y;
                r20.y = r14.x;
                ...
                while (true) {
                  ...
                  r22.xy = r23.xy * lightConstantsCB[r10.w].data[3].yy + r21.xy;
                  r15.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r22.xyz, r11.w).x;
                  r14.z = r15.w * 0.125 + r14.z;
                  r14.w = (int)r14.w + 1;
                }
              } else {
                r21.z = (uint)r14.y;
                r14.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r21.xyz, r11.w).x;
              }
              r10.w = r14.z * r14.z;
              r10.w = r10.w * r14.z;
            } else {
  ...
  r4.xyz = r18.xyz * float3(0.0399999991,0.0399999991,0.0399999991) + r4.xyz;
  r2.xyz = r4.xyz + r2.xyz;
  r4.xyz = float3(1,1,1) + -r3.xyz;
  r4.xyz = r19.xyz * r4.xyz;
  r3.xyz = r18.xyz * r3.xyz + r4.xyz;
