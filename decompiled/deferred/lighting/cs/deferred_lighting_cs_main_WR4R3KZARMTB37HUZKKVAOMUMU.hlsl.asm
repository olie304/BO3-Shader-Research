...
ushr r0.y, r0.y, l(24)
uge r4.z, r0.y, r3.z
ult r5.w, r0.y, cb2[0].y
and r4.z, r4.z, r5.w
if_nz r4.z
  imul null, r4.z, r0.y, l(14)
  if_nz r1.z
    add r13.yzw, cb1[24].xxyz, cb10[r4.z + 0].xxyz
    mov r13.x, l(16)
    store_structured u2.xyzw, cb2[52].x, l(880), r13.xyzw
  endif 
  add r13.xyz, r10.xyzx, -cb10[r4.z + 0].xyzx
  and r5.w, l(0x0000ffff), cb10[r4.z + 7].z
  ubfe r6.w, l(6), l(25), cb10[r4.z + 7].z
  imul null, r7.w, r5.w, l(6)
  dp3 r8.w, cb11[r7.w + 0].xyzx, r13.xyzx
  add_sat r8.w, r8.w, cb11[r7.w + 0].w
  dp3 r9.w, cb11[r7.w + 1].xyzx, r13.xyzx
  add_sat r9.w, r9.w, cb11[r7.w + 1].w
  mul r8.w, r8.w, r9.w
  dp3 r9.w, cb11[r7.w + 2].xyzx, r13.xyzx
  add_sat r9.w, r9.w, cb11[r7.w + 2].w
  mul r8.w, r8.w, r9.w
  dp3 r9.w, cb11[r7.w + 3].xyzx, r13.xyzx
  add_sat r9.w, r9.w, cb11[r7.w + 3].w
  mul r8.w, r8.w, r9.w
  dp3 r9.w, cb11[r7.w + 4].xyzx, r13.xyzx
  add_sat r9.w, r9.w, cb11[r7.w + 4].w
  mul r8.w, r8.w, r9.w
  dp3 r9.w, cb11[r7.w + 5].xyzx, r13.xyzx
  add_sat r7.w, r9.w, cb11[r7.w + 5].w
  mul r14.x, r7.w, r8.w
  and r7.w, l(1), cb10[r4.z + 6].x
  mov r14.yz, l(0,0,1.000000,0)
  movc r14.xy, r7.wwww, r14.xyxx, r14.zxzz
  mov r15.x, l(1.000000)
  mov r7.w, cb10[r4.z + 6].x
  mov r16.xy, r14.xyxx
  mov r8.w, l(1)
  loop 
    ige r9.w, r8.w, r6.w
    ...
    dp3 r10.w, cb11[r9.w + 0].xyzx, r13.xyzx
    add_sat r10.w, r10.w, cb11[r9.w + 0].w
    mul r10.w, r10.w, r16.x
    dp3 r13.w, cb11[r9.w + 1].xyzx, r13.xyzx
    add_sat r13.w, r13.w, cb11[r9.w + 1].w
    mul r10.w, r10.w, r13.w
    dp3 r13.w, cb11[r9.w + 2].xyzx, r13.xyzx
    add_sat r13.w, r13.w, cb11[r9.w + 2].w
    mul r10.w, r10.w, r13.w
    dp3 r13.w, cb11[r9.w + 3].xyzx, r13.xyzx
    add_sat r13.w, r13.w, cb11[r9.w + 3].w
    mul r10.w, r10.w, r13.w
    dp3 r13.w, cb11[r9.w + 4].xyzx, r13.xyzx
    add_sat r13.w, r13.w, cb11[r9.w + 4].w
    mul r10.w, r10.w, r13.w
    dp3 r13.w, cb11[r9.w + 5].xyzx, r13.xyzx
    add_sat r9.w, r13.w, cb11[r9.w + 5].w
    mul r16.x, r9.w, r10.w
    ushr r13.w, r7.w, l(2)
    ubfe r14.z, l(1), l(2), r7.w
    and r14.w, r13.w, l(2)
    max r15.z, r16.x, r16.y
    mad r9.w, -r10.w, r9.w, l(1.000000)
    mul r9.w, r9.w, r16.y
    movc r15.y, r14.w, r9.w, r15.z
    movc r16.xy, r14.zzzz, r16.xyxx, r15.xyxx
    iadd r8.w, r8.w, l(1)
    mov r7.w, r13.w
  endloop 
  mov_sat r16.y, r16.y
  mul r5.w, r16.y, cb10[r4.z + 6].y
  ...
  if_nz r6.w
    if_nz r1.z
      ...
      store_structured u2.x, cb2[52].x, l(896), r5.w
    endif 
    mul r6.w, r5.w, cb10[r4.z + 7].y
    mov r14.x, cb10[r4.z + 7].w
    mov r14.yz, cb10[r4.z + 8].xxyx
    dp3 r7.w, r12.xyzx, r14.xyzx
    dp3 r8.w, r13.xyzx, r14.xyzx
    add r8.w, r8.w, -cb10[r4.z + 8].z
    ...
    mov r14.x, cb10[r4.z + 8].w
    mov r14.yz, cb10[r4.z + 9].xxyx
    dp3 r8.w, r12.xyzx, r14.xyzx
    dp3 r9.w, r13.xyzx, r14.xyzx
    add r9.w, r9.w, -cb10[r4.z + 9].z
    ...
    div r8.w, r9.w, r8.w
    min r7.w, r7.w, |r8.w|
    mov r14.x, cb10[r4.z + 9].w
    mov r14.yz, cb10[r4.z + 10].xxyx
    dp3 r8.w, r12.xyzx, r14.xyzx
    dp3 r9.w, r13.xyzx, r14.xyzx
    add r9.w, r9.w, -cb10[r4.z + 10].z
    ge r10.w, r9.w, l(0.000000)
    max r9.w, r2.w, |r9.w|
    movc r9.w, r10.w, r9.w, -r9.w
    max r8.w, -r8.w, l(0.00000010)
    div r8.w, r9.w, r8.w
    min r7.w, r7.w, |r8.w|
    mov r14.x, cb10[r4.z + 10].w
    mov r14.yz, cb10[r4.z + 11].xxyx
    dp3 r8.w, r12.xyzx, r14.xyzx
    dp3 r9.w, r13.xyzx, r14.xyzx
    add r9.w, r9.w, -cb10[r4.z + 11].z
    ge r10.w, r9.w, l(0.000000)
    max r9.w, r2.w, |r9.w|
    movc r9.w, r10.w, r9.w, -r9.w
    max r8.w, -r8.w, l(0.00000010)
    div r8.w, r9.w, r8.w
    min r7.w, r7.w, |r8.w|
    mov r14.x, cb10[r4.z + 11].w
    mov r14.yz, cb10[r4.z + 12].xxyx
    dp3 r8.w, r12.xyzx, r14.xyzx
    dp3 r9.w, r13.xyzx, r14.xyzx
    add r9.w, r9.w, -cb10[r4.z + 12].z
    ge r10.w, r9.w, l(0.000000)
    max r9.w, r2.w, |r9.w|
    movc r9.w, r10.w, r9.w, -r9.w
    max r8.w, -r8.w, l(0.00000010)
    div r8.w, r9.w, r8.w
    min r7.w, r7.w, |r8.w|
    mov r14.x, cb10[r4.z + 12].w
    mov r14.yz, cb10[r4.z + 13].xxyx
    dp3 r8.w, r12.xyzx, r14.xyzx
    dp3 r9.w, r13.xyzx, r14.xyzx
    add r9.w, r9.w, -cb10[r4.z + 13].z
    ge r10.w, r9.w, l(0.000000)
    max r9.w, r2.w, |r9.w|
    movc r9.w, r10.w, r9.w, -r9.w
    max r8.w, -r8.w, l(0.00000010)
    div r8.w, r9.w, r8.w
    min r7.w, r7.w, |r8.w|
    add r14.x, r13.x, cb10[r4.z + 3].w
    add r14.yz, r13.yyzy, cb10[r4.z + 4].xxyx
    mad r14.xyz, r12.xyzx, r7.wwww, r14.xyzx
    dp3 r8.w, r14.xyzx, r14.xyzx
    sqrt r8.w, r8.w
    div r7.w, r7.w, r8.w
    add r7.w, r7.w, r7.w
    sqrt r7.w, r7.w
    mad r7.w, r1.w, l(5.000000), r7.w
    add r7.w, r7.w, l(-0.844800)
    mov r15.x, cb10[r4.z + 0].w
    mov r15.y, cb10[r4.z + 1].z
    mov r15.z, cb10[r4.z + 2].y
    dp3 r16.x, r14.xyzx, r15.xyzx
    mov r17.xy, cb10[r4.z + 1].xwxx
    mov r17.z, cb10[r4.z + 2].z
    dp3 r16.y, r14.xyzx, r17.xyzx
    mov r18.x, cb10[r4.z + 1].y
    mov r18.yz, cb10[r4.z + 2].xxwx
    dp3 r16.z, r14.xyzx, r18.xyzx
    ubfe r8.w, l(9), l(16), cb10[r4.z + 7].z
    utof r16.w, r8.w
    sample_l_indexable(texturecubearray)(float,float,float,float) r14.xyz, r16.xyzw, t8.xyzw, s2, r7.w
    and r19.xyz, r14.xyzx, l(0x7fffffff, 0x7fffffff, 0x7fffffff, 0)
    ieq r19.xyz, r19.xyzx, l(0x7f800000, 0x7f800000, 0x7f800000, 0)
    or r7.w, r19.y, r19.x
    or r7.w, r19.z, r7.w
    movc r14.xyz, r7.wwww, l(1.000000,1.000000,0,0), r14.xyzx
    dp3 r19.x, r13.xyzx, r15.xyzx
    dp3 r19.y, r13.xyzx, r17.xyzx
    dp3 r19.z, r13.xyzx, r18.xyzx
    mad_sat r13.xyz, r19.xyzx, cb10[r4.z + 3].xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
    mul r19.xy, r13.xyxx, cb10[r4.z + 4].zwzz
    mul r19.z, r13.z, cb10[r4.z + 5].x
    add r13.xyz, r19.xyzx, cb10[r4.z + 5].yzwy
    ...
    or r4.z, r16.y, r16.x
    or r4.z, r16.z, r4.z
    movc r15.xyz, r4.zzzz, l(1.000000,1.000000,0,0), r15.xyzx
    mul r13.xyz, r13.xyzx, r15.xyzx
    dp3 r4.z, r13.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
    mul r7.w, r3.y, r4.z
    mul r14.xyz, r6.wwww, r14.xyzx
    dp3 r6.w, r14.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
    mad r4.z, r3.y, r4.z, r6.w
    div r4.z, r7.w, r4.z
...
if_nz r3.z
  ...
  if_nz r1.z
    and r3.z, r4.z, l(1)
    imad r3.z, r3.z, l(20), l(880)
    add r15.yzw, cb1[24].xxyz, cb10[r0.y + 0].xxyz
    mov r15.x, l(16)
    store_structured u2.xyzw, cb2[52].x, r3.z, r15.xyzw
  endif 
  iadd r3.z, r4.z, l(1)
  ...
  loop 
    ...
    dp3 r13.w, cb11[r10.w + 0].xyzx, r15.xyzx
    add_sat r13.w, r13.w, cb11[r10.w + 0].w
    mul r13.w, r13.w, r18.x
    dp3 r14.w, cb11[r10.w + 1].xyzx, r15.xyzx
    add_sat r14.w, r14.w, cb11[r10.w + 1].w
    mul r13.w, r13.w, r14.w
    dp3 r14.w, cb11[r10.w + 2].xyzx, r15.xyzx
    add_sat r14.w, r14.w, cb11[r10.w + 2].w
    mul r13.w, r13.w, r14.w
    dp3 r14.w, cb11[r10.w + 3].xyzx, r15.xyzx
    add_sat r14.w, r14.w, cb11[r10.w + 3].w
    mul r13.w, r13.w, r14.w
    dp3 r14.w, cb11[r10.w + 4].xyzx, r15.xyzx
    add_sat r14.w, r14.w, cb11[r10.w + 4].w
    mul r13.w, r13.w, r14.w
    dp3 r14.w, cb11[r10.w + 5].xyzx, r15.xyzx
    add_sat r10.w, r14.w, cb11[r10.w + 5].w
    mul r18.x, r10.w, r13.w
    ushr r14.w, r8.w, l(2)
    ubfe r15.w, l(1), l(2), r8.w
    and r16.z, r14.w, l(2)
    max r16.w, r18.x, r18.y
    mad r10.w, -r13.w, r10.w, l(1.000000)
    mul r10.w, r10.w, r18.y
    movc r17.y, r16.z, r10.w, r16.w
    movc r18.xy, r15.wwww, r18.xyxx, r17.xyxx
    iadd r9.w, r9.w, l(1)
    mov r8.w, r14.w
  endloop 
  add_sat r6.w, -r5.w, r18.y
  ...
  if_nz r8.w
    ...
    and r9.w, r1.z, r9.w
    if_nz r9.w
      imad r16.xy, r8.wwww, l(20, 20, 0, 0), l(860, 876, 0, 0)
      ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r8.w, cb2[52].x, r16.x, u2.xxxx
      or r8.w, r8.w, l(32)
      store_structured u2.x, cb2[52].x, r16.x, r8.w
      store_structured u2.x, cb2[52].x, r16.y, r7.w
    endif 
    iadd r3.z, r4.z, l(257)
    mad r6.w, r6.w, cb10[r0.y + 6].y, r5.w
    mul r7.w, r7.w, cb10[r0.y + 7].y
...
ge r0.y, r5.w, l(1.000000)
bfi r1.w, l(8), l(0), r3.z, r4.z
movc r0.y, r0.y, r1.w, r3.z
max r1.w, r6.w, l(1.000000)
rcp r1.w, r1.w
mov_sat r6.w, r6.w
mul r15.xyz, r1.wwww, r13.xyzx
mul r14.xyz, r1.wwww, r14.xyzx
lt r2.w, r6.w, l(0.990000)
if_nz r2.w
  ...
  mad r15.xyz, r13.xyzx, r1.wwww, r11.xyzx
  mov r12.w, l(0)
