...
sqrt r1.z, r1.z
mul r2.yz, r0.zzwz, cb1[44].zzwz
gather4_indexable(texture2d)(float,float,float,float) r12.xyzw, r2.yzyy, t27.xyzw, s4.x
gather4_indexable(texture2d)(float,float,float,float) r13.xyzw, r2.yzyy, t28.xyzw, s4.x
mul r0.zw, r0.zzzw, l(0.000000, 0.000000, 0.500000, 0.500000)
frc r0.zw, r0.zzzw
add r2.yz, -r0.wwzw, l(0.000000, 1.000000, 1.000000, 0.000000)
mul r14.y, r2.y, r2.z
mul r14.xz, r0.zzwz, r2.yyzy
mul r14.w, r0.w, r0.z
...
max r1.w, r1.w, |r13.y|
max r1.w, r1.w, |r13.x|
eq r2.yzw, r0.wwww, |r13.yyzw|
movc r0.w, r2.y, r12.y, r12.x
movc r0.w, r2.z, r12.z, r0.w
movc r0.w, r2.w, r12.w, r0.w
...
add r2.xyz, r9.xyzx, -cb2[35].xyzx
mul r12.x, r2.x, cb2[35].w
mul r12.yz, r2.yyzy, cb2[36].xxyx
add_sat r2.xyz, r12.xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
mul r12.xy, r2.xyxx, cb2[36].zwzz
mul r12.z, r2.z, cb2[37].x
add r2.xyz, r12.xyzx, cb2[37].yzwy
lt r12.xyz, l(0.000000, 0.000000, 0.000000, 0.000000), r10.xyzx
movc r12.xyz, r12.xyzx, l(0,0,0,0), l(0.500000,0.500000,0.500000,0)
mov r12.w, l(0)
add r13.xyz, r2.xyzx, r12.wwxw
...
add r2.xyz, r2.xyzx, r12.wwzw
sample_l_indexable(texture3d)(float,float,float,float) r2.xyz, r2.xyzx, t19.xyzw, s4, l(0.000000)
mad r2.xyz, r2.xyzx, r14.zzzz, r13.xyzx
mov r10.w, l(0)
