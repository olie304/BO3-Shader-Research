...
r0.y = samp0[]..swiz;
  ...
  while (true) {
    ...
    if (r15.w != 0) {
      ...
      r26.w = (int)r25.w + 1;
      r16.yzw = -refProbeConstantsCB[r14.w].data[0].xyz + r11.xyz;
      r15.w = 0x0000ffff & (int)refProbeConstantsCB[r14.w].data[7].z;
      if (6 == 0) r18.y = 0; else if (6+25 < 32) {       r18.y = (uint)refProbeConstantsCB[r14.w].data[7].z << (32-(6 + 25)); r18.y = (uint)r18.y >> (32-6);      } else r18.y = (uint)refProbeConstantsCB[r14.w].data[7].z >> 25;
      r18.z = (int)r15.w * 6;
      ...
      while (true) {
        ...
        r20.w = (int)r20.w * 6;
        r22.w = dot(refProbeAttenuationConstantsCB[r20.w].data[0].xyz, r16.yzw);
        r22.w = saturate(refProbeAttenuationConstantsCB[r20.w].data[0].w + r22.w);
        r22.w = r27.x * r22.w;
        r23.w = dot(refProbeAttenuationConstantsCB[r20.w].data[1].xyz, r16.yzw);
        r23.w = saturate(refProbeAttenuationConstantsCB[r20.w].data[1].w + r23.w);
        r22.w = r23.w * r22.w;
        r23.w = dot(refProbeAttenuationConstantsCB[r20.w].data[2].xyz, r16.yzw);
        r23.w = saturate(refProbeAttenuationConstantsCB[r20.w].data[2].w + r23.w);
        r22.w = r23.w * r22.w;
        r23.w = dot(refProbeAttenuationConstantsCB[r20.w].data[3].xyz, r16.yzw);
        r23.w = saturate(refProbeAttenuationConstantsCB[r20.w].data[3].w + r23.w);
        r22.w = r23.w * r22.w;
        r23.w = dot(refProbeAttenuationConstantsCB[r20.w].data[4].xyz, r16.yzw);
        r23.w = saturate(refProbeAttenuationConstantsCB[r20.w].data[4].w + r23.w);
        r22.w = r23.w * r22.w;
        r23.w = dot(refProbeAttenuationConstantsCB[r20.w].data[5].xyz, r16.yzw);
        ...
        r20.w = -r22.w * r20.w + 1;
        r20.w = r27.y * r20.w;
        r21.y = r27.w ? r20.w : r28.x;
        r27.xy = r27.zz ? r27.xy : r21.xy;
        r19.w = (int)r19.w + 1;
        r19.x = r23.w;
      }
      r27.y = saturate(r27.y);
      r15.w = refProbeConstantsCB[r14.w].data[6].y * r27.y;
      r18.y = cmp(0 < r15.w);
      if (r18.y != 0) {
        r18.y = (int)r26.w & 7;
        r18.z = (int)r18.y + -1;
        ...
        r18.y = dot(r17.xyz, r28.xyz);
        r18.z = dot(r16.yzw, r28.xyz);
        r18.z = -refProbeConstantsCB[r14.w].data[8].z + r18.z;
        r18.w = cmp(r18.z >= 0);
        ...
        r27.xzw = r17.xyz * r18.yyy + r28.xyz;
        r18.z = dot(r27.xzw, r27.xzw);
        r18.z = sqrt(r18.z);
        r18.y = r18.y / r18.z;
        r18.y = r18.y + r18.y;
        r18.y = sqrt(r18.y);
        ...
        if (9 == 0) r18.z = 0; else if (9+16 < 32) {         r18.z = (uint)refProbeConstantsCB[r14.w].data[7].z << (32-(9 + 16)); r18.z = (uint)r18.z >> (32-9);        } else r18.z = (uint)refProbeConstantsCB[r14.w].data[7].z >> 16;
        r29.w = (uint)r18.z;
        ...
        r19.x = (int)r27.z | (int)r27.x;
        r19.x = (int)r27.w | (int)r19.x;
        ...
        r14.w = r10.w * r14.w + r15.w;
        r14.w = r16.y / r14.w;
        r28.x = r24.w;
        r28.yz = r25.xy;
        r16.yzw = r18.yzw * r14.www + r28.xyz;
        r24.w = r16.y;
        r25.xy = r16.zw;
      } else {
        r26.xyz = r25.xyz;
  ...
  while (true) {
    ...
    if (r15.w != 0) {
      ...
      while (true) {
        ...
        r28.x = r23.w * r22.w;
        r26.w = (uint)r19.x >> 2;
        if (1 == 0) r28.z = 0; else if (1+2 < 32) {         r28.z = (uint)r19.x << (32-(1 + 2)); r28.z = (uint)r28.z >> (32-1);        } else r28.z = (uint)r19.x >> 2;
        r28.w = (int)r26.w & 2;
        r29.x = max(r28.y, r28.x);
        r22.w = -r23.w * r22.w + 1;
        r22.w = r28.y * r22.w;
        r21.w = r28.w ? r22.w : r29.x;
        r28.xy = r28.zz ? r28.xy : r21.zw;
        r20.w = (int)r20.w + 1;
        r19.x = r26.w;
      }
      r15.w = saturate(r28.y + -r25.z);
      ...
      if (r19.w != 0) {
        ...
        r20.w = r20.w ? r2.w : 0;
        if (r20.w != 0) {
          r27.zw = mad((int2)r19.ww, int2(20,20), int2(860,876));
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r19.w, cb2[52].x, r27.z, u2.xxxx
        r19.w = samp0[]..swiz;
          r19.w = (int)r19.w | 32;
          GBufferDiffuseColor[viewID].r27.z = u2.x;
          GBufferDiffuseColor[viewID].r27.w = u2.x;
        }
        r21.y = (int)r21.y + 257;
        r21.x = r15.w * refProbeConstantsCB[r14.w].data[6].y + r21.x;
        ...
        r19.x = dot(r17.xyz, r29.xyz);
        r19.w = dot(r18.yzw, r29.xyz);
        ...
        r19.w = r20.w / r19.w;
        r19.x = min(r19.x, abs(r19.w));
        r29.x = refProbeConstantsCB[r14.w].data[3].w + r18.y;
        r29.yz = refProbeConstantsCB[r14.w].data[4].xy + r18.zw;
        r28.xzw = r17.xyz * r19.xxx + r29.xyz;
        r19.w = dot(r28.xzw, r28.xzw);
        r19.w = sqrt(r19.w);
        r19.x = r19.x / r19.w;
        r19.x = r19.x + r19.x;
        r19.x = sqrt(r19.x);
        ...
        r30.w = (uint)r19.w;
        r28.xzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r30.xyzw, r19.x).xyz;
        r33.xyz = (int3)r28.xzw & int3(-2147483648,-2147483648,-2147483648);
        r33.xyz = cmp((int3)r33.xyz == int3(2139095040,2139095040,2139095040));
        r19.x = (int)r33.y | (int)r33.x;
        r19.x = (int)r33.z | (int)r19.x;
        r28.xzw = r19.xxx ? float3(1,1,0) : r28.xzw;
        ...
        r18.yzw = r18.yzw * r32.zzz + r29.xyw;
        ...
        r29.xyz = r14.www ? float3(1,1,0) : r29.xyz;
        r30.xyz = r29.xyz * r18.yzw;
        r14.w = dot(r30.xyz, float3(0.212599993,0.715200007,0.0722000003));
        r16.yzw = r18.yzw * r29.xyz + r16.yzw;
        r18.y = r14.w * r10.w;
        r28.xzw = r28.xzw * r15.www;
        r15.w = dot(r28.xzw, float3(0.212599993,0.715200007,0.0722000003));
        r14.w = r10.w * r14.w + r15.w;
        r14.w = r18.y / r14.w;
        r26.xyz = r28.xzw * r14.www + r26.xyz;
      } else {
        r27.x = r21.x;
        r21.xy = r27.xy;
      }
  ...
  r0.x = cmp(r25.z >= 1);
  bitmask.w = ((~(-1 << 8)) << 0) & 0xffffffff;  r6.w = (((uint)r21.y << 0) & bitmask.w) | ((uint)r25.w & ~bitmask.w);
  r0.x = r0.x ? r6.w : r21.y;
  r6.w = max(1, r21.x);
  r6.w = rcp(r6.w);
  r21.x = saturate(r21.x);
  r18.xyz = r16.yzw * r6.www;
  r19.xyz = r26.xyz * r6.www;
  r9.w = cmp(r21.x < 0.99000001);
  if (r9.w != 0) {
    r0.x = (int)r0.x + 256;
    r9.w = 1 + -r21.x;
    ...
    r18.xyz = r16.yzw * r6.www + r20.xyz;
    r17.w = 0;
    ...
    r19.xyz = r16.yzw * r6.www + r19.xyz;
  }
  r6.w = r2.x + r5.z;
  r6.w = log2(abs(r6.w));
  r6.w = r6.w * r2.z;
  ...
  r16.yzw = r19.xyz * r6.www;
  r19.xyz = r16.yzw * r13.zzz;
  ...
  if (r8.w != 0) {
    ...
    if (r8.w != 0) {
      ...
      r3.y = cmp(0 < r3.y);
      r18.xyz = r18.xyz * r5.zzz + r23.xyz;
      ...
      r1.z = r5.z * r1.z;
      r1.z = r3.z * r1.z;
      r24.xyz = r1.zzz * r16.yzw + r19.xyz;
      ...
      r21.zw = r24.xy;
      r25.zw = r19.xy;
      r18.xyzw = r3.yyyy ? r21.xyzw : r25.xyzw;
      r23.x = r24.z;
      r22.w = r19.z;
        ...
        if (r14.w != 0) {
          ...
          if (r14.w != 0) {
            ...
            while (true) {
              ...
              if (r20.w != 0) break;
              r41.y = dot(icb[r19.w+0].yx, r18.xy);
              r41.z = dot(icb[r19.w+0].yx, r18.yz);
              ...
              if (r15.w == 0) {
                ...
                if (enableDitheredShadow != 0) {
                  ...
                  while (true) {
                    ...
                    if (r21.w != 0) break;
                    r39.x = dot(icb[r20.w+0].yx, r18.xw);
                  ...
                  r38.z = (uint)r15.w;
                  r19.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r38.xyz, r10.w).x;
                }
                r9.w = r19.w * r19.w;
                r9.w = r9.w * r19.w;
              } else {
