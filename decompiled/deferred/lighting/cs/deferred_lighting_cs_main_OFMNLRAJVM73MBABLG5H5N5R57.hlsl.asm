...
loop 
  ieq r19.w, r17.w, l(2)
  breakc_nz r19.w
  movc r19.w, r17.w, r0.x, r17.y
  uge r20.w, r19.w, r17.x
  ult r22.w, r19.w, cb2[0].y
  ...
  if_nz r20.w
    ...
    dp3 r27.x, cb11[r23.w + 0].xyzx, r18.yzwy
    add_sat r27.x, r27.x, cb11[r23.w + 0].w
    dp3 r27.y, cb11[r23.w + 1].xyzx, r18.yzwy
    add_sat r27.y, r27.y, cb11[r23.w + 1].w
    mul r27.x, r27.y, r27.x
    dp3 r27.y, cb11[r23.w + 2].xyzx, r18.yzwy
    add_sat r27.y, r27.y, cb11[r23.w + 2].w
    mul r27.x, r27.y, r27.x
    dp3 r27.y, cb11[r23.w + 3].xyzx, r18.yzwy
    add_sat r27.y, r27.y, cb11[r23.w + 3].w
    mul r27.x, r27.y, r27.x
    dp3 r27.y, cb11[r23.w + 4].xyzx, r18.yzwy
    add_sat r27.y, r27.y, cb11[r23.w + 4].w
    mul r27.x, r27.y, r27.x
    dp3 r27.y, cb11[r23.w + 5].xyzx, r18.yzwy
    add_sat r23.w, r27.y, cb11[r23.w + 5].w
    mul r19.x, r23.w, r27.x
    and r23.w, l(1), cb10[r19.w + 6].x
    movc r27.xy, r23.wwww, r19.xyxx, r19.zxzz
    mov r19.x, cb10[r19.w + 6].x
    mov r28.xy, r27.xyxx
    mov r23.w, l(1)
    loop 
      ige r27.z, r23.w, r22.w
      breakc_nz r27.z
      iadd r27.z, r20.w, r23.w
      imul null, r27.z, r27.z, l(6)
      dp3 r27.w, cb11[r27.z + 0].xyzx, r18.yzwy
      add_sat r27.w, r27.w, cb11[r27.z + 0].w
      mul r27.w, r27.w, r28.x
      dp3 r28.z, cb11[r27.z + 1].xyzx, r18.yzwy
      add_sat r28.z, r28.z, cb11[r27.z + 1].w
      mul r27.w, r27.w, r28.z
      dp3 r28.z, cb11[r27.z + 2].xyzx, r18.yzwy
      add_sat r28.z, r28.z, cb11[r27.z + 2].w
      mul r27.w, r27.w, r28.z
      dp3 r28.z, cb11[r27.z + 3].xyzx, r18.yzwy
      add_sat r28.z, r28.z, cb11[r27.z + 3].w
      mul r27.w, r27.w, r28.z
      dp3 r28.z, cb11[r27.z + 4].xyzx, r18.yzwy
      add_sat r28.z, r28.z, cb11[r27.z + 4].w
      mul r27.w, r27.w, r28.z
      dp3 r28.z, cb11[r27.z + 5].xyzx, r18.yzwy
      ...
      movc r21.y, r29.x, r27.z, r29.y
      movc r28.xy, r28.wwww, r28.xyxx, r21.xyxx
      iadd r23.w, r23.w, l(1)
      mov r19.x, r28.z
    endloop 
    mov_sat r28.y, r28.y
    mul r19.x, r28.y, cb10[r19.w + 6].y
    ...
    if_nz r20.w
      ...
      dp3 r21.y, r16.xyzx, r27.xyzx
      dp3 r22.w, r18.yzwy, r27.xyzx
      add r22.w, r22.w, -cb10[r19.w + 9].z
      ge r23.w, r22.w, l(0.000000)
      max r22.w, r15.z, |r22.w|
      ...
      div r21.y, r22.w, r21.y
      min r20.w, r20.w, |r21.y|
      add r27.x, r18.y, cb10[r19.w + 3].w
      add r27.yz, r18.zzwz, cb10[r19.w + 4].xxyx
      mad r27.xyz, r16.xyzx, r20.wwww, r27.xyzx
      dp3 r21.y, r27.xyzx, r27.xyzx
      sqrt r21.y, r21.y
      div r20.w, r20.w, r21.y
      add r20.w, r20.w, r20.w
      sqrt r20.w, r20.w
      mad r20.w, r12.w, l(5.000000), r20.w
      ...
      utof r30.w, r21.y
      sample_l_indexable(texturecubearray)(float,float,float,float) r27.xyz, r30.xyzw, t8.xyzw, s2, r20.w
      and r28.xzw, r27.xxyz, l(0x7fffffff, 0, 0x7fffffff, 0x7fffffff)
      ieq r28.xzw, r28.xxzw, l(0x7f800000, 0, 0x7f800000, 0x7f800000)
      or r20.w, r28.z, r28.x
      or r20.w, r28.w, r20.w
      movc r27.xyz, r20.wwww, l(1.000000,1.000000,0,0), r27.xyzx
      dp3 r33.x, r18.yzwy, r29.xyzx
      dp3 r33.y, r18.yzwy, r31.xyzx
      dp3 r33.z, r18.yzwy, r32.xyzx
      mad_sat r18.yzw, r33.xxyz, cb10[r19.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
      mul r33.xy, r18.yzyy, cb10[r19.w + 4].zwzz
      mul r33.z, r18.w, cb10[r19.w + 5].x
      add r18.yzw, r33.xxyz, cb10[r19.w + 5].yyzw
      ...
      or r19.w, r29.y, r29.x
      or r19.w, r29.z, r19.w
      movc r28.xzw, r19.wwww, l(1.000000,0,1.000000,0), r28.xxzw
      mul r29.xyz, r18.yzwy, r28.xzwx
      dp3 r19.w, r29.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r24.xyz, r18.yzwy, r28.xzwx, r24.xyzx
      mul r18.y, r15.w, r19.w
      mul r27.xyz, r19.xxxx, r27.xyzx
      dp3 r18.z, r27.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r18.z, r15.w, r19.w, r18.z
      div r18.y, r18.y, r18.z
      mov r29.x, r24.w
      mov r29.yz, r25.xxyx
      mad r18.yzw, r27.xxyz, r18.yyyy, r29.xxyz
      mov r24.w, r18.y
      mov r25.xy, r18.zwzz
    else 
...
loop 
  ...
  breakc_nz r19.w
  movc r19.w, r17.w, r0.x, r17.y
  ult r20.w, r19.w, r17.x
  if_nz r20.w
    imul null, r19.w, r19.w, l(14)
    if_nz r6.w
      and r20.w, r21.y, l(15)
      imad r20.w, r20.w, l(20), l(880)
      add r18.yzw, cb1[24].xxyz, cb10[r19.w + 0].xxyz
      store_structured u2.xyzw, cb2[52].x, r20.w, r18.xyzw
    endif 
    iadd r28.y, r21.y, l(1)
    add r18.yzw, r5.xxyz, -cb10[r19.w + 0].xxyz
    and r20.w, l(0x0000ffff), cb10[r19.w + 7].z
    ubfe r22.w, l(6), l(25), cb10[r19.w + 7].z
    imul null, r23.w, r20.w, l(6)
    ...
    and r23.w, l(1), cb10[r19.w + 6].x
    movc r28.zw, r23.wwww, r19.xxxy, r19.zzzx
    mov r19.x, cb10[r19.w + 6].x
    mov r29.xy, r28.zwzz
    mov r23.w, l(1)
    loop 
      ...
      dp3 r29.z, cb11[r26.w + 1].xyzx, r18.yzwy
      add_sat r29.z, r29.z, cb11[r26.w + 1].w
      mul r27.w, r27.w, r29.z
      dp3 r29.z, cb11[r26.w + 2].xyzx, r18.yzwy
      add_sat r29.z, r29.z, cb11[r26.w + 2].w
      mul r27.w, r27.w, r29.z
      dp3 r29.z, cb11[r26.w + 3].xyzx, r18.yzwy
      add_sat r29.z, r29.z, cb11[r26.w + 3].w
      mul r27.w, r27.w, r29.z
      dp3 r29.z, cb11[r26.w + 4].xyzx, r18.yzwy
      add_sat r29.z, r29.z, cb11[r26.w + 4].w
      mul r27.w, r27.w, r29.z
      dp3 r29.z, cb11[r26.w + 5].xyzx, r18.yzwy
      add_sat r26.w, r29.z, cb11[r26.w + 5].w
      ...
      movc r21.w, r30.x, r26.w, r30.y
      movc r29.xy, r29.wwww, r29.xyxx, r21.zwzz
      iadd r23.w, r23.w, l(1)
      mov r19.x, r29.z
    endloop 
    ...
    if_nz r21.w
      and r21.w, r28.y, l(31)
      iadd r22.w, r21.w, l(-1)
      ult r22.w, r22.w, l(32)
      and r22.w, r6.w, r22.w
      if_nz r22.w
        imad r28.zw, r21.wwww, l(0, 0, 20, 20), l(0, 0, 860, 876)
        ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r21.w, cb2[52].x, r28.z, u2.xxxx
        or r21.w, r21.w, l(32)
        store_structured u2.x, cb2[52].x, r28.z, r21.w
        store_structured u2.x, cb2[52].x, r28.w, r20.w
      endif 
      iadd r21.y, r21.y, l(257)
      mad r21.x, r19.x, cb10[r19.w + 6].y, r21.x
      mul r19.x, r20.w, cb10[r19.w + 7].y
      mov r30.x, cb10[r19.w + 7].w
      mov r30.yz, cb10[r19.w + 8].xxyx
      dp3 r20.w, r16.xyzx, r30.xyzx
      dp3 r21.w, r18.yzwy, r30.xyzx
      add r21.w, r21.w, -cb10[r19.w + 8].z
      ge r22.w, r21.w, l(0.000000)
      max r21.w, r15.z, |r21.w|
      ...
      mad r29.xzw, r16.xxyz, r20.wwww, r30.xxyz
      dp3 r21.w, r29.xzwx, r29.xzwx
      sqrt r21.w, r21.w
      ...
      dp3 r31.x, r29.xzwx, r30.xyzx
      mov r32.xy, cb10[r19.w + 1].xwxx
      mov r32.z, cb10[r19.w + 2].z
      dp3 r31.y, r29.xzwx, r32.xyzx
      mov r33.x, cb10[r19.w + 1].y
      mov r33.yz, cb10[r19.w + 2].xxwx
      dp3 r31.z, r29.xzwx, r33.xyzx
      ubfe r21.w, l(9), l(16), cb10[r19.w + 7].z
      utof r31.w, r21.w
      sample_l_indexable(texturecubearray)(float,float,float,float) r29.xzw, r31.xyzw, t8.xwyz, s2, r20.w
      and r34.xyz, r29.xzwx, l(0x7fffffff, 0x7fffffff, 0x7fffffff, 0)
      ieq r34.xyz, r34.xyzx, l(0x7f800000, 0x7f800000, 0x7f800000, 0)
      or r20.w, r34.y, r34.x
      or r20.w, r34.z, r20.w
      movc r29.xzw, r20.wwww, l(1.000000,0,1.000000,0), r29.xxzw
      ...
      movc r22.z, r30.y, l(0), l(0.500000)
      add r30.xyw, r18.yzyw, r22.xyxz
      ...
      add r18.yzw, r18.yyzw, r23.xxyz
      sample_l_indexable(texture3d)(float,float,float,float) r18.yzw, r18.yzwy, t19.wxyz, s4, l(0.000000)
      mad r18.yzw, r18.yyzw, r33.zzzz, r30.xxyw
      ...
      mul r31.xyz, r18.yzwy, r30.xyzx
      dp3 r19.w, r31.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r26.xyz, r18.yzwy, r30.xyzx, r26.xyzx
      mul r18.y, r15.w, r19.w
      mul r29.xzw, r19.xxxx, r29.xxzw
      dp3 r18.z, r29.xzwx, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r18.z, r15.w, r19.w, r18.z
      div r18.y, r18.y, r18.z
      mad r27.xyz, r29.xzwx, r18.yyyy, r27.xyzx
    else 
      mov r28.x, r21.x
      mov r21.xy, r28.xyxx
    endif 
...
bfi r12.w, l(8), l(0), r21.y, r25.w
movc r0.x, r0.x, r12.w, r21.y
max r12.w, r21.x, l(1.000000)
rcp r12.w, r12.w
mov_sat r21.x, r21.x
mul r17.xyw, r12.wwww, r26.xyxz
mul r18.xyz, r12.wwww, r27.xyzx
lt r15.z, r21.x, l(0.990000)
if_nz r15.z
  iadd r0.x, r0.x, l(256)
  add r15.z, -r21.x, l(1.000000)
  ...
  mad r17.xyw, r26.xyxz, r12.wwww, r19.xyxz
  mov r16.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r19.xyz, r16.xyzw, t8.xyzw, s2, r15.y
  mad r12.w, cb2[19].x, r15.z, -r11.w
  mad r11.w, r2.y, r12.w, r11.w
  mad r18.xyz, r19.xyzx, r11.wwww, r18.xyzx
endif 
...
ret 
// Approximately 2575 instruction slots used
