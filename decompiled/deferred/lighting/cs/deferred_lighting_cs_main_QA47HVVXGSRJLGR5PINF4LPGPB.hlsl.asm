...
uge r0.y, r13.z, r12.w
ult r14.w, r13.z, cb2[0].y
and r0.y, r0.y, r14.w
if_nz r0.y
  imul null, r0.y, r13.z, l(14)
  add r15.yzw, r10.xxyz, -cb10[r0.y + 0].xxyz
  and r14.w, l(0x0000ffff), cb10[r0.y + 7].z
  ubfe r17.x, l(6), l(25), cb10[r0.y + 7].z
  imul null, r17.y, r14.w, l(6)
  ...
  endloop 
  mov_sat r19.y, r19.y
  mul r14.w, r19.y, cb10[r0.y + 6].y
  lt r17.x, l(0.000000), r14.w
  if_nz r17.x
    mul r17.x, r14.w, cb10[r0.y + 7].y
    ...
    mad r18.xyz, r16.xyzx, r17.yyyy, r18.xyzx
    ...
    ubfe r17.z, l(9), l(16), cb10[r0.y + 7].z
    utof r20.w, r17.z
...
lt r0.y, r14.w, l(1.000000)
if_nz r0.y
  ult r0.y, r13.z, r12.w
  if_nz r0.y
    imul null, r0.y, r13.z, l(14)
    ...
    loop 
      ...
      mov r17.w, r20.z
    endloop 
    add_sat r12.w, -r14.w, r21.y
    mul r13.z, r12.w, cb10[r0.y + 6].y
    lt r17.w, l(0.000000), r13.z
    if_nz r17.w
      mad r14.w, r12.w, cb10[r0.y + 6].y, r14.w
      mul r12.w, r13.z, cb10[r0.y + 7].y
