...
mov r15.w, l(0)
sample_l_indexable(texturecubearray)(float,float,float,float) r13.yzw, r15.xyzw, t8.wxyz, s2, r2.z
...
switch r7.w
  ...
  add r17.xyz, -r5.xyzx, r13.yzwy
  dp3 r9.w, r16.xyzx, r17.xyzx
  div_sat r10.w, -r9.w, cb9[r0.x + 6].y
  mad r18.xyz, r10.wwww, r16.xyzx, r13.yzwy
  movc r18.xyz, r8.wwww, r18.xyzx, cb9[r0.x + 0].xyzx
  ...
  if_nz r16.w
    ...
    mad_sat r18.xy, r16.wwww, cb9[r0.x + 2].xzxx, cb9[r0.x + 2].ywyy
    ...
    if_nz r16.w
      ...
      if_nz r16.w
        ...
        loop 
          ige r19.w, r19.z, l(8)
          breakc_nz r19.w
          dp2 r22.y, icb[r19.z + 0].yxyy, r20.xyxx
          dp2 r22.z, icb[r19.z + 0].yxyy, r20.yzyy
          mul r22.yz, r22.yyzy, cb9[r0.x + 3].yyyy
          mul r22.x, r19.x, r22.y
          mul r22.w, r18.x, r22.y
          mad r21.xyz, r18.yzwy, r17.wwww, r22.xzwx
          sample_c_lz_indexable(texturecubearray)(float,float,float,float) r19.w, r21.xyzw, t10.xxxx, s13, r16.w
          mad r19.y, r19.w, l(0.125000), r19.y
      ...
      if_nz r16.w
        ...
        dp3 r17.w, r16.xyzx, r15.xyzx
        dp3 r15.x, r15.xyzx, r17.xyzx
        ...
        mad r13.yzw, r9.wwww, r16.xxyz, r13.yyzw
        movc r13.yzw, r8.wwww, r13.yyzw, cb9[r0.x + 0].xxyz
        add r13.yzw, -r5.xxyz, r13.yyzw
        dp3 r8.w, r13.yzwy, r13.yzwy
        rsq r8.w, r8.w
        mul r15.xyz, r8.wwww, r13.yzwy
        ...
        if_nz r10.w
          ...
          mad r17.xyz, r11.xyzx, r10.wwww, r5.xyzx
          mov r18.xyz, cb9[r9.w + 6].yzwy
          mov r18.w, cb9[r9.w + 7].x
          mov r17.w, l(1.000000)
          dp4 r10.w, r18.xyzw, r17.xyzw
          mov r18.xyz, cb9[r9.w + 7].yzwy
          mov r18.w, cb9[r9.w + 8].x
          dp4 r16.x, r18.xyzw, r17.xyzw
          lt r16.y, r16.x, r10.w
          if_z r16.y
            mov r18.xyz, cb9[r9.w + 4].yzwy
            mov r18.w, cb9[r9.w + 5].x
            dp4 r18.x, r18.xyzw, r17.xyzw
            mov r19.xyz, cb9[r9.w + 5].yzwy
            mov r19.w, cb9[r9.w + 6].x
            dp4 r18.y, r19.xyzw, r17.xyzw
            div r17.xy, r18.xyxx, r16.xxxx
            mad r17.xy, r17.xyxx, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
            add r18.x, r17.x, cb9[r9.w + 9].w
            add r18.y, r17.y, cb9[r9.w + 10].x
            mul r17.xy, r18.xyxx, cb9[r9.w + 9].yzyy
            div r17.zw, cb9[r9.w + 3].yyyy, cb9[r9.w + 8].yyyw
            ...
            or r16.z, r17.w, r17.z
            if_z r16.z
              mov_sat r17.xy, r17.xyxx
              mad r18.x, r17.x, cb9[r9.w + 8].y, cb9[r9.w + 8].z
              mad r18.y, r17.y, cb9[r9.w + 8].w, cb9[r9.w + 9].x
              mul r17.x, r16.x, cb9[r9.w + 10].z
              mad r10.w, cb9[r9.w + 10].y, r16.x, r10.w
              div r10.w, r10.w, r17.x
            endif 
          else 
            mov r16.z, l(-1)
          endif 
          or r16.x, r16.y, r16.z
          if_z r16.x
            max r10.w, r10.w, l(0.00006104)
            and r16.x, l(0x0000ffff), cb9[r9.w + 1].w
            if_nz cb2[58].y
              mov r17.x, -r13.x
              utof r19.z, r16.x
              mov r17.y, r14.x
              ...
              loop 
                ige r17.w, r16.z, l(8)
                breakc_nz r17.w
                dp2 r20.x, icb[r16.z + 0].yxyy, r17.xyxx
                dp2 r20.y, icb[r16.z + 0].yxyy, r17.yzyy
                mad r19.xy, r20.xyxx, cb9[r9.w + 3].yyyy, r18.xyxx
                sample_c_lz_indexable(texture2darray)(float,float,float,float) r17.w, r19.xyzx, t9.xxxx, s13, r10.w
                mad r16.y, r17.w, l(0.125000), r16.y
                iadd r16.z, r16.z, l(1)
              endloop 
            else 
              utof r18.z, r16.x
              sample_c_lz_indexable(texture2darray)(float,float,float,float) r16.y, r18.xyzx, t9.xxxx, s13, r10.w
            endif 
            mul r9.w, r16.y, r16.y
            mul r9.w, r16.y, r9.w
          else 
            mov r9.w, l(1.000000)
          endif 
        ...
        add r9.w, -r15.w, r9.w
        mad r9.w, r1.z, r9.w, r15.w
        mul r9.w, r11.w, r9.w
        mov r16.x, cb9[r0.x + 0].w
        mov r16.yz, cb9[r0.x + 1].xxyx
        lt r10.w, l(0.000000), r12.w
        mad r17.xyz, r9.wwww, r16.xyzx, r3.yzwy
        dp3_sat r9.w, r11.xyzx, r15.xyzx
        mad r13.yzw, r13.yyzw, r8.wwww, r12.xxyz
        dp3 r8.w, r13.yzwy, r13.yzwy
        rsq r8.w, r8.w
        mul r13.yzw, r8.wwww, r13.yyzw
        dp3 r8.w, r13.yzwy, r12.xyzx
        dp3 r12.w, r11.xyzx, r13.yzwy
        mad r13.y, |r12.w|, r0.w, -|r12.w|
        mad r12.w, |r12.w|, r13.y, l(1.000000)
        mad r13.y, r9.w, r4.z, r6.w
        ...
        mul r9.w, r9.w, r12.w
        mul r9.w, r11.w, r9.w
        mad r13.yzw, r9.wwww, r16.xxyz, r2.yyzw
        add_sat r8.w, -r8.w, l(1.000000)
        mul r12.w, r8.w, r8.w
        mul r12.w, r12.w, r12.w
        mul r8.w, r8.w, r12.w
        mul r8.w, r8.w, r9.w
        mad r15.xyz, r8.wwww, r16.xyzx, r14.yzwy
        movc r3.yzw, r10.wwww, r17.xxyz, r3.yyzw
        movc r14.yzw, r10.wwww, r15.xxyz, r14.yyzw
        movc r2.yzw, r10.wwww, r13.yyzw, r2.yyzw
        if_nz r1.w
  ...
  if_nz r11.w
    ...
    if_nz r12.w
      ...
      dp4 r17.x, r17.xyzw, r5.xyzw
      mov r18.xyz, cb9[r0.x + 5].yzwy
      mov r18.w, cb9[r0.x + 6].x
      dp4 r17.y, r18.xyzw, r5.xyzw
      div r17.xy, r17.xyxx, r11.wwww
      ...
      if_nz r5.w
        ...
        exp r18.xy, r18.xyxx
        mul r11.w, r18.x, cb9[r0.x + 12].x
        mad r17.w, cb9[r0.x + 12].y, r18.y, l(-1.000000)
        mad r11.w, cb9[r0.x + 12].y, r18.y, -r11.w
        div_sat r11.w, r17.w, r11.w
        mul r17.w, r11.w, r11.w
        mad r11.w, r11.w, l(-2.000000), l(3.000000)
        mul r5.w, r11.w, r17.w
      endif 
      mul r12.w, r5.w, r15.w
      and r5.w, l(255), cb9[r0.x + 14].w
      if_nz r5.w
        mov r17.z, l(1.000000)
        dp3 r11.w, cb9[r0.x + 13].xyzx, r17.xyzx
        mov r18.x, cb9[r0.x + 13].w
        mov r18.yz, cb9[r0.x + 14].xxyx
        dp3 r15.w, r18.xyzx, r17.xyzx
        frc r17.x, r11.w
        frc r17.y, r15.w
        iadd r5.w, r5.w, l(-1)
        utof r17.z, r5.w
    ...
    if_nz r5.w
        ...
        if_nz r15.w
          ...
          if_nz cb2[58].y
            ...
            loop 
              ...
              sample_c_lz_indexable(texture2darray)(float,float,float,float) r17.w, r18.xyzx, t9.xxxx, s13, r5.w
              mad r15.w, r17.w, l(0.125000), r15.w
              iadd r16.w, r16.w, l(1)
            endloop 
          else 
            utof r17.z, r11.w
            sample_c_lz_indexable(texture2darray)(float,float,float,float) r15.w, r17.xyzx, t9.xxxx, s13, r5.w
          endif 
      ...
      if_nz r11.w
        ...
        if_nz r15.w
          ...
          mad r16.xyz, r11.xyzx, r15.wwww, r5.xyzx
          mov r17.xyz, cb9[r12.w + 6].yzwy
          mov r17.w, cb9[r12.w + 7].x
          mov r16.w, l(1.000000)
          dp4 r15.w, r17.xyzw, r16.xyzw
          mov r17.xyz, cb9[r12.w + 7].yzwy
          mov r17.w, cb9[r12.w + 8].x
          dp4 r17.x, r17.xyzw, r16.xyzw
          lt r17.y, r17.x, r15.w
          if_z r17.y
            mov r18.xyz, cb9[r12.w + 4].yzwy
            mov r18.w, cb9[r12.w + 5].x
            dp4 r18.x, r18.xyzw, r16.xyzw
            mov r19.xyz, cb9[r12.w + 5].yzwy
            mov r19.w, cb9[r12.w + 6].x
            dp4 r18.y, r19.xyzw, r16.xyzw
            div r16.xy, r18.xyxx, r17.xxxx
            mad r16.xy, r16.xyxx, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
            add r18.x, r16.x, cb9[r12.w + 9].w
            add r18.y, r16.y, cb9[r12.w + 10].x
            mul r16.xy, r18.xyxx, cb9[r12.w + 9].yzyy
            div r16.zw, cb9[r12.w + 3].yyyy, cb9[r12.w + 8].yyyw
            add r17.zw, -r16.zzzw, l(0.000000, 0.000000, 1.000000, 1.000000)
            ge r17.zw, r16.xxxy, r17.zzzw
            ge r16.zw, r16.zzzw, r16.xxxy
            or r16.zw, r16.zzzw, r17.zzzw
            or r16.z, r16.w, r16.z
            if_z r16.z
              mov_sat r16.xy, r16.xyxx
              mad r18.x, r16.x, cb9[r12.w + 8].y, cb9[r12.w + 8].z
              mad r18.y, r16.y, cb9[r12.w + 8].w, cb9[r12.w + 9].x
              mul r16.x, r17.x, cb9[r12.w + 10].z
              mad r15.w, cb9[r12.w + 10].y, r17.x, r15.w
              div r15.w, r15.w, r16.x
            endif 
          else 
            mov r16.z, l(-1)
          endif 
          or r16.x, r17.y, r16.z
          if_z r16.x
            max r15.w, r15.w, l(0.00006104)
            and r16.x, l(0x0000ffff), cb9[r12.w + 1].w
            if_nz cb2[58].y
              mov r17.x, -r13.x
              utof r19.z, r16.x
              mov r17.y, r14.x
              ...
              loop 
                ...
                dp2 r20.x, icb[r16.z + 0].yxyy, r17.xyxx
                dp2 r20.y, icb[r16.z + 0].yxyy, r17.yzyy
                mad r19.xy, r20.xyxx, cb9[r12.w + 3].yyyy, r18.xyxx
                sample_c_lz_indexable(texture2darray)(float,float,float,float) r16.w, r19.xyzx, t9.xxxx, s13, r15.w
                mad r16.y, r16.w, l(0.125000), r16.y
                iadd r16.z, r16.z, l(1)
              endloop 
            else 
              utof r18.z, r16.x
              sample_c_lz_indexable(texture2darray)(float,float,float,float) r16.y, r18.xyzx, t9.xxxx, s13, r15.w
            endif 
          ...
          if_nz r3.x
            ...
            mad r16.xyz, r11.xyzx, r3.xxxx, r5.xyzx
            mov r17.xyz, cb9[r0.x + 6].yzwy
            mov r17.w, cb9[r0.x + 7].x
            mov r16.w, l(1.000000)
            dp4 r3.x, r17.xyzw, r16.xyzw
            ...
            if_z r12.w
              ...
              if_nz cb2[58].y
                ...
                loop 
                  ige r15.w, r14.x, l(8)
                  breakc_nz r15.w
                  dp2 r19.x, icb[r14.x + 0].yxyy, r16.xyxx
                  dp2 r19.y, icb[r14.x + 0].yxyy, r16.yzyy
                  mad r18.xy, r19.xyxx, cb9[r0.x + 3].yyyy, r17.xyxx
                  sample_c_lz_indexable(texture2darray)(float,float,float,float) r15.w, r18.xyzx, t9.xxxx, s13, r3.x
                  mad r13.x, r15.w, l(0.125000), r13.x
                  iadd r14.x, r14.x, l(1)
                endloop 
              else 
                utof r17.z, r12.w
                sample_c_lz_indexable(texture2darray)(float,float,float,float) r13.x, r17.xyzx, t9.xxxx, s13, r3.x
              endif 
        ...
        mad r11.xyz, r0.wwww, r13.yzwy, r2.yzwy
        add_sat r0.x, -r0.x, l(1.000000)
        mul r2.x, r0.x, r0.x
        mul r2.x, r2.x, r2.x
        mul r0.x, r0.x, r2.x
        mul r0.x, r0.x, r0.w
        mad r12.xyz, r0.xxxx, r13.yzwy, r14.yzwy
        movc r3.yzw, r1.zzzz, r16.xxyz, r3.yyzw
        movc r14.yzw, r1.zzzz, r12.xxyz, r14.yyzw
...
mad r8.xyz, r8.zxyz, l(3.000000, 1.000000, 2.000000, 0.000000), l(0.500000, 0.000000, -1.000000, 0.000000)
ftou r0.w, r8.x
ieq r0.w, r0.x, r0.w
movc r8.xy, r0.wwww, r8.yzyy, l(-1.000000,0,0,0)
mad r9.xyz, r9.zxyz, l(3.000000, 1.000000, 2.000000, 0.000000), l(0.500000, 0.000000, -1.000000, 0.000000)
ftou r0.w, r9.x
ieq r0.w, r0.x, r0.w
movc r8.zw, r0.wwww, r9.yyyz, l(0,0,-1.000000,0)
mad r9.xyz, r10.zxyz, l(3.000000, 1.000000, 2.000000, 0.000000), l(0.500000, 0.000000, -1.000000, 0.000000)
ftou r0.w, r9.x
ieq r0.x, r0.x, r0.w
movc r0.xw, r0.xxxx, r9.yyyz, l(-1.000000,0,0,0)
mov r9.x, r7.x
mov r9.yz, r8.xxzx
mov r9.w, r0.x
...
add r0.x, r9.w, r0.x
mul r1.z, r8.y, r9.y
mad r1.z, r9.x, r7.y, r1.z
mad r1.z, r9.z, r8.w, r1.z
...
ret 
// Approximately 1094 instruction slots used
