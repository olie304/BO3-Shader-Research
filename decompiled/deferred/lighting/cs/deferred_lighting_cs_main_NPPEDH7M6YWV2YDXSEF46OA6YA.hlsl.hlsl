...
r0.y = samp0[]..swiz;
  ...
  while (true) {
    ...
    r15.y = cmp((uint)r13.w < numRefProbes);
    r14.w = r14.w ? r15.y : 0;
    if (r14.w != 0) {
      r13.w = (int)r13.w * 14;
      ...
      while (true) {
        ...
        r19.w = -r20.z * r19.w + 1;
        r19.w = r25.y * r19.w;
        r20.y = r22.w ? r19.w : r25.z;
        r25.xy = r21.ww ? r25.xy : r20.xy;
        r18.w = (int)r18.w + 1;
        r18.x = r20.w;
      }
      r25.y = saturate(r25.y);
      r14.w = refProbeConstantsCB[r13.w].data[6].y * r25.y;
      r16.y = cmp(0 < r14.w);
      if (r16.y != 0) {
        r24.w = r25.y * refProbeConstantsCB[r13.w].data[6].y + r24.w;
        ...
        r16.y = dot(r17.xyz, r26.xyz);
        r16.z = dot(r15.yzw, r26.xyz);
        ...
        r16.z = r16.w / r16.z;
        r16.y = min(r16.y, abs(r16.z));
        r26.x = refProbeConstantsCB[r13.w].data[3].w + r15.y;
        r26.yz = refProbeConstantsCB[r13.w].data[4].xy + r15.zw;
        r20.yzw = r17.xyz * r16.yyy + r26.xyz;
    ...
    while (true) {
      ...
      if (r14.w != 0) {
        ...
        while (true) {
          ...
          if (r21.w != 0) break;
          r21.w = (int)r14.w + (int)r19.w;
          r21.w = (int)r21.w * 6;
          r22.w = dot(refProbeAttenuationConstantsCB[r21.w].data[0].xyz, r16.yzw);
          r22.w = saturate(refProbeAttenuationConstantsCB[r21.w].data[0].w + r22.w);
          r22.w = r26.x * r22.w;
          r26.z = dot(refProbeAttenuationConstantsCB[r21.w].data[1].xyz, r16.yzw);
          r26.z = saturate(refProbeAttenuationConstantsCB[r21.w].data[1].w + r26.z);
          r22.w = r26.z * r22.w;
          r26.z = dot(refProbeAttenuationConstantsCB[r21.w].data[2].xyz, r16.yzw);
          r26.z = saturate(refProbeAttenuationConstantsCB[r21.w].data[2].w + r26.z);
          r22.w = r26.z * r22.w;
          r26.z = dot(refProbeAttenuationConstantsCB[r21.w].data[3].xyz, r16.yzw);
          r26.z = saturate(refProbeAttenuationConstantsCB[r21.w].data[3].w + r26.z);
          r22.w = r26.z * r22.w;
          r26.z = dot(refProbeAttenuationConstantsCB[r21.w].data[4].xyz, r16.yzw);
          r26.z = saturate(refProbeAttenuationConstantsCB[r21.w].data[4].w + r26.z);
          r22.w = r26.z * r22.w;
          r26.z = dot(refProbeAttenuationConstantsCB[r21.w].data[5].xyz, r16.yzw);
          r21.w = saturate(refProbeAttenuationConstantsCB[r21.w].data[5].w + r26.z);
          r26.x = r22.w * r21.w;
          r26.z = (uint)r18.x >> 2;
          if (1 == 0) r26.w = 0; else if (1+2 < 32) {           r26.w = (uint)r18.x << (32-(1 + 2)); r26.w = (uint)r26.w >> (32-1);          } else r26.w = (uint)r18.x >> 2;
          r27.x = (int)r26.z & 2;
          r27.y = max(r26.y, r26.x);
          r21.w = -r22.w * r21.w + 1;
          r21.w = r26.y * r21.w;
          r20.y = r27.x ? r21.w : r27.y;
          r26.xy = r26.ww ? r26.xy : r20.xy;
          r19.w = (int)r19.w + 1;
          r18.x = r26.z;
        }
        r14.w = saturate(r26.y + -r24.w);
        r18.x = refProbeConstantsCB[r13.w].data[6].y * r14.w;
        r18.w = cmp(0 < r18.x);
        if (r18.w != 0) {
          r25.w = r14.w * refProbeConstantsCB[r13.w].data[6].y + r25.w;
          r14.w = refProbeConstantsCB[r13.w].data[7].y * r18.x;
          r27.x = refProbeConstantsCB[r13.w].data[7].w;
          r27.yz = refProbeConstantsCB[r13.w].data[8].xy;
          r18.x = dot(r17.xyz, r27.xyz);
          ...
          r20.yzw = r17.xyz * r18.xxx + r27.xyz;
          ...
          r28.w = (uint)r18.w;
          r20.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r28.xyzw, r18.x).xyz;
          ...
          r16.y = r13.w * r9.w;
          r20.yzw = r20.yzw * r14.www;
          r14.w = dot(r20.yzw, float3(0.212599993,0.715200007,0.0722000003));
          r13.w = r9.w * r13.w + r14.w;
          r13.w = r16.y / r13.w;
          r25.xyz = r20.yzw * r13.www + r25.xyz;
        }
      }
      r10.w = (int)r10.w + 1;
    }
