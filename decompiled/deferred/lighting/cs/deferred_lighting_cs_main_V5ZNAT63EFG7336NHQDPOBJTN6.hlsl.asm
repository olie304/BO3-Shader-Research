...
loop 
  ieq r13.w, r9.w, l(2)
  breakc_nz r13.w
  movc r13.w, r9.w, r0.y, r8.w
  uge r14.z, r13.w, r7.w
  ult r14.w, r13.w, cb2[0].y
  and r14.z, r14.w, r14.z
  if_nz r14.z
    imul null, r13.w, r13.w, l(14)
    add r16.yzw, r11.xxyz, -cb10[r13.w + 0].xxyz
    and r14.z, l(0x0000ffff), cb10[r13.w + 7].z
    ubfe r14.w, l(6), l(25), cb10[r13.w + 7].z
    imul null, r15.w, r14.z, l(6)
    dp3 r17.y, cb11[r15.w + 0].xyzx, r16.yzwy
    add_sat r17.y, r17.y, cb11[r15.w + 0].w
    dp3 r17.z, cb11[r15.w + 1].xyzx, r16.yzwy
    add_sat r17.z, r17.z, cb11[r15.w + 1].w
    mul r17.y, r17.z, r17.y
    dp3 r17.z, cb11[r15.w + 2].xyzx, r16.yzwy
    add_sat r17.z, r17.z, cb11[r15.w + 2].w
    mul r17.y, r17.z, r17.y
    dp3 r17.z, cb11[r15.w + 3].xyzx, r16.yzwy
    add_sat r17.z, r17.z, cb11[r15.w + 3].w
    mul r17.y, r17.z, r17.y
    dp3 r17.z, cb11[r15.w + 4].xyzx, r16.yzwy
    add_sat r17.z, r17.z, cb11[r15.w + 4].w
    mul r17.y, r17.z, r17.y
    dp3 r17.z, cb11[r15.w + 5].xyzx, r16.yzwy
    add_sat r15.w, r17.z, cb11[r15.w + 5].w
    mul r19.x, r15.w, r17.y
    and r15.w, l(1), cb10[r13.w + 6].x
    movc r17.yz, r15.wwww, r19.xxyx, r19.zzxz
    mov r15.w, cb10[r13.w + 6].x
    mov r26.xy, r17.yzyy
    mov r17.w, l(1)
    loop 
      ige r19.x, r17.w, r14.w
      breakc_nz r19.x
      iadd r19.x, r14.z, r17.w
      imul null, r19.x, r19.x, l(6)
      dp3 r19.w, cb11[r19.x + 0].xyzx, r16.yzwy
      add_sat r19.w, r19.w, cb11[r19.x + 0].w
      mul r19.w, r19.w, r26.x
      dp3 r20.w, cb11[r19.x + 1].xyzx, r16.yzwy
      add_sat r20.w, r20.w, cb11[r19.x + 1].w
      mul r19.w, r19.w, r20.w
      dp3 r20.w, cb11[r19.x + 2].xyzx, r16.yzwy
      add_sat r20.w, r20.w, cb11[r19.x + 2].w
      mul r19.w, r19.w, r20.w
      dp3 r20.w, cb11[r19.x + 3].xyzx, r16.yzwy
      add_sat r20.w, r20.w, cb11[r19.x + 3].w
      mul r19.w, r19.w, r20.w
      dp3 r20.w, cb11[r19.x + 4].xyzx, r16.yzwy
      add_sat r20.w, r20.w, cb11[r19.x + 4].w
      mul r19.w, r19.w, r20.w
      dp3 r20.w, cb11[r19.x + 5].xyzx, r16.yzwy
      add_sat r19.x, r20.w, cb11[r19.x + 5].w
      mul r26.x, r19.x, r19.w
      ushr r20.w, r15.w, l(2)
      ubfe r21.z, l(1), l(2), r15.w
      and r21.w, r20.w, l(2)
      max r22.w, r26.x, r26.y
      mad r19.x, -r19.w, r19.x, l(1.000000)
      mul r19.x, r19.x, r26.y
      movc r21.y, r21.w, r19.x, r22.w
      movc r26.xy, r21.zzzz, r26.xyxx, r21.xyxx
      iadd r17.w, r17.w, l(1)
      mov r15.w, r20.w
    endloop 
    mov_sat r26.y, r26.y
    mul r14.z, r26.y, cb10[r13.w + 6].y
    lt r14.w, l(0.000000), r14.z
    if_nz r14.w
      mad r25.w, r26.y, cb10[r13.w + 6].y, r25.w
      mul r14.z, r14.z, cb10[r13.w + 7].y
      mov r27.x, cb10[r13.w + 7].w
      mov r27.yz, cb10[r13.w + 8].xxyx
      dp3 r14.w, r18.xyzx, r27.xyzx
      dp3 r15.w, r16.yzwy, r27.xyzx
      add r15.w, r15.w, -cb10[r13.w + 8].z
      ...
      dp3 r15.w, r18.xyzx, r27.xyzx
      dp3 r17.y, r16.yzwy, r27.xyzx
      ...
      mad r17.yzw, r18.xxyz, r14.wwww, r27.xxyz
      dp3 r15.w, r17.yzwy, r17.yzwy
      sqrt r15.w, r15.w
      div r14.w, r14.w, r15.w
      add r14.w, r14.w, r14.w
      sqrt r14.w, r14.w
      mad r14.w, r3.y, l(5.000000), r14.w
      ...
      ubfe r15.w, l(9), l(16), cb10[r13.w + 7].z
      utof r28.w, r15.w
      ...
      mad r16.yzw, r16.yyzw, r27.zzzz, r26.xxzw
      sample_l_indexable(texturecubearray)(float,float,float,float) r21.yzw, r28.xyzw, t8.wxyz, s2, l(6.000000)
      mul r26.xzw, r16.yyzw, r21.yyzw
      dp3 r13.w, r26.xzwx, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r24.xyz, r16.yzwy, r21.yzwy, r24.xyzx
      mul r14.w, r6.w, r13.w
      mul r16.yzw, r14.zzzz, r17.yyzw
      dp3 r14.z, r16.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r13.w, r6.w, r13.w, r14.z
      div r13.w, r14.w, r13.w
      mov r27.x, r24.w
      mov r27.yz, r25.yyzy
      mad r25.xyz, r16.yzwy, r13.wwww, r27.xyzx
      mov r24.w, r25.x
    endif 
  endif 
  iadd r9.w, r9.w, l(1)
...
if_nz r9.w
  ...
  loop 
    ...
    breakc_nz r13.w
    movc r13.w, r9.w, r0.y, r8.w
    ult r14.z, r13.w, r7.w
    if_nz r14.z
      imul null, r13.w, r13.w, l(14)
      add r17.yzw, r11.xxyz, -cb10[r13.w + 0].xxyz
      and r14.z, l(0x0000ffff), cb10[r13.w + 7].z
      ubfe r14.w, l(6), l(25), cb10[r13.w + 7].z
      imul null, r15.w, r14.z, l(6)
      dp3 r19.w, cb11[r15.w + 0].xyzx, r17.yzwy
      add_sat r19.w, r19.w, cb11[r15.w + 0].w
      dp3 r20.w, cb11[r15.w + 1].xyzx, r17.yzwy
      add_sat r20.w, r20.w, cb11[r15.w + 1].w
      mul r19.w, r19.w, r20.w
      dp3 r20.w, cb11[r15.w + 2].xyzx, r17.yzwy
      add_sat r20.w, r20.w, cb11[r15.w + 2].w
      mul r19.w, r19.w, r20.w
      dp3 r20.w, cb11[r15.w + 3].xyzx, r17.yzwy
      add_sat r20.w, r20.w, cb11[r15.w + 3].w
      mul r19.w, r19.w, r20.w
      dp3 r20.w, cb11[r15.w + 4].xyzx, r17.yzwy
      add_sat r20.w, r20.w, cb11[r15.w + 4].w
      mul r19.w, r19.w, r20.w
      dp3 r20.w, cb11[r15.w + 5].xyzx, r17.yzwy
      add_sat r15.w, r20.w, cb11[r15.w + 5].w
      mul r19.x, r15.w, r19.w
      and r15.w, l(1), cb10[r13.w + 6].x
      movc r19.xw, r15.wwww, r19.xxxy, r19.zzzx
      mov r15.w, cb10[r13.w + 6].x
      mov r27.xy, r19.xwxx
      mov r20.w, l(1)
      loop 
        ige r21.z, r20.w, r14.w
        breakc_nz r21.z
        iadd r21.z, r14.z, r20.w
        imul null, r21.z, r21.z, l(6)
        dp3 r21.w, cb11[r21.z + 0].xyzx, r17.yzwy
        add_sat r21.w, r21.w, cb11[r21.z + 0].w
        mul r21.w, r21.w, r27.x
        dp3 r22.w, cb11[r21.z + 1].xyzx, r17.yzwy
        add_sat r22.w, r22.w, cb11[r21.z + 1].w
        mul r21.w, r21.w, r22.w
        dp3 r22.w, cb11[r21.z + 2].xyzx, r17.yzwy
        add_sat r22.w, r22.w, cb11[r21.z + 2].w
        mul r21.w, r21.w, r22.w
        dp3 r22.w, cb11[r21.z + 3].xyzx, r17.yzwy
        add_sat r22.w, r22.w, cb11[r21.z + 3].w
        mul r21.w, r21.w, r22.w
        dp3 r22.w, cb11[r21.z + 4].xyzx, r17.yzwy
        add_sat r22.w, r22.w, cb11[r21.z + 4].w
        mul r21.w, r21.w, r22.w
        dp3 r22.w, cb11[r21.z + 5].xyzx, r17.yzwy
        add_sat r21.z, r22.w, cb11[r21.z + 5].w
        mul r27.x, r21.z, r21.w
        ushr r22.w, r15.w, l(2)
        ubfe r23.w, l(1), l(2), r15.w
        and r27.z, r22.w, l(2)
        max r27.w, r27.x, r27.y
        mad r21.z, -r21.w, r21.z, l(1.000000)
        mul r21.z, r21.z, r27.y
        movc r21.y, r27.z, r21.z, r27.w
        movc r27.xy, r23.wwww, r27.xyxx, r21.xyxx
        iadd r20.w, r20.w, l(1)
        mov r15.w, r22.w
      endloop 
      add_sat r14.z, -r25.w, r27.y
      mul r14.w, r14.z, cb10[r13.w + 6].y
      lt r15.w, l(0.000000), r14.w
      if_nz r15.w
        mad r26.w, r14.z, cb10[r13.w + 6].y, r26.w
        mul r14.z, r14.w, cb10[r13.w + 7].y
        mov r28.x, cb10[r13.w + 7].w
        mov r28.yz, cb10[r13.w + 8].xxyx
        dp3 r14.w, r18.xyzx, r28.xyzx
        dp3 r15.w, r17.yzwy, r28.xyzx
        add r15.w, r15.w, -cb10[r13.w + 8].z
        ge r19.x, r15.w, l(0.000000)
        max r15.w, r4.w, |r15.w|
        movc r15.w, r19.x, r15.w, -r15.w
        max r14.w, -r14.w, l(0.00000010)
        div r14.w, r15.w, r14.w
        min r14.w, |r14.w|, l(131072.000000)
        mov r28.x, cb10[r13.w + 8].w
        mov r28.yz, cb10[r13.w + 9].xxyx
        dp3 r15.w, r18.xyzx, r28.xyzx
        dp3 r19.x, r17.yzwy, r28.xyzx
        add r19.x, r19.x, -cb10[r13.w + 9].z
        ...
        dp3 r15.w, r18.xyzx, r28.xyzx
        dp3 r19.x, r17.yzwy, r28.xyzx
        add r19.x, r19.x, -cb10[r13.w + 10].z
        ge r19.w, r19.x, l(0.000000)
        max r19.x, r4.w, |r19.x|
        movc r19.x, r19.w, r19.x, -r19.x
        max r15.w, -r15.w, l(0.00000010)
        ...
        dp3 r15.w, r18.xyzx, r28.xyzx
        dp3 r19.x, r17.yzwy, r28.xyzx
        add r19.x, r19.x, -cb10[r13.w + 11].z
        ge r19.w, r19.x, l(0.000000)
        max r19.x, r4.w, |r19.x|
        movc r19.x, r19.w, r19.x, -r19.x
        max r15.w, -r15.w, l(0.00000010)
        ...
        dp3 r15.w, r18.xyzx, r28.xyzx
        dp3 r19.x, r17.yzwy, r28.xyzx
        add r19.x, r19.x, -cb10[r13.w + 12].z
        ge r19.w, r19.x, l(0.000000)
        max r19.x, r4.w, |r19.x|
        movc r19.x, r19.w, r19.x, -r19.x
        max r15.w, -r15.w, l(0.00000010)
        ...
        dp3 r15.w, r18.xyzx, r28.xyzx
        dp3 r19.x, r17.yzwy, r28.xyzx
        add r19.x, r19.x, -cb10[r13.w + 13].z
        ge r19.w, r19.x, l(0.000000)
        max r19.x, r4.w, |r19.x|
        movc r19.x, r19.w, r19.x, -r19.x
        max r15.w, -r15.w, l(0.00000010)
        div r15.w, r19.x, r15.w
        min r14.w, r14.w, |r15.w|
        add r28.x, r17.y, cb10[r13.w + 3].w
        add r28.yz, r17.zzwz, cb10[r13.w + 4].xxyx
        mad r21.yzw, r18.xxyz, r14.wwww, r28.xxyz
        ...
        dp3 r29.x, r21.yzwy, r28.xyzx
        mov r30.xy, cb10[r13.w + 1].xwxx
        mov r30.z, cb10[r13.w + 2].z
        dp3 r29.y, r21.yzwy, r30.xyzx
        mov r31.x, cb10[r13.w + 1].y
        mov r31.yz, cb10[r13.w + 2].xxwx
        dp3 r29.z, r21.yzwy, r31.xyzx
        ubfe r15.w, l(9), l(16), cb10[r13.w + 7].z
        utof r29.w, r15.w
        sample_l_indexable(texturecubearray)(float,float,float,float) r21.yzw, r29.xyzw, t8.wxyz, s2, r14.w
        dp3 r32.x, r17.yzwy, r28.xyzx
        dp3 r32.y, r17.yzwy, r30.xyzx
        dp3 r32.z, r17.yzwy, r31.xyzx
        mad_sat r17.yzw, r32.xxyz, cb10[r13.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
        mul r32.xy, r17.yzyy, cb10[r13.w + 4].zwzz
        mul r32.z, r17.w, cb10[r13.w + 5].x
        add r17.yzw, r32.xxyz, cb10[r13.w + 5].yyzw
        ...
        mad r16.yzw, r17.yyzw, r27.xxzw, r16.yyzw
        mul r14.w, r6.w, r13.w
        mul r17.yzw, r14.zzzz, r21.yyzw
        dp3 r14.z, r17.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
        mad r13.w, r6.w, r13.w, r14.z
        div r13.w, r14.w, r13.w
        mad r26.xyz, r17.yzwy, r13.wwww, r26.xyzx
      endif 
    endif 
    iadd r9.w, r9.w, l(1)
  endloop 
...
lt r3.y, r25.w, l(0.990000)
if_nz r3.y
  add r3.y, -r25.w, l(1.000000)
  mul r4.w, r3.y, cb2[19].x
  ...
  dp3 r4.w, r19.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
...
ret 
// Approximately 1880 instruction slots used
