...
frc r0.z, r0.z
mad r0.z, r0.z, l(6.28318548), cb1[70].w
sincos r15.x, r16.x, r0.z
dp3_sat r2.x, r11.xyzx, r12.xyzx
dp3 r0.z, -r12.xyzx, r11.xyzx
add r0.z, r0.z, r0.z
mad r17.xyz, r11.xyzx, -r0.zzzz, -r12.xyzx
...
if_nz r2.w
  ...
  if_nz r2.w
    ...
    mad r9.xyw, r2.wwww, r9.xyxw, r19.xyxz
    ...
    sample_l_indexable(texture2d)(float,float,float,float) r3.w, r18.xyxx, t28.yzwx, s1, r2.w
    mad r21.xyz, r19.xywx, l(0.031250, 0.031250, 0.031250, 0.000000), r18.xyzx
    sample_l_indexable(texture2d)(float,float,float,float) r5.w, r21.xyxx, t28.yzwx, s1, r2.w
    min r3.w, |r3.w|, |r5.w|
    mul r3.w, r21.z, r3.w
    ...
    movc r3.w, r6.w, r7.w, r3.w
    sample_l_indexable(texture2d)(float,float,float,float) r2.w, r16.yzyy, t28.yzwx, s1, r2.w
    min r2.w, |r5.w|, |r2.w|
    mul r2.w, r9.w, r2.w
    ...
    loop 
      ...
      mad r16.yzw, r19.xxyw, r9.wwww, r18.xxyz
      sample_l_indexable(texture2d)(float,float,float,float) r9.w, r16.yzyy, t28.yzwx, s1, l(0.000000)
      ...
      if_nz r12.w
        if_nz r21.z
          ...
          movc r13.zw, r12.wwww, r16.yyyz, r9.xxxy
          mov r21.z, r16.w
          mov r23.x, r6.w
      ...
      loop 
        ...
        mad r24.xyz, r20.xyzx, r23.wwww, r16.yzwy
...
dp3 r5.w, r15.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
mov r17.w, l(0)
sample_l_indexable(texturecubearray)(float,float,float,float) r16.yzw, r17.xyzw, t8.wxyz, s2, r3.w
add r3.w, -r5.w, cb2[19].x
mad r3.w, r2.y, r3.w, r5.w
mul r16.yzw, r3.wwww, r16.yyzw
add r0.w, -r0.w, l(1.000000)
mad r9.xyz, r16.yzwy, r0.wwww, r9.xyzx
mad r0.w, r4.z, r1.w, r2.x
log r0.w, |r0.w|
mul r0.w, r0.w, r1.z
exp r0.w, r0.w
...
loop 
  ieq r6.w, r5.w, l(2)
  breakc_nz r6.w
  movc r6.w, r5.w, r0.x, r3.w
  imul null, r6.w, r6.w, l(15)
  ubfe r7.w, l(3), l(24), cb9[r6.w + 1].w
  switch r7.w
    case l(4)
    lt r7.w, l(0.000000), cb9[r6.w + 6].y
    mov r30.xy, cb9[r6.w + 5].zwzz
    mov r30.z, cb9[r6.w + 6].x
    mad r31.xyz, -r30.xyzx, l(0.500000, 0.500000, 0.500000, 0.000000), cb9[r6.w + 0].xyzx
    add r32.xyz, -r10.xyzx, r31.xyzx
    dp3 r8.w, r30.xyzx, r32.xyzx
    div_sat r11.w, -r8.w, cb9[r6.w + 6].y
    mad r33.xyz, r11.wwww, r30.xyzx, r31.xyzx
      ...
      if_nz r14.w
        ...
        if_nz r14.w
          ...
          loop 
            ige r25.w, r24.w, l(8)
            breakc_nz r25.w
            dp2 r35.y, icb[r24.w + 0].yxyy, r9.xyxx
            dp2 r35.z, icb[r24.w + 0].yxyy, r9.yzyy
        ...
        if_nz r14.w
          ...
          dp3 r17.w, r30.xyzx, r17.xyzx
          dp3 r24.w, r17.xyzx, r32.xyzx
          mad r25.w, -r17.w, r17.w, cb9[r6.w + 6].y
          mad r8.w, r17.w, r24.w, -r8.w
          div_sat r8.w, r8.w, r25.w
          div r17.w, r25.w, cb9[r6.w + 6].y
          mul r17.w, r17.w, l(10.000000)
          min r17.w, r17.w, l(1.000000)
          add r8.w, -r11.w, r8.w
          mad r8.w, r17.w, r8.w, r11.w
          mad r30.xyz, r8.wwww, r30.xyzx, r31.xyzx
          movc r30.xyz, r7.wwww, r30.xyzx, cb9[r6.w + 0].xyzx
          add r30.xyz, -r10.xyzx, r30.xyzx
          dp3 r7.w, r30.xyzx, r30.xyzx
          rsq r7.w, r7.w
          mul r31.xyz, r7.wwww, r30.xyzx
          ...
          if_nz r11.w
            ...
            if_z r24.w
              ...
              div r18.xy, r32.xyxx, r17.wwww
              mad r18.xy, r18.xyxx, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
              add r32.x, r18.x, cb9[r8.w + 9].w
              add r32.y, r18.y, cb9[r8.w + 10].x
              mul r18.xy, r32.xyxx, cb9[r8.w + 9].yzyy
              ...
              if_z r18.z
                ...
                mad r32.x, r18.x, cb9[r8.w + 8].y, cb9[r8.w + 8].z
                mad r32.y, r18.y, cb9[r8.w + 8].w, cb9[r8.w + 9].x
                mul r18.x, r17.w, cb9[r8.w + 10].z
                mad r11.w, cb9[r8.w + 10].y, r17.w, r11.w
                div r11.w, r11.w, r18.x
              endif 
            else 
              mov r18.z, l(-1)
            endif 
            or r17.w, r24.w, r18.z
            if_z r17.w
              ...
              if_nz cb2[58].y
                ...
                loop 
                  ige r26.w, r25.w, l(8)
                  breakc_nz r26.w
                  dp2 r33.x, icb[r25.w + 0].yxyy, r9.xwxx
                  dp2 r33.y, icb[r25.w + 0].xyxx, r13.xyxx
                  mad r18.xy, r33.xyxx, cb9[r8.w + 3].yyyy, r32.xyxx
                  sample_c_lz_indexable(texture2darray)(float,float,float,float) r18.x, r18.xyzx, t9.xxxx, s13, r11.w
                  mad r24.w, r18.x, l(0.125000), r24.w
                  iadd r25.w, r25.w, l(1)
                endloop 
              else 
                utof r32.z, r17.w
                sample_c_lz_indexable(texture2darray)(float,float,float,float) r24.w, r32.xyzx, t9.xxxx, s13, r11.w
              endif 
            ...
            if_nz r11.w
              ...
              if_z r18.x
                ...
                div r18.yz, r32.xxyx, r17.wwww
                mad r18.yz, r18.yyzy, l(0.000000, 0.500000, -0.500000, 0.000000), l(0.000000, 0.500000, 0.500000, 0.000000)
                add r20.x, r18.y, cb9[r8.w + 9].w
                add r20.y, r18.z, cb9[r8.w + 10].x
                mul r18.yz, r20.xxyx, cb9[r8.w + 9].yyzy
                div r20.xy, cb9[r8.w + 3].yyyy, cb9[r8.w + 8].ywyy
                ...
                if_z r20.x
                  ...
                  mad r32.x, r18.y, cb9[r8.w + 8].y, cb9[r8.w + 8].z
                  mad r32.y, r18.z, cb9[r8.w + 8].w, cb9[r8.w + 9].x
                  mul r18.y, r17.w, cb9[r8.w + 10].z
                  mad r11.w, cb9[r8.w + 10].y, r17.w, r11.w
                  div r11.w, r11.w, r18.y
                endif 
              else 
                mov r20.x, l(-1)
              endif 
              or r17.w, r18.x, r20.x
              if_z r17.w
                max r11.w, r11.w, l(0.00006104)
                and r17.w, l(0x0000ffff), cb9[r8.w + 1].w
                if_nz cb2[58].y
                  ...
                  utof r32.z, r17.w
                  sample_c_lz_indexable(texture2darray)(float,float,float,float) r20.x, r32.xyzx, t9.xxxx, s13, r11.w
                endif 
          ...
          mul r8.w, r12.w, r8.w
          mov r18.x, cb9[r6.w + 0].w
          mov r18.yz, cb9[r6.w + 1].xxyx
          lt r11.w, l(0.000000), r13.z
          mad r32.xyz, r8.wwww, r18.xyzx, r27.xyzx
          dp3_sat r8.w, r11.xyzx, r31.xyzx
          mad r30.xyz, r30.xyzx, r7.wwww, r12.xyzx
          dp3 r7.w, r30.xyzx, r30.xyzx
          rsq r7.w, r7.w
          mul r30.xyz, r7.wwww, r30.xyzx
          dp3 r7.w, r30.xyzx, r12.xyzx
          dp3 r13.z, r11.xyzx, r30.xyzx
          mad r13.w, |r13.z|, r0.z, -|r13.z|
          ...
          mul r8.w, r8.w, r13.z
          mul r8.w, r12.w, r8.w
          mad r30.xyz, r8.wwww, r18.xyzx, r29.xyzx
          add_sat r7.w, -r7.w, l(1.000000)
          mul r12.w, r7.w, r7.w
          mul r12.w, r12.w, r12.w
          mul r7.w, r7.w, r12.w
          mul r7.w, r7.w, r8.w
          mad r18.xyz, r7.wwww, r18.xyzx, r28.xyzx
          movc r27.xyz, r11.wwww, r32.xyzx, r27.xyzx
          movc r28.xyz, r11.wwww, r18.xyzx, r28.xyzx
          movc r29.xyz, r11.wwww, r30.xyzx, r29.xyzx
        endif 
      endif 
    endif 
    break 
    case l(2)
    add r18.xy, -r10.xyxx, cb9[r6.w + 3].zwzz
    add r18.z, -r10.z, cb9[r6.w + 4].x
    dp3 r7.w, r18.xyzx, r18.xyzx
    rsq r7.w, r7.w
    mul r30.xyz, r7.wwww, r18.xyzx
    dp3 r8.w, r11.xyzx, r30.xyzx
    mov_sat r11.w, r8.w
    lt r12.w, l(0.000000), r11.w
    if_nz r12.w
      mov r30.xyz, cb9[r6.w + 7].yzwy
      mov r30.w, cb9[r6.w + 8].x
      dp4 r12.w, r30.xyzw, r10.xyzw
      lt r13.z, r12.w, l(1.000000)
      if_nz r13.z
        mov r31.xyz, l(1.000000,1.000000,1.000000,0)
        mov r13.z, l(0)
      else 
        add r32.xyz, -r10.xyzx, cb9[r6.w + 0].xyzx
        ...
        div r19.xy, r32.xyxx, r12.wwww
        lt r12.w, cb9[r6.w + 10].w, l(0.00048828)
        if_nz r12.w
          mad_sat r20.yz, |r19.xxyx|, cb9[r6.w + 12].xxyx, cb9[r6.w + 12].zzwz
          mul r32.xy, r20.yzyy, r20.yzyy
          mad r20.yz, r20.yyzy, l(0.000000, -2.000000, -2.000000, 0.000000), l(0.000000, 3.000000, 3.000000, 0.000000)
          mul r20.yz, r20.yyzy, r32.xxyx
          mul r12.w, r20.z, r20.y
        else 
          mul_sat r32.xyzw, |r19.yyxx|, cb9[r6.w + 11].xyzw
          ...
          exp r20.yz, r20.yyzy
          mul r14.w, r20.y, cb9[r6.w + 12].x
          mad r17.w, cb9[r6.w + 12].y, r20.z, l(-1.000000)
          mad r14.w, cb9[r6.w + 12].y, r20.z, -r14.w
        ...
        if_nz r12.w
          dp3 r13.w, cb9[r6.w + 13].xyzx, r19.xyzx
          mov r32.x, cb9[r6.w + 13].w
          mov r32.yz, cb9[r6.w + 14].xxyx
      ...
      mov r32.x, cb9[r6.w + 0].w
      mov r32.yz, cb9[r6.w + 1].xxyx
      ...
      if_nz r12.w
        ...
        if_nz r12.w
          ...
          dp4 r12.w, r32.xyzw, r21.xyzw
          dp4 r13.w, r30.xyzw, r21.xyzw
          ge r14.w, r13.w, r12.w
          if_nz r14.w
            mov r30.xyz, cb9[r6.w + 4].yzwy
            mov r30.w, cb9[r6.w + 5].x
            dp4 r19.x, r30.xyzw, r21.xyzw
            mov r30.xyz, cb9[r6.w + 5].yzwy
            mov r30.w, cb9[r6.w + 6].x
            dp4 r19.y, r30.xyzw, r21.xyzw
            div r19.xy, r19.xyxx, r13.wwww
            mad_sat r19.xy, r19.xyxx, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
            mad r21.x, r19.x, cb9[r6.w + 8].y, cb9[r6.w + 8].z
            mad r21.y, r19.y, cb9[r6.w + 8].w, cb9[r6.w + 9].x
            ...
            if_nz cb2[58].y
              ...
              loop 
                ige r19.x, r17.w, l(8)
                breakc_nz r19.x
                dp2 r19.x, icb[r17.w + 0].xyxx, r24.xyxx
                dp2 r19.y, icb[r17.w + 0].yxyy, r24.xzxx
                mad r30.xy, r19.xyxx, cb9[r6.w + 3].yyyy, r21.xyxx
                sample_c_lz_indexable(texture2darray)(float,float,float,float) r19.x, r30.xyzx, t9.xxxx, s13, r12.w
                mad r14.w, r19.x, l(0.125000), r14.w
                iadd r17.w, r17.w, l(1)
              endloop 
            else 
              utof r21.z, r13.w
              sample_c_lz_indexable(texture2darray)(float,float,float,float) r14.w, r21.xyzx, t9.xxxx, s13, r12.w
            endif 
        ...
        if_nz r13.z
          ...
          if_nz r17.w
            ...
            mov r30.xyz, cb9[r13.w + 6].yzwy
            mov r30.w, cb9[r13.w + 7].x
            dp4 r17.w, r30.xyzw, r22.xyzw
            mov r30.xyz, cb9[r13.w + 7].yzwy
            mov r30.w, cb9[r13.w + 8].x
            dp4 r19.x, r30.xyzw, r22.xyzw
            lt r19.y, r19.x, r17.w
            if_z r19.y
              mov r30.xyz, cb9[r13.w + 4].yzwy
              mov r30.w, cb9[r13.w + 5].x
              dp4 r21.x, r30.xyzw, r22.xyzw
              mov r30.xyz, cb9[r13.w + 5].yzwy
              mov r30.w, cb9[r13.w + 6].x
              ...
              add r21.x, r20.y, cb9[r13.w + 9].w
              add r21.y, r20.z, cb9[r13.w + 10].x
              mul r20.yz, r21.xxyx, cb9[r13.w + 9].yyzy
              div r21.xy, cb9[r13.w + 3].yyyy, cb9[r13.w + 8].ywyy
              ...
              if_z r21.x
                ...
                mad r22.x, r20.y, cb9[r13.w + 8].y, cb9[r13.w + 8].z
                mad r22.y, r20.z, cb9[r13.w + 8].w, cb9[r13.w + 9].x
                mul r20.y, r19.x, cb9[r13.w + 10].z
                mad r17.w, cb9[r13.w + 10].y, r19.x, r17.w
            ...
            if_z r19.x
              ...
              and r19.x, l(0x0000ffff), cb9[r13.w + 1].w
              if_nz cb2[58].y
                utof r21.z, r19.x
                mov r19.y, l(0)
                mov r20.y, l(0)
                loop 
                  ...
                  mad r21.xy, r30.xyxx, cb9[r13.w + 3].yyyy, r22.xyxx
                  sample_c_lz_indexable(texture2darray)(float,float,float,float) r20.z, r21.xyzx, t9.xxxx, s13, r17.w
                  mad r19.y, r20.z, l(0.125000), r19.y
                  iadd r20.y, r20.y, l(1)
                endloop 
              else 
                utof r22.z, r19.x
                sample_c_lz_indexable(texture2darray)(float,float,float,float) r19.y, r22.xyzx, t9.xxxx, s13, r17.w
              endif 
            ...
            if_nz r13.w
              ...
              mad r23.xyz, r11.xyzx, r13.wwww, r10.xyzx
              mov r30.xyz, cb9[r6.w + 6].yzwy
              mov r30.w, cb9[r6.w + 7].x
              dp4 r13.w, r30.xyzw, r23.xyzw
              mov r30.xyz, cb9[r6.w + 7].yzwy
              mov r30.w, cb9[r6.w + 8].x
              dp4 r17.w, r30.xyzw, r23.xyzw
              lt r19.x, r17.w, r13.w
              if_z r19.x
                mov r30.xyz, cb9[r6.w + 4].yzwy
                mov r30.w, cb9[r6.w + 5].x
                ...
                div r20.yz, r21.xxyx, r17.wwww
                mad r20.yz, r20.yyzy, l(0.000000, 0.500000, -0.500000, 0.000000), l(0.000000, 0.500000, 0.500000, 0.000000)
                add r21.x, r20.y, cb9[r6.w + 9].w
                add r21.y, r20.z, cb9[r6.w + 10].x
                mul r20.yz, r21.xxyx, cb9[r6.w + 9].yyzy
                ...
                if_z r21.x
                  mov_sat r20.yz, r20.yyzy
                  mad r22.x, r20.y, cb9[r6.w + 8].y, cb9[r6.w + 8].z
                  mad r22.y, r20.z, cb9[r6.w + 8].w, cb9[r6.w + 9].x
                  mul r20.y, r17.w, cb9[r6.w + 10].z
              ...
              if_z r17.w
                ...
                if_nz cb2[58].y
                  ...
                  loop 
                    ...
                    mad r21.xy, r23.xyxx, cb9[r6.w + 3].yyyy, r22.xyxx
                    sample_c_lz_indexable(texture2darray)(float,float,float,float) r20.z, r21.xyzx, t9.xxxx, s13, r13.w
          ...
          add r6.w, -r11.w, r6.w
          mad r6.w, r1.z, r6.w, r11.w
          mul r6.w, r12.w, r6.w
          lt r8.w, l(0.000000), r8.w
          mad r21.xyz, r6.wwww, r31.xyzx, r27.xyzx
          mad r18.xyz, r18.xyzx, r7.wwww, r12.xyzx
          dp3 r6.w, r18.xyzx, r18.xyzx
          rsq r6.w, r6.w
          mul r18.xyz, r6.wwww, r18.xyzx
          dp3 r6.w, r18.xyzx, r12.xyzx
          dp3 r7.w, r11.xyzx, r18.xyzx
          mad r13.w, |r7.w|, r0.z, -|r7.w|
          ...
          mad r18.xyz, r7.wwww, r31.xyzx, r29.xyzx
          add_sat r6.w, -r6.w, l(1.000000)
          mul r11.w, r6.w, r6.w
          mul r11.w, r11.w, r11.w
          mul r6.w, r6.w, r11.w
          mul r6.w, r6.w, r7.w
          mad r22.xyz, r6.wwww, r31.xyzx, r28.xyzx
          movc r27.xyz, r8.wwww, r21.xyzx, r27.xyzx
          movc r28.xyz, r8.wwww, r22.xyzx, r28.xyzx
          movc r29.xyz, r8.wwww, r18.xyzx, r29.xyzx
        endif 
      endif 
    endif 
    break 
...
ret 
// Approximately 1362 instruction slots used
