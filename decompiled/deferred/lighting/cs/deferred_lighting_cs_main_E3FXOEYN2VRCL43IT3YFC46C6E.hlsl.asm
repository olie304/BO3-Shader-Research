...
loop 
  ieq r14.w, r13.w, l(2)
  breakc_nz r14.w
  movc r14.w, r13.w, r0.y, r9.w
  uge r15.y, r14.w, r8.w
  ...
  if_nz r15.y
    ...
    loop 
      ...
      mul r25.x, r20.z, r20.w
      ushr r21.w, r16.w, l(2)
      ubfe r22.w, l(1), l(2), r16.w
      and r25.z, r21.w, l(2)
      max r25.w, r25.x, r25.y
      mad r20.z, -r20.w, r20.z, l(1.000000)
      mul r20.z, r20.z, r25.y
      movc r20.y, r25.z, r20.z, r25.w
      movc r25.xy, r22.wwww, r25.xyxx, r20.xyxx
      iadd r19.w, r19.w, l(1)
      mov r16.w, r21.w
    endloop 
    mov_sat r25.y, r25.y
    mul r16.y, r25.y, cb10[r14.w + 6].y
    lt r16.z, l(0.000000), r16.y
    if_nz r16.z
      mad r24.w, r25.y, cb10[r14.w + 6].y, r24.w
      ...
      dp3 r16.w, r17.xyzx, r26.xyzx
      dp3 r18.x, r15.yzwy, r26.xyzx
      ...
      div r16.w, r18.x, r16.w
      min r16.z, |r16.w|, r16.z
      add r26.x, r15.y, cb10[r14.w + 3].w
      add r26.yz, r15.zzwz, cb10[r14.w + 4].xxyx
      mad r20.yzw, r17.xxyz, r16.zzzz, r26.xxyz
      dp3 r16.w, r20.yzwy, r20.yzwy
      sqrt r16.w, r16.w
      div r16.z, r16.z, r16.w
      add r16.z, r16.z, r16.z
      sqrt r16.z, r16.z
      mad r16.z, r3.z, l(5.000000), r16.z
      ...
      utof r27.w, r16.w
      sample_l_indexable(texturecubearray)(float,float,float,float) r20.yzw, r27.xyzw, t8.wxyz, s2, r16.z
      dp3 r30.x, r15.yzwy, r26.xyzx
      dp3 r30.y, r15.yzwy, r28.xyzx
      dp3 r30.z, r15.yzwy, r29.xyzx
      mad_sat r15.yzw, r30.xxyz, cb10[r14.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
      mul r30.xy, r15.yzyy, cb10[r14.w + 4].zwzz
      mul r30.z, r15.w, cb10[r14.w + 5].x
      add r15.yzw, r30.xxyz, cb10[r14.w + 5].yyzw
      ...
      mul r28.xyz, r16.yyyy, r28.xyzx
      movc r21.z, r25.z, l(0), l(0.500000)
      add r29.xyz, r15.yzwy, r21.xyzx
      ...
      mad r23.xyz, r15.yzwy, r25.xzwx, r23.xyzx
      mul r15.y, r7.w, r14.w
      mul r16.yzw, r16.yyyy, r20.yyzw
      dp3 r15.z, r16.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r14.w, r7.w, r14.w, r15.z
      div r14.w, r15.y, r14.w
      mov r26.x, r23.w
      mov r26.yz, r24.yyzy
      mad r24.xyz, r16.yzwy, r14.wwww, r26.xyzx
      mov r23.w, r24.x
    endif 
  endif 
...
if_nz r13.w
  ...
  loop 
    ...
    breakc_nz r14.w
    movc r14.w, r13.w, r0.y, r9.w
    ult r16.y, r14.w, r8.w
    if_nz r16.y
      imul null, r14.w, r14.w, l(14)
      add r16.yzw, r11.xxyz, -cb10[r14.w + 0].xxyz
      ...
      loop 
        ...
        dp3 r26.z, cb11[r22.w + 0].xyzx, r16.yzwy
        ...
        mov r18.x, r26.w
      endloop 
      add_sat r18.x, -r24.w, r26.y
      mul r18.w, r18.x, cb10[r14.w + 6].y
      lt r19.w, l(0.000000), r18.w
      if_nz r19.w
        mad r25.w, r18.x, cb10[r14.w + 6].y, r25.w
        ...
        div r19.w, r20.y, r19.w
        min r18.w, r18.w, |r19.w|
        add r27.x, r16.y, cb10[r14.w + 3].w
        add r27.yz, r16.zzwz, cb10[r14.w + 4].xxyx
        mad r20.yzw, r17.xxyz, r18.wwww, r27.xxyz
        dp3 r19.w, r20.yzwy, r20.yzwy
        sqrt r19.w, r19.w
        div r18.w, r18.w, r19.w
        add r18.w, r18.w, r18.w
        sqrt r18.w, r18.w
        mad r18.w, r3.z, l(5.000000), r18.w
        ...
        mad_sat r16.yzw, r31.xxyz, cb10[r14.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
        mul r31.xy, r16.yzyy, cb10[r14.w + 4].zwzz
        mul r31.z, r16.w, cb10[r14.w + 5].x
        add r16.yzw, r31.xxyz, cb10[r14.w + 5].yyzw
  ...
  loop 
    ...
    if_nz r9.w
        ...
        if_nz r26.w
          ...
          if_nz r20.x
            ...
            if_nz r20.z
              ...
              mad r20.z, |r14.w|, l(-0.200000), l(0.400000)
            ...
            mad r33.xyz, r33.xyzx, r12.wwww, r13.xyzx
            dp3 r12.w, r33.xyzx, r33.xyzx
            rsq r12.w, r12.w
            mul r33.xyz, r12.wwww, r33.xyzx
            dp3 r12.w, r33.xyzx, r13.xyzx
            ...
            movc r31.xyz, r14.wwww, r19.xywx, r31.xyzx
            movc r32.xyz, r14.wwww, r33.xyzx, r32.xyzx
          endif 
        endif 
      endif 
    else 
      ...
      if_nz r8.w
        ...
        dp3 r13.w, r22.xyzx, r17.xyzx
        dp3 r14.w, r22.xyzx, r33.xyzx
        dp3 r17.w, r17.xyzx, r33.xyzx
        ...
        mad r19.xyw, r14.wwww, r22.xyxz, r19.xyxw
        ...
        rsq r14.w, r13.w
        mul r19.xyw, r14.wwww, r19.xyxw
        dp3 r14.w, r12.xyzx, r19.xywx
        mov_sat r17.w, r14.w
        ...
        if_nz r19.x
          ...
          if_nz r19.x
            ...
            if_nz r13.w
              ...
              mad r22.xyz, r22.xyzx, r12.wwww, r13.xyzx
              dp3 r12.w, r22.xyzx, r22.xyzx
              rsq r12.w, r12.w
              mul r22.xyz, r12.wwww, r22.xyzx
              dp3 r12.w, r22.xyzx, r13.xyzx
              dp3 r14.w, r12.xyzx, r22.xyzx
...
ret 
// Approximately 1844 instruction slots used
