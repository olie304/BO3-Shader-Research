...
mul r14.w, r1.w, r1.z
dp4 r0.w, r12.xyzw, r14.xyzw
add r13.xyzw, -r0.xxxx, r13.xyzw
min r1.z, |r13.w|, |r13.z|
min r1.z, r1.z, |r13.y|
min r1.z, r1.z, |r13.x|
max r1.w, |r13.w|, |r13.z|
max r1.w, r1.w, |r13.y|
max r1.w, r1.w, |r13.x|
eq r13.xyz, r1.zzzz, |r13.yzwy|
movc r1.z, r13.x, r12.y, r12.x
movc r1.z, r13.y, r12.z, r1.z
movc r1.z, r13.z, r12.w, r1.z
