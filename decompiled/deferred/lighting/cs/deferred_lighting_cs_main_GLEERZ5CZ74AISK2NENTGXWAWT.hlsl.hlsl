...
r0.y = samplerLinear[]..swiz;
  ...
  if (probeDebug != 0) {
    ...
    r10.w = samplerLinear[]..swiz;
      ...
      while (true) {
        ...
        r40.w = (int)r9.w + (int)r40.w;
        r40.w = (int)r40.w * 14;
        r43.xyz = -refProbeConstantsCB[r40.w].data[0].xyz + r5.xyz;
        r43.x = dot(r43.xyz, r43.xyz);
        r43.x = sqrt(r43.x);
        r43.x = cmp(probeDebugRadius >= r43.x);
        if (r43.x != 0) {
          r31.yzw = refProbeConstantsCB[r40.w].data[1].xyz;
          r31.x = refProbeConstantsCB[r40.w].data[0].w;
          r32.yzw = refProbeConstantsCB[r40.w].data[2].xyz;
          r32.x = refProbeConstantsCB[r40.w].data[1].w;
          r33.xyz = refProbeConstantsCB[r40.w].data[3].xyz;
          r33.w = refProbeConstantsCB[r40.w].data[4].z;
          r34.yz = refProbeConstantsCB[r40.w].data[4].xy;
          r34.x = refProbeConstantsCB[r40.w].data[3].w;
          r34.w = refProbeConstantsCB[r40.w].data[6].x;
          r35.yzw = refProbeConstantsCB[r40.w].data[5].xyz;
          r35.x = refProbeConstantsCB[r40.w].data[4].w;
          r36.yz = refProbeConstantsCB[r40.w].data[7].yw;
          r36.x = refProbeConstantsCB[r40.w].data[6].y;
          r36.w = refProbeConstantsCB[r40.w].data[8].x;
          r37.xyz = refProbeConstantsCB[r40.w].data[8].yzw;
          r37.w = refProbeConstantsCB[r40.w].data[9].x;
          r38.xyz = refProbeConstantsCB[r40.w].data[10].yzw;
          r38.w = refProbeConstantsCB[r40.w].data[11].x;
          r39.xyz = refProbeConstantsCB[r40.w].data[11].yzw;
          r39.w = refProbeConstantsCB[r40.w].data[12].x;
          r16.yzw = refProbeConstantsCB[r40.w].data[0].xyz;
          r43.xy = refProbeConstantsCB[r40.w].data[13].yz;
          r12.w = -1;
          r14.w = refProbeConstantsCB[r40.w].data[2].w;
          r29.w = refProbeConstantsCB[r40.w].data[5].w;
          r30.w = refProbeConstantsCB[r40.w].data[7].z;
  ...
  if (r7.w != 0) {
    ...
    r13.w = dot(refProbeAttenuationConstantsCB[r10.w].data[1].xyz, r15.yzw);
    r13.w = saturate(refProbeAttenuationConstantsCB[r10.w].data[1].w + r13.w);
    r12.w = r13.w * r12.w;
    r13.w = dot(refProbeAttenuationConstantsCB[r10.w].data[2].xyz, r15.yzw);
    r13.w = saturate(refProbeAttenuationConstantsCB[r10.w].data[2].w + r13.w);
    r12.w = r13.w * r12.w;
    r13.w = dot(refProbeAttenuationConstantsCB[r10.w].data[3].xyz, r15.yzw);
    r13.w = saturate(refProbeAttenuationConstantsCB[r10.w].data[3].w + r13.w);
    r12.w = r13.w * r12.w;
    r13.w = dot(refProbeAttenuationConstantsCB[r10.w].data[4].xyz, r15.yzw);
    r13.w = saturate(refProbeAttenuationConstantsCB[r10.w].data[4].w + r13.w);
    r12.w = r13.w * r12.w;
    r13.w = dot(refProbeAttenuationConstantsCB[r10.w].data[5].xyz, r15.yzw);
    r10.w = saturate(refProbeAttenuationConstantsCB[r10.w].data[5].w + r13.w);
    r22.x = r12.w * r10.w;
    r10.w = (int)r21.w & 1;
    r22.yz = float2(0,1);
    r19.zw = r10.ww ? r22.xy : r22.zx;
    r22.x = 1;
    r10.w = r21.w;
    r32.xy = r19.zw;
    r12.w = 1;
    while (true) {
      r13.w = cmp((int)r12.w >= (int)r9.w);
      if (r13.w != 0) break;
      r13.w = (int)r6.w + (int)r12.w;
      r13.w = (int)r13.w * 6;
      ...
      r14.w = r32.x * r14.w;
      r18.w = dot(refProbeAttenuationConstantsCB[r13.w].data[1].xyz, r15.yzw);
      r18.w = saturate(refProbeAttenuationConstantsCB[r13.w].data[1].w + r18.w);
      r14.w = r18.w * r14.w;
      r18.w = dot(refProbeAttenuationConstantsCB[r13.w].data[2].xyz, r15.yzw);
      r18.w = saturate(refProbeAttenuationConstantsCB[r13.w].data[2].w + r18.w);
      r14.w = r18.w * r14.w;
      r18.w = dot(refProbeAttenuationConstantsCB[r13.w].data[3].xyz, r15.yzw);
      r18.w = saturate(refProbeAttenuationConstantsCB[r13.w].data[3].w + r18.w);
      r14.w = r18.w * r14.w;
      r18.w = dot(refProbeAttenuationConstantsCB[r13.w].data[4].xyz, r15.yzw);
      r18.w = saturate(refProbeAttenuationConstantsCB[r13.w].data[4].w + r18.w);
      r14.w = r18.w * r14.w;
      r18.w = dot(refProbeAttenuationConstantsCB[r13.w].data[5].xyz, r15.yzw);
      r13.w = saturate(refProbeAttenuationConstantsCB[r13.w].data[5].w + r18.w);
      r32.x = r14.w * r13.w;
      r18.w = (uint)r10.w >> 2;
      if (1 == 0) r20.w = 0; else if (1+2 < 32) {       r20.w = (uint)r10.w << (32-(1 + 2)); r20.w = (uint)r20.w >> (32-1);      } else r20.w = (uint)r10.w >> 2;
      r22.z = (int)r18.w & 2;
      r22.w = max(r32.y, r32.x);
      r13.w = -r14.w * r13.w + 1;
      r13.w = r32.y * r13.w;
      r22.y = r22.z ? r13.w : r22.w;
      r32.xy = r20.ww ? r32.xy : r22.xy;
      r12.w = (int)r12.w + 1;
      r10.w = r18.w;
    }
    ...
    if (r6.w != 0) {
      ...
      r6.w = r22.w * r19.y;
      r9.w = dot(r17.xyz, r23.xyz);
      r10.w = dot(r15.yzw, r23.xyz);
      r10.w = r10.w + -r24.w;
      r12.w = cmp(r10.w >= 0);
      ...
      r10.w = dot(r17.xyz, r24.xyz);
      r12.w = dot(r15.yzw, r24.xyz);
      r12.w = r12.w + -r25.w;
      r13.w = cmp(r12.w >= 0);
      ...
      r10.w = r12.w / r10.w;
      r9.w = min(abs(r10.w), r9.w);
      r10.w = dot(r17.xyz, r26.xyz);
      r12.w = dot(r15.yzw, r26.xyz);
      r12.w = r12.w + -r27.w;
      r13.w = cmp(r12.w >= 0);
      r12.w = max(abs(r12.w), r3.z);
      r12.w = r13.w ? r12.w : -r12.w;
      ...
      r19.xyz = r17.xyz * r9.www + r19.xyz;
      ...
      r21.w = (uint)r8.w;
      r19.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r21.xyzw, r9.w).xyz;
      ...
      r8.w = dot(r15.yzw, float3(0.212599993,0.715200007,0.0722000003));
      r9.w = r8.w * r3.w;
      r15.yzw = r19.xyz * r6.www;
      r6.w = dot(r15.yzw, float3(0.212599993,0.715200007,0.0722000003));
      r6.w = r3.w * r8.w + r6.w;
      r6.w = r9.w / r6.w;
      r22.xyz = r15.yzw * r6.www;
      r6.w = 257;
    } else {
      r22.xyzw = float4(0,0,0,0);
      r6.w = 1;
  ...
  if (r7.w == 0) {
    ...
    r14.w = samplerLinear[]..swiz;
      r15.y = cmp((int)r9.w == (int)r13.w);
      bitmask.z = ((~(-1 << r10.w)) << 0) & 0xffffffff;  r15.z = (((uint)0 << 0) & bitmask.z) | ((uint)r14.w & ~bitmask.z);
      r14.w = r15.y ? r15.z : r14.w;
      r15.y = cmp((int)r12.w == (int)r13.w);
      if (r13.z == 0) r15.z = 0; else if (r13.z+0 < 32) {       r15.z = (uint)r14.w << (32-(r13.z + 0)); r15.z = (uint)r15.z >> (32-r13.z);      } else r15.z = (uint)r14.w >> 0;
      r14.w = r15.y ? r15.z : r14.w;
      r27.xyzw = r25.xyzw;
      r28.xyzw = r26.xyzw;
      r15.y = r14.w;
      while (true) {
        ...
        r15.z = (int)r13.w + (int)r15.z;
        r15.z = (int)r15.z * 14;
        r15.w = (int)r28.w & 255;
        r16.y = cmp((uint)r15.w < 32);
        r16.y = r2.z ? r16.y : 0;
        if (r16.y != 0) {
          r15.w = mad((int)r15.w, 20, 880);
          r18.yzw = refProbeConstantsCB[r15.z].data[0].xyz + eyeOffset.xyz;
          GBufferDiffuseColor[viewID].r15.w = u2.xyzw;
        }
        r29.w = (int)r28.w + 1;
        r16.yzw = -refProbeConstantsCB[r15.z].data[0].xyz + r5.xyz;
        r15.w = 0x0000ffff & (int)refProbeConstantsCB[r15.z].data[7].z;
        if (6 == 0) r18.y = 0; else if (6+25 < 32) {         r18.y = (uint)refProbeConstantsCB[r15.z].data[7].z << (32-(6 + 25)); r18.y = (uint)r18.y >> (32-6);        } else r18.y = (uint)refProbeConstantsCB[r15.z].data[7].z >> 25;
        r18.z = (int)r15.w * 6;
        r18.w = dot(refProbeAttenuationConstantsCB[r18.z].data[0].xyz, r16.yzw);
        r18.w = saturate(refProbeAttenuationConstantsCB[r18.z].data[0].w + r18.w);
        r19.w = dot(refProbeAttenuationConstantsCB[r18.z].data[1].xyz, r16.yzw);
        r19.w = saturate(refProbeAttenuationConstantsCB[r18.z].data[1].w + r19.w);
        r18.w = r19.w * r18.w;
        r19.w = dot(refProbeAttenuationConstantsCB[r18.z].data[2].xyz, r16.yzw);
        r19.w = saturate(refProbeAttenuationConstantsCB[r18.z].data[2].w + r19.w);
        r18.w = r19.w * r18.w;
        r19.w = dot(refProbeAttenuationConstantsCB[r18.z].data[3].xyz, r16.yzw);
        r19.w = saturate(refProbeAttenuationConstantsCB[r18.z].data[3].w + r19.w);
        r18.w = r19.w * r18.w;
        r19.w = dot(refProbeAttenuationConstantsCB[r18.z].data[4].xyz, r16.yzw);
        r19.w = saturate(refProbeAttenuationConstantsCB[r18.z].data[4].w + r19.w);
        r18.w = r19.w * r18.w;
        r19.w = dot(refProbeAttenuationConstantsCB[r18.z].data[5].xyz, r16.yzw);
        r18.z = saturate(refProbeAttenuationConstantsCB[r18.z].data[5].w + r19.w);
        r19.x = r18.w * r18.z;
        r18.z = 1 & (int)refProbeConstantsCB[r15.z].data[6].x;
        r18.zw = r18.zz ? r19.xy : r19.zx;
        r19.x = refProbeConstantsCB[r15.z].data[6].x;
        r30.xy = r18.zw;
        r19.w = 1;
        while (true) {
          r20.w = cmp((int)r19.w >= (int)r18.y);
          if (r20.w != 0) break;
          r20.w = (int)r15.w + (int)r19.w;
          r20.w = (int)r20.w * 6;
          r23.w = dot(refProbeAttenuationConstantsCB[r20.w].data[0].xyz, r16.yzw);
          ...
          r30.x = r23.w * r20.w;
          r24.w = (uint)r19.x >> 2;
          if (1 == 0) r30.z = 0; else if (1+2 < 32) {           r30.z = (uint)r19.x << (32-(1 + 2)); r30.z = (uint)r30.z >> (32-1);          } else r30.z = (uint)r19.x >> 2;
          r30.w = (int)r24.w & 2;
          r31.x = max(r30.y, r30.x);
          r20.w = -r23.w * r20.w + 1;
          r20.w = r30.y * r20.w;
          r21.y = r30.w ? r20.w : r31.x;
          r30.xy = r30.zz ? r30.xy : r21.xy;
          r19.w = (int)r19.w + 1;
          r19.x = r24.w;
        }
        r30.y = saturate(r30.y);
        r15.w = refProbeConstantsCB[r15.z].data[6].y * r30.y;
        r18.y = cmp(0 < r15.w);
        if (r18.y != 0) {
          r18.y = (int)r29.w & 255;
          r18.z = (int)r18.y + -1;
          r18.z = cmp((uint)r18.z < 32);
          r18.z = r2.z ? r18.z : 0;
          if (r18.z != 0) {
            r18.yz = mad((int2)r18.yy, int2(20,20), int2(860,876));
          // Known bad code for instruction (needs manual fix):
          ...
          r28.w = (int)r28.w + 257;
          r28.z = r30.y * refProbeConstantsCB[r15.z].data[6].y + r28.z;
          r15.w = refProbeConstantsCB[r15.z].data[7].y * r15.w;
          r31.x = refProbeConstantsCB[r15.z].data[7].w;
          r31.yz = refProbeConstantsCB[r15.z].data[8].xy;
          r18.y = dot(r17.xyz, r31.xyz);
          r18.z = dot(r16.yzw, r31.xyz);
          r18.z = -refProbeConstantsCB[r15.z].data[8].z + r18.z;
          r18.w = cmp(r18.z >= 0);
          r18.z = max(abs(r18.z), r3.z);
          r18.z = r18.w ? r18.z : -r18.z;
          r18.y = max(1.00000001e-07, -r18.y);
          r18.y = r18.z / r18.y;
          r18.y = min(131072, abs(r18.y));
          r31.x = refProbeConstantsCB[r15.z].data[8].w;
          r31.yz = refProbeConstantsCB[r15.z].data[9].xy;
          r18.z = dot(r17.xyz, r31.xyz);
          r18.w = dot(r16.yzw, r31.xyz);
          ...
          r31.x = refProbeConstantsCB[r15.z].data[9].w;
          r31.yz = refProbeConstantsCB[r15.z].data[10].xy;
          r18.z = dot(r17.xyz, r31.xyz);
          r18.w = dot(r16.yzw, r31.xyz);
          ...
          r18.z = r18.w / r18.z;
          r18.y = min(r18.y, abs(r18.z));
          r31.x = refProbeConstantsCB[r15.z].data[10].w;
          r31.yz = refProbeConstantsCB[r15.z].data[11].xy;
          r18.z = dot(r17.xyz, r31.xyz);
          r18.w = dot(r16.yzw, r31.xyz);
          ...
          r18.z = r18.w / r18.z;
          r18.y = min(r18.y, abs(r18.z));
          r31.x = refProbeConstantsCB[r15.z].data[11].w;
          r31.yz = refProbeConstantsCB[r15.z].data[12].xy;
          r18.z = dot(r17.xyz, r31.xyz);
          r18.w = dot(r16.yzw, r31.xyz);
          ...
          r18.z = r18.w / r18.z;
          r18.y = min(r18.y, abs(r18.z));
          r31.x = refProbeConstantsCB[r15.z].data[12].w;
          r31.yz = refProbeConstantsCB[r15.z].data[13].xy;
          r18.z = dot(r17.xyz, r31.xyz);
          r18.w = dot(r16.yzw, r31.xyz);
          ...
          r18.z = r18.w / r18.z;
          r18.y = min(r18.y, abs(r18.z));
          r31.x = refProbeConstantsCB[r15.z].data[3].w + r16.y;
          r31.yz = refProbeConstantsCB[r15.z].data[4].xy + r16.zw;
          r30.xzw = r17.xyz * r18.yyy + r31.xyz;
          r18.z = dot(r30.xzw, r30.xzw);
          r18.z = sqrt(r18.z);
          r18.y = r18.y / r18.z;
          r18.y = r18.y + r18.y;
          r18.y = sqrt(r18.y);
          ...
          r31.x = refProbeConstantsCB[r15.z].data[0].w;
          r31.y = refProbeConstantsCB[r15.z].data[1].z;
          r31.z = refProbeConstantsCB[r15.z].data[2].y;
          r32.x = dot(r30.xzw, r31.xyz);
          r33.xy = refProbeConstantsCB[r15.z].data[1].xw;
          r33.z = refProbeConstantsCB[r15.z].data[2].z;
          r32.y = dot(r30.xzw, r33.xyz);
          r34.x = refProbeConstantsCB[r15.z].data[1].y;
          r34.yz = refProbeConstantsCB[r15.z].data[2].xw;
          r32.z = dot(r30.xzw, r34.xyz);
          if (9 == 0) r18.z = 0; else if (9+16 < 32) {           r18.z = (uint)refProbeConstantsCB[r15.z].data[7].z << (32-(9 + 16)); r18.z = (uint)r18.z >> (32-9);          } else r18.z = (uint)refProbeConstantsCB[r15.z].data[7].z >> 16;
          r32.w = (uint)r18.z;
          r18.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r32.xyzw, r18.y).xyz;
          r30.xzw = (int3)r18.yzw & int3(-2147483648,-2147483648,-2147483648);
          r30.xzw = cmp((int3)r30.xzw == int3(2139095040,2139095040,2139095040));
          r19.x = (int)r30.z | (int)r30.x;
          r19.x = (int)r30.w | (int)r19.x;
          r18.yzw = r19.xxx ? float3(1,1,0) : r18.yzw;
          r35.x = dot(r16.yzw, r31.xyz);
          r35.y = dot(r16.yzw, r33.xyz);
          r35.z = dot(r16.yzw, r34.xyz);
          r16.yzw = saturate(r35.xyz * refProbeConstantsCB[r15.z].data[3].xyz + float3(0.5,0.5,0.5));
          r35.xy = refProbeConstantsCB[r15.z].data[4].zw * r16.yz;
          r35.z = refProbeConstantsCB[r15.z].data[5].x * r16.w;
          r16.yzw = refProbeConstantsCB[r15.z].data[5].yzw + r35.xyz;
          ...
          r15.z = (int)r31.y | (int)r31.x;
          r15.z = (int)r31.z | (int)r15.z;
          r30.xzw = r15.zzz ? float3(1,1,0) : r30.xzw;
          r31.xyz = r30.xzw * r16.yzw;
          r15.z = dot(r31.xyz, float3(0.212599993,0.715200007,0.0722000003));
          r27.xyz = r16.yzw * r30.xzw + r27.xyz;
          r16.y = r15.z * r3.w;
          r18.yzw = r18.yzw * r15.www;
          r15.w = dot(r18.yzw, float3(0.212599993,0.715200007,0.0722000003));
          r15.z = r3.w * r15.z + r15.w;
          r15.z = r16.y / r15.z;
          r31.x = r27.w;
          r31.yz = r28.xy;
          r16.yzw = r18.yzw * r15.zzz + r31.xyz;
          r27.w = r16.y;
          r28.xy = r16.zw;
        } else {
          r29.xyz = r28.xyz;
    ...
    r12.w = 0;
    while (true) {
      r13.z = cmp((uint)r12.w >= (uint)r7.w);
      if (r13.z != 0) break;
      r13.z = (uint)r12.w >> 5;
    ...
    r13.z = samplerLinear[]..swiz;
      ...
      if (r10.w == 0) r14.w = 0; else if (r10.w+0 < 32) {       r14.w = (uint)r13.z << (32-(r10.w + 0)); r14.w = (uint)r14.w >> (32-r10.w);      } else r14.w = (uint)r13.z >> 0;
      ...
      while (true) {
        ...
        r21.y = (int)r30.z + 1;
        r18.yzw = -refProbeConstantsCB[r14.w].data[0].xyz + r5.xyz;
        r19.w = 0x0000ffff & (int)refProbeConstantsCB[r14.w].data[7].z;
        if (6 == 0) r20.w = 0; else if (6+25 < 32) {         r20.w = (uint)refProbeConstantsCB[r14.w].data[7].z << (32-(6 + 25)); r20.w = (uint)r20.w >> (32-6);        } else r20.w = (uint)refProbeConstantsCB[r14.w].data[7].z >> 25;
        r22.w = (int)r19.w * 6;
        ...
        r19.x = r23.w * r22.w;
        r22.w = 1 & (int)refProbeConstantsCB[r14.w].data[6].x;
        r31.xy = r22.ww ? r19.xy : r19.zx;
        r19.x = refProbeConstantsCB[r14.w].data[6].x;
        r32.xy = r31.xy;
        r22.w = 1;
        while (true) {
          r23.w = cmp((int)r22.w >= (int)r20.w);
          if (r23.w != 0) break;
          ...
          r23.w = -r24.w * r23.w + 1;
          r23.w = r32.y * r23.w;
          r21.w = r29.w ? r23.w : r30.w;
          r32.xy = r28.ww ? r32.xy : r21.zw;
          r22.w = (int)r22.w + 1;
          r19.x = r27.w;
        }
        r19.x = saturate(r32.y + -r30.y);
        r19.w = refProbeConstantsCB[r14.w].data[6].y * r19.x;
        r20.w = cmp(0 < r19.w);
        if (r20.w != 0) {
          r20.w = (int)r21.y & 255;
          r21.w = (int)r20.w + -1;
          ...
          r30.z = (int)r30.z + 257;
          r30.x = r19.x * refProbeConstantsCB[r14.w].data[6].y + r30.x;
          r19.x = refProbeConstantsCB[r14.w].data[7].y * r19.w;
          r31.x = refProbeConstantsCB[r14.w].data[7].w;
          r31.yz = refProbeConstantsCB[r14.w].data[8].xy;
          r19.w = dot(r17.xyz, r31.xyz);
          r20.w = dot(r18.yzw, r31.xyz);
          r20.w = -refProbeConstantsCB[r14.w].data[8].z + r20.w;
          r21.w = cmp(r20.w >= 0);
          ...
          r31.x = refProbeConstantsCB[r14.w].data[8].w;
          r31.yz = refProbeConstantsCB[r14.w].data[9].xy;
          r20.w = dot(r17.xyz, r31.xyz);
          r21.w = dot(r18.yzw, r31.xyz);
          r21.w = -refProbeConstantsCB[r14.w].data[9].z + r21.w;
          r22.w = cmp(r21.w >= 0);
          ...
          r31.x = refProbeConstantsCB[r14.w].data[9].w;
          r31.yz = refProbeConstantsCB[r14.w].data[10].xy;
          r20.w = dot(r17.xyz, r31.xyz);
          r21.w = dot(r18.yzw, r31.xyz);
          r21.w = -refProbeConstantsCB[r14.w].data[10].z + r21.w;
          r22.w = cmp(r21.w >= 0);
          r21.w = max(abs(r21.w), r3.z);
          r21.w = r22.w ? r21.w : -r21.w;
          r20.w = max(1.00000001e-07, -r20.w);
          r20.w = r21.w / r20.w;
          r19.w = min(abs(r20.w), r19.w);
          r31.x = refProbeConstantsCB[r14.w].data[10].w;
          r31.yz = refProbeConstantsCB[r14.w].data[11].xy;
          r20.w = dot(r17.xyz, r31.xyz);
          r21.w = dot(r18.yzw, r31.xyz);
          r21.w = -refProbeConstantsCB[r14.w].data[11].z + r21.w;
          r22.w = cmp(r21.w >= 0);
          r21.w = max(abs(r21.w), r3.z);
          r21.w = r22.w ? r21.w : -r21.w;
          r20.w = max(1.00000001e-07, -r20.w);
          r20.w = r21.w / r20.w;
          r19.w = min(abs(r20.w), r19.w);
          r31.x = refProbeConstantsCB[r14.w].data[11].w;
          r31.yz = refProbeConstantsCB[r14.w].data[12].xy;
          r20.w = dot(r17.xyz, r31.xyz);
          r21.w = dot(r18.yzw, r31.xyz);
          r21.w = -refProbeConstantsCB[r14.w].data[12].z + r21.w;
          r22.w = cmp(r21.w >= 0);
          r21.w = max(abs(r21.w), r3.z);
          r21.w = r22.w ? r21.w : -r21.w;
          r20.w = max(1.00000001e-07, -r20.w);
          r20.w = r21.w / r20.w;
          r19.w = min(abs(r20.w), r19.w);
          r31.x = refProbeConstantsCB[r14.w].data[12].w;
          r31.yz = refProbeConstantsCB[r14.w].data[13].xy;
          r20.w = dot(r17.xyz, r31.xyz);
          r21.w = dot(r18.yzw, r31.xyz);
          r21.w = -refProbeConstantsCB[r14.w].data[13].z + r21.w;
          r22.w = cmp(r21.w >= 0);
          r21.w = max(abs(r21.w), r3.z);
          r21.w = r22.w ? r21.w : -r21.w;
          r20.w = max(1.00000001e-07, -r20.w);
          r20.w = r21.w / r20.w;
          r19.w = min(abs(r20.w), r19.w);
          r31.x = refProbeConstantsCB[r14.w].data[3].w + r18.y;
          r31.yz = refProbeConstantsCB[r14.w].data[4].xy + r18.zw;
          r31.xyz = r17.xyz * r19.www + r31.xyz;
          ...
          r33.x = refProbeConstantsCB[r14.w].data[0].w;
          r33.y = refProbeConstantsCB[r14.w].data[1].z;
          r33.z = refProbeConstantsCB[r14.w].data[2].y;
          r34.x = dot(r31.xyz, r33.xyz);
          r35.xy = refProbeConstantsCB[r14.w].data[1].xw;
          r35.z = refProbeConstantsCB[r14.w].data[2].z;
          r34.y = dot(r31.xyz, r35.xyz);
          r36.x = refProbeConstantsCB[r14.w].data[1].y;
          r36.yz = refProbeConstantsCB[r14.w].data[2].xw;
          r34.z = dot(r31.xyz, r36.xyz);
          if (9 == 0) r20.w = 0; else if (9+16 < 32) {           r20.w = (uint)refProbeConstantsCB[r14.w].data[7].z << (32-(9 + 16)); r20.w = (uint)r20.w >> (32-9);          } else r20.w = (uint)refProbeConstantsCB[r14.w].data[7].z >> 16;
          r34.w = (uint)r20.w;
          ...
          r18.yzw = saturate(r37.xyz * refProbeConstantsCB[r14.w].data[3].xyz + float3(0.5,0.5,0.5));
          r37.xy = refProbeConstantsCB[r14.w].data[4].zw * r18.yz;
          r37.z = refProbeConstantsCB[r14.w].data[5].x * r18.w;
          r18.yzw = refProbeConstantsCB[r14.w].data[5].yzw + r37.xyz;
          ...
          r32.xzw = r14.www ? float3(1,1,0) : r32.xzw;
          r33.xyz = r32.xzw * r18.yzw;
          r14.w = dot(r33.xyz, float3(0.212599993,0.715200007,0.0722000003));
          r28.xyz = r18.yzw * r32.xzw + r28.xyz;
          r18.y = r14.w * r3.w;
          r31.xyz = r31.xyz * r19.xxx;
          r18.z = dot(r31.xyz, float3(0.212599993,0.715200007,0.0722000003));
          r14.w = r3.w * r14.w + r18.z;
          r14.w = r18.y / r14.w;
          r29.xyz = r31.xyz * r14.www + r29.xyz;
        } else {
          r21.x = r30.x;
          r30.xz = r21.xy;
        }
    ...
    r2.w = cmp(r26.z >= 1);
    r3.z = (int)r26.w & 0x0000ff00;
    bitmask.z = ((~(-1 << 8)) << 0) & 0xffffffff;  r3.z = (((uint)r16.z << 0) & bitmask.z) | ((uint)r3.z & ~bitmask.z);
    r6.w = r2.w ? r3.z : r16.z;
    r2.w = max(1, r16.y);
    r2.w = rcp(r2.w);
    r16.y = saturate(r16.y);
    r18.xyz = r15.yzw * r2.www;
    r22.xyz = r27.xyz * r2.www;
    r3.z = cmp(r16.y < 0.99000001);
    if (r3.z != 0) {
      r6.w = (int)r6.w + 256;
      r3.z = 1 + -r16.y;
      ...
      r18.xyz = r15.yzw * r2.www + r16.yzw;
      r17.w = 0;
  ...
  while (true) {
    ...
    if (r10.w != 0) break;
    r10.w = r9.w ? r0.x : r4.z;
    r10.w = (int)r10.w * 15;
    if (3 == 0) r11.w = 0; else if (3+24 < 32) {     r11.w = (uint)lightConstantsCB[r10.w].data[1].w << (32-(3 + 24)); r11.w = (uint)r11.w >> (32-3);    } else r11.w = (uint)lightConstantsCB[r10.w].data[1].w >> 24;
    switch (r11.w) {
      case 4 :      if (r2.z != 0) {
        r11.w = (int)r8.w & 3;
        r11.w = mad((int)r11.w, 24, 112);
        r20.yzw = lightConstantsCB[r10.w].data[0].xyz + eyeOffset.xyz;
        GBufferDiffuseColor[viewID].r11.w = u2.xyzw;
      }
      r11.w = (int)r8.w + 1;
      r12.w = cmp(0 < lightConstantsCB[r10.w].data[6].y);
      r35.xy = lightConstantsCB[r10.w].data[5].zw;
      r35.z = lightConstantsCB[r10.w].data[6].x;
      r20.yzw = -r35.xyz * float3(0.5,0.5,0.5) + lightConstantsCB[r10.w].data[0].xyz;
      r36.xyz = r20.yzw + -r5.xyz;
      r13.z = dot(r35.xyz, r36.xyz);
      r13.w = saturate(-r13.z / lightConstantsCB[r10.w].data[6].y);
      r37.xyz = r13.www * r35.xyz + r20.yzw;
      r37.xyz = r12.www ? r37.xyz : lightConstantsCB[r10.w].data[0].xyz;
      ...
      if (r24.w != 0) {
        r24.w = sqrt(r14.w);
        r28.w = lightConstantsCB[r10.w].data[3].x * lightConstantsCB[r10.w].data[3].x;
        r14.w = r28.w / r14.w;
        r14.w = min(1, r14.w);
        r37.xy = saturate(r24.ww * lightConstantsCB[r10.w].data[2].xz + lightConstantsCB[r10.w].data[2].yw);
        ...
        r24.w = cmp(0 < r14.w);
        if (r24.w != 0) {
          if (3 == 0) r24.w = 0; else if (3+27 < 32) {           r24.w = (uint)lightConstantsCB[r10.w].data[1].w << (32-(3 + 27)); r24.w = (uint)r24.w >> (32-3);          } else r24.w = (uint)lightConstantsCB[r10.w].data[1].w >> 27;
          r28.w = (int)r11.w & 7;
          r29.w = (int)r28.w + -1;
          ...
          if (r24.w != 0) {
            ...
            r37.xyz = r11.xyz * r24.www + r5.xyz;
            r37.xyz = -lightConstantsCB[r10.w].data[4].yzw + r37.xyz;
            r24.w = max(abs(r37.y), abs(r37.z));
            r24.w = max(abs(r37.x), r24.w);
            r24.w = lightConstantsCB[r10.w].data[5].x / r24.w;
            r24.w = lightConstantsCB[r10.w].data[5].y + r24.w;
            r29.w = dot(r37.xyz, r37.xyz);
            r29.w = rsqrt(r29.w);
            r24.w = max(6.10351563e-05, r24.w);
            r30.w = 0x0000ffff & (int)lightConstantsCB[r10.w].data[1].w;
            r38.w = (uint)r30.w;
            r30.w = 0;
            r31.w = 0;
            while (true) {
              ...
              r39.yz = lightConstantsCB[r10.w].data[3].yy * r39.yz;
              r39.x = r39.y * r16.x;
              r39.w = r39.y * r15.x;
          ...
          r24.w = cmp(0 < r14.w);
          if (r24.w != 0) {
            r24.w = lightConstantsCB[r10.w].data[1].z * r1.z;
            r24.w = 0.25 * r24.w;
            r29.w = dot(r35.xyz, r17.xyz);
            r31.w = dot(r17.xyz, r36.xyz);
            r32.w = -r29.w * r29.w + lightConstantsCB[r10.w].data[6].y;
            r13.z = r29.w * r31.w + -r13.z;
            r13.z = saturate(r13.z / r32.w);
            r29.w = r32.w / lightConstantsCB[r10.w].data[6].y;
            r29.w = 10 * r29.w;
            r29.w = min(1, r29.w);
            r13.z = r13.z + -r13.w;
            r13.z = r29.w * r13.z + r13.w;
            r20.yzw = r13.zzz * r35.xyz + r20.yzw;
            r20.yzw = r12.www ? r20.yzw : lightConstantsCB[r10.w].data[0].xyz;
            r20.yzw = r20.yzw + -r5.xyz;
            r12.w = dot(r20.yzw, r20.yzw);
            r12.w = rsqrt(r12.w);
            r35.xyz = r20.yzw * r12.www;
            if (4 == 0) r13.z = 0; else if (4+16 < 32) {             r13.z = (uint)lightConstantsCB[r10.w].data[1].w << (32-(4 + 16)); r13.z = (uint)r13.z >> (32-4);            } else r13.z = (uint)lightConstantsCB[r10.w].data[1].w >> 16;
            ...
            if (r13.w != 0) {
              ...
              r36.xyz = lightConstantsCB[r13.z].data[6].yzw;
              r36.w = lightConstantsCB[r13.z].data[7].x;
              r13.w = dot(r36.xyzw, r22.xyzw);
              r36.xyz = lightConstantsCB[r13.z].data[7].yzw;
              r36.w = lightConstantsCB[r13.z].data[8].x;
              r29.w = dot(r36.xyzw, r22.xyzw);
              r31.w = cmp(r29.w < r13.w);
              if (r31.w == 0) {
                r36.xyz = lightConstantsCB[r13.z].data[4].yzw;
                r36.w = lightConstantsCB[r13.z].data[5].x;
                ...
                r36.x = lightConstantsCB[r13.z].data[9].w + r22.x;
                r36.y = lightConstantsCB[r13.z].data[10].x + r22.y;
                r22.xy = lightConstantsCB[r13.z].data[9].yz * r36.xy;
                r36.xy = lightConstantsCB[r13.z].data[3].yy / lightConstantsCB[r13.z].data[8].yw;
                ...
                if (r22.z == 0) {
                  ...
                  r36.x = r22.x * lightConstantsCB[r13.z].data[8].y + lightConstantsCB[r13.z].data[8].z;
                  r36.y = r22.y * lightConstantsCB[r13.z].data[8].w + lightConstantsCB[r13.z].data[9].x;
                  r22.x = lightConstantsCB[r13.z].data[10].z * r29.w;
                  r13.w = lightConstantsCB[r13.z].data[10].y * r29.w + r13.w;
                  r13.w = r13.w / r22.x;
                }
              } else {
                r22.z = -1;
              ...
              if (r22.x == 0) {
                ...
                if (enableDitheredShadow != 0) {
                  ...
                  while (true) {
                    ...
                    r37.xy = r38.xy * lightConstantsCB[r13.z].data[3].yy + r36.xy;
              ...
              if (4 == 0) r13.z = 0; else if (4+20 < 32) {               r13.z = (uint)lightConstantsCB[r10.w].data[1].w << (32-(4 + 20)); r13.z = (uint)r13.z >> (32-4);              } else r13.z = (uint)lightConstantsCB[r10.w].data[1].w >> 20;
              r13.w = cmp(0 < (uint)r13.z);
              r13.w = r13.w ? r7.w : 0;
              if (r13.w != 0) {
                r13.z = (int)r13.z + numLights;
                ...
                r23.xyz = r11.xyz * r13.www + r5.xyz;
                r36.xyz = lightConstantsCB[r13.z].data[6].yzw;
                r36.w = lightConstantsCB[r13.z].data[7].x;
                ...
                if (r22.z == 0) {
                  ...
                  r36.x = lightConstantsCB[r13.z].data[9].w + r23.x;
                  r36.y = lightConstantsCB[r13.z].data[10].x + r23.y;
                  r23.xy = lightConstantsCB[r13.z].data[9].yz * r36.xy;
                  r36.xy = lightConstantsCB[r13.z].data[3].yy / lightConstantsCB[r13.z].data[8].yw;
                  r36.zw = float2(1,1) + -r36.xy;
                  ...
                  if (r23.z == 0) {
                    ...
                    r36.x = r23.x * lightConstantsCB[r13.z].data[8].y + lightConstantsCB[r13.z].data[8].z;
                    r36.y = r23.y * lightConstantsCB[r13.z].data[8].w + lightConstantsCB[r13.z].data[9].x;
                    r23.x = lightConstantsCB[r13.z].data[10].z * r22.x;
                    r13.w = lightConstantsCB[r13.z].data[10].y * r22.x + r13.w;
                    r13.w = r13.w / r23.x;
                  }
                } else {
                  r23.z = -1;
                ...
                if (r22.x == 0) {
                  ...
                  if (enableDitheredShadow != 0) {
                    ...
                    while (true) {
                      ...
                      r23.xy = r37.xy * lightConstantsCB[r13.z].data[3].yy + r36.xy;
            ...
            r13.z = r13.z + -r18.w;
            r13.z = r1.w * r13.z + r18.w;
            r13.z = r13.z * r14.w;
            r23.x = lightConstantsCB[r10.w].data[0].w;
            r23.yz = lightConstantsCB[r10.w].data[1].xy;
            r13.w = cmp(0 < r17.w);
            r36.xyz = r13.zzz * r23.xyz + r31.xyz;
            r17.w = saturate(dot(r11.xyz, r35.xyz));
            r20.yzw = r20.yzw * r12.www + r12.xyz;
            r12.w = dot(r20.yzw, r20.yzw);
            r12.w = rsqrt(r12.w);
            r20.yzw = r20.yzw * r12.www;
            r12.w = dot(r20.yzw, r12.xyz);
            r18.w = dot(r11.xyz, r20.yzw);
            ...
            r12.w = r18.w * r12.w;
            r12.w = r17.w * r12.w;
            r35.xyz = r12.www * r23.xyz + r33.xyz;
            r23.xyz = r13.zzz * r23.xyz + r32.xyz;
            ...
            r13.z = r2.z ? r13.z : 0;
            if (r13.z != 0) {
              r13.zw = mad((int2)r12.ww, int2(24,24), int2(88,108));
            // Known bad code for instruction (needs manual fix):
      ...
      case 2 :      if (r2.z != 0) {
        r11.w = (int)r8.w & 3;
        r11.w = mad((int)r11.w, 24, 112);
        r21.yzw = lightConstantsCB[r10.w].data[0].xyz + eyeOffset.xyz;
        GBufferDiffuseColor[viewID].r11.w = u2.xyzw;
      }
      r11.w = (int)r8.w + 1;
      r23.xy = lightConstantsCB[r10.w].data[3].zw + -r5.xy;
      r23.z = lightConstantsCB[r10.w].data[4].x + -r5.z;
      r12.w = dot(r23.xyz, r23.xyz);
      r12.w = rsqrt(r12.w);
      r20.yzw = r23.xyz * r12.www;
      r13.z = dot(r11.xyz, r20.yzw);
      r13.w = saturate(r13.z);
      r14.w = r0.w ? abs(r13.z) : r13.w;
      r17.w = cmp(0 < r14.w);
      if (r17.w != 0) {
        r35.xyz = lightConstantsCB[r10.w].data[7].yzw;
        r35.w = lightConstantsCB[r10.w].data[8].x;
        r17.w = dot(r35.xyzw, r5.xyzw);
        r18.w = cmp(r17.w < 1);
        if (r18.w != 0) {
          r20.yzw = float3(1,1,1);
          r18.w = 0;
        } else {
          r21.yzw = lightConstantsCB[r10.w].data[0].xyz + -r5.xyz;
          r22.x = lightConstantsCB[r10.w].data[3].x * lightConstantsCB[r10.w].data[3].x;
          r21.y = dot(r21.yzw, r21.yzw);
          r21.y = r22.x / r21.y;
          r21.y = min(1, r21.y);
          r21.zw = saturate(r17.ww * lightConstantsCB[r10.w].data[2].xz + lightConstantsCB[r10.w].data[2].yw);
          ...
          r17.w = cmp(lightConstantsCB[r10.w].data[10].w < 0.00048828125);
          if (r17.w != 0) {
            r21.zw = saturate(abs(r24.xy) * lightConstantsCB[r10.w].data[12].xy + lightConstantsCB[r10.w].data[12].zw);
            r36.xy = r21.zw * r21.zw;
            r21.zw = r21.zw * float2(-2,-2) + float2(3,3);
            r21.zw = r36.xy * r21.zw;
            r17.w = r21.z * r21.w;
          } else {
            r36.xyzw = saturate(lightConstantsCB[r10.w].data[11].xyzw * abs(r24.yyxx));
            r36.xyzw = log2(r36.xyzw);
            r36.xyzw = lightConstantsCB[r10.w].data[12].zzzz * r36.xyzw;
            r36.xyzw = exp2(r36.xyzw);
            r21.zw = r36.xy + r36.zw;
            r21.zw = log2(r21.zw);
            r21.zw = lightConstantsCB[r10.w].data[12].ww * r21.zw;
            r21.zw = exp2(r21.zw);
            r21.z = lightConstantsCB[r10.w].data[12].x * r21.z;
            r22.x = lightConstantsCB[r10.w].data[12].y * r21.w + -1;
            r21.z = lightConstantsCB[r10.w].data[12].y * r21.w + -r21.z;
          ...
          r18.w = r21.y * r17.w;
          r17.w = 255 & (int)lightConstantsCB[r10.w].data[14].w;
          if (r17.w != 0) {
            r21.y = dot(lightConstantsCB[r10.w].data[13].xyz, r24.xyz);
            r36.x = lightConstantsCB[r10.w].data[13].w;
            r36.yz = lightConstantsCB[r10.w].data[14].xy;
        ...
        r36.x = lightConstantsCB[r10.w].data[0].w;
        r36.yz = lightConstantsCB[r10.w].data[1].xy;
        r20.yzw = r36.xyz * r20.yzw;
        r17.w = cmp(0 < r18.w);
        if (r17.w != 0) {
          if (3 == 0) r17.w = 0; else if (3+27 < 32) {           r17.w = (uint)lightConstantsCB[r10.w].data[1].w << (32-(3 + 27)); r17.w = (uint)r17.w >> (32-3);          } else r17.w = (uint)lightConstantsCB[r10.w].data[1].w >> 27;
          r21.y = (int)r11.w & 7;
          r21.z = (int)r21.y + -1;
          ...
          if (r17.w != 0) {
            r17.w = abs(r13.z) * -0.200000003 + 0.400000006;
            r21.z = cmp(r13.z < 0);
            r21.z = r0.w ? r21.z : 0;
            r17.w = r21.z ? -r17.w : r17.w;
            r25.xyz = r11.xyz * r17.www + r5.xyz;
            ...
            if (r21.w != 0) {
              ...
              r25.x = r24.x * lightConstantsCB[r10.w].data[8].y + lightConstantsCB[r10.w].data[8].z;
              r25.y = r24.y * lightConstantsCB[r10.w].data[8].w + lightConstantsCB[r10.w].data[9].x;
              r17.w = r17.w / r21.z;
              r17.w = max(6.10351563e-05, r17.w);
              r21.z = 0x0000ffff & (int)lightConstantsCB[r10.w].data[1].w;
              if (enableDitheredShadow != 0) {
                r35.z = (uint)r21.z;
                r21.w = 0;
                r22.x = 0;
                while (true) {
                  ...
                  r35.xy = r24.xy * lightConstantsCB[r10.w].data[3].yy + r25.xy;
          ...
          r18.w = cmp(0 < r17.w);
          if (r18.w != 0) {
            r18.w = lightConstantsCB[r10.w].data[1].z * r1.z;
            r18.w = r18.w * r13.w;
            if (4 == 0) r21.z = 0; else if (4+16 < 32) {             r21.z = (uint)lightConstantsCB[r10.w].data[1].w << (32-(4 + 16)); r21.z = (uint)r21.z >> (32-4);            } else r21.z = (uint)lightConstantsCB[r10.w].data[1].w >> 16;
            r22.x = cmp(0 < (uint)r21.z);
            r22.x = r22.x ? r3.x : 0;
            if (r22.x != 0) {
              r21.z = (int)r21.z + numLights;
              r21.z = mad((int)r21.z, 15, -15);
              r22.x = abs(r13.z) * -0.200000003 + 0.400000006;
              r24.x = cmp(r13.z < 0);
              r24.x = r0.w ? r24.x : 0;
              r22.x = r24.x ? -r22.x : r22.x;
              r26.xyz = r11.xyz * r22.xxx + r5.xyz;
              ...
              if (4 == 0) r10.w = 0; else if (4+20 < 32) {               r10.w = (uint)lightConstantsCB[r10.w].data[1].w << (32-(4 + 20)); r10.w = (uint)r10.w >> (32-4);              } else r10.w = (uint)lightConstantsCB[r10.w].data[1].w >> 20;
              r21.z = cmp(0 < (uint)r10.w);
              r21.z = r21.z ? r7.w : 0;
              if (r21.z != 0) {
                r10.w = (int)r10.w + numLights;
                r10.w = mad((int)r10.w, 15, -15);
                r21.z = abs(r13.z) * -0.200000003 + 0.400000006;
                r22.x = cmp(r13.z < 0);
                r22.x = r0.w ? r22.x : 0;
                ...
                if (r24.x == 0) {
                  ...
                  r25.xy = r25.xy * float2(0.5,-0.5) + float2(0.5,0.5);
                  r26.x = lightConstantsCB[r10.w].data[9].w + r25.x;
                  r26.y = lightConstantsCB[r10.w].data[10].x + r25.y;
                  r25.xy = lightConstantsCB[r10.w].data[9].yz * r26.xy;
                  ...
                  if (r24.w == 0) {
                    r25.xy = saturate(r25.xy);
                    r26.x = r25.x * lightConstantsCB[r10.w].data[8].y + lightConstantsCB[r10.w].data[8].z;
                    r26.y = r25.y * lightConstantsCB[r10.w].data[8].w + lightConstantsCB[r10.w].data[9].x;
                    r25.x = lightConstantsCB[r10.w].data[10].z * r22.x;
                    r21.z = lightConstantsCB[r10.w].data[10].y * r22.x + r21.z;
                    r21.z = r21.z / r25.x;
                  }
                } else {
                  r24.w = -1;
                ...
                if (r22.x == 0) {
                  ...
                  if (enableDitheredShadow != 0) {
                    ...
                    while (true) {
                      ...
                      r25.xy = r27.xy * lightConstantsCB[r10.w].data[3].yy + r26.xy;
            ...
            r10.w = r10.w + -r14.w;
            r10.w = r1.w * r10.w + r14.w;
            r10.w = r10.w * r17.w;
            r13.z = cmp(0 < r13.z);
            r25.xyz = r10.www * r20.yzw + r31.xyz;
            ...
            r12.w = r14.w * r12.w;
            r12.w = r13.w * r12.w;
            r26.xyz = r12.www * r20.yzw + r33.xyz;
            r20.yzw = r10.www * r20.yzw + r32.xyz;
            r20.yzw = r0.www ? r20.yzw : r32.xyz;
            r31.xyz = r13.zzz ? r25.xyz : r31.xyz;
            r32.xyz = r13.zzz ? r32.xyz : r20.yzw;
            r33.xyz = r13.zzz ? r26.xyz : r33.xyz;
            r34.xyz = r13.zzz ? r23.xyz : r34.xyz;
            r10.w = (int)r21.y & 7;
            r12.w = (int)r10.w + -1;
            r12.w = cmp((uint)r12.w < 32);
            r12.w = r2.z ? r12.w : 0;
            if (r12.w != 0) {
              r13.zw = mad((int2)r10.ww, int2(24,24), int2(88,108));
            // Known bad code for instruction (needs manual fix):
  ...
  if (enableCountDebug != 0) {
    if (debugDrawOverlayType != 0) {
      switch (cb2[53].y) {
        case 1 :        r0.x = (int)r8.w & 3;
        break;
        case 2 :        if (2 == 0) r0.x = 0; else if (2+8 < 32) {         r0.x = (uint)r8.w << (32-(2 + 8)); r0.x = (uint)r0.x >> (32-2);        } else r0.x = (uint)r8.w >> 8;
        break;
        case 3 :        r0.x = (uint)r8.w >> 16;
        break;
...
store_uav_typed u0.xyzw, r1.xyyy, r2.xywx
  ...
  if (enableCountDebug != 0) {
    ...
    if (2 == 0) r0.w = 0; else if (2+8 < 32) {     r0.w = (uint)r8.w << (32-(2 + 8)); r0.w = (uint)r0.w >> (32-2);    } else r0.w = (uint)r8.w >> 8;
    // Needs manual fix for instruction:
