...
r0.y = samplerLinear[]..swiz;
  ...
  while (true) {
    r6.w = cmp((int)r0.y == 2);
    if (r6.w != 0) break;
    r6.w = r0.y ? r0.x : r13.y;
    r7.w = cmp((uint)r6.w >= (uint)r4.z);
    ...
    if (r7.w != 0) {
      ...
      r24.w = (int)r23.w + 1;
      r14.yzw = -refProbeConstantsCB[r6.w].data[0].xyz + r11.xyz;
      ...
      r9.w = (int)r7.w * 6;
      r10.w = dot(refProbeAttenuationConstantsCB[r9.w].data[0].xyz, r14.yzw);
      ...
      r16.yz = r9.ww ? r17.xy : r17.zx;
      r9.w = refProbeConstantsCB[r6.w].data[6].x;
      r25.xy = r16.yz;
      r10.w = 1;
      while (true) {
        r13.w = cmp((int)r10.w >= (int)r8.w);
        if (r13.w != 0) break;
        ...
        r16.w = r25.x * r16.w;
        r17.x = dot(refProbeAttenuationConstantsCB[r13.w].data[1].xyz, r14.yzw);
        r17.x = saturate(refProbeAttenuationConstantsCB[r13.w].data[1].w + r17.x);
        r16.w = r17.x * r16.w;
        r17.x = dot(refProbeAttenuationConstantsCB[r13.w].data[2].xyz, r14.yzw);
        r17.x = saturate(refProbeAttenuationConstantsCB[r13.w].data[2].w + r17.x);
        r16.w = r17.x * r16.w;
        r17.x = dot(refProbeAttenuationConstantsCB[r13.w].data[3].xyz, r14.yzw);
        r17.x = saturate(refProbeAttenuationConstantsCB[r13.w].data[3].w + r17.x);
        r16.w = r17.x * r16.w;
        r17.x = dot(refProbeAttenuationConstantsCB[r13.w].data[4].xyz, r14.yzw);
        r17.x = saturate(refProbeAttenuationConstantsCB[r13.w].data[4].w + r17.x);
        r16.w = r17.x * r16.w;
        r17.x = dot(refProbeAttenuationConstantsCB[r13.w].data[5].xyz, r14.yzw);
        r13.w = saturate(refProbeAttenuationConstantsCB[r13.w].data[5].w + r17.x);
        r25.x = r16.w * r13.w;
        r17.x = (uint)r9.w >> 2;
        if (1 == 0) r17.w = 0; else if (1+2 < 32) {         r17.w = (uint)r9.w << (32-(1 + 2)); r17.w = (uint)r17.w >> (32-1);        } else r17.w = (uint)r9.w >> 2;
        r18.w = (int)r17.x & 2;
        r20.w = max(r25.y, r25.x);
        r13.w = -r16.w * r13.w + 1;
        r13.w = r25.y * r13.w;
        r19.y = r18.w ? r13.w : r20.w;
        r25.xy = r17.ww ? r25.xy : r19.xy;
        r10.w = (int)r10.w + 1;
        r9.w = r17.x;
      }
      r25.y = saturate(r25.y);
      r7.w = refProbeConstantsCB[r6.w].data[6].y * r25.y;
      r8.w = cmp(0 < r7.w);
      if (r8.w != 0) {
        r8.w = (int)r24.w & 7;
        r9.w = (int)r8.w + -1;
        ...
        r9.w = r2.z ? r9.w : 0;
        if (r9.w != 0) {
          r16.yz = mad((int2)r8.ww, int2(20,20), int2(860,876));
        // Known bad code for instruction (needs manual fix):
        ...
        r23.w = (int)r23.w + 257;
        r23.z = r25.y * refProbeConstantsCB[r6.w].data[6].y + r23.z;
        r7.w = refProbeConstantsCB[r6.w].data[7].y * r7.w;
        r26.x = refProbeConstantsCB[r6.w].data[7].w;
        r26.yz = refProbeConstantsCB[r6.w].data[8].xy;
        r8.w = dot(r15.xyz, r26.xyz);
        r9.w = dot(r14.yzw, r26.xyz);
        ...
        r26.x = refProbeConstantsCB[r6.w].data[8].w;
        r26.yz = refProbeConstantsCB[r6.w].data[9].xy;
        ...
        r26.x = refProbeConstantsCB[r6.w].data[9].w;
        r26.yz = refProbeConstantsCB[r6.w].data[10].xy;
        r9.w = dot(r15.xyz, r26.xyz);
        r10.w = dot(r14.yzw, r26.xyz);
        ...
        r9.w = r10.w / r9.w;
        r8.w = min(abs(r9.w), r8.w);
        r26.x = refProbeConstantsCB[r6.w].data[10].w;
        r26.yz = refProbeConstantsCB[r6.w].data[11].xy;
        r9.w = dot(r15.xyz, r26.xyz);
        r10.w = dot(r14.yzw, r26.xyz);
        ...
        r9.w = r10.w / r9.w;
        r8.w = min(abs(r9.w), r8.w);
        r26.x = refProbeConstantsCB[r6.w].data[11].w;
        r26.yz = refProbeConstantsCB[r6.w].data[12].xy;
        r9.w = dot(r15.xyz, r26.xyz);
        r10.w = dot(r14.yzw, r26.xyz);
        ...
        r9.w = r10.w / r9.w;
        r8.w = min(abs(r9.w), r8.w);
        r26.x = refProbeConstantsCB[r6.w].data[12].w;
        r26.yz = refProbeConstantsCB[r6.w].data[13].xy;
        r9.w = dot(r15.xyz, r26.xyz);
        r10.w = dot(r14.yzw, r26.xyz);
        ...
        r9.w = r10.w / r9.w;
        r8.w = min(abs(r9.w), r8.w);
        r26.x = refProbeConstantsCB[r6.w].data[3].w + r14.y;
        r26.yz = refProbeConstantsCB[r6.w].data[4].xy + r14.zw;
        r16.yzw = r15.xyz * r8.www + r26.xyz;
        ...
        r26.x = refProbeConstantsCB[r6.w].data[0].w;
        r26.y = refProbeConstantsCB[r6.w].data[1].z;
        r26.z = refProbeConstantsCB[r6.w].data[2].y;
        r27.x = dot(r16.yzw, r26.xyz);
        r28.xy = refProbeConstantsCB[r6.w].data[1].xw;
        r28.z = refProbeConstantsCB[r6.w].data[2].z;
        r27.y = dot(r16.yzw, r28.xyz);
        r29.x = refProbeConstantsCB[r6.w].data[1].y;
        r29.yz = refProbeConstantsCB[r6.w].data[2].xw;
        ...
        r27.w = (uint)r9.w;
        r16.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r27.xyzw, r8.w).xyz;
        r25.xzw = (int3)r16.yzw & int3(-2147483648,-2147483648,-2147483648);
        r25.xzw = cmp((int3)r25.xzw == int3(2139095040,2139095040,2139095040));
        r8.w = (int)r25.z | (int)r25.x;
        r8.w = (int)r25.w | (int)r8.w;
        r16.yzw = r8.www ? float3(1,1,0) : r16.yzw;
        r30.x = dot(r14.yzw, r26.xyz);
        r30.y = dot(r14.yzw, r28.xyz);
        r30.z = dot(r14.yzw, r29.xyz);
        r14.yzw = saturate(r30.xyz * refProbeConstantsCB[r6.w].data[3].xyz + float3(0.5,0.5,0.5));
        r30.xy = refProbeConstantsCB[r6.w].data[4].zw * r14.yz;
        r30.z = refProbeConstantsCB[r6.w].data[5].x * r14.w;
        r14.yzw = refProbeConstantsCB[r6.w].data[5].yzw + r30.xyz;
  ...
  while (true) {
    ...
    if (r7.w != 0) {
      ...
      r25.y = (int)r19.y + 1;
      r16.yzw = -refProbeConstantsCB[r6.w].data[0].xyz + r11.xyz;
      r7.w = 0x0000ffff & (int)refProbeConstantsCB[r6.w].data[7].z;
      if (6 == 0) r8.w = 0; else if (6+25 < 32) {       r8.w = (uint)refProbeConstantsCB[r6.w].data[7].z << (32-(6 + 25)); r8.w = (uint)r8.w >> (32-6);      } else r8.w = (uint)refProbeConstantsCB[r6.w].data[7].z >> 25;
      r9.w = (int)r7.w * 6;
      r10.w = dot(refProbeAttenuationConstantsCB[r9.w].data[0].xyz, r16.yzw);
      r10.w = saturate(refProbeAttenuationConstantsCB[r9.w].data[0].w + r10.w);
      r13.w = dot(refProbeAttenuationConstantsCB[r9.w].data[1].xyz, r16.yzw);
      r13.w = saturate(refProbeAttenuationConstantsCB[r9.w].data[1].w + r13.w);
      r10.w = r13.w * r10.w;
      r13.w = dot(refProbeAttenuationConstantsCB[r9.w].data[2].xyz, r16.yzw);
      r13.w = saturate(refProbeAttenuationConstantsCB[r9.w].data[2].w + r13.w);
      r10.w = r13.w * r10.w;
      r13.w = dot(refProbeAttenuationConstantsCB[r9.w].data[3].xyz, r16.yzw);
      r13.w = saturate(refProbeAttenuationConstantsCB[r9.w].data[3].w + r13.w);
      r10.w = r13.w * r10.w;
      r13.w = dot(refProbeAttenuationConstantsCB[r9.w].data[4].xyz, r16.yzw);
      r13.w = saturate(refProbeAttenuationConstantsCB[r9.w].data[4].w + r13.w);
      r10.w = r13.w * r10.w;
      r13.w = dot(refProbeAttenuationConstantsCB[r9.w].data[5].xyz, r16.yzw);
      r9.w = saturate(refProbeAttenuationConstantsCB[r9.w].data[5].w + r13.w);
      r17.x = r10.w * r9.w;
      r9.w = 1 & (int)refProbeConstantsCB[r6.w].data[6].x;
      r17.xw = r9.ww ? r17.xy : r17.zx;
      r9.w = refProbeConstantsCB[r6.w].data[6].x;
      r26.xy = r17.xw;
      r10.w = 1;
      while (true) {
        ...
        r13.w = (int)r7.w + (int)r10.w;
        r13.w = (int)r13.w * 6;
        r18.w = dot(refProbeAttenuationConstantsCB[r13.w].data[0].xyz, r16.yzw);
        r18.w = saturate(refProbeAttenuationConstantsCB[r13.w].data[0].w + r18.w);
        r18.w = r26.x * r18.w;
        r20.w = dot(refProbeAttenuationConstantsCB[r13.w].data[1].xyz, r16.yzw);
        r20.w = saturate(refProbeAttenuationConstantsCB[r13.w].data[1].w + r20.w);
        r18.w = r20.w * r18.w;
        r20.w = dot(refProbeAttenuationConstantsCB[r13.w].data[2].xyz, r16.yzw);
        r20.w = saturate(refProbeAttenuationConstantsCB[r13.w].data[2].w + r20.w);
        r18.w = r20.w * r18.w;
        r20.w = dot(refProbeAttenuationConstantsCB[r13.w].data[3].xyz, r16.yzw);
        r20.w = saturate(refProbeAttenuationConstantsCB[r13.w].data[3].w + r20.w);
        r18.w = r20.w * r18.w;
        r20.w = dot(refProbeAttenuationConstantsCB[r13.w].data[4].xyz, r16.yzw);
        r20.w = saturate(refProbeAttenuationConstantsCB[r13.w].data[4].w + r20.w);
        r18.w = r20.w * r18.w;
        r20.w = dot(refProbeAttenuationConstantsCB[r13.w].data[5].xyz, r16.yzw);
        r13.w = saturate(refProbeAttenuationConstantsCB[r13.w].data[5].w + r20.w);
        r26.x = r18.w * r13.w;
        r20.w = (uint)r9.w >> 2;
        ...
        r13.w = -r18.w * r13.w + 1;
        r13.w = r26.y * r13.w;
        r19.w = r24.w ? r13.w : r25.z;
        r26.xy = r21.ww ? r26.xy : r19.zw;
        r10.w = (int)r10.w + 1;
        r9.w = r20.w;
      }
      r7.w = saturate(r26.y + -r23.z);
      ...
      if (r9.w != 0) {
        ...
        r10.w = r2.z ? r10.w : 0;
        if (r10.w != 0) {
          r17.xw = mad((int2)r9.ww, int2(20,20), int2(860,876));
        // Known bad code for instruction (needs manual fix):
        ...
        r19.y = (int)r19.y + 257;
        r19.x = r7.w * refProbeConstantsCB[r6.w].data[6].y + r19.x;
        r7.w = refProbeConstantsCB[r6.w].data[7].y * r8.w;
        r27.x = refProbeConstantsCB[r6.w].data[7].w;
        r27.yz = refProbeConstantsCB[r6.w].data[8].xy;
        r8.w = dot(r15.xyz, r27.xyz);
        r9.w = dot(r16.yzw, r27.xyz);
        r9.w = -refProbeConstantsCB[r6.w].data[8].z + r9.w;
        r10.w = cmp(r9.w >= 0);
        r9.w = max(abs(r9.w), r3.z);
        r9.w = r10.w ? r9.w : -r9.w;
        ...
        r8.w = r9.w / r8.w;
        r8.w = min(131072, abs(r8.w));
        r27.x = refProbeConstantsCB[r6.w].data[8].w;
        r27.yz = refProbeConstantsCB[r6.w].data[9].xy;
        ...
        r9.w = r10.w / r9.w;
        r8.w = min(abs(r9.w), r8.w);
        r27.x = refProbeConstantsCB[r6.w].data[9].w;
        r27.yz = refProbeConstantsCB[r6.w].data[10].xy;
        r9.w = dot(r15.xyz, r27.xyz);
        r10.w = dot(r16.yzw, r27.xyz);
        r10.w = -refProbeConstantsCB[r6.w].data[10].z + r10.w;
        r13.w = cmp(r10.w >= 0);
        ...
        r9.w = r10.w / r9.w;
        r8.w = min(abs(r9.w), r8.w);
        r27.x = refProbeConstantsCB[r6.w].data[10].w;
        r27.yz = refProbeConstantsCB[r6.w].data[11].xy;
        r9.w = dot(r15.xyz, r27.xyz);
        r10.w = dot(r16.yzw, r27.xyz);
        r10.w = -refProbeConstantsCB[r6.w].data[11].z + r10.w;
        r13.w = cmp(r10.w >= 0);
        ...
        r9.w = r10.w / r9.w;
        r8.w = min(abs(r9.w), r8.w);
        r27.x = refProbeConstantsCB[r6.w].data[11].w;
        r27.yz = refProbeConstantsCB[r6.w].data[12].xy;
        r9.w = dot(r15.xyz, r27.xyz);
        r10.w = dot(r16.yzw, r27.xyz);
        r10.w = -refProbeConstantsCB[r6.w].data[12].z + r10.w;
        r13.w = cmp(r10.w >= 0);
        ...
        r9.w = r10.w / r9.w;
        r8.w = min(abs(r9.w), r8.w);
        r27.x = refProbeConstantsCB[r6.w].data[12].w;
        r27.yz = refProbeConstantsCB[r6.w].data[13].xy;
        r9.w = dot(r15.xyz, r27.xyz);
        r10.w = dot(r16.yzw, r27.xyz);
        r10.w = -refProbeConstantsCB[r6.w].data[13].z + r10.w;
        r13.w = cmp(r10.w >= 0);
        ...
        r9.w = r10.w / r9.w;
        r8.w = min(abs(r9.w), r8.w);
        r27.x = refProbeConstantsCB[r6.w].data[3].w + r16.y;
        r27.yz = refProbeConstantsCB[r6.w].data[4].xy + r16.zw;
        r26.xzw = r15.xyz * r8.www + r27.xyz;
        r9.w = dot(r26.xzw, r26.xzw);
        r9.w = sqrt(r9.w);
        r8.w = r8.w / r9.w;
        r8.w = r8.w + r8.w;
        r8.w = sqrt(r8.w);
        r8.w = r2.w * 5 + r8.w;
        r8.w = -0.844799995 + r8.w;
        r27.x = refProbeConstantsCB[r6.w].data[0].w;
        r27.y = refProbeConstantsCB[r6.w].data[1].z;
        r27.z = refProbeConstantsCB[r6.w].data[2].y;
        r28.x = dot(r26.xzw, r27.xyz);
        r29.xy = refProbeConstantsCB[r6.w].data[1].xw;
        r29.z = refProbeConstantsCB[r6.w].data[2].z;
        r28.y = dot(r26.xzw, r29.xyz);
        r30.x = refProbeConstantsCB[r6.w].data[1].y;
        r30.yz = refProbeConstantsCB[r6.w].data[2].xw;
        r28.z = dot(r26.xzw, r30.xyz);
        if (9 == 0) r9.w = 0; else if (9+16 < 32) {         r9.w = (uint)refProbeConstantsCB[r6.w].data[7].z << (32-(9 + 16)); r9.w = (uint)r9.w >> (32-9);        } else r9.w = (uint)refProbeConstantsCB[r6.w].data[7].z >> 16;
        r28.w = (uint)r9.w;
        r26.xzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r28.xyzw, r8.w).xyz;
        r31.xyz = (int3)r26.xzw & int3(-2147483648,-2147483648,-2147483648);
        r31.xyz = cmp((int3)r31.xyz == int3(2139095040,2139095040,2139095040));
        r8.w = (int)r31.y | (int)r31.x;
        r8.w = (int)r31.z | (int)r8.w;
        r26.xzw = r8.www ? float3(1,1,0) : r26.xzw;
        r31.x = dot(r16.yzw, r27.xyz);
        r31.y = dot(r16.yzw, r29.xyz);
        r31.z = dot(r16.yzw, r30.xyz);
        r16.yzw = saturate(r31.xyz * refProbeConstantsCB[r6.w].data[3].xyz + float3(0.5,0.5,0.5));
        r31.xy = refProbeConstantsCB[r6.w].data[4].zw * r16.yz;
        r31.z = refProbeConstantsCB[r6.w].data[5].x * r16.w;
        r16.yzw = refProbeConstantsCB[r6.w].data[5].yzw + r31.xyz;
        ...
        r27.xyz = r6.www ? float3(1,1,0) : r27.xyz;
        r28.xyz = r27.xyz * r16.yzw;
        r6.w = dot(r28.xyz, float3(0.212599993,0.715200007,0.0722000003));
        r14.yzw = r16.yzw * r27.xyz + r14.yzw;
        r8.w = r6.w * r3.w;
        r16.yzw = r26.xzw * r7.www;
        r7.w = dot(r16.yzw, float3(0.212599993,0.715200007,0.0722000003));
        r6.w = r3.w * r6.w + r7.w;
        r6.w = r8.w / r6.w;
        r24.xyz = r16.yzw * r6.www + r24.xyz;
      } else {
        r25.x = r19.x;
        r19.xy = r25.xy;
      }
  ...
  switch (r4.z) {
    case 4 :    if (r2.z != 0) {
      r17.yzw = lightConstantsCB[r2.w].data[0].xyz + eyeOffset.xyz;
      r17.x = 2;
      GBufferDiffuseColor[viewID].112 = u2.xyzw;
    }
    r5.z = cmp(0 < lightConstantsCB[r2.w].data[6].y);
    r17.xy = lightConstantsCB[r2.w].data[5].zw;
    r17.z = lightConstantsCB[r2.w].data[6].x;
    r13.yzw = -r17.xyz * float3(0.5,0.5,0.5) + lightConstantsCB[r2.w].data[0].xyz;
    r18.xyz = r13.yzw + -r11.xyz;
    r6.w = dot(r17.xyz, r18.xyz);
    r7.w = saturate(-r6.w / lightConstantsCB[r2.w].data[6].y);
    r19.xyz = r7.www * r17.xyz + r13.yzw;
    r19.xyz = r5.zzz ? r19.xyz : lightConstantsCB[r2.w].data[0].xyz;
    ...
    if (r12.w != 0) {
      r12.w = sqrt(r8.w);
      r15.w = lightConstantsCB[r2.w].data[3].x * lightConstantsCB[r2.w].data[3].x;
      r8.w = r15.w / r8.w;
      r8.w = min(1, r8.w);
      r19.xy = saturate(r12.ww * lightConstantsCB[r2.w].data[2].xz + lightConstantsCB[r2.w].data[2].yw);
      ...
      if (r12.w != 0) {
        ...
        if (r12.w != 0) {
          ...
          r19.yzw = -lightConstantsCB[r2.w].data[4].yzw + r19.yzw;
          ...
          r16.w = 0x0000ffff & (int)lightConstantsCB[r2.w].data[1].w;
          r21.x = -r13.x;
          r22.w = (uint)r16.w;
          r21.y = r14.x;
          r21.z = r13.x;
          ...
          while (true) {
            ...
            r23.yz = lightConstantsCB[r2.w].data[3].yy * r20.yz;
            r23.x = r23.y * r20.x;
            r23.w = r23.y * r19.x;
        ...
        if (r12.w != 0) {
          ...
          r15.y = -r15.w * r15.w + lightConstantsCB[r2.w].data[6].y;
          ...
          r13.yzw = r6.www * r17.xyz + r13.yzw;
          r13.yzw = r5.zzz ? r13.yzw : lightConstantsCB[r2.w].data[0].xyz;
          r13.yzw = r13.yzw + -r11.xyz;
          r5.z = dot(r13.yzw, r13.yzw);
          r5.z = rsqrt(r5.z);
          r15.xyz = r13.yzw * r5.zzz;
          if (4 == 0) r6.w = 0; else if (4+16 < 32) {           r6.w = (uint)lightConstantsCB[r2.w].data[1].w << (32-(4 + 16)); r6.w = (uint)r6.w >> (32-4);          } else r6.w = (uint)lightConstantsCB[r2.w].data[1].w >> 16;
          ...
          if (r7.w != 0) {
            ...
            if (4 == 0) r6.w = 0; else if (4+20 < 32) {             r6.w = (uint)lightConstantsCB[r2.w].data[1].w << (32-(4 + 20)); r6.w = (uint)r6.w >> (32-4);            } else r6.w = (uint)lightConstantsCB[r2.w].data[1].w >> 20;
            r7.w = cmp(0 < (uint)r6.w);
            r15.w = ~(int)r3.x;
            r7.w = r7.w ? r15.w : 0;
            if (r7.w != 0) {
          ...
          r6.w = r6.w * r8.w;
          r17.x = lightConstantsCB[r2.w].data[0].w;
          r17.yz = lightConstantsCB[r2.w].data[1].xy;
          r7.w = cmp(0 < r9.w);
          r18.xyz = r6.www * r17.xyz + r3.yzw;
          r6.w = saturate(dot(r12.xyz, r15.xyz));
          r13.yzw = r13.yzw * r5.zzz + r5.xyw;
          r5.z = dot(r13.yzw, r13.yzw);
          r5.z = rsqrt(r5.z);
          r13.yzw = r13.yzw * r5.zzz;
          r5.z = dot(r13.yzw, r5.xyw);
          ...
          r6.w = r9.w * r6.w;
          r6.w = r6.w * r8.w;
          r13.yzw = r6.www * r17.xyz + r14.yzw;
          ...
          r14.yzw = r7.www ? r13.yzw : r14.yzw;
          if (r2.z != 0) {
          // Known bad code for instruction (needs manual fix):
    ...
    r5.z = rsqrt(r5.z);
    r13.yzw = r15.xyz * r5.zzz;
    r6.w = dot(r12.xyz, r13.yzw);
    r7.w = saturate(r6.w);
    r8.w = cmp(0 < r7.w);
    if (r8.w != 0) {
      r17.xyz = lightConstantsCB[r2.w].data[7].yzw;
      r17.w = lightConstantsCB[r2.w].data[8].x;
      r11.w = 1;
      ...
      if (r9.w != 0) {
        ...
        r18.xyz = lightConstantsCB[r2.w].data[0].xyz + -r11.xyz;
        r10.w = lightConstantsCB[r2.w].data[3].x * lightConstantsCB[r2.w].data[3].x;
        r12.w = dot(r18.xyz, r18.xyz);
        r10.w = r10.w / r12.w;
        r10.w = min(1, r10.w);
        r18.xy = saturate(r8.ww * lightConstantsCB[r2.w].data[2].xz + lightConstantsCB[r2.w].data[2].yw);
        r18.zw = r18.xy * r18.xy;
        r18.xy = r18.xy * float2(-2,-2) + float2(3,3);
        r18.xy = r18.zw * r18.xy;
        r10.w = r18.x * r10.w;
        r10.w = r10.w * r18.y;
        r18.xyz = lightConstantsCB[r2.w].data[4].yzw;
        r18.w = lightConstantsCB[r2.w].data[5].x;
        r18.x = dot(r18.xyzw, r11.xyzw);
        r19.xyz = lightConstantsCB[r2.w].data[5].yzw;
        r19.w = lightConstantsCB[r2.w].data[6].x;
        r18.y = dot(r19.xyzw, r11.xyzw);
        r18.xy = r18.xy / r8.ww;
        r8.w = cmp(lightConstantsCB[r2.w].data[10].w < 0.00048828125);
        if (r8.w != 0) {
          r19.xy = saturate(abs(r18.xy) * lightConstantsCB[r2.w].data[12].xy + lightConstantsCB[r2.w].data[12].zw);
          r19.zw = r19.xy * r19.xy;
          r19.xy = r19.xy * float2(-2,-2) + float2(3,3);
          r19.xy = r19.zw * r19.xy;
          r8.w = r19.x * r19.y;
        } else {
          r19.xyzw = saturate(lightConstantsCB[r2.w].data[11].xyzw * abs(r18.yyxx));
          r19.xyzw = log2(r19.xyzw);
          r19.xyzw = lightConstantsCB[r2.w].data[12].zzzz * r19.xyzw;
          r19.xyzw = exp2(r19.xyzw);
          r19.xy = r19.xy + r19.zw;
          r19.xy = log2(r19.xy);
          r19.xy = lightConstantsCB[r2.w].data[12].ww * r19.xy;
          r19.xy = exp2(r19.xy);
          r11.w = lightConstantsCB[r2.w].data[12].x * r19.x;
          r12.w = lightConstantsCB[r2.w].data[12].y * r19.y + -1;
          r11.w = lightConstantsCB[r2.w].data[12].y * r19.y + -r11.w;
        ...
        if (r8.w != 0) {
          r18.z = 1;
          r10.w = dot(lightConstantsCB[r2.w].data[13].xyz, r18.xyz);
          r19.x = lightConstantsCB[r2.w].data[13].w;
          r19.yz = lightConstantsCB[r2.w].data[14].xy;
      ...
      r18.x = lightConstantsCB[r2.w].data[0].w;
      r18.yz = lightConstantsCB[r2.w].data[1].xy;
      ...
      if (r8.w != 0) {
        ...
        if (r8.w != 0) {
          ...
          r19.xyz = lightConstantsCB[r2.w].data[6].yzw;
          r19.w = lightConstantsCB[r2.w].data[7].x;
          r18.w = 1;
          r8.w = dot(r19.xyzw, r18.xyzw);
          r10.w = dot(r17.xyzw, r18.xyzw);
          r11.w = cmp(r10.w >= r8.w);
          if (r11.w != 0) {
            r17.xyz = lightConstantsCB[r2.w].data[4].yzw;
            r17.w = lightConstantsCB[r2.w].data[5].x;
            ...
            r18.x = r17.x * lightConstantsCB[r2.w].data[8].y + lightConstantsCB[r2.w].data[8].z;
            r18.y = r17.y * lightConstantsCB[r2.w].data[8].w + lightConstantsCB[r2.w].data[9].x;
            r8.w = r8.w / r10.w;
            r8.w = max(6.10351563e-05, r8.w);
            r10.w = 0x0000ffff & (int)lightConstantsCB[r2.w].data[1].w;
            if (enableDitheredShadow != 0) {
              r17.x = -r13.x;
              r19.z = (uint)r10.w;
              r17.y = r14.x;
              ...
              while (true) {
                ...
                r19.xy = r20.xy * lightConstantsCB[r2.w].data[3].yy + r18.xy;
        ...
        if (r9.w != 0) {
          ...
          r9.w = r9.w * r7.w;
          if (4 == 0) r10.w = 0; else if (4+16 < 32) {           r10.w = (uint)lightConstantsCB[r2.w].data[1].w << (32-(4 + 16)); r10.w = (uint)r10.w >> (32-4);          } else r10.w = (uint)lightConstantsCB[r2.w].data[1].w >> 16;
          ...
          if (r11.w != 0) {
            ...
            if (r3.x != 0) {
              ...
              r18.xyz = lightConstantsCB[r2.w].data[6].yzw;
              r18.w = lightConstantsCB[r2.w].data[7].x;
              r17.w = 1;
              r3.x = dot(r18.xyzw, r17.xyzw);
              r18.xyz = lightConstantsCB[r2.w].data[7].yzw;
              r18.w = lightConstantsCB[r2.w].data[8].x;
              ...
              if (r11.w == 0) {
                ...
                r17.xy = r17.xy * float2(0.5,-0.5) + float2(0.5,0.5);
                r18.x = lightConstantsCB[r2.w].data[9].w + r17.x;
                r18.y = lightConstantsCB[r2.w].data[10].x + r17.y;
                r17.xy = lightConstantsCB[r2.w].data[9].yz * r18.xy;
                r17.zw = lightConstantsCB[r2.w].data[3].yy / lightConstantsCB[r2.w].data[8].yw;
                r18.xy = float2(1,1) + -r17.zw;
                r18.xy = cmp(r17.xy >= r18.xy);
                r17.zw = cmp(r17.zw >= r17.xy);
                r17.zw = (int2)r17.zw | (int2)r18.xy;
                ...
                if (r12.w == 0) {
                  ...
                  r18.x = r17.x * lightConstantsCB[r2.w].data[8].y + lightConstantsCB[r2.w].data[8].z;
                  r18.y = r17.y * lightConstantsCB[r2.w].data[8].w + lightConstantsCB[r2.w].data[9].x;
                  r15.w = lightConstantsCB[r2.w].data[10].z * r10.w;
                  r3.x = lightConstantsCB[r2.w].data[10].y * r10.w + r3.x;
                  r3.x = r3.x / r15.w;
                }
              } else {
                r12.w = -1;
          ...
          r1.w = r1.w * r8.w;
          r2.x = cmp(0 < r6.w);
          r17.xyz = r1.www * r13.yzw + r3.yzw;
          r15.xyz = r15.xyz * r5.zzz + r5.xyw;
          r1.w = dot(r15.xyz, r15.xyz);
          r1.w = rsqrt(r1.w);
          r15.xyz = r15.xyz * r1.www;
          r1.w = dot(r15.xyz, r5.xyw);
          r2.w = dot(r12.xyz, r15.xyz);
          r1.z = abs(r2.w) * r1.z + -abs(r2.w);
          r1.z = abs(r2.w) * r1.z + 1;
          r0.y = r7.w * r0.y + r2.y;
          r1.z = r1.z * r1.z;
          r0.y = r1.z * r0.y;
          r0.y = rcp(r0.y);
