...
r0.y = samplerLinear[]..swiz;
  ...
  switch (r7.w) {
    ...
    if (r16.w != 0) {
      ...
      r11.w = r17.w / r11.w;
      r11.w = min(1, r11.w);
      r18.xy = saturate(r16.ww * lightConstantsCB[r0.x].data[2].xz + lightConstantsCB[r0.x].data[2].yw);
      ...
      if (r16.w != 0) {
        ...
        if (r16.w != 0) {
          ...
          r19.y = 0x0000ffff & (int)lightConstantsCB[r0.x].data[1].w;
          r20.x = -r13.x;
          r21.w = (uint)r19.y;
          r20.y = r14.x;
          r20.z = r13.x;
          ...
          while (true) {
            ...
            if (r19.w != 0) break;
            r22.y = dot(icb[r19.z+0].yx, r20.xy);
            r22.z = dot(icb[r19.z+0].yx, r20.yz);
            r22.yz = lightConstantsCB[r0.x].data[3].yy * r22.yz;
            r22.x = r22.y * r19.x;
            r22.w = r22.y * r18.x;
            r21.xyz = r18.yzw * r17.www + r22.xzw;
            r19.w = gOmniShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r21.xyzw, r16.w).x;
            r19.y = r19.w * 0.125 + r19.y;
            r19.z = (int)r19.z + 1;
          }
        } else {
          r19.y = 1;
        ...
        r16.w = cmp(0 < r11.w);
        if (r16.w != 0) {
          r16.w = lightConstantsCB[r0.x].data[1].z * r0.w;
          r16.w = 0.25 * r16.w;
          r17.w = dot(r16.xyz, r15.xyz);
          r15.x = dot(r15.xyz, r17.xyz);
          ...
          r13.yzw = r9.www * r16.xyz + r13.yzw;
          r13.yzw = r8.www ? r13.yzw : lightConstantsCB[r0.x].data[0].xyz;
          r13.yzw = r13.yzw + -r5.xyz;
          r8.w = dot(r13.yzw, r13.yzw);
          r8.w = rsqrt(r8.w);
          r15.xyz = r13.yzw * r8.www;
          ...
          if (r10.w != 0) {
            ...
            r17.xyz = r11.xyz * r10.www + r5.xyz;
            r18.xyz = lightConstantsCB[r9.w].data[6].yzw;
            r18.w = lightConstantsCB[r9.w].data[7].x;
            r17.w = 1;
            r10.w = dot(r18.xyzw, r17.xyzw);
            r18.xyz = lightConstantsCB[r9.w].data[7].yzw;
            r18.w = lightConstantsCB[r9.w].data[8].x;
            r16.x = dot(r18.xyzw, r17.xyzw);
            r16.y = cmp(r16.x < r10.w);
            if (r16.y == 0) {
              r18.xyz = lightConstantsCB[r9.w].data[4].yzw;
              r18.w = lightConstantsCB[r9.w].data[5].x;
              r18.x = dot(r18.xyzw, r17.xyzw);
              r19.xyz = lightConstantsCB[r9.w].data[5].yzw;
              r19.w = lightConstantsCB[r9.w].data[6].x;
              r18.y = dot(r19.xyzw, r17.xyzw);
              r17.xy = r18.xy / r16.xx;
              r17.xy = r17.xy * float2(0.5,-0.5) + float2(0.5,0.5);
              r18.x = lightConstantsCB[r9.w].data[9].w + r17.x;
              r18.y = lightConstantsCB[r9.w].data[10].x + r17.y;
              r17.xy = lightConstantsCB[r9.w].data[9].yz * r18.xy;
              r17.zw = lightConstantsCB[r9.w].data[3].yy / lightConstantsCB[r9.w].data[8].yw;
              r18.xy = float2(1,1) + -r17.zw;
              r18.xy = cmp(r17.xy >= r18.xy);
              r17.zw = cmp(r17.zw >= r17.xy);
              r17.zw = (int2)r17.zw | (int2)r18.xy;
              r16.z = (int)r17.w | (int)r17.z;
              if (r16.z == 0) {
                r17.xy = saturate(r17.xy);
                r18.x = r17.x * lightConstantsCB[r9.w].data[8].y + lightConstantsCB[r9.w].data[8].z;
                r18.y = r17.y * lightConstantsCB[r9.w].data[8].w + lightConstantsCB[r9.w].data[9].x;
                r17.x = lightConstantsCB[r9.w].data[10].z * r16.x;
                r10.w = lightConstantsCB[r9.w].data[10].y * r16.x + r10.w;
                r10.w = r10.w / r17.x;
              }
            } else {
              r16.z = -1;
            }
            r16.x = (int)r16.y | (int)r16.z;
            if (r16.x == 0) {
              r10.w = max(6.10351563e-05, r10.w);
              r16.x = 0x0000ffff & (int)lightConstantsCB[r9.w].data[1].w;
              if (enableDitheredShadow != 0) {
                ...
                r16.yz = float2(0,0);
                while (true) {
                  r17.w = cmp((int)r16.z >= 8);
                  if (r17.w != 0) break;
                  r20.x = dot(icb[r16.z+0].yx, r17.xy);
                  r20.y = dot(icb[r16.z+0].yx, r17.yz);
                  r19.xy = r20.xy * lightConstantsCB[r9.w].data[3].yy + r18.xy;
                  r17.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r19.xyz, r10.w).x;
                  r16.y = r17.w * 0.125 + r16.y;
                  r16.z = (int)r16.z + 1;
                }
              } else {
                r18.z = (uint)r16.x;
                r16.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r18.xyz, r10.w).x;
              }
              r9.w = r16.y * r16.y;
              r9.w = r9.w * r16.y;
            } else {
          ...
          r9.w = r9.w + -r15.w;
          r9.w = r1.z * r9.w + r15.w;
          r9.w = r9.w * r11.w;
          r16.x = lightConstantsCB[r0.x].data[0].w;
          r16.yz = lightConstantsCB[r0.x].data[1].xy;
          r10.w = cmp(0 < r12.w);
          r17.xyz = r9.www * r16.xyz + r3.yzw;
          r9.w = saturate(dot(r11.xyz, r15.xyz));
          r13.yzw = r13.yzw * r8.www + r12.xyz;
          r8.w = dot(r13.yzw, r13.yzw);
          r8.w = rsqrt(r8.w);
          r13.yzw = r13.yzw * r8.www;
          r8.w = dot(r13.yzw, r12.xyz);
          r12.w = dot(r11.xyz, r13.yzw);
          r13.y = abs(r12.w) * r0.w + -abs(r12.w);
          r12.w = abs(r12.w) * r13.y + 1;
          r13.y = r9.w * r4.z + r6.w;
          r12.w = r12.w * r12.w;
          r12.w = r12.w * r13.y;
          r12.w = rcp(r12.w);
          r9.w = r9.w * r16.w;
          r9.w = r12.w * r9.w;
          r9.w = r9.w * r11.w;
          r13.yzw = r9.www * r16.xyz + r2.yzw;
          r8.w = saturate(1 + -r8.w);
          r12.w = r8.w * r8.w;
          r12.w = r12.w * r12.w;
          r8.w = r12.w * r8.w;
          r8.w = r9.w * r8.w;
          r15.xyz = r8.www * r16.xyz + r14.yzw;
          r3.yzw = r10.www ? r17.xyz : r3.yzw;
          r14.yzw = r10.www ? r15.xyz : r14.yzw;
          r2.yzw = r10.www ? r13.yzw : r2.yzw;
          if (r1.w != 0) {
          // Known bad code for instruction (needs manual fix):
    ...
    if (r11.w != 0) {
      ...
      r5.w = 1;
      r11.w = dot(r16.xyzw, r5.xyzw);
      r12.w = cmp(r11.w < 1);
      if (r12.w != 0) {
        r13.yzw = float3(1,1,1);
        r12.w = 0;
      } else {
        r17.xyz = lightConstantsCB[r0.x].data[0].xyz + -r5.xyz;
        r15.w = lightConstantsCB[r0.x].data[3].x * lightConstantsCB[r0.x].data[3].x;
        r17.x = dot(r17.xyz, r17.xyz);
        r15.w = r15.w / r17.x;
        r15.w = min(1, r15.w);
        r17.xy = saturate(r11.ww * lightConstantsCB[r0.x].data[2].xz + lightConstantsCB[r0.x].data[2].yw);
        ...
        if (r5.w != 0) {
          ...
          r18.xy = exp2(r18.xy);
          r11.w = lightConstantsCB[r0.x].data[12].x * r18.x;
          r17.w = lightConstantsCB[r0.x].data[12].y * r18.y + -1;
          r11.w = lightConstantsCB[r0.x].data[12].y * r18.y + -r11.w;
          r11.w = saturate(r17.w / r11.w);
          r17.w = r11.w * r11.w;
          r11.w = r11.w * -2 + 3;
          r5.w = r17.w * r11.w;
        }
        ...
        if (r5.w != 0) {
          r17.z = 1;
          r11.w = dot(lightConstantsCB[r0.x].data[13].xyz, r17.xyz);
          r18.x = lightConstantsCB[r0.x].data[13].w;
          r18.yz = lightConstantsCB[r0.x].data[14].xy;
          r15.w = dot(r18.xyz, r17.xyz);
          r17.x = frac(r11.w);
          r17.y = frac(r15.w);
          r5.w = (int)r5.w + -1;
          r17.z = (uint)r5.w;
      ...
      if (r5.w != 0) {
          ...
          if (r15.w != 0) {
            ...
            if (enableDitheredShadow != 0) {
              ...
              while (true) {
                ...
                r17.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r18.xyz, r5.w).x;
                r15.w = r17.w * 0.125 + r15.w;
                r16.w = (int)r16.w + 1;
              }
            } else {
              r17.z = (uint)r11.w;
              r15.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r17.xyz, r5.w).x;
            }
            r5.w = r15.w * r15.w;
            r5.w = r5.w * r15.w;
          } else {
        ...
        r11.w = cmp(0 < r5.w);
        if (r11.w != 0) {
          r11.w = lightConstantsCB[r0.x].data[1].z * r0.w;
          r11.w = r11.w * r10.w;
          ...
          if (r15.w != 0) {
            ...
            r16.xyz = r11.xyz * r15.www + r5.xyz;
            r17.xyz = lightConstantsCB[r12.w].data[6].yzw;
            r17.w = lightConstantsCB[r12.w].data[7].x;
            r16.w = 1;
            r15.w = dot(r17.xyzw, r16.xyzw);
            r17.xyz = lightConstantsCB[r12.w].data[7].yzw;
            r17.w = lightConstantsCB[r12.w].data[8].x;
            r17.x = dot(r17.xyzw, r16.xyzw);
            r17.y = cmp(r17.x < r15.w);
            if (r17.y == 0) {
              r18.xyz = lightConstantsCB[r12.w].data[4].yzw;
              r18.w = lightConstantsCB[r12.w].data[5].x;
              r18.x = dot(r18.xyzw, r16.xyzw);
              r19.xyz = lightConstantsCB[r12.w].data[5].yzw;
              r19.w = lightConstantsCB[r12.w].data[6].x;
              r18.y = dot(r19.xyzw, r16.xyzw);
              r16.xy = r18.xy / r17.xx;
              r16.xy = r16.xy * float2(0.5,-0.5) + float2(0.5,0.5);
              r18.x = lightConstantsCB[r12.w].data[9].w + r16.x;
              r18.y = lightConstantsCB[r12.w].data[10].x + r16.y;
              r16.xy = lightConstantsCB[r12.w].data[9].yz * r18.xy;
              r16.zw = lightConstantsCB[r12.w].data[3].yy / lightConstantsCB[r12.w].data[8].yw;
              r17.zw = float2(1,1) + -r16.zw;
              r17.zw = cmp(r16.xy >= r17.zw);
              r16.zw = cmp(r16.zw >= r16.xy);
              r16.zw = (int2)r16.zw | (int2)r17.zw;
              r16.z = (int)r16.w | (int)r16.z;
              if (r16.z == 0) {
                r16.xy = saturate(r16.xy);
                r18.x = r16.x * lightConstantsCB[r12.w].data[8].y + lightConstantsCB[r12.w].data[8].z;
                r18.y = r16.y * lightConstantsCB[r12.w].data[8].w + lightConstantsCB[r12.w].data[9].x;
                r16.x = lightConstantsCB[r12.w].data[10].z * r17.x;
                r15.w = lightConstantsCB[r12.w].data[10].y * r17.x + r15.w;
                r15.w = r15.w / r16.x;
              }
            } else {
              r16.z = -1;
            }
            r16.x = (int)r17.y | (int)r16.z;
            if (r16.x == 0) {
              r15.w = max(6.10351563e-05, r15.w);
              r16.x = 0x0000ffff & (int)lightConstantsCB[r12.w].data[1].w;
              if (enableDitheredShadow != 0) {
                r17.x = -r13.x;
                r19.z = (uint)r16.x;
                r17.y = r14.x;
                ...
                while (true) {
                  ...
                  r20.x = dot(icb[r16.z+0].yx, r17.xy);
                  r20.y = dot(icb[r16.z+0].yx, r17.yz);
                  r19.xy = r20.xy * lightConstantsCB[r12.w].data[3].yy + r18.xy;
                  r16.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r19.xyz, r15.w).x;
                  r16.y = r16.w * 0.125 + r16.y;
                  r16.z = (int)r16.z + 1;
                }
              } else {
                r18.z = (uint)r16.x;
                r16.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r18.xyz, r15.w).x;
              }
              r12.w = r16.y * r16.y;
              r12.w = r12.w * r16.y;
            } else {
            ...
            if (r3.x != 0) {
              ...
              if (r15.w == 0) {
                ...
                if (r16.z == 0) {
                  ...
                  r17.x = r16.x * lightConstantsCB[r0.x].data[8].y + lightConstantsCB[r0.x].data[8].z;
                  r17.y = r16.y * lightConstantsCB[r0.x].data[8].w + lightConstantsCB[r0.x].data[9].x;
                  r16.x = lightConstantsCB[r0.x].data[10].z * r12.w;
              ...
              if (r12.w == 0) {
                ...
                if (enableDitheredShadow != 0) {
                  ...
                  while (true) {
                    ...
                    if (r15.w != 0) break;
                    r19.x = dot(icb[r14.x+0].yx, r16.xy);
                    r19.y = dot(icb[r14.x+0].yx, r16.yz);
                    r18.xy = r19.xy * lightConstantsCB[r0.x].data[3].yy + r17.xy;
                    r15.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r18.xyz, r3.x).x;
                    r13.x = r15.w * 0.125 + r13.x;
                    r14.x = (int)r14.x + 1;
                  }
                } else {
                  r17.z = (uint)r12.w;
                  r13.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r17.xyz, r3.x).x;
                }
                r0.x = r13.x * r13.x;
                r0.x = r0.x * r13.x;
              } else {
          ...
          r0.w = r5.w * r0.w;
          r0.w = 0.25 * r0.w;
          r11.xyz = r0.www * r13.yzw + r2.yzw;
          r0.x = saturate(1 + -r0.x);
          r2.x = r0.x * r0.x;
          r2.x = r2.x * r2.x;
          r0.x = r2.x * r0.x;
          r0.x = r0.w * r0.x;
          r12.xyz = r0.xxx * r13.yzw + r14.yzw;
          r3.yzw = r1.zzz ? r16.xyz : r3.yzw;
          r14.yzw = r1.zzz ? r12.xyz : r14.yzw;
  ...
  r8.xyz = r8.zxy * float3(3,1,2) + float3(0.5,0,-1);
  r0.w = (uint)r8.x;
  r0.w = cmp((int)r0.x == (int)r0.w);
  r8.xy = r0.ww ? r8.yz : float2(-1,0);
  r9.xyz = r9.zxy * float3(3,1,2) + float3(0.5,0,-1);
  r0.w = (uint)r9.x;
  r0.w = cmp((int)r0.x == (int)r0.w);
  r8.zw = r0.ww ? r9.yz : float2(-1,0);
  r9.xyz = r10.zxy * float3(3,1,2) + float3(0.5,0,-1);
  r0.w = (uint)r9.x;
  r0.x = cmp((int)r0.x == (int)r0.w);
  r0.xw = r0.xx ? r9.yz : float2(-1,0);
  r9.x = r7.x;
  r9.yz = r8.xz;
  r9.w = r0.x;
  ...
  r7.z = -r4.y * 0.5 + r0.x;
  r7.x = r7.z + r4.y;
  r4.xyz = float3(1,1,1) + -r7.xyz;
  r4.xyz = r14.yzw * r4.xyz;
  r2.xyz = r2.yzw * r7.xyz + r4.xyz;
