...
// unknown dcl_: dcl_thread_group 8, 8, 1
  r0.x = mad(permuteStride, 9, (int)vThreadGroupID.x);
...
r0.y = samp0[]..swiz;
  ...
  if (r10.w != 0) {
    ...
    r16.x = dot(refProbeAttenuationConstantsCB[r14.z].data[1].xyz, r13.yzw);
    r16.x = saturate(refProbeAttenuationConstantsCB[r14.z].data[1].w + r16.x);
    r14.w = r16.x * r14.w;
    r16.x = dot(refProbeAttenuationConstantsCB[r14.z].data[2].xyz, r13.yzw);
    r16.x = saturate(refProbeAttenuationConstantsCB[r14.z].data[2].w + r16.x);
    r14.w = r16.x * r14.w;
    r16.x = dot(refProbeAttenuationConstantsCB[r14.z].data[3].xyz, r13.yzw);
    r16.x = saturate(refProbeAttenuationConstantsCB[r14.z].data[3].w + r16.x);
    r14.w = r16.x * r14.w;
    r16.x = dot(refProbeAttenuationConstantsCB[r14.z].data[4].xyz, r13.yzw);
    r16.x = saturate(refProbeAttenuationConstantsCB[r14.z].data[4].w + r16.x);
    r14.w = r16.x * r14.w;
    r16.x = dot(refProbeAttenuationConstantsCB[r14.z].data[5].xyz, r13.yzw);
    r14.z = saturate(refProbeAttenuationConstantsCB[r14.z].data[5].w + r16.x);
    r16.x = r14.w * r14.z;
    r14.z = 1 & (int)refProbeConstantsCB[r10.w].data[6].x;
    r16.yz = float2(0,1);
    r14.zw = r14.zz ? r16.xy : r16.zx;
    r16.x = 1;
    r16.z = refProbeConstantsCB[r10.w].data[6].x;
    r17.xy = r14.zw;
    r16.w = 1;
    while (true) {
      r17.z = cmp((int)r16.w >= (int)r14.y);
      if (r17.z != 0) break;
    ...
    r12.w = refProbeConstantsCB[r10.w].data[6].y * r17.y;
    r14.y = cmp(0 < r12.w);
    if (r14.y != 0) {
      r14.y = refProbeConstantsCB[r10.w].data[7].y * r12.w;
      r16.x = refProbeConstantsCB[r10.w].data[7].w;
      r16.yz = refProbeConstantsCB[r10.w].data[8].xy;
      r14.z = dot(r15.xyz, r16.xyz);
      r14.w = dot(r13.yzw, r16.xyz);
      r14.w = -refProbeConstantsCB[r10.w].data[8].z + r14.w;
      r16.x = cmp(r14.w >= 0);
      r14.w = max(abs(r14.w), r9.y);
      ...
      r16.xyz = r15.xyz * r14.zzz + r16.xyz;
      ...
      r18.w = (uint)r14.w;
      r16.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r18.xyzw, r14.z).xyz;
      ...
      r10.w = r9.z * r10.w + r14.y;
      r10.w = r14.z / r10.w;
      r14.yzw = r16.xyz * r10.www;
    } else {
  ...
  if (r10.w != 0) {
    ...
    if (r9.w != 0) {
      ...
      r17.x = r17.x * r16.w;
      r16.w = 1 & (int)refProbeConstantsCB[r0.y].data[6].x;
      r17.yz = float2(0,1);
      r17.xy = r16.ww ? r17.xy : r17.zx;
      r18.x = 1;
      r16.w = refProbeConstantsCB[r0.y].data[6].x;
      r19.xy = r17.xy;
      r17.z = 1;
      while (true) {
      ...
      if (r16.w != 0) {
        ...
        r16.w = -refProbeConstantsCB[r0.y].data[8].z + r16.w;
        r17.x = cmp(r16.w >= 0);
        ...
        r17.y = cmp(r17.x >= 0);
        r9.y = max(abs(r17.x), r9.y);
        r9.y = r17.y ? r9.y : -r9.y;
        r16.w = max(1.00000001e-07, -r16.w);
        r9.y = r9.y / r16.w;
        r9.y = min(r10.w, abs(r9.y));
        r17.x = refProbeConstantsCB[r0.y].data[3].w + r16.x;
        r17.yz = refProbeConstantsCB[r0.y].data[4].xy + r16.yz;
        r17.xyz = r15.xyz * r9.yyy + r17.xyz;
        ...
        if (9 == 0) r9.y = 0; else if (9+16 < 32) {         r9.y = (uint)refProbeConstantsCB[r0.y].data[7].z << (32-(9 + 16)); r9.y = (uint)r9.y >> (32-9);        } else r9.y = (uint)refProbeConstantsCB[r0.y].data[7].z >> 16;
        r19.w = (uint)r9.y;
        r17.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r19.xyzw, r7.w).xyz;
        ...
        r9.y = dot(r16.xyz, float3(0.212599993,0.715200007,0.0722000003));
        r0.y = r9.z * r0.y + r9.y;
        r0.y = r7.w / r0.y;
  ...
  r9.yzw = r13.yzw * r0.yyy;
  r14.yzw = r14.yzw * r0.yyy;
  r7.w = cmp(r12.w < 0.99000001);
  if (r7.w != 0) {
    r7.w = 1 + -r12.w;
    ...
    r9.yzw = r13.yzw * r0.yyy + r16.xyz;
    r15.w = 0;
    r13.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r15.xyzw, r9.x).xyz;
  ...
  r13.yzw = r9.yzw * r2.www;
  r15.xyz = r0.zzz ? r13.yzw : 0;
  ...
  r14.yzw = r14.yzw * r0.yyy;
  r16.xzw = r14.yzw * r16.xxx;
  r14.yzw = r14.yzw * r16.yyy;
  r0.y = cmp(0 < r6.w);
  if (r0.y != 0) {
    r0.y = cmp(0 < r8.w);
    if (r0.y != 0) {
