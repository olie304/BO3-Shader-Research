...
r0.y = samplerLinear[]..swiz;
  ...
  if (r6.w != 0) {
    r6.w = (int)r0.y * 14;
    r15.yzw = -refProbeConstantsCB[r6.w].data[0].xyz + r11.xyz;
    ...
    r9.w = (int)r7.w * 6;
    r13.z = dot(refProbeAttenuationConstantsCB[r9.w].data[0].xyz, r15.yzw);
    r13.z = saturate(refProbeAttenuationConstantsCB[r9.w].data[0].w + r13.z);
    r13.w = dot(refProbeAttenuationConstantsCB[r9.w].data[1].xyz, r15.yzw);
    r13.w = saturate(refProbeAttenuationConstantsCB[r9.w].data[1].w + r13.w);
    r13.z = r13.z * r13.w;
    r13.w = dot(refProbeAttenuationConstantsCB[r9.w].data[2].xyz, r15.yzw);
    r13.w = saturate(refProbeAttenuationConstantsCB[r9.w].data[2].w + r13.w);
    r13.z = r13.z * r13.w;
    r13.w = dot(refProbeAttenuationConstantsCB[r9.w].data[3].xyz, r15.yzw);
    r13.w = saturate(refProbeAttenuationConstantsCB[r9.w].data[3].w + r13.w);
    r13.z = r13.z * r13.w;
    r13.w = dot(refProbeAttenuationConstantsCB[r9.w].data[4].xyz, r15.yzw);
    r13.w = saturate(refProbeAttenuationConstantsCB[r9.w].data[4].w + r13.w);
    r13.z = r13.z * r13.w;
    r13.w = dot(refProbeAttenuationConstantsCB[r9.w].data[5].xyz, r15.yzw);
    r9.w = saturate(refProbeAttenuationConstantsCB[r9.w].data[5].w + r13.w);
    r18.x = r13.z * r9.w;
    r9.w = 1 & (int)refProbeConstantsCB[r6.w].data[6].x;
    r18.yz = float2(0,1);
    r13.zw = r9.ww ? r18.xy : r18.zx;
    r18.x = 1;
    r9.w = refProbeConstantsCB[r6.w].data[6].x;
    r19.xy = r13.zw;
    r14.w = 1;
    while (true) {
      r16.y = cmp((int)r14.w >= (int)r8.w);
      if (r16.y != 0) break;
      r16.y = (int)r7.w + (int)r14.w;
      r16.y = (int)r16.y * 6;
      ...
      r19.x = r16.z * r16.y;
      r16.w = (uint)r9.w >> 2;
      if (1 == 0) r18.z = 0; else if (1+2 < 32) {       r18.z = (uint)r9.w << (32-(1 + 2)); r18.z = (uint)r18.z >> (32-1);      } else r18.z = (uint)r9.w >> 2;
      r18.w = (int)r16.w & 2;
      r19.z = max(r19.y, r19.x);
      r16.y = -r16.z * r16.y + 1;
      r16.y = r19.y * r16.y;
      r18.y = r18.w ? r16.y : r19.z;
      r19.xy = r18.zz ? r19.xy : r18.xy;
      r14.w = (int)r14.w + 1;
      r9.w = r16.w;
    }
    r19.y = saturate(r19.y);
    r7.w = refProbeConstantsCB[r6.w].data[6].y * r19.y;
    r8.w = cmp(0 < r7.w);
    if (r8.w != 0) {
      r8.w = refProbeConstantsCB[r6.w].data[7].y * r7.w;
      r18.x = refProbeConstantsCB[r6.w].data[7].w;
      r18.yz = refProbeConstantsCB[r6.w].data[8].xy;
      r9.w = dot(r17.xyz, r18.xyz);
      r13.z = dot(r15.yzw, r18.xyz);
      r13.z = -refProbeConstantsCB[r6.w].data[8].z + r13.z;
      r13.w = cmp(r13.z >= 0);
      ...
      r18.x = refProbeConstantsCB[r6.w].data[8].w;
      r18.yz = refProbeConstantsCB[r6.w].data[9].xy;
      r13.z = dot(r17.xyz, r18.xyz);
      r13.w = dot(r15.yzw, r18.xyz);
      r13.w = -refProbeConstantsCB[r6.w].data[9].z + r13.w;
      r14.w = cmp(r13.w >= 0);
      r13.w = max(abs(r13.w), r3.z);
      r13.w = r14.w ? r13.w : -r13.w;
      r13.z = max(1.00000001e-07, -r13.z);
      r13.z = r13.w / r13.z;
      r9.w = min(abs(r13.z), r9.w);
      r18.x = refProbeConstantsCB[r6.w].data[9].w;
      r18.yz = refProbeConstantsCB[r6.w].data[10].xy;
      r13.z = dot(r17.xyz, r18.xyz);
      r13.w = dot(r15.yzw, r18.xyz);
      r13.w = -refProbeConstantsCB[r6.w].data[10].z + r13.w;
      r14.w = cmp(r13.w >= 0);
      r13.w = max(abs(r13.w), r3.z);
      r13.w = r14.w ? r13.w : -r13.w;
      r13.z = max(1.00000001e-07, -r13.z);
      r13.z = r13.w / r13.z;
      r9.w = min(abs(r13.z), r9.w);
      r18.x = refProbeConstantsCB[r6.w].data[10].w;
      r18.yz = refProbeConstantsCB[r6.w].data[11].xy;
      r13.z = dot(r17.xyz, r18.xyz);
      r13.w = dot(r15.yzw, r18.xyz);
      r13.w = -refProbeConstantsCB[r6.w].data[11].z + r13.w;
      r14.w = cmp(r13.w >= 0);
      r13.w = max(abs(r13.w), r3.z);
      r13.w = r14.w ? r13.w : -r13.w;
      r13.z = max(1.00000001e-07, -r13.z);
      r13.z = r13.w / r13.z;
      r9.w = min(abs(r13.z), r9.w);
      r18.x = refProbeConstantsCB[r6.w].data[11].w;
      r18.yz = refProbeConstantsCB[r6.w].data[12].xy;
      r13.z = dot(r17.xyz, r18.xyz);
      r13.w = dot(r15.yzw, r18.xyz);
      r13.w = -refProbeConstantsCB[r6.w].data[12].z + r13.w;
      r14.w = cmp(r13.w >= 0);
      r13.w = max(abs(r13.w), r3.z);
      r13.w = r14.w ? r13.w : -r13.w;
      r13.z = max(1.00000001e-07, -r13.z);
      r13.z = r13.w / r13.z;
      r9.w = min(abs(r13.z), r9.w);
      r18.x = refProbeConstantsCB[r6.w].data[12].w;
      r18.yz = refProbeConstantsCB[r6.w].data[13].xy;
      r13.z = dot(r17.xyz, r18.xyz);
      r13.w = dot(r15.yzw, r18.xyz);
      r13.w = -refProbeConstantsCB[r6.w].data[13].z + r13.w;
      r14.w = cmp(r13.w >= 0);
      r13.w = max(abs(r13.w), r3.z);
      r13.w = r14.w ? r13.w : -r13.w;
      r13.z = max(1.00000001e-07, -r13.z);
      r13.z = r13.w / r13.z;
      r9.w = min(abs(r13.z), r9.w);
      r18.x = refProbeConstantsCB[r6.w].data[3].w + r15.y;
      r18.yz = refProbeConstantsCB[r6.w].data[4].xy + r15.zw;
      ...
      r18.x = refProbeConstantsCB[r6.w].data[0].w;
      r18.y = refProbeConstantsCB[r6.w].data[1].z;
      r18.z = refProbeConstantsCB[r6.w].data[2].y;
      r19.x = dot(r16.yzw, r18.xyz);
      r20.xy = refProbeConstantsCB[r6.w].data[1].xw;
      r20.z = refProbeConstantsCB[r6.w].data[2].z;
      r19.y = dot(r16.yzw, r20.xyz);
      r21.x = refProbeConstantsCB[r6.w].data[1].y;
      r21.yz = refProbeConstantsCB[r6.w].data[2].xw;
      r19.z = dot(r16.yzw, r21.xyz);
      if (9 == 0) r13.z = 0; else if (9+16 < 32) {       r13.z = (uint)refProbeConstantsCB[r6.w].data[7].z << (32-(9 + 16)); r13.z = (uint)r13.z >> (32-9);      } else r13.z = (uint)refProbeConstantsCB[r6.w].data[7].z >> 16;
      r19.w = (uint)r13.z;
      ...
      r15.yzw = saturate(r22.xyz * refProbeConstantsCB[r6.w].data[3].xyz + float3(0.5,0.5,0.5));
      r22.xy = refProbeConstantsCB[r6.w].data[4].zw * r15.yz;
      r22.z = refProbeConstantsCB[r6.w].data[5].x * r15.w;
      r15.yzw = refProbeConstantsCB[r6.w].data[5].yzw + r22.xyz;
  ...
  if (r6.w != 0) {
    ...
    if (r4.w != 0) {
      ...
      r8.w = (int)r4.w * 6;
      r9.w = dot(refProbeAttenuationConstantsCB[r8.w].data[0].xyz, r18.xyz);
      r9.w = saturate(refProbeAttenuationConstantsCB[r8.w].data[0].w + r9.w);
      r13.z = dot(refProbeAttenuationConstantsCB[r8.w].data[1].xyz, r18.xyz);
      r13.z = saturate(refProbeAttenuationConstantsCB[r8.w].data[1].w + r13.z);
      r9.w = r13.z * r9.w;
      r13.z = dot(refProbeAttenuationConstantsCB[r8.w].data[2].xyz, r18.xyz);
      r13.z = saturate(refProbeAttenuationConstantsCB[r8.w].data[2].w + r13.z);
      r9.w = r13.z * r9.w;
      r13.z = dot(refProbeAttenuationConstantsCB[r8.w].data[3].xyz, r18.xyz);
      r13.z = saturate(refProbeAttenuationConstantsCB[r8.w].data[3].w + r13.z);
      r9.w = r13.z * r9.w;
      r13.z = dot(refProbeAttenuationConstantsCB[r8.w].data[4].xyz, r18.xyz);
      r13.z = saturate(refProbeAttenuationConstantsCB[r8.w].data[4].w + r13.z);
      r9.w = r13.z * r9.w;
      r13.z = dot(refProbeAttenuationConstantsCB[r8.w].data[5].xyz, r18.xyz);
      r8.w = saturate(refProbeAttenuationConstantsCB[r8.w].data[5].w + r13.z);
      r19.x = r9.w * r8.w;
      r8.w = 1 & (int)refProbeConstantsCB[r0.y].data[6].x;
      r19.yz = float2(0,1);
      r13.zw = r8.ww ? r19.xy : r19.zx;
      r19.x = 1;
      r8.w = refProbeConstantsCB[r0.y].data[6].x;
      r20.xy = r13.zw;
      r9.w = 1;
      while (true) {
        r14.w = cmp((int)r9.w >= (int)r6.w);
        if (r14.w != 0) break;
        r14.w = (int)r4.w + (int)r9.w;
        r14.w = (int)r14.w * 6;
