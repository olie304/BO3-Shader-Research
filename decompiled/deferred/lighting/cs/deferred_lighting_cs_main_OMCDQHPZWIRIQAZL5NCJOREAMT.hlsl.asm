...
loop 
  ...
  if_nz r19.w
    ...
    dp3 r26.x, cb11[r22.w + 0].xyzx, r17.yzwy
    add_sat r26.x, r26.x, cb11[r22.w + 0].w
    dp3 r26.y, cb11[r22.w + 1].xyzx, r17.yzwy
    add_sat r26.y, r26.y, cb11[r22.w + 1].w
    mul r26.x, r26.y, r26.x
    dp3 r26.y, cb11[r22.w + 2].xyzx, r17.yzwy
    add_sat r26.y, r26.y, cb11[r22.w + 2].w
    mul r26.x, r26.y, r26.x
    dp3 r26.y, cb11[r22.w + 3].xyzx, r17.yzwy
    add_sat r26.y, r26.y, cb11[r22.w + 3].w
    mul r26.x, r26.y, r26.x
    dp3 r26.y, cb11[r22.w + 4].xyzx, r17.yzwy
    add_sat r26.y, r26.y, cb11[r22.w + 4].w
    mul r26.x, r26.y, r26.x
    dp3 r26.y, cb11[r22.w + 5].xyzx, r17.yzwy
    add_sat r22.w, r26.y, cb11[r22.w + 5].w
    mul r18.x, r22.w, r26.x
    ...
    mov r22.w, l(1)
    loop 
      ige r26.z, r22.w, r21.w
      breakc_nz r26.z
      iadd r26.z, r19.w, r22.w
      imul null, r26.z, r26.z, l(6)
      dp3 r26.w, cb11[r26.z + 0].xyzx, r17.yzwy
      add_sat r26.w, r26.w, cb11[r26.z + 0].w
      mul r26.w, r26.w, r27.x
      dp3 r27.z, cb11[r26.z + 1].xyzx, r17.yzwy
      add_sat r27.z, r27.z, cb11[r26.z + 1].w
      mul r26.w, r26.w, r27.z
      dp3 r27.z, cb11[r26.z + 2].xyzx, r17.yzwy
      add_sat r27.z, r27.z, cb11[r26.z + 2].w
      mul r26.w, r26.w, r27.z
      dp3 r27.z, cb11[r26.z + 3].xyzx, r17.yzwy
      add_sat r27.z, r27.z, cb11[r26.z + 3].w
      mul r26.w, r26.w, r27.z
      dp3 r27.z, cb11[r26.z + 4].xyzx, r17.yzwy
      add_sat r27.z, r27.z, cb11[r26.z + 4].w
      mul r26.w, r26.w, r27.z
      dp3 r27.z, cb11[r26.z + 5].xyzx, r17.yzwy
      ...
      movc r20.y, r28.x, r26.z, r28.y
      movc r27.xy, r27.wwww, r27.xyxx, r20.xyxx
      iadd r22.w, r22.w, l(1)
      mov r18.x, r27.z
    endloop 
    mov_sat r27.y, r27.y
    mul r18.x, r27.y, cb10[r18.w + 6].y
    lt r19.w, l(0.000000), r18.x
    if_nz r19.w
      and r19.w, r25.w, l(7)
      iadd r20.y, r19.w, l(-1)
      ult r20.y, r20.y, l(32)
      and r20.y, r3.z, r20.y
      if_nz r20.y
        imad r26.xy, r19.wwww, l(20, 20, 0, 0), l(860, 876, 0, 0)
        ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r19.w, cb2[52].x, r26.x, u2.xxxx
        or r19.w, r19.w, l(32)
        store_structured u2.x, cb2[52].x, r26.x, r19.w
        store_structured u2.x, cb2[52].x, r26.y, r18.x
      endif 
      iadd r24.w, r24.w, l(257)
      mad r24.z, r27.y, cb10[r18.w + 6].y, r24.z
...
loop 
  ...
  if_nz r19.w
    ...
    and r22.w, l(1), cb10[r18.w + 6].x
    movc r27.zw, r22.wwww, r18.xxxy, r18.zzzx
    mov r18.x, cb10[r18.w + 6].x
    mov r28.xy, r27.zwzz
    mov r22.w, l(1)
    loop 
      ...
      dp3 r28.z, cb11[r25.w + 1].xyzx, r17.yzwy
      add_sat r28.z, r28.z, cb11[r25.w + 1].w
      mul r26.w, r26.w, r28.z
      dp3 r28.z, cb11[r25.w + 2].xyzx, r17.yzwy
      add_sat r28.z, r28.z, cb11[r25.w + 2].w
      mul r26.w, r26.w, r28.z
      dp3 r28.z, cb11[r25.w + 3].xyzx, r17.yzwy
      add_sat r28.z, r28.z, cb11[r25.w + 3].w
      mul r26.w, r26.w, r28.z
      dp3 r28.z, cb11[r25.w + 4].xyzx, r17.yzwy
      add_sat r28.z, r28.z, cb11[r25.w + 4].w
      mul r26.w, r26.w, r28.z
      dp3 r28.z, cb11[r25.w + 5].xyzx, r17.yzwy
      add_sat r25.w, r28.z, cb11[r25.w + 5].w
      ...
      movc r20.w, r29.x, r25.w, r29.y
      movc r28.xy, r28.wwww, r28.xyxx, r20.zwzz
      iadd r22.w, r22.w, l(1)
      mov r18.x, r28.z
    endloop 
    ...
    if_nz r20.w
      and r20.w, r27.y, l(31)
      iadd r21.w, r20.w, l(-1)
      ult r21.w, r21.w, l(32)
      and r21.w, r3.z, r21.w
      if_nz r21.w
        imad r27.zw, r20.wwww, l(0, 0, 20, 20), l(0, 0, 860, 876)
        ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r20.w, cb2[52].x, r27.z, u2.xxxx
        or r20.w, r20.w, l(32)
        store_structured u2.x, cb2[52].x, r27.z, r20.w
        store_structured u2.x, cb2[52].x, r27.w, r19.w
      endif 
      ...
      div r20.w, r21.w, r20.w
      min r19.w, r19.w, |r20.w|
      add r29.x, r17.y, cb10[r18.w + 3].w
      add r29.yz, r17.zzwz, cb10[r18.w + 4].xxyx
      mad r28.xzw, r16.xxyz, r19.wwww, r29.xxyz
      dp3 r20.w, r28.xzwx, r28.xzwx
      sqrt r20.w, r20.w
      ...
      utof r30.w, r20.w
      sample_l_indexable(texturecubearray)(float,float,float,float) r28.xzw, r30.xyzw, t8.xwyz, s2, r19.w
      and r33.xyz, r28.xzwx, l(0x7fffffff, 0x7fffffff, 0x7fffffff, 0)
      ieq r33.xyz, r33.xyzx, l(0x7f800000, 0x7f800000, 0x7f800000, 0)
      or r19.w, r33.y, r33.x
      or r19.w, r33.z, r19.w
      movc r28.xzw, r19.wwww, l(1.000000,0,1.000000,0), r28.xxzw
      ...
      mad r17.z, r13.w, r18.w, r17.z
      div r17.y, r17.y, r17.z
      mad r26.xyz, r28.xzwx, r17.yyyy, r26.xyzx
    else 
      mov r27.x, r20.x
      mov r20.xy, r27.xyxx
    endif 
...
if_nz r10.w
  ...
  mad r15.yzw, r25.xxyz, r7.wwww, r18.xxyz
  mov r16.w, l(0)
...
ret 
// Approximately 2561 instruction slots used
