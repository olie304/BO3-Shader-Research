...
mov r15.w, l(0)
sample_l_indexable(texturecubearray)(float,float,float,float) r14.yzw, r15.xyzw, t8.wxyz, s2, r5.w
...
switch r2.z
  ...
  movc r21.xyz, r2.zzzz, r21.xyzx, cb9[r0.x + 0].xyzx
  ...
  if_nz r8.w
    ...
    if_nz r8.w
      ...
      if_nz r8.w
        ...
        movc r15.xyz, r2.zzzz, r15.xyzx, cb9[r0.x + 0].xyzx
        add r15.xyz, -r10.xyzx, r15.xyzx
        dp3 r2.z, r15.xyzx, r15.xyzx
        rsq r2.z, r2.z
        mul r18.xyz, r2.zzzz, r15.xyzx
        ...
        mad r15.xyz, r15.xyzx, r2.zzzz, r12.xyzx
        dp3 r2.z, r15.xyzx, r15.xyzx
        rsq r2.z, r2.z
        mul r15.xyz, r2.zzzz, r15.xyzx
        dp3 r2.z, r15.xyzx, r12.xyzx
        ...
        mul r6.w, r6.w, r7.w
        mul r5.w, r5.w, r6.w
        mad r15.xyz, r5.wwww, r19.xyzx, r9.xyzx
        add_sat r2.z, -r2.z, l(1.000000)
        mul r6.w, r2.z, r2.z
        mul r6.w, r6.w, r6.w
        mul r2.z, r2.z, r6.w
        mul r2.z, r2.z, r5.w
        mad r18.xyz, r2.zzzz, r19.xyzx, r17.xyzx
        ...
        movc r9.xyz, r4.zzzz, r15.xyzx, r9.xyzx
      endif 
    endif 
  endif 
  break 
  ...
  if_nz r6.w
    ...
    if_nz r6.w
      ...
      if_nz r7.w
        ...
        mad r13.xyz, r13.yzwy, r2.wwww, r18.xyzx
        ...
        mad r2.xyz, r0.wwww, r19.xyzx, r9.xyzx
        ...
        movc r14.yzw, r0.yyyy, r13.xxyz, r14.yyzw
...
ret 
// Approximately 1393 instruction slots used
