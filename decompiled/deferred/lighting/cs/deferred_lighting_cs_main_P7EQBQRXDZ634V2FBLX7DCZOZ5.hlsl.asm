...
if_nz r10.w
  ...
  add r15.yzw, r11.xxyz, -cb10[r10.w + 0].xxyz
  and r13.w, l(0x0000ffff), cb10[r10.w + 7].z
  ubfe r17.x, l(6), l(25), cb10[r10.w + 7].z
  ...
  endloop 
  mov_sat r19.y, r19.y
  mul r13.w, r19.y, cb10[r10.w + 6].y
  ...
  if_nz r17.x
    ...
    mov r19.x, cb10[r10.w + 0].w
    mov r19.y, cb10[r10.w + 1].z
    mov r19.z, cb10[r10.w + 2].y
    dp3 r20.x, r18.xyzx, r19.xyzx
    mov r21.xy, cb10[r10.w + 1].xwxx
    mov r21.z, cb10[r10.w + 2].z
    dp3 r20.y, r18.xyzx, r21.xyzx
    mov r22.x, cb10[r10.w + 1].y
    mov r22.yz, cb10[r10.w + 2].xxwx
    dp3 r20.z, r18.xyzx, r22.xyzx
    ubfe r17.z, l(9), l(16), cb10[r10.w + 7].z
    utof r20.w, r17.z
    ...
    mad_sat r15.yzw, r18.xxyz, cb10[r10.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
    mul r18.xy, r15.yzyy, cb10[r10.w + 4].zwzz
    mul r18.z, r15.w, cb10[r10.w + 5].x
    add r15.yzw, r18.xxyz, cb10[r10.w + 5].yyzw
...
if_nz r9.w
  ...
  if_nz r19.x
    ...
    mad r17.w, r17.w, cb10[r0.y + 6].y, r13.w
...
bfi r4.w, l(8), l(0), r9.w, r10.w
movc r0.y, r0.y, r4.w, r9.w
max r4.w, r17.w, l(1.000000)
rcp r4.w, r4.w
mov_sat r17.w, r17.w
mul r18.xyz, r4.wwww, r15.yzwy
mul r17.xyz, r4.wwww, r17.xyzx
lt r7.w, r17.w, l(0.990000)
if_nz r7.w
  iadd r0.y, r0.y, l(256)
  add r7.w, -r17.w, l(1.000000)
  ...
  mad r18.xyz, r15.yzwy, r4.wwww, r19.xyzx
  mov r16.w, l(0)
  ...
  mad r17.xyz, r15.yzwy, r4.wwww, r17.xyzx
endif 
...
ret 
// Approximately 2118 instruction slots used
