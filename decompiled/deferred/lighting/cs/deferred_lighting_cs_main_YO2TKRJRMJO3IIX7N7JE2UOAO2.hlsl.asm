...
add r1.w, r1.w, r1.w
mad r13.xyz, r11.xyzx, -r1.wwww, -r12.xyzx
...
if_z r6.w
  ...
  if_nz r8.w
    ...
    loop 
      ...
      breakc_nz r10.w
      ftou r10.w, r8.w
      add r15.xy, r14.xyxx, -cb2[r10.w + 20].xyxx
  ...
  if_nz r10.w
    ...
    if_z r15.w
      ...
      movc r14.w, r16.z, r17.z, r14.w
      ushr r15.w, r14.w, l(13)
      movc r14.w, r16.y, r15.w, r14.w
      ...
      movc r16.yzw, r14.wwww, r16.yyzw, r18.xxzw
      ...
      if_z r12.w
        ...
        movc r17.yz, r14.wwww, r18.xxzx, r19.xxyx
      ...
      if_z r12.w
        ...
        mad r15.x, r14.x, r15.y, r15.x
        mad r14.w, r14.y, r14.w, r15.x
        movc r16.x, r12.w, r14.w, r16.x
      endif 
    endif 
    mad r12.w, -cb2[27].z, l(2.000000), r14.z
  ...
  if_z r10.w
    if_z cb2[58].y
      ftou r10.w, r8.w
      add r14.zw, r14.xxxy, -cb2[r10.w + 20].xxxy
    ...
    if_nz cb2[58].y
      ...
      add r14.xy, r14.xyxx, -cb2[r8.w + 20].xyxx
      ...
      loop 
        uge r16.x, r15.w, l(8)
        breakc_nz r16.x
        ult r16.x, r9.w, r15.w
        movc r16.yz, r16.xxxx, r14.xxyx, r14.zzwz
        movc r16.w, r16.x, cb2[r8.w + 20].w, cb2[r10.w + 20].w
        movc r16.x, r16.x, r8.w, r10.w
...
mad r14.xy, -r6.wwww, l(10.000000, 5.000000, 0.000000, 0.000000), l(6.857410, 7.085000, 0.000000, 0.000000)
exp r10.w, r14.x
mul r10.w, r2.x, r10.w
mul r10.w, r10.w, l(9.136810)
mul r12.w, r6.w, r8.w
mad r12.w, -r12.w, l(2.015905), r14.y
exp r12.w, r12.w
...
if_nz r25.w
  ...
  and r12.w, r26.z, l(0x0000ffff)
  ubfe r14.w, l(6), l(25), r26.z
  ...
  loop 
    ...
    breakc_nz r19.w
    iadd r19.w, r12.w, r16.w
    imul null, r19.w, r19.w, l(6)
    dp3 r26.y, cb11[r19.w + 0].xyzx, r25.xyzx
    add_sat r26.y, r26.y, cb11[r19.w + 0].w
    mul r26.y, r26.y, r31.x
    dp3 r26.w, cb11[r19.w + 1].xyzx, r25.xyzx
    add_sat r26.w, r26.w, cb11[r19.w + 1].w
    mul r26.y, r26.w, r26.y
    dp3 r26.w, cb11[r19.w + 2].xyzx, r25.xyzx
    add_sat r26.w, r26.w, cb11[r19.w + 2].w
    mul r26.y, r26.w, r26.y
    dp3 r26.w, cb11[r19.w + 3].xyzx, r25.xyzx
    add_sat r26.w, r26.w, cb11[r19.w + 3].w
    mul r26.y, r26.w, r26.y
    dp3 r26.w, cb11[r19.w + 4].xyzx, r25.xyzx
    add_sat r26.w, r26.w, cb11[r19.w + 4].w
    mul r26.y, r26.w, r26.y
    dp3 r26.w, cb11[r19.w + 5].xyzx, r25.xyzx
    add_sat r19.w, r26.w, cb11[r19.w + 5].w
    mul r31.x, r19.w, r26.y
    ushr r26.w, r15.w, l(2)
    ubfe r27.w, l(1), l(2), r15.w
    and r28.w, r26.w, l(2)
    max r29.w, r31.x, r31.y
    mad r19.w, -r26.y, r19.w, l(1.000000)
    mul r19.w, r19.w, r31.y
    movc r30.y, r28.w, r19.w, r29.w
  ...
  if_nz r12.w
    ...
    movc r17.xyz, r14.wwww, l(1.000000,1.000000,0,0), r17.xyzx
    ...
    or r14.w, r16.z, r14.w
    movc r15.xyz, r14.wwww, l(1.000000,1.000000,0,0), r15.xyzx
    mul r14.xyz, r14.xyzx, r15.xyzx
    dp3 r14.x, r14.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
    mul r14.y, r10.w, r14.x
    mul r15.xyz, r12.wwww, r17.xyzx
    dp3 r12.w, r15.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
    mad r12.w, r10.w, r14.x, r12.w
    div r12.w, r14.y, r12.w
    mul r30.xyz, r12.wwww, r15.xyzx
    mov r12.w, l(257)
  else 
...
if_z r14.x
  ...
  loop 
    ...
    loop 
      ...
      if_nz r19.y
        ...
        mad r27.xyz, r13.xyzx, r19.yyyy, r27.xyzx
  ...
  loop 
    ...
    loop 
      ...
      if_nz r19.w
        ...
        mad r31.xzw, r13.xxyz, r19.yyyy, r32.xxyz
  ...
  bfi r9.w, l(8), l(0), r25.y, r9.w
  movc r12.w, r6.w, r9.w, r25.y
  max r6.w, r25.x, l(1.000000)
  rcp r6.w, r6.w
  mov_sat r25.x, r25.x
  mul r14.xyz, r6.wwww, r21.xyzx
  mul r30.xyz, r6.wwww, r24.xyzx
  lt r9.w, r25.x, l(0.990000)
  if_nz r9.w
    iadd r12.w, r12.w, l(256)
    add r9.w, -r25.x, l(1.000000)
    ...
    mad r14.xyz, r21.xyzx, r6.wwww, r15.xyzx
    mov r13.w, l(0)
    ...
    mad r30.xyz, r13.xyzx, r6.wwww, r30.xyzx
  endif 
else 
...
if_nz r2.y
  ...
  if_nz r2.y
      ...
      if_z r10.w
        ...
        if_nz cb2[58].y
          ...
          loop 
            ...
            sample_c_lz_indexable(texture2darray)(float,float,float,float) r15.w, r21.xyzx, t9.xxxx, s13, r10.w
            mad r13.w, r15.w, l(0.125000), r13.w
            iadd r14.w, r14.w, l(1)
          endloop 
        else 
          utof r19.z, r11.w
          sample_c_lz_indexable(texture2darray)(float,float,float,float) r13.w, r19.xyzx, t9.xxxx, s13, r10.w
        endif 
        ...
        if_z r9.w
          ...
          if_nz cb2[58].y
            ...
            loop 
              ...
              sample_c_lz_indexable(texture2darray)(float,float,float,float) r11.w, r21.xyzx, t9.xxxx, s13, r9.w
    ...
    mad r4.xyw, r14.xyxz, r3.zzzz, r19.xyxz
    mad r14.xyz, -r10.xyzx, r0.zzzz, cb2[17].xyzx
    ...
    mul r0.z, r0.z, r2.y
    mul r0.z, r0.z, r1.w
    mad r12.xyz, r0.zzzz, r18.xyzx, r16.xzwx
    mad r14.xyz, r1.zzzz, r18.xyzx, r15.xyzx
    and r14.xyz, r0.wwww, r14.xyzx
    movc r13.xyz, r2.xxxx, r4.xywx, r13.xyzx
    movc r15.xyz, r2.xxxx, r15.xyzx, r14.xyzx
    movc r16.xzw, r2.xxxx, r12.xxyz, r16.xxzw
    movc r17.xyz, r2.xxxx, r11.xyzx, r17.xyzx
    if_nz r2.w
...
ftou r1.w, r6.x
ieq r1.w, r1.z, r1.w
movc r4.zw, r1.wwww, r6.yyyz, l(0,0,-1.000000,0)
...
mad r3.xyz, r13.xyzx, r5.yzwy, r3.xyzx
...
ret 
// Approximately 1787 instruction slots used
