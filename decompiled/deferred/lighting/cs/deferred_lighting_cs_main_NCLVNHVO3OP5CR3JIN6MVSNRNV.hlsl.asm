...
loop 
  ...
  bfi r14.w, r7.w, l(0), l(0), r14.y
  movc r14.y, r14.z, r14.w, r14.y
  ieq r14.z, r8.w, r13.w
  ubfe r14.w, r9.w, l(0), r14.y
  movc r14.y, r14.z, r14.w, r14.y
...
if_nz r8.w
  ...
  loop 
    ...
    ieq r15.y, r0.z, r9.w
    ubfe r15.z, r7.w, l(0), r13.w
    movc r13.w, r15.y, r15.z, r13.w
    ...
    loop 
      ...
      loop 
        ...
        mov r17.x, r27.w
      endloop 
      add_sat r17.x, -r17.w, r28.y
      mul r19.y, r17.x, cb10[r19.z + 6].y
      lt r19.w, l(0.000000), r19.y
      if_nz r19.w
        mad r25.w, r17.x, cb10[r19.z + 6].y, r25.w
        mul r17.x, r19.y, cb10[r19.z + 7].y
        ...
        mad r15.yzw, r19.yyzw, r26.xxyz, r15.yyzw
        mul r19.y, r4.w, r18.z
        mul r26.xyz, r17.xxxx, r27.xyzx
        dp3 r17.x, r26.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
        mad r17.x, r4.w, r18.z, r17.x
        div r17.x, r19.y, r17.x
        mad r25.xyz, r26.xyzx, r17.xxxx, r25.xyzx
      endif 
    endloop 
    ...
    if_nz r13.w
      ...
      if_nz r13.w
        ...
        if_nz r13.w
          ...
          mad r25.w, -r16.w, r16.w, cb9[r4.w + 6].y
          mad r6.w, r16.w, r20.w, -r6.w
          div_sat r6.w, r6.w, r25.w
          div r16.w, r25.w, cb9[r4.w + 6].y
              ...
              if_z r16.w
                ...
                if_nz cb2[58].y
                  ...
                  loop 
                    ige r21.z, r21.y, l(8)
                    breakc_nz r21.z
                    dp2 r33.x, icb[r21.y + 0].xyxx, r13.xyxx
                    dp2 r33.y, icb[r21.y + 0].yxyy, r13.xzxx
                    mad r19.xy, r33.xyxx, cb9[r6.w + 3].yyyy, r32.xyxx
                    sample_c_lz_indexable(texture2darray)(float,float,float,float) r19.x, r19.xyzx, t9.xxxx, s13, r7.w
          ...
          mad r30.xyz, r30.xyzx, r5.zzzz, r10.yzwy
          dp3 r5.z, r30.xyzx, r30.xyzx
          rsq r5.z, r5.z
          mul r30.xyz, r5.zzzz, r30.xyzx
          dp3 r5.z, r30.xyzx, r10.yzwy
    ...
    if_nz r8.w
      ...
      if_nz r9.w
        ...
        if_nz r8.w
          ...
          mad r16.w, cb9[r4.w + 12].y, r21.z, l(-1.000000)
      ...
      if_nz r8.w
          ...
          if_nz r13.w
            ...
            if_nz cb2[58].y
              ...
              loop 
                ige r20.x, r16.w, l(8)
                breakc_nz r20.x
                dp2 r20.x, icb[r16.w + 0].xyxx, r25.xyxx
                dp2 r20.y, icb[r16.w + 0].yxyy, r25.xzxx
        ...
        if_nz r9.w
          ...
          if_nz r16.w
            ...
            mad r23.xyz, r12.xyzx, r16.wwww, r11.xyzx
            ...
            if_z r20.y
              ...
              if_z r22.x
                ...
                mad r16.w, cb9[r12.w + 10].y, r20.x, r16.w
            ...
            if_z r20.x
              ...
              if_nz cb2[58].y
                ...
                loop 
                  ...
                  sample_c_lz_indexable(texture2darray)(float,float,float,float) r21.z, r22.xyzx, t9.xxxx, s13, r16.w
                  mad r20.y, r21.z, l(0.125000), r20.y
                  iadd r21.y, r21.y, l(1)
                endloop 
              else 
                utof r23.z, r20.x
                sample_c_lz_indexable(texture2darray)(float,float,float,float) r20.y, r23.xyzx, t9.xxxx, s13, r16.w
              endif 
            ...
            if_nz r12.w
              ...
              mov r30.xyz, cb9[r4.w + 7].yzwy
              mov r30.w, cb9[r4.w + 8].x
              dp4 r16.w, r30.xyzw, r24.xyzw
              lt r20.x, r16.w, r12.w
              if_z r20.x
                mov r30.xyz, cb9[r4.w + 4].yzwy
                mov r30.w, cb9[r4.w + 5].x
          ...
          mad r19.xyz, r19.xyzx, r5.zzzz, r10.yzwy
          dp3 r4.w, r19.xyzx, r19.xyzx
          rsq r4.w, r4.w
          mul r19.xyz, r4.wwww, r19.xyzx
          dp3 r4.w, r19.xyzx, r10.yzwy
