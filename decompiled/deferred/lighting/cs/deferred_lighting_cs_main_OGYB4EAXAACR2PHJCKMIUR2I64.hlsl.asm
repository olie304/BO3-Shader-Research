...
if_nz r15.z
  ...
  add r16.xyz, r5.yzwy, -cb10[r15.z + 0].xyzx
...
if_nz r15.y
  ...
  add r18.xyz, r5.yzwy, -cb10[r0.y + 0].xyzx
  and r16.w, l(0x0000ffff), cb10[r0.y + 7].z
  ubfe r17.w, l(6), l(25), cb10[r0.y + 7].z
  ...
  if_nz r18.w
    ...
    mad r16.w, r16.w, cb10[r0.y + 6].y, r15.w
    mul r17.w, r17.w, cb10[r0.y + 7].y
    ...
    ubfe r12.w, l(9), l(16), cb10[r0.y + 7].z
    utof r21.w, r12.w
...
if_nz r12.w
  ...
  mad r17.xyz, r14.xyzx, r8.wwww, r17.xyzx
endif 
...
ret 
// Approximately 1805 instruction slots used
