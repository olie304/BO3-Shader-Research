    ...
    loop 
      ...
      if_nz r13.y
        if_nz r20.z
          ...
          movc r17.xy, r13.yyyy, r15.xyxx, r9.xyxx
          mov r20.z, r15.w
          mov r22.x, r7.w
...
if_z r8.w
  ...
  if_nz r12.w
    ...
    loop 
      ...
      breakc_nz r15.y
      ftou r15.y, r12.w
      add r15.zw, r13.yyyz, -cb2[r15.y + 20].xxxy
  ...
  if_z r15.y
    if_z cb2[58].y
      ftou r13.w, r12.w
      add r15.yz, r13.yyzy, -cb2[r13.w + 20].xxyx
    ...
    if_nz cb2[58].y
      ...
      loop 
        ...
        movc r17.yz, r17.xxxx, r13.yyzy, r15.yyzy
        movc r17.w, r17.x, cb2[r12.w + 20].w, cb2[r13.w + 20].w
        movc r17.x, r17.x, r12.w, r13.w
...
mul r12.w, r8.w, l(5.000000)
mad r13.y, r8.w, l(5.000000), l(-2.500000)
...
mul r15.x, r8.w, r12.w
mad r13.w, -r15.x, l(2.015905), r13.w
exp r13.w, r13.w
...
imad r0.x, r0.y, r15.x, r0.x
bfi r0.x, l(27), l(5), r0.x, l(16)
and r0.y, r13.w, l(-32)
iadd r15.x, -r0.y, r13.w
...
loop 
  ...
  ieq r17.w, r0.y, r15.w
  bfi r18.z, r15.x, l(0), l(0), r16.w
  movc r16.w, r17.w, r18.z, r16.w
  ieq r17.w, r15.y, r15.w
  ubfe r18.z, r15.z, l(0), r16.w
  movc r16.w, r17.w, r18.z, r16.w
  ...
  loop 
    ...
    add r25.xyz, r10.xyzx, -cb10[r18.z + 0].xyzx
    ...
    endloop 
    mov_sat r27.y, r27.y
    mul r16.x, r27.y, cb10[r18.z + 6].y
    lt r18.y, l(0.000000), r16.x
    if_nz r18.y
      mad r24.z, r27.y, cb10[r18.z + 6].y, r24.z
      mul r16.x, r16.x, cb10[r18.z + 7].y
      ...
      sqrt r18.y, r18.y
      mad r18.y, r8.w, l(5.000000), r18.y
...
if_nz r15.y
  ...
  mov r17.w, l(0)
  loop 
    uge r18.z, r17.w, r13.w
    breakc_nz r18.z
    ushr r18.z, r17.w, l(5)
    iadd r18.z, r0.x, r18.z
    ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r18.z, r18.z, l(0), t26.xxxx
    ieq r18.w, r0.y, r17.w
    ubfe r19.w, r15.x, l(0), r18.z
    movc r18.z, r18.w, r19.w, r18.z
    ...
    loop 
      ...
      add r26.xyz, r10.xyzx, -cb10[r20.w + 0].xyzx
      and r25.w, l(0x0000ffff), cb10[r20.w + 7].z
      ubfe r26.w, l(6), l(25), cb10[r20.w + 7].z
      imul null, r27.x, r25.w, l(6)
      dp3 r27.y, cb11[r27.x + 0].xyzx, r26.xyzx
      add_sat r27.y, r27.y, cb11[r27.x + 0].w
      dp3 r27.z, cb11[r27.x + 1].xyzx, r26.xyzx
      add_sat r27.z, r27.z, cb11[r27.x + 1].w
      mul r27.y, r27.z, r27.y
      dp3 r27.z, cb11[r27.x + 2].xyzx, r26.xyzx
      add_sat r27.z, r27.z, cb11[r27.x + 2].w
      mul r27.y, r27.z, r27.y
      dp3 r27.z, cb11[r27.x + 3].xyzx, r26.xyzx
      add_sat r27.z, r27.z, cb11[r27.x + 3].w
      mul r27.y, r27.z, r27.y
      dp3 r27.z, cb11[r27.x + 4].xyzx, r26.xyzx
      add_sat r27.z, r27.z, cb11[r27.x + 4].w
      mul r27.y, r27.z, r27.y
      dp3 r27.z, cb11[r27.x + 5].xyzx, r26.xyzx
      add_sat r27.x, r27.z, cb11[r27.x + 5].w
      mul r16.x, r27.x, r27.y
      and r27.x, l(1), cb10[r20.w + 6].x
      movc r27.xy, r27.xxxx, r16.xyxx, r16.zxzz
      mov r16.x, cb10[r20.w + 6].x
      mov r28.xy, r27.xyxx
      mov r27.z, l(1)
      loop 
        ige r27.w, r27.z, r26.w
        breakc_nz r27.w
        iadd r27.w, r25.w, r27.z
        imul null, r27.w, r27.w, l(6)
        dp3 r28.z, cb11[r27.w + 0].xyzx, r26.xyzx
        add_sat r28.z, r28.z, cb11[r27.w + 0].w
        mul r28.z, r28.z, r28.x
        dp3 r28.w, cb11[r27.w + 1].xyzx, r26.xyzx
        add_sat r28.w, r28.w, cb11[r27.w + 1].w
        mul r28.z, r28.w, r28.z
        dp3 r28.w, cb11[r27.w + 2].xyzx, r26.xyzx
        add_sat r28.w, r28.w, cb11[r27.w + 2].w
        mul r28.z, r28.w, r28.z
        dp3 r28.w, cb11[r27.w + 3].xyzx, r26.xyzx
        add_sat r28.w, r28.w, cb11[r27.w + 3].w
        mul r28.z, r28.w, r28.z
        dp3 r28.w, cb11[r27.w + 4].xyzx, r26.xyzx
        add_sat r28.w, r28.w, cb11[r27.w + 4].w
        mul r28.z, r28.w, r28.z
        dp3 r28.w, cb11[r27.w + 5].xyzx, r26.xyzx
        ...
        movc r18.y, r29.y, r27.w, r29.z
        movc r28.xy, r29.xxxx, r28.xyxx, r18.xyxx
        iadd r27.z, r27.z, l(1)
        mov r16.x, r28.w
      endloop 
      add_sat r16.x, -r18.w, r28.y
      mul r18.y, r16.x, cb10[r20.w + 6].y
      lt r25.w, l(0.000000), r18.y
      if_nz r25.w
        mad r24.w, r16.x, cb10[r20.w + 6].y, r24.w
        mul r16.x, r18.y, cb10[r20.w + 7].y
        mov r27.x, cb10[r20.w + 7].w
        mov r27.yz, cb10[r20.w + 8].xxyx
        dp3 r18.y, r14.xyzx, r27.xyzx
        dp3 r25.w, r26.xyzx, r27.xyzx
        add r25.w, r25.w, -cb10[r20.w + 8].z
        ge r26.w, r25.w, l(0.000000)
        max r25.w, r13.y, |r25.w|
        movc r25.w, r26.w, r25.w, -r25.w
        max r18.y, -r18.y, l(0.00000010)
        div r18.y, r25.w, r18.y
        min r18.y, |r18.y|, l(131072.000000)
        mov r27.x, cb10[r20.w + 8].w
        mov r27.yz, cb10[r20.w + 9].xxyx
        dp3 r25.w, r14.xyzx, r27.xyzx
        dp3 r26.w, r26.xyzx, r27.xyzx
        add r26.w, r26.w, -cb10[r20.w + 9].z
        ge r27.x, r26.w, l(0.000000)
        max r26.w, r13.y, |r26.w|
        movc r26.w, r27.x, r26.w, -r26.w
        max r25.w, -r25.w, l(0.00000010)
        div r25.w, r26.w, r25.w
        min r18.y, r18.y, |r25.w|
        ...
        div r25.w, r26.w, r25.w
        min r18.y, r18.y, |r25.w|
        add r27.x, r26.x, cb10[r20.w + 3].w
        add r27.yz, r26.yyzy, cb10[r20.w + 4].xxyx
        mad r27.xyz, r14.xyzx, r18.yyyy, r27.xyzx
        dp3 r25.w, r27.xyzx, r27.xyzx
        sqrt r25.w, r25.w
        div r18.y, r18.y, r25.w
        add r18.y, r18.y, r18.y
        sqrt r18.y, r18.y
        mad r18.y, r8.w, l(5.000000), r18.y
        add r18.y, r18.y, l(-0.844800)
        ...
        ubfe r25.w, l(9), l(16), cb10[r20.w + 7].z
        utof r30.w, r25.w
        ...
        mad_sat r26.xyz, r33.xyzx, cb10[r20.w + 3].xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
        mul r33.xy, r26.xyxx, cb10[r20.w + 4].zwzz
        mul r33.z, r26.z, cb10[r20.w + 5].x
        add r26.xyz, r33.xyzx, cb10[r20.w + 5].yzwy
...
if_nz r0.y
  ...
  mad r13.yzw, r21.xxyz, r0.xxxx, r16.xxyz
  mov r14.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r14.xyz, r14.xyzw, t8.xyzw, s2, r12.w
  mad r0.x, cb2[19].x, r0.y, -r8.w
  mad r0.x, r2.y, r0.x, r8.w
  mad r15.xyz, r14.xyzx, r0.xxxx, r15.xyzx
endif 
add r0.x, -r2.w, l(1.000000)
mad r9.xyw, r15.xyxz, r0.xxxx, r9.xyxw
...
if_nz r0.x
  ...
  if_nz r0.x
    ...
    if_nz cb2[23].x
      ...
      utof r15.z, r4.z
      sample_l_indexable(texture2darray)(float,float,float,float) r9.xyw, r15.xyzx, t20.xywz, s2, l(0.000000)
      ...
      if_z r6.w
        ...
        if_nz cb2[58].y
          ...
          loop 
            ...
            sample_c_lz_indexable(texture2darray)(float,float,float,float) r14.w, r17.xyzx, t9.xxxx, s13, r6.w
        ...
        if_z r6.w
          ...
          if_nz cb2[58].y
            ...
            loop 
              ige r11.w, r9.z, l(8)
              breakc_nz r11.w
              dp2 r18.x, icb[r9.z + 0].yxyy, r16.xyxx
              dp2 r18.y, icb[r9.z + 0].yxyy, r16.yzyy
              mad r17.xy, r18.xyxx, cb9[r4.z + 3].yyyy, r15.xyxx
            ...
            utof r15.z, r8.w
            sample_c_lz_indexable(texture2darray)(float,float,float,float) r3.x, r15.xyzx, t9.xxxx, s13, r6.w
          endif 
          mul r4.z, r3.x, r3.x
          mul r3.x, r3.x, r4.z
        else 
    ...
    add r2.x, -r7.w, r2.x
    mad r1.z, r1.z, r2.x, r7.w
    mul r1.z, r10.w, r1.z
    lt r2.x, l(0.000000), r5.w
    mad r15.xyz, r1.zzzz, r9.xywx, r13.yzwy
    ...
    mul r0.y, r0.z, r0.y
    mul r0.x, r0.y, r0.x
    mad r0.xyz, r0.xxxx, r9.xywx, r14.xyzx
    movc r13.yzw, r2.xxxx, r15.xxyz, r13.yyzw
    movc r14.xyz, r2.xxxx, r0.xyzx, r14.xyzx
    movc r2.yzw, r2.xxxx, r11.xxyz, r2.yyzw
  endif 
endif 
...
ret 
// Approximately 1649 instruction slots used
