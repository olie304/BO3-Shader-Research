...
loop 
  ...
  if_nz r13.z
    ...
    if_nz r2.w
      ...
      store_structured u2.xyzw, cb2[52].x, r13.z, r15.xyzw
    endif 
    iadd r23.w, r22.w, l(1)
    add r15.yzw, r5.yyzw, -cb10[r13.y + 0].xxyz
    and r13.z, l(0x0000ffff), cb10[r13.y + 7].z
    ubfe r13.w, l(6), l(25), cb10[r13.y + 7].z
    imul null, r16.w, r13.z, l(6)
    dp3 r17.w, cb11[r16.w + 0].xyzx, r15.yzwy
    ...
    if_nz r13.w
      ...
      if_nz r16.x
        ...
        store_structured u2.x, cb2[52].x, r16.w, r13.z
      endif 
      iadd r22.w, r22.w, l(257)
      mad r22.z, r24.y, cb10[r13.y + 6].y, r22.z
      mul r13.z, r13.z, cb10[r13.y + 7].y
      mov r25.x, cb10[r13.y + 7].w
      mov r25.yz, cb10[r13.y + 8].xxyx
      ...
      mov r25.x, cb10[r13.y + 8].w
      mov r25.yz, cb10[r13.y + 9].xxyx
      dp3 r16.x, r14.xyzx, r25.xyzx
      ...
      mov r25.x, cb10[r13.y + 9].w
      mov r25.yz, cb10[r13.y + 10].xxyx
      dp3 r16.x, r14.xyzx, r25.xyzx
      dp3 r16.w, r15.yzwy, r25.xyzx
      ...
      div r16.x, r16.w, r16.x
      min r13.w, r13.w, |r16.x|
      mov r25.x, cb10[r13.y + 10].w
      mov r25.yz, cb10[r13.y + 11].xxyx
      dp3 r16.x, r14.xyzx, r25.xyzx
      dp3 r16.w, r15.yzwy, r25.xyzx
      ...
      div r16.x, r16.w, r16.x
      min r13.w, r13.w, |r16.x|
      mov r25.x, cb10[r13.y + 11].w
      mov r25.yz, cb10[r13.y + 12].xxyx
      dp3 r16.x, r14.xyzx, r25.xyzx
      dp3 r16.w, r15.yzwy, r25.xyzx
      ...
      div r16.x, r16.w, r16.x
      min r13.w, r13.w, |r16.x|
      mov r25.x, cb10[r13.y + 12].w
      mov r25.yz, cb10[r13.y + 13].xxyx
      dp3 r16.x, r14.xyzx, r25.xyzx
      dp3 r16.w, r15.yzwy, r25.xyzx
      ...
      div r16.x, r16.w, r16.x
      min r13.w, r13.w, |r16.x|
      add r25.x, r15.y, cb10[r13.y + 3].w
      add r25.yz, r15.zzwz, cb10[r13.y + 4].xxyx
      mad r24.xzw, r14.xxyz, r13.wwww, r25.xxyz
      dp3 r16.x, r24.xzwx, r24.xzwx
      sqrt r16.x, r16.x
      ...
      mov r25.x, cb10[r13.y + 0].w
      mov r25.y, cb10[r13.y + 1].z
      mov r25.z, cb10[r13.y + 2].y
      dp3 r26.x, r24.xzwx, r25.xyzx
      mov r27.xy, cb10[r13.y + 1].xwxx
      mov r27.z, cb10[r13.y + 2].z
      dp3 r26.y, r24.xzwx, r27.xyzx
      mov r28.x, cb10[r13.y + 1].y
      mov r28.yz, cb10[r13.y + 2].xxwx
      dp3 r26.z, r24.xzwx, r28.xyzx
      ubfe r16.x, l(9), l(16), cb10[r13.y + 7].z
      utof r26.w, r16.x
      sample_l_indexable(texturecubearray)(float,float,float,float) r24.xzw, r26.xyzw, t8.xwyz, s2, r13.w
      ...
      movc r24.xzw, r13.wwww, l(1.000000,0,1.000000,0), r24.xxzw
      dp3 r29.x, r15.yzwy, r25.xyzx
      dp3 r29.y, r15.yzwy, r27.xyzx
      dp3 r29.z, r15.yzwy, r28.xyzx
      mad_sat r15.yzw, r29.xxyz, cb10[r13.y + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
      mul r29.xy, r15.yzyy, cb10[r13.y + 4].zwzz
      mul r29.z, r15.w, cb10[r13.y + 5].x
      add r15.yzw, r29.xxyz, cb10[r13.y + 5].yyzw
      ...
      or r13.y, r26.y, r26.x
      or r13.y, r26.z, r13.y
      movc r25.xyz, r13.yyyy, l(1.000000,1.000000,0,0), r25.xyzx
      mul r26.xyz, r15.yzwy, r25.xyzx
      dp3 r13.y, r26.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r21.xyz, r15.yzwy, r25.xyzx, r21.xyzx
      mul r13.w, r8.w, r13.y
      mul r15.yzw, r13.zzzz, r24.xxzw
      dp3 r13.z, r15.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r13.y, r8.w, r13.y, r13.z
      div r13.y, r13.w, r13.y
      mov r25.x, r21.w
      mov r25.yz, r22.xxyx
      mad r13.yzw, r15.yyzw, r13.yyyy, r25.xxyz
      mov r21.w, r13.y
      mov r22.xy, r13.zwzz
    else 
...
loop 
  ieq r16.w, r12.w, l(2)
  breakc_nz r16.w
  movc r16.w, r12.w, r0.y, r10.w
  ult r17.w, r16.w, r9.w
  if_nz r17.w
    imul null, r16.w, r16.w, l(14)
    if_nz r2.w
      and r17.w, r18.y, l(15)
      imad r17.w, r17.w, l(20), l(880)
      add r15.yzw, cb1[24].xxyz, cb10[r16.w + 0].xxyz
      store_structured u2.xyzw, cb2[52].x, r17.w, r15.xyzw
    endif 
    iadd r24.y, r18.y, l(1)
    add r15.yzw, r5.yyzw, -cb10[r16.w + 0].xxyz
    ...
    dp3 r24.z, cb11[r20.w + 1].xyzx, r15.yzwy
    add_sat r24.z, r24.z, cb11[r20.w + 1].w
    mul r23.w, r23.w, r24.z
    dp3 r24.z, cb11[r20.w + 2].xyzx, r15.yzwy
    add_sat r24.z, r24.z, cb11[r20.w + 2].w
    mul r23.w, r23.w, r24.z
    dp3 r24.z, cb11[r20.w + 3].xyzx, r15.yzwy
    add_sat r24.z, r24.z, cb11[r20.w + 3].w
    mul r23.w, r23.w, r24.z
    dp3 r24.z, cb11[r20.w + 4].xyzx, r15.yzwy
    add_sat r24.z, r24.z, cb11[r20.w + 4].w
    mul r23.w, r23.w, r24.z
    dp3 r24.z, cb11[r20.w + 5].xyzx, r15.yzwy
    add_sat r20.w, r24.z, cb11[r20.w + 5].w
    mul r16.x, r20.w, r23.w
    and r20.w, l(1), cb10[r16.w + 6].x
    movc r24.zw, r20.wwww, r16.xxxy, r16.zzzx
    ...
    loop 
      ...
      breakc_nz r23.w
      iadd r23.w, r17.w, r20.w
      imul null, r23.w, r23.w, l(6)
      dp3 r25.z, cb11[r23.w + 0].xyzx, r15.yzwy
      add_sat r25.z, r25.z, cb11[r23.w + 0].w
      ...
      mul r25.x, r23.w, r25.z
      ushr r25.w, r16.x, l(2)
      ubfe r26.x, l(1), l(2), r16.x
      and r26.y, r25.w, l(2)
      max r26.z, r25.x, r25.y
      mad r23.w, -r25.z, r23.w, l(1.000000)
      mul r23.w, r23.w, r25.y
      movc r18.w, r26.y, r23.w, r26.z
      movc r25.xy, r26.xxxx, r25.xyxx, r18.zwzz
      iadd r20.w, r20.w, l(1)
      mov r16.x, r25.w
    endloop 
    add_sat r16.x, -r22.z, r25.y
    mul r17.w, r16.x, cb10[r16.w + 6].y
    lt r18.w, l(0.000000), r17.w
    if_nz r18.w
      and r18.w, r24.y, l(31)
      iadd r19.w, r18.w, l(-1)
      ult r19.w, r19.w, l(32)
      and r19.w, r2.w, r19.w
      if_nz r19.w
        imad r24.zw, r18.wwww, l(0, 0, 20, 20), l(0, 0, 860, 876)
        ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r18.w, cb2[52].x, r24.z, u2.xxxx
        or r18.w, r18.w, l(32)
        store_structured u2.x, cb2[52].x, r24.z, r18.w
        store_structured u2.x, cb2[52].x, r24.w, r17.w
      endif 
      iadd r18.y, r18.y, l(257)
      mad r18.x, r16.x, cb10[r16.w + 6].y, r18.x
      mul r16.x, r17.w, cb10[r16.w + 7].y
      ...
      div r18.w, r19.w, r18.w
      min r17.w, r17.w, |r18.w|
      add r26.x, r15.y, cb10[r16.w + 3].w
      add r26.yz, r15.zzwz, cb10[r16.w + 4].xxyx
      mad r25.xzw, r14.xxyz, r17.wwww, r26.xxyz
      dp3 r18.w, r25.xzwx, r25.xzwx
      sqrt r18.w, r18.w
      ...
      mov r28.xy, cb10[r16.w + 1].xwxx
      mov r28.z, cb10[r16.w + 2].z
      dp3 r27.y, r25.xzwx, r28.xyzx
      mov r29.x, cb10[r16.w + 1].y
      mov r29.yz, cb10[r16.w + 2].xxwx
      dp3 r27.z, r25.xzwx, r29.xyzx
      ubfe r18.w, l(9), l(16), cb10[r16.w + 7].z
      utof r27.w, r18.w
      sample_l_indexable(texturecubearray)(float,float,float,float) r25.xzw, r27.xyzw, t8.xwyz, s2, r17.w
      ...
      movc r25.xzw, r17.wwww, l(1.000000,0,1.000000,0), r25.xxzw
      dp3 r30.x, r15.yzwy, r26.xyzx
      dp3 r30.y, r15.yzwy, r28.xyzx
      dp3 r30.z, r15.yzwy, r29.xyzx
      mad_sat r15.yzw, r30.xxyz, cb10[r16.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
      mul r30.xy, r15.yzyy, cb10[r16.w + 4].zwzz
      mul r30.z, r15.w, cb10[r16.w + 5].x
      add r15.yzw, r30.xxyz, cb10[r16.w + 5].yyzw
      ...
      add r15.yzw, r15.yyzw, r20.xxyz
      sample_l_indexable(texture3d)(float,float,float,float) r15.yzw, r15.yzwy, t19.wxyz, s4, l(0.000000)
      mad r15.yzw, r15.yyzw, r29.zzzz, r26.xxyw
      ...
      or r16.w, r27.y, r27.x
      or r16.w, r27.z, r16.w
      movc r26.xyz, r16.wwww, l(1.000000,1.000000,0,0), r26.xyzx
      mul r27.xyz, r15.yzwy, r26.xyzx
      dp3 r16.w, r27.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r13.yzw, r15.yyzw, r26.xxyz, r13.yyzw
      mul r15.y, r8.w, r16.w
      mul r25.xzw, r16.xxxx, r25.xxzw
      dp3 r15.z, r25.xzwx, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r15.z, r8.w, r16.w, r15.z
      div r15.y, r15.y, r15.z
      mad r23.xyz, r25.xzwx, r15.yyyy, r23.xyzx
    else 
      mov r24.x, r18.x
      mov r18.xy, r24.xyxx
    endif 
  ...
  iadd r12.w, r12.w, l(1)
endloop 
ge r0.y, r22.z, l(1.000000)
bfi r4.z, l(8), l(0), r18.y, r22.w
movc r0.y, r0.y, r4.z, r18.y
max r4.z, r18.x, l(1.000000)
rcp r4.z, r4.z
mov_sat r18.x, r18.x
mul r15.xyz, r4.zzzz, r13.yzwy
mul r16.xyz, r4.zzzz, r23.xyzx
lt r7.w, r18.x, l(0.990000)
if_nz r7.w
  ...
  mad r15.xyz, r13.yzwy, r4.zzzz, r17.xyzx
  mov r14.w, l(0)
  ...
  mad r16.xyz, r13.yzwy, r4.zzzz, r16.xyzx
endif 
add r4.z, r5.x, r2.x
log r4.z, |r4.z|
mul r4.z, r2.z, r4.z
