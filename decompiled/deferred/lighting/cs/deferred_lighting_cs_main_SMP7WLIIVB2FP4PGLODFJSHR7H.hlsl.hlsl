...
r0.y = samplerLinear[]..swiz;
  ...
  if (r7.w != 0) {
    r7.w = (int)r0.y * 14;
    r10.yzw = -refProbeConstantsCB[r7.w].data[0].xyz + r11.xyz;
    ...
    r13.w = (int)r8.w * 6;
    r14.w = dot(refProbeAttenuationConstantsCB[r13.w].data[0].xyz, r10.yzw);
    r14.w = saturate(refProbeAttenuationConstantsCB[r13.w].data[0].w + r14.w);
    r15.y = dot(refProbeAttenuationConstantsCB[r13.w].data[1].xyz, r10.yzw);
    r15.y = saturate(refProbeAttenuationConstantsCB[r13.w].data[1].w + r15.y);
    r14.w = r15.y * r14.w;
    r15.y = dot(refProbeAttenuationConstantsCB[r13.w].data[2].xyz, r10.yzw);
    r15.y = saturate(refProbeAttenuationConstantsCB[r13.w].data[2].w + r15.y);
    r14.w = r15.y * r14.w;
    r15.y = dot(refProbeAttenuationConstantsCB[r13.w].data[3].xyz, r10.yzw);
    r15.y = saturate(refProbeAttenuationConstantsCB[r13.w].data[3].w + r15.y);
    r14.w = r15.y * r14.w;
    r15.y = dot(refProbeAttenuationConstantsCB[r13.w].data[4].xyz, r10.yzw);
    r15.y = saturate(refProbeAttenuationConstantsCB[r13.w].data[4].w + r15.y);
    r14.w = r15.y * r14.w;
    r15.y = dot(refProbeAttenuationConstantsCB[r13.w].data[5].xyz, r10.yzw);
    r13.w = saturate(refProbeAttenuationConstantsCB[r13.w].data[5].w + r15.y);
    r18.x = r14.w * r13.w;
    r13.w = 1 & (int)refProbeConstantsCB[r7.w].data[6].x;
    r18.yz = float2(0,1);
    r15.yz = r13.ww ? r18.xy : r18.zx;
    r18.x = 1;
    r13.w = refProbeConstantsCB[r7.w].data[6].x;
    r19.xy = r15.yz;
    r14.w = 1;
    while (true) {
      r15.w = cmp((int)r14.w >= (int)r9.w);
      if (r15.w != 0) break;
      r15.w = (int)r8.w + (int)r14.w;
      r15.w = (int)r15.w * 6;
    ...
    if (r9.w != 0) {
      ...
      r14.w = dot(r10.yzw, r18.xyz);
      r14.w = -refProbeConstantsCB[r7.w].data[8].z + r14.w;
      r15.y = cmp(r14.w >= 0);
      ...
      r14.w = r15.y / r14.w;
      r13.w = min(abs(r14.w), r13.w);
      r18.x = refProbeConstantsCB[r7.w].data[3].w + r10.y;
      r18.yz = refProbeConstantsCB[r7.w].data[4].xy + r10.zw;
      r15.yzw = r17.xyz * r13.www + r18.xyz;
      ...
      r19.x = dot(r15.yzw, r18.xyz);
      r20.xy = refProbeConstantsCB[r7.w].data[1].xw;
      r20.z = refProbeConstantsCB[r7.w].data[2].z;
      r19.y = dot(r15.yzw, r20.xyz);
      r21.x = refProbeConstantsCB[r7.w].data[1].y;
      r21.yz = refProbeConstantsCB[r7.w].data[2].xw;
      r19.z = dot(r15.yzw, r21.xyz);
      if (9 == 0) r14.w = 0; else if (9+16 < 32) {       r14.w = (uint)refProbeConstantsCB[r7.w].data[7].z << (32-(9 + 16)); r14.w = (uint)r14.w >> (32-9);      } else r14.w = (uint)refProbeConstantsCB[r7.w].data[7].z >> 16;
      r19.w = (uint)r14.w;
      r15.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r19.xyzw, r13.w).xyz;
      r22.x = dot(r10.yzw, r18.xyz);
      r22.y = dot(r10.yzw, r20.xyz);
      r22.z = dot(r10.yzw, r21.xyz);
      r10.yzw = saturate(r22.xyz * refProbeConstantsCB[r7.w].data[3].xyz + float3(0.5,0.5,0.5));
      r22.xy = refProbeConstantsCB[r7.w].data[4].zw * r10.yz;
      r22.z = refProbeConstantsCB[r7.w].data[5].x * r10.w;
      r10.yzw = refProbeConstantsCB[r7.w].data[5].yzw + r22.xyz;
      r19.x = dot(r12.xyz, r18.xyz);
      r19.y = dot(r12.xyz, r20.xyz);
      r19.z = dot(r12.xyz, r21.xyz);
      r16.yzw = cmp(float3(0,0,0) < r19.xyz);
      r18.z = r16.y ? 0 : 0.5;
      r18.xy = float2(0,0);
      ...
      r21.z = r16.z ? 0 : 0.5;
      r21.xy = float2(0,0);
      r21.xyz = r21.xyz + r10.yzw;
      r21.xyz = gProbeYArray.SampleLevel(samplerLinearClamp_s, r21.xyz, 0).xyz;
      r21.xyz = r21.xyz * r20.yyy;
      r18.xyz = r18.xyz * r20.xxx + r21.xyz;
      r21.z = r16.w ? 0 : 0.5;
      r21.xy = float2(0,0);
      r10.yzw = r21.xyz + r10.yzw;
      r10.yzw = gProbeZArray.SampleLevel(samplerLinearClamp_s, r10.yzw, 0).xyz;
      r10.yzw = r10.yzw * r20.zzz + r18.xyz;
      r16.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r19.xyzw, 6).xyz;
      r10.yzw = r16.yzw * r10.yzw;
      r7.w = dot(r10.yzw, float3(0.212599993,0.715200007,0.0722000003));
      r13.w = r7.w * r4.w;
  ...
  if (r7.w != 0) {
    ...
    if (r6.w != 0) {
      ...
      r9.w = (int)r6.w * 6;
      r13.w = dot(refProbeAttenuationConstantsCB[r9.w].data[0].xyz, r16.yzw);
      r13.w = saturate(refProbeAttenuationConstantsCB[r9.w].data[0].w + r13.w);
      r14.w = dot(refProbeAttenuationConstantsCB[r9.w].data[1].xyz, r16.yzw);
      r14.w = saturate(refProbeAttenuationConstantsCB[r9.w].data[1].w + r14.w);
      r13.w = r14.w * r13.w;
      r14.w = dot(refProbeAttenuationConstantsCB[r9.w].data[2].xyz, r16.yzw);
      r14.w = saturate(refProbeAttenuationConstantsCB[r9.w].data[2].w + r14.w);
      r13.w = r14.w * r13.w;
      r14.w = dot(refProbeAttenuationConstantsCB[r9.w].data[3].xyz, r16.yzw);
      r14.w = saturate(refProbeAttenuationConstantsCB[r9.w].data[3].w + r14.w);
      r13.w = r14.w * r13.w;
      r14.w = dot(refProbeAttenuationConstantsCB[r9.w].data[4].xyz, r16.yzw);
      r14.w = saturate(refProbeAttenuationConstantsCB[r9.w].data[4].w + r14.w);
      r13.w = r14.w * r13.w;
      r14.w = dot(refProbeAttenuationConstantsCB[r9.w].data[5].xyz, r16.yzw);
      ...
      r13.w = 1;
      while (true) {
        r14.w = cmp((int)r13.w >= (int)r7.w);
        if (r14.w != 0) break;
        r14.w = (int)r6.w + (int)r13.w;
        r14.w = (int)r14.w * 6;
        r18.z = dot(refProbeAttenuationConstantsCB[r14.w].data[0].xyz, r16.yzw);
        r18.z = saturate(refProbeAttenuationConstantsCB[r14.w].data[0].w + r18.z);
        r18.z = r20.x * r18.z;
        r18.w = dot(refProbeAttenuationConstantsCB[r14.w].data[1].xyz, r16.yzw);
        r18.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[1].w + r18.w);
        r18.z = r18.z * r18.w;
        r18.w = dot(refProbeAttenuationConstantsCB[r14.w].data[2].xyz, r16.yzw);
        r18.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[2].w + r18.w);
        r18.z = r18.z * r18.w;
        r18.w = dot(refProbeAttenuationConstantsCB[r14.w].data[3].xyz, r16.yzw);
        r18.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[3].w + r18.w);
        r18.z = r18.z * r18.w;
        r18.w = dot(refProbeAttenuationConstantsCB[r14.w].data[4].xyz, r16.yzw);
        r18.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[4].w + r18.w);
        r18.z = r18.z * r18.w;
        r18.w = dot(refProbeAttenuationConstantsCB[r14.w].data[5].xyz, r16.yzw);
  ...
  if (r2.w != 0) {
    ...
    r16.yzw = r10.yzw * r0.yyy + r18.xyz;
    r17.w = 0;
    r10.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r17.xyzw, r3.z).xyz;
    r0.y = sunConstants.globalProbeExposure * r2.w + -r3.w;
    r0.y = r2.y * r0.y + r3.w;
    r15.yzw = r10.yzw * r0.yyy + r15.yzw;
  }
  r0.y = r5.z * r1.w + r2.x;
  r0.y = log2(abs(r0.y));
  r0.y = r1.z * r0.y;
