...
r0.y = samplerLinear[]..swiz;
  ...
  while (true) {
    ...
    r13.w = cmp((uint)r8.w < numRefProbes);
    r9.w = r9.w ? r13.w : 0;
    if (r9.w != 0) {
      r8.w = (int)r8.w * 14;
      if (r1.z != 0) {
        ...
        r12.yzw = refProbeConstantsCB[r8.w].data[0].xyz + eyeOffset.xyz;
        GBufferDiffuseColor[viewID].r9.w = u2.xyzw;
      }
      r20.w = (int)r19.w + 1;
      r12.yzw = -refProbeConstantsCB[r8.w].data[0].xyz + r4.xyw;
      ...
      r14.w = (int)r9.w * 6;
      r16.w = dot(refProbeAttenuationConstantsCB[r14.w].data[0].xyz, r12.yzw);
      r16.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[0].w + r16.w);
      r17.w = dot(refProbeAttenuationConstantsCB[r14.w].data[1].xyz, r12.yzw);
      r17.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[1].w + r17.w);
      r16.w = r17.w * r16.w;
      r17.w = dot(refProbeAttenuationConstantsCB[r14.w].data[2].xyz, r12.yzw);
      r17.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[2].w + r17.w);
      r16.w = r17.w * r16.w;
      r17.w = dot(refProbeAttenuationConstantsCB[r14.w].data[3].xyz, r12.yzw);
      r17.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[3].w + r17.w);
      r16.w = r17.w * r16.w;
      r17.w = dot(refProbeAttenuationConstantsCB[r14.w].data[4].xyz, r12.yzw);
      r17.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[4].w + r17.w);
      r16.w = r17.w * r16.w;
      r17.w = dot(refProbeAttenuationConstantsCB[r14.w].data[5].xyz, r12.yzw);
      r14.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[5].w + r17.w);
      r13.x = r16.w * r14.w;
      r14.w = 1 & (int)refProbeConstantsCB[r8.w].data[6].x;
      r21.xy = r14.ww ? r13.xy : r13.zx;
      r13.x = refProbeConstantsCB[r8.w].data[6].x;
      r22.xy = r21.xy;
      r14.w = 1;
      while (true) {
        ...
        r17.w = r22.x * r17.w;
        r21.z = dot(refProbeAttenuationConstantsCB[r16.w].data[1].xyz, r12.yzw);
        r21.z = saturate(refProbeAttenuationConstantsCB[r16.w].data[1].w + r21.z);
        r17.w = r21.z * r17.w;
        r21.z = dot(refProbeAttenuationConstantsCB[r16.w].data[2].xyz, r12.yzw);
        r21.z = saturate(refProbeAttenuationConstantsCB[r16.w].data[2].w + r21.z);
        r17.w = r21.z * r17.w;
        r21.z = dot(refProbeAttenuationConstantsCB[r16.w].data[3].xyz, r12.yzw);
        r21.z = saturate(refProbeAttenuationConstantsCB[r16.w].data[3].w + r21.z);
        r17.w = r21.z * r17.w;
        r21.z = dot(refProbeAttenuationConstantsCB[r16.w].data[4].xyz, r12.yzw);
        r21.z = saturate(refProbeAttenuationConstantsCB[r16.w].data[4].w + r21.z);
        r17.w = r21.z * r17.w;
        r21.z = dot(refProbeAttenuationConstantsCB[r16.w].data[5].xyz, r12.yzw);
        r16.w = saturate(refProbeAttenuationConstantsCB[r16.w].data[5].w + r21.z);
        r22.x = r17.w * r16.w;
        r21.z = (uint)r13.x >> 2;
        if (1 == 0) r21.w = 0; else if (1+2 < 32) {         r21.w = (uint)r13.x << (32-(1 + 2)); r21.w = (uint)r21.w >> (32-1);        } else r21.w = (uint)r13.x >> 2;
        r22.z = (int)r21.z & 2;
        r22.w = max(r22.y, r22.x);
        r16.w = -r17.w * r16.w + 1;
        r16.w = r22.y * r16.w;
        r15.y = r22.z ? r16.w : r22.w;
        r22.xy = r21.ww ? r22.xy : r15.xy;
        r14.w = (int)r14.w + 1;
        r13.x = r21.z;
      }
      ...
      if (r13.x != 0) {
        ...
        r13.w = r1.z ? r13.w : 0;
        if (r13.w != 0) {
          r13.xw = mad((int2)r13.xx, int2(20,20), int2(860,876));
        // Known bad code for instruction (needs manual fix):
        ...
        r14.w = samplerLinear[]..swiz;
          r14.w = (int)r14.w | 32;
          GBufferDiffuseColor[viewID].r13.x = u2.x;
          GBufferDiffuseColor[viewID].r13.w = u2.x;
        }
        r19.w = (int)r19.w + 257;
        r19.z = r22.y * refProbeConstantsCB[r8.w].data[6].y + r19.z;
        ...
        r13.x = dot(r11.xyz, r21.xyz);
        r13.w = dot(r12.yzw, r21.xyz);
        ...
        r13.w = r14.w / r13.w;
        r13.x = min(r13.x, abs(r13.w));
        r21.x = refProbeConstantsCB[r8.w].data[3].w + r12.y;
        r21.yz = refProbeConstantsCB[r8.w].data[4].xy + r12.zw;
        r21.xyz = r11.xyz * r13.xxx + r21.xyz;
        ...
        r24.w = (uint)r13.w;
        r21.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r24.xyzw, r13.x).xyz;
        r22.xzw = (int3)r21.xyz & int3(-2147483648,-2147483648,-2147483648);
        r22.xzw = cmp((int3)r22.xzw == int3(2139095040,2139095040,2139095040));
        r13.x = (int)r22.z | (int)r22.x;
        r13.x = (int)r22.w | (int)r13.x;
        r21.xyz = r13.xxx ? float3(1,1,0) : r21.xyz;
        r27.x = dot(r12.yzw, r23.xyz);
        r27.y = dot(r12.yzw, r25.xyz);
        r27.z = dot(r12.yzw, r26.xyz);
        r12.yzw = saturate(r27.xyz * refProbeConstantsCB[r8.w].data[3].xyz + float3(0.5,0.5,0.5));
        r27.xy = refProbeConstantsCB[r8.w].data[4].zw * r12.yz;
        r27.z = refProbeConstantsCB[r8.w].data[5].x * r12.w;
        r12.yzw = refProbeConstantsCB[r8.w].data[5].yzw + r27.xyz;
        ...
        r9.w = dot(r21.xyz, float3(0.212599993,0.715200007,0.0722000003));
        r8.w = r3.z * r8.w + r9.w;
        r8.w = r12.y / r8.w;
        r23.x = r18.w;
        r23.yz = r19.xy;
        r12.yzw = r21.xyz * r8.www + r23.xyz;
        r18.w = r12.y;
        r19.xy = r12.zw;
      } else {
        r20.xyz = r19.xyz;
  ...
  while (true) {
    ...
    if (r9.w != 0) {
      ...
      while (true) {
        ...
        r16.w = -r17.w * r16.w + 1;
        r16.w = r23.y * r16.w;
        r15.w = r23.z ? r16.w : r23.w;
        r23.xy = r21.ww ? r23.xy : r15.zw;
        r14.w = (int)r14.w + 1;
        r13.x = r20.w;
      }
      r9.w = saturate(r23.y + -r19.z);
      r13.x = refProbeConstantsCB[r8.w].data[6].y * r9.w;
      r13.w = cmp(0 < r13.x);
      if (r13.w != 0) {
        r13.w = (int)r22.y & 31;
        r14.w = (int)r13.w + -1;
        ...
        r14.w = r1.z ? r14.w : 0;
        if (r14.w != 0) {
          r22.zw = mad((int2)r13.ww, int2(20,20), int2(860,876));
        // Known bad code for instruction (needs manual fix):
        ...
        r15.y = (int)r15.y + 257;
        r15.x = r9.w * refProbeConstantsCB[r8.w].data[6].y + r15.x;
        r9.w = refProbeConstantsCB[r8.w].data[7].y * r13.x;
        r24.x = refProbeConstantsCB[r8.w].data[7].w;
        r24.yz = refProbeConstantsCB[r8.w].data[8].xy;
        r13.x = dot(r11.xyz, r24.xyz);
        r13.w = dot(r12.yzw, r24.xyz);
        r13.w = -refProbeConstantsCB[r8.w].data[8].z + r13.w;
        r14.w = cmp(r13.w >= 0);
        r13.w = max(abs(r13.w), r2.w);
        r13.w = r14.w ? r13.w : -r13.w;
        ...
        r13.x = r13.w / r13.x;
        r13.x = min(131072, abs(r13.x));
        r24.x = refProbeConstantsCB[r8.w].data[8].w;
        r24.yz = refProbeConstantsCB[r8.w].data[9].xy;
        ...
        r13.w = r14.w / r13.w;
        r13.x = min(r13.x, abs(r13.w));
        r24.x = refProbeConstantsCB[r8.w].data[9].w;
        r24.yz = refProbeConstantsCB[r8.w].data[10].xy;
        r13.w = dot(r11.xyz, r24.xyz);
        r14.w = dot(r12.yzw, r24.xyz);
        r14.w = -refProbeConstantsCB[r8.w].data[10].z + r14.w;
        r15.w = cmp(r14.w >= 0);
        ...
        r13.w = r14.w / r13.w;
        r13.x = min(r13.x, abs(r13.w));
        r24.x = refProbeConstantsCB[r8.w].data[10].w;
        r24.yz = refProbeConstantsCB[r8.w].data[11].xy;
        r13.w = dot(r11.xyz, r24.xyz);
        r14.w = dot(r12.yzw, r24.xyz);
        r14.w = -refProbeConstantsCB[r8.w].data[11].z + r14.w;
        r15.w = cmp(r14.w >= 0);
        ...
        r13.w = r14.w / r13.w;
        r13.x = min(r13.x, abs(r13.w));
        r24.x = refProbeConstantsCB[r8.w].data[11].w;
        r24.yz = refProbeConstantsCB[r8.w].data[12].xy;
        r13.w = dot(r11.xyz, r24.xyz);
        r14.w = dot(r12.yzw, r24.xyz);
        r14.w = -refProbeConstantsCB[r8.w].data[12].z + r14.w;
        r15.w = cmp(r14.w >= 0);
        ...
        r13.w = r14.w / r13.w;
        r13.x = min(r13.x, abs(r13.w));
        r24.x = refProbeConstantsCB[r8.w].data[12].w;
        r24.yz = refProbeConstantsCB[r8.w].data[13].xy;
        r13.w = dot(r11.xyz, r24.xyz);
        r14.w = dot(r12.yzw, r24.xyz);
        r14.w = -refProbeConstantsCB[r8.w].data[13].z + r14.w;
        r15.w = cmp(r14.w >= 0);
        ...
        r13.w = r14.w / r13.w;
        r13.x = min(r13.x, abs(r13.w));
        r24.x = refProbeConstantsCB[r8.w].data[3].w + r12.y;
        r24.yz = refProbeConstantsCB[r8.w].data[4].xy + r12.zw;
        r23.xzw = r11.xyz * r13.xxx + r24.xyz;
        r13.w = dot(r23.xzw, r23.xzw);
        r13.w = sqrt(r13.w);
        r13.x = r13.x / r13.w;
        r13.x = r13.x + r13.x;
        r13.x = sqrt(r13.x);
        r13.x = r1.w * 5 + r13.x;
        r13.x = -0.844799995 + r13.x;
        r24.x = refProbeConstantsCB[r8.w].data[0].w;
        r24.y = refProbeConstantsCB[r8.w].data[1].z;
        r24.z = refProbeConstantsCB[r8.w].data[2].y;
        r25.x = dot(r23.xzw, r24.xyz);
        r26.xy = refProbeConstantsCB[r8.w].data[1].xw;
        r26.z = refProbeConstantsCB[r8.w].data[2].z;
        r25.y = dot(r23.xzw, r26.xyz);
        r27.x = refProbeConstantsCB[r8.w].data[1].y;
        r27.yz = refProbeConstantsCB[r8.w].data[2].xw;
        r25.z = dot(r23.xzw, r27.xyz);
        if (9 == 0) r13.w = 0; else if (9+16 < 32) {         r13.w = (uint)refProbeConstantsCB[r8.w].data[7].z << (32-(9 + 16)); r13.w = (uint)r13.w >> (32-9);        } else r13.w = (uint)refProbeConstantsCB[r8.w].data[7].z >> 16;
        r25.w = (uint)r13.w;
        r23.xzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r25.xyzw, r13.x).xyz;
        ...
        r23.xzw = r13.xxx ? float3(1,1,0) : r23.xzw;
        r28.x = dot(r12.yzw, r24.xyz);
        r28.y = dot(r12.yzw, r26.xyz);
        r28.z = dot(r12.yzw, r27.xyz);
        r12.yzw = saturate(r28.xyz * refProbeConstantsCB[r8.w].data[3].xyz + float3(0.5,0.5,0.5));
        r28.xy = refProbeConstantsCB[r8.w].data[4].zw * r12.yz;
        r28.z = refProbeConstantsCB[r8.w].data[5].x * r12.w;
        r12.yzw = refProbeConstantsCB[r8.w].data[5].yzw + r28.xyz;
        ...
        r9.w = dot(r23.xzw, float3(0.212599993,0.715200007,0.0722000003));
        r8.w = r3.z * r8.w + r9.w;
        r8.w = r12.y / r8.w;
        r21.xyz = r23.xzw * r8.www + r21.xyz;
      } else {
        r22.x = r15.x;
        r15.xy = r22.xy;
      }
