...
min r2.z, |r17.w|, |r17.z|
min r2.z, r2.z, |r17.y|
min r2.z, r2.z, |r17.x|
max r2.w, |r17.w|, |r17.z|
max r2.w, r2.w, |r17.y|
max r2.w, r2.w, |r17.x|
eq r3.yzw, r2.zzzz, |r17.yyzw|
movc r2.z, r3.y, r16.y, r16.x
movc r2.z, r3.z, r16.z, r2.z
movc r2.z, r3.w, r16.w, r2.z
...
loop 
  ...
  loop 
    ...
    loop 
      ...
      dp3 r25.z, cb11[r19.w + 1].xyzx, r14.yzwy
      add_sat r25.z, r25.z, cb11[r19.w + 1].w
      mul r20.w, r20.w, r25.z
      dp3 r25.z, cb11[r19.w + 2].xyzx, r14.yzwy
      add_sat r25.z, r25.z, cb11[r19.w + 2].w
      mul r20.w, r20.w, r25.z
      dp3 r25.z, cb11[r19.w + 3].xyzx, r14.yzwy
      add_sat r25.z, r25.z, cb11[r19.w + 3].w
      mul r20.w, r20.w, r25.z
      dp3 r25.z, cb11[r19.w + 4].xyzx, r14.yzwy
      add_sat r25.z, r25.z, cb11[r19.w + 4].w
      mul r20.w, r20.w, r25.z
      dp3 r25.z, cb11[r19.w + 5].xyzx, r14.yzwy
      add_sat r19.w, r25.z, cb11[r19.w + 5].w
      mul r25.x, r19.w, r20.w
      ushr r25.z, r16.x, l(2)
      ubfe r25.w, l(1), l(2), r16.x
      and r26.x, r25.z, l(2)
      max r26.y, r25.x, r25.y
      mad r19.w, -r20.w, r19.w, l(1.000000)
      mul r19.w, r19.w, r25.y
      movc r18.y, r26.x, r19.w, r26.y
      movc r25.xy, r25.wwww, r25.xyxx, r18.xyxx
    ...
    if_nz r16.x
      mad r24.z, r25.y, cb10[r10.w + 6].y, r24.z
      ...
      mad r18.yzw, r15.xxyz, r16.xxxx, r26.xxyz
      dp3 r16.w, r18.yzwy, r18.yzwy
      sqrt r16.w, r16.w
      div r16.x, r16.x, r16.w
      add r16.x, r16.x, r16.x
      sqrt r16.x, r16.x
      mad r16.x, r2.w, l(5.000000), r16.x
      ...
      utof r27.w, r16.w
      sample_l_indexable(texturecubearray)(float,float,float,float) r18.yzw, r27.xyzw, t8.wxyz, s2, r16.x
      ...
      mov r26.x, r23.w
      mov r26.yz, r24.xxyx
      mad r24.xyw, r18.zwzy, r10.wwww, r26.yzyx
      mov r23.w, r24.w
    endif 
  endloop 
  ...
  loop 
    ...
    loop 
      ...
      loop 
        ...
        mov r16.x, r26.z
      endloop 
      add_sat r16.x, -r13.w, r27.y
      mul r18.y, r16.x, cb10[r17.w + 6].y
      lt r18.z, l(0.000000), r18.y
      if_nz r18.z
        mad r24.w, r16.x, cb10[r17.w + 6].y, r24.w
        mul r16.x, r18.y, cb10[r17.w + 7].y
        ...
        mad r14.yzw, r25.xxyz, r26.xxyz, r14.yyzw
        mul r17.w, r3.w, r17.z
...
ret 
// Approximately 1432 instruction slots used
