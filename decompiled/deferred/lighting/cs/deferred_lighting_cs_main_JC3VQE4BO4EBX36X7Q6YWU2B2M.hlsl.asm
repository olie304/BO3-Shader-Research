...
loop 
  ieq r15.z, r15.y, l(2)
  breakc_nz r15.z
  movc r15.z, r15.y, r0.y, r15.x
  uge r15.w, r15.z, r12.w
  ult r17.w, r15.z, cb2[0].y
  ...
  if_nz r15.w
    ...
    if_nz r3.z
      ...
      store_structured u2.xyzw, cb2[52].x, r15.w, r16.xyzw
    endif 
    iadd r24.w, r23.w, l(1)
    add r16.yzw, r5.yyzw, -cb10[r15.z + 0].xxyz
    ...
    loop 
      ...
      movc r19.y, r26.z, r20.w, r26.w
      movc r26.xy, r25.wwww, r26.xyxx, r19.xyxx
      iadd r18.w, r18.w, l(1)
      mov r17.x, r25.z
    endloop 
    mov_sat r26.y, r26.y
    mul r15.w, r26.y, cb10[r15.z + 6].y
    ...
    if_nz r17.x
      ...
      if_nz r17.w
        ...
        store_structured u2.x, cb2[52].x, r17.w, r15.w
      endif 
      iadd r23.w, r23.w, l(257)
      mad r23.z, r26.y, cb10[r15.z + 6].y, r23.z
      mul r15.w, r15.w, cb10[r15.z + 7].y
      mov r25.x, cb10[r15.z + 7].w
      mov r25.yz, cb10[r15.z + 8].xxyx
      dp3 r17.x, r14.xyzx, r25.xyzx
      ...
      mov r25.x, cb10[r15.z + 8].w
      mov r25.yz, cb10[r15.z + 9].xxyx
      ...
      mov r25.x, cb10[r15.z + 9].w
      mov r25.yz, cb10[r15.z + 10].xxyx
      dp3 r17.w, r14.xyzx, r25.xyzx
      dp3 r18.w, r16.yzwy, r25.xyzx
      ...
      div r17.w, r18.w, r17.w
      min r17.x, |r17.w|, r17.x
      mov r25.x, cb10[r15.z + 10].w
      mov r25.yz, cb10[r15.z + 11].xxyx
      dp3 r17.w, r14.xyzx, r25.xyzx
      dp3 r18.w, r16.yzwy, r25.xyzx
      ...
      div r17.w, r18.w, r17.w
      min r17.x, |r17.w|, r17.x
      mov r25.x, cb10[r15.z + 11].w
      mov r25.yz, cb10[r15.z + 12].xxyx
      dp3 r17.w, r14.xyzx, r25.xyzx
      dp3 r18.w, r16.yzwy, r25.xyzx
      ...
      div r17.w, r18.w, r17.w
      min r17.x, |r17.w|, r17.x
      mov r25.x, cb10[r15.z + 12].w
      mov r25.yz, cb10[r15.z + 13].xxyx
      dp3 r17.w, r14.xyzx, r25.xyzx
      dp3 r18.w, r16.yzwy, r25.xyzx
      ...
      div r17.w, r18.w, r17.w
      min r17.x, |r17.w|, r17.x
      add r25.x, r16.y, cb10[r15.z + 3].w
      add r25.yz, r16.zzwz, cb10[r15.z + 4].xxyx
      mad r25.xyz, r14.xyzx, r17.xxxx, r25.xyzx
      ...
      mov r27.x, cb10[r15.z + 0].w
      mov r27.y, cb10[r15.z + 1].z
      mov r27.z, cb10[r15.z + 2].y
      dp3 r28.x, r25.xyzx, r27.xyzx
      mov r29.xy, cb10[r15.z + 1].xwxx
      mov r29.z, cb10[r15.z + 2].z
      dp3 r28.y, r25.xyzx, r29.xyzx
      mov r30.x, cb10[r15.z + 1].y
      mov r30.yz, cb10[r15.z + 2].xxwx
      ...
      mad_sat r16.yzw, r31.xxyz, cb10[r15.z + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
      mul r31.xy, r16.yzyy, cb10[r15.z + 4].zwzz
      mul r31.z, r16.w, cb10[r15.z + 5].x
      add r16.yzw, r31.xxyz, cb10[r15.z + 5].yyzw
      ...
      or r15.z, r27.y, r27.x
      or r15.z, r27.z, r15.z
      movc r26.xzw, r15.zzzz, l(1.000000,0,1.000000,0), r26.xxzw
...
loop 
  ieq r18.w, r17.w, l(2)
  breakc_nz r18.w
  movc r18.w, r17.w, r0.y, r15.x
  ult r20.w, r18.w, r12.w
  if_nz r20.w
    imul null, r18.w, r18.w, l(14)
    if_nz r3.z
      and r20.w, r19.y, l(15)
    ...
    add r16.yzw, r5.yyzw, -cb10[r18.w + 0].xxyz
    ...
    mul r17.x, r24.w, r25.z
    and r24.w, l(1), cb10[r18.w + 6].x
    movc r25.zw, r24.wwww, r17.xxxy, r17.zzzx
    mov r17.x, cb10[r18.w + 6].x
    mov r26.xy, r25.zwzz
    mov r24.w, l(1)
    loop 
      ige r26.z, r24.w, r21.w
      breakc_nz r26.z
      iadd r26.z, r20.w, r24.w
      imul null, r26.z, r26.z, l(6)
      dp3 r26.w, cb11[r26.z + 0].xyzx, r16.yzwy
      add_sat r26.w, r26.w, cb11[r26.z + 0].w
      mul r26.w, r26.w, r26.x
      dp3 r27.x, cb11[r26.z + 1].xyzx, r16.yzwy
      add_sat r27.x, r27.x, cb11[r26.z + 1].w
      mul r26.w, r26.w, r27.x
      dp3 r27.x, cb11[r26.z + 2].xyzx, r16.yzwy
      add_sat r27.x, r27.x, cb11[r26.z + 2].w
      mul r26.w, r26.w, r27.x
      dp3 r27.x, cb11[r26.z + 3].xyzx, r16.yzwy
      add_sat r27.x, r27.x, cb11[r26.z + 3].w
      mul r26.w, r26.w, r27.x
      dp3 r27.x, cb11[r26.z + 4].xyzx, r16.yzwy
      add_sat r27.x, r27.x, cb11[r26.z + 4].w
      mul r26.w, r26.w, r27.x
      dp3 r27.x, cb11[r26.z + 5].xyzx, r16.yzwy
      add_sat r26.z, r27.x, cb11[r26.z + 5].w
      mul r26.x, r26.z, r26.w
      ushr r27.x, r17.x, l(2)
      ubfe r27.y, l(1), l(2), r17.x
      and r27.z, r27.x, l(2)
      max r27.w, r26.x, r26.y
      mad r26.z, -r26.w, r26.z, l(1.000000)
      mul r26.z, r26.z, r26.y
      movc r19.w, r27.z, r26.z, r27.w
      movc r26.xy, r27.yyyy, r26.xyxx, r19.zwzz
    ...
    if_nz r20.w
      and r20.w, r25.y, l(31)
      iadd r21.w, r20.w, l(-1)
      ult r21.w, r21.w, l(32)
      and r21.w, r3.z, r21.w
      if_nz r21.w
        imad r25.zw, r20.wwww, l(0, 0, 20, 20), l(0, 0, 860, 876)
        ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r20.w, cb2[52].x, r25.z, u2.xxxx
        or r20.w, r20.w, l(32)
        store_structured u2.x, cb2[52].x, r25.z, r20.w
        store_structured u2.x, cb2[52].x, r25.w, r19.w
      endif 
      iadd r19.y, r19.y, l(257)
      mad r19.x, r17.x, cb10[r18.w + 6].y, r19.x
      ...
      mad r26.xzw, r14.xxyz, r19.wwww, r27.xxyz
      dp3 r20.w, r26.xzwx, r26.xzwx
      sqrt r20.w, r20.w
      ...
      utof r28.w, r20.w
      sample_l_indexable(texturecubearray)(float,float,float,float) r26.xzw, r28.xyzw, t8.xwyz, s2, r19.w
      ...
      movc r26.xzw, r19.wwww, l(1.000000,0,1.000000,0), r26.xxzw
      dp3 r31.x, r16.yzwy, r27.xyzx
      dp3 r31.y, r16.yzwy, r29.xyzx
      dp3 r31.z, r16.yzwy, r30.xyzx
      mad_sat r16.yzw, r31.xxyz, cb10[r18.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
      mul r31.xy, r16.yzyy, cb10[r18.w + 4].zwzz
      mul r31.z, r16.w, cb10[r18.w + 5].x
      add r16.yzw, r31.xxyz, cb10[r18.w + 5].yyzw
      dp3 r28.x, r11.xyzx, r27.xyzx
      dp3 r28.y, r11.xyzx, r29.xyzx
      dp3 r28.z, r11.xyzx, r30.xyzx
      ...
      or r18.z, r28.y, r28.x
      or r18.z, r28.z, r18.z
      movc r27.xyz, r18.zzzz, l(1.000000,1.000000,0,0), r27.xyzx
      mul r28.xyz, r16.yzwy, r27.xyzx
      dp3 r18.z, r28.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r15.yzw, r16.yyzw, r27.xxyz, r15.yyzw
...
bfi r6.w, l(8), l(0), r19.y, r23.w
movc r0.y, r0.y, r6.w, r19.y
max r6.w, r19.x, l(1.000000)
rcp r6.w, r6.w
mov_sat r19.x, r19.x
mul r16.xyz, r6.wwww, r15.yzwy
mul r17.xyz, r6.wwww, r24.xyzx
lt r9.w, r19.x, l(0.990000)
if_nz r9.w
  iadd r0.y, r0.y, l(256)
  add r9.w, -r19.x, l(1.000000)
  ...
  mad r16.xyz, r15.yzwy, r6.wwww, r18.xyzx
  mov r14.w, l(0)
...
ret 
// Approximately 1814 instruction slots used
