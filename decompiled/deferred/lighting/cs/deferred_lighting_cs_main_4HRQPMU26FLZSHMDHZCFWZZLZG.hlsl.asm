...
min r2.w, r2.w, |r18.y|
min r2.w, r2.w, |r18.x|
max r5.w, |r18.w|, |r18.z|
max r5.w, r5.w, |r18.y|
max r5.w, r5.w, |r18.x|
eq r15.yzw, r2.wwww, |r18.yyzw|
movc r2.w, r15.y, r17.y, r17.x
movc r2.w, r15.z, r17.z, r2.w
movc r2.w, r15.w, r17.w, r2.w
...
loop 
  ...
  loop 
    ...
    add r26.xyz, r10.xyzx, -cb10[r19.z + 0].xyzx
...
if_nz r15.y
  ...
  loop 
    ...
    loop 
      ...
      add r27.xyz, r10.xyzx, -cb10[r21.w + 0].xyzx
...
if_nz r8.w
  ...
  mov r16.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r18.xyz, r16.xyzw, t8.xyzw, s2, r9.y
...
if_nz r2.z
  ...
  if_nz r2.z
    ...
    if_nz r8.w
      ...
      mov r23.xyz, cb9[r4.z + 4].yzwy
      mov r23.w, cb9[r4.z + 5].x
      mov r22.w, l(1.000000)
      dp4 r23.x, r23.xyzw, r22.xyzw
      mov r24.xyz, cb9[r4.z + 5].yzwy
      mov r24.w, cb9[r4.z + 6].x
      ...
      add r23.x, r9.y, cb9[r4.z + 9].w
      add r23.y, r9.w, cb9[r4.z + 10].x
      mul r9.yw, r23.xxxy, cb9[r4.z + 9].yyyz
      ...
      if_z r8.w
        ...
        mad r22.x, r9.y, cb9[r4.z + 8].y, cb9[r4.z + 8].z
        mad r22.y, r9.w, cb9[r4.z + 8].w, cb9[r4.z + 9].x
        ...
        if_nz cb2[58].y
          ...
          loop 
            ige r12.w, r11.w, l(8)
            breakc_nz r12.w
            dp2 r25.x, icb[r11.w + 0].yxyy, r23.xyxx
            dp2 r25.y, icb[r11.w + 0].yxyy, r23.yzyy
            mad r24.xy, r25.xyxx, cb9[r4.z + 3].yyyy, r22.xyxx
            sample_c_lz_indexable(texture2darray)(float,float,float,float) r12.w, r24.xyzx, t9.xxxx, s13, r8.w
            mad r9.w, r12.w, l(0.125000), r9.w
            iadd r11.w, r11.w, l(1)
          endloop 
        else 
          utof r22.z, r9.y
          sample_c_lz_indexable(texture2darray)(float,float,float,float) r9.w, r22.xyzx, t9.xxxx, s13, r8.w
        endif 
        mul r4.z, r9.w, r9.w
        mul r4.z, r9.w, r4.z
      else 
    ...
    mad r23.yzw, r2.zzzz, r21.xxyz, r17.xxyz
    ...
    mad r15.yzw, r4.zzzz, r21.xxyz, r19.zzxy
