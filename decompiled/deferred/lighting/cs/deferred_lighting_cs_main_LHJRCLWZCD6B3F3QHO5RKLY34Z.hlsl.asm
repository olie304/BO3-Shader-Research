...
if_nz r8.w
  ...
  if_nz r2.z
    add r17.yzw, cb1[24].xxyz, cb10[r8.w + 0].xxyz
    mov r17.x, l(16)
    store_structured u2.xyzw, cb2[52].x, l(880), r17.xyzw
  endif 
  add r14.yzw, r11.xxyz, -cb10[r8.w + 0].xxyz
  ...
  mov r15.w, l(1)
  loop 
    ige r17.z, r15.w, r10.w
    breakc_nz r17.z
    iadd r17.z, r9.w, r15.w
  ...
  if_nz r10.w
    ...
    mov r17.x, cb10[r8.w + 7].w
    mov r17.yz, cb10[r8.w + 8].xxyx
    dp3 r13.w, r16.xyzx, r17.xyzx
    dp3 r15.y, r14.yzwy, r17.xyzx
    add r15.y, r15.y, -cb10[r8.w + 8].z
    ...
    mov r17.x, cb10[r8.w + 8].w
    mov r17.yz, cb10[r8.w + 9].xxyx
    dp3 r15.y, r16.xyzx, r17.xyzx
    dp3 r15.z, r14.yzwy, r17.xyzx
    add r15.z, r15.z, -cb10[r8.w + 9].z
    ...
    mov r17.x, cb10[r8.w + 9].w
    mov r17.yz, cb10[r8.w + 10].xxyx
    dp3 r15.y, r16.xyzx, r17.xyzx
    dp3 r15.z, r14.yzwy, r17.xyzx
    add r15.z, r15.z, -cb10[r8.w + 10].z
    ge r15.w, r15.z, l(0.000000)
    max r15.z, r4.w, |r15.z|
    movc r15.z, r15.w, r15.z, -r15.z
    max r15.y, -r15.y, l(0.00000010)
    div r15.y, r15.z, r15.y
    min r13.w, r13.w, |r15.y|
    mov r17.x, cb10[r8.w + 10].w
    mov r17.yz, cb10[r8.w + 11].xxyx
    dp3 r15.y, r16.xyzx, r17.xyzx
    dp3 r15.z, r14.yzwy, r17.xyzx
    add r15.z, r15.z, -cb10[r8.w + 11].z
    ge r15.w, r15.z, l(0.000000)
    max r15.z, r4.w, |r15.z|
    movc r15.z, r15.w, r15.z, -r15.z
    max r15.y, -r15.y, l(0.00000010)
    div r15.y, r15.z, r15.y
    min r13.w, r13.w, |r15.y|
    mov r17.x, cb10[r8.w + 11].w
    mov r17.yz, cb10[r8.w + 12].xxyx
    dp3 r15.y, r16.xyzx, r17.xyzx
    dp3 r15.z, r14.yzwy, r17.xyzx
    add r15.z, r15.z, -cb10[r8.w + 12].z
    ge r15.w, r15.z, l(0.000000)
    max r15.z, r4.w, |r15.z|
    movc r15.z, r15.w, r15.z, -r15.z
    max r15.y, -r15.y, l(0.00000010)
    div r15.y, r15.z, r15.y
    min r13.w, r13.w, |r15.y|
    mov r17.x, cb10[r8.w + 12].w
    mov r17.yz, cb10[r8.w + 13].xxyx
    dp3 r15.y, r16.xyzx, r17.xyzx
    dp3 r15.z, r14.yzwy, r17.xyzx
    add r15.z, r15.z, -cb10[r8.w + 13].z
    ge r15.w, r15.z, l(0.000000)
    max r15.z, r4.w, |r15.z|
    movc r15.z, r15.w, r15.z, -r15.z
    max r15.y, -r15.y, l(0.00000010)
    div r15.y, r15.z, r15.y
    min r13.w, r13.w, |r15.y|
    add r17.x, r14.y, cb10[r8.w + 3].w
    add r17.yz, r14.zzwz, cb10[r8.w + 4].xxyx
    ...
    mov r17.x, cb10[r8.w + 0].w
    mov r17.y, cb10[r8.w + 1].z
    mov r17.z, cb10[r8.w + 2].y
    dp3 r18.x, r15.yzwy, r17.xyzx
    mov r19.xy, cb10[r8.w + 1].xwxx
    mov r19.z, cb10[r8.w + 2].z
    dp3 r18.y, r15.yzwy, r19.xyzx
    mov r20.x, cb10[r8.w + 1].y
    mov r20.yz, cb10[r8.w + 2].xxwx
    dp3 r18.z, r15.yzwy, r20.xyzx
    ubfe r15.y, l(9), l(16), cb10[r8.w + 7].z
    utof r18.w, r15.y
    ...
    mad_sat r14.yzw, r21.xxyz, cb10[r8.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
    mul r21.xy, r14.yzyy, cb10[r8.w + 4].zwzz
    mul r21.z, r14.w, cb10[r8.w + 5].x
    add r14.yzw, r21.xxyz, cb10[r8.w + 5].yyzw
...
if_nz r7.w
  ...
  if_nz r2.z
    ...
    mov r17.x, l(16)
    store_structured u2.xyzw, cb2[52].x, r7.w, r17.xyzw
  endif 
  iadd r7.w, r8.w, l(1)
  ...
  loop 
    ...
    mov r17.w, r19.w
  endloop 
  add_sat r10.w, -r9.w, r20.y
  mul r13.w, r10.w, cb10[r0.y + 6].y
  ...
  if_nz r17.w
    ...
    if_nz r18.x
      ...
      store_structured u2.x, cb2[52].x, r18.y, r13.w
    endif 
    iadd r7.w, r8.w, l(257)
    mad r10.w, r10.w, cb10[r0.y + 6].y, r9.w
...
ret 
// Approximately 1670 instruction slots used
