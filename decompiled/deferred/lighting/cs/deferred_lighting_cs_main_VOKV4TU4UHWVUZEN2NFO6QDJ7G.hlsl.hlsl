  ...
  if (r2.z != 0) {
    ...
    if (r2.z != 0) {
      ...
      if (sunConstants.sunCookieIndex != 0) {
        ...
        r6.w = dot(sunConstants.sunCookieTransform[1].xyzw, r19.xyzw);
        r19.x = frac(r4.z);
        r19.y = frac(r6.w);
      ...
      if (r6.w != 0) {
        ...
        if (r6.w == 0) {
          ...
          r6.w = lightConstantsCB[r4.z].data[10].y + r6.w;
          r6.w = r6.w / lightConstantsCB[r4.z].data[10].z;
          r6.w = max(6.10351563e-05, r6.w);
          r8.w = 0x0000ffff & (int)lightConstantsCB[r4.z].data[1].w;
          if (enableDitheredShadow != 0) {
            r20.x = -r13.x;
            r21.z = (uint)r8.w;
            r20.y = r14.x;
            ...
            while (true) {
              ...
              r13.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r21.xyz, r6.w).x;
      ...
      r4.z = r4.z * r7.w;
      r2.w = cmp(0 < r2.w);
      r19.xyz = r4.zzz * r15.yzw + r17.xyz;
      ...
      r6.w = abs(r4.z) * r0.w + -abs(r4.z);
      r4.z = abs(r4.z) * r6.w + 1;
      r5.w = r5.w * r1.w + r2.y;
      r4.z = r4.z * r4.z;
      r4.z = r4.z * r5.w;
      r4.z = rcp(r4.z);
