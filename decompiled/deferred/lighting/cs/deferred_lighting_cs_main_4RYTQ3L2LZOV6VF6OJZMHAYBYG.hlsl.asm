...
mad r15.xy, -r4.zzzz, l(10.000000, 5.000000, 0.000000, 0.000000), l(6.857410, 7.085000, 0.000000, 0.000000)
exp r7.w, r15.x
mul r7.w, r2.x, r7.w
mul r7.w, r7.w, l(9.136810)
mul r8.w, r4.z, r4.w
mad r8.w, -r8.w, l(2.015905), r15.y
exp r8.w, r8.w
mul r8.w, r2.x, r8.w
...
if_nz cb2[54].x
  ...
  loop 
    uge r27.z, r26.w, cb2[0].y
    breakc_nz r27.z
    ushr r27.z, r26.w, l(5)
    iadd r27.z, r8.w, r27.z
    ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r27.z, r27.z, l(0), t26.xxxx
...
if_nz r9.w
  ...
  loop 
    ...
    breakc_nz r20.w
    iadd r20.w, r8.w, r17.w
    imul null, r20.w, r20.w, l(6)
    dp3 r26.w, cb11[r20.w + 0].xyzx, r26.xyzx
    add_sat r26.w, r26.w, cb11[r20.w + 0].w
    mul r26.w, r26.w, r32.x
    dp3 r27.y, cb11[r20.w + 1].xyzx, r26.xyzx
    add_sat r27.y, r27.y, cb11[r20.w + 1].w
    mul r26.w, r26.w, r27.y
    dp3 r27.y, cb11[r20.w + 2].xyzx, r26.xyzx
    add_sat r27.y, r27.y, cb11[r20.w + 2].w
    mul r26.w, r26.w, r27.y
    dp3 r27.y, cb11[r20.w + 3].xyzx, r26.xyzx
    add_sat r27.y, r27.y, cb11[r20.w + 3].w
    mul r26.w, r26.w, r27.y
    dp3 r27.y, cb11[r20.w + 4].xyzx, r26.xyzx
    add_sat r27.y, r27.y, cb11[r20.w + 4].w
    mul r26.w, r26.w, r27.y
    dp3 r27.y, cb11[r20.w + 5].xyzx, r26.xyzx
    add_sat r20.w, r27.y, cb11[r20.w + 5].w
    mul r32.x, r20.w, r26.w
    ushr r27.y, r16.w, l(2)
    ubfe r27.z, l(1), l(2), r16.w
    and r27.w, r27.y, l(2)
    max r28.w, r32.x, r32.y
    mad r20.w, -r26.w, r20.w, l(1.000000)
    mul r20.w, r20.w, r32.y
    movc r31.y, r27.w, r20.w, r28.w
    movc r32.xy, r27.zzzz, r32.xyxx, r31.xyxx
    iadd r17.w, r17.w, l(1)
    mov r16.w, r27.y
  endloop 
  mov_sat r32.y, r32.y
  mul r31.w, r19.x, r32.y
  lt r8.w, l(0.000000), r31.w
  if_nz r8.w
    if_nz r2.w
    ...
    dp3 r19.x, r12.xyzx, r30.xyzx
    dp3 r19.y, r12.xyzx, r15.xyzx
    dp3 r19.z, r12.xyzx, r28.xyzx
...
if_z r9.w
  ...
  loop 
    ...
    loop 
      ...
      if_nz r19.y
        ...
        dp3 r30.y, r12.xyzx, r32.xyzx
        dp3 r30.z, r12.xyzx, r33.xyzx
  ...
  loop 
    ...
    loop 
      ...
      movc r30.xy, r24.wwww, r17.xyxx, r17.zxzz
      ...
      if_nz r20.w
        ...
        if_nz r21.w
          ...
          store_structured u2.x, cb2[52].x, r30.y, r19.w
        endif 
        iadd r29.z, r29.z, l(257)
        mad r29.x, r17.x, cb10[r18.w + 6].y, r29.x
        mul r17.x, r19.w, cb10[r18.w + 7].y
        mov r30.x, cb10[r18.w + 7].w
        mov r30.yz, cb10[r18.w + 8].xxyx
        dp3 r19.w, r14.xyzx, r30.xyzx
        dp3 r20.w, r16.yzwy, r30.xyzx
        ...
        mov r30.x, cb10[r18.w + 8].w
        mov r30.yz, cb10[r18.w + 9].xxyx
        ...
        mov r30.x, cb10[r18.w + 9].w
        mov r30.yz, cb10[r18.w + 10].xxyx
        dp3 r20.w, r14.xyzx, r30.xyzx
        dp3 r21.w, r16.yzwy, r30.xyzx
        ...
        div r20.w, r21.w, r20.w
        min r19.w, r19.w, |r20.w|
        mov r30.x, cb10[r18.w + 10].w
        mov r30.yz, cb10[r18.w + 11].xxyx
        dp3 r20.w, r14.xyzx, r30.xyzx
        dp3 r21.w, r16.yzwy, r30.xyzx
        ...
        div r20.w, r21.w, r20.w
        min r19.w, r19.w, |r20.w|
        mov r30.x, cb10[r18.w + 11].w
        mov r30.yz, cb10[r18.w + 12].xxyx
        dp3 r20.w, r14.xyzx, r30.xyzx
        dp3 r21.w, r16.yzwy, r30.xyzx
        ...
        div r20.w, r21.w, r20.w
        min r19.w, r19.w, |r20.w|
        mov r30.x, cb10[r18.w + 12].w
        mov r30.yz, cb10[r18.w + 13].xxyx
        dp3 r20.w, r14.xyzx, r30.xyzx
        dp3 r21.w, r16.yzwy, r30.xyzx
        ...
        div r20.w, r21.w, r20.w
        min r19.w, r19.w, |r20.w|
        add r30.x, r16.y, cb10[r18.w + 3].w
        add r30.yz, r16.zzwz, cb10[r18.w + 4].xxyx
        mad r30.xyz, r14.xyzx, r19.wwww, r30.xyzx
        dp3 r20.w, r30.xyzx, r30.xyzx
        sqrt r20.w, r20.w
        div r19.w, r19.w, r20.w
        add r19.w, r19.w, r19.w
        sqrt r19.w, r19.w
        mad r19.w, r4.z, l(5.000000), r19.w
        ...
        utof r34.w, r20.w
        sample_l_indexable(texturecubearray)(float,float,float,float) r30.xyz, r34.xyzw, t8.xyzw, s2, r19.w
        ...
        movc r30.xyz, r19.wwww, l(1.000000,1.000000,0,0), r30.xyzx
  ...
  and r6.w, r23.w, l(0x0000ff00)
  bfi r6.w, l(8), l(0), r26.y, r6.w
  movc r8.w, r4.z, r6.w, r26.y
  max r4.z, r26.x, l(1.000000)
  rcp r4.z, r4.z
  mov_sat r26.x, r26.x
  mul r15.xyz, r4.zzzz, r24.xyzx
  ...
  if_nz r6.w
    ...
    mad r15.xyz, r24.xyzx, r4.zzzz, r16.xyzx
    mov r14.w, l(0)
    sample_l_indexable(texturecubearray)(float,float,float,float) r16.xyz, r14.xyzw, t8.xyzw, s2, r4.w
    mad r4.z, cb2[19].x, r6.w, -r7.w
    mad r4.z, r2.y, r4.z, r7.w
    mad r31.xyz, r16.xyzx, r4.zzzz, r31.xyzx
  endif 
else 
...
switch r6.w
  ...
  if_nz r16.w
    sqrt r16.w, r12.w
    mul r17.y, cb9[r0.x + 3].x, cb9[r0.x + 3].x
    div r12.w, r17.y, r12.w
    ...
    if_nz r16.w
      ...
      if_nz r16.w
        ...
        lt r17.y, r14.w, l(0.000000)
        and r17.y, r3.z, r17.y
      ...
      lt r16.w, l(0.000000), r12.w
      if_nz r16.w
        mul r16.w, r0.w, cb9[r0.x + 1].z
        mul r16.w, r16.w, l(0.250000)
        dp3 r17.y, r18.xyzx, r14.xyzx
        dp3 r14.x, r14.xyzx, r20.xyzx
        mad r14.y, -r17.y, r17.y, cb9[r0.x + 6].y
        mad r9.w, r17.y, r14.x, -r9.w
        ...
        if_nz r10.w
          ...
          if_z r18.w
            ...
            if_z r19.z
              ...
              mul r19.x, r17.y, cb9[r9.w + 10].z
              mad r10.w, cb9[r9.w + 10].y, r17.y, r10.w
          ...
          if_z r17.y
            ...
            and r17.y, l(0x0000ffff), cb9[r9.w + 1].w
            if_nz cb2[58].y
              mov r19.x, -r4.x
              utof r21.z, r17.y
              mov r19.y, r13.x
        ...
        mad r14.y, r14.w, r1.w, r2.y
        mul r14.x, r14.x, r14.x
        mul r14.x, r14.y, r14.x
        rcp r14.x, r14.x
        mul r14.y, r16.w, r14.w
        mul r14.x, r14.y, r14.x
        mul r14.x, r12.w, r14.x
        mad r14.yzw, r14.xxxx, r19.xxyz, r13.yyzw
        ...
        mad r19.xyz, r9.wwww, r19.xyzx, r16.xyzx
        and r19.xyz, r3.zzzz, r19.xyzx
        movc r4.yzw, r10.wwww, r20.xxyz, r4.yyzw
        movc r16.xyz, r10.wwww, r16.xyzx, r19.xyzx
        movc r17.xzw, r10.wwww, r18.xxyz, r17.xxzw
        movc r13.yzw, r10.wwww, r14.yyzw, r13.yyzw
        if_nz r2.w
            ...
            if_z r15.w
              ...
              if_nz cb2[58].y
                ...
                loop 
                  ...
                  mad r21.xy, r22.xyxx, cb9[r0.x + 3].yyyy, r20.xyxx
                  sample_c_lz_indexable(texture2darray)(float,float,float,float) r16.w, r21.xyzx, t9.xxxx, s13, r1.z
                  mad r4.x, r16.w, l(0.125000), r4.x
...
ret 
// Approximately 2492 instruction slots used
