...
and r7.w, r7.w, r8.w
if_nz r7.w
  mul r14.yzw, r5.yyyy, cb1[9].xxyw
  mad r14.yzw, r5.xxxx, cb1[8].xxyw, r14.yyzw
  mad r14.yzw, r5.zzzz, cb1[10].xxyw, r14.yyzw
  add r14.yzw, r14.yyzw, cb1[11].xxyw
  mad r15.yzw, r16.xxyz, l(0.000000, 2000.000000, 2000.000000, 2000.000000), r5.xxyz
  ...
  if_nz r7.w
    ...
    mul r3.zw, r3.zzzw, |r20.xxxy|
    max r3.z, r3.w, r3.z
    log r3.z, r3.z
    round_pi r3.z, r3.z
    max r3.z, r3.z, l(0.000000)
    sample_l_indexable(texture2d)(float,float,float,float) r3.w, r17.xyxx, t28.yzwx, s1, r3.z
    ...
    sample_l_indexable(texture2d)(float,float,float,float) r9.w, r21.xyxx, t28.yzwx, s1, r3.z
    min r7.w, |r7.w|, |r9.w|
    mul r7.w, r21.z, r7.w
    ...
    sample_l_indexable(texture2d)(float,float,float,float) r8.w, r21.xyxx, t28.yzwx, s1, r3.z
    min r7.w, |r7.w|, |r8.w|
    mul r7.w, r21.z, r7.w
    lt r7.w, r7.w, l(1.000000)
    iadd r9.w, r3.w, l(8)
    ...
    loop 
      ...
      mad r18.xyw, r19.xyxz, r12.wwww, r17.xyxz
      sample_l_indexable(texture2d)(float,float,float,float) r12.w, r18.xyxx, t28.yzwx, s1, l(0.000000)
      ...
      loop 
        ...
        if_nz r24.z
          ...
          movc r24.w, r25.w, l(1.000000), r10.w
...
mul r7.w, r3.w, l(5.000000)
mad r8.w, r3.w, l(5.000000), l(-2.500000)
mul r8.w, r8.w, l(0.400000)
max r8.w, r8.w, l(0.000000)
mul r8.w, r8.w, l(100.000000)
mad r15.yz, -r3.wwww, l(0.000000, 10.000000, 5.000000, 0.000000), l(0.000000, 6.857410, 7.085000, 0.000000)
exp r9.w, r15.y
mul r9.w, r2.x, r9.w
mul r9.w, r9.w, l(9.136810)
mul r10.w, r3.w, r7.w
mad r10.w, -r10.w, l(2.015905), r15.z
exp r10.w, r10.w
...
loop 
  ieq r13.w, r12.w, l(2)
  breakc_nz r13.w
  movc r13.w, r12.w, r0.x, r15.y
  uge r15.w, r13.w, r10.w
  ult r18.w, r13.w, cb2[0].y
  ...
  if_nz r15.w
    ...
    add r17.yzw, r5.xxyz, -cb10[r13.w + 0].xxyz
    ...
    endloop 
    mov_sat r27.y, r27.y
    mul r15.w, r27.y, cb10[r13.w + 6].y
    ...
    if_nz r18.x
      ...
      mad r24.z, r27.y, cb10[r13.w + 6].y, r24.z
      mul r15.w, r15.w, cb10[r13.w + 7].y
      mov r26.x, cb10[r13.w + 7].w
      mov r26.yz, cb10[r13.w + 8].xxyx
      dp3 r18.x, r16.xyzx, r26.xyzx
      ...
      div r18.w, r19.w, r18.w
      min r18.x, |r18.w|, r18.x
      add r26.x, r17.y, cb10[r13.w + 3].w
      add r26.yz, r17.zzwz, cb10[r13.w + 4].xxyx
      mad r26.xyz, r16.xyzx, r18.xxxx, r26.xyzx
      dp3 r18.w, r26.xyzx, r26.xyzx
      sqrt r18.w, r18.w
      div r18.x, r18.x, r18.w
      add r18.x, r18.x, r18.x
      sqrt r18.x, r18.x
      mad r18.x, r3.w, l(5.000000), r18.x
      ...
      movc r27.xzw, r13.wwww, l(1.000000,0,1.000000,0), r27.xxzw
      ...
      mul r17.y, r9.w, r13.w
      mul r26.xyz, r15.wwww, r26.xyzx
      dp3 r15.w, r26.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r13.w, r9.w, r13.w, r15.w
      div r13.w, r17.y, r13.w
      mov r28.x, r23.w
      mov r28.yz, r24.xxyx
      mad r17.yzw, r26.xxyz, r13.wwww, r28.xxyz
      mov r23.w, r17.y
      mov r24.xy, r17.zwzz
    else 
...
loop 
  ...
  breakc_nz r13.w
  movc r13.w, r12.w, r0.x, r15.y
  ult r15.w, r13.w, r10.w
  if_nz r15.w
    imul null, r13.w, r13.w, l(14)
    if_nz r6.w
      and r15.w, r20.y, l(15)
      imad r15.w, r15.w, l(20), l(880)
      add r17.yzw, cb1[24].xxyz, cb10[r13.w + 0].xxyz
      store_structured u2.xyzw, cb2[52].x, r15.w, r17.xyzw
    endif 
    ...
    mul r18.x, r19.w, r21.w
    and r19.w, l(1), cb10[r13.w + 6].x
    movc r27.zw, r19.wwww, r18.xxxy, r18.zzzx
    mov r18.x, cb10[r13.w + 6].x
    mov r28.xy, r27.zwzz
    mov r19.w, l(1)
    loop 
      ...
      ushr r25.w, r18.x, l(2)
      ubfe r26.w, l(1), l(2), r18.x
      and r28.z, r25.w, l(2)
      max r28.w, r28.x, r28.y
      mad r21.w, -r22.w, r21.w, l(1.000000)
      mul r21.w, r21.w, r28.y
      movc r20.w, r28.z, r21.w, r28.w
      movc r28.xy, r26.wwww, r28.xyxx, r20.zwzz
      iadd r19.w, r19.w, l(1)
      mov r18.x, r25.w
    endloop 
    add_sat r15.w, -r24.z, r28.y
    mul r18.x, r15.w, cb10[r13.w + 6].y
    lt r18.w, l(0.000000), r18.x
    if_nz r18.w
      and r18.w, r27.y, l(31)
      ...
      if_nz r19.w
        ...
        store_structured u2.x, cb2[52].x, r27.w, r18.x
      endif 
      iadd r20.y, r20.y, l(257)
      mad r20.x, r15.w, cb10[r13.w + 6].y, r20.x
      mul r15.w, r18.x, cb10[r13.w + 7].y
      mov r29.x, cb10[r13.w + 7].w
      mov r29.yz, cb10[r13.w + 8].xxyx
      ...
      div r18.x, r18.w, r18.x
      min r18.x, |r18.x|, l(131072.000000)
      mov r29.x, cb10[r13.w + 8].w
      mov r29.yz, cb10[r13.w + 9].xxyx
      ...
      div r18.w, r19.w, r18.w
      min r18.x, |r18.w|, r18.x
      mov r29.x, cb10[r13.w + 9].w
      mov r29.yz, cb10[r13.w + 10].xxyx
      dp3 r18.w, r16.xyzx, r29.xyzx
      dp3 r19.w, r17.yzwy, r29.xyzx
      add r19.w, r19.w, -cb10[r13.w + 10].z
      ge r20.w, r19.w, l(0.000000)
      ...
      div r18.w, r19.w, r18.w
      min r18.x, |r18.w|, r18.x
      mov r29.x, cb10[r13.w + 10].w
      mov r29.yz, cb10[r13.w + 11].xxyx
      dp3 r18.w, r16.xyzx, r29.xyzx
      dp3 r19.w, r17.yzwy, r29.xyzx
      add r19.w, r19.w, -cb10[r13.w + 11].z
      ge r20.w, r19.w, l(0.000000)
      ...
      div r18.w, r19.w, r18.w
      min r18.x, |r18.w|, r18.x
      mov r29.x, cb10[r13.w + 11].w
      mov r29.yz, cb10[r13.w + 12].xxyx
      dp3 r18.w, r16.xyzx, r29.xyzx
      dp3 r19.w, r17.yzwy, r29.xyzx
      add r19.w, r19.w, -cb10[r13.w + 12].z
      ge r20.w, r19.w, l(0.000000)
      ...
      div r18.w, r19.w, r18.w
      min r18.x, |r18.w|, r18.x
      mov r29.x, cb10[r13.w + 12].w
      mov r29.yz, cb10[r13.w + 13].xxyx
      dp3 r18.w, r16.xyzx, r29.xyzx
      dp3 r19.w, r17.yzwy, r29.xyzx
      add r19.w, r19.w, -cb10[r13.w + 13].z
      ge r20.w, r19.w, l(0.000000)
      ...
      div r18.w, r19.w, r18.w
      min r18.x, |r18.w|, r18.x
      add r29.x, r17.y, cb10[r13.w + 3].w
      add r29.yz, r17.zzwz, cb10[r13.w + 4].xxyx
      mad r28.xzw, r16.xxyz, r18.xxxx, r29.xxyz
      ...
      mad r18.x, r3.w, l(5.000000), r18.x
      add r18.x, r18.x, l(-0.844800)
      mov r29.x, cb10[r13.w + 0].w
      mov r29.y, cb10[r13.w + 1].z
      mov r29.z, cb10[r13.w + 2].y
      dp3 r30.x, r28.xzwx, r29.xyzx
      mov r31.xy, cb10[r13.w + 1].xwxx
      mov r31.z, cb10[r13.w + 2].z
      dp3 r30.y, r28.xzwx, r31.xyzx
      mov r32.x, cb10[r13.w + 1].y
      mov r32.yz, cb10[r13.w + 2].xxwx
      dp3 r30.z, r28.xzwx, r32.xyzx
      ubfe r18.w, l(9), l(16), cb10[r13.w + 7].z
      utof r30.w, r18.w
      sample_l_indexable(texturecubearray)(float,float,float,float) r28.xzw, r30.xyzw, t8.xwyz, s2, r18.x
      and r33.xyz, r28.xzwx, l(0x7fffffff, 0x7fffffff, 0x7fffffff, 0)
      ieq r33.xyz, r33.xyzx, l(0x7f800000, 0x7f800000, 0x7f800000, 0)
      or r18.x, r33.y, r33.x
      or r18.x, r33.z, r18.x
      movc r28.xzw, r18.xxxx, l(1.000000,0,1.000000,0), r28.xxzw
      dp3 r33.x, r17.yzwy, r29.xyzx
      dp3 r33.y, r17.yzwy, r31.xyzx
      dp3 r33.z, r17.yzwy, r32.xyzx
      mad_sat r17.yzw, r33.xxyz, cb10[r13.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
      mul r33.xy, r17.yzyy, cb10[r13.w + 4].zwzz
      mul r33.z, r17.w, cb10[r13.w + 5].x
      add r17.yzw, r33.xxyz, cb10[r13.w + 5].yyzw
      ...
      mul r17.y, r9.w, r13.w
      mul r28.xzw, r15.wwww, r28.xxzw
      dp3 r15.w, r28.xzwx, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r13.w, r9.w, r13.w, r15.w
      div r13.w, r17.y, r13.w
      mad r26.xyz, r28.xzwx, r13.wwww, r26.xyzx
    else 
      mov r27.x, r20.x
      mov r20.xy, r27.xyxx
    endif 
...
bfi r3.w, l(8), l(0), r20.y, r24.w
movc r0.x, r0.x, r3.w, r20.y
max r3.w, r20.x, l(1.000000)
rcp r3.w, r3.w
mov_sat r20.x, r20.x
mul r17.xyz, r3.wwww, r25.xyzx
mul r18.xyz, r3.wwww, r26.xyzx
lt r8.w, r20.x, l(0.990000)
if_nz r8.w
  iadd r0.x, r0.x, l(256)
  add r8.w, -r20.x, l(1.000000)
  ...
  mad r17.xyz, r25.xyzx, r3.wwww, r19.xyzx
  mov r16.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r19.xyz, r16.xyzw, t8.xyzw, s2, r7.w
  mad r3.w, cb2[19].x, r8.w, -r9.w
  mad r3.w, r2.y, r3.w, r9.w
  mad r18.xyz, r19.xyzx, r3.wwww, r18.xyzx
endif 
...
mul r14.yzw, r1.wwww, r14.yyzw
mul r18.xyz, r3.zzzz, r14.yzwy
mul r14.yzw, r3.wwww, r14.yyzw
sqrt r1.w, r2.w
...
loop 
  ...
  switch r8.w
    ...
    if_nz r15.w
      ...
      mad_sat r36.xy, r15.wwww, cb9[r7.w + 2].xzxx, cb9[r7.w + 2].ywyy
      ...
      if_nz r15.w
        ubfe r15.w, l(3), l(27), cb9[r7.w + 1].w
        and r16.w, r8.w, l(7)
        iadd r17.w, r16.w, l(-1)
        ult r17.w, r17.w, l(32)
        and r17.w, r6.w, r17.w
        if_nz r17.w
        ...
        if_nz r15.w
          ...
          loop 
            ...
            sample_c_lz_indexable(texturecubearray)(float,float,float,float) r28.w, r37.xyzw, t10.xxxx, s13, r15.w
        ...
        if_nz r15.w
          ...
          mad r10.w, -r15.y, r2.x, l(1.000000)
          mul r10.w, r10.w, r10.w
          mad r10.w, -r10.w, l(0.620000), l(0.620000)
          add r10.w, -r15.y, r10.w
          mad r10.w, r2.w, r10.w, r15.y
          ...
          mad r15.y, |r13.w|, r2.z, -|r13.w|
          mad r13.w, |r13.w|, r15.y, l(1.000000)
          mad r15.y, r10.w, r1.w, r2.y
          ...
          if_nz r10.w
            imad r15.yw, r9.wwww, l(0, 24, 0, 24), l(0, 88, 0, 108)
            ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r9.w, cb2[52].x, r15.y, u2.xxxx
            or r9.w, r9.w, l(8)
    ...
    if_nz r12.w
      ...
      if_nz r13.w
        ...
        mul r15.y, cb9[r7.w + 3].x, cb9[r7.w + 3].x
        ...
        mul r15.y, r15.y, r21.y
        mul r15.y, r21.z, r15.y
      ...
      if_nz r12.w
        ...
        if_nz r15.w
          ...
          ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r16.w, cb2[52].x, r15.y, u2.xxxx
          or r16.w, r16.w, l(4)
          store_structured u2.x, cb2[52].x, r15.y, r16.w
          store_structured u2.x, cb2[52].x, r15.w, r13.w
        endif 
        iadd r15.y, r3.w, l(257)
        ine r12.w, r12.w, l(1)
        if_nz r12.w
          ...
          dp4 r15.w, r34.xyzw, r25.xyzw
          ge r16.w, r15.w, r12.w
          if_nz r16.w
        ...
        if_nz r13.w
          mul r13.w, r2.z, cb9[r7.w + 1].z
          mul r13.w, r11.w, r13.w
          ubfe r15.w, l(4), l(16), cb9[r7.w + 1].w
          ult r17.w, l(0), r15.w
          ...
          if_nz r17.w
            ...
            mov r34.xyz, cb9[r15.w + 6].yzwy
            mov r34.w, cb9[r15.w + 7].x
            dp4 r17.w, r34.xyzw, r26.xyzw
            mov r34.xyz, cb9[r15.w + 7].yzwy
            mov r34.w, cb9[r15.w + 8].x
            dp4 r21.y, r34.xyzw, r26.xyzw
            lt r21.z, r21.y, r17.w
            if_z r21.z
              mov r34.xyz, cb9[r15.w + 4].yzwy
              mov r34.w, cb9[r15.w + 5].x
              dp4 r24.x, r34.xyzw, r26.xyzw
              mov r34.xyz, cb9[r15.w + 5].yzwy
              mov r34.w, cb9[r15.w + 6].x
              ...
              add r24.x, r23.y, cb9[r15.w + 9].w
              add r24.y, r23.z, cb9[r15.w + 10].x
              mul r23.yz, r24.xxyx, cb9[r15.w + 9].yyzy
              div r24.xy, cb9[r15.w + 3].yyyy, cb9[r15.w + 8].ywyy
              ...
              if_z r21.w
                ...
                mad r25.x, r23.y, cb9[r15.w + 8].y, cb9[r15.w + 8].z
                mad r25.y, r23.z, cb9[r15.w + 8].w, cb9[r15.w + 9].x
                mul r23.y, r21.y, cb9[r15.w + 10].z
                mad r17.w, cb9[r15.w + 10].y, r21.y, r17.w
            ...
            if_z r21.y
              ...
              if_nz cb2[58].y
                ...
                loop 
                  ...
                  mad r26.xy, r24.xyxx, cb9[r15.w + 3].yyyy, r25.xyxx
            ...
            if_nz r15.w
              ...
              if_z r21.y
                ...
                if_z r21.w
                  ...
                  mad r15.w, cb9[r7.w + 10].y, r17.w, r15.w
                  div r15.w, r15.w, r23.y
                endif 
              else 
                mov r21.w, l(-1)
              endif 
              ...
              if_z r17.w
                ...
                if_nz cb2[58].y
                  ...
                  loop 
                    ...
                    sample_c_lz_indexable(texture2darray)(float,float,float,float) r23.y, r26.xyzx, t9.xxxx, s13, r15.w
                    mad r21.y, r23.y, l(0.125000), r21.y
                    iadd r21.w, r21.w, l(1)
                  endloop 
                else 
                  utof r25.z, r17.w
                  sample_c_lz_indexable(texture2darray)(float,float,float,float) r21.y, r25.xyzx, t9.xxxx, s13, r15.w
                endif 
          ...
          mad r15.w, |r9.w|, r2.z, -|r9.w|
          mad r9.w, |r9.w|, r15.w, l(1.000000)
          mad r11.w, r11.w, r1.w, r2.y
          mul r9.w, r9.w, r9.w
          mul r9.w, r11.w, r9.w
          rcp r9.w, r9.w
          mul r9.w, r13.w, r9.w
