...
if_nz r2.z
  ...
  if_nz r2.z
    ...
    if_nz r6.w
      ...
      mad r19.xyz, r11.xyzx, r6.wwww, r10.xyzx
      ...
      if_z r6.w
        ...
        if_nz cb2[58].y
          ...
          loop 
            ...
            sample_c_lz_indexable(texture2darray)(float,float,float,float) r13.z, r21.xyzx, t9.xxxx, s13, r6.w
    ...
    add r4.z, -r5.w, r4.z
    mad r4.z, r1.z, r4.z, r5.w
    mul r4.z, r7.w, r4.z
    lt r2.w, l(0.000000), r2.w
    mad r19.xyz, r4.zzzz, r15.yzwy, r17.xyzx
    ...
    mad r20.xyz, r2.zzzz, r15.yzwy, r9.xywx
...
add r1.z, r6.w, r1.z
mul r2.y, r4.w, r6.y
mad r2.y, r6.x, r4.y, r2.y
mad r2.y, r6.z, r5.y, r2.y
...
mad r0.xyz, r2.xzwx, r3.yzwy, r0.xyzx
...
ret 
// Approximately 1388 instruction slots used
