...
r0.y = samplerLinear[]..swiz;
  ...
  r3.z = 5 * r2.w;
  r4.y = r2.w * 5 + -2.5;
  r4.y = 0.400000006 * r4.y;
  r4.y = max(0, r4.y);
  r4.zw = -r2.ww * float2(10,5) + float2(6.85740995,7.08500004);
  r4.z = exp2(r4.z);
  r4.z = r4.z * r2.x;
  r6.w = r3.z * r2.w;
  ...
  r4.w = exp2(r4.w);
  r4.w = r4.w * r2.x;
  r4.yzw = float3(100,9.1368103,9.70808983) * r4.yzw;
  r4.z = max(r4.z, r4.w);
  ...
  if (probeDebug != 0) {
    ...
    r4.w = (int)r4.w + 7;
    r4.w = (uint)r4.w >> 3;
    r4.w = mad((int)r0.z, (int)r4.w, (int)r0.y);
    ...
    r9.w = samplerLinear[]..swiz;
      ...
      while (true) {
        if (r41.x == 0) break;
        r41.y = firstbitlow((uint)r41.x);
        r41.z = 1 << (int)r41.y;
        r41.z = ~(int)r41.z;
        r41.x = (int)r41.z & (int)r41.x;
        r41.y = (int)r8.w + (int)r41.y;
        r41.y = (int)r41.y * 14;
        r42.xyz = -refProbeConstantsCB[r41.y].data[0].xyz + r11.xyz;
        r41.z = dot(r42.xyz, r42.xyz);
        r41.z = sqrt(r41.z);
        r41.z = cmp(probeDebugRadius >= r41.z);
        if (r41.z != 0) {
          r29.yzw = refProbeConstantsCB[r41.y].data[1].xyz;
          r29.x = refProbeConstantsCB[r41.y].data[0].w;
          r30.yzw = refProbeConstantsCB[r41.y].data[2].xyz;
          r30.x = refProbeConstantsCB[r41.y].data[1].w;
          r31.xyz = refProbeConstantsCB[r41.y].data[3].xyz;
          r31.w = refProbeConstantsCB[r41.y].data[4].z;
          r32.yz = refProbeConstantsCB[r41.y].data[4].xy;
          r32.x = refProbeConstantsCB[r41.y].data[3].w;
          r32.w = refProbeConstantsCB[r41.y].data[6].x;
          r33.yzw = refProbeConstantsCB[r41.y].data[5].xyz;
          r33.x = refProbeConstantsCB[r41.y].data[4].w;
          r34.yz = refProbeConstantsCB[r41.y].data[7].yw;
          r34.x = refProbeConstantsCB[r41.y].data[6].y;
          r34.w = refProbeConstantsCB[r41.y].data[8].x;
          r35.xyz = refProbeConstantsCB[r41.y].data[8].yzw;
          r35.w = refProbeConstantsCB[r41.y].data[9].x;
          r36.xyz = refProbeConstantsCB[r41.y].data[10].yzw;
          r36.w = refProbeConstantsCB[r41.y].data[11].x;
          r37.xyz = refProbeConstantsCB[r41.y].data[11].yzw;
          r37.w = refProbeConstantsCB[r41.y].data[12].x;
          r38.xyz = refProbeConstantsCB[r41.y].data[0].xyz;
          r41.zw = refProbeConstantsCB[r41.y].data[13].yz;
          r10.w = -1;
          r27.w = refProbeConstantsCB[r41.y].data[2].w;
          r28.w = refProbeConstantsCB[r41.y].data[5].w;
          r38.w = refProbeConstantsCB[r41.y].data[7].z;
          r39.xyz = refProbeConstantsCB[r41.y].data[9].yzw;
          r39.w = refProbeConstantsCB[r41.y].data[10].x;
          r40.xyz = refProbeConstantsCB[r41.y].data[12].yzw;
          r40.w = refProbeConstantsCB[r41.y].data[13].x;
          r26.zw = r41.zw;
          break;
        }
      }
  ...
  if (r6.w != 0) {
    ...
    r15.w = dot(refProbeAttenuationConstantsCB[r9.w].data[1].xyz, r13.yzw);
    r15.w = saturate(refProbeAttenuationConstantsCB[r9.w].data[1].w + r15.w);
    r10.w = r15.w * r10.w;
    r15.w = dot(refProbeAttenuationConstantsCB[r9.w].data[2].xyz, r13.yzw);
    r15.w = saturate(refProbeAttenuationConstantsCB[r9.w].data[2].w + r15.w);
    r10.w = r15.w * r10.w;
    r15.w = dot(refProbeAttenuationConstantsCB[r9.w].data[3].xyz, r13.yzw);
    r15.w = saturate(refProbeAttenuationConstantsCB[r9.w].data[3].w + r15.w);
    r10.w = r15.w * r10.w;
    r15.w = dot(refProbeAttenuationConstantsCB[r9.w].data[4].xyz, r13.yzw);
    r15.w = saturate(refProbeAttenuationConstantsCB[r9.w].data[4].w + r15.w);
    r10.w = r15.w * r10.w;
    r15.w = dot(refProbeAttenuationConstantsCB[r9.w].data[5].xyz, r13.yzw);
    r9.w = saturate(refProbeAttenuationConstantsCB[r9.w].data[5].w + r15.w);
    r30.x = r10.w * r9.w;
    r9.w = (int)r18.w & 1;
    r30.yz = float2(0,1);
    r19.zw = r9.ww ? r30.xy : r30.zx;
    r30.x = 1;
    r9.w = r18.w;
    r31.xy = r19.zw;
    r10.w = 1;
    while (true) {
      ...
      if (r15.w != 0) break;
      r15.w = (int)r4.w + (int)r10.w;
      r15.w = (int)r15.w * 6;
      r16.w = dot(refProbeAttenuationConstantsCB[r15.w].data[0].xyz, r13.yzw);
      r16.w = saturate(refProbeAttenuationConstantsCB[r15.w].data[0].w + r16.w);
      r16.w = r31.x * r16.w;
      r17.w = dot(refProbeAttenuationConstantsCB[r15.w].data[1].xyz, r13.yzw);
      r17.w = saturate(refProbeAttenuationConstantsCB[r15.w].data[1].w + r17.w);
      r16.w = r17.w * r16.w;
      r17.w = dot(refProbeAttenuationConstantsCB[r15.w].data[2].xyz, r13.yzw);
      r17.w = saturate(refProbeAttenuationConstantsCB[r15.w].data[2].w + r17.w);
      r16.w = r17.w * r16.w;
      r17.w = dot(refProbeAttenuationConstantsCB[r15.w].data[3].xyz, r13.yzw);
      r17.w = saturate(refProbeAttenuationConstantsCB[r15.w].data[3].w + r17.w);
      r16.w = r17.w * r16.w;
      r17.w = dot(refProbeAttenuationConstantsCB[r15.w].data[4].xyz, r13.yzw);
      r17.w = saturate(refProbeAttenuationConstantsCB[r15.w].data[4].w + r17.w);
      r16.w = r17.w * r16.w;
      r17.w = dot(refProbeAttenuationConstantsCB[r15.w].data[5].xyz, r13.yzw);
      r15.w = saturate(refProbeAttenuationConstantsCB[r15.w].data[5].w + r17.w);
      r31.x = r16.w * r15.w;
      r17.w = (uint)r9.w >> 2;
      if (1 == 0) r20.w = 0; else if (1+2 < 32) {       r20.w = (uint)r9.w << (32-(1 + 2)); r20.w = (uint)r20.w >> (32-1);      } else r20.w = (uint)r9.w >> 2;
      r26.y = (int)r17.w & 2;
      r26.z = max(r31.y, r31.x);
      r15.w = -r16.w * r15.w + 1;
      r15.w = r31.y * r15.w;
      r30.y = r26.y ? r15.w : r26.z;
      r31.xy = r20.ww ? r31.xy : r30.xy;
      r10.w = (int)r10.w + 1;
      r9.w = r17.w;
    }
    ...
    if (r4.w != 0) {
      ...
      r19.w = (uint)r7.w;
      r18.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r19.xyzw, r8.w).xyz;
  ...
  if (r6.w == 0) {
    ...
    r13.w = samplerLinear[]..swiz;
      r16.w = cmp((int)r8.w == (int)r13.z);
      bitmask.w = ((~(-1 << r9.w)) << 0) & 0xffffffff;  r17.w = (((uint)0 << 0) & bitmask.w) | ((uint)r13.w & ~bitmask.w);
      r13.w = r16.w ? r17.w : r13.w;
      r16.w = cmp((int)r10.w == (int)r13.z);
      if (r13.y == 0) r17.w = 0; else if (r13.y+0 < 32) {       r17.w = (uint)r13.w << (32-(r13.y + 0)); r17.w = (uint)r17.w >> (32-r13.y);      } else r17.w = (uint)r13.w >> 0;
      r13.w = r16.w ? r17.w : r13.w;
      r23.xyzw = r21.xyzw;
      r24.xyzw = r22.xyzw;
      r16.w = r13.w;
      while (true) {
        ...
        r25.w = (int)r24.w + 1;
        r15.yzw = -refProbeConstantsCB[r17.w].data[0].xyz + r11.xyz;
        ...
        r26.x = (int)r19.w * 6;
        r26.y = dot(refProbeAttenuationConstantsCB[r26.x].data[0].xyz, r15.yzw);
        r26.y = saturate(refProbeAttenuationConstantsCB[r26.x].data[0].w + r26.y);
        r26.z = dot(refProbeAttenuationConstantsCB[r26.x].data[1].xyz, r15.yzw);
        r26.z = saturate(refProbeAttenuationConstantsCB[r26.x].data[1].w + r26.z);
        r26.y = r26.y * r26.z;
        r26.z = dot(refProbeAttenuationConstantsCB[r26.x].data[2].xyz, r15.yzw);
        r26.z = saturate(refProbeAttenuationConstantsCB[r26.x].data[2].w + r26.z);
        r26.y = r26.y * r26.z;
        r26.z = dot(refProbeAttenuationConstantsCB[r26.x].data[3].xyz, r15.yzw);
        r26.z = saturate(refProbeAttenuationConstantsCB[r26.x].data[3].w + r26.z);
        r26.y = r26.y * r26.z;
        r26.z = dot(refProbeAttenuationConstantsCB[r26.x].data[4].xyz, r15.yzw);
        r26.z = saturate(refProbeAttenuationConstantsCB[r26.x].data[4].w + r26.z);
        r26.y = r26.y * r26.z;
        r26.z = dot(refProbeAttenuationConstantsCB[r26.x].data[5].xyz, r15.yzw);
        r26.x = saturate(refProbeAttenuationConstantsCB[r26.x].data[5].w + r26.z);
        r16.x = r26.y * r26.x;
        r26.x = 1 & (int)refProbeConstantsCB[r17.w].data[6].x;
        r26.xy = r26.xx ? r16.xy : r16.zx;
        r16.x = refProbeConstantsCB[r17.w].data[6].x;
        r27.xy = r26.xy;
        r26.z = 1;
        while (true) {
          r26.w = cmp((int)r26.z >= (int)r20.w);
          if (r26.w != 0) break;
          r26.w = (int)r19.w + (int)r26.z;
          r26.w = (int)r26.w * 6;
          r27.z = dot(refProbeAttenuationConstantsCB[r26.w].data[0].xyz, r15.yzw);
          r27.z = saturate(refProbeAttenuationConstantsCB[r26.w].data[0].w + r27.z);
          r27.z = r27.x * r27.z;
          r27.w = dot(refProbeAttenuationConstantsCB[r26.w].data[1].xyz, r15.yzw);
          r27.w = saturate(refProbeAttenuationConstantsCB[r26.w].data[1].w + r27.w);
          r27.z = r27.z * r27.w;
          r27.w = dot(refProbeAttenuationConstantsCB[r26.w].data[2].xyz, r15.yzw);
          r27.w = saturate(refProbeAttenuationConstantsCB[r26.w].data[2].w + r27.w);
          r27.z = r27.z * r27.w;
          r27.w = dot(refProbeAttenuationConstantsCB[r26.w].data[3].xyz, r15.yzw);
          r27.w = saturate(refProbeAttenuationConstantsCB[r26.w].data[3].w + r27.w);
          r27.z = r27.z * r27.w;
          r27.w = dot(refProbeAttenuationConstantsCB[r26.w].data[4].xyz, r15.yzw);
          r27.w = saturate(refProbeAttenuationConstantsCB[r26.w].data[4].w + r27.w);
          r27.z = r27.z * r27.w;
          r27.w = dot(refProbeAttenuationConstantsCB[r26.w].data[5].xyz, r15.yzw);
          r26.w = saturate(refProbeAttenuationConstantsCB[r26.w].data[5].w + r27.w);
          r27.x = r27.z * r26.w;
          r27.w = (uint)r16.x >> 2;
          if (1 == 0) r28.x = 0; else if (1+2 < 32) {           r28.x = (uint)r16.x << (32-(1 + 2)); r28.x = (uint)r28.x >> (32-1);          } else r28.x = (uint)r16.x >> 2;
          r28.y = (int)r27.w & 2;
          r28.z = max(r27.y, r27.x);
          r26.w = -r27.z * r26.w + 1;
          r26.w = r27.y * r26.w;
          r18.y = r28.y ? r26.w : r28.z;
          r27.xy = r28.xx ? r27.xy : r18.xy;
          r26.z = (int)r26.z + 1;
          r16.x = r27.w;
        }
        ...
        if (r18.y != 0) {
          ...
          r19.w = r20.w / r19.w;
          r18.y = min(abs(r19.w), r18.y);
          r26.x = refProbeConstantsCB[r17.w].data[3].w + r15.y;
          r26.yz = refProbeConstantsCB[r17.w].data[4].xy + r15.zw;
          ...
          r15.yzw = saturate(r33.xyz * refProbeConstantsCB[r17.w].data[3].xyz + float3(0.5,0.5,0.5));
          r33.xy = refProbeConstantsCB[r17.w].data[4].zw * r15.yz;
          r33.z = refProbeConstantsCB[r17.w].data[5].x * r15.w;
          r15.yzw = refProbeConstantsCB[r17.w].data[5].yzw + r33.xyz;
    ...
    r10.w = 0;
    while (true) {
      r16.w = cmp((uint)r10.w >= (uint)r6.w);
      if (r16.w != 0) break;
      r16.w = (uint)r10.w >> 5;
    ...
    r16.w = samplerLinear[]..swiz;
      ...
      if (r9.w == 0) r18.x = 0; else if (r9.w+0 < 32) {       r18.x = (uint)r16.w << (32-(r9.w + 0)); r18.x = (uint)r18.x >> (32-r9.w);      } else r18.x = (uint)r16.w >> 0;
      r16.w = r17.w ? r18.x : r16.w;
      r25.xyz = r13.yzw;
      r26.xyz = r23.xyz;
      r27.xyz = r24.xzy;
      r17.w = r16.w;
      while (true) {
        if (r17.w == 0) break;
        r18.x = firstbitlow((uint)r17.w);
        r18.y = 1 << (int)r18.x;
        r18.y = ~(int)r18.y;
        r17.w = (int)r17.w & (int)r18.y;
        r18.x = (int)r10.w + (int)r18.x;
        r18.x = (int)r18.x * 14;
        r18.y = (int)r27.z & 255;
        r19.w = cmp((uint)r18.y < 32);
        r19.w = r2.z ? r19.w : 0;
        if (r19.w != 0) {
          r18.y = mad((int)r18.y, 20, 880);
          r15.yzw = refProbeConstantsCB[r18.x].data[0].xyz + eyeOffset.xyz;
          GBufferDiffuseColor[viewID].r18.y = u2.xyzw;
        }
        r28.y = (int)r27.z + 1;
        r15.yzw = -refProbeConstantsCB[r18.x].data[0].xyz + r11.xyz;
        r18.y = 0x0000ffff & (int)refProbeConstantsCB[r18.x].data[7].z;
        if (6 == 0) r19.w = 0; else if (6+25 < 32) {         r19.w = (uint)refProbeConstantsCB[r18.x].data[7].z << (32-(6 + 25)); r19.w = (uint)r19.w >> (32-6);        } else r19.w = (uint)refProbeConstantsCB[r18.x].data[7].z >> 25;
        r20.w = (int)r18.y * 6;
        ...
        r16.x = r23.w * r20.w;
        r20.w = 1 & (int)refProbeConstantsCB[r18.x].data[6].x;
        r28.zw = r20.ww ? r16.xy : r16.zx;
        r16.x = refProbeConstantsCB[r18.x].data[6].x;
        r29.xy = r28.zw;
        r20.w = 1;
        while (true) {
          r23.w = cmp((int)r20.w >= (int)r19.w);
          if (r23.w != 0) break;
          r23.w = (int)r18.y + (int)r20.w;
          r23.w = (int)r23.w * 6;
          ...
          r23.w = -r24.w * r23.w + 1;
          r23.w = r29.y * r23.w;
          r18.w = r27.w ? r23.w : r29.z;
          r29.xy = r26.ww ? r29.xy : r18.zw;
          r20.w = (int)r20.w + 1;
          r16.x = r25.w;
        }
        r16.x = saturate(r29.y + -r27.y);
        r18.y = refProbeConstantsCB[r18.x].data[6].y * r16.x;
        r18.w = cmp(0 < r18.y);
        if (r18.w != 0) {
          r18.w = (int)r28.y & 255;
          r19.w = (int)r18.w + -1;
          ...
          r19.w = r2.z ? r19.w : 0;
          if (r19.w != 0) {
            r28.zw = mad((int2)r18.ww, int2(20,20), int2(860,876));
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r18.w, cb2[52].x, r28.z, u2.xxxx
          ...
          r27.z = (int)r27.z + 257;
          r27.x = r16.x * refProbeConstantsCB[r18.x].data[6].y + r27.x;
          r16.x = refProbeConstantsCB[r18.x].data[7].y * r18.y;
          r31.x = refProbeConstantsCB[r18.x].data[7].w;
          r31.yz = refProbeConstantsCB[r18.x].data[8].xy;
          r18.y = dot(r14.xyz, r31.xyz);
          r18.w = dot(r15.yzw, r31.xyz);
          r18.w = -refProbeConstantsCB[r18.x].data[8].z + r18.w;
          r19.w = cmp(r18.w >= 0);
          r18.w = max(abs(r18.w), r4.y);
          r18.w = r19.w ? r18.w : -r18.w;
          r18.y = max(1.00000001e-07, -r18.y);
          r18.y = r18.w / r18.y;
          r18.y = min(131072, abs(r18.y));
          r31.x = refProbeConstantsCB[r18.x].data[8].w;
          r31.yz = refProbeConstantsCB[r18.x].data[9].xy;
          r18.w = dot(r14.xyz, r31.xyz);
          r19.w = dot(r15.yzw, r31.xyz);
          r19.w = -refProbeConstantsCB[r18.x].data[9].z + r19.w;
          r20.w = cmp(r19.w >= 0);
          r19.w = max(abs(r19.w), r4.y);
          r19.w = r20.w ? r19.w : -r19.w;
          ...
          r31.x = refProbeConstantsCB[r18.x].data[9].w;
          r31.yz = refProbeConstantsCB[r18.x].data[10].xy;
          r18.w = dot(r14.xyz, r31.xyz);
          r19.w = dot(r15.yzw, r31.xyz);
          r19.w = -refProbeConstantsCB[r18.x].data[10].z + r19.w;
          r20.w = cmp(r19.w >= 0);
          r19.w = max(abs(r19.w), r4.y);
          r19.w = r20.w ? r19.w : -r19.w;
          r18.w = max(1.00000001e-07, -r18.w);
          r18.w = r19.w / r18.w;
          r18.y = min(r18.y, abs(r18.w));
          r31.x = refProbeConstantsCB[r18.x].data[10].w;
          r31.yz = refProbeConstantsCB[r18.x].data[11].xy;
          r18.w = dot(r14.xyz, r31.xyz);
          r19.w = dot(r15.yzw, r31.xyz);
          r19.w = -refProbeConstantsCB[r18.x].data[11].z + r19.w;
          r20.w = cmp(r19.w >= 0);
          r19.w = max(abs(r19.w), r4.y);
          r19.w = r20.w ? r19.w : -r19.w;
          r18.w = max(1.00000001e-07, -r18.w);
          r18.w = r19.w / r18.w;
          r18.y = min(r18.y, abs(r18.w));
          r31.x = refProbeConstantsCB[r18.x].data[11].w;
          r31.yz = refProbeConstantsCB[r18.x].data[12].xy;
          r18.w = dot(r14.xyz, r31.xyz);
          r19.w = dot(r15.yzw, r31.xyz);
          r19.w = -refProbeConstantsCB[r18.x].data[12].z + r19.w;
          r20.w = cmp(r19.w >= 0);
          r19.w = max(abs(r19.w), r4.y);
          r19.w = r20.w ? r19.w : -r19.w;
          r18.w = max(1.00000001e-07, -r18.w);
          r18.w = r19.w / r18.w;
          r18.y = min(r18.y, abs(r18.w));
          r31.x = refProbeConstantsCB[r18.x].data[12].w;
          r31.yz = refProbeConstantsCB[r18.x].data[13].xy;
          r18.w = dot(r14.xyz, r31.xyz);
          r19.w = dot(r15.yzw, r31.xyz);
          r19.w = -refProbeConstantsCB[r18.x].data[13].z + r19.w;
          r20.w = cmp(r19.w >= 0);
          r19.w = max(abs(r19.w), r4.y);
          r19.w = r20.w ? r19.w : -r19.w;
          r18.w = max(1.00000001e-07, -r18.w);
          r18.w = r19.w / r18.w;
          r18.y = min(r18.y, abs(r18.w));
          r31.x = refProbeConstantsCB[r18.x].data[3].w + r15.y;
          r31.yz = refProbeConstantsCB[r18.x].data[4].xy + r15.zw;
          r29.xzw = r14.xyz * r18.yyy + r31.xyz;
          r18.w = dot(r29.xzw, r29.xzw);
          r18.w = sqrt(r18.w);
          r18.y = r18.y / r18.w;
          r18.y = r18.y + r18.y;
          r18.y = sqrt(r18.y);
          r18.y = r2.w * 5 + r18.y;
          r18.y = -0.844799995 + r18.y;
          r31.x = refProbeConstantsCB[r18.x].data[0].w;
          r31.y = refProbeConstantsCB[r18.x].data[1].z;
          r31.z = refProbeConstantsCB[r18.x].data[2].y;
          r32.x = dot(r29.xzw, r31.xyz);
          r33.xy = refProbeConstantsCB[r18.x].data[1].xw;
          r33.z = refProbeConstantsCB[r18.x].data[2].z;
          r32.y = dot(r29.xzw, r33.xyz);
          r34.x = refProbeConstantsCB[r18.x].data[1].y;
          r34.yz = refProbeConstantsCB[r18.x].data[2].xw;
          r32.z = dot(r29.xzw, r34.xyz);
          if (9 == 0) r18.w = 0; else if (9+16 < 32) {           r18.w = (uint)refProbeConstantsCB[r18.x].data[7].z << (32-(9 + 16)); r18.w = (uint)r18.w >> (32-9);          } else r18.w = (uint)refProbeConstantsCB[r18.x].data[7].z >> 16;
          r32.w = (uint)r18.w;
          r29.xzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r32.xyzw, r18.y).xyz;
          r35.xyz = (int3)r29.xzw & int3(-2147483648,-2147483648,-2147483648);
          r35.xyz = cmp((int3)r35.xyz == int3(2139095040,2139095040,2139095040));
          r18.y = (int)r35.y | (int)r35.x;
          r18.y = (int)r35.z | (int)r18.y;
          r29.xzw = r18.yyy ? float3(1,1,0) : r29.xzw;
          r35.x = dot(r15.yzw, r31.xyz);
          r35.y = dot(r15.yzw, r33.xyz);
          r35.z = dot(r15.yzw, r34.xyz);
          r15.yzw = saturate(r35.xyz * refProbeConstantsCB[r18.x].data[3].xyz + float3(0.5,0.5,0.5));
          r35.xy = refProbeConstantsCB[r18.x].data[4].zw * r15.yz;
          r35.z = refProbeConstantsCB[r18.x].data[5].x * r15.w;
          r15.yzw = refProbeConstantsCB[r18.x].data[5].yzw + r35.xyz;
          r32.x = dot(r12.xyz, r31.xyz);
          r32.y = dot(r12.xyz, r33.xyz);
          r32.z = dot(r12.xyz, r34.xyz);
          r18.xyw = cmp(float3(0,0,0) < r32.xyz);
          r17.z = r18.x ? 0 : 0.5;
          r31.xyz = r17.xyz + r15.yzw;
          r31.xyz = gProbeXArray.SampleLevel(samplerLinearClamp_s, r31.xyz, 0).xyz;
          r33.xyz = r32.xyz * r32.xyz;
          r33.xyz = r33.xyz * r16.xxx;
          r19.z = r18.y ? 0 : 0.5;
          r34.xyz = r19.xyz + r15.yzw;
          ...
          r15.yzw = r20.xyz + r15.yzw;
          r15.yzw = gProbeZArray.SampleLevel(samplerLinearClamp_s, r15.yzw, 0).xyz;
          r15.yzw = r15.yzw * r33.zzz + r31.xyz;
          r18.xyw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r32.xyzw, 6).xyz;
          r31.xyz = (int3)r18.xyw & int3(-2147483648,-2147483648,-2147483648);
          r31.xyz = cmp((int3)r31.xyz == int3(2139095040,2139095040,2139095040));
          r17.z = (int)r31.y | (int)r31.x;
          r17.z = (int)r31.z | (int)r17.z;
          r18.xyw = r17.zzz ? float3(1,1,0) : r18.xyw;
          r31.xyz = r18.xyw * r15.yzw;
          r17.z = dot(r31.xyz, float3(0.212599993,0.715200007,0.0722000003));
          r25.xyz = r15.yzw * r18.xyw + r25.xyz;
          r15.y = r17.z * r4.z;
          r18.xyw = r29.xzw * r16.xxx;
          r15.z = dot(r18.xyw, float3(0.212599993,0.715200007,0.0722000003));
          r15.z = r4.z * r17.z + r15.z;
          r15.y = r15.y / r15.z;
          r26.xyz = r18.xyw * r15.yyy + r26.xyz;
        } else {
          r28.x = r27.x;
          r27.xz = r28.xy;
        }
    ...
    r2.w = cmp(r22.z >= 1);
    r4.y = (int)r22.w & 0x0000ff00;
    bitmask.y = ((~(-1 << 8)) << 0) & 0xffffffff;  r4.y = (((uint)r24.y << 0) & bitmask.y) | ((uint)r4.y & ~bitmask.y);
    r4.w = r2.w ? r4.y : r24.y;
    r2.w = max(1, r24.x);
    r2.w = rcp(r2.w);
    r24.x = saturate(r24.x);
    r15.xyz = r13.yzw * r2.www;
    r30.xyz = r23.xyz * r2.www;
    r4.y = cmp(r24.x < 0.99000001);
    if (r4.y != 0) {
      r4.w = (int)r4.w + 256;
      r4.y = 1 + -r24.x;
      ...
      r4.z = dot(r16.xyz, float3(0.212599993,0.715200007,0.0722000003));
      r15.xyz = r13.yzw * r2.www + r16.xyz;
      r14.w = 0;
      r13.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r14.xyzw, r3.z).xyz;
      r2.w = sunConstants.globalProbeExposure * r4.y + -r4.z;
      r2.w = r2.y * r2.w + r4.z;
  ...
  r15.xyz = r30.xyz * r2.www;
  r16.xyz = r15.xyz * r4.yyy;
  ...
  switch (r3.z) {
    ...
    r18.xyz = -r17.xyz * float3(0.5,0.5,0.5) + lightConstantsCB[r0.x].data[0].xyz;
    r19.xyz = r18.xyz + -r11.xyz;
    r4.z = dot(r17.xyz, r19.xyz);
    r5.x = saturate(-r4.z / lightConstantsCB[r0.x].data[6].y);
    r20.xyz = r5.xxx * r17.xyz + r18.xyz;
      ...
      if (r9.w != 0) {
        ...
        if (r9.w != 0) {
          ...
          while (true) {
            ...
            if (r15.w != 0) break;
            r21.y = dot(icb[r14.w+0].yx, r22.xy);
            r21.z = dot(icb[r14.w+0].yx, r22.yz);
            r24.yz = lightConstantsCB[r0.x].data[3].yy * r21.yz;
            r24.x = r24.y * r21.x;
            r24.w = r24.y * r20.x;
            r23.xyz = r20.yzw * r10.www + r24.xzw;
            r15.w = gOmniShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r23.xyzw, r9.w).x;
        ...
        if (r9.w != 0) {
          ...
          r9.w = 0.25 * r9.w;
          r10.w = dot(r17.xyz, r14.xyz);
          r12.w = dot(r14.xyz, r19.xyz);
          r14.x = -r10.w * r10.w + lightConstantsCB[r0.x].data[6].y;
          r4.z = r10.w * r12.w + -r4.z;
          r4.z = saturate(r4.z / r14.x);
          r10.w = r14.x / lightConstantsCB[r0.x].data[6].y;
          r10.w = 10 * r10.w;
          r10.w = min(1, r10.w);
          r4.z = r4.z + -r5.x;
          r4.z = r10.w * r4.z + r5.x;
          r14.xyz = r4.zzz * r17.xyz + r18.xyz;
          r14.xyz = r4.yyy ? r14.xyz : lightConstantsCB[r0.x].data[0].xyz;
          r14.xyz = r14.xyz + -r11.xyz;
          r4.y = dot(r14.xyz, r14.xyz);
          r4.y = rsqrt(r4.y);
          r17.xyz = r14.xyz * r4.yyy;
          ...
          if (r5.x != 0) {
            ...
            if (r12.w == 0) {
              ...
              if (r14.w == 0) {
                ...
                r15.w = lightConstantsCB[r4.z].data[10].z * r10.w;
                r5.x = lightConstantsCB[r4.z].data[10].y * r10.w + r5.x;
                r5.x = r5.x / r15.w;
              }
            } else {
              r14.w = -1;
            }
            r10.w = (int)r12.w | (int)r14.w;
            if (r10.w == 0) {
              ...
              if (enableDitheredShadow != 0) {
                ...
                while (true) {
                  r15.w = cmp((int)r14.w >= 8);
                  if (r15.w != 0) break;
                  r21.x = dot(icb[r14.w+0].yx, r18.xy);
                  r21.y = dot(icb[r14.w+0].yx, r18.yz);
                  r20.xy = r21.xy * lightConstantsCB[r4.z].data[3].yy + r19.xy;
                  r15.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r20.xyz, r5.x).x;
                  r12.w = r15.w * 0.125 + r12.w;
                  r14.w = (int)r14.w + 1;
                }
              } else {
                r19.z = (uint)r10.w;
                r12.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r19.xyz, r5.x).x;
              }
              r4.z = r12.w * r12.w;
              r4.z = r4.z * r12.w;
            } else {
          ...
          r5.x = cmp(0 < r7.w);
          r19.xyz = r4.zzz * r18.xyz + r13.yzw;
          r4.z = saturate(dot(r12.xyz, r17.xyz));
          ...
          r4.z = r7.w * r4.z;
          r4.z = r4.z * r6.w;
          r14.xyz = r4.zzz * r18.xyz + r15.xyz;
          r4.y = saturate(1 + -r4.y);
          r7.w = r4.y * r4.y;
          r7.w = r7.w * r7.w;
          r4.y = r7.w * r4.y;
          r4.y = r4.z * r4.y;
          r17.xyz = r4.yyy * r18.xyz + r16.xyz;
          r13.yzw = r5.xxx ? r19.xyz : r13.yzw;
          r16.xyz = r5.xxx ? r17.xyz : r16.xyz;
          r15.xyz = r5.xxx ? r14.xyz : r15.xyz;
          if (r2.z != 0) {
          // Known bad code for instruction (needs manual fix):
    ...
    if (r6.w != 0) {
      ...
      if (r7.w != 0) {
        ...
        if (r6.w != 0) {
          ...
          r20.xy = exp2(r20.xy);
          r9.w = lightConstantsCB[r0.x].data[12].x * r20.x;
          r10.w = lightConstantsCB[r0.x].data[12].y * r20.y + -1;
          r9.w = lightConstantsCB[r0.x].data[12].y * r20.y + -r9.w;
      ...
      if (r6.w != 0) {
        ...
        if (r6.w != 0) {
          ...
          r8.w = dot(r17.xyzw, r19.xyzw);
          r9.w = cmp(r8.w >= r6.w);
          if (r9.w != 0) {
            r17.xyz = lightConstantsCB[r0.x].data[4].yzw;
            r17.w = lightConstantsCB[r0.x].data[5].x;
            r17.x = dot(r17.xyzw, r19.xyzw);
            r20.xyz = lightConstantsCB[r0.x].data[5].yzw;
            r20.w = lightConstantsCB[r0.x].data[6].x;
            r17.y = dot(r20.xyzw, r19.xyzw);
            r17.xy = r17.xy / r8.ww;
            r17.xy = saturate(r17.xy * float2(0.5,-0.5) + float2(0.5,0.5));
            r19.x = r17.x * lightConstantsCB[r0.x].data[8].y + lightConstantsCB[r0.x].data[8].z;
            r19.y = r17.y * lightConstantsCB[r0.x].data[8].w + lightConstantsCB[r0.x].data[9].x;
            r6.w = r6.w / r8.w;
            ...
            if (enableDitheredShadow != 0) {
              ...
              while (true) {
                ...
                if (r11.w != 0) break;
                r21.x = dot(icb[r10.w+0].yx, r17.xy);
                r21.y = dot(icb[r10.w+0].yx, r17.yz);
        ...
        if (r7.w != 0) {
          ...
          if (r9.w != 0) {
            ...
            r17.xyz = r12.xyz * r9.www + r11.xyz;
            r19.xyz = lightConstantsCB[r8.w].data[6].yzw;
            r19.w = lightConstantsCB[r8.w].data[7].x;
            r17.w = 1;
            r9.w = dot(r19.xyzw, r17.xyzw);
            r19.xyz = lightConstantsCB[r8.w].data[7].yzw;
            r19.w = lightConstantsCB[r8.w].data[8].x;
            r10.w = dot(r19.xyzw, r17.xyzw);
            r11.w = cmp(r10.w < r9.w);
            if (r11.w == 0) {
              r19.xyz = lightConstantsCB[r8.w].data[4].yzw;
              r19.w = lightConstantsCB[r8.w].data[5].x;
              r19.x = dot(r19.xyzw, r17.xyzw);
              r20.xyz = lightConstantsCB[r8.w].data[5].yzw;
              r20.w = lightConstantsCB[r8.w].data[6].x;
              r19.y = dot(r20.xyzw, r17.xyzw);
              r17.xy = r19.xy / r10.ww;
              r17.xy = r17.xy * float2(0.5,-0.5) + float2(0.5,0.5);
              r19.x = lightConstantsCB[r8.w].data[9].w + r17.x;
              r19.y = lightConstantsCB[r8.w].data[10].x + r17.y;
              r17.xy = lightConstantsCB[r8.w].data[9].yz * r19.xy;
              r17.zw = lightConstantsCB[r8.w].data[3].yy / lightConstantsCB[r8.w].data[8].yw;
              r19.xy = float2(1,1) + -r17.zw;
              r19.xy = cmp(r17.xy >= r19.xy);
              r17.zw = cmp(r17.zw >= r17.xy);
              r17.zw = (int2)r17.zw | (int2)r19.xy;
              r12.w = (int)r17.w | (int)r17.z;
              if (r12.w == 0) {
                r17.xy = saturate(r17.xy);
                r19.x = r17.x * lightConstantsCB[r8.w].data[8].y + lightConstantsCB[r8.w].data[8].z;
                r19.y = r17.y * lightConstantsCB[r8.w].data[8].w + lightConstantsCB[r8.w].data[9].x;
                r14.w = lightConstantsCB[r8.w].data[10].z * r10.w;
            ...
            if (r10.w == 0) {
              ...
              if (enableDitheredShadow != 0) {
                ...
                while (true) {
                  ...
                  if (r14.w != 0) break;
                  r21.x = dot(icb[r12.w+0].yx, r17.xy);
                  r21.y = dot(icb[r12.w+0].yx, r17.yz);
            ...
            if (r1.z != 0) {
              ...
              if (r9.w == 0) {
                ...
                r17.xy = r19.xy / r8.ww;
                r17.xy = r17.xy * float2(0.5,-0.5) + float2(0.5,0.5);
                r19.x = lightConstantsCB[r0.x].data[9].w + r17.x;
                r19.y = lightConstantsCB[r0.x].data[10].x + r17.y;
                r17.xy = lightConstantsCB[r0.x].data[9].yz * r19.xy;
                ...
                if (r10.w == 0) {
                  ...
                  r1.z = lightConstantsCB[r0.x].data[10].y * r8.w + r1.z;
                  r1.z = r1.z / r11.w;
                }
              } else {
                r10.w = -1;
              ...
              if (r8.w == 0) {
                ...
                if (enableDitheredShadow != 0) {
                  ...
                  while (true) {
                    ...
                    if (r10.w != 0) break;
                    r21.x = dot(icb[r9.w+0].yx, r17.xy);
                    r21.y = dot(icb[r9.w+0].yx, r17.yz);
                    r20.xy = r21.xy * lightConstantsCB[r0.x].data[3].yy + r19.xy;
                    r10.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r20.xyz, r1.z).x;
                    r4.x = r10.w * 0.125 + r4.x;
                    r9.w = (int)r9.w + 1;
                  }
                } else {
                  r19.z = (uint)r8.w;
          ...
          r0.x = r0.x * r6.w;
          r1.z = cmp(0 < r4.z);
          r17.xyz = r0.xxx * r18.xyz + r13.yzw;
          r4.xyz = r14.xyz * r4.yyy + r5.yzw;
          r0.x = dot(r4.xyz, r4.xyz);
          r0.x = rsqrt(r0.x);
          r4.xyz = r4.xyz * r0.xxx;
          r0.x = dot(r4.xyz, r5.yzw);
          ...
          r0.w = r6.w * r0.w;
          r0.w = 0.25 * r0.w;
          r2.xyw = r0.www * r18.xyz + r15.xyz;
          r0.x = saturate(1 + -r0.x);
          r1.w = r0.x * r0.x;
          r1.w = r1.w * r1.w;
          r0.x = r1.w * r0.x;
          r0.x = r0.w * r0.x;
          r4.xyz = r0.xxx * r18.xyz + r16.xyz;
          r13.yzw = r1.zzz ? r17.xyz : r13.yzw;
          r16.xyz = r1.zzz ? r4.xyz : r16.xyz;
          r15.xyz = r1.zzz ? r2.xyw : r15.xyz;
          if (r2.z != 0) {
          // Known bad code for instruction (needs manual fix):
  ...
  r4.xyz = r10.zxy * float3(3,1,2) + float3(0.5,0,-1);
  r0.w = (uint)r4.x;
  r0.x = cmp((int)r0.x == (int)r0.w);
  r0.xw = r0.xx ? r4.yz : float2(-1,0);
  r7.x = r1.z;
  r7.y = r2.x;
  r7.z = r3.x;
  r7.w = r0.x;
  ...
  r5.xyzw = permuteHighlight & int4(32,3,64,12);
  r1.zw = cmp((int2)r5.xz != int2(0,0));
  r3.xy = cmp((int2)r5.yw == int2(2,0));
  r1.zw = r1.zw ? r3.xy : 0;
  ...
  if (enableCountDebug != 0) {
    if (debugDrawOverlayType != 0) {
      switch (cb2[53].y) {
        ...
        break;
        case 4 :        r0.x = (int)r4.w & 255;
        break;
        case 5 :        if (8 == 0) r0.x = 0; else if (8+8 < 32) {         r0.x = (uint)r4.w << (32-(8 + 8)); r0.x = (uint)r0.x >> (32-8);        } else r0.x = (uint)r4.w >> 8;
        break;
        default :
        r0.x = 0;
        break;
