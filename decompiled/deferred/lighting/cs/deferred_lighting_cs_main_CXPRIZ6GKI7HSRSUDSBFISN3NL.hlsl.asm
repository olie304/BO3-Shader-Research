...
loop 
  ieq r14.w, r12.w, l(2)
  breakc_nz r14.w
  movc r14.w, r12.w, r0.y, r9.w
  uge r15.w, r14.w, r8.w
  ...
  if_nz r15.w
    ...
    add r13.yzw, r4.xxyw, -cb10[r14.w + 0].xxyz
    and r15.w, l(0x0000ffff), cb10[r14.w + 7].z
    ubfe r17.w, l(6), l(25), cb10[r14.w + 7].z
    imul null, r18.w, r15.w, l(6)
    dp3 r22.x, cb11[r18.w + 0].xyzx, r13.yzwy
    add_sat r22.x, r22.x, cb11[r18.w + 0].w
    dp3 r22.y, cb11[r18.w + 1].xyzx, r13.yzwy
    add_sat r22.y, r22.y, cb11[r18.w + 1].w
    mul r22.x, r22.y, r22.x
    dp3 r22.y, cb11[r18.w + 2].xyzx, r13.yzwy
    add_sat r22.y, r22.y, cb11[r18.w + 2].w
    mul r22.x, r22.y, r22.x
    dp3 r22.y, cb11[r18.w + 3].xyzx, r13.yzwy
    add_sat r22.y, r22.y, cb11[r18.w + 3].w
    mul r22.x, r22.y, r22.x
    dp3 r22.y, cb11[r18.w + 4].xyzx, r13.yzwy
    add_sat r22.y, r22.y, cb11[r18.w + 4].w
    mul r22.x, r22.y, r22.x
    dp3 r22.y, cb11[r18.w + 5].xyzx, r13.yzwy
    add_sat r18.w, r22.y, cb11[r18.w + 5].w
    mul r14.x, r18.w, r22.x
    and r18.w, l(1), cb10[r14.w + 6].x
    movc r22.xy, r18.wwww, r14.xyxx, r14.zxzz
    mov r14.x, cb10[r14.w + 6].x
    mov r23.xy, r22.xyxx
    mov r18.w, l(1)
    loop 
      ige r22.z, r18.w, r17.w
      breakc_nz r22.z
      iadd r22.z, r15.w, r18.w
      imul null, r22.z, r22.z, l(6)
      dp3 r22.w, cb11[r22.z + 0].xyzx, r13.yzwy
      add_sat r22.w, r22.w, cb11[r22.z + 0].w
      mul r22.w, r22.w, r23.x
      dp3 r23.z, cb11[r22.z + 1].xyzx, r13.yzwy
      add_sat r23.z, r23.z, cb11[r22.z + 1].w
      mul r22.w, r22.w, r23.z
      dp3 r23.z, cb11[r22.z + 2].xyzx, r13.yzwy
      add_sat r23.z, r23.z, cb11[r22.z + 2].w
      mul r22.w, r22.w, r23.z
      dp3 r23.z, cb11[r22.z + 3].xyzx, r13.yzwy
      add_sat r23.z, r23.z, cb11[r22.z + 3].w
      mul r22.w, r22.w, r23.z
      dp3 r23.z, cb11[r22.z + 4].xyzx, r13.yzwy
      add_sat r23.z, r23.z, cb11[r22.z + 4].w
      mul r22.w, r22.w, r23.z
      dp3 r23.z, cb11[r22.z + 5].xyzx, r13.yzwy
      add_sat r22.z, r23.z, cb11[r22.z + 5].w
      mul r23.x, r22.z, r22.w
      ushr r23.z, r14.x, l(2)
      ubfe r23.w, l(1), l(2), r14.x
      and r24.x, r23.z, l(2)
      max r24.y, r23.x, r23.y
      mad r22.z, -r22.w, r22.z, l(1.000000)
      mul r22.z, r22.z, r23.y
      movc r16.y, r24.x, r22.z, r24.y
      movc r23.xy, r23.wwww, r23.xyxx, r16.xyxx
      iadd r18.w, r18.w, l(1)
      mov r14.x, r23.z
    endloop 
    mov_sat r23.y, r23.y
    mul r14.x, r23.y, cb10[r14.w + 6].y
    lt r15.w, l(0.000000), r14.x
    if_nz r15.w
      and r15.w, r21.w, l(7)
      iadd r16.y, r15.w, l(-1)
      ult r16.y, r16.y, l(32)
      and r16.y, r1.w, r16.y
      if_nz r16.y
        imad r22.xy, r15.wwww, l(20, 20, 0, 0), l(860, 876, 0, 0)
        ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r15.w, cb2[52].x, r22.x, u2.xxxx
        or r15.w, r15.w, l(32)
        store_structured u2.x, cb2[52].x, r22.x, r15.w
        store_structured u2.x, cb2[52].x, r22.y, r14.x
      endif 
      iadd r20.w, r20.w, l(257)
      mad r20.z, r23.y, cb10[r14.w + 6].y, r20.z
      mul r14.x, r14.x, cb10[r14.w + 7].y
      mov r22.x, cb10[r14.w + 7].w
      mov r22.yz, cb10[r14.w + 8].xxyx
      dp3 r15.w, r11.xyzx, r22.xyzx
      dp3 r16.y, r13.yzwy, r22.xyzx
      ...
      mov r22.x, cb10[r14.w + 8].w
      mov r22.yz, cb10[r14.w + 9].xxyx
      dp3 r16.y, r11.xyzx, r22.xyzx
      ...
      mov r22.x, cb10[r14.w + 9].w
      mov r22.yz, cb10[r14.w + 10].xxyx
      dp3 r16.y, r11.xyzx, r22.xyzx
      dp3 r17.w, r13.yzwy, r22.xyzx
      ...
      div r16.y, r17.w, r16.y
      min r15.w, r15.w, |r16.y|
      mov r22.x, cb10[r14.w + 10].w
      mov r22.yz, cb10[r14.w + 11].xxyx
      dp3 r16.y, r11.xyzx, r22.xyzx
      dp3 r17.w, r13.yzwy, r22.xyzx
      ...
      div r16.y, r17.w, r16.y
      min r15.w, r15.w, |r16.y|
      mov r22.x, cb10[r14.w + 11].w
      mov r22.yz, cb10[r14.w + 12].xxyx
      dp3 r16.y, r11.xyzx, r22.xyzx
      dp3 r17.w, r13.yzwy, r22.xyzx
      ...
      div r16.y, r17.w, r16.y
      min r15.w, r15.w, |r16.y|
      mov r22.x, cb10[r14.w + 12].w
      mov r22.yz, cb10[r14.w + 13].xxyx
      dp3 r16.y, r11.xyzx, r22.xyzx
      dp3 r17.w, r13.yzwy, r22.xyzx
      ...
      div r16.y, r17.w, r16.y
      min r15.w, r15.w, |r16.y|
      add r22.x, r13.y, cb10[r14.w + 3].w
      add r22.yz, r13.zzwz, cb10[r14.w + 4].xxyx
      mad r22.xyz, r11.xyzx, r15.wwww, r22.xyzx
      dp3 r16.y, r22.xyzx, r22.xyzx
      sqrt r16.y, r16.y
      ...
      mov r26.xy, cb10[r14.w + 1].xwxx
      mov r26.z, cb10[r14.w + 2].z
      dp3 r25.y, r22.xyzx, r26.xyzx
      mov r27.x, cb10[r14.w + 1].y
      mov r27.yz, cb10[r14.w + 2].xxwx
      dp3 r25.z, r22.xyzx, r27.xyzx
      ubfe r16.y, l(9), l(16), cb10[r14.w + 7].z
      utof r25.w, r16.y
      sample_l_indexable(texturecubearray)(float,float,float,float) r22.xyz, r25.xyzw, t8.xyzw, s2, r15.w
      and r23.xzw, r22.xxyz, l(0x7fffffff, 0, 0x7fffffff, 0x7fffffff)
      ieq r23.xzw, r23.xxzw, l(0x7f800000, 0, 0x7f800000, 0x7f800000)
      or r15.w, r23.z, r23.x
      or r15.w, r23.w, r15.w
      ...
      mad_sat r13.yzw, r28.xxyz, cb10[r14.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
      mul r28.xy, r13.yzyy, cb10[r14.w + 4].zwzz
      mul r28.z, r13.w, cb10[r14.w + 5].x
      add r13.yzw, r28.xxyz, cb10[r14.w + 5].yyzw
      ...
      movc r18.z, r23.w, l(0), l(0.500000)
      ...
      mad r13.yzw, r13.yyzw, r26.zzzz, r24.xxyz
      sample_l_indexable(texturecubearray)(float,float,float,float) r23.xzw, r25.xyzw, t8.xwyz, s2, l(6.000000)
      and r24.xyz, r23.xzwx, l(0x7fffffff, 0x7fffffff, 0x7fffffff, 0)
      ieq r24.xyz, r24.xyzx, l(0x7f800000, 0x7f800000, 0x7f800000, 0)
      or r14.w, r24.y, r24.x
      or r14.w, r24.z, r14.w
      movc r23.xzw, r14.wwww, l(1.000000,0,1.000000,0), r23.xxzw
      mul r24.xyz, r13.yzwy, r23.xzwx
      dp3 r14.w, r24.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r19.xyz, r13.yzwy, r23.xzwx, r19.xyzx
      mul r13.y, r7.w, r14.w
      mul r22.xyz, r14.xxxx, r22.xyzx
      dp3 r13.z, r22.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r13.z, r7.w, r14.w, r13.z
      div r13.y, r13.y, r13.z
      mov r24.x, r19.w
      mov r24.yz, r20.xxyx
      mad r13.yzw, r22.xxyz, r13.yyyy, r24.xxyz
      mov r19.w, r13.y
      mov r20.xy, r13.zwzz
    else 
...
loop 
  ...
  breakc_nz r14.w
  movc r14.w, r12.w, r0.y, r9.w
  ult r15.w, r14.w, r8.w
  if_nz r15.w
    imul null, r14.w, r14.w, l(14)
    if_nz r1.w
      and r15.w, r16.y, l(15)
      imad r15.w, r15.w, l(20), l(880)
      add r13.yzw, cb1[24].xxyz, cb10[r14.w + 0].xxyz
      store_structured u2.xyzw, cb2[52].x, r15.w, r13.xyzw
    endif 
    ...
    dp3 r22.w, cb11[r18.w + 1].xyzx, r13.yzwy
    add_sat r22.w, r22.w, cb11[r18.w + 1].w
    mul r21.w, r21.w, r22.w
    dp3 r22.w, cb11[r18.w + 2].xyzx, r13.yzwy
    add_sat r22.w, r22.w, cb11[r18.w + 2].w
    mul r21.w, r21.w, r22.w
    dp3 r22.w, cb11[r18.w + 3].xyzx, r13.yzwy
    add_sat r22.w, r22.w, cb11[r18.w + 3].w
    mul r21.w, r21.w, r22.w
    dp3 r22.w, cb11[r18.w + 4].xyzx, r13.yzwy
    add_sat r22.w, r22.w, cb11[r18.w + 4].w
    mul r21.w, r21.w, r22.w
    dp3 r22.w, cb11[r18.w + 5].xyzx, r13.yzwy
    add_sat r18.w, r22.w, cb11[r18.w + 5].w
    mul r14.x, r18.w, r21.w
    and r18.w, l(1), cb10[r14.w + 6].x
    movc r23.zw, r18.wwww, r14.xxxy, r14.zzzx
    mov r14.x, cb10[r14.w + 6].x
    mov r24.xy, r23.zwzz
    mov r18.w, l(1)
    loop 
      ...
      dp3 r22.w, cb11[r21.w + 0].xyzx, r13.yzwy
      add_sat r22.w, r22.w, cb11[r21.w + 0].w
      mul r22.w, r22.w, r24.x
      dp3 r24.z, cb11[r21.w + 1].xyzx, r13.yzwy
      add_sat r24.z, r24.z, cb11[r21.w + 1].w
      mul r22.w, r22.w, r24.z
      dp3 r24.z, cb11[r21.w + 2].xyzx, r13.yzwy
      add_sat r24.z, r24.z, cb11[r21.w + 2].w
      mul r22.w, r22.w, r24.z
      dp3 r24.z, cb11[r21.w + 3].xyzx, r13.yzwy
      add_sat r24.z, r24.z, cb11[r21.w + 3].w
      mul r22.w, r22.w, r24.z
      dp3 r24.z, cb11[r21.w + 4].xyzx, r13.yzwy
      add_sat r24.z, r24.z, cb11[r21.w + 4].w
      mul r22.w, r22.w, r24.z
      dp3 r24.z, cb11[r21.w + 5].xyzx, r13.yzwy
      add_sat r21.w, r24.z, cb11[r21.w + 5].w
      mul r24.x, r21.w, r22.w
      ...
      movc r16.w, r25.x, r21.w, r25.y
      movc r24.xy, r24.wwww, r24.xyxx, r16.zwzz
      iadd r18.w, r18.w, l(1)
      mov r14.x, r24.z
    endloop 
    add_sat r14.x, -r20.z, r24.y
    mul r15.w, r14.x, cb10[r14.w + 6].y
    lt r16.w, l(0.000000), r15.w
    if_nz r16.w
      and r16.w, r23.y, l(31)
      iadd r17.w, r16.w, l(-1)
      ult r17.w, r17.w, l(32)
      and r17.w, r1.w, r17.w
      if_nz r17.w
        imad r23.zw, r16.wwww, l(0, 0, 20, 20), l(0, 0, 860, 876)
        ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r16.w, cb2[52].x, r23.z, u2.xxxx
        or r16.w, r16.w, l(32)
        store_structured u2.x, cb2[52].x, r23.z, r16.w
        store_structured u2.x, cb2[52].x, r23.w, r15.w
      endif 
      iadd r16.y, r16.y, l(257)
      mad r16.x, r14.x, cb10[r14.w + 6].y, r16.x
      mul r14.x, r15.w, cb10[r14.w + 7].y
      ...
      div r16.w, r17.w, r16.w
      min r15.w, r15.w, |r16.w|
      add r25.x, r13.y, cb10[r14.w + 3].w
      add r25.yz, r13.zzwz, cb10[r14.w + 4].xxyx
      mad r24.xzw, r11.xxyz, r15.wwww, r25.xxyz
      dp3 r16.w, r24.xzwx, r24.xzwx
      sqrt r16.w, r16.w
      ...
      utof r26.w, r16.w
      sample_l_indexable(texturecubearray)(float,float,float,float) r24.xzw, r26.xyzw, t8.xwyz, s2, r15.w
      ...
      movc r24.xzw, r15.wwww, l(1.000000,0,1.000000,0), r24.xxzw
      dp3 r29.x, r13.yzwy, r25.xyzx
      dp3 r29.y, r13.yzwy, r27.xyzx
      dp3 r29.z, r13.yzwy, r28.xyzx
      mad_sat r13.yzw, r29.xxyz, cb10[r14.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
      mul r29.xy, r13.yzyy, cb10[r14.w + 4].zwzz
      mul r29.z, r13.w, cb10[r14.w + 5].x
      add r13.yzw, r29.xxyz, cb10[r14.w + 5].yyzw
      dp3 r26.x, r10.xyzx, r25.xyzx
      ...
      movc r25.xyz, r14.wwww, l(1.000000,1.000000,0,0), r25.xyzx
      ...
      mul r13.y, r7.w, r14.w
      mul r24.xzw, r14.xxxx, r24.xxzw
      dp3 r13.z, r24.xzwx, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r13.z, r7.w, r14.w, r13.z
      div r13.y, r13.y, r13.z
      mad r22.xyz, r24.xzwx, r13.yyyy, r22.xyzx
    else 
      mov r23.x, r16.x
      mov r16.xy, r23.xyxx
    endif 
...
bfi r2.w, l(8), l(0), r16.y, r20.w
movc r0.y, r0.y, r2.w, r16.y
max r2.w, r16.x, l(1.000000)
rcp r2.w, r2.w
mov_sat r16.x, r16.x
mul r13.xyz, r2.wwww, r21.xyzx
mul r14.xyz, r2.wwww, r22.xyzx
lt r6.w, r16.x, l(0.990000)
if_nz r6.w
  iadd r0.y, r0.y, l(256)
  add r6.w, -r16.x, l(1.000000)
  ...
  mad r13.xyz, r21.xyzx, r2.wwww, r10.xyzx
  mov r11.w, l(0)
