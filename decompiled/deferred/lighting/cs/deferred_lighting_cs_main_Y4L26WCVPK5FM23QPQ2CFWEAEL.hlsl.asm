...
mov r16.w, l(0)
sample_l_indexable(texturecubearray)(float,float,float,float) r17.xyz, r16.xyzw, t8.xyzw, s2, r4.z
...
ret 
// Approximately 1555 instruction slots used
