...
loop 
  ieq r9.w, r0.y, l(2)
  breakc_nz r9.w
  movc r9.w, r0.y, r0.x, r13.y
  uge r10.w, r9.w, r8.w
  ult r12.w, r9.w, cb2[0].y
  ...
  if_nz r10.w
    ...
    if_nz r2.w
      ...
      store_structured u2.xyzw, cb2[52].x, r10.w, r15.xyzw
    endif 
    iadd r23.w, r22.w, l(1)
    add r15.yzw, r5.xxyz, -cb10[r9.w + 0].xxyz
    and r10.w, l(0x0000ffff), cb10[r9.w + 7].z
    ubfe r12.w, l(6), l(25), cb10[r9.w + 7].z
    imul null, r13.w, r10.w, l(6)
    dp3 r16.w, cb11[r13.w + 0].xyzx, r15.yzwy
    add_sat r16.w, r16.w, cb11[r13.w + 0].w
    dp3 r17.w, cb11[r13.w + 1].xyzx, r15.yzwy
    add_sat r17.w, r17.w, cb11[r13.w + 1].w
    mul r16.w, r16.w, r17.w
    dp3 r17.w, cb11[r13.w + 2].xyzx, r15.yzwy
    add_sat r17.w, r17.w, cb11[r13.w + 2].w
    mul r16.w, r16.w, r17.w
    dp3 r17.w, cb11[r13.w + 3].xyzx, r15.yzwy
    add_sat r17.w, r17.w, cb11[r13.w + 3].w
    mul r16.w, r16.w, r17.w
    dp3 r17.w, cb11[r13.w + 4].xyzx, r15.yzwy
    add_sat r17.w, r17.w, cb11[r13.w + 4].w
    mul r16.w, r16.w, r17.w
    dp3 r17.w, cb11[r13.w + 5].xyzx, r15.yzwy
    add_sat r13.w, r17.w, cb11[r13.w + 5].w
    mul r16.x, r13.w, r16.w
    and r13.w, l(1), cb10[r9.w + 6].x
    movc r16.xw, r13.wwww, r16.xxxy, r16.zzzx
    mov r13.w, cb10[r9.w + 6].x
    mov r24.xy, r16.xwxx
    mov r17.w, l(1)
    loop 
      ige r19.w, r17.w, r12.w
      breakc_nz r19.w
      iadd r19.w, r10.w, r17.w
      imul null, r19.w, r19.w, l(6)
      dp3 r20.w, cb11[r19.w + 0].xyzx, r15.yzwy
      add_sat r20.w, r20.w, cb11[r19.w + 0].w
      mul r20.w, r20.w, r24.x
      dp3 r24.z, cb11[r19.w + 1].xyzx, r15.yzwy
      add_sat r24.z, r24.z, cb11[r19.w + 1].w
      mul r20.w, r20.w, r24.z
      dp3 r24.z, cb11[r19.w + 2].xyzx, r15.yzwy
      add_sat r24.z, r24.z, cb11[r19.w + 2].w
      mul r20.w, r20.w, r24.z
      dp3 r24.z, cb11[r19.w + 3].xyzx, r15.yzwy
      add_sat r24.z, r24.z, cb11[r19.w + 3].w
      mul r20.w, r20.w, r24.z
      dp3 r24.z, cb11[r19.w + 4].xyzx, r15.yzwy
      add_sat r24.z, r24.z, cb11[r19.w + 4].w
      mul r20.w, r20.w, r24.z
      dp3 r24.z, cb11[r19.w + 5].xyzx, r15.yzwy
      add_sat r19.w, r24.z, cb11[r19.w + 5].w
      mul r24.x, r19.w, r20.w
      ushr r24.z, r13.w, l(2)
      ubfe r24.w, l(1), l(2), r13.w
      and r25.x, r24.z, l(2)
    ...
    if_nz r12.w
      ...
      if_nz r13.w
        imad r16.xw, r12.wwww, l(20, 0, 0, 20), l(860, 0, 0, 876)
        ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r12.w, cb2[52].x, r16.x, u2.xxxx
        or r12.w, r12.w, l(32)
        store_structured u2.x, cb2[52].x, r16.x, r12.w
        store_structured u2.x, cb2[52].x, r16.w, r10.w
      endif 
      iadd r22.w, r22.w, l(257)
      mad r22.z, r24.y, cb10[r9.w + 6].y, r22.z
      mul r10.w, r10.w, cb10[r9.w + 7].y
      mov r25.x, cb10[r9.w + 7].w
      mov r25.yz, cb10[r9.w + 8].xxyx
      dp3 r12.w, r14.xyzx, r25.xyzx
      dp3 r13.w, r15.yzwy, r25.xyzx
      add r13.w, r13.w, -cb10[r9.w + 8].z
      ...
      dp3 r16.x, r15.yzwy, r25.xyzx
      add r16.x, r16.x, -cb10[r9.w + 9].z
      ...
      dp3 r13.w, r14.xyzx, r25.xyzx
      dp3 r16.x, r15.yzwy, r25.xyzx
      add r16.x, r16.x, -cb10[r9.w + 10].z
      ge r16.w, r16.x, l(0.000000)
      max r16.x, r6.w, |r16.x|
      movc r16.x, r16.w, r16.x, -r16.x
      max r13.w, -r13.w, l(0.00000010)
      ...
      dp3 r13.w, r14.xyzx, r25.xyzx
      dp3 r16.x, r15.yzwy, r25.xyzx
      add r16.x, r16.x, -cb10[r9.w + 11].z
      ge r16.w, r16.x, l(0.000000)
      max r16.x, r6.w, |r16.x|
      movc r16.x, r16.w, r16.x, -r16.x
      max r13.w, -r13.w, l(0.00000010)
      ...
      dp3 r13.w, r14.xyzx, r25.xyzx
      dp3 r16.x, r15.yzwy, r25.xyzx
      add r16.x, r16.x, -cb10[r9.w + 12].z
      ge r16.w, r16.x, l(0.000000)
      max r16.x, r6.w, |r16.x|
      movc r16.x, r16.w, r16.x, -r16.x
      max r13.w, -r13.w, l(0.00000010)
      ...
      dp3 r13.w, r14.xyzx, r25.xyzx
      dp3 r16.x, r15.yzwy, r25.xyzx
      add r16.x, r16.x, -cb10[r9.w + 13].z
      ge r16.w, r16.x, l(0.000000)
      max r16.x, r6.w, |r16.x|
      movc r16.x, r16.w, r16.x, -r16.x
      max r13.w, -r13.w, l(0.00000010)
      div r13.w, r16.x, r13.w
      min r12.w, r12.w, |r13.w|
      add r25.x, r15.y, cb10[r9.w + 3].w
      add r25.yz, r15.zzwz, cb10[r9.w + 4].xxyx
      mad r24.xzw, r14.xxyz, r12.wwww, r25.xxyz
      dp3 r13.w, r24.xzwx, r24.xzwx
      sqrt r13.w, r13.w
      ...
      ubfe r13.w, l(9), l(16), cb10[r9.w + 7].z
      utof r26.w, r13.w
      sample_l_indexable(texturecubearray)(float,float,float,float) r24.xzw, r26.xyzw, t8.xwyz, s2, r12.w
      ...
      movc r24.xzw, r12.wwww, l(1.000000,0,1.000000,0), r24.xxzw
      dp3 r29.x, r15.yzwy, r25.xyzx
      dp3 r29.y, r15.yzwy, r27.xyzx
      dp3 r29.z, r15.yzwy, r28.xyzx
      mad_sat r15.yzw, r29.xxyz, cb10[r9.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
      mul r29.xy, r15.yzyy, cb10[r9.w + 4].zwzz
      mul r29.z, r15.w, cb10[r9.w + 5].x
      add r15.yzw, r29.xxyz, cb10[r9.w + 5].yyzw
      ...
      mul r28.xyz, r10.wwww, r28.xyzx
      movc r19.z, r25.y, l(0), l(0.500000)
      add r25.xyw, r15.yzyw, r19.xyxz
      ...
      mad r15.yzw, r15.yyzw, r28.zzzz, r25.xxyw
      ...
      mad r21.xyz, r15.yzwy, r25.xyzx, r21.xyzx
      mul r12.w, r7.w, r9.w
      mul r15.yzw, r10.wwww, r24.xxzw
      dp3 r10.w, r15.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r9.w, r7.w, r9.w, r10.w
      div r9.w, r12.w, r9.w
      mov r25.x, r21.w
      mov r25.yz, r22.xxyx
      mad r15.yzw, r15.yyzw, r9.wwww, r25.xxyz
      mov r21.w, r15.y
      mov r22.xy, r15.zwzz
    else 
...
loop 
  ...
  if_nz r10.w
    ...
    loop 
      ...
      movc r18.w, r25.z, r19.w, r25.w
      movc r26.xy, r24.wwww, r26.xyxx, r18.zwzz
      iadd r17.w, r17.w, l(1)
      mov r13.w, r23.w
    endloop 
    add_sat r10.w, -r22.z, r26.y
    mul r12.w, r10.w, cb10[r9.w + 6].y
    lt r13.w, l(0.000000), r12.w
    if_nz r13.w
      and r13.w, r25.y, l(31)
      iadd r16.x, r13.w, l(-1)
      ult r16.x, r16.x, l(32)
      and r16.x, r2.w, r16.x
      if_nz r16.x
        imad r16.xw, r13.wwww, l(20, 0, 0, 20), l(860, 0, 0, 876)
        ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r13.w, cb2[52].x, r16.x, u2.xxxx
        or r13.w, r13.w, l(32)
        store_structured u2.x, cb2[52].x, r16.x, r13.w
        store_structured u2.x, cb2[52].x, r16.w, r12.w
      endif 
      iadd r18.y, r18.y, l(257)
      mad r18.x, r10.w, cb10[r9.w + 6].y, r18.x
      mul r10.w, r12.w, cb10[r9.w + 7].y
      mov r27.x, cb10[r9.w + 7].w
      mov r27.yz, cb10[r9.w + 8].xxyx
      dp3 r12.w, r14.xyzx, r27.xyzx
      dp3 r13.w, r15.yzwy, r27.xyzx
      add r13.w, r13.w, -cb10[r9.w + 8].z
      ge r16.x, r13.w, l(0.000000)
      max r13.w, r6.w, |r13.w|
      movc r13.w, r16.x, r13.w, -r13.w
      ...
      div r12.w, r13.w, r12.w
      min r12.w, |r12.w|, l(131072.000000)
      mov r27.x, cb10[r9.w + 8].w
      mov r27.yz, cb10[r9.w + 9].xxyx
      dp3 r13.w, r14.xyzx, r27.xyzx
      dp3 r16.x, r15.yzwy, r27.xyzx
      add r16.x, r16.x, -cb10[r9.w + 9].z
      ge r16.w, r16.x, l(0.000000)
      max r16.x, r6.w, |r16.x|
      movc r16.x, r16.w, r16.x, -r16.x
      ...
      div r13.w, r16.x, r13.w
      min r12.w, r12.w, |r13.w|
      mov r27.x, cb10[r9.w + 9].w
      mov r27.yz, cb10[r9.w + 10].xxyx
      dp3 r13.w, r14.xyzx, r27.xyzx
      dp3 r16.x, r15.yzwy, r27.xyzx
      add r16.x, r16.x, -cb10[r9.w + 10].z
      ge r16.w, r16.x, l(0.000000)
      ...
      div r13.w, r16.x, r13.w
      min r12.w, r12.w, |r13.w|
      mov r27.x, cb10[r9.w + 10].w
      mov r27.yz, cb10[r9.w + 11].xxyx
      dp3 r13.w, r14.xyzx, r27.xyzx
      dp3 r16.x, r15.yzwy, r27.xyzx
      add r16.x, r16.x, -cb10[r9.w + 11].z
      ge r16.w, r16.x, l(0.000000)
      ...
      div r13.w, r16.x, r13.w
      min r12.w, r12.w, |r13.w|
      mov r27.x, cb10[r9.w + 11].w
      mov r27.yz, cb10[r9.w + 12].xxyx
      dp3 r13.w, r14.xyzx, r27.xyzx
      dp3 r16.x, r15.yzwy, r27.xyzx
      add r16.x, r16.x, -cb10[r9.w + 12].z
      ge r16.w, r16.x, l(0.000000)
      ...
      div r13.w, r16.x, r13.w
      min r12.w, r12.w, |r13.w|
      mov r27.x, cb10[r9.w + 12].w
      mov r27.yz, cb10[r9.w + 13].xxyx
      dp3 r13.w, r14.xyzx, r27.xyzx
      dp3 r16.x, r15.yzwy, r27.xyzx
      add r16.x, r16.x, -cb10[r9.w + 13].z
      ge r16.w, r16.x, l(0.000000)
      ...
      div r13.w, r16.x, r13.w
      min r12.w, r12.w, |r13.w|
      add r27.x, r15.y, cb10[r9.w + 3].w
      add r27.yz, r15.zzwz, cb10[r9.w + 4].xxyx
      mad r26.xzw, r14.xxyz, r12.wwww, r27.xxyz
      dp3 r13.w, r26.xzwx, r26.xzwx
      sqrt r13.w, r13.w
      div r12.w, r12.w, r13.w
      add r12.w, r12.w, r12.w
      sqrt r12.w, r12.w
      mad r12.w, r3.y, l(5.000000), r12.w
      add r12.w, r12.w, l(-0.844800)
      mov r27.x, cb10[r9.w + 0].w
      mov r27.y, cb10[r9.w + 1].z
      mov r27.z, cb10[r9.w + 2].y
      dp3 r28.x, r26.xzwx, r27.xyzx
      mov r29.xy, cb10[r9.w + 1].xwxx
      mov r29.z, cb10[r9.w + 2].z
      dp3 r28.y, r26.xzwx, r29.xyzx
      mov r30.x, cb10[r9.w + 1].y
      mov r30.yz, cb10[r9.w + 2].xxwx
      dp3 r28.z, r26.xzwx, r30.xyzx
      ubfe r13.w, l(9), l(16), cb10[r9.w + 7].z
      utof r28.w, r13.w
      sample_l_indexable(texturecubearray)(float,float,float,float) r26.xzw, r28.xyzw, t8.xwyz, s2, r12.w
      ...
      mad_sat r15.yzw, r31.xxyz, cb10[r9.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
      mul r31.xy, r15.yzyy, cb10[r9.w + 4].zwzz
      mul r31.z, r15.w, cb10[r9.w + 5].x
      add r15.yzw, r31.xxyz, cb10[r9.w + 5].yyzw
      ...
      mul r12.w, r7.w, r9.w
      mul r15.yzw, r10.wwww, r26.xxzw
      dp3 r10.w, r15.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r9.w, r7.w, r9.w, r10.w
      div r9.w, r12.w, r9.w
      mad r24.xyz, r15.yzwy, r9.wwww, r24.xyzx
    else 
      mov r25.x, r18.x
      mov r18.xy, r25.xyxx
    endif 
...
lt r3.y, r18.x, l(0.990000)
if_nz r3.y
  iadd r0.x, r0.x, l(256)
  add r3.y, -r18.x, l(1.000000)
  mul r6.w, r3.y, cb2[19].x
  ...
  mov r14.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r17.xyz, r14.xyzw, t8.xyzw, s2, r3.z
  mad r0.y, cb2[19].x, r3.y, -r6.w
...
mul r17.xyz, r4.zzzz, r15.xyzx
and r18.xyz, r3.wwww, r17.xyzx
...
switch r3.z
  case l(4)
  if_nz r2.w
    add r20.yzw, cb1[24].xxyz, cb9[r3.y + 0].xxyz
    mov r20.x, l(2)
    store_structured u2.xyzw, cb2[52].x, l(112), r20.xyzw
  endif 
  lt r6.w, l(0.000000), cb9[r3.y + 6].y
  mov r20.xy, cb9[r3.y + 5].zwzz
  mov r20.z, cb9[r3.y + 6].x
  mad r13.yzw, -r20.xxyz, l(0.000000, 0.500000, 0.500000, 0.500000), cb9[r3.y + 0].xxyz
  add r21.xyz, -r5.xyzx, r13.yzwy
  dp3 r7.w, r20.xyzx, r21.xyzx
  div_sat r8.w, -r7.w, cb9[r3.y + 6].y
  mad r22.xyz, r8.wwww, r20.xyzx, r13.yzwy
  movc r22.xyz, r6.wwww, r22.xyzx, cb9[r3.y + 0].xyzx
  ...
  if_nz r12.w
    sqrt r12.w, r9.w
    mul r14.w, cb9[r3.y + 3].x, cb9[r3.y + 3].x
    div r9.w, r14.w, r9.w
    min r9.w, r9.w, l(1.000000)
    mad_sat r22.xy, r12.wwww, cb9[r3.y + 2].xzxx, cb9[r3.y + 2].ywyy
    ...
    if_nz r12.w
      ubfe r12.w, l(3), l(27), cb9[r3.y + 1].w
      if_nz r2.w
      ...
      if_nz r12.w
        ...
        add r22.yzw, r22.yyzw, -cb9[r3.y + 4].yyzw
        max r12.w, |r22.w|, |r22.z|
        max r12.w, r12.w, |r22.y|
        div r12.w, cb9[r3.y + 5].x, r12.w
        add r12.w, r12.w, cb9[r3.y + 5].y
        ...
        loop 
          ...
          mul r26.yz, r23.yyzy, cb9[r3.y + 3].yyyy
      ...
      if_nz r12.w
        ...
        if_nz r8.w
          ...
          ubfe r7.w, l(4), l(20), cb9[r3.y + 1].w
          ult r8.w, l(0), r7.w
          not r14.w, r1.z
          and r8.w, r8.w, r14.w
          if_nz r8.w
        ...
        mul r7.w, r9.w, r7.w
        mov r20.x, cb9[r3.y + 0].w
        mov r20.yz, cb9[r3.y + 1].xxyx
        mul r21.xyz, r7.wwww, r20.xyzx
        lt r8.w, l(0.000000), r10.w
        mad r21.xyz, r15.xyzx, r4.zzzz, r21.xyzx
        ...
        mad r13.y, |r11.w|, r1.w, -|r11.w|
        mad r11.w, |r11.w|, r13.y, l(1.000000)
        mad r13.y, r10.w, r0.y, r2.y
        ...
        mad r13.yzw, r10.wwww, r20.xxyz, r16.xxyz
        add_sat r6.w, -r6.w, l(1.000000)
        mul r11.w, r6.w, r6.w
        mul r11.w, r11.w, r11.w
        mul r6.w, r6.w, r11.w
        mul r6.w, r6.w, r10.w
        mad r14.xyz, r6.wwww, r20.xyzx, r19.xyzx
        mad r20.xyz, r7.wwww, r20.xyzx, r18.xyzx
        and r20.xyz, r3.wwww, r20.xyzx
        movc r17.xyz, r8.wwww, r21.xyzx, r17.xyzx
        movc r18.xyz, r8.wwww, r18.xyzx, r20.xyzx
        movc r19.xyz, r8.wwww, r14.xyzx, r19.xyzx
        movc r16.xyz, r8.wwww, r13.yzwy, r16.xyzx
        if_nz r2.w
  ...
  case l(2)
  if_nz r2.w
    add r14.yzw, cb1[24].xxyz, cb9[r3.y + 0].xxyz
    mov r14.x, l(2)
    store_structured u2.xyzw, cb2[52].x, l(112), r14.xyzw
  endif 
  add r14.xy, -r5.xyxx, cb9[r3.y + 3].zwzz
  add r14.z, -r5.z, cb9[r3.y + 4].x
  ...
  if_nz r10.w
    mov r20.xyz, cb9[r3.y + 7].yzwy
    mov r20.w, cb9[r3.y + 8].x
    mov r5.w, l(1.000000)
    dp4 r10.w, r20.xyzw, r5.xyzw
    lt r11.w, r10.w, l(1.000000)
    if_nz r11.w
      mov r13.yzw, l(0,1.000000,1.000000,1.000000)
      mov r11.w, l(0)
    else 
      add r21.xyz, -r5.xyzx, cb9[r3.y + 0].xyzx
      ...
      lt r5.w, cb9[r3.y + 10].w, l(0.00048828)
      if_nz r5.w
        mad_sat r22.xy, |r21.xyxx|, cb9[r3.y + 12].xyxx, cb9[r3.y + 12].zwzz
        mul r22.zw, r22.xxxy, r22.xxxy
        mad r22.xy, r22.xyxx, l(-2.000000, -2.000000, 0.000000, 0.000000), l(3.000000, 3.000000, 0.000000, 0.000000)
        mul r22.xy, r22.xyxx, r22.zwzz
        ...
        log r22.xy, r22.xyxx
        mul r22.xy, r22.xyxx, cb9[r3.y + 12].wwww
        exp r22.xy, r22.xyxx
        mul r10.w, r22.x, cb9[r3.y + 12].x
        mad r14.w, cb9[r3.y + 12].y, r22.y, l(-1.000000)
        mad r10.w, cb9[r3.y + 12].y, r22.y, -r10.w
    ...
    if_nz r5.w
      ubfe r5.w, l(3), l(27), cb9[r3.y + 1].w
      if_nz r2.w
      ...
      if_nz r5.w
        ...
        ge r12.w, r10.w, r5.w
        if_nz r12.w
          mov r20.xyz, cb9[r3.y + 4].yzwy
          mov r20.w, cb9[r3.y + 5].x
          ...
          mad r21.x, r20.x, cb9[r3.y + 8].y, cb9[r3.y + 8].z
          mad r21.y, r20.y, cb9[r3.y + 8].w, cb9[r3.y + 9].x
          div r5.w, r5.w, r10.w
          max r5.w, r5.w, l(0.00006104)
          and r10.w, l(0x0000ffff), cb9[r3.y + 1].w
          if_nz cb2[58].y
            mov r20.x, -r3.x
            utof r22.z, r10.w
            mov r20.y, r13.x
            ...
            loop 
              ...
              mad r22.xy, r23.xyxx, cb9[r3.y + 3].yyyy, r21.xyxx
      ...
      if_nz r10.w
        ...
        if_nz r12.w
          ...
          if_nz r1.z
            ...
            if_z r12.w
              ...
              if_z r14.w
                mov_sat r20.xy, r20.xyxx
                mad r21.x, r20.x, cb9[r1.z + 8].y, cb9[r1.z + 8].z
                mad r21.y, r20.y, cb9[r1.z + 8].w, cb9[r1.z + 9].x
                mul r15.w, r11.w, cb9[r1.z + 10].z
                mad r3.y, cb9[r1.z + 10].y, r11.w, r3.y
                div r3.y, r3.y, r15.w
              endif 
            else 
              mov r14.w, l(-1)
            ...
            if_z r11.w
              ...
              if_nz cb2[58].y
                ...
                loop 
                  ige r13.x, r12.w, l(8)
                  breakc_nz r13.x
                  dp2 r23.x, icb[r12.w + 0].yxyy, r20.xyxx
                  dp2 r23.y, icb[r12.w + 0].yxyy, r20.yzyy
                  mad r22.xy, r23.xyxx, cb9[r1.z + 3].yyyy, r21.xyxx
                  sample_c_lz_indexable(texture2darray)(float,float,float,float) r13.x, r22.xyzx, t9.xxxx, s13, r3.y
                  mad r3.x, r13.x, l(0.125000), r3.x
                  iadd r12.w, r12.w, l(1)
                endloop 
              else 
                utof r21.z, r11.w
                sample_c_lz_indexable(texture2darray)(float,float,float,float) r3.x, r21.xyzx, t9.xxxx, s13, r3.y
              endif 
              mul r1.z, r3.x, r3.x
              mul r1.z, r3.x, r1.z
            else 
        ...
        add r1.z, -r9.w, r1.z
        mad r1.z, r2.z, r1.z, r9.w
        mul r1.z, r5.w, r1.z
        mul r20.xyz, r13.yzwy, r1.zzzz
        lt r2.x, l(0.000000), r7.w
        mad r15.xyz, r15.xyzx, r4.zzzz, r20.xyzx
        ...
        mad r11.xyz, r0.yyyy, r13.yzwy, r16.xyzx
        ...
        mad r13.xyz, r1.zzzz, r13.yzwy, r18.xyzx
        and r13.xyz, r3.wwww, r13.xyzx
        movc r17.xyz, r2.xxxx, r15.xyzx, r17.xyzx
        movc r18.xyz, r2.xxxx, r18.xyzx, r13.xyzx
...
mad r2.xyz, r18.xyzx, r4.xyzx, r2.xyzx
