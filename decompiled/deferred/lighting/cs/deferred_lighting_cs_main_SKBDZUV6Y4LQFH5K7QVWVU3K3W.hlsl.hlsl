...
r0.y = samp0[]..swiz;
  ...
  if (r13.z != 0) {
    ...
    r14.yzw = -refProbeConstantsCB[r13.z].data[0].xyz + r11.xyz;
    r13.w = 0x0000ffff & (int)refProbeConstantsCB[r13.z].data[7].z;
    if (6 == 0) r16.x = 0; else if (6+25 < 32) {     r16.x = (uint)refProbeConstantsCB[r13.z].data[7].z << (32-(6 + 25)); r16.x = (uint)r16.x >> (32-6);    } else r16.x = (uint)refProbeConstantsCB[r13.z].data[7].z >> 25;
    r16.y = (int)r13.w * 6;
    r16.z = dot(refProbeAttenuationConstantsCB[r16.y].data[0].xyz, r14.yzw);
    r16.z = saturate(refProbeAttenuationConstantsCB[r16.y].data[0].w + r16.z);
    r16.w = dot(refProbeAttenuationConstantsCB[r16.y].data[1].xyz, r14.yzw);
    r16.w = saturate(refProbeAttenuationConstantsCB[r16.y].data[1].w + r16.w);
    r16.z = r16.z * r16.w;
    r16.w = dot(refProbeAttenuationConstantsCB[r16.y].data[2].xyz, r14.yzw);
    r16.w = saturate(refProbeAttenuationConstantsCB[r16.y].data[2].w + r16.w);
    r16.z = r16.z * r16.w;
    r16.w = dot(refProbeAttenuationConstantsCB[r16.y].data[3].xyz, r14.yzw);
    r16.w = saturate(refProbeAttenuationConstantsCB[r16.y].data[3].w + r16.w);
    r16.z = r16.z * r16.w;
    r16.w = dot(refProbeAttenuationConstantsCB[r16.y].data[4].xyz, r14.yzw);
    r16.w = saturate(refProbeAttenuationConstantsCB[r16.y].data[4].w + r16.w);
    r16.z = r16.z * r16.w;
    r16.w = dot(refProbeAttenuationConstantsCB[r16.y].data[5].xyz, r14.yzw);
    ...
    if (r16.x != 0) {
      ...
      r16.x = refProbeConstantsCB[r13.z].data[7].y * r13.w;
      r17.x = refProbeConstantsCB[r13.z].data[7].w;
      r17.yz = refProbeConstantsCB[r13.z].data[8].xy;
      r16.y = dot(r15.xyz, r17.xyz);
      r16.z = dot(r14.yzw, r17.xyz);
      ...
      r16.z = r16.w / r16.z;
      r16.y = min(r16.y, abs(r16.z));
      r17.x = refProbeConstantsCB[r13.z].data[3].w + r14.y;
      r17.yz = refProbeConstantsCB[r13.z].data[4].xy + r14.zw;
      r17.xyz = r15.xyz * r16.yyy + r17.xyz;
      ...
      r18.x = refProbeConstantsCB[r13.z].data[0].w;
      r18.y = refProbeConstantsCB[r13.z].data[1].z;
      r18.z = refProbeConstantsCB[r13.z].data[2].y;
      r19.x = dot(r17.xyz, r18.xyz);
      r20.xy = refProbeConstantsCB[r13.z].data[1].xw;
      r20.z = refProbeConstantsCB[r13.z].data[2].z;
      r19.y = dot(r17.xyz, r20.xyz);
      r21.x = refProbeConstantsCB[r13.z].data[1].y;
      r21.yz = refProbeConstantsCB[r13.z].data[2].xw;
      ...
      r17.x = dot(r14.yzw, r18.xyz);
      r17.y = dot(r14.yzw, r20.xyz);
      r17.z = dot(r14.yzw, r21.xyz);
      r14.yzw = saturate(r17.xyz * refProbeConstantsCB[r13.z].data[3].xyz + float3(0.5,0.5,0.5));
      r17.xy = refProbeConstantsCB[r13.z].data[4].zw * r14.yz;
      r17.z = refProbeConstantsCB[r13.z].data[5].x * r14.w;
      r14.yzw = refProbeConstantsCB[r13.z].data[5].yzw + r17.xyz;
  ...
  if (r13.y != 0) {
    ...
    r13.y = (int)r13.z + 1;
    r17.xyz = -refProbeConstantsCB[r0.x].data[0].xyz + r11.xyz;
    ...
    if (r18.x != 0) {
      ...
      r13.y = (int)r13.z + 257;
      r16.w = r16.w * refProbeConstantsCB[r0.x].data[6].y + r13.w;
  ...
  r0.x = cmp(r13.w >= 1);
  bitmask.w = ((~(-1 << 8)) << 0) & 0xffffffff;  r6.w = (((uint)r13.y << 0) & bitmask.w) | ((uint)r13.z & ~bitmask.w);
  r0.x = r0.x ? r6.w : r13.y;
  r6.w = max(1, r16.w);
  r6.w = rcp(r6.w);
  r16.w = saturate(r16.w);
  r13.yzw = r14.yzw * r6.www;
  r16.xyz = r16.xyz * r6.www;
  r9.w = cmp(r16.w < 0.99000001);
  if (r9.w != 0) {
    r0.x = (int)r0.x + 256;
    r9.w = 1 + -r16.w;
    ...
    r10.w = dot(r17.xyz, float3(0.212599993,0.715200007,0.0722000003));
    r13.yzw = r14.yzw * r6.www + r17.xyz;
    r15.w = 0;
    ...
    r16.xyz = r14.yzw * r6.www + r16.xyz;
  }
  r6.w = r2.x + r5.z;
  r6.w = log2(abs(r6.w));
  r6.w = r6.w * r2.z;
  ...
  r17.xyz = r13.yzw * r5.zzz;
  r18.xyz = r4.zzz ? r17.yzx : 0;
  ...
  r16.xyz = r16.xyz * r6.www;
  r19.xyz = r16.xyz * r14.yyy;
  r16.xyz = r16.xyz * r14.zzz;
  r2.y = sqrt(r2.z);
  r2.y = r2.y * 0.5 + 0.5;
  r2.y = r2.y * r2.y;
  r6.w = 0.5 * r2.y;
  ...
  if (r8.w != 0) {
    ...
    if (r8.w != 0) {
      ...
      if (r10.w != 0) {
        ...
        r20.xyz = r12.xyz * r10.www + r11.xyz;
        ...
        if (r10.w == 0) {
          ...
          if (enableDitheredShadow != 0) {
            ...
            while (true) {
              ...
              r20.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r22.xyz, r10.w).x;
              r15.w = r20.w * 0.125 + r15.w;
              r19.w = (int)r19.w + 1;
            }
          } else {
            r20.z = (uint)r12.w;
            r15.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r20.xyz, r10.w).x;
          }
          r9.w = r15.w * r15.w;
          r9.w = r9.w * r15.w;
        } else {
      ...
      r3.y = cmp(0 < r3.y);
      r20.xyz = r13.yzw * r5.zzz + r20.xyz;
      r13.yzw = -r11.xyz * r1.zzz + sunConstants.wldDir.xyz;
      r1.z = dot(r13.yzw, r13.yzw);
      r1.z = rsqrt(r1.z);
      r13.yzw = r13.yzw * r1.zzz;
      r1.z = dot(r13.yzw, r5.xyw);
      ...
      r3.z = r7.w * r3.z;
      r3.z = 0.25 * r3.z;
      r21.yzw = r3.zzz * r14.yzw + r16.xyz;
      r1.z = saturate(1 + -r1.z);
      r5.z = r1.z * r1.z;
      r5.z = r5.z * r5.z;
      r1.z = r5.z * r1.z;
      r1.z = r3.z * r1.z;
      r13.yzw = r1.zzz * r14.yzw + r19.xyz;
      r14.yzw = r3.www * r14.yzw + r18.zxy;
      r22.xyz = r4.zzz ? r14.zwy : 0;
      r20.w = r18.z;
      r17.w = r22.z;
      ...
      r21.x = r13.w;
      r16.w = r19.z;
      r16.xyzw = r3.yyyy ? r21.yzwx : r16.xyzw;
      if (r2.w != 0) {
      // Known bad code for instruction (needs manual fix):
  ...
  r0.y = (int)r0.y * 15;
  if (3 == 0) r3.y = 0; else if (3+24 < 32) {   r3.y = (uint)lightConstantsCB[r0.y].data[1].w << (32-(3 + 24)); r3.y = (uint)r3.y >> (32-3);  } else r3.y = (uint)lightConstantsCB[r0.y].data[1].w >> 24;
  switch (r3.y) {
    case 4 :    if (r2.w != 0) {
      r20.yzw = lightConstantsCB[r0.y].data[0].xyz + eyeOffset.xyz;
      r20.x = 2;
      GBufferDiffuseColor[viewID].136 = u2.xyzw;
    }
    r3.y = (int)r1.z + 1;
    r3.z = cmp(0 < lightConstantsCB[r0.y].data[6].y);
    r20.xy = lightConstantsCB[r0.y].data[5].zw;
    r20.z = lightConstantsCB[r0.y].data[6].x;
    r13.yzw = -r20.xyz * float3(0.5,0.5,0.5) + lightConstantsCB[r0.y].data[0].xyz;
    r14.yzw = r13.yzw + -r11.xyz;
    r3.w = dot(r20.xyz, r14.yzw);
    r5.z = saturate(-r3.w / lightConstantsCB[r0.y].data[6].y);
    r21.xyz = r5.zzz * r20.xyz + r13.yzw;
    r21.xyz = r3.zzz ? r21.xyz : lightConstantsCB[r0.y].data[0].xyz;
    ...
    if (r10.w != 0) {
      ...
      r7.w = r12.w / r7.w;
      r7.w = min(1, r7.w);
      r21.xy = saturate(r10.ww * lightConstantsCB[r0.y].data[2].xz + lightConstantsCB[r0.y].data[2].yw);
      ...
      r10.w = cmp(0 < r7.w);
      if (r10.w != 0) {
        if (3 == 0) r10.w = 0; else if (3+27 < 32) {         r10.w = (uint)lightConstantsCB[r0.y].data[1].w << (32-(3 + 27)); r10.w = (uint)r10.w >> (32-3);        } else r10.w = (uint)lightConstantsCB[r0.y].data[1].w >> 27;
        if (r2.w != 0) {
        // Known bad code for instruction (needs manual fix):
        ...
        if (r10.w != 0) {
          ...
          r10.w = lightConstantsCB[r0.y].data[5].x / r10.w;
          r10.w = lightConstantsCB[r0.y].data[5].y + r10.w;
        ...
        if (r10.w != 0) {
          ...
          r10.w = 0.25 * r10.w;
          r15.w = dot(r20.xyz, r15.xyz);
          r14.y = dot(r15.xyz, r14.yzw);
          r14.z = -r15.w * r15.w + lightConstantsCB[r0.y].data[6].y;
          r3.w = r15.w * r14.y + -r3.w;
          r3.w = saturate(r3.w / r14.z);
          r14.y = r14.z / lightConstantsCB[r0.y].data[6].y;
          r14.y = 10 * r14.y;
          r14.y = min(1, r14.y);
          r3.w = r3.w + -r5.z;
          r3.w = r14.y * r3.w + r5.z;
          r13.yzw = r3.www * r20.xyz + r13.yzw;
          r13.yzw = r3.zzz ? r13.yzw : lightConstantsCB[r0.y].data[0].xyz;
          r13.yzw = r13.yzw + -r11.xyz;
          r3.z = dot(r13.yzw, r13.yzw);
          r3.z = rsqrt(r3.z);
          r14.yzw = r13.yzw * r3.zzz;
          if (4 == 0) r3.w = 0; else if (4+16 < 32) {           r3.w = (uint)lightConstantsCB[r0.y].data[1].w << (32-(4 + 16)); r3.w = (uint)r3.w >> (32-4);          } else r3.w = (uint)lightConstantsCB[r0.y].data[1].w >> 16;
          r5.z = cmp(0 < (uint)r3.w);
          r5.z = r3.x ? r5.z : 0;
          if (r5.z != 0) {
            r3.w = (int)r3.w + numLights;
            r3.w = mad((int)r3.w, 15, -15);
            r5.z = abs(r8.w) * -0.200000003 + 0.400000006;
            r15.x = cmp(r8.w < 0);
            r15.x = r4.z ? r15.x : 0;
            r5.z = r15.x ? -r5.z : r5.z;
            ...
            if (r17.w == 0) {
              ...
              if (r15.z == 0) {
                ...
                r15.x = lightConstantsCB[r3.w].data[10].z * r16.w;
                r5.z = lightConstantsCB[r3.w].data[10].y * r16.w + r5.z;
                r5.z = r5.z / r15.x;
              }
            } else {
              r15.z = -1;
            ...
            if (r15.x == 0) {
              ...
              r15.x = 0x0000ffff & (int)lightConstantsCB[r3.w].data[1].w;
              if (enableDitheredShadow != 0) {
                r21.x = -r13.x;
                r22.z = (uint)r15.x;
                r21.y = r14.x;
                ...
                while (true) {
                  ...
                  r15.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r22.xyz, r5.z).x;
                  r15.y = r15.w * 0.125 + r15.y;
                  r15.z = (int)r15.z + 1;
                }
              } else {
                r20.z = (uint)r15.x;
                r15.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r20.xyz, r5.z).x;
              }
              r3.w = r15.y * r15.y;
              r3.w = r3.w * r15.y;
            } else {
            ...
            if (4 == 0) r3.w = 0; else if (4+20 < 32) {             r3.w = (uint)lightConstantsCB[r0.y].data[1].w << (32-(4 + 20)); r3.w = (uint)r3.w >> (32-4);            } else r3.w = (uint)lightConstantsCB[r0.y].data[1].w >> 20;
            r5.z = cmp(0 < (uint)r3.w);
            r15.x = ~(int)r3.x;
            r5.z = r5.z ? r15.x : 0;
            if (r5.z != 0) {
          ...
          r3.w = r2.z * r3.w + r9.w;
          r3.w = r3.w * r7.w;
          r15.x = lightConstantsCB[r0.y].data[0].w;
          r15.yz = lightConstantsCB[r0.y].data[1].xy;
          r5.z = cmp(0 < r8.w);
          r20.xyz = r3.www * r15.xyz + r17.xyz;
          r8.w = saturate(dot(r12.xyz, r14.yzw));
          r13.yzw = r13.yzw * r3.zzz + r5.xyw;
          r3.z = dot(r13.yzw, r13.yzw);
          r3.z = rsqrt(r3.z);
          r13.yzw = r13.yzw * r3.zzz;
          r3.z = dot(r13.yzw, r5.xyw);
          r9.w = dot(r12.xyz, r13.yzw);
          r13.y = abs(r9.w) * r1.w + -abs(r9.w);
          r9.w = abs(r9.w) * r13.y + 1;
          r13.y = r8.w * r2.y + r6.w;
          r9.w = r9.w * r9.w;
          r9.w = r9.w * r13.y;
          r9.w = rcp(r9.w);
          r8.w = r8.w * r10.w;
          r8.w = r9.w * r8.w;
          r8.w = r8.w * r7.w;
          r13.yzw = r8.www * r15.xyz + r16.xyz;
          r3.z = saturate(1 + -r3.z);
          r9.w = r3.z * r3.z;
          r9.w = r9.w * r9.w;
          r3.z = r9.w * r3.z;
          r3.z = r8.w * r3.z;
          r14.yzw = r3.zzz * r15.xyz + r19.xyz;
          r15.xyz = r3.www * r15.xyz + r18.zxy;
          r15.xyz = r4.zzz ? r15.xyz : r18.zxy;
          r17.xyz = r5.zzz ? r20.xyz : r17.xyz;
          r18.xyz = r5.zzz ? r18.xyz : r15.yzx;
          r19.xyz = r5.zzz ? r14.yzw : r19.xyz;
    ...
    r3.w = dot(r12.xyz, r13.yzw);
    r5.z = saturate(r3.w);
    r7.w = r4.z ? abs(r3.w) : r5.z;
    r8.w = cmp(0 < r7.w);
    if (r8.w != 0) {
      r20.xyz = lightConstantsCB[r0.y].data[7].yzw;
      r20.w = lightConstantsCB[r0.y].data[8].x;
      r11.w = 1;
      r8.w = dot(r20.xyzw, r11.xyzw);
      r9.w = cmp(r8.w < 1);
      if (r9.w != 0) {
        r13.yzw = float3(1,1,1);
        r9.w = 0;
      } else {
        r14.yzw = lightConstantsCB[r0.y].data[0].xyz + -r11.xyz;
        r10.w = lightConstantsCB[r0.y].data[3].x * lightConstantsCB[r0.y].data[3].x;
        r12.w = dot(r14.yzw, r14.yzw);
        r10.w = r10.w / r12.w;
        r10.w = min(1, r10.w);
        r14.yz = saturate(r8.ww * lightConstantsCB[r0.y].data[2].xz + lightConstantsCB[r0.y].data[2].yw);
        r21.xy = r14.yz * r14.yz;
        r14.yz = r14.yz * float2(-2,-2) + float2(3,3);
        r14.yz = r21.xy * r14.yz;
        r10.w = r14.y * r10.w;
        r10.w = r10.w * r14.z;
        r21.xyz = lightConstantsCB[r0.y].data[4].yzw;
        r21.w = lightConstantsCB[r0.y].data[5].x;
        r21.x = dot(r21.xyzw, r11.xyzw);
        r22.xyz = lightConstantsCB[r0.y].data[5].yzw;
        r22.w = lightConstantsCB[r0.y].data[6].x;
        r21.y = dot(r22.xyzw, r11.xyzw);
        r21.xy = r21.xy / r8.ww;
        r8.w = cmp(lightConstantsCB[r0.y].data[10].w < 0.00048828125);
        if (r8.w != 0) {
          r14.yz = saturate(abs(r21.xy) * lightConstantsCB[r0.y].data[12].xy + lightConstantsCB[r0.y].data[12].zw);
          r22.xy = r14.yz * r14.yz;
          r14.yz = r14.yz * float2(-2,-2) + float2(3,3);
          r14.yz = r22.xy * r14.yz;
          r8.w = r14.y * r14.z;
        } else {
          r22.xyzw = saturate(lightConstantsCB[r0.y].data[11].xyzw * abs(r21.yyxx));
          r22.xyzw = log2(r22.xyzw);
          r22.xyzw = lightConstantsCB[r0.y].data[12].zzzz * r22.xyzw;
          r22.xyzw = exp2(r22.xyzw);
          r14.yz = r22.xy + r22.zw;
          r14.yz = log2(r14.yz);
          r14.yz = lightConstantsCB[r0.y].data[12].ww * r14.yz;
          r14.yz = exp2(r14.yz);
          r11.w = lightConstantsCB[r0.y].data[12].x * r14.y;
          r12.w = lightConstantsCB[r0.y].data[12].y * r14.z + -1;
          r11.w = lightConstantsCB[r0.y].data[12].y * r14.z + -r11.w;
        ...
        if (r8.w != 0) {
          r21.z = 1;
          r10.w = dot(lightConstantsCB[r0.y].data[13].xyz, r21.xyz);
          r22.x = lightConstantsCB[r0.y].data[13].w;
          r22.yz = lightConstantsCB[r0.y].data[14].xy;
      ...
      r21.x = lightConstantsCB[r0.y].data[0].w;
      r21.yz = lightConstantsCB[r0.y].data[1].xy;
      ...
      if (r8.w != 0) {
        ...
        if (r8.w != 0) {
          ...
          r22.xyz = lightConstantsCB[r0.y].data[6].yzw;
          r22.w = lightConstantsCB[r0.y].data[7].x;
          r21.w = 1;
          r8.w = dot(r22.xyzw, r21.xyzw);
          r11.w = dot(r20.xyzw, r21.xyzw);
          ...
          if (r12.w != 0) {
            ...
            r14.yz = r20.xy / r11.ww;
            r14.yz = saturate(r14.yz * float2(0.5,-0.5) + float2(0.5,0.5));
            r20.x = r14.y * lightConstantsCB[r0.y].data[8].y + lightConstantsCB[r0.y].data[8].z;
            r20.y = r14.z * lightConstantsCB[r0.y].data[8].w + lightConstantsCB[r0.y].data[9].x;
            r8.w = r8.w / r11.w;
            ...
            if (enableDitheredShadow != 0) {
              ...
              while (true) {
                ...
                r22.xy = r23.xy * lightConstantsCB[r0.y].data[3].yy + r20.xy;
        ...
        r9.w = cmp(0 < r8.w);
        if (r9.w != 0) {
          r9.w = lightConstantsCB[r0.y].data[1].z * r1.w;
          r9.w = r9.w * r5.z;
          ...
          if (r12.w != 0) {
            ...
            r20.xyz = r12.xyz * r12.www + r11.xyz;
            ...
            if (r3.x != 0) {
              ...
              r11.w = cmp(r3.w < 0);
              r11.w = r4.z ? r11.w : 0;
              r3.x = r11.w ? -r3.x : r3.x;
              r20.xyz = r12.xyz * r3.xxx + r11.xyz;
              r21.xyz = lightConstantsCB[r0.y].data[6].yzw;
              r21.w = lightConstantsCB[r0.y].data[7].x;
              r20.w = 1;
              r3.x = dot(r21.xyzw, r20.xyzw);
              r21.xyz = lightConstantsCB[r0.y].data[7].yzw;
              r21.w = lightConstantsCB[r0.y].data[8].x;
              r11.w = dot(r21.xyzw, r20.xyzw);
              r12.w = cmp(r11.w < r3.x);
              if (r12.w == 0) {
                r21.xyz = lightConstantsCB[r0.y].data[4].yzw;
                r21.w = lightConstantsCB[r0.y].data[5].x;
                r21.x = dot(r21.xyzw, r20.xyzw);
                ...
                r14.yz = r14.yz * float2(0.5,-0.5) + float2(0.5,0.5);
                r20.x = lightConstantsCB[r0.y].data[9].w + r14.y;
                r20.y = lightConstantsCB[r0.y].data[10].x + r14.z;
                r14.yz = lightConstantsCB[r0.y].data[9].yz * r20.xy;
                r20.xy = lightConstantsCB[r0.y].data[3].yy / lightConstantsCB[r0.y].data[8].yw;
                r20.zw = float2(1,1) + -r20.xy;
                r20.zw = cmp(r14.yz >= r20.zw);
                r20.xy = cmp(r20.xy >= r14.yz);
                r20.xy = (int2)r20.xy | (int2)r20.zw;
                r14.w = (int)r20.y | (int)r20.x;
                if (r14.w == 0) {
                  r14.yz = saturate(r14.yz);
                  r20.x = r14.y * lightConstantsCB[r0.y].data[8].y + lightConstantsCB[r0.y].data[8].z;
                  r20.y = r14.z * lightConstantsCB[r0.y].data[8].w + lightConstantsCB[r0.y].data[9].x;
                  r14.y = lightConstantsCB[r0.y].data[10].z * r11.w;
                  r3.x = lightConstantsCB[r0.y].data[10].y * r11.w + r3.x;
                  r3.x = r3.x / r14.y;
                }
              } else {
                r14.w = -1;
              ...
              if (r11.w == 0) {
                ...
                if (enableDitheredShadow != 0) {
                  ...
                  while (true) {
                    ...
                    r22.xy = r14.xy * lightConstantsCB[r0.y].data[3].yy + r20.xy;
                    r14.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r22.xyz, r3.x).x;
                    r12.w = r14.x * 0.125 + r12.w;
                    r13.x = (int)r13.x + 1;
                  }
                } else {
                  r20.z = (uint)r11.w;
                  r12.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r20.xyz, r3.x).x;
                }
                r0.y = r12.w * r12.w;
                r0.y = r0.y * r12.w;
              } else {
          ...
          r0.y = r0.y * r8.w;
          r2.x = cmp(0 < r3.w);
          r14.xyz = r0.yyy * r13.yzw + r17.xyz;
          r3.xzw = r15.xyz * r3.zzz + r5.xyw;
          r2.z = dot(r3.xzw, r3.xzw);
          r2.z = rsqrt(r2.z);
          r3.xzw = r3.xzw * r2.zzz;
          r2.z = dot(r3.xzw, r5.xyw);
          r3.x = dot(r12.xyz, r3.xzw);
          ...
          r1.w = r8.w * r1.w;
          r1.w = 0.25 * r1.w;
          r3.xzw = r1.www * r13.yzw + r16.xyz;
          r2.y = saturate(1 + -r2.z);
          r2.z = r2.y * r2.y;
          r2.z = r2.z * r2.z;
          r2.y = r2.y * r2.z;
          r1.w = r2.y * r1.w;
          r5.xyz = r1.www * r13.yzw + r19.xyz;
          r12.xyz = r0.yyy * r13.yzw + r18.zxy;
          r12.xyz = r4.zzz ? r12.xyz : r18.zxy;
          r17.xyz = r2.xxx ? r14.xyz : r17.xyz;
          r18.xyz = r2.xxx ? r18.xyz : r12.yzx;
          r19.xyz = r2.xxx ? r5.xyz : r19.xyz;
          r16.xyz = r2.xxx ? r3.xzw : r16.xyz;
          if (r2.w != 0) {
          // Known bad code for instruction (needs manual fix):
  ...
  r2.xyz = r18.zxy * r3.xyz + r2.xyz;
  r4.xyw = float3(0.959999979,0.959999979,0.959999979) * r19.xyz;
  r4.xyw = r16.xyz * float3(0.0399999991,0.0399999991,0.0399999991) + r4.xyw;
  r2.xyz = r4.xyw + r2.xyz;
  r4.xyw = float3(1,1,1) + -r3.xyz;
  r4.xyw = r19.xyz * r4.xyw;
  r3.xyz = r16.xyz * r3.xyz + r4.xyw;
  r3.xyz = r17.xyz * r6.xyz + r3.xyz;
