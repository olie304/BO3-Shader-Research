...
r0.y = samplerLinear[]..swiz;
  ...
  r0.x = rsqrt(r0.x);
  r11.xyz = -r9.xyz * r0.xxx;
  r2.x = saturate(dot(r10.xyz, r11.xyz));
  r0.x = dot(-r11.xyz, r10.xyz);
  r0.x = r0.x + r0.x;
  r11.xyz = r10.xyz * -r0.xxx + -r11.xyz;
  r0.x = 17 * r2.y;
  r0.x = exp2(r0.x);
  r0.x = 2 + r0.x;
  r0.x = 2 / r0.x;
  ...
  r0.w = gSSAOTexture.SampleLevel(samplerLinearClamp_s, r1.zw, 0).x;
  r1.z = r4.z * r0.w;
  r1.w = 1 + -r2.y;
  r2.z = 5 * r1.w;
  r2.w = r1.w * 5 + -2.5;
  ...
  if (r6.w != 0) {
    r6.w = (int)r0.y * 14;
    r12.xyz = -refProbeConstantsCB[r6.w].data[0].xyz + r9.xyz;
  ...
  if (r6.w != 0) {
    ...
    if (r5.w != 0) {
      ...
      while (true) {
        ...
        r17.x = r13.w * r12.w;
        r14.w = (uint)r8.w >> 2;
        if (1 == 0) r15.z = 0; else if (1+2 < 32) {         r15.z = (uint)r8.w << (32-(1 + 2)); r15.z = (uint)r15.z >> (32-1);        } else r15.z = (uint)r8.w >> 2;
        r15.w = (int)r14.w & 2;
        r16.z = max(r17.y, r17.x);
        r12.w = -r13.w * r12.w + 1;
        r12.w = r17.y * r12.w;
        r16.y = r15.w ? r12.w : r16.z;
        r17.xy = r15.zz ? r17.xy : r16.xy;
        r9.w = (int)r9.w + 1;
        r8.w = r14.w;
      }
      r5.w = saturate(r17.y + -r7.w);
      r6.w = refProbeConstantsCB[r0.y].data[6].y * r5.w;
      r8.w = cmp(0 < r6.w);
      if (r8.w != 0) {
        r7.w = r5.w * refProbeConstantsCB[r0.y].data[6].y + r7.w;
        r5.w = refProbeConstantsCB[r0.y].data[7].y * r6.w;
        ...
        r2.w = r12.w ? r2.w : -r2.w;
        r8.w = max(1.00000001e-07, -r8.w);
        r2.w = r2.w / r8.w;
        r2.w = min(r6.w, abs(r2.w));
