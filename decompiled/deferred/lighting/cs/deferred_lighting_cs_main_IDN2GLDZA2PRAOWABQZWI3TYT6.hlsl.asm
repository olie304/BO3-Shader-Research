...
loop 
  ...
  loop 
    ...
    if_nz r19.y
      ...
      sqrt r19.y, r19.y
      mad r19.y, r5.w, l(5.000000), r19.y
...
if_nz r5.w
  ...
  mov r16.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r18.xyz, r16.xyzw, t8.xyzw, s2, r7.w
