...
mul r15.xyz, r3.zzzz, r14.xyzx
and r16.xyz, r0.wwww, r15.xyzx
...
if_nz r2.y
  ...
  if_nz r2.y
    ...
    mad r11.xyz, r1.wwww, r18.xyzx, r13.xyzx
    add_sat r0.z, -r0.z, l(1.000000)
    mul r2.y, r0.z, r0.z
    mul r2.y, r2.y, r2.y
    mul r0.z, r0.z, r2.y
    mul r0.z, r0.z, r1.w
    mad r12.xyz, r0.zzzz, r18.xyzx, r17.xzwx
    mad r14.xyz, r1.zzzz, r18.xyzx, r16.xyzx
    and r14.xyz, r0.wwww, r14.xyzx
    movc r15.xyz, r2.xxxx, r4.xywx, r15.xyzx
    movc r16.xyz, r2.xxxx, r16.xyzx, r14.xyzx
...
mad r3.xyz, r15.xyzx, r5.yzwy, r3.xyzx
...
ret 
// Approximately 859 instruction slots used
