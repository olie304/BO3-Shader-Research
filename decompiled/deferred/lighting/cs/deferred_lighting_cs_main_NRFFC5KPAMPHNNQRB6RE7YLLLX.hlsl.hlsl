...
// unknown dcl_: dcl_thread_group 8, 8, 1
  ...
  r0.x = mad(permuteStride, 25, (int)vThreadGroupID.x);
...
r0.y = samplerLinear[]..swiz;
  ...
  if (r7.w != 0) {
    r7.w = (int)r0.y * 14;
    if (r1.z != 0) {
      r12.yzw = refProbeConstantsCB[r7.w].data[0].xyz + eyeOffset.xyz;
      r12.x = 16;
      GBufferDiffuseColor[viewID].880 = u2.xyzw;
    }
    r12.xyz = -refProbeConstantsCB[r7.w].data[0].xyz + r4.xyw;
    ...
    r12.w = (int)r8.w * 6;
    r13.x = dot(refProbeAttenuationConstantsCB[r12.w].data[0].xyz, r12.xyz);
    r13.x = saturate(refProbeAttenuationConstantsCB[r12.w].data[0].w + r13.x);
    r13.y = dot(refProbeAttenuationConstantsCB[r12.w].data[1].xyz, r12.xyz);
    r13.y = saturate(refProbeAttenuationConstantsCB[r12.w].data[1].w + r13.y);
    r13.x = r13.x * r13.y;
    r13.y = dot(refProbeAttenuationConstantsCB[r12.w].data[2].xyz, r12.xyz);
    r13.y = saturate(refProbeAttenuationConstantsCB[r12.w].data[2].w + r13.y);
    r13.x = r13.x * r13.y;
    r13.y = dot(refProbeAttenuationConstantsCB[r12.w].data[3].xyz, r12.xyz);
    r13.y = saturate(refProbeAttenuationConstantsCB[r12.w].data[3].w + r13.y);
    r13.x = r13.x * r13.y;
    r13.y = dot(refProbeAttenuationConstantsCB[r12.w].data[4].xyz, r12.xyz);
    r13.y = saturate(refProbeAttenuationConstantsCB[r12.w].data[4].w + r13.y);
    r13.x = r13.x * r13.y;
    r13.y = dot(refProbeAttenuationConstantsCB[r12.w].data[5].xyz, r12.xyz);
    r12.w = saturate(refProbeAttenuationConstantsCB[r12.w].data[5].w + r13.y);
    r13.x = r13.x * r12.w;
    r12.w = 1 & (int)refProbeConstantsCB[r7.w].data[6].x;
    r13.yz = float2(0,1);
    r13.xy = r12.ww ? r13.xy : r13.zx;
    r14.x = 1;
    r12.w = refProbeConstantsCB[r7.w].data[6].x;
    r15.xy = r13.xy;
    r13.z = 1;
    while (true) {
      r13.w = cmp((int)r13.z >= (int)r9.w);
      if (r13.w != 0) break;
      r13.w = (int)r8.w + (int)r13.z;
      r13.w = (int)r13.w * 6;
      r14.z = dot(refProbeAttenuationConstantsCB[r13.w].data[0].xyz, r12.xyz);
      r14.z = saturate(refProbeAttenuationConstantsCB[r13.w].data[0].w + r14.z);
      r14.z = r15.x * r14.z;
      r14.w = dot(refProbeAttenuationConstantsCB[r13.w].data[1].xyz, r12.xyz);
      r14.w = saturate(refProbeAttenuationConstantsCB[r13.w].data[1].w + r14.w);
      r14.z = r14.z * r14.w;
      r14.w = dot(refProbeAttenuationConstantsCB[r13.w].data[2].xyz, r12.xyz);
      r14.w = saturate(refProbeAttenuationConstantsCB[r13.w].data[2].w + r14.w);
      r14.z = r14.z * r14.w;
      r14.w = dot(refProbeAttenuationConstantsCB[r13.w].data[3].xyz, r12.xyz);
      r14.w = saturate(refProbeAttenuationConstantsCB[r13.w].data[3].w + r14.w);
      r14.z = r14.z * r14.w;
      r14.w = dot(refProbeAttenuationConstantsCB[r13.w].data[4].xyz, r12.xyz);
      r14.w = saturate(refProbeAttenuationConstantsCB[r13.w].data[4].w + r14.w);
      r14.z = r14.z * r14.w;
      r14.w = dot(refProbeAttenuationConstantsCB[r13.w].data[5].xyz, r12.xyz);
      r13.w = saturate(refProbeAttenuationConstantsCB[r13.w].data[5].w + r14.w);
      r15.x = r14.z * r13.w;
      r14.w = (uint)r12.w >> 2;
      if (1 == 0) r15.z = 0; else if (1+2 < 32) {       r15.z = (uint)r12.w << (32-(1 + 2)); r15.z = (uint)r15.z >> (32-1);      } else r15.z = (uint)r12.w >> 2;
      r15.w = (int)r14.w & 2;
      r16.x = max(r15.y, r15.x);
      r13.w = -r14.z * r13.w + 1;
      r13.w = r15.y * r13.w;
      r14.y = r15.w ? r13.w : r16.x;
      r15.xy = r15.zz ? r15.xy : r14.xy;
      r13.z = (int)r13.z + 1;
      r12.w = r14.w;
    }
    r15.y = saturate(r15.y);
    r8.w = refProbeConstantsCB[r7.w].data[6].y * r15.y;
    r9.w = cmp(0 < r8.w);
    if (r9.w != 0) {
      if (r1.z != 0) {
      // Known bad code for instruction (needs manual fix):
      ...
      r13.x = refProbeConstantsCB[r7.w].data[7].w;
      r13.yz = refProbeConstantsCB[r7.w].data[8].xy;
      r12.w = dot(r11.xyz, r13.xyz);
      r13.x = dot(r12.xyz, r13.xyz);
      r13.x = -refProbeConstantsCB[r7.w].data[8].z + r13.x;
      r13.y = cmp(r13.x >= 0);
      r13.x = max(abs(r13.x), r2.w);
      r13.x = r13.y ? r13.x : -r13.x;
      r12.w = max(1.00000001e-07, -r12.w);
      r12.w = r13.x / r12.w;
      r12.w = min(131072, abs(r12.w));
      r13.x = refProbeConstantsCB[r7.w].data[8].w;
      r13.yz = refProbeConstantsCB[r7.w].data[9].xy;
      r13.w = dot(r11.xyz, r13.xyz);
      r13.x = dot(r12.xyz, r13.xyz);
      r13.x = -refProbeConstantsCB[r7.w].data[9].z + r13.x;
      r13.y = cmp(r13.x >= 0);
      r13.x = max(abs(r13.x), r2.w);
      r13.x = r13.y ? r13.x : -r13.x;
      r13.y = max(1.00000001e-07, -r13.w);
      r13.x = r13.x / r13.y;
      r12.w = min(abs(r13.x), r12.w);
      r13.x = refProbeConstantsCB[r7.w].data[9].w;
      r13.yz = refProbeConstantsCB[r7.w].data[10].xy;
      r13.w = dot(r11.xyz, r13.xyz);
      r13.x = dot(r12.xyz, r13.xyz);
      r13.x = -refProbeConstantsCB[r7.w].data[10].z + r13.x;
      r13.y = cmp(r13.x >= 0);
      r13.x = max(abs(r13.x), r2.w);
      r13.x = r13.y ? r13.x : -r13.x;
      r13.y = max(1.00000001e-07, -r13.w);
      r13.x = r13.x / r13.y;
      r12.w = min(abs(r13.x), r12.w);
      r13.x = refProbeConstantsCB[r7.w].data[10].w;
      r13.yz = refProbeConstantsCB[r7.w].data[11].xy;
      r13.w = dot(r11.xyz, r13.xyz);
      r13.x = dot(r12.xyz, r13.xyz);
      r13.x = -refProbeConstantsCB[r7.w].data[11].z + r13.x;
      r13.y = cmp(r13.x >= 0);
      r13.x = max(abs(r13.x), r2.w);
      r13.x = r13.y ? r13.x : -r13.x;
      r13.y = max(1.00000001e-07, -r13.w);
      r13.x = r13.x / r13.y;
      r12.w = min(abs(r13.x), r12.w);
      r13.x = refProbeConstantsCB[r7.w].data[11].w;
      r13.yz = refProbeConstantsCB[r7.w].data[12].xy;
      r13.w = dot(r11.xyz, r13.xyz);
      r13.x = dot(r12.xyz, r13.xyz);
      r13.x = -refProbeConstantsCB[r7.w].data[12].z + r13.x;
      r13.y = cmp(r13.x >= 0);
      r13.x = max(abs(r13.x), r2.w);
      r13.x = r13.y ? r13.x : -r13.x;
      r13.y = max(1.00000001e-07, -r13.w);
      r13.x = r13.x / r13.y;
      r12.w = min(abs(r13.x), r12.w);
      r13.x = refProbeConstantsCB[r7.w].data[12].w;
      r13.yz = refProbeConstantsCB[r7.w].data[13].xy;
      r13.w = dot(r11.xyz, r13.xyz);
      r13.x = dot(r12.xyz, r13.xyz);
      r13.x = -refProbeConstantsCB[r7.w].data[13].z + r13.x;
      r13.y = cmp(r13.x >= 0);
      r13.x = max(abs(r13.x), r2.w);
      r13.x = r13.y ? r13.x : -r13.x;
      r13.y = max(1.00000001e-07, -r13.w);
      r13.x = r13.x / r13.y;
      r12.w = min(abs(r13.x), r12.w);
      r13.x = refProbeConstantsCB[r7.w].data[3].w + r12.x;
      r13.yz = refProbeConstantsCB[r7.w].data[4].xy + r12.yz;
      r13.xyz = r11.xyz * r12.www + r13.xyz;
      ...
      r14.x = refProbeConstantsCB[r7.w].data[0].w;
      r14.y = refProbeConstantsCB[r7.w].data[1].z;
      r14.z = refProbeConstantsCB[r7.w].data[2].y;
      r15.x = dot(r13.xyz, r14.xyz);
      r16.xy = refProbeConstantsCB[r7.w].data[1].xw;
      r16.z = refProbeConstantsCB[r7.w].data[2].z;
      r15.y = dot(r13.xyz, r16.xyz);
      r17.x = refProbeConstantsCB[r7.w].data[1].y;
      r17.yz = refProbeConstantsCB[r7.w].data[2].xw;
      r15.z = dot(r13.xyz, r17.xyz);
      if (9 == 0) r13.x = 0; else if (9+16 < 32) {       r13.x = (uint)refProbeConstantsCB[r7.w].data[7].z << (32-(9 + 16)); r13.x = (uint)r13.x >> (32-9);      } else r13.x = (uint)refProbeConstantsCB[r7.w].data[7].z >> 16;
      r15.w = (uint)r13.x;
      r13.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r15.xyzw, r12.w).xyz;
      r18.xyz = (int3)r13.xyz & int3(-2147483648,-2147483648,-2147483648);
      r18.xyz = cmp((int3)r18.xyz == int3(2139095040,2139095040,2139095040));
      r12.w = (int)r18.y | (int)r18.x;
      r12.w = (int)r18.z | (int)r12.w;
      r13.xyz = r12.www ? float3(1,1,0) : r13.xyz;
      r18.x = dot(r12.xyz, r14.xyz);
      r18.y = dot(r12.xyz, r16.xyz);
      r18.z = dot(r12.xyz, r17.xyz);
      r12.xyz = saturate(r18.xyz * refProbeConstantsCB[r7.w].data[3].xyz + float3(0.5,0.5,0.5));
      r18.xy = refProbeConstantsCB[r7.w].data[4].zw * r12.xy;
      r18.z = refProbeConstantsCB[r7.w].data[5].x * r12.z;
      r12.xyz = refProbeConstantsCB[r7.w].data[5].yzw + r18.xyz;
      ...
      r15.xyz = (int3)r14.xyz & int3(-2147483648,-2147483648,-2147483648);
      r15.xyz = cmp((int3)r15.xyz == int3(2139095040,2139095040,2139095040));
      r7.w = (int)r15.y | (int)r15.x;
      r7.w = (int)r15.z | (int)r7.w;
      r14.xyz = r7.www ? float3(1,1,0) : r14.xyz;
  ...
  if (r6.w != 0) {
    ...
    if (r1.z != 0) {
      ...
      r14.yzw = refProbeConstantsCB[r0.y].data[0].xyz + eyeOffset.xyz;
      r14.x = 16;
      GBufferDiffuseColor[viewID].r6.w = u2.xyzw;
    }
    r6.w = (int)r7.w + 1;
    r14.xyz = -refProbeConstantsCB[r0.y].data[0].xyz + r4.xyw;
    ...
    r13.w = (int)r9.w * 6;
    r14.w = dot(refProbeAttenuationConstantsCB[r13.w].data[0].xyz, r14.xyz);
    r14.w = saturate(refProbeAttenuationConstantsCB[r13.w].data[0].w + r14.w);
    r15.x = dot(refProbeAttenuationConstantsCB[r13.w].data[1].xyz, r14.xyz);
    r15.x = saturate(refProbeAttenuationConstantsCB[r13.w].data[1].w + r15.x);
    r14.w = r15.x * r14.w;
    r15.x = dot(refProbeAttenuationConstantsCB[r13.w].data[2].xyz, r14.xyz);
    r15.x = saturate(refProbeAttenuationConstantsCB[r13.w].data[2].w + r15.x);
    r14.w = r15.x * r14.w;
    r15.x = dot(refProbeAttenuationConstantsCB[r13.w].data[3].xyz, r14.xyz);
    r15.x = saturate(refProbeAttenuationConstantsCB[r13.w].data[3].w + r15.x);
    r14.w = r15.x * r14.w;
    r15.x = dot(refProbeAttenuationConstantsCB[r13.w].data[4].xyz, r14.xyz);
    r15.x = saturate(refProbeAttenuationConstantsCB[r13.w].data[4].w + r15.x);
    r14.w = r15.x * r14.w;
    r15.x = dot(refProbeAttenuationConstantsCB[r13.w].data[5].xyz, r14.xyz);
    r13.w = saturate(refProbeAttenuationConstantsCB[r13.w].data[5].w + r15.x);
    r15.x = r14.w * r13.w;
    r13.w = 1 & (int)refProbeConstantsCB[r0.y].data[6].x;
    r15.yz = float2(0,1);
    r15.xy = r13.ww ? r15.xy : r15.zx;
    r16.x = 1;
    r13.w = refProbeConstantsCB[r0.y].data[6].x;
    r17.xy = r15.xy;
    r14.w = 1;
    while (true) {
      r15.z = cmp((int)r14.w >= (int)r12.w);
      if (r15.z != 0) break;
      r15.z = (int)r9.w + (int)r14.w;
      r15.z = (int)r15.z * 6;
      r15.w = dot(refProbeAttenuationConstantsCB[r15.z].data[0].xyz, r14.xyz);
      r15.w = saturate(refProbeAttenuationConstantsCB[r15.z].data[0].w + r15.w);
      r15.w = r17.x * r15.w;
      r16.z = dot(refProbeAttenuationConstantsCB[r15.z].data[1].xyz, r14.xyz);
      r16.z = saturate(refProbeAttenuationConstantsCB[r15.z].data[1].w + r16.z);
      r15.w = r16.z * r15.w;
      r16.z = dot(refProbeAttenuationConstantsCB[r15.z].data[2].xyz, r14.xyz);
      r16.z = saturate(refProbeAttenuationConstantsCB[r15.z].data[2].w + r16.z);
      r15.w = r16.z * r15.w;
      r16.z = dot(refProbeAttenuationConstantsCB[r15.z].data[3].xyz, r14.xyz);
      r16.z = saturate(refProbeAttenuationConstantsCB[r15.z].data[3].w + r16.z);
      r15.w = r16.z * r15.w;
      r16.z = dot(refProbeAttenuationConstantsCB[r15.z].data[4].xyz, r14.xyz);
      r16.z = saturate(refProbeAttenuationConstantsCB[r15.z].data[4].w + r16.z);
      r15.w = r16.z * r15.w;
      r16.z = dot(refProbeAttenuationConstantsCB[r15.z].data[5].xyz, r14.xyz);
      r15.z = saturate(refProbeAttenuationConstantsCB[r15.z].data[5].w + r16.z);
      r17.x = r15.w * r15.z;
      r16.z = (uint)r13.w >> 2;
      if (1 == 0) r16.w = 0; else if (1+2 < 32) {       r16.w = (uint)r13.w << (32-(1 + 2)); r16.w = (uint)r16.w >> (32-1);      } else r16.w = (uint)r13.w >> 2;
      r17.z = (int)r16.z & 2;
      r17.w = max(r17.y, r17.x);
      r15.z = -r15.w * r15.z + 1;
      r15.z = r17.y * r15.z;
      r16.y = r17.z ? r15.z : r17.w;
      r17.xy = r16.ww ? r17.xy : r16.xy;
      r14.w = (int)r14.w + 1;
      r13.w = r16.z;
    }
    r9.w = saturate(r17.y + -r8.w);
    r12.w = refProbeConstantsCB[r0.y].data[6].y * r9.w;
    r13.w = cmp(0 < r12.w);
    if (r13.w != 0) {
      r13.w = (int)r6.w & 3;
      r14.w = (int)r13.w + -1;
      ...
      r14.w = r1.z ? r14.w : 0;
      if (r14.w != 0) {
        r15.xy = mad((int2)r13.ww, int2(20,20), int2(860,876));
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r13.w, cb2[52].x, r15.x, u2.xxxx
      r13.w = samplerLinear[]..swiz;
        r13.w = (int)r13.w | 32;
        GBufferDiffuseColor[viewID].r15.x = u2.x;
        GBufferDiffuseColor[viewID].r15.y = u2.x;
      }
      r6.w = (int)r7.w + 257;
      r9.w = r9.w * refProbeConstantsCB[r0.y].data[6].y + r8.w;
      r12.w = refProbeConstantsCB[r0.y].data[7].y * r12.w;
      r15.x = refProbeConstantsCB[r0.y].data[7].w;
      r15.yz = refProbeConstantsCB[r0.y].data[8].xy;
      r13.w = dot(r11.xyz, r15.xyz);
      r14.w = dot(r14.xyz, r15.xyz);
      ...
      r14.w = dot(r11.xyz, r15.xyz);
      r15.x = dot(r14.xyz, r15.xyz);
      r15.x = -refProbeConstantsCB[r0.y].data[9].z + r15.x;
      r15.y = cmp(r15.x >= 0);
      ...
      r14.w = dot(r11.xyz, r15.xyz);
      r15.x = dot(r14.xyz, r15.xyz);
      r15.x = -refProbeConstantsCB[r0.y].data[10].z + r15.x;
      r15.y = cmp(r15.x >= 0);
      r15.x = max(abs(r15.x), r2.w);
      r15.x = r15.y ? r15.x : -r15.x;
      r14.w = max(1.00000001e-07, -r14.w);
      ...
      r14.w = dot(r11.xyz, r15.xyz);
      r15.x = dot(r14.xyz, r15.xyz);
      r15.x = -refProbeConstantsCB[r0.y].data[11].z + r15.x;
      r15.y = cmp(r15.x >= 0);
      r15.x = max(abs(r15.x), r2.w);
      r15.x = r15.y ? r15.x : -r15.x;
      r14.w = max(1.00000001e-07, -r14.w);
      ...
      r14.w = dot(r11.xyz, r15.xyz);
      r15.x = dot(r14.xyz, r15.xyz);
      r15.x = -refProbeConstantsCB[r0.y].data[12].z + r15.x;
      r15.y = cmp(r15.x >= 0);
      r15.x = max(abs(r15.x), r2.w);
      r15.x = r15.y ? r15.x : -r15.x;
      r14.w = max(1.00000001e-07, -r14.w);
      ...
      r14.w = dot(r11.xyz, r15.xyz);
      r15.x = dot(r14.xyz, r15.xyz);
      r15.x = -refProbeConstantsCB[r0.y].data[13].z + r15.x;
      r15.y = cmp(r15.x >= 0);
      r2.w = max(abs(r15.x), r2.w);
      r2.w = r15.y ? r2.w : -r2.w;
      r14.w = max(1.00000001e-07, -r14.w);
      r2.w = r2.w / r14.w;
      r2.w = min(r13.w, abs(r2.w));
      r15.x = refProbeConstantsCB[r0.y].data[3].w + r14.x;
      r15.yz = refProbeConstantsCB[r0.y].data[4].xy + r14.yz;
      r15.xyz = r11.xyz * r2.www + r15.xyz;
      ...
      r17.w = (uint)r2.w;
      r15.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r17.xyzw, r1.w).xyz;
      r20.xyz = (int3)r15.xyz & int3(-2147483648,-2147483648,-2147483648);
      r20.xyz = cmp((int3)r20.xyz == int3(2139095040,2139095040,2139095040));
      r1.w = (int)r20.y | (int)r20.x;
      r1.w = (int)r20.z | (int)r1.w;
      r15.xyz = r1.www ? float3(1,1,0) : r15.xyz;
  ...
  r0.y = cmp(r8.w >= 1);
  bitmask.w = ((~(-1 << 8)) << 0) & 0xffffffff;  r1.w = (((uint)r6.w << 0) & bitmask.w) | ((uint)r7.w & ~bitmask.w);
  r0.y = r0.y ? r1.w : r6.w;
  r1.w = max(1, r9.w);
  r1.w = rcp(r1.w);
  r9.w = saturate(r9.w);
  r14.xyz = r12.xyz * r1.www;
  ...
  if (r2.w != 0) {
    ...
    r15.xyz = -globalProbeConstants.data[0].xyz + r4.xyw;
    ...
    r14.xyz = r12.xyz * r1.www + r10.xyz;
    r11.w = 0;
