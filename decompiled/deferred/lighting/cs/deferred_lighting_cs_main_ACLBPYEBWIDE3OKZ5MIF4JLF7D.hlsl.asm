...
add r8.w, -r11.w, cb2[19].x
mad r8.w, r2.y, r8.w, r11.w
mul r17.xyz, r8.wwww, r17.xyzx
add r2.w, -r2.w, l(1.000000)
mad r9.xyw, r17.xyxz, r2.wwww, r9.xyxw
...
if_nz r6.w
  ...
  if_nz r6.w
    mul r6.w, r0.w, cb2[18].w
    mul r6.w, r7.w, r6.w
    if_nz cb2[23].x
      add r19.xyz, r10.xyzx, cb1[24].xyzx
      mov r19.w, l(1.000000)
      dp4 r8.w, cb2[24].xyzw, r19.xyzw
      dp4 r9.x, cb2[25].xyzw, r19.xyzw
      frc r19.x, r8.w
      frc r19.y, r9.x
    ...
    if_nz r11.w
      ...
      mad r19.xyz, r11.xyzx, r11.wwww, r10.xyzx
      ...
      add r20.x, r13.z, cb9[r8.w + 9].w
      add r20.y, r13.w, cb9[r8.w + 10].x
      mul r13.zw, r20.xxxy, cb9[r8.w + 9].yyyz
      div r15.yz, cb9[r8.w + 3].yyyy, cb9[r8.w + 8].yywy
      ...
      or r11.w, r15.z, r15.y
      if_z r11.w
        mov r20.xyz, cb9[r8.w + 6].yzwy
        mov r20.w, cb9[r8.w + 7].x
        dp4 r11.w, r20.xyzw, r19.xyzw
        mov_sat r13.zw, r13.zzzw
        mad r19.x, r13.z, cb9[r8.w + 8].y, cb9[r8.w + 8].z
        mad r19.y, r13.w, cb9[r8.w + 8].w, cb9[r8.w + 9].x
        add r11.w, r11.w, cb9[r8.w + 10].y
        div r11.w, r11.w, cb9[r8.w + 10].z
        max r11.w, r11.w, l(0.00006104)
        and r13.z, l(0x0000ffff), cb9[r8.w + 1].w
        if_nz cb2[58].y
          mov r20.x, -r13.x
          utof r21.z, r13.z
          mov r20.y, r14.x
          ...
          loop 
            ...
            sample_c_lz_indexable(texture2darray)(float,float,float,float) r15.y, r21.xyzx, t9.xxxx, s13, r11.w
            mad r13.w, r15.y, l(0.125000), r13.w
            iadd r14.w, r14.w, l(1)
          endloop 
        else 
          utof r19.z, r13.z
          sample_c_lz_indexable(texture2darray)(float,float,float,float) r13.w, r19.xyzx, t9.xxxx, s13, r11.w
        endif 
    ...
    mad r15.yzw, r6.wwww, r9.xxyw, r2.yyzw
      ...
      if_nz r18.w
        ...
        if_nz r18.w
          ...
          if_nz r18.w
            ...
            mad r18.w, -r17.w, r0.z, l(1.000000)
        ...
        if_nz r18.w
          ...
          if_nz r18.w
            ...
            if_nz r14.w
              ...
              mad r14.w, -r17.w, r0.z, l(1.000000)
              mul r14.w, r14.w, r14.w
...
ret 
// Approximately 1810 instruction slots used
