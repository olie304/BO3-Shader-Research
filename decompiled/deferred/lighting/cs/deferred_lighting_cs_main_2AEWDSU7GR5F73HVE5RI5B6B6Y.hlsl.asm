...
frc r2.zw, r2.zzzw
add r10.xy, -r2.wzww, l(1.000000, 1.000000, 0.000000, 0.000000)
mul r21.y, r10.x, r10.y
mul r21.xz, r2.zzwz, r10.xxyx
mul r21.w, r2.w, r2.z
dp4 r2.z, r19.xyzw, r21.xyzw
add r10.xyzw, -r3.zzzz, r20.xyzw
min r2.w, |r10.w|, |r10.z|
min r2.w, r2.w, |r10.y|
min r2.w, r2.w, |r10.x|
max r3.w, |r10.w|, |r10.z|
max r3.w, r3.w, |r10.y|
max r3.w, r3.w, |r10.x|
eq r10.xyz, r2.wwww, |r10.yzwy|
movc r2.w, r10.x, r19.y, r19.x
movc r2.w, r10.y, r19.z, r2.w
movc r2.w, r10.z, r19.w, r2.w
...
ret 
// Approximately 2100 instruction slots used
