...
r0.y = samp0[]..swiz;
  ...
  r17.xyzw = r17.xyzw + -r10.yyyy;
  r2.w = min(abs(r17.z), abs(r17.w));
  r2.w = min(abs(r17.y), r2.w);
  r2.w = min(abs(r17.x), r2.w);
  r3.y = max(abs(r17.z), abs(r17.w));
  r3.y = max(abs(r17.y), r3.y);
  r3.y = max(abs(r17.x), r3.y);
  r14.yzw = cmp(r2.www == abs(r17.yzw));
  r2.w = r14.y ? r16.y : r16.x;
  r2.w = r14.z ? r16.z : r2.w;
  r2.w = r14.w ? r16.w : r2.w;
  ...
  if (r3.w == 0) {
    ...
    r3.w = -sunConstants.splitDepthOffset + r10.w;
    ...
    if (r6.w != 0) {
      ...
      while (true) {
        ...
        if (r8.w != 0) break;
        r8.w = (uint)r6.w;
        r14.yz = -sunConstants.splitPinTransform[r8.w].xy + r10.yz;
    ...
    if (r8.w != 0) {
      ...
      r16.xz = rcp(r14.yy);
      r16.y = -r16.z;
      r14.yzw = r10.yzy * r16.xyz + r14.zwz;
    ...
    // Known bad code for instruction (needs manual fix):
        ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r13.w, r9.w, l(0), t23.xxxx
    r13.w = samp0[]..swiz;
      ...
      r18.w = samp0[]..swiz;
        ...
        r18.z = samp0[]..swiz;
          ...
          r13.w = (int)-r18.y + 6;
          r17.yz = (uint2)r14.wz >> (uint2)r13.ww;
        ...
        r14.y = samp0[]..swiz;
          ...
          r14.y = r10.y * r14.z + r14.y;
          r13.w = r10.z * r13.w + r14.y;
          r16.y = r9.w ? r13.w : r16.y;
        }
      }
  ...
  r7.w = max(0, r7.w);
  r7.w = 100 * r7.w;
  r10.yz = -r3.ww * float2(10,5) + float2(6.85740995,7.08500004);
  r8.w = exp2(r10.y);
  r8.w = r8.w * r2.x;
  r8.w = 9.1368103 * r8.w;
  r9.w = r6.w * r3.w;
  ...
  r10.y = (uint)renderTargetSize.x;
  r10.y = (int)r10.y + 7;
  r10.y = (uint)r10.y >> 3;
  r0.y = mad((int)r0.z, (int)r10.y, (int)r0.y);
  bitmask.y = ((~(-1 << 27)) << 5) & 0xffffffff;  r0.y = (((uint)r0.y << 5) & bitmask.y) | ((uint)16 & ~bitmask.y);
  r0.z = (int)r9.w & -32;
  r10.y = (int)-r0.z + (int)r9.w;
  ...
  r14.y = samp0[]..swiz;
    ...
    bitmask.w = ((~(-1 << r10.y)) << 0) & 0xffffffff;  r14.w = (((uint)0 << 0) & bitmask.w) | ((uint)r14.y & ~bitmask.w);
    r14.y = r14.z ? r14.w : r14.y;
    r14.z = cmp((int)r10.z == (int)r13.w);
    if (r10.w == 0) r14.w = 0; else if (r10.w+0 < 32) {     r14.w = (uint)r14.y << (32-(r10.w + 0)); r14.w = (uint)r14.w >> (32-r10.w);    } else r14.w = (uint)r14.y >> 0;
    r14.y = r14.z ? r14.w : r14.y;
    r23.xyzw = r21.xyzw;
    r24.xyz = r22.yzw;
    r14.z = r14.y;
    while (true) {
      ...
      r18.z = (int)r16.w * 6;
      r18.w = dot(refProbeAttenuationConstantsCB[r18.z].data[0].xyz, r25.xyz);
      r18.w = saturate(refProbeAttenuationConstantsCB[r18.z].data[0].w + r18.w);
      r19.w = dot(refProbeAttenuationConstantsCB[r18.z].data[1].xyz, r25.xyz);
      r19.w = saturate(refProbeAttenuationConstantsCB[r18.z].data[1].w + r19.w);
      r18.w = r19.w * r18.w;
      r19.w = dot(refProbeAttenuationConstantsCB[r18.z].data[2].xyz, r25.xyz);
      r19.w = saturate(refProbeAttenuationConstantsCB[r18.z].data[2].w + r19.w);
      r18.w = r19.w * r18.w;
      r19.w = dot(refProbeAttenuationConstantsCB[r18.z].data[3].xyz, r25.xyz);
      r19.w = saturate(refProbeAttenuationConstantsCB[r18.z].data[3].w + r19.w);
      r18.w = r19.w * r18.w;
      r19.w = dot(refProbeAttenuationConstantsCB[r18.z].data[4].xyz, r25.xyz);
      r19.w = saturate(refProbeAttenuationConstantsCB[r18.z].data[4].w + r19.w);
      r18.w = r19.w * r18.w;
      r19.w = dot(refProbeAttenuationConstantsCB[r18.z].data[5].xyz, r25.xyz);
      r18.z = saturate(refProbeAttenuationConstantsCB[r18.z].data[5].w + r19.w);
      r16.x = r18.w * r18.z;
      r18.z = 1 & (int)refProbeConstantsCB[r14.w].data[6].x;
      r18.zw = r18.zz ? r16.xy : r16.zx;
      r16.x = refProbeConstantsCB[r14.w].data[6].x;
      r26.xy = r18.zw;
      r19.w = 1;
      while (true) {
        ...
        r20.w = -r25.w * r20.w + 1;
        r20.w = r26.y * r20.w;
        r18.y = r27.x ? r20.w : r27.y;
        r26.xy = r26.ww ? r26.xy : r18.xy;
        r19.w = (int)r19.w + 1;
        r16.x = r26.z;
      }
      r26.y = saturate(r26.y);
      r16.x = refProbeConstantsCB[r14.w].data[6].y * r26.y;
      r16.w = cmp(0 < r16.x);
      if (r16.w != 0) {
        r24.z = r26.y * refProbeConstantsCB[r14.w].data[6].y + r24.z;
        r16.x = refProbeConstantsCB[r14.w].data[7].y * r16.x;
        r27.x = refProbeConstantsCB[r14.w].data[7].w;
        r27.yz = refProbeConstantsCB[r14.w].data[8].xy;
        r16.w = dot(r15.xyz, r27.xyz);
        r17.w = dot(r25.xyz, r27.xyz);
        ...
        r18.yzw = r15.xyz * r16.www + r27.xyz;
        ...
        r28.w = (uint)r17.w;
        r18.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r28.xyzw, r16.w).xyz;
        ...
        r23.xyz = r25.xyz * r26.xzw + r23.xyz;
        r16.w = r14.w * r8.w;
        r18.yzw = r18.yzw * r16.xxx;
        r16.x = dot(r18.yzw, float3(0.212599993,0.715200007,0.0722000003));
        r14.w = r8.w * r14.w + r16.x;
        r14.w = r16.w / r14.w;
        r25.x = r23.w;
        r25.yz = r24.xy;
        r24.xyw = r18.zwy * r14.www + r25.yzx;
        r23.w = r24.w;
      }
    }
    r21.xyzw = r23.xyzw;
  ...
  if (r10.z != 0) {
    ...
    r13.w = samp0[]..swiz;
      r16.w = cmp((int)r0.z == (int)r10.w);
      if (r10.y == 0) r17.w = 0; else if (r10.y+0 < 32) {       r17.w = (uint)r13.w << (32-(r10.y + 0)); r17.w = (uint)r17.w >> (32-r10.y);      } else r17.w = (uint)r13.w >> 0;
      ...
      while (true) {
        ...
        r18.z = (int)r10.w + (int)r18.z;
        r18.z = (int)r18.z * 14;
        r26.xyz = -refProbeConstantsCB[r18.z].data[0].xyz + r11.xyz;
        ...
        r20.w = (int)r18.w * 6;
        r25.w = dot(refProbeAttenuationConstantsCB[r20.w].data[0].xyz, r26.xyz);
        r25.w = saturate(refProbeAttenuationConstantsCB[r20.w].data[0].w + r25.w);
        ...
        while (true) {
          ...
          r25.w = -r26.w * r25.w + 1;
          r25.w = r28.y * r25.w;
          r18.y = r28.z ? r25.w : r28.w;
          r28.xy = r27.ww ? r28.xy : r18.xy;
          r20.w = (int)r20.w + 1;
          r16.x = r27.z;
        }
        r16.x = saturate(r28.y + -r16.w);
        ...
        if (r18.w != 0) {
          ...
          r27.x = refProbeConstantsCB[r18.z].data[7].w;
          r27.yz = refProbeConstantsCB[r18.z].data[8].xy;
          ...
          r27.x = refProbeConstantsCB[r18.z].data[8].w;
          r27.yz = refProbeConstantsCB[r18.z].data[9].xy;
          ...
          r27.x = refProbeConstantsCB[r18.z].data[9].w;
          r27.yz = refProbeConstantsCB[r18.z].data[10].xy;
          r18.w = dot(r15.xyz, r27.xyz);
          r19.w = dot(r26.xyz, r27.xyz);
          ...
          r18.w = r19.w / r18.w;
          r18.y = min(r18.y, abs(r18.w));
          r27.x = refProbeConstantsCB[r18.z].data[10].w;
          r27.yz = refProbeConstantsCB[r18.z].data[11].xy;
          r18.w = dot(r15.xyz, r27.xyz);
          r19.w = dot(r26.xyz, r27.xyz);
          ...
          r18.w = r19.w / r18.w;
          r18.y = min(r18.y, abs(r18.w));
          r27.x = refProbeConstantsCB[r18.z].data[11].w;
          r27.yz = refProbeConstantsCB[r18.z].data[12].xy;
          r18.w = dot(r15.xyz, r27.xyz);
          r19.w = dot(r26.xyz, r27.xyz);
          ...
          r18.w = r19.w / r18.w;
          r18.y = min(r18.y, abs(r18.w));
          r27.x = refProbeConstantsCB[r18.z].data[12].w;
          r27.yz = refProbeConstantsCB[r18.z].data[13].xy;
          r18.w = dot(r15.xyz, r27.xyz);
          r19.w = dot(r26.xyz, r27.xyz);
          ...
          r18.w = r19.w / r18.w;
          r18.y = min(r18.y, abs(r18.w));
          r27.x = refProbeConstantsCB[r18.z].data[3].w + r26.x;
          r27.yz = refProbeConstantsCB[r18.z].data[4].xy + r26.yz;
          ...
          r29.x = refProbeConstantsCB[r18.z].data[0].w;
          r29.y = refProbeConstantsCB[r18.z].data[1].z;
          r29.z = refProbeConstantsCB[r18.z].data[2].y;
          r30.x = dot(r27.xyz, r29.xyz);
          r31.xy = refProbeConstantsCB[r18.z].data[1].xw;
          r31.z = refProbeConstantsCB[r18.z].data[2].z;
          r30.y = dot(r27.xyz, r31.xyz);
          r32.x = refProbeConstantsCB[r18.z].data[1].y;
          r32.yz = refProbeConstantsCB[r18.z].data[2].xw;
          ...
          r26.xyz = saturate(r33.xyz * refProbeConstantsCB[r18.z].data[3].xyz + float3(0.5,0.5,0.5));
          r33.xy = refProbeConstantsCB[r18.z].data[4].zw * r26.xy;
          r33.z = refProbeConstantsCB[r18.z].data[5].x * r26.z;
          r18.yzw = refProbeConstantsCB[r18.z].data[5].yzw + r33.xyz;
          r30.x = dot(r12.xyz, r29.xyz);
          r30.y = dot(r12.xyz, r31.xyz);
          r30.z = dot(r12.xyz, r32.xyz);
          r26.xyz = cmp(float3(0,0,0) < r30.xyz);
          r17.z = r26.x ? 0 : 0.5;
          r28.xzw = r18.yzw + r17.xyz;
          r28.xzw = gProbeXArray.SampleLevel(samplerLinearClamp_s, r28.xzw, 0).xyz;
          r29.xyz = r30.xyz * r30.xyz;
          r29.xyz = r29.xyz * r16.xxx;
          r19.z = r26.y ? 0 : 0.5;
          r26.xyw = r19.xyz + r18.yzw;
          ...
          r18.yzw = r18.yzw * r29.zzz + r26.xyw;
          r26.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r30.xyzw, 6).xyz;
          r28.xzw = r26.xyz * r18.yzw;
          r17.z = dot(r28.xzw, float3(0.212599993,0.715200007,0.0722000003));
          r25.xyz = r18.yzw * r26.xyz + r25.xyz;
          r18.y = r17.z * r8.w;
          r26.xyz = r27.xyz * r16.xxx;
          r16.x = dot(r26.xyz, float3(0.212599993,0.715200007,0.0722000003));
          r16.x = r8.w * r17.z + r16.x;
          r16.x = r18.y / r16.x;
  ...
  r10.yzw = r21.xyz * r0.yyy;
  r14.yzw = r22.xyz * r0.yyy;
  r0.z = cmp(r22.w < 0.99000001);
  if (r0.z != 0) {
    r0.z = 1 + -r22.w;
    r3.w = sunConstants.globalProbeExposure * r0.z;
    ...
    r10.yzw = r21.xyz * r0.yyy + r16.xyz;
    r15.w = 0;
    r16.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r15.xyzw, r6.w).xyz;
    r0.y = sunConstants.globalProbeExposure * r0.z + -r3.w;
    r0.y = r2.y * r0.y + r3.w;
  ...
  r10.yzw = r14.yzw * r0.yyy;
  r17.xyz = r10.zwy * r2.yyy;
  ...
  if (r3.w != 0) {
    r3.w = cmp(0 < r4.w);
    if (r3.w != 0) {
      r3.w = sunConstants.specScale * r1.z;
      r3.w = r3.w * r3.z;
      if (sunConstants.sunCookieIndex != 0) {
        ...
        r18.z = (uint)r5.z;
        r10.yzw = gCookieArray.SampleLevel(samplerLinear_s, r18.xyz, 0).xyz;
      ...
      if (r6.w != 0) {
        ...
        r18.xyz = r12.xyz * r6.www + r11.xyz;
        r19.xyz = lightConstantsCB[r5.z].data[4].yzw;
        r19.w = lightConstantsCB[r5.z].data[5].x;
        r18.w = 1;
        r19.x = dot(r19.xyzw, r18.xyzw);
        r20.xyz = lightConstantsCB[r5.z].data[5].yzw;
        r20.w = lightConstantsCB[r5.z].data[6].x;
        r19.y = dot(r20.xyzw, r18.xyzw);
        r14.yz = r19.xy * float2(0.5,-0.5) + float2(0.5,0.5);
        r19.x = lightConstantsCB[r5.z].data[9].w + r14.y;
        r19.y = lightConstantsCB[r5.z].data[10].x + r14.z;
        r14.yz = lightConstantsCB[r5.z].data[9].yz * r19.xy;
        r19.xy = lightConstantsCB[r5.z].data[3].yy / lightConstantsCB[r5.z].data[8].yw;
        r19.zw = float2(1,1) + -r19.xy;
        r19.zw = cmp(r14.yz >= r19.zw);
        r19.xy = cmp(r19.xy >= r14.yz);
        r19.xy = (int2)r19.xy | (int2)r19.zw;
        r6.w = (int)r19.y | (int)r19.x;
        if (r6.w == 0) {
          r19.xyz = lightConstantsCB[r5.z].data[6].yzw;
          r19.w = lightConstantsCB[r5.z].data[7].x;
          r6.w = dot(r19.xyzw, r18.xyzw);
          r14.yz = saturate(r14.yz);
          r18.x = r14.y * lightConstantsCB[r5.z].data[8].y + lightConstantsCB[r5.z].data[8].z;
          r18.y = r14.z * lightConstantsCB[r5.z].data[8].w + lightConstantsCB[r5.z].data[9].x;
          ...
          if (enableDitheredShadow != 0) {
            ...
            while (true) {
              ...
              if (r12.w != 0) break;
              r21.x = dot(icb[r9.w+0].yx, r19.xy);
              r21.y = dot(icb[r9.w+0].yx, r19.yz);
              r20.xy = r21.xy * lightConstantsCB[r5.z].data[3].yy + r18.xy;
      ...
      r5.z = r5.z * r4.w;
      r3.y = cmp(0 < r3.y);
      r18.xyz = r5.zzz * r10.yzw + r16.xyz;
      r14.yzw = -r11.xyz * r0.www + sunConstants.wldDir.xyz;
      r0.w = dot(r14.yzw, r14.yzw);
      r0.w = rsqrt(r0.w);
      r14.yzw = r14.yzw * r0.www;
      r0.w = dot(r14.yzw, r13.xyz);
      r5.z = dot(r12.xyz, r14.yzw);
      r6.w = abs(r5.z) * r1.z + -abs(r5.z);
      ...
      r3.z = r4.w * r3.z;
      r3.z = 0.25 * r3.z;
      r14.yzw = r3.zzz * r10.yzw + r2.yzw;
      r0.w = saturate(1 + -r0.w);
      r3.w = r0.w * r0.w;
      r3.w = r3.w * r3.w;
      r0.w = r3.w * r0.w;
      r0.w = r3.z * r0.w;
      r19.xyz = r0.www * r10.zwy + r17.xyz;
      r18.w = r19.z;
      r16.w = r17.z;
      r16.xyzw = r3.yyyy ? r18.xyzw : r16.xyzw;
      r19.zw = r14.yz;
      r17.zw = r2.yz;
      r18.xyzw = r3.yyyy ? r19.xyzw : r17.xyzw;
      r2.w = r3.y ? r14.w : r2.w;
      r17.z = r16.w;
      r17.xy = r18.xy;
      r2.yz = r18.zw;
    }
  ...
  switch (r0.w) {
    ...
    r3.yzw = -r18.xyz * float3(0.5,0.5,0.5) + lightConstantsCB[r0.x].data[0].xyz;
    r10.yzw = r3.yzw + -r11.xyz;
    r4.w = dot(r18.xyz, r10.yzw);
    r5.z = saturate(-r4.w / lightConstantsCB[r0.x].data[6].y);
    r14.yzw = r5.zzz * r18.xyz + r3.yzw;
    r14.yzw = r0.www ? r14.yzw : lightConstantsCB[r0.x].data[0].xyz;
    r14.yzw = r14.yzw + -r11.xyz;
    r6.w = dot(r14.yzw, r14.yzw);
    r7.w = rsqrt(r6.w);
    r14.yzw = r14.yzw * r7.www;
    r7.w = dot(r12.xyz, r14.yzw);
    r8.w = saturate(r7.w);
    r9.w = cmp(0 < r8.w);
    if (r9.w != 0) {
      r9.w = sqrt(r6.w);
      ...
      r6.w = r12.w / r6.w;
      r6.w = min(1, r6.w);
      r14.yz = saturate(r9.ww * lightConstantsCB[r0.x].data[2].xz + lightConstantsCB[r0.x].data[2].yw);
      r19.xy = r14.yz * r14.yz;
      r14.yz = r14.yz * float2(-2,-2) + float2(3,3);
      r14.yz = r19.xy * r14.yz;
      r6.w = r14.y * r6.w;
      r6.w = r6.w * r14.z;
      r9.w = cmp(0 < r6.w);
      if (r9.w != 0) {
        ...
        if (r9.w != 0) {
          r14.yz = (uint2)r1.yx;
          r9.w = dot(r14.yz, float2(0.0671105608,0.00583714992));
          r9.w = frac(r9.w);
          r9.w = 52.9829178 * r9.w;
          r9.w = frac(r9.w);
          r9.w = r9.w * 6.28318548 + gameTick.w;
          sincos(r9.w, r19.x, r20.x);
          r9.w = abs(r7.w) * -0.200000003 + 0.400000006;
          r14.yzw = r12.xyz * r9.www + r11.xyz;
          r14.yzw = -lightConstantsCB[r0.x].data[4].yzw + r14.yzw;
          r9.w = max(abs(r14.z), abs(r14.w));
          r9.w = max(abs(r14.y), r9.w);
          ...
          while (true) {
            ...
            if (r16.w != 0) break;
            r19.y = dot(icb[r15.w+0].yx, r21.xy);
            r19.z = dot(icb[r15.w+0].yx, r21.yz);
            r23.yz = lightConstantsCB[r0.x].data[3].yy * r19.yz;
            r23.x = r23.y * r20.x;
            r23.w = r23.y * r19.x;
            r22.xyz = r14.yzw * r12.www + r23.xzw;
            r16.w = gOmniShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r22.xyzw, r9.w).x;
        ...
        if (r9.w != 0) {
          ...
          r10.y = dot(r15.xyz, r10.yzw);
          r10.z = -r12.w * r12.w + lightConstantsCB[r0.x].data[6].y;
          r4.w = r12.w * r10.y + -r4.w;
          r4.w = saturate(r4.w / r10.z);
          r10.y = r10.z / lightConstantsCB[r0.x].data[6].y;
          r10.y = 10 * r10.y;
          r10.y = min(1, r10.y);
          r4.w = r4.w + -r5.z;
          r4.w = r10.y * r4.w + r5.z;
          r3.yzw = r4.www * r18.xyz + r3.yzw;
          r3.yzw = r0.www ? r3.yzw : lightConstantsCB[r0.x].data[0].xyz;
          r3.yzw = r3.yzw + -r11.xyz;
          r0.w = dot(r3.yzw, r3.yzw);
          r0.w = rsqrt(r0.w);
          r10.yzw = r3.yzw * r0.www;
          ...
          if (r5.z != 0) {
            ...
            r18.xyz = lightConstantsCB[r4.w].data[6].yzw;
            r18.w = lightConstantsCB[r4.w].data[7].x;
            r15.w = 1;
            r5.z = dot(r18.xyzw, r15.xyzw);
            r18.xyz = lightConstantsCB[r4.w].data[7].yzw;
            r18.w = lightConstantsCB[r4.w].data[8].x;
            r12.w = dot(r18.xyzw, r15.xyzw);
            r13.w = cmp(r12.w < r5.z);
            if (r13.w == 0) {
              r18.xyz = lightConstantsCB[r4.w].data[4].yzw;
              r18.w = lightConstantsCB[r4.w].data[5].x;
              r18.x = dot(r18.xyzw, r15.xyzw);
              r19.xyz = lightConstantsCB[r4.w].data[5].yzw;
              r19.w = lightConstantsCB[r4.w].data[6].x;
              r18.y = dot(r19.xyzw, r15.xyzw);
              r14.yz = r18.xy / r12.ww;
              r14.yz = r14.yz * float2(0.5,-0.5) + float2(0.5,0.5);
              r15.x = lightConstantsCB[r4.w].data[9].w + r14.y;
              r15.y = lightConstantsCB[r4.w].data[10].x + r14.z;
              r14.yz = lightConstantsCB[r4.w].data[9].yz * r15.xy;
              r15.xy = lightConstantsCB[r4.w].data[3].yy / lightConstantsCB[r4.w].data[8].yw;
              ...
              if (r14.w == 0) {
                r14.yz = saturate(r14.yz);
                r15.x = r14.y * lightConstantsCB[r4.w].data[8].y + lightConstantsCB[r4.w].data[8].z;
                r15.y = r14.z * lightConstantsCB[r4.w].data[8].w + lightConstantsCB[r4.w].data[9].x;
                r14.y = lightConstantsCB[r4.w].data[10].z * r12.w;
            ...
            if (r12.w == 0) {
              ...
              if (enableDitheredShadow != 0) {
                ...
                while (true) {
                  ...
                  if (r14.z != 0) break;
                  r20.x = dot(icb[r14.y+0].yx, r18.xy);
                  r20.y = dot(icb[r14.y+0].yx, r18.yz);
                  r19.xy = r20.xy * lightConstantsCB[r4.w].data[3].yy + r15.xy;
                  r14.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r19.xyz, r5.z).x;
                  r13.w = r14.z * 0.125 + r13.w;
                  r14.y = (int)r14.y + 1;
                }
              } else {
                r15.z = (uint)r12.w;
                r13.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r15.xyz, r5.z).x;
              }
              r4.w = r13.w * r13.w;
              r4.w = r4.w * r13.w;
            } else {
          ...
          r5.z = cmp(0 < r7.w);
          r14.yzw = r4.www * r15.xyz + r16.xyz;
          r4.w = saturate(dot(r12.xyz, r10.yzw));
          r3.yzw = r3.yzw * r0.www + r13.xyz;
          r0.w = dot(r3.yzw, r3.yzw);
          r0.w = rsqrt(r0.w);
          r3.yzw = r3.yzw * r0.www;
          r0.w = dot(r3.yzw, r13.xyz);
          r3.y = dot(r12.xyz, r3.yzw);
          r3.z = abs(r3.y) * r1.z + -abs(r3.y);
          r3.y = abs(r3.y) * r3.z + 1;
          r3.z = r4.w * r0.y + r0.z;
          r3.y = r3.y * r3.y;
          r3.y = r3.y * r3.z;
          r3.y = rcp(r3.y);
          ...
          r3.y = r3.y * r3.z;
          r3.y = r3.y * r6.w;
          r10.yzw = r3.yyy * r15.xyz + r2.yzw;
          r0.w = saturate(1 + -r0.w);
          r3.z = r0.w * r0.w;
          r3.z = r3.z * r3.z;
          r0.w = r3.z * r0.w;
          r0.w = r3.y * r0.w;
          r3.yzw = r0.www * r15.xyz + r17.zxy;
          r16.xyz = r5.zzz ? r14.yzw : r16.xyz;
          r17.xyz = r5.zzz ? r3.zwy : r17.xyz;
          r2.yzw = r5.zzz ? r10.yzw : r2.yzw;
        }
      }
    }
    break;
    ...
    if (r3.w != 0) {
      ...
      if (r4.w != 0) {
        ...
        r5.z = lightConstantsCB[r0.x].data[3].x * lightConstantsCB[r0.x].data[3].x;
        r6.w = dot(r14.yzw, r14.yzw);
        r5.z = r5.z / r6.w;
        r5.z = min(1, r5.z);
        r14.yz = saturate(r3.ww * lightConstantsCB[r0.x].data[2].xz + lightConstantsCB[r0.x].data[2].yw);
        r19.xy = r14.yz * r14.yz;
        r14.yz = r14.yz * float2(-2,-2) + float2(3,3);
        r14.yz = r19.xy * r14.yz;
        r5.z = r14.y * r5.z;
        ...
        r19.xy = r19.xy / r3.ww;
        r3.w = cmp(lightConstantsCB[r0.x].data[10].w < 0.00048828125);
        if (r3.w != 0) {
          r14.yz = saturate(abs(r19.xy) * lightConstantsCB[r0.x].data[12].xy + lightConstantsCB[r0.x].data[12].zw);
          ...
          r14.yz = r20.xy + r20.zw;
          r14.yz = log2(r14.yz);
          r14.yz = lightConstantsCB[r0.x].data[12].ww * r14.yz;
          r14.yz = exp2(r14.yz);
          r6.w = lightConstantsCB[r0.x].data[12].x * r14.y;
          r7.w = lightConstantsCB[r0.x].data[12].y * r14.z + -1;
          r6.w = lightConstantsCB[r0.x].data[12].y * r14.z + -r6.w;
        ...
        r4.w = r5.z * r3.w;
        r3.w = 255 & (int)lightConstantsCB[r0.x].data[14].w;
        if (r3.w != 0) {
          r19.z = 1;
          r5.z = dot(lightConstantsCB[r0.x].data[13].xyz, r19.xyz);
          r20.x = lightConstantsCB[r0.x].data[13].w;
          r20.yz = lightConstantsCB[r0.x].data[14].xy;
          r6.w = dot(r20.xyz, r19.xyz);
          r19.x = frac(r5.z);
          r19.y = frac(r6.w);
          r3.w = (int)r3.w + -1;
          r19.z = (uint)r3.w;
          r10.yzw = gCookieArray.SampleLevel(samplerLinear_s, r19.xyz, 0).xyz;
        } else {
          r10.yzw = float3(1,1,1);
        }
      }
      ...
      r3.w = cmp(0 < r4.w);
      if (r3.w != 0) {
        if (3 == 0) r3.w = 0; else if (3+27 < 32) {         r3.w = (uint)lightConstantsCB[r0.x].data[1].w << (32-(3 + 27)); r3.w = (uint)r3.w >> (32-3);        } else r3.w = (uint)lightConstantsCB[r0.x].data[1].w >> 27;
        r3.w = cmp((int)r3.w != 1);
        if (r3.w != 0) {
          r3.w = abs(r3.y) * -0.200000003 + 0.400000006;
          r19.xyz = r12.xyz * r3.www + r11.xyz;
          r20.xyz = lightConstantsCB[r0.x].data[6].yzw;
          r20.w = lightConstantsCB[r0.x].data[7].x;
          r19.w = 1;
          r3.w = dot(r20.xyzw, r19.xyzw);
          r5.z = dot(r18.xyzw, r19.xyzw);
          r6.w = cmp(r5.z >= r3.w);
          if (r6.w != 0) {
            ...
            r18.x = r14.y * lightConstantsCB[r0.x].data[8].y + lightConstantsCB[r0.x].data[8].z;
            r18.y = r14.z * lightConstantsCB[r0.x].data[8].w + lightConstantsCB[r0.x].data[9].x;
            r3.w = r3.w / r5.z;
            r3.w = max(6.10351563e-05, r3.w);
            r5.z = 0x0000ffff & (int)lightConstantsCB[r0.x].data[1].w;
            if (enableDitheredShadow != 0) {
              r19.x = -r3.x;
              r20.z = (uint)r5.z;
              r19.y = r14.x;
              ...
              while (true) {
                r8.w = cmp((int)r7.w >= 8);
                if (r8.w != 0) break;
                r21.x = dot(icb[r7.w+0].yx, r19.xy);
                r21.y = dot(icb[r7.w+0].yx, r19.yz);
                r20.xy = r21.xy * lightConstantsCB[r0.x].data[3].yy + r18.xy;
                r8.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r20.xyz, r3.w).x;
                r6.w = r8.w * 0.125 + r6.w;
                r7.w = (int)r7.w + 1;
              }
            } else {
              r18.z = (uint)r5.z;
              r6.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r18.xyz, r3.w).x;
            }
            r3.w = r6.w * r6.w;
            r3.w = r3.w * r6.w;
          } else {
        ...
        r4.w = cmp(0 < r3.w);
        if (r4.w != 0) {
          r4.w = lightConstantsCB[r0.x].data[1].z * r1.z;
          r4.w = r4.w * r3.z;
          if (4 == 0) r5.z = 0; else if (4+16 < 32) {           r5.z = (uint)lightConstantsCB[r0.x].data[1].w << (32-(4 + 16)); r5.z = (uint)r5.z >> (32-4);          } else r5.z = (uint)lightConstantsCB[r0.x].data[1].w >> 16;
          r6.w = cmp(0 < (uint)r5.z);
          r6.w = r10.x ? r6.w : 0;
          if (r6.w != 0) {
            r5.z = (int)r5.z + numLights;
            ...
            r18.w = 1;
            r6.w = dot(r19.xyzw, r18.xyzw);
            r19.xyz = lightConstantsCB[r5.z].data[7].yzw;
            r19.w = lightConstantsCB[r5.z].data[8].x;
            ...
            if (r8.w == 0) {
              ...
              r14.yz = r19.xy / r7.ww;
              r14.yz = r14.yz * float2(0.5,-0.5) + float2(0.5,0.5);
              r18.x = lightConstantsCB[r5.z].data[9].w + r14.y;
              r18.y = lightConstantsCB[r5.z].data[10].x + r14.z;
              r14.yz = lightConstantsCB[r5.z].data[9].yz * r18.xy;
              r18.xy = lightConstantsCB[r5.z].data[3].yy / lightConstantsCB[r5.z].data[8].yw;
              r18.zw = float2(1,1) + -r18.xy;
              r18.zw = cmp(r14.yz >= r18.zw);
              r18.xy = cmp(r18.xy >= r14.yz);
              r18.xy = (int2)r18.xy | (int2)r18.zw;
              r9.w = (int)r18.y | (int)r18.x;
              if (r9.w == 0) {
                r14.yz = saturate(r14.yz);
                r18.x = r14.y * lightConstantsCB[r5.z].data[8].y + lightConstantsCB[r5.z].data[8].z;
                r18.y = r14.z * lightConstantsCB[r5.z].data[8].w + lightConstantsCB[r5.z].data[9].x;
                r11.w = lightConstantsCB[r5.z].data[10].z * r7.w;
                r6.w = lightConstantsCB[r5.z].data[10].y * r7.w + r6.w;
                r6.w = r6.w / r11.w;
              }
            } else {
              r9.w = -1;
            ...
            if (r5.z != 0) {
              ...
              if (r7.w == 0) {
                ...
                r14.yz = r19.xy / r6.ww;
                r14.yz = r14.yz * float2(0.5,-0.5) + float2(0.5,0.5);
                r18.x = lightConstantsCB[r0.x].data[9].w + r14.y;
                r18.y = lightConstantsCB[r0.x].data[10].x + r14.z;
                r14.yz = lightConstantsCB[r0.x].data[9].yz * r18.xy;
                r18.xy = lightConstantsCB[r0.x].data[3].yy / lightConstantsCB[r0.x].data[8].yw;
                r18.zw = float2(1,1) + -r18.xy;
                r18.zw = cmp(r14.yz >= r18.zw);
                r18.xy = cmp(r18.xy >= r14.yz);
                r18.xy = (int2)r18.xy | (int2)r18.zw;
                ...
                if (r8.w == 0) {
                  ...
                  r18.x = r14.y * lightConstantsCB[r0.x].data[8].y + lightConstantsCB[r0.x].data[8].z;
                  r18.y = r14.z * lightConstantsCB[r0.x].data[8].w + lightConstantsCB[r0.x].data[9].x;
                  r9.w = lightConstantsCB[r0.x].data[10].z * r6.w;
                  r5.z = lightConstantsCB[r0.x].data[10].y * r6.w + r5.z;
                  r5.z = r5.z / r9.w;
                }
              } else {
                r8.w = -1;
              ...
              if (r6.w == 0) {
                r5.z = max(6.10351563e-05, r5.z);
                r6.w = 0x0000ffff & (int)lightConstantsCB[r0.x].data[1].w;
                if (enableDitheredShadow != 0) {
                  r19.x = -r3.x;
                  r20.z = (uint)r6.w;
                  r19.y = r14.x;
                  ...
                  while (true) {
                    r8.w = cmp((int)r7.w >= 8);
                    if (r8.w != 0) break;
                    r14.x = dot(icb[r7.w+0].yx, r19.xy);
                    r14.y = dot(icb[r7.w+0].yx, r19.yz);
                    r20.xy = r14.xy * lightConstantsCB[r0.x].data[3].yy + r18.xy;
                  ...
                  r18.z = (uint)r6.w;
                  r3.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r18.xyz, r5.z).x;
                }
                r0.x = r3.x * r3.x;
                r0.x = r0.x * r3.x;
              } else {
          ...
          r0.x = r0.x * r3.w;
          r1.w = cmp(0 < r3.y);
          r14.xyz = r0.xxx * r10.yzw + r16.xyz;
          r15.xyz = r15.xyz * r0.www + r13.xyz;
          r0.x = dot(r15.xyz, r15.xyz);
          r0.x = rsqrt(r0.x);
          r15.xyz = r15.xyz * r0.xxx;
          r0.x = dot(r15.xyz, r13.xyz);
          r0.w = dot(r12.xyz, r15.xyz);
          ...
          r0.y = r3.w * r0.y;
          r0.y = 0.25 * r0.y;
          r3.xyz = r0.yyy * r10.yzw + r2.yzw;
          r0.x = saturate(1 + -r0.x);
          r0.z = r0.x * r0.x;
          r0.z = r0.z * r0.z;
          r0.x = r0.x * r0.z;
          r0.x = r0.y * r0.x;
          r0.xyz = r0.xxx * r10.yzw + r17.zxy;
          r16.xyz = r1.www ? r14.xyz : r16.xyz;
          r17.xyz = r1.www ? r0.yzx : r17.xyz;
  ...
  r3.z = -r0.y * 0.5 + r0.x;
  r3.x = r3.z + r0.y;
  r0.xyz = float3(1,1,1) + -r3.xyz;
  r0.xyz = r17.zxy * r0.xyz;
  r0.xyz = r2.yzw * r3.xyz + r0.xyz;
  r0.xyz = r16.xyz * r4.xyz + r0.xyz;
