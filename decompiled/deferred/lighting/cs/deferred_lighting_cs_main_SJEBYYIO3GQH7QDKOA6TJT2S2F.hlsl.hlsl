// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:23:55 2021
...
r0.y = samp0[]..swiz;
  ...
  while (true) {
    ...
    if (r15.z != 0) break;
    r15.z = (uint)r15.y >> 5;
    r15.z = (int)r0.x + (int)r15.z;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r15.z, r15.z, l(0), t26.xxxx
  r15.z = samp0[]..swiz;
    r15.w = cmp((int)r12.w == (int)r15.y);
    bitmask.w = ((~(-1 << r13.z)) << 0) & 0xffffffff;  r17.w = (((uint)0 << 0) & bitmask.w) | ((uint)r15.z & ~bitmask.w);
    r15.z = r15.w ? r17.w : r15.z;
    r15.w = cmp((int)r13.w == (int)r15.y);
  ...
  if (r13.w != 0) {
    ...
    r14.w = 0;
    while (true) {
      r17.w = cmp((uint)r14.w >= (uint)r9.w);
      if (r17.w != 0) break;
      r17.w = (uint)r14.w >> 5;
    ...
    r17.w = samp0[]..swiz;
      ...
      if (r13.z == 0) r19.z = 0; else if (r13.z+0 < 32) {       r19.z = (uint)r17.w << (32-(r13.z + 0)); r19.z = (uint)r19.z >> (32-r13.z);      } else r19.z = (uint)r17.w >> 0;
      ...
      while (true) {
        ...
        r19.w = (int)r19.w * 14;
        r27.xyz = -refProbeConstantsCB[r19.w].data[0].xyz + r10.xyz;
  ...
  if (r6.w != 0) {
    ...
    r16.w = 0;
    r17.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r16.xyzw, r8.w).xyz;
  ...
  if (r2.y != 0) {
    ...
    if (r2.y != 0) {
      ...
      if (r4.z != 0) {
        ...
        r20.x = lightConstantsCB[r2.z].data[9].w + r13.z;
        r20.y = lightConstantsCB[r2.z].data[10].x + r13.w;
        r13.zw = lightConstantsCB[r2.z].data[9].yz * r20.xy;
        ...
        if (r4.z == 0) {
          ...
          r19.x = r13.z * lightConstantsCB[r2.z].data[8].y + lightConstantsCB[r2.z].data[8].z;
          r19.y = r13.w * lightConstantsCB[r2.z].data[8].w + lightConstantsCB[r2.z].data[9].x;
      ...
      r2.z = r2.z * r7.w;
      r2.w = cmp(0 < r2.w);
      r19.xyz = r2.zzz * r15.yzw + r17.xyz;
      ...
      r0.z = r2.z * r0.z;
      r0.z = r2.y * r0.z;
      r21.xyz = r0.zzz * r15.zwy + r18.xyz;
      r19.w = r21.z;
      r17.w = r18.z;
      ...
      if (r13.z != 0) {
        ...
        if (r18.w != 0) {
          ...
          if (r20.w != 0) {
            ...
            r25.w = lightConstantsCB[r11.w].data[3].x * lightConstantsCB[r11.w].data[3].x;
            r27.w = dot(r36.xyz, r36.xyz);
            r25.w = r25.w / r27.w;
            r25.w = min(1, r25.w);
            r36.xy = saturate(r18.ww * lightConstantsCB[r11.w].data[2].xz + lightConstantsCB[r11.w].data[2].yw);
            ...
            r18.w = cmp(lightConstantsCB[r11.w].data[10].w < 0.00048828125);
            if (r18.w != 0) {
              r36.xy = saturate(abs(r20.xy) * lightConstantsCB[r11.w].data[12].xy + lightConstantsCB[r11.w].data[12].zw);
              r36.zw = r36.xy * r36.xy;
              r36.xy = r36.xy * float2(-2,-2) + float2(3,3);
              r36.xy = r36.zw * r36.xy;
              r18.w = r36.x * r36.y;
            } else {
              r36.xyzw = saturate(lightConstantsCB[r11.w].data[11].xyzw * abs(r20.yyxx));
            ...
            r20.w = r25.w * r18.w;
            r18.w = 255 & (int)lightConstantsCB[r11.w].data[14].w;
            if (r18.w != 0) {
              r25.w = dot(lightConstantsCB[r11.w].data[13].xyz, r20.xyz);
          ...
          if (r18.w != 0) {
              ...
              if (r20.x != 0) {
                ...
                if (r7.w != 0) {
                  ...
                  while (true) {
                    ...
                    r34.xy = r36.xy * lightConstantsCB[r11.w].data[3].yy + r21.xy;
                    r25.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r34.xyz, r13.z).x;
                    r20.x = r25.w * 0.125 + r20.x;
                    r20.y = (int)r20.y + 1;
                  }
                } else {
                  r21.z = (uint)r18.w;
                  r20.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r21.xyz, r13.z).x;
                }
                r13.z = r20.x * r20.x;
                r13.z = r13.z * r20.x;
              } else {
            ...
            r18.w = cmp(0 < r13.z);
            if (r18.w != 0) {
              if (4 == 0) r18.w = 0; else if (4+16 < 32) {               r18.w = (uint)lightConstantsCB[r11.w].data[1].w << (32-(4 + 16)); r18.w = (uint)r18.w >> (32-4);              } else r18.w = (uint)lightConstantsCB[r11.w].data[1].w >> 16;
              ...
              if (r20.y != 0) {
                ...
                r22.xyz = r11.xyz * r20.yyy + r10.xyz;
                ...
                if (r20.w == 0) {
                  ...
                  if (r7.w != 0) {
                    ...
                    while (true) {
                      ...
                      r36.y = dot(icb[r22.y+0].xy, r13.xy);
                ...
                if (4 == 0) r18.w = 0; else if (4+20 < 32) {                 r18.w = (uint)lightConstantsCB[r11.w].data[1].w << (32-(4 + 20)); r18.w = (uint)r18.w >> (32-4);                } else r18.w = (uint)lightConstantsCB[r11.w].data[1].w >> 20;
                r20.y = cmp(0 < (uint)r18.w);
                r20.y = r20.y ? r0.z : 0;
                if (r20.y != 0) {
                  r18.w = (int)r18.w + numLights;
                  r18.w = mad((int)r18.w, 15, -15);
                  r20.y = abs(r16.w) * -0.200000003 + 0.400000006;
                  r23.xyz = r11.xyz * r20.yyy + r10.xyz;
                  r34.xyz = lightConstantsCB[r18.w].data[6].yzw;
                  r34.w = lightConstantsCB[r18.w].data[7].x;
              ...
              r14.w = r18.w * r14.w;
              r13.z = r14.w * r13.z;
              r23.xyz = r13.zzz * r35.xyz + r32.xyz;
              r13.w = saturate(1 + -r13.w);
              r14.w = r13.w * r13.w;
              r14.w = r14.w * r14.w;
              r13.w = r14.w * r13.w;
              r13.z = r13.z * r13.w;
              r33.xyz = r13.zzz * r35.xyz + r31.xyz;
        ...
        if (r12.w != 0) {
          ...
          r13.z = lightConstantsCB[r11.w].data[1].z * r0.w;
          r13.z = 0.25 * r13.z;
          r13.w = cmp(0 < lightConstantsCB[r11.w].data[6].y);
          r21.xy = lightConstantsCB[r11.w].data[5].zw;
          r21.z = lightConstantsCB[r11.w].data[6].x;
          r23.xyz = -r21.xyz * float3(0.5,0.5,0.5) + lightConstantsCB[r11.w].data[0].xyz;
          r33.xyz = r23.xyz + -r10.xyz;
          r14.w = dot(r21.xyz, r16.xyz);
          r16.w = dot(r21.xyz, r33.xyz);
          r17.w = dot(r16.xyz, r33.xyz);
          r18.w = -r14.w * r14.w + lightConstantsCB[r11.w].data[6].y;
          r14.w = r14.w * r17.w + -r16.w;
          r16.w = saturate(-r16.w / lightConstantsCB[r11.w].data[6].y);
          r14.w = saturate(r14.w / r18.w);
          r17.w = r18.w / lightConstantsCB[r11.w].data[6].y;
          r17.w = 10 * r17.w;
          r17.w = min(1, r17.w);
          r14.w = r14.w + -r16.w;
          r14.w = r17.w * r14.w + r16.w;
          r33.xyz = r14.www * r21.xyz + r23.xyz;
          r21.xyz = r16.www * r21.xyz + r23.xyz;
          r21.xyz = r13.www ? r21.xyz : lightConstantsCB[r11.w].data[0].xyz;
          r23.xyz = r13.www ? r33.xyz : lightConstantsCB[r11.w].data[0].xyz;
          r23.xyz = r23.xyz + -r10.xyz;
          r21.xyz = r21.xyz + -r10.xyz;
          r13.w = dot(r23.xyz, r23.xyz);
          r13.w = rsqrt(r13.w);
          r33.xyz = r23.xyz * r13.www;
          r14.w = dot(r21.xyz, r21.xyz);
          r16.w = rsqrt(r14.w);
          r21.xyz = r21.xyz * r16.www;
          r16.w = dot(r11.xyz, r21.xyz);
          r17.w = saturate(r16.w);
          r18.w = cmp(0 < r17.w);
          if (r18.w != 0) {
            r18.w = sqrt(r14.w);
            r20.y = lightConstantsCB[r11.w].data[3].x * lightConstantsCB[r11.w].data[3].x;
            r14.w = r20.y / r14.w;
            r14.w = min(1, r14.w);
            r20.yw = saturate(r18.ww * lightConstantsCB[r11.w].data[2].xz + lightConstantsCB[r11.w].data[2].yw);
            ...
            if (r18.w != 0) {
              ...
              if (r12.w != 0) {
                ...
                r21.xyz = -lightConstantsCB[r11.w].data[4].yzw + r21.xyz;
                r12.w = max(abs(r21.y), abs(r21.z));
                r12.w = max(abs(r21.x), r12.w);
                ...
                r20.y = 0x0000ffff & (int)lightConstantsCB[r11.w].data[1].w;
                r34.w = (uint)r20.y;
                r20.yw = float2(0,0);
                while (true) {
                  r22.z = cmp((int)r20.w >= 8);
                  if (r22.z != 0) break;
                  r35.y = dot(icb[r20.w+0].xy, r14.xy);
                  r35.z = dot(icb[r20.w+0].yx, r14.xz);
                  r35.yz = lightConstantsCB[r11.w].data[3].yy * r35.yz;
                  r35.x = r35.y * r15.x;
                  r35.w = r35.y * r3.x;
                  r34.xyz = r21.xyz * r18.www + r35.xzw;
                  r22.z = gOmniShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r34.xyzw, r12.w).x;
              ...
              if (r14.w != 0) {
                ...
                if (r18.w != 0) {
                  ...
                  if (r21.x == 0) {
                    ...
                    r21.yz = r34.xy / r20.ww;
                    r21.yz = r21.yz * float2(0.5,-0.5) + float2(0.5,0.5);
                    r24.x = lightConstantsCB[r14.w].data[9].w + r21.y;
                    r24.y = lightConstantsCB[r14.w].data[10].x + r21.z;
                    r21.yz = lightConstantsCB[r14.w].data[9].yz * r24.xy;
                    ...
                    if (r22.z == 0) {
                      r21.yz = saturate(r21.yz);
                      r24.x = r21.y * lightConstantsCB[r14.w].data[8].y + lightConstantsCB[r14.w].data[8].z;
                      r24.y = r21.z * lightConstantsCB[r14.w].data[8].w + lightConstantsCB[r14.w].data[9].x;
                      r21.y = lightConstantsCB[r14.w].data[10].z * r20.w;
                      r18.w = lightConstantsCB[r14.w].data[10].y * r20.w + r18.w;
                      r18.w = r18.w / r21.y;
                    }
                  } else {
                    r22.z = -1;
                  ...
                  if (r20.w == 0) {
                    ...
                    r20.w = 0x0000ffff & (int)lightConstantsCB[r14.w].data[1].w;
                    if (r7.w != 0) {
                      r21.z = (uint)r20.w;
                      r22.z = 0;
                      r25.w = 0;
                      while (true) {
                        ...
                        r21.xy = r34.xy * lightConstantsCB[r14.w].data[3].yy + r24.xy;
                  ...
                  if (r18.w != 0) {
                    ...
                    r14.w = mad((int)r14.w, 15, -15);
                    r18.w = abs(r16.w) * -0.200000003 + 0.400000006;
                    r26.xyz = r11.xyz * r18.www + r10.xyz;
                    r34.xyz = lightConstantsCB[r14.w].data[6].yzw;
                    r34.w = lightConstantsCB[r14.w].data[7].x;
                    ...
                    if (r21.x == 0) {
                      ...
                      if (r24.x == 0) {
                        r21.yz = saturate(r21.yz);
                        r26.x = r21.y * lightConstantsCB[r14.w].data[8].y + lightConstantsCB[r14.w].data[8].z;
                        r26.y = r21.z * lightConstantsCB[r14.w].data[8].w + lightConstantsCB[r14.w].data[9].x;
                        r21.y = lightConstantsCB[r14.w].data[10].z * r20.w;
                        r18.w = lightConstantsCB[r14.w].data[10].y * r20.w + r18.w;
                        r18.w = r18.w / r21.y;
                      }
                    ...
                    if (r20.w == 0) {
                      ...
                      if (r7.w != 0) {
                        ...
                        while (true) {
                          ...
                          r21.xy = r34.xy * lightConstantsCB[r14.w].data[3].yy + r26.xy;
                          r21.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r21.xyz, r18.w).x;
                ...
                r14.w = r14.w + -r17.w;
                r14.w = r1.z * r14.w + r17.w;
                r14.w = r14.w * r12.w;
                r21.x = lightConstantsCB[r11.w].data[0].w;
                r21.yz = lightConstantsCB[r11.w].data[1].xy;
                r11.w = cmp(0 < r16.w);
                r26.xyz = r14.www * r21.xyz + r15.yzw;
                r14.w = saturate(dot(r11.xyz, r33.xyz));
                r23.xyz = r23.xyz * r13.www + r12.xyz;
                r13.w = dot(r23.xyz, r23.xyz);
                r13.w = rsqrt(r13.w);
                r23.xyz = r23.xyz * r13.www;
                r13.w = dot(r23.xyz, r12.xyz);
                r16.w = dot(r11.xyz, r23.xyz);
                r17.w = abs(r16.w) * r0.w + -abs(r16.w);
                r16.w = abs(r16.w) * r17.w + 1;
                r17.w = r14.w * r0.x + r1.w;
                r16.w = r16.w * r16.w;
                r16.w = r16.w * r17.w;
                r16.w = rcp(r16.w);
                r13.z = r14.w * r13.z;
                r13.z = r16.w * r13.z;
                r12.w = r13.z * r12.w;
                r23.xyz = r12.www * r21.xyz + r32.xyz;
                r13.z = saturate(1 + -r13.w);
                r13.w = r13.z * r13.z;
                r13.w = r13.w * r13.w;
                r13.z = r13.z * r13.w;
                r12.w = r13.z * r12.w;
                r21.xyz = r12.www * r21.xyz + r31.xyz;
                r15.yzw = r11.www ? r26.xyz : r15.yzw;
                r31.xyz = r11.www ? r21.xyz : r31.xyz;
