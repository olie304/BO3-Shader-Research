...
r0.y = samp0[]..swiz;
    ...
    if (r9.w == 0) {
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          r14.w = r13.w ? sunConstants.splitPinTransform[r7.w].w : sunConstants.splitPinTransform[r9.z].w;
          r13.w = r13.w ? r7.w : r9.z;
  ...
  if (r2.z != 0) {
    ...
    if (r2.z != 0) {
      ...
      if (sunConstants.sunCookieIndex != 0) {
        ...
        r5.w = dot(sunConstants.sunCookieTransform[1].xyzw, r17.xyzw);
        r17.x = frac(r4.z);
        r17.y = frac(r5.w);
        r4.z = -1 + (int14)sunConstants.sunCookieIndex;
        r17.z = (uint)r4.z;
        r14.yzw = gCookieArray.SampleLevel(samplerLinear_s, r17.xyz, 0).xyz;
      ...
      if (r5.w != 0) {
        ...
        if (r5.w == 0) {
          ...
          r17.x = r18.x * lightConstantsCB[r4.z].data[8].y + lightConstantsCB[r4.z].data[8].z;
          r17.y = r18.y * lightConstantsCB[r4.z].data[8].w + lightConstantsCB[r4.z].data[9].x;
          ...
          if (enableDitheredShadow != 0) {
            ...
            while (true) {
              ...
              r19.xy = r20.xy * lightConstantsCB[r4.z].data[3].yy + r17.xy;
              r12.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r19.xyz, r5.w).x;
      ...
      r2.z = r6.w * r2.z;
      r2.z = 0.25 * r2.z;
      r18.xyz = r2.zzz * r14.yzw + r13.yzw;
      r0.z = saturate(1 + -r0.z);
      r3.w = r0.z * r0.z;
      r3.w = r3.w * r3.w;
      r0.z = r3.w * r0.z;
      r0.z = r2.z * r0.z;
      r19.xyz = r0.zzz * r14.zwy + r16.xyz;
      r17.w = r19.z;
      r9.w = r16.z;
      r9.xyzw = r2.wwww ? r17.xyzw : r9.xyzw;
      r19.zw = r18.xy;
      r16.zw = r13.yz;
      r17.xyzw = r2.wwww ? r19.xyzw : r16.xyzw;
      r13.w = r2.w ? r18.z : r13.w;
      r16.z = r9.w;
      r16.xy = r17.xy;
      r13.yz = r17.zw;
    }
  ...
  r0.x = (uint)r0.x >> 24;
  r0.x = (int)r0.x * 15;
  if (3 == 0) r0.z = 0; else if (3+24 < 32) {   r0.z = (uint)lightConstantsCB[r0.x].data[1].w << (32-(3 + 24)); r0.z = (uint)r0.z >> (32-3);  } else r0.z = (uint)lightConstantsCB[r0.x].data[1].w >> 24;
  switch (r0.z) {
    case 4 :    r0.z = cmp(0 < lightConstantsCB[r0.x].data[6].y);
    ...
    r18.xyz = r14.yzw + -r10.xyz;
    r2.z = dot(r17.xyz, r18.xyz);
    r2.w = saturate(-r2.z / lightConstantsCB[r0.x].data[6].y);
    r19.xyz = r2.www * r17.xyz + r14.yzw;
    r19.xyz = r0.zzz ? r19.xyz : lightConstantsCB[r0.x].data[0].xyz;
    r19.xyz = r19.xyz + -r10.xyz;
    r3.w = dot(r19.xyz, r19.xyz);
    r4.z = rsqrt(r3.w);
    r19.xyz = r19.xyz * r4.zzz;
    r4.z = dot(r11.xyz, r19.xyz);
    r5.w = saturate(r4.z);
    r6.w = cmp(0 < r5.w);
    if (r6.w != 0) {
      r6.w = sqrt(r3.w);
      ...
      if (r6.w != 0) {
        ...
        if (r6.w != 0) {
          r19.xy = (uint2)r1.yx;
          r6.w = dot(r19.xy, float2(0.0671105608,0.00583714992));
          r6.w = frac(r6.w);
          r6.w = 52.9829178 * r6.w;
          r6.w = frac(r6.w);
          r6.w = r6.w * 6.28318548 + gameTick.w;
          sincos(r6.w, r19.x, r20.x);
          r6.w = abs(r4.z) * -0.200000003 + 0.400000006;
          r19.yzw = r11.xyz * r6.www + r10.xyz;
          r19.yzw = -lightConstantsCB[r0.x].data[4].yzw + r19.yzw;
          r6.w = max(abs(r19.z), abs(r19.w));
          r6.w = max(abs(r19.y), r6.w);
          r6.w = lightConstantsCB[r0.x].data[5].x / r6.w;
          r6.w = lightConstantsCB[r0.x].data[5].y + r6.w;
          r7.w = dot(r19.yzw, r19.yzw);
          r7.w = rsqrt(r7.w);
          ...
          while (true) {
            ...
            if (r11.w != 0) break;
            r20.y = dot(icb[r9.w+0].yx, r21.xy);
            r20.z = dot(icb[r9.w+0].yx, r21.yz);
            r23.yz = lightConstantsCB[r0.x].data[3].yy * r20.yz;
            r23.x = r23.y * r20.x;
            r23.w = r23.y * r19.x;
            r22.xyz = r19.yzw * r7.www + r23.xzw;
            r11.w = gOmniShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r22.xyzw, r6.w).x;
        ...
        if (r6.w != 0) {
          ...
          r6.w = 0.25 * r6.w;
          r7.w = dot(r17.xyz, r15.xyz);
          r8.w = dot(r15.xyz, r18.xyz);
          r9.w = -r7.w * r7.w + lightConstantsCB[r0.x].data[6].y;
          r2.z = r7.w * r8.w + -r2.z;
          r2.z = saturate(r2.z / r9.w);
          r7.w = r9.w / lightConstantsCB[r0.x].data[6].y;
          r7.w = 10 * r7.w;
          r7.w = min(1, r7.w);
          r2.z = r2.z + -r2.w;
          r2.z = r7.w * r2.z + r2.w;
          r14.yzw = r2.zzz * r17.xyz + r14.yzw;
          r14.yzw = r0.zzz ? r14.yzw : lightConstantsCB[r0.x].data[0].xyz;
          r14.yzw = r14.yzw + -r10.xyz;
          r0.z = dot(r14.yzw, r14.yzw);
          r0.z = rsqrt(r0.z);
          r15.xyz = r14.yzw * r0.zzz;
          if (4 == 0) r2.z = 0; else if (4+16 < 32) {           r2.z = (uint)lightConstantsCB[r0.x].data[1].w << (32-(4 + 16)); r2.z = (uint)r2.z >> (32-4);          } else r2.z = (uint)lightConstantsCB[r0.x].data[1].w >> 16;
          r2.w = cmp(0 < (uint)r2.z);
          r2.w = r0.y ? r2.w : 0;
          if (r2.w != 0) {
            r2.z = (int)r2.z + numLights;
            r2.z = mad((int)r2.z, 15, -15);
            r2.w = abs(r4.z) * -0.200000003 + 0.400000006;
            r17.xyz = r11.xyz * r2.www + r10.xyz;
            r18.xyz = lightConstantsCB[r2.z].data[6].yzw;
            r18.w = lightConstantsCB[r2.z].data[7].x;
            r17.w = 1;
            r2.w = dot(r18.xyzw, r17.xyzw);
            r18.xyz = lightConstantsCB[r2.z].data[7].yzw;
            r18.w = lightConstantsCB[r2.z].data[8].x;
            ...
            if (r8.w == 0) {
              ...
              if (r9.w == 0) {
                ...
                r18.x = r17.x * lightConstantsCB[r2.z].data[8].y + lightConstantsCB[r2.z].data[8].z;
                r18.y = r17.y * lightConstantsCB[r2.z].data[8].w + lightConstantsCB[r2.z].data[9].x;
                r11.w = lightConstantsCB[r2.z].data[10].z * r7.w;
                r2.w = lightConstantsCB[r2.z].data[10].y * r7.w + r2.w;
                r2.w = r2.w / r11.w;
              }
            } else {
              r9.w = -1;
            ...
            if (r7.w == 0) {
              ...
              r7.w = 0x0000ffff & (int)lightConstantsCB[r2.z].data[1].w;
              if (enableDitheredShadow != 0) {
                r17.x = -r13.x;
                r19.z = (uint)r7.w;
                r17.y = r14.x;
                ...
                while (true) {
                  ...
                  r19.xy = r20.xy * lightConstantsCB[r2.z].data[3].yy + r18.xy;
                  r11.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r19.xyz, r2.w).x;
                  r8.w = r11.w * 0.125 + r8.w;
                  r9.w = (int)r9.w + 1;
                }
              } else {
                r18.z = (uint)r7.w;
                r8.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r18.xyz, r2.w).x;
              }
              r2.z = r8.w * r8.w;
              r2.z = r2.z * r8.w;
            } else {
            ...
            if (4 == 0) r2.z = 0; else if (4+20 < 32) {             r2.z = (uint)lightConstantsCB[r0.x].data[1].w << (32-(4 + 20)); r2.z = (uint)r2.z >> (32-4);            } else r2.z = (uint)lightConstantsCB[r0.x].data[1].w >> 20;
            r2.w = cmp(0 < (uint)r2.z);
            r7.w = ~(int)r0.y;
            r2.w = r2.w ? r7.w : 0;
            if (r2.w != 0) {
          ...
          r2.w = cmp(0 < r4.z);
          r18.xyz = r2.zzz * r17.xyz + r9.xyz;
          r2.z = saturate(dot(r11.xyz, r15.xyz));
          r14.yzw = r14.yzw * r0.zzz + r12.xyz;
          r0.z = dot(r14.yzw, r14.yzw);
          r0.z = rsqrt(r0.z);
          ...
          r2.z = r4.z * r2.z;
          r2.z = r2.z * r3.w;
          r14.yzw = r2.zzz * r17.xyz + r13.yzw;
          r0.z = saturate(1 + -r0.z);
          r3.w = r0.z * r0.z;
          r3.w = r3.w * r3.w;
          r0.z = r3.w * r0.z;
          r0.z = r2.z * r0.z;
          r15.xyz = r0.zzz * r17.xyz + r16.zxy;
          r9.xyz = r2.www ? r18.xyz : r9.xyz;
          r16.xyz = r2.www ? r15.yzx : r16.xyz;
          r13.yzw = r2.www ? r14.yzw : r13.yzw;
        }
      }
    }
    break;
    ...
    r0.z = rsqrt(r0.z);
    r14.yzw = r15.xyz * r0.zzz;
    r2.z = dot(r11.xyz, r14.yzw);
    r2.w = saturate(r2.z);
    r3.w = cmp(0 < r2.w);
    if (r3.w != 0) {
      ...
      r10.w = 1;
      r3.w = dot(r17.xyzw, r10.xyzw);
      r4.z = cmp(r3.w < 1);
      if (r4.z != 0) {
        r14.yzw = float3(1,1,1);
        r4.z = 0;
      } else {
        r18.xyz = lightConstantsCB[r0.x].data[0].xyz + -r10.xyz;
        r5.w = lightConstantsCB[r0.x].data[3].x * lightConstantsCB[r0.x].data[3].x;
        ...
        if (r3.w != 0) {
          r18.z = 1;
          r5.w = dot(lightConstantsCB[r0.x].data[13].xyz, r18.xyz);
      ...
      if (r3.w != 0) {
        ...
        if (r3.w != 0) {
          ...
          r18.xyz = r11.xyz * r3.www + r10.xyz;
          ...
          if (r6.w != 0) {
            ...
            r5.w = 0x0000ffff & (int)lightConstantsCB[r0.x].data[1].w;
            if (enableDitheredShadow != 0) {
              r17.x = -r13.x;
              r19.z = (uint)r5.w;
              r17.y = r14.x;
        ...
        r4.z = cmp(0 < r3.w);
        if (r4.z != 0) {
          r4.z = lightConstantsCB[r0.x].data[1].z * r0.w;
          r4.z = r4.z * r2.w;
          if (4 == 0) r5.w = 0; else if (4+16 < 32) {           r5.w = (uint)lightConstantsCB[r0.x].data[1].w << (32-(4 + 16)); r5.w = (uint)r5.w >> (32-4);          } else r5.w = (uint)lightConstantsCB[r0.x].data[1].w >> 16;
          ...
          if (r6.w != 0) {
            ...
            if (r8.w == 0) {
              ...
              if (r9.w == 0) {
                ...
                r10.w = lightConstantsCB[r5.w].data[10].z * r7.w;
            ...
            if (r0.y != 0) {
              ...
              if (r6.w == 0) {
                ...
                if (r7.w == 0) {
                  ...
                  r18.x = r17.x * lightConstantsCB[r0.x].data[8].y + lightConstantsCB[r0.x].data[8].z;
                  r18.y = r17.y * lightConstantsCB[r0.x].data[8].w + lightConstantsCB[r0.x].data[9].x;
                  r8.w = lightConstantsCB[r0.x].data[10].z * r5.w;
                  r0.y = lightConstantsCB[r0.x].data[10].y * r5.w + r0.y;
                  r0.y = r0.y / r8.w;
                }
              } else {
                r7.w = -1;
              }
              r5.w = (int)r6.w | (int)r7.w;
              if (r5.w == 0) {
                ...
                if (enableDitheredShadow != 0) {
                  ...
                  while (true) {
                    ...
                    r20.y = dot(icb[r7.w+0].yx, r17.yz);
                    r19.xy = r20.xy * lightConstantsCB[r0.x].data[3].yy + r18.xy;
                    r8.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r19.xyz, r0.y).x;
                    r6.w = r8.w * 0.125 + r6.w;
                    r7.w = (int)r7.w + 1;
                  }
                } else {
                  r18.z = (uint)r5.w;
                  r6.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r18.xyz, r0.y).x;
                }
                r0.x = r6.w * r6.w;
                r0.x = r0.x * r6.w;
              } else {
          ...
          r0.x = r0.x * r3.w;
          r0.y = cmp(0 < r2.z);
          r17.xyz = r0.xxx * r14.yzw + r9.xyz;
          r15.xyz = r15.xyz * r0.zzz + r12.xyz;
          r0.x = dot(r15.xyz, r15.xyz);
          r0.x = rsqrt(r0.x);
          r15.xyz = r15.xyz * r0.xxx;
          r0.x = dot(r15.xyz, r12.xyz);
          r0.z = dot(r11.xyz, r15.xyz);
          ...
          r0.z = r3.w * r0.z;
          r0.z = 0.25 * r0.z;
          r2.xyz = r0.zzz * r14.yzw + r13.yzw;
          r0.x = saturate(1 + -r0.x);
          r0.w = r0.x * r0.x;
          r0.w = r0.w * r0.w;
          r0.x = r0.x * r0.w;
          r0.x = r0.z * r0.x;
          r0.xzw = r0.xxx * r14.yzw + r16.zxy;
          r9.xyz = r0.yyy ? r17.xyz : r9.xyz;
          r16.xyz = r0.yyy ? r0.zwx : r16.xyz;
