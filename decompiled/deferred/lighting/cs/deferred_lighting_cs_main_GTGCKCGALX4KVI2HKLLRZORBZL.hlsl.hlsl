...
r0.y = samplerLinear[]..swiz;
  ...
  while (true) {
    ...
    if (r9.w != 0) {
      ...
      r16.yz = r14.ww ? r19.xy : r19.zx;
      r14.w = refProbeConstantsCB[r8.w].data[6].x;
      r27.xy = r16.yz;
      r16.w = 1;
      while (true) {
        r18.y = cmp((int)r16.w >= (int)r10.w);
        if (r18.y != 0) break;
        r18.y = (int)r9.w + (int)r16.w;
        r18.y = (int)r18.y * 6;
        r18.z = dot(refProbeAttenuationConstantsCB[r18.y].data[0].xyz, r15.yzw);
        r18.z = saturate(refProbeAttenuationConstantsCB[r18.y].data[0].w + r18.z);
        r18.z = r27.x * r18.z;
        r18.w = dot(refProbeAttenuationConstantsCB[r18.y].data[1].xyz, r15.yzw);
        r18.w = saturate(refProbeAttenuationConstantsCB[r18.y].data[1].w + r18.w);
        r18.z = r18.z * r18.w;
        r18.w = dot(refProbeAttenuationConstantsCB[r18.y].data[2].xyz, r15.yzw);
        r18.w = saturate(refProbeAttenuationConstantsCB[r18.y].data[2].w + r18.w);
        r18.z = r18.z * r18.w;
        r18.w = dot(refProbeAttenuationConstantsCB[r18.y].data[3].xyz, r15.yzw);
        r18.w = saturate(refProbeAttenuationConstantsCB[r18.y].data[3].w + r18.w);
        r18.z = r18.z * r18.w;
        r18.w = dot(refProbeAttenuationConstantsCB[r18.y].data[4].xyz, r15.yzw);
        r18.w = saturate(refProbeAttenuationConstantsCB[r18.y].data[4].w + r18.w);
        r18.z = r18.z * r18.w;
        r18.w = dot(refProbeAttenuationConstantsCB[r18.y].data[5].xyz, r15.yzw);
        ...
        r18.y = -r18.z * r18.y + 1;
        r18.y = r27.y * r18.y;
        r21.y = r19.w ? r18.y : r20.w;
        r27.xy = r19.xx ? r27.xy : r21.xy;
        r16.w = (int)r16.w + 1;
        r14.w = r18.w;
      }
      ...
      if (r10.w != 0) {
        ...
        r14.w = r2.z ? r14.w : 0;
        if (r14.w != 0) {
          r16.yz = mad((int2)r10.ww, int2(20,20), int2(860,876));
        // Known bad code for instruction (needs manual fix):
        ...
        r16.y = -refProbeConstantsCB[r8.w].data[9].z + r16.y;
        r16.z = cmp(r16.y >= 0);
        r16.y = max(abs(r16.y), r3.z);
        r16.y = r16.z ? r16.y : -r16.y;
        r14.w = max(1.00000001e-07, -r14.w);
        r14.w = r16.y / r14.w;
        r10.w = min(abs(r14.w), r10.w);
        r28.x = refProbeConstantsCB[r8.w].data[9].w;
        r28.yz = refProbeConstantsCB[r8.w].data[10].xy;
        r14.w = dot(r17.xyz, r28.xyz);
        r16.y = dot(r15.yzw, r28.xyz);
        r16.y = -refProbeConstantsCB[r8.w].data[10].z + r16.y;
        r16.z = cmp(r16.y >= 0);
        r16.y = max(abs(r16.y), r3.z);
        r16.y = r16.z ? r16.y : -r16.y;
        r14.w = max(1.00000001e-07, -r14.w);
        ...
        r14.w = dot(r17.xyz, r28.xyz);
        r16.y = dot(r15.yzw, r28.xyz);
        r16.y = -refProbeConstantsCB[r8.w].data[11].z + r16.y;
        r16.z = cmp(r16.y >= 0);
        r16.y = max(abs(r16.y), r3.z);
        r16.y = r16.z ? r16.y : -r16.y;
        r14.w = max(1.00000001e-07, -r14.w);
        ...
        r14.w = dot(r17.xyz, r28.xyz);
        r16.y = dot(r15.yzw, r28.xyz);
        r16.y = -refProbeConstantsCB[r8.w].data[12].z + r16.y;
        r16.z = cmp(r16.y >= 0);
        r16.y = max(abs(r16.y), r3.z);
        r16.y = r16.z ? r16.y : -r16.y;
        r14.w = max(1.00000001e-07, -r14.w);
        ...
        r14.w = dot(r17.xyz, r28.xyz);
        r16.y = dot(r15.yzw, r28.xyz);
        r16.y = -refProbeConstantsCB[r8.w].data[13].z + r16.y;
        r16.z = cmp(r16.y >= 0);
        r16.y = max(abs(r16.y), r3.z);
        r16.y = r16.z ? r16.y : -r16.y;
        r14.w = max(1.00000001e-07, -r14.w);
        ...
        if (9 == 0) r14.w = 0; else if (9+16 < 32) {         r14.w = (uint)refProbeConstantsCB[r8.w].data[7].z << (32-(9 + 16)); r14.w = (uint)r14.w >> (32-9);        } else r14.w = (uint)refProbeConstantsCB[r8.w].data[7].z >> 16;
        r29.w = (uint)r14.w;
  ...
  while (true) {
    ...
    if (r9.w != 0) {
      ...
      r21.y = (int)r16.z + 1;
      r18.yzw = -refProbeConstantsCB[r8.w].data[0].xyz + r11.xyz;
      r9.w = 0x0000ffff & (int)refProbeConstantsCB[r8.w].data[7].z;
      if (6 == 0) r10.w = 0; else if (6+25 < 32) {       r10.w = (uint)refProbeConstantsCB[r8.w].data[7].z << (32-(6 + 25)); r10.w = (uint)r10.w >> (32-6);      } else r10.w = (uint)refProbeConstantsCB[r8.w].data[7].z >> 25;
      r14.w = (int)r9.w * 6;
      r16.w = dot(refProbeAttenuationConstantsCB[r14.w].data[0].xyz, r18.yzw);
      r16.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[0].w + r16.w);
      r19.w = dot(refProbeAttenuationConstantsCB[r14.w].data[1].xyz, r18.yzw);
      r19.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[1].w + r19.w);
      r16.w = r19.w * r16.w;
      r19.w = dot(refProbeAttenuationConstantsCB[r14.w].data[2].xyz, r18.yzw);
      r19.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[2].w + r19.w);
      r16.w = r19.w * r16.w;
      r19.w = dot(refProbeAttenuationConstantsCB[r14.w].data[3].xyz, r18.yzw);
      r19.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[3].w + r19.w);
      r16.w = r19.w * r16.w;
      r19.w = dot(refProbeAttenuationConstantsCB[r14.w].data[4].xyz, r18.yzw);
      r19.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[4].w + r19.w);
      r16.w = r19.w * r16.w;
      r19.w = dot(refProbeAttenuationConstantsCB[r14.w].data[5].xyz, r18.yzw);
      r14.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[5].w + r19.w);
      r19.x = r16.w * r14.w;
      r14.w = 1 & (int)refProbeConstantsCB[r8.w].data[6].x;
      r19.xw = r14.ww ? r19.xy : r19.zx;
      r14.w = refProbeConstantsCB[r8.w].data[6].x;
      r27.xy = r19.xw;
      r16.w = 1;
      while (true) {
        r20.w = cmp((int)r16.w >= (int)r10.w);
        if (r20.w != 0) break;
        r20.w = (int)r9.w + (int)r16.w;
        r20.w = (int)r20.w * 6;
        ...
        r27.x = r22.w * r20.w;
        r23.w = (uint)r14.w >> 2;
        if (1 == 0) r26.w = 0; else if (1+2 < 32) {         r26.w = (uint)r14.w << (32-(1 + 2)); r26.w = (uint)r26.w >> (32-1);        } else r26.w = (uint)r14.w >> 2;
        r27.z = (int)r23.w & 2;
        r27.w = max(r27.y, r27.x);
        r20.w = -r22.w * r20.w + 1;
        r20.w = r27.y * r20.w;
        r21.w = r27.z ? r20.w : r27.w;
        r27.xy = r26.ww ? r27.xy : r21.zw;
        r16.w = (int)r16.w + 1;
        r14.w = r23.w;
      }
      ...
      if (r14.w != 0) {
        ...
        r16.w = r2.z ? r16.w : 0;
        if (r16.w != 0) {
          r19.xw = mad((int2)r14.ww, int2(20,20), int2(860,876));
        // Known bad code for instruction (needs manual fix):
        ...
        r16.z = (int)r16.z + 257;
        r16.y = r9.w * refProbeConstantsCB[r8.w].data[6].y + r16.y;
        ...
        r28.yz = refProbeConstantsCB[r8.w].data[9].xy;
        r14.w = dot(r17.xyz, r28.xyz);
        r16.w = dot(r18.yzw, r28.xyz);
        r16.w = -refProbeConstantsCB[r8.w].data[9].z + r16.w;
        r19.x = cmp(r16.w >= 0);
        ...
        r14.w = dot(r17.xyz, r28.xyz);
        r16.w = dot(r18.yzw, r28.xyz);
        r16.w = -refProbeConstantsCB[r8.w].data[10].z + r16.w;
        r19.x = cmp(r16.w >= 0);
        r16.w = max(abs(r16.w), r3.z);
        r16.w = r19.x ? r16.w : -r16.w;
        r14.w = max(1.00000001e-07, -r14.w);
        ...
        r14.w = dot(r17.xyz, r28.xyz);
        r16.w = dot(r18.yzw, r28.xyz);
        r16.w = -refProbeConstantsCB[r8.w].data[11].z + r16.w;
        r19.x = cmp(r16.w >= 0);
        r16.w = max(abs(r16.w), r3.z);
        r16.w = r19.x ? r16.w : -r16.w;
        r14.w = max(1.00000001e-07, -r14.w);
        ...
        r14.w = dot(r17.xyz, r28.xyz);
        r16.w = dot(r18.yzw, r28.xyz);
        r16.w = -refProbeConstantsCB[r8.w].data[12].z + r16.w;
        r19.x = cmp(r16.w >= 0);
        r16.w = max(abs(r16.w), r3.z);
        r16.w = r19.x ? r16.w : -r16.w;
        r14.w = max(1.00000001e-07, -r14.w);
        ...
        r14.w = dot(r17.xyz, r28.xyz);
        r16.w = dot(r18.yzw, r28.xyz);
        r16.w = -refProbeConstantsCB[r8.w].data[13].z + r16.w;
        r19.x = cmp(r16.w >= 0);
        r16.w = max(abs(r16.w), r3.z);
        r16.w = r19.x ? r16.w : -r16.w;
        r14.w = max(1.00000001e-07, -r14.w);
        r14.w = r16.w / r14.w;
        r10.w = min(abs(r14.w), r10.w);
        r28.x = refProbeConstantsCB[r8.w].data[3].w + r18.y;
        r28.yz = refProbeConstantsCB[r8.w].data[4].xy + r18.zw;
        r27.xzw = r17.xyz * r10.www + r28.xyz;
        ...
        if (9 == 0) r14.w = 0; else if (9+16 < 32) {         r14.w = (uint)refProbeConstantsCB[r8.w].data[7].z << (32-(9 + 16)); r14.w = (uint)r14.w >> (32-9);        } else r14.w = (uint)refProbeConstantsCB[r8.w].data[7].z >> 16;
        r29.w = (uint)r14.w;
        r27.xzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r29.xyzw, r10.w).xyz;
        r32.xyz = (int3)r27.xzw & int3(-2147483648,-2147483648,-2147483648);
        r32.xyz = cmp((int3)r32.xyz == int3(2139095040,2139095040,2139095040));
        r10.w = (int)r32.y | (int)r32.x;
        r10.w = (int)r32.z | (int)r10.w;
        r27.xzw = r10.www ? float3(1,1,0) : r27.xzw;
        r32.x = dot(r18.yzw, r28.xyz);
        r32.y = dot(r18.yzw, r30.xyz);
        r32.z = dot(r18.yzw, r31.xyz);
        r18.yzw = saturate(r32.xyz * refProbeConstantsCB[r8.w].data[3].xyz + float3(0.5,0.5,0.5));
        r32.xy = refProbeConstantsCB[r8.w].data[4].zw * r18.yz;
        r32.z = refProbeConstantsCB[r8.w].data[5].x * r18.w;
        r18.yzw = refProbeConstantsCB[r8.w].data[5].yzw + r32.xyz;
        r29.x = dot(r12.xyz, r28.xyz);
        r29.y = dot(r12.xyz, r30.xyz);
        r29.z = dot(r12.xyz, r31.xyz);
        ...
        r28.xyz = r8.www ? float3(1,1,0) : r28.xyz;
        r29.xyz = r28.xyz * r18.yzw;
        r8.w = dot(r29.xyz, float3(0.212599993,0.715200007,0.0722000003));
        r15.yzw = r18.yzw * r28.xyz + r15.yzw;
        r10.w = r8.w * r3.w;
        r18.yzw = r27.xzw * r9.www;
        r9.w = dot(r18.yzw, float3(0.212599993,0.715200007,0.0722000003));
        r8.w = r3.w * r8.w + r9.w;
        r8.w = r10.w / r8.w;
        r26.xyz = r18.yzw * r8.www + r26.xyz;
      } else {
        r21.x = r16.y;
        r16.yz = r21.xy;
      }
  ...
  r16.yz = r2.xy * float2(0.984375,0.984375) + float2(0.0078125,0.0078125);
  r16.yz = gEnvBRDFGeneric.SampleLevel(samplerLinear_s, r16.yz, 0).xy;
  r18.xyz = r19.xyz * r2.www;
  r19.xyz = r18.xyz * r16.yyy;
  r16.yzw = r18.xyz * r16.zzz;
  r2.y = sqrt(r1.w);
  r2.y = r2.y * 0.5 + 0.5;
  r2.y = r2.y * r2.y;
  r2.w = 0.5 * r2.y;
    ...
    switch (r9.w) {
        ...
        if (r24.w != 0) {
          ...
          if (r24.w != 0) {
            ...
            while (true) {
              ...
              if (r32.w != 0) break;
              r39.y = dot(icb[r31.w+0].yx, r18.xy);
              r39.z = dot(icb[r31.w+0].yx, r18.yz);
          ...
          if (r24.w != 0) {
              ...
              if (r22.x == 0) {
                ...
                if (enableDitheredShadow != 0) {
                  ...
                  while (true) {
                    ...
                    if (r29.w != 0) break;
                    r38.x = dot(icb[r22.z+0].yx, r18.xw);
            ...
            r19.w = dot(r12.xyz, r20.yzw);
            r20.y = abs(r19.w) * r1.z + -abs(r19.w);
            r19.w = abs(r19.w) * r20.y + 1;
      ...
      if (r17.w != 0) {
        ...
        if (r17.w != 0) {
          ...
          r19.w = cmp(0 < r17.w);
          if (r19.w != 0) {
            r19.w = lightConstantsCB[r8.w].data[1].z * r1.z;
            r19.w = r19.w * r13.z;
