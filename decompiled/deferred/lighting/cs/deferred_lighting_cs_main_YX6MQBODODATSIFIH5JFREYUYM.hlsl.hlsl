...
r0.y = samp0[]..swiz;
  ...
  while (true) {
    ...
    if (r13.w != 0) break;
    r13.w = r0.y ? r0.x : r13.y;
    r16.w = cmp((uint)r13.w >= (uint)r12.w);
    r17.w = cmp((uint)r13.w < numRefProbes);
    r16.w = r16.w ? r17.w : 0;
    if (r16.w != 0) {
      r13.w = (int)r13.w * 14;
      if (r3.y != 0) {
      ...
      r23.w = (int)r22.w + 1;
      r15.yzw = -refProbeConstantsCB[r13.w].data[0].xyz + r5.xyz;
      ...
      r24.x = dot(refProbeAttenuationConstantsCB[r19.w].data[1].xyz, r15.yzw);
      r24.x = saturate(refProbeAttenuationConstantsCB[r19.w].data[1].w + r24.x);
      r20.w = r24.x * r20.w;
      r24.x = dot(refProbeAttenuationConstantsCB[r19.w].data[2].xyz, r15.yzw);
      r24.x = saturate(refProbeAttenuationConstantsCB[r19.w].data[2].w + r24.x);
      r20.w = r24.x * r20.w;
      r24.x = dot(refProbeAttenuationConstantsCB[r19.w].data[3].xyz, r15.yzw);
      r24.x = saturate(refProbeAttenuationConstantsCB[r19.w].data[3].w + r24.x);
      r20.w = r24.x * r20.w;
      r24.x = dot(refProbeAttenuationConstantsCB[r19.w].data[4].xyz, r15.yzw);
      r24.x = saturate(refProbeAttenuationConstantsCB[r19.w].data[4].w + r24.x);
      r20.w = r24.x * r20.w;
      r24.x = dot(refProbeAttenuationConstantsCB[r19.w].data[5].xyz, r15.yzw);
      r19.w = saturate(refProbeAttenuationConstantsCB[r19.w].data[5].w + r24.x);
      r16.x = r20.w * r19.w;
      r19.w = 1 & (int)refProbeConstantsCB[r13.w].data[6].x;
      r24.xy = r19.ww ? r16.xy : r16.zx;
      ...
      while (true) {
        ...
        r25.x = r24.z * r20.w;
        r24.w = (uint)r16.x >> 2;
        if (1 == 0) r25.z = 0; else if (1+2 < 32) {         r25.z = (uint)r16.x << (32-(1 + 2)); r25.z = (uint)r25.z >> (32-1);        } else r25.z = (uint)r16.x >> 2;
        r25.w = (int)r24.w & 2;
        r26.x = max(r25.y, r25.x);
        r20.w = -r24.z * r20.w + 1;
        r20.w = r25.y * r20.w;
        r18.y = r25.w ? r20.w : r26.x;
        r25.xy = r25.zz ? r25.xy : r18.xy;
        r19.w = (int)r19.w + 1;
        r16.x = r24.w;
      }
      ...
      if (r16.w != 0) {
        ...
        r17.w = r3.y ? r17.w : 0;
        if (r17.w != 0) {
          r24.xy = mad((int2)r16.ww, int2(20,20), int2(860,876));
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r16.w, cb2[52].x, r24.x, u2.xxxx
        r16.w = samp0[]..swiz;
          r16.w = (int)r16.w | 32;
        ...
        r22.w = (int)r22.w + 257;
        r22.z = r25.y * refProbeConstantsCB[r13.w].data[6].y + r22.z;
        r16.x = refProbeConstantsCB[r13.w].data[7].y * r16.x;
        r24.x = refProbeConstantsCB[r13.w].data[7].w;
        r24.yz = refProbeConstantsCB[r13.w].data[8].xy;
        r16.w = dot(r14.xyz, r24.xyz);
        r17.w = dot(r15.yzw, r24.xyz);
        ...
        r24.x = refProbeConstantsCB[r13.w].data[8].w;
        r24.yz = refProbeConstantsCB[r13.w].data[9].xy;
        r17.w = dot(r14.xyz, r24.xyz);
        r18.y = dot(r15.yzw, r24.xyz);
        ...
        r24.x = refProbeConstantsCB[r13.w].data[9].w;
        r24.yz = refProbeConstantsCB[r13.w].data[10].xy;
        r17.w = dot(r14.xyz, r24.xyz);
        r18.y = dot(r15.yzw, r24.xyz);
        ...
        r17.w = r18.y / r17.w;
        r16.w = min(abs(r17.w), r16.w);
        r24.x = refProbeConstantsCB[r13.w].data[10].w;
        r24.yz = refProbeConstantsCB[r13.w].data[11].xy;
        r17.w = dot(r14.xyz, r24.xyz);
        r18.y = dot(r15.yzw, r24.xyz);
        ...
        r17.w = r18.y / r17.w;
        r16.w = min(abs(r17.w), r16.w);
        r24.x = refProbeConstantsCB[r13.w].data[11].w;
        r24.yz = refProbeConstantsCB[r13.w].data[12].xy;
        r17.w = dot(r14.xyz, r24.xyz);
        r18.y = dot(r15.yzw, r24.xyz);
        ...
        r17.w = r18.y / r17.w;
        r16.w = min(abs(r17.w), r16.w);
        r24.x = refProbeConstantsCB[r13.w].data[12].w;
        r24.yz = refProbeConstantsCB[r13.w].data[13].xy;
        r17.w = dot(r14.xyz, r24.xyz);
        r18.y = dot(r15.yzw, r24.xyz);
        ...
        r17.w = r18.y / r17.w;
        r16.w = min(abs(r17.w), r16.w);
        r24.x = refProbeConstantsCB[r13.w].data[3].w + r15.y;
        r24.yz = refProbeConstantsCB[r13.w].data[4].xy + r15.zw;
        r24.xyz = r14.xyz * r16.www + r24.xyz;
        ...
        r27.w = (uint)r17.w;
        r24.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r27.xyzw, r16.w).xyz;
        r25.xzw = (int3)r24.xyz & int3(-2147483648,-2147483648,-2147483648);
        r25.xzw = cmp((int3)r25.xzw == int3(2139095040,2139095040,2139095040));
        r16.w = (int)r25.z | (int)r25.x;
        r16.w = (int)r25.w | (int)r16.w;
        r24.xyz = r16.www ? float3(1,1,0) : r24.xyz;
        r30.x = dot(r15.yzw, r26.xyz);
        r30.y = dot(r15.yzw, r28.xyz);
        r30.z = dot(r15.yzw, r29.xyz);
        r15.yzw = saturate(r30.xyz * refProbeConstantsCB[r13.w].data[3].xyz + float3(0.5,0.5,0.5));
        r30.xy = refProbeConstantsCB[r13.w].data[4].zw * r15.yz;
        r30.z = refProbeConstantsCB[r13.w].data[5].x * r15.w;
        r15.yzw = refProbeConstantsCB[r13.w].data[5].yzw + r30.xyz;
        r27.x = dot(r11.xyz, r26.xyz);
        r27.y = dot(r11.xyz, r28.xyz);
        r27.z = dot(r11.xyz, r29.xyz);
        r25.xzw = cmp(float3(0,0,0) < r27.xyz);
        r17.z = r25.x ? 0 : 0.5;
        r26.xyz = r17.xyz + r15.yzw;
        r26.xyz = gProbeXArray.SampleLevel(samplerLinearClamp_s, r26.xyz, 0).xyz;
        r28.xyz = r27.xyz * r27.xyz;
        r28.xyz = r28.xyz * r16.xxx;
        r19.z = r25.z ? 0 : 0.5;
        r29.xyz = r19.xyz + r15.yzw;
        ...
        r15.yzw = r15.yzw * r28.zzz + r26.xyz;
        ...
        r25.xzw = r13.www ? float3(1,1,0) : r25.xzw;
        r26.xyz = r25.xzw * r15.yzw;
        r13.w = dot(r26.xyz, float3(0.212599993,0.715200007,0.0722000003));
        r21.xyz = r15.yzw * r25.xzw + r21.xyz;
        r15.y = r13.w * r10.w;
        r24.xyz = r24.xyz * r16.xxx;
        r15.z = dot(r24.xyz, float3(0.212599993,0.715200007,0.0722000003));
        r13.w = r10.w * r13.w + r15.z;
        r13.w = r15.y / r13.w;
        r26.x = r21.w;
        r26.yz = r22.xy;
        r15.yzw = r24.xyz * r13.www + r26.xyz;
        r21.w = r15.y;
        r22.xy = r15.zw;
      } else {
        r23.xyz = r22.xyz;
  ...
  while (true) {
    ...
    if (r16.w != 0) {
      ...
      while (true) {
        ...
        r26.x = r23.w * r20.w;
        r24.w = (uint)r16.x >> 2;
        if (1 == 0) r26.z = 0; else if (1+2 < 32) {         r26.z = (uint)r16.x << (32-(1 + 2)); r26.z = (uint)r26.z >> (32-1);        } else r26.z = (uint)r16.x >> 2;
        r26.w = (int)r24.w & 2;
        r27.x = max(r26.y, r26.x);
        r20.w = -r23.w * r20.w + 1;
        r20.w = r26.y * r20.w;
        r18.w = r26.w ? r20.w : r27.x;
        r26.xy = r26.zz ? r26.xy : r18.zw;
        r19.w = (int)r19.w + 1;
        r16.x = r24.w;
      }
      r16.x = saturate(r26.y + -r22.z);
      r16.w = refProbeConstantsCB[r13.w].data[6].y * r16.x;
      r17.w = cmp(0 < r16.w);
      if (r17.w != 0) {
        r17.w = (int)r25.y & 31;
        r18.w = (int)r17.w + -1;
        ...
        r18.y = (int)r18.y + 257;
        r18.x = r16.x * refProbeConstantsCB[r13.w].data[6].y + r18.x;
        r16.x = refProbeConstantsCB[r13.w].data[7].y * r16.w;
        r27.x = refProbeConstantsCB[r13.w].data[7].w;
        r27.yz = refProbeConstantsCB[r13.w].data[8].xy;
        r16.w = dot(r14.xyz, r27.xyz);
        ...
        r17.w = dot(r14.xyz, r27.xyz);
        r18.w = dot(r15.yzw, r27.xyz);
        r18.w = -refProbeConstantsCB[r13.w].data[9].z + r18.w;
        r19.w = cmp(r18.w >= 0);
        ...
        r17.w = dot(r14.xyz, r27.xyz);
        r18.w = dot(r15.yzw, r27.xyz);
        r18.w = -refProbeConstantsCB[r13.w].data[10].z + r18.w;
        r19.w = cmp(r18.w >= 0);
        r18.w = max(abs(r18.w), r9.w);
        r18.w = r19.w ? r18.w : -r18.w;
        r17.w = max(1.00000001e-07, -r17.w);
        ...
        r17.w = dot(r14.xyz, r27.xyz);
        r18.w = dot(r15.yzw, r27.xyz);
        r18.w = -refProbeConstantsCB[r13.w].data[11].z + r18.w;
        r19.w = cmp(r18.w >= 0);
        r18.w = max(abs(r18.w), r9.w);
        r18.w = r19.w ? r18.w : -r18.w;
        r17.w = max(1.00000001e-07, -r17.w);
        ...
        r17.w = dot(r14.xyz, r27.xyz);
        r18.w = dot(r15.yzw, r27.xyz);
        r18.w = -refProbeConstantsCB[r13.w].data[12].z + r18.w;
        r19.w = cmp(r18.w >= 0);
        r18.w = max(abs(r18.w), r9.w);
        r18.w = r19.w ? r18.w : -r18.w;
        r17.w = max(1.00000001e-07, -r17.w);
        ...
        r17.w = dot(r14.xyz, r27.xyz);
        r18.w = dot(r15.yzw, r27.xyz);
        r18.w = -refProbeConstantsCB[r13.w].data[13].z + r18.w;
        r19.w = cmp(r18.w >= 0);
        r18.w = max(abs(r18.w), r9.w);
        r18.w = r19.w ? r18.w : -r18.w;
        r17.w = max(1.00000001e-07, -r17.w);
        r17.w = r18.w / r17.w;
        r16.w = min(abs(r17.w), r16.w);
        r27.x = refProbeConstantsCB[r13.w].data[3].w + r15.y;
        r27.yz = refProbeConstantsCB[r13.w].data[4].xy + r15.zw;
        r26.xzw = r14.xyz * r16.www + r27.xyz;
        ...
        if (9 == 0) r17.w = 0; else if (9+16 < 32) {         r17.w = (uint)refProbeConstantsCB[r13.w].data[7].z << (32-(9 + 16)); r17.w = (uint)r17.w >> (32-9);        } else r17.w = (uint)refProbeConstantsCB[r13.w].data[7].z >> 16;
        r28.w = (uint)r17.w;
        r26.xzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r28.xyzw, r16.w).xyz;
        ...
        r26.xzw = r16.www ? float3(1,1,0) : r26.xzw;
        r31.x = dot(r15.yzw, r27.xyz);
        r31.y = dot(r15.yzw, r29.xyz);
        r31.z = dot(r15.yzw, r30.xyz);
        r15.yzw = saturate(r31.xyz * refProbeConstantsCB[r13.w].data[3].xyz + float3(0.5,0.5,0.5));
        r31.xy = refProbeConstantsCB[r13.w].data[4].zw * r15.yz;
        r31.z = refProbeConstantsCB[r13.w].data[5].x * r15.w;
        r15.yzw = refProbeConstantsCB[r13.w].data[5].yzw + r31.xyz;
        ...
        r15.y = r13.w * r10.w;
        r26.xzw = r26.xzw * r16.xxx;
        r15.z = dot(r26.xzw, float3(0.212599993,0.715200007,0.0722000003));
        r13.w = r10.w * r13.w + r15.z;
        r13.w = r15.y / r13.w;
        r24.xyz = r26.xzw * r13.www + r24.xyz;
      } else {
        r25.x = r18.x;
        r18.xy = r25.xy;
      }
  ...
  if (r6.w != 0) {
    ...
    r14.w = 0;
    r17.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r14.xyzw, r8.w).xyz;
  ...
  if (r4.z != 0) {
    ...
    if (r4.z != 0) {
      ...
      if (r8.w != 0) {
        ...
        r20.x = lightConstantsCB[r6.w].data[9].w + r13.y;
        r20.y = lightConstantsCB[r6.w].data[10].x + r13.w;
        r13.yw = lightConstantsCB[r6.w].data[9].yz * r20.xy;
        r20.xy = lightConstantsCB[r6.w].data[3].yy / lightConstantsCB[r6.w].data[8].yw;
        ...
        if (r8.w == 0) {
          ...
          r19.x = r13.y * lightConstantsCB[r6.w].data[8].y + lightConstantsCB[r6.w].data[8].z;
          r19.y = r13.w * lightConstantsCB[r6.w].data[8].w + lightConstantsCB[r6.w].data[9].x;
      ...
      r20.xyz = -r5.xyz * r1.www + sunConstants.wldDir.xyz;
      r1.w = dot(r20.xyz, r20.xyz);
      r1.w = rsqrt(r1.w);
      r20.xyz = r20.xyz * r1.www;
      r1.w = dot(r20.xyz, r12.xyz);
      r6.w = dot(r11.xyz, r20.xyz);
      r8.w = abs(r6.w) * r2.z + -abs(r6.w);
      ...
      r3.w = r7.w * r3.w;
      r3.w = 0.25 * r3.w;
      r20.xyz = r3.www * r18.xyz + r16.xyz;
      r1.w = saturate(1 + -r1.w);
      r4.z = r1.w * r1.w;
      r4.z = r4.z * r4.z;
      r1.w = r4.z * r1.w;
      r1.w = r3.w * r1.w;
      r18.xyz = r1.www * r18.yzx + r17.xyz;
      r19.w = r18.z;
      r15.w = r17.z;
      r15.xyzw = r3.zzzz ? r19.xyzw : r15.xyzw;
      r18.zw = r20.xy;
      r17.zw = r16.xy;
      r18.xyzw = r3.zzzz ? r18.xyzw : r17.xyzw;
      r16.z = r3.z ? r20.z : r16.z;
      if (r3.y != 0) {
      // Known bad code for instruction (needs manual fix):
  ...
  r3.z = (int)r13.z * 15;
  if (3 == 0) r3.w = 0; else if (3+24 < 32) {   r3.w = (uint)lightConstantsCB[r3.z].data[1].w << (32-(3 + 24)); r3.w = (uint)r3.w >> (32-3);  } else r3.w = (uint)lightConstantsCB[r3.z].data[1].w >> 24;
  switch (r3.w) {
    case 4 :    if (r3.y != 0) {
      r18.yzw = lightConstantsCB[r3.z].data[0].xyz + eyeOffset.xyz;
      r18.x = 2;
      GBufferDiffuseColor[viewID].136 = u2.xyzw;
    }
    r3.w = (int)r1.w + 1;
    r4.z = cmp(0 < lightConstantsCB[r3.z].data[6].y);
    r18.xy = lightConstantsCB[r3.z].data[5].zw;
    r18.z = lightConstantsCB[r3.z].data[6].x;
    r13.yzw = -r18.xyz * float3(0.5,0.5,0.5) + lightConstantsCB[r3.z].data[0].xyz;
    r19.xyz = r13.yzw + -r5.xyz;
    r6.w = dot(r18.xyz, r19.xyz);
    r7.w = saturate(-r6.w / lightConstantsCB[r3.z].data[6].y);
    r20.xyz = r7.www * r18.xyz + r13.yzw;
    r20.xyz = r4.zzz ? r20.xyz : lightConstantsCB[r3.z].data[0].xyz;
    ...
    if (r11.w != 0) {
      ...
      r8.w = r12.w / r8.w;
      r8.w = min(1, r8.w);
      r20.xy = saturate(r11.ww * lightConstantsCB[r3.z].data[2].xz + lightConstantsCB[r3.z].data[2].yw);
      ...
      r11.w = cmp(0 < r8.w);
      if (r11.w != 0) {
        if (3 == 0) r11.w = 0; else if (3+27 < 32) {         r11.w = (uint)lightConstantsCB[r3.z].data[1].w << (32-(3 + 27)); r11.w = (uint)r11.w >> (32-3);        } else r11.w = (uint)lightConstantsCB[r3.z].data[1].w >> 27;
        if (r3.y != 0) {
        // Known bad code for instruction (needs manual fix):
        ...
        if (r11.w != 0) {
          ...
          r20.yzw = -lightConstantsCB[r3.z].data[4].yzw + r20.yzw;
          r11.w = max(abs(r20.z), abs(r20.w));
          r11.w = max(abs(r20.y), r11.w);
          r11.w = lightConstantsCB[r3.z].data[5].x / r11.w;
          r11.w = lightConstantsCB[r3.z].data[5].y + r11.w;
          r14.w = dot(r20.yzw, r20.yzw);
          r14.w = rsqrt(r14.w);
          r11.w = max(6.10351563e-05, r11.w);
          r15.w = 0x0000ffff & (int)lightConstantsCB[r3.z].data[1].w;
          r22.x = -r3.x;
          r23.w = (uint)r15.w;
          r22.y = r13.x;
          r22.z = r3.x;
          ...
          while (true) {
            ...
            r24.yz = lightConstantsCB[r3.z].data[3].yy * r21.yz;
            r24.x = r24.y * r21.x;
            r24.w = r24.y * r20.x;
        ...
        if (r11.w != 0) {
          ...
          r14.y = -r14.w * r14.w + lightConstantsCB[r3.z].data[6].y;
          ...
          r13.yzw = r6.www * r18.xyz + r13.yzw;
          r13.yzw = r4.zzz ? r13.yzw : lightConstantsCB[r3.z].data[0].xyz;
          r13.yzw = r13.yzw + -r5.xyz;
          r4.z = dot(r13.yzw, r13.yzw);
          r4.z = rsqrt(r4.z);
          r14.xyz = r13.yzw * r4.zzz;
          if (4 == 0) r6.w = 0; else if (4+16 < 32) {           r6.w = (uint)lightConstantsCB[r3.z].data[1].w << (32-(4 + 16)); r6.w = (uint)r6.w >> (32-4);          } else r6.w = (uint)lightConstantsCB[r3.z].data[1].w >> 16;
          ...
          if (r7.w != 0) {
            ...
            if (4 == 0) r6.w = 0; else if (4+20 < 32) {             r6.w = (uint)lightConstantsCB[r3.z].data[1].w << (32-(4 + 20)); r6.w = (uint)r6.w >> (32-4);            } else r6.w = (uint)lightConstantsCB[r3.z].data[1].w >> 20;
            r7.w = cmp(0 < (uint)r6.w);
            r14.w = ~(int)r1.z;
            r7.w = r7.w ? r14.w : 0;
            if (r7.w != 0) {
          ...
          r6.w = r6.w * r8.w;
          r18.x = lightConstantsCB[r3.z].data[0].w;
          r18.yz = lightConstantsCB[r3.z].data[1].xy;
          r7.w = cmp(0 < r9.w);
          r19.xyz = r6.www * r18.xyz + r15.xyz;
          ...
          r6.w = r9.w * r6.w;
          r6.w = r6.w * r8.w;
          r13.yzw = r6.www * r18.xyz + r16.xyz;
          r4.z = saturate(1 + -r4.z);
          r9.w = r4.z * r4.z;
          r9.w = r9.w * r9.w;
          r4.z = r9.w * r4.z;
          r4.z = r6.w * r4.z;
          r14.xyz = r4.zzz * r18.xyz + r17.zxy;
          r15.xyz = r7.www ? r19.xyz : r15.xyz;
          r17.xyz = r7.www ? r14.yzx : r17.xyz;
    ...
    r8.w = cmp(0 < r7.w);
    if (r8.w != 0) {
      r18.xyz = lightConstantsCB[r3.z].data[7].yzw;
      r18.w = lightConstantsCB[r3.z].data[8].x;
      r5.w = 1;
      r8.w = dot(r18.xyzw, r5.xyzw);
      r9.w = cmp(r8.w < 1);
      if (r9.w != 0) {
        r13.yzw = float3(1,1,1);
        r9.w = 0;
      } else {
        r19.xyz = lightConstantsCB[r3.z].data[0].xyz + -r5.xyz;
        r10.w = lightConstantsCB[r3.z].data[3].x * lightConstantsCB[r3.z].data[3].x;
        r11.w = dot(r19.xyz, r19.xyz);
        r10.w = r10.w / r11.w;
        r10.w = min(1, r10.w);
        r19.xy = saturate(r8.ww * lightConstantsCB[r3.z].data[2].xz + lightConstantsCB[r3.z].data[2].yw);
        r19.zw = r19.xy * r19.xy;
        r19.xy = r19.xy * float2(-2,-2) + float2(3,3);
        r19.xy = r19.zw * r19.xy;
        r10.w = r19.x * r10.w;
        r10.w = r10.w * r19.y;
        r19.xyz = lightConstantsCB[r3.z].data[4].yzw;
        r19.w = lightConstantsCB[r3.z].data[5].x;
        r19.x = dot(r19.xyzw, r5.xyzw);
        r20.xyz = lightConstantsCB[r3.z].data[5].yzw;
        r20.w = lightConstantsCB[r3.z].data[6].x;
        r19.y = dot(r20.xyzw, r5.xyzw);
        r19.xy = r19.xy / r8.ww;
        r5.w = cmp(lightConstantsCB[r3.z].data[10].w < 0.00048828125);
        if (r5.w != 0) {
          r20.xy = saturate(abs(r19.xy) * lightConstantsCB[r3.z].data[12].xy + lightConstantsCB[r3.z].data[12].zw);
          r20.zw = r20.xy * r20.xy;
          r20.xy = r20.xy * float2(-2,-2) + float2(3,3);
          r20.xy = r20.zw * r20.xy;
          r5.w = r20.x * r20.y;
        } else {
          r20.xyzw = saturate(lightConstantsCB[r3.z].data[11].xyzw * abs(r19.yyxx));
          r20.xyzw = log2(r20.xyzw);
          r20.xyzw = lightConstantsCB[r3.z].data[12].zzzz * r20.xyzw;
          r20.xyzw = exp2(r20.xyzw);
          r20.xy = r20.xy + r20.zw;
          r20.xy = log2(r20.xy);
          r20.xy = lightConstantsCB[r3.z].data[12].ww * r20.xy;
          r20.xy = exp2(r20.xy);
          r8.w = lightConstantsCB[r3.z].data[12].x * r20.x;
          r11.w = lightConstantsCB[r3.z].data[12].y * r20.y + -1;
          r8.w = lightConstantsCB[r3.z].data[12].y * r20.y + -r8.w;
        ...
        if (r5.w != 0) {
          r19.z = 1;
          r8.w = dot(lightConstantsCB[r3.z].data[13].xyz, r19.xyz);
          r20.x = lightConstantsCB[r3.z].data[13].w;
          r20.yz = lightConstantsCB[r3.z].data[14].xy;
      ...
      r19.x = lightConstantsCB[r3.z].data[0].w;
      r19.yz = lightConstantsCB[r3.z].data[1].xy;
      ...
      if (r5.w != 0) {
        ...
        if (r5.w != 0) {
          ...
          r20.xyz = lightConstantsCB[r3.z].data[6].yzw;
          r20.w = lightConstantsCB[r3.z].data[7].x;
          r19.w = 1;
          r5.w = dot(r20.xyzw, r19.xyzw);
          r10.w = dot(r18.xyzw, r19.xyzw);
          r11.w = cmp(r10.w >= r5.w);
          if (r11.w != 0) {
            r18.xyz = lightConstantsCB[r3.z].data[4].yzw;
            r18.w = lightConstantsCB[r3.z].data[5].x;
            ...
            r19.x = r18.x * lightConstantsCB[r3.z].data[8].y + lightConstantsCB[r3.z].data[8].z;
            r19.y = r18.y * lightConstantsCB[r3.z].data[8].w + lightConstantsCB[r3.z].data[9].x;
            r5.w = r5.w / r10.w;
            r5.w = max(6.10351563e-05, r5.w);
            r10.w = 0x0000ffff & (int)lightConstantsCB[r3.z].data[1].w;
            if (enableDitheredShadow != 0) {
              r18.x = -r3.x;
              r20.z = (uint)r10.w;
              r18.y = r13.x;
              ...
              while (true) {
                ...
                r20.xy = r21.xy * lightConstantsCB[r3.z].data[3].yy + r19.xy;
        ...
        r9.w = cmp(0 < r5.w);
        if (r9.w != 0) {
          r9.w = lightConstantsCB[r3.z].data[1].z * r2.z;
          r9.w = r9.w * r7.w;
          if (4 == 0) r10.w = 0; else if (4+16 < 32) {           r10.w = (uint)lightConstantsCB[r3.z].data[1].w << (32-(4 + 16)); r10.w = (uint)r10.w >> (32-4);          } else r10.w = (uint)lightConstantsCB[r3.z].data[1].w >> 16;
          ...
          if (r11.w != 0) {
            ...
            r18.xyz = r11.xyz * r11.www + r5.xyz;
            ...
            if (r14.w == 0) {
              ...
              r18.xy = r18.xy * float2(0.5,-0.5) + float2(0.5,0.5);
              r19.x = lightConstantsCB[r10.w].data[9].w + r18.x;
              r19.y = lightConstantsCB[r10.w].data[10].x + r18.y;
              r18.xy = lightConstantsCB[r10.w].data[9].yz * r19.xy;
              r18.zw = lightConstantsCB[r10.w].data[3].yy / lightConstantsCB[r10.w].data[8].yw;
              r19.xy = float2(1,1) + -r18.zw;
              r19.xy = cmp(r18.xy >= r19.xy);
              r18.zw = cmp(r18.zw >= r18.xy);
              r18.zw = (int2)r18.zw | (int2)r19.xy;
              ...
              if (r15.w == 0) {
                r18.xy = saturate(r18.xy);
                r19.x = r18.x * lightConstantsCB[r10.w].data[8].y + lightConstantsCB[r10.w].data[8].z;
                r19.y = r18.y * lightConstantsCB[r10.w].data[8].w + lightConstantsCB[r10.w].data[9].x;
                r16.w = lightConstantsCB[r10.w].data[10].z * r12.w;
            ...
            r10.w = cmp(0 < (uint)r3.z);
            r1.z = ~(int)r1.z;
            r1.z = r10.w ? r1.z : 0;
            if (r1.z != 0) {
              r1.z = (int)r3.z + numLights;
              r1.z = mad((int)r1.z, 15, -15);
              r3.z = abs(r6.w) * -0.200000003 + 0.400000006;
              r18.xyz = r11.xyz * r3.zzz + r5.xyz;
              r19.xyz = lightConstantsCB[r1.z].data[6].yzw;
              r19.w = lightConstantsCB[r1.z].data[7].x;
              r18.w = 1;
              r3.z = dot(r19.xyzw, r18.xyzw);
              r19.xyz = lightConstantsCB[r1.z].data[7].yzw;
              r19.w = lightConstantsCB[r1.z].data[8].x;
              r10.w = dot(r19.xyzw, r18.xyzw);
              r11.w = cmp(r10.w < r3.z);
              if (r11.w == 0) {
                r19.xyz = lightConstantsCB[r1.z].data[4].yzw;
                r19.w = lightConstantsCB[r1.z].data[5].x;
                r19.x = dot(r19.xyzw, r18.xyzw);
                r20.xyz = lightConstantsCB[r1.z].data[5].yzw;
                r20.w = lightConstantsCB[r1.z].data[6].x;
                r19.y = dot(r20.xyzw, r18.xyzw);
                ...
                if (r12.w == 0) {
                  r18.xy = saturate(r18.xy);
                  r19.x = r18.x * lightConstantsCB[r1.z].data[8].y + lightConstantsCB[r1.z].data[8].z;
                  r19.y = r18.y * lightConstantsCB[r1.z].data[8].w + lightConstantsCB[r1.z].data[9].x;
                  r14.w = lightConstantsCB[r1.z].data[10].z * r10.w;
                  r3.z = lightConstantsCB[r1.z].data[10].y * r10.w + r3.z;
                  r3.z = r3.z / r14.w;
                }
              } else {
                r12.w = -1;
              ...
              if (r10.w == 0) {
                ...
                r10.w = 0x0000ffff & (int)lightConstantsCB[r1.z].data[1].w;
                if (enableDitheredShadow != 0) {
                  r18.x = -r3.x;
                  r20.z = (uint)r10.w;
                  r18.y = r13.x;
                  ...
                  while (true) {
                    ...
                    r20.xy = r21.xy * lightConstantsCB[r1.z].data[3].yy + r19.xy;
                    r12.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r20.xyz, r3.z).x;
                    r3.x = r12.w * 0.125 + r3.x;
                    r11.w = (int)r11.w + 1;
                  }
                } else {
                  r19.z = (uint)r10.w;
                  r3.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r19.xyz, r3.z).x;
                }
                r1.z = r3.x * r3.x;
                r1.z = r1.z * r3.x;
              } else {
          ...
          r1.z = r1.z * r5.w;
          r2.x = cmp(0 < r6.w);
          r18.xyz = r1.zzz * r13.yzw + r15.xyz;
          ...
          r0.y = r5.w * r0.y;
          r0.y = 0.25 * r0.y;
          r2.yzw = r0.yyy * r13.yzw + r16.xyz;
          r1.z = saturate(1 + -r1.z);
          r3.x = r1.z * r1.z;
          r3.x = r3.x * r3.x;
          r1.z = r3.x * r1.z;
          r0.y = r1.z * r0.y;
          r11.xyz = r0.yyy * r13.yzw + r17.zxy;
          r15.xyz = r2.xxx ? r18.xyz : r15.xyz;
          r17.xyz = r2.xxx ? r11.yzx : r17.xyz;
          r16.xyz = r2.xxx ? r2.yzw : r16.xyz;
          if (r3.y != 0) {
          // Known bad code for instruction (needs manual fix):
