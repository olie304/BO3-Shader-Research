...
mul r14.xyz, r4.wwww, r14.xyzx
mul r17.xzw, r17.xxxx, r14.xxyz
mul r14.xyz, r17.yyyy, r14.xyzx
if_nz r2.z
  mov r18.x, l(3)
...
if_nz r2.y
  ...
  if_nz r2.y
      ...
      if_z r9.w
        ...
        if_nz cb2[58].y
          ...
          loop 
            ...
            sample_c_lz_indexable(texture2darray)(float,float,float,float) r14.w, r21.xyzx, t9.xxxx, s13, r9.w
    ...
    mad r2.xyw, r1.zzzz, r18.xyxz, r14.xyxz
    ...
    mad r11.xyz, r0.zzzz, r18.xyzx, r16.xyzx
    and r11.xyz, r3.zzzz, r11.xyzx
    movc r15.xyz, r1.wwww, r13.xyzx, r15.xyzx
    movc r16.xyz, r1.wwww, r16.xyzx, r11.xyzx
    movc r17.xzw, r1.wwww, r4.xxyz, r17.xxzw
...
add r4.x, r2.y, r4.z
mul r2.xyw, r5.yzyw, r15.xyxz
mad r2.xyw, r16.xyxz, r4.xyxz, r2.xyxw
mul r3.xyw, r17.xzxw, l(0.960000, 0.960000, 0.000000, 0.960000)
mad r3.xyw, r14.xyxz, l(0.040000, 0.040000, 0.000000, 0.040000), r3.xyxw
add r2.xyw, r2.xyxw, r3.xyxw
add r3.xyw, -r4.xyxz, l(1.000000, 1.000000, 0.000000, 1.000000)
mul r3.xyw, r3.xyxw, r17.xzxw
mad r3.xyw, r14.xyxz, r4.xyxz, r3.xyxw
mad r3.xyw, r15.xyxz, r5.yzyw, r3.xyxw
...
ret 
// Approximately 880 instruction slots used
