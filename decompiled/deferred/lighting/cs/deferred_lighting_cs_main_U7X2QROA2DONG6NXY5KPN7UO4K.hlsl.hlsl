...
r0.y = samp0[]..swiz;
  ...
  r8.w = dot(r14.xyz, float3(0.212599993,0.715200007,0.0722000003));
  r13.w = 0;
  ...
  r15.xyz = r14.xyz * r3.zzz;
  r16.xyz = r0.www ? r15.xyz : 0;
  ...
  r13.xyz = r13.xyz * r6.www;
  r17.xzw = r13.xyz * r17.xxx;
  r13.xyz = r13.xyz * r17.yyy;
  if (r2.w != 0) {
    r18.x = 3;
  ...
  if (r2.y != 0) {
    ...
    if (r2.y != 0) {
        ...
        if (r10.w == 0) {
          ...
          if (enableDitheredShadow != 0) {
            ...
            while (true) {
              ...
              r14.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r21.xyz, r10.w).x;
      ...
      r1.w = r7.w * r1.w;
      r1.w = 0.25 * r1.w;
      r11.xyz = r1.www * r18.xyz + r13.xyz;
      r0.z = saturate(1 + -r0.z);
      r2.y = r0.z * r0.z;
      r2.y = r2.y * r2.y;
      r0.z = r2.y * r0.z;
      r0.z = r1.w * r0.z;
      r12.xyz = r0.zzz * r18.xyz + r17.xzw;
      r14.xyz = r1.zzz * r18.xyz + r16.xyz;
      r14.xyz = r0.www ? r14.xyz : 0;
      r15.xyz = r2.xxx ? r4.xyw : r15.xyz;
      r16.xyz = r2.xxx ? r16.xyz : r14.xyz;
      r17.xzw = r2.xxx ? r12.xyz : r17.xzw;
      r13.xyz = r2.xxx ? r11.xyz : r13.xyz;
      if (r2.w != 0) {
      // Known bad code for instruction (needs manual fix):
  ...
  r3.z = -r2.y * 0.5 + r1.z;
  r3.x = r3.z + r2.y;
  r2.xyz = r15.xyz * r5.yzw;
  r2.xyz = r16.xyz * r3.xyz + r2.xyz;
  r4.xyz = float3(0.959999979,0.959999979,0.959999979) * r17.xzw;
  r4.xyz = r13.xyz * float3(0.0399999991,0.0399999991,0.0399999991) + r4.xyz;
  r2.xyz = r4.xyz + r2.xyz;
  r4.xyz = float3(1,1,1) + -r3.xyz;
  r4.xyz = r17.xzw * r4.xyz;
  r3.xyz = r13.xyz * r3.xyz + r4.xyz;
  r3.xyz = r15.xyz * r5.yzw + r3.xyz;
