...
r0.y = samp0[]..swiz;
  ...
  if (r10.w != 0) {
    r10.w = (int)r0.y * 14;
    if (r2.w != 0) {
      r15.yzw = refProbeConstantsCB[r10.w].data[0].xyz + eyeOffset.xyz;
      r15.x = 16;
      GBufferDiffuseColor[viewID].880 = u2.xyzw;
    }
    r13.yzw = -refProbeConstantsCB[r10.w].data[0].xyz + r5.yzw;
    r12.w = 0x0000ffff & (int)refProbeConstantsCB[r10.w].data[7].z;
    if (6 == 0) r15.x = 0; else if (6+25 < 32) {     r15.x = (uint)refProbeConstantsCB[r10.w].data[7].z << (32-(6 + 25)); r15.x = (uint)r15.x >> (32-6);    } else r15.x = (uint)refProbeConstantsCB[r10.w].data[7].z >> 25;
    r15.y = (int)r12.w * 6;
    r15.z = dot(refProbeAttenuationConstantsCB[r15.y].data[0].xyz, r13.yzw);
    r15.z = saturate(refProbeAttenuationConstantsCB[r15.y].data[0].w + r15.z);
    r15.w = dot(refProbeAttenuationConstantsCB[r15.y].data[1].xyz, r13.yzw);
    r15.w = saturate(refProbeAttenuationConstantsCB[r15.y].data[1].w + r15.w);
    r15.z = r15.z * r15.w;
    r15.w = dot(refProbeAttenuationConstantsCB[r15.y].data[2].xyz, r13.yzw);
    r15.w = saturate(refProbeAttenuationConstantsCB[r15.y].data[2].w + r15.w);
    r15.z = r15.z * r15.w;
    r15.w = dot(refProbeAttenuationConstantsCB[r15.y].data[3].xyz, r13.yzw);
    r15.w = saturate(refProbeAttenuationConstantsCB[r15.y].data[3].w + r15.w);
    r15.z = r15.z * r15.w;
    r15.w = dot(refProbeAttenuationConstantsCB[r15.y].data[4].xyz, r13.yzw);
    r15.w = saturate(refProbeAttenuationConstantsCB[r15.y].data[4].w + r15.w);
    r15.z = r15.z * r15.w;
    r15.w = dot(refProbeAttenuationConstantsCB[r15.y].data[5].xyz, r13.yzw);
    r15.y = saturate(refProbeAttenuationConstantsCB[r15.y].data[5].w + r15.w);
    r16.x = r15.z * r15.y;
    r15.y = 1 & (int)refProbeConstantsCB[r10.w].data[6].x;
    r16.yz = float2(0,1);
    r15.yz = r15.yy ? r16.xy : r16.zx;
    r16.x = 1;
    r15.w = refProbeConstantsCB[r10.w].data[6].x;
    r17.xy = r15.yz;
    r16.z = 1;
    while (true) {
      ...
      r17.x = r17.z * r16.w;
      r17.w = (uint)r15.w >> 2;
      if (1 == 0) r18.x = 0; else if (1+2 < 32) {       r18.x = (uint)r15.w << (32-(1 + 2)); r18.x = (uint)r18.x >> (32-1);      } else r18.x = (uint)r15.w >> 2;
      r18.y = (int)r17.w & 2;
    ...
    if (r15.x != 0) {
      ...
      r15.x = refProbeConstantsCB[r10.w].data[7].y * r12.w;
      ...
      r16.xyz = r14.xyz * r15.yyy + r16.xyz;
      ...
      r18.w = (uint)r15.z;
      r15.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r18.xyzw, r15.y).xyz;
      r16.xyz = (int3)r15.yzw & int3(-2147483648,-2147483648,-2147483648);
      r16.xyz = cmp((int3)r16.xyz == int3(2139095040,2139095040,2139095040));
      r16.x = (int)r16.y | (int)r16.x;
      r16.x = (int)r16.z | (int)r16.x;
      r15.yzw = r16.xxx ? float3(1,1,0) : r15.yzw;
      r16.x = dot(r13.yzw, r17.xyz);
      r16.y = dot(r13.yzw, r19.xyz);
      r16.z = dot(r13.yzw, r20.xyz);
      r13.yzw = saturate(r16.xyz * refProbeConstantsCB[r10.w].data[3].xyz + float3(0.5,0.5,0.5));
      r16.xy = refProbeConstantsCB[r10.w].data[4].zw * r13.yz;
      r16.z = refProbeConstantsCB[r10.w].data[5].x * r13.w;
      r13.yzw = refProbeConstantsCB[r10.w].data[5].yzw + r16.xyz;
      ...
      r10.w = (int)r17.z | (int)r10.w;
      r16.xyz = r10.www ? float3(1,1,0) : r16.xyz;
      r13.yzw = r16.xyz * r13.yzw;
      r10.w = dot(r13.yzw, float3(0.212599993,0.715200007,0.0722000003));
      r16.x = r10.w * r8.w;
      r15.xyz = r15.yzw * r15.xxx;
      r15.w = dot(r15.xyz, float3(0.212599993,0.715200007,0.0722000003));
      r10.w = r8.w * r10.w + r15.w;
      r10.w = r16.x / r10.w;
  ...
  if (r9.w != 0) {
    ...
    r9.w = (int)r10.w + 1;
    r16.xyz = -refProbeConstantsCB[r0.y].data[0].xyz + r5.yzw;
    r15.w = 0x0000ffff & (int)refProbeConstantsCB[r0.y].data[7].z;
    ...
    r15.w = saturate(r19.y + -r12.w);
    r16.w = refProbeConstantsCB[r0.y].data[6].y * r15.w;
    r17.x = cmp(0 < r16.w);
    if (r17.x != 0) {
      r17.x = (int)r9.w & 3;
      r17.y = (int)r17.x + -1;
      ...
      r9.w = (int)r10.w + 257;
      r15.w = r15.w * refProbeConstantsCB[r0.y].data[6].y + r12.w;
      ...
      r17.w = cmp(r17.z >= 0);
      r7.w = max(abs(r17.z), r7.w);
      r7.w = r17.w ? r7.w : -r7.w;
      r17.y = max(1.00000001e-07, -r17.y);
      r7.w = r7.w / r17.y;
      r7.w = min(r17.x, abs(r7.w));
      r17.x = refProbeConstantsCB[r0.y].data[3].w + r16.x;
      r17.yz = refProbeConstantsCB[r0.y].data[4].xy + r16.yz;
      r17.xyz = r14.xyz * r7.www + r17.xyz;
      ...
      r19.w = (uint)r7.w;
      r17.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r19.xyzw, r4.z).xyz;
      r22.xyz = (int3)r17.xyz & int3(-2147483648,-2147483648,-2147483648);
      r22.xyz = cmp((int3)r22.xyz == int3(2139095040,2139095040,2139095040));
      r4.z = (int)r22.y | (int)r22.x;
      r4.z = (int)r22.z | (int)r4.z;
      r17.xyz = r4.zzz ? float3(1,1,0) : r17.xyz;
      ...
      r7.w = dot(r16.xyz, float3(0.212599993,0.715200007,0.0722000003));
      r0.y = r8.w * r0.y + r7.w;
      r0.y = r4.z / r0.y;
  ...
  r0.y = cmp(r12.w >= 1);
  bitmask.z = ((~(-1 << 8)) << 0) & 0xffffffff;  r4.z = (((uint)r9.w << 0) & bitmask.z) | ((uint)r10.w & ~bitmask.z);
  r0.y = r0.y ? r4.z : r9.w;
  r4.z = max(1, r15.w);
  r4.z = rcp(r4.z);
  ...
  if (r7.w != 0) {
    ...
    r16.xyz = r13.yzw * r4.zzz + r17.xyz;
    r14.w = 0;
    ...
    r4.z = r2.y * r4.z + r8.w;
    r15.xyz = r13.yzw * r4.zzz + r15.xyz;
  }
  r4.z = r2.x + r5.x;
  r4.z = log2(abs(r4.z));
  r4.z = r4.z * r2.z;
