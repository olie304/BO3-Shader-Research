...
r0.y = samplerLinear[]..swiz;
  ...
  while (true) {
    ...
    if (r9.w != 0) {
      r8.w = (int)r8.w * 14;
      r13.yzw = -refProbeConstantsCB[r8.w].data[0].xyz + r10.xyz;
      ...
      r17.z = dot(refProbeAttenuationConstantsCB[r15.w].data[1].xyz, r13.yzw);
      r17.z = saturate(refProbeAttenuationConstantsCB[r15.w].data[1].w + r17.z);
      r16.w = r17.z * r16.w;
      r17.z = dot(refProbeAttenuationConstantsCB[r15.w].data[2].xyz, r13.yzw);
      r17.z = saturate(refProbeAttenuationConstantsCB[r15.w].data[2].w + r17.z);
      r16.w = r17.z * r16.w;
      r17.z = dot(refProbeAttenuationConstantsCB[r15.w].data[3].xyz, r13.yzw);
      r17.z = saturate(refProbeAttenuationConstantsCB[r15.w].data[3].w + r17.z);
      r16.w = r17.z * r16.w;
      r17.z = dot(refProbeAttenuationConstantsCB[r15.w].data[4].xyz, r13.yzw);
      r17.z = saturate(refProbeAttenuationConstantsCB[r15.w].data[4].w + r17.z);
      r16.w = r17.z * r16.w;
      r17.z = dot(refProbeAttenuationConstantsCB[r15.w].data[5].xyz, r13.yzw);
      r15.w = saturate(refProbeAttenuationConstantsCB[r15.w].data[5].w + r17.z);
      r15.x = r16.w * r15.w;
      r15.w = 1 & (int)refProbeConstantsCB[r8.w].data[6].x;
      r15.xw = r15.ww ? r15.xy : r15.zx;
      r16.w = refProbeConstantsCB[r8.w].data[6].x;
      r22.xy = r15.xw;
      r17.z = 1;
      while (true) {
        ...
        r17.w = (int)r17.w * 6;
        r18.w = dot(refProbeAttenuationConstantsCB[r17.w].data[0].xyz, r13.yzw);
        r18.w = saturate(refProbeAttenuationConstantsCB[r17.w].data[0].w + r18.w);
        r18.w = r22.x * r18.w;
        r19.w = dot(refProbeAttenuationConstantsCB[r17.w].data[1].xyz, r13.yzw);
        r19.w = saturate(refProbeAttenuationConstantsCB[r17.w].data[1].w + r19.w);
        r18.w = r19.w * r18.w;
        r19.w = dot(refProbeAttenuationConstantsCB[r17.w].data[2].xyz, r13.yzw);
        r19.w = saturate(refProbeAttenuationConstantsCB[r17.w].data[2].w + r19.w);
        r18.w = r19.w * r18.w;
        r19.w = dot(refProbeAttenuationConstantsCB[r17.w].data[3].xyz, r13.yzw);
        r19.w = saturate(refProbeAttenuationConstantsCB[r17.w].data[3].w + r19.w);
        r18.w = r19.w * r18.w;
        r19.w = dot(refProbeAttenuationConstantsCB[r17.w].data[4].xyz, r13.yzw);
        r19.w = saturate(refProbeAttenuationConstantsCB[r17.w].data[4].w + r19.w);
        r18.w = r19.w * r18.w;
        r19.w = dot(refProbeAttenuationConstantsCB[r17.w].data[5].xyz, r13.yzw);
        r17.w = saturate(refProbeAttenuationConstantsCB[r17.w].data[5].w + r19.w);
        r22.x = r18.w * r17.w;
        r19.w = (uint)r16.w >> 2;
        if (1 == 0) r22.z = 0; else if (1+2 < 32) {         r22.z = (uint)r16.w << (32-(1 + 2)); r22.z = (uint)r22.z >> (32-1);        } else r22.z = (uint)r16.w >> 2;
        r22.w = (int)r19.w & 2;
        r23.x = max(r22.y, r22.x);
        r17.w = -r18.w * r17.w + 1;
        r17.w = r22.y * r17.w;
        r17.y = r22.w ? r17.w : r23.x;
        r22.xy = r22.zz ? r22.xy : r17.xy;
        r17.z = (int)r17.z + 1;
        r16.w = r19.w;
      }
      r22.y = saturate(r22.y);
      r9.w = refProbeConstantsCB[r8.w].data[6].y * r22.y;
      r12.w = cmp(0 < r9.w);
      if (r12.w != 0) {
        r21.w = r22.y * refProbeConstantsCB[r8.w].data[6].y + r21.w;
        ...
        r12.w = dot(r14.xyz, r23.xyz);
        r15.x = dot(r13.yzw, r23.xyz);
        ...
        r15.w = -refProbeConstantsCB[r8.w].data[9].z + r15.w;
        r16.w = cmp(r15.w >= 0);
        ...
        r15.x = dot(r14.xyz, r23.xyz);
        r15.w = dot(r13.yzw, r23.xyz);
        r15.w = -refProbeConstantsCB[r8.w].data[10].z + r15.w;
        r16.w = cmp(r15.w >= 0);
        r15.w = max(abs(r15.w), r5.w);
        r15.w = r16.w ? r15.w : -r15.w;
        r15.x = max(1.00000001e-07, -r15.x);
        ...
        r15.x = dot(r14.xyz, r23.xyz);
        r15.w = dot(r13.yzw, r23.xyz);
        r15.w = -refProbeConstantsCB[r8.w].data[11].z + r15.w;
        r16.w = cmp(r15.w >= 0);
        r15.w = max(abs(r15.w), r5.w);
        r15.w = r16.w ? r15.w : -r15.w;
        r15.x = max(1.00000001e-07, -r15.x);
        ...
        r15.x = dot(r14.xyz, r23.xyz);
        r15.w = dot(r13.yzw, r23.xyz);
        r15.w = -refProbeConstantsCB[r8.w].data[12].z + r15.w;
        r16.w = cmp(r15.w >= 0);
        r15.w = max(abs(r15.w), r5.w);
        r15.w = r16.w ? r15.w : -r15.w;
        r15.x = max(1.00000001e-07, -r15.x);
        ...
        r15.x = dot(r14.xyz, r23.xyz);
        r15.w = dot(r13.yzw, r23.xyz);
        r15.w = -refProbeConstantsCB[r8.w].data[13].z + r15.w;
        r16.w = cmp(r15.w >= 0);
        r15.w = max(abs(r15.w), r5.w);
        r15.w = r16.w ? r15.w : -r15.w;
        r15.x = max(1.00000001e-07, -r15.x);
        r15.x = r15.w / r15.x;
        r12.w = min(abs(r15.x), r12.w);
        r23.x = refProbeConstantsCB[r8.w].data[3].w + r13.y;
        r23.yz = refProbeConstantsCB[r8.w].data[4].xy + r13.zw;
        r17.yzw = r14.xyz * r12.www + r23.xyz;
        ...
        r24.w = (uint)r15.x;
        r17.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r24.xyzw, r12.w).xyz;
        r27.x = dot(r13.yzw, r23.xyz);
        r27.y = dot(r13.yzw, r25.xyz);
        r27.z = dot(r13.yzw, r26.xyz);
        r13.yzw = saturate(r27.xyz * refProbeConstantsCB[r8.w].data[3].xyz + float3(0.5,0.5,0.5));
        r27.xy = refProbeConstantsCB[r8.w].data[4].zw * r13.yz;
        r27.z = refProbeConstantsCB[r8.w].data[5].x * r13.w;
        r13.yzw = refProbeConstantsCB[r8.w].data[5].yzw + r27.xyz;
  ...
  if (r0.y != 0) {
    ...
    while (true) {
      ...
      if (r9.w != 0) {
        r8.w = (int)r8.w * 14;
        r23.xyz = -refProbeConstantsCB[r8.w].data[0].xyz + r10.xyz;
        r9.w = 0x0000ffff & (int)refProbeConstantsCB[r8.w].data[7].z;
        if (6 == 0) r12.w = 0; else if (6+25 < 32) {         r12.w = (uint)refProbeConstantsCB[r8.w].data[7].z << (32-(6 + 25)); r12.w = (uint)r12.w >> (32-6);        } else r12.w = (uint)refProbeConstantsCB[r8.w].data[7].z >> 25;
        r15.w = (int)r9.w * 6;
        r16.w = dot(refProbeAttenuationConstantsCB[r15.w].data[0].xyz, r23.xyz);
        r16.w = saturate(refProbeAttenuationConstantsCB[r15.w].data[0].w + r16.w);
        r17.z = dot(refProbeAttenuationConstantsCB[r15.w].data[1].xyz, r23.xyz);
        r17.z = saturate(refProbeAttenuationConstantsCB[r15.w].data[1].w + r17.z);
        r16.w = r17.z * r16.w;
        r17.z = dot(refProbeAttenuationConstantsCB[r15.w].data[2].xyz, r23.xyz);
        r17.z = saturate(refProbeAttenuationConstantsCB[r15.w].data[2].w + r17.z);
        r16.w = r17.z * r16.w;
        r17.z = dot(refProbeAttenuationConstantsCB[r15.w].data[3].xyz, r23.xyz);
        r17.z = saturate(refProbeAttenuationConstantsCB[r15.w].data[3].w + r17.z);
        r16.w = r17.z * r16.w;
        r17.z = dot(refProbeAttenuationConstantsCB[r15.w].data[4].xyz, r23.xyz);
        r17.z = saturate(refProbeAttenuationConstantsCB[r15.w].data[4].w + r17.z);
        r16.w = r17.z * r16.w;
        r17.z = dot(refProbeAttenuationConstantsCB[r15.w].data[5].xyz, r23.xyz);
        r15.w = saturate(refProbeAttenuationConstantsCB[r15.w].data[5].w + r17.z);
        r15.x = r16.w * r15.w;
        r15.w = 1 & (int)refProbeConstantsCB[r8.w].data[6].x;
        r15.xw = r15.ww ? r15.xy : r15.zx;
        ...
        while (true) {
          ...
          r17.w = (int)r9.w + (int)r17.z;
          r17.w = (int)r17.w * 6;
          r18.w = dot(refProbeAttenuationConstantsCB[r17.w].data[0].xyz, r23.xyz);
          r18.w = saturate(refProbeAttenuationConstantsCB[r17.w].data[0].w + r18.w);
          r18.w = r24.x * r18.w;
          r19.w = dot(refProbeAttenuationConstantsCB[r17.w].data[1].xyz, r23.xyz);
          r19.w = saturate(refProbeAttenuationConstantsCB[r17.w].data[1].w + r19.w);
          r18.w = r19.w * r18.w;
          r19.w = dot(refProbeAttenuationConstantsCB[r17.w].data[2].xyz, r23.xyz);
          r19.w = saturate(refProbeAttenuationConstantsCB[r17.w].data[2].w + r19.w);
          r18.w = r19.w * r18.w;
          r19.w = dot(refProbeAttenuationConstantsCB[r17.w].data[3].xyz, r23.xyz);
          r19.w = saturate(refProbeAttenuationConstantsCB[r17.w].data[3].w + r19.w);
          r18.w = r19.w * r18.w;
          r19.w = dot(refProbeAttenuationConstantsCB[r17.w].data[4].xyz, r23.xyz);
          r19.w = saturate(refProbeAttenuationConstantsCB[r17.w].data[4].w + r19.w);
          r18.w = r19.w * r18.w;
          r19.w = dot(refProbeAttenuationConstantsCB[r17.w].data[5].xyz, r23.xyz);
          r17.w = saturate(refProbeAttenuationConstantsCB[r17.w].data[5].w + r19.w);
          r24.x = r18.w * r17.w;
          r19.w = (uint)r16.w >> 2;
          if (1 == 0) r23.w = 0; else if (1+2 < 32) {           r23.w = (uint)r16.w << (32-(1 + 2)); r23.w = (uint)r23.w >> (32-1);          } else r23.w = (uint)r16.w >> 2;
          r24.z = (int)r19.w & 2;
          r24.w = max(r24.y, r24.x);
          r17.w = -r18.w * r17.w + 1;
          r17.w = r24.y * r17.w;
          r17.y = r24.z ? r17.w : r24.w;
          r24.xy = r23.ww ? r24.xy : r17.xy;
          r17.z = (int)r17.z + 1;
          r16.w = r19.w;
        }
        r9.w = saturate(r24.y + -r21.w);
        r12.w = refProbeConstantsCB[r8.w].data[6].y * r9.w;
        r15.x = cmp(0 < r12.w);
        if (r15.x != 0) {
          r22.w = r9.w * refProbeConstantsCB[r8.w].data[6].y + r22.w;
          r9.w = refProbeConstantsCB[r8.w].data[7].y * r12.w;
          r25.x = refProbeConstantsCB[r8.w].data[7].w;
          r25.yz = refProbeConstantsCB[r8.w].data[8].xy;
          r12.w = dot(r14.xyz, r25.xyz);
          r15.x = dot(r23.xyz, r25.xyz);
          r15.x = -refProbeConstantsCB[r8.w].data[8].z + r15.x;
          r15.w = cmp(r15.x >= 0);
          r15.x = max(abs(r15.x), r5.w);
          r15.x = r15.w ? r15.x : -r15.x;
          ...
          r15.x = r15.w / r15.x;
          r12.w = min(abs(r15.x), r12.w);
          r25.x = refProbeConstantsCB[r8.w].data[3].w + r23.x;
          r25.yz = refProbeConstantsCB[r8.w].data[4].xy + r23.yz;
          r17.yzw = r14.xyz * r12.www + r25.xyz;
          r15.x = dot(r17.yzw, r17.yzw);
          r15.x = sqrt(r15.x);
          r12.w = r12.w / r15.x;
          r12.w = r12.w + r12.w;
          ...
          if (9 == 0) r15.x = 0; else if (9+16 < 32) {           r15.x = (uint)refProbeConstantsCB[r8.w].data[7].z << (32-(9 + 16)); r15.x = (uint)r15.x >> (32-9);          } else r15.x = (uint)refProbeConstantsCB[r8.w].data[7].z >> 16;
          r26.w = (uint)r15.x;
          r17.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r26.xyzw, r12.w).xyz;
          r29.x = dot(r23.xyz, r25.xyz);
          r29.y = dot(r23.xyz, r27.xyz);
          r29.z = dot(r23.xyz, r28.xyz);
          r23.xyz = saturate(r29.xyz * refProbeConstantsCB[r8.w].data[3].xyz + float3(0.5,0.5,0.5));
          r29.xy = refProbeConstantsCB[r8.w].data[4].zw * r23.xy;
          r29.z = refProbeConstantsCB[r8.w].data[5].x * r23.z;
          r23.xyz = refProbeConstantsCB[r8.w].data[5].yzw + r29.xyz;
          ...
          r8.w = dot(r25.xyz, float3(0.212599993,0.715200007,0.0722000003));
          r13.yzw = r23.xyz * r24.xzw + r13.yzw;
          r12.w = r8.w * r6.w;
          r17.yzw = r17.yzw * r9.www;
          r9.w = dot(r17.yzw, float3(0.212599993,0.715200007,0.0722000003));
          r8.w = r6.w * r8.w + r9.w;
          r8.w = r12.w / r8.w;
          r22.xyz = r17.yzw * r8.www + r22.xyz;
        }
      }
      r0.y = (int)r0.y + 1;
    }
  ...
  if (r0.y != 0) {
    r0.y = 1 + -r21.w;
    r2.z = sunConstants.globalProbeExposure * r0.y;
    ...
    r2.z = dot(r16.xyz, float3(0.212599993,0.715200007,0.0722000003));
    r13.yzw = r20.xyz * r0.xxx + r16.xyz;
    r14.w = 0;
    r16.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r14.xyzw, r2.w).xyz;
    r0.x = sunConstants.globalProbeExposure * r0.y + -r2.z;
    r0.x = r2.y * r0.x + r2.z;
  ...
  r2.yzw = r15.xyz * r0.xxx;
  r15.xyz = r2.yzw * r1.zzz;
  ...
  r0.xy = r1.zz * r0.xy;
  r1.z = (int)r9.y * 15;
  if (3 == 0) r1.w = 0; else if (3+24 < 32) {   r1.w = (uint)lightConstantsCB[r1.z].data[1].w << (32-(3 + 24)); r1.w = (uint)r1.w >> (32-3);  } else r1.w = (uint)lightConstantsCB[r1.z].data[1].w >> 24;
  switch (r1.w) {
    case 4 :    r1.w = cmp(0 < lightConstantsCB[r1.z].data[6].y);
    r16.xy = lightConstantsCB[r1.z].data[5].zw;
    r16.z = lightConstantsCB[r1.z].data[6].x;
    r9.xyw = -r16.xyz * float3(0.5,0.5,0.5) + lightConstantsCB[r1.z].data[0].xyz;
    r17.xyz = r9.xyw + -r10.xyz;
    r4.z = dot(r16.xyz, r17.xyz);
    r5.w = saturate(-r4.z / lightConstantsCB[r1.z].data[6].y);
    r18.xyz = r5.www * r16.xyz + r9.xyw;
    r18.xyz = r1.www ? r18.xyz : lightConstantsCB[r1.z].data[0].xyz;
    ...
    if (r11.w != 0) {
      r11.w = sqrt(r6.w);
      r12.w = lightConstantsCB[r1.z].data[3].x * lightConstantsCB[r1.z].data[3].x;
      r6.w = r12.w / r6.w;
      r6.w = min(1, r6.w);
      r18.xy = saturate(r11.ww * lightConstantsCB[r1.z].data[2].xz + lightConstantsCB[r1.z].data[2].yw);
      ...
      r11.w = cmp(0 < r6.w);
      if (r11.w != 0) {
        if (3 == 0) r11.w = 0; else if (3+27 < 32) {         r11.w = (uint)lightConstantsCB[r1.z].data[1].w << (32-(3 + 27)); r11.w = (uint)r11.w >> (32-3);        } else r11.w = (uint)lightConstantsCB[r1.z].data[1].w >> 27;
        ...
        if (r11.w != 0) {
          ...
          r18.yzw = -lightConstantsCB[r1.z].data[4].yzw + r18.yzw;
          r11.w = max(abs(r18.z), abs(r18.w));
          r11.w = max(abs(r18.y), r11.w);
          r11.w = lightConstantsCB[r1.z].data[5].x / r11.w;
          r11.w = lightConstantsCB[r1.z].data[5].y + r11.w;
          r12.w = dot(r18.yzw, r18.yzw);
          r12.w = rsqrt(r12.w);
          r11.w = max(6.10351563e-05, r11.w);
          r14.w = 0x0000ffff & (int)lightConstantsCB[r1.z].data[1].w;
          r20.x = -r3.x;
          r21.w = (uint)r14.w;
          r20.y = r13.x;
          r20.z = r3.x;
          ...
          while (true) {
            ...
            r22.yz = lightConstantsCB[r1.z].data[3].yy * r19.yz;
            r22.x = r22.y * r19.x;
            r22.w = r22.y * r18.x;
        ...
        r11.w = cmp(0 < r6.w);
        if (r11.w != 0) {
          r11.w = lightConstantsCB[r1.z].data[1].z * r0.z;
          r11.w = 0.25 * r11.w;
          r12.w = dot(r16.xyz, r14.xyz);
          r14.x = dot(r14.xyz, r17.xyz);
          r14.y = -r12.w * r12.w + lightConstantsCB[r1.z].data[6].y;
          r4.z = r12.w * r14.x + -r4.z;
          r4.z = saturate(r4.z / r14.y);
          r12.w = r14.y / lightConstantsCB[r1.z].data[6].y;
          r12.w = 10 * r12.w;
          r12.w = min(1, r12.w);
          r4.z = r4.z + -r5.w;
          r4.z = r12.w * r4.z + r5.w;
          r9.xyw = r4.zzz * r16.xyz + r9.xyw;
          r9.xyw = r1.www ? r9.xyw : lightConstantsCB[r1.z].data[0].xyz;
          r9.xyw = r9.xyw + -r10.xyz;
          r1.w = dot(r9.xyw, r9.xyw);
          r1.w = rsqrt(r1.w);
          r14.xyz = r9.xyw * r1.www;
          if (4 == 0) r4.z = 0; else if (4+16 < 32) {           r4.z = (uint)lightConstantsCB[r1.z].data[1].w << (32-(4 + 16)); r4.z = (uint)r4.z >> (32-4);          } else r4.z = (uint)lightConstantsCB[r1.z].data[1].w >> 16;
          ...
          if (r5.w != 0) {
            ...
            if (4 == 0) r4.z = 0; else if (4+20 < 32) {             r4.z = (uint)lightConstantsCB[r1.z].data[1].w << (32-(4 + 20)); r4.z = (uint)r4.z >> (32-4);            } else r4.z = (uint)lightConstantsCB[r1.z].data[1].w >> 20;
            r5.w = cmp(0 < (uint)r4.z);
            r12.w = ~(int)r9.z;
            r5.w = r5.w ? r12.w : 0;
            if (r5.w != 0) {
          ...
          r4.z = r0.w * r4.z + r8.w;
          r4.z = r4.z * r6.w;
          r16.x = lightConstantsCB[r1.z].data[0].w;
          r16.yz = lightConstantsCB[r1.z].data[1].xy;
          r5.w = cmp(0 < r7.w);
          r17.xyz = r4.zzz * r16.xyz + r13.yzw;
          r4.z = saturate(dot(r11.xyz, r14.xyz));
          r9.xyw = r9.xyw * r1.www + r12.xyz;
          r1.w = dot(r9.xyw, r9.xyw);
          r1.w = rsqrt(r1.w);
          r9.xyw = r9.xyw * r1.www;
          r1.w = dot(r9.xyw, r12.xyz);
          ...
          r13.yzw = r5.www ? r17.xyz : r13.yzw;
          r15.xyz = r5.www ? r14.xyz : r15.xyz;
          r2.yzw = r5.www ? r9.xyw : r2.yzw;
        }
      }
    }
    break;
    case 2 :    r14.xy = lightConstantsCB[r1.z].data[3].zw + -r10.xy;
    r14.z = lightConstantsCB[r1.z].data[4].x + -r10.z;
    r1.w = dot(r14.xyz, r14.xyz);
    r1.w = rsqrt(r1.w);
    r9.xyw = r14.xyz * r1.www;
    r4.z = dot(r11.xyz, r9.xyw);
    r5.w = saturate(r4.z);
    r6.w = cmp(0 < r5.w);
    if (r6.w != 0) {
      r16.xyz = lightConstantsCB[r1.z].data[7].yzw;
      r16.w = lightConstantsCB[r1.z].data[8].x;
      r10.w = 1;
      ...
      if (r7.w != 0) {
        ...
        r17.xyz = lightConstantsCB[r1.z].data[0].xyz + -r10.xyz;
        r8.w = lightConstantsCB[r1.z].data[3].x * lightConstantsCB[r1.z].data[3].x;
        r11.w = dot(r17.xyz, r17.xyz);
        r8.w = r8.w / r11.w;
        r8.w = min(1, r8.w);
        r17.xy = saturate(r6.ww * lightConstantsCB[r1.z].data[2].xz + lightConstantsCB[r1.z].data[2].yw);
        r17.zw = r17.xy * r17.xy;
        r17.xy = r17.xy * float2(-2,-2) + float2(3,3);
        r17.xy = r17.zw * r17.xy;
        r8.w = r17.x * r8.w;
        r8.w = r8.w * r17.y;
        r17.xyz = lightConstantsCB[r1.z].data[4].yzw;
        r17.w = lightConstantsCB[r1.z].data[5].x;
        r17.x = dot(r17.xyzw, r10.xyzw);
        r18.xyz = lightConstantsCB[r1.z].data[5].yzw;
        r18.w = lightConstantsCB[r1.z].data[6].x;
        r17.y = dot(r18.xyzw, r10.xyzw);
        r17.xy = r17.xy / r6.ww;
        r6.w = cmp(lightConstantsCB[r1.z].data[10].w < 0.00048828125);
        if (r6.w != 0) {
          r18.xy = saturate(abs(r17.xy) * lightConstantsCB[r1.z].data[12].xy + lightConstantsCB[r1.z].data[12].zw);
          r18.zw = r18.xy * r18.xy;
          r18.xy = r18.xy * float2(-2,-2) + float2(3,3);
          r18.xy = r18.zw * r18.xy;
          r6.w = r18.x * r18.y;
        } else {
          r18.xyzw = saturate(lightConstantsCB[r1.z].data[11].xyzw * abs(r17.yyxx));
          r18.xyzw = log2(r18.xyzw);
          r18.xyzw = lightConstantsCB[r1.z].data[12].zzzz * r18.xyzw;
          r18.xyzw = exp2(r18.xyzw);
          r18.xy = r18.xy + r18.zw;
          r18.xy = log2(r18.xy);
          r18.xy = lightConstantsCB[r1.z].data[12].ww * r18.xy;
          r18.xy = exp2(r18.xy);
          r10.w = lightConstantsCB[r1.z].data[12].x * r18.x;
          r11.w = lightConstantsCB[r1.z].data[12].y * r18.y + -1;
          r10.w = lightConstantsCB[r1.z].data[12].y * r18.y + -r10.w;
        ...
        r7.w = r8.w * r6.w;
        r6.w = 255 & (int)lightConstantsCB[r1.z].data[14].w;
        if (r6.w != 0) {
          r17.z = 1;
          r8.w = dot(lightConstantsCB[r1.z].data[13].xyz, r17.xyz);
          r18.x = lightConstantsCB[r1.z].data[13].w;
          r18.yz = lightConstantsCB[r1.z].data[14].xy;
          r10.w = dot(r18.xyz, r17.xyz);
          r17.x = frac(r8.w);
          r17.y = frac(r10.w);
          r6.w = (int)r6.w + -1;
          r17.z = (uint)r6.w;
          r9.xyw = gCookieArray.SampleLevel(samplerLinear_s, r17.xyz, 0).xyz;
        } else {
          r9.xyw = float3(1,1,1);
        }
      }
      r17.x = lightConstantsCB[r1.z].data[0].w;
      r17.yz = lightConstantsCB[r1.z].data[1].xy;
      r9.xyw = r17.xyz * r9.xyw;
      r6.w = cmp(0 < r7.w);
      if (r6.w != 0) {
        if (3 == 0) r6.w = 0; else if (3+27 < 32) {         r6.w = (uint)lightConstantsCB[r1.z].data[1].w << (32-(3 + 27)); r6.w = (uint)r6.w >> (32-3);        } else r6.w = (uint)lightConstantsCB[r1.z].data[1].w >> 27;
        r6.w = cmp((int)r6.w != 1);
        if (r6.w != 0) {
          ...
          r10.w = cmp(r8.w >= r6.w);
          if (r10.w != 0) {
            r16.xyz = lightConstantsCB[r1.z].data[4].yzw;
            r16.w = lightConstantsCB[r1.z].data[5].x;
            ...
            r17.x = r16.x * lightConstantsCB[r1.z].data[8].y + lightConstantsCB[r1.z].data[8].z;
            r17.y = r16.y * lightConstantsCB[r1.z].data[8].w + lightConstantsCB[r1.z].data[9].x;
            r6.w = r6.w / r8.w;
            r6.w = max(6.10351563e-05, r6.w);
            r8.w = 0x0000ffff & (int)lightConstantsCB[r1.z].data[1].w;
            if (enableDitheredShadow != 0) {
              r16.x = -r3.x;
              r18.z = (uint)r8.w;
              r16.y = r13.x;
              ...
              while (true) {
                ...
                r18.xy = r19.xy * lightConstantsCB[r1.z].data[3].yy + r17.xy;
        ...
        r7.w = cmp(0 < r6.w);
        if (r7.w != 0) {
          r7.w = lightConstantsCB[r1.z].data[1].z * r0.z;
          r7.w = r7.w * r5.w;
          if (4 == 0) r8.w = 0; else if (4+16 < 32) {           r8.w = (uint)lightConstantsCB[r1.z].data[1].w << (32-(4 + 16)); r8.w = (uint)r8.w >> (32-4);          } else r8.w = (uint)lightConstantsCB[r1.z].data[1].w >> 16;
          ...
          if (r10.w != 0) {
            ...
            r16.xyz = r11.xyz * r10.www + r10.xyz;
            ...
            if (4 == 0) r1.z = 0; else if (4+20 < 32) {             r1.z = (uint)lightConstantsCB[r1.z].data[1].w << (32-(4 + 20)); r1.z = (uint)r1.z >> (32-4);            } else r1.z = (uint)lightConstantsCB[r1.z].data[1].w >> 20;
            r8.w = cmp(0 < (uint)r1.z);
            r9.z = ~(int)r9.z;
            r8.w = r8.w ? r9.z : 0;
            if (r8.w != 0) {
              r1.z = (int)r1.z + numLights;
              r1.z = mad((int)r1.z, 15, -15);
              r8.w = abs(r4.z) * -0.200000003 + 0.400000006;
              r16.xyz = r11.xyz * r8.www + r10.xyz;
              r17.xyz = lightConstantsCB[r1.z].data[6].yzw;
              r17.w = lightConstantsCB[r1.z].data[7].x;
              r16.w = 1;
              r8.w = dot(r17.xyzw, r16.xyzw);
              r17.xyz = lightConstantsCB[r1.z].data[7].yzw;
              r17.w = lightConstantsCB[r1.z].data[8].x;
              r9.z = dot(r17.xyzw, r16.xyzw);
              r10.w = cmp(r9.z < r8.w);
              if (r10.w == 0) {
                r17.xyz = lightConstantsCB[r1.z].data[4].yzw;
                r17.w = lightConstantsCB[r1.z].data[5].x;
                ...
                r16.xy = r17.xy / r9.zz;
                r16.xy = r16.xy * float2(0.5,-0.5) + float2(0.5,0.5);
                r17.x = lightConstantsCB[r1.z].data[9].w + r16.x;
                r17.y = lightConstantsCB[r1.z].data[10].x + r16.y;
                r16.xy = lightConstantsCB[r1.z].data[9].yz * r17.xy;
                r16.zw = lightConstantsCB[r1.z].data[3].yy / lightConstantsCB[r1.z].data[8].yw;
                r17.xy = float2(1,1) + -r16.zw;
                r17.xy = cmp(r16.xy >= r17.xy);
                r16.zw = cmp(r16.zw >= r16.xy);
                r16.zw = (int2)r16.zw | (int2)r17.xy;
                ...
                if (r11.w == 0) {
                  ...
                  r17.x = r16.x * lightConstantsCB[r1.z].data[8].y + lightConstantsCB[r1.z].data[8].z;
                  r17.y = r16.y * lightConstantsCB[r1.z].data[8].w + lightConstantsCB[r1.z].data[9].x;
                  r12.w = lightConstantsCB[r1.z].data[10].z * r9.z;
                  r8.w = lightConstantsCB[r1.z].data[10].y * r9.z + r8.w;
                  r8.w = r8.w / r12.w;
                }
              } else {
                r11.w = -1;
              ...
              if (r9.z == 0) {
                ...
                r9.z = 0x0000ffff & (int)lightConstantsCB[r1.z].data[1].w;
                if (enableDitheredShadow != 0) {
                  r16.x = -r3.x;
                  r18.z = (uint)r9.z;
                  r16.y = r13.x;
          ...
          r0.x = r6.w * r0.x;
          r0.x = 0.25 * r0.x;
          r11.xyz = r0.xxx * r9.xyw + r2.yzw;
          r0.y = saturate(1 + -r0.w);
          r0.z = r0.y * r0.y;
          r0.z = r0.z * r0.z;
          r0.y = r0.y * r0.z;
          r0.x = r0.x * r0.y;
          r0.xyz = r0.xxx * r9.xyw + r15.xyz;
          r13.yzw = r1.zzz ? r16.xyz : r13.yzw;
          r15.xyz = r1.zzz ? r0.xyz : r15.xyz;
          r2.yzw = r1.zzz ? r11.xyz : r2.yzw;
        }
      }
    }
    break;
