...
r0.y = samp0[]..swiz;
  ...
  r2.w = r9.x ? r18.y : r18.x;
  r2.w = r9.y ? r18.z : r2.w;
  r2.w = r9.z ? r18.w : r2.w;
    ...
    switch (r4.z) {
      ...
      if (r11.w != 0) {
        ...
        if (r11.w != 0) {
          ...
          r11.w = cmp(0 < r7.w);
          if (r11.w != 0) {
            r11.w = lightConstantsCB[r3.w].data[1].z * r1.z;
            r11.w = 0.25 * r11.w;
      ...
      if (r7.w != 0) {
        ...
        if (r7.w != 0) {
          ...
          r8.w = cmp(0 < r7.w);
          if (r8.w != 0) {
            r8.w = lightConstantsCB[r3.w].data[1].z * r1.z;
            r8.w = r8.w * r6.w;
