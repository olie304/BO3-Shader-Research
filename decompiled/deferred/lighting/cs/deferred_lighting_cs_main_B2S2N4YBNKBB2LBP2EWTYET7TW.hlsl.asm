...
loop 
  ...
  if_nz r8.w
    ...
    loop 
      ...
      movc r14.y, r20.z, r14.w, r20.w
      movc r20.xy, r19.wwww, r20.xyxx, r14.xyxx
      iadd r14.z, r14.z, l(1)
      mov r13.w, r16.w
    endloop 
    mov_sat r20.y, r20.y
    mul r8.w, r20.y, cb10[r7.w + 6].y
    lt r9.w, l(0.000000), r8.w
    if_nz r9.w
      mad r18.w, r20.y, cb10[r7.w + 6].y, r18.w
      mul r8.w, r8.w, cb10[r7.w + 7].y
      mov r21.x, cb10[r7.w + 7].w
      mov r21.yz, cb10[r7.w + 8].xxyx
      dp3 r9.w, r11.xyzx, r21.xyzx
      dp3 r12.x, r19.xyzx, r21.xyzx
      add r12.x, r12.x, -cb10[r7.w + 8].z
      ...
      mov r21.x, cb10[r7.w + 8].w
      mov r21.yz, cb10[r7.w + 9].xxyx
      dp3 r12.x, r11.xyzx, r21.xyzx
      dp3 r12.w, r19.xyzx, r21.xyzx
      add r12.w, r12.w, -cb10[r7.w + 9].z
      ...
      min r9.w, r9.w, |r12.x|
      mov r21.x, cb10[r7.w + 9].w
      mov r21.yz, cb10[r7.w + 10].xxyx
      dp3 r12.x, r11.xyzx, r21.xyzx
      dp3 r12.w, r19.xyzx, r21.xyzx
      add r12.w, r12.w, -cb10[r7.w + 10].z
      ge r13.w, r12.w, l(0.000000)
      max r12.w, r2.z, |r12.w|
      movc r12.w, r13.w, r12.w, -r12.w
      max r12.x, -r12.x, l(0.00000010)
      div r12.x, r12.w, r12.x
      min r9.w, r9.w, |r12.x|
      mov r21.x, cb10[r7.w + 10].w
      mov r21.yz, cb10[r7.w + 11].xxyx
      dp3 r12.x, r11.xyzx, r21.xyzx
      dp3 r12.w, r19.xyzx, r21.xyzx
      add r12.w, r12.w, -cb10[r7.w + 11].z
      ge r13.w, r12.w, l(0.000000)
      max r12.w, r2.z, |r12.w|
      movc r12.w, r13.w, r12.w, -r12.w
      max r12.x, -r12.x, l(0.00000010)
      div r12.x, r12.w, r12.x
      min r9.w, r9.w, |r12.x|
      mov r21.x, cb10[r7.w + 11].w
      mov r21.yz, cb10[r7.w + 12].xxyx
      dp3 r12.x, r11.xyzx, r21.xyzx
      dp3 r12.w, r19.xyzx, r21.xyzx
      add r12.w, r12.w, -cb10[r7.w + 12].z
      ge r13.w, r12.w, l(0.000000)
      max r12.w, r2.z, |r12.w|
      movc r12.w, r13.w, r12.w, -r12.w
      max r12.x, -r12.x, l(0.00000010)
      div r12.x, r12.w, r12.x
      min r9.w, r9.w, |r12.x|
      mov r21.x, cb10[r7.w + 12].w
      mov r21.yz, cb10[r7.w + 13].xxyx
      dp3 r12.x, r11.xyzx, r21.xyzx
      dp3 r12.w, r19.xyzx, r21.xyzx
      add r12.w, r12.w, -cb10[r7.w + 13].z
      ge r13.w, r12.w, l(0.000000)
      max r12.w, r2.z, |r12.w|
      movc r12.w, r13.w, r12.w, -r12.w
      max r12.x, -r12.x, l(0.00000010)
      div r12.x, r12.w, r12.x
      min r9.w, r9.w, |r12.x|
      add r21.x, r19.x, cb10[r7.w + 3].w
      add r21.yz, r19.yyzy, cb10[r7.w + 4].xxyx
      mad r14.yzw, r11.xxyz, r9.wwww, r21.xxyz
      dp3 r12.x, r14.yzwy, r14.yzwy
      sqrt r12.x, r12.x
      div r9.w, r9.w, r12.x
      add r9.w, r9.w, r9.w
      sqrt r9.w, r9.w
      mad r9.w, r1.z, l(5.000000), r9.w
      add r9.w, r9.w, l(-0.844800)
      mov r21.x, cb10[r7.w + 0].w
      mov r21.y, cb10[r7.w + 1].z
      mov r21.z, cb10[r7.w + 2].y
      dp3 r22.x, r14.yzwy, r21.xyzx
      mov r23.xy, cb10[r7.w + 1].xwxx
      mov r23.z, cb10[r7.w + 2].z
      dp3 r22.y, r14.yzwy, r23.xyzx
      mov r24.x, cb10[r7.w + 1].y
      mov r24.yz, cb10[r7.w + 2].xxwx
      dp3 r22.z, r14.yzwy, r24.xyzx
      ubfe r12.x, l(9), l(16), cb10[r7.w + 7].z
      utof r22.w, r12.x
      sample_l_indexable(texturecubearray)(float,float,float,float) r14.yzw, r22.xyzw, t8.wxyz, s2, r9.w
      dp3 r25.x, r19.xyzx, r21.xyzx
      dp3 r25.y, r19.xyzx, r23.xyzx
      dp3 r25.z, r19.xyzx, r24.xyzx
      mad_sat r19.xyz, r25.xyzx, cb10[r7.w + 3].xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
      mul r25.xy, r19.xyxx, cb10[r7.w + 4].zwzz
      mul r25.z, r19.z, cb10[r7.w + 5].x
      add r19.xyz, r25.xyzx, cb10[r7.w + 5].yzwy
      ...
      dp3 r7.w, r21.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
      ...
      mad r7.w, r2.w, r7.w, r8.w
      div r7.w, r9.w, r7.w
      mov r19.x, r17.w
      mov r19.yz, r18.yyzy
      mad r18.xyz, r14.yzwy, r7.wwww, r19.xyzx
      mov r17.w, r18.x
    endif 
  endif 
  iadd r6.w, r6.w, l(1)
endloop 
lt r6.w, r18.w, l(1.000000)
if_nz r6.w
  mov r12.yz, l(0,0,1.000000,0)
  mov r13.xy, l(0,0,0,0)
  mov r14.x, l(1.000000)
  ...
  loop 
    ...
    if_nz r8.w
      imul null, r7.w, r7.w, l(14)
      add r21.xyz, r9.xyzx, -cb10[r7.w + 0].xyzx
      and r8.w, l(0x0000ffff), cb10[r7.w + 7].z
      ubfe r9.w, l(6), l(25), cb10[r7.w + 7].z
      imul null, r12.w, r8.w, l(6)
      dp3 r13.w, cb11[r12.w + 0].xyzx, r21.xyzx
      add_sat r13.w, r13.w, cb11[r12.w + 0].w
      dp3 r14.z, cb11[r12.w + 1].xyzx, r21.xyzx
      add_sat r14.z, r14.z, cb11[r12.w + 1].w
      mul r13.w, r13.w, r14.z
      dp3 r14.z, cb11[r12.w + 2].xyzx, r21.xyzx
      add_sat r14.z, r14.z, cb11[r12.w + 2].w
      mul r13.w, r13.w, r14.z
      dp3 r14.z, cb11[r12.w + 3].xyzx, r21.xyzx
      add_sat r14.z, r14.z, cb11[r12.w + 3].w
      mul r13.w, r13.w, r14.z
      dp3 r14.z, cb11[r12.w + 4].xyzx, r21.xyzx
      add_sat r14.z, r14.z, cb11[r12.w + 4].w
      mul r13.w, r13.w, r14.z
      dp3 r14.z, cb11[r12.w + 5].xyzx, r21.xyzx
      add_sat r12.w, r14.z, cb11[r12.w + 5].w
      mul r12.x, r12.w, r13.w
      and r12.w, l(1), cb10[r7.w + 6].x
      movc r12.xw, r12.wwww, r12.xxxy, r12.zzzx
      ...
      loop 
        ...
        iadd r14.w, r8.w, r14.z
        imul null, r14.w, r14.w, l(6)
        dp3 r15.w, cb11[r14.w + 0].xyzx, r21.xyzx
        add_sat r15.w, r15.w, cb11[r14.w + 0].w
        mul r15.w, r15.w, r22.x
        dp3 r16.w, cb11[r14.w + 1].xyzx, r21.xyzx
        add_sat r16.w, r16.w, cb11[r14.w + 1].w
        mul r15.w, r15.w, r16.w
        dp3 r16.w, cb11[r14.w + 2].xyzx, r21.xyzx
        add_sat r16.w, r16.w, cb11[r14.w + 2].w
        mul r15.w, r15.w, r16.w
        dp3 r16.w, cb11[r14.w + 3].xyzx, r21.xyzx
        add_sat r16.w, r16.w, cb11[r14.w + 3].w
        mul r15.w, r15.w, r16.w
        dp3 r16.w, cb11[r14.w + 4].xyzx, r21.xyzx
        add_sat r16.w, r16.w, cb11[r14.w + 4].w
        mul r15.w, r15.w, r16.w
        dp3 r16.w, cb11[r14.w + 5].xyzx, r21.xyzx
        add_sat r14.w, r16.w, cb11[r14.w + 5].w
        mul r22.x, r14.w, r15.w
        ushr r16.w, r13.w, l(2)
        ubfe r20.w, l(1), l(2), r13.w
        and r21.w, r16.w, l(2)
        max r22.z, r22.x, r22.y
        mad r14.w, -r15.w, r14.w, l(1.000000)
        mul r14.w, r14.w, r22.y
        movc r14.y, r21.w, r14.w, r22.z
        movc r22.xy, r20.wwww, r22.xyxx, r14.xyxx
        iadd r14.z, r14.z, l(1)
        mov r13.w, r16.w
      endloop 
      add_sat r8.w, -r18.w, r22.y
      mul r9.w, r8.w, cb10[r7.w + 6].y
      lt r12.x, l(0.000000), r9.w
      if_nz r12.x
        mad r19.w, r8.w, cb10[r7.w + 6].y, r19.w
        mul r8.w, r9.w, cb10[r7.w + 7].y
        mov r23.x, cb10[r7.w + 7].w
        mov r23.yz, cb10[r7.w + 8].xxyx
        dp3 r9.w, r11.xyzx, r23.xyzx
        dp3 r12.x, r21.xyzx, r23.xyzx
        add r12.x, r12.x, -cb10[r7.w + 8].z
        ge r12.w, r12.x, l(0.000000)
        max r12.x, r2.z, |r12.x|
        movc r12.x, r12.w, r12.x, -r12.x
        ...
        div r9.w, r12.x, r9.w
        min r9.w, |r9.w|, l(131072.000000)
        mov r23.x, cb10[r7.w + 8].w
        mov r23.yz, cb10[r7.w + 9].xxyx
        ...
        div r12.x, r12.w, r12.x
        min r9.w, r9.w, |r12.x|
        mov r23.x, cb10[r7.w + 9].w
        mov r23.yz, cb10[r7.w + 10].xxyx
        dp3 r12.x, r11.xyzx, r23.xyzx
        dp3 r12.w, r21.xyzx, r23.xyzx
        add r12.w, r12.w, -cb10[r7.w + 10].z
        ge r13.w, r12.w, l(0.000000)
        ...
        div r12.x, r12.w, r12.x
        min r9.w, r9.w, |r12.x|
        mov r23.x, cb10[r7.w + 10].w
        mov r23.yz, cb10[r7.w + 11].xxyx
        dp3 r12.x, r11.xyzx, r23.xyzx
        dp3 r12.w, r21.xyzx, r23.xyzx
        add r12.w, r12.w, -cb10[r7.w + 11].z
        ge r13.w, r12.w, l(0.000000)
        ...
        div r12.x, r12.w, r12.x
        min r9.w, r9.w, |r12.x|
        mov r23.x, cb10[r7.w + 11].w
        mov r23.yz, cb10[r7.w + 12].xxyx
        dp3 r12.x, r11.xyzx, r23.xyzx
        dp3 r12.w, r21.xyzx, r23.xyzx
        add r12.w, r12.w, -cb10[r7.w + 12].z
        ge r13.w, r12.w, l(0.000000)
        ...
        div r12.x, r12.w, r12.x
        min r9.w, r9.w, |r12.x|
        mov r23.x, cb10[r7.w + 12].w
        mov r23.yz, cb10[r7.w + 13].xxyx
        dp3 r12.x, r11.xyzx, r23.xyzx
        dp3 r12.w, r21.xyzx, r23.xyzx
        add r12.w, r12.w, -cb10[r7.w + 13].z
        ge r13.w, r12.w, l(0.000000)
        ...
        div r12.x, r12.w, r12.x
        min r9.w, r9.w, |r12.x|
        add r23.x, r21.x, cb10[r7.w + 3].w
        add r23.yz, r21.yyzy, cb10[r7.w + 4].xxyx
        mad r14.yzw, r11.xxyz, r9.wwww, r23.xxyz
        dp3 r12.x, r14.yzwy, r14.yzwy
        sqrt r12.x, r12.x
        div r9.w, r9.w, r12.x
        add r9.w, r9.w, r9.w
        ...
        mad r9.w, r1.z, l(5.000000), r9.w
        add r9.w, r9.w, l(-0.844800)
        mov r23.x, cb10[r7.w + 0].w
        mov r23.y, cb10[r7.w + 1].z
        mov r23.z, cb10[r7.w + 2].y
        dp3 r24.x, r14.yzwy, r23.xyzx
        mov r25.xy, cb10[r7.w + 1].xwxx
        mov r25.z, cb10[r7.w + 2].z
        dp3 r24.y, r14.yzwy, r25.xyzx
        mov r26.x, cb10[r7.w + 1].y
        mov r26.yz, cb10[r7.w + 2].xxwx
        dp3 r24.z, r14.yzwy, r26.xyzx
        ubfe r12.x, l(9), l(16), cb10[r7.w + 7].z
        utof r24.w, r12.x
        sample_l_indexable(texturecubearray)(float,float,float,float) r14.yzw, r24.xyzw, t8.wxyz, s2, r9.w
        dp3 r27.x, r21.xyzx, r23.xyzx
        dp3 r27.y, r21.xyzx, r25.xyzx
        dp3 r27.z, r21.xyzx, r26.xyzx
        mad_sat r21.xyz, r27.xyzx, cb10[r7.w + 3].xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
        mul r27.xy, r21.xyxx, cb10[r7.w + 4].zwzz
        mul r27.z, r21.z, cb10[r7.w + 5].x
        add r21.xyz, r27.xyzx, cb10[r7.w + 5].yzwy
        ...
        dp3 r7.w, r23.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
        ...
        mad r7.w, r2.w, r7.w, r8.w
        div r7.w, r9.w, r7.w
        mad r19.xyz, r14.yzwy, r7.wwww, r19.xyzx
      endif 
    endif 
    iadd r6.w, r6.w, l(1)
  endloop 
...
lt r1.z, r18.w, l(0.990000)
if_nz r1.z
  add r1.z, -r18.w, l(1.000000)
