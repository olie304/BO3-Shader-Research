...
if_nz r7.w
  ...
  add r13.xyz, r9.xyzx, -cb10[r7.w + 0].xyzx
  and r8.w, l(0x0000ffff), cb10[r7.w + 7].z
  ubfe r9.w, l(6), l(25), cb10[r7.w + 7].z
  imul null, r12.w, r8.w, l(6)
  dp3 r13.w, cb11[r12.w + 0].xyzx, r13.xyzx
  add_sat r13.w, r13.w, cb11[r12.w + 0].w
  dp3 r14.x, cb11[r12.w + 1].xyzx, r13.xyzx
  add_sat r14.x, r14.x, cb11[r12.w + 1].w
  mul r13.w, r13.w, r14.x
  dp3 r14.x, cb11[r12.w + 2].xyzx, r13.xyzx
  add_sat r14.x, r14.x, cb11[r12.w + 2].w
  mul r13.w, r13.w, r14.x
  dp3 r14.x, cb11[r12.w + 3].xyzx, r13.xyzx
  add_sat r14.x, r14.x, cb11[r12.w + 3].w
  mul r13.w, r13.w, r14.x
  dp3 r14.x, cb11[r12.w + 4].xyzx, r13.xyzx
  add_sat r14.x, r14.x, cb11[r12.w + 4].w
  mul r13.w, r13.w, r14.x
  dp3 r14.x, cb11[r12.w + 5].xyzx, r13.xyzx
  add_sat r12.w, r14.x, cb11[r12.w + 5].w
  mul r14.x, r12.w, r13.w
  and r12.w, l(1), cb10[r7.w + 6].x
  mov r14.yz, l(0,0,1.000000,0)
  movc r14.xy, r12.wwww, r14.xyxx, r14.zxzz
  mov r15.x, l(1.000000)
  mov r12.w, cb10[r7.w + 6].x
  mov r16.xy, r14.xyxx
  mov r13.w, l(1)
  loop 
    ige r14.z, r13.w, r9.w
    breakc_nz r14.z
    iadd r14.z, r8.w, r13.w
    imul null, r14.z, r14.z, l(6)
    dp3 r14.w, cb11[r14.z + 0].xyzx, r13.xyzx
    add_sat r14.w, r14.w, cb11[r14.z + 0].w
    mul r14.w, r14.w, r16.x
    dp3 r15.z, cb11[r14.z + 1].xyzx, r13.xyzx
    add_sat r15.z, r15.z, cb11[r14.z + 1].w
    mul r14.w, r14.w, r15.z
    dp3 r15.z, cb11[r14.z + 2].xyzx, r13.xyzx
    add_sat r15.z, r15.z, cb11[r14.z + 2].w
    mul r14.w, r14.w, r15.z
    dp3 r15.z, cb11[r14.z + 3].xyzx, r13.xyzx
    add_sat r15.z, r15.z, cb11[r14.z + 3].w
    mul r14.w, r14.w, r15.z
    dp3 r15.z, cb11[r14.z + 4].xyzx, r13.xyzx
    add_sat r15.z, r15.z, cb11[r14.z + 4].w
    mul r14.w, r14.w, r15.z
    dp3 r15.z, cb11[r14.z + 5].xyzx, r13.xyzx
    add_sat r14.z, r15.z, cb11[r14.z + 5].w
    mul r16.x, r14.z, r14.w
    ushr r15.z, r12.w, l(2)
    ubfe r15.w, l(1), l(2), r12.w
    and r16.z, r15.z, l(2)
    max r16.w, r16.x, r16.y
    mad r14.z, -r14.w, r14.z, l(1.000000)
    mul r14.z, r14.z, r16.y
    movc r15.y, r16.z, r14.z, r16.w
    movc r16.xy, r15.wwww, r16.xyxx, r15.xyxx
    iadd r13.w, r13.w, l(1)
    mov r12.w, r15.z
  endloop 
  mov_sat r16.y, r16.y
  mul r8.w, r16.y, cb10[r7.w + 6].y
  lt r9.w, l(0.000000), r8.w
  if_nz r9.w
    mul r9.w, r8.w, cb10[r7.w + 7].y
    mov r14.x, cb10[r7.w + 7].w
    mov r14.yz, cb10[r7.w + 8].xxyx
    dp3 r12.w, r11.xyzx, r14.xyzx
    dp3 r13.w, r13.xyzx, r14.xyzx
    add r13.w, r13.w, -cb10[r7.w + 8].z
    ge r14.x, r13.w, l(0.000000)
    max r13.w, r3.w, |r13.w|
    movc r13.w, r14.x, r13.w, -r13.w
    max r12.w, -r12.w, l(0.00000010)
    div r12.w, r13.w, r12.w
    min r12.w, |r12.w|, l(131072.000000)
    mov r14.x, cb10[r7.w + 8].w
    mov r14.yz, cb10[r7.w + 9].xxyx
    dp3 r13.w, r11.xyzx, r14.xyzx
    dp3 r14.x, r13.xyzx, r14.xyzx
    add r14.x, r14.x, -cb10[r7.w + 9].z
    ...
    mov r14.x, cb10[r7.w + 9].w
    mov r14.yz, cb10[r7.w + 10].xxyx
    dp3 r13.w, r11.xyzx, r14.xyzx
    dp3 r14.x, r13.xyzx, r14.xyzx
    add r14.x, r14.x, -cb10[r7.w + 10].z
    ge r14.y, r14.x, l(0.000000)
    max r14.x, r3.w, |r14.x|
    movc r14.x, r14.y, r14.x, -r14.x
    max r13.w, -r13.w, l(0.00000010)
    div r13.w, r14.x, r13.w
    min r12.w, r12.w, |r13.w|
    mov r14.x, cb10[r7.w + 10].w
    mov r14.yz, cb10[r7.w + 11].xxyx
    dp3 r13.w, r11.xyzx, r14.xyzx
    dp3 r14.x, r13.xyzx, r14.xyzx
    add r14.x, r14.x, -cb10[r7.w + 11].z
    ge r14.y, r14.x, l(0.000000)
    max r14.x, r3.w, |r14.x|
    movc r14.x, r14.y, r14.x, -r14.x
    max r13.w, -r13.w, l(0.00000010)
    div r13.w, r14.x, r13.w
    min r12.w, r12.w, |r13.w|
    mov r14.x, cb10[r7.w + 11].w
    mov r14.yz, cb10[r7.w + 12].xxyx
    dp3 r13.w, r11.xyzx, r14.xyzx
    dp3 r14.x, r13.xyzx, r14.xyzx
    add r14.x, r14.x, -cb10[r7.w + 12].z
    ge r14.y, r14.x, l(0.000000)
    max r14.x, r3.w, |r14.x|
    movc r14.x, r14.y, r14.x, -r14.x
    max r13.w, -r13.w, l(0.00000010)
    div r13.w, r14.x, r13.w
    min r12.w, r12.w, |r13.w|
    mov r14.x, cb10[r7.w + 12].w
    mov r14.yz, cb10[r7.w + 13].xxyx
    dp3 r13.w, r11.xyzx, r14.xyzx
    dp3 r14.x, r13.xyzx, r14.xyzx
    add r14.x, r14.x, -cb10[r7.w + 13].z
    ge r14.y, r14.x, l(0.000000)
    max r14.x, r3.w, |r14.x|
    movc r14.x, r14.y, r14.x, -r14.x
    max r13.w, -r13.w, l(0.00000010)
    div r13.w, r14.x, r13.w
    min r12.w, r12.w, |r13.w|
    add r14.x, r13.x, cb10[r7.w + 3].w
    add r14.yz, r13.yyzy, cb10[r7.w + 4].xxyx
    ...
    mov r15.x, cb10[r7.w + 0].w
    mov r15.y, cb10[r7.w + 1].z
    mov r15.z, cb10[r7.w + 2].y
    dp3 r16.x, r14.xyzx, r15.xyzx
    mov r17.xy, cb10[r7.w + 1].xwxx
    mov r17.z, cb10[r7.w + 2].z
    dp3 r16.y, r14.xyzx, r17.xyzx
    mov r18.x, cb10[r7.w + 1].y
    mov r18.yz, cb10[r7.w + 2].xxwx
    dp3 r16.z, r14.xyzx, r18.xyzx
    ubfe r13.w, l(9), l(16), cb10[r7.w + 7].z
    utof r16.w, r13.w
    sample_l_indexable(texturecubearray)(float,float,float,float) r14.xyz, r16.xyzw, t8.xyzw, s2, r12.w
    dp3 r19.x, r13.xyzx, r15.xyzx
    dp3 r19.y, r13.xyzx, r17.xyzx
    dp3 r19.z, r13.xyzx, r18.xyzx
    mad_sat r13.xyz, r19.xyzx, cb10[r7.w + 3].xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
    mul r19.xy, r13.xyxx, cb10[r7.w + 4].zwzz
    mul r19.z, r13.z, cb10[r7.w + 5].x
    add r13.xyz, r19.xyzx, cb10[r7.w + 5].yzwy
...
if_nz r7.w
  ...
  if_nz r6.w
    ...
    if_nz r9.w
      ...
      ge r13.w, r12.w, l(0.000000)
      max r3.w, r3.w, |r12.w|
      movc r3.w, r13.w, r3.w, -r3.w
      max r9.w, -r9.w, l(0.00000010)
      div r3.w, r3.w, r9.w
      min r3.w, |r3.w|, r7.w
      add r16.x, r15.x, cb10[r0.y + 3].w
      add r16.yz, r15.yyzy, cb10[r0.y + 4].xxyx
      mad r16.xyz, r11.xyzx, r3.wwww, r16.xyzx
      dp3 r7.w, r16.xyzx, r16.xyzx
      sqrt r7.w, r7.w
      div r3.w, r3.w, r7.w
      add r3.w, r3.w, r3.w
      sqrt r3.w, r3.w
      mad r2.z, r2.z, l(5.000000), r3.w
      ...
      ubfe r3.w, l(9), l(16), cb10[r0.y + 7].z
      utof r18.w, r3.w
...
if_nz r2.z
  ...
  mad r15.xyz, r13.xyzx, r0.yyyy, r10.xyzx
  mov r11.w, l(0)
