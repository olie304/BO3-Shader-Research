...
add r13.z, -r11.w, cb2[19].x
mad r11.w, r2.y, r13.z, r11.w
mul r17.xyz, r11.wwww, r17.xyzx
add r5.w, -r5.w, l(1.000000)
mad r9.xyw, r17.xyxz, r5.wwww, r9.xyxw
mad r5.w, r4.z, r2.z, r2.x
log r5.w, |r5.w|
mul r5.w, r1.w, r5.w
exp r5.w, r5.w
mad r2.z, r4.z, r2.z, r5.w
...
mul r19.xzw, r19.xxxx, r9.xxyw
mul r20.xyz, r19.yyyy, r9.xywx
sqrt r2.y, r1.w
...
if_nz r4.z
  ...
  if_nz r4.z
    ...
    if_nz cb2[23].x
      ...
      dp4 r5.w, cb2[24].xyzw, r21.xyzw
      dp4 r7.w, cb2[25].xyzw, r21.xyzw
      frc r21.x, r5.w
      frc r21.y, r7.w
    ...
    if_nz r7.w
      ...
      mad r7.w, |r6.w|, l(-0.200000), l(0.400000)
      lt r11.w, r6.w, l(0.000000)
      and r11.w, r0.w, r11.w
      movc r7.w, r11.w, -r7.w, r7.w
      mad r21.xyz, r11.xyzx, r7.wwww, r10.xyzx
      mov r22.xyz, cb9[r5.w + 4].yzwy
      mov r22.w, cb9[r5.w + 5].x
      mov r21.w, l(1.000000)
      dp4 r22.x, r22.xyzw, r21.xyzw
      mov r23.xyz, cb9[r5.w + 5].yzwy
      mov r23.w, cb9[r5.w + 6].x
      ...
      div r22.zw, cb9[r5.w + 3].yyyy, cb9[r5.w + 8].yyyw
      ...
      or r7.w, r22.w, r22.z
      if_z r7.w
        mov r23.xyz, cb9[r5.w + 6].yzwy
        mov r23.w, cb9[r5.w + 7].x
        dp4 r7.w, r23.xyzw, r21.xyzw
        mov_sat r22.xy, r22.xyxx
        mad r21.x, r22.x, cb9[r5.w + 8].y, cb9[r5.w + 8].z
        mad r21.y, r22.y, cb9[r5.w + 8].w, cb9[r5.w + 9].x
        add r7.w, r7.w, cb9[r5.w + 10].y
        div r7.w, r7.w, cb9[r5.w + 10].z
        ...
        if_nz cb2[58].y
          ...
          loop 
            ige r16.w, r14.w, l(8)
            breakc_nz r16.w
            dp2 r24.x, icb[r14.w + 0].yxyy, r22.xyxx
            dp2 r24.y, icb[r14.w + 0].yxyy, r22.yzyy
            mad r23.xy, r24.xyxx, cb9[r5.w + 3].yyyy, r21.xyxx
            sample_c_lz_indexable(texture2darray)(float,float,float,float) r16.w, r23.xyzx, t9.xxxx, s13, r7.w
            mad r13.z, r16.w, l(0.125000), r13.z
            iadd r14.w, r14.w, l(1)
          endloop 
        else 
          utof r21.z, r11.w
          sample_c_lz_indexable(texture2darray)(float,float,float,float) r13.z, r21.xyzx, t9.xxxx, s13, r7.w
        endif 
    ...
    mad r5.w, -r12.w, r5.w, l(1.000000)
    mul r5.w, r5.w, r5.w
    mad r5.w, -r5.w, l(0.620000), l(0.620000)
    add r5.w, -r12.w, r5.w
    mad r5.w, r1.w, r5.w, r12.w
    mul r5.w, r13.w, r5.w
    mul r21.xyz, r9.xywx, r5.wwww
    ...
    mad r22.yzw, r2.wwww, r9.xxyw, r20.xxyz
    add_sat r0.z, -r0.z, l(1.000000)
    mul r4.z, r0.z, r0.z
    mul r4.z, r4.z, r4.z
    mul r0.z, r0.z, r4.z
    mul r0.z, r0.z, r2.w
    mad r15.yzw, r0.zzzz, r9.xxyw, r19.xxzw
    mad r9.xyw, r5.wwww, r9.xyxw, r18.zxzy
    and r23.xyz, r0.wwww, r9.ywxy
    mov r21.w, r18.z
    mov r17.w, r23.z
    movc r17.xyzw, r6.wwww, r21.xyzw, r17.xyzw
    mov r18.zw, r15.yyyz
    mov r23.zw, r19.xxxz
    movc r21.xyzw, r6.wwww, r18.xyzw, r23.xyzw
    mov r22.x, r15.w
    mov r20.w, r19.w
    movc r20.xyzw, r6.wwww, r22.yzwx, r20.xyzw
    mov r18.z, r17.w
    mov r18.xy, r21.xyxx
    mov r19.xz, r21.zzwz
    mov r19.w, r20.w
    ...
    if_nz r11.w
      ...
      if_nz r17.w
        ...
        if_nz r18.w
          ...
          mul r19.y, r19.y, r40.x
          mul r19.y, r40.y, r19.y
          ...
          if_nz r17.w
            dp3 r19.y, cb9[r7.w + 13].xyzx, r22.xyzx
            ...
            if_nz r19.y
              ...
              if_nz r5.w
                ...
                loop 
                  ...
                  mad r19.y, r23.x, l(0.125000), r19.y
                  iadd r20.w, r20.w, l(1)
                endloop 
              else 
                utof r38.z, r17.w
                sample_c_lz_indexable(texture2darray)(float,float,float,float) r19.y, r38.xyzx, t9.xxxx, s13, r11.w
              endif 
