...
r0.y = samp0[]..swiz;
  ...
  r0.y = (uint)r0.y >> 24;
  r12.w = cmp((uint)r0.y >= (uint)r10.w);
  r13.y = cmp((uint)r0.y < numRefProbes);
  r12.w = r12.w ? r13.y : 0;
  if (r12.w != 0) {
    r12.w = (int)r0.y * 14;
    if (r2.w != 0) {
    ...
    r14.y = refProbeConstantsCB[r12.w].data[6].y * r18.y;
    r14.z = cmp(0 < r14.y);
    if (r14.z != 0) {
      if (r2.w != 0) {
      // Known bad code for instruction (needs manual fix):
      ...
      r14.z = refProbeConstantsCB[r12.w].data[7].y * r14.y;
      ...
      r16.x = -refProbeConstantsCB[r12.w].data[8].z + r16.x;
      r16.y = cmp(r16.x >= 0);
      ...
      if (9 == 0) r16.x = 0; else if (9+16 < 32) {       r16.x = (uint)refProbeConstantsCB[r12.w].data[7].z << (32-(9 + 16)); r16.x = (uint)r16.x >> (32-9);      } else r16.x = (uint)refProbeConstantsCB[r12.w].data[7].z >> 16;
      r18.w = (uint)r16.x;
  ...
  if (r10.w != 0) {
    ...
    r14.z = 0x0000ffff & (int)refProbeConstantsCB[r0.y].data[7].z;
    ...
    r14.w = refProbeConstantsCB[r0.y].data[6].y * r14.z;
    r16.w = cmp(0 < r14.w);
    if (r16.w != 0) {
      r16.w = (int)r10.w & 3;
      r17.w = (int)r16.w + -1;
      ...
      r10.w = (int)r12.w + 257;
      r14.z = r14.z * refProbeConstantsCB[r0.y].data[6].y + r14.y;
      r14.w = refProbeConstantsCB[r0.y].data[7].y * r14.w;
      ...
      r18.y = cmp(r18.x >= 0);
      r8.w = max(abs(r18.x), r8.w);
      r8.w = r18.y ? r8.w : -r8.w;
      r17.w = max(1.00000001e-07, -r17.w);
      r8.w = r8.w / r17.w;
      r8.w = min(r16.w, abs(r8.w));
      r18.x = refProbeConstantsCB[r0.y].data[3].w + r17.x;
      r18.yz = refProbeConstantsCB[r0.y].data[4].xy + r17.yz;
      r18.xyz = r15.xyz * r8.www + r18.xyz;
      ...
      r20.w = (uint)r8.w;
      r18.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r20.xyzw, r5.w).xyz;
      r23.xyz = (int3)r18.xyz & int3(-2147483648,-2147483648,-2147483648);
      r23.xyz = cmp((int3)r23.xyz == int3(2139095040,2139095040,2139095040));
      r5.w = (int)r23.y | (int)r23.x;
      r5.w = (int)r23.z | (int)r5.w;
      r18.xyz = r5.www ? float3(1,1,0) : r18.xyz;
  ...
  r0.y = cmp(r14.y >= 1);
  bitmask.w = ((~(-1 << 8)) << 0) & 0xffffffff;  r5.w = (((uint)r10.w << 0) & bitmask.w) | ((uint)r12.w & ~bitmask.w);
  r0.y = r0.y ? r5.w : r10.w;
  r5.w = max(1, r14.z);
  r5.w = rcp(r5.w);
  r14.z = saturate(r14.z);
  r17.xyz = r13.yzw * r5.www;
  r16.xyz = r16.xyz * r5.www;
  r8.w = cmp(r14.z < 0.99000001);
  if (r8.w != 0) {
    r0.y = (int)r0.y + 256;
    r8.w = 1 + -r14.z;
    ...
    r17.xyz = r13.yzw * r5.www + r14.yzw;
    r15.w = 0;
    ...
    r5.w = r2.y * r5.w + r9.w;
    r16.xyz = r13.yzw * r5.www + r16.xyz;
  }
  r5.w = r2.x + r4.z;
  r5.w = log2(abs(r5.w));
  r5.w = r5.w * r2.z;
  ...
  if (r2.y != 0) {
    ...
    if (r2.y != 0) {
      ...
      r2.z = cmp(0 < r3.y);
      r3.xyw = r17.xyz * r4.zzz + r19.xyz;
      r17.xyz = -r5.xyz * r1.zzz + sunConstants.wldDir.xyz;
      r1.z = dot(r17.xyz, r17.xyz);
      r1.z = rsqrt(r1.z);
      r17.xyz = r17.xyz * r1.zzz;
      r1.z = dot(r17.xyz, r12.xyz);
      r4.z = dot(r11.xyz, r17.xyz);
      ...
      r17.xyz = r2.xxx * r18.xyz + r14.yzw;
      r17.xyz = r0.www ? r17.xyz : 0;
      r13.yzw = r2.zzz ? r3.xyw : r13.yzw;
      r14.yzw = r2.zzz ? r14.yzw : r17.xyz;
      r15.xzw = r2.zzz ? r12.xyz : r15.xzw;
      r16.xyz = r2.zzz ? r11.xyz : r16.xyz;
      if (r2.w != 0) {
      // Known bad code for instruction (needs manual fix):
