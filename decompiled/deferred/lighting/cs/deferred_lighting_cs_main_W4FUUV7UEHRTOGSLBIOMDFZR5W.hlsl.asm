...
lt r4.w, r25.w, l(0.990000)
if_nz r4.w
  add r4.w, -r25.w, l(1.000000)
  ...
  dp3 r8.w, r17.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
...
if_nz r2.z
  ...
  if_nz r2.z
    ...
    if_nz r5.z
      ...
      add r23.x, r14.z, cb9[r4.w + 9].w
      add r23.y, r14.w, cb9[r4.w + 10].x
      mul r14.zw, r23.xxxy, cb9[r4.w + 9].yyyz
      ...
      if_z r5.z
        ...
        mad r22.x, r14.z, cb9[r4.w + 8].y, cb9[r4.w + 8].z
        mad r22.y, r14.w, cb9[r4.w + 8].w, cb9[r4.w + 9].x
    ...
    mad r16.yzw, r3.wwww, r16.yyzw, r20.zzxy
...
ret 
// Approximately 1898 instruction slots used
