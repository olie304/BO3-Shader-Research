...
r0.y = samplerLinear[]..swiz;
  ...
  r10.z = samplerLinear[]..swiz;
    r10.w = cmp((int)r0.z == (int)r10.y);
    bitmask.w = ((~(-1 << r7.w)) << 0) & 0xffffffff;  r13.w = (((uint)0 << 0) & bitmask.w) | ((uint)r10.z & ~bitmask.w);
    r10.z = r10.w ? r13.w : r10.z;
    ...
    while (true) {
      ...
      r18.w = dot(refProbeAttenuationConstantsCB[r16.z].data[1].xyz, r15.yzw);
      r18.w = saturate(refProbeAttenuationConstantsCB[r16.z].data[1].w + r18.w);
      r16.w = r18.w * r16.w;
      r18.w = dot(refProbeAttenuationConstantsCB[r16.z].data[2].xyz, r15.yzw);
      r18.w = saturate(refProbeAttenuationConstantsCB[r16.z].data[2].w + r18.w);
      r16.w = r18.w * r16.w;
      r18.w = dot(refProbeAttenuationConstantsCB[r16.z].data[3].xyz, r15.yzw);
      r18.w = saturate(refProbeAttenuationConstantsCB[r16.z].data[3].w + r18.w);
      r16.w = r18.w * r16.w;
      r18.w = dot(refProbeAttenuationConstantsCB[r16.z].data[4].xyz, r15.yzw);
      r18.w = saturate(refProbeAttenuationConstantsCB[r16.z].data[4].w + r18.w);
      r16.w = r18.w * r16.w;
      r18.w = dot(refProbeAttenuationConstantsCB[r16.z].data[5].xyz, r15.yzw);
      r16.z = saturate(refProbeAttenuationConstantsCB[r16.z].data[5].w + r18.w);
      r18.x = r16.w * r16.z;
      r16.z = 1 & (int)refProbeConstantsCB[r13.w].data[6].x;
      r16.zw = r16.zz ? r18.xy : r18.zx;
      r18.x = refProbeConstantsCB[r13.w].data[6].x;
      r27.xy = r16.zw;
      r18.w = 1;
      while (true) {
        r19.w = cmp((int)r18.w >= (int)r16.y);
        if (r19.w != 0) break;
        r19.w = (int)r14.w + (int)r18.w;
        r19.w = (int)r19.w * 6;
        r20.z = dot(refProbeAttenuationConstantsCB[r19.w].data[0].xyz, r15.yzw);
        r20.z = saturate(refProbeAttenuationConstantsCB[r19.w].data[0].w + r20.z);
        r20.z = r27.x * r20.z;
        r20.w = dot(refProbeAttenuationConstantsCB[r19.w].data[1].xyz, r15.yzw);
        r20.w = saturate(refProbeAttenuationConstantsCB[r19.w].data[1].w + r20.w);
        r20.z = r20.z * r20.w;
        r20.w = dot(refProbeAttenuationConstantsCB[r19.w].data[2].xyz, r15.yzw);
        r20.w = saturate(refProbeAttenuationConstantsCB[r19.w].data[2].w + r20.w);
        r20.z = r20.z * r20.w;
        r20.w = dot(refProbeAttenuationConstantsCB[r19.w].data[3].xyz, r15.yzw);
        r20.w = saturate(refProbeAttenuationConstantsCB[r19.w].data[3].w + r20.w);
        r20.z = r20.z * r20.w;
        r20.w = dot(refProbeAttenuationConstantsCB[r19.w].data[4].xyz, r15.yzw);
        r20.w = saturate(refProbeAttenuationConstantsCB[r19.w].data[4].w + r20.w);
        r20.z = r20.z * r20.w;
        r20.w = dot(refProbeAttenuationConstantsCB[r19.w].data[5].xyz, r15.yzw);
        r19.w = saturate(refProbeAttenuationConstantsCB[r19.w].data[5].w + r20.w);
        r27.x = r20.z * r19.w;
        r20.w = (uint)r18.x >> 2;
        if (1 == 0) r21.w = 0; else if (1+2 < 32) {         r21.w = (uint)r18.x << (32-(1 + 2)); r21.w = (uint)r21.w >> (32-1);        } else r21.w = (uint)r18.x >> 2;
        r22.w = (int)r20.w & 2;
        r27.z = max(r27.y, r27.x);
        r19.w = -r20.z * r19.w + 1;
        r19.w = r27.y * r19.w;
        r20.y = r22.w ? r19.w : r27.z;
        r27.xy = r21.ww ? r27.xy : r20.xy;
        r18.w = (int)r18.w + 1;
        r18.x = r20.w;
      }
      r27.y = saturate(r27.y);
      r14.w = refProbeConstantsCB[r13.w].data[6].y * r27.y;
      r16.y = cmp(0 < r14.w);
      if (r16.y != 0) {
        r26.z = r27.y * refProbeConstantsCB[r13.w].data[6].y + r26.z;
        r14.w = refProbeConstantsCB[r13.w].data[7].y * r14.w;
        r28.x = refProbeConstantsCB[r13.w].data[7].w;
        r28.yz = refProbeConstantsCB[r13.w].data[8].xy;
        r16.y = dot(r17.xyz, r28.xyz);
        r16.z = dot(r15.yzw, r28.xyz);
        ...
        r16.z = r16.w / r16.z;
        r16.y = min(r16.y, abs(r16.z));
        r28.x = refProbeConstantsCB[r13.w].data[3].w + r15.y;
        r28.yz = refProbeConstantsCB[r13.w].data[4].xy + r15.zw;
        r20.yzw = r17.xyz * r16.yyy + r28.xyz;
        r16.z = dot(r20.yzw, r20.yzw);
        r16.z = sqrt(r16.z);
        r16.y = r16.y / r16.z;
        r16.y = r16.y + r16.y;
        r16.y = sqrt(r16.y);
        ...
        r29.w = (uint)r16.z;
        r16.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r29.xyzw, r16.y).xyz;
        r32.x = dot(r15.yzw, r28.xyz);
        r32.y = dot(r15.yzw, r30.xyz);
        r32.z = dot(r15.yzw, r31.xyz);
        r15.yzw = saturate(r32.xyz * refProbeConstantsCB[r13.w].data[3].xyz + float3(0.5,0.5,0.5));
        r32.xy = refProbeConstantsCB[r13.w].data[4].zw * r15.yz;
        r32.z = refProbeConstantsCB[r13.w].data[5].x * r15.w;
        r15.yzw = refProbeConstantsCB[r13.w].data[5].yzw + r32.xyz;
        r29.x = dot(r12.xyz, r28.xyz);
        r29.y = dot(r12.xyz, r30.xyz);
        r29.z = dot(r12.xyz, r31.xyz);
        r20.yzw = cmp(float3(0,0,0) < r29.xyz);
        r19.z = r20.y ? 0 : 0.5;
        r27.xzw = r19.xyz + r15.yzw;
        ...
        r20.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r29.xyzw, 6).xyz;
        r27.xzw = r20.yzw * r15.yzw;
        r13.w = dot(r27.xzw, float3(0.212599993,0.715200007,0.0722000003));
        r25.xyz = r15.yzw * r20.yzw + r25.xyz;
        r15.y = r13.w * r4.w;
        r16.yzw = r16.yzw * r14.www;
        r14.w = dot(r16.yzw, float3(0.212599993,0.715200007,0.0722000003));
        r13.w = r4.w * r13.w + r14.w;
        r13.w = r15.y / r13.w;
        r28.x = r25.w;
        r28.yz = r26.xy;
        r26.xyw = r16.zwy * r13.www + r28.yzx;
        r25.w = r26.w;
      }
    }
    r23.xyzw = r25.xyzw;
  ...
  if (r8.w != 0) {
    ...
    r13.w = samplerLinear[]..swiz;
      r14.w = cmp((int)r0.z == (int)r9.w);
      if (r7.w == 0) r15.y = 0; else if (r7.w+0 < 32) {       r15.y = (uint)r13.w << (32-(r7.w + 0)); r15.y = (uint)r15.y >> (32-r7.w);      } else r15.y = (uint)r13.w >> 0;
      ...
      while (true) {
        ...
        r16.z = (int)r9.w + (int)r16.z;
        r16.z = (int)r16.z * 14;
        r27.xyz = -refProbeConstantsCB[r16.z].data[0].xyz + r11.xyz;
        r16.w = 0x0000ffff & (int)refProbeConstantsCB[r16.z].data[7].z;
        if (6 == 0) r18.w = 0; else if (6+25 < 32) {         r18.w = (uint)refProbeConstantsCB[r16.z].data[7].z << (32-(6 + 25)); r18.w = (uint)r18.w >> (32-6);        } else r18.w = (uint)refProbeConstantsCB[r16.z].data[7].z >> 25;
        r19.w = (int)r16.w * 6;
        r20.z = dot(refProbeAttenuationConstantsCB[r19.w].data[0].xyz, r27.xyz);
        r20.z = saturate(refProbeAttenuationConstantsCB[r19.w].data[0].w + r20.z);
        r20.w = dot(refProbeAttenuationConstantsCB[r19.w].data[1].xyz, r27.xyz);
        r20.w = saturate(refProbeAttenuationConstantsCB[r19.w].data[1].w + r20.w);
        r20.z = r20.z * r20.w;
        r20.w = dot(refProbeAttenuationConstantsCB[r19.w].data[2].xyz, r27.xyz);
        r20.w = saturate(refProbeAttenuationConstantsCB[r19.w].data[2].w + r20.w);
        r20.z = r20.z * r20.w;
        r20.w = dot(refProbeAttenuationConstantsCB[r19.w].data[3].xyz, r27.xyz);
        r20.w = saturate(refProbeAttenuationConstantsCB[r19.w].data[3].w + r20.w);
        r20.z = r20.z * r20.w;
        r20.w = dot(refProbeAttenuationConstantsCB[r19.w].data[4].xyz, r27.xyz);
        r20.w = saturate(refProbeAttenuationConstantsCB[r19.w].data[4].w + r20.w);
        r20.z = r20.z * r20.w;
        r20.w = dot(refProbeAttenuationConstantsCB[r19.w].data[5].xyz, r27.xyz);
        r19.w = saturate(refProbeAttenuationConstantsCB[r19.w].data[5].w + r20.w);
        r18.x = r20.z * r19.w;
        r19.w = 1 & (int)refProbeConstantsCB[r16.z].data[6].x;
        r20.zw = r19.ww ? r18.xy : r18.zx;
        r18.x = refProbeConstantsCB[r16.z].data[6].x;
        r28.xy = r20.zw;
        r19.w = 1;
        while (true) {
          ...
          r21.w = (int)r21.w * 6;
          r22.w = dot(refProbeAttenuationConstantsCB[r21.w].data[0].xyz, r27.xyz);
          ...
          r28.x = r22.w * r21.w;
          r27.w = (uint)r18.x >> 2;
          if (1 == 0) r28.z = 0; else if (1+2 < 32) {           r28.z = (uint)r18.x << (32-(1 + 2)); r28.z = (uint)r28.z >> (32-1);          } else r28.z = (uint)r18.x >> 2;
          r28.w = (int)r27.w & 2;
          r29.x = max(r28.y, r28.x);
          r21.w = -r22.w * r21.w + 1;
          r21.w = r28.y * r21.w;
          r20.y = r28.w ? r21.w : r29.x;
          r28.xy = r28.zz ? r28.xy : r20.xy;
          r19.w = (int)r19.w + 1;
          r18.x = r27.w;
        }
        r16.w = saturate(r28.y + -r14.w);
        r18.x = refProbeConstantsCB[r16.z].data[6].y * r16.w;
        r18.w = cmp(0 < r18.x);
        if (r18.w != 0) {
          r26.w = r16.w * refProbeConstantsCB[r16.z].data[6].y + r26.w;
          r16.w = refProbeConstantsCB[r16.z].data[7].y * r18.x;
          ...
          r18.w = -refProbeConstantsCB[r16.z].data[8].z + r18.w;
          r19.w = cmp(r18.w >= 0);
          ...
          r19.w = -refProbeConstantsCB[r16.z].data[9].z + r19.w;
          r20.y = cmp(r19.w >= 0);
          ...
          r18.w = dot(r17.xyz, r29.xyz);
          r19.w = dot(r27.xyz, r29.xyz);
          r19.w = -refProbeConstantsCB[r16.z].data[10].z + r19.w;
          r20.y = cmp(r19.w >= 0);
          r19.w = max(abs(r19.w), r3.w);
          r19.w = r20.y ? r19.w : -r19.w;
          r18.w = max(1.00000001e-07, -r18.w);
          ...
          r18.w = dot(r17.xyz, r29.xyz);
          r19.w = dot(r27.xyz, r29.xyz);
          r19.w = -refProbeConstantsCB[r16.z].data[11].z + r19.w;
          r20.y = cmp(r19.w >= 0);
          r19.w = max(abs(r19.w), r3.w);
          r19.w = r20.y ? r19.w : -r19.w;
          r18.w = max(1.00000001e-07, -r18.w);
          ...
          r18.w = dot(r17.xyz, r29.xyz);
          r19.w = dot(r27.xyz, r29.xyz);
          r19.w = -refProbeConstantsCB[r16.z].data[12].z + r19.w;
          r20.y = cmp(r19.w >= 0);
          r19.w = max(abs(r19.w), r3.w);
          r19.w = r20.y ? r19.w : -r19.w;
          r18.w = max(1.00000001e-07, -r18.w);
          ...
          r18.w = dot(r17.xyz, r29.xyz);
          r19.w = dot(r27.xyz, r29.xyz);
          r19.w = -refProbeConstantsCB[r16.z].data[13].z + r19.w;
          r20.y = cmp(r19.w >= 0);
          r19.w = max(abs(r19.w), r3.w);
          r19.w = r20.y ? r19.w : -r19.w;
          r18.w = max(1.00000001e-07, -r18.w);
          r18.w = r19.w / r18.w;
          r18.x = min(r18.x, abs(r18.w));
          r29.x = refProbeConstantsCB[r16.z].data[3].w + r27.x;
          r29.yz = refProbeConstantsCB[r16.z].data[4].xy + r27.yz;
          r20.yzw = r17.xyz * r18.xxx + r29.xyz;
          ...
          if (9 == 0) r18.w = 0; else if (9+16 < 32) {           r18.w = (uint)refProbeConstantsCB[r16.z].data[7].z << (32-(9 + 16)); r18.w = (uint)r18.w >> (32-9);          } else r18.w = (uint)refProbeConstantsCB[r16.z].data[7].z >> 16;
          r30.w = (uint)r18.w;
          r20.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r30.xyzw, r18.x).xyz;
          r33.x = dot(r27.xyz, r29.xyz);
          r33.y = dot(r27.xyz, r31.xyz);
          r33.z = dot(r27.xyz, r32.xyz);
          r27.xyz = saturate(r33.xyz * refProbeConstantsCB[r16.z].data[3].xyz + float3(0.5,0.5,0.5));
          r33.xy = refProbeConstantsCB[r16.z].data[4].zw * r27.xy;
          r33.z = refProbeConstantsCB[r16.z].data[5].x * r27.z;
          r27.xyz = refProbeConstantsCB[r16.z].data[5].yzw + r33.xyz;
          ...
          r15.yzw = r27.xyz * r28.xzw + r15.yzw;
          r18.x = r16.z * r4.w;
          r20.yzw = r20.yzw * r16.www;
          r16.w = dot(r20.yzw, float3(0.212599993,0.715200007,0.0722000003));
          r16.z = r4.w * r16.z + r16.w;
          r16.z = r18.x / r16.z;
          r26.xyz = r20.yzw * r16.zzz + r26.xyz;
        }
      }
      r25.xyzw = r26.xyzw;
      r10.yzw = r15.yzw;
      ...
      if (r13.w != 0) {
        ...
        if (r13.w != 0) {
          ...
          if (r13.w != 0) {
            ...
            r25.w = -r14.w * r14.w + lightConstantsCB[r4.w].data[6].y;
            r6.w = r14.w * r20.w + -r6.w;
            r6.w = saturate(r6.w / r25.w);
            r14.w = r25.w / lightConstantsCB[r4.w].data[6].y;
            r14.w = 10 * r14.w;
            r14.w = min(1, r14.w);
            r6.w = r6.w + -r7.w;
            ...
            if (r7.w != 0) {
              ...
              if (r20.w == 0) {
                ...
                if (r19.z == 0) {
                  ...
                  r19.x = lightConstantsCB[r6.w].data[10].z * r14.w;
              ...
              if (r7.w != 0) {
                ...
                if (r19.x == 0) {
                  ...
                  if (r21.x == 0) {
                    ...
                    r19.y = lightConstantsCB[r6.w].data[10].z * r14.w;
                    r7.w = lightConstantsCB[r6.w].data[10].y * r14.w + r7.w;
                    r7.w = r7.w / r19.y;
                  }
                } else {
            ...
            r30.xyz = r30.xyz * r5.zzz + r13.xyz;
            r5.z = dot(r30.xyz, r30.xyz);
            r5.z = rsqrt(r5.z);
            r30.xyz = r30.xyz * r5.zzz;
            r5.z = dot(r30.xyz, r13.xyz);
      ...
      if (r8.w != 0) {
        ...
        if (r9.w != 0) {
          ...
          if (r8.w != 0) {
            ...
            r14.w = lightConstantsCB[r4.w].data[12].y * r21.z + -1;
        ...
        if (r8.w != 0) {
          ...
          if (r9.w != 0) {
            ...
            if (r14.w != 0) {
              ...
              r23.xyz = r12.xyz * r14.www + r11.xyz;
              ...
              if (r20.y == 0) {
                ...
                if (r22.x == 0) {
                  ...
                  r14.w = lightConstantsCB[r12.w].data[10].y * r20.x + r14.w;
                  r14.w = r14.w / r21.y;
                }
              } else {
                r22.x = -1;
              ...
              if (r12.w != 0) {
                ...
                if (r20.x == 0) {
                  ...
                  if (r22.x == 0) {
                    ...
                    r21.y = lightConstantsCB[r4.w].data[10].z * r14.w;
            ...
            r19.xyz = r19.xyz * r5.zzz + r13.xyz;
            r4.w = dot(r19.xyz, r19.xyz);
            r4.w = rsqrt(r4.w);
            r19.xyz = r19.xyz * r4.www;
            r4.w = dot(r19.xyz, r13.xyz);
