...
mad r5.w, r2.x, r1.w, r4.z
mul r1.w, r1.w, r5.w
mul r4.z, r4.z, r5.w
ftou r5.w, cb1[44].x
iadd r5.w, r5.w, l(7)
ushr r5.w, r5.w, l(3)
imad r0.x, r0.y, r5.w, r0.x
ishl r0.x, r0.x, l(5)
not r0.y, r9.z
mov r19.x, -r13.x
...
ret 
// Approximately 993 instruction slots used
