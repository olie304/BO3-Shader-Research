...
r0.y = samplerLinear[]..swiz;
  ...
  r0.y = (uint)r0.y >> 24;
  r8.w = cmp((uint)r0.y >= (uint)r7.w);
  r9.w = cmp((uint)r0.y < numRefProbes);
  r8.w = r8.w ? r9.w : 0;
  if (r8.w != 0) {
    r8.w = (int)r0.y * 14;
    if (r2.z != 0) {
      r17.yzw = refProbeConstantsCB[r8.w].data[0].xyz + eyeOffset.xyz;
      r17.x = 16;
      GBufferDiffuseColor[viewID].880 = u2.xyzw;
    }
    r14.yzw = -refProbeConstantsCB[r8.w].data[0].xyz + r11.xyz;
    ...
    r15.w = 1;
    while (true) {
      r17.z = cmp((int)r15.w >= (int)r10.w);
      if (r17.z != 0) break;
      r17.z = (int)r9.w + (int)r15.w;
      r17.z = (int)r17.z * 6;
    ...
    r9.w = refProbeConstantsCB[r8.w].data[6].y * r18.y;
    r10.w = cmp(0 < r9.w);
    if (r10.w != 0) {
      if (r2.z != 0) {
      // Known bad code for instruction (needs manual fix):
      ...
      r17.x = refProbeConstantsCB[r8.w].data[7].w;
      r17.yz = refProbeConstantsCB[r8.w].data[8].xy;
      r13.w = dot(r16.xyz, r17.xyz);
      r15.y = dot(r14.yzw, r17.xyz);
      r15.y = -refProbeConstantsCB[r8.w].data[8].z + r15.y;
      r15.z = cmp(r15.y >= 0);
      ...
      r17.x = refProbeConstantsCB[r8.w].data[8].w;
      r17.yz = refProbeConstantsCB[r8.w].data[9].xy;
      r15.y = dot(r16.xyz, r17.xyz);
      r15.z = dot(r14.yzw, r17.xyz);
      r15.z = -refProbeConstantsCB[r8.w].data[9].z + r15.z;
      r15.w = cmp(r15.z >= 0);
      ...
      r17.x = refProbeConstantsCB[r8.w].data[9].w;
      r17.yz = refProbeConstantsCB[r8.w].data[10].xy;
      r15.y = dot(r16.xyz, r17.xyz);
      r15.z = dot(r14.yzw, r17.xyz);
      r15.z = -refProbeConstantsCB[r8.w].data[10].z + r15.z;
      r15.w = cmp(r15.z >= 0);
      r15.z = max(abs(r15.z), r4.w);
      r15.z = r15.w ? r15.z : -r15.z;
      r15.y = max(1.00000001e-07, -r15.y);
      r15.y = r15.z / r15.y;
      r13.w = min(abs(r15.y), r13.w);
      r17.x = refProbeConstantsCB[r8.w].data[10].w;
      r17.yz = refProbeConstantsCB[r8.w].data[11].xy;
      r15.y = dot(r16.xyz, r17.xyz);
      r15.z = dot(r14.yzw, r17.xyz);
      r15.z = -refProbeConstantsCB[r8.w].data[11].z + r15.z;
      r15.w = cmp(r15.z >= 0);
      r15.z = max(abs(r15.z), r4.w);
      r15.z = r15.w ? r15.z : -r15.z;
      r15.y = max(1.00000001e-07, -r15.y);
      r15.y = r15.z / r15.y;
      r13.w = min(abs(r15.y), r13.w);
      r17.x = refProbeConstantsCB[r8.w].data[11].w;
      r17.yz = refProbeConstantsCB[r8.w].data[12].xy;
      r15.y = dot(r16.xyz, r17.xyz);
      r15.z = dot(r14.yzw, r17.xyz);
      r15.z = -refProbeConstantsCB[r8.w].data[12].z + r15.z;
      r15.w = cmp(r15.z >= 0);
      r15.z = max(abs(r15.z), r4.w);
      r15.z = r15.w ? r15.z : -r15.z;
      r15.y = max(1.00000001e-07, -r15.y);
      r15.y = r15.z / r15.y;
      r13.w = min(abs(r15.y), r13.w);
      r17.x = refProbeConstantsCB[r8.w].data[12].w;
      r17.yz = refProbeConstantsCB[r8.w].data[13].xy;
      r15.y = dot(r16.xyz, r17.xyz);
      r15.z = dot(r14.yzw, r17.xyz);
      r15.z = -refProbeConstantsCB[r8.w].data[13].z + r15.z;
      r15.w = cmp(r15.z >= 0);
      r15.z = max(abs(r15.z), r4.w);
      r15.z = r15.w ? r15.z : -r15.z;
      r15.y = max(1.00000001e-07, -r15.y);
      r15.y = r15.z / r15.y;
      r13.w = min(abs(r15.y), r13.w);
      r17.x = refProbeConstantsCB[r8.w].data[3].w + r14.y;
      r17.yz = refProbeConstantsCB[r8.w].data[4].xy + r14.zw;
      ...
      r17.x = refProbeConstantsCB[r8.w].data[0].w;
      r17.y = refProbeConstantsCB[r8.w].data[1].z;
      r17.z = refProbeConstantsCB[r8.w].data[2].y;
      r18.x = dot(r15.yzw, r17.xyz);
      r19.xy = refProbeConstantsCB[r8.w].data[1].xw;
      r19.z = refProbeConstantsCB[r8.w].data[2].z;
      r18.y = dot(r15.yzw, r19.xyz);
      r20.x = refProbeConstantsCB[r8.w].data[1].y;
      r20.yz = refProbeConstantsCB[r8.w].data[2].xw;
      r18.z = dot(r15.yzw, r20.xyz);
      if (9 == 0) r15.y = 0; else if (9+16 < 32) {       r15.y = (uint)refProbeConstantsCB[r8.w].data[7].z << (32-(9 + 16)); r15.y = (uint)r15.y >> (32-9);      } else r15.y = (uint)refProbeConstantsCB[r8.w].data[7].z >> 16;
      r18.w = (uint)r15.y;
      ...
      r13.w = (int)r21.y | (int)r21.x;
      r13.w = (int)r21.z | (int)r13.w;
      r15.yzw = r13.www ? float3(1,1,0) : r15.yzw;
      r21.x = dot(r14.yzw, r17.xyz);
      r21.y = dot(r14.yzw, r19.xyz);
      r21.z = dot(r14.yzw, r20.xyz);
      r14.yzw = saturate(r21.xyz * refProbeConstantsCB[r8.w].data[3].xyz + float3(0.5,0.5,0.5));
      r21.xy = refProbeConstantsCB[r8.w].data[4].zw * r14.yz;
      r21.z = refProbeConstantsCB[r8.w].data[5].x * r14.w;
      r14.yzw = refProbeConstantsCB[r8.w].data[5].yzw + r21.xyz;
  ...
  if (r7.w != 0) {
    ...
    r10.w = saturate(r20.y + -r9.w);
    r13.w = refProbeConstantsCB[r0.y].data[6].y * r10.w;
    r17.w = cmp(0 < r13.w);
    if (r17.w != 0) {
      r17.w = (int)r7.w & 3;
      r18.x = (int)r17.w + -1;
      ...
      r18.x = r2.z ? r18.x : 0;
      if (r18.x != 0) {
        r18.xy = mad((int2)r17.ww, int2(20,20), int2(860,876));
      // Known bad code for instruction (needs manual fix):
      ...
      r7.w = (int)r8.w + 257;
      r10.w = r10.w * refProbeConstantsCB[r0.y].data[6].y + r9.w;
      ...
      r18.y = cmp(r18.x >= 0);
      r4.w = max(abs(r18.x), r4.w);
      r4.w = r18.y ? r4.w : -r4.w;
      r18.x = max(1.00000001e-07, -r18.w);
      r4.w = r4.w / r18.x;
      r4.w = min(r17.w, abs(r4.w));
      r18.x = refProbeConstantsCB[r0.y].data[3].w + r17.x;
      r18.yz = refProbeConstantsCB[r0.y].data[4].xy + r17.yz;
      r18.xyz = r16.xyz * r4.www + r18.xyz;
      ...
      if (9 == 0) r4.w = 0; else if (9+16 < 32) {       r4.w = (uint)refProbeConstantsCB[r0.y].data[7].z << (32-(9 + 16)); r4.w = (uint)r4.w >> (32-9);      } else r4.w = (uint)refProbeConstantsCB[r0.y].data[7].z >> 16;
      r20.w = (uint)r4.w;
  ...
  r0.y = cmp(r9.w >= 1);
  bitmask.w = ((~(-1 << 8)) << 0) & 0xffffffff;  r2.w = (((uint)r7.w << 0) & bitmask.w) | ((uint)r8.w & ~bitmask.w);
  r0.y = r0.y ? r2.w : r7.w;
  r2.w = max(1, r10.w);
  r2.w = rcp(r2.w);
