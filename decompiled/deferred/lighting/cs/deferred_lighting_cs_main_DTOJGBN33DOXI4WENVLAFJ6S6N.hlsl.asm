...
if_nz r27.z
  ...
  loop 
    ...
    dp3 r27.y, cb11[r21.w + 0].xyzx, r15.xyzx
    add_sat r27.y, r27.y, cb11[r21.w + 0].w
    mul r27.y, r27.y, r32.x
    dp3 r28.w, cb11[r21.w + 1].xyzx, r15.xyzx
    add_sat r28.w, r28.w, cb11[r21.w + 1].w
    mul r27.y, r27.y, r28.w
    dp3 r28.w, cb11[r21.w + 2].xyzx, r15.xyzx
    add_sat r28.w, r28.w, cb11[r21.w + 2].w
    mul r27.y, r27.y, r28.w
    dp3 r28.w, cb11[r21.w + 3].xyzx, r15.xyzx
    add_sat r28.w, r28.w, cb11[r21.w + 3].w
    mul r27.y, r27.y, r28.w
    dp3 r28.w, cb11[r21.w + 4].xyzx, r15.xyzx
    add_sat r28.w, r28.w, cb11[r21.w + 4].w
    mul r27.y, r27.y, r28.w
    dp3 r28.w, cb11[r21.w + 5].xyzx, r15.xyzx
    add_sat r21.w, r28.w, cb11[r21.w + 5].w
  ...
  if_nz r15.w
    ...
    mul r15.w, r20.y, r31.w
    dp3 r16.w, r13.xyzx, r21.xyzx
    dp3 r17.w, r15.xyzx, r21.xyzx
    ...
    dp3 r17.w, r13.xyzx, r22.xyzx
    dp3 r18.w, r15.xyzx, r22.xyzx
    ...
    mad r19.xyz, r13.xyzx, r16.wwww, r19.xyzx
    ...
    dp3 r21.x, r15.xyzx, r30.xyzx
    dp3 r21.y, r15.xyzx, r16.xyzx
    dp3 r21.z, r15.xyzx, r28.xyzx
    mad_sat r15.xyz, r21.xyzx, r17.xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
    mad r15.xyz, r15.xyzx, r18.xyzx, r29.xyzx
    ...
    mad r15.xyz, r15.xyzx, r18.zzzz, r16.xywx
    ...
    mul r15.y, r14.w, r15.x
    mul r16.xyz, r15.wwww, r19.xyzx
    dp3 r15.z, r16.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
    mad r15.x, r14.w, r15.x, r15.z
    div r15.x, r15.y, r15.x
    mul r31.xyz, r15.xxxx, r16.xyzx
    mov r15.x, l(257)
  else 
...
if_z r15.y
  ...
  loop 
    ...
    loop 
      ...
      if_nz r20.y
        ...
        mad r28.xyz, r13.xyzx, r20.yyyy, r28.xyzx
  ...
  loop 
    ...
    loop 
      ...
      if_nz r21.w
        ...
        mad r32.xzw, r13.xxyz, r20.wwww, r33.xxyz
  ...
  endloop 
  ge r8.w, r24.z, l(1.000000)
  and r12.w, r24.w, l(0x0000ff00)
  bfi r12.w, l(8), l(0), r26.y, r12.w
  movc r15.x, r8.w, r12.w, r26.y
  max r8.w, r26.x, l(1.000000)
  rcp r8.w, r8.w
  mov_sat r26.x, r26.x
  mul r15.yzw, r8.wwww, r16.yyzw
  mul r31.xyz, r8.wwww, r25.xyzx
  lt r12.w, r26.x, l(0.990000)
  if_nz r12.w
    iadd r15.x, r15.x, l(256)
    add r12.w, -r26.x, l(1.000000)
    mul r14.w, r12.w, cb2[19].x
    ...
    mad r15.yzw, r16.yyzw, r8.wwww, r17.xxyz
    mov r13.w, l(0)
    sample_l_indexable(texturecubearray)(float,float,float,float) r13.xyz, r13.xyzw, t8.xyzw, s2, r10.w
    mad r8.w, cb2[19].x, r12.w, -r11.w
    mad r8.w, r2.y, r8.w, r11.w
    mad r31.xyz, r13.xyzx, r8.wwww, r31.xyzx
  endif 
else 
  mov r15.yzw, l(0,0,0,0)
endif 
...
if_nz r1.w
  ...
  if_nz r1.w
    ...
    mad r15.yzw, r15.yyzw, r3.zzzz, r19.xxyz
    ...
    movc r14.xyz, r2.xxxx, r15.yzwy, r14.xyzx
...
if_nz cb2[52].y
  if_nz cb2[53].y
    switch cb2[53].y
      ...
      break 
      case l(4)
      and r0.w, r15.x, l(255)
      break 
      case l(5)
      ubfe r0.w, l(8), l(8), r15.x
      break 
      default 
      mov r0.w, l(0)
      break 
...
if_nz cb2[52].y
  ...
  and r1.x, r15.x, l(255)
  atomic_iadd g1, l(12), r1.x
  ubfe r1.y, l(8), l(8), r15.x
...
ret 
// Approximately 2235 instruction slots used
