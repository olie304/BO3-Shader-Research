...
loop 
  ieq r5.w, r4.z, l(2)
  breakc_nz r5.w
  movc r5.w, r4.z, r0.y, r3.z
  uge r6.w, r5.w, r3.y
  ult r7.w, r5.w, cb2[0].y
  and r6.w, r6.w, r7.w
  if_nz r6.w
    imul null, r5.w, r5.w, l(14)
    if_nz r1.z
      and r6.w, r20.w, l(3)
      imad r6.w, r6.w, l(20), l(880)
      add r13.yzw, cb1[24].xxyz, cb10[r5.w + 0].xxyz
      store_structured u2.xyzw, cb2[52].x, r6.w, r13.xyzw
    endif 
    iadd r21.w, r20.w, l(1)
    add r13.yzw, r10.xxyz, -cb10[r5.w + 0].xxyz
    and r6.w, l(0x0000ffff), cb10[r5.w + 7].z
    ubfe r7.w, l(6), l(25), cb10[r5.w + 7].z
    imul null, r8.w, r6.w, l(6)
    dp3 r9.w, cb11[r8.w + 0].xyzx, r13.yzwy
    add_sat r9.w, r9.w, cb11[r8.w + 0].w
    dp3 r10.w, cb11[r8.w + 1].xyzx, r13.yzwy
    add_sat r10.w, r10.w, cb11[r8.w + 1].w
    mul r9.w, r9.w, r10.w
    dp3 r10.w, cb11[r8.w + 2].xyzx, r13.yzwy
    add_sat r10.w, r10.w, cb11[r8.w + 2].w
    mul r9.w, r9.w, r10.w
    dp3 r10.w, cb11[r8.w + 3].xyzx, r13.yzwy
    add_sat r10.w, r10.w, cb11[r8.w + 3].w
    mul r9.w, r9.w, r10.w
    dp3 r10.w, cb11[r8.w + 4].xyzx, r13.yzwy
    add_sat r10.w, r10.w, cb11[r8.w + 4].w
    mul r9.w, r9.w, r10.w
    dp3 r10.w, cb11[r8.w + 5].xyzx, r13.yzwy
    add_sat r8.w, r10.w, cb11[r8.w + 5].w
    mul r14.x, r8.w, r9.w
    and r8.w, l(1), cb10[r5.w + 6].x
    movc r14.xw, r8.wwww, r14.xxxy, r14.zzzx
    ...
    loop 
      ...
      dp3 r17.w, cb11[r10.w + 1].xyzx, r13.yzwy
      add_sat r17.w, r17.w, cb11[r10.w + 1].w
      mul r15.w, r15.w, r17.w
      dp3 r17.w, cb11[r10.w + 2].xyzx, r13.yzwy
      add_sat r17.w, r17.w, cb11[r10.w + 2].w
      mul r15.w, r15.w, r17.w
      dp3 r17.w, cb11[r10.w + 3].xyzx, r13.yzwy
      add_sat r17.w, r17.w, cb11[r10.w + 3].w
      mul r15.w, r15.w, r17.w
      dp3 r17.w, cb11[r10.w + 4].xyzx, r13.yzwy
      add_sat r17.w, r17.w, cb11[r10.w + 4].w
      mul r15.w, r15.w, r17.w
      dp3 r17.w, cb11[r10.w + 5].xyzx, r13.yzwy
      add_sat r10.w, r17.w, cb11[r10.w + 5].w
      mul r22.x, r10.w, r15.w
      ushr r17.w, r8.w, l(2)
      ubfe r18.w, l(1), l(2), r8.w
      and r22.z, r17.w, l(2)
      max r22.w, r22.x, r22.y
      mad r10.w, -r15.w, r10.w, l(1.000000)
      mul r10.w, r10.w, r22.y
      movc r16.y, r22.z, r10.w, r22.w
      movc r22.xy, r18.wwww, r22.xyxx, r16.xyxx
      iadd r9.w, r9.w, l(1)
      mov r8.w, r17.w
    endloop 
    mov_sat r22.y, r22.y
    mul r6.w, r22.y, cb10[r5.w + 6].y
    ...
    if_nz r7.w
      ...
      and r8.w, r1.z, r8.w
      if_nz r8.w
        imad r14.xw, r7.wwww, l(20, 0, 0, 20), l(860, 0, 0, 876)
        ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r7.w, cb2[52].x, r14.x, u2.xxxx
        or r7.w, r7.w, l(32)
        store_structured u2.x, cb2[52].x, r14.x, r7.w
        store_structured u2.x, cb2[52].x, r14.w, r6.w
      endif 
      iadd r20.w, r20.w, l(257)
      mad r20.z, r22.y, cb10[r5.w + 6].y, r20.z
      mul r6.w, r6.w, cb10[r5.w + 7].y
      mov r23.x, cb10[r5.w + 7].w
      mov r23.yz, cb10[r5.w + 8].xxyx
      dp3 r7.w, r12.xyzx, r23.xyzx
      dp3 r8.w, r13.yzwy, r23.xyzx
      add r8.w, r8.w, -cb10[r5.w + 8].z
      ...
      mov r23.x, cb10[r5.w + 8].w
      mov r23.yz, cb10[r5.w + 9].xxyx
      dp3 r8.w, r12.xyzx, r23.xyzx
      dp3 r9.w, r13.yzwy, r23.xyzx
      add r9.w, r9.w, -cb10[r5.w + 9].z
      ...
      div r8.w, r9.w, r8.w
      min r7.w, r7.w, |r8.w|
      mov r23.x, cb10[r5.w + 9].w
      mov r23.yz, cb10[r5.w + 10].xxyx
      dp3 r8.w, r12.xyzx, r23.xyzx
      dp3 r9.w, r13.yzwy, r23.xyzx
      add r9.w, r9.w, -cb10[r5.w + 10].z
      ge r10.w, r9.w, l(0.000000)
      max r9.w, r2.w, |r9.w|
      movc r9.w, r10.w, r9.w, -r9.w
      max r8.w, -r8.w, l(0.00000010)
      div r8.w, r9.w, r8.w
      min r7.w, r7.w, |r8.w|
      mov r23.x, cb10[r5.w + 10].w
      mov r23.yz, cb10[r5.w + 11].xxyx
      dp3 r8.w, r12.xyzx, r23.xyzx
      dp3 r9.w, r13.yzwy, r23.xyzx
      add r9.w, r9.w, -cb10[r5.w + 11].z
      ge r10.w, r9.w, l(0.000000)
      max r9.w, r2.w, |r9.w|
      movc r9.w, r10.w, r9.w, -r9.w
      max r8.w, -r8.w, l(0.00000010)
      div r8.w, r9.w, r8.w
      min r7.w, r7.w, |r8.w|
      mov r23.x, cb10[r5.w + 11].w
      mov r23.yz, cb10[r5.w + 12].xxyx
      dp3 r8.w, r12.xyzx, r23.xyzx
      dp3 r9.w, r13.yzwy, r23.xyzx
      add r9.w, r9.w, -cb10[r5.w + 12].z
      ge r10.w, r9.w, l(0.000000)
      max r9.w, r2.w, |r9.w|
      movc r9.w, r10.w, r9.w, -r9.w
      max r8.w, -r8.w, l(0.00000010)
      div r8.w, r9.w, r8.w
      min r7.w, r7.w, |r8.w|
      mov r23.x, cb10[r5.w + 12].w
      mov r23.yz, cb10[r5.w + 13].xxyx
      dp3 r8.w, r12.xyzx, r23.xyzx
      dp3 r9.w, r13.yzwy, r23.xyzx
      add r9.w, r9.w, -cb10[r5.w + 13].z
      ge r10.w, r9.w, l(0.000000)
      max r9.w, r2.w, |r9.w|
      movc r9.w, r10.w, r9.w, -r9.w
      max r8.w, -r8.w, l(0.00000010)
      div r8.w, r9.w, r8.w
      min r7.w, r7.w, |r8.w|
      add r23.x, r13.y, cb10[r5.w + 3].w
      add r23.yz, r13.zzwz, cb10[r5.w + 4].xxyx
      mad r22.xzw, r12.xxyz, r7.wwww, r23.xxyz
      dp3 r8.w, r22.xzwx, r22.xzwx
      sqrt r8.w, r8.w
      div r7.w, r7.w, r8.w
      add r7.w, r7.w, r7.w
      sqrt r7.w, r7.w
      ...
      mov r23.x, cb10[r5.w + 0].w
      mov r23.y, cb10[r5.w + 1].z
      mov r23.z, cb10[r5.w + 2].y
      dp3 r24.x, r22.xzwx, r23.xyzx
      mov r25.xy, cb10[r5.w + 1].xwxx
      mov r25.z, cb10[r5.w + 2].z
      dp3 r24.y, r22.xzwx, r25.xyzx
      mov r26.x, cb10[r5.w + 1].y
      mov r26.yz, cb10[r5.w + 2].xxwx
      dp3 r24.z, r22.xzwx, r26.xyzx
      ubfe r8.w, l(9), l(16), cb10[r5.w + 7].z
      utof r24.w, r8.w
      sample_l_indexable(texturecubearray)(float,float,float,float) r22.xzw, r24.xyzw, t8.xwyz, s2, r7.w
      and r27.xyz, r22.xzwx, l(0x7fffffff, 0x7fffffff, 0x7fffffff, 0)
      ieq r27.xyz, r27.xyzx, l(0x7f800000, 0x7f800000, 0x7f800000, 0)
      or r7.w, r27.y, r27.x
      or r7.w, r27.z, r7.w
      movc r22.xzw, r7.wwww, l(1.000000,0,1.000000,0), r22.xxzw
      dp3 r27.x, r13.yzwy, r23.xyzx
      dp3 r27.y, r13.yzwy, r25.xyzx
      dp3 r27.z, r13.yzwy, r26.xyzx
      mad_sat r13.yzw, r27.xxyz, cb10[r5.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
      mul r27.xy, r13.yzyy, cb10[r5.w + 4].zwzz
      mul r27.z, r13.w, cb10[r5.w + 5].x
      add r13.yzw, r27.xxyz, cb10[r5.w + 5].yyzw
      ...
      mul r7.w, r3.x, r5.w
      mul r13.yzw, r6.wwww, r22.xxzw
      dp3 r6.w, r13.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r5.w, r3.x, r5.w, r6.w
      div r5.w, r7.w, r5.w
      mov r23.x, r19.w
      mov r23.yz, r20.xxyx
      mad r13.yzw, r13.yyzw, r5.wwww, r23.xxyz
      mov r19.w, r13.y
      mov r20.xy, r13.zwzz
    else 
...
loop 
  ...
  if_nz r6.w
    ...
    loop 
      ...
      dp3 r17.w, cb11[r10.w + 5].xyzx, r13.yzwy
      add_sat r10.w, r17.w, cb11[r10.w + 5].w
      mul r24.x, r10.w, r15.w
      ushr r17.w, r8.w, l(2)
      ubfe r18.w, l(1), l(2), r8.w
      and r21.w, r17.w, l(2)
      max r22.w, r24.x, r24.y
      mad r10.w, -r15.w, r10.w, l(1.000000)
      mul r10.w, r10.w, r24.y
      movc r16.w, r21.w, r10.w, r22.w
      movc r24.xy, r18.wwww, r24.xyxx, r16.zwzz
      iadd r9.w, r9.w, l(1)
      mov r8.w, r17.w
    endloop 
    add_sat r6.w, -r20.z, r24.y
    mul r7.w, r6.w, cb10[r5.w + 6].y
    ...
    if_nz r8.w
      ...
      mad r16.x, r6.w, cb10[r5.w + 6].y, r16.x
      mul r6.w, r7.w, cb10[r5.w + 7].y
      mov r25.x, cb10[r5.w + 7].w
      mov r25.yz, cb10[r5.w + 8].xxyx
      dp3 r7.w, r12.xyzx, r25.xyzx
      dp3 r8.w, r13.yzwy, r25.xyzx
      add r8.w, r8.w, -cb10[r5.w + 8].z
      ge r9.w, r8.w, l(0.000000)
      max r8.w, r2.w, |r8.w|
      movc r8.w, r9.w, r8.w, -r8.w
      ...
      div r7.w, r8.w, r7.w
      min r7.w, |r7.w|, l(131072.000000)
      mov r25.x, cb10[r5.w + 8].w
      mov r25.yz, cb10[r5.w + 9].xxyx
      ...
      div r8.w, r9.w, r8.w
      min r7.w, r7.w, |r8.w|
      mov r25.x, cb10[r5.w + 9].w
      mov r25.yz, cb10[r5.w + 10].xxyx
      dp3 r8.w, r12.xyzx, r25.xyzx
      dp3 r9.w, r13.yzwy, r25.xyzx
      add r9.w, r9.w, -cb10[r5.w + 10].z
      ge r10.w, r9.w, l(0.000000)
      ...
      div r8.w, r9.w, r8.w
      min r7.w, r7.w, |r8.w|
      mov r25.x, cb10[r5.w + 10].w
      mov r25.yz, cb10[r5.w + 11].xxyx
      dp3 r8.w, r12.xyzx, r25.xyzx
      dp3 r9.w, r13.yzwy, r25.xyzx
      add r9.w, r9.w, -cb10[r5.w + 11].z
      ge r10.w, r9.w, l(0.000000)
      ...
      div r8.w, r9.w, r8.w
      min r7.w, r7.w, |r8.w|
      mov r25.x, cb10[r5.w + 11].w
      mov r25.yz, cb10[r5.w + 12].xxyx
      dp3 r8.w, r12.xyzx, r25.xyzx
      dp3 r9.w, r13.yzwy, r25.xyzx
      add r9.w, r9.w, -cb10[r5.w + 12].z
      ge r10.w, r9.w, l(0.000000)
      ...
      div r8.w, r9.w, r8.w
      min r7.w, r7.w, |r8.w|
      mov r25.x, cb10[r5.w + 12].w
      mov r25.yz, cb10[r5.w + 13].xxyx
      dp3 r8.w, r12.xyzx, r25.xyzx
      dp3 r9.w, r13.yzwy, r25.xyzx
      add r9.w, r9.w, -cb10[r5.w + 13].z
      ge r10.w, r9.w, l(0.000000)
      ...
      div r8.w, r9.w, r8.w
      min r7.w, r7.w, |r8.w|
      add r25.x, r13.y, cb10[r5.w + 3].w
      add r25.yz, r13.zzwz, cb10[r5.w + 4].xxyx
      mad r24.xzw, r12.xxyz, r7.wwww, r25.xxyz
      dp3 r8.w, r24.xzwx, r24.xzwx
      sqrt r8.w, r8.w
      div r7.w, r7.w, r8.w
      add r7.w, r7.w, r7.w
      sqrt r7.w, r7.w
      mad r7.w, r1.w, l(5.000000), r7.w
      add r7.w, r7.w, l(-0.844800)
      mov r25.x, cb10[r5.w + 0].w
      mov r25.y, cb10[r5.w + 1].z
      mov r25.z, cb10[r5.w + 2].y
      dp3 r26.x, r24.xzwx, r25.xyzx
      mov r27.xy, cb10[r5.w + 1].xwxx
      mov r27.z, cb10[r5.w + 2].z
      dp3 r26.y, r24.xzwx, r27.xyzx
      mov r28.x, cb10[r5.w + 1].y
      mov r28.yz, cb10[r5.w + 2].xxwx
      dp3 r26.z, r24.xzwx, r28.xyzx
      ubfe r8.w, l(9), l(16), cb10[r5.w + 7].z
      utof r26.w, r8.w
      sample_l_indexable(texturecubearray)(float,float,float,float) r24.xzw, r26.xyzw, t8.xwyz, s2, r7.w
      and r29.xyz, r24.xzwx, l(0x7fffffff, 0x7fffffff, 0x7fffffff, 0)
      ieq r29.xyz, r29.xyzx, l(0x7f800000, 0x7f800000, 0x7f800000, 0)
      or r7.w, r29.y, r29.x
      or r7.w, r29.z, r7.w
      movc r24.xzw, r7.wwww, l(1.000000,0,1.000000,0), r24.xxzw
      dp3 r29.x, r13.yzwy, r25.xyzx
      dp3 r29.y, r13.yzwy, r27.xyzx
      dp3 r29.z, r13.yzwy, r28.xyzx
      mad_sat r13.yzw, r29.xxyz, cb10[r5.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
      mul r29.xy, r13.yzyy, cb10[r5.w + 4].zwzz
      mul r29.z, r13.w, cb10[r5.w + 5].x
      add r13.yzw, r29.xxyz, cb10[r5.w + 5].yyzw
      ...
      or r5.w, r26.y, r26.x
      or r5.w, r26.z, r5.w
      movc r25.xyz, r5.wwww, l(1.000000,1.000000,0,0), r25.xyzx
      mul r26.xyz, r13.yzwy, r25.xyzx
      dp3 r5.w, r26.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r21.xyz, r13.yzwy, r25.xyzx, r21.xyzx
      mul r7.w, r3.x, r5.w
      mul r13.yzw, r6.wwww, r24.xxzw
      dp3 r6.w, r13.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r5.w, r3.x, r5.w, r6.w
      div r5.w, r7.w, r5.w
      mad r22.xyz, r13.yzwy, r5.wwww, r22.xyzx
    else 
      mov r23.x, r16.x
      mov r16.xy, r23.xyxx
    endif 
...
if_nz r2.w
  ...
  mad r3.xyz, r21.xyzx, r1.wwww, r11.xyzx
  mov r12.w, l(0)
  ...
  mad r13.xyz, r11.xyzx, r1.wwww, r13.xyzx
endif 
add r1.w, r3.w, r2.x
log r1.w, |r1.w|
mul r0.w, r0.w, r1.w
...
ret 
// Approximately 923 instruction slots used
