...
add r1.z, r1.z, r1.z
mad r14.xyz, r12.xyzx, -r1.zzzz, -r10.yzwy
...
if_z r3.w
  ...
  if_z r8.w
    if_z cb2[58].y
      ...
      itof r8.w, cb2[26].y
      add r15.z, r6.w, r8.w
      sample_c_lz_indexable(texture2darray)(float,float,float,float) r8.w, r15.xyzx, t13.xxxx, s13, r3.w
    ...
    if_nz cb2[58].y
      ...
      loop 
        uge r15.w, r13.w, l(8)
        breakc_nz r15.w
        ult r15.w, r7.w, r13.w
        movc r16.zw, r15.wwww, r13.yyyz, r16.xxxy
        movc r17.x, r15.w, cb2[r6.w + 20].w, cb2[r8.w + 20].w
        movc r15.w, r15.w, r6.w, r8.w
        ...
        utof r17.z, r15.w
        sample_c_lz_indexable(texture2darray)(float,float,float,float) r15.w, r17.xyzx, t13.xxxx, s13, r3.w
...
imad r0.y, r0.z, r13.y, r0.y
bfi r0.y, l(27), l(5), r0.y, l(16)
and r0.z, r9.w, l(-32)
iadd r13.y, -r0.z, r9.w
...
loop 
  ...
  loop 
    ...
    add r24.xyz, r11.xyzx, -cb10[r17.w + 0].xyzx
...
if_nz r3.w
  ...
  if_nz r3.w
    ...
    mul r3.w, r3.z, r3.w
    if_nz cb2[23].x
      add r17.xyz, r11.xyzx, cb1[24].xyzx
      mov r17.w, l(1.000000)
      dp4 r5.z, cb2[24].xyzw, r17.xyzw
    ...
    if_nz r6.w
      ...
      mov r18.xyz, cb9[r5.z + 4].yzwy
      mov r18.w, cb9[r5.z + 5].x
      mov r17.w, l(1.000000)
      dp4 r18.x, r18.xyzw, r17.xyzw
      mov r19.xyz, cb9[r5.z + 5].yzwy
      mov r19.w, cb9[r5.z + 6].x
      ...
      add r19.x, r18.x, cb9[r5.z + 9].w
      add r19.y, r18.y, cb9[r5.z + 10].x
      mul r18.xy, r19.xyxx, cb9[r5.z + 9].yzyy
      div r18.zw, cb9[r5.z + 3].yyyy, cb9[r5.z + 8].yyyw
      ...
      if_z r6.w
        ...
        mad r17.x, r18.x, cb9[r5.z + 8].y, cb9[r5.z + 8].z
        mad r17.y, r18.y, cb9[r5.z + 8].w, cb9[r5.z + 9].x
        ...
        if_nz cb2[58].y
          ...
          loop 
            ...
            mad r19.xy, r20.xyxx, cb9[r5.z + 3].yyyy, r17.xyxx
    ...
    mad r17.xyz, r5.zzzz, r13.yzwy, r16.xyzx
    mad r18.xyz, -r11.xyzx, r0.wwww, cb2[17].xyzx
    dp3 r0.w, r18.xyzx, r18.xyzx
    rsq r0.w, r0.w
    mul r18.xyz, r0.wwww, r18.xyzx
    dp3 r0.w, r18.xyzx, r10.yzwy
    dp3 r5.z, r12.xyzx, r18.xyzx
    ...
    mad r18.xyz, r3.zzzz, r13.yzwy, r2.yzwy
    add_sat r0.w, -r0.w, l(1.000000)
    mul r3.w, r0.w, r0.w
    mul r3.w, r3.w, r3.w
    mul r0.w, r0.w, r3.w
    mul r0.w, r0.w, r3.z
    mad r19.xyz, r0.wwww, r13.zwyz, r15.xyzx
    mov r17.w, r19.z
    mov r16.w, r15.z
    movc r16.xyzw, r3.yyyy, r17.xyzw, r16.xyzw
    mov r19.zw, r18.xxxy
    mov r15.zw, r2.yyyz
    movc r17.xyzw, r3.yyyy, r19.xyzw, r15.xyzw
    movc r2.w, r3.y, r18.z, r2.w
    mov r15.z, r16.w
    mov r15.xy, r17.xyxx
    mov r2.yz, r17.zzwz
  endif 
...
switch r0.w
  ...
  mad r3.yzw, -r17.xxyz, l(0.000000, 0.500000, 0.500000, 0.500000), cb9[r0.x + 0].xxyz
  add r13.yzw, -r11.xxyz, r3.yyzw
  dp3 r4.w, r17.xyzx, r13.yzwy
  div_sat r5.z, -r4.w, cb9[r0.x + 6].y
  mad r18.xyz, r5.zzzz, r17.xyzx, r3.yzwy
  movc r18.xyz, r0.wwww, r18.xyzx, cb9[r0.x + 0].xyzx
  ...
  if_nz r9.w
    ...
    if_nz r9.w
      ...
      if_nz r9.w
        ...
        mad r13.z, -r12.w, r12.w, cb9[r0.x + 6].y
        mad r4.w, r12.w, r13.y, -r4.w
        div_sat r4.w, r4.w, r13.z
        div r12.w, r13.z, cb9[r0.x + 6].y
        mul r12.w, r12.w, l(10.000000)
        min r12.w, r12.w, l(1.000000)
        add r4.w, -r5.z, r4.w
        mad r4.w, r12.w, r4.w, r5.z
        mad r3.yzw, r4.wwww, r17.xxyz, r3.yyzw
        movc r3.yzw, r0.wwww, r3.yyzw, cb9[r0.x + 0].xxyz
        add r3.yzw, -r11.xxyz, r3.yyzw
        dp3 r0.w, r3.yzwy, r3.yzwy
        rsq r0.w, r0.w
        mul r13.yzw, r0.wwww, r3.yyzw
        ...
        if_nz r5.z
          ...
          mad r14.xyz, r12.xyzx, r5.zzzz, r11.xyzx
          mov r17.xyz, cb9[r4.w + 6].yzwy
          mov r17.w, cb9[r4.w + 7].x
          mov r14.w, l(1.000000)
          dp4 r5.z, r17.xyzw, r14.xyzw
          ...
          if_z r15.w
            ...
            add r17.x, r14.x, cb9[r4.w + 9].w
            add r17.y, r14.y, cb9[r4.w + 10].x
            mul r14.xy, r17.xyxx, cb9[r4.w + 9].yzyy
            div r14.zw, cb9[r4.w + 3].yyyy, cb9[r4.w + 8].yyyw
            ...
            if_z r14.z
              ...
              mad r17.x, r14.x, cb9[r4.w + 8].y, cb9[r4.w + 8].z
              mad r17.y, r14.y, cb9[r4.w + 8].w, cb9[r4.w + 9].x
              mul r14.x, r12.w, cb9[r4.w + 10].z
        ...
        mul r4.w, r6.w, r4.w
        mov r14.x, cb9[r0.x + 0].w
        mov r14.yz, cb9[r0.x + 1].xxyx
        lt r5.z, l(0.000000), r7.w
        mad r17.xyz, r4.wwww, r14.xyzx, r16.xyzx
        dp3_sat r4.w, r12.xyzx, r13.yzwy
        mad r3.yzw, r3.yyzw, r0.wwww, r10.yyzw
        dp3 r0.w, r3.yzwy, r3.yzwy
        rsq r0.w, r0.w
        mul r3.yzw, r0.wwww, r3.yyzw
        dp3 r0.w, r3.yzwy, r10.yzwy
        ...
        mul r3.y, r3.z, r3.y
        mul r3.y, r6.w, r3.y
        mad r13.yzw, r3.yyyy, r14.xxyz, r2.yyzw
        add_sat r0.w, -r0.w, l(1.000000)
        mul r3.z, r0.w, r0.w
        mul r3.z, r3.z, r3.z
        mul r0.w, r0.w, r3.z
        mul r0.w, r0.w, r3.y
        mad r3.yzw, r0.wwww, r14.xxyz, r15.zzxy
        movc r16.xyz, r5.zzzz, r17.xyzx, r16.xyzx
        movc r15.xyz, r5.zzzz, r3.zwyz, r15.xyzx
  ...
  if_nz r3.w
    ...
    if_nz r4.w
      ...
      if_nz r3.w
        ...
        dp3 r5.z, cb9[r0.x + 13].xyzx, r18.xyzx
    ...
    if_nz r3.w
      ...
      if_nz r3.w
        ...
        mad r18.xyz, r12.xyzx, r3.wwww, r11.xyzx
      ...
      if_nz r4.w
        ...
        if_nz r6.w
          ...
          mad r6.w, |r3.y|, l(-0.200000), l(0.400000)
          mad r17.xyz, r12.xyzx, r6.wwww, r11.xyzx
          mov r18.xyz, cb9[r5.z + 6].yzwy
          mov r18.w, cb9[r5.z + 7].x
          mov r17.w, l(1.000000)
          dp4 r6.w, r18.xyzw, r17.xyzw
          mov r18.xyz, cb9[r5.z + 7].yzwy
          mov r18.w, cb9[r5.z + 8].x
          ...
          if_z r8.w
            ...
            add r18.x, r17.x, cb9[r5.z + 9].w
            add r18.y, r17.y, cb9[r5.z + 10].x
            mul r17.xy, r18.xyxx, cb9[r5.z + 9].yzyy
            div r17.zw, cb9[r5.z + 3].yyyy, cb9[r5.z + 8].yyyw
            ...
            if_z r9.w
              ...
              mad r18.x, r17.x, cb9[r5.z + 8].y, cb9[r5.z + 8].z
              mad r18.y, r17.y, cb9[r5.z + 8].w, cb9[r5.z + 9].x
          ...
          if_z r7.w
            ...
            if_nz cb2[58].y
              ...
              loop 
                ...
                mad r19.xy, r20.xyxx, cb9[r5.z + 3].yyyy, r18.xyxx
          ...
          if_nz r5.z
            ...
            mad r17.xyz, r12.xyzx, r5.zzzz, r11.xyzx
            mov r18.xyz, cb9[r0.x + 6].yzwy
            mov r18.w, cb9[r0.x + 7].x
            mov r17.w, l(1.000000)
            dp4 r5.z, r18.xyzw, r17.xyzw
            ...
            if_z r6.w
              ...
              if_nz cb2[58].y
                ...
                loop 
                  ...
                  dp2 r20.y, icb[r7.w + 0].yxyy, r17.yzyy
                  mad r19.xy, r20.xyxx, cb9[r0.x + 3].yyyy, r18.xyxx
                  sample_c_lz_indexable(texture2darray)(float,float,float,float) r8.w, r19.xyzx, t9.xxxx, s13, r5.z
        ...
        mad r17.xyz, r0.xxxx, r13.yzwy, r16.xyzx
        mad r14.xyz, r14.xyzx, r0.wwww, r10.yzwy
        ...
        mad r3.xyz, r0.yyyy, r13.yzwy, r2.yzwy
        ...
        movc r16.xyz, r1.wwww, r17.xyzx, r16.xyzx
        movc r15.xyz, r1.wwww, r0.yzxy, r15.xyzx
