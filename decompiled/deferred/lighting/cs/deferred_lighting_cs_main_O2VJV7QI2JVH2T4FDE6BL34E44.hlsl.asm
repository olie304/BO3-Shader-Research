...
if_nz r2.w
  ...
  if_nz r2.w
    ...
    mad r15.yzw, r2.wwww, r15.yyzw, r18.xxyz
    ...
    mad r17.xyz, r2.wwww, r19.xyzx, r17.xyzx
    ...
    sample_l_indexable(texture2d)(float,float,float,float) r3.y, r17.xyxx, t28.yxzw, s1, r2.w
    ...
    loop 
      ...
      mad r15.yzw, r18.xxyw, r10.zzzz, r17.xxyz
      sample_l_indexable(texture2d)(float,float,float,float) r10.z, r15.yzyy, t28.yzxw, s1, l(0.000000)
      mul r10.w, r15.w, |r10.z|
      ...
      if_nz r10.w
        if_nz r20.z
          ...
          movc r14.yz, r10.wwww, r15.yyzy, r3.yyzy
          mov r20.z, r15.w
          mov r22.x, r7.w
      ...
      loop 
        ...
        mad r23.yzw, r19.xxyz, r23.yyyy, r15.yyzw
...
loop 
  ...
  loop 
    ...
    add r26.xyz, r11.xyzx, -cb10[r15.y + 0].xyzx
    ...
    if_nz r15.w
      ...
      sqrt r15.w, r15.w
      mad r15.w, r3.y, l(5.000000), r15.w
...
if_nz r9.w
  ...
  loop 
    ...
    loop 
      ...
      add r27.xyz, r11.xyzx, -cb10[r17.w + 0].xyzx
      ...
      if_nz r19.y
        ...
        sqrt r18.w, r18.w
        mad r18.w, r3.y, l(5.000000), r18.w
  ...
  if_nz r7.w
    ...
    if_nz r7.w
      ...
      if_nz r7.w
        ...
        mad r20.xyz, r14.yzwy, r2.zzzz, r20.xyzx
        ...
        mul r5.z, r5.z, r6.w
        mul r4.w, r4.w, r5.z
        mad r16.xyz, r4.wwww, r19.xyzx, r10.yzwy
        ...
        movc r10.yzw, r2.wwww, r16.xxyz, r10.yyzw
      endif 
    endif 
  endif 
  break 
  ...
  if_nz r5.z
    ...
    if_nz r5.z
      ...
      if_nz r6.w
        ...
        mad r2.xyz, r14.yzwy, r2.zzzz, r18.xyzx
        mad r14.xyz, r16.xyzx, r1.wwww, r13.xyzx
        ...
        mad r12.xyz, r0.yyyy, r19.xyzx, r10.yzwy
        ...
        mad r13.xyz, r0.xxxx, r19.xyzx, r15.yzwy
        and r13.xyz, r3.xxxx, r13.xyzx
        movc r3.yzw, r1.zzzz, r2.xxyz, r3.yyzw
        movc r15.yzw, r1.zzzz, r15.yyzw, r13.xxyz
        movc r17.xyz, r1.zzzz, r0.yzwy, r17.xyzx
        movc r10.yzw, r1.zzzz, r12.xxyz, r10.yyzw
      endif 
    endif 
  endif 
  break 
...
ret 
// Approximately 1894 instruction slots used
