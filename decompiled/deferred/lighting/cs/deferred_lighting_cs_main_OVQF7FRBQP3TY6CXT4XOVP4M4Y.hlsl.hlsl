...
// unknown dcl_: dcl_thread_group 8, 8, 1
  ...
  r0.x = mad(permuteStride, 31, (int)vThreadGroupID.x);
...
r0.y = samplerLinear[]..swiz;
  ...
  while (true) {
    ...
    if (r13.w != 0) {
      ...
      if (r2.w != 0) {
        ...
        r17.yzw = refProbeConstantsCB[r12.w].data[0].xyz + eyeOffset.xyz;
        GBufferDiffuseColor[viewID].r13.w = u2.xyzw;
      }
      r25.w = (int)r24.w + 1;
      r15.yzw = -refProbeConstantsCB[r12.w].data[0].xyz + r5.xyz;
      r13.w = 0x0000ffff & (int)refProbeConstantsCB[r12.w].data[7].z;
      if (6 == 0) r14.w = 0; else if (6+25 < 32) {       r14.w = (uint)refProbeConstantsCB[r12.w].data[7].z << (32-(6 + 25)); r14.w = (uint)r14.w >> (32-6);      } else r14.w = (uint)refProbeConstantsCB[r12.w].data[7].z >> 25;
      r17.y = (int)r13.w * 6;
      ...
      r18.x = r17.z * r17.y;
      r17.y = 1 & (int)refProbeConstantsCB[r12.w].data[6].x;
      r17.yz = r17.yy ? r18.xy : r18.zx;
      r17.w = refProbeConstantsCB[r12.w].data[6].x;
      r26.xy = r17.yz;
      r18.x = 1;
      while (true) {
        ...
        r19.w = r26.x * r19.w;
        r21.w = dot(refProbeAttenuationConstantsCB[r18.w].data[1].xyz, r15.yzw);
        r21.w = saturate(refProbeAttenuationConstantsCB[r18.w].data[1].w + r21.w);
        r19.w = r21.w * r19.w;
        r21.w = dot(refProbeAttenuationConstantsCB[r18.w].data[2].xyz, r15.yzw);
        r21.w = saturate(refProbeAttenuationConstantsCB[r18.w].data[2].w + r21.w);
        r19.w = r21.w * r19.w;
        r21.w = dot(refProbeAttenuationConstantsCB[r18.w].data[3].xyz, r15.yzw);
        r21.w = saturate(refProbeAttenuationConstantsCB[r18.w].data[3].w + r21.w);
        r19.w = r21.w * r19.w;
        r21.w = dot(refProbeAttenuationConstantsCB[r18.w].data[4].xyz, r15.yzw);
        r21.w = saturate(refProbeAttenuationConstantsCB[r18.w].data[4].w + r21.w);
        r19.w = r21.w * r19.w;
        r21.w = dot(refProbeAttenuationConstantsCB[r18.w].data[5].xyz, r15.yzw);
        ...
        r18.w = -r19.w * r18.w + 1;
        r18.w = r26.y * r18.w;
        r20.y = r26.z ? r18.w : r26.w;
        r26.xy = r22.ww ? r26.xy : r20.xy;
        r18.x = (int)r18.x + 1;
        r17.w = r21.w;
      }
      r26.y = saturate(r26.y);
      r13.w = refProbeConstantsCB[r12.w].data[6].y * r26.y;
      r14.w = cmp(0 < r13.w);
      if (r14.w != 0) {
        r14.w = (int)r25.w & 7;
        r17.y = (int)r14.w + -1;
        ...
        r17.y = r17.y ? r2.w : 0;
        if (r17.y != 0) {
          r17.yz = mad((int2)r14.ww, int2(20,20), int2(860,876));
        // Known bad code for instruction (needs manual fix):
        ...
        r24.w = (int)r24.w + 257;
        r24.z = r26.y * refProbeConstantsCB[r12.w].data[6].y + r24.z;
        r13.w = refProbeConstantsCB[r12.w].data[7].y * r13.w;
        r27.x = refProbeConstantsCB[r12.w].data[7].w;
        r27.yz = refProbeConstantsCB[r12.w].data[8].xy;
        r14.w = dot(r16.xyz, r27.xyz);
        r17.y = dot(r15.yzw, r27.xyz);
        r17.y = -refProbeConstantsCB[r12.w].data[8].z + r17.y;
        r17.z = cmp(r17.y >= 0);
        ...
        r27.x = refProbeConstantsCB[r12.w].data[8].w;
        r27.yz = refProbeConstantsCB[r12.w].data[9].xy;
        r17.y = dot(r16.xyz, r27.xyz);
        r17.z = dot(r15.yzw, r27.xyz);
        r17.z = -refProbeConstantsCB[r12.w].data[9].z + r17.z;
        r17.w = cmp(r17.z >= 0);
        r17.z = max(abs(r17.z), r7.w);
        r17.z = r17.w ? r17.z : -r17.z;
        r17.y = max(1.00000001e-07, -r17.y);
        r17.y = r17.z / r17.y;
        r14.w = min(abs(r17.y), r14.w);
        r27.x = refProbeConstantsCB[r12.w].data[9].w;
        r27.yz = refProbeConstantsCB[r12.w].data[10].xy;
        r17.y = dot(r16.xyz, r27.xyz);
        r17.z = dot(r15.yzw, r27.xyz);
        r17.z = -refProbeConstantsCB[r12.w].data[10].z + r17.z;
        r17.w = cmp(r17.z >= 0);
        r17.z = max(abs(r17.z), r7.w);
        r17.z = r17.w ? r17.z : -r17.z;
        r17.y = max(1.00000001e-07, -r17.y);
        r17.y = r17.z / r17.y;
        r14.w = min(abs(r17.y), r14.w);
        r27.x = refProbeConstantsCB[r12.w].data[10].w;
        r27.yz = refProbeConstantsCB[r12.w].data[11].xy;
        r17.y = dot(r16.xyz, r27.xyz);
        r17.z = dot(r15.yzw, r27.xyz);
        r17.z = -refProbeConstantsCB[r12.w].data[11].z + r17.z;
        r17.w = cmp(r17.z >= 0);
        r17.z = max(abs(r17.z), r7.w);
        r17.z = r17.w ? r17.z : -r17.z;
        r17.y = max(1.00000001e-07, -r17.y);
        r17.y = r17.z / r17.y;
        r14.w = min(abs(r17.y), r14.w);
        r27.x = refProbeConstantsCB[r12.w].data[11].w;
        r27.yz = refProbeConstantsCB[r12.w].data[12].xy;
        r17.y = dot(r16.xyz, r27.xyz);
        r17.z = dot(r15.yzw, r27.xyz);
        r17.z = -refProbeConstantsCB[r12.w].data[12].z + r17.z;
        r17.w = cmp(r17.z >= 0);
        r17.z = max(abs(r17.z), r7.w);
        r17.z = r17.w ? r17.z : -r17.z;
        r17.y = max(1.00000001e-07, -r17.y);
        r17.y = r17.z / r17.y;
        r14.w = min(abs(r17.y), r14.w);
        r27.x = refProbeConstantsCB[r12.w].data[12].w;
        r27.yz = refProbeConstantsCB[r12.w].data[13].xy;
        r17.y = dot(r16.xyz, r27.xyz);
        r17.z = dot(r15.yzw, r27.xyz);
        r17.z = -refProbeConstantsCB[r12.w].data[13].z + r17.z;
        r17.w = cmp(r17.z >= 0);
        r17.z = max(abs(r17.z), r7.w);
        r17.z = r17.w ? r17.z : -r17.z;
        r17.y = max(1.00000001e-07, -r17.y);
        r17.y = r17.z / r17.y;
        r14.w = min(abs(r17.y), r14.w);
        r27.x = refProbeConstantsCB[r12.w].data[3].w + r15.y;
        r27.yz = refProbeConstantsCB[r12.w].data[4].xy + r15.zw;
        r17.yzw = r16.xyz * r14.www + r27.xyz;
        ...
        if (9 == 0) r17.y = 0; else if (9+16 < 32) {         r17.y = (uint)refProbeConstantsCB[r12.w].data[7].z << (32-(9 + 16)); r17.y = (uint)r17.y >> (32-9);        } else r17.y = (uint)refProbeConstantsCB[r12.w].data[7].z >> 16;
        r28.w = (uint)r17.y;
        ...
        r14.w = (int)r26.z | (int)r26.x;
        r14.w = (int)r26.w | (int)r14.w;
        r17.yzw = r14.www ? float3(1,1,0) : r17.yzw;
        r31.x = dot(r15.yzw, r27.xyz);
        r31.y = dot(r15.yzw, r29.xyz);
        r31.z = dot(r15.yzw, r30.xyz);
        r15.yzw = saturate(r31.xyz * refProbeConstantsCB[r12.w].data[3].xyz + float3(0.5,0.5,0.5));
        r31.xy = refProbeConstantsCB[r12.w].data[4].zw * r15.yz;
        r31.z = refProbeConstantsCB[r12.w].data[5].x * r15.w;
        r15.yzw = refProbeConstantsCB[r12.w].data[5].yzw + r31.xyz;
        ...
        r14.w = r12.w * r8.w;
        r15.yzw = r17.yzw * r13.www;
        r13.w = dot(r15.yzw, float3(0.212599993,0.715200007,0.0722000003));
        r12.w = r8.w * r12.w + r13.w;
        r12.w = r14.w / r12.w;
        r27.x = r23.w;
        r27.yz = r24.xy;
        r15.yzw = r15.yzw * r12.www + r27.xyz;
        r23.w = r15.y;
        r24.xy = r15.zw;
      } else {
        r25.xyz = r24.xyz;
  ...
  while (true) {
    ...
    if (r13.w != 0) {
      ...
      r26.y = (int)r20.y + 1;
      r17.yzw = -refProbeConstantsCB[r12.w].data[0].xyz + r5.xyz;
      r13.w = 0x0000ffff & (int)refProbeConstantsCB[r12.w].data[7].z;
      if (6 == 0) r14.w = 0; else if (6+25 < 32) {       r14.w = (uint)refProbeConstantsCB[r12.w].data[7].z << (32-(6 + 25)); r14.w = (uint)r14.w >> (32-6);      } else r14.w = (uint)refProbeConstantsCB[r12.w].data[7].z >> 25;
      r18.w = (int)r13.w * 6;
      ...
      r19.w = refProbeConstantsCB[r12.w].data[6].x;
      r27.xy = r18.xw;
      r21.w = 1;
      while (true) {
        r22.w = cmp((int)r21.w >= (int)r14.w);
        if (r22.w != 0) break;
        ...
        r22.w = -r25.w * r22.w + 1;
        r22.w = r27.y * r22.w;
        r20.w = r27.z ? r22.w : r27.w;
        r27.xy = r26.ww ? r27.xy : r20.zw;
        r21.w = (int)r21.w + 1;
        r19.w = r26.z;
      }
      r13.w = saturate(r27.y + -r24.z);
      r14.w = refProbeConstantsCB[r12.w].data[6].y * r13.w;
      r18.x = cmp(0 < r14.w);
      if (r18.x != 0) {
        r18.x = (int)r26.y & 31;
        r18.w = (int)r18.x + -1;
        ...
        r20.y = (int)r20.y + 257;
        r20.x = r13.w * refProbeConstantsCB[r12.w].data[6].y + r20.x;
        r13.w = refProbeConstantsCB[r12.w].data[7].y * r14.w;
        r28.x = refProbeConstantsCB[r12.w].data[7].w;
        r28.yz = refProbeConstantsCB[r12.w].data[8].xy;
        r14.w = dot(r16.xyz, r28.xyz);
        r18.x = dot(r17.yzw, r28.xyz);
        r18.x = -refProbeConstantsCB[r12.w].data[8].z + r18.x;
        r18.w = cmp(r18.x >= 0);
        ...
        r14.w = r18.x / r14.w;
        r14.w = min(131072, abs(r14.w));
        r28.x = refProbeConstantsCB[r12.w].data[8].w;
        r28.yz = refProbeConstantsCB[r12.w].data[9].xy;
        ...
        r18.x = r18.w / r18.x;
        r14.w = min(abs(r18.x), r14.w);
        r28.x = refProbeConstantsCB[r12.w].data[9].w;
        r28.yz = refProbeConstantsCB[r12.w].data[10].xy;
        r18.x = dot(r16.xyz, r28.xyz);
        r18.w = dot(r17.yzw, r28.xyz);
        ...
        r18.x = r18.w / r18.x;
        r14.w = min(abs(r18.x), r14.w);
        r28.x = refProbeConstantsCB[r12.w].data[10].w;
        r28.yz = refProbeConstantsCB[r12.w].data[11].xy;
        r18.x = dot(r16.xyz, r28.xyz);
        r18.w = dot(r17.yzw, r28.xyz);
        ...
        r18.x = r18.w / r18.x;
        r14.w = min(abs(r18.x), r14.w);
        r28.x = refProbeConstantsCB[r12.w].data[11].w;
        r28.yz = refProbeConstantsCB[r12.w].data[12].xy;
        r18.x = dot(r16.xyz, r28.xyz);
        r18.w = dot(r17.yzw, r28.xyz);
        ...
        r18.x = r18.w / r18.x;
        r14.w = min(abs(r18.x), r14.w);
        r28.x = refProbeConstantsCB[r12.w].data[12].w;
        r28.yz = refProbeConstantsCB[r12.w].data[13].xy;
        r18.x = dot(r16.xyz, r28.xyz);
        r18.w = dot(r17.yzw, r28.xyz);
        ...
        r18.x = r18.w / r18.x;
        r14.w = min(abs(r18.x), r14.w);
        r28.x = refProbeConstantsCB[r12.w].data[3].w + r17.y;
        r28.yz = refProbeConstantsCB[r12.w].data[4].xy + r17.zw;
        r27.xzw = r16.xyz * r14.www + r28.xyz;
        r18.x = dot(r27.xzw, r27.xzw);
        r18.x = sqrt(r18.x);
        r14.w = r14.w / r18.x;
        r14.w = r14.w + r14.w;
        r14.w = sqrt(r14.w);
        r14.w = r3.z * 5 + r14.w;
        r14.w = -0.844799995 + r14.w;
        r28.x = refProbeConstantsCB[r12.w].data[0].w;
        r28.y = refProbeConstantsCB[r12.w].data[1].z;
        r28.z = refProbeConstantsCB[r12.w].data[2].y;
        r29.x = dot(r27.xzw, r28.xyz);
        r30.xy = refProbeConstantsCB[r12.w].data[1].xw;
        r30.z = refProbeConstantsCB[r12.w].data[2].z;
        r29.y = dot(r27.xzw, r30.xyz);
        r31.x = refProbeConstantsCB[r12.w].data[1].y;
        r31.yz = refProbeConstantsCB[r12.w].data[2].xw;
        r29.z = dot(r27.xzw, r31.xyz);
        if (9 == 0) r18.x = 0; else if (9+16 < 32) {         r18.x = (uint)refProbeConstantsCB[r12.w].data[7].z << (32-(9 + 16)); r18.x = (uint)r18.x >> (32-9);        } else r18.x = (uint)refProbeConstantsCB[r12.w].data[7].z >> 16;
        r29.w = (uint)r18.x;
        ...
        r14.w = (int)r32.y | (int)r32.x;
        r14.w = (int)r32.z | (int)r14.w;
        r27.xzw = r14.www ? float3(1,1,0) : r27.xzw;
        r32.x = dot(r17.yzw, r28.xyz);
        r32.y = dot(r17.yzw, r30.xyz);
        r32.z = dot(r17.yzw, r31.xyz);
        r17.yzw = saturate(r32.xyz * refProbeConstantsCB[r12.w].data[3].xyz + float3(0.5,0.5,0.5));
        r32.xy = refProbeConstantsCB[r12.w].data[4].zw * r17.yz;
        r32.z = refProbeConstantsCB[r12.w].data[5].x * r17.w;
        r17.yzw = refProbeConstantsCB[r12.w].data[5].yzw + r32.xyz;
  ...
  if (enableCountDebug != 0) {
    if (debugDrawOverlayType != 0) {
      switch (cb2[53].y) {
        case 1 :        r0.y = (int)r6.w & 3;
        break;
        case 2 :        if (2 == 0) r0.y = 0; else if (2+8 < 32) {         r0.y = (uint)r6.w << (32-(2 + 8)); r0.y = (uint)r0.y >> (32-2);        } else r0.y = (uint)r6.w >> 8;
        break;
