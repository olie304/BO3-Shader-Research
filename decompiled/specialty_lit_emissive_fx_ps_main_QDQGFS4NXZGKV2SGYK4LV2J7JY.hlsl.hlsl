// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:41:47 2021
...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  if (r4.w != 0) {
    ...
    if (r4.w != 0) {
      ...
      r3.z = saturate(r3.z);
      r13.yzw = -v6.xyz * r1.www + sunConstants.wldDir.xyz;
