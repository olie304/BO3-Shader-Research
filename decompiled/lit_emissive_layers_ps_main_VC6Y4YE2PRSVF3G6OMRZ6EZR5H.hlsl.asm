...
if_nz r1.w
  ...
  mad r1.w, cb0[12].z, r1.z, l(1.000000)
  mul r1.w, r1.w, cb0[12].y
  mul r1.w, r1.w, l(0.01745329)
  sincos r4.x, r5.x, r1.w
  mov r5.y, r5.x
  mov r5.z, r4.x
  dp2 r9.x, r5.yzyy, r3.xyxx
  mov r5.x, -r4.x
  dp2 r9.y, r5.xyxx, r3.xyxx
  mul r1.zw, r1.zzzz, cb0[13].xxxy
  mad r1.zw, r1.zzzw, cb0[13].zzzw, r9.xxxy
  ...
  mov_sat r3.xy, r1.zwzz
  movc r8.xy, cb0[15].zwzz, r3.xyxx, r1.zwzz
endif 
sample_indexable(texture2d)(float,float,float,float) r3.xyzw, r8.xyxx, t25.xyzw, s1
...
frc r1.z, r1.z
mad r4.y, cb1[69].w, cb0[16].z, r1.z
mov r4.x, cb0[16].x
