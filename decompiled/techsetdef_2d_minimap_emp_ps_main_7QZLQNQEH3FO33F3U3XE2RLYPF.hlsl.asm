...
// minimapMask                       texture  float4          2d             t7      1 
...
dcl_output o0.xyzw
dcl_temps 3
add r0.x, cb1[69].z, l(0.500000)
mul r0.x, r0.x, l(30.000000)
round_ni r0.x, r0.x
mul r0.x, r0.x, l(4937.987305)
sincos r0.x, null, r0.x
frc r0.x, r0.x
mul r0.x, r0.x, l(48.000000)
round_ni r0.x, r0.x
add r0.yz, v2.xxyx, l(0.000000, -0.500000, -0.500000, 0.000000)
mul r0.y, r0.y, cb3[1].y
sincos r1.x, r2.x, cb3[1].x
mul r0.w, r0.z, r1.x
mul r0.z, r0.z, r2.x
mad r1.y, r0.y, r1.x, r0.z
mad r0.y, r0.y, r2.x, -r0.w
div r1.x, r0.y, cb3[1].y
mad r0.yz, r1.xxyx, cb3[0].zzwz, cb3[0].xxyx
resinfo_indexable(texture2d)(float,float,float,float) r1.xy, l(0), t0.xyzw
div r1.zw, l(0.000000, 0.000000, 48.000000, 48.000000), r1.xxxy
div r2.xy, r0.yzyy, r1.zwzz
round_ni r2.xy, r2.xyxx
add r0.xw, r0.xxxx, r2.xxxy
resinfo_indexable(texture2d)(float,float,float,float) r2.zw, l(0), t6.zwxy
div r0.xw, r0.xxxw, r2.zzzw
sample_indexable(texture2d)(float,float,float,float) r0.x, r0.xwxx, t6.yxzw, s1
mul r0.x, r0.x, r0.x
mad r0.x, r0.x, l(47.000000), l(1.000000)
div r0.xw, r0.xxxx, r1.xxxy
mad r0.yz, -r2.xxyx, r1.zzwz, r0.yyzy
div r0.yz, r0.yyzy, r0.xxwx
round_ni r0.yz, r0.yyzy
mul r1.xy, r1.zwzz, r2.xyxx
mad r0.xy, r0.xwxx, r0.yzyy, r1.xyxx
mul r0.z, cb1[69].z, l(30.000000)
round_ni r0.z, r0.z
mul r0.z, r0.z, l(4937.987305)
sincos r0.z, null, r0.z
frc r0.z, r0.z
mul r0.z, r0.z, l(48.000000)
round_ni r0.z, r0.z
add r0.zw, r0.zzzz, r2.xxxy
div r0.zw, r0.zzzw, r2.zzzw
sample_indexable(texture2d)(float,float,float,float) r2.xyz, r0.zwzz, t6.xyzw, s1
mad r0.zw, r2.xxxy, l(0.000000, 0.000000, 2.000000, 2.000000), l(0.000000, 0.000000, -1.000000, -1.000000)
mad_sat r0.xy, r1.zwzz, r0.zwzz, r0.xyxx
...
sample_indexable(texture2d)(float,float,float,float) r1.x, v2.xyxx, t7.wxyz, s1
mul o0.w, r0.w, r1.x
