...
mad r2.xyzw, r5.zzzz, cb1[10].xyzw, r8.xyzw
mov o6.xyz, r5.xyzx
...
mul r2.xy, r3.xyxx, cb0[18].ywyy
mul r2.xy, r2.xyxx, l(27.239243, 25.132742, 0.000000, 0.000000)
add r0.x, r2.y, r2.x
add r1.y, r1.z, r1.y
mul r1.z, cb0[19].x, l(34.456177)
mad r1.y, r1.z, r1.x, r1.y
mul r1.x, r1.x, cb0[19].y
mad r0.x, r1.x, l(34.456177), r0.x
mul r0.x, r0.x, v1.y
mul r0.x, r0.x, l(0.025000)
mul r1.x, r1.y, v1.y
mul r1.x, r1.x, l(0.025000)
mad r1.y, v4.w, l(2.000000), l(-1.000000)
...
mad r0.xyz, r0.xyzx, l(511.000000, 511.000000, 511.000000, 0.000000), l(512.000000, 512.000000, 512.000000, 0.000000)
mad r0.xyz, r0.xyzx, l(0.00195695, 0.00195695, 0.00195695, 0.000000), l(-1.00195694, -1.00195694, -1.00195694, 0.000000)
dp3 r3.x, r0.xyzx, r4.xyzx
...
mul r1.xzw, r2.yyzx, r0.zzxy
mad r0.xyz, r0.yzxy, r2.zxyz, -r1.xzwx
mul r0.xyz, r1.yyyy, r0.xyzx
dp3 r1.x, r0.xyzx, r4.xyzx
dp3 r1.y, r0.xyzx, r6.xyzx
dp3 r1.z, r0.xyzx, r7.xyzx
