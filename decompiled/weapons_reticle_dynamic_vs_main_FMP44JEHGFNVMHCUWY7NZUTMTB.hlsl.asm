    ...
    if_nz r1.w
      ...
      if_nz r1.w
        ...
        if_nz r1.w
          ...
          dp3 r0.w, r7.xyzx, v0.xyzx
          add r0.w, r7.w, r0.w
          mad r5.z, r0.w, v4.w, r5.z
          dp3 r0.w, r7.xyzx, r0.xyzx
          mad r6.z, r0.w, v4.w, r6.z
...
mov r5.w, l(1.000000)
mov r3.w, r6.x
dp4 r2.w, r5.xyzw, r3.xyzw
mov r4.w, r6.y
dp4 r3.x, r5.xyzw, r4.xyzw
mov r6.xyz, r2.xyzx
dp4 r2.x, r5.xyzw, r6.xyzw
mul r3.xyzw, r3.xxxx, cb1[9].xyzw
mad r3.xyzw, r2.wwww, cb1[8].xyzw, r3.xyzw
...
mul r4.xyz, r3.yyyy, cb1[5].xyzx
mad r3.xyw, r3.xxxx, cb1[4].xyxz, r4.xyxz
mad r3.xyz, r3.zzzz, cb1[6].xyzx, r3.xywx
...
mul r7.xyz, r3.wwww, cb1[5].xyzx
mad r1.yzw, r1.wwww, cb1[4].xxyz, r7.xxyz
mad r1.xyz, r1.xxxx, cb1[6].xyzx, r1.yzwy
