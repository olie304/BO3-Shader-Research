...
dcl_output o0.xyzw
dcl_temps 4
sample_indexable(texture2d)(float,float,float,float) r0.x, v2.xyxx, t21.wxyz, s1
mul r0.y, r0.x, v1.w
mad r0.x, -r0.x, v1.w, cb1[59].x
mad r0.x, cb1[59].w, r0.x, r0.y
lt r0.x, r0.x, l(0.050000)
discard_nz r0.x
sample_indexable(texture2d)(float,float,float,float) r0.xy, v2.xyxx, t22.xyzw, s3
...
sample_indexable(texture2d)(float,float,float,float) r0.y, v2.xyxx, t24.yxzw, s5
mul o0.x, r0.y, r0.x
