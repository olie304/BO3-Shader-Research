...
mul r0.y, r0.y, r1.x
dp3 r0.z, v1.xyzx, l(0.299000, 0.587000, 0.114000, 0.000000)
max r0.z, r0.z, l(0.000100)
max r0.z, r0.z, cb1[85].x
mul r0.z, r0.z, cb0[12].x
mul r0.z, r0.z, v5.w
movc r0.z, cb0[14].x, cb0[12].x, r0.z
mul r0.y, r0.y, r0.z
mad r0.yzw, v2.xxyz, r0.yyyy, v1.xxyz
mul r2.xyz, r0.xxxx, v3.xyzx
mad r0.yzw, r1.yyzw, r0.yyzw, -r2.xxyz
mad r0.yzw, v3.wwww, r0.yyzw, r2.xxyz
mul r1.xyz, r0.xxxx, v11.xyzx
mov o0.w, r0.x
mad r0.xyz, r0.yzwy, v10.xyzx, r1.xyzx
