...
sample_indexable(texture2d)(float,float,float,float) r5.xyzw, r11.xyxx, t47.xyzw, s1
...
mov r1.x, cb0[33].y
sample_l_indexable(texture2d)(float,float,float,float) r0.z, r1.xyxx, t30.yzxw, s7, l(0.000000)
log r0.z, |r0.z|
...
ret 
// Approximately 3190 instruction slots used
