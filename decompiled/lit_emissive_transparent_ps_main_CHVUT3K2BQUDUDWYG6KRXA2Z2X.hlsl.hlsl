...
r4.y = samp0[]..swiz;
  ...
  r0.w = cmp(r4.y < 0);
  r8.xyz = r0.www ? float3(1,1,1) : emissiveTint1.xyz;
  r8.xyz = r7.zzz ? tint1.xyz : r8.xyz;
              ...
              if (r24.w != 0) {
                ...
                if (r24.w != 0) {
                  ...
                  while (true) {
                    ...
                    if (r28.w != 0) break;
                    r43.y = dot(icb[r27.w+0].yx, r5.xy);
                    r43.z = dot(icb[r27.w+0].yx, r5.yz);
                    ...
                    r13.w = samp0[]..swiz;
                      ...
                      if (r8.w != 0) {
                        ...
                        while (true) {
                          ...
                          if (r25.w != 0) break;
                          r42.x = dot(icb[r18.z+0].yx, r5.xw);
