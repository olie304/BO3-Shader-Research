...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r41.z = samp0[]..swiz;
  r41.w = samp0[]..swiz;
    r15.w = dot(r36.xyz, r35.xyz);
    r15.w = saturate(r15.w + r36.w);
    r16.w = dot(r37.xyz, r35.xyz);
    r16.w = saturate(r16.w + r37.w);
    r15.w = r16.w * r15.w;
    r16.w = dot(r38.xyz, r35.xyz);
    r16.w = saturate(r16.w + r38.w);
    r15.w = r16.w * r15.w;
    r16.w = dot(r39.xyz, r35.xyz);
    r16.w = saturate(r16.w + r39.w);
    r15.w = r16.w * r15.w;
    r16.w = dot(r40.xyz, r35.xyz);
    r16.w = saturate(r16.w + r40.w);
    r15.w = r16.w * r15.w;
    r16.w = dot(r41.xyz, r35.xyz);
    ...
    r29.x = dot(r35.xyz, r22.xyz);
    r29.y = dot(r35.xyz, r31.xyz);
    r29.z = dot(r35.xyz, r24.xyz);
    ...
    while (true) {
      ...
      if (r18.z != 0) {
        ...
        if (r13.w != 0) {
          ...
          r37.z = samp0[]..swiz;
          r37.w = samp0[]..swiz;
            r18.w = dot(r31.xyz, r35.xyz);
            r18.w = saturate(r18.w + r31.w);
            r18.w = r30.x * r18.w;
            r22.z = dot(r32.xyz, r35.xyz);
            r22.z = saturate(r22.z + r32.w);
            r18.w = r22.z * r18.w;
            r22.z = dot(r33.xyz, r35.xyz);
            r22.z = saturate(r22.z + r33.w);
            r18.w = r22.z * r18.w;
            r22.z = dot(r34.xyz, r35.xyz);
            r22.z = saturate(r22.z + r34.w);
            r18.w = r22.z * r18.w;
            r22.z = dot(r36.xyz, r35.xyz);
            r22.z = saturate(r22.z + r36.w);
            r18.w = r22.z * r18.w;
            r22.z = dot(r37.xyz, r35.xyz);
            ...
            r18.w = -r18.w * r22.z + 1;
            r18.w = r30.y * r18.w;
            r6.y = r26.w ? r18.w : r27.w;
            r30.xy = r25.ww ? r30.xy : r6.xy;
            r18.z = (int)r18.z + 1;
            r17.w = r24.w;
          }
          ...
          if (r17.w != 0) {
            r17.w = (int)r16.z + 257;
            r31.z = r30.y * r14.y + r28.w;
            r6.y = r6.y * r28.x;
            r30.xzw = r26.xyz * r6.yyy;
            ...
            r18.w = r18.z * r11.y;
            r30.xzw = r23.yzw * r6.yyy;
            r6.y = dot(r30.xzw, float3(0.212599993,0.715200007,0.0722000003));
            r6.y = r11.y * r18.z + r6.y;
            r6.y = r18.w / r6.y;
            r33.x = r29.w;
            r33.yz = r28.yz;
            r31.xyw = r30.zwx * r6.yyy + r33.yzx;
            r32.w = r31.w;
          } else {
            r17.w = (int)r16.z + 1;
            r32.xyzw = r29.xyzw;
  ...
  if (r11.z == 0) {
    r6.x = numRefProbes + -numOverrideProbes;
    r6.y = (int)r6.x & -32;
    r11.z = (int)-r6.y + (int)r6.x;
    r11.w = numRefProbes & -32;
    r13.x = (int)-r11.w + numRefProbes;
    r14.xy = float2(0,0);
    r15.w = 0;
    r16.yz = float2(0,1);
    r17.xy = float2(0,0);
    ...
    while (true) {
      ...
      r13.z = visibleProbes.Load(r15.xyzw).x;
      r13.w = cmp((int)r6.y == (int)r13.y);
      bitmask.z = ((~(-1 << r11.z)) << 0) & 0xffffffff;  r14.z = (((uint)0 << 0) & bitmask.z) | ((uint)r13.z & ~bitmask.z);
      r13.z = r13.w ? r14.z : r13.z;
      r13.w = cmp((int)r11.w == (int)r13.y);
      if (r13.x == 0) r14.z = 0; else if (r13.x+0 < 32) {       r14.z = (uint)r13.z << (32-(r13.x + 0)); r14.z = (uint)r14.z >> (32-r13.x);      } else r14.z = (uint)r13.z >> 0;
      r13.z = r13.w ? r14.z : r13.z;
      r13.w = (int)r13.y + numLights;
      r26.xyzw = r24.yzwx;
      r27.xyzw = r25.xyzw;
      r14.z = r13.z;
      while (true) {
        ...
        r15.y = samp0[]..swiz;
          ...
          r36.z = samp0[]..swiz;
          r36.w = samp0[]..swiz;
            r17.w = dot(r31.xyz, r30.xyz);
            r17.w = saturate(r17.w + r31.w);
            r18.z = dot(r32.xyz, r30.xyz);
            r18.z = saturate(r18.z + r32.w);
            r17.w = r18.z * r17.w;
            r18.z = dot(r33.xyz, r30.xyz);
            r18.z = saturate(r18.z + r33.w);
            r17.w = r18.z * r17.w;
            r18.z = dot(r34.xyz, r30.xyz);
            r18.z = saturate(r18.z + r34.w);
            r17.w = r18.z * r17.w;
            r18.z = dot(r35.xyz, r30.xyz);
            r18.z = saturate(r18.z + r35.w);
            r17.w = r18.z * r17.w;
            r18.z = dot(r36.xyz, r30.xyz);
            ...
            r42.y = samp0[]..swiz;
              ...
              r15.y = dot(r30.xyz, r29.xyz);
              r15.y = r15.y + -r37.w;
              r15.z = cmp(r15.y >= 0);
              r15.y = max(abs(r15.y), r10.w);
              ...
              r15.x = min(r15.x, abs(r15.y));
              r39.z = r40.z;
              r15.y = dot(r12.xyz, r39.xyz);
              r15.z = dot(r30.xyz, r39.xyz);
              r15.z = r15.z + -r40.w;
              r16.x = cmp(r15.z >= 0);
              r15.z = max(abs(r15.z), r10.w);
              r15.z = r16.x ? r15.z : -r15.z;
              ...
              r15.x = min(r15.x, abs(r15.y));
              r40.z = r41.x;
              r15.y = dot(r12.xyz, r40.xyz);
              r15.z = dot(r30.xyz, r40.xyz);
              r15.z = r15.z + -r41.y;
              r16.x = cmp(r15.z >= 0);
              r15.z = max(abs(r15.z), r10.w);
              r15.z = r16.x ? r15.z : -r15.z;
              ...
              r15.x = min(r15.x, abs(r15.y));
              r42.zw = r41.zw;
              r15.y = dot(r12.zxy, r42.xzw);
              r15.z = dot(r30.zxy, r42.xzw);
              r15.z = r15.z + -r42.y;
              r16.x = cmp(r15.z >= 0);
              r15.z = max(abs(r15.z), r10.w);
              r15.z = r16.x ? r15.z : -r15.z;
              ...
              if (9 == 0) r15.y = 0; else if (9+16 < 32) {               r15.y = (uint)r29.w << (32-(9 + 16)); r15.y = (uint)r15.y >> (32-9);              } else r15.y = (uint)r29.w >> 16;
              r37.w = (uint)r15.y;
              r15.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r37.xyzw, r15.x).xyz;
              ...
              r14.w = r11.y * r16.x + r14.w;
              r14.w = r16.w / r14.w;
              r28.x = r26.w;
              r28.yz = r27.xy;
              r15.xyz = r15.xyz * r14.www + r28.xyz;
              r26.w = r15.x;
              r27.xy = r15.yz;
            } else {
              r27.w = (int)r27.w + 1;
    ...
    if (r11.w != 0) {
      ...
      r13.w = 0;
      while (true) {
        r15.w = cmp((uint)r13.w >= (uint)r6.x);
        if (r15.w != 0) break;
        r13.z = (uint)r13.w >> 5;
        r14.xyz = (int3)r4.xyz + (int3)r13.xyz;
        r13.z = visibleProbes.Load(r14.xyzw).x;
        r14.x = cmp((int)r6.y == (int)r13.w);
        if (r11.z == 0) r14.y = 0; else if (r11.z+0 < 32) {         r14.y = (uint)r13.z << (32-(r11.z + 0)); r14.y = (uint)r14.y >> (32-r11.z);        } else r14.y = (uint)r13.z >> 0;
        ...
        while (true) {
          ...
          r29.y = samp0[]..swiz;
            ...
            r37.z = samp0[]..swiz;
            r37.w = samp0[]..swiz;
              r23.w = dot(r32.xyz, r31.xyz);
              r23.w = saturate(r23.w + r32.w);
              r25.w = dot(r33.xyz, r31.xyz);
              r25.w = saturate(r25.w + r33.w);
              r23.w = r25.w * r23.w;
              r25.w = dot(r34.xyz, r31.xyz);
              r25.w = saturate(r25.w + r34.w);
              r23.w = r25.w * r23.w;
              r25.w = dot(r35.xyz, r31.xyz);
              r25.w = saturate(r25.w + r35.w);
              r23.w = r25.w * r23.w;
              r25.w = dot(r36.xyz, r31.xyz);
              r25.w = saturate(r25.w + r36.w);
              r23.w = r25.w * r23.w;
              r25.w = dot(r37.xyz, r31.xyz);
              r25.w = saturate(r25.w + r37.w);
              r15.x = r25.w * r23.w;
              r23.w = (int)r29.x & 1;
              r29.zw = r23.ww ? r15.xy : r15.zx;
              r15.x = r29.x;
              r32.xy = r29.zw;
              r23.w = 1;
              while (true) {
                r25.w = cmp((int)r23.w >= (int)r22.w);
                if (r25.w != 0) break;
                r25.w = (int)r20.w + (int)r23.w;
              // Known bad code for instruction (needs manual fix):
              ...
              r38.w = samp0[]..swiz;
                ...
                r25.w = -r25.w * r26.w + 1;
                r25.w = r32.y * r25.w;
                r17.y = r31.w ? r25.w : r32.z;
                r32.xy = r28.ww ? r32.xy : r17.xy;
                r23.w = (int)r23.w + 1;
                r15.x = r27.w;
              }
              r15.x = saturate(r32.y + -r15.w);
              r17.y = r15.x * r29.y;
              r20.w = cmp(0 < r17.y);
              if (r20.w != 0) {
              // Known bad code for instruction (needs manual fix):
              ...
              r43.y = samp0[]..swiz;
                r14.z = (int)r14.z + 257;
                r14.y = r15.x * r29.y + r14.y;
                r15.x = r17.y * r30.z;
                r30.z = r38.z;
                r17.y = dot(r12.xyz, r30.xyz);
                ...
                r29.xyz = r12.xyz * r17.yyy + r29.xyz;
                ...
                if (9 == 0) r18.w = 0; else if (9+16 < 32) {                 r18.w = (uint)r30.w << (32-(9 + 16)); r18.w = (uint)r18.w >> (32-9);                } else r18.w = (uint)r30.w >> 16;
                r38.w = (uint)r18.w;
                r29.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r38.xyzw, r17.y).xyz;
                r32.xzw = (int3)r29.xyz & int3(-2147483648,-2147483648,-2147483648);
                r32.xzw = cmp((int3)r32.xzw == int3(2139095040,2139095040,2139095040));
                r17.y = (int)r32.z | (int)r32.x;
                r17.y = (int)r32.w | (int)r17.y;
                r29.xyz = r17.yyy ? float3(1,1,0) : r29.xyz;
                ...
                r16.z = (int)r31.y | (int)r31.x;
                r16.z = (int)r31.z | (int)r16.z;
                r30.xyz = r16.zzz ? float3(1,1,0) : r30.xyz;
                r31.xyz = r30.xyz * r28.xyz;
                r16.z = dot(r31.xyz, float3(0.212599993,0.715200007,0.0722000003));
                r26.xyz = r28.xyz * r30.xyz + r26.xyz;
                r17.y = r16.z * r11.y;
                r28.xyz = r29.xyz * r15.xxx;
                r15.x = dot(r28.xyz, float3(0.212599993,0.715200007,0.0722000003));
                r15.x = r11.y * r16.z + r15.x;
                r15.x = r17.y / r15.x;
                r27.xyz = r28.xyz * r15.xxx + r27.xyz;
              } else {
                r14.z = (int)r14.z + 1;
              }
            }
    ...
    r19.xyz = r23.xyz * r4.xxx;
    r20.xyz = r24.xyz * r4.xxx;
    ...
    if (r4.y != 0) {
      ...
      r19.xyz = r23.xyz * r4.xxx + r11.yzw;
      r12.w = 0;
  ...
  if (useSSR != 0) {
    ...
    if (useLoopedSSR != 0) {
      ...
      while (true) {
        ...
        r6.y = cmp(abs(r6.x) < r13.z);
        r12.w = cmp(abs(r6.x) >= v0.w);
        r6.y = r6.y ? r12.w : 0;
        if (r6.y != 0) {
          r6.x = r13.z + -abs(r6.x);
          r6.x = ssrParams.w * r6.x;
          r14.xyz = -r6.xxx * r11.yzw + r13.xyz;
          ...
          r6.xy = r14.xy / r14.zz;
          r6.xy = r6.xy * float2(0.5,-0.5) + float2(0.5,0.5);
          r14.xyz = iResolveScene.SampleLevel(bilinearClamp_s, r6.xy, 0).xyz;
  ...
  if (r4.y == 0) {
    ...
    if (r4.w != 0) {
      ...
      while (true) {
        ...
        if (r6.y != 0) break;
        r6.y = (uint)r4.w;
        r11.yz = -sunConstants.splitPinTransform[r6.y].xy + r10.yz;
        r11.y = max(abs(r11.y), abs(r11.z));
        r6.x = sunConstants.splitPinTransform[r6.y].z * r11.y;
        r6.y = cmp(r6.x < 1);
        if (r6.y != 0) {
          break;
        }
    ...
    if (r6.y != 0) {
      ...
      r12.xy = floor(r12.xy);
      r12.y = sunConstants.sstLightingConstants.constants.dimensionInTiles.x * r12.y;
      r12.x = r12.y * sunConstants.sstLightingConstants.coordScale + r12.x;
      r12.x = (uint)r12.x;
      r12.x = (int)r12.x + (int10)sunConstants.sstLightingConstants.rootOffset;
    // Known bad code for instruction (needs manual fix):
    ...
    r12.y = samp0[]..swiz;
      ...
      if (r12.z == 0) {
        ...
        r13.x = (int)r12.z + (int)r12.x;
        r12.x = (uint)r12.y >> 25;
        r12.x = (uint)r12.x;
        r11.yzw = r12.xxx * r11.yzw;
      ...
      r13.z = samp0[]..swiz;
        r12.xy = (uint2)r11.wz >> int2(6,6);
        r12.z = (int)r13.z & 0xc0000000;
        r13.w = (int)r13.x + 1;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r13.w, r13.w, l(0), t23.xxxx
      r13.w = samp0[]..swiz;
        r12.y = r12.y ? r13.z : r13.w;
        r13.w = (uint)r12.y >> 13;
        r12.x = r12.x ? r13.w : r12.y;
      ...
      r14.z = samp0[]..swiz;
        r13.y = 0;
        r14.y = 1;
        r14.xyz = r12.zzz ? r13.xyz : r14.xyz;
        r15.yz = r12.zz ? float2(8.40779079e-45,1.40129846e-45) : float2(7.00649232e-45,2.80259693e-45);
        r12.xy = (uint2)r11.wz >> (uint2)r15.yy;
        r12.xy = (int2)r12.xy & int2(1,1);
        r13.w = (int)r14.z & 0xc0000000;
        r14.w = (int)r14.x + 1;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r14.w, r14.w, l(0), t23.xxxx
      r14.w = samp0[]..swiz;
        r12.y = r12.y ? r14.z : r14.w;
        r14.w = (uint)r12.y >> 13;
        r12.x = r12.x ? r14.w : r12.y;
        r12.x = (int)r12.x & 8191;
        r15.x = (int)r12.x + (int)r14.x;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r15.w, r15.x, l(0), t23.xxxx
      r15.w = samp0[]..swiz;
        r14.xyz = r13.www ? r14.xyz : r15.xzw;
        r12.xyz = r12.zzz ? r13.xyz : r14.xyz;
        r13.x = (int)r12.z & 0xc0000000;
        if (r13.x == 0) {
          r13.x = (int)-r12.y + 6;
          r13.xy = (uint2)r11.wz >> (uint2)r13.xx;
          r13.z = (int)r12.z | 0x40000000;
        ...
        r13.w = samp0[]..swiz;
          ...
          r12.y = (int)-r13.y + 6;
          r14.xy = (uint2)r11.wz >> (uint2)r12.yy;
          r12.y = (int)r13.w & 0xc0000000;
          r14.z = (int)r13.w | 0x40000000;
        ...
        r14.z = samp0[]..swiz;
          r14.y = r13.z;
          r14.xyz = r12.yyy ? r13.xyw : r14.xyz;
          r13.y = (int)-r14.y + 6;
          r13.yz = (uint2)r11.wz >> (uint2)r13.yy;
        ...
        r15.y = samp0[]..swiz;
          r13.yz = r14.yy ? r14.xz : r15.xy;
          r12.xz = r12.yy ? r13.xw : r13.yz;
        }
        r12.y = (int)r12.z & 0xc0000000;
        if (r12.y == 0) {
          if (14 == 0) r13.x = 0; else if (14+15 < 32) {           r13.x = (uint)r12.z << (32-(14 + 15)); r13.x = (uint)r13.x >> (32-14);          } else r13.x = (uint)r12.z >> 15;
          r13.x = (uint)r13.x;
          r13.x = sunConstants.sstLightingConstants.constants.spanInInches * r13.x;
          r13.yz = (int2)r12.zz & int2(32767,536870912);
          r13.y = (uint)r13.y;
          r13.y = sunConstants.sstLightingConstants.constants.spanInInches * r13.y;
          r13.xy = float2(6.10388815e-05,3.05185094e-05) * r13.xy;
          r13.w = (int)r11.z & 3;
        ...
        r13.w = samp0[]..swiz;
          ...
          bitmask.y = ((~(-1 << 2)) << 1) & 0xffffffff;  r14.y = (((uint)r11.z << 1) & bitmask.y) | ((uint)0 & ~bitmask.y);
          bitmask.z = ((~(-1 << 1)) << 4) & 0xffffffff;  r14.z = (((uint)r11.w << 4) & bitmask.z) | ((uint)0 & ~bitmask.z);
          r11.y = (uint)r13.w >> (uint)r14.x;
          r11.y = (int)r11.y & 255;
          r11.y = (uint)r11.y;
          r11.y = r11.y * r13.y;
          r11.y = r11.y * 0.00392156886 + r13.x;
          r11.z = (int)r14.y + 1;
        ...
        r11.z = samp0[]..swiz;
          r11.z = (uint)r11.z >> (uint)r14.z;
          r11.z = (int)r11.z & 0x0000ffff;
          r11.z = (uint)r11.z;
          r11.z = r11.z * r13.y;
          r11.z = r11.z * 1.52590219e-05 + r13.x;
          r12.w = r13.z ? r11.y : r11.z;
        } else {
          r11.y = (int)r12.z & 0x80000000;
          r11.z = (int)r12.x + 1;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r11.z, r11.z, l(0), t23.xxxx
        r11.z = samp0[]..swiz;
    ...
    if (r6.y == 0) {
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          if (r12.w != 0) break;
          r12.w = cmp((uint)r6.x < (uint)r11.w);
          r13.xy = r12.ww ? r10.yz : r11.yz;
          r13.z = r12.w ? sunConstants.splitPinTransform[r4.w].w : sunConstants.splitPinTransform[r6.y].w;
          r12.w = r12.w ? r4.w : r6.y;
          r14.x = dot(icb[r11.w+0].yx, r12.xy);
          r14.y = dot(icb[r11.w+0].yx, r12.yz);
          r13.xy = r14.xy * r13.zz + r13.xy;
          r12.w = (int)r12.w + (int16)sunConstants.splitArrayOffset;
          r13.z = (uint)r12.w;
          r12.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r13.xyz, r4.y).x;
  ...
  r17.w = samp0[]..swiz;
    ...
    r18.xyz = r2.xyz * r2.www + v7.xyz;
    r18.w = 1;
    r6.x = dot(r12.xyzw, r18.xyzw);
    r6.y = dot(r13.xyzw, r18.xyzw);
    r2.w = dot(r14.xyzw, r18.xyzw);
    r10.y = dot(r15.xyzw, r18.xyzw);
    ...
    r12.xy = cmp(r6.xy >= r12.xy);
    r11.yz = cmp(r11.yz >= r6.xy);
    r11.yz = (int2)r11.yz | (int2)r12.xy;
    r10.w = (int)r11.z | (int)r11.y;
    ...
    r11.z = samp0[]..swiz;
      ...
      r12.xy = r6.xy * r16.xz + r16.yw;
      r4.y = r11.z * r10.y;
      r2.w = r11.y * r10.y + r2.w;
      r2.w = r2.w / r4.y;
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          if (r10.x != 0) break;
          r10.x = dot(icb[r6.y+0].yx, r13.xy);
          r10.y = dot(icb[r6.y+0].yx, r13.yz);
          r14.xy = r10.xy * r4.ww + r12.xy;
          r10.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r14.xyz, r2.w).x;
          r6.x = r10.x * 0.125 + r6.x;
          r6.y = (int)r6.y + 1;
        }
      } else {
        r12.z = (uint)r4.y;
        r6.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r12.xyz, r2.w).x;
      }
      r2.w = r6.x * r6.x;
      r2.w = r2.w * r6.x;
    } else {
  ...
  r4.xyz = r2.www ? r4.yzw : r19.xyz;
  r3.xyz = r2.www ? r3.xyz : r20.xyz;
