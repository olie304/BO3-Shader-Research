...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:35:56 2021
//
//
...
//   float4 flagScrollParms;            // Offset:  224 Size:    16
//   float flagRippleScale;             // Offset:  240 Size:     4
//   float flagRippleHeight;            // Offset:  244 Size:     4
//   float2 wind1Parms;                 // Offset:  248 Size:     8 [unused]
//   float2 wind2Parms;                 // Offset:  256 Size:     8 [unused]
//   float2 wind3Parms;                 // Offset:  264 Size:     8 [unused]
//
// }
//
...
// detailMap                         texture  float4          2d            t30      1 
// gTransShadowmapArray              texture   float     2darray            t31      1 
// flagRippleDetailMap               texture  float4          2d            t37      1 
...
sample_indexable(texture2d)(float,float,float,float) r0.w, v2.xyxx, t24.yzwx, s5
add_sat r0.w, -r0.w, l(1.000000)
mul r0.xyz, r0.wwww, r0.xyzx
sample_indexable(texture2d)(float,float,float,float) r0.w, v2.xyxx, t29.yzwx, s7
sample_indexable(texture2d)(float,float,float,float) r1.x, v2.xyxx, t26.xyzw, s5
add r1.y, -cb0[13].x, cb0[13].y
mad r1.x, r1.x, r1.y, cb0[13].x
...
sample_indexable(texture2d)(float,float,float,float) r4.xyz, r4.xyxx, t30.xyzw, s6
...
mad r3.xy, r4.xyxx, cb0[13].zzzz, r1.yzyy
dp3 r1.y, r3.xyzx, r3.xyzx
rsq r1.y, r1.y
mul r3.xyz, r1.yyyy, r3.xyzx
mad r1.y, r3.w, cb0[13].z, r1.w
mul r4.xyzw, cb0[14].xyzw, cb1[69].wwww
mad r4.xyzw, v2.xyxy, cb0[15].xxxx, r4.xyzw
sample_indexable(texture2d)(float,float,float,float) r5.xyz, r4.xyxx, t37.xyzw, s6
mad r1.zw, r5.xxxy, l(0.000000, 0.000000, 1.99218750, 1.99218750), l(0.000000, 0.000000, -1.000000, -1.000000)
mul r3.w, r5.z, r5.z
mul r3.w, r3.w, l(0.33333334)
min r3.w, r3.w, l(1.000000)
sample_indexable(texture2d)(float,float,float,float) r4.xyz, r4.zwzz, t37.xyzw, s6
mad r4.xy, r4.xyxx, l(1.99218750, 1.99218750, 0.000000, 0.000000), l(-1.000000, -1.000000, 0.000000, 0.000000)
mul r4.z, r4.z, r4.z
mul r4.z, r4.z, l(0.33333334)
min r4.z, r4.z, l(1.000000)
mad r3.xy, r1.zwzz, cb0[15].yyyy, r3.xyxx
dp3 r1.z, r3.xyzx, r3.xyzx
rsq r1.z, r1.z
mul r3.xyz, r1.zzzz, r3.xyzx
mad r1.y, r3.w, cb0[15].y, r1.y
mad r3.xy, r4.xyxx, cb0[15].yyyy, r3.xyxx
dp3 r1.z, r3.xyzx, r3.xyzx
rsq r1.z, r1.z
mul r3.xyz, r1.zzzz, r3.xyzx
mad r1.y, r4.z, cb0[15].y, r1.y
...
ret 
// Approximately 1994 instruction slots used
