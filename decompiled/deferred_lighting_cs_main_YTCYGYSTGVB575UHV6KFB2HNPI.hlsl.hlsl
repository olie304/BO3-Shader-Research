  ...
  while (true) {
    ...
    switch (r7.w) {
      ...
      if (r13.w != 0) {
        ...
        r11.w = r14.w / r11.w;
        r11.w = min(1, r11.w);
        r36.xy = saturate(r13.ww * lightConstantsCB[r6.w].data[2].xz + lightConstantsCB[r6.w].data[2].yw);
        ...
        if (r13.w != 0) {
          ...
          r17.w = r2.z ? r17.w : 0;
          if (r17.w != 0) {
            r36.xy = mad((int2)r14.ww, int2(24,24), int2(88,104));
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r14.w, cb2[52].x, r36.x, u2.xxxx
          r14.w = samp0[]..swiz;
            r14.w = (int)r14.w | 4;
          ...
          if (r13.w != 0) {
            ...
            r36.xyz = r11.xyz * r13.www + r5.xyz;
            ...
            r19.w = 0;
            while (true) {
              r25.w = cmp((int)r19.w >= 8);
              if (r25.w != 0) break;
              r38.y = dot(icb[r19.w+0].yx, r20.xy);
              r38.z = dot(icb[r19.w+0].yx, r20.yz);
              r38.yz = lightConstantsCB[r6.w].data[3].yy * r38.yz;
              r38.x = r38.y * r16.x;
              r38.w = r38.y * r15.x;
              r37.xyz = r36.xyz * r17.www + r38.xzw;
              r25.w = gOmniShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r37.xyzw, r13.w).x;
              r18.w = r25.w * 0.125 + r18.w;
              r19.w = (int)r19.w + 1;
            }
          } else {
            r18.w = 1;
          ...
          r13.w = cmp(0 < r11.w);
          if (r13.w != 0) {
            r13.w = lightConstantsCB[r6.w].data[1].z * r1.z;
            r13.w = 0.25 * r13.w;
            r17.w = dot(r34.xyz, r17.xyz);
            r19.w = dot(r17.xyz, r35.xyz);
            r25.w = -r17.w * r17.w + lightConstantsCB[r6.w].data[6].y;
            r9.w = r17.w * r19.w + -r9.w;
            r9.w = saturate(r9.w / r25.w);
            r17.w = r25.w / lightConstantsCB[r6.w].data[6].y;
            r17.w = 10 * r17.w;
            r17.w = min(1, r17.w);
            r9.w = r9.w + -r10.w;
            r9.w = r17.w * r9.w + r10.w;
            r21.yzw = r9.www * r34.xyz + r21.yzw;
            ...
            if (r10.w != 0) {
              ...
              r23.xyz = r11.xyz * r10.www + r5.xyz;
              r35.xyz = lightConstantsCB[r9.w].data[6].yzw;
              r35.w = lightConstantsCB[r9.w].data[7].x;
              r10.w = dot(r35.xyzw, r23.xyzw);
              r35.xyz = lightConstantsCB[r9.w].data[7].yzw;
              r35.w = lightConstantsCB[r9.w].data[8].x;
              r17.w = dot(r35.xyzw, r23.xyzw);
              r19.w = cmp(r17.w < r10.w);
              if (r19.w == 0) {
                r35.xyz = lightConstantsCB[r9.w].data[4].yzw;
                r35.w = lightConstantsCB[r9.w].data[5].x;
                r35.x = dot(r35.xyzw, r23.xyzw);
                r36.xyz = lightConstantsCB[r9.w].data[5].yzw;
                r36.w = lightConstantsCB[r9.w].data[6].x;
                r35.y = dot(r36.xyzw, r23.xyzw);
                r23.xy = r35.xy / r17.ww;
                r23.xy = r23.xy * float2(0.5,-0.5) + float2(0.5,0.5);
                r35.x = lightConstantsCB[r9.w].data[9].w + r23.x;
                r35.y = lightConstantsCB[r9.w].data[10].x + r23.y;
                r23.xy = lightConstantsCB[r9.w].data[9].yz * r35.xy;
                r35.xy = lightConstantsCB[r9.w].data[3].yy / lightConstantsCB[r9.w].data[8].yw;
                ...
                if (r23.z == 0) {
                  ...
                  r35.x = r23.x * lightConstantsCB[r9.w].data[8].y + lightConstantsCB[r9.w].data[8].z;
                  r35.y = r23.y * lightConstantsCB[r9.w].data[8].w + lightConstantsCB[r9.w].data[9].x;
                  r23.x = lightConstantsCB[r9.w].data[10].z * r17.w;
              ...
              if (r17.w == 0) {
                ...
                if (enableDitheredShadow != 0) {
                  ...
                  while (true) {
                    ...
                    if (r29.w != 0) break;
                    r36.x = dot(icb[r25.w+0].yx, r20.xw);
                    r36.y = dot(icb[r25.w+0].xy, r13.xy);
                    r23.xy = r36.xy * lightConstantsCB[r9.w].data[3].yy + r35.xy;
                    r23.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r23.xyz, r10.w).x;
                    r19.w = r23.x * 0.125 + r19.w;
                    r25.w = (int)r25.w + 1;
                  }
                } else {
                  r35.z = (uint)r17.w;
                  r19.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r35.xyz, r10.w).x;
                }
                r9.w = r19.w * r19.w;
                r9.w = r9.w * r19.w;
              } else {
              ...
              if (r10.w != 0) {
                ...
                r9.w = mad((int)r9.w, 15, -15);
                r10.w = abs(r12.w) * -0.200000003 + 0.400000006;
                r24.xyz = r11.xyz * r10.www + r5.xyz;
                r35.xyz = lightConstantsCB[r9.w].data[6].yzw;
                r35.w = lightConstantsCB[r9.w].data[7].x;
                r10.w = dot(r35.xyzw, r24.xyzw);
                r35.xyz = lightConstantsCB[r9.w].data[7].yzw;
                r35.w = lightConstantsCB[r9.w].data[8].x;
                r17.w = dot(r35.xyzw, r24.xyzw);
                r23.x = cmp(r17.w < r10.w);
                if (r23.x == 0) {
                  r35.xyz = lightConstantsCB[r9.w].data[4].yzw;
                  r35.w = lightConstantsCB[r9.w].data[5].x;
                  ...
                  r23.yz = r35.xy / r17.ww;
                  r23.yz = r23.yz * float2(0.5,-0.5) + float2(0.5,0.5);
                  r24.x = lightConstantsCB[r9.w].data[9].w + r23.y;
                  r24.y = lightConstantsCB[r9.w].data[10].x + r23.z;
                  r23.yz = lightConstantsCB[r9.w].data[9].yz * r24.xy;
                  r24.xy = lightConstantsCB[r9.w].data[3].yy / lightConstantsCB[r9.w].data[8].yw;
                  ...
                  if (r24.x == 0) {
                    ...
                    r35.x = r23.y * lightConstantsCB[r9.w].data[8].y + lightConstantsCB[r9.w].data[8].z;
                    r35.y = r23.z * lightConstantsCB[r9.w].data[8].w + lightConstantsCB[r9.w].data[9].x;
                    r23.y = lightConstantsCB[r9.w].data[10].z * r17.w;
                    r10.w = lightConstantsCB[r9.w].data[10].y * r17.w + r10.w;
                    r10.w = r10.w / r23.y;
                  }
                } else {
                ...
                if (r17.w == 0) {
                  ...
                  if (enableDitheredShadow != 0) {
                    ...
                    r35.z = (uint)r17.w;
                    r24.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r35.xyz, r10.w).x;
                  }
                  r9.w = r24.x * r24.x;
                  r9.w = r9.w * r24.x;
                } else {
            ...
            r9.w = r12.w * r9.w;
            r9.w = r9.w * r11.w;
            r21.yzw = r9.www * r23.xyz + r33.xyz;
            r8.w = saturate(1 + -r8.w);
            r12.w = r8.w * r8.w;
            r12.w = r12.w * r12.w;
            r8.w = r12.w * r8.w;
            ...
            r16.yzw = r10.www ? r35.xyz : r16.yzw;
            r32.xyz = r10.www ? r23.xyz : r32.xyz;
            r33.xyz = r10.www ? r21.yzw : r33.xyz;
            r8.w = (int)r14.w & 15;
            r9.w = (int)r8.w + -1;
      ...
      if (r11.w != 0) {
        ...
        if (r12.w != 0) {
          ...
          r13.w = dot(r22.yzw, r22.yzw);
          r13.z = r13.z / r13.w;
          r13.z = min(1, r13.z);
          r22.yz = saturate(r11.ww * lightConstantsCB[r6.w].data[2].xz + lightConstantsCB[r6.w].data[2].yw);
          ...
          if (r11.w != 0) {
            ...
            r22.yz = exp2(r22.yz);
            r13.w = lightConstantsCB[r6.w].data[12].x * r22.y;
            r14.w = lightConstantsCB[r6.w].data[12].y * r22.z + -1;
            r13.w = lightConstantsCB[r6.w].data[12].y * r22.z + -r13.w;
          ...
          if (r11.w != 0) {
            r13.z = dot(lightConstantsCB[r6.w].data[13].xyz, r25.xyz);
            r35.x = lightConstantsCB[r6.w].data[13].w;
            r35.yz = lightConstantsCB[r6.w].data[14].xy;
            r13.w = dot(r35.xyz, r25.xyz);
            r35.xy = frac(r13.zw);
            r11.w = (int)r11.w + -1;
            r35.z = (uint)r11.w;
        ...
        if (r11.w != 0) {
          ...
          r13.w = r2.z ? r13.w : 0;
          if (r13.w != 0) {
            r13.zw = mad((int2)r13.zz, int2(24,24), int2(88,104));
          // Known bad code for instruction (needs manual fix):
          ...
          if (r11.w != 0) {
            ...
            r11.w = dot(r35.xyzw, r26.xyzw);
            r13.w = dot(r34.xyzw, r26.xyzw);
            ...
            if (r14.w != 0) {
              ...
              if (enableDitheredShadow != 0) {
                ...
                r17.w = 0;
                while (true) {
                  r22.y = cmp((int)r17.w >= 8);
                  if (r22.y != 0) break;
                  r25.x = dot(icb[r17.w+0].xy, r29.xy);
                  r25.y = dot(icb[r17.w+0].yx, r29.xz);
                  r34.xy = r25.xy * lightConstantsCB[r6.w].data[3].yy + r26.xy;
                  r22.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r34.xyz, r11.w).x;
                  r14.w = r22.y * 0.125 + r14.w;
                  r17.w = (int)r17.w + 1;
                }
              } else {
                r26.z = (uint)r13.w;
                r14.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r26.xyz, r11.w).x;
              }
              r11.w = r14.w * r14.w;
              r11.w = r11.w * r14.w;
            } else {
          ...
          r12.w = cmp(0 < r11.w);
          if (r12.w != 0) {
            r12.w = lightConstantsCB[r6.w].data[1].z * r1.z;
            r12.w = r12.w * r10.w;
            if (4 == 0) r13.w = 0; else if (4+16 < 32) {             r13.w = (uint)lightConstantsCB[r6.w].data[1].w << (32-(4 + 16)); r13.w = (uint)r13.w >> (32-4);            } else r13.w = (uint)lightConstantsCB[r6.w].data[1].w >> 16;
            ...
            if (r17.w != 0) {
              ...
              r27.xyz = r11.xyz * r17.www + r5.xyz;
              ...
              if (r22.z == 0) {
                ...
                r25.x = lightConstantsCB[r13.w].data[9].w + r24.y;
                r25.y = lightConstantsCB[r13.w].data[10].x + r24.z;
                r24.yz = lightConstantsCB[r13.w].data[9].yz * r25.xy;
                ...
                if (r22.w == 0) {
                  ...
                  r26.x = r24.y * lightConstantsCB[r13.w].data[8].y + lightConstantsCB[r13.w].data[8].z;
                  r26.y = r24.z * lightConstantsCB[r13.w].data[8].w + lightConstantsCB[r13.w].data[9].x;
                  r24.y = lightConstantsCB[r13.w].data[10].z * r22.y;
                  r17.w = lightConstantsCB[r13.w].data[10].y * r22.y + r17.w;
                  r17.w = r17.w / r24.y;
                }
              } else {
                r22.w = -1;
              ...
              if (r22.y == 0) {
                ...
                if (enableDitheredShadow != 0) {
                  ...
                  while (true) {
                    ...
                    r27.xy = r25.xy * lightConstantsCB[r13.w].data[3].yy + r26.xy;
                    r24.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r27.xyz, r17.w).x;
              ...
              if (r13.w != 0) {
                ...
                r13.w = dot(r34.xyzw, r28.xyzw);
                r34.xyz = lightConstantsCB[r6.w].data[7].yzw;
                r34.w = lightConstantsCB[r6.w].data[8].x;
                r17.w = dot(r34.xyzw, r28.xyzw);
                r22.y = cmp(r17.w < r13.w);
                if (r22.y == 0) {
                  r34.xyz = lightConstantsCB[r6.w].data[4].yzw;
                  r34.w = lightConstantsCB[r6.w].data[5].x;
                  ...
                  if (r22.w == 0) {
                    ...
                    r24.y = lightConstantsCB[r6.w].data[10].z * r17.w;
                    r13.w = lightConstantsCB[r6.w].data[10].y * r17.w + r13.w;
                    r13.w = r13.w / r24.y;
                  }
                } else {
                  r22.w = -1;
                }
                r17.w = (int)r22.y | (int)r22.w;
                if (r17.w == 0) {
                  r13.w = max(6.10351563e-05, r13.w);
                  ...
                  if (enableDitheredShadow != 0) {
                    ...
                    while (true) {
                      ...
                      r24.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r27.xyz, r13.w).x;
                      r22.y = r24.y * 0.125 + r22.y;
                      r22.w = (int)r22.w + 1;
                    }
                  } else {
                    r26.z = (uint)r17.w;
                    r22.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r26.xyz, r13.w).x;
                  }
                  r6.w = r22.y * r22.y;
                  r6.w = r6.w * r22.y;
                } else {
            ...
            r6.w = r6.w * r11.w;
            r9.w = cmp(0 < r9.w);
            r25.xyw = r6.www * r21.yzw + r16.yzw;
            ...
            r13.w = abs(r8.w) * r1.z + -abs(r8.w);
            r8.w = abs(r8.w) * r13.w + 1;
            r10.w = r10.w * r2.y + r3.z;
            r8.w = r8.w * r8.w;
            r8.w = r8.w * r10.w;
            r8.w = rcp(r8.w);
            r8.w = r8.w * r12.w;
            ...
            r16.yzw = r9.www ? r25.xyw : r16.yzw;
            r32.xyz = r9.www ? r21.yzw : r32.xyz;
            r33.xyz = r9.www ? r23.xyz : r33.xyz;
            r6.w = (int)r13.z & 15;
            r8.w = (int)r6.w + -1;
