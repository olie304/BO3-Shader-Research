...
r0.y = samp0[]..swiz;
  ...
  r13.w = 0;
  r13.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r13.xyzw, r4.z).xyz;
  r4.z = sunConstants.globalProbeExposure + -r6.w;
  r4.z = r2.y * r4.z + r6.w;
  r13.xyz = r13.xyz * r4.zzz;
  r4.z = r2.x + r3.z;
  r4.z = log2(abs(r4.z));
  r4.z = r4.z * r1.w;
  r4.z = exp2(r4.z);
  ...
  r13.xyz = r13.xyz * r4.zzz;
  r15.xzw = r13.xyz * r15.xxx;
  r13.xyz = r13.xyz * r15.yyy;
  if (r2.z != 0) {
    r16.x = 3;
  ...
  if (r2.y != 0) {
    ...
    if (r2.y != 0) {
      ...
      r1.z = r1.z * r4.w;
      r1.w = cmp(0 < r2.w);
      r17.xyz = r1.zzz * r16.xyz + r14.xyz;
      ...
      r0.w = r4.w * r0.w;
      r0.w = 0.25 * r0.w;
      r2.xyw = r0.www * r16.xyz + r13.xyz;
      r0.z = saturate(1 + -r0.z);
      r1.z = r0.z * r0.z;
      r1.z = r1.z * r1.z;
      r0.z = r1.z * r0.z;
      r0.z = r0.w * r0.z;
      r4.xyz = r0.zzz * r16.xyz + r15.xzw;
      r14.xyz = r1.www ? r17.xyz : r14.xyz;
      r15.xzw = r1.www ? r4.xyz : r15.xzw;
      r13.xyz = r1.www ? r2.xyw : r13.xyz;
      if (r2.z != 0) {
      // Known bad code for instruction (needs manual fix):
  ...
  r2.xyw = r13.xyz * r3.xyz + r2.xyw;
  r2.xyw = r14.xyz * r5.yzw + r2.xyw;
