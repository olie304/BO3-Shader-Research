...
mul r2.xy, r0.xyxx, cb0[5].xyxx
mul r0.xy, r0.xyxx, cb0[18].xyxx
mul r2.zw, v2.xxxy, cb0[5].xxxy
movc r3.xy, cb0[15].yyyy, r2.xyxx, r2.zwzz
movc r2.xy, cb0[17].wwww, r2.xyxx, r2.zwzz
sample_indexable(texture2d)(float,float,float,float) r4.xyz, r3.xyxx, t33.xyzw, s1
mad r4.xyz, r4.xyzx, cb2[41].xyzx, -r1.xyzx
mul r2.zw, v2.xxxy, cb0[18].xxxy
movc r0.xy, cb0[15].xxxx, r0.xyxx, r2.zwzz
sample_indexable(texture2d)(float,float,float,float) r0.x, r0.xyxx, t11.xyzw, s1
sample_indexable(texture2d)(float,float,float,float) r5.xyz, r0.zwzz, t10.xyzw, s3
sample_indexable(texture2d)(float,float,float,float) r0.y, r0.zwzz, t7.yxzw, s2
mad r0.zw, r5.xxxy, l(0.000000, 0.000000, 1.99218750, 1.99218750), l(0.000000, 0.000000, -1.000000, -1.000000)
mul r1.w, r5.z, r5.z
mul r1.w, r1.w, l(0.33333334)
min r1.w, r1.w, l(1.000000)
sample_indexable(texture2d)(float,float,float,float) r5.xyz, v2.xyxx, t6.xyzw, s3
...
mad r5.xy, r0.zwzz, cb0[11].zzzz, r2.zwzz
...
rsq r0.w, r0.w
mul r9.xyz, r0.wwww, v5.xyzx
mul r9.xyz, r0.zzzz, r9.xyzx
mad r8.xyz, r9.xyzx, r6.xxxx, r8.xyzx
dp3 r0.w, v4.xyzx, v4.xyzx
rsq r0.w, r0.w
mul r10.xyz, r0.wwww, v4.xyzx
mul r11.xyz, r0.zzzz, r10.xyzx
mad r8.xyz, r11.xyzx, r6.zzzz, r8.xyzx
dp3 r0.w, r8.xyzx, r8.xyzx
rsq r0.w, r0.w
mul r8.xyz, r0.wwww, r8.xyzx
dp3_sat r0.w, r8.xyzx, cb2[39].yzwy
dp3_sat r3.w, r8.xyzx, cb2[40].xyzx
log r3.w, r3.w
mul r3.w, r3.w, cb0[19].y
exp r3.w, r3.w
add r3.w, r3.w, -cb0[19].x
log r0.w, r0.w
mul r0.w, r0.w, cb0[18].w
exp r0.w, r0.w
add r0.w, r0.w, -cb0[18].z
add r4.w, -cb0[18].z, l(1.000000)
max r4.w, r4.w, l(0.000100)
div_sat r0.w, r0.w, r4.w
mul r0.w, r0.x, r0.w
mad r1.xyz, r0.wwww, r4.xyzx, r1.xyzx
sample_indexable(texture2d)(float,float,float,float) r4.xyz, r2.xyxx, t40.xyzw, s1
...
mov o0.w, l(1.000000)
sample_indexable(texture2d)(float,float,float,float) r1.xyz, r3.xyxx, t34.xyzw, s3
sample_indexable(texture2d)(float,float,float,float) r3.x, r3.xyxx, t32.xyzw, s1
...
mad r4.w, r1.z, cb0[11].w, r3.z
mad r5.xy, r1.xyxx, cb0[11].wwww, r2.zwzz
dp3 r1.x, r5.xyzx, r5.xyzx
rsq r1.x, r1.x
mul r4.xyz, r1.xxxx, r5.xyzx
mad r6.w, r1.w, cb0[11].z, r3.z
add r1.xyzw, r4.xyzw, -r6.xyzw
mad r1.xyzw, r0.wwww, r1.xyzw, r6.xyzw
sample_indexable(texture2d)(float,float,float,float) r3.y, r2.xyxx, t41.yxzw, s3
sample_indexable(texture2d)(float,float,float,float) r2.x, r2.xyxx, t39.xyzw, s1
mad r2.y, r3.y, l(1.99218750), l(-1.000000)
mul r3.y, r3.y, r3.y
mul r3.y, r3.y, l(0.33333334)
min r3.y, r3.y, l(1.000000)
mad r4.w, r3.y, cb0[15].z, r3.z
mad r5.xy, r2.yyyy, cb0[15].zzzz, r2.zwzz
dp3 r2.y, r5.xyzx, r5.xyzx
rsq r2.y, r2.y
mul r4.xyz, r2.yyyy, r5.xyzx
add r4.xyzw, -r1.xyzw, r4.xyzw
mad r1.xyzw, r0.xxxx, r4.xyzw, r1.xyzw
mul r2.yzw, r1.yyyy, r7.xxyz
mad r2.yzw, r9.xxyz, r1.xxxx, r2.yyzw
mad r1.xyz, r11.xyzx, r1.zzzz, r2.yzwy
add r2.y, r11.y, r11.x
mad r2.y, r10.z, r0.z, r2.y
mul r2.y, r2.y, l(0.500000)
dp3 r2.z, r1.xyzx, r1.xyzx
rsq r2.z, r2.z
mul r4.yzw, r1.xxyz, r2.zzzz
mul r5.yzw, r4.yyzw, l(0.000000, 1.000000, -1.000000, -1.000000)
mad r1.xyz, r10.xyzx, r0.zzzz, -r2.yyyy
max r0.z, r1.z, r1.y
max r0.z, r0.z, r1.x
max r0.z, r0.z, r2.y
eq r1.x, r0.z, r1.x
...
eq r0.z, r0.z, r1.z
mov r5.x, l(3)
movc r4.xyzw, r0.zzzz, r5.xyzw, r4.xyzw
add r0.z, r4.z, r4.y
add r1.z, r4.w, r0.z
...
add r1.x, -cb0[10].y, cb0[10].z
mad r0.y, r0.y, r1.x, cb0[10].y
