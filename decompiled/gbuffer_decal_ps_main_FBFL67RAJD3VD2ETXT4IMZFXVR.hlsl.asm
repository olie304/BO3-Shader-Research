...
mul r2.x, r0.y, r1.w
sample_indexable(texture2d)(float,float,float,float) r2.y, r0.zwzz, t11.yxzw, s4
sample_indexable(texture2d)(float,float,float,float) r2.z, r0.zwzz, t10.yzxw, s2
add r2.w, -cb0[10].y, cb0[10].z
mad r2.z, r2.z, r2.w, cb0[10].y
mul_sat r2.z, r2.z, l(0.05882353)
sample_indexable(texture2d)(float,float,float,float) r3.xyz, r0.zwzz, t9.xyzw, s3
...
mad r2.w, cb1[62].x, r2.w, cb0[10].y
...
if_nz r3.z
  ...
  movc r1.xyz, r0.wwww, r5.xyzx, r4.yzwy
endif 
...
mad r5.xyz, v5.xyzx, r4.xxxx, -r3.xywx
mad r3.xyz, cb1[60].wwww, r5.xyzx, r3.xywx
