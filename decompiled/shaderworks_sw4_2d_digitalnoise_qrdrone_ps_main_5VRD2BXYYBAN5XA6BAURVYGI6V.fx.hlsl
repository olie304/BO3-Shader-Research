  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r3.x = r2.x * r0.y;
  r3.y = -r2.y * r0.y;
  r2.xy = r3.xy * float2(167.555862,94.2501678) + float2(0.75,0.75);
  r2.xyz = GridTexture.Sample(GridTexture_Sampler_s, r2.xy).xyz;
  r2.xyz = float3(0.184,0.698000014,0.588) * r2.xyz;
