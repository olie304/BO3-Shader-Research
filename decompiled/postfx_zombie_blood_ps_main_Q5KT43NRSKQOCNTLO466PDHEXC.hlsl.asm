...
div r2.xy, r1.zwzz, r0.wwww
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r2.xyxx, t7.xyzw, s2
mad r0.z, r0.z, r1.y, cb0[11].x
div r0.zw, r1.zzzw, r0.zzzz
sample_indexable(texture2d)(float,float,float,float) r3.xyzw, r0.zwzz, t7.xyzw, s2
add r2.xyzw, r2.xyzw, -r3.xyzw
mad r2.xyzw, r1.xxxx, r2.xyzw, r3.xyzw
mad r0.x, r0.x, r1.y, cb0[11].x
mad r0.z, r0.y, r1.y, cb0[11].x
...
div r0.zw, r1.zzzw, r0.zzzz
sample_indexable(texture2d)(float,float,float,float) r3.xyzw, r0.zwzz, t7.xyzw, s2
div r0.xz, r1.zzwz, r0.xxxx
sample_indexable(texture2d)(float,float,float,float) r4.xyzw, r0.xzxx, t7.xyzw, s2
add r3.xyzw, r3.xyzw, -r4.xyzw
mad r0.xyzw, r0.yyyy, r3.xyzw, r4.xyzw
add r2.xyz, -r0.xyzx, r2.xyzx
mad r0.xyz, r2.wwww, r2.xyzx, r0.xyzx
add_sat r0.w, r2.w, r0.w
min r1.x, |cb3[0].x|, l(1.000000)
mul r1.x, r1.x, cb0[10].z
mul r1.x, r1.x, cb1[44].z
sample_indexable(texture2d)(float,float,float,float) r1.y, v1.xyxx, t6.yxzw, s1
add r1.y, -r1.y, l(1.000000)
mad r2.x, r1.y, r1.x, l(1.000000)
