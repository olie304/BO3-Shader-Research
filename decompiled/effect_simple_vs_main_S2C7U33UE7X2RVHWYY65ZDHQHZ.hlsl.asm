...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:25:43 2021
//
//
// Buffer Definitions: 
//
...
eq r1.xy, cb0[15].xyxx, l(0.000000, 0.000000, 0.000000, 0.000000)
and r0.w, r1.y, r1.x
mul r1.xy, cb0[15].xyxx, l(0.01745329, 0.01745329, 0.000000, 0.000000)
...
movc o8.xy, r0.wwww, l(0,1.000000,0,0), r2.xyxx
ushr r0.w, v0.w, l(16)
f16tof32 o5.w, r0.w
...
or r1.w, r5.z, r1.w
or r3.z, r5.w, r1.w
movc o13.xyz, r0.wwww, r1.xyzx, l(1.000000,0,0,0)
movc o14.xyz, r0.wwww, r2.xyzx, r4.xyzx
mov r3.y, l(1.000000)
movc r1.xy, r0.wwww, r3.xyxx, r3.xzxx
mul o4.xy, r1.yyyy, v2.xyxx
...
add r3.xyz, v0.xyzx, -cb1[24].xyzx
...
if_nz r0.w
  ...
  sqrt r0.w, r0.w
  dp3 r4.x, cb1[38].xyzx, -r4.xyzx
  mad r4.y, -cb1[31].w, cb1[31].w, l(1.000000)
  mad r4.z, cb1[31].w, -r4.x, l(1.000000)
  mul r4.z, r4.z, r4.z
  mul r4.z, r4.z, l(12.566371)
  div r4.y, r4.y, r4.z
  add r4.z, r0.w, -cb1[37].z
  mul_sat r4.z, r4.z, cb1[37].w
  mul r4.y, r4.z, r4.y
  mad r0.w, r0.w, cb1[35].x, cb1[34].w
  mul r0.w, r0.w, cb1[35].z
  lt r4.z, l(0.010000), |r3.z|
  mul r4.w, r3.z, cb1[35].y
  mul r5.x, r4.w, l(-1.442695)
  exp r5.x, r5.x
  add r5.x, -r5.x, l(1.000000)
  div r4.w, r5.x, r4.w
  mul r4.w, r0.w, r4.w
  movc r0.w, r4.z, r4.w, r0.w
  mul r5.xyz, r0.wwww, cb1[33].xyzx
  exp r5.xyz, r5.xyzx
  ...
  mul r4.xyz, r4.yyyy, cb1[32].xyzx
  ...
  mul o11.xyz, r4.xyzx, r6.xyzx
  mov o10.xyz, r5.xyzx
  mov o3.xyzw, l(0,0,0,1.000000)
else 
  mul r0.w, r3.z, cb1[29].w
  mad r4.x, cb1[29].w, r3.z, cb1[29].x
  lt r4.y, |r0.w|, l(0.000100)
  min r4.z, r4.x, l(64.000000)
  mul r4.z, r4.z, l(1.442695)
  exp r4.z, r4.z
  mov_sat r4.w, cb1[30].x
  lt r5.x, r4.x, l(0.000000)
  add r4.x, r4.x, l(1.000000)
  movc r4.x, r5.x, r4.z, r4.x
  add r4.x, r4.x, -cb1[30].x
  movc r0.w, r4.y, l(1.000000), r0.w
  div r0.w, r4.x, r0.w
  movc r0.w, r4.y, r4.w, r0.w
  mul r0.w, r0.w, cb1[29].y
  dp3 r4.x, r3.xyzx, r3.xyzx
  sqrt r4.y, r4.x
  mad r0.w, r0.w, r4.y, cb1[29].z
  exp r0.w, r0.w
  min r0.w, r0.w, l(1.000000)
  rsq r4.x, r4.x
  mul r4.xyz, r3.xyzx, r4.xxxx
  dp3 r4.x, cb1[38].xyzx, r4.xyzx
  mad_sat r4.x, cb1[40].y, r4.x, cb1[40].x
  add r5.xyzw, cb1[28].xyzw, -cb1[39].xyzw
  mad r4.xyzw, r4.xxxx, r5.xyzw, cb1[39].xyzw
  add r0.w, -r0.w, l(1.000000)
  mad o3.w, -r0.w, r4.w, l(1.000000)
  mov o10.xyz, l(1.000000,1.000000,1.000000,0)
  mov o11.xyz, l(0,0,0,0)
  mov o3.xyz, r4.xyzx
endif 
max r1.z, cb0[18].w, l(0.000000)
mul r0.w, r3.y, cb1[5].z
mad r0.w, r3.x, cb1[4].z, r0.w
mad r0.w, r3.z, cb1[6].z, r0.w
mul r4.xyz, r3.yyyy, cb1[9].xywx
mad r4.xyz, r3.xxxx, cb1[8].xywx, r4.xyzx
mad r4.xyz, r3.zzzz, cb1[10].xywx, r4.xyzx
...
ftou r4.xy, r4.xyxx
mul r5.xyz, r3.yyyy, cb2[29].xyzx
mad r5.xyz, r3.xxxx, cb2[28].xyzx, r5.xyzx
mad r5.xyz, r3.zzzz, cb2[30].xyzx, r5.xyzx
  ...
  loop 
    ...
    if_nz r6.w
      ...
      switch r7.x
        ...
        mul r9.w, r9.w, r13.x
        dp4 r14.x, r14.xyzw, r3.xyzw
        dp4 r14.y, r15.xyzw, r3.xyzw
...
ne r3.w, l(0.000000, 0.000000, 0.000000, 0.000000), r4.w
mad r5.xyz, r10.xyzx, r0.wwww, r9.xyzx
mad r0.w, -r4.w, l(1.010101), l(1.000000)
mul r6.xyz, cb2[19].xxxx, cb2[19].yzwy
mad r4.xyz, r6.xyzx, r0.wwww, r4.xyzx
add r4.xyz, r4.xyzx, r9.xyzx
movc r4.xyz, r3.wwww, r5.xyzx, r4.xyzx
mul o1.xyz, r4.xyzx, v1.xyzx
max r0.w, r1.z, l(0.100000)
div r0.w, l(1.000000, 1.000000, 1.000000, 1.000000), r0.w
ge r3.w, l(1.000000), r0.w
mul_sat r0.w, r0.w, r2.w
mul r0.w, r0.w, v1.w
movc o1.w, r3.w, r0.w, v1.w
mov o0.xyzw, r2.xyzw
mov o5.xyz, r3.xyzx
mov r1.w, l(0)
mov o6.xyzw, r1.wxzw
