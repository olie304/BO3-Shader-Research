  ...
  out float3 o0 : SV_TARGET0)
{
  ...
  r0.xyz = r1.xyz ? r0.xyz : float3(2,2,2);
  r1.xy = v1.xy * postFxControl0.xy + postFxControl0.zw;
  r0.w = tNoise.Sample(pointWrap_s, r1.xy).x;
  r0.w = postFxControl1.x * r0.w;
  r1.xy = float2(0.0250000004,0.0250000004) * v0.xy;
  r1.xyz = tDither.Sample(pointWrap_s, r1.xy).xyz;
  r0.xyz = r0.www * r1.xyz + r0.xyz;
  r1.xy = r1.xz * r0.ww;
  r0.xz = r1.yx * r0.yy + r0.xz;
  r0.xyz = postFxControl1.yyy * r0.xyz;
  r0.xyz = max(float3(0,0,0), r0.xyz);
  r0.xyz = log2(r0.xyz);
  r0.xyz = postFxControl1.zzz * r0.xyz;
  r0.xyz = exp2(r0.xyz);
  o0.xyz = -postFxControl1.www + r0.xyz;
  return;
}