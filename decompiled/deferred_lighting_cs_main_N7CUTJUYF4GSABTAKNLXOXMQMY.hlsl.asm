...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:23:42 2021
//
//
// Buffer Definitions: 
//
...
if_nz r6.w
  ...
  add r15.yzw, r5.xxyz, -cb10[r6.w + 0].xxyz
  ...
  movc r13.zw, r9.wwww, r18.xxxy, r18.zzzx
  ...
  loop 
    ...
    dp3 r14.w, cb11[r12.w + 0].xyzx, r15.yzwy
    add_sat r14.w, r14.w, cb11[r12.w + 0].w
    mul r14.w, r14.w, r19.x
    dp3 r16.y, cb11[r12.w + 1].xyzx, r15.yzwy
    add_sat r16.y, r16.y, cb11[r12.w + 1].w
    mul r14.w, r14.w, r16.y
    dp3 r16.y, cb11[r12.w + 2].xyzx, r15.yzwy
    add_sat r16.y, r16.y, cb11[r12.w + 2].w
    mul r14.w, r14.w, r16.y
    dp3 r16.y, cb11[r12.w + 3].xyzx, r15.yzwy
    add_sat r16.y, r16.y, cb11[r12.w + 3].w
    mul r14.w, r14.w, r16.y
    dp3 r16.y, cb11[r12.w + 4].xyzx, r15.yzwy
    add_sat r16.y, r16.y, cb11[r12.w + 4].w
    mul r14.w, r14.w, r16.y
    dp3 r16.y, cb11[r12.w + 5].xyzx, r15.yzwy
    add_sat r12.w, r16.y, cb11[r12.w + 5].w
    mul r19.x, r12.w, r14.w
    ushr r16.y, r9.w, l(2)
    ubfe r16.z, l(1), l(2), r9.w
    and r16.w, r16.y, l(2)
    max r18.z, r19.x, r19.y
    mad r12.w, -r14.w, r12.w, l(1.000000)
    mul r12.w, r12.w, r19.y
    movc r18.y, r16.w, r12.w, r18.z
    movc r19.xy, r16.zzzz, r19.xyxx, r18.xyxx
    iadd r10.w, r10.w, l(1)
    mov r9.w, r16.y
  endloop 
  mov_sat r19.y, r19.y
  mul r7.w, r19.y, cb10[r6.w + 6].y
  ...
  if_nz r8.w
    ...
    mov r18.x, cb10[r6.w + 7].w
    mov r18.yz, cb10[r6.w + 8].xxyx
    dp3 r9.w, r17.xyzx, r18.xyzx
    dp3 r10.w, r15.yzwy, r18.xyzx
    add r10.w, r10.w, -cb10[r6.w + 8].z
    ...
    mov r18.x, cb10[r6.w + 8].w
    mov r18.yz, cb10[r6.w + 9].xxyx
    dp3 r10.w, r17.xyzx, r18.xyzx
    dp3 r12.w, r15.yzwy, r18.xyzx
    add r12.w, r12.w, -cb10[r6.w + 9].z
    ...
    min r9.w, r9.w, |r10.w|
    mov r18.x, cb10[r6.w + 9].w
    mov r18.yz, cb10[r6.w + 10].xxyx
    dp3 r10.w, r17.xyzx, r18.xyzx
    dp3 r12.w, r15.yzwy, r18.xyzx
    add r12.w, r12.w, -cb10[r6.w + 10].z
    ge r13.z, r12.w, l(0.000000)
    max r12.w, r3.y, |r12.w|
    movc r12.w, r13.z, r12.w, -r12.w
    max r10.w, -r10.w, l(0.00000010)
    div r10.w, r12.w, r10.w
    min r9.w, r9.w, |r10.w|
    mov r18.x, cb10[r6.w + 10].w
    mov r18.yz, cb10[r6.w + 11].xxyx
    dp3 r10.w, r17.xyzx, r18.xyzx
    dp3 r12.w, r15.yzwy, r18.xyzx
    add r12.w, r12.w, -cb10[r6.w + 11].z
    ge r13.z, r12.w, l(0.000000)
    max r12.w, r3.y, |r12.w|
    movc r12.w, r13.z, r12.w, -r12.w
    max r10.w, -r10.w, l(0.00000010)
    div r10.w, r12.w, r10.w
    min r9.w, r9.w, |r10.w|
    mov r18.x, cb10[r6.w + 11].w
    mov r18.yz, cb10[r6.w + 12].xxyx
    dp3 r10.w, r17.xyzx, r18.xyzx
    dp3 r12.w, r15.yzwy, r18.xyzx
    add r12.w, r12.w, -cb10[r6.w + 12].z
    ge r13.z, r12.w, l(0.000000)
    max r12.w, r3.y, |r12.w|
    movc r12.w, r13.z, r12.w, -r12.w
    max r10.w, -r10.w, l(0.00000010)
    div r10.w, r12.w, r10.w
    min r9.w, r9.w, |r10.w|
    mov r18.x, cb10[r6.w + 12].w
    mov r18.yz, cb10[r6.w + 13].xxyx
    dp3 r10.w, r17.xyzx, r18.xyzx
    dp3 r12.w, r15.yzwy, r18.xyzx
    add r12.w, r12.w, -cb10[r6.w + 13].z
    ge r13.z, r12.w, l(0.000000)
    max r12.w, r3.y, |r12.w|
    movc r12.w, r13.z, r12.w, -r12.w
    max r10.w, -r10.w, l(0.00000010)
    div r10.w, r12.w, r10.w
    min r9.w, r9.w, |r10.w|
    add r18.x, r15.y, cb10[r6.w + 3].w
    add r18.yz, r15.zzwz, cb10[r6.w + 4].xxyx
    ...
    mov r18.x, cb10[r6.w + 0].w
    mov r18.y, cb10[r6.w + 1].z
    mov r18.z, cb10[r6.w + 2].y
    dp3 r19.x, r16.yzwy, r18.xyzx
    mov r20.xy, cb10[r6.w + 1].xwxx
    mov r20.z, cb10[r6.w + 2].z
    dp3 r19.y, r16.yzwy, r20.xyzx
    mov r21.x, cb10[r6.w + 1].y
    mov r21.yz, cb10[r6.w + 2].xxwx
    dp3 r19.z, r16.yzwy, r21.xyzx
    ubfe r10.w, l(9), l(16), cb10[r6.w + 7].z
    utof r19.w, r10.w
    ...
    mad_sat r15.yzw, r22.xxyz, cb10[r6.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
    mul r22.xy, r15.yzyy, cb10[r6.w + 4].zwzz
    mul r22.z, r15.w, cb10[r6.w + 5].x
    add r15.yzw, r22.xxyz, cb10[r6.w + 5].yyzw
...
if_nz r3.w
  ...
  if_nz r1.w
    and r3.w, r6.w, l(1)
    imad r3.w, r3.w, l(20), l(880)
    add r18.yzw, cb1[24].xxyz, cb10[r0.y + 0].xxyz
    mov r18.x, l(16)
    store_structured u2.xyzw, cb2[52].x, r3.w, r18.xyzw
  endif 
  iadd r3.w, r6.w, l(1)
  ...
  if_nz r10.w
    ...
    dp3 r12.w, r17.xyzx, r19.xyzx
    dp3 r13.z, r18.xyzx, r19.xyzx
    add r13.z, r13.z, -cb10[r0.y + 10].z
    ge r13.w, r13.z, l(0.000000)
    max r13.z, r3.y, |r13.z|
    movc r13.z, r13.w, r13.z, -r13.z
    max r12.w, -r12.w, l(0.00000010)
    ...
    dp3 r12.w, r17.xyzx, r19.xyzx
    dp3 r13.z, r18.xyzx, r19.xyzx
    add r13.z, r13.z, -cb10[r0.y + 11].z
    ge r13.w, r13.z, l(0.000000)
    max r13.z, r3.y, |r13.z|
    movc r13.z, r13.w, r13.z, -r13.z
    max r12.w, -r12.w, l(0.00000010)
    ...
    dp3 r12.w, r17.xyzx, r19.xyzx
    dp3 r13.z, r18.xyzx, r19.xyzx
    add r13.z, r13.z, -cb10[r0.y + 12].z
    ge r13.w, r13.z, l(0.000000)
    max r13.z, r3.y, |r13.z|
    movc r13.z, r13.w, r13.z, -r13.z
    max r12.w, -r12.w, l(0.00000010)
    ...
    dp3 r12.w, r17.xyzx, r19.xyzx
    dp3 r13.z, r18.xyzx, r19.xyzx
    add r13.z, r13.z, -cb10[r0.y + 13].z
    ge r13.w, r13.z, l(0.000000)
    max r3.y, r3.y, |r13.z|
    movc r3.y, r13.w, r3.y, -r3.y
    max r12.w, -r12.w, l(0.00000010)
    div r3.y, r3.y, r12.w
    min r3.y, |r3.y|, r10.w
    add r19.x, r18.x, cb10[r0.y + 3].w
    add r19.yz, r18.yyzy, cb10[r0.y + 4].xxyx
    mad r19.xyz, r17.xyzx, r3.yyyy, r19.xyzx
    dp3 r10.w, r19.xyzx, r19.xyzx
    sqrt r10.w, r10.w
    div r3.y, r3.y, r10.w
    add r3.y, r3.y, r3.y
    sqrt r3.y, r3.y
    mad r2.z, r2.z, l(5.000000), r3.y
    ...
    ubfe r3.y, l(9), l(16), cb10[r0.y + 7].z
    utof r21.w, r3.y
    ...
    or r2.z, r24.y, r24.x
    or r2.z, r24.z, r2.z
    movc r19.xyz, r2.zzzz, l(1.000000,1.000000,0,0), r19.xyzx
    ...
    dp3 r3.y, r18.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
    mad r0.y, r3.z, r0.y, r3.y
    div r0.y, r2.z, r0.y
...
ret 
// Approximately 1654 instruction slots used
