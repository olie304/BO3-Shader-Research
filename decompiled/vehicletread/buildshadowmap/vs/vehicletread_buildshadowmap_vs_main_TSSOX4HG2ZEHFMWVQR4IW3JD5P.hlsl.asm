...
//   float2 scrollUVs;                  // Offset:  160 Size:     8
//   float treadDepth;                  // Offset:  168 Size:     4
//   float reverseTread;                // Offset:  172 Size:     4
//
// }
//
...
if_nz r0.x
  ...
  if_nz r0.z
    ...
    add r0.z, r2.w, r0.z
    mul r1.yz, r0.wwzw, v2.xxxx
    ne r0.z, v2.y, l(0.000000)
    if_nz r0.z
      iadd r0.z, r0.x, v3.y
      ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r2.xyzw, r0.z, l(0), t5.xyzw
      dp3 r0.w, r2.xyzx, v0.xyzx
      add r0.w, r2.w, r0.w
      mad r1.x, r0.w, v2.y, r1.x
      ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r2.xyzw, r0.z, l(16), t5.xyzw
      dp3 r0.w, r2.xyzx, v0.xyzx
      add r0.w, r2.w, r0.w
      mad r1.y, r0.w, v2.y, r1.y
      ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r2.xyzw, r0.z, l(32), t5.xyzw
      dp3 r0.z, r2.xyzx, v0.xyzx
      add r0.z, r2.w, r0.z
      mad r1.z, r0.z, v2.y, r1.z
      ne r0.z, v2.z, l(0.000000)
      if_nz r0.z
        iadd r0.z, r0.x, v3.z
        ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r2.xyzw, r0.z, l(0), t5.xyzw
        dp3 r0.w, r2.xyzx, v0.xyzx
        add r0.w, r2.w, r0.w
        mad r1.x, r0.w, v2.z, r1.x
        ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r2.xyzw, r0.z, l(16), t5.xyzw
        dp3 r0.w, r2.xyzx, v0.xyzx
        add r0.w, r2.w, r0.w
        mad r1.y, r0.w, v2.z, r1.y
        ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r2.xyzw, r0.z, l(32), t5.xyzw
        dp3 r0.z, r2.xyzx, v0.xyzx
        add r0.z, r2.w, r0.z
        mad r1.z, r0.z, v2.z, r1.z
        ne r0.z, v2.w, l(0.000000)
        if_nz r0.z
          iadd r0.x, r0.x, v3.w
...
ne r0.z, cb0[10].w, l(0.000000)
movc r0.x, r0.z, r0.y, r0.x
mad r0.xy, r0.xxxx, cb0[10].xyxx, v1.xyxx
sample_l_indexable(texture2d)(float,float,float,float) r0.x, r0.xyxx, t6.xyzw, s1, l(0.000000)
mul r0.x, r0.x, cb0[10].z
mad r0.yzw, v4.xxyz, l(0.000000, 2.001957, 2.001957, 2.001957), l(0.000000, -1.00195694, -1.00195694, -1.00195694)
...
if_nz r2.x
  ...
  mov r2.xyzw, l(0,0,1.000000,0)
endif 
mov r1.w, l(1.000000)
dp4 r3.x, r1.xyzw, r3.xyzw
dp4 r3.y, r1.xyzw, r4.xyzw
dp4 r3.z, r1.xyzw, r2.xyzw
mad r0.xyz, r5.xyzx, r0.xxxx, r3.xyzx
