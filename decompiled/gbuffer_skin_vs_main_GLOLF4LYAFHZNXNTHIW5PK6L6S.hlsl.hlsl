// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:31:33 2021
...
r3.w = gpuSkinBase[]..swiz;
  ...
  if (r1.w != 0) {
    ...
    r7.w = gpuSkinBase[]..swiz;
      ...
      r4.z = v5.x * r2.w;
    // Known bad code for instruction (needs manual fix):
        ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r2.z, r2.z, l(48), t5.xxxx
    r2.z = gpuSkinBase[]..swiz;
      r7.z = v5.x * r2.z;
    ...
    r9.xyzw = gpuSkinPos.Load(r4.xyz).xyzw;
    r10.xyzw = gpuSkinPos.Load(r4.xwz).xyzw;
    r3.xyw = gpuSkinBase.Load(r4.xzz).xyz;
    r8.xyzw = r8.xyzw + -r6.xyzw;
    r6.xyzw = r3.zzzz * r8.xyzw + r6.xyzw;
    r8.xyzw = r10.xyzw + -r9.xyzw;
    r8.xyzw = r3.zzzz * r8.xyzw + r9.xyzw;
    r9.xyz = v0.xyz + -r3.xyw;
    r1.w = dot(r6.xyzw, r6.xyzw);
    r1.w = rsqrt(r1.w);
    r6.xyzw = r6.xyzw * r1.wwww;
    r10.xyz = r6.xyz + r6.xyz;
    r11.xyz = r10.xxx * r6.xzw;
    r1.w = r10.y * r6.w;
    r2.zw = r10.zz * r6.wz;
    r7.w = r6.y * r10.y + r2.w;
    r12.x = 1 + -r7.w;
    r13.x = r6.z * r10.x + -r1.w;
    r12.y = r6.y * r10.x + -r2.z;
    r14.xy = r6.yx * r10.xx + r2.zw;
    r14.z = r6.z * r10.y + -r11.z;
    r6.xyz = r6.zwy * r10.yyy + r11.zyx;
    r12.z = r6.y;
    ...
    r6.xyz = v5.xxx * r9.xyz;
    r7.z = v5.x * r8.w;
    r1.w = cmp(v5.y != 0.000000);
    if (r1.w != 0) {
      r4.x = v6.y;
      r8.xyzw = gpuSkinQuat.Load(r4.xyz).xyzw;
      r9.xyzw = gpuSkinQuat.Load(r4.xwz).xyzw;
      r10.xyzw = gpuSkinPos.Load(r4.xyz).xyzw;
      r11.xyzw = gpuSkinPos.Load(r4.xwz).xyzw;
      r12.xyz = gpuSkinBase.Load(r4.xzz).xyz;
      r9.xyzw = r9.xyzw + -r8.xyzw;
      r8.xyzw = r3.zzzz * r9.xyzw + r8.xyzw;
      r9.xyzw = r11.xyzw + -r10.xyzw;
      r9.xyzw = r3.zzzz * r9.xyzw + r10.xyzw;
      r10.xyz = v0.xyz + -r12.xyz;
      ...
      r8.x = dot(r0.xyz, r14.xyz);
      r8.y = dot(r0.xzy, r16.xzw);
      r8.z = dot(r0.xyz, r15.xyz);
      r10.x = dot(r1.xyz, r14.xyz);
      r10.y = dot(r1.xzy, r16.xzw);
      r10.z = dot(r1.xyz, r15.xyz);
      r11.xyz = r11.xyz + r12.xyz;
      r9.xyz = r11.xyz + r9.xyz;
      r5.xyz = r9.xyz * v5.yyy + r5.xyz;
      r3.xyw = r8.xyz * v5.yyy + r3.xyw;
      r6.xyz = r10.xyz * v5.yyy + r6.xyz;
      r7.z = r9.w * v5.y + r7.z;
      ...
      if (r1.w != 0) {
        ...
        r11.xyz = r11.xyz + r12.xyz;
        r9.xyz = r11.xyz + r9.xyz;
        r5.xyz = r9.xyz * v5.zzz + r5.xyz;
        r3.xyw = r8.xyz * v5.zzz + r3.xyw;
        r6.xyz = r10.xyz * v5.zzz + r6.xyz;
        r7.z = r9.w * v5.z + r7.z;
        ...
        if (r1.w != 0) {
          ...
          r10.x = dot(r1.xyz, r13.xyz);
          r10.y = dot(r1.xzy, r15.xzw);
          r10.z = dot(r1.xyz, r14.xyz);
          r4.xyz = r11.xyz + r4.xyz;
          r4.xyz = r4.xyz + r9.xyz;
          r5.xyz = r4.xyz * v5.www + r5.xyz;
          r3.xyw = r8.xyz * v5.www + r3.xyw;
          r6.xyz = r10.xyz * v5.www + r6.xyz;
          r7.z = r9.w * v5.w + r7.z;
        }
      }
    }
...
r8.w = gpuSkinBase[]..swiz;
  ...
  r2.w = gpuSkinBase[]..swiz;
    ...
    if (r0.x != 0) {
      ...
      r8.xyz = r5.xxx * r4.xzw;
      r5.w = r5.y * r4.w;
      r9.xy = r5.zz * r4.wz;
      r5.z = r4.y * r5.y + r9.y;
      r10.x = 1 + -r5.z;
      r11.x = r4.z * r5.x + -r5.w;
      r10.y = r4.y * r5.x + -r9.x;
      r9.xy = r4.yx * r5.xx + r9.xy;
      r9.z = r4.z * r5.y + -r8.z;
      r4.xyz = r4.zwy * r5.yyy + r8.zyx;
      r10.z = r4.y;
      r5.x = dot(r1.xyw, r10.xyz);
      r9.w = 1 + -r9.y;
      r5.y = dot(r1.xwy, r9.xzw);
      r11.yz = r4.xz * float2(1,-1) + float2(0,1);
      r5.z = dot(r1.xyw, r11.xyz);
      ...
      if (r0.x != 0) {
        ...
        if (r0.x != 0) {
          ...
          if (r0.x != 0) {
            ...
            r9.x = r4.z * r5.x + -r1.w;
            r8.y = r4.y * r5.x + -r5.z;
            r10.xy = r4.yx * r5.xx + r5.zw;
            r10.z = r4.z * r5.y + -r6.z;
            r4.xyz = r4.zwy * r5.yyy + r6.zyx;
            r8.z = r4.y;
            r5.x = dot(r1.xyz, r8.xyz);
            r10.w = 1 + -r10.y;
            r5.y = dot(r1.xzy, r10.xzw);
