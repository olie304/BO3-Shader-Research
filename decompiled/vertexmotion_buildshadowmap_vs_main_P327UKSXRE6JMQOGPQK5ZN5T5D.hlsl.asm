...
mul r1.x, cb1[69].w, cb2[38].y
mad r1.y, r1.x, l(0.900000), r0.y
mul r1.xy, r1.xyxx, l(0.900000, 0.700000, 0.000000, 0.000000)
sincos r1.y, null, r1.y
mad r1.z, cb1[69].w, cb2[38].y, l(0.500000)
mad r1.w, r1.z, l(0.700000), r0.y
mul r1.zw, r1.zzzw, l(0.000000, 0.000000, 0.700000, 0.700000)
sincos null, r1.w, r1.w
mul r2.x, r1.w, r1.y
mul r2.y, v0.z, l(0.010000)
mul r2.x, r2.y, r2.x
mul r2.yz, v1.xxyx, cb0[11].zzwz
mul r3.z, r2.z, r2.x
mul r2.xw, cb2[38].zzzw, cb2[38].yyyy
mul r1.yw, r1.yyyw, r2.xxxw
mul r3.xy, r2.zzzz, r1.ywyy
mul r2.xzw, r3.xxyz, l(0.110000, 0.000000, 0.130000, 0.090000)
...
mad r0.x, r0.x, l(0.100000), r1.z
mul r0.x, r0.x, l(0.070000)
sincos null, r0.x, r0.x
mad r1.x, r1.y, l(0.100000), r1.x
