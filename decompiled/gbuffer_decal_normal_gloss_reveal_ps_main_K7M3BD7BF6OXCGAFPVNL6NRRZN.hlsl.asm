...
dcl_output o1.xyzw
dcl_temps 4
mad_sat r0.x, v1.x, l(0.998000), l(0.001000)
log r0.y, r0.x
...
add r0.y, -r0.x, r0.y
mul r1.xyzw, v1.yzyz, cb0[13].xyxy
movc r0.zw, cb0[12].wwww, r1.zzzw, v1.yyyz
...
add r0.yzw, cb0[12].xxyz, l(0.000000, -1.000000, -1.000000, -1.000000)
...
mad r1.z, r0.z, l(0.49755621), r0.w
