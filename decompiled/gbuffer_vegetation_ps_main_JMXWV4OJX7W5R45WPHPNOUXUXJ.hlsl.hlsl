// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:31:38 2021
...
Texture2D<float4> underFfuseMap : register(t12);
  ...
  out float2 o3 : SV_TARGET3)
{
  ...
  if (v6.x == 0) {
    ...
    r0.w = r1.w * r0.w;
    r3.xyzw = underFfuseMap.Sample(colorSampler_s, w1.xy).xyzw;
    r1.w = cmp(r3.w < 0.5);
    if (r1.w != 0) discard;
  ...
  r0.x = specColorMapThick.Sample(colorSampler_s, w1.xy).x;
  r0.x = 1 + -r0.x;
  r5.xyz = treeCanopyScatterColor.xyz * r3.xyz;
  r0.y = r5.z * r0.x;
  r2.zw = v5.xy / v5.ww;
  r5.zw = float2(0.5,0.5) * renderTargetSize.xy;
  r6.x = r5.z * r2.z;
  r6.y = -r5.w * r2.w;
  r2.zw = renderTargetSize.xy * float2(0.5,0.5) + r6.xy;
  r2.zw = v0.xy + -r2.zw;
  r0.z = r2.x + r2.y;
  r0.z = r1.w * r1.x + r0.z;
  r0.z = 0.5 * r0.z;
  ...
  r0.z = max(r1.w, r0.z);
  r1.x = cmp(r0.z == r1.x);
  r6.yzw = float3(1,-1,-1) * r4.yzw;
  r1.w = 2 + r0.z;
  r6.x = 1;
  r4.x = 0;
  r4.xyzw = r1.xxxx ? r6.xyzw : r4.xyzw;
  r0.z = r1.x ? r1.w : r0.z;
  r1.x = cmp(r0.z == r1.y);
  r6.yzw = float3(-1,1,-1) * r4.yzw;
  r1.y = 2 + r0.z;
