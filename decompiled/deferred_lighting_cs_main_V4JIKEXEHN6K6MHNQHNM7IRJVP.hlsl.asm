...
mul r19.w, r2.w, r2.z
dp4 r2.z, r17.xyzw, r19.xyzw
add r18.xyzw, -r10.yyyy, r18.xyzw
min r2.w, |r18.w|, |r18.z|
min r2.w, r2.w, |r18.y|
min r2.w, r2.w, |r18.x|
max r3.y, |r18.w|, |r18.z|
max r3.y, r3.y, |r18.y|
max r3.y, r3.y, |r18.x|
eq r14.yzw, r2.wwww, |r18.yyzw|
movc r2.w, r14.y, r17.y, r17.x
movc r2.w, r14.z, r17.z, r2.w
movc r2.w, r14.w, r17.w, r2.w
...
if_z r4.w
  ...
  if_nz r7.w
    ...
    loop 
      ...
      breakc_nz r9.w
      ftou r9.w, r7.w
      add r14.yz, r10.yyzy, -cb2[r9.w + 20].xxyx
  ...
  if_nz r9.w
    ...
    rcp r17.xz, r14.yyyy
    mov r17.y, -r17.z
    mad r14.yzw, r10.yyzy, r17.xxyz, r14.zzwz
    add r15.yzw, l(0.000000, -0.00781250, -0.00781250, -0.00781250), cb2[27].xxyx
    max r14.yzw, r14.yyzw, l(0.000000, 0.000000, 0.000000, 0.000000)
    min r14.yzw, r15.yyzw, r14.yyzw
    mul r15.yz, r14.wwzw, cb2[32].xxxx
    round_ni r15.yz, r15.yyzy
    mul r13.w, r15.z, cb2[27].x
    mad r13.w, r13.w, cb2[32].x, r15.y
    ftou r13.w, r13.w
    ...
    if_z r15.z
      ...
      iadd r17.x, r13.w, r15.z
      ushr r13.w, r15.y, l(25)
      utof r13.w, r13.w
      ...
      ushr r15.yz, r14.wwzw, l(0, 6, 6, 0)
      ...
      movc r15.z, r15.z, r17.z, r17.w
      ushr r17.w, r15.z, l(13)
      movc r15.y, r15.y, r17.w, r15.z
      and r15.y, r15.y, l(8191)
      iadd r18.x, r15.y, r17.x
      ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r18.z, r18.x, l(0), t23.xxxx
      mov r17.y, l(0)
      mov r18.y, l(1)
      movc r18.xyz, r13.wwww, r17.xyzx, r18.xyzx
      movc r19.yz, r13.wwww, l(0,6,1,0), l(0,5,2,0)
      ushr r15.yz, r14.wwzw, r19.yyyy
      and r15.yz, r15.yyzy, l(0, 1, 1, 0)
      ...
      movc r15.z, r15.z, r18.z, r18.w
      ushr r18.w, r15.z, l(13)
      movc r15.y, r15.y, r18.w, r15.z
      and r15.y, r15.y, l(8191)
      iadd r19.x, r15.y, r18.x
      ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r19.w, r19.x, l(0), t23.xxxx
      movc r18.xyz, r17.wwww, r18.xyzx, r19.xzwx
      movc r17.xyz, r13.wwww, r17.xyzx, r18.xyzx
      and r13.w, r17.z, l(0xc0000000)
      if_z r13.w
        iadd r13.w, -r17.y, l(6)
        ushr r15.yz, r14.wwzw, r13.wwww
        or r13.w, r17.z, l(0x40000000)
        bfi r15.z, l(1), l(1), r15.z, l(0)
        bfi r15.y, l(1), l(0), r15.y, r15.z
        imul null, r15.y, r15.y, l(10)
        ushr r13.w, r13.w, r15.y
        ...
        bfi r15.y, l(1), l(0), r15.y, r15.z
        imul null, r15.y, r15.y, l(10)
        ushr r15.y, r17.y, r15.y
        and r15.y, r15.y, l(1023)
        iadd r19.x, r15.y, r18.x
        ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r19.z, r19.x, l(0), t23.xxxx
        mov r19.y, r18.z
        movc r19.xyz, r13.wwww, r18.xywx, r19.xyzx
        iadd r15.y, -r19.y, l(6)
        ushr r15.yz, r14.wwzw, r15.yyyy
        and r17.y, r19.z, l(0xc0000000)
        or r17.w, r19.z, l(0x40000000)
        bfi r15.z, l(1), l(1), r15.z, l(0)
        bfi r15.y, l(1), l(0), r15.y, r15.z
        imul null, r15.y, r15.y, l(10)
        ushr r15.y, r17.w, r15.y
        and r15.y, r15.y, l(1023)
        iadd r20.x, r15.y, r19.x
        ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r20.y, r20.x, l(0), t23.xxxx
        movc r15.yz, r17.yyyy, r19.xxzx, r20.xxyx
        movc r17.xz, r13.wwww, r18.xxwx, r15.yyzy
      endif 
      and r13.w, r17.z, l(0xc0000000)
      if_z r13.w
        ubfe r15.y, l(14), l(15), r17.z
        utof r15.y, r15.y
        mul r15.y, r15.y, cb2[27].w
        and r17.yw, r17.zzzz, l(0, 0x00007fff, 0, 0x20000000)
        utof r15.z, r17.y
        mul r15.z, r15.z, cb2[27].w
        mul r15.yz, r15.yyzy, l(0.000000, 0.00006104, 0.00003052, 0.000000)
        and r17.y, r14.z, l(3)
        ...
        utof r14.z, r14.z
        mul r14.z, r15.z, r14.z
        mad r14.z, r14.z, l(0.00001526), r15.y
        movc r15.w, r17.w, r14.y, r14.z
      else 
        and r14.y, r17.z, l(0x80000000)
        iadd r14.z, r17.x, l(1)
        ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r14.z, r14.z, l(0), t23.xxxx
        movc r14.y, r14.y, r14.z, l(0)
        ishl r14.z, r17.z, l(2)
        ushr r14.w, r14.y, l(16)
        and r14.y, r14.y, l(0x0000ffff)
        f16tof32 r14.yw, r14.yyyw
        mad r14.z, r10.y, r14.w, r14.z
        mad r14.y, r10.z, r14.y, r14.z
        movc r15.w, r13.w, r14.y, r15.w
      endif 
    endif 
  ...
  if_z r9.w
    if_z cb2[58].y
      ...
      mad r17.xy, r14.yzyy, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
      itof r9.w, cb2[26].y
      add r17.z, r7.w, r9.w
    ...
    if_nz cb2[58].y
      ...
      loop 
        ...
        movc r15.yz, r14.wwww, r10.yyzy, r14.yyzy
        movc r15.w, r14.w, cb2[r7.w + 20].w, cb2[r9.w + 20].w
        movc r14.w, r14.w, r7.w, r9.w
        dp2 r18.x, icb[r13.w + 0].yxyy, r17.xyxx
        dp2 r18.y, icb[r13.w + 0].yxyy, r17.yzyy
        mad r18.xy, r18.xyxx, r15.wwww, r15.yzyy
...
loop 
  ...
  bfi r15.y, r10.z, l(0), l(0), r14.z
  movc r14.z, r14.w, r15.y, r14.z
  ieq r14.w, r10.w, r14.y
...
if_nz r0.z
  ...
  mad r14.yzw, r15.yyzw, r0.yyyy, r14.yyzw
endif 
...
if_nz r2.y
  ...
  if_nz r2.y
    ...
    mul r0.w, r0.w, r2.w
    mul r0.w, r0.w, r2.y
    mad r10.yzw, r0.wwww, r14.yyzw, r15.yyzw
    mad r2.yzw, r2.zzzz, r14.yyzw, r18.zzxy
...
ret 
// Approximately 1910 instruction slots used
