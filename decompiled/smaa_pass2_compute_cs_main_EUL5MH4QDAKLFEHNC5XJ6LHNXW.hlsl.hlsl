...
r0.z = bilinearSampler[]..swiz;
  ...
  r3.yw = renderTargetSize.zw * r0.xw;
  r1.x = r1.x * 1 + 0.5;
  r1.x = (int)r1.x;
  r1.x = (int)r1.x & 15;
  r1.yz = edgesTex.SampleLevel(bilinearSampler_s, r3.yw, 0).xy;
  r4.xyzw = renderTargetSize.zwzw * float4(-1,0,1,0) + r3.ywyw;
  ...
  if (r5.y != 0) {
    ...
    if (r4.z != 0) {
      ...
      r7.xyzw = r7.xyzw * renderTargetSize.zwzw + r3.ywyw;
    ...
    if (r4.z != 0) {
      ...
      if (r4.x == 0) {
        r4.x = 1 + r6.y;
        r4.xw = r4.xx * renderTargetSize.zw + r3.yw;
  ...
  if (r1.x != 0) {
    ...
    while (true) {
      r7.x = cmp(r6.z >= r6.w);
      if (r7.x != 0) break;
      r4.zw = edgesTex.SampleLevel(bilinearSampler_s, r5.zw, 0).xy;
      r5.zw = renderTargetSize.zw * float2(2,0) + r5.zw;
      r7.x = -r4.z * 32 + r4.w;
      r7.x = cmp(0.828125 < r7.x);
      r6.w = r7.x ? r6.w : r6.z;
      r6.z = 2 + r6.z;
    }
    r1.xw = r4.zw * float2(32,32) + float2(33,0);
    r1.xw = round(r1.xw);
    r7.xy = (int2)r1.xw;
    r7.zw = float2(0,0);
    r1.xw = smaaTex.Load(r7.xyz).xy;
    r1.w = 3 * r1.w;
    r1.x = r1.x * 2.00787401 + r6.z;
    r4.x = round(r1.x);
    r6.y = round(r1.w);
    r1.xw = abs(r4.yx);
    r1.xw = (uint2)r1.xw >> int2(1,1);
    r1.xw = (int2)r1.xw + int2(532487680,532487680);
    r1.xw = min(float2(19,19), r1.xw);
    r1.xw = r6.xy * float2(20,20) + r1.xw;
    r1.xw = r1.xw * float2(0.0125000002,0.00510204071) + float2(0.00625000009,0.18622449);
    r1.yz = smaaTex.SampleLevel(bilinearSampler_s, r1.xw, 0).xy;
    r1.x = max(r1.y, r1.z);
    r1.x = cmp(0 < r1.x);
    if (r1.x != 0) {
      r3.z = -renderTargetSize.z * r4.y + r3.y;
      r3.x = renderTargetSize.z * r4.x + r3.y;
      r1.xw = cmp(r4.xy >= r4.yx);
      r4.zw = r1.xw ? float2(1,1) : 0;
      r4.z = cmp(r4.w == r4.z);
      r1.xw = (int2)r1.xw | (int2)r4.zz;
      r1.xw = r1.xw ? float2(1,1) : 0;
      r4.zw = renderTargetSize.zw * float2(0.25,0) + r3.zw;
      ...
      r6.xy = round(r4.wz);
      r4.zw = r6.xy * r1.xx;
      r5.zw = renderTargetSize.zw + r3.xw;
      r5.zw = edgesTex.SampleLevel(bilinearSampler_s, r5.zw, 0).xy;
      r6.zw = r5.wz * r1.ww;
      r7.xyzw = renderTargetSize.zwzw * float4(0,-2,0,0.25) + r3.zwxw;
      r7.y = edgesTex.SampleLevel(bilinearSampler_s, r7.xy, 0).x;
      r8.xy = -renderTargetSize.zw + r3.zw;
      r7.x = edgesTex.SampleLevel(bilinearSampler_s, r8.xy, 0).y;
      r8.xy = r7.xy * r1.xx;
      r7.zw = renderTargetSize.zw * float2(1,-2) + r7.zw;
      r7.zw = edgesTex.SampleLevel(bilinearSampler_s, r7.zw, 0).xy;
      r8.z = r7.w * 5 + -3.75;
      r7.w = abs(r8.z) * r7.w;
      r8.zw = round(r7.wz);
      r7.zw = r8.zw * r1.ww;
      r4.x = r4.y + r4.x;
      r4.x = cmp(0 < r4.x);
      r9.xy = saturate(r1.xx * r6.xy + r6.zw);
      r9.zw = saturate(r1.xx * r7.xy + r7.zw);
      r4.y = r4.w + r4.z;
      r4.y = r1.w * r5.z + r4.y;
      r4.y = saturate(r1.w * r5.w + r4.y);
      r4.z = r8.y + r8.x;
      r4.z = r1.w * r8.w + r4.z;
      r4.z = saturate(r1.w * r8.z + r4.z);
      r4.w = -r1.x * r6.y + 2;
      r4.w = saturate(-r1.w * r5.z + r4.w);
      r6.x = r4.y * r4.w;
      r1.x = -r1.x * r7.y + 2;
      r1.x = saturate(-r1.w * r8.w + r1.x);
      r6.y = r4.z * r1.x;
      r1.xw = r4.xx ? r9.xz : r6.xy;
      r4.yz = float2(1,1) + -r9.yw;
      r1.xw = r4.yz * r1.xw;
      r1.xw = r4.xx ? r1.xw : r6.xy;
      r1.yz = r1.yz * r1.xw;
    }
    r5.y = -1;
  }
  if (r5.x != 0) {
    r1.xw = float2(-0.125,-0.25) * renderTargetSize.zw;
    r1.xw = r0.xw * renderTargetSize.zw + r1.xw;
    r4.xy = float2(0,1);
    r4.zw = r1.xw;
    r5.zw = float2(-3,61);
    while (true) {
      r6.x = cmp(r5.z >= r5.w);
      if (r6.x != 0) break;
      r4.xy = edgesTex.SampleLevel(bilinearSampler_s, r4.zw, 0).yx;
    ...
    r4.y = round(r1.x);
    r6.x = round(r1.w);
    r1.xw = float2(-0.125,1.75) * renderTargetSize.zw;
    ...
    while (true) {
      r6.z = cmp(r5.z >= r5.w);
      if (r6.z != 0) break;
      r1.xw = edgesTex.SampleLevel(bilinearSampler_s, r4.zw, 0).yx;
      r4.zw = renderTargetSize.zw * float2(0,2) + r4.zw;
      r6.z = -r1.x * 32 + r1.w;
    ...
    r0.x = cmp(0 < r0.x);
    if (r0.x != 0) {
      r3.x = -renderTargetSize.w * r4.y + r3.w;
      r3.z = renderTargetSize.w * r4.x + r3.w;
      r0.xw = cmp(r4.xy >= r4.yx);
      r1.xw = r0.xw ? float2(1,1) : 0;
      r1.x = cmp(r1.w == r1.x);
      r0.xw = (int2)r0.xw | (int2)r1.xx;
      r0.xw = r0.xw ? float2(1,1) : 0;
      r1.xw = renderTargetSize.zw * float2(0,0.25) + r3.yx;
      ...
      r6.xy = round(r1.xw);
      r1.xw = r6.xy * r0.xx;
      r4.zw = renderTargetSize.zw + r3.yz;
      r4.zw = edgesTex.SampleLevel(bilinearSampler_s, r4.zw, 0).xy;
      r5.zw = r4.zw * r0.ww;
      r7.xyzw = renderTargetSize.zwzw * float4(-2,0,0.25,0) + r3.yxyz;
      r3.w = edgesTex.SampleLevel(bilinearSampler_s, r7.xy, 0).y;
      r3.xy = -renderTargetSize.zw + r3.yx;
      r3.z = edgesTex.SampleLevel(bilinearSampler_s, r3.xy, 0).x;
      r3.xy = r3.zw * r0.xx;
      r6.zw = renderTargetSize.zw * float2(-2,1) + r7.zw;
      r6.zw = edgesTex.SampleLevel(bilinearSampler_s, r6.zw, 0).xy;
      r7.x = r6.z * 5 + -3.75;
      r6.z = abs(r7.x) * r6.z;
      r7.zw = round(r6.zw);
      ...
      r8.zw = saturate(r0.xx * r3.zw + r6.zw);
      r1.x = r1.w + r1.x;
      r1.x = r0.w * r4.w + r1.x;
      r1.x = saturate(r0.w * r4.z + r1.x);
      r1.w = r3.y + r3.x;
      r1.w = r0.w * r7.w + r1.w;
      r1.w = saturate(r0.w * r7.z + r1.w);
      r3.x = -r0.x * r6.y + 2;
      r3.x = saturate(-r0.w * r4.w + r3.x);
      r3.x = r3.x * r1.x;
      r0.x = -r0.x * r3.w + 2;
  ...
  // No code for instruction (needs manual fix):
    ...
    r2.xyzw = (int4)r2.xyzw + (int4)r5.xyyy;
