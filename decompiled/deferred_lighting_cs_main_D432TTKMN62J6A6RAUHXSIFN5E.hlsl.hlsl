...
r0.y = samplerLinear[]..swiz;
  ...
  while (true) {
    ...
    if (r12.w != 0) break;
    r12.w = r9.w ? r0.x : r9.x;
    r13.z = cmp((uint)r12.w >= (uint)r8.w);
    r13.w = cmp((uint)r12.w < numRefProbes);
    r13.z = r13.w ? r13.z : 0;
    if (r13.z != 0) {
      r12.w = (int)r12.w * 14;
      r15.yzw = -refProbeConstantsCB[r12.w].data[0].xyz + r10.xyz;
      r13.z = 0x0000ffff & (int)refProbeConstantsCB[r12.w].data[7].z;
      if (6 == 0) r13.w = 0; else if (6+25 < 32) {       r13.w = (uint)refProbeConstantsCB[r12.w].data[7].z << (32-(6 + 25)); r13.w = (uint)r13.w >> (32-6);      } else r13.w = (uint)refProbeConstantsCB[r12.w].data[7].z >> 25;
      r14.w = (int)r13.z * 6;
      r17.w = dot(refProbeAttenuationConstantsCB[r14.w].data[0].xyz, r15.yzw);
      r17.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[0].w + r17.w);
      r18.w = dot(refProbeAttenuationConstantsCB[r14.w].data[1].xyz, r15.yzw);
      r18.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[1].w + r18.w);
      r17.w = r18.w * r17.w;
      r18.w = dot(refProbeAttenuationConstantsCB[r14.w].data[2].xyz, r15.yzw);
      r18.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[2].w + r18.w);
      r17.w = r18.w * r17.w;
      r18.w = dot(refProbeAttenuationConstantsCB[r14.w].data[3].xyz, r15.yzw);
      r18.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[3].w + r18.w);
      r17.w = r18.w * r17.w;
      r18.w = dot(refProbeAttenuationConstantsCB[r14.w].data[4].xyz, r15.yzw);
      r18.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[4].w + r18.w);
      r17.w = r18.w * r17.w;
      r18.w = dot(refProbeAttenuationConstantsCB[r14.w].data[5].xyz, r15.yzw);
      r14.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[5].w + r18.w);
      r17.x = r17.w * r14.w;
      r14.w = 1 & (int)refProbeConstantsCB[r12.w].data[6].x;
      r17.xw = r14.ww ? r17.xy : r17.zx;
      ...
      while (true) {
        ...
        r19.z = -r19.w * r19.z + 1;
        r19.z = r24.y * r19.z;
        r19.y = r24.z ? r19.z : r24.w;
        r24.xy = r21.ww ? r24.xy : r19.xy;
        r18.w = (int)r18.w + 1;
        r14.w = r20.w;
      }
      r24.y = saturate(r24.y);
      r13.z = refProbeConstantsCB[r12.w].data[6].y * r24.y;
      r13.w = cmp(0 < r13.z);
      if (r13.w != 0) {
        r23.w = r24.y * refProbeConstantsCB[r12.w].data[6].y + r23.w;
        r13.z = refProbeConstantsCB[r12.w].data[7].y * r13.z;
        ...
        r17.x = dot(r15.yzw, r25.xyz);
        r17.x = -refProbeConstantsCB[r12.w].data[9].z + r17.x;
        r17.w = cmp(r17.x >= 0);
        ...
        r14.w = dot(r16.xyz, r25.xyz);
        r17.x = dot(r15.yzw, r25.xyz);
        r17.x = -refProbeConstantsCB[r12.w].data[10].z + r17.x;
        r17.w = cmp(r17.x >= 0);
        r17.x = max(abs(r17.x), r6.w);
        r17.x = r17.w ? r17.x : -r17.x;
        r14.w = max(1.00000001e-07, -r14.w);
        ...
        r14.w = dot(r16.xyz, r25.xyz);
        r17.x = dot(r15.yzw, r25.xyz);
        r17.x = -refProbeConstantsCB[r12.w].data[11].z + r17.x;
        r17.w = cmp(r17.x >= 0);
        r17.x = max(abs(r17.x), r6.w);
        r17.x = r17.w ? r17.x : -r17.x;
        r14.w = max(1.00000001e-07, -r14.w);
        ...
        r14.w = dot(r16.xyz, r25.xyz);
        r17.x = dot(r15.yzw, r25.xyz);
        r17.x = -refProbeConstantsCB[r12.w].data[12].z + r17.x;
        r17.w = cmp(r17.x >= 0);
        r17.x = max(abs(r17.x), r6.w);
        r17.x = r17.w ? r17.x : -r17.x;
        r14.w = max(1.00000001e-07, -r14.w);
        ...
        r14.w = dot(r16.xyz, r25.xyz);
        r17.x = dot(r15.yzw, r25.xyz);
        r17.x = -refProbeConstantsCB[r12.w].data[13].z + r17.x;
        r17.w = cmp(r17.x >= 0);
        r17.x = max(abs(r17.x), r6.w);
        r17.x = r17.w ? r17.x : -r17.x;
        r14.w = max(1.00000001e-07, -r14.w);
        r14.w = r17.x / r14.w;
        r13.w = min(abs(r14.w), r13.w);
        r25.x = refProbeConstantsCB[r12.w].data[3].w + r15.y;
        r25.yz = refProbeConstantsCB[r12.w].data[4].xy + r15.zw;
        r19.yzw = r16.xyz * r13.www + r25.xyz;
        ...
        r25.x = refProbeConstantsCB[r12.w].data[0].w;
        r25.y = refProbeConstantsCB[r12.w].data[1].z;
        r25.z = refProbeConstantsCB[r12.w].data[2].y;
        r26.x = dot(r19.yzw, r25.xyz);
        r27.xy = refProbeConstantsCB[r12.w].data[1].xw;
        r27.z = refProbeConstantsCB[r12.w].data[2].z;
        r26.y = dot(r19.yzw, r27.xyz);
        r28.x = refProbeConstantsCB[r12.w].data[1].y;
        r28.yz = refProbeConstantsCB[r12.w].data[2].xw;
        ...
        r26.w = (uint)r14.w;
        r19.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r26.xyzw, r13.w).xyz;
        r29.x = dot(r15.yzw, r25.xyz);
        r29.y = dot(r15.yzw, r27.xyz);
        r29.z = dot(r15.yzw, r28.xyz);
        r15.yzw = saturate(r29.xyz * refProbeConstantsCB[r12.w].data[3].xyz + float3(0.5,0.5,0.5));
        r29.xy = refProbeConstantsCB[r12.w].data[4].zw * r15.yz;
        r29.z = refProbeConstantsCB[r12.w].data[5].x * r15.w;
        r15.yzw = refProbeConstantsCB[r12.w].data[5].yzw + r29.xyz;
  ...
  if (r9.w != 0) {
    ...
    while (true) {
      ...
      if (r13.z != 0) {
        r12.w = (int)r12.w * 14;
        r25.xyz = -refProbeConstantsCB[r12.w].data[0].xyz + r10.xyz;
        r13.z = 0x0000ffff & (int)refProbeConstantsCB[r12.w].data[7].z;
        if (6 == 0) r13.w = 0; else if (6+25 < 32) {         r13.w = (uint)refProbeConstantsCB[r12.w].data[7].z << (32-(6 + 25)); r13.w = (uint)r13.w >> (32-6);        } else r13.w = (uint)refProbeConstantsCB[r12.w].data[7].z >> 25;
        r14.w = (int)r13.z * 6;
        r17.w = dot(refProbeAttenuationConstantsCB[r14.w].data[0].xyz, r25.xyz);
        r17.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[0].w + r17.w);
        r18.w = dot(refProbeAttenuationConstantsCB[r14.w].data[1].xyz, r25.xyz);
        r18.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[1].w + r18.w);
        r17.w = r18.w * r17.w;
        r18.w = dot(refProbeAttenuationConstantsCB[r14.w].data[2].xyz, r25.xyz);
        r18.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[2].w + r18.w);
        r17.w = r18.w * r17.w;
        r18.w = dot(refProbeAttenuationConstantsCB[r14.w].data[3].xyz, r25.xyz);
        r18.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[3].w + r18.w);
        r17.w = r18.w * r17.w;
        r18.w = dot(refProbeAttenuationConstantsCB[r14.w].data[4].xyz, r25.xyz);
        r18.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[4].w + r18.w);
        r17.w = r18.w * r17.w;
        r18.w = dot(refProbeAttenuationConstantsCB[r14.w].data[5].xyz, r25.xyz);
        r14.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[5].w + r18.w);
        r17.x = r17.w * r14.w;
        r14.w = 1 & (int)refProbeConstantsCB[r12.w].data[6].x;
        r17.xw = r14.ww ? r17.xy : r17.zx;
        ...
        while (true) {
          ...
          r19.z = -r19.w * r19.z + 1;
          r19.z = r26.y * r19.z;
          r19.y = r25.w ? r19.z : r26.z;
          r26.xy = r21.ww ? r26.xy : r19.xy;
          r18.w = (int)r18.w + 1;
          r14.w = r20.w;
        }
        r13.z = saturate(r26.y + -r23.w);
        r13.w = refProbeConstantsCB[r12.w].data[6].y * r13.z;
        r14.w = cmp(0 < r13.w);
        if (r14.w != 0) {
          r24.w = r13.z * refProbeConstantsCB[r12.w].data[6].y + r24.w;
          r13.z = refProbeConstantsCB[r12.w].data[7].y * r13.w;
          ...
          r14.w = r17.x / r14.w;
          r13.w = min(abs(r14.w), r13.w);
          r27.x = refProbeConstantsCB[r12.w].data[3].w + r25.x;
          r27.yz = refProbeConstantsCB[r12.w].data[4].xy + r25.yz;
          r19.yzw = r16.xyz * r13.www + r27.xyz;
          r14.w = dot(r19.yzw, r19.yzw);
          r14.w = sqrt(r14.w);
          r13.w = r13.w / r14.w;
          r13.w = r13.w + r13.w;
          ...
          if (9 == 0) r14.w = 0; else if (9+16 < 32) {           r14.w = (uint)refProbeConstantsCB[r12.w].data[7].z << (32-(9 + 16)); r14.w = (uint)r14.w >> (32-9);          } else r14.w = (uint)refProbeConstantsCB[r12.w].data[7].z >> 16;
          r28.w = (uint)r14.w;
          r19.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r28.xyzw, r13.w).xyz;
          r31.x = dot(r25.xyz, r27.xyz);
          r31.y = dot(r25.xyz, r29.xyz);
          r31.z = dot(r25.xyz, r30.xyz);
          r25.xyz = saturate(r31.xyz * refProbeConstantsCB[r12.w].data[3].xyz + float3(0.5,0.5,0.5));
          r31.xy = refProbeConstantsCB[r12.w].data[4].zw * r25.xy;
          r31.z = refProbeConstantsCB[r12.w].data[5].x * r25.z;
          r25.xyz = refProbeConstantsCB[r12.w].data[5].yzw + r31.xyz;
          ...
          r13.z = dot(r19.yzw, float3(0.212599993,0.715200007,0.0722000003));
          r12.w = r7.w * r12.w + r13.z;
          r12.w = r13.w / r12.w;
          r24.xyz = r19.yzw * r12.www + r24.xyz;
        }
      }
      r9.w = (int)r9.w + 1;
    }
  ...
  if (r2.w != 0) {
    ...
    r16.w = 0;
    r18.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r16.xyzw, r5.w).xyz;
