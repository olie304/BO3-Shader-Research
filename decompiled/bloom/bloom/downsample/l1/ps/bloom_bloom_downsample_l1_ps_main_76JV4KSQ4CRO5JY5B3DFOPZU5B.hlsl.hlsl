  ...
  out float4 o1 : SV_TARGET1)
{
  ...
  r0.xyz = r0.xyz * float3(0.125,0.125,0.125) + r2.xyz;
  r2.xyz = codeTexture0.Sample(biLinearClamp_s, v0.xy, int2(0, 0)).xyz;
  ...
  r1.xyz = r4.xyz + r1.xyz;
  r1.xyz = r1.xyz * float3(0.25,0.25,0.25) + -r3.xyz;
  o1.xyz = r1.xyz * float3(0.5,0.5,0.5) + r3.xyz;
  r1.xyz = postFxBloom00.xxx * r0.xyz;
  r1.w = dot(r0.xyz, postFxBloom00.yzw);
