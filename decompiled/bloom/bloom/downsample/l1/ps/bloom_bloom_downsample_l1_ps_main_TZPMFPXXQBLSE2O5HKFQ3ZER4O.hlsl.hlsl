...
Texture2D<uint2> codeTexture2 : register(t2);
  ...
  out float3 o2 : SV_TARGET2)
{
  ...
  r3.xyz = codeTexture0.Sample(biLinearClamp_s, v0.xy).xyz;
  r2.w = dot(r3.xyz, float3(0.212599993,0.715200007,0.0722000003));
  r2.w = 1 + r2.w;
  r2.w = 1 / r2.w;
  r2.xyz = r3.xyz * r2.www + r2.xyz;
  r2.xyz = r0.xyz * r0.www + r2.xyz;
  r4.xyz = codeTexture0.Sample(biLinearClamp_s, v0.xy, int2(0, 0)).xyz;
  r3.w = dot(r4.xyz, float3(0.212599993,0.715200007,0.0722000003));
  r3.w = 1 + r3.w;
  r3.w = 1 / r3.w;
  ...
  r6.xyz = r4.xyz * r3.www + r5.xyz;
  r0.w = r3.w + r2.w;
  r7.xyz = codeTexture0.Sample(biLinearClamp_s, v0.xy, int2(0, 0)).xyz;
  r3.w = dot(r7.xyz, float3(0.212599993,0.715200007,0.0722000003));
  r3.w = 1 + r3.w;
  r3.w = 1 / r3.w;
  r6.xyz = r7.xyz * r3.www + r6.xyz;
  r0.w = r3.w + r0.w;
  r8.xyz = codeTexture0.Sample(biLinearClamp_s, v0.xy, int2(0, 0)).xyz;
  r3.w = dot(r8.xyz, float3(0.212599993,0.715200007,0.0722000003));
  r3.w = 1 + r3.w;
  r3.w = 1 / r3.w;
  r6.xyz = r8.xyz * r3.www + r6.xyz;
  r0.w = r3.w + r0.w;
  r6.xyz = r6.xyz / r0.www;
  r6.xyz = float3(0.125,0.125,0.125) * r6.xyz;
  r2.xyz = r2.xyz * float3(0.125,0.125,0.125) + r6.xyz;
  r6.xyz = r8.xyz * r3.www + r5.xyz;
  r0.w = r3.w + r2.w;
  r8.xyz = r8.xyz + r1.xyz;
  r9.xyz = codeTexture0.Sample(biLinearClamp_s, v0.xy, int2(0, 0)).xyz;
  r3.w = dot(r9.xyz, float3(0.212599993,0.715200007,0.0722000003));
  r3.w = 1 + r3.w;
  r3.w = 1 / r3.w;
  r6.xyz = r9.xyz * r3.www + r6.xyz;
  r0.w = r3.w + r0.w;
  r10.xyz = codeTexture0.Sample(biLinearClamp_s, v0.xy, int2(0, 0)).xyz;
  r3.w = dot(r10.xyz, float3(0.212599993,0.715200007,0.0722000003));
  r3.w = 1 + r3.w;
  r3.w = 1 / r3.w;
  r6.xyz = r10.xyz * r3.www + r6.xyz;
  r0.w = r3.w + r0.w;
  r6.xyz = r6.xyz / r0.www;
  r2.xyz = r6.xyz * float3(0.125,0.125,0.125) + r2.xyz;
  r5.xyz = r10.xyz * r3.www + r5.xyz;
  r0.w = r3.w + r2.w;
  ...
  r5.xyz = codeTexture0.Sample(biLinearClamp_s, v0.xy, int2(0, 0)).xyz;
  r1.w = dot(r5.xyz, float3(0.212599993,0.715200007,0.0722000003));
  r1.w = 1 + r1.w;
  r1.w = 1 / r1.w;
  ...
  r2.xyz = r5.xyz + r2.xyz;
  r4.xyz = postFxBloom00.xxx * r1.xyz;
  r4.w = dot(r1.xyz, postFxBloom00.yzw);
  r1.xyzw = float4(5.55555534,5.55555534,5.55555534,5.55555534) * r4.xyzw;
  r1.xyzw = log2(r1.xyzw);
  r4.xyzw = cmp(r1.xyzw < float4(0,0,0,0));
  r5.xyzw = postFxBloom01.xxxy * r1.xyzw;
  r1.xyzw = postFxBloom01.zzzw * r1.xyzw;
  r1.xyzw = r4.xyzw ? r5.xyzw : r1.xyzw;
  r1.xyzw = exp2(r1.xyzw);
  o0.xyzw = float4(0.180000007,0.180000007,0.180000007,0.180000007) * r1.xyzw;
  r1.xyz = r2.xyz * float3(0.25,0.25,0.25) + -r3.xyz;
  r2.xyz = float3(0.100000001,0.100000001,0.100000001) * r2.xyz;
  r2.xyz = r3.xyz * float3(0.200000003,0.200000003,0.200000003) + r2.xyz;
  o1.xyz = r1.xyz * float3(0.5,0.5,0.5) + r3.xyz;
  o2.xyz = r0.xyz * float3(0.0500000007,0.0500000007,0.0500000007) + r2.xyz;
  r0.xy = trunc(v1.xy);
  r0.xy = float2(4,4) * r0.xy;
  r0.xy = (int2)r0.xy;
  r0.zw = float2(0,0);
  r0.x = codeTexture2.Load(r0.xyz).y;
  r0.x = cmp((int)r0.x != 128);
  r0.x = r0.x ? postFxControl0.z : 0;
  r1.xy = (int2)v1.xy;
  r1.zw = float2(0,0);
  r0.y = codeTexture1.Load(r1.xyz).x;
  r0.z = rcp(abs(r0.y));
  r0.z = r0.z * 0.015625 + 0.984375;
  r0.w = rcp(r0.y);
  r0.y = cmp(r0.y < 0);
  r0.w = 0.984375 * r0.w;
  r0.z = r0.y ? r0.z : r0.w;
  r0.z = saturate(r0.z * postFxControl0.x + postFxControl0.y);
  o1.w = r0.y ? r0.z : r0.x;
  return;
}