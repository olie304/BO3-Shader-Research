...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:22:44 2021
//
//
// Buffer Definitions: 
//
...
//   float4 postFxBloom02;              // Offset: 1312 Size:    16
//   float4 postFxBloom03;              // Offset: 1328 Size:    16
...
//   float4 postFxBloom12;              // Offset: 1472 Size:    16
//   float4 postFxBloom13;              // Offset: 1488 Size:    16
//   float4 postFxBloom14;              // Offset: 1504 Size:    16
//   float4 postFxBloom15;              // Offset: 1520 Size:    16
//   float4 postFxBloom16;              // Offset: 1536 Size:    16
//   float4 postFxBloom17;              // Offset: 1552 Size:    16
//   float4 postFxBloom18;              // Offset: 1568 Size:    16
//   float4 postFxBloom19;              // Offset: 1584 Size:    16
...
dcl_constantbuffer CB8[100], immediateIndexed
...
mul r0.w, r0.w, l(0.14285715)
mul r0.xyz, r0.xyzx, cb8[82].xyzx
mul r1.xyz, r0.wwww, cb8[83].xyzx
mad r0.xyz, r0.xyzx, l(0.14285715, 0.14285715, 0.14285715, 0.000000), r1.xyzx
...
sqrt r0.xyz, r0.xyzx
mad_sat r0.xyz, r0.xyzx, cb8[92].xyzx, cb8[93].xyzx
log r0.xyz, r0.xyzx
mul r0.xyz, r0.xyzx, cb8[94].xyzx
exp r0.xyz, r0.xyzx
mad_sat r0.xyz, r0.xyzx, cb8[95].xyzx, cb8[96].xyzx
mul r0.xyz, r0.xyzx, r0.xyzx
dp3 r0.w, r0.xyzx, cb8[97].xyzx
add_sat r1.x, r0.w, cb8[97].w
dp3 r0.w, r0.xyzx, cb8[98].xyzx
dp3 r0.x, r0.xyzx, cb8[99].xyzx
add_sat r1.z, r0.x, cb8[99].w
add_sat r1.y, r0.w, cb8[98].w
log r0.xyz, r1.xyzx
mul r0.xyz, r0.xyzx, l(0.450000, 0.450000, 0.450000, 0.000000)
exp r0.xyz, r0.xyzx
mad r0.xyz, r0.xyzx, l(1.099000, 1.099000, 1.099000, 0.000000), l(-0.099000, -0.099000, -0.099000, 0.000000)
ge r2.xyz, l(0.018000, 0.018000, 0.018000, 0.000000), r1.xyzx
mul r1.xyz, r1.xyzx, l(4.500000, 4.500000, 4.500000, 0.000000)
movc r0.xyz, r2.xyzx, r1.xyzx, r0.xyzx
mul o0.xyz, r0.xyzx, l(256.000000, 256.000000, 256.000000, 0.000000)
ret 
