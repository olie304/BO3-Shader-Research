// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:22:44 2021
...
// unknown dcl_: dcl_resource_structured t5, 64
  ...
  r0.x = uiDest.x;
  r0.x = (uint)r0.x;
  r0.y = postFxBloom24.x * postFxBloom24.z;
  r0.x = r0.y * r0.x;
  o1.xyzw = float4(1.83389997,1.2816,0.967400014,0.727900028) * r0.xxxx;
  o2.xyz = float3(0.524399996,0.340700001,0.167899996) * r0.xxx;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r0.x, v2.x, l(12), t4.xxxx
r0.x = codeTexture0[]..swiz;
// Known bad code for instruction (needs manual fix):
...
r3.x = codeTexture0[]..swiz;
r3.y = codeTexture0[]..swiz;
r3.z = codeTexture0[]..swiz;
r3.w = codeTexture0[]..swiz;
// Known bad code for instruction (needs manual fix):
...
r0.z = codeTexture0[]..swiz;
r0.w = codeTexture0[]..swiz;
  r2.y = r3.w;
  r2.z = r0.w;
  ...
  o3.xyzw = viewProjectionMatrix._m30_m31_m32_m33 + r0.xyzw;
  return;
}