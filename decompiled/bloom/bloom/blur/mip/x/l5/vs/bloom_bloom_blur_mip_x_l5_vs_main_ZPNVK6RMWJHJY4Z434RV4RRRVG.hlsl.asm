...
//   float4 postFxBloom24;              // Offset: 1664 Size:    16
...
dcl_constantbuffer CB8[105], immediateIndexed
...
utof r0.x, r0.x
mul r0.y, cb8[104].z, cb8[104].x
mul r0.x, r0.x, r0.y
mul o1.xyzw, r0.xxxx, l(1.833900, 1.281600, 0.967400, 0.727900)
mul o2.xyz, r0.xxxx, l(0.524400, 0.340700, 0.167900, 0.000000)
...
add o3.xyzw, r0.xyzw, cb1[11].xyzw
ret 
