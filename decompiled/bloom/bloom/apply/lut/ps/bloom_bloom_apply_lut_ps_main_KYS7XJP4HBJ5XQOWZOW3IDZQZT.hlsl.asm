...
sample_indexable(texture2d)(float,float,float,float) r1.xy, r0.xyxx, t2.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r1.z, r0.zwzz, t2.xyzw, s0
mad r0.xyz, r1.xyzx, v1.xxxx, l(0.008730, 0.008730, 0.008730, 0.000000)
log r0.xyz, r0.xyzx
