// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:31:19 2021
...
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) o2.x, r0.y, l(12), t5.xxxx
r2.x = gpuSkinBase[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) o2.y, r0.y, l(28), t5.xxxx
r2.y = gpuSkinBase[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) o2.z, r0.y, l(44), t5.xxxx
r2.z = gpuSkinBase[]..swiz;
  ...
  r2.w = gpuSkinBase[]..swiz;
    ...
    if (r0.y != 0) {
      ...
      r1.xyw = gpuSkinPos.Load(r3.xyz).xyz;
      r6.xyz = gpuSkinPos.Load(r3.xwz).xyz;
      r7.xyz = gpuSkinBase.Load(r3.xzz).xyz;
      r5.xyzw = r5.xyzw + -r4.xyzw;
      r4.xyzw = r1.zzzz * r5.xyzw + r4.xyzw;
      r5.xyz = r6.xyz + -r1.xyw;
      r1.xyw = r1.zzz * r5.xyz + r1.xyw;
      r5.xyz = v0.xyz + -r7.xyz;
      r0.y = dot(r4.xyzw, r4.xyzw);
      r0.y = rsqrt(r0.y);
      r4.xyzw = r4.xyzw * r0.yyyy;
      r6.xyz = r4.xyz + r4.xyz;
      r8.xyz = r6.xxx * r4.xzw;
      r0.y = r6.y * r4.w;
      r6.zw = r6.zz * r4.wz;
      r0.z = r4.y * r6.y + r6.w;
      r9.x = 1 + -r0.z;
      r10.x = r4.z * r6.x + -r0.y;
      r9.y = r4.y * r6.x + -r6.z;
      r11.xy = r4.yx * r6.xx + r6.zw;
      r11.z = r4.z * r6.y + -r8.z;
      r4.xyz = r4.zwy * r6.yyy + r8.zyx;
      r9.z = r4.y;
      r6.x = dot(r5.xyz, r9.xyz);
      r11.w = 1 + -r11.y;
      r6.y = dot(r5.xzy, r11.xzw);
      r10.yz = r4.xz * float2(1,-1) + float2(0,1);
      r6.z = dot(r5.xyz, r10.xyz);
      r4.xyz = r6.xyz + r7.xyz;
      r1.xyw = r4.xyz + r1.xyw;
      r2.xyz = v5.xxx * r1.xyw;
      ...
      if (r0.y != 0) {
        ...
        if (r0.y != 0) {
          ...
          if (r0.y != 0) {
            ...
            r4.xyzw = r1.zzzz * r5.xyzw + r4.xyzw;
            r5.xyz = r6.xyz + -r1.xyw;
            r1.xyz = r1.zzz * r5.xyz + r1.xyw;
            r5.xyz = v0.xyz + -r3.xyz;
            r0.y = dot(r4.xyzw, r4.xyzw);
            r0.y = rsqrt(r0.y);
            r4.xyzw = r4.xyzw * r0.yyyy;
            r6.xyz = r4.xyz + r4.xyz;
            ...
            r8.z = r4.y;
            r6.x = dot(r5.xyz, r8.xyz);
            r10.w = 1 + -r10.y;
            r6.y = dot(r5.xzy, r10.xzw);
            r9.yz = r4.xz * float2(1,-1) + float2(0,1);
            r6.z = dot(r5.xyz, r9.xyz);
            r3.xyz = r6.xyz + r3.xyz;
            r1.xyz = r3.xyz + r1.xyz;
            r2.xyz = r1.xyz * v5.www + r2.xyz;
          }
        }
      }
    }
