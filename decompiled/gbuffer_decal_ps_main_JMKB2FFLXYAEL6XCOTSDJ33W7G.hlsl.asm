...
sample_indexable(texture2d)(float,float,float,float) r1.x, v2.xyxx, t7.xyzw, s1
...
mul r1.x, r0.w, v1.w
sample_indexable(texture2d)(float,float,float,float) r1.yzw, v2.xyxx, t9.wxyz, s2
sample_indexable(texture2d)(float,float,float,float) r2.x, v2.xyxx, t12.xyzw, s4
sample_indexable(texture2d)(float,float,float,float) r2.y, v2.xyxx, t11.yxzw, s2
