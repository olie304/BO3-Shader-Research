// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:37:07 2021
...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r6.y = 0;
  while (true) {
    r13.w = cmp((uint)r6.y >= numLights);
    if (r13.w != 0) break;
    r21.z = (uint)r6.y >> 5;
    r22.xyz = (int3)r19.xyz + (int3)r21.xyz;
    r13.w = visibleLights.Load(r22.xyzw).x;
    r22.xyz = r29.xyz;
    r40.xyz = r30.xyz;
    r41.xyz = r31.xyz;
    r42.xyz = r32.xyz;
    ...
    while (true) {
      ...
      r55.z = samp0[]..swiz;
      r55.w = samp0[]..swiz;
        if (3 == 0) r28.w = 0; else if (3+24 < 32) {         r28.w = (uint)r50.w << (32-(3 + 24)); r28.w = (uint)r28.w >> (32-3);        } else r28.w = (uint)r50.w >> 24;
        switch (r28.w) {
          case 4 :          r28.w = cmp(0 < r55.x);
          r56.xy = r54.zw;
          r56.z = r55.w;
          r57.xyz = -r56.xyz * float3(0.5,0.5,0.5) + r49.yzw;
          r58.xyz = -v5.xyz + r57.xyz;
          r29.w = dot(r56.xyz, r58.xyz);
          r30.w = saturate(-r29.w / r55.x);
          r59.xyz = r30.www * r56.xyz + r57.xyz;
          r59.xyz = r28.www ? r59.xyz : r49.yzw;
          r59.xyz = -v5.xyz + r59.xyz;
          r31.w = dot(r59.xyz, r59.xyz);
          r32.w = rsqrt(r31.w);
          r59.xyz = r59.xyz * r32.www;
          r32.w = dot(r2.xyz, r59.xyz);
          ...
          if (r33.w != 0) {
            ...
            r31.w = r34.w / r31.w;
            r31.w = min(1, r31.w);
            r39.zw = saturate(r33.ww * r51.xz + r51.yw);
            ...
            if (r31.w != 0) {
              ...
              r31.w = cmp((int)r39.z != 1);
              if (r31.w != 0) {
                r31.w = abs(r32.w) * -0.200000003 + 0.400000006;
                r33.w = cmp(r32.w < 0);
                r31.w = r33.w ? -r31.w : r31.w;
                r61.xyz = r2.xyz * r31.www + v5.xyz;
                r61.xyz = r61.xyz + -r53.xyz;
                r31.w = max(abs(r61.y), abs(r61.z));
                r31.w = max(abs(r61.x), r31.w);
                r31.w = r54.x / r31.w;
                r31.w = r31.w + r54.y;
                r33.w = dot(r61.xyz, r61.xyz);
                r33.w = rsqrt(r33.w);
                r31.w = max(6.10351563e-05, r31.w);
                r34.w = (int)r50.w & 0x0000ffff;
                r62.w = (uint)r34.w;
                r60.y = 0;
                r34.w = 0;
                while (true) {
                  ...
                  if (r35.w != 0) break;
                  r63.y = dot(icb[r34.w+0].yx, r20.xy);
                  r63.z = dot(icb[r34.w+0].yx, r20.yz);
                  r63.yz = r63.yz * r52.yy;
                  r63.x = r63.y * r11.x;
                  r63.w = r63.y * r10.x;
                  r62.xyz = r61.xyz * r33.www + r63.xzw;
                  r35.w = gOmniShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r62.xyzw, r31.w).x;
                  r60.y = r35.w * 0.125 + r60.y;
                  r34.w = (int)r34.w + 1;
                }
              } else {
                r60.y = 1;
              ...
              r62.w = samp0[]..swiz;
                ...
                r24.xyz = r2.xyz * r34.www + v5.xyz;
                r34.w = dot(r61.xyzw, r24.xyzw);
                r35.w = dot(r62.xyzw, r24.xyzw);
                ...
                r24.y = samp0[]..swiz;
                  ...
                  if (r15.w != 0) {
                    ...
                    while (true) {
                      ...
                      if (r34.w != 0) break;
                      r63.x = dot(icb[r31.w+0].yx, r20.xw);
                      r63.y = dot(icb[r31.w+0].xy, r8.xy);
                      r62.xy = r63.xy * r33.ww + r61.xy;
                      r34.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r62.xyz, r24.x).x;
              ...
              if (r24.y != 0) {
                ...
                r31.w = dot(r56.xyz, r12.xyz);
                r33.w = dot(r12.xyz, r58.xyz);
                r34.w = -r31.w * r31.w + r55.x;
                ...
                r56.xyz = r29.www * r56.xyz + r57.xyz;
                r56.xyz = r28.www ? r56.xyz : r49.yzw;
                r56.xyz = -v5.xyz + r56.xyz;
                r28.w = dot(r56.xyz, r56.xyz);
                r28.w = rsqrt(r28.w);
                r57.xyz = r56.xyz * r28.www;
                r29.w = -abs(r32.w) * r4.w + 1;
                r29.w = r29.w * r29.w;
                r29.w = -r29.w * 0.620000005 + 0.620000005;
                r29.w = r29.w + -abs(r32.w);
                r29.w = r29.w * 0.816496611 + abs(r32.w);
                r30.w = cmp(0 < r32.w);
                r31.w = saturate(dot(r2.xyz, r57.xyz));
                r56.xyz = r56.xyz * r28.www + r7.xyz;
                r28.w = dot(r56.xyz, r56.xyz);
                r28.w = rsqrt(r28.w);
                r56.xyz = r56.xyz * r28.www;
                r28.w = dot(r2.xyz, r56.xyz);
                r32.w = dot(r56.xyz, r7.xyz);
                r33.w = dot(r56.xyz, r4.xyz);
                r34.w = dot(r56.xyz, r5.xyz);
                r33.w = r33.w * r33.w;
                r33.w = r33.w / r1.y;
                r34.w = r34.w * r34.w;
                r34.w = r34.w / r1.z;
                ...
                r28.w = r31.w * r28.w;
                r28.w = r28.w * r24.y;
                r56.xyz = r30.www ? r29.www : 0;
                r29.w = r30.w ? 0 : r29.w;
                r57.xyz = r30.www ? r28.www : 0;
                r24.y = r30.w ? r24.y : 0;
                r50.x = r49.x;
                r28.w = dot(r50.xyz, float3(0.212599993,0.715200007,0.0722000003));
                r28.w = r28.w * r24.x;
                r30.w = cmp(r17.w < r28.w);
                if (r30.w != 0) {
                  r30.w = r21.z * r21.w;
                  r58.xyz = r30.www * r43.xyz;
                  ...
                  r40.xyz = r56.xyw * r29.www + r40.xyz;
          ...
          r59.w = samp0[]..swiz;
            ...
            r29.w = samp0[]..swiz;
              r66.xyz = -v5.xyz + r49.yzw;
              r30.w = r52.x * r52.x;
              r31.w = dot(r66.xyz, r66.xyz);
              r30.w = r30.w / r31.w;
              r30.w = min(1, r30.w);
              r39.zw = saturate(r28.ww * r51.xz + r51.yw);
              ...
              r25.xy = r51.xy / r28.ww;
              r28.w = cmp(r63.w < 0.00048828125);
              if (r28.w != 0) {
                r64.y = r65.x;
            ...
            if (r25.x != 0) {
                ...
                r59.y = samp0[]..swiz;
                  ...
                  if (r15.w != 0) {
                    ...
                    while (true) {
                      ...
                      if (r30.w != 0) break;
                      r53.x = dot(icb[r29.w+0].xy, r9.xy);
                      r53.y = dot(icb[r29.w+0].yx, r9.xz);
                      r51.xy = r53.xy * r52.yy + r26.xy;
                      r30.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r51.xyz, r25.x).x;
                      r28.w = r30.w * 0.125 + r28.w;
                      r29.w = (int)r29.w + 1;
                    }
                  } else {
                    r26.z = (uint)r25.w;
                    r28.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r26.xyz, r25.x).x;
                  }
                  r25.x = r28.w * r28.w;
                  r62.y = r25.x * r28.w;
                } else {
              ...
              r58.z = samp0[]..swiz;
              r58.w = samp0[]..swiz;
                r25.w = abs(r24.y) * -0.200000003 + 0.400000006;
                r26.x = cmp(r24.y < 0);
                r25.w = r26.x ? -r25.w : r25.w;
                r27.xyz = r2.xyz * r25.www + v5.xyz;
                r26.x = dot(r51.xyzw, r27.xyzw);
                r26.y = dot(r52.xyzw, r27.xyzw);
                r25.w = dot(r53.xyzw, r27.xyzw);
                ...
                r27.yz = r25.yy / r55.xz;
                r39.zw = float2(1,1) + -r27.yz;
                r39.zw = cmp(r26.xy >= r39.zw);
                r27.yz = cmp(r27.yz >= r26.xy);
                r27.yz = (int2)r27.yz | (int2)r39.zw;
                ...
                r27.z = samp0[]..swiz;
                  ...
                  if (r15.w != 0) {
                    ...
                    while (true) {
                      ...
                      if (r27.z != 0) break;
                      r52.x = dot(icb[r27.y+0].xy, r28.xy);
                      r52.y = dot(icb[r27.y+0].yx, r28.xz);
                      r26.xy = r52.xy * r25.yy + r51.xy;
                    ...
                    r51.z = (uint)r25.w;
                    r27.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r51.xyz, r25.x).x;
                  }
                  r25.x = r27.x * r27.x;
                  r25.x = r25.x * r27.x;
                } else {
              ...
              r25.y = cmp(0 < r25.x);
              if (r25.y != 0) {
                r25.y = 0.166666672 * r50.x;
                r25.w = -abs(r24.y) * r4.w + 1;
                r25.w = r25.w * r25.w;
                r25.w = -r25.w * 0.620000005 + 0.620000005;
                r25.w = r25.w + -abs(r24.y);
                r25.w = r25.w * 0.816496611 + abs(r24.y);
                r26.x = cmp(0 < r24.y);
                r24.y = saturate(r24.y);
                r50.xyz = r56.xyz * r24.xxx + r7.xyz;
                r24.x = dot(r50.xyz, r50.xyz);
                r24.x = rsqrt(r24.x);
                r50.xyz = r50.xyz * r24.xxx;
                r24.x = dot(r2.xyz, r50.xyz);
                r26.y = dot(r50.xyz, r7.xyz);
                r26.z = dot(r50.xyz, r4.xyz);
                r27.y = dot(r50.xyz, r5.xyz);
                r26.z = r26.z * r26.z;
                r26.z = r26.z / r1.y;
                r27.y = r27.y * r27.y;
                r27.y = r27.y / r1.z;
                r26.z = r27.y + r26.z;
                r24.x = abs(r24.x) * abs(r24.x) + r26.z;
                r26.z = r24.y * r8.z + r8.w;
                r24.x = r24.x * r24.x;
                r24.x = r24.x * r6.x;
                r24.x = r24.x * r26.z;
                r24.x = rcp(r24.x);
                r24.y = r24.y * r25.y;
                r24.x = r24.x * r24.y;
                r24.y = saturate(1 + -r26.y);
                r25.y = r24.y * r24.y;
                r25.y = r25.y * r25.y;
                r24.y = r25.y * r24.y;
                r24.y = r24.x * r24.y;
                r50.xyz = r26.xxx ? r25.www : 0;
                r25.y = r26.x ? 0 : r25.w;
                r51.xyz = r26.xxx ? r24.yyy : 0;
                r24.x = r26.x ? r24.x : 0;
                r24.y = dot(r49.xyz, float3(0.212599993,0.715200007,0.0722000003));
                r24.y = r25.x * r24.y;
                r25.w = cmp(r17.w < r24.y);
                if (r25.w != 0) {
                  r25.w = r21.z * r21.w;
                  r26.xyz = r25.www * r43.xyz;
                  ...
                  r26.xyz = r25.xxx * r49.xyz;
                  r22.xyz = r26.xyz * r50.zzz + r22.xyz;
                  r40.xyz = r26.xyz * r25.yyy + r40.xyz;
                  r42.xyz = r26.xyz * r24.xxx + r42.xyz;
                  r41.xyz = r26.xyz * r51.xyz + r41.xyz;
                }
              }
            }
          }
  ...
  r8.xyz = viewProjectionMatrix._m10_m11_m13 * r13.yyy;
  r8.xyz = r13.xxx * viewProjectionMatrix._m00_m01_m03 + r8.xyz;
  r8.xyz = r13.zzz * viewProjectionMatrix._m20_m21_m23 + r8.xyz;
  r8.xyz = r8.xyz + r10.yzw;
  r9.z = rcp(r8.z);
  r1.yz = r9.zz * r8.xy;
  r9.xy = r1.yz * float2(0.5,-0.5) + float2(0.5,0.5);
  r8.xyw = r34.xyz * float3(2.4000001,2.4000001,2.4000001) + r13.xyz;
  r1.y = dot(v0.xy, float2(0.0671105608,0.00583714992));
  r1.y = frac(r1.y);
  r1.y = 52.9829178 * r1.y;
  r1.y = frac(r1.y);
  r1.z = 3.14159989 * r1.y;
  sincos(r1.z, r6.x, r10.x);
  r11.xyz = r6.xxx * r5.xyz;
  r11.xyz = r10.xxx * r4.xyz + r11.xyz;
  r11.xyz = r11.xyz * float3(0.119999997,0.119999997,0.119999997) + r8.xyw;
  ...
  r6.xy = float2(0.5,-0.5) * r11.xy;
  r11.z = rcp(r11.z);
  r11.xy = r6.xy * r11.zz + float2(0.5,0.5);
  r13.xyz = -r9.xyz;
  r11.xyz = r13.xyz + r11.xyz;
  r15.xyz = r1.yyy * float3(3.14159989,0.5,0.5) + float3(3.14159989,0.333333343,1);
  sincos(r15.x, r6.x, r10.x);
  r5.xyz = r6.xxx * r5.xyz;
  r4.xyz = r10.xxx * r4.xyz + r5.xyz;
  r4.xyz = r4.xyz * float3(0.119999997,0.119999997,0.119999997) + r8.xyw;
  ...
  r3.w = rcp(r3.w);
  r1.z = r3.w * r1.z;
  r5.xy = float2(0.117647059,0.117647059) * r15.yz;
  r5.xy = r5.xy * r5.xy;
  x1[0].x = r5.x;
  r8.xyw = r11.xyz * r5.xxx + r9.xyz;
  r5.zw = cmp(r1.zz < r5.xy);
  r6.xy = renderTargetSize.xy * r8.xy;
  r10.xy = (int2)r6.xy;
  r10.zw = float2(0,0);
  ...
  x0[0].x = r4.w;
  x1[1].x = r5.y;
  r8.xyw = r4.xyz * r5.yyy + r9.xyz;
  r6.xy = renderTargetSize.xy * r8.xy;
  r10.xy = (int2)r6.xy;
  r10.zw = float2(0,0);
  r5.z = floatZSampler.Load(r10.xyz).x;
  r6.x = cmp(r5.z >= 0.984375);
  r6.y = 1.01587307 * r5.z;
  r5.z = r5.z * 64 + -63;
  r5.z = r6.x ? r5.z : r6.y;
  r5.z = max(9.99999994e-09, r5.z);
  r5.z = rcp(r5.z);
  x2[1].x = r5.z;
  r6.x = 0.0419999994 + r5.z;
  r6.x = r8.w * r6.x;
  r6.x = cmp(1 < r6.x);
  ...
  if (r6.x != 0) {
    r6.xy = r1.yy * float2(0.5,0.5) + float2(1.33333337,2);
    r6.xy = float2(0.117647059,0.117647059) * r6.xy;
    r6.xy = r6.xy * r6.xy + -r5.xy;
    r5.x = r4.w * r6.x + r5.x;
    x1[0].x = r5.x;
    r8.xyw = r11.xyz * r5.xxx + r9.xyz;
    r5.x = cmp(r1.z < r5.x);
    ...
    r4.w = r5.w * r6.y + r5.y;
    x1[1].x = r4.w;
    r8.xyw = r4.xyz * r4.www + r9.xyz;
    r4.w = cmp(r1.z < r4.w);
    r5.xy = renderTargetSize.xy * r8.xy;
    r10.xy = (int2)r5.xy;
    r10.zw = float2(0,0);
    r5.x = floatZSampler.Load(r10.xyz).x;
    r5.y = cmp(r5.x >= 0.984375);
    r6.x = 1.01587307 * r5.x;
    r5.x = r5.x * 64 + -63;
    r5.x = r5.y ? r5.x : r6.x;
  ...
  if (r3.w == 0) {
    ...
    r4.w = r5.x * r5.y + r4.w;
    x1[1].x = r4.w;
    r5.yzw = r4.xyz * r4.www + r9.xyz;
    r4.w = cmp(r1.z < r4.w);
    r5.yz = renderTargetSize.xy * r5.yz;
    r10.xy = (int2)r5.yz;
    r10.zw = float2(0,0);
    r5.y = floatZSampler.Load(r10.xyz).x;
  ...
  r1.z = (int)r1.y & -32;
  r3.w = (int)-r1.z + (int)r1.y;
  r4.w = numRefProbes & -32;
  r5.w = (int)-r4.w + numRefProbes;
  r10.xy = float2(0,0);
  r11.w = 0;
  r13.yz = float2(0,1);
  r15.xy = float2(0,0);
  ...
  r6.x = r1.z;
  while (true) {
    r6.y = cmp((uint)r6.x >= numRefProbes);
    if (r6.y != 0) break;
    r10.z = (uint)r6.x >> 5;
    r11.xyz = (int3)r10.xyz + (int3)r19.xyz;
    r6.y = visibleProbes.Load(r11.xyzw).x;
    r7.w = cmp((int)r1.z == (int)r6.x);
    bitmask.w = ((~(-1 << r3.w)) << 0) & 0xffffffff;  r8.w = (((uint)0 << 0) & bitmask.w) | ((uint)r6.y & ~bitmask.w);
    r6.y = r7.w ? r8.w : r6.y;
    r7.w = cmp((int)r4.w == (int)r6.x);
    if (r5.w == 0) r8.w = 0; else if (r5.w+0 < 32) {     r8.w = (uint)r6.y << (32-(r5.w + 0)); r8.w = (uint)r8.w >> (32-r5.w);    } else r8.w = (uint)r6.y >> 0;
    r6.y = r7.w ? r8.w : r6.y;
    r7.w = (int)r6.x + numLights;
    r21.xyzw = r18.xyzw;
    r22.xyz = r20.yzw;
    r8.w = r6.y;
    while (true) {
      ...
      r11.y = samp0[]..swiz;
        ...
        r30.z = samp0[]..swiz;
        r30.w = samp0[]..swiz;
          r14.y = dot(r25.xyz, r11.xyz);
          r14.y = saturate(r14.y + r25.w);
          r15.w = dot(r26.xyz, r11.xyz);
          r15.w = saturate(r15.w + r26.w);
          r14.y = r15.w * r14.y;
          r15.w = dot(r27.xyz, r11.xyz);
          r15.w = saturate(r15.w + r27.w);
          r14.y = r15.w * r14.y;
          r15.w = dot(r28.xyz, r11.xyz);
          r15.w = saturate(r15.w + r28.w);
          r14.y = r15.w * r14.y;
          r15.w = dot(r29.xyz, r11.xyz);
          ...
          r32.w = samp0[]..swiz;
            ...
            r15.w = saturate(r15.w + r27.w);
            r15.w = r26.x * r15.w;
            r16.w = dot(r28.xyz, r11.xyz);
            r16.w = saturate(r16.w + r28.w);
            r15.w = r16.w * r15.w;
            r16.w = dot(r29.xyz, r11.xyz);
            r16.w = saturate(r16.w + r29.w);
            r15.w = r16.w * r15.w;
            r16.w = dot(r30.xyz, r11.xyz);
            r16.w = saturate(r16.w + r30.w);
            r15.w = r16.w * r15.w;
            r16.w = dot(r31.xyz, r11.xyz);
            r16.w = saturate(r16.w + r31.w);
            r15.w = r16.w * r15.w;
            r16.w = dot(r32.xyz, r11.xyz);
            r16.w = saturate(r16.w + r32.w);
            r26.x = r16.w * r15.w;
            r17.w = (uint)r13.x >> 2;
            if (1 == 0) r19.w = 0; else if (1+2 < 32) {             r19.w = (uint)r13.x << (32-(1 + 2)); r19.w = (uint)r19.w >> (32-1);            } else r19.w = (uint)r13.x >> 2;
            r23.w = (int)r17.w & 2;
            r25.z = max(r26.y, r26.x);
            r15.w = -r15.w * r16.w + 1;
            r15.w = r26.y * r15.w;
            r14.w = r23.w ? r15.w : r25.z;
            r26.xy = r19.ww ? r26.xy : r14.zw;
            r14.y = (int)r14.y + 1;
            r13.x = r17.w;
          }
          ...
          r36.x = samp0[]..swiz;
          r36.y = samp0[]..swiz;
            r22.z = r26.y * r10.w + r22.z;
            r9.w = r10.z * r24.z;
            r24.z = r31.z;
            r10.z = dot(r12.xyz, r24.xyz);
            ...
            r32.z = r33.z;
            r10.w = dot(r12.xyz, r32.xyz);
            r13.x = dot(r11.xyz, r32.xyz);
            r13.x = r13.x + -r33.w;
            r13.w = cmp(r13.x >= 0);
            r13.x = max(100, abs(r13.x));
            r13.x = r13.w ? r13.x : -r13.x;
            ...
            r10.z = min(r10.z, abs(r10.w));
            r36.zw = r35.zw;
            r10.w = dot(r12.zxy, r36.xzw);
            r13.x = dot(r11.zxy, r36.xzw);
            r13.x = r13.x + -r36.y;
            r13.w = cmp(r13.x >= 0);
            r13.x = max(100, abs(r13.x));
            r13.x = r13.w ? r13.x : -r13.x;
            ...
            r24.x = r28.w;
            r24.yz = r29.zw;
            r14.xyw = r24.xyz + r11.xyz;
            r14.xyw = r12.xyz * r10.zzz + r14.xyw;
            ...
            r23.y = r25.z;
            r23.z = r27.x;
            r31.x = dot(r14.xyw, r23.xyz);
            r24.xy = r25.xw;
            r24.z = r27.w;
            r31.y = dot(r14.xyw, r24.xyz);
            r27.x = r25.y;
            ...
            r31.w = (uint)r10.w;
            r14.xyw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r31.xyzw, r10.z).xyz;
            r25.x = dot(r11.xyz, r23.xyz);
            r25.y = dot(r11.xyz, r24.xyz);
            r25.z = dot(r11.xyz, r27.xyz);
            r11.xyz = saturate(r25.xyz * r28.xyz + float3(0.5,0.5,0.5));
            r29.z = r30.x;
            ...
            r11.xyz = r11.xyz * r25.zzz + r23.xyw;
            ...
            r10.w = 1.26815999 * r10.z;
            r11.xyz = r14.xyw * r9.www;
            r9.w = dot(r11.xyz, float3(0.212599993,0.715200007,0.0722000003));
            r9.w = r10.z * 1.26815999 + r9.w;
            r9.w = r10.w / r9.w;
            r23.x = r21.w;
            r23.yz = r22.xy;
  ...
  if (r4.w != 0) {
    ...
    r5.w = 0;
    while (true) {
      r7.w = cmp((uint)r5.w >= (uint)r1.y);
      if (r7.w != 0) break;
      r10.z = (uint)r5.w >> 5;
      r11.xyz = (int3)r10.xyz + (int3)r19.xyz;
      r7.w = visibleProbes.Load(r11.xyzw).x;
      r8.w = cmp((int)r1.z == (int)r5.w);
      if (r3.w == 0) r9.w = 0; else if (r3.w+0 < 32) {       r9.w = (uint)r7.w << (32-(r3.w + 0)); r9.w = (uint)r9.w >> (32-r3.w);      } else r9.w = (uint)r7.w >> 0;
      r7.w = r8.w ? r9.w : r7.w;
      r8.w = (int)r5.w + numLights;
      r22.xyzw = r17.xyzw;
      r11.xyz = r21.xyz;
      r9.w = r4.w;
      r10.z = r7.w;
      while (true) {
        ...
        r24.y = samp0[]..swiz;
          ...
          r32.w = samp0[]..swiz;
            ...
            r13.x = r16.w * r15.w;
            r15.w = (int)r24.x & 1;
            r24.zw = r15.ww ? r13.xy : r13.zx;
            r13.x = r24.x;
            r27.xy = r24.zw;
            r15.w = 1;
            while (true) {
              r16.w = cmp((int)r15.w >= (int)r14.w);
              if (r16.w != 0) break;
            ...
            r33.w = samp0[]..swiz;
              ...
              r16.w = -r16.w * r19.w + 1;
              r16.w = r27.y * r16.w;
              r6.y = r26.w ? r16.w : r27.z;
              r27.xy = r23.ww ? r27.xy : r6.xy;
              r15.w = (int)r15.w + 1;
              r13.x = r21.w;
            }
            r6.y = saturate(r27.y + -r9.w);
            r13.x = r6.y * r24.y;
            r13.w = cmp(0 < r13.x);
            if (r13.w != 0) {
            // Known bad code for instruction (needs manual fix):
            ...
            r38.y = samp0[]..swiz;
              ...
              r10.w = min(abs(r13.x), r10.w);
              r38.zw = r37.zw;
              r13.x = dot(r12.zxy, r38.xzw);
              r13.w = dot(r26.zxy, r38.xzw);
              r13.w = r13.w + -r38.y;
              r14.w = cmp(r13.w >= 0);
              r13.w = max(100, abs(r13.w));
              r13.w = r14.w ? r13.w : -r13.w;
              ...
              r24.xyz = r12.xyz * r10.www + r24.xyz;
              ...
              r33.w = (uint)r13.x;
              r24.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r33.xyzw, r10.w).xyz;
              ...
              r13.x = 1.26815999 * r10.w;
              r23.xyz = r24.xyz * r6.yyy;
              r6.y = dot(r23.xyz, float3(0.212599993,0.715200007,0.0722000003));
              r6.y = r10.w * 1.26815999 + r6.y;
              r6.y = r13.x / r6.y;
              r22.xyz = r23.xyz * r6.yyy + r22.xyz;
            }
          }
        }
      }
  ...
  r10.xyz = r18.xyz * r1.yyy;
  r11.xyz = r20.xyz * r1.yyy;
  r1.z = cmp(r20.w < 0.99000001);
  if (r1.z != 0) {
    r1.z = 1 + -r20.w;
    ...
    r10.xyz = r18.xyz * r1.yyy + r2.xyz;
    r12.w = 0;
    r2.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r12.xyzw, 5).xyz;
    r11.xyz = r2.xyz * r1.zzz + r11.xyz;
  }
  r2.xyz = r10.xyz * r1.xxx + r5.xyz;
  r5.xyz = r10.xyz * r1.xxx + r8.xyz;
  r6.w = 0;
  r1.yz = float2(0.0078125,0.0078125) + r6.zw;
  r1.yz = gEnvBRDFGeneric.SampleLevel(samplerLinear_s, r1.yz, 0).xy;
  r6.xyz = r11.xyz * r1.xxx;
  r4.xyz = r6.xyz * r1.yyy + r4.xyz;
  ...
  r3.x = min(1, r3.x);
  r3.yzw = saturate(r0.xyz * float3(0.0199999996,0.0199999996,0.0199999996) + float3(0.0399999991,0.0399999991,0.0399999991));
  r6.xyz = specColorTint.xyz * r3.yzw;
  r7.xyz = r3.xxx * r0.xyz;
  r5.xyz = r7.xyz * r5.xyz;
  r2.xyz = r2.xyz * r0.xyz + r5.xyz;
  r3.xyz = -r3.yzw * specColorTint.xyz + float3(1,1,1);
  ...
  if (useAlphaControls != 0) {
    ...
    r2.x = saturate(r2.w * r2.x + r2.y);
    r2.x = r2.x * r0.w;
    r3.xy = (int2)v0.xy;
    r3.zw = float2(0,0);
    r2.y = floatZSampler.Load(r3.xyz).x;
    r2.w = cmp(r2.y >= 0.984375);
    r3.x = 1.01587307 * r2.y;
    r2.y = r2.y * 64 + -63;
    r2.y = r2.w ? r2.y : r3.x;
    r2.y = max(9.99999994e-09, r2.y);
    r2.y = rcp(r2.y);
    r2.w = 1 / zFeatherDistance;
