...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:33:10 2021
//
//
// Buffer Definitions: 
//
...
sample_indexable(texture2d)(float,float,float,float) r4.xyzw, r13.xyxx, t47.xyzw, s1
...
mov r4.x, cb0[33].y
sample_l_indexable(texture2d)(float,float,float,float) r0.w, r4.xyxx, t30.yzwx, s7, l(0.000000)
log r0.w, |r0.w|
...
ret 
// Approximately 2491 instruction slots used
