...
Texture2D<float4> flagRippleDetailMap : register(t14);
  ...
  out float2 o3 : SV_TARGET3)
{
  ...
  r2.xyzw = gameTime.wwww * flagScrollParms.xyzw;
  r2.xyzw = v2.xyxy * flagRippleScale + r2.xyzw;
  r4.xyz = flagRippleDetailMap.Sample(normalSampler_s, r2.xy).xyz;
  r2.xy = r4.xy * float2(1.9921875,1.9921875) + float2(-1,-1);
  r1.w = r4.z * r4.z;
  r1.w = 0.333333343 * r1.w;
  r1.w = min(1, r1.w);
  r4.xyz = flagRippleDetailMap.Sample(normalSampler_s, r2.zw).xyz;
  r2.zw = r4.xy * float2(1.9921875,1.9921875) + float2(-1,-1);
  r3.w = r4.z * r4.z;
  r3.w = 0.333333343 * r3.w;
  r3.w = min(1, r3.w);
  r3.xy = r2.xy * flagRippleHeight + r3.xy;
  r2.x = dot(r3.xyz, r3.xyz);
  r2.x = rsqrt(r2.x);
  r3.xyz = r3.xyz * r2.xxx;
  r1.z = r1.w * flagRippleHeight + r1.z;
  ...
  r0.w = flagParams.z * r0.z;
  r1.yz = v6.xy / v6.ww;
  r4.zw = float2(0.5,0.5) * renderTargetSize.xy;
  r5.x = r4.z * r1.y;
  r5.y = -r4.w * r1.z;
  r1.yz = renderTargetSize.xy * float2(0.5,0.5) + r5.xy;
  r1.yz = v0.xy + -r1.yz;
  r3.w = r4.x + r4.y;
  r3.w = r3.z * r1.w + r3.w;
  r3.w = 0.5 * r3.w;
  r3.xyz = r3.xyz * r1.www + -r3.www;
  r1.w = max(r3.y, r3.z);
  r1.w = max(r3.x, r1.w);
  r1.w = max(r3.w, r1.w);
  r3.x = cmp(r1.w == r3.x);
  ...
  r1.xw = (uint2)v0.xy;
  r2.y = r0.x * flagParams.z + -r0.w;
  r0.w = r2.y * 0.5 + r0.w;
  r2.z = r0.y * flagParams.z + -r0.w;
  r2.x = r2.z * 0.5 + r0.w;
  r1.xw = (int2)r1.xw & int2(1,1);
  r0.w = cmp((int)r1.w == (int)r1.x);
  r1.xw = r0.ww ? r2.xy : r2.xz;
  o2.xy = r1.xw * float2(1,0.5) + float2(0,0.5);
  r1.xw = float2(-10,-10) + abs(r1.yz);
  r1.xw = saturate(float2(0.0333333351,0.0333333351) * r1.xw);
  r2.xy = float2(0.100000001,0.100000001) * abs(r1.yz);
  r2.xy = min(float2(1,1), r2.xy);
  r2.xy = r2.xy + -r1.xw;
  r1.xw = r2.xy * float2(0.5,0.5) + r1.xw;
  r1.yz = cmp(r1.yz >= float2(0,0));
  o3.xy = r1.yz ? r1.xw : -r1.xw;
  o0.xyz = r0.xyz;
  o0.w = 1;
  o2.w = 0.666666687;
  return;
