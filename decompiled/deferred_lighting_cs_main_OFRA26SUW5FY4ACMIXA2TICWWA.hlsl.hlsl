...
r0.y = samp0[]..swiz;
  ...
  if (probeDebug != 0) {
    ...
    while (true) {
      r27.w = cmp((uint)r14.w >= numRefProbes);
      if (r27.w != 0) break;
      r27.w = (uint)r14.w >> 5;
    ...
    r27.w = samp0[]..swiz;
      ...
      while (true) {
        ...
        r42.y = (int)r14.w + (int)r42.y;
        r42.y = (int)r42.y * 14;
        r43.xyz = -refProbeConstantsCB[r42.y].data[0].xyz + r5.xyz;
  ...
  if (r10.w != 0) {
    ...
    if (6 == 0) r14.z = 0; else if (6+25 < 32) {     r14.z = (uint)r12.w << (32-(6 + 25)); r14.z = (uint)r14.z >> (32-6);    } else r14.z = (uint)r12.w >> 25;
    r14.w = (int)r9.w * 6;
    r16.w = dot(refProbeAttenuationConstantsCB[r14.w].data[0].xyz, r13.yzw);
    r16.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[0].w + r16.w);
    r17.w = dot(refProbeAttenuationConstantsCB[r14.w].data[1].xyz, r13.yzw);
    r17.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[1].w + r17.w);
    r16.w = r17.w * r16.w;
    r17.w = dot(refProbeAttenuationConstantsCB[r14.w].data[2].xyz, r13.yzw);
    r17.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[2].w + r17.w);
    r16.w = r17.w * r16.w;
    r17.w = dot(refProbeAttenuationConstantsCB[r14.w].data[3].xyz, r13.yzw);
    r17.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[3].w + r17.w);
    r16.w = r17.w * r16.w;
    r17.w = dot(refProbeAttenuationConstantsCB[r14.w].data[4].xyz, r13.yzw);
    r17.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[4].w + r17.w);
    r16.w = r17.w * r16.w;
    r17.w = dot(refProbeAttenuationConstantsCB[r14.w].data[5].xyz, r13.yzw);
    r14.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[5].w + r17.w);
    r30.x = r16.w * r14.w;
    r14.w = (int)r19.w & 1;
    r30.yz = float2(0,1);
    r20.zw = r14.ww ? r30.xy : r30.zx;
    r30.x = 1;
    r14.w = r19.w;
    r31.xy = r20.zw;
    r16.w = 1;
    while (true) {
      r17.w = cmp((int)r16.w >= (int)r14.z);
      if (r17.w != 0) break;
      r17.w = (int)r9.w + (int)r16.w;
      r17.w = (int)r17.w * 6;
      ...
      r18.w = r31.x * r18.w;
      r21.w = dot(refProbeAttenuationConstantsCB[r17.w].data[1].xyz, r13.yzw);
      r21.w = saturate(refProbeAttenuationConstantsCB[r17.w].data[1].w + r21.w);
      r18.w = r21.w * r18.w;
      r21.w = dot(refProbeAttenuationConstantsCB[r17.w].data[2].xyz, r13.yzw);
      r21.w = saturate(refProbeAttenuationConstantsCB[r17.w].data[2].w + r21.w);
      r18.w = r21.w * r18.w;
      r21.w = dot(refProbeAttenuationConstantsCB[r17.w].data[3].xyz, r13.yzw);
      r21.w = saturate(refProbeAttenuationConstantsCB[r17.w].data[3].w + r21.w);
      r18.w = r21.w * r18.w;
      r21.w = dot(refProbeAttenuationConstantsCB[r17.w].data[4].xyz, r13.yzw);
      r21.w = saturate(refProbeAttenuationConstantsCB[r17.w].data[4].w + r21.w);
      r18.w = r21.w * r18.w;
      r21.w = dot(refProbeAttenuationConstantsCB[r17.w].data[5].xyz, r13.yzw);
    ...
    if (r9.w != 0) {
      ...
      r16.w = dot(r13.yzw, r26.xyz);
      r14.y = r16.w + -r14.y;
      r16.w = cmp(r14.y >= 0);
      r14.y = max(abs(r14.y), r7.w);
      r14.y = r16.w ? r14.y : -r14.y;
      r14.w = max(1.00000001e-07, -r14.w);
      r14.y = r14.y / r14.w;
      ...
      r20.w = (uint)r12.w;
      r14.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r20.xyzw, r14.y).xyz;
      r19.xyz = (int3)r14.yzw & int3(-2147483648,-2147483648,-2147483648);
      ...
      r19.x = dot(r13.yzw, r29.xyz);
      r19.y = dot(r13.yzw, r16.xyz);
      r19.z = dot(r13.yzw, r27.xyz);
      r13.yzw = saturate(r19.xyz * r17.xyz + float3(0.5,0.5,0.5));
  ...
  if (r10.w == 0) {
    ...
    r14.w = samp0[]..swiz;
      r17.w = cmp((int)r13.y == (int)r14.z);
      bitmask.w = ((~(-1 << r13.z)) << 0) & 0xffffffff;  r18.w = (((uint)0 << 0) & bitmask.w) | ((uint)r14.w & ~bitmask.w);
    ...
    r13.w = 0;
    while (true) {
      r17.w = cmp((uint)r13.w >= (uint)r10.w);
      if (r17.w != 0) break;
      r17.w = (uint)r13.w >> 5;
    ...
    r17.w = samp0[]..swiz;
      r18.w = cmp((int)r13.y == (int)r13.w);
      if (r13.z == 0) r19.x = 0; else if (r13.z+0 < 32) {       r19.x = (uint)r17.w << (32-(r13.z + 0)); r19.x = (uint)r19.x >> (32-r13.z);      } else r19.x = (uint)r17.w >> 0;
      ...
      while (true) {
        ...
        if (r19.w != 0) {
          ...
          r31.xzw = r15.xyz * r19.yyy + r32.xyz;
    ...
    r9.w = r3.z ? r7.w : r25.y;
    r3.z = max(1, r25.x);
    r3.z = rcp(r3.z);
    r25.x = saturate(r25.x);
    r13.yzw = r14.yzw * r3.zzz;
    r30.xyz = r24.xyz * r3.zzz;
    r7.w = cmp(r25.x < 0.99000001);
    if (r7.w != 0) {
      r9.w = (int)r9.w + 256;
      r7.w = 1 + -r25.x;
      r8.w = sunConstants.globalProbeExposure * r7.w;
      r16.xyz = -globalProbeConstants.data[0].xyz + r5.xyz;
      ...
      r13.yzw = r14.yzw * r3.zzz + r16.xyz;
      r15.w = 0;
      ...
      r3.z = r2.y * r3.z + r8.w;
      r30.xyz = r14.yzw * r3.zzz + r30.xyz;
    }
  } else {
    r13.yzw = float3(0,0,0);
  }
    ...
    if (r10.w != 0) {
      ...
      if (r10.w != 0) {
        ...
        if (r10.w != 0) {
          ...
          r20.yzw = r11.xyz * r10.www + r5.xyz;
        ...
        r10.w = cmp(0 < r6.w);
        if (r10.w != 0) {
          r10.w = lightConstantsCB[r0.x].data[1].z * r1.z;
          r10.w = 0.25 * r10.w;
          r12.w = dot(r18.xyz, r15.xyz);
          r15.x = dot(r15.xyz, r19.xyz);
          r15.y = -r12.w * r12.w + lightConstantsCB[r0.x].data[6].y;
          r3.w = r12.w * r15.x + -r3.w;
          r3.w = saturate(r3.w / r15.y);
          r12.w = r15.y / lightConstantsCB[r0.x].data[6].y;
          r12.w = 10 * r12.w;
          r12.w = min(1, r12.w);
          r3.w = r3.w + -r4.z;
          ...
          if (r4.z != 0) {
            ...
            if (r15.w == 0) {
              ...
              if (r16.w == 0) {
                ...
                r17.w = lightConstantsCB[r3.w].data[10].z * r12.w;
            ...
            if (r12.w == 0) {
              ...
              if (enableDitheredShadow != 0) {
                ...
                while (true) {
                  ...
                  r17.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r20.xyz, r4.z).x;
                  r15.w = r17.w * 0.125 + r15.w;
                  r16.w = (int)r16.w + 1;
                }
              } else {
                r19.z = (uint)r12.w;
                r15.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r19.xyz, r4.z).x;
              }
              r3.w = r15.w * r15.w;
              r3.w = r3.w * r15.w;
            } else {
      ...
      if (r5.w != 0) {
          ...
          if (r10.w != 0) {
            ...
            if (enableDitheredShadow != 0) {
              ...
              while (true) {
                ...
                r12.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r20.xyz, r5.w).x;
                r10.w = r12.w * 0.125 + r10.w;
                r11.w = (int)r11.w + 1;
              }
            } else {
              r19.z = (uint)r8.w;
              r10.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r19.xyz, r5.w).x;
            }
            r5.w = r10.w * r10.w;
            r5.w = r5.w * r10.w;
          } else {
        ...
        if (r7.w != 0) {
          ...
          if (r10.w != 0) {
            ...
            r18.xyz = r11.xyz * r10.www + r5.xyz;
            ...
            if (r12.w == 0) {
              ...
              if (r15.w == 0) {
                ...
                r16.w = lightConstantsCB[r8.w].data[10].z * r11.w;
            ...
            if (r3.x != 0) {
              ...
              if (r10.w == 0) {
                ...
                if (r11.w == 0) {
                  ...
                  r19.x = r18.x * lightConstantsCB[r0.x].data[8].y + lightConstantsCB[r0.x].data[8].z;
                  r19.y = r18.y * lightConstantsCB[r0.x].data[8].w + lightConstantsCB[r0.x].data[9].x;
                  r12.w = lightConstantsCB[r0.x].data[10].z * r8.w;
