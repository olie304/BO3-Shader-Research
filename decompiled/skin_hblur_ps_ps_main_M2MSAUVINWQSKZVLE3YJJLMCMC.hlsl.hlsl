  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r2.xzw = float3(0.0715152994,0.231067002,0.798469007) * r1.xyz;
  r0.x = cmp(0 < r0.z);
  r4.xy = float2(-0.178540006,0.178541005) * r0.yy;
  r4.z = 0;
  ...
  r6.xyzw = r3.zwzw * float4(-0.0690418035,-0.0690418035,-0.0210682992,-0.0210682992) + v1.xyxy;
  ...
  if (r0.x != 0) {
    ...
    r0.x = exp2(r0.x);
    r11.xyz = float3(0.174447,0.0479632989,8.1458802e-07) * r0.xxx;
    r11.xyz = r11.xyz * r5.xyz + r2.xzw;
    r12.xyz = r0.xxx * float3(0.174447,0.0479632989,8.1458802e-07) + float3(0.0715152994,0.231067002,0.798469007);
    ...
    r0.x = sssParams.w * r0.x;
    r0.x = exp2(r0.x);
    r13.xyz = float3(0.178063005,0.0941203013,0.0072812601) * r0.xxx;
    r11.xyz = r13.xyz * r7.xyz + r11.xyz;
    r12.xyz = r0.xxx * float3(0.178063005,0.0941203013,0.0072812601) + r12.xyz;
    ...
    r0.x = sssParams.w * r0.x;
    r0.x = exp2(r0.x);
    r13.xyz = float3(0.111732997,0.242384002,0.0934842005) * r0.xxx;
    r11.xyz = r13.xyz * r8.xyz + r11.xyz;
    r12.xyz = r0.xxx * float3(0.111732997,0.242384002,0.0934842005) + r12.xyz;
    ...
    r0.x = sssParams.w * r0.x;
    r0.x = exp2(r0.x);
    r13.xyz = float3(0.111732997,0.242383003,0.0934825018) * r0.xxx;
    r11.xyz = r13.xyz * r6.yzw + r11.xyz;
    r12.xyz = r0.xxx * float3(0.111732997,0.242383003,0.0934825018) + r12.xyz;
    ...
    r0.x = sssParams.w * r0.x;
    r0.x = exp2(r0.x);
    r13.xyz = float3(0.178063005,0.094119899,0.0072811502) * r0.xxx;
    r11.xyz = r13.xyz * r9.xyz + r11.xyz;
    r12.xyz = r0.xxx * float3(0.178063005,0.094119899,0.0072811502) + r12.xyz;
    ...
    r0.x = sssParams.w * r0.x;
    r0.x = exp2(r0.x);
    r4.yzw = float3(0.174446002,0.0479629003,8.14475015e-07) * r0.xxx;
    r4.yzw = r4.yzw * r10.xyz + r11.xyz;
    r0.xzw = r0.xxx * float3(0.174446002,0.0479629003,8.14475015e-07) + r12.xyz;
  } else {
    ...
    r0.y = exp2(r0.y);
    r11.xyz = float3(0.174447,0.0479632989,8.1458802e-07) * r0.yyy;
    r2.xzw = r11.xyz * r5.xyz + r2.xzw;
    r5.xyz = r0.yyy * float3(0.174447,0.0479632989,8.1458802e-07) + float3(0.0715152994,0.231067002,0.798469007);
    ...
    r0.y = sssParams.w * r0.y;
    r0.y = exp2(r0.y);
    r11.xyz = float3(0.178063005,0.0941203013,0.0072812601) * r0.yyy;
    r2.xzw = r11.xyz * r7.xyz + r2.xzw;
    r5.xyz = r0.yyy * float3(0.178063005,0.0941203013,0.0072812601) + r5.xyz;
    ...
    r0.y = sssParams.w * r0.y;
    r0.y = exp2(r0.y);
    r7.xyz = float3(0.111732997,0.242384002,0.0934842005) * r0.yyy;
    r2.xzw = r7.xyz * r8.xyz + r2.xzw;
    r5.xyz = r0.yyy * float3(0.111732997,0.242384002,0.0934842005) + r5.xyz;
    ...
    r0.y = sssParams.w * r0.y;
    r0.y = exp2(r0.y);
    r7.xyz = float3(0.111732997,0.242383003,0.0934825018) * r0.yyy;
    r2.xzw = r7.xyz * r6.yzw + r2.xzw;
    r5.xyz = r0.yyy * float3(0.111732997,0.242383003,0.0934825018) + r5.xyz;
    ...
    r0.y = sssParams.w * r0.y;
    r0.y = exp2(r0.y);
    r3.xyz = float3(0.178063005,0.094119899,0.0072811502) * r0.yyy;
    r2.xzw = r3.xyz * r9.xyz + r2.xzw;
    r3.xyz = r0.yyy * float3(0.178063005,0.094119899,0.0072811502) + r5.xyz;
    ...
    r0.y = sssParams.w * r0.y;
    r0.y = exp2(r0.y);
    r5.xyz = float3(0.174446002,0.0479629003,8.14475015e-07) * r0.yyy;
    r4.yzw = r5.xyz * r10.xyz + r2.xzw;
    r0.xzw = r0.yyy * float3(0.174446002,0.0479629003,8.14475015e-07) + r3.xyz;
  }
