...
if_nz r0.z
  ...
  mad r2.xy, -r4.zyzz, r2.wzww, r2.xyxx
  gather4_indexable(texture2d)(float,float,float,float) r3.xyzw, r2.yxyy, t7.xyzw, s0.x
  mad r2.xy, r2.xyxx, cb1[44].yxyy, l(-0.49804688, -0.49804688, 0.000000, 0.000000)
  ftoi r4.xy, r2.yxyy
  iadd r5.xy, r4.yxyy, l(1, 1, 0, 0)
  mov r4.z, r5.x
  mov r4.w, l(0)
  ld_indexable(texture2d)(float,float,float,float) r1.w, r4.xzww, t2.yzwx
  mov r5.z, l(0)
  ld_indexable(texture2d)(float,float,float,float) r4.z, r5.yxzz, t2.yzxw
  mov r5.w, r4.y
  ld_indexable(texture2d)(float,float,float,float) r5.x, r5.ywzz, t2.xyzw
  ld_indexable(texture2d)(float,float,float,float) r4.x, r4.xyww, t2.xyzw
