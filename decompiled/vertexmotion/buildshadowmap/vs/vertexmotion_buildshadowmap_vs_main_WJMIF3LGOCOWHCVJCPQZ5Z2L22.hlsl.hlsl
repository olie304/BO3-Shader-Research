...
r1.w = gpuSkinBase[]..swiz;
  ...
  if (r0.y != 0) {
    ...
    r3.w = gpuSkinBase[]..swiz;
      ...
      r0.z = r0.z + r3.w;
      r2.yz = v3.xx * r0.wz;
      r0.z = cmp(v3.y != 0.000000);
      if (r0.z != 0) {
        r0.z = (int)r0.y + (int)v4.y;
      // Known bad code for instruction (needs manual fix):
      ...
      r3.w = gpuSkinBase[]..swiz;
        ...
        r0.z = r0.z + r3.w;
        r2.z = r0.z * v3.y + r2.z;
        r0.z = cmp(v3.z != 0.000000);
        if (r0.z != 0) {
          r0.z = (int)r0.y + (int)v4.z;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r3.xyzw, r0.z, l(0), t5.xyzw
        r3.x = gpuSkinBase[]..swiz;
        r3.y = gpuSkinBase[]..swiz;
        ...
        r3.w = gpuSkinBase[]..swiz;
          ...
          r0.z = r0.z + r3.w;
          r2.z = r0.z * v3.z + r2.z;
          r0.z = cmp(v3.w != 0.000000);
          if (r0.z != 0) {
            r0.y = (int)r0.y + (int)v4.w;
          // Known bad code for instruction (needs manual fix):
    ...
    if (r0.y != 0) {
      ...
      if (r0.y != 0) {
        ...
        if (r0.y != 0) {
          ...
          r2.xyz = r0.yzw * v3.www + r2.xyz;
        }
      }
    }
  }
  r0.yz = vertexColorScale.xy * v1.xy;
// Known bad code for instruction (needs manual fix):
...
r0.x = gpuSkinBase[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r1.y, v5.x, l(12), t4.xxxx
r1.y = gpuSkinBase[]..swiz;
...
r5.w = gpuSkinBase[]..swiz;
  ...
  r6.xyz = r5.xyz;
  r3.z = dot(r2.xyzw, r6.xyzw);
  r1.yzw = eyeOffset.xyz + r3.xyz;
  r0.w = weather.windSpeed * gameTime.w;
  r2.w = 0.899999976 * r0.w;
  r3.x = gameTime.w * weather.windSpeed + 0.5;
  r3.y = 0.699999988 * r3.x;
  r0.w = r0.w * 0.899999976 + r1.y;
  r0.w = 0.699999988 * r0.w;
  r0.w = sin(r0.w);
  r3.x = r3.x * 0.699999988 + r1.y;
  r3.x = 0.699999988 * r3.x;
  r3.x = cos(r3.x);
  r3.z = 0.00999999978 * r2.z;
  ...
  r0.w = r0.w * r3.z;
  r5.z = r0.w * r0.z;
  r3.xzw = float3(0.109999999,0.129999995,0.0900000036) * r5.xyz;
  r0.z = r1.x * 0.100000001 + r2.w;
  r0.z = 0.0700000003 * r0.z;
  r0.z = sin(r0.z);
  r0.z = r0.z * 0.5 + 0.5;
  r0.x = r0.x * 0.100000001 + r3.y;
  ...
  r0.x = r0.z * r0.x;
  r0.x = r0.x * r0.y;
  r3.z = r0.x * 0.00999999978 + r3.z;
  r0.xyz = r3.xzw + r1.yzw;
