...
r0.z = modelInstanceBuffer[]..swiz;
  if (r0.z != 0) {
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r2.x, r0.z, l(12), t5.xxxx
  r2.x = modelInstanceBuffer[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r2.y, r0.z, l(28), t5.xxxx
  r2.y = modelInstanceBuffer[]..swiz;
  // Known bad code for instruction (needs manual fix):
  ...
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r5.xyzw, r0.z, l(32), t5.xywz
  ...
  r1.w = r1.w * r2.w;
  r5.z = r1.w * r0.y;
  r4.xyz = float3(0.109999999,0.129999995,0.0900000036) * r5.xyz;
