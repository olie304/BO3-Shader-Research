...
//   float2 vertexColorScale;           // Offset:  184 Size:     8
//
// }
//
...
if_nz r0.x
  ...
  if_nz r0.y
    ...
    if_nz r0.y
      ...
      dp3 r0.z, r2.xyzx, v0.xyzx
      add r0.z, r2.w, r0.z
      mad r1.x, r0.z, v3.y, r1.x
      ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r2.xyzw, r0.y, l(16), t5.xyzw
      dp3 r0.z, r2.xyzx, v0.xyzx
      add r0.z, r2.w, r0.z
      mad r1.y, r0.z, v3.y, r1.y
      ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r2.xyzw, r0.y, l(32), t5.xyzw
      dp3 r0.y, r2.xyzx, v0.xyzx
      add r0.y, r2.w, r0.y
      mad r1.z, r0.y, v3.y, r1.z
      ...
      if_nz r0.y
        ...
        dp3 r0.z, r2.xyzx, v0.xyzx
        add r0.z, r2.w, r0.z
        mad r1.x, r0.z, v3.z, r1.x
        ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r2.xyzw, r0.y, l(16), t5.xyzw
        dp3 r0.z, r2.xyzx, v0.xyzx
        add r0.z, r2.w, r0.z
        mad r1.y, r0.z, v3.z, r1.y
        ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r2.xyzw, r0.y, l(32), t5.xyzw
        dp3 r0.y, r2.xyzx, v0.xyzx
        add r0.y, r2.w, r0.y
        mad r1.z, r0.y, v3.z, r1.z
...
mov r6.w, r5.z
dp4 r3.z, r1.xyzw, r6.xyzw
add r3.xyz, r3.xyzx, cb1[24].xyzx
mul r0.z, cb1[69].w, cb2[38].y
mad r0.w, cb1[69].w, cb2[38].y, l(0.500000)
mad r1.w, r0.z, l(0.900000), r3.x
mul r1.w, r1.w, l(0.700000)
sincos r1.w, null, r1.w
mad r2.z, r0.w, l(0.700000), r3.x
mul r2.xyz, r2.xyzx, l(0.100000, 0.100000, 0.700000, 0.000000)
sincos null, r2.z, r2.z
mul r2.w, r1.z, l(0.010000)
...
mul r1.w, r2.w, r1.w
mul r5.z, r0.y, r1.w
mul r4.xyz, r5.xyzx, l(0.110000, 0.130000, 0.090000, 0.000000)
mad r0.y, r0.z, l(0.900000), r2.x
mul r0.y, r0.y, l(0.070000)
sincos r0.y, null, r0.y
mad r0.y, r0.y, l(0.500000), l(0.500000)
mad r0.z, r0.w, l(0.700000), r2.y
...
sqrt r0.z, r0.z
mul r0.z, r0.z, cb2[38].y
mul r0.z, r0.z, cb2[38].z
mul r0.z, r0.y, r0.z
mul r0.z, r0.x, r0.z
mad r4.x, r0.z, l(0.010000), r4.x
dp2 r0.z, r1.yzyy, r1.yzyy
sqrt r0.z, r0.z
mul r0.z, r0.z, cb2[38].y
mul r0.z, r0.z, cb2[38].w
mul r0.y, r0.y, r0.z
mul r0.x, r0.x, r0.y
mad r4.y, r0.x, l(0.010000), r4.y
