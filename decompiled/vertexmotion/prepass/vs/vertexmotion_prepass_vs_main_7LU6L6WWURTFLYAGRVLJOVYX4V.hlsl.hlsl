...
r3.w = gpuSkinBase[]..swiz;
  ...
  if (r0.w != 0) {
    ...
    r6.x = dot(r1.xyz, r10.xyz);
    r6.y = dot(r1.xzy, r12.xzw);
    r6.z = dot(r1.xyz, r11.xyz);
...
r4.w = gpuSkinBase[]..swiz;
  ...
  r3.w = r6.y;
  r0.z = dot(r5.xyzw, r3.xyzw);
  r6.xyz = r4.xyz;
  r0.w = dot(r5.xyzw, r6.xyzw);
