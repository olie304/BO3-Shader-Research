...
if_nz r0.w
  ...
  if_nz r0.w
    ...
    if_nz r1.w
      ...
      dp3 r2.z, r6.xyzx, r0.xyzx
      add r2.z, r6.w, r2.z
      mad r5.x, r2.z, v4.y, r5.x
      dp3 r2.z, r6.xyzx, r1.xyzx
      mad r4.x, r2.z, v4.y, r4.x
      ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r6.xyzw, r1.w, l(16), t5.xyzw
      dp3 r2.z, r6.xyzx, r0.xyzx
      add r2.z, r6.w, r2.z
      mad r5.y, r2.z, v4.y, r5.y
      dp3 r2.z, r6.xyzx, r1.xyzx
      mad r4.y, r2.z, v4.y, r4.y
      ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r6.xyzw, r1.w, l(32), t5.xyzw
      dp3 r1.w, r6.xyzx, r0.xyzx
      add r1.w, r6.w, r1.w
      ...
      if_nz r1.w
        ...
        dp3 r2.z, r6.xyzx, r0.xyzx
        add r2.z, r6.w, r2.z
        mad r5.x, r2.z, v4.z, r5.x
        dp3 r2.z, r6.xyzx, r1.xyzx
        mad r4.x, r2.z, v4.z, r4.x
        ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r6.xyzw, r1.w, l(16), t5.xyzw
        dp3 r2.z, r6.xyzx, r0.xyzx
        add r2.z, r6.w, r2.z
        mad r5.y, r2.z, v4.z, r5.y
        dp3 r2.z, r6.xyzx, r1.xyzx
        mad r4.y, r2.z, v4.z, r4.y
        ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r6.xyzw, r1.w, l(32), t5.xyzw
        dp3 r1.w, r6.xyzx, r0.xyzx
        add r1.w, r6.w, r1.w
  ...
  mul r5.xyz, r3.xywx, v4.xxxx
  mul r3.xyw, r6.xyxz, v4.xxxx
  ...
  if_nz r0.w
    ...
    mul r0.w, r6.w, r9.y
    mul r2.zw, r6.wwwz, r9.zzzz
    mad r1.w, r6.y, r9.y, r2.w
    add r12.x, -r1.w, l(1.000000)
    mad r13.x, r6.z, r9.x, -r0.w
    mad r12.y, r6.y, r9.x, -r2.z
    mad r14.xy, r6.yxyy, r9.xxxx, r2.zwzz
    ...
    dp3 r6.x, r1.xyzx, r12.xyzx
    dp3 r6.y, r1.xzyx, r14.xzwx
    dp3 r6.z, r1.xyzx, r13.xyzx
    add r8.xyz, r10.xyzx, r9.xyzx
    add r7.xyz, r7.xyzx, r8.xyzx
    mad r5.xyz, r7.xyzx, v4.yyyy, r5.xyzx
    mad r3.xyw, r6.xyxz, v4.yyyy, r3.xyxw
    ...
    if_nz r0.w
      ...
      add r8.xyz, r10.xyzx, r9.xyzx
      add r7.xyz, r7.xyzx, r8.xyzx
      mad r5.xyz, r7.xyzx, v4.zzzz, r5.xyzx
      mad r3.xyw, r6.xyxz, v4.zzzz, r3.xyxw
      ...
      if_nz r0.w
        ...
        mad r1.w, r6.y, r9.y, r2.w
        add r11.x, -r1.w, l(1.000000)
        mad r12.x, r6.z, r9.x, -r0.w
        mad r11.y, r6.y, r9.x, -r2.z
        mad r13.xy, r6.yxyy, r9.xxxx, r2.zwzz
        ...
        mad r5.xyz, r4.xyzx, v4.wwww, r5.xyzx
        mad r3.xyw, r6.xyxz, v4.wwww, r3.xyxw
      endif 
    endif 
  endif 
  dp3 r0.w, r3.xywx, r3.xywx
  rsq r0.w, r0.w
  mul r1.xyz, r0.wwww, r3.xywx
endif 
...
if_nz r1.x
  ...
  movc r3.xyzw, r1.xxxx, r3.xyzw, l(0,0,0,0)
  ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r4.xyzw, r1.y, l(48), t8.xyzw
  movc r1.xyzw, r1.yyyy, r4.xyzw, r3.xyzw
  ne r2.x, l(0.000000, 0.000000, 0.000000, 0.000000), r1.w
  if_nz r2.x
    ftou r1.w, r1.w
    if_nz r1.w
      iadd r2.x, r1.w, v5.x
      ...
      if_nz r2.x
        ...
        dp3 r2.z, r4.xyzx, r0.xyzx
        add r2.z, r4.w, r2.z
        mad r3.x, r2.z, v4.y, r3.x
        ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r4.xyzw, r2.x, l(16), t8.xyzw
        dp3 r2.z, r4.xyzx, r0.xyzx
        add r2.z, r4.w, r2.z
        mad r3.y, r2.z, v4.y, r3.y
        ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r4.xyzw, r2.x, l(32), t8.xyzw
        dp3 r2.x, r4.xyzx, r0.xyzx
        add r2.x, r4.w, r2.x
        ...
        if_nz r2.x
          ...
          dp3 r2.z, r4.xyzx, r0.xyzx
          add r2.z, r4.w, r2.z
          mad r3.x, r2.z, v4.z, r3.x
          ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r4.xyzw, r2.x, l(16), t8.xyzw
          dp3 r2.z, r4.xyzx, r0.xyzx
          add r2.z, r4.w, r2.z
          mad r3.y, r2.z, v4.z, r3.y
          ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r4.xyzw, r2.x, l(32), t8.xyzw
          dp3 r2.x, r4.xyzx, r0.xyzx
          add r2.x, r4.w, r2.x
    ...
    ld_indexable(texture2d)(float,float,float,float) r1.xyw, r4.xyzz, t3.xywz
    ld_indexable(texture2d)(float,float,float,float) r2.xzw, r4.xwzz, t3.xwyz
    ...
    mad r1.xyw, r1.zzzz, r2.xzxw, r1.xyxw
    add r2.xzw, r0.xxyz, -r7.xxyz
    ...
    mul r6.w, r5.w, r6.y
    mul r9.xy, r5.wzww, r6.zzzz
    mad r6.z, r5.y, r6.y, r9.y
    add r10.x, -r6.z, l(1.000000)
    mad r11.x, r5.z, r6.x, -r6.w
    mad r10.y, r5.y, r6.x, -r9.x
    mad r9.xy, r5.yxyy, r6.xxxx, r9.xyxx
    mad r9.z, r5.z, r6.y, -r8.z
    mad r5.xyz, r5.zwyz, r6.yyyy, r8.zyxz
    mov r10.z, r5.y
    dp3 r6.x, r2.xzwx, r10.xyzx
    add r9.w, -r9.y, l(1.000000)
    dp3 r6.y, r2.xwzx, r9.xzwx
    mad r11.yz, r5.xxzx, l(0.000000, 1.000000, -1.000000, 0.000000), l(0.000000, 0.000000, 1.000000, 0.000000)
    dp3 r6.z, r2.xzwx, r11.xyzx
    add r2.xzw, r7.xxyz, r6.xxyz
    add r1.xyw, r1.xyxw, r2.xzxw
    mul r3.xyz, r1.xywx, v4.xxxx
    ...
    if_nz r1.x
      ...
      add r2.xzw, r7.xxyz, r6.xxyz
      add r1.xyw, r1.xyxw, r2.xzxw
      mad r3.xyz, r1.xywx, v4.yyyy, r3.xyzx
      ...
      if_nz r1.x
        ...
        add r2.xzw, r7.xxyz, r6.xxyz
        add r1.xyw, r1.xyxw, r2.xzxw
        mad r3.xyz, r1.xywx, v4.zzzz, r3.xyzx
        ...
        if_nz r1.x
          ...
          mad r5.xyzw, r1.zzzz, r6.xyzw, r5.xyzw
          add r2.xzw, -r1.xxyw, r2.xxzw
          mad r1.xyz, r1.zzzz, r2.xzwx, r1.xywx
          add r2.xzw, r0.xxyz, -r4.xxyz
  ...
  movc r1.xyzw, r1.xxxx, r4.xyzw, l(0,0,0,0)
  ne r2.x, l(0.000000, 0.000000, 0.000000, 0.000000), r1.w
  if_nz r2.x
    ftou r1.w, r1.w
    if_nz r1.w
    ...
    if_nz r1.x
      ...
      if_nz r1.x
        ...
        if_nz r1.x
          ...
          rsq r1.w, r1.w
          mul r5.xyzw, r1.wwww, r5.xyzw
          add r2.xzw, r5.xxyz, r5.xxyz
          mul r6.xyz, r2.xxxx, r5.xzwx
          mul r1.w, r2.z, r5.w
          mul r7.xy, r2.wwww, r5.wzww
          mad r2.w, r5.y, r2.z, r7.y
          add r8.x, -r2.w, l(1.000000)
          mad r9.x, r5.z, r2.x, -r1.w
          mad r8.y, r5.y, r2.x, -r7.x
          mad r7.xy, r5.yxyy, r2.xxxx, r7.xyxx
          mad r7.z, r5.z, r2.z, -r6.z
          mad r2.xzw, r5.zzwy, r2.zzzz, r6.zzyx
          mov r8.z, r2.z
          dp3 r5.x, r0.xyzx, r8.xyzx
          add r7.w, -r7.y, l(1.000000)
          dp3 r5.y, r0.xzyx, r7.xzwx
          mad r9.yz, r2.xxwx, l(0.000000, 1.000000, -1.000000, 0.000000), l(0.000000, 0.000000, 1.000000, 0.000000)
          dp3 r5.z, r0.xyzx, r9.xyzx
