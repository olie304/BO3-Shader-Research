...
mov r4.w, r1.z
mov r0.w, l(1.000000)
dp4 r1.z, r0.xyzw, r4.xyzw
mul r3.xyzw, r1.zzzz, cb1[9].xyzw
mov r2.w, r1.y
mov r5.w, r1.w
dp4 r1.y, r0.xyzw, r5.xyzw
dp4 r1.z, r0.xyzw, r2.xyzw
mad r2.xyzw, r1.zzzz, cb1[8].xyzw, r3.xyzw
...
mov r2.x, r4.w
mov r2.z, r1.w
add r2.xyz, r2.xyzx, -cb7[12].xyzx
mov r3.w, r2.y
dp4 r2.y, r0.xyzw, r3.xyzw
mul r3.xyzw, r2.yyyy, cb7[1].xyzw
mov r4.w, r2.x
mov r1.w, r2.z
dp4 r1.x, r0.xyzw, r1.xyzw
dp4 r0.x, r0.xyzw, r4.xyzw
mad r0.xyzw, r0.xxxx, cb7[0].xyzw, r3.xyzw
mad r0.xyzw, r1.xxxx, cb7[2].xyzw, r0.xyzw
