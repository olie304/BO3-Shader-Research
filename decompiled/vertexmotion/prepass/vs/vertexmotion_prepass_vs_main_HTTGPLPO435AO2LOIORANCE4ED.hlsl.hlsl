...
r2.y = modelInstanceBuffer[]..swiz;
  ...
  r5.w = r6.y;
  r2.w = dot(r4.xyzw, r5.xyzw);
  r7.w = r6.z;
  r3.x = dot(r4.xyzw, r7.xyzw);
  r4.xyzw = viewProjectionMatrix._m10_m11_m12_m13 * r2.wwww;
  r4.xyzw = r2.zzzz * viewProjectionMatrix._m00_m01_m02_m03 + r4.xyzw;
  r3.xyzw = r3.xxxx * viewProjectionMatrix._m20_m21_m22_m23 + r4.xyzw;
  ...
  o3.z = dot(r1.xyz, r2.yzw);
  r1.x = (int)r2.x & 0x0fffffff;
  if (r1.x != 0) {
    if (r1.x != 0) {
      r1.y = cmp(v4.x != 0.000000);
      if (r1.y != 0) {
        r1.y = (int)r1.x + (int)v5.x;
      // Known bad code for instruction (needs manual fix):
...
r1.y = modelInstanceBuffer[]..swiz;
  ...
  r1.xyzw = r1.xxxx * motionVectorConstants.prevFrameOffToClpMatrixFull._m00_m01_m02_m03 + r2.xyzw;
