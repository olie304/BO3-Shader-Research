...
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r1.xy, v4.x, l(8), t4.xyxx
...
r5.w = modelInstanceBuffer[]..swiz;
  ...
  r2.w = r1.y;
  r5.w = r1.w;
  r1.y = dot(r0.xyzw, r5.xyzw);
  r1.z = dot(r0.xyzw, r2.xyzw);
  r2.xyzw = r1.zzzz * viewProjectionMatrix._m00_m01_m02_m03 + r3.xyzw;
  r2.xyzw = r1.yyyy * viewProjectionMatrix._m20_m21_m22_m23 + r2.xyzw;
  o0.xyzw = viewProjectionMatrix._m30_m31_m32_m33 + r2.xyzw;
  o1.x = 1;
  o2.xy = v2.xy;
  r1.yzw = v3.xyz * float3(2.00195694,2.00195694,2.00195694) + float3(-1.00195694,-1.00195694,-1.00195694);
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r2.x, v4.x, l(12), t4.xxxx
r2.x = modelInstanceBuffer[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r2.yzw, r2.x, l(0), t5.xxyz
r2.y = modelInstanceBuffer[]..swiz;
r2.z = modelInstanceBuffer[]..swiz;
r2.w = modelInstanceBuffer[]..swiz;
  o3.x = dot(r1.yzw, r2.yzw);
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r2.yzw, r2.x, l(16), t5.xxyz
r2.y = modelInstanceBuffer[]..swiz;
r2.z = modelInstanceBuffer[]..swiz;
r2.w = modelInstanceBuffer[]..swiz;
  o3.y = dot(r1.yzw, r2.yzw);
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r2.yzw, r2.x, l(32), t5.xxyz
r2.y = modelInstanceBuffer[]..swiz;
r2.z = modelInstanceBuffer[]..swiz;
r2.w = modelInstanceBuffer[]..swiz;
  o3.z = dot(r1.yzw, r2.yzw);
  r1.y = cmp((int)r2.x != 0);
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r1.z, v4.x, l(0), t4.xxxx
r1.z = modelInstanceBuffer[]..swiz;
  ...
  r1.x = r1.y ? r1.x : r2.x;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r2.xyzw, r1.x, l(16), t8.xwyz
r2.x = modelInstanceBuffer[]..swiz;
r2.y = modelInstanceBuffer[]..swiz;
r2.z = modelInstanceBuffer[]..swiz;
r2.w = modelInstanceBuffer[]..swiz;
  r3.xyz = r2.xzw;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r4.xyzw, r1.x, l(0), t8.xyzw
r4.x = modelInstanceBuffer[]..swiz;
r4.y = modelInstanceBuffer[]..swiz;
r4.z = modelInstanceBuffer[]..swiz;
r4.w = modelInstanceBuffer[]..swiz;
...
r1.w = modelInstanceBuffer[]..swiz;
  r2.x = r4.w;
  r2.z = r1.w;
  r2.xyz = -motionVectorConstants.prevFrameEyeOffset.xyz + r2.xyz;
  r3.w = r2.y;
  r2.y = dot(r0.xyzw, r3.xyzw);
  r3.xyzw = motionVectorConstants.prevFrameOffToClpMatrixFull._m10_m11_m12_m13 * r2.yyyy;
  r4.w = r2.x;
  r1.w = r2.z;
  r1.x = dot(r0.xyzw, r1.xyzw);
  r0.x = dot(r0.xyzw, r4.xyzw);
  r0.xyzw = r0.xxxx * motionVectorConstants.prevFrameOffToClpMatrixFull._m00_m01_m02_m03 + r3.xyzw;
  r0.xyzw = r1.xxxx * motionVectorConstants.prevFrameOffToClpMatrixFull._m20_m21_m22_m23 + r0.xyzw;
