...
//   float2 breakUpMapTile;             // Offset:  280 Size:     8
//   float weatherThreshold;            // Offset:  288 Size:     4
//   float weatherHarshness;            // Offset:  292 Size:     4
//
// }
//
...
movc r4.xy, cb0[17].yyyy, r4.xyxx, r4.zwzz
...
mad r1.xy, r2.xwxx, cb0[13].zzzz, r0.xyxx
...
add r4.w, -cb0[18].x, l(1.000000)
max r4.w, r4.w, l(0.000100)
div_sat r3.w, r3.w, r4.w
mul r2.yz, r2.yyzy, cb0[17].zzwz
mul r11.xy, v2.xyxx, cb0[17].zwzz
movc r2.yz, cb0[17].xxxx, r2.yyzy, r11.xxyx
...
add r4.w, -cb0[16].x, cb0[16].y
mad r0.w, r0.w, r4.w, cb0[16].x
...
mad r6.w, r1.w, cb0[13].z, r0.z
mad r1.xy, r4.xyxx, cb0[13].wwww, r0.xyxx
dp3 r0.x, r1.xyzx, r1.xyzx
rsq r0.x, r0.x
mul r1.xyz, r0.xxxx, r1.xyzx
mad r1.w, r3.w, cb0[13].w, r0.z
