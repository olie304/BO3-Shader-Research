...
mad r1.x, r1.w, r1.x, cb0[11].x
add r1.y, -cb0[14].x, cb0[14].y
mad r1.y, r1.z, r1.y, cb0[14].x
mul_sat r1.xy, r1.xyxx, l(0.05882353, 0.05882353, 0.000000, 0.000000)
add r1.y, -r1.x, r1.y
mad r1.x, r0.z, r1.y, r1.x
sample_indexable(texture2d)(float,float,float,float) r6.z, r0.xyxx, t12.yzxw, s4
mad r0.xy, r7.xyxx, l(1.99218750, 1.99218750, 0.000000, 0.000000), l(-1.000000, -1.000000, 0.000000, 0.000000)
mul r1.y, r7.z, r7.z
...
mad r3.xy, r0.xyxx, cb0[12].yyyy, r2.xyxx
dp3 r0.x, r3.xyzx, r3.xyzx
rsq r0.x, r0.x
mul r2.xyz, r0.xxxx, r3.xyzx
mad r2.w, r1.y, cb0[12].y, r0.w
add r2.xyzw, -r4.xyzw, r2.xyzw
mad r0.xyzw, r0.zzzz, r2.xyzw, r4.xyzw
...
mad r0.xyz, r1.yzwy, r0.zzzz, r2.xyzx
