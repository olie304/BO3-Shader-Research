...
loop 
  ...
  if_nz r13.w
    ...
    dp3 r17.y, cb11[r15.z + 1].xyzx, r14.yzwy
    add_sat r17.y, r17.y, cb11[r15.z + 1].w
    mul r15.w, r15.w, r17.y
    dp3 r17.y, cb11[r15.z + 2].xyzx, r14.yzwy
    add_sat r17.y, r17.y, cb11[r15.z + 2].w
    mul r15.w, r15.w, r17.y
    dp3 r17.y, cb11[r15.z + 3].xyzx, r14.yzwy
    add_sat r17.y, r17.y, cb11[r15.z + 3].w
    mul r15.w, r15.w, r17.y
    dp3 r17.y, cb11[r15.z + 4].xyzx, r14.yzwy
    add_sat r17.y, r17.y, cb11[r15.z + 4].w
    mul r15.w, r15.w, r17.y
    dp3 r17.y, cb11[r15.z + 5].xyzx, r14.yzwy
    add_sat r15.z, r17.y, cb11[r15.z + 5].w
    mul r18.x, r15.z, r15.w
    and r15.z, l(1), cb10[r10.w + 6].x
    movc r15.zw, r15.zzzz, r18.xxxy, r18.zzzx
    mov r17.y, cb10[r10.w + 6].x
    mov r26.xy, r15.zwzz
    mov r17.z, l(1)
    loop 
      ige r17.w, r17.z, r15.y
      breakc_nz r17.w
      iadd r17.w, r13.w, r17.z
      imul null, r17.w, r17.w, l(6)
      dp3 r18.x, cb11[r17.w + 0].xyzx, r14.yzwy
      add_sat r18.x, r18.x, cb11[r17.w + 0].w
      mul r18.x, r18.x, r26.x
      ...
      mul r26.x, r17.w, r18.x
      ushr r18.w, r17.y, l(2)
      ubfe r19.w, l(1), l(2), r17.y
      and r21.w, r18.w, l(2)
      max r22.w, r26.x, r26.y
      mad r17.w, -r18.x, r17.w, l(1.000000)
      mul r17.w, r17.w, r26.y
      movc r20.y, r21.w, r17.w, r22.w
      movc r26.xy, r19.wwww, r26.xyxx, r20.xyxx
    ...
    if_nz r15.y
      and r15.y, r25.w, l(7)
      iadd r15.z, r15.y, l(-1)
      ult r15.z, r15.z, l(32)
      and r15.z, r2.z, r15.z
      if_nz r15.z
        imad r15.yz, r15.yyyy, l(0, 20, 20, 0), l(0, 860, 876, 0)
        ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r15.w, cb2[52].x, r15.y, u2.xxxx
        or r15.w, r15.w, l(32)
        store_structured u2.x, cb2[52].x, r15.y, r15.w
        store_structured u2.x, cb2[52].x, r15.z, r13.w
      endif 
      ...
      mad r17.yzw, r16.xxyz, r15.yyyy, r27.xxyz
      dp3 r15.z, r17.yzwy, r17.yzwy
      sqrt r15.z, r15.z
      ...
      or r17.y, r17.w, r17.y
      movc r15.yzw, r17.yyyy, l(0,1.000000,1.000000,0), r15.yyzw
...
loop 
  ...
  breakc_nz r10.w
  movc r10.w, r9.w, r0.y, r8.w
  ult r13.w, r10.w, r7.w
  if_nz r13.w
    imul null, r10.w, r10.w, l(14)
    if_nz r2.z
      and r13.w, r15.z, l(15)
      imad r13.w, r13.w, l(20), l(880)
      add r17.yzw, cb1[24].xxyz, cb10[r10.w + 0].xxyz
      store_structured u2.xyzw, cb2[52].x, r13.w, r17.xyzw
    endif 
    iadd r20.y, r15.z, l(1)
    add r17.yzw, r11.xxyz, -cb10[r10.w + 0].xxyz
    and r13.w, l(0x0000ffff), cb10[r10.w + 7].z
    ...
    loop 
      ...
      movc r20.w, r27.x, r22.w, r27.y
      movc r26.xy, r26.wwww, r26.xyxx, r20.zwzz
      iadd r21.w, r21.w, l(1)
      mov r19.w, r26.z
    endloop 
    add_sat r13.w, -r24.z, r26.y
    mul r15.w, r13.w, cb10[r10.w + 6].y
    lt r18.x, l(0.000000), r15.w
    if_nz r18.x
      and r18.x, r20.y, l(31)
      ...
      mad r15.y, r13.w, cb10[r10.w + 6].y, r15.y
      mul r13.w, r15.w, cb10[r10.w + 7].y
      mov r27.x, cb10[r10.w + 7].w
      mov r27.yz, cb10[r10.w + 8].xxyx
      dp3 r15.w, r16.xyzx, r27.xyzx
      dp3 r18.x, r17.yzwy, r27.xyzx
      add r18.x, r18.x, -cb10[r10.w + 8].z
      ...
      div r18.x, r18.w, r18.x
      min r15.w, r15.w, |r18.x|
      add r27.x, r17.y, cb10[r10.w + 3].w
      add r27.yz, r17.zzwz, cb10[r10.w + 4].xxyx
      ...
      ubfe r18.x, l(9), l(16), cb10[r10.w + 7].z
      utof r28.w, r18.x
      ...
      mad_sat r17.yzw, r31.xxyz, cb10[r10.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
      mul r31.xy, r17.yzyy, cb10[r10.w + 4].zwzz
      mul r31.z, r17.w, cb10[r10.w + 5].x
      add r17.yzw, r31.xxyz, cb10[r10.w + 5].yyzw
      dp3 r28.x, r12.xyzx, r27.xyzx
      dp3 r28.y, r12.xyzx, r29.xyzx
      dp3 r28.z, r12.xyzx, r30.xyzx
      ...
      mul r15.w, r6.w, r10.w
      mul r17.yzw, r13.wwww, r26.xxzw
...
loop 
  ...
  loop 
    ...
    if_nz r17.w
      ...
      add r39.xy, -r11.xyxx, cb9[r13.w + 3].zwzz
      add r39.z, -r11.z, cb9[r13.w + 4].x
      dp3 r20.y, r39.xyzx, r39.xyzx
      rsq r20.y, r20.y
      mul r40.xyz, r20.yyyy, r39.xyzx
      mul r20.z, r0.w, cb9[r13.w + 1].z
      mul r20.z, r20.z, l(0.250000)
      dp3 r20.w, r12.xyzx, r40.xyzx
      mov_sat r22.w, r20.w
      movc r27.w, r3.z, |r20.w|, r22.w
      ...
      if_nz r29.w
        ...
        if_nz r30.w
          ...
          add r42.xyz, -r11.xyzx, cb9[r13.w + 0].xyzx
        ...
        if_nz r22.x
          ...
          if_nz r22.y
            ...
            mad r39.xyz, r39.xyzx, r20.yyyy, r5.yzwy
            dp3 r20.y, r39.xyzx, r39.xyzx
            rsq r20.y, r20.y
            mul r39.xyz, r20.yyyy, r39.xyzx
            dp3 r20.y, r39.xyzx, r5.yzwy
            dp3 r23.x, r12.xyzx, r39.xyzx
            mad r23.y, |r23.x|, r0.w, -|r23.x|
        ...
        if_nz r21.w
          ...
          if_nz r22.y
            ...
            if_nz r16.w
              ...
              mad r39.xyz, r12.xyzx, r16.wwww, r11.xyzx
            ...
            if_nz r21.w
              ...
              movc r21.yzw, r3.zzzz, r21.yyzw, r36.xxyz
...
ret 
// Approximately 1695 instruction slots used
