  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r1.x = colorMap.SampleGrad(colorSampler_s, r1.xy, r0.x, r0.z).w;
  r2.zw = cmp(v4.xy != float2(0,1));
  if (r2.z != 0) {
    r3.xy = float2(-0.5,-0.5) + v2.zw;
    r1.zw = r3.xy * scaleUVsColor.xy + r1.zw;
    r3.x = dot(r4.yz, r1.zw);
    r3.y = dot(r4.xy, r1.zw);
    r1.zw = r2.xy * scaleUVsColor.xy + r3.xy;
    r1.zw = float2(0.5,0.5) + r1.zw;
    r1.z = colorMap.SampleGrad(colorSampler_s, r1.zw, r0.x, r0.z).w;
    r1.z = r1.z + -r1.x;
    r1.x = v4.x * r1.z + r1.x;
  }
  r1.z = v1.w + r1.x;
  r2.x = saturate(r1.z * v4.y + -v4.y);
  r2.y = 1;
  r1.y = v1.w;
  r1.xy = r2.ww ? r2.xy : r1.xy;
  r1.x = r1.x * r1.y;
  r1.yz = useOldHDRScale * v2.xy;
  r1.y = alphaMap.SampleGrad(colorSampler_s, r1.yz, r0.y, r0.w).x;
  if (r2.z != 0) {
    r1.zw = useOldHDRScale * v2.zw;
    r0.x = alphaMap.SampleGrad(colorSampler_s, r1.zw, r0.x, r0.z).x;
    r0.x = r0.x + -r1.y;
    r1.y = v4.x * r0.x + r1.y;
  }
  r0.x = r1.x * r1.y;
  ...
  if (r0.y != 0) discard;
  r0.x = saturate(-r0.x * translucentShadowOpacity + 1);
