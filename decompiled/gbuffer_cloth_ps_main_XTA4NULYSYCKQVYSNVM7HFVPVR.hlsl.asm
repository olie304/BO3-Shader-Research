...
sample_indexable(texture2d)(float,float,float,float) r5.xyzw, v1.yzyy, t16.xyzw, s5
...
rsq r2.w, r2.w
mad r1.yzw, r1.yyzw, r2.wwww, -r4.xxyz
mad r4.yzw, cb1[60].wwww, r1.yyzw, r4.xxyz
mul r1.yz, v1.yyzy, cb0[13].xxyx
sample_indexable(texture2d)(float,float,float,float) r1.yz, r1.yzyy, t18.zxyw, s7
...
movc o0.xyz, r2.wwww, r1.yzwy, r6.xyzx
