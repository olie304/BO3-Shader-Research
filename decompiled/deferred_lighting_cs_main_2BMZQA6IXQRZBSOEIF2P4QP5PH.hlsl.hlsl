...
r0.y = samplerLinear[]..swiz;
  ...
  while (true) {
    ...
    r13.w = cmp((uint)r9.w < numRefProbes);
    r10.w = r10.w ? r13.w : 0;
    if (r10.w != 0) {
      r9.w = (int)r9.w * 14;
      if (r2.z != 0) {
        ...
        r17.yzw = refProbeConstantsCB[r9.w].data[0].xyz + eyeOffset.xyz;
        GBufferDiffuseColor[viewID].r10.w = u2.xyzw;
      }
      r25.w = (int)r24.w + 1;
      r14.yzw = -refProbeConstantsCB[r9.w].data[0].xyz + r11.xyz;
      r10.w = 0x0000ffff & (int)refProbeConstantsCB[r9.w].data[7].z;
      if (6 == 0) r13.w = 0; else if (6+25 < 32) {       r13.w = (uint)refProbeConstantsCB[r9.w].data[7].z << (32-(6 + 25)); r13.w = (uint)r13.w >> (32-6);      } else r13.w = (uint)refProbeConstantsCB[r9.w].data[7].z >> 25;
      r15.y = (int)r10.w * 6;
      r15.z = dot(refProbeAttenuationConstantsCB[r15.y].data[0].xyz, r14.yzw);
      r15.z = saturate(refProbeAttenuationConstantsCB[r15.y].data[0].w + r15.z);
      r15.w = dot(refProbeAttenuationConstantsCB[r15.y].data[1].xyz, r14.yzw);
      r15.w = saturate(refProbeAttenuationConstantsCB[r15.y].data[1].w + r15.w);
      r15.z = r15.z * r15.w;
      r15.w = dot(refProbeAttenuationConstantsCB[r15.y].data[2].xyz, r14.yzw);
      r15.w = saturate(refProbeAttenuationConstantsCB[r15.y].data[2].w + r15.w);
      r15.z = r15.z * r15.w;
      r15.w = dot(refProbeAttenuationConstantsCB[r15.y].data[3].xyz, r14.yzw);
      r15.w = saturate(refProbeAttenuationConstantsCB[r15.y].data[3].w + r15.w);
      r15.z = r15.z * r15.w;
      r15.w = dot(refProbeAttenuationConstantsCB[r15.y].data[4].xyz, r14.yzw);
      r15.w = saturate(refProbeAttenuationConstantsCB[r15.y].data[4].w + r15.w);
      r15.z = r15.z * r15.w;
      r15.w = dot(refProbeAttenuationConstantsCB[r15.y].data[5].xyz, r14.yzw);
      ...
      while (true) {
        ...
        r17.w = r26.x * r17.w;
        r18.x = dot(refProbeAttenuationConstantsCB[r17.z].data[1].xyz, r14.yzw);
        r18.x = saturate(refProbeAttenuationConstantsCB[r17.z].data[1].w + r18.x);
        r17.w = r18.x * r17.w;
        r18.x = dot(refProbeAttenuationConstantsCB[r17.z].data[2].xyz, r14.yzw);
        r18.x = saturate(refProbeAttenuationConstantsCB[r17.z].data[2].w + r18.x);
        r17.w = r18.x * r17.w;
        r18.x = dot(refProbeAttenuationConstantsCB[r17.z].data[3].xyz, r14.yzw);
        r18.x = saturate(refProbeAttenuationConstantsCB[r17.z].data[3].w + r18.x);
        r17.w = r18.x * r17.w;
        r18.x = dot(refProbeAttenuationConstantsCB[r17.z].data[4].xyz, r14.yzw);
        r18.x = saturate(refProbeAttenuationConstantsCB[r17.z].data[4].w + r18.x);
        r17.w = r18.x * r17.w;
        r18.x = dot(refProbeAttenuationConstantsCB[r17.z].data[5].xyz, r14.yzw);
        ...
        r19.w = (int)r18.x & 2;
        r21.w = max(r26.y, r26.x);
        r17.z = -r17.w * r17.z + 1;
        r17.z = r26.y * r17.z;
        r20.y = r19.w ? r17.z : r21.w;
        r26.xy = r18.ww ? r26.xy : r20.xy;
        r17.y = (int)r17.y + 1;
        r15.w = r18.x;
      }
      r26.y = saturate(r26.y);
      r10.w = refProbeConstantsCB[r9.w].data[6].y * r26.y;
      r13.w = cmp(0 < r10.w);
      if (r13.w != 0) {
        r13.w = (int)r25.w & 7;
        r15.y = (int)r13.w + -1;
        ...
        r15.y = r2.z ? r15.y : 0;
        if (r15.y != 0) {
          r15.yz = mad((int2)r13.ww, int2(20,20), int2(860,876));
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r13.w, cb2[52].x, r15.y, u2.xxxx
        ...
        r24.w = (int)r24.w + 257;
        r24.z = r26.y * refProbeConstantsCB[r9.w].data[6].y + r24.z;
        ...
        r15.y = r15.z / r15.y;
        r13.w = min(abs(r15.y), r13.w);
        r27.x = refProbeConstantsCB[r9.w].data[3].w + r14.y;
        r27.yz = refProbeConstantsCB[r9.w].data[4].xy + r14.zw;
        r15.yzw = r16.xyz * r13.www + r27.xyz;
        r17.y = dot(r15.yzw, r15.yzw);
        r17.y = sqrt(r17.y);
        r13.w = r13.w / r17.y;
        r13.w = r13.w + r13.w;
        r13.w = sqrt(r13.w);
        ...
        r28.w = (uint)r15.y;
        r15.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r28.xyzw, r13.w).xyz;
        ...
        r14.yzw = saturate(r31.xyz * refProbeConstantsCB[r9.w].data[3].xyz + float3(0.5,0.5,0.5));
        r31.xy = refProbeConstantsCB[r9.w].data[4].zw * r14.yz;
        r31.z = refProbeConstantsCB[r9.w].data[5].x * r14.w;
        r14.yzw = refProbeConstantsCB[r9.w].data[5].yzw + r31.xyz;
        ...
        r9.w = (int)r26.z | (int)r26.x;
        r9.w = (int)r26.w | (int)r9.w;
        ...
        r13.w = r9.w * r4.w;
        r14.yzw = r15.yzw * r10.www;
        r10.w = dot(r14.yzw, float3(0.212599993,0.715200007,0.0722000003));
        r9.w = r4.w * r9.w + r10.w;
        r9.w = r13.w / r9.w;
        r27.x = r23.w;
        r27.yz = r24.xy;
        r14.yzw = r14.yzw * r9.www + r27.xyz;
        r23.w = r14.y;
        r24.xy = r14.zw;
      } else {
        r25.xyz = r24.xyz;
  ...
  while (true) {
    ...
    if (r10.w != 0) {
      ...
      r20.y = (int)r15.z + 1;
      r17.yzw = -refProbeConstantsCB[r9.w].data[0].xyz + r11.xyz;
      r10.w = 0x0000ffff & (int)refProbeConstantsCB[r9.w].data[7].z;
      if (6 == 0) r13.w = 0; else if (6+25 < 32) {       r13.w = (uint)refProbeConstantsCB[r9.w].data[7].z << (32-(6 + 25)); r13.w = (uint)r13.w >> (32-6);      } else r13.w = (uint)refProbeConstantsCB[r9.w].data[7].z >> 25;
      r15.w = (int)r10.w * 6;
      r18.w = dot(refProbeAttenuationConstantsCB[r15.w].data[0].xyz, r17.yzw);
      r18.w = saturate(refProbeAttenuationConstantsCB[r15.w].data[0].w + r18.w);
      r19.w = dot(refProbeAttenuationConstantsCB[r15.w].data[1].xyz, r17.yzw);
      r19.w = saturate(refProbeAttenuationConstantsCB[r15.w].data[1].w + r19.w);
      r18.w = r19.w * r18.w;
      r19.w = dot(refProbeAttenuationConstantsCB[r15.w].data[2].xyz, r17.yzw);
      r19.w = saturate(refProbeAttenuationConstantsCB[r15.w].data[2].w + r19.w);
      r18.w = r19.w * r18.w;
      r19.w = dot(refProbeAttenuationConstantsCB[r15.w].data[3].xyz, r17.yzw);
      r19.w = saturate(refProbeAttenuationConstantsCB[r15.w].data[3].w + r19.w);
      r18.w = r19.w * r18.w;
      r19.w = dot(refProbeAttenuationConstantsCB[r15.w].data[4].xyz, r17.yzw);
      r19.w = saturate(refProbeAttenuationConstantsCB[r15.w].data[4].w + r19.w);
      r18.w = r19.w * r18.w;
      r19.w = dot(refProbeAttenuationConstantsCB[r15.w].data[5].xyz, r17.yzw);
      r15.w = saturate(refProbeAttenuationConstantsCB[r15.w].data[5].w + r19.w);
      r18.x = r18.w * r15.w;
      r15.w = 1 & (int)refProbeConstantsCB[r9.w].data[6].x;
      r18.xw = r15.ww ? r18.xy : r18.zx;
      r15.w = refProbeConstantsCB[r9.w].data[6].x;
      r26.xy = r18.xw;
      r19.w = 1;
      while (true) {
        ...
        r21.w = -r22.w * r21.w + 1;
        r21.w = r26.y * r21.w;
        r20.w = r26.w ? r21.w : r27.x;
        r26.xy = r26.zz ? r26.xy : r20.zw;
        r19.w = (int)r19.w + 1;
        r15.w = r25.w;
      }
      r10.w = saturate(r26.y + -r24.z);
      r13.w = refProbeConstantsCB[r9.w].data[6].y * r10.w;
      r15.w = cmp(0 < r13.w);
      if (r15.w != 0) {
        r15.w = (int)r20.y & 31;
        r18.x = (int)r15.w + -1;
        ...
        r15.z = (int)r15.z + 257;
        r15.y = r10.w * refProbeConstantsCB[r9.w].data[6].y + r15.y;
        r10.w = refProbeConstantsCB[r9.w].data[7].y * r13.w;
        r27.x = refProbeConstantsCB[r9.w].data[7].w;
        r27.yz = refProbeConstantsCB[r9.w].data[8].xy;
        r13.w = dot(r16.xyz, r27.xyz);
        r15.w = dot(r17.yzw, r27.xyz);
        r15.w = -refProbeConstantsCB[r9.w].data[8].z + r15.w;
        r18.x = cmp(r15.w >= 0);
        r15.w = max(abs(r15.w), r4.z);
        r15.w = r18.x ? r15.w : -r15.w;
        r13.w = max(1.00000001e-07, -r13.w);
        r13.w = r15.w / r13.w;
        r13.w = min(131072, abs(r13.w));
        r27.x = refProbeConstantsCB[r9.w].data[8].w;
        ...
        r18.x = -refProbeConstantsCB[r9.w].data[9].z + r18.x;
        r18.w = cmp(r18.x >= 0);
        ...
        r15.w = dot(r16.xyz, r27.xyz);
        r18.x = dot(r17.yzw, r27.xyz);
        r18.x = -refProbeConstantsCB[r9.w].data[10].z + r18.x;
        r18.w = cmp(r18.x >= 0);
        r18.x = max(abs(r18.x), r4.z);
        r18.x = r18.w ? r18.x : -r18.x;
        r15.w = max(1.00000001e-07, -r15.w);
        ...
        r15.w = dot(r16.xyz, r27.xyz);
        r18.x = dot(r17.yzw, r27.xyz);
        r18.x = -refProbeConstantsCB[r9.w].data[11].z + r18.x;
        r18.w = cmp(r18.x >= 0);
        r18.x = max(abs(r18.x), r4.z);
        r18.x = r18.w ? r18.x : -r18.x;
        r15.w = max(1.00000001e-07, -r15.w);
        ...
        r15.w = dot(r16.xyz, r27.xyz);
        r18.x = dot(r17.yzw, r27.xyz);
        r18.x = -refProbeConstantsCB[r9.w].data[12].z + r18.x;
        r18.w = cmp(r18.x >= 0);
        r18.x = max(abs(r18.x), r4.z);
        r18.x = r18.w ? r18.x : -r18.x;
        r15.w = max(1.00000001e-07, -r15.w);
        ...
        r15.w = dot(r16.xyz, r27.xyz);
        r18.x = dot(r17.yzw, r27.xyz);
        r18.x = -refProbeConstantsCB[r9.w].data[13].z + r18.x;
        r18.w = cmp(r18.x >= 0);
        r18.x = max(abs(r18.x), r4.z);
        r18.x = r18.w ? r18.x : -r18.x;
        r15.w = max(1.00000001e-07, -r15.w);
        r15.w = r18.x / r15.w;
        r13.w = min(abs(r15.w), r13.w);
        r27.x = refProbeConstantsCB[r9.w].data[3].w + r17.y;
        r27.yz = refProbeConstantsCB[r9.w].data[4].xy + r17.zw;
        r26.xzw = r16.xyz * r13.www + r27.xyz;
        r15.w = dot(r26.xzw, r26.xzw);
        r15.w = sqrt(r15.w);
        r13.w = r13.w / r15.w;
        r13.w = r13.w + r13.w;
        r13.w = sqrt(r13.w);
        ...
        r28.w = (uint)r15.w;
        r26.xzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r28.xyzw, r13.w).xyz;
        r31.xyz = (int3)r26.xzw & int3(-2147483648,-2147483648,-2147483648);
        r31.xyz = cmp((int3)r31.xyz == int3(2139095040,2139095040,2139095040));
        r13.w = (int)r31.y | (int)r31.x;
        r13.w = (int)r31.z | (int)r13.w;
        r26.xzw = r13.www ? float3(1,1,0) : r26.xzw;
        r31.x = dot(r17.yzw, r27.xyz);
        r31.y = dot(r17.yzw, r29.xyz);
        r31.z = dot(r17.yzw, r30.xyz);
        r17.yzw = saturate(r31.xyz * refProbeConstantsCB[r9.w].data[3].xyz + float3(0.5,0.5,0.5));
        r31.xy = refProbeConstantsCB[r9.w].data[4].zw * r17.yz;
        r31.z = refProbeConstantsCB[r9.w].data[5].x * r17.w;
        r17.yzw = refProbeConstantsCB[r9.w].data[5].yzw + r31.xyz;
        r28.x = dot(r12.xyz, r27.xyz);
        r28.y = dot(r12.xyz, r29.xyz);
        r28.z = dot(r12.xyz, r30.xyz);
