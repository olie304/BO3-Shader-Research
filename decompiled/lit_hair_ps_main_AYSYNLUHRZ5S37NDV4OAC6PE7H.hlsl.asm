...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:36:55 2021
//
//
...
mad_sat r3.yzw, r1.xxyz, l(0.000000, 0.020000, 0.020000, 0.020000), l(0.000000, 0.040000, 0.040000, 0.040000)
...
mad r0.yzw, r0.yyzw, r6.xxyz, r2.xxyz
...
if_nz cb0[11].w
  ...
  rcp r1.y, r1.y
  div r1.w, l(1.000000, 1.000000, 1.000000, 1.000000), cb0[12].x
...
mul r1.x, r1.x, r1.w
exp r2.y, r1.x
mad_sat r1.xz, cb0[12].wwww, r2.xxyx, r1.zzzz
add r1.y, -r1.x, r1.y
add r1.x, -r1.x, r1.z
...
ret 
// Approximately 2754 instruction slots used
