...
r0.w = modelInstanceBuffer[]..swiz;
  r2.y = r3.w;
  r2.z = r0.w;
  r2.xyw = -eyeOffset.xyz + r2.xyz;
  r4.w = r2.y;
  r4.xyz = r3.xyz;
  r5.xyz = v0.xyz;
  r5.w = 1;
  r4.x = dot(r5.xyzw, r4.xyzw);
  r4.xyzw = viewProjectionMatrix._m10_m11_m12_m13 * r4.xxxx;
  o3.x = dot(r5.xyzw, r1.xyzw);
  r1.w = r2.x;
  r1.x = dot(r5.xyzw, r1.xyzw);
  r1.xyzw = r1.xxxx * viewProjectionMatrix._m00_m01_m02_m03 + r4.xyzw;
  r2.xyz = r0.xyz;
  o3.z = dot(r5.xyzw, r0.xyzw);
  r0.x = dot(r5.xyzw, r2.xyzw);
  o3.y = dot(r5.xyzw, r3.xyzw);
  ...
  o4.xy = renderTargetSize.xy * r0.xy;
  o4.zw = r0.zw;
  o5.x = cmp(r0.z >= r0.w);
