...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r2.w = min(1, r2.w);
  r4.xyz = saturate(r0.xyz * float3(0.0199999996,0.0199999996,0.0199999996) + float3(0.0399999991,0.0399999991,0.0399999991));
  r7.xyz = specColorTint.xyz * r4.xyz;
  r8.xyz = r2.www * r0.xyz;
  r5.xyz = r8.xyz * r5.xyz;
  r0.xyz = r3.xyz * r0.xyz + r5.xyz;
  r3.xyz = -r4.xyz * specColorTint.xyz + float3(1,1,1);
