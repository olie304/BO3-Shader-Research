...
uge r0.y, r15.z, r15.y
ult r17.x, r15.z, cb2[0].y
and r0.y, r0.y, r17.x
if_nz r0.y
  imul null, r0.y, r15.z, l(14)
  ...
  endloop 
  mov_sat r20.y, r20.y
  mul r17.w, r20.y, cb10[r0.y + 6].y
  lt r18.x, l(0.000000), r17.w
  if_nz r18.x
    mul r18.x, r17.w, cb10[r0.y + 7].y
    ...
    mad r19.xyz, r16.xyzx, r18.yyyy, r19.xyzx
    ...
    ubfe r18.z, l(9), l(16), cb10[r0.y + 7].z
    utof r21.w, r18.z
    sample_l_indexable(texturecubearray)(float,float,float,float) r18.yzw, r21.xyzw, t8.wxyz, s2, r18.y
    dp3 r19.x, r17.xyzx, r20.xyzx
    dp3 r19.y, r17.xyzx, r22.xyzx
    dp3 r19.z, r17.xyzx, r23.xyzx
    mad_sat r17.xyz, r19.xyzx, cb10[r0.y + 3].xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
    mul r19.xy, r17.xyxx, cb10[r0.y + 4].zwzz
    mul r19.z, r17.z, cb10[r0.y + 5].x
    add r17.xyz, r19.xyzx, cb10[r0.y + 5].yzwy
...
lt r0.y, r17.w, l(1.000000)
if_nz r0.y
  ult r0.y, r15.z, r15.y
  if_nz r0.y
    imul null, r0.y, r15.z, l(14)
    ...
    if_nz r18.w
      ...
      sqrt r13.w, r13.w
      mad r8.w, r8.w, l(5.000000), r13.w
      ...
      utof r22.w, r13.w
      sample_l_indexable(texturecubearray)(float,float,float,float) r20.xyz, r22.xyzw, t8.xyzw, s2, r8.w
...
max r0.y, r17.w, l(1.000000)
rcp r0.y, r0.y
mov_sat r17.w, r17.w
mul r19.xyz, r0.yyyy, r17.xyzx
mul r18.xyz, r0.yyyy, r18.xyzx
lt r8.w, r17.w, l(0.990000)
if_nz r8.w
  add r8.w, -r17.w, l(1.000000)
  ...
  mov r16.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r17.xyz, r16.xyzw, t8.xyzw, s2, r13.z
