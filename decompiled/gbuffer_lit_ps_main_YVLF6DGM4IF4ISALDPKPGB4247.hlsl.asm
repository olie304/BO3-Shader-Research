...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:29:41 2021
//
//
// Buffer Definitions: 
//
...
sample_indexable(texture2d)(float,float,float,float) r3.xyzw, v1.yzyy, t16.xyzw, s5
...
sample_indexable(texture2d)(float,float,float,float) r6.xyz, r6.xyxx, t14.xyzw, s3
mul r7.xy, v1.yzyy, cb0[4].xyxx
sample_indexable(texture2d)(float,float,float,float) r7.xyz, r7.xyxx, t15.xyzw, s3
if_nz r2.w
  mul r2.w, r3.x, cb0[13].y
  mov r7.xyz, r4.xyzx
else 
  lt r3.x, l(0.000000), r3.y
  if_nz r3.x
    mul r2.w, r3.y, cb0[13].x
    mov r7.xyz, r5.xyzx
  else 
    lt r3.x, l(0.000000), r3.z
    if_nz r3.x
      mul r2.w, r3.z, cb0[12].w
      mov r7.xyz, r6.xyzx
    else 
      lt r3.x, l(0.000000), r3.w
      if_nz r3.x
        mul r2.w, r3.w, cb0[12].z
      else 
...
div r1.yw, v5.xxxy, v5.wwww
mul r4.zw, cb1[44].xxxy, l(0.000000, 0.000000, 0.500000, 0.500000)
mul r5.x, r1.y, r4.z
mul r5.y, r1.w, -r4.w
mad r1.yw, cb1[44].xxxy, l(0.000000, 0.500000, 0.000000, 0.500000), r5.xxxy
add r1.yw, -r1.yyyw, v0.xxxy
add r3.w, r4.y, r4.x
mad r3.w, r3.z, r1.z, r3.w
mul r3.w, r3.w, l(0.500000)
mad r3.xyz, r3.xyzx, r1.zzzz, -r3.wwww
max r1.z, r3.z, r3.y
max r1.z, r1.z, r3.x
max r1.z, r1.z, r3.w
eq r3.x, r1.z, r3.x
...
add r0.xy, |r1.ywyy|, l(-10.000000, -10.000000, 0.000000, 0.000000)
mul_sat r0.xy, r0.xyxx, l(0.03333334, 0.03333334, 0.000000, 0.000000)
mul r1.xz, |r1.yywy|, l(0.100000, 0.000000, 0.100000, 0.000000)
min r1.xz, r1.xxzx, l(1.000000, 0.000000, 1.000000, 0.000000)
add r1.xz, -r0.xxyx, r1.xxzx
mad r0.xy, r1.xzxx, l(0.500000, 0.500000, 0.000000, 0.000000), r0.xyxx
ge r1.xy, r1.ywyy, l(0.000000, 0.000000, 0.000000, 0.000000)
