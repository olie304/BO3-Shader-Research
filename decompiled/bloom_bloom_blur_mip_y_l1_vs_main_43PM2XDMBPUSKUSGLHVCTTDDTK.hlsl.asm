...
//   float4 postFxBloom20;              // Offset: 1600 Size:    16
...
dcl_constantbuffer CB8[101], immediateIndexed
...
utof r0.x, r0.x
mul r0.y, cb8[100].w, cb8[100].y
mul r0.x, r0.x, r0.y
mul o1.xyz, r0.xxxx, l(1.465200, 0.791600, 0.366100, 0.000000)
