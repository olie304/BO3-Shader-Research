...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:23:17 2021
//
//
// Buffer Definitions: 
//
...
mad r15.yz, -r4.wwww, l(0.000000, 10.000000, 5.000000, 0.000000), l(0.000000, 6.857410, 7.085000, 0.000000)
exp r8.w, r15.y
mul r8.w, r2.x, r8.w
mul r8.w, r8.w, l(9.136810)
mul r9.w, r4.w, r6.w
mad r9.w, -r9.w, l(2.015905), r15.z
exp r9.w, r9.w
mul r9.w, r2.x, r9.w
...
if_nz r10.w
  ...
  ubfe r17.w, l(6), l(25), r13.w
  imul null, r18.w, r9.w, l(6)
  ...
  if_nz r9.w
    ...
    movc r20.xyz, r13.wwww, l(1.000000,1.000000,0,0), r20.xyzx
...
if_z r10.w
  ...
  and r15.y, r10.w, l(-32)
  iadd r15.z, r10.w, -r15.y
  ...
  loop 
    ...
    loop 
      ...
      if_nz r20.w
        ...
        sqrt r20.w, r20.w
        mad r20.w, r4.w, l(5.000000), r20.w
  ...
  loop 
    ...
    loop 
      ...
      if_nz r22.w
        ...
        sqrt r21.w, r21.w
        mad r21.w, r4.w, l(5.000000), r21.w
  ...
  endloop 
  ge r4.w, r25.z, l(1.000000)
  and r7.w, r25.w, l(0x0000ff00)
  bfi r7.w, l(8), l(0), r27.y, r7.w
  movc r9.w, r4.w, r7.w, r27.y
  max r4.w, r27.x, l(1.000000)
  rcp r4.w, r4.w
  mov_sat r27.x, r27.x
  mul r15.yzw, r4.wwww, r23.xxyz
  mul r32.xyz, r4.wwww, r26.xyzx
  lt r7.w, r27.x, l(0.990000)
  if_nz r7.w
    iadd r9.w, r9.w, l(256)
    add r7.w, -r27.x, l(1.000000)
    ...
    mad r15.yzw, r23.xxyz, r4.wwww, r17.xxyz
    mov r16.w, l(0)
    sample_l_indexable(texturecubearray)(float,float,float,float) r17.xyz, r16.xyzw, t8.xyzw, s2, r6.w
    mad r4.w, cb2[19].x, r7.w, -r8.w
    mad r4.w, r2.y, r4.w, r8.w
    mad r32.xyz, r17.xyzx, r4.wwww, r32.xyzx
  endif 
else 
  mov r15.yzw, l(0,0,0,0)
endif 
...
loop 
  ...
  switch r8.w
    ...
    iadd r8.w, r5.x, l(1)
    lt r10.w, l(0.000000), cb9[r7.w + 6].y
    ...
    div_sat r13.w, -r12.w, cb9[r7.w + 6].y
    mad r37.xyz, r13.wwww, r35.xyzx, r20.yzwy
    movc r37.xyz, r10.wwww, r37.xyzx, cb9[r7.w + 0].xyzx
    ...
    if_nz r24.w
      sqrt r24.w, r16.w
      mul r28.w, cb9[r7.w + 3].x, cb9[r7.w + 3].x
      div r16.w, r28.w, r16.w
      min r16.w, r16.w, l(1.000000)
      mad_sat r37.xy, r24.wwww, cb9[r7.w + 2].xzxx, cb9[r7.w + 2].ywyy
      ...
      lt r24.w, l(0.000000), r16.w
      if_nz r24.w
        ubfe r24.w, l(3), l(27), cb9[r7.w + 1].w
        and r28.w, r8.w, l(7)
        ...
        if_nz r24.w
          ...
          div r24.w, cb9[r7.w + 5].x, r24.w
          add r24.w, r24.w, cb9[r7.w + 5].y
          dp3 r29.w, r37.xyzx, r37.xyzx
          rsq r29.w, r29.w
          max r24.w, r24.w, l(0.00006104)
          and r30.w, l(0x0000ffff), cb9[r7.w + 1].w
          utof r38.w, r30.w
          mov r30.w, l(0)
          mov r31.w, l(0)
          loop 
        ...
        if_nz r24.w
          ...
          if_nz r13.w
            ...
            mad r22.xyz, r12.xyzx, r13.wwww, r11.xyzx
            ...
            if_z r31.w
              ...
              if_z r22.z
                ...
                mad r13.w, cb9[r12.w + 10].y, r29.w, r13.w
            ...
            ubfe r12.w, l(4), l(20), cb9[r7.w + 1].w
            ult r13.w, l(0), r12.w
            ...
            if_nz r13.w
              ...
              if_z r22.z
                ...
                if_z r23.z
                  ...
                  mad r13.w, cb9[r12.w + 10].y, r22.x, r13.w
              ...
              if_z r22.x
                ...
                if_nz cb2[58].y
                  ...
                  loop 
                    ige r31.w, r29.w, l(8)
                    breakc_nz r31.w
                    dp2 r37.x, icb[r29.w + 0].xyxx, r13.xyxx
                    dp2 r37.y, icb[r29.w + 0].yxyy, r13.xzxx
          ...
          mad r20.yzw, r20.yyzw, r10.wwww, r5.yyzw
          dp3 r10.w, r20.yzwy, r20.yzwy
          rsq r10.w, r10.w
          mul r20.yzw, r10.wwww, r20.yyzw
          dp3 r10.w, r20.yzwy, r5.yzwy
          dp3 r18.w, r12.xyzx, r20.yzwy
          mad r20.y, |r18.w|, r0.w, -|r18.w|
          mad r18.w, |r18.w|, r20.y, l(1.000000)
          mad r20.y, r17.w, r1.w, r2.y
    ...
    if_nz r17.w
      ...
      if_nz r18.w
        ...
        mul r22.x, cb9[r7.w + 3].x, cb9[r7.w + 3].x
        dp3 r21.y, r21.yzwy, r21.yzwy
        div r21.y, r22.x, r21.y
        min r21.y, r21.y, l(1.000000)
        mad_sat r21.zw, r17.wwww, cb9[r7.w + 2].xxxz, cb9[r7.w + 2].yyyw
        ...
        if_nz r17.w
          mad_sat r21.zw, |r24.xxxy|, cb9[r7.w + 12].xxxy, cb9[r7.w + 12].zzzw
          mul r36.xy, r21.zwzz, r21.zwzz
          mad r21.zw, r21.zzzw, l(0.000000, 0.000000, -2.000000, -2.000000), l(0.000000, 0.000000, 3.000000, 3.000000)
          mul r21.zw, r21.zzzw, r36.xxxy
          ...
          log r21.zw, r21.zzzw
          mul r21.zw, r21.zzzw, cb9[r7.w + 12].wwww
          exp r21.zw, r21.zzzw
          mul r21.z, r21.z, cb9[r7.w + 12].x
          mad r22.x, cb9[r7.w + 12].y, r21.w, l(-1.000000)
          mad r21.z, cb9[r7.w + 12].y, r21.w, -r21.z
        ...
        if_nz r17.w
          dp3 r21.y, cb9[r7.w + 13].xyzx, r24.xyzx
      ...
      if_nz r17.w
        ...
        if_nz r18.w
          ...
          ubfe r21.z, l(4), l(16), cb9[r7.w + 1].w
          ult r22.x, l(0), r21.z
          ...
          if_nz r22.x
            ...
            if_nz r21.z
              ...
              if_z r24.x
                ...
                mad r25.xy, r25.xyxx, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
                add r26.x, r25.x, cb9[r7.w + 9].w
                add r26.y, r25.y, cb9[r7.w + 10].x
                mul r25.xy, r26.xyxx, cb9[r7.w + 9].yzyy
                div r26.xy, cb9[r7.w + 3].yyyy, cb9[r7.w + 8].ywyy
                ...
                if_z r24.w
                  mov_sat r25.xy, r25.xyxx
                  mad r26.x, r25.x, cb9[r7.w + 8].y, cb9[r7.w + 8].z
                  mad r26.y, r25.y, cb9[r7.w + 8].w, cb9[r7.w + 9].x
                  mul r25.x, r22.x, cb9[r7.w + 10].z
                  mad r21.z, cb9[r7.w + 10].y, r22.x, r21.z
              ...
              if_z r22.x
                ...
                and r22.x, l(0x0000ffff), cb9[r7.w + 1].w
                if_nz cb2[58].y
                  utof r25.z, r22.x
                ...
                mul r7.w, r24.x, r24.x
                mul r7.w, r24.x, r7.w
              else 
                mov r7.w, l(1.000000)
              endif 
              mul r17.w, r7.w, r17.w
            endif 
          endif 
          mad r7.w, -r16.w, r2.x, l(1.000000)
          mul r7.w, r7.w, r7.w
          mad r7.w, -r7.w, l(0.620000), l(0.620000)
          add r7.w, -r16.w, r7.w
          mad r7.w, r2.z, r7.w, r16.w
          mul r7.w, r17.w, r7.w
          lt r12.w, l(0.000000), r12.w
          mad r25.xyz, r7.wwww, r20.yzwy, r31.xyzx
          mad r23.xyz, r23.xyzx, r10.wwww, r5.yzwy
          dp3 r10.w, r23.xyzx, r23.xyzx
          rsq r10.w, r10.w
          mul r23.xyz, r10.wwww, r23.xyzx
          dp3 r10.w, r23.xyzx, r5.yzwy
          dp3 r16.w, r12.xyzx, r23.xyzx
          mad r21.z, |r16.w|, r0.w, -|r16.w|
          mad r16.w, |r16.w|, r21.z, l(1.000000)
