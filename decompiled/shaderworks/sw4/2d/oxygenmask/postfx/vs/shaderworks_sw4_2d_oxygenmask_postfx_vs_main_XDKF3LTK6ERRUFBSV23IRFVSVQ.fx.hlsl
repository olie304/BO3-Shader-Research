  ...
  out float4 o4 : TEXCOORD3)
{
  ...
  o1.xy = v1.xy;
  r0.x = 1.88495576 * gameTime.w;
  r0.x = sin(r0.x);
  r0.y = cmp(0 < r0.x);
  r0.z = cmp(r0.x < 0);
  r0.x = log2(abs(r0.x));
  r0.x = 0.349999994 * r0.x;
  r0.x = exp2(r0.x);
  r0.y = (int)-r0.y + (int)r0.z;
  r0.y = (int)r0.y;
  r0.x = r0.x * r0.y;
  o2.xyzw = r0.xxxx * float4(0.5,0.5,0.5,0.5) + float4(0.5,0.5,0.5,0.5);
  r0.x = saturate(scriptVector0.z);
  r0.x = BlurAmountMax * r0.x;
  r0.xyzw = r0.xxxx * float4(0.00999999978,0.0199999996,0.0500000007,0.0599999987) + float4(1,1,1,1);
  r1.xyzw = float4(-0.5,-0.5,-0.5,-0.5) + v1.xyxy;
  r2.xyzw = r1.zwzw / r0.xxyy;
  r0.xyzw = r1.xyzw / r0.zzww;
  o4.xyzw = float4(0.5,0.5,0.5,0.5) + r0.xyzw;
  o3.xyzw = float4(0.5,0.5,0.5,0.5) + r2.xyzw;
  return;
}