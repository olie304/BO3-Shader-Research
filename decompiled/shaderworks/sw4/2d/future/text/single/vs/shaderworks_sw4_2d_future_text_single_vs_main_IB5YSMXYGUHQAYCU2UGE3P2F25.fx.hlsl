  ...
  out float4 o3 : TEXCOORD3)
{
  ...
  r0.xyzw = v0.wwww * viewProjectionMatrix._m30_m31_m32_m33 + r0.xyzw;
  o0.xyzw = r0.xyzw;
  o1.xy = v1.xy;
  ...
  r0.z = r0.z * 4 + -r0.w;
  r1.w = 0.25 * r0.z;
  r0.z = dot(r1.wwww, float4(81.2394867,17.3480244,37.3498383,59.3948402));
  r1.x = frac(r0.z);
  r0.z = dot(r1.xwww, float4(81.2394867,17.3480244,37.3498383,59.3948402));
  r1.y = frac(r0.z);
  r0.z = dot(r1.xyww, float4(81.2394867,17.3480244,37.3498383,59.3948402));
  r1.z = frac(r0.z);
  ...
  r0.zw = r0.zw + r0.zw;
  r0.zw = frac(r0.zw);
  o2.xy = r0.xy * float2(0.375,1.39999998) + r0.zw;
  o2.zw = float2(5,5) * r0.xy;
