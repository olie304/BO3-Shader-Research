  ...
  out float p1 : TEXCOORD2)
{
  ...
  r0.yw = r0.xx * float2(0.0666666701,0.0666666701) + float2(0.727262974,0.689234972);
  r1.x = dot(r0.yyyy, float4(81.2394867,17.3480244,37.3498383,59.3948402));
  r0.x = frac(r1.x);
  r1.x = dot(r0.xyyy, float4(81.2394867,17.3480244,37.3498383,59.3948402));
  r0.z = frac(r1.x);
  r1.x = dot(r0.xzyy, float4(81.2394867,17.3480244,37.3498383,59.3948402));
  r2.xyw = r0.xzy;
  r2.z = frac(r1.x);
  r1.x = dot(r2.xyzw, float4(81.2394867,17.3480244,37.3498383,59.3948402));
  r2.w = frac(r1.x);
  r1.x = dot(r2.xyzw, float4(81.2394867,17.3480244,37.3498383,59.3948402));
  r2.x = frac(r1.x);
  r1.x = dot(r2.xyzw, float4(81.2394867,17.3480244,37.3498383,59.3948402));
