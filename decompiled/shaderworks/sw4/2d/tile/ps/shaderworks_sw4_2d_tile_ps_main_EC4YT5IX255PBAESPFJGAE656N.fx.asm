...
// ------------------------------ ---------- ------- ----------- -------------- ------
// Tile_Sampler                      sampler      NA          NA             s1      1 
// Tile                              texture  float4          2d             t0      1 
...
dcl_output o0.xyzw
dcl_temps 2
add r0.xy, -cb3[0].xzxx, cb3[0].ywyy
mad r0.xy, v2.xyxx, r0.xyxx, cb3[0].xzxx
mul r0.x, r0.y, r0.x
mul r0.yz, v2.xxyx, cb3[1].xxyx
