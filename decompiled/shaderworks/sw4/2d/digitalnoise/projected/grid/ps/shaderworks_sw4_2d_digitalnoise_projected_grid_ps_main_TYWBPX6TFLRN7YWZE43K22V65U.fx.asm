...
rcp r0.y, r0.y
mul r0.y, r0.y, l(0.000050)
add r2.xy, v1.xyxx, l(-0.500000, -0.500000, 0.000000, 0.000000)
mul r0.w, r0.y, r2.x
mul r0.y, r0.y, -r2.y
mul r2.xy, r0.wyww, l(0.02327165, 0.01309030, 0.000000, 0.000000)
mad r0.y, cb3[0].z, l(2.000000), l(1.000000)
div r0.y, l(10.000000), r0.y
mul r0.w, r0.y, l(360.000000)
mul r2.zw, r2.xxxy, r0.wwww
mad r2.xy, r0.wwww, r2.xyxx, l(0.750000, 0.750000, 0.000000, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r3.xyz, r2.xyxx, t0.xyzw, s1
dp2 r0.w, r2.zwzz, r2.zwzz
mul r0.y, r0.y, r0.w
mad_sat r0.y, -r0.y, l(0.015000), l(1.000000)
mul r2.xyz, r0.yyyy, r3.xyzx
mul r2.xyz, r2.xyzx, l(0.000000, 0.200000, 0.000000, 0.000000)
