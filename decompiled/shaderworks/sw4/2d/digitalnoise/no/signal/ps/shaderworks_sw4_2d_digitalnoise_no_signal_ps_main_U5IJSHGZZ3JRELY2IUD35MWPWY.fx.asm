...
// resolvedPostSun_C11_P0_sampler    sampler      NA          NA             s3      1 
// BlockNoise                        texture  float4          2d             t0      1 
// Lookup2                           texture  float4          2d             t6      1 
// resolvedPostSun_C11_P0            texture  float4          2d             t7      1 
...
sample_indexable(texture2d)(float,float,float,float) r0.y, r2.xwxx, t6.yxzw, s2
...
mov r3.w, r2.w
sample_indexable(texture2d)(float,float,float,float) r1.xzw, r3.zwzz, t7.xwyz, s3
max r0.y, r1.z, r1.x
max r0.y, r1.w, r0.y
min r1.z, r1.z, r1.x
min r1.z, r1.w, r1.z
...
sample_indexable(texture2d)(float,float,float,float) r1.xzw, r3.xwxx, t7.xwyz, s3
sample_indexable(texture2d)(float,float,float,float) r3.xyz, r3.ywyy, t7.xyzw, s3
max r0.y, r1.z, r1.x
max r0.y, r1.w, r0.y
min r1.x, r1.z, r1.x
min r1.x, r1.w, r1.x
...
mov r2.y, v1.y
sample_indexable(texture2d)(float,float,float,float) r0.y, r2.xyxx, t6.yxzw, s2
mad r0.y, r0.y, l(2.000000), l(-1.000000)
mad r2.x, r0.y, r1.y, v1.x
mul r0.y, r1.y, r0.y
mad r1.xy, r0.yyyy, l(0.500000, -0.250000, 0.000000, 0.000000), v1.xxxx
mov r2.y, v1.y
sample_indexable(texture2d)(float,float,float,float) r2.xyz, r2.xyxx, t7.xyzw, s3
max r0.y, r2.y, r2.x
max r0.y, r2.z, r0.y
min r1.w, r2.y, r2.x
min r1.w, r2.z, r1.w
...
mov r1.z, v1.y
sample_indexable(texture2d)(float,float,float,float) r3.xyz, r1.xzxx, t7.xyzw, s3
sample_indexable(texture2d)(float,float,float,float) r1.xyz, r1.yzyy, t7.xyzw, s3
max r0.y, r3.y, r3.x
max r0.y, r3.z, r0.y
min r1.w, r3.y, r3.x
min r1.w, r3.z, r1.w
...
add r2.xyz, -r0.wwww, l(1.000000, 1.000000, 1.000000, 0.000000)
