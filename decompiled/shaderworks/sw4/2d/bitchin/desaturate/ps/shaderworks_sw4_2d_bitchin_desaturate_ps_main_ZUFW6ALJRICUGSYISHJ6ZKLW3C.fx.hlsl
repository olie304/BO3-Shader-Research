  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.xyzw = codeTexture0_C3_P0.Sample(codeTexture0_C3_P0_sampler_s, v2.xy).xyzw;
  r1.x = max(r0.x, r0.y);
  r1.x = max(r1.x, r0.z);
  r1.y = min(r0.x, r0.y);
  r1.y = min(r1.y, r0.z);
  r1.x = r1.x + r1.y;
  r1.xyz = r1.xxx * float3(0.5,0.5,0.5) + -r0.xyz;
  r1.w = 0;
  r0.xyzw = scriptVector0.xxxx * r1.xyzw + r0.xyzw;
