...
// ------------------------------ ---------- ------- ----------- -------------- ------
// codeTexture0_C8_P0_sampler        sampler      NA          NA             s1      1 
// codeTexture0_C8_P0                texture  float4          2d             t0      1 
...
dp2 r0.x, l(0.68454719, -0.72896856, 0.000000, 0.000000), r0.xyxx
add r0.x, r0.x, l(0.500000)
mad r0.x, cb3[0].x, l(-2.000000), r0.x
add_sat r0.xy, r0.xxxx, l(1.000000, 0.500000, 0.000000, 0.000000)
add r0.x, r0.x, l(-0.500000)
mul r0.y, r0.y, l(8.421900)
min r0.y, r0.y, l(1.000000)
add r0.z, cb3[0].x, l(-0.500000)
mad r0.z, |r0.z|, l(0.585600), l(0.707200)
dp2 r0.x, |r0.xxxx|, r0.zzzz
min r0.x, r0.x, l(1.000000)
add r0.xy, -r0.xyxx, l(1.000000, 1.000000, 0.000000, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r1.xyzw, v2.xyxx, t0.xyzw, s1
add r2.xyz, r0.xxxx, r1.xyzx
mul r2.w, r0.y, r1.w
