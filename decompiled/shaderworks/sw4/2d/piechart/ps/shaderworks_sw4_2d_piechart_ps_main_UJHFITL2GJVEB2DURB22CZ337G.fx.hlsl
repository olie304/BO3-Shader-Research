...
SamplerState PieChart_Sampler_s : register(s1);
Texture2D<float4> PieChart : register(t0);
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.x = 12.566371 + r0.x;
  r0.x = 0.159154937 * r0.x;
  r0.y = cmp(r0.x >= -r0.x);
  r0.x = frac(abs(r0.x));
  r0.x = r0.y ? r0.x : -r0.x;
  r0.x = 6.28318548 * r0.x;
  r0.x = cmp(r0.x < scriptVector0.y);
  r1.xyzw = PieChart.Sample(PieChart_Sampler_s, v2.xy).xyzw;
  r0.xyzw = r0.xxxx ? r1.xyzw : 0;
