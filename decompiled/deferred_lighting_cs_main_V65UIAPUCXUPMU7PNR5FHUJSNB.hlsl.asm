...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:24:03 2021
//
//
// Buffer Definitions: 
//
...
mov r16.w, r0.z
loop 
  uge r17.y, r16.w, cb2[0].y
  breakc_nz r17.y
  ushr r17.y, r16.w, l(5)
  iadd r17.y, r0.y, r17.y
  ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r17.y, r17.y, l(0), t26.xxxx
  ieq r17.z, r0.z, r16.w
  bfi r17.w, r15.w, l(0), l(0), r17.y
  movc r17.y, r17.z, r17.w, r17.y
  ieq r17.z, r16.y, r16.w
  ubfe r17.w, r16.z, l(0), r17.y
  movc r17.y, r17.z, r17.w, r17.y
  ...
  loop 
    ...
    not r19.w, r19.w
    and r17.z, r17.z, r19.w
    iadd r17.w, r16.w, r17.w
    imul null, r17.w, r17.w, l(14)
    add r28.xyz, r11.xyzx, -cb10[r17.w + 0].xyzx
    and r19.w, l(0x0000ffff), cb10[r17.w + 7].z
    ubfe r20.w, l(6), l(25), cb10[r17.w + 7].z
    imul null, r21.z, r19.w, l(6)
    dp3 r21.w, cb11[r21.z + 0].xyzx, r28.xyzx
    add_sat r21.w, r21.w, cb11[r21.z + 0].w
    dp3 r22.w, cb11[r21.z + 1].xyzx, r28.xyzx
    add_sat r22.w, r22.w, cb11[r21.z + 1].w
    mul r21.w, r21.w, r22.w
    dp3 r22.w, cb11[r21.z + 2].xyzx, r28.xyzx
    add_sat r22.w, r22.w, cb11[r21.z + 2].w
    mul r21.w, r21.w, r22.w
    dp3 r22.w, cb11[r21.z + 3].xyzx, r28.xyzx
    add_sat r22.w, r22.w, cb11[r21.z + 3].w
    mul r21.w, r21.w, r22.w
    dp3 r22.w, cb11[r21.z + 4].xyzx, r28.xyzx
    add_sat r22.w, r22.w, cb11[r21.z + 4].w
    mul r21.w, r21.w, r22.w
    dp3 r22.w, cb11[r21.z + 5].xyzx, r28.xyzx
    add_sat r21.z, r22.w, cb11[r21.z + 5].w
    mul r19.x, r21.z, r21.w
    and r21.z, l(1), cb10[r17.w + 6].x
    movc r21.zw, r21.zzzz, r19.xxxy, r19.zzzx
    mov r19.x, cb10[r17.w + 6].x
    mov r29.xy, r21.zwzz
    mov r22.w, l(1)
    loop 
      ...
      movc r21.y, r30.x, r23.w, r30.y
      movc r29.xy, r29.wwww, r29.xyxx, r21.xyxx
      iadd r22.w, r22.w, l(1)
      mov r19.x, r29.z
    endloop 
    mov_sat r29.y, r29.y
    mul r19.x, r29.y, cb10[r17.w + 6].y
    lt r19.w, l(0.000000), r19.x
    if_nz r19.w
      mad r27.z, r29.y, cb10[r17.w + 6].y, r27.z
      mul r19.x, r19.x, cb10[r17.w + 7].y
      mov r30.x, cb10[r17.w + 7].w
      mov r30.yz, cb10[r17.w + 8].xxyx
      dp3 r19.w, r18.xyzx, r30.xyzx
      dp3 r20.w, r28.xyzx, r30.xyzx
      add r20.w, r20.w, -cb10[r17.w + 8].z
      ...
      mov r30.x, cb10[r17.w + 8].w
      mov r30.yz, cb10[r17.w + 9].xxyx
      dp3 r20.w, r18.xyzx, r30.xyzx
      dp3 r21.y, r28.xyzx, r30.xyzx
      add r21.y, r21.y, -cb10[r17.w + 9].z
      ...
      mov r30.x, cb10[r17.w + 9].w
      mov r30.yz, cb10[r17.w + 10].xxyx
      dp3 r20.w, r18.xyzx, r30.xyzx
      dp3 r21.y, r28.xyzx, r30.xyzx
      add r21.y, r21.y, -cb10[r17.w + 10].z
      ge r21.z, r21.y, l(0.000000)
      max r21.y, r13.w, |r21.y|
      movc r21.y, r21.z, r21.y, -r21.y
      max r20.w, -r20.w, l(0.00000010)
      div r20.w, r21.y, r20.w
      min r19.w, r19.w, |r20.w|
      mov r30.x, cb10[r17.w + 10].w
      mov r30.yz, cb10[r17.w + 11].xxyx
      dp3 r20.w, r18.xyzx, r30.xyzx
      dp3 r21.y, r28.xyzx, r30.xyzx
      add r21.y, r21.y, -cb10[r17.w + 11].z
      ge r21.z, r21.y, l(0.000000)
      max r21.y, r13.w, |r21.y|
      movc r21.y, r21.z, r21.y, -r21.y
      max r20.w, -r20.w, l(0.00000010)
      div r20.w, r21.y, r20.w
      min r19.w, r19.w, |r20.w|
      mov r30.x, cb10[r17.w + 11].w
      mov r30.yz, cb10[r17.w + 12].xxyx
      dp3 r20.w, r18.xyzx, r30.xyzx
      dp3 r21.y, r28.xyzx, r30.xyzx
      add r21.y, r21.y, -cb10[r17.w + 12].z
      ge r21.z, r21.y, l(0.000000)
      max r21.y, r13.w, |r21.y|
      movc r21.y, r21.z, r21.y, -r21.y
      max r20.w, -r20.w, l(0.00000010)
      div r20.w, r21.y, r20.w
      min r19.w, r19.w, |r20.w|
      mov r30.x, cb10[r17.w + 12].w
      mov r30.yz, cb10[r17.w + 13].xxyx
      dp3 r20.w, r18.xyzx, r30.xyzx
      dp3 r21.y, r28.xyzx, r30.xyzx
      add r21.y, r21.y, -cb10[r17.w + 13].z
      ge r21.z, r21.y, l(0.000000)
      max r21.y, r13.w, |r21.y|
      movc r21.y, r21.z, r21.y, -r21.y
      max r20.w, -r20.w, l(0.00000010)
      div r20.w, r21.y, r20.w
      min r19.w, r19.w, |r20.w|
      add r30.x, r28.x, cb10[r17.w + 3].w
      add r30.yz, r28.yyzy, cb10[r17.w + 4].xxyx
      mad r21.yzw, r18.xxyz, r19.wwww, r30.xxyz
      ...
      mov r30.x, cb10[r17.w + 0].w
      mov r30.y, cb10[r17.w + 1].z
      mov r30.z, cb10[r17.w + 2].y
      dp3 r31.x, r21.yzwy, r30.xyzx
      mov r32.xy, cb10[r17.w + 1].xwxx
      mov r32.z, cb10[r17.w + 2].z
      dp3 r31.y, r21.yzwy, r32.xyzx
      mov r33.x, cb10[r17.w + 1].y
      mov r33.yz, cb10[r17.w + 2].xxwx
      dp3 r31.z, r21.yzwy, r33.xyzx
      ubfe r20.w, l(9), l(16), cb10[r17.w + 7].z
      utof r31.w, r20.w
      sample_l_indexable(texturecubearray)(float,float,float,float) r21.yzw, r31.xyzw, t8.wxyz, s2, r19.w
      dp3 r34.x, r28.xyzx, r30.xyzx
      dp3 r34.y, r28.xyzx, r32.xyzx
      dp3 r34.z, r28.xyzx, r33.xyzx
      mad_sat r28.xyz, r34.xyzx, cb10[r17.w + 3].xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
      mul r34.xy, r28.xyxx, cb10[r17.w + 4].zwzz
      mul r34.z, r28.z, cb10[r17.w + 5].x
      add r28.xyz, r34.xyzx, cb10[r17.w + 5].yzwy
...
if_nz r16.y
  ...
  loop 
    ...
    ieq r19.w, r0.z, r17.z
    ubfe r20.w, r15.w, l(0), r17.w
    ...
    loop 
      ...
      ishl r21.w, l(1), r21.z
      not r21.w, r21.w
      and r20.w, r20.w, r21.w
      iadd r21.z, r17.z, r21.z
      imul null, r21.z, r21.z, l(14)
      add r29.xyz, r11.xyzx, -cb10[r21.z + 0].xyzx
      and r21.w, l(0x0000ffff), cb10[r21.z + 7].z
      ubfe r22.w, l(6), l(25), cb10[r21.z + 7].z
      imul null, r23.w, r21.w, l(6)
      dp3 r28.w, cb11[r23.w + 0].xyzx, r29.xyzx
      add_sat r28.w, r28.w, cb11[r23.w + 0].w
      dp3 r29.w, cb11[r23.w + 1].xyzx, r29.xyzx
      add_sat r29.w, r29.w, cb11[r23.w + 1].w
      mul r28.w, r28.w, r29.w
      dp3 r29.w, cb11[r23.w + 2].xyzx, r29.xyzx
      add_sat r29.w, r29.w, cb11[r23.w + 2].w
      mul r28.w, r28.w, r29.w
      dp3 r29.w, cb11[r23.w + 3].xyzx, r29.xyzx
      add_sat r29.w, r29.w, cb11[r23.w + 3].w
      mul r28.w, r28.w, r29.w
      dp3 r29.w, cb11[r23.w + 4].xyzx, r29.xyzx
      add_sat r29.w, r29.w, cb11[r23.w + 4].w
      mul r28.w, r28.w, r29.w
      dp3 r29.w, cb11[r23.w + 5].xyzx, r29.xyzx
      add_sat r23.w, r29.w, cb11[r23.w + 5].w
      mul r19.x, r23.w, r28.w
      and r23.w, l(1), cb10[r21.z + 6].x
      movc r30.xy, r23.wwww, r19.xyxx, r19.zxzz
      mov r19.x, cb10[r21.z + 6].x
      mov r31.xy, r30.xyxx
      mov r23.w, l(1)
      loop 
        ige r28.w, r23.w, r22.w
        breakc_nz r28.w
        iadd r28.w, r21.w, r23.w
        ...
        movc r21.y, r31.z, r28.w, r31.w
        movc r31.xy, r30.wwww, r31.xyxx, r21.xyxx
        iadd r23.w, r23.w, l(1)
        mov r19.x, r30.z
      endloop 
      add_sat r19.x, -r19.w, r31.y
      mul r21.y, r19.x, cb10[r21.z + 6].y
      lt r21.w, l(0.000000), r21.y
      if_nz r21.w
        mad r27.w, r19.x, cb10[r21.z + 6].y, r27.w
        mul r19.x, r21.y, cb10[r21.z + 7].y
        mov r30.x, cb10[r21.z + 7].w
        mov r30.yz, cb10[r21.z + 8].xxyx
        dp3 r21.y, r18.xyzx, r30.xyzx
        dp3 r21.w, r29.xyzx, r30.xyzx
        add r21.w, r21.w, -cb10[r21.z + 8].z
        ...
        mov r30.x, cb10[r21.z + 8].w
        mov r30.yz, cb10[r21.z + 9].xxyx
        dp3 r21.w, r18.xyzx, r30.xyzx
        dp3 r22.w, r29.xyzx, r30.xyzx
        add r22.w, r22.w, -cb10[r21.z + 9].z
        ...
        mov r30.x, cb10[r21.z + 9].w
        mov r30.yz, cb10[r21.z + 10].xxyx
        dp3 r21.w, r18.xyzx, r30.xyzx
        dp3 r22.w, r29.xyzx, r30.xyzx
        add r22.w, r22.w, -cb10[r21.z + 10].z
        ge r23.w, r22.w, l(0.000000)
        max r22.w, r13.w, |r22.w|
        movc r22.w, r23.w, r22.w, -r22.w
        max r21.w, -r21.w, l(0.00000010)
        div r21.w, r22.w, r21.w
        min r21.y, |r21.w|, r21.y
        mov r30.x, cb10[r21.z + 10].w
        mov r30.yz, cb10[r21.z + 11].xxyx
        dp3 r21.w, r18.xyzx, r30.xyzx
        dp3 r22.w, r29.xyzx, r30.xyzx
        add r22.w, r22.w, -cb10[r21.z + 11].z
        ge r23.w, r22.w, l(0.000000)
        max r22.w, r13.w, |r22.w|
        movc r22.w, r23.w, r22.w, -r22.w
        max r21.w, -r21.w, l(0.00000010)
        div r21.w, r22.w, r21.w
        min r21.y, |r21.w|, r21.y
        mov r30.x, cb10[r21.z + 11].w
        mov r30.yz, cb10[r21.z + 12].xxyx
        dp3 r21.w, r18.xyzx, r30.xyzx
        dp3 r22.w, r29.xyzx, r30.xyzx
        add r22.w, r22.w, -cb10[r21.z + 12].z
        ge r23.w, r22.w, l(0.000000)
        max r22.w, r13.w, |r22.w|
        movc r22.w, r23.w, r22.w, -r22.w
        max r21.w, -r21.w, l(0.00000010)
        div r21.w, r22.w, r21.w
        min r21.y, |r21.w|, r21.y
        mov r30.x, cb10[r21.z + 12].w
        mov r30.yz, cb10[r21.z + 13].xxyx
        dp3 r21.w, r18.xyzx, r30.xyzx
        dp3 r22.w, r29.xyzx, r30.xyzx
        add r22.w, r22.w, -cb10[r21.z + 13].z
        ge r23.w, r22.w, l(0.000000)
        max r22.w, r13.w, |r22.w|
        movc r22.w, r23.w, r22.w, -r22.w
        max r21.w, -r21.w, l(0.00000010)
        div r21.w, r22.w, r21.w
        min r21.y, |r21.w|, r21.y
        add r30.x, r29.x, cb10[r21.z + 3].w
        add r30.yz, r29.yyzy, cb10[r21.z + 4].xxyx
        ...
        mov r32.x, cb10[r21.z + 0].w
        mov r32.y, cb10[r21.z + 1].z
        mov r32.z, cb10[r21.z + 2].y
        dp3 r33.x, r30.xyzx, r32.xyzx
        mov r34.xy, cb10[r21.z + 1].xwxx
        mov r34.z, cb10[r21.z + 2].z
        dp3 r33.y, r30.xyzx, r34.xyzx
        mov r35.x, cb10[r21.z + 1].y
        mov r35.yz, cb10[r21.z + 2].xxwx
        dp3 r33.z, r30.xyzx, r35.xyzx
        ubfe r21.w, l(9), l(16), cb10[r21.z + 7].z
        utof r33.w, r21.w
        ...
        mad_sat r29.xyz, r36.xyzx, cb10[r21.z + 3].xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
        mul r36.xy, r29.xyxx, cb10[r21.z + 4].zwzz
        mul r36.z, r29.z, cb10[r21.z + 5].x
        add r21.yzw, r36.xxyz, cb10[r21.z + 5].yyzw
        dp3 r33.x, r12.xyzx, r32.xyzx
        dp3 r33.y, r12.xyzx, r34.xyzx
        dp3 r33.z, r12.xyzx, r35.xyzx
        lt r29.xyz, l(0.000000, 0.000000, 0.000000, 0.000000), r33.xyzx
        movc r20.z, r29.x, l(0), l(0.500000)
        add r31.xzw, r20.xxyz, r21.yyzw
        sample_l_indexable(texture3d)(float,float,float,float) r31.xzw, r31.xzwx, t17.xwyz, s4, l(0.000000)
        mul r32.xyz, r33.xyzx, r33.xyzx
        mul r32.xyz, r19.xxxx, r32.xyzx
        movc r22.z, r29.y, l(0), l(0.500000)
        add r29.xyw, r21.yzyw, r22.xyxz
        ...
        mad r29.xyw, r31.xzxw, r32.xxxx, r29.xyxw
        movc r23.z, r29.z, l(0), l(0.500000)
        add r21.yzw, r21.yyzw, r23.xxyz
        sample_l_indexable(texture3d)(float,float,float,float) r21.yzw, r21.yzwy, t19.wxyz, s4, l(0.000000)
        mad r21.yzw, r21.yyzw, r32.zzzz, r29.xxyw
        sample_l_indexable(texturecubearray)(float,float,float,float) r29.xyz, r33.xyzw, t8.xyzw, s2, l(6.000000)
        mul r31.xzw, r21.yyzw, r29.xxyz
        dp3 r20.z, r31.xzwx, l(0.212600, 0.715200, 0.072200, 0.000000)
        mad r28.xyz, r21.yzwy, r29.xyzx, r28.xyzx
...
if_nz r2.y
  ...
  if_nz r2.y
    ...
    if_nz r3.y
      ...
      mad r22.xyz, r12.xyzx, r3.yyyy, r11.xyzx
      ...
      mad r3.yw, r23.xxxy, l(0.000000, 0.500000, 0.000000, -0.500000), l(0.000000, 0.500000, 0.000000, 0.500000)
      add r23.x, r3.y, cb9[r2.z + 9].w
      add r23.y, r3.w, cb9[r2.z + 10].x
      mul r3.yw, r23.xxxy, cb9[r2.z + 9].yyyz
      div r14.zw, cb9[r2.z + 3].yyyy, cb9[r2.z + 8].yyyw
      add r23.xy, -r14.zwzz, l(1.000000, 1.000000, 0.000000, 0.000000)
      ge r23.xy, r3.ywyy, r23.xyxx
      ge r14.zw, r14.zzzw, r3.yyyw
      or r14.zw, r14.zzzw, r23.xxxy
      or r5.z, r14.w, r14.z
      if_z r5.z
        ...
        mad r22.x, r3.y, cb9[r2.z + 8].y, cb9[r2.z + 8].z
        mad r22.y, r3.w, cb9[r2.z + 8].w, cb9[r2.z + 9].x
        ...
        if_nz cb2[58].y
          ...
          loop 
            ige r9.w, r7.w, l(8)
            breakc_nz r9.w
            dp2 r25.x, icb[r7.w + 0].yxyy, r23.xyxx
            dp2 r25.y, icb[r7.w + 0].yxyy, r23.yzyy
            mad r24.xy, r25.xyxx, cb9[r2.z + 3].yyyy, r22.xyxx
            sample_c_lz_indexable(texture2darray)(float,float,float,float) r9.w, r24.xyzx, t9.xxxx, s13, r3.y
            mad r5.z, r9.w, l(0.125000), r5.z
            iadd r7.w, r7.w, l(1)
          endloop 
        else 
          utof r22.z, r3.w
          sample_c_lz_indexable(texture2darray)(float,float,float,float) r5.z, r22.xyzx, t9.xxxx, s13, r3.y
        endif 
        mul r2.z, r5.z, r5.z
        mul r2.z, r5.z, r2.z
      else 
    ...
    mad r23.yzw, r2.yyyy, r10.yyzw, r21.xxyz
    ...
    mad r2.yzw, r2.zzzz, r10.yyzw, r20.zzxy
...
ret 
// Approximately 2341 instruction slots used
