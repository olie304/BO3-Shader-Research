...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  if (useAlphaControls != 0) {
    ...
    r1.w = dot(r4.xyz, v3.xyz);
    r1.w = r1.w * r1.w;
    r1.w = saturate(r1.w * w2.x + w2.y);
    r1.w = r1.w * r0.w;
    r4.xy = (int2)v0.xy;
    r4.zw = float2(0,0);
