...
r0.y = samplerLinear[]..swiz;
  ...
  r10.y = samplerLinear[]..swiz;
    ...
    while (true) {
      ...
      r14.w = (int)r13.w * 6;
      r15.w = dot(refProbeAttenuationConstantsCB[r14.w].data[0].xyz, r16.yzw);
      r15.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[0].w + r15.w);
      r17.y = dot(refProbeAttenuationConstantsCB[r14.w].data[1].xyz, r16.yzw);
      r17.y = saturate(refProbeAttenuationConstantsCB[r14.w].data[1].w + r17.y);
      r15.w = r17.y * r15.w;
      r17.y = dot(refProbeAttenuationConstantsCB[r14.w].data[2].xyz, r16.yzw);
      r17.y = saturate(refProbeAttenuationConstantsCB[r14.w].data[2].w + r17.y);
      r15.w = r17.y * r15.w;
      r17.y = dot(refProbeAttenuationConstantsCB[r14.w].data[3].xyz, r16.yzw);
      r17.y = saturate(refProbeAttenuationConstantsCB[r14.w].data[3].w + r17.y);
      r15.w = r17.y * r15.w;
      r17.y = dot(refProbeAttenuationConstantsCB[r14.w].data[4].xyz, r16.yzw);
      r17.y = saturate(refProbeAttenuationConstantsCB[r14.w].data[4].w + r17.y);
      r15.w = r17.y * r15.w;
      r17.y = dot(refProbeAttenuationConstantsCB[r14.w].data[5].xyz, r16.yzw);
      r14.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[5].w + r17.y);
      r19.x = r15.w * r14.w;
      r14.w = 1 & (int)refProbeConstantsCB[r10.w].data[6].x;
      r17.yz = r14.ww ? r19.xy : r19.zx;
      r14.w = refProbeConstantsCB[r10.w].data[6].x;
      r28.xy = r17.yz;
      r15.w = 1;
      while (true) {
        r17.w = cmp((int)r15.w >= (int)r14.z);
        if (r17.w != 0) break;
        r17.w = (int)r13.w + (int)r15.w;
        r17.w = (int)r17.w * 6;
        r19.x = dot(refProbeAttenuationConstantsCB[r17.w].data[0].xyz, r16.yzw);
        r19.x = saturate(refProbeAttenuationConstantsCB[r17.w].data[0].w + r19.x);
        r19.x = r28.x * r19.x;
        r19.w = dot(refProbeAttenuationConstantsCB[r17.w].data[1].xyz, r16.yzw);
        r19.w = saturate(refProbeAttenuationConstantsCB[r17.w].data[1].w + r19.w);
        r19.x = r19.x * r19.w;
        r19.w = dot(refProbeAttenuationConstantsCB[r17.w].data[2].xyz, r16.yzw);
        r19.w = saturate(refProbeAttenuationConstantsCB[r17.w].data[2].w + r19.w);
        r19.x = r19.x * r19.w;
        r19.w = dot(refProbeAttenuationConstantsCB[r17.w].data[3].xyz, r16.yzw);
        r19.w = saturate(refProbeAttenuationConstantsCB[r17.w].data[3].w + r19.w);
        r19.x = r19.x * r19.w;
        r19.w = dot(refProbeAttenuationConstantsCB[r17.w].data[4].xyz, r16.yzw);
        r19.w = saturate(refProbeAttenuationConstantsCB[r17.w].data[4].w + r19.w);
        r19.x = r19.x * r19.w;
        r19.w = dot(refProbeAttenuationConstantsCB[r17.w].data[5].xyz, r16.yzw);
        ...
        r17.w = -r19.x * r17.w + 1;
        r17.w = r28.y * r17.w;
        r21.y = r21.z ? r17.w : r21.w;
        r28.xy = r20.ww ? r28.xy : r21.xy;
        r15.w = (int)r15.w + 1;
        r14.w = r19.w;
      }
      r28.y = saturate(r28.y);
      r13.w = refProbeConstantsCB[r10.w].data[6].y * r28.y;
      r14.z = cmp(0 < r13.w);
      if (r14.z != 0) {
        r27.z = r28.y * refProbeConstantsCB[r10.w].data[6].y + r27.z;
        r13.w = refProbeConstantsCB[r10.w].data[7].y * r13.w;
        r29.x = refProbeConstantsCB[r10.w].data[7].w;
        r29.yz = refProbeConstantsCB[r10.w].data[8].xy;
        r14.z = dot(r18.xyz, r29.xyz);
        r14.w = dot(r16.yzw, r29.xyz);
        ...
        r29.x = refProbeConstantsCB[r10.w].data[8].w;
        r29.yz = refProbeConstantsCB[r10.w].data[9].xy;
        r14.w = dot(r18.xyz, r29.xyz);
        r15.w = dot(r16.yzw, r29.xyz);
        ...
        r29.x = refProbeConstantsCB[r10.w].data[9].w;
        r29.yz = refProbeConstantsCB[r10.w].data[10].xy;
        r14.w = dot(r18.xyz, r29.xyz);
        r15.w = dot(r16.yzw, r29.xyz);
        ...
        r14.w = r15.w / r14.w;
        r14.z = min(r14.z, abs(r14.w));
        r29.x = refProbeConstantsCB[r10.w].data[10].w;
        r29.yz = refProbeConstantsCB[r10.w].data[11].xy;
        r14.w = dot(r18.xyz, r29.xyz);
        r15.w = dot(r16.yzw, r29.xyz);
        ...
        r14.w = r15.w / r14.w;
        r14.z = min(r14.z, abs(r14.w));
        r29.x = refProbeConstantsCB[r10.w].data[11].w;
        r29.yz = refProbeConstantsCB[r10.w].data[12].xy;
        r14.w = dot(r18.xyz, r29.xyz);
        r15.w = dot(r16.yzw, r29.xyz);
        ...
        r14.w = r15.w / r14.w;
        r14.z = min(r14.z, abs(r14.w));
        r29.x = refProbeConstantsCB[r10.w].data[12].w;
        r29.yz = refProbeConstantsCB[r10.w].data[13].xy;
        r14.w = dot(r18.xyz, r29.xyz);
        r15.w = dot(r16.yzw, r29.xyz);
        ...
        r14.w = r15.w / r14.w;
        r14.z = min(r14.z, abs(r14.w));
        r29.x = refProbeConstantsCB[r10.w].data[3].w + r16.y;
        r29.yz = refProbeConstantsCB[r10.w].data[4].xy + r16.zw;
        r17.yzw = r18.xyz * r14.zzz + r29.xyz;
        ...
        r29.x = refProbeConstantsCB[r10.w].data[0].w;
        r29.y = refProbeConstantsCB[r10.w].data[1].z;
        r29.z = refProbeConstantsCB[r10.w].data[2].y;
        r30.x = dot(r17.yzw, r29.xyz);
        r31.xy = refProbeConstantsCB[r10.w].data[1].xw;
        r31.z = refProbeConstantsCB[r10.w].data[2].z;
        r30.y = dot(r17.yzw, r31.xyz);
        r32.x = refProbeConstantsCB[r10.w].data[1].y;
        r32.yz = refProbeConstantsCB[r10.w].data[2].xw;
        r30.z = dot(r17.yzw, r32.xyz);
        ...
        r30.w = (uint)r14.w;
        r17.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r30.xyzw, r14.z).xyz;
        r33.x = dot(r16.yzw, r29.xyz);
        r33.y = dot(r16.yzw, r31.xyz);
        r33.z = dot(r16.yzw, r32.xyz);
        r16.yzw = saturate(r33.xyz * refProbeConstantsCB[r10.w].data[3].xyz + float3(0.5,0.5,0.5));
        r33.xy = refProbeConstantsCB[r10.w].data[4].zw * r16.yz;
        r33.z = refProbeConstantsCB[r10.w].data[5].x * r16.w;
        r16.yzw = refProbeConstantsCB[r10.w].data[5].yzw + r33.xyz;
        r30.x = dot(r12.xyz, r29.xyz);
        r30.y = dot(r12.xyz, r31.xyz);
        r30.z = dot(r12.xyz, r32.xyz);
        r21.yzw = cmp(float3(0,0,0) < r30.xyz);
        r20.z = r21.y ? 0 : 0.5;
        r28.xzw = r20.xyz + r16.yzw;
        ...
        r31.xyz = r31.xyz * r29.yyy;
        r28.xzw = r28.xzw * r29.xxx + r31.xyz;
        r23.z = r21.w ? 0 : 0.5;
        r16.yzw = r23.xyz + r16.yzw;
        r16.yzw = gProbeZArray.SampleLevel(samplerLinearClamp_s, r16.yzw, 0).xyz;
        r16.yzw = r16.yzw * r29.zzz + r28.xzw;
        r21.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r30.xyzw, 6).xyz;
        r28.xzw = r21.yzw * r16.yzw;
        r10.w = dot(r28.xzw, float3(0.212599993,0.715200007,0.0722000003));
        r26.xyz = r16.yzw * r21.yzw + r26.xyz;
        r14.z = r10.w * r3.w;
        r16.yzw = r17.yzw * r13.www;
        r13.w = dot(r16.yzw, float3(0.212599993,0.715200007,0.0722000003));
        r10.w = r3.w * r10.w + r13.w;
        r10.w = r14.z / r10.w;
        r29.x = r26.w;
        r29.yz = r27.xy;
        r27.xyw = r16.zwy * r10.www + r29.yzx;
        r26.w = r27.w;
      }
    }
    r24.xyzw = r26.xyzw;
  ...
  if (r7.w != 0) {
    ...
    r9.w = samplerLinear[]..swiz;
      ...
      while (true) {
        ...
        r14.w = (int)r14.w * 14;
        r17.yzw = -refProbeConstantsCB[r14.w].data[0].xyz + r11.xyz;
        ...
        r15.w = saturate(r28.y + -r13.w);
        r19.x = refProbeConstantsCB[r14.w].data[6].y * r15.w;
        r19.w = cmp(0 < r19.x);
        if (r19.w != 0) {
          r27.w = r15.w * refProbeConstantsCB[r14.w].data[6].y + r27.w;
          r15.w = refProbeConstantsCB[r14.w].data[7].y * r19.x;
          ...
          r19.w = r20.w / r19.w;
          r19.x = min(r19.x, abs(r19.w));
          r29.x = refProbeConstantsCB[r14.w].data[3].w + r17.y;
          r29.yz = refProbeConstantsCB[r14.w].data[4].xy + r17.zw;
          ...
          r17.yzw = saturate(r33.xyz * refProbeConstantsCB[r14.w].data[3].xyz + float3(0.5,0.5,0.5));
          r33.xy = refProbeConstantsCB[r14.w].data[4].zw * r17.yz;
          r33.z = refProbeConstantsCB[r14.w].data[5].x * r17.w;
          r17.yzw = refProbeConstantsCB[r14.w].data[5].yzw + r33.xyz;
          r30.x = dot(r12.xyz, r29.xyz);
          r30.y = dot(r12.xyz, r31.xyz);
          r30.z = dot(r12.xyz, r32.xyz);
          ...
          r16.yzw = r17.yzw * r28.xzw + r16.yzw;
          r17.y = r14.w * r3.w;
          r21.yzw = r21.yzw * r15.www;
          r15.w = dot(r21.yzw, float3(0.212599993,0.715200007,0.0722000003));
          r14.w = r3.w * r14.w + r15.w;
          r14.w = r17.y / r14.w;
          r27.xyz = r21.yzw * r14.www + r27.xyz;
        }
      }
      r26.xyzw = r27.xyzw;
      r10.yzw = r16.yzw;
  ...
  if (r0.z != 0) {
    ...
    r2.w = dot(r17.yzw, float3(0.212599993,0.715200007,0.0722000003));
    r10.yzw = r24.xyz * r0.yyy + r17.yzw;
    r18.w = 0;
    r3.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r18.xyzw, r3.y).xyz;
  ...
  while (true) {
    ...
    switch (r7.w) {
      ...
      r14.z = saturate(r13.w);
      r14.z = r3.x ? abs(r13.w) : r14.z;
      r14.w = cmp(0 < r14.z);
      if (r14.w != 0) {
        r14.w = sqrt(r12.w);
        r15.w = lightConstantsCB[r6.w].data[3].x * lightConstantsCB[r6.w].data[3].x;
        r12.w = r15.w / r12.w;
        r12.w = min(1, r12.w);
        ...
        if (r14.w != 0) {
          ...
          if (r14.w != 0) {
            ...
            while (true) {
              ...
              r37.x = r37.y * r17.x;
              r37.w = r37.y * r16.x;
              r36.xyz = r35.xyz * r15.www + r37.xzw;
          ...
          if (r14.w != 0) {
            ...
            r14.w = 0.25 * r14.w;
            r15.w = dot(r32.xyz, r18.xyz);
            r21.w = dot(r18.xyz, r34.xyz);
            r26.w = -r15.w * r15.w + lightConstantsCB[r6.w].data[6].y;
            r8.w = r15.w * r21.w + -r8.w;
            r8.w = saturate(r8.w / r26.w);
            r15.w = r26.w / lightConstantsCB[r6.w].data[6].y;
            r15.w = 10 * r15.w;
            r15.w = min(1, r15.w);
            r8.w = r8.w + -r9.w;
            ...
            if (r9.w != 0) {
              ...
              r9.w = abs(r13.w) * -0.200000003 + 0.400000006;
              r15.w = cmp(r13.w < 0);
              r15.w = r3.x ? r15.w : 0;
              r9.w = r15.w ? -r9.w : r9.w;
              ...
              r15.w = dot(r34.xyzw, r20.xyzw);
              r21.w = cmp(r15.w < r9.w);
              if (r21.w == 0) {
                ...
                if (r20.z == 0) {
                  ...
                  r20.x = lightConstantsCB[r8.w].data[10].z * r15.w;
              ...
              if (r15.w == 0) {
                ...
                if (enableDitheredShadow != 0) {
                  ...
                  while (true) {
                    ...
                    r35.y = dot(icb[r26.w+0].xy, r14.xy);
              ...
              if (r9.w != 0) {
                ...
                if (r20.x == 0) {
                  ...
                  if (r22.x == 0) {
                    ...
                    r20.y = lightConstantsCB[r8.w].data[10].z * r15.w;
                    r9.w = lightConstantsCB[r8.w].data[10].y * r15.w + r9.w;
                    r9.w = r9.w / r20.y;
                  }
                } else {
                ...
                if (r15.w == 0) {
                  ...
                  if (enableDitheredShadow != 0) {
                    ...
                    while (true) {
                      ...
                      if (r22.z != 0) break;
                      r35.x = dot(icb[r22.y+0].xy, r15.xy);
                      r35.y = dot(icb[r22.y+0].yx, r15.xz);
                      r20.xy = r35.xy * lightConstantsCB[r8.w].data[3].yy + r34.xy;
                      r20.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r20.xyz, r9.w).x;
            ...
            r32.xyz = r32.xyz * r7.www + r13.xyz;
            r7.w = dot(r32.xyz, r32.xyz);
            r7.w = rsqrt(r7.w);
            r32.xyz = r32.xyz * r7.www;
            r7.w = dot(r32.xyz, r13.xyz);
            r14.z = dot(r12.xyz, r32.xyz);
            r15.w = abs(r14.z) * r0.w + -abs(r14.z);
            r14.z = abs(r14.z) * r15.w + 1;
            r15.w = r13.w * r0.y + r0.z;
            r14.z = r14.z * r14.z;
            r14.z = r14.z * r15.w;
            r14.z = rcp(r14.z);
            r13.w = r13.w * r14.w;
      ...
      if (r13.w != 0) {
        ...
        if (r14.z != 0) {
          ...
          r15.w = dot(r34.xyz, r34.xyz);
          r14.w = r14.w / r15.w;
          r14.w = min(1, r14.w);
          r22.yz = saturate(r13.ww * lightConstantsCB[r6.w].data[2].xz + lightConstantsCB[r6.w].data[2].yw);
          ...
          r13.w = cmp(lightConstantsCB[r6.w].data[10].w < 0.00048828125);
          if (r13.w != 0) {
            ...
            r22.yz = exp2(r22.yz);
            r15.w = lightConstantsCB[r6.w].data[12].x * r22.y;
            r22.y = lightConstantsCB[r6.w].data[12].y * r22.z + -1;
            r15.w = lightConstantsCB[r6.w].data[12].y * r22.z + -r15.w;
            r15.w = saturate(r22.y / r15.w);
            r22.y = r15.w * r15.w;
            r15.w = r15.w * -2 + 3;
            r13.w = r22.y * r15.w;
          }
          r14.z = r14.w * r13.w;
          r13.w = 255 & (int)lightConstantsCB[r6.w].data[14].w;
          if (r13.w != 0) {
        ...
        if (r13.w != 0) {
          ...
          if (r13.w != 0) {
            r13.w = abs(r8.w) * -0.200000003 + 0.400000006;
            r14.w = cmp(r8.w < 0);
            r14.w = r3.x ? r14.w : 0;
            ...
            if (r15.w != 0) {
              ...
              if (enableDitheredShadow != 0) {
                ...
                while (true) {
                  ...
                  r21.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r32.xyz, r13.w).x;
                  r15.w = r21.y * 0.125 + r15.w;
                  r21.x = (int)r21.x + 1;
                }
              } else {
                r23.z = (uint)r14.w;
                r15.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r23.xyz, r13.w).x;
              }
              r13.w = r15.w * r15.w;
              r13.w = r13.w * r15.w;
            } else {
          ...
          r14.z = cmp(0 < r13.w);
          if (r14.z != 0) {
            r14.z = lightConstantsCB[r6.w].data[1].z * r0.w;
            r14.z = r14.z * r9.w;
            ...
            r20.xyz = r20.xyz * r7.www + r13.xyz;
            r7.w = dot(r20.xyz, r20.xyz);
            r7.w = rsqrt(r7.w);
            r20.xyz = r20.xyz * r7.www;
            r7.w = dot(r20.xyz, r13.xyz);
