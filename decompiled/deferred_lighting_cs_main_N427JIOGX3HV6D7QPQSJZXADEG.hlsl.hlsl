...
r0.y = samp0[]..swiz;
  ...
  if (r6.w == 0) {
    ...
    if (r8.w != 0) {
      ...
      while (true) {
        ...
        r9.w = sunConstants.splitPinTransform[r10.w].z * r14.y;
        r10.w = cmp(r9.w < 1);
        if (r10.w != 0) {
          break;
        }
    ...
    if (r10.w == 0) {
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          if (r16.w != 0) break;
          r16.w = cmp((uint)r9.w < (uint)r14.w);
          r17.xy = r16.ww ? r13.yz : r14.yz;
          r17.z = r16.w ? sunConstants.splitPinTransform[r8.w].w : sunConstants.splitPinTransform[r10.w].w;
          r16.w = r16.w ? r8.w : r10.w;
          ...
          r17.z = (uint)r16.w;
          r16.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r17.xyz, r6.w).x;
  ...
  r0.y = 0;
  while (true) {
    r14.y = cmp((int)r0.y == 2);
    if (r14.y != 0) break;
    r14.y = r0.y ? r0.x : r13.z;
    r14.z = cmp((uint)r14.y >= (uint)r13.y);
    r14.w = cmp((uint)r14.y < numRefProbes);
    r14.z = r14.w ? r14.z : 0;
    if (r14.z != 0) {
      r14.y = (int)r14.y * 14;
      if (r2.w != 0) {
      ...
      r24.w = (int)r23.w + 1;
      r16.yzw = -refProbeConstantsCB[r14.y].data[0].xyz + r11.xyz;
      ...
      r14.z = refProbeConstantsCB[r14.y].data[6].y * r25.y;
      r14.w = cmp(0 < r14.z);
      if (r14.w != 0) {
        r14.w = (int)r24.w & 7;
        r17.x = (int)r14.w + -1;
        ...
        r23.w = (int)r23.w + 257;
        r23.z = r25.y * refProbeConstantsCB[r14.y].data[6].y + r23.z;
        ...
        r17.x = r17.w / r17.x;
        r14.w = min(abs(r17.x), r14.w);
        r26.x = refProbeConstantsCB[r14.y].data[3].w + r16.y;
        r26.yz = refProbeConstantsCB[r14.y].data[4].xy + r16.zw;
        r25.xzw = r15.xyz * r14.www + r26.xyz;
        ...
        r27.w = (uint)r17.x;
        r25.xzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r27.xyzw, r14.w).xyz;
        ...
        r16.yzw = saturate(r30.xyz * refProbeConstantsCB[r14.y].data[3].xyz + float3(0.5,0.5,0.5));
        r30.xy = refProbeConstantsCB[r14.y].data[4].zw * r16.yz;
        r30.z = refProbeConstantsCB[r14.y].data[5].x * r16.w;
        r16.yzw = refProbeConstantsCB[r14.y].data[5].yzw + r30.xyz;
        ...
        r14.y = (int)r27.y | (int)r27.x;
        r14.y = (int)r27.z | (int)r14.y;
        r26.xyz = r14.yyy ? float3(1,1,0) : r26.xyz;
        r27.xyz = r26.xyz * r16.yzw;
        r14.y = dot(r27.xyz, float3(0.212599993,0.715200007,0.0722000003));
        r22.xyz = r16.yzw * r26.xyz + r22.xyz;
        r14.w = r14.y * r10.w;
        r16.yzw = r25.xzw * r14.zzz;
        r14.z = dot(r16.yzw, float3(0.212599993,0.715200007,0.0722000003));
        r14.y = r10.w * r14.y + r14.z;
        r14.y = r14.w / r14.y;
        r26.x = r22.w;
        r26.yz = r23.xy;
        r14.yzw = r16.yzw * r14.yyy + r26.xyz;
        r22.w = r14.y;
        r23.xy = r14.zw;
      } else {
        r24.xyz = r23.xyz;
  ...
  r0.y = 0;
  while (true) {
    r17.w = cmp((int)r0.y == 2);
    if (r17.w != 0) break;
    r17.w = r0.y ? r0.x : r13.z;
    r18.w = cmp((uint)r17.w < (uint)r13.y);
    if (r18.w != 0) {
      r17.w = (int)r17.w * 14;
      if (r2.w != 0) {
        r18.w = (int)r19.y & 15;
      ...
      r25.y = (int)r19.y + 1;
      r16.yzw = -refProbeConstantsCB[r17.w].data[0].xyz + r11.xyz;
      ...
      r25.z = dot(refProbeAttenuationConstantsCB[r21.w].data[1].xyz, r16.yzw);
      r25.z = saturate(refProbeAttenuationConstantsCB[r21.w].data[1].w + r25.z);
      r24.w = r25.z * r24.w;
      r25.z = dot(refProbeAttenuationConstantsCB[r21.w].data[2].xyz, r16.yzw);
      r25.z = saturate(refProbeAttenuationConstantsCB[r21.w].data[2].w + r25.z);
      r24.w = r25.z * r24.w;
      r25.z = dot(refProbeAttenuationConstantsCB[r21.w].data[3].xyz, r16.yzw);
      r25.z = saturate(refProbeAttenuationConstantsCB[r21.w].data[3].w + r25.z);
      r24.w = r25.z * r24.w;
      r25.z = dot(refProbeAttenuationConstantsCB[r21.w].data[4].xyz, r16.yzw);
      r25.z = saturate(refProbeAttenuationConstantsCB[r21.w].data[4].w + r25.z);
      r24.w = r25.z * r24.w;
      r25.z = dot(refProbeAttenuationConstantsCB[r21.w].data[5].xyz, r16.yzw);
      r21.w = saturate(refProbeAttenuationConstantsCB[r21.w].data[5].w + r25.z);
      r17.x = r24.w * r21.w;
      r21.w = 1 & (int)refProbeConstantsCB[r17.w].data[6].x;
      r25.zw = r21.ww ? r17.xy : r17.zx;
      ...
      while (true) {
        ...
        r24.w = (int)r24.w * 6;
        r26.z = dot(refProbeAttenuationConstantsCB[r24.w].data[0].xyz, r16.yzw);
        r26.z = saturate(refProbeAttenuationConstantsCB[r24.w].data[0].w + r26.z);
        r26.z = r26.x * r26.z;
        ...
        r24.w = -r26.z * r24.w + 1;
        r24.w = r26.y * r24.w;
        r19.w = r27.y ? r24.w : r27.z;
        r26.xy = r27.xx ? r26.xy : r19.zw;
        r21.w = (int)r21.w + 1;
        r17.x = r26.w;
      }
      ...
      if (r19.w != 0) {
        ...
        r20.w = r20.w ? r2.w : 0;
        if (r20.w != 0) {
          r25.zw = mad((int2)r19.ww, int2(20,20), int2(860,876));
        // Known bad code for instruction (needs manual fix):
        ...
        r19.y = (int)r19.y + 257;
        r19.x = r17.x * refProbeConstantsCB[r17.w].data[6].y + r19.x;
        ...
        r18.w = dot(r15.xyz, r27.xyz);
        r19.w = dot(r16.yzw, r27.xyz);
        ...
        r19.w = r20.w / r19.w;
        r18.w = min(abs(r19.w), r18.w);
        r27.x = refProbeConstantsCB[r17.w].data[3].w + r16.y;
        r27.yz = refProbeConstantsCB[r17.w].data[4].xy + r16.zw;
        r26.xzw = r15.xyz * r18.www + r27.xyz;
        r19.w = dot(r26.xzw, r26.xzw);
        r19.w = sqrt(r19.w);
        r18.w = r18.w / r19.w;
        r18.w = r18.w + r18.w;
        r18.w = sqrt(r18.w);
        ...
        r28.w = (uint)r19.w;
        r26.xzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r28.xyzw, r18.w).xyz;
        ...
        r18.w = (int)r31.z | (int)r18.w;
        r26.xzw = r18.www ? float3(1,1,0) : r26.xzw;
        ...
        r17.w = (int)r28.y | (int)r28.x;
        r17.w = (int)r28.z | (int)r17.w;
        r27.xyz = r17.www ? float3(1,1,0) : r27.xyz;
        r28.xyz = r27.xyz * r16.yzw;
        r17.w = dot(r28.xyz, float3(0.212599993,0.715200007,0.0722000003));
        r14.yzw = r16.yzw * r27.xyz + r14.yzw;
        r16.y = r17.w * r10.w;
        r26.xzw = r26.xzw * r17.xxx;
        r16.z = dot(r26.xzw, float3(0.212599993,0.715200007,0.0722000003));
        r16.z = r10.w * r17.w + r16.z;
        r16.y = r16.y / r16.z;
        r24.xyz = r26.xzw * r16.yyy + r24.xyz;
      } else {
        r25.x = r19.x;
        r19.xy = r25.xy;
      }
  ...
  r6.w = cmp(r19.x < 0.99000001);
  if (r6.w != 0) {
    r0.x = (int)r0.x + 256;
    r6.w = 1 + -r19.x;
    r9.w = sunConstants.globalProbeExposure * r6.w;
    ...
    r15.w = 0;
    r14.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r15.xyzw, r8.w).xyz;
    r0.y = sunConstants.globalProbeExposure * r6.w + -r9.w;
    r0.y = r2.y * r0.y + r9.w;
  ...
  r18.xyz = r16.xyz * r5.zzz;
  r19.xyz = r4.zzz ? r18.yzx : 0;
  ...
  r17.xyz = r14.yzw * r13.yyy;
  r20.xyz = r14.yzw * r13.zzz;
  r0.y = sqrt(r2.z);
  r0.y = r0.y * 0.5 + 0.5;
  r0.y = r0.y * r0.y;
  r2.y = 0.5 * r0.y;
  ...
  if (r6.w != 0) {
    ...
    r6.w = cmp(0 < r7.w);
    if (r6.w != 0) {
      r6.w = sunConstants.specScale * r1.w;
      r6.w = r6.w * r3.z;
      if (sunConstants.sunCookieIndex != 0) {
        r21.xyz = eyeOffset.xyz + r11.xyz;
        r21.w = 1;
        r8.w = dot(sunConstants.sunCookieTransform[0].xyzw, r21.xyzw);
        r9.w = dot(sunConstants.sunCookieTransform[1].xyzw, r21.xyzw);
        r21.x = frac(r8.w);
        r21.y = frac(r9.w);
        r8.w = -1 + (int14)sunConstants.sunCookieIndex;
        r21.z = (uint)r8.w;
        r14.yzw = gCookieArray.SampleLevel(samplerLinear_s, r21.xyz, 0).xyz;
      ...
      if (r9.w != 0) {
        ...
        r22.xyz = lightConstantsCB[r8.w].data[4].yzw;
        r22.w = lightConstantsCB[r8.w].data[5].x;
        r21.w = 1;
        r22.x = dot(r22.xyzw, r21.xyzw);
        r23.xyz = lightConstantsCB[r8.w].data[5].yzw;
        r23.w = lightConstantsCB[r8.w].data[6].x;
        r22.y = dot(r23.xyzw, r21.xyzw);
        r13.yz = r22.xy * float2(0.5,-0.5) + float2(0.5,0.5);
        r22.x = lightConstantsCB[r8.w].data[9].w + r13.y;
        r22.y = lightConstantsCB[r8.w].data[10].x + r13.z;
        r13.yz = lightConstantsCB[r8.w].data[9].yz * r22.xy;
        r22.xy = lightConstantsCB[r8.w].data[3].yy / lightConstantsCB[r8.w].data[8].yw;
        r22.zw = float2(1,1) + -r22.xy;
        r22.zw = cmp(r13.yz >= r22.zw);
        r22.xy = cmp(r22.xy >= r13.yz);
        r22.xy = (int2)r22.xy | (int2)r22.zw;
        r9.w = (int)r22.y | (int)r22.x;
        if (r9.w == 0) {
          r22.xyz = lightConstantsCB[r8.w].data[6].yzw;
          r22.w = lightConstantsCB[r8.w].data[7].x;
          r9.w = dot(r22.xyzw, r21.xyzw);
          r13.yz = saturate(r13.yz);
          r21.x = r13.y * lightConstantsCB[r8.w].data[8].y + lightConstantsCB[r8.w].data[8].z;
          r21.y = r13.z * lightConstantsCB[r8.w].data[8].w + lightConstantsCB[r8.w].data[9].x;
          ...
          if (enableDitheredShadow != 0) {
            ...
            while (true) {
              ...
              if (r13.z != 0) break;
              r24.x = dot(icb[r13.y+0].yx, r22.xy);
              r24.y = dot(icb[r13.y+0].yx, r22.yz);
              r23.xy = r24.xy * lightConstantsCB[r8.w].data[3].yy + r21.xy;
              r13.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r23.xyz, r9.w).x;
      ...
      r3.w = r2.z * r8.w + r3.w;
      r3.w = r3.w * r7.w;
      r21.xyz = r3.www * r14.yzw;
      r3.y = cmp(0 < r3.y);
      r16.xyz = r16.xyz * r5.zzz + r21.xyz;
      ...
      r8.w = abs(r5.z) * r1.w + -abs(r5.z);
      r5.z = abs(r5.z) * r8.w + 1;
      r3.z = r3.z * r0.y + r2.y;
      r5.z = r5.z * r5.z;
      r3.z = r5.z * r3.z;
      r3.z = rcp(r3.z);
      ...
      r3.z = r7.w * r3.z;
      r3.z = 0.25 * r3.z;
      r21.yzw = r3.zzz * r14.yzw + r20.xyz;
      r1.z = saturate(1 + -r1.z);
      r5.z = r1.z * r1.z;
      r5.z = r5.z * r5.z;
      r1.z = r5.z * r1.z;
      r1.z = r3.z * r1.z;
      r22.xyz = r1.zzz * r14.yzw + r17.xyz;
      r14.yzw = r3.www * r14.yzw + r19.zxy;
      r23.xyz = r4.zzz ? r14.zwy : 0;
      r16.w = r19.z;
      r18.w = r23.z;
      r18.xyzw = r3.yyyy ? r16.xyzw : r18.xyzw;
      r19.zw = r22.xy;
      r23.zw = r17.xy;
      r16.xyzw = r3.yyyy ? r19.xyzw : r23.xyzw;
      r21.x = r22.z;
      r20.w = r17.z;
      r20.xyzw = r3.yyyy ? r21.yzwx : r20.xyzw;
      if (r2.w != 0) {
      // Known bad code for instruction (needs manual fix):
  ...
  switch (r3.z) {
    case 4 :    if (r2.w != 0) {
      r16.yzw = lightConstantsCB[r3.y].data[0].xyz + eyeOffset.xyz;
      r16.x = 2;
      GBufferDiffuseColor[viewID].136 = u2.xyzw;
    }
    r3.z = (int)r1.z + 1;
    r3.w = cmp(0 < lightConstantsCB[r3.y].data[6].y);
    r16.xy = lightConstantsCB[r3.y].data[5].zw;
    r16.z = lightConstantsCB[r3.y].data[6].x;
    r13.yzw = -r16.xyz * float3(0.5,0.5,0.5) + lightConstantsCB[r3.y].data[0].xyz;
    r14.yzw = r13.yzw + -r11.xyz;
    r5.z = dot(r16.xyz, r14.yzw);
    r6.w = saturate(-r5.z / lightConstantsCB[r3.y].data[6].y);
    r21.xyz = r6.www * r16.xyz + r13.yzw;
    r21.xyz = r3.www ? r21.xyz : lightConstantsCB[r3.y].data[0].xyz;
    r21.xyz = r21.xyz + -r11.xyz;
    r7.w = dot(r21.xyz, r21.xyz);
    r8.w = rsqrt(r7.w);
    r21.xyz = r21.xyz * r8.www;
    r8.w = dot(r12.xyz, r21.xyz);
    r9.w = saturate(r8.w);
    r9.w = r4.z ? abs(r8.w) : r9.w;
    r10.w = cmp(0 < r9.w);
    if (r10.w != 0) {
      r10.w = sqrt(r7.w);
      ...
      r10.w = cmp(0 < r7.w);
      if (r10.w != 0) {
        if (3 == 0) r10.w = 0; else if (3+27 < 32) {         r10.w = (uint)lightConstantsCB[r3.y].data[1].w << (32-(3 + 27)); r10.w = (uint)r10.w >> (32-3);        } else r10.w = (uint)lightConstantsCB[r3.y].data[1].w >> 27;
        if (r2.w != 0) {
        // Known bad code for instruction (needs manual fix):
        ...
        if (r10.w != 0) {
          ...
          r21.yzw = r12.xyz * r10.www + r11.xyz;
          r21.yzw = -lightConstantsCB[r3.y].data[4].yzw + r21.yzw;
          r10.w = max(abs(r21.z), abs(r21.w));
          r10.w = max(abs(r21.y), r10.w);
          r10.w = lightConstantsCB[r3.y].data[5].x / r10.w;
          r10.w = lightConstantsCB[r3.y].data[5].y + r10.w;
          r15.w = dot(r21.yzw, r21.yzw);
          r15.w = rsqrt(r15.w);
          r10.w = max(6.10351563e-05, r10.w);
          r16.w = 0x0000ffff & (int)lightConstantsCB[r3.y].data[1].w;
          r23.x = -r13.x;
          r24.w = (uint)r16.w;
          r23.y = r14.x;
          r23.z = r13.x;
          ...
          while (true) {
            ...
            r25.yz = lightConstantsCB[r3.y].data[3].yy * r22.yz;
            r25.x = r25.y * r22.x;
            r25.w = r25.y * r21.x;
            r24.xyz = r21.yzw * r15.www + r25.xzw;
            r18.w = gOmniShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r24.xyzw, r10.w).x;
        ...
        if (r10.w != 0) {
          ...
          r10.w = 0.25 * r10.w;
          r15.w = dot(r16.xyz, r15.xyz);
          r14.y = dot(r15.xyz, r14.yzw);
          r14.z = -r15.w * r15.w + lightConstantsCB[r3.y].data[6].y;
          r5.z = r15.w * r14.y + -r5.z;
          r5.z = saturate(r5.z / r14.z);
          r14.y = r14.z / lightConstantsCB[r3.y].data[6].y;
          r14.y = 10 * r14.y;
          r14.y = min(1, r14.y);
          r5.z = r5.z + -r6.w;
          r5.z = r14.y * r5.z + r6.w;
          r13.yzw = r5.zzz * r16.xyz + r13.yzw;
          r13.yzw = r3.www ? r13.yzw : lightConstantsCB[r3.y].data[0].xyz;
          r13.yzw = r13.yzw + -r11.xyz;
          r3.w = dot(r13.yzw, r13.yzw);
          r3.w = rsqrt(r3.w);
          r14.yzw = r13.yzw * r3.www;
          if (4 == 0) r5.z = 0; else if (4+16 < 32) {           r5.z = (uint)lightConstantsCB[r3.y].data[1].w << (32-(4 + 16)); r5.z = (uint)r5.z >> (32-4);          } else r5.z = (uint)lightConstantsCB[r3.y].data[1].w >> 16;
          ...
          if (r6.w != 0) {
            ...
            r15.x = cmp(r8.w < 0);
            r15.x = r4.z ? r15.x : 0;
            r6.w = r15.x ? -r6.w : r6.w;
            r15.xyz = r12.xyz * r6.www + r11.xyz;
            r16.xyz = lightConstantsCB[r5.z].data[6].yzw;
            r16.w = lightConstantsCB[r5.z].data[7].x;
            r15.w = 1;
            r6.w = dot(r16.xyzw, r15.xyzw);
            r16.xyz = lightConstantsCB[r5.z].data[7].yzw;
            r16.w = lightConstantsCB[r5.z].data[8].x;
            r16.x = dot(r16.xyzw, r15.xyzw);
            r16.y = cmp(r16.x < r6.w);
            if (r16.y == 0) {
              ...
              r15.xy = r21.xy / r16.xx;
              r15.xy = r15.xy * float2(0.5,-0.5) + float2(0.5,0.5);
              r21.x = lightConstantsCB[r5.z].data[9].w + r15.x;
              r21.y = lightConstantsCB[r5.z].data[10].x + r15.y;
              r15.xy = lightConstantsCB[r5.z].data[9].yz * r21.xy;
              r15.zw = lightConstantsCB[r5.z].data[3].yy / lightConstantsCB[r5.z].data[8].yw;
              r16.zw = float2(1,1) + -r15.zw;
              r16.zw = cmp(r15.xy >= r16.zw);
              r15.zw = cmp(r15.zw >= r15.xy);
              r15.zw = (int2)r15.zw | (int2)r16.zw;
              r15.z = (int)r15.w | (int)r15.z;
              if (r15.z == 0) {
                r15.xy = saturate(r15.xy);
                r21.x = r15.x * lightConstantsCB[r5.z].data[8].y + lightConstantsCB[r5.z].data[8].z;
                r21.y = r15.y * lightConstantsCB[r5.z].data[8].w + lightConstantsCB[r5.z].data[9].x;
                r15.x = lightConstantsCB[r5.z].data[10].z * r16.x;
                r6.w = lightConstantsCB[r5.z].data[10].y * r16.x + r6.w;
                r6.w = r6.w / r15.x;
              }
            } else {
              r15.z = -1;
            }
            r15.x = (int)r16.y | (int)r15.z;
            if (r15.x == 0) {
              r6.w = max(6.10351563e-05, r6.w);
              r15.x = 0x0000ffff & (int)lightConstantsCB[r5.z].data[1].w;
              if (enableDitheredShadow != 0) {
                r16.x = -r13.x;
                r22.z = (uint)r15.x;
                r16.y = r14.x;
                ...
                while (true) {
                  ...
                  if (r15.w != 0) break;
                  r23.x = dot(icb[r15.z+0].yx, r16.xy);
                  r23.y = dot(icb[r15.z+0].yx, r16.yz);
                  r22.xy = r23.xy * lightConstantsCB[r5.z].data[3].yy + r21.xy;
                  r15.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r22.xyz, r6.w).x;
                  r15.y = r15.w * 0.125 + r15.y;
                  r15.z = (int)r15.z + 1;
                }
              } else {
                r21.z = (uint)r15.x;
                r15.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r21.xyz, r6.w).x;
              }
              r5.z = r15.y * r15.y;
              r5.z = r5.z * r15.y;
            } else {
            ...
            if (4 == 0) r5.z = 0; else if (4+20 < 32) {             r5.z = (uint)lightConstantsCB[r3.y].data[1].w << (32-(4 + 20)); r5.z = (uint)r5.z >> (32-4);            } else r5.z = (uint)lightConstantsCB[r3.y].data[1].w >> 20;
            r6.w = cmp(0 < (uint)r5.z);
            r15.x = ~(int)r3.x;
            r6.w = r6.w ? r15.x : 0;
            if (r6.w != 0) {
          ...
          r5.z = r2.z * r5.z + r9.w;
          r5.z = r5.z * r7.w;
          r15.x = lightConstantsCB[r3.y].data[0].w;
          r15.yz = lightConstantsCB[r3.y].data[1].xy;
          r6.w = cmp(0 < r8.w);
          r16.xyz = r5.zzz * r15.xyz + r18.xyz;
          r8.w = saturate(dot(r12.xyz, r14.yzw));
          r13.yzw = r13.yzw * r3.www + r5.xyw;
          r3.w = dot(r13.yzw, r13.yzw);
          r3.w = rsqrt(r3.w);
          r13.yzw = r13.yzw * r3.www;
          r3.w = dot(r13.yzw, r5.xyw);
          r9.w = dot(r12.xyz, r13.yzw);
          r13.y = abs(r9.w) * r1.w + -abs(r9.w);
          r9.w = abs(r9.w) * r13.y + 1;
          r13.y = r8.w * r0.y + r2.y;
          r9.w = r9.w * r9.w;
          r9.w = r9.w * r13.y;
          r9.w = rcp(r9.w);
          r8.w = r8.w * r10.w;
          r8.w = r9.w * r8.w;
          r8.w = r8.w * r7.w;
          r13.yzw = r8.www * r15.xyz + r20.xyz;
          r3.w = saturate(1 + -r3.w);
          r9.w = r3.w * r3.w;
          r9.w = r9.w * r9.w;
          r3.w = r9.w * r3.w;
          r3.w = r8.w * r3.w;
          r14.yzw = r3.www * r15.xyz + r17.xyz;
          r15.xyz = r5.zzz * r15.xyz + r19.zxy;
          r15.xyz = r4.zzz ? r15.xyz : r19.zxy;
          r18.xyz = r6.www ? r16.xyz : r18.xyz;
          r19.xyz = r6.www ? r19.xyz : r15.yzx;
          r17.xyz = r6.www ? r14.yzw : r17.xyz;
          r20.xyz = r6.www ? r13.yzw : r20.xyz;
          if (r2.w != 0) {
          // Known bad code for instruction (needs manual fix):
    ...
    r5.z = dot(r12.xyz, r13.yzw);
    r6.w = saturate(r5.z);
    r7.w = r4.z ? abs(r5.z) : r6.w;
    r8.w = cmp(0 < r7.w);
    if (r8.w != 0) {
      r16.xyz = lightConstantsCB[r3.y].data[7].yzw;
      r16.w = lightConstantsCB[r3.y].data[8].x;
      r11.w = 1;
      ...
      if (r9.w != 0) {
        ...
        r14.yzw = lightConstantsCB[r3.y].data[0].xyz + -r11.xyz;
        r10.w = lightConstantsCB[r3.y].data[3].x * lightConstantsCB[r3.y].data[3].x;
        r12.w = dot(r14.yzw, r14.yzw);
        r10.w = r10.w / r12.w;
        r10.w = min(1, r10.w);
        r14.yz = saturate(r8.ww * lightConstantsCB[r3.y].data[2].xz + lightConstantsCB[r3.y].data[2].yw);
        ...
        r21.xy = r21.xy / r8.ww;
        r8.w = cmp(lightConstantsCB[r3.y].data[10].w < 0.00048828125);
        if (r8.w != 0) {
          r14.yz = saturate(abs(r21.xy) * lightConstantsCB[r3.y].data[12].xy + lightConstantsCB[r3.y].data[12].zw);
          ...
          r14.yz = log2(r14.yz);
          r14.yz = lightConstantsCB[r3.y].data[12].ww * r14.yz;
          r14.yz = exp2(r14.yz);
          r11.w = lightConstantsCB[r3.y].data[12].x * r14.y;
          r12.w = lightConstantsCB[r3.y].data[12].y * r14.z + -1;
          r11.w = lightConstantsCB[r3.y].data[12].y * r14.z + -r11.w;
        ...
        r9.w = r10.w * r8.w;
        r8.w = 255 & (int)lightConstantsCB[r3.y].data[14].w;
        if (r8.w != 0) {
          r21.z = 1;
      ...
      r8.w = cmp(0 < r9.w);
      if (r8.w != 0) {
        if (3 == 0) r8.w = 0; else if (3+27 < 32) {         r8.w = (uint)lightConstantsCB[r3.y].data[1].w << (32-(3 + 27)); r8.w = (uint)r8.w >> (32-3);        } else r8.w = (uint)lightConstantsCB[r3.y].data[1].w >> 27;
        if (r2.w != 0) {
        // Known bad code for instruction (needs manual fix):
        ...
        if (r8.w != 0) {
          ...
          r11.w = dot(r16.xyzw, r21.xyzw);
          r12.w = cmp(r11.w >= r8.w);
          if (r12.w != 0) {
            r16.xyz = lightConstantsCB[r3.y].data[4].yzw;
            r16.w = lightConstantsCB[r3.y].data[5].x;
            r16.x = dot(r16.xyzw, r21.xyzw);
            r22.xyz = lightConstantsCB[r3.y].data[5].yzw;
            r22.w = lightConstantsCB[r3.y].data[6].x;
            r16.y = dot(r22.xyzw, r21.xyzw);
            r14.yz = r16.xy / r11.ww;
            r14.yz = saturate(r14.yz * float2(0.5,-0.5) + float2(0.5,0.5));
            r16.x = r14.y * lightConstantsCB[r3.y].data[8].y + lightConstantsCB[r3.y].data[8].z;
            r16.y = r14.z * lightConstantsCB[r3.y].data[8].w + lightConstantsCB[r3.y].data[9].x;
            r8.w = r8.w / r11.w;
            r8.w = max(6.10351563e-05, r8.w);
            r11.w = 0x0000ffff & (int)lightConstantsCB[r3.y].data[1].w;
            if (enableDitheredShadow != 0) {
              r21.x = -r13.x;
              r22.z = (uint)r11.w;
              r21.y = r14.x;
              ...
              while (true) {
                ...
                r22.xy = r23.xy * lightConstantsCB[r3.y].data[3].yy + r16.xy;
                r14.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r22.xyz, r8.w).x;
                r12.w = r14.z * 0.125 + r12.w;
                r14.y = (int)r14.y + 1;
              }
            } else {
              r16.z = (uint)r11.w;
              r12.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r8.w).x;
            }
            r8.w = r12.w * r12.w;
            r8.w = r8.w * r12.w;
          } else {
        ...
        if (r9.w != 0) {
          ...
          if (r12.w != 0) {
            ...
            r16.xyz = r12.xyz * r12.www + r11.xyz;
            r21.xyz = lightConstantsCB[r11.w].data[6].yzw;
            r21.w = lightConstantsCB[r11.w].data[7].x;
            r16.w = 1;
            r12.w = dot(r21.xyzw, r16.xyzw);
            r21.xyz = lightConstantsCB[r11.w].data[7].yzw;
            r21.w = lightConstantsCB[r11.w].data[8].x;
            r14.y = dot(r21.xyzw, r16.xyzw);
            r14.z = cmp(r14.y < r12.w);
            if (r14.z == 0) {
              r21.xyz = lightConstantsCB[r11.w].data[4].yzw;
              r21.w = lightConstantsCB[r11.w].data[5].x;
              r21.x = dot(r21.xyzw, r16.xyzw);
              r22.xyz = lightConstantsCB[r11.w].data[5].yzw;
              r22.w = lightConstantsCB[r11.w].data[6].x;
              r21.y = dot(r22.xyzw, r16.xyzw);
              r16.xy = r21.xy / r14.yy;
              r16.xy = r16.xy * float2(0.5,-0.5) + float2(0.5,0.5);
              r21.x = lightConstantsCB[r11.w].data[9].w + r16.x;
              r21.y = lightConstantsCB[r11.w].data[10].x + r16.y;
              r16.xy = lightConstantsCB[r11.w].data[9].yz * r21.xy;
              r16.zw = lightConstantsCB[r11.w].data[3].yy / lightConstantsCB[r11.w].data[8].yw;
              r21.xy = float2(1,1) + -r16.zw;
              r21.xy = cmp(r16.xy >= r21.xy);
              r16.zw = cmp(r16.zw >= r16.xy);
              r16.zw = (int2)r16.zw | (int2)r21.xy;
              r14.w = (int)r16.w | (int)r16.z;
              if (r14.w == 0) {
                r16.xy = saturate(r16.xy);
                r21.x = r16.x * lightConstantsCB[r11.w].data[8].y + lightConstantsCB[r11.w].data[8].z;
                r21.y = r16.y * lightConstantsCB[r11.w].data[8].w + lightConstantsCB[r11.w].data[9].x;
                r15.w = lightConstantsCB[r11.w].data[10].z * r14.y;
                r12.w = lightConstantsCB[r11.w].data[10].y * r14.y + r12.w;
                r12.w = r12.w / r15.w;
              }
            } else {
              r14.w = -1;
            }
            r14.y = (int)r14.z | (int)r14.w;
            if (r14.y == 0) {
              r12.w = max(6.10351563e-05, r12.w);
              r14.y = 0x0000ffff & (int)lightConstantsCB[r11.w].data[1].w;
              if (enableDitheredShadow != 0) {
                r16.x = -r13.x;
                r22.z = (uint)r14.y;
                r16.y = r14.x;
                ...
                while (true) {
                  ...
                  if (r15.w != 0) break;
                  r23.x = dot(icb[r14.w+0].yx, r16.xy);
                  r23.y = dot(icb[r14.w+0].yx, r16.yz);
                ...
                r21.z = (uint)r14.y;
                r14.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r21.xyz, r12.w).x;
              }
              r11.w = r14.z * r14.z;
              r11.w = r11.w * r14.z;
            } else {
            ...
            if (r3.x != 0) {
              ...
              r3.y = abs(r5.z) * -0.200000003 + 0.400000006;
              r11.w = cmp(r5.z < 0);
              r11.w = r4.z ? r11.w : 0;
              r3.y = r11.w ? -r3.y : r3.y;
              r16.xyz = r12.xyz * r3.yyy + r11.xyz;
              r21.xyz = lightConstantsCB[r3.x].data[6].yzw;
              r21.w = lightConstantsCB[r3.x].data[7].x;
              r16.w = 1;
              r3.y = dot(r21.xyzw, r16.xyzw);
              r21.xyz = lightConstantsCB[r3.x].data[7].yzw;
              r21.w = lightConstantsCB[r3.x].data[8].x;
              r11.w = dot(r21.xyzw, r16.xyzw);
              r12.w = cmp(r11.w < r3.y);
              if (r12.w == 0) {
                r21.xyz = lightConstantsCB[r3.x].data[4].yzw;
                r21.w = lightConstantsCB[r3.x].data[5].x;
                r21.x = dot(r21.xyzw, r16.xyzw);
                r22.xyz = lightConstantsCB[r3.x].data[5].yzw;
                r22.w = lightConstantsCB[r3.x].data[6].x;
                r21.y = dot(r22.xyzw, r16.xyzw);
                r14.yz = r21.xy / r11.ww;
                r14.yz = r14.yz * float2(0.5,-0.5) + float2(0.5,0.5);
                r16.x = lightConstantsCB[r3.x].data[9].w + r14.y;
                r16.y = lightConstantsCB[r3.x].data[10].x + r14.z;
                r14.yz = lightConstantsCB[r3.x].data[9].yz * r16.xy;
                r16.xy = lightConstantsCB[r3.x].data[3].yy / lightConstantsCB[r3.x].data[8].yw;
                ...
                if (r14.w == 0) {
                  ...
                  r16.x = r14.y * lightConstantsCB[r3.x].data[8].y + lightConstantsCB[r3.x].data[8].z;
                  r16.y = r14.z * lightConstantsCB[r3.x].data[8].w + lightConstantsCB[r3.x].data[9].x;
                  r14.y = lightConstantsCB[r3.x].data[10].z * r11.w;
                  r3.y = lightConstantsCB[r3.x].data[10].y * r11.w + r3.y;
                  r3.y = r3.y / r14.y;
                }
              } else {
                r14.w = -1;
              ...
              if (r11.w == 0) {
                ...
                r11.w = 0x0000ffff & (int)lightConstantsCB[r3.x].data[1].w;
                if (enableDitheredShadow != 0) {
                  r21.x = -r13.x;
                  r22.z = (uint)r11.w;
                  r21.y = r14.x;
                  ...
                  r13.x = 0;
                  while (true) {
                    r14.x = cmp((int)r13.x >= 8);
                    if (r14.x != 0) break;
                    r14.x = dot(icb[r13.x+0].yx, r21.xy);
                    r14.y = dot(icb[r13.x+0].yx, r21.yz);
                    r22.xy = r14.xy * lightConstantsCB[r3.x].data[3].yy + r16.xy;
                    r14.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r22.xyz, r3.y).x;
                    r12.w = r14.x * 0.125 + r12.w;
                    r13.x = (int)r13.x + 1;
                  }
                } else {
                  r16.z = (uint)r11.w;
                  r12.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r3.y).x;
                }
                r3.x = r12.w * r12.w;
                r3.x = r3.x * r12.w;
              } else {
          ...
          r2.x = r2.x * r8.w;
          r2.z = cmp(0 < r5.z);
          r14.xyz = r2.xxx * r13.yzw + r18.xyz;
          r3.xyw = r15.xyz * r3.www + r5.xyw;
          r5.z = dot(r3.xyw, r3.xyw);
          r5.z = rsqrt(r5.z);
          r3.xyw = r5.zzz * r3.xyw;
          r5.x = dot(r3.xyw, r5.xyw);
          ...
          r0.y = r8.w * r0.y;
          r0.y = 0.25 * r0.y;
          r3.xyw = r0.yyy * r13.yzw + r20.xyz;
          r1.w = saturate(1 + -r5.x);
          r2.y = r1.w * r1.w;
          r2.y = r2.y * r2.y;
          r1.w = r2.y * r1.w;
          r0.y = r1.w * r0.y;
          r5.xyz = r0.yyy * r13.yzw + r17.xyz;
          r12.xyz = r2.xxx * r13.yzw + r19.zxy;
          r12.xyz = r4.zzz ? r12.xyz : r19.zxy;
          r18.xyz = r2.zzz ? r14.xyz : r18.xyz;
          r19.xyz = r2.zzz ? r19.xyz : r12.yzx;
          r17.xyz = r2.zzz ? r5.xyz : r17.xyz;
          r20.xyz = r2.zzz ? r3.xyw : r20.xyz;
          if (r2.w != 0) {
          // Known bad code for instruction (needs manual fix):
  ...
  r3.z = -r2.y * 0.5 + r0.y;
  r3.x = r3.z + r2.y;
  r2.xyz = r18.xyz * r6.xyz;
  r2.xyz = r19.zxy * r3.xyz + r2.xyz;
  r4.xyw = float3(0.959999979,0.959999979,0.959999979) * r17.xyz;
  r4.xyw = r20.xyz * float3(0.0399999991,0.0399999991,0.0399999991) + r4.xyw;
  r2.xyz = r4.xyw + r2.xyz;
  r4.xyw = float3(1,1,1) + -r3.xyz;
  r4.xyw = r17.xyz * r4.xyw;
  r3.xyz = r20.xyz * r3.xyz + r4.xyw;
  r3.xyz = r18.xyz * r6.xyz + r3.xyz;
  r2.xyz = r4.zzz ? r2.xyz : r3.xyz;
