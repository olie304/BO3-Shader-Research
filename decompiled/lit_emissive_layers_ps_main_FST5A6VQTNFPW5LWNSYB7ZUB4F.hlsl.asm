...
if_nz r1.w
  ...
  mad r7.zw, r7.zzzw, cb0[13].zzzw, r14.xxxy
...
frc r2.w, r2.w
mad r12.y, cb1[69].w, cb0[16].z, r2.w
mov r12.x, cb0[16].x
sample_l_indexable(texture2d)(float,float,float,float) r2.w, r12.xyxx, t24.yzwx, s5, l(0.000000)
log r2.w, |r2.w|
...
if_nz r2.w
  ...
  round_z r2.w, r2.w
  add r2.w, r2.w, v2.x
  div r12.x, r2.w, cb0[21].x
  round_z r2.w, r3.w
  add r2.w, r2.w, v2.y
  div r12.y, r2.w, cb0[20].w
else 
  dp3 r2.w, -v7.xyzx, -v7.xyzx
  rsq r2.w, r2.w
  mul r13.xyz, r2.wwww, -v7.xyzx
  dp3 r4.x, r13.xyzx, r4.xyzx
  dp3 r4.y, r13.xyzx, r5.xyzx
  dp3 r2.w, r13.xyzx, r3.xyzx
  ...
  mad r3.xy, r3.xyxx, cb0[22].zwzz, r13.xyxx
  ...
  movc r12.x, cb0[24].w, r3.z, r3.x
  movc r12.y, cb0[25].x, r3.w, r3.y
endif 
sample_indexable(texture2d)(float,float,float,float) r3.xyzw, r12.xyxx, t26.xyzw, s1
...
ret 
// Approximately 2720 instruction slots used
