...
if_nz r6.w
  ...
  add r15.yzw, r11.xxyz, -cb10[r6.w + 0].xxyz
  and r7.w, l(0x0000ffff), cb10[r6.w + 7].z
  ubfe r8.w, l(6), l(25), cb10[r6.w + 7].z
  imul null, r9.w, r7.w, l(6)
  dp3 r13.z, cb11[r9.w + 0].xyzx, r15.yzwy
  add_sat r13.z, r13.z, cb11[r9.w + 0].w
  dp3 r13.w, cb11[r9.w + 1].xyzx, r15.yzwy
  add_sat r13.w, r13.w, cb11[r9.w + 1].w
  mul r13.z, r13.w, r13.z
  dp3 r13.w, cb11[r9.w + 2].xyzx, r15.yzwy
  add_sat r13.w, r13.w, cb11[r9.w + 2].w
  mul r13.z, r13.w, r13.z
  dp3 r13.w, cb11[r9.w + 3].xyzx, r15.yzwy
  add_sat r13.w, r13.w, cb11[r9.w + 3].w
  mul r13.z, r13.w, r13.z
  dp3 r13.w, cb11[r9.w + 4].xyzx, r15.yzwy
  add_sat r13.w, r13.w, cb11[r9.w + 4].w
  mul r13.z, r13.w, r13.z
  dp3 r13.w, cb11[r9.w + 5].xyzx, r15.yzwy
  add_sat r9.w, r13.w, cb11[r9.w + 5].w
  mul r18.x, r9.w, r13.z
  ...
  mov r14.w, l(1)
  loop 
    ige r16.y, r14.w, r8.w
    breakc_nz r16.y
    iadd r16.y, r7.w, r14.w
    ...
    mul r19.x, r16.y, r16.z
    ushr r16.w, r9.w, l(2)
    ubfe r18.z, l(1), l(2), r9.w
    and r18.w, r16.w, l(2)
    max r19.z, r19.x, r19.y
    mad r16.y, -r16.z, r16.y, l(1.000000)
    mul r16.y, r16.y, r19.y
    movc r18.y, r18.w, r16.y, r19.z
  ...
  if_nz r8.w
    ...
    dp3 r13.z, r17.xyzx, r18.xyzx
    dp3 r13.w, r15.yzwy, r18.xyzx
    add r13.w, r13.w, -cb10[r6.w + 9].z
    ...
    dp3 r13.z, r17.xyzx, r18.xyzx
    dp3 r13.w, r15.yzwy, r18.xyzx
    add r13.w, r13.w, -cb10[r6.w + 10].z
    ge r14.w, r13.w, l(0.000000)
    max r13.w, r3.z, |r13.w|
    movc r13.w, r14.w, r13.w, -r13.w
    max r13.z, -r13.z, l(0.00000010)
    ...
    dp3 r13.z, r17.xyzx, r18.xyzx
    dp3 r13.w, r15.yzwy, r18.xyzx
    add r13.w, r13.w, -cb10[r6.w + 11].z
    ge r14.w, r13.w, l(0.000000)
    max r13.w, r3.z, |r13.w|
    movc r13.w, r14.w, r13.w, -r13.w
    max r13.z, -r13.z, l(0.00000010)
    ...
    dp3 r13.z, r17.xyzx, r18.xyzx
    dp3 r13.w, r15.yzwy, r18.xyzx
    add r13.w, r13.w, -cb10[r6.w + 12].z
    ge r14.w, r13.w, l(0.000000)
    max r13.w, r3.z, |r13.w|
    movc r13.w, r14.w, r13.w, -r13.w
    max r13.z, -r13.z, l(0.00000010)
    ...
    dp3 r13.z, r17.xyzx, r18.xyzx
    dp3 r13.w, r15.yzwy, r18.xyzx
    add r13.w, r13.w, -cb10[r6.w + 13].z
    ge r14.w, r13.w, l(0.000000)
    max r13.w, r3.z, |r13.w|
    movc r13.w, r14.w, r13.w, -r13.w
    max r13.z, -r13.z, l(0.00000010)
    ...
    ubfe r13.z, l(9), l(16), cb10[r6.w + 7].z
    utof r19.w, r13.z
...
if_nz r6.w
  ...
  if_nz r4.w
    ...
    dp3 r9.w, cb11[r8.w + 0].xyzx, r18.xyzx
    add_sat r9.w, r9.w, cb11[r8.w + 0].w
    dp3 r13.z, cb11[r8.w + 1].xyzx, r18.xyzx
    add_sat r13.z, r13.z, cb11[r8.w + 1].w
    mul r9.w, r9.w, r13.z
    dp3 r13.z, cb11[r8.w + 2].xyzx, r18.xyzx
    add_sat r13.z, r13.z, cb11[r8.w + 2].w
    mul r9.w, r9.w, r13.z
    dp3 r13.z, cb11[r8.w + 3].xyzx, r18.xyzx
    add_sat r13.z, r13.z, cb11[r8.w + 3].w
    mul r9.w, r9.w, r13.z
    dp3 r13.z, cb11[r8.w + 4].xyzx, r18.xyzx
    add_sat r13.z, r13.z, cb11[r8.w + 4].w
    mul r9.w, r9.w, r13.z
    dp3 r13.z, cb11[r8.w + 5].xyzx, r18.xyzx
    add_sat r8.w, r13.z, cb11[r8.w + 5].w
    mul r19.x, r8.w, r9.w
    and r8.w, l(1), cb10[r0.y + 6].x
    mov r19.yz, l(0,0,1.000000,0)
    movc r13.zw, r8.wwww, r19.xxxy, r19.zzzx
