...
add r1.z, -r1.y, r1.z
mad r3.y, cb1[62].w, r1.z, r1.y
add r1.y, -r1.x, cb1[63].x
mad r1.x, cb1[63].w, r1.y, r1.x
movc r1.yzw, v7.xxxx, v3.xxyz, -v3.xxyz
dp3 r2.z, r1.yzwy, r1.yzwy
rsq r2.z, r2.z
mad r1.yzw, r1.yyzw, r2.zzzz, -r2.xxyw
mad r2.xyz, cb1[60].wwww, r1.yzwy, r2.xywx
mul r0.w, r0.w, v1.w
...
if_z r0.w
  ...
  rcp r0.w, r0.w
  mov_sat r22.w, r22.w
  mul r19.xyz, r0.wwww, r21.xyzx
  mul r20.xyz, r0.wwww, r22.xyzx
...
if_z r3.y
  ...
  if_z r6.z
    if_z cb2[58].y
      ...
      itof r6.z, cb2[26].y
      add r14.z, r3.w, r6.z
      sample_c_lz_indexable(texture2darray)(float,float,float,float) r6.z, r14.xyzx, t13.xxxx, s13, r3.y
    ...
    if_nz cb2[58].y
      ...
      loop 
        ...
        utof r16.z, r8.w
        sample_c_lz_indexable(texture2darray)(float,float,float,float) r8.w, r16.xyzx, t13.xxxx, s13, r3.y
...
if_nz r3.y
  ...
  if_nz r3.y
    ...
    if_nz r5.w
      ...
      mad r6.z, |r2.w|, l(-0.200000), l(0.400000)
      lt r6.w, r2.w, l(0.000000)
      movc r6.z, r6.w, -r6.z, r6.z
      mad r18.xyz, r2.xyzx, r6.zzzz, v6.xyzx
    ...
    mul r2.w, r2.w, r4.x
    mul r2.w, r3.z, r2.w
    mad r15.yzw, r2.wwww, r8.yyzw, r13.xxyz
    add_sat r3.y, -r3.w, l(1.000000)
    mul r3.z, r3.y, r3.y
    mul r3.z, r3.z, r3.z
    mul r3.y, r3.z, r3.y
    mul r2.w, r2.w, r3.y
    mad r3.yzw, r2.wwww, r8.yyzw, r9.yyzw
    mov r14.w, r12.z
    mov r12.w, r14.z
          ...
          if_nz r16.w
            ...
            if_nz r16.w
              ...
              if_nz r16.w
                ...
                mad r43.xyz, r2.xyzx, r16.wwww, v6.xyzx
              ...
              if_nz r16.w
                ...
                mad r12.w, r5.z, r12.w, |r15.w|
                mul r12.w, r15.z, r12.w
                mov r34.x, r33.x
                lt r13.w, l(0.000000), r15.w
                mad r20.xyz, r12.wwww, r34.xyzx, r17.xyzx
                dp3_sat r15.w, r2.xyzx, r41.xyzx
                mad r40.xyz, r40.xyzx, r11.wwww, r4.yzwy
                dp3 r11.w, r40.xyzx, r40.xyzx
                rsq r11.w, r11.w
                mul r40.xyz, r11.wwww, r40.xyzx
                dp3 r11.w, r40.xyzx, r4.yzwy
                dp3 r19.x, r2.xyzx, r40.xyzx
                mad r21.w, |r19.x|, r5.y, -|r19.x|
                mad r19.x, |r19.x|, r21.w, l(1.000000)
                mad r21.w, r15.w, r0.w, r1.x
...
mad r0.xyz, r3.yzwy, r0.xyzx, r1.xyzx
mul r1.xyz, r29.xyzx, l(0.960000, 0.960000, 0.960000, 0.000000)
mad r1.xyz, r8.yzwy, l(0.040000, 0.040000, 0.040000, 0.000000), r1.xyzx
