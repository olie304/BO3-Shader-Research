...
// flowMap                           texture  float4          2d            t12      1 
// noiseMap                          texture  float4          2d            t14      1 
...
sample_indexable(texture2d)(float,float,float,float) r0.w, r1.xyxx, t11.yzwx, s2
mul r0.x, r0.x, r0.w
...
mad o0.xyz, r0.xxxx, r2.xyzx, l(1.000000, 1.000000, 1.000000, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r0.w, r0.yzyy, t10.yzwx, s3
...
mad r4.xy, r0.yzyy, cb0[14].zzzz, r4.xyxx
sample_indexable(texture2d)(float,float,float,float) r4.xy, r4.xyxx, t14.xyzw, s6
mul r4.xy, r4.xyxx, cb0[14].wwww
mad r4.xy, r0.yzyy, cb0[13].xxxx, r4.xyxx
frc r4.zw, r4.xxxy
...
resinfo_indexable(texture2d)(float,float,float,float) r6.xy, l(0), t9.xyzw
...
sample_indexable(texture2d)(float,float,float,float) r6.xy, r6.xyxx, t12.xyzw, s5
...
sample_indexable(texture2d)(float,float,float,float) r6.zw, r7.xyxx, t12.zwxy, s5
add r6.zw, r6.zzzw, r6.zzzw
sample_indexable(texture2d)(float,float,float,float) r7.xy, r7.zwzz, t12.xyzw, s5
...
sample_indexable(texture2d)(float,float,float,float) r4.xy, r4.xyxx, t12.xyzw, s5
add r4.xy, r4.xyxx, r4.xyxx
if_nz cb0[17].w
  sample_indexable(texture2d)(float,float,float,float) r7.zw, r0.yzyy, t12.zwxy, s5
  ...
  dp2 r2.w, r8.zwzz, r7.zwzz
  sqrt r2.w, r2.w
  mad r2.w, r2.w, cb0[16].z, cb0[16].y
  mul r7.zw, r2.wwww, cb0[17].xxxy
else 
...
rsq r4.zw, r4.zzzw
if_z cb0[15].x
  mul r2.w, cb0[13].y, cb1[69].w
  mad r5.xy, r6.xyxx, l(-1.000000, 1.000000, 0.000000, 0.000000), l(1.000000, -1.000000, 0.000000, 0.000000)
  mad r5.xy, r5.xyxx, r2.wwww, r1.xyxx
  sample_l_indexable(texture2d)(float,float,float,float) r5.xy, r5.xyxx, t9.xyzw, s4, r1.w
  mad r8.xy, r6.zwzz, l(-1.000000, 1.000000, 0.000000, 0.000000), l(1.000000, -1.000000, 0.000000, 0.000000)
  mad r8.xy, r8.xyxx, r2.wwww, r1.xyxx
  sample_l_indexable(texture2d)(float,float,float,float) r8.xy, r8.xyxx, t9.xyzw, s4, r1.w
  ...
  mad r1.xy, r8.zwzz, r2.wwww, r1.xyxx
  sample_l_indexable(texture2d)(float,float,float,float) r1.xy, r1.xyxx, t9.xyzw, s4, r1.w
  add r1.xy, -r8.xyxx, r1.xyxx
  mad r1.xy, r5.zzzz, r1.xyxx, r8.xyxx
  add r1.xy, -r5.xyxx, r1.xyxx
  mad r1.xy, r5.wwww, r1.xyxx, r5.xyxx
  mad r1.xy, r1.xyxx, r7.zzzz, r7.wwww
else 
  mad r5.xy, r6.xyxx, l(-1.000000, 1.000000, 0.000000, 0.000000), l(1.000000, -1.000000, 0.000000, 0.000000)
  dp2 r2.w, r5.xyxx, r5.xyxx
  sqrt r2.w, r2.w
  max r2.w, r2.w, l(0.000010)
  div r8.xy, r5.xyxx, r2.wwww
  mov r8.z, -r8.x
  dp2 r5.x, r0.yzyy, r8.yzyy
  dp2 r5.y, r0.yzyy, -r8.xyxx
  mul r9.xy, r5.xyxx, cb0[12].xyxx
  mul r2.w, r2.w, cb1[69].w
  mad r9.z, -r2.w, cb0[13].y, r9.y
  sample_l_indexable(texture2d)(float,float,float,float) r5.xy, r9.xzxx, t9.xyzw, s4, r1.w
  ...
  sqrt r2.w, r2.w
  max r2.w, r2.w, l(0.000010)
  div r6.xy, r6.xyxx, r2.wwww
  mov r6.z, -r6.x
  dp2 r7.x, r0.yzyy, r6.yzyy
  dp2 r7.y, r0.yzyy, -r6.xyxx
  mul r8.xy, r7.xyxx, cb0[12].xyxx
  mul r2.w, r2.w, cb1[69].w
  mad r8.z, -r2.w, cb0[13].y, r8.y
  sample_l_indexable(texture2d)(float,float,float,float) r7.xy, r8.xzxx, t9.xyzw, s4, r1.w
  ...
  sqrt r2.w, r2.w
  max r2.w, r2.w, l(0.000010)
  div r6.xy, r4.xyxx, r2.wwww
  mov r6.z, -r6.x
  dp2 r4.x, r0.yzyy, r6.yzyy
  dp2 r4.y, r0.yzyy, -r6.xyxx
  mul r9.xy, r4.xyxx, cb0[12].xyxx
  mul r0.y, r2.w, cb1[69].w
  mad r9.z, -r0.y, cb0[13].y, r9.y
  sample_l_indexable(texture2d)(float,float,float,float) r0.yz, r9.xzxx, t9.zxyw, s4, r1.w
  mad r0.yz, r0.yyzy, r7.zzzz, r7.wwww
  dp2 r4.x, r0.yzyy, r6.yzyy
  dp2 r4.y, r0.yzyy, -r6.xyxx
  add r0.yz, -r8.xxyx, r4.xxyx
  mad r0.yz, r5.zzzz, r0.yyzy, r8.xxyx
  add r0.yz, -r5.xxyx, r0.yyzy
  mad r1.xy, r5.wwww, r0.yzyy, r5.xyxx
endif 
mul r0.y, r4.w, r4.z
...
ftou r2.xy, v0.xyxx
mov r2.zw, l(0,0,0,0)
ld_indexable(texture2d)(float,float,float,float) r0.yz, r2.xyzw, t6.xzwy
...
xor r0.z, r2.w, r2.z
movc r2.z, r0.z, l(-0.57735026), l(0.57735026)
...
mad r1.z, r0.w, l(0.49755621), r0.y
