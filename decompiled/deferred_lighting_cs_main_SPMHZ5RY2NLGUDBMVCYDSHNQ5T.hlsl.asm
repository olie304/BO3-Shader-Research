...
if_nz r8.w
  ...
  if_nz r13.w
    ...
    dp3 r14.w, r18.xyzx, r19.xyzx
    dp3 r15.w, r16.yzwy, r19.xyzx
    add r15.w, r15.w, -cb10[r8.w + 10].z
    ge r17.y, r15.w, l(0.000000)
    max r15.w, r4.w, |r15.w|
    movc r15.w, r17.y, r15.w, -r15.w
    max r14.w, -r14.w, l(0.00000010)
    ...
    dp3 r14.w, r18.xyzx, r19.xyzx
    dp3 r15.w, r16.yzwy, r19.xyzx
    add r15.w, r15.w, -cb10[r8.w + 11].z
    ge r17.y, r15.w, l(0.000000)
    max r15.w, r4.w, |r15.w|
    movc r15.w, r17.y, r15.w, -r15.w
    max r14.w, -r14.w, l(0.00000010)
    ...
    dp3 r14.w, r18.xyzx, r19.xyzx
    dp3 r15.w, r16.yzwy, r19.xyzx
    add r15.w, r15.w, -cb10[r8.w + 12].z
    ge r17.y, r15.w, l(0.000000)
    max r15.w, r4.w, |r15.w|
    movc r15.w, r17.y, r15.w, -r15.w
    max r14.w, -r14.w, l(0.00000010)
    ...
    dp3 r14.w, r18.xyzx, r19.xyzx
    dp3 r15.w, r16.yzwy, r19.xyzx
    add r15.w, r15.w, -cb10[r8.w + 13].z
    ge r17.y, r15.w, l(0.000000)
    max r15.w, r4.w, |r15.w|
    movc r15.w, r17.y, r15.w, -r15.w
    max r14.w, -r14.w, l(0.00000010)
    div r14.w, r15.w, r14.w
    min r14.z, |r14.w|, r14.z
    add r19.x, r16.y, cb10[r8.w + 3].w
    add r19.yz, r16.zzwz, cb10[r8.w + 4].xxyx
    ...
    sqrt r14.z, r14.z
    mad r14.z, r3.y, l(5.000000), r14.z
    add r14.z, r14.z, l(-0.844800)
    mov r19.x, cb10[r8.w + 0].w
    mov r19.y, cb10[r8.w + 1].z
    mov r19.z, cb10[r8.w + 2].y
    dp3 r20.x, r17.yzwy, r19.xyzx
    mov r21.xy, cb10[r8.w + 1].xwxx
    mov r21.z, cb10[r8.w + 2].z
    dp3 r20.y, r17.yzwy, r21.xyzx
    mov r22.x, cb10[r8.w + 1].y
    mov r22.yz, cb10[r8.w + 2].xxwx
    ...
    mad_sat r16.yzw, r23.xxyz, cb10[r8.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
    mul r23.xy, r16.yzyy, cb10[r8.w + 4].zwzz
    mul r23.z, r16.w, cb10[r8.w + 5].x
    add r16.yzw, r23.xxyz, cb10[r8.w + 5].yyzw
    ...
    mad r8.w, r6.w, r8.w, r13.w
    div r8.w, r14.z, r8.w
    mul r17.yzw, r8.wwww, r17.yyzw
  else 
...
if_nz r8.w
  ...
  if_nz r7.w
    ...
    mov r15.w, l(1)
    loop 
      ige r19.w, r15.w, r8.w
      breakc_nz r19.w
      iadd r19.w, r7.w, r15.w
      ...
      mov r13.w, r20.w
    endloop 
    add_sat r7.w, -r9.w, r21.y
    mul r8.w, r7.w, cb10[r0.y + 6].y
    lt r13.w, l(0.000000), r8.w
    if_nz r13.w
      mad r9.w, r7.w, cb10[r0.y + 6].y, r9.w
      mul r7.w, r8.w, cb10[r0.y + 7].y
      ...
      ge r14.w, r14.z, l(0.000000)
      max r4.w, r4.w, |r14.z|
      movc r4.w, r14.w, r4.w, -r4.w
      max r13.w, -r13.w, l(0.00000010)
      div r4.w, r4.w, r13.w
      min r4.w, |r4.w|, r8.w
      add r20.x, r19.x, cb10[r0.y + 3].w
      add r20.yz, r19.yyzy, cb10[r0.y + 4].xxyx
      mad r20.xyz, r18.xyzx, r4.wwww, r20.xyzx
      dp3 r8.w, r20.xyzx, r20.xyzx
      sqrt r8.w, r8.w
      div r4.w, r4.w, r8.w
      add r4.w, r4.w, r4.w
      sqrt r4.w, r4.w
      mad r3.y, r3.y, l(5.000000), r4.w
      ...
      ubfe r4.w, l(9), l(16), cb10[r0.y + 7].z
      utof r22.w, r4.w
      sample_l_indexable(texturecubearray)(float,float,float,float) r20.xyz, r22.xyzw, t8.xyzw, s2, r3.y
...
if_nz r3.y
  ...
  dp3 r4.w, r20.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
  mad r19.xyz, r16.yzwy, r0.yyyy, r20.xyzx
  mov r18.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r16.yzw, r18.xyzw, t8.wxyz, s2, r3.z
  mad r0.y, cb2[19].x, r3.y, -r4.w
  mad r0.y, r2.y, r0.y, r4.w
  mad r17.yzw, r16.yyzw, r0.yyyy, r17.yyzw
endif 
...
ret 
// Approximately 1858 instruction slots used
