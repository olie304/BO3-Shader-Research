// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:33:41 2021
...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  while (true) {
    ...
    r8.w = cmp((int)r0.x == (int)r5.w);
    if (r3.w == 0) r9.z = 0; else if (r3.w+0 < 32) {     r9.z = (uint)r6.w << (32-(r3.w + 0)); r9.z = (uint)r9.z >> (32-r3.w);    } else r9.z = (uint)r6.w >> 0;
    r6.w = r8.w ? r9.z : r6.w;
    ...
    while (true) {
      ...
      r17.y = samp0[]..swiz;
        ...
        r18.z = samp0[]..swiz;
          ...
          r13.w = rsqrt(r13.w);
          r20.xyz = r19.xyz * r13.www;
          r13.w = dot(r20.xyz, v4.xyz);
          r13.w = cmp(r13.w >= 0.5);
          if (r13.w != 0) {
          // Known bad code for instruction (needs manual fix):
          ...
          r21.w = samp0[]..swiz;
            ...
            r18.w = samp0[]..swiz;
              ...
              if (r19.z != 0) {
                if (4 == 0) r13.w = 0; else if (4+24 < 32) {                 r13.w = (uint)r17.w << (32-(4 + 24)); r13.w = (uint)r13.w >> (32-4);                } else r13.w = (uint)r17.w >> 24;
                r13.w = 1 << (int)r13.w;
                r14.w = (uint)r17.w >> 28;
                r14.w = 1 << (int)r14.w;
                r15.w = cmp((int)r19.z == 4);
                if (r15.w != 0) {
                  r15.w = (int)r17.w & 4095;
                  if (12 == 0) r20.w = 0; else if (12+12 < 32) {                   r20.w = (uint)r17.w << (32-(12 + 12)); r20.w = (uint)r20.w >> (32-12);                  } else r20.w = (uint)r17.w >> 12;
              ...
              r14.w = cmp(r17.x != 1.000000);
              r15.w = r13.w + r16.w;
              r15.w = saturate(r15.w * r17.x + -r17.x);
              r13.w = r14.w ? r15.w : r13.w;
              if (r19.w != 0) {
                if (4 == 0) r14.w = 0; else if (4+24 < 32) {                 r14.w = (uint)r18.y << (32-(4 + 24)); r14.w = (uint)r14.w >> (32-4);                } else r14.w = (uint)r18.y >> 24;
                r14.w = 1 << (int)r14.w;
                r15.w = (uint)r18.y >> 28;
                r15.w = 1 << (int)r15.w;
                r16.w = cmp((int)r19.w == 2);
                if (r16.w != 0) {
                  ...
                  r25.xyz = r28.xyz * r25.xyz;
                  r16.w = materialTexMask.SampleGrad(samplerLinearClamp_s, r26.xyz, r27.x, r25.x).x;
                } else {
                  r17.x = cmp((int)r19.w == 4);
                  if (r17.x != 0) {
                    ...
                    r27.x = (uint)r17.x;
                    r27.y = (uint)r19.z;
                    r17.xw = r27.xy + r26.xy;
                    r26.xy = invBcTexSizes.xy * r17.xw;
                    r26.z = (uint)r19.w;
                    r27.xyz = invBcTexSizes.xyx * r23.zyz;
                    r27.xyz = r27.xyz * r25.xyz;
                    r28.xyz = invBcTexSizes.xyx * r24.zyz;
                    r25.xyz = r28.xyz * r25.xyz;
                    r16.w = materialTexBC7.SampleGrad(samplerLinearClamp_s, r26.xyz, r27.x, r25.x).x;
                  } else {
                    r17.x = (int)r18.y & 4095;
                    if (12 == 0) r19.z = 0; else if (12+12 < 32) {                     r19.z = (uint)r18.y << (32-(12 + 12)); r19.z = (uint)r19.z >> (32-12);                    } else r19.z = (uint)r18.y >> 12;
                    if (10 == 0) r19.w = 0; else if (10+20 < 32) {                     r19.w = (uint)r18.w << (32-(10 + 20)); r19.w = (uint)r19.w >> (32-10);                    } else r19.w = (uint)r18.w >> 20;
                    ...
                    r27.y = (uint)r19.z;
                    r17.xw = r27.xy + r26.xy;
                    r26.xy = invBcTexSizes.zw * r17.xw;
                    r26.z = (uint)r19.w;
                    r27.xyz = invBcTexSizes.zwz * r23.zyz;
                    r27.xyz = r27.xyz * r25.xyz;
                    r28.xyz = invBcTexSizes.zwz * r24.zyz;
                    r25.xyz = r28.xyz * r25.xyz;
                    r16.w = materialTexBC3.SampleGrad(samplerLinearClamp_s, r26.xyz, r27.x, r25.x).x;
                  }
                }
                r25.xyz = r16.www * float3(0.959999979,0.959999979,0.959999979) + float3(0.0399999991,0.0399999991,0.0399999991);
              ...
              if (r17.x != 0) {
                ...
                r12.w = samp0[]..swiz;
                  ...
                  r26.xyz = r29.xyz * r26.xyz;
                  r12.w = materialTexMask.SampleGrad(samplerLinearClamp_s, r27.xyz, r28.x, r26.x).x;
                } else {
                  r14.w = cmp((int)r17.x == 6);
                  r12.w = r14.w ? 0 : 1;
                }
              } else {
                r12.w = 1;
              ...
              if (r17.y != 0) {
                ...
                r17.xyz = r20.xyz * r14.www + r17.xyz;
              ...
              r14.w = 1 + -r13.w;
              r17.xyz = r14.www * r10.xyz;
              r10.xyz = r16.xyz * r13.www + r17.xyz;
              r16.xyz = r15.xyz * r14.www;
              r15.xyz = r25.xyz * r13.www + r16.xyz;
              r9.z = r9.z * r14.w + r13.w;
              r14.w = r14.w * r9.w;
              r9.w = r12.w * r13.w + r14.w;
            }
          }
        }
      }
  ...
  if (r0.y != 0) {
    ...
    r4.zw = -r11.xy / r0.yy;
    r0.yz = r0.zz ? r4.zw : 0;
    r4.zw = float2(-0.5,-0.5) + v2.xy;
    r1.w = 9.99999975e-06 + layerDepth;
    r0.yz = r1.ww * r0.yz;
    r0.yz = scaleUVs.xy * r0.yz;
    r0.yz = r4.zw * scaleUVs.xy + r0.yz;
    ...
    r11.y = r11.x;
    r11.z = r10.x;
    r12.x = dot(r11.yz, r0.yz);
    r11.x = -r10.x;
    r12.y = dot(r11.xy, r0.yz);
    ...
    r9.xy = clampU ? r4.zw : r0.yz;
  }
  r0.y = dot(-v7.xyz, -v7.xyz);
  r0.y = rsqrt(r0.y);
  r10.xyz = -v7.xyz * r0.yyy;
  r0.z = saturate(dot(r10.xyz, r3.xyz));
  r3.xyzw = emissiveMap.Sample(colorSampler_s, r9.xy).xyzw;
  ...
  sincos(r0.z, r9.x, r11.x);
  r0.z = dot(r4.xy, float2(0.0671105608,0.00583714992));
  r0.z = frac(r0.z);
  r0.z = 52.9829178 * r0.z;
  r0.z = frac(r0.z);
  r0.z = r0.z * 6.28318548 + gameTick.w;
  sincos(r0.z, r4.x, r12.x);
  r5.x = saturate(dot(r2.xyz, r10.xyz));
  r0.z = dot(-r10.xyz, r2.xyz);
  r0.z = r0.z + r0.z;
  r13.xyz = r2.xyz * -r0.zzz + -r10.xyz;
  r0.z = 17 * r5.y;
  r0.z = exp2(r0.z);
  r0.z = 2 + r0.z;
  r0.z = 2 / r0.z;
  ...
  r12.yzw = r21.xyz * r3.www;
  r14.xyz = r22.xyz * r3.www;
  ...
  r5.yzw = r14.xyz * r2.www;
  r14.xyz = r5.zwy * r4.yyy;
  r4.yzw = r5.yzw * r4.zzz;
  r0.w = sqrt(r1.w);
  r0.w = r0.w * 0.5 + 0.5;
  r0.w = r0.w * r0.w;
  r2.w = 0.5 * r0.w;
  ...
  if (r5.z == 0) {
    ...
    if (r9.z == 0) {
      if (enableDitheredShadow == 0) {
        ...
        r16.z = r9.z + r6.w;
        r9.z = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r5.z).x;
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          r18.z = (uint)r11.w;
          r11.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r18.xyz, r5.z).x;
  ...
  if (r5.z != 0) {
    ...
    if (r5.z != 0) {
      ...
      r6.w = dot(r2.xyz, r12.yzw);
      r7.w = abs(r6.w) * r0.z + -abs(r6.w);
      ...
      r16.w = r7.z;
      r15.w = r14.z;
      r15.xyzw = r3.wwww ? r16.xyzw : r15.xyzw;
      r7.zw = r12.yz;
      r14.zw = r4.yz;
      r7.xyzw = r3.wwww ? r7.xyzw : r14.xyzw;
      r4.w = r3.w ? r12.w : r4.w;
      r14.z = r15.w;
      r14.xy = r7.xy;
      r4.yz = r7.zw;
    }
  ...
  while (true) {
    ...
    if (r8.w != 0) break;
    r5.z = (uint)r6.w >> 5;
    r16.xyz = (int3)r5.xyz + (int3)r8.xyz;
      ...
      r32.y = samp0[]..swiz;
        ...
        r37.w = samp0[]..swiz;
          ...
          switch (r10.w) {
            ...
            if (r24.w != 0) {
              ...
              if (r24.w != 0) {
                ...
                if (r24.w != 0) {
                  r24.w = r32.x * r0.z;
                  r24.w = 0.25 * r24.w;
                  r25.w = dot(r38.xyz, r13.xyz);
                  r27.w = dot(r13.xyz, r40.xyz);
                      ...
                      r11.w = samp0[]..swiz;
                        ...
                        if (r8.w != 0) {
                          ...
                          while (true) {
                            ...
                            if (r27.w != 0) break;
                            r41.x = dot(icb[r25.w+0].xy, r11.xy);
                            r41.y = dot(icb[r25.w+0].yx, r11.xz);
                  ...
                  r38.xyz = r38.xyz * r10.www + r10.xyz;
                  r10.w = dot(r38.xyz, r38.xyz);
                  r10.w = rsqrt(r10.w);
                  r38.xyz = r38.xyz * r10.www;
                  r10.w = dot(r38.xyz, r10.xyz);
                  r15.w = dot(r2.xyz, r38.xyz);
                  r18.x = abs(r15.w) * r0.z + -abs(r15.w);
                  r15.w = abs(r15.w) * r18.x + 1;
                  r18.x = r11.w * r0.w + r2.w;
                  r15.w = r15.w * r15.w;
                  r15.w = r15.w * r18.x;
                  r15.w = rcp(r15.w);
                  r11.w = r11.w * r24.w;
                  ...
                  r10.w = r14.w * r10.w;
                  r10.w = r11.w * r10.w;
                  r39.xyz = r10.www * r32.xyz + r29.xyz;
            ...
            r10.w = rsqrt(r10.w);
            r38.xyz = r19.xyz * r10.www;
            r11.w = dot(r2.xyz, r38.xyz);
            r13.w = saturate(r11.w);
            r14.w = cmp(0 < r13.w);
            if (r14.w != 0) {
            // Known bad code for instruction (needs manual fix):
            ...
            r39.w = samp0[]..swiz;
              ...
              if (r14.w != 0) {
                ...
                if (r14.w != 0) {
                  ...
                  r21.xyz = r2.xyz * r14.www + v7.xyz;
                  r38.xyz = r37.xyz;
                  r14.w = dot(r38.xyzw, r21.xyzw);
                ...
                if (r14.w != 0) {
                  ...
                  r19.xyz = r19.xyz * r10.www + r10.xyz;
                  r10.w = dot(r19.xyz, r19.xyz);
                  r10.w = rsqrt(r10.w);
                  r19.xyz = r19.xyz * r10.www;
                  r10.w = dot(r19.xyz, r10.xyz);
                  r15.w = dot(r2.xyz, r19.xyz);
                  r19.x = abs(r15.w) * r0.z + -abs(r15.w);
                  r15.w = abs(r15.w) * r19.x + 1;
                  r13.w = r13.w * r0.w + r2.w;
                  r15.w = r15.w * r15.w;
                  r13.w = r15.w * r13.w;
                  r13.w = rcp(r13.w);
                  r13.w = r13.w * r14.w;
