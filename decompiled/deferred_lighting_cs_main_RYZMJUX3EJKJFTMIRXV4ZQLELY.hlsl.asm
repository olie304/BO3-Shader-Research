...
loop 
  ieq r18.w, r17.w, l(2)
  breakc_nz r18.w
  movc r18.w, r17.w, r0.x, r15.z
  uge r19.z, r18.w, r15.y
  ult r19.w, r18.w, cb2[0].y
  and r19.z, r19.w, r19.z
  if_nz r19.z
    imul null, r18.w, r18.w, l(14)
    add r24.xyz, r10.xyzx, -cb10[r18.w + 0].xyzx
    ...
    movc r25.xy, r20.wwww, r17.xyxx, r17.zxzz
    ...
    loop 
      ...
      movc r19.y, r26.z, r21.w, r26.w
      movc r26.xy, r25.wwww, r26.xyxx, r19.xyxx
      iadd r20.w, r20.w, l(1)
      mov r17.x, r25.z
    endloop 
    mov_sat r26.y, r26.y
    mul r17.x, r26.y, cb10[r18.w + 6].y
    lt r19.y, l(0.000000), r17.x
    if_nz r19.y
      mad r23.w, r26.y, cb10[r18.w + 6].y, r23.w
      mul r17.x, r17.x, cb10[r18.w + 7].y
      mov r25.x, cb10[r18.w + 7].w
      mov r25.yz, cb10[r18.w + 8].xxyx
      dp3 r19.y, r16.xyzx, r25.xyzx
      dp3 r19.z, r24.xyzx, r25.xyzx
      ...
      div r19.z, r19.w, r19.z
      min r19.y, |r19.z|, r19.y
      add r25.x, r24.x, cb10[r18.w + 3].w
      add r25.yz, r24.yyzy, cb10[r18.w + 4].xxyx
      mad r25.xyz, r16.xyzx, r19.yyyy, r25.xyzx
      ...
      mov r29.xy, cb10[r18.w + 1].xwxx
      mov r29.z, cb10[r18.w + 2].z
      dp3 r28.y, r25.xyzx, r29.xyzx
      mov r30.x, cb10[r18.w + 1].y
      mov r30.yz, cb10[r18.w + 2].xxwx
      dp3 r28.z, r25.xyzx, r30.xyzx
      ubfe r19.z, l(9), l(16), cb10[r18.w + 7].z
      utof r28.w, r19.z
      sample_l_indexable(texturecubearray)(float,float,float,float) r19.yzw, r28.xyzw, t8.wxyz, s2, r19.y
      dp3 r25.x, r24.xyzx, r27.xyzx
      dp3 r25.y, r24.xyzx, r29.xyzx
      dp3 r25.z, r24.xyzx, r30.xyzx
      mad_sat r24.xyz, r25.xyzx, cb10[r18.w + 3].xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
      mul r25.xy, r24.xyxx, cb10[r18.w + 4].zwzz
      mul r25.z, r24.z, cb10[r18.w + 5].x
      add r24.xyz, r25.xyzx, cb10[r18.w + 5].yzwy
      dp3 r28.x, r11.xyzx, r27.xyzx
      dp3 r28.y, r11.xyzx, r29.xyzx
      dp3 r28.z, r11.xyzx, r30.xyzx
      lt r25.xyz, l(0.000000, 0.000000, 0.000000, 0.000000), r28.xyzx
      movc r18.z, r25.x, l(0), l(0.500000)
      add r26.xzw, r18.xxyz, r24.xxyz
      ...
      movc r20.z, r25.y, l(0), l(0.500000)
      add r25.xyw, r20.xyxz, r24.xyxz
      ...
      mad r25.xyw, r26.xzxw, r27.xxxx, r25.xyxw
      ...
      mad r24.xyz, r24.xyzx, r27.zzzz, r25.xywx
      ...
      dp3 r18.z, r26.xzwx, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r22.xyz, r24.xyzx, r25.xyzx, r22.xyzx
      mul r18.w, r14.w, r18.z
      ...
      mov r24.x, r22.w
      mov r24.yz, r23.yyzy
      mad r23.xyz, r19.yzwy, r17.xxxx, r24.xyzx
      mov r22.w, r23.x
    endif 
  endif 
  iadd r17.w, r17.w, l(1)
endloop 
lt r17.x, r23.w, l(1.000000)
if_nz r17.x
  mov r17.yz, l(0,0,1.000000,0)
  mov r18.xy, l(0,0,0,0)
  mov r19.x, l(1.000000)
  ...
  loop 
    ...
    if_nz r19.z
      ...
      loop 
        ...
        iadd r21.w, r19.z, r20.w
        imul null, r21.w, r21.w, l(6)
        dp3 r25.w, cb11[r21.w + 0].xyzx, r26.xyzx
        ...
        movc r19.y, r27.w, r21.w, r28.z
        movc r28.xy, r27.zzzz, r28.xyxx, r19.xyxx
        iadd r20.w, r20.w, l(1)
        mov r17.x, r26.w
      endloop 
      add_sat r17.x, -r23.w, r28.y
      mul r19.y, r17.x, cb10[r18.w + 6].y
      lt r19.z, l(0.000000), r19.y
      if_nz r19.z
        mad r24.w, r17.x, cb10[r18.w + 6].y, r24.w
        mul r17.x, r19.y, cb10[r18.w + 7].y
...
if_nz r8.w
  ...
  mov r16.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r19.xyz, r16.xyzw, t8.xyzw, s2, r13.z
  mad r0.x, cb2[19].x, r8.w, -r11.w
  mad r0.x, r2.y, r0.x, r11.w
  mad r18.xyz, r19.xyzx, r0.xxxx, r18.xyzx
endif 
add r0.x, -r2.w, l(1.000000)
mad r9.xyw, r18.xyxz, r0.xxxx, r9.xyxw
...
if_nz r4.z
  ...
  if_nz r4.z
    ...
    mad r20.xyz, r4.zzzz, r9.xywx, r2.yzwy
    add_sat r0.z, -r0.z, l(1.000000)
    mul r6.w, r0.z, r0.z
    mul r6.w, r6.w, r6.w
    mul r0.z, r0.z, r6.w
    mul r0.z, r0.z, r4.z
    mad r21.xyz, r0.zzzz, r9.ywxy, r18.xyzx
    mov r19.w, r21.z
    mov r17.w, r18.z
    movc r17.xyzw, r5.wwww, r19.xyzw, r17.xyzw
    mov r21.zw, r20.xxxy
    mov r18.zw, r2.yyyz
    movc r19.xyzw, r5.wwww, r21.xyzw, r18.xyzw
    movc r2.w, r5.w, r20.z, r2.w
    mov r18.z, r17.w
    mov r18.xy, r19.xyxx
    mov r2.yz, r19.zzwz
  endif 
...
loop 
  ...
  switch r6.w
    ...
    if_nz r13.w
      sqrt r13.w, r11.w
      mul r14.w, cb9[r5.w + 3].x, cb9[r5.w + 3].x
      div r11.w, r14.w, r11.w
      min r11.w, r11.w, l(1.000000)
      mad_sat r15.yz, r13.wwww, cb9[r5.w + 2].xxzx, cb9[r5.w + 2].yywy
      mul r34.xy, r15.yzyy, r15.yzyy
      mad r15.yz, r15.yyzy, l(0.000000, -2.000000, -2.000000, 0.000000), l(0.000000, 3.000000, 3.000000, 0.000000)
      mul r15.yz, r15.yyzy, r34.xxyx
      mul r11.w, r11.w, r15.y
      mul r11.w, r15.z, r11.w
      lt r13.w, l(0.000000), r11.w
      if_nz r13.w
        ubfe r13.w, l(3), l(27), cb9[r5.w + 1].w
        ine r13.w, r13.w, l(1)
        if_nz r13.w
          mad r13.w, |r12.w|, l(-0.200000), l(0.400000)
          mad r34.xyz, r11.xyzx, r13.wwww, r10.xyzx
          add r34.xyz, r34.xyzx, -cb9[r5.w + 4].yzwy
          max r13.w, |r34.z|, |r34.y|
          max r13.w, r13.w, |r34.x|
          div r13.w, cb9[r5.w + 5].x, r13.w
          add r13.w, r13.w, cb9[r5.w + 5].y
          dp3 r14.w, r34.xyzx, r34.xyzx
          rsq r14.w, r14.w
          max r13.w, r13.w, l(0.00006104)
          and r15.y, l(0x0000ffff), cb9[r5.w + 1].w
          utof r35.w, r15.y
          mov r15.yz, l(0,0,0,0)
          loop 
            ige r16.w, r15.z, l(8)
            breakc_nz r16.w
            dp2 r36.y, icb[r15.z + 0].yxyy, r19.xyxx
            dp2 r36.z, icb[r15.z + 0].yxyy, r19.yzyy
            mul r36.yz, r36.yyzy, cb9[r5.w + 3].yyyy
            mul r36.x, r15.x, r36.y
            mul r36.w, r3.x, r36.y
            mad r35.xyz, r34.xyzx, r14.wwww, r36.xzwx
            sample_c_lz_indexable(texturecubearray)(float,float,float,float) r16.w, r35.xyzw, t10.xxxx, s13, r13.w
        ...
        lt r13.w, l(0.000000), r11.w
        if_nz r13.w
          mul r13.w, r0.w, cb9[r5.w + 1].z
          mul r13.w, r13.w, l(0.250000)
          dp3 r14.w, r31.xyzx, r16.xyzx
          dp3 r15.z, r16.xyzx, r33.xyzx
          mad r16.w, -r14.w, r14.w, cb9[r5.w + 6].y
          mad r7.w, r14.w, r15.z, -r7.w
          div_sat r7.w, r7.w, r16.w
          div r14.w, r16.w, cb9[r5.w + 6].y
          ...
          if_nz r8.w
            ...
            if_z r15.z
              ...
              add r33.x, r20.x, cb9[r7.w + 9].w
              add r33.y, r20.y, cb9[r7.w + 10].x
              mul r20.xy, r33.xyxx, cb9[r7.w + 9].yzyy
              div r33.xy, cb9[r7.w + 3].yyyy, cb9[r7.w + 8].ywyy
              add r33.zw, -r33.xxxy, l(0.000000, 0.000000, 1.000000, 1.000000)
              ge r33.zw, r20.xxxy, r33.zzzw
              ge r33.xy, r33.xyxx, r20.xyxx
              or r33.xy, r33.xyxx, r33.zwzz
              or r16.w, r33.y, r33.x
              if_z r16.w
                mov_sat r20.xy, r20.xyxx
                mad r33.x, r20.x, cb9[r7.w + 8].y, cb9[r7.w + 8].z
                mad r33.y, r20.y, cb9[r7.w + 8].w, cb9[r7.w + 9].x
            ...
            if_z r14.w
              ...
              if_nz cb2[58].y
                ...
                loop 
                  ige r17.w, r16.w, l(8)
                  breakc_nz r17.w
                  dp2 r34.x, icb[r16.w + 0].yxyy, r19.xwxx
                  dp2 r34.y, icb[r16.w + 0].xyxx, r13.xyxx
                  mad r20.xy, r34.xyxx, cb9[r7.w + 3].yyyy, r33.xyxx
                  sample_c_lz_indexable(texture2darray)(float,float,float,float) r17.w, r20.xyzx, t9.xxxx, s13, r8.w
                  mad r15.z, r17.w, l(0.125000), r15.z
                  iadd r16.w, r16.w, l(1)
                endloop 
              else 
                utof r33.z, r14.w
                sample_c_lz_indexable(texture2darray)(float,float,float,float) r15.z, r33.xyzx, t9.xxxx, s13, r8.w
              endif 
            ...
            if_nz r8.w
              ...
              if_z r16.w
                ...
                mad r20.xy, r20.xyxx, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
                add r22.x, r20.x, cb9[r7.w + 9].w
                add r22.y, r20.y, cb9[r7.w + 10].x
                mul r20.xy, r22.xyxx, cb9[r7.w + 9].yzyy
                div r22.xy, cb9[r7.w + 3].yyyy, cb9[r7.w + 8].ywyy
                add r33.xy, -r22.xyxx, l(1.000000, 1.000000, 0.000000, 0.000000)
                ge r33.xy, r20.xyxx, r33.xyxx
                ge r22.xy, r22.xyxx, r20.xyxx
                or r22.xy, r22.xyxx, r33.xyxx
                or r17.w, r22.y, r22.x
                if_z r17.w
                  mov_sat r20.xy, r20.xyxx
                  mad r22.x, r20.x, cb9[r7.w + 8].y, cb9[r7.w + 8].z
                  mad r22.y, r20.y, cb9[r7.w + 8].w, cb9[r7.w + 9].x
                  mul r18.w, r14.w, cb9[r7.w + 10].z
                  mad r8.w, cb9[r7.w + 10].y, r14.w, r8.w
                  div r8.w, r8.w, r18.w
                endif 
              else 
              ...
              if_z r14.w
                ...
                if_nz cb2[58].y
                  ...
                  loop 
                    ...
                    mad r20.xy, r33.xyxx, cb9[r7.w + 3].yyyy, r22.xyxx
                    sample_c_lz_indexable(texture2darray)(float,float,float,float) r18.w, r20.xyzx, t9.xxxx, s13, r8.w
          ...
          mad r22.xyz, r7.wwww, r20.xyzx, r9.xywx
          ...
          mul r7.w, r7.w, r12.w
          mul r7.w, r11.w, r7.w
          mad r31.xyz, r7.wwww, r20.xyzx, r30.xyzx
          ...
          movc r9.xyw, r8.wwww, r22.xyxz, r9.xyxw
    ...
    if_nz r11.w
      ...
      if_nz r12.w
        ...
        mad_sat r32.xy, r11.wwww, cb9[r5.w + 2].xzxx, cb9[r5.w + 2].ywyy
        ...
        mul r13.z, r13.z, r32.x
        mul r13.z, r32.y, r13.z
        ...
        div r21.xy, r32.xyxx, r11.wwww
        lt r11.w, cb9[r5.w + 10].w, l(0.00048828)
        if_nz r11.w
          mad_sat r32.xy, |r21.xyxx|, cb9[r5.w + 12].xyxx, cb9[r5.w + 12].zwzz
          mul r32.zw, r32.xxxy, r32.xxxy
          mad r32.xy, r32.xyxx, l(-2.000000, -2.000000, 0.000000, 0.000000), l(3.000000, 3.000000, 0.000000, 0.000000)
          mul r32.xy, r32.xyxx, r32.zwzz
          mul r11.w, r32.y, r32.x
        else 
          ...
          exp r32.xy, r32.xyxx
          mul r13.w, r32.x, cb9[r5.w + 12].x
          mad r14.w, cb9[r5.w + 12].y, r32.y, l(-1.000000)
          mad r13.w, cb9[r5.w + 12].y, r32.y, -r13.w
          div_sat r13.w, r14.w, r13.w
          mul r14.w, r13.w, r13.w
          mad r13.w, r13.w, l(-2.000000), l(3.000000)
          mul r11.w, r13.w, r14.w
        endif 
        ...
        if_nz r11.w
          ...
          dp3 r13.w, r32.xyzx, r21.xyzx
          frc r32.xy, r13.zwzz
          iadd r11.w, r11.w, l(-1)
          utof r32.z, r11.w
          sample_l_indexable(texture2darray)(float,float,float,float) r22.xyz, r32.xyzx, t20.xyzw, s2, l(0.000000)
        else 
          mov r22.xyz, l(1.000000,1.000000,1.000000,0)
        endif 
      endif 
      ...
      if_nz r11.w
          ...
          if_nz r13.w
            ...
            if_nz cb2[58].y
              ...
              loop 
                ige r17.w, r14.w, l(8)
                breakc_nz r17.w
                dp2 r31.x, icb[r14.w + 0].xyxx, r26.xyxx
                dp2 r31.y, icb[r14.w + 0].yxyy, r26.xzxx
                mad r22.xy, r31.xyxx, cb9[r5.w + 3].yyyy, r23.xyxx
                sample_c_lz_indexable(texture2darray)(float,float,float,float) r17.w, r22.xyzx, t9.xxxx, s13, r11.w
        ...
        if_nz r12.w
          ...
          if_nz r14.w
            ...
            if_z r18.w
              ...
              if_z r22.z
                ...
                mul r22.x, r17.w, cb9[r13.z + 10].z
                mad r14.w, cb9[r13.z + 10].y, r17.w, r14.w
                div r14.w, r14.w, r22.x
              endif 
            else 
              mov r22.z, l(-1)
            endif 
            or r17.w, r18.w, r22.z
            if_z r17.w
              max r14.w, r14.w, l(0.00006104)
              and r17.w, l(0x0000ffff), cb9[r13.z + 1].w
              if_nz cb2[58].y
                utof r22.z, r17.w
                mov r18.w, l(0)
                mov r24.x, l(0)
                loop 
                  ...
                  mad r18.w, r22.x, l(0.125000), r18.w
                  iadd r24.x, r24.x, l(1)
                endloop 
              else 
                utof r23.z, r17.w
                sample_c_lz_indexable(texture2darray)(float,float,float,float) r18.w, r23.xyzx, t9.xxxx, s13, r14.w
              endif 
            ...
            if_nz r13.z
              ...
              mov r31.xyz, cb9[r5.w + 7].yzwy
              mov r31.w, cb9[r5.w + 8].x
              dp4 r14.w, r31.xyzw, r25.xyzw
              lt r17.w, r14.w, r13.z
              if_z r17.w
                mov r31.xyz, cb9[r5.w + 4].yzwy
                mov r31.w, cb9[r5.w + 5].x
                ...
                if_z r22.z
                  ...
                  mad r23.x, r22.x, cb9[r5.w + 8].y, cb9[r5.w + 8].z
                  mad r23.y, r22.y, cb9[r5.w + 8].w, cb9[r5.w + 9].x
                  mul r22.x, r14.w, cb9[r5.w + 10].z
                  mad r13.z, cb9[r5.w + 10].y, r14.w, r13.z
                  div r13.z, r13.z, r22.x
                endif 
              else 
                mov r22.z, l(-1)
              endif 
              or r14.w, r17.w, r22.z
              if_z r14.w
                max r13.z, r13.z, l(0.00006104)
                and r14.w, l(0x0000ffff), cb9[r5.w + 1].w
                if_nz cb2[58].y
                  utof r22.z, r14.w
                  mov r17.w, l(0)
                  mov r24.x, l(0)
                  loop 
                    ...
                    mad r17.w, r22.x, l(0.125000), r17.w
                    iadd r24.x, r24.x, l(1)
                  endloop 
                else 
                  utof r23.z, r14.w
          ...
          mad r22.xyz, r5.wwww, r21.xywx, r9.xywx
          ...
          mad r20.xyz, r6.wwww, r21.xywx, r30.xyzx
          add_sat r5.w, -r5.w, l(1.000000)
          mul r8.w, r5.w, r5.w
          mul r8.w, r8.w, r8.w
          mul r5.w, r5.w, r8.w
          mul r5.w, r5.w, r6.w
          mad r21.xyw, r5.wwww, r21.xyxw, r29.xyxz
          movc r9.xyw, r7.wwww, r22.xyxz, r9.xyxw
          movc r29.xyz, r7.wwww, r21.xywx, r29.xyzx
