...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:43:15 2021
//
//
// Buffer Definitions: 
//
...
if_nz r0.w
  ...
  if_nz r0.w
    ...
    mul r3.yz, r1.wwzw, v3.xxxx
    ne r1.z, v3.y, l(0.000000)
    if_nz r1.z
      iadd r1.z, r0.w, v4.y
      ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r5.xyzw, r1.z, l(0), t5.xyzw
      dp3 r1.w, r5.xyzx, v0.xyzx
      add r1.w, r5.w, r1.w
      mad r4.x, r1.w, v3.y, r4.x
      dp3 r1.w, r5.xyzx, r0.xyzx
      mad r3.x, r1.w, v3.y, r3.x
      ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r5.xyzw, r1.z, l(16), t5.xyzw
      dp3 r1.w, r5.xyzx, v0.xyzx
      add r1.w, r5.w, r1.w
      mad r4.y, r1.w, v3.y, r4.y
      dp3 r1.w, r5.xyzx, r0.xyzx
      mad r3.y, r1.w, v3.y, r3.y
      ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r5.xyzw, r1.z, l(32), t5.xyzw
      dp3 r1.z, r5.xyzx, v0.xyzx
      add r1.z, r5.w, r1.z
      mad r4.z, r1.z, v3.y, r4.z
      dp3 r1.z, r5.xyzx, r0.xyzx
      mad r3.z, r1.z, v3.y, r3.z
      ne r1.z, v3.z, l(0.000000)
      if_nz r1.z
        iadd r1.z, r0.w, v4.z
        ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r5.xyzw, r1.z, l(0), t5.xyzw
        dp3 r1.w, r5.xyzx, v0.xyzx
        add r1.w, r5.w, r1.w
        mad r4.x, r1.w, v3.z, r4.x
        dp3 r1.w, r5.xyzx, r0.xyzx
        mad r3.x, r1.w, v3.z, r3.x
        ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r5.xyzw, r1.z, l(16), t5.xyzw
        dp3 r1.w, r5.xyzx, v0.xyzx
        add r1.w, r5.w, r1.w
        mad r4.y, r1.w, v3.z, r4.y
        dp3 r1.w, r5.xyzx, r0.xyzx
        mad r3.y, r1.w, v3.z, r3.y
        ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r5.xyzw, r1.z, l(32), t5.xyzw
        dp3 r1.z, r5.xyzx, v0.xyzx
        add r1.z, r5.w, r1.z
        mad r4.z, r1.z, v3.z, r4.z
        dp3 r1.z, r5.xyzx, r0.xyzx
        mad r3.z, r1.z, v3.z, r3.z
        ne r1.z, v3.w, l(0.000000)
        if_nz r1.z
          iadd r0.w, r0.w, v4.w
          ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r5.xyzw, r0.w, l(0), t5.xyzw
          dp3 r1.z, r5.xyzx, v0.xyzx
          add r1.z, r5.w, r1.z
          mad r4.x, r1.z, v3.w, r4.x
          dp3 r1.z, r5.xyzx, r0.xyzx
          mad r3.x, r1.z, v3.w, r3.x
          ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r5.xyzw, r0.w, l(16), t5.xyzw
          dp3 r1.z, r5.xyzx, v0.xyzx
          add r1.z, r5.w, r1.z
          mad r4.y, r1.z, v3.w, r4.y
          dp3 r1.z, r5.xyzx, r0.xyzx
          mad r3.y, r1.z, v3.w, r3.y
  ...
  mul r4.xyz, r2.xywx, v3.xxxx
  mul r2.xyw, r5.xyxz, v3.xxxx
  ...
  if_nz r0.w
    ...
    mad r4.xyz, r6.xyzx, v3.yyyy, r4.xyzx
    mad r2.xyw, r5.xyxz, v3.yyyy, r2.xyxw
    ...
    if_nz r0.w
      ...
      mad r2.xyw, r5.xyxz, v3.zzzz, r2.xyxw
      ...
      if_nz r0.w
        ...
        mad r4.xyz, r3.xyzx, v3.wwww, r4.xyzx
        mad r2.xyw, r5.xyxz, v3.wwww, r2.xyxw
      endif 
    endif 
  endif 
...
dp3 o2.x, r0.xyzx, r3.xyzx
dp3 o2.y, r0.xyzx, r4.xyzx
dp3 o2.z, r0.xyzx, r5.xyzx
iadd r0.x, r0.w, v4.x
...
movc r0.xyz, r0.wwww, r3.xyzx, l(1.000000,0,0,0)
...
sqrt r1.w, r1.w
add r2.w, r1.w, l(-0.225000)
lt r3.x, r2.w, l(0.000000)
mul r1.w, r1.w, l(0.88888896)
mad r2.w, r2.w, l(1.09090912), l(0.200000)
movc r1.w, r3.x, r1.w, r2.w
mul r1.w, r1.w, r1.w
mad_sat r1.w, -r1.w, l(18.400000), l(1.000000)
mul r1.w, r1.w, l(0.101000)
  ...
  if_nz r0.x
    ...
    if_nz r0.x
      ...
      if_nz r0.y
        ...
        dp3 r0.z, r4.xyzx, v0.xyzx
        add r0.z, r4.w, r0.z
        mad r3.x, r0.z, v3.y, r3.x
        ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r4.xyzw, r0.y, l(16), t8.xyzw
        dp3 r0.z, r4.xyzx, v0.xyzx
        add r0.z, r4.w, r0.z
        mad r3.y, r0.z, v3.y, r3.y
        ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r4.xyzw, r0.y, l(32), t8.xyzw
        dp3 r0.y, r4.xyzx, v0.xyzx
        add r0.y, r4.w, r0.y
        mad r3.z, r0.y, v3.y, r3.z
        ...
        if_nz r0.y
          ...
          dp3 r0.z, r4.xyzx, v0.xyzx
          add r0.z, r4.w, r0.z
          mad r3.x, r0.z, v3.z, r3.x
          ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r4.xyzw, r0.y, l(16), t8.xyzw
          dp3 r0.z, r4.xyzx, v0.xyzx
          add r0.z, r4.w, r0.z
          mad r3.y, r0.z, v3.z, r3.y
          ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r4.xyzw, r0.y, l(32), t8.xyzw
          dp3 r0.y, r4.xyzx, v0.xyzx
          add r0.y, r4.w, r0.y
          mad r3.z, r0.y, v3.z, r3.z
    ...
    mad r1.w, r5.y, r6.y, r6.w
    add r9.x, -r1.w, l(1.000000)
    mad r10.x, r5.z, r6.x, -r1.x
    ...
    mul r3.xyz, r0.xyzx, v3.xxxx
    ne r0.x, v3.y, l(0.000000)
    if_nz r0.x
      mov r4.x, v4.y
      ld_indexable(texture2d)(float,float,float,float) r5.xyzw, r4.xyzz, t2.xyzw
      ld_indexable(texture2d)(float,float,float,float) r6.xyzw, r4.xwzz, t2.xyzw
      ...
      add r2.xyw, r7.xyxz, r6.xyxz
      add r0.xyz, r0.xyzx, r2.xywx
      mad r3.xyz, r0.xyzx, v3.yyyy, r3.xyzx
      ne r0.x, v3.z, l(0.000000)
      if_nz r0.x
        mov r4.x, v4.z
        ld_indexable(texture2d)(float,float,float,float) r5.xyzw, r4.xyzz, t2.xyzw
        ld_indexable(texture2d)(float,float,float,float) r6.xyzw, r4.xwzz, t2.xyzw
        ...
        add r2.xyw, r7.xyxz, r6.xyxz
        add r0.xyz, r0.xyzx, r2.xywx
        mad r3.xyz, r0.xyzx, v3.zzzz, r3.xyzx
        ne r0.x, v3.w, l(0.000000)
        if_nz r0.x
          mov r4.x, v4.w
          ld_indexable(texture2d)(float,float,float,float) r5.xyzw, r4.xyzz, t2.xyzw
          ld_indexable(texture2d)(float,float,float,float) r6.xyzw, r4.xwzz, t2.xyzw
...
and r0.x, r1.y, l(0x0fffffff)
ine r0.y, r1.z, l(0)
ieq r0.z, r0.w, l(0)
and r0.y, r0.z, r0.y
ine r0.z, r0.x, l(0)
and r0.y, r0.z, r0.y
movc r0.y, r0.y, r0.x, r1.z
iadd r0.x, r0.x, r0.y
