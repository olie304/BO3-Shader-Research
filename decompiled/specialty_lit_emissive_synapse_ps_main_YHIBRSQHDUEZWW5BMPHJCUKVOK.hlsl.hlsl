// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:42:22 2021
...
cbuffer _Globals : register(b0)
{
  ...
  float2 rotateUVs : packoffset(c12);
  float2 scrollUVs : packoffset(c12.z);
  float2 scaleUVs : packoffset(c13);
  float2 offsetUVs : packoffset(c13.z);
  float2 zoomUVs : packoffset(c14);
  float zoomRate : packoffset(c14.z);
  float layerDepth : packoffset(c14.w);
  bool clampU : packoffset(c15);
  bool clampV : packoffset(c15.y);
  float hdrScale : packoffset(c15.z);
  float emissiveFalloffPower : packoffset(c15.w);
  float3 emissiveTint1 : packoffset(c16);
  bool relativeHDR : packoffset(c16.w);
  float2 maskTiling : packoffset(c17);
  float2 colorTiling : packoffset(c17.z);
  float revealDriver : packoffset(c18);
  float pulseDriver : packoffset(c18.y);
}
...
Texture2D<float4> revealMap : register(t26);
...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  r0.xyzw = colorTiling.xy * v2.xyxy;
  ...
  r0.y = min(1, r0.y);
  r2.zw = detailScale.xy * v2.xy;
  r4.xyz = detailMap.Sample(normalSampler_s, r2.zw).xyz;
  r2.zw = r4.xy * float2(1.9921875,1.9921875) + float2(-1,-1);
  r1.w = r4.z * r4.z;
  r1.w = 0.333333343 * r1.w;
  r1.w = min(1, r1.w);
  r3.xy = r2.zw * detailScaleHeight + r2.xy;
  r2.x = dot(r3.xyz, r3.xyz);
  r2.x = rsqrt(r2.x);
  r2.xyz = r3.xyz * r2.xxx;
  r0.y = r1.w * detailScaleHeight + r0.y;
  r1.w = v8.x ? 1 : -1;
  ...
  r0.x = r0.y + r0.x;
  r0.x = log2(r0.x);
  r0.y = saturate(-0.0588235296 * r0.x);
  ...
  r5.xy = r5.zw * scaleUVs.xy + r8.xy;
  r3.w = gameTime.w * zoomRate;
  r3.w = cos(r3.w);
  r3.w = r3.w * 0.5 + 0.5;
  r3.w = 1 + -r3.w;
  r4.w = zoomUVs.y + -zoomUVs.x;
  r3.w = r3.w * r4.w + zoomUVs.x;
  r5.xy = r5.xy / r3.ww;
  r5.xy = float2(0.5,0.5) + r5.xy;
  r5.zw = saturate(r5.xy);
  r5.xy = clampU ? r5.zw : r5.xy;
  r5.xyz = emissiveMap.Sample(colorSampler_s, r5.xy).xyz;
  r0.z = emissiveMap.Sample(colorSampler_s, r0.zw).w;
  r5.xyz = emissiveTint1.xyz * r5.xyz;
...
r6.y = samp0[]..swiz;
  r6.x = saturate(r6.x);
  r0.w = revealMap.Sample(revealSampler_s, v2.xy).x;
  r3.w = saturate(r6.y * 0.998000026 + 0.00100000005);
  r4.w = 1 + -r3.w;
  r5.w = saturate(alphaRevealParms.y);
  r3.w = log2(r3.w);
  r3.w = r5.w * r3.w;
  r3.w = exp2(r3.w);
  r7.x = -r3.w;
  ...
  r3.w = r5.w * r3.w;
  r7.y = exp2(r3.w);
  r6.yz = saturate(alphaRevealParms.xx * r7.xy + r4.ww);
  r0.w = -r6.y + r0.w;
  r3.w = r6.z + -r6.y;
  r0.w = saturate(r0.w / r3.w);
  r3.x = saturate(dot(r4.xyz, r3.xyz));
  r3.y = cmp(clampU == 0.000000);
  r3.x = log2(r3.x);
  r3.x = clampU * r3.x;
  r3.x = exp2(r3.x);
  r3.x = r3.y ? 1 : r3.x;
  ...
  r0.zw = float2(0,0);
  while (true) {
    r3.w = cmp((uint)r0.w >= numRefProbes);
    if (r3.w != 0) break;
    r11.z = (uint)r0.w >> 5;
    r12.xyz = (int3)r10.xyz + (int3)r11.xyz;
    r3.w = visibleProbes.Load(r12.xyzw).x;
  // Known bad code for instruction (needs manual fix):
  ...
  r38.w = samp0[]..swiz;
    ...
    r11.w = dot(r34.xyz, r12.xyz);
    r11.w = saturate(r11.w + r34.w);
    r11.z = r11.z * r11.w;
    r11.w = dot(r35.xyz, r12.xyz);
    r11.w = saturate(r11.w + r35.w);
    r11.z = r11.z * r11.w;
    r11.w = dot(r36.xyz, r12.xyz);
    r11.w = saturate(r11.w + r36.w);
    r11.z = r11.z * r11.w;
    r11.w = dot(r37.xyz, r12.xyz);
    r11.w = saturate(r11.w + r37.w);
    r11.z = r11.z * r11.w;
    r11.w = dot(r38.xyz, r12.xyz);
    r11.w = saturate(r11.w + r38.w);
    r13.x = r11.z * r11.w;
    r11.z = (int)r8.y & 1;
    r11.zw = r11.zz ? r13.xy : r13.zx;
    r33.xy = r26.zw;
    r33.z = r27.z;
    r13.x = dot(r9.xyz, r33.xyz);
    ...
    r27.x = r23.w;
    r27.yz = r24.zw;
    r27.xyz = r27.xyz + r12.xyz;
    r27.xyz = r9.xyz * r13.xxx + r27.xyz;
    ...
    r28.w = (uint)r17.w;
    r21.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r28.xyzw, r13.x).xyz;
    r26.yzw = (int3)r21.xyz & int3(-2147483648,-2147483648,-2147483648);
    r26.yzw = cmp((int3)r26.yzw == int3(2139095040,2139095040,2139095040));
    r13.x = (int)r26.z | (int)r26.y;
    r13.x = (int)r26.w | (int)r13.x;
    r21.xyz = r13.xxx ? float3(1,1,0) : r21.xyz;
    r27.x = dot(r12.xyz, r20.xyz);
    r27.y = dot(r12.xyz, r29.xyz);
    r27.z = dot(r12.xyz, r22.xyz);
    ...
    while (true) {
      ...
      if (r14.w != 0) {
        ...
        if (r8.w != 0) {
          ...
          r14.w = 1;
          while (true) {
            r15.z = cmp((int)r14.w >= (int)r17.z);
            if (r15.z != 0) break;
            r15.z = (int)r10.w + (int)r14.w;
          // Known bad code for instruction (needs manual fix):
  ...
  if (r0.z == 0) {
    r0.z = numRefProbes + -numOverrideProbes;
    r0.w = (int)r0.z & -32;
    r3.w = (int)-r0.w + (int)r0.z;
    ...
    while (true) {
      ...
      r11.z = cmp((int)r0.w == (int)r8.w);
      bitmask.w = ((~(-1 << r3.w)) << 0) & 0xffffffff;  r11.w = (((uint)0 << 0) & bitmask.w) | ((uint)r10.w & ~bitmask.w);
      r10.w = r11.z ? r11.w : r10.w;
      r11.z = cmp((int)r8.y == (int)r8.w);
      if (r8.z == 0) r11.w = 0; else if (r8.z+0 < 32) {       r11.w = (uint)r10.w << (32-(r8.z + 0)); r11.w = (uint)r11.w >> (32-r8.z);      } else r11.w = (uint)r10.w >> 0;
      r10.w = r11.z ? r11.w : r10.w;
      r11.z = (int)r8.w + numLights;
      r22.xyzw = r20.xyzw;
      r23.xyz = r21.yzw;
      r11.w = r10.w;
      while (true) {
        ...
        r25.y = samp0[]..swiz;
          ...
          r32.w = samp0[]..swiz;
            ...
            r33.w = samp0[]..swiz;
              ...
              r17.w = -r17.w * r24.w + 1;
              r17.w = r27.y * r17.w;
              r15.y = r27.w ? r17.w : r28.x;
              r27.xy = r27.zz ? r27.xy : r15.xy;
              r16.w = (int)r16.w + 1;
              r13.x = r26.w;
            }
            ...
            r38.x = samp0[]..swiz;
            r38.y = samp0[]..swiz;
              r23.z = r27.y * r12.z + r23.z;
              r12.x = r12.y * r25.z;
              r25.z = r33.z;
              r12.y = dot(r9.xyz, r25.xyz);
              r12.z = dot(r26.xyz, r25.xyz);
              r12.z = r12.z + -r33.w;
              r13.x = cmp(r12.z >= 0);
              r12.z = max(abs(r12.z), r6.w);
              r12.z = r13.x ? r12.z : -r12.z;
              r12.y = max(1.00000001e-07, -r12.y);
              r12.y = r12.z / r12.y;
              r12.y = min(131072, abs(r12.y));
              r33.z = r34.z;
              r12.z = dot(r9.xyz, r33.xyz);
              ...
              r15.yzw = r9.xyz * r12.yyy + r15.yzw;
              r12.z = dot(r15.yzw, r15.yzw);
              r12.z = sqrt(r12.z);
              r12.y = r12.y / r12.z;
              r12.y = r12.y + r12.y;
              r12.y = sqrt(r12.y);
              ...
              if (9 == 0) r12.z = 0; else if (9+16 < 32) {               r12.z = (uint)r25.w << (32-(9 + 16)); r12.z = (uint)r12.z >> (32-9);              } else r12.z = (uint)r25.w >> 16;
              r33.w = (uint)r12.z;
              r15.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r33.xyzw, r12.y).xyz;
              r27.xzw = (int3)r15.yzw & int3(-2147483648,-2147483648,-2147483648);
              r27.xzw = cmp((int3)r27.xzw == int3(2139095040,2139095040,2139095040));
              r12.y = (int)r27.z | (int)r27.x;
              r12.y = (int)r27.w | (int)r12.y;
              r15.yzw = r12.yyy ? float3(1,1,0) : r15.yzw;
              ...
              r12.y = (int)r26.y | (int)r26.x;
              r12.y = (int)r26.z | (int)r12.y;
              r25.xyz = r12.yyy ? float3(1,1,0) : r25.xyz;
              r26.xyz = r25.xyz * r24.xyz;
              r12.y = dot(r26.xyz, float3(0.212599993,0.715200007,0.0722000003));
              r22.xyz = r24.xyz * r25.xyz + r22.xyz;
              r12.z = r12.y * r7.w;
              r15.yzw = r15.yzw * r12.xxx;
              r12.x = dot(r15.yzw, float3(0.212599993,0.715200007,0.0722000003));
              r12.x = r7.w * r12.y + r12.x;
              r12.x = r12.z / r12.x;
              r24.x = r22.w;
              r24.yz = r23.xy;
              r23.xyw = r15.zwy * r12.xxx + r24.yzx;
              r22.w = r23.w;
            }
          }
        }
    ...
    if (r8.y != 0) {
      ...
      r11.w = 0;
      while (true) {
        r13.w = cmp((uint)r11.w >= (uint)r0.z);
        if (r13.w != 0) break;
        r11.z = (uint)r11.w >> 5;
        r12.xyz = (int3)r10.xyz + (int3)r11.xyz;
        r11.z = visibleProbes.Load(r12.xyzw).x;
        r12.x = cmp((int)r0.w == (int)r11.w);
        if (r3.w == 0) r12.y = 0; else if (r3.w+0 < 32) {         r12.y = (uint)r11.z << (32-(r3.w + 0)); r12.y = (uint)r12.y >> (32-r3.w);        } else r12.y = (uint)r11.z >> 0;
        ...
        while (true) {
          if (r12.z == 0) break;
          r13.w = firstbitlow((uint)r12.z);
          r14.w = 1 << (int)r13.w;
          r15.z = (int)r12.z & (int)r14.w;
          if (r15.z != 0) {
            r12.z = (int)r12.z ^ (int)r14.w;
            r14.w = (int)r12.x + (int)r13.w;
          // Known bad code for instruction (needs manual fix):
          ...
          r26.y = samp0[]..swiz;
            ...
            r33.w = samp0[]..swiz;
              ...
              r35.w = samp0[]..swiz;
                ...
                r29.xy = r27.ww ? r29.xy : r15.xy;
                r17.w = (int)r17.w + 1;
                r13.x = r25.w;
              }
              r13.x = saturate(r29.y + -r12.y);
              r14.w = r13.x * r15.w;
              r15.y = cmp(0 < r14.w);
              if (r15.y != 0) {
              // Known bad code for instruction (needs manual fix):
              ...
              r39.y = samp0[]..swiz;
                ...
                r34.w = (uint)r14.w;
                r15.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r34.xyzw, r13.w).xyz;
    ...
    r18.xyz = r20.xyz * r0.zzz;
    r19.xyz = r21.xyz * r0.zzz;
    r0.w = cmp(r21.w < 0.99000001);
    if (r0.w != 0) {
      r0.w = 1 + -r21.w;
      r3.w = sunConstants.globalProbeExposure * r0.w;
      r8.yzw = -globalProbeConstants.data[0].xyz + v7.xyz;
      r11.x = globalProbeConstants.data[0].w * r8.y;
      r11.yz = globalProbeConstants.data[1].xy * r8.zw;
      r8.yzw = saturate(float3(0.5,0.5,0.5) + r11.xyz);
      r11.xy = globalProbeConstants.data[1].zw * r8.yz;
      r11.z = globalProbeConstants.data[2].x * r8.w;
      r8.yzw = globalProbeConstants.data[2].yzw + r11.xyz;
      r11.xyz = cmp(float3(0,0,0) < r2.xyz);
      r11.xyz = r11.xyz ? float3(0,0,0) : float3(0.5,0.5,0.5);
      r11.w = 0;
      r12.xyz = r11.wwx + r8.yzw;
      r12.xyz = gProbeXArray.SampleLevel(samplerLinearClamp_s, r12.xyz, 0).xyz;
      r13.xyz = r2.xyz * r2.xyz;
      r13.xyz = r13.xyz * r3.www;
      r14.xyz = r11.wwy + r8.yzw;
      ...
      r8.yzw = r11.wwz + r8.yzw;
      r8.yzw = gProbeZArray.SampleLevel(samplerLinearClamp_s, r8.yzw, 0).xyz;
      r8.yzw = r8.yzw * r13.zzz + r12.xyz;
      r2.w = 0;
      r11.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r2.xyzw, 6).xyz;
      r8.yzw = r11.xyz * r8.yzw;
      r2.w = dot(r8.yzw, float3(0.212599993,0.715200007,0.0722000003));
      r18.xyz = r20.xyz * r0.zzz + r8.yzw;
      r9.w = 0;
      r8.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r9.xyzw, r6.z).xyz;
      r0.z = sunConstants.globalProbeExposure * r0.w + -r2.w;
      r0.z = r0.y * r0.z + r2.w;
      r19.xyz = r8.yzw * r0.zzz + r19.xyz;
    }
  } else {
    r19.x = r18.w;
  }
  r0.yz = r0.xy * float2(0.984375,0.984375) + float2(0.0078125,0.0078125);
  r0.yz = gEnvBRDFGeneric.SampleLevel(samplerLinear_s, r0.yz, 0).xy;
  r11.xyz = r19.yzx * r0.yyy;
  r0.yzw = r19.xyz * r0.zzz;
  r2.w = sqrt(r5.z);
  r2.w = r2.w * 0.5 + 0.5;
  r2.w = r2.w * r2.w;
  r3.w = 0.5 * r2.w;
  ...
  if (r6.w == 0) {
    ...
    if (r9.w != 0) {
      ...
      while (true) {
        ...
        if (r12.x != 0) break;
        r12.x = (uint)r9.w;
        r12.yz = -sunConstants.splitPinTransform[r12.x].xy + r8.yz;
        r12.y = max(abs(r12.y), abs(r12.z));
        r10.w = sunConstants.splitPinTransform[r12.x].z * r12.y;
        r12.x = cmp(r10.w < 1);
        if (r12.x != 0) {
          break;
        }
    ...
    if (r12.x != 0) {
      ...
      r13.xz = rcp(r12.yy);
      r13.y = -r13.z;
      r12.yzw = r8.yzy * r13.xyz + r12.zwz;
    ...
    if (r12.x == 0) {
      if (enableDitheredShadow == 0) {
        r8.w = (uint)r9.w;
        r12.xy = -sunConstants.splitPinTransform[r8.w].xy + r8.yz;
        r12.xy = sunConstants.splitPinTransform[r8.w].zz * r12.xy;
        r12.xy = r12.xy * float2(0.5,-0.5) + float2(0.5,0.5);
        r8.w = (int16)sunConstants.splitArrayOffset;
        r12.z = r9.w + r8.w;
        r8.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r12.xyz, r6.w).x;
      ...
      if (enableDitheredShadow != 0) {
        ...
        r8.yz = -sunConstants.splitPinTransform[r9.w].xy + r8.yz;
        r8.yz = sunConstants.splitPinTransform[r9.w].zz * r8.yz;
        ...
        while (true) {
          ...
          if (r13.w != 0) break;
          r13.w = cmp((uint)r10.w < (uint)r13.z);
          r14.xy = r13.ww ? r8.yz : r13.xy;
          r14.z = r13.w ? sunConstants.splitPinTransform[r9.w].w : sunConstants.splitPinTransform[r8.w].w;
          r13.w = r13.w ? r9.w : r8.w;
          ...
          r14.z = (uint)r13.w;
          r13.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r14.xyz, r6.w).x;
  ...
  if (r6.w != 0) {
    r6.w = cmp(0 < r7.w);
    if (r6.w != 0) {
      r6.w = sunConstants.specScale * r5.y;
      r6.w = r6.w * r6.z;
      if (sunConstants.sunCookieIndex != 0) {
        r12.xyz = eyeOffset.xyz + v7.xyz;
        r12.w = 1;
        r8.y = dot(sunConstants.sunCookieTransform[0].xyzw, r12.xyzw);
        r8.z = dot(sunConstants.sunCookieTransform[1].xyzw, r12.xyzw);
        r12.xy = frac(r8.yz);
        r8.y = -1 + (int14)sunConstants.sunCookieIndex;
        r12.z = (uint)r8.y;
        r8.yzw = gCookieArray.SampleLevel(samplerLinear_s, r12.xyz, 0).xyz;
      ...
      r15.z = samp0[]..swiz;
      r15.w = samp0[]..swiz;
        r16.x = abs(r5.w) * -0.200000003 + 0.400000006;
        r16.xyz = r2.xyz * r16.xxx + v7.xyz;
        r16.w = 1;
        ...
        r15.y = samp0[]..swiz;
          ...
          if (enableDitheredShadow != 0) {
            ...
            while (true) {
              ...
              r15.xy = r16.xy * r10.ww + r13.xy;
              r12.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r15.xyz, r9.w).x;
              r12.y = r12.w * 0.125 + r12.y;
              r12.z = (int)r12.z + 1;
            }
          } else {
            r13.z = (uint)r12.x;
            r12.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r13.xyz, r9.w).x;
          }
          r9.w = r12.y * r12.y;
          r9.w = r9.w * r12.y;
        } else {
      ...
      r9.w = r9.w * r7.w;
      r5.w = cmp(0 < r5.w);
      r12.xyz = r9.www * r8.yzw + r18.xyz;
      r13.xyz = -v7.xyz * r1.www + sunConstants.wldDir.xyz;
      r1.w = dot(r13.xyz, r13.xyz);
      r1.w = rsqrt(r1.w);
      r13.xyz = r13.xyz * r1.www;
      r1.w = dot(r13.xyz, r4.xyz);
      r9.w = dot(r2.xyz, r13.xyz);
      ...
      r6.z = r7.w * r6.z;
      r6.z = 0.25 * r6.z;
      r13.xyz = r6.zzz * r8.yzw + r0.yzw;
      r1.w = saturate(1 + -r1.w);
      r6.w = r1.w * r1.w;
      r6.w = r6.w * r6.w;
      r1.w = r6.w * r1.w;
      r1.w = r6.z * r1.w;
      r14.xyz = r1.www * r8.zwy + r11.xyz;
      r12.w = r14.z;
      r18.w = r11.z;
      r18.xyzw = r5.wwww ? r12.xyzw : r18.xyzw;
      r14.zw = r13.xy;
      r11.zw = r0.yz;
      r12.xyzw = r5.wwww ? r14.xyzw : r11.xyzw;
      r0.w = r5.w ? r13.z : r0.w;
      r11.z = r18.w;
      r11.xy = r12.xy;
      r0.yz = r12.zw;
    }
      ...
      r31.y = samp0[]..swiz;
        ...
        r36.w = samp0[]..swiz;
          ...
          switch (r11.w) {
            ...
            r13.z = dot(r37.xyz, r39.xyz);
            r13.w = saturate(-r13.z / r36.x);
              ...
              if (r24.w != 0) {
                ...
                if (r24.w != 0) {
                  ...
                  while (true) {
                    ...
                    if (r28.w != 0) break;
                    r42.y = dot(icb[r27.w+0].yx, r12.xy);
                    r42.z = dot(icb[r27.w+0].yx, r12.yz);
                ...
                if (r24.w != 0) {
                  r24.w = r31.x * r5.y;
                  r24.w = 0.25 * r24.w;
                  r25.w = dot(r37.xyz, r9.xyz);
                  r27.w = dot(r9.xyz, r39.xyz);
                  r28.w = -r25.w * r25.w + r36.x;
                  r13.z = r25.w * r27.w + -r13.z;
                  r13.z = saturate(r13.z / r28.w);
                  r25.w = r28.w / r36.x;
                  r25.w = 10 * r25.w;
                  r25.w = min(1, r25.w);
                  r13.z = r13.z + -r13.w;
                  r13.z = r25.w * r13.z + r13.w;
                  r37.xyz = r13.zzz * r37.xyz + r38.xyz;
                  r37.xyz = r11.www ? r37.xyz : r30.yzw;
                  r37.xyz = -v7.xyz + r37.xyz;
                  r11.w = dot(r37.xyz, r37.xyz);
                  r11.w = rsqrt(r11.w);
                  r38.xyz = r37.xyz * r11.www;
                  if (4 == 0) r13.z = 0; else if (4+16 < 32) {                   r13.z = (uint)r31.w << (32-(4 + 16)); r13.z = (uint)r13.z >> (32-4);                  } else r13.z = (uint)r31.w >> 16;
                  ...
                  r40.w = samp0[]..swiz;
                    ...
                    r16.xyz = r2.xyz * r25.www + v7.xyz;
                    r25.w = dot(r39.xyzw, r16.xyzw);
                    r27.w = dot(r40.xyzw, r16.xyzw);
                    ...
                    r43.x = samp0[]..swiz;
                    r43.y = samp0[]..swiz;
                      r39.x = dot(r39.xyzw, r16.xyzw);
                      r39.y = dot(r40.xyzw, r16.xyzw);
                      r16.xy = r39.xy / r27.ww;
                      r16.xy = r16.xy * float2(0.5,-0.5) + float2(0.5,0.5);
                      r16.xy = r16.xy + r42.zw;
                      r16.xy = r16.xy * r42.xy;
                      r39.xy = r13.ww / r41.xz;
                      r39.zw = float2(1,1) + -r39.xy;
                      r39.zw = cmp(r16.xy >= r39.zw);
                      r39.xy = cmp(r39.xy >= r16.xy);
                      r39.xy = (int2)r39.xy | (int2)r39.zw;
                      r16.z = (int)r39.y | (int)r39.x;
                      r16.xy = saturate(r16.xy);
                      r39.xy = r16.xy * r41.xz + r41.yw;
                      r16.x = r43.y * r27.w;
                      r16.y = r43.x * r27.w + r25.w;
                      r16.x = r16.y / r16.x;
                    } else {
                      r16.z = -1;
                    }
                    ...
                    r13.z = samp0[]..swiz;
                      ...
                      if (r7.w != 0) {
                        ...
                        while (true) {
                          ...
                          if (r25.w != 0) break;
                          r41.x = dot(icb[r16.z+0].yx, r12.xw);
                          r41.y = dot(icb[r16.z+0].xy, r6.xy);
                          r40.xy = r41.xy * r13.ww + r39.xy;
                          r25.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r40.xyz, r16.x).x;
                          r16.y = r25.w * 0.125 + r16.y;
                          r16.z = (int)r16.z + 1;
                        }
                      } else {
                        r39.z = (uint)r13.z;
                        r16.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r39.xyz, r16.x).x;
                      }
                      r13.z = r16.y * r16.y;
                      r13.z = r13.z * r16.y;
                    } else {
                    ...
                    if (4 == 0) r13.z = 0; else if (4+20 < 32) {                     r13.z = (uint)r31.w << (32-(4 + 20)); r13.z = (uint)r13.z >> (32-4);                    } else r13.z = (uint)r31.w >> 20;
                    r13.w = cmp(0 < (uint)r13.z);
                    r13.w = r13.w ? r1.w : 0;
                    if (r13.w != 0) {
                      r13.z = (int)r13.z + numLights;
                    ...
                    r40.z = samp0[]..swiz;
                    r40.w = samp0[]..swiz;
                      r16.x = abs(r19.w) * -0.200000003 + 0.400000006;
                      r17.xyz = r2.xyz * r16.xxx + v7.xyz;
                      r16.x = dot(r39.xyzw, r17.xyzw);
                      r16.z = dot(r40.xyzw, r17.xyzw);
                      ...
                      r13.z = samp0[]..swiz;
                        ...
                        if (r7.w != 0) {
                          ...
                          r39.z = (uint)r13.z;
                          r16.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r39.xyz, r16.x).x;
                        }
                        r13.z = r16.z * r16.z;
                        r13.z = r13.z * r16.z;
                      } else {
                  ...
                  r13.z = r13.z + -r23.w;
                  r13.z = r5.z * r13.z + r23.w;
                  r13.z = r13.z * r18.w;
                  r31.x = r30.x;
                  r13.w = cmp(0 < r19.w);
                  r17.xyz = r13.zzz * r31.xyz + r14.xyz;
                  r13.z = saturate(dot(r2.xyz, r38.xyz));
                  r37.xyz = r37.xyz * r11.www + r4.xyz;
                  r11.w = dot(r37.xyz, r37.xyz);
                  r11.w = rsqrt(r11.w);
                  r37.xyz = r37.xyz * r11.www;
                  r11.w = dot(r37.xyz, r4.xyz);
                  r16.x = dot(r2.xyz, r37.xyz);
                  r19.w = abs(r16.x) * r5.y + -abs(r16.x);
                  r16.x = abs(r16.x) * r19.w + 1;
                  r19.w = r13.z * r2.w + r3.w;
                  r16.x = r16.x * r16.x;
                  r16.x = r16.x * r19.w;
                  r16.x = rcp(r16.x);
                  r13.z = r13.z * r24.w;
                  r13.z = r16.x * r13.z;
                  r13.z = r13.z * r18.w;
                  r37.xyz = r13.zzz * r31.xyz + r29.xyz;
                  ...
                  r14.xyz = r13.www ? r17.xyz : r14.xyz;
            ...
            break;
            case 2 :            r17.xy = r33.zw;
            r17.z = r34.w;
            r17.xyz = -v7.xyz + r17.xyz;
            r11.w = dot(r17.xyz, r17.xyz);
            r11.w = rsqrt(r11.w);
            r37.xyz = r17.xyz * r11.www;
            r13.z = dot(r2.xyz, r37.xyz);
            ...
            r38.w = samp0[]..swiz;
              ...
              r19.w = samp0[]..swiz;
                r44.xyz = -v7.xyz + r30.yzw;
                r23.w = r33.x * r33.x;
                r24.w = dot(r44.xyz, r44.xyz);
                r23.w = r23.w / r24.w;
                r23.w = min(1, r23.w);
                r32.xy = saturate(r16.xx * r32.xz + r32.yw);
                ...
                r23.w = r23.w * r32.y;
                r34.w = r35.x;
                r32.x = dot(r34.xyzw, r15.xyzw);
                r44.xyz = r35.yzw;
                r44.w = r36.w;
                r32.y = dot(r44.xyzw, r15.xyzw);
                r19.xy = r32.xy / r16.xx;
                r16.x = cmp(r41.w < 0.00048828125);
                if (r16.x != 0) {
                  r42.y = r43.x;
              ...
              r16.x = cmp(0 < r18.w);
              if (r16.x != 0) {
                if (3 == 0) r16.x = 0; else if (3+27 < 32) {                 r16.x = (uint)r31.w << (32-(3 + 27)); r16.x = (uint)r16.x >> (32-3);                } else r16.x = (uint)r31.w >> 27;
                r16.x = cmp((int)r16.x != 1);
                if (r16.x != 0) {
                  r16.x = abs(r13.z) * -0.200000003 + 0.400000006;
                  r20.xyz = r2.xyz * r16.xxx + v7.xyz;
                  r37.xyz = r36.xyz;
                  r16.x = dot(r37.xyzw, r20.xyzw);
                  ...
                  r38.y = samp0[]..swiz;
                    ...
                    if (r7.w != 0) {
                      ...
                      r20.z = (uint)r16.x;
                      r23.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r20.xyz, r10.w).x;
                    }
                    r10.w = r23.w * r23.w;
                    r10.w = r10.w * r23.w;
                  } else {
                ...
                if (r16.x != 0) {
                  r16.x = r31.x * r5.y;
                  r16.x = r16.x * r13.w;
                  if (4 == 0) r18.w = 0; else if (4+16 < 32) {                   r18.w = (uint)r31.w << (32-(4 + 16)); r18.w = (uint)r18.w >> (32-4);                  } else r18.w = (uint)r31.w >> 16;
                  r20.x = cmp(0 < (uint)r18.w);
                  r20.x = r4.w ? r20.x : 0;
                  if (r20.x != 0) {
                  ...
                  r36.z = samp0[]..swiz;
                  r36.w = samp0[]..swiz;
                    r20.y = abs(r13.z) * -0.200000003 + 0.400000006;
                    r21.xyz = r2.xyz * r20.yyy + v7.xyz;
                    ...
                    r30.y = samp0[]..swiz;
                      ...
                      if (r7.w != 0) {
                        ...
                        r31.z = (uint)r20.y;
                        r20.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r31.xyz, r18.w).x;
                      }
                      r18.w = r20.z * r20.z;
                      r18.w = r18.w * r20.z;
                    } else {
                    ...
                    if (4 == 0) r18.w = 0; else if (4+20 < 32) {                     r18.w = (uint)r31.w << (32-(4 + 20)); r18.w = (uint)r18.w >> (32-4);                    } else r18.w = (uint)r31.w >> 20;
                    r20.x = cmp(0 < (uint)r18.w);
                    r20.x = r20.x ? r1.w : 0;
                    if (r20.x != 0) {
                      r18.w = (int)r18.w + numLights;
                    ...
                    r35.w = samp0[]..swiz;
                      ...
                      r22.z = samp0[]..swiz;
                        ...
                        if (r7.w != 0) {
                          ...
                          r30.z = (uint)r20.y;
                          r22.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r30.xyz, r18.w).x;
                        }
                        r18.w = r22.x * r22.x;
                        r18.w = r18.w * r22.x;
                      } else {
                  ...
                  r18.w = r18.w + -r13.w;
                  r18.w = r5.z * r18.w + r13.w;
                  r18.w = r18.w * r10.w;
                  r13.z = cmp(0 < r13.z);
                  r21.xyz = r18.www * r19.xyw + r14.xyz;
                  r17.xyz = r17.xyz * r11.www + r4.xyz;
                  r11.w = dot(r17.xyz, r17.xyz);
                  r11.w = rsqrt(r11.w);
                  r17.xyz = r17.xyz * r11.www;
                  r11.w = dot(r17.xyz, r4.xyz);
                  r17.x = dot(r2.xyz, r17.xyz);
                  r17.y = abs(r17.x) * r5.y + -abs(r17.x);
                  r17.x = abs(r17.x) * r17.y + 1;
                  r13.w = r13.w * r2.w + r3.w;
                  r17.x = r17.x * r17.x;
                  r13.w = r17.x * r13.w;
                  r13.w = rcp(r13.w);
                  r13.w = r13.w * r16.x;
                  r10.w = r13.w * r10.w;
                  r10.w = 0.25 * r10.w;
                  r17.xyz = r10.www * r19.xyw + r29.xyz;
                  r11.w = saturate(1 + -r11.w);
                  r13.w = r11.w * r11.w;
                  r13.w = r13.w * r13.w;
                  r11.w = r13.w * r11.w;
                  r10.w = r11.w * r10.w;
                  r19.xyw = r10.www * r19.xyw + r28.xyz;
                  r14.xyz = r13.zzz ? r21.xyz : r14.xyz;
                  r28.xyz = r13.zzz ? r19.xyw : r28.xyz;
                  r29.xyz = r13.zzz ? r17.xyz : r29.xyz;
                }
              }
            }
            break;
