...
// ------------------------------ ---------- ------- ----------- -------------- ------
// clampSamplerState                 sampler      NA          NA             s1      1 
...
dcl_output o0.xyzw
dcl_temps 2
mad r0.xyzw, v1.xyxy, cb8[0].xxyy, cb8[1].xyzw
sample_indexable(texture2d)(float,float,float,float) r1.xy, r0.xyxx, t6.xyzw, s1
sample_indexable(texture2d)(float,float,float,float) r1.zw, r0.zwzz, t6.zwxy, s1
mul r0.xyzw, r1.xyzw, cb8[0].zzww
add r0.xy, r0.zwzz, r0.xyxx
add_sat r0.z, v1.y, cb8[2].x
mul r0.z, r0.z, r0.z
mul r0.xy, r0.zzzz, r0.xyxx
mad r0.xy, r0.xyxx, cb8[2].yyyy, v1.xyxx
