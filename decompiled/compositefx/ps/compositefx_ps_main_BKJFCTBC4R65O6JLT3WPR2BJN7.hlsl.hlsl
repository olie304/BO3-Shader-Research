...
SamplerState clampSamplerState_s : register(s1);
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.xyzw = v1.xyxy * postFxControl0.xxyy + postFxControl1.xyzw;
  r1.xy = normalMap.Sample(clampSamplerState_s, r0.xy).xy;
  r1.zw = normalMap.Sample(clampSamplerState_s, r0.zw).xy;
  r0.xyzw = postFxControl0.zzww * r1.xyzw;
  r0.xy = r0.xy + r0.zw;
  r0.z = saturate(postFxControl2.x + v1.y);
  r0.z = r0.z * r0.z;
  r0.xy = r0.xy * r0.zz;
  r0.xy = r0.xy * postFxControl2.yy + v1.xy;
  r0.xyz = colorMap.Sample(clampSamplerState_s, r0.xy).xyz;
  o0.xyz = r0.xyz;
  o0.w = 0;
  return;
}