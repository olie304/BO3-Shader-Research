...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:39:49 2021
//
//
// Buffer Definitions: 
//
...
//   float4 lobeWeightingThicknessRefraction;// Offset:  256 Size:    16 [unused]
//   float3 normalAdjustAndGloss;       // Offset:  272 Size:    12 [unused]
//   float4 decalTint;                  // Offset:  288 Size:    16 [unused]
//   float2 opacityScale;               // Offset:  304 Size:     8 [unused]
//   float invZFeatherDepth;            // Offset:  312 Size:     4 [unused]
//   float2 normalsFlowScaleMin;        // Offset:  320 Size:     8 [unused]
//   float4 ssrParams;                  // Offset:  336 Size:    16 [unused]
//   float translucentShadowOpacity;    // Offset:  352 Size:     4 [unused]
//   float3 foamColor;                  // Offset:  356 Size:    12 [unused]
//   float4 foamMaskScroll01;           // Offset:  368 Size:    16
//   float4 foamMaskScroll23;           // Offset:  384 Size:    16
//   float4 foamMaskScale01;            // Offset:  400 Size:    16
//   float4 foamMaskScale23;            // Offset:  416 Size:    16
//   float foamScale;                   // Offset:  432 Size:     4 [unused]
//   float2 foamSpacing;                // Offset:  436 Size:     8 [unused]
//   float foamColorScale;              // Offset:  444 Size:     4 [unused]
//   float foamZFeather;                // Offset:  448 Size:     4 [unused]
//   bool useFoam;                      // Offset:  452 Size:     4 [unused]
//   bool useSSR;                       // Offset:  456 Size:     4 [unused]
//   bool useLoopedSSR;                 // Offset:  460 Size:     4 [unused]
//   bool useSpecularZFeather;          // Offset:  464 Size:     4 [unused]
//   bool scaleNormalsWithFlow;         // Offset:  468 Size:     4 [unused]
//   bool doubleSidedLighting;          // Offset:  472 Size:     4 [unused]
//
// }
//
...
mul r0.xyzw, cb0[23].xyzw, cb1[69].wwww
mad o7.xyzw, v0.xyxy, cb0[25].xyzw, r0.xyzw
mul r0.xyzw, cb0[24].xyzw, cb1[69].wwww
mad o8.xyzw, v0.xyxy, cb0[26].xyzw, r0.xyzw
mov o1.x, v1.w
mov o1.yz, v2.xxyx
mov o6.xyz, r8.xyzx
mov o2.x, v7.x
