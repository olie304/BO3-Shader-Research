...
sample_indexable(texture2d)(float,float,float,float) r1.yzw, v2.xyxx, t7.wxyz, s2
...
mad r2.xyw, r5.xyxz, r2.xxxx, r7.xyxz
mad r2.xyz, r4.xyzx, r2.zzzz, r2.xywx
dp3 r1.w, r2.xyzx, r2.xyzx
rsq r1.w, r1.w
mul r2.xyz, r1.wwww, r2.xyzx
mul r7.xy, v2.xyxx, cb0[9].xyxx
sample_indexable(texture2d)(float,float,float,float) r8.xyzw, r7.xyxx, t10.xyzw, s3
...
mov_sat r3.w, r3.w
mov_sat r1.w, r1.w
mad r2.w, r2.w, -v1.x, l(1.000000)
mad_sat r4.w, r8.w, l(0.998000), l(0.001000)
mov_sat r5.w, r2.w
add_sat r2.w, r2.w, cb0[8].x
add r6.w, cb0[8].y, cb0[8].y
log r4.w, r4.w
mul r4.w, r4.w, r6.w
exp r4.w, r4.w
add r2.w, -r5.w, r2.w
...
mul r3.w, r3.w, r3.w
mul r3.w, r3.w, r6.w
mad r2.w, r5.w, r2.w, r3.w
mad r1.w, r1.w, -v1.z, l(1.000000)
mov_sat r3.w, r1.w
add_sat r1.w, r1.w, cb0[8].x
add r1.w, -r3.w, r1.w
add r3.w, -r3.w, r4.w
...
mad r0.xyz, r1.wwww, r8.xyzx, r0.xyzx
sample_indexable(texture2d)(float,float,float,float) r7.xyz, r7.xyxx, t11.xyzw, s3
...
mul r4.w, r1.x, l(-17.000000)
exp r4.w, r4.w
add r4.w, r3.w, r4.w
log r4.w, r4.w
mul r4.w, r4.w, l(-0.05882353)
...
rsq r2.w, r2.w
add r4.z, -r1.x, r4.w
mad r1.x, r1.w, r4.z, r1.x
add r3.w, -r1.y, r3.w
mad r1.y, r1.w, r3.w, r1.y
