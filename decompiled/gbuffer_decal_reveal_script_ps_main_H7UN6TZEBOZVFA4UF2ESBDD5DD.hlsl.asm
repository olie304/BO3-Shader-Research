...
if_nz r1.z
  ftoi r1.w, cb1[64].w
  lod r2.x, v2.xyxx, t7.y, s1
  lod r4.w, v2.xyxx, t7.x, s1
  lt r2.x, r2.x, r4.w
...
sample_indexable(texture2d)(float,float,float,float) r9.xyz, v2.xyxx, t11.xyzw, s1
mul r9.xyz, r9.xyzx, v1.xyzx
sample_indexable(texture2d)(float,float,float,float) r10.xyz, v2.xyxx, t12.xyzw, s2
...
sample_indexable(texture2d)(float,float,float,float) r2.y, v2.xyxx, t10.yxzw, s3
