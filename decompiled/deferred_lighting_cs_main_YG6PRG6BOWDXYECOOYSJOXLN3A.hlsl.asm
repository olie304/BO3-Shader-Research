...
loop 
  ieq r14.z, r14.y, l(2)
  breakc_nz r14.z
  movc r14.z, r14.y, r0.y, r13.w
  uge r14.w, r14.z, r10.w
  ult r15.y, r14.z, cb2[0].y
  ...
  if_nz r14.w
    ...
    if_nz r2.w
      ...
      add r17.yzw, cb1[24].xxyz, cb10[r14.z + 0].xxyz
      store_structured u2.xyzw, cb2[52].x, r14.w, r17.xyzw
    endif 
    iadd r25.w, r24.w, l(1)
    add r15.yzw, r11.xxyz, -cb10[r14.z + 0].xxyz
    and r14.w, l(0x0000ffff), cb10[r14.z + 7].z
    ubfe r17.y, l(6), l(25), cb10[r14.z + 7].z
    imul null, r17.z, r14.w, l(6)
    dp3 r17.w, cb11[r17.z + 0].xyzx, r15.yzwy
    add_sat r17.w, r17.w, cb11[r17.z + 0].w
    dp3 r18.w, cb11[r17.z + 1].xyzx, r15.yzwy
    add_sat r18.w, r18.w, cb11[r17.z + 1].w
    mul r17.w, r17.w, r18.w
    dp3 r18.w, cb11[r17.z + 2].xyzx, r15.yzwy
    add_sat r18.w, r18.w, cb11[r17.z + 2].w
    mul r17.w, r17.w, r18.w
    dp3 r18.w, cb11[r17.z + 3].xyzx, r15.yzwy
    add_sat r18.w, r18.w, cb11[r17.z + 3].w
    mul r17.w, r17.w, r18.w
    dp3 r18.w, cb11[r17.z + 4].xyzx, r15.yzwy
    add_sat r18.w, r18.w, cb11[r17.z + 4].w
    mul r17.w, r17.w, r18.w
    dp3 r18.w, cb11[r17.z + 5].xyzx, r15.yzwy
    add_sat r17.z, r18.w, cb11[r17.z + 5].w
    mul r18.x, r17.z, r17.w
    and r17.z, l(1), cb10[r14.z + 6].x
    movc r17.zw, r17.zzzz, r18.xxxy, r18.zzzx
    mov r18.x, cb10[r14.z + 6].x
    mov r26.xy, r17.zwzz
    mov r18.w, l(1)
    loop 
      ige r19.w, r18.w, r17.y
      breakc_nz r19.w
      iadd r19.w, r14.w, r18.w
      imul null, r19.w, r19.w, l(6)
      dp3 r21.w, cb11[r19.w + 0].xyzx, r15.yzwy
      add_sat r21.w, r21.w, cb11[r19.w + 0].w
      mul r21.w, r21.w, r26.x
      dp3 r22.w, cb11[r19.w + 1].xyzx, r15.yzwy
      add_sat r22.w, r22.w, cb11[r19.w + 1].w
      mul r21.w, r21.w, r22.w
      dp3 r22.w, cb11[r19.w + 2].xyzx, r15.yzwy
      add_sat r22.w, r22.w, cb11[r19.w + 2].w
      mul r21.w, r21.w, r22.w
      dp3 r22.w, cb11[r19.w + 3].xyzx, r15.yzwy
      add_sat r22.w, r22.w, cb11[r19.w + 3].w
      mul r21.w, r21.w, r22.w
      dp3 r22.w, cb11[r19.w + 4].xyzx, r15.yzwy
      add_sat r22.w, r22.w, cb11[r19.w + 4].w
      mul r21.w, r21.w, r22.w
      dp3 r22.w, cb11[r19.w + 5].xyzx, r15.yzwy
      add_sat r19.w, r22.w, cb11[r19.w + 5].w
      mul r26.x, r19.w, r21.w
      ushr r22.w, r18.x, l(2)
      ubfe r26.z, l(1), l(2), r18.x
      and r26.w, r22.w, l(2)
      max r27.x, r26.x, r26.y
      mad r19.w, -r21.w, r19.w, l(1.000000)
      mul r19.w, r19.w, r26.y
      movc r20.y, r26.w, r19.w, r27.x
      movc r26.xy, r26.zzzz, r26.xyxx, r20.xyxx
      iadd r18.w, r18.w, l(1)
      mov r18.x, r22.w
    endloop 
    mov_sat r26.y, r26.y
    mul r14.w, r26.y, cb10[r14.z + 6].y
    lt r17.y, l(0.000000), r14.w
    if_nz r17.y
      and r17.y, r25.w, l(7)
      iadd r17.z, r17.y, l(-1)
      ult r17.z, r17.z, l(32)
      and r17.z, r2.w, r17.z
      if_nz r17.z
        imad r17.yz, r17.yyyy, l(0, 20, 20, 0), l(0, 860, 876, 0)
        ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r17.w, cb2[52].x, r17.y, u2.xxxx
        or r17.w, r17.w, l(32)
        store_structured u2.x, cb2[52].x, r17.y, r17.w
        store_structured u2.x, cb2[52].x, r17.z, r14.w
      endif 
      iadd r24.w, r24.w, l(257)
      mad r24.z, r26.y, cb10[r14.z + 6].y, r24.z
      ...
      add r17.z, r17.z, -cb10[r14.z + 8].z
      ...
      dp3 r17.z, r16.xyzx, r27.xyzx
      dp3 r17.w, r15.yzwy, r27.xyzx
      add r17.w, r17.w, -cb10[r14.z + 9].z
      ...
      dp3 r17.z, r16.xyzx, r27.xyzx
      dp3 r17.w, r15.yzwy, r27.xyzx
      add r17.w, r17.w, -cb10[r14.z + 10].z
      ge r18.x, r17.w, l(0.000000)
      max r17.w, r8.w, |r17.w|
      movc r17.w, r18.x, r17.w, -r17.w
      max r17.z, -r17.z, l(0.00000010)
      ...
      dp3 r17.z, r16.xyzx, r27.xyzx
      dp3 r17.w, r15.yzwy, r27.xyzx
      add r17.w, r17.w, -cb10[r14.z + 11].z
      ge r18.x, r17.w, l(0.000000)
      max r17.w, r8.w, |r17.w|
      movc r17.w, r18.x, r17.w, -r17.w
      max r17.z, -r17.z, l(0.00000010)
      ...
      dp3 r17.z, r16.xyzx, r27.xyzx
      dp3 r17.w, r15.yzwy, r27.xyzx
      add r17.w, r17.w, -cb10[r14.z + 12].z
      ge r18.x, r17.w, l(0.000000)
      max r17.w, r8.w, |r17.w|
      movc r17.w, r18.x, r17.w, -r17.w
      max r17.z, -r17.z, l(0.00000010)
      ...
      dp3 r17.z, r16.xyzx, r27.xyzx
      dp3 r17.w, r15.yzwy, r27.xyzx
      add r17.w, r17.w, -cb10[r14.z + 13].z
      ge r18.x, r17.w, l(0.000000)
      max r17.w, r8.w, |r17.w|
      movc r17.w, r18.x, r17.w, -r17.w
      max r17.z, -r17.z, l(0.00000010)
      div r17.z, r17.w, r17.z
      min r17.y, |r17.z|, r17.y
      add r27.x, r15.y, cb10[r14.z + 3].w
      add r27.yz, r15.zzwz, cb10[r14.z + 4].xxyx
      mad r26.xzw, r16.xxyz, r17.yyyy, r27.xxyz
      dp3 r17.z, r26.xzwx, r26.xzwx
      sqrt r17.z, r17.z
      div r17.y, r17.y, r17.z
      add r17.y, r17.y, r17.y
      sqrt r17.y, r17.y
      mad r17.y, r4.w, l(5.000000), r17.y
      add r17.y, r17.y, l(-0.844800)
      mov r27.x, cb10[r14.z + 0].w
      mov r27.y, cb10[r14.z + 1].z
      mov r27.z, cb10[r14.z + 2].y
      dp3 r28.x, r26.xzwx, r27.xyzx
      mov r29.xy, cb10[r14.z + 1].xwxx
      mov r29.z, cb10[r14.z + 2].z
      dp3 r28.y, r26.xzwx, r29.xyzx
      mov r30.x, cb10[r14.z + 1].y
      mov r30.yz, cb10[r14.z + 2].xxwx
      dp3 r28.z, r26.xzwx, r30.xyzx
      ubfe r17.z, l(9), l(16), cb10[r14.z + 7].z
      utof r28.w, r17.z
      ...
      or r18.x, r26.z, r26.x
      or r18.x, r26.w, r18.x
      movc r17.yzw, r18.xxxx, l(0,1.000000,1.000000,0), r17.yyzw
      dp3 r31.x, r15.yzwy, r27.xyzx
      dp3 r31.y, r15.yzwy, r29.xyzx
      dp3 r31.z, r15.yzwy, r30.xyzx
      mad_sat r15.yzw, r31.xxyz, cb10[r14.z + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
      mul r31.xy, r15.yzyy, cb10[r14.z + 4].zwzz
      mul r31.z, r15.w, cb10[r14.z + 5].x
      add r15.yzw, r31.xxyz, cb10[r14.z + 5].yyzw
      ...
      movc r26.xzw, r14.zzzz, l(1.000000,0,1.000000,0), r26.xxzw
      ...
      dp3 r14.w, r17.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r14.z, r9.w, r14.z, r14.w
      div r14.z, r15.y, r14.z
      mov r27.x, r23.w
      mov r27.yz, r24.xxyx
      mad r15.yzw, r17.yyzw, r14.zzzz, r27.xxyz
      mov r23.w, r15.y
      mov r24.xy, r15.zwzz
    else 
...
loop 
  ...
  if_nz r19.w
    ...
    dp3 r26.x, cb11[r22.w + 1].xyzx, r17.yzwy
    add_sat r26.x, r26.x, cb11[r22.w + 1].w
    mul r25.w, r25.w, r26.x
    dp3 r26.x, cb11[r22.w + 2].xyzx, r17.yzwy
    add_sat r26.x, r26.x, cb11[r22.w + 2].w
    mul r25.w, r25.w, r26.x
    dp3 r26.x, cb11[r22.w + 3].xyzx, r17.yzwy
    add_sat r26.x, r26.x, cb11[r22.w + 3].w
    mul r25.w, r25.w, r26.x
    dp3 r26.x, cb11[r22.w + 4].xyzx, r17.yzwy
    add_sat r26.x, r26.x, cb11[r22.w + 4].w
    mul r25.w, r25.w, r26.x
    dp3 r26.x, cb11[r22.w + 5].xyzx, r17.yzwy
    add_sat r22.w, r26.x, cb11[r22.w + 5].w
    mul r18.x, r22.w, r25.w
    and r22.w, l(1), cb10[r18.w + 6].x
    movc r26.xy, r22.wwww, r18.xyxx, r18.zxzz
    ...
    loop 
      ...
      dp3 r26.z, cb11[r25.w + 0].xyzx, r17.yzwy
      add_sat r26.z, r26.z, cb11[r25.w + 0].w
      mul r26.z, r26.z, r27.x
      dp3 r26.w, cb11[r25.w + 1].xyzx, r17.yzwy
      add_sat r26.w, r26.w, cb11[r25.w + 1].w
      mul r26.z, r26.w, r26.z
      dp3 r26.w, cb11[r25.w + 2].xyzx, r17.yzwy
      add_sat r26.w, r26.w, cb11[r25.w + 2].w
      mul r26.z, r26.w, r26.z
      dp3 r26.w, cb11[r25.w + 3].xyzx, r17.yzwy
      add_sat r26.w, r26.w, cb11[r25.w + 3].w
      mul r26.z, r26.w, r26.z
      dp3 r26.w, cb11[r25.w + 4].xyzx, r17.yzwy
      add_sat r26.w, r26.w, cb11[r25.w + 4].w
      mul r26.z, r26.w, r26.z
      dp3 r26.w, cb11[r25.w + 5].xyzx, r17.yzwy
      ...
      movc r20.w, r27.w, r25.w, r28.x
      movc r27.xy, r27.zzzz, r27.xyxx, r20.zwzz
    ...
    if_nz r20.w
      ...
      if_nz r21.w
        imad r26.xy, r20.wwww, l(20, 20, 0, 0), l(860, 876, 0, 0)
        ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r20.w, cb2[52].x, r26.x, u2.xxxx
        or r20.w, r20.w, l(32)
        store_structured u2.x, cb2[52].x, r26.x, r20.w
        store_structured u2.x, cb2[52].x, r26.y, r19.w
      endif 
      iadd r15.z, r15.z, l(257)
      mad r15.y, r18.x, cb10[r18.w + 6].y, r15.y
      mul r18.x, r19.w, cb10[r18.w + 7].y
      mov r26.x, cb10[r18.w + 7].w
      mov r26.yz, cb10[r18.w + 8].xxyx
      dp3 r19.w, r16.xyzx, r26.xyzx
      dp3 r20.w, r17.yzwy, r26.xyzx
      ...
      dp3 r20.w, r16.xyzx, r26.xyzx
      dp3 r21.w, r17.yzwy, r26.xyzx
      ...
      div r20.w, r21.w, r20.w
      min r19.w, r19.w, |r20.w|
      add r26.x, r17.y, cb10[r18.w + 3].w
      add r26.yz, r17.zzwz, cb10[r18.w + 4].xxyx
      mad r26.xyz, r16.xyzx, r19.wwww, r26.xyzx
      dp3 r20.w, r26.xyzx, r26.xyzx
      sqrt r20.w, r20.w
      div r19.w, r19.w, r20.w
      add r19.w, r19.w, r19.w
      sqrt r19.w, r19.w
      mad r19.w, r4.w, l(5.000000), r19.w
      ...
      utof r29.w, r20.w
      sample_l_indexable(texturecubearray)(float,float,float,float) r26.xyz, r29.xyzw, t8.xyzw, s2, r19.w
      and r27.xzw, r26.xxyz, l(0x7fffffff, 0, 0x7fffffff, 0x7fffffff)
      ieq r27.xzw, r27.xxzw, l(0x7f800000, 0, 0x7f800000, 0x7f800000)
      or r19.w, r27.z, r27.x
      or r19.w, r27.w, r19.w
      movc r26.xyz, r19.wwww, l(1.000000,1.000000,0,0), r26.xyzx
      ...
      dp3 r18.w, r28.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r14.yzw, r17.yyzw, r27.xxzw, r14.yyzw
      mul r17.y, r9.w, r18.w
      mul r26.xyz, r18.xxxx, r26.xyzx
      dp3 r17.z, r26.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r17.z, r9.w, r18.w, r17.z
      div r17.y, r17.y, r17.z
      mad r25.xyz, r26.xyzx, r17.yyyy, r25.xyzx
    else 
      mov r20.x, r15.y
      mov r15.yz, r20.xxyx
    endif 
...
endloop 
ge r0.y, r24.z, l(1.000000)
bfi r4.w, l(8), l(0), r15.z, r24.w
movc r0.y, r0.y, r4.w, r15.z
max r4.w, r15.y, l(1.000000)
rcp r4.w, r4.w
mov_sat r15.y, r15.y
mul r17.xyz, r4.wwww, r14.yzwy
mul r18.xyz, r4.wwww, r25.xyzx
...
if_nz r8.w
  ...
  mad r17.xyz, r14.yzwy, r4.wwww, r15.yzwy
  mov r16.w, l(0)
  ...
  mad r18.xyz, r14.yzwy, r4.wwww, r18.xyzx
endif 
add r4.w, r5.x, r2.x
log r4.w, |r4.w|
mul r4.w, r2.z, r4.w
...
ret 
// Approximately 2115 instruction slots used
