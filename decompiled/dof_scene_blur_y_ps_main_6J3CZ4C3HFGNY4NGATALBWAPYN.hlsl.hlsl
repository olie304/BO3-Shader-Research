  ...
  out float3 o0 : SV_TARGET0)
{
  ...
  if (r0.w != 0) {
    r1.x = 0;
    r1.yw = float2(0.5,1.5) * postFxControl0.yy;
    r2.xyzw = v0.xyxy + -r1.xyxw;
    ...
    if (r0.w != 0) {
      r1.x = 0;
      r1.yw = float2(0.25,0.75) * postFxControl0.yy;
      r2.xyzw = v0.xyxy + -r1.xyxw;
      r3.xyz = codeTexture0.SampleLevel(bilinearClamp_s, r2.xy, 0).xyz;
      ...
      r2.x = 0;
      r2.yw = float2(1.25,1.75) * postFxControl0.yy;
      ...
      r2.x = 0;
      r2.yw = float2(2.25,2.75) * postFxControl0.yy;
      r3.xyzw = v0.xyxy + -r2.xyxw;
      r4.xyz = codeTexture0.SampleLevel(bilinearClamp_s, r3.xy, 0).xyz;
