  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r2.z = aoMap.Sample(aoSampler_s, r0.yz).x;
  ...
  r1.w = min(1, r1.w);
  r0.yz = detailScale.xy * r0.yz;
  r5.xyz = detailMap.Sample(normalSampler_s, r0.yz).xyz;
  r0.yz = r5.xy * float2(1.9921875,1.9921875) + float2(-1,-1);
  r3.z = r5.z * r5.z;
  r3.z = 0.333333343 * r3.z;
  r3.z = min(1, r3.z);
  r4.xy = r0.yz * detailScaleHeight + r3.xy;
  r0.y = dot(r4.xyz, r4.xyz);
  r0.y = rsqrt(r0.y);
  r3.xyw = r4.xyz * r0.yyy;
  r0.y = r3.z * detailScaleHeight + r1.w;
