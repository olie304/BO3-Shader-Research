...
r0.y = samp0[]..swiz;
  ...
  r14.xyz = r14.xyz * r4.www;
  r17.xzw = r14.xyz * r17.xxx;
  r14.xyz = r14.xyz * r17.yyy;
  if (r2.z != 0) {
    r18.x = 3;
  ...
  if (r2.y != 0) {
    ...
    if (r2.y != 0) {
        ...
        if (r9.w == 0) {
          ...
          if (enableDitheredShadow != 0) {
            ...
            while (true) {
              ...
              r14.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r21.xyz, r9.w).x;
      ...
      r1.z = r6.w * r1.z;
      r1.z = 0.25 * r1.z;
      r2.xyw = r1.zzz * r18.xyz + r14.xyz;
      r0.w = saturate(1 + -r0.w);
      r4.x = r0.w * r0.w;
      r4.x = r4.x * r4.x;
      r0.w = r4.x * r0.w;
      r0.w = r1.z * r0.w;
      r4.xyz = r0.www * r18.xyz + r17.xzw;
      r11.xyz = r0.zzz * r18.xyz + r16.xyz;
      r11.xyz = r3.zzz ? r11.xyz : 0;
      r15.xyz = r1.www ? r13.xyz : r15.xyz;
      r16.xyz = r1.www ? r16.xyz : r11.xyz;
      r17.xzw = r1.www ? r4.xyz : r17.xzw;
