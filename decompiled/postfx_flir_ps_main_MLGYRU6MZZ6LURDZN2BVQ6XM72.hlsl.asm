...
//   float2 colorTile;                  // Offset:  168 Size:     8
//   float refractionAmount;            // Offset:  176 Size:     4
//   float2 refractionTile;             // Offset:  180 Size:     8
//   float2 refractionScroll1;          // Offset:  192 Size:     8
//   float2 refractionScroll2;          // Offset:  200 Size:     8
//
// }
//
...
mul r2.xyzw, cb0[12].xyzw, cb1[69].wwww
mad r2.xyzw, v1.xyxy, cb0[11].yzyz, r2.xyzw
sample_indexable(texture2d)(float,float,float,float) r1.zw, r2.xyxx, t7.zwxy, s1
sample_indexable(texture2d)(float,float,float,float) r2.xy, r2.zwzz, t7.xyzw, s1
if_nz r1.y
  mul r2.zw, cb0[11].xxxx, cb1[44].zzzw
  mad r1.yz, r1.zzwz, l(0.000000, 2.000000, 2.000000, 0.000000), l(0.000000, -1.000000, -1.000000, 0.000000)
  mad r1.yz, r2.xxyx, l(0.000000, 2.000000, 2.000000, 0.000000), r1.yyzy
...
mul r1.yzw, r2.xxyz, l(0.000000, 0.00003052, 0.00003052, 0.00003052)
mul r0.w, r0.w, r1.x
