// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:34:35 2021
...
cbuffer _Globals : register(b0)
{
  ...
  float emissiveFalloffPower : packoffset(c12.y);
  float3 emissiveTint1 : packoffset(c13);
  bool relativeHDR : packoffset(c13.w);
  bool invertFalloff : packoffset(c14);
  float layerDepth : packoffset(c14.y);
  float uvMotionToggle1 : packoffset(c14.z) = {0};
}
...
Texture2D<float4> detailMap : register(t22);
...
r2.w = samp0[]..swiz;
  r6.zw = (int2)r2.ww & int2(268435456,536870912);
  if (r6.z != 0) {
  ...
  r0.w = r0.w * r1.z + r13.x;
  r2.xyz = r2.xyz * r1.zzz + r15.xyz;
  r1.w = dot(r2.xyz, r2.xyz);
  r1.w = rsqrt(r1.w);
  r2.xyz = r2.xyz * r1.www;
  r7.y = r1.x * r1.z + r13.y;
  r8.xyz = r1.zzz * float3(0.0399999991,0.0399999991,0.0399999991) + r16.xyz;
  r1.x = dot(-v6.xyz, -v6.xyz);
  r1.x = rsqrt(r1.x);
  r9.xyz = -v6.xyz * r1.xxx;
  r1.w = dot(r9.xyz, r3.xyz);
  r3.x = dot(r9.xyz, r4.xyz);
  r3.y = dot(r9.xyz, r5.xyz);
  r3.z = cmp(0 < r1.w);
  r3.xy = -r3.xy / r1.ww;
  r3.xy = r3.zz ? r3.xy : 0;
  r3.z = 9.99999975e-06 + invertFalloff;
  r3.xy = r3.xy * r3.zz + w1.xy;
  ...
  r1.w = frac(r1.w);
  r1.yw = float2(0.0078125,52.9829178) * r1.yw;
  r1.w = frac(r1.w);
  r1.w = r1.w * 6.28318548 + gameTick.w;
  sincos(r1.w, r5.x, r10.x);
  ...
  r7.x = saturate(dot(r2.xyz, r9.xyz));
  r1.w = dot(-r9.xyz, r2.xyz);
  r1.w = r1.w + r1.w;
  r12.xyz = r2.xyz * -r1.www + -r9.xyz;
  r1.w = 17 * r7.y;
  r1.w = exp2(r1.w);
  r1.w = 2 + r1.w;
  r1.w = 2 / r1.w;
  ...
  while (true) {
    ...
    r8.w = cmp((int)r1.y == (int)r7.z);
    bitmask.w = ((~(-1 << r6.x)) << 0) & 0xffffffff;  r9.w = (((uint)0 << 0) & bitmask.w) | ((uint)r7.w & ~bitmask.w);
    r7.w = r8.w ? r9.w : r7.w;
    ...
    while (true) {
      ...
      if (r11.z != 0) {
        r9.w = (int)r9.w ^ (int)r11.y;
        r11.y = (int)r8.w + (int)r10.w;
      // Known bad code for instruction (needs manual fix):
      ...
      while (true) {
        ...
        r26.y = samp0[]..swiz;
          ...
          r33.w = samp0[]..swiz;
            ...
            r39.x = samp0[]..swiz;
            r39.y = samp0[]..swiz;
              r24.w = r13.w * r14.w + r24.w;
              r10.w = r14.z * r26.z;
              r26.z = r34.z;
              r13.w = dot(r12.xyz, r26.xyz);
              r14.z = dot(r27.xyz, r26.xyz);
              r14.z = r14.z + -r34.w;
              r14.w = cmp(r14.z >= 0);
              ...
              r34.w = (uint)r14.z;
              r18.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r34.xyzw, r13.w).xyz;
              ...
              r14.z = r13.w * r5.w;
              r18.yzw = r18.yzw * r10.www;
              r10.w = dot(r18.yzw, float3(0.212599993,0.715200007,0.0722000003));
              r10.w = r5.w * r13.w + r10.w;
              r10.w = r14.z / r10.w;
              r24.xyz = r18.yzw * r10.www + r24.xyz;
            }
          }
        }
      }
  ...
  r6.xyz = r21.xyz * r1.yyy;
  r11.yzw = r22.xyz * r1.yyy;
  r4.z = cmp(r22.w < 0.99000001);
  if (r4.z != 0) {
    r4.z = 1 + -r22.w;
    r5.z = sunConstants.globalProbeExposure * r4.z;
    ...
    r6.xyz = r21.xyz * r1.yyy + r14.xyz;
    r12.w = 0;
    r14.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r12.xyzw, r4.w).xyz;
    r1.y = sunConstants.globalProbeExposure * r4.z + -r2.w;
    r1.y = r7.y * r1.y + r2.w;
    r11.yzw = r14.xyz * r1.yyy + r11.yzw;
  }
  r4.zw = r7.xy * float2(0.984375,0.984375) + float2(0.0078125,0.0078125);
  r4.zw = gEnvBRDFGeneric.SampleLevel(samplerLinear_s, r4.zw, 0).xy;
  r14.xyz = r11.zwy * r4.zzz;
  r7.yzw = r11.yzw * r4.www;
  r1.y = sqrt(r4.y);
  r1.y = r1.y * 0.5 + 0.5;
  r1.y = r1.y * r1.y;
  r2.w = 0.5 * r1.y;
  ...
  r1.y = r4.z * r1.y;
  r2.w = r4.z * r2.w;
  r4.z = dot(r2.xyz, sunConstants.wldDir.xyz);
  r4.w = saturate(r4.z);
  r5.z = cmp(0 >= r4.w);
  if (r5.z != 0) {
    r5.w = 0;
    ...
    if (r10.w == 0) {
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          r17.z = (uint)r13.w;
          r13.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r17.xyz, r5.z).x;
  ...
  if (r5.z != 0) {
    ...
    if (r5.z != 0) {
      ...
      r15.w = r17.z;
      r6.w = r14.z;
      r6.xyzw = r4.zzzz ? r15.xyzw : r6.xyzw;
      r17.zw = r16.xy;
      r14.zw = r7.yz;
      r15.xyzw = r4.zzzz ? r17.xyzw : r14.xyzw;
      r7.w = r4.z ? r16.z : r7.w;
      r14.z = r6.w;
      r14.xy = r15.xy;
      r7.yz = r15.zw;
    }
  ...
  while (true) {
    ...
    while (true) {
      if (r7.x == 0) break;
      r8.w = firstbitlow((uint)r7.x);
      r9.w = 1 << (int)r8.w;
      r10.w = (int)r7.x & (int)r9.w;
      if (r10.w != 0) {
        r7.x = (int)r7.x ^ (int)r9.w;
