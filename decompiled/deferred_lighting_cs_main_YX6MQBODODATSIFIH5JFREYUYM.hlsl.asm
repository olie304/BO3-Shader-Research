...
loop 
  ...
  uge r16.w, r13.w, r12.w
  ult r17.w, r13.w, cb2[0].y
  ...
  if_nz r16.w
    ...
    if_nz r3.y
      ...
      store_structured u2.xyzw, cb2[52].x, r16.w, r15.xyzw
    endif 
    iadd r23.w, r22.w, l(1)
    add r15.yzw, r5.xxyz, -cb10[r13.w + 0].xxyz
    and r16.w, l(0x0000ffff), cb10[r13.w + 7].z
    ubfe r17.w, l(6), l(25), cb10[r13.w + 7].z
    imul null, r19.w, r16.w, l(6)
    dp3 r20.w, cb11[r19.w + 0].xyzx, r15.yzwy
    add_sat r20.w, r20.w, cb11[r19.w + 0].w
    dp3 r24.x, cb11[r19.w + 1].xyzx, r15.yzwy
    add_sat r24.x, r24.x, cb11[r19.w + 1].w
    mul r20.w, r20.w, r24.x
    dp3 r24.x, cb11[r19.w + 2].xyzx, r15.yzwy
    add_sat r24.x, r24.x, cb11[r19.w + 2].w
    mul r20.w, r20.w, r24.x
    dp3 r24.x, cb11[r19.w + 3].xyzx, r15.yzwy
    add_sat r24.x, r24.x, cb11[r19.w + 3].w
    mul r20.w, r20.w, r24.x
    dp3 r24.x, cb11[r19.w + 4].xyzx, r15.yzwy
    add_sat r24.x, r24.x, cb11[r19.w + 4].w
    mul r20.w, r20.w, r24.x
    dp3 r24.x, cb11[r19.w + 5].xyzx, r15.yzwy
    add_sat r19.w, r24.x, cb11[r19.w + 5].w
    mul r16.x, r19.w, r20.w
    and r19.w, l(1), cb10[r13.w + 6].x
    movc r24.xy, r19.wwww, r16.xyxx, r16.zxzz
    mov r16.x, cb10[r13.w + 6].x
    mov r25.xy, r24.xyxx
    mov r19.w, l(1)
    loop 
      ...
      dp3 r24.z, cb11[r20.w + 0].xyzx, r15.yzwy
      add_sat r24.z, r24.z, cb11[r20.w + 0].w
      ...
      mul r25.x, r20.w, r24.z
      ushr r24.w, r16.x, l(2)
      ubfe r25.z, l(1), l(2), r16.x
      and r25.w, r24.w, l(2)
      max r26.x, r25.x, r25.y
      mad r20.w, -r24.z, r20.w, l(1.000000)
      mul r20.w, r20.w, r25.y
      movc r18.y, r25.w, r20.w, r26.x
      movc r25.xy, r25.zzzz, r25.xyxx, r18.xyxx
      iadd r19.w, r19.w, l(1)
      mov r16.x, r24.w
    endloop 
    mov_sat r25.y, r25.y
    mul r16.x, r25.y, cb10[r13.w + 6].y
    lt r16.w, l(0.000000), r16.x
    if_nz r16.w
      and r16.w, r23.w, l(7)
      iadd r17.w, r16.w, l(-1)
      ult r17.w, r17.w, l(32)
      and r17.w, r3.y, r17.w
      if_nz r17.w
        imad r24.xy, r16.wwww, l(20, 20, 0, 0), l(860, 876, 0, 0)
        ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r16.w, cb2[52].x, r24.x, u2.xxxx
        or r16.w, r16.w, l(32)
        store_structured u2.x, cb2[52].x, r24.x, r16.w
        store_structured u2.x, cb2[52].x, r24.y, r16.x
      endif 
      iadd r22.w, r22.w, l(257)
      mad r22.z, r25.y, cb10[r13.w + 6].y, r22.z
      mul r16.x, r16.x, cb10[r13.w + 7].y
      mov r24.x, cb10[r13.w + 7].w
      mov r24.yz, cb10[r13.w + 8].xxyx
      dp3 r16.w, r14.xyzx, r24.xyzx
      dp3 r17.w, r15.yzwy, r24.xyzx
      add r17.w, r17.w, -cb10[r13.w + 8].z
      ...
      dp3 r18.y, r15.yzwy, r24.xyzx
      add r18.y, r18.y, -cb10[r13.w + 9].z
      ge r19.w, r18.y, l(0.000000)
      max r18.y, r9.w, |r18.y|
      ...
      dp3 r17.w, r14.xyzx, r24.xyzx
      dp3 r18.y, r15.yzwy, r24.xyzx
      add r18.y, r18.y, -cb10[r13.w + 10].z
      ge r19.w, r18.y, l(0.000000)
      max r18.y, r9.w, |r18.y|
      movc r18.y, r19.w, r18.y, -r18.y
      max r17.w, -r17.w, l(0.00000010)
      ...
      dp3 r17.w, r14.xyzx, r24.xyzx
      dp3 r18.y, r15.yzwy, r24.xyzx
      add r18.y, r18.y, -cb10[r13.w + 11].z
      ge r19.w, r18.y, l(0.000000)
      max r18.y, r9.w, |r18.y|
      movc r18.y, r19.w, r18.y, -r18.y
      max r17.w, -r17.w, l(0.00000010)
      ...
      dp3 r17.w, r14.xyzx, r24.xyzx
      dp3 r18.y, r15.yzwy, r24.xyzx
      add r18.y, r18.y, -cb10[r13.w + 12].z
      ge r19.w, r18.y, l(0.000000)
      max r18.y, r9.w, |r18.y|
      movc r18.y, r19.w, r18.y, -r18.y
      max r17.w, -r17.w, l(0.00000010)
      ...
      dp3 r17.w, r14.xyzx, r24.xyzx
      dp3 r18.y, r15.yzwy, r24.xyzx
      add r18.y, r18.y, -cb10[r13.w + 13].z
      ge r19.w, r18.y, l(0.000000)
      max r18.y, r9.w, |r18.y|
      movc r18.y, r19.w, r18.y, -r18.y
      max r17.w, -r17.w, l(0.00000010)
      div r17.w, r18.y, r17.w
      min r16.w, r16.w, |r17.w|
      add r24.x, r15.y, cb10[r13.w + 3].w
      add r24.yz, r15.zzwz, cb10[r13.w + 4].xxyx
      mad r24.xyz, r14.xyzx, r16.wwww, r24.xyzx
      ...
      ubfe r17.w, l(9), l(16), cb10[r13.w + 7].z
      utof r27.w, r17.w
      sample_l_indexable(texturecubearray)(float,float,float,float) r24.xyz, r27.xyzw, t8.xyzw, s2, r16.w
      and r25.xzw, r24.xxyz, l(0x7fffffff, 0, 0x7fffffff, 0x7fffffff)
      ieq r25.xzw, r25.xxzw, l(0x7f800000, 0, 0x7f800000, 0x7f800000)
      or r16.w, r25.z, r25.x
      or r16.w, r25.w, r16.w
      movc r24.xyz, r16.wwww, l(1.000000,1.000000,0,0), r24.xyzx
      ...
      movc r25.xzw, r13.wwww, l(1.000000,0,1.000000,0), r25.xxzw
      mul r26.xyz, r15.yzwy, r25.xzwx
      dp3 r13.w, r26.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r21.xyz, r15.yzwy, r25.xzwx, r21.xyzx
      mul r15.y, r10.w, r13.w
      mul r24.xyz, r16.xxxx, r24.xyzx
      dp3 r15.z, r24.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r13.w, r10.w, r13.w, r15.z
      div r13.w, r15.y, r13.w
      mov r26.x, r21.w
      mov r26.yz, r22.xxyx
      mad r15.yzw, r24.xxyz, r13.wwww, r26.xxyz
      mov r21.w, r15.y
      mov r22.xy, r15.zwzz
    else 
...
loop 
  ...
  breakc_nz r13.w
  movc r13.w, r0.y, r0.x, r13.y
  ult r16.w, r13.w, r12.w
  if_nz r16.w
    imul null, r13.w, r13.w, l(14)
    if_nz r3.y
      and r16.w, r18.y, l(15)
      imad r16.w, r16.w, l(20), l(880)
      add r15.yzw, cb1[24].xxyz, cb10[r13.w + 0].xxyz
      store_structured u2.xyzw, cb2[52].x, r16.w, r15.xyzw
    endif 
    iadd r25.y, r18.y, l(1)
    add r15.yzw, r5.xxyz, -cb10[r13.w + 0].xxyz
    and r16.w, l(0x0000ffff), cb10[r13.w + 7].z
    ubfe r17.w, l(6), l(25), cb10[r13.w + 7].z
    imul null, r19.w, r16.w, l(6)
    dp3 r20.w, cb11[r19.w + 0].xyzx, r15.yzwy
    add_sat r20.w, r20.w, cb11[r19.w + 0].w
    dp3 r23.w, cb11[r19.w + 1].xyzx, r15.yzwy
    add_sat r23.w, r23.w, cb11[r19.w + 1].w
    mul r20.w, r20.w, r23.w
    dp3 r23.w, cb11[r19.w + 2].xyzx, r15.yzwy
    add_sat r23.w, r23.w, cb11[r19.w + 2].w
    mul r20.w, r20.w, r23.w
    dp3 r23.w, cb11[r19.w + 3].xyzx, r15.yzwy
    add_sat r23.w, r23.w, cb11[r19.w + 3].w
    mul r20.w, r20.w, r23.w
    dp3 r23.w, cb11[r19.w + 4].xyzx, r15.yzwy
    add_sat r23.w, r23.w, cb11[r19.w + 4].w
    mul r20.w, r20.w, r23.w
    dp3 r23.w, cb11[r19.w + 5].xyzx, r15.yzwy
    add_sat r19.w, r23.w, cb11[r19.w + 5].w
    mul r16.x, r19.w, r20.w
    and r19.w, l(1), cb10[r13.w + 6].x
    movc r25.zw, r19.wwww, r16.xxxy, r16.zzzx
    mov r16.x, cb10[r13.w + 6].x
    mov r26.xy, r25.zwzz
    mov r19.w, l(1)
    loop 
      ...
      movc r18.w, r26.w, r20.w, r27.x
      movc r26.xy, r26.zzzz, r26.xyxx, r18.zwzz
      iadd r19.w, r19.w, l(1)
      mov r16.x, r24.w
    endloop 
    add_sat r16.x, -r22.z, r26.y
    mul r16.w, r16.x, cb10[r13.w + 6].y
    lt r17.w, l(0.000000), r16.w
    if_nz r17.w
      and r17.w, r25.y, l(31)
      iadd r18.w, r17.w, l(-1)
      ult r18.w, r18.w, l(32)
      and r18.w, r3.y, r18.w
      if_nz r18.w
        ...
        store_structured u2.x, cb2[52].x, r25.w, r16.w
      endif 
      iadd r18.y, r18.y, l(257)
      mad r18.x, r16.x, cb10[r13.w + 6].y, r18.x
      mul r16.x, r16.w, cb10[r13.w + 7].y
      mov r27.x, cb10[r13.w + 7].w
      mov r27.yz, cb10[r13.w + 8].xxyx
      dp3 r16.w, r14.xyzx, r27.xyzx
      dp3 r17.w, r15.yzwy, r27.xyzx
      add r17.w, r17.w, -cb10[r13.w + 8].z
      ...
      add r18.w, r18.w, -cb10[r13.w + 9].z
      ...
      dp3 r17.w, r14.xyzx, r27.xyzx
      dp3 r18.w, r15.yzwy, r27.xyzx
      add r18.w, r18.w, -cb10[r13.w + 10].z
      ge r19.w, r18.w, l(0.000000)
      max r18.w, r9.w, |r18.w|
      movc r18.w, r19.w, r18.w, -r18.w
      max r17.w, -r17.w, l(0.00000010)
      ...
      dp3 r17.w, r14.xyzx, r27.xyzx
      dp3 r18.w, r15.yzwy, r27.xyzx
      add r18.w, r18.w, -cb10[r13.w + 11].z
      ge r19.w, r18.w, l(0.000000)
      max r18.w, r9.w, |r18.w|
      movc r18.w, r19.w, r18.w, -r18.w
      max r17.w, -r17.w, l(0.00000010)
      ...
      dp3 r17.w, r14.xyzx, r27.xyzx
      dp3 r18.w, r15.yzwy, r27.xyzx
      add r18.w, r18.w, -cb10[r13.w + 12].z
      ge r19.w, r18.w, l(0.000000)
      max r18.w, r9.w, |r18.w|
      movc r18.w, r19.w, r18.w, -r18.w
      max r17.w, -r17.w, l(0.00000010)
      ...
      dp3 r17.w, r14.xyzx, r27.xyzx
      dp3 r18.w, r15.yzwy, r27.xyzx
      add r18.w, r18.w, -cb10[r13.w + 13].z
      ge r19.w, r18.w, l(0.000000)
      max r18.w, r9.w, |r18.w|
      movc r18.w, r19.w, r18.w, -r18.w
      max r17.w, -r17.w, l(0.00000010)
      div r17.w, r18.w, r17.w
      min r16.w, r16.w, |r17.w|
      add r27.x, r15.y, cb10[r13.w + 3].w
      add r27.yz, r15.zzwz, cb10[r13.w + 4].xxyx
      mad r26.xzw, r14.xxyz, r16.wwww, r27.xxyz
      ...
      ubfe r17.w, l(9), l(16), cb10[r13.w + 7].z
      utof r28.w, r17.w
      sample_l_indexable(texturecubearray)(float,float,float,float) r26.xzw, r28.xyzw, t8.xwyz, s2, r16.w
      ...
      movc r26.xzw, r16.wwww, l(1.000000,0,1.000000,0), r26.xxzw
      dp3 r31.x, r15.yzwy, r27.xyzx
      dp3 r31.y, r15.yzwy, r29.xyzx
      dp3 r31.z, r15.yzwy, r30.xyzx
      mad_sat r15.yzw, r31.xxyz, cb10[r13.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
      mul r31.xy, r15.yzyy, cb10[r13.w + 4].zwzz
      mul r31.z, r15.w, cb10[r13.w + 5].x
      add r15.yzw, r31.xxyz, cb10[r13.w + 5].yyzw
      ...
      add r15.yzw, r15.yyzw, r20.xxyz
      sample_l_indexable(texture3d)(float,float,float,float) r15.yzw, r15.yzwy, t19.wxyz, s4, l(0.000000)
      mad r15.yzw, r15.yyzw, r30.zzzz, r27.xxyw
      ...
      mul r28.xyz, r15.yzwy, r27.xyzx
      dp3 r13.w, r28.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r23.xyz, r15.yzwy, r27.xyzx, r23.xyzx
      mul r15.y, r10.w, r13.w
      mul r26.xzw, r16.xxxx, r26.xxzw
      dp3 r15.z, r26.xzwx, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r13.w, r10.w, r13.w, r15.z
      div r13.w, r15.y, r13.w
      mad r24.xyz, r26.xzwx, r13.wwww, r24.xyzx
    else 
      mov r25.x, r18.x
      mov r18.xy, r25.xyxx
    endif 
  ...
  iadd r0.y, r0.y, l(1)
endloop 
ge r0.x, r22.z, l(1.000000)
bfi r0.y, l(8), l(0), r18.y, r22.w
movc r0.x, r0.x, r0.y, r18.y
max r0.y, r18.x, l(1.000000)
rcp r0.y, r0.y
mov_sat r18.x, r18.x
mul r15.xyz, r0.yyyy, r23.xyzx
mul r16.xyz, r0.yyyy, r24.xyzx
lt r6.w, r18.x, l(0.990000)
if_nz r6.w
  iadd r0.x, r0.x, l(256)
  add r6.w, -r18.x, l(1.000000)
  ...
  mad r15.xyz, r23.xyzx, r0.yyyy, r17.xyzx
  mov r14.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r17.xyz, r14.xyzw, t8.xyzw, s2, r8.w
...
if_nz r4.z
  ...
  if_nz r4.z
    ...
    if_nz r8.w
      ...
      add r20.x, r13.y, cb9[r6.w + 9].w
      add r20.y, r13.w, cb9[r6.w + 10].x
      mul r13.yw, r20.xxxy, cb9[r6.w + 9].yyyz
      div r20.xy, cb9[r6.w + 3].yyyy, cb9[r6.w + 8].ywyy
      ...
      if_z r8.w
        ...
        mad r19.x, r13.y, cb9[r6.w + 8].y, cb9[r6.w + 8].z
    ...
    add r6.w, -r3.w, r6.w
    mad r6.w, r2.w, r6.w, r3.w
    mul r6.w, r7.w, r6.w
    lt r3.z, l(0.000000), r3.z
    mad r19.xyz, r6.wwww, r18.xyzx, r15.xyzx
    mad r20.xyz, -r5.xyzx, r1.wwww, cb2[17].xyzx
    dp3 r1.w, r20.xyzx, r20.xyzx
    rsq r1.w, r1.w
    mul r20.xyz, r1.wwww, r20.xyzx
    dp3 r1.w, r20.xyzx, r12.xyzx
    dp3 r6.w, r11.xyzx, r20.xyzx
    mad r8.w, |r6.w|, r2.z, -|r6.w|
    mad r6.w, |r6.w|, r8.w, l(1.000000)
    mad r3.w, r3.w, r0.y, r2.y
    mul r6.w, r6.w, r6.w
    mul r3.w, r3.w, r6.w
    rcp r3.w, r3.w
    mul r3.w, r4.z, r3.w
    ...
    mad r20.xyz, r3.wwww, r18.xyzx, r16.xyzx
    add_sat r1.w, -r1.w, l(1.000000)
    mul r4.z, r1.w, r1.w
    mul r4.z, r4.z, r4.z
    mul r1.w, r1.w, r4.z
    mul r1.w, r1.w, r3.w
    mad r18.xyz, r1.wwww, r18.yzxy, r17.xyzx
    mov r19.w, r18.z
    mov r15.w, r17.z
    movc r15.xyzw, r3.zzzz, r19.xyzw, r15.xyzw
    mov r18.zw, r20.xxxy
    mov r17.zw, r16.xxxy
    movc r18.xyzw, r3.zzzz, r18.xyzw, r17.xyzw
    movc r16.z, r3.z, r20.z, r16.z
    if_nz r3.y
...
imul null, r3.z, r13.z, l(15)
ubfe r3.w, l(3), l(24), cb9[r3.z + 1].w
switch r3.w
  case l(4)
  if_nz r3.y
    add r18.yzw, cb1[24].xxyz, cb9[r3.z + 0].xxyz
    mov r18.x, l(2)
    store_structured u2.xyzw, cb2[52].x, l(136), r18.xyzw
  endif 
  iadd r3.w, r1.w, l(1)
  lt r4.z, l(0.000000), cb9[r3.z + 6].y
  mov r18.xy, cb9[r3.z + 5].zwzz
  mov r18.z, cb9[r3.z + 6].x
  mad r13.yzw, -r18.xxyz, l(0.000000, 0.500000, 0.500000, 0.500000), cb9[r3.z + 0].xxyz
  add r19.xyz, -r5.xyzx, r13.yzwy
  dp3 r6.w, r18.xyzx, r19.xyzx
  div_sat r7.w, -r6.w, cb9[r3.z + 6].y
  mad r20.xyz, r7.wwww, r18.xyzx, r13.yzwy
  movc r20.xyz, r4.zzzz, r20.xyzx, cb9[r3.z + 0].xyzx
  ...
  if_nz r11.w
    sqrt r11.w, r8.w
    mul r12.w, cb9[r3.z + 3].x, cb9[r3.z + 3].x
    div r8.w, r12.w, r8.w
    min r8.w, r8.w, l(1.000000)
    mad_sat r20.xy, r11.wwww, cb9[r3.z + 2].xzxx, cb9[r3.z + 2].ywyy
    ...
    if_nz r11.w
      ubfe r11.w, l(3), l(27), cb9[r3.z + 1].w
      if_nz r3.y
      ...
      if_nz r11.w
        ...
        add r20.yzw, r20.yyzw, -cb9[r3.z + 4].yyzw
        max r11.w, |r20.w|, |r20.z|
        max r11.w, r11.w, |r20.y|
        div r11.w, cb9[r3.z + 5].x, r11.w
        add r11.w, r11.w, cb9[r3.z + 5].y
        dp3 r14.w, r20.yzwy, r20.yzwy
        rsq r14.w, r14.w
        max r11.w, r11.w, l(0.00006104)
        and r15.w, l(0x0000ffff), cb9[r3.z + 1].w
        mov r22.x, -r3.x
        utof r23.w, r15.w
        mov r22.y, r13.x
        mov r22.z, r3.x
        ...
        loop 
          ...
          mul r24.yz, r21.yyzy, cb9[r3.z + 3].yyyy
      ...
      if_nz r11.w
        ...
        if_nz r7.w
          ...
          mov r19.xyz, cb9[r6.w + 7].yzwy
          mov r19.w, cb9[r6.w + 8].x
          ...
          if_z r15.w
            ...
            if_z r16.w
              ...
              mad r19.x, r18.x, cb9[r6.w + 8].y, cb9[r6.w + 8].z
              mad r19.y, r18.y, cb9[r6.w + 8].w, cb9[r6.w + 9].x
              mul r17.w, r14.w, cb9[r6.w + 10].z
          ...
          if_z r14.w
            ...
            if_nz cb2[58].y
              ...
              loop 
                ...
                mad r20.xy, r21.xyxx, cb9[r6.w + 3].yyyy, r19.xyxx
          ...
          ubfe r6.w, l(4), l(20), cb9[r3.z + 1].w
          ult r7.w, l(0), r6.w
          not r14.w, r1.z
          and r7.w, r7.w, r14.w
          if_nz r7.w
        ...
        mul r6.w, r8.w, r6.w
        mov r18.x, cb9[r3.z + 0].w
        mov r18.yz, cb9[r3.z + 1].xxyx
        lt r7.w, l(0.000000), r9.w
        mad r19.xyz, r6.wwww, r18.xyzx, r15.xyzx
        dp3_sat r6.w, r11.xyzx, r14.xyzx
        ...
        mul r6.w, r6.w, r9.w
        mul r6.w, r8.w, r6.w
        mad r13.yzw, r6.wwww, r18.xxyz, r16.xxyz
        add_sat r4.z, -r4.z, l(1.000000)
        mul r9.w, r4.z, r4.z
        mul r9.w, r9.w, r9.w
        mul r4.z, r4.z, r9.w
        mul r4.z, r4.z, r6.w
        mad r14.xyz, r4.zzzz, r18.xyzx, r17.zxyz
        movc r15.xyz, r7.wwww, r19.xyzx, r15.xyzx
        movc r17.xyz, r7.wwww, r14.yzxy, r17.xyzx
  ...
  case l(2)
  if_nz r3.y
    add r14.yzw, cb1[24].xxyz, cb9[r3.z + 0].xxyz
    mov r14.x, l(2)
    store_structured u2.xyzw, cb2[52].x, l(136), r14.xyzw
  endif 
  iadd r3.w, r1.w, l(1)
  add r14.xy, -r5.xyxx, cb9[r3.z + 3].zwzz
  add r14.z, -r5.z, cb9[r3.z + 4].x
  ...
  if_nz r8.w
    mov r18.xyz, cb9[r3.z + 7].yzwy
    mov r18.w, cb9[r3.z + 8].x
    mov r5.w, l(1.000000)
    dp4 r8.w, r18.xyzw, r5.xyzw
    lt r9.w, r8.w, l(1.000000)
    if_nz r9.w
      mov r13.yzw, l(0,1.000000,1.000000,1.000000)
      mov r9.w, l(0)
    else 
      add r19.xyz, -r5.xyzx, cb9[r3.z + 0].xyzx
      mul r10.w, cb9[r3.z + 3].x, cb9[r3.z + 3].x
      dp3 r11.w, r19.xyzx, r19.xyzx
      div r10.w, r10.w, r11.w
      min r10.w, r10.w, l(1.000000)
      mad_sat r19.xy, r8.wwww, cb9[r3.z + 2].xzxx, cb9[r3.z + 2].ywyy
      ...
      lt r5.w, cb9[r3.z + 10].w, l(0.00048828)
      if_nz r5.w
        mad_sat r20.xy, |r19.xyxx|, cb9[r3.z + 12].xyxx, cb9[r3.z + 12].zwzz
        mul r20.zw, r20.xxxy, r20.xxxy
        mad r20.xy, r20.xyxx, l(-2.000000, -2.000000, 0.000000, 0.000000), l(3.000000, 3.000000, 0.000000, 0.000000)
        mul r20.xy, r20.xyxx, r20.zwzz
        mul r5.w, r20.y, r20.x
      else 
        mul_sat r20.xyzw, |r19.yyxx|, cb9[r3.z + 11].xyzw
        log r20.xyzw, r20.xyzw
        mul r20.xyzw, r20.xyzw, cb9[r3.z + 12].zzzz
        exp r20.xyzw, r20.xyzw
        add r20.xy, r20.zwzz, r20.xyxx
        log r20.xy, r20.xyxx
        mul r20.xy, r20.xyxx, cb9[r3.z + 12].wwww
        exp r20.xy, r20.xyxx
        mul r8.w, r20.x, cb9[r3.z + 12].x
        mad r11.w, cb9[r3.z + 12].y, r20.y, l(-1.000000)
        mad r8.w, cb9[r3.z + 12].y, r20.y, -r8.w
      ...
      mul r9.w, r5.w, r10.w
      and r5.w, l(255), cb9[r3.z + 14].w
      if_nz r5.w
        mov r19.z, l(1.000000)
        dp3 r8.w, cb9[r3.z + 13].xyzx, r19.xyzx
        mov r20.x, cb9[r3.z + 13].w
        mov r20.yz, cb9[r3.z + 14].xxyx
    ...
    mov r19.x, cb9[r3.z + 0].w
    mov r19.yz, cb9[r3.z + 1].xxyx
    mul r13.yzw, r13.yyzw, r19.xxyz
    lt r5.w, l(0.000000), r9.w
    if_nz r5.w
      ubfe r5.w, l(3), l(27), cb9[r3.z + 1].w
      if_nz r3.y
      ...
      if_nz r5.w
        ...
        dp4 r10.w, r18.xyzw, r19.xyzw
        ge r11.w, r10.w, r5.w
        if_nz r11.w
          mov r18.xyz, cb9[r3.z + 4].yzwy
          mov r18.w, cb9[r3.z + 5].x
          ...
          mad r19.x, r18.x, cb9[r3.z + 8].y, cb9[r3.z + 8].z
          mad r19.y, r18.y, cb9[r3.z + 8].w, cb9[r3.z + 9].x
          div r5.w, r5.w, r10.w
          max r5.w, r5.w, l(0.00006104)
          and r10.w, l(0x0000ffff), cb9[r3.z + 1].w
          if_nz cb2[58].y
            mov r18.x, -r3.x
            utof r20.z, r10.w
            mov r18.y, r13.x
            ...
            loop 
              ige r14.w, r12.w, l(8)
              breakc_nz r14.w
              dp2 r21.x, icb[r12.w + 0].yxyy, r18.xyxx
              dp2 r21.y, icb[r12.w + 0].yxyy, r18.yzyy
              mad r20.xy, r21.xyxx, cb9[r3.z + 3].yyyy, r19.xyxx
      ...
      if_nz r9.w
        mul r9.w, r2.z, cb9[r3.z + 1].z
        mul r9.w, r7.w, r9.w
        ubfe r10.w, l(4), l(16), cb9[r3.z + 1].w
        ult r11.w, l(0), r10.w
        ...
        if_nz r11.w
          ...
          mad r18.xyz, r11.xyzx, r11.wwww, r5.xyzx
          ...
          if_z r14.w
            ...
            mad r18.xy, r18.xyxx, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
            add r19.x, r18.x, cb9[r10.w + 9].w
            add r19.y, r18.y, cb9[r10.w + 10].x
            mul r18.xy, r19.xyxx, cb9[r10.w + 9].yzyy
            div r18.zw, cb9[r10.w + 3].yyyy, cb9[r10.w + 8].yyyw
            add r19.xy, -r18.zwzz, l(1.000000, 1.000000, 0.000000, 0.000000)
            ge r19.xy, r18.xyxx, r19.xyxx
            ge r18.zw, r18.zzzw, r18.xxxy
            or r18.zw, r18.zzzw, r19.xxxy
            ...
            if_z r15.w
              mov_sat r18.xy, r18.xyxx
              mad r19.x, r18.x, cb9[r10.w + 8].y, cb9[r10.w + 8].z
              mad r19.y, r18.y, cb9[r10.w + 8].w, cb9[r10.w + 9].x
              mul r16.w, r12.w, cb9[r10.w + 10].z
          ...
          ubfe r3.z, l(4), l(20), cb9[r3.z + 1].w
          ult r10.w, l(0), r3.z
          not r1.z, r1.z
          and r1.z, r1.z, r10.w
          if_nz r1.z
            iadd r1.z, r3.z, cb2[0].x
            imad r1.z, r1.z, l(15), l(-15)
            mad r3.z, |r6.w|, l(-0.200000), l(0.400000)
            mad r18.xyz, r11.xyzx, r3.zzzz, r5.xyzx
            mov r19.xyz, cb9[r1.z + 6].yzwy
            mov r19.w, cb9[r1.z + 7].x
            mov r18.w, l(1.000000)
            dp4 r3.z, r19.xyzw, r18.xyzw
            ...
            if_z r11.w
              ...
              ge r18.zw, r18.zzzw, r18.xxxy
              or r18.zw, r18.zzzw, r19.xxxy
              or r12.w, r18.w, r18.z
              if_z r12.w
                mov_sat r18.xy, r18.xyxx
                mad r19.x, r18.x, cb9[r1.z + 8].y, cb9[r1.z + 8].z
                mad r19.y, r18.y, cb9[r1.z + 8].w, cb9[r1.z + 9].x
                mul r14.w, r10.w, cb9[r1.z + 10].z
                mad r3.z, cb9[r1.z + 10].y, r10.w, r3.z
                div r3.z, r3.z, r14.w
              endif 
            else 
              mov r12.w, l(-1)
            ...
            if_z r10.w
              ...
              if_nz cb2[58].y
                ...
                loop 
                  ...
                  sample_c_lz_indexable(texture2darray)(float,float,float,float) r12.w, r20.xyzx, t9.xxxx, s13, r3.z
                  mad r3.x, r12.w, l(0.125000), r3.x
                  iadd r11.w, r11.w, l(1)
                endloop 
              else 
                utof r19.z, r10.w
                sample_c_lz_indexable(texture2darray)(float,float,float,float) r3.x, r19.xyzx, t9.xxxx, s13, r3.z
              endif 
              mul r1.z, r3.x, r3.x
              mul r1.z, r3.x, r1.z
            else 
        ...
        mad r18.xyz, r1.zzzz, r13.yzwy, r15.xyzx
        ...
        mad r2.yzw, r0.yyyy, r13.yyzw, r16.xxyz
        add_sat r1.z, -r1.z, l(1.000000)
        mul r3.x, r1.z, r1.z
        mul r3.x, r3.x, r3.x
        mul r1.z, r1.z, r3.x
        mul r0.y, r0.y, r1.z
        mad r11.xyz, r0.yyyy, r13.yzwy, r17.zxyz
        movc r15.xyz, r2.xxxx, r18.xyzx, r15.xyzx
        movc r17.xyz, r2.xxxx, r11.yzxy, r17.xyzx
        movc r16.xyz, r2.xxxx, r2.yzwy, r16.xyzx
        if_nz r3.y
...
ftou r0.y, r2.y
mad r3.xzw, r7.zzxy, l(3.000000, 0.000000, 1.000000, 2.000000), l(0.500000, 0.000000, 0.000000, -1.000000)
ftou r1.z, r3.x
ieq r1.z, r0.y, r1.z
movc r3.xz, r1.zzzz, r3.zzwz, l(-1.000000,0,0,0)
...
mad r2.xyz, r16.xyzx, r4.xyzx, r2.xyzx
...
ret 
// Approximately 2060 instruction slots used
