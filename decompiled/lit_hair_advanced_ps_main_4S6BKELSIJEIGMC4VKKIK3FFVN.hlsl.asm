...
if_nz r1.y
  ftoi r1.y, cb1[64].w
  lod r1.z, v1.yzyy, t21.y, s1
  lod r1.w, v1.yzyy, t21.x, s1
  lt r1.z, r1.z, r1.w
...
add r2.x, -r0.w, r2.x
mad r3.y, cb1[62].w, r2.x, r0.w
add r0.w, -r2.y, cb1[63].x
mad r0.w, cb1[63].w, r0.w, r2.y
...
sample_indexable(texture2d)(float,float,float,float) r2.w, v1.yzyy, t29.yzwx, s7
