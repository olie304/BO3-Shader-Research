...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:22:49 2021
//
//
// Buffer Definitions: 
//
...
//   float2 scriptControl;              // Offset:  344 Size:     8 [unused]
...
// emissiveMask                      texture  float4          2d            t24      1 
// distortionMap                     texture  float4          2d            t25      1 
...
add r1.zw, v1.yyyz, l(0.000000, 0.000000, -0.500000, -0.500000)
...
mad r1.xy, r1.xyxx, cb0[13].zwzz, r4.xyxx
...
sample_indexable(texture2d)(float,float,float,float) r0.w, r1.xyxx, t24.yzwx, s1
mul r1.xy, cb0[19].yyyy, cb1[44].zwzz
mul r2.xyzw, v1.yzyz, cb0[20].xyzw
mad r1.zw, cb1[69].wwww, cb0[19].zzzw, r2.xxxy
sample_indexable(texture2d)(float,float,float,float) r1.zw, r1.zwzz, t25.zwxy, s1
mad r1.zw, r1.zzzw, l(0.000000, 0.000000, 1.99218750, 1.99218750), l(0.000000, 0.000000, -1.000000, -1.000000)
mad r1.xy, r1.zwzz, r1.xyxx, r2.zwzz
mad r1.xy, cb1[69].wwww, cb0[21].xyxx, r1.xyxx
sample_indexable(texture2d)(float,float,float,float) r1.xyzw, r1.xyxx, t22.xyzw, s1
...
mov_sat r2.x, r2.x
mul r0.w, r0.w, r2.x
eq r2.xyz, r2.yyyy, l(3.000000, 2.000000, 1.000000, 0.000000)
movc r3.xyz, r2.zzzz, cb0[22].xyzx, cb0[18].yzwy
movc r2.yzw, r2.yyyy, cb0[23].xxyz, r3.xxyz
movc r2.xyz, r2.xxxx, cb0[24].xyzx, r2.yzwy
