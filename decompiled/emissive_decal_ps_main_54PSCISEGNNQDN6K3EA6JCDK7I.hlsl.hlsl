...
// unknown dcl_: dcl_resource_structured t4, 24
  ...
  r0.xy = float2(0.100000001,1) * w1.xy;
...
r1.x = colorSampler[]..swiz;
  ...
  r1.y = exp2(r1.y);
  r1.y = (uint)r1.y;
  uiDest.w = (uint)r1.x / (uint)r1.y;
  r1.w = uiDest.w;
  r1.y = (int)r1.y * 10;
  uiDest.x = (uint)r1.x / (uint)r1.y;
  r1.x = uiDest.x;
  r1.x = mad((int)r1.x, -10, (int)r1.w);
  r1.y = frac(r1.z);
  r1.x = (uint)r1.x;
  r1.x = 0.100000001 * r1.x;
  r1.x = r1.y * 0.100000001 + r1.x;
  r1.y = w1.y;
  r0.xyzw = emissiveMap.SampleGrad(colorSampler_s, r1.xy, r0.zwzz, r0.xyxx).xyzw;
  r0.xyz = emissiveTint1.xyz * r0.xyz;
  ...
  r1.y = cmp(emissiveFalloffPower == 0.000000);
  r1.x = log2(r1.x);
