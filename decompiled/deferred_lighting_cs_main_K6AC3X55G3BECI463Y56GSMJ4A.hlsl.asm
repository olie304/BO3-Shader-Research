...
ult r13.w, r14.y, r13.w
if_nz r13.w
  imul null, r13.w, r14.y, l(14)
  if_nz r3.z
    and r14.y, r0.y, l(1)
  ...
  iadd r14.y, r0.y, l(1)
  add r18.xyz, r5.xyzx, -cb10[r13.w + 0].xyzx
  ...
  if_nz r19.x
    ...
    iadd r14.y, r0.y, l(257)
    mad r17.w, r17.w, cb10[r13.w + 6].y, r14.w
    mul r18.w, r18.w, cb10[r13.w + 7].y
    mov r19.x, cb10[r13.w + 7].w
    mov r19.yz, cb10[r13.w + 8].xxyx
    dp3 r19.w, r16.xyzx, r19.xyzx
    dp3 r19.x, r18.xyzx, r19.xyzx
    add r19.x, r19.x, -cb10[r13.w + 8].z
    ...
    mov r20.x, cb10[r13.w + 8].w
    mov r20.yz, cb10[r13.w + 9].xxyx
    dp3 r19.y, r16.xyzx, r20.xyzx
    dp3 r19.z, r18.xyzx, r20.xyzx
    add r19.z, r19.z, -cb10[r13.w + 9].z
    ...
    mov r20.x, cb10[r13.w + 9].w
    mov r20.yz, cb10[r13.w + 10].xxyx
    dp3 r19.y, r16.xyzx, r20.xyzx
    dp3 r19.z, r18.xyzx, r20.xyzx
    add r19.z, r19.z, -cb10[r13.w + 10].z
    ge r19.w, r19.z, l(0.000000)
    max r19.z, r10.w, |r19.z|
    movc r19.z, r19.w, r19.z, -r19.z
    max r19.y, -r19.y, l(0.00000010)
    div r19.y, r19.z, r19.y
    min r19.x, |r19.y|, r19.x
    mov r20.x, cb10[r13.w + 10].w
    mov r20.yz, cb10[r13.w + 11].xxyx
    dp3 r19.y, r16.xyzx, r20.xyzx
    dp3 r19.z, r18.xyzx, r20.xyzx
    add r19.z, r19.z, -cb10[r13.w + 11].z
    ge r19.w, r19.z, l(0.000000)
    max r19.z, r10.w, |r19.z|
    movc r19.z, r19.w, r19.z, -r19.z
    max r19.y, -r19.y, l(0.00000010)
    div r19.y, r19.z, r19.y
    min r19.x, |r19.y|, r19.x
    mov r20.x, cb10[r13.w + 11].w
    mov r20.yz, cb10[r13.w + 12].xxyx
    dp3 r19.y, r16.xyzx, r20.xyzx
    dp3 r19.z, r18.xyzx, r20.xyzx
    add r19.z, r19.z, -cb10[r13.w + 12].z
    ge r19.w, r19.z, l(0.000000)
    max r19.z, r10.w, |r19.z|
    movc r19.z, r19.w, r19.z, -r19.z
    max r19.y, -r19.y, l(0.00000010)
    div r19.y, r19.z, r19.y
    min r19.x, |r19.y|, r19.x
    mov r20.x, cb10[r13.w + 12].w
    mov r20.yz, cb10[r13.w + 13].xxyx
    dp3 r19.y, r16.xyzx, r20.xyzx
    dp3 r19.z, r18.xyzx, r20.xyzx
    add r19.z, r19.z, -cb10[r13.w + 13].z
    ge r19.w, r19.z, l(0.000000)
    ...
    add r19.x, r18.x, cb10[r13.w + 3].w
    add r19.yz, r18.yyzy, cb10[r13.w + 4].xxyx
    ...
    mov r20.x, cb10[r13.w + 0].w
    mov r20.y, cb10[r13.w + 1].z
    mov r20.z, cb10[r13.w + 2].y
    dp3 r21.x, r19.xyzx, r20.xyzx
    mov r22.xy, cb10[r13.w + 1].xwxx
    mov r22.z, cb10[r13.w + 2].z
    dp3 r21.y, r19.xyzx, r22.xyzx
    mov r23.x, cb10[r13.w + 1].y
    mov r23.yz, cb10[r13.w + 2].xxwx
    dp3 r21.z, r19.xyzx, r23.xyzx
    ubfe r10.w, l(9), l(16), cb10[r13.w + 7].z
    utof r21.w, r10.w
    ...
    mad_sat r18.xyz, r24.xyzx, cb10[r13.w + 3].xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
    mul r24.xy, r18.xyxx, cb10[r13.w + 4].zwzz
    mul r24.z, r18.z, cb10[r13.w + 5].x
    add r18.xyz, r24.xyzx, cb10[r13.w + 5].yzwy
...
ge r7.w, r14.w, l(1.000000)
bfi r0.y, l(8), l(0), r14.y, r0.y
movc r0.y, r7.w, r0.y, r14.y
max r7.w, r17.w, l(1.000000)
rcp r7.w, r7.w
mov_sat r17.w, r17.w
mul r18.xyz, r7.wwww, r15.yzwy
...
if_nz r10.w
  ...
  mad r18.xyz, r15.yzwy, r7.wwww, r19.xyzx
  mov r16.w, l(0)
...
if_nz r7.w
  ...
  if_nz r7.w
    ...
    mad r20.xyz, r9.wwww, r19.xyzx, r18.xyzx
    ...
    mul r1.w, r1.w, r7.w
    mul r1.w, r1.w, r6.w
    mad r19.xyz, r1.wwww, r19.yzxy, r17.xyzx
    mov r20.w, r19.z
    mov r18.w, r17.z
    movc r18.xyzw, r3.wwww, r20.xyzw, r18.xyzw
    mov r19.zw, r21.xxxy
    mov r17.zw, r15.yyyz
    movc r19.xyzw, r3.wwww, r19.xyzw, r17.xyzw
...
ret 
// Approximately 2063 instruction slots used
