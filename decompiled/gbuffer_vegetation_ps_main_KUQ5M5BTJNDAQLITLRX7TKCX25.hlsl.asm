...
add r1.z, -v1.x, cb1[63].x
mad o2.z, cb1[63].w, r1.z, v1.x
...
max r3.z, cb0[12].w, l(0.000100)
mul r3.z, r0.w, r3.z
movc r0.w, v5.x, r0.w, r3.z
sample_indexable(texture2d)(float,float,float,float) r3.z, v1.yzyy, t9.yzxw, s1
add r3.z, -r3.z, l(1.000000)
mul r4.xyz, r0.xyzx, cb0[12].xyzx
mul r3.w, r3.z, r4.z
add r3.x, r3.y, r3.x
