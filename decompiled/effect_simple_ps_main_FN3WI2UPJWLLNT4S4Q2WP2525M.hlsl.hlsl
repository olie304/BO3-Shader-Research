...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r2.zw = offsetUVsColor.xy * scaleUVsColor.xy;
  r2.zw = r2.xy * scaleUVsColor.xy + r2.zw;
  ...
  r2.zw = r3.xy * scaleUVsColor.xy + r6.xy;
  r2.zw = float2(0.5,0.5) + r2.zw;
  r3.xyzw = colorMap.SampleGrad(colorSampler_s, r2.zw, r0.zwzz, r1.xyxx).xyzw;
  ...
  r1.w = r5.z ? r1.w : 0;
  r1.w = r5.w ? r1.w : 0;
  r2.z = max(9.99999975e-05, r3.w);
  r5.xyz = saturate(r4.xyz / r2.zzz);
  r5.xyz = saturate(-levelsControls.xxx + r5.xyz);
  r6.xy = levelsControls.yw + -levelsControls.xz;
  r2.w = max(9.99999975e-05, r6.x);
  ...
  r3.xyz = r1.www ? r4.xyz : r5.xyz;
  r4.xy = (int2)v0.xy;
  r4.zw = float2(0,0);
  r1.w = floatZSampler.Load(r4.xyz).x;
  r2.w = cmp(v6.z == 0.000000);
  r4.x = 1 / v6.z;
  r2.w = r2.w ? 60000 : r4.x;
  ...
  r4.x = rcp(r4.x);
  r4.y = cmp(v6.y != 1.000000);
  r5.xyz = r3.xyz / r2.zzz;
  r2.z = v1.w + r3.w;
  r6.y = saturate(r2.z * v6.y + -v6.y);
  r6.xzw = r6.yyy * r5.xyz;
  r3.xyzw = r4.yyyy ? r6.xzwy : r3.xyzw;
  r6.x = 1;
  r4.yz = r4.yy ? r6.xy : v1.ww;
  r2.z = cmp(r4.x < r1.w);
  r1.w = -r4.x + r1.w;
  ...
  r1.zw = offsetUVsEmissive.xy * scaleUVsEmissive.xy;
  r1.zw = r2.xy * scaleUVsEmissive.xy + r1.zw;
  r2.xy = gameTime.ww * scrollUVsEmissive.xy;
  r2.w = rotateUVsEmissive.y * gameTime.w + 1;
  r2.w = rotateUVsEmissive.x * r2.w;
  r2.w = 0.0174532924 * r2.w;
  sincos(r2.w, r4.x, r5.x);
  r5.y = r5.x;
  r5.z = r4.x;
  r6.x = dot(r5.yz, r1.zw);
  r5.x = -r4.x;
  r6.y = dot(r5.xy, r1.zw);
  r1.zw = r2.xy * scaleUVsEmissive.xy + r6.xy;
  r1.zw = float2(0.5,0.5) + r1.zw;
  r1.z = emissiveMap.SampleGrad(colorSampler_s, r1.zw, r0.z, r1.x).x;
  r1.z = r1.z * r2.z;
  r1.w = dot(v1.xyz, float3(0.298999995,0.587000012,0.114));
  ...
  r2.w = 1;
  r0.xyzw = r1.xxxx ? r2.xxzw : r0.xyzw;
