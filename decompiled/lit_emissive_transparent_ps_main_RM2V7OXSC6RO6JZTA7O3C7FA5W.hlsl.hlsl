...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  if (r2.z != 0) {
    ...
    r4.x = colorMap.CalculateLevelOfDetailUnclamped(colorSampler_s, v2.xy);
    r4.y = colorMap.CalculateLevelOfDetail(colorSampler_s, v2.xy);
    r4.x = cmp(r4.x < r4.y);
    r4.y = cmp(0 < r4.y);
    r5.xyz = (int3)r2.zzz & int3(1,2,4);
    r6.xyz = r5.xxx ? float3(1,0,1) : r0.xyz;
    r5.xyw = r5.yyy ? float3(0,1,1) : r0.xyz;
    r4.yzw = r4.yyy ? r6.xyz : r5.xyw;
    r5.xyz = r5.zzz ? float3(0,1,0) : r0.xyz;
    r0.xyz = r4.xxx ? r4.yzw : r5.xyz;
  }
  ...
  while (true) {
    ...
    if (r2.w == 0) r9.w = 0; else if (r2.w+0 < 32) {     r9.w = (uint)r6.w << (32-(r2.w + 0)); r9.w = (uint)r9.w >> (32-r2.w);    } else r9.w = (uint)r6.w >> 0;
    r6.w = r7.w ? r9.w : r6.w;
  ...
  if (r1.x != 0) {
    ...
    r3.x = columnCount * r1.x;
    r3.x = cmp(r3.x >= -r3.x);
    r3.x = r3.x ? columnCount : -columnCount;
    r4.w = 1 / r3.x;
    r1.x = r4.w * r1.x;
    r1.x = frac(r1.x);
    r1.x = r3.x * r1.x;
    ...
    r1.xw = r3.xx * r1.xw;
    r1.xw = scaleUVs.xy * r1.xw;
    r1.xw = r5.zw * scaleUVs.xy + r1.xw;
    r1.xw = offsetUVs.xy * scaleUVs.xy + r1.xw;
    ...
    r10.y = r10.x;
    r10.z = r3.x;
    r11.x = dot(r10.yz, r1.xw);
    r10.x = -r3.x;
    r11.y = dot(r10.xy, r1.xw);
    r1.xw = gameTime.ww * scrollUVs.xy;
    r1.xw = r1.xw * scaleUVs.xy + r11.xy;
    ...
    r7.xy = clampU ? r5.zw : r1.xw;
  }
  r1.x = dot(-v7.xyz, -v7.xyz);
  r1.x = rsqrt(r1.x);
  r10.xyz = -v7.xyz * r1.xxx;
  r1.w = saturate(dot(r10.xyz, r3.yzw));
  r3.xyzw = emissiveMap.Sample(colorSampler_s, r7.xy).xyzw;
  r3.xyz = emissiveTint1.xyz * r3.xyz;
  r4.w = log2(r1.w);
  r4.w = emissiveFalloffPower * r4.w;
  r4.w = exp2(r4.w);
  r1.w = 1 + -r1.w;
  r1.w = log2(r1.w);
  r1.w = emissiveFalloffPower * r1.w;
  r1.w = exp2(r1.w);
  r1.w = invertFalloff ? r1.w : r4.w;
  r4.w = cmp(emissiveFalloffPower == 0.000000);
  r1.w = r4.w ? 1 : r1.w;
  r3.w = hdrScale * r3.w;
  r1.w = r3.w * r1.w;
  r1.z = r1.w * r1.z;
  ...
  r1.z = frac(r1.z);
  r7.y = gameTime.w * flickerSpeed + r1.z;
  r7.x = flickerSeed.x;
  r1.z = flickerLookupMap.SampleLevel(lookupSampler_s, r7.xy, 0).x;
  r1.z = log2(abs(r1.z));
  ...
  r6.x = saturate(dot(r2.xyz, r10.xyz));
  ...
  r41.w = samp0[]..swiz;
    ...
    r31.y = dot(r2.xyz, r32.xyz);
    r31.z = dot(r2.xyz, r25.xyz);
  ...
  if (r6.w == 0) {
    ...
    if (r5.w != 0) {
      ...
      r2.w = r6.y * r5.y + r2.w;
      r22.xyz = r12.yzw * r2.www + r22.xyz;
    }
  } else {
    r22.x = r21.w;
  }
  ...
  r6.yzw = r22.xyz * r2.www;
  r15.xyz = r6.zwy * r5.yyy;
  r5.yzw = r6.yzw * r5.zzz;
  r1.y = sqrt(r4.w);
  r1.y = r1.y * 0.5 + 0.5;
  r1.y = r1.y * r1.y;
  r2.w = 0.5 * r1.y;
  ...
  r1.y = r6.y * r1.y;
  r2.w = r6.y * r2.w;
  r6.y = dot(r2.xyz, sunConstants.wldDir.xyz);
  r6.z = saturate(r6.y);
  r6.w = cmp(0 >= r6.z);
  if (r6.w != 0) {
    r7.z = 0;
  ...
  if (r6.w != 0) {
    ...
    if (r6.w != 0) {
      ...
      r6.z = r7.z * r6.z;
      r6.z = 0.25 * r6.z;
      r12.yzw = r6.zzz * r8.xyz + r5.yzw;
      r1.x = saturate(1 + -r1.x);
      r6.w = r1.x * r1.x;
      r6.w = r6.w * r6.w;
      r1.x = r6.w * r1.x;
      r1.x = r6.z * r1.x;
      r8.xyz = r1.xxx * r8.yzx + r15.xyz;
      r16.w = r8.z;
      r14.w = r15.z;
      r14.xyzw = r6.yyyy ? r16.xyzw : r14.xyzw;
      r8.zw = r12.yz;
      r15.zw = r5.yz;
      r8.xyzw = r6.yyyy ? r8.xyzw : r15.xyzw;
      r5.w = r6.y ? r12.w : r5.w;
      r15.z = r14.w;
      r15.xy = r8.xy;
      r5.yz = r8.zw;
    }
                    ...
                    r15.w = samp0[]..swiz;
                      ...
                      if (r10.w != 0) {
                        ...
                        while (true) {
                          ...
                          if (r27.w != 0) break;
                          r42.x = dot(icb[r19.z+0].yx, r8.xw);
            ...
            r39.w = samp0[]..swiz;
              ...
              if (r16.w != 0) {
                ...
                if (r16.w != 0) {
                  ...
                  r19.x = r19.x + -r16.z;
                  r19.x = r4.w * r19.x + r16.z;
                  r19.x = r19.x * r13.w;
                  r15.w = cmp(0 < r15.w);
                  r23.xyz = r19.xxx * r21.xyw + r12.yzw;
                  r20.xyz = r20.xyz * r14.www + r10.xyz;
                  r14.w = dot(r20.xyz, r20.xyz);
                  r14.w = rsqrt(r14.w);
                  r20.xyz = r20.xyz * r14.www;
                  r14.w = dot(r20.xyz, r10.xyz);
                  r19.x = dot(r2.xyz, r20.xyz);
                  r20.x = abs(r19.x) * r1.w + -abs(r19.x);
                  r19.x = abs(r19.x) * r20.x + 1;
                  r16.z = r16.z * r1.y + r2.w;
                  r19.x = r19.x * r19.x;
                  r16.z = r19.x * r16.z;
                  r16.z = rcp(r16.z);
                  r16.z = r16.z * r16.w;
