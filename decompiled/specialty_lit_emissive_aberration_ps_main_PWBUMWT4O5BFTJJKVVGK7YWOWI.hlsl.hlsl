...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  r0.xy = w1.xy * colorScale.xy + r0.xy;
  ...
  r6.x = dot(r5.xyz, v4.xyz);
  r6.y = dot(r5.xyz, v5.xyz);
  r2.z = dot(r5.xyz, v3.xyz);
  r2.w = cmp(0 < r2.z);
  r6.xy = -r6.xy / r2.zz;
  r2.zw = r2.ww ? r6.xy : 0;
  r6.xy = float2(-0.5,-0.5) + w1.xy;
  ...
  r2.w = outlineMap.Sample(colorSampler_s, w1.xy).w;
  r6.xyzw = w1.xyyz + r6.xyzz;
