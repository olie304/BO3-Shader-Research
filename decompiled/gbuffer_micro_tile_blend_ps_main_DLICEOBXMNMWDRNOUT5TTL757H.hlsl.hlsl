  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r1.w = glossMapDetail2.Sample(specColorSampler_s, r3.yz).x;
  ...
  r5.w = r4.w * detailScaleHeight1 + r0.w;
  ...
  r1.z = debugGlossOverride.x * r3.y + glossRange.x;
  r1.z = saturate(0.0588235296 * r1.z);
  r1.w = cmp(0 < debugStreamerControl.w);
  if (r1.w != 0) {
    r1.w = (int)debugStreamerControl.w;
    r3.y = colorMap.CalculateLevelOfDetailUnclamped(colorSampler_s, v2.xy);
  ...
  r1.z = debugOcclusionOverride.x + -r2.w;
  o2.z = debugOcclusionOverride.w * r1.z + r2.w;
  r1.yzw = v4.xyz * r1.yyy + -r0.xyz;
  r5.yzw = debugNormalOverride.www * r1.yzw + r0.xyz;
  r0.x = r4.x + r4.y;
  r0.x = r3.w * r1.x + r0.x;
  r0.x = 0.5 * r0.x;
  r1.xyz = r3.xzw * r1.xxx + -r0.xxx;
  r0.y = max(r1.y, r1.z);
  r0.y = max(r1.x, r0.y);
  r0.x = max(r0.x, r0.y);
  r0.y = cmp(r0.x == r1.x);
