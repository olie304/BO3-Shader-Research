...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r3.w = min(1, r3.w);
  r3.xy = r4.xy * detailScaleHeight + r1.yz;
  r1.y = dot(r3.xyz, r3.xyz);
  r1.y = rsqrt(r1.y);
  r3.xyz = r3.xyz * r1.yyy;
  r1.y = r3.w * detailScaleHeight + r1.w;
  ...
  r1.zw = r5.xy * float2(1.9921875,1.9921875) + float2(-1,-1);
  r3.w = r5.z * r5.z;
  r3.w = 0.333333343 * r3.w;
  r3.w = min(1, r3.w);
  ...
  r4.z = min(1, r4.z);
  r3.xy = r1.zw * flagRippleHeight + r3.xy;
  r1.z = dot(r3.xyz, r3.xyz);
  r1.z = rsqrt(r1.z);
  r3.xyz = r3.xyz * r1.zzz;
  r1.y = r3.w * flagRippleHeight + r1.y;
  r3.xy = r4.xy * flagRippleHeight + r3.xy;
  r1.z = dot(r3.xyz, r3.xyz);
  r1.z = rsqrt(r1.z);
  r3.xyz = r3.xyz * r1.zzz;
  r1.y = r4.z * flagRippleHeight + r1.y;
  r1.z = v7.x ? 1 : -1;
  ...
  r1.x = saturate(dot(r3.xyz, r5.yzw));
  ...
  while (true) {
    ...
    bitmask.w = ((~(-1 << r1.w)) << 0) & 0xffffffff;  r10.w = (((uint)0 << 0) & bitmask.w) | ((uint)r10.y & ~bitmask.w);
  ...
  if (r4.w != 0) {
    ...
    while (true) {
      ...
      r12.w = cmp((int)r1.z == (int)r9.z);
      if (r1.w == 0) r13.z = 0; else if (r1.w+0 < 32) {       r13.z = (uint)r9.w << (32-(r1.w + 0)); r13.z = (uint)r13.z >> (32-r1.w);      } else r13.z = (uint)r9.w >> 0;
  ...
  if (r1.w != 0) {
    ...
    r1.z = r1.y * r1.z + r3.w;
    r10.yzw = r13.xyz * r1.zzz + r10.yzw;
  }
  r1.z = r1.x + r0.w;
  r1.z = log2(abs(r1.z));
  r1.z = r6.z * r1.z;
