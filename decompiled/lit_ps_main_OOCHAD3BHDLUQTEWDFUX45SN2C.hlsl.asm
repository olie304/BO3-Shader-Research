...
sample_indexable(texture2d)(float,float,float,float) r1.x, v2.xyxx, t24.xyzw, s5
...
sample_indexable(texture2d)(float,float,float,float) r1.x, v2.xyxx, t29.xyzw, s7
sample_indexable(texture2d)(float,float,float,float) r2.x, v2.xyxx, t26.xyzw, s5
...
if_nz r2.z
  ftoi r2.z, cb1[64].w
  lod r2.w, v2.xyxx, t21.y, s3
  lod r3.y, v2.xyxx, t21.x, s3
  lt r2.w, r2.w, r3.y
