...
sample_indexable(texture2d)(float,float,float,float) r1.yzw, r1.yzyy, t24.wxyz, s3
...
mad r0.xyz, cb1[58].wwww, r1.yzwy, r0.xyzx
...
if_z r1.x
  ...
  max r1.x, r23.w, l(1.000000)
  rcp r1.x, r1.x
  mov_sat r23.w, r23.w
  mul r20.xyz, r1.xxxx, r22.xyzx
  mul r21.xyz, r1.xxxx, r23.xyzx
  ...
  if_nz r4.z
    ...
    mad r20.xyz, r22.xyzx, r1.xxxx, r9.yzwy
    mov r11.w, l(0)
    sample_l_indexable(texturecubearray)(float,float,float,float) r9.yzw, r11.xyzw, t8.wxyz, s2, r7.z
    mad r1.x, cb2[19].x, r4.z, -r3.w
    mad r1.x, r4.y, r1.x, r3.w
    mad r21.xyz, r9.yzwy, r1.xxxx, r21.xyzx
  endif 
else 
  mov r21.x, r20.w
endif 
...
mul r9.yzw, r1.xxxx, r21.xxyz
mul r14.xyz, r4.yyyy, r9.zwyz
mul r4.yzw, r4.zzzz, r9.yyzw
sqrt r0.w, r6.z
mad r0.w, r0.w, l(0.500000), l(0.500000)
mul r0.w, r0.w, r0.w
mul r1.x, r0.w, l(0.500000)
mad r0.w, -r0.w, l(0.500000), l(1.000000)
mad r3.w, r4.x, r0.w, r1.x
mul r0.w, r0.w, r3.w
mul r1.x, r1.x, r3.w
...
if_nz r7.z
  ...
  if_nz r7.z
    ...
    if_nz r10.y
      ...
      mad r10.z, |r3.w|, l(-0.200000), l(0.400000)
      mad r19.xyz, r3.xyzx, r10.zzzz, v5.xyzx
    ...
    mad r10.yzw, r6.wwww, r9.yyzw, r4.yyzw
          ...
          if_nz r25.w
            ...
            if_nz r25.w
              ...
              if_nz r25.w
                ...
                mad r41.xyz, r3.xyzx, r25.wwww, v5.xyzx
              ...
              if_nz r25.w
                ...
                if_nz r14.w
                  ...
                  mad r19.xyz, r3.xyzx, r26.wwww, v5.xyzx
                  ...
                  if_nz r14.w
                    ...
                    mad r20.xyz, r3.xyzx, r19.xxxx, v5.xyzx
                ...
                mad r13.w, -r21.w, r4.x, l(1.000000)
          ...
          if_nz r16.z
            ...
            if_nz r16.z
              ...
              if_nz r16.z
                ...
                mad r22.xyz, r3.xyzx, r16.zzzz, v5.xyzx
              ...
              if_nz r16.z
                ...
                if_nz r22.x
                  ...
                  mad r23.xyz, r3.xyzx, r22.yyyy, v5.xyzx
                  ...
                  if_nz r22.x
                    ...
                    mad r22.y, |r13.w|, l(-0.200000), l(0.400000)
                    mad r24.xyz, r3.xyzx, r22.yyyy, v5.xyzx
                ...
                mad r16.w, -r14.w, r4.x, l(1.000000)
                mul r16.w, r16.w, r16.w
...
mad r1.xyz, r29.xyzx, r1.yzwy, r3.xyzx
