...
//   float4 postFxBloom10;              // Offset: 1440 Size:    16
//   float4 postFxBloom11;              // Offset: 1456 Size:    16
...
dcl_constantbuffer CB8[92], immediateIndexed
...
mov r4.x, l(0)
mov r4.y, v2.z
add r4.zw, -r4.xxxy, v0.xxxy
add r4.xy, r4.xyxx, v0.xyxx
sample_indexable(texture2d)(float,float,float,float) r5.xyzw, r4.xyxx, t0.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r4.xyzw, r4.zwzz, t0.xyzw, s0
add r1.xyzw, r1.xyzw, r4.xyzw
sample_indexable(texture2d)(float,float,float,float) r4.xyzw, v0.xyxx, t0.xyzw, s0
add r1.xyzw, r1.xyzw, r4.xyzw
...
mul r0.w, r0.w, l(0.06666667)
mul r0.xyz, r0.xyzx, cb8[90].xyzx
mul r1.xyz, r0.wwww, cb8[91].xyzx
mad o0.xyz, r0.xyzx, l(0.06666667, 0.06666667, 0.06666667, 0.000000), r1.xyzx
ret 
