...
r0.w = shaderConstantSetBuffer[]..swiz;
  ...
  r4.x = dot(r1.xyz, r3.xyz);
  r4.y = dot(r1.xyz, r5.xyz);
  r4.z = dot(r1.xyz, r7.xyz);
  r1.x = dot(r4.xyz, r4.xyz);
  r1.x = rsqrt(r1.x);
  r1.xyz = r4.xyz * r1.xxx;
  r3.x = dot(r2.xzw, r3.xyz);
  r3.y = dot(r2.xzw, r5.xyz);
  r3.z = dot(r2.xzw, r7.xyz);
  r1.w = dot(r3.xyz, r3.xyz);
  r1.w = rsqrt(r1.w);
  r2.xzw = r3.xyz * r1.www;
  ...
  if (r0.w != 0) {
    ...
    r4.xy = r4.xy * r0.ww;
    r4.xy = scaleUVs.xy * r4.xy;
    r4.xy = r4.zw * scaleUVs.xy + r4.xy;
    r4.xy = offsetUVs.xy * scaleUVs.xy + r4.xy;
    ...
    r4.xy = gameTime.ww * scrollUVs.xy;
    r4.xy = r4.xy * scaleUVs.xy + r7.xy;
...
r5.w = shaderConstantSetBuffer[]..swiz;
  ...
  r4.xy = r6.zz ? r4.zw : r4.xy;
  r4.xy = r6.yy ? r5.xy : r4.xy;
  o7.xy = r6.xx ? r5.zw : r4.xy;
  r3.z = v1.w;
  o1.xyz = r3.zxy;
  o3.xyz = r0.xyz;
  o4.xyz = r1.xyz;
