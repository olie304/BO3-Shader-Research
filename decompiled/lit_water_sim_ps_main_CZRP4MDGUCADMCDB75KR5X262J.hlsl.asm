...
mul r11.y, r0.x, l(0.00781250)
min r11.y, r11.y, l(15.000000)
ftou r11.y, r11.y
ushr r13.xy, r0.yzyy, l(6, 6, 0, 0)
ishl r13.z, r11.y, l(4)
and r0.y, r10.w, l(-32)
iadd r0.z, -r0.y, r10.w
...
loop 
  ...
  loop 
    ...
    and r16.w, r15.z, r15.x
    if_nz r16.w
      xor r15.x, r15.z, r15.x
      ...
      if_nz r15.z
        ...
        mul r16.x, r17.w, r18.w
        and r17.w, r25.x, l(1)
        movc r25.zw, r17.wwww, r16.xxxy, r16.zzzx
        mov r16.x, r25.x
        mov r28.xy, r25.zwzz
        mov r17.w, l(1)
        loop 
          ...
          movc r4.y, r28.z, r18.w, r28.w
          movc r28.xy, r27.wwww, r28.xyxx, r4.xyxx
          iadd r17.w, r17.w, l(1)
          mov r16.x, r24.w
        endloop 
        mov_sat r28.y, r28.y
        mul r4.y, r25.y, r28.y
        ...
        if_nz r15.z
          ...
          mad r25.xyz, r12.xyzx, r15.yyyy, r25.xyzx
          dp3 r15.z, r25.xyzx, r25.xyzx
          sqrt r15.z, r15.z
          div r15.y, r15.y, r15.z
          add r15.y, r15.y, r15.y
          sqrt r15.y, r15.y
          mad r15.y, r7.z, l(5.000000), r15.y
          ...
          utof r34.w, r15.z
          sample_l_indexable(texturecubearray)(float,float,float,float) r25.xyz, r34.xyzw, t8.xyzw, s2, r15.y
...
if_nz r4.x
  ...
  loop 
    ...
    breakc_nz r17.w
    ushr r14.z, r16.w, l(5)
    iadd r15.xyz, r13.xywx, r14.xyzx
    ld_indexable(texture2darray)(uint,uint,uint,uint) r14.z, r15.xyzw, t7.yzxw
    ieq r15.x, r0.y, r16.w
    ubfe r15.y, r0.z, l(0), r14.z
    movc r14.z, r15.x, r15.y, r14.z
    iadd r15.x, r16.w, cb2[0].x
    ...
    loop 
      breakc_z r15.z
      firstbit_lo r17.w, r15.z
      ishl r18.w, l(1), r17.w
      and r19.w, r15.z, r18.w
      if_nz r19.w
        xor r15.z, r15.z, r18.w
        iadd r18.w, r15.x, r17.w
        ...
        if_nz r18.w
          ...
          and r24.w, r26.x, l(1)
          movc r26.zw, r24.wwww, r16.xxxy, r16.zzzx
          mov r16.x, r26.x
          mov r29.xy, r26.zwzz
          mov r24.w, l(1)
          loop 
            ...
            movc r4.y, r30.x, r25.w, r30.y
            movc r29.xy, r29.wwww, r29.xyxx, r4.xyxx
            iadd r24.w, r24.w, l(1)
            mov r16.x, r29.z
          endloop 
          add_sat r4.y, -r15.y, r29.y
          mul r16.x, r26.y, r4.y
          ...
          if_nz r18.w
            ...
            mad r23.w, r4.y, r26.y, r23.w
            mul r4.y, r27.z, r16.x
            mov r27.z, r35.z
            dp3 r16.x, r12.xyzx, r27.xyzx
            dp3 r17.w, r28.xyzx, r27.xyzx
            ...
            mad r26.xyz, r12.xyzx, r16.xxxx, r26.xyzx
            ...
            mad r24.xyz, r25.xyzx, r27.xyzx, r24.xyzx
            mul r17.z, r9.w, r16.x
            mul r25.xyz, r4.yyyy, r26.xyzx
            dp3 r4.y, r25.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
            mad r4.y, r9.w, r16.x, r4.y
            div r4.y, r17.z, r4.y
            mad r23.xyz, r25.xyzx, r4.yyyy, r23.xyzx
          endif 
        endif 
      endif 
    endloop 
...
if_nz r0.z
  ...
  mov r12.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r12.xyz, r12.xyzw, t8.xyzw, s2, r7.w
  mad r0.y, cb2[19].x, r0.z, -r1.w
  mad r0.y, r5.y, r0.y, r1.w
  mad r14.xyz, r12.xyzx, r0.yyyy, r14.xyzx
endif 
if_nz cb0[28].z
  ...
  if_nz cb0[28].w
    ...
    loop 
      ...
      max r1.w, |r19.y|, |r19.x|
      lt r1.w, r19.z, r1.w
      if_nz r1.w
        break 
      endif 
      div r4.xy, r19.xyxx, r19.zzzz
      ...
      if_nz r4.x
        ...
        mad r19.xyz, -r1.wwww, r16.xyzx, r18.xyzx
        ...
        div r4.xy, r19.xyxx, r19.zzzz
        mad r4.xy, r4.xyxx, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
        sample_l_indexable(texture2d)(float,float,float,float) r19.xyz, r4.xyxx, t30.xyzw, s8, l(0.000000)
    ...
    mad r12.xyz, r12.xyzx, r0.yyyy, v6.xyzx
    mul r15.xyz, r12.yyyy, cb1[9].xywx
    mad r12.xyw, r12.xxxx, cb1[8].xyxw, r15.xyxz
    mad r12.xyz, r12.zzzz, cb1[10].xywx, r12.xywx
    add r12.xyz, r12.xyzx, cb1[11].xywx
    div r0.yz, r12.xxyx, r12.zzzz
    max r1.w, |r0.z|, |r0.y|
    ...
    and r1.w, r1.w, r4.x
    sample_indexable(texture2d)(float,float,float,float) r12.xyz, r0.yzyy, t30.xyzw, s8
    if_nz r1.w
      mul r14.xyz, r12.xyzx, cb1[85].xxxx
    endif 
  endif 
endif 
...
if_z r1.w
  mul r12.xyz, v6.yyyy, cb2[29].xyzx
  mad r12.xyz, v6.xxxx, cb2[28].xyzx, r12.xyzx
  mad r12.xyz, v6.zzzz, cb2[30].xyzx, r12.xyzx
  add r12.xyz, r12.xyzx, cb2[31].xyzx
  add r1.w, r12.z, -cb2[17].w
  ...
  if_nz r4.y
    ...
    loop 
      ...
      breakc_nz r7.z
      ftou r7.z, r4.y
      add r9.zw, r12.xxxy, -cb2[r7.z + 20].xxxy
      max r7.w, |r9.w|, |r9.z|
  ...
  if_nz r7.z
    ...
    rcp r16.xz, r15.xxxx
    mov r16.y, -r16.z
    mad r15.xyz, r12.xyxx, r16.xyzx, r15.yzyy
    ...
    if_z r9.w
      ...
      if_z r7.w
        ...
        movc r16.xz, r7.wwww, r17.xxwx, r9.zzwz
      endif 
      and r7.w, r16.z, l(0xc0000000)
      if_z r7.w
        ubfe r9.z, l(14), l(15), r16.z
        utof r9.z, r9.z
        ...
        mad r12.w, r12.w, l(0.00392157), r9.z
        iadd r13.w, r15.y, l(1)
        ubfe r14.w, l(1), l(1), r15.z
  ...
  if_z r7.z
    ...
    if_nz cb2[58].y
      ...
      add r12.xy, r12.xyxx, -cb2[r4.y + 20].xyxx
      mul r12.xy, r12.xyxx, cb2[r4.y + 20].zzzz
      ...
      loop 
        uge r12.z, r10.w, l(8)
        breakc_nz r12.z
        ult r12.z, r5.y, r10.w
        movc r16.xy, r12.zzzz, r12.xyxx, r9.zwzz
        movc r12.w, r12.z, cb2[r4.y + 20].w, cb2[r7.z + 20].w
        movc r12.z, r12.z, r4.y, r7.z
        ...
        utof r16.z, r12.z
        sample_c_lz_indexable(texture2darray)(float,float,float,float) r12.z, r16.xyzx, t13.xxxx, s13, r1.w
        ...
        mad r7.w, r12.z, l(0.125000), r7.w
...
if_nz r4.y
  ...
  if_z r7.z
    ...
    mad r15.xy, r9.zwzz, r18.xzxx, r18.ywyy
    mul r1.w, r5.y, r12.y
    mad r0.y, r12.x, r5.y, r0.y
    div r0.y, r0.y, r1.w
    ...
    if_nz cb2[58].y
      ...
      loop 
        ige r7.w, r7.z, l(8)
        breakc_nz r7.w
        dp2 r17.x, icb[r7.z + 0].yxyy, r12.xyxx
        dp2 r17.y, icb[r7.z + 0].yxyy, r12.yzyy
        mad r16.xy, r17.xyxx, r4.yyyy, r15.xyxx
        sample_c_lz_indexable(texture2darray)(float,float,float,float) r7.w, r16.xyzx, t9.xxxx, s13, r0.y
        mad r5.y, r7.w, l(0.125000), r5.y
        iadd r7.z, r7.z, l(1)
      endloop 
    else 
      utof r15.z, r1.w
      sample_c_lz_indexable(texture2darray)(float,float,float,float) r5.y, r15.xyzx, t9.xxxx, s13, r0.y
    endif 
    mul r0.y, r5.y, r5.y
    mul r0.y, r5.y, r0.y
  else 
...
if_nz r1.w
  if_nz cb2[23].x
    ...
    mad r12.xyz, cb2[23].yyyy, r12.xyzx, l(1.000000, 1.000000, 1.000000, 0.000000)
    mul r12.xyz, r12.xyzx, cb2[18].xyzx
  else 
    mov r12.xyz, cb2[18].xyzx
  endif 
  mul r12.xyz, r4.xxxx, r12.xyzx
  add r1.w, r0.z, r7.y
  div r1.w, r0.z, r1.w
  mad r15.xyz, r12.xyzx, r1.wwww, r11.yzwy
  mad r16.xyz, -v6.xyzx, r6.xxxx, cb2[17].xyzx
  dp3 r1.w, r16.xyzx, r16.xyzx
  rsq r1.w, r1.w
  mul r16.xyz, r1.wwww, r16.xyzx
  dp3_sat r1.w, r1.xyzx, r16.xyzx
  dp3_sat r4.x, r16.xyzx, r6.yzwy
  mul r4.y, r1.w, r1.w
  ...
  mul r16.xyz, r4.xxxx, r12.xyzx
  mad r16.xyz, r16.xyzx, r0.zzzz, r14.xyzx
  mul r12.xyz, r4.yyyy, r12.xyzx
  mad r12.xyz, r12.xyzx, r0.zzzz, r16.xyzx
else 
  mov r15.xyz, r11.yzwy
  mov r12.xyz, r14.xyzx
endif 
movc r11.yzw, r0.yyyy, r15.xxyz, r11.yyzw
movc r12.xyz, r0.yyyy, r12.xyzx, r14.xyzx
mov r14.x, -r9.x
...
loop 
  ...
  ld_indexable(texture2darray)(uint,uint,uint,uint) r1.w, r16.xyzw, t6.yzwx
  ...
  loop 
    ...
    if_nz r7.z
      ...
      ubfe r6.x, l(3), l(24), r28.x
      switch r6.x
        case l(4)
        lt r6.x, l(0.000000), r32.x
        mov r33.x, r31.w
        mov r33.yz, r32.zzwz
        mad r34.xyz, -r33.xyzx, l(0.500000, 0.500000, 0.500000, 0.000000), r26.xyzx
        add r35.xyz, r34.xyzx, -v6.xyzx
        dp3 r7.z, r33.xyzx, r35.xyzx
        div_sat r7.z, -r7.z, r32.x
        mad r33.xyz, r7.zzzz, r33.xyzx, r34.xyzx
        movc r33.xyz, r6.xxxx, r33.xyzx, r26.xyzx
        add r33.xyz, r33.xyzx, -v6.xyzx
        dp3 r6.x, r33.xyzx, r33.xyzx
        rsq r7.z, r6.x
        mul r34.xyz, r7.zzzz, r33.xyzx
        dp3 r7.w, r1.xyzx, r34.xyzx
        mov_sat r9.z, r7.w
        movc r9.z, cb0[29].z, |r7.w|, r9.z
        lt r9.w, l(0.000000), r9.z
        if_nz r9.w
          sqrt r9.w, r6.x
          mul r10.w, r29.y, r29.y
          div r6.x, r10.w, r6.x
          min r6.x, r6.x, l(1.000000)
          mad_sat r10.w, r9.w, r28.y, r28.z
          mad_sat r9.w, r9.w, r28.w, r29.x
          ...
          mul r9.w, r9.w, r10.w
          mul r6.x, r6.x, r9.w
          lt r9.w, l(0.000000), r6.x
          if_nz r9.w
            ubfe r15.zw, l(0, 0, 3, 4), l(0, 0, 27, 20), r28.xxxx
            ine r9.w, r15.z, l(1)
            if_nz r9.w
              ...
              mad r34.xyz, r1.xyzx, r9.wwww, v6.xyzx
              mov r30.z, r31.x
              add r34.xyz, -r30.xyzx, r34.xyzx
              max r9.w, |r34.z|, |r34.y|
              max r9.w, r9.w, |r34.x|
              div r9.w, r31.y, r9.w
              add r9.w, r31.z, r9.w
              ...
              loop 
                ige r15.z, r13.w, l(8)
                breakc_nz r15.z
                dp2 r36.y, icb[r13.w + 0].yxyy, r14.xyxx
                dp2 r36.z, icb[r13.w + 0].yxyy, r14.yzyy
                mul r36.yz, r29.zzzz, r36.yyzy
                mul r36.x, r11.x, r36.y
                mul r36.w, r7.x, r36.y
                mad r35.xyz, r34.xyzx, r10.wwww, r36.xzwx
                sample_c_lz_indexable(texturecubearray)(float,float,float,float) r15.z, r35.xyzw, t10.xxxx, s13, r9.w
            ...
            if_nz r15.w
              ...
              and r7.w, r5.z, r7.w
              movc r7.w, r7.w, -r13.w, r13.w
              mad r18.xyz, r1.xyzx, r7.wwww, v6.xyzx
              dp4 r7.w, r34.xyzw, r18.xyzw
              ...
              if_z r15.z
                ...
                dp4 r34.x, r34.xyzw, r18.xyzw
                dp4 r34.y, r35.xyzw, r18.xyzw
                div r18.xy, r34.xyxx, r13.wwww
                mad r18.xy, r18.xyxx, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
                add r18.xy, r37.zwzz, r18.xyxx
                mul r18.xy, r37.xyxx, r18.xyxx
                div r34.xy, r10.wwww, r36.xzxx
                add r34.zw, -r34.xxxy, l(0.000000, 0.000000, 1.000000, 1.000000)
                ge r34.zw, r18.xxxy, r34.zzzw
                ge r34.xy, r34.xyxx, r18.xyxx
                or r34.xy, r34.xyxx, r34.zwzz
                or r15.w, r34.y, r34.x
                mov_sat r18.xy, r18.xyxx
                mad r18.xy, r18.xyxx, r36.xzxx, r36.ywyy
                mul r19.w, r13.w, r38.y
                mad r7.w, r38.x, r13.w, r7.w
                div r7.w, r7.w, r19.w
              else 
                mov r15.w, l(-1)
              endif 
              or r13.w, r15.z, r15.w
              if_z r13.w
                ...
                if_nz r4.x
                  ...
                  loop 
                    ige r15.w, r15.z, l(8)
                    breakc_nz r15.w
                    dp2 r35.x, icb[r15.z + 0].yxyy, r14.xwxx
                    dp2 r35.y, icb[r15.z + 0].xyxx, r9.xyxx
                    mad r34.xy, r35.xyxx, r10.wwww, r18.xyxx
                    sample_c_lz_indexable(texture2darray)(float,float,float,float) r15.w, r34.xyzx, t9.xxxx, s13, r7.w
                    mad r13.w, r15.w, l(0.125000), r13.w
                    iadd r15.z, r15.z, l(1)
                  endloop 
                else 
                  utof r18.z, r9.w
                  sample_c_lz_indexable(texture2darray)(float,float,float,float) r13.w, r18.xyzx, t9.xxxx, s13, r7.w
                endif 
            ...
            lt r7.w, l(0.000000), r6.x
            if_nz r7.w
              mov r27.z, r26.w
              mul r18.xyz, r27.zxyz, r6.xxxx
              add r6.x, r7.y, r9.z
              div r6.x, r9.z, r6.x
              mad r16.xyz, r18.xyzx, r6.xxxx, r16.xyzx
              mad r33.xyz, r33.xyzx, r7.zzzz, r6.yzwy
              dp3 r6.x, r33.xyzx, r33.xyzx
              rsq r6.x, r6.x
              mul r33.xyz, r6.xxxx, r33.xyzx
              dp3_sat r6.x, r1.xyzx, r33.xyzx
              dp3_sat r7.z, r33.xyzx, r6.yzwy
              mul r7.w, r6.x, r6.x
              mad r15.zw, r7.wwww, cb0[15].xxxz, l(0.000000, 0.000000, 1.000000, 1.000000)
              mul r15.zw, r15.zzzw, r15.zzzw
              div r15.zw, cb0[15].yyyw, r15.zzzw
              mul r15.zw, r6.xxxx, r15.zzzw
              mul r6.x, r7.z, l(4.000000)
              div r7.zw, r15.zzzw, r6.xxxx
              mul r7.zw, r7.zzzw, cb0[16].xxxy
              mul r33.xyz, r7.zzzz, r18.xyzx
              mad r33.xyz, r33.xyzx, r9.zzzz, r25.xyzx
              mul r18.xyz, r7.wwww, r18.xyzx
              mad r25.xyz, r18.xyzx, r9.zzzz, r33.xyzx
            endif 
          endif 
        endif 
        break 
        ...
        dp3 r6.x, r18.xyzx, r18.xyzx
        rsq r6.x, r6.x
        mul r33.xyz, r6.xxxx, r18.xyzx
        dp3 r7.z, r1.xyzx, r33.xyzx
        mov_sat r7.w, r7.z
        movc r7.w, cb0[29].z, |r7.z|, r7.w
        lt r9.z, l(0.000000), r7.w
        if_nz r9.z
          ...
          if_nz r9.w
            ...
            mul r15.z, r29.y, r29.y
            dp3 r15.w, r26.xyzx, r26.xyzx
            div r15.z, r15.z, r15.w
            min r15.z, r15.z, l(1.000000)
            mad_sat r15.w, r9.z, r28.y, r28.z
            mad_sat r19.w, r9.z, r28.w, r29.x
            mul r22.w, r15.w, r15.w
            ...
            mov r40.xy, r31.zwzz
            mov r40.zw, r32.zzzw
            dp4 r26.y, r40.xyzw, r17.xyzw
            div r19.xy, r26.xyxx, r9.zzzz
            lt r9.z, r37.w, l(0.00048828)
            if_nz r9.z
              mov r38.y, r39.x
              mad_sat r26.xy, |r19.xyxx|, r38.zwzz, r38.xyxx
              ...
              mul r9.z, r26.y, r26.x
            else 
              mov r37.w, r38.y
              mul_sat r37.xyzw, |r19.yyxx|, r37.xyzw
              log r37.xyzw, r37.xyzw
              mul r37.xyzw, r37.xyzw, r38.xxxx
              exp r37.xyzw, r37.xyzw
              add r26.xy, r37.zwzz, r37.xyxx
              log r26.xy, r26.xyxx
              mul r26.xy, r26.xyxx, r39.xxxx
              exp r26.xy, r26.xyxx
              mul r15.w, r26.x, r38.z
              mad r19.w, r38.w, r26.y, l(-1.000000)
              mad r15.w, r38.w, r26.y, -r15.w
              div_sat r15.w, r19.w, r15.w
              mul r19.w, r15.w, r15.w
              mad r15.w, r15.w, l(-2.000000), l(3.000000)
              mul r9.z, r15.w, r19.w
            endif 
            mul r9.w, r9.z, r15.z
            and r9.z, r10.w, l(255)
            if_nz r9.z
              ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r26.xyz, r5.y, l(220), t12.xyzx
              dp3 r10.w, r39.yzwy, r19.xyzx
              dp3 r15.z, r26.xyzx, r19.xyzx
              frc r26.x, r10.w
              frc r26.y, r15.z
              iadd r9.z, r9.z, l(-1)
              utof r26.z, r9.z
              sample_l_indexable(texture2darray)(float,float,float,float) r36.xyz, r26.xyzx, t20.xyzw, s2, l(0.000000)
            else 
              mov r36.xyz, l(1.000000,1.000000,1.000000,0)
            endif 
          endif 
          mov r27.w, r26.w
          mul r19.xyw, r27.wxwy, r36.xyxz
          lt r9.z, l(0.000000), r9.w
          if_nz r9.z
            ubfe r15.zw, l(0, 0, 3, 4), l(0, 0, 27, 20), r28.xxxx
            ine r9.z, r15.z, l(1)
            if_nz r9.z
              mad r9.z, |r7.z|, l(-0.200000), l(0.400000)
              lt r10.w, r7.z, l(0.000000)
              and r10.w, r5.z, r10.w
              movc r9.z, r10.w, -r9.z, r9.z
              mad r20.xyz, r1.xyzx, r9.zzzz, v6.xyzx
              mov r33.xy, r32.xyxx
              dp4 r9.z, r33.xyzw, r20.xyzw
              dp4 r10.w, r35.xyzw, r20.xyzw
              ge r15.z, r10.w, r9.z
              if_nz r15.z
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r34.xy, r5.y, l(140), t12.xyxx
                mov r30.zw, r31.xxxy
                dp4 r26.x, r30.xyzw, r20.xyzw
                mov r32.xy, r31.zwzz
                dp4 r26.y, r32.xyzw, r20.xyzw
                div r20.xy, r26.xyxx, r10.wwww
                mad_sat r20.xy, r20.xyxx, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
                mad r20.xy, r20.xyxx, r34.zxzz, r34.wyww
                div r5.y, r9.z, r10.w
                max r5.y, r5.y, l(0.00006104)
                and r9.z, r28.x, l(0x0000ffff)
                if_nz r4.x
                  utof r26.z, r9.z
                  mov r10.w, l(0)
                  mov r15.z, l(0)
                  loop 
                    ige r22.w, r15.z, l(8)
                    breakc_nz r22.w
                    dp2 r27.x, icb[r15.z + 0].xyxx, r10.xyxx
                    dp2 r27.y, icb[r15.z + 0].yxyy, r10.xzxx
                    mad r26.xy, r27.xyxx, r29.zzzz, r20.xyxx
                    sample_c_lz_indexable(texture2darray)(float,float,float,float) r22.w, r26.xyzx, t9.xxxx, s13, r5.y
                    mad r10.w, r22.w, l(0.125000), r10.w
                    iadd r15.z, r15.z, l(1)
                  endloop 
                else 
                  utof r20.z, r9.z
                  sample_c_lz_indexable(texture2darray)(float,float,float,float) r10.w, r20.xyzx, t9.xxxx, s13, r5.y
                endif 
                mul r5.y, r10.w, r10.w
                mul r5.y, r10.w, r5.y
              else 
                mov r5.y, l(1.000000)
              endif 
            ...
            if_nz r15.w
              ...
              mad r15.z, |r7.z|, l(-0.200000), l(0.400000)
              lt r7.z, r7.z, l(0.000000)
              and r7.z, r5.z, r7.z
              movc r7.z, r7.z, -r15.z, r15.z
              mad r21.xyz, r1.xyzx, r7.zzzz, v6.xyzx
              dp4 r20.x, r26.xyzw, r21.xyzw
              dp4 r20.y, r27.xyzw, r21.xyzw
              dp4 r7.z, r28.xyzw, r21.xyzw
              dp4 r15.z, r29.xyzw, r21.xyzw
              lt r15.w, r15.z, r7.z
              div r20.xy, r20.xyxx, r15.zzzz
              ...
              if_z r15.w
                ...
                mad r20.xy, r20.xyxx, r30.xzxx, r30.ywyy
                mul r9.z, r15.z, r21.y
                mad r7.z, r21.x, r15.z, r7.z
                div r7.z, r7.z, r9.z
                max r7.z, r7.z, l(0.00006104)
                and r9.z, r15.w, l(0x0000ffff)
                if_nz r4.x
                  utof r21.z, r9.z
                  ...
                  loop 
                    ige r22.w, r15.w, l(8)
                    breakc_nz r22.w
                    dp2 r26.x, icb[r15.w + 0].xyxx, r22.xyxx
                    dp2 r26.y, icb[r15.w + 0].yxyy, r22.xzxx
                    mad r21.xy, r26.xyxx, r9.wwww, r20.xyxx
                    sample_c_lz_indexable(texture2darray)(float,float,float,float) r21.x, r21.xyzx, t9.xxxx, s13, r7.z
                    mad r15.z, r21.x, l(0.125000), r15.z
                    iadd r15.w, r15.w, l(1)
                  endloop 
                else 
                  utof r20.z, r9.z
                  sample_c_lz_indexable(texture2darray)(float,float,float,float) r15.z, r20.xyzx, t9.xxxx, s13, r7.z
                endif 
                mul r7.z, r15.z, r15.z
                mul r7.z, r15.z, r7.z
              else 
                mov r7.z, l(1.000000)
              endif 
            ...
            lt r7.z, l(0.000000), r5.y
            if_nz r7.z
              mul r19.xyw, r19.xyxw, r5.yyyy
              add r5.y, r7.w, r7.y
              div r5.y, r7.w, r5.y
              mad r16.xyz, r19.xywx, r5.yyyy, r16.xyzx
              mad r18.xyz, r18.xyzx, r6.xxxx, r6.yzwy
              dp3 r5.y, r18.xyzx, r18.xyzx
              rsq r5.y, r5.y
              mul r18.xyz, r5.yyyy, r18.xyzx
              dp3_sat r5.y, r1.xyzx, r18.xyzx
              dp3_sat r6.x, r18.xyzx, r6.yzwy
              mul r7.z, r5.y, r5.y
              mad r9.zw, r7.zzzz, cb0[15].xxxz, l(0.000000, 0.000000, 1.000000, 1.000000)
              mul r9.zw, r9.zzzw, r9.zzzw
              div r9.zw, cb0[15].yyyw, r9.zzzw
              mul r9.zw, r5.yyyy, r9.zzzw
              mul r5.y, r6.x, l(4.000000)
              div r9.zw, r9.zzzw, r5.yyyy
              mul r9.zw, r9.zzzw, cb0[16].xxxy
              mul r18.xyz, r9.zzzz, r19.xywx
              mad r18.xyz, r18.xyzx, r7.wwww, r25.xyzx
              mul r19.xyw, r9.wwww, r19.xyxw
              mad r25.xyz, r19.xywx, r7.wwww, r18.xyzx
            endif 
          endif 
        endif 
        break 
...
mul r1.w, r6.w, r7.w
mad r6.xyz, r6.xyzx, r23.xyzx, -r4.xywx
...
mov o0.w, l(1.000000)
ret 
// Approximately 2340 instruction slots used
