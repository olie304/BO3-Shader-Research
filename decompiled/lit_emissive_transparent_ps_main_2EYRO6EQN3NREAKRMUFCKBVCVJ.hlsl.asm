...
sample_indexable(texture2d)(float,float,float,float) r3.x, v1.yzyy, t25.xyzw, s3
...
mul r8.xyz, r3.wwww, r7.xyzx
mad r8.xyz, r6.xyzx, r3.zzzz, r8.xyzx
mad r8.xyz, r5.xyzx, r4.xxxx, r8.xyzx
...
if_nz r3.z
  ftoi r3.z, cb1[64].w
  lod r3.w, v1.yzyy, t21.y, s1
  lod r4.x, v1.yzyy, t21.x, s1
  lt r3.w, r3.w, r4.x
  lt r4.x, l(0.000000), r4.x
  and r9.xyz, r3.zzzz, l(1, 2, 4, 0)
  movc r10.xyz, r9.xxxx, l(1.000000,0,1.000000,0), r1.xyzx
  movc r9.xyw, r9.yyyy, l(0,1.000000,0,1.000000), r1.xyxz
  movc r4.xyw, r4.xxxx, r10.xyxz, r9.xyxw
  movc r9.xyz, r9.zzzz, l(0,1.000000,0,0), r1.xyzx
  movc r1.xyz, r3.wwww, r4.xywx, r9.xyzx
endif 
add r4.xyw, -r1.xyxz, cb1[58].xyxz
mad r1.xyz, cb1[58].wwww, r4.xywx, r1.xyzx
mad r1.w, -r1.w, v1.x, cb1[59].x
mad r0.w, cb1[59].w, r1.w, r0.w
add r4.xyw, -r2.yzyw, cb1[61].xyxz
mad r2.yzw, cb1[61].wwww, r4.xxyw, r2.yyzw
add r1.w, -r3.x, r3.y
mad r1.w, cb1[62].w, r1.w, r3.x
add r3.x, -r2.x, cb1[63].x
mad r2.x, cb1[63].w, r3.x, r2.x
movc r3.xyz, v7.xxxx, v3.xyzx, -v3.xyzx
dp3 r3.w, r3.xyzx, r3.xyzx
rsq r3.w, r3.w
mad r3.xyz, r3.xyzx, r3.wwww, -r8.xyzx
mad r3.xyz, cb1[60].wwww, r3.xyzx, r8.xyzx
          ...
          if_nz r13.z
            ...
            if_nz r13.z
              ...
              if_nz r22.y
                ...
                mul r24.xyz, r4.zzzz, r25.xyzx
                mul r22.xyz, r4.zzzz, r22.xyzx
                mul r23.xyz, r4.zzzz, r23.xyzx
          ...
          if_nz r16.w
            ...
            if_nz r16.w
              ...
              if_nz r25.y
                ...
                mul r27.xyz, r4.zzzz, r28.xyzx
                mul r25.xyz, r4.zzzz, r25.xyzx
                mul r26.xyz, r4.zzzz, r26.xyzx
...
div r4.zw, -r5.xxxy, r1.wwww
and r4.zw, r3.zzzz, r4.zzzw
add r3.z, cb0[14].z, l(0.000010)
mad r4.zw, r4.zzzw, r3.zzzz, v1.yyyz
sample_indexable(texture2d)(float,float,float,float) r5.xyzw, r4.zwzz, t29.xyzw, s1
...
utof r4.zw, r4.yyyx
dp2 r0.y, r4.wzww, l(0.06711056, 0.00583715, 0.000000, 0.000000)
frc r0.y, r0.y
mul r0.y, r0.y, l(52.982918)
frc r0.y, r0.y
mad r0.y, r0.y, l(6.28318548), cb1[70].w
sincos r6.x, r7.x, r0.y
dp2 r0.y, r4.zwzz, l(0.06711056, 0.00583715, 0.000000, 0.000000)
frc r0.y, r0.y
mul r0.y, r0.y, l(52.982918)
frc r0.y, r0.y
mad r0.y, r0.y, l(6.28318548), cb1[70].w
...
loop 
  ...
  dp3 r29.x, r8.xyzx, r22.xyzx
  dp3 r29.y, r8.xyzx, r30.xyzx
  dp3 r29.z, r8.xyzx, r24.xyzx
    ...
    if_nz r16.x
      ...
      if_nz r9.w
        ...
        loop 
          ...
          movc r4.y, r18.w, r16.w, r19.z
          movc r30.xy, r18.zzzz, r30.xyxx, r4.xyxx
        ...
        if_nz r15.z
          ...
          mul r16.x, r6.z, r15.z
          mul r30.xzw, r4.yyyy, r23.xxyz
          dp3 r4.y, r30.xzwx, l(0.212600, 0.715200, 0.072200, 0.000000)
          mad r4.y, r6.z, r15.z, r4.y
          div r4.y, r16.x, r4.y
          mov r33.x, r29.w
          mov r33.yz, r28.yyzy
...
if_z r3.w
  ...
  rcp r3.z, r3.z
  mov_sat r24.w, r24.w
  mul r20.xyz, r3.zzzz, r23.xyzx
  mul r21.xyz, r3.zzzz, r24.xyzx
  ...
  if_nz r3.w
    ...
    mad r4.xyw, r9.yzyw, r4.wwww, r11.yzyw
    mov r8.w, l(0)
    sample_l_indexable(texturecubearray)(float,float,float,float) r9.yzw, r8.xyzw, t8.wxyz, s2, l(6.000000)
    mul r4.xyw, r4.xyxw, r9.yzyw
    dp3 r6.z, r4.xywx, l(0.212600, 0.715200, 0.072200, 0.000000)
    mad r20.xyz, r23.xyzx, r3.zzzz, r4.xywx
    mov r12.w, l(0)
    sample_l_indexable(texturecubearray)(float,float,float,float) r4.xyz, r12.xyzw, t8.xyzw, s2, r4.z
    mad r3.z, cb2[19].x, r3.w, -r6.z
    mad r3.z, r3.y, r3.z, r6.z
    mad r21.xyz, r4.xyzx, r3.zzzz, r21.xyzx
  endif 
else 
  mov r21.x, r20.w
endif 
...
ret 
// Approximately 2949 instruction slots used
