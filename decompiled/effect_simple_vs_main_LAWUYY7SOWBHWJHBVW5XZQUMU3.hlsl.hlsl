...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  r5.xy = floor(r4.zy);
  r3.w = r5.y * outdoorSSTConstants.constants.dimensionInTiles.x + r5.x;
  r3.w = (uint)r3.w;
// Known bad code for instruction (needs manual fix):
...
r4.w = samp0[]..swiz;
  ...
  r7.w = samp0[]..swiz;
    ...
    r7.z = samp0[]..swiz;
      ...
      r4.w = (int)-r7.y + 6;
      r5.yw = (uint2)r4.zy >> (uint2)r4.ww;
      r4.w = (int)r7.z & 0xc0000000;
      r6.y = (int)r7.z | 0x40000000;
      bitmask.w = ((~(-1 << 1)) << 1) & 0xffffffff;  r5.w = (((uint)r5.w << 1) & bitmask.w) | ((uint)0 & ~bitmask.w);
      bitmask.y = ((~(-1 << 1)) << 0) & 0xffffffff;  r5.y = (((uint)r5.y << 0) & bitmask.y) | ((uint)r5.w & ~bitmask.y);
      r5.y = (int)r5.y * 10;
    ...
    r8.y = samp0[]..swiz;
      r5.yw = r4.ww ? r7.xz : r8.xy;
      r5.xz = r3.ww ? r6.xw : r5.yw;
    }
    r3.w = (int)r5.z & 0xc0000000;
    if (r3.w == 0) {
      if (14 == 0) r4.w = 0; else if (14+15 < 32) {       r4.w = (uint)r5.z << (32-(14 + 15)); r4.w = (uint)r4.w >> (32-14);      } else r4.w = (uint)r5.z >> 15;
      r4.w = (uint)r4.w;
    ...
    r6.x = samp0[]..swiz;
      bitmask.y = ((~(-1 << 2)) << 3) & 0xffffffff;  r6.y = (((uint)r4.x << 3) & bitmask.y) | ((uint)0 & ~bitmask.y);
      bitmask.z = ((~(-1 << 2)) << 1) & 0xffffffff;  r6.z = (((uint)r4.y << 1) & bitmask.z) | ((uint)0 & ~bitmask.z);
      bitmask.w = ((~(-1 << 1)) << 4) & 0xffffffff;  r6.w = (((uint)r4.z << 4) & bitmask.w) | ((uint)0 & ~bitmask.w);
      r4.x = (uint)r6.x >> (uint)r6.y;
      r4.x = (int)r4.x & 255;
      r4.x = (uint)r4.x;
      r4.x = r4.x * r5.y;
  ...
  r3.x = dot(r3.xyz, pinToWorldZ.xyz);
  r3.x = pinToWorldZ.w + r3.x;
  r3.x = saturate(v0.z + -r3.x);
  o1.w = r3.x * r2.w;
  o0.xyzw = r1.xyzw;
  o5.xyz = r2.xyz;
  r0.w = 0;
