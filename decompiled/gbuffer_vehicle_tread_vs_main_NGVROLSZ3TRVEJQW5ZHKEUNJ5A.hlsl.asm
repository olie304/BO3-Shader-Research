...
dp3 r3.z, r0.xyzx, r7.xyzx
dp3 r1.w, r3.xyzx, r3.xyzx
rsq r1.w, r1.w
mul r3.xyz, r1.wwww, r3.xyzx
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) r4.xy, r2.y, l(16), t0.xyxx
ne r1.w, cb0[15].y, l(0.000000)
movc r1.w, r1.w, r4.y, r4.x
mad r4.xy, r1.wwww, cb0[12].xyxx, v2.xyxx
sample_l_indexable(texture2d)(float,float,float,float) r1.w, r4.xyxx, t6.yzwx, s1, l(0.000000)
mul r1.w, r1.w, cb0[15].x
mad r3.xyz, r3.xyzx, r1.wwww, r8.xyzx
mul r5.xyzw, r3.yyyy, cb1[9].xyzw
mad r5.xyzw, r3.xxxx, cb1[8].xyzw, r5.xyzw
mad r5.xyzw, r3.zzzz, cb1[10].xyzw, r5.xyzw
add o0.xyzw, r5.xyzw, cb1[11].xyzw
resinfo_indexable(texture2d)(float,float,float,float)_uint r4.zw, l(0), t6.zwxy
utof r4.zw, r4.zzzw
div r4.zw, l(1.000000, 1.000000, 1.000000, 1.000000), r4.zzzw
add r5.xy, -r4.zwzz, r4.xyxx
sample_l_indexable(texture2d)(float,float,float,float) r1.w, r5.xyxx, t6.yzwx, s1, l(0.000000)
mad r5.xyzw, r4.zwzw, l(-1.000000, 0.000000, -1.000000, 1.000000), r4.xyxy
sample_l_indexable(texture2d)(float,float,float,float) r2.y, r5.xyxx, t6.yxzw, s1, l(0.000000)
sample_l_indexable(texture2d)(float,float,float,float) r3.w, r5.zwzz, t6.yzwx, s1, l(0.000000)
mad r5.xyzw, r4.zwzw, l(0.000000, -1.000000, 0.000000, 1.000000), r4.xyxy
sample_l_indexable(texture2d)(float,float,float,float) r5.x, r5.xyxx, t6.xyzw, s1, l(0.000000)
sample_l_indexable(texture2d)(float,float,float,float) r5.y, r5.zwzz, t6.yxzw, s1, l(0.000000)
mad r6.xyzw, r4.zwzw, l(1.000000, -1.000000, 1.000000, 0.000000), r4.xyxy
sample_l_indexable(texture2d)(float,float,float,float) r5.z, r6.xyxx, t6.yzxw, s1, l(0.000000)
sample_l_indexable(texture2d)(float,float,float,float) r5.w, r6.zwzz, t6.yzwx, s1, l(0.000000)
add r4.zw, r4.zzzw, r4.xxxy
sample_l_indexable(texture2d)(float,float,float,float) r4.z, r4.zwzz, t6.yzxw, s1, l(0.000000)
mad r4.w, |r5.w|, l(2.000000), |r5.z|
add r4.w, |r4.z|, r4.w
add r4.w, -|r1.w|, r4.w
mad r2.y, -|r2.y|, l(2.000000), r4.w
add r2.y, -|r3.w|, r2.y
mad r3.w, |r5.y|, l(2.000000), |r3.w|
add r3.w, |r4.z|, r3.w
add r1.w, -|r1.w|, r3.w
mad r1.w, -|r5.x|, l(2.000000), r1.w
add r1.w, -|r5.z|, r1.w
mov r5.x, -r2.y
mov r5.y, -r1.w
max r1.w, cb0[15].x, l(0.000100)
div r5.z, l(1.000000, 1.000000, 1.000000, 1.000000), r1.w
dp3 r1.w, r5.xyzx, r5.xyzx
rsq r1.w, r1.w
mul r5.xyz, r1.wwww, r5.xyzx
mul r2.xyz, r2.xzwx, r5.yyyy
mad r1.xyz, r5.xxxx, r1.xyzx, r2.xyzx
mad r0.xyz, r5.zzzz, r0.xyzx, r1.xyzx
dp3 r1.x, r0.xyzx, r0.xyzx
rsq r1.x, r1.x
mul r0.xyz, r0.xyzx, r1.xxxx
lt r1.x, l(0.800000), r0.x
lt r1.y, r0.x, l(-0.800000)
or r1.x, r1.y, r1.x
movc r1.xyz, r1.xxxx, l(1.000000,0,0,0), l(0,0,1.000000,0)
mul r2.xyz, r0.zxyz, r1.xyzx
mad r1.xyz, r0.yzxy, r1.yzxy, -r2.xyzx
