...
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, v1.yzyy, t30.xyzw, s1
mul r6.xyz, r2.xyzx, cb0[10].xyzx
...
exp r5.z, r5.z
mul r5.w, r2.w, r5.z
mul r2.xyz, r5.wwww, r6.xyzx
ge r5.w, v0.z, l(0.984375)
mul r6.x, v0.z, l(1.01587307)
mad r6.y, v0.z, l(64.000000), l(-63.000000)
...
dp3_sat r5.x, r1.xyzx, r7.xyzx
dp3 r6.w, -r7.xyzx, r1.xyzx
add r6.w, r6.w, r6.w
mad r12.xyz, r1.xyzx, -r6.wwww, -r7.xyzx
mul r6.w, r5.y, l(17.000000)
exp r6.w, r6.w
...
mul r8.y, r8.y, r8.y
mul r8.z, r8.y, l(0.500000)
mad r8.y, -r8.y, l(0.500000), l(1.000000)
mad r8.w, r5.x, r8.y, r8.z
mul r8.yz, r8.wwww, r8.yyzy
dp3 r8.w, r1.xyzx, cb2[17].xyzx
mov_sat r9.z, r8.w
ge r9.w, l(0.000000), r9.z
if_nz r9.w
  mov r10.w, l(0)
endif 
if_z r9.w
  ...
  if_z r13.z
    if_z cb2[58].y
      ...
      sample_c_lz_indexable(texture2darray)(float,float,float,float) r11.w, r14.xyzx, t13.xxxx, s13, r9.w
    ...
    if_nz cb2[58].y
      ...
      loop 
        ...
        utof r16.z, r15.y
        sample_c_lz_indexable(texture2darray)(float,float,float,float) r15.y, r16.xyzx, t13.xxxx, s13, r9.w
...
if_nz r9.w
  ...
  if_nz r9.w
    ...
    mad r13.x, -r9.z, r13.x, l(1.000000)
    mul r13.x, r13.x, r13.x
    mad r13.x, -r13.x, l(0.620000), l(0.620000)
    add r13.x, -r9.z, r13.x
    mad r13.x, r7.w, r13.x, r9.z
    ...
    mad r14.y, |r14.x|, r6.w, -|r14.x|
    mad r14.x, |r14.x|, r14.y, l(1.000000)
    mad r9.z, r9.z, r8.y, r8.z
    ...
    mov r13.w, r15.z
    and r13.xyzw, r8.wwww, r13.xyzw
    mov r15.zw, r14.xxxy
    and r15.xyzw, r8.wwww, r15.xyzw
    and r4.w, r8.w, r14.z
  else 
...
mul r8.w, r5.w, l(0.00781250)
min r8.w, r8.w, l(15.000000)
ftou r8.w, r8.w
ushr r14.xy, r6.xyxx, l(6, 6, 0, 0)
ishl r14.z, r8.w, l(4)
mov r16.x, -r9.x
not r6.x, r6.z
mad r6.y, -r5.x, l(0.500000), l(1.000000)
          ...
          if_nz r30.w
            ...
            if_nz r30.w
              ...
              if_nz r30.w
                  ...
                  if_z r20.y
                    ...
                    if_nz r10.w
                      ...
                      loop 
                        ...
                        dp2 r44.y, icb[r22.w + 0].xyxx, r9.xyxx
                ...
                mad r20.x, -r29.w, r6.y, l(1.000000)
                ...
                mad r40.xyz, r40.xyzx, r17.wwww, r7.xyzx
                dp3 r17.w, r40.xyzx, r40.xyzx
                rsq r17.w, r17.w
                mul r40.xyz, r17.wwww, r40.xyzx
                dp3 r17.w, r40.xyzx, r7.xyzx
                dp3 r21.x, r1.xyzx, r40.xyzx
                mad r21.z, |r21.x|, r6.w, -|r21.x|
                mad r21.x, |r21.x|, r21.z, l(1.000000)
                mad r21.z, r20.x, r8.y, r8.z
          ...
          if_nz r21.x
            ...
            if_nz r21.x
              ...
              if_nz r21.x
                ...
                mad r21.z, -r20.y, r6.y, l(1.000000)
                ...
                mad r33.xyz, r40.xyzx, r17.wwww, r7.xyzx
                dp3 r17.w, r33.xyzx, r33.xyzx
                rsq r17.w, r17.w
                mul r33.xyz, r17.wwww, r33.xyzx
                dp3 r17.w, r33.xyzx, r7.xyzx
                dp3 r21.z, r1.xyzx, r33.xyzx
                mad r23.x, |r21.z|, r6.w, -|r21.z|
                mad r21.z, |r21.z|, r23.x, l(1.000000)
                mad r20.y, r20.y, r8.y, r8.z
                mul r21.z, r21.z, r21.z
...
loop 
  ...
  dp3 r10.w, r35.xyzx, r34.xyzx
  add_sat r10.w, r35.w, r10.w
  dp3 r11.x, r36.xyzx, r34.xyzx
  add_sat r11.x, r36.w, r11.x
  mul r10.w, r10.w, r11.x
  dp3 r11.x, r37.xyzx, r34.xyzx
  add_sat r11.x, r37.w, r11.x
  mul r10.w, r10.w, r11.x
  dp3 r11.x, r38.xyzx, r34.xyzx
  add_sat r11.x, r38.w, r11.x
  mul r10.w, r10.w, r11.x
  dp3 r11.x, r39.xyzx, r34.xyzx
  add_sat r11.x, r39.w, r11.x
  mul r10.w, r10.w, r11.x
  dp3 r11.x, r40.xyzx, r34.xyzx
  add_sat r11.x, r40.w, r11.x
  mul r9.x, r10.w, r11.x
  and r10.w, r8.x, l(1)
  movc r16.zw, r10.wwww, r9.xxxy, r9.zzzx
  mov r35.xy, r25.zwzz
  mov r35.z, r26.z
  ...
  dp3 r11.x, r34.xyzx, r26.xyzx
  add r11.x, -r27.w, r11.x
  ...
  dp3 r11.x, r34.xyzx, r27.xyzx
  add r11.x, -r28.w, r11.x
  ge r13.w, r11.x, l(0.000000)
  max r11.x, r6.y, |r11.x|
  movc r11.x, r13.w, r11.x, -r11.x
  max r10.w, -r10.w, l(0.00000010)
  ...
  dp3 r11.x, r34.xyzx, r28.xyzx
  add r11.x, -r31.w, r11.x
  ge r13.w, r11.x, l(0.000000)
  max r11.x, r6.y, |r11.x|
  movc r11.x, r13.w, r11.x, -r11.x
  max r10.w, -r10.w, l(0.00000010)
  ...
  dp3 r11.x, r34.xyzx, r31.xyzx
  add r11.x, -r32.y, r11.x
  ge r13.w, r11.x, l(0.000000)
  max r11.x, r6.y, |r11.x|
  movc r11.x, r13.w, r11.x, -r11.x
  max r10.w, -r10.w, l(0.00000010)
  ...
  min r9.x, r9.x, |r10.w|
  mov r33.zw, r32.zzzw
  dp3 r10.w, r12.zxyz, r33.xzwx
  dp3 r11.x, r34.zxyz, r33.xzwx
  add r11.x, -r33.y, r11.x
  ge r13.w, r11.x, l(0.000000)
  max r11.x, r6.y, |r11.x|
  movc r11.x, r13.w, r11.x, -r11.x
  max r10.w, -r10.w, l(0.00000010)
  ...
  movc r10.z, r19.x, l(0), l(0.500000)
  ...
  loop 
    ...
    if_nz r11.x
      ...
      if_nz r8.z
        ...
        mov r11.x, l(1)
        loop 
          ige r13.z, r11.x, r20.x
          breakc_nz r13.z
          iadd r13.z, r9.w, r11.x
        ...
        endloop 
        mov_sat r27.y, r27.y
        mul r10.w, r8.y, r27.y
        lt r11.x, l(0.000000), r10.w
        if_nz r11.x
          mad r28.z, r27.y, r8.y, r25.w
          mul r10.w, r25.x, r10.w
          mul r27.xzw, r10.wwww, r23.xxyz
          ...
          dp3 r11.x, r31.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
          mad r31.xyz, r27.xzwx, r24.xyzx, r26.xyzx
          mul r13.z, r6.z, r11.x
          mul r27.xzw, r10.wwww, r20.yyzw
          dp3 r10.w, r27.xzwx, l(0.212600, 0.715200, 0.072200, 0.000000)
          mad r10.w, r6.z, r11.x, r10.w
          div r10.w, r13.z, r10.w
          mov r32.x, r26.w
          mov r32.yz, r25.yyzy
          mad r28.xyw, r27.zwzx, r10.wwww, r32.yzyx
          mov r31.w, r28.w
        else 
...
if_z r6.w
  ...
  loop 
    ...
    loop 
      ...
      ishl r10.w, l(1), r9.z
      and r11.x, r9.y, r10.w
      if_nz r11.x
        xor r9.y, r9.y, r10.w
        iadd r10.w, r9.z, r9.x
        ...
        and r10.w, r24.y, r24.x
        and r10.w, r24.z, r10.w
        if_nz r10.w
          iadd r9.z, r8.w, r9.z
          ...
          and r13.w, r15.z, l(1)
          movc r27.xy, r13.wwww, r10.xyxx, r10.zxzz
          mov r10.x, r15.z
          mov r28.xy, r27.xyxx
          mov r13.w, l(1)
          loop 
            ige r14.w, r13.w, r11.x
            breakc_nz r14.w
            ...
            ushr r19.w, r10.x, l(2)
            ubfe r24.w, l(1), l(2), r10.x
            and r26.w, r19.w, l(2)
          ...
          if_nz r10.w
            ...
            dp3 r11.x, r26.xyzx, r36.xyzx
            add r11.x, -r37.w, r11.x
            ge r13.w, r11.x, l(0.000000)
            max r11.x, r6.y, |r11.x|
            movc r11.x, r13.w, r11.x, -r11.x
            max r10.w, -r10.w, l(0.00000010)
            ...
            min r10.x, |r10.w|, r10.x
            mov r37.z, r38.z
            dp3 r10.w, r12.xyzx, r37.xyzx
            dp3 r11.x, r26.xyzx, r37.xyzx
            add r11.x, -r38.w, r11.x
            ge r13.w, r11.x, l(0.000000)
            max r11.x, r6.y, |r11.x|
            movc r11.x, r13.w, r11.x, -r11.x
            max r10.w, -r10.w, l(0.00000010)
            ...
            min r10.x, |r10.w|, r10.x
            mov r38.z, r39.x
            dp3 r10.w, r12.xyzx, r38.xyzx
            dp3 r11.x, r26.xyzx, r38.xyzx
            add r11.x, -r39.y, r11.x
            ge r13.w, r11.x, l(0.000000)
            max r11.x, r6.y, |r11.x|
            movc r11.x, r13.w, r11.x, -r11.x
            max r10.w, -r10.w, l(0.00000010)
            ...
            min r10.x, |r10.w|, r10.x
            mov r40.zw, r39.zzzw
            dp3 r10.w, r12.zxyz, r40.xzwx
            dp3 r11.x, r26.zxyz, r40.xzwx
            add r11.x, -r40.y, r11.x
            ge r13.w, r11.x, l(0.000000)
            max r11.x, r6.y, |r11.x|
            movc r11.x, r13.w, r11.x, -r11.x
            max r10.w, -r10.w, l(0.00000010)
  ...
  if_nz r7.z
    ...
    loop 
      ...
      loop 
        breakc_z r11.x
        firstbit_lo r13.w, r11.x
        ishl r14.w, l(1), r13.w
        and r15.z, r11.x, r14.w
        if_nz r15.z
          xor r11.x, r11.x, r14.w
          ...
          if_nz r14.w
            ...
            mul r10.x, r18.w, r19.w
            and r18.w, r15.z, l(1)
            movc r28.xy, r18.wwww, r10.xyxx, r10.zxzz
            mov r10.x, r15.z
            mov r31.xy, r28.xyxx
            mov r18.w, l(1)
            loop 
              ...
              ushr r25.w, r10.x, l(2)
              ubfe r27.w, l(1), l(2), r10.x
              and r28.z, r25.w, l(2)
              ...
              mov r10.x, r25.w
            endloop 
            add_sat r10.x, -r10.w, r31.y
            mul r14.w, r15.w, r10.x
            ...
            if_nz r15.y
              ...
              mad r24.w, r10.x, r15.w, r24.w
              mul r10.x, r26.z, r14.w
              mov r26.z, r36.z
              ...
              mul r15.yzw, r10.xxxx, r15.yyzw
              dp3 r10.x, r15.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
              mad r10.x, r6.z, r13.z, r10.x
              div r10.x, r13.w, r10.x
              mad r24.xyz, r15.yzwy, r10.xxxx, r24.xyzx
            endif 
          endif 
        endif 
      endloop 
...
mad r6.xyz, r17.xyzx, r0.wwww, r11.yzwy
...
ftoi r4.xy, v0.xyxx
mov r4.zw, l(0,0,0,0)
ld_indexable(texture2d)(float,float,float,float) r0.w, r4.xyzw, t0.yzwx
...
if_nz r1.z
  sample_indexable(texture2d)(float,float,float,float) r1.z, v1.yzyy, t38.xywz, s1
  sample_indexable(texture2d)(float,float,float,float) r4.xyzw, v1.yzyy, t46.xyzw, s1
...
mul r0.w, r2.w, r0.w
sample_indexable(texture2d)(float,float,float,float) r1.z, v7.xyxx, t37.yzxw, s1
mad r1.xy, r1.xyxx, cb0[16].zzzz, v0.xyxx
mul r1.xy, r1.xyxx, cb1[44].zwzz
sample_indexable(texture2d)(float,float,float,float) r1.xyw, r1.xyxx, t29.xywz, s1
