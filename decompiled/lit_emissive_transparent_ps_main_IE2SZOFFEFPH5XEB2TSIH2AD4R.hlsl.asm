...
mad r0.y, r0.y, r0.w, r6.w
mad r4.xyz, r4.xyzx, r0.wwww, r14.xyzx
mov_sat r5.x, r5.x
mul r1.w, r5.x, cb0[18].x
eq r6.xyz, r5.yyyy, l(3.000000, 2.000000, 1.000000, 0.000000)
lt r3.x, r5.y, l(0.000000)
movc r7.xyz, r3.xxxx, l(1.000000,1.000000,1.000000,0), cb0[19].xyzx
movc r7.xyz, r6.zzzz, cb0[22].xyzx, r7.xyzx
movc r6.yzw, r6.yyyy, cb0[23].xxyz, r7.xxyz
movc r6.xyz, r6.xxxx, cb0[24].xyzx, r6.yzwy
lt r3.x, l(0.500000), cb0[20].y
if_nz r3.x
  mul r3.x, cb0[11].w, cb0[11].z
  mul r4.w, r3.x, cb0[12].x
  mul r5.x, r4.w, cb1[69].w
  ge r5.x, r5.x, -r5.x
  movc r5.x, r5.x, r4.w, -r4.w
  div r5.y, l(1.000000, 1.000000, 1.000000, 1.000000), r5.x
  mul r5.y, r5.y, cb1[69].w
  frc r5.y, r5.y
  mul r5.x, r5.y, r5.x
  div r4.w, r5.x, r4.w
  mul r3.x, r3.x, r4.w
  ...
  mul r5.x, r3.x, cb0[11].w
  ge r5.x, r5.x, -r5.x
  movc r5.x, r5.x, cb0[11].w, -cb0[11].w
  div r5.y, l(1.000000, 1.000000, 1.000000, 1.000000), r5.x
  mul r3.x, r3.x, r5.y
  frc r3.x, r3.x
  mul r3.x, r3.x, r5.x
  round_z r3.x, r3.x
  add r3.x, r3.x, v2.x
  div r5.x, r3.x, cb0[11].w
  round_z r3.x, r4.w
  add r3.x, r3.x, v2.y
  div r5.y, r3.x, cb0[11].z
else 
  dp3 r3.x, -v7.xyzx, -v7.xyzx
  rsq r3.x, r3.x
  mul r7.xyz, r3.xxxx, -v7.xyzx
  dp3 r10.x, r7.xyzx, v5.xyzx
  dp3 r10.y, r7.xyzx, v6.xyzx
  dp3 r3.x, r7.xyzx, v4.xyzx
  lt r4.w, l(0.000000), r3.x
  div r7.xy, -r10.xyxx, r3.xxxx
  and r7.xy, r4.wwww, r7.xyxx
  add r7.zw, v2.xxxy, l(0.000000, 0.000000, -0.500000, -0.500000)
  add r3.x, cb0[15].y, l(0.000010)
  mul r7.xy, r3.xxxx, r7.xyxx
  mul r7.xy, r7.xyxx, cb0[13].zwzz
  mad r7.xy, r7.zwzz, cb0[13].zwzz, r7.xyxx
  mad r7.xy, cb0[14].xyxx, cb0[13].zwzz, r7.xyxx
  ...
  mov r10.y, r10.x
  mov r10.z, r3.x
  dp2 r11.x, r10.yzyy, r7.xyxx
  mov r10.x, -r3.x
  dp2 r11.y, r10.xyxx, r7.xyxx
  mul r7.xy, cb0[13].xyxx, cb1[69].wwww
  mad r7.xy, r7.xyxx, cb0[13].zwzz, r11.xyxx
  ...
  div r7.xy, r7.xyxx, r3.xxxx
  add r7.xy, r7.xyxx, l(0.500000, 0.500000, 0.000000, 0.000000)
  mov_sat r7.zw, r7.xxxy
  movc r5.xy, cb0[15].zwzz, r7.zwzz, r7.xyxx
endif 
dp3 r3.x, -v7.xyzx, -v7.xyzx
rsq r3.x, r3.x
mul r7.xyz, r3.xxxx, -v7.xyzx
dp3_sat r3.y, r7.xyzx, r3.yzwy
sample_indexable(texture2d)(float,float,float,float) r10.xyzw, r5.xyxx, t26.xyzw, s1
...
frc r0.w, r0.w
mad r5.y, cb1[69].w, cb0[16].z, r0.w
mov r5.x, cb0[16].x
sample_l_indexable(texture2d)(float,float,float,float) r0.w, r5.xyxx, t25.yzwx, s5, l(0.000000)
log r0.w, |r0.w|
...
add r1.w, r1.w, r1.w
mad r12.xyz, r2.xyzx, -r1.wwww, -r7.xyzx
mul r1.w, r0.y, l(17.000000)
exp r1.w, r1.w
...
if_z r6.w
  ...
  if_nz r5.w
    ...
    mad r20.xyz, r22.xyzx, r5.yyyy, r11.yzwy
    mov r12.w, l(0)
    ...
    mad r21.xyz, r11.yzwy, r2.wwww, r21.xyzx
  endif 
else 
  mov r21.x, r20.w
endif 
...
if_nz r6.w
  ...
  if_nz r6.w
    ...
    add r8.w, -r6.z, r8.w
    mad r8.w, r4.w, r8.w, r6.z
    mul r8.w, r7.w, r8.w
    lt r2.w, l(0.000000), r2.w
    mad r15.xyz, r8.wwww, r8.xyzx, r13.xyzx
    mad r11.yzw, -v7.xxyz, r3.xxxx, cb2[17].xxyz
    dp3 r3.x, r11.yzwy, r11.yzwy
    rsq r3.x, r3.x
    mul r11.yzw, r3.xxxx, r11.yyzw
    dp3 r3.x, r11.yzwy, r7.xyzx
    dp3 r8.w, r2.xyzx, r11.yzwy
    mad r9.w, |r8.w|, r1.w, -|r8.w|
    mad r8.w, |r8.w|, r9.w, l(1.000000)
    mad r6.z, r6.z, r0.y, r0.z
    mul r8.w, r8.w, r8.w
    mul r6.z, r6.z, r8.w
    rcp r6.z, r6.z
    mul r6.z, r6.w, r6.z
    ...
    mad r11.yzw, r6.zzzz, r8.xxyz, r5.yyzw
    add_sat r3.x, -r3.x, l(1.000000)
    mul r6.w, r3.x, r3.x
    mul r6.w, r6.w, r6.w
    mul r3.x, r3.x, r6.w
    mul r3.x, r3.x, r6.z
    mad r8.xyz, r3.xxxx, r8.yzxy, r14.xyzx
    mov r15.w, r8.z
    mov r13.w, r14.z
          ...
          if_nz r15.z
            ...
            if_nz r15.z
              ...
              if_nz r15.z
                ...
                mad r19.xyz, r19.xyzx, r12.wwww, r7.xyzx
                dp3 r12.w, r19.xyzx, r19.xyzx
                rsq r12.w, r12.w
                mul r19.xyz, r12.wwww, r19.xyzx
                dp3 r12.w, r19.xyzx, r7.xyzx
...
ret 
// Approximately 2655 instruction slots used
