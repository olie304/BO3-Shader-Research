...
r0.y = samplerLinear[]..swiz;
  ...
  if (r6.w != 0) {
    ...
    r15.yzw = -refProbeConstantsCB[r6.w].data[0].xyz + r5.xyz;
    ...
    while (true) {
      ...
      r12.w = (int)r12.w * 6;
      r14.w = dot(refProbeAttenuationConstantsCB[r12.w].data[0].xyz, r15.yzw);
      r14.w = saturate(refProbeAttenuationConstantsCB[r12.w].data[0].w + r14.w);
      r14.w = r19.x * r14.w;
      r16.y = dot(refProbeAttenuationConstantsCB[r12.w].data[1].xyz, r15.yzw);
      r16.y = saturate(refProbeAttenuationConstantsCB[r12.w].data[1].w + r16.y);
      r14.w = r16.y * r14.w;
      r16.y = dot(refProbeAttenuationConstantsCB[r12.w].data[2].xyz, r15.yzw);
      r16.y = saturate(refProbeAttenuationConstantsCB[r12.w].data[2].w + r16.y);
      r14.w = r16.y * r14.w;
      r16.y = dot(refProbeAttenuationConstantsCB[r12.w].data[3].xyz, r15.yzw);
      r16.y = saturate(refProbeAttenuationConstantsCB[r12.w].data[3].w + r16.y);
      r14.w = r16.y * r14.w;
      r16.y = dot(refProbeAttenuationConstantsCB[r12.w].data[4].xyz, r15.yzw);
      r16.y = saturate(refProbeAttenuationConstantsCB[r12.w].data[4].w + r16.y);
      r14.w = r16.y * r14.w;
      r16.y = dot(refProbeAttenuationConstantsCB[r12.w].data[5].xyz, r15.yzw);
      r12.w = saturate(refProbeAttenuationConstantsCB[r12.w].data[5].w + r16.y);
      r19.x = r14.w * r12.w;
      r16.y = (uint)r9.w >> 2;
      if (1 == 0) r16.z = 0; else if (1+2 < 32) {       r16.z = (uint)r9.w << (32-(1 + 2)); r16.z = (uint)r16.z >> (32-1);      } else r16.z = (uint)r9.w >> 2;
      r16.w = (int)r16.y & 2;
      r18.z = max(r19.y, r19.x);
      r12.w = -r14.w * r12.w + 1;
      r12.w = r19.y * r12.w;
      r18.y = r16.w ? r12.w : r18.z;
      r19.xy = r16.zz ? r19.xy : r18.xy;
      r10.w = (int)r10.w + 1;
      r9.w = r16.y;
    }
    ...
    if (r8.w != 0) {
      ...
      r12.w = -refProbeConstantsCB[r6.w].data[9].z + r12.w;
      r13.z = cmp(r12.w >= 0);
      ...
      r10.w = dot(r17.xyz, r18.xyz);
      r12.w = dot(r15.yzw, r18.xyz);
      r12.w = -refProbeConstantsCB[r6.w].data[10].z + r12.w;
      r13.z = cmp(r12.w >= 0);
      r12.w = max(abs(r12.w), r3.y);
      r12.w = r13.z ? r12.w : -r12.w;
      r10.w = max(1.00000001e-07, -r10.w);
      ...
      r10.w = dot(r17.xyz, r18.xyz);
      r12.w = dot(r15.yzw, r18.xyz);
      r12.w = -refProbeConstantsCB[r6.w].data[11].z + r12.w;
      r13.z = cmp(r12.w >= 0);
      r12.w = max(abs(r12.w), r3.y);
      r12.w = r13.z ? r12.w : -r12.w;
      r10.w = max(1.00000001e-07, -r10.w);
      ...
      r10.w = dot(r17.xyz, r18.xyz);
      r12.w = dot(r15.yzw, r18.xyz);
      r12.w = -refProbeConstantsCB[r6.w].data[12].z + r12.w;
      r13.z = cmp(r12.w >= 0);
      r12.w = max(abs(r12.w), r3.y);
      r12.w = r13.z ? r12.w : -r12.w;
      r10.w = max(1.00000001e-07, -r10.w);
      ...
      r10.w = dot(r17.xyz, r18.xyz);
      r12.w = dot(r15.yzw, r18.xyz);
      r12.w = -refProbeConstantsCB[r6.w].data[13].z + r12.w;
      r13.z = cmp(r12.w >= 0);
      r12.w = max(abs(r12.w), r3.y);
      r12.w = r13.z ? r12.w : -r12.w;
      r10.w = max(1.00000001e-07, -r10.w);
  ...
  if (r3.w != 0) {
    ...
    if (r1.w != 0) {
      r3.w = (int)r6.w & 1;
      r3.w = mad((int)r3.w, 20, 880);
      r18.yzw = refProbeConstantsCB[r0.y].data[0].xyz + eyeOffset.xyz;
      r18.x = 16;
      GBufferDiffuseColor[viewID].r3.w = u2.xyzw;
    }
    r3.w = (int)r6.w + 1;
    ...
    if (r10.w != 0) {
      ...
      r13.w = cmp(r13.z >= 0);
      r3.y = max(abs(r13.z), r3.y);
      r3.y = r13.w ? r3.y : -r3.y;
      r12.w = max(1.00000001e-07, -r12.w);
      r3.y = r3.y / r12.w;
      r3.y = min(r10.w, abs(r3.y));
      r19.x = refProbeConstantsCB[r0.y].data[3].w + r18.x;
      r19.yz = refProbeConstantsCB[r0.y].data[4].xy + r18.yz;
      r19.xyz = r17.xyz * r3.yyy + r19.xyz;
      ...
      if (9 == 0) r3.y = 0; else if (9+16 < 32) {       r3.y = (uint)refProbeConstantsCB[r0.y].data[7].z << (32-(9 + 16)); r3.y = (uint)r3.y >> (32-9);      } else r3.y = (uint)refProbeConstantsCB[r0.y].data[7].z >> 16;
      r21.w = (uint)r3.y;
      r19.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r21.xyzw, r2.z).xyz;
      r24.xyz = (int3)r19.xyz & int3(-2147483648,-2147483648,-2147483648);
      r24.xyz = cmp((int3)r24.xyz == int3(2139095040,2139095040,2139095040));
      r2.z = (int)r24.y | (int)r24.x;
      r2.z = (int)r24.z | (int)r2.z;
      r19.xyz = r2.zzz ? float3(1,1,0) : r19.xyz;
      ...
      r3.y = dot(r18.xyz, float3(0.212599993,0.715200007,0.0722000003));
      r0.y = r3.z * r0.y + r3.y;
      r0.y = r2.z / r0.y;
  ...
  r0.y = cmp(r7.w >= 1);
  bitmask.z = ((~(-1 << 8)) << 0) & 0xffffffff;  r2.z = (((uint)r3.w << 0) & bitmask.z) | ((uint)r6.w & ~bitmask.z);
  r0.y = r0.y ? r2.z : r3.w;
  r2.z = max(1, r8.w);
  r2.z = rcp(r2.z);
  r8.w = saturate(r8.w);
