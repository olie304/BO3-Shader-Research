...
dcl_output o0.xyzw
dcl_temps 46
sample_indexable(texture2d)(float,float,float,float) r0.x, v1.yzyy, t22.xyzw, s5
mul r1.xyzw, v1.yzyz, cb0[12].xyzw
...
sample_indexable(texture2d)(float,float,float,float) r0.yzw, v1.yzyy, t0.wxyz, s3
...
loop 
  ...
  dp3 r12.w, r34.xyzx, r9.yzwy
  add_sat r12.w, r34.w, r12.w
  dp3 r13.z, r35.xyzx, r9.yzwy
  add_sat r13.z, r35.w, r13.z
  mul r12.w, r12.w, r13.z
  dp3 r13.z, r36.xyzx, r9.yzwy
  add_sat r13.z, r36.w, r13.z
  mul r12.w, r12.w, r13.z
  dp3 r13.z, r37.xyzx, r9.yzwy
  add_sat r13.z, r37.w, r13.z
  mul r12.w, r12.w, r13.z
  dp3 r13.z, r38.xyzx, r9.yzwy
  add_sat r13.z, r38.w, r13.z
  mul r12.w, r12.w, r13.z
  dp3 r13.z, r39.xyzx, r9.yzwy
  ...
  dp3 r30.x, r9.yzwy, r21.xyzx
  dp3 r30.y, r9.yzwy, r29.xyzx
  dp3 r30.z, r9.yzwy, r23.xyzx
  mad_sat r24.xyz, r30.xyzx, r24.xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
  mov r25.z, r26.x
  mad r24.xyz, r24.xyzx, r25.xyzx, r26.yzwy
  dp3 r28.x, r3.xyzx, r21.xyzx
  dp3 r28.y, r3.xyzx, r29.xyzx
  dp3 r28.z, r3.xyzx, r23.xyzx
...
if_z r1.z
    ...
    loop 
      ...
      if_nz r10.w
        ...
        if_nz r9.w
          ...
          and r9.w, r27.w, l(0x0000ffff)
          ubfe r10.w, l(6), l(25), r27.w
          ...
          if_nz r10.w
            ...
            utof r34.w, r10.w
            sample_l_indexable(texturecubearray)(float,float,float,float) r17.yzw, r34.xyzw, t8.wxyz, s2, r9.w
            and r28.xzw, r17.yyzw, l(0x7fffffff, 0, 0x7fffffff, 0x7fffffff)
            ieq r28.xzw, r28.xxzw, l(0x7f800000, 0, 0x7f800000, 0x7f800000)
            or r9.w, r28.z, r28.x
            or r9.w, r28.w, r9.w
            movc r17.yzw, r9.wwww, l(0,1.000000,1.000000,0), r17.yyzw
            ...
            dp3 r9.w, r27.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
            ...
            mov r26.x, r24.w
            mov r26.yz, r25.xxyx
            mad r25.xyw, r14.yzyx, r9.zzzz, r26.yzyx
            mov r24.w, r25.w
          endif 
        endif 
      endif 
  ...
  if_nz r2.x
    ...
    mul r13.x, r8.y, cb2[35].w
    mul r13.yz, r8.zzwz, cb2[36].xxyx
    add_sat r8.yzw, r13.xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
    mul r13.xy, r8.yzyy, cb2[36].zwzz
    mul r13.z, r8.w, cb2[37].x
    add r8.yzw, r13.xxyz, cb2[37].yyzw
    lt r9.yzw, l(0.000000, 0.000000, 0.000000, 0.000000), r3.xxyz
    movc r13.xyz, r9.yzwy, l(0,0,0,0), l(0.500000,0.500000,0.500000,0)
    mov r13.w, l(0)
    add r9.yzw, r8.yyzw, r13.wwwx
    ...
    mad r9.yzw, r9.yyzw, r14.xxxx, r15.xxyz
    add r8.yzw, r8.yyzw, r13.wwwz
    sample_l_indexable(texture3d)(float,float,float,float) r8.yzw, r8.yzwy, t19.wxyz, s4, l(0.000000)
    mad r8.yzw, r8.yyzw, r14.zzzz, r9.yyzw
    mov r3.w, l(0)
    ...
    dp3 r2.y, r8.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
    mad r19.xyz, r22.xyzx, r1.zzzz, r8.yzwy
    mov r11.w, l(0)
    ...
    mad r20.xyz, r8.yzwy, r1.zzzz, r20.xyzx
  endif 
else 
  mov r20.x, r19.w
endif 
  ...
  if_nz r9.y
    ...
    if_z r10.w
      ...
      if_z r9.z
        ...
        movc r9.zw, r12.wwww, r17.xxxz, r18.xxxy
...
if_nz r5.w
  ...
  if_nz r5.w
    ...
    if_nz r7.w
      ...
      mad r18.xyz, r3.xyzx, r9.yyyy, v6.xyzx
    ...
    mad r14.xyz, r6.wwww, r8.yzwy, r19.xyzx
    ...
    exp r0.z, r0.z
    mul r0.z, r0.z, r4.w
    mad r15.xyz, r0.zzzz, r8.zwyz, r13.xyzx
    mov r14.w, r15.z
    mov r19.w, r13.z
          ...
          if_nz r19.w
            ...
            if_nz r19.w
              ...
              if_nz r19.w
                ...
                mad r41.xyz, r3.xyzx, r19.wwww, v6.xyzx
              ...
              if_nz r19.w
                ...
                if_nz r12.w
                  ...
                  mad r18.xyz, r3.xyzx, r21.wwww, v6.xyzx
                  ...
                  if_nz r12.w
                    ...
                    mad r20.xyz, r3.xyzx, r18.xxxx, v6.xyzx
                ...
                mad r39.xyz, r10.wwww, r32.xyzx, r16.xyzx
            ...
            if_nz r13.w
              ...
              if_nz r13.w
                ...
                if_nz r18.x
                  ...
                  mad r23.xyz, r3.xyzx, r19.wwww, v6.xyzx
                  ...
                  if_nz r18.x
                    ...
                    mad r19.w, |r11.w|, l(-0.200000), l(0.400000)
                    mad r24.xyz, r3.xyzx, r19.wwww, v6.xyzx
...
mov o0.w, r0.w
ret 
// Approximately 2860 instruction slots used
