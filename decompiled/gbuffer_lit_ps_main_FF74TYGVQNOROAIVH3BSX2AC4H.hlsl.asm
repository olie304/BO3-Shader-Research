...
sample_indexable(texture2d)(float,float,float,float) r1.xyz, v2.xyxx, t9.xyzw, s2
sample_indexable(texture2d)(float,float,float,float) r0.w, v2.xyxx, t12.yzwx, s4
sample_indexable(texture2d)(float,float,float,float) r1.w, v2.xyxx, t11.yzwx, s2
add r2.x, -cb0[11].x, cb0[11].y
mad r1.w, r1.w, r2.x, cb0[11].x
mul_sat r1.w, r1.w, l(0.05882353)
sample_indexable(texture2d)(float,float,float,float) r2.yzw, v2.xyxx, t10.wxyz, s3
...
sample_indexable(texture2d)(float,float,float,float) r4.xyzw, v2.xyxx, t18.xyzw, s5
lt r3.w, l(0.000000), r4.x
mul r5.xy, v2.xyxx, cb0[7].xyxx
sample_indexable(texture2d)(float,float,float,float) r5.xyz, r5.xyxx, t14.xyzw, s3
mul r6.xy, v2.xyxx, cb0[6].xyxx
sample_indexable(texture2d)(float,float,float,float) r6.xyz, r6.xyxx, t15.xyzw, s3
mul r7.xy, v2.xyxx, cb0[5].xyxx
sample_indexable(texture2d)(float,float,float,float) r7.xyz, r7.xyxx, t16.xyzw, s3
mul r8.xy, v2.xyxx, cb0[4].xyxx
sample_indexable(texture2d)(float,float,float,float) r8.xyz, r8.xyxx, t17.xyzw, s3
if_nz r3.w
...
if_nz r2.y
  ftoi r2.y, cb1[64].w
  lod r2.w, v2.xyxx, t7.y, s1
  lod r3.w, v2.xyxx, t7.x, s1
  lt r2.w, r2.w, r3.w
