...
mad r6.xyz, r6.xyzx, r1.wwww, r16.xyzx
...
sample_indexable(texture2d)(float,float,float,float) r9.xyzw, r9.xyxx, t24.xyzw, s1
mul r9.xyzw, r9.xyzw, cb0[18].xyzw
mul r9.xyz, r9.wwww, r9.xyzx
mul r9.xyz, r9.xyzx, cb0[19].zzzz
add r1.x, v2.y, v2.x
add r1.x, r1.x, v2.z
add r2.w, r1.x, cb0[16].y
frc r2.w, r2.w
mad r10.y, cb1[69].w, cb0[16].z, r2.w
mov r10.x, cb0[16].x
sample_l_indexable(texture2d)(float,float,float,float) r2.w, r10.xyxx, t22.yzwx, s5, l(0.000000)
log r2.w, |r2.w|
...
mul r2.w, r10.w, cb0[18].w
mul r10.xyz, r2.wwww, r10.xyzx
mul r10.xyz, r10.xyzx, cb0[26].wwww
add r2.w, r1.x, cb0[25].z
frc r2.w, r2.w
mad r11.y, cb1[69].w, cb0[25].w, r2.w
mov r11.x, cb0[25].y
sample_l_indexable(texture2d)(float,float,float,float) r2.w, r11.xyxx, t22.yzwx, s5, l(0.000000)
log r2.w, |r2.w|
...
mul r10.xyz, r2.wwww, r10.xyzx
mad r2.w, -r10.w, cb0[26].w, l(1.000000)
...
if_nz r2.w
  ...
  round_z r2.w, r2.w
  add r2.w, r2.w, v1.y
  div r10.x, r2.w, cb0[28].x
  round_z r2.w, r3.w
  add r2.w, r2.w, v1.z
  div r10.y, r2.w, cb0[27].w
else 
  dp3 r2.w, -v6.xyzx, -v6.xyzx
  rsq r2.w, r2.w
  mul r11.xyz, r2.wwww, -v6.xyzx
...
mov r4.x, cb0[32].y
sample_l_indexable(texture2d)(float,float,float,float) r1.x, r4.xyxx, t22.xyzw, s5, l(0.000000)
log r1.x, |r1.x|
mul r1.x, r1.x, cb0[33].z
exp r1.x, r1.x
add r2.w, -cb0[33].x, cb0[33].y
mad r1.x, r1.x, r2.w, cb0[33].x
mul r3.xyz, r1.xxxx, r3.xyzx
mad r1.x, -r3.w, cb0[33].w, l(1.000000)
...
loop 
  ...
  sqrt r13.w, r13.w
  mad r13.w, r5.y, l(5.000000), r13.w
  ...
  dp3 r29.x, r6.xyzx, r22.xyzx
  dp3 r29.y, r6.xyzx, r30.xyzx
  dp3 r29.z, r6.xyzx, r24.xyzx
...
if_z r1.z
      ...
      if_nz r11.w
        ...
        if_nz r11.z
          ...
          if_nz r13.w
            ...
            sqrt r11.z, r11.z
            mad r11.z, r5.y, l(5.000000), r11.z
        ...
        if_nz r14.w
          ...
          if_nz r14.z
            ...
            if_nz r16.w
              ...
              sqrt r14.z, r14.z
              mad r14.z, r5.y, l(5.000000), r14.z
  ...
  lt r5.y, r24.w, l(0.990000)
  if_nz r5.y
    add r5.y, -r24.w, l(1.000000)
    mul r5.w, r5.y, cb2[19].x
    ...
    lt r11.yzw, l(0.000000, 0.000000, 0.000000, 0.000000), r6.xxyz
    ...
    mov r6.w, l(0)
    sample_l_indexable(texturecubearray)(float,float,float,float) r11.yzw, r6.xyzw, t8.wxyz, s2, l(6.000000)
    mul r7.xyz, r7.xyzx, r11.yzwy
    dp3 r5.w, r7.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
    mad r20.xyz, r23.xyzx, r1.zzzz, r7.xyzx
    mov r12.w, l(0)
    sample_l_indexable(texturecubearray)(float,float,float,float) r7.xyz, r12.xyzw, t8.xyzw, s2, r5.z
    mad r1.z, cb2[19].x, r5.y, -r5.w
    mad r1.z, r8.y, r1.z, r5.w
...
mad r6.w, r8.x, r1.y, r1.z
mul r1.yz, r1.yyzy, r6.wwww
...
if_z r8.z
  ...
  if_z r10.w
    if_z cb2[58].y
      ...
      sample_c_lz_indexable(texture2darray)(float,float,float,float) r10.w, r15.xyzx, t13.xxxx, s13, r8.z
    ...
    if_nz cb2[58].y
      ...
      loop 
        ...
        utof r17.z, r13.w
        sample_c_lz_indexable(texture2darray)(float,float,float,float) r13.w, r17.xyzx, t13.xxxx, s13, r8.z
...
if_nz r8.z
  ...
  if_nz r8.z
    ...
    mad r9.z, -r8.y, r9.z, l(1.000000)
    mul r9.z, r9.z, r9.z
    mad r9.z, -r9.z, l(0.620000), l(0.620000)
    add r9.z, -r8.y, r9.z
    mad r9.z, r4.w, r9.z, r8.y
    mul r9.z, r8.w, r9.z
    ...
    mad r16.xyz, r8.yyyy, r11.yzwy, r5.yzwy
    ...
    mov r15.w, r17.z
    mov r7.w, r14.z
    movc r7.xyzw, r6.wwww, r15.xyzw, r7.xyzw
    mov r17.zw, r16.xxxy
    mov r14.zw, r5.yyyz
    movc r15.xyzw, r6.wwww, r17.xyzw, r14.xyzw
    movc r5.w, r6.w, r16.z, r5.w
    mov r14.z, r7.w
    mov r14.xy, r15.xyxx
    mov r5.yz, r15.zzwz
  endif 
          ...
          if_nz r26.w
            ...
            if_nz r26.w
              ...
              if_nz r26.w
                ...
                mad r41.xyz, r6.xyzx, r26.wwww, v6.xyzx
              ...
              if_nz r26.w
                ...
                if_nz r14.w
                  ...
                  mad r18.xyz, r6.xyzx, r27.wwww, v6.xyzx
                  ...
                  if_nz r14.w
                    ...
                    mad r19.xyz, r6.xyzx, r18.xxxx, v6.xyzx
                ...
                mad r24.w, |r18.x|, r2.w, -|r18.x|
                mad r18.x, |r18.x|, r24.w, l(1.000000)
                mad r24.w, r13.w, r1.y, r1.z
          ...
          if_nz r18.x
            ...
            if_nz r18.x
              ...
              if_nz r18.x
                ...
                mad r21.xyz, r6.xyzx, r18.xxxx, v6.xyzx
              ...
              if_nz r18.x
                ...
                if_nz r20.w
                  ...
                  if_nz r20.w
                    ...
                    mad r21.x, |r13.w|, l(-0.200000), l(0.400000)
                    mad r23.xyz, r6.xyzx, r21.xxxx, v6.xyzx
...
ret 
// Approximately 3160 instruction slots used
