...
if_z r5.w
  ...
  if_nz r6.z
    mov r6.zw, l(0,0,0,0)
    loop 
      ge r8.x, r6.z, l(3.000000)
      breakc_nz r8.x
      ftou r8.x, r6.z
      add r8.yz, r7.yyzy, -cb2[r8.x + 20].xxyx
      max r8.y, |r8.z|, |r8.y|
      mul r6.w, r8.y, cb2[r8.x + 20].z
      lt r8.x, r6.w, l(1.000000)
      if_nz r8.x
        break 
      endif 
  ...
  if_nz r8.x
    ...
    lt r7.w, r9.w, r7.w
    movc r6.y, r7.w, l(0), l(1.000000)
  endif 
  if_z r8.x
    if_z cb2[58].y
      ftou r7.w, r6.z
      add r8.xy, r7.yzyy, -cb2[r7.w + 20].xyxx
      ...
      itof r7.w, cb2[26].y
      add r8.z, r6.z, r7.w
      sample_c_lz_indexable(texture2darray)(float,float,float,float) r7.w, r8.xyzx, t13.xxxx, s13, r5.w
    ...
    if_nz cb2[58].y
      ...
      ftou r6.zw, r6.zzzw
      add r9.xy, r7.yzyy, -cb2[r7.w + 20].xyxx
      ...
      add r7.yz, r7.yyzy, -cb2[r6.z + 20].xxyx
      mul r7.yz, r7.yyzy, cb2[r6.z + 20].zzzz
      ...
      loop 
        ...
        breakc_nz r9.w
        ult r9.w, r6.w, r9.z
        movc r10.xy, r9.wwww, r7.yzyy, r9.xyxx
        movc r10.z, r9.w, cb2[r6.z + 20].w, cb2[r7.w + 20].w
        movc r9.w, r9.w, r6.z, r7.w
        ...
        utof r10.z, r9.w
        sample_c_lz_indexable(texture2darray)(float,float,float,float) r9.w, r10.xyzx, t13.xxxx, s13, r5.w
...
if_nz r5.w
  ...
  mad r12.xyz, r0.xyzx, r0.wwww, v6.xyzx
  mov r12.w, l(1.000000)
  dp4 r8.x, r8.xyzw, r12.xyzw
  dp4 r8.y, r9.xyzw, r12.xyzw
  mad r7.yz, r8.xxyx, l(0.000000, 0.500000, -0.500000, 0.000000), l(0.000000, 0.500000, 0.500000, 0.000000)
  add r7.yz, r11.zzwz, r7.yyzy
  mul r7.yz, r11.xxyx, r7.yyzy
  div r8.xy, r6.zzzz, r10.xzxx
  add r8.zw, -r8.xxxy, l(0.000000, 0.000000, 1.000000, 1.000000)
  ge r8.zw, r7.yyyz, r8.zzzw
  ge r8.xy, r8.xyxx, r7.yzyy
  ...
  if_z r0.w
    ...
    mad r8.xy, r7.yzyy, r10.xzxx, r10.ywyy
    add r5.w, r9.x, r5.w
    div r5.w, r5.w, r9.y
    ...
    if_nz cb2[58].y
      ...
      loop 
        ...
        mad r10.xy, r7.xyxx, r6.zzzz, r8.xyxx
      ...
      utof r8.z, r0.w
      sample_c_lz_indexable(texture2darray)(float,float,float,float) r6.x, r8.xyzx, t9.xxxx, s13, r5.w
    endif 
    mul r0.w, r6.x, r6.x
    mul r0.w, r6.x, r0.w
  else 
...
mad r2.xzw, r6.xxyz, r0.yyyy, r17.xxyz
mad r4.xyz, r6.xyzx, r3.wwww, r17.xyzx
...
mov o0.w, l(1.000000)
ret 
// Approximately 1529 instruction slots used
