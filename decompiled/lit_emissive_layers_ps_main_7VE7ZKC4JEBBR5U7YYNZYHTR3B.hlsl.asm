...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:32:46 2021
//
//
// Buffer Definitions: 
//
...
// emissiveMap2                      texture  float4          2d            t37      1 
// emissiveMap3                      texture  float4          2d            t38      1 
...
mul r0.w, r2.w, v1.x
sample_indexable(texture2d)(float,float,float,float) r1.z, r0.yzyy, t25.yzxw, s6
sample_indexable(texture2d)(float,float,float,float) r1.w, r0.yzyy, t24.yzwx, s3
add r3.x, -cb0[11].x, cb0[11].y
mad r1.w, r1.w, r3.x, cb0[11].x
mul_sat r1.w, r1.w, l(0.05882353)
sample_indexable(texture2d)(float,float,float,float) r3.yzw, r0.yzyy, t22.wxyz, s5
...
mov r11.x, cb0[16].x
sample_l_indexable(texture2d)(float,float,float,float) r2.w, r11.xyxx, t26.yzwx, s7, l(0.000000)
log r2.w, |r2.w|
...
sample_indexable(texture2d)(float,float,float,float) r11.xyzw, r11.xyxx, t37.xyzw, s1
...
mov r12.x, cb0[25].y
sample_l_indexable(texture2d)(float,float,float,float) r2.w, r12.xyxx, t26.yzwx, s7, l(0.000000)
log r2.w, |r2.w|
...
mov r1.x, cb0[32].y
sample_l_indexable(texture2d)(float,float,float,float) r0.z, r1.xyxx, t26.yzxw, s7, l(0.000000)
log r0.z, |r0.z|
...
ret 
// Approximately 3184 instruction slots used
