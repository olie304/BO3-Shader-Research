...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r2.w = debugAlphaOverride.w * r0.w + r2.x;
  r0.w = r1.z + -r1.y;
  ...
  r4.x = saturate(dot(r1.xyz, r5.yzw));
  r6.y = dot(-r5.yzw, r1.xyz);
  r6.y = r6.y + r6.y;
  r11.xyz = r1.xyz * -r6.yyy + -r5.yzw;
  r6.y = 17 * r4.y;
  r6.y = exp2(r6.y);
  r6.y = 2 + r6.y;
  r6.y = 2 / r6.y;
  ...
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r22.xyzw, r4.z, l(0), t15.wxyz
  r22.x = samp0[]..swiz;
  r22.y = samp0[]..swiz;
  r22.z = samp0[]..swiz;
  r22.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r23.xyzw, r4.z, l(16), t15.xyzw
  r23.x = samp0[]..swiz;
  r23.y = samp0[]..swiz;
  r23.z = samp0[]..swiz;
  r23.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r24.xyzw, r4.z, l(32), t15.yxwz
  r24.x = samp0[]..swiz;
  r24.y = samp0[]..swiz;
  r24.z = samp0[]..swiz;
  r24.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r25.xyzw, r4.z, l(48), t15.xyzw
  r25.x = samp0[]..swiz;
  r25.y = samp0[]..swiz;
  r25.z = samp0[]..swiz;
  r25.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r26.xyzw, r4.z, l(64), t15.zwxy
  r26.x = samp0[]..swiz;
  r26.y = samp0[]..swiz;
  r26.z = samp0[]..swiz;
  r26.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r27.xyzw, r4.z, l(80), t15.xyzw
  r27.x = samp0[]..swiz;
  r27.y = samp0[]..swiz;
  r27.z = samp0[]..swiz;
  r27.w = samp0[]..swiz;
  ...
  r9.z = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r28.xyzw, r4.z, l(116), t15.xyzw
  r28.x = samp0[]..swiz;
  r28.y = samp0[]..swiz;
  r28.z = samp0[]..swiz;
  r28.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r29.xyzw, r4.z, l(132), t15.zwxy
  r29.x = samp0[]..swiz;
  r29.y = samp0[]..swiz;
  r29.z = samp0[]..swiz;
  r29.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r30.xyzw, r4.z, l(148), t15.zwxy
  r30.x = samp0[]..swiz;
  r30.y = samp0[]..swiz;
  r30.z = samp0[]..swiz;
  r30.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r31.xyzw, r4.z, l(164), t15.zwxy
  r31.x = samp0[]..swiz;
  r31.y = samp0[]..swiz;
  r31.z = samp0[]..swiz;
  r31.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r32.xyzw, r4.z, l(180), t15.zwxy
  r32.x = samp0[]..swiz;
  r32.y = samp0[]..swiz;
  r32.z = samp0[]..swiz;
  r32.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r33.xyzw, r4.z, l(196), t15.xyzw
  r33.x = samp0[]..swiz;
  r33.y = samp0[]..swiz;
  r33.z = samp0[]..swiz;
  r33.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r34.xy, r4.z, l(212), t15.xyxx
  r34.x = samp0[]..swiz;
  r34.y = samp0[]..swiz;
  ...
  if (r3.w == 0) {
    ...
    if (r4.z != 0) {
      ...
      r20.xyz = r22.xyz * r3.www + r9.yzw;
      r11.w = 0;
      r9.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r11.xyzw, r7.z).xyz;
      r3.w = sunConstants.globalProbeExposure * r4.z + -r1.w;
      r1.w = r4.y * r3.w + r1.w;
      r21.xyz = r9.yzw * r1.www + r21.xyz;
    }
  } else {
    r21.x = r20.w;
  }
  ...
  r9.yzw = r21.xyz * r1.www;
  r10.yzw = r9.yzw * r4.yyy;
  ...
  if (r4.y != 0) {
    ...
    if (r4.y != 0) {
      ...
      r4.w = -r4.x * 0.5 + 1;
      r4.w = -abs(r3.w) * r4.w + 1;
      r4.w = r4.w * r4.w;
      r4.w = -r4.w * 0.620000005 + 0.620000005;
      r4.w = r4.w + -abs(r3.w);
      r4.w = r6.z * r4.w + abs(r3.w);
      r4.w = r4.w * r4.z;
      r6.w = cmp(0 < r3.w);
      ...
      r4.y = saturate(1 + -r4.w);
      r4.z = r4.y * r4.y;
      r4.z = r4.z * r4.z;
      r4.y = r4.y * r4.z;
      r3.w = r4.y * r3.w;
      r4.yzw = r3.www * r9.yzw + r10.yzw;
      r15.w = r13.z;
      r13.w = r15.z;
            ...
            if (r17.w != 0) {
              ...
              if (r17.w != 0) {
                ...
                if (r17.w != 0) {
                  ...
                  r16.w = saturate(dot(r1.xyz, r42.xyz));
                  r41.xyz = r41.xyz * r12.www + r5.yzw;
                  r12.w = dot(r41.xyz, r41.xyz);
                  r12.w = rsqrt(r12.w);
                  r41.xyz = r41.xyz * r12.www;
                  r12.w = dot(r41.xyz, r5.yzw);
                  r20.x = dot(r1.xyz, r41.xyz);
                  r22.w = abs(r20.x) * r6.y + -abs(r20.x);
                  r20.x = abs(r20.x) * r22.w + 1;
                  r22.w = r16.w * r0.w + r1.w;
                  r20.x = r20.x * r20.x;
                  r20.x = r20.x * r22.w;
                  r20.x = rcp(r20.x);
                  r16.w = r16.w * r17.w;
            ...
            r42.w = samp0[]..swiz;
              ...
              if (r14.w != 0) {
                ...
                if (r14.w != 0) {
                  ...
                  r21.xyz = r21.xyz * r12.www + r5.yzw;
                  r12.w = dot(r21.xyz, r21.xyz);
                  r12.w = rsqrt(r12.w);
                  r21.xyz = r21.xyz * r12.www;
                  r12.w = dot(r21.xyz, r5.yzw);
                  r20.x = dot(r1.xyz, r21.xyz);
                  r21.x = abs(r20.x) * r6.y + -abs(r20.x);
                  r20.x = abs(r20.x) * r21.x + 1;
                  r21.x = r13.w * r0.w + r1.w;
                  r20.x = r20.x * r20.x;
                  r20.x = r20.x * r21.x;
                  r20.x = rcp(r20.x);
                  r13.w = r13.w * r14.w;
  ...
  r1.xyz = r29.xyz * r3.xyz;
  r0.xyz = r4.yzw * r0.xyz + r1.xyz;
  r1.xyz = float3(0.959999979,0.959999979,0.959999979) * r30.xyz;
