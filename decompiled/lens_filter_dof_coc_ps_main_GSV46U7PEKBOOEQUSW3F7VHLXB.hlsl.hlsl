...
Texture2D<float4> lensFilter : register(t1);
  ...
  out float o1 : SV_TARGET1)
{
  ...
  r0.y = dot(r1.xyz, postFxControl0.xyz);
  r1.xyz = -r0.yyy * postFxControl1.xyz + r1.xyz;
  r0.z = saturate(r0.y * postFxControl0.w + postFxControl1.w);
  r2.xyz = postFxControl1.xyz * r0.yyy;
  r0.yzw = r0.zzz * r1.xyz + r2.xyz;
  r1.xyz = lensFilter.Sample(bilinearClamp_s, v1.xy).xyz;
  r0.yzw = r1.xyz * r0.yzw;
  o0.xyz = postFxControl2.yyy * r0.yzw;
  r0.y = 1 + -r0.x;
  r0.y = -r0.y * 40 + 1;
  r0.z = cmp(r0.x >= 0.984375);
  r0.x = r0.z ? r0.y : r0.x;
  r0.x = max(9.99999994e-09, r0.x);
  r0.x = postFxControl2.z / r0.x;
  r0.x = 25.3999996 * r0.x;
  r0.x = postFxControl3.y / r0.x;
  r0.x = -1 + r0.x;
  r0.x = postFxControl3.z * r0.x;
  r0.x = postFxControl3.w * r0.x;
  r0.x = 0.5 * r0.x;
  o1.x = r0.z ? 0 : r0.x;
  return;
}