...
mov r2.xyz, v0.xyzx
mov r2.w, l(1.000000)
dp4 r3.y, r2.xyzw, r3.xyzw
mul r5.xyzw, r3.yyyy, cb1[9].xyzw
mov r1.w, r0.y
mov r4.w, r0.w
dp4 r3.z, r2.xyzw, r4.xyzw
dp4 r3.x, r2.xyzw, r1.xyzw
mad r1.xyzw, r3.xxxx, cb1[8].xyzw, r5.xyzw
mov o6.xyz, r3.xyzx
mad r1.xyzw, r3.zzzz, cb1[10].xyzw, r1.xyzw
...
mad r3.xyz, r1.wwww, cb1[6].xyzx, r3.xyzx
...
mul r0.yzw, r0.yyyy, cb1[5].xxyz
dp3 r1.w, r3.xyzx, r4.xyzx
mad r0.yzw, r1.wwww, cb1[4].xxyz, r0.yyzw
dp3 r1.w, r3.xyzx, r5.xyzx
mad r0.yzw, r1.wwww, cb1[6].xxyz, r0.yyzw
dp3 r1.w, r0.yzwy, r0.yzwy
rsq r1.w, r1.w
mul o4.xyz, r0.yzwy, r1.wwww
mul r0.yzw, r1.zzxy, r3.yyzx
mad r0.yzw, r1.yyzx, r3.zzxy, -r0.yyzw
mad r1.x, v4.w, l(2.000000), l(-1.000000)
...
mad r3.xyz, r1.zzzz, cb1[4].xyzx, r3.xyzx
...
dp3 r0.y, r0.yzwy, r1.yzwy
mad r0.yzw, r0.yyyy, cb1[6].xxyz, r3.xxyz
dp3 r1.y, r0.yzwy, r0.yzwy
rsq r1.y, r1.y
mul o5.xyz, r0.yzwy, r1.yyyy
ine r0.y, r0.x, l(0)
