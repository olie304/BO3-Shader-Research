...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  if (r2.z != 0) {
    ...
    r2.w = colorMap.CalculateLevelOfDetailUnclamped(colorSampler_s, r0.xy);
    r0.x = colorMap.CalculateLevelOfDetail(colorSampler_s, r0.xy);
    r0.y = cmp(r2.w < r0.x);
    r0.x = cmp(0 < r0.x);
    r3.xyw = (int3)r2.zzz & int3(1,2,4);
    r8.xyz = r3.xxx ? float3(1,0,1) : r1.xyz;
    r9.xyz = r3.yyy ? float3(0,1,1) : r1.xyz;
    r8.xyz = r0.xxx ? r8.xyz : r9.xyz;
    r3.xyw = r3.www ? float3(0,1,0) : r1.xyz;
    r1.xyz = r0.yyy ? r8.xyz : r3.xyw;
  }
  ...
  r0.y = r2.y + -r2.x;
  r0.y = debugGlossOverride.w * r0.y + r2.x;
  r0.z = debugOcclusionOverride.x + -r0.w;
  r0.z = debugOcclusionOverride.w * r0.z + r0.w;
  r2.xyz = v7.xxx ? v3.xyz : -v3.xyz;
  r0.w = dot(r2.xyz, r2.xyz);
  r0.w = rsqrt(r0.w);
  r2.xyz = r2.xyz * r0.www + -r7.xyz;
  r2.xyz = debugNormalOverride.www * r2.xyz + r7.xyz;
...
r2.w = samp0[]..swiz;
            ...
            r29.w = samp0[]..swiz;
              ...
              r26.w = samp0[]..swiz;
                ...
                if (r25.y != 0) {
                  ...
                  r27.xyz = r28.xyz * r3.zzz;
                  r25.xyz = r25.xyz * r3.zzz;
                  r26.xyz = r26.xyz * r3.zzz;
                  r17.w = -17 * r14.z;
                  r17.w = exp2(r17.w);
                  r16.w = r17.w + r16.w;
                  r16.w = log2(r16.w);
  ...
  if (r4.w != 0) {
    ...
    r5.y = dot(r10.xyz, r6.xyz);
    r4.x = dot(r10.xyz, r4.xyz);
    r4.y = cmp(0 < r4.x);
    r4.xz = -r5.xy / r4.xx;
    r4.xy = r4.yy ? r4.xz : 0;
    r4.zw = float2(-0.5,-0.5) + w1.xy;
    r5.x = 9.99999975e-06 + layer3Depth;
    r4.xy = r5.xx * r4.xy;
    r4.xy = scaleUVs3.xy * r4.xy;
    r4.xy = r4.zw * scaleUVs3.xy + r4.xy;
    r4.xy = offsetUVs3.xy * scaleUVs3.xy + r4.xy;
    r4.z = rotateUVs3.y * gameTime.w + 1;
    r4.z = rotateUVs3.x * r4.z;
    r4.z = 0.0174532924 * r4.z;
    sincos(r4.z, r5.x, r6.x);
    r6.y = r6.x;
    r6.z = r5.x;
    r10.x = dot(r6.yz, r4.xy);
    r6.x = -r5.x;
    r10.y = dot(r6.xy, r4.xy);
    r4.xy = gameTime.ww * scrollUVs3.xy;
    r4.xy = r4.xy * scaleUVs3.xy + r10.xy;
    r4.z = gameTime.w * zoomRate3;
    r4.z = cos(r4.z);
    r4.z = r4.z * 0.5 + 0.5;
    r4.z = 1 + -r4.z;
    r4.w = zoomUVs3.y + -zoomUVs3.x;
    r4.z = r4.z * r4.w + zoomUVs3.x;
    r4.xy = r4.xy / r4.zz;
    r4.xy = float2(0.5,0.5) + r4.xy;
    r4.zw = saturate(r4.xy);
    r9.x = clampU3 ? r4.z : r4.x;
    r9.y = clampV3 ? r4.w : r4.y;
  }
  ...
  r3.w = clampV3 + r3.w;
  r3.w = frac(r3.w);
  r5.y = gameTime.w * clampV3 + r3.w;
  r5.x = clampV3;
  r3.w = flickerLookupMap.SampleLevel(lookupSampler_s, r5.xy, 0).x;
  r3.w = log2(abs(r3.w));
  r3.w = flickerPower3 * r3.w;
  r3.w = exp2(r3.w);
  r5.x = flickerRange3.y + -flickerRange3.x;
  r3.w = r3.w * r5.x + flickerRange3.x;
  ...
  if (r0.w == 0) {
    ...
    r6.y = cmp(r23.w < 0.99000001);
    if (r6.y != 0) {
      r6.y = 1 + -r23.w;
      r6.w = sunConstants.globalProbeExposure * r6.y;
      ...
      r11.w = 0;
      r7.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r11.xyzw, r6.z).xyz;
      r0.w = sunConstants.globalProbeExposure * r6.y + -r2.w;
      r0.w = r0.y * r0.w + r2.w;
  ...
  r6.yzw = r20.xyz * r0.www;
  r13.xyz = r6.zwy * r0.yyy;
  r0.yzw = r6.yzw * r0.zzz;
  r2.w = sqrt(r5.w);
  r2.w = r2.w * 0.5 + 0.5;
  r2.w = r2.w * r2.w;
  r6.y = 0.5 * r2.w;
  ...
  if (r8.z != 0) {
    ...
    if (r8.z != 0) {
      ...
      r17.z = samp0[]..swiz;
      r17.w = samp0[]..swiz;
        r12.w = abs(r6.z) * -0.200000003 + 0.400000006;
      ...
      r14.w = r16.z;
      r7.w = r13.z;
      r7.xyzw = r6.zzzz ? r14.xyzw : r7.xyzw;
      r16.zw = r15.xy;
      r13.zw = r0.yz;
      r14.xyzw = r6.zzzz ? r16.xyzw : r13.xyzw;
      r0.w = r6.z ? r15.z : r0.w;
      r13.z = r7.w;
      r13.xy = r14.xy;
      r0.yz = r14.zw;
    }
