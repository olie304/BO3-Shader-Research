...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:24:30 2021
//
//
...
//   float1 alphaDissolve;              // Offset:  200 Size:     4
//   bool useOldHDRScale;               // Offset:  204 Size:     4
//
// }
//
...
rcp r1.xy, r1.xyxx
eq r1.z, cb0[12].x, l(0.000000)
div r1.w, l(1.000000, 1.000000, 1.000000, 1.000000), cb0[12].x
movc r1.z, r1.z, l(60000.000000), r1.w
ne r1.w, cb0[12].z, l(1.000000)
max r2.x, r0.w, l(0.000100)
div r2.xyz, r0.xyzx, r2.xxxx
add r2.w, r0.w, v1.w
mad_sat r3.y, r2.w, cb0[12].z, -cb0[12].z
mul r3.xzw, r2.xxyz, r3.yyyy
movc r0.xyzw, r1.wwww, r3.xzwy, r0.xyzw
mov r3.x, l(1.000000)
movc r2.xy, r1.wwww, r3.xyxx, v1.wwww
lt r1.w, r1.y, r1.x
add r1.x, -r1.y, r1.x
...
mul r1.x, r1.y, r1.x
dp3 r1.y, v1.xyzx, l(0.299000, 0.587000, 0.114000, 0.000000)
max r1.y, r1.y, l(0.000100)
max r1.y, r1.y, cb1[85].x
mul r1.y, r1.y, cb0[11].z
mul r1.y, r1.y, v3.w
movc r1.y, cb0[12].w, cb0[11].z, r1.y
mul r1.x, r1.x, r1.y
mad r1.xyz, v3.xyzx, r1.xxxx, v1.xyzx
