...
r0.y = samp0[]..swiz;
  ...
  if (r0.y != 0) {
    r0.y = (int)r15.y * 14;
    r17.xyz = -refProbeConstantsCB[r0.y].data[0].xyz + r10.xyz;
    ...
    r15.w = (int)r13.w * 6;
    r17.w = dot(refProbeAttenuationConstantsCB[r15.w].data[0].xyz, r17.xyz);
    r17.w = saturate(refProbeAttenuationConstantsCB[r15.w].data[0].w + r17.w);
    r18.x = dot(refProbeAttenuationConstantsCB[r15.w].data[1].xyz, r17.xyz);
    r18.x = saturate(refProbeAttenuationConstantsCB[r15.w].data[1].w + r18.x);
    r17.w = r18.x * r17.w;
    r18.x = dot(refProbeAttenuationConstantsCB[r15.w].data[2].xyz, r17.xyz);
    r18.x = saturate(refProbeAttenuationConstantsCB[r15.w].data[2].w + r18.x);
    r17.w = r18.x * r17.w;
    r18.x = dot(refProbeAttenuationConstantsCB[r15.w].data[3].xyz, r17.xyz);
    r18.x = saturate(refProbeAttenuationConstantsCB[r15.w].data[3].w + r18.x);
    r17.w = r18.x * r17.w;
    r18.x = dot(refProbeAttenuationConstantsCB[r15.w].data[4].xyz, r17.xyz);
    r18.x = saturate(refProbeAttenuationConstantsCB[r15.w].data[4].w + r18.x);
    r17.w = r18.x * r17.w;
    r18.x = dot(refProbeAttenuationConstantsCB[r15.w].data[5].xyz, r17.xyz);
    r15.w = saturate(refProbeAttenuationConstantsCB[r15.w].data[5].w + r18.x);
    r18.x = r17.w * r15.w;
    ...
    if (r14.w != 0) {
      ...
      r18.xyz = r16.xyz * r15.www + r18.xyz;
      ...
      if (9 == 0) r17.w = 0; else if (9+16 < 32) {       r17.w = (uint)refProbeConstantsCB[r0.y].data[7].z << (32-(9 + 16)); r17.w = (uint)r17.w >> (32-9);      } else r17.w = (uint)refProbeConstantsCB[r0.y].data[7].z >> 16;
      r20.w = (uint)r17.w;
  ...
  if (r0.y != 0) {
    ...
    if (r0.y != 0) {
      r0.y = (int)r15.y * 14;
      r19.xyz = -refProbeConstantsCB[r0.y].data[0].xyz + r10.xyz;
      r13.z = 0x0000ffff & (int)refProbeConstantsCB[r0.y].data[7].z;
      if (6 == 0) r14.w = 0; else if (6+25 < 32) {       r14.w = (uint)refProbeConstantsCB[r0.y].data[7].z << (32-(6 + 25)); r14.w = (uint)r14.w >> (32-6);      } else r14.w = (uint)refProbeConstantsCB[r0.y].data[7].z >> 25;
      r15.y = (int)r13.z * 6;
      r15.w = dot(refProbeAttenuationConstantsCB[r15.y].data[0].xyz, r19.xyz);
      r15.w = saturate(refProbeAttenuationConstantsCB[r15.y].data[0].w + r15.w);
      r17.w = dot(refProbeAttenuationConstantsCB[r15.y].data[1].xyz, r19.xyz);
      r17.w = saturate(refProbeAttenuationConstantsCB[r15.y].data[1].w + r17.w);
      r15.w = r17.w * r15.w;
      r17.w = dot(refProbeAttenuationConstantsCB[r15.y].data[2].xyz, r19.xyz);
      r17.w = saturate(refProbeAttenuationConstantsCB[r15.y].data[2].w + r17.w);
      r15.w = r17.w * r15.w;
      r17.w = dot(refProbeAttenuationConstantsCB[r15.y].data[3].xyz, r19.xyz);
      r17.w = saturate(refProbeAttenuationConstantsCB[r15.y].data[3].w + r17.w);
      r15.w = r17.w * r15.w;
      r17.w = dot(refProbeAttenuationConstantsCB[r15.y].data[4].xyz, r19.xyz);
      r17.w = saturate(refProbeAttenuationConstantsCB[r15.y].data[4].w + r17.w);
      r15.w = r17.w * r15.w;
      r17.w = dot(refProbeAttenuationConstantsCB[r15.y].data[5].xyz, r19.xyz);
      r15.y = saturate(refProbeAttenuationConstantsCB[r15.y].data[5].w + r17.w);
      r20.x = r15.w * r15.y;
      r15.y = 1 & (int)refProbeConstantsCB[r0.y].data[6].x;
      r20.yz = float2(0,1);
      r15.yw = r15.yy ? r20.xy : r20.zx;
      r20.x = 1;
      ...
      while (true) {
        ...
        r21.x = r20.z * r19.w;
        r20.w = (uint)r17.w >> 2;
        if (1 == 0) r21.z = 0; else if (1+2 < 32) {         r21.z = (uint)r17.w << (32-(1 + 2)); r21.z = (uint)r21.z >> (32-1);        } else r21.z = (uint)r17.w >> 2;
        r21.w = (int)r20.w & 2;
      ...
      r13.z = saturate(r21.y + -r13.w);
      r14.w = refProbeConstantsCB[r0.y].data[6].y * r13.z;
      r15.y = cmp(0 < r14.w);
      if (r15.y != 0) {
        r13.w = r13.z * refProbeConstantsCB[r0.y].data[6].y + r13.w;
        r13.z = refProbeConstantsCB[r0.y].data[7].y * r14.w;
        r20.x = refProbeConstantsCB[r0.y].data[7].w;
        r20.yz = refProbeConstantsCB[r0.y].data[8].xy;
        r14.w = dot(r16.xyz, r20.xyz);
        r15.y = dot(r19.xyz, r20.xyz);
        r15.y = -refProbeConstantsCB[r0.y].data[8].z + r15.y;
        r15.w = cmp(r15.y >= 0);
        r15.y = max(abs(r15.y), r9.w);
        r15.y = r15.w ? r15.y : -r15.y;
        ...
        r15.y = dot(r16.xyz, r20.xyz);
        r15.w = dot(r19.xyz, r20.xyz);
        r15.w = -refProbeConstantsCB[r0.y].data[9].z + r15.w;
        r17.w = cmp(r15.w >= 0);
        ...
        r15.y = dot(r16.xyz, r20.xyz);
        r15.w = dot(r19.xyz, r20.xyz);
        r15.w = -refProbeConstantsCB[r0.y].data[10].z + r15.w;
        r17.w = cmp(r15.w >= 0);
        r15.w = max(abs(r15.w), r9.w);
        r15.w = r17.w ? r15.w : -r15.w;
        r15.y = max(1.00000001e-07, -r15.y);
        ...
        r15.y = dot(r16.xyz, r20.xyz);
        r15.w = dot(r19.xyz, r20.xyz);
        r15.w = -refProbeConstantsCB[r0.y].data[11].z + r15.w;
        r17.w = cmp(r15.w >= 0);
        r15.w = max(abs(r15.w), r9.w);
        r15.w = r17.w ? r15.w : -r15.w;
        r15.y = max(1.00000001e-07, -r15.y);
        ...
        r15.y = dot(r16.xyz, r20.xyz);
        r15.w = dot(r19.xyz, r20.xyz);
        r15.w = -refProbeConstantsCB[r0.y].data[12].z + r15.w;
        r17.w = cmp(r15.w >= 0);
        r15.w = max(abs(r15.w), r9.w);
        r15.w = r17.w ? r15.w : -r15.w;
        r15.y = max(1.00000001e-07, -r15.y);
        ...
        r15.y = dot(r16.xyz, r20.xyz);
        r15.w = dot(r19.xyz, r20.xyz);
        r15.w = -refProbeConstantsCB[r0.y].data[13].z + r15.w;
        r17.w = cmp(r15.w >= 0);
        r9.w = max(abs(r15.w), r9.w);
        r9.w = r17.w ? r9.w : -r9.w;
        r15.y = max(1.00000001e-07, -r15.y);
        r9.w = r9.w / r15.y;
        r9.w = min(r14.w, abs(r9.w));
        r20.x = refProbeConstantsCB[r0.y].data[3].w + r19.x;
        r20.yz = refProbeConstantsCB[r0.y].data[4].xy + r19.yz;
        r20.xyz = r16.xyz * r9.www + r20.xyz;
        ...
        r22.w = (uint)r9.w;
        r20.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r22.xyzw, r8.w).xyz;
        ...
        r8.w = r12.w * r0.y;
        r19.xyz = r20.xyz * r13.zzz;
        r9.w = dot(r19.xyz, float3(0.212599993,0.715200007,0.0722000003));
        r0.y = r12.w * r0.y + r9.w;
        r0.y = r8.w / r0.y;
        r18.xyz = r19.xyz * r0.yyy + r18.xyz;
      }
    }
  }
  r0.y = max(1, r13.w);
  ...
  r19.xyz = r17.xyz * r0.yyy;
  r18.xyz = r18.xyz * r0.yyy;
  r8.w = cmp(r13.w < 0.99000001);
  if (r8.w != 0) {
    r8.w = 1 + -r13.w;
    r9.w = sunConstants.globalProbeExposure * r8.w;
    r20.xyz = -globalProbeConstants.data[0].xyz + r10.xyz;
    ...
    r21.xyz = cmp(float3(0,0,0) < r11.xyz);
    ...
    r11.w = 0;
    r21.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r11.xyzw, 6).xyz;
    r20.xyz = r21.xyz * r20.xyz;
    r9.w = dot(r20.xyz, float3(0.212599993,0.715200007,0.0722000003));
    r19.xyz = r17.xyz * r0.yyy + r20.xyz;
    r16.w = 0;
    r17.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r16.xyzw, r9.y).xyz;
    r0.y = sunConstants.globalProbeExposure * r8.w + -r9.w;
    r0.y = r2.y * r0.y + r9.w;
    r18.xyz = r17.xyz * r0.yyy + r18.xyz;
  }
  r0.y = r4.z * r2.z + r2.x;
  r0.y = log2(abs(r0.y));
  r0.y = r1.w * r0.y;
  ...
  r17.xyz = r19.xyz * r2.www;
  r20.xyz = r0.www ? r17.yzx : 0;
  ...
  if (r2.z != 0) {
    ...
    if (r2.z != 0) {
      ...
      r5.w = cmp(0 < r5.w);
      r19.xyz = r19.xyz * r2.www + r23.xyz;
      ...
      r19.w = r20.z;
      r17.w = r22.z;
      r17.xyzw = r5.wwww ? r19.xyzw : r17.xyzw;
      r20.zw = r9.xy;
      r22.zw = r21.xy;
      r19.xyzw = r5.wwww ? r20.xyzw : r22.xyzw;
      r23.x = r9.w;
      r18.w = r21.z;
        ...
        if (r12.w != 0) {
          ...
          if (r12.w != 0) {
            ...
            while (true) {
              ...
              if (r15.y != 0) break;
              r39.y = dot(icb[r14.w+0].yx, r19.xy);
              r39.z = dot(icb[r14.w+0].yx, r19.yz);
              ...
              if (r13.z == 0) {
                ...
                if (enableDitheredShadow != 0) {
                  ...
                  while (true) {
                    ...
                    if (r15.w != 0) break;
                    r37.x = dot(icb[r15.y+0].yx, r19.xw);
              ...
              if (r16.w == 0) {
                ...
                if (enableDitheredShadow != 0) {
                  ...
                  while (true) {
                    ...
                    if (r20.w != 0) break;
                    r26.x = dot(icb[r18.w+0].xy, r29.xy);
                    r26.y = dot(icb[r18.w+0].yx, r29.xz);
                  ...
                  r25.z = (uint)r16.w;
                  r17.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r25.xyz, r15.w).x;
                }
                r12.w = r17.w * r17.w;
                r12.w = r12.w * r17.w;
              } else {
                ...
                if (r15.w == 0) {
                  ...
                  if (enableDitheredShadow != 0) {
                    ...
                    while (true) {
                      r20.w = cmp((int)r18.w >= 8);
                      if (r20.w != 0) break;
                      r26.x = dot(icb[r18.w+0].xy, r30.xy);
                      r26.y = dot(icb[r18.w+0].yx, r30.xz);
