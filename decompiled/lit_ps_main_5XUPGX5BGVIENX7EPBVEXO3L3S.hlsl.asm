...
mul o0.w, r0.w, r1.x
sample_indexable(texture2d)(float,float,float,float) r0.w, v1.yzyy, t26.yzwx, s7
sample_indexable(texture2d)(float,float,float,float) r1.x, v1.yzyy, t25.xyzw, s5
add r1.y, -cb0[12].x, cb0[12].y
mad r1.x, r1.x, r1.y, cb0[12].x
mul_sat r1.x, r1.x, l(0.05882353)
sample_indexable(texture2d)(float,float,float,float) r1.yzw, v1.yzyy, t24.wxyz, s6
