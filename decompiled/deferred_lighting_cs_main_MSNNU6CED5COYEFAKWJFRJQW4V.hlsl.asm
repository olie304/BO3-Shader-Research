...
loop 
  ...
  if_nz r16.z
    ...
    if_nz r16.w
      ...
      div r18.x, r18.w, r18.x
      min r16.w, r16.w, |r18.x|
      mov r27.x, cb10[r16.y + 10].w
      mov r27.yz, cb10[r16.y + 11].xxyx
      dp3 r18.x, r17.xyzx, r27.xyzx
      dp3 r18.w, r25.xyzx, r27.xyzx
      ...
      div r18.x, r18.w, r18.x
      min r16.w, r16.w, |r18.x|
      mov r27.x, cb10[r16.y + 11].w
      mov r27.yz, cb10[r16.y + 12].xxyx
      dp3 r18.x, r17.xyzx, r27.xyzx
      dp3 r18.w, r25.xyzx, r27.xyzx
      ...
      div r18.x, r18.w, r18.x
      min r16.w, r16.w, |r18.x|
      mov r27.x, cb10[r16.y + 12].w
      mov r27.yz, cb10[r16.y + 13].xxyx
      dp3 r18.x, r17.xyzx, r27.xyzx
      dp3 r18.w, r25.xyzx, r27.xyzx
      ...
      div r18.x, r18.w, r18.x
      min r16.w, r16.w, |r18.x|
      add r27.x, r25.x, cb10[r16.y + 3].w
      add r27.yz, r25.yyzy, cb10[r16.y + 4].xxyx
      mad r20.yzw, r17.xxyz, r16.wwww, r27.xxyz
      dp3 r18.x, r20.yzwy, r20.yzwy
      sqrt r18.x, r18.x
      div r16.w, r16.w, r18.x
      add r16.w, r16.w, r16.w
      sqrt r16.w, r16.w
      mad r16.w, r7.w, l(5.000000), r16.w
      add r16.w, r16.w, l(-0.844800)
      mov r27.x, cb10[r16.y + 0].w
      mov r27.y, cb10[r16.y + 1].z
      mov r27.z, cb10[r16.y + 2].y
      dp3 r28.x, r20.yzwy, r27.xyzx
      mov r29.xy, cb10[r16.y + 1].xwxx
      mov r29.z, cb10[r16.y + 2].z
      dp3 r28.y, r20.yzwy, r29.xyzx
      mov r30.x, cb10[r16.y + 1].y
      mov r30.yz, cb10[r16.y + 2].xxwx
      dp3 r28.z, r20.yzwy, r30.xyzx
      ubfe r18.x, l(9), l(16), cb10[r16.y + 7].z
      utof r28.w, r18.x
      sample_l_indexable(texturecubearray)(float,float,float,float) r20.yzw, r28.xyzw, t8.wxyz, s2, r16.w
      dp3 r31.x, r25.xyzx, r27.xyzx
      dp3 r31.y, r25.xyzx, r29.xyzx
      dp3 r31.z, r25.xyzx, r30.xyzx
      mad_sat r25.xyz, r31.xyzx, cb10[r16.y + 3].xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
      mul r31.xy, r25.xyxx, cb10[r16.y + 4].zwzz
      mul r31.z, r25.z, cb10[r16.y + 5].x
      add r25.xyz, r31.xyzx, cb10[r16.y + 5].yzwy
...
if_nz r15.w
  ...
  loop 
    ieq r18.w, r15.w, l(2)
    breakc_nz r18.w
    movc r18.w, r15.w, r0.y, r15.z
    ult r19.w, r18.w, r15.y
    if_nz r19.w
      imul null, r18.w, r18.w, l(14)
      add r26.xyz, r11.xyzx, -cb10[r18.w + 0].xyzx
      ...
      movc r27.xy, r20.wwww, r18.xyxx, r18.zxzz
      ...
      loop 
        ...
        dp3 r22.w, cb11[r21.w + 0].xyzx, r26.xyzx
        add_sat r22.w, r22.w, cb11[r21.w + 0].w
        mul r22.w, r22.w, r28.x
        dp3 r26.w, cb11[r21.w + 1].xyzx, r26.xyzx
        add_sat r26.w, r26.w, cb11[r21.w + 1].w
        mul r22.w, r22.w, r26.w
        dp3 r26.w, cb11[r21.w + 2].xyzx, r26.xyzx
        add_sat r26.w, r26.w, cb11[r21.w + 2].w
        mul r22.w, r22.w, r26.w
        dp3 r26.w, cb11[r21.w + 3].xyzx, r26.xyzx
        add_sat r26.w, r26.w, cb11[r21.w + 3].w
        mul r22.w, r22.w, r26.w
        dp3 r26.w, cb11[r21.w + 4].xyzx, r26.xyzx
        add_sat r26.w, r26.w, cb11[r21.w + 4].w
        mul r22.w, r22.w, r26.w
        dp3 r26.w, cb11[r21.w + 5].xyzx, r26.xyzx
        add_sat r21.w, r26.w, cb11[r21.w + 5].w
        ...
        movc r20.y, r27.w, r21.w, r28.z
        movc r28.xy, r27.zzzz, r28.xyxx, r20.xyxx
        iadd r20.w, r20.w, l(1)
        mov r18.x, r26.w
      endloop 
      ...
      if_nz r20.y
        ...
        mad r20.yzw, r17.xxyz, r19.wwww, r27.xxyz
        ...
        utof r29.w, r20.y
        sample_l_indexable(texturecubearray)(float,float,float,float) r20.yzw, r29.xyzw, t8.wxyz, s2, r19.w
        dp3 r32.x, r26.xyzx, r27.xyzx
        dp3 r32.y, r26.xyzx, r30.xyzx
        dp3 r32.z, r26.xyzx, r31.xyzx
        mad_sat r26.xyz, r32.xyzx, cb10[r18.w + 3].xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
        mul r32.xy, r26.xyxx, cb10[r18.w + 4].zwzz
        mul r32.z, r26.z, cb10[r18.w + 5].x
        add r26.xyz, r32.xyzx, cb10[r18.w + 5].yzwy
        ...
        dp3 r18.w, r28.xzwx, l(0.212600, 0.715200, 0.072200, 0.000000)
        mad r16.yzw, r26.xxyz, r27.xxyz, r16.yyzw
        mul r19.z, r14.w, r18.w
        mul r20.yzw, r18.xxxx, r20.yyzw
        dp3 r18.x, r20.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
        mad r18.x, r14.w, r18.w, r18.x
        div r18.x, r19.z, r18.x
        mad r25.xyz, r20.yzwy, r18.xxxx, r25.xyzx
      endif 
    endif 
    iadd r15.w, r15.w, l(1)
  endloop 
...
lt r7.w, r24.w, l(0.990000)
if_nz r7.w
  add r7.w, -r24.w, l(1.000000)
...
mul r0.y, r0.y, r0.y
mul r3.z, r0.y, l(0.500000)
mad r0.y, -r0.y, l(0.500000), l(1.000000)
mad r4.w, r2.x, r0.y, r3.z
mul r0.y, r0.y, r4.w
mul r3.z, r3.z, r4.w
  ...
  if_nz r4.w
    ...
    if_nz r7.w
      ...
      if_z r7.w
        ...
        and r9.w, l(0x0000ffff), cb9[r5.z + 1].w
        if_nz cb2[58].y
          mov r21.x, -r3.x
          utof r22.z, r9.w
          mov r21.y, r14.x
    ...
    mad r15.yzw, r4.wwww, r10.yyzw, r2.yyzw
