// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:33:16 2021
...
cbuffer _Globals : register(b0)
{
  ...
  float2 commonScale : packoffset(c34);
}
...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  r5.w = 0;
  while (true) {
    r6.z = cmp((uint)r5.w >= numStaticDecals);
    if (r6.z != 0) break;
    r11.z = (uint)r5.w >> 5;
    r12.xyz = (int3)r10.xyz + (int3)r11.xyz;
    r6.z = visibleDecals.Load(r12.xyzw).x;
    r6.w = cmp((int)r0.x == (int)r5.w);
    if (r1.w == 0) r7.w = 0; else if (r1.w+0 < 32) {     r7.w = (uint)r6.z << (32-(r1.w + 0)); r7.w = (uint)r7.w >> (32-r1.w);    } else r7.w = (uint)r6.z >> 0;
    r6.z = r6.w ? r7.w : r6.z;
    ...
    while (true) {
      ...
      r19.y = samp0[]..swiz;
        ...
        r20.z = samp0[]..swiz;
          ...
          r11.w = rsqrt(r11.w);
          r22.xyz = r21.xyz * r11.www;
          r11.w = dot(r22.xyz, r3.xyz);
          r11.w = cmp(r11.w >= 0.5);
          if (r11.w != 0) {
          // Known bad code for instruction (needs manual fix):
          ...
          r23.w = samp0[]..swiz;
            ...
            r20.w = samp0[]..swiz;
              ...
              if (r21.z != 0) {
                if (4 == 0) r11.w = 0; else if (4+24 < 32) {                 r11.w = (uint)r19.w << (32-(4 + 24)); r11.w = (uint)r11.w >> (32-4);                } else r11.w = (uint)r19.w >> 24;
                r11.w = 1 << (int)r11.w;
                r13.w = (uint)r19.w >> 28;
                r13.w = 1 << (int)r13.w;
              ...
              if (r21.w != 0) {
                ...
                if (r15.w != 0) {
                  ...
                  r27.xyz = r30.xyz * r27.xyz;
                  r15.w = materialTexMask.SampleGrad(samplerLinearClamp_s, r28.xyz, r29.x, r27.x).x;
                } else {
                  r16.w = cmp((int)r21.w == 4);
                  if (r16.w != 0) {
              ...
              if (r19.x != 0) {
                ...
                r11.z = samp0[]..swiz;
                  ...
                  r28.xyz = r31.xyz * r28.xyz;
                  r11.z = materialTexMask.SampleGrad(samplerLinearClamp_s, r29.xyz, r30.z, r28.z).x;
                } else {
              ...
              r11.z = saturate(0.764705896 * r11.z);
              if (r19.y != 0) {
                ...
                r15.w = rsqrt(r15.w);
                r20.xyz = r24.xyz * r15.www;
                r15.w = dot(-r23.xyz, -r23.xyz);
                r15.w = rsqrt(r15.w);
                r21.xyz = -r23.xyz * r15.www;
                ...
                r16.xyz = r19.xyz * r11.www + r20.xyz;
              }
              r13.w = 1 + -r11.w;
              r19.xyz = r13.www * r12.xyz;
              r12.xyz = r18.xyz * r11.www + r19.xyz;
              r18.xyz = r17.xyz * r13.www;
              r17.xyz = r27.xyz * r11.www + r18.xyz;
              r7.w = r7.w * r13.w + r11.w;
              r13.w = r13.w * r8.w;
              r8.w = r11.z * r11.w + r13.w;
            }
          }
        }
      }
  ...
  r3.w = saturate(r3.w);
  r0.x = 1 + -r3.w;
  r1.xyz = r1.xyz * r0.xxx + r13.xyz;
  o0.w = r0.z * r0.x + r3.w;
  r2.xyz = r2.xzw * r0.xxx + r14.xyz;
  r0.y = dot(r2.xyz, r2.xyz);
  r0.y = rsqrt(r0.y);
  r2.xyz = r2.xyz * r0.yyy;
  r7.y = r0.w * r0.x + r4.w;
  r0.yzw = r0.xxx * float3(0.0399999991,0.0399999991,0.0399999991) + r15.xyz;
  ...
  if (r1.w != 0) {
    ...
    r6.zw = -r12.xy / r1.ww;
    r6.zw = r3.ww ? r6.zw : 0;
    r7.zw = float2(-0.5,-0.5) + v2.xy;
    r1.w = 9.99999975e-06 + layerDepth;
    r6.zw = r6.zw * r1.ww;
    r6.zw = scaleUVs.xy * r6.zw;
    r6.zw = r7.zw * scaleUVs.xy + r6.zw;
    ...
    r12.y = r12.x;
    r12.z = r11.x;
    r13.x = dot(r12.yz, r6.zw);
    r12.x = -r11.x;
    r13.y = dot(r12.xy, r6.zw);
    r6.zw = gameTime.ww * scrollUVs.xy;
    r6.zw = r6.zw * scaleUVs.xy + r13.xy;
    ...
    r7.zw = saturate(r6.zw);
    r8.xy = clampU ? r7.zw : r6.zw;
  }
  r8.xyzw = emissiveMap1.Sample(colorSampler_s, r8.xy).xyzw;
  r8.xyzw = emissiveTint1.xyzw * r8.xyzw;
  r8.xyz = r8.xyz * r8.www;
  r1.w = v3.x + v3.y;
  r1.w = v3.z + r1.w;
  r3.w = flickerSeed.y + r1.w;
  r3.w = frac(r3.w);
  r11.y = gameTime.w * flickerSpeed + r3.w;
  r11.x = flickerSeed.x;
  r3.w = flickerLookupMap.SampleLevel(lookupSampler_s, r11.xy, 0).x;
  r3.w = log2(abs(r3.w));
  ...
  r3.w = cmp(0.5 < uvMotionToggle2);
  if (r3.w != 0) {
    r3.w = columnCount2 * rowCount2;
    r4.w = imageTime2 * r3.w;
    ...
    r3.w = r4.w * r3.w;
    r3.w = round(r3.w);
    r4.w = r3.w / columnCount2;
    r5.w = columnCount2 * r3.w;
    r5.w = cmp(r5.w >= -r5.w);
    ...
    r3.w = trunc(r3.w);
    r3.w = v2.x + r3.w;
    r11.x = r3.w / columnCount2;
    r3.w = trunc(r4.w);
    r3.w = v2.y + r3.w;
    r11.y = r3.w / rowCount2;
  } else {
    r3.w = dot(-v7.xyz, -v7.xyz);
    r3.w = rsqrt(r3.w);
    r12.xyz = -v7.xyz * r3.www;
    r13.x = dot(r12.xyz, r4.xyz);
    r13.y = dot(r12.xyz, r5.xyz);
    r3.w = dot(r12.xyz, r3.xyz);
    r4.w = cmp(0 < r3.w);
    r6.zw = -r13.xy / r3.ww;
    r6.zw = r4.ww ? r6.zw : 0;
    r7.zw = float2(-0.5,-0.5) + v2.xy;
    r3.w = 9.99999975e-06 + layer2Depth;
    r6.zw = r6.zw * r3.ww;
    r6.zw = scaleUVs2.xy * r6.zw;
    r6.zw = r7.zw * scaleUVs2.xy + r6.zw;
    r6.zw = offsetUVs2.xy * scaleUVs2.xy + r6.zw;
    r3.w = rotateUVs2.y * gameTime.w + 1;
    r3.w = rotateUVs2.x * r3.w;
    r3.w = 0.0174532924 * r3.w;
    sincos(r3.w, r12.x, r13.x);
    r13.y = r13.x;
    r13.z = r12.x;
    r14.x = dot(r13.yz, r6.zw);
    r13.x = -r12.x;
    r14.y = dot(r13.xy, r6.zw);
    r6.zw = gameTime.ww * scrollUVs2.xy;
    r6.zw = r6.zw * scaleUVs2.xy + r14.xy;
    r3.w = gameTime.w * zoomRate2;
    r3.w = cos(r3.w);
    r3.w = r3.w * 0.5 + 0.5;
    r3.w = 1 + -r3.w;
    r4.w = zoomUVs2.y + -zoomUVs2.x;
    r3.w = r3.w * r4.w + zoomUVs2.x;
    r6.zw = r6.zw / r3.ww;
    r6.zw = float2(0.5,0.5) + r6.zw;
    r7.zw = saturate(r6.zw);
    r11.x = clampU2 ? r7.z : r6.z;
    r11.y = clampV2 ? r7.w : r6.w;
  }
  ...
  r3.w = clampV2 + r1.w;
  r3.w = frac(r3.w);
  r12.y = gameTime.w * clampV2 + r3.w;
  r12.x = clampV2;
  r3.w = flickerLookupMap.SampleLevel(lookupSampler_s, r12.xy, 0).x;
  r3.w = log2(abs(r3.w));
  r3.w = flickerPower2 * r3.w;
  r3.w = exp2(r3.w);
  r4.w = flickerRange2.y + -flickerRange2.x;
  r3.w = r3.w * r4.w + flickerRange2.x;
  r11.xyz = r11.xyz * r3.www;
  r3.w = 1 + -r11.w;
  r8.xyz = r8.xyz * r3.www + r11.xyz;
  r3.w = cmp(0.5 < uvMotionToggle3);
  if (r3.w != 0) {
    r3.w = columnCount3 * rowCount3;
    r4.w = imageTime3 * r3.w;
    r5.w = gameTime.w * r4.w;
    r5.w = cmp(r5.w >= -r5.w);
    r5.w = r5.w ? r4.w : -r4.w;
    r6.z = 1 / r5.w;
    ...
    r3.w = r4.w * r3.w;
    r3.w = round(r3.w);
    r4.w = r3.w / columnCount3;
    r5.w = columnCount3 * r3.w;
    r5.w = cmp(r5.w >= -r5.w);
    ...
    r3.w = trunc(r3.w);
    r3.w = v2.x + r3.w;
    r11.x = r3.w / columnCount3;
    r3.w = trunc(r4.w);
    r3.w = v2.y + r3.w;
    r11.y = r3.w / rowCount3;
  } else {
    r3.w = dot(-v7.xyz, -v7.xyz);
    r3.w = rsqrt(r3.w);
    r12.xyz = -v7.xyz * r3.www;
    ...
    r3.z = gameTime.w * zoomRate3;
    r3.z = cos(r3.z);
    r3.z = r3.z * 0.5 + 0.5;
    r3.z = 1 + -r3.z;
    r3.w = zoomUVs3.y + -zoomUVs3.x;
    r3.z = r3.z * r3.w + zoomUVs3.x;
    r3.xy = r3.xy / r3.zz;
  ...
  r1.w = clampV3 + r1.w;
  r1.w = frac(r1.w);
  r4.y = gameTime.w * clampV3 + r1.w;
  r4.x = clampV3;
  r1.w = flickerLookupMap.SampleLevel(lookupSampler_s, r4.xy, 0).x;
  r1.w = log2(abs(r1.w));
  r1.w = flickerPower3 * r1.w;
  r1.w = exp2(r1.w);
  r4.x = flickerRange3.y + -flickerRange3.x;
  r1.w = r1.w * r4.x + flickerRange3.x;
  ...
  while (true) {
    ...
    r11.w = cmp((int)r7.z == (int)r11.y);
    bitmask.z = ((~(-1 << r7.w)) << 0) & 0xffffffff;  r13.z = (((uint)0 << 0) & bitmask.z) | ((uint)r11.z & ~bitmask.z);
  ...
  if (r8.w != 0) {
    ...
    r10.w = 0;
    while (true) {
      r13.w = cmp((uint)r10.w >= (uint)r6.w);
      if (r13.w != 0) break;
      r13.z = (uint)r10.w >> 5;
      r14.xyz = (int3)r10.xyz + (int3)r13.xyz;
      r13.z = visibleProbes.Load(r14.xyzw).x;
      r13.w = cmp((int)r7.z == (int)r10.w);
      if (r7.w == 0) r14.x = 0; else if (r7.w+0 < 32) {       r14.x = (uint)r13.z << (32-(r7.w + 0)); r14.x = (uint)r14.x >> (32-r7.w);      } else r14.x = (uint)r13.z >> 0;
  ...
  r13.xyz = r20.xyz * r5.yyy;
  r11.yzw = r21.xyz * r5.yyy;
  ...
  if (r5.w != 0) {
    ...
    r13.xyz = r20.xyz * r5.yyy + r14.xyz;
    r12.w = 0;
    r14.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r12.xyzw, r5.z).xyz;
    r5.y = sunConstants.globalProbeExposure * r5.w + -r2.w;
    r2.w = r7.y * r5.y + r2.w;
    r11.yzw = r14.xyz * r2.www + r11.yzw;
  }
  r5.yz = r7.xy * float2(0.984375,0.984375) + float2(0.0078125,0.0078125);
  r5.yz = gEnvBRDFGeneric.SampleLevel(samplerLinear_s, r5.yz, 0).xy;
  r14.xyz = r11.zwy * r5.yyy;
  r5.yzw = r11.yzw * r5.zzz;
  r2.w = sqrt(r4.w);
  r2.w = r2.w * 0.5 + 0.5;
  r2.w = r2.w * r2.w;
  r6.z = 0.5 * r2.w;
  ...
  if (r7.z == 0) {
    ...
    r7.z = -sunConstants.splitDepthOffset + r11.w;
    ...
    if (r12.w == 0) {
      if (enableDitheredShadow == 0) {
        ...
        r15.z = r11.w + r8.w;
        r11.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r15.xyz, r7.z).x;
      ...
      if (enableDitheredShadow != 0) {
        ...
        r11.yz = -sunConstants.splitPinTransform[r8.w].xy + r11.yz;
        ...
        while (true) {
          ...
          r16.w = r16.z ? sunConstants.splitPinTransform[r8.w].w : sunConstants.splitPinTransform[r11.w].w;
          r16.z = r16.z ? r8.w : r11.w;
          ...
          r17.z = (uint)r16.z;
          r16.z = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r17.xyz, r7.z).x;
  ...
  if (r7.z != 0) {
    r7.z = cmp(0 < r7.w);
    if (r7.z != 0) {
      r7.z = sunConstants.specScale * r3.w;
      r7.z = r7.z * r7.y;
      if (sunConstants.sunCookieIndex != 0) {
        ...
        r15.z = (uint)r8.w;
        r9.xyz = gCookieArray.SampleLevel(samplerLinear_s, r15.xyz, 0).xyz;
      ...
      r18.w = samp0[]..swiz;
        ...
        r16.y = samp0[]..swiz;
          ...
          if (enableDitheredShadow != 0) {
            ...
            r15.z = (uint)r10.w;
            r11.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r15.xyz, r8.w).x;
          }
          r8.w = r11.y * r11.y;
          r8.w = r8.w * r11.y;
        } else {
      ...
      r7.y = r7.w * r7.y;
      r7.y = 0.25 * r7.y;
      r11.yzw = r7.yyy * r9.xyz + r5.yzw;
      r0.x = saturate(1 + -r0.x);
      r7.z = r0.x * r0.x;
      r7.z = r7.z * r7.z;
      r0.x = r7.z * r0.x;
      r0.x = r7.y * r0.x;
      r9.xyz = r0.xxx * r9.yzx + r14.xyz;
      r15.w = r9.z;
      r13.w = r14.z;
      r13.xyzw = r6.wwww ? r15.xyzw : r13.xyzw;
      r9.zw = r11.yz;
      r14.zw = r5.yz;
      r9.xyzw = r6.wwww ? r9.xyzw : r14.xyzw;
      r5.w = r6.w ? r11.w : r5.w;
      r14.z = r13.w;
      r14.xy = r9.xy;
      r5.yz = r9.zw;
    }
  ...
  r8.w = 0;
  while (true) {
    r10.w = cmp((uint)r8.w >= numLights);
    if (r10.w != 0) break;
    r7.z = (uint)r8.w >> 5;
    r15.xyz = (int3)r7.xyz + (int3)r10.xyz;
    ...
    while (true) {
      ...
      r31.y = samp0[]..swiz;
        ...
        r36.z = samp0[]..swiz;
        r36.w = samp0[]..swiz;
          if (3 == 0) r14.w = 0; else if (3+24 < 32) {           r14.w = (uint)r31.w << (32-(3 + 24)); r14.w = (uint)r14.w >> (32-3);          } else r14.w = (uint)r31.w >> 24;
          switch (r14.w) {
            case 4 :            r14.w = cmp(0 < r36.x);
            r37.xy = r35.zw;
            r37.z = r36.w;
            r38.xyz = -r37.xyz * float3(0.5,0.5,0.5) + r30.yzw;
            r39.xyz = -v7.xyz + r38.xyz;
            r19.w = dot(r37.xyz, r39.xyz);
            r23.w = saturate(-r19.w / r36.x);
            r40.xyz = r23.www * r37.xyz + r38.xyz;
            r40.xyz = r14.www ? r40.xyz : r30.yzw;
            r40.xyz = -v7.xyz + r40.xyz;
            r24.w = dot(r40.xyz, r40.xyz);
            r25.w = rsqrt(r24.w);
            r40.xyz = r40.xyz * r25.www;
            r25.w = dot(r2.xyz, r40.xyz);
            ...
            if (r27.w != 0) {
              ...
              r24.w = r28.w / r24.w;
              r24.w = min(1, r24.w);
              r40.xy = saturate(r27.ww * r32.xz + r32.yw);
              ...
              r27.w = cmp(0 < r24.w);
              if (r27.w != 0) {
                if (3 == 0) r27.w = 0; else if (3+27 < 32) {                 r27.w = (uint)r31.w << (32-(3 + 27)); r27.w = (uint)r27.w >> (32-3);                } else r27.w = (uint)r31.w >> 27;
                r27.w = cmp((int)r27.w != 1);
                if (r27.w != 0) {
                  r27.w = abs(r25.w) * -0.200000003 + 0.400000006;
                  r40.xyz = r2.xyz * r27.www + v7.xyz;
                  r40.xyz = r40.xyz + -r34.xyz;
                  r27.w = max(abs(r40.y), abs(r40.z));
                  r27.w = max(abs(r40.x), r27.w);
                  r27.w = r35.x / r27.w;
                  r27.w = r27.w + r35.y;
                  r28.w = dot(r40.xyz, r40.xyz);
                  r28.w = rsqrt(r28.w);
                  r27.w = max(6.10351563e-05, r27.w);
                  r29.w = (int)r31.w & 0x0000ffff;
                  r41.w = (uint)r29.w;
                  r29.w = 0;
                  r37.w = 0;
                  while (true) {
                    r38.w = cmp((int)r37.w >= 8);
                    if (r38.w != 0) break;
                    r42.y = dot(icb[r37.w+0].yx, r9.xy);
                    r42.z = dot(icb[r37.w+0].yx, r9.yz);
                    r42.yz = r42.yz * r33.yy;
                    r42.x = r42.y * r11.x;
                    r42.w = r42.y * r5.x;
                    r41.xyz = r40.xyz * r28.www + r42.xzw;
                    r38.w = gOmniShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r41.xyzw, r27.w).x;
                ...
                if (r27.w != 0) {
                  r27.w = r31.x * r3.w;
                  r27.w = 0.25 * r27.w;
                  r28.w = dot(r37.xyz, r12.xyz);
                  r37.w = dot(r12.xyz, r39.xyz);
                  r38.w = -r28.w * r28.w + r36.x;
                  r19.w = r28.w * r37.w + -r19.w;
                  r19.w = saturate(r19.w / r38.w);
                  r28.w = r38.w / r36.x;
                  r28.w = 10 * r28.w;
                  r28.w = min(1, r28.w);
                  r19.w = r19.w + -r23.w;
                  r19.w = r28.w * r19.w + r23.w;
                  r37.xyz = r19.www * r37.xyz + r38.xyz;
                  r37.xyz = r14.www ? r37.xyz : r30.yzw;
                  r37.xyz = -v7.xyz + r37.xyz;
                  r14.w = dot(r37.xyz, r37.xyz);
                  r14.w = rsqrt(r14.w);
                  r38.xyz = r37.xyz * r14.www;
                  if (4 == 0) r19.w = 0; else if (4+16 < 32) {                   r19.w = (uint)r31.w << (32-(4 + 16)); r19.w = (uint)r19.w >> (32-4);                  } else r19.w = (uint)r31.w >> 16;
                  r23.w = cmp(0 < (uint)r19.w);
                  r23.w = r1.w ? r23.w : 0;
                  if (r23.w != 0) {
                  ...
                  r40.w = samp0[]..swiz;
                    ...
                    r17.xyz = r2.xyz * r28.www + v7.xyz;
                    r28.w = dot(r39.xyzw, r17.xyzw);
                    r37.w = dot(r40.xyzw, r17.xyzw);
                    r38.w = cmp(r37.w < r28.w);
                    if (r38.w == 0) {
                    // Known bad code for instruction (needs manual fix):
                    ...
                    r43.y = samp0[]..swiz;
                      ...
                      r17.x = r43.y * r37.w;
                      r17.y = r43.x * r37.w + r28.w;
                      r17.x = r17.y / r17.x;
                    } else {
                      r17.z = -1;
                    }
                    r17.y = (int)r38.w | (int)r17.z;
                    if (r17.y == 0) {
                    // Known bad code for instruction (needs manual fix):
                    ...
                    r17.y = samp0[]..swiz;
                      ...
                      if (r10.w != 0) {
                        ...
                        r19.w = 0;
                        while (true) {
                          r28.w = cmp((int)r19.w >= 8);
                          if (r28.w != 0) break;
                          r41.x = dot(icb[r19.w+0].yx, r9.xw);
                          r41.y = dot(icb[r19.w+0].xy, r6.xy);
                          r40.xy = r41.xy * r23.ww + r39.xy;
                          r28.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r40.xyz, r17.x).x;
                          r17.z = r28.w * 0.125 + r17.z;
                          r19.w = (int)r19.w + 1;
                        }
                      } else {
                        r39.z = (uint)r17.y;
                    ...
                    r40.z = samp0[]..swiz;
                    r40.w = samp0[]..swiz;
                      r19.w = abs(r25.w) * -0.200000003 + 0.400000006;
                      r18.xyz = r2.xyz * r19.www + v7.xyz;
                      r19.w = dot(r39.xyzw, r18.xyzw);
                      r23.w = dot(r40.xyzw, r18.xyzw);
                      r28.w = cmp(r23.w < r19.w);
                      if (r28.w == 0) {
                      // Known bad code for instruction (needs manual fix):
                      ...
                      r17.x = samp0[]..swiz;
                        ...
                        if (r10.w != 0) {
                          ...
                          r18.yz = float2(0,0);
                          while (true) {
                            r19.w = cmp((int)r18.z >= 8);
                            if (r19.w != 0) break;
                            r41.x = dot(icb[r18.z+0].xy, r8.xy);
                            r41.y = dot(icb[r18.z+0].yx, r8.xz);
                            r40.xy = r41.xy * r17.yy + r39.xy;
                            r19.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r40.xyz, r18.x).x;
                            r18.y = r19.w * 0.125 + r18.y;
                            r18.z = (int)r18.z + 1;
                          }
                        } else {
                          r39.z = (uint)r17.x;
                  ...
                  r17.x = r17.x + -r26.w;
                  r17.x = r4.w * r17.x + r26.w;
                  r17.x = r17.x * r24.w;
                  r31.x = r30.x;
                  r17.y = cmp(0 < r25.w);
                  r39.xyz = r17.xxx * r31.xyz + r15.xyz;
                  r17.x = saturate(dot(r2.xyz, r38.xyz));
                  r37.xyz = r37.xyz * r14.www + r4.xyz;
                  r14.w = dot(r37.xyz, r37.xyz);
                  r14.w = rsqrt(r14.w);
                  r37.xyz = r37.xyz * r14.www;
                  r14.w = dot(r37.xyz, r4.xyz);
                  r18.x = dot(r2.xyz, r37.xyz);
                  r18.z = abs(r18.x) * r3.w + -abs(r18.x);
                  r18.x = abs(r18.x) * r18.z + 1;
                  r18.z = r17.x * r2.w + r6.z;
                  r18.x = r18.x * r18.x;
                  r18.x = r18.x * r18.z;
                  r18.x = rcp(r18.x);
                  r17.x = r17.x * r27.w;
                  r17.x = r18.x * r17.x;
                  r17.x = r17.x * r24.w;
                  r37.xyz = r17.xxx * r31.xyz + r29.xyz;
                  r14.w = saturate(1 + -r14.w);
                  r18.x = r14.w * r14.w;
                  r18.x = r18.x * r18.x;
                  r14.w = r18.x * r14.w;
                  r14.w = r17.x * r14.w;
                  r38.xyz = r14.www * r31.xyz + r28.xyz;
                  r15.xyz = r17.yyy ? r39.xyz : r15.xyz;
                  r28.xyz = r17.yyy ? r38.xyz : r28.xyz;
                  r29.xyz = r17.yyy ? r37.xyz : r29.xyz;
                }
              }
            }
            break;
            ...
            r14.w = rsqrt(r14.w);
            r38.xyz = r37.xyz * r14.www;
            r17.x = dot(r2.xyz, r38.xyz);
            r17.y = saturate(r17.x);
            r18.x = cmp(0 < r17.y);
            if (r18.x != 0) {
            // Known bad code for instruction (needs manual fix):
            ...
            r39.w = samp0[]..swiz;
              ...
              r19.w = samp0[]..swiz;
                ...
                r23.w = r23.w / r24.w;
                r23.w = min(1, r23.w);
                r32.xy = saturate(r18.xx * r32.xz + r32.yw);
                ...
                r45.xyz = r35.yzw;
                r45.w = r36.w;
                r32.y = dot(r45.xyzw, r16.xyzw);
                r19.xy = r32.xy / r18.xx;
                r18.x = cmp(r42.w < 0.00048828125);
                if (r18.x != 0) {
                  r43.y = r44.x;
                  r32.xy = saturate(abs(r19.xy) * r43.zw + r43.xy);
                  r32.zw = r32.xy * r32.xy;
                  r32.xy = r32.xy * float2(-2,-2) + float2(3,3);
                  r32.xy = r32.zw * r32.xy;
                  r18.x = r32.x * r32.y;
                  ...
                  r42.w = r43.y;
                  r32.xyzw = saturate(r42.xyzw * abs(r19.yyxx));
                ...
                r32.y = samp0[]..swiz;
                r32.z = samp0[]..swiz;
                  r19.w = dot(r44.yzw, r19.xyz);
                  r19.x = dot(r32.xyz, r19.xyz);
                  r32.xy = frac(r19.wx);
                  r18.x = (int)r18.x + -1;
                  r32.z = (uint)r18.x;
                  r41.xyz = gCookieArray.SampleLevel(samplerLinear_s, r32.xyz, 0).xyz;
                } else {
                  r41.xyz = float3(1,1,1);
                }
              }
              r30.yz = r31.yz;
              r19.xyw = r30.xyz * r41.xyz;
              r18.x = cmp(0 < r18.z);
              if (r18.x != 0) {
                if (3 == 0) r18.x = 0; else if (3+27 < 32) {                 r18.x = (uint)r31.w << (32-(3 + 27)); r18.x = (uint)r18.x >> (32-3);                } else r18.x = (uint)r31.w >> 27;
                r18.x = cmp((int)r18.x != 1);
                if (r18.x != 0) {
                  r18.x = abs(r17.x) * -0.200000003 + 0.400000006;
                  r20.xyz = r2.xyz * r18.xxx + v7.xyz;
                  r38.xyz = r36.xyz;
                  r18.x = dot(r38.xyzw, r20.xyzw);
                  r23.w = dot(r40.xyzw, r20.xyzw);
                  r24.w = cmp(r23.w >= r18.x);
                  if (r24.w != 0) {
                  // Known bad code for instruction (needs manual fix):
                  ...
                  r39.y = samp0[]..swiz;
                    ...
                    if (r10.w != 0) {
                      ...
                      while (true) {
                        ...
                        r25.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r30.xyz, r13.w).x;
                        r23.w = r25.w * 0.125 + r23.w;
                        r24.w = (int)r24.w + 1;
                      }
                    } else {
                      r20.z = (uint)r18.x;
                      r23.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r20.xyz, r13.w).x;
                    }
                    r13.w = r23.w * r23.w;
                    r13.w = r13.w * r23.w;
                  } else {
                ...
                if (r18.x != 0) {
                  r18.x = r31.x * r3.w;
                  r18.x = r18.x * r17.y;
                  if (4 == 0) r18.z = 0; else if (4+16 < 32) {                   r18.z = (uint)r31.w << (32-(4 + 16)); r18.z = (uint)r18.z >> (32-4);                  } else r18.z = (uint)r31.w >> 16;
                  r20.x = cmp(0 < (uint)r18.z);
                  r20.x = r1.w ? r20.x : 0;
                  if (r20.x != 0) {
                    r18.z = (int)r18.z + numLights;
                    r18.z = (int)r18.z + -1;
                  // Known bad code for instruction (needs manual fix):
                  ...
                  r36.z = samp0[]..swiz;
                  r36.w = samp0[]..swiz;
                    r20.y = abs(r17.x) * -0.200000003 + 0.400000006;
                    ...
                    r30.y = samp0[]..swiz;
                      ...
                      if (r10.w != 0) {
                        ...
                        r31.z = (uint)r20.y;
                        r20.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r31.xyz, r18.z).x;
                      }
                      r18.z = r20.z * r20.z;
                      r18.z = r18.z * r20.z;
                    } else {
                    ...
                    if (4 == 0) r18.z = 0; else if (4+20 < 32) {                     r18.z = (uint)r31.w << (32-(4 + 20)); r18.z = (uint)r18.z >> (32-4);                    } else r18.z = (uint)r31.w >> 20;
                    r20.x = cmp(0 < (uint)r18.z);
                    r20.x = r20.x ? r0.x : 0;
                    if (r20.x != 0) {
                      r18.z = (int)r18.z + numLights;
                    ...
                    r35.w = samp0[]..swiz;
                      ...
                      r22.z = samp0[]..swiz;
                        ...
                        if (r10.w != 0) {
                          ...
                          r30.z = (uint)r20.y;
                          r22.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r30.xyz, r18.z).x;
                        }
                        r18.z = r22.x * r22.x;
                        r18.z = r18.z * r22.x;
                      } else {
                  ...
                  r18.z = -r17.y * r6.w + 1;
                  r18.z = r18.z * r18.z;
                  r18.z = -r18.z * 0.620000005 + 0.620000005;
                  r18.z = r18.z + -r17.y;
                  r18.z = r4.w * r18.z + r17.y;
                  r18.z = r18.z * r13.w;
                  r17.x = cmp(0 < r17.x);
                  r21.xyz = r18.zzz * r19.xyw + r15.xyz;
                  r30.xyz = r37.xyz * r14.www + r4.xyz;
                  r14.w = dot(r30.xyz, r30.xyz);
                  r14.w = rsqrt(r14.w);
                  r30.xyz = r30.xyz * r14.www;
                  r14.w = dot(r30.xyz, r4.xyz);
                  r18.z = dot(r2.xyz, r30.xyz);
                  r20.x = abs(r18.z) * r3.w + -abs(r18.z);
                  r18.z = abs(r18.z) * r20.x + 1;
                  r17.y = r17.y * r2.w + r6.z;
                  r18.z = r18.z * r18.z;
                  r17.y = r18.z * r17.y;
                  r17.y = rcp(r17.y);
                  r17.y = r17.y * r18.x;
                  r13.w = r17.y * r13.w;
                  r13.w = 0.25 * r13.w;
                  r30.xyz = r13.www * r19.xyw + r29.xyz;
                  r14.w = saturate(1 + -r14.w);
                  r17.y = r14.w * r14.w;
                  r17.y = r17.y * r17.y;
                  r14.w = r17.y * r14.w;
                  r13.w = r14.w * r13.w;
                  r19.xyw = r13.www * r19.xyw + r28.xyz;
                  r15.xyz = r17.xxx ? r21.xyz : r15.xyz;
                  r28.xyz = r17.xxx ? r19.xyw : r28.xyz;
                  r29.xyz = r17.xxx ? r30.xyz : r29.xyz;
                }
              }
            }
            break;
