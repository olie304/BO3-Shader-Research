...
//   float4 uvAtlas;                    // Offset:  160 Size:    16
//
// }
//
...
mad o1.zw, cb1[69].xxxw, cb8[0].xxxz, v1.xxxy
mov o1.xy, v1.xyxx
mul r0.x, cb0[10].w, cb1[69].w
div r0.x, r0.x, cb0[10].z
ge r0.y, r0.x, -r0.x
frc r0.x, |r0.x|
movc r0.x, r0.y, r0.x, -r0.x
mul r0.y, r0.x, cb0[10].z
round_z r0.y, r0.y
add r0.z, r0.y, l(1.000000)
div r0.z, r0.z, cb0[10].z
ge r0.w, r0.z, -r0.z
frc r0.z, |r0.z|
movc r0.z, r0.w, r0.z, -r0.z
mul r0.z, r0.z, cb0[10].z
div r0.z, r0.z, cb0[10].x
ge r0.w, r0.z, -r0.z
frc r1.x, |r0.z|
round_ni r1.w, r0.z
...
round_ni r1.z, r0.z
add r0.zw, r1.zzzw, v1.xxxy
div r1.xy, l(1.000000, 1.000000, 1.000000, 1.000000), cb0[10].xyxx
mul o2.zw, r0.zzzw, r1.xxxy
div r0.z, r0.y, cb0[10].x
mad o3.x, r0.x, cb0[10].z, -r0.y
ge r0.x, r0.z, -r0.z
frc r0.y, |r0.z|
movc r0.x, r0.x, r0.y, -r0.y
mul r0.x, r0.x, cb0[10].x
round_ni r2.xy, r0.xzxx
add r0.xy, r2.xyxx, v1.xyxx
mul o2.xy, r1.xyxx, r0.xyxx
ret 
