...
if_nz r3.w
  ...
  if_nz r3.w
    ...
    mad r16.xyz, r5.wwww, r8.xyzx, r15.xyzx
    ...
    mul r0.y, r0.y, r3.w
    mul r0.y, r0.y, r2.w
    mad r8.xyz, r0.yyyy, r8.yzxy, r14.xyzx
    mov r16.w, r8.z
    mov r15.w, r14.z
    movc r15.xyzw, r1.wwww, r16.xyzw, r15.xyzw
    mov r8.zw, r12.yyyz
    mov r14.zw, r6.yyyz
    movc r8.xyzw, r1.wwww, r8.xyzw, r14.xyzw
...
ret 
// Approximately 2352 instruction slots used
