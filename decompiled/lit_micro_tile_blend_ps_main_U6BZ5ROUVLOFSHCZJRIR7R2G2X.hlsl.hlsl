...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r5.w = r1.z * detailScaleHeight1 + r1.w;
  ...
  r5.x = saturate(dot(r0.xyz, r3.xyz));
  r4.y = dot(-r3.xyz, r0.xyz);
  r4.y = r4.y + r4.y;
  r9.xyz = r0.xyz * -r4.yyy + -r3.xyz;
  r4.y = 17 * r5.y;
  r4.y = exp2(r4.y);
  r4.y = 2 + r4.y;
  r4.y = 2 / r4.y;
            ...
            r37.w = samp0[]..swiz;
              ...
              if (r17.x != 0) {
                ...
                if (r17.x != 0) {
                  ...
                  r18.xyz = r18.xyz * r12.www + r3.xyz;
                  r12.w = dot(r18.xyz, r18.xyz);
                  r12.w = rsqrt(r12.w);
                  r18.xyz = r18.xyz * r12.www;
                  r12.w = dot(r18.xyz, r3.xyz);
