...
//   uint numDecals;                    // Offset:  916 Size:     4
...
// visibleDecals                         UAV    uint     2darray             u0      1 
...
add r3.xyz, -r2.xyzx, r8.xyzx
max r1.xyz, r1.xyzx, |r3.xyzx|
add r0.xyw, r0.xyxw, -r2.xyxz
max r0.xyw, |r0.xyxw|, r1.xyxz
iadd r1.x, cb2[0].y, cb2[0].x
iadd r1.y, r1.x, cb2[57].y
ishl r1.z, r0.z, l(5)
iadd r1.x, r1.z, r1.x
iadd r1.y, -r1.x, r1.y
umin r1.y, r1.y, l(32)
...
loop 
  ...
  add r4.xyz, -r2.xyzx, r4.xyzx
  mov r5.z, r4.w
  add r5.xyz, r0.xywx, r5.zxyz
  lt r4.xyz, r5.xyzx, |r4.xyzx|
  or r2.w, r4.y, r4.x
  or r2.w, r4.z, r2.w
  or r3.z, r1.w, r1.z
  movc r1.z, r2.w, r1.z, r3.z
