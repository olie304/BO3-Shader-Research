  ...
  out float3 o0 : SV_TARGET0)
{
  ...
  r0.xyz = codeTexture0.SampleLevel(bilinearClamp_s, v0.xy, 0).xyz;
  r1.x = postFxControl0.x;
  r1.yw = float2(0,0);
  r2.xy = v0.xy + -r1.xy;
  r2.xyz = codeTexture0.SampleLevel(bilinearClamp_s, r2.xy, 0).xyz;
  r2.xyz = float3(0.241970703,0.241970703,0.241970703) * r2.xyz;
  r0.xyz = r0.xyz * float3(0.398942262,0.398942262,0.398942262) + r2.xyz;
  r1.xy = v0.xy + r1.xy;
  r2.xyz = codeTexture0.SampleLevel(bilinearClamp_s, r1.xy, 0).xyz;
  r0.xyz = r2.xyz * float3(0.241970703,0.241970703,0.241970703) + r0.xyz;
  r1.z = 2 * postFxControl0.x;
  r1.xy = v0.xy + -r1.zw;
  r2.xyz = codeTexture0.SampleLevel(bilinearClamp_s, r1.xy, 0).xyz;
  r0.xyz = r2.xyz * float3(0.0539909601,0.0539909601,0.0539909601) + r0.xyz;
  r1.xy = v0.xy + r1.zw;
  r1.xyz = codeTexture0.SampleLevel(bilinearClamp_s, r1.xy, 0).xyz;
  r0.xyz = r1.xyz * float3(0.0539909601,0.0539909601,0.0539909601) + r0.xyz;
  r1.x = 3 * postFxControl0.x;
  r1.y = 0;
  r1.zw = v0.xy + -r1.xy;
  r2.xyz = codeTexture0.SampleLevel(bilinearClamp_s, r1.zw, 0).xyz;
  r0.xyz = r2.xyz * float3(0.00443184003,0.00443184003,0.00443184003) + r0.xyz;
  r1.xy = v0.xy + r1.xy;
  r1.xyz = codeTexture0.SampleLevel(bilinearClamp_s, r1.xy, 0).xyz;
  r0.xyz = r1.xyz * float3(0.00443184003,0.00443184003,0.00443184003) + r0.xyz;
  r0.w = cmp(3 < postFxControl0.w);
  if (r0.w != 0) {
    r1.xz = float2(0.5,1.5) * postFxControl0.xx;
    r1.yw = float2(0,0);
    r2.xyzw = v0.xyxy + -r1.xyzw;
    r3.xyz = codeTexture0.SampleLevel(bilinearClamp_s, r2.xy, 0).xyz;
    r3.xyz = r3.xyz * float3(0.352065325,0.352065325,0.352065325) + r0.xyz;
    r1.xyzw = v0.xyxy + r1.xwzw;
    r4.xyz = codeTexture0.SampleLevel(bilinearClamp_s, r1.xy, 0).xyz;
    r3.xyz = r4.xyz * float3(0.352065325,0.352065325,0.352065325) + r3.xyz;
    r2.xyz = codeTexture0.SampleLevel(bilinearClamp_s, r2.zw, 0).xyz;
    r2.xyz = r2.xyz * float3(0.129517585,0.129517585,0.129517585) + r3.xyz;
    r1.xyz = codeTexture0.SampleLevel(bilinearClamp_s, r1.zw, 0).xyz;
    r1.xyz = r1.xyz * float3(0.129517585,0.129517585,0.129517585) + r2.xyz;
    r2.x = 2.5 * postFxControl0.x;
    r2.y = 0;
    r2.zw = v0.xy + -r2.xy;
    r3.xyz = codeTexture0.SampleLevel(bilinearClamp_s, r2.zw, 0).xyz;
    r1.xyz = r3.xyz * float3(0.0175282899,0.0175282899,0.0175282899) + r1.xyz;
    r2.xy = v0.xy + r2.xy;
    r2.xyz = codeTexture0.SampleLevel(bilinearClamp_s, r2.xy, 0).xyz;
    r0.xyz = r2.xyz * float3(0.0175282899,0.0175282899,0.0175282899) + r1.xyz;
    r0.w = cmp(9 < postFxControl0.w);
    if (r0.w != 0) {
      r1.xz = float2(0.25,0.75) * postFxControl0.xx;
      r1.yw = float2(0,0);
      r2.xyzw = v0.xyxy + -r1.xyzw;
      r3.xyz = codeTexture0.SampleLevel(bilinearClamp_s, r2.xy, 0).xyz;
      r3.xyz = r3.xyz * float3(0.386668086,0.386668086,0.386668086) + r0.xyz;
      r1.xyzw = v0.xyxy + r1.xwzw;
      r4.xyz = codeTexture0.SampleLevel(bilinearClamp_s, r1.xy, 0).xyz;
      r3.xyz = r4.xyz * float3(0.386668086,0.386668086,0.386668086) + r3.xyz;
      r2.xyz = codeTexture0.SampleLevel(bilinearClamp_s, r2.zw, 0).xyz;
      r2.xyz = r2.xyz * float3(0.301137418,0.301137418,0.301137418) + r3.xyz;
      r1.xyz = codeTexture0.SampleLevel(bilinearClamp_s, r1.zw, 0).xyz;
      r1.xyz = r1.xyz * float3(0.301137418,0.301137418,0.301137418) + r2.xyz;
      r2.xz = float2(1.25,1.75) * postFxControl0.xx;
      r2.yw = float2(0,0);
      r3.xyzw = v0.xyxy + -r2.xyzw;
      r4.xyz = codeTexture0.SampleLevel(bilinearClamp_s, r3.xy, 0).xyz;
      r1.xyz = r4.xyz * float3(0.182649076,0.182649076,0.182649076) + r1.xyz;
      r2.xyzw = v0.xyxy + r2.xwzw;
      r4.xyz = codeTexture0.SampleLevel(bilinearClamp_s, r2.xy, 0).xyz;
      r1.xyz = r4.xyz * float3(0.182649076,0.182649076,0.182649076) + r1.xyz;
      r3.xyz = codeTexture0.SampleLevel(bilinearClamp_s, r3.zw, 0).xyz;
      r1.xyz = r3.xyz * float3(0.0862773135,0.0862773135,0.0862773135) + r1.xyz;
      r2.xyz = codeTexture0.SampleLevel(bilinearClamp_s, r2.zw, 0).xyz;
      r1.xyz = r2.xyz * float3(0.0862773135,0.0862773135,0.0862773135) + r1.xyz;
      r2.xz = float2(2.25,2.75) * postFxControl0.xx;
      r2.yw = float2(0,0);
      r3.xyzw = v0.xyxy + -r2.xyzw;
      r4.xyz = codeTexture0.SampleLevel(bilinearClamp_s, r3.xy, 0).xyz;
      r1.xyz = r4.xyz * float3(0.0317396484,0.0317396484,0.0317396484) + r1.xyz;
      r2.xyzw = v0.xyxy + r2.xwzw;
      r4.xyz = codeTexture0.SampleLevel(bilinearClamp_s, r2.xy, 0).xyz;
      r1.xyz = r4.xyz * float3(0.0317396484,0.0317396484,0.0317396484) + r1.xyz;
      r3.xyz = codeTexture0.SampleLevel(bilinearClamp_s, r3.zw, 0).xyz;
      r1.xyz = r3.xyz * float3(0.00909356028,0.00909356028,0.00909356028) + r1.xyz;
      r2.xyz = codeTexture0.SampleLevel(bilinearClamp_s, r2.zw, 0).xyz;
      r0.xyz = r2.xyz * float3(0.00909356028,0.00909356028,0.00909356028) + r1.xyz;
      r0.w = 3.99308205;
    } else {
      r0.w = 1.99795175;
    }
