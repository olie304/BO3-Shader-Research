...
mov r1.xz, l(0,0,0,0)
mov r1.y, cb8[0].y
add r2.xy, -r1.xyxx, v0.xyxx
sample_l_indexable(texture2d)(float,float,float,float) r2.xyz, r2.xyxx, t0.xyzw, s0, l(0.000000)
mul r2.xyz, r2.xyzx, l(0.24197070, 0.24197070, 0.24197070, 0.000000)
mad r0.xyz, r0.xyzx, l(0.39894226, 0.39894226, 0.39894226, 0.000000), r2.xyzx
add r1.xy, r1.xyxx, v0.xyxx
sample_l_indexable(texture2d)(float,float,float,float) r2.xyz, r1.xyxx, t0.xyzw, s0, l(0.000000)
mad r0.xyz, r2.xyzx, l(0.24197070, 0.24197070, 0.24197070, 0.000000), r0.xyzx
mul r1.w, cb8[0].y, l(2.000000)
add r1.xy, -r1.zwzz, v0.xyxx
sample_l_indexable(texture2d)(float,float,float,float) r2.xyz, r1.xyxx, t0.xyzw, s0, l(0.000000)
mad r0.xyz, r2.xyzx, l(0.05399096, 0.05399096, 0.05399096, 0.000000), r0.xyzx
add r1.xy, r1.zwzz, v0.xyxx
sample_l_indexable(texture2d)(float,float,float,float) r1.xyz, r1.xyxx, t0.xyzw, s0, l(0.000000)
mad r0.xyz, r1.xyzx, l(0.05399096, 0.05399096, 0.05399096, 0.000000), r0.xyzx
mov r1.x, l(0)
mul r1.y, cb8[0].y, l(3.000000)
add r1.zw, -r1.xxxy, v0.xxxy
sample_l_indexable(texture2d)(float,float,float,float) r2.xyz, r1.zwzz, t0.xyzw, s0, l(0.000000)
mad r0.xyz, r2.xyzx, l(0.00443184, 0.00443184, 0.00443184, 0.000000), r0.xyzx
add r1.xy, r1.xyxx, v0.xyxx
sample_l_indexable(texture2d)(float,float,float,float) r1.xyz, r1.xyxx, t0.xyzw, s0, l(0.000000)
mad r0.xyz, r1.xyzx, l(0.00443184, 0.00443184, 0.00443184, 0.000000), r0.xyzx
lt r0.w, l(3.000000), cb8[0].w
if_nz r0.w
  mov r1.x, l(0)
  mul r1.yw, cb8[0].yyyy, l(0.000000, 0.500000, 0.000000, 1.500000)
  add r2.xyzw, -r1.xyxw, v0.xyxy
  sample_l_indexable(texture2d)(float,float,float,float) r3.xyz, r2.xyxx, t0.xyzw, s0, l(0.000000)
  mad r3.xyz, r3.xyzx, l(0.35206532, 0.35206532, 0.35206532, 0.000000), r0.xyzx
  add r1.xyzw, r1.xyxw, v0.xyxy
  sample_l_indexable(texture2d)(float,float,float,float) r4.xyz, r1.xyxx, t0.xyzw, s0, l(0.000000)
  mad r3.xyz, r4.xyzx, l(0.35206532, 0.35206532, 0.35206532, 0.000000), r3.xyzx
  sample_l_indexable(texture2d)(float,float,float,float) r2.xyz, r2.zwzz, t0.xyzw, s0, l(0.000000)
  mad r2.xyz, r2.xyzx, l(0.12951759, 0.12951759, 0.12951759, 0.000000), r3.xyzx
  sample_l_indexable(texture2d)(float,float,float,float) r1.xyz, r1.zwzz, t0.xyzw, s0, l(0.000000)
  mad r1.xyz, r1.xyzx, l(0.12951759, 0.12951759, 0.12951759, 0.000000), r2.xyzx
  mov r2.x, l(0)
  mul r2.y, cb8[0].y, l(2.500000)
  add r2.zw, -r2.xxxy, v0.xxxy
  sample_l_indexable(texture2d)(float,float,float,float) r3.xyz, r2.zwzz, t0.xyzw, s0, l(0.000000)
  mad r1.xyz, r3.xyzx, l(0.01752829, 0.01752829, 0.01752829, 0.000000), r1.xyzx
  add r2.xy, r2.xyxx, v0.xyxx
  sample_l_indexable(texture2d)(float,float,float,float) r2.xyz, r2.xyxx, t0.xyzw, s0, l(0.000000)
  mad r0.xyz, r2.xyzx, l(0.01752829, 0.01752829, 0.01752829, 0.000000), r1.xyzx
  lt r0.w, l(9.000000), cb8[0].w
  if_nz r0.w
    mov r1.x, l(0)
    mul r1.yw, cb8[0].yyyy, l(0.000000, 0.250000, 0.000000, 0.750000)
    add r2.xyzw, -r1.xyxw, v0.xyxy
    sample_l_indexable(texture2d)(float,float,float,float) r3.xyz, r2.xyxx, t0.xyzw, s0, l(0.000000)
    mad r3.xyz, r3.xyzx, l(0.38666809, 0.38666809, 0.38666809, 0.000000), r0.xyzx
    add r1.xyzw, r1.xyxw, v0.xyxy
    sample_l_indexable(texture2d)(float,float,float,float) r4.xyz, r1.xyxx, t0.xyzw, s0, l(0.000000)
    mad r3.xyz, r4.xyzx, l(0.38666809, 0.38666809, 0.38666809, 0.000000), r3.xyzx
    sample_l_indexable(texture2d)(float,float,float,float) r2.xyz, r2.zwzz, t0.xyzw, s0, l(0.000000)
    mad r2.xyz, r2.xyzx, l(0.30113742, 0.30113742, 0.30113742, 0.000000), r3.xyzx
    sample_l_indexable(texture2d)(float,float,float,float) r1.xyz, r1.zwzz, t0.xyzw, s0, l(0.000000)
    mad r1.xyz, r1.xyzx, l(0.30113742, 0.30113742, 0.30113742, 0.000000), r2.xyzx
    mov r2.x, l(0)
    mul r2.yw, cb8[0].yyyy, l(0.000000, 1.250000, 0.000000, 1.750000)
    add r3.xyzw, -r2.xyxw, v0.xyxy
    sample_l_indexable(texture2d)(float,float,float,float) r4.xyz, r3.xyxx, t0.xyzw, s0, l(0.000000)
    mad r1.xyz, r4.xyzx, l(0.18264908, 0.18264908, 0.18264908, 0.000000), r1.xyzx
    add r2.xyzw, r2.xyxw, v0.xyxy
    ...
    mad r1.xyz, r3.xyzx, l(0.08627731, 0.08627731, 0.08627731, 0.000000), r1.xyzx
    sample_l_indexable(texture2d)(float,float,float,float) r2.xyz, r2.zwzz, t0.xyzw, s0, l(0.000000)
    mad r1.xyz, r2.xyzx, l(0.08627731, 0.08627731, 0.08627731, 0.000000), r1.xyzx
    mov r2.x, l(0)
    mul r2.yw, cb8[0].yyyy, l(0.000000, 2.250000, 0.000000, 2.750000)
    add r3.xyzw, -r2.xyxw, v0.xyxy
    sample_l_indexable(texture2d)(float,float,float,float) r4.xyz, r3.xyxx, t0.xyzw, s0, l(0.000000)
    mad r1.xyz, r4.xyzx, l(0.03173965, 0.03173965, 0.03173965, 0.000000), r1.xyzx
    add r2.xyzw, r2.xyxw, v0.xyxy
    sample_l_indexable(texture2d)(float,float,float,float) r4.xyz, r2.xyxx, t0.xyzw, s0, l(0.000000)
    mad r1.xyz, r4.xyzx, l(0.03173965, 0.03173965, 0.03173965, 0.000000), r1.xyzx
    sample_l_indexable(texture2d)(float,float,float,float) r3.xyz, r3.zwzz, t0.xyzw, s0, l(0.000000)
    mad r1.xyz, r3.xyzx, l(0.00909356, 0.00909356, 0.00909356, 0.000000), r1.xyzx
    sample_l_indexable(texture2d)(float,float,float,float) r2.xyz, r2.zwzz, t0.xyzw, s0, l(0.000000)
    mad r0.xyz, r2.xyzx, l(0.00909356, 0.00909356, 0.00909356, 0.000000), r1.xyzx
    mov r0.w, l(3.993082)
  else 
    mov r0.w, l(1.99795175)
  endif 
else 
  mov r0.w, l(0.99972928)
endif 
