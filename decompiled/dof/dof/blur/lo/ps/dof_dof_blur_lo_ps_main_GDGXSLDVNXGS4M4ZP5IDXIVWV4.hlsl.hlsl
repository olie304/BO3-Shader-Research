  ...
  out float3 o0 : SV_TARGET0)
{
  ...
  r0.y = cmp(0 < r0.x);
  if (r0.y != 0) {
    r1.xyzw = r0.xxxx * postFxConst00.xyzw + v1.xyxy;
    r2.xyzw = r0.xxxx * postFxConst01.xyzw + v1.xyxy;
    r0.yzw = codeTexture0.SampleLevel(bilinearClamp_s, r1.xy, 0).xyz;
    r1.x = codeTexture1.SampleLevel(bilinearClamp_s, r1.xy, 0).x;
    r3.xyz = codeTexture0.SampleLevel(bilinearClamp_s, r1.zw, 0).xyz;
    r1.y = codeTexture1.SampleLevel(bilinearClamp_s, r1.zw, 0).x;
    r4.xyz = codeTexture0.SampleLevel(bilinearClamp_s, r2.xy, 0).xyz;
    r1.z = codeTexture1.SampleLevel(bilinearClamp_s, r2.xy, 0).x;
    r5.xyz = codeTexture0.SampleLevel(bilinearClamp_s, r2.zw, 0).xyz;
    r1.w = codeTexture1.SampleLevel(bilinearClamp_s, r2.zw, 0).x;
    r1.x = r1.x * r0.x;
    r1.x = r0.x * r0.x + r1.x;
    r1.x = r1.y * r0.x + r1.x;
    ...
    r2.xyzw = r0.xxxx * postFxConst02.xyzw + v1.xyxy;
    r3.xyzw = r0.xxxx * postFxConst03.xyzw + v1.xyxy;
    r1.yzw = codeTexture0.SampleLevel(bilinearClamp_s, r2.xy, 0).xyz;
    r2.x = codeTexture1.SampleLevel(bilinearClamp_s, r2.xy, 0).x;
    r4.xyz = codeTexture0.SampleLevel(bilinearClamp_s, r2.zw, 0).xyz;
    r2.y = codeTexture1.SampleLevel(bilinearClamp_s, r2.zw, 0).x;
    r5.xyz = codeTexture0.SampleLevel(bilinearClamp_s, r3.xy, 0).xyz;
    r2.z = codeTexture1.SampleLevel(bilinearClamp_s, r3.xy, 0).x;
    r6.xyz = codeTexture0.SampleLevel(bilinearClamp_s, r3.zw, 0).xyz;
    r2.w = codeTexture1.SampleLevel(bilinearClamp_s, r3.zw, 0).x;
    r1.x = r2.x * r0.x + r1.x;
    ...
    r2.xyzw = r0.xxxx * postFxConst04.xyzw + v1.xyxy;
    r3.xyzw = r0.xxxx * postFxConst05.xyzw + v1.xyxy;
    r1.yzw = codeTexture0.SampleLevel(bilinearClamp_s, r2.xy, 0).xyz;
    r2.x = codeTexture1.SampleLevel(bilinearClamp_s, r2.xy, 0).x;
    r4.xyz = codeTexture0.SampleLevel(bilinearClamp_s, r2.zw, 0).xyz;
    r2.y = codeTexture1.SampleLevel(bilinearClamp_s, r2.zw, 0).x;
    ...
    r1.x = r2.w * r0.x + r1.x;
    r0.yzw = r6.xyz * r0.xxx + r0.yzw;
    r2.xyzw = r0.xxxx * postFxConst06.xyzw + v1.xyxy;
    r3.xyzw = r0.xxxx * postFxConst07.xyzw + v1.xyxy;
    r1.yzw = codeTexture0.SampleLevel(bilinearClamp_s, r2.xy, 0).xyz;
    r2.x = codeTexture1.SampleLevel(bilinearClamp_s, r2.xy, 0).x;
    r4.xyz = codeTexture0.SampleLevel(bilinearClamp_s, r2.zw, 0).xyz;
    r2.y = codeTexture1.SampleLevel(bilinearClamp_s, r2.zw, 0).x;
    ...
    r1.x = r2.w * r0.x + r1.x;
    r0.yzw = r6.xyz * r0.xxx + r0.yzw;
    r2.xyzw = r0.xxxx * postFxConst08.xyzw + v1.xyxy;
    r3.xyzw = r0.xxxx * postFxConst09.xyzw + v1.xyxy;
    r1.yzw = codeTexture0.SampleLevel(bilinearClamp_s, r2.xy, 0).xyz;
    r2.x = codeTexture1.SampleLevel(bilinearClamp_s, r2.xy, 0).x;
    r4.xyz = codeTexture0.SampleLevel(bilinearClamp_s, r2.zw, 0).xyz;
    r2.y = codeTexture1.SampleLevel(bilinearClamp_s, r2.zw, 0).x;
    ...
    r1.x = r2.w * r0.x + r1.x;
    r0.yzw = r6.xyz * r0.xxx + r0.yzw;
    r2.xyzw = r0.xxxx * postFxConst10.xyzw + v1.xyxy;
    r3.xyzw = r0.xxxx * postFxConst11.xyzw + v1.xyxy;
    r1.yzw = codeTexture0.SampleLevel(bilinearClamp_s, r2.xy, 0).xyz;
    r2.x = codeTexture1.SampleLevel(bilinearClamp_s, r2.xy, 0).x;
    r4.xyz = codeTexture0.SampleLevel(bilinearClamp_s, r2.zw, 0).xyz;
    r2.y = codeTexture1.SampleLevel(bilinearClamp_s, r2.zw, 0).x;
    ...
    r1.x = r2.w * r0.x + r1.x;
    r0.yzw = r6.xyz * r0.xxx + r0.yzw;
    r2.xyzw = r0.xxxx * postFxConst12.xyzw + v1.xyxy;
    r3.xyzw = r0.xxxx * postFxConst13.xyzw + v1.xyxy;
    r1.yzw = codeTexture0.SampleLevel(bilinearClamp_s, r2.xy, 0).xyz;
    r2.x = codeTexture1.SampleLevel(bilinearClamp_s, r2.xy, 0).x;
    r4.xyz = codeTexture0.SampleLevel(bilinearClamp_s, r2.zw, 0).xyz;
    r2.y = codeTexture1.SampleLevel(bilinearClamp_s, r2.zw, 0).x;
    ...
    r1.x = r2.w * r0.x + r1.x;
    r0.yzw = r6.xyz * r0.xxx + r0.yzw;
    r2.xyzw = r0.xxxx * postFxConst14.xyzw + v1.xyxy;
    r3.xyzw = r0.xxxx * postFxConst15.xyzw + v1.xyxy;
    r1.yzw = codeTexture0.SampleLevel(bilinearClamp_s, r2.xy, 0).xyz;
    r2.x = codeTexture1.SampleLevel(bilinearClamp_s, r2.xy, 0).x;
    r4.xyz = codeTexture0.SampleLevel(bilinearClamp_s, r2.zw, 0).xyz;
    r2.y = codeTexture1.SampleLevel(bilinearClamp_s, r2.zw, 0).x;
    ...
    r1.x = r2.w * r0.x + r1.x;
    r0.yzw = r6.xyz * r0.xxx + r0.yzw;
    r2.xyzw = r0.xxxx * postFxConst16.xyzw + v1.xyxy;
    r3.xyzw = r0.xxxx * postFxConst17.xyzw + v1.xyxy;
    r1.yzw = codeTexture0.SampleLevel(bilinearClamp_s, r2.xy, 0).xyz;
    r2.x = codeTexture1.SampleLevel(bilinearClamp_s, r2.xy, 0).x;
    r4.xyz = codeTexture0.SampleLevel(bilinearClamp_s, r2.zw, 0).xyz;
    r2.y = codeTexture1.SampleLevel(bilinearClamp_s, r2.zw, 0).x;
    ...
    r1.x = r2.w * r0.x + r1.x;
    r0.yzw = r6.xyz * r0.xxx + r0.yzw;
    r2.xyzw = r0.xxxx * postFxConst18.xyzw + v1.xyxy;
    r3.xyzw = r0.xxxx * postFxConst19.xyzw + v1.xyxy;
    r1.yzw = codeTexture0.SampleLevel(bilinearClamp_s, r2.xy, 0).xyz;
    r2.x = codeTexture1.SampleLevel(bilinearClamp_s, r2.xy, 0).x;
    r4.xyz = codeTexture0.SampleLevel(bilinearClamp_s, r2.zw, 0).xyz;
    r2.y = codeTexture1.SampleLevel(bilinearClamp_s, r2.zw, 0).x;
    ...
    r1.x = r2.w * r0.x + r1.x;
    r0.yzw = r6.xyz * r0.xxx + r0.yzw;
    r2.xyzw = r0.xxxx * postFxConst20.xyzw + v1.xyxy;
    r3.xyzw = r0.xxxx * postFxConst21.xyzw + v1.xyxy;
    r1.yzw = codeTexture0.SampleLevel(bilinearClamp_s, r2.xy, 0).xyz;
    r2.x = codeTexture1.SampleLevel(bilinearClamp_s, r2.xy, 0).x;
    r4.xyz = codeTexture0.SampleLevel(bilinearClamp_s, r2.zw, 0).xyz;
    r2.y = codeTexture1.SampleLevel(bilinearClamp_s, r2.zw, 0).x;
    ...
    r1.x = r2.w * r0.x + r1.x;
    r0.yzw = r6.xyz * r0.xxx + r0.yzw;
    r2.xyzw = r0.xxxx * postFxConst22.xyzw + v1.xyxy;
    r3.xyzw = r0.xxxx * postFxConst23.xyzw + v1.xyxy;
    r1.yzw = codeTexture0.SampleLevel(bilinearClamp_s, r2.xy, 0).xyz;
    r2.x = codeTexture1.SampleLevel(bilinearClamp_s, r2.xy, 0).x;
    r4.xyz = codeTexture0.SampleLevel(bilinearClamp_s, r2.zw, 0).xyz;
    r2.y = codeTexture1.SampleLevel(bilinearClamp_s, r2.zw, 0).x;
