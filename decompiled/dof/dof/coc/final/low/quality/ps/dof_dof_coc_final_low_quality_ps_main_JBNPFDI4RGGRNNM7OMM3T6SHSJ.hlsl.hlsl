  ...
  out float3 o0 : SV_TARGET0)
{
  ...
  r0.w = codeTexture1.Sample(bilinearClamp_s, v0.xy).x;
  r1.x = cmp(0 < r0.w);
  if (r1.x != 0) {
    r1.xyz = codeTexture2.Sample(bilinearClamp_s, v0.xy).xyz;
    r1.w = postFxConst00.x * r0.w;
    r1.w = saturate(r1.w);
    r0.w = saturate(r0.w * postFxConst00.y + postFxConst00.z);
    r2.x = 1 + -r1.w;
    r1.w = 0.25 * r1.w;
    r2.yz = v1.xy + v0.xy;
    r3.xyz = codeTexture0.SampleLevel(bilinearClamp_s, r2.yz, 0).xyz;
    r4.xyz = codeTexture0.SampleLevel(bilinearClamp_s, r2.yz, 0, int2(1, 0)).xyz;
    r3.xyz = r4.xyz + r3.xyz;
    r4.xyz = codeTexture0.SampleLevel(bilinearClamp_s, r2.yz, 0, int2(1, 1)).xyz;
    r3.xyz = r4.xyz + r3.xyz;
    r2.yzw = codeTexture0.SampleLevel(bilinearClamp_s, r2.yz, 0, int2(0, 1)).xyz;
    r2.yzw = r3.xyz + r2.yzw;
    r2.yzw = r2.yzw * r1.www;
    r2.xyz = r0.xyz * r2.xxx + r2.yzw;
    r1.w = 1 + -r0.w;
    r2.xyz = r2.xyz * r1.www;
    o0.xyz = r1.xyz * r0.www + r2.xyz;
  } else {
    o0.xyz = r0.xyz;
  }
  return;
