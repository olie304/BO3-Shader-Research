...
mad r1.xyzw, r0.xyzw, l(64.000000, 64.000000, 64.000000, 64.000000), l(-63.000000, -63.000000, -63.000000, -63.000000)
max r1.xyzw, r1.xyzw, l(0.00000001, 0.00000001, 0.00000001, 0.00000001)
div r1.xyzw, cb8[2].xxxx, r1.xyzw
max r2.xyzw, r0.xyzw, l(0.00000001, 0.00000001, 0.00000001, 0.00000001)
ge r0.xyzw, r0.xyzw, l(0.984375, 0.984375, 0.984375, 0.984375)
div r2.xyzw, cb8[2].yyyy, r2.xyzw
movc r0.xyzw, r0.xyzw, r1.xyzw, r2.xyzw
rcp r0.xyzw, r0.xyzw
mad r0.xyzw, r0.xyzw, cb8[0].xxxx, cb8[0].yyyy
mad_sat r0.xyzw, r0.xyzw, cb8[0].zzzz, cb8[0].wwww
