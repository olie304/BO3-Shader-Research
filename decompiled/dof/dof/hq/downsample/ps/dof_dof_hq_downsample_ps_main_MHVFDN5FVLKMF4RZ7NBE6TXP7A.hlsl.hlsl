  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.zw = float2(0,0);
  r1.xyzw = codeTexture0.Load(r0.xyw, int3(0, 0, 0)).xyzw;
  r2.x = saturate(postFxControl0.w * r1.w);
  r2.x = 0.0603027344 * r2.x;
  r1.xyzw = r2.xxxx * r1.xyzw;
  r3.xyzw = codeTexture0.Load(r0.xyw, int3(0, 0, 0)).xyzw;
  r2.y = saturate(postFxControl0.w * r3.w);
  r2.z = 0.0412597656 * r2.y;
  r2.x = r2.y * 0.0412597656 + r2.x;
  r1.xyzw = r3.xyzw * r2.zzzz + r1.xyzw;
  r3.xyzw = codeTexture0.Load(r0.xyw, int3(0, 0, 0)).xyzw;
  r2.y = saturate(postFxControl0.w * r3.w);
  r2.z = 0.0603027344 * r2.y;
  r2.x = r2.y * 0.0603027344 + r2.x;
  r1.xyzw = r3.xyzw * r2.zzzz + r1.xyzw;
  r3.xyzw = codeTexture0.Load(r0.xyw, int3(0, 0, 0)).xyzw;
  r2.y = saturate(postFxControl0.w * r3.w);
  r2.z = 0.0412597656 * r2.y;
  ...
  r3.xyzw = codeTexture0.Load(r0.xyw, int3(0, 0, 0)).xyzw;
  r2.y = saturate(postFxControl0.w * r3.w);
  r2.z = 0.0881347656 * r2.y;
  r2.x = r2.y * 0.0881347656 + r2.x;
  r1.xyzw = r3.xyzw * r2.zzzz + r1.xyzw;
  r3.xyzw = codeTexture0.Load(r0.xyw, int3(0, 0, 0)).xyzw;
  r2.y = saturate(postFxControl0.w * r3.w);
  r2.z = 0.0881347656 * r2.y;
  ...
  r1.xyzw = r3.xyzw * r2.zzzz + r1.xyzw;
  r3.xyzw = codeTexture0.Load(r0.xyw, int3(0, 0, 0)).xyzw;
  r0.xyzw = codeTexture0.Load(r0.xyz, int3(0, 0, 0)).xyzw;
  r2.y = saturate(postFxControl0.w * r3.w);
  r2.z = 0.0603027344 * r2.y;
  r2.x = r2.y * 0.0603027344 + r2.x;
  r1.xyzw = r3.xyzw * r2.zzzz + r1.xyzw;
  r2.y = saturate(postFxControl0.w * r0.w);
  r2.z = 0.0412597656 * r2.y;
  r2.x = r2.y * 0.0412597656 + r2.x;
  r0.xyzw = r0.xyzw * r2.zzzz + r1.xyzw;
  r1.xyzw = r0.xyzw / r2.xxxx;
  r2.x = cmp(0 < r2.x);
