  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  float4 x0[60];
  x0[0].xy = float2(0,0.25);
  x0[1].xy = float2(-0.216499999,0.125);
  x0[2].xy = float2(-0.216499999,-0.125);
  x0[3].xy = float2(-0,-0.25);
  x0[4].xy = float2(0.216499999,-0.125);
  x0[5].xy = float2(0.216499999,0.125);
  x0[6].xy = float2(0,0.5);
  x0[7].xy = float2(-0.25,0.432999998);
  x0[8].xy = float2(-0.432999998,0.25);
  x0[9].xy = float2(-0.5,0);
  x0[10].xy = float2(-0.432999998,-0.25);
  x0[11].xy = float2(-0.25,-0.432999998);
  x0[12].xy = float2(-0,-0.5);
  x0[13].xy = float2(0.25,-0.432999998);
  x0[14].xy = float2(0.432999998,-0.25);
  x0[15].xy = float2(0.5,-0);
  x0[16].xy = float2(0.432999998,0.25);
  x0[17].xy = float2(0.25,0.432999998);
  x0[18].xy = float2(0,0.75);
  x0[19].xy = float2(-0.256500006,0.70480001);
  x0[20].xy = float2(-0.48210001,0.574500024);
  x0[21].xy = float2(-0.649500012,0.375);
  x0[22].xy = float2(-0.738600016,0.130199999);
  x0[23].xy = float2(-0.738600016,-0.130199999);
  x0[24].xy = float2(-0.649500012,-0.375);
  x0[25].xy = float2(-0.48210001,-0.574500024);
  x0[26].xy = float2(-0.256500006,-0.70480001);
  x0[27].xy = float2(-0,-0.75);
  x0[28].xy = float2(0.256500006,-0.70480001);
  x0[29].xy = float2(0.48210001,-0.574500024);
  x0[30].xy = float2(0.649500012,-0.375);
  x0[31].xy = float2(0.738600016,-0.130199999);
  x0[32].xy = float2(0.738600016,0.130199999);
  x0[33].xy = float2(0.649500012,0.375);
  x0[34].xy = float2(0.48210001,0.574500024);
  x0[35].xy = float2(0.256500006,0.70480001);
  x0[36].xy = float2(0,1);
  x0[37].xy = float2(-0.2588,0.965900004);
  x0[38].xy = float2(-0.5,0.865999997);
  x0[39].xy = float2(-0.707099974,0.707099974);
  x0[40].xy = float2(-0.865999997,0.5);
  x0[41].xy = float2(-0.965900004,0.2588);
  x0[42].xy = float2(-1,0);
  x0[43].xy = float2(-0.965900004,-0.2588);
  x0[44].xy = float2(-0.865999997,-0.5);
  x0[45].xy = float2(-0.707099974,-0.707099974);
  x0[46].xy = float2(-0.5,-0.865999997);
  x0[47].xy = float2(-0.2588,-0.965900004);
  x0[48].xy = float2(-0,-1);
  x0[49].xy = float2(0.2588,-0.965900004);
  x0[50].xy = float2(0.5,-0.865999997);
  x0[51].xy = float2(0.707099974,-0.707099974);
  x0[52].xy = float2(0.865999997,-0.5);
  x0[53].xy = float2(0.965900004,-0.2588);
  x0[54].xy = float2(1,-0);
  x0[55].xy = float2(0.965900004,0.2588);
  x0[56].xy = float2(0.865999997,0.5);
  x0[57].xy = float2(0.707099974,0.707099974);
  x0[58].xy = float2(0.5,0.865999997);
  x0[59].xy = float2(0.2588,0.965900004);
  ...
  if (r1.x != 0) {
    ...
    r1.zw = postFxControl0.xy * r0.ww;
    r3.xyz = r2.xyz;
    r3.w = r1.y;
    r4.x = 0;
    while (true) {
      r4.y = cmp((int)r4.x >= 60);
      if (r4.y != 0) break;
      r4.yz = x0[r4.x+0].xy;
      r5.xy = r4.yz * r1.zw + v1.xy;
      r5.xyzw = codeTexture0.SampleLevel(samp0_s, r5.xy, r1.x).xyzw;
      r4.w = r5.w * r5.w + 1;
      r4.w = 1 / r4.w;
