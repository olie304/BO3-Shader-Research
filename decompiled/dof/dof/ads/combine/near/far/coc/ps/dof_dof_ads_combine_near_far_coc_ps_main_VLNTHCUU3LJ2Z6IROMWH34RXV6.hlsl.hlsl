...
Texture2D<uint> codeTexture2 : register(t2);
  ...
  out float o0 : SV_TARGET0)
{
  ...
  r0.x = r0.x ? postFxControl1.w : 0;
  r0.y = codeTexture1.Sample(bilinearClamp_s, v0.xy).x;
  r0.x = max(r0.y, r0.x);
  r0.y = codeTexture0.Sample(bilinearClamp_s, v0.xy).x;
  r0.z = saturate(r0.y * postFxControl1.x + postFxControl1.y);
  r0.y = cmp(r0.y >= 0.984375);
  r0.z = postFxControl1.z * r0.z;
  r0.y = r0.y ? 0 : r0.z;
  o0.x = max(r0.y, r0.x);
  return;
}