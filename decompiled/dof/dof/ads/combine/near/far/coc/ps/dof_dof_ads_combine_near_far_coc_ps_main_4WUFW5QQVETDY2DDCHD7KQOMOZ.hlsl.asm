...
// codeTexture2                      texture    uint          2d             t2      1 
...
ine r0.x, r0.x, l(128)
and r0.x, r0.x, cb8[1].w
sample_indexable(texture2d)(float,float,float,float) r0.y, v0.xyxx, t1.yxzw, s0
max r0.x, r0.x, r0.y
sample_indexable(texture2d)(float,float,float,float) r0.y, v0.xyxx, t0.yxzw, s0
mad_sat r0.z, r0.y, cb8[1].x, cb8[1].y
ge r0.y, r0.y, l(0.984375)
mul r0.z, r0.z, cb8[1].z
