...
// foveaMap                          texture  float4          2d             t2      1 
...
dcl_output o1.xy
dcl_temps 2
mad r0.xy, v0.xyxx, cb8[2].xyxx, cb8[2].zwzz
...
ld_indexable(texture2d)(float,float,float,float) r1.x, r1.xyww, t0.xyzw
mul r0.yzw, r0.yyzw, cb8[1].zzzz
mul o0.xyz, r0.xxxx, r0.yzwy
add r0.x, -r1.x, l(1.000000)
mad r0.x, -r0.x, l(40.000000), l(1.000000)
ge r0.y, r1.x, l(0.984375)
movc r0.x, r0.y, r0.x, r1.x
max r0.x, r0.x, l(0.00000001)
div r0.x, cb1[41].x, r0.x
mul r0.x, r0.x, l(25.400000)
div r0.x, cb8[0].y, r0.x
add r0.x, r0.x, l(-1.000000)
mul r0.x, r0.x, cb8[0].z
mul r0.x, r0.x, cb8[0].w
lt r0.y, l(0.000000), r0.x
mul r0.x, r0.x, l(0.500000)
and o1.x, r0.x, r0.y
mad_sat o1.y, r0.x, cb8[1].x, cb8[1].y
ret 
