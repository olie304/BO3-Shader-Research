...
Texture2D<float4> foveaMap : register(t2);
  ...
  out float2 o1 : SV_TARGET1)
{
  ...
  r0.xy = v0.xy * postFxControl2.xy + postFxControl2.zw;
  r0.x = foveaMap.Sample(bilinearClamp_s, r0.xy).x;
  r0.x = saturate(1 + r0.x);
  r1.xy = (int2)v0.xy;
  r1.zw = float2(0,0);
  r0.yzw = codeTexture1.Load(r1.xyz).xyz;
  r1.x = codeTexture0.Load(r1.xyw).x;
  r0.yzw = postFxControl1.zzz * r0.yzw;
  ...
  r0.x = postFxControl0.y / r0.x;
  r0.x = -1 + r0.x;
  r0.x = postFxControl0.z * r0.x;
  r0.x = postFxControl0.w * r0.x;
  r0.y = cmp(0 < r0.x);
  r0.x = 0.5 * r0.x;
  o1.x = r0.y ? r0.x : 0;
  o1.y = saturate(r0.x * postFxControl1.x + postFxControl1.y);
  return;
}