...
dcl_immediateConstantBuffer { { 0.258800, -0.965900, 0, 0},
...
utof r0.xy, r0.xyxx
mad r0.x, r0.x, l(4.000000), l(-2.000000)
...
mad r1.yz, r0.xxxx, cb1[44].zzwz, v0.xxyx
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r1.yzyy, t2.xyzw, s0
ge r0.x, r1.x, l(0.984375)
mad_sat r1.x, r1.x, cb8[1].y, cb8[1].z
movc r0.x, r0.x, r1.x, l(1.000000)
min r0.x, r2.w, r0.x
mul r0.x, r0.x, cb8[1].w
lt r1.x, l(0.000000), r0.x
if_nz r1.x
  mad_sat r1.x, r0.x, l(4.000000), l(-0.500000)
  lt r1.y, r1.x, l(1.000000)
  if_nz r1.y
    lt r1.y, l(0.000000), cb1[70].y
    movc r1.yz, r1.yyyy, l(0,1.000000,-1.000000,0), l(0,0.750000,-0.750000,0)
    mul_sat r0.x, r0.x, l(8.000000)
    mul r0.x, r0.x, l(2.250000)
    mul r1.yz, r1.yyzy, r0.xxxx
    mul r1.yz, r1.yyzy, cb1[44].zzwz
    dp3 r0.x, r0.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
    add r0.x, r0.x, l(1.000000)
    iadd r3.w, -r0.x, l(0x7ef311c2)
    mul r3.xyz, r0.yzwy, r3.wwww
    ...
    loop 
      ige r1.w, r0.x, l(6)
      breakc_nz r1.w
      mad r6.xy, r1.yzyy, icb[r0.x + 0].xyxx, v0.xyxx
      ...
      iadd r1.w, -r1.w, l(0x7ef311c2)
      mad r5.xyzw, r1.wwww, r4.xyzw, r5.xyzw
      iadd r0.x, r0.x, l(1)
    endloop 
    rcp r0.x, r5.w
    mul r1.yzw, r0.xxxx, r5.xxyz
    mad r3.xyz, -r5.xyzx, r0.xxxx, r2.xyzx
    mad o0.xyz, r1.xxxx, r3.xyzx, r1.yzwy
  else 
    mov o0.xyz, r2.xyzx
  endif 
else 
