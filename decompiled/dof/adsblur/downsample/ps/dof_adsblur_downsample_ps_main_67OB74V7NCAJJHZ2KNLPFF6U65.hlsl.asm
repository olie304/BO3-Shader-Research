...
gather4_aoffimmi_indexable(-1,-1,0)(texture2d)(float,float,float,float) r0.xyzw, v0.xyxx, t6.xyzw, s1.x
...
max r0.x, r0.y, r0.x
div r0.y, cb8[0].z, r0.x
add_sat r0.y, r0.y, cb8[0].w
mul r0.y, r0.y, cb8[1].x
ge r0.z, r0.x, l(0.984375)
mad_sat r0.x, r0.x, cb8[0].x, cb8[0].y
