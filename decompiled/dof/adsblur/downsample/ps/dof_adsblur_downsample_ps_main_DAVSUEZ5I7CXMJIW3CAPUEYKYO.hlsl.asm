...
// sceneColor                        texture  float4          2d             t0      1 
// sceneStencil                      texture   uint2          2d             t2      1 
// sceneDepth                        texture  float4          2d             t6      1 
...
dcl_output o0.xyzw
dcl_temps 3
sample_aoffimmi_indexable(-1,1,0)(texture2d)(float,float,float,float) r0.xyz, v0.xyxx, t0.xyzw, s1
dp3 r1.x, r0.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
add r1.x, r1.x, l(1.000000)
iadd r1.x, -r1.x, l(0x7ef311c2)
mov r0.w, l(1.000000)
mul r0.xyzw, r0.xyzw, r1.xxxx
sample_aoffimmi_indexable(-1,-1,0)(texture2d)(float,float,float,float) r1.xyz, v0.xyxx, t0.xyzw, s1
...
mul r0.xy, v1.xyxx, l(4.000000, 4.000000, 0.000000, 0.000000)
ftoi r0.xy, r0.xyxx
mov r0.zw, l(0,0,0,0)
ld_indexable(texture2d)(uint,uint,uint,uint) r0.x, r0.xyzw, t2.yxzw
ine r0.x, r0.x, l(128)
and r0.x, r0.x, cb8[0].z
gather4_aoffimmi_indexable(-1,-1,0)(texture2d)(float,float,float,float) r1.xyzw, v0.xyxx, t6.xyzw, s1.x
gather4_aoffimmi_indexable(-1,1,0)(texture2d)(float,float,float,float) r2.xyzw, v0.xyxx, t6.xyzw, s1.x
