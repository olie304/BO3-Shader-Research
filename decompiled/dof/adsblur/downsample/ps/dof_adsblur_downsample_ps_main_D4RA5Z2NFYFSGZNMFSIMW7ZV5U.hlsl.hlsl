  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.xyzw = sceneDepth.Gather(bilinearClamp_s, v0.xy, int2(-1, -1)).xyzw;
  ...
  r0.x = max(r0.x, r0.y);
  r0.y = postFxControl0.z / r0.x;
  r0.y = saturate(postFxControl0.w + r0.y);
  r0.y = postFxControl1.x * r0.y;
  r0.z = cmp(r0.x >= 0.984375);
  r0.x = saturate(r0.x * postFxControl0.x + postFxControl0.y);
  o0.w = r0.z ? r0.x : r0.y;
  return;
}