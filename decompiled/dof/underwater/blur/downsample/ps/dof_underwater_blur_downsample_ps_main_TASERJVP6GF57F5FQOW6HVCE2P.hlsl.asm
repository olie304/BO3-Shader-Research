...
min r1.xy, r0.ywyy, r0.xzxx
ge r0.xyzw, r0.xyzw, l(0.984375, 0.984375, 0.984375, 0.984375)
movc r0.xyzw, r0.xyzw, l(0,0,0,0), l(1.000000,1.000000,1.000000,1.000000)
min r1.x, r1.y, r1.x
mul r1.y, r1.x, l(1.01587307)
ge r1.x, r1.x, l(0.984375)
max r1.y, r1.y, l(0.00000001)
rcp r1.y, r1.y
movc r1.x, r1.x, l(0), r1.y
mul r2.xyzw, r1.xxxx, cb8[0].xyzw
mul r1.xyz, r1.xxxx, cb8[1].xyzx
...
mul r2.x, r2.x, r2.w
mad r3.x, r2.x, r1.x, r2.x
gather4_indexable(texture2d)(float,float,float,float) r4.xyzw, v0.xyxx, t0.xyzw, s0.y
dp4 r1.x, r4.xyzw, r0.xyzw
mul r1.x, r2.y, r1.x
mad r3.y, r1.x, r1.y, r1.x
gather4_indexable(texture2d)(float,float,float,float) r4.xyzw, v0.xyxx, t0.xyzw, s0.z
dp4 r0.x, r4.xyzw, r0.xyzw
mul r0.x, r2.z, r0.x
mad r3.z, r0.x, r1.z, r0.x
add r0.xyz, r3.xyzx, l(0.008730, 0.008730, 0.008730, 0.000000)
log r0.xyz, r0.xyzx
