...
Texture2D<float4> dispFX : register(t1);
Texture2D<float4> boltFX : register(t2);
  ...
  out float3 o0 : SV_TARGET0)
{
  ...
  r0.xy = dispFX.Sample(bilinearClamp_s, v1.zw).xy;
  r0.z = postFxControl0.w * v1.y;
  r0.xy = r0.xy * r0.zz + v1.xy;
  r0.xyz = codeTexture0.Sample(bilinearClamp_s, r0.xy).xyz;
  r1.xyz = boltFX.Sample(bilinearClamp_s, v2.zw).xyz;
  r2.xyz = boltFX.Sample(bilinearClamp_s, v2.xy).xyz;
  r1.xyz = -r2.xyz + r1.xyz;
  r1.xyz = v3.xxx * r1.xyz + r2.xyz;
  r0.xyz = r1.xyz * float3(32768,32768,32768) + r0.xyz;
  r1.xyz = codeTexture0.Sample(bilinearClamp_s, v1.xy).xyz;
  r0.xyz = -r1.xyz + r0.xyz;
  o0.xyz = postFxControl1.xxx * r0.xyz + r1.xyz;
  return;
}