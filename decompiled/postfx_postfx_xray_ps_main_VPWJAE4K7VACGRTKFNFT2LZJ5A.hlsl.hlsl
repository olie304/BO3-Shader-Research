  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.xyzw = codeTexture1.Sample(samp0_s, v1.xy).xyzw;
  r1.x = dot(r0.xyz, float3(1,1,1));
  r1.x = cmp(0 != r1.x);
  r0.w = cmp(r0.w == 0.000000);
  r0.w = r0.w ? r1.x : 0;
  r1.xy = r0.ww ? postFxControl0.zw : postFxControl2.zw;
  r2.xy = renderTargetSize.zw * r1.yy;
  r3.xy = (int2)v0.xy;
  r3.zw = float2(0,0);
  r4.z = floatZSampler.Load(r3.xyw).x;
  r1.yzw = codeTexture0.Load(r3.xyz).xyz;
  r2.w = cmp(0.899999976 < r4.z);
  r3.xy = -r2.yx;
  r3.z = 0;
  r3.xyzw = v1.xyxy + r3.zxyz;
  r5.xyz = codeTexture1.Sample(samp0_s, r3.xy).xyz;
  r2.z = 0;
  r6.xyzw = v1.xyxy + r2.zyxz;
  r2.xyz = codeTexture1.Sample(samp0_s, r6.xy).xyz;
  r7.xyz = codeTexture1.Sample(samp0_s, r3.zw).xyz;
  r8.xyz = codeTexture1.Sample(samp0_s, r6.zw).xyz;
  r3.x = codeTexture2.Sample(samp0_s, r3.xy).x;
  r3.y = codeTexture2.Sample(samp0_s, r6.xy).x;
  r3.z = codeTexture2.Sample(samp0_s, r3.zw).x;
  r3.w = codeTexture2.Sample(samp0_s, r6.zw).x;
  if (r2.w != 0) {
    o0.xyz = r1.yzw;
    o0.w = 1;
    return;
  ...
  r9.xy = r0.ww ? postFxControl1.xy : postFxControl3.xy;
  r2.w = r0.w ? postFxControl0.x : 1;
  r0.w = r0.w ? postFxControl0.y : postFxControl2.y;
  r0.y = max(r0.y, r0.z);
  r0.x = max(r0.x, r0.y);
  ...
  if (r0.x != 0) {
    ...
    r0.x = codeTexture2.Sample(samp0_s, v1.xy).x;
    r0.y = 0;
  }
  r0.z = cmp(0 != r0.w);
  r2.xy = float2(7,0.0130000003) * gameTime.ww;
  r2.z = sin(r2.x);
  r2.z = r2.z * 0.5 + 0.5;
  r4.xy = v1.xy;
  r4.w = r0.x;
  r3.xyzw = r4.xyzw * r2.zzzz;
  r2.z = dot(r3.xyzw, float4(81.2394867,17.3480244,37.3498383,59.3948402));
  r3.x = frac(r2.z);
  r2.z = dot(r3.xyzw, float4(81.2394867,17.3480244,37.3498383,59.3948402));
  r3.y = frac(r2.z);
  r2.z = dot(r3.xyzw, float4(81.2394867,17.3480244,37.3498383,59.3948402));
  ...
  r2.z = r3.x + r2.z;
  r2.z = 0.25 * r2.z;
  r2.xy = v1.xy * float2(20,1970) + r2.xy;
  r2.x = sin(r2.x);
  r2.x = r2.x * 0.5 + 0.5;
  r2.x = r2.x * r0.w;
  r2.y = cos(r2.y);
  ...
  r0.x = r0.x ? r0.z : 0;
  r0.y = r0.x ? 0 : r0.y;
  r0.xz = r0.xx ? float2(0,1) : r2.xy;
  r0.w = cmp(0 < r4.z);
  r1.x = cmp(r4.z >= 0.984375);
  r2.x = 1.01587307 * r4.z;
  r2.y = r4.z * 64 + -63;
  r1.x = r1.x ? r2.y : r2.x;
  ...
  r1.x = -0.5 + v1.x;
  r1.x = r1.x * r2.y;
  r2.x = 1.69885421 * r1.x;
  r1.x = dot(r2.xy, r2.xy);
  r1.x = sqrt(r1.x);
  r1.x = r9.x + -r1.x;
  r1.x = saturate(r1.x * r9.y);
  r0.w = r0.w ? r1.x : 1;
  r0.x = r0.x + r0.y;
  r0.x = r0.w * r0.x;
  r0.x = 32768 * r0.x;
  r0.xyw = r0.xxx * r6.xyz;
  o0.xyz = r0.zzz * r1.yzw + r0.xyw;
  o0.w = 1;
  return;
}