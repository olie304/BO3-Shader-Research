// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:33:21 2021
...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  if (r1.w != 0) {
    ...
    r3.xy = r3.xy * scaleUVs2.xy + r13.xy;
    ...
    r12.x = clampU2 ? r3.z : r3.x;
    r12.y = clampV2 ? r3.w : r3.y;
  }
  r3.xyzw = emissiveMap2.Sample(colorSampler_s, r12.xy).xyzw;
  ...
  r1.x = r1.x * r1.w + flickerRange2.x;
