...
r3.w = samp0[]..swiz;
  ...
  r3.xy = (uint2)r6.yx;
  r1.w = dot(r3.yx, float2(0.0671105608,0.00583714992));
  r1.w = frac(r1.w);
  r1.zw = float2(0.0078125,52.9829178) * r1.zw;
  r1.w = frac(r1.w);
  r1.w = r1.w * 6.28318548 + gameTick.w;
  sincos(r1.w, r5.x, r9.x);
  r1.w = dot(r3.xy, float2(0.0671105608,0.00583714992));
  r1.w = frac(r1.w);
  r1.w = 52.9829178 * r1.w;
  r1.w = frac(r1.w);
  r1.w = r1.w * 6.28318548 + gameTick.w;
  sincos(r1.w, r3.x, r11.x);
  r7.x = saturate(dot(r2.xyz, r10.xyz));
  r1.w = dot(-r10.xyz, r2.xyz);
  r1.w = r1.w + r1.w;
  r12.xyz = r2.xyz * -r1.www + -r10.xyz;
  r1.w = 17 * r7.y;
  r1.w = exp2(r1.w);
  r1.w = 2 + r1.w;
  r1.w = 2 / r1.w;
  ...
  while (true) {
    ...
    r9.w = cmp((int)r1.z == (int)r7.w);
    bitmask.w = ((~(-1 << r6.x)) << 0) & 0xffffffff;  r10.w = (((uint)0 << 0) & bitmask.w) | ((uint)r8.w & ~bitmask.w);
    r8.w = r9.w ? r10.w : r8.w;
    r9.w = cmp((int)r6.y == (int)r7.w);
    if (r7.z == 0) r10.w = 0; else if (r7.z+0 < 32) {     r10.w = (uint)r8.w << (32-(r7.z + 0)); r10.w = (uint)r10.w >> (32-r7.z);    } else r10.w = (uint)r8.w >> 0;
    r8.w = r9.w ? r10.w : r8.w;
  ...
  if (r3.z != 0) {
    r3.z = 1 + -r22.w;
    r5.w = sunConstants.globalProbeExposure * r3.z;
  ...
  if (r5.z != 0) {
    ...
    if (r5.z != 0) {
      ...
      r3.z = r5.w * r3.z;
      r3.z = 0.25 * r3.z;
      r16.xyz = r3.zzz * r11.yzw + r7.yzw;
      r3.w = saturate(1 + -r3.w);
      r5.z = r3.w * r3.w;
      r5.z = r5.z * r5.z;
      r3.w = r5.z * r3.w;
      r3.z = r3.z * r3.w;
      r17.xyz = r3.zzz * r11.zwy + r14.xyz;
      r15.w = r17.z;
      r6.w = r14.z;
