// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:40:20 2021
...
Texture2D<float4> vignetteMap : register(t7);
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r1.x = r1.x * r0.w;
  r3.xyzw = float4(3.05175781e-05,3.05175781e-05,3.05175781e-05,1) * r2.xyzw;
  r0.xyzw = -r2.xyzw * float4(3.05175781e-05,3.05175781e-05,3.05175781e-05,1) + r0.xyzw;
  r0.xyzw = r1.xxxx * r0.xyzw + r3.xyzw;
  r1.xyzw = vignetteMap.Sample(bilinearSampler_s, v1.xy).xyzw;
  r2.x = saturate(scriptVector1.w);
  r1.w = r2.x * r1.w;
