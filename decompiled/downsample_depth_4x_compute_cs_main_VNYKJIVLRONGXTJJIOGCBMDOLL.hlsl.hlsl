...
// unknown dcl_: dcl_thread_group 8, 8, 1
  ...
  r1.xyzw = floatZSampler.Gather(depthSampler_s, r0.xy).zxwy;
  r2.xyzw = floatZSampler.Gather(depthSampler_s, r0.xy, int2(0, 2)).zxwy;
  r3.xyzw = floatZSampler.Gather(depthSampler_s, r0.xy, int2(2, 0)).zxwy;
  r0.xyzw = floatZSampler.Gather(depthSampler_s, r0.xy, int2(2, 2)).zxwy;
  ...
  if (r4.x != 0) {
    ...
    r4.xy = r4.xx ? r5.xy : r5.zw;
    r4.z = cmp(r1.x < r4.x);
    r1.yw = float2(2.80259693e-45,4.20389539e-45);
    r4.xy = r4.zz ? r1.xy : r4.xy;
    r4.z = cmp(r1.z < r4.x);
    r4.xy = r4.zz ? r1.zw : r4.xy;
    r4.z = cmp(r2.y < r4.x);
    r5.xz = r2.yw;
    r5.yw = float2(5.60519386e-45,7.00649232e-45);
    r4.xy = r4.zz ? r5.xy : r4.xy;
    r4.z = cmp(r2.w < r4.x);
    r4.xy = r4.zz ? r5.zw : r4.xy;
    r4.z = cmp(r2.x < r4.x);
    r2.yw = float2(8.40779079e-45,9.80908925e-45);
    r4.xy = r4.zz ? r2.xy : r4.xy;
    r4.z = cmp(r2.z < r4.x);
    r4.xy = r4.zz ? r2.zw : r4.xy;
    r4.z = cmp(r3.y < r4.x);
    r5.xz = r3.yw;
    r5.yw = float2(1.12103877e-44,1.26116862e-44);
    r4.xy = r4.zz ? r5.xy : r4.xy;
    r4.z = cmp(r3.w < r4.x);
    r4.xy = r4.zz ? r5.zw : r4.xy;
    r4.z = cmp(r3.x < r4.x);
    r3.yw = float2(1.40129846e-44,1.54142831e-44);
    r4.xy = r4.zz ? r3.xy : r4.xy;
    r4.z = cmp(r3.z < r4.x);
    r4.xy = r4.zz ? r3.zw : r4.xy;
    r4.z = cmp(r0.y < r4.x);
    r5.xz = r0.yw;
    r5.yw = float2(1.68155816e-44,1.821688e-44);
    r4.xy = r4.zz ? r5.xy : r4.xy;
    r4.z = cmp(r0.w < r4.x);
    r4.xy = r4.zz ? r5.zw : r4.xy;
    r4.z = cmp(r0.x < r4.x);
    r0.yw = float2(1.96181785e-44,2.1019477e-44);
    r4.xy = r4.zz ? r0.xy : r4.xy;
    r4.z = cmp(r0.z < r4.x);
    r4.xy = r4.zz ? r0.zw : r4.xy;
  } else {
    r4.z = cmp(r1.y < r1.w);
    r5.xz = r1.wy;
    r5.yw = float2(1.40129846e-45,0);
    r4.zw = r4.zz ? r5.xy : r5.zw;
    r5.x = cmp(r4.z < r1.x);
    r1.yw = float2(2.80259693e-45,4.20389539e-45);
    r1.xy = r5.xx ? r1.xy : r4.zw;
    r4.z = cmp(r1.x < r1.z);
    r1.xy = r4.zz ? r1.zw : r1.xy;
    r1.z = cmp(r1.x < r2.y);
    r5.xz = r2.yw;
    r5.yw = float2(5.60519386e-45,7.00649232e-45);
    r1.xy = r1.zz ? r5.xy : r1.xy;
    r1.z = cmp(r1.x < r2.w);
    r1.xy = r1.zz ? r5.zw : r1.xy;
    r1.z = cmp(r1.x < r2.x);
    r2.yw = float2(8.40779079e-45,9.80908925e-45);
    r1.xy = r1.zz ? r2.xy : r1.xy;
    r1.z = cmp(r1.x < r2.z);
    r1.xy = r1.zz ? r2.zw : r1.xy;
    r1.z = cmp(r1.x < r3.y);
    r2.xz = r3.yw;
    r2.yw = float2(1.12103877e-44,1.26116862e-44);
    r1.xy = r1.zz ? r2.xy : r1.xy;
    r1.z = cmp(r1.x < r3.w);
    r1.xy = r1.zz ? r2.zw : r1.xy;
    r1.z = cmp(r1.x < r3.x);
    ...
    r1.z = cmp(r1.x < r3.z);
    r1.xy = r1.zz ? r3.zw : r1.xy;
    r1.z = cmp(r1.x < r0.y);
    r2.xz = r0.yw;
    r2.yw = float2(1.68155816e-44,1.821688e-44);
    r1.xy = r1.zz ? r2.xy : r1.xy;
    r1.z = cmp(r1.x < r0.w);
    r1.xy = r1.zz ? r2.zw : r1.xy;
    r1.z = cmp(r1.x < r0.x);
    ...
    r1.x = cmp(r0.x < r0.z);
    r4.xy = r1.xx ? r0.zw : r0.xy;
  }
  r0.x = (uint)r4.y << 1;
  r0.xy = int2(-2147483648,-2147483648) >> (uint2)r0.xx;
