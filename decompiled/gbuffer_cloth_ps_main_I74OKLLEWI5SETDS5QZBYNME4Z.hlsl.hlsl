...
r0.x = colorSampler[]..swiz;
  ...
  r1.x = debugGlossOverride.x * r1.y + glossRange.x;
  r1.x = saturate(0.0588235296 * r1.x);
  r1.x = -17 * r1.x;
  r1.x = exp2(r1.x);
  r1.x = r3.x + r1.x;
  ...
  if (r1.y != 0) {
    ...
    r2.xyz = r1.zzz ? r6.xyw : r7.xyz;
  }
  r6.xyz = debugColorOverride.xyz + -r2.xyz;
  r2.xyz = debugColorOverride.www * r6.xyz + r2.xyz;
  r1.y = -r1.w * w1.x + debugAlphaOverride.x;
  r1.y = debugAlphaOverride.w * r1.y + r2.w;
  ...
  r1.x = debugOcclusionOverride.x + -r0.w;
  o2.z = debugOcclusionOverride.w * r1.x + r0.w;
  r1.xzw = v9.xxx ? v4.xyz : -v4.xyz;
  ...
  r7.xyz = r1.xxx * r7.xyz + float3(1,1,1);
  r8.xyz = clothSecondaryTint.xyz + -r7.xyz;
  r1.xzw = r1.zzz * r8.xyz + r7.xyz;
  r0.w = saturate(r1.y + -r0.x);
  ...
  r3.x = rsqrt(r3.x);
  r8.xyz = -v8.xyz * r3.xxx;
  r3.x = saturate(dot(r4.yzw, r8.xyz));
  r3.x = 1 + -r3.x;
