...
sample_indexable(texture2d)(float,float,float,float) r3.yzw, v2.xyxx, t24.wxyz, s5
...
mad r3.x, cb1[62].x, r3.x, cb0[12].x
...
add r1.w, -r2.w, r3.x
mad r1.w, cb1[62].w, r1.w, r2.w
add r2.w, -r0.w, cb1[63].x
mad r0.w, cb1[63].w, r2.w, r0.w
movc r3.xyz, v8.xxxx, v4.xyzx, -v4.xyzx
dp3 r2.w, r3.xyzx, r3.xyzx
rsq r2.w, r2.w
mad r3.xyz, r3.xyzx, r2.wwww, -r4.xzwx
...
mad r0.z, r0.z, r2.w, r5.w
mad r3.xyz, r3.xyzx, r2.wwww, r15.xyzx
dp3 r3.w, r3.xyzx, r3.xyzx
rsq r3.w, r3.w
mul r3.xyz, r3.wwww, r3.xyzx
mad r8.y, r1.w, r2.w, r6.w
...
dp3 r5.x, r12.xyzx, r6.xyzx
dp3 r5.y, r12.xyzx, r7.xyzx
lt r4.y, l(0.000000), r1.w
div r5.xy, -r5.xyxx, r1.wwww
and r4.yw, r4.yyyy, r5.xxxy
add r5.x, cb0[14].z, l(0.000010)
mad r4.yw, r4.yyyw, r5.xxxx, v2.xxxy
sample_indexable(texture2d)(float,float,float,float) r5.xyzw, r4.ywyy, t29.xyzw, s1
mul r5.xyz, r9.xyzx, r5.xyzx
mov_sat r1.w, r1.w
log r4.y, r1.w
mul r4.y, r4.y, cb0[13].x
exp r4.y, r4.y
add r1.w, -r1.w, l(1.000000)
log r1.w, r1.w
mul r1.w, r1.w, cb0[13].x
exp r1.w, r1.w
movc r1.w, cb0[14].y, r1.w, r4.y
eq r4.y, cb0[13].x, l(0.000000)
movc r1.w, r4.y, l(1.000000), r1.w
mul r0.x, r0.x, r5.w
mul r0.x, r1.w, r0.x
mul r0.x, r2.w, r0.x
...
sqrt r2.w, r1.w
add r4.y, -r8.y, l(1.000000)
mul r4.z, r4.y, l(5.000000)
mad r4.w, r4.y, l(5.000000), l(-2.500000)
mul_sat r4.w, r4.w, l(0.400000)
mul r4.w, r4.w, l(100.000000)
mad r6.zw, -r4.yyyy, l(0.000000, 0.000000, 10.000000, 5.000000), l(0.000000, 0.000000, 6.857410, 7.085000)
exp r6.z, r6.z
mul r6.z, r6.z, r8.x
mul r7.w, r4.y, r4.z
...
loop 
  ...
  dp3 r31.x, r3.xyzx, r23.xyzx
  dp3 r31.y, r3.xyzx, r32.xyzx
  dp3 r31.z, r3.xyzx, r25.xyzx
...
if_z r6.w
  ...
  if_nz r4.w
    ...
    mad r21.xyz, r23.xyzx, r4.yyyy, r9.yzwy
    mov r13.w, l(0)
    sample_l_indexable(texturecubearray)(float,float,float,float) r9.yzw, r13.xyzw, t8.wxyz, s2, r4.z
    mad r4.y, cb2[19].x, r4.w, -r3.w
    mad r3.w, r8.y, r4.y, r3.w
    mad r22.xyz, r9.yzwy, r3.wwww, r22.xyzx
  endif 
else 
  mov r22.x, r21.w
endif 
...
mad r4.yz, r8.xxyx, l(0.000000, 0.984375, 0.984375, 0.000000), l(0.000000, 0.00781250, 0.00781250, 0.000000)
sample_l_indexable(texture2d)(float,float,float,float) r4.yz, r4.yzyy, t5.zxyw, s2, l(0.000000)
mul r8.yzw, r3.wwww, r22.xxyz
mul r15.xyz, r4.yyyy, r8.zwyz
mul r4.yzw, r4.zzzz, r8.yyzw
sqrt r0.w, r2.w
...
if_nz r7.w
  ...
  if_nz r7.w
    ...
    mad r10.xyz, r8.zzzz, r9.yzwy, r14.xyzx
    ...
    mad r8.yzw, r6.wwww, r9.yyzw, r4.yyzw
    add_sat r0.y, -r0.y, l(1.000000)
    mul r7.w, r0.y, r0.y
    mul r7.w, r7.w, r7.w
    mul r0.y, r0.y, r7.w
    mul r0.y, r0.y, r6.w
    mad r16.xyz, r0.yyyy, r9.zwyz, r15.xyzx
    mov r10.w, r16.z
    mov r14.w, r15.z
    movc r14.xyzw, r6.zzzz, r10.xyzw, r14.xyzw
    mov r16.zw, r8.yyyz
    mov r15.zw, r4.yyyz
    movc r10.xyzw, r6.zzzz, r16.xyzw, r15.xyzw
    movc r4.w, r6.z, r8.w, r4.w
    mov r15.z, r14.w
    mov r15.xy, r10.xyxx
    mov r4.yz, r10.zzwz
  endif 
...
mov r5.w, l(1.000000)
movc r1.xyzw, cb0[14].xxxx, r1.xyzw, r5.xyzw
