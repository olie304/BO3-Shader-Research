...
//   float4 postFxBloom22;              // Offset: 1632 Size:    16
...
dcl_constantbuffer CB8[103], immediateIndexed
...
utof r0.x, r0.x
mul r0.y, cb8[102].w, cb8[102].y
mul r0.x, r0.x, r0.y
mul o1.xyz, r0.xxxx, l(1.690600, 1.096800, 0.747900, 0.000000)
mul o2.xy, r0.xxxx, l(0.472800, 0.229900, 0.000000, 0.000000)
