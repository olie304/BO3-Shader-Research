...
if_nz r0.y
  ...
  if_nz r0.y
    ...
    add r0.y, r1.w, -cb2[17].w
    mad r0.y, -r0.y, l(0.00006104), l(1.000000)
    iadd r1.x, cb2[26].y, l(2)
    utof r3.z, r1.x
    sample_c_lz_aoffimmi_indexable(1,1,0)(texture2darray)(float,float,float,float) r1.x, r3.xyzx, t13.xxxx, s13, r0.y
    sample_c_lz_aoffimmi_indexable(1,-1,0)(texture2darray)(float,float,float,float) r1.y, r3.xyzx, t13.xxxx, s13, r0.y
    add r1.x, r1.y, r1.x
    sample_c_lz_aoffimmi_indexable(-1,1,0)(texture2darray)(float,float,float,float) r1.y, r3.xyzx, t13.xxxx, s13, r0.y
    add r1.x, r1.y, r1.x
    sample_c_lz_aoffimmi_indexable(-1,-1,0)(texture2darray)(float,float,float,float) r0.y, r3.xyzx, t13.xxxx, s13, r0.y
    add r0.y, r0.y, r1.x
    sample_l_indexable(texture2darray)(float,float,float,float) r1.x, r3.xyzx, t31.xyzw, s0, l(0.000000)
    mad r0.y, r0.y, l(0.250000), r1.x
    add_sat r4.x, r0.y, l(-1.000000)
  endif 
  imm_atomic_alloc r3.x, u0
  mov r4.yz, l(0,1,31,0)
  store_structured u0.xyz, r3.x, l(76), r4.xyzx
  store_structured u0.x, r3.x, l(0), l(4)
  imm_atomic_alloc r3.x, u0
  add r3.x, r3.x, r4.x
  imm_atomic_alloc r4.x, u0
  mov r3.yz, l(0,2,31,0)
  store_structured u0.xyz, r4.x, l(76), r3.xyzx
  store_structured u0.x, r4.x, l(0), l(4)
  imm_atomic_alloc r4.x, u0
  add r3.x, r3.x, r4.x
  imm_atomic_alloc r4.x, u0
