// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:36:48 2021
...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  if (r2.x != 0) {
    ...
    r3.xyz = r3.zzz ? float3(0,1,0) : r0.xyz;
    r0.xyz = r2.yyy ? r2.xzw : r3.xyz;
  }
  ...
  r1.x = r1.w + -r1.z;
  r2.y = debugGlossOverride.w * r1.x + r1.z;
  r1.x = debugOcclusionOverride.x + -r1.y;
  r1.x = debugOcclusionOverride.w * r1.x + r1.y;
  ...
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r16.xyzw, r10.w, l(0), t15.wxyz
  r16.x = samp0[]..swiz;
  r16.y = samp0[]..swiz;
  r16.z = samp0[]..swiz;
  r16.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r17.xyzw, r10.w, l(16), t15.xyzw
  r17.x = samp0[]..swiz;
  r17.y = samp0[]..swiz;
  r17.z = samp0[]..swiz;
  r17.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r18.xyzw, r10.w, l(32), t15.yxwz
  r18.x = samp0[]..swiz;
  r18.y = samp0[]..swiz;
  r18.z = samp0[]..swiz;
  r18.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r20.xyzw, r10.w, l(48), t15.xyzw
  r20.x = samp0[]..swiz;
  r20.y = samp0[]..swiz;
  r20.z = samp0[]..swiz;
  r20.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r21.xyzw, r10.w, l(64), t15.zwxy
  r21.x = samp0[]..swiz;
  r21.y = samp0[]..swiz;
  r21.z = samp0[]..swiz;
  r21.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r22.xyzw, r10.w, l(80), t15.xyzw
  r22.x = samp0[]..swiz;
  r22.y = samp0[]..swiz;
  r22.z = samp0[]..swiz;
  r22.w = samp0[]..swiz;
  ...
  r11.y = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r23.xyzw, r10.w, l(116), t15.xyzw
  r23.x = samp0[]..swiz;
  r23.y = samp0[]..swiz;
  r23.z = samp0[]..swiz;
  r23.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r24.xyzw, r10.w, l(132), t15.zwxy
  r24.x = samp0[]..swiz;
  r24.y = samp0[]..swiz;
  r24.z = samp0[]..swiz;
  r24.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r25.xyzw, r10.w, l(148), t15.zwxy
  r25.x = samp0[]..swiz;
  r25.y = samp0[]..swiz;
  r25.z = samp0[]..swiz;
  r25.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r26.xyzw, r10.w, l(164), t15.zwxy
  r26.x = samp0[]..swiz;
  r26.y = samp0[]..swiz;
  r26.z = samp0[]..swiz;
  r26.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r27.xyzw, r10.w, l(180), t15.zwxy
  r27.x = samp0[]..swiz;
  r27.y = samp0[]..swiz;
  r27.z = samp0[]..swiz;
  r27.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r28.xyzw, r10.w, l(196), t15.xyzw
  r28.x = samp0[]..swiz;
  r28.y = samp0[]..swiz;
  r28.z = samp0[]..swiz;
  r28.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r29.xy, r10.w, l(212), t15.xyxx
  r29.x = samp0[]..swiz;
  r29.y = samp0[]..swiz;
    r30.xyz = v5.xyz + -r16.yzw;
    r11.z = dot(r30.xyz, r30.xyz);
    r11.z = sqrt(r11.z);
    r11.z = cmp(probeDebugRadius >= r11.z);
    r12.w = (int)r23.y & 0x0000ffff;
  // Known bad code for instruction (needs manual fix):
  ...
  r36.z = samp0[]..swiz;
  r36.w = samp0[]..swiz;
    r13.z = dot(r31.xyz, r30.xyz);
    r13.z = saturate(r13.z + r31.w);
    r13.w = dot(r32.xyz, r30.xyz);
    r13.w = saturate(r13.w + r32.w);
    r13.z = r13.z * r13.w;
    r13.w = dot(r33.xyz, r30.xyz);
    r13.w = saturate(r13.w + r33.w);
    r13.z = r13.z * r13.w;
    r13.w = dot(r34.xyz, r30.xyz);
    r13.w = saturate(r13.w + r34.w);
    r13.z = r13.z * r13.w;
    r13.w = dot(r35.xyz, r30.xyz);
    r13.w = saturate(r13.w + r35.w);
    r13.z = r13.z * r13.w;
    r13.w = dot(r36.xyz, r30.xyz);
    r13.w = saturate(r13.w + r36.w);
    r12.x = r13.z * r13.w;
    r13.z = (int)r11.x & 1;
    r13.zw = r13.zz ? r12.xy : r12.zx;
    r31.xy = r23.zw;
    r31.z = r24.z;
    r12.x = dot(r8.xyz, r31.xyz);
    r16.w = dot(r30.xyz, r31.xyz);
    r16.w = r16.w + -r24.w;
    r19.w = cmp(r16.w >= 0);
    ...
    r12.x = min(abs(r16.w), r12.x);
    r29.zw = r28.zw;
    r16.w = dot(r8.zxy, r29.xzw);
    r19.w = dot(r30.zxy, r29.xzw);
    r19.w = r19.w + -r29.y;
    r23.z = cmp(r19.w >= 0);
    r19.w = max(abs(r19.w), r4.w);
    r19.w = r23.z ? r19.w : -r19.w;
    ...
    r24.x = r20.w;
    r24.yz = r21.zw;
    r24.xyz = r24.xyz + r30.xyz;
    r24.xyz = r8.xyz * r12.xxx + r24.xyz;
    ...
    r25.w = (uint)r17.y;
    r17.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r25.xyzw, r12.x).xyz;
    r23.yzw = (int3)r17.yzw & int3(-2147483648,-2147483648,-2147483648);
    r23.yzw = cmp((int3)r23.yzw == int3(2139095040,2139095040,2139095040));
    r12.x = (int)r23.z | (int)r23.y;
    r12.x = (int)r23.w | (int)r12.x;
    r17.yzw = r12.xxx ? float3(1,1,0) : r17.yzw;
    r24.x = dot(r30.xyz, r16.xyz);
    r24.y = dot(r30.xyz, r26.xyz);
    r24.z = dot(r30.xyz, r18.xyz);
    r20.xyz = saturate(r24.xyz * r20.xyz + float3(0.5,0.5,0.5));
    r21.z = r22.x;
    r20.xyz = r20.xyz * r21.xyz + r22.yzw;
    r25.x = dot(r6.xyz, r16.xyz);
    r25.y = dot(r6.xyz, r26.xyz);
    r25.z = dot(r6.xyz, r18.xyz);
    r16.xyz = gProbeXArray.SampleLevel(samplerLinearClamp_s, r20.xyz, 0).xyz;
    r18.xyz = float3(0,0,0.5) + r20.xyz;
    r21.xyz = gProbeXArray.SampleLevel(samplerLinearClamp_s, r18.xyz, 0).xyz;
    r22.xyz = gProbeYArray.SampleLevel(samplerLinearClamp_s, r20.xyz, 0).xyz;
    r23.yzw = gProbeYArray.SampleLevel(samplerLinearClamp_s, r18.xyz, 0).xyz;
    ...
    r24.xyz = r23.yzw + r22.xyz;
    r24.xyz = r24.xyz + r20.xyz;
    r24.xyz = r24.xyz + r18.xyz;
    r24.xyz = r24.xyz * r7.yyy;
    r16.xyz = r21.xyz + r16.xyz;
    r20.xyz = r16.xyz + r20.xyz;
    r18.xyz = r20.xyz + r18.xyz;
    r18.xyz = r18.xyz * r7.zzz;
    r16.xyz = r16.xyz + r22.xyz;
    r16.xyz = r16.xyz + r23.yzw;
    r16.xyz = r16.xyz * r7.www;
    r18.xyz = float3(0.25,0.25,0.25) * r18.xyz;
    r18.xyz = r24.xyz * float3(0.25,0.25,0.25) + r18.xyz;
    r16.xyz = r16.xyz * float3(0.25,0.25,0.25) + r18.xyz;
    r18.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r25.xyzw, 6).xyz;
    r20.xyz = (int3)r18.xyz & int3(-2147483648,-2147483648,-2147483648);
    r20.xyz = cmp((int3)r20.xyz == int3(2139095040,2139095040,2139095040));
    r12.x = (int)r20.y | (int)r20.x;
    r12.x = (int)r20.z | (int)r12.x;
    r18.xyz = r12.xxx ? float3(1,1,0) : r18.xyz;
    r20.xyzw = r14.xyzw;
    r21.xyz = r15.yzw;
    r12.x = r9.w;
    r16.w = r10.z;
    while (true) {
      ...
      if (r19.w != 0) {
        ...
        if (r11.z != 0) {
          ...
          r19.w = 1;
          while (true) {
            r21.w = cmp((int)r19.w >= (int)r17.x);
            if (r21.w != 0) break;
            r21.w = (int)r12.w + (int)r19.w;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r24.xyzw, r21.w, l(0), t16.xyzw
          r24.x = samp0[]..swiz;
          r24.y = samp0[]..swiz;
          r24.z = samp0[]..swiz;
          r24.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r25.xyzw, r21.w, l(16), t16.xyzw
          r25.x = samp0[]..swiz;
          r25.y = samp0[]..swiz;
          r25.z = samp0[]..swiz;
          r25.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r26.xyzw, r21.w, l(32), t16.xyzw
          r26.x = samp0[]..swiz;
          r26.y = samp0[]..swiz;
          r26.z = samp0[]..swiz;
          r26.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r27.xyzw, r21.w, l(48), t16.xyzw
          r27.x = samp0[]..swiz;
          r27.y = samp0[]..swiz;
          r27.z = samp0[]..swiz;
          r27.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r28.xyzw, r21.w, l(64), t16.xyzw
          r28.x = samp0[]..swiz;
          r28.y = samp0[]..swiz;
          r28.z = samp0[]..swiz;
          r28.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r29.xyzw, r21.w, l(80), t16.xyzw
          r29.x = samp0[]..swiz;
          r29.y = samp0[]..swiz;
          r29.z = samp0[]..swiz;
          r29.w = samp0[]..swiz;
            r21.w = dot(r24.xyz, r30.xyz);
            r21.w = saturate(r21.w + r24.w);
            r21.w = r22.x * r21.w;
            r22.z = dot(r25.xyz, r30.xyz);
            r22.z = saturate(r22.z + r25.w);
            r21.w = r22.z * r21.w;
            r22.z = dot(r26.xyz, r30.xyz);
            r22.z = saturate(r22.z + r26.w);
            r21.w = r22.z * r21.w;
            r22.z = dot(r27.xyz, r30.xyz);
            r22.z = saturate(r22.z + r27.w);
            r21.w = r22.z * r21.w;
            r22.z = dot(r28.xyz, r30.xyz);
            r22.z = saturate(r22.z + r28.w);
            r21.w = r22.z * r21.w;
            r22.z = dot(r29.xyz, r30.xyz);
            r22.z = saturate(r22.z + r29.w);
            r22.x = r22.z * r21.w;
            r22.w = (uint)r18.w >> 2;
            if (1 == 0) r23.y = 0; else if (1+2 < 32) {             r23.y = (uint)r18.w << (32-(1 + 2)); r23.y = (uint)r23.y >> (32-1);            } else r23.y = (uint)r18.w >> 2;
            r23.z = (int)r22.w & 2;
            r23.w = max(r22.y, r22.x);
            r21.w = -r21.w * r22.z + 1;
            r21.w = r22.y * r21.w;
            r13.y = r23.z ? r21.w : r23.w;
            r22.xy = r23.yy ? r22.xy : r13.xy;
            r19.w = (int)r19.w + 1;
            r18.w = r22.w;
          }
          ...
          r18.w = cmp(0 < r13.y);
          if (r18.w != 0) {
            r24.z = r22.y * r11.y + r21.z;
            r13.y = r13.y * r23.x;
            r22.xzw = r16.xyz * r13.yyy;
            r23.yzw = r22.xzw * r18.xyz;
            r18.w = dot(r23.yzw, float3(0.212599993,0.715200007,0.0722000003));
            r25.xyz = r22.xzw * r18.xyz + r20.xyz;
            r19.w = r18.w * r7.x;
            r22.xzw = r17.yzw * r13.yyy;
            r13.y = dot(r22.xzw, float3(0.212599993,0.715200007,0.0722000003));
            r13.y = r7.x * r18.w + r13.y;
            r13.y = r19.w / r13.y;
            r26.x = r20.w;
            r26.yz = r21.xy;
            r24.xyw = r22.zwx * r13.yyy + r26.yzx;
            r25.w = r24.w;
          } else {
            r25.xyzw = r20.xyzw;
            r24.xyz = r21.xyz;
  ...
  if (r9.w == 0) {
    ...
    while (true) {
      ...
      r12.x = cmp((int)r10.x == (int)r11.w);
      bitmask.y = ((~(-1 << r10.y)) << 0) & 0xffffffff;  r12.y = (((uint)0 << 0) & bitmask.y) | ((uint)r11.z & ~bitmask.y);
      r11.z = r12.x ? r12.y : r11.z;
      r12.x = cmp((int)r10.z == (int)r11.w);
      ...
      while (true) {
        ...
        r23.y = samp0[]..swiz;
          ...
          r22.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r16.zw, r12.z, l(96), t15.xxxy
          r16.z = samp0[]..swiz;
          r16.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
          ...
          r30.w = samp0[]..swiz;
            ...
            r32.w = samp0[]..swiz;
              ...
              r24.w = -r24.w * r25.z + 1;
              r24.w = r26.y * r24.w;
              r16.y = r26.w ? r24.w : r27.x;
              r26.xy = r26.zz ? r26.xy : r16.xy;
              r22.w = (int)r22.w + 1;
              r13.x = r25.w;
            }
            ...
            r36.y = samp0[]..swiz;
              ...
              r23.x = r28.w;
              r23.yz = r29.zw;
              r16.yzw = r23.xyz + r24.xyz;
              r16.yzw = r8.xyz * r13.xxx + r16.yzw;
              ...
              r22.y = r25.z;
              r22.z = r27.x;
              r31.x = dot(r16.yzw, r22.xyz);
              r23.xy = r25.xw;
              r23.z = r27.w;
              r31.y = dot(r16.yzw, r23.xyz);
              r27.x = r25.y;
              ...
              r31.w = (uint)r13.w;
              r16.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r31.xyzw, r13.x).xyz;
              r25.xyz = (int3)r16.yzw & int3(-2147483648,-2147483648,-2147483648);
              r25.xyz = cmp((int3)r25.xyz == int3(2139095040,2139095040,2139095040));
              r13.x = (int)r25.y | (int)r25.x;
              r13.x = (int)r25.z | (int)r13.x;
              r16.yzw = r13.xxx ? float3(1,1,0) : r16.yzw;
              ...
              r13.w = r13.x * r7.x;
              r16.yzw = r16.yzw * r12.zzz;
              r12.z = dot(r16.yzw, float3(0.212599993,0.715200007,0.0722000003));
              r12.z = r7.x * r13.x + r12.z;
              r12.z = r13.w / r12.z;
              r22.x = r20.w;
              r22.yz = r21.xy;
              r21.xyw = r16.zwy * r12.zzz + r22.yzx;
              r20.w = r21.w;
            }
          }
        }
    ...
    if (r10.z != 0) {
      ...
      r10.w = 0;
      while (true) {
        r11.w = cmp((uint)r10.w >= (uint)r9.w);
        if (r11.w != 0) break;
        r11.z = (uint)r10.w >> 5;
        r12.xyz = (int3)r11.xyz + (int3)r19.xyz;
        r11.z = visibleProbes.Load(r12.xyzw).x;
        r11.w = cmp((int)r10.x == (int)r10.w);
        if (r10.y == 0) r12.x = 0; else if (r10.y+0 < 32) {         r12.x = (uint)r11.z << (32-(r10.y + 0)); r12.x = (uint)r12.x >> (32-r10.y);        } else r12.x = (uint)r11.z >> 0;
        ...
        while (true) {
          ...
          r16.w = 1 << (int)r16.z;
          r19.w = (int)r15.w & (int)r16.w;
          if (r19.w != 0) {
            r15.w = (int)r15.w ^ (int)r16.w;
            r16.w = (int)r11.w + (int)r16.z;
          // Known bad code for instruction (needs manual fix):
          ...
          r24.y = samp0[]..swiz;
            ...
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r23.xyzw, r16.z, l(0), t15.wxyz
            r23.x = samp0[]..swiz;
            r23.y = samp0[]..swiz;
            r23.z = samp0[]..swiz;
            r23.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r24.xy, r16.z, l(96), t15.xyxx
            r24.x = samp0[]..swiz;
            r24.y = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r25.xyzw, r16.z, l(116), t15.zwxy
            r25.x = samp0[]..swiz;
            r25.y = samp0[]..swiz;
            r25.z = samp0[]..swiz;
            r25.w = samp0[]..swiz;
            ...
            r32.w = samp0[]..swiz;
              ...
              if (r16.w != 0) {
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r28.xyzw, r16.z, l(16), t15.xyzw
              r28.x = samp0[]..swiz;
              r28.y = samp0[]..swiz;
              r28.z = samp0[]..swiz;
              r28.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r29.xyzw, r16.z, l(32), t15.yxwz
              r29.x = samp0[]..swiz;
              r29.y = samp0[]..swiz;
              r29.z = samp0[]..swiz;
              r29.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r30.xyzw, r16.z, l(48), t15.xyzw
              r30.x = samp0[]..swiz;
              r30.y = samp0[]..swiz;
              r30.z = samp0[]..swiz;
              r30.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r31.xyzw, r16.z, l(64), t15.zwxy
              r31.x = samp0[]..swiz;
              r31.y = samp0[]..swiz;
              r31.z = samp0[]..swiz;
              r31.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r32.xyzw, r16.z, l(80), t15.xyzw
              r32.x = samp0[]..swiz;
              r32.y = samp0[]..swiz;
              r32.z = samp0[]..swiz;
              r32.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r33.xyzw, r16.z, l(132), t15.zwxy
              r33.x = samp0[]..swiz;
              r33.y = samp0[]..swiz;
              r33.z = samp0[]..swiz;
              r33.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r34.xyzw, r16.z, l(148), t15.zwxy
              r34.x = samp0[]..swiz;
              r34.y = samp0[]..swiz;
              r34.z = samp0[]..swiz;
              r34.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r35.xyzw, r16.z, l(164), t15.zwxy
              r35.x = samp0[]..swiz;
              r35.y = samp0[]..swiz;
              r35.z = samp0[]..swiz;
              r35.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r36.xyzw, r16.z, l(180), t15.zwxy
              r36.x = samp0[]..swiz;
              r36.y = samp0[]..swiz;
              r36.z = samp0[]..swiz;
              r36.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r37.xyzw, r16.z, l(196), t15.xyzw
              r37.x = samp0[]..swiz;
              r37.y = samp0[]..swiz;
              r37.z = samp0[]..swiz;
              r37.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r38.xy, r16.z, l(212), t15.xyxx
              r38.x = samp0[]..swiz;
              r38.y = samp0[]..swiz;
                ...
                r24.xyz = r8.xyz * r16.yyy + r24.xyz;
                r16.z = dot(r24.xyz, r24.xyz);
                r16.z = sqrt(r16.z);
                r16.y = r16.y / r16.z;
                r16.y = r16.y + r16.y;
                r16.y = sqrt(r16.y);
                ...
                if (9 == 0) r16.z = 0; else if (9+16 < 32) {                 r16.z = (uint)r25.w << (32-(9 + 16)); r16.z = (uint)r16.z >> (32-9);                } else r16.z = (uint)r25.w >> 16;
                r33.w = (uint)r16.z;
                r16.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r33.xyzw, r16.y).xyz;
                r24.xyz = (int3)r16.yzw & int3(-2147483648,-2147483648,-2147483648);
                r24.xyz = cmp((int3)r24.xyz == int3(2139095040,2139095040,2139095040));
                r19.w = (int)r24.y | (int)r24.x;
                r19.w = (int)r24.z | (int)r19.w;
                r16.yzw = r19.www ? float3(1,1,0) : r16.yzw;
                r24.x = dot(r26.xyz, r23.xyz);
                r24.y = dot(r26.xyz, r25.xyz);
                r24.z = dot(r26.xyz, r29.xyz);
                r24.xyz = saturate(r24.xyz * r30.xyz + float3(0.5,0.5,0.5));
                r31.z = r32.x;
                r24.xyz = r24.xyz * r31.xyz + r32.yzw;
                r33.x = dot(r6.xyz, r23.xyz);
                r33.y = dot(r6.xyz, r25.xyz);
                r33.z = dot(r6.xyz, r29.xyz);
                r23.xyz = gProbeXArray.SampleLevel(samplerLinearClamp_s, r24.xyz, 0).xyz;
                r25.xyz = float3(0,0,0.5) + r24.xyz;
                r26.xyz = gProbeXArray.SampleLevel(samplerLinearClamp_s, r25.xyz, 0).xyz;
                r27.xzw = gProbeYArray.SampleLevel(samplerLinearClamp_s, r24.xyz, 0).xyz;
                r28.xyz = gProbeYArray.SampleLevel(samplerLinearClamp_s, r25.xyz, 0).xyz;
                r24.xyz = gProbeZArray.SampleLevel(samplerLinearClamp_s, r24.xyz, 0).xyz;
                ...
                r29.xyz = r29.xyz * r7.yyy;
                r23.xyz = r26.xyz + r23.xyz;
                r24.xyz = r23.xyz + r24.xyz;
                r24.xyz = r24.xyz + r25.xyz;
                r24.xyz = r24.xyz * r7.zzz;
    ...
    r14.xyz = r17.xyz * r2.www;
    r15.xyz = r18.xyz * r2.www;
    r4.w = cmp(r18.w < 0.99000001);
    if (r4.w != 0) {
      r4.w = 1 + -r18.w;
      r7.x = sunConstants.globalProbeExposure * r4.w;
      r10.xyz = -globalProbeConstants.data[0].xyz + v5.xyz;
      ...
      r12.xyz = float3(0,0,0.5) + r10.xyz;
      r13.xyz = gProbeXArray.SampleLevel(samplerLinearClamp_s, r12.xyz, 0).xyz;
      r16.xyz = gProbeYArray.SampleLevel(samplerLinearClamp_s, r10.xyz, 0).xyz;
      r18.xyz = gProbeYArray.SampleLevel(samplerLinearClamp_s, r12.xyz, 0).xyz;
      ...
      r11.xyz = r11.xyz + r18.xyz;
      r7.yzw = r11.xyz * r7.www;
      r10.xyz = float3(0.25,0.25,0.25) * r10.xyz;
      r10.xyz = r19.xyz * float3(0.25,0.25,0.25) + r10.xyz;
      r7.yzw = r7.yzw * float3(0.25,0.25,0.25) + r10.xyz;
