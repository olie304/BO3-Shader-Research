...
r0.y = samp0[]..swiz;
  ...
  r6.w = max(0, r6.w);
  r6.w = 100 * r6.w;
  r13.yz = -r4.yy * float2(10,5) + float2(6.85740995,7.08500004);
  r7.w = exp2(r13.y);
  r7.w = r7.w * r2.x;
  r7.w = 9.1368103 * r7.w;
  r8.w = r4.w * r4.y;
  ...
  if (probeDebug != 0) {
    ...
    r12.w = 0;
    while (true) {
      r26.z = cmp((uint)r12.w >= numRefProbes);
      if (r26.z != 0) break;
      r26.z = (uint)r12.w >> 5;
      r26.z = (int)r8.w + (int)r26.z;
    // Known bad code for instruction (needs manual fix):
  ...
  if (r9.w != 0) {
    ...
    r8.w = (int)r10.w & 0x0000ffff;
    if (6 == 0) r12.w = 0; else if (6+25 < 32) {     r12.w = (uint)r10.w << (32-(6 + 25)); r12.w = (uint)r12.w >> (32-6);    } else r12.w = (uint)r10.w >> 25;
    r15.w = (int)r8.w * 6;
    ...
    while (true) {
      ...
      if (r17.w != 0) break;
      r17.w = (int)r8.w + (int)r16.w;
      r17.w = (int)r17.w * 6;
      r20.w = dot(refProbeAttenuationConstantsCB[r17.w].data[0].xyz, r13.yzw);
      r20.w = saturate(refProbeAttenuationConstantsCB[r17.w].data[0].w + r20.w);
      r20.w = r31.x * r20.w;
      r26.y = dot(refProbeAttenuationConstantsCB[r17.w].data[1].xyz, r13.yzw);
      r26.y = saturate(refProbeAttenuationConstantsCB[r17.w].data[1].w + r26.y);
      r20.w = r26.y * r20.w;
      r26.y = dot(refProbeAttenuationConstantsCB[r17.w].data[2].xyz, r13.yzw);
      r26.y = saturate(refProbeAttenuationConstantsCB[r17.w].data[2].w + r26.y);
      r20.w = r26.y * r20.w;
      r26.y = dot(refProbeAttenuationConstantsCB[r17.w].data[3].xyz, r13.yzw);
      r26.y = saturate(refProbeAttenuationConstantsCB[r17.w].data[3].w + r26.y);
      r20.w = r26.y * r20.w;
      r26.y = dot(refProbeAttenuationConstantsCB[r17.w].data[4].xyz, r13.yzw);
      r26.y = saturate(refProbeAttenuationConstantsCB[r17.w].data[4].w + r26.y);
      r20.w = r26.y * r20.w;
      r26.y = dot(refProbeAttenuationConstantsCB[r17.w].data[5].xyz, r13.yzw);
      r17.w = saturate(refProbeAttenuationConstantsCB[r17.w].data[5].w + r26.y);
      r31.x = r20.w * r17.w;
      r26.y = (uint)r15.w >> 2;
    ...
    if (r8.w != 0) {
      ...
      if (9 == 0) r10.w = 0; else if (9+16 < 32) {       r10.w = (uint)r10.w << (32-(9 + 16)); r10.w = (uint)r10.w >> (32-9);      } else r10.w = (uint)r10.w >> 16;
      r19.w = (uint)r10.w;
      r18.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r19.xyzw, r12.w).xyz;
      r20.xyz = (int3)r18.xyz & int3(-2147483648,-2147483648,-2147483648);
      r20.xyz = cmp((int3)r20.xyz == int3(2139095040,2139095040,2139095040));
      r10.w = (int)r20.y | (int)r20.x;
      r10.w = (int)r20.z | (int)r10.w;
  ...
  if (r9.w == 0) {
    ...
    r17.w = samp0[]..swiz;
      r19.w = cmp((int)r12.w == (int)r16.w);
      bitmask.w = ((~(-1 << r13.y)) << 0) & 0xffffffff;  r20.w = (((uint)0 << 0) & bitmask.w) | ((uint)r17.w & ~bitmask.w);
      r17.w = r19.w ? r20.w : r17.w;
      r19.w = cmp((int)r13.z == (int)r16.w);
      if (r13.w == 0) r20.w = 0; else if (r13.w+0 < 32) {       r20.w = (uint)r17.w << (32-(r13.w + 0)); r20.w = (uint)r20.w >> (32-r13.w);      } else r20.w = (uint)r17.w >> 0;
      r17.w = r19.w ? r20.w : r17.w;
      r23.xyzw = r21.xyzw;
      r24.xyzw = r22.xyzw;
      r19.w = r17.w;
    ...
    r13.z = 0;
    while (true) {
      r13.w = cmp((uint)r13.z >= (uint)r9.w);
      if (r13.w != 0) break;
      r13.w = (uint)r13.z >> 5;
    ...
    r4.y = cmp(r22.z >= 1);
    r6.w = (int)r22.w & 0x0000ff00;
    bitmask.w = ((~(-1 << 8)) << 0) & 0xffffffff;  r6.w = (((uint)r25.y << 0) & bitmask.w) | ((uint)r6.w & ~bitmask.w);
    r8.w = r4.y ? r6.w : r25.y;
    r4.y = max(1, r25.x);
    r4.y = rcp(r4.y);
    r25.x = saturate(r25.x);
    r13.yzw = r23.xyz * r4.yyy;
    r30.xyz = r24.xyz * r4.yyy;
    r6.w = cmp(r25.x < 0.99000001);
    if (r6.w != 0) {
      r8.w = (int)r8.w + 256;
      r6.w = 1 + -r25.x;
      ...
      r7.w = dot(r15.xyz, float3(0.212599993,0.715200007,0.0722000003));
      r13.yzw = r23.xyz * r4.yyy + r15.xyz;
      r14.w = 0;
      r14.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r14.xyzw, r4.w).xyz;
      r4.y = sunConstants.globalProbeExposure * r6.w + -r7.w;
      r4.y = r2.y * r4.y + r7.w;
      r30.xyz = r14.xyz * r4.yyy + r30.xyz;
    }
  } else {
    r13.yzw = float3(0,0,0);
  }
  ...
  if (r2.y != 0) {
    ...
    if (r2.y != 0) {
          ...
          if (r5.x == 0) {
            ...
            if (enableDitheredShadow != 0) {
              ...
              while (true) {
                ...
                r9.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r19.xyz, r5.x).x;
      ...
      r0.z = r1.z * r0.z;
      r0.z = r0.w * r0.z;
      r4.xyw = r0.zzz * r16.xyz + r14.xzw;
      r13.yzw = r1.www ? r17.xyz : r13.yzw;
      r14.xzw = r1.www ? r4.xyw : r14.xzw;
  ...
  if (enableCountDebug != 0) {
    if (debugDrawOverlayType != 0) {
      switch (cb2[53].y) {
        ...
        break;
        case 4 :        r0.w = (int)r8.w & 255;
        break;
        case 5 :        if (8 == 0) r0.w = 0; else if (8+8 < 32) {         r0.w = (uint)r8.w << (32-(8 + 8)); r0.w = (uint)r0.w >> (32-8);        } else r0.w = (uint)r8.w >> 8;
        break;
        default :
        r0.w = 0;
        break;
...
store_uav_typed u0.xyzw, r1.xyyy, r2.xywx
  ...
  if (enableCountDebug != 0) {
    ...
    InterlockedAdd(dest, value, orig_value);
    if (8 == 0) r1.y = 0; else if (8+8 < 32) {     r1.y = (uint)r8.w << (32-(8 + 8)); r1.y = (uint)r1.y >> (32-8);    } else r1.y = (uint)r8.w >> 8;
    // Needs manual fix for instruction:
