...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  r3.xyzw = emissiveMap.Sample(colorSampler_s, r8.xy).xyzw;
  ...
  r1.w = frac(r1.w);
  r2.y = gameTime.w * flickerSpeed + r1.w;
  r2.x = flickerSeed.x;
  r1.w = flickerLookupMap.SampleLevel(lookupSampler_s, r2.xy, 0).x;
  r1.w = log2(abs(r1.w));
  r1.w = flickerPower * r1.w;
  r1.w = exp2(r1.w);
  r2.x = flickerRange.y + -flickerRange.x;
  r1.w = r1.w * r2.x + flickerRange.x;
  r3.xyz = r3.xyz * r1.www;
  ...
  if (r11.y != 0) {
    ...
    r15.w = 0;
    while (true) {
      r16.w = cmp((uint)r15.w >= (uint)r8.w);
      if (r16.w != 0) break;
      r13.z = (uint)r15.w >> 5;
      r14.xyz = (int3)r7.xyz + (int3)r13.xyz;
      r13.z = visibleProbes.Load(r14.xyzw).x;
  ...
  r8.zw = r1.xy * float2(0.984375,0.984375) + float2(0.0078125,0.0078125);
  r8.zw = gEnvBRDFGeneric.SampleLevel(samplerLinear_s, r8.zw, 0).xy;
  r14.xyz = r11.zwy * r8.zzz;
  ...
  if (r7.w != 0) {
    ...
    if (r7.w != 0) {
      ...
      if (sunConstants.sunCookieIndex != 0) {
        r6.w = 1;
        r8.w = dot(sunConstants.sunCookieTransform[0].xyzw, r6.xyzw);
