...
r2.z = samp0[]..swiz;
  ...
  while (true) {
    ...
    bitmask.y = ((~(-1 << r2.x)) << 0) & 0xffffffff;  r9.y = (((uint)0 << 0) & bitmask.y) | ((uint)r8.z & ~bitmask.y);
    r8.z = r8.w ? r9.y : r8.z;
    r8.w = cmp((int)r2.y == (int)r8.y);
      ...
      r14.y = samp0[]..swiz;
        ...
        r31.w = samp0[]..swiz;
          ...
          r37.y = samp0[]..swiz;
            ...
            r32.w = (uint)r10.w;
            r17.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r32.xyzw, r9.w).xyz;
            ...
            r24.x = r22.w;
            r24.yz = r23.xy;
            r23.xyw = r14.yzx * r9.zzz + r24.yzx;
            r22.w = r23.w;
          }
        }
      }
  ...
  if (r2.y != 0) {
    ...
    r7.w = 0;
    while (true) {
      r9.y = cmp((uint)r7.w >= (uint)r6.w);
      if (r9.y != 0) break;
      r13.z = (uint)r7.w >> 5;
      r14.xyz = (int3)r12.xyz + (int3)r13.xyz;
      r9.y = visibleProbes.Load(r14.xyzw).x;
      r9.z = cmp((int)r1.z == (int)r7.w);
      if (r2.x == 0) r9.w = 0; else if (r2.x+0 < 32) {       r9.w = (uint)r9.y << (32-(r2.x + 0)); r9.w = (uint)r9.w >> (32-r2.x);      } else r9.w = (uint)r9.y >> 0;
      r9.y = r9.z ? r9.w : r9.y;
  ...
  if (r5.w != 0) {
    ...
    r14.xyz = r9.yzw ? float3(0,0,0) : float3(0.5,0.5,0.5);
    r14.w = 0;
    r9.yzw = r14.wwx + r8.yzw;
    ...
    r9.yzw = r9.yzw * r15.xxx + r16.xyz;
    r8.yzw = r14.wwz + r8.yzw;
    r8.yzw = gProbeZArray.SampleLevel(samplerLinearClamp_s, r8.yzw, 0).xyz;
    r8.yzw = r8.yzw * r15.zzz + r9.yzw;
    r3.w = 0;
    r9.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r3.xyzw, 6).xyz;
    r8.yzw = r9.yzw * r8.yzw;
    r3.w = dot(r8.yzw, float3(0.212599993,0.715200007,0.0722000003));
    r13.xyz = r20.xyz * r1.zzz + r8.yzw;
    r11.w = 0;
    r8.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r11.xyzw, r4.w).xyz;
    r1.z = sunConstants.globalProbeExposure * r5.w + -r3.w;
    r1.z = r0.y * r1.z + r3.w;
    r2.xyz = r8.yzw * r1.zzz + r2.xyz;
  }
  r6.zw = r0.xy * float2(0.984375,0.984375) + float2(0.0078125,0.0078125);
  r6.zw = gEnvBRDFGlass.SampleLevel(samplerLinear_s, r6.zw, 0).xy;
  r14.xyz = r6.zzz * r2.yzx;
  ...
  if (r5.w == 0) {
    ...
    if (r9.y != 0) {
      ...
      r16.xz = rcp(r15.xx);
      r16.y = -r16.z;
      r15.xyz = r8.yzy * r16.xyz + r15.yzy;
    ...
    r9.w = samp0[]..swiz;
      ...
      if (r10.w == 0) {
        ...
        r16.x = (int)r9.z + (int)r10.w;
        r9.z = (uint)r9.w >> 25;
        r9.z = (uint)r9.z;
        r15.xyz = r15.xyz * r9.zzz;
    ...
    if (r9.y == 0) {
      if (enableDitheredShadow == 0) {
        ...
        r15.xy = r9.yz * float2(0.5,-0.5) + float2(0.5,0.5);
        ...
        r9.y = gTransShadowmapArray.SampleLevel(samp0_s, r15.xyz, 0).x;
        r8.w = r9.y + r8.w;
  ...
  if (r5.w != 0) {
    ...
    if (r5.w != 0) {
      ...
      if (sunConstants.sunCookieIndex != 0) {
        ...
        r15.z = (uint)r6.w;
        r8.yzw = gCookieArray.SampleLevel(samplerLinear_s, r15.xyz, 0).xyz;
      ...
      r18.w = samp0[]..swiz;
        ...
        r19.xyz = r3.xyz * r9.yyy + v6.xyz;
        r19.w = 1;
        r15.x = dot(r15.xyzw, r19.xyzw);
        r15.y = dot(r16.xyzw, r19.xyzw);
        r9.yz = r15.xy * float2(0.5,-0.5) + float2(0.5,0.5);
        r9.yz = r9.yz + r18.zw;
        r9.yz = r9.yz * r18.xy;
        r15.xy = r7.ww / r17.xz;
        r15.zw = float2(1,1) + -r15.xy;
        r15.zw = cmp(r9.yz >= r15.zw);
        r15.xy = cmp(r15.xy >= r9.yz);
        ...
        r16.y = samp0[]..swiz;
          ...
          if (enableDitheredShadow != 0) {
            ...
            r15.z = (uint)r9.y;
            r9.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r15.xyz, r6.w).x;
          }
          r6.w = r9.z * r9.z;
          r6.w = r6.w * r9.z;
        } else {
            ...
            if (r16.w != 0) {
              ...
              if (r16.w != 0) {
                ...
                if (r16.w != 0) {
                  ...
                  r10.w = exp2(r10.w);
                  r10.w = r11.w * r10.w;
                  r39.xyz = r10.www * r32.xyz + r17.xyz;
            ...
            r39.w = samp0[]..swiz;
              ...
              if (r13.w != 0) {
                ...
                if (r13.w != 0) {
                  ...
                  r14.w = r14.w * r7.w;
                  r11.w = cmp(0 < r11.w);
                  r22.xyz = r14.www * r21.xyw + r9.yzw;
