        ...
        if_nz r14.w
          ...
          if_nz r14.w
            ...
            if_nz r19.y
              ...
              mad r19.xyz, r22.xyzx, r15.wwww, r19.xyzx
            ...
            add r15.w, -r14.w, l(1.000000)
            mul r19.xyz, r12.xyzx, r15.wwww
            mad r12.xyz, r18.xyzx, r14.wwww, r19.xyzx
            mul r18.xyz, r15.wwww, r17.xyzx
            mad r17.xyz, r27.xyzx, r14.wwww, r18.xyzx
            mad r10.w, r10.w, r15.w, r14.w
            mul r15.w, r11.z, r15.w
            mad r11.z, r13.w, r14.w, r15.w
          endif 
        endif 
      endif 
    endif 
...
mad r0.z, r0.z, r1.w, r5.w
mad r2.xyz, r2.xyzx, r1.wwww, r14.xyzx
dp3 r2.w, r2.xyzx, r2.xyzx
rsq r2.w, r2.w
mul r2.xyz, r2.wwww, r2.xyzx
mad r7.y, r0.w, r1.w, r6.z
...
exp r0.w, r0.w
movc r0.w, cb0[13].y, r0.w, r4.x
eq r4.x, cb0[12].x, l(0.000000)
movc r0.w, r4.x, l(1.000000), r0.w
mul r0.x, r0.x, r3.w
mul r0.x, r0.w, r0.x
mul r0.x, r1.w, r0.x
...
dp3 r0.w, -r12.xyzx, r2.xyzx
add r0.w, r0.w, r0.w
mad r13.xyz, r2.xyzx, -r0.wwww, -r12.xyzx
mul r0.w, r7.y, l(17.000000)
exp r0.w, r0.w
...
loop 
  ...
  bfi r11.w, r7.z, l(0), l(0), r11.y
  movc r11.y, r11.z, r11.w, r11.y
  ieq r11.z, r7.w, r10.w
  ubfe r11.w, r8.w, l(0), r11.y
  movc r11.y, r11.z, r11.w, r11.y
    ...
    if_nz r14.w
      ...
      if_nz r14.z
        ...
        if_nz r16.x
          ...
          sqrt r14.z, r14.z
          mad r14.z, r4.y, l(5.000000), r14.z
...
max r4.y, r22.w, l(1.000000)
rcp r4.y, r4.y
mov_sat r22.w, r22.w
mul r14.xyz, r4.yyyy, r21.xyzx
mul r11.yzw, r4.yyyy, r22.xxyz
...
if_nz r4.w
  ...
  mad r14.xyz, r21.xyzx, r4.yyyy, r15.xyzx
  mov r13.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r15.xyz, r13.xyzw, t8.xyzw, s2, r4.z
  mad r4.y, cb2[19].x, r4.w, -r2.w
  mad r2.w, r7.y, r4.y, r2.w
  mad r11.yzw, r15.xxyz, r2.wwww, r11.yyzw
endif 
mad r4.yz, r7.xxyx, l(0.000000, 0.984375, 0.984375, 0.000000), l(0.000000, 0.00781250, 0.00781250, 0.000000)
sample_l_indexable(texture2d)(float,float,float,float) r4.yz, r4.yzyy, t5.zxyw, s2, l(0.000000)
mul r15.xyz, r4.yyyy, r11.zwyz
...
if_nz r7.y
  ...
  if_nz r7.y
    ...
    mad r7.yzw, r6.wwww, r9.xxyz, r4.yyzw
...
mad r0.xyw, r28.xyxz, r8.xyxz, r0.xyxw
