...
loop 
  ieq r13.w, r10.w, l(2)
  breakc_nz r13.w
  movc r13.w, r10.w, r0.y, r9.w
  uge r15.y, r13.w, r8.w
  ult r15.z, r13.w, cb2[0].y
  ...
  if_nz r15.y
    ...
    if_nz r2.w
      ...
      store_structured u2.xyzw, cb2[52].x, r15.y, r17.xyzw
    endif 
    iadd r25.w, r24.w, l(1)
    add r15.yzw, r11.xxyz, -cb10[r13.w + 0].xxyz
    and r17.y, l(0x0000ffff), cb10[r13.w + 7].z
    ubfe r17.z, l(6), l(25), cb10[r13.w + 7].z
    ...
    mul r18.x, r17.w, r18.w
    and r17.w, l(1), cb10[r13.w + 6].x
    movc r18.xw, r17.wwww, r18.xxxy, r18.zzzx
    mov r17.w, cb10[r13.w + 6].x
    mov r26.xy, r18.xwxx
    mov r19.w, l(1)
    loop 
      ige r21.w, r19.w, r17.z
      breakc_nz r21.w
      iadd r21.w, r17.y, r19.w
      imul null, r21.w, r21.w, l(6)
      dp3 r22.w, cb11[r21.w + 0].xyzx, r15.yzwy
      add_sat r22.w, r22.w, cb11[r21.w + 0].w
      mul r22.w, r22.w, r26.x
      dp3 r26.z, cb11[r21.w + 1].xyzx, r15.yzwy
      add_sat r26.z, r26.z, cb11[r21.w + 1].w
      mul r22.w, r22.w, r26.z
      dp3 r26.z, cb11[r21.w + 2].xyzx, r15.yzwy
      add_sat r26.z, r26.z, cb11[r21.w + 2].w
      mul r22.w, r22.w, r26.z
      dp3 r26.z, cb11[r21.w + 3].xyzx, r15.yzwy
      add_sat r26.z, r26.z, cb11[r21.w + 3].w
      mul r22.w, r22.w, r26.z
      dp3 r26.z, cb11[r21.w + 4].xyzx, r15.yzwy
      add_sat r26.z, r26.z, cb11[r21.w + 4].w
      mul r22.w, r22.w, r26.z
      dp3 r26.z, cb11[r21.w + 5].xyzx, r15.yzwy
      add_sat r21.w, r26.z, cb11[r21.w + 5].w
      mul r26.x, r21.w, r22.w
      ushr r26.z, r17.w, l(2)
      ubfe r26.w, l(1), l(2), r17.w
      and r27.x, r26.z, l(2)
    ...
    endloop 
    mov_sat r26.y, r26.y
    mul r17.y, r26.y, cb10[r13.w + 6].y
    lt r17.z, l(0.000000), r17.y
    if_nz r17.z
      and r17.z, r25.w, l(7)
      iadd r17.w, r17.z, l(-1)
      ult r17.w, r17.w, l(32)
      and r17.w, r2.w, r17.w
      if_nz r17.w
        imad r17.zw, r17.zzzz, l(0, 0, 20, 20), l(0, 0, 860, 876)
        ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r18.x, cb2[52].x, r17.z, u2.xxxx
        or r18.x, r18.x, l(32)
        store_structured u2.x, cb2[52].x, r17.z, r18.x
        store_structured u2.x, cb2[52].x, r17.w, r17.y
      endif 
      iadd r24.w, r24.w, l(257)
      mad r24.z, r26.y, cb10[r13.w + 6].y, r24.z
      mul r17.y, r17.y, cb10[r13.w + 7].y
      ...
      mad r26.xzw, r16.xxyz, r17.zzzz, r27.xxyz
      dp3 r17.w, r26.xzwx, r26.xzwx
      sqrt r17.w, r17.w
      div r17.z, r17.z, r17.w
      add r17.z, r17.z, r17.z
      sqrt r17.z, r17.z
      mad r17.z, r4.z, l(5.000000), r17.z
      ...
      utof r28.w, r17.w
      sample_l_indexable(texturecubearray)(float,float,float,float) r26.xzw, r28.xyzw, t8.xwyz, s2, r17.z
      ...
      mul r30.xyz, r17.yyyy, r30.xyzx
      movc r21.z, r27.y, l(0), l(0.500000)
      add r27.xyw, r15.yzyw, r21.xyxz
      ...
      mul r15.y, r7.w, r13.w
      mul r17.yzw, r17.yyyy, r26.xxzw
      dp3 r15.z, r17.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r13.w, r7.w, r13.w, r15.z
      div r13.w, r15.y, r13.w
      mov r27.x, r23.w
      mov r27.yz, r24.xxyx
      mad r15.yzw, r17.yyzw, r13.wwww, r27.xxyz
      mov r23.w, r15.y
      mov r24.xy, r15.zwzz
    else 
...
loop 
  ...
  if_nz r18.w
    ...
    and r18.w, l(0x0000ffff), cb10[r13.w + 7].z
    ...
    and r21.w, l(1), cb10[r13.w + 6].x
    movc r26.zw, r21.wwww, r18.xxxy, r18.zzzx
    ...
    loop 
      ...
      dp3 r27.z, cb11[r22.w + 1].xyzx, r17.yzwy
      add_sat r27.z, r27.z, cb11[r22.w + 1].w
      mul r25.w, r25.w, r27.z
      dp3 r27.z, cb11[r22.w + 2].xyzx, r17.yzwy
      add_sat r27.z, r27.z, cb11[r22.w + 2].w
      mul r25.w, r25.w, r27.z
      dp3 r27.z, cb11[r22.w + 3].xyzx, r17.yzwy
      add_sat r27.z, r27.z, cb11[r22.w + 3].w
      mul r25.w, r25.w, r27.z
      dp3 r27.z, cb11[r22.w + 4].xyzx, r17.yzwy
      add_sat r27.z, r27.z, cb11[r22.w + 4].w
      mul r25.w, r25.w, r27.z
      dp3 r27.z, cb11[r22.w + 5].xyzx, r17.yzwy
      ...
      movc r20.w, r28.x, r22.w, r28.y
      movc r27.xy, r27.wwww, r27.xyxx, r20.zwzz
      iadd r21.w, r21.w, l(1)
      mov r18.x, r27.z
    endloop 
    add_sat r18.x, -r24.z, r27.y
    mul r18.w, r18.x, cb10[r13.w + 6].y
    ...
    if_nz r19.w
      ...
      mad r20.x, r18.x, cb10[r13.w + 6].y, r20.x
      mul r18.x, r18.w, cb10[r13.w + 7].y
      ...
      mad r27.xzw, r16.xxyz, r18.wwww, r28.xxyz
...
bfi r4.z, l(8), l(0), r20.y, r24.w
movc r0.y, r0.y, r4.z, r20.y
max r4.z, r20.x, l(1.000000)
rcp r4.z, r4.z
mov_sat r20.x, r20.x
mul r17.xyz, r4.zzzz, r15.yzwy
mul r18.xyz, r4.zzzz, r25.xyzx
...
if_nz r6.w
  ...
  mad r17.xyz, r15.yzwy, r4.zzzz, r19.xyzx
  mov r16.w, l(0)
  ...
  mad r18.xyz, r15.yzwy, r4.zzzz, r18.xyzx
endif 
...
ret 
// Approximately 2106 instruction slots used
