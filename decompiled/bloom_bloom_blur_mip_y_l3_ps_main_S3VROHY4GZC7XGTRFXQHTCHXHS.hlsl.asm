...
//   float4 postFxBloom06;              // Offset: 1376 Size:    16
//   float4 postFxBloom07;              // Offset: 1392 Size:    16
...
dcl_constantbuffer CB8[88], immediateIndexed
...
mul r0.w, r0.w, l(0.09090909)
mul r0.xyz, r0.xyzx, cb8[86].xyzx
mul r1.xyz, r0.wwww, cb8[87].xyzx
mad r0.xyz, r0.xyzx, l(0.09090909, 0.09090909, 0.09090909, 0.000000), r1.xyzx
