...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:26:58 2021
//
//
// Buffer Definitions: 
//
...
sample_indexable(texture2d)(float,float,float,float) r3.x, v1.yzyy, t10.xyzw, s2
...
sample_indexable(texture2d)(float,float,float,float) r4.xyz, v1.yzyy, t9.xyzw, s3
...
if_nz r3.y
  ftoi r3.y, cb1[64].w
  lod r3.z, v1.yzyy, t6.y, s1
  lod r3.w, v1.yzyy, t6.x, s1
  lt r3.z, r3.z, r3.w
  ...
  movc r1.xyz, r3.zzzz, r7.xywx, r8.xyzx
endif 
...
add r1.w, -r0.z, r3.x
mad r0.z, cb1[62].w, r1.w, r0.z
add r1.w, -r2.w, cb1[63].x
mad o2.z, cb1[63].w, r1.w, r2.w
movc r3.xyz, v8.xxxx, v3.xyzx, -v3.xyzx
