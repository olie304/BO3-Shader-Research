  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r4.xyz = float3(0.146835998,0.437839001,0.952030003) * r2.xyz;
  r1.y = cmp(0 < r1.x);
  r5.xy = float2(-0.261132985,0.261135012) * r0.ww;
  r5.z = 0;
  ...
  r7.xyzw = r3.zwzw * float4(-0.0959469005,-0.0959469005,-0.0421367995,-0.0421367995) + v1.xyxy;
  ...
  if (r1.y != 0) {
    ...
    r1.y = exp2(r1.y);
    r12.xyz = float3(0.106012002,0.0256836005,7.17777021e-13) * r1.yyy;
    r12.xyz = r12.xyz * r6.xyz + r4.xyz;
    r13.xyz = r1.yyy * float3(0.106012002,0.0256836005,7.17777021e-13) + float3(0.146835998,0.437839001,0.952030003);
    ...
    r1.y = sssParams.w * r1.y;
    r1.y = exp2(r1.y);
    r14.xyz = float3(0.171772003,0.0639377013,0.00064857601) * r1.yyy;
    r12.xyz = r14.xyz * r8.xyz + r12.xyz;
    r13.xyz = r1.yyy * float3(0.171772003,0.0639377013,0.00064857601) + r13.xyz;
    ...
    r1.y = sssParams.w * r1.y;
    r1.y = exp2(r1.y);
    r14.xyz = float3(0.148799002,0.191460997,0.0233364999) * r1.yyy;
    r12.xyz = r14.xyz * r9.xyz + r12.xyz;
    r13.xyz = r1.yyy * float3(0.148799002,0.191460997,0.0233364999) + r13.xyz;
    ...
    r1.y = sssParams.w * r1.y;
    r1.y = exp2(r1.y);
    r14.xyz = float3(0.148799002,0.191459,0.0233362) * r1.yyy;
    r12.xyz = r14.xyz * r7.xyz + r12.xyz;
    r13.xyz = r1.yyy * float3(0.148799002,0.191459,0.0233362) + r13.xyz;
    ...
    r1.y = sssParams.w * r1.y;
    r1.y = exp2(r1.y);
    r14.xyz = float3(0.171773002,0.0639377013,0.000648564019) * r1.yyy;
    r12.xyz = r14.xyz * r10.xyz + r12.xyz;
    r13.xyz = r1.yyy * float3(0.171773002,0.0639377013,0.000648564019) + r13.xyz;
    ...
    r1.x = exp2(r1.x);
    r5.yzw = float3(0.106009997,0.0256832,7.17540014e-13) * r1.xxx;
    r5.yzw = r5.yzw * r11.xyz + r12.xyz;
    r1.xyz = r1.xxx * float3(0.106009997,0.0256832,7.17540014e-13) + r13.xyz;
  } else {
    ...
    r0.w = exp2(r0.w);
    r12.xyz = float3(0.106012002,0.0256836005,7.17777021e-13) * r0.www;
    r4.xyz = r12.xyz * r6.xyz + r4.xyz;
    r6.xyz = r0.www * float3(0.106012002,0.0256836005,7.17777021e-13) + float3(0.146835998,0.437839001,0.952030003);
    ...
    r0.w = sssParams.w * r0.w;
    r0.w = exp2(r0.w);
    r12.xyz = float3(0.171772003,0.0639377013,0.00064857601) * r0.www;
    r4.xyz = r12.xyz * r8.xyz + r4.xyz;
    r6.xyz = r0.www * float3(0.171772003,0.0639377013,0.00064857601) + r6.xyz;
    ...
    r0.w = sssParams.w * r0.w;
    r0.w = exp2(r0.w);
    r8.xyz = float3(0.148799002,0.191460997,0.0233364999) * r0.www;
    r4.xyz = r8.xyz * r9.xyz + r4.xyz;
    r6.xyz = r0.www * float3(0.148799002,0.191460997,0.0233364999) + r6.xyz;
    ...
    r0.w = sssParams.w * r0.w;
    r0.w = exp2(r0.w);
    r8.xyz = float3(0.148799002,0.191459,0.0233362) * r0.www;
    r4.xyz = r8.xyz * r7.xyz + r4.xyz;
    r6.xyz = r0.www * float3(0.148799002,0.191459,0.0233362) + r6.xyz;
    ...
    r0.w = sssParams.w * r0.w;
    r0.w = exp2(r0.w);
    r3.xyz = float3(0.171773002,0.0639377013,0.000648564019) * r0.www;
    r3.xyz = r3.xyz * r10.xyz + r4.xyz;
    r4.xyz = r0.www * float3(0.171773002,0.0639377013,0.000648564019) + r6.xyz;
    ...
    r0.w = sssParams.w * r0.w;
    r0.w = exp2(r0.w);
    r6.xyz = float3(0.106009997,0.0256832,7.17540014e-13) * r0.www;
    r5.yzw = r6.xyz * r11.xyz + r3.xyz;
    r1.xyz = r0.www * float3(0.106009997,0.0256832,7.17540014e-13) + r4.xyz;
  }
