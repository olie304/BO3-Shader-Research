...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  if (r2.z != 0) {
    ...
    r4.w = colorMap.CalculateLevelOfDetailUnclamped(colorSampler_s, v2.xy);
    r5.w = colorMap.CalculateLevelOfDetail(colorSampler_s, v2.xy);
    r4.w = cmp(r4.w < r5.w);
    r5.w = cmp(0 < r5.w);
  ...
  r8.y = r1.x * r1.z + r5.w;
  r6.xyz = r6.xyz * r1.zzz + r16.xyz;
  r1.xw = gameTime.ww * wobbleScroll.xy;
  r1.xw = v2.xy * wobbleScale.xy + r1.xw;
  r1.xw = wobbleMap.Sample(normalSampler_s, r1.xw).xy;
  r1.xw = r1.xw * float2(1.9921875,1.9921875) + float2(-1,-1);
  r1.xw = renderTargetSize.zw * r1.xw;
  ...
  r7.zw = r1.xw * layer1Wobble + r9.xy;
  ...
  if (r4.w != 0) {
    ...
    r7.zw = r7.zw * scaleUVs2.xy + r15.xy;
    ...
    r7.zw = float2(0.5,0.5) + r7.zw;
    r8.zw = saturate(r7.zw);
    r12.x = clampU2 ? r8.z : r7.z;
    r12.y = clampV2 ? r8.w : r7.w;
  }
  r7.zw = r1.xw * layer2Wobble + r12.xy;
  r12.xyzw = emissiveMap2.Sample(colorSampler_s, r7.zw).xyzw;
  ...
  if (r4.w != 0) {
    ...
    r5.y = r5.x;
    r5.z = r4.x;
    r13.x = dot(r5.yz, r3.yz);
    r5.x = -r4.x;
    r13.y = dot(r5.xy, r3.yz);
    r3.yz = gameTime.ww * scrollUVs3.xy;
    r3.yz = r3.yz * scaleUVs3.xy + r13.xy;
    ...
    r12.x = clampU3 ? r4.x : r3.y;
    r12.y = clampV3 ? r4.y : r3.z;
  }
  r1.xw = r1.xw * layer3Wobble + r12.xy;
  r4.xyzw = emissiveMap3.Sample(colorSampler_s, r1.xw).xyzw;
  ...
  r1.x = r1.x * r1.w + flickerRange3.x;
  r3.xyz = r3.yzw * r1.xxx;
  r1.x = 1 + -r4.w;
  ...
  if (r7.w != 0) {
    ...
    if (r7.w != 0) {
      ...
      r1.x = dot(r12.yzw, r4.xyz);
      r8.z = dot(r2.xyz, r12.yzw);
      ...
      r16.w = r10.z;
      r14.w = r15.z;
      r14.xyzw = r6.wwww ? r16.xyzw : r14.xyzw;
      r10.zw = r8.yz;
      r15.zw = r5.yz;
      r10.xyzw = r6.wwww ? r10.xyzw : r15.xyzw;
      r5.w = r6.w ? r8.w : r5.w;
      r15.z = r14.w;
      r15.xy = r10.xy;
      r5.yz = r10.zw;
