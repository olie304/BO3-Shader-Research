...
gather4_aoffimmi_indexable(0,2,0)(texture2d)(float,float,float,float) r2.xyzw, r0.xyxx, t0.xyzw, s0.x
gather4_aoffimmi_indexable(2,0,0)(texture2d)(float,float,float,float) r3.xyzw, r0.xyxx, t0.xyzw, s0.x
gather4_aoffimmi_indexable(2,2,0)(texture2d)(float,float,float,float) r0.xyzw, r0.xyxx, t0.xyzw, s0.x
and r4.xy, vThreadID.xyxx, l(1, 1, 0, 0)
ieq r4.x, r4.y, r4.x
min r4.y, r1.z, r1.y
min r4.z, r2.y, r2.x
min r4.yz, r1.xxwx, r4.yyzy
min r4.w, r2.w, r3.x
min r4.w, r2.z, r4.w
min r5.x, r3.w, r3.z
min r5.x, r3.y, r5.x
