// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:34:31 2021
...
cbuffer _Globals : register(b0)
{
  ...
  uint zFeatherComputeSprites : packoffset(c19);
  float hdrScale : packoffset(c19.y);
  float emissiveFalloffPower : packoffset(c19.z);
...
Texture2D<float4> normalBodyMap : register(t37);
Texture2D<float4> emissiveMap : register(t38);
...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r2.z = samp0[]..swiz;
    ...
    r0.w = saturate(dot(r3.xyz, r0.yzw));
    r3.xy = v2.xy;
    r3.z = 1;
...
r1.w = samp0[]..swiz;
  ...
  r2.w = aoMap.Sample(aoSampler_s, r1.xy).x;
  r3.w = glossMap.Sample(specColorSampler_s, r1.xy).x;
  r4.x = glossRange.y + -glossRange.x;
  r3.w = r3.w * r4.x + glossRange.x;
  r3.w = saturate(0.0588235296 * r3.w);
  r4.yzw = normalMap.Sample(normalSampler_s, r1.xy).xyz;
  r4.yzw = float3(-0.5,-0.5,-0) + r4.yzw;
  r4.yzw = baseNormalHeight * r4.yzw + float3(0.5,0.5,0);
  r5.xy = r4.yz * float2(1.9921875,1.9921875) + float2(-1,-1);
  r4.y = r4.w * r4.w;
  ...
  r1.z = samp0[]..swiz;
    r6.xyz = normalBodyMap.Sample(normalSampler_s, v2.xy).xyz;
    ...
    r1.w = min(1, r1.w);
    r7.xy = r5.xy * r1.zz + r4.zw;
    r4.z = dot(r7.xyz, r7.xyz);
    r4.z = rsqrt(r4.z);
    r5.xyz = r7.xyz * r4.zzz;
    r4.y = r4.y * r1.z + r1.w;
  } else {
  ...
  r3.w = debugGlossOverride.x * r4.x + glossRange.x;
  r3.w = saturate(0.0588235296 * r3.w);
  r3.w = -17 * r3.w;
  r3.w = exp2(r3.w);
  r3.w = r4.y + r3.w;
  r3.w = log2(r3.w);
  r3.w = saturate(-0.0588235296 * r3.w);
  r4.x = cmp(0 < debugStreamerControl.w);
  if (r4.x != 0) {
    r4.x = (int)debugStreamerControl.w;
    r4.y = colorMap.CalculateLevelOfDetailUnclamped(colorSampler_s, r1.xy);
    r4.z = colorMap.CalculateLevelOfDetail(colorSampler_s, r1.xy);
    r4.y = cmp(r4.y < r4.z);
    r4.z = cmp(0 < r4.z);
    r7.xyz = (int3)r4.xxx & int3(1,2,4);
    r8.xyz = r7.xxx ? float3(1,0,1) : r2.xyz;
    r7.xyw = r7.yyy ? float3(0,1,1) : r2.xyz;
    r4.xzw = r4.zzz ? r8.xyz : r7.xyw;
    r7.xyz = r7.zzz ? float3(0,1,0) : r2.xyz;
    r2.xyz = r4.yyy ? r4.xzw : r7.xyz;
  }
  r4.xyz = debugColorOverride.xyz + -r2.xyz;
  r2.xyz = debugColorOverride.www * r4.xyz + r2.xyz;
  r4.xyz = debugSpecularOverride.xyz + -r3.xyz;
  r3.xyz = debugSpecularOverride.www * r4.xyz + r3.xyz;
  r3.w = r3.w + -r1.w;
  r1.w = debugGlossOverride.w * r3.w + r1.w;
  r3.w = debugOcclusionOverride.x + -r2.w;
  r2.w = debugOcclusionOverride.w * r3.w + r2.w;
  r4.xyz = v8.xxx ? v4.xyz : -v4.xyz;
  ...
  r3.w = min(15, r3.w);
  r3.w = (uint)r3.w;
  r10.xy = (uint2)r5.yx >> int2(6,6);
  r10.z = (uint)r3.w << 4;
  r3.w = numStaticDecals & -32;
  r5.z = (int)-r3.w + numStaticDecals;
  r11.xy = float2(0,0);
  r12.w = 0;
  r9.w = 1;
  ...
  while (true) {
    ...
    r10.w = cmp((int)r3.w == (int)r7.w);
    if (r5.z == 0) r11.z = 0; else if (r5.z+0 < 32) {     r11.z = (uint)r8.w << (32-(r5.z + 0)); r11.z = (uint)r11.z >> (32-r5.z);    } else r11.z = (uint)r8.w >> 0;
  ...
  r5.w = saturate(r5.w);
  r1.z = 1 + -r5.w;
  r2.xyz = r2.xyz * r1.zzz + r13.xyz;
  r4.xyz = r4.xyz * r1.zzz + r14.xyz;
  r3.w = dot(r4.xyz, r4.xyz);
  r3.w = rsqrt(r3.w);
  ...
  if (r1.w != 0) {
    ...
    r12.y = r12.x;
    r12.z = r11.x;
    r13.x = dot(r12.yz, r1.xy);
    r12.x = -r11.x;
    r13.y = dot(r12.xy, r1.xy);
    r1.xy = gameTime.ww * scrollUVs.xy;
    r1.xy = r1.xy * scaleUVs.xy + r13.xy;
  ...
  r1.x = rsqrt(r1.x);
  r11.xyz = -v7.xyz * r1.xxx;
  r1.y = saturate(dot(r11.xyz, r6.xyz));
  r6.xyzw = emissiveMap.Sample(colorSampler_s, r8.xy).xyzw;
  r6.xyz = emissiveTint1.xyz * r6.xyz;
  r1.w = log2(r1.y);
  r1.w = emissiveFalloffPower * r1.w;
  r1.w = exp2(r1.w);
  r1.y = 1 + -r1.y;
  r1.y = log2(r1.y);
  r1.y = emissiveFalloffPower * r1.y;
  r1.y = exp2(r1.y);
  r1.y = invertFalloff ? r1.y : r1.w;
  ...
  r3.w = frac(r3.w);
  r6.y = gameTime.w * flickerSpeed + r3.w;
  r6.x = flickerSeed.x;
  r3.w = flickerLookupMap.SampleLevel(lookupSampler_s, r6.xy, 0).x;
  r3.w = log2(abs(r3.w));
  r3.w = flickerPower * r3.w;
  r3.w = exp2(r3.w);
  r5.z = flickerRange.y + -flickerRange.x;
  r3.w = r3.w * r5.z + flickerRange.x;
  ...
  r7.x = saturate(dot(r4.xyz, r11.xyz));
  r5.y = dot(-r11.xyz, r4.xyz);
  r5.y = r5.y + r5.y;
  r13.xyz = r4.xyz * -r5.yyy + -r11.xyz;
  r5.y = 17 * r7.y;
  r5.y = exp2(r5.y);
  r5.y = 2 + r5.y;
  r5.y = 2 / r5.y;
  ...
  r41.w = samp0[]..swiz;
    ...
    r30.xyz = r13.xyz * r16.xxx + r30.xyz;
    ...
    r31.w = (uint)r20.w;
    r24.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r31.xyzw, r16.x).xyz;
    ...
    r24.xyz = r16.xxx ? float3(1,1,0) : r24.xyz;
  ...
  if (r7.w == 0) {
    ...
    r8.w = (int)r7.w & -32;
    r10.w = (int)r7.w + (int)-r8.w;
    r11.w = numRefProbes & -32;
    r12.y = (int)-r11.w + numRefProbes;
    r14.xy = float2(0,0);
    r15.w = 0;
    r16.yz = float2(0,1);
    r17.xy = float2(0,0);
    ...
    while (true) {
      ...
      r14.z = cmp((int)r8.w == (int)r12.z);
      bitmask.w = ((~(-1 << r10.w)) << 0) & 0xffffffff;  r14.w = (((uint)0 << 0) & bitmask.w) | ((uint)r12.w & ~bitmask.w);
      r12.w = r14.z ? r14.w : r12.w;
      r14.z = cmp((int)r11.w == (int)r12.z);
      if (r12.y == 0) r14.w = 0; else if (r12.y+0 < 32) {       r14.w = (uint)r12.w << (32-(r12.y + 0)); r14.w = (uint)r14.w >> (32-r12.y);      } else r14.w = (uint)r12.w >> 0;
      r12.w = r14.z ? r14.w : r12.w;
      r14.z = (int)r12.z + numLights;
      r25.xyzw = r23.xyzw;
      r26.xyz = r24.yzw;
      r14.w = r12.w;
      while (true) {
        if (r14.w == 0) break;
        r15.x = firstbitlow((uint)r14.w);
        r15.y = 1 << (int)r15.x;
        r15.z = (int)r14.w & (int)r15.y;
        if (r15.z != 0) {
          r14.w = (int)r14.w ^ (int)r15.y;
        ...
        r28.y = samp0[]..swiz;
          ...
          r35.w = samp0[]..swiz;
            ...
            r41.x = samp0[]..swiz;
            r41.y = samp0[]..swiz;
              r26.z = r30.y * r15.z + r26.z;
              r15.x = r15.y * r28.z;
              r28.z = r36.z;
              r15.y = dot(r13.xyz, r28.xyz);
              r15.z = dot(r29.xyz, r28.xyz);
              r15.z = r15.z + -r36.w;
              r16.x = cmp(r15.z >= 0);
              ...
              r18.yzw = r13.xyz * r15.yyy + r18.yzw;
              r15.z = dot(r18.yzw, r18.yzw);
              r15.z = sqrt(r15.z);
              r15.y = r15.y / r15.z;
              r15.y = r15.y + r15.y;
              r15.y = sqrt(r15.y);
              ...
              r36.w = (uint)r15.z;
              r18.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r36.xyzw, r15.y).xyz;
              r30.xzw = (int3)r18.yzw & int3(-2147483648,-2147483648,-2147483648);
              r30.xzw = cmp((int3)r30.xzw == int3(2139095040,2139095040,2139095040));
              r15.y = (int)r30.z | (int)r30.x;
              r15.y = (int)r30.w | (int)r15.y;
              r18.yzw = r15.yyy ? float3(1,1,0) : r18.yzw;
              ...
              r15.y = (int)r29.y | (int)r29.x;
              r15.y = (int)r29.z | (int)r15.y;
              r28.xyz = r15.yyy ? float3(1,1,0) : r28.xyz;
              r29.xyz = r28.xyz * r27.xyz;
              r15.y = dot(r29.xyz, float3(0.212599993,0.715200007,0.0722000003));
              r25.xyz = r27.xyz * r28.xyz + r25.xyz;
              r15.z = r15.y * r7.z;
              r18.yzw = r18.yzw * r15.xxx;
              r15.x = dot(r18.yzw, float3(0.212599993,0.715200007,0.0722000003));
              r15.x = r7.z * r15.y + r15.x;
              r15.x = r15.z / r15.x;
              r27.x = r25.w;
              r27.yz = r26.xy;
              r26.xyw = r18.zwy * r15.xxx + r27.yzx;
              r25.w = r26.w;
            }
          }
        }
    ...
    if (r11.w != 0) {
      ...
      r14.w = 0;
      while (true) {
        r16.w = cmp((uint)r14.w >= (uint)r7.w);
        if (r16.w != 0) break;
        r14.z = (uint)r14.w >> 5;
        r15.xyz = (int3)r10.xyz + (int3)r14.xyz;
        r14.z = visibleProbes.Load(r15.xyzw).x;
        r15.x = cmp((int)r8.w == (int)r14.w);
        if (r10.w == 0) r15.y = 0; else if (r10.w+0 < 32) {         r15.y = (uint)r14.z << (32-(r10.w + 0)); r15.y = (uint)r15.y >> (32-r10.w);        } else r15.y = (uint)r14.z >> 0;
        ...
        while (true) {
          if (r15.z == 0) break;
          r16.w = firstbitlow((uint)r15.z);
          r17.w = 1 << (int)r16.w;
          r18.z = (int)r15.z & (int)r17.w;
          if (r18.z != 0) {
            r15.z = (int)r15.z ^ (int)r17.w;
            r17.w = (int)r15.x + (int)r16.w;
          // Known bad code for instruction (needs manual fix):
          ...
          r29.y = samp0[]..swiz;
            ...
            r36.w = samp0[]..swiz;
              ...
              r38.w = samp0[]..swiz;
                ...
                r22.w = -r22.w * r27.w + 1;
                r22.w = r32.y * r22.w;
                r18.y = r31.z ? r22.w : r31.w;
                r32.xy = r30.ww ? r32.xy : r18.xy;
                r20.w = (int)r20.w + 1;
                r16.x = r28.w;
              }
              r16.x = saturate(r32.y + -r15.y);
              r17.w = r16.x * r18.w;
              r18.y = cmp(0 < r17.w);
              if (r18.y != 0) {
              // Known bad code for instruction (needs manual fix):
              ...
              r42.y = samp0[]..swiz;
                ...
                r37.w = (uint)r17.w;
                r18.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r37.xyzw, r16.w).xyz;
                r31.xyz = (int3)r18.yzw & int3(-2147483648,-2147483648,-2147483648);
                r31.xyz = cmp((int3)r31.xyz == int3(2139095040,2139095040,2139095040));
                r16.w = (int)r31.y | (int)r31.x;
                r16.w = (int)r31.z | (int)r16.w;
    ...
    r21.xyz = r23.xyz * r5.www;
    r22.xyz = r24.xyz * r5.www;
    ...
    if (r6.w != 0) {
      ...
      r21.xyz = r23.xyz * r5.www + r12.yzw;
      r13.w = 0;
      r12.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r13.xyzw, r6.z).xyz;
      r5.w = sunConstants.globalProbeExposure * r6.w + -r4.w;
      r4.w = r7.y * r5.w + r4.w;
      r22.xyz = r12.yzw * r4.www + r22.xyz;
    }
  } else {
    r22.x = r21.w;
  }
  ...
  r14.xyz = r21.xyz * r2.www;
  r6.zw = r7.xy * float2(0.984375,0.984375) + float2(0.0078125,0.0078125);
  r6.zw = gEnvBRDFGeneric.SampleLevel(samplerLinear_s, r6.zw, 0).xy;
  r7.yzw = r22.xyz * r4.www;
  r15.xyz = r7.zwy * r6.zzz;
  r7.yzw = r7.yzw * r6.www;
  r2.w = sqrt(r5.z);
  r2.w = r2.w * 0.5 + 0.5;
  r2.w = r2.w * r2.w;
  r4.w = 0.5 * r2.w;
  ...
  r2.w = r5.w * r2.w;
  r4.w = r5.w * r4.w;
  r5.w = dot(r4.xyz, sunConstants.wldDir.xyz);
  r6.z = saturate(r5.w);
  r6.w = cmp(0 >= r6.z);
  if (r6.w != 0) {
    r8.w = 0;
  ...
  if (r6.w == 0) {
    ...
    r6.w = -sunConstants.splitDepthOffset + r12.w;
    r6.w = -r6.w * 6.10351563e-05 + 1;
    r10.w = saturate(r6.w);
    r10.w = cmp(r6.w == r10.w);
    if (r10.w != 0) {
      r10.w = 0;
      r11.w = 0;
      while (true) {
        ...
        if (r13.w != 0) break;
        r13.w = (uint)r10.w;
        r16.xy = -sunConstants.splitPinTransform[r13.w].xy + r12.yz;
        r16.x = max(abs(r16.x), abs(r16.y));
        r11.w = sunConstants.splitPinTransform[r13.w].z * r16.x;
        r13.w = cmp(r11.w < 1);
        if (r13.w != 0) {
          break;
        }
    ...
    if (r13.w == 0) {
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          if (r17.z != 0) break;
          r17.z = cmp((uint)r11.w < (uint)r16.w);
          r18.xy = r17.zz ? r12.yz : r17.xy;
          r17.w = r17.z ? sunConstants.splitPinTransform[r10.w].w : sunConstants.splitPinTransform[r12.w].w;
          r17.z = r17.z ? r10.w : r12.w;
          ...
          r18.z = (uint)r17.z;
          r17.z = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r18.xyz, r6.w).x;
          r17.w = gTransShadowmapArray.SampleLevel(samp0_s, r18.xyz, 0).x;
          r17.z = r17.z + r17.w;
          r17.z = saturate(-1 + r17.z);
          r13.w = r17.z * 0.125 + r13.w;
          r16.w = (int)r16.w + 1;
        }
        r6.w = r13.w * r13.w;
        r8.w = r6.w * r13.w;
  ...
  if (r6.w != 0) {
    ...
    if (r6.w != 0) {
      ...
      if (sunConstants.sunCookieIndex != 0) {
        r9.w = 1;
        r10.w = dot(sunConstants.sunCookieTransform[0].xyzw, r9.xyzw);
        r9.x = dot(sunConstants.sunCookieTransform[1].xyzw, r9.xyzw);
        r16.x = frac(r10.w);
        r16.y = frac(r9.x);
        r9.x = -1 + (int14)sunConstants.sunCookieIndex;
        r16.z = (uint)r9.x;
        r9.xyz = gCookieArray.SampleLevel(samplerLinear_s, r16.xyz, 0).xyz;
      ...
      r19.z = samp0[]..swiz;
      r19.w = samp0[]..swiz;
        r11.w = abs(r5.w) * -0.200000003 + 0.400000006;
        r20.xyz = r4.xyz * r11.www + v7.xyz;
        r20.w = 1;
        ...
        r17.y = samp0[]..swiz;
          ...
          if (enableDitheredShadow != 0) {
            ...
            while (true) {
              ...
              if (r12.w != 0) break;
              r19.x = dot(icb[r12.z+0].yx, r17.xy);
              r19.y = dot(icb[r12.z+0].yx, r17.yz);
              r18.xy = r19.xy * r10.ww + r16.xy;
              r12.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r18.xyz, r9.w).x;
              r12.y = r12.w * 0.125 + r12.y;
              r12.z = (int)r12.z + 1;
            }
          } else {
            r16.z = (uint)r11.w;
            r12.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r9.w).x;
          }
          r9.w = r12.y * r12.y;
          r9.w = r9.w * r12.y;
        } else {
      ...
      r6.z = r8.w * r6.z;
      r6.z = 0.25 * r6.z;
      r12.yzw = r6.zzz * r9.xyz + r7.yzw;
      r1.x = saturate(1 + -r1.x);
      r6.w = r1.x * r1.x;
      r6.w = r6.w * r6.w;
      r1.x = r6.w * r1.x;
      r1.x = r6.z * r1.x;
      r9.xyz = r1.xxx * r9.yzx + r15.xyz;
      r16.w = r9.z;
      r14.w = r15.z;
      r14.xyzw = r5.wwww ? r16.xyzw : r14.xyzw;
      r9.zw = r12.yz;
      r15.zw = r7.yz;
      r9.xyzw = r5.wwww ? r9.xyzw : r15.xyzw;
      r7.w = r5.w ? r12.w : r7.w;
      r15.z = r14.w;
      r15.xy = r9.xy;
      r7.yz = r9.zw;
    }
  ...
  r6.w = 0;
  while (true) {
    r7.x = cmp((uint)r6.w >= numLights);
    if (r7.x != 0) break;
    r16.z = (uint)r6.w >> 5;
    r17.xyz = (int3)r10.xyz + (int3)r16.xyz;
    r7.x = visibleLights.Load(r17.xyzw).x;
    r17.xyz = r12.yzw;
    r30.xyz = r28.xyz;
    r31.xyz = r29.xyz;
    r8.w = r6.z;
    ...
    while (true) {
      ...
      r33.y = samp0[]..swiz;
        ...
        r38.z = samp0[]..swiz;
        r38.w = samp0[]..swiz;
          if (3 == 0) r13.w = 0; else if (3+24 < 32) {           r13.w = (uint)r33.w << (32-(3 + 24)); r13.w = (uint)r13.w >> (32-3);          } else r13.w = (uint)r33.w >> 24;
          switch (r13.w) {
            case 4 :            r13.w = cmp(0 < r38.x);
            r39.xy = r37.zw;
            r39.z = r38.w;
            r40.xyz = -r39.xyz * float3(0.5,0.5,0.5) + r32.yzw;
            r41.xyz = -v7.xyz + r40.xyz;
            r14.w = dot(r39.xyz, r41.xyz);
            r15.w = saturate(-r14.w / r38.x);
            r42.xyz = r15.www * r39.xyz + r40.xyz;
            r42.xyz = r13.www ? r42.xyz : r32.yzw;
            r42.xyz = -v7.xyz + r42.xyz;
            r16.z = dot(r42.xyz, r42.xyz);
            r16.w = rsqrt(r16.z);
            r42.xyz = r42.xyz * r16.www;
            r16.w = dot(r4.xyz, r42.xyz);
              ...
              if (r25.w != 0) {
                ...
                if (r25.w != 0) {
                  ...
                  while (true) {
                    ...
                    if (r29.w != 0) break;
                    r44.y = dot(icb[r28.w+0].yx, r9.xy);
                    r44.z = dot(icb[r28.w+0].yx, r9.yz);
                ...
                if (r25.w != 0) {
                  ...
                  r14.w = r26.w * r28.w + -r14.w;
                  r14.w = saturate(r14.w / r29.w);
                  r26.w = r29.w / r38.x;
                  r26.w = 10 * r26.w;
                  r26.w = min(1, r26.w);
                  r14.w = r14.w + -r15.w;
                  r14.w = r26.w * r14.w + r15.w;
                  r39.xyz = r14.www * r39.xyz + r40.xyz;
                  r39.xyz = r13.www ? r39.xyz : r32.yzw;
                  r39.xyz = -v7.xyz + r39.xyz;
                  r13.w = dot(r39.xyz, r39.xyz);
                  r13.w = rsqrt(r13.w);
                  r40.xyz = r39.xyz * r13.www;
                      ...
                      r14.w = samp0[]..swiz;
                        ...
                        if (r8.w != 0) {
                          ...
                          while (true) {
                            ...
                            if (r28.w != 0) break;
                            r42.x = dot(icb[r26.w+0].xy, r8.xy);
                            r42.y = dot(icb[r26.w+0].yx, r8.xz);
                            r20.xy = r42.xy * r15.ww + r41.xy;
                  ...
                  r14.w = r14.w + -r21.w;
                  r14.w = r5.z * r14.w + r21.w;
                  r14.w = r14.w * r16.z;
                  r33.x = r32.x;
                  r15.w = cmp(0 < r16.w);
                  r20.xyz = r14.www * r33.xyz + r17.xyz;
                  r14.w = saturate(dot(r4.xyz, r40.xyz));
                  r39.xyz = r39.xyz * r13.www + r11.xyz;
                  r13.w = dot(r39.xyz, r39.xyz);
                  r13.w = rsqrt(r13.w);
                  r39.xyz = r39.xyz * r13.www;
                  r13.w = dot(r39.xyz, r11.xyz);
                  r16.w = dot(r4.xyz, r39.xyz);
                  r19.x = abs(r16.w) * r5.y + -abs(r16.w);
                  r16.w = abs(r16.w) * r19.x + 1;
                  r19.x = r14.w * r2.w + r4.w;
                  r16.w = r16.w * r16.w;
                  r16.w = r16.w * r19.x;
                  r16.w = rcp(r16.w);
                  r14.w = r14.w * r25.w;
                  r14.w = r16.w * r14.w;
                  r14.w = r14.w * r16.z;
                  r39.xyz = r14.www * r33.xyz + r31.xyz;
                  r13.w = saturate(1 + -r13.w);
                  r16.z = r13.w * r13.w;
                  r16.z = r16.z * r16.z;
                  r13.w = r16.z * r13.w;
                  r13.w = r14.w * r13.w;
                  r40.xyz = r13.www * r33.xyz + r30.xyz;
                  r17.xyz = r15.www ? r20.xyz : r17.xyz;
                  r30.xyz = r15.www ? r40.xyz : r30.xyz;
                  r31.xyz = r15.www ? r39.xyz : r31.xyz;
                }
              }
            }
            break;
            ...
            r40.w = samp0[]..swiz;
              ...
              r19.x = samp0[]..swiz;
                ...
                r21.w = r21.w / r25.w;
                r21.w = min(1, r21.w);
                r34.xy = saturate(r16.zz * r34.xz + r34.yw);
                ...
                r21.xy = r34.xy / r16.zz;
                r16.z = cmp(r43.w < 0.00048828125);
                if (r16.z != 0) {
                  r44.y = r45.x;
              ...
              if (r16.z != 0) {
                ...
                if (r16.z != 0) {
                  ...
                  r22.xyz = r4.xyz * r16.zzz + v7.xyz;
                  r39.xyz = r38.xyz;
                  r16.z = dot(r39.xyzw, r22.xyzw);
                  ...
                  r40.y = samp0[]..swiz;
                    ...
                    if (r8.w != 0) {
                      ...
                      while (true) {
                        ...
                        r26.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r32.xyz, r11.w).x;
                ...
                if (r16.z != 0) {
                  r16.z = r33.x * r5.y;
                  r16.z = r16.z * r15.w;
                  if (4 == 0) r16.w = 0; else if (4+16 < 32) {                   r16.w = (uint)r33.w << (32-(4 + 16)); r16.w = (uint)r16.w >> (32-4);                  } else r16.w = (uint)r33.w >> 16;
                  ...
                  r38.w = samp0[]..swiz;
                    ...
                    r32.y = samp0[]..swiz;
                      ...
                      if (r8.w != 0) {
                        ...
                        r33.z = (uint)r22.y;
                        r22.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r33.xyz, r16.w).x;
                      }
                      r16.w = r22.z * r22.z;
                      r16.w = r16.w * r22.z;
                    } else {
                    ...
                    if (4 == 0) r16.w = 0; else if (4+20 < 32) {                     r16.w = (uint)r33.w << (32-(4 + 20)); r16.w = (uint)r16.w >> (32-4);                    } else r16.w = (uint)r33.w >> 20;
                    r22.x = cmp(0 < (uint)r16.w);
                    r22.x = r22.x ? r1.x : 0;
                    if (r22.x != 0) {
                      r16.w = (int)r16.w + numLights;
                    ...
                    r37.w = samp0[]..swiz;
                      ...
                      r24.z = samp0[]..swiz;
                        ...
                        if (r8.w != 0) {
                          ...
                          r32.z = (uint)r22.y;
                          r24.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r32.xyz, r16.w).x;
                        }
                        r16.w = r24.x * r24.x;
                        r16.w = r16.w * r24.x;
                      } else {
                  ...
                  r16.w = r16.w + -r15.w;
                  r16.w = r5.z * r16.w + r15.w;
                  r16.w = r16.w * r11.w;
                  r14.w = cmp(0 < r14.w);
                  r23.xyz = r16.www * r21.xyw + r17.xyz;
                  r20.xyz = r20.xyz * r13.www + r11.xyz;
                  r13.w = dot(r20.xyz, r20.xyz);
                  r13.w = rsqrt(r13.w);
                  r20.xyz = r20.xyz * r13.www;
                  r13.w = dot(r20.xyz, r11.xyz);
                  r16.w = dot(r4.xyz, r20.xyz);
                  r20.x = abs(r16.w) * r5.y + -abs(r16.w);
                  r16.w = abs(r16.w) * r20.x + 1;
                  r15.w = r15.w * r2.w + r4.w;
                  r16.w = r16.w * r16.w;
                  r15.w = r16.w * r15.w;
                  r15.w = rcp(r15.w);
                  r15.w = r15.w * r16.z;
                  r11.w = r15.w * r11.w;
                  r11.w = 0.25 * r11.w;
                  r20.xyz = r11.www * r21.xyw + r31.xyz;
                  r13.w = saturate(1 + -r13.w);
                  r15.w = r13.w * r13.w;
                  r15.w = r15.w * r15.w;
                  r13.w = r15.w * r13.w;
                  r11.w = r13.w * r11.w;
                  r21.xyw = r11.www * r21.xyw + r30.xyz;
                  r17.xyz = r14.www ? r23.xyz : r17.xyz;
                  r30.xyz = r14.www ? r21.xyw : r30.xyz;
                  r31.xyz = r14.www ? r20.xyz : r31.xyz;
                }
              }
            }
            break;
  ...
  r3.xyz = r29.xyz * r3.xyz + r4.xyz;
  r2.xyz = r12.yzw * r2.xyz + r3.xyz;
  ...
  r1.xyz = relativeHDR ? r3.xyz : r1.yzw;
