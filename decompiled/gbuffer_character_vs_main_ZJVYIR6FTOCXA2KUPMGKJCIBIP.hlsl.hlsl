...
r0.w = modelInstanceBuffer[]..swiz;
  ...
  r3.xyz = viewMatrix._m10_m11_m12 * r1.www;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r4.xyz, r0.x, l(0), t5.xyzx
r4.x = modelInstanceBuffer[]..swiz;
r4.y = modelInstanceBuffer[]..swiz;
r4.z = modelInstanceBuffer[]..swiz;
...
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r5.xyz, r0.x, l(32), t5.xyzx
r5.x = modelInstanceBuffer[]..swiz;
r5.y = modelInstanceBuffer[]..swiz;
r5.z = modelInstanceBuffer[]..swiz;
  r1.w = dot(r1.xyz, r5.xyz);
  r3.xyz = r1.www * viewMatrix._m20_m21_m22 + r3.xyz;
  ...
  r0.yzw = viewMatrix._m10_m11_m12 * r0.yyy;
  r1.w = dot(r3.xyz, r4.xyz);
  r0.yzw = r1.www * viewMatrix._m00_m01_m02 + r0.yzw;
  r1.w = dot(r3.xyz, r5.xyz);
  r0.yzw = r1.www * viewMatrix._m20_m21_m22 + r0.yzw;
  r1.w = dot(r0.yzw, r0.yzw);
  r1.w = rsqrt(r1.w);
  o4.xyz = r1.www * r0.yzw;
  r0.yzw = r3.yzx * r1.zxy;
  r0.yzw = r1.yzx * r3.zxy + -r0.yzw;
  r1.x = v4.w * 2 + -1;
...
r3.y = modelInstanceBuffer[]..swiz;
r3.z = modelInstanceBuffer[]..swiz;
  r1.z = dot(r0.yzw, r3.xyz);
  r3.xyz = viewMatrix._m10_m11_m12 * r1.zzz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r4.xyz, r1.y, l(0), t5.xyzx
r4.x = modelInstanceBuffer[]..swiz;
r4.y = modelInstanceBuffer[]..swiz;
r4.z = modelInstanceBuffer[]..swiz;
  r1.z = dot(r0.yzw, r4.xyz);
  r3.xyz = r1.zzz * viewMatrix._m00_m01_m02 + r3.xyz;
// Known bad code for instruction (needs manual fix):
...
r1.w = modelInstanceBuffer[]..swiz;
  ...
  r0.yzw = r0.yyy * viewMatrix._m20_m21_m22 + r3.xyz;
  r1.y = dot(r0.yzw, r0.yzw);
  r1.y = rsqrt(r1.y);
  o5.xyz = r1.yyy * r0.yzw;
  r0.y = cmp((int)r0.x != 0);
// Known bad code for instruction (needs manual fix):
