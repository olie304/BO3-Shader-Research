...
mov r6.y, r5.x
mov r6.z, r4.x
dp2 r4.x, r0.xyxx, r6.yzyy
dp2 r4.y, r0.xyxx, r6.xyxx
add r2.zw, r1.yyyx, r4.xxxy
add r1.z, r1.z, l(0.500000)
add r2.zw, r1.zzzz, r2.zzzw
mul r2.zw, r2.zzzw, cb0[5].xxxy
add r4.xy, r4.xyxx, l(0.500000, 0.500000, 0.000000, 0.000000)
mul r4.xy, r4.xyxx, cb0[5].xyxx
movc r2.zw, cb0[15].xxxx, r2.zzzw, r4.xxxy
sample_indexable(texture2d)(float,float,float,float) r4.xyzw, r2.zwzz, t7.xyzw, s1
sample_indexable(texture2d)(float,float,float,float) r1.w, r2.zwzz, t9.yzwx, s1
...
sample_indexable(texture2d)(float,float,float,float) r5.xyz, r2.zwzz, t11.xyzw, s2
...
mov r7.y, r6.x
mov r7.z, r5.x
dp2 r5.x, r0.xyxx, r7.yzyy
dp2 r5.y, r0.xyxx, r7.xyxx
add r0.xy, r1.yxyy, r5.xyxx
...
movc r0.xy, cb0[15].yyyy, r0.xyxx, r1.xyxx
sample_indexable(texture2d)(float,float,float,float) r5.xyzw, r0.xyxx, t15.xyzw, s1
sample_indexable(texture2d)(float,float,float,float) r1.x, r0.xyxx, t12.xyzw, s1
add r6.xyz, cb0[13].xyzx, l(-1.000000, -1.000000, -1.000000, 0.000000)
mad r1.xyz, r1.xxxx, r6.xyzx, l(1.000000, 1.000000, 1.000000, 0.000000)
...
mad r4.xyzw, r0.zzzz, r5.xyzw, r4.xyzw
mul r4.xyz, r4.xyzx, v8.xyzx
...
mul r0.y, r1.z, r1.z
mul r0.xy, r0.xyxx, l(-17.000000, 0.33333334, 0.000000, 0.000000)
...
mad r1.xyw, r2.xyxz, r1.xxxx, r3.xyxz
mad r0.yzw, r0.yyzw, r1.zzzz, r1.xxyw
dp3 r1.x, r0.yzwy, r0.yzwy
rsq r1.x, r1.x
mul r0.yzw, r0.yyzw, r1.xxxx
mul o0.xyz, r4.wwww, r4.xyzx
ftou r1.xy, v0.xyxx
mov r1.zw, l(0,0,0,0)
...
mul o1.xyz, r4.wwww, r0.xyzx
mul o2.xyzw, r4.wwww, l(0.040000, 0.500000, 1.000000, 1.000000)
mov o0.w, r4.w
mov o1.w, r4.w
ret 
