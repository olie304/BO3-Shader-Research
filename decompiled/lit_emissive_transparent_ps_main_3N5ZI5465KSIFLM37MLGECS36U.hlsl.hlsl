...
r3.w = samp0[]..swiz;
  ...
  r2.xyz = r2.xyw * r1.www + r13.xyz;
  r2.w = dot(r2.xyz, r2.xyz);
  r2.w = rsqrt(r2.w);
  r2.xyz = r2.xyz * r2.www;
  r5.y = r1.y * r1.w + r11.y;
  r6.xyz = r1.www * float3(0.0399999991,0.0399999991,0.0399999991) + r14.xyz;
  ...
  r3.yzw = emissiveTint1.xyz * r7.xyz;
  r4.z = log2(r3.x);
  ...
  r4.zw = (uint2)r4.yx;
  r5.z = dot(r4.wz, float2(0.0671105608,0.00583714992));
  r5.z = frac(r5.z);
  r5.z = 52.9829178 * r5.z;
  r5.z = frac(r5.z);
  r5.z = r5.z * 6.28318548 + gameTick.w;
  sincos(r5.z, r7.x, r9.x);
  ...
  r4.z = dot(-r8.xyz, r2.xyz);
  r4.z = r4.z + r4.z;
  r12.xyz = r2.xyz * -r4.zzz + -r8.xyz;
  r4.z = 17 * r5.y;
  r4.z = exp2(r4.z);
  r4.z = 2 + r4.z;
  r4.z = 2 / r4.z;
  ...
  if (r4.y != 0) {
    ...
    while (true) {
      ...
      r11.y = cmp((int)r1.z == (int)r8.w);
      if (r4.x == 0) r11.z = 0; else if (r4.x+0 < 32) {       r11.z = (uint)r9.w << (32-(r4.x + 0)); r11.z = (uint)r11.z >> (32-r4.x);      } else r11.z = (uint)r9.w >> 0;
  ...
  if (r4.x != 0) {
    ...
    r10.yzw = r21.xyz * r1.zzz + r14.xyz;
    r12.w = 0;
    r14.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r12.xyzw, r5.w).xyz;
    r1.z = sunConstants.globalProbeExposure * r4.x + -r2.w;
    r1.z = r5.y * r1.z + r2.w;
  ...
  r5.yzw = r11.yzw * r1.zzz;
  r15.xyz = r5.zwy * r4.xxx;
  r5.yzw = r5.yzw * r4.yyy;
  r1.x = sqrt(r4.w);
  r1.x = r1.x * 0.5 + 0.5;
  r1.x = r1.x * r1.x;
  r1.z = 0.5 * r1.x;
  ...
  if (r4.y != 0) {
    r4.y = cmp(0 < r6.w);
    if (r4.y != 0) {
      r4.y = sunConstants.specScale * r4.z;
      r4.y = r4.y * r4.x;
      ...
      r1.y = dot(r11.yzw, r8.xyz);
      r7.z = dot(r2.xyz, r11.yzw);
      r7.w = abs(r7.z) * r4.z + -abs(r7.z);
      ...
      r4.x = r6.w * r4.x;
      r4.x = 0.25 * r4.x;
      r11.yzw = r4.xxx * r10.yzw + r5.yzw;
      r1.y = saturate(1 + -r1.y);
      r4.y = r1.y * r1.y;
      r4.y = r4.y * r4.y;
      r1.y = r4.y * r1.y;
      r1.y = r4.x * r1.y;
      r17.xyz = r1.yyy * r10.zwy + r15.xyz;
      r16.w = r17.z;
      r14.w = r15.z;
  ...
  r4.y = 0;
  while (true) {
    r5.x = cmp((uint)r4.y >= numLights);
    if (r5.x != 0) break;
    r17.z = (uint)r4.y >> 5;
    r18.xyz = (int3)r13.xyz + (int3)r17.xyz;
    r5.x = visibleLights.Load(r18.xyzw).x;
    r11.yzw = r10.yzw;
    r18.xyz = r29.xyz;
    r31.xyz = r30.xyz;
    r6.w = r4.x;
            ...
            if (r17.z != 0) {
              ...
              if (r17.z != 0) {
                ...
                if (r17.z != 0) {
                    ...
                    r9.w = samp0[]..swiz;
                      ...
                      if (r6.w != 0) {
                        ...
                        while (true) {
                          ...
                          r42.y = dot(icb[r27.w+0].xy, r7.xy);
                  ...
                  r9.w = r9.w + -r15.w;
                  r9.w = r4.w * r9.w + r15.w;
                  r9.w = r9.w * r13.w;
                  r33.x = r32.x;
                  r12.w = cmp(0 < r14.w);
                  r20.xyz = r9.www * r33.xyz + r11.yzw;
                  r9.w = saturate(dot(r2.xyz, r40.xyz));
                  r21.xyz = r39.xyz * r8.www + r8.xyz;
                  r8.w = dot(r21.xyz, r21.xyz);
                  r8.w = rsqrt(r8.w);
                  r21.xyz = r21.xyz * r8.www;
                  r8.w = dot(r21.xyz, r8.xyz);
                  r14.w = dot(r2.xyz, r21.xyz);
                  r15.w = abs(r14.w) * r4.z + -abs(r14.w);
                  r14.w = abs(r14.w) * r15.w + 1;
                  r15.w = r9.w * r1.x + r1.z;
                  r14.w = r14.w * r14.w;
                  r14.w = r14.w * r15.w;
                  r14.w = rcp(r14.w);
                  r9.w = r9.w * r17.z;
                  ...
                  r8.w = r13.w * r8.w;
                  r8.w = r9.w * r8.w;
                  r39.xyz = r8.www * r33.xyz + r18.xyz;
                  r11.yzw = r12.www ? r20.xyz : r11.yzw;
                  r18.xyz = r12.www ? r39.xyz : r18.xyz;
            ...
            r40.w = samp0[]..swiz;
              ...
              if (r13.w != 0) {
                ...
                if (r13.w != 0) {
                  ...
                  r14.w = r14.w * r7.w;
                  r9.w = cmp(0 < r9.w);
                  r23.xyz = r14.www * r21.xyz + r11.yzw;
                  ...
                  r17.z = abs(r14.w) * r4.z + -abs(r14.w);
