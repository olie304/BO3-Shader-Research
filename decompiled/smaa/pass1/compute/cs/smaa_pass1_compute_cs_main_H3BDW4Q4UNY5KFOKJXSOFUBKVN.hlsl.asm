...
itof r0.xyzw, vThreadID.xyxx
add r0.xyzw, r0.xyzw, l(0.500000, 0.500000, 0.500000, 0.500000)
mul r0.xyzw, r0.xyzw, cb1[44].zwzz
ishl r1.xyz, vThreadIDInGroup.xyyx, l(1, 1, 2, 0)
umax r1.w, r1.y, r1.x
ult r1.w, r1.w, l(12)
if_nz r1.w
  iadd r2.xy, vThreadIDInGroup.xyxx, vThreadID.xyxx
  iadd r2.xy, r2.xyxx, l(-1, -1, 0, 0)
  utof r2.xy, r2.xyxx
  mul r2.xy, r2.xyxx, cb1[44].zwzz
  gather4_indexable(texture2d)(float,float,float,float) r2.xyzw, r2.xyxx, t1.xyzw, s0.x
  ishl r1.y, r1.y, l(2)
  store_structured g0.x, r1.x, r1.y, r2.w
  imad r1.w, vThreadIDInGroup.x, l(2), l(1)
  store_structured g0.x, r1.w, r1.y, r2.z
  iadd r2.z, r1.y, l(4)
  store_structured g0.x, r1.x, r2.z, r2.x
  store_structured g0.x, r1.w, r2.z, r2.y
endif 
sync_g_t
store_uav_typed u1.xyzw, vThreadID.xyyy, l(0,0,0,0)
iadd r1.xyw, vThreadIDInGroup.xyxx, l(2, 2, 0, 1)
iadd r2.x, r1.z, l(8)
...
add r3.y, -r2.w, r2.y
mov r4.y, |r3.y|
mad r3.yz, r0.wwyw, l(0.000000, 1.500000, 1.100000, 0.000000), l(0.000000, -0.750000, -0.495000, 0.000000)
dp2 r3.y, r3.yzyy, r3.yzyy
ishr r3.y, r3.y, l(1)
iadd r3.y, r3.y, l(0x1fbd1df5)
add_sat r3.y, -r3.y, l(1.000000)
mul r5.xyzw, r4.wyww, r3.yyyy
ge r5.xyzw, r5.xyzw, l(0.100000, 0.100000, 0.100000, 0.100000)
and r5.xyzw, r5.xyzw, l(0x3f800000, 0x3f800000, 0x3f800000, 0x3f800000)
max r3.y, r5.y, r5.w
ne r3.y, l(0.000000, 0.000000, 0.000000, 0.000000), r3.y
if_nz r3.y
  iadd r1.yz, r1.yyzy, l(0, -8, 12, 0)
  ld_structured r3.y, r1.x, r1.z, g0.xxxx
  iadd r3.z, vThreadIDInGroup.x, l(3)
  ...
  add r1.x, r1.y, r1.x
  mad r1.x, r2.w, l(4.000000), -r1.x
  mov r1.y, |r1.x|
  mad r1.w, r8.x, l(2.000000), r2.z
  add r1.w, r8.y, r1.w
  mad r1.w, r3.x, l(4.000000), -r1.w
  mov r1.x, |r1.w|
  max r1.z, |r1.z|, |r2.x|
  max r1.w, |r2.y|, |r3.w|
  max r1.w, r1.w, r1.z
  max r1.xw, r1.xxxy, r1.wwww
  max r1.y, r1.y, r1.z
  eq r1.yz, |r2.xxxx|, r1.yywy
  and r1.yz, r1.yyzy, l(0, 32, 2, 0)
  eq r1.x, |r3.w|, r1.x
  movc r1.x, r1.x, l(8), r1.z
  iadd r1.y, r1.y, r1.x
  itof r1.y, r1.y
  ...
  or r0.w, r0.w, r1.z
  or r3.x, r0.w, vThreadID.x
  f32tof16 r0.xyz, r0.xyzx
  movc r0.xyz, r2.xyzx, r0.xyzx, l(0x00007bff,0x00007bff,0x00007bff,0)
  ubfe r0.x, l(11), l(4), r0.x
  ishl r0.yz, r0.yyzy, l(0, 7, 17, 0)
  and r0.y, r0.y, l(0x003ff800)
  iadd r0.x, r0.y, r0.x
  bfi r3.y, l(22), l(0), r0.x, r0.z
  add r0.x, r1.y, l(0.500000)
  ftoi r0.x, r0.x
  and r0.xy, r0.xxxx, l(8, 34, 0, 0)
  if_nz r0.x
    ubfe r0.x, l(1), l(1), r1.x
    ineg r2.y, r0.x
    ishr r0.x, r1.x, l(3)
    ineg r2.x, r0.x
    iadd r1.xy, r2.xyxx, vThreadID.xyxx
    mov r1.zw, l(0,0,0,0)
    ld_indexable(texture2d)(float,float,float,float) r0.xzw, r1.xyzw, t2.xwyz
    and r1.xyz, r0.xzwx, l(0x7f800000, 0x7f800000, 0x7f800000, 0)
    ine r1.xyz, r1.xyzx, l(0x7f800000, 0x7f800000, 0x7f800000, 0)
    f32tof16 r0.xzw, r0.xxzw
    movc r0.xzw, r1.xxyz, r0.xxzw, l(0x00007bff,0,0x00007bff,0x00007bff)
    ubfe r0.x, l(11), l(4), r0.x
    ishl r0.zw, r0.zzzw, l(0, 0, 7, 17)
    and r0.z, r0.z, l(0x003ff800)
    iadd r0.x, r0.z, r0.x
