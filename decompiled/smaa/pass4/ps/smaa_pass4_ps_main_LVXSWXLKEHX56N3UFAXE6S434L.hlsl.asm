...
// velocityTex0                      texture  float4          2d             t6      1 
// filmicHistoryTex1                 texture  float4          2d             t7      1 
// depthTex                          texture  float4          2d             t9      1 
...
sample_l_indexable(texture2d)(float,float,float,float) r0.x, r0.xyxx, t9.xyzw, s0, l(0.000000)
mad r1.xyzw, cb1[44].zwzw, l(-2.000000, -2.000000, -2.000000, 2.000000), v1.xyxy
sample_l_indexable(texture2d)(float,float,float,float) r0.y, r1.xyxx, t9.yxzw, s0, l(0.000000)
max r0.x, r0.y, r0.x
sample_l_indexable(texture2d)(float,float,float,float) r0.z, r1.zwzz, t9.yzxw, s0, l(0.000000)
max r0.x, r0.z, r0.x
mad r1.xy, cb1[44].zwzz, l(2.000000, -2.000000, 0.000000, 0.000000), v1.xyxx
sample_l_indexable(texture2d)(float,float,float,float) r0.w, r1.xyxx, t9.yzwx, s0, l(0.000000)
max r0.x, r0.w, r0.x
sample_l_indexable(texture2d)(float,float,float,float) r1.x, v1.xyxx, t9.xyzw, s0, l(0.000000)
max r0.x, r0.x, r1.x
...
mad r0.zw, -cb1[44].zzzw, r0.xxxy, v1.xxxy
sample_l_indexable(texture2d)(float,float,float,float) r1.xyz, v1.xyxx, t0.xyzw, s0, l(0.000000)
sample_l_indexable(texture2d)(float,float,float,float) r2.xyz, r0.zwzz, t7.xyzw, s0, l(0.000000)
mul r3.xyz, r1.xyzx, l(0.00003052, 0.00003052, 0.00003052, 0.000000)
...
ishr r2.xyz, r2.xyzx, l(1, 1, 1, 0)
iadd r2.xyz, r2.xyzx, l(0x1fbd1df5, 0x1fbd1df5, 0x1fbd1df5, 0)
dp3 r2.x, r2.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
add r1.w, r1.w, -r2.x
mad_sat r1.w, |r1.w|, l(6.66666651), l(-0.33333334)
lt r2.x, l(0.000000), r1.w
if_nz r2.x
  lt r2.x, |r0.y|, |r0.x|
  mul r3.xy, r0.zwzz, cb1[44].xyxx
  movc r0.z, r2.x, r3.x, r3.y
  add r0.w, r0.z, l(-0.500000)
  round_ni r4.yw, r0.wwww
  add r4.xz, r4.wwww, l(0.500000, 0.000000, 0.500000, 0.000000)
  add r0.z, r0.z, -r4.x
  mul r0.w, r0.z, r0.z
  add r2.y, r0.w, r0.w
  mad r2.z, r0.w, l(2.000000), -r0.z
  mad r2.z, -r0.w, r0.z, r2.z
  mad r2.y, r0.w, r0.z, -r2.y
  add r2.y, r2.y, l(1.000000)
  mad r2.w, r0.z, r0.z, r0.z
  mad r2.w, -r0.w, r0.z, r2.w
  mad r0.z, r0.w, r0.z, -r0.w
  add r0.w, r2.w, r2.y
  div r5.y, r2.w, r0.w
  mov r5.xz, l(-0.500000,0,2.500000,0)
  add r4.xyz, r4.ywzy, r5.xzyx
  mov r4.w, r3.y
  mov r3.zw, r4.xxxz
  movc r5.xyzw, r2.xxxx, r4.xwzw, r3.xzxw
  mov r4.x, r3.x
  movc r2.xy, r2.xxxx, r4.ywyy, r4.xyxx
  mul r3.xyzw, r5.xyzw, cb1[44].zwzw
  sample_l_indexable(texture2d)(float,float,float,float) r4.xyz, r3.xyxx, t7.xyzw, s0, l(0.000000)
  sample_l_indexable(texture2d)(float,float,float,float) r3.xyz, r3.zwzz, t7.xyzw, s0, l(0.000000)
  mul r3.xyz, r0.wwww, r3.xyzx
  mad r3.xyz, r2.zzzz, r4.xyzx, r3.xyzx
  mul r2.xy, r2.xyxx, cb1[44].zwzz
  sample_l_indexable(texture2d)(float,float,float,float) r2.xyz, r2.xyxx, t7.xyzw, s0, l(0.000000)
  mad r2.xyz, r0.zzzz, r2.xyzx, r3.xyzx
  dp2 r0.x, r0.xyxx, r0.xyxx
  ishr r0.x, r0.x, l(1)
  iadd r0.x, r0.x, l(0x1fbd1df5)
  add_sat r0.x, -r0.x, l(40.000000)
  mad r3.xyzw, cb1[44].zwzw, l(-1.000000, 0.000000, 1.000000, 0.000000), v1.xyxy
  sample_l_indexable(texture2d)(float,float,float,float) r0.yzw, r3.xyxx, t0.wxyz, s0, l(0.000000)
  sample_l_indexable(texture2d)(float,float,float,float) r3.xyz, r3.zwzz, t0.xyzw, s0, l(0.000000)
  mad r4.xyzw, cb1[44].zwzw, l(0.000000, 1.000000, 0.000000, -1.000000), v1.xyxy
  ...
  min r6.xyz, r0.yzwy, r6.xyzx
  min r6.xyz, r1.xyzx, r6.xyzx
  max r4.xyz, r4.xyzx, r5.xyzx
  max r3.xyz, r3.xyzx, r4.xyzx
  max r0.yzw, r0.yyzw, r3.xxyz
  max r0.yzw, r0.yyzw, r1.xxyz
  max r3.xyz, r2.xyzx, r6.xyzx
  max r2.xyz, r0.yzwy, r2.xyzx
  max r4.xyz, r0.yzwy, r6.xyzx
  min r2.xyz, r2.xyzx, r4.xyzx
  min r2.xyz, r2.xyzx, r3.xyzx
  mul r3.xyz, r6.xyzx, l(0.00003052, 0.00003052, 0.00003052, 0.000000)
  ishr r3.xyz, r3.xyzx, l(1, 1, 1, 0)
  iadd r3.xyz, r3.xyzx, l(0x1fbd1df5, 0x1fbd1df5, 0x1fbd1df5, 0)
  dp3 r2.w, r3.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
  mul r0.yzw, r0.yyzw, l(0.000000, 0.00003052, 0.00003052, 0.00003052)
  ishr r0.yzw, r0.yyzw, l(0, 1, 1, 1)
  iadd r0.yzw, r0.yyzw, l(0, 0x1fbd1df5, 0x1fbd1df5, 0x1fbd1df5)
  ...
  add r0.w, -cb8[1].x, cb8[1].y
  mad r0.y, -r0.w, r0.y, cb8[1].y
  max r0.z, r1.w, r0.z
