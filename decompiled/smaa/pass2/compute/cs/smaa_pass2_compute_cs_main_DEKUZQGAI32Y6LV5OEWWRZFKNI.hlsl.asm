...
mul r3.zw, r0.xxxw, cb1[44].zzzw
mad r1.x, r1.x, l(1.000000), l(0.500000)
ftoi r1.x, r1.x
and r1.x, r1.x, l(15)
sample_l_indexable(texture2d)(float,float,float,float) r1.yz, r3.zwzz, t4.zxyw, s0, l(0.000000)
mad r4.xyzw, cb1[44].zwzw, l(-1.000000, 0.000000, 1.000000, 0.000000), r3.zwzw
...
if_nz r5.x
  ...
  if_nz r4.z
    ...
    mad r7.xyzw, r7.xyzw, cb1[44].zwzw, r3.zwzw
    ...
    if_z r1.y
      ...
      mad r6.zw, r6.zzzw, cb1[44].zzzw, r3.zzzw
      ...
      mad r7.xy, r7.xyxx, cb1[44].zwzz, r3.zwzz
  ...
  if_nz r4.z
    ...
    if_z r4.x
      ...
      mad r4.xw, r4.xxxx, cb1[44].zzzw, r3.zzzw
...
if_nz r1.x
  ...
  loop 
    ge r6.z, r5.z, r5.w
    breakc_nz r6.z
    sample_l_indexable(texture2d)(float,float,float,float) r1.xw, r4.zwzz, t4.xzwy, s0, l(0.000000)
    mad r4.zw, cb1[44].zzzw, l(0.000000, 0.000000, 2.000000, 0.000000), r4.zzzw
  ...
  if_nz r0.x
    mad r3.y, -cb1[44].z, r4.y, r3.z
    mad r3.x, cb1[44].z, r4.x, r3.z
    ...
    mad r1.xw, cb1[44].zzzw, l(0.250000, 0.000000, 0.000000, 0.000000), r3.yyyw
    ...
    mad r3.z, r1.x, l(5.000000), l(-3.750000)
    mul r1.x, r1.x, |r3.z|
    round_ne r6.xy, r1.wxww
    mul r1.xw, r0.xxxx, r6.xxxy
    add r4.zw, r3.xxxw, cb1[44].zzzw
    sample_l_indexable(texture2d)(float,float,float,float) r4.zw, r4.zwzz, t4.zwxy, s0, l(0.000000)
    mul r5.zw, r0.wwww, r4.wwwz
    mad r7.xyzw, cb1[44].zwzw, l(0.000000, -2.000000, 0.000000, 0.250000), r3.ywxw
    sample_l_indexable(texture2d)(float,float,float,float) r3.z, r7.xyxx, t4.wyxz, s0, l(0.000000)
    add r3.yw, r3.yyyw, -cb1[44].zzzw
    sample_l_indexable(texture2d)(float,float,float,float) r3.x, r3.ywyy, t4.yxwz, s0, l(0.000000)
    mul r3.yw, r0.xxxx, r3.xxxz
    mad r6.zw, cb1[44].zzzw, l(0.000000, 0.000000, 1.000000, -2.000000), r7.zzzw
    sample_l_indexable(texture2d)(float,float,float,float) r6.zw, r6.zwzz, t4.zwxy, s0, l(0.000000)
    mad r7.x, r6.w, l(5.000000), l(-3.750000)
    mul r6.w, r6.w, |r7.x|
    round_ne r7.zw, r6.wwwz
    mul r6.zw, r0.wwww, r7.zzzw
    add r4.x, r4.x, r4.y
    lt r4.x, l(0.000000), r4.x
    mad_sat r8.xy, r0.xxxx, r6.xyxx, r5.zwzz
    mad_sat r8.zw, r0.xxxx, r3.xxxz, r6.zzzw
    add r1.x, r1.x, r1.w
    mad r1.x, r0.w, r4.z, r1.x
    mad_sat r1.x, r0.w, r4.w, r1.x
    add r1.w, r3.y, r3.w
    mad r1.w, r0.w, r7.w, r1.w
    mad_sat r1.w, r0.w, r7.z, r1.w
    mad r3.x, -r0.x, r6.y, l(2.000000)
    mad_sat r3.x, -r0.w, r4.z, r3.x
    mul r3.x, r1.x, r3.x
    mad r0.x, -r0.x, r3.z, l(2.000000)
