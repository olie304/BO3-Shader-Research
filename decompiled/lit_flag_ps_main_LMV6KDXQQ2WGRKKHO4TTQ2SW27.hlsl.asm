...
dp3_sat r4.x, r1.xyzx, r5.yzwy
dp3 r6.y, -r5.yzwy, r1.xyzx
add r6.y, r6.y, r6.y
mad r11.xyz, r1.xyzx, -r6.yyyy, -r5.yzwy
...
if_z r3.w
  ...
  if_nz r4.z
    ...
    mad r20.xyz, r22.xyzx, r3.wwww, r9.yzwy
    mov r11.w, l(0)
    sample_l_indexable(texturecubearray)(float,float,float,float) r9.yzw, r11.xyzw, t8.wxyz, s2, r7.z
    mad r3.w, cb2[19].x, r4.z, -r1.w
    mad r1.w, r4.y, r3.w, r1.w
    mad r21.xyz, r9.yzwy, r1.wwww, r21.xyzx
  endif 
else 
  mov r21.x, r20.w
endif 
...
mul r9.yzw, r1.wwww, r21.xxyz
mul r10.yzw, r4.yyyy, r9.yyzw
...
if_nz r4.y
  ...
  if_nz r4.y
    ...
    add_sat r4.y, -r4.w, l(1.000000)
    mul r4.z, r4.y, r4.y
    mul r4.z, r4.z, r4.z
    mul r4.y, r4.z, r4.y
    mul r3.w, r3.w, r4.y
    mad r4.yzw, r3.wwww, r9.yyzw, r10.yyzw
    mov r15.w, r13.z
    mov r13.w, r15.z
          ...
          if_nz r17.w
            ...
            if_nz r17.w
              ...
              if_nz r17.w
                ...
                dp3_sat r16.w, r1.xyzx, r42.xyzx
                mad r41.xyz, r41.xyzx, r12.wwww, r5.yzwy
                dp3 r12.w, r41.xyzx, r41.xyzx
                rsq r12.w, r12.w
                mul r41.xyz, r12.wwww, r41.xyzx
                dp3 r12.w, r41.xyzx, r5.yzwy
                dp3 r20.x, r1.xyzx, r41.xyzx
                mad r22.w, |r20.x|, r6.y, -|r20.x|
                mad r20.x, |r20.x|, r22.w, l(1.000000)
                mad r22.w, r16.w, r0.w, r1.w
          ...
          if_nz r14.w
            ...
            if_nz r14.w
              ...
              if_nz r14.w
                ...
                mad r23.xyz, r1.xyzx, r14.wwww, v6.xyzx
              ...
              if_nz r14.w
                ...
                mov_sat r13.w, r13.w
                mad r21.xyz, r21.xyzx, r12.wwww, r5.yzwy
                dp3 r12.w, r21.xyzx, r21.xyzx
                rsq r12.w, r12.w
                mul r21.xyz, r12.wwww, r21.xyzx
                dp3 r12.w, r21.xyzx, r5.yzwy
                dp3 r20.x, r1.xyzx, r21.xyzx
                mad r21.x, |r20.x|, r6.y, -|r20.x|
                mad r20.x, |r20.x|, r21.x, l(1.000000)
                mad r21.x, r13.w, r0.w, r1.w
                mul r20.x, r20.x, r20.x
