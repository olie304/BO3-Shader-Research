...
r0.y = samp0[]..swiz;
  ...
  r17.xz = r9.xy * r2.zw;
  r17.w = r2.z * r2.w;
  r1.w = dot(r15.xyzw, r17.xyzw);
  r16.xyzw = r16.xyzw + -r9.wwww;
  r2.z = min(abs(r16.z), abs(r16.w));
  r2.z = min(abs(r16.y), r2.z);
  r2.z = min(abs(r16.x), r2.z);
  r2.w = max(abs(r16.z), abs(r16.w));
  r2.w = max(abs(r16.y), r2.w);
  r2.w = max(abs(r16.x), r2.w);
  r13.yzw = cmp(r2.zzz == abs(r16.yzw));
  r2.z = r13.y ? r15.y : r15.x;
  r2.z = r13.z ? r15.z : r2.z;
  r2.z = r13.w ? r15.w : r2.z;
  ...
  r12.w = cmp((uint)r0.x >= (uint)r9.w);
  r13.y = cmp((uint)r0.x < numRefProbes);
  r12.w = r12.w ? r13.y : 0;
  if (r12.w != 0) {
    r12.w = (int)r0.x * 14;
    r13.yzw = -refProbeConstantsCB[r12.w].data[0].xyz + r10.xyz;
    r15.x = 0x0000ffff & (int)refProbeConstantsCB[r12.w].data[7].z;
    if (6 == 0) r15.y = 0; else if (6+25 < 32) {     r15.y = (uint)refProbeConstantsCB[r12.w].data[7].z << (32-(6 + 25)); r15.y = (uint)r15.y >> (32-6);    } else r15.y = (uint)refProbeConstantsCB[r12.w].data[7].z >> 25;
    r15.z = (int)r15.x * 6;
    r15.w = dot(refProbeAttenuationConstantsCB[r15.z].data[0].xyz, r13.yzw);
    r15.w = saturate(refProbeAttenuationConstantsCB[r15.z].data[0].w + r15.w);
    r16.x = dot(refProbeAttenuationConstantsCB[r15.z].data[1].xyz, r13.yzw);
    r16.x = saturate(refProbeAttenuationConstantsCB[r15.z].data[1].w + r16.x);
    r15.w = r16.x * r15.w;
    r16.x = dot(refProbeAttenuationConstantsCB[r15.z].data[2].xyz, r13.yzw);
    r16.x = saturate(refProbeAttenuationConstantsCB[r15.z].data[2].w + r16.x);
    r15.w = r16.x * r15.w;
    r16.x = dot(refProbeAttenuationConstantsCB[r15.z].data[3].xyz, r13.yzw);
    r16.x = saturate(refProbeAttenuationConstantsCB[r15.z].data[3].w + r16.x);
    r15.w = r16.x * r15.w;
    r16.x = dot(refProbeAttenuationConstantsCB[r15.z].data[4].xyz, r13.yzw);
    r16.x = saturate(refProbeAttenuationConstantsCB[r15.z].data[4].w + r16.x);
    r15.w = r16.x * r15.w;
    r16.x = dot(refProbeAttenuationConstantsCB[r15.z].data[5].xyz, r13.yzw);
    r15.z = saturate(refProbeAttenuationConstantsCB[r15.z].data[5].w + r16.x);
    r16.x = r15.w * r15.z;
    r15.z = 1 & (int)refProbeConstantsCB[r12.w].data[6].x;
    r16.yz = float2(0,1);
    r15.zw = r15.zz ? r16.xy : r16.zx;
    r16.x = 1;
    r16.z = refProbeConstantsCB[r12.w].data[6].x;
    r17.xy = r15.zw;
    r16.w = 1;
    while (true) {
      r17.z = cmp((int)r16.w >= (int)r15.y);
      if (r17.z != 0) break;
      r17.z = (int)r15.x + (int)r16.w;
      r17.z = (int)r17.z * 6;
      r17.w = dot(refProbeAttenuationConstantsCB[r17.z].data[0].xyz, r13.yzw);
      r17.w = saturate(refProbeAttenuationConstantsCB[r17.z].data[0].w + r17.w);
      r17.w = r17.x * r17.w;
      r18.x = dot(refProbeAttenuationConstantsCB[r17.z].data[1].xyz, r13.yzw);
      r18.x = saturate(refProbeAttenuationConstantsCB[r17.z].data[1].w + r18.x);
      r17.w = r18.x * r17.w;
      r18.x = dot(refProbeAttenuationConstantsCB[r17.z].data[2].xyz, r13.yzw);
      r18.x = saturate(refProbeAttenuationConstantsCB[r17.z].data[2].w + r18.x);
      r17.w = r18.x * r17.w;
      r18.x = dot(refProbeAttenuationConstantsCB[r17.z].data[3].xyz, r13.yzw);
      r18.x = saturate(refProbeAttenuationConstantsCB[r17.z].data[3].w + r18.x);
      r17.w = r18.x * r17.w;
      r18.x = dot(refProbeAttenuationConstantsCB[r17.z].data[4].xyz, r13.yzw);
      r18.x = saturate(refProbeAttenuationConstantsCB[r17.z].data[4].w + r18.x);
      r17.w = r18.x * r17.w;
      r18.x = dot(refProbeAttenuationConstantsCB[r17.z].data[5].xyz, r13.yzw);
      r17.z = saturate(refProbeAttenuationConstantsCB[r17.z].data[5].w + r18.x);
      r17.x = r17.w * r17.z;
      r18.x = (uint)r16.z >> 2;
      if (1 == 0) r18.y = 0; else if (1+2 < 32) {       r18.y = (uint)r16.z << (32-(1 + 2)); r18.y = (uint)r18.y >> (32-1);      } else r18.y = (uint)r16.z >> 2;
      r18.z = (int)r18.x & 2;
      r18.w = max(r17.y, r17.x);
      r17.z = -r17.w * r17.z + 1;
      r17.z = r17.y * r17.z;
      r16.y = r18.z ? r17.z : r18.w;
      r17.xy = r18.yy ? r17.xy : r16.xy;
      r16.w = (int)r16.w + 1;
      r16.z = r18.x;
    }
    r17.y = saturate(r17.y);
    r15.x = refProbeConstantsCB[r12.w].data[6].y * r17.y;
    r15.y = cmp(0 < r15.x);
    if (r15.y != 0) {
      r15.y = refProbeConstantsCB[r12.w].data[7].y * r15.x;
      r16.x = refProbeConstantsCB[r12.w].data[7].w;
      r16.yz = refProbeConstantsCB[r12.w].data[8].xy;
      r15.z = dot(r14.xyz, r16.xyz);
      r15.w = dot(r13.yzw, r16.xyz);
      ...
      r16.x = refProbeConstantsCB[r12.w].data[8].w;
      r16.yz = refProbeConstantsCB[r12.w].data[9].xy;
      r15.w = dot(r14.xyz, r16.xyz);
      r16.x = dot(r13.yzw, r16.xyz);
      r16.x = -refProbeConstantsCB[r12.w].data[9].z + r16.x;
      r16.y = cmp(r16.x >= 0);
      r16.x = max(abs(r16.x), r9.x);
      r16.x = r16.y ? r16.x : -r16.x;
      r15.w = max(1.00000001e-07, -r15.w);
      r15.w = r16.x / r15.w;
      r15.z = min(r15.z, abs(r15.w));
      r16.x = refProbeConstantsCB[r12.w].data[9].w;
      r16.yz = refProbeConstantsCB[r12.w].data[10].xy;
      r15.w = dot(r14.xyz, r16.xyz);
      r16.x = dot(r13.yzw, r16.xyz);
      r16.x = -refProbeConstantsCB[r12.w].data[10].z + r16.x;
      r16.y = cmp(r16.x >= 0);
      r16.x = max(abs(r16.x), r9.x);
      r16.x = r16.y ? r16.x : -r16.x;
      r15.w = max(1.00000001e-07, -r15.w);
      r15.w = r16.x / r15.w;
      r15.z = min(r15.z, abs(r15.w));
      r16.x = refProbeConstantsCB[r12.w].data[10].w;
      r16.yz = refProbeConstantsCB[r12.w].data[11].xy;
      r15.w = dot(r14.xyz, r16.xyz);
      r16.x = dot(r13.yzw, r16.xyz);
      r16.x = -refProbeConstantsCB[r12.w].data[11].z + r16.x;
      r16.y = cmp(r16.x >= 0);
      r16.x = max(abs(r16.x), r9.x);
      r16.x = r16.y ? r16.x : -r16.x;
      r15.w = max(1.00000001e-07, -r15.w);
      r15.w = r16.x / r15.w;
      r15.z = min(r15.z, abs(r15.w));
      r16.x = refProbeConstantsCB[r12.w].data[11].w;
      r16.yz = refProbeConstantsCB[r12.w].data[12].xy;
      r15.w = dot(r14.xyz, r16.xyz);
      r16.x = dot(r13.yzw, r16.xyz);
      r16.x = -refProbeConstantsCB[r12.w].data[12].z + r16.x;
      r16.y = cmp(r16.x >= 0);
      r16.x = max(abs(r16.x), r9.x);
      r16.x = r16.y ? r16.x : -r16.x;
      r15.w = max(1.00000001e-07, -r15.w);
      r15.w = r16.x / r15.w;
      r15.z = min(r15.z, abs(r15.w));
      r16.x = refProbeConstantsCB[r12.w].data[12].w;
      r16.yz = refProbeConstantsCB[r12.w].data[13].xy;
      r15.w = dot(r14.xyz, r16.xyz);
      r16.x = dot(r13.yzw, r16.xyz);
      r16.x = -refProbeConstantsCB[r12.w].data[13].z + r16.x;
      r16.y = cmp(r16.x >= 0);
      r16.x = max(abs(r16.x), r9.x);
      r16.x = r16.y ? r16.x : -r16.x;
      r15.w = max(1.00000001e-07, -r15.w);
      r15.w = r16.x / r15.w;
      r15.z = min(r15.z, abs(r15.w));
      r16.x = refProbeConstantsCB[r12.w].data[3].w + r13.y;
      r16.yz = refProbeConstantsCB[r12.w].data[4].xy + r13.zw;
      r16.xyz = r14.xyz * r15.zzz + r16.xyz;
      ...
      r17.x = refProbeConstantsCB[r12.w].data[0].w;
      r17.y = refProbeConstantsCB[r12.w].data[1].z;
      r17.z = refProbeConstantsCB[r12.w].data[2].y;
      r18.x = dot(r16.xyz, r17.xyz);
      r19.xy = refProbeConstantsCB[r12.w].data[1].xw;
      r19.z = refProbeConstantsCB[r12.w].data[2].z;
      r18.y = dot(r16.xyz, r19.xyz);
      r20.x = refProbeConstantsCB[r12.w].data[1].y;
      r20.yz = refProbeConstantsCB[r12.w].data[2].xw;
      ...
      r18.w = (uint)r15.w;
      r16.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r18.xyzw, r15.z).xyz;
      r21.x = dot(r13.yzw, r17.xyz);
      r21.y = dot(r13.yzw, r19.xyz);
      r21.z = dot(r13.yzw, r20.xyz);
      r13.yzw = saturate(r21.xyz * refProbeConstantsCB[r12.w].data[3].xyz + float3(0.5,0.5,0.5));
      r21.xy = refProbeConstantsCB[r12.w].data[4].zw * r13.yz;
      r21.z = refProbeConstantsCB[r12.w].data[5].x * r13.w;
      r13.yzw = refProbeConstantsCB[r12.w].data[5].yzw + r21.xyz;
      ...
      r20.xyz = r20.xyz * r15.yyy;
      r21.z = r17.y ? 0 : 0.5;
      r21.xy = float2(0,0);
      r17.xyw = r21.xyz + r13.yzw;
      ...
      r13.yzw = r13.yzw * r20.zzz + r17.xyw;
      r17.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r18.xyzw, 6).xyz;
      r13.yzw = r17.xyz * r13.yzw;
      r12.w = dot(r13.yzw, float3(0.212599993,0.715200007,0.0722000003));
      r15.z = r12.w * r9.y;
      r16.xyz = r16.xyz * r15.yyy;
      r15.y = dot(r16.xyz, float3(0.212599993,0.715200007,0.0722000003));
      r12.w = r9.y * r12.w + r15.y;
      r12.w = r15.z / r12.w;
      r15.yzw = r16.xyz * r12.www;
    } else {
  ...
  r12.w = cmp(r15.x < 1);
  if (r12.w != 0) {
    r9.w = cmp((uint)r0.x < (uint)r9.w);
    if (r9.w != 0) {
      r0.x = (int)r0.x * 14;
      r16.xyz = -refProbeConstantsCB[r0.x].data[0].xyz + r10.xyz;
      r9.w = 0x0000ffff & (int)refProbeConstantsCB[r0.x].data[7].z;
      ...
      r9.w = saturate(r19.y + -r15.x);
      r12.w = refProbeConstantsCB[r0.x].data[6].y * r9.w;
      r16.w = cmp(0 < r12.w);
      if (r16.w != 0) {
        r15.x = r9.w * refProbeConstantsCB[r0.x].data[6].y + r15.x;
        r9.w = refProbeConstantsCB[r0.x].data[7].y * r12.w;
        r17.x = refProbeConstantsCB[r0.x].data[7].w;
        r17.yz = refProbeConstantsCB[r0.x].data[8].xy;
        r12.w = dot(r14.xyz, r17.xyz);
        ...
        r17.y = cmp(r17.x >= 0);
        r9.x = max(abs(r17.x), r9.x);
        r9.x = r17.y ? r9.x : -r9.x;
        r16.w = max(1.00000001e-07, -r16.w);
        r9.x = r9.x / r16.w;
        r9.x = min(r12.w, abs(r9.x));
        r17.x = refProbeConstantsCB[r0.x].data[3].w + r16.x;
        r17.yz = refProbeConstantsCB[r0.x].data[4].xy + r16.yz;
        r17.xyz = r14.xyz * r9.xxx + r17.xyz;
        ...
        if (9 == 0) r9.x = 0; else if (9+16 < 32) {         r9.x = (uint)refProbeConstantsCB[r0.x].data[7].z << (32-(9 + 16)); r9.x = (uint)r9.x >> (32-9);        } else r9.x = (uint)refProbeConstantsCB[r0.x].data[7].z >> 16;
        r19.w = (uint)r9.x;
        r17.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r19.xyzw, r6.w).xyz;
        ...
        r9.x = dot(r16.xyz, float3(0.212599993,0.715200007,0.0722000003));
        r0.x = r9.y * r0.x + r9.x;
        r0.x = r6.w / r0.x;
        r15.yzw = r16.xyz * r0.xxx + r15.yzw;
      }
    }
  }
  r0.x = max(1, r15.x);
  ...
  r9.xyw = r13.yzw * r0.xxx;
  r15.yzw = r15.yzw * r0.xxx;
  r6.w = cmp(r15.x < 0.99000001);
  if (r6.w != 0) {
    r6.w = 1 + -r15.x;
    ...
    r9.xyw = r13.yzw * r0.xxx + r16.xyz;
    r14.w = 0;
    r13.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r14.xyzw, r8.w).xyz;
    r0.x = sunConstants.globalProbeExposure * r6.w + -r11.w;
    r0.x = r2.y * r0.x + r11.w;
    r15.yzw = r13.yzw * r0.xxx + r15.yzw;
  }
  r0.x = r4.z * r1.w + r2.x;
  r0.x = log2(abs(r0.x));
  r0.x = r1.z * r0.x;
  ...
  if (r2.y != 0) {
    ...
    if (r2.y != 0) {
      ...
      if (sunConstants.sunCookieIndex != 0) {
        ...
        r17.w = 1;
        r2.z = dot(sunConstants.sunCookieTransform[0].xyzw, r17.xyzw);
        r4.z = dot(sunConstants.sunCookieTransform[1].xyzw, r17.xyzw);
        r17.x = frac(r2.z);
        r17.y = frac(r4.z);
      ...
      if (r4.z != 0) {
        ...
        r17.xyz = r11.xyz * r4.zzz + r10.xyz;
        r18.xyz = lightConstantsCB[r2.z].data[4].yzw;
        r18.w = lightConstantsCB[r2.z].data[5].x;
        r17.w = 1;
        r18.x = dot(r18.xyzw, r17.xyzw);
        r19.xyz = lightConstantsCB[r2.z].data[5].yzw;
        r19.w = lightConstantsCB[r2.z].data[6].x;
        r18.y = dot(r19.xyzw, r17.xyzw);
        r18.xy = r18.xy * float2(0.5,-0.5) + float2(0.5,0.5);
        r19.x = lightConstantsCB[r2.z].data[9].w + r18.x;
        r19.y = lightConstantsCB[r2.z].data[10].x + r18.y;
        r18.xy = lightConstantsCB[r2.z].data[9].yz * r19.xy;
        r18.zw = lightConstantsCB[r2.z].data[3].yy / lightConstantsCB[r2.z].data[8].yw;
        r19.xy = float2(1,1) + -r18.zw;
        r19.xy = cmp(r18.xy >= r19.xy);
        r18.zw = cmp(r18.zw >= r18.xy);
        r18.zw = (int2)r18.zw | (int2)r19.xy;
        r4.z = (int)r18.w | (int)r18.z;
        if (r4.z == 0) {
          r19.xyz = lightConstantsCB[r2.z].data[6].yzw;
          r19.w = lightConstantsCB[r2.z].data[7].x;
          r4.z = dot(r19.xyzw, r17.xyzw);
          r18.xy = saturate(r18.xy);
          r17.x = r18.x * lightConstantsCB[r2.z].data[8].y + lightConstantsCB[r2.z].data[8].z;
          r17.y = r18.y * lightConstantsCB[r2.z].data[8].w + lightConstantsCB[r2.z].data[9].x;
          ...
          if (enableDitheredShadow != 0) {
            ...
            while (true) {
              ...
              r19.xy = r20.xy * lightConstantsCB[r2.z].data[3].yy + r17.xy;
            ...
            r17.z = (uint)r6.w;
            r8.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r17.xyz, r4.z).x;
          }
          r2.z = r8.w * r8.w;
          r2.z = r2.z * r8.w;
        } else {
      ...
      r2.y = r7.w * r2.y;
      r2.y = 0.25 * r2.y;
      r18.xyz = r2.yyy * r13.yzw + r9.xyw;
      r0.z = saturate(1 + -r0.z);
      r2.z = r0.z * r0.z;
      r2.z = r2.z * r2.z;
      r0.z = r2.z * r0.z;
      r0.z = r2.y * r0.z;
      r19.xyz = r0.zzz * r13.zwy + r15.xyz;
      r17.w = r19.z;
      r16.w = r15.z;
      r16.xyzw = r2.wwww ? r17.xyzw : r16.xyzw;
      r19.zw = r18.xy;
      r15.zw = r9.xy;
      r17.xyzw = r2.wwww ? r19.xyzw : r15.xyzw;
      r9.w = r2.w ? r18.z : r9.w;
      r15.z = r16.w;
      r15.xy = r17.xy;
      r9.xy = r17.zw;
    }
  ...
  switch (r0.z) {
    ...
    r2.yzw = -r17.xyz * float3(0.5,0.5,0.5) + lightConstantsCB[r0.y].data[0].xyz;
    ...
    r18.xyz = r0.zzz ? r18.xyz : lightConstantsCB[r0.y].data[0].xyz;
    ...
    if (r11.w != 0) {
      ...
      if (r11.w != 0) {
        ...
        r11.w = cmp(0 < r6.w);
        if (r11.w != 0) {
          r11.w = lightConstantsCB[r0.y].data[1].z * r0.w;
          r11.w = 0.25 * r11.w;
          r12.w = dot(r17.xyz, r14.xyz);
          r13.y = dot(r14.xyz, r13.yzw);
          r13.z = -r12.w * r12.w + lightConstantsCB[r0.y].data[6].y;
          r4.z = r12.w * r13.y + -r4.z;
          r4.z = saturate(r4.z / r13.z);
          r12.w = r13.z / lightConstantsCB[r0.y].data[6].y;
          r12.w = 10 * r12.w;
          r12.w = min(1, r12.w);
          r4.z = r4.z + -r5.w;
          r4.z = r12.w * r4.z + r5.w;
          r2.yzw = r4.zzz * r17.xyz + r2.yzw;
          r2.yzw = r0.zzz ? r2.yzw : lightConstantsCB[r0.y].data[0].xyz;
          r2.yzw = r2.yzw + -r10.xyz;
          r0.z = dot(r2.yzw, r2.yzw);
          r0.z = rsqrt(r0.z);
          r13.yzw = r2.yzw * r0.zzz;
          ...
          r2.yzw = r2.yzw * r0.zzz + r12.xyz;
          r0.z = dot(r2.yzw, r2.yzw);
          r0.z = rsqrt(r0.z);
          r2.yzw = r2.yzw * r0.zzz;
          r0.z = dot(r2.yzw, r12.xyz);
    ...
    if (r2.w != 0) {
      ...
      if (r4.z != 0) {
        ...
        r18.xyz = lightConstantsCB[r0.y].data[0].xyz + -r10.xyz;
        r5.w = lightConstantsCB[r0.y].data[3].x * lightConstantsCB[r0.y].data[3].x;
        r6.w = dot(r18.xyz, r18.xyz);
        r5.w = r5.w / r6.w;
        r5.w = min(1, r5.w);
        r18.xy = saturate(r2.ww * lightConstantsCB[r0.y].data[2].xz + lightConstantsCB[r0.y].data[2].yw);
        r18.zw = r18.xy * r18.xy;
        r18.xy = r18.xy * float2(-2,-2) + float2(3,3);
        r18.xy = r18.zw * r18.xy;
        r5.w = r18.x * r5.w;
        ...
        r18.xy = r18.xy / r2.ww;
        r2.w = cmp(lightConstantsCB[r0.y].data[10].w < 0.00048828125);
        if (r2.w != 0) {
          ...
          r19.xy = exp2(r19.xy);
          r6.w = lightConstantsCB[r0.y].data[12].x * r19.x;
          r7.w = lightConstantsCB[r0.y].data[12].y * r19.y + -1;
          r6.w = lightConstantsCB[r0.y].data[12].y * r19.y + -r6.w;
        ...
        r4.z = r5.w * r2.w;
        r2.w = 255 & (int)lightConstantsCB[r0.y].data[14].w;
        if (r2.w != 0) {
          r18.z = 1;
          r5.w = dot(lightConstantsCB[r0.y].data[13].xyz, r18.xyz);
      ...
      r2.w = cmp(0 < r4.z);
      if (r2.w != 0) {
        if (3 == 0) r2.w = 0; else if (3+27 < 32) {         r2.w = (uint)lightConstantsCB[r0.y].data[1].w << (32-(3 + 27)); r2.w = (uint)r2.w >> (32-3);        } else r2.w = (uint)lightConstantsCB[r0.y].data[1].w >> 27;
        r2.w = cmp((int)r2.w != 1);
        if (r2.w != 0) {
          ...
          if (r6.w != 0) {
            ...
            r5.w = 0x0000ffff & (int)lightConstantsCB[r0.y].data[1].w;
            if (enableDitheredShadow != 0) {
              r17.x = -r3.x;
              r19.z = (uint)r5.w;
              r17.y = r13.x;
        ...
        r4.z = cmp(0 < r2.w);
        if (r4.z != 0) {
          r4.z = lightConstantsCB[r0.y].data[1].z * r0.w;
          r4.z = r4.z * r2.z;
          if (4 == 0) r5.w = 0; else if (4+16 < 32) {           r5.w = (uint)lightConstantsCB[r0.y].data[1].w << (32-(4 + 16)); r5.w = (uint)r5.w >> (32-4);          } else r5.w = (uint)lightConstantsCB[r0.y].data[1].w >> 16;
            ...
            if (r5.w != 0) {
              ...
              if (r7.w == 0) {
                ...
                if (r8.w == 0) {
                  ...
                  r18.x = r17.x * lightConstantsCB[r0.y].data[8].y + lightConstantsCB[r0.y].data[8].z;
                  r18.y = r17.y * lightConstantsCB[r0.y].data[8].w + lightConstantsCB[r0.y].data[9].x;
                  r9.z = lightConstantsCB[r0.y].data[10].z * r6.w;
                  r5.w = lightConstantsCB[r0.y].data[10].y * r6.w + r5.w;
                  r5.w = r5.w / r9.z;
                }
              } else {
                r8.w = -1;
              ...
              if (r6.w == 0) {
                r5.w = max(6.10351563e-05, r5.w);
                r6.w = 0x0000ffff & (int)lightConstantsCB[r0.y].data[1].w;
                if (enableDitheredShadow != 0) {
                  r17.x = -r3.x;
                  r19.z = (uint)r6.w;
                  r17.y = r13.x;
          ...
          r0.y = r0.y * r2.w;
          r1.z = cmp(0 < r2.y);
          r17.xyz = r0.yyy * r13.yzw + r16.xyz;
          r14.xyz = r14.xyz * r0.zzz + r12.xyz;
          r0.y = dot(r14.xyz, r14.xyz);
          r0.y = rsqrt(r0.y);
          r14.xyz = r14.xyz * r0.yyy;
          r0.y = dot(r14.xyz, r12.xyz);
          r0.z = dot(r11.xyz, r14.xyz);
          r0.w = abs(r0.z) * r0.w + -abs(r0.z);
          r0.z = abs(r0.z) * r0.w + 1;
          r0.x = r2.z * r0.x + r1.w;
          r0.z = r0.z * r0.z;
          r0.x = r0.z * r0.x;
          r0.x = rcp(r0.x);
