...
rsq r2.w, r2.w
sample_indexable(texture2d)(float,float,float,float) r7.xyz, r0.xyxx, t17.xyzw, s2
mul r2.xyz, r2.xyzx, r7.xyzx
mul r2.xyz, r2.xyzx, v8.xyzx
sample_indexable(texture2d)(float,float,float,float) r3.w, r0.xyxx, t19.yzwx, s3
mad r1.w, r3.w, r1.w, cb0[12].x
mul_sat r1.w, r1.w, l(0.05882353)
sample_indexable(texture2d)(float,float,float,float) r7.xyz, r0.xyxx, t18.xyzw, s4
add r7.xyz, r7.xyzx, l(-0.500000, -0.500000, -0.000000, 0.000000)
mad r7.xyz, cb0[11].wwww, r7.xyzx, l(0.500000, 0.500000, 0.000000, 0.000000)
...
mad r1.xyz, r1.xyzx, v8.xyzx, -r2.xyzx
mad r1.xyz, r0.yyyy, r1.xyzx, r2.xyzx
add r0.w, r0.w, -r1.w
mad r0.w, r0.y, r0.w, r1.w
min r5.z, r0.z, l(1.000000)
mad r2.xyz, r3.xyzx, r2.wwww, -r4.xyzx
...
dp2 r4.y, r2.xzxx, r1.yzyy
dp3 r0.z, r2.xyzx, r3.xyzx
add r0.z, |r0.z|, l(1.000000)
rsq r0.z, r0.z
mul r1.yz, r0.zzzz, r4.xxyx
mad r2.xy, r1.yzyy, l(0.58823532, 0.58823532, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
...
mov r5.xyw, l(0.040000,0.500000,0,1.000000)
