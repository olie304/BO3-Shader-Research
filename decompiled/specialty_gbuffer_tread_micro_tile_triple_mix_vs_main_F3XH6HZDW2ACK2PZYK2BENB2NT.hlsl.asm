...
//   float2 mixScale;                   // Offset:  248 Size:     8 [unused]
//   float detailScaleHeight1;          // Offset:  256 Size:     4 [unused]
//   float detailScaleHeight2;          // Offset:  260 Size:     4 [unused]
//   float4 colorTint;                  // Offset:  272 Size:    16 [unused]
//   float4 colorTint1;                 // Offset:  288 Size:    16 [unused]
//   float2 glossRange2;                // Offset:  304 Size:     8 [unused]
//   float rotateUVs1;                  // Offset:  312 Size:     4 [unused]
//   float rotateUVs2;                  // Offset:  316 Size:     4 [unused]
//   bool useUVOffsets1;                // Offset:  320 Size:     4 [unused]
//   bool useUVOffsets2;                // Offset:  324 Size:     4 [unused]
//   float detailScaleHeight3;          // Offset:  328 Size:     4 [unused]
//   float4 colorTint2;                 // Offset:  336 Size:    16 [unused]
//   float2 glossRange3;                // Offset:  352 Size:     8 [unused]
//   float rotateUVs3;                  // Offset:  360 Size:     4 [unused]
//   bool useUVOffsets3;                // Offset:  364 Size:     4 [unused]
//   float4 specColorTint1;             // Offset:  368 Size:    16 [unused]
//   float4 specColorTint2;             // Offset:  384 Size:    16 [unused]
//
// }
//
...
dp3 r6.z, r0.xyzx, r7.xyzx
dp3 r0.x, r6.xyzx, r6.xyzx
rsq r0.x, r0.x
mul o3.xyz, r0.xxxx, r6.xyzx
...
mul r3.xyzw, r3.wwww, cb1[9].xyzw
mad r1.xyzw, r1.wwww, cb1[8].xyzw, r3.xyzw
mad r1.xyzw, r4.xxxx, cb1[10].xyzw, r1.xyzw
...
mad o1.yz, r0.xxxx, cb0[12].xxyx, v2.xxyx
mov o1.x, v1.w
ret 
