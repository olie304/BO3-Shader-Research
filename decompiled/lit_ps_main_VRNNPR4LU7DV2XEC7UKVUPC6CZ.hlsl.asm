...
sample_indexable(texture2d)(float,float,float,float) r2.x, v2.xyxx, t22.xyzw, s3
...
mul r3.x, r3.x, r3.x
mul r3.x, r3.x, r3.y
mul r3.yzw, r4.xxyz, cb0[13].xxxx
mad r4.xyz, -r4.xyzx, cb0[13].xxxx, r4.xyzx
...
ret 
// Approximately 1946 instruction slots used
