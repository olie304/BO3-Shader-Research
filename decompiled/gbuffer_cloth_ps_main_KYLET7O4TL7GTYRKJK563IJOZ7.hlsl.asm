...
sample_indexable(texture2d)(float,float,float,float) r1.y, v2.xyxx, t9.yxzw, s4
...
add r2.xzw, -r0.xxyz, cb1[58].xxyz
mad r0.xyz, cb1[58].wwww, r2.xzwx, r0.xyzx
mad r0.w, -r0.w, v1.w, cb1[59].x
mad_sat r0.w, cb1[59].w, r0.w, r1.x
...
mad o2.z, cb1[63].w, r1.z, r1.y
movc r1.yzw, v8.xxxx, v3.xxyz, -v3.xxyz
...
sample_indexable(texture2d)(float,float,float,float) r1.yz, r1.yzyy, t17.zxyw, s7
...
mad r1.yzw, r1.zzzz, r7.xxyz, r6.xxyz
add r1.yzw, r1.yyzw, l(0.000000, -1.000000, -1.000000, -1.000000)
mad r1.yzw, r0.wwww, r1.yyzw, l(0.000000, 1.000000, 1.000000, 1.000000)
mul r6.xyz, r0.xyzx, r1.yzwy
sample_indexable(texture2d)(float,float,float,float) r0.w, v2.xyxx, t16.yzwx, s6
mul r4.w, r0.w, cb0[11].w
lt r4.w, l(0.000000), r4.w
mul r5.z, r1.x, l(17.000000)
exp r5.z, r5.z
...
mad r0.xyz, r0.xyzx, r1.yzwy, -r2.xzwx
mad r0.xyz, r5.zzzz, r0.xyzx, r2.xzwx
mul r1.yzw, r0.wwww, r6.xxyz
movc o0.xyz, r4.wwww, r1.yzwy, r6.xyzx
movc r0.xyz, r4.wwww, r0.xyzx, r2.xzwx
...
add r0.w, r5.y, r5.x
mad r0.w, r4.z, r2.y, r0.w
mul r0.w, r0.w, l(0.500000)
mad r2.xyz, r4.xyzx, r2.yyyy, -r0.wwww
max r1.w, r2.z, r2.y
max r1.w, r1.w, r2.x
max r0.w, r0.w, r1.w
eq r1.w, r0.w, r2.x
