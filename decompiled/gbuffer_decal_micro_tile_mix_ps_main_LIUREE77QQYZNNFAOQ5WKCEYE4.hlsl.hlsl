  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r4.yzw = colorMapDetail2.Sample(colorSampler_s, r2.yz).xyz;
  ...
  r2.z = r4.z * r2.z;
  r5.y = exp2(r2.z);
  r4.yz = saturate(alphaRevealSoftEdge * r5.xy + r4.yy);
  r2.y = -r4.y + r2.y;
  r2.z = r4.z + -r4.y;
  r2.y = saturate(r2.y / r2.z);
  r2.z = glossRange.y + -glossRange.x;
  r3.w = r3.w * r2.z + glossRange.x;
  r3.w = saturate(0.0588235296 * r3.w);
  r4.y = glossRange2.y + -glossRange2.x;
  r1.w = r1.w * r4.y + glossRange2.x;
  ...
  if (r1.z != 0) {
    ...
    r2.xzw = r2.xxx ? r5.xyz : r4.xyw;
    r4.xyz = r4.zzz ? float3(0,1,0) : r3.xyz;
    r3.xyz = r1.www ? r2.xzw : r4.xyz;
  }
