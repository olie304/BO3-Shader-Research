...
Texture2D<float4> tImg0 : register(t0);
Texture2D<float4> tImg1 : register(t1);
Texture2D<float4> tImg2 : register(t2);
Texture2D<float4> tImg3 : register(t3);
  ...
  out float3 o0 : SV_TARGET0)
{
  ...
  r0.xyz = tImg1.Sample(pointClamp_s, v0.xy).xyz;
  r0.xyz = postFxControl0.yyy * r0.xyz;
  r1.xyz = tImg0.Sample(pointClamp_s, v0.xy).xyz;
  r0.xyz = r1.xyz * postFxControl0.xxx + r0.xyz;
  r0.w = tImg2.Sample(pointClamp_s, v0.xy).x;
  r0.xyz = r0.www * postFxControl0.zzz + r0.xyz;
  r0.w = tImg3.Sample(pointClamp_s, v0.xy).x;
  o0.xyz = r0.www * postFxControl0.www + r0.xyz;
  return;
}