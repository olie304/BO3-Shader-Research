...
r0.y = samp0[]..swiz;
  ...
  while (true) {
    ...
    if (r4.w == 0) r10.w = 0; else if (r4.w+0 < 32) {     r10.w = (uint)r7.w << (32-(r4.w + 0)); r10.w = (uint)r10.w >> (32-r4.w);    } else r10.w = (uint)r7.w >> 0;
    r7.w = r8.w ? r10.w : r7.w;
    r8.w = (int)r3.w + (int)r6.w;
    r12.xyz = r13.xyz;
    r16.xyz = r14.xyz;
    r17.xyz = r15.xyz;
    r10.w = r5.w;
          ...
          r23.w = samp0[]..swiz;
            ...
            r20.w = samp0[]..swiz;
              ...
              if (r19.y != 0) {
                ...
                r19.xyz = r22.xyz * r15.www + r19.xyz;
                r15.w = dot(r19.xyz, r19.xyz);
                r15.w = rsqrt(r15.w);
                r19.xyz = r19.xyz * r15.www;
                r15.w = 1 + -r14.w;
                r20.xyz = r16.xyz * r15.www;
                r16.xyz = r19.xyz * r14.www + r20.xyz;
              }
              r15.w = 1 + -r14.w;
              r19.xyz = r15.www * r12.xyz;
              r12.xyz = r18.xyz * r14.www + r19.xyz;
              r18.xyz = r17.xyz * r15.www;
              r17.xyz = r27.xyz * r14.www + r18.xyz;
              r10.w = r10.w * r15.w + r14.w;
              r15.w = r15.w * r11.z;
              r11.z = r13.w * r14.w + r15.w;
            }
          }
        }
      }
  ...
  r0.x = saturate(r0.x);
  r0.x = hdrScale * r0.x;
  r11.xyz = cmp(r0.yyy == float3(3,2,1));
  r0.y = cmp(r0.y < 0);
  r12.xyz = r0.yyy ? float3(1,1,1) : emissiveTint1.xyz;
  r12.xyz = r11.zzz ? tint1.xyz : r12.xyz;
  ...
  while (true) {
    ...
    bitmask.w = ((~(-1 << r7.z)) << 0) & 0xffffffff;  r11.w = (((uint)0 << 0) & bitmask.w) | ((uint)r11.y & ~bitmask.w);
    r11.y = r11.z ? r11.w : r11.y;
    r11.z = cmp((int)r7.w == (int)r10.w);
    if (r8.w == 0) r11.w = 0; else if (r8.w+0 < 32) {     r11.w = (uint)r11.y << (32-(r8.w + 0)); r11.w = (uint)r11.w >> (32-r8.w);    } else r11.w = (uint)r11.y >> 0;
    r11.y = r11.z ? r11.w : r11.y;
  ...
  if (r7.w != 0) {
    ...
    r8.w = 0;
    while (true) {
      r10.w = cmp((uint)r8.w >= (uint)r5.w);
      if (r10.w != 0) break;
      r14.z = (uint)r8.w >> 5;
      r15.xyz = (int3)r10.xyz + (int3)r14.xyz;
      r10.w = visibleProbes.Load(r15.xyzw).x;
      r12.w = cmp((int)r6.w == (int)r8.w);
      if (r7.z == 0) r14.z = 0; else if (r7.z+0 < 32) {       r14.z = (uint)r10.w << (32-(r7.z + 0)); r14.z = (uint)r14.z >> (32-r7.z);      } else r14.z = (uint)r10.w >> 0;
  ...
  r14.xyz = r21.xyz * r4.yyy;
  r11.yzw = r22.xyz * r4.yyy;
  ...
  if (r4.w != 0) {
    ...
    r14.xyz = r21.xyz * r4.yyy + r15.xyz;
    r13.w = 0;
    r15.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r13.xyzw, r4.z).xyz;
    r4.y = sunConstants.globalProbeExposure * r4.w + -r2.w;
    r2.w = r7.y * r4.y + r2.w;
    r11.yzw = r15.xyz * r2.www + r11.yzw;
  }
  r4.yz = r7.xy * float2(0.984375,0.984375) + float2(0.0078125,0.0078125);
  r4.yz = gEnvBRDFGeneric.SampleLevel(samplerLinear_s, r4.yz, 0).xy;
  r15.xyz = r11.zwy * r4.yyy;
  ...
  if (r7.y != 0) {
    r7.y = cmp(0 < r7.z);
    if (r7.y != 0) {
      r7.y = sunConstants.specScale * r0.w;
      r7.y = r7.y * r6.w;
      ...
      r6.w = r7.z * r6.w;
      r6.w = 0.25 * r6.w;
      r7.yzw = r6.www * r9.xyz + r4.yzw;
      r0.y = saturate(1 + -r0.y);
      r8.w = r0.y * r0.y;
      r8.w = r8.w * r8.w;
      r0.y = r8.w * r0.y;
      r0.y = r6.w * r0.y;
      r9.xyz = r0.yyy * r9.yzx + r15.xyz;
      r16.w = r9.z;
      r14.w = r15.z;
  ...
  r0.xyw = r28.xyz * r8.xyz + r0.xyw;
  r0.xyw = r11.yzw * r1.xyz + r0.xyw;
