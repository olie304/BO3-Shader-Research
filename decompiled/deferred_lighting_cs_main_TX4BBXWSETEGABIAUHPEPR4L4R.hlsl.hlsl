...
r0.y = samp0[]..swiz;
  ...
  if (r10.w != 0) {
    ...
    r13.yzw = -refProbeConstantsCB[r10.w].data[0].xyz + r11.xyz;
    r14.y = 0x0000ffff & (int)refProbeConstantsCB[r10.w].data[7].z;
    if (6 == 0) r14.z = 0; else if (6+25 < 32) {     r14.z = (uint)refProbeConstantsCB[r10.w].data[7].z << (32-(6 + 25)); r14.z = (uint)r14.z >> (32-6);    } else r14.z = (uint)refProbeConstantsCB[r10.w].data[7].z >> 25;
    r14.w = (int)r14.y * 6;
    r16.x = dot(refProbeAttenuationConstantsCB[r14.w].data[0].xyz, r13.yzw);
    r16.x = saturate(refProbeAttenuationConstantsCB[r14.w].data[0].w + r16.x);
    r16.y = dot(refProbeAttenuationConstantsCB[r14.w].data[1].xyz, r13.yzw);
    r16.y = saturate(refProbeAttenuationConstantsCB[r14.w].data[1].w + r16.y);
    r16.x = r16.x * r16.y;
    r16.y = dot(refProbeAttenuationConstantsCB[r14.w].data[2].xyz, r13.yzw);
    r16.y = saturate(refProbeAttenuationConstantsCB[r14.w].data[2].w + r16.y);
    r16.x = r16.x * r16.y;
    r16.y = dot(refProbeAttenuationConstantsCB[r14.w].data[3].xyz, r13.yzw);
    r16.y = saturate(refProbeAttenuationConstantsCB[r14.w].data[3].w + r16.y);
    r16.x = r16.x * r16.y;
    r16.y = dot(refProbeAttenuationConstantsCB[r14.w].data[4].xyz, r13.yzw);
    r16.y = saturate(refProbeAttenuationConstantsCB[r14.w].data[4].w + r16.y);
    r16.x = r16.x * r16.y;
    r16.y = dot(refProbeAttenuationConstantsCB[r14.w].data[5].xyz, r13.yzw);
    r14.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[5].w + r16.y);
    r16.x = r16.x * r14.w;
    r14.w = 1 & (int)refProbeConstantsCB[r10.w].data[6].x;
    r16.yz = float2(0,1);
    r16.xy = r14.ww ? r16.xy : r16.zx;
    r17.x = 1;
    r14.w = refProbeConstantsCB[r10.w].data[6].x;
    r18.xy = r16.xy;
    r16.z = 1;
    while (true) {
      r16.w = cmp((int)r16.z >= (int)r14.z);
      if (r16.w != 0) break;
      r16.w = (int)r14.y + (int)r16.z;
      r16.w = (int)r16.w * 6;
    ...
    r14.y = refProbeConstantsCB[r10.w].data[6].y * r18.y;
    r14.z = cmp(0 < r14.y);
    if (r14.z != 0) {
      if (r2.w != 0) {
      // Known bad code for instruction (needs manual fix):
      ...
      r14.z = refProbeConstantsCB[r10.w].data[7].y * r14.y;
      r16.x = refProbeConstantsCB[r10.w].data[7].w;
      r16.yz = refProbeConstantsCB[r10.w].data[8].xy;
      r14.w = dot(r15.xyz, r16.xyz);
      r16.x = dot(r13.yzw, r16.xyz);
      r16.x = -refProbeConstantsCB[r10.w].data[8].z + r16.x;
      r16.y = cmp(r16.x >= 0);
      ...
      r16.x = refProbeConstantsCB[r10.w].data[8].w;
      r16.yz = refProbeConstantsCB[r10.w].data[9].xy;
      r16.w = dot(r15.xyz, r16.xyz);
      r16.x = dot(r13.yzw, r16.xyz);
      r16.x = -refProbeConstantsCB[r10.w].data[9].z + r16.x;
      r16.y = cmp(r16.x >= 0);
      r16.x = max(abs(r16.x), r7.w);
      r16.x = r16.y ? r16.x : -r16.x;
      ...
      r16.x = refProbeConstantsCB[r10.w].data[9].w;
      r16.yz = refProbeConstantsCB[r10.w].data[10].xy;
      r16.w = dot(r15.xyz, r16.xyz);
      r16.x = dot(r13.yzw, r16.xyz);
      r16.x = -refProbeConstantsCB[r10.w].data[10].z + r16.x;
      r16.y = cmp(r16.x >= 0);
      r16.x = max(abs(r16.x), r7.w);
      r16.x = r16.y ? r16.x : -r16.x;
      r16.y = max(1.00000001e-07, -r16.w);
      r16.x = r16.x / r16.y;
      r14.w = min(abs(r16.x), r14.w);
      r16.x = refProbeConstantsCB[r10.w].data[10].w;
      r16.yz = refProbeConstantsCB[r10.w].data[11].xy;
      r16.w = dot(r15.xyz, r16.xyz);
      r16.x = dot(r13.yzw, r16.xyz);
      r16.x = -refProbeConstantsCB[r10.w].data[11].z + r16.x;
      r16.y = cmp(r16.x >= 0);
      r16.x = max(abs(r16.x), r7.w);
      r16.x = r16.y ? r16.x : -r16.x;
      r16.y = max(1.00000001e-07, -r16.w);
      r16.x = r16.x / r16.y;
      r14.w = min(abs(r16.x), r14.w);
      r16.x = refProbeConstantsCB[r10.w].data[11].w;
      r16.yz = refProbeConstantsCB[r10.w].data[12].xy;
      r16.w = dot(r15.xyz, r16.xyz);
      r16.x = dot(r13.yzw, r16.xyz);
      r16.x = -refProbeConstantsCB[r10.w].data[12].z + r16.x;
      r16.y = cmp(r16.x >= 0);
      r16.x = max(abs(r16.x), r7.w);
      r16.x = r16.y ? r16.x : -r16.x;
      r16.y = max(1.00000001e-07, -r16.w);
      r16.x = r16.x / r16.y;
      r14.w = min(abs(r16.x), r14.w);
      r16.x = refProbeConstantsCB[r10.w].data[12].w;
      r16.yz = refProbeConstantsCB[r10.w].data[13].xy;
      r16.w = dot(r15.xyz, r16.xyz);
      r16.x = dot(r13.yzw, r16.xyz);
      r16.x = -refProbeConstantsCB[r10.w].data[13].z + r16.x;
      r16.y = cmp(r16.x >= 0);
      r16.x = max(abs(r16.x), r7.w);
      r16.x = r16.y ? r16.x : -r16.x;
      r16.y = max(1.00000001e-07, -r16.w);
      r16.x = r16.x / r16.y;
      r14.w = min(abs(r16.x), r14.w);
      r16.x = refProbeConstantsCB[r10.w].data[3].w + r13.y;
      r16.yz = refProbeConstantsCB[r10.w].data[4].xy + r13.zw;
      r16.xyz = r15.xyz * r14.www + r16.xyz;
      ...
      r17.x = refProbeConstantsCB[r10.w].data[0].w;
      r17.y = refProbeConstantsCB[r10.w].data[1].z;
      r17.z = refProbeConstantsCB[r10.w].data[2].y;
      r18.x = dot(r16.xyz, r17.xyz);
      r19.xy = refProbeConstantsCB[r10.w].data[1].xw;
      r19.z = refProbeConstantsCB[r10.w].data[2].z;
      r18.y = dot(r16.xyz, r19.xyz);
      r20.x = refProbeConstantsCB[r10.w].data[1].y;
      r20.yz = refProbeConstantsCB[r10.w].data[2].xw;
      r18.z = dot(r16.xyz, r20.xyz);
      if (9 == 0) r16.x = 0; else if (9+16 < 32) {       r16.x = (uint)refProbeConstantsCB[r10.w].data[7].z << (32-(9 + 16)); r16.x = (uint)r16.x >> (32-9);      } else r16.x = (uint)refProbeConstantsCB[r10.w].data[7].z >> 16;
      r18.w = (uint)r16.x;
      r16.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r18.xyzw, r14.w).xyz;
      ...
      r14.w = (int)r21.z | (int)r14.w;
      r16.xyz = r14.www ? float3(1,1,0) : r16.xyz;
      r21.x = dot(r13.yzw, r17.xyz);
      r21.y = dot(r13.yzw, r19.xyz);
      r21.z = dot(r13.yzw, r20.xyz);
      r13.yzw = saturate(r21.xyz * refProbeConstantsCB[r10.w].data[3].xyz + float3(0.5,0.5,0.5));
      r21.xy = refProbeConstantsCB[r10.w].data[4].zw * r13.yz;
      r21.z = refProbeConstantsCB[r10.w].data[5].x * r13.w;
      r13.yzw = refProbeConstantsCB[r10.w].data[5].yzw + r21.xyz;
      ...
      r10.w = (int)r18.y | (int)r18.x;
      r10.w = (int)r18.z | (int)r10.w;
      r17.xyz = r10.www ? float3(1,1,0) : r17.xyz;
  ...
  if (r9.w != 0) {
    ...
    r14.z = 0x0000ffff & (int)refProbeConstantsCB[r0.x].data[7].z;
    if (6 == 0) r14.w = 0; else if (6+25 < 32) {     r14.w = (uint)refProbeConstantsCB[r0.x].data[7].z << (32-(6 + 25)); r14.w = (uint)r14.w >> (32-6);    } else r14.w = (uint)refProbeConstantsCB[r0.x].data[7].z >> 25;
    r16.w = (int)r14.z * 6;
    ...
    r14.z = saturate(r20.y + -r14.y);
    r14.w = refProbeConstantsCB[r0.x].data[6].y * r14.z;
    r16.w = cmp(0 < r14.w);
    if (r16.w != 0) {
      r16.w = (int)r9.w & 3;
      r17.w = (int)r16.w + -1;
      ...
      r9.w = (int)r10.w + 257;
      r14.z = r14.z * refProbeConstantsCB[r0.x].data[6].y + r14.y;
      r14.w = refProbeConstantsCB[r0.x].data[7].y * r14.w;
      r18.x = refProbeConstantsCB[r0.x].data[7].w;
      r18.yz = refProbeConstantsCB[r0.x].data[8].xy;
      r16.w = dot(r15.xyz, r18.xyz);
      ...
      r18.y = cmp(r18.x >= 0);
      r7.w = max(abs(r18.x), r7.w);
      r7.w = r18.y ? r7.w : -r7.w;
      r17.w = max(1.00000001e-07, -r17.w);
      r7.w = r7.w / r17.w;
      r7.w = min(r16.w, abs(r7.w));
      r18.x = refProbeConstantsCB[r0.x].data[3].w + r17.x;
      r18.yz = refProbeConstantsCB[r0.x].data[4].xy + r17.yz;
      r18.xyz = r15.xyz * r7.www + r18.xyz;
      ...
      if (9 == 0) r7.w = 0; else if (9+16 < 32) {       r7.w = (uint)refProbeConstantsCB[r0.x].data[7].z << (32-(9 + 16)); r7.w = (uint)r7.w >> (32-9);      } else r7.w = (uint)refProbeConstantsCB[r0.x].data[7].z >> 16;
      r20.w = (uint)r7.w;
      r18.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r20.xyzw, r3.w).xyz;
      r23.xyz = (int3)r18.xyz & int3(-2147483648,-2147483648,-2147483648);
      r23.xyz = cmp((int3)r23.xyz == int3(2139095040,2139095040,2139095040));
      r3.w = (int)r23.y | (int)r23.x;
      r3.w = (int)r23.z | (int)r3.w;
      r18.xyz = r3.www ? float3(1,1,0) : r18.xyz;
      ...
      r13.yzw = r17.xyz * r19.xyz + r13.yzw;
      r3.w = r8.w * r0.x;
      r17.xyz = r18.xyz * r14.www;
  ...
  r0.x = cmp(r14.y >= 1);
  bitmask.w = ((~(-1 << 8)) << 0) & 0xffffffff;  r3.w = (((uint)r9.w << 0) & bitmask.w) | ((uint)r10.w & ~bitmask.w);
  r0.x = r0.x ? r3.w : r9.w;
  r3.w = max(1, r14.z);
  r3.w = rcp(r3.w);
  r14.z = saturate(r14.z);
  r17.xyz = r13.yzw * r3.www;
  r16.xyz = r16.xyz * r3.www;
  r7.w = cmp(r14.z < 0.99000001);
  if (r7.w != 0) {
    r0.x = (int)r0.x + 256;
    r7.w = 1 + -r14.z;
    ...
    r17.xyz = r13.yzw * r3.www + r14.yzw;
    r15.w = 0;
    ...
    r3.w = r2.y * r3.w + r8.w;
    r16.xyz = r13.yzw * r3.www + r16.xyz;
  }
  r3.w = r2.x + r5.z;
  r3.w = log2(abs(r3.w));
  r3.w = r3.w * r2.z;
  ...
  r14.yzw = r16.xyz * r3.www;
  r16.xyz = r14.zwy * r13.yyy;
  ...
  if (r5.z != 0) {
    ...
    if (r5.z != 0) {
      ...
      r6.w = r6.w * r4.z;
      r3.y = cmp(0 < r3.y);
      r18.xyz = r6.www * r14.yzw + r17.xyz;
      r19.xyz = -r11.xyz * r1.zzz + sunConstants.wldDir.xyz;
      r1.z = dot(r19.xyz, r19.xyz);
      r1.z = rsqrt(r1.z);
      r19.xyz = r19.xyz * r1.zzz;
      r1.z = dot(r19.xyz, r5.xyw);
      ...
      r3.z = r4.z * r3.z;
      r3.z = 0.25 * r3.z;
      r19.xyz = r3.zzz * r14.yzw + r13.yzw;
      r1.z = saturate(1 + -r1.z);
      r5.z = r1.z * r1.z;
      r5.z = r5.z * r5.z;
      r1.z = r5.z * r1.z;
      r1.z = r3.z * r1.z;
      r20.xyz = r1.zzz * r14.zwy + r16.xyz;
      r18.w = r20.z;
      r17.w = r16.z;
      r17.xyzw = r3.yyyy ? r18.xyzw : r17.xyzw;
      r20.zw = r19.xy;
      r16.zw = r13.yz;
      r18.xyzw = r3.yyyy ? r20.xyzw : r16.xyzw;
      r13.w = r3.y ? r19.z : r13.w;
      if (r2.w != 0) {
      // Known bad code for instruction (needs manual fix):
  ...
  switch (r3.y) {
    ...
    r14.yzw = -r18.xyz * float3(0.5,0.5,0.5) + lightConstantsCB[r0.y].data[0].xyz;
    r19.xyz = r14.yzw + -r11.xyz;
    r4.z = dot(r18.xyz, r19.xyz);
    r5.z = saturate(-r4.z / lightConstantsCB[r0.y].data[6].y);
    r20.xyz = r5.zzz * r18.xyz + r14.yzw;
    r20.xyz = r3.zzz ? r20.xyz : lightConstantsCB[r0.y].data[0].xyz;
    ...
    if (r9.w != 0) {
      ...
      r6.w = r10.w / r6.w;
      r6.w = min(1, r6.w);
      r20.xy = saturate(r9.ww * lightConstantsCB[r0.y].data[2].xz + lightConstantsCB[r0.y].data[2].yw);
      ...
      r9.w = cmp(0 < r6.w);
      if (r9.w != 0) {
        if (3 == 0) r9.w = 0; else if (3+27 < 32) {         r9.w = (uint)lightConstantsCB[r0.y].data[1].w << (32-(3 + 27)); r9.w = (uint)r9.w >> (32-3);        } else r9.w = (uint)lightConstantsCB[r0.y].data[1].w >> 27;
        if (r2.w != 0) {
        // Known bad code for instruction (needs manual fix):
        ...
        if (r9.w != 0) {
          ...
          r9.w = lightConstantsCB[r0.y].data[5].x / r9.w;
          r9.w = lightConstantsCB[r0.y].data[5].y + r9.w;
        ...
        if (r9.w != 0) {
          ...
          r15.y = -r12.w * r12.w + lightConstantsCB[r0.y].data[6].y;
          r4.z = r12.w * r15.x + -r4.z;
          r4.z = saturate(r4.z / r15.y);
          r12.w = r15.y / lightConstantsCB[r0.y].data[6].y;
          r12.w = 10 * r12.w;
          r12.w = min(1, r12.w);
          r4.z = r4.z + -r5.z;
          r4.z = r12.w * r4.z + r5.z;
          r14.yzw = r4.zzz * r18.xyz + r14.yzw;
          r14.yzw = r3.zzz ? r14.yzw : lightConstantsCB[r0.y].data[0].xyz;
          ...
          r5.z = cmp(0 < r7.w);
          r19.xyz = r4.zzz * r18.xyz + r17.xyz;
          r4.z = saturate(dot(r12.xyz, r15.xyz));
          r14.yzw = r14.yzw * r3.zzz + r5.xyw;
          r3.z = dot(r14.yzw, r14.yzw);
          r3.z = rsqrt(r3.z);
          r14.yzw = r14.yzw * r3.zzz;
          r3.z = dot(r14.yzw, r5.xyw);
          ...
          r4.z = r7.w * r4.z;
          r4.z = r4.z * r6.w;
          r14.yzw = r4.zzz * r18.xyz + r13.yzw;
          r3.z = saturate(1 + -r3.z);
          r7.w = r3.z * r3.z;
          r7.w = r7.w * r7.w;
          r3.z = r7.w * r3.z;
          r3.z = r4.z * r3.z;
          r15.xyz = r3.zzz * r18.xyz + r16.zxy;
          r17.xyz = r5.zzz ? r19.xyz : r17.xyz;
          r16.xyz = r5.zzz ? r15.yzx : r16.xyz;
          r13.yzw = r5.zzz ? r14.yzw : r13.yzw;
          if (r2.w != 0) {
          // Known bad code for instruction (needs manual fix):
    ...
    r3.z = rsqrt(r3.z);
    r14.yzw = r15.xyz * r3.zzz;
    r4.z = dot(r12.xyz, r14.yzw);
    r5.z = saturate(r4.z);
    r6.w = cmp(0 < r5.z);
    if (r6.w != 0) {
      ...
      if (r7.w != 0) {
        ...
        r19.xyz = lightConstantsCB[r0.y].data[0].xyz + -r11.xyz;
        r8.w = lightConstantsCB[r0.y].data[3].x * lightConstantsCB[r0.y].data[3].x;
        r9.w = dot(r19.xyz, r19.xyz);
        r8.w = r8.w / r9.w;
        r8.w = min(1, r8.w);
        r19.xy = saturate(r6.ww * lightConstantsCB[r0.y].data[2].xz + lightConstantsCB[r0.y].data[2].yw);
        ...
        if (r6.w != 0) {
          ...
          r20.xy = exp2(r20.xy);
          r9.w = lightConstantsCB[r0.y].data[12].x * r20.x;
          r10.w = lightConstantsCB[r0.y].data[12].y * r20.y + -1;
          r9.w = lightConstantsCB[r0.y].data[12].y * r20.y + -r9.w;
      ...
      if (r6.w != 0) {
        ...
        if (r6.w != 0) {
          ...
          if (r10.w != 0) {
            ...
            r19.x = r18.x * lightConstantsCB[r0.y].data[8].y + lightConstantsCB[r0.y].data[8].z;
            r19.y = r18.y * lightConstantsCB[r0.y].data[8].w + lightConstantsCB[r0.y].data[9].x;
            r6.w = r6.w / r9.w;
            r6.w = max(6.10351563e-05, r6.w);
            r9.w = 0x0000ffff & (int)lightConstantsCB[r0.y].data[1].w;
            if (enableDitheredShadow != 0) {
              r18.x = -r13.x;
              r20.z = (uint)r9.w;
              r18.y = r14.x;
        ...
        r7.w = cmp(0 < r6.w);
        if (r7.w != 0) {
          r7.w = lightConstantsCB[r0.y].data[1].z * r1.w;
          r7.w = r7.w * r5.z;
          if (4 == 0) r9.w = 0; else if (4+16 < 32) {           r9.w = (uint)lightConstantsCB[r0.y].data[1].w << (32-(4 + 16)); r9.w = (uint)r9.w >> (32-4);          } else r9.w = (uint)lightConstantsCB[r0.y].data[1].w >> 16;
          ...
          if (r10.w != 0) {
            ...
            r9.w = cmp(0 < (uint)r0.y);
            r3.x = ~(int)r3.x;
            r3.x = r3.x ? r9.w : 0;
            if (r3.x != 0) {
              r0.y = (int)r0.y + numLights;
              r0.y = mad((int)r0.y, 15, -15);
              r3.x = abs(r4.z) * -0.200000003 + 0.400000006;
              ...
              if (r10.w == 0) {
                ...
                r18.xy = r19.xy / r9.ww;
                r18.xy = r18.xy * float2(0.5,-0.5) + float2(0.5,0.5);
                r19.x = lightConstantsCB[r0.y].data[9].w + r18.x;
                r19.y = lightConstantsCB[r0.y].data[10].x + r18.y;
                r18.xy = lightConstantsCB[r0.y].data[9].yz * r19.xy;
                ...
                if (r11.w == 0) {
                  ...
                  r19.x = r18.x * lightConstantsCB[r0.y].data[8].y + lightConstantsCB[r0.y].data[8].z;
                  r19.y = r18.y * lightConstantsCB[r0.y].data[8].w + lightConstantsCB[r0.y].data[9].x;
                  r12.w = lightConstantsCB[r0.y].data[10].z * r9.w;
                  r3.x = lightConstantsCB[r0.y].data[10].y * r9.w + r3.x;
                  r3.x = r3.x / r12.w;
                }
              } else {
                r11.w = -1;
              ...
              if (r9.w == 0) {
                ...
                if (enableDitheredShadow != 0) {
                  ...
                  r19.z = (uint)r9.w;
                  r10.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r19.xyz, r3.x).x;
                }
                r0.y = r10.w * r10.w;
                r0.y = r0.y * r10.w;
              } else {
          ...
          r0.y = r0.y * r6.w;
          r2.x = cmp(0 < r4.z);
          r18.xyz = r0.yyy * r14.yzw + r17.xyz;
          r15.xyz = r15.xyz * r3.zzz + r5.xyw;
          ...
          r1.w = r6.w * r1.w;
          r1.w = 0.25 * r1.w;
          r3.xzw = r1.www * r14.yzw + r13.yzw;
          r0.y = saturate(1 + -r0.y);
          r2.y = r0.y * r0.y;
          r2.y = r2.y * r2.y;
          r0.y = r2.y * r0.y;
          r0.y = r1.w * r0.y;
          r5.xyz = r0.yyy * r14.yzw + r16.zxy;
          r17.xyz = r2.xxx ? r18.xyz : r17.xyz;
          r16.xyz = r2.xxx ? r5.yzx : r16.xyz;
          r13.yzw = r2.xxx ? r3.xzw : r13.yzw;
          if (r2.w != 0) {
          // Known bad code for instruction (needs manual fix):
  ...
  r2.xyz = r16.zxy * r2.xyz;
  r2.xyz = r13.yzw * r3.xyz + r2.xyz;
  r2.xyz = r17.xyz * r6.xyz + r2.xyz;
