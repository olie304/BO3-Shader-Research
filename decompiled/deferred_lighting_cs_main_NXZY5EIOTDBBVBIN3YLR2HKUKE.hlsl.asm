...
loop 
  ...
  if_nz r16.w
    ...
    add r15.yzw, r5.yyzw, -cb10[r13.w + 0].xxyz
...
loop 
  ieq r17.w, r16.w, l(2)
  breakc_nz r17.w
  movc r17.w, r16.w, r0.y, r13.y
  ult r18.x, r17.w, r12.w
  if_nz r18.x
    imul null, r17.w, r17.w, l(14)
    if_nz r2.w
      and r18.x, r13.w, l(15)
    ...
    add r15.yzw, r5.yyzw, -cb10[r17.w + 0].xxyz
    ...
    loop 
      ...
      dp3 r25.z, cb11[r24.w + 0].xyzx, r15.yzwy
      add_sat r25.z, r25.z, cb11[r24.w + 0].w
      mul r25.z, r25.z, r26.x
      dp3 r25.w, cb11[r24.w + 1].xyzx, r15.yzwy
      add_sat r25.w, r25.w, cb11[r24.w + 1].w
      mul r25.z, r25.w, r25.z
      dp3 r25.w, cb11[r24.w + 2].xyzx, r15.yzwy
      add_sat r25.w, r25.w, cb11[r24.w + 2].w
      mul r25.z, r25.w, r25.z
      dp3 r25.w, cb11[r24.w + 3].xyzx, r15.yzwy
      add_sat r25.w, r25.w, cb11[r24.w + 3].w
      mul r25.z, r25.w, r25.z
      dp3 r25.w, cb11[r24.w + 4].xyzx, r15.yzwy
      add_sat r25.w, r25.w, cb11[r24.w + 4].w
      mul r25.z, r25.w, r25.z
      dp3 r25.w, cb11[r24.w + 5].xyzx, r15.yzwy
    ...
    if_nz r19.w
      ...
      mad r13.z, r16.x, cb10[r17.w + 6].y, r13.z
      ...
      dp3 r19.w, r14.xyzx, r25.xyzx
      dp3 r20.w, r15.yzwy, r25.xyzx
      ...
      div r19.w, r20.w, r19.w
      min r18.w, r18.w, |r19.w|
      add r25.x, r15.y, cb10[r17.w + 3].w
      add r25.yz, r15.zzwz, cb10[r17.w + 4].xxyx
      ...
      mad_sat r15.yzw, r31.xxyz, cb10[r17.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
      mul r31.xy, r15.yzyy, cb10[r17.w + 4].zwzz
      mul r31.z, r15.w, cb10[r17.w + 5].x
      add r15.yzw, r31.xxyz, cb10[r17.w + 5].yyzw
      ...
      or r17.z, r27.y, r27.x
      or r17.z, r27.z, r17.z
      movc r26.xzw, r17.zzzz, l(1.000000,0,1.000000,0), r26.xxzw
...
bfi r6.w, l(8), l(0), r13.w, r22.w
movc r0.y, r0.y, r6.w, r13.w
max r6.w, r13.z, l(1.000000)
rcp r6.w, r6.w
mov_sat r13.z, r13.z
mul r15.xyz, r6.wwww, r23.xyzx
mul r16.xyz, r6.wwww, r24.xyzx
lt r9.w, r13.z, l(0.990000)
if_nz r9.w
  iadd r0.y, r0.y, l(256)
  add r9.w, -r13.z, l(1.000000)
  mul r10.w, r9.w, cb2[19].x
  add r13.yzw, r5.yyzw, -cb2[35].xxyz
  mul r17.x, r13.y, cb2[35].w
  mul r17.yz, r13.zzwz, cb2[36].xxyx
  add_sat r13.yzw, r17.xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
  mul r17.xy, r13.yzyy, cb2[36].zwzz
  mul r17.z, r13.w, cb2[37].x
  add r13.yzw, r17.xxyz, cb2[37].yyzw
  lt r17.xyz, l(0.000000, 0.000000, 0.000000, 0.000000), r11.xyzx
  movc r17.xyz, r17.xyzx, l(0,0,0,0), l(0.500000,0.500000,0.500000,0)
  mov r17.w, l(0)
  add r18.xyz, r13.yzwy, r17.wwxw
  ...
  mad r15.xyz, r23.xyzx, r6.wwww, r13.yzwy
  mov r14.w, l(0)
...
if_nz r2.y
  ...
  if_nz r2.y
    ...
    mad r4.xyw, r15.xyxz, r5.xxxx, r19.xyxz
    mad r15.xyz, -r5.yzwy, r0.wwww, cb2[17].xyzx
    dp3 r0.w, r15.xyzx, r15.xyzx
    rsq r0.w, r0.w
    mul r15.xyz, r0.wwww, r15.xyzx
    dp3 r0.w, r15.xyzx, r12.xyzx
    ...
    mul r0.w, r0.w, r2.y
    mul r0.w, r0.w, r1.w
    mad r12.xyz, r0.wwww, r18.xyzx, r17.xzwx
    mad r15.xyz, r1.zzzz, r18.xyzx, r14.xyzx
    and r15.xyz, r3.zzzz, r15.xyzx
    movc r13.yzw, r2.xxxx, r4.xxyw, r13.yyzw
    movc r14.xyz, r2.xxxx, r14.xyzx, r15.xyzx
    movc r17.xzw, r2.xxxx, r12.xxyz, r17.xxzw
