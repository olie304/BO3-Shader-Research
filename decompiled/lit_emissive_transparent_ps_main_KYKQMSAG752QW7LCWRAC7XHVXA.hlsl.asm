...
//      = 0x00000000 
//   float2 scriptControl;              // Offset:  240 Size:     8 [unused]
//   float3 tint1;                      // Offset:  256 Size:    12
//   float3 tint2;                      // Offset:  272 Size:    12
//   float3 tint3;                      // Offset:  288 Size:    12
//
// }
//
...
mad r3.xyz, r5.xyzx, r3.xxxx, r7.xyzx
...
mad r1.xyz, r1.xyzx, r2.wwww, r14.xyzx
mad r0.z, r0.z, r2.w, r6.w
mad r3.xyz, r3.xyzx, r2.wwww, r15.xyzx
dp3 r3.w, r3.xyzx, r3.xyzx
rsq r3.w, r3.w
mul r3.xyz, r3.wwww, r3.xyzx
mad r8.y, r1.w, r2.w, r7.z
mad r2.xyz, r2.xyzx, r2.wwww, r16.xyzx
mov_sat r0.x, r0.x
mul r0.x, r0.x, cb0[12].w
eq r9.xyz, r0.yyyy, l(3.000000, 2.000000, 1.000000, 0.000000)
lt r0.y, r0.y, l(0.000000)
movc r12.xyz, r0.yyyy, l(1.000000,1.000000,1.000000,0), cb0[13].yzwy
movc r12.xyz, r9.zzzz, cb0[16].xyzx, r12.xyzx
movc r9.yzw, r9.yyyy, cb0[17].xxyz, r12.xxyz
...
exp r1.w, r1.w
movc r1.w, cb0[14].y, r1.w, r5.x
eq r5.x, cb0[13].x, l(0.000000)
movc r1.w, r5.x, l(1.000000), r1.w
mul r0.x, r0.x, r4.w
mul r0.x, r1.w, r0.x
mul r0.x, r2.w, r0.x
...
add r1.w, r1.w, r1.w
mad r13.xyz, r3.xyzx, -r1.wwww, -r12.xyzx
...
loop 
  ...
  ieq r11.w, r7.w, r9.z
  bfi r12.w, r8.z, l(0), l(0), r9.w
  movc r9.w, r11.w, r12.w, r9.w
  ieq r11.w, r8.w, r9.z
  ubfe r12.w, r9.y, l(0), r9.w
  movc r9.w, r11.w, r12.w, r9.w
...
if_nz r5.w
  ...
  mad r9.yzw, r21.xxyz, r5.yyyy, r15.xxyz
  mov r13.w, l(0)
...
if_z r7.w
  ...
  if_nz r8.z
    ...
    loop 
      ...
      breakc_nz r11.w
      ftou r11.w, r8.z
      add r16.xy, r9.yzyy, -cb2[r11.w + 20].xyxx
...
if_nz r7.w
  ...
  if_nz r7.w
    ...
    if_nz r8.w
      ...
      mad r11.w, |r6.z|, l(-0.200000), l(0.400000)
      mad r19.xyz, r3.xyzx, r11.wwww, v7.xyzx
      mov r19.w, l(1.000000)
      dp4 r10.x, r10.xyzw, r19.xyzw
      ...
      add r10.xy, r18.zwzz, r10.xyxx
      mul r10.xy, r18.xyxx, r10.xyxx
      div r10.zw, r8.wwww, r17.xxxz
      add r16.xy, -r10.zwzz, l(1.000000, 1.000000, 0.000000, 0.000000)
      ge r16.xy, r10.xyxx, r16.xyxx
      ge r10.zw, r10.zzzw, r10.xxxy
      or r10.zw, r10.zzzw, r16.xxxy
      ...
      if_z r10.z
        ...
        mad r16.xy, r10.xyxx, r17.xzxx, r17.ywyy
        add r8.z, r18.x, r8.z
        div r8.z, r8.z, r18.y
        ...
        if_nz cb2[58].y
          ...
          loop 
            ige r10.w, r10.z, l(8)
            breakc_nz r10.w
            dp2 r19.x, icb[r10.z + 0].yxyy, r17.xyxx
            dp2 r19.y, icb[r10.z + 0].yxyy, r17.yzyy
            mad r18.xy, r19.xyxx, r8.wwww, r16.xyxx
            sample_c_lz_indexable(texture2darray)(float,float,float,float) r10.w, r18.xyzx, t9.xxxx, s13, r8.z
            mad r10.y, r10.w, l(0.125000), r10.y
            iadd r10.z, r10.z, l(1)
          endloop 
        else 
          utof r16.z, r10.x
          sample_c_lz_indexable(texture2darray)(float,float,float,float) r10.y, r16.xyzx, t9.xxxx, s13, r8.z
        endif 
    ...
    mad r8.yzw, r6.wwww, r9.yyzw, r5.yyzw
    add_sat r0.y, -r0.y, l(1.000000)
    mul r7.w, r0.y, r0.y
    mul r7.w, r7.w, r7.w
    mul r0.y, r0.y, r7.w
    mul r0.y, r0.y, r6.w
    mad r16.xyz, r0.yyyy, r9.zwyz, r14.xyzx
    mov r10.w, r16.z
    mov r15.w, r14.z
    movc r15.xyzw, r6.zzzz, r10.xyzw, r15.xyzw
    mov r16.zw, r8.yyyz
    mov r14.zw, r5.yyyz
    movc r10.xyzw, r6.zzzz, r16.xyzw, r14.xyzw
...
mad r0.xyw, r28.xyxz, r2.xyxz, r0.xyxw
mad r0.xyw, r9.yzyw, r1.xyxz, r0.xyxw
