...
// ------------------------------ ---------- ------- ----------- -------------- ------
// samplerClamp                      sampler      NA          NA             s1      1 
...
lt r1.z, r1.x, l(0.984375)
and r1.y, r1.z, r1.y
mul r1.z, r1.x, l(1.01587307)
max r1.z, r1.z, l(0.00000001)
rcp r1.z, r1.z
mul r1.w, r1.z, v1.x
mul r1.w, r1.w, cb8[15].z
mul r2.x, r1.z, -v1.y
mul r2.x, r2.x, cb8[15].w
mul r2.xyz, r2.xxxx, cb8[1].xyzx
mad r2.xyz, r1.wwww, cb8[0].xyzx, r2.xyzx
mad r2.xyz, r1.zzzz, cb8[2].xyzx, r2.xyzx
add r2.xyz, r2.xyzx, cb8[3].xyzx
add r3.xyz, r2.xyzx, -cb8[16].xyzx
mad r1.zw, r3.xxxy, l(0.000000, 0.000000, 0.00323529, 0.00323529), l(0.000000, 0.000000, 0.500000, 0.500000)
sample_indexable(texture2d)(float,float,float,float) r1.z, r1.zwzz, t6.yzxw, s1
add r4.xyz, r2.xyzx, -cb8[17].xyzx
mad r5.xy, r4.xyxx, l(0.00323529, 0.00323529, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r1.w, r5.xyxx, t6.yzwx, s1
add r5.xyz, r2.xyzx, -cb8[18].xyzx
mad r6.xy, r5.xyxx, l(0.00323529, 0.00323529, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r2.w, r6.xyxx, t6.yzwx, s1
add r6.xyz, r2.xyzx, -cb8[19].xyzx
mad r7.xy, r6.xyxx, l(0.00323529, 0.00323529, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r3.w, r7.xyxx, t6.yzwx, s1
add r7.xyz, r2.xyzx, -cb8[20].xyzx
mad r8.xy, r7.xyxx, l(0.00323529, 0.00323529, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r4.w, r8.xyxx, t6.yzwx, s1
add r8.xyz, r2.xyzx, -cb8[21].xyzx
mad r9.xy, r8.xyxx, l(0.00323529, 0.00323529, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r5.w, r9.xyxx, t6.yzwx, s1
add r9.xyz, r2.xyzx, -cb8[22].xyzx
mad r10.xy, r9.xyxx, l(0.00323529, 0.00323529, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r6.w, r10.xyxx, t6.yzwx, s1
add r2.xyz, r2.xyzx, -cb8[23].xyzx
mad r10.xy, r2.xyxx, l(0.00323529, 0.00323529, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r7.w, r10.xyxx, t6.yzwx, s1
if_nz r1.y
  ld_aoffimmi_indexable(0,-1,0)(texture2d)(float,float,float,float) r1.y, r0.xyww, t0.yxzw
  ld_aoffimmi_indexable(0,1,0)(texture2d)(float,float,float,float) r0.x, r0.xyzw, t0.xyzw
  add r0.y, -r1.y, r1.x
  add r0.x, -r1.x, r0.x
  max r0.x, r0.x, r0.y
  mul_sat r0.x, r0.x, l(100000.000000)
  lt r0.y, l(0.000000), r0.x
  if_nz r0.y
    lt r0.y, l(0.000000), cb8[16].w
    if_nz r0.y
      dp3 r0.y, r3.xyzx, r3.xyzx
      ge r0.z, l(25600.000000), r0.y
      if_nz r0.z
        sqrt r0.y, r0.y
        mad r0.y, cb1[69].w, l(-100.000000), r0.y
        mul r0.y, r0.y, l(0.012500)
        frc r0.y, r0.y
        mul r0.y, r0.y, r0.y
        mad r0.y, r0.y, l(0.500000), r1.z
      else 
        mov r0.y, l(0)
      endif 
    else 
    ...
    lt r0.z, l(0.000000), cb8[17].w
    if_nz r0.z
      dp3 r0.z, r4.xyzx, r4.xyzx
      ge r0.w, l(25600.000000), r0.z
      if_nz r0.w
        sqrt r0.z, r0.z
        mad r0.z, cb1[69].w, l(-100.000000), r0.z
        mul r0.z, r0.z, l(0.012500)
        frc r0.z, r0.z
        mul r0.z, r0.z, r0.z
    ...
    if_nz r0.z
      ...
      if_nz r0.w
        ...
        frc r0.z, r0.z
        mul r0.z, r0.z, r0.z
        mad r0.z, r0.z, l(0.500000), r3.w
      else 
        mov r0.z, l(0)
      endif 
      add r0.y, r0.z, r0.y
    endif 
    lt r0.z, l(0.000000), cb8[20].w
    if_nz r0.z
    ...
    if_nz r0.z
      ...
      if_nz r0.w
        ...
        frc r0.z, r0.z
        mul r0.z, r0.z, r0.z
        mad r0.z, r0.z, l(0.500000), r5.w
      else 
        mov r0.z, l(0)
      endif 
      add r0.y, r0.z, r0.y
    endif 
    lt r0.z, l(0.000000), cb8[22].w
    if_nz r0.z
      ...
      if_nz r0.w
        ...
        frc r0.z, r0.z
        mul r0.z, r0.z, r0.z
        mad r0.z, r0.z, l(0.500000), r6.w
      else 
        mov r0.z, l(0)
      endif 
      add r0.y, r0.z, r0.y
    endif 
    lt r0.z, l(0.000000), cb8[23].w
    if_nz r0.z
      ...
      if_nz r0.w
        ...
        frc r0.z, r0.z
        mul r0.z, r0.z, r0.z
        mad r0.z, r0.z, l(0.500000), r7.w
      else 
        mov r0.z, l(0)
      endif 
      add r0.y, r0.z, r0.y
    endif 
    min r0.y, r0.y, l(0.700000)
    lt r0.z, l(0.000000), r0.y
    mov r1.z, cb1[69].w
    mov r1.w, v1.y
    dp2 r0.w, r1.zwzz, l(37.349838, 59.394840, 0.000000, 0.000000)
    frc r1.x, r0.w
    dp3 r0.w, r1.xzwx, l(81.239487, 37.349838, 59.394840, 0.000000)
    frc r1.y, r0.w
    dp4 r0.w, r1.xyzw, l(81.239487, 17.348024, 37.349838, 59.394840)
    frc r1.z, r0.w
    dp4 r0.w, r1.xyzw, l(81.239487, 17.348024, 37.349838, 59.394840)
    frc r1.w, r0.w
    dp4 r0.w, r1.xyzw, l(81.239487, 17.348024, 37.349838, 59.394840)
