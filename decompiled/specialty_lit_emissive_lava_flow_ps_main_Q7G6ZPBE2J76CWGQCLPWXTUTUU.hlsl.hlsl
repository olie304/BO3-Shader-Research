// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:42:05 2021
...
Texture2D<float4> flowMap : register(t25);
Texture2D<float4> noiseMap : register(t26);
...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  if (scaleNormalsWithFlow != 0) {
    r7.xy = flowMap.Sample(flowSampler_s, v2.xy).xy;
    r8.xy = r7.xy + r7.xy;
  ...
  if (useOrientedNormalMap == 0) {
    ...
    r8.xy = r2.xz / r0.yy;
    r8.z = -r8.x;
    r9.x = dot(v2.xy, r8.yz);
    r9.y = dot(v2.xy, -r8.xy);
    ...
    r4.xy = r2.xz / r0.yy;
    r4.z = -r4.x;
    r8.x = dot(v2.xy, r4.yz);
    r8.y = dot(v2.xy, -r4.xy);
  ...
  r2.x = min(15, r2.x);
  r2.x = (uint)r2.x;
  r7.xy = (uint2)r2.zy >> int2(6,6);
  r7.z = (uint)r2.x << 4;
  r2.x = numStaticDecals & -32;
  r3.w = (int)-r2.x + numStaticDecals;
  r8.xy = float2(0,0);
  r9.w = 0;
  r5.w = 1;
  ...
  r8.w = 0;
  while (true) {
    r10.w = cmp((uint)r8.w >= numStaticDecals);
    if (r10.w != 0) break;
    r8.z = (uint)r8.w >> 5;
    r9.xyz = (int3)r7.xyz + (int3)r8.xyz;
    r8.z = visibleDecals.Load(r9.xyzw).x;
    r9.x = cmp((int)r2.x == (int)r8.w);
    if (r3.w == 0) r9.y = 0; else if (r3.w+0 < 32) {     r9.y = (uint)r8.z << (32-(r3.w + 0)); r9.y = (uint)r9.y >> (32-r3.w);    } else r9.y = (uint)r8.z >> 0;
    r8.z = r9.x ? r9.y : r8.z;
    r9.x = (int)r2.w + (int)r8.w;
    r13.xyz = r10.xyz;
    r14.xyz = r11.xyz;
    r15.xyz = r12.xyz;
    r9.y = r4.w;
  ...
  r4.w = saturate(r4.w);
  r1.x = 1 + -r4.w;
  r3.xyz = r6.xyz * r1.xxx + r10.xyz;
  r2.x = r7.w * r1.x + r4.w;
  r0.yzw = r0.yzw * r1.xxx + r11.xyz;
  r2.w = dot(r0.yzw, r0.yzw);
  r2.w = rsqrt(r2.w);
  r4.xyz = r2.www * r0.yzw;
  r0.y = r0.x * r1.x + r6.w;
  r6.xyz = r1.xxx * float3(0.0399999991,0.0399999991,0.0399999991) + r12.xyz;
  r0.z = dot(-v7.xyz, -v7.xyz);
  r0.z = rsqrt(r0.z);
  r8.xyz = -v7.xyz * r0.zzz;
  r9.x = dot(r8.xyz, v5.xyz);
  r9.y = dot(r8.xyz, v6.xyz);
  r0.w = dot(r8.xyz, v4.xyz);
  r2.w = cmp(0 < r0.w);
  r9.xy = -r9.xy / r0.ww;
  r9.xy = r2.ww ? r9.xy : 0;
  r9.zw = float2(-0.5,-0.5) + v2.xy;
  r0.w = 9.99999975e-06 + layerDepth;
  r9.xy = r9.xy * r0.ww;
  r9.xy = scaleUVs.xy * r9.xy;
  r9.xy = r9.zw * scaleUVs.xy + r9.xy;
  r9.xy = offsetUVs.xy * scaleUVs.xy + r9.xy;
  ...
  r11.y = r11.x;
  r11.z = r10.x;
  r12.x = dot(r11.yz, r9.xy);
  r11.x = -r10.x;
  r12.y = dot(r11.xy, r9.xy);
  r9.xy = gameTime.ww * scrollUVs.xy;
  r9.xy = r9.xy * scaleUVs.xy + r12.xy;
  ...
  r9.xy = clampU ? r9.zw : r9.xy;
  r0.w = saturate(dot(r8.xyz, r1.yzw));
  r9.xyzw = emissiveMap.Sample(colorSampler_s, r9.xy).xyzw;
  r1.yzw = emissiveTint1.xyz * r9.xyz;
  r2.w = log2(r0.w);
  r2.w = useOrientedNormalMap * r2.w;
  r2.w = exp2(r2.w);
  r0.w = 1 + -r0.w;
  r0.w = log2(r0.w);
  r0.w = useOrientedNormalMap * r0.w;
  r0.w = exp2(r0.w);
  r0.w = invertFalloff ? r0.w : r2.w;
  r2.w = cmp(useOrientedNormalMap == 0.000000);
  r0.w = r2.w ? 1 : r0.w;
  r2.w = useOrientedNormalMap * r9.w;
  r0.w = r2.w * r0.w;
  r0.w = r0.w * r1.x;
  ...
  r0.w = frac(r0.w);
  r9.y = gameTime.w * flickerSpeed + r0.w;
  r9.x = flickerSeed.x;
  r0.w = flickerLookupMap.SampleLevel(lookupSampler_s, r9.xy, 0).x;
  r0.w = log2(abs(r0.w));
  r0.w = flickerPower * r0.w;
  r0.w = exp2(r0.w);
  r1.w = flickerRange.y + -flickerRange.x;
  r0.w = r0.w * r1.w + flickerRange.x;
  r1.xyz = r1.xyz * r0.www;
  r0.w = cmp(isDepthHack != 0);
  r2.yz = (uint2)r2.yz;
  r2.w = dot(r2.zy, float2(0.0671105608,0.00583714992));
  r2.w = frac(r2.w);
  r2.w = 52.9829178 * r2.w;
  r2.w = frac(r2.w);
  r2.w = r2.w * 6.28318548 + gameTick.w;
  sincos(r2.w, r9.x, r10.x);
  r2.y = dot(r2.yz, float2(0.0671105608,0.00583714992));
  r2.y = frac(r2.y);
  ...
  r2.y = dot(-r8.xyz, r4.xyz);
  r2.y = r2.y + r2.y;
  r13.xyz = r4.xyz * -r2.yyy + -r8.xyz;
  r2.y = 17 * r0.y;
  r2.y = exp2(r2.y);
  r2.y = 2 + r2.y;
  r2.y = 2 / r2.y;
  ...
  r6.w = 100 * r6.w;
  r9.zw = -r2.ww * float2(10,5) + float2(6.85740995,7.08500004);
  r7.w = exp2(r9.z);
  r7.w = r7.w * r0.x;
  r7.w = 9.1368103 * r7.w;
  r8.w = r3.w * r2.w;
  ...
  while (true) {
    ...
    if (r9.w != 0) break;
    r14.z = (uint)r9.z >> 5;
    r15.xyz = (int3)r7.xyz + (int3)r14.xyz;
  ...
  r35.x = samp0[]..swiz;
  r35.y = samp0[]..swiz;
    r12.yzw = v7.xyz + -r23.yzw;
    r10.w = dot(r12.yzw, r12.yzw);
    r10.w = sqrt(r10.w);
  ...
  r41.z = samp0[]..swiz;
  r41.w = samp0[]..swiz;
    r14.z = dot(r36.xyz, r12.yzw);
    r14.z = saturate(r14.z + r36.w);
    r14.w = dot(r37.xyz, r12.yzw);
    r14.w = saturate(r14.w + r37.w);
    r14.z = r14.z * r14.w;
    r14.w = dot(r38.xyz, r12.yzw);
    r14.w = saturate(r14.w + r38.w);
    r14.z = r14.z * r14.w;
    r14.w = dot(r39.xyz, r12.yzw);
    r14.w = saturate(r14.w + r39.w);
    r14.z = r14.z * r14.w;
    r14.w = dot(r40.xyz, r12.yzw);
    r14.w = saturate(r14.w + r40.w);
    r14.z = r14.z * r14.w;
    r14.w = dot(r41.xyz, r12.yzw);
    ...
    r15.xy = r29.zw;
    r15.z = r30.z;
    r16.x = dot(r13.xyz, r15.xyz);
    r15.x = dot(r12.yzw, r15.xyz);
    r15.x = r15.x + -r30.w;
    r15.y = cmp(r15.x >= 0);
    r15.x = max(abs(r15.x), r6.w);
    r15.x = r15.y ? r15.x : -r15.x;
    r15.y = max(1.00000001e-07, -r16.x);
    r15.x = r15.x / r15.y;
    r15.x = min(131072, abs(r15.x));
    r30.z = r31.z;
    r15.y = dot(r13.xyz, r30.xyz);
    r15.z = dot(r12.yzw, r30.xyz);
    r15.z = r15.z + -r31.w;
    r16.x = cmp(r15.z >= 0);
    ...
    r31.z = r32.z;
    r15.y = dot(r13.xyz, r31.xyz);
    r15.z = dot(r12.yzw, r31.xyz);
    r15.z = r15.z + -r32.w;
    r16.x = cmp(r15.z >= 0);
    r15.z = max(abs(r15.z), r6.w);
    r15.z = r16.x ? r15.z : -r15.z;
    ...
    r15.x = min(r15.x, abs(r15.y));
    r32.z = r33.z;
    r15.y = dot(r13.xyz, r32.xyz);
    r15.z = dot(r12.yzw, r32.xyz);
    r15.z = r15.z + -r33.w;
    r16.x = cmp(r15.z >= 0);
    r15.z = max(abs(r15.z), r6.w);
    r15.z = r16.x ? r15.z : -r15.z;
    ...
    r15.x = min(r15.x, abs(r15.y));
    r33.z = r34.x;
    r15.y = dot(r13.xyz, r33.xyz);
    r15.z = dot(r12.yzw, r33.xyz);
    r15.z = r15.z + -r34.y;
    r16.x = cmp(r15.z >= 0);
    r15.z = max(abs(r15.z), r6.w);
    r15.z = r16.x ? r15.z : -r15.z;
    ...
    r15.x = min(r15.x, abs(r15.y));
    r35.zw = r34.zw;
    r15.y = dot(r13.zxy, r35.xzw);
    r15.z = dot(r12.wyz, r35.xzw);
    r15.z = r15.z + -r35.y;
    r16.x = cmp(r15.z >= 0);
    r15.z = max(abs(r15.z), r6.w);
    r15.z = r16.x ? r15.z : -r15.z;
    ...
    r30.x = r26.w;
    r30.yz = r27.zw;
    r30.xyz = r30.xyz + r12.yzw;
    r30.xyz = r13.xyz * r15.xxx + r30.xyz;
    r15.y = dot(r30.xyz, r30.xyz);
    r15.y = sqrt(r15.y);
    r15.x = r15.x / r15.y;
    r15.x = r15.x + r15.x;
    r15.x = sqrt(r15.x);
    ...
    if (6 == 0) r15.y = 0; else if (6+25 < 32) {     r15.y = (uint)r29.y << (32-(6 + 25)); r15.y = (uint)r15.y >> (32-6);    } else r15.y = (uint)r29.y >> 25;
    if (9 == 0) r15.z = 0; else if (9+16 < 32) {     r15.z = (uint)r29.y << (32-(9 + 16)); r15.z = (uint)r15.z >> (32-9);    } else r15.z = (uint)r29.y >> 16;
    r31.w = (uint)r15.z;
    r24.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r31.xyzw, r15.x).xyz;
    r29.yzw = (int3)r24.xyz & int3(-2147483648,-2147483648,-2147483648);
    r29.yzw = cmp((int3)r29.yzw == int3(2139095040,2139095040,2139095040));
    r15.x = (int)r29.z | (int)r29.y;
    r15.x = (int)r29.w | (int)r15.x;
    r24.xyz = r15.xxx ? float3(1,1,0) : r24.xyz;
    r30.x = dot(r12.yzw, r23.xyz);
    r30.y = dot(r12.yzw, r32.xyz);
    r30.z = dot(r12.yzw, r25.xyz);
    ...
    r15.x = (int)r29.z | (int)r29.y;
    r15.x = (int)r29.w | (int)r15.x;
    r28.xyz = r15.xxx ? float3(1,1,0) : r28.xyz;
    r30.xyzw = r21.xyzw;
    r29.yzw = r22.yzw;
    r15.x = r8.w;
    r15.z = r9.w;
    while (true) {
      if (r15.z == 0) break;
      r16.x = firstbitlow((uint)r15.z);
      r16.x = 1 << (int)r16.x;
      r16.w = (int)r15.z & (int)r16.x;
      if (r16.w != 0) {
        r16.x = ~(int)r16.x;
        ...
        if (r10.w != 0) {
          ...
          r37.w = samp0[]..swiz;
            ...
            r19.z = (int)r18.z & 2;
            r19.w = max(r31.y, r31.x);
            r17.z = -r17.z * r17.w + 1;
            r17.z = r31.y * r17.z;
            r20.y = r19.z ? r17.z : r19.w;
            r31.xy = r18.ww ? r31.xy : r20.xy;
            r16.w = (int)r16.w + 1;
            r16.x = r18.z;
          }
          ...
          if (r16.w != 0) {
            ...
            r16.x = r16.x * r29.x;
            r20.yzw = r27.xyz * r16.xxx;
            r31.xzw = r23.xyw * r20.zzz;
            r31.xzw = r25.xyz * r20.yyy + r31.xzw;
            r20.yzw = r26.xyz * r20.www + r31.xzw;
            r31.xzw = r20.yzw * r28.xyz;
            r16.w = dot(r31.xzw, float3(0.212599993,0.715200007,0.0722000003));
            r33.xyz = r20.yzw * r28.xyz + r30.xyz;
            r17.z = r16.w * r7.w;
            r20.yzw = r24.xyz * r16.xxx;
            r16.x = dot(r20.yzw, float3(0.212599993,0.715200007,0.0722000003));
            r16.x = r7.w * r16.w + r16.x;
            r16.x = r17.z / r16.x;
            r34.x = r30.w;
            r34.yz = r29.yz;
            r32.xyw = r20.zwy * r16.xxx + r34.yzx;
            r33.w = r32.w;
          } else {
            r33.xyzw = r30.xyzw;
            r32.xyz = r29.yzw;
  ...
  if (r8.w == 0) {
    ...
    while (true) {
      ...
      r12.y = cmp((int)r9.z == (int)r11.z);
      bitmask.z = ((~(-1 << r9.w)) << 0) & 0xffffffff;  r12.z = (((uint)0 << 0) & bitmask.z) | ((uint)r11.w & ~bitmask.z);
      r11.w = r12.y ? r12.z : r11.w;
      r12.y = cmp((int)r10.w == (int)r11.z);
      if (r11.y == 0) r12.z = 0; else if (r11.y+0 < 32) {       r12.z = (uint)r11.w << (32-(r11.y + 0)); r12.z = (uint)r12.z >> (32-r11.y);      } else r12.z = (uint)r11.w >> 0;
      r11.w = r12.y ? r12.z : r11.w;
      r12.y = (int)r11.z + numLights;
      r25.xyzw = r23.xyzw;
      r26.xyz = r24.yzw;
      r12.z = r11.w;
      while (true) {
        ...
        r15.y = samp0[]..swiz;
          ...
          r34.w = samp0[]..swiz;
            ...
            r40.y = samp0[]..swiz;
              ...
              r12.w = r7.w * r14.z + r12.w;
              r12.w = r14.w / r12.w;
              r27.x = r25.w;
              r27.yz = r26.xy;
              r26.xyw = r15.yzx * r12.www + r27.yzx;
              r25.w = r26.w;
            }
          }
        }
    ...
    if (r10.w != 0) {
      ...
      r12.y = 0;
      while (true) {
        r12.z = cmp((uint)r12.y >= (uint)r8.w);
        if (r12.z != 0) break;
        r14.z = (uint)r12.y >> 5;
        r15.xyz = (int3)r7.xyz + (int3)r14.xyz;
        r12.z = visibleProbes.Load(r15.xyzw).x;
        r12.w = cmp((int)r9.z == (int)r12.y);
    ...
    if (r6.w != 0) {
      ...
      r21.xyz = r23.xyz * r2.www + r11.yzw;
      r13.w = 0;
      r11.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r13.xyzw, r3.w).xyz;
      r2.w = sunConstants.globalProbeExposure * r6.w + -r4.w;
      r2.w = r0.y * r2.w + r4.w;
      r22.xyz = r11.yzw * r2.www + r22.xyz;
    }
  } else {
    r22.x = r21.w;
  }
  r9.zw = r0.xy * float2(0.984375,0.984375) + float2(0.0078125,0.0078125);
  r9.zw = gEnvBRDFGeneric.SampleLevel(samplerLinear_s, r9.zw, 0).xy;
  r14.xyz = r22.yzx * r9.zzz;
  r11.yzw = r22.xyz * r9.www;
  r0.y = sqrt(r2.z);
  r0.y = r0.y * 0.5 + 0.5;
  r0.y = r0.y * r0.y;
  r2.w = 0.5 * r0.y;
  ...
  if (r6.w == 0) {
    ...
    if (r8.w != 0) {
      ...
      while (true) {
        ...
        if (r9.w != 0) break;
        r9.w = (uint)r8.w;
        r15.xy = -sunConstants.splitPinTransform[r9.w].xy + r12.yz;
    ...
    r13.w = samp0[]..swiz;
      ...
      r18.w = samp0[]..swiz;
        ...
        r15.x = samp0[]..swiz;
          ...
          r13.w = r12.z * r13.w + r15.x;
          r16.x = r10.w ? r13.w : r16.x;
        }
      }
    ...
    if (r9.w == 0) {
      ...
      if (enableDitheredShadow != 0) {
        ...
        r12.yz = -sunConstants.splitPinTransform[r8.w].xy + r12.yz;
        ...
        while (true) {
          ...
          if (r13.w != 0) break;
          r13.w = cmp((uint)r9.z < (uint)r12.w);
          r16.zw = r13.ww ? r12.yz : r16.xy;
          r15.w = r13.w ? sunConstants.splitPinTransform[r8.w].w : sunConstants.splitPinTransform[r9.w].w;
          r13.w = r13.w ? r8.w : r9.w;
  ...
  if (r6.w != 0) {
    ...
    if (r6.w != 0) {
      ...
      if (sunConstants.sunCookieIndex != 0) {
        ...
        r15.z = (uint)r5.x;
        r5.xyz = gCookieArray.SampleLevel(samplerLinear_s, r15.xyz, 0).xyz;
      ...
      r18.w = samp0[]..swiz;
        ...
        r19.xyz = r4.xyz * r9.zzz + v7.xyz;
        r19.w = 1;
        r15.x = dot(r15.xyzw, r19.xyzw);
        r15.y = dot(r16.xyzw, r19.xyzw);
        r9.zw = r15.xy * float2(0.5,-0.5) + float2(0.5,0.5);
        r9.zw = r9.zw + r18.zw;
        r9.zw = r9.zw * r18.xy;
        r12.yz = r8.ww / r17.xz;
        r15.xy = float2(1,1) + -r12.yz;
        r15.xy = cmp(r9.zw >= r15.xy);
        r12.yz = cmp(r12.yz >= r9.zw);
        r12.yz = (int2)r12.yz | (int2)r15.xy;
        ...
        r12.z = samp0[]..swiz;
          ...
          if (enableDitheredShadow != 0) {
            ...
            while (true) {
              ...
              r12.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r17.xyz, r5.w).x;
              r9.w = r12.y * 0.125 + r9.w;
              r10.w = (int)r10.w + 1;
            }
          } else {
            r15.z = (uint)r9.z;
            r9.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r15.xyz, r5.w).x;
          }
          r5.w = r9.w * r9.w;
          r5.w = r5.w * r9.w;
        } else {
      ...
      r5.w = r5.w * r7.w;
      r3.w = cmp(0 < r3.w);
      r15.xyz = r5.www * r5.xyz + r21.xyz;
      r12.yzw = -v7.xyz * r0.zzz + sunConstants.wldDir.xyz;
      r0.z = dot(r12.yzw, r12.yzw);
      r0.z = rsqrt(r0.z);
      r12.yzw = r12.yzw * r0.zzz;
      r0.z = dot(r12.yzw, r8.xyz);
      r5.w = dot(r4.xyz, r12.yzw);
      ...
      r4.w = r7.w * r4.w;
      r4.w = 0.25 * r4.w;
      r12.yzw = r4.www * r5.xyz + r11.yzw;
      r0.z = saturate(1 + -r0.z);
      r5.w = r0.z * r0.z;
      r5.w = r5.w * r5.w;
      r0.z = r5.w * r0.z;
      r0.z = r4.w * r0.z;
      r5.xyz = r0.zzz * r5.yzx + r14.xyz;
      r15.w = r5.z;
      r21.w = r14.z;
      r21.xyzw = r3.wwww ? r15.xyzw : r21.xyzw;
      r5.zw = r12.yz;
      r14.zw = r11.yz;
      r5.xyzw = r3.wwww ? r5.xyzw : r14.xyzw;
      r11.w = r3.w ? r12.w : r11.w;
      r14.z = r21.w;
      r14.xy = r5.xy;
      r11.yz = r5.zw;
    }
  ...
  while (true) {
    ...
    if (r6.w != 0) break;
    r15.z = (uint)r4.w >> 5;
    r16.xyz = (int3)r7.xyz + (int3)r15.xyz;
      ...
      r33.y = samp0[]..swiz;
        ...
        r38.w = samp0[]..swiz;
          ...
          switch (r9.w) {
              ...
              if (r20.w != 0) {
                ...
                if (r20.w != 0) {
                  ...
                  while (true) {
                    ...
                    if (r27.w != 0) break;
                    r44.y = dot(icb[r26.w+0].yx, r5.xy);
                    r44.z = dot(icb[r26.w+0].yx, r5.yz);
                ...
                if (r20.w != 0) {
                  ...
                  r42.z = samp0[]..swiz;
                  r42.w = samp0[]..swiz;
                    r21.w = abs(r15.z) * -0.200000003 + 0.400000006;
                    r18.xyz = r4.xyz * r21.www + v7.xyz;
                    r21.w = dot(r41.xyzw, r18.xyzw);
                    ...
                    r10.w = samp0[]..swiz;
                      ...
                      if (r7.w != 0) {
                        ...
                        r18.yz = float2(0,0);
                        while (true) {
                          r21.w = cmp((int)r18.z >= 8);
                          if (r21.w != 0) break;
                          r43.x = dot(icb[r18.z+0].yx, r5.xw);
                          r43.y = dot(icb[r18.z+0].xy, r9.xy);
                          r42.xy = r43.xy * r13.ww + r41.xy;
                          r21.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r42.xyz, r18.x).x;
                          r18.y = r21.w * 0.125 + r18.y;
                          r18.z = (int)r18.z + 1;
                        }
                      } else {
                        r41.z = (uint)r10.w;
                  ...
                  r10.w = r10.w + -r15.w;
                  r10.w = r2.z * r10.w + r15.w;
                  r10.w = r10.w * r14.w;
                  r33.x = r32.x;
                  r13.w = cmp(0 < r15.z);
                  r19.xyz = r10.www * r33.xyz + r16.xyz;
                  r10.w = saturate(dot(r4.xyz, r40.xyz));
                  r39.xyz = r39.xyz * r9.www + r8.xyz;
                  r9.w = dot(r39.xyz, r39.xyz);
                  r9.w = rsqrt(r9.w);
                  r39.xyz = r39.xyz * r9.www;
                  r9.w = dot(r39.xyz, r8.xyz);
                  r15.z = dot(r4.xyz, r39.xyz);
                  r15.w = abs(r15.z) * r2.y + -abs(r15.z);
                  r15.z = abs(r15.z) * r15.w + 1;
                  r15.w = r10.w * r0.y + r2.w;
                  r15.z = r15.z * r15.z;
                  r15.z = r15.z * r15.w;
                  r15.z = rcp(r15.z);
                  r10.w = r10.w * r20.w;
            ...
            r9.w = rsqrt(r9.w);
            r39.xyz = r19.xyz * r9.www;
            r10.w = dot(r4.xyz, r39.xyz);
            r13.w = saturate(r10.w);
            r14.w = cmp(0 < r13.w);
            if (r14.w != 0) {
            // Known bad code for instruction (needs manual fix):
            ...
            r40.w = samp0[]..swiz;
              ...
              if (r14.w != 0) {
                ...
                if (r14.w != 0) {
                  ...
                  r22.xyz = r4.xyz * r14.www + v7.xyz;
                  r39.xyz = r38.xyz;
                  r14.w = dot(r39.xyzw, r22.xyzw);
                  r15.w = dot(r41.xyzw, r22.xyzw);
                  ...
                  r40.y = samp0[]..swiz;
                    ...
                    if (r7.w != 0) {
                      ...
                      r18.x = 0;
                      while (true) {
                        r21.w = cmp((int)r18.x >= 8);
                        if (r21.w != 0) break;
                        r34.x = dot(icb[r18.x+0].xy, r25.xy);
                        r34.y = dot(icb[r18.x+0].yx, r25.xz);
                        r32.xy = r34.xy * r35.yy + r22.xy;
                        r21.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r32.xyz, r9.z).x;
                        r15.w = r21.w * 0.125 + r15.w;
                        r18.x = (int)r18.x + 1;
                      }
                    } else {
                      r22.z = (uint)r14.w;
                      r15.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r22.xyz, r9.z).x;
                    }
                    r9.z = r15.w * r15.w;
                    r9.z = r9.z * r15.w;
                  } else {
                ...
                if (r14.w != 0) {
                  ...
                  r38.w = samp0[]..swiz;
                    ...
                    r23.z = samp0[]..swiz;
                      ...
                      r15.z = r23.z * r22.z;
                      r21.w = r23.y * r22.z + r21.w;
                      r15.z = r21.w / r15.z;
                      r15.z = max(6.10351563e-05, r15.z);
                      r21.w = r23.x ? 0.000000 : 0;
                      if (r7.w != 0) {
                        r22.z = (uint)r21.w;
                        r23.xy = float2(0,0);
                        while (true) {
                        ...
                        r32.z = (uint)r21.w;
                        r23.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r32.xyz, r15.z).x;
                      }
                      r15.z = r23.x * r23.x;
                      r15.z = r15.z * r23.x;
                    } else {
                    ...
                    r37.w = samp0[]..swiz;
                      ...
                      r24.y = samp0[]..swiz;
                        ...
                        r15.z = r24.y * r22.z;
                        r21.w = r24.x * r22.z + r21.w;
                        r15.z = r21.w / r15.z;
                        r15.z = max(6.10351563e-05, r15.z);
                        r21.w = r23.y ? 0.000000 : 0;
                        if (r7.w != 0) {
                          r22.z = (uint)r21.w;
                          r23.yz = float2(0,0);
                          while (true) {
                          ...
                          r32.z = (uint)r21.w;
                          r23.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r32.xyz, r15.z).x;
                        }
                        r15.z = r23.y * r23.y;
                        r15.z = r15.z * r23.y;
                      } else {
                  ...
                  r9.z = r13.w * r9.z;
                  r9.z = 0.25 * r9.z;
                  r19.xyz = r9.zzz * r20.xyw + r31.xyz;
                  r9.w = saturate(1 + -r9.w);
                  r13.w = r9.w * r9.w;
                  r13.w = r13.w * r13.w;
                  r9.w = r13.w * r9.w;
                  r9.z = r9.z * r9.w;
                  r20.xyw = r9.zzz * r20.xyw + r30.xyz;
                  r16.xyz = r10.www ? r22.xyz : r16.xyz;
                  r30.xyz = r10.www ? r20.xyw : r30.xyz;
                  r31.xyz = r10.www ? r19.xyz : r31.xyz;
                }
              }
            }
            break;
