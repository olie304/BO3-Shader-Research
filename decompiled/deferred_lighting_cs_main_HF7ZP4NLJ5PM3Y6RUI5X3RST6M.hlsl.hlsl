...
r0.y = samp0[]..swiz;
  ...
  while (true) {
    ...
    if (r13.z != 0) break;
    r13.z = r12.w ? r0.y : r10.w;
    r13.w = cmp((uint)r13.z >= (uint)r9.w);
    r14.w = cmp((uint)r13.z < numRefProbes);
    r13.w = r13.w ? r14.w : 0;
    if (r13.w != 0) {
      r13.z = (int)r13.z * 14;
      if (r2.z != 0) {
      ...
      r16.yz = r16.yy ? r19.xy : r19.zx;
      r16.w = refProbeConstantsCB[r13.z].data[6].x;
      r27.xy = r16.yz;
      r18.y = 1;
      while (true) {
        r18.z = cmp((int)r18.y >= (int)r14.w);
        if (r18.z != 0) break;
        r18.z = (int)r13.w + (int)r18.y;
        r18.z = (int)r18.z * 6;
        ...
        r18.w = r27.x * r18.w;
        r19.x = dot(refProbeAttenuationConstantsCB[r18.z].data[1].xyz, r15.yzw);
        r19.x = saturate(refProbeAttenuationConstantsCB[r18.z].data[1].w + r19.x);
        r18.w = r19.x * r18.w;
        r19.x = dot(refProbeAttenuationConstantsCB[r18.z].data[2].xyz, r15.yzw);
        r19.x = saturate(refProbeAttenuationConstantsCB[r18.z].data[2].w + r19.x);
        r18.w = r19.x * r18.w;
        r19.x = dot(refProbeAttenuationConstantsCB[r18.z].data[3].xyz, r15.yzw);
        r19.x = saturate(refProbeAttenuationConstantsCB[r18.z].data[3].w + r19.x);
        r18.w = r19.x * r18.w;
        r19.x = dot(refProbeAttenuationConstantsCB[r18.z].data[4].xyz, r15.yzw);
        r19.x = saturate(refProbeAttenuationConstantsCB[r18.z].data[4].w + r19.x);
        r18.w = r19.x * r18.w;
        r19.x = dot(refProbeAttenuationConstantsCB[r18.z].data[5].xyz, r15.yzw);
        r18.z = saturate(refProbeAttenuationConstantsCB[r18.z].data[5].w + r19.x);
        r27.x = r18.w * r18.z;
        r19.x = (uint)r16.w >> 2;
        ...
        r18.z = -r18.w * r18.z + 1;
        r18.z = r27.y * r18.z;
        r21.y = r20.w ? r18.z : r22.w;
        r27.xy = r19.ww ? r27.xy : r21.xy;
        r18.y = (int)r18.y + 1;
        r16.w = r19.x;
      }
      r27.y = saturate(r27.y);
      r13.w = refProbeConstantsCB[r13.z].data[6].y * r27.y;
      r14.w = cmp(0 < r13.w);
      if (r14.w != 0) {
        r14.w = (int)r26.w & 7;
        r16.y = (int)r14.w + -1;
        ...
        r16.y = r2.z ? r16.y : 0;
        if (r16.y != 0) {
          r16.yz = mad((int2)r14.ww, int2(20,20), int2(860,876));
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r14.w, cb2[52].x, r16.y, u2.xxxx
        r14.w = samp0[]..swiz;
          r14.w = (int)r14.w | 32;
        ...
        r25.w = (int)r25.w + 257;
        r25.z = r27.y * refProbeConstantsCB[r13.z].data[6].y + r25.z;
        r13.w = refProbeConstantsCB[r13.z].data[7].y * r13.w;
        r28.x = refProbeConstantsCB[r13.z].data[7].w;
        r28.yz = refProbeConstantsCB[r13.z].data[8].xy;
        r14.w = dot(r17.xyz, r28.xyz);
        r16.y = dot(r15.yzw, r28.xyz);
        r16.y = -refProbeConstantsCB[r13.z].data[8].z + r16.y;
        r16.z = cmp(r16.y >= 0);
        ...
        r28.x = refProbeConstantsCB[r13.z].data[8].w;
        r28.yz = refProbeConstantsCB[r13.z].data[9].xy;
        ...
        r28.x = refProbeConstantsCB[r13.z].data[9].w;
        r28.yz = refProbeConstantsCB[r13.z].data[10].xy;
        r16.y = dot(r17.xyz, r28.xyz);
        r16.z = dot(r15.yzw, r28.xyz);
        ...
        r16.y = r16.z / r16.y;
        r14.w = min(abs(r16.y), r14.w);
        r28.x = refProbeConstantsCB[r13.z].data[10].w;
        r28.yz = refProbeConstantsCB[r13.z].data[11].xy;
        r16.y = dot(r17.xyz, r28.xyz);
        r16.z = dot(r15.yzw, r28.xyz);
        ...
        r16.y = r16.z / r16.y;
        r14.w = min(abs(r16.y), r14.w);
        r28.x = refProbeConstantsCB[r13.z].data[11].w;
        r28.yz = refProbeConstantsCB[r13.z].data[12].xy;
        r16.y = dot(r17.xyz, r28.xyz);
        r16.z = dot(r15.yzw, r28.xyz);
        ...
        r16.y = r16.z / r16.y;
        r14.w = min(abs(r16.y), r14.w);
        r28.x = refProbeConstantsCB[r13.z].data[12].w;
        r28.yz = refProbeConstantsCB[r13.z].data[13].xy;
        r16.y = dot(r17.xyz, r28.xyz);
        r16.z = dot(r15.yzw, r28.xyz);
        ...
        r16.y = r16.z / r16.y;
        r14.w = min(abs(r16.y), r14.w);
        r28.x = refProbeConstantsCB[r13.z].data[3].w + r15.y;
        r28.yz = refProbeConstantsCB[r13.z].data[4].xy + r15.zw;
        r16.yzw = r17.xyz * r14.www + r28.xyz;
        r18.y = dot(r16.yzw, r16.yzw);
        r18.y = sqrt(r18.y);
        r14.w = r14.w / r18.y;
        r14.w = r14.w + r14.w;
        r14.w = sqrt(r14.w);
        ...
        r28.x = refProbeConstantsCB[r13.z].data[0].w;
        r28.y = refProbeConstantsCB[r13.z].data[1].z;
        r28.z = refProbeConstantsCB[r13.z].data[2].y;
        r29.x = dot(r16.yzw, r28.xyz);
        r30.xy = refProbeConstantsCB[r13.z].data[1].xw;
        r30.z = refProbeConstantsCB[r13.z].data[2].z;
        r29.y = dot(r16.yzw, r30.xyz);
        r31.x = refProbeConstantsCB[r13.z].data[1].y;
        r31.yz = refProbeConstantsCB[r13.z].data[2].xw;
        ...
        r29.w = (uint)r16.y;
        r16.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r29.xyzw, r14.w).xyz;
        ...
        r15.yzw = saturate(r32.xyz * refProbeConstantsCB[r13.z].data[3].xyz + float3(0.5,0.5,0.5));
        r32.xy = refProbeConstantsCB[r13.z].data[4].zw * r15.yz;
        r32.z = refProbeConstantsCB[r13.z].data[5].x * r15.w;
        r15.yzw = refProbeConstantsCB[r13.z].data[5].yzw + r32.xyz;
        ...
        r13.z = (int)r27.z | (int)r27.x;
        r13.z = (int)r27.w | (int)r13.z;
        r18.yzw = r13.zzz ? float3(1,1,0) : r18.yzw;
        ...
        r13.z = r8.w * r13.z + r13.w;
        r13.z = r14.w / r13.z;
        r28.x = r24.w;
        r28.yz = r25.xy;
        r15.yzw = r15.yzw * r13.zzz + r28.xyz;
        r24.w = r15.y;
        r25.xy = r15.zw;
      } else {
        r26.xyz = r25.xyz;
  ...
  r12.w = 0;
  while (true) {
    r14.w = cmp((int)r12.w == 2);
    if (r14.w != 0) break;
    r14.w = r12.w ? r0.y : r10.w;
    r16.y = cmp((uint)r14.w < (uint)r9.w);
    if (r16.y != 0) {
      r14.w = (int)r14.w * 14;
      if (r2.z != 0) {
        r16.y = (int)r13.w & 15;
      ...
      r21.y = (int)r13.w + 1;
      r16.yzw = -refProbeConstantsCB[r14.w].data[0].xyz + r5.xyz;
      r18.y = 0x0000ffff & (int)refProbeConstantsCB[r14.w].data[7].z;
      if (6 == 0) r18.z = 0; else if (6+25 < 32) {       r18.z = (uint)refProbeConstantsCB[r14.w].data[7].z << (32-(6 + 25)); r18.z = (uint)r18.z >> (32-6);      } else r18.z = (uint)refProbeConstantsCB[r14.w].data[7].z >> 25;
      r18.w = (int)r18.y * 6;
      ...
      r20.w = dot(refProbeAttenuationConstantsCB[r18.w].data[1].xyz, r16.yzw);
      r20.w = saturate(refProbeAttenuationConstantsCB[r18.w].data[1].w + r20.w);
      r19.w = r20.w * r19.w;
      r20.w = dot(refProbeAttenuationConstantsCB[r18.w].data[2].xyz, r16.yzw);
      r20.w = saturate(refProbeAttenuationConstantsCB[r18.w].data[2].w + r20.w);
      r19.w = r20.w * r19.w;
      r20.w = dot(refProbeAttenuationConstantsCB[r18.w].data[3].xyz, r16.yzw);
      r20.w = saturate(refProbeAttenuationConstantsCB[r18.w].data[3].w + r20.w);
      r19.w = r20.w * r19.w;
      r20.w = dot(refProbeAttenuationConstantsCB[r18.w].data[4].xyz, r16.yzw);
      r20.w = saturate(refProbeAttenuationConstantsCB[r18.w].data[4].w + r20.w);
      r19.w = r20.w * r19.w;
      r20.w = dot(refProbeAttenuationConstantsCB[r18.w].data[5].xyz, r16.yzw);
      r18.w = saturate(refProbeAttenuationConstantsCB[r18.w].data[5].w + r20.w);
      r19.x = r19.w * r18.w;
      r18.w = 1 & (int)refProbeConstantsCB[r14.w].data[6].x;
      r19.xw = r18.ww ? r19.xy : r19.zx;
      r18.w = refProbeConstantsCB[r14.w].data[6].x;
      r27.xy = r19.xw;
      r20.w = 1;
      while (true) {
        r22.w = cmp((int)r20.w >= (int)r18.z);
        if (r22.w != 0) break;
        r22.w = (int)r18.y + (int)r20.w;
        r22.w = (int)r22.w * 6;
        r23.w = dot(refProbeAttenuationConstantsCB[r22.w].data[0].xyz, r16.yzw);
        ...
        r27.x = r23.w * r22.w;
        r26.w = (uint)r18.w >> 2;
        if (1 == 0) r27.z = 0; else if (1+2 < 32) {         r27.z = (uint)r18.w << (32-(1 + 2)); r27.z = (uint)r27.z >> (32-1);        } else r27.z = (uint)r18.w >> 2;
        r27.w = (int)r26.w & 2;
        r28.x = max(r27.y, r27.x);
        r22.w = -r23.w * r22.w + 1;
        r22.w = r27.y * r22.w;
        r21.w = r27.w ? r22.w : r28.x;
        r27.xy = r27.zz ? r27.xy : r21.zw;
        r20.w = (int)r20.w + 1;
        r18.w = r26.w;
      }
      r18.y = saturate(r27.y + -r25.z);
      r18.z = refProbeConstantsCB[r14.w].data[6].y * r18.y;
      r18.w = cmp(0 < r18.z);
      if (r18.w != 0) {
        r18.w = (int)r21.y & 31;
        r19.x = (int)r18.w + -1;
        r19.x = cmp((uint)r19.x < 32);
        r19.x = r2.z ? r19.x : 0;
        if (r19.x != 0) {
          r19.xw = mad((int2)r18.ww, int2(20,20), int2(860,876));
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r18.w, cb2[52].x, r19.x, u2.xxxx
        r18.w = samp0[]..swiz;
          r18.w = (int)r18.w | 32;
        ...
        r13.w = (int)r13.w + 257;
        r13.z = r18.y * refProbeConstantsCB[r14.w].data[6].y + r13.z;
        r18.y = refProbeConstantsCB[r14.w].data[7].y * r18.z;
        r28.x = refProbeConstantsCB[r14.w].data[7].w;
        r28.yz = refProbeConstantsCB[r14.w].data[8].xy;
        r18.z = dot(r17.xyz, r28.xyz);
        r18.w = dot(r16.yzw, r28.xyz);
        ...
        r18.w = dot(r17.xyz, r28.xyz);
        r19.x = dot(r16.yzw, r28.xyz);
        r19.x = -refProbeConstantsCB[r14.w].data[11].z + r19.x;
        r19.w = cmp(r19.x >= 0);
        r19.x = max(abs(r19.x), r7.w);
        r19.x = r19.w ? r19.x : -r19.x;
        r18.w = max(1.00000001e-07, -r18.w);
        ...
        r18.w = dot(r17.xyz, r28.xyz);
        r19.x = dot(r16.yzw, r28.xyz);
        r19.x = -refProbeConstantsCB[r14.w].data[12].z + r19.x;
        r19.w = cmp(r19.x >= 0);
        r19.x = max(abs(r19.x), r7.w);
        r19.x = r19.w ? r19.x : -r19.x;
        r18.w = max(1.00000001e-07, -r18.w);
        ...
        r18.w = dot(r17.xyz, r28.xyz);
        r19.x = dot(r16.yzw, r28.xyz);
        r19.x = -refProbeConstantsCB[r14.w].data[13].z + r19.x;
        r19.w = cmp(r19.x >= 0);
        r19.x = max(abs(r19.x), r7.w);
        r19.x = r19.w ? r19.x : -r19.x;
        r18.w = max(1.00000001e-07, -r18.w);
        r18.w = r19.x / r18.w;
        r18.z = min(r18.z, abs(r18.w));
        r28.x = refProbeConstantsCB[r14.w].data[3].w + r16.y;
        r28.yz = refProbeConstantsCB[r14.w].data[4].xy + r16.zw;
        r27.xzw = r17.xyz * r18.zzz + r28.xyz;
        r18.w = dot(r27.xzw, r27.xzw);
        r18.w = sqrt(r18.w);
        r18.z = r18.z / r18.w;
        r18.z = r18.z + r18.z;
        r18.z = sqrt(r18.z);
        r18.z = r3.z * 5 + r18.z;
        r18.z = -0.844799995 + r18.z;
        ...
        r29.w = (uint)r18.w;
        r27.xzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r29.xyzw, r18.z).xyz;
        ...
        r27.xzw = r18.zzz ? float3(1,1,0) : r27.xzw;
        r32.x = dot(r16.yzw, r28.xyz);
        r32.y = dot(r16.yzw, r30.xyz);
        r32.z = dot(r16.yzw, r31.xyz);
        r16.yzw = saturate(r32.xyz * refProbeConstantsCB[r14.w].data[3].xyz + float3(0.5,0.5,0.5));
        r32.xy = refProbeConstantsCB[r14.w].data[4].zw * r16.yz;
        r32.z = refProbeConstantsCB[r14.w].data[5].x * r16.w;
        r16.yzw = refProbeConstantsCB[r14.w].data[5].yzw + r32.xyz;
        r29.x = dot(r11.xyz, r28.xyz);
        r29.y = dot(r11.xyz, r30.xyz);
        r29.z = dot(r11.xyz, r31.xyz);
        ...
        r31.xyz = r31.xyz * r18.yyy;
        r22.z = r28.y ? 0 : 0.5;
        r28.xyw = r22.xyz + r16.yzw;
        ...
        r16.yzw = r16.yzw * r31.zzz + r28.xyw;
        ...
        r15.yzw = r16.yzw * r28.xyz + r15.yzw;
        r16.y = r14.w * r8.w;
        r18.yzw = r27.xzw * r18.yyy;
        r16.z = dot(r18.yzw, float3(0.212599993,0.715200007,0.0722000003));
        r14.w = r8.w * r14.w + r16.z;
        r14.w = r16.y / r14.w;
  ...
  r0.y = cmp(r25.z >= 1);
  bitmask.z = ((~(-1 << 8)) << 0) & 0xffffffff;  r3.z = (((uint)r13.w << 0) & bitmask.z) | ((uint)r25.w & ~bitmask.z);
  r0.y = r0.y ? r3.z : r13.w;
  r3.z = max(1, r13.z);
  r3.z = rcp(r3.z);
  r13.z = saturate(r13.z);
  r16.yzw = r15.yzw * r3.zzz;
  r18.xyz = r26.xyz * r3.zzz;
  ...
  if (r7.w != 0) {
    ...
    r16.yzw = r15.yzw * r3.zzz + r19.xyz;
    r17.w = 0;
  ...
  r15.yzw = r18.xyz * r3.zzz;
  r18.xyz = r15.zwy * r13.zzz;
  ...
  if (r4.z != 0) {
    ...
    if (r4.z != 0) {
      ...
      r6.w = r6.w * r3.w;
      r2.w = cmp(0 < r2.w);
      r20.xyz = r6.www * r16.yzw + r19.xyz;
      ...
      r0.w = r4.z * r0.w;
      r0.w = r3.y * r0.w;
      r22.xyz = r0.www * r16.zwy + r18.xyz;
      r20.w = r22.z;
      r19.w = r18.z;
      r19.xyzw = r2.wwww ? r20.xyzw : r19.xyzw;
      r22.zw = r21.xy;
      r18.zw = r15.yz;
      r20.xyzw = r2.wwww ? r22.xyzw : r18.xyzw;
