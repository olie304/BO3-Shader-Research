...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  r1.x = r1.y + r1.x;
  r1.x = log2(r1.x);
  r1.y = saturate(-0.0588235296 * r1.x);
  ...
  r5.y = 1 + -r1.y;
  r5.w = r5.y * 5 + -2.5;
  r5.zw = float2(5,0.400000006) * r5.yw;
  r5.w = max(0, r5.w);
  r5.w = 100 * r5.w;
  ...
  r3.x = min(15, r3.x);
  r3.x = (uint)r3.x;
  r10.xy = (uint2)r1.zw >> int2(6,6);
  r10.z = (uint)r3.x << 4;
  r1.z = (int)r6.w & -32;
  r1.w = (int)-r1.z + (int)r6.w;
  r3.x = numRefProbes & -32;
  r7.w = (int)-r3.x + numRefProbes;
  r11.xy = float2(0,0);
  r12.w = 0;
  r13.yz = float2(0,1);
  r14.xy = float2(0,0);
  ...
  while (true) {
    ...
    bitmask.w = ((~(-1 << r1.w)) << 0) & 0xffffffff;  r10.w = (((uint)0 << 0) & bitmask.w) | ((uint)r8.z & ~bitmask.w);
    r8.z = r8.w ? r10.w : r8.z;
    r8.w = cmp((int)r3.x == (int)r8.y);
  ...
  if (r3.x != 0) {
    ...
    while (true) {
      ...
      r11.z = cmp((int)r1.z == (int)r7.w);
      if (r1.w == 0) r11.w = 0; else if (r1.w+0 < 32) {       r11.w = (uint)r10.w << (32-(r1.w + 0)); r11.w = (uint)r11.w >> (32-r1.w);      } else r11.w = (uint)r10.w >> 0;
  ...
  r8.yzw = r18.xyz * r1.zzz;
  r11.xyz = r19.xyz * r1.zzz;
  r1.w = cmp(r19.w < 0.99000001);
  if (r1.w != 0) {
    r1.w = 1 + -r19.w;
    ...
    r8.yzw = r18.xyz * r1.zzz + r12.xyz;
    r9.w = 0;
    r5.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r9.xyzw, r5.z).xyz;
    r1.z = sunConstants.globalProbeExposure * r1.w + -r2.w;
    r1.z = r1.y * r1.z + r2.w;
    r11.xyz = r5.yzw * r1.zzz + r11.xyz;
  }
  r1.z = r1.x + r0.w;
  r1.z = log2(abs(r1.z));
  r1.z = r4.w * r1.z;
  ...
  r5.yzw = r11.xyz * r1.zzz;
  r11.xyz = r5.zwy * r1.yyy;
  r1.yzw = r5.yzw * r1.www;
  r0.w = sqrt(r4.w);
  r0.w = r0.w * 0.5 + 0.5;
  r0.w = r0.w * r0.w;
  r2.w = 0.5 * r0.w;
  ...
  if (r5.z != 0) {
    r5.z = cmp(0 < r5.w);
    if (r5.z != 0) {
      r5.z = sunConstants.specScale * r3.w;
      r5.z = r5.z * r5.y;
      ...
      r16.z = samp0[]..swiz;
      r16.w = samp0[]..swiz;
        r7.w = abs(r3.x) * -0.200000003 + 0.400000006;
        r17.xyz = r2.xyz * r7.www + v6.xyz;
        r17.w = 1;
      ...
      r14.xyz = -v6.xyz * r3.yyy + sunConstants.wldDir.xyz;
      r3.y = dot(r14.xyz, r14.xyz);
      r3.y = rsqrt(r3.y);
      r14.xyz = r14.xyz * r3.yyy;
      r3.y = dot(r14.xyz, r4.xyz);
      r6.z = dot(r2.xyz, r14.xyz);
      ...
      r5.y = r5.w * r5.y;
      r5.y = 0.25 * r5.y;
      r14.xyz = r5.yyy * r8.yzw + r1.yzw;
      r3.y = saturate(1 + -r3.y);
      r5.z = r3.y * r3.y;
      r5.z = r5.z * r5.z;
      r3.y = r5.z * r3.y;
      r3.y = r5.y * r3.y;
      r15.xyz = r3.yyy * r8.zwy + r11.xyz;
      r13.w = r15.z;
      r12.w = r11.z;
      r12.xyzw = r3.xxxx ? r13.xyzw : r12.xyzw;
      r15.zw = r14.xy;
      r11.zw = r1.yz;
      r13.xyzw = r3.xxxx ? r15.xyzw : r11.xyzw;
      r1.w = r3.x ? r14.z : r1.w;
      r11.z = r12.w;
      r11.xy = r13.xy;
      r1.yz = r13.zw;
    }
  ...
  while (true) {
    ...
    while (true) {
      ...
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=80)(mixed,mixed,mixed,mixed) r29.xyzw, r10.w, l(0), t11.xyzw
      r29.x = samp0[]..swiz;
      r29.y = samp0[]..swiz;
      r29.z = samp0[]..swiz;
      r29.w = samp0[]..swiz;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=80)(mixed,mixed,mixed,mixed) r30.xy, r10.w, l(16), t11.xyxx
      r30.x = samp0[]..swiz;
      r30.y = samp0[]..swiz;
        ...
        if (r11.w != 0) {
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r29.xyzw, r10.w, l(0), t12.wxyz
        r29.x = samp0[]..swiz;
        r29.y = samp0[]..swiz;
        r29.z = samp0[]..swiz;
        r29.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r30.xyzw, r10.w, l(16), t12.zxyw
        r30.x = samp0[]..swiz;
        r30.y = samp0[]..swiz;
        r30.z = samp0[]..swiz;
        r30.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r31.xyzw, r10.w, l(32), t12.xyzw
        r31.x = samp0[]..swiz;
        r31.y = samp0[]..swiz;
        r31.z = samp0[]..swiz;
        r31.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r32.xyzw, r10.w, l(48), t12.xyzw
        r32.x = samp0[]..swiz;
        r32.y = samp0[]..swiz;
        r32.z = samp0[]..swiz;
        r32.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r33.xyzw, r10.w, l(64), t12.yzwx
        r33.x = samp0[]..swiz;
        r33.y = samp0[]..swiz;
        r33.z = samp0[]..swiz;
        r33.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r34.xyzw, r10.w, l(80), t12.xyzw
        r34.x = samp0[]..swiz;
        r34.y = samp0[]..swiz;
        r34.z = samp0[]..swiz;
        r34.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r35.xyzw, r10.w, l(96), t12.yzwx
        r35.x = samp0[]..swiz;
        r35.y = samp0[]..swiz;
        r35.z = samp0[]..swiz;
        r35.w = samp0[]..swiz;
          if (3 == 0) r11.w = 0; else if (3+24 < 32) {           r11.w = (uint)r30.w << (32-(3 + 24)); r11.w = (uint)r11.w >> (32-3);          } else r11.w = (uint)r30.w >> 24;
          switch (r11.w) {
            case 4 :            r11.w = cmp(0 < r35.x);
            r36.xy = r34.zw;
            r36.z = r35.w;
            r37.xyz = -r36.xyz * float3(0.5,0.5,0.5) + r29.yzw;
            r38.xyz = -v6.xyz + r37.xyz;
            r12.w = dot(r36.xyz, r38.xyz);
            r14.z = saturate(-r12.w / r35.x);
            r39.xyz = r14.zzz * r36.xyz + r37.xyz;
            r39.xyz = r11.www ? r39.xyz : r29.yzw;
            r39.xyz = -v6.xyz + r39.xyz;
            r14.w = dot(r39.xyz, r39.xyz);
            r19.w = rsqrt(r14.w);
            r39.xyz = r39.xyz * r19.www;
            r19.w = dot(r2.xyz, r39.xyz);
            ...
            if (r24.w != 0) {
              ...
              if (r24.w != 0) {
                ...
                if (r24.w != 0) {
                  ...
                  r36.xyz = r11.www ? r36.xyz : r29.yzw;
                  r36.xyz = -v6.xyz + r36.xyz;
                  r11.w = dot(r36.xyz, r36.xyz);
                  r11.w = rsqrt(r11.w);
                  r37.xyz = r36.xyz * r11.www;
                  if (4 == 0) r12.w = 0; else if (4+16 < 32) {                   r12.w = (uint)r30.w << (32-(4 + 16)); r12.w = (uint)r12.w >> (32-4);                  } else r12.w = (uint)r30.w >> 16;
                  ...
                  r39.w = samp0[]..swiz;
                    ...
                    if (r28.w == 0) {
                    // Known bad code for instruction (needs manual fix):
                                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r38.xyzw, r12.w, l(68), t12.xyzw
                    r38.x = samp0[]..swiz;
                    r38.y = samp0[]..swiz;
                    r38.z = samp0[]..swiz;
                    r38.w = samp0[]..swiz;
                    // Known bad code for instruction (needs manual fix):
                                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r39.xyzw, r12.w, l(84), t12.xyzw
                    r39.x = samp0[]..swiz;
                    r39.y = samp0[]..swiz;
                    r39.z = samp0[]..swiz;
                    r39.w = samp0[]..swiz;
                    ...
                    r41.w = samp0[]..swiz;
                    // Known bad code for instruction (needs manual fix):
                                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r42.xy, r12.w, l(164), t12.xyxx
                    r42.x = samp0[]..swiz;
                    r42.y = samp0[]..swiz;
                    ...
                    if (4 == 0) r12.w = 0; else if (4+20 < 32) {                     r12.w = (uint)r30.w << (32-(4 + 20)); r12.w = (uint)r12.w >> (32-4);                    } else r12.w = (uint)r30.w >> 20;
                    r14.z = cmp(0 < (uint)r12.w);
                    r14.z = r3.x ? r14.z : 0;
                    if (r14.z != 0) {
                      r12.w = (int)r12.w + numLights;
                  ...
                  r12.w = r12.w + -r23.w;
                  r12.w = r4.w * r12.w + r23.w;
                  r12.w = r12.w * r14.w;
                  r30.x = r29.x;
                  r14.z = cmp(0 < r19.w);
                  r18.xyz = r12.www * r30.xyz + r8.yzw;
                  r12.w = saturate(dot(r2.xyz, r37.xyz));
                  r36.xyz = r36.xyz * r11.www + r4.xyz;
                  r11.w = dot(r36.xyz, r36.xyz);
                  r11.w = rsqrt(r11.w);
                  r36.xyz = r36.xyz * r11.www;
                  r11.w = dot(r36.xyz, r4.xyz);
                  r17.x = dot(r2.xyz, r36.xyz);
                  r19.w = abs(r17.x) * r3.w + -abs(r17.x);
                  r17.x = abs(r17.x) * r19.w + 1;
                  r19.w = r12.w * r0.w + r2.w;
                  r17.x = r17.x * r17.x;
                  r17.x = r17.x * r19.w;
                  r17.x = rcp(r17.x);
                  r12.w = r12.w * r24.w;
                  r12.w = r17.x * r12.w;
                  r12.w = r12.w * r14.w;
                  r36.xyz = r12.www * r30.xyz + r28.xyz;
                  r11.w = saturate(1 + -r11.w);
                  r14.w = r11.w * r11.w;
                  r14.w = r14.w * r14.w;
                  r11.w = r14.w * r11.w;
                  r11.w = r12.w * r11.w;
                  r37.xyz = r11.www * r30.xyz + r15.xyz;
                  r8.yzw = r14.zzz ? r18.xyz : r8.yzw;
                  r15.xyz = r14.zzz ? r37.xyz : r15.xyz;
                  r28.xyz = r14.zzz ? r36.xyz : r28.xyz;
                }
              }
            }
            break;
            ...
            r11.w = rsqrt(r11.w);
            r36.xyz = r18.xyz * r11.www;
            r12.w = dot(r2.xyz, r36.xyz);
            r14.z = saturate(r12.w);
            r14.w = cmp(0 < r14.z);
            if (r14.w != 0) {
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r36.xyzw, r10.w, l(112), t12.yzwx
            r36.x = samp0[]..swiz;
            r36.y = samp0[]..swiz;
            r36.z = samp0[]..swiz;
            r36.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r37.xyzw, r10.w, l(128), t12.zxyw
            r37.x = samp0[]..swiz;
            r37.y = samp0[]..swiz;
            r37.z = samp0[]..swiz;
            r37.w = samp0[]..swiz;
              ...
              r19.w = samp0[]..swiz;
                ...
                if (r14.w != 0) {
                // Known bad code for instruction (needs manual fix):
                                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r31.xyz, r10.w, l(220), t12.xyzx
                r31.x = samp0[]..swiz;
                r31.y = samp0[]..swiz;
                r31.z = samp0[]..swiz;
              ...
              if (r14.w != 0) {
                ...
                if (r14.w != 0) {
                  ...
                  if (r24.w != 0) {
                  // Known bad code for instruction (needs manual fix):
                                    ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r37.y, r10.w, l(144), t12.xxxx
                  r37.y = samp0[]..swiz;
                    r33.w = r34.x;
                    ...
                    if (r7.w != 0) {
                      ...
                      while (true) {
                        ...
                        r25.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r29.xyz, r10.w).x;
                ...
                if (r14.w != 0) {
                  ...
                  r18.x = abs(r17.x) * r3.w + -abs(r17.x);
                  r17.x = abs(r17.x) * r18.x + 1;
                  r14.z = r14.z * r0.w + r2.w;
                  r17.x = r17.x * r17.x;
                  r14.z = r17.x * r14.z;
                  r14.z = rcp(r14.z);
                  r14.z = r14.z * r14.w;
                  r10.w = r14.z * r10.w;
                  r10.w = 0.25 * r10.w;
                  r18.xyz = r10.www * r19.xyw + r28.xyz;
                  r11.w = saturate(1 + -r11.w);
                  r14.z = r11.w * r11.w;
                  r14.z = r14.z * r14.z;
                  r11.w = r14.z * r11.w;
                  r10.w = r11.w * r10.w;
                  r19.xyw = r10.www * r19.xyw + r15.xyz;
                  r8.yzw = r12.www ? r21.xyz : r8.yzw;
                  r15.xyz = r12.www ? r19.xyw : r15.xyz;
                  r28.xyz = r12.www ? r18.xyz : r28.xyz;
                }
              }
            }
            break;
