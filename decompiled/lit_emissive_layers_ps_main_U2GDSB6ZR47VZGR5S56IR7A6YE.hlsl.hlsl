...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  while (true) {
    ...
    if (r3.w == 0) r8.w = 0; else if (r3.w+0 < 32) {     r8.w = (uint)r7.z << (32-(r3.w + 0)); r8.w = (uint)r8.w >> (32-r3.w);    } else r8.w = (uint)r7.z >> 0;
    r7.z = r7.w ? r8.w : r7.z;
  ...
  if (r1.x != 0) {
    ...
    r13.y = r13.x;
    r13.z = r12.x;
    r14.x = dot(r13.yz, r1.xw);
    r13.x = -r12.x;
    r14.y = dot(r13.xy, r1.xw);
    r1.xw = gameTime.ww * scrollUVs.xy;
    r1.xw = r1.xw * scaleUVs.xy + r14.xy;
  ...
  r12.xyz = r12.xyz * r1.www;
  r1.w = -r12.w * alphaLayer2 + 1;
  r9.xyz = r9.xyz * r1.www + r12.xyz;
  ...
  if (r7.z == 0) {
    ...
    if (r5.z != 0) {
      ...
      r5.w = dot(r12.yzw, float3(0.212599993,0.715200007,0.0722000003));
      r21.xyz = r23.xyz * r4.www + r12.yzw;
      r13.w = 0;
      r12.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r13.xyzw, r5.y).xyz;
      r4.w = sunConstants.globalProbeExposure * r5.z + -r5.w;
      r4.w = r8.y * r4.w + r5.w;
