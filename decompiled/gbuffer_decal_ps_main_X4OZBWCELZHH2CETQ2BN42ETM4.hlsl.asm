...
sample_indexable(texture2d)(float,float,float,float) r6.xyz, r0.yzyy, t16.xyzw, s4
...
mad r5.xy, r0.yzyy, cb0[13].zzzz, r4.xyxx
dp3 r0.y, r5.xyzx, r5.xyzx
rsq r0.y, r0.y
mul r4.xyz, r0.yyyy, r5.xyzx
mad r0.y, r2.w, cb0[13].z, r1.w
...
mad r4.z, r0.y, l(0.49755621), r0.z
