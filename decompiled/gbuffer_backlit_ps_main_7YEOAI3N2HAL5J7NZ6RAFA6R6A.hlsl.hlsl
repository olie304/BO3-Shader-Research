// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:26:14 2021
  ...
  out float2 o3 : SV_TARGET3)
{
  ...
  if (r3.x != 0) {
    ...
    r3.xz = r3.xz * r6.zw + r6.xy;
    r3.xz = v0.xy + -r3.xz;
    r3.w = r5.x + r5.y;
    r3.w = r4.z * r3.y + r3.w;
    r3.w = 0.5 * r3.w;
    r6.xyz = r4.xyz * r3.yyy + -r3.www;
    r4.w = max(r6.y, r6.z);
    r4.w = max(r6.x, r4.w);
    r3.w = max(r4.w, r3.w);
    r4.w = cmp(r3.w == r6.x);
    ...
    r7.x = 1;
    r2.x = 0;
    r7.xyzw = r4.wwww ? r7.xyzw : r2.xyzw;
    r3.w = r4.w ? r5.z : r3.w;
    r4.w = cmp(r3.w == r6.y);
    ...
    r6.x = 3;
    r6.xyzw = r3.wwww ? r6.xyzw : r7.xyzw;
    r3.w = r6.y + r6.z;
    r7.z = r3.w + r6.w;
    r7.y = r6.w + -r6.y;
    r7.x = -r6.z * 3 + r7.z;
  ...
  r6.x = 1;
  r2.x = 0;
  r2.xyzw = r3.yyyy ? r6.xyzw : r2.xyzw;
  r1.z = r3.y ? r3.w : r1.z;
  r3.y = cmp(r1.z == r4.y);
  r6.yzw = float3(-1,1,-1) * r2.yzw;
  r3.w = 2 + r1.z;
