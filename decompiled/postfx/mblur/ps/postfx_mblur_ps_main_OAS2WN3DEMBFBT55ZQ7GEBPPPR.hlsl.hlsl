  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  if (r1.y != 0) {
    ...
    r2.xyzw = r2.xyzw * float4(0.363636374,0.363636374,0.363636374,0.363636374) + v1.xyxy;
    r5.xyzw = r3.zwzw * float4(0.181818187,0.181818187,-0.181818187,-0.181818187) + r2.zwzw;
    ...
    r6.xyzw = r3.zwzw * float4(0.545454562,0.545454562,-0.545454562,-0.545454562) + r2.zwzw;
    ...
    r2.xyzw = r3.zwzw * float4(0.909090936,0.909090936,-0.909090936,-0.909090936) + r2.xyzw;
    ...
    r8.xyzw = saturate(r1.yyyy * r4.yzyw + float4(-1.5,-1.5,-1.5,-1.5));
    ...
    r0.xyz = r2.xyz * float3(0.166666672,0.166666672,0.166666672) + r1.yzw;
  } else {
    r1.xyzw = r3.zwzw * r1.xxxx;
    r1.xyzw = r1.xyzw * float4(0.363636374,0.363636374,0.363636374,0.363636374) + v1.xyxy;
    r2.xyzw = r3.zwzw * float4(-0.909090936,-0.909090936,-0.545454562,-0.545454562) + r1.zwzw;
    ...
    r2.xyz = r4.xyz * float3(0.166666672,0.166666672,0.166666672) + r2.xyz;
    r4.xyzw = r3.zwzw * float4(-0.181818187,-0.181818187,0.181818187,0.181818187) + r1.zwzw;
    r5.xyz = colorMapSampler.SampleLevel(linearClamp_s, r4.xy, 1).xyz;
    r2.xyz = r5.xyz * float3(0.166666672,0.166666672,0.166666672) + r2.xyz;
    r4.xyz = colorMapSampler.SampleLevel(linearClamp_s, r4.zw, 1).xyz;
    r2.xyz = r4.xyz * float3(0.166666672,0.166666672,0.166666672) + r2.xyz;
    r1.xyzw = r3.xyzw * float4(0.545454562,0.545454562,0.909090936,0.909090936) + r1.xyzw;
    r3.xyz = colorMapSampler.SampleLevel(linearClamp_s, r1.xy, 1).xyz;
    r2.xyz = r3.xyz * float3(0.166666672,0.166666672,0.166666672) + r2.xyz;
    r1.xyz = colorMapSampler.SampleLevel(linearClamp_s, r1.zw, 1).xyz;
    r0.xyz = r1.xyz * float3(0.166666672,0.166666672,0.166666672) + r2.xyz;
  }
  o0.xyzw = r0.xyzw;
  return;
}