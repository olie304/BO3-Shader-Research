...
// motionVectorsAA                   texture  float2          2d             t6      1 
...
ftoi r0.xy, v0.xyxx
mov r0.zw, l(0,0,0,0)
ld_indexable(texture2d)(float,float,float,float) r1.xy, r0.xyww, t6.xyzw
ld_indexable(texture2d)(float,float,float,float) r0.x, r0.xyzw, t0.xyzw
add r0.yz, |r1.xxyx|, |r1.xxyx|
min r0.yz, r0.yyzy, l(0.000000, 1.000000, 1.000000, 0.000000)
mul r0.yz, r0.yyzy, l(0.000000, 10.000000, 10.000000, 0.000000)
...
mad r0.yz, r1.zzwz, l(0.000000, 30.000000, 30.000000, 0.000000), r0.yyzy
movc r0.yz, r1.xxyx, r0.yyzy, -r0.yyzy
mul r0.yz, r0.yyzy, cb7[12].wwww
div r1.xy, cb1[44].xyxx, cb1[45].xyxx
mul r0.yz, r0.yyzy, r1.xxyx
mul r0.yz, r0.yyzy, l(0.000000, 0.500000, 0.500000, 0.000000)
dp2 r0.w, r0.yzyy, r0.yzyy
sqrt r0.w, r0.w
min r1.x, r0.w, l(20.000000)
add r0.w, r0.w, l(0.000100)
add r1.x, r1.x, r1.x
mul r0.yz, r0.yyzy, r1.xxxx
div r0.yz, r0.yyzy, r0.wwww
mad o0.xy, r0.yzyy, l(0.00392157, 0.00392157, 0.000000, 0.000000), l(0.50196081, 0.50196081, 0.000000, 0.000000)
