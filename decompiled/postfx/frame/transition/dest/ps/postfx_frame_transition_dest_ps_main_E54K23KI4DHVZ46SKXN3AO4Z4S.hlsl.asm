...
//   float brightnessBoost;             // Offset:  172 Size:     4
//   float durdenBlur;                  // Offset:  176 Size:     4
//
// }
//
...
// warpMaskMap                       texture  float4          2d             t6      1 
// durdenMap                         texture  float4          2d             t7      1 
...
dcl_output o0.xyzw
dcl_temps 4
mul r0.x, cb0[11].x, cb1[44].z
mul r0.x, r0.x, cb3[0].w
mad_sat r1.xyzw, r0.xxxx, l(-0.56308931, -0.26805860, -0.10714890, -0.65222108), v1.xyxy
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r1.xyxx, t7.xyzw, s1
sample_indexable(texture2d)(float,float,float,float) r1.xyzw, r1.zwzz, t7.xyzw, s1
add r1.xyzw, r1.xyzw, r2.xyzw
mad_sat r2.xyzw, r0.xxxx, l(-0.29749349, 0.23678830, -0.94028169, 0.28764710), v1.xyxy
sample_indexable(texture2d)(float,float,float,float) r3.xyzw, r2.xyxx, t7.xyzw, s1
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r2.zwzz, t7.xyzw, s1
add r1.xyzw, r1.xyzw, r3.xyzw
add r1.xyzw, r2.xyzw, r1.xyzw
mad_sat r2.xyzw, r0.xxxx, l(0.374713, -0.33693859, 0.45787710, -0.74987531), v1.xyxy
sample_indexable(texture2d)(float,float,float,float) r3.xyzw, r2.xyxx, t7.xyzw, s1
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r2.zwzz, t7.xyzw, s1
add r1.xyzw, r1.xyzw, r3.xyzw
add r1.xyzw, r2.xyzw, r1.xyzw
mad_sat r2.xyzw, r0.xxxx, l(-0.44277370, -0.886701, 0.78879791, -0.427878), v1.xyxy
sample_indexable(texture2d)(float,float,float,float) r3.xyzw, r2.xyxx, t7.xyzw, s1
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r2.zwzz, t7.xyzw, s1
add r1.xyzw, r1.xyzw, r3.xyzw
add r1.xyzw, r2.xyzw, r1.xyzw
mad_sat r2.xyzw, r0.xxxx, l(-0.02906443, -0.20072490, 0.42776331, 0.16513520), v1.xyxy
sample_indexable(texture2d)(float,float,float,float) r3.xyzw, r2.xyxx, t7.xyzw, s1
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r2.zwzz, t7.xyzw, s1
add r1.xyzw, r1.xyzw, r3.xyzw
add r1.xyzw, r2.xyzw, r1.xyzw
mad_sat r2.xyzw, r0.xxxx, l(-0.23078820, 0.64043868, -0.65763211, 0.67459911), v1.xyxy
sample_indexable(texture2d)(float,float,float,float) r3.xyzw, r2.xyxx, t7.xyzw, s1
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r2.zwzz, t7.xyzw, s1
add r1.xyzw, r1.xyzw, r3.xyzw
add r1.xyzw, r2.xyzw, r1.xyzw
mad_sat r2.xyzw, r0.xxxx, l(0.86913669, 0.00676916, 0.28367040, 0.93041968), v1.xyxy
mad_sat r0.xyzw, r0.xxxx, l(0.51202959, 0.59052241, -0.96844608, -0.18936320), v1.xyxy
sample_indexable(texture2d)(float,float,float,float) r3.xyzw, r2.xyxx, t7.xyzw, s1
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r2.zwzz, t7.xyzw, s1
add r1.xyzw, r1.xyzw, r3.xyzw
add r1.xyzw, r2.xyzw, r1.xyzw
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r0.xyxx, t7.xyzw, s1
sample_indexable(texture2d)(float,float,float,float) r0.xyzw, r0.zwzz, t7.xyzw, s1
add r1.xyzw, r1.xyzw, r2.xyzw
...
mul r1.yw, r1.yyyy, r1.xxxz
mul r1.xz, r0.wwww, r1.xxzx
mad r1.xz, r1.xxzx, l(0.500000, 0.000000, 0.500000, 0.000000), l(0.500000, 0.000000, 0.500000, 0.000000)
mad r1.yw, r1.yyyw, l(0.000000, 0.500000, 0.000000, 0.500000), l(0.000000, 0.500000, 0.000000, 0.500000)
lt r0.w, l(0.000000), cb3[0].x
movc r1.xy, r0.wwww, r1.ywyy, r1.xzxx
sample_indexable(texture2d)(float,float,float,float) r1.xyzw, r1.xyxx, t0.xyzw, s1
mad r1.xyz, -r1.xyzx, l(0.00003052, 0.00003052, 0.00003052, 0.000000), l(1.000000, 1.000000, 1.000000, 0.000000)
mov o0.w, r1.w
mad r0.xyz, -r1.xyzx, r0.xyzx, l(1.000000, 1.000000, 1.000000, 0.000000)
add r0.w, cb0[10].w, l(-1.000000)
mad r0.w, cb3[0].y, r0.w, l(1.000000)
