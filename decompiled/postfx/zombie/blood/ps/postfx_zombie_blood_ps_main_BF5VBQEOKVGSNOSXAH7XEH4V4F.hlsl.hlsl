  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.w = 0.5 + r0.z;
  r0.w = frac(r0.w);
  r1.x = 6.28318548 * r0.w;
  r1.x = cos(r1.x);
  r1.x = r1.x * 0.5 + 0.5;
  r1.x = 1 + -r1.x;
  r1.y = colorScroll.y + -colorScroll.x;
  r0.w = r0.w * r1.y + colorScroll.x;
  r1.zw = v1.xy * float2(2,2) + float2(-1,-1);
  r2.xy = r1.zw / r0.ww;
  r2.xyzw = colorMap.Sample(bilinearSampler_s, r2.xy).xyzw;
  r0.z = r0.z * r1.y + colorScroll.x;
  r0.zw = r1.zw / r0.zz;
  r3.xyzw = colorMap.Sample(bilinearSampler_s, r0.zw).xyzw;
  r2.xyzw = -r3.xyzw + r2.xyzw;
  r2.xyzw = r1.xxxx * r2.xyzw + r3.xyzw;
  r0.x = r0.x * r1.y + colorScroll.x;
  r0.z = r0.y * r1.y + colorScroll.x;
  ...
  r3.xyzw = colorMap.Sample(bilinearSampler_s, r0.zw).xyzw;
  r0.xz = r1.zw / r0.xx;
  r4.xyzw = colorMap.Sample(bilinearSampler_s, r0.xz).xyzw;
  r3.xyzw = -r4.xyzw + r3.xyzw;
  r0.xyzw = r0.yyyy * r3.xyzw + r4.xyzw;
  ...
  r1.y = revealMap.Sample(bilinearClampler_s, v1.xy).x;
  r1.y = 1 + -r1.y;
  r2.x = r1.y * r1.x + 1;
  r1.x = -r1.y * r1.x + 1;
  r1.xy = r1.zw * r1.xx;
