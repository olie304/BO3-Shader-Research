...
mul r0.yz, cb0[11].xxyx, cb1[69].wwww
mad r0.yz, v1.xxyx, cb0[11].zzwz, r0.yyzy
lt r0.w, l(0.000000), r0.x
lt r1.x, l(0.000000), cb0[10].z
and r0.w, r0.w, r1.x
sample_indexable(texture2d)(float,float,float,float) r1.xy, r0.yzyy, t9.xyzw, s1
if_nz r0.w
  mul r1.zw, cb0[10].zzzz, cb1[44].zzzw
...
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r0.yzyy, t7.xyzw, s1
add_sat r0.yz, r1.xxyx, v1.xxyx
...
mul r1.xyz, r1.xyzx, l(0.00006104, 0.00006104, 0.00006104, 0.000000)
mul r5.xyz, r0.yzwy, r0.yzwy
...
mad r2.xyz, -r2.xyzx, r0.xxxx, l(1.000000, 1.000000, 1.000000, 0.000000)
mul r1.xyz, r1.xyzx, r2.xyzx
mad r0.xyz, r0.yzwy, r3.xyzx, r1.xyzx
movc r0.xyz, r4.xyzx, r5.xyzx, r0.xyzx
