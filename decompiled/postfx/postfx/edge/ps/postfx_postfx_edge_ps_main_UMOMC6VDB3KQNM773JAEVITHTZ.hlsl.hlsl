...
Texture2D<float4> codeTexture0 : register(t7);
Texture2D<float4> codeTexture1 : register(t9);
Texture2D<float4> codeTexture2 : register(t10);
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.xyzw = postFxControl0.wwww * float4(0.000781250012,-0.00138888892,-0.000781250012,0.00138888892) + v1.xyxy;
  r0.x = floatZSampler.Sample(samp0_s, r0.xy).x;
  r0.y = floatZSampler.Sample(samp0_s, r0.zw).x;
  r0.w = r0.x + r0.y;
  r1.xyzw = postFxControl0.wwww * float4(0.000781250012,0,0.000781250012,0.00138888892) + v1.xyxy;
  r1.x = floatZSampler.Sample(samp0_s, r1.xy).x;
  r1.y = floatZSampler.Sample(samp0_s, r1.zw).x;
  r2.xyzw = postFxControl0.wwww * float4(-0.000781250012,0,0,0.00138888892) + v1.xyxy;
  r1.z = floatZSampler.Sample(samp0_s, r2.xy).x;
  r1.w = floatZSampler.Sample(samp0_s, r2.zw).x;
  r0.x = r1.x + r1.z;
  r2.xyzw = postFxControl0.wwww * float4(0,-0.00138888892,-0.000781250012,-0.00138888892) + v1.xyxy;
  r1.x = floatZSampler.Sample(samp0_s, r2.xy).x;
  r1.z = floatZSampler.Sample(samp0_s, r2.zw).x;
  r0.yz = r1.wy + r1.xz;
  r1.x = floatZSampler.Sample(samp0_s, v1.xy).x;
  r0.xyzw = r1.xxxx * float4(2,2,2,2) + -r0.xyzw;
  r0.xyzw = float4(1000,1000,1000,1000) * abs(r0.xyzw);
  r0.xyzw = r0.xyzw / r1.xxxx;
  r0.x = max(r0.x, r0.y);
  r0.x = max(r0.x, r0.z);
  r0.x = max(r0.x, r0.w);
  r0.y = cmp(r0.x < 0.300000012);
  r0.x = saturate(r0.x);
  r0.z = codeTexture2.Sample(samp0_s, v1.xy).x;
  r0.w = cmp(r0.z < r1.x);
  r1.x = cmp(0.899999976 < r1.x);
  r0.z = cmp(0 < r0.z);
  r0.z = r0.w ? r0.z : 0;
  r0.z = (int)r1.x | (int)r0.z;
  r1.xyzw = codeTexture1.Sample(samp0_s, v1.xy).xyzw;
  r1.xyzw = r0.zzzz ? float4(0,0,0,0) : r1.xyzw;
  r0.z = dot(float3(0.349999994,0.5,0.150000006), r1.xyz);
  r0.z = cmp(9.99999975e-06 < r0.z);
  r0.y = (int)r0.z | (int)r0.y;
  r0.x = r0.y ? 0 : r0.x;
  r2.xyzw = codeTexture0.Sample(samp0_s, v1.xy).xyzw;
  r3.xyzw = colorMapSampler.Sample(samp0_s, v1.xy).xyzw;
  r2.xyzw = -r3.xyzw + r2.xyzw;
  r2.xyzw = postFxControl0.xxxx * r2.xyzw + r3.xyzw;
  r1.xyzw = r2.xyzw * float4(3.05175781e-05,3.05175781e-05,3.05175781e-05,1) + r1.xyzw;
