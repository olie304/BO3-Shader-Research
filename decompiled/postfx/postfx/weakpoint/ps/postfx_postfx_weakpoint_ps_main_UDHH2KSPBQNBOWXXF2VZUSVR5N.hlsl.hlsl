  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r2.y = codeTexture2.Load(r0.xyw).x;
  r3.xyzw = float4(0,-0.00138888892,0,0.00138888892) + v1.xyxy;
  r2.z = codeTexture2.Sample(samp0_s, r3.xy).x;
  r2.w = codeTexture2.Sample(samp0_s, r3.zw).x;
  r3.xyzw = float4(0.000781250012,0,-0.000781250012,0) + v1.xyxy;
  r3.x = codeTexture2.Sample(samp0_s, r3.xy).x;
  r3.y = codeTexture2.Sample(samp0_s, r3.zw).x;
  r4.xyzw = float4(0.000781250012,0.00138888892,-0.000781250012,-0.00138888892) + v1.xyxy;
  r3.z = codeTexture2.Sample(samp0_s, r4.xy).x;
  r3.w = codeTexture2.Sample(samp0_s, r4.zw).x;
  r4.xyzw = float4(0.000781250012,-0.00138888892,-0.000781250012,0.00138888892) + v1.xyxy;
  r4.x = codeTexture2.Sample(samp0_s, r4.xy).x;
  r4.y = codeTexture2.Sample(samp0_s, r4.zw).x;
  r4.z = max(9.99999994e-09, r2.y);
  r4.z = zNear.x / r4.z;
  r5.xy = float2(-0.5,-0.5) + v1.xy;
  r4.w = r5.x * r4.z;
  r4.w = postFxControlF.z * r4.w;
  r5.x = -r5.y * r4.z;
  r5.x = postFxControlF.w * r5.x;
  r5.xyz = postFxControl1.xyz * r5.xxx;
  r5.xyz = r4.www * postFxControl0.xyz + r5.xyz;
  r5.xyz = r4.zzz * postFxControl2.xyz + r5.xyz;
  r5.xyz = postFxControl3.xyz + r5.xyz;
  r4.zw = float2(0.200000003,0.300000012) * gameTime.ww;
  r4.zw = r5.xy * float2(0.0250000004,0.0250000004) + r4.zw;
  r6.xyzw = gridTexture.Sample(samplerBilinearWrap_s, r4.zw).xyzw;
  if (r2.x != 0) {
    o0.xyz = r1.xyz;
    o0.w = 1;
    return;
  }
  r2.x = cmp(r2.y == 0.000000);
  if (r2.x != 0) {
    o0.xyz = r1.xyz;
    o0.w = 1;
    return;
  }
  r0.xyzw = codeTexture1.Load(r0.xyz).xyzw;
  r0.y = max(r0.y, r0.z);
  r0.x = max(r0.x, r0.y);
  r0.x = max(r0.x, r0.w);
  r0.x = cmp(0 < r0.x);
  ...
  r0.xz = r3.xz + r3.yw;
  r0.w = r4.x + r4.y;
  r0.xyzw = r2.yyyy * float4(2,2,2,2) + -r0.xyzw;
  ...
  r1.x = 20 * gameTime.w;
  r1.x = frac(r1.x);
  r1.x = gameTime.w * 20 + -r1.x;
  r3.z = 0.0500000007 * r1.x;
  r3.w = v1.y;
  r1.x = dot(r3.zw, float2(37.3498383,59.3948402));
  r3.x = frac(r1.x);
  r1.x = dot(r3.xzw, float3(81.2394867,37.3498383,59.3948402));
  r3.y = frac(r1.x);
  r1.x = dot(r3.xyzw, float4(81.2394867,17.3480244,37.3498383,59.3948402));
  r3.z = frac(r1.x);
  r1.x = dot(r3.xyzw, float4(81.2394867,17.3480244,37.3498383,59.3948402));
  r3.w = frac(r1.x);
  r1.x = dot(r3.xyzw, float4(81.2394867,17.3480244,37.3498383,59.3948402));
  ...
  r1.x = frac(r1.x);
  r1.x = r1.x * 0.5 + 0.5;
  r1.y = cmp(postFxControlF.x < 2);
  if (r1.y != 0) {
    r1.yz = r2.yw + -r2.zy;
    r1.y = max(r1.y, r1.z);
    r1.z = r2.y + -r1.w;
    r1.z = 9.99999997e-07 + r1.z;
    r1.w = 0.00249999994 * r5.z;
    r1.w = frac(r1.w);
    r2.xy = cmp(r5.zz < float2(-400,-100));
    r2.z = cmp(0 < r5.z);
    ...
    r1.w = r1.w * r0.x;
    r1.z = cmp(0 >= r1.z);
    r2.xzw = r1.xxx * r1.www + r0.yzw;
    r2.xzw = r1.zzz ? r2.xzw : r0.yzw;
    r1.z = cmp(r1.w == 0.000000);
    r1.w = r2.y ? 0 : 1;
    r2.y = cmp(r1.y < 0);
    r1.y = r2.y ? 0 : r1.y;
    r2.y = cmp(r1.y < 9.99999975e-06);
    r1.y = r1.y * r1.w;
    r1.y = 100000 * r1.y;
    r1.y = r2.y ? r1.y : r1.w;
    r1.y = dot(r1.yy, r1.xx);
    r3.xyz = r1.yyy * r6.xyz;
    r3.xyz = r3.xyz * r6.www + r2.xzw;
    r1.yzw = r1.zzz ? r3.xyz : r2.xzw;
  } else {
    r0.yzw = r1.xxx * r0.xxx + r0.yzw;
    r0.x = cmp(r0.x == 0.000000);
    r1.x = r1.x + r1.x;
    r2.xyz = r1.xxx * r6.xyz;
    r2.xyz = r2.xyz * r6.www + r0.yzw;
    r1.yzw = r0.xxx ? r2.xyz : r0.yzw;
  }
  o0.xyz = float3(32768,32768,32768) * r1.yzw;
  o0.w = 1;
  return;
}