...
// dispFX                            texture  float4          2d             t1      1 
// boltFX                            texture  float4          2d             t2      1 
...
dcl_output o0.xyz
dcl_temps 3
sample_indexable(texture2d)(float,float,float,float) r0.xy, v1.zwzz, t1.xyzw, s0
mul r0.z, v1.y, cb8[0].w
mad r0.xy, r0.xyxx, r0.zzzz, v1.xyxx
sample_indexable(texture2d)(float,float,float,float) r0.xyz, r0.xyxx, t0.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r1.xyz, v2.zwzz, t2.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r2.xyz, v2.xyxx, t2.xyzw, s0
add r1.xyz, r1.xyzx, -r2.xyzx
mad r1.xyz, v3.xxxx, r1.xyzx, r2.xyzx
mad r0.xyz, r1.xyzx, l(32768.000000, 32768.000000, 32768.000000, 0.000000), r0.xyzx
sample_indexable(texture2d)(float,float,float,float) r1.xyz, v1.xyxx, t0.xyzw, s0
add r0.xyz, r0.xyzx, -r1.xyzx
mad o0.xyz, cb8[1].xxxx, r0.xyzx, r1.xyzx
ret 
