  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.xy = -postFxControl1.xz + r0.xy;
  r0.x = dot(r0.xy, r0.xy);
  r0.y = r0.x * r0.x;
  r0.x = cmp(r0.x < postFxControl1.w);
  r0.z = postFxControl1.w * postFxControl1.w;
  r0.y = r0.y / r0.z;
  r0.z = gameTime.w + -postFxControl2.x;
  r0.z = r0.z / postFxControl2.y;
  r0.z = 1 + -r0.z;
  r0.y = r0.y * r0.z;
  r0.yzw = float3(0.5,0.800000012,1) * r0.yyy;
