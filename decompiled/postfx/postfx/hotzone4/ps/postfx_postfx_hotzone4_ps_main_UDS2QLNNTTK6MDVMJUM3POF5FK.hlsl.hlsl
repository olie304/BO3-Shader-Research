  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.y = -0.5 + v1.x;
  r0.y = r0.y * r1.y;
  r1.x = 1.69885421 * r0.y;
  r0.yz = -postFxControl0.xz + r1.xy;
  r0.y = dot(r0.yz, r0.yz);
  r0.y = sqrt(r0.y);
  r0.z = cmp(r0.y < r0.x);
  r0.x = r0.y / r0.x;
  r0.x = r0.z ? r0.x : 1;
  r0.zw = postFxControl0.ww * float2(500,500) + float2(50,-50);
  r1.z = r0.z + -r0.y;
  ...
  r0.x = r0.w ? r1.z : r0.x;
  r0.x = r0.y ? r0.x : 0;
  r0.y = 250 * postFxControl1.w;
  r0.zw = -postFxControl1.xz + r1.xy;
  r0.z = dot(r0.zw, r0.zw);
  r0.z = sqrt(r0.z);
  r0.w = cmp(r0.z < r0.y);
  r0.y = r0.z / r0.y;
  r0.y = r0.w ? r0.y : 1;
  r1.zw = postFxControl1.ww * float2(500,500) + float2(50,-50);
  r0.w = r1.z + -r0.z;
  ...
  r0.y = r0.z ? r0.y : 0;
  r0.x = r0.x + r0.y;
  r0.y = 250 * postFxControl2.w;
  r0.zw = -postFxControl2.xz + r1.xy;
  r0.z = dot(r0.zw, r0.zw);
  r0.z = sqrt(r0.z);
  r0.w = cmp(r0.z < r0.y);
  r0.y = r0.z / r0.y;
  r0.y = r0.w ? r0.y : 1;
  r1.zw = postFxControl2.ww * float2(500,500) + float2(50,-50);
  r0.w = r1.z + -r0.z;
  r0.w = 0.00999999978 * r0.w;
  r1.w = cmp(r1.w < r0.z);
  r0.z = cmp(r1.z >= r0.z);
  ...
  r0.y = r0.z ? r0.y : 0;
  r0.x = r0.x + r0.y;
  r0.y = 250 * postFxControl3.w;
  r0.zw = -postFxControl3.xz + r1.xy;
  r0.z = dot(r0.zw, r0.zw);
  r0.z = sqrt(r0.z);
  r0.w = cmp(r0.z < r0.y);
  r0.y = r0.z / r0.y;
  r0.y = r0.w ? r0.y : 1;
  r1.zw = postFxControl3.ww * float2(500,500) + float2(50,-50);
  r0.w = r1.z + -r0.z;
  r0.w = 0.00999999978 * r0.w;
  r1.w = cmp(r1.w < r0.z);
  r0.z = cmp(r1.z >= r0.z);
  ...
  r0.y = r0.z ? r0.y : 0;
  r0.x = r0.x + r0.y;
  r0.y = 250 * postFxControl4.w;
  r0.zw = -postFxControl4.xz + r1.xy;
  r0.z = dot(r0.zw, r0.zw);
  r0.z = sqrt(r0.z);
  r0.w = cmp(r0.z < r0.y);
  r0.y = r0.z / r0.y;
  r0.y = r0.w ? r0.y : 1;
  r1.zw = postFxControl4.ww * float2(500,500) + float2(50,-50);
  r0.w = r1.z + -r0.z;
  r0.w = 0.00999999978 * r0.w;
  r1.w = cmp(r1.w < r0.z);
  r0.z = cmp(r1.z >= r0.z);
  ...
  r0.y = r0.z ? r0.y : 0;
  r0.x = r0.x + r0.y;
  r0.y = 250 * postFxControl5.w;
  r0.zw = -postFxControl5.xz + r1.xy;
  r0.z = dot(r0.zw, r0.zw);
  r0.z = sqrt(r0.z);
  r0.w = cmp(r0.z < r0.y);
  r0.y = r0.z / r0.y;
  r0.y = r0.w ? r0.y : 1;
  r1.zw = postFxControl5.ww * float2(500,500) + float2(50,-50);
  r0.w = r1.z + -r0.z;
  r0.w = 0.00999999978 * r0.w;
  r1.w = cmp(r1.w < r0.z);
  r0.z = cmp(r1.z >= r0.z);
  ...
  r0.y = r0.z ? r0.y : 0;
  r0.x = r0.x + r0.y;
  r0.y = 250 * postFxControl6.w;
  r0.zw = -postFxControl6.xz + r1.xy;
  r0.z = dot(r0.zw, r0.zw);
  r0.z = sqrt(r0.z);
  r0.w = cmp(r0.z < r0.y);
  r0.y = r0.z / r0.y;
  r0.y = r0.w ? r0.y : 1;
  r1.zw = postFxControl6.ww * float2(500,500) + float2(50,-50);
  r0.w = r1.z + -r0.z;
  r0.w = 0.00999999978 * r0.w;
  r1.w = cmp(r1.w < r0.z);
  r0.z = cmp(r1.z >= r0.z);
  ...
  r0.y = r0.z ? r0.y : 0;
  r0.x = r0.x + r0.y;
  r0.y = 250 * postFxControl7.w;
  r0.zw = -postFxControl7.xz + r1.xy;
  r0.z = dot(r0.zw, r0.zw);
  r0.z = sqrt(r0.z);
  r0.w = cmp(r0.z < r0.y);
  r0.y = r0.z / r0.y;
  r0.y = r0.w ? r0.y : 1;
  r1.zw = postFxControl7.ww * float2(500,500) + float2(50,-50);
  r0.w = r1.z + -r0.z;
  r0.w = 0.00999999978 * r0.w;
  r1.w = cmp(r1.w < r0.z);
  r0.z = cmp(r1.z >= r0.z);
  ...
  r0.y = r0.z ? r0.y : 0;
  r0.x = r0.x + r0.y;
  r0.y = 250 * postFxControl8.w;
  r0.zw = -postFxControl8.xz + r1.xy;
  r0.z = dot(r0.zw, r0.zw);
  r0.z = sqrt(r0.z);
  r0.w = cmp(r0.z < r0.y);
  r0.y = r0.z / r0.y;
  r0.y = r0.w ? r0.y : 1;
  r1.zw = postFxControl8.ww * float2(500,500) + float2(50,-50);
  r0.w = r1.z + -r0.z;
  r0.w = 0.00999999978 * r0.w;
  r1.w = cmp(r1.w < r0.z);
  r0.z = cmp(r1.z >= r0.z);
  ...
  r0.y = r0.z ? r0.y : 0;
  r0.x = r0.x + r0.y;
  r0.yz = -postFxControl9.xz + r1.xy;
  r0.y = dot(r0.yz, r0.yz);
  r0.y = sqrt(r0.y);
  r0.z = 250 * postFxControl9.w;
  r0.w = cmp(r0.y < r0.z);
  r0.z = r0.y / r0.z;
  r0.z = r0.w ? r0.z : 1;
  r1.zw = postFxControl9.ww * float2(500,500) + float2(50,-50);
  r0.w = r1.z + -r0.y;
  r0.w = 0.00999999978 * r0.w;
  r1.w = cmp(r1.w < r0.y);
  r0.y = cmp(r1.z >= r0.y);
  ...
  r0.y = r0.y ? r0.z : 0;
  r0.x = r0.x + r0.y;
  r0.yz = -postFxControlA.xz + r1.xy;
  r0.y = dot(r0.yz, r0.yz);
  r0.y = sqrt(r0.y);
  r0.z = 250 * postFxControlA.w;
  r0.w = cmp(r0.y < r0.z);
  r0.z = r0.y / r0.z;
  r0.z = r0.w ? r0.z : 1;
  r1.zw = postFxControlA.ww * float2(500,500) + float2(50,-50);
  r0.w = r1.z + -r0.y;
  r0.w = 0.00999999978 * r0.w;
  r1.w = cmp(r1.w < r0.y);
  r0.y = cmp(r1.z >= r0.y);
  ...
  r0.y = r0.y ? r0.z : 0;
  r0.x = r0.x + r0.y;
  r0.yz = -postFxControlB.xz + r1.xy;
  r0.y = dot(r0.yz, r0.yz);
  r0.y = sqrt(r0.y);
  r0.z = 250 * postFxControlB.w;
  r0.w = cmp(r0.y < r0.z);
  r0.z = r0.y / r0.z;
  r0.z = r0.w ? r0.z : 1;
  r1.zw = postFxControlB.ww * float2(500,500) + float2(50,-50);
  r0.w = r1.z + -r0.y;
  r0.w = 0.00999999978 * r0.w;
  r1.w = cmp(r1.w < r0.y);
  r0.y = cmp(r1.z >= r0.y);
  ...
  r0.y = r0.y ? r0.z : 0;
  r0.x = r0.x + r0.y;
  r0.yz = -postFxControlC.xz + r1.xy;
  r0.y = dot(r0.yz, r0.yz);
  r0.y = sqrt(r0.y);
  r0.z = 250 * postFxControlC.w;
  r0.w = cmp(r0.y < r0.z);
  r0.z = r0.y / r0.z;
  r0.z = r0.w ? r0.z : 1;
  r1.zw = postFxControlC.ww * float2(500,500) + float2(50,-50);
  r0.w = r1.z + -r0.y;
  r0.w = 0.00999999978 * r0.w;
  r1.w = cmp(r1.w < r0.y);
  r0.y = cmp(r1.z >= r0.y);
  ...
  r0.y = r0.y ? r0.z : 0;
  r0.x = r0.x + r0.y;
  r0.yz = -postFxControlD.xz + r1.xy;
  r0.y = dot(r0.yz, r0.yz);
  r0.y = sqrt(r0.y);
  r0.z = 250 * postFxControlD.w;
  r0.w = cmp(r0.y < r0.z);
  r0.z = r0.y / r0.z;
  r0.z = r0.w ? r0.z : 1;
  r1.zw = postFxControlD.ww * float2(500,500) + float2(50,-50);
  r0.w = r1.z + -r0.y;
  r0.w = 0.00999999978 * r0.w;
  r1.w = cmp(r1.w < r0.y);
  r0.y = cmp(r1.z >= r0.y);
  ...
  r0.y = r0.y ? r0.z : 0;
  r0.x = r0.x + r0.y;
  r0.yz = -postFxControlE.xz + r1.xy;
  r1.xz = -postFxControlF.xz + r1.xy;
  r0.w = cmp(r1.y < 10);
  r1.x = dot(r1.xz, r1.xz);
  r1.x = sqrt(r1.x);
  r0.y = dot(r0.yz, r0.yz);
  r0.y = sqrt(r0.y);
  r0.z = 250 * postFxControlE.w;
  r1.y = cmp(r0.y < r0.z);
  r0.z = r0.y / r0.z;
  r0.z = r1.y ? r0.z : 1;
  r1.yz = postFxControlE.ww * float2(500,500) + float2(50,-50);
  r1.w = r1.y + -r0.y;
  ...
  r0.y = r0.y ? r0.z : 0;
  r0.x = r0.x + r0.y;
  r0.y = 250 * postFxControlF.w;
  r0.z = cmp(r1.x < r0.y);
  r0.y = r1.x / r0.y;
  r0.y = r0.z ? r0.y : 1;
  r1.yz = postFxControlF.ww * float2(500,500) + float2(50,-50);
  r0.z = r1.y + -r1.x;
  ...
  r0.w = floatZSampler.Sample(samp0_s, r1.xy).x;
