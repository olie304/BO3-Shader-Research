...
//   bool useAlphaBlend;                // Offset:  200 Size:     4
//
// }
//
...
div r1.xw, r1.yyyz, r1.xxxx
mad r1.xw, r1.xxxw, l(0.500000, 0.000000, 0.000000, 0.281250), l(0.500000, 0.000000, 0.000000, 0.500000)
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r1.xwxx, t7.xyzw, s2
mad r0.x, r0.x, r0.w, cb0[11].x
div r1.xw, r1.yyyz, r0.xxxx
mad r1.xw, r1.xxxw, l(0.500000, 0.000000, 0.000000, 0.281250), l(0.500000, 0.000000, 0.000000, 0.500000)
...
div r0.yz, r1.yyzy, r0.yyyy
mad r0.yz, r0.yyzy, l(0.000000, 0.500000, 0.281250, 0.000000), l(0.000000, 0.500000, 0.500000, 0.000000)
...
mad r1.xy, cb1[69].wwww, cb0[12].xyxx, r1.xyxx
add r1.xy, r1.xyxx, l(0.500000, 0.500000, 0.000000, 0.000000)
...
mov_sat r3.w, cb3[0].y
mul r1.w, r1.w, r3.w
mul r0.w, r0.w, r3.w
mad r4.xyz, -r2.xyzx, l(0.00003052, 0.00003052, 0.00003052, 0.000000), r1.xyzx
...
movc r0.xyz, cb0[12].zzzz, r3.xyzx, r0.xyzx
