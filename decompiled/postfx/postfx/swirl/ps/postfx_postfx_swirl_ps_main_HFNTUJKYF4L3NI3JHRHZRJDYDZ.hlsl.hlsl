  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r1.xy = float2(1,0.5625) * r1.zw;
  r1.z = bloodRotation * gameTime.w + 1;
  r1.z = 0.0174532924 * r1.z;
  sincos(r1.z, r3.x, r4.x);
  r5.z = r3.x;
  r5.y = r4.x;
  r5.x = -r3.x;
  r3.y = dot(r5.xy, r1.xy);
  r3.x = dot(r5.yz, r1.xy);
  r1.xy = gameTime.ww * bloodScroll.xy;
  r1.xy = r1.xy * float2(1,0.5625) + r3.xy;
  r1.xy = float2(0.5,0.5) + r1.xy;
  r1.xyzw = bloodMotesMap.Sample(bilinearSampler_s, r1.xy).xyzw;
  r3.x = saturate(scriptVector0.y);
  r1.w = r3.x * r1.w;
  r0.w = r3.x * r0.w;
  r3.xyz = -r2.xyz * float3(3.05175781e-05,3.05175781e-05,3.05175781e-05) + r1.xyz;
