...
Texture2D<float4> pixelTexture : register(t0);
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.x = cmp(postFxControl0.w < postFxControl1.x);
  r0.y = cmp(postFxControl1.x != 0.000000);
  r0.x = r0.y ? r0.x : 0;
  r0.yz = renderTargetSize.zw * v0.xy;
  r0.yz = r0.yz * float2(2,2) + float2(-1,-1);
  r0.y = dot(r0.yz, r0.yz);
  r0.y = sqrt(r0.y);
  r0.z = postFxControl1.x + -postFxControl0.w;
  r0.y = -postFxControl0.w + r0.y;
  r0.z = 1 / r0.z;
  ...
  r0.y = r0.z * r0.y;
  r0.x = r0.x ? r0.y : 1;
  r0.yz = float2(0.5,0.5) + postFxControl0.yz;
  r0.x = -postFxControl0.x * r0.x;
  r0.x = 0.0909090936 * r0.x;
  r1.xy = v1.xy + -r0.yz;
  r2.xyzw = float4(0,0,0,0);
  r0.w = 0;
  while (true) {
    r1.z = cmp((int)r0.w >= 12);
    if (r1.z != 0) break;
    r1.z = (int)r0.w;
    r1.z = r0.x * r1.z + 1;
    r1.zw = r1.xy * r1.zz + r0.yz;
    r3.xyzw = pixelTexture.Sample(bilinearClamp_s, r1.zw).xyzw;
    r2.xyzw = r3.xyzw + r2.xyzw;
    r0.w = (int)r0.w + 1;
  }
  o0.xyzw = float4(0.0833333358,0.0833333358,0.0833333358,0.0833333358) * r2.xyzw;
  return;
}