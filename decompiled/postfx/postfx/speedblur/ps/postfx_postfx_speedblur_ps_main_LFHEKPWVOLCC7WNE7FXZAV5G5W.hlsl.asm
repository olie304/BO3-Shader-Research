...
dcl_output o0.xyzw
dcl_temps 4
lt r0.x, cb8[0].w, cb8[1].x
ne r0.y, cb8[1].x, l(0.000000)
and r0.x, r0.y, r0.x
...
sqrt r0.y, r0.y
add r0.z, -cb8[0].w, cb8[1].x
add r0.y, r0.y, -cb8[0].w
...
add r0.yz, cb8[0].yyzy, l(0.000000, 0.500000, 0.500000, 0.000000)
mul r0.x, r0.x, -cb8[0].x
mul r0.x, r0.x, l(0.09090909)
...
loop 
  ...
  breakc_nz r1.z
  itof r1.z, r0.w
  mad r1.z, r0.x, r1.z, l(1.000000)
  mad r1.zw, r1.xxxy, r1.zzzz, r0.yyyz
  sample_indexable(texture2d)(float,float,float,float) r3.xyzw, r1.zwzz, t0.xyzw, s1
  add r2.xyzw, r2.xyzw, r3.xyzw
  iadd r0.w, r0.w, l(1)
endloop 
mul o0.xyzw, r2.xyzw, l(0.08333334, 0.08333334, 0.08333334, 0.08333334)
ret 
