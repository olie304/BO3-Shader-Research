...
sample_indexable(texture2d)(float,float,float,float) r3.xyz, r1.yzyy, t7.xyzw, s0
mov r2.z, l(0)
add r4.xyzw, r2.zyxz, v1.xyxy
sample_indexable(texture2d)(float,float,float,float) r5.xyz, r4.xyxx, t7.xyzw, s0
mov r2.w, -r2.x
add r2.xy, r2.wzww, v1.xyxx
sample_indexable(texture2d)(float,float,float,float) r6.xyz, r2.xyxx, t7.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r7.xyz, r4.zwzz, t7.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r1.y, r1.yzyy, t9.yxzw, s0
sample_indexable(texture2d)(float,float,float,float) r1.z, r4.xyxx, t9.yzxw, s0
sample_indexable(texture2d)(float,float,float,float) r1.w, r2.xyxx, t9.yzwx, s0
sample_indexable(texture2d)(float,float,float,float) r2.x, r4.zwzz, t9.xyzw, s0
if_nz r0.w
  mov o0.xyz, r0.xyzx
  mov o0.w, l(1.000000)
  ret 
...
mul r2.yzw, r2.yyzw, l(0.000000, 0.250000, 0.250000, 0.250000)
max r3.x, r2.w, r2.z
max r3.x, r2.y, r3.x
