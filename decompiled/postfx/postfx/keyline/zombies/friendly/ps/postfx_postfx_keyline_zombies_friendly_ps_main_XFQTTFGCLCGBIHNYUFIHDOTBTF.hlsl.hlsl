  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r2.xy = renderTargetSize.zw * postFxControl0.ww;
  r3.x = -r2.y;
  r3.z = 0;
  r1.yz = v1.xy + r3.zx;
  r3.xyz = codeTexture1.Sample(samp0_s, r1.yz).xyz;
  r2.z = 0;
  r4.xyzw = v1.xyxy + r2.zyxz;
  r5.xyz = codeTexture1.Sample(samp0_s, r4.xy).xyz;
  r2.w = -r2.x;
  r2.xy = v1.xy + r2.wz;
  r6.xyz = codeTexture1.Sample(samp0_s, r2.xy).xyz;
  r7.xyz = codeTexture1.Sample(samp0_s, r4.zw).xyz;
  r1.y = codeTexture2.Sample(samp0_s, r1.yz).x;
  r1.z = codeTexture2.Sample(samp0_s, r4.xy).x;
  r1.w = codeTexture2.Sample(samp0_s, r2.xy).x;
  r2.x = codeTexture2.Sample(samp0_s, r4.zw).x;
  if (r0.w != 0) {
    o0.xyz = r0.xyz;
    o0.w = 1;
    return;
  ...
  r0.w = rcp(r0.w);
  r0.w = postFxControl1.x + -r0.w;
  r0.w = saturate(postFxControl1.y * r0.w);
  r1.x = sin(gameTime.w);
  r1.x = r1.x * 0.5 + 0.75;
