...
SamplerState samplerClamp_s : register(s1);
Texture2D<float4> floatZSampler : register(t0);
Texture2D<float4> gridTexture : register(t6);
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r1.z = rcp(r1.z);
  r1.w = v1.x * r1.z;
  r1.w = postFxControlF.z * r1.w;
  r2.x = -v1.y * r1.z;
  r2.x = postFxControlF.w * r2.x;
  r2.xyz = postFxControl1.xyz * r2.xxx;
  r2.xyz = r1.www * postFxControl0.xyz + r2.xyz;
  r2.xyz = r1.zzz * postFxControl2.xyz + r2.xyz;
  r2.xyz = postFxControl3.xyz + r2.xyz;
  r3.xyz = -postFxConst00.xyz + r2.xyz;
  r1.zw = r3.xy * float2(0.00323529402,0.00323529402) + float2(0.5,0.5);
  r1.z = gridTexture.Sample(samplerClamp_s, r1.zw).x;
  r4.xyz = -postFxConst01.xyz + r2.xyz;
  r5.xy = r4.xy * float2(0.00323529402,0.00323529402) + float2(0.5,0.5);
  r1.w = gridTexture.Sample(samplerClamp_s, r5.xy).x;
  r5.xyz = -postFxConst02.xyz + r2.xyz;
  r6.xy = r5.xy * float2(0.00323529402,0.00323529402) + float2(0.5,0.5);
  r2.w = gridTexture.Sample(samplerClamp_s, r6.xy).x;
  r6.xyz = -postFxConst03.xyz + r2.xyz;
  r7.xy = r6.xy * float2(0.00323529402,0.00323529402) + float2(0.5,0.5);
  r3.w = gridTexture.Sample(samplerClamp_s, r7.xy).x;
  r7.xyz = -postFxConst04.xyz + r2.xyz;
  r8.xy = r7.xy * float2(0.00323529402,0.00323529402) + float2(0.5,0.5);
  r4.w = gridTexture.Sample(samplerClamp_s, r8.xy).x;
  r8.xyz = -postFxConst05.xyz + r2.xyz;
  r9.xy = r8.xy * float2(0.00323529402,0.00323529402) + float2(0.5,0.5);
  r5.w = gridTexture.Sample(samplerClamp_s, r9.xy).x;
  r9.xyz = -postFxConst06.xyz + r2.xyz;
  r10.xy = r9.xy * float2(0.00323529402,0.00323529402) + float2(0.5,0.5);
  r6.w = gridTexture.Sample(samplerClamp_s, r10.xy).x;
  r2.xyz = -postFxConst07.xyz + r2.xyz;
  r10.xy = r2.xy * float2(0.00323529402,0.00323529402) + float2(0.5,0.5);
  r7.w = gridTexture.Sample(samplerClamp_s, r10.xy).x;
  if (r1.y != 0) {
    r1.y = floatZSampler.Load(r0.xyw, int3(0, 0, 0)).x;
    r0.x = floatZSampler.Load(r0.xyz, int3(0, 0, 0)).x;
    r0.y = r1.x + -r1.y;
    r0.x = r0.x + -r1.x;
    r0.x = max(r0.y, r0.x);
    r0.x = saturate(100000 * r0.x);
    r0.y = cmp(0 < r0.x);
    if (r0.y != 0) {
      r0.y = cmp(0 < postFxConst00.w);
      if (r0.y != 0) {
        r0.y = dot(r3.xyz, r3.xyz);
        r0.z = cmp(25600 >= r0.y);
        if (r0.z != 0) {
          r0.y = sqrt(r0.y);
          r0.y = gameTime.w * -100 + r0.y;
          r0.y = 0.0125000002 * r0.y;
          r0.y = frac(r0.y);
          r0.y = r0.y * r0.y;
          r0.y = r0.y * 0.5 + r1.z;
        } else {
      ...
      r0.z = cmp(0 < postFxConst01.w);
      if (r0.z != 0) {
        r0.z = dot(r4.xyz, r4.xyz);
        r0.w = cmp(25600 >= r0.z);
        if (r0.w != 0) {
          r0.z = sqrt(r0.z);
          r0.z = gameTime.w * -100 + r0.z;
          r0.z = 0.0125000002 * r0.z;
          r0.z = frac(r0.z);
          r0.z = r0.z * r0.z;
          r0.z = r0.z * 0.5 + r1.w;
        } else {
      ...
      r0.y = min(0.699999988, r0.y);
      r0.z = cmp(0 < r0.y);
      r1.z = gameTime.w;
      r1.w = v1.y;
      r0.w = dot(r1.zw, float2(37.3498383,59.3948402));
      r1.x = frac(r0.w);
      r0.w = dot(r1.xzw, float3(81.2394867,37.3498383,59.3948402));
      r1.y = frac(r0.w);
      r0.w = dot(r1.xyzw, float4(81.2394867,17.3480244,37.3498383,59.3948402));
      r1.z = frac(r0.w);
      r0.w = dot(r1.xyzw, float4(81.2394867,17.3480244,37.3498383,59.3948402));
      r1.w = frac(r0.w);
      r0.w = dot(r1.xyzw, float4(81.2394867,17.3480244,37.3498383,59.3948402));
