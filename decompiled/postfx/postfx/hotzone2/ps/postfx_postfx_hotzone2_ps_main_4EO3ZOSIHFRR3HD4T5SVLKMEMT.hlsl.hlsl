  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.xy = -postFxControl1.zx + postFxControl0.zx;
  ...
  r0.w = -0.5 + v1.x;
  r0.yw = r0.yw * r0.zz;
  r0.w = 1.69885421 * r0.w;
  r0.x = r0.x * r0.w + -r0.y;
  r0.x = postFxControl0.x * postFxControl1.z + r0.x;
  r0.x = -postFxControl0.z * postFxControl1.x + r0.x;
  r0.y = cmp(r0.x < 0);
  r0.x = cmp(0 < r0.x);
  r1.xy = -postFxControl2.zx + postFxControl1.zx;
  r1.y = r1.y * r0.z;
  r1.x = r1.x * r0.w + -r1.y;
  r1.x = postFxControl1.x * postFxControl2.z + r1.x;
  r1.x = -postFxControl1.z * postFxControl2.x + r1.x;
  r1.y = cmp(r1.x < 0);
  r1.x = cmp(0 < r1.x);
  r0.xy = r0.xy ? r1.xy : 0;
  r1.xy = postFxControl2.zx + -postFxControl0.zx;
  r1.y = r1.y * r0.z;
  r1.x = r1.x * r0.w + -r1.y;
  r1.x = postFxControl2.x * postFxControl0.z + r1.x;
  r1.x = -postFxControl2.z * postFxControl0.x + r1.x;
  r1.y = cmp(r1.x < 0);
  r1.x = cmp(0 < r1.x);
  r0.xy = r0.xy ? r1.xy : 0;
  r0.x = (int)r0.x | (int)r0.y;
  r1.xy = -postFxControl4.zx + postFxControl3.zx;
  r0.y = r1.y * r0.z;
  r0.y = r1.x * r0.w + -r0.y;
  r0.y = postFxControl3.x * postFxControl4.z + r0.y;
  r0.y = -postFxControl3.z * postFxControl4.x + r0.y;
  r1.x = cmp(r0.y < 0);
  r0.y = cmp(0 < r0.y);
  r1.yz = -postFxControl5.zx + postFxControl4.zx;
  r1.z = r1.z * r0.z;
  r1.y = r1.y * r0.w + -r1.z;
  r1.y = postFxControl4.x * postFxControl5.z + r1.y;
  r1.y = -postFxControl4.z * postFxControl5.x + r1.y;
  r1.z = cmp(r1.y < 0);
  r1.y = cmp(0 < r1.y);
  r0.y = r0.y ? r1.y : 0;
  r1.x = r1.z ? r1.x : 0;
  r1.yz = postFxControl5.zx + -postFxControl3.zx;
  r1.z = r1.z * r0.z;
  r1.y = r1.y * r0.w + -r1.z;
  r1.y = postFxControl5.x * postFxControl3.z + r1.y;
  r1.y = -postFxControl5.z * postFxControl3.x + r1.y;
  r1.z = cmp(r1.y < 0);
  r1.y = cmp(0 < r1.y);
  r0.y = r0.y ? r1.y : 0;
  r1.x = r1.z ? r1.x : 0;
  ...
  r0.x = r0.x + r0.y;
  r1.xy = -postFxControl7.zx + postFxControl6.zx;
  r0.y = r1.y * r0.z;
  r0.y = r1.x * r0.w + -r0.y;
  r0.y = postFxControl6.x * postFxControl7.z + r0.y;
  r0.y = -postFxControl6.z * postFxControl7.x + r0.y;
  r1.x = cmp(r0.y < 0);
  r0.y = cmp(0 < r0.y);
  r1.yz = -postFxControl8.zx + postFxControl7.zx;
  r1.z = r1.z * r0.z;
  r1.y = r1.y * r0.w + -r1.z;
  r1.y = postFxControl7.x * postFxControl8.z + r1.y;
  r1.y = -postFxControl7.z * postFxControl8.x + r1.y;
  r1.z = cmp(r1.y < 0);
  r1.y = cmp(0 < r1.y);
  r0.y = r0.y ? r1.y : 0;
  r1.x = r1.z ? r1.x : 0;
  r1.yz = postFxControl8.zx + -postFxControl6.zx;
  r1.z = r1.z * r0.z;
  r1.y = r1.y * r0.w + -r1.z;
  r1.y = postFxControl8.x * postFxControl6.z + r1.y;
  r1.y = -postFxControl8.z * postFxControl6.x + r1.y;
  r1.z = cmp(r1.y < 0);
  r1.y = cmp(0 < r1.y);
  r0.y = r0.y ? r1.y : 0;
  r1.x = r1.z ? r1.x : 0;
  ...
  r0.x = r0.x + r0.y;
  r1.xy = -postFxControlA.zx + postFxControl9.zx;
  r0.y = r1.y * r0.z;
  r0.y = r1.x * r0.w + -r0.y;
  r0.y = postFxControl9.x * postFxControlA.z + r0.y;
  r0.y = -postFxControl9.z * postFxControlA.x + r0.y;
  r1.x = cmp(r0.y < 0);
  r0.y = cmp(0 < r0.y);
  r1.yz = -postFxControlB.zx + postFxControlA.zx;
  r1.z = r1.z * r0.z;
  r1.y = r1.y * r0.w + -r1.z;
  r1.y = postFxControlA.x * postFxControlB.z + r1.y;
  r1.y = -postFxControlA.z * postFxControlB.x + r1.y;
  r1.z = cmp(r1.y < 0);
  r1.y = cmp(0 < r1.y);
  r0.y = r0.y ? r1.y : 0;
  r1.x = r1.z ? r1.x : 0;
  r1.yz = postFxControlB.zx + -postFxControl9.zx;
  r1.z = r1.z * r0.z;
  r1.y = r1.y * r0.w + -r1.z;
  r1.y = postFxControlB.x * postFxControl9.z + r1.y;
  r1.y = -postFxControlB.z * postFxControl9.x + r1.y;
  r1.z = cmp(r1.y < 0);
  r1.y = cmp(0 < r1.y);
  r0.y = r0.y ? r1.y : 0;
  r1.x = r1.z ? r1.x : 0;
  ...
  r0.y = r0.y ? 1.000000 : 0;
  r0.x = r0.x + r0.y;
  r1.xy = -postFxControlD.zx + postFxControlC.zx;
  r0.y = r1.y * r0.z;
  r0.y = r1.x * r0.w + -r0.y;
  r0.y = postFxControlC.x * postFxControlD.z + r0.y;
  r0.y = -postFxControlC.z * postFxControlD.x + r0.y;
  r1.x = cmp(r0.y < 0);
  r0.y = cmp(0 < r0.y);
  r1.yz = -postFxControlE.zx + postFxControlD.zx;
  r1.z = r1.z * r0.z;
  r1.y = r1.y * r0.w + -r1.z;
  r1.y = postFxControlD.x * postFxControlE.z + r1.y;
  r1.y = -postFxControlD.z * postFxControlE.x + r1.y;
  r1.z = cmp(r1.y < 0);
  r1.y = cmp(0 < r1.y);
  r0.y = r0.y ? r1.y : 0;
  r1.x = r1.z ? r1.x : 0;
  r1.yz = postFxControlE.zx + -postFxControlC.zx;
  r1.z = r1.z * r0.z;
  r0.z = cmp(r0.z < 10);
  r0.w = r1.y * r0.w + -r1.z;
  r0.w = postFxControlE.x * postFxControlC.z + r0.w;
  r0.w = -postFxControlE.z * postFxControlC.x + r0.w;
  r1.y = cmp(r0.w < 0);
  r0.w = cmp(0 < r0.w);
  r0.y = r0.w ? r0.y : 0;
  r0.w = r1.y ? r1.x : 0;
  ...
  r0.x = (int)r0.x;
  r0.x = cmp((int)r0.x == 1);
  r1.xyzw = r0.xxxx ? float4(0.5,0,0,0) : float4(1,0,0,0);
  r0.x = r0.z ? 0 : r0.y;
