...
dcl_output o0.xyzw
dcl_temps 4
mul r0.xy, v1.xyxx, l(45.000000, 600.000000, 0.000000, 0.000000)
round_ni r0.x, r0.x
mul r0.x, r0.x, l(1234.123413)
sincos null, r0.x, r0.x
mul r0.x, r0.x, l(123.456001)
frc r0.x, r0.x
mul r0.z, cb1[69].w, l(720.000000)
mad r0.x, r0.z, r0.x, r0.y
mul r0.x, r0.x, l(0.06666667)
round_ni r0.x, r0.x
mul r0.x, r0.x, l(0.04166667)
ge r0.y, r0.x, -r0.x
frc r0.x, |r0.x|
movc r0.x, r0.y, r0.x, -r0.x
mad r0.x, r0.x, l(24.000000), l(4.000000)
max r0.x, r0.x, l(0.000000)
mul r0.yz, r0.xxxx, l(0.000000, 0.062500, 0.018750, 0.000000)
add r0.w, -cb8[0].y, cb1[69].w
div r0.w, r0.w, cb8[0].x
add r0.w, -r0.w, l(1.000000)
mad r0.w, r0.w, l(4.000000), l(-2.000000)
add r0.w, r0.w, -v1.y
mad r0.w, -r0.w, r0.w, l(1.000000)
max r0.w, r0.w, l(0.000000)
sample_indexable(texture2d)(float,float,float,float) r1.xyzw, v1.xyxx, t0.xyzw, s1
mul r2.xyz, r1.xzyx, l(0.00003052, 0.00003052, 0.00003052, 0.000000)
dp3 r1.y, r2.xzyx, l(0.350000, 0.500000, 0.150000, 0.000000)
mad r3.xyz, -r1.xzwx, l(0.00003052, 0.00003052, 1.000000, 0.000000), r1.yyyy
mul r1.xyz, r1.xzwx, l(0.00003052, 0.00003052, 1.000000, 0.000000)
mad r2.xyw, r0.wwww, r3.xyxz, r1.xyxz
...
mad r2.xyz, r0.xyzx, r0.wwww, r2.xzyx
mul o0.xyzw, r2.xyzw, l(32768.000000, 32768.000000, 32768.000000, 32768.000000)
ret 
