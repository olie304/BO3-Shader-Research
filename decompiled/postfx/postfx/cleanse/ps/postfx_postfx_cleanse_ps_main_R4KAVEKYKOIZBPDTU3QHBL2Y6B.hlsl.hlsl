  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.xy = float2(45,600) * v1.xy;
  r0.x = floor(r0.x);
  r0.x = 1234.12341 * r0.x;
  r0.x = cos(r0.x);
  r0.x = 123.456001 * r0.x;
  r0.x = frac(r0.x);
  r0.z = 720 * gameTime.w;
  r0.x = r0.z * r0.x + r0.y;
  r0.x = 0.0666666701 * r0.x;
  r0.x = floor(r0.x);
  r0.x = 0.0416666679 * r0.x;
  r0.y = cmp(r0.x >= -r0.x);
  r0.x = frac(abs(r0.x));
  r0.x = r0.y ? r0.x : -r0.x;
  r0.x = r0.x * 24 + 4;
  r0.x = max(0, r0.x);
  r0.yz = float2(0.0625,0.0187500007) * r0.xx;
  r0.w = gameTime.w + -postFxControl0.y;
  r0.w = r0.w / postFxControl0.x;
  r0.w = 1 + -r0.w;
  r0.w = r0.w * 4 + -2;
  r0.w = -v1.y + r0.w;
  r0.w = -r0.w * r0.w + 1;
  r0.w = max(0, r0.w);
  r1.xyzw = pixelTexture.Sample(bilinearClamp_s, v1.xy).xyzw;
  r2.xyz = float3(3.05175781e-05,3.05175781e-05,3.05175781e-05) * r1.xzy;
  r1.y = dot(r2.xzy, float3(0.349999994,0.5,0.150000006));
  r3.xyz = -r1.xzw * float3(3.05175781e-05,3.05175781e-05,1) + r1.yyy;
  r1.xyz = float3(3.05175781e-05,3.05175781e-05,1) * r1.xzw;
  r2.xyw = r0.www * r3.xyz + r1.xyz;
  ...
  r2.xyz = r0.xyz * r0.www + r2.xzy;
  o0.xyzw = float4(32768,32768,32768,32768) * r2.xyzw;
  return;
}