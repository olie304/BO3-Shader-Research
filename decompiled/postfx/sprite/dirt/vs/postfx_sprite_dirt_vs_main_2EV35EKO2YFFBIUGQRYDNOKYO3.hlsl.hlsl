  ...
  out float4 o2 : TEXCOORD2)
{
  ...
  r4.x = frac(r2.y);
  r4.yzw = r3.xyw;
  r2.y = dot(r4.yzxw, float4(81.2394867,17.3480244,37.3498383,59.3948402));
  r4.y = frac(r2.y);
  r5.xyzw = r0.xxxx * float4(13.0072002,13.0072002,13.0072002,13.0072002) + float4(0.344999999,9.35000038,1.34500003,12.04);
  r5.xyzw = r2.xxxx * float4(3.34573007,3.34573007,3.34573007,3.34573007) + r5.xyzw;
  r2.y = dot(r5.xyzw, float4(81.2394867,17.3480244,37.3498383,59.3948402));
  r5.x = frac(r2.y);
  r2.y = dot(r5.xyzw, float4(81.2394867,17.3480244,37.3498383,59.3948402));
  r5.y = frac(r2.y);
  r2.y = dot(r5.xyzw, float4(81.2394867,17.3480244,37.3498383,59.3948402));
  ...
  r2.zw = float2(1,1.77777779) * r2.zw;
  r3.y = cmp(r0.w >= -r0.w);
  r0.w = frac(abs(r0.w));
  r0.w = r3.y ? r0.w : -r0.w;
  ...
  r0.x = dot(r6.xyzw, float4(81.2394867,17.3480244,37.3498383,59.3948402));
  r0.x = frac(r0.x);
  r3.yz = scaleMax.xy + -scaleMin.xy;
  r3.xy = r3.xx * r3.yz + scaleMin.xy;
  r3.zw = fadeInMaxMin.xz + -fadeInMaxMin.yw;
  r0.w = r4.x * r3.z + fadeInMaxMin.y;
  r2.x = r4.y * r3.w + fadeOutMaxMin.y;
  r3.zw = jitterMaxMin.x + -jitterMaxMin.y;
  r3.z = r4.z * r3.z + jitterMaxMin.y;
  r4.xy = slideMaxMin.xz + -slideMaxMin.yw;
  r1.w = r1.w * r4.x + slideMaxMin.y;
  o2.w = r5.x * r3.w + warpMaxMin.y;
  r3.w = r5.y * r4.y + heightMaxMin.y;
  r3.w = heightScale * r3.w;
  r3.w = 30 * r3.w;
  r4.xy = pauseMaxMin.xz + -pauseMaxMin.yw;
  r4.x = r5.z * r4.x + pauseMaxMin.y;
  r6.x = r2.y * r4.y + stretchMaxMin.y;
  r2.y = rotationMaxMin.x + -rotationMaxMin.y;
  r1.z = r1.z * r2.y + rotationMaxMin.y;
  r4.yz = -scriptVector0.yz * float2(1,1.77777779) + r2.zw;
  r2.y = dot(r4.yz, r4.yz);
  r2.y = rsqrt(r2.y);
  r4.yz = r4.yz * r2.yy;
  r0.yz = r3.xy * r0.yz;
  ...
  r6.y = 1 / r2.y;
  r2.y = -r4.x + r1.x;
  r3.x = saturate(r2.y / r1.y);
  r5.xz = float2(-1,-1) + r6.xy;
  r3.xy = r3.xx * r5.xz + float2(1,1);
  r0.yz = r3.xy * r0.yz;
  r3.x = r3.w / r3.x;
  r3.y = cmp(r0.w == 0.000000);
  ...
  r1.y = r3.x ? 1 : r1.y;
  o2.z = r1.y * r0.w;
  r0.w = min(abs(r4.z), abs(r4.y));
  r1.y = max(abs(r4.z), abs(r4.y));
  r1.y = 1 / r1.y;
  r0.w = r1.y * r0.w;
  r1.y = r0.w * r0.w;
  ...
  r6.y = r3.x;
  r6.z = r2.x;
  r3.x = dot(r6.yz, r0.yz);
  r6.x = -r2.x;
  r3.y = dot(r6.xy, r0.yz);
  r0.y = cmp(r4.x < r1.x);
  r0.z = r2.y * r2.y;
  r0.zw = r4.yz * r0.zz;
  r0.zw = r0.zw * r1.ww;
  r0.zw = r0.zw * float2(0.00999999978,0.00999999978) + r2.zw;
  r0.yz = r0.yy ? r0.zw : r2.zw;
  r0.yz = r3.xy + r0.yz;
  r0.w = cmp(r1.x < r4.x);
  r1.x = 0.00999999978 * r3.z;
  r1.yz = r4.yz * r0.xx;
  ...
  o0.x = r0.x;
  o0.zw = float2(1,1);
  p1.xy = float2(1,1.77777779) * scriptVector0.yz;
  o2.xy = r6.zy;
  return;
}