...
mad r3.x, r2.w, r1.w, l(1.000000)
mad r1.w, -r2.w, r1.w, l(1.000000)
mad r3.zw, v1.xxxy, l(0.000000, 0.000000, 2.000000, 2.000000), l(0.000000, 0.000000, -1.000000, -1.000000)
mul r4.xy, r3.xxxx, r3.zwzz
mul r3.xz, r1.wwww, r3.zzwz
...
movc r3.xz, r1.wwww, r4.xxyx, r3.xxzx
mad r4.xy, cb1[69].wwww, cb0[12].xyxx, v1.xyxx
sample_indexable(texture2d)(float,float,float,float) r1.w, r4.xyxx, t7.yzwx, s1
mul r1.w, r1.w, r3.y
mul r1.w, r1.w, cb0[10].w
mul r3.yw, r1.wwww, cb1[44].zzzw
mad r4.xy, r3.ywyy, cb0[11].zzzz, r3.xzxx
mad r3.xyzw, r3.ywyw, cb0[11].xxyy, r3.xzxz
sample_indexable(texture2d)(float,float,float,float) r4.z, r4.xyxx, t0.xyzw, s1
sample_indexable(texture2d)(float,float,float,float) r4.x, r3.xyxx, t0.xyzw, s1
sample_indexable(texture2d)(float,float,float,float) r4.y, r3.zwzz, t0.xyzw, s1
mad r3.xyz, -r4.xyzx, l(0.00003052, 0.00003052, 0.00003052, 0.000000), l(1.000000, 1.000000, 1.000000, 0.000000)
mul r4.xyz, r4.xyzx, l(0.00003052, 0.00003052, 0.00003052, 0.000000)
...
movc r0.xyz, cb0[13].yyyy, r0.xyzx, r2.xyzx
