...
cbuffer _Globals : register(b0)
{
  ...
  float aberrationPixels : packoffset(c11.z);
  float3 aberrationFactors : packoffset(c12);
  float2 aberrationScroll : packoffset(c13);
}
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r1.xyz = log2(abs(scriptVector1.xyz));
  r1.xyz = float3(2.20000005,2.20000005,2.20000005) * r1.xyz;
  r1.xyz = exp2(r1.xyz);
  r1.xyz = float3(-1,-1,-1) + r1.xyz;
  r2.xyz = saturate(scriptVector0.zyx);
  r1.xyz = r2.xxx * r1.xyz + float3(1,1,1);
  r0.xyz = r1.xyz * r0.xyz;
  r0.w = r2.z * r0.w;
  r0.xyz = -r0.xyz * r0.www + float3(1,1,1);
  r1.xy = gameTime.ww * aberrationScroll.xy + v1.xy;
  r0.w = aberrationMask.Sample(bilinearSampler_s, r1.xy).x;
  r0.w = r2.y * r0.w;
  r0.w = aberrationPixels * r0.w;
  r1.xy = renderTargetSize.zw * r0.ww;
  r1.zw = r1.xy * aberrationFactors.zz + v1.xy;
  r2.xyzw = r1.xyxy * aberrationFactors.xxyy + v1.xyxy;
  r1.z = frameBuffer.Sample(bilinearSampler_s, r1.zw).z;
  r1.x = frameBuffer.Sample(bilinearSampler_s, r2.xy).x;
  r1.y = frameBuffer.Sample(bilinearSampler_s, r2.zw).y;
