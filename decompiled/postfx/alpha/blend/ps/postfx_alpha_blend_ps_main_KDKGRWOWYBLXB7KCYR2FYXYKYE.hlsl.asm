...
//   float warpAmount;                  // Offset:  184 Size:     4
//
// }
//
...
sample_indexable(texture2d)(float,float,float,float) r0.zw, r0.xyxx, t7.zwxy, s1
mul r0.xy, r0.xyxx, cb0[11].yyyy
sample_indexable(texture2d)(float,float,float,float) r1.xyzw, r0.xyxx, t6.xyzw, s1
mad r0.xy, r0.zwzz, l(1.99218750, 1.99218750, 0.000000, 0.000000), l(-1.000000, -1.000000, 0.000000, 0.000000)
mul r0.xy, r0.xyxx, cb1[44].zwzz
mul r0.xy, r0.xyxx, cb0[11].zzzz
mad r0.xy, r0.xyxx, cb3[1].wwww, v1.xyxx
