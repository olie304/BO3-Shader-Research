...
mov r9.x, cb0[16].x
sample_l_indexable(texture2d)(float,float,float,float) r1.w, r9.xyxx, t24.yzwx, s5, l(0.000000)
log r1.w, |r1.w|
...
mov r10.x, cb0[25].y
sample_l_indexable(texture2d)(float,float,float,float) r1.w, r10.xyxx, t24.yzwx, s5, l(0.000000)
log r1.w, |r1.w|
...
ret 
// Approximately 2813 instruction slots used
