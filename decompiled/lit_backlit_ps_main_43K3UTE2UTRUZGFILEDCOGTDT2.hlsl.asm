...
if_nz r3.x
  ...
  mad r8.yzw, r19.xxyz, r2.wwww, r12.xxyz
  mov r10.w, l(0)
  ...
  mad r9.yzw, r12.xxyz, r1.wwww, r9.yyzw
endif 
add r1.w, r0.w, r5.x
log r1.w, |r1.w|
mul r1.w, r1.w, r5.z
...
mul r8.yzw, r1.wwww, r9.yyzw
mul r9.yzw, r3.xxxx, r8.yyzw
...
if_z r3.x
  ...
  if_z r6.z
    if_z cb2[58].y
      ...
      itof r6.z, cb2[26].y
      add r14.z, r5.y, r6.z
      sample_c_lz_indexable(texture2darray)(float,float,float,float) r6.z, r14.xyzx, t13.xxxx, s13, r3.x
    ...
    if_nz cb2[58].y
      ...
      add r8.yz, r8.yyzy, -cb2[r5.y + 20].xxyx
      mul r8.yz, r8.yyzy, cb2[r5.y + 20].zzzz
      ...
      loop 
        ...
        movc r10.w, r8.w, cb2[r5.y + 20].w, cb2[r6.z + 20].w
        movc r8.w, r8.w, r5.y, r6.z
        ...
        utof r16.z, r8.w
        sample_c_lz_indexable(texture2darray)(float,float,float,float) r8.w, r16.xyzx, t13.xxxx, s13, r3.x
...
if_nz r3.x
  ...
  if_nz r3.x
    ...
    if_nz cb2[23].x
      ...
      dp4 r5.y, cb2[24].xyzw, r14.xyzw
      dp4 r5.w, cb2[25].xyzw, r14.xyzw
      frc r14.xy, r5.ywyy
      iadd r5.y, l(-1), cb2[23].x
      utof r14.z, r5.y
    ...
    if_nz r5.w
      ...
      mad r18.xyz, r1.xyzx, r6.zzzz, v5.xyzx
      ...
      if_z r7.w
        ...
        if_nz cb2[58].y
          ...
          loop 
            ...
            sample_c_lz_indexable(texture2darray)(float,float,float,float) r10.w, r16.xyzx, t9.xxxx, s13, r5.y
            mad r6.w, r10.w, l(0.125000), r6.w
            iadd r7.w, r7.w, l(1)
          endloop 
        else 
          utof r14.z, r6.z
          sample_c_lz_indexable(texture2darray)(float,float,float,float) r6.w, r14.xyzx, t9.xxxx, s13, r5.y
        endif 
        mul r5.y, r6.w, r6.w
        mul r5.y, r6.w, r5.y
      else 
    ...
    mad r5.y, -r5.x, l(0.500000), l(1.000000)
    mad r5.y, -|r2.w|, r5.y, l(1.000000)
    mul r5.y, r5.y, r5.y
    mad r5.y, -r5.y, l(0.620000), l(0.620000)
    add r5.y, -|r2.w|, r5.y
    mad r5.y, r5.z, r5.y, |r2.w|
    mul r5.y, r3.y, r5.y
    lt r5.w, l(0.000000), r2.w
    mad r14.xyz, r5.yyyy, r8.zwyz, r12.xyzx
    mov_sat r2.w, r2.w
    ...
    dp3 r5.y, r1.xyzx, r15.xyzx
    mad r6.z, |r5.y|, r4.w, -|r5.y|
    mad r5.y, |r5.y|, r6.z, l(1.000000)
    mad r6.z, r2.w, r0.w, r1.w
    mul r5.y, r5.y, r5.y
    mul r5.y, r6.z, r5.y
    rcp r5.y, r5.y
    mul r2.w, r3.x, r2.w
    ...
    mul r3.x, r3.y, r3.x
    mul r2.w, r2.w, r3.x
    mad r3.xyz, r2.wwww, r8.yzwy, r9.yzwy
    mov r14.w, r12.z
    mov r12.w, r14.z
          ...
          if_nz r16.w
            ...
            if_nz r16.w
              ...
              if_nz r16.w
                ...
                mad r43.xyz, r1.xyzx, r16.wwww, v5.xyzx
              ...
              if_nz r16.w
                ...
                if_nz r13.w
                  ...
                  mad r19.xyz, r1.xyzx, r21.wwww, v5.xyzx
          ...
          if_nz r13.w
            ...
            if_nz r13.w
              ...
              if_nz r13.w
                ...
                mad r22.xyz, r1.xyzx, r13.wwww, v5.xyzx
              ...
              if_nz r13.w
                ...
                if_nz r16.w
                  ...
                  mad r23.xyz, r1.xyzx, r19.xxxx, v5.xyzx
                  ...
                  if_nz r16.w
                    ...
                    lt r22.x, r12.w, l(0.000000)
                    movc r19.x, r22.x, -r19.x, r19.x
                    mad r24.xyz, r1.xyzx, r19.xxxx, v5.xyzx
...
mad r0.xyz, r5.xywx, r0.xyzx, r1.xyzx
