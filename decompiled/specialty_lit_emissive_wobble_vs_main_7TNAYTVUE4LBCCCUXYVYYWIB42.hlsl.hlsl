...
r0.w = modelInstanceBuffer[]..swiz;
  ...
  r1.xyzw = float4(1,1,1,1) + -v2.xyxy;
  r2.xy = wind1Parms.xy * r1.zw;
  r1.xyzw = wind2Parms.xyzw * r1.xyzw;
  r2.xy = float2(3.63189912,3.63189912) * r2.xy;
  r0.w = r2.x + r2.y;
  r2.x = gameTime.w + flagParams.y;
  r2.x = flagParams.x * r2.x;
  r0.w = r2.x * 5.6548667 + r0.w;
  r1.xyzw = float4(8.37758064,8.37758064,20.2683392,20.2683392) * r1.xyzw;
  r1.xy = r1.xz + r1.yw;
  r1.xy = r2.xx * float2(9.42477798,7.53982306) + r1.xy;
  r0.w = sin(r0.w);
  r1.xy = sin(r1.xy);
  r1.x = 3 * r1.x;
  r0.w = r0.w * 7.5 + r1.x;
  r0.w = r1.y * 1.70000005 + r0.w;
  r0.w = v1.y * r0.w;
  r1.xyz = r0.www * r0.xyz + r3.xyz;
// Known bad code for instruction (needs manual fix):
