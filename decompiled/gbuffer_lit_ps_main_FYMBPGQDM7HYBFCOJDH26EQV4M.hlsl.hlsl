  ...
  out float2 o3 : SV_TARGET3)
{
  ...
  r2.w = min(1, r2.w);
  r5.xyz = detailMap.Sample(normalSampler_s, r0.xy).xyz;
  r0.xy = r5.xy * float2(1.9921875,1.9921875) + float2(-1,-1);
  r3.z = r5.z * r5.z;
  r3.z = 0.333333343 * r3.z;
  r3.z = min(1, r3.z);
  r4.xy = r0.xy * detailScaleHeight + r3.xy;
  r0.x = dot(r4.xyz, r4.xyz);
  r0.x = rsqrt(r0.x);
  r3.xyw = r4.xyz * r0.xxx;
  r0.x = r3.z * detailScaleHeight + r2.w;
  r0.y = v8.x ? 1 : -1;
  ...
  r0.x = r1.w + r0.x;
  r0.x = log2(r0.x);
  r0.xw = saturate(float2(-0.0588235296,-0.0588235296) * r0.xw);
  ...
  o2.z = debugOcclusionOverride.w * r0.w + r0.z;
