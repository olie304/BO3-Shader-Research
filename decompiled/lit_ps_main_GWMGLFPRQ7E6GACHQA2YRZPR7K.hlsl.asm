...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:37:55 2021
//
//
...
sample_indexable(texture2d)(float,float,float,float) r2.w, v1.yzyy, t24.yzwx, s3
...
rsq r2.x, r2.x
mul r3.xyw, r2.xxxx, r4.xyxz
mad r2.x, r2.z, cb0[11].z, r3.z
...
mul r2.y, r2.w, l(-17.000000)
exp r2.y, r2.y
add r2.x, r2.y, r2.x
log r2.x, r2.x
mul_sat r2.y, r2.x, l(-0.05882353)
...
frc r4.w, r4.w
mul r4.xw, r4.xxxw, l(0.00781250, 0.000000, 0.000000, 52.982918)
frc r4.w, r4.w
...
add r4.w, r4.w, r4.w
mad r10.xyz, r3.xyzx, -r4.wwww, -r5.xyzx
mul r4.w, r2.y, l(17.000000)
exp r4.w, r4.w
...
mul r6.zw, r6.yyyw, l(0.000000, 0.000000, 5.000000, 0.400000)
...
rcp r2.z, r2.z
mov_sat r20.w, r20.w
mul r9.yzw, r2.zzzz, r19.xxyz
mul r12.xyz, r2.zzzz, r20.xyzx
lt r2.w, r20.w, l(0.990000)
if_nz r2.w
  add r2.w, -r20.w, l(1.000000)
  mul r4.x, r2.w, cb2[19].x
  ...
  mad r9.yzw, r19.xxyz, r2.zzzz, r13.xxyz
  mov r10.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r6.yzw, r10.xyzw, t8.wxyz, s2, r6.z
  mad r2.z, cb2[19].x, r2.w, -r3.w
  mad r2.z, r2.y, r2.z, r3.w
  mad r12.xyz, r6.yzwy, r2.zzzz, r12.xyzx
endif 
add r2.z, r0.w, r2.x
log r2.z, |r2.z|
mul r2.z, r2.z, r5.w
...
mul r6.yzw, r2.zzzz, r12.xxyz
mul r12.xyz, r2.yyyy, r6.zwyz
mul r2.yzw, r2.wwww, r6.yyzw
sqrt r0.w, r5.w
mad r0.w, r0.w, l(0.500000), l(0.500000)
mul r0.w, r0.w, r0.w
mul r3.w, r0.w, l(0.500000)
mad r0.w, -r0.w, l(0.500000), l(1.000000)
mad r4.x, r2.x, r0.w, r3.w
mul r0.w, r0.w, r4.x
mul r3.w, r3.w, r4.x
dp3 r4.x, r3.xyzx, cb2[17].xyzx
mov_sat r6.y, r4.x
...
if_nz r6.z
  ...
  if_nz r6.z
    ...
    if_nz r7.w
      ...
      mad r8.w, |r4.x|, l(-0.200000), l(0.400000)
      mad r18.xyz, r3.xyzx, r8.wwww, v5.xyzx
    ...
    mad r15.xyz, r6.yyyy, r9.yzwy, r2.yzwy
    add_sat r4.y, -r4.y, l(1.000000)
    mul r6.z, r4.y, r4.y
    mul r6.z, r6.z, r6.z
    mul r4.y, r4.y, r6.z
    mul r4.y, r4.y, r6.y
    mad r16.xyz, r4.yyyy, r9.zwyz, r12.xyzx
    mov r14.w, r16.z
    mov r13.w, r12.z
    movc r13.xyzw, r4.xxxx, r14.xyzw, r13.xyzw
    mov r16.zw, r15.xxxy
    mov r12.zw, r2.yyyz
    movc r14.xyzw, r4.xxxx, r16.xyzw, r12.xyzw
    movc r2.w, r4.x, r15.z, r2.w
    mov r12.z, r13.w
    mov r12.xy, r14.xyxx
    mov r2.yz, r14.zzwz
  endif 
...
loop 
  ...
  loop 
    ...
    if_nz r13.w
      ...
      and r12.w, r30.y, r30.x
      and r12.w, r30.z, r12.w
      if_nz r12.w
        ...
        ubfe r12.w, l(3), l(24), r31.w
        switch r12.w
          case l(4)
          lt r12.w, l(0.000000), r36.x
          mov r37.xy, r35.zwzz
          mov r37.z, r36.w
          mad r38.xyz, -r37.xyzx, l(0.500000, 0.500000, 0.500000, 0.000000), r30.yzwy
          add r39.xyz, r38.xyzx, -v5.xyzx
          dp3 r13.w, r37.xyzx, r39.xyzx
          div_sat r15.z, -r13.w, r36.x
          mad r40.xyz, r15.zzzz, r37.xyzx, r38.xyzx
          movc r40.xyz, r12.wwww, r40.xyzx, r30.yzwy
          add r40.xyz, r40.xyzx, -v5.xyzx
          dp3 r15.w, r40.xyzx, r40.xyzx
          rsq r20.w, r15.w
          mul r40.xyz, r20.wwww, r40.xyzx
          dp3 r20.w, r3.xyzx, r40.xyzx
          mov_sat r24.w, r20.w
          ...
          if_nz r25.w
            ...
            mul r15.w, r15.w, r40.x
            mul r15.w, r40.y, r15.w
            ...
            if_nz r25.w
              ...
              if_nz r25.w
                ...
                mad r40.xyz, r3.xyzx, r25.wwww, v5.xyzx
              ...
              if_nz r25.w
                ...
                add r13.w, -r15.z, r13.w
                mad r13.w, r26.w, r13.w, r15.z
                mad r37.xyz, r13.wwww, r37.xyzx, r38.xyzx
                movc r37.xyz, r12.wwww, r37.xyzx, r30.yzwy
                add r37.xyz, r37.xyzx, -v5.xyzx
                dp3 r12.w, r37.xyzx, r37.xyzx
                rsq r12.w, r12.w
                mul r38.xyz, r12.wwww, r37.xyzx
                ubfe r13.w, l(4), l(16), r31.w
                ult r15.z, l(0), r13.w
                and r15.z, r4.z, r15.z
                if_nz r15.z
                  ...
                  mad r18.xyz, r3.xyzx, r26.wwww, v5.xyzx
                  dp4 r26.w, r39.xyzw, r18.xyzw
                  ...
                  if_z r29.w
                    ...
                    mul r18.x, r28.w, r43.y
                    mad r18.y, r43.x, r28.w, r26.w
                  ...
                  if_z r18.y
                    ...
                    if_nz r8.w
                      ...
                      loop 
                        ...
                        mad r40.xy, r41.xyxx, r15.zzzz, r39.xyxx
                        sample_c_lz_indexable(texture2darray)(float,float,float,float) r26.w, r40.xyzx, t9.xxxx, s13, r18.x
                  ...
                  ubfe r13.w, l(4), l(20), r31.w
                  ult r15.z, l(0), r13.w
                  and r15.z, r4.x, r15.z
                  if_nz r15.z
                    iadd r13.w, r13.w, cb2[0].x
                    iadd r13.w, r13.w, l(-1)
                    ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r15.z, r13.w, l(52), t12.xxxx
                    ...
                    if_z r18.z
                      ...
                      if_nz r8.w
                        ...
                        loop 
                          ...
                          mad r19.xy, r40.xyxx, r15.zzzz, r39.xyxx
                ...
                mad r13.w, -r24.w, r2.x, l(1.000000)
                mul r13.w, r13.w, r13.w
                mad r13.w, -r13.w, l(0.620000), l(0.620000)
                add r13.w, -r24.w, r13.w
                mad r13.w, r5.w, r13.w, r24.w
                mul r13.w, r15.w, r13.w
                mov r31.x, r30.x
                lt r15.z, l(0.000000), r20.w
                mad r19.xyz, r13.wwww, r31.xyzx, r9.yzwy
                dp3_sat r13.w, r3.xyzx, r38.xyzx
                mad r37.xyz, r37.xyzx, r12.wwww, r5.xyzx
                dp3 r12.w, r37.xyzx, r37.xyzx
                rsq r12.w, r12.w
                mul r37.xyz, r12.wwww, r37.xyzx
                dp3 r12.w, r37.xyzx, r5.xyzx
                dp3 r18.x, r3.xyzx, r37.xyzx
                mad r20.w, |r18.x|, r4.w, -|r18.x|
                mad r18.x, |r18.x|, r20.w, l(1.000000)
                mad r20.w, r13.w, r0.w, r3.w
                ...
                mul r13.w, r15.w, r13.w
                mad r37.xyz, r13.wwww, r31.xyzx, r29.xyzx
                add_sat r12.w, -r12.w, l(1.000000)
                mul r15.w, r12.w, r12.w
                mul r15.w, r15.w, r15.w
                mul r12.w, r12.w, r15.w
                mul r12.w, r12.w, r13.w
                mad r38.xyz, r12.wwww, r31.xyzx, r16.xyzx
                movc r9.yzw, r15.zzzz, r19.xxyz, r9.yyzw
                movc r16.xyz, r15.zzzz, r38.xyzx, r16.xyzx
                movc r29.xyz, r15.zzzz, r37.xyzx, r29.xyzx
              endif 
            endif 
          endif 
          break 
          ...
          rsq r12.w, r12.w
          mul r37.xyz, r12.wwww, r19.xyzx
          dp3 r13.w, r3.xyzx, r37.xyzx
          mov_sat r15.z, r13.w
          ...
          if_nz r15.w
            ...
            mov r39.w, r38.y
            dp4 r15.w, r39.xyzw, r17.xyzw
            lt r18.x, r15.w, l(1.000000)
            if_nz r18.x
              ...
              mad_sat r32.xy, r15.wwww, r32.xzxx, r32.ywyy
              ...
              div r20.xy, r32.xyxx, r15.wwww
              lt r15.w, r41.w, l(0.00048828)
              if_nz r15.w
                mov r42.y, r43.x
                ...
                mul r15.w, r25.w, r26.w
              endif 
              mul r18.x, r15.w, r24.w
            ...
            lt r15.w, l(0.000000), r18.x
            if_nz r15.w
              ubfe r15.w, l(3), l(27), r31.w
              ine r15.w, r15.w, l(1)
              if_nz r15.w
                mad r15.w, |r13.w|, l(-0.200000), l(0.400000)
                mad r21.xyz, r3.xyzx, r15.wwww, v5.xyzx
                mov r37.xyz, r36.xyzx
                dp4 r15.w, r37.xyzw, r21.xyzw
                dp4 r24.w, r39.xyzw, r21.xyzw
                ge r25.w, r24.w, r15.w
                if_nz r25.w
                  ...
                  div r11.w, r15.w, r24.w
                  max r11.w, r11.w, l(0.00006104)
                  and r15.w, r31.w, l(0x0000ffff)
                  if_nz r8.w
                    utof r30.z, r15.w
                    mov r24.w, l(0)
                    mov r25.w, l(0)
                    loop 
                      ige r26.w, r25.w, l(8)
                      breakc_nz r26.w
                      dp2 r32.x, icb[r25.w + 0].xyxx, r24.xyxx
                      dp2 r32.y, icb[r25.w + 0].yxyy, r24.xzxx
                      mad r30.xy, r32.xyxx, r33.yyyy, r21.xyxx
                      sample_c_lz_indexable(texture2darray)(float,float,float,float) r26.w, r30.xyzx, t9.xxxx, s13, r11.w
              ...
              if_nz r15.w
                mul r15.w, r4.w, r31.x
                mul r15.w, r15.z, r15.w
                ubfe r18.x, l(4), l(16), r31.w
                ult r21.x, l(0), r18.x
                  ...
                  if_z r22.x
                    ...
                    if_nz r8.w
                      ...
                      loop 
                        ige r26.w, r25.w, l(8)
                        breakc_nz r26.w
                        dp2 r30.x, icb[r25.w + 0].xyxx, r25.xyxx
                        dp2 r30.y, icb[r25.w + 0].yxyy, r25.xzxx
                      ...
                      utof r31.z, r21.y
                      sample_c_lz_indexable(texture2darray)(float,float,float,float) r21.z, r31.xyzx, t9.xxxx, s13, r18.x
                    endif 
                  ...
                  if_nz r21.x
                    ...
                    if_z r23.x
                      ...
                      if_nz r8.w
                        ...
                        utof r30.z, r21.y
                        sample_c_lz_indexable(texture2darray)(float,float,float,float) r23.x, r30.xyzx, t9.xxxx, s13, r18.x
                      endif 
                ...
                mad r19.xyz, r11.wwww, r20.xywx, r29.xyzx
                add_sat r12.w, -r12.w, l(1.000000)
                mul r15.z, r12.w, r12.w
                mul r15.z, r15.z, r15.z
                mul r12.w, r12.w, r15.z
                mul r11.w, r11.w, r12.w
                mad r20.xyw, r11.wwww, r20.xyxw, r16.xyxz
                movc r9.yzw, r13.wwww, r22.xxyz, r9.yyzw
                movc r16.xyz, r13.wwww, r20.xywx, r16.xyzx
                movc r29.xyz, r13.wwww, r19.xyzx, r29.xyzx
              endif 
            endif 
          endif 
          break 
...
mad r0.xyz, r6.yzwy, r0.xyzx, r2.xyzx
...
ret 
// Approximately 1924 instruction slots used
