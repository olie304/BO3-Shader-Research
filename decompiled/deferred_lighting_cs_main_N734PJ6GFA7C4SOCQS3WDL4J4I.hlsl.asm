  ...
  if_z r9.w
    ...
    if_nz cb2[58].y
      ...
      loop 
        ...
        movc r14.w, r13.w, cb2[r7.w + 20].w, cb2[r9.z + 20].w
        movc r13.w, r13.w, r7.w, r9.z
...
if_nz r2.z
  ...
  if_nz r2.z
    ...
    if_nz cb2[23].x
      ...
      dp4 r5.w, cb2[25].xyzw, r17.xyzw
      frc r17.x, r4.z
      frc r17.y, r5.w
      iadd r4.z, l(-1), cb2[23].x
      utof r17.z, r4.z
      sample_l_indexable(texture2darray)(float,float,float,float) r14.yzw, r17.xyzx, t20.wxyz, s2, l(0.000000)
    ...
    if_nz r5.w
      ...
      if_z r5.w
        ...
        mad r17.x, r18.x, cb9[r4.z + 8].y, cb9[r4.z + 8].z
        mad r17.y, r18.y, cb9[r4.z + 8].w, cb9[r4.z + 9].x
        ...
        if_nz cb2[58].y
          ...
          loop 
            ...
            mad r19.xy, r20.xyxx, cb9[r4.z + 3].yyyy, r17.xyxx
            sample_c_lz_indexable(texture2darray)(float,float,float,float) r12.w, r19.xyzx, t9.xxxx, s13, r5.w
    ...
    mad r18.xyz, r2.zzzz, r14.yzwy, r13.yzwy
    add_sat r0.z, -r0.z, l(1.000000)
    mul r3.w, r0.z, r0.z
    mul r3.w, r3.w, r3.w
    mul r0.z, r0.z, r3.w
    mul r0.z, r0.z, r2.z
    mad r19.xyz, r0.zzzz, r14.zwyz, r16.xyzx
    mov r17.w, r19.z
    mov r9.w, r16.z
    movc r9.xyzw, r2.wwww, r17.xyzw, r9.xyzw
    mov r19.zw, r18.xxxy
    mov r16.zw, r13.yyyz
    movc r17.xyzw, r2.wwww, r19.xyzw, r16.xyzw
    movc r13.w, r2.w, r18.z, r13.w
    mov r16.z, r9.w
    mov r16.xy, r17.xyxx
    mov r13.yz, r17.zzwz
  endif 
...
switch r0.z
  ...
  add r18.xyz, -r10.xyzx, r14.yzwy
  dp3 r2.z, r17.xyzx, r18.xyzx
  div_sat r2.w, -r2.z, cb9[r0.x + 6].y
  mad r19.xyz, r2.wwww, r17.xyzx, r14.yzwy
  movc r19.xyz, r0.zzzz, r19.xyzx, cb9[r0.x + 0].xyzx
  ...
  if_nz r6.w
    ...
    if_nz r6.w
      ...
      if_nz r6.w
        utof r19.xy, r1.yxyy
        dp2 r6.w, r19.xyxx, l(0.06711056, 0.00583715, 0.000000, 0.000000)
        frc r6.w, r6.w
        ...
        mad r19.yzw, r11.xxyz, r6.wwww, r10.xxyz
        add r19.yzw, r19.yyzw, -cb9[r0.x + 4].yyzw
        max r6.w, |r19.w|, |r19.z|
        max r6.w, r6.w, |r19.y|
        div r6.w, cb9[r0.x + 5].x, r6.w
        add r6.w, r6.w, cb9[r0.x + 5].y
        dp3 r7.w, r19.yzwy, r19.yzwy
        rsq r7.w, r7.w
        ...
        loop 
          ige r11.w, r9.w, l(8)
          breakc_nz r11.w
          dp2 r20.y, icb[r9.w + 0].yxyy, r21.xyxx
          dp2 r20.z, icb[r9.w + 0].yxyy, r21.yzyy
          mul r23.yz, r20.yyzy, cb9[r0.x + 3].yyyy
          mul r23.x, r20.x, r23.y
          mul r23.w, r19.x, r23.y
          mad r22.xyz, r19.yzwy, r7.wwww, r23.xzwx
          sample_c_lz_indexable(texturecubearray)(float,float,float,float) r11.w, r22.xyzw, t10.xxxx, s13, r6.w
      ...
      if_nz r6.w
        ...
        dp3 r7.w, r17.xyzx, r15.xyzx
        dp3 r8.w, r15.xyzx, r18.xyzx
        mad r9.w, -r7.w, r7.w, cb9[r0.x + 6].y
        mad r2.z, r7.w, r8.w, -r2.z
        div_sat r2.z, r2.z, r9.w
        div r7.w, r9.w, cb9[r0.x + 6].y
        mul r7.w, r7.w, l(10.000000)
        min r7.w, r7.w, l(1.000000)
        add r2.z, -r2.w, r2.z
        mad r2.z, r7.w, r2.z, r2.w
        mad r14.yzw, r2.zzzz, r17.xxyz, r14.yyzw
        movc r14.yzw, r0.zzzz, r14.yyzw, cb9[r0.x + 0].xxyz
        add r14.yzw, -r10.xxyz, r14.yyzw
        dp3 r0.z, r14.yzwy, r14.yzwy
        rsq r0.z, r0.z
        mul r15.xyz, r0.zzzz, r14.yzwy
        ubfe r2.z, l(4), l(16), cb9[r0.x + 1].w
        ult r2.w, l(0), r2.z
        and r2.w, r0.y, r2.w
        if_nz r2.w
          iadd r2.z, r2.z, cb2[0].x
          imad r2.z, r2.z, l(15), l(-15)
          mad r2.w, |r4.z|, l(-0.200000), l(0.400000)
          mad r17.xyz, r11.xyzx, r2.wwww, r10.xyzx
          mov r18.xyz, cb9[r2.z + 6].yzwy
          mov r18.w, cb9[r2.z + 7].x
          mov r17.w, l(1.000000)
          dp4 r2.w, r18.xyzw, r17.xyzw
          mov r18.xyz, cb9[r2.z + 7].yzwy
          mov r18.w, cb9[r2.z + 8].x
          ...
          if_z r8.w
            ...
            if_z r9.w
              ...
              mad r18.x, r17.x, cb9[r2.z + 8].y, cb9[r2.z + 8].z
              mad r18.y, r17.y, cb9[r2.z + 8].w, cb9[r2.z + 9].x
              mul r11.w, r7.w, cb9[r2.z + 10].z
              mad r2.w, cb9[r2.z + 10].y, r7.w, r2.w
              div r2.w, r2.w, r11.w
            endif 
          else 
            mov r9.w, l(-1)
          ...
          if_z r7.w
            ...
            and r7.w, l(0x0000ffff), cb9[r2.z + 1].w
            if_nz cb2[58].y
              mov r17.x, -r13.x
              utof r19.z, r7.w
              mov r17.y, r14.x
              ...
              loop 
                ige r11.w, r9.w, l(8)
                breakc_nz r11.w
                dp2 r20.x, icb[r9.w + 0].yxyy, r17.xyxx
                dp2 r20.y, icb[r9.w + 0].yxyy, r17.yzyy
                mad r19.xy, r20.xyxx, cb9[r2.z + 3].yyyy, r18.xyxx
                sample_c_lz_indexable(texture2darray)(float,float,float,float) r11.w, r19.xyzx, t9.xxxx, s13, r2.w
                mad r8.w, r11.w, l(0.125000), r8.w
                iadd r9.w, r9.w, l(1)
              endloop 
            else 
              utof r18.z, r7.w
              sample_c_lz_indexable(texture2darray)(float,float,float,float) r8.w, r18.xyzx, t9.xxxx, s13, r2.w
            endif 
            mul r2.z, r8.w, r8.w
            mul r2.z, r8.w, r2.z
          else 
          ...
          ubfe r2.z, l(4), l(20), cb9[r0.x + 1].w
          ult r2.w, l(0), r2.z
          not r7.w, r0.y
          and r2.w, r2.w, r7.w
          if_nz r2.w
        ...
        add r2.z, -r5.w, r2.z
        mad r2.z, r1.w, r2.z, r5.w
        mul r2.z, r3.w, r2.z
        mov r17.x, cb9[r0.x + 0].w
        mov r17.yz, cb9[r0.x + 1].xxyx
        lt r2.w, l(0.000000), r4.z
        mad r18.xyz, r2.zzzz, r17.xyzx, r9.xyzx
        dp3_sat r2.z, r11.xyzx, r15.xyzx
        mad r14.yzw, r14.yyzw, r0.zzzz, r12.xxyz
        dp3 r0.z, r14.yzwy, r14.yzwy
        rsq r0.z, r0.z
        ...
        mul r2.z, r2.z, r4.z
        mul r2.z, r3.w, r2.z
        mad r14.yzw, r2.zzzz, r17.xxyz, r13.yyzw
        add_sat r0.z, -r0.z, l(1.000000)
        mul r3.w, r0.z, r0.z
        mul r3.w, r3.w, r3.w
        mul r0.z, r0.z, r3.w
        mul r0.z, r0.z, r2.z
        mad r15.xyz, r0.zzzz, r17.xyzx, r16.zxyz
        movc r9.xyz, r2.wwww, r18.xyzx, r9.xyzx
        movc r16.xyz, r2.wwww, r15.yzxy, r16.xyzx
        movc r13.yzw, r2.wwww, r14.yyzw, r13.yyzw
      endif 
    endif 
  endif 
  break 
  ...
  rsq r0.z, r0.z
  mul r14.yzw, r0.zzzz, r15.xxyz
  dp3 r2.z, r11.xyzx, r14.yzwy
  mov_sat r2.w, r2.z
  ...
  if_nz r3.w
    ...
    dp4 r3.w, r17.xyzw, r10.xyzw
    lt r4.z, r3.w, l(1.000000)
    if_nz r4.z
      mov r14.yzw, l(0,1.000000,1.000000,1.000000)
      mov r4.z, l(0)
    else 
      add r18.xyz, -r10.xyzx, cb9[r0.x + 0].xyzx
      mul r5.w, cb9[r0.x + 3].x, cb9[r0.x + 3].x
      dp3 r6.w, r18.xyzx, r18.xyzx
      div r5.w, r5.w, r6.w
      min r5.w, r5.w, l(1.000000)
      mad_sat r18.xy, r3.wwww, cb9[r0.x + 2].xzxx, cb9[r0.x + 2].ywyy
      ...
      if_nz r3.w
        ...
        exp r19.xy, r19.xyxx
        mul r6.w, r19.x, cb9[r0.x + 12].x
        mad r7.w, cb9[r0.x + 12].y, r19.y, l(-1.000000)
        mad r6.w, cb9[r0.x + 12].y, r19.y, -r6.w
      ...
      if_nz r3.w
        ...
        dp3 r5.w, cb9[r0.x + 13].xyzx, r18.xyzx
    ...
    if_nz r3.w
      ...
      if_nz r3.w
        ...
        if_nz r6.w
          ...
          and r5.w, l(0x0000ffff), cb9[r0.x + 1].w
          if_nz cb2[58].y
            mov r17.x, -r13.x
            utof r19.z, r5.w
            mov r17.y, r14.x
            ...
            loop 
              ...
              sample_c_lz_indexable(texture2darray)(float,float,float,float) r8.w, r19.xyzx, t9.xxxx, s13, r3.w
      ...
      if_nz r4.z
        mul r4.z, r1.z, cb9[r0.x + 1].z
        mul r4.z, r2.w, r4.z
        ubfe r5.w, l(4), l(16), cb9[r0.x + 1].w
        ult r6.w, l(0), r5.w
        and r6.w, r0.y, r6.w
        if_nz r6.w
          ...
          if_nz r0.y
            ...
            mad r0.y, |r2.z|, l(-0.200000), l(0.400000)
            mad r17.xyz, r11.xyzx, r0.yyyy, r10.xyzx
            mov r18.xyz, cb9[r0.x + 6].yzwy
            mov r18.w, cb9[r0.x + 7].x
            mov r17.w, l(1.000000)
            dp4 r0.y, r18.xyzw, r17.xyzw
            ...
            if_z r6.w
              ...
              if_z r7.w
                ...
                mad r18.x, r17.x, cb9[r0.x + 8].y, cb9[r0.x + 8].z
                mad r18.y, r17.y, cb9[r0.x + 8].w, cb9[r0.x + 9].x
                mul r8.w, r5.w, cb9[r0.x + 10].z
                mad r0.y, cb9[r0.x + 10].y, r5.w, r0.y
                div r0.y, r0.y, r8.w
              endif 
            else 
              mov r7.w, l(-1)
            ...
            if_z r5.w
              ...
              if_nz cb2[58].y
                ...
                utof r18.z, r5.w
                sample_c_lz_indexable(texture2darray)(float,float,float,float) r6.w, r18.xyzx, t9.xxxx, s13, r0.y
              endif 
              mul r0.x, r6.w, r6.w
              mul r0.x, r6.w, r0.x
            else 
        ...
        mad r2.xyz, r0.zzzz, r14.yzwy, r13.yzwy
        add_sat r0.x, -r0.x, l(1.000000)
        mul r0.w, r0.x, r0.x
        mul r0.w, r0.w, r0.w
        mul r0.x, r0.w, r0.x
        mul r0.x, r0.x, r0.z
        mad r0.xzw, r0.xxxx, r14.yyzw, r16.zzxy
        movc r9.xyz, r0.yyyy, r17.xyzx, r9.xyzx
        movc r16.xyz, r0.yyyy, r0.zwxz, r16.xyzx
        movc r13.yzw, r0.yyyy, r2.xxyz, r13.yyzw
      endif 
    endif 
  endif 
  break 
