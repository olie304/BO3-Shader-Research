...
dp3_sat r8.x, r3.xyzx, r4.xyzx
dp3 r4.w, -r4.xyzx, r3.xyzx
add r4.w, r4.w, r4.w
mad r12.xyz, r3.xyzx, -r4.wwww, -r4.xyzx
...
if_z r5.w
  ...
  if_nz r10.w
    ...
    movc r6.z, r11.w, l(0), l(1.000000)
  endif 
  if_z r10.w
    if_z cb2[58].y
      ftou r10.w, r6.w
    ...
    if_nz cb2[58].y
      ...
      loop 
        ...
        movc r15.w, r13.w, cb2[r6.w + 20].w, cb2[r10.w + 20].w
        movc r13.w, r13.w, r6.w, r10.w
...
if_nz r5.w
  ...
  if_nz r5.w
    ...
    if_nz r9.w
      ...
      mad r19.xyz, r3.xyzx, r10.wwww, v6.xyzx
      ...
      if_z r10.w
        ...
        if_nz cb2[58].y
          ...
          utof r16.z, r10.w
          sample_c_lz_indexable(texture2darray)(float,float,float,float) r12.w, r16.xyzx, t9.xxxx, s13, r6.w
        endif 
...
mad r3.xyz, r29.xyzx, r9.xyzx, r3.xyzx
...
ret 
// Approximately 2762 instruction slots used
