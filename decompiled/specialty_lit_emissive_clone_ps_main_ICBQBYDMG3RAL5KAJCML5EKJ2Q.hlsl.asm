...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:41:26 2021
//
//
...
//   float3 scriptControl;              // Offset:  320 Size:    12 [unused]
...
if_nz r0.x
  ...
  dp3 r2.x, r0.xyzx, v5.xyzx
  dp3 r2.y, r0.xyzx, v6.xyzx
  dp3 r0.x, r0.xyzx, v4.xyzx
  lt r0.y, l(0.000000), r0.x
  div r0.xz, -r2.xxyx, r0.xxxx
  and r0.xy, r0.xzxx, r0.yyyy
  add r0.zw, v2.zzzw, l(0.000000, 0.000000, -0.500000, -0.500000)
...
frc r1.x, r1.x
mad r1.y, cb1[69].w, cb0[16].z, r1.x
mov r1.x, cb0[16].x
sample_l_indexable(texture2d)(float,float,float,float) r1.x, r1.xyxx, t21.xyzw, s3, l(0.000000)
log r1.x, |r1.x|
mul r1.x, r1.x, cb0[17].z
exp r1.x, r1.x
add r1.y, -cb0[17].x, cb0[17].y
mad r1.x, r1.x, r1.y, cb0[17].x
mul r0.xyz, r0.xyzx, r1.xxxx
mul r1.xyz, r0.xyzx, cb1[85].xxxx
movc r0.xyz, cb0[23].wwww, r1.xyzx, r0.xyzx
mul_sat r1.x, v8.z, l(0.02083333)
mul r1.y, r1.x, r1.x
mul r1.x, r1.y, r1.x
mul r0.xyzw, r0.xyzw, r1.xxxx
mul r1.xy, v0.xyxx, cb1[44].zwzz
mul r1.zw, v4.xxxy, cb1[44].zzzw
...
ftou r1.xy, v0.xyxx
bfi r2.x, l(1), l(16), cb0[17].w, l(0)
iadd r2.x, r2.x, l(1)
...
if_nz r2.x
  ...
  ishl r2.y, v0.z, l(2)
  bfi r2.y, l(11), l(0), l(2046), r2.y
  bfi r3.y, l(1), l(0), cb0[17].w, r2.y
