...
r2.w = samp0[]..swiz;
  ...
  if (r8.z != 0) {
    ...
    while (true) {
      ...
      if (r3.x == 0) r8.z = 0; else if (r3.x+0 < 32) {       r8.z = (uint)r6.w << (32-(r3.x + 0)); r8.z = (uint)r8.z >> (32-r3.x);      } else r8.z = (uint)r6.w >> 0;
      r6.w = r7.w ? r8.z : r6.w;
            ...
            r30.w = samp0[]..swiz;
              ...
              r27.w = samp0[]..swiz;
                ...
                if (r22.w != 0) {
                  ...
                  r28.xyz = r29.xyz * r4.yyy;
                  r26.xyz = r26.xyz * r4.yyy;
                  r27.xyz = r27.xyz * r4.yyy;
                  r19.w = -17 * r12.w;
                  r19.w = exp2(r19.w);
                  r18.w = r19.w + r18.w;
                  r18.w = log2(r18.w);
  ...
  r4.xyz = r4.xzw * r1.www + r17.xyz;
  r2.w = dot(r4.xyz, r4.xyz);
  r2.w = rsqrt(r2.w);
  r4.xyz = r4.xyz * r2.www;
  r9.y = r0.z * r1.w + r15.y;
  r3.xyz = r3.yzw * r1.www + r18.xyz;
  ...
  if (r0.z != 0) {
    ...
    r8.zw = r8.zw * scaleUVs.xy + r13.xy;
  ...
  if (r2.w != 0) {
    ...
    r11.x = clampU2 ? r5.x : r1.x;
    r11.y = clampV2 ? r5.y : r1.y;
  }
  r5.xyzw = emissiveMap2.Sample(colorSampler_s, r11.xy).xyzw;
  r5.xyz = emissiveTint2.xyz * r5.xyz;
  r1.x = hdrScale * r5.w;
  r5.xyz = r5.xyz * r1.xxx;
  r0.z = clampV2 + r0.z;
  r0.z = frac(r0.z);
  r1.y = gameTime.w * clampV2 + r0.z;
  r1.x = clampV2;
  r0.z = flickerLookupMap.SampleLevel(lookupSampler_s, r1.xy, 0).x;
  r0.z = log2(abs(r0.z));
  r0.z = flickerPower2 * r0.z;
  r0.z = exp2(r0.z);
  r1.x = flickerRange2.y + -flickerRange2.x;
  r0.z = r0.z * r1.x + flickerRange2.x;
  ...
  if (r1.z == 0) {
    ...
    while (true) {
      ...
      bitmask.w = ((~(-1 << r8.w)) << 0) & 0xffffffff;  r11.w = (((uint)0 << 0) & bitmask.w) | ((uint)r11.y & ~bitmask.w);
    ...
    if (r9.z != 0) {
      ...
      while (true) {
        ...
        if (r8.w == 0) r13.w = 0; else if (r8.w+0 < 32) {         r13.w = (uint)r10.w << (32-(r8.w + 0)); r13.w = (uint)r13.w >> (32-r8.w);        } else r13.w = (uint)r10.w >> 0;
    ...
    if (r6.y != 0) {
      ...
      r1.z = sunConstants.globalProbeExposure * r6.y + -r4.w;
      r1.z = r9.y * r1.z + r4.w;
  ...
  if (r7.w != 0) {
    ...
    if (r7.w != 0) {
      ...
      r18.z = samp0[]..swiz;
      r18.w = samp0[]..swiz;
        r11.z = abs(r4.w) * -0.200000003 + 0.400000006;
        r19.xyz = r4.xyz * r11.zzz + v6.xyz;
        r19.w = 1;
      ...
      r0.z = dot(r11.yzw, r5.xyz);
      r10.w = dot(r4.xyz, r11.yzw);
      r11.y = abs(r10.w) * r3.w + -abs(r10.w);
  ...
  while (true) {
    ...
    if (r8.w != 0) break;
    r9.z = (uint)r7.w >> 5;
    r16.xyz = (int3)r8.xyz + (int3)r9.xyz;
            ...
            if (r26.w != 0) {
              ...
              if (r26.w != 0) {
                ...
                if (r26.w != 0) {
                  ...
                  r24.w = abs(r18.x) * r3.w + -abs(r18.x);
                  r18.x = abs(r18.x) * r24.w + 1;
                  r24.w = r13.w * r0.w + r1.z;
                  r18.x = r18.x * r18.x;
                  r18.x = r18.x * r24.w;
                  r18.x = rcp(r18.x);
                  r13.w = r13.w * r26.w;
