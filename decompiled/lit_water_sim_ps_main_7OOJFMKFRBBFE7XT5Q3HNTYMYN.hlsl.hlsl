// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:39:41 2021
...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  while (true) {
    ...
    while (true) {
      ...
      r19.y = samp0[]..swiz;
        ...
        r19.z = r29.w;
        r19.xyz = cmp(abs(r29.xyz) < r19.zxy);
        r18.w = r19.y ? r19.x : 0;
        r18.w = r19.z ? r18.w : 0;
        if (r18.w != 0) {
        ...
        r30.w = samp0[]..swiz;
          ...
          r18.w = (int)r30.w & 0x0000ffff;
          if (6 == 0) r19.z = 0; else if (6+25 < 32) {           r19.z = (uint)r30.w << (32-(6 + 25)); r19.z = (uint)r19.z >> (32-6);          } else r19.z = (uint)r30.w >> 25;
        // Known bad code for instruction (needs manual fix):
        ...
        r37.z = samp0[]..swiz;
        r37.w = samp0[]..swiz;
          r20.w = dot(r32.xyz, r31.xyz);
          r20.w = saturate(r20.w + r32.w);
          r21.w = dot(r33.xyz, r31.xyz);
          r21.w = saturate(r21.w + r33.w);
          r20.w = r21.w * r20.w;
          r21.w = dot(r34.xyz, r31.xyz);
          r21.w = saturate(r21.w + r34.w);
          r20.w = r21.w * r20.w;
          r21.w = dot(r35.xyz, r31.xyz);
          r21.w = saturate(r21.w + r35.w);
          r20.w = r21.w * r20.w;
          r21.w = dot(r36.xyz, r31.xyz);
          r21.w = saturate(r21.w + r36.w);
          r20.w = r21.w * r20.w;
          r21.w = dot(r37.xyz, r31.xyz);
          ...
          r23.w = 1;
          while (true) {
            r24.w = cmp((int)r23.w >= (int)r19.z);
            if (r24.w != 0) break;
            r24.w = (int)r18.w + (int)r23.w;
          // Known bad code for instruction (needs manual fix):
          ...
          r38.z = samp0[]..swiz;
          r38.w = samp0[]..swiz;
            r24.w = dot(r33.xyz, r31.xyz);
            r24.w = saturate(r24.w + r33.w);
            r24.w = r32.x * r24.w;
            r29.w = dot(r34.xyz, r31.xyz);
            r29.w = saturate(r29.w + r34.w);
            r24.w = r29.w * r24.w;
            r29.w = dot(r35.xyz, r31.xyz);
            r29.w = saturate(r29.w + r35.w);
            r24.w = r29.w * r24.w;
            r29.w = dot(r36.xyz, r31.xyz);
            r29.w = saturate(r29.w + r36.w);
            r24.w = r29.w * r24.w;
            r29.w = dot(r37.xyz, r31.xyz);
            r29.w = saturate(r29.w + r37.w);
            r24.w = r29.w * r24.w;
            r29.w = dot(r38.xyz, r31.xyz);
            r29.w = saturate(r29.w + r38.w);
            r32.x = r29.w * r24.w;
            r31.w = (uint)r21.w >> 2;
            if (1 == 0) r32.z = 0; else if (1+2 < 32) {             r32.z = (uint)r21.w << (32-(1 + 2)); r32.z = (uint)r32.z >> (32-1);            } else r32.z = (uint)r21.w >> 2;
            r32.w = (int)r31.w & 2;
            r33.x = max(r32.y, r32.x);
            r24.w = -r24.w * r29.w + 1;
            r24.w = r32.y * r24.w;
            r22.y = r32.w ? r24.w : r33.x;
            r32.xy = r32.zz ? r32.xy : r22.xy;
            r23.w = (int)r23.w + 1;
            r21.w = r31.w;
          }
          ...
          r43.x = samp0[]..swiz;
          r43.y = samp0[]..swiz;
            r28.z = r32.y * r19.y + r28.z;
            r18.z = r18.w * r30.z;
            r30.z = r38.z;
            r18.w = dot(r17.xyz, r30.xyz);
            r19.x = dot(r31.xyz, r30.xyz);
            r19.x = r19.x + -r38.w;
            r19.y = cmp(r19.x >= 0);
            ...
            r38.z = r39.z;
            r19.x = dot(r17.xyz, r38.xyz);
            r19.y = dot(r31.xyz, r38.xyz);
            r19.y = r19.y + -r39.w;
            r19.z = cmp(r19.y >= 0);
            ...
            r39.z = r40.z;
            r19.x = dot(r17.xyz, r39.xyz);
            r19.y = dot(r31.xyz, r39.xyz);
            r19.y = r19.y + -r40.w;
            r19.z = cmp(r19.y >= 0);
            r19.y = max(abs(r19.y), r11.w);
            r19.y = r19.z ? r19.y : -r19.y;
            ...
            r18.w = min(abs(r19.x), r18.w);
            r40.z = r41.z;
            r19.x = dot(r17.xyz, r40.xyz);
            r19.y = dot(r31.xyz, r40.xyz);
            r19.y = r19.y + -r41.w;
            r19.z = cmp(r19.y >= 0);
            r19.y = max(abs(r19.y), r11.w);
            r19.y = r19.z ? r19.y : -r19.y;
            ...
            r18.w = min(abs(r19.x), r18.w);
            r43.zw = r42.zw;
            r19.x = dot(r17.zxy, r43.xzw);
            r19.y = dot(r31.zxy, r43.xzw);
            r19.y = r19.y + -r43.y;
            r19.z = cmp(r19.y >= 0);
            r19.y = max(abs(r19.y), r11.w);
            r19.y = r19.z ? r19.y : -r19.y;
            ...
            r29.y = r33.z;
            r29.z = r34.x;
            r38.x = dot(r19.xyz, r29.xyz);
            r30.xy = r33.xw;
            r30.z = r34.w;
            r38.y = dot(r19.xyz, r30.xyz);
            r34.x = r33.y;
            r38.z = dot(r19.xyz, r34.xyz);
            if (9 == 0) r19.x = 0; else if (9+16 < 32) {             r19.x = (uint)r30.w << (32-(9 + 16)); r19.x = (uint)r19.x >> (32-9);            } else r19.x = (uint)r30.w >> 16;
            r38.w = (uint)r19.x;
            r19.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r38.xyzw, r18.w).xyz;
            ...
            r32.xzw = r32.xzw * r18.zzz;
            r23.z = r29.y ? 0 : 0.5;
            r29.xyw = r31.xyz + r23.xyz;
            ...
            r18.w = dot(r31.xyz, float3(0.212599993,0.715200007,0.0722000003));
            ...
            r29.x = r27.w;
            r29.yz = r28.xy;
            r28.xyw = r19.yzx * r18.zzz + r29.yzx;
            r27.w = r28.w;
          }
        }
      }
  ...
  if (r15.y != 0) {
    ...
    r16.z = 0;
    while (true) {
      r16.w = cmp((uint)r16.z >= (uint)r13.z);
      if (r16.w != 0) break;
      r18.z = (uint)r16.z >> 5;
      r19.xyz = (int3)r4.xyz + (int3)r18.xyz;
      r16.w = visibleProbes.Load(r19.xyzw).x;
      r18.z = cmp((int)r13.w == (int)r16.z);
      if (r14.w == 0) r18.w = 0; else if (r14.w+0 < 32) {       r18.w = (uint)r16.w << (32-(r14.w + 0)); r18.w = (uint)r18.w >> (32-r14.w);      } else r18.w = (uint)r16.w >> 0;
      r16.w = r18.z ? r18.w : r16.w;
      r18.z = (int)r16.z + numLights;
      r28.xyzw = r27.xyzw;
      r19.xyz = r15.yzw;
      r18.w = r16.y;
      r20.w = r16.w;
      while (true) {
        ...
        r23.w = 1 << (int)r21.w;
        r24.w = (int)r20.w & (int)r23.w;
        if (r24.w != 0) {
          r20.w = (int)r20.w ^ (int)r23.w;
          r23.w = (int)r18.z + (int)r21.w;
        // Known bad code for instruction (needs manual fix):
        ...
        r30.y = samp0[]..swiz;
          ...
          r31.w = samp0[]..swiz;
            ...
            if (6 == 0) r24.w = 0; else if (6+25 < 32) {             r24.w = (uint)r31.w << (32-(6 + 25)); r24.w = (uint)r24.w >> (32-6);            } else r24.w = (uint)r31.w >> 25;
          // Known bad code for instruction (needs manual fix):
          ...
          r38.z = samp0[]..swiz;
          r38.w = samp0[]..swiz;
            r29.w = dot(r33.xyz, r32.xyz);
            r29.w = saturate(r29.w + r33.w);
            r30.z = dot(r34.xyz, r32.xyz);
            r30.z = saturate(r30.z + r34.w);
            r29.w = r30.z * r29.w;
            r30.z = dot(r35.xyz, r32.xyz);
            r30.z = saturate(r30.z + r35.w);
            r29.w = r30.z * r29.w;
            r30.z = dot(r36.xyz, r32.xyz);
            r30.z = saturate(r30.z + r36.w);
            r29.w = r30.z * r29.w;
            r30.z = dot(r37.xyz, r32.xyz);
            r30.z = saturate(r30.z + r37.w);
            r29.w = r30.z * r29.w;
            r30.z = dot(r38.xyz, r32.xyz);
            r30.z = saturate(r30.z + r38.w);
            r20.x = r30.z * r29.w;
            r29.w = (int)r30.x & 1;
            r30.zw = r29.ww ? r20.xy : r20.zx;
            r20.x = r30.x;
            r33.xy = r30.zw;
            r29.w = 1;
            while (true) {
              r32.w = cmp((int)r29.w >= (int)r24.w);
              if (r32.w != 0) break;
              r32.w = (int)r23.w + (int)r29.w;
            // Known bad code for instruction (needs manual fix):
            ...
            r39.z = samp0[]..swiz;
            r39.w = samp0[]..swiz;
              r32.w = dot(r34.xyz, r32.xyz);
              r32.w = saturate(r32.w + r34.w);
              r32.w = r33.x * r32.w;
              r33.z = dot(r35.xyz, r32.xyz);
              r33.z = saturate(r33.z + r35.w);
              r32.w = r33.z * r32.w;
              r33.z = dot(r36.xyz, r32.xyz);
              r33.z = saturate(r33.z + r36.w);
              r32.w = r33.z * r32.w;
              r33.z = dot(r37.xyz, r32.xyz);
              r33.z = saturate(r33.z + r37.w);
              r32.w = r33.z * r32.w;
              r33.z = dot(r38.xyz, r32.xyz);
              r33.z = saturate(r33.z + r38.w);
              r32.w = r33.z * r32.w;
              r33.z = dot(r39.xyz, r32.xyz);
              r33.z = saturate(r33.z + r39.w);
              r33.x = r33.z * r32.w;
              r33.w = (uint)r20.x >> 2;
              if (1 == 0) r34.x = 0; else if (1+2 < 32) {               r34.x = (uint)r20.x << (32-(1 + 2)); r34.x = (uint)r34.x >> (32-1);              } else r34.x = (uint)r20.x >> 2;
              r34.y = (int)r33.w & 2;
              r34.z = max(r33.y, r33.x);
              r32.w = -r32.w * r33.z + 1;
              r32.w = r33.y * r32.w;
              r22.y = r34.y ? r32.w : r34.z;
              r33.xy = r34.xx ? r33.xy : r22.xy;
              r29.w = (int)r29.w + 1;
              r20.x = r33.w;
            }
            r20.x = saturate(r33.y + -r18.w);
            r22.y = r20.x * r30.y;
            r23.w = cmp(0 < r22.y);
            if (r23.w != 0) {
            // Known bad code for instruction (needs manual fix):
            ...
            r44.x = samp0[]..swiz;
            r44.y = samp0[]..swiz;
              r28.w = r20.x * r30.y + r28.w;
              r20.x = r22.y * r31.z;
              r31.z = r39.z;
              r21.w = dot(r17.xyz, r31.xyz);
              r22.y = dot(r32.xyz, r31.xyz);
              r22.y = r22.y + -r39.w;
              r23.w = cmp(r22.y >= 0);
              r22.y = max(abs(r22.y), r11.w);
              r22.y = r23.w ? r22.y : -r22.y;
              r21.w = max(1.00000001e-07, -r21.w);
              r21.w = r22.y / r21.w;
              r21.w = min(131072, abs(r21.w));
              r39.z = r40.z;
              r22.y = dot(r17.xyz, r39.xyz);
              r23.w = dot(r32.xyz, r39.xyz);
              r23.w = r23.w + -r40.w;
              r24.w = cmp(r23.w >= 0);
              r23.w = max(abs(r23.w), r11.w);
              r23.w = r24.w ? r23.w : -r23.w;
              r22.y = max(1.00000001e-07, -r22.y);
              r22.y = r23.w / r22.y;
              r21.w = min(abs(r22.y), r21.w);
              r40.z = r41.z;
              r22.y = dot(r17.xyz, r40.xyz);
              r23.w = dot(r32.xyz, r40.xyz);
              r23.w = r23.w + -r41.w;
              r24.w = cmp(r23.w >= 0);
              r23.w = max(abs(r23.w), r11.w);
              r23.w = r24.w ? r23.w : -r23.w;
              ...
              r21.w = min(abs(r22.y), r21.w);
              r41.z = r42.z;
              r22.y = dot(r17.xyz, r41.xyz);
              r23.w = dot(r32.xyz, r41.xyz);
              r23.w = r23.w + -r42.w;
              r24.w = cmp(r23.w >= 0);
              r23.w = max(abs(r23.w), r11.w);
              r23.w = r24.w ? r23.w : -r23.w;
              ...
              r21.w = min(abs(r22.y), r21.w);
              r42.z = r43.x;
              r22.y = dot(r17.xyz, r42.xyz);
              r23.w = dot(r32.xyz, r42.xyz);
              r23.w = r23.w + -r43.y;
              r24.w = cmp(r23.w >= 0);
              r23.w = max(abs(r23.w), r11.w);
              r23.w = r24.w ? r23.w : -r23.w;
              ...
              r21.w = min(abs(r22.y), r21.w);
              r44.zw = r43.zw;
              r22.y = dot(r17.zxy, r44.xzw);
              r23.w = dot(r32.zxy, r44.xzw);
              r23.w = r23.w + -r44.y;
              r24.w = cmp(r23.w >= 0);
              r23.w = max(abs(r23.w), r11.w);
              r23.w = r24.w ? r23.w : -r23.w;
              ...
              r30.xyz = r17.xyz * r21.www + r30.xyz;
              r22.y = dot(r30.xyz, r30.xyz);
              r22.y = sqrt(r22.y);
              r21.w = r21.w / r22.y;
              r21.w = r21.w + r21.w;
              r21.w = sqrt(r21.w);
              ...
              if (9 == 0) r22.y = 0; else if (9+16 < 32) {               r22.y = (uint)r31.w << (32-(9 + 16)); r22.y = (uint)r22.y >> (32-9);              } else r22.y = (uint)r31.w >> 16;
              r39.w = (uint)r22.y;
              r30.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r39.xyzw, r21.w).xyz;
              r34.x = dot(r32.xyz, r29.xyz);
              r34.y = dot(r32.xyz, r31.xyz);
              r34.z = dot(r32.xyz, r35.xyz);
              r32.xyz = saturate(r34.xyz * r36.xyz + float3(0.5,0.5,0.5));
              r37.z = r38.x;
              r32.xyz = r32.xyz * r37.xyz + r38.yzw;
              r39.x = dot(r2.xyz, r29.xyz);
              r39.y = dot(r2.xyz, r31.xyz);
              r39.z = dot(r2.xyz, r35.xyz);
              r29.xyz = cmp(float3(0,0,0) < r39.xyz);
              r21.z = r29.x ? 0 : 0.5;
              r31.xyz = r32.xyz + r21.xyz;
              r31.xyz = gProbeXArray.SampleLevel(samplerLinearClamp_s, r31.xyz, 0).xyz;
              r33.xzw = r39.xyz * r39.xyz;
              r33.xzw = r33.xzw * r20.xxx;
              r23.z = r29.y ? 0 : 0.5;
              r29.xyw = r32.xyz + r23.xyz;
              r29.xyw = gProbeYArray.SampleLevel(samplerLinearClamp_s, r29.xyw, 0).xyz;
              r29.xyw = r29.xyw * r33.zzz;
              r29.xyw = r31.xyz * r33.xxx + r29.xyw;
              r24.z = r29.z ? 0 : 0.5;
              r31.xyz = r32.xyz + r24.xyz;
              r31.xyz = gProbeZArray.SampleLevel(samplerLinearClamp_s, r31.xyz, 0).xyz;
              r29.xyz = r31.xyz * r33.www + r29.xyw;
              r31.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r39.xyzw, 6).xyz;
              r32.xyz = r31.xyz * r29.xyz;
              r21.z = dot(r32.xyz, float3(0.212599993,0.715200007,0.0722000003));
              r19.xyz = r29.xyz * r31.xyz + r19.xyz;
              r21.w = r21.z * r12.w;
              r29.xyz = r30.xyz * r20.xxx;
              r20.x = dot(r29.xyz, float3(0.212599993,0.715200007,0.0722000003));
              r20.x = r12.w * r21.z + r20.x;
              r20.x = r21.w / r20.x;
              r28.xyz = r29.xyz * r20.xxx + r28.xyz;
            }
          }
        }
      }
  ...
  r0.z = max(1, r26.w);
  r0.z = rcp(r0.z);
  r26.w = saturate(r26.w);
  r15.yzw = r25.xyz * r0.zzz;
  r16.yzw = r26.xyz * r0.zzz;
  r11.w = cmp(r26.w < 0.99000001);
  if (r11.w != 0) {
    r11.w = 1 + -r26.w;
    r12.w = sunConstants.globalProbeExposure * r11.w;
    r18.xyz = -globalProbeConstants.data[0].xyz + v7.xyz;
    ...
    r15.yzw = r25.xyz * r0.zzz + r18.xyz;
    r17.w = 0;
    r17.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r17.xyzw, r11.z).xyz;
    r0.z = sunConstants.globalProbeExposure * r11.w + -r2.w;
    r0.z = r10.z * r0.z + r2.w;
    r16.yzw = r17.xyz * r0.zzz + r16.yzw;
  }
  if (useSSR != 0) {
    r0.z = dot(r9.xyz, r2.xyz);
    r0.z = r0.z + r0.z;
    r17.xyz = r2.xyz * -r0.zzz + r9.xyz;
    r0.z = dot(r9.xyz, -r2.xyz);
    r0.z = r0.z + r0.z;
    r18.xyz = r2.xyz * r0.zzz + r9.xyz;
    r17.xyz = v10.xxx ? r17.xyz : r18.xyz;
    if (useLoopedSSR != 0) {
      r18.xyz = viewMatrix._m10_m11_m12 * v7.yyy;
      r18.xyz = v7.xxx * viewMatrix._m00_m01_m02 + r18.xyz;
      r18.xyz = v7.zzz * viewMatrix._m20_m21_m22 + r18.xyz;
      r19.xyz = ssrParams.zzz * r17.xyz;
      r20.xyz = viewMatrix._m10_m11_m12 * r19.yyy;
      r19.xyw = r19.xxx * viewMatrix._m00_m01_m02 + r20.xyz;
      r19.xyz = r19.zzz * viewMatrix._m20_m21_m22 + r19.xyw;
      r0.z = min(1000, ssrParams.x);
      r18.xyz = r19.xyz * float3(10,10,10) + r18.xyz;
      ...
      while (true) {
        ...
        r23.xyz = projectionMatrix._m10_m11_m13 * r21.yyy;
        r23.xyz = r21.xxx * projectionMatrix._m00_m01_m03 + r23.xyz;
        r23.xyz = r21.zzz * projectionMatrix._m20_m21_m23 + r23.xyz;
        r23.xyz = projectionMatrix._m30_m31_m33 + r23.xyz;
        r10.z = max(abs(r23.x), abs(r23.y));
        r10.z = cmp(r23.z < r10.z);
        if (r10.z != 0) {
          break;
        }
        r11.zw = r23.xy / r23.zz;
        r11.zw = r11.zw * float2(0.5,-0.5) + float2(0.5,0.5);
        r10.z = ifloatZSceneDownsampled.SampleLevel(bilinearClamp_s, r11.zw, 1).x;
        r11.z = cmp(abs(r10.z) < r21.z);
        r11.w = cmp(abs(r10.z) >= v0.w);
        r11.z = r11.w ? r11.z : 0;
        if (r11.z != 0) {
          r10.z = r21.z + -abs(r10.z);
          r10.z = ssrParams.w * r10.z;
          r23.xyz = -r10.zzz * r19.xyz + r21.xyz;
          r24.xyz = projectionMatrix._m10_m11_m13 * r23.yyy;
          r23.xyw = r23.xxx * projectionMatrix._m00_m01_m03 + r24.xyz;
          r23.xyz = r23.zzz * projectionMatrix._m20_m21_m23 + r23.xyw;
          r23.xyz = projectionMatrix._m30_m31_m33 + r23.xyz;
          r11.zw = r23.xy / r23.zz;
          r11.zw = r11.zw * float2(0.5,-0.5) + float2(0.5,0.5);
          r23.xyz = iResolveScene.SampleLevel(bilinearClamp_s, r11.zw, 0).xyz;
          r23.xyz = relHDRExposure.xxx * r23.xyz;
          r20.xyz = r23.xyz;
          break;
        }
        r2.w = (int)r2.w + 1;
      ...
      r17.xyz = r17.xyz * r0.zzz + v7.xyz;
      r18.xyz = viewProjectionMatrix._m10_m11_m13 * r17.yyy;
      r17.xyw = r17.xxx * viewProjectionMatrix._m00_m01_m03 + r18.xyz;
      r17.xyz = r17.zzz * viewProjectionMatrix._m20_m21_m23 + r17.xyw;
      r17.xyz = viewProjectionMatrix._m30_m31_m33 + r17.xyz;
      r11.zw = r17.xy / r17.zz;
      ...
      r0.z = cmp(r0.z < 1);
      r0.z = r0.z ? r2.w : 0;
      r17.xyz = iResolveScene.Sample(bilinearClamp_s, r11.zw).xyz;
      if (r0.z != 0) {
        r16.yzw = relHDRExposure.xxx * r17.xyz;
      }
    }
  }
  ...
  if (r10.z == 0) {
    r17.xyz = sunConstants.sstLightingConstants.offToPinTransform._m10_m11_m12 * v7.yyy;
    r17.xyz = v7.xxx * sunConstants.sstLightingConstants.offToPinTransform._m00_m01_m02 + r17.xyz;
    r17.xyz = v7.zzz * sunConstants.sstLightingConstants.offToPinTransform._m20_m21_m22 + r17.xyz;
    r17.xyz = sunConstants.sstLightingConstants.offToPinTransform._m30_m31_m32 + r17.xyz;
    r10.z = -sunConstants.splitDepthOffset + r17.z;
    ...
    if (r11.w != 0) {
      ...
      while (true) {
        ...
        if (r13.z != 0) break;
        r13.z = (uint)r11.w;
        r18.xy = -sunConstants.splitPinTransform[r13.z].xy + r17.xy;
        r13.w = max(abs(r18.x), abs(r18.y));
    ...
    r13.z = cmp(r11.w >= 3);
    if (r13.z != 0) {
      r18.xyz = sunConstants.sstLightingConstants.constants.inchesPerTexel * float3(128,0.5,0.5);
      r19.xz = rcp(r18.xx);
      r19.y = -r19.z;
      r18.xyz = r17.xyx * r19.xyz + r18.yzy;
      ...
      r18.xyz = min(r18.xyz, r19.xyz);
      r19.xy = sunConstants.sstLightingConstants.coordScale * r18.zy;
      r19.xy = floor(r19.xy);
      r13.w = sunConstants.sstLightingConstants.constants.dimensionInTiles.x * r19.y;
      r13.w = r13.w * sunConstants.sstLightingConstants.coordScale + r19.x;
      r13.w = (uint)r13.w;
    ...
    r14.w = samp0[]..swiz;
      r17.w = (int)r14.w & 0x40000000;
      r18.w = (uint)r14.w << 2;
      if (r17.w == 0) {
        r17.w = (int)r14.w & 0x01ffffff;
        r19.x = (int)r13.w + (int)r17.w;
        r13.w = (uint)r14.w >> 25;
        r13.w = (uint)r13.w;
        r18.xyz = r18.xyz * r13.www;
        r18.xyz = frac(r18.xyz);
        r18.xyz = float3(128,128,128) * r18.xyz;
        r18.xyz = (uint3)r18.xyz;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r19.z, r19.x, l(0), t23.xxxx
      r19.z = samp0[]..swiz;
        r20.xy = (uint2)r18.zy >> int2(6,6);
        r13.w = (int)r19.z & 0xc0000000;
        r14.w = (int)r19.x + 1;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r14.w, r14.w, l(0), t23.xxxx
      r14.w = samp0[]..swiz;
        r14.w = r20.y ? r19.z : r14.w;
        r17.w = (uint)r14.w >> 13;
        r14.w = r20.x ? r17.w : r14.w;
      ...
      r20.z = samp0[]..swiz;
        r19.y = 0;
        r20.y = 1;
        r20.xyz = r13.www ? r19.xyz : r20.xyz;
        r21.yz = r13.ww ? float2(8.40779079e-45,1.40129846e-45) : float2(7.00649232e-45,2.80259693e-45);
        r22.xy = (uint2)r18.zy >> (uint2)r21.yy;
      ...
      r17.w = samp0[]..swiz;
        r17.w = r22.y ? r20.z : r17.w;
        r19.w = (uint)r17.w >> 13;
        r17.w = r22.x ? r19.w : r17.w;
      ...
      r21.w = samp0[]..swiz;
        r20.xyz = r14.www ? r20.xyz : r21.xzw;
        r19.xyz = r13.www ? r19.xyz : r20.xyz;
        r13.w = (int)r19.z & 0xc0000000;
        if (r13.w == 0) {
          r13.w = (int)-r19.y + 6;
          r20.xy = (uint2)r18.zy >> (uint2)r13.ww;
          r13.w = (int)r19.z | 0x40000000;
          bitmask.w = ((~(-1 << 1)) << 1) & 0xffffffff;  r14.w = (((uint)r20.y << 1) & bitmask.w) | ((uint)0 & ~bitmask.w);
          bitmask.w = ((~(-1 << 1)) << 0) & 0xffffffff;  r14.w = (((uint)r20.x << 0) & bitmask.w) | ((uint)r14.w & ~bitmask.w);
          r14.w = (int)r14.w * 10;
        ...
        r20.w = samp0[]..swiz;
          ...
          r13.w = (int)-r20.y + 6;
          r19.yw = (uint2)r18.zy >> (uint2)r13.ww;
          r13.w = (int)r20.w & 0xc0000000;
          r14.w = (int)r20.w | 0x40000000;
          bitmask.w = ((~(-1 << 1)) << 1) & 0xffffffff;  r17.w = (((uint)r19.w << 1) & bitmask.w) | ((uint)0 & ~bitmask.w);
          bitmask.w = ((~(-1 << 1)) << 0) & 0xffffffff;  r17.w = (((uint)r19.y << 0) & bitmask.w) | ((uint)r17.w & ~bitmask.w);
          r17.w = (int)r17.w * 10;
          r14.w = (uint)r14.w >> (uint)r17.w;
          r14.w = (int)r14.w & 1023;
          r21.x = (int)r14.w + (int)r20.x;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r21.z, r21.x, l(0), t23.xxxx
        r21.z = samp0[]..swiz;
          r21.y = r20.z;
          r21.xyz = r13.www ? r20.xyw : r21.xyz;
          r14.w = (int)-r21.y + 6;
          r19.yw = (uint2)r18.zy >> (uint2)r14.ww;
          r14.w = (int)r21.z & 0xc0000000;
          r17.w = (int)r21.z | 0x40000000;
          bitmask.w = ((~(-1 << 1)) << 1) & 0xffffffff;  r19.w = (((uint)r19.w << 1) & bitmask.w) | ((uint)0 & ~bitmask.w);
          bitmask.y = ((~(-1 << 1)) << 0) & 0xffffffff;  r19.y = (((uint)r19.y << 0) & bitmask.y) | ((uint)r19.w & ~bitmask.y);
          r19.y = (int)r19.y * 10;
          r17.w = (uint)r17.w >> (uint)r19.y;
          r17.w = (int)r17.w & 1023;
          r22.x = (int)r17.w + (int)r21.x;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r22.y, r22.x, l(0), t23.xxxx
        r22.y = samp0[]..swiz;
          r19.yw = r14.ww ? r21.xz : r22.xy;
          r19.xz = r13.ww ? r20.xw : r19.yw;
        }
        r13.w = (int)r19.z & 0xc0000000;
        if (r13.w == 0) {
          if (14 == 0) r14.w = 0; else if (14+15 < 32) {           r14.w = (uint)r19.z << (32-(14 + 15)); r14.w = (uint)r14.w >> (32-14);          } else r14.w = (uint)r19.z >> 15;
          r14.w = (uint)r14.w;
          r14.w = sunConstants.sstLightingConstants.constants.spanInInches * r14.w;
          r14.w = 6.10388815e-05 * r14.w;
          r19.yw = (int2)r19.zz & int2(32767,536870912);
          r17.w = (uint)r19.y;
          r17.w = sunConstants.sstLightingConstants.constants.spanInInches * r17.w;
          r17.w = 3.05185094e-05 * r17.w;
          r19.y = (int)r18.y & 3;
          r19.y = (int)r19.y + (int)r19.x;
          r19.y = (int)r19.y + 1;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r19.y, r19.y, l(0), t23.xxxx
        r19.y = samp0[]..swiz;
          bitmask.x = ((~(-1 << 2)) << 3) & 0xffffffff;  r20.x = (((uint)r18.x << 3) & bitmask.x) | ((uint)0 & ~bitmask.x);
          bitmask.y = ((~(-1 << 2)) << 1) & 0xffffffff;  r20.y = (((uint)r18.y << 1) & bitmask.y) | ((uint)0 & ~bitmask.y);
          bitmask.z = ((~(-1 << 1)) << 4) & 0xffffffff;  r20.z = (((uint)r18.z << 4) & bitmask.z) | ((uint)0 & ~bitmask.z);
          r18.x = (uint)r19.y >> (uint)r20.x;
          r18.x = (int)r18.x & 255;
          r18.x = (uint)r18.x;
          r18.x = r18.x * r17.w;
          r18.x = r18.x * 0.00392156886 + r14.w;
          r18.y = (int)r20.y + 1;
          if (1 == 0) r18.z = 0; else if (1+1 < 32) {           r18.z = (uint)r18.z << (32-(1 + 1)); r18.z = (uint)r18.z >> (32-1);          } else r18.z = (uint)r18.z >> 1;
          r18.y = (int)r18.z + (int)r18.y;
          r18.y = (int)r18.y + (int)r19.x;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r18.y, r18.y, l(0), t23.xxxx
        r18.y = samp0[]..swiz;
          r18.y = (uint)r18.y >> (uint)r20.z;
          r18.y = (int)r18.y & 0x0000ffff;
          r18.y = (uint)r18.y;
          r17.w = r18.y * r17.w;
          r14.w = r17.w * 1.52590219e-05 + r14.w;
          r18.w = r19.w ? r18.x : r14.w;
        } else {
          r14.w = (int)r19.z & 0x80000000;
          r17.w = (int)r19.x + 1;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r17.w, r17.w, l(0), t23.xxxx
        r17.w = samp0[]..swiz;
          ...
          r17.w = (uint)r19.z << 2;
          r18.x = (uint)r14.w >> 16;
          r18.x = f16tof32(r18.x);
          r14.w = (int)r14.w & 0x0000ffff;
          r14.w = f16tof32(r14.w);
          r17.w = r17.x * r18.x + r17.w;
          r14.w = r17.y * r14.w + r17.w;
          r18.w = r13.w ? r14.w : r18.w;
        }
      }
      r13.w = -sunConstants.sstLightingConstants.constants.inchesPerTexel * 2 + r17.z;
      r13.w = cmp(r18.w < r13.w);
      r11.z = r13.w ? 0 : 1;
    }
    if (r13.z == 0) {
      if (enableDitheredShadow == 0) {
        r13.z = (uint)r11.w;
        r17.zw = -sunConstants.splitPinTransform[r13.z].xy + r17.xy;
        r13.zw = sunConstants.splitPinTransform[r13.z].zz * r17.zw;
        r18.xy = r13.zw * float2(0.5,-0.5) + float2(0.5,0.5);
        r13.z = (int16)sunConstants.splitArrayOffset;
        r18.z = r13.z + r11.w;
        r13.z = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r18.xyz, r10.z).x;
      ...
      if (enableDitheredShadow != 0) {
        ...
        r12.w = (uint)r12.w;
        r17.zw = -sunConstants.splitPinTransform[r13.z].xy + r17.xy;
        r17.zw = sunConstants.splitPinTransform[r13.z].zz * r17.zw;
        r17.zw = r17.zw * float2(0.5,-0.5) + float2(0.5,0.5);
        r17.xy = -sunConstants.splitPinTransform[r11.w].xy + r17.xy;
        ...
        r14.w = 0;
        while (true) {
          r18.w = cmp((uint)r14.w >= 8);
          if (r18.w != 0) break;
          r18.w = cmp((uint)r12.w < (uint)r14.w);
          r19.xy = r18.ww ? r17.xy : r17.zw;
          r19.z = r18.w ? sunConstants.splitPinTransform[r11.w].w : sunConstants.splitPinTransform[r13.z].w;
          r18.w = r18.w ? r11.w : r13.z;
          r20.x = dot(icb[r14.w+0].yx, r18.xy);
          r20.y = dot(icb[r14.w+0].yx, r18.yz);
          r19.xy = r20.xy * r19.zz + r19.xy;
          r18.w = (int)r18.w + (int16)sunConstants.splitArrayOffset;
          r19.z = (uint)r18.w;
          r18.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r19.xyz, r10.z).x;
          r19.x = gTransShadowmapArray.SampleLevel(samp0_s, r19.xyz, 0).x;
          r18.w = r19.x + r18.w;
          r18.w = saturate(-1 + r18.w);
          r13.w = r18.w * 0.125 + r13.w;
          r14.w = (int)r14.w + 1;
        }
        r10.z = r13.w * r13.w;
        r11.z = r10.z * r13.w;
  ...
  r23.w = samp0[]..swiz;
    ...
    r24.xyz = r2.xyz * r0.zzz + v7.xyz;
    r24.w = 1;
    r17.x = dot(r17.xyzw, r24.xyzw);
    r17.y = dot(r18.xyzw, r24.xyzw);
    r0.z = dot(r19.xyzw, r24.xyzw);
    r12.w = dot(r20.xyzw, r24.xyzw);
    r13.z = cmp(r12.w < r0.z);
    r17.xy = r17.xy / r12.ww;
    r17.xy = r17.xy * float2(0.5,-0.5) + float2(0.5,0.5);
    r17.xy = r17.xy + r23.zw;
    r17.xy = r17.xy * r23.xy;
    r17.zw = r11.ww / r21.xz;
    r18.xy = float2(1,1) + -r17.zw;
    r18.xy = cmp(r17.xy >= r18.xy);
    r17.zw = cmp(r17.zw >= r17.xy);
    r17.zw = (int2)r17.zw | (int2)r18.xy;
    r13.w = (int)r17.w | (int)r17.z;
    ...
    r17.w = samp0[]..swiz;
      ...
      r18.xy = r17.xy * r21.xz + r21.yw;
      r10.z = r17.w * r12.w;
      r0.z = r17.z * r12.w + r0.z;
      r0.z = r0.z / r10.z;
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          if (r13.w != 0) break;
          r20.x = dot(icb[r13.z+0].yx, r17.xy);
          r20.y = dot(icb[r13.z+0].yx, r17.yz);
          r19.xy = r20.xy * r11.ww + r18.xy;
        ...
        r18.z = (uint)r10.z;
        r12.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r18.xyz, r0.z).x;
      }
      r0.z = r12.w * r12.w;
      r0.z = r0.z * r12.w;
    } else {
  ...
  if (r10.z != 0) {
    ...
    r18.xyz = r11.yyy * r3.xyz;
    r18.xyz = r18.xyz * r2.www + r16.yzw;
    r3.xyz = r11.zzz * r3.xyz;
    r3.xyz = r3.xyz * r2.www + r18.xyz;
  } else {
    r17.xyz = r15.yzw;
    r3.xyz = r16.yzw;
  }
  r11.yzw = r0.zzz ? r17.xyz : r15.yzw;
  r3.xyz = r0.zzz ? r3.xyz : r16.yzw;
  r17.x = -r13.x;
  r18.xy = float2(0,0);
  r19.w = 0;
  r20.xyz = v7.xyz;
  ...
  while (true) {
    ...
    while (true) {
      ...
      r13.w = 1 << (int)r13.z;
      r14.w = (int)r12.w & (int)r13.w;
      if (r14.w != 0) {
        r12.w = (int)r12.w ^ (int)r13.w;
        r13.z = (int)r2.w + (int)r13.z;
      // Known bad code for instruction (needs manual fix):
      ...
      r34.z = samp0[]..swiz;
      r34.w = samp0[]..swiz;
        if (3 == 0) r13.w = 0; else if (3+24 < 32) {         r13.w = (uint)r30.x << (32-(3 + 24)); r13.w = (uint)r13.w >> (32-3);        } else r13.w = (uint)r30.x >> 24;
        switch (r13.w) {
          case 4 :          r13.w = cmp(0 < r34.x);
          r35.x = r33.w;
          r35.yz = r34.zw;
          r36.xyz = -r35.xyz * float3(0.5,0.5,0.5) + r28.xyz;
          r37.xyz = -v7.xyz + r36.xyz;
          r14.w = dot(r35.xyz, r37.xyz);
          r14.w = saturate(-r14.w / r34.x);
          r35.xyz = r14.www * r35.xyz + r36.xyz;
          r35.xyz = r13.www ? r35.xyz : r28.xyz;
          r35.xyz = -v7.xyz + r35.xyz;
          r13.w = dot(r35.xyz, r35.xyz);
          r14.w = rsqrt(r13.w);
          r36.xyz = r35.xyz * r14.www;
          r18.z = dot(r2.xyz, r36.xyz);
          r18.w = saturate(r18.z);
          r18.w = useSpecularZFeather ? abs(r18.z) : r18.w;
          r22.x = cmp(0 < r18.w);
          if (r22.x != 0) {
            r22.x = sqrt(r13.w);
            r22.y = r31.y * r31.y;
            r13.w = r22.y / r13.w;
            r13.w = min(1, r13.w);
            r22.y = saturate(r22.x * r30.y + r30.z);
            r22.x = saturate(r22.x * r30.w + r31.x);
            r23.w = r22.y * r22.y;
            r22.y = r22.y * -2 + 3;
            r22.y = r23.w * r22.y;
            r13.w = r22.y * r13.w;
            ...
            r22.x = cmp(0 < r13.w);
            if (r22.x != 0) {
              if (3 == 0) r22.x = 0; else if (3+27 < 32) {               r22.x = (uint)r30.x << (32-(3 + 27)); r22.x = (uint)r22.x >> (32-3);              } else r22.x = (uint)r30.x >> 27;
              if (4 == 0) r22.y = 0; else if (4+20 < 32) {               r22.y = (uint)r30.x << (32-(4 + 20)); r22.y = (uint)r22.y >> (32-4);              } else r22.y = (uint)r30.x >> 20;
              r22.x = cmp((int)r22.x != 1);
              if (r22.x != 0) {
                r22.x = abs(r18.z) * -0.200000003 + 0.400000006;
                r23.w = cmp(r18.z < 0);
                r23.w = r10.w ? r23.w : 0;
                r22.x = r23.w ? -r22.x : r22.x;
                r36.xyz = r2.xyz * r22.xxx + v7.xyz;
                r32.z = r33.x;
                r36.xyz = r36.xyz + -r32.xyz;
                r22.x = max(abs(r36.y), abs(r36.z));
                r22.x = max(abs(r36.x), r22.x);
                r22.x = r33.y / r22.x;
                r22.x = r22.x + r33.z;
                r23.w = dot(r36.xyz, r36.xyz);
                r23.w = rsqrt(r23.w);
                r22.x = max(6.10351563e-05, r22.x);
                r26.w = (int)r30.x & 0x0000ffff;
                r37.w = (uint)r26.w;
                r26.w = 0;
                r27.w = 0;
                while (true) {
                  r35.w = cmp((int)r27.w >= 8);
                  if (r35.w != 0) break;
                  r38.y = dot(icb[r27.w+0].yx, r17.xy);
                  r38.z = dot(icb[r27.w+0].yx, r17.yz);
                  r38.yz = r38.yz * r31.zz;
                  r38.x = r38.y * r16.x;
                  r38.w = r38.y * r15.x;
                  r37.xyz = r36.xyz * r23.www + r38.xzw;
                  r35.w = gOmniShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r37.xyzw, r22.x).x;
                  r26.w = r35.w * 0.125 + r26.w;
                  r27.w = (int)r27.w + 1;
                }
              } else {
                r26.w = 1;
              ...
              r37.w = samp0[]..swiz;
                ...
                r18.z = cmp(r18.z < 0);
                r18.z = r10.w ? r18.z : 0;
                r18.z = r18.z ? -r23.w : r23.w;
                r21.xyz = r2.xyz * r18.zzz + v7.xyz;
                r18.z = dot(r36.xyzw, r21.xyzw);
                r23.w = dot(r37.xyzw, r21.xyzw);
                ...
                r40.y = samp0[]..swiz;
                  ...
                  r36.y = dot(r37.xyzw, r21.xyzw);
                  r21.xy = r36.xy / r23.ww;
                  r21.xy = r21.xy * float2(0.5,-0.5) + float2(0.5,0.5);
                  r21.xy = r21.xy + r39.zw;
                  r21.xy = r21.xy * r39.xy;
                  r36.xy = r22.yy / r38.xz;
                  r36.zw = float2(1,1) + -r36.xy;
                  r36.zw = cmp(r21.xy >= r36.zw);
                  r36.xy = cmp(r36.xy >= r21.xy);
                  r36.xy = (int2)r36.xy | (int2)r36.zw;
                  r21.z = (int)r36.y | (int)r36.x;
                  r21.xy = saturate(r21.xy);
                  r36.xy = r21.xy * r38.xz + r38.yw;
                  r21.x = r40.y * r23.w;
                  r18.z = r40.x * r23.w + r18.z;
                  r18.z = r18.z / r21.x;
                } else {
                  r21.z = -1;
                }
                ...
                r21.x = samp0[]..swiz;
                  ...
                  if (r10.z != 0) {
                    ...
                    while (true) {
                      ...
                      if (r22.x != 0) break;
                      r38.x = dot(icb[r21.z+0].yx, r17.xw);
                      r38.y = dot(icb[r21.z+0].xy, r13.xy);
                      r37.xy = r38.xy * r22.yy + r36.xy;
                      r22.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r37.xyz, r18.z).x;
                      r21.y = r22.x * 0.125 + r21.y;
                      r21.z = (int)r21.z + 1;
                    }
                  } else {
                    r36.z = (uint)r21.x;
                    r21.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r36.xyz, r18.z).x;
                  }
                  r18.z = r21.y * r21.y;
                  r18.z = r18.z * r21.y;
                } else {
              ...
              if (r18.z != 0) {
                r29.z = r28.w;
                r36.xyz = r13.www * r29.zxy;
                r13.w = r18.w + r0.y;
                r13.w = r18.w / r13.w;
                r19.xyz = r36.xyz * r13.www + r19.xyz;
                r35.xyz = r35.xyz * r14.www + r12.xyz;
                r13.w = dot(r35.xyz, r35.xyz);
                r13.w = rsqrt(r13.w);
                r35.xyz = r35.xyz * r13.www;
                r13.w = saturate(dot(r2.xyz, r35.xyz));
                r14.w = saturate(dot(r35.xyz, r12.xyz));
                r18.z = r13.w * r13.w;
                r21.xz = r18.zz * specularLobeRoughnessControl.xz + float2(1,1);
                r21.xz = r21.xz * r21.xz;
                r21.xz = specularLobeRoughnessControl.yw / r21.xz;
                r21.xz = r21.xz * r13.ww;
                r13.w = 4 * r14.w;
                r21.xz = r21.xz / r13.ww;
                r21.xz = lobeWeightingThicknessRefraction.xy * r21.xz;
                r35.xyz = r36.xyz * r21.xxx;
                r35.xyz = r35.xyz * r18.www + r27.xyz;
                r36.xyz = r36.xyz * r21.zzz;
                r27.xyz = r36.xyz * r18.www + r35.xyz;
              }
            }
          }
          break;
          ...
          r13.w = dot(r35.xyz, r35.xyz);
          r13.w = rsqrt(r13.w);
          r36.xyz = r35.xyz * r13.www;
          r14.w = dot(r2.xyz, r36.xyz);
          r18.z = saturate(r14.w);
          r18.z = useSpecularZFeather ? abs(r14.w) : r18.z;
          r18.w = cmp(0 < r18.z);
          if (r18.w != 0) {
          // Known bad code for instruction (needs manual fix):
          ...
          r37.w = samp0[]..swiz;
            ...
            r21.z = samp0[]..swiz;
              ...
              r22.x = r31.y * r31.y;
              r22.y = dot(r28.xyz, r28.xyz);
              r22.x = r22.x / r22.y;
              r22.x = min(1, r22.x);
              r22.y = saturate(r18.w * r30.y + r30.z);
              r23.w = saturate(r18.w * r30.w + r31.x);
              r27.w = r22.y * r22.y;
              r22.y = r22.y * -2 + 3;
              r22.y = r27.w * r22.y;
              r22.x = r22.x * r22.y;
              ...
              r22.x = r22.x * r22.y;
              r32.zw = r33.xy;
              r28.x = dot(r32.xyzw, r20.xyzw);
              r43.xy = r33.zw;
              r43.zw = r34.zw;
              r28.y = dot(r43.xyzw, r20.xyzw);
              r23.xy = r28.xy / r18.ww;
              r18.w = cmp(r40.w < 0.00048828125);
              if (r18.w != 0) {
                r41.y = r42.x;
                r28.xy = saturate(abs(r23.xy) * r41.zw + r41.xy);
                r30.yz = r28.xy * r28.xy;
                r28.xy = r28.xy * float2(-2,-2) + float2(3,3);
                r28.xy = r30.yz * r28.xy;
                r18.w = r28.x * r28.y;
              } else {
                r40.w = r41.y;
                r40.xyzw = saturate(r40.xyzw * abs(r23.yyxx));
                r40.xyzw = log2(r40.xyzw);
                r40.xyzw = r41.xxxx * r40.xyzw;
                r40.xyzw = exp2(r40.xyzw);
                r28.xy = r40.xy + r40.zw;
                r28.xy = log2(r28.xy);
                r28.xy = r42.xx * r28.xy;
                r28.xy = exp2(r28.xy);
                r22.y = r41.z * r28.x;
                r23.w = r41.w * r28.y + -1;
                r22.y = r41.w * r28.y + -r22.y;
                r22.y = saturate(r23.w / r22.y);
                r23.w = r22.y * r22.y;
                r22.y = r22.y * -2 + 3;
                r18.w = r23.w * r22.y;
              }
              ...
              r28.y = samp0[]..swiz;
              r28.z = samp0[]..swiz;
                r21.z = dot(r42.yzw, r23.xyz);
                r22.x = dot(r28.xyz, r23.xyz);
                r28.x = frac(r21.z);
                r28.y = frac(r22.x);
                r18.w = (int)r18.w + -1;
                r28.z = (uint)r18.w;
                r39.xyz = gCookieArray.SampleLevel(samplerLinear_s, r28.xyz, 0).xyz;
              } else {
                r39.xyz = float3(1,1,1);
              }
            }
            r29.w = r28.w;
            r23.xyw = r39.xyz * r29.wxy;
            r18.w = cmp(0 < r21.x);
            if (r18.w != 0) {
              if (3 == 0) r22.x = 0; else if (3+27 < 32) {               r22.x = (uint)r30.x << (32-(3 + 27)); r22.x = (uint)r22.x >> (32-3);              } else r22.x = (uint)r30.x >> 27;
              if (4 == 0) r22.y = 0; else if (4+20 < 32) {               r22.y = (uint)r30.x << (32-(4 + 20)); r22.y = (uint)r22.y >> (32-4);              } else r22.y = (uint)r30.x >> 20;
              r18.w = cmp((int)r22.x != 1);
              if (r18.w != 0) {
                r18.w = abs(r14.w) * -0.200000003 + 0.400000006;
                r21.z = cmp(r14.w < 0);
                r21.z = r10.w ? r21.z : 0;
                r18.w = r21.z ? -r18.w : r18.w;
                r24.xyz = r2.xyz * r18.www + v7.xyz;
                r36.xy = r34.xy;
                r18.w = dot(r36.xyzw, r24.xyzw);
                r21.z = dot(r38.xyzw, r24.xyzw);
                ...
                r37.y = samp0[]..swiz;
                  r32.zw = r33.xy;
                  r28.x = dot(r32.xyzw, r24.xyzw);
                  r34.xy = r33.zw;
                  r28.y = dot(r34.xyzw, r24.xyzw);
                  r24.xy = r28.xy / r21.zz;
                  r24.xy = saturate(r24.xy * float2(0.5,-0.5) + float2(0.5,0.5));
                  r24.xy = r24.xy * r37.zx + r37.wy;
                  r13.z = r18.w / r21.z;
                  r13.z = max(6.10351563e-05, r13.z);
                  r18.w = (int)r30.x & 0x0000ffff;
                  if (r10.z != 0) {
                    r28.z = (uint)r18.w;
                    r21.z = 0;
                    r22.x = 0;
                    while (true) {
                      r27.w = cmp((int)r22.x >= 8);
                      if (r27.w != 0) break;
                      r29.x = dot(icb[r22.x+0].xy, r14.xy);
                      r29.y = dot(icb[r22.x+0].yx, r14.xz);
                      r28.xy = r29.xy * r31.zz + r24.xy;
                      r27.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r28.xyz, r13.z).x;
                      r21.z = r27.w * 0.125 + r21.z;
                      r22.x = (int)r22.x + 1;
                    }
                  } else {
                    r24.z = (uint)r18.w;
                    r21.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r24.xyz, r13.z).x;
                  }
                  r13.z = r21.z * r21.z;
                  r13.z = r13.z * r21.z;
                } else {
              ...
              r33.z = samp0[]..swiz;
              r33.w = samp0[]..swiz;
                r22.x = abs(r14.w) * -0.200000003 + 0.400000006;
                r14.w = cmp(r14.w < 0);
                r14.w = r10.w ? r14.w : 0;
                r14.w = r14.w ? -r22.x : r22.x;
                r25.xyz = r2.xyz * r14.www + v7.xyz;
                r22.x = dot(r28.xyzw, r25.xyzw);
                r22.y = dot(r29.xyzw, r25.xyzw);
                r14.w = dot(r30.xyzw, r25.xyzw);
                r24.x = dot(r31.xyzw, r25.xyzw);
                r24.y = cmp(r24.x < r14.w);
                r22.xy = r22.xy / r24.xx;
                r22.xy = r22.xy * float2(0.5,-0.5) + float2(0.5,0.5);
                r22.xy = r22.xy + r33.zw;
                r22.xy = r22.xy * r33.xy;
                r25.xy = r21.xx / r32.xz;
                r28.xy = float2(1,1) + -r25.xy;
                r28.xy = cmp(r22.xy >= r28.xy);
                r25.xy = cmp(r25.xy >= r22.xy);
                r25.xy = (int2)r25.xy | (int2)r28.xy;
                ...
                r25.y = samp0[]..swiz;
                  ...
                  r28.xy = r22.xy * r32.xz + r32.yw;
                  r18.w = r25.y * r24.x;
                  r14.w = r25.x * r24.x + r14.w;
                  r14.w = r14.w / r18.w;
                  r14.w = max(6.10351563e-05, r14.w);
                  r18.w = r24.y ? 0.000000 : 0;
                  if (r10.z != 0) {
                    r24.z = (uint)r18.w;
                    r22.xy = float2(0,0);
                    while (true) {
                      r25.x = cmp((int)r22.y >= 8);
                      if (r25.x != 0) break;
                      r25.x = dot(icb[r22.y+0].xy, r26.xy);
                      r25.y = dot(icb[r22.y+0].yx, r26.xz);
                      r24.xy = r25.xy * r21.xx + r28.xy;
                      r24.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r24.xyz, r14.w).x;
                      r22.x = r24.x * 0.125 + r22.x;
                      r22.y = (int)r22.y + 1;
                    }
                  } else {
                    r28.z = (uint)r18.w;
                    r22.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r28.xyz, r14.w).x;
                  }
                  r14.w = r22.x * r22.x;
                  r14.w = r14.w * r22.x;
                } else {
              ...
              r14.w = cmp(0 < r13.z);
              if (r14.w != 0) {
                r23.xyw = r13.zzz * r23.xyw;
                r13.z = r18.z + r0.y;
                r13.z = r18.z / r13.z;
                r19.xyz = r23.xyw * r13.zzz + r19.xyz;
                r24.xyz = r35.xyz * r13.www + r12.xyz;
                r13.z = dot(r24.xyz, r24.xyz);
                r13.z = rsqrt(r13.z);
                r24.xyz = r24.xyz * r13.zzz;
                r13.z = saturate(dot(r2.xyz, r24.xyz));
                r13.w = saturate(dot(r24.xyz, r12.xyz));
                r14.w = r13.z * r13.z;
                r24.xy = r14.ww * specularLobeRoughnessControl.xz + float2(1,1);
                r24.xy = r24.xy * r24.xy;
                r24.xy = specularLobeRoughnessControl.yw / r24.xy;
                r24.xy = r24.xy * r13.zz;
                r13.z = 4 * r13.w;
                r13.zw = r24.xy / r13.zz;
                r13.zw = lobeWeightingThicknessRefraction.xy * r13.zw;
                r24.xyz = r23.xyw * r13.zzz;
                r24.xyz = r24.xyz * r18.zzz + r27.xyz;
                r23.xyw = r23.xyw * r13.www;
                r27.xyz = r23.xyw * r18.zzz + r24.xyz;
              }
            }
          }
          break;
  ...
  r2.w = r10.x * 2 + 1;
  r2.w = log2(r2.w);
  r22.z = 0.0833333358 * r2.w;
  r3.xyzw = rColorRamp.Sample(bilinearClamp_s, r22.zw).xyzw;
  r3.xyz = r3.xyz * r0.xyz;
  r1.w = r3.w * r1.w;
  r1.xyz = r1.xyz * r15.yzw + -r3.xyz;
  r1.xyz = r1.www * r1.xyz + r3.xyz;
  r1.xyz = -r2.xyz * relHDRExposure.xxx + r1.xyz;
  r0.xyz = r10.yyy * r1.xyz + r0.xyz;
  r1.xyz = r8.xyz * r15.yzw + -r0.xyz;
  r0.xyz = r7.xxx * r1.xyz + r0.xyz;
  r1.xyz = r16.yzw * r0.www + r7.yzw;
  r0.w = 1 + -r9.w;
  r1.w = r0.w * r0.w;
  r1.w = r1.w * r1.w;
  r0.w = r1.w * r0.w;
  ...
  r1.xyz = foamColor.xyz * r15.yzw + -r0.xyz;
