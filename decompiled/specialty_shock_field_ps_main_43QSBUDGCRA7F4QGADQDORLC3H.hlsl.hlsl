...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  r2.xyzw = emissiveMap.Sample(colorSampler_s, w1.xy).xyzw;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r4.w, v2.x, l(4), t4.xxxx
r4.w = samp0[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) r6.xyz, r4.w, l(32), t0.xyzx
r6.x = samp0[]..swiz;
r6.y = samp0[]..swiz;
r6.z = samp0[]..swiz;
  ...
  r5.z = saturate(dot(v3.xyz, r6.xyz));
  ...
  r7.zw = (uint2)r7.yx;
  r8.x = dot(r7.wz, float2(0.0671105608,0.00583714992));
  r8.x = frac(r8.x);
  r8.x = 52.9829178 * r8.x;
  r8.x = frac(r8.x);
  r8.x = r8.x * 6.28318548 + gameTick.w;
  ...
  sincos(r7.z, r10.x, r11.x);
  r5.x = saturate(dot(r1.xyz, r6.xyz));
  r7.z = dot(-r6.xyz, r1.xyz);
  r7.z = r7.z + r7.z;
  r12.xyz = r1.xyz * -r7.zzz + -r6.xyz;
  r7.z = 17 * r5.y;
  r7.z = exp2(r7.z);
  r7.z = 2 + r7.z;
  r7.z = 2 / r7.z;
  ...
  r9.w = r5.x * r8.z + r8.w;
  r8.zw = r9.ww * r8.zw;
  r9.w = dot(r1.xyz, sunConstants.wldDir.xyz);
  r10.y = saturate(r9.w);
  r10.z = cmp(0 >= r10.y);
  if (r10.z != 0) {
    r10.w = 0;
  ...
  if (r10.z == 0) {
    ...
    r10.z = -sunConstants.splitDepthOffset + r11.w;
    r10.z = -r10.z * 6.10351563e-05 + 1;
    r13.x = saturate(r10.z);
    r13.x = cmp(r10.z == r13.x);
    if (r13.x != 0) {
      r13.xy = float2(0,0);
      while (true) {
        r13.z = cmp(r13.x >= 3);
    ...
    if (r13.z == 0) {
      if (enableDitheredShadow == 0) {
        ...
        r14.z = r13.x + r11.w;
        r11.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r14.xyz, r10.z).x;
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          r16.z = (uint)r15.y;
          r15.y = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r10.z).x;
  ...
  if (r10.z != 0) {
    r10.z = cmp(0 < r10.w);
    if (r10.z != 0) {
      r10.z = sunConstants.specScale * r7.z;
      r10.z = r10.z * r10.y;
      ...
      r13.x = r13.x + -r10.y;
      r13.x = r7.w * r13.x + r10.y;
      r13.x = r13.x * r10.w;
      r13.xyz = r13.xxx * r11.yzw;
      r9.w = cmp(0 < r9.w);
      r14.xyz = -v6.xyz * r4.www + sunConstants.wldDir.xyz;
      r4.w = dot(r14.xyz, r14.xyz);
      r4.w = rsqrt(r4.w);
      r14.xyz = r14.xyz * r4.www;
      r4.w = dot(r14.xyz, r6.xyz);
      r14.x = dot(r1.xyz, r14.xyz);
      r14.y = abs(r14.x) * r7.z + -abs(r14.x);
      r14.x = abs(r14.x) * r14.y + 1;
      r10.y = r10.y * r8.z + r8.w;
      r14.x = r14.x * r14.x;
      r10.y = r14.x * r10.y;
      r10.y = rcp(r10.y);
      r10.y = r10.y * r10.z;
  ...
  r11.y = 0;
  while (true) {
    r11.z = cmp((uint)r11.y >= numLights);
    if (r11.z != 0) break;
    r17.z = (uint)r11.y >> 5;
    r18.xyz = (int3)r14.xyz + (int3)r17.xyz;
    r11.z = visibleLights.Load(r18.xyzw).x;
    r18.xyz = r10.yzw;
    r31.xyz = r29.xyz;
    r32.xyz = r30.xyz;
    r11.w = r9.w;
            ...
            if (r30.w != 0) {
              ...
              if (r30.w != 0) {
                ...
                if (r30.w != 0) {
                    ...
                    r20.y = samp0[]..swiz;
                      ...
                      if (r11.w != 0) {
                        ...
                        while (true) {
                          ...
                          r44.y = dot(icb[r22.w+0].xy, r8.xy);
                      ...
                      r20.x = samp0[]..swiz;
                        ...
                        if (r11.w != 0) {
                          ...
                          while (true) {
                            ...
                            if (r22.w != 0) break;
                            r44.x = dot(icb[r21.z+0].xy, r9.xy);
                            r44.y = dot(icb[r21.z+0].yx, r9.xz);
                  ...
                  r40.xyz = r40.xyz * r17.www + r6.xyz;
                  r17.w = dot(r40.xyz, r40.xyz);
                  r17.w = rsqrt(r17.w);
                  r40.xyz = r40.xyz * r17.www;
                  r17.w = dot(r40.xyz, r6.xyz);
                  r21.x = dot(r1.xyz, r40.xyz);
                  r21.z = abs(r21.x) * r7.z + -abs(r21.x);
                  r21.x = abs(r21.x) * r21.z + 1;
                  r21.z = r20.x * r8.z + r8.w;
                  r21.x = r21.x * r21.x;
                  r21.x = r21.x * r21.z;
                  r21.x = rcp(r21.x);
                  r20.x = r20.x * r30.w;
            ...
            r42.w = samp0[]..swiz;
              ...
              if (r21.x != 0) {
                ...
                if (r21.x != 0) {
                  ...
                  r33.xyz = r40.xyz * r17.www + r6.xyz;
                  r17.w = dot(r33.xyz, r33.xyz);
                  r17.w = rsqrt(r17.w);
                  r33.xyz = r33.xyz * r17.www;
                  r17.w = dot(r33.xyz, r6.xyz);
                  r21.z = dot(r1.xyz, r33.xyz);
                  r23.x = abs(r21.z) * r7.z + -abs(r21.z);
                  r21.z = abs(r21.z) * r23.x + 1;
                  r20.y = r20.y * r8.z + r8.w;
                  r21.z = r21.z * r21.z;
                  r20.y = r21.z * r20.y;
                  r20.y = rcp(r20.y);
                  r20.y = r20.y * r21.x;
  ...
  r40.z = samp0[]..swiz;
  r40.w = samp0[]..swiz;
    r10.x = dot(r35.xyz, r34.xyz);
    r10.x = saturate(r10.x + r35.w);
    r11.w = dot(r36.xyz, r34.xyz);
    r11.w = saturate(r11.w + r36.w);
    r10.x = r11.w * r10.x;
    r11.w = dot(r37.xyz, r34.xyz);
    r11.w = saturate(r11.w + r37.w);
    r10.x = r11.w * r10.x;
    r11.w = dot(r38.xyz, r34.xyz);
    r11.w = saturate(r11.w + r38.w);
    r10.x = r11.w * r10.x;
    r11.w = dot(r39.xyz, r34.xyz);
    r11.w = saturate(r11.w + r39.w);
    r10.x = r11.w * r10.x;
    r11.w = dot(r40.xyz, r34.xyz);
    r11.w = saturate(r11.w + r40.w);
    r9.x = r11.w * r10.x;
    r10.x = (int)r8.x & 1;
    r16.zw = r10.xx ? r9.xy : r9.zx;
    r35.xy = r25.zw;
    r35.z = r26.z;
    r9.x = dot(r12.xyz, r35.xyz);
    r10.x = dot(r34.xyz, r35.xyz);
    r10.x = r10.x + -r26.w;
    r11.w = cmp(r10.x >= 0);
    r10.x = max(abs(r10.x), r6.y);
    r10.x = r11.w ? r10.x : -r10.x;
    r9.x = max(1.00000001e-07, -r9.x);
    r9.x = r10.x / r9.x;
    r9.x = min(131072, abs(r9.x));
    r26.z = r27.z;
    r10.x = dot(r12.xyz, r26.xyz);
    r11.w = dot(r34.xyz, r26.xyz);
    r11.w = r11.w + -r27.w;
    r13.w = cmp(r11.w >= 0);
    r11.w = max(abs(r11.w), r6.y);
    r11.w = r13.w ? r11.w : -r11.w;
    r10.x = max(1.00000001e-07, -r10.x);
    r10.x = r11.w / r10.x;
    r9.x = min(abs(r10.x), r9.x);
    r27.z = r28.z;
    r10.x = dot(r12.xyz, r27.xyz);
    ...
    r9.x = min(abs(r10.x), r9.x);
    r28.z = r31.z;
    r10.x = dot(r12.xyz, r28.xyz);
    r11.w = dot(r34.xyz, r28.xyz);
    r11.w = r11.w + -r31.w;
    r13.w = cmp(r11.w >= 0);
    r11.w = max(abs(r11.w), r6.y);
    r11.w = r13.w ? r11.w : -r11.w;
    ...
    r9.x = min(abs(r10.x), r9.x);
    r31.z = r32.x;
    r10.x = dot(r12.xyz, r31.xyz);
    r11.w = dot(r34.xyz, r31.xyz);
    r11.w = r11.w + -r32.y;
    r13.w = cmp(r11.w >= 0);
    r11.w = max(abs(r11.w), r6.y);
    r11.w = r13.w ? r11.w : -r11.w;
    ...
    r9.x = min(abs(r10.x), r9.x);
    r33.zw = r32.zw;
    r10.x = dot(r12.zxy, r33.xzw);
    r11.w = dot(r34.zxy, r33.xzw);
    r11.w = r11.w + -r33.y;
    r13.w = cmp(r11.w >= 0);
    r11.w = max(abs(r11.w), r6.y);
    r11.w = r13.w ? r11.w : -r11.w;
    ...
    while (true) {
      if (r10.x == 0) break;
      r11.z = firstbitlow((uint)r10.x);
      r11.z = 1 << (int)r11.z;
      r11.w = (int)r10.x & (int)r11.z;
      if (r11.w != 0) {
        r11.z = ~(int)r11.z;
        r10.x = (int)r10.x & (int)r11.z;
        if (r8.z != 0) {
          r11.z = r8.x;
          r27.xy = r16.zw;
          r11.w = 1;
          while (true) {
            r13.z = cmp((int)r11.w >= (int)r20.x);
            if (r13.z != 0) break;
          ...
          r36.w = samp0[]..swiz;
            ...
            r27.x = r13.z * r13.w;
            r14.w = (uint)r11.z >> 2;
            if (1 == 0) r15.z = 0; else if (1+2 < 32) {             r15.z = (uint)r11.z << (32-(1 + 2)); r15.z = (uint)r15.z >> (32-1);            } else r15.z = (uint)r11.z >> 2;
            r15.w = (int)r14.w & 2;
          ...
          if (r11.w != 0) {
            ...
            r11.z = r11.z * r25.x;
            r27.xzw = r23.xyz * r11.zzz;
            r31.xyz = r27.zzz * r19.xyw;
            r31.xyz = r21.xyz * r27.xxx + r31.xyz;
            r27.xzw = r22.xyz * r27.www + r31.xyz;
            r31.xyz = r27.xzw * r24.xyz;
            r11.w = dot(r31.xyz, float3(0.212599993,0.715200007,0.0722000003));
            r31.xyz = r27.xzw * r24.xyz + r26.xyz;
            r13.z = r11.w * r6.z;
            r27.xzw = r20.yzw * r11.zzz;
            r11.z = dot(r27.xzw, float3(0.212599993,0.715200007,0.0722000003));
            r11.z = r6.z * r11.w + r11.z;
            r11.z = r13.z / r11.z;
            r32.x = r26.w;
            r32.yz = r25.yz;
            r28.xyw = r27.zwx * r11.zzz + r32.yzx;
            r31.w = r28.w;
          } else {
            r31.xyzw = r26.xyzw;
            r28.xyz = r25.yzw;
  ...
  if (r6.w == 0) {
    ...
    r8.w = r7.x;
    while (true) {
      r10.x = cmp((uint)r8.w >= numRefProbes);
      if (r10.x != 0) break;
      r8.z = (uint)r8.w >> 5;
      ...
      while (true) {
        ...
        r10.x = 1 << (int)r9.z;
        r11.w = (int)r9.y & (int)r10.x;
        if (r11.w != 0) {
          r9.y = (int)r9.y ^ (int)r10.x;
          r10.x = (int)r9.z + (int)r9.x;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=80)(mixed,mixed,mixed,mixed) r24.xyzw, r10.x, l(0), t11.xyzw
        r24.x = samp0[]..swiz;
        r24.y = samp0[]..swiz;
        r24.z = samp0[]..swiz;
        r24.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=80)(mixed,mixed,mixed,mixed) r25.xy, r10.x, l(16), t11.xyxx
        r25.x = samp0[]..swiz;
        r25.y = samp0[]..swiz;
          ...
          r25.w = samp0[]..swiz;
            ...
            r10.x = (int)r25.w & 0x0000ffff;
            if (6 == 0) r11.w = 0; else if (6+25 < 32) {             r11.w = (uint)r25.w << (32-(6 + 25)); r11.w = (uint)r11.w >> (32-6);            } else r11.w = (uint)r25.w >> 25;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r27.xyzw, r10.x, l(0), t16.xyzw
          r27.x = samp0[]..swiz;
          r27.y = samp0[]..swiz;
          r27.z = samp0[]..swiz;
          r27.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r28.xyzw, r10.x, l(16), t16.xyzw
          r28.x = samp0[]..swiz;
          r28.y = samp0[]..swiz;
          r28.z = samp0[]..swiz;
          r28.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r31.xyzw, r10.x, l(32), t16.xyzw
          r31.x = samp0[]..swiz;
          r31.y = samp0[]..swiz;
          r31.z = samp0[]..swiz;
          r31.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r32.xyzw, r10.x, l(48), t16.xyzw
          r32.x = samp0[]..swiz;
          r32.y = samp0[]..swiz;
          r32.z = samp0[]..swiz;
          r32.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r33.xyzw, r10.x, l(64), t16.xyzw
          r33.x = samp0[]..swiz;
          r33.y = samp0[]..swiz;
          r33.z = samp0[]..swiz;
          r33.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r34.xyzw, r10.x, l(80), t16.xyzw
          r34.x = samp0[]..swiz;
          r34.y = samp0[]..swiz;
          r34.z = samp0[]..swiz;
          r34.w = samp0[]..swiz;
            ...
            r40.y = samp0[]..swiz;
              ...
              r11.x = r11.w / r11.x;
              r10.x = min(abs(r11.x), r10.x);
              r36.z = r37.z;
              r11.x = dot(r12.xyz, r36.xyz);
              r11.w = dot(r26.xyz, r36.xyz);
              r11.w = r11.w + -r37.w;
              r13.w = cmp(r11.w >= 0);
              r11.w = max(abs(r11.w), r6.y);
              r11.w = r13.w ? r11.w : -r11.w;
          ...
          r26.y = samp0[]..swiz;
            ...
            r35.w = samp0[]..swiz;
              ...
              r37.w = samp0[]..swiz;
                ...
                r31.x = r23.w * r19.w;
                r25.w = (uint)r11.x >> 2;
                if (1 == 0) r27.w = 0; else if (1+2 < 32) {                 r27.w = (uint)r11.x << (32-(1 + 2)); r27.w = (uint)r27.w >> (32-1);                } else r27.w = (uint)r11.x >> 2;
                r28.z = (int)r25.w & 2;
              ...
              r41.y = samp0[]..swiz;
                ...
                r13.w = r13.z * r6.z;
                r15.yzw = r15.yzw * r11.xxx;
                r11.x = dot(r15.yzw, float3(0.212599993,0.715200007,0.0722000003));
                r11.x = r6.z * r13.z + r11.x;
                r11.x = r13.w / r11.x;
                r24.xyz = r15.yzw * r11.xxx + r24.xyz;
              }
            }
          }
        }
  ...
  r1.z = cmp(r0.w < 1);
  if (r1.z != 0) {
    r1.z = edgeColorMap.Sample(colorSampler_s, w1.xy).w;
    r4.xyzw = edgeEmissiveMap.Sample(colorSampler_s, w1.xy).xyzw;
  ...
  r0.w = r0.w * r2.w;
  r1.z = alphaMask.Sample(colorSampler_s, v7.xy).x;
