...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  while (true) {
    ...
    while (true) {
      ...
      r16.y = samp0[]..swiz;
        ...
        r16.z = r25.w;
        r16.xyz = cmp(abs(r25.xyz) < r16.zxy);
        r15.w = r16.y ? r16.x : 0;
        r15.w = r16.z ? r15.w : 0;
        if (r15.w != 0) {
        ...
        r26.w = samp0[]..swiz;
          ...
          if (6 == 0) r16.z = 0; else if (6+25 < 32) {           r16.z = (uint)r26.w << (32-(6 + 25)); r16.z = (uint)r16.z >> (32-6);          } else r16.z = (uint)r26.w >> 25;
        // Known bad code for instruction (needs manual fix):
        ...
        r33.w = samp0[]..swiz;
          ...
          r34.w = samp0[]..swiz;
            ...
            r28.x = r25.w * r20.w;
            r27.w = (uint)r18.w >> 2;
            if (1 == 0) r28.z = 0; else if (1+2 < 32) {             r28.z = (uint)r18.w << (32-(1 + 2)); r28.z = (uint)r28.z >> (32-1);            } else r28.z = (uint)r18.w >> 2;
            r28.w = (int)r27.w & 2;
            r29.x = max(r28.y, r28.x);
            r20.w = -r20.w * r25.w + 1;
            r20.w = r28.y * r20.w;
            r5.y = r28.w ? r20.w : r29.x;
            r28.xy = r28.zz ? r28.xy : r5.xy;
            r19.w = (int)r19.w + 1;
            r18.w = r27.w;
          }
          ...
          r39.x = samp0[]..swiz;
          r39.y = samp0[]..swiz;
            r24.z = r28.y * r16.y + r24.z;
            r5.y = r5.y * r26.z;
            r26.z = r34.z;
            r15.z = dot(r14.xyz, r26.xyz);
            ...
            r34.z = r35.z;
            r15.w = dot(r14.xyz, r34.xyz);
            r16.x = dot(r27.xyz, r34.xyz);
            r16.x = r16.x + -r35.w;
            r16.y = cmp(r16.x >= 0);
            r16.x = max(abs(r16.x), r8.w);
            ...
            r25.y = r29.z;
            r25.z = r30.x;
            r34.x = dot(r16.xyz, r25.xyz);
            r26.xy = r29.xw;
            r26.z = r30.w;
            r34.y = dot(r16.xyz, r26.xyz);
            r30.x = r29.y;
            r34.z = dot(r16.xyz, r30.xyz);
            if (9 == 0) r15.w = 0; else if (9+16 < 32) {             r15.w = (uint)r26.w << (32-(9 + 16)); r15.w = (uint)r15.w >> (32-9);            } else r15.w = (uint)r26.w >> 16;
            r34.w = (uint)r15.w;
            r16.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r34.xyzw, r15.z).xyz;
  ...
  if (r5.x != 0) {
    ...
    r13.z = 0;
    while (true) {
      r13.w = cmp((uint)r13.z >= (uint)r10.z);
      if (r13.w != 0) break;
      r15.z = (uint)r13.z >> 5;
      r16.xyz = (int3)r4.xyz + (int3)r15.xyz;
      r13.w = visibleProbes.Load(r16.xyzw).x;
      r15.z = cmp((int)r10.w == (int)r13.z);
      if (r11.w == 0) r15.w = 0; else if (r11.w+0 < 32) {       r15.w = (uint)r13.w << (32-(r11.w + 0)); r15.w = (uint)r15.w >> (32-r11.w);      } else r15.w = (uint)r13.w >> 0;
      ...
      while (true) {
        ...
        r26.y = samp0[]..swiz;
          ...
          r27.w = samp0[]..swiz;
            ...
            if (6 == 0) r20.w = 0; else if (6+25 < 32) {             r20.w = (uint)r27.w << (32-(6 + 25)); r20.w = (uint)r20.w >> (32-6);            } else r20.w = (uint)r27.w >> 25;
          // Known bad code for instruction (needs manual fix):
          ...
          r34.w = samp0[]..swiz;
            ...
            r17.x = r26.z * r25.w;
            r25.w = (int)r26.x & 1;
            r26.zw = r25.ww ? r17.xy : r17.zx;
            r17.x = r26.x;
            r29.xy = r26.zw;
            r25.w = 1;
            while (true) {
              r28.w = cmp((int)r25.w >= (int)r20.w);
              if (r28.w != 0) break;
            ...
            r35.w = samp0[]..swiz;
              ...
              r28.w = -r28.w * r29.z + 1;
              r28.w = r29.y * r28.w;
              r5.y = r30.y ? r28.w : r30.z;
              r29.xy = r30.xx ? r29.xy : r5.xy;
              r25.w = (int)r25.w + 1;
              r17.x = r29.w;
            }
            r5.y = saturate(r29.y + -r15.w);
            r17.x = r5.y * r26.y;
            r19.w = cmp(0 < r17.x);
            if (r19.w != 0) {
            // Known bad code for instruction (needs manual fix):
            ...
            r40.x = samp0[]..swiz;
            r40.y = samp0[]..swiz;
              r24.w = r5.y * r26.y + r24.w;
              r5.y = r17.x * r27.z;
              r27.z = r35.z;
              r17.x = dot(r14.xyz, r27.xyz);
              ...
              r18.w = r19.w / r18.w;
              r17.x = min(abs(r18.w), r17.x);
              r36.z = r37.z;
              r18.w = dot(r14.xyz, r36.xyz);
              ...
              r26.xyz = r14.xyz * r17.xxx + r26.xyz;
              ...
              r35.w = (uint)r18.w;
              r26.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r35.xyzw, r17.x).xyz;
              ...
              r29.xzw = r29.xzw * r5.yyy;
              r19.z = r25.y ? 0 : 0.5;
              r25.xyw = r28.xyz + r19.xyz;
              r25.xyw = gProbeYArray.SampleLevel(samplerLinearClamp_s, r25.xyw, 0).xyz;
              ...
              r16.xyz = r25.xyz * r27.xyz + r16.xyz;
              r18.z = r17.x * r9.w;
              r25.xyz = r26.xyz * r5.yyy;
              r5.y = dot(r25.xyz, float3(0.212599993,0.715200007,0.0722000003));
              r5.y = r9.w * r17.x + r5.y;
              r5.y = r18.z / r5.y;
              r24.xyz = r25.xyz * r5.yyy + r24.xyz;
            }
          }
        }
      }
  ...
  if (r5.x != 0) {
    ...
    r14.w = 0;
    r14.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r14.xyzw, r6.w).xyz;
  ...
  if (useSSR != 0) {
    ...
    r14.xyz = v8.xxx ? r14.xyz : r15.xyz;
    if (useLoopedSSR != 0) {
  ...
  if (r5.x == 0) {
    ...
    if (r6.w != 0) {
      ...
      while (true) {
        ...
        if (r9.w != 0) break;
        r9.w = (uint)r6.w;
        r10.zw = -sunConstants.splitPinTransform[r9.w].xy + r14.xy;
    ...
    r10.w = samp0[]..swiz;
      ...
      r18.w = samp0[]..swiz;
        ...
        r11.w = samp0[]..swiz;
          ...
          r11.w = r14.x * r15.x + r11.w;
          r10.w = r14.y * r10.w + r11.w;
          r14.w = r10.z ? r10.w : r14.w;
        }
      }
      r10.z = -sunConstants.sstLightingConstants.constants.inchesPerTexel * 2 + r14.z;
      r10.z = cmp(r14.w < r10.z);
      r5.y = r10.z ? 0 : 1;
    }
    if (r9.w == 0) {
      if (enableDitheredShadow == 0) {
        ...
        r15.z = r9.w + r6.w;
        r9.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r15.xyz, r5.x).x;
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          if (r14.w != 0) break;
          r14.w = cmp((uint)r8.w < (uint)r14.z);
          r16.xy = r14.ww ? r14.xy : r10.zw;
          r15.w = r14.w ? sunConstants.splitPinTransform[r6.w].w : sunConstants.splitPinTransform[r9.w].w;
          r14.w = r14.w ? r6.w : r9.w;
          r17.x = dot(icb[r14.z+0].yx, r15.xy);
          r17.y = dot(icb[r14.z+0].yx, r15.yz);
          r16.xy = r17.xy * r15.ww + r16.xy;
          r14.w = (int)r14.w + (int16)sunConstants.splitArrayOffset;
          r16.z = (uint)r14.w;
          r14.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r5.x).x;
  ...
  r19.w = samp0[]..swiz;
    ...
    r14.y = samp0[]..swiz;
      ...
      r15.xy = r10.zw * r18.xz + r18.yw;
      r5.x = r14.y * r8.w;
      r0.z = r14.x * r8.w + r0.z;
      r0.z = r0.z / r5.x;
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          if (r10.z != 0) break;
          r17.x = dot(icb[r9.w+0].yx, r14.xy);
          r17.y = dot(icb[r9.w+0].yx, r14.yz);
          r16.xy = r17.xy * r6.ww + r15.xy;
        ...
        r15.z = (uint)r5.x;
        r8.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r15.xyz, r0.z).x;
      }
      r0.z = r8.w * r8.w;
      r0.z = r0.z * r8.w;
    } else {
  ...
  if (r5.x != 0) {
    ...
    r15.xyz = -v7.xyz * r6.zzz + sunConstants.wldDir.xyz;
  ...
  while (true) {
    ...
    while (true) {
      if (r5.y == 0) break;
      r6.z = firstbitlow((uint)r5.y);
      r6.w = 1 << (int)r6.z;
      r8.w = (int)r5.y & (int)r6.w;
      if (r8.w != 0) {
        r5.y = (int)r5.y ^ (int)r6.w;
        r6.z = (int)r1.w + (int)r6.z;
      // Known bad code for instruction (needs manual fix):
      ...
      r31.z = samp0[]..swiz;
      r31.w = samp0[]..swiz;
        if (3 == 0) r6.w = 0; else if (3+24 < 32) {         r6.w = (uint)r27.x << (32-(3 + 24)); r6.w = (uint)r6.w >> (32-3);        } else r6.w = (uint)r27.x >> 24;
        switch (r6.w) {
          case 4 :          r6.w = cmp(0 < r31.x);
          r32.x = r30.w;
          r32.yz = r31.zw;
          r33.xyz = -r32.xyz * float3(0.5,0.5,0.5) + r25.xyz;
          r34.xyz = -v7.xyz + r33.xyz;
          r8.w = dot(r32.xyz, r34.xyz);
          r8.w = saturate(-r8.w / r31.x);
          r32.xyz = r8.www * r32.xyz + r33.xyz;
          r32.xyz = r6.www ? r32.xyz : r25.xyz;
          r32.xyz = -v7.xyz + r32.xyz;
          r6.w = dot(r32.xyz, r32.xyz);
          r8.w = rsqrt(r6.w);
          r33.xyz = r32.xyz * r8.www;
          r9.w = dot(r1.xyz, r33.xyz);
          r10.z = saturate(r9.w);
          ...
          if (r10.w != 0) {
            ...
            r6.w = r11.w / r6.w;
            r6.w = min(1, r6.w);
            r11.w = saturate(r10.w * r27.y + r27.z);
            r10.w = saturate(r10.w * r27.w + r28.x);
            r15.z = r11.w * r11.w;
            r11.w = r11.w * -2 + 3;
            r11.w = r15.z * r11.w;
            r6.w = r11.w * r6.w;
            ...
            if (r10.w != 0) {
              ...
              if (r10.w != 0) {
                ...
                while (true) {
                  ...
                  if (r22.w != 0) break;
                  r35.y = dot(icb[r19.w+0].yx, r14.xy);
                  r35.z = dot(icb[r19.w+0].yx, r14.yz);
                  r35.yz = r35.yz * r28.zz;
                  r35.x = r35.y * r13.x;
                  r35.w = r35.y * r12.x;
                  r34.xyz = r33.xyz * r11.www + r35.xzw;
                  r22.w = gOmniShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r34.xyzw, r10.w).x;
              ...
              r34.z = samp0[]..swiz;
              r34.w = samp0[]..swiz;
                r15.w = abs(r9.w) * -0.200000003 + 0.400000006;
                r9.w = cmp(r9.w < 0);
                r9.w = r6.y ? r9.w : 0;
                r9.w = r9.w ? -r15.w : r15.w;
                r18.xyz = r1.xyz * r9.www + v7.xyz;
                r9.w = dot(r33.xyzw, r18.xyzw);
                r15.w = dot(r34.xyzw, r18.xyzw);
                r19.w = cmp(r15.w < r9.w);
                if (r19.w == 0) {
                // Known bad code for instruction (needs manual fix):
                ...
                r37.y = samp0[]..swiz;
                  ...
                  r18.x = r37.y * r15.w;
                  r9.w = r37.x * r15.w + r9.w;
                  r9.w = r9.w / r18.x;
                } else {
                  r18.z = -1;
                }
                r15.w = (int)r19.w | (int)r18.z;
                if (r15.w == 0) {
                // Known bad code for instruction (needs manual fix):
                ...
                r10.w = samp0[]..swiz;
                  ...
                  if (r5.x != 0) {
                    ...
                    while (true) {
                      r22.w = cmp((int)r19.w >= 8);
                      if (r22.w != 0) break;
                      r34.x = dot(icb[r19.w+0].yx, r14.xw);
                      r34.y = dot(icb[r19.w+0].xy, r10.xy);
                      r18.xy = r34.xy * r11.ww + r33.xy;
                      r18.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r18.xyz, r9.w).x;
                      r15.w = r18.x * 0.125 + r15.w;
                      r19.w = (int)r19.w + 1;
                    }
                  } else {
                    r33.z = (uint)r10.w;
                    r15.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r33.xyz, r9.w).x;
                  }
                  r9.w = r15.w * r15.w;
                  r9.w = r9.w * r15.w;
                } else {
              ...
              if (r9.w != 0) {
                r26.z = r25.w;
                r18.xyz = r6.www * r26.zxy;
                r6.w = r10.z + r0.y;
                r6.w = r10.z / r6.w;
                r16.xyz = r18.xyz * r6.www + r16.xyz;
                r32.xyz = r32.xyz * r8.www + r9.xyz;
                r6.w = dot(r32.xyz, r32.xyz);
                r6.w = rsqrt(r6.w);
                r32.xyz = r32.xyz * r6.www;
                r6.w = saturate(dot(r1.xyz, r32.xyz));
                r8.w = saturate(dot(r32.xyz, r9.xyz));
                r9.w = r6.w * r6.w;
                r32.xy = r9.ww * specularLobeRoughnessControl.xz + float2(1,1);
                ...
                r32.xzw = r32.xzw * r10.zzz + r24.xyz;
                r18.xyz = r32.yyy * r18.xyz;
                r24.xyz = r18.xyz * r10.zzz + r32.xzw;
              }
            }
          }
          break;
          ...
          r6.w = rsqrt(r6.w);
          r32.xyz = r18.xyz * r6.www;
          r8.w = dot(r1.xyz, r32.xyz);
          r9.w = saturate(r8.w);
          r9.w = useSpecularZFeather ? abs(r8.w) : r9.w;
          r10.z = cmp(0 < r9.w);
          if (r10.z != 0) {
          // Known bad code for instruction (needs manual fix):
          ...
          r33.w = samp0[]..swiz;
            ...
            r11.w = samp0[]..swiz;
              ...
              r19.w = r19.w / r22.w;
              r19.w = min(1, r19.w);
              r22.w = saturate(r10.z * r27.y + r27.z);
              r23.w = saturate(r10.z * r27.w + r28.x);
              r24.w = r22.w * r22.w;
              r22.w = r22.w * -2 + 3;
              r22.w = r24.w * r22.w;
              r19.w = r22.w * r19.w;
              ...
              r19.xy = r25.xy / r10.zz;
              r10.z = cmp(r36.w < 0.00048828125);
              if (r10.z != 0) {
                r37.y = r38.x;
                ...
                r22.w = r37.z * r25.x;
                r23.w = r37.w * r25.y + -1;
                r22.w = r37.w * r25.y + -r22.w;
                r22.w = saturate(r23.w / r22.w);
                r23.w = r22.w * r22.w;
                r22.w = r22.w * -2 + 3;
                r10.z = r23.w * r22.w;
              }
            ...
            r26.w = r25.w;
            r19.xyw = r35.xyz * r26.wxy;
            r10.z = cmp(0 < r10.w);
            if (r10.z != 0) {
              if (3 == 0) r25.x = 0; else if (3+27 < 32) {               r25.x = (uint)r27.x << (32-(3 + 27)); r25.x = (uint)r25.x >> (32-3);              } else r25.x = (uint)r27.x >> 27;
              if (4 == 0) r25.y = 0; else if (4+20 < 32) {               r25.y = (uint)r27.x << (32-(4 + 20)); r25.y = (uint)r25.y >> (32-4);              } else r25.y = (uint)r27.x >> 20;
              r10.z = cmp((int)r25.x != 1);
              if (r10.z != 0) {
                r10.z = abs(r8.w) * -0.200000003 + 0.400000006;
                r11.w = cmp(r8.w < 0);
                r11.w = r6.y ? r11.w : 0;
                r10.z = r11.w ? -r10.z : r10.z;
                r20.xyz = r1.xyz * r10.zzz + v7.xyz;
                r32.xy = r31.xy;
                r10.z = dot(r32.xyzw, r20.xyzw);
                r11.w = dot(r34.xyzw, r20.xyzw);
                r22.w = cmp(r11.w >= r10.z);
                if (r22.w != 0) {
                // Known bad code for instruction (needs manual fix):
                ...
                r33.y = samp0[]..swiz;
                  ...
                  if (r5.x != 0) {
                    ...
                    while (true) {
                      ...
                      if (r23.w != 0) break;
                      r27.x = dot(icb[r22.w+0].xy, r11.xy);
                      r27.y = dot(icb[r22.w+0].yx, r11.xz);
                      r26.xy = r27.xy * r28.zz + r20.xy;
                      r23.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r26.xyz, r6.z).x;
                      r11.w = r23.w * 0.125 + r11.w;
                      r22.w = (int)r22.w + 1;
                    }
                  } else {
                    r20.z = (uint)r10.z;
                    r11.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r20.xyz, r6.z).x;
                  }
                  r6.z = r11.w * r11.w;
                  r6.z = r6.z * r11.w;
                } else {
              ...
              r30.z = samp0[]..swiz;
              r30.w = samp0[]..swiz;
                r20.x = abs(r8.w) * -0.200000003 + 0.400000006;
                r8.w = cmp(r8.w < 0);
                r8.w = r6.y ? r8.w : 0;
                r8.w = r8.w ? -r20.x : r20.x;
                r21.xyz = r1.xyz * r8.www + v7.xyz;
                r20.x = dot(r25.xyzw, r21.xyzw);
                r20.y = dot(r26.xyzw, r21.xyzw);
                r8.w = dot(r27.xyzw, r21.xyzw);
                r20.z = dot(r28.xyzw, r21.xyzw);
                r21.x = cmp(r20.z < r8.w);
                r20.xy = r20.xy / r20.zz;
                r20.xy = r20.xy * float2(0.5,-0.5) + float2(0.5,0.5);
                r20.xy = r20.xy + r30.zw;
                r20.xy = r20.xy * r30.xy;
                r21.yz = r10.ww / r29.xz;
                r25.xy = float2(1,1) + -r21.yz;
                r25.xy = cmp(r20.xy >= r25.xy);
                r21.yz = cmp(r21.yz >= r20.xy);
                r21.yz = (int2)r21.yz | (int2)r25.xy;
                ...
                r21.z = samp0[]..swiz;
                  ...
                  r25.xy = r20.xy * r29.xz + r29.yw;
                  r10.z = r21.z * r20.z;
                  r8.w = r21.y * r20.z + r8.w;
                  r8.w = r8.w / r10.z;
                  r8.w = max(6.10351563e-05, r8.w);
                  r10.z = r21.x ? 0.000000 : 0;
                  if (r5.x != 0) {
                    r20.z = (uint)r10.z;
                    r21.xy = float2(0,0);
                    while (true) {
                      ...
                      if (r21.z != 0) break;
                      r26.x = dot(icb[r21.y+0].xy, r22.xy);
                      r26.y = dot(icb[r21.y+0].yx, r22.xz);
                      r20.xy = r26.xy * r10.ww + r25.xy;
                    ...
                    r25.z = (uint)r10.z;
                    r21.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r25.xyz, r8.w).x;
                  }
                  r8.w = r21.x * r21.x;
                  r8.w = r8.w * r21.x;
                } else {
              ...
              r8.w = cmp(0 < r6.z);
              if (r8.w != 0) {
                r19.xyw = r6.zzz * r19.xyw;
                r6.z = r9.w + r0.y;
                r6.z = r9.w / r6.z;
                r16.xyz = r19.xyw * r6.zzz + r16.xyz;
                r18.xyz = r18.xyz * r6.www + r9.xyz;
                r6.z = dot(r18.xyz, r18.xyz);
                r6.z = rsqrt(r6.z);
                r18.xyz = r18.xyz * r6.zzz;
                r6.z = saturate(dot(r1.xyz, r18.xyz));
                r6.w = saturate(dot(r18.xyz, r9.xyz));
                r8.w = r6.z * r6.z;
                r10.zw = r8.ww * specularLobeRoughnessControl.xz + float2(1,1);
                r10.zw = r10.zw * r10.zw;
                r10.zw = specularLobeRoughnessControl.yw / r10.zw;
                r10.zw = r10.zw * r6.zz;
                r6.z = 4 * r6.w;
                r6.zw = r10.zw / r6.zz;
                r6.zw = lobeWeightingThicknessRefraction.xy * r6.zw;
                r18.xyz = r19.xyw * r6.zzz;
                r18.xyz = r18.xyz * r9.www + r24.xyz;
                r19.xyw = r19.xyw * r6.www;
                r24.xyz = r19.xyw * r9.www + r18.xyz;
              }
            }
          }
          break;
