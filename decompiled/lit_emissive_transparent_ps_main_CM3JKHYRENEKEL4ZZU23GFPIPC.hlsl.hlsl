...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  r4.x = dot(r2.yzw, r5.xyz);
  r4.y = dot(r2.yzw, r6.xyz);
  r4.z = cmp(0 < r3.w);
  r4.xy = -r4.xy / r3.ww;
  r4.xy = r4.zz ? r4.xy : 0;
  ...
  r3.yz = (uint2)r3.yz;
  r3.w = dot(r3.zy, float2(0.0671105608,0.00583714992));
  r3.w = frac(r3.w);
  r3.w = 52.9829178 * r3.w;
  r3.w = frac(r3.w);
  r3.w = r3.w * 6.28318548 + gameTick.w;
  sincos(r3.w, r5.x, r6.x);
  r3.y = dot(r3.yz, float2(0.0671105608,0.00583714992));
  r3.y = frac(r3.y);
  r3.y = 52.9829178 * r3.y;
  r3.y = frac(r3.y);
  r3.y = r3.y * 6.28318548 + gameTick.w;
  sincos(r3.y, r11.x, r12.x);
  r7.x = saturate(dot(r8.xyz, r2.yzw));
  r3.y = dot(-r2.yzw, r8.xyz);
  r3.y = r3.y + r3.y;
  r13.xyz = r8.xyz * -r3.yyy + -r2.yzw;
  r3.y = 17 * r7.y;
  r3.y = exp2(r3.y);
  r3.y = 2 + r3.y;
  r3.y = 2 / r3.y;
  ...
  r7.zw = float2(0,0);
  while (true) {
    r10.w = cmp((uint)r7.w >= numRefProbes);
    if (r10.w != 0) break;
    r14.z = (uint)r7.w >> 5;
  ...
  r41.z = samp0[]..swiz;
  r41.w = samp0[]..swiz;
    r14.w = dot(r36.xyz, r12.yzw);
    r14.w = saturate(r14.w + r36.w);
    r15.x = dot(r37.xyz, r12.yzw);
    r15.x = saturate(r15.x + r37.w);
    r14.w = r15.x * r14.w;
    r15.x = dot(r38.xyz, r12.yzw);
    r15.x = saturate(r15.x + r38.w);
    r14.w = r15.x * r14.w;
    r15.x = dot(r39.xyz, r12.yzw);
    r15.x = saturate(r15.x + r39.w);
    r14.w = r15.x * r14.w;
    r15.x = dot(r40.xyz, r12.yzw);
    r15.x = saturate(r15.x + r40.w);
    r14.w = r15.x * r14.w;
    r15.x = dot(r41.xyz, r12.yzw);
    r15.x = saturate(r15.x + r41.w);
    r16.x = r15.x * r14.w;
    r14.w = (int)r11.y & 1;
    ...
    r30.z = r31.z;
    r15.z = dot(r13.xyz, r30.xyz);
    r16.x = dot(r12.yzw, r30.xyz);
    r16.x = r16.x + -r31.w;
    r16.w = cmp(r16.x >= 0);
    ...
    r14.w = min(abs(r15.z), r14.w);
    r35.zw = r34.zw;
    r15.z = dot(r13.zxy, r35.xzw);
    r16.x = dot(r12.wyz, r35.xzw);
    r16.x = r16.x + -r35.y;
    r16.w = cmp(r16.x >= 0);
    r16.x = max(abs(r16.x), r5.w);
    r16.x = r16.w ? r16.x : -r16.x;
    ...
    r30.xyz = r13.xyz * r14.www + r30.xyz;
    r15.z = dot(r30.xyz, r30.xyz);
    r15.z = sqrt(r15.z);
    r14.w = r14.w / r15.z;
    r14.w = r14.w + r14.w;
    r14.w = sqrt(r14.w);
    ...
    r31.w = (uint)r16.w;
    r24.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r31.xyzw, r14.w).xyz;
    r29.yzw = (int3)r24.xyz & int3(-2147483648,-2147483648,-2147483648);
    r29.yzw = cmp((int3)r29.yzw == int3(2139095040,2139095040,2139095040));
    r14.w = (int)r29.z | (int)r29.y;
    r14.w = (int)r29.w | (int)r14.w;
    r24.xyz = r14.www ? float3(1,1,0) : r24.xyz;
  ...
  if (r7.z == 0) {
    ...
    while (true) {
      ...
      bitmask.w = ((~(-1 << r10.w)) << 0) & 0xffffffff;  r12.w = (((uint)0 << 0) & bitmask.w) | ((uint)r12.y & ~bitmask.w);
      r12.y = r12.z ? r12.w : r12.y;
      r12.z = cmp((int)r11.y == (int)r11.w);
      if (r11.z == 0) r12.w = 0; else if (r11.z+0 < 32) {       r12.w = (uint)r12.y << (32-(r11.z + 0)); r12.w = (uint)r12.w >> (32-r11.z);      } else r12.w = (uint)r12.y >> 0;
      r12.y = r12.z ? r12.w : r12.y;
    ...
    if (r11.y != 0) {
      ...
      r12.z = 0;
      while (true) {
        r12.w = cmp((uint)r12.z >= (uint)r7.z);
        if (r12.w != 0) break;
        r14.z = (uint)r12.z >> 5;
        r15.xyz = (int3)r10.xyz + (int3)r14.xyz;
        r12.w = visibleProbes.Load(r15.xyzw).x;
        r14.z = cmp((int)r7.w == (int)r12.z);
        if (r10.w == 0) r14.w = 0; else if (r10.w+0 < 32) {         r14.w = (uint)r12.w << (32-(r10.w + 0)); r14.w = (uint)r14.w >> (32-r10.w);        } else r14.w = (uint)r12.w >> 0;
    ...
    if (r5.w != 0) {
      ...
      r12.yzw = cmp(float3(0,0,0) < r8.xyz);
      ...
      r8.w = 0;
      r12.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r8.xyzw, 6).xyz;
      r11.yzw = r12.yzw * r11.yzw;
      r6.w = dot(r11.yzw, float3(0.212599993,0.715200007,0.0722000003));
      r21.xyz = r23.xyz * r3.www + r11.yzw;
      r13.w = 0;
      r11.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r13.xyzw, r5.z).xyz;
      r3.w = sunConstants.globalProbeExposure * r5.w + -r6.w;
      r3.w = r7.y * r3.w + r6.w;
      r22.xyz = r11.yzw * r3.www + r22.xyz;
    }
  } else {
    r22.x = r21.w;
  }
  ...
  if (r6.w == 0) {
    ...
    if (r10.w != 0) {
      ...
      while (true) {
        ...
        if (r12.z != 0) break;
        r12.z = (uint)r10.w;
        r16.xy = -sunConstants.splitPinTransform[r12.z].xy + r11.yz;
    ...
    if (r12.z == 0) {
      if (enableDitheredShadow == 0) {
        r11.w = (uint)r10.w;
        r12.zw = -sunConstants.splitPinTransform[r11.w].xy + r11.yz;
        r12.zw = sunConstants.splitPinTransform[r11.w].zz * r12.zw;
        r16.xy = r12.zw * float2(0.5,-0.5) + float2(0.5,0.5);
        r11.w = (int16)sunConstants.splitArrayOffset;
        r16.z = r11.w + r10.w;
        r11.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r6.w).x;
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          r17.yz = r17.xx ? r11.yz : r12.zw;
          r17.w = r17.x ? sunConstants.splitPinTransform[r10.w].w : sunConstants.splitPinTransform[r11.w].w;
          r17.x = r17.x ? r10.w : r11.w;
          ...
          r18.z = (uint)r17.x;
          r17.x = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r18.xyz, r6.w).x;
  ...
  if (r6.w != 0) {
    ...
    if (r6.w != 0) {
      ...
      r19.z = samp0[]..swiz;
      r19.w = samp0[]..swiz;
        r11.y = abs(r5.z) * -0.200000003 + 0.400000006;
        r20.xyz = r8.xyz * r11.yyy + v7.xyz;
        r20.w = 1;
        ...
        r12.yz = r10.ww / r18.xz;
        r16.xy = float2(1,1) + -r12.yz;
        r16.xy = cmp(r11.yz >= r16.xy);
        ...
        r12.z = samp0[]..swiz;
          ...
          if (enableDitheredShadow != 0) {
            ...
            while (true) {
              ...
              r12.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r18.xyz, r9.w).x;
              r11.z = r12.y * 0.125 + r11.z;
              r11.w = (int)r11.w + 1;
            }
          } else {
            r16.z = (uint)r11.y;
            r11.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r9.w).x;
          }
          r9.w = r11.z * r11.z;
          r9.w = r9.w * r11.z;
        } else {
      ...
      r1.w = dot(r11.yzw, r2.yzw);
      r9.w = dot(r8.xyz, r11.yzw);
      r10.w = abs(r9.w) * r3.y + -abs(r9.w);
      ...
      r5.w = r8.w * r5.w;
      r5.w = 0.25 * r5.w;
      r11.yzw = r5.www * r9.xyz + r7.yzw;
      r1.w = saturate(1 + -r1.w);
      r6.w = r1.w * r1.w;
      r6.w = r6.w * r6.w;
      r1.w = r6.w * r1.w;
      r1.w = r5.w * r1.w;
      r9.xyz = r1.www * r9.yzx + r15.xyz;
      r16.w = r9.z;
      r14.w = r15.z;
      r14.xyzw = r5.zzzz ? r16.xyzw : r14.xyzw;
      r9.zw = r11.yz;
      r15.zw = r7.yz;
      r9.xyzw = r5.zzzz ? r9.xyzw : r15.xyzw;
      r7.w = r5.z ? r11.w : r7.w;
      r15.z = r14.w;
      r15.xy = r9.xy;
      r7.yz = r9.zw;
    }
              ...
              if (r26.w != 0) {
                ...
                if (r26.w != 0) {
                  ...
                  while (true) {
                    ...
                    if (r30.w != 0) break;
                    r43.y = dot(icb[r29.w+0].yx, r9.xy);
                    r43.z = dot(icb[r29.w+0].yx, r9.yz);
                    ...
                    r15.w = samp0[]..swiz;
                      ...
                      if (r8.w != 0) {
                        ...
                        while (true) {
                          ...
                          if (r27.w != 0) break;
                          r42.x = dot(icb[r19.z+0].yx, r9.xw);
                          r42.y = dot(icb[r19.z+0].xy, r5.xy);
