// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:43:52 2021
...
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r2.xyz, v6.x, l(8), t4.xyzx
...
r3.w = gpuSkinBase[]..swiz;
  ...
  if (r0.w != 0) {
    ...
    r6.x = dot(r1.xyz, r11.xyz);
    r6.y = dot(r1.xzy, r13.xzw);
    r6.z = dot(r1.xyz, r12.xyz);
    r7.xyz = r8.xyz + r9.xyz;
    r3.xyw = r7.xyz + r3.xyw;
    r5.xyz = v4.xxx * r3.xyw;
    r3.xyw = v4.xxx * r6.xyz;
    ...
    if (r0.w != 0) {
      ...
      r12.y = r6.y * r9.x + -r2.z;
      r14.xy = r6.yx * r9.xx + r2.zw;
      ...
      r6.x = dot(r1.xyz, r12.xyz);
      r6.y = dot(r1.xzy, r14.xzw);
      r6.z = dot(r1.xyz, r13.xyz);
      r8.xyz = r9.xyz + r10.xyz;
      r7.xyz = r8.xyz + r7.xyz;
      r5.xyz = r7.xyz * v4.yyy + r5.xyz;
      r3.xyw = r6.xyz * v4.yyy + r3.xyw;
      ...
      if (r0.w != 0) {
        ...
        if (r0.w != 0) {
          ...
          r11.y = r6.y * r9.x + -r2.z;
          r13.xy = r6.yx * r9.xx + r2.zw;
...
r6.w = gpuSkinBase[]..swiz;
  ...
  r5.w = 1;
  r3.w = r7.x;
  r1.w = dot(r5.xyzw, r3.xyzw);
  r4.w = r7.y;
  r2.y = dot(r5.xyzw, r4.xyzw);
  r7.xyz = r6.xyz;
  r2.z = dot(r5.xyzw, r7.xyzw);
  r3.xyzw = viewProjectionMatrix._m10_m11_m12_m13 * r2.yyyy;
  r3.xyzw = r1.wwww * viewProjectionMatrix._m00_m01_m02_m03 + r3.xyzw;
  r3.xyzw = r2.zzzz * viewProjectionMatrix._m20_m21_m22_m23 + r3.xyzw;
  o0.xyzw = viewProjectionMatrix._m30_m31_m32_m33 + r3.xyzw;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r2.yz, v6.x, l(8), t4.xxyx
r2.y = gpuSkinBase[]..swiz;
r2.z = gpuSkinBase[]..swiz;
  r1.w = (int)r0.w + (int)r2.z;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r3.xyz, r1.w, l(0), t5.xyzx
r3.x = gpuSkinBase[]..swiz;
r3.y = gpuSkinBase[]..swiz;
r3.z = gpuSkinBase[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r4.xyz, r1.w, l(16), t5.xyzx
r4.x = gpuSkinBase[]..swiz;
r4.y = gpuSkinBase[]..swiz;
r4.z = gpuSkinBase[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r5.xyz, r1.w, l(32), t5.xyzx
r5.x = gpuSkinBase[]..swiz;
r5.y = gpuSkinBase[]..swiz;
r5.z = gpuSkinBase[]..swiz;
  o3.x = dot(r1.xyz, r3.xyz);
  o3.y = dot(r1.xyz, r4.xyz);
  o3.z = dot(r1.xyz, r5.xyz);
  r1.x = (int)r2.x & 0x0fffffff;
  if (r1.x != 0) {
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r1.xy, v6.x, l(16), t4.xyxx
  r1.x = gpuSkinBase[]..swiz;
  r1.y = gpuSkinBase[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r3.xyzw, r1.x, l(48), t5.xyzw
  r3.x = gpuSkinBase[]..swiz;
  r3.y = gpuSkinBase[]..swiz;
  r3.z = gpuSkinBase[]..swiz;
  r3.w = gpuSkinBase[]..swiz;
    r3.xyzw = r1.xxxx ? r3.xyzw : float4(0,0,0,0);
  // Known bad code for instruction (needs manual fix):
  ...
  r4.w = gpuSkinBase[]..swiz;
    ...
    if (r2.x != 0) {
      r1.w = (uint)r1.w;
      if (r1.w != 0) {
        r2.x = (int)r1.w + (int)v5.x;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r3.xyzw, r2.x, l(0), t8.xyzw
      r3.x = gpuSkinBase[]..swiz;
      r3.y = gpuSkinBase[]..swiz;
      r3.z = gpuSkinBase[]..swiz;
      r3.w = gpuSkinBase[]..swiz;
        ...
        r3.x = v4.x * r2.z;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r4.xyzw, r2.x, l(16), t8.xyzw
      r4.x = gpuSkinBase[]..swiz;
      r4.y = gpuSkinBase[]..swiz;
      r4.z = gpuSkinBase[]..swiz;
      r4.w = gpuSkinBase[]..swiz;
        ...
        r2.z = r2.z + r4.w;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r4.xyzw, r2.x, l(32), t8.xyzw
      r4.x = gpuSkinBase[]..swiz;
      r4.y = gpuSkinBase[]..swiz;
      r4.z = gpuSkinBase[]..swiz;
      r4.w = gpuSkinBase[]..swiz;
        r2.x = dot(r4.xyz, r0.xyz);
        r2.x = r2.x + r4.w;
        r3.yz = v4.xx * r2.zx;
        r2.x = cmp(v4.y != 0.000000);
        if (r2.x != 0) {
          r2.x = (int)r1.w + (int)v5.y;
        // Known bad code for instruction (needs manual fix):
        ...
        r4.w = gpuSkinBase[]..swiz;
          ...
          r2.x = r2.x + r4.w;
          r3.z = r2.x * v4.y + r3.z;
          r2.x = cmp(v4.z != 0.000000);
          if (r2.x != 0) {
            r2.x = (int)r1.w + (int)v5.z;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r4.xyzw, r2.x, l(0), t8.xyzw
          r4.x = gpuSkinBase[]..swiz;
          r4.y = gpuSkinBase[]..swiz;
          ...
          r4.w = gpuSkinBase[]..swiz;
            ...
            r2.x = r2.x + r4.w;
            r3.z = r2.x * v4.z + r3.z;
            r2.x = cmp(v4.w != 0.000000);
            if (r2.x != 0) {
              r1.w = (int)r1.w + (int)v5.w;
            // Known bad code for instruction (needs manual fix):
            ...
            r4.w = gpuSkinBase[]..swiz;
              ...
              r3.x = r2.x * v4.w + r3.x;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r4.xyzw, r1.w, l(16), t8.xyzw
            r4.x = gpuSkinBase[]..swiz;
            r4.y = gpuSkinBase[]..swiz;
            r4.z = gpuSkinBase[]..swiz;
            r4.w = gpuSkinBase[]..swiz;
              ...
              r3.y = r2.x * v4.w + r3.y;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r4.xyzw, r1.w, l(32), t8.xyzw
            r4.x = gpuSkinBase[]..swiz;
            r4.y = gpuSkinBase[]..swiz;
            r4.z = gpuSkinBase[]..swiz;
            r4.w = gpuSkinBase[]..swiz;
      ...
      r1.xyw = gpuSkinPos.Load(r4.xyz).xyz;
      r2.xzw = gpuSkinPos.Load(r4.xwz).xyz;
      r7.xyz = gpuSkinBase.Load(r4.xzz).xyz;
      r6.xyzw = r6.xyzw + -r5.xyzw;
      r5.xyzw = r1.zzzz * r6.xyzw + r5.xyzw;
      r2.xzw = r2.xzw + -r1.xyw;
      r1.xyw = r1.zzz * r2.xzw + r1.xyw;
      ...
      r6.z = r5.y * r6.y + r9.y;
      r10.x = 1 + -r6.z;
      r11.x = r5.z * r6.x + -r6.w;
      r10.y = r5.y * r6.x + -r9.x;
      r9.xy = r5.yx * r6.xx + r9.xy;
      r9.z = r5.z * r6.y + -r8.z;
      r5.xyz = r5.zwy * r6.yyy + r8.zyx;
      r10.z = r5.y;
      r6.x = dot(r2.xzw, r10.xyz);
      r9.w = 1 + -r9.y;
      r6.y = dot(r2.xwz, r9.xzw);
      r11.yz = r5.xz * float2(1,-1) + float2(0,1);
      r6.z = dot(r2.xzw, r11.xyz);
      r2.xzw = r6.xyz + r7.xyz;
      r1.xyw = r2.xzw + r1.xyw;
      r3.xyz = v4.xxx * r1.xyw;
      ...
      if (r1.x != 0) {
        ...
        if (r1.x != 0) {
          ...
          if (r1.x != 0) {
            ...
            r5.xyzw = r1.zzzz * r6.xyzw + r5.xyzw;
            r2.xzw = r2.xzw + -r1.xyw;
            r1.xyz = r1.zzz * r2.xzw + r1.xyw;
            r2.xzw = -r4.xyz + r0.xyz;
            ...
            r8.z = r5.y;
            r6.x = dot(r2.xzw, r8.xyz);
            r10.w = 1 + -r10.y;
            r6.y = dot(r2.xwz, r10.xzw);
            r9.yz = r5.xz * float2(1,-1) + float2(0,1);
            r6.z = dot(r2.xzw, r9.xyz);
            r2.xzw = r6.xyz + r4.xyz;
            r1.xyz = r2.xzw + r1.xyz;
            r3.xyz = r1.xyz * v4.www + r3.xyz;
          }
        }
      }
    }
  ...
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r1.x, v6.x, l(16), t4.xxxx
  r1.x = gpuSkinBase[]..swiz;
  // Known bad code for instruction (needs manual fix):
  ...
  r4.z = gpuSkinBase[]..swiz;
  r4.w = gpuSkinBase[]..swiz;
    r1.xyzw = r1.xxxx ? r4.xyzw : float4(0,0,0,0);
    r2.x = cmp(0 != r1.w);
    if (r2.x != 0) {
      r1.w = (uint)r1.w;
      if (r1.w != 0) {
      ...
      r4.w = gpuSkinBase[]..swiz;
        ...
        r2.z = r2.z + r4.w;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r4.xyzw, r2.x, l(32), t5.xyzw
      r4.x = gpuSkinBase[]..swiz;
      r4.y = gpuSkinBase[]..swiz;
      r4.z = gpuSkinBase[]..swiz;
      r4.w = gpuSkinBase[]..swiz;
        ...
        r4.w = gpuSkinBase[]..swiz;
          ...
          r4.w = gpuSkinBase[]..swiz;
            ...
            r4.w = gpuSkinBase[]..swiz;
              ...
              r3.y = r2.x * v4.w + r3.y;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r4.xyzw, r1.w, l(32), t5.xyzw
            r4.x = gpuSkinBase[]..swiz;
            r4.y = gpuSkinBase[]..swiz;
            r4.z = gpuSkinBase[]..swiz;
            r4.w = gpuSkinBase[]..swiz;
      ...
      if (r1.x != 0) {
        ...
        if (r1.x != 0) {
          ...
          if (r1.x != 0) {
            ...
            r1.w = rsqrt(r1.w);
            r5.xyzw = r5.xyzw * r1.wwww;
            r2.xzw = r5.xyz + r5.xyz;
            r6.xyz = r5.xzw * r2.xxx;
            r1.w = r5.w * r2.z;
            r7.xy = r5.wz * r2.ww;
            r2.w = r5.y * r2.z + r7.y;
            r8.x = 1 + -r2.w;
            r9.x = r5.z * r2.x + -r1.w;
            r8.y = r5.y * r2.x + -r7.x;
            r7.xy = r5.yx * r2.xx + r7.xy;
            r7.z = r5.z * r2.z + -r6.z;
            r2.xzw = r5.zwy * r2.zzz + r6.zyx;
            r8.z = r2.z;
            r5.x = dot(r0.xyz, r8.xyz);
            r7.w = 1 + -r7.y;
            r5.y = dot(r0.xzy, r7.xzw);
            r9.yz = r2.xw * float2(1,-1) + float2(0,1);
            r5.z = dot(r0.xyz, r9.xyz);
...
r0.w = gpuSkinBase[]..swiz;
  ...
  o4.xyzw = motionVectorConstants.prevFrameOffToClpMatrixFull._m30_m31_m32_m33 + r0.xyzw;
  o2.xy = v2.xy;
  o1.x = 1;
  return;
}