...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  if (r1.w == 0) {
    ...
    if (r9.y != 0) {
      ...
      r12.w = 0;
      while (true) {
        r14.w = cmp((uint)r12.w >= (uint)r1.w);
        if (r14.w != 0) break;
        r12.z = (uint)r12.w >> 5;
        r13.xyz = (int3)r11.xyz + (int3)r12.xyz;
    ...
    if (r4.z != 0) {
      ...
      r19.xyz = r21.xyz * r1.www + r9.yzw;
      r10.w = 0;
      r9.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r10.xyzw, r7.z).xyz;
      r1.w = sunConstants.globalProbeExposure * r4.z + -r2.w;
      r1.w = r4.y * r1.w + r2.w;
