...
loop 
  ...
  if_nz r9.w
    ...
    loop 
      ...
      dp3 r18.x, cb11[r16.w + 0].xyzx, r15.yzwy
      add_sat r18.x, r18.x, cb11[r16.w + 0].w
      mul r18.x, r18.x, r25.x
      ...
      movc r20.y, r20.z, r16.w, r20.w
      movc r25.xy, r19.wwww, r25.xyxx, r20.xyxx
      iadd r14.w, r14.w, l(1)
      mov r13.w, r18.w
    endloop 
    mov_sat r25.y, r25.y
    mul r9.w, r25.y, cb10[r8.w + 6].y
    lt r13.z, l(0.000000), r9.w
    if_nz r13.z
      mad r24.w, r25.y, cb10[r8.w + 6].y, r24.w
      mul r9.w, r9.w, cb10[r8.w + 7].y
      mov r26.x, cb10[r8.w + 7].w
      mov r26.yz, cb10[r8.w + 8].xxyx
      dp3 r13.z, r17.xyzx, r26.xyzx
      dp3 r13.w, r15.yzwy, r26.xyzx
      ...
      mov r26.x, cb10[r8.w + 8].w
      mov r26.yz, cb10[r8.w + 9].xxyx
      dp3 r13.w, r17.xyzx, r26.xyzx
      dp3 r14.w, r15.yzwy, r26.xyzx
      ...
      mov r26.x, cb10[r8.w + 9].w
      mov r26.yz, cb10[r8.w + 10].xxyx
      dp3 r13.w, r17.xyzx, r26.xyzx
      dp3 r14.w, r15.yzwy, r26.xyzx
      ...
      div r13.w, r14.w, r13.w
      min r13.z, |r13.w|, r13.z
      mov r26.x, cb10[r8.w + 10].w
      mov r26.yz, cb10[r8.w + 11].xxyx
      dp3 r13.w, r17.xyzx, r26.xyzx
      dp3 r14.w, r15.yzwy, r26.xyzx
      ...
      div r13.w, r14.w, r13.w
      min r13.z, |r13.w|, r13.z
      mov r26.x, cb10[r8.w + 11].w
      mov r26.yz, cb10[r8.w + 12].xxyx
      dp3 r13.w, r17.xyzx, r26.xyzx
      dp3 r14.w, r15.yzwy, r26.xyzx
      ...
      div r13.w, r14.w, r13.w
      min r13.z, |r13.w|, r13.z
      mov r26.x, cb10[r8.w + 12].w
      mov r26.yz, cb10[r8.w + 13].xxyx
      dp3 r13.w, r17.xyzx, r26.xyzx
      dp3 r14.w, r15.yzwy, r26.xyzx
      ...
      div r13.w, r14.w, r13.w
      min r13.z, |r13.w|, r13.z
      add r26.x, r15.y, cb10[r8.w + 3].w
      add r26.yz, r15.zzwz, cb10[r8.w + 4].xxyx
      mad r16.yzw, r17.xxyz, r13.zzzz, r26.xxyz
      dp3 r13.w, r16.yzwy, r16.yzwy
      sqrt r13.w, r13.w
      div r13.z, r13.z, r13.w
      add r13.z, r13.z, r13.z
      sqrt r13.z, r13.z
      mad r13.z, r2.w, l(5.000000), r13.z
      add r13.z, r13.z, l(-0.844800)
      mov r26.x, cb10[r8.w + 0].w
      mov r26.y, cb10[r8.w + 1].z
      mov r26.z, cb10[r8.w + 2].y
      dp3 r27.x, r16.yzwy, r26.xyzx
      mov r28.xy, cb10[r8.w + 1].xwxx
      mov r28.z, cb10[r8.w + 2].z
      dp3 r27.y, r16.yzwy, r28.xyzx
      mov r29.x, cb10[r8.w + 1].y
      mov r29.yz, cb10[r8.w + 2].xxwx
      dp3 r27.z, r16.yzwy, r29.xyzx
      ubfe r13.w, l(9), l(16), cb10[r8.w + 7].z
      utof r27.w, r13.w
      sample_l_indexable(texturecubearray)(float,float,float,float) r16.yzw, r27.xyzw, t8.wxyz, s2, r13.z
      dp3 r30.x, r15.yzwy, r26.xyzx
      dp3 r30.y, r15.yzwy, r28.xyzx
      dp3 r30.z, r15.yzwy, r29.xyzx
      mad_sat r15.yzw, r30.xxyz, cb10[r8.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
      mul r30.xy, r15.yzyy, cb10[r8.w + 4].zwzz
      mul r30.z, r15.w, cb10[r8.w + 5].x
      add r15.yzw, r30.xxyz, cb10[r8.w + 5].yyzw
      ...
      mov r26.x, r23.w
      mov r26.yz, r24.yyzy
      mad r24.xyz, r15.yzwy, r8.wwww, r26.xyzx
      mov r23.w, r24.x
    endif 
  endif 
  iadd r7.w, r7.w, l(1)
...
if_nz r7.w
  ...
  loop 
    ...
    if_nz r9.w
      ...
      ubfe r13.z, l(6), l(25), cb10[r8.w + 7].z
      imul null, r13.w, r9.w, l(6)
      dp3 r14.w, cb11[r13.w + 0].xyzx, r16.yzwy
      add_sat r14.w, r14.w, cb11[r13.w + 0].w
      dp3 r18.w, cb11[r13.w + 1].xyzx, r16.yzwy
      add_sat r18.w, r18.w, cb11[r13.w + 1].w
      mul r14.w, r14.w, r18.w
      dp3 r18.w, cb11[r13.w + 2].xyzx, r16.yzwy
      add_sat r18.w, r18.w, cb11[r13.w + 2].w
      mul r14.w, r14.w, r18.w
      dp3 r18.w, cb11[r13.w + 3].xyzx, r16.yzwy
      add_sat r18.w, r18.w, cb11[r13.w + 3].w
      mul r14.w, r14.w, r18.w
      dp3 r18.w, cb11[r13.w + 4].xyzx, r16.yzwy
      add_sat r18.w, r18.w, cb11[r13.w + 4].w
      mul r14.w, r14.w, r18.w
      dp3 r18.w, cb11[r13.w + 5].xyzx, r16.yzwy
      add_sat r13.w, r18.w, cb11[r13.w + 5].w
      mul r18.x, r13.w, r14.w
      and r13.w, l(1), cb10[r8.w + 6].x
      movc r18.xw, r13.wwww, r18.xxxy, r18.zzzx
      mov r13.w, cb10[r8.w + 6].x
      mov r26.xy, r18.xwxx
      mov r14.w, l(1)
      loop 
        ige r19.w, r14.w, r13.z
        breakc_nz r19.w
        iadd r19.w, r9.w, r14.w
        imul null, r19.w, r19.w, l(6)
        dp3 r20.z, cb11[r19.w + 0].xyzx, r16.yzwy
        add_sat r20.z, r20.z, cb11[r19.w + 0].w
        mul r20.z, r20.z, r26.x
        ...
        movc r20.y, r22.w, r19.w, r26.z
        movc r26.xy, r21.wwww, r26.xyxx, r20.xyxx
        iadd r14.w, r14.w, l(1)
        mov r13.w, r20.w
      endloop 
      add_sat r9.w, -r24.w, r26.y
      mul r13.z, r9.w, cb10[r8.w + 6].y
      lt r13.w, l(0.000000), r13.z
      if_nz r13.w
        mad r25.w, r9.w, cb10[r8.w + 6].y, r25.w
        mul r9.w, r13.z, cb10[r8.w + 7].y
        mov r27.x, cb10[r8.w + 7].w
        mov r27.yz, cb10[r8.w + 8].xxyx
        dp3 r13.z, r17.xyzx, r27.xyzx
        ...
        div r13.w, r14.w, r13.w
        min r13.z, |r13.w|, r13.z
        add r27.x, r16.y, cb10[r8.w + 3].w
        add r27.yz, r16.zzwz, cb10[r8.w + 4].xxyx
        mad r20.yzw, r17.xxyz, r13.zzzz, r27.xxyz
        dp3 r13.w, r20.yzwy, r20.yzwy
        sqrt r13.w, r13.w
        div r13.z, r13.z, r13.w
        add r13.z, r13.z, r13.z
        sqrt r13.z, r13.z
        ...
        ubfe r13.w, l(9), l(16), cb10[r8.w + 7].z
        utof r28.w, r13.w
        sample_l_indexable(texturecubearray)(float,float,float,float) r20.yzw, r28.xyzw, t8.wxyz, s2, r13.z
        dp3 r31.x, r16.yzwy, r27.xyzx
        dp3 r31.y, r16.yzwy, r29.xyzx
        dp3 r31.z, r16.yzwy, r30.xyzx
        mad_sat r16.yzw, r31.xxyz, cb10[r8.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
        mul r31.xy, r16.yzyy, cb10[r8.w + 4].zwzz
        mul r31.z, r16.w, cb10[r8.w + 5].x
        add r16.yzw, r31.xxyz, cb10[r8.w + 5].yyzw
        ...
        mul r13.z, r3.w, r8.w
        mul r16.yzw, r9.wwww, r20.yyzw
        dp3 r9.w, r16.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
        mad r8.w, r3.w, r8.w, r9.w
        div r8.w, r13.z, r8.w
        mad r25.xyz, r16.yzwy, r8.wwww, r25.xyzx
      endif 
    endif 
    iadd r7.w, r7.w, l(1)
  endloop 
...
if_nz r2.w
  ...
  mov r17.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r18.xyz, r17.xyzw, t8.xyzw, s2, r3.y
  ...
  loop 
    ...
    if_nz r13.z
      ...
      if_nz r25.w
        ...
        if_nz r20.x
          ...
          if_nz r13.z
            ...
            mad r21.xyz, r12.xyzx, r13.zzzz, r11.xyzx
            mov r39.xyz, cb9[r9.w + 6].yzwy
            mov r39.w, cb9[r9.w + 7].x
            dp4 r13.z, r39.xyzw, r21.xyzw
            dp4 r20.x, r37.xyzw, r21.xyzw
            ge r20.y, r20.x, r13.z
            if_nz r20.y
              ...
              if_nz r7.w
                ...
                utof r37.z, r20.x
                sample_c_lz_indexable(texture2darray)(float,float,float,float) r20.y, r37.xyzx, t9.xxxx, s13, r13.z
              endif 
          ...
          if_nz r20.x
            ...
            mad r36.xyz, r36.xyzx, r13.wwww, r10.yzwy
            dp3 r13.w, r36.xyzx, r36.xyzx
            rsq r13.w, r13.w
      ...
      if_nz r12.w
        ...
        dp3 r14.w, r22.xyzx, r17.xyzx
        dp3 r17.w, r22.xyzx, r37.xyzx
        dp3 r18.w, r17.xyzx, r37.xyzx
        ...
        movc r22.xyz, r13.wwww, r22.xyzx, cb9[r9.w + 0].xyzx
        movc r36.xyz, r13.wwww, r37.xyzx, cb9[r9.w + 0].xyzx
        ...
        if_nz r20.x
          ...
          if_nz r20.x
            ...
            if_nz r14.w
              ...
              dp3_sat r17.w, r12.xyzx, r37.xyzx
...
ret 
// Approximately 1430 instruction slots used
