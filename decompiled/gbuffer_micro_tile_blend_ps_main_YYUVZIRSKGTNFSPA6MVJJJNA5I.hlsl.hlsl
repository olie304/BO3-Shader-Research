  ...
  out float2 o3 : SV_TARGET3)
{
  ...
  r2.xw = r3.xy * float2(1.9921875,1.9921875) + float2(-1,-1);
  r3.x = r3.z * r3.z;
  ...
  r2.yz = v2.yx + r5.xy;
  r2.yz = r2.yz + r1.ww;
  r3.yz = detailScale2.xy * r2.yz;
  r5.xy = float2(0.5,0.5) + r5.xy;
  r5.zw = detailScale2.xy * r5.xy;
  r3.yz = useUVOffsets1 ? r3.yz : r5.zw;
  ...
  r3.yzw = detailMap2.Sample(normalSampler_s, r3.yz).xyz;
  ...
  r5.w = r3.x * detailScaleHeight1 + r0.w;
  r1.xy = r3.yz * detailScaleHeight2 + r0.yz;
  ...
  if (r1.w != 0) {
    ...
    r6.xyz = r5.xxx ? float3(1,0,1) : r4.xyz;
    r5.xyw = r5.yyy ? float3(0,1,1) : r4.xyz;
    r5.xyw = r3.zzz ? r6.xyz : r5.xyw;
    r6.xyz = r5.zzz ? float3(0,1,0) : r4.xyz;
    r4.xyz = r2.yyy ? r5.xyw : r6.xyz;
  }
  r5.xyz = debugColorOverride.xyz + -r4.xyz;
  o0.xyz = debugColorOverride.www * r5.xyz + r4.xyz;
  ...
  r2.x = 1;
  r5.x = 0;
  r2.xyzw = r1.xxxx ? r2.xyzw : r5.xyzw;
  r0.z = r1.x ? r1.w : r0.z;
  r1.x = cmp(r0.z == r1.y);
