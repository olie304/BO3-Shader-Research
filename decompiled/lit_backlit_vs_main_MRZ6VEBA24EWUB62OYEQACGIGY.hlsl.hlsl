...
r0.w = shaderConstantSetBuffer[]..swiz;
  ...
  r0.w = v3.w * 2 + -1;
  if (r1.x != 0) {
    r3.x = cmp(v4.x != 0.000000);
    if (r3.x != 0) {
      r3.x = (int)r1.x + (int)v5.x;
    // Known bad code for instruction (needs manual fix):
    ...
    r3.w = shaderConstantSetBuffer[]..swiz;
      ...
      r4.z = v4.x * r3.x;
      r3.x = cmp(v4.y != 0.000000);
      if (r3.x != 0) {
        r3.x = (int)r1.x + (int)v5.y;
      // Known bad code for instruction (needs manual fix):
      ...
      r3.w = shaderConstantSetBuffer[]..swiz;
        ...
        r3.x = dot(r3.xyz, r1.yzw);
        r4.z = r3.x * v4.y + r4.z;
        r3.x = cmp(v4.z != 0.000000);
        if (r3.x != 0) {
          r3.x = (int)r1.x + (int)v5.z;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r7.xyzw, r3.x, l(0), t5.xyzw
        r7.x = shaderConstantSetBuffer[]..swiz;
        r7.y = shaderConstantSetBuffer[]..swiz;
        ...
        r3.w = shaderConstantSetBuffer[]..swiz;
          ...
          r3.x = dot(r3.xyz, r1.yzw);
          r4.z = r3.x * v4.z + r4.z;
          r3.x = cmp(v4.w != 0.000000);
          if (r3.x != 0) {
            r1.x = (int)r1.x + (int)v5.w;
          // Known bad code for instruction (needs manual fix):
