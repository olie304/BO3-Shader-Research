...
if_nz r7.w
  ...
  dp3 r15.y, cb11[r13.w + 0].xyzx, r14.yzwy
  add_sat r15.y, r15.y, cb11[r13.w + 0].w
  dp3 r15.z, cb11[r13.w + 1].xyzx, r14.yzwy
  add_sat r15.z, r15.z, cb11[r13.w + 1].w
  mul r15.y, r15.z, r15.y
  dp3 r15.z, cb11[r13.w + 2].xyzx, r14.yzwy
  add_sat r15.z, r15.z, cb11[r13.w + 2].w
  mul r15.y, r15.z, r15.y
  dp3 r15.z, cb11[r13.w + 3].xyzx, r14.yzwy
  add_sat r15.z, r15.z, cb11[r13.w + 3].w
  mul r15.y, r15.z, r15.y
  dp3 r15.z, cb11[r13.w + 4].xyzx, r14.yzwy
  add_sat r15.z, r15.z, cb11[r13.w + 4].w
  mul r15.y, r15.z, r15.y
  dp3 r15.z, cb11[r13.w + 5].xyzx, r14.yzwy
  add_sat r13.w, r15.z, cb11[r13.w + 5].w
  mul r17.x, r13.w, r15.y
  and r13.w, l(1), cb10[r7.w + 6].x
  mov r17.yz, l(0,0,1.000000,0)
  movc r15.yz, r13.wwww, r17.xxyx, r17.zzxz
  mov r17.x, l(1.000000)
  mov r13.w, cb10[r7.w + 6].x
  mov r18.xy, r15.yzyy
  mov r15.w, l(1)
  loop 
    ige r17.z, r15.w, r9.w
    breakc_nz r17.z
    iadd r17.z, r8.w, r15.w
    imul null, r17.z, r17.z, l(6)
    dp3 r17.w, cb11[r17.z + 0].xyzx, r14.yzwy
    add_sat r17.w, r17.w, cb11[r17.z + 0].w
    mul r17.w, r17.w, r18.x
    dp3 r18.z, cb11[r17.z + 1].xyzx, r14.yzwy
    add_sat r18.z, r18.z, cb11[r17.z + 1].w
    mul r17.w, r17.w, r18.z
    dp3 r18.z, cb11[r17.z + 2].xyzx, r14.yzwy
    add_sat r18.z, r18.z, cb11[r17.z + 2].w
    mul r17.w, r17.w, r18.z
    dp3 r18.z, cb11[r17.z + 3].xyzx, r14.yzwy
    add_sat r18.z, r18.z, cb11[r17.z + 3].w
    mul r17.w, r17.w, r18.z
    dp3 r18.z, cb11[r17.z + 4].xyzx, r14.yzwy
    add_sat r18.z, r18.z, cb11[r17.z + 4].w
    mul r17.w, r17.w, r18.z
    dp3 r18.z, cb11[r17.z + 5].xyzx, r14.yzwy
  ...
  if_nz r9.w
    ...
    dp3 r15.y, r16.xyzx, r17.xyzx
    dp3 r15.z, r14.yzwy, r17.xyzx
    add r15.z, r15.z, -cb10[r7.w + 9].z
    ...
    min r13.w, r13.w, |r15.y|
    mov r17.x, cb10[r7.w + 9].w
    mov r17.yz, cb10[r7.w + 10].xxyx
    dp3 r15.y, r16.xyzx, r17.xyzx
    dp3 r15.z, r14.yzwy, r17.xyzx
    add r15.z, r15.z, -cb10[r7.w + 10].z
    ge r15.w, r15.z, l(0.000000)
    max r15.z, r3.w, |r15.z|
    movc r15.z, r15.w, r15.z, -r15.z
    max r15.y, -r15.y, l(0.00000010)
    ...
    dp3 r15.y, r16.xyzx, r17.xyzx
    dp3 r15.z, r14.yzwy, r17.xyzx
    add r15.z, r15.z, -cb10[r7.w + 11].z
    ge r15.w, r15.z, l(0.000000)
    max r15.z, r3.w, |r15.z|
    movc r15.z, r15.w, r15.z, -r15.z
    max r15.y, -r15.y, l(0.00000010)
    ...
    dp3 r15.y, r16.xyzx, r17.xyzx
    dp3 r15.z, r14.yzwy, r17.xyzx
    add r15.z, r15.z, -cb10[r7.w + 12].z
    ge r15.w, r15.z, l(0.000000)
    max r15.z, r3.w, |r15.z|
    movc r15.z, r15.w, r15.z, -r15.z
    max r15.y, -r15.y, l(0.00000010)
    ...
    dp3 r15.y, r16.xyzx, r17.xyzx
    dp3 r15.z, r14.yzwy, r17.xyzx
    add r15.z, r15.z, -cb10[r7.w + 13].z
    ge r15.w, r15.z, l(0.000000)
    max r15.z, r3.w, |r15.z|
    movc r15.z, r15.w, r15.z, -r15.z
    max r15.y, -r15.y, l(0.00000010)
    ...
    mad r15.yzw, r16.xxyz, r13.wwww, r17.xxyz
    dp3 r17.x, r15.yzwy, r15.yzwy
    sqrt r17.x, r17.x
    div r13.w, r13.w, r17.x
    ...
    ubfe r15.y, l(9), l(16), cb10[r7.w + 7].z
    utof r18.w, r15.y
    sample_l_indexable(texturecubearray)(float,float,float,float) r15.yzw, r18.xyzw, t8.wxyz, s2, r13.w
...
if_nz r7.w
  ...
  if_nz r6.w
    ...
    dp3 r13.w, cb11[r9.w + 0].xyzx, r17.xyzx
    add_sat r13.w, r13.w, cb11[r9.w + 0].w
    dp3 r17.w, cb11[r9.w + 1].xyzx, r17.xyzx
    add_sat r17.w, r17.w, cb11[r9.w + 1].w
    mul r13.w, r13.w, r17.w
    dp3 r17.w, cb11[r9.w + 2].xyzx, r17.xyzx
    add_sat r17.w, r17.w, cb11[r9.w + 2].w
    mul r13.w, r13.w, r17.w
    dp3 r17.w, cb11[r9.w + 3].xyzx, r17.xyzx
    add_sat r17.w, r17.w, cb11[r9.w + 3].w
    mul r13.w, r13.w, r17.w
    dp3 r17.w, cb11[r9.w + 4].xyzx, r17.xyzx
    add_sat r17.w, r17.w, cb11[r9.w + 4].w
    mul r13.w, r13.w, r17.w
    dp3 r17.w, cb11[r9.w + 5].xyzx, r17.xyzx
    add_sat r9.w, r17.w, cb11[r9.w + 5].w
...
if_nz r2.w
  ...
  mad r17.xyz, r14.yzwy, r0.yyyy, r18.xyzx
  mov r16.w, l(0)
  ...
  mad r15.yzw, r14.yyzw, r0.yyyy, r15.yyzw
endif 
...
ret 
// Approximately 1373 instruction slots used
