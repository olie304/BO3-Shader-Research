...
cbuffer PerSceneConsts : register(b1)
{
  ...
  uint isDepthHack : packoffset(c91);
}
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.xy = r0.zw / r0.xy;
  r0.xyz = colorMapSampler1.Sample(tileMipBilinearSampler_s, r0.xy).xyz;
  r1.xyz = float3(3.05175781e-05,3.05175781e-05,3.05175781e-05) * r0.xyz;
  r1.xyz = log2(r1.xyz);
  r1.xyz = float3(0.416666657,0.416666657,0.416666657) * r1.xyz;
  r1.xyz = exp2(r1.xyz);
  r1.xyz = r1.xyz * float3(1.05499995,1.05499995,1.05499995) + float3(-0.0549999997,-0.0549999997,-0.0549999997);
  r2.xyz = cmp(float3(102.590057,102.590057,102.590057) >= r0.xyz);
  r0.xyz = float3(0.000394287112,0.000394287112,0.000394287112) * r0.xyz;
