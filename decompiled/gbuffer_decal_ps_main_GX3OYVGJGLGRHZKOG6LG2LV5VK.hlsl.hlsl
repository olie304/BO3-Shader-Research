  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r3.xy = saturate(float2(-0.0588235296,0.0588235296) * r3.xy);
  r3.y = -17 * r3.y;
  r3.y = exp2(r3.y);
  r3.y = r3.z + r3.y;
  r3.y = log2(r3.y);
  ...
  if (r3.z != 0) {
    ...
    r4.w = colorMap.CalculateLevelOfDetailUnclamped(colorSampler_s, r0.yz);
    ...
    r5.xyw = r0.yyy ? r6.xyz : r5.xyw;
    r6.xyz = r5.zzz ? float3(0,1,0) : r1.xyz;
    r1.xyz = r0.zzz ? r5.xyw : r6.xyz;
  }
