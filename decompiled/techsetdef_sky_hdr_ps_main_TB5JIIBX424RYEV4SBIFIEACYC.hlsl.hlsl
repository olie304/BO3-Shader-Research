// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:43:23 2021
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.w = -r0.z;
  r1.xyz = colorMap.Sample(colorSampler_s, r0.xyw).xyz;
  r0.xyz = colorMap.Sample(colorSampler_s, r0.xyz).xyz;
