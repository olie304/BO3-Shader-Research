...
r7.w = modelInstanceBuffer[]..swiz;
  ...
  r5.xyzw = viewProjectionMatrix._m10_m11_m12_m13 * r0.xxxx;
  r4.w = r3.y;
  r7.w = r3.w;
  r0.x = dot(r2.xyzw, r4.xyzw);
  r5.xyzw = r0.xxxx * viewProjectionMatrix._m00_m01_m02_m03 + r5.xyzw;
  r0.x = dot(r2.xyzw, r7.xyzw);
  r2.xyzw = r0.xxxx * viewProjectionMatrix._m20_m21_m22_m23 + r5.xyzw;
