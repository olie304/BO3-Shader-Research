...
add r3.xyz, -r2.xyzx, cb1[61].xyzx
mad r2.xyz, cb1[61].wwww, r3.xyzx, r2.xyzx
add r1.x, -r1.z, r1.w
...
rsq r1.z, r1.z
mad r3.xyz, r3.xyzx, r1.zzzz, -r7.xyzx
...
if_z r1.z
  ...
  if_nz r5.z
    ...
    mad r1.z, cb2[19].x, r5.z, -r3.w
    mad r1.z, r8.y, r1.z, r3.w
...
mad r3.w, r8.x, r1.y, r1.z
mul r1.yz, r1.yyzy, r3.wwww
