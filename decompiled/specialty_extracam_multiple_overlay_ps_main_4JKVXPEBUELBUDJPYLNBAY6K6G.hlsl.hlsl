// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:41:10 2021
...
r0.x = bilinearClampler[]..swiz;
  r2.xyzw = colorMap.Sample(bilinearClampler_s, w1.xy).xyzw;
  ...
  if (r0.x != 0) {
    r0.xyzw = extracamTexture4.Sample(bilinearClampler_s, w1.xy).xyzw;
    o0.w = r0.w;
  } else {
    r1.x = cmp(extracamSelect == 3);
    if (r1.x != 0) {
      r0.xyzw = extracamTexture3.Sample(bilinearClampler_s, w1.xy).xyzw;
      o0.w = r0.w;
    } else {
      r1.x = cmp(extracamSelect == 2);
      if (r1.x != 0) {
        r0.xyzw = extracamTexture2.Sample(bilinearClampler_s, w1.xy).xyzw;
        o0.w = r0.w;
      } else {
        r0.xyzw = extracamTexture1.Sample(bilinearClampler_s, w1.xy).xyzw;
        o0.w = r0.w;
      }
    }
  }
