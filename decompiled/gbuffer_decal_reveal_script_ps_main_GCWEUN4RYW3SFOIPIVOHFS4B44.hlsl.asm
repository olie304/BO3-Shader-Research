...
rsq r0.w, r0.w
sample_indexable(texture2d)(float,float,float,float) r6.xyz, r0.xyxx, t12.xyzw, s1
mul r6.xyz, r6.xyzx, v8.xyzx
sample_indexable(texture2d)(float,float,float,float) r7.xyz, r0.xyxx, t14.xyzw, s2
...
mad_sat r0.y, r2.w, l(0.998000), l(0.001000)
add r2.w, -r0.y, l(1.000000)
mov_sat r3.w, cb0[8].y
log r0.y, r0.y
mul r0.y, r0.y, r3.w
exp r0.y, r0.y
mov r4.x, -r0.y
...
mul r0.y, r0.y, r3.w
exp r4.y, r0.y
mad_sat r4.xy, cb0[8].xxxx, r4.xyxx, r2.wwww
add r0.x, r0.x, -r4.x
add r0.y, -r4.x, r4.y
