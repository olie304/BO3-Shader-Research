...
if_nz r3.z
  ...
  if_nz r3.z
    ...
    max r3.z, r13.z, r13.y
    add r15.xyw, r16.xyxz, -r17.xyxz
    mad r15.xyw, r3.zzzz, r15.xyxw, r17.xyxz
    ...
    sample_l_indexable(texture2d)(float,float,float,float) r4.y, r16.xyxx, t28.yxzw, s1, r3.z
    mad r20.xyz, r18.xyzx, l(0.031250, 0.031250, 0.031250, 0.000000), r16.xyzx
    sample_l_indexable(texture2d)(float,float,float,float) r4.z, r20.xyxx, t28.yzxw, s1, r3.z
    min r4.y, |r4.y|, |r4.z|
    mul r4.y, r20.z, r4.y
    lt r4.y, r4.y, l(1.000000)
    and r4.w, r4.y, l(1)
    mad r20.xyz, r18.xyzx, l(0.062500, 0.062500, 0.062500, 0.000000), r16.xyzx
    sample_l_indexable(texture2d)(float,float,float,float) r6.w, r20.xyxx, t28.yzwx, s1, r3.z
    min r4.z, |r4.z|, |r6.w|
    mul r4.z, r20.z, r4.z
    lt r4.z, r4.z, l(1.000000)
    bfi r4.y, l(1), l(0), r4.y, l(2)
    movc r4.y, r4.z, r4.y, r4.w
    ...
    iadd r6.w, r4.y, l(4)
    movc r4.y, r4.w, r6.w, r4.y
    mad r20.xyz, r18.xyzx, l(0.125000, 0.125000, 0.125000, 0.000000), r16.xyzx
    sample_l_indexable(texture2d)(float,float,float,float) r4.w, r20.xyxx, t28.yzwx, s1, r3.z
    min r4.z, |r4.z|, |r4.w|
    mul r4.z, r20.z, r4.z
    lt r4.z, r4.z, l(1.000000)
    iadd r6.w, r4.y, l(8)
    movc r4.y, r4.z, r6.w, r4.y
    ...
    loop 
      ...
      if_nz r13.y
        if_nz r20.z
          lt r13.y, r13.w, |r10.w|
          lt r13.z, r7.w, r15.w
          and r13.y, r13.z, r13.y
          movc r17.xy, r13.yyyy, r15.xyxx, r4.yzyy
          mov r20.z, r15.w
          mov r22.x, r7.w
  ...
  mul r1.w, r1.w, r3.z
  mul r1.w, r15.y, r1.w
  mad r13.yz, r4.yyzy, l(0.000000, 2.000000, 2.000000, 0.000000), l(0.000000, -1.000000, -1.000000, 0.000000)
  ...
  if_nz r4.w
    sample_l_indexable(texture2d)(float,float,float,float) r13.yz, r4.yzyy, t22.zxyw, s4, l(0.000000)
    ...
    mad r4.yz, -r13.yyzy, cb1[44].zzwz, r4.yyzy
    sample_l_indexable(texture2d)(float,float,float,float) r4.yzw, r4.yzyy, t21.wxyz, s4, l(0.000000)
    mul r4.yzw, r4.yyzw, cb1[85].xxxx
...
mul r7.w, r6.w, l(5.000000)
mad r8.w, r6.w, l(5.000000), l(-2.500000)
...
if_nz cb2[54].x
  ...
  loop 
    ...
    loop 
      ...
      if_nz r40.w
        mov r29.yzw, cb10[r40.z + 1].xxyz
        mov r29.x, cb10[r40.z + 0].w
        mov r30.yzw, cb10[r40.z + 2].xxyz
        mov r30.x, cb10[r40.z + 1].w
        mov r31.xyz, cb10[r40.z + 3].xyzx
        mov r31.w, cb10[r40.z + 4].z
        mov r32.yz, cb10[r40.z + 4].xxyx
        mov r32.x, cb10[r40.z + 3].w
        mov r32.w, cb10[r40.z + 6].x
        mov r33.yzw, cb10[r40.z + 5].xxyz
        mov r33.x, cb10[r40.z + 4].w
        mov r34.yz, cb10[r40.z + 7].yywy
        mov r34.x, cb10[r40.z + 6].y
        mov r34.w, cb10[r40.z + 8].x
        mov r35.xyz, cb10[r40.z + 8].yzwy
        mov r35.w, cb10[r40.z + 9].x
        mov r36.xyz, cb10[r40.z + 10].yzwy
        mov r36.w, cb10[r40.z + 11].x
        mov r37.xyz, cb10[r40.z + 11].yzwy
        mov r37.w, cb10[r40.z + 12].x
        mov r38.xyz, cb10[r40.z + 0].xyzx
        mov r43.xy, cb10[r40.z + 13].yzyy
        mov r38.w, l(-1)
        mov r39.z, cb10[r40.z + 2].w
...
if_nz r26.z
  ...
  loop 
    ...
    dp3 r27.w, cb11[r20.w + 1].xyzx, r13.yzwy
    add_sat r27.w, r27.w, cb11[r20.w + 1].w
    mul r26.y, r26.y, r27.w
    dp3 r27.w, cb11[r20.w + 2].xyzx, r13.yzwy
    add_sat r27.w, r27.w, cb11[r20.w + 2].w
    mul r26.y, r26.y, r27.w
    dp3 r27.w, cb11[r20.w + 3].xyzx, r13.yzwy
    add_sat r27.w, r27.w, cb11[r20.w + 3].w
    mul r26.y, r26.y, r27.w
    dp3 r27.w, cb11[r20.w + 4].xyzx, r13.yzwy
    add_sat r27.w, r27.w, cb11[r20.w + 4].w
    mul r26.y, r26.y, r27.w
    dp3 r27.w, cb11[r20.w + 5].xyzx, r13.yzwy
    add_sat r20.w, r27.w, cb11[r20.w + 5].w
    mul r31.x, r20.w, r26.y
    ushr r27.w, r16.w, l(2)
    ubfe r28.w, l(1), l(2), r16.w
    and r29.w, r27.w, l(2)
    max r30.z, r31.x, r31.y
    mad r20.w, -r26.y, r20.w, l(1.000000)
    mul r20.w, r20.w, r31.y
    movc r30.y, r29.w, r20.w, r30.z
    movc r31.xy, r28.wwww, r31.xyxx, r30.xyxx
...
if_z r13.y
  ...
  loop 
    ...
    ieq r18.w, r13.w, r15.w
    bfi r20.w, r15.x, l(0), l(0), r17.w
    movc r17.w, r18.w, r20.w, r17.w
    ieq r18.w, r15.y, r15.w
    ubfe r20.w, r15.z, l(0), r17.w
    movc r17.w, r18.w, r20.w, r17.w
    ...
    loop 
      ...
      add r16.yzw, r11.xxyz, -cb10[r20.w + 0].xxyz
  ...
  loop 
    ...
    ieq r19.x, r13.w, r17.w
    ubfe r19.y, r15.x, l(0), r18.w
    ...
    loop 
      ...
      add r16.yzw, r11.xxyz, -cb10[r19.y + 0].xxyz
      ...
      loop 
        ...
        movc r19.w, r30.w, r25.w, r31.z
        movc r31.xy, r28.wwww, r31.xyxx, r19.zwzz
      ...
      if_nz r20.w
        ...
        mad r31.xzw, r14.xxyz, r19.wwww, r32.xxyz
        dp3 r20.w, r31.xzwx, r31.xzwx
        sqrt r20.w, r20.w
        ...
        utof r33.w, r20.w
        sample_l_indexable(texturecubearray)(float,float,float,float) r31.xzw, r33.xyzw, t8.xwyz, s2, r19.w
        ...
        mul r16.y, r9.w, r18.z
        mul r31.xzw, r17.xxxx, r31.xxzw
        dp3 r16.z, r31.xzwx, l(0.212600, 0.715200, 0.072200, 0.000000)
        mad r16.z, r9.w, r18.z, r16.z
        div r16.y, r16.y, r16.z
        mad r27.xyz, r31.xzwx, r16.yyyy, r27.xyzx
      else 
        mov r29.x, r28.x
        mov r28.xz, r29.xxyx
      endif 
  ...
  movc r10.w, r6.w, r8.w, r25.y
  max r6.w, r25.x, l(1.000000)
  rcp r6.w, r6.w
  mov_sat r25.x, r25.x
  mul r13.yzw, r6.wwww, r15.yyzw
  mul r30.xyz, r6.wwww, r24.xyzx
  ...
  if_nz r8.w
    ...
    mad r13.yzw, r15.yyzw, r6.wwww, r16.xxyz
    mov r14.w, l(0)
    sample_l_indexable(texturecubearray)(float,float,float,float) r15.xyz, r14.xyzw, t8.xyzw, s2, r7.w
    mad r6.w, cb2[19].x, r8.w, -r9.w
    mad r6.w, r2.y, r6.w, r9.w
    mad r30.xyz, r15.xyzx, r6.wwww, r30.xyzx
  endif 
else 
  mov r13.yzw, l(0,0,0,0)
endif 
add r1.w, -r1.w, l(1.000000)
mad r4.yzw, r30.xxyz, r1.wwww, r4.yyzw
add r1.w, r5.x, r2.x
log r1.w, |r1.w|
mul r1.w, r1.w, r2.z
exp r1.w, r1.w
...
mul r4.yzw, r1.wwww, r4.yyzw
mul r15.xzw, r15.xxxx, r4.yyzw
mul r4.yzw, r15.yyyy, r4.yyzw
sqrt r1.w, r2.z
...
switch r3.z
  ...
  if_nz r14.w
    sqrt r14.w, r8.w
    mul r15.y, cb9[r0.x + 3].x, cb9[r0.x + 3].x
    div r8.w, r15.y, r8.w
    min r8.w, r8.w, l(1.000000)
    mad_sat r19.xy, r14.wwww, cb9[r0.x + 2].xzxx, cb9[r0.x + 2].ywyy
    ...
    if_nz r14.w
      ubfe r14.w, l(3), l(27), cb9[r0.x + 1].w
      if_nz r2.w
        ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r15.y, cb2[52].x, l(112), u2.xxxx
        or r15.y, r15.y, l(4)
        store_structured u2.x, cb2[52].x, l(112), r15.y
      ...
      if_nz r14.w
        ...
        mad r19.yzw, r12.xxyz, r14.wwww, r11.xxyz
        add r19.yzw, r19.yyzw, -cb9[r0.x + 4].yyzw
        max r14.w, |r19.w|, |r19.z|
        max r14.w, r14.w, |r19.y|
        div r14.w, cb9[r0.x + 5].x, r14.w
        add r14.w, r14.w, cb9[r0.x + 5].y
        dp3 r15.y, r19.yzwy, r19.yzwy
        rsq r15.y, r15.y
        ...
        loop 
          ...
          mad r22.xyz, r19.yzwy, r15.yyyy, r23.xzwx
      ...
      if_nz r14.w
        ...
        dp3 r15.y, r16.xyzx, r14.xyzx
        dp3 r14.x, r14.xyzx, r18.xyzx
        mad r14.y, -r15.y, r15.y, cb9[r0.x + 6].y
        mad r6.w, r15.y, r14.x, -r6.w
        ...
        if_nz r7.w
          ...
          if_z r16.w
            ...
            if_z r17.z
              ...
              mul r17.x, r15.y, cb9[r6.w + 10].z
              mad r7.w, cb9[r6.w + 10].y, r15.y, r7.w
              div r7.w, r7.w, r17.x
            endif 
          else 
            mov r17.z, l(-1)
          endif 
          or r15.y, r16.w, r17.z
          if_z r15.y
            max r7.w, r7.w, l(0.00006104)
            and r15.y, l(0x0000ffff), cb9[r6.w + 1].w
            if_nz cb2[58].y
              mov r17.x, -r4.x
              utof r19.z, r15.y
              mov r17.y, r13.x
        ...
        mad r18.xyz, r6.wwww, r17.xyzx, r13.yzwy
        ...
        mul r6.w, r6.w, r9.w
        mul r6.w, r8.w, r6.w
        mad r14.xyz, r6.wwww, r17.xyzx, r4.yzwy
        ...
        movc r13.yzw, r7.wwww, r18.xxyz, r13.yyzw
        movc r15.xzw, r7.wwww, r16.xxyz, r15.xxzw
        movc r4.yzw, r7.wwww, r14.xxyz, r4.yyzw
        if_nz r2.w
        ...
        if_nz r12.w
          ...
          if_nz cb2[58].y
            ...
            loop 
              ige r15.y, r14.w, l(8)
              breakc_nz r15.y
              dp2 r20.x, icb[r14.w + 0].yxyy, r16.xyxx
              dp2 r20.y, icb[r14.w + 0].yxyy, r16.yzyy
              mad r19.xy, r20.xyxx, cb9[r0.x + 3].yyyy, r18.xyxx
              sample_c_lz_indexable(texture2darray)(float,float,float,float) r15.y, r19.xyzx, t9.xxxx, s13, r8.w
      ...
      if_nz r9.w
        ...
        if_nz r12.w
          ...
          if_z r15.y
            ...
            div r16.xy, r18.xyxx, r14.wwww
            mad r16.xy, r16.xyxx, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
            add r18.x, r16.x, cb9[r11.w + 9].w
            add r18.y, r16.y, cb9[r11.w + 10].x
            mul r16.xy, r18.xyxx, cb9[r11.w + 9].yzyy
            ...
            if_z r16.z
              ...
              mad r18.x, r16.x, cb9[r11.w + 8].y, cb9[r11.w + 8].z
              mad r18.y, r16.y, cb9[r11.w + 8].w, cb9[r11.w + 9].x
              mul r16.x, r14.w, cb9[r11.w + 10].z
          ...
          if_z r14.w
            ...
            if_nz cb2[58].y
              ...
              loop 
                ige r17.w, r16.w, l(8)
                breakc_nz r17.w
                dp2 r20.x, icb[r16.w + 0].yxyy, r16.xyxx
                dp2 r20.y, icb[r16.w + 0].yxyy, r16.yzyy
              ...
              utof r18.z, r14.w
              sample_c_lz_indexable(texture2darray)(float,float,float,float) r15.y, r18.xyzx, t9.xxxx, s13, r12.w
            endif 
        ...
        mad r16.xyz, r0.xxxx, r17.xyzx, r13.yzwy
        mad r14.xyz, r14.xyzx, r5.xxxx, r5.yzwy
        ...
        mad r2.xyz, r0.wwww, r17.xyzx, r4.yzwy
        ...
        movc r4.yzw, r1.zzzz, r2.xxyz, r4.yyzw
        if_nz r2.w
...
mad r2.xyz, r4.yzwy, r5.xyzx, r2.xyzx
...
ret 
// Approximately 2452 instruction slots used
