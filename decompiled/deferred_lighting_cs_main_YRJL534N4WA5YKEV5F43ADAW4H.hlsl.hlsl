...
r0.y = samplerLinear[]..swiz;
  ...
  r2.w = dot(r9.xyw, float3(0.212599993,0.715200007,0.0722000003));
  r16.w = 0;
  ...
  r4.z = (int)r4.z + 7;
  r4.z = (uint)r4.z >> 3;
  r0.x = mad((int)r0.y, (int)r4.z, (int)r0.x);
  r0.x = (uint)r0.x << 5;
  r0.y = ~(int)r9.z;
  r18.x = -r13.x;
  r2.x = -r2.x * 0.5 + 1;
      ...
      if (r13.z != 0) {
        ...
        if (r19.w != 0) {
          ...
          if (r24.w != 0) {
            ...
            r26.w = r26.w / r27.w;
            r26.w = min(1, r26.w);
            r36.xy = saturate(r19.ww * lightConstantsCB[r11.w].data[2].xz + lightConstantsCB[r11.w].data[2].yw);
            ...
            r19.w = cmp(lightConstantsCB[r11.w].data[10].w < 0.00048828125);
            if (r19.w != 0) {
              r36.xy = saturate(abs(r19.xy) * lightConstantsCB[r11.w].data[12].xy + lightConstantsCB[r11.w].data[12].zw);
              r36.zw = r36.xy * r36.xy;
              r36.xy = r36.xy * float2(-2,-2) + float2(3,3);
              r36.xy = r36.zw * r36.xy;
              r19.w = r36.x * r36.y;
            } else {
              r36.xyzw = saturate(lightConstantsCB[r11.w].data[11].xyzw * abs(r19.yyxx));
            ...
            r24.w = r26.w * r19.w;
            r19.w = 255 & (int)lightConstantsCB[r11.w].data[14].w;
            if (r19.w != 0) {
              r26.w = dot(lightConstantsCB[r11.w].data[13].xyz, r19.xyz);
          ...
          if (r26.w != 0) {
            ...
            if (r13.z != 0) {
              ...
              r20.xyz = r11.xyz * r13.zzz + r10.xyz;
              r35.xyz = lightConstantsCB[r11.w].data[6].yzw;
              r35.w = lightConstantsCB[r11.w].data[7].x;
              r13.z = dot(r35.xyzw, r20.xyzw);
              r26.w = dot(r34.xyzw, r20.xyzw);
              r27.w = cmp(r26.w >= r13.z);
              if (r27.w != 0) {
                r34.xyz = lightConstantsCB[r11.w].data[4].yzw;
                r34.w = lightConstantsCB[r11.w].data[5].x;
                r34.x = dot(r34.xyzw, r20.xyzw);
                r35.xyz = lightConstantsCB[r11.w].data[5].yzw;
                r35.w = lightConstantsCB[r11.w].data[6].x;
                r34.y = dot(r35.xyzw, r20.xyzw);
                r20.xy = r34.xy / r26.ww;
                r20.xy = saturate(r20.xy * float2(0.5,-0.5) + float2(0.5,0.5));
                r34.x = r20.x * lightConstantsCB[r11.w].data[8].y + lightConstantsCB[r11.w].data[8].z;
                r34.y = r20.y * lightConstantsCB[r11.w].data[8].w + lightConstantsCB[r11.w].data[9].x;
                r13.z = r13.z / r26.w;
                r13.z = max(6.10351563e-05, r13.z);
                r20.x = 0x0000ffff & (int)lightConstantsCB[r11.w].data[1].w;
                if (r7.w != 0) {
                  r35.z = (uint)r20.x;
                  r20.yz = float2(0,0);
                  while (true) {
                    ...
                    r35.xy = r36.xy * lightConstantsCB[r11.w].data[3].yy + r34.xy;
                    r26.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r35.xyz, r13.z).x;
                    r20.y = r26.w * 0.125 + r20.y;
                    r20.z = (int)r20.z + 1;
                  }
                } else {
                  r34.z = (uint)r20.x;
                  r20.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r34.xyz, r13.z).x;
                }
                r13.z = r20.y * r20.y;
                r13.z = r13.z * r20.y;
              } else {
            ...
            r20.x = cmp(0 < r13.z);
            if (r20.x != 0) {
              if (4 == 0) r20.x = 0; else if (4+16 < 32) {               r20.x = (uint)lightConstantsCB[r11.w].data[1].w << (32-(4 + 16)); r20.x = (uint)r20.x >> (32-4);              } else r20.x = (uint)lightConstantsCB[r11.w].data[1].w >> 16;
              ...
              if (r20.z != 0) {
                ...
                r21.xyz = r11.xyz * r20.zzz + r10.xyz;
                ...
                if (r21.x == 0) {
                  ...
                  if (r7.w != 0) {
                    ...
                    while (true) {
                      ...
                      r36.y = dot(icb[r21.z+0].xy, r13.xy);
                ...
                if (4 == 0) r20.x = 0; else if (4+20 < 32) {                 r20.x = (uint)lightConstantsCB[r11.w].data[1].w << (32-(4 + 20)); r20.x = (uint)r20.x >> (32-4);                } else r20.x = (uint)lightConstantsCB[r11.w].data[1].w >> 20;
                r20.z = cmp(0 < (uint)r20.x);
                r20.z = r20.z ? r0.y : 0;
                if (r20.z != 0) {
                  r20.x = (int)r20.x + numLights;
                  r20.x = mad((int)r20.x, 15, -15);
                  r20.z = abs(r16.w) * -0.200000003 + 0.400000006;
                  r22.xyz = r11.xyz * r20.zzz + r10.xyz;
                  r34.xyz = lightConstantsCB[r20.x].data[6].yzw;
                  r34.w = lightConstantsCB[r20.x].data[7].x;
              ...
              r20.x = dot(r11.xyz, r33.xyz);
              r20.z = abs(r20.x) * r0.z + -abs(r20.x);
              r20.x = abs(r20.x) * r20.z + 1;
              r20.z = r17.w * r1.z + r1.w;
              r20.x = r20.x * r20.x;
              r20.x = r20.x * r20.z;
              r20.x = rcp(r20.x);
              r14.w = r17.w * r14.w;
              r14.w = r20.x * r14.w;
              r13.z = r14.w * r13.z;
              r33.xyz = r13.zzz * r19.xyw + r32.xyz;
              r13.w = saturate(1 + -r13.w);
              r14.w = r13.w * r13.w;
              r14.w = r14.w * r14.w;
              r13.w = r14.w * r13.w;
              r13.z = r13.z * r13.w;
              r19.xyw = r13.zzz * r19.xyw + r31.xyz;
        ...
        if (r12.w != 0) {
          ...
          r22.xy = lightConstantsCB[r11.w].data[5].zw;
          r22.z = lightConstantsCB[r11.w].data[6].x;
          r19.xyw = -r22.xyz * float3(0.5,0.5,0.5) + lightConstantsCB[r11.w].data[0].xyz;
          r33.xyz = r19.xyw + -r10.xyz;
          r14.w = dot(r22.xyz, r16.xyz);
          r16.w = dot(r22.xyz, r33.xyz);
          r17.w = dot(r16.xyz, r33.xyz);
          r20.x = -r14.w * r14.w + lightConstantsCB[r11.w].data[6].y;
          r14.w = r14.w * r17.w + -r16.w;
          r16.w = saturate(-r16.w / lightConstantsCB[r11.w].data[6].y);
          r14.w = saturate(r14.w / r20.x);
          r17.w = r20.x / lightConstantsCB[r11.w].data[6].y;
          r17.w = 10 * r17.w;
          r17.w = min(1, r17.w);
          r14.w = r14.w + -r16.w;
          r14.w = r17.w * r14.w + r16.w;
          r33.xyz = r14.www * r22.xyz + r19.xyw;
          r19.xyw = r16.www * r22.xyz + r19.xyw;
          r19.xyw = r13.www ? r19.xyw : lightConstantsCB[r11.w].data[0].xyz;
          r22.xyz = r13.www ? r33.xyz : lightConstantsCB[r11.w].data[0].xyz;
          r22.xyz = r22.xyz + -r10.xyz;
          r19.xyw = r19.xyw + -r10.xyz;
          r13.w = dot(r22.xyz, r22.xyz);
          r13.w = rsqrt(r13.w);
          r33.xyz = r22.xyz * r13.www;
          r14.w = dot(r19.xyw, r19.xyw);
          r16.w = rsqrt(r14.w);
          r19.xyw = r19.xyw * r16.www;
          r16.w = dot(r11.xyz, r19.xyw);
          r17.w = saturate(r16.w);
          r19.x = cmp(0 < r17.w);
          if (r19.x != 0) {
            r19.x = sqrt(r14.w);
            r19.y = lightConstantsCB[r11.w].data[3].x * lightConstantsCB[r11.w].data[3].x;
            r14.w = r19.y / r14.w;
            r14.w = min(1, r14.w);
            r19.xy = saturate(r19.xx * lightConstantsCB[r11.w].data[2].xz + lightConstantsCB[r11.w].data[2].yw);
            ...
            if (r19.x != 0) {
              ...
              if (r12.w != 0) {
                ...
                r19.xyw = r11.xyz * r12.www + r10.xyz;
                r19.xyw = -lightConstantsCB[r11.w].data[4].yzw + r19.xyw;
                r12.w = max(abs(r19.y), abs(r19.w));
                r12.w = max(abs(r19.x), r12.w);
                ...
                r20.z = 0x0000ffff & (int)lightConstantsCB[r11.w].data[1].w;
                r34.w = (uint)r20.z;
                r20.z = 0;
                r21.x = 0;
                while (true) {
                  ...
                  r24.w = gOmniShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r34.xyzw, r12.w).x;
              ...
              if (r14.w != 0) {
                ...
                if (r19.x != 0) {
                  ...
                  r23.xyz = r11.xyz * r19.xxx + r10.xyz;
                  ...
                  if (r19.w == 0) {
                    ...
                    r34.x = lightConstantsCB[r14.w].data[9].w + r23.x;
                    r34.y = lightConstantsCB[r14.w].data[10].x + r23.y;
                    r23.xy = lightConstantsCB[r14.w].data[9].yz * r34.xy;
                    r34.xy = lightConstantsCB[r14.w].data[3].yy / lightConstantsCB[r14.w].data[8].yw;
                    r34.zw = float2(1,1) + -r34.xy;
                    ...
                    if (r20.x == 0) {
                      ...
                      r34.x = r23.x * lightConstantsCB[r14.w].data[8].y + lightConstantsCB[r14.w].data[8].z;
                      r34.y = r23.y * lightConstantsCB[r14.w].data[8].w + lightConstantsCB[r14.w].data[9].x;
                      r21.x = lightConstantsCB[r14.w].data[10].z * r19.y;
                      r19.x = lightConstantsCB[r14.w].data[10].y * r19.y + r19.x;
                      r19.x = r19.x / r21.x;
                    }
                  } else {
                    r20.x = -1;
                  ...
                  if (r19.y == 0) {
                    ...
                    if (r7.w != 0) {
                      ...
                      while (true) {
                        ...
                        r23.xy = r35.xy * lightConstantsCB[r14.w].data[3].yy + r34.xy;
                  ...
                  if (r19.x != 0) {
                    ...
                    r14.w = mad((int)r14.w, 15, -15);
                    r19.x = abs(r16.w) * -0.200000003 + 0.400000006;
                    r25.xyz = r11.xyz * r19.xxx + r10.xyz;
                    r34.xyz = lightConstantsCB[r14.w].data[6].yzw;
                    r34.w = lightConstantsCB[r14.w].data[7].x;
                    ...
                    if (r20.x == 0) {
                      ...
                      r23.xy = r23.xy * float2(0.5,-0.5) + float2(0.5,0.5);
                      r25.x = lightConstantsCB[r14.w].data[9].w + r23.x;
                      r25.y = lightConstantsCB[r14.w].data[10].x + r23.y;
                      r23.xy = lightConstantsCB[r14.w].data[9].yz * r25.xy;
                      ...
                      if (r21.x == 0) {
                        r23.xy = saturate(r23.xy);
                        r25.x = r23.x * lightConstantsCB[r14.w].data[8].y + lightConstantsCB[r14.w].data[8].z;
                        r25.y = r23.y * lightConstantsCB[r14.w].data[8].w + lightConstantsCB[r14.w].data[9].x;
                        r23.x = lightConstantsCB[r14.w].data[10].z * r19.y;
                        r19.x = lightConstantsCB[r14.w].data[10].y * r19.y + r19.x;
                        r19.x = r19.x / r23.x;
                      }
                    } else {
                    ...
                    if (r19.y == 0) {
                      ...
                      if (r7.w != 0) {
                        ...
                        while (true) {
                          ...
                          r23.xy = r34.xy * lightConstantsCB[r14.w].data[3].yy + r25.xy;
                ...
                r14.w = r14.w + -r17.w;
                r14.w = r0.w * r14.w + r17.w;
                r14.w = r14.w * r12.w;
                r23.x = lightConstantsCB[r11.w].data[0].w;
                r23.yz = lightConstantsCB[r11.w].data[1].xy;
                r11.w = cmp(0 < r16.w);
                r25.xyz = r14.www * r23.xyz + r30.xyz;
                r14.w = saturate(dot(r11.xyz, r33.xyz));
                r22.xyz = r22.xyz * r13.www + r12.xyz;
                r13.w = dot(r22.xyz, r22.xyz);
                r13.w = rsqrt(r13.w);
                r22.xyz = r22.xyz * r13.www;
                r13.w = dot(r22.xyz, r12.xyz);
                r16.w = dot(r11.xyz, r22.xyz);
                r17.w = abs(r16.w) * r0.z + -abs(r16.w);
                r16.w = abs(r16.w) * r17.w + 1;
                r17.w = r14.w * r1.z + r1.w;
                r16.w = r16.w * r16.w;
                r16.w = r16.w * r17.w;
                r16.w = rcp(r16.w);
                r13.z = r14.w * r13.z;
                r13.z = r16.w * r13.z;
                r12.w = r13.z * r12.w;
                r22.xyz = r12.www * r23.xyz + r32.xyz;
                r13.z = saturate(1 + -r13.w);
                r13.w = r13.z * r13.z;
                r13.w = r13.w * r13.w;
                r13.z = r13.z * r13.w;
                r12.w = r13.z * r12.w;
                r23.xyz = r12.www * r23.xyz + r31.xyz;
                r30.xyz = r11.www ? r25.xyz : r30.xyz;
                r31.xyz = r11.www ? r23.xyz : r31.xyz;
