// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:28:46 2021
...
void main( 
  ...
  out float p2 : TEXCOORD12,
  out uint o3 : TEXCOORD4,
  out float3 p3 : TEXCOORD9,
...
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r5.xyz, r0.z, l(0), t5.xyzx
r5.x = modelInstanceBuffer[]..swiz;
r5.y = modelInstanceBuffer[]..swiz;
r5.z = modelInstanceBuffer[]..swiz;
  r6.y = r5.x;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r7.xyz, r0.z, l(16), t5.xyzx
r7.x = modelInstanceBuffer[]..swiz;
r7.y = modelInstanceBuffer[]..swiz;
r7.z = modelInstanceBuffer[]..swiz;
  r6.z = r7.x;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r8.xyz, r0.z, l(32), t5.xyzx
...
r8.z = modelInstanceBuffer[]..swiz;
  ...
  p2.x = r0.w * r0.y;
  o3.x = v5.x;
  r6.xyz = v3.xyz * float3(2.00195694,2.00195694,2.00195694) + float3(-1.00195694,-1.00195694,-1.00195694);
  r9.x = dot(r6.xyz, r1.xyz);
  r9.y = dot(r6.xyz, r3.xyz);
  r9.z = dot(r6.xyz, r4.xyz);
  r0.y = dot(r9.xyz, r9.xyz);
  r0.y = rsqrt(r0.y);
  o4.xyz = r9.xyz * r0.yyy;
  r9.xyz = v4.xyz * float3(2.00195694,2.00195694,2.00195694) + float3(-1.00195694,-1.00195694,-1.00195694);
  r10.x = dot(r9.xyz, r1.xyz);
  r10.y = dot(r9.xyz, r3.xyz);
  r10.z = dot(r9.xyz, r4.xyz);
  r0.y = dot(r10.xyz, r10.xyz);
  r0.y = rsqrt(r0.y);
  o5.xyz = r10.xyz * r0.yyy;
  r10.xyz = r9.yzx * r6.zxy;
  r6.xyz = r6.yzx * r9.zxy + -r10.xyz;
  r0.y = v4.w * 2 + -1;
