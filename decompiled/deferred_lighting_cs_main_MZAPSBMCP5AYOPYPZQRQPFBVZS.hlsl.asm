...
if_nz cb2[54].x
  ...
  iadd r5.w, r5.w, l(7)
  ushr r5.w, r5.w, l(3)
  imad r5.w, r0.y, r5.w, r0.x
  bfi r5.w, l(27), l(5), r5.w, l(16)
  ...
  loop 
    ...
    loop 
      breakc_z r39.x
      firstbit_lo r39.y, r39.x
      ishl r39.z, l(1), r39.y
      not r39.z, r39.z
      and r39.x, r39.z, r39.x
      iadd r39.y, r8.w, r39.y
      imul null, r39.y, r39.y, l(14)
      add r40.xyz, r4.xyzx, -cb10[r39.y + 0].xyzx
      dp3 r39.z, r40.xyzx, r40.xyzx
      sqrt r39.z, r39.z
      ge r39.z, cb2[54].y, r39.z
      if_nz r39.z
        mov r27.yzw, cb10[r39.y + 1].xxyz
        mov r27.x, cb10[r39.y + 0].w
        mov r28.yzw, cb10[r39.y + 2].xxyz
        mov r28.x, cb10[r39.y + 1].w
        mov r29.xyz, cb10[r39.y + 3].xyzx
        mov r29.w, cb10[r39.y + 4].z
        mov r30.yz, cb10[r39.y + 4].xxyx
        mov r30.x, cb10[r39.y + 3].w
        mov r30.w, cb10[r39.y + 6].x
        mov r31.yzw, cb10[r39.y + 5].xxyz
        mov r31.x, cb10[r39.y + 4].w
        mov r32.yz, cb10[r39.y + 7].yywy
        mov r32.x, cb10[r39.y + 6].y
        mov r32.w, cb10[r39.y + 8].x
        mov r33.xyz, cb10[r39.y + 8].yzwy
        mov r33.w, cb10[r39.y + 9].x
        mov r34.xyz, cb10[r39.y + 10].yzwy
        mov r34.w, cb10[r39.y + 11].x
        mov r35.xyz, cb10[r39.y + 11].yzwy
        mov r35.w, cb10[r39.y + 12].x
        mov r36.xyz, cb10[r39.y + 0].xyzx
        mov r39.zw, cb10[r39.y + 13].yyyz
        mov r23.w, l(-1)
        mov r25.w, cb10[r39.y + 2].w
        mov r26.w, cb10[r39.y + 5].w
        mov r36.w, cb10[r39.y + 7].z
        mov r37.xyz, cb10[r39.y + 9].yzwy
        mov r37.w, cb10[r39.y + 10].x
        mov r38.xyz, cb10[r39.y + 12].yzwy
        mov r38.w, cb10[r39.y + 13].x
        mov r24.zw, r39.zzzw
        break 
      endif 
    endloop 
...
if_nz r6.w
  ...
  and r5.w, r7.w, l(0x0000ffff)
  ubfe r8.w, l(6), l(25), r7.w
  imul null, r9.w, r5.w, l(6)
  dp3 r12.w, cb11[r9.w + 0].xyzx, r23.xyzx
  add_sat r12.w, r12.w, cb11[r9.w + 0].w
  dp3 r13.w, cb11[r9.w + 1].xyzx, r23.xyzx
  add_sat r13.w, r13.w, cb11[r9.w + 1].w
  mul r12.w, r12.w, r13.w
  dp3 r13.w, cb11[r9.w + 2].xyzx, r23.xyzx
  add_sat r13.w, r13.w, cb11[r9.w + 2].w
  mul r12.w, r12.w, r13.w
  dp3 r13.w, cb11[r9.w + 3].xyzx, r23.xyzx
  add_sat r13.w, r13.w, cb11[r9.w + 3].w
  mul r12.w, r12.w, r13.w
  dp3 r13.w, cb11[r9.w + 4].xyzx, r23.xyzx
  add_sat r13.w, r13.w, cb11[r9.w + 4].w
  mul r12.w, r12.w, r13.w
  dp3 r13.w, cb11[r9.w + 5].xyzx, r23.xyzx
  add_sat r9.w, r13.w, cb11[r9.w + 5].w
  mul r28.x, r9.w, r12.w
  and r9.w, r15.w, l(1)
  mov r28.yz, l(0,0,1.000000,0)
  movc r16.zw, r9.wwww, r28.xxxy, r28.zzzx
  ...
  if_nz r5.w
    ...
    div r9.w, r12.w, r9.w
    min r8.w, r8.w, |r9.w|
    dp3 r9.w, r11.xyzx, r19.xyzx
    dp3 r12.w, r23.xyzx, r19.xyzx
    ...
    dp3 r12.w, r23.xyzx, r20.xyzx
    add r12.w, -r21.w, r12.w
    ge r13.w, r12.w, l(0.000000)
    max r12.w, r2.w, |r12.w|
    movc r12.w, r13.w, r12.w, -r12.w
    max r9.w, -r9.w, l(0.00000010)
    ...
    dp3 r12.w, r23.xyzx, r22.xyzx
    add r12.w, -r24.x, r12.w
    ge r13.w, r12.w, l(0.000000)
    max r12.w, r2.w, |r12.w|
    movc r12.w, r13.w, r12.w, -r12.w
    max r9.w, -r9.w, l(0.00000010)
    ...
    mad r15.xyz, r11.xyzx, r8.wwww, r15.xyzx
    ...
    utof r16.w, r7.w
    sample_l_indexable(texturecubearray)(float,float,float,float) r15.xyz, r16.xyzw, t8.xyzw, s2, r8.w
    ...
    or r7.w, r14.y, r14.x
    or r7.w, r14.z, r7.w
    movc r13.xyz, r7.wwww, l(1.000000,1.000000,0,0), r13.xyzx
    mul r12.xyz, r12.xyzx, r13.xyzx
    dp3 r7.w, r12.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
    mul r8.w, r4.w, r7.w
    mul r12.xyz, r5.wwww, r15.xyzx
    dp3 r5.w, r12.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
    mad r5.w, r4.w, r7.w, r5.w
    div r5.w, r8.w, r5.w
    mul r28.xyz, r5.wwww, r12.xyzx
    mov r5.w, l(257)
  else 
...
if_z r6.w
  ...
  and r8.w, r6.w, l(-32)
  iadd r9.w, r6.w, -r8.w
  and r12.x, cb2[0].y, l(-32)
  iadd r12.y, -r12.x, cb2[0].y
  mov r13.x, l(16)
  ...
  loop 
    ...
    ieq r14.w, r8.w, r12.z
    bfi r15.w, r9.w, l(0), l(0), r12.w
    movc r12.w, r14.w, r15.w, r12.w
    ieq r14.w, r12.x, r12.z
    ubfe r15.w, r12.y, l(0), r12.w
    movc r12.w, r14.w, r15.w, r12.w
    ...
    loop 
      ...
      iadd r15.w, r12.z, r15.w
      imul null, r15.w, r15.w, l(14)
      and r17.w, r22.w, l(255)
      ult r18.w, r17.w, l(32)
      and r18.w, r1.z, r18.w
      if_nz r18.w
        imad r17.w, r17.w, l(20), l(880)
        add r13.yzw, cb1[24].xxyz, cb10[r15.w + 0].xxyz
        store_structured u2.xyzw, cb2[52].x, r17.w, r13.xyzw
      endif 
      iadd r23.w, r22.w, l(1)
      add r13.yzw, r4.xxyz, -cb10[r15.w + 0].xxyz
      and r17.w, l(0x0000ffff), cb10[r15.w + 7].z
      ubfe r18.w, l(6), l(25), cb10[r15.w + 7].z
      imul null, r24.x, r17.w, l(6)
      dp3 r24.y, cb11[r24.x + 0].xyzx, r13.yzwy
      add_sat r24.y, r24.y, cb11[r24.x + 0].w
      dp3 r24.z, cb11[r24.x + 1].xyzx, r13.yzwy
      add_sat r24.z, r24.z, cb11[r24.x + 1].w
      mul r24.y, r24.z, r24.y
      dp3 r24.z, cb11[r24.x + 2].xyzx, r13.yzwy
      add_sat r24.z, r24.z, cb11[r24.x + 2].w
      mul r24.y, r24.z, r24.y
      dp3 r24.z, cb11[r24.x + 3].xyzx, r13.yzwy
      add_sat r24.z, r24.z, cb11[r24.x + 3].w
      mul r24.y, r24.z, r24.y
      dp3 r24.z, cb11[r24.x + 4].xyzx, r13.yzwy
      add_sat r24.z, r24.z, cb11[r24.x + 4].w
      mul r24.y, r24.z, r24.y
      dp3 r24.z, cb11[r24.x + 5].xyzx, r13.yzwy
      add_sat r24.x, r24.z, cb11[r24.x + 5].w
      mul r14.x, r24.x, r24.y
      and r24.x, l(1), cb10[r15.w + 6].x
      movc r24.xy, r24.xxxx, r14.xyxx, r14.zxzz
      mov r14.x, cb10[r15.w + 6].x
      mov r25.xy, r24.xyxx
      mov r24.z, l(1)
      loop 
        ige r24.w, r24.z, r18.w
        breakc_nz r24.w
        iadd r24.w, r17.w, r24.z
        imul null, r24.w, r24.w, l(6)
        dp3 r25.z, cb11[r24.w + 0].xyzx, r13.yzwy
        add_sat r25.z, r25.z, cb11[r24.w + 0].w
        mul r25.z, r25.z, r25.x
        dp3 r25.w, cb11[r24.w + 1].xyzx, r13.yzwy
        add_sat r25.w, r25.w, cb11[r24.w + 1].w
        mul r25.z, r25.w, r25.z
        dp3 r25.w, cb11[r24.w + 2].xyzx, r13.yzwy
        add_sat r25.w, r25.w, cb11[r24.w + 2].w
        mul r25.z, r25.w, r25.z
        dp3 r25.w, cb11[r24.w + 3].xyzx, r13.yzwy
        add_sat r25.w, r25.w, cb11[r24.w + 3].w
        mul r25.z, r25.w, r25.z
        dp3 r25.w, cb11[r24.w + 4].xyzx, r13.yzwy
        add_sat r25.w, r25.w, cb11[r24.w + 4].w
        mul r25.z, r25.w, r25.z
        dp3 r25.w, cb11[r24.w + 5].xyzx, r13.yzwy
        add_sat r24.w, r25.w, cb11[r24.w + 5].w
        mul r25.x, r24.w, r25.z
        ushr r25.w, r14.x, l(2)
        ubfe r26.x, l(1), l(2), r14.x
        and r26.y, r25.w, l(2)
        max r26.z, r25.x, r25.y
        mad r24.w, -r25.z, r24.w, l(1.000000)
        mul r24.w, r24.w, r25.y
        movc r16.y, r26.y, r24.w, r26.z
        movc r25.xy, r26.xxxx, r25.xyxx, r16.xyxx
        iadd r24.z, r24.z, l(1)
        mov r14.x, r25.w
      endloop 
      mov_sat r25.y, r25.y
      mul r14.x, r25.y, cb10[r15.w + 6].y
      lt r16.y, l(0.000000), r14.x
      if_nz r16.y
        and r16.y, r23.w, l(255)
        iadd r17.w, r16.y, l(-1)
        ult r17.w, r17.w, l(32)
        and r17.w, r1.z, r17.w
        if_nz r17.w
          imad r24.xy, r16.yyyy, l(20, 20, 0, 0), l(860, 876, 0, 0)
          ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r16.y, cb2[52].x, r24.x, u2.xxxx
          or r16.y, r16.y, l(32)
          store_structured u2.x, cb2[52].x, r24.x, r16.y
          store_structured u2.x, cb2[52].x, r24.y, r14.x
        endif 
        iadd r22.w, r22.w, l(257)
        mad r22.z, r25.y, cb10[r15.w + 6].y, r22.z
        mul r14.x, r14.x, cb10[r15.w + 7].y
        mov r24.x, cb10[r15.w + 7].w
        mov r24.yz, cb10[r15.w + 8].xxyx
        ...
        mov r24.x, cb10[r15.w + 8].w
        mov r24.yz, cb10[r15.w + 9].xxyx
        dp3 r17.w, r11.xyzx, r24.xyzx
        dp3 r18.w, r13.yzwy, r24.xyzx
        add r18.w, r18.w, -cb10[r15.w + 9].z
        ge r24.x, r18.w, l(0.000000)
        max r18.w, r2.w, |r18.w|
        movc r18.w, r24.x, r18.w, -r18.w
        max r17.w, -r17.w, l(0.00000010)
        div r17.w, r18.w, r17.w
        min r16.y, r16.y, |r17.w|
        mov r24.x, cb10[r15.w + 9].w
        mov r24.yz, cb10[r15.w + 10].xxyx
        dp3 r17.w, r11.xyzx, r24.xyzx
        dp3 r18.w, r13.yzwy, r24.xyzx
        ...
        div r17.w, r18.w, r17.w
        min r16.y, r16.y, |r17.w|
        mov r24.x, cb10[r15.w + 10].w
        mov r24.yz, cb10[r15.w + 11].xxyx
        dp3 r17.w, r11.xyzx, r24.xyzx
        dp3 r18.w, r13.yzwy, r24.xyzx
        ...
        div r17.w, r18.w, r17.w
        min r16.y, r16.y, |r17.w|
        mov r24.x, cb10[r15.w + 11].w
        mov r24.yz, cb10[r15.w + 12].xxyx
        dp3 r17.w, r11.xyzx, r24.xyzx
        dp3 r18.w, r13.yzwy, r24.xyzx
        ...
        div r17.w, r18.w, r17.w
        min r16.y, r16.y, |r17.w|
        mov r24.x, cb10[r15.w + 12].w
        mov r24.yz, cb10[r15.w + 13].xxyx
        dp3 r17.w, r11.xyzx, r24.xyzx
        dp3 r18.w, r13.yzwy, r24.xyzx
        ...
        div r17.w, r18.w, r17.w
        min r16.y, r16.y, |r17.w|
        add r24.x, r13.y, cb10[r15.w + 3].w
        add r24.yz, r13.zzwz, cb10[r15.w + 4].xxyx
        mad r24.xyz, r11.xyzx, r16.yyyy, r24.xyzx
        dp3 r17.w, r24.xyzx, r24.xyzx
        sqrt r17.w, r17.w
        div r16.y, r16.y, r17.w
        add r16.y, r16.y, r16.y
        sqrt r16.y, r16.y
        mad r16.y, r1.w, l(5.000000), r16.y
        ...
        utof r27.w, r17.w
        sample_l_indexable(texturecubearray)(float,float,float,float) r24.xyz, r27.xyzw, t8.xyzw, s2, r16.y
        and r25.xzw, r24.xxyz, l(0x7fffffff, 0, 0x7fffffff, 0x7fffffff)
        ieq r25.xzw, r25.xxzw, l(0x7f800000, 0, 0x7f800000, 0x7f800000)
        or r16.y, r25.z, r25.x
        or r16.y, r25.w, r16.y
        movc r24.xyz, r16.yyyy, l(1.000000,1.000000,0,0), r24.xyzx
        dp3 r31.x, r13.yzwy, r26.xyzx
        dp3 r31.y, r13.yzwy, r29.xyzx
        dp3 r31.z, r13.yzwy, r30.xyzx
        mad_sat r13.yzw, r31.xxyz, cb10[r15.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
        mul r31.xy, r13.yzyy, cb10[r15.w + 4].zwzz
        mul r31.z, r13.w, cb10[r15.w + 5].x
        add r13.yzw, r31.xxyz, cb10[r15.w + 5].yyzw
        ...
        or r15.z, r26.y, r26.x
        or r15.z, r26.z, r15.z
  ...
  loop 
    ...
    ieq r15.w, r8.w, r13.w
    ubfe r16.x, r9.w, l(0), r14.w
    movc r14.w, r15.w, r16.x, r14.w
    ...
    loop 
      ...
      imul null, r16.x, r16.x, l(14)
      and r16.y, r25.z, l(255)
      ult r17.w, r16.y, l(32)
      and r17.w, r1.z, r17.w
      if_nz r17.w
        imad r16.y, r16.y, l(20), l(880)
        add r12.yzw, cb1[24].xxyz, cb10[r16.x + 0].xxyz
        store_structured u2.xyzw, cb2[52].x, r16.y, r12.xyzw
      endif 
      iadd r26.y, r25.z, l(1)
      add r12.yzw, r4.xxyz, -cb10[r16.x + 0].xxyz
      and r16.y, l(0x0000ffff), cb10[r16.x + 7].z
      ubfe r17.w, l(6), l(25), cb10[r16.x + 7].z
      imul null, r18.w, r16.y, l(6)
      dp3 r21.w, cb11[r18.w + 0].xyzx, r12.yzwy
      add_sat r21.w, r21.w, cb11[r18.w + 0].w
      dp3 r22.w, cb11[r18.w + 1].xyzx, r12.yzwy
      add_sat r22.w, r22.w, cb11[r18.w + 1].w
      mul r21.w, r21.w, r22.w
      dp3 r22.w, cb11[r18.w + 2].xyzx, r12.yzwy
      add_sat r22.w, r22.w, cb11[r18.w + 2].w
      mul r21.w, r21.w, r22.w
      dp3 r22.w, cb11[r18.w + 3].xyzx, r12.yzwy
      add_sat r22.w, r22.w, cb11[r18.w + 3].w
      mul r21.w, r21.w, r22.w
      dp3 r22.w, cb11[r18.w + 4].xyzx, r12.yzwy
      add_sat r22.w, r22.w, cb11[r18.w + 4].w
      mul r21.w, r21.w, r22.w
      dp3 r22.w, cb11[r18.w + 5].xyzx, r12.yzwy
      add_sat r18.w, r22.w, cb11[r18.w + 5].w
      mul r13.x, r18.w, r21.w
      and r18.w, l(1), cb10[r16.x + 6].x
      movc r26.zw, r18.wwww, r13.xxxy, r13.zzzx
      mov r13.x, cb10[r16.x + 6].x
      mov r27.xy, r26.zwzz
      mov r18.w, l(1)
      loop 
        ige r21.w, r18.w, r17.w
        breakc_nz r21.w
        iadd r21.w, r16.y, r18.w
        ...
        movc r16.w, r25.w, r21.w, r27.z
        movc r27.xy, r24.wwww, r27.xyxx, r16.zwzz
        iadd r18.w, r18.w, l(1)
        mov r13.x, r23.w
      endloop 
      add_sat r13.x, -r25.y, r27.y
      mul r16.y, r13.x, cb10[r16.x + 6].y
      lt r16.w, l(0.000000), r16.y
      if_nz r16.w
        and r16.w, r26.y, l(255)
        iadd r17.w, r16.w, l(-1)
        ult r17.w, r17.w, l(32)
        and r17.w, r1.z, r17.w
        if_nz r17.w
          imad r26.zw, r16.wwww, l(0, 0, 20, 20), l(0, 0, 860, 876)
          ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r16.w, cb2[52].x, r26.z, u2.xxxx
          or r16.w, r16.w, l(32)
          store_structured u2.x, cb2[52].x, r26.z, r16.w
          store_structured u2.x, cb2[52].x, r26.w, r16.y
        endif 
        iadd r25.z, r25.z, l(257)
        mad r25.x, r13.x, cb10[r16.x + 6].y, r25.x
        mul r13.x, r16.y, cb10[r16.x + 7].y
        mov r29.x, cb10[r16.x + 7].w
        mov r29.yz, cb10[r16.x + 8].xxyx
        dp3 r16.y, r11.xyzx, r29.xyzx
        dp3 r16.w, r12.yzwy, r29.xyzx
        add r16.w, r16.w, -cb10[r16.x + 8].z
        ...
        min r16.y, |r16.y|, l(131072.000000)
        mov r29.x, cb10[r16.x + 8].w
        mov r29.yz, cb10[r16.x + 9].xxyx
        dp3 r16.w, r11.xyzx, r29.xyzx
        dp3 r17.w, r12.yzwy, r29.xyzx
        add r17.w, r17.w, -cb10[r16.x + 9].z
        ge r18.w, r17.w, l(0.000000)
        max r17.w, r2.w, |r17.w|
        movc r17.w, r18.w, r17.w, -r17.w
        max r16.w, -r16.w, l(0.00000010)
        div r16.w, r17.w, r16.w
        min r16.y, |r16.w|, r16.y
        mov r29.x, cb10[r16.x + 9].w
        mov r29.yz, cb10[r16.x + 10].xxyx
        dp3 r16.w, r11.xyzx, r29.xyzx
        dp3 r17.w, r12.yzwy, r29.xyzx
        add r17.w, r17.w, -cb10[r16.x + 10].z
        ge r18.w, r17.w, l(0.000000)
        max r17.w, r2.w, |r17.w|
        movc r17.w, r18.w, r17.w, -r17.w
        max r16.w, -r16.w, l(0.00000010)
        div r16.w, r17.w, r16.w
        min r16.y, |r16.w|, r16.y
        mov r29.x, cb10[r16.x + 10].w
        mov r29.yz, cb10[r16.x + 11].xxyx
        dp3 r16.w, r11.xyzx, r29.xyzx
        dp3 r17.w, r12.yzwy, r29.xyzx
        add r17.w, r17.w, -cb10[r16.x + 11].z
        ge r18.w, r17.w, l(0.000000)
        max r17.w, r2.w, |r17.w|
        movc r17.w, r18.w, r17.w, -r17.w
        max r16.w, -r16.w, l(0.00000010)
        div r16.w, r17.w, r16.w
        min r16.y, |r16.w|, r16.y
        mov r29.x, cb10[r16.x + 11].w
        mov r29.yz, cb10[r16.x + 12].xxyx
        dp3 r16.w, r11.xyzx, r29.xyzx
        dp3 r17.w, r12.yzwy, r29.xyzx
        add r17.w, r17.w, -cb10[r16.x + 12].z
        ge r18.w, r17.w, l(0.000000)
        max r17.w, r2.w, |r17.w|
        movc r17.w, r18.w, r17.w, -r17.w
        max r16.w, -r16.w, l(0.00000010)
        div r16.w, r17.w, r16.w
        min r16.y, |r16.w|, r16.y
        mov r29.x, cb10[r16.x + 12].w
        mov r29.yz, cb10[r16.x + 13].xxyx
        dp3 r16.w, r11.xyzx, r29.xyzx
        dp3 r17.w, r12.yzwy, r29.xyzx
        add r17.w, r17.w, -cb10[r16.x + 13].z
        ge r18.w, r17.w, l(0.000000)
        max r17.w, r2.w, |r17.w|
        movc r17.w, r18.w, r17.w, -r17.w
        max r16.w, -r16.w, l(0.00000010)
        div r16.w, r17.w, r16.w
        min r16.y, |r16.w|, r16.y
        add r29.x, r12.y, cb10[r16.x + 3].w
        add r29.yz, r12.zzwz, cb10[r16.x + 4].xxyx
        mad r27.xzw, r11.xxyz, r16.yyyy, r29.xxyz
        dp3 r16.w, r27.xzwx, r27.xzwx
        sqrt r16.w, r16.w
        ...
        mad r16.y, r1.w, l(5.000000), r16.y
        add r16.y, r16.y, l(-0.844800)
        mov r29.x, cb10[r16.x + 0].w
        mov r29.y, cb10[r16.x + 1].z
        mov r29.z, cb10[r16.x + 2].y
        dp3 r30.x, r27.xzwx, r29.xyzx
        mov r31.xy, cb10[r16.x + 1].xwxx
        mov r31.z, cb10[r16.x + 2].z
        dp3 r30.y, r27.xzwx, r31.xyzx
        mov r32.x, cb10[r16.x + 1].y
        mov r32.yz, cb10[r16.x + 2].xxwx
        dp3 r30.z, r27.xzwx, r32.xyzx
        ubfe r16.w, l(9), l(16), cb10[r16.x + 7].z
        utof r30.w, r16.w
        sample_l_indexable(texturecubearray)(float,float,float,float) r27.xzw, r30.xyzw, t8.xwyz, s2, r16.y
        and r33.xyz, r27.xzwx, l(0x7fffffff, 0x7fffffff, 0x7fffffff, 0)
        ieq r33.xyz, r33.xyzx, l(0x7f800000, 0x7f800000, 0x7f800000, 0)
        or r16.y, r33.y, r33.x
        or r16.y, r33.z, r16.y
        movc r27.xzw, r16.yyyy, l(1.000000,0,1.000000,0), r27.xxzw
        dp3 r33.x, r12.yzwy, r29.xyzx
        dp3 r33.y, r12.yzwy, r31.xyzx
        dp3 r33.z, r12.yzwy, r32.xyzx
        mad_sat r12.yzw, r33.xxyz, cb10[r16.x + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
        mul r33.xy, r12.yzyy, cb10[r16.x + 4].zwzz
        mul r33.z, r12.w, cb10[r16.x + 5].x
        add r12.yzw, r33.xxyz, cb10[r16.x + 5].yyzw
        dp3 r30.x, r10.xyzx, r29.xyzx
        dp3 r30.y, r10.xyzx, r31.xyzx
        dp3 r30.z, r10.xyzx, r32.xyzx
        lt r16.xyw, l(0.000000, 0.000000, 0.000000, 0.000000), r30.xyxz
        movc r14.z, r16.x, l(0), l(0.500000)
        ...
        movc r17.z, r16.w, l(0), l(0.500000)
        ...
        sample_l_indexable(texturecubearray)(float,float,float,float) r16.xyw, r30.xyzw, t8.xywz, s2, l(6.000000)
        and r29.xyz, r16.xywx, l(0x7fffffff, 0x7fffffff, 0x7fffffff, 0)
        ieq r29.xyz, r29.xyzx, l(0x7f800000, 0x7f800000, 0x7f800000, 0)
        or r14.z, r29.y, r29.x
        or r14.z, r29.z, r14.z
        movc r16.xyw, r14.zzzz, l(1.000000,1.000000,0,0), r16.xyxw
        mul r29.xyz, r12.yzwy, r16.xywx
        dp3 r14.z, r29.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
        mad r23.xyz, r12.yzwy, r16.xywx, r23.xyzx
        mul r12.y, r4.w, r14.z
        mul r16.xyw, r13.xxxx, r27.xzxw
        dp3 r12.z, r16.xywx, l(0.212600, 0.715200, 0.072200, 0.000000)
        mad r12.z, r4.w, r14.z, r12.z
        div r12.y, r12.y, r12.z
        mad r24.xyz, r16.xywx, r12.yyyy, r24.xyzx
      else 
        mov r26.x, r25.x
        mov r25.xz, r26.xxyx
      endif 
  ...
  endloop 
  ge r1.w, r20.z, l(1.000000)
  and r2.w, r20.w, l(0x0000ff00)
  bfi r2.w, l(8), l(0), r22.y, r2.w
  movc r5.w, r1.w, r2.w, r22.y
  max r1.w, r22.x, l(1.000000)
  rcp r1.w, r1.w
  mov_sat r22.x, r22.x
  mul r12.xyz, r1.wwww, r18.xyzx
  mul r28.xyz, r1.wwww, r21.xyzx
  lt r2.w, r22.x, l(0.990000)
  if_nz r2.w
    iadd r5.w, r5.w, l(256)
    add r2.w, -r22.x, l(1.000000)
    ...
    mad r12.xyz, r18.xyzx, r1.wwww, r10.xyzx
    mov r11.w, l(0)
    sample_l_indexable(texturecubearray)(float,float,float,float) r10.xyz, r11.xyzw, t8.xyzw, s2, r2.z
    mad r1.w, cb2[19].x, r2.w, -r4.w
    mad r1.w, r2.y, r1.w, r4.w
    mad r28.xyz, r10.xyzx, r1.wwww, r28.xyzx
  endif 
else 
...
mad r3.xyz, r11.xyzx, r6.xyzx, r3.xyzx
...
if_nz r0.z
  ...
  if_nz r0.w
    ...
    movc r5.xy, r0.wwww, r6.xyxx, r5.xyxx
    mul r6.xyz, r5.xxxx, cb2[12].xyzx
    exp r6.xyz, r6.xyzx
    mul r5.xyz, r5.yyyy, cb2[12].xyzx
    exp r5.xyz, r5.xyzx
    add r5.xyz, -r6.xyzx, r5.xyzx
    mad r5.xyz, cb2[13].wwww, r5.xyzx, r6.xyzx
  else 
