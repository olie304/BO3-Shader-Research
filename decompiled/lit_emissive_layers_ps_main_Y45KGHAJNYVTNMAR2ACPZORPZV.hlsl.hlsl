...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
          ...
          r25.w = samp0[]..swiz;
            ...
            r22.w = samp0[]..swiz;
              ...
              if (r21.y != 0) {
                ...
                r23.xyz = r24.xyz * r4.xxx;
                r21.xyz = r21.xyz * r4.xxx;
                r22.xyz = r22.xyz * r4.xxx;
                r18.w = -17 * r12.w;
                r18.w = exp2(r18.w);
                r17.w = r18.w + r17.w;
                r17.w = log2(r17.w);
  ...
  r0.z = r0.w * r0.y + r3.w;
  r7.xyz = r7.xyz * r0.yyy + r16.xyz;
  r0.w = dot(r7.xyz, r7.xyz);
  r0.w = rsqrt(r0.w);
  r7.xyz = r7.xyz * r0.www;
  r9.y = r1.w * r0.y + r5.w;
  r3.xyz = r3.xyz * r0.yyy + r17.xyz;
  ...
  if (r0.w != 0) {
    ...
    r13.y = r13.x;
    r13.z = r4.x;
    r14.x = dot(r13.yz, r8.zw);
    r13.x = -r4.x;
    r14.y = dot(r13.xy, r8.zw);
    r8.zw = gameTime.ww * scrollUVs.xy;
    r8.zw = r8.zw * scaleUVs.xy + r14.xy;
  ...
  if (r1.w != 0) {
    ...
    r15.x = dot(r14.xyz, r5.xyz);
    r15.y = dot(r14.xyz, r6.xyz);
    r1.w = dot(r14.xyz, r4.yzw);
    r2.w = cmp(0 < r1.w);
    r8.zw = -r15.xy / r1.ww;
    r8.zw = r2.ww ? r8.zw : 0;
    r9.zw = float2(-0.5,-0.5) + r1.xy;
    ...
    r8.zw = r8.zw * scaleUVs2.xy + r15.xy;
    ...
    r8.zw = float2(0.5,0.5) + r8.zw;
    r9.zw = saturate(r8.zw);
    r13.x = clampU2 ? r9.z : r8.z;
    r13.y = clampV2 ? r9.w : r8.w;
  }
  ...
  if (r1.w != 0) {
    ...
    r13.x = clampU3 ? r4.x : r1.x;
    r13.y = clampV3 ? r4.y : r1.y;
  }
  r4.xyzw = emissiveMap3.Sample(colorSampler_s, r13.xy).xyzw;
  r1.xyw = emissiveTint3.xyz * r4.xyz;
  r2.w = hdrScale * r4.w;
  r1.xyw = r2.www * r1.xyw;
  r0.w = clampV3 + r0.w;
  r0.w = frac(r0.w);
  r4.y = gameTime.w * clampV3 + r0.w;
  r4.x = clampV3;
  r0.w = flickerLookupMap.SampleLevel(lookupSampler_s, r4.xy, 0).x;
  r0.w = log2(abs(r0.w));
  r0.w = flickerPower3 * r0.w;
  r0.w = exp2(r0.w);
  r2.w = flickerRange3.y + -flickerRange3.x;
  r0.w = r0.w * r2.w + flickerRange3.x;
  r1.xyw = r1.xyw * r0.www;
  r0.w = 1 + -r4.w;
  r1.xyw = r10.xyz * r0.www + r1.xyw;
  ...
  sincos(r2.w, r6.x, r8.x);
  r2.w = dot(r5.xy, float2(0.0671105608,0.00583714992));
  r2.w = frac(r2.w);
  r2.w = 52.9829178 * r2.w;
  r2.w = frac(r2.w);
  r2.w = r2.w * 6.28318548 + gameTick.w;
  sincos(r2.w, r5.x, r10.x);
  r9.x = saturate(dot(r7.xyz, r1.xyw));
  r2.w = dot(-r1.xyw, r7.xyz);
  r2.w = r2.w + r2.w;
  r13.xyz = r7.xyz * -r2.www + -r1.xyw;
  r2.w = 17 * r9.y;
  r2.w = exp2(r2.w);
  r2.w = 2 + r2.w;
  r2.w = 2 / r2.w;
  ...
  if (r9.w != 0) {
    ...
    r12.w = 0;
    while (true) {
      r14.w = cmp((uint)r12.w >= (uint)r6.w);
      if (r14.w != 0) break;
      r14.z = (uint)r12.w >> 5;
      r15.xyz = (int3)r12.xyz + (int3)r14.xyz;
  ...
  if (r5.w != 0) {
    ...
    r6.z = dot(r15.xyz, float3(0.212599993,0.715200007,0.0722000003));
    r10.yzw = r21.xyz * r5.yyy + r15.xyz;
    r13.w = 0;
    r15.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r13.xyzw, r5.z).xyz;
    r5.y = sunConstants.globalProbeExposure * r5.w + -r6.z;
    r5.y = r9.y * r5.y + r6.z;
    r14.xyz = r15.xyz * r5.yyy + r14.xyz;
  }
  r5.y = r9.x + r1.z;
  r5.y = log2(abs(r5.y));
  r5.y = r5.y * r3.w;
  ...
  r9.yzw = r14.xyz * r5.yyy;
  r14.xyz = r9.zwy * r5.zzz;
  r5.yzw = r9.yzw * r5.www;
  r1.z = sqrt(r3.w);
  r1.z = r1.z * 0.5 + 0.5;
  r1.z = r1.z * r1.z;
  r6.z = 0.5 * r1.z;
  ...
  if (r8.w != 0) {
    ...
    if (r8.w != 0) {
      ...
      r11.w = r16.z;
      r15.w = r14.z;
      r15.xyzw = r6.wwww ? r11.xyzw : r15.xyzw;
      r16.zw = r9.yz;
      r14.zw = r5.yz;
      r11.xyzw = r6.wwww ? r16.xyzw : r14.xyzw;
      r5.w = r6.w ? r9.w : r5.w;
      r14.z = r15.w;
      r14.xy = r11.xy;
      r5.yz = r11.zw;
            ...
            if (r27.w != 0) {
              ...
              if (r27.w != 0) {
                ...
                if (r27.w != 0) {
                  ...
                  r15.w = r15.w + -r26.w;
                  r15.w = r3.w * r15.w + r26.w;
                  r15.w = r15.w * r24.w;
                  r32.x = r31.x;
                  r18.x = cmp(0 < r25.w);
                  r19.xyz = r15.www * r32.xyz + r16.xyz;
                  r15.w = saturate(dot(r7.xyz, r39.xyz));
                  r38.xyz = r38.xyz * r14.www + r1.xyw;
                  r14.w = dot(r38.xyz, r38.xyz);
                  r14.w = rsqrt(r14.w);
                  r38.xyz = r38.xyz * r14.www;
                  r14.w = dot(r38.xyz, r1.xyw);
                  r18.z = dot(r7.xyz, r38.xyz);
                  r25.w = abs(r18.z) * r2.w + -abs(r18.z);
                  r18.z = abs(r18.z) * r25.w + 1;
                  r25.w = r15.w * r1.z + r6.z;
                  r18.z = r18.z * r18.z;
                  r18.z = r18.z * r25.w;
                  r18.z = rcp(r18.z);
                  r15.w = r15.w * r27.w;
