...
// gridTexture                       texture  float4          2d             t6      1 
// codeTexture0                      texture  float4          2d             t7      1 
// codeTexture1                      texture  float4          2d             t9      1 
// codeTexture2                      texture  float4          2d            t10      1 
...
ftoi r0.xy, v0.xyxx
mov r0.zw, l(0,0,0,0)
ld_indexable(texture2d)(float,float,float,float) r1.xyz, r0.xyww, t7.xyzw
ld_indexable(texture2d)(float,float,float,float) r1.w, r0.xyww, t0.yzwx
lt r2.x, l(0.900000), r1.w
ld_indexable(texture2d)(float,float,float,float) r2.y, r0.xyww, t10.yxzw
add r3.xyzw, v1.xyxy, l(0.000000, -0.00138889, 0.000000, 0.00138889)
sample_indexable(texture2d)(float,float,float,float) r2.z, r3.xyxx, t10.yzxw, s0
sample_indexable(texture2d)(float,float,float,float) r2.w, r3.zwzz, t10.yzwx, s0
add r3.xyzw, v1.xyxy, l(0.00078125, 0.000000, -0.00078125, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r3.x, r3.xyxx, t10.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r3.y, r3.zwzz, t10.yxzw, s0
add r4.xyzw, v1.xyxy, l(0.00078125, 0.00138889, -0.00078125, -0.00138889)
sample_indexable(texture2d)(float,float,float,float) r3.z, r4.xyxx, t10.yzxw, s0
sample_indexable(texture2d)(float,float,float,float) r3.w, r4.zwzz, t10.yzwx, s0
add r4.xyzw, v1.xyxy, l(0.00078125, -0.00138889, -0.00078125, 0.00138889)
sample_indexable(texture2d)(float,float,float,float) r4.x, r4.xyxx, t10.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r4.y, r4.zwzz, t10.yxzw, s0
max r4.z, r2.y, l(0.00000001)
div r4.z, cb1[41].x, r4.z
add r5.xy, v1.xyxx, l(-0.500000, -0.500000, 0.000000, 0.000000)
mul r4.w, r4.z, r5.x
mul r4.w, r4.w, cb8[15].z
mul r5.x, r4.z, -r5.y
mul r5.x, r5.x, cb8[15].w
mul r5.xyz, r5.xxxx, cb8[1].xyzx
mad r5.xyz, r4.wwww, cb8[0].xyzx, r5.xyzx
mad r5.xyz, r4.zzzz, cb8[2].xyzx, r5.xyzx
add r5.xyz, r5.xyzx, cb8[3].xyzx
mul r4.zw, cb1[69].wwww, l(0.000000, 0.000000, 0.200000, 0.300000)
mad r4.zw, r5.xxxy, l(0.000000, 0.000000, 0.025000, 0.025000), r4.zzzw
sample_indexable(texture2d)(float,float,float,float) r6.xyzw, r4.zwzz, t6.xyzw, s2
if_nz r2.x
  mov o0.xyz, r1.xyzx
  mov o0.w, l(1.000000)
  ret 
endif 
eq r2.x, r2.y, l(0.000000)
if_nz r2.x
  mov o0.xyz, r1.xyzx
  mov o0.w, l(1.000000)
  ret 
endif 
ld_indexable(texture2d)(float,float,float,float) r0.xyzw, r0.xyzw, t9.xyzw
max r0.y, r0.z, r0.y
max r0.x, r0.y, r0.x
max r0.x, r0.w, r0.x
...
add r0.y, r2.w, r2.z
add r0.xz, r3.yywy, r3.xxzx
add r0.w, r4.y, r4.x
mad r0.xyzw, r2.yyyy, l(2.000000, 2.000000, 2.000000, 2.000000), -r0.xyzw
mul r0.xyzw, |r0.xyzw|, l(1000.000000, 1000.000000, 1000.000000, 1000.000000)
div r0.xyzw, r0.xyzw, r2.yyyy
max r0.x, r0.y, r0.x
max r0.x, r0.z, r0.x
max r0.x, r0.w, r0.x
...
mul r0.yzw, r1.xxyz, l(0.000000, 0.00003052, 0.00003052, 0.00003052)
mul r1.x, cb1[69].w, l(20.000000)
frc r1.x, r1.x
mad r1.x, cb1[69].w, l(20.000000), -r1.x
mul r3.z, r1.x, l(0.050000)
mov r3.w, v1.y
dp2 r1.x, r3.zwzz, l(37.349838, 59.394840, 0.000000, 0.000000)
frc r3.x, r1.x
dp3 r1.x, r3.xzwx, l(81.239487, 37.349838, 59.394840, 0.000000)
frc r3.y, r1.x
dp4 r1.x, r3.xyzw, l(81.239487, 17.348024, 37.349838, 59.394840)
frc r3.z, r1.x
dp4 r1.x, r3.xyzw, l(81.239487, 17.348024, 37.349838, 59.394840)
frc r3.w, r1.x
dp4 r1.x, r3.xyzw, l(81.239487, 17.348024, 37.349838, 59.394840)
...
lt r1.y, cb8[15].x, l(2.000000)
if_nz r1.y
  add r1.yz, -r2.zzyz, r2.yywy
  max r1.y, r1.z, r1.y
  add r1.z, -r1.w, r2.y
  add r1.z, r1.z, l(0.000001)
  mul r1.w, r5.z, l(0.002500)
  frc r1.w, r1.w
  lt r2.xy, r5.zzzz, l(-400.000000, -100.000000, 0.000000, 0.000000)
  ...
  mad r2.xzw, r1.xxxx, r1.wwww, r0.yyzw
  movc r2.xzw, r1.zzzz, r2.xxzw, r0.yyzw
  eq r1.z, r1.w, l(0.000000)
  movc r1.w, r2.y, l(0), l(1.000000)
  lt r2.y, r1.y, l(0.000000)
  movc r1.y, r2.y, l(0), r1.y
  lt r2.y, r1.y, l(0.000010)
  mul r1.y, r1.w, r1.y
  mul r1.y, r1.y, l(100000.000000)
  movc r1.y, r2.y, r1.y, r1.w
  dp2 r1.y, r1.yyyy, r1.xxxx
  mul r3.xyz, r6.xyzx, r1.yyyy
  mad r3.xyz, r3.xyzx, r6.wwww, r2.xzwx
  movc r1.yzw, r1.zzzz, r3.xxyz, r2.xxzw
else 
  mad r0.yzw, r1.xxxx, r0.xxxx, r0.yyzw
  eq r0.x, r0.x, l(0.000000)
  add r1.x, r1.x, r1.x
  mul r2.xyz, r6.xyzx, r1.xxxx
  mad r2.xyz, r2.xyzx, r6.wwww, r0.yzwy
  movc r1.yzw, r0.xxxx, r2.xxyz, r0.yyzw
endif 
mul o0.xyz, r1.yzwy, l(32768.000000, 32768.000000, 32768.000000, 0.000000)
mov o0.w, l(1.000000)
ret 
