...
Texture2DArray<float> codeTexture0 : register(t0);
...
// unknown dcl_: dcl_thread_group 8, 8, 1
  ...
  r0.z = (uint)vThreadID.z;
  r0.xyzw = codeTexture0.Gather(LinearSampler_s, r0.xyz).xyzw;
  r1.x = (uint)vThreadIDInGroup.x << 1;
  r1.x = mad((int)vThreadIDInGroup.y, 32, (int)r1.x);
  codeTexture0[r1.x].0 = g0.x;
  r0.w = (int)r1.x + 1;
  codeTexture0[r0.w].0 = g0.x;
  r0.zw = (int2)r1.xx + int2(16,17);
  codeTexture0[r0.z].0 = g0.x;
  codeTexture0[r0.w].0 = g0.x;
  GroupMemoryBarrierWithGroupSync();
  r0.x = mad((int)vThreadIDInGroup.y, 16, (int)vThreadIDInGroup.x);
  r1.xyzw = (int4)r0.xxxx + int4(64,68,70,66);
...
r1.x = LinearSampler[]..swiz;
  ...
  r0.y = r2.z + r0.y;
  r3.xyzw = (int4)r0.xxxx + int4(100,36,72,132);
// Known bad code for instruction (needs manual fix):
...
r2.w = LinearSampler[]..swiz;
  ...
  r0.z = r2.x + r0.z;
  r0.y = r0.y + r0.z;
  r4.xyzw = (int4)r0.xxxx + int4(4,83,53,85);
// Known bad code for instruction (needs manual fix):
...
r3.x = LinearSampler[]..swiz;
  ...
  r0.z = r0.w + r0.z;
  r4.xyzw = (int4)r0.xxxx + int4(51,98,38,102);
// Known bad code for instruction (needs manual fix):
...
r2.x = LinearSampler[]..swiz;
  ...
  r0.z = saturate(max(r1.w, r0.z));
  r0.z = r0.w + r0.z;
  r3.xyzw = (int4)r0.xxxx + int4(34,113,23,119);
// Known bad code for instruction (needs manual fix):
...
r1.w = LinearSampler[]..swiz;
  ...
  r0.z = r0.w + r0.z;
  r3.xyzw = (int4)r0.xxxx + int4(17,117,19,115);
// Known bad code for instruction (needs manual fix):
ld_structured r0.w, r3.x, l(0), g0.xxxx
r0.w = LinearSampler[]..swiz;
  r0.w = r0.w * r1.y + -r2.w;
...
r1.y = LinearSampler[]..swiz;
  ...
  r0.z = saturate(max(r1.x, r0.z));
  r0.z = r0.w + r0.z;
  r3.xyzw = (int4)r0.xxxx + int4(21,87,49,81);
  r0.x = (int)r0.x + 55;
// Known bad code for instruction (needs manual fix):
...
r1.w = LinearSampler[]..swiz;
  ...
  r2.x = (int)vThreadID.z & 3;
  r2.yzw = (uint3)vThreadID.zzz >> int3(2,2,2);
