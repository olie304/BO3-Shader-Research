...
sample_indexable(texture2d)(float,float,float,float) r4.xyzw, v2.xyxx, t17.xyzw, s5
lt r2.y, l(0.000000), r4.x
mul r2.zw, v2.xxxy, cb0[7].xxxy
sample_indexable(texture2d)(float,float,float,float) r5.xyz, r2.zwzz, t12.xyzw, s3
mul r2.zw, v2.xxxy, cb0[6].xxxy
sample_indexable(texture2d)(float,float,float,float) r6.xyz, r2.zwzz, t14.xyzw, s3
mul r2.zw, v2.xxxy, cb0[5].xxxy
sample_indexable(texture2d)(float,float,float,float) r7.xyz, r2.zwzz, t15.xyzw, s3
mul r2.zw, v2.xxxy, cb0[4].xxxy
sample_indexable(texture2d)(float,float,float,float) r8.xyz, r2.zwzz, t16.xyzw, s3
if_nz r2.y
