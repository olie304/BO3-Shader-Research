...
mul r1.x, r0.z, cb1[12].x
mul r1.y, r0.w, cb1[13].y
mov r1.z, l(1.000000)
mul r0.xzw, r0.xxxx, r1.xxyz
mul r1.xyz, r0.zzzz, cb1[17].xyzx
mad r1.xyz, r0.xxxx, cb1[16].xyzx, r1.xyzx
mad r0.xzw, r0.wwww, cb1[18].xxyz, r1.xxyz
add r0.xzw, r0.xxzw, cb1[24].xxyz
mul r1.xyz, r0.zzzz, v2.xyzx
mad r1.xyz, r0.xxxx, v1.xyzx, r1.xyzx
mad r0.xzw, r0.wwww, v3.xxyz, r1.xxyz
add r0.xzw, r0.xxzw, v4.xxyz
...
if_nz r0.w
  ...
  mad r2.xyzw, r0.zzzz, r1.xyzw, r2.xyzw
endif 
log r1.xyz, |r2.xyzx|
