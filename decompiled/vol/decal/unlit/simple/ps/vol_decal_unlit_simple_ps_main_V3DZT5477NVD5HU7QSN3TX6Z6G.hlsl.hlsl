  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.x = min(r0.x, r1.z);
  r0.w = v8.w * r0.x;
  r1.xyzw = r0.yzyz * float4(0.5,-0.5,0.5,-0.5) + float4(0.5,0.5,0.5,0.5);
  ...
  if (r2.y == 0) r2.z = 0; else if (r2.y+0 < 32) {   r2.z = (uint)r0.y << (32-(r2.y + 0)); r2.z = (uint)r2.z >> (32-r2.y);  } else r2.z = (uint)r0.y >> 0;
  if (r2.w == 0) r0.y = 0; else if (r2.w+r2.y < 32) {   r0.y = (uint)r0.y << (32-(r2.w + r2.y)); r0.y = (uint)r0.y >> (32-r2.w);  } else r0.y = (uint)r0.y >> r2.y;
