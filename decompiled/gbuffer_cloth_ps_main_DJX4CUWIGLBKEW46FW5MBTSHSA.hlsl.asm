...
sample_indexable(texture2d)(float,float,float,float) r1.y, v2.xyxx, t6.yxzw, s2
...
sample_indexable(texture2d)(float,float,float,float) r1.y, v2.xyxx, t10.yxzw, s4
sample_indexable(texture2d)(float,float,float,float) r1.z, v2.xyxx, t9.yzxw, s2
...
sample_indexable(texture2d)(float,float,float,float) r0.w, v2.xyxx, t12.yzwx, s5
