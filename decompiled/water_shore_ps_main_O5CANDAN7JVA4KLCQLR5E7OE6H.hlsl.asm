...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:44:08 2021
//
//
// Buffer Definitions: 
//
...
mov r2.zw, l(0,0,0,0)
loop 
  uge r3.w, r2.w, cb2[0].y
  breakc_nz r3.w
  ushr r10.z, r2.w, l(5)
  iadd r11.xyz, r9.xyzx, r10.xyzx
  ld_indexable(texture2darray)(uint,uint,uint,uint) r3.w, r11.xyzw, t7.yzwx
  ...
  dp3 r10.w, r33.xyzx, r11.xyzx
  add_sat r10.w, r33.w, r10.w
  mul r10.z, r10.w, r10.z
  dp3 r10.w, r34.xyzx, r11.xyzx
  add_sat r10.w, r34.w, r10.w
  mul r10.z, r10.w, r10.z
  dp3 r10.w, r35.xyzx, r11.xyzx
  add_sat r10.w, r35.w, r10.w
  mul r10.z, r10.w, r10.z
  dp3 r10.w, r36.xyzx, r11.xyzx
  add_sat r10.w, r36.w, r10.w
  mul r10.z, r10.w, r10.z
  dp3 r10.w, r37.xyzx, r11.xyzx
  add_sat r10.w, r37.w, r10.w
  mul r12.x, r10.w, r10.z
  and r10.z, r7.y, l(1)
  movc r10.zw, r10.zzzz, r12.xxxy, r12.zzzx
  mov r32.xy, r25.zwzz
  mov r32.z, r26.z
  ...
  sqrt r12.x, r12.x
  mad r12.x, r6.y, l(5.000000), r12.x
  ...
  ubfe r16.zw, l(0, 0, 6, 9), l(0, 0, 25, 16), r25.yyyy
  utof r27.w, r16.w
  sample_l_indexable(texturecubearray)(float,float,float,float) r20.xyz, r27.xyzw, t8.xyzw, s2, r12.x
  ...
  movc r20.xyz, r12.xxxx, l(1.000000,1.000000,0,0), r20.xyzx
  ...
  dp3 r27.x, r0.xyzx, r19.xyzx
  dp3 r27.y, r0.xyzx, r28.xyzx
  dp3 r27.z, r0.xyzx, r21.xyzx
  ...
  loop 
    ...
    if_nz r13.w
      ...
      if_nz r7.w
        ...
        mov r13.w, l(1)
        loop 
          ige r14.z, r13.w, r16.z
          breakc_nz r14.z
          iadd r14.z, r9.w, r13.w
          ...
          movc r16.y, r16.w, r14.z, r19.z
          movc r27.xy, r15.wwww, r27.xyxx, r16.xyxx
          iadd r13.w, r13.w, l(1)
          mov r13.z, r15.z
        endloop 
        mov_sat r27.y, r27.y
        mul r13.z, r7.z, r27.y
        lt r13.w, l(0.000000), r13.z
        if_nz r13.w
          mad r28.z, r27.y, r7.z, r25.w
...
if_z r2.z
      ...
      if_nz r11.z
        ...
        if_nz r11.y
          ...
          if_nz r12.x
            ...
            mad r22.z, r26.y, r11.z, r22.z
            mul r11.x, r24.z, r11.y
            mov r24.z, r32.z
            dp3 r11.y, r8.xyzx, r24.xyzx
            ...
            min r11.y, |r11.z|, r11.y
            mov r34.z, r35.z
            dp3 r11.z, r8.xyzx, r34.xyzx
            dp3 r12.x, r25.xyzx, r34.xyzx
            ...
            min r11.y, |r11.z|, r11.y
            mov r35.z, r36.x
            dp3 r11.z, r8.xyzx, r35.xyzx
            dp3 r12.x, r25.xyzx, r35.xyzx
            ...
            min r11.y, |r11.z|, r11.y
            mov r37.zw, r36.zzzw
            dp3 r11.z, r8.zxyz, r37.xzwx
            dp3 r12.x, r25.zxyz, r37.xzwx
            ...
            utof r32.w, r11.z
            sample_l_indexable(texturecubearray)(float,float,float,float) r14.yzw, r32.xyzw, t8.wxyz, s2, r11.y
            and r26.xzw, r14.yyzw, l(0x7fffffff, 0, 0x7fffffff, 0x7fffffff)
            ieq r26.xzw, r26.xxzw, l(0x7f800000, 0, 0x7f800000, 0x7f800000)
            or r11.y, r26.z, r26.x
            or r11.y, r26.w, r11.y
            movc r14.yzw, r11.yyyy, l(0,1.000000,1.000000,0), r14.yyzw
            ...
            dp3 r32.x, r0.xyzx, r23.xyzx
            dp3 r32.y, r0.xyzx, r24.xyzx
            ...
            mad r23.xyz, r24.xyzx, r26.wwww, r23.xywx
            ...
            or r11.y, r25.y, r25.x
            or r11.y, r25.z, r11.y
            movc r24.xyz, r11.yyyy, l(1.000000,1.000000,0,0), r24.xyzx
            ...
            mov r23.x, r21.w
            mov r23.yz, r22.xxyx
            mad r22.xyw, r14.zwzy, r11.xxxx, r23.yzyx
            mov r21.w, r22.w
          endif 
        endif 
      endif 
      ...
      loop 
        ...
        if_nz r14.z
          ...
          if_nz r13.w
            ...
            mul r12.x, r16.w, r18.w
            and r16.w, r14.z, l(1)
            movc r27.xy, r16.wwww, r12.xyxx, r12.zxzz
            mov r12.x, r14.z
            mov r28.xy, r27.xyxx
            mov r16.w, l(1)
            loop 
              ...
              mul r18.w, r18.w, r23.w
              dp3 r23.w, r34.xyzx, r26.xyzx
              add_sat r23.w, r34.w, r23.w
              mul r28.x, r18.w, r23.w
              ...
              movc r14.y, r27.z, r18.w, r27.w
              movc r28.xy, r26.wwww, r28.xyxx, r14.xyxx
              iadd r16.w, r16.w, l(1)
              mov r12.x, r24.w
            endloop 
            add_sat r12.x, -r11.y, r28.y
            ...
            if_nz r14.y
              ...
              utof r33.w, r13.w
              sample_l_indexable(texturecubearray)(float,float,float,float) r14.yzw, r33.xyzw, t8.wxyz, s2, r12.w
              and r27.xyz, r14.yzwy, l(0x7fffffff, 0x7fffffff, 0x7fffffff, 0)
              ...
              movc r16.z, r24.z, l(0), l(0.500000)
              ...
              movc r25.xyz, r12.wwww, l(1.000000,1.000000,0,0), r25.xyzx
  ...
  mul r18.xyz, r2.zzzz, r20.xyzx
  lt r2.w, r20.w, l(0.990000)
  if_nz r2.w
    add r2.w, -r20.w, l(1.000000)
    mul r3.w, r2.w, cb2[19].x
    add r7.yzw, v6.xxyz, -cb2[35].xxyz
    mul r9.x, r7.y, cb2[35].w
    mul r9.yz, r7.zzwz, cb2[36].xxyx
    add_sat r7.yzw, r9.xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
    mul r9.xy, r7.yzyy, cb2[36].zwzz
    mul r9.z, r7.w, cb2[37].x
    add r7.yzw, r9.xxyz, cb2[37].yyzw
    lt r9.xyz, l(0.000000, 0.000000, 0.000000, 0.000000), r0.xyzx
    movc r9.xyz, r9.xyzx, l(0,0,0,0), l(0.500000,0.500000,0.500000,0)
    mov r9.w, l(0)
    add r10.xyz, r7.yzwy, r9.wwxw
    sample_l_indexable(texture3d)(float,float,float,float) r10.xyz, r10.xyzx, t17.xyzw, s4, l(0.000000)
    mul r11.xyz, r0.xyzx, r0.xyzx
    mul r11.xyz, r3.wwww, r11.xyzx
    add r12.xyz, r7.yzwy, r9.wwyw
    ...
    mad r10.xyz, r10.xyzx, r11.xxxx, r12.xyzx
    add r7.yzw, r7.yyzw, r9.wwwz
    sample_l_indexable(texture3d)(float,float,float,float) r7.yzw, r7.yzwy, t19.wxyz, s4, l(0.000000)
    mad r7.yzw, r7.yyzw, r11.zzzz, r10.xxyz
    mov r0.w, l(0)
    sample_l_indexable(texturecubearray)(float,float,float,float) r9.xyz, r0.xyzw, t8.xyzw, s2, l(6.000000)
    mul r7.yzw, r7.yyzw, r9.xxyz
    dp3 r0.w, r7.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
    mad r17.xyz, r19.xyzx, r2.zzzz, r7.yzwy
    mov r8.w, l(0)
    ...
    mad r18.xyz, r6.yzwy, r0.wwww, r18.xyzx
  endif 
else 
  mov r18.x, r17.w
endif 
mul r2.xzw, r18.xxyz, cb0[20].yyyy
dp3 r0.w, r0.xyzx, cb2[17].xyzx
ge r3.w, l(0.000000), |r0.w|
if_nz r3.w
  mov r5.w, l(0)
endif 
if_z r3.w
  mul r6.yzw, v6.yyyy, cb2[29].xxyz
  mad r6.yzw, v6.xxxx, cb2[28].xxyz, r6.yyzw
  mad r6.yzw, v6.zzzz, cb2[30].xxyz, r6.yyzw
  add r6.yzw, r6.yyzw, cb2[31].xxyz
  add r3.w, r6.w, -cb2[17].w
  ...
  if_nz r7.y
    mov r7.yz, l(0,0,0,0)
    loop 
      ge r7.w, r7.y, l(3.000000)
      breakc_nz r7.w
      ftou r7.w, r7.y
      add r8.xy, r6.yzyy, -cb2[r7.w + 20].xyxx
      max r8.x, |r8.y|, |r8.x|
      mul r7.z, r8.x, cb2[r7.w + 20].z
    ...
    mov r7.yz, l(0,3.000000,0,0)
  endif 
  ge r7.w, r7.y, l(3.000000)
  if_nz r7.w
    mul r8.xyz, l(128.000000, 0.500000, 0.500000, 0.000000), cb2[27].zxyz
    rcp r9.xz, r8.xxxx
    mov r9.y, -r9.z
    mad r8.xyz, r6.yzyy, r9.xyzx, r8.yzyy
    ...
    min r8.xyz, r9.xyzx, r8.xyzx
    mul r9.xy, r8.zyzz, cb2[32].xxxx
    round_ni r9.xy, r9.xyxx
    mul r8.w, r9.y, cb2[27].x
    mad r8.w, r8.w, cb2[32].x, r9.x
    ftou r8.w, r8.w
    ...
    if_z r9.y
      ...
      mov r10.y, l(0)
      mov r11.y, l(1)
      movc r9.xyw, r8.wwww, r10.xyxz, r11.xyxz
      movc r11.yz, r8.wwww, l(0,6,1,0), l(0,5,2,0)
      ushr r12.xy, r8.zyzz, r11.yyyy
      and r12.xy, r12.xyxx, l(1, 1, 0, 0)
      and r10.w, r9.w, l(0xc0000000)
      iadd r11.y, r9.x, l(1)
      ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r11.y, r11.y, l(0), t23.xxxx
      movc r11.y, r12.y, r9.w, r11.y
      ushr r12.y, r11.y, l(13)
      movc r11.y, r12.x, r12.y, r11.y
      and r11.y, r11.y, l(8191)
      iadd r11.x, r9.x, r11.y
      ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r11.w, r11.x, l(0), t23.xxxx
      movc r9.xyw, r10.wwww, r9.xyxw, r11.xzxw
      movc r9.xyw, r8.wwww, r10.xyxz, r9.xyxw
      and r8.w, r9.w, l(0xc0000000)
      if_z r8.w
        iadd r8.w, -r9.y, l(6)
        ushr r10.xy, r8.zyzz, r8.wwww
        or r8.w, r9.w, l(0x40000000)
        bfi r10.y, l(1), l(1), r10.y, l(0)
        bfi r10.x, l(1), l(0), r10.x, r10.y
        imul null, r10.x, r10.x, l(10)
        ushr r8.w, r8.w, r10.x
        and r8.w, r8.w, l(1023)
        iadd r10.x, r8.w, r9.x
        ...
        iadd r8.w, -r10.y, l(6)
        ushr r11.xy, r8.zyzz, r8.wwww
        and r8.w, r10.w, l(0xc0000000)
        or r9.y, r10.w, l(0x40000000)
        bfi r11.y, l(1), l(1), r11.y, l(0)
        bfi r11.x, l(1), l(0), r11.x, r11.y
        imul null, r11.x, r11.x, l(10)
        ushr r9.y, r9.y, r11.x
        and r9.y, r9.y, l(1023)
        iadd r11.x, r9.y, r10.x
        ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r11.z, r11.x, l(0), t23.xxxx
        mov r11.y, r10.z
        movc r11.xyz, r8.wwww, r10.xywx, r11.xyzx
        iadd r9.y, -r11.y, l(6)
        ushr r10.yz, r8.zzyz, r9.yyyy
        and r9.y, r11.z, l(0xc0000000)
        or r11.y, r11.z, l(0x40000000)
        bfi r10.z, l(1), l(1), r10.z, l(0)
        bfi r10.y, l(1), l(0), r10.y, r10.z
        imul null, r10.y, r10.y, l(10)
        ushr r10.y, r11.y, r10.y
        ...
        movc r10.yz, r9.yyyy, r11.xxzx, r12.xxyx
        movc r9.xw, r8.wwww, r10.xxxw, r10.yyyz
      endif 
      and r8.w, r9.w, l(0xc0000000)
      if_z r8.w
        ubfe r9.y, l(14), l(15), r9.w
        utof r9.y, r9.y
        mul r9.y, r9.y, cb2[27].w
        mul r9.y, r9.y, l(0.00006104)
        and r10.xy, r9.wwww, l(0x00007fff, 0x20000000, 0, 0)
        utof r10.x, r10.x
        mul r10.x, r10.x, cb2[27].w
        mul r10.x, r10.x, l(0.00003052)
        and r10.z, r8.y, l(3)
        iadd r10.z, r9.x, r10.z
        iadd r10.z, r10.z, l(1)
        ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r10.z, r10.z, l(0), t23.xxxx
        bfi r11.xyz, l(2, 2, 1, 0), l(3, 1, 4, 0), r8.xyzx, l(0, 0, 0, 0)
        ushr r8.x, r10.z, r11.x
        and r8.x, r8.x, l(255)
        utof r8.x, r8.x
        mul r8.x, r10.x, r8.x
        mad r8.x, r8.x, l(0.00392157), r9.y
        iadd r8.y, r11.y, l(1)
        ubfe r8.z, l(1), l(1), r8.z
        iadd r8.y, r8.z, r8.y
        iadd r8.y, r8.y, r9.x
        ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r8.y, r8.y, l(0), t23.xxxx
        ushr r8.y, r8.y, r11.z
        and r8.y, r8.y, l(0x0000ffff)
        utof r8.y, r8.y
        mul r8.y, r10.x, r8.y
        mad r8.y, r8.y, l(0.00001526), r9.y
        movc r9.z, r10.y, r8.x, r8.y
      else 
        and r8.x, r9.w, l(0x80000000)
        iadd r8.y, r9.x, l(1)
        ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r8.y, r8.y, l(0), t23.xxxx
        movc r8.x, r8.x, r8.y, l(0)
        ishl r8.y, r9.w, l(2)
        ushr r8.z, r8.x, l(16)
        and r8.x, r8.x, l(0x0000ffff)
        f16tof32 r8.xz, r8.xxzx
        mad r8.y, r6.y, r8.z, r8.y
        mad r8.x, r6.z, r8.x, r8.y
        movc r9.z, r8.w, r8.x, r9.z
      endif 
    endif 
  ...
  if_z r7.w
    if_z cb2[58].y
      ftou r6.w, r7.y
      add r8.xy, r6.yzyy, -cb2[r6.w + 20].xyxx
      mul r8.xy, r8.xyxx, cb2[r6.w + 20].zzzz
      mad r8.xy, r8.xyxx, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
      itof r6.w, cb2[26].y
      add r8.z, r6.w, r7.y
      sample_c_lz_indexable(texture2darray)(float,float,float,float) r6.w, r8.xyzx, t13.xxxx, s13, r3.w
    ...
    if_nz cb2[58].y
      ...
      ftou r7.yz, r7.yyzy
      add r9.xy, r6.yzyy, -cb2[r6.w + 20].xyxx
      ...
      add r6.yz, r6.yyzy, -cb2[r7.y + 20].xxyx
      mul r6.yz, r6.yyzy, cb2[r7.y + 20].zzzz
      ...
      loop 
        ...
        breakc_nz r9.z
        ult r9.z, r7.z, r8.w
        movc r10.xy, r9.zzzz, r6.yzyy, r9.xyxx
        movc r9.w, r9.z, cb2[r7.y + 20].w, cb2[r6.w + 20].w
        movc r9.z, r9.z, r7.y, r6.w
        dp2 r11.x, icb[r8.w + 0].yxyy, r8.xyxx
        dp2 r11.y, icb[r8.w + 0].yxyy, r8.yzyy
        mad r10.xy, r11.xyxx, r9.wwww, r10.xyxx
        iadd r9.z, r9.z, cb2[26].y
        utof r10.z, r9.z
        sample_c_lz_indexable(texture2darray)(float,float,float,float) r9.z, r10.xyzx, t13.xxxx, s13, r3.w
...
if_nz r3.w
  ...
  mad r6.z, |r0.w|, l(-0.200000), l(0.400000)
  lt r6.w, r0.w, l(0.000000)
  movc r6.z, r6.w, -r6.z, r6.z
  mad r12.xyz, r0.xyzx, r6.zzzz, v6.xyzx
  mov r12.w, l(1.000000)
  dp4 r8.x, r8.xyzw, r12.xyzw
  dp4 r8.y, r9.xyzw, r12.xyzw
  mad r6.zw, r8.xxxy, l(0.000000, 0.000000, 0.500000, -0.500000), l(0.000000, 0.000000, 0.500000, 0.500000)
  add r6.zw, r11.zzzw, r6.zzzw
  mul r6.zw, r11.xxxy, r6.zzzw
  div r7.yz, r6.yyyy, r10.xxzx
  add r8.xy, -r7.yzyy, l(1.000000, 1.000000, 0.000000, 0.000000)
  ge r8.xy, r6.zwzz, r8.xyxx
  ge r7.yz, r7.yyzy, r6.zzwz
  or r7.yz, r7.yyzy, r8.xxyx
  or r7.y, r7.z, r7.y
  if_z r7.y
    ...
    dp4 r3.w, r8.xyzw, r12.xyzw
    mov_sat r6.zw, r6.zzzw
    mad r8.xy, r6.zwzz, r10.xzxx, r10.ywyy
    add r3.w, r7.z, r3.w
    div r3.w, r3.w, r7.w
    max r3.w, r3.w, l(0.00006104)
    and r6.z, r7.y, l(0x0000ffff)
    if_nz cb2[58].y
      mov r9.x, -r6.x
      utof r10.z, r6.z
      mov r9.y, r7.x
      ...
      loop 
        ige r7.x, r6.w, l(8)
        breakc_nz r7.x
        dp2 r7.x, icb[r6.w + 0].yxyy, r9.xyxx
        dp2 r7.y, icb[r6.w + 0].yxyy, r9.yzyy
        mad r10.xy, r7.xyxx, r6.yyyy, r8.xyxx
        sample_c_lz_indexable(texture2darray)(float,float,float,float) r7.x, r10.xyzx, t9.xxxx, s13, r3.w
        mad r6.x, r7.x, l(0.125000), r6.x
        iadd r6.w, r6.w, l(1)
      endloop 
    else 
      utof r8.z, r6.z
      sample_c_lz_indexable(texture2darray)(float,float,float,float) r6.x, r8.xyzx, t9.xxxx, s13, r3.w
    endif 
    mul r3.w, r6.x, r6.x
    mul r3.w, r6.x, r3.w
  else 
...
mul r6.xyz, r5.wwww, cb2[18].xyzx
mad r7.xyz, -v6.xyzx, r4.xxxx, cb2[17].xyzx
dp3 r3.w, r7.xyzx, r7.xyzx
rsq r3.w, r3.w
mul r7.xyz, r3.wwww, r7.xyzx
mov_sat r3.w, r0.w
dp3_sat r0.x, r0.xyzx, r7.xyzx
dp3_sat r0.y, r7.xyzx, cb2[17].xyzx
dp3_sat r0.z, r7.xyzx, r4.yzwy
...
log r0.x, r0.x
mul r4.xy, r0.xxxx, cb0[17].xyxx
exp r4.xy, r4.xyxx
dp2 r0.x, r4.xyxx, cb0[18].xyxx
mul r0.y, r3.w, r0.y
...
mad r0.xyz, r6.xyzx, r0.yyyy, r17.xyzx
mad r4.xyz, r6.xyzx, |r0.wwww|, r17.xyzx
mul r0.xyz, r3.xyzx, r0.xyzx
mad r1.xyz, r4.xyzx, r1.xyzx, -r0.xyzx
mad r0.xyz, r2.yyyy, r1.xyzx, r0.xyzx
add r0.w, -r2.y, l(1.000000)
mad r0.xyz, r2.xzwx, r0.wwww, r0.xyzx
dp2 r0.w, v6.xyxx, v6.xyxx
sqrt r0.w, r0.w
mad r0.w, r0.w, cb0[20].z, cb0[20].w
exp r0.w, r0.w
min r0.w, r0.w, l(1.000000)
mul r1.xyz, cb0[28].xyzx, cb2[18].xyzx
...
if_nz r0.w
  ...
  if_nz r1.x
    ...
    mul r2.xyz, r1.xxxx, cb2[12].xyzx
    exp r2.xyz, r2.xyzx
    mul r1.xyz, r1.yyyy, cb2[12].xyzx
    exp r1.xyz, r1.xyzx
    add r1.xyz, -r2.xyzx, r1.xyzx
    mad r1.xyz, cb2[13].wwww, r1.xyzx, r2.xyzx
  else 
    mad r2.x, r0.w, cb2[15].x, cb2[14].z
    mul r2.x, r2.x, cb2[16].x
    lt r2.y, l(0.010000), |v6.z|
    mul r2.z, v6.z, cb2[15].z
...
mov o0.w, l(1.000000)
ret 
// Approximately 1532 instruction slots used
