...
sample_indexable(texture2d)(float,float,float,float) r12.xyzw, r12.xyxx, t25.xyzw, s1
mul r12.xyz, r12.xyzx, cb0[20].xyzx
mul r1.w, r12.w, cb0[18].w
mul r12.xyz, r1.wwww, r12.xyzx
mul r12.xyz, r12.xyzx, cb0[26].wwww
add r1.w, r1.x, cb0[25].z
frc r1.w, r1.w
mad r13.y, cb1[69].w, cb0[25].w, r1.w
mov r13.x, cb0[25].y
sample_l_indexable(texture2d)(float,float,float,float) r1.w, r13.xyxx, t22.yzwx, s5, l(0.000000)
log r1.w, |r1.w|
...
mul r12.xyz, r1.wwww, r12.xyzx
mad r1.w, -r12.w, cb0[26].w, l(1.000000)
...
ret 
// Approximately 2803 instruction slots used
