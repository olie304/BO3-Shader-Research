...
if_nz r1.w
  ...
  mov r15.y, r15.x
  mov r15.z, r14.x
  dp2 r16.x, r15.yzyy, r8.zwzz
  mov r15.x, -r14.x
  dp2 r16.y, r15.xyxx, r8.zwzz
  mul r8.zw, cb0[22].xxxy, cb1[69].wwww
  mad r8.zw, r8.zzzw, cb0[22].zzzw, r16.xxxy
  ...
  add r8.zw, r8.zzzw, l(0.000000, 0.000000, 0.500000, 0.500000)
  mov_sat r9.zw, r8.zzzw
  movc r13.x, cb0[24].w, r9.z, r8.z
  movc r13.y, cb0[25].x, r9.w, r8.w
endif 
sample_indexable(texture2d)(float,float,float,float) r13.xyzw, r13.xyxx, t37.xyzw, s1
mul r13.xyz, r13.xyzx, cb0[20].xyzx
mul r1.w, r13.w, cb0[18].w
mul r13.xyz, r1.wwww, r13.xyzx
add r1.w, r0.z, cb0[25].z
frc r1.w, r1.w
mad r14.y, cb1[69].w, cb0[25].w, r1.w
mov r14.x, cb0[25].y
sample_l_indexable(texture2d)(float,float,float,float) r1.w, r14.xyxx, t26.yzwx, s7, l(0.000000)
log r1.w, |r1.w|
...
if_nz r1.w
  ...
  round_z r1.w, r1.w
  add r1.w, r1.w, r1.x
  div r13.x, r1.w, cb0[28].x
  round_z r1.w, r2.w
  add r1.w, r1.w, r1.y
  div r13.y, r1.w, cb0[27].w
else 
  dp3 r1.w, -v7.xyzx, -v7.xyzx
  rsq r1.w, r1.w
  mul r14.xyz, r1.wwww, -v7.xyzx
  ...
  movc r13.x, cb0[31].w, r5.x, r1.x
  movc r13.y, cb0[32].x, r5.y, r1.y
endif 
sample_indexable(texture2d)(float,float,float,float) r5.xyzw, r13.xyxx, t38.xyzw, s1
mul r1.xyw, r5.xyxz, cb0[27].xyxz
mul r2.w, r5.w, cb0[18].w
mul r1.xyw, r1.xyxw, r2.wwww
add r0.z, r0.z, cb0[32].z
frc r0.z, r0.z
mad r5.y, cb1[69].w, cb0[32].w, r0.z
mov r5.x, cb0[32].y
sample_l_indexable(texture2d)(float,float,float,float) r0.z, r5.xyxx, t26.yzxw, s7, l(0.000000)
log r0.z, |r0.z|
mul r0.z, r0.z, cb0[33].z
exp r0.z, r0.z
add r2.w, -cb0[33].x, cb0[33].y
mad r0.z, r0.z, r2.w, cb0[33].x
...
ret 
// Approximately 2820 instruction slots used
