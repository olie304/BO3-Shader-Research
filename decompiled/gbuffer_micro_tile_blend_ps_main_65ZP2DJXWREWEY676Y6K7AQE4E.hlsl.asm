...
sample_indexable(texture2d)(float,float,float,float) r1.xyw, r0.zwzz, t9.xywz, s2
...
mul r1.z, r1.z, r2.w
exp r4.y, r1.z
mad_sat r4.xy, cb0[10].wwww, r4.xyxx, r0.wwww
mul r4.zw, v2.xxxy, cb0[11].yyyz
sample_indexable(texture2d)(float,float,float,float) r0.w, r4.zwzz, t7.yzwx, s3
add r0.w, -r4.x, r0.w
add r1.z, -r4.x, r4.y
...
mad r3.w, r0.z, cb0[12].w, r1.z
mul r0.z, r1.w, r1.w
mad r1.xy, r1.xyxx, l(1.99218750, 1.99218750, 0.000000, 0.000000), l(-1.000000, -1.000000, 0.000000, 0.000000)
mad r4.xy, r1.xyxx, cb0[12].zzzz, r2.xyxx
mul r0.z, r0.z, l(0.33333334)
min r0.z, r0.z, l(1.000000)
mad r1.w, r0.z, cb0[12].z, r1.z
mad r0.xy, r0.xyxx, cb0[12].wwww, r2.xyxx
...
mul_sat r0.x, cb0[15].y, l(0.05882353)
