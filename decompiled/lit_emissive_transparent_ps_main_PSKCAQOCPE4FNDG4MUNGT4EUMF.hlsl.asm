...
if_nz r1.w
  ...
  sincos r3.x, r7.x, r1.w
  mov r7.y, r7.x
  mov r7.z, r3.x
  dp2 r10.x, r7.yzyy, r5.zwzz
  mov r7.x, -r3.x
  dp2 r10.y, r7.xyxx, r5.zwzz
...
mov r6.x, cb0[16].x
sample_l_indexable(texture2d)(float,float,float,float) r0.w, r6.xyxx, t24.yzwx, s5, l(0.000000)
log r0.w, |r0.w|
...
ret 
// Approximately 2644 instruction slots used
