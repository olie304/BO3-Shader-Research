...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:31:39 2021
//
//
// Buffer Definitions: 
//
...
mad r5.xyz, r4.xyzx, r1.wwww, r5.xyzx
...
mad r0.w, -r0.w, v1.w, cb1[63].x
mad o2.z, cb1[63].w, r0.w, r1.x
movc r1.xzw, v7.xxxx, v3.xxyz, -v3.xxyz
dp3 r0.w, r1.xzwx, r1.xzwx
rsq r0.w, r0.w
mad r1.xzw, r1.xxzw, r0.wwww, -r5.xxyz
mad r5.yzw, cb1[60].wwww, r1.xxzw, r5.xxyz
max r0.w, cb0[14].w, l(0.000100)
mul r0.w, r0.w, r1.y
movc r0.w, v7.x, r1.y, r0.w
sample_indexable(texture2d)(float,float,float,float) r1.x, v2.xyxx, t11.xyzw, s1
add r1.x, -r1.x, l(1.000000)
mul r1.yzw, r0.xxyz, cb0[14].xxyz
mul r1.w, r1.x, r1.w
...
mad r3.xyz, r3.xyzx, r2.wwww, -r2.zzzz
max r2.w, r3.z, r3.y
max r2.w, r2.w, r3.x
max r2.z, r2.w, r2.z
eq r2.w, r2.z, r3.x
...
ftou r2.zw, v0.xxxy
mad r3.y, r1.y, r1.x, -r1.w
mad r0.w, r3.y, l(0.500000), r1.w
mad r3.z, r1.z, r1.x, -r0.w
