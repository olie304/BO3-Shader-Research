...
r3.z = outdoorOcclusionTree[]..swiz;
  ...
  r7.z = outdoorOcclusionTree[]..swiz;
    r6.y = 0;
    r7.y = 1;
    r7.xyz = r3.www ? r6.xyz : r7.xyz;
    r8.yz = r3.ww ? float2(8.40779079e-45,1.40129846e-45) : float2(7.00649232e-45,2.80259693e-45);
    r3.xz = (uint2)r1.wy >> (uint2)r8.yy;
  ...
  r8.w = outdoorOcclusionTree[]..swiz;
    ...
    r6.w = outdoorOcclusionTree[]..swiz;
      r6.yz = (int2)r3.zz + int2(1,2);
      r3.z = (int)-r6.y + 6;
      r7.xy = (uint2)r1.wy >> (uint2)r3.zz;
      r3.z = (int)r6.w & 0xc0000000;
      r4.w = (int)r6.w | 0x40000000;
      bitmask.w = ((~(-1 << 1)) << 1) & 0xffffffff;  r5.w = (((uint)r7.y << 1) & bitmask.w) | ((uint)0 & ~bitmask.w);
      bitmask.w = ((~(-1 << 1)) << 0) & 0xffffffff;  r5.w = (((uint)r7.x << 0) & bitmask.w) | ((uint)r5.w & ~bitmask.w);
      r5.w = (int)r5.w * 10;
      r4.w = (uint)r4.w >> (uint)r5.w;
      r4.w = (int)r4.w & 1023;
    ...
    r7.z = outdoorOcclusionTree[]..swiz;
      r7.y = r6.z;
      r7.xyz = r3.zzz ? r6.xyw : r7.xyz;
      r4.w = (int)-r7.y + 6;
      r6.yz = (uint2)r1.wy >> (uint2)r4.ww;
      r4.w = (int)r7.z & 0xc0000000;
  ...
  r1.x = dot(r5.xyz, pinToWorldZ.xyz);
