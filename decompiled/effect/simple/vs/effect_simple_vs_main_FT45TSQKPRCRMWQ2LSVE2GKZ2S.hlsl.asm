...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:25:29 2021
//
//
// Buffer Definitions: 
//
...
if_z r2.w
  ...
  movc r2.w, r8.y, r6.z, r2.w
  ushr r3.w, r2.w, l(13)
  movc r2.w, r8.x, r3.w, r2.w
  and r2.w, r2.w, l(8191)
  iadd r7.x, r2.w, r6.x
  ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r7.w, r7.x, l(0), t0.xxxx
  movc r6.xyz, r1.wwww, r6.xyzx, r7.xzwx
  movc r5.xyz, r0.wwww, r5.xyzx, r6.xyzx
  and r0.w, r5.z, l(0xc0000000)
  if_z r0.w
    iadd r0.w, -r5.y, l(6)
    ushr r6.xy, r4.zyzz, r0.wwww
    or r0.w, r5.z, l(0x40000000)
    bfi r1.w, l(1), l(1), r6.y, l(0)
    bfi r1.w, l(1), l(0), r6.x, r1.w
    ...
    iadd r0.w, -r6.y, l(6)
    ushr r5.yw, r4.zzzy, r0.wwww
    and r0.w, r6.w, l(0xc0000000)
    or r1.w, r6.w, l(0x40000000)
    bfi r2.w, l(1), l(1), r5.w, l(0)
    bfi r2.w, l(1), l(0), r5.y, r2.w
    ...
    mov r7.y, r6.z
    movc r7.xyz, r0.wwww, r6.xywx, r7.xyzx
    iadd r1.w, -r7.y, l(6)
    ushr r5.yw, r4.zzzy, r1.wwww
    and r1.w, r7.z, l(0xc0000000)
    or r2.w, r7.z, l(0x40000000)
    bfi r3.w, l(1), l(1), r5.w, l(0)
    bfi r3.w, l(1), l(0), r5.y, r3.w
    ...
    movc r5.yw, r1.wwww, r7.xxxz, r8.xxxy
    movc r5.xz, r0.wwww, r6.xxwx, r5.yywy
  endif 
  and r0.w, r5.z, l(0xc0000000)
  if_z r0.w
    ubfe r1.w, l(14), l(15), r5.z
    utof r1.w, r1.w
    ...
    bfi r4.xyw, l(2, 2, 0, 1), l(3, 1, 0, 4), r4.xyxz, l(0, 0, 0, 0)
    ushr r3.w, r3.w, r4.x
    and r3.w, r3.w, l(255)
    utof r3.w, r3.w
    mul r3.w, r2.w, r3.w
    mad r3.w, r3.w, l(0.00392157), r1.w
    iadd r4.x, r4.y, l(1)
    ubfe r4.y, l(1), l(1), r4.z
    iadd r4.x, r4.y, r4.x
    iadd r4.x, r4.x, r5.x
    ...
    movc r3.z, r5.w, r3.w, r1.w
  else 
    and r1.w, r5.z, l(0x80000000)
    iadd r2.w, r5.x, l(1)
    ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r2.w, r2.w, l(0), t0.xxxx
    ...
    movc r3.z, r0.w, r1.w, r3.z
  endif 
endif 
dp3 r0.w, r3.xyzx, cb2[49].xyzx
