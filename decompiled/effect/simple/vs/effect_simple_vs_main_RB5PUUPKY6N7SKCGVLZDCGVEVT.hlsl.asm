...
mul r1.xy, v0.yyyy, cb2[45].xyxx
mad r1.xy, v0.xxxx, cb2[44].xyxx, r1.xyxx
mad r1.xy, v0.zzzz, cb2[46].xyxx, r1.xyxx
add r1.xy, r1.xyxx, cb2[47].xyxx
mul r2.xyz, cb2[43].zxyz, l(128.000000, 0.500000, 0.500000, 0.000000)
rcp r3.xz, r2.xxxx
mov r3.y, -r3.z
mad r2.xyz, r1.xyxx, r3.xyzx, r2.yzyy
add r3.xyz, cb2[43].xyxx, l(-0.00781250, -0.00781250, -0.00781250, 0.000000)
max r2.xyz, r2.xyzx, l(0.000000, 0.000000, 0.000000, 0.000000)
min r2.xyz, r3.xyzx, r2.xyzx
round_ni r3.xy, r2.zyzz
mad r0.w, r3.y, cb2[43].x, r3.x
ftou r0.w, r0.w
...
if_z r2.w
  ...
  if_z r0.w
    ...
    iadd r4.yz, r3.yyyy, l(0, 1, 2, 0)
    iadd r0.w, -r4.y, l(6)
    ushr r3.yw, r2.zzzy, r0.wwww
    and r0.w, r4.w, l(0xc0000000)
    or r1.w, r4.w, l(0x40000000)
    bfi r2.w, l(1), l(1), r3.w, l(0)
    bfi r2.w, l(1), l(0), r3.y, r2.w
    ...
    iadd r1.w, -r5.y, l(6)
    ushr r3.yw, r2.zzzy, r1.wwww
    and r1.w, r5.z, l(0xc0000000)
    or r2.w, r5.z, l(0x40000000)
    bfi r3.w, l(1), l(1), r3.w, l(0)
    bfi r3.y, l(1), l(0), r3.y, r3.w
    imul null, r3.y, r3.y, l(10)
    ushr r2.w, r2.w, r3.y
    and r2.w, r2.w, l(1023)
    iadd r6.x, r2.w, r5.x
    ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r6.y, r6.x, l(0), t0.xxxx
    movc r3.yw, r1.wwww, r5.xxxz, r6.xxxy
    movc r3.xz, r0.wwww, r4.xxwx, r3.yywy
  endif 
  and r0.w, r3.z, l(0xc0000000)
  if_z r0.w
    ubfe r1.w, l(14), l(15), r3.z
    utof r1.w, r1.w
    mul r1.w, r1.w, cb2[43].w
    mul r1.w, r1.w, l(0.00006104)
    and r3.yw, r3.zzzz, l(0, 0x00007fff, 0, 0x20000000)
    utof r2.w, r3.y
    ...
    bfi r4.xyz, l(2, 2, 1, 0), l(3, 1, 4, 0), r2.xyzx, l(0, 0, 0, 0)
    ushr r2.x, r3.y, r4.x
    and r2.x, r2.x, l(255)
    utof r2.x, r2.x
    mul r2.x, r2.w, r2.x
    mad r2.x, r2.x, l(0.00392157), r1.w
    iadd r2.y, r4.y, l(1)
    ...
    utof r2.y, r2.y
    mul r2.y, r2.w, r2.y
    mad r1.w, r2.y, l(0.00001526), r1.w
    movc r1.z, r3.w, r2.x, r1.w
  else 
    and r1.w, r3.z, l(0x80000000)
    iadd r2.x, r3.x, l(1)
    ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r2.x, r2.x, l(0), t0.xxxx
    movc r1.w, r1.w, r2.x, l(0)
    ishl r2.x, r3.z, l(2)
    ushr r2.y, r1.w, l(16)
    f16tof32 r2.y, r2.y
    ...
    movc r1.z, r0.w, r1.w, r1.z
  endif 
endif 
dp3 r0.w, r1.xyzx, cb2[49].xyzx
