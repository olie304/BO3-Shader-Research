...
//   float hdrScale;                    // Offset:  240 Size:     4 [unused]
//   uint zFeatherComputeSprites;       // Offset:  244 Size:     4 [unused]
//   float desaturationAmount;          // Offset:  248 Size:     4 [unused]
...
movc o4.xyzw, v2.xxxx, r5.xyzw, r0.zwzw
movc o6.x, v2.x, r1.w, l(0)
utof r0.x, r0.y
utof r0.y, r2.y
...
movc o8.xy, r1.wwww, l(0,1.000000,0,0), r2.xyxx
f16tof32 o5.w, v2.z
ushr o9.x, v2.z, l(16)
...
if_z r3.w
  ...
  mov r6.y, l(0)
  mov r7.y, l(1)
  movc r7.xyz, r3.wwww, r6.xyzx, r7.xyzx
  movc r8.yz, r3.wwww, l(0,6,1,0), l(0,5,2,0)
  ushr r3.xz, r1.wwyw, r8.yyyy
  ...
  movc r3.xzw, r3.wwww, r6.xxyz, r7.xxyz
  ...
  if_z r4.w
    ...
    iadd r6.yz, r3.zzzz, l(0, 1, 2, 0)
    iadd r3.z, -r6.y, l(6)
    ushr r7.xy, r1.wyww, r3.zzzz
    and r3.z, r6.w, l(0xc0000000)
    or r4.w, r6.w, l(0x40000000)
    bfi r5.w, l(1), l(1), r7.y, l(0)
    bfi r5.w, l(1), l(0), r7.x, r5.w
    imul null, r5.w, r5.w, l(10)
    ushr r4.w, r4.w, r5.w
    and r4.w, r4.w, l(1023)
    iadd r7.x, r4.w, r6.x
    ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r7.z, r7.x, l(0), t0.xxxx
    mov r7.y, r6.z
    movc r7.xyz, r3.zzzz, r6.xywx, r7.xyzx
    iadd r4.w, -r7.y, l(6)
    ushr r6.yz, r1.wwyw, r4.wwww
    and r4.w, r7.z, l(0xc0000000)
    ...
    movc r3.xw, r3.zzzz, r6.xxxw, r6.yyyz
  endif 
  ...
  if_z r3.z
    ...
    and r6.xy, r3.wwww, l(0x00007fff, 0x20000000, 0, 0)
    utof r5.w, r6.x
    ...
    movc r5.z, r3.z, r1.x, r5.z
  endif 
endif 
dp3 r1.x, r5.xyzx, cb2[49].xyzx
