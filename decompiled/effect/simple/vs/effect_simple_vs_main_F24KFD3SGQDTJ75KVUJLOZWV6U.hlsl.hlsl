...
// unknown dcl_: dcl_input_sgv v7.x, vertex_id
  ...
  o4.xyzw = v2.xxxx ? r8.xyzw : r0.zwzw;
  o6.x = v2.x ? r1.w : 0;
  r0.x = (uint)r0.y;
  r0.y = (uint)r3.w;
  ...
  if (r0.x != 0) {
    ...
    r3.x = r3.x * r0.x;
    r0.x = r2.w ? r3.x : r0.x;
    r7.xyz = fogConsts5.xyz * r0.xxx;
    r7.xyz = exp2(r7.xyz);
    r7.xyz = r7.xyz * fogConsts4.www + float3(1,1,1);
    r7.xyz = saturate(-fogConsts4.www + r7.xyz);
    r0.y = saturate(r0.y);
    r0.x = r0.y * r0.y + 1;
    r0.x = r0.x * 0.0596831031 + -1;
    r0.x = fogConsts7.w * r0.x + 1;
    r8.xyz = fogConsts4.xyz * r1.www;
    r8.xyz = r0.xxx * fogConsts3.xyz + r8.xyz;
    r8.xyz = fogConsts5.www * r8.xyz;
    r9.xyz = float3(1,1,1) + -r7.xyz;
    o11.xyz = r9.xyz * r8.xyz;
    o10.xyz = r7.xyz;
    o3.xyzw = float4(0,0,0,1);
  } else {
    r0.x = fogConsts.w * r5.z;
    r0.y = fogConsts.w * r5.z + fogConsts.x;
    ...
    r7.xyzw = -sunFogColor.xyzw + fogColor.xyzw;
    r7.xyzw = r0.yyyy * r7.xyzw + sunFogColor.xyzw;
    r0.x = 1 + -r0.x;
    o3.w = -r0.x * r7.w + 1;
