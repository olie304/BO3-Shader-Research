...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  r3.xy = outdoorSSTConstants.offToPinTransform._m10_m11 * v0.yy;
  r3.xy = v0.xx * outdoorSSTConstants.offToPinTransform._m00_m01 + r3.xy;
  r3.xy = v0.zz * outdoorSSTConstants.offToPinTransform._m20_m21 + r3.xy;
  r3.xy = outdoorSSTConstants.offToPinTransform._m30_m31 + r3.xy;
  r4.xyz = float3(128,0.5,0.5) * outdoorSSTConstants.constants.inchesPerTexel;
  r5.xz = rcp(r4.xx);
  r5.y = -r5.z;
  ...
  r5.xy = floor(r4.zy);
  r0.w = r5.y * outdoorSSTConstants.constants.dimensionInTiles.x + r5.x;
  r0.w = (uint)r0.w;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r1.w, r0.w, l(0), t0.xxxx
r1.w = samp0[]..swiz;
  r2.w = r1.w ? 2.000000 : 0;
  r3.z = (uint)r1.w << 2;
  if (r2.w == 0) {
    r2.w = r1.w ? 0.000000 : 0;
    r5.x = (int)r0.w + (int)r2.w;
    r0.w = (uint)r1.w >> 25;
    r0.w = (uint)r0.w;
  ...
  r5.z = samp0[]..swiz;
    r6.xy = (uint2)r4.zy >> int2(6,6);
    r0.w = (int)r5.z & 0xc0000000;
    r1.w = (int)r5.x + 1;
  // Known bad code for instruction (needs manual fix):
  ...
  r6.z = samp0[]..swiz;
    ...
    r7.yz = r0.ww ? float2(8.40779079e-45,1.40129846e-45) : float2(7.00649232e-45,2.80259693e-45);
  ...
  r7.w = samp0[]..swiz;
    r6.xyz = r1.www ? r6.xyz : r7.xzw;
    r5.xyz = r0.www ? r5.xyz : r6.xyz;
    r0.w = (int)r5.z & 0xc0000000;
    if (r0.w == 0) {
      r0.w = (int)-r5.y + 6;
      r6.xy = (uint2)r4.zy >> (uint2)r0.ww;
      r0.w = (int)r5.z | 0x40000000;
      bitmask.w = ((~(-1 << 1)) << 1) & 0xffffffff;  r1.w = (((uint)r6.y << 1) & bitmask.w) | ((uint)0 & ~bitmask.w);
      bitmask.w = ((~(-1 << 1)) << 0) & 0xffffffff;  r1.w = (((uint)r6.x << 0) & bitmask.w) | ((uint)r1.w & ~bitmask.w);
      r1.w = (int)r1.w * 10;
      r0.w = (uint)r0.w >> (uint)r1.w;
      r0.w = (int)r0.w & 1023;
      r6.x = (int)r0.w + (int)r5.x;
    // Known bad code for instruction (needs manual fix):
    ...
    r6.w = samp0[]..swiz;
      ...
      r0.w = (int)-r6.y + 6;
      r5.yw = (uint2)r4.zy >> (uint2)r0.ww;
      r0.w = (int)r6.w & 0xc0000000;
      r1.w = (int)r6.w | 0x40000000;
      bitmask.w = ((~(-1 << 1)) << 1) & 0xffffffff;  r2.w = (((uint)r5.w << 1) & bitmask.w) | ((uint)0 & ~bitmask.w);
      bitmask.w = ((~(-1 << 1)) << 0) & 0xffffffff;  r2.w = (((uint)r5.y << 0) & bitmask.w) | ((uint)r2.w & ~bitmask.w);
      r2.w = (int)r2.w * 10;
    ...
    r7.z = samp0[]..swiz;
      r7.y = r6.z;
      r7.xyz = r0.www ? r6.xyw : r7.xyz;
      r1.w = (int)-r7.y + 6;
      r5.yw = (uint2)r4.zy >> (uint2)r1.ww;
      r1.w = (int)r7.z & 0xc0000000;
      r2.w = (int)r7.z | 0x40000000;
      bitmask.w = ((~(-1 << 1)) << 1) & 0xffffffff;  r3.w = (((uint)r5.w << 1) & bitmask.w) | ((uint)0 & ~bitmask.w);
      bitmask.w = ((~(-1 << 1)) << 0) & 0xffffffff;  r3.w = (((uint)r5.y << 0) & bitmask.w) | ((uint)r3.w & ~bitmask.w);
      r3.w = (int)r3.w * 10;
      r2.w = (uint)r2.w >> (uint)r3.w;
      r2.w = (int)r2.w & 1023;
      r8.x = (int)r2.w + (int)r7.x;
    // Known bad code for instruction (needs manual fix):
        ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r8.y, r8.x, l(0), t0.xxxx
    r8.y = samp0[]..swiz;
      r5.yw = r1.ww ? r7.xz : r8.xy;
      r5.xz = r0.ww ? r6.xw : r5.yw;
    }
    r0.w = (int)r5.z & 0xc0000000;
    if (r0.w == 0) {
      if (14 == 0) r1.w = 0; else if (14+15 < 32) {       r1.w = (uint)r5.z << (32-(14 + 15)); r1.w = (uint)r1.w >> (32-14);      } else r1.w = (uint)r5.z >> 15;
      r1.w = (uint)r1.w;
    ...
    r3.w = samp0[]..swiz;
      bitmask.x = ((~(-1 << 2)) << 3) & 0xffffffff;  r4.x = (((uint)r4.x << 3) & bitmask.x) | ((uint)0 & ~bitmask.x);
      bitmask.y = ((~(-1 << 2)) << 1) & 0xffffffff;  r4.y = (((uint)r4.y << 1) & bitmask.y) | ((uint)0 & ~bitmask.y);
      bitmask.w = ((~(-1 << 1)) << 4) & 0xffffffff;  r4.w = (((uint)r4.z << 4) & bitmask.w) | ((uint)0 & ~bitmask.w);
      r3.w = (uint)r3.w >> (uint)r4.x;
      r3.w = (int)r3.w & 255;
      r3.w = (uint)r3.w;
      r3.w = r3.w * r2.w;
      r3.w = r3.w * 0.00392156886 + r1.w;
      r4.x = (int)r4.y + 1;
      if (1 == 0) r4.y = 0; else if (1+1 < 32) {       r4.y = (uint)r4.z << (32-(1 + 1)); r4.y = (uint)r4.y >> (32-1);      } else r4.y = (uint)r4.z >> 1;
  ...
  r0.w = dot(r3.xyz, pinToWorldZ.xyz);
