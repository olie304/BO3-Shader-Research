...
mul r1.x, r1.y, r1.x
mul r1.x, r1.x, cb0[14].w
lt r1.y, r1.x, l(0.250000)
discard_nz r1.y
dp3 r1.y, r0.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
add r1.yzw, -r0.xxyz, r1.yyyy
mad r0.xyz, cb0[12].yyyy, r1.yzwy, r0.xyzx
...
ge r1.yzw, r0.xxyz, l(0.000000, 0.00006104, 0.00006104, 0.00006104)
and r0.xyz, r0.xyzx, r1.yzwy
