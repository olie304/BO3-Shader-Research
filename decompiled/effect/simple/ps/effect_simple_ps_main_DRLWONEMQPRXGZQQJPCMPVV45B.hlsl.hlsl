  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.xyzw = cmp(levelsControls.xyzw == float4(0,1,0,1));
  r0.x = r0.y ? r0.x : 0;
  r0.x = r0.z ? r0.x : 0;
  r0.x = r0.w ? r0.x : 0;
  r0.yz = v3.xy / v3.zz;
  r1.xy = ddx_coarse(r0.yz);
  r1.zw = ddy_coarse(r0.yz);
  r1.xyzw = colorMap.SampleGrad(colorSampler_s, r0.yz, r1.xyxx, r1.zwzz).xyzw;
  r0.y = dot(r1.xyz, float3(0.212599993,0.715200007,0.0722000003));
  r0.yzw = r0.yyy + -r1.xyz;
  r0.yzw = desaturationAmount * r0.yzw + r1.xyz;
  r2.x = max(9.99999975e-05, r1.w);
  r2.yzw = saturate(r0.yzw / r2.xxx);
  ...
  r2.x = dot(v6.xyz, v4.xyz);
  r2.xyz = -v6.xyz * r2.xxx + v4.xyz;
  r2.w = dot(r2.xyz, r2.xyz);
  r2.w = rsqrt(r2.w);
  r2.xyz = r2.xyz * r2.www;
  r3.xy = cmp((int2)v5.ww == int2(1,2));
  r2.xyz = r3.yyy ? r2.xyz : v6.xyz;
