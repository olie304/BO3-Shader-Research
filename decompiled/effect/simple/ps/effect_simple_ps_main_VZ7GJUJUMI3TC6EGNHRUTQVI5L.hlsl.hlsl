  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r2.xyzw = colorMap.SampleGrad(colorSampler_s, r1.zw, r0.zwzz, r1.xyxx).wxyz;
  r1.z = dot(r2.yzw, float3(0.212599993,0.715200007,0.0722000003));
  r3.xyz = r1.zzz + -r2.yzw;
  r3.xyz = desaturationAmount * r3.xyz + r2.yzw;
  r4.xyzw = cmp(levelsControls.xyzw == float4(0,1,0,1));
  r1.z = r4.y ? r4.x : 0;
  r1.z = r4.z ? r1.z : 0;
  r1.z = r4.w ? r1.z : 0;
  r1.w = max(9.99999975e-05, r2.x);
  r4.xyz = saturate(r3.xyz / r1.www);
  r4.xyz = saturate(-levelsControls.xxx + r4.xyz);
  r2.zw = levelsControls.yw + -levelsControls.xz;
  r1.w = max(9.99999975e-05, r2.z);
  r4.xyz = r4.xyz / r1.www;
  r4.xyz = min(float3(1,1,1), r4.xyz);
  r4.xyz = r4.xyz * r2.www + levelsControls.zzz;
  ...
  r1.z = cmp(v4.y != 1.000000);
  r1.w = v1.w + r2.x;
  r4.x = saturate(r1.w * v4.y + -v4.y);
  r4.y = 1;
  r2.y = v1.w;
  ...
  r0.w = translucentShadowOpacity * r0.w;
  r1.x = cmp(r0.w < 0.25);
  if (r1.x != 0) discard;
