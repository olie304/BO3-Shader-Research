  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.xy = r0.zz ? r0.xy : 0;
  r0.y = r1.x * r0.y;
  r0.z = dot(v1.xyz, float3(0.298999995,0.587000012,0.114));
  r0.z = max(9.99999975e-05, r0.z);
  r0.z = max(relHDRExposure.x, r0.z);
  r0.z = hdrScale * r0.z;
  r0.z = v5.w * r0.z;
  r0.z = useOldHDRScale ? hdrScale : r0.z;
  r0.y = r0.z * r0.y;
  r0.yzw = v2.xyz * r0.yyy + v1.xyz;
  r2.xyz = v3.xyz * r0.xxx;
  r0.yzw = r1.yzw * r0.yzw + -r2.xyz;
  r0.yzw = v3.www * r0.yzw + r2.xyz;
  r1.xyz = v11.xyz * r0.xxx;
  o0.w = r0.x;
  r0.xyz = r0.yzw * v10.xyz + r1.xyz;
