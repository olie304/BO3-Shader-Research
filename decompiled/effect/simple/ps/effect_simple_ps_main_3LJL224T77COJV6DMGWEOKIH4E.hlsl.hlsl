...
cbuffer _Globals : register(b0)
{
  ...
  float translucentShadowOpacity : packoffset(c14.w);
}
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r1.x = r1.x * r1.y;
  r1.w = useOldHDRScale * r1.x;
  r2.x = cmp(r1.w < 0.25);
  if (r2.x != 0) discard;
  r2.x = dot(r0.xyz, float3(0.212599993,0.715200007,0.0722000003));
  r2.xyz = r2.xxx + -r0.xyz;
  r0.xyz = desaturationAmount * r2.xyz + r0.xyz;
  r2.xyzw = cmp(levelsControls.xyzw == float4(0,1,0,1));
  r2.x = r2.y ? r2.x : 0;
  r2.x = r2.z ? r2.x : 0;
  r2.x = r2.w ? r2.x : 0;
  r2.y = max(9.99999975e-05, r0.w);
  r2.yzw = saturate(r0.xyz / r2.yyy);
  ...
  r3.xyz = cmp(float3(0.0404499993,0.0404499993,0.0404499993) >= r2.yzw);
  r4.xyz = float3(0.0773993805,0.0773993805,0.0773993805) * r2.yzw;
  r2.yzw = float3(0.0549999997,0.0549999997,0.0549999997) + r2.yzw;
  r2.yzw = float3(0.947867334,0.947867334,0.947867334) * abs(r2.yzw);
  r2.yzw = log2(r2.yzw);
  r2.yzw = float3(2.4000001,2.4000001,2.4000001) * r2.yzw;
  r2.yzw = exp2(r2.yzw);
  r2.yzw = r3.xyz ? r4.xyz : r2.yzw;
