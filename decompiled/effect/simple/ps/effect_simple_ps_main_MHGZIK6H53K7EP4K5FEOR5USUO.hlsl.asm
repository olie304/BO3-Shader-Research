...
ieq r1.zw, v5.wwww, l(0, 0, 1, 2)
dp3 r2.w, v6.xyzx, v4.xyzx
mad r3.xyz, -v6.xyzx, r2.wwww, v4.xyzx
...
movc r0.xyz, r2.xxxx, r1.xywx, r3.xyzx
ftoi r3.xy, v0.xyxx
mov r3.zw, l(0,0,0,0)
ld_indexable(texture2d)(float,float,float,float) r1.x, r3.xyzw, t0.xyzw
eq r1.y, v5.z, l(0.000000)
div r1.w, l(1.000000, 1.000000, 1.000000, 1.000000), v5.z
movc r1.y, r1.y, l(60000.000000), r1.w
ge r1.w, r1.x, l(0.984375)
mul r2.x, r1.x, l(1.01587307)
mad r1.x, r1.x, l(64.000000), l(-63.000000)
movc r1.x, r1.w, r1.x, r2.x
...
div r3.xyz, r0.xyzx, r2.yyyy
add r2.y, r0.w, v1.w
mad_sat r4.w, r2.y, v5.y, -v5.y
mul r4.xyz, r3.xyzx, r4.wwww
movc r0.xyzw, r2.zzzz, r4.xyzw, r0.xyzw
movc r2.y, r2.z, l(1.000000), v1.w
lt r2.z, r1.w, r1.x
add r1.x, -r1.w, r1.x
...
mad r3.xyz, r0.xyzx, v1.xyzx, -r1.xyzx
mad r1.xyz, v2.wwww, r3.xyzx, r1.xyzx
