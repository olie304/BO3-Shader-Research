// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:25:14 2021
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.y = r1.z ? r0.y : 0;
  r0.y = r1.w ? r0.y : 0;
  r0.zw = levelsControls.yw + -levelsControls.xz;
  r0.z = max(9.99999975e-05, r0.z);
  r1.xy = v4.xy / v4.zz;
  r1.zw = ddx_coarse(r1.xy);
  r2.xy = ddy_coarse(r1.xy);
  r3.xyzw = colorMap.SampleGrad(colorSampler_s, r1.xy, r1.zwzz, r2.xyxx).xyzw;
  r1.x = emissiveMap.SampleGrad(colorSampler_s, r1.xy, r1.z, r2.x).x;
  r1.y = dot(r3.xyz, float3(0.212599993,0.715200007,0.0722000003));
  r1.yzw = r1.yyy + -r3.xyz;
  r1.yzw = desaturationAmount * r1.yzw + r3.xyz;
  r2.x = max(9.99999975e-05, r3.w);
  r2.yzw = saturate(r1.yzw / r2.xxx);
  r2.yzw = saturate(-levelsControls.xxx + r2.yzw);
  r2.yzw = r2.yzw / r0.zzz;
  r2.yzw = min(float3(1,1,1), r2.yzw);
  r2.yzw = r2.yzw * r0.www + levelsControls.zzz;
  r4.xyz = float3(0.0549999997,0.0549999997,0.0549999997) + r2.yzw;
  ...
  r2.yzw = float3(0.0773993805,0.0773993805,0.0773993805) * r2.yzw;
  r2.yzw = r5.xyz ? r2.yzw : r4.xyz;
  r2.yzw = r2.yzw * r3.www;
  r3.xyz = r0.yyy ? r1.yzw : r2.yzw;
  r0.yzw = r3.xyz / r2.xxx;
  r1.y = v1.w + r3.w;
  r2.y = saturate(r1.y * v6.y + -v6.y);
  r2.xzw = r2.yyy * r0.yzw;
  r0.y = cmp(v6.y != 1.000000);
  r3.xyzw = r0.yyyy ? r2.xzwy : r3.xyzw;
  r3.xyzw = r3.xyzw * r0.xxxx;
  r2.x = 1;
  r0.yz = r0.yy ? r2.xy : v1.ww;
  ...
  r1.yzw = -v7.xyz * r1.yyy + v5.xyz;
  r3.x = dot(r1.yzw, r1.yzw);
  r3.x = rsqrt(r3.x);
  r1.yzw = r3.xxx * r1.yzw;
  r3.xy = cmp((int2)v6.ww == int2(1,2));
  r1.yzw = r3.yyy ? r1.yzw : v7.xyz;
  r0.yzw = r3.xxx ? r0.yzw : r1.yzw;
  ...
  r0.x = r1.x * r0.x;
  r1.xyz = v2.xyz * r0.xxx + v1.xyz;
  r1.xyz = r2.xyz * r1.xyz + -r0.yzw;
  r0.xyz = v3.www * r1.xyz + r0.yzw;
