...
//   float desaturationAmount;          // Offset:  244 Size:     4
...
sample_d_indexable(texture2d)(float,float,float,float) r3.xyzw, r1.xyxx, t0.xyzw, s1, r0.xyxx, r0.zwzz
ne r1.xy, v4.xyxx, l(0.000000, 1.000000, 0.000000, 0.000000)
if_nz r1.x
  add r2.zw, v2.zzzw, l(0.000000, 0.000000, -0.500000, -0.500000)
  mad r1.zw, r2.zzzw, cb0[18].xxxy, r1.zzzw
...
add r1.z, r3.w, v1.w
mad_sat r4.x, r1.z, v4.y, -v4.y
mov r4.y, l(1.000000)
mov r3.x, v1.w
movc r1.yz, r1.yyyy, r4.xxyx, r3.wwxw
mul r2.w, r1.z, r1.y
...
if_nz r1.x
  mul r1.xz, v2.zzwz, cb0[17].yyzy
  sample_d_indexable(texture2d)(float,float,float,float) r0.x, r1.xzxx, t21.xyzw, s1, r0.xyxx, r0.zwzz
  add r0.x, -r1.y, r0.x
