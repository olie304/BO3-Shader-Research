...
ubfe r6.xy, l(1, 1, 0, 0), l(19, 20, 0, 0), r0.xxxx
...
mul r6.zw, r7.xxxy, r4.xxxy
mad r7.yzw, r8.xxyz, r6.zzzz, r2.xxyz
mad r7.yzw, r3.zzxy, r6.wwww, r7.yyzw
mov r3.w, r7.x
...
if_nz r0.z
  if_nz r0.z
    ...
    ushr r0.x, r0.x, l(16)
    ieq r6.xzw, r8.zzzz, l(1, 0, 0, 3)
    iadd r4.y, r4.y, l(-1)
    ubfe r0.y, r0.w, l(0), r0.y
    movc r0.x, r6.x, r0.x, r0.y
    or r0.y, r6.w, r6.z
    ...
    movc r0.xy, r6.wwww, r4.xzxx, r0.xyxx
...
mov o3.xyz, r0.xyzx
ret 
// Approximately 864 instruction slots used
