...
mul r5.zw, r7.xxxy, r4.xxxy
mad r7.yzw, r8.xxyz, r5.zzzz, r2.xxyz
mad r7.yzw, r3.zzxy, r5.wwww, r7.yyzw
mov r3.w, r7.x
...
if_nz r6.y
  ...
  mul r4.xy, r1.zzzz, cb2[45].xyxx
  mad r1.yz, r1.yyyy, cb2[44].xxyx, r4.xxyx
  mad r1.yz, r1.wwww, cb2[46].xxyx, r1.yyzy
  add r4.xy, r1.yzyy, cb2[47].xyxx
  mul r5.xyz, cb2[43].zxyz, l(128.000000, 0.500000, 0.500000, 0.000000)
  rcp r7.xz, r5.xxxx
  mov r7.y, -r7.z
  mad r5.xyz, r4.xyxx, r7.xyzx, r5.yzyy
  add r6.xyw, cb2[43].xyxx, l(-0.00781250, -0.00781250, 0.000000, -0.00781250)
  max r5.xyz, r5.xyzx, l(0.000000, 0.000000, 0.000000, 0.000000)
  min r5.xyz, r6.xywx, r5.xyzx
  round_ni r1.yz, r5.zzyz
  mad r1.y, r1.z, cb2[43].x, r1.y
  ftou r1.y, r1.y
  ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r1.z, r1.y, l(0), t24.xxxx
  and r4.w, r1.z, l(0x40000000)
  ishl r4.z, r1.z, l(2)
  if_z r4.w
    and r4.w, r1.z, l(0x01ffffff)
    iadd r7.x, r1.y, r4.w
    ushr r1.y, r1.z, l(25)
    utof r1.y, r1.y
    ...
    if_z r1.y
      ...
      ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r8.z, r8.x, l(0), t24.xxxx
      mov r8.y, r7.z
      movc r8.xyz, r4.wwww, r7.xywx, r8.xyzx
      iadd r1.y, -r8.y, l(6)
      ushr r1.yz, r5.zzyz, r1.yyyy
      and r5.w, r8.z, l(0xc0000000)
      or r6.y, r8.z, l(0x40000000)
      bfi r1.z, l(1), l(1), r1.z, l(0)
      bfi r1.y, l(1), l(0), r1.y, r1.z
      imul null, r1.y, r1.y, l(10)
      ushr r1.y, r6.y, r1.y
      ...
      movc r1.yz, r5.wwww, r8.xxzx, r9.xxyx
      movc r6.xw, r4.wwww, r7.xxxw, r1.yyyz
    endif 
    and r1.y, r6.w, l(0xc0000000)
    if_z r1.y
      ubfe r1.z, l(14), l(15), r6.w
      utof r1.z, r1.z
      mul r1.z, r1.z, cb2[43].w
      mul r1.z, r1.z, l(0.00006104)
      and r7.xy, r6.wwww, l(0x00007fff, 0x20000000, 0, 0)
      utof r4.w, r7.x
      mul r4.w, r4.w, cb2[43].w
      mul r4.w, r4.w, l(0.00003052)
      and r5.w, r5.y, l(3)
      iadd r5.w, r5.w, r6.x
      iadd r5.w, r5.w, l(1)
      ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r5.w, r5.w, l(0), t24.xxxx
      ...
      utof r5.x, r5.x
      mul r5.x, r4.w, r5.x
      mad r5.x, r5.x, l(0.00392157), r1.z
      iadd r5.y, r7.z, l(1)
      ...
      utof r5.y, r5.y
      mul r4.w, r4.w, r5.y
      mad r1.z, r4.w, l(0.00001526), r1.z
      movc r4.z, r7.y, r5.x, r1.z
    else 
      and r1.z, r6.w, l(0x80000000)
      iadd r4.w, r6.x, l(1)
      ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r4.w, r4.w, l(0), t24.xxxx
      movc r1.z, r1.z, r4.w, l(0)
      ishl r4.w, r6.w, l(2)
      ushr r5.x, r1.z, l(16)
      f16tof32 r5.x, r5.x
      ...
      mad r1.z, r4.y, r1.z, r4.w
      movc r4.z, r1.y, r1.z, r4.z
    endif 
  endif 
  dp3 r1.y, r4.xyzx, cb2[49].xyzx
  add r1.y, r1.y, cb2[49].w
  add_sat r1.y, -r1.y, r1.w
  mul r1.x, r1.y, r1.x
endif 
ine r1.y, r6.z, l(0)
    ...
    loop 
      ...
      if_nz r6.x
        ...
        switch r5.w
          ...
          mul r7.w, r7.w, r8.w
          mul r6.z, r6.z, r7.w
          dp4 r19.x, r13.xyzw, r2.xyzw
          dp4 r19.y, r14.xyzw, r2.xyzw
          div r7.xy, r19.xyxx, r5.wwww
          lt r7.w, r16.w, l(0.00048828)
          if_nz r7.w
            mov r17.y, r18.x
            mad_sat r14.yz, |r7.xxyx|, r17.zzwz, r17.xxyx
            ...
            mov r16.w, r17.y
            mul_sat r16.xyzw, |r7.yyxx|, r16.xyzw
            log r16.xyzw, r16.xyzw
            mul r16.xyzw, r16.xyzw, r17.xxxx
            exp r16.xyzw, r16.xyzw
            add r14.yz, r16.zzwz, r16.xxyx
            log r14.yz, r14.yyzy
            mul r14.yz, r14.yyzy, r18.xxxx
            exp r14.yz, r14.yyzy
            mul r8.w, r14.y, r17.z
            mad r14.y, r17.w, r14.z, l(-1.000000)
            mad r8.w, r17.w, r14.z, -r8.w
            div_sat r8.w, r14.y, r8.w
            mul r14.y, r8.w, r8.w
            mad r8.w, r8.w, l(-2.000000), l(3.000000)
            mul r8.w, r8.w, r14.y
            mul r7.w, r6.z, r8.w
          endif 
          ge r6.z, l(0.000000), r7.w
          if_nz r6.z
            mov r15.xyz, r9.xyzx
            break 
          endif 
          ...
          if_nz r6.z
            ...
            dp3 r8.w, r18.yzwy, r7.xyzx
            dp3 r14.y, r14.yzwy, r7.xyzx
            frc r16.x, r8.w
            frc r16.y, r14.y
            iadd r6.z, r6.z, l(-1)
            utof r16.z, r6.z
            ...
            mov r11.w, r10.w
            mul r11.xyz, r11.wyzw, r14.yzwy
          else 
            mov r11.x, r10.w
          endif 
          ubfe r6.z, l(3), l(27), r12.x
          ine r6.z, r6.z, l(1)
          if_nz r6.z
            ...
            mad_sat r7.xy, r7.xyxx, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
            dp4 r4.w, r16.xyzw, r2.xyzw
            div r4.w, r4.w, r5.w
            mad r16.xy, r7.xyxx, r17.xzxx, r17.ywyy
            and r5.w, r12.x, l(0x0000ffff)
            utof r16.z, r5.w
            sample_c_lz_indexable(texture2darray)(float,float,float,float) r4.w, r16.xyzx, t9.xxxx, s13, r4.w
          else 
            mov r4.w, l(1.000000)
          endif 
          mul r4.w, r4.w, r7.w
          ...
          div r4.w, r5.w, r4.w
          mad r15.xyz, r7.xywx, r4.wwww, r9.xyzx
          break 
          case l(4)
          ...
          ubfe r5.w, l(3), l(27), r12.x
          ine r5.w, r5.w, l(1)
          if_nz r5.w
            add r16.xyz, r2.xyzx, -r13.xyzx
            max r5.w, |r16.z|, |r16.y|
            max r5.w, r5.w, |r16.x|
            div r5.w, r13.w, r5.w
            add r5.w, r14.x, r5.w
            and r6.x, r12.x, l(0x0000ffff)
            utof r16.w, r6.x
            sample_c_lz_indexable(texturecubearray)(float,float,float,float) r5.w, r16.xyzw, t10.xxxx, s13, r5.w
          else 
            mov r5.w, l(1.000000)
          endif 
          mul r4.w, r4.w, r5.w
          ...
          min r5.w, r4.w, cb1[85].x
          div r4.w, r5.w, r4.w
          mad r15.xyz, r6.xyzx, r4.wwww, r9.xyzx
          break 
          default 
          mov r15.xyz, r9.xyzx
          break 
...
mov o1.xyzw, r0.xyzw
ret 
// Approximately 1038 instruction slots used
