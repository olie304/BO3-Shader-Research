...
// unknown dcl_: dcl_input_sgv v7.x, vertex_id
  ...
  r3.y = -r0.w;
  r3.xyz = float3(-1,0,1) + r3.xxy;
  r5.xyz = v5.zzz * r1.yzw;
  r4.xyz = r5.xyz * r3.xxx + -r4.xyz;
  r5.xyz = r5.xyz * v5.xxx + v0.xyz;
  r2.xyz = r2.xyz * v5.yyy + r5.xyz;
  r2.xyz = r2.xyz + r4.xyz;
  r2.xyz = -eyeOffset.xyz + r2.xyz;
  r3.xy = float2(0.5,0.5) * r3.yz;
  ...
  r3.zw = (uint2)r2.yz << int2(23,23);
  r3.zw = (int2)-r3.zw + int2(1065353216,1065353216);
  r4.xy = r3.zw * r3.xy;
  r0.w = (int)v2.x & 255;
  if (r2.y == 0) r1.x = 0; else if (r2.y+0 < 32) {   r1.x = (uint)r0.w << (32-(r2.y + 0)); r1.x = (uint)r1.x >> (32-r2.y);  } else r1.x = (uint)r0.w >> 0;
  ...
  r4.zw = (uint2)r2.xz;
  r2.zw = r4.zw * r3.zw + r4.xy;
  r5.y = (uint)r0.w;
  r5.x = (uint)r1.x;
  r2.xy = r5.xy * r3.zw + r4.xy;
  o2.xyzw = v2.xxxx ? r2.xyzw : r3.xyxy;
  o4.xy = r3.xy;
  r1.xz = viewProjectionMatrix._m10_m11 * r1.zz;
  r1.xy = r1.yy * viewProjectionMatrix._m00_m01 + r1.xz;
  r1.xy = r1.ww * viewProjectionMatrix._m20_m21 + r1.xy;
  r2.xw = float2(1,-1);
  r2.yz = v1.xx;
  r1.xy = r2.xy * r1.xy;
  o3.xy = r1.xy * r2.zw;
