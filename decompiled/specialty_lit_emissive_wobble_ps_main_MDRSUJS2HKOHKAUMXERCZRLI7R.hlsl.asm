...
mad r2.xyz, r2.xywx, r1.zzzz, r16.xyzx
...
mad r3.xy, r3.xyxx, r2.wwww, v2.xyxx
...
exp r1.w, r1.w
movc r1.w, cb0[15].x, r1.w, r2.w
eq r2.w, cb0[13].z, l(0.000000)
movc r1.w, r2.w, l(1.000000), r1.w
mul r2.w, r3.w, cb0[13].y
mul r1.w, r1.w, r2.w
mul r1.z, r1.z, r1.w
...
add r1.w, r1.w, r1.w
mad r13.xyz, r6.xyzx, -r1.wwww, -r9.xyzx
...
if_nz r7.w
  ...
  if_nz r7.w
    ...
    mad r8.yzw, r6.wwww, r10.xxyz, r4.yyzw
    ...
    mov r10.zw, r8.yyyz
    mov r15.zw, r4.yyyz
    movc r10.xyzw, r5.wwww, r10.xyzw, r15.xyzw
...
ret 
// Approximately 2572 instruction slots used
