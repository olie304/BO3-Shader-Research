...
r0.w = modelInstanceBuffer[]..swiz;
  if (r0.w != 0) {
    r1.x = cmp(v2.x != 0.000000);
    if (r1.x != 0) {
      r1.x = (int)r0.w + (int)v3.x;
    // Known bad code for instruction (needs manual fix):
    ...
    r1.w = modelInstanceBuffer[]..swiz;
      ...
      r2.z = v2.x * r1.x;
      r1.x = cmp(v2.y != 0.000000);
      if (r1.x != 0) {
        r1.x = (int)r0.w + (int)v3.y;
      // Known bad code for instruction (needs manual fix):
      ...
      r1.w = modelInstanceBuffer[]..swiz;
        ...
        r1.x = dot(r1.xyz, r0.xyz);
        r2.z = r1.x * v2.y + r2.z;
        r1.x = cmp(v2.z != 0.000000);
        if (r1.x != 0) {
          r1.x = (int)r0.w + (int)v3.z;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r4.xyzw, r1.x, l(0), t5.xyzw
        r4.x = modelInstanceBuffer[]..swiz;
        r4.y = modelInstanceBuffer[]..swiz;
        ...
        r1.w = modelInstanceBuffer[]..swiz;
          ...
          r1.x = dot(r1.xyz, r0.xyz);
          r2.z = r1.x * v2.z + r2.z;
          r1.x = cmp(v2.w != 0.000000);
          if (r1.x != 0) {
            r1.x = (int)r0.w + (int)v3.w;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r4.xyzw, r1.x, l(0), t5.xyzw
          r4.x = modelInstanceBuffer[]..swiz;
          r4.y = modelInstanceBuffer[]..swiz;
...
r1.y = modelInstanceBuffer[]..swiz;
  ...
  o1.z = dot(r0.xyz, r1.yzw);
  r0.x = (int)r1.x & 0x0fffffff;
  if (r0.x != 0) {
    if (r0.x != 0) {
      r0.y = cmp(v2.x != 0.000000);
      if (r0.y != 0) {
