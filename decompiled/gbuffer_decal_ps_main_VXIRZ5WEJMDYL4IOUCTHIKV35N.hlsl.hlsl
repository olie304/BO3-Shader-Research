...
Texture2D<float> volDecalRevealTexture : register(t17);
  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r0.w = specColorMap.Sample(specColorSampler_s, r0.yz).x;
  ...
  r0.w = aoMap.Sample(aoSampler_s, r0.yz).x;
  ...
  if (r3.x != 0) {
    ...
    r0.z = cmp(r3.z < r0.y);
    r0.y = cmp(0 < r0.y);
    r3.xzw = (int3)r3.xxx & int3(1,2,4);
    r5.xyz = r3.xxx ? float3(1,0,1) : r1.xyz;
    r6.xyz = r3.zzz ? float3(0,1,1) : r1.xyz;
    r5.xyz = r0.yyy ? r5.xyz : r6.xyz;
    r3.xzw = r3.www ? float3(0,1,0) : r1.xyz;
    r1.xyz = r0.zzz ? r5.xyz : r3.xzw;
  }
  r3.xzw = debugColorOverride.xyz + -r1.xyz;
  r1.xyz = debugColorOverride.www * r3.xzw + r1.xyz;
  r0.y = debugAlphaOverride.x + -r0.x;
  r0.x = debugAlphaOverride.w * r0.y + r0.x;
  r3.xzw = debugSpecularOverride.xyz + -r2.xyz;
  r2.xyz = debugSpecularOverride.www * r3.xzw + r2.xyz;
  r0.y = r2.w + -r1.w;
  r0.y = debugGlossOverride.w * r0.y + r1.w;
  r0.z = debugOcclusionOverride.x + -r0.w;
  r5.z = debugOcclusionOverride.w * r0.z + r0.w;
  r3.xyz = v5.xyz * r3.yyy + -r4.xyz;
  r3.xyz = debugNormalOverride.www * r3.xyz + r4.xyz;
  ...
  r6.xy = float2(-1.22474492,1.22474492) * r4.xz;
  r7.xyz = float3(0.707106769,-1.41421354,0.707106769) * r4.xyz;
