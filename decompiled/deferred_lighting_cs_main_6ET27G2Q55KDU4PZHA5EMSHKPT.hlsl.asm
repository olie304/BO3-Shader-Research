...
movc r2.z, r9.x, r16.y, r16.x
movc r2.z, r9.y, r16.z, r2.z
movc r2.z, r9.z, r16.w, r2.z
  ...
  if_nz r9.w
    ...
    if_nz r9.w
      ...
      if_nz r9.w
        ...
        movc r13.yzw, r3.wwww, r13.yyzw, cb9[r0.x + 0].xxyz
        ...
        mad r17.xyz, r4.zzzz, r16.xyzx, r9.xyzx
        dp3_sat r4.z, r11.xyzx, r15.xyzx
        mad r13.yzw, r13.yyzw, r3.wwww, r12.xxyz
        dp3 r3.w, r13.yzwy, r13.yzwy
        rsq r3.w, r3.w
        mul r13.yzw, r3.wwww, r13.yyzw
        dp3 r3.w, r13.yzwy, r12.xyzx
        ...
        movc r9.xyz, r5.wwww, r17.xyzx, r9.xyzx
    ...
    if_nz r6.w
      ...
      if_nz r7.w
        ...
        if_nz r9.w
          ...
          mad r16.xyz, r11.xyzx, r9.wwww, r10.xyzx
          ...
          if_z r10.w
            ...
            if_nz cb2[58].y
              ...
              loop 
                ige r15.w, r12.w, l(8)
                breakc_nz r15.w
                dp2 r19.x, icb[r12.w + 0].yxyy, r16.xyxx
                dp2 r19.y, icb[r12.w + 0].yxyy, r16.yzyy
          ...
          if_nz r0.y
            ...
            mad r16.xyz, r11.xyzx, r0.yyyy, r10.xyzx
            mov r17.xyz, cb9[r0.x + 6].yzwy
            mov r17.w, cb9[r0.x + 7].x
            mov r16.w, l(1.000000)
            dp4 r0.y, r17.xyzw, r16.xyzw
        ...
        mad r16.xyz, r0.xxxx, r13.yzwy, r9.xyzx
        mad r15.xyz, r15.xyzx, r3.wwww, r12.xyzx
        dp3 r0.x, r15.xyzx, r15.xyzx
        rsq r0.x, r0.x
        mul r15.xyz, r0.xxxx, r15.xyzx
        dp3 r0.x, r15.xyzx, r12.xyzx
        dp3 r1.z, r11.xyzx, r15.xyzx
        ...
        mad r11.xyz, r0.zzzz, r13.yzwy, r2.yzwy
        add_sat r0.x, -r0.x, l(1.000000)
        mul r0.w, r0.x, r0.x
        mul r0.w, r0.w, r0.w
        mul r0.x, r0.w, r0.x
        mul r0.x, r0.x, r0.z
        mad r0.xzw, r0.xxxx, r13.yyzw, r14.yyzw
        movc r9.xyz, r0.yyyy, r16.xyzx, r9.xyzx
        movc r14.yzw, r0.yyyy, r0.xxzw, r14.yyzw
        movc r2.yzw, r0.yyyy, r11.xxyz, r2.yyzw
      endif 
    endif 
  endif 
  break 
...
ret 
// Approximately 933 instruction slots used
