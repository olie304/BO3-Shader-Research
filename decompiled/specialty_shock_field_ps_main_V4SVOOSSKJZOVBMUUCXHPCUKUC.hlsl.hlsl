...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r4.x = aoMap.Sample(aoSampler_s, v2.xy).x;
  ...
  r7.xyz = colorTint.xyz * r6.xyz;
  r1.w = dot(-v7.xyz, -v7.xyz);
  r1.w = rsqrt(r1.w);
  r8.xyz = -v7.xyz * r1.www;
  r4.x = saturate(dot(v4.xyz, r8.xyz));
  ...
  r7.zw = (uint2)r7.yx;
  r8.w = dot(r7.wz, float2(0.0671105608,0.00583714992));
  r8.w = frac(r8.w);
  r8.w = 52.9829178 * r8.w;
  r8.w = frac(r8.w);
  r8.w = r8.w * 6.28318548 + gameTick.w;
  sincos(r8.w, r9.x, r10.x);
  ...
  r7.z = dot(-r8.xyz, r2.xyz);
  r7.z = r7.z + r7.z;
  r13.xyz = r2.xyz * -r7.zzz + -r8.xyz;
  r7.z = 17 * r5.y;
  r7.z = exp2(r7.z);
  r7.z = 2 + r7.z;
  r7.z = 2 / r7.z;
  ...
  if (r11.y != 0) {
    r11.y = cmp(0 < r11.z);
    if (r11.y != 0) {
      r11.y = sunConstants.specScale * r7.z;
      r11.y = r11.y * r10.w;
      ...
      r1.w = dot(r15.xyz, r8.xyz);
      r11.w = dot(r2.xyz, r15.xyz);
      r15.x = abs(r11.w) * r7.z + -abs(r11.w);
            ...
            r42.w = samp0[]..swiz;
              ...
              if (r21.z != 0) {
                ...
                if (r21.z != 0) {
                  ...
                  r23.y = r23.y + -r21.x;
                  r23.y = r7.w * r23.y + r21.x;
                  r23.y = r23.y * r16.w;
                  r18.w = cmp(0 < r18.w);
                  r25.xyz = r23.yyy * r34.xyz + r19.xyz;
                  r22.xyz = r22.xyz * r18.zzz + r8.xyz;
                  r18.z = dot(r22.xyz, r22.xyz);
                  r18.z = rsqrt(r18.z);
                  r22.xyz = r22.xyz * r18.zzz;
                  r18.z = dot(r22.xyz, r8.xyz);
                  r22.x = dot(r2.xyz, r22.xyz);
                  r22.y = abs(r22.x) * r7.z + -abs(r22.x);
  ...
  r1.w = cmp(r0.w < 1);
  if (r1.w != 0) {
    r1.w = edgeColorMap.Sample(colorSampler_s, v2.xy).w;
    r2.xyzw = edgeEmissiveMap.Sample(colorSampler_s, v2.xy).xyzw;
  ...
  r0.w = r0.w * r6.w;
  r1.w = alphaMask.Sample(colorSampler_s, w2.xy).x;
