  ...
  out float3 o2 : SV_TARGET2)
{
  ...
  r0.xyz = postFxBloom00.xxx * r1.xyz;
  r0.w = dot(r1.xyz, postFxBloom00.yzw);
  r0.xyzw = float4(5.55555534,5.55555534,5.55555534,5.55555534) * r0.xyzw;
  r0.xyzw = log2(r0.xyzw);
  r1.xyzw = cmp(r0.xyzw < float4(0,0,0,0));
  r2.xyzw = postFxBloom01.xxxy * r0.xyzw;
  r0.xyzw = postFxBloom01.zzzw * r0.xyzw;
  r0.xyzw = r1.xyzw ? r2.xyzw : r0.xyzw;
  r0.xyzw = exp2(r0.xyzw);
  o0.xyzw = float4(0.180000007,0.180000007,0.180000007,0.180000007) * r0.xyzw;
  return;
}