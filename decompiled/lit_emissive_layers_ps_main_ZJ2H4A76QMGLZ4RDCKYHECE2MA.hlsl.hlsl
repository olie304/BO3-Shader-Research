...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  if (r1.w != 0) {
    ...
    r15.y = r15.x;
    r15.z = r14.x;
    r16.x = dot(r15.yz, r8.zw);
    r15.x = -r14.x;
    r16.y = dot(r15.xy, r8.zw);
    r8.zw = gameTime.ww * scrollUVs2.xy;
    r8.zw = r8.zw * scaleUVs2.xy + r16.xy;
  ...
  if (r1.w != 0) {
    ...
    r13.x = clampU3 ? r5.x : r1.x;
    r13.y = clampV3 ? r5.y : r1.y;
  }
  ...
  r8.w = 0;
  while (true) {
    r11.w = cmp((uint)r8.w >= numLights);
    if (r11.w != 0) break;
    r11.z = (uint)r8.w >> 5;
    r16.xyz = (int3)r11.xyz + (int3)r12.xyz;
    r11.z = visibleLights.Load(r16.xyzw).x;
    r16.xyz = r10.yzw;
    r29.xyz = r27.xyz;
    r30.xyz = r28.xyz;
    r11.w = r7.w;
              ...
              if (r27.w != 0) {
                ...
                if (r27.w != 0) {
                  ...
                  while (true) {
                    ...
                    if (r38.w != 0) break;
                    r43.y = dot(icb[r30.w+0].yx, r9.xy);
                    r43.z = dot(icb[r30.w+0].yx, r9.yz);
