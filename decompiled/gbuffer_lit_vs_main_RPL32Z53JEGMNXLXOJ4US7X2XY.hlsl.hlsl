...
r0.x = shaderConstantSetBuffer[]..swiz;
  ...
  r1.xyz = vertPush * r0.yzw;
  r1.xyz = r1.xyz * r0.xxx;
  r1.xyz = r1.xyz * v1.www + v0.xyz;
  r1.w = 1;
// Known bad code for instruction (needs manual fix):
...
r5.w = shaderConstantSetBuffer[]..swiz;
  ...
  r4.w = r3.y;
  r0.x = dot(r1.xyzw, r4.xyzw);
  r6.xyzw = viewProjectionMatrix._m10_m11_m12_m13 * r0.xxxx;
  r2.w = r3.x;
  r5.w = r3.z;
  r0.x = dot(r1.xyzw, r2.xyzw);
  r3.xyzw = r0.xxxx * viewProjectionMatrix._m00_m01_m02_m03 + r6.xyzw;
  r0.x = dot(r1.xyzw, r5.xyzw);
  r1.xyzw = r0.xxxx * viewProjectionMatrix._m20_m21_m22_m23 + r3.xyzw;
  ...
  r3.xyz = r1.yzx * r0.wyz;
  r0.xyz = r0.zwy * r1.zxy + -r3.xyz;
  r0.w = v4.w * 2 + -1;
