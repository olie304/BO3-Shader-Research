...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  if (r5.w != 0) {
    ...
    if (r5.w != 0) {
      ...
      r3.w = saturate(r3.w);
      r12.yzw = -v7.xyz * r1.www + sunConstants.wldDir.xyz;
