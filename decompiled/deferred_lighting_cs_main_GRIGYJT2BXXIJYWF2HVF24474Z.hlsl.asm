...
add r0.w, r0.w, r0.w
mad r15.xyz, r12.xyzx, -r0.wwww, -r13.xyzx
...
if_nz r2.w
  ...
  if_nz r2.w
    ...
    mad r17.xyw, r2.wwww, r18.xyxz, r17.xyxz
    ...
    sample_l_indexable(texture2d)(float,float,float,float) r3.y, r16.xyxx, t28.yxzw, s1, r2.w
    mad r20.xyz, r18.xyzx, l(0.031250, 0.031250, 0.031250, 0.000000), r16.xyzx
    sample_l_indexable(texture2d)(float,float,float,float) r3.z, r20.xyxx, t28.yzxw, s1, r2.w
    min r3.y, |r3.y|, |r3.z|
    mul r3.y, r20.z, r3.y
    ...
    sample_l_indexable(texture2d)(float,float,float,float) r4.w, r20.xyxx, t28.yzwx, s1, r2.w
    min r3.z, |r3.z|, |r4.w|
    mul r3.z, r20.z, r3.z
    lt r3.z, r3.z, l(1.000000)
    iadd r6.w, r3.y, l(8)
    ...
    movc r3.y, r4.w, r6.w, r3.y
    sample_l_indexable(texture2d)(float,float,float,float) r2.w, r14.yzyy, t28.yzwx, s1, r2.w
    min r2.w, |r3.z|, |r2.w|
    mul r2.w, r17.w, r2.w
    ...
    loop 
      ...
      mad r17.xyw, r18.xyxz, r10.zzzz, r16.xyxz
      sample_l_indexable(texture2d)(float,float,float,float) r10.z, r17.xyxx, t28.yzxw, s1, l(0.000000)
      ...
      if_nz r10.w
        if_nz r20.z
          ...
          movc r14.yz, r10.wwww, r17.xxyx, r3.yyzy
          mov r20.z, r17.w
          mov r22.x, r7.w
          movc r23.xyz, r10.wwww, r20.zxyz, r22.xyzx
          mov r6.w, r20.x
          mov r20.z, l(-1)
          mov r3.yz, r14.yyzy
          mov r7.w, r23.x
      ...
      loop 
        ...
        mad r23.xyz, r19.xyzx, r23.xxxx, r17.xywx
  ...
  mad r14.yz, r10.yyzy, l(0.000000, -2.000000, -2.000000, 0.000000), l(0.000000, 3.000000, 3.000000, 0.000000)
  mul r10.yz, r10.yyzy, r10.yyzy
  mad r10.yz, -r14.yyzy, r10.yyzy, l(0.000000, 1.000000, 1.000000, 0.000000)
...
mad r14.yz, -r3.yyyy, l(0.000000, 10.000000, 5.000000, 0.000000), l(0.000000, 6.857410, 7.085000, 0.000000)
exp r6.w, r14.y
mul r6.w, r2.x, r6.w
...
loop 
  ...
  bfi r16.w, r8.w, l(0), l(0), r14.z
  movc r14.z, r14.w, r16.w, r14.z
  ieq r14.w, r9.w, r14.y
  ...
  loop 
    ...
    add r25.xyz, r11.xyzx, -cb10[r16.w + 0].xyzx
    and r17.w, l(0x0000ffff), cb10[r16.w + 7].z
    ubfe r18.z, l(6), l(25), cb10[r16.w + 7].z
    imul null, r18.w, r17.w, l(6)
    dp3 r19.w, cb11[r18.w + 0].xyzx, r25.xyzx
    add_sat r19.w, r19.w, cb11[r18.w + 0].w
    dp3 r20.w, cb11[r18.w + 1].xyzx, r25.xyzx
    add_sat r20.w, r20.w, cb11[r18.w + 1].w
    mul r19.w, r19.w, r20.w
    dp3 r20.w, cb11[r18.w + 2].xyzx, r25.xyzx
    add_sat r20.w, r20.w, cb11[r18.w + 2].w
    mul r19.w, r19.w, r20.w
    dp3 r20.w, cb11[r18.w + 3].xyzx, r25.xyzx
    add_sat r20.w, r20.w, cb11[r18.w + 3].w
    mul r19.w, r19.w, r20.w
    dp3 r20.w, cb11[r18.w + 4].xyzx, r25.xyzx
    add_sat r20.w, r20.w, cb11[r18.w + 4].w
    mul r19.w, r19.w, r20.w
    dp3 r20.w, cb11[r18.w + 5].xyzx, r25.xyzx
    add_sat r18.w, r20.w, cb11[r18.w + 5].w
    mul r16.x, r18.w, r19.w
    and r18.w, l(1), cb10[r16.w + 6].x
    movc r26.xy, r18.wwww, r16.xyxx, r16.zxzz
    mov r16.x, cb10[r16.w + 6].x
    mov r27.xy, r26.xyxx
    mov r18.w, l(1)
    loop 
      ige r19.w, r18.w, r18.z
      breakc_nz r19.w
      iadd r19.w, r17.w, r18.w
      ...
      movc r18.y, r26.w, r19.w, r27.z
      movc r27.xy, r26.zzzz, r27.xyxx, r18.xyxx
      iadd r18.w, r18.w, l(1)
      mov r16.x, r25.w
    endloop 
    mov_sat r27.y, r27.y
    mul r16.x, r27.y, cb10[r16.w + 6].y
    lt r17.w, l(0.000000), r16.x
    if_nz r17.w
      mad r24.z, r27.y, cb10[r16.w + 6].y, r24.z
      mul r16.x, r16.x, cb10[r16.w + 7].y
      mov r26.x, cb10[r16.w + 7].w
      mov r26.yz, cb10[r16.w + 8].xxyx
      dp3 r17.w, r15.xyzx, r26.xyzx
      dp3 r18.y, r25.xyzx, r26.xyzx
      add r18.y, r18.y, -cb10[r16.w + 8].z
      ...
      mov r26.x, cb10[r16.w + 8].w
      mov r26.yz, cb10[r16.w + 9].xxyx
      dp3 r18.y, r15.xyzx, r26.xyzx
      dp3 r18.z, r25.xyzx, r26.xyzx
      add r18.z, r18.z, -cb10[r16.w + 9].z
      ...
      mov r26.x, cb10[r16.w + 9].w
      mov r26.yz, cb10[r16.w + 10].xxyx
      dp3 r18.y, r15.xyzx, r26.xyzx
      dp3 r18.z, r25.xyzx, r26.xyzx
      add r18.z, r18.z, -cb10[r16.w + 10].z
      ge r18.w, r18.z, l(0.000000)
      max r18.z, r4.w, |r18.z|
      movc r18.z, r18.w, r18.z, -r18.z
      max r18.y, -r18.y, l(0.00000010)
      div r18.y, r18.z, r18.y
      min r17.w, r17.w, |r18.y|
      mov r26.x, cb10[r16.w + 10].w
      mov r26.yz, cb10[r16.w + 11].xxyx
      dp3 r18.y, r15.xyzx, r26.xyzx
      dp3 r18.z, r25.xyzx, r26.xyzx
      add r18.z, r18.z, -cb10[r16.w + 11].z
      ge r18.w, r18.z, l(0.000000)
      max r18.z, r4.w, |r18.z|
      movc r18.z, r18.w, r18.z, -r18.z
      max r18.y, -r18.y, l(0.00000010)
      div r18.y, r18.z, r18.y
      min r17.w, r17.w, |r18.y|
      mov r26.x, cb10[r16.w + 11].w
      mov r26.yz, cb10[r16.w + 12].xxyx
      dp3 r18.y, r15.xyzx, r26.xyzx
      dp3 r18.z, r25.xyzx, r26.xyzx
      add r18.z, r18.z, -cb10[r16.w + 12].z
      ge r18.w, r18.z, l(0.000000)
      max r18.z, r4.w, |r18.z|
      movc r18.z, r18.w, r18.z, -r18.z
      max r18.y, -r18.y, l(0.00000010)
      div r18.y, r18.z, r18.y
      min r17.w, r17.w, |r18.y|
      mov r26.x, cb10[r16.w + 12].w
      mov r26.yz, cb10[r16.w + 13].xxyx
      dp3 r18.y, r15.xyzx, r26.xyzx
      dp3 r18.z, r25.xyzx, r26.xyzx
      add r18.z, r18.z, -cb10[r16.w + 13].z
      ge r18.w, r18.z, l(0.000000)
      max r18.z, r4.w, |r18.z|
      movc r18.z, r18.w, r18.z, -r18.z
      max r18.y, -r18.y, l(0.00000010)
      div r18.y, r18.z, r18.y
      min r17.w, r17.w, |r18.y|
      add r26.x, r25.x, cb10[r16.w + 3].w
      add r26.yz, r25.yyzy, cb10[r16.w + 4].xxyx
      mad r18.yzw, r15.xxyz, r17.wwww, r26.xxyz
      dp3 r19.w, r18.yzwy, r18.yzwy
      sqrt r19.w, r19.w
      div r17.w, r17.w, r19.w
      add r17.w, r17.w, r17.w
      sqrt r17.w, r17.w
      mad r17.w, r3.y, l(5.000000), r17.w
      add r17.w, r17.w, l(-0.844800)
      mov r26.x, cb10[r16.w + 0].w
      mov r26.y, cb10[r16.w + 1].z
      mov r26.z, cb10[r16.w + 2].y
      dp3 r28.x, r18.yzwy, r26.xyzx
      ...
      ubfe r18.y, l(9), l(16), cb10[r16.w + 7].z
      utof r28.w, r18.y
      sample_l_indexable(texturecubearray)(float,float,float,float) r18.yzw, r28.xyzw, t8.wxyz, s2, r17.w
      dp3 r31.x, r25.xyzx, r26.xyzx
      dp3 r31.y, r25.xyzx, r29.xyzx
      dp3 r31.z, r25.xyzx, r30.xyzx
      mad_sat r25.xyz, r31.xyzx, cb10[r16.w + 3].xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
      mul r31.xy, r25.xyxx, cb10[r16.w + 4].zwzz
      mul r31.z, r25.z, cb10[r16.w + 5].x
      add r25.xyz, r31.xyzx, cb10[r16.w + 5].yzwy
      dp3 r28.x, r12.xyzx, r26.xyzx
      dp3 r28.y, r12.xyzx, r29.xyzx
      dp3 r28.z, r12.xyzx, r30.xyzx
      lt r26.xyz, l(0.000000, 0.000000, 0.000000, 0.000000), r28.xyzx
      ...
      mad r26.xyw, r27.xzxw, r29.xxxx, r26.xyxw
      ...
      mad r25.xyz, r25.xyzx, r29.zzzz, r26.xywx
      ...
      dp3 r16.w, r27.xzwx, l(0.212600, 0.715200, 0.072200, 0.000000)
...
if_nz r9.w
  ...
  loop 
    ...
    ieq r17.w, r0.z, r13.w
    ubfe r18.z, r8.w, l(0), r16.w
    movc r16.w, r17.w, r18.z, r16.w
    ...
    loop 
      ...
      ubfe r20.w, l(6), l(25), cb10[r18.w + 7].z
      imul null, r25.w, r19.w, l(6)
      dp3 r26.w, cb11[r25.w + 0].xyzx, r26.xyzx
      add_sat r26.w, r26.w, cb11[r25.w + 0].w
      dp3 r27.x, cb11[r25.w + 1].xyzx, r26.xyzx
      add_sat r27.x, r27.x, cb11[r25.w + 1].w
      mul r26.w, r26.w, r27.x
      dp3 r27.x, cb11[r25.w + 2].xyzx, r26.xyzx
      add_sat r27.x, r27.x, cb11[r25.w + 2].w
      mul r26.w, r26.w, r27.x
      dp3 r27.x, cb11[r25.w + 3].xyzx, r26.xyzx
      add_sat r27.x, r27.x, cb11[r25.w + 3].w
      mul r26.w, r26.w, r27.x
      dp3 r27.x, cb11[r25.w + 4].xyzx, r26.xyzx
      add_sat r27.x, r27.x, cb11[r25.w + 4].w
      mul r26.w, r26.w, r27.x
      dp3 r27.x, cb11[r25.w + 5].xyzx, r26.xyzx
      add_sat r25.w, r27.x, cb11[r25.w + 5].w
      mul r16.x, r25.w, r26.w
      and r25.w, l(1), cb10[r18.w + 6].x
      movc r27.xy, r25.wwww, r16.xyxx, r16.zxzz
      mov r16.x, cb10[r18.w + 6].x
      mov r28.xy, r27.xyxx
      mov r25.w, l(1)
      loop 
        ige r26.w, r25.w, r20.w
        breakc_nz r26.w
        iadd r26.w, r19.w, r25.w
        ...
        movc r18.y, r28.w, r26.w, r29.x
        movc r28.xy, r28.zzzz, r28.xyxx, r18.xyxx
        iadd r25.w, r25.w, l(1)
        mov r16.x, r27.w
      endloop 
      add_sat r16.x, -r17.w, r28.y
      mul r18.y, r16.x, cb10[r18.w + 6].y
      lt r19.w, l(0.000000), r18.y
      if_nz r19.w
        mad r24.w, r16.x, cb10[r18.w + 6].y, r24.w
        mul r16.x, r18.y, cb10[r18.w + 7].y
        ...
        add r20.w, r20.w, -cb10[r18.w + 9].z
        ...
        dp3 r19.w, r15.xyzx, r27.xyzx
        dp3 r20.w, r26.xyzx, r27.xyzx
        add r20.w, r20.w, -cb10[r18.w + 10].z
        ge r25.w, r20.w, l(0.000000)
        max r20.w, r4.w, |r20.w|
        movc r20.w, r25.w, r20.w, -r20.w
        max r19.w, -r19.w, l(0.00000010)
        ...
        dp3 r19.w, r15.xyzx, r27.xyzx
        dp3 r20.w, r26.xyzx, r27.xyzx
        add r20.w, r20.w, -cb10[r18.w + 11].z
        ge r25.w, r20.w, l(0.000000)
        max r20.w, r4.w, |r20.w|
        movc r20.w, r25.w, r20.w, -r20.w
        max r19.w, -r19.w, l(0.00000010)
        ...
        dp3 r19.w, r15.xyzx, r27.xyzx
        dp3 r20.w, r26.xyzx, r27.xyzx
        add r20.w, r20.w, -cb10[r18.w + 12].z
        ge r25.w, r20.w, l(0.000000)
        max r20.w, r4.w, |r20.w|
        movc r20.w, r25.w, r20.w, -r20.w
        max r19.w, -r19.w, l(0.00000010)
        ...
        dp3 r19.w, r15.xyzx, r27.xyzx
        dp3 r20.w, r26.xyzx, r27.xyzx
        add r20.w, r20.w, -cb10[r18.w + 13].z
        ge r25.w, r20.w, l(0.000000)
        max r20.w, r4.w, |r20.w|
        movc r20.w, r25.w, r20.w, -r20.w
        max r19.w, -r19.w, l(0.00000010)
        ...
        sqrt r18.y, r18.y
        mad r18.y, r3.y, l(5.000000), r18.y
        ...
        mad_sat r26.xyz, r33.xyzx, cb10[r18.w + 3].xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
        mul r33.xy, r26.xyxx, cb10[r18.w + 4].zwzz
        mul r33.z, r26.z, cb10[r18.w + 5].x
        add r26.xyz, r33.xyzx, cb10[r18.w + 5].yzwy
...
rcp r0.y, r0.y
mov_sat r22.w, r22.w
mul r14.yzw, r0.yyyy, r21.xxyz
mul r16.xyz, r0.yyyy, r22.xyzx
...
if_nz r0.z
  ...
  dp3 r3.y, r17.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
  mad r14.yzw, r21.xxyz, r0.yyyy, r17.xxyz
  mov r15.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r17.xyz, r15.xyzw, t8.xyzw, s2, r3.z
...
switch r1.w
  ...
  mad r10.yzw, -r16.xxyz, l(0.000000, 0.500000, 0.500000, 0.500000), cb9[r0.x + 0].xxyz
  add r17.xyz, -r11.xyzx, r10.yzwy
  dp3 r4.w, r16.xyzx, r17.xyzx
  div_sat r5.z, -r4.w, cb9[r0.x + 6].y
  mad r18.xyz, r5.zzzz, r16.xyzx, r10.yzwy
  ...
  if_nz r9.w
    ...
    if_nz r9.w
      ...
      if_nz r9.w
        ...
        dp3 r12.w, r16.xyzx, r15.xyzx
        dp3 r13.w, r15.xyzx, r17.xyzx
        mad r15.x, -r12.w, r12.w, cb9[r0.x + 6].y
        mad r4.w, r12.w, r13.w, -r4.w
        div_sat r4.w, r4.w, r15.x
        div r12.w, r15.x, cb9[r0.x + 6].y
        mul r12.w, r12.w, l(10.000000)
        min r12.w, r12.w, l(1.000000)
        add r4.w, -r5.z, r4.w
        mad r4.w, r12.w, r4.w, r5.z
        mad r10.yzw, r4.wwww, r16.xxyz, r10.yyzw
        movc r10.yzw, r1.wwww, r10.yyzw, cb9[r0.x + 0].xxyz
        ...
        if_nz r5.z
          ...
          if_z r12.w
            ...
            if_nz cb2[58].y
              ...
              utof r17.z, r12.w
              sample_c_lz_indexable(texture2darray)(float,float,float,float) r13.w, r17.xyzx, t9.xxxx, s13, r5.z
            endif 
        ...
        mad r10.yzw, r10.yyzw, r1.wwww, r13.xxyz
        dp3 r1.w, r10.yzwy, r10.yzwy
        rsq r1.w, r1.w
        mul r10.yzw, r1.wwww, r10.yyzw
        dp3 r1.w, r10.yzwy, r13.xyzx
        ...
        mul r4.w, r4.w, r7.w
        mul r4.w, r6.w, r4.w
        mad r10.yzw, r4.wwww, r16.xxyz, r2.yyzw
        add_sat r1.w, -r1.w, l(1.000000)
        mul r6.w, r1.w, r1.w
        mul r6.w, r6.w, r6.w
        mul r1.w, r1.w, r6.w
        mul r1.w, r1.w, r4.w
        mad r15.xyz, r1.wwww, r16.xyzx, r14.yzwy
        movc r3.yzw, r5.zzzz, r17.xxyz, r3.yyzw
        movc r14.yzw, r5.zzzz, r15.xxyz, r14.yyzw
  ...
  rsq r1.w, r1.w
  mul r10.yzw, r1.wwww, r15.xxyz
  dp3 r4.w, r12.xyzx, r10.yzwy
  mov_sat r5.z, r4.w
  ...
  if_nz r6.w
    ...
    if_nz r7.w
      ...
      if_nz r6.w
        ...
        iadd r6.w, r6.w, l(-1)
        utof r17.z, r6.w
        sample_l_indexable(texture2darray)(float,float,float,float) r10.yzw, r17.xyzx, t20.wxyz, s2, l(0.000000)
      else 
        mov r10.yzw, l(0,1.000000,1.000000,1.000000)
      endif 
    endif 
    ...
    if_nz r6.w
      ...
      if_nz r7.w
        ...
        mad r16.xyz, r0.xxxx, r10.yzwy, r3.yzwy
        mad r15.xyz, r15.xyzx, r1.wwww, r13.xyzx
        dp3 r0.x, r15.xyzx, r15.xyzx
        rsq r0.x, r0.x
        mul r15.xyz, r0.xxxx, r15.xyzx
        dp3 r0.x, r15.xyzx, r13.xyzx
        dp3 r1.w, r12.xyzx, r15.xyzx
        ...
        mad r12.xyz, r0.yyyy, r10.yzwy, r2.yzwy
        add_sat r0.x, -r0.x, l(1.000000)
        mul r0.z, r0.x, r0.x
        mul r0.z, r0.z, r0.z
        mul r0.x, r0.z, r0.x
        mul r0.x, r0.x, r0.y
        mad r0.xyz, r0.xxxx, r10.yzwy, r14.yzwy
        movc r3.yzw, r1.zzzz, r16.xxyz, r3.yyzw
        movc r14.yzw, r1.zzzz, r0.xxyz, r14.yyzw
        movc r2.yzw, r1.zzzz, r12.xxyz, r2.yyzw
      endif 
    endif 
  endif 
  break 
...
ret 
// Approximately 1859 instruction slots used
