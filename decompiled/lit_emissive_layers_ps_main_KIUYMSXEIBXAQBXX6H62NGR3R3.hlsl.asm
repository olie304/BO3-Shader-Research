...
mul r1.xw, cb0[34].xxxy, cb1[69].wwww
mad r1.xw, v2.xxxy, cb0[34].zzzw, r1.xxxw
sample_indexable(texture2d)(float,float,float,float) r1.xw, r1.xwxx, t38.xzwy, s5
mad r1.xw, r1.xxxw, l(1.99218750, 0.000000, 0.000000, 1.99218750), l(-1.000000, 0.000000, 0.000000, -1.000000)
mul r1.xw, r1.xxxw, cb1[44].zzzw
...
if_nz r3.x
  ...
  round_z r3.x, r3.x
  add r3.x, r3.x, v2.x
  div r9.x, r3.x, cb0[11].w
  round_z r3.x, r4.w
  add r3.x, r3.x, v2.y
  div r9.y, r3.x, cb0[11].z
else 
...
mad r7.zw, r1.xxxw, cb0[35].xxxx, r9.xxxy
...
if_nz r4.w
  ...
  dp3 r4.w, r13.xyzx, r3.yzwy
  lt r5.w, l(0.000000), r4.w
  div r7.zw, -r14.xxxy, r4.wwww
...
mad r7.zw, r1.xxxw, cb0[35].yyyy, r12.xxxy
sample_indexable(texture2d)(float,float,float,float) r12.xyzw, r7.zwzz, t30.xyzw, s1
...
if_nz r4.w
  ...
  mov r5.y, r5.x
  mov r5.z, r4.x
  dp2 r13.x, r5.yzyy, r3.yzyy
  mov r5.x, -r4.x
  dp2 r13.y, r5.xyxx, r3.yzyy
  mul r3.yz, cb0[29].xxyx, cb1[69].wwww
  mad r3.yz, r3.yyzy, cb0[29].zzwz, r13.xxyx
  ...
  movc r12.x, cb0[31].w, r4.x, r3.y
  movc r12.y, cb0[32].x, r4.y, r3.z
endif 
mad r1.xw, r1.xxxw, cb0[35].zzzz, r12.xxxy
sample_indexable(texture2d)(float,float,float,float) r4.xyzw, r1.xwxx, t37.xyzw, s1
mul r3.yzw, r4.xxyz, cb0[27].xxyz
mul r1.x, r4.w, cb0[18].w
mul r3.yzw, r1.xxxx, r3.yyzw
add r1.x, r3.x, cb0[32].z
frc r1.x, r1.x
