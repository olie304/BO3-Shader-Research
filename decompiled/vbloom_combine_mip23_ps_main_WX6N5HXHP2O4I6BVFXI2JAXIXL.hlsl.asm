...
dcl_constantbuffer CB8[33], immediateIndexed
...
mul r1.xyz, r0.wwww, cb8[27].xyzx
mad r0.xyz, r0.xyzx, cb8[24].xyzx, r1.xyzx
sample_indexable(texture2d)(float,float,float,float) r1.xyz, v0.xyxx, t1.xyzw, s0
add r0.xyz, r0.xyzx, r1.xyzx
mov r0.w, l(1.000000)
dp4_sat r1.x, r0.xyzw, cb8[30].xyzw
dp4_sat r1.y, r0.xyzw, cb8[31].xyzw
dp4_sat r1.z, r0.xyzw, cb8[32].xyzw
mul o0.xyz, r1.xyzx, l(256.000000, 256.000000, 256.000000, 0.000000)
ret 
