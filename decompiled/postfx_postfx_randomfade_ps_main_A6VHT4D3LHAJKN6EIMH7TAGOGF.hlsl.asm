...
frc r0.x, r0.x
add r0.x, r0.x, cb8[0].x
ge r0.x, r0.x, l(1.000000)
movc r0.x, r0.x, l(0), l(1.000000)
sample_indexable(texture2d)(float,float,float,float) r1.xyzw, v1.xyxx, t0.xyzw, s0
and r0.yzw, r1.xxyz, l(0, 0x7f800000, 0x7f800000, 0x7f800000)
ine r0.yzw, r0.yyzw, l(0, 0x7f800000, 0x7f800000, 0x7f800000)
mul r1.xyz, r1.xyzx, l(0.00003052, 0.00003052, 0.00003052, 0.000000)
mov o0.w, r1.w
movc r0.yzw, r0.yyzw, r1.xxyz, l(0,2.000000,2.000000,2.000000)
