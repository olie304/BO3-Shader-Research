...
r0.z = samp0[]..swiz;
  ...
  if (r2.z != 0) {
    ...
    r3.xyw = r3.xxx ? r7.xyz : r6.xyw;
    r6.xyz = r6.zzz ? float3(0,1,0) : r1.xyz;
    r1.xyz = r2.www ? r3.xyw : r6.xyz;
  }
  ...
  while (true) {
    ...
    r10.w = cmp((int)r4.w == (int)r9.w);
    if (r5.w == 0) r11.x = 0; else if (r5.w+0 < 32) {     r11.x = (uint)r10.z << (32-(r5.w + 0)); r11.x = (uint)r11.x >> (32-r5.w);    } else r11.x = (uint)r10.z >> 0;
    r10.z = r10.w ? r11.x : r10.z;
    r10.w = (int)r5.z + (int)r9.w;
    r11.xyz = r12.xyz;
    r15.xyz = r13.xyz;
    r16.xyz = r14.xyz;
    r12.w = r6.w;
    ...
    while (true) {
      ...
      r16.w = 1 << (int)r15.w;
      r17.x = (int)r14.w & (int)r16.w;
      if (r17.x != 0) {
        r14.w = (int)r14.w ^ (int)r16.w;
        r16.w = (int)r10.w + (int)r15.w;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=80)(mixed,mixed,mixed,mixed) r17.xyzw, r16.w, l(0), t11.xyzw
      r17.x = samp0[]..swiz;
      r17.y = samp0[]..swiz;
      r17.z = samp0[]..swiz;
      r17.w = samp0[]..swiz;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=80)(mixed,mixed,mixed,mixed) r18.xy, r16.w, l(16), t11.xyxx
      r18.x = samp0[]..swiz;
      r18.y = samp0[]..swiz;
        ...
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=128)(mixed,mixed,mixed,mixed) r17.xyz, r15.w, l(0), t36.xyzx
        r17.x = samp0[]..swiz;
        r17.y = samp0[]..swiz;
        r17.z = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=128)(mixed,mixed,mixed,mixed) r18.xyz, r15.w, l(16), t36.xyzx
        r18.x = samp0[]..swiz;
        r18.y = samp0[]..swiz;
        r18.z = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=128)(mixed,mixed,mixed,mixed) r19.xyz, r15.w, l(32), t36.xyzx
        r19.x = samp0[]..swiz;
        r19.y = samp0[]..swiz;
        r19.z = samp0[]..swiz;
          r20.x = r17.x;
          ...
          r16.w = dot(r21.xyz, v4.xyz);
          r16.w = cmp(r16.w >= 0.5);
          if (r16.w != 0) {
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=128)(mixed,mixed,mixed,mixed) r22.xyw, r15.w, l(48), t36.xyxz
          r22.x = samp0[]..swiz;
          r22.y = samp0[]..swiz;
          r22.w = samp0[]..swiz;
            r20.w = r22.x;
            ...
            if (r16.w != 0) {
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=128)(mixed,mixed,mixed,mixed) r17.xyzw, r15.w, l(64), t36.xyzw
            r17.x = samp0[]..swiz;
            r17.y = samp0[]..swiz;
            r17.z = samp0[]..swiz;
            r17.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=128)(mixed,mixed,mixed,mixed) r18.xyzw, r15.w, l(80), t36.xyzw
            r18.x = samp0[]..swiz;
            r18.y = samp0[]..swiz;
            r18.z = samp0[]..swiz;
            r18.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=128)(mixed,mixed,mixed,mixed) r19.xyzw, r15.w, l(96), t36.xyzw
            r19.x = samp0[]..swiz;
            r19.y = samp0[]..swiz;
            r19.z = samp0[]..swiz;
            r19.w = samp0[]..swiz;
              ...
              if (r20.z != 0) {
                if (4 == 0) r16.w = 0; else if (4+24 < 32) {                 r16.w = (uint)r18.w << (32-(4 + 24)); r16.w = (uint)r16.w >> (32-4);                } else r16.w = (uint)r18.w >> 24;
                r16.w = 1 << (int)r16.w;
                r21.w = (uint)r18.w >> 28;
                r21.w = 1 << (int)r21.w;
                r22.w = cmp((int)r20.z == 4);
                if (r22.w != 0) {
                  r22.w = (int)r18.w & 4095;
                  if (12 == 0) r23.w = 0; else if (12+12 < 32) {                   r23.w = (uint)r18.w << (32-(12 + 12)); r23.w = (uint)r23.w >> (32-12);                  } else r23.w = (uint)r18.w >> 12;
                  r24.w = (int)r19.w & 1023;
                  r26.xz = (uint2)r16.ww;
                  r26.y = (uint)r21.w;
              ...
              r18.w = cmp(r18.x != 1.000000);
              r17.w = r16.w + r17.w;
              r17.w = saturate(r17.w * r18.x + -r18.x);
              r16.w = r18.w ? r17.w : r16.w;
              if (r20.w != 0) {
                if (4 == 0) r17.w = 0; else if (4+24 < 32) {                 r17.w = (uint)r19.y << (32-(4 + 24)); r17.w = (uint)r17.w >> (32-4);                } else r17.w = (uint)r19.y >> 24;
                r17.w = 1 << (int)r17.w;
                r18.x = (uint)r19.y >> 28;
                r18.x = 1 << (int)r18.x;
                r18.w = cmp((int)r20.w == 2);
                if (r18.w != 0) {
                  ...
                  r20.z = cmp((int)r20.w == 4);
                  if (r20.z != 0) {
                    r20.z = (int)r19.y & 4095;
                    if (12 == 0) r26.x = 0; else if (12+12 < 32) {                     r26.x = (uint)r19.y << (32-(12 + 12)); r26.x = (uint)r26.x >> (32-12);                    } else r26.x = (uint)r19.y >> 12;
                    if (10 == 0) r26.y = 0; else if (10+20 < 32) {                     r26.y = (uint)r19.w << (32-(10 + 20)); r26.y = (uint)r26.y >> (32-10);                    } else r26.y = (uint)r19.w >> 20;
                    r27.xz = (uint2)r17.ww;
                    r27.y = (uint)r18.x;
                    ...
                    r28.x = (uint)r20.z;
                    r28.yz = (uint2)r26.xy;
                    r20.zw = r28.xy + r26.zw;
                    r28.xy = invBcTexSizes.xy * r20.zw;
                    r26.xyz = invBcTexSizes.xyx * r24.zyz;
                    r26.xyz = r26.xyz * r27.xyz;
                    r29.xyz = invBcTexSizes.xyx * r25.zyz;
                    r27.xyz = r29.xyz * r27.xyz;
                    ...
                    r28.yz = (uint2)r26.xy;
                    r20.zw = r28.xy + r26.zw;
                    r28.xy = invBcTexSizes.zw * r20.zw;
                    r26.xyz = invBcTexSizes.zwz * r24.zyz;
                    r26.xyz = r26.xyz * r27.xyz;
                ...
                r26.xyz = r18.www * float3(0.959999979,0.959999979,0.959999979) + float3(0.0399999991,0.0399999991,0.0399999991);
                r17.w = saturate(1 + -r18.w);
              ...
              if (r18.x != 0) {
                ...
                r15.w = samp0[]..swiz;
                  ...
                  r18.z = (uint)r19.z >> 28;
                  r18.z = 1 << (int)r18.z;
                  r19.y = (int)r19.z & 4095;
                  r15.w = (int)r15.w & 1023;
                  r27.xz = (uint2)r17.ww;
                  r27.y = (uint)r18.z;
                  r20.zw = r20.xy * r27.zy + float2(0.5,0.5);
                  r28.xy = float2(-0.5,-0.5) + r27.zy;
                  r20.zw = min(r28.xy, r20.zw);
                  r28.x = (uint)r19.y;
                  r28.y = (uint)r18.w;
                  r18.zw = r28.xy + r20.zw;
              ...
              if (r18.y != 0) {
                ...
                r17.w = dot(r18.xy, r18.xy);
                r17.w = 1 + -r17.w;
                r17.w = max(0, r17.w);
                r17.w = sqrt(r17.w);
                r18.z = r18.z * r18.z;
                r18.z = 0.333333343 * r18.z;
                r18.z = min(1, r18.z);
                r18.w = dot(r23.xyz, r23.xyz);
                r18.w = rsqrt(r18.w);
                r19.xyz = r23.xyz * r18.www;
                r18.w = dot(-r22.xyz, -r22.xyz);
                r18.w = rsqrt(r18.w);
                r20.xyz = -r22.xyz * r18.www;
                ...
                r18.z = r18.z + r18.w;
                r18.z = log2(r18.z);
                r18.z = -0.0588235296 * r18.z;
                r15.w = max(0, r18.z);
                r18.yzw = r20.xyz * r18.yyy;
                r18.xyz = r19.xyz * r18.xxx + r18.yzw;
                r18.xyz = r21.xyz * r17.www + r18.xyz;
                r17.w = dot(r18.xyz, r18.xyz);
                r17.w = rsqrt(r17.w);
                r18.xyz = r18.xyz * r17.www;
                r17.w = 1 + -r16.w;
                r19.xyz = r17.www * r15.xyz;
                r15.xyz = r18.xyz * r16.www + r19.xyz;
              }
              r17.w = 1 + -r16.w;
              r18.xyz = r17.www * r11.xyz;
              r11.xyz = r17.xyz * r16.www + r18.xyz;
              r17.xyz = r17.www * r16.xyz;
              r16.xyz = r26.xyz * r16.www + r17.xyz;
              r12.w = r12.w * r17.w + r16.w;
              r17.x = r17.w * r13.w;
              r13.w = r15.w * r16.w + r17.x;
            }
          }
        }
      }
  ...
  r6.w = saturate(r6.w);
  r3.z = 1 + -r6.w;
  r1.xyz = r1.xyz * r3.zzz + r12.xyz;
  r0.w = r0.w * r3.z + r6.w;
  r2.yzw = r2.yzw * r3.zzz + r13.xyz;
  r4.w = dot(r2.yzw, r2.yzw);
  r4.w = rsqrt(r4.w);
  r6.xyz = r4.www * r2.yzw;
  r7.y = r1.w * r3.z + r7.w;
  r2.yzw = r3.xyw * r3.zzz + r14.xyz;
  r0.z = gameTime.w + -r0.z;
  r0.x = saturate(r0.x);
  r0.x = hdrScale * r0.x;
  r3.xyw = cmp(r0.yyy == float3(3,2,1));
  r0.y = cmp(r0.y < 0);
  r10.xyz = r0.yyy ? float3(1,1,1) : emissiveTint1.xyz;
  r10.xyz = r3.www ? tint1.xyz : r10.xyz;
  r10.xyz = r3.yyy ? tint2.xyz : r10.xyz;
  r3.xyw = r3.xxx ? tint3.xyz : r10.xyz;
  ...
  if (r0.y != 0) {
    ...
    r12.y = r12.x;
    r12.z = r11.x;
    r13.x = dot(r12.yz, r5.zw);
    r12.x = -r11.x;
    r13.y = dot(r12.xy, r5.zw);
    r0.yz = scrollUVs.xy * r0.zz;
    r0.yz = r0.yz * scaleUVs.xy + r13.xy;
    ...
    r5.zw = saturate(r0.yz);
    r10.xy = clampU ? r5.zw : r0.yz;
  }
  r0.y = dot(-v7.xyz, -v7.xyz);
  r0.y = rsqrt(r0.y);
  r11.xyz = -v7.xyz * r0.yyy;
  r0.z = saturate(dot(r11.xyz, r4.xyz));
  r4.xyzw = emissiveMap.Sample(colorSampler_s, r10.xy).xyzw;
  ...
  r0.x = frac(r0.x);
  r4.y = gameTime.w * flickerSpeed + r0.x;
  r4.x = flickerSeed.x;
  r0.x = flickerLookupMap.SampleLevel(lookupSampler_s, r4.xy, 0).x;
  r0.x = log2(abs(r0.x));
  ...
  r7.x = saturate(dot(r6.xyz, r11.xyz));
  r0.z = dot(-r11.xyz, r6.xyz);
  r0.z = r0.z + r0.z;
  r13.xyz = r6.xyz * -r0.zzz + -r11.xyz;
  r0.z = 17 * r7.y;
  r0.z = exp2(r0.z);
  r0.z = 2 + r0.z;
  r0.z = 2 / r0.z;
  ...
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r23.xyzw, r7.z, l(0), t15.wxyz
  r23.x = samp0[]..swiz;
  r23.y = samp0[]..swiz;
  r23.z = samp0[]..swiz;
  r23.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r24.xyzw, r7.z, l(16), t15.xyzw
  r24.x = samp0[]..swiz;
  r24.y = samp0[]..swiz;
  r24.z = samp0[]..swiz;
  r24.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r25.xyzw, r7.z, l(32), t15.yxwz
  r25.x = samp0[]..swiz;
  r25.y = samp0[]..swiz;
  r25.z = samp0[]..swiz;
  r25.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r26.xyzw, r7.z, l(48), t15.xyzw
  r26.x = samp0[]..swiz;
  r26.y = samp0[]..swiz;
  r26.z = samp0[]..swiz;
  r26.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r27.xyzw, r7.z, l(64), t15.zwxy
  r27.x = samp0[]..swiz;
  r27.y = samp0[]..swiz;
  r27.z = samp0[]..swiz;
  r27.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r28.xyzw, r7.z, l(80), t15.xyzw
  r28.x = samp0[]..swiz;
  r28.y = samp0[]..swiz;
  r28.z = samp0[]..swiz;
  r28.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r12.yz, r7.z, l(96), t15.xxyx
  r12.y = samp0[]..swiz;
  r12.z = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r29.xyzw, r7.z, l(116), t15.xyzw
  r29.x = samp0[]..swiz;
  r29.y = samp0[]..swiz;
  r29.z = samp0[]..swiz;
  r29.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r30.xyzw, r7.z, l(132), t15.zwxy
  r30.x = samp0[]..swiz;
  r30.y = samp0[]..swiz;
  r30.z = samp0[]..swiz;
  r30.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r31.xyzw, r7.z, l(148), t15.zwxy
  r31.x = samp0[]..swiz;
  r31.y = samp0[]..swiz;
  r31.z = samp0[]..swiz;
  r31.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r32.xyzw, r7.z, l(164), t15.zwxy
  r32.x = samp0[]..swiz;
  r32.y = samp0[]..swiz;
  r32.z = samp0[]..swiz;
  r32.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r33.xyzw, r7.z, l(180), t15.zwxy
  r33.x = samp0[]..swiz;
  r33.y = samp0[]..swiz;
  r33.z = samp0[]..swiz;
  r33.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r34.xyzw, r7.z, l(196), t15.xyzw
  r34.x = samp0[]..swiz;
  r34.y = samp0[]..swiz;
  r34.z = samp0[]..swiz;
  r34.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r35.xy, r7.z, l(212), t15.xyxx
  r35.x = samp0[]..swiz;
  r35.y = samp0[]..swiz;
  ...
  if (r5.w == 0) {
    ...
    while (true) {
      ...
      r12.z = cmp((int)r7.z == (int)r11.w);
      bitmask.w = ((~(-1 << r7.w)) << 0) & 0xffffffff;  r12.w = (((uint)0 << 0) & bitmask.w) | ((uint)r12.y & ~bitmask.w);
    ...
    if (r9.w != 0) {
      ...
      r10.w = 0;
      while (true) {
        r11.w = cmp((uint)r10.w >= (uint)r5.w);
        if (r11.w != 0) break;
        r14.z = (uint)r10.w >> 5;
        r15.xyz = (int3)r9.xyz + (int3)r14.xyz;
        r11.w = visibleProbes.Load(r15.xyzw).x;
        r14.z = cmp((int)r7.z == (int)r10.w);
        if (r7.w == 0) r14.w = 0; else if (r7.w+0 < 32) {         r14.w = (uint)r11.w << (32-(r7.w + 0)); r14.w = (uint)r14.w >> (32-r7.w);        } else r14.w = (uint)r11.w >> 0;
    ...
    if (r4.w != 0) {
      ...
      r5.z = dot(r12.yzw, float3(0.212599993,0.715200007,0.0722000003));
      r21.xyz = r23.xyz * r4.yyy + r12.yzw;
      r13.w = 0;
      r12.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r13.xyzw, r4.z).xyz;
      r4.y = sunConstants.globalProbeExposure * r4.w + -r5.z;
      r4.y = r7.y * r4.y + r5.z;
      r22.xyz = r12.yzw * r4.yyy + r22.xyz;
    }
  } else {
    r22.x = r21.w;
  }
  ...
  r7.yzw = r22.xyz * r4.yyy;
  r15.xyz = r7.zwy * r4.zzz;
  r4.yzw = r7.yzw * r4.www;
  r2.x = sqrt(r1.w);
  r2.x = r2.x * 0.5 + 0.5;
  r2.x = r2.x * r2.x;
  r5.z = 0.5 * r2.x;
  ...
  r2.x = r5.w * r2.x;
  r5.z = r5.z * r5.w;
  r5.w = dot(r6.xyz, sunConstants.wldDir.xyz);
  r6.w = saturate(r5.w);
  r7.y = cmp(0 >= r6.w);
  if (r7.y != 0) {
    r7.z = 0;
  ...
  if (r7.y == 0) {
    ...
    r7.y = -sunConstants.splitDepthOffset + r12.w;
    ...
    if (r7.w != 0) {
      ...
      while (true) {
        ...
        if (r10.w != 0) break;
        r10.w = (uint)r7.w;
        r16.xy = -sunConstants.splitPinTransform[r10.w].xy + r12.yz;
    ...
    if (r10.w == 0) {
      if (enableDitheredShadow == 0) {
        ...
        r16.z = r10.w + r7.w;
        r10.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r7.y).x;
      ...
      if (enableDitheredShadow != 0) {
        ...
        r9.w = 28 * r9.w;
        r9.w = (uint)r9.w;
        r17.xy = -sunConstants.splitPinTransform[r10.w].xy + r12.yz;
        ...
        while (true) {
          ...
          r18.z = (uint)r13.w;
          r13.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r18.xyz, r7.y).x;
  ...
  if (r7.y != 0) {
    r7.y = cmp(0 < r7.z);
    if (r7.y != 0) {
      r7.y = sunConstants.specScale * r0.z;
      r7.y = r7.y * r6.w;
      if (sunConstants.sunCookieIndex != 0) {
        ...
        r16.z = (uint)r7.w;
        r8.xyz = gCookieArray.SampleLevel(samplerLinear_s, r16.xyz, 0).xyz;
      ...
      r8.zw = r7.yz;
      r15.zw = r4.yz;
      r8.xyzw = r5.wwww ? r8.xyzw : r15.xyzw;
      r4.w = r5.w ? r7.w : r4.w;
      r15.z = r14.w;
      r15.xy = r8.xy;
      r4.yz = r8.zw;
              ...
              if (r26.w != 0) {
                ...
                if (r26.w != 0) {
                  ...
                  while (true) {
                    ...
                    if (r30.w != 0) break;
                    r43.y = dot(icb[r29.w+0].yx, r8.xy);
                    r43.z = dot(icb[r29.w+0].yx, r8.yz);
                ...
                if (r26.w != 0) {
                  ...
                  r14.w = saturate(dot(r6.xyz, r39.xyz));
                  r38.xyz = r38.xyz * r13.www + r11.xyz;
                  r13.w = dot(r38.xyz, r38.xyz);
                  r13.w = rsqrt(r13.w);
                  r38.xyz = r38.xyz * r13.www;
                  r13.w = dot(r38.xyz, r11.xyz);
                  r18.x = dot(r6.xyz, r38.xyz);
                  r24.w = abs(r18.x) * r0.z + -abs(r18.x);
                  r18.x = abs(r18.x) * r24.w + 1;
                  r24.w = r14.w * r2.x + r5.z;
                  r18.x = r18.x * r18.x;
                  r18.x = r18.x * r24.w;
                  r18.x = rcp(r18.x);
                  r14.w = r14.w * r26.w;
            ...
            r39.w = samp0[]..swiz;
              ...
              if (r18.x != 0) {
                ...
                if (r18.x != 0) {
                  ...
                  r19.xyz = r19.xyz * r13.www + r11.xyz;
                  r13.w = dot(r19.xyz, r19.xyz);
                  r13.w = rsqrt(r13.w);
                  r19.xyz = r19.xyz * r13.www;
                  r13.w = dot(r19.xyz, r11.xyz);
                  r19.x = dot(r6.xyz, r19.xyz);
                  r19.y = abs(r19.x) * r0.z + -abs(r19.x);
                  r19.x = abs(r19.x) * r19.y + 1;
                  r15.w = r15.w * r2.x + r5.z;
                  r19.x = r19.x * r19.x;
                  r15.w = r19.x * r15.w;
                  r15.w = rcp(r15.w);
                  r15.w = r15.w * r18.x;
