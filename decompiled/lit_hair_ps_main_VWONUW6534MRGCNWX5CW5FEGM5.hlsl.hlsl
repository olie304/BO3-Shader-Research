// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:37:10 2021
...
cbuffer _Globals : register(b0)
{
  ...
  float alphaRevealSoftEdge : packoffset(c11.w);
  float alphaRevealRamp : packoffset(c12);
  float scriptControl : packoffset(c12.y);
}
...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  r0.z = r0.z * 0.5 + glossRange.x;
  r0.xz = saturate(float2(0.0588235296,0.0588235296) * r0.xz);
  ...
  r0.z = r2.z + r0.z;
  r0.z = log2(r0.z);
  r0.xz = float2(-0.0588235296,-0.0588235296) * r0.xz;
  ...
  if (r2.z != 0) {
    ...
    r4.w = colorMap.CalculateLevelOfDetail(colorSampler_s, v2.xy);
    r3.x = cmp(r3.x < r4.w);
    r4.w = cmp(0 < r4.w);
  ...
  r0.z = r0.z + -r0.x;
  r0.x = r9.w * r0.z + r0.x;
  r0.z = cmp(anisotropy < 0);
  r0.x = 17 * r0.x;
  r13.y = exp2(r0.x);
  r0.xz = r0.zz ? r13.xy : r13.yx;
  r0.xz = float2(2,2) + r0.xz;
  r0.xz = float2(2,2) / r0.xz;
  ...
  if (r10.w != 0) {
    ...
    if (r10.w != 0) {
      ...
      r13.w = cmp(0 < r9.w);
      r9.w = saturate(r9.w);
      r15.xyz = -v7.xyz * r3.xxx + sunConstants.wldDir.xyz;
  ...
  r10.z = rcp(r9.z);
  r0.xz = r10.zz * r9.xy;
  r10.xy = r0.xz * float2(0.5,-0.5) + float2(0.5,0.5);
  ...
  r0.x = frac(r0.x);
  r0.z = 3.14159989 * r0.x;
  r0.z = gameTick.w * 0.5 + r0.z;
  sincos(r0.z, r3.x, r8.x);
  r11.xyz = r3.xxx * r5.xyz;
  r11.xyz = r8.xxx * r4.xyz + r11.xyz;
  ...
  r0.z = 3.14159989 + r0.z;
  sincos(r0.z, r3.x, r8.x);
  r5.xyz = r3.xxx * r5.xyz;
  r4.xyz = r8.xxx * r4.xyz + r5.xyz;
  ...
  r0.z = dot(renderTargetSize.zw, renderTargetSize.zw);
  r0.z = sqrt(r0.z);
  r1.w = dot(r11.xy, r11.xy);
  r1.w = sqrt(r1.w);
  r1.w = rcp(r1.w);
  r0.z = r1.w * r0.z;
  r5.xy = r0.xx * float2(0.5,0.5) + float2(0.333333343,1);
  r5.xy = float2(0.117647059,0.117647059) * r5.xy;
  r5.xy = r5.xy * r5.xy;
  x1[0].x = r5.x;
  r8.xyz = r11.xyz * r5.xxx + r10.xyz;
  r5.zw = cmp(r0.zz < r5.xy);
  ...
  if (r5.w != 0) {
    r6.zw = r0.xx * float2(0.5,0.5) + float2(1.33333337,2);
    ...
    r13.xy = (int2)r8.xy;
    r13.zw = float2(0,0);
    r5.w = floatZSampler.Load(r13.xyz).x;
    r6.z = cmp(r5.w >= 0.984375);
    r7.w = 1.01587307 * r5.w;
    r5.w = r5.w * 64 + -63;
    r5.w = r6.z ? r5.w : r7.w;
  ...
  if (r1.w == 0) {
    r5.xy = r0.xx * float2(0.5,0.5) + float2(2.33333325,3);
    r5.xy = float2(0.117647059,0.117647059) * r5.xy;
    r1.w = x1[0].x;
    r3.x = x0[0].x;
    r4.w = r5.x * r5.x + -r1.w;
  ...
  if (r1.w == 0) {
    r5.xy = r0.xx * float2(0.5,0.5) + float2(3.33333325,4);
    r5.xy = float2(0.117647059,0.117647059) * r5.xy;
    r1.w = x1[0].x;
    r3.x = x0[0].x;
    r4.w = r5.x * r5.x + -r1.w;
  ...
  if (r1.w == 0) {
    r5.xy = r0.xx * float2(0.5,0.5) + float2(4.33333349,5);
    r5.xy = float2(0.117647059,0.117647059) * r5.xy;
    r1.w = x1[0].x;
    r3.x = x0[0].x;
    r4.w = r5.x * r5.x + -r1.w;
  ...
  if (r1.w == 0) {
    r5.xy = r0.xx * float2(0.5,0.5) + float2(5.33333349,6);
    r5.xy = float2(0.117647059,0.117647059) * r5.xy;
    r1.w = x1[0].x;
    r3.x = x0[0].x;
    r4.w = r5.x * r5.x + -r1.w;
  ...
  if (r1.w == 0) {
    r5.xy = r0.xx * float2(0.5,0.5) + float2(6.33333349,7);
    r5.xy = float2(0.117647059,0.117647059) * r5.xy;
    r1.w = x1[0].x;
    r3.x = x0[0].x;
    r4.w = r5.x * r5.x + -r1.w;
  ...
  if (r1.w == 0) {
    r5.xy = r0.xx * float2(0.5,0.5) + float2(7.33333349,8);
    r5.xy = float2(0.117647059,0.117647059) * r5.xy;
    r0.x = x1[0].x;
    r1.w = x0[0].x;
    r3.x = r5.x * r5.x + -r0.x;
    r0.x = r1.w * r3.x + r0.x;
    r5.xzw = r11.xyz * r0.xxx + r10.xyz;
    r0.x = cmp(r0.z < r0.x);
    r5.xz = renderTargetSize.xy * r5.xz;
    r8.xy = (int2)r5.xz;
    r8.zw = float2(0,0);
    r3.x = floatZSampler.Load(r8.xyz).x;
    r4.w = cmp(r3.x >= 0.984375);
    ...
    r3.x = r5.y * r5.y + -r0.x;
    r0.x = r1.w * r3.x + r0.x;
    r4.xyz = r4.xyz * r0.xxx + r10.xyz;
    r0.x = cmp(r0.z < r0.x);
    r4.xy = renderTargetSize.xy * r4.xy;
    r5.xy = (int2)r4.xy;
    r5.zw = float2(0,0);
    r0.z = floatZSampler.Load(r5.xyz).x;
    r3.x = cmp(r0.z >= 0.984375);
    r4.x = 1.01587307 * r0.z;
    r0.z = r0.z * 64 + -63;
    r0.z = r3.x ? r0.z : r4.x;
  ...
  r0.x = x0[0].x;
  r0.y = -debugGlossOverride.w * r0.y + 1;
  r0.z = 5 * r0.y;
  r1.w = r0.y * 5 + -2.5;
  r1.w = saturate(0.400000006 * r1.w);
  r1.w = 100 * r1.w;
  r4.xy = -r0.yy * float2(10,5) + float2(6.85740995,7.08500004);
  r3.x = exp2(r4.x);
  r3.x = r6.x * r3.x;
  r3.x = 9.1368103 * r3.x;
  r4.x = r0.z * r0.y;
  r4.x = -r4.x * 2.0159049 + r4.y;
  r4.x = exp2(r4.x);
  r4.x = r6.x * r4.x;
  r4.x = 9.70808983 * r4.x;
  r3.x = max(r4.x, r3.x);
  ...
  while (true) {
    ...
    if (r6.w != 0) break;
    r4.z = (uint)r6.z >> 5;
    r5.xyz = (int3)r4.xyz + (int3)r18.xyz;
    r4.z = visibleProbes.Load(r5.xyzw).x;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r16.xyzw, r6.z, l(0), t15.wxyz
  r16.x = samp0[]..swiz;
  r16.y = samp0[]..swiz;
  r16.z = samp0[]..swiz;
  r16.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r17.xyzw, r6.z, l(16), t15.xyzw
  r17.x = samp0[]..swiz;
  r17.y = samp0[]..swiz;
  r17.z = samp0[]..swiz;
  r17.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r19.xyzw, r6.z, l(32), t15.yxwz
  r19.x = samp0[]..swiz;
  r19.y = samp0[]..swiz;
  r19.z = samp0[]..swiz;
  r19.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r20.xyzw, r6.z, l(48), t15.xyzw
  r20.x = samp0[]..swiz;
  r20.y = samp0[]..swiz;
  r20.z = samp0[]..swiz;
  r20.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r21.xyzw, r6.z, l(64), t15.zwxy
  r21.x = samp0[]..swiz;
  r21.y = samp0[]..swiz;
  r21.z = samp0[]..swiz;
  r21.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r22.xyzw, r6.z, l(80), t15.xyzw
  r22.x = samp0[]..swiz;
  r22.y = samp0[]..swiz;
  r22.z = samp0[]..swiz;
  r22.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r5.xy, r6.z, l(96), t15.xyxx
  r5.x = samp0[]..swiz;
  r5.y = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r23.xyzw, r6.z, l(116), t15.xyzw
  r23.x = samp0[]..swiz;
  r23.y = samp0[]..swiz;
  r23.z = samp0[]..swiz;
  r23.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r24.xyzw, r6.z, l(132), t15.zwxy
  r24.x = samp0[]..swiz;
  r24.y = samp0[]..swiz;
  r24.z = samp0[]..swiz;
  r24.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r25.xyzw, r6.z, l(148), t15.zwxy
  r25.x = samp0[]..swiz;
  r25.y = samp0[]..swiz;
  r25.z = samp0[]..swiz;
  r25.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r26.xyzw, r6.z, l(164), t15.zwxy
  r26.x = samp0[]..swiz;
  r26.y = samp0[]..swiz;
  r26.z = samp0[]..swiz;
  r26.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r27.xyzw, r6.z, l(180), t15.zwxy
  r27.x = samp0[]..swiz;
  r27.y = samp0[]..swiz;
  r27.z = samp0[]..swiz;
  r27.w = samp0[]..swiz;
  ...
  r33.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r39.xy, r6.z, l(212), t15.xyxx
  r39.x = samp0[]..swiz;
  r39.y = samp0[]..swiz;
    r40.xyz = v7.xyz + -r16.yzw;
    r5.z = dot(r40.xyz, r40.xyz);
    r5.z = sqrt(r5.z);
    r5.z = cmp(probeDebugRadius >= r5.z);
    r6.w = (int)r23.y & 0x0000ffff;
  // Known bad code for instruction (needs manual fix):
  ...
  r46.z = samp0[]..swiz;
  r46.w = samp0[]..swiz;
    r7.w = dot(r41.xyz, r40.xyz);
    r7.w = saturate(r7.w + r41.w);
    r8.w = dot(r42.xyz, r40.xyz);
    r8.w = saturate(r8.w + r42.w);
    r7.w = r8.w * r7.w;
    r8.w = dot(r43.xyz, r40.xyz);
    r8.w = saturate(r8.w + r43.w);
    r7.w = r8.w * r7.w;
    r8.w = dot(r44.xyz, r40.xyz);
    r8.w = saturate(r8.w + r44.w);
    r7.w = r8.w * r7.w;
    r8.w = dot(r45.xyz, r40.xyz);
    r8.w = saturate(r8.w + r45.w);
    r7.w = r8.w * r7.w;
    r8.w = dot(r46.xyz, r40.xyz);
    r8.w = saturate(r8.w + r46.w);
    r8.x = r8.w * r7.w;
    r7.w = (int)r5.x & 1;
    r8.xw = r7.ww ? r8.xy : r8.zx;
    r41.xy = r23.zw;
    r41.z = r24.z;
    r7.w = dot(r12.xyz, r41.xyz);
    r9.w = dot(r40.xyz, r41.xyz);
    r9.w = r9.w + -r24.w;
    r10.w = cmp(r9.w >= 0);
    r9.w = max(abs(r9.w), r1.w);
    ...
    r10.w = dot(r40.xyz, r24.xyz);
    r10.w = r10.w + -r25.w;
    r11.w = cmp(r10.w >= 0);
    r10.w = max(abs(r10.w), r1.w);
    ...
    r7.w = min(abs(r9.w), r7.w);
    r39.zw = r33.zw;
    r9.w = dot(r12.zxy, r39.xzw);
    r10.w = dot(r40.zxy, r39.xzw);
    r10.w = r10.w + -r39.y;
    r11.w = cmp(r10.w >= 0);
    r10.w = max(abs(r10.w), r1.w);
    r10.w = r11.w ? r10.w : -r10.w;
    ...
    r24.x = r20.w;
    r24.yz = r21.zw;
    r24.xyz = r24.xyz + r40.xyz;
    r24.xyz = r12.xyz * r7.www + r24.xyz;
    ...
    r16.y = r17.z;
    r16.z = r19.x;
    r25.x = dot(r24.xyz, r16.xyz);
    r26.xy = r17.xw;
    r26.z = r19.w;
    r25.y = dot(r24.xyz, r26.xyz);
    r19.x = r17.y;
    r25.z = dot(r24.xyz, r19.xyz);
    if (6 == 0) r17.x = 0; else if (6+25 < 32) {     r17.x = (uint)r23.y << (32-(6 + 25)); r17.x = (uint)r17.x >> (32-6);    } else r17.x = (uint)r23.y >> 25;
    if (9 == 0) r17.y = 0; else if (9+16 < 32) {     r17.y = (uint)r23.y << (32-(9 + 16)); r17.y = (uint)r17.y >> (32-9);    } else r17.y = (uint)r23.y >> 16;
    r25.w = (uint)r17.y;
    r17.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r25.xyzw, r7.w).xyz;
    r23.yzw = (int3)r17.yzw & int3(-2147483648,-2147483648,-2147483648);
    r23.yzw = cmp((int3)r23.yzw == int3(2139095040,2139095040,2139095040));
    r7.w = (int)r23.z | (int)r23.y;
    r7.w = (int)r23.w | (int)r7.w;
    r17.yzw = r7.www ? float3(1,1,0) : r17.yzw;
    r24.x = dot(r40.xyz, r16.xyz);
    r24.y = dot(r40.xyz, r26.xyz);
    r24.z = dot(r40.xyz, r19.xyz);
    r20.xyz = saturate(r24.xyz * r20.xyz + float3(0.5,0.5,0.5));
    r21.z = r22.x;
    r20.xyz = r20.xyz * r21.xyz + r22.yzw;
    r25.x = dot(r2.xyz, r16.xyz);
    r25.y = dot(r2.xyz, r26.xyz);
    r25.z = dot(r2.xyz, r19.xyz);
    r16.xyz = cmp(float3(0,0,0) < r25.xyz);
    r10.z = r16.x ? 0 : 0.5;
    r19.xyz = r20.xyz + r10.xyz;
    r19.xyz = gProbeXArray.SampleLevel(samplerLinearClamp_s, r19.xyz, 0).xyz;
    r11.z = r16.y ? 0 : 0.5;
    r16.xyw = r20.xyz + r11.xyz;
    ...
    r21.xyz = r25.xyz * r25.xyz;
    r22.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r25.xyzw, 6).xyz;
    r23.yzw = (int3)r22.xyz & int3(-2147483648,-2147483648,-2147483648);
    r23.yzw = cmp((int3)r23.yzw == int3(2139095040,2139095040,2139095040));
    r7.w = (int)r23.z | (int)r23.y;
    r7.w = (int)r23.w | (int)r7.w;
    r22.xyz = r7.www ? float3(1,1,0) : r22.xyz;
    r24.xyzw = r14.xyzw;
    r23.yzw = r15.yzw;
    r7.w = r4.w;
    r9.w = r4.z;
    while (true) {
      ...
      if (r10.w != 0) {
        ...
        if (r5.z != 0) {
          ...
          r10.w = 1;
          while (true) {
            r11.z = cmp((int)r10.w >= (int)r17.x);
            if (r11.z != 0) break;
            r11.z = (int)r6.w + (int)r10.w;
          // Known bad code for instruction (needs manual fix):
          ...
          r27.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r33.xyzw, r11.z, l(32), t16.xyzw
          r33.x = samp0[]..swiz;
          r33.y = samp0[]..swiz;
          r33.z = samp0[]..swiz;
          r33.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r39.xyzw, r11.z, l(48), t16.xyzw
          r39.x = samp0[]..swiz;
          r39.y = samp0[]..swiz;
          r39.z = samp0[]..swiz;
          r39.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r41.xyzw, r11.z, l(64), t16.xyzw
          r41.x = samp0[]..swiz;
          r41.y = samp0[]..swiz;
          r41.z = samp0[]..swiz;
          r41.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r42.xyzw, r11.z, l(80), t16.xyzw
          r42.x = samp0[]..swiz;
          r42.y = samp0[]..swiz;
          r42.z = samp0[]..swiz;
          r42.w = samp0[]..swiz;
            r11.z = dot(r26.xyz, r40.xyz);
            r11.z = saturate(r11.z + r26.w);
            r11.z = r25.x * r11.z;
            r11.w = dot(r27.xyz, r40.xyz);
            r11.w = saturate(r11.w + r27.w);
            r11.z = r11.z * r11.w;
            r11.w = dot(r33.xyz, r40.xyz);
            r11.w = saturate(r11.w + r33.w);
            r11.z = r11.z * r11.w;
            r11.w = dot(r39.xyz, r40.xyz);
            r11.w = saturate(r11.w + r39.w);
            r11.z = r11.z * r11.w;
            r11.w = dot(r41.xyz, r40.xyz);
            r11.w = saturate(r11.w + r41.w);
            r11.z = r11.z * r11.w;
            r11.w = dot(r42.xyz, r40.xyz);
            r11.w = saturate(r11.w + r42.w);
            r25.x = r11.z * r11.w;
            r13.z = (uint)r10.z >> 2;
            if (1 == 0) r13.w = 0; else if (1+2 < 32) {             r13.w = (uint)r10.z << (32-(1 + 2)); r13.w = (uint)r13.w >> (32-1);            } else r13.w = (uint)r10.z >> 2;
            r16.z = (int)r13.z & 2;
            r18.w = max(r25.y, r25.x);
            r11.z = -r11.z * r11.w + 1;
            r11.z = r25.y * r11.z;
            r9.y = r16.z ? r11.z : r18.w;
            r25.xy = r13.ww ? r25.xy : r9.xy;
            r10.w = (int)r10.w + 1;
            r10.z = r13.z;
          }
          ...
          r10.z = cmp(0 < r9.y);
          if (r10.z != 0) {
            r26.z = r25.y * r5.y + r23.w;
            r9.y = r9.y * r23.x;
            r25.xzw = r21.xyz * r9.yyy;
            r27.xyz = r25.zzz * r16.xyw;
            r27.xyz = r19.xyz * r25.xxx + r27.xyz;
            r25.xzw = r20.xyz * r25.www + r27.xyz;
            r27.xyz = r25.xzw * r22.xyz;
            r10.z = dot(r27.xyz, float3(0.212599993,0.715200007,0.0722000003));
            r27.xyz = r25.xzw * r22.xyz + r24.xyz;
            r10.w = r10.z * r3.x;
            r25.xzw = r17.yzw * r9.yyy;
            r9.y = dot(r25.xzw, float3(0.212599993,0.715200007,0.0722000003));
            r9.y = r3.x * r10.z + r9.y;
            r9.y = r10.w / r9.y;
            r33.x = r24.w;
            r33.yz = r23.yz;
            r26.xyw = r25.zwx * r9.yyy + r33.yzx;
            r27.w = r26.w;
          } else {
            r27.xyzw = r24.xyzw;
            r26.xyz = r23.yzw;
  ...
  if (r4.w == 0) {
    r4.x = numRefProbes + -numOverrideProbes;
    r4.y = (int)r4.x & -32;
    r4.z = (int)-r4.y + (int)r4.x;
    r4.w = numRefProbes & -32;
    r5.x = (int)-r4.w + numRefProbes;
    r8.xy = float2(0,0);
    r10.w = 0;
    r11.yz = float2(0,1);
    r13.xy = float2(0,0);
    ...
    r5.y = r4.y;
    while (true) {
      r5.z = cmp((uint)r5.y >= numRefProbes);
      if (r5.z != 0) break;
      r8.z = (uint)r5.y >> 5;
      r10.xyz = (int3)r8.xyz + (int3)r18.xyz;
      r5.z = visibleProbes.Load(r10.xyzw).x;
      r5.w = cmp((int)r4.y == (int)r5.y);
      bitmask.z = ((~(-1 << r4.z)) << 0) & 0xffffffff;  r6.z = (((uint)0 << 0) & bitmask.z) | ((uint)r5.z & ~bitmask.z);
      r5.z = r5.w ? r6.z : r5.z;
      r5.w = cmp((int)r4.w == (int)r5.y);
      if (r5.x == 0) r6.z = 0; else if (r5.x+0 < 32) {       r6.z = (uint)r5.z << (32-(r5.x + 0)); r6.z = (uint)r6.z >> (32-r5.x);      } else r6.z = (uint)r5.z >> 0;
      r5.z = r5.w ? r6.z : r5.z;
      r5.w = (int)r5.y + numLights;
      r21.xyzw = r19.xyzw;
      r22.xyz = r20.yzw;
      r6.z = r5.z;
      while (true) {
        ...
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=80)(mixed,mixed,mixed,mixed) r23.xyzw, r7.w, l(0), t11.xyzw
        r23.x = samp0[]..swiz;
        r23.y = samp0[]..swiz;
        r23.z = samp0[]..swiz;
        r23.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=80)(mixed,mixed,mixed,mixed) r10.xy, r7.w, l(16), t11.xyxx
        r10.x = samp0[]..swiz;
        r10.y = samp0[]..swiz;
          ...
          r8.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r24.xyzw, r6.w, l(116), t15.zwxy
          r24.x = samp0[]..swiz;
          r24.y = samp0[]..swiz;
          r24.z = samp0[]..swiz;
          r24.w = samp0[]..swiz;
            r10.xyz = v7.xyz + -r23.yzw;
            r7.w = (int)r24.w & 0x0000ffff;
            if (6 == 0) r9.w = 0; else if (6+25 < 32) {             r9.w = (uint)r24.w << (32-(6 + 25)); r9.w = (uint)r9.w >> (32-6);            } else r9.w = (uint)r24.w >> 25;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r25.xyzw, r7.w, l(0), t16.xyzw
          r25.x = samp0[]..swiz;
          r25.y = samp0[]..swiz;
          r25.z = samp0[]..swiz;
          r25.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r26.xyzw, r7.w, l(16), t16.xyzw
          r26.x = samp0[]..swiz;
          r26.y = samp0[]..swiz;
          r26.z = samp0[]..swiz;
          r26.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r27.xyzw, r7.w, l(32), t16.xyzw
          r27.x = samp0[]..swiz;
          r27.y = samp0[]..swiz;
          r27.z = samp0[]..swiz;
          r27.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r33.xyzw, r7.w, l(48), t16.xyzw
          r33.x = samp0[]..swiz;
          r33.y = samp0[]..swiz;
          r33.z = samp0[]..swiz;
          r33.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r39.xyzw, r7.w, l(64), t16.xyzw
          r39.x = samp0[]..swiz;
          r39.y = samp0[]..swiz;
          r39.z = samp0[]..swiz;
          r39.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r40.xyzw, r7.w, l(80), t16.xyzw
          r40.x = samp0[]..swiz;
          r40.y = samp0[]..swiz;
          r40.z = samp0[]..swiz;
          r40.w = samp0[]..swiz;
            r11.w = dot(r25.xyz, r10.xyz);
            r11.w = saturate(r11.w + r25.w);
            r13.w = dot(r26.xyz, r10.xyz);
            ...
            r11.w = r13.w * r11.w;
            r13.w = dot(r39.xyz, r10.xyz);
            r13.w = saturate(r13.w + r39.w);
            r11.w = r13.w * r11.w;
            r13.w = dot(r40.xyz, r10.xyz);
            ...
            r33.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r39.xyzw, r17.w, l(48), t16.xyzw
            r39.x = samp0[]..swiz;
            r39.y = samp0[]..swiz;
            r39.z = samp0[]..swiz;
            r39.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r40.xyzw, r17.w, l(64), t16.xyzw
            r40.x = samp0[]..swiz;
            r40.y = samp0[]..swiz;
            r40.z = samp0[]..swiz;
            r40.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r41.xyzw, r17.w, l(80), t16.xyzw
            r41.x = samp0[]..swiz;
            r41.y = samp0[]..swiz;
            r41.z = samp0[]..swiz;
            r41.w = samp0[]..swiz;
              r17.w = dot(r26.xyz, r10.xyz);
              r17.w = saturate(r17.w + r26.w);
              r17.w = r25.x * r17.w;
              r18.w = dot(r27.xyz, r10.xyz);
              r18.w = saturate(r18.w + r27.w);
              r17.w = r18.w * r17.w;
              r18.w = dot(r33.xyz, r10.xyz);
              r18.w = saturate(r18.w + r33.w);
              r17.w = r18.w * r17.w;
              r18.w = dot(r39.xyz, r10.xyz);
              r18.w = saturate(r18.w + r39.w);
              r17.w = r18.w * r17.w;
              r18.w = dot(r40.xyz, r10.xyz);
              r18.w = saturate(r18.w + r40.w);
              r17.w = r18.w * r17.w;
              r18.w = dot(r41.xyz, r10.xyz);
              r18.w = saturate(r18.w + r41.w);
              r25.x = r18.w * r17.w;
              r23.w = (uint)r13.w >> 2;
              if (1 == 0) r25.z = 0; else if (1+2 < 32) {               r25.z = (uint)r13.w << (32-(1 + 2)); r25.z = (uint)r25.z >> (32-1);              } else r25.z = (uint)r13.w >> 2;
              r25.w = (int)r23.w & 2;
              r26.x = max(r25.y, r25.x);
              r17.w = -r17.w * r18.w + 1;
              r17.w = r25.y * r17.w;
              r9.y = r25.w ? r17.w : r26.x;
              r25.xy = r25.zz ? r25.xy : r9.xy;
              r16.w = (int)r16.w + 1;
              r13.w = r23.w;
            }
            r25.y = saturate(r25.y);
            ...
            if (r8.z != 0) {
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r26.xyzw, r6.w, l(16), t15.xyzw
            r26.x = samp0[]..swiz;
            r26.y = samp0[]..swiz;
            r26.z = samp0[]..swiz;
            r26.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r27.xyzw, r6.w, l(32), t15.yxwz
            r27.x = samp0[]..swiz;
            r27.y = samp0[]..swiz;
            r27.z = samp0[]..swiz;
            r27.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r33.xyzw, r6.w, l(48), t15.xyzw
            r33.x = samp0[]..swiz;
            r33.y = samp0[]..swiz;
            r33.z = samp0[]..swiz;
            r33.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r39.xyzw, r6.w, l(64), t15.zwxy
            r39.x = samp0[]..swiz;
            r39.y = samp0[]..swiz;
            r39.z = samp0[]..swiz;
            r39.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r40.xyzw, r6.w, l(80), t15.xyzw
            r40.x = samp0[]..swiz;
            r40.y = samp0[]..swiz;
            r40.z = samp0[]..swiz;
            r40.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r41.xyzw, r6.w, l(132), t15.zwxy
            r41.x = samp0[]..swiz;
            r41.y = samp0[]..swiz;
            r41.z = samp0[]..swiz;
            r41.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r42.xyzw, r6.w, l(148), t15.zwxy
            r42.x = samp0[]..swiz;
            r42.y = samp0[]..swiz;
            r42.z = samp0[]..swiz;
            r42.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r43.xyzw, r6.w, l(164), t15.zwxy
            r43.x = samp0[]..swiz;
            r43.y = samp0[]..swiz;
            r43.z = samp0[]..swiz;
            r43.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r44.xyzw, r6.w, l(180), t15.zwxy
            r44.x = samp0[]..swiz;
            r44.y = samp0[]..swiz;
            r44.z = samp0[]..swiz;
            r44.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r45.xyzw, r6.w, l(196), t15.xyzw
            r45.x = samp0[]..swiz;
            r45.y = samp0[]..swiz;
            r45.z = samp0[]..swiz;
            r45.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r46.xy, r6.w, l(212), t15.xyxx
            r46.x = samp0[]..swiz;
            r46.y = samp0[]..swiz;
              r22.z = r25.y * r8.w + r22.z;
              r6.w = r7.w * r24.z;
              r24.z = r41.z;
              r7.w = dot(r12.xyz, r24.xyz);
              r8.z = dot(r10.xyz, r24.xyz);
              r8.z = r8.z + -r41.w;
              r8.w = cmp(r8.z >= 0);
              r8.z = max(abs(r8.z), r1.w);
              r8.z = r8.w ? r8.z : -r8.z;
              r7.w = max(1.00000001e-07, -r7.w);
              r7.w = r8.z / r7.w;
              r7.w = min(131072, abs(r7.w));
              r41.z = r42.z;
              r8.z = dot(r12.xyz, r41.xyz);
              r8.w = dot(r10.xyz, r41.xyz);
              r8.w = r8.w + -r42.w;
              r9.y = cmp(r8.w >= 0);
              r8.w = max(abs(r8.w), r1.w);
              r8.w = r9.y ? r8.w : -r8.w;
              r8.z = max(1.00000001e-07, -r8.z);
              r8.z = r8.w / r8.z;
              r7.w = min(abs(r8.z), r7.w);
              r42.z = r43.z;
              r8.z = dot(r12.xyz, r42.xyz);
              r8.w = dot(r10.xyz, r42.xyz);
              r8.w = r8.w + -r43.w;
              r9.y = cmp(r8.w >= 0);
              r8.w = max(abs(r8.w), r1.w);
              r8.w = r9.y ? r8.w : -r8.w;
              ...
              r7.w = min(abs(r8.z), r7.w);
              r43.z = r44.z;
              r8.z = dot(r12.xyz, r43.xyz);
              r8.w = dot(r10.xyz, r43.xyz);
              r8.w = r8.w + -r44.w;
              r9.y = cmp(r8.w >= 0);
              r8.w = max(abs(r8.w), r1.w);
              r8.w = r9.y ? r8.w : -r8.w;
              ...
              r7.w = min(abs(r8.z), r7.w);
              r44.z = r45.x;
              r8.z = dot(r12.xyz, r44.xyz);
              r8.w = dot(r10.xyz, r44.xyz);
              r8.w = r8.w + -r45.y;
              r9.y = cmp(r8.w >= 0);
              r8.w = max(abs(r8.w), r1.w);
              r8.w = r9.y ? r8.w : -r8.w;
              ...
              r7.w = min(abs(r8.z), r7.w);
              r46.zw = r45.zw;
              r8.z = dot(r12.zxy, r46.xzw);
              r8.w = dot(r10.zxy, r46.xzw);
              r8.w = r8.w + -r46.y;
              r9.y = cmp(r8.w >= 0);
              r8.w = max(abs(r8.w), r1.w);
              r8.w = r9.y ? r8.w : -r8.w;
              ...
              if (9 == 0) r8.z = 0; else if (9+16 < 32) {               r8.z = (uint)r24.w << (32-(9 + 16)); r8.z = (uint)r8.z >> (32-9);              } else r8.z = (uint)r24.w >> 16;
              r41.w = (uint)r8.z;
              r24.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r41.xyzw, r7.w).xyz;
              r25.xzw = (int3)r24.xyz & int3(-2147483648,-2147483648,-2147483648);
              r25.xzw = cmp((int3)r25.xzw == int3(2139095040,2139095040,2139095040));
              r7.w = (int)r25.z | (int)r25.x;
              r7.w = (int)r25.w | (int)r7.w;
              r24.xyz = r7.www ? float3(1,1,0) : r24.xyz;
              r26.x = dot(r10.xyz, r23.xyz);
              r26.y = dot(r10.xyz, r42.xyz);
              r26.z = dot(r10.xyz, r27.xyz);
              r10.xyz = saturate(r26.xyz * r33.xyz + float3(0.5,0.5,0.5));
              r39.z = r40.x;
              ...
              r10.xyz = r10.xyz * r26.zzz + r23.xyw;
              r23.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r41.xyzw, 6).xyz;
              r25.xzw = (int3)r23.xyz & int3(-2147483648,-2147483648,-2147483648);
              r25.xzw = cmp((int3)r25.xzw == int3(2139095040,2139095040,2139095040));
              r7.w = (int)r25.z | (int)r25.x;
              r7.w = (int)r25.w | (int)r7.w;
              r23.xyz = r7.www ? float3(1,1,0) : r23.xyz;
              r25.xzw = r23.xyz * r10.xyz;
              r7.w = dot(r25.xzw, float3(0.212599993,0.715200007,0.0722000003));
              r21.xyz = r10.xyz * r23.xyz + r21.xyz;
              r8.z = r7.w * r3.x;
              r10.xyz = r24.xyz * r6.www;
              r6.w = dot(r10.xyz, float3(0.212599993,0.715200007,0.0722000003));
              r6.w = r3.x * r7.w + r6.w;
              r6.w = r8.z / r6.w;
              r23.x = r21.w;
              r23.yz = r22.xy;
              r22.xyw = r10.yzx * r6.www + r23.yzx;
              r21.w = r22.w;
            }
          }
        }
    ...
    if (r4.w != 0) {
      ...
      r5.w = 0;
      while (true) {
        r6.z = cmp((uint)r5.w >= (uint)r4.x);
        if (r6.z != 0) break;
        r5.z = (uint)r5.w >> 5;
        r8.xyz = (int3)r5.xyz + (int3)r18.xyz;
        r5.z = visibleProbes.Load(r8.xyzw).x;
        r6.z = cmp((int)r4.y == (int)r5.w);
        if (r4.z == 0) r6.w = 0; else if (r4.z+0 < 32) {         r6.w = (uint)r5.z << (32-(r4.z + 0)); r6.w = (uint)r6.w >> (32-r4.z);        } else r6.w = (uint)r5.z >> 0;
        r5.z = r6.z ? r6.w : r5.z;
        ...
        while (true) {
          ...
          if (r11.w != 0) {
            ...
            r10.w = (int)r6.z + (int)r9.w;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=80)(mixed,mixed,mixed,mixed) r23.xyzw, r10.w, l(0), t11.xyzw
          r23.x = samp0[]..swiz;
          r23.y = samp0[]..swiz;
          r23.z = samp0[]..swiz;
          r23.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=80)(mixed,mixed,mixed,mixed) r24.xy, r10.w, l(16), t11.xyxx
          r24.x = samp0[]..swiz;
          r24.y = samp0[]..swiz;
            r23.xyz = -v7.xyz + r23.xyz;
            r24.z = r23.w;
            ...
            r23.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r24.xy, r9.w, l(96), t15.xyxx
            r24.x = samp0[]..swiz;
            r24.y = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
            ...
            r25.z = samp0[]..swiz;
            r25.w = samp0[]..swiz;
              r26.xyz = v7.xyz + -r23.yzw;
              r10.w = (int)r25.w & 0x0000ffff;
              if (6 == 0) r11.w = 0; else if (6+25 < 32) {               r11.w = (uint)r25.w << (32-(6 + 25)); r11.w = (uint)r11.w >> (32-6);              } else r11.w = (uint)r25.w >> 25;
            // Known bad code for instruction (needs manual fix):
            ...
            r27.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r33.xyzw, r10.w, l(16), t16.xyzw
            r33.x = samp0[]..swiz;
            r33.y = samp0[]..swiz;
            r33.z = samp0[]..swiz;
            r33.w = samp0[]..swiz;
            ...
            r42.w = samp0[]..swiz;
              ...
              r13.w = r15.w * r13.w;
              r15.w = dot(r39.xyz, r26.xyz);
              r15.w = saturate(r15.w + r39.w);
              r13.w = r15.w * r13.w;
              r15.w = dot(r40.xyz, r26.xyz);
              r15.w = saturate(r15.w + r40.w);
              r13.w = r15.w * r13.w;
              r15.w = dot(r41.xyz, r26.xyz);
              r15.w = saturate(r15.w + r41.w);
              r13.w = r15.w * r13.w;
              r15.w = dot(r42.xyz, r26.xyz);
              r15.w = saturate(r15.w + r42.w);
              r10.x = r15.w * r13.w;
              r13.w = (int)r24.x & 1;
              r24.zw = r13.ww ? r10.xy : r10.zx;
              r10.x = r24.x;
              r27.xy = r24.zw;
              r13.w = 1;
              while (true) {
              ...
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r33.xyzw, r15.w, l(0), t16.xyzw
              r33.x = samp0[]..swiz;
              r33.y = samp0[]..swiz;
              r33.z = samp0[]..swiz;
              r33.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r39.xyzw, r15.w, l(16), t16.xyzw
              r39.x = samp0[]..swiz;
              r39.y = samp0[]..swiz;
              r39.z = samp0[]..swiz;
              r39.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r40.xyzw, r15.w, l(32), t16.xyzw
              r40.x = samp0[]..swiz;
              r40.y = samp0[]..swiz;
              r40.z = samp0[]..swiz;
              r40.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r41.xyzw, r15.w, l(48), t16.xyzw
              r41.x = samp0[]..swiz;
              r41.y = samp0[]..swiz;
              r41.z = samp0[]..swiz;
              r41.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r42.xyzw, r15.w, l(64), t16.xyzw
              r42.x = samp0[]..swiz;
              r42.y = samp0[]..swiz;
              r42.z = samp0[]..swiz;
              r42.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r43.xyzw, r15.w, l(80), t16.xyzw
              r43.x = samp0[]..swiz;
              r43.y = samp0[]..swiz;
              r43.z = samp0[]..swiz;
              r43.w = samp0[]..swiz;
                ...
                r15.w = r16.w * r15.w;
                r16.w = dot(r43.xyz, r26.xyz);
                r16.w = saturate(r16.w + r43.w);
                r27.x = r16.w * r15.w;
                r18.w = (uint)r10.x >> 2;
                if (1 == 0) r21.w = 0; else if (1+2 < 32) {                 r21.w = (uint)r10.x << (32-(1 + 2)); r21.w = (uint)r21.w >> (32-1);                } else r21.w = (uint)r10.x >> 2;
                r23.w = (int)r18.w & 2;
                r26.w = max(r27.y, r27.x);
                r15.w = -r15.w * r16.w + 1;
                r15.w = r27.y * r15.w;
                r9.y = r23.w ? r15.w : r26.w;
                r27.xy = r21.ww ? r27.xy : r9.xy;
                r13.w = (int)r13.w + 1;
                r10.x = r18.w;
              }
              r9.y = saturate(r27.y + -r6.w);
              r10.x = r9.y * r24.y;
              r10.w = cmp(0 < r10.x);
              if (r10.w != 0) {
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r33.xyzw, r9.w, l(16), t15.xyzw
              r33.x = samp0[]..swiz;
              r33.y = samp0[]..swiz;
              r33.z = samp0[]..swiz;
              r33.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r39.xyzw, r9.w, l(32), t15.yxwz
              r39.x = samp0[]..swiz;
              r39.y = samp0[]..swiz;
              r39.z = samp0[]..swiz;
              r39.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r40.xyzw, r9.w, l(48), t15.xyzw
              r40.x = samp0[]..swiz;
              r40.y = samp0[]..swiz;
              r40.z = samp0[]..swiz;
              r40.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r41.xyzw, r9.w, l(64), t15.zwxy
              r41.x = samp0[]..swiz;
              r41.y = samp0[]..swiz;
              r41.z = samp0[]..swiz;
              r41.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r42.xyzw, r9.w, l(80), t15.xyzw
              r42.x = samp0[]..swiz;
              r42.y = samp0[]..swiz;
              r42.z = samp0[]..swiz;
              r42.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r43.xyzw, r9.w, l(132), t15.zwxy
              r43.x = samp0[]..swiz;
              r43.y = samp0[]..swiz;
              r43.z = samp0[]..swiz;
              r43.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r44.xyzw, r9.w, l(148), t15.zwxy
              r44.x = samp0[]..swiz;
              r44.y = samp0[]..swiz;
              r44.z = samp0[]..swiz;
              r44.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r45.xyzw, r9.w, l(164), t15.zwxy
              r45.x = samp0[]..swiz;
              r45.y = samp0[]..swiz;
              r45.z = samp0[]..swiz;
              r45.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r46.xyzw, r9.w, l(180), t15.zwxy
              r46.x = samp0[]..swiz;
              r46.y = samp0[]..swiz;
              r46.z = samp0[]..swiz;
              r46.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r47.xyzw, r9.w, l(196), t15.xyzw
              r47.x = samp0[]..swiz;
              r47.y = samp0[]..swiz;
              r47.z = samp0[]..swiz;
              r47.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r48.xy, r9.w, l(212), t15.xyxx
              r48.x = samp0[]..swiz;
              r48.y = samp0[]..swiz;
                ...
                r10.x = r10.x + -r43.w;
                r10.w = cmp(r10.x >= 0);
                r10.x = max(abs(r10.x), r1.w);
                r10.x = r10.w ? r10.x : -r10.x;
                r9.w = max(1.00000001e-07, -r9.w);
                r9.w = r10.x / r9.w;
                r9.w = min(131072, abs(r9.w));
                r43.z = r44.z;
                r10.x = dot(r12.xyz, r43.xyz);
                r10.w = dot(r26.xyz, r43.xyz);
                r10.w = r10.w + -r44.w;
                r11.w = cmp(r10.w >= 0);
                r10.w = max(abs(r10.w), r1.w);
                r10.w = r11.w ? r10.w : -r10.w;
                ...
                r10.x = r10.w / r10.x;
                r9.w = min(abs(r10.x), r9.w);
                r44.z = r45.z;
                r10.x = dot(r12.xyz, r44.xyz);
                r10.w = dot(r26.xyz, r44.xyz);
                r10.w = r10.w + -r45.w;
                r11.w = cmp(r10.w >= 0);
                r10.w = max(abs(r10.w), r1.w);
                r10.w = r11.w ? r10.w : -r10.w;
                ...
                r9.w = min(abs(r10.x), r9.w);
                r45.z = r46.z;
                r10.x = dot(r12.xyz, r45.xyz);
                r10.w = dot(r26.xyz, r45.xyz);
                r10.w = r10.w + -r46.w;
                r11.w = cmp(r10.w >= 0);
                r10.w = max(abs(r10.w), r1.w);
                r10.w = r11.w ? r10.w : -r10.w;
                ...
                r9.w = min(abs(r10.x), r9.w);
                r46.z = r47.x;
                r10.x = dot(r12.xyz, r46.xyz);
                r10.w = dot(r26.xyz, r46.xyz);
                r10.w = r10.w + -r47.y;
                r11.w = cmp(r10.w >= 0);
                r10.w = max(abs(r10.w), r1.w);
                r10.w = r11.w ? r10.w : -r10.w;
                ...
                r9.w = min(abs(r10.x), r9.w);
                r48.zw = r47.zw;
                r10.x = dot(r12.zxy, r48.xzw);
                r10.w = dot(r26.zxy, r48.xzw);
                r10.w = r10.w + -r48.y;
                r11.w = cmp(r10.w >= 0);
                r10.w = max(abs(r10.w), r1.w);
                r10.w = r11.w ? r10.w : -r10.w;
                ...
                r24.xyz = r12.xyz * r9.www + r24.xyz;
                r10.x = dot(r24.xyz, r24.xyz);
                r10.x = sqrt(r10.x);
                r9.w = r9.w / r10.x;
                r9.w = r9.w + r9.w;
                r9.w = sqrt(r9.w);
    ...
    r14.xyz = r19.xyz * r0.yyy;
    r15.xyz = r20.xyz * r0.yyy;
    r1.w = cmp(r20.w < 0.99000001);
    if (r1.w != 0) {
      r1.w = 1 + -r20.w;
      r3.x = sunConstants.globalProbeExposure * r1.w;
      r4.xyz = -globalProbeConstants.data[0].xyz + v7.xyz;
      ...
      r14.xyz = r19.xyz * r0.yyy + r2.xyz;
      r12.w = 0;
      r2.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r12.xyzw, r0.z).xyz;
      r0.y = sunConstants.globalProbeExposure * r1.w + -r2.w;
      r0.y = r6.y * r0.y + r2.w;
      r15.xyz = r2.xyz * r0.yyy + r15.xyz;
    }
  } else {
    r15.x = r14.w;
  }
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r0.y, v3.x, l(4), t4.xxxx
r0.y = samp0[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) r0.y, r0.y, l(0), t0.xxxx
r0.y = samp0[]..swiz;
  r0.z = revealMap.Sample(revealSampler_s, v2.xy).x;
  r0.y = saturate(r0.y * 0.998000026 + 0.00100000005);
  r1.w = 1 + -r0.y;
  ...
  r0.z = debugOcclusionOverride.w * r0.w + r0.z;
  r0.w = x2[0].x;
  r0.w = r0.w + -r9.z;
  ...
  r0.x = min(r38.w, r0.x);
  r0.x = r38.z * r0.x;
  r2.xyz = r0.xxx * r32.xyz;
  r4.xyz = r2.xyz * r34.xyz + r28.xyz;
  r5.xyz = r2.xyz * r35.xyz + r29.xyz;
  r8.xyz = r2.xyz * r36.xyz + r31.xyz;
  r2.xyz = r2.xyz * r37.xyz + r30.xyz;
  r4.xyz = r14.xyz * r0.zzz + r4.xyz;
  r5.xyz = r14.xyz * r0.zzz + r5.xyz;
  r0.xw = r6.xy * float2(0.984375,0.984375) + float2(0.0078125,0.0078125);
  r0.xw = gEnvBRDFGeneric.SampleLevel(samplerLinear_s, r0.xw, 0).xy;
  r6.xyz = r15.xyz * r0.zzz;
  ...
  r1.w = min(1, r1.w);
  r3.xyz = saturate(r1.xyz * float3(0.0199999996,0.0199999996,0.0199999996) + float3(0.0399999991,0.0399999991,0.0399999991));
  r6.xyz = specColorTint.xyz * r3.xyz;
  r7.xyz = r1.xyz * r1.www;
  r5.xyz = r7.xyz * r5.xyz;
  r1.xyz = r4.xyz * r1.xyz + r5.xyz;
  r3.xyz = -r3.xyz * specColorTint.xyz + float3(1,1,1);
  r2.xyz = r3.xyz * r2.xyz;
  r0.xzw = r0.xzw * r6.xyz + r2.xyz;
  ...
  if (r1.x != 0) {
    ...
    r1.xyz = r1.www * r2.xyz + r0.xzw;
  }
  r0.xzw = relHDRExposure.yyy * r1.xyz;
  r1.xyz = cmp(r0.xzw >= float3(6.10351563e-05,6.10351563e-05,6.10351563e-05));
  r0.xzw = r1.xyz ? r0.xzw : 0;
  o0.xyz = min(float3(65024,65024,64512), r0.xzw);
  o0.w = r0.y;
  return;
}