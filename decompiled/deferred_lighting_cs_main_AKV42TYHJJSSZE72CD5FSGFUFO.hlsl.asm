...
dp3 r4.z, r14.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
mov r15.w, l(0)
sample_l_indexable(texturecubearray)(float,float,float,float) r16.xyz, r15.xyzw, t8.xyzw, s2, r2.w
add r2.w, -r4.z, cb2[19].x
...
ret 
// Approximately 1168 instruction slots used
