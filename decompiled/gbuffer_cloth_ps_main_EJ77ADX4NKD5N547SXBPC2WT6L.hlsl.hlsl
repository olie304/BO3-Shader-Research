  ...
  out float2 o3 : SV_TARGET3)
{
  ...
  r1.xzw = r6.xyz * r0.www;
  o0.xyz = r2.www ? r1.xzw : r6.xyz;
  r0.xyz = r2.www ? r0.xyz : r2.xyz;
  r1.xz = v6.xy / v6.ww;
  r2.xy = float2(0.5,0.5) * renderTargetSize.xy;
  r6.x = r2.x * r1.x;
  r6.y = -r2.y * r1.z;
  r1.xz = renderTargetSize.xy * float2(0.5,0.5) + r6.xy;
  r1.xz = v0.xy + -r1.xz;
  r0.w = r5.x + r5.y;
  r0.w = r3.w * r3.x + r0.w;
  r0.w = 0.5 * r0.w;
  r2.xyz = r3.yzw * r3.xxx + -r0.www;
  r1.w = max(r2.y, r2.z);
  r1.w = max(r2.x, r1.w);
  r0.w = max(r1.w, r0.w);
  r1.w = cmp(r0.w == r2.x);
