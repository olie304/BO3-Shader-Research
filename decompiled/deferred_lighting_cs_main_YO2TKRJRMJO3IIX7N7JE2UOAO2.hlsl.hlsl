// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:24:12 2021
...
r0.y = samp0[]..swiz;
  ...
  r1.w = r1.w + r1.w;
  r13.xyz = r11.xyz * -r1.www + -r12.xyz;
  r1.w = 17 * r2.y;
  r1.w = exp2(r1.w);
  r1.w = 2 + r1.w;
  r1.w = 2 / r1.w;
  ...
  if (r6.w == 0) {
    ...
    r6.w = -sunConstants.splitDepthOffset + r14.z;
    ...
    if (r8.w != 0) {
      ...
      while (true) {
        ...
        if (r10.w != 0) break;
        r10.w = (uint)r8.w;
        r15.xy = -sunConstants.splitPinTransform[r10.w].xy + r14.xy;
    ...
    r14.w = samp0[]..swiz;
      ...
      r14.w = samp0[]..swiz;
        r14.w = r16.z ? r17.z : r14.w;
        r15.w = (uint)r14.w >> 13;
        r14.w = r16.y ? r15.w : r14.w;
      ...
      r18.w = samp0[]..swiz;
        r16.yzw = r14.www ? r16.yzw : r18.xzw;
        ...
        r18.z = samp0[]..swiz;
          ...
          r14.w = (int)-r18.y + 6;
          r17.yz = (uint2)r15.zy >> (uint2)r14.ww;
        ...
        r15.x = samp0[]..swiz;
          ...
          r15.x = r14.x * r15.y + r15.x;
          r14.w = r14.y * r14.w + r15.x;
          r16.x = r12.w ? r14.w : r16.x;
        }
      }
      r12.w = -sunConstants.sstLightingConstants.constants.inchesPerTexel * 2 + r14.z;
    ...
    if (r10.w == 0) {
      if (enableDitheredShadow == 0) {
        r10.w = (uint)r8.w;
        r14.zw = -sunConstants.splitPinTransform[r10.w].xy + r14.xy;
      ...
      if (enableDitheredShadow != 0) {
        ...
        r14.xy = -sunConstants.splitPinTransform[r8.w].xy + r14.xy;
  ...
  r9.w = max(0, r9.w);
  r9.w = 100 * r9.w;
  r14.xy = -r6.ww * float2(10,5) + float2(6.85740995,7.08500004);
  r10.w = exp2(r14.x);
  r10.w = r10.w * r2.x;
  r10.w = 9.1368103 * r10.w;
  r12.w = r8.w * r6.w;
  r12.w = -r12.w * 2.0159049 + r14.y;
  r12.w = exp2(r12.w);
  r12.w = r12.w * r2.x;
  ...
  if (r25.w != 0) {
    ...
    r12.w = (int)r26.z & 0x0000ffff;
    if (6 == 0) r14.w = 0; else if (6+25 < 32) {     r14.w = (uint)r26.z << (32-(6 + 25)); r14.w = (uint)r14.w >> (32-6);    } else r14.w = (uint)r26.z >> 25;
    r15.w = (int)r12.w * 6;
    ...
    while (true) {
      ...
      if (r19.w != 0) break;
      r19.w = (int)r12.w + (int)r16.w;
      r19.w = (int)r19.w * 6;
      r26.y = dot(refProbeAttenuationConstantsCB[r19.w].data[0].xyz, r25.xyz);
      r26.y = saturate(refProbeAttenuationConstantsCB[r19.w].data[0].w + r26.y);
      r26.y = r31.x * r26.y;
      r26.w = dot(refProbeAttenuationConstantsCB[r19.w].data[1].xyz, r25.xyz);
      r26.w = saturate(refProbeAttenuationConstantsCB[r19.w].data[1].w + r26.w);
      r26.y = r26.y * r26.w;
      r26.w = dot(refProbeAttenuationConstantsCB[r19.w].data[2].xyz, r25.xyz);
      r26.w = saturate(refProbeAttenuationConstantsCB[r19.w].data[2].w + r26.w);
      r26.y = r26.y * r26.w;
      r26.w = dot(refProbeAttenuationConstantsCB[r19.w].data[3].xyz, r25.xyz);
      r26.w = saturate(refProbeAttenuationConstantsCB[r19.w].data[3].w + r26.w);
      r26.y = r26.y * r26.w;
      r26.w = dot(refProbeAttenuationConstantsCB[r19.w].data[4].xyz, r25.xyz);
      r26.w = saturate(refProbeAttenuationConstantsCB[r19.w].data[4].w + r26.w);
      r26.y = r26.y * r26.w;
      r26.w = dot(refProbeAttenuationConstantsCB[r19.w].data[5].xyz, r25.xyz);
      r19.w = saturate(refProbeAttenuationConstantsCB[r19.w].data[5].w + r26.w);
      r31.x = r26.y * r19.w;
      r26.w = (uint)r15.w >> 2;
      if (1 == 0) r27.w = 0; else if (1+2 < 32) {       r27.w = (uint)r15.w << (32-(1 + 2)); r27.w = (uint)r27.w >> (32-1);      } else r27.w = (uint)r15.w >> 2;
      r28.w = (int)r26.w & 2;
      r29.w = max(r31.y, r31.x);
      r19.w = -r26.y * r19.w + 1;
      r19.w = r31.y * r19.w;
      r30.y = r28.w ? r19.w : r29.w;
    ...
    if (r12.w != 0) {
      ...
      if (9 == 0) r15.w = 0; else if (9+16 < 32) {       r15.w = (uint)r26.z << (32-(9 + 16)); r15.w = (uint)r15.w >> (32-9);      } else r15.w = (uint)r26.z >> 16;
      r18.w = (uint)r15.w;
      ...
      r14.w = (int)r19.y | (int)r19.x;
      r14.w = (int)r19.z | (int)r14.w;
      r17.xyz = r14.www ? float3(1,1,0) : r17.xyz;
      ...
      r14.w = (int)r16.z | (int)r14.w;
      r15.xyz = r14.www ? float3(1,1,0) : r15.xyz;
      r14.xyz = r15.xyz * r14.xyz;
      r14.x = dot(r14.xyz, float3(0.212599993,0.715200007,0.0722000003));
      r14.y = r14.x * r10.w;
      r15.xyz = r17.xyz * r12.www;
      r12.w = dot(r15.xyz, float3(0.212599993,0.715200007,0.0722000003));
      r12.w = r10.w * r14.x + r12.w;
      r12.w = r14.y / r12.w;
      r30.xyz = r15.xyz * r12.www;
      r12.w = 257;
    } else {
  ...
  r14.x = (int)r14.x & (int)r25.w;
  if (r14.x == 0) {
    r14.x = numRefProbes + -numOverrideProbes;
    ...
    while (true) {
      ...
      if (r15.w != 0) break;
      r15.w = (uint)r15.z >> 5;
      r15.w = (int)r14.y + (int)r15.w;
    // Known bad code for instruction (needs manual fix):
        ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r15.w, r15.w, l(0), t26.xxxx
    r15.w = samp0[]..swiz;
      r17.w = cmp((int)r14.z == (int)r15.z);
      bitmask.w = ((~(-1 << r14.w)) << 0) & 0xffffffff;  r18.w = (((uint)0 << 0) & bitmask.w) | ((uint)r15.w & ~bitmask.w);
      ...
      while (true) {
        ...
        if (r19.y != 0) {
          ...
          r27.xyz = r13.xyz * r19.yyy + r27.xyz;
    ...
    while (true) {
      ...
      if (r17.w != 0) break;
      r17.w = (uint)r16.w >> 5;
      r17.w = (int)r14.y + (int)r17.w;
    // Known bad code for instruction (needs manual fix):
        ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r17.w, r17.w, l(0), t26.xxxx
    r17.w = samp0[]..swiz;
      r18.w = cmp((int)r14.z == (int)r16.w);
      if (r14.w == 0) r19.x = 0; else if (r14.w+0 < 32) {       r19.x = (uint)r17.w << (32-(r14.w + 0)); r19.x = (uint)r19.x >> (32-r14.w);      } else r19.x = (uint)r17.w >> 0;
      ...
      while (true) {
        ...
        if (r19.w != 0) {
          ...
          r31.xzw = r13.xyz * r19.yyy + r32.xyz;
    ...
    bitmask.w = ((~(-1 << 8)) << 0) & 0xffffffff;  r9.w = (((uint)r25.y << 0) & bitmask.w) | ((uint)r9.w & ~bitmask.w);
    r12.w = r6.w ? r9.w : r25.y;
    r6.w = max(1, r25.x);
    r6.w = rcp(r6.w);
    r25.x = saturate(r25.x);
    r14.xyz = r21.xyz * r6.www;
    r30.xyz = r24.xyz * r6.www;
    r9.w = cmp(r25.x < 0.99000001);
    if (r9.w != 0) {
      r12.w = (int)r12.w + 256;
      r9.w = 1 + -r25.x;
      ...
      r14.xyz = r21.xyz * r6.www + r15.xyz;
      r13.w = 0;
      r13.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r13.xyzw, r8.w).xyz;
      r6.w = sunConstants.globalProbeExposure * r9.w + -r10.w;
      r6.w = r2.y * r6.w + r10.w;
      r30.xyz = r13.xyz * r6.www + r30.xyz;
    }
  } else {
  ...
  if (r2.y != 0) {
    ...
    if (r2.y != 0) {
      ...
      if (r10.w != 0) {
        ...
        if (r10.w == 0) {
          ...
          if (enableDitheredShadow != 0) {
            ...
            r19.z = (uint)r11.w;
            r13.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r19.xyz, r10.w).x;
          }
          r9.w = r13.w * r13.w;
          r9.w = r9.w * r13.w;
        } else {
        ...
        if (r1.z != 0) {
          ...
          if (r9.w == 0) {
            ...
            if (enableDitheredShadow != 0) {
              ...
              r5.x = 0;
              while (true) {
                r11.w = cmp((int)r5.x >= 8);
                if (r11.w != 0) break;
                r22.x = dot(icb[r5.x+0].yx, r20.xy);
                r22.y = dot(icb[r5.x+0].yx, r20.yz);
                r21.xy = r22.xy * lightConstantsCB[r1.z].data[3].yy + r19.xy;
                r11.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r21.xyz, r9.w).x;
                r4.x = r11.w * 0.125 + r4.x;
                r5.x = (int)r5.x + 1;
              }
            } else {
              r19.z = (uint)r10.w;
      ...
      r2.x = cmp(0 < r4.y);
      r4.xyw = r14.xyz * r3.zzz + r19.xyz;
      r14.xyz = -r10.xyz * r0.zzz + sunConstants.wldDir.xyz;
      ...
      r0.z = r2.y * r0.z;
      r0.z = r1.w * r0.z;
      r12.xyz = r0.zzz * r18.xyz + r16.xzw;
      r14.xyz = r1.zzz * r18.xyz + r15.xyz;
      r14.xyz = r0.www ? r14.xyz : 0;
      r13.xyz = r2.xxx ? r4.xyw : r13.xyz;
      r15.xyz = r2.xxx ? r15.xyz : r14.xyz;
      r16.xzw = r2.xxx ? r12.xyz : r16.xzw;
      r17.xyz = r2.xxx ? r11.xyz : r17.xyz;
      if (r2.w != 0) {
      // Known bad code for instruction (needs manual fix):
  ...
  if (enableCountDebug != 0) {
    if (debugDrawOverlayType != 0) {
      switch (cb2[53].y) {
        ...
        break;
        case 4 :        r0.w = (int)r12.w & 255;
        break;
        case 5 :        if (8 == 0) r0.w = 0; else if (8+8 < 32) {         r0.w = (uint)r12.w << (32-(8 + 8)); r0.w = (uint)r0.w >> (32-8);        } else r0.w = (uint)r12.w >> 8;
        break;
        default :
        r0.w = 0;
        break;
...
store_uav_typed u0.xyzw, r1.xyyy, r2.xyzx
  ...
  if (enableCountDebug != 0) {
    ...
    InterlockedAdd(dest, value, orig_value);
    if (8 == 0) r1.y = 0; else if (8+8 < 32) {     r1.y = (uint)r12.w << (32-(8 + 8)); r1.y = (uint)r1.y >> (32-8);    } else r1.y = (uint)r12.w >> 8;
    // Needs manual fix for instruction:
