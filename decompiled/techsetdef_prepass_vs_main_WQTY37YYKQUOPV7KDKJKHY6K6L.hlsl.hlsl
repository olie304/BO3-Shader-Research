...
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r0.xyz, r0.x, l(32), t5.xyzx
r0.x = modelInstanceBuffer[]..swiz;
...
r0.z = modelInstanceBuffer[]..swiz;
  ...
  r6.w = 1;
  r5.xyz = r3.xyz;
  r3.x = dot(r6.xyzw, r5.xyzw);
  r7.xyz = r4.xyz;
  r7.w = r2.y;
  r1.w = r2.z;
  r3.z = dot(r6.xyzw, r1.xyzw);
  r3.y = dot(r6.xyzw, r7.xyzw);
  r1.xyz = eyeOffset.xyz + r3.xyz;
  r0.w = weather.windSpeed * gameTime.w;
  r1.w = r0.w * 0.899999976 + r1.x;
  r0.w = 0.899999976 * r0.w;
  r0.w = r3.w * 0.100000001 + r0.w;
  ...
  r2.y = r2.x * 0.699999988 + r1.x;
  r2.x = 0.699999988 * r2.x;
  r2.x = r4.w * 0.100000001 + r2.x;
  r2.x = 0.0700000003 * r2.x;
  r2.x = cos(r2.x);
  r0.w = r2.x * 0.5 + r0.w;
  r0.w = 0.5 + r0.w;
  r0.w = 0.5 * r0.w;
  r2.x = 0.699999988 * r2.y;
  r2.x = cos(r2.x);
  r2.y = r2.x * r1.w;
  r2.z = 0.00999999978 * v0.z;
  r2.y = r2.y * r2.z;
  r2.zw = vertexColorScale.xy * v1.xy;
  r4.xy = weather.windSpeed * weather.windDirSin;
  r1.w = r4.x * r1.w;
  r2.x = r4.y * r2.x;
  r3.yz = r2.xy * r2.ww;
  r3.x = r1.w * r2.w;
  r2.xyw = float3(0.109999999,0.129999995,0.0900000036) * r3.xyz;
  r1.w = dot(v0.xz, v0.xz);
  r1.w = sqrt(r1.w);
  r1.w = weather.windSpeed * r1.w;
  r1.w = weather.windDirSin * r1.w;
  r1.w = r1.w * r0.w;
  r1.w = r1.w * r2.z;
  r2.x = r1.w * 0.00999999978 + r2.x;
  r1.w = dot(v0.yz, v0.yz);
  r1.w = sqrt(r1.w);
  r1.w = weather.windSpeed * r1.w;
  r1.w = weather.windDirCos * r1.w;
  r0.w = r1.w * r0.w;
  r0.w = r0.w * r2.z;
  r2.y = r0.w * 0.00999999978 + r2.y;
  ...
  r2.xyzw = r1.zzzz * viewProjectionMatrix._m20_m21_m22_m23 + r2.xyzw;
  r1.xyz = -motionVectorConstants.prevFrameEyeOffset.xyz + r1.xyz;
  r3.xyzw = -eyeOffset.yyyy * viewProjectionMatrix._m10_m11_m12_m13;
  r3.xyzw = -eyeOffset.xxxx * viewProjectionMatrix._m00_m01_m02_m03 + r3.xyzw;
  r3.xyzw = -eyeOffset.zzzz * viewProjectionMatrix._m20_m21_m22_m23 + r3.xyzw;
  r3.xyzw = viewProjectionMatrix._m30_m31_m32_m33 + r3.xyzw;
  o0.xyzw = r3.xyzw + r2.xyzw;
  r2.xyz = v2.xyz * float3(2.00195694,2.00195694,2.00195694) + float3(-1.00195694,-1.00195694,-1.00195694);
  o1.x = dot(r2.xyz, r5.xyz);
  o1.y = dot(r2.xyz, r7.xyz);
  o1.z = dot(r2.xyz, r0.xyz);
  r0.xyzw = motionVectorConstants.prevFrameOffToClpMatrixFull._m10_m11_m12_m13 * r1.yyyy;
  r0.xyzw = r1.xxxx * motionVectorConstants.prevFrameOffToClpMatrixFull._m00_m01_m02_m03 + r0.xyzw;
  r0.xyzw = r1.zzzz * motionVectorConstants.prevFrameOffToClpMatrixFull._m20_m21_m22_m23 + r0.xyzw;
