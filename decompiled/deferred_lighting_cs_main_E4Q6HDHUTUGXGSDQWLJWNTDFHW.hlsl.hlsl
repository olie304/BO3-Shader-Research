...
r0.y = samplerLinear[]..swiz;
  ...
  while (true) {
    ...
    r14.y = cmp((uint)r9.w < numRefProbes);
    r13.w = r13.w ? r14.y : 0;
    if (r13.w != 0) {
      r9.w = (int)r9.w * 14;
      r14.yzw = -refProbeConstantsCB[r9.w].data[0].xyz + r11.xyz;
      r13.w = 0x0000ffff & (int)refProbeConstantsCB[r9.w].data[7].z;
      if (6 == 0) r15.y = 0; else if (6+25 < 32) {       r15.y = (uint)refProbeConstantsCB[r9.w].data[7].z << (32-(6 + 25)); r15.y = (uint)r15.y >> (32-6);      } else r15.y = (uint)refProbeConstantsCB[r9.w].data[7].z >> 25;
      r15.z = (int)r13.w * 6;
      ...
      r17.x = r15.w * r15.z;
      r15.z = 1 & (int)refProbeConstantsCB[r9.w].data[6].x;
      r15.zw = r15.zz ? r17.xy : r17.zx;
      r17.x = refProbeConstantsCB[r9.w].data[6].x;
      r24.xy = r15.zw;
      r17.w = 1;
      while (true) {
      ...
      r13.w = refProbeConstantsCB[r9.w].data[6].y * r24.y;
      r15.y = cmp(0 < r13.w);
      if (r15.y != 0) {
        ...
        r15.y = dot(r16.xyz, r25.xyz);
        r15.z = dot(r14.yzw, r25.xyz);
        r15.z = -refProbeConstantsCB[r9.w].data[8].z + r15.z;
        r15.w = cmp(r15.z >= 0);
        ...
        r15.z = dot(r16.xyz, r25.xyz);
        r15.w = dot(r14.yzw, r25.xyz);
        ...
        r15.z = r15.w / r15.z;
        r15.y = min(r15.y, abs(r15.z));
        r25.x = refProbeConstantsCB[r9.w].data[3].w + r14.y;
        r25.yz = refProbeConstantsCB[r9.w].data[4].xy + r14.zw;
        r19.yzw = r16.xyz * r15.yyy + r25.xyz;
        ...
        if (9 == 0) r15.z = 0; else if (9+16 < 32) {         r15.z = (uint)refProbeConstantsCB[r9.w].data[7].z << (32-(9 + 16)); r15.z = (uint)r15.z >> (32-9);        } else r15.z = (uint)refProbeConstantsCB[r9.w].data[7].z >> 16;
        r26.w = (uint)r15.z;
        r15.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r26.xyzw, r15.y).xyz;
        r29.x = dot(r14.yzw, r25.xyz);
        r29.y = dot(r14.yzw, r27.xyz);
        r29.z = dot(r14.yzw, r28.xyz);
        r14.yzw = saturate(r29.xyz * refProbeConstantsCB[r9.w].data[3].xyz + float3(0.5,0.5,0.5));
        r29.xy = refProbeConstantsCB[r9.w].data[4].zw * r14.yz;
        r29.z = refProbeConstantsCB[r9.w].data[5].x * r14.w;
        r14.yzw = refProbeConstantsCB[r9.w].data[5].yzw + r29.xyz;
        r26.x = dot(r12.xyz, r25.xyz);
        r26.y = dot(r12.xyz, r27.xyz);
        r26.z = dot(r12.xyz, r28.xyz);
        r19.yzw = cmp(float3(0,0,0) < r26.xyz);
        r18.z = r19.y ? 0 : 0.5;
        r24.xzw = r18.xyz + r14.yzw;
        r24.xzw = gProbeXArray.SampleLevel(samplerLinearClamp_s, r24.xzw, 0).xyz;
        r25.xyz = r26.xyz * r26.xyz;
        r25.xyz = r25.xyz * r13.www;
        r20.z = r19.z ? 0 : 0.5;
        r27.xyz = r20.xyz + r14.yzw;
        r27.xyz = gProbeYArray.SampleLevel(samplerLinearClamp_s, r27.xyz, 0).xyz;
        r27.xyz = r27.xyz * r25.yyy;
        r24.xzw = r24.xzw * r25.xxx + r27.xyz;
        r21.z = r19.w ? 0 : 0.5;
        r14.yzw = r21.xyz + r14.yzw;
        r14.yzw = gProbeZArray.SampleLevel(samplerLinearClamp_s, r14.yzw, 0).xyz;
        r14.yzw = r14.yzw * r25.zzz + r24.xzw;
        r19.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r26.xyzw, 6).xyz;
        r24.xzw = r19.yzw * r14.yzw;
        r9.w = dot(r24.xzw, float3(0.212599993,0.715200007,0.0722000003));
        r22.xyz = r14.yzw * r19.yzw + r22.xyz;
        r14.y = r9.w * r4.w;
  ...
  if (r8.w != 0) {
    ...
    while (true) {
      ...
      if (r13.w != 0) {
        ...
        r13.w = 0x0000ffff & (int)refProbeConstantsCB[r9.w].data[7].z;
        if (6 == 0) r17.w = 0; else if (6+25 < 32) {         r17.w = (uint)refProbeConstantsCB[r9.w].data[7].z << (32-(6 + 25)); r17.w = (uint)r17.w >> (32-6);        } else r17.w = (uint)refProbeConstantsCB[r9.w].data[7].z >> 25;
        r18.w = (int)r13.w * 6;
        ...
        r18.w = saturate(refProbeAttenuationConstantsCB[r18.w].data[5].w + r19.w);
        r17.x = r19.z * r18.w;
        r18.w = 1 & (int)refProbeConstantsCB[r9.w].data[6].x;
        ...
        while (true) {
          ...
          r20.w = (int)r20.w * 6;
          r21.w = dot(refProbeAttenuationConstantsCB[r20.w].data[0].xyz, r15.yzw);
          r21.w = saturate(refProbeAttenuationConstantsCB[r20.w].data[0].w + r21.w);
          r21.w = r25.x * r21.w;
          r25.z = dot(refProbeAttenuationConstantsCB[r20.w].data[1].xyz, r15.yzw);
          r25.z = saturate(refProbeAttenuationConstantsCB[r20.w].data[1].w + r25.z);
          r21.w = r25.z * r21.w;
          r25.z = dot(refProbeAttenuationConstantsCB[r20.w].data[2].xyz, r15.yzw);
          r25.z = saturate(refProbeAttenuationConstantsCB[r20.w].data[2].w + r25.z);
          r21.w = r25.z * r21.w;
          r25.z = dot(refProbeAttenuationConstantsCB[r20.w].data[3].xyz, r15.yzw);
          r25.z = saturate(refProbeAttenuationConstantsCB[r20.w].data[3].w + r25.z);
          r21.w = r25.z * r21.w;
          r25.z = dot(refProbeAttenuationConstantsCB[r20.w].data[4].xyz, r15.yzw);
          r25.z = saturate(refProbeAttenuationConstantsCB[r20.w].data[4].w + r25.z);
          r21.w = r25.z * r21.w;
          r25.z = dot(refProbeAttenuationConstantsCB[r20.w].data[5].xyz, r15.yzw);
          r20.w = saturate(refProbeAttenuationConstantsCB[r20.w].data[5].w + r25.z);
          r25.x = r21.w * r20.w;
          r25.z = (uint)r17.x >> 2;
          if (1 == 0) r25.w = 0; else if (1+2 < 32) {           r25.w = (uint)r17.x << (32-(1 + 2)); r25.w = (uint)r25.w >> (32-1);          } else r25.w = (uint)r17.x >> 2;
          r26.x = (int)r25.z & 2;
          r26.y = max(r25.y, r25.x);
          r20.w = -r21.w * r20.w + 1;
          r20.w = r25.y * r20.w;
          r19.y = r26.x ? r20.w : r26.y;
          r25.xy = r25.ww ? r25.xy : r19.xy;
          r18.w = (int)r18.w + 1;
          r17.x = r25.z;
        }
        r13.w = saturate(r25.y + -r23.w);
        r17.x = refProbeConstantsCB[r9.w].data[6].y * r13.w;
        r17.w = cmp(0 < r17.x);
        if (r17.w != 0) {
          r24.w = r13.w * refProbeConstantsCB[r9.w].data[6].y + r24.w;
          r13.w = refProbeConstantsCB[r9.w].data[7].y * r17.x;
          r26.x = refProbeConstantsCB[r9.w].data[7].w;
          r26.yz = refProbeConstantsCB[r9.w].data[8].xy;
          r17.x = dot(r16.xyz, r26.xyz);
          r17.w = dot(r15.yzw, r26.xyz);
          ...
          r17.w = r18.w / r17.w;
          r17.x = min(r17.x, abs(r17.w));
          r26.x = refProbeConstantsCB[r9.w].data[3].w + r15.y;
          r26.yz = refProbeConstantsCB[r9.w].data[4].xy + r15.zw;
          ...
          if (9 == 0) r17.w = 0; else if (9+16 < 32) {           r17.w = (uint)refProbeConstantsCB[r9.w].data[7].z << (32-(9 + 16)); r17.w = (uint)r17.w >> (32-9);          } else r17.w = (uint)refProbeConstantsCB[r9.w].data[7].z >> 16;
          r27.w = (uint)r17.w;
          ...
          r15.yzw = saturate(r30.xyz * refProbeConstantsCB[r9.w].data[3].xyz + float3(0.5,0.5,0.5));
          r30.xy = refProbeConstantsCB[r9.w].data[4].zw * r15.yz;
          r30.z = refProbeConstantsCB[r9.w].data[5].x * r15.w;
          r15.yzw = refProbeConstantsCB[r9.w].data[5].yzw + r30.xyz;
          r27.x = dot(r12.xyz, r26.xyz);
          r27.y = dot(r12.xyz, r28.xyz);
          r27.z = dot(r12.xyz, r29.xyz);
          r25.xzw = cmp(float3(0,0,0) < r27.xyz);
          r18.z = r25.x ? 0 : 0.5;
          r26.xyz = r18.xyz + r15.yzw;
          r26.xyz = gProbeXArray.SampleLevel(samplerLinearClamp_s, r26.xyz, 0).xyz;
          r28.xyz = r27.xyz * r27.xyz;
          r28.xyz = r28.xyz * r13.www;
          r20.z = r25.z ? 0 : 0.5;
          r29.xyz = r20.xyz + r15.yzw;
          ...
          r14.yzw = r15.yzw * r25.xzw + r14.yzw;
          r15.y = r9.w * r4.w;
          r19.yzw = r19.yzw * r13.www;
          r13.w = dot(r19.yzw, float3(0.212599993,0.715200007,0.0722000003));
          r9.w = r4.w * r9.w + r13.w;
          r9.w = r15.y / r9.w;
