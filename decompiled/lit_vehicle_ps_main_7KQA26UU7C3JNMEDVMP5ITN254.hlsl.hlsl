...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  r2.w = min(1, r2.w);
  r4.xyzw = detailNormalMask.Sample(detailMaskSampler_s, v2.xy).xyzw;
  r3.w = cmp(0 < r4.x);
  r5.xy = detailScale3.xy * v2.xy;
  r5.xyz = detailNormal1.Sample(normalSampler_s, r5.xy).xyz;
  r6.xy = detailScale2.xy * v2.xy;
  r6.xyz = detailNormal2.Sample(normalSampler_s, r6.xy).xyz;
  r7.xy = detailScale1.xy * v2.xy;
  r7.xyz = detailNormal3.Sample(normalSampler_s, r7.xy).xyz;
  r8.xy = detailScale.xy * v2.xy;
  r8.xyz = detailNormal4.Sample(normalSampler_s, r8.xy).xyz;
  if (r3.w != 0) {
    r3.w = detailScaleHeight3 * r4.x;
    r8.xyz = r5.xyz;
  } else {
    r4.x = cmp(0 < r4.y);
    if (r4.x != 0) {
      r3.w = detailScaleHeight2 * r4.y;
      r8.xyz = r6.xyz;
    } else {
      r4.x = cmp(0 < r4.z);
      if (r4.x != 0) {
        r3.w = detailScaleHeight1 * r4.z;
        r8.xyz = r7.xyz;
      } else {
        r4.x = cmp(0 < r4.w);
        if (r4.x != 0) {
          r3.w = detailScaleHeight * r4.w;
        } else {
          r8.xyz = float3(0,0,0);
          r3.w = 0;
        }
  ...
  r4.xy = r8.xy * float2(1.9921875,1.9921875) + float2(-1,-1);
  r4.z = r8.z * r8.z;
  r4.z = 0.333333343 * r4.z;
  r4.z = min(1, r4.z);
  r3.xy = r4.xy * r3.ww + r2.yz;
  ...
  r2.x = r2.y + r2.x;
  r2.x = log2(r2.x);
  r7.y = saturate(-0.0588235296 * r2.x);
  r2.xzw = r6.xyz * r3.yyy;
  r2.xzw = r5.xyz * r3.xxx + r2.xzw;
  r2.xzw = r4.xyz * r3.zzz + r2.xzw;
  r3.w = dot(r2.xzw, r2.xzw);
  r3.w = rsqrt(r3.w);
  r8.xyz = r3.www * r2.xzw;
  r2.xz = (uint2)v0.xy;
  ...
  r7.x = saturate(dot(r8.xyz, r9.xyz));
  r5.w = dot(-r9.xyz, r8.xyz);
  r5.w = r5.w + r5.w;
  r14.xyz = r8.xyz * -r5.www + -r9.xyz;
  r5.w = 17 * r7.y;
  r5.w = exp2(r5.w);
  r5.w = 2 + r5.w;
  r5.w = 2 / r5.w;
  ...
  if (r7.w != 0) {
    ...
    if (r7.w != 0) {
      ...
      r11.w = cmp(0 < (uint)r7.w);
      r11.w = r4.w ? r11.w : 0;
      if (r11.w != 0) {
        r7.w = (int)r7.w + numLights;
        r7.w = (int)r7.w + -1;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r11.w, r7.w, l(52), t12.xxxx
      r11.w = samp0[]..swiz;
      // Known bad code for instruction (needs manual fix):
      ...
      r18.w = samp0[]..swiz;
        ...
        r15.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r13.yz, r7.w, l(164), t12.xxyx
        r13.y = samp0[]..swiz;
        r13.z = samp0[]..swiz;
          ...
          if (enableDitheredShadow != 0) {
            ...
            while (true) {
              ...
              r13.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r17.xyz, r7.w).x;
              r12.z = r13.y * 0.125 + r12.z;
              r12.w = (int)r12.w + 1;
            }
          } else {
            r15.z = (uint)r12.y;
            r12.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r15.xyz, r7.w).x;
          }
          r7.w = r12.z * r12.z;
          r7.w = r7.w * r12.z;
        } else {
  ...
  r10.xyzw = metalFlakeMaskScale * v2.xyxy;
  r10.xyzw = float4(4,4,4,4) * r10.xyzw;
  r2.z = metalFlakeMaskMap.Sample(metalFlakeSampler_s, r10.xy).x;
  r17.xyzw = float4(0.5,0.5,0.5,0.5) + v2.xyxy;
  r17.xyzw = metalFlakeMaskScale * r17.xyzw;
  r17.xyzw = float4(4,4,4,4) * r17.xyzw;
  r2.w = metalFlakeMaskMap.Sample(metalFlakeSampler_s, r17.xy).x;
  r10.xyz = metalFlakeNormalMap.Sample(metalFlakeSampler_s, r10.zw).xyz;
  r7.zw = r10.xy * float2(1.9921875,1.9921875) + float2(-1,-1);
  r5.w = r10.z * r10.z;
  ...
  r6.w = min(1, r6.w);
  r3.xy = r7.zw * r2.zz + r3.xy;
  r7.z = dot(r3.xyz, r3.xyz);
  r7.z = rsqrt(r7.z);
  r3.xyz = r7.zzz * r3.xyz;
  r2.y = r5.w * r2.z + r2.y;
  r3.xy = r10.xy * r2.ww + r3.xy;
  ...
  r2.y = r2.y * r7.y + -r7.y;
  r2.y = r0.w * r2.y + r7.y;
  r2.z = saturate(dot(r3.xyz, r9.xyz));
  ...
  r2.w = r2.w * r2.z;
  r2.z = r5.x * r2.z;
  r5.x = dot(r3.xyz, sunConstants.wldDir.xyz);
  r5.y = saturate(r5.x);
  r5.z = cmp(0 >= r5.y);
  if (r5.z != 0) {
    r5.w = 0;
  ...
  if (r5.z == 0) {
    r6.xyz = sunConstants.sstLightingConstants.offToPinTransform._m10_m11_m12 * v6.yyy;
    r6.xyz = v6.xxx * sunConstants.sstLightingConstants.offToPinTransform._m00_m01_m02 + r6.xyz;
    r6.xyz = v6.zzz * sunConstants.sstLightingConstants.offToPinTransform._m20_m21_m22 + r6.xyz;
    ...
    if (r6.w != 0) {
      ...
      while (true) {
        ...
        if (r7.w != 0) break;
        r7.w = (uint)r6.w;
        r10.xy = -sunConstants.splitPinTransform[r7.w].xy + r6.xy;
    ...
    if (r7.w == 0) {
      if (enableDitheredShadow == 0) {
        ...
        r7.w = gTransShadowmapArray.SampleLevel(samp0_s, r10.xyz, 0).x;
        r6.z = r7.w + r6.z;
  ...
  if (r5.z != 0) {
    ...
    if (r5.z != 0) {
      ...
      if (sunConstants.sunCookieIndex != 0) {
        ...
        r6.w = 1;
        r7.z = dot(sunConstants.sunCookieTransform[0].xyzw, r6.xyzw);
      ...
      r19.z = samp0[]..swiz;
      r19.w = samp0[]..swiz;
        r7.w = abs(r5.x) * -0.200000003 + 0.400000006;
        r20.xyz = r3.xyz * r7.www + v6.xyz;
        r20.w = 1;
      ...
      r5.x = cmp(0 < r5.x);
      r10.xyz = -v6.xyz * r3.www + sunConstants.wldDir.xyz;
      r3.w = dot(r10.xyz, r10.xyz);
      r3.w = rsqrt(r3.w);
      r10.xyz = r10.xyz * r3.www;
      r3.w = dot(r10.xyz, r9.xyz);
      r6.w = dot(r3.xyz, r10.xyz);
      r7.z = abs(r6.w) * r2.y + -abs(r6.w);
  ...
  r2.x = 1 + -r7.y;
  r2.z = r2.x * 5 + -2.5;
  r2.yz = float2(5,0.400000006) * r2.xz;
  r2.z = max(0, r2.z);
  ...
  while (true) {
    ...
    while (true) {
      ...
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=80)(mixed,mixed,mixed,mixed) r22.xyzw, r6.x, l(0), t11.xyzw
      r22.x = samp0[]..swiz;
      r22.y = samp0[]..swiz;
      r22.z = samp0[]..swiz;
      r22.w = samp0[]..swiz;
      ...
      r6.y = samp0[]..swiz;
        ...
        r23.w = samp0[]..swiz;
          ...
          r6.z = (int)r23.w & 0x0000ffff;
          if (6 == 0) r7.z = 0; else if (6+25 < 32) {           r7.z = (uint)r23.w << (32-(6 + 25)); r7.z = (uint)r7.z >> (32-6);          } else r7.z = (uint)r23.w >> 25;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r25.xyzw, r6.z, l(0), t16.xyzw
        r25.x = samp0[]..swiz;
        r25.y = samp0[]..swiz;
        r25.z = samp0[]..swiz;
        r25.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r26.xyzw, r6.z, l(16), t16.xyzw
        r26.x = samp0[]..swiz;
        r26.y = samp0[]..swiz;
        r26.z = samp0[]..swiz;
        r26.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r27.xyzw, r6.z, l(32), t16.xyzw
        r27.x = samp0[]..swiz;
        r27.y = samp0[]..swiz;
        r27.z = samp0[]..swiz;
        r27.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r28.xyzw, r6.z, l(48), t16.xyzw
        r28.x = samp0[]..swiz;
        r28.y = samp0[]..swiz;
        r28.z = samp0[]..swiz;
        r28.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r30.xyzw, r6.z, l(64), t16.xyzw
        r30.x = samp0[]..swiz;
        r30.y = samp0[]..swiz;
        r30.z = samp0[]..swiz;
        r30.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r31.xyzw, r6.z, l(80), t16.xyzw
        r31.x = samp0[]..swiz;
        r31.y = samp0[]..swiz;
        r31.z = samp0[]..swiz;
        r31.w = samp0[]..swiz;
          r7.w = dot(r25.xyz, r24.xyz);
          r7.w = saturate(r7.w + r25.w);
          r9.w = dot(r26.xyz, r24.xyz);
          r9.w = saturate(r9.w + r26.w);
          r7.w = r9.w * r7.w;
          r9.w = dot(r27.xyz, r24.xyz);
          r9.w = saturate(r9.w + r27.w);
          r7.w = r9.w * r7.w;
          r9.w = dot(r28.xyz, r24.xyz);
          r9.w = saturate(r9.w + r28.w);
          r7.w = r9.w * r7.w;
          r9.w = dot(r30.xyz, r24.xyz);
          r9.w = saturate(r9.w + r30.w);
          r7.w = r9.w * r7.w;
          r9.w = dot(r31.xyz, r24.xyz);
          r9.w = saturate(r9.w + r31.w);
          r9.x = r9.w * r7.w;
          r7.w = r6.x ? 0.000000 : 0;
          r9.xw = r7.ww ? r9.xy : r9.zx;
          r7.w = r6.x;
          r25.xy = r9.xw;
          r10.w = 1;
          while (true) {
            r11.z = cmp((int)r10.w >= (int)r7.z);
            if (r11.z != 0) break;
          ...
          r28.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r30.xyzw, r11.z, l(48), t16.xyzw
          r30.x = samp0[]..swiz;
          r30.y = samp0[]..swiz;
          r30.z = samp0[]..swiz;
          r30.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r31.xyzw, r11.z, l(64), t16.xyzw
          r31.x = samp0[]..swiz;
          r31.y = samp0[]..swiz;
          r31.z = samp0[]..swiz;
          r31.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r32.xyzw, r11.z, l(80), t16.xyzw
          r32.x = samp0[]..swiz;
          r32.y = samp0[]..swiz;
          r32.z = samp0[]..swiz;
          r32.w = samp0[]..swiz;
            r11.z = dot(r26.xyz, r24.xyz);
            r11.z = saturate(r11.z + r26.w);
            r11.z = r25.x * r11.z;
            r11.w = dot(r27.xyz, r24.xyz);
            r11.w = saturate(r11.w + r27.w);
            r11.z = r11.z * r11.w;
            r11.w = dot(r28.xyz, r24.xyz);
            r11.w = saturate(r11.w + r28.w);
            r11.z = r11.z * r11.w;
            r11.w = dot(r30.xyz, r24.xyz);
            r11.w = saturate(r11.w + r30.w);
            r11.z = r11.z * r11.w;
            r11.w = dot(r31.xyz, r24.xyz);
            r11.w = saturate(r11.w + r31.w);
            r11.z = r11.z * r11.w;
            r11.w = dot(r32.xyz, r24.xyz);
            r11.w = saturate(r11.w + r32.w);
            r25.x = r11.z * r11.w;
            r12.x = (uint)r7.w >> 2;
            if (1 == 0) r13.x = 0; else if (1+2 < 32) {             r13.x = (uint)r7.w << (32-(1 + 2)); r13.x = (uint)r13.x >> (32-1);            } else r13.x = (uint)r7.w >> 2;
            r15.w = (int)r12.x & 2;
            r16.w = max(r25.y, r25.x);
            r11.z = -r11.z * r11.w + 1;
            r11.z = r25.y * r11.z;
            r11.y = r15.w ? r11.z : r16.w;
            r25.xy = r13.xx ? r25.xy : r11.xy;
            r10.w = (int)r10.w + 1;
            r7.w = r12.x;
          }
          ...
          if (r6.z != 0) {
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r26.xyzw, r5.w, l(16), t15.xyzw
          r26.x = samp0[]..swiz;
          r26.y = samp0[]..swiz;
          r26.z = samp0[]..swiz;
          r26.w = samp0[]..swiz;
          ...
          r28.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r30.xyzw, r5.w, l(64), t15.zwxy
          r30.x = samp0[]..swiz;
          r30.y = samp0[]..swiz;
          r30.z = samp0[]..swiz;
          r30.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r31.xyzw, r5.w, l(80), t15.xyzw
          r31.x = samp0[]..swiz;
          r31.y = samp0[]..swiz;
          r31.z = samp0[]..swiz;
          r31.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r32.xyzw, r5.w, l(132), t15.zwxy
          r32.x = samp0[]..swiz;
          r32.y = samp0[]..swiz;
          r32.z = samp0[]..swiz;
          r32.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r33.xyzw, r5.w, l(148), t15.zwxy
          r33.x = samp0[]..swiz;
          r33.y = samp0[]..swiz;
          r33.z = samp0[]..swiz;
          r33.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r34.xyzw, r5.w, l(164), t15.zwxy
          r34.x = samp0[]..swiz;
          r34.y = samp0[]..swiz;
          r34.z = samp0[]..swiz;
          r34.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r35.xyzw, r5.w, l(180), t15.zwxy
          r35.x = samp0[]..swiz;
          r35.y = samp0[]..swiz;
          r35.z = samp0[]..swiz;
          r35.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r36.xyzw, r5.w, l(196), t15.xyzw
          r36.x = samp0[]..swiz;
          r36.y = samp0[]..swiz;
          r36.z = samp0[]..swiz;
          r36.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r37.xy, r5.w, l(212), t15.xyxx
          r37.x = samp0[]..swiz;
          r37.y = samp0[]..swiz;
            r21.z = r25.y * r6.y + r21.z;
            r5.w = r6.x * r23.z;
            r23.z = r32.z;
            r6.x = dot(r14.xyz, r23.xyz);
            r6.y = dot(r24.xyz, r23.xyz);
            r6.y = r6.y + -r32.w;
            r6.z = cmp(r6.y >= 0);
            ...
            r32.z = r33.z;
            r6.y = dot(r14.xyz, r32.xyz);
            r6.z = dot(r24.xyz, r32.xyz);
            r6.z = r6.z + -r33.w;
            r7.z = cmp(r6.z >= 0);
            ...
            r33.z = r34.z;
            r6.y = dot(r14.xyz, r33.xyz);
            r6.z = dot(r24.xyz, r33.xyz);
            r6.z = r6.z + -r34.w;
            r7.z = cmp(r6.z >= 0);
            r6.z = max(abs(r6.z), r2.z);
            r6.z = r7.z ? r6.z : -r6.z;
            ...
            r6.x = min(r6.x, abs(r6.y));
            r37.zw = r36.zw;
            r6.y = dot(r14.zxy, r37.xzw);
            r6.z = dot(r24.zxy, r37.xzw);
            r6.z = r6.z + -r37.y;
            r7.z = cmp(r6.z >= 0);
            r6.z = max(abs(r6.z), r2.z);
            r6.z = r7.z ? r6.z : -r6.z;
            ...
            r22.y = r26.z;
            r22.z = r27.x;
            r32.x = dot(r11.yzw, r22.xyz);
            r23.xy = r26.xw;
            r23.z = r27.w;
            r32.y = dot(r11.yzw, r23.xyz);
            r27.x = r26.y;
            r32.z = dot(r11.yzw, r27.xyz);
            if (9 == 0) r6.y = 0; else if (9+16 < 32) {             r6.y = (uint)r23.w << (32-(9 + 16)); r6.y = (uint)r6.y >> (32-9);            } else r6.y = (uint)r23.w >> 16;
            r32.w = (uint)r6.y;
            r6.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r32.xyzw, r6.x).xyz;
            r26.x = dot(r24.xyz, r22.xyz);
            r26.y = dot(r24.xyz, r23.xyz);
            r26.z = dot(r24.xyz, r27.xyz);
            r11.yzw = saturate(r26.xyz * r28.xyz + float3(0.5,0.5,0.5));
            r30.z = r31.x;
            r11.yzw = r11.yzw * r30.xyz + r31.yzw;
            r32.x = dot(r8.xyz, r22.xyz);
            r32.y = dot(r8.xyz, r23.xyz);
            r32.z = dot(r8.xyz, r27.xyz);
            r22.xyz = cmp(float3(0,0,0) < r32.xyz);
            r10.z = r22.x ? 0 : 0.5;
            r23.xyz = r11.yzw + r10.xyz;
            r23.xyz = gProbeXArray.SampleLevel(samplerLinearClamp_s, r23.xyz, 0).xyz;
            r24.xyz = r32.xyz * r32.xyz;
            r24.xyz = r24.xyz * r5.www;
            r16.z = r22.y ? 0 : 0.5;
            r22.xyw = r16.xyz + r11.yzw;
            ...
            r17.z = r22.z ? 0 : 0.5;
            r11.yzw = r17.xyz + r11.yzw;
            r11.yzw = gProbeZArray.SampleLevel(samplerLinearClamp_s, r11.yzw, 0).xyz;
            r11.yzw = r11.yzw * r24.zzz + r22.xyw;
            r22.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r32.xyzw, 6).xyz;
            r23.xyz = r22.xyz * r11.yzw;
            r7.z = dot(r23.xyz, float3(0.212599993,0.715200007,0.0722000003));
            r20.xyz = r11.yzw * r22.xyz + r20.xyz;
            r7.w = r7.z * r2.w;
  ...
  if (r3.w != 0) {
    ...
    while (true) {
      ...
      while (true) {
        ...
        r7.z = 1 << (int)r6.w;
        r7.w = (int)r5.z & (int)r7.z;
        if (r7.w != 0) {
          r5.z = (int)r5.z ^ (int)r7.z;
          r7.z = (int)r5.x + (int)r6.w;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=80)(mixed,mixed,mixed,mixed) r23.xyzw, r7.z, l(0), t11.xyzw
        r23.x = samp0[]..swiz;
        r23.y = samp0[]..swiz;
        r23.z = samp0[]..swiz;
        r23.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=80)(mixed,mixed,mixed,mixed) r24.xy, r7.z, l(16), t11.xyxx
        r24.x = samp0[]..swiz;
        r24.y = samp0[]..swiz;
          ...
          r24.w = samp0[]..swiz;
            ...
            if (6 == 0) r10.z = 0; else if (6+25 < 32) {             r10.z = (uint)r24.w << (32-(6 + 25)); r10.z = (uint)r10.z >> (32-6);            } else r10.z = (uint)r24.w >> 25;
          // Known bad code for instruction (needs manual fix):
          ...
          r32.w = samp0[]..swiz;
            ...
            r11.w = dot(r27.xyz, r25.xyz);
            r11.w = saturate(r11.w + r27.w);
            r10.w = r11.w * r10.w;
            r11.w = dot(r28.xyz, r25.xyz);
            r11.w = saturate(r11.w + r28.w);
            r10.w = r11.w * r10.w;
            r11.w = dot(r30.xyz, r25.xyz);
            r11.w = saturate(r11.w + r30.w);
            r10.w = r11.w * r10.w;
            r11.w = dot(r31.xyz, r25.xyz);
            r11.w = saturate(r11.w + r31.w);
            r10.w = r11.w * r10.w;
            r11.w = dot(r32.xyz, r25.xyz);
            r11.w = saturate(r11.w + r32.w);
            r6.x = r11.w * r10.w;
            r10.w = (int)r7.z & 1;
            r26.xy = r10.ww ? r6.xy : r6.zx;
            r6.x = r7.z;
            r27.xy = r26.xy;
            r10.w = 1;
            while (true) {
            ...
            r28.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r30.xyzw, r11.w, l(16), t16.xyzw
            r30.x = samp0[]..swiz;
            r30.y = samp0[]..swiz;
            r30.z = samp0[]..swiz;
            r30.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r31.xyzw, r11.w, l(32), t16.xyzw
            r31.x = samp0[]..swiz;
            r31.y = samp0[]..swiz;
            r31.z = samp0[]..swiz;
            r31.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r32.xyzw, r11.w, l(48), t16.xyzw
            r32.x = samp0[]..swiz;
            r32.y = samp0[]..swiz;
            r32.z = samp0[]..swiz;
            r32.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r33.xyzw, r11.w, l(64), t16.xyzw
            r33.x = samp0[]..swiz;
            r33.y = samp0[]..swiz;
            r33.z = samp0[]..swiz;
            r33.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r34.xyzw, r11.w, l(80), t16.xyzw
            r34.x = samp0[]..swiz;
            r34.y = samp0[]..swiz;
            r34.z = samp0[]..swiz;
            r34.w = samp0[]..swiz;
              ...
              r11.w = saturate(r11.w + r28.w);
              r11.w = r27.x * r11.w;
              r12.x = dot(r30.xyz, r25.xyz);
              r12.x = saturate(r12.x + r30.w);
              r11.w = r12.x * r11.w;
              r12.x = dot(r31.xyz, r25.xyz);
              r12.x = saturate(r12.x + r31.w);
              r11.w = r12.x * r11.w;
              r12.x = dot(r32.xyz, r25.xyz);
              r12.x = saturate(r12.x + r32.w);
              r11.w = r12.x * r11.w;
              r12.x = dot(r33.xyz, r25.xyz);
              r12.x = saturate(r12.x + r33.w);
              r11.w = r12.x * r11.w;
              r12.x = dot(r34.xyz, r25.xyz);
              ...
              r11.w = -r11.w * r12.x + 1;
              r11.w = r27.y * r11.w;
              r10.y = r16.w ? r11.w : r20.w;
              r27.xy = r15.ww ? r27.xy : r10.xy;
              r10.w = (int)r10.w + 1;
              r6.x = r13.x;
            }
            r6.x = saturate(r27.y + -r5.y);
            r7.z = r6.x * r7.w;
            r9.w = cmp(0 < r7.z);
            if (r9.w != 0) {
            // Known bad code for instruction (needs manual fix):
            ...
            r26.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r28.xyzw, r6.w, l(32), t15.yxwz
            r28.x = samp0[]..swiz;
            r28.y = samp0[]..swiz;
            r28.z = samp0[]..swiz;
            r28.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r30.xyzw, r6.w, l(48), t15.xyzw
            r30.x = samp0[]..swiz;
            r30.y = samp0[]..swiz;
            r30.z = samp0[]..swiz;
            r30.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r31.xyzw, r6.w, l(64), t15.zwxy
            r31.x = samp0[]..swiz;
            r31.y = samp0[]..swiz;
            r31.z = samp0[]..swiz;
            r31.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r32.xyzw, r6.w, l(80), t15.xyzw
            r32.x = samp0[]..swiz;
            r32.y = samp0[]..swiz;
            r32.z = samp0[]..swiz;
            r32.w = samp0[]..swiz;
            ...
            r33.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r34.xyzw, r6.w, l(148), t15.zwxy
            r34.x = samp0[]..swiz;
            r34.y = samp0[]..swiz;
            r34.z = samp0[]..swiz;
            r34.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r35.xyzw, r6.w, l(164), t15.zwxy
            r35.x = samp0[]..swiz;
            r35.y = samp0[]..swiz;
            r35.z = samp0[]..swiz;
            r35.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r36.xyzw, r6.w, l(180), t15.zwxy
            r36.x = samp0[]..swiz;
            r36.y = samp0[]..swiz;
            r36.z = samp0[]..swiz;
            r36.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r37.xyzw, r6.w, l(196), t15.xyzw
            r37.x = samp0[]..swiz;
            r37.y = samp0[]..swiz;
            r37.z = samp0[]..swiz;
            r37.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r38.xy, r6.w, l(212), t15.xyxx
            r38.x = samp0[]..swiz;
            r38.y = samp0[]..swiz;
              r21.w = r6.x * r7.w + r21.w;
              r6.x = r7.z * r24.z;
              r24.z = r33.z;
              r6.w = dot(r14.xyz, r24.xyz);
              r7.z = dot(r25.xyz, r24.xyz);
              r7.z = r7.z + -r33.w;
              r7.w = cmp(r7.z >= 0);
              r7.z = max(abs(r7.z), r2.z);
              r7.z = r7.w ? r7.z : -r7.z;
              r6.w = max(1.00000001e-07, -r6.w);
              r6.w = r7.z / r6.w;
              r6.w = min(131072, abs(r6.w));
              r33.z = r34.z;
              r7.z = dot(r14.xyz, r33.xyz);
              r7.w = dot(r25.xyz, r33.xyz);
              r7.w = r7.w + -r34.w;
              r9.w = cmp(r7.w >= 0);
              ...
              r34.z = r35.z;
              r7.z = dot(r14.xyz, r34.xyz);
              r7.w = dot(r25.xyz, r34.xyz);
              r7.w = r7.w + -r35.w;
              r9.w = cmp(r7.w >= 0);
              r7.w = max(abs(r7.w), r2.z);
              r7.w = r9.w ? r7.w : -r7.w;
              ...
              r6.w = min(abs(r7.z), r6.w);
              r35.z = r36.z;
              r7.z = dot(r14.xyz, r35.xyz);
              r7.w = dot(r25.xyz, r35.xyz);
              r7.w = r7.w + -r36.w;
              r9.w = cmp(r7.w >= 0);
              r7.w = max(abs(r7.w), r2.z);
              r7.w = r9.w ? r7.w : -r7.w;
              ...
              r6.w = min(abs(r7.z), r6.w);
              r36.z = r37.x;
              r7.z = dot(r14.xyz, r36.xyz);
              r7.w = dot(r25.xyz, r36.xyz);
              r7.w = r7.w + -r37.y;
              r9.w = cmp(r7.w >= 0);
              r7.w = max(abs(r7.w), r2.z);
              r7.w = r9.w ? r7.w : -r7.w;
              ...
              r6.w = min(abs(r7.z), r6.w);
              r38.zw = r37.zw;
              r7.z = dot(r14.zxy, r38.xzw);
              r7.w = dot(r25.zxy, r38.xzw);
              r7.w = r7.w + -r38.y;
              r9.w = cmp(r7.w >= 0);
              r7.w = max(abs(r7.w), r2.z);
              r7.w = r9.w ? r7.w : -r7.w;
              ...
              r23.y = r26.z;
              r23.z = r28.x;
              r33.x = dot(r10.yzw, r23.xyz);
              r24.xy = r26.xw;
              r24.z = r28.w;
              r33.y = dot(r10.yzw, r24.xyz);
              r28.x = r26.y;
              r33.z = dot(r10.yzw, r28.xyz);
              if (9 == 0) r7.z = 0; else if (9+16 < 32) {               r7.z = (uint)r24.w << (32-(9 + 16)); r7.z = (uint)r7.z >> (32-9);              } else r7.z = (uint)r24.w >> 16;
              r33.w = (uint)r7.z;
              r10.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r33.xyzw, r6.w).xyz;
              r26.x = dot(r25.xyz, r23.xyz);
              r26.y = dot(r25.xyz, r24.xyz);
              r26.z = dot(r25.xyz, r28.xyz);
              r25.xyz = saturate(r26.xyz * r30.xyz + float3(0.5,0.5,0.5));
              r31.z = r32.x;
              r25.xyz = r25.xyz * r31.xyz + r32.yzw;
              r33.x = dot(r8.xyz, r23.xyz);
              r33.y = dot(r8.xyz, r24.xyz);
              r33.z = dot(r8.xyz, r28.xyz);
              r23.xyz = cmp(float3(0,0,0) < r33.xyz);
              r9.z = r23.x ? 0 : 0.5;
              r24.xyz = r25.xyz + r9.xyz;
              r24.xyz = gProbeXArray.SampleLevel(samplerLinearClamp_s, r24.xyz, 0).xyz;
              r26.xyz = r33.xyz * r33.xyz;
              r26.xyz = r26.xyz * r6.xxx;
              r11.z = r23.y ? 0 : 0.5;
              r23.xyw = r25.xyz + r11.xyz;
              ...
              r6.w = dot(r25.xyz, float3(0.212599993,0.715200007,0.0722000003));
              ...
              r6.x = r2.w * r6.w + r6.x;
              r6.x = r7.z / r6.x;
              r21.xyz = r10.yzw * r6.xxx + r21.xyz;
            }
          }
        }
      }
  ...
  r3.xyz = r18.xyz * r2.xxx;
  r4.xyz = r19.xyz * r2.xxx;
  r2.z = cmp(r19.w < 0.99000001);
  if (r2.z != 0) {
    r2.z = 1 + -r19.w;
    r2.w = sunConstants.globalProbeExposure * r2.z;
    r5.xyz = -globalProbeConstants.data[0].xyz + v6.xyz;
    ...
    r5.xyz = r5.xyz * r10.zzz + r9.xyz;
    r8.w = 0;
    r6.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r8.xyzw, 6).xyz;
    r5.xyz = r6.xyz * r5.xyz;
    r2.w = dot(r5.xyz, float3(0.212599993,0.715200007,0.0722000003));
    r3.xyz = r18.xyz * r2.xxx + r5.xyz;
    r14.w = 0;
    r5.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r14.xyzw, r2.y).xyz;
    r2.x = sunConstants.globalProbeExposure * r2.z + -r2.w;
    r2.x = r7.y * r2.x + r2.w;
    r4.xyz = r5.xyz * r2.xxx + r4.xyz;
  }
  r2.xyz = r3.xyz * r1.www + r12.yzw;
  r3.xyz = float3(1,1,1) + -r1.xyz;
  r3.xyz = r13.yzw * r3.xyz;
  r1.xyz = r29.xyz * r1.xyz + r3.xyz;
  r0.xyz = r2.xyz * r0.xyz + r1.xyz;
  r1.xy = r7.xy * float2(0.984375,0.984375) + float2(0.0078125,0.0078125);
