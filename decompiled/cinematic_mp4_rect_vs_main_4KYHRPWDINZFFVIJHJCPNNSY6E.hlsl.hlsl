...
cbuffer _Globals : register(b0)
{
  ...
  float2 movieRectBottomLeft : packoffset(c10);
  float2 movieRectUpperRight : packoffset(c10.z);
}
...
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r0.xy, v4.x, l(12), t4.xyxx
...
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r0.y, v4.x, l(0), t4.xxxx
r0.y = gpuSkinBase[]..swiz;
...
r0.w = gpuSkinBase[]..swiz;
  ...
  r0.xy = movieRectUpperRight.xy + -movieRectBottomLeft.xy;
  o1.xy = v1.xy * r0.xy + movieRectBottomLeft.xy;
  return;
}