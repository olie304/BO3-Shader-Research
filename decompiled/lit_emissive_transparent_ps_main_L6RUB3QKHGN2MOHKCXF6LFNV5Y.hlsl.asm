...
mad o0.w, r0.z, r0.x, r4.z
mad r2.xyz, r2.xywx, r0.xxxx, r12.xyzx
dp3 r0.y, r2.xyzx, r2.xyzx
rsq r0.y, r0.y
mul r2.xyz, r0.yyyy, r2.xyzx
mad r5.y, r1.w, r0.x, r4.w
mad r6.xyz, r0.xxxx, l(0.040000, 0.040000, 0.040000, 0.000000), r13.xyzx
...
if_nz r0.y
  ...
  round_z r0.y, r0.y
  add r0.y, r0.y, v2.x
  div r9.x, r0.y, cb0[11].w
  round_z r0.y, r0.z
  add r0.y, r0.y, v2.y
  div r9.y, r0.y, cb0[11].z
else 
  ...
  div r4.zw, -r11.xxxy, r0.yyyy
  and r0.yz, r0.zzzz, r4.zzwz
  ...
  mad r0.yz, r4.zzwz, cb0[13].zzwz, r0.yyzy
  ...
  mov r11.y, r11.x
  mov r11.z, r10.x
  dp2 r12.x, r11.yzyy, r0.yzyy
  mov r11.x, -r10.x
  dp2 r12.y, r11.xyxx, r0.yzyy
  ...
  movc r9.xy, cb0[15].zwzz, r4.zwzz, r0.yzyy
endif 
dp3 r0.y, -v7.xyzx, -v7.xyzx
rsq r0.y, r0.y
mul r10.xyz, r0.yyyy, -v7.xyzx
dp3_sat r0.z, r10.xyzx, r3.xyzx
...
mov r9.x, cb0[16].x
sample_l_indexable(texture2d)(float,float,float,float) r0.x, r9.xyxx, t26.xyzw, s7, l(0.000000)
log r0.x, |r0.x|
...
frc r0.z, r0.z
mad r0.z, r0.z, l(6.28318548), cb1[70].w
sincos r4.x, r12.x, r0.z
dp3_sat r5.x, r2.xyzx, r10.xyzx
dp3 r0.z, -r10.xyzx, r2.xyzx
add r0.z, r0.z, r0.z
mad r13.xyz, r2.xyzx, -r0.zzzz, -r10.xyzx
...
mad r4.z, r3.w, l(5.000000), l(-2.500000)
    ...
    if_nz r14.z
      ...
      if_nz r12.w
        ...
        if_nz r14.z
          ...
          utof r33.w, r14.z
          sample_l_indexable(texturecubearray)(float,float,float,float) r18.yzw, r33.xyzw, t8.wxyz, s2, r12.w
...
rcp r3.w, r3.w
mov_sat r22.w, r22.w
mul r12.yzw, r3.wwww, r21.xxyz
mul r14.xyz, r3.wwww, r22.xyzx
...
if_nz r4.z
  ...
  mad r12.yzw, r21.xxyz, r3.wwww, r15.xxyz
  mov r13.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r15.xyz, r13.xyzw, t8.xyzw, s2, r4.y
  mad r3.w, cb2[19].x, r4.z, -r2.w
...
if_z r5.z
  ...
  if_nz r6.w
    ...
    mov r8.w, l(0)
    loop 
      ge r9.z, r6.w, l(3.000000)
      breakc_nz r9.z
      ftou r9.z, r6.w
      add r16.xy, r12.yzyy, -cb2[r9.z + 20].xyxx
  ...
  if_z r9.z
    if_z cb2[58].y
      ftou r9.z, r6.w
      add r16.xy, r12.yzyy, -cb2[r9.z + 20].xyxx
      mul r9.zw, r16.xxxy, cb2[r9.z + 20].zzzz
      mad r16.xy, r9.zwzz, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
      itof r9.z, cb2[26].y
      add r16.z, r6.w, r9.z
      sample_c_lz_indexable(texture2darray)(float,float,float,float) r9.z, r16.xyzx, t13.xxxx, s13, r5.z
    ...
    if_nz cb2[58].y
      ...
      ftou r8.w, r8.w
      add r17.xy, r12.yzyy, -cb2[r9.z + 20].xyxx
      mul r17.xy, r17.xyxx, cb2[r9.z + 20].zzzz
      ...
      loop 
        ...
        movc r12.w, r11.w, cb2[r6.w + 20].w, cb2[r9.z + 20].w
        movc r11.w, r11.w, r6.w, r9.z
        ...
        utof r18.z, r11.w
        sample_c_lz_indexable(texture2darray)(float,float,float,float) r11.w, r18.xyzx, t13.xxxx, s13, r5.z
...
if_nz r5.z
  ...
  if_nz r5.z
    ...
    if_nz r7.w
      ...
      mad r20.xyz, r2.xyzx, r8.wwww, v7.xyzx
      ...
      if_z r8.w
        ...
        if_nz cb2[58].y
          ...
          loop 
            ...
            sample_c_lz_indexable(texture2darray)(float,float,float,float) r10.w, r18.xyzx, t9.xxxx, s13, r6.w
            mad r9.z, r10.w, l(0.125000), r9.z
            iadd r9.w, r9.w, l(1)
          endloop 
        else 
          utof r16.z, r8.w
          sample_c_lz_indexable(texture2darray)(float,float,float,float) r9.z, r16.xyzx, t9.xxxx, s13, r6.w
        endif 
        mul r6.w, r9.z, r9.z
        mul r6.w, r9.z, r6.w
      else 
    ...
    mad r16.xyz, r6.wwww, r7.xyzx, r15.xyzx
    ...
    mad r7.w, |r6.w|, r0.z, -|r6.w|
    mad r6.w, |r6.w|, r7.w, l(1.000000)
    mad r5.y, r5.y, r0.w, r2.w
    mul r6.w, r6.w, r6.w
    mul r5.y, r5.y, r6.w
    rcp r5.y, r5.y
    mul r5.y, r5.z, r5.y
    ...
    mad r12.yzw, r5.yyyy, r7.xxyz, r4.yyzw
    add_sat r0.y, -r0.y, l(1.000000)
    mul r5.z, r0.y, r0.y
    mul r5.z, r5.z, r5.z
    mul r0.y, r0.y, r5.z
    mul r0.y, r0.y, r5.y
    mad r7.xyz, r0.yyyy, r7.yzxy, r14.xyzx
    mov r16.w, r7.z
    mov r15.w, r14.z
    movc r15.xyzw, r3.wwww, r16.xyzw, r15.xyzw
    mov r7.zw, r12.yyyz
    mov r14.zw, r4.yyyz
    movc r7.xyzw, r3.wwww, r7.xyzw, r14.xyzw
    movc r4.w, r3.w, r12.w, r4.w
    mov r14.z, r15.w
    mov r14.xy, r7.xyxx
    mov r4.yz, r7.zzwz
  endif 
        ...
        switch r10.w
          ...
          if_nz r24.w
            ...
            if_nz r24.w
              ...
              if_nz r24.w
                ...
                dp3 r25.w, r38.xyzx, r13.xyzx
                dp3 r27.w, r13.xyzx, r40.xyzx
                    ...
                    if_z r18.z
                      ...
                      if_nz r8.w
                        ...
                        loop 
                          ige r27.w, r25.w, l(8)
                          breakc_nz r27.w
                          dp2 r41.x, icb[r25.w + 0].xyxx, r11.xyxx
                          dp2 r41.y, icb[r25.w + 0].yxyy, r11.xzxx
          ...
          if_nz r14.w
            ...
            if_nz r15.w
              ...
              mul r15.w, r14.w, r20.w
              and r14.w, r18.x, l(255)
              if_nz r14.w
            ...
            if_nz r14.w
              ...
              if_nz r14.w
                ...
                mad r19.xyz, r19.xyzx, r10.wwww, r10.xyzx
                dp3 r10.w, r19.xyzx, r19.xyzx
                rsq r10.w, r10.w
                mul r19.xyz, r10.wwww, r19.xyzx
                dp3 r10.w, r19.xyzx, r10.xyzx
...
mad r0.xyz, r12.yzwy, r1.xyzx, r0.xyzx
...
ret 
// Approximately 2315 instruction slots used
