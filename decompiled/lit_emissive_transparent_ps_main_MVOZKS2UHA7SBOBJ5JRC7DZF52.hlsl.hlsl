...
r0.y = samp0[]..swiz;
  ...
  r0.x = saturate(r0.x);
  r0.x = hdrScale * r0.x;
  r11.xyzw = cmp(r0.yyyy == float4(4,3,2,1));
  r0.y = cmp(r0.y < 0);
  r12.xyz = r0.yyy ? float3(1,1,1) : emissiveTint1.xyz;
  r12.xyz = r11.www ? tint1.xyz : r12.xyz;
  r12.xyz = r11.zzz ? tint2.xyz : r12.xyz;
  r11.yzw = r11.yyy ? tint3.xyz : r12.xyz;
  r11.xyz = r11.xxx ? tint4.xyz : r11.yzw;
