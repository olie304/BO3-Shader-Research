...
if_nz r0.y
  ...
  if_nz r12.w
    ...
    mad r17.xyz, r16.xyzx, r13.wwww, r17.xyzx
    ...
    ubfe r14.w, l(9), l(16), cb10[r0.y + 7].z
    utof r19.w, r14.w
    sample_l_indexable(texturecubearray)(float,float,float,float) r17.xyz, r19.xyzw, t8.xyzw, s2, r13.w
...
if_nz r9.w
  ...
  iadd r12.w, r0.y, l(1)
  add r18.xyz, r5.xyzx, -cb10[r9.w + 0].xyzx
  and r13.w, l(0x0000ffff), cb10[r9.w + 7].z
  ubfe r14.y, l(6), l(25), cb10[r9.w + 7].z
  ...
  if_nz r14.w
    ...
    if_nz r17.w
      ...
      store_structured u2.x, cb2[52].x, r19.y, r14.y
    endif 
    iadd r12.w, r0.y, l(257)
    mad r13.w, r13.w, cb10[r9.w + 6].y, r10.w
    mul r14.y, r14.y, cb10[r9.w + 7].y
    ...
    mov r19.x, cb10[r9.w + 8].w
    mov r19.yz, cb10[r9.w + 9].xxyx
    ...
    mov r19.x, cb10[r9.w + 9].w
    mov r19.yz, cb10[r9.w + 10].xxyx
    dp3 r17.w, r16.xyzx, r19.xyzx
    dp3 r18.w, r18.xyzx, r19.xyzx
    ...
    div r17.w, r18.w, r17.w
    min r14.w, r14.w, |r17.w|
    mov r19.x, cb10[r9.w + 10].w
    mov r19.yz, cb10[r9.w + 11].xxyx
    dp3 r17.w, r16.xyzx, r19.xyzx
    dp3 r18.w, r18.xyzx, r19.xyzx
    ...
    div r17.w, r18.w, r17.w
    min r14.w, r14.w, |r17.w|
    mov r19.x, cb10[r9.w + 11].w
    mov r19.yz, cb10[r9.w + 12].xxyx
    dp3 r17.w, r16.xyzx, r19.xyzx
    dp3 r18.w, r18.xyzx, r19.xyzx
    ...
    div r17.w, r18.w, r17.w
    min r14.w, r14.w, |r17.w|
    mov r19.x, cb10[r9.w + 12].w
    mov r19.yz, cb10[r9.w + 13].xxyx
    dp3 r17.w, r16.xyzx, r19.xyzx
    dp3 r18.w, r18.xyzx, r19.xyzx
...
ge r3.z, r10.w, l(1.000000)
bfi r0.y, l(8), l(0), r12.w, r0.y
movc r0.y, r3.z, r0.y, r12.w
max r3.z, r13.w, l(1.000000)
rcp r3.z, r3.z
mov_sat r13.w, r13.w
...
ret 
// Approximately 1645 instruction slots used
