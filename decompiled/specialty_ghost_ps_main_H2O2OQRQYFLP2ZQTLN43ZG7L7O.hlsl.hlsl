// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:41:16 2021
...
cbuffer _Globals : register(b0)
{
  ...
  float alphaRevealSoftEdge : packoffset(c11.z);
  float alphaRevealRamp : packoffset(c11.w);
  float2 revealScale : packoffset(c12);
  float edgeAmount : packoffset(c12.z);
  float edgeHarshness : packoffset(c12.w);
...
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) r0.x, r0.x, l(80), t0.xxxx
r0.x = shaderConstantSetBuffer[]..swiz;
  r0.x = saturate(r0.x);
  r0.y = dot(-v6.xyz, -v6.xyz);
  r0.y = rsqrt(r0.y);
  r0.yzw = -v6.xyz * r0.yyy;
  r0.y = saturate(dot(v3.xyz, r0.yzw));
  r0.xz = float2(1,1) + -r0.xy;
  r0.z = log2(r0.z);
  r0.z = edgeHarshness * r0.z;
  r0.z = exp2(r0.z);
  r0.z = saturate(edgeAmount * r0.z);
  r0.w = 3 * edgeHarshness;
  r0.y = log2(r0.y);
  r0.y = r0.w * r0.y;
  r0.y = exp2(r0.y);
  r0.y = r0.y * 0.5 + r0.z;
  r0.y = min(1, r0.y);
  r0.z = saturate(0.0166666675 * v7.z);
  r0.w = r0.z * r0.z;
  r0.z = r0.z * r0.w;
  r0.y = r0.y * r0.z;
  r1.xyz = sceneTint.xyz * edgeAmount;
  r0.x = r0.y * r0.x;
