...
sample_indexable(texture2d)(float,float,float,float) r2.xyz, r0.xyxx, t7.xyzw, s2
...
mul r1.w, r1.w, r2.x
exp r3.y, r1.w
mad_sat r2.xy, cb0[10].xxxx, r3.xyxx, r0.wwww
add r0.z, r0.z, -r2.x
add r0.w, -r2.x, r2.y
div_sat r0.z, r0.z, r0.w
mul o0.xyz, r0.zzzz, r1.xyzx
mov o0.w, r0.z
sample_indexable(texture2d)(float,float,float,float) r0.w, r0.xyxx, t11.yzwx, s3
add r1.x, -cb0[12].x, cb0[12].y
mad r0.w, r0.w, r1.x, cb0[12].x
mul_sat r0.w, r0.w, l(0.05882353)
mul r0.w, r0.w, l(-17.000000)
exp r0.w, r0.w
sample_indexable(texture2d)(float,float,float,float) r1.xyz, r0.xyxx, t10.xyzw, s4
sample_indexable(texture2d)(float,float,float,float) r2.z, r0.xyxx, t12.yzxw, s5
...
ftou r3.xy, v0.xyxx
mov r3.zw, l(0,0,0,0)
ld_indexable(texture2d)(float,float,float,float) r0.yw, r3.xyzw, t0.xzyw
ge r1.z, r0.y, l(0.500000)
movc r1.z, r1.z, l(0.500000), l(0.00146628)
mad r3.z, r0.x, l(0.49755621), r1.z
dp3 r0.x, v4.xyzx, v4.xyzx
rsq r0.x, r0.x
mul r4.xyz, r0.xxxx, v4.xyzx
...
mad r0.x, r0.w, l(3.000000), l(0.500000)
...
dp2 r4.y, r1.xzxx, r4.xyxx
dp3 r4.x, r1.xyzx, r5.xyzx
mul r0.xw, r0.xxxx, r4.xxxy
mad r3.xy, r0.xwxx, l(0.58823532, 0.58823532, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
and r0.xyw, r3.xyxz, r0.yyyy
