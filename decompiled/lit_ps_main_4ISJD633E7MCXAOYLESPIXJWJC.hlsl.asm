...
sample_indexable(texture2d)(float,float,float,float) r2.w, v2.xyxx, t22.yzwx, s3
sample_indexable(texture2d)(float,float,float,float) r3.x, v2.xyxx, t25.xyzw, s3
