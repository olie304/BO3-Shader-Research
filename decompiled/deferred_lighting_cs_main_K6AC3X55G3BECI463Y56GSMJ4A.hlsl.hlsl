...
r0.y = samp0[]..swiz;
  ...
  r0.y = cmp((uint)r14.y >= (uint)r13.w);
  ...
  if (r0.y != 0) {
    ...
    if (6 == 0) r17.x = 0; else if (6+25 < 32) {     r17.x = (uint)refProbeConstantsCB[r0.y].data[7].z << (32-(6 + 25)); r17.x = (uint)r17.x >> (32-6);    } else r17.x = (uint)refProbeConstantsCB[r0.y].data[7].z >> 25;
    r17.y = (int)r14.w * 6;
    ...
    r18.x = r17.z * r17.y;
    r17.y = 1 & (int)refProbeConstantsCB[r0.y].data[6].x;
    r18.yz = float2(0,1);
    ...
    r14.w = refProbeConstantsCB[r0.y].data[6].y * r19.y;
    r17.x = cmp(0 < r14.w);
    if (r17.x != 0) {
      if (r3.z != 0) {
      // Known bad code for instruction (needs manual fix):
      ...
      r17.x = refProbeConstantsCB[r0.y].data[7].y * r14.w;
      ...
      r17.z = -refProbeConstantsCB[r0.y].data[8].z + r17.z;
      r17.w = cmp(r17.z >= 0);
      ...
      if (9 == 0) r17.z = 0; else if (9+16 < 32) {       r17.z = (uint)refProbeConstantsCB[r0.y].data[7].z << (32-(9 + 16)); r17.z = (uint)r17.z >> (32-9);      } else r17.z = (uint)refProbeConstantsCB[r0.y].data[7].z >> 16;
      r20.w = (uint)r17.z;
      ...
      r15.yzw = saturate(r18.xyz * refProbeConstantsCB[r0.y].data[3].xyz + float3(0.5,0.5,0.5));
      r18.xy = refProbeConstantsCB[r0.y].data[4].zw * r15.yz;
      r18.z = refProbeConstantsCB[r0.y].data[5].x * r15.w;
      r15.yzw = refProbeConstantsCB[r0.y].data[5].yzw + r18.xyz;
  ...
  r13.w = cmp((uint)r14.y < (uint)r13.w);
  if (r13.w != 0) {
    r13.w = (int)r14.y * 14;
    if (r3.z != 0) {
      r14.y = (int)r0.y & 1;
    ...
    r14.y = (int)r0.y + 1;
    r18.xyz = -refProbeConstantsCB[r13.w].data[0].xyz + r5.xyz;
    ...
    r20.x = 1;
    r19.z = refProbeConstantsCB[r13.w].data[6].x;
    r21.xy = r19.xy;
    r19.w = 1;
    while (true) {
    ...
    r18.w = refProbeConstantsCB[r13.w].data[6].y * r17.w;
    r19.x = cmp(0 < r18.w);
    if (r19.x != 0) {
      r19.x = (int)r14.y & 3;
      r19.y = (int)r19.x + -1;
      ...
      r14.y = (int)r0.y + 257;
      r17.w = r17.w * refProbeConstantsCB[r13.w].data[6].y + r14.w;
      r18.w = refProbeConstantsCB[r13.w].data[7].y * r18.w;
      r19.x = refProbeConstantsCB[r13.w].data[7].w;
      r19.yz = refProbeConstantsCB[r13.w].data[8].xy;
      r19.w = dot(r16.xyz, r19.xyz);
      r19.x = dot(r18.xyz, r19.xyz);
      r19.x = -refProbeConstantsCB[r13.w].data[8].z + r19.x;
      r19.y = cmp(r19.x >= 0);
      ...
      r20.x = refProbeConstantsCB[r13.w].data[8].w;
      r20.yz = refProbeConstantsCB[r13.w].data[9].xy;
      r19.y = dot(r16.xyz, r20.xyz);
      r19.z = dot(r18.xyz, r20.xyz);
      r19.z = -refProbeConstantsCB[r13.w].data[9].z + r19.z;
      r19.w = cmp(r19.z >= 0);
      ...
      r20.x = refProbeConstantsCB[r13.w].data[9].w;
      r20.yz = refProbeConstantsCB[r13.w].data[10].xy;
      r19.y = dot(r16.xyz, r20.xyz);
      r19.z = dot(r18.xyz, r20.xyz);
      r19.z = -refProbeConstantsCB[r13.w].data[10].z + r19.z;
      r19.w = cmp(r19.z >= 0);
      r19.z = max(abs(r19.z), r10.w);
      r19.z = r19.w ? r19.z : -r19.z;
      r19.y = max(1.00000001e-07, -r19.y);
      r19.y = r19.z / r19.y;
      r19.x = min(r19.x, abs(r19.y));
      r20.x = refProbeConstantsCB[r13.w].data[10].w;
      r20.yz = refProbeConstantsCB[r13.w].data[11].xy;
      r19.y = dot(r16.xyz, r20.xyz);
      r19.z = dot(r18.xyz, r20.xyz);
      r19.z = -refProbeConstantsCB[r13.w].data[11].z + r19.z;
      r19.w = cmp(r19.z >= 0);
      r19.z = max(abs(r19.z), r10.w);
      r19.z = r19.w ? r19.z : -r19.z;
      r19.y = max(1.00000001e-07, -r19.y);
      r19.y = r19.z / r19.y;
      r19.x = min(r19.x, abs(r19.y));
      r20.x = refProbeConstantsCB[r13.w].data[11].w;
      r20.yz = refProbeConstantsCB[r13.w].data[12].xy;
      r19.y = dot(r16.xyz, r20.xyz);
      r19.z = dot(r18.xyz, r20.xyz);
      r19.z = -refProbeConstantsCB[r13.w].data[12].z + r19.z;
      r19.w = cmp(r19.z >= 0);
      r19.z = max(abs(r19.z), r10.w);
      r19.z = r19.w ? r19.z : -r19.z;
      r19.y = max(1.00000001e-07, -r19.y);
      r19.y = r19.z / r19.y;
      r19.x = min(r19.x, abs(r19.y));
      r20.x = refProbeConstantsCB[r13.w].data[12].w;
      r20.yz = refProbeConstantsCB[r13.w].data[13].xy;
      r19.y = dot(r16.xyz, r20.xyz);
      r19.z = dot(r18.xyz, r20.xyz);
      r19.z = -refProbeConstantsCB[r13.w].data[13].z + r19.z;
      r19.w = cmp(r19.z >= 0);
      ...
      r19.x = refProbeConstantsCB[r13.w].data[3].w + r18.x;
      r19.yz = refProbeConstantsCB[r13.w].data[4].xy + r18.yz;
      ...
      r20.x = refProbeConstantsCB[r13.w].data[0].w;
      r20.y = refProbeConstantsCB[r13.w].data[1].z;
      r20.z = refProbeConstantsCB[r13.w].data[2].y;
      r21.x = dot(r19.xyz, r20.xyz);
      r22.xy = refProbeConstantsCB[r13.w].data[1].xw;
      r22.z = refProbeConstantsCB[r13.w].data[2].z;
      r21.y = dot(r19.xyz, r22.xyz);
      r23.x = refProbeConstantsCB[r13.w].data[1].y;
      r23.yz = refProbeConstantsCB[r13.w].data[2].xw;
      r21.z = dot(r19.xyz, r23.xyz);
      if (9 == 0) r10.w = 0; else if (9+16 < 32) {       r10.w = (uint)refProbeConstantsCB[r13.w].data[7].z << (32-(9 + 16)); r10.w = (uint)r10.w >> (32-9);      } else r10.w = (uint)refProbeConstantsCB[r13.w].data[7].z >> 16;
      r21.w = (uint)r10.w;
      ...
      r18.xyz = saturate(r24.xyz * refProbeConstantsCB[r13.w].data[3].xyz + float3(0.5,0.5,0.5));
      r24.xy = refProbeConstantsCB[r13.w].data[4].zw * r18.xy;
      r24.z = refProbeConstantsCB[r13.w].data[5].x * r18.z;
      r18.xyz = refProbeConstantsCB[r13.w].data[5].yzw + r24.xyz;
      ...
      r20.xyz = r7.www ? float3(1,1,0) : r20.xyz;
      ...
      r13.w = dot(r18.xyz, float3(0.212599993,0.715200007,0.0722000003));
      r7.w = r12.w * r7.w + r13.w;
      r7.w = r10.w / r7.w;
      r17.xyz = r18.xyz * r7.www + r17.xyz;
    } else {
      r17.w = r14.w;
    }
  } else {
  ...
  r7.w = cmp(r14.w >= 1);
  bitmask.y = ((~(-1 << 8)) << 0) & 0xffffffff;  r0.y = (((uint)r14.y << 0) & bitmask.y) | ((uint)r0.y & ~bitmask.y);
  r0.y = r7.w ? r0.y : r14.y;
  r7.w = max(1, r17.w);
  r7.w = rcp(r7.w);
  r17.w = saturate(r17.w);
  r18.xyz = r15.yzw * r7.www;
  ...
  if (r10.w != 0) {
    ...
    r18.xyz = r15.yzw * r7.www + r19.xyz;
    r16.w = 0;
  ...
  if (r7.w != 0) {
    ...
    if (r7.w != 0) {
      ...
      r9.w = r9.w * r8.w;
      r3.w = cmp(0 < r3.w);
      r20.xyz = r9.www * r19.xyz + r18.xyz;
      ...
      r1.w = r7.w * r1.w;
      r1.w = r6.w * r1.w;
      r19.xyz = r1.www * r19.yzx + r17.xyz;
      r20.w = r19.z;
      r18.w = r17.z;
      r18.xyzw = r3.wwww ? r20.xyzw : r18.xyzw;
      r19.zw = r21.xy;
      r17.zw = r15.yz;
      r19.xyzw = r3.wwww ? r19.xyzw : r17.xyzw;
