...
add r2.xyz, r2.xyzx, r5.xyzx
mul r4.xyz, r1.xyzx, cb8[80].xxxx
dp3 r4.w, r1.xyzx, cb8[80].yzwy
mul r1.xyzw, r4.xyzw, l(5.55555534, 5.55555534, 5.55555534, 5.55555534)
log r1.xyzw, r1.xyzw
lt r4.xyzw, r1.xyzw, l(0.000000, 0.000000, 0.000000, 0.000000)
mul r5.xyzw, r1.xyzw, cb8[81].xxxy
mul r1.xyzw, r1.xyzw, cb8[81].zzzw
movc r1.xyzw, r4.xyzw, r5.xyzw, r1.xyzw
exp r1.xyzw, r1.xyzw
mul o0.xyzw, r1.xyzw, l(0.180000, 0.180000, 0.180000, 0.180000)
mad r1.xyz, r2.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000), -r3.xyzx
...
rcp r0.y, |r0.x|
mad r0.y, r0.y, l(0.015625), l(0.984375)
rcp r0.z, r0.x
lt r0.x, r0.x, l(0.000000)
mul r0.z, r0.z, l(0.984375)
movc r0.y, r0.x, r0.y, r0.z
div r0.z, cb8[0].z, r0.y
mad_sat r0.y, r0.y, cb8[0].x, cb8[0].y
add_sat r0.z, r0.z, cb8[0].w
mul r0.z, r0.z, cb8[1].x
movc o1.w, r0.x, r0.y, r0.z
ret 
