...
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r1.zw, v5.x, l(8), t4.xxxy
...
r7.w = modelInstanceBuffer[]..swiz;
  ...
  r5.xyzw = viewProjectionMatrix._m10_m11_m12_m13 * r1.zzzz;
  r4.w = r3.y;
  r7.w = r3.w;
  r1.z = dot(r2.xyzw, r4.xyzw);
  r5.xyzw = r1.zzzz * viewProjectionMatrix._m00_m01_m02_m03 + r5.xyzw;
  r1.z = dot(r2.xyzw, r7.xyzw);
  r5.xyzw = r1.zzzz * viewProjectionMatrix._m20_m21_m22_m23 + r5.xyzw;
  o0.xyzw = viewProjectionMatrix._m30_m31_m32_m33 + r5.xyzw;
  r3.yzw = log2(abs(v1.xyz));
  ...
  r1.z = r1.z * r1.x;
  r3.y = 27.2392426 * wind1Parms.x;
  r1.z = r3.y * r3.x + r1.z;
  r3.x = wind1Parms.y * r3.x;
  r1.z = r1.w * r1.y + r1.z;
  r1.xy = wind2Parms.yw * r1.xy;
  r1.z = v1.y * r1.z;
  r1.xz = float2(25.1327419,0.0250000004) * r1.xz;
  r1.x = r3.x * 27.2392426 + r1.x;
  ...
  r5.x = dot(r0.yzw, r4.xyz);
  r5.y = dot(r0.yzw, r6.xyz);
  r5.z = dot(r0.yzw, r7.xyz);
  r1.x = dot(r5.xyz, r5.xyz);
  r1.x = rsqrt(r1.x);
  o3.xyz = r5.xyz * r1.xxx;
  r5.x = dot(r3.xyz, r4.xyz);
  r5.y = dot(r3.xyz, r6.xyz);
  r5.z = dot(r3.xyz, r7.xyz);
  r1.x = dot(r5.xyz, r5.xyz);
  r1.x = rsqrt(r1.x);
  o4.xyz = r5.xyz * r1.xxx;
  r1.xzw = r0.wyz * r3.yzx;
  r0.yzw = r0.zwy * r3.zxy + -r1.xzw;
