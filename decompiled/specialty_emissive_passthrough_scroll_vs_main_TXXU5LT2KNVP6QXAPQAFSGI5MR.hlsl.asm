...
mul r1.yzw, r2.xxyz, l(0.000000, 0.100000, 0.100000, 0.100000)
frc o3.xyz, r1.yzwy
mov o3.w, v5.x
mul r1.yz, cb0[17].xxzx, l(0.000000, 27.239243, 25.132742, 0.000000)
mul r1.yz, r3.xxyx, r1.yyzy
mul r2.xy, r3.xyxx, cb0[17].ywyy
mul r2.xy, r2.xyxx, l(27.239243, 25.132742, 0.000000, 0.000000)
add r0.x, r2.y, r2.x
add r1.y, r1.z, r1.y
mul r1.z, cb0[18].x, l(34.456177)
