// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:37:25 2021
...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  if (r7.z != 0) {
    ...
    if (r7.z != 0) {
      ...
      r10.yzw = -v6.xyz * r2.www + sunConstants.wldDir.xyz;
