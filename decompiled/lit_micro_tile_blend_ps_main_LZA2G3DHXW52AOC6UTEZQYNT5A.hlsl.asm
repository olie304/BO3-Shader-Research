...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:37:27 2021
//
//
// Buffer Definitions: 
//
...
sample_indexable(texture2d)(float,float,float,float) r0.yzw, v2.xyxx, t21.wxyz, s3
...
mad r4.yz, r4.yyzy, l(0.000000, 1.99218750, 1.99218750, 0.000000), l(0.000000, -1.000000, -1.000000, 0.000000)
mul r2.z, r4.w, r4.w
...
mad r0.xyz, r2.xzwx, r0.zzzz, r4.xyzx
dp3 r1.x, r0.xyzx, r0.xyzx
rsq r1.x, r1.x
mul r0.xyz, r0.xyzx, r1.xxxx
mad r1.x, cb1[62].x, r1.w, cb0[10].y
mul_sat r1.x, r1.x, l(0.05882353)
lt r1.z, l(0.000000), cb1[64].w
if_nz r1.z
  ftoi r1.z, cb1[64].w
  lod r1.w, v2.xyxx, t0.y, s1
  lod r2.x, v2.xyxx, t0.x, s1
  lt r1.w, r1.w, r2.x
  lt r2.x, l(0.000000), r2.x
  and r2.yzw, r1.zzzz, l(0, 1, 2, 4)
  movc r4.xyz, r2.yyyy, l(1.000000,0,1.000000,0), r3.xyzx
  movc r5.xyz, r2.zzzz, l(0,1.000000,1.000000,0), r3.xyzx
  movc r2.xyz, r2.xxxx, r4.xyzx, r5.xyzx
  movc r4.xyz, r2.wwww, l(0,1.000000,0,0), r3.xyzx
  movc r3.xyz, r1.wwww, r2.xyzx, r4.xyzx
endif 
add r2.xyz, -r3.xyzx, cb1[58].xyzx
mad r2.xyz, cb1[58].wwww, r2.xyzx, r3.xyzx
add r1.z, -r3.w, cb1[59].x
mad o0.w, cb1[59].w, r1.z, r3.w
...
loop 
  ...
  breakc_nz r8.w
  ushr r0.z, r8.z, l(5)
  iadd r12.xyz, r0.xyzx, r11.xyzx
  ld_indexable(texture2darray)(uint,uint,uint,uint) r0.z, r12.xyzw, t7.yzxw
...
if_z r8.y
  ...
  rcp r0.x, r0.x
  mov_sat r22.w, r22.w
  mul r18.xyz, r0.xxxx, r21.xyzx
  mul r19.xyz, r0.xxxx, r22.xyzx
  ...
  if_nz r0.y
    ...
    dp3 r0.z, r8.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
    mad r18.xyz, r21.xyzx, r0.xxxx, r8.yzwy
    mov r10.w, l(0)
    sample_l_indexable(texturecubearray)(float,float,float,float) r8.yzw, r10.xyzw, t8.wxyz, s2, r6.z
    mad r0.x, cb2[19].x, r0.y, -r0.z
    mad r0.x, r4.y, r0.x, r0.z
    mad r19.xyz, r8.yzwy, r0.xxxx, r19.xyzx
  endif 
else 
  mov r19.x, r18.w
endif 
...
mad r0.yz, r4.xxyx, l(0.000000, 0.984375, 0.984375, 0.000000), l(0.000000, 0.00781250, 0.00781250, 0.000000)
sample_l_indexable(texture2d)(float,float,float,float) r0.yz, r0.yzyy, t5.zxyw, s2, l(0.000000)
mul r8.yzw, r0.xxxx, r19.xxyz
mul r13.xyz, r0.yyyy, r8.zwyz
...
if_nz r6.z
  ...
  if_nz r6.z
    ...
    if_nz r9.y
      ...
      mad r18.xyz, r1.xyzx, r9.zzzz, v7.xyzx
    ...
    mad r9.yzw, -v7.xxyz, r2.wwww, cb2[17].xxyz
...
mad r0.xyz, r8.yzwy, r2.xyzx, r0.xyzx
...
ret 
// Approximately 2255 instruction slots used
