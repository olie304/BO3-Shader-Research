...
ushr r0.y, r0.y, l(24)
uge r12.w, r0.y, r10.w
ult r13.y, r0.y, cb2[0].y
and r12.w, r12.w, r13.y
if_nz r12.w
  imul null, r12.w, r0.y, l(14)
  if_nz r2.w
  ...
  endloop 
  mov_sat r18.y, r18.y
  mul r14.y, r18.y, cb10[r12.w + 6].y
  ...
  if_nz r14.z
    ...
    ubfe r16.x, l(9), l(16), cb10[r12.w + 7].z
    utof r18.w, r16.x
...
if_nz r10.w
  ...
  and r14.z, l(0x0000ffff), cb10[r0.y + 7].z
  ...
  if_nz r16.w
    ...
    mad r14.z, r14.z, cb10[r0.y + 6].y, r14.y
    ...
    or r5.w, r23.y, r23.x
    or r5.w, r23.z, r5.w
    movc r18.xyz, r5.wwww, l(1.000000,1.000000,0,0), r18.xyzx
...
ge r0.y, r14.y, l(1.000000)
bfi r5.w, l(8), l(0), r10.w, r12.w
movc r0.y, r0.y, r5.w, r10.w
max r5.w, r14.z, l(1.000000)
rcp r5.w, r5.w
mov_sat r14.z, r14.z
mul r17.xyz, r5.wwww, r13.yzwy
mul r16.xyz, r5.wwww, r16.xyzx
lt r8.w, r14.z, l(0.990000)
if_nz r8.w
  iadd r0.y, r0.y, l(256)
  add r8.w, -r14.z, l(1.000000)
  ...
  mad r17.xyz, r13.yzwy, r5.wwww, r14.yzwy
  mov r15.w, l(0)
  ...
  mad r16.xyz, r13.yzwy, r5.wwww, r16.xyzx
endif 
add r5.w, r4.z, r2.x
log r5.w, |r5.w|
mul r5.w, r2.z, r5.w
...
if_nz r2.y
  ...
  if_nz r2.y
    ...
    mad r3.xyw, r17.xyxz, r4.zzzz, r19.xyxz
    mad r17.xyz, -r5.xyzx, r1.zzzz, cb2[17].xyzx
    dp3 r1.z, r17.xyzx, r17.xyzx
    rsq r1.z, r1.z
    mul r17.xyz, r1.zzzz, r17.xyzx
    dp3 r1.z, r17.xyzx, r12.xyzx
    ...
    mad r17.xyz, r2.xxxx, r18.xyzx, r14.yzwy
    and r17.xyz, r0.wwww, r17.xyzx
    movc r13.yzw, r2.zzzz, r3.xxyw, r13.yyzw
    movc r14.yzw, r2.zzzz, r14.yyzw, r17.xxyz
    movc r15.xzw, r2.zzzz, r12.xxyz, r15.xxzw
    movc r16.xyz, r2.zzzz, r11.xyzx, r16.xyzx
    if_nz r2.w
...
mad r3.xyz, r16.xyzx, r3.xyzx, r4.xyzx
...
ret 
// Approximately 1383 instruction slots used
