...
//   float Radius;                      // Offset:  160 Size:     4
//   float Hardness;                    // Offset:  164 Size:     4
//
// }
//
...
// ------------------------------ ---------- ------- ----------- -------------- ------
// ui3dSampler_C4_P0_sampler         sampler      NA          NA             s1      1 
// ui3dSampler_C4_P0                 texture  float4          2d             t0      1 
...
mad r0.yz, v2.xxyx, cb1[74].xxyx, cb1[74].zzwz
...
exp r0.y, r0.y
div r0.x, r0.y, r0.x
mad r0.x, -r0.x, cb3[0].x, l(1.000000)
mul r0.xyzw, r0.xxxx, r2.xyzw
mad r1.x, -cb3[0].y, cb3[0].x, l(1.000000)
