...
r0.y = samplerLinear[]..swiz;
  ...
  r0.w = r0.w + r0.w;
  r15.xyz = r12.xyz * -r0.www + -r13.xyz;
  r0.w = 17 * r2.y;
  r0.w = exp2(r0.w);
  r0.w = 2 + r0.w;
  r0.w = 2 / r0.w;
  ...
  r2.z = min(abs(r17.z), abs(r17.w));
  r2.z = min(abs(r17.y), r2.z);
  r2.z = min(abs(r17.x), r2.z);
  r2.w = max(abs(r17.z), abs(r17.w));
  r2.w = max(abs(r17.y), r2.w);
  r2.w = max(abs(r17.x), r2.w);
  r3.yzw = cmp(r2.zzz == abs(r17.yzw));
  r2.z = r3.y ? r16.y : r16.x;
  r2.z = r3.z ? r16.z : r2.z;
  r2.z = r3.w ? r16.w : r2.z;
  ...
  r10.y = samplerLinear[]..swiz;
    ...
    while (true) {
      ...
      while (true) {
        ...
        r20.w = r25.x * r20.w;
        r25.z = dot(refProbeAttenuationConstantsCB[r19.w].data[1].xyz, r14.yzw);
        r25.z = saturate(refProbeAttenuationConstantsCB[r19.w].data[1].w + r25.z);
        r20.w = r25.z * r20.w;
        r25.z = dot(refProbeAttenuationConstantsCB[r19.w].data[2].xyz, r14.yzw);
        r25.z = saturate(refProbeAttenuationConstantsCB[r19.w].data[2].w + r25.z);
        r20.w = r25.z * r20.w;
        r25.z = dot(refProbeAttenuationConstantsCB[r19.w].data[3].xyz, r14.yzw);
        r25.z = saturate(refProbeAttenuationConstantsCB[r19.w].data[3].w + r25.z);
        r20.w = r25.z * r20.w;
        r25.z = dot(refProbeAttenuationConstantsCB[r19.w].data[4].xyz, r14.yzw);
        r25.z = saturate(refProbeAttenuationConstantsCB[r19.w].data[4].w + r25.z);
        r20.w = r25.z * r20.w;
        r25.z = dot(refProbeAttenuationConstantsCB[r19.w].data[5].xyz, r14.yzw);
        r19.w = saturate(refProbeAttenuationConstantsCB[r19.w].data[5].w + r25.z);
        r25.x = r20.w * r19.w;
        r25.z = (uint)r16.x >> 2;
        if (1 == 0) r25.w = 0; else if (1+2 < 32) {         r25.w = (uint)r16.x << (32-(1 + 2)); r25.w = (uint)r25.w >> (32-1);        } else r25.w = (uint)r16.x >> 2;
        r26.x = (int)r25.z & 2;
        r26.y = max(r25.y, r25.x);
        r19.w = -r20.w * r19.w + 1;
        r19.w = r25.y * r19.w;
        r18.y = r26.x ? r19.w : r26.y;
        r25.xy = r25.ww ? r25.xy : r18.xy;
        r17.w = (int)r17.w + 1;
        r16.x = r25.z;
      }
      ...
      r16.x = cmp(0 < r13.w);
      if (r16.x != 0) {
        r24.z = r25.y * refProbeConstantsCB[r10.w].data[6].y + r24.z;
        ...
        r18.yzw = r15.xyz * r16.xxx + r26.xyz;
        ...
        r27.w = (uint)r16.w;
        r18.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r27.xyzw, r16.x).xyz;
        ...
        r26.x = r23.w;
        r26.yz = r24.xy;
        r24.xyw = r18.zwy * r10.www + r26.yzx;
        r23.w = r24.w;
      }
    }
    r21.xyzw = r23.xyzw;
  ...
  if (r7.w != 0) {
    ...
    r9.w = samplerLinear[]..swiz;
      ...
      while (true) {
        ...
        r16.x = saturate(r27.y + -r13.w);
        r18.y = refProbeConstantsCB[r17.w].data[6].y * r16.x;
        r18.z = cmp(0 < r18.y);
        if (r18.z != 0) {
          r24.w = r16.x * refProbeConstantsCB[r17.w].data[6].y + r24.w;
          r16.x = refProbeConstantsCB[r17.w].data[7].y * r18.y;
          ...
          r14.yzw = r25.xyz * r26.xyz + r14.yzw;
          r17.w = r17.z * r3.w;
  ...
  switch (r1.w) {
    ...
    r10.yzw = -r16.xyz * float3(0.5,0.5,0.5) + lightConstantsCB[r0.x].data[0].xyz;
    r17.xyz = r10.yzw + -r11.xyz;
    r4.w = dot(r16.xyz, r17.xyz);
    r5.z = saturate(-r4.w / lightConstantsCB[r0.x].data[6].y);
    r18.xyz = r5.zzz * r16.xyz + r10.yzw;
    ...
    if (r9.w != 0) {
      ...
      if (r9.w != 0) {
        ...
        if (r9.w != 0) {
          ...
          r9.w = 0.25 * r9.w;
          r12.w = dot(r16.xyz, r15.xyz);
          r13.w = dot(r15.xyz, r17.xyz);
          r15.x = -r12.w * r12.w + lightConstantsCB[r0.x].data[6].y;
          r4.w = r12.w * r13.w + -r4.w;
          r4.w = saturate(r4.w / r15.x);
          r12.w = r15.x / lightConstantsCB[r0.x].data[6].y;
          r12.w = 10 * r12.w;
          r12.w = min(1, r12.w);
          r4.w = r4.w + -r5.z;
          r4.w = r12.w * r4.w + r5.z;
          r10.yzw = r4.www * r16.xyz + r10.yzw;
          r10.yzw = r1.www ? r10.yzw : lightConstantsCB[r0.x].data[0].xyz;
          ...
          if (r5.z != 0) {
            ...
            if (r12.w == 0) {
              ...
              if (enableDitheredShadow != 0) {
                ...
                r17.z = (uint)r12.w;
                r13.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r17.xyz, r5.z).x;
              }
              r4.w = r13.w * r13.w;
              r4.w = r4.w * r13.w;
            } else {
          ...
          r4.w = saturate(dot(r12.xyz, r15.xyz));
          r10.yzw = r10.yzw * r1.www + r13.xyz;
          r1.w = dot(r10.yzw, r10.yzw);
          r1.w = rsqrt(r1.w);
          r10.yzw = r10.yzw * r1.www;
          r1.w = dot(r10.yzw, r13.xyz);
          ...
          r4.w = r7.w * r4.w;
          r4.w = r4.w * r6.w;
          r10.yzw = r4.www * r16.xyz + r2.yzw;
          r1.w = saturate(1 + -r1.w);
          r6.w = r1.w * r1.w;
          r6.w = r6.w * r6.w;
          r1.w = r6.w * r1.w;
          r1.w = r4.w * r1.w;
          r15.xyz = r1.www * r16.xyz + r14.yzw;
          r3.yzw = r5.zzz ? r17.xyz : r3.yzw;
          r14.yzw = r5.zzz ? r15.xyz : r14.yzw;
    ...
    r1.w = rsqrt(r1.w);
    r10.yzw = r15.xyz * r1.www;
    r4.w = dot(r12.xyz, r10.yzw);
    r5.z = saturate(r4.w);
    r6.w = cmp(0 < r5.z);
    if (r6.w != 0) {
      ...
      if (r7.w != 0) {
        ...
        if (r6.w != 0) {
          ...
          r6.w = (int)r6.w + -1;
          r17.z = (uint)r6.w;
          r10.yzw = gCookieArray.SampleLevel(samplerLinear_s, r17.xyz, 0).xyz;
        } else {
          r10.yzw = float3(1,1,1);
        }
      }
      ...
      if (r6.w != 0) {
        ...
        if (r7.w != 0) {
          ...
          r0.x = r0.x * r6.w;
          r1.z = cmp(0 < r4.w);
          r16.xyz = r0.xxx * r10.yzw + r3.yzw;
          r15.xyz = r15.xyz * r1.www + r13.xyz;
          ...
          r0.y = r6.w * r0.y;
          r0.y = 0.25 * r0.y;
          r12.xyz = r0.yyy * r10.yzw + r2.yzw;
          r0.x = saturate(1 + -r0.x);
          r0.z = r0.x * r0.x;
          r0.z = r0.z * r0.z;
          r0.x = r0.x * r0.z;
          r0.x = r0.y * r0.x;
          r0.xyz = r0.xxx * r10.yzw + r14.yzw;
          r3.yzw = r1.zzz ? r16.xyz : r3.yzw;
          r14.yzw = r1.zzz ? r0.xyz : r14.yzw;
          r2.yzw = r1.zzz ? r12.xyz : r2.yzw;
        }
      }
    }
    break;
