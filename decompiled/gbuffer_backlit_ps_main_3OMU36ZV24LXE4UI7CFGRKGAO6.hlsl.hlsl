// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:26:11 2021
  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r2.yzw = debugNormalOverride.www * r2.xyz + r3.xzw;
  r3.x = dot(float3(0.212599993,0.715200007,0.0722000003), r1.xyz);
  r3.x = cmp(0.0909999982 < r3.x);
  if (r3.x != 0) {
    r3.x = r5.x + r5.y;
    r3.x = r4.z * r3.y + r3.x;
    r3.x = 0.5 * r3.x;
    r6.xyz = r4.xyz * r3.yyy + -r3.xxx;
    r3.z = max(r6.y, r6.z);
    r3.z = max(r6.x, r3.z);
    r3.x = max(r3.x, r3.z);
    r3.z = cmp(r3.x == r6.x);
    r7.yzw = float3(1,-1,-1) * r2.yzw;
    r3.w = 2 + r3.x;
    r7.x = 1;
    r2.x = 0;
    r7.xyzw = r3.zzzz ? r7.xyzw : r2.xyzw;
    r3.x = r3.z ? r3.w : r3.x;
    r3.z = cmp(r3.x == r6.y);
    ...
    r6.x = 3;
    r6.xyzw = r3.xxxx ? r6.xyzw : r7.xyzw;
    r3.x = r6.y + r6.z;
    r7.z = r3.x + r6.w;
    r7.y = r6.w + -r6.y;
    r7.x = -r6.z * 3 + r7.z;
    r3.xzw = float3(0.408248305,0.707106769,0.577350259) * r7.xyz;
    r3.w = 1 + abs(r3.w);
    r3.w = rsqrt(r3.w);
    r3.xz = r3.xz * r3.ww;
    o1.xy = r3.xz * float2(0.588235319,0.588235319) + float2(0.5,0.5);
    o1.z = r1.w * 0.49755621 + 0.00146627566;
    r3.x = (uint)r6.x;
    o1.w = 0.333333343 * r3.x;
    r3.xz = (uint2)v0.xy;
    r6.y = r1.x + -r1.z;
    r1.x = r6.y * 0.5 + r1.z;
    r6.z = r1.y + -r1.x;
    r6.x = r6.z * 0.5 + r1.x;
    r1.xy = (int2)r3.xz & int2(1,1);
  ...
  r3.xzw = backlightScatterColor.xyz * r0.xyz;
  r1.x = 1 + -r1.x;
  r1.y = r3.w * r1.x;
  r1.z = r5.x + r5.y;
  r1.z = r4.z * r3.y + r1.z;
  r1.z = 0.5 * r1.z;
  r4.xyz = r4.xyz * r3.yyy + -r1.zzz;
  r3.y = max(r4.y, r4.z);
  r3.y = max(r4.x, r3.y);
  r1.z = max(r3.y, r1.z);
  r3.y = cmp(r1.z == r4.x);
