    ...
    loop 
      ...
      loop 
        ...
        if_nz r22.w
          ...
          movc r23.w, r24.x, l(1.000000), r8.w
...
dp3 r5.w, r13.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
mov r15.w, l(0)
sample_l_indexable(texturecubearray)(float,float,float,float) r14.yzw, r15.xyzw, t8.wxyz, s2, r3.w
...
ubfe r3.w, l(3), l(24), cb9[r0.x + 1].w
switch r3.w
  case l(4)
  lt r3.w, l(0.000000), cb9[r0.x + 6].y
  mov r9.xy, cb9[r0.x + 5].zwzz
  mov r9.z, cb9[r0.x + 6].x
  mad r16.xyz, -r9.xyzx, l(0.500000, 0.500000, 0.500000, 0.000000), cb9[r0.x + 0].xyzx
  add r17.xyz, -r10.xyzx, r16.xyzx
  dp3 r4.z, r9.xyzx, r17.xyzx
  div_sat r5.w, -r4.z, cb9[r0.x + 6].y
  mad r18.xyz, r5.wwww, r9.xyzx, r16.xyzx
  movc r18.xyz, r3.wwww, r18.xyzx, cb9[r0.x + 0].xyzx
  ...
  if_nz r9.w
    ...
    if_nz r9.w
      ...
      if_nz r9.w
        ...
        if_nz r5.w
          ...
          if_z r11.w
            ...
            if_nz cb2[58].y
              ...
              utof r17.z, r11.w
              sample_c_lz_indexable(texture2darray)(float,float,float,float) r12.w, r17.xyzx, t9.xxxx, s13, r5.w
            endif 
        ...
        mul r4.z, r4.z, r7.w
        mul r4.z, r6.w, r4.z
        mad r9.xyz, r4.zzzz, r16.xyzx, r2.yzwy
        add_sat r3.w, -r3.w, l(1.000000)
        mul r6.w, r3.w, r3.w
        mul r6.w, r6.w, r6.w
        mul r3.w, r3.w, r6.w
        mul r3.w, r3.w, r4.z
        mad r15.xyz, r3.wwww, r16.xyzx, r14.yzwy
        movc r13.yzw, r5.wwww, r17.xxyz, r13.yyzw
        movc r14.yzw, r5.wwww, r15.xxyz, r14.yyzw
  ...
  if_nz r6.w
    ...
    if_nz r7.w
      ...
      add r17.xyz, -r10.xyzx, cb9[r0.x + 0].xyzx
      ...
      if_nz r6.w
        ...
        mad r10.w, cb9[r0.x + 12].y, r18.y, l(-1.000000)
    ...
    if_nz r6.w
      ...
      if_nz r6.w
        ...
        if_nz r9.w
          ...
          mad r17.x, r15.x, cb9[r0.x + 8].y, cb9[r0.x + 8].z
          mad r17.y, r15.y, cb9[r0.x + 8].w, cb9[r0.x + 9].x
          div r6.w, r6.w, r8.w
      ...
      if_nz r7.w
        ...
        if_nz r9.w
          ...
          if_z r10.w
            ...
            if_nz cb2[58].y
              ...
              loop 
                ige r15.w, r12.w, l(8)
                breakc_nz r15.w
                dp2 r19.x, icb[r12.w + 0].yxyy, r15.xyxx
                dp2 r19.y, icb[r12.w + 0].yxyy, r15.yzyy
              ...
              utof r17.z, r10.w
              sample_c_lz_indexable(texture2darray)(float,float,float,float) r11.w, r17.xyzx, t9.xxxx, s13, r9.w
            endif 
          ...
          if_nz r0.y
            ...
            if_z r9.w
              ...
              mov r18.w, cb9[r0.x + 6].x
              dp4 r17.y, r18.xyzw, r15.xyzw
              div r15.xy, r17.xyxx, r8.wwww
              mad r15.xy, r15.xyxx, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
              add r17.x, r15.x, cb9[r0.x + 9].w
              add r17.y, r15.y, cb9[r0.x + 10].x
              mul r15.xy, r17.xyxx, cb9[r0.x + 9].yzyy
            ...
            if_z r8.w
              ...
              if_nz cb2[58].y
                ...
                utof r17.z, r8.w
                sample_c_lz_indexable(texture2darray)(float,float,float,float) r9.w, r17.xyzx, t9.xxxx, s13, r0.y
              endif 
              mul r0.x, r9.w, r9.w
              mul r0.x, r9.w, r0.x
            else 
        ...
        mad r9.xyz, r0.zzzz, r16.xyzx, r2.yzwy
        add_sat r0.x, -r0.x, l(1.000000)
        mul r0.w, r0.x, r0.x
        mul r0.w, r0.w, r0.w
        mul r0.x, r0.w, r0.x
        mul r0.x, r0.x, r0.z
        mad r0.xzw, r0.xxxx, r16.xxyz, r14.yyzw
        movc r13.yzw, r0.yyyy, r15.xxyz, r13.yyzw
        movc r14.yzw, r0.yyyy, r0.xxzw, r14.yyzw
