...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  o0.w = debugAlphaOverride.w * r0.w + r1.y;
  ...
  r0.w = r2.x + -r1.w;
  r1.y = debugGlossOverride.w * r0.w + r1.w;
  ...
  r1.x = saturate(dot(r3.xyz, r4.yzw));
  ...
  r1.zw = float2(0,0);
  while (true) {
    r2.x = cmp((uint)r1.w >= numRefProbes);
    if (r2.x != 0) break;
    r12.z = (uint)r1.w >> 5;
    r13.xyz = (int3)r11.xyz + (int3)r12.xyz;
    r2.x = visibleProbes.Load(r13.xyzw).x;
  ...
  if (r1.z == 0) {
    ...
    if (r8.y != 0) {
      ...
      while (true) {
        ...
        if (r2.x == 0) r12.z = 0; else if (r2.x+0 < 32) {         r12.z = (uint)r9.w << (32-(r2.x + 0)); r12.z = (uint)r12.z >> (32-r2.x);        } else r12.z = (uint)r9.w >> 0;
    ...
    if (r1.w != 0) {
      r1.w = 1 + -r22.w;
      r2.x = sunConstants.globalProbeExposure * r1.w;
      ...
      r2.x = dot(r8.yzw, float3(0.212599993,0.715200007,0.0722000003));
      r19.xyz = r21.xyz * r1.zzz + r8.yzw;
      r10.w = 0;
      r8.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r10.xyzw, r6.z).xyz;
      r1.z = sunConstants.globalProbeExposure * r1.w + -r2.x;
      r1.z = r1.y * r1.z + r2.x;
  ...
  r13.xyz = r8.zwy * r1.yyy;
  r1.yzw = r8.yzw * r1.www;
  r0.w = sqrt(r5.z);
  r0.w = r0.w * 0.5 + 0.5;
  r0.w = r0.w * r0.w;
  r2.x = 0.5 * r0.w;
  ...
  if (r6.z != 0) {
    ...
    if (r6.z != 0) {
      ...
      r9.yzw = -v7.xyz * r4.xxx + sunConstants.wldDir.xyz;
