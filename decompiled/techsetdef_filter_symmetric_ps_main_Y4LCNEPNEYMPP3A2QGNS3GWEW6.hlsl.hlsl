  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.xyzw = colorMapSampler.Sample(samp0_s, v3.xy).xyzw;
  ...
  r2.xyzw = colorMapSampler.Sample(samp0_s, v2.xy).xyzw;
  r1.xyzw = r2.xyzw + r1.xyzw;
  r0.xyzw = filterTap[0].wwww * r1.xyzw + r0.xyzw;
  r1.xyzw = colorMapSampler.Sample(samp0_s, v5.xy).xyzw;
  r2.xyzw = colorMapSampler.Sample(samp0_s, v6.xy).xyzw;
  r1.xyzw = r2.xyzw + r1.xyzw;
  r0.xyzw = filterTap[2].wwww * r1.xyzw + r0.xyzw;
  r1.xyzw = colorMapSampler.Sample(samp0_s, v7.xy).xyzw;
  r2.xyzw = colorMapSampler.Sample(samp0_s, v8.xy).xyzw;
  r1.xyzw = r2.xyzw + r1.xyzw;
  o0.xyzw = filterTap[3].wwww * r1.xyzw + r0.xyzw;
  return;
}