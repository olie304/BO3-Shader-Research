...
r3.w = shaderConstantSetBuffer[]..swiz;
  ...
  if (r1.w != 0) {
    ...
    r7.w = shaderConstantSetBuffer[]..swiz;
      ...
      r4.yz = v4.xx * r2.zy;
      r2.y = cmp(v4.y != 0.000000);
      if (r2.y != 0) {
        r2.y = (int)r1.w + (int)v5.y;
      // Known bad code for instruction (needs manual fix):
      ...
      r7.w = shaderConstantSetBuffer[]..swiz;
        ...
        r2.y = dot(r7.xyz, r1.xyz);
        r4.z = r2.y * v4.y + r4.z;
        r2.y = cmp(v4.z != 0.000000);
        if (r2.y != 0) {
          r2.y = (int)r1.w + (int)v5.z;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r7.xyzw, r2.y, l(0), t5.xyzw
        r7.x = shaderConstantSetBuffer[]..swiz;
        r7.y = shaderConstantSetBuffer[]..swiz;
...
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r3.xy, v6.x, l(0), t4.xyxx
r3.x = shaderConstantSetBuffer[]..swiz;
r3.y = shaderConstantSetBuffer[]..swiz;
...
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) o1.x, r3.y, l(0), t0.xxxx
