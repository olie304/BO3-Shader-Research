...
dp3 r6.w, r4.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
mov r14.w, l(0)
  ...
  if_nz r15.w
    ...
    if_nz r15.w
      ...
      if_nz r15.w
        ...
        mad r20.xyz, r4.yzwy, r5.xxxx, r20.xyzx
  ...
  if_nz r12.w
    ...
    if_nz r11.w
      ...
      if_nz r12.w
        ...
        mad r4.xyz, r4.yzwy, r5.xxxx, r18.xyzx
        mad r14.xyz, r14.xyzx, r7.wwww, r5.yzwy
        ...
        mad r2.xyw, r0.wwww, r19.xyxz, r13.yzyw
        add_sat r1.w, -r1.w, l(1.000000)
        mul r4.w, r1.w, r1.w
        mul r4.w, r4.w, r4.w
        mul r1.w, r1.w, r4.w
        mul r0.w, r0.w, r1.w
        mad r5.xyz, r0.wwww, r19.xyzx, r17.xzwx
        mad r12.xyz, r0.xxxx, r19.xyzx, r16.xyzx
        and r12.xyz, r3.zzzz, r12.xyzx
        movc r15.xyz, r1.zzzz, r4.xyzx, r15.xyzx
        movc r16.xyz, r1.zzzz, r16.xyzx, r12.xyzx
        movc r17.xzw, r1.zzzz, r5.xxyz, r17.xxzw
...
mad r3.xyw, r15.xyxz, r6.xyxz, r3.xyxw
...
ret 
// Approximately 1111 instruction slots used
