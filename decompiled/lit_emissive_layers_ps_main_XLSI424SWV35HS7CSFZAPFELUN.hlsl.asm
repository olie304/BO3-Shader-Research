...
if_nz r3.x
  ...
  round_z r3.x, r3.x
  add r3.x, r3.x, v1.y
  div r8.x, r3.x, cb0[11].w
  round_z r3.x, r4.w
  add r3.x, r3.x, v1.z
  div r8.y, r3.x, cb0[11].z
else 
  dp3 r3.x, -v6.xyzx, -v6.xyzx
  rsq r3.x, r3.x
  mul r9.xyz, r3.xxxx, -v6.xyzx
  dp3 r10.x, r9.xyzx, r4.xyzx
  dp3 r10.y, r9.xyzx, r5.xyzx
  dp3 r3.x, r9.xyzx, r3.yzwy
  lt r4.w, l(0.000000), r3.x
  div r7.zw, -r10.xxxy, r3.xxxx
  ...
  mov r9.y, r9.x
  mov r9.z, r3.x
  dp2 r10.x, r9.yzyy, r7.zwzz
  mov r9.x, -r3.x
  dp2 r10.y, r9.xyxx, r7.zwzz
  mul r7.zw, cb0[13].xxxy, cb1[69].wwww
  mad r7.zw, r7.zzzw, cb0[13].zzzw, r10.xxxy
...
add r3.x, v2.y, v2.x
add r3.x, r3.x, v2.z
add r4.w, r3.x, cb0[16].y
frc r4.w, r4.w
mad r9.y, cb1[69].w, cb0[16].z, r4.w
mov r9.x, cb0[16].x
sample_l_indexable(texture2d)(float,float,float,float) r4.w, r9.xyxx, t24.yzwx, s5, l(0.000000)
log r4.w, |r4.w|
...
add r4.w, r3.x, cb0[25].z
frc r4.w, r4.w
mad r10.y, cb1[69].w, cb0[25].w, r4.w
mov r10.x, cb0[25].y
sample_l_indexable(texture2d)(float,float,float,float) r4.w, r10.xyxx, t24.yzwx, s5, l(0.000000)
log r4.w, |r4.w|
...
if_nz r4.w
  ...
  div r3.yw, -r4.xxxy, r3.yyyy
  and r3.yz, r3.yywy, r3.zzzz
  add r4.xy, v1.yzyy, l(-0.500000, -0.500000, 0.000000, 0.000000)
  add r3.w, cb0[31].y, l(0.000010)
  mul r3.yz, r3.wwww, r3.yyzy
  mul r3.yz, r3.yyzy, cb0[29].zzwz
  mad r3.yz, r4.xxyx, cb0[29].zzwz, r3.yyzy
  mad r3.yz, cb0[30].xxyx, cb0[29].zzwz, r3.yyzy
  mad r3.w, cb0[28].w, cb1[69].w, l(1.000000)
  mul r3.w, r3.w, cb0[28].z
  mul r3.w, r3.w, l(0.01745329)
  sincos r4.x, r5.x, r3.w
  mov r5.y, r5.x
  mov r5.z, r4.x
  dp2 r10.x, r5.yzyy, r3.yzyy
  mov r5.x, -r4.x
  dp2 r10.y, r5.xyxx, r3.yzyy
  mul r3.yz, cb0[29].xxyx, cb1[69].wwww
  mad r3.yz, r3.yyzy, cb0[29].zzwz, r10.xxyx
  mul r3.w, cb0[31].x, cb1[69].w
  sincos null, r3.w, r3.w
  mad r3.w, r3.w, l(0.500000), l(0.500000)
  add r3.w, -r3.w, l(1.000000)
  add r4.x, -cb0[30].z, cb0[30].w
  mad r3.w, r3.w, r4.x, cb0[30].z
  div r3.yz, r3.yyzy, r3.wwww
  add r3.yz, r3.yyzy, l(0.000000, 0.500000, 0.500000, 0.000000)
  mov_sat r4.xy, r3.yzyy
  movc r9.x, cb0[31].w, r4.x, r3.y
  movc r9.y, cb0[32].x, r4.y, r3.z
endif 
sample_indexable(texture2d)(float,float,float,float) r4.xyzw, r9.xyxx, t29.xyzw, s1
mul r3.yzw, r4.xxyz, cb0[27].xxyz
mul r4.x, r4.w, cb0[18].w
mul r3.yzw, r3.yyzw, r4.xxxx
add r3.x, r3.x, cb0[32].z
frc r3.x, r3.x
mad r4.y, cb1[69].w, cb0[32].w, r3.x
mov r4.x, cb0[32].y
sample_l_indexable(texture2d)(float,float,float,float) r3.x, r4.xyxx, t24.xyzw, s5, l(0.000000)
log r3.x, |r3.x|
mul r3.x, r3.x, cb0[33].z
exp r3.x, r3.x
add r4.x, -cb0[33].x, cb0[33].y
mad r3.x, r3.x, r4.x, cb0[33].x
...
frc r4.w, r4.w
mad r4.w, r4.w, l(6.28318548), cb1[70].w
sincos r5.x, r10.x, r4.w
dp3_sat r0.x, r2.xyzx, r4.xyzx
dp3 r4.w, -r4.xyzx, r2.xyzx
add r4.w, r4.w, r4.w
mad r11.xyz, r2.xyzx, -r4.wwww, -r4.xyzx
...
if_z r0.w
  ...
  if_nz r5.z
    ...
    mov r11.w, l(0)
    sample_l_indexable(texturecubearray)(float,float,float,float) r7.xyz, r11.xyzw, t8.xyzw, s2, r5.w
...
if_nz r8.z
  ...
  if_nz r8.z
    ...
    mov r14.w, r16.z
    mov r7.w, r13.z
    movc r7.xyzw, r5.wwww, r14.xyzw, r7.xyzw
    mov r16.zw, r15.xxxy
    mov r13.zw, r0.yyyz
          ...
          if_nz r24.w
            ...
            if_nz r24.w
              ...
              if_nz r24.w
                ...
                mad r38.xyz, r38.xyzx, r11.wwww, r4.xyzx
                dp3 r11.w, r38.xyzx, r38.xyzx
                rsq r11.w, r11.w
                mul r38.xyz, r11.wwww, r38.xyzx
                dp3 r11.w, r38.xyzx, r4.xyzx
          ...
          if_nz r15.z
            ...
            if_nz r15.z
              ...
              if_nz r15.z
                ...
                mad r19.xyz, r19.xyzx, r11.wwww, r4.xyzx
                dp3 r11.w, r19.xyzx, r19.xyzx
                rsq r11.w, r11.w
                mul r19.xyz, r11.wwww, r19.xyzx
                dp3 r11.w, r19.xyzx, r4.xyzx
...
ret 
// Approximately 3161 instruction slots used
