  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r1.w = r1.w * r0.y;
  r2.z = aoMap.Sample(aoSampler_s, r0.zw).x;
  r3.x = glossMap.Sample(specColorSampler_s, r0.zw).x;
  r3.y = glossRange.y + -glossRange.x;
  r3.x = r3.x * r3.y + glossRange.x;
  r3.x = saturate(0.0588235296 * r3.x);
  r3.yzw = normalMap.Sample(normalSampler_s, r0.zw).xyz;
  r3.yzw = float3(-0.5,-0.5,-0) + r3.yzw;
  r3.yzw = baseNormalHeight * r3.yzw + float3(0.5,0.5,0);
  r0.zw = r3.yz * float2(1.9921875,1.9921875) + float2(-1,-1);
