...
r0.y = samp0[]..swiz;
  ...
  if (r0.y != 0) {
    ...
    r3.z = samp0[]..swiz;
      ...
      r0.y = -sunConstants.splitDepthOffset + r1.w;
      r0.y = -r0.y * 6.10351563e-05 + 1;
      r1.x = (int16)sunConstants.splitArrayOffset + 2;
      r3.z = (uint)r1.x;
      r1.x = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r3.xyz, r0.y, int2(1, 1)).x;
      r1.y = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r3.xyz, r0.y, int2(1, -1)).x;
      r1.x = r1.x + r1.y;
      r1.y = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r3.xyz, r0.y, int2(-1, 1)).x;
      r1.x = r1.x + r1.y;
      r0.y = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r3.xyz, r0.y, int2(-1, -1)).x;
      r0.y = r1.x + r0.y;
      r1.x = gTransShadowmapArray.SampleLevel(samp0_s, r3.xyz, 0).x;
      r0.y = r0.y * 0.25 + r1.x;
      r4.x = saturate(-1 + r0.y);
    }
    // Needs manual fix for instruction:
    imm_atomic_alloc r3.x, u0
    InterlockedExchange ?(dest, value, orig_value);
    r4.yz = float2(1.40129846e-45,4.34402524e-44);
    [r3.x].76 = u0.xyz;
    [r3.x].0 = u0.x;
    // Needs manual fix for instruction:
    imm_atomic_alloc r3.x, u0
