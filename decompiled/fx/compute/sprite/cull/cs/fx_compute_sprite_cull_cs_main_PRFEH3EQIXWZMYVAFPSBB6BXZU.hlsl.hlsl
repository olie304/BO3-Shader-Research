...
// unknown dcl_: dcl_thread_group 8, 8, 1
  ...
  u1.GetDimensions(0, uiDest.x, uiDest.y, uiDest.z);
  r1.xy = uiDest.xy;
...
store_uav_typed u1.xyzw, r0.xyyy, l(2.000000,2.000000,2.000000,2.000000)
  r1.x = (int)computeSpriteControl.x + 1023;
  r1.x = (uint)r1.x >> 10;
  r1.y = 0;
  while (true) {
    r1.z = cmp((uint)r1.y >= (uint)r1.x);
    if (r1.z != 0) break;
    r0.zw = r1.yy;
  // No code for instruction (needs manual fix):
    store_uav_typed u2.xyzw, r0.xyzw, l(0,0,0,0)
    r1.y = (int)r1.y + 1;
  }
  return;
}