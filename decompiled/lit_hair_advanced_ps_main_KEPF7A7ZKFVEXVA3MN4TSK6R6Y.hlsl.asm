...
if_nz r0.x
  ftoi r0.x, cb1[64].w
  lod r0.y, v2.xyxx, t21.y, s1
  lod r0.z, v2.xyxx, t21.x, s1
  lt r0.y, r0.y, r0.z
...
sample_indexable(texture2d)(float,float,float,float) r2.y, v2.xyxx, t25.yxzw, s6
add r2.z, -cb0[10].y, cb0[10].z
mad r1.w, r1.w, r2.z, cb0[10].y
...
mad r2.z, cb1[62].x, r2.z, cb0[10].y
...
add r2.x, -r1.w, r2.x
mad r3.y, cb1[62].w, r2.x, r1.w
add r1.w, -r2.y, cb1[63].x
mad r1.w, cb1[63].w, r1.w, r2.y
mul r2.xyz, cb1[9].xywx, -cb1[24].yyyy
mad r2.xyz, -cb1[24].xxxx, cb1[8].xywx, r2.xyzx
mad r2.xyz, -cb1[24].zzzz, cb1[10].xywx, r2.xyzx
add r2.xyz, r2.xyzx, cb1[11].xywx
add r4.xyz, v6.xyzx, cb1[24].xyzx
sample_indexable(texture2d)(float,float,float,float) r2.w, v2.xyxx, t29.yzwx, s7
...
mul r16.xyz, r1.xyzx, cb0[11].xyzx
sqrt r3.z, r9.z
...
mul r9.w, r3.w, r8.w
sqrt r9.w, r9.w
mul r13.yzw, v6.yyyy, cb2[29].xxyz
mad r13.yzw, v6.xxxx, cb2[28].xxyz, r13.yyzw
mad r13.yzw, v6.zzzz, cb2[30].xxyz, r13.yyzw
...
if_nz r10.w
  ...
  mad r22.xyz, r7.xyzx, r11.wwww, v6.xyzx
...
if_nz r10.w
  ...
  mad r19.xyz, -v6.xyzx, r6.wwww, cb2[17].xyzx
      ...
      switch r26.w
        ...
        if_nz r30.w
          ...
          if_nz r31.w
            ...
            mad r55.xyz, r7.xyzx, r31.wwww, v6.xyzx
            mov r50.z, r51.x
          ...
          if_nz r38.w
            ...
            mad r25.xyz, r7.xyzx, r34.wwww, v6.xyzx
        ...
        if_nz r25.x
          ...
          if_nz r30.w
            ...
            mad r27.xyz, r7.xyzx, r30.wwww, v6.xyzx
            mov r53.xy, r52.xyxx
          ...
          if_nz r38.w
            ...
            mad r28.xyz, r7.xyzx, r27.zzzz, v6.xyzx
...
mov x0[0].x, r4.z
mov x1[1].x, r4.y
mad r8.xyz, r2.xyzx, r4.yyyy, r11.xyzx
...
if_z r4.x
  ...
  mov x1[1].x, r4.y
  mad r5.xyz, r2.xyzx, r4.yyyy, r11.xyzx
  lt r4.y, r3.w, r4.y
  mul r5.xy, r5.xyxx, cb1[44].xyxx
  ftoi r8.xy, r5.xyxx
  mov r8.zw, l(0,0,0,0)
...
if_z r4.x
  ...
  mad r2.xyz, r2.xyzx, r3.zzzz, r11.xyzx
  lt r3.z, r3.w, r3.z
...
min r2.x, r2.x, r38.y
mul r2.x, r2.x, r38.x
mul r2.xyz, r33.xyzx, r2.xxxx
mad r4.xyz, r2.xyzx, r35.xyzx, r30.xyzx
mad r5.xyz, r2.xyzx, r36.xyzx, r32.xyzx
mad r2.xyz, r2.xyzx, r37.xyzx, r31.xyzx
...
loop 
  ...
  iadd r12.xyz, r11.xyzx, r20.xyzx
  ...
  add r31.xyz, -r17.yzwy, v6.xyzx
  dp3 r11.w, r31.xyzx, r31.xyzx
  sqrt r11.w, r11.w
  ge r11.w, cb2[54].y, r11.w
  and r12.z, r24.y, l(0x0000ffff)
  ...
  dp3 r13.w, r32.xyzx, r31.xyzx
  add_sat r13.w, r32.w, r13.w
  dp3 r14.z, r33.xyzx, r31.xyzx
  add_sat r14.z, r33.w, r14.z
  mul r13.w, r13.w, r14.z
  dp3 r14.z, r34.xyzx, r31.xyzx
  add_sat r14.z, r34.w, r14.z
  mul r13.w, r13.w, r14.z
  dp3 r14.z, r35.xyzx, r31.xyzx
  add_sat r14.z, r35.w, r14.z
  mul r13.w, r13.w, r14.z
  dp3 r14.z, r36.xyzx, r31.xyzx
  add_sat r14.z, r36.w, r14.z
  mul r13.w, r13.w, r14.z
  dp3 r14.z, r37.xyzx, r31.xyzx
  ...
  dp3 r25.x, r31.xyzx, r17.xyzx
  dp3 r25.y, r31.xyzx, r27.xyzx
  dp3 r25.z, r31.xyzx, r19.xyzx
  ...
  dp3 r26.z, r7.xyzx, r19.xyzx
  sample_l_indexable(texture3d)(float,float,float,float) r17.xyz, r21.xyzx, t17.xyzw, s4, l(0.000000)
  add r19.xyz, r21.xyzx, l(0.000000, 0.000000, 0.500000, 0.000000)
  sample_l_indexable(texture3d)(float,float,float,float) r22.xyz, r19.xyzx, t17.xyzw, s4, l(0.000000)
  sample_l_indexable(texture3d)(float,float,float,float) r23.xyz, r21.xyzx, t18.xyzw, s4, l(0.000000)
  sample_l_indexable(texture3d)(float,float,float,float) r24.yzw, r19.xyzx, t18.wxyz, s4, l(0.000000)
  ...
  mad r19.xyz, r25.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000), r19.xyzx
  mad r17.xyz, r17.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000), r19.xyzx
  sample_l_indexable(texturecubearray)(float,float,float,float) r19.xyz, r26.xyzw, t8.xyzw, s2, l(6.000000)
...
if_z r9.w
  ...
  loop 
    ...
    ieq r12.w, r10.w, r11.w
    bfi r13.x, r11.x, l(0), l(0), r12.z
    movc r12.z, r12.w, r13.x, r12.z
    ieq r12.w, r11.y, r11.w
    ubfe r13.x, r11.z, l(0), r12.z
    movc r12.z, r12.w, r13.x, r12.z
    ...
    loop 
      ...
      if_nz r14.w
        ...
        if_nz r13.z
          ...
          mul r14.x, r20.w, r23.w
          and r20.w, r17.z, l(1)
          movc r26.xy, r20.wwww, r14.xyxx, r14.zxzz
          mov r14.x, r17.z
          mov r27.xy, r26.xyxx
          mov r20.w, l(1)
          loop 
            ige r23.w, r20.w, r14.w
            breakc_nz r23.w
            iadd r23.w, r13.z, r20.w
          ...
          if_nz r14.x
            ...
            mad r22.z, r27.y, r17.w, r22.z
            mul r13.y, r24.z, r13.z
            mov r24.z, r32.z
            dp3 r13.z, r8.xyzx, r24.xyzx
            ...
            mov r24.x, r29.w
            mov r24.yz, r30.zzwz
            add r17.yzw, r25.xxyz, r24.xxyz
            mad r17.yzw, r8.xxyz, r13.zzzz, r17.yyzw
            dp3 r14.x, r17.yzwy, r17.yzwy
            sqrt r14.x, r14.x
            ...
            mov r23.y, r26.z
            mov r23.z, r28.x
            dp3 r32.x, r17.yzwy, r23.xyzx
            mov r24.xy, r26.xwxx
            mov r24.z, r28.w
            dp3 r32.y, r17.yzwy, r24.xyzx
            mov r28.x, r26.y
            ...
            and r26.xyz, r17.yzwy, l(0x7fffffff, 0x7fffffff, 0x7fffffff, 0)
            ...
            dp3 r32.x, r7.xyzx, r23.xyzx
            dp3 r32.y, r7.xyzx, r24.xyzx
            dp3 r32.z, r7.xyzx, r28.xyzx
            sample_l_indexable(texture3d)(float,float,float,float) r23.xyz, r25.xyzx, t17.xyzw, s4, l(0.000000)
            add r24.xyz, r25.xyzx, l(0.000000, 0.000000, 0.500000, 0.000000)
            sample_l_indexable(texture3d)(float,float,float,float) r26.xyz, r24.xyzx, t17.xyzw, s4, l(0.000000)
            sample_l_indexable(texture3d)(float,float,float,float) r27.xzw, r25.xyzx, t18.xwyz, s4, l(0.000000)
            sample_l_indexable(texture3d)(float,float,float,float) r28.xyz, r24.xyzx, t18.xyzw, s4, l(0.000000)
            ...
            or r13.z, r25.y, r25.x
            or r13.z, r25.z, r13.z
            movc r24.xyz, r13.zzzz, l(1.000000,1.000000,0,0), r24.xyzx
            ...
            dp3 r13.y, r17.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
            mad r13.y, r6.w, r13.z, r13.y
            div r13.y, r14.x, r13.y
            mov r23.x, r21.w
            mov r23.yz, r22.xxyx
            mad r22.xyw, r17.zwzy, r13.yyyy, r23.yzyx
            mov r21.w, r22.w
          endif 
        endif 
      endif 
  ...
  if_nz r11.y
    ...
    mov r14.w, l(0)
    loop 
      uge r16.w, r14.w, r9.w
      breakc_nz r16.w
      ushr r12.z, r14.w, l(5)
      iadd r13.xyz, r12.xyzx, r20.xyzx
      ld_indexable(texture2darray)(uint,uint,uint,uint) r12.z, r13.xyzw, t7.yzxw
      ieq r13.x, r10.w, r14.w
      ubfe r13.y, r11.x, l(0), r12.z
      movc r12.z, r13.x, r13.y, r12.z
      iadd r13.x, r14.w, cb2[0].x
      ...
      loop 
        breakc_z r13.z
        firstbit_lo r16.w, r13.z
        ishl r17.z, l(1), r16.w
        and r17.w, r13.z, r17.z
        if_nz r17.w
          xor r13.z, r13.z, r17.z
          iadd r17.z, r13.x, r16.w
          ...
          if_nz r17.z
            ...
            and r20.w, r25.w, l(0x0000ffff)
            ubfe r23.w, l(6), l(25), r25.w
            ...
            mul r14.x, r24.w, r26.w
            and r24.w, r17.z, l(1)
            movc r27.xy, r24.wwww, r14.xyxx, r14.zxzz
            mov r14.x, r17.z
            mov r28.xy, r27.xyxx
            mov r24.w, l(1)
            loop 
              ige r26.w, r24.w, r23.w
              breakc_nz r26.w
              ...
              mov r14.x, r27.w
            endloop 
            add_sat r14.x, -r13.y, r28.y
            mul r17.y, r17.w, r14.x
            ...
            if_nz r17.z
              ...
              mad r22.w, r14.x, r17.w, r22.w
              mul r14.x, r25.z, r17.y
              mov r25.z, r33.z
              ...
              mad r17.yzw, r8.xxyz, r16.wwww, r17.yyzw
              dp3 r20.w, r17.yzwy, r17.yzwy
              sqrt r20.w, r20.w
              ...
              sample_l_indexable(texture3d)(float,float,float,float) r24.xyz, r26.xyzx, t17.xyzw, s4, l(0.000000)
              add r25.xyz, r26.xyzx, l(0.000000, 0.000000, 0.500000, 0.000000)
              sample_l_indexable(texture3d)(float,float,float,float) r27.xyz, r25.xyzx, t17.xyzw, s4, l(0.000000)
              sample_l_indexable(texture3d)(float,float,float,float) r28.xzw, r26.xyzx, t18.xwyz, s4, l(0.000000)
              ...
              sample_l_indexable(texture3d)(float,float,float,float) r25.xyz, r25.xyzx, t19.xyzw, s4, l(0.000000)
              add r30.xyz, r28.xzwx, r29.xyzx
              add r30.xyz, r26.xyzx, r30.xyzx
              add r30.xyz, r25.xyzx, r30.xyzx
              mul r30.xyz, r9.xxxx, r30.xyzx
              add r24.xyz, r24.xyzx, r27.xyzx
              add r26.xyz, r26.xyzx, r24.xyzx
              add r25.xyz, r25.xyzx, r26.xyzx
              mul r25.xyz, r9.yyyy, r25.xyzx
              add r24.xyz, r28.xzwx, r24.xyzx
              add r24.xyz, r29.xyzx, r24.xyzx
              mul r24.xyz, r9.zzzz, r24.xyzx
              ...
              mad r24.xyz, r24.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000), r25.xyzx
              ...
              ieq r26.xyz, r26.xyzx, l(0x7f800000, 0x7f800000, 0x7f800000, 0)
              or r16.w, r26.y, r26.x
              or r16.w, r26.z, r16.w
              movc r25.xyz, r16.wwww, l(1.000000,1.000000,0,0), r25.xyzx
    ...
    endloop 
    mov r19.xyzw, r21.zxyw
    mov r18.xyz, r11.yzwy
    mov r19.xyzw, r19.yzxw
  else 
    mov r19.x, r18.w
  endif 
  max r3.z, r19.w, l(1.000000)
  rcp r3.z, r3.z
  mov_sat r19.w, r19.w
  mul r15.xyz, r3.zzzz, r18.xyzx
  mul r16.xyz, r3.zzzz, r19.xyzx
  ...
  if_nz r4.w
    ...
    sample_l_indexable(texture3d)(float,float,float,float) r17.xyz, r11.xyzx, t18.xyzw, s4, l(0.000000)
    ...
    mul r20.xyz, r9.xxxx, r20.xyzx
    add r12.xyz, r12.xyzx, r14.xyzx
    add r11.xyz, r11.xyzx, r12.xyzx
    add r11.xyz, r13.xyzx, r11.xyzx
    mul r9.xyw, r9.yyyy, r11.xyxz
    add r11.xyz, r17.xyzx, r12.xyzx
    add r11.xyz, r19.xyzx, r11.xyzx
    mul r11.xyz, r9.zzzz, r11.xyzx
    mul r9.xyz, r9.xywx, l(0.250000, 0.250000, 0.250000, 0.000000)
    mad r9.xyz, r20.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000), r9.xyzx
    mad r9.xyz, r11.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000), r9.xyzx
    ...
    mad r15.xyz, r18.xyzx, r3.zzzz, r7.xyzx
    mov r8.w, l(0)
    ...
    mad r16.xyz, r7.xyzx, r3.zzzz, r16.xyzx
  endif 
else 
  mov r16.x, r15.w
endif 
mad r4.xyz, r15.xyzx, r1.wwww, r4.xyzx
...
mul r7.xyz, r1.wwww, r16.xyzx
mad r2.xyz, r7.xyzx, r3.xxxx, r2.xyzx
mad r3.xyz, r7.xyzx, r3.yyyy, r5.xyzx
mul r1.w, r2.w, l(0.040000)
mad r2.w, -r2.w, l(0.040000), l(1.000000)
