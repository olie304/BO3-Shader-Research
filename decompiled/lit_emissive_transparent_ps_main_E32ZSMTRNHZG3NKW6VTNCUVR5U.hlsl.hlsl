...
r0.y = samp0[]..swiz;
  ...
  while (true) {
    ...
    if (r4.z == 0) r9.w = 0; else if (r4.z+0 < 32) {     r9.w = (uint)r8.w << (32-(r4.z + 0)); r9.w = (uint)r9.w >> (32-r4.z);    } else r9.w = (uint)r8.w >> 0;
    r8.w = r9.z ? r9.w : r8.w;
  ...
  o0.w = r0.z * r1.w + r4.w;
  r2.xyz = r2.xzw * r1.www + r12.xyz;
  r0.z = dot(r2.xyz, r2.xyz);
  r0.z = rsqrt(r0.z);
  r2.xyz = r2.xyz * r0.zzz;
  r5.y = r0.w * r1.w + r5.w;
  r6.xyz = r1.www * float3(0.0399999991,0.0399999991,0.0399999991) + r13.xyz;
  r0.x = saturate(r0.x);
  r0.x = hdrScale * r0.x;
  r9.xyz = cmp(r0.yyy == float3(3,2,1));
  r0.y = cmp(r0.y < 0);
  r0.yzw = r0.yyy ? float3(1,1,1) : emissiveTint1.xyz;
  r0.yzw = r9.zzz ? tint1.xyz : r0.yzw;
  r0.yzw = r9.yyy ? tint2.xyz : r0.yzw;
  r0.yzw = r9.xxx ? tint3.xyz : r0.yzw;
  r3.w = cmp(0.5 < invertFalloff);
  if (r3.w != 0) {
    r3.w = rowCount * columnCount;
    r4.z = imageTime * r3.w;
    r4.w = gameTime.w * r4.z;
    r4.w = cmp(r4.w >= -r4.w);
    r4.w = r4.w ? r4.z : -r4.z;
    r5.z = 1 / r4.w;
    ...
    r3.w = r4.z * r3.w;
    r3.w = round(r3.w);
    r4.z = r3.w / columnCount;
    r4.w = columnCount * r3.w;
    r4.w = cmp(r4.w >= -r4.w);
  ...
  r0.w = frac(r0.w);
  r3.y = gameTime.w * flickerSpeed + r0.w;
  r3.x = flickerSeed.x;
  r0.w = flickerLookupMap.SampleLevel(lookupSampler_s, r3.xy, 0).x;
  r0.w = log2(abs(r0.w));
  ...
  r4.w = 100 * r4.w;
  r5.zw = -r3.zz * float2(10,5) + float2(6.85740995,7.08500004);
  r5.z = exp2(r5.z);
  r5.z = r5.x * r5.z;
  r6.w = r4.z * r3.z;
  ...
  if (r9.w != 0) {
    ...
    r10.w = 0;
    while (true) {
      r13.w = cmp((uint)r10.w >= (uint)r5.w);
      if (r13.w != 0) break;
      r13.z = (uint)r10.w >> 5;
      r14.xyz = (int3)r8.xyz + (int3)r13.xyz;
  ...
  r13.xyz = r20.xyz * r3.zzz;
  r11.yzw = r21.xyz * r3.zzz;
  ...
  if (r4.w != 0) {
    ...
    r13.xyz = r20.xyz * r3.zzz + r14.xyz;
    r12.w = 0;
    r14.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r12.xyzw, r4.z).xyz;
    r3.z = sunConstants.globalProbeExposure * r4.w + -r2.w;
    r2.w = r5.y * r3.z + r2.w;
  ...
  if (r6.w != 0) {
    ...
    if (r6.w != 0) {
      ...
      r3.w = dot(r11.yzw, r10.xyz);
      r7.w = dot(r2.xyz, r11.yzw);
      r9.w = abs(r7.w) * r1.w + -abs(r7.w);
      ...
      r4.w = r8.w * r4.w;
      r4.w = 0.25 * r4.w;
      r11.yzw = r4.www * r7.xyz + r5.yzw;
      r3.w = saturate(1 + -r3.w);
      r6.w = r3.w * r3.w;
      r6.w = r6.w * r6.w;
      r3.w = r6.w * r3.w;
      r3.w = r4.w * r3.w;
      r7.xyz = r3.www * r7.yzx + r14.xyz;
      r15.w = r7.z;
      r13.w = r14.z;
      r13.xyzw = r4.zzzz ? r15.xyzw : r13.xyzw;
      r7.zw = r11.yz;
      r14.zw = r5.yz;
      r7.xyzw = r4.zzzz ? r7.xyzw : r14.xyzw;
      r5.w = r4.z ? r11.w : r5.w;
      r14.z = r13.w;
      r14.xy = r7.xy;
      r5.yz = r7.zw;
    }
                    ...
                    r13.w = samp0[]..swiz;
                      ...
                      if (r8.w != 0) {
                        ...
                        while (true) {
                          ...
                          r42.y = dot(icb[r18.z+0].xy, r4.xy);
