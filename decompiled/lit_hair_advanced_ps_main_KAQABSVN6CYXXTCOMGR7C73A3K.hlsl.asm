...
sample_indexable(texture2d)(float,float,float,float) r1.z, v2.xyxx, t22.xyzw, s5
...
sample_indexable(texture2d)(float,float,float,float) r2.z, v2.xyxx, t29.yzxw, s7
sample_indexable(texture2d)(float,float,float,float) r4.xyzw, v2.xyxx, t26.xyzw, s7
...
movc r6.xyz, v7.xxxx, v4.xyzx, -v4.xyzx
dp3 r4.w, r6.xyzx, r6.xyzx
rsq r4.w, r4.w
mul r6.xyz, r4.wwww, r6.xyzx
movc r7.xyz, v7.xxxx, v5.xyzx, -v5.xyzx
...
if_nz r10.z
  ...
  mad r21.xyz, r6.xyzx, r11.wwww, v6.xyzx
...
if_nz r10.z
  ...
  mad r18.xyz, -v6.xyzx, r7.wwww, cb2[17].xyzx
      ...
      switch r28.w
        ...
        if_nz r30.w
          ...
          if_nz r31.w
            ...
            mad r54.xyz, r6.xyzx, r31.wwww, v6.xyzx
            mov r49.z, r50.x
          ...
          if_nz r37.w
            ...
            mad r24.xyz, r6.xyzx, r34.wwww, v6.xyzx
        ...
        if_nz r24.x
          ...
          if_nz r25.y
            ...
            mad r26.xyz, r6.xyzx, r25.yyyy, v6.xyzx
            mov r52.xy, r51.xyxx
