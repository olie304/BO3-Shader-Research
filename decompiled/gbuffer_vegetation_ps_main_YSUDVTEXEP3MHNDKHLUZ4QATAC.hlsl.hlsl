// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:31:41 2021
...
Texture2D<float4> specColorMapThick : register(t11);
  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r0.w = -r0.w * w1.x + debugOcclusionOverride.x;
  o2.z = debugOcclusionOverride.w * r0.w + r1.x;
  r1.xzw = v6.xxx ? v3.xyz : -v3.xyz;
  r0.w = dot(r1.xzw, r1.xzw);
  r0.w = rsqrt(r0.w);
  r1.xzw = r1.xzw * r0.www + -r5.xyz;
  r5.yzw = debugNormalOverride.www * r1.xzw + r5.xyz;
  r0.w = max(9.99999975e-05, backsideGlossScale);
  r0.w = r1.y * r0.w;
  r0.w = v6.x ? r1.y : r0.w;
  r1.x = specColorMapThick.Sample(colorSampler_s, v2.xy).x;
  r1.x = 1 + -r1.x;
  r1.yzw = treeCanopyScatterColor.xyz * r0.xyz;
  r1.w = r1.w * r1.x;
  r2.x = r4.x + r4.y;
  r2.x = r3.z * r2.w + r2.x;
  r2.x = 0.5 * r2.x;
  r2.yzw = r3.xyz * r2.www + -r2.xxx;
  r3.x = max(r2.z, r2.w);
  r3.x = max(r3.x, r2.y);
  r2.x = max(r3.x, r2.x);
  r2.y = cmp(r2.x == r2.y);
  ...
  r2.z = 2 + r2.x;
  r4.x = 2;
  r3.xyzw = r2.yyyy ? r4.xyzw : r3.xyzw;
  r2.x = r2.y ? r2.z : r2.x;
  r2.x = cmp(r2.x == r2.w);
  r4.yzw = float3(-1,-1,1) * r3.yzw;
  r4.x = 3;
