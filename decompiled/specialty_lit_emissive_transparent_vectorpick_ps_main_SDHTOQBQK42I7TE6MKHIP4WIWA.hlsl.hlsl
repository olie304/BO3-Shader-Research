...
r4.w = samp0[]..swiz;
  ...
  r1.z = saturate(v7.x);
  r1.z = hdrScale * r1.z;
  r8.xyz = cmp(v7.yyy == float3(3,2,1));
  ...
  r3.yz = r3.yz * r3.ww + w1.xy;
  r4.xyzw = emissiveMap.Sample(colorSampler_s, r3.yz).xyzw;
  ...
  r3.x = exp2(r3.x);
  r3.x = relativeHDR ? r3.x : r4.x;
  r4.x = cmp(emissiveFalloffPower == 0.000000);
  r3.x = r4.x ? 1 : r3.x;
  r1.z = r4.w * r1.z;
  r1.z = r1.z * r3.x;
  r1.z = r1.z * r2.y;
  r3.xyz = r3.yzw * r1.zzz;
  ...
  if (r5.w != 0) {
    ...
    if (r5.w != 0) {
      ...
      r1.w = r5.w * r1.w;
      r1.w = r5.z * r1.w;
      r17.xyz = r1.www * r10.zwy + r14.xyz;
      r15.w = r17.z;
      r13.w = r14.z;
                      ...
                      r11.w = samp0[]..swiz;
                        ...
                        if (r6.w != 0) {
                          ...
                          while (true) {
                            ...
                            if (r26.w != 0) break;
                            r42.x = dot(icb[r21.w+0].xy, r8.xy);
                            r42.y = dot(icb[r21.w+0].yx, r8.xz);
