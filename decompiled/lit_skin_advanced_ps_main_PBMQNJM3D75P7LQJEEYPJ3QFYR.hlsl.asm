...
mul_sat r1.yz, v8.xxyx, cb0[12].wwww
log r1.yz, r1.yyzy
mul r1.yz, r1.yyzy, cb0[12].zzzz
exp r1.yz, r1.yyzy
lt r1.w, r1.z, r1.y
sample_indexable(texture2d)(float,float,float,float) r2.xyz, v1.yzyy, t37.xyzw, s5
...
movc r1.z, r1.w, cb0[12].y, cb0[12].x
...
mul r1.y, r1.z, r1.y
mad r4.xy, r2.xyxx, r1.yyyy, r3.xyxx
dp3 r1.z, r4.xyzx, r4.xyzx
rsq r1.z, r1.z
mul r2.xyw, r1.zzzz, r4.xyxz
mad r1.y, r2.z, r1.y, r1.w
mul r1.zw, v1.yyyz, cb0[4].xxxy
sample_indexable(texture2d)(float,float,float,float) r3.xyz, r1.zwzz, t26.xyzw, s5
mad r1.zw, r3.xxxy, l(0.000000, 0.000000, 1.99218750, 1.99218750), l(0.000000, 0.000000, -1.000000, -1.000000)
mul r2.z, r3.z, r3.z
mul r2.z, r2.z, l(0.33333334)
min r2.z, r2.z, l(1.000000)
mad r2.xy, r1.zwzz, cb0[11].zzzz, r2.xyxx
dp3 r1.z, r2.xywx, r2.xywx
rsq r1.z, r1.z
mul r2.xyw, r1.zzzz, r2.xyxw
mad r1.y, r2.z, cb0[11].z, r1.y
movc r1.z, v9.x, l(1.000000), l(-1.000000)
    ...
    if_nz r10.w
      ...
      if_nz r10.z
        ...
        if_nz r13.x
          ...
          min r10.z, |r10.w|, r10.z
          mov r36.zw, r35.zzzw
          dp3 r10.w, r7.zxyz, r36.xzwx
          dp3 r13.x, r12.zxyz, r36.xzwx
          ...
          mov r23.y, r26.z
          mov r23.z, r27.x
          dp3 r31.x, r15.yzwy, r23.xyzx
          mov r24.xy, r26.xwxx
          mov r24.z, r27.w
          dp3 r31.y, r15.yzwy, r24.xyzx
          mov r27.x, r26.y
          dp3 r31.z, r15.yzwy, r27.xyzx
          ubfe r10.w, l(9), l(16), r24.w
          utof r31.w, r10.w
          sample_l_indexable(texturecubearray)(float,float,float,float) r15.yzw, r31.xyzw, t8.wxyz, s2, r10.z
          dp3 r26.x, r12.xyzx, r23.xyzx
          dp3 r26.y, r12.xyzx, r24.xyzx
          dp3 r26.z, r12.xyzx, r27.xyzx
          mad_sat r12.xyz, r26.xyzx, r28.xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
          mov r29.z, r30.x
          mad r12.xyz, r12.xyzx, r29.xyzx, r30.yzwy
          dp3 r31.x, r11.xyzx, r23.xyzx
          dp3 r31.y, r11.xyzx, r24.xyzx
          dp3 r31.z, r11.xyzx, r27.xyzx
          lt r23.xyz, l(0.000000, 0.000000, 0.000000, 0.000000), r31.xyzx
          movc r14.z, r23.x, l(0), l(0.500000)
          add r24.xyz, r12.xyzx, r14.xyzx
          ...
          mov r23.x, r21.w
          mov r23.yz, r22.xxyx
          mad r22.xyw, r12.yzyx, r9.wwww, r23.yzyx
          mov r21.w, r22.w
        endif 
      endif 
    endif 
      ...
      if_nz r10.w
        ...
        if_nz r10.z
          ...
          loop 
            ...
            movc r15.y, r26.w, r17.w, r27.z
            movc r27.xy, r24.wwww, r27.xyxx, r15.xyxx
            iadd r16.w, r16.w, l(1)
            mov r13.x, r22.w
          endloop 
          add_sat r10.z, -r6.w, r27.y
          ...
          if_nz r13.w
            ...
            mad r23.w, r10.z, r10.w, r23.w
            mul r9.w, r25.z, r13.x
            mov r25.z, r33.z
            dp3 r10.z, r7.xyzx, r25.xyzx
            ...
            dp3 r33.x, r11.xyzx, r24.xyzx
            dp3 r33.y, r11.xyzx, r25.xyzx
            ...
            mad r9.w, r1.y, r10.z, r9.w
            div r9.w, r10.w, r9.w
            mad r23.xyz, r15.yzwy, r9.wwww, r23.xyzx
          endif 
        endif 
      endif 
    endloop 
...
rcp r0.y, r0.y
mov_sat r20.w, r20.w
mul r1.xyz, r0.yyyy, r19.xyzx
mul r10.xyz, r0.yyyy, r20.xyzx
...
if_nz r1.w
  ...
  lt r13.xyz, l(0.000000, 0.000000, 0.000000, 0.000000), r11.xyzx
  ...
  mad r1.xyz, r19.xyzx, r0.yyyy, r11.xyzx
  mov r7.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r7.xyz, r7.xyzw, t8.xyzw, s2, r0.w
  mad r0.y, cb2[19].x, r1.w, -r2.w
  mad r0.y, r5.y, r0.y, r2.w
  mad r10.xyz, r7.xyzx, r0.yyyy, r10.xyzx
endif 
mad r4.xyz, r1.xyzx, r6.xyzx, r4.xyzx
mad r1.xyz, r1.xyzx, r6.xyzx, r8.xyzx
...
mov o2.w, r0.x
ret 
// Approximately 3604 instruction slots used
