...
mul r1.w, cb1[26].w, l(0.750000)
mov r2.x, vThreadID.y
movc r2.y, r0.z, r0.w, r2.x
movc r3.xyzw, r0.zzzz, r1.wwww, r1.xyzx
...
if_nz r1.x
  ...
  add r2.xyzw, r2.xyzx, r3.xyzx
  iadd r1.xy, r1.xxxx, l(8, 9, 0, 0)
  ld_structured r3.xyz, r1.x, l(0), g0.xyzx
  add r2.xyzw, r2.xyzw, r3.xyzx
  ld_structured r1.xyz, r1.y, l(0), g0.xyzx
  add r2.xyzw, r1.xyzx, r2.xyzw
  mul r2.xyzw, r2.xyzw, l(0.250000, 0.250000, 0.250000, 0.250000)
  store_structured g0.xyz, r0.y, l(0), r2.wyzw
  imad r3.xy, vThreadGroupID.yxyy, r0.wwww, vThreadIDInGroup.yxyy
  iadd r1.x, r0.x, l(-1)
  iadd r1.x, -r3.x, r1.x
  movc r3.z, r0.z, r1.x, r3.x
  movc r2.xyzw, r0.zzzz, r1.wwww, r2.xyzw
...
if_nz r0.y
  ...
  movc r3.y, r0.z, r0.x, r0.y
  movc r0.xyzw, r0.zzzz, r1.wwww, r2.xyzw
  mov r3.x, vThreadGroupID.x
  mov r3.zw, vThreadID.zzzz
