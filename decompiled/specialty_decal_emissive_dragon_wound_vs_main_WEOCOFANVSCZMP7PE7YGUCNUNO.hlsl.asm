...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:40:53 2021
//
//
// Buffer Definitions: 
//
...
mov r5.w, l(1.000000)
mov r4.w, r8.x
dp4 r9.x, r5.xyzw, r4.xyzw
mov r6.w, r8.y
dp4 r9.y, r5.xyzw, r6.xyzw
mov r8.xyz, r7.xyzx
...
dp3 r5.x, r1.xyzx, r4.xyzx
dp3 r5.y, r1.xyzx, r6.xyzx
...
dp3 r4.z, r2.yzwy, r8.xyzx
dp3 r0.w, r4.xyzx, r4.xyzx
rsq r0.w, r0.w
mul r2.xyz, r0.wwww, r4.xyzx
mul r4.xyzw, r9.yyyy, cb1[9].xyzw
mad r4.xyzw, r9.xxxx, cb1[8].xyzw, r4.xyzw
mad r4.xyzw, r9.zzzz, cb1[10].xyzw, r4.xyzw
...
mul r3.xzw, r4.xxyz, l(0.100000, 0.000000, 0.100000, 0.100000)
frc o2.xyz, r3.xzwx
...
if_nz r0.w
  ...
  round_z r0.w, r0.w
  add r0.w, r0.w, v2.x
  div r4.x, r0.w, cb0[12].w
  round_z r0.w, r1.w
  add r0.w, r0.w, v2.y
  div r4.y, r0.w, cb0[12].z
else 
  dp3 r0.w, -r9.xyzx, -r9.xyzx
  rsq r0.w, r0.w
  mul r3.xzw, r0.wwww, -r9.xxyz
  dp3 r5.x, r3.xzwx, r1.xyzx
  dp3 r5.y, r3.xzwx, r2.xyzx
  dp3 r0.w, r3.xzwx, r0.xyzx
  lt r1.w, l(0.000000), r0.w
  div r3.xz, -r5.xxyx, r0.wwww
  and r3.xz, r1.wwww, r3.xxzx
  add r5.xy, v2.xyxx, l(-0.500000, -0.500000, 0.000000, 0.000000)
  add r0.w, cb0[16].y, l(0.000010)
  mul r3.xz, r0.wwww, r3.xxzx
  mul r3.xz, r3.xxzx, cb0[14].zzwz
  mad r3.xz, r5.xxyx, cb0[14].zzwz, r3.xxzx
  mad r3.xz, cb0[15].xxyx, cb0[14].zzwz, r3.xxzx
  ...
  mov r6.y, r6.x
  mov r6.z, r5.x
  dp2 r7.x, r6.yzyy, r3.xzxx
  mov r6.x, -r5.x
  dp2 r7.y, r6.xyxx, r3.xzxx
  mul r3.xz, cb0[14].xxyx, cb1[69].wwww
  mad r3.xz, r3.xxzx, cb0[14].zzwz, r7.xxyx
  ...
  div r3.xz, r3.xxzx, r0.wwww
  add r3.xz, r3.xxzx, l(0.500000, 0.000000, 0.500000, 0.000000)
  mov_sat r5.xy, r3.xzxx
  movc r4.xy, cb0[16].zwzz, r5.xyxx, r3.xzxx
endif 
...
movc r3.xz, r6.zzzz, r5.xxyx, r3.xxzx
movc r3.xz, r6.yyyy, r5.zzwz, r3.xxzx
movc o7.xy, r6.xxxx, r3.ywyy, r3.xzxx
mov r4.z, v1.w
mov o1.xyz, r4.zxyz
mov o3.xyz, r0.xyzx
mov o4.xyz, r1.xyzx
