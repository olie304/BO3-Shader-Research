  ...
  out float4 o1 : SV_TARGET1)
{
  ...
  r0.x = saturate(v1.x * 0.998000026 + 0.00100000005);
  r0.y = log2(r0.x);
  r0.x = 1 + -r0.x;
  ...
  r0.y = r0.y + -r0.x;
  r1.xyzw = normalTiling.xyxy * w1.xyyz;
  r0.zw = scaleReveal ? r1.zw : w1.xy;
