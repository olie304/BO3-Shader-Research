  ...
  if_z r11.w
    ...
    if_nz cb2[58].y
      ...
      loop 
        ...
        movc r17.x, r16.y, cb2[r8.w + 20].w, cb2[r11.w + 20].w
        movc r16.y, r16.y, r8.w, r11.w
          ...
          if_nz r13.w
            ...
            if_nz r13.w
              ...
              if_nz r13.w
                ...
                mad r18.xyz, r18.xyzx, r11.wwww, r3.xyzx
                dp3 r11.w, r18.xyzx, r18.xyzx
                rsq r11.w, r11.w
                mul r18.xyz, r11.wwww, r18.xyzx
                dp3 r11.w, r18.xyzx, r3.xyzx
...
if_z r2.x
  ftou r2.xy, v0.xyxx
  bfi r3.x, l(1), l(16), cb0[10].w, l(0)
  iadd r3.x, r3.x, l(1)
...
ret 
// Approximately 2252 instruction slots used
