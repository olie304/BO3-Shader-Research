// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:36:08 2021
...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  r2.w = saturate(r2.w);
  r1.y = 1 + -r2.w;
  r3.xyz = colorTint.xyz * r1.yyy + r9.xyz;
  r1.x = r1.x * r1.y + r2.w;
    ...
    if (r11.w == 0) {
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          r16.x = r15.y ? sunConstants.splitPinTransform[r8.z].w : sunConstants.splitPinTransform[r11.w].w;
          r15.y = r15.y ? r8.z : r11.w;
                    ...
                    r12.w = samp0[]..swiz;
                      ...
                      if (r7.w != 0) {
                        ...
                        while (true) {
                          ...
                          r42.y = dot(icb[r16.z+0].xy, r8.xy);
            ...
            r39.w = samp0[]..swiz;
              ...
              if (r13.w != 0) {
                ...
                if (r13.w != 0) {
                  ...
                  r17.xyz = r17.xyz * r11.www + r7.xyz;
                  r11.w = dot(r17.xyz, r17.xyz);
                  r11.w = rsqrt(r11.w);
                  r17.xyz = r17.xyz * r11.www;
                  r11.w = dot(r17.xyz, r7.xyz);
