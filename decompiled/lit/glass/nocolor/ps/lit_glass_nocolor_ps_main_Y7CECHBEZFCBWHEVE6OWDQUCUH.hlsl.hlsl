...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r3.y = r0.x * r0.w + r4.w;
  r4.xyz = r0.www * float3(0.0799999982,0.0799999982,0.0799999982) + r11.xyz;
  r0.x = dot(-v7.xyz, -v7.xyz);
  r0.x = rsqrt(r0.x);
  r7.xyz = -v7.xyz * r0.xxx;
  ...
  r4.w = 100 * r4.w;
  r8.zw = -r3.zz * float2(10,5) + float2(6.85740995,7.08500004);
  r6.w = exp2(r8.z);
  r6.w = r6.w * r3.x;
  r6.w = 9.1368103 * r6.w;
  r7.w = r2.w * r3.z;
  ...
  if (r7.w == 0) {
    ...
    r20.xyz = r22.xyz * r3.zzz;
    r21.xyz = r23.xyz * r3.zzz;
    ...
    if (r4.w != 0) {
      ...
      r20.xyz = r22.xyz * r3.zzz + r11.yzw;
      r12.w = 0;
  ...
  r3.yz = gEnvBRDFGlass.SampleLevel(samplerLinear_s, r3.yz, 0).xy;
  r11.yzw = r21.xyz * r1.www;
  r14.xyz = r11.zwy * r3.yyy;
  r11.yzw = r11.yzw * r3.zzz;
  r0.y = sqrt(r2.z);
  r0.y = r0.y * 0.5 + 0.5;
  r0.y = r0.y * r0.y;
  r1.w = 0.5 * r0.y;
  ...
  if (r3.z == 0) {
    ...
    r3.z = -sunConstants.splitDepthOffset + r15.z;
    ...
    if (r6.w != 0) {
      ...
      while (true) {
        ...
        if (r8.z != 0) break;
        r8.z = (uint)r6.w;
        r16.xy = -sunConstants.splitPinTransform[r8.z].xy + r15.xy;
    ...
    r9.w = samp0[]..swiz;
      ...
      r10.w = samp0[]..swiz;
        r10.w = r20.y ? r18.z : r10.w;
        r15.w = (uint)r10.w >> 13;
        r10.w = r20.x ? r15.w : r10.w;
      ...
      r19.w = samp0[]..swiz;
        ...
        r18.w = samp0[]..swiz;
          ...
          r8.w = r18.w ? -2.000000 : 0;
          r9.w = (int)r18.w | 0x40000000;
          bitmask.w = ((~(-1 << 1)) << 1) & 0xffffffff;  r10.w = (((uint)r17.w << 1) & bitmask.w) | ((uint)0 & ~bitmask.w);
          bitmask.w = ((~(-1 << 1)) << 0) & 0xffffffff;  r10.w = (((uint)r17.y << 0) & bitmask.w) | ((uint)r10.w & ~bitmask.w);
          r10.w = (int)r10.w * 10;
        ...
        r19.z = samp0[]..swiz;
          ...
          r10.w = (int)r19.z | 0x40000000;
          bitmask.w = ((~(-1 << 1)) << 1) & 0xffffffff;  r15.w = (((uint)r17.w << 1) & bitmask.w) | ((uint)0 & ~bitmask.w);
          bitmask.w = ((~(-1 << 1)) << 0) & 0xffffffff;  r15.w = (((uint)r17.y << 0) & bitmask.w) | ((uint)r15.w & ~bitmask.w);
          r15.w = (int)r15.w * 10;
      ...
      r8.w = -sunConstants.sstLightingConstants.constants.inchesPerTexel * 2 + r15.z;
      r8.w = cmp(r12.w < r8.w);
      r4.w = r8.w ? 0 : 1;
    }
    if (r8.z == 0) {
      if (enableDitheredShadow == 0) {
        r8.z = (uint)r6.w;
        r15.zw = -sunConstants.splitPinTransform[r8.z].xy + r15.xy;
        r8.zw = sunConstants.splitPinTransform[r8.z].zz * r15.zw;
        r16.xy = r8.zw * float2(0.5,-0.5) + float2(0.5,0.5);
        r8.z = (int16)sunConstants.splitArrayOffset;
        r16.z = r8.z + r6.w;
        r8.z = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r3.z).x;
      ...
      if (enableDitheredShadow != 0) {
        ...
        r7.w = (uint)r7.w;
        r15.zw = -sunConstants.splitPinTransform[r8.z].xy + r15.xy;
        r15.zw = sunConstants.splitPinTransform[r8.z].zz * r15.zw;
        ...
        while (true) {
          ...
          r17.xy = r10.ww ? r15.xy : r15.zw;
          r12.w = r10.w ? sunConstants.splitPinTransform[r6.w].w : sunConstants.splitPinTransform[r8.z].w;
          r10.w = r10.w ? r6.w : r8.z;
  ...
  if (r3.z != 0) {
    r3.z = cmp(0 < r4.w);
    if (r3.z != 0) {
      r3.z = sunConstants.specScale * r2.y;
      r3.z = r3.z * r3.y;
      ...
      r18.w = samp0[]..swiz;
        ...
        r8.zw = r15.xy * float2(0.5,-0.5) + float2(0.5,0.5);
        r8.zw = r8.zw + r18.zw;
        r8.zw = r8.zw * r18.xy;
        r15.xy = r6.ww / r17.xz;
        r15.zw = float2(1,1) + -r15.xy;
        r15.zw = cmp(r8.zw >= r15.zw);
        r15.xy = cmp(r15.xy >= r8.zw);
        ...
        r16.y = samp0[]..swiz;
          ...
          if (enableDitheredShadow != 0) {
            ...
            while (true) {
              ...
              r8.z = r9.w * 0.125 + r8.z;
              r8.w = (int)r8.w + 1;
            }
          } else {
            r15.z = (uint)r7.w;
            r8.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r15.xyz, r5.w).x;
          }
          r5.w = r8.z * r8.z;
          r5.w = r5.w * r8.z;
        } else {
  ...
  while (true) {
    ...
    if (r7.w != 0) break;
    r3.z = (uint)r6.w >> 5;
    r15.xyz = (int3)r3.xyz + (int3)r6.xyz;
    r3.z = visibleLights.Load(r15.xyzw).x;
    r15.xyz = r26.xyz;
    r29.xyz = r27.xyz;
    r30.xyz = r28.xyz;
    r7.w = r4.w;
            ...
            if (r23.w != 0) {
              ...
              if (r23.w != 0) {
                ...
                if (r23.w != 0) {
                  ...
                  r38.xyz = r38.xyz * r9.www + r7.xyz;
                  r9.w = dot(r38.xyz, r38.xyz);
                  r9.w = rsqrt(r9.w);
                  r38.xyz = r38.xyz * r9.www;
                  r9.w = dot(r38.xyz, r7.xyz);
            ...
            r39.w = samp0[]..swiz;
              ...
              if (r13.w != 0) {
                  ...
                  r39.y = samp0[]..swiz;
                    ...
                    if (r7.w != 0) {
                      ...
                      while (true) {
                        ...
                        r24.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r31.xyz, r8.w).x;
                        r17.x = r24.w * 0.125 + r17.x;
                        r23.w = (int)r23.w + 1;
                      }
                    } else {
                      r20.z = (uint)r13.w;
                      r17.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r20.xyz, r8.w).x;
                    }
                    r8.w = r17.x * r17.x;
                    r8.w = r8.w * r17.x;
                  } else {
                ...
                if (r13.w != 0) {
                  ...
                  r18.xyz = r18.xyz * r9.www + r7.xyz;
                  r9.w = dot(r18.xyz, r18.xyz);
                  r9.w = rsqrt(r9.w);
                  r18.xyz = r18.xyz * r9.www;
                  r9.w = dot(r18.xyz, r7.xyz);
                  ...
                  r8.w = r12.w * r8.w;
                  r8.w = 0.25 * r8.w;
                  r18.xyz = r8.www * r19.xyw + r30.xyz;
                  r9.w = saturate(1 + -r9.w);
                  r9.w = log2(r9.w);
                  r9.w = 3.4000001 * r9.w;
                  r9.w = exp2(r9.w);
                  r8.w = r9.w * r8.w;
                  r19.xyw = r8.www * r19.xyw + r29.xyz;
  ...
  r0.xyw = float3(1,1,1) + -r4.xyz;
  r0.xyw = r27.xyz * r0.xyw;
  r0.xyw = r28.xyz * r4.xyz + r0.xyw;
  r0.xyw = r26.xyz * r9.xyz + r0.xyw;
  r1.x = log2(r3.w);
  r1.x = 3.4000001 * r1.x;
  r1.x = exp2(r1.x);
  r1.y = 1 + -r0.z;
