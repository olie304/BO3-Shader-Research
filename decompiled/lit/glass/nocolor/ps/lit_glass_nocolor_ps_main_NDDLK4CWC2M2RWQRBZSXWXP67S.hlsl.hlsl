...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  if (r1.x != 0) {
    ...
    r1.xyz = r1.www * r2.xyz + r0.xyw;
  }
  r0.xyw = relHDRExposure.yyy * r1.xyz;
  r1.xyz = cmp(r0.xyw >= float3(6.10351563e-05,6.10351563e-05,6.10351563e-05));
  r0.xyw = r1.xyz ? r0.xyw : 0;
  o0.xyz = min(float3(65024,65024,64512), r0.xyw);
  o0.w = r0.z;
  return;
}