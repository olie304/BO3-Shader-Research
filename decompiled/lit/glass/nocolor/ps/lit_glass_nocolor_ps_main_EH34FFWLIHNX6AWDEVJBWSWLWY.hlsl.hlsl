...
r2.w = samp0[]..swiz;
  ...
  r2.z = rsqrt(r2.z);
  r3.xyz = r2.zzz * r1.xyw;
  r1.y = r0.x * r1.z + r10.y;
  r4.xyz = r1.zzz * float3(0.0799999982,0.0799999982,0.0799999982) + r12.xyz;
  ...
  r1.y = r1.x * r0.y + r0.w;
  r0.yw = r1.yy * r0.yw;
  r1.y = dot(r3.xyz, sunConstants.wldDir.xyz);
  r3.w = saturate(r1.y);
  r4.w = cmp(0 >= r3.w);
  if (r4.w != 0) {
    r5.y = 0;
  ...
  r0.xyw = r29.xyz * r4.xyz + r0.xyw;
  r0.xyw = r9.yzw * r5.xzw + r0.xyw;
  r1.x = log2(r7.w);
  r1.x = 3.4000001 * r1.x;
  r1.x = exp2(r1.x);
  r1.y = 1 + -r0.z;
