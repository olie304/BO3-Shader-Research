// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:36:10 2021
...
cbuffer _Globals : register(b0)
{
  ...
  float2 glossScale1 : packoffset(c12);
  float2 glossScale2 : packoffset(c12.z);
  float2 glossRange2 : packoffset(c13);
}
...
Texture2D<float4> glossMap2 : register(t24);
...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  r0.x = mixMap.Sample(mixSampler_s, v2.xy).x;
  r1.xyzw = glossScale1.xyzw * v2.xyxy;
  ...
  r0.z = glossMap2.Sample(specColorSampler_s, r1.zw).x;
  r0.w = glossRange2.y + -glossRange2.x;
  r0.z = r0.z * r0.w + glossRange2.x;
  ...
  r1.x = sqrt(r1.x);
  r0.w = r0.w * r0.w;
  r0.xw = float2(-17,0.333333343) * r0.xw;
  r0.w = min(1, r0.w);
  r1.y = v8.x ? 1 : -1;
  ...
  r1.z = min(15, r1.z);
  r1.z = (uint)r1.z;
  r6.xy = (uint2)r2.yx >> int2(6,6);
  r6.z = (uint)r1.z << 4;
  r1.z = numStaticDecals & -32;
  r2.z = (int)-r1.z + numStaticDecals;
  r7.xy = float2(0,0);
  r8.w = 0;
  r5.w = 1;
  r9.xyz = float3(0,0,0);
  ...
  while (true) {
    ...
    r7.z = cmp((int)r1.z == (int)r4.w);
    if (r2.z == 0) r7.w = 0; else if (r2.z+0 < 32) {     r7.w = (uint)r6.w << (32-(r2.z + 0)); r7.w = (uint)r7.w >> (32-r2.z);    } else r7.w = (uint)r6.w >> 0;
    r6.w = r7.z ? r7.w : r6.w;
    ...
    while (true) {
      ...
      r15.y = samp0[]..swiz;
        ...
        r16.z = samp0[]..swiz;
          ...
          r12.w = rsqrt(r12.w);
          r18.xyz = r17.xyz * r12.www;
          r12.w = dot(r18.xyz, v4.xyz);
          r12.w = cmp(r12.w >= 0.5);
          if (r12.w != 0) {
          // Known bad code for instruction (needs manual fix):
          ...
          r19.w = samp0[]..swiz;
            ...
            r20.z = r16.y;
            r20.w = r19.y;
            r17.y = dot(r5.xyzw, r20.xyzw);
            r19.x = r14.z;
            r19.y = r15.z;
            r19.z = r16.z;
            r17.z = dot(r5.xyzw, r19.xyzw);
            r14.xyz = cmp(abs(r17.xyz) < float3(1,1,1));
            r12.w = r14.y ? r14.x : 0;
            r12.w = r14.z ? r12.w : 0;
            if (r12.w != 0) {
            // Known bad code for instruction (needs manual fix):
            ...
            r16.z = samp0[]..swiz;
            r16.w = samp0[]..swiz;
              r21.x = dot(r3.xyz, r20.xyz);
              r21.y = dot(r3.xyz, r19.xyz);
              r22.x = dot(r4.xyz, r20.xyz);
              r22.y = dot(r4.xyz, r19.xyz);
              r17.xy = r17.yz * float2(0.5,-0.5) + float2(0.5,0.5);
              r21.xyz = float3(0.5,-0.5,0.5) * r21.xyx;
              r22.xyz = float3(0.5,-0.5,0.5) * r22.xyx;
              r17.zw = (int2)r15.yz & int2(65535,65535);
              if (r17.z != 0) {
                if (4 == 0) r12.w = 0; else if (4+24 < 32) {                 r12.w = (uint)r15.w << (32-(4 + 24)); r12.w = (uint)r12.w >> (32-4);                } else r12.w = (uint)r15.w >> 24;
                r12.w = 1 << (int)r12.w;
                r13.w = (uint)r15.w >> 28;
                r13.w = 1 << (int)r13.w;
                r18.w = cmp((int)r17.z == 4);
                if (r18.w != 0) {
                  r18.w = (int)r15.w & 4095;
                  if (12 == 0) r19.w = 0; else if (12+12 < 32) {                   r19.w = (uint)r15.w << (32-(12 + 12)); r19.w = (uint)r19.w >> (32-12);                  } else r19.w = (uint)r15.w >> 12;
                  r20.w = (int)r16.w & 1023;
                  r23.xz = (uint2)r12.ww;
                  r23.y = (uint)r13.w;
                  r24.xy = r17.xy * r23.zy + float2(0.5,0.5);
                  r24.zw = float2(-0.5,-0.5) + r23.zy;
                  r24.xy = min(r24.xy, r24.zw);
                  r25.x = (uint)r18.w;
                  r25.y = (uint)r19.w;
                  r24.xy = r25.xy + r24.xy;
                  r24.xy = invBcTexSizes.xy * r24.xy;
                  r24.z = (uint)r20.w;
                  r25.xyz = invBcTexSizes.xyx * r21.zyz;
                  r25.xyz = r25.xyz * r23.xyz;
                  r26.xyz = invBcTexSizes.xyx * r22.zyz;
                  r23.xyz = r26.xyz * r23.xyz;
                  r23.xyzw = materialTexBC7.SampleGrad(samplerLinearClamp_s, r24.xyz, r25.xyzx, r23.xyzx).xyzw;
                } else {
                  r17.z = cmp((int)r17.z == 1);
                  if (r17.z != 0) {
                    r17.z = (int)r15.w & 4095;
                    if (12 == 0) r15.w = 0; else if (12+12 < 32) {                     r15.w = (uint)r15.w << (32-(12 + 12)); r15.w = (uint)r15.w >> (32-12);                    } else r15.w = (uint)r15.w >> 12;
                    r18.w = (int)r16.w & 1023;
                    r24.xz = (uint2)r12.ww;
                    r24.y = (uint)r13.w;
                    r25.xy = r17.xy * r24.zy + float2(0.5,0.5);
                    ...
                    r23.xyzw = materialTexBC3.SampleGrad(samplerLinearClamp_s, r25.xyz, r26.xyzx, r24.xyzx).xyzw;
                  } else {
                    r23.xyzw = float4(1,1,1,1);
                  }
                }
              ...
              r13.w = cmp(r15.x != 1.000000);
              r14.w = r12.w + r14.w;
              r14.w = saturate(r14.w * r15.x + -r15.x);
              r12.w = r13.w ? r14.w : r12.w;
              if (r17.w != 0) {
                if (4 == 0) r13.w = 0; else if (4+24 < 32) {                 r13.w = (uint)r16.y << (32-(4 + 24)); r13.w = (uint)r13.w >> (32-4);                } else r13.w = (uint)r16.y >> 24;
                r13.w = 1 << (int)r13.w;
                r14.w = (uint)r16.y >> 28;
                r14.w = 1 << (int)r14.w;
                r15.x = cmp((int)r17.w == 2);
                if (r15.x != 0) {
                  r15.x = (int)r16.y & 4095;
                  if (12 == 0) r23.x = 0; else if (12+12 < 32) {                   r23.x = (uint)r16.y << (32-(12 + 12)); r23.x = (uint)r23.x >> (32-12);                  } else r23.x = (uint)r16.y >> 12;
                  if (10 == 0) r23.y = 0; else if (10+20 < 32) {                   r23.y = (uint)r16.w << (32-(10 + 20)); r23.y = (uint)r23.y >> (32-10);                  } else r23.y = (uint)r16.w >> 20;
                  r24.xz = (uint2)r13.ww;
                  r24.y = (uint)r14.w;
                  r23.zw = r17.xy * r24.zy + float2(0.5,0.5);
                  r25.xy = float2(-0.5,-0.5) + r24.zy;
                  r23.zw = min(r25.xy, r23.zw);
                  r25.x = (uint)r15.x;
                  r25.yz = (uint2)r23.xy;
                  r15.xw = r25.xy + r23.zw;
                  r25.xy = invMaskTexSizes.xy * r15.xw;
                  r23.xyz = invMaskTexSizes.xyx * r21.zyz;
                  r23.xyz = r23.xyz * r24.xyz;
                  r26.xyz = invMaskTexSizes.xyx * r22.zyz;
                  r24.xyz = r26.xyz * r24.xyz;
                  r15.x = materialTexMask.SampleGrad(samplerLinearClamp_s, r25.xyz, r23.x, r24.x).x;
                } else {
                  r15.w = cmp((int)r17.w == 4);
                  if (r15.w != 0) {
                    r15.w = (int)r16.y & 4095;
                    if (12 == 0) r17.z = 0; else if (12+12 < 32) {                     r17.z = (uint)r16.y << (32-(12 + 12)); r17.z = (uint)r17.z >> (32-12);                    } else r17.z = (uint)r16.y >> 12;
                    if (10 == 0) r17.w = 0; else if (10+20 < 32) {                     r17.w = (uint)r16.w << (32-(10 + 20)); r17.w = (uint)r17.w >> (32-10);                    } else r17.w = (uint)r16.w >> 20;
                    r23.xz = (uint2)r13.ww;
                    r23.y = (uint)r14.w;
                    r24.xy = r17.xy * r23.zy + float2(0.5,0.5);
                    r24.zw = float2(-0.5,-0.5) + r23.zy;
                    ...
                    r26.xyz = invBcTexSizes.xyx * r22.zyz;
                    r23.xyz = r26.xyz * r23.xyz;
                    r15.x = materialTexBC7.SampleGrad(samplerLinearClamp_s, r24.xyz, r25.x, r23.x).x;
                  } else {
                    r15.w = (int)r16.y & 4095;
                    if (12 == 0) r17.z = 0; else if (12+12 < 32) {                     r17.z = (uint)r16.y << (32-(12 + 12)); r17.z = (uint)r17.z >> (32-12);                    } else r17.z = (uint)r16.y >> 12;
                    if (10 == 0) r17.w = 0; else if (10+20 < 32) {                     r17.w = (uint)r16.w << (32-(10 + 20)); r17.w = (uint)r17.w >> (32-10);                    } else r17.w = (uint)r16.w >> 20;
                    ...
                    r24.z = (uint)r17.w;
                    r25.xyz = invBcTexSizes.zwz * r21.zyz;
                    r25.xyz = r25.xyz * r23.xyz;
                    r26.xyz = invBcTexSizes.zwz * r22.zyz;
                    r23.xyz = r26.xyz * r23.xyz;
                    r15.x = materialTexBC3.SampleGrad(samplerLinearClamp_s, r24.xyz, r25.x, r23.x).x;
                  }
                }
                r23.xyz = r15.xxx * float3(0.959999979,0.959999979,0.959999979) + float3(0.0399999991,0.0399999991,0.0399999991);
                r13.w = saturate(1 + -r15.x);
                r14.xyz = r14.xyz * r13.www;
              } else {
                r23.xyz = float3(0.0399999991,0.0399999991,0.0399999991);
              }
              r15.xy = (uint2)r15.zy >> int2(16,16);
              if (r15.x != 0) {
                r13.w = cmp((int)r15.x == 2);
                if (r13.w != 0) {
                // Known bad code for instruction (needs manual fix):
                                ld_structured_indexable(structured_buffer, stride=128)(mixed,mixed,mixed,mixed) r11.w, r11.w, l(112), t36.xxxx
                r11.w = samp0[]..swiz;
                  if (4 == 0) r15.z = 0; else if (4+24 < 32) {                   r15.z = (uint)r16.z << (32-(4 + 24)); r15.z = (uint)r15.z >> (32-4);                  } else r15.z = (uint)r16.z >> 24;
                  if (12 == 0) r15.w = 0; else if (12+12 < 32) {                   r15.w = (uint)r16.z << (32-(12 + 12)); r15.w = (uint)r15.w >> (32-12);                  } else r15.w = (uint)r16.z >> 12;
                  r13.w = 1 << (int)r15.z;
                  r14.w = (uint)r16.z >> 28;
                  r14.w = 1 << (int)r14.w;
                  r15.z = (int)r16.z & 4095;
                  r11.w = (int)r11.w & 1023;
                  r24.xz = (uint2)r13.ww;
                  r24.y = (uint)r14.w;
                  r16.yz = r17.xy * r24.zy + float2(0.5,0.5);
                  r17.zw = float2(-0.5,-0.5) + r24.zy;
                  r16.yz = min(r17.zw, r16.yz);
                  r25.xy = (uint2)r15.zw;
                  r15.zw = r25.xy + r16.yz;
                  r25.xy = invMaskTexSizes.xy * r15.zw;
                  r25.z = (uint)r11.w;
                  r26.xyz = invMaskTexSizes.xyx * r21.zyz;
                  r26.xyz = r26.xyz * r24.xyz;
                  r27.xyz = invMaskTexSizes.xyx * r22.zyz;
                  r24.xyz = r27.xyz * r24.xyz;
                  r11.w = materialTexMask.SampleGrad(samplerLinearClamp_s, r25.xyz, r26.x, r24.x).x;
                } else {
                  r13.w = cmp((int)r15.x == 6);
                  r11.w = r13.w ? 0 : 1;
                }
              } else {
                r11.w = 1;
              ...
              if (r15.y != 0) {
                r13.w = cmp((int)r15.y == 3);
                if (r13.w != 0) {
                  if (4 == 0) r15.x = 0; else if (4+24 < 32) {                   r15.x = (uint)r16.x << (32-(4 + 24)); r15.x = (uint)r15.x >> (32-4);                  } else r15.x = (uint)r16.x >> 24;
                  if (12 == 0) r15.y = 0; else if (12+12 < 32) {                   r15.y = (uint)r16.x << (32-(12 + 12)); r15.y = (uint)r15.y >> (32-12);                  } else r15.y = (uint)r16.x >> 12;
                  if (10 == 0) r15.z = 0; else if (10+10 < 32) {                   r15.z = (uint)r16.w << (32-(10 + 10)); r15.z = (uint)r15.z >> (32-10);                  } else r15.z = (uint)r16.w >> 10;
                  r13.w = 1 << (int)r15.x;
                  r14.w = (uint)r16.x >> 28;
                  r14.w = 1 << (int)r14.w;
                  r15.x = (int)r16.x & 4095;
                  r16.xz = (uint2)r13.ww;
                  r16.y = (uint)r14.w;
                  r17.xy = r17.xy * r16.xy + float2(0.5,0.5);
                  r17.zw = float2(-0.5,-0.5) + r16.zy;
                  r17.xy = min(r17.xy, r17.zw);
                  r24.xy = (uint2)r15.xy;
                  r15.xy = r24.xy + r17.xy;
                  r17.xy = invMaskTexSizes.zw * r15.xy;
                  r17.z = (uint)r15.z;
                  r15.xyz = invMaskTexSizes.zwz * r21.xyz;
                  r15.xyz = r15.xyz * r16.xyz;
                  r21.xyz = invMaskTexSizes.zwz * r22.xyz;
                  r16.xyz = r21.xyz * r16.xyz;
                  r15.xyz = materialTexBC7linear.SampleGrad(samplerLinearClamp_s, r17.xyz, r15.xyz, r16.xyz).xyz;
                } else {
                  r15.xyz = float3(0.5,0.5,1);
                }
                r15.xy = r15.xy * float2(1.9921875,1.9921875) + float2(-1,-1);
                r13.w = dot(r15.xy, r15.xy);
                r13.w = 1 + -r13.w;
                r13.w = max(0, r13.w);
                r13.w = sqrt(r13.w);
                r14.w = r15.z * r15.z;
                ...
                r15.z = rsqrt(r15.z);
                r16.xyz = r20.xyz * r15.zzz;
                r15.z = dot(-r19.xyz, -r19.xyz);
                r15.z = rsqrt(r15.z);
                r17.xyz = -r19.xyz * r15.zzz;
                ...
                r15.xyz = r16.xyz * r15.xxx + r15.yzw;
                r15.xyz = r18.xyz * r13.www + r15.xyz;
              ...
              r13.w = 1 + -r12.w;
              r15.xyz = r13.www * r8.xyz;
              r8.xyz = r14.xyz * r12.www + r15.xyz;
              r14.xyz = r13.xyz * r13.www;
              r13.xyz = r23.xyz * r12.www + r14.xyz;
              r7.w = r7.w * r13.w + r12.w;
              r13.w = r13.w * r9.w;
              r9.w = r11.w * r12.w + r13.w;
            }
          }
        }
      }
  ...
  r1.y = 1 + -r2.w;
  r1.x = r1.x * r1.y + r2.w;
  r0.yzw = r0.yzw * r1.yyy + r10.xyz;
  r1.z = dot(r0.yzw, r0.yzw);
  r1.z = rsqrt(r1.z);
  r4.xyz = r1.zzz * r0.yzw;
  r0.y = r0.x * r1.y + r3.w;
  r1.yzw = r1.yyy * float3(0.0799999982,0.0799999982,0.0799999982) + r11.xyz;
  ...
  r2.y = r2.y + r2.y;
  r11.xyz = r4.xyz * -r2.yyy + -r3.xyz;
  r2.y = 17 * r0.y;
  r2.y = exp2(r2.y);
  r2.y = 2 + r2.y;
  r2.y = 2 / r2.y;
  r2.z = sqrt(r2.y);
  r7.zw = float2(1,1) + -r0.yx;
  r2.w = 5 * r7.z;
  r3.w = r7.z * 5 + -2.5;
  ...
  while (true) {
    ...
    r10.y = visibleProbes.Load(r13.xyzw).x;
  // Known bad code for instruction (needs manual fix):
  ...
  r33.x = samp0[]..swiz;
  r33.y = samp0[]..swiz;
    r13.xyz = v7.xyz + -r21.yzw;
    r12.z = dot(r13.xyz, r13.xyz);
    r12.z = sqrt(r12.z);
    r12.z = cmp(probeDebugRadius >= r12.z);
  ...
  r39.w = samp0[]..swiz;
    ...
    r28.z = r29.z;
    r16.w = dot(r11.xyz, r28.xyz);
    r17.w = dot(r13.xyz, r28.xyz);
    r17.w = r17.w + -r29.w;
    r18.z = cmp(r17.w >= 0);
    r17.w = max(abs(r17.w), r3.w);
    r17.w = r18.z ? r17.w : -r17.w;
    ...
    r15.w = min(abs(r16.w), r15.w);
    r31.z = r32.x;
    r16.w = dot(r11.xyz, r31.xyz);
    r17.w = dot(r13.xyz, r31.xyz);
    r17.w = r17.w + -r32.y;
    r18.z = cmp(r17.w >= 0);
    r17.w = max(abs(r17.w), r3.w);
    r17.w = r18.z ? r17.w : -r17.w;
    ...
    r15.w = min(abs(r16.w), r15.w);
    r33.zw = r32.zw;
    r16.w = dot(r11.zxy, r33.xzw);
    r17.w = dot(r13.zxy, r33.xzw);
    r17.w = r17.w + -r33.y;
    r18.z = cmp(r17.w >= 0);
    r17.w = max(abs(r17.w), r3.w);
    r17.w = r18.z ? r17.w : -r17.w;
    ...
    r28.xyz = r11.xyz * r15.www + r28.xyz;
    ...
    r29.w = (uint)r18.w;
    r22.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r29.xyzw, r15.w).xyz;
    r27.yzw = (int3)r22.xyz & int3(-2147483648,-2147483648,-2147483648);
    r27.yzw = cmp((int3)r27.yzw == int3(2139095040,2139095040,2139095040));
    r15.w = (int)r27.z | (int)r27.y;
    r15.w = (int)r27.w | (int)r15.w;
    r22.xyz = r15.www ? float3(1,1,0) : r22.xyz;
    ...
    r29.x = dot(r4.xyz, r21.xyz);
    r29.y = dot(r4.xyz, r30.xyz);
    r29.z = dot(r4.xyz, r23.xyz);
    ...
    r27.yzw = cmp((int3)r27.yzw == int3(2139095040,2139095040,2139095040));
    r15.z = (int)r27.z | (int)r27.y;
    r15.z = (int)r27.w | (int)r15.z;
    r26.xyz = r15.zzz ? float3(1,1,0) : r26.xyz;
    r28.xyzw = r19.xyzw;
    r27.yzw = r20.yzw;
    r15.z = r8.w;
    r15.w = r10.y;
      ...
      if (r16.w != 0) {
        ...
        if (r12.z != 0) {
          ...
          r35.w = samp0[]..swiz;
            ...
            r29.x = r17.z * r17.w;
            r18.w = (uint)r16.z >> 2;
            if (1 == 0) r21.z = 0; else if (1+2 < 32) {             r21.z = (uint)r16.z << (32-(1 + 2)); r21.z = (uint)r21.z >> (32-1);            } else r21.z = (uint)r16.z >> 2;
            r22.w = (int)r18.w & 2;
            r23.w = max(r29.y, r29.x);
            r17.z = -r17.z * r17.w + 1;
            r17.z = r29.y * r17.z;
            r18.y = r22.w ? r17.z : r23.w;
            r29.xy = r21.zz ? r29.xy : r18.xy;
            r16.w = (int)r16.w + 1;
            r16.z = r18.w;
          }
  ...
  if (r8.w == 0) {
        ...
        r26.y = samp0[]..swiz;
          ...
          r33.w = samp0[]..swiz;
            ...
            r39.y = samp0[]..swiz;
              ...
              r13.z = r14.x * r26.z;
              r26.z = r34.z;
              r14.x = dot(r11.xyz, r26.xyz);
              r14.w = dot(r27.xyz, r26.xyz);
              r14.w = r14.w + -r34.w;
              r15.w = cmp(r14.w >= 0);
              r14.w = max(abs(r14.w), r3.w);
              ...
              r34.w = (uint)r14.w;
              r16.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r34.xyzw, r14.x).xyz;
              r28.xyz = (int3)r16.yzw & int3(-2147483648,-2147483648,-2147483648);
              r28.xyz = cmp((int3)r28.xyz == int3(2139095040,2139095040,2139095040));
              r14.x = (int)r28.y | (int)r28.x;
              r14.x = (int)r28.z | (int)r14.x;
              r16.yzw = r14.xxx ? float3(1,1,0) : r16.yzw;
              ...
              r25.x = r23.w;
              r25.yz = r24.xy;
              r24.xyw = r16.zwy * r13.zzz + r25.yzx;
              r23.w = r24.w;
            }
          }
        }
      ...
      while (true) {
        ...
        while (true) {
          ...
          r27.y = samp0[]..swiz;
            ...
            r26.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r27.xy, r16.z, l(96), t15.xyxx
            r27.x = samp0[]..swiz;
            r27.y = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r28.xyzw, r16.z, l(116), t15.zwxy
            r28.x = samp0[]..swiz;
            r28.y = samp0[]..swiz;
            r28.z = samp0[]..swiz;
            r28.w = samp0[]..swiz;
              r29.xyz = v7.xyz + -r26.yzw;
            ...
            r35.w = samp0[]..swiz;
              ...
              r36.w = samp0[]..swiz;
                ...
                r20.w = r24.w * r20.w;
                r24.w = dot(r34.xyz, r29.xyz);
                r24.w = saturate(r24.w + r34.w);
                r20.w = r24.w * r20.w;
                r24.w = dot(r35.xyz, r29.xyz);
                r24.w = saturate(r24.w + r35.w);
                r20.w = r24.w * r20.w;
                r24.w = dot(r36.xyz, r29.xyz);
                r24.w = saturate(r24.w + r36.w);
                r30.x = r24.w * r20.w;
                r26.w = (uint)r14.x >> 2;
                if (1 == 0) r29.w = 0; else if (1+2 < 32) {                 r29.w = (uint)r14.x << (32-(1 + 2)); r29.w = (uint)r29.w >> (32-1);                } else r29.w = (uint)r14.x >> 2;
                r30.z = (int)r26.w & 2;
                r30.w = max(r30.y, r30.x);
                r20.w = -r20.w * r24.w + 1;
                r20.w = r30.y * r20.w;
                r16.y = r30.z ? r20.w : r30.w;
                r30.xy = r29.ww ? r30.xy : r16.xy;
                r18.w = (int)r18.w + 1;
                r14.x = r26.w;
              }
              ...
              if (r16.w != 0) {
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r31.xyzw, r16.z, l(16), t15.xyzw
              r31.x = samp0[]..swiz;
              r31.y = samp0[]..swiz;
              r31.z = samp0[]..swiz;
              r31.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r32.xyzw, r16.z, l(32), t15.yxwz
              r32.x = samp0[]..swiz;
              r32.y = samp0[]..swiz;
              r32.z = samp0[]..swiz;
              r32.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r33.xyzw, r16.z, l(48), t15.xyzw
              r33.x = samp0[]..swiz;
              r33.y = samp0[]..swiz;
              r33.z = samp0[]..swiz;
              r33.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r34.xyzw, r16.z, l(64), t15.zwxy
              r34.x = samp0[]..swiz;
              r34.y = samp0[]..swiz;
              r34.z = samp0[]..swiz;
              r34.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r35.xyzw, r16.z, l(80), t15.xyzw
              r35.x = samp0[]..swiz;
              r35.y = samp0[]..swiz;
              r35.z = samp0[]..swiz;
              r35.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r36.xyzw, r16.z, l(132), t15.zwxy
              r36.x = samp0[]..swiz;
              r36.y = samp0[]..swiz;
              r36.z = samp0[]..swiz;
              r36.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r37.xyzw, r16.z, l(148), t15.zwxy
              r37.x = samp0[]..swiz;
              r37.y = samp0[]..swiz;
              r37.z = samp0[]..swiz;
              r37.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r38.xyzw, r16.z, l(164), t15.zwxy
              r38.x = samp0[]..swiz;
              r38.y = samp0[]..swiz;
              r38.z = samp0[]..swiz;
              r38.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r39.xyzw, r16.z, l(180), t15.zwxy
              r39.x = samp0[]..swiz;
              r39.y = samp0[]..swiz;
              r39.z = samp0[]..swiz;
              r39.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r40.xyzw, r16.z, l(196), t15.xyzw
              r40.x = samp0[]..swiz;
              r40.y = samp0[]..swiz;
              r40.z = samp0[]..swiz;
              r40.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r41.xy, r16.z, l(212), t15.xyxx
              r41.x = samp0[]..swiz;
              r41.y = samp0[]..swiz;
                r25.w = r14.x * r27.y + r25.w;
                r14.x = r16.y * r28.z;
                r28.z = r36.z;
                r16.y = dot(r11.xyz, r28.xyz);
                ...
                r16.y = min(r16.y, abs(r16.z));
                r38.z = r39.z;
                r16.z = dot(r11.xyz, r38.xyz);
                r16.w = dot(r29.xyz, r38.xyz);
                r16.w = r16.w + -r39.w;
                r17.w = cmp(r16.w >= 0);
                r16.w = max(abs(r16.w), r3.w);
                r16.w = r17.w ? r16.w : -r16.w;
                ...
                r16.y = min(r16.y, abs(r16.z));
                r39.z = r40.x;
                r16.z = dot(r11.xyz, r39.xyz);
                r16.w = dot(r29.xyz, r39.xyz);
                r16.w = r16.w + -r40.y;
                r17.w = cmp(r16.w >= 0);
                r16.w = max(abs(r16.w), r3.w);
                r16.w = r17.w ? r16.w : -r16.w;
                ...
                r16.y = min(r16.y, abs(r16.z));
                r41.zw = r40.zw;
                r16.z = dot(r11.zxy, r41.xzw);
                r16.w = dot(r29.zxy, r41.xzw);
                r16.w = r16.w + -r41.y;
                r17.w = cmp(r16.w >= 0);
                r16.w = max(abs(r16.w), r3.w);
                r16.w = r17.w ? r16.w : -r16.w;
                ...
                r27.xyz = r11.xyz * r16.yyy + r27.xyz;
                ...
                if (9 == 0) r16.z = 0; else if (9+16 < 32) {                 r16.z = (uint)r28.w << (32-(9 + 16)); r16.z = (uint)r16.z >> (32-9);                } else r16.z = (uint)r28.w >> 16;
                r36.w = (uint)r16.z;
                r16.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r36.xyzw, r16.y).xyz;
    ...
    r19.xyz = r21.xyz * r3.www;
    r20.xyz = r22.xyz * r3.www;
    r6.w = cmp(r22.w < 0.99000001);
    if (r6.w != 0) {
      r6.w = 1 + -r22.w;
      r7.z = sunConstants.globalProbeExposure * r6.w;
      r10.yzw = -globalProbeConstants.data[0].xyz + v7.xyz;
      r12.x = globalProbeConstants.data[0].w * r10.y;
      r12.yz = globalProbeConstants.data[1].xy * r10.zw;
      r10.yzw = saturate(float3(0.5,0.5,0.5) + r12.xyz);
      r12.xy = globalProbeConstants.data[1].zw * r10.yz;
      r12.z = globalProbeConstants.data[2].x * r10.w;
      r10.yzw = globalProbeConstants.data[2].yzw + r12.xyz;
      r12.xyz = cmp(float3(0,0,0) < r4.xyz);
      r12.xyz = r12.xyz ? float3(0,0,0) : float3(0.5,0.5,0.5);
      r12.w = 0;
      r13.xyz = r12.wwx + r10.yzw;
      r13.xyz = gProbeXArray.SampleLevel(samplerLinearClamp_s, r13.xyz, 0).xyz;
      r14.xyz = r4.xyz * r4.xyz;
      r14.xyz = r14.xyz * r7.zzz;
      r15.xyz = r12.wwy + r10.yzw;
      ...
      r10.yzw = r12.wwz + r10.yzw;
      r10.yzw = gProbeZArray.SampleLevel(samplerLinearClamp_s, r10.yzw, 0).xyz;
      r10.yzw = r10.yzw * r14.zzz + r13.xyz;
      r4.w = 0;
      r12.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r4.xyzw, 6).xyz;
      r10.yzw = r12.xyz * r10.yzw;
      r4.w = dot(r10.yzw, float3(0.212599993,0.715200007,0.0722000003));
      r19.xyz = r21.xyz * r3.www + r10.yzw;
      r11.w = 0;
      r10.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r11.xyzw, r2.w).xyz;
      r2.w = sunConstants.globalProbeExposure * r6.w + -r4.w;
      r2.w = r0.y * r2.w + r4.w;
      r20.xyz = r10.yzw * r2.www + r20.xyz;
    }
  } else {
    r20.x = r19.w;
  }
  r10.yz = r0.xy * float2(0.984375,0.984375) + float2(0.0078125,0.0078125);
  r10.yz = gEnvBRDFGlass.SampleLevel(samplerLinear_s, r10.yz, 0).xy;
  r12.xyz = r20.yzx * r10.yyy;
  r10.yzw = r20.xyz * r10.zzz;
  r0.y = sqrt(r2.z);
  r0.y = r0.y * 0.5 + 0.5;
  r0.y = r0.y * r0.y;
  r2.w = 0.5 * r0.y;
  ...
  if (r6.w == 0) {
    ...
    if (r8.w != 0) {
      ...
      while (true) {
        ...
        if (r11.w != 0) break;
        r11.w = (uint)r8.w;
        r14.xy = -sunConstants.splitPinTransform[r11.w].xy + r13.xy;
    ...
    if (r11.w == 0) {
      if (enableDitheredShadow == 0) {
        ...
        r14.z = r11.w + r8.w;
        r11.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r14.xyz, r6.w).x;
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          if (r15.y != 0) break;
          r15.y = cmp((uint)r9.w < (uint)r15.x);
          r15.zw = r15.yy ? r13.xy : r13.zw;
          r16.x = r15.y ? sunConstants.splitPinTransform[r8.w].w : sunConstants.splitPinTransform[r11.w].w;
          r15.y = r15.y ? r8.w : r11.w;
          ...
          r16.z = (uint)r15.y;
          r15.y = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r6.w).x;
  ...
  if (r6.w != 0) {
    ...
    if (r6.w != 0) {
      ...
      if (sunConstants.sunCookieIndex != 0) {
        r5.w = 1;
        r8.w = dot(sunConstants.sunCookieTransform[0].xyzw, r5.xyzw);
      ...
      r13.w = samp0[]..swiz;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r14.xyzw, r5.w, l(84), t12.xyzw
      r14.x = samp0[]..swiz;
      r14.y = samp0[]..swiz;
      r14.z = samp0[]..swiz;
      r14.w = samp0[]..swiz;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r15.xyzw, r5.w, l(132), t12.xyzw
      r15.x = samp0[]..swiz;
      r15.y = samp0[]..swiz;
      r15.z = samp0[]..swiz;
      r15.w = samp0[]..swiz;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r16.xyzw, r5.w, l(148), t12.xyzw
      r16.x = samp0[]..swiz;
      r16.y = samp0[]..swiz;
      r16.z = samp0[]..swiz;
      r16.w = samp0[]..swiz;
        r9.w = abs(r3.w) * -0.200000003 + 0.400000006;
        r17.xyz = r4.xyz * r9.www + v7.xyz;
        r17.w = 1;
        ...
        r9.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r14.xyzw, r5.w, l(100), t12.xyzw
        r14.x = samp0[]..swiz;
        r14.y = samp0[]..swiz;
        r14.z = samp0[]..swiz;
        r14.w = samp0[]..swiz;
        ...
        r13.w = samp0[]..swiz;
          ...
          if (enableDitheredShadow != 0) {
            ...
            while (true) {
              ...
              r15.xy = r16.xy * r8.ww + r14.xy;
              r14.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r15.xyz, r5.w).x;
              r11.w = r14.w * 0.125 + r11.w;
              r13.w = (int)r13.w + 1;
            }
          } else {
            r14.z = (uint)r9.w;
            r11.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r14.xyz, r5.w).x;
          }
          r5.w = r11.w * r11.w;
          r5.w = r5.w * r11.w;
        } else {
      ...
      r5.w = r5.w * r7.z;
      r3.w = cmp(0 < r3.w);
      r13.xyz = r5.www * r5.xyz + r19.xyz;
      r14.xyz = -v7.xyz * r0.zzz + sunConstants.wldDir.xyz;
      r0.z = dot(r14.xyz, r14.xyz);
      r0.z = rsqrt(r0.z);
      r14.xyz = r14.xyz * r0.zzz;
      r0.z = dot(r14.xyz, r3.xyz);
      r5.w = dot(r4.xyz, r14.xyz);
      r8.w = abs(r5.w) * r2.y + -abs(r5.w);
      r5.w = abs(r5.w) * r8.w + 1;
      r4.w = r4.w * r0.y + r2.w;
      r5.w = r5.w * r5.w;
      r4.w = r5.w * r4.w;
      r4.w = rcp(r4.w);
      ...
      r4.w = r7.z * r4.w;
      r4.w = 0.25 * r4.w;
      r14.xyz = r4.www * r5.xyz + r10.yzw;
      r0.z = saturate(1 + -r0.z);
      r0.z = log2(r0.z);
      r0.z = 3.4000001 * r0.z;
      r0.z = exp2(r0.z);
      r0.z = r4.w * r0.z;
      r5.xyz = r0.zzz * r5.yzx + r12.xyz;
      r13.w = r5.z;
      r19.w = r12.z;
      r19.xyzw = r3.wwww ? r13.xyzw : r19.xyzw;
      r5.zw = r14.xy;
      r12.zw = r10.yz;
      r5.xyzw = r3.wwww ? r5.xyzw : r12.xyzw;
      r10.w = r3.w ? r14.z : r10.w;
      r12.z = r19.w;
      r12.xy = r5.xy;
      r10.yz = r5.zw;
    }
  ...
  while (true) {
    ...
    if (r6.w != 0) break;
    r13.z = (uint)r4.w >> 5;
    r14.xyz = (int3)r6.xyz + (int3)r13.xyz;
      ...
      r32.y = samp0[]..swiz;
        ...
        r37.w = samp0[]..swiz;
          ...
          switch (r11.w) {
            ...
            r18.w = rsqrt(r13.w);
            r41.xyz = r41.xyz * r18.www;
            r18.w = dot(r4.xyz, r41.xyz);
            ...
            if (r23.w != 0) {
              ...
              if (r23.w != 0) {
                ...
                if (r23.w != 0) {
                  ...
                  r41.z = samp0[]..swiz;
                  r41.w = samp0[]..swiz;
                    r24.w = abs(r18.w) * -0.200000003 + 0.400000006;
                    r16.xyz = r4.xyz * r24.www + v7.xyz;
                    r24.w = dot(r40.xyzw, r16.xyzw);
                    r26.w = dot(r41.xyzw, r16.xyzw);
                    ...
                    r44.x = samp0[]..swiz;
                    r44.y = samp0[]..swiz;
                      r40.x = dot(r40.xyzw, r16.xyzw);
                      r40.y = dot(r41.xyzw, r16.xyzw);
                      r16.xy = r40.xy / r26.ww;
                      r16.xy = r16.xy * float2(0.5,-0.5) + float2(0.5,0.5);
                      r16.xy = r16.xy + r43.zw;
                      r16.xy = r16.xy * r43.xy;
                      r40.xy = r13.zz / r42.xz;
                      r40.zw = float2(1,1) + -r40.xy;
                      r40.zw = cmp(r16.xy >= r40.zw);
                      r40.xy = cmp(r40.xy >= r16.xy);
                      r40.xy = (int2)r40.xy | (int2)r40.zw;
                      r16.z = (int)r40.y | (int)r40.x;
                      r16.xy = saturate(r16.xy);
                      r40.xy = r16.xy * r42.xz + r42.yw;
                      r16.x = r44.y * r26.w;
                      r16.y = r44.x * r26.w + r24.w;
                      r16.x = r16.y / r16.x;
                    } else {
                      r16.z = -1;
                    }
                    ...
                    r12.w = samp0[]..swiz;
                      ...
                      if (r7.z != 0) {
                        ...
                        while (true) {
                          ...
                          if (r24.w != 0) break;
                          r42.x = dot(icb[r16.z+0].yx, r5.xw);
                          r42.y = dot(icb[r16.z+0].xy, r7.xy);
                          r41.xy = r42.xy * r13.zz + r40.xy;
                          r24.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r41.xyz, r16.x).x;
                          r16.y = r24.w * 0.125 + r16.y;
                          r16.z = (int)r16.z + 1;
                        }
                      } else {
                        r40.z = (uint)r12.w;
                        r16.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r40.xyz, r16.x).x;
                      }
                      r12.w = r16.y * r16.y;
                      r12.w = r12.w * r16.y;
                    } else {
                    ...
                    r41.z = samp0[]..swiz;
                    r41.w = samp0[]..swiz;
                      r16.x = abs(r18.w) * -0.200000003 + 0.400000006;
                      r17.xyz = r4.xyz * r16.xxx + v7.xyz;
                      r16.x = dot(r40.xyzw, r17.xyzw);
                      r16.z = dot(r41.xyzw, r17.xyzw);
                      ...
                      r12.w = samp0[]..swiz;
                        ...
                        if (r7.z != 0) {
                          ...
                          while (true) {
                            ...
                            if (r26.w != 0) break;
                            r41.x = dot(icb[r24.w+0].xy, r8.xy);
                            r41.y = dot(icb[r24.w+0].yx, r8.xz);
                            r17.xy = r41.xy * r13.zz + r40.xy;
                          ...
                          r40.z = (uint)r12.w;
                          r16.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r40.xyz, r16.x).x;
                        }
                        r12.w = r16.z * r16.z;
                        r12.w = r12.w * r16.z;
                      } else {
                  ...
                  r32.x = r31.x;
                  r13.z = cmp(0 < r18.w);
                  r17.xyz = r12.www * r32.xyz + r14.xyz;
                  r12.w = saturate(dot(r4.xyz, r39.xyz));
                  r38.xyz = r38.xyz * r11.www + r3.xyz;
                  r11.w = dot(r38.xyz, r38.xyz);
                  r11.w = rsqrt(r11.w);
                  r38.xyz = r38.xyz * r11.www;
                  r11.w = dot(r38.xyz, r3.xyz);
                  r16.x = dot(r4.xyz, r38.xyz);
                  r18.w = abs(r16.x) * r2.y + -abs(r16.x);
                  r16.x = abs(r16.x) * r18.w + 1;
                  r18.w = r12.w * r0.y + r2.w;
                  r16.x = r16.x * r16.x;
                  r16.x = r16.x * r18.w;
                  r16.x = rcp(r16.x);
                  r12.w = r12.w * r23.w;
                  ...
                  r14.xyz = r13.zzz ? r17.xyz : r14.xyz;
            ...
            break;
            case 2 :            r17.xy = r34.zw;
            r17.z = r35.w;
            r17.xyz = -v7.xyz + r17.xyz;
            r11.w = dot(r17.xyz, r17.xyz);
            r11.w = rsqrt(r11.w);
            r38.xyz = r17.xyz * r11.www;
            r12.w = dot(r4.xyz, r38.xyz);
            ...
            r39.w = samp0[]..swiz;
              ...
              r44.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r18.w, r9.w, l(236), t12.xxxx
              r18.w = samp0[]..swiz;
                ...
                r19.w = r19.w * r33.y;
                r35.w = r36.x;
                r33.x = dot(r35.xyzw, r15.xyzw);
                r45.xyz = r36.yzw;
                r45.w = r37.w;
                r33.y = dot(r45.xyzw, r15.xyzw);
                r18.xy = r33.xy / r13.ww;
                r13.w = cmp(r42.w < 0.00048828125);
                if (r13.w != 0) {
                  r43.y = r44.x;
                  r33.xy = saturate(abs(r18.xy) * r43.zw + r43.xy);
                  r33.zw = r33.xy * r33.xy;
                  r33.xy = r33.xy * float2(-2,-2) + float2(3,3);
                  r33.xy = r33.zw * r33.xy;
                  r13.w = r33.x * r33.y;
                  ...
                  r42.w = r43.y;
                  r33.xyzw = saturate(r42.xyzw * abs(r18.yyxx));
                ...
                r33.y = samp0[]..swiz;
                r33.z = samp0[]..swiz;
                  r18.w = dot(r44.yzw, r18.xyz);
                  r18.x = dot(r33.xyz, r18.xyz);
                  r33.xy = frac(r18.wx);
                  r13.w = (int)r13.w + -1;
                  r33.z = (uint)r13.w;
              ...
              if (r13.w != 0) {
                ...
                if (r13.w != 0) {
                  ...
                  r20.xyz = r4.xyz * r13.www + v7.xyz;
                  r38.xyz = r37.xyz;
                  r13.w = dot(r38.xyzw, r20.xyzw);
                  r19.w = dot(r40.xyzw, r20.xyzw);
                  r23.w = cmp(r19.w >= r13.w);
                  if (r23.w != 0) {
                  // Known bad code for instruction (needs manual fix):
                  ...
                  r39.y = samp0[]..swiz;
                    ...
                    if (r7.z != 0) {
                      ...
                      while (true) {
                        ...
                        r19.w = r24.w * 0.125 + r19.w;
                        r23.w = (int)r23.w + 1;
                      }
                    } else {
                      r20.z = (uint)r13.w;
                      r19.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r20.xyz, r9.w).x;
                    }
                    r9.w = r19.w * r19.w;
                    r9.w = r9.w * r19.w;
                  } else {
                ...
                if (r13.w != 0) {
                  r13.w = r32.x * r2.y;
                  r13.w = r13.w * r13.z;
                  if (4 == 0) r16.x = 0; else if (4+16 < 32) {                   r16.x = (uint)r32.w << (32-(4 + 16)); r16.x = (uint)r16.x >> (32-4);                  } else r16.x = (uint)r32.w >> 16;
                  r20.x = cmp(0 < (uint)r16.x);
                  r20.x = r0.w ? r20.x : 0;
                  if (r20.x != 0) {
                    r16.x = (int)r16.x + numLights;
                    r16.x = (int)r16.x + -1;
                  // Known bad code for instruction (needs manual fix):
                                    ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r20.x, r16.x, l(52), t12.xxxx
                  r20.x = samp0[]..swiz;
                  // Known bad code for instruction (needs manual fix):
                                    ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r31.xyzw, r16.x, l(68), t12.xyzw
                  r31.x = samp0[]..swiz;
                  r31.y = samp0[]..swiz;
                  r31.z = samp0[]..swiz;
                  r31.w = samp0[]..swiz;
                  // Known bad code for instruction (needs manual fix):
                                    ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r33.xyzw, r16.x, l(84), t12.xyzw
                  r33.x = samp0[]..swiz;
                  r33.y = samp0[]..swiz;
                  r33.z = samp0[]..swiz;
                  r33.w = samp0[]..swiz;
                  // Known bad code for instruction (needs manual fix):
                                    ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r34.xyzw, r16.x, l(100), t12.xyzw
                  r34.x = samp0[]..swiz;
                  r34.y = samp0[]..swiz;
                  r34.z = samp0[]..swiz;
                  r34.w = samp0[]..swiz;
                  // Known bad code for instruction (needs manual fix):
                                    ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r35.xyzw, r16.x, l(116), t12.xyzw
                  r35.x = samp0[]..swiz;
                  r35.y = samp0[]..swiz;
                  r35.z = samp0[]..swiz;
                  r35.w = samp0[]..swiz;
                  // Known bad code for instruction (needs manual fix):
                                    ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r36.xyzw, r16.x, l(132), t12.xyzw
                  r36.x = samp0[]..swiz;
                  r36.y = samp0[]..swiz;
                  r36.z = samp0[]..swiz;
                  r36.w = samp0[]..swiz;
                  // Known bad code for instruction (needs manual fix):
                                    ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r37.xyzw, r16.x, l(148), t12.xyzw
                  r37.x = samp0[]..swiz;
                  r37.y = samp0[]..swiz;
                  r37.z = samp0[]..swiz;
                  r37.w = samp0[]..swiz;
                    r20.y = abs(r12.w) * -0.200000003 + 0.400000006;
                    r21.xyz = r4.xyz * r20.yyy + v7.xyz;
                    ...
                    r21.x = samp0[]..swiz;
                    // Known bad code for instruction (needs manual fix):
                                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r31.xy, r16.x, l(164), t12.xyxx
                    r31.x = samp0[]..swiz;
                    r31.y = samp0[]..swiz;
                      ...
                      if (r7.z != 0) {
                        ...
                        while (true) {
                          ...
                          r21.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r21.xyz, r16.x).x;
                          r20.z = r21.x * 0.125 + r20.z;
                          r23.w = (int)r23.w + 1;
                        }
                      } else {
                        r32.z = (uint)r20.y;
                        r20.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r32.xyz, r16.x).x;
                      }
                      r16.x = r20.z * r20.z;
                      r16.x = r16.x * r20.z;
                    } else {
                    ...
                    if (4 == 0) r16.x = 0; else if (4+20 < 32) {                     r16.x = (uint)r32.w << (32-(4 + 20)); r16.x = (uint)r16.x >> (32-4);                    } else r16.x = (uint)r32.w >> 20;
                    r20.x = cmp(0 < (uint)r16.x);
                    r20.x = r20.x ? r0.z : 0;
                    if (r20.x != 0) {
                      r16.x = (int)r16.x + numLights;
                    ...
                    r31.w = samp0[]..swiz;
                    // Known bad code for instruction (needs manual fix):
                                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r32.xyzw, r16.x, l(84), t12.xyzw
                    r32.x = samp0[]..swiz;
                    r32.y = samp0[]..swiz;
                    r32.z = samp0[]..swiz;
                    r32.w = samp0[]..swiz;
                    // Known bad code for instruction (needs manual fix):
                                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r33.xyzw, r16.x, l(100), t12.xyzw
                    r33.x = samp0[]..swiz;
                    r33.y = samp0[]..swiz;
                    r33.z = samp0[]..swiz;
                    r33.w = samp0[]..swiz;
                    // Known bad code for instruction (needs manual fix):
                                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r34.xyzw, r16.x, l(116), t12.xyzw
                    r34.x = samp0[]..swiz;
                    r34.y = samp0[]..swiz;
                    r34.z = samp0[]..swiz;
                    r34.w = samp0[]..swiz;
                    // Known bad code for instruction (needs manual fix):
                                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r35.xyzw, r16.x, l(132), t12.xyzw
                    r35.x = samp0[]..swiz;
                    r35.y = samp0[]..swiz;
                    r35.z = samp0[]..swiz;
                    r35.w = samp0[]..swiz;
                    // Known bad code for instruction (needs manual fix):
                                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r36.xyzw, r16.x, l(148), t12.xyzw
                    r36.x = samp0[]..swiz;
                    r36.y = samp0[]..swiz;
                    r36.z = samp0[]..swiz;
                    r36.w = samp0[]..swiz;
                      r20.y = abs(r12.w) * -0.200000003 + 0.400000006;
                      r22.xyz = r4.xyz * r20.yyy + v7.xyz;
                      ...
                      if (r22.x == 0) {
                      // Known bad code for instruction (needs manual fix):
                                            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r22.x, r16.x, l(28), t12.xxxx
                      r22.x = samp0[]..swiz;
                      // Known bad code for instruction (needs manual fix):
                                            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r22.yz, r16.x, l(164), t12.xxyx
                      r22.y = samp0[]..swiz;
                      r22.z = samp0[]..swiz;
                        ...
                        if (r7.z != 0) {
                          ...
                          r31.z = (uint)r20.y;
                          r22.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r31.xyz, r16.x).x;
                        }
                        r16.x = r22.x * r22.x;
                        r16.x = r16.x * r22.x;
                      } else {
                  ...
                  r16.x = r16.x + -r13.z;
                  r16.x = r2.z * r16.x + r13.z;
                  r16.x = r16.x * r9.w;
                  r12.w = cmp(0 < r12.w);
                  r21.xyz = r16.xxx * r18.xyw + r14.xyz;
                  r17.xyz = r17.xyz * r11.www + r3.xyz;
                  r11.w = dot(r17.xyz, r17.xyz);
                  r11.w = rsqrt(r11.w);
                  r17.xyz = r17.xyz * r11.www;
                  r11.w = dot(r17.xyz, r3.xyz);
                  r16.x = dot(r4.xyz, r17.xyz);
                  r17.x = abs(r16.x) * r2.y + -abs(r16.x);
                  r16.x = abs(r16.x) * r17.x + 1;
                  r13.z = r13.z * r0.y + r2.w;
                  r16.x = r16.x * r16.x;
                  r13.z = r16.x * r13.z;
                  r13.z = rcp(r13.z);
                  r13.z = r13.z * r13.w;
                  r9.w = r13.z * r9.w;
                  r9.w = 0.25 * r9.w;
                  r17.xyz = r9.www * r18.xyw + r30.xyz;
                  r11.w = saturate(1 + -r11.w);
                  r11.w = log2(r11.w);
                  r11.w = 3.4000001 * r11.w;
                  r11.w = exp2(r11.w);
                  r9.w = r11.w * r9.w;
                  r18.xyw = r9.www * r18.xyw + r29.xyz;
                  r14.xyz = r12.www ? r21.xyz : r14.xyz;
                  r29.xyz = r12.www ? r18.xyw : r29.xyz;
                  r30.xyz = r12.www ? r17.xyz : r30.xyz;
                }
              }
            }
            break;
  ...
  r0.xyz = float3(1,1,1) + -r1.yzw;
  r0.xyz = r27.xyz * r0.xyz;
  r0.xyz = r28.xyz * r1.yzw + r0.xyz;
  r0.xyz = r26.xyz * r9.xyz + r0.xyz;
  r0.w = log2(r7.w);
  r0.w = 3.4000001 * r0.w;
  r0.w = exp2(r0.w);
  r1.y = 1 + -r1.x;
