// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:36:19 2021
...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  r0.x = mixMap.Sample(mixSampler_s, w1.xy).x;
  r1.xyzw = glossScale1.xyzw * w1.xyyz;
...
r2.z = samp0[]..swiz;
  ...
  r0.y = r0.x * r1.y + r9.y;
  r4.xyz = r1.yyy * float3(0.0799999982,0.0799999982,0.0799999982) + r12.xyz;
  ...
  r5.w = 100 * r5.w;
  r6.zw = -r2.zz * float2(10,5) + float2(6.85740995,7.08500004);
  r6.z = exp2(r6.z);
  r7.w = r4.w * r2.z;
  ...
  r21.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r22.xyzw, r6.w, l(16), t15.xyzw
  r22.x = samp0[]..swiz;
  r22.y = samp0[]..swiz;
  r22.z = samp0[]..swiz;
  r22.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r23.xyzw, r6.w, l(32), t15.yxwz
  r23.x = samp0[]..swiz;
  r23.y = samp0[]..swiz;
  r23.z = samp0[]..swiz;
  r23.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r24.xyzw, r6.w, l(48), t15.xyzw
  r24.x = samp0[]..swiz;
  r24.y = samp0[]..swiz;
  r24.z = samp0[]..swiz;
  r24.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r25.xyzw, r6.w, l(64), t15.zwxy
  r25.x = samp0[]..swiz;
  r25.y = samp0[]..swiz;
  r25.z = samp0[]..swiz;
  r25.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r26.xyzw, r6.w, l(80), t15.xyzw
  r26.x = samp0[]..swiz;
  r26.y = samp0[]..swiz;
  r26.z = samp0[]..swiz;
  r26.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r8.yz, r6.w, l(96), t15.xxyx
  r8.y = samp0[]..swiz;
  r8.z = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r27.xyzw, r6.w, l(116), t15.xyzw
  r27.x = samp0[]..swiz;
  r27.y = samp0[]..swiz;
  r27.z = samp0[]..swiz;
  r27.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r28.xyzw, r6.w, l(132), t15.zwxy
  r28.x = samp0[]..swiz;
  r28.y = samp0[]..swiz;
  r28.z = samp0[]..swiz;
  r28.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r29.xyzw, r6.w, l(148), t15.zwxy
  r29.x = samp0[]..swiz;
  r29.y = samp0[]..swiz;
  r29.z = samp0[]..swiz;
  r29.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r30.xyzw, r6.w, l(164), t15.zwxy
  r30.x = samp0[]..swiz;
  r30.y = samp0[]..swiz;
  r30.z = samp0[]..swiz;
  r30.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r31.xyzw, r6.w, l(180), t15.zwxy
  r31.x = samp0[]..swiz;
  r31.y = samp0[]..swiz;
  r31.z = samp0[]..swiz;
  r31.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r32.xyzw, r6.w, l(196), t15.xyzw
  r32.x = samp0[]..swiz;
  r32.y = samp0[]..swiz;
  r32.z = samp0[]..swiz;
  r32.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r33.xy, r6.w, l(212), t15.xyxx
  r33.x = samp0[]..swiz;
  r33.y = samp0[]..swiz;
    r9.yzw = v6.xyz + -r21.yzw;
    r8.w = dot(r9.yzw, r9.yzw);
    r8.w = sqrt(r8.w);
    r8.w = cmp(probeDebugRadius >= r8.w);
    r10.w = (int)r27.y & 0x0000ffff;
  // Known bad code for instruction (needs manual fix):
  ...
  r39.z = samp0[]..swiz;
  r39.w = samp0[]..swiz;
    r12.w = dot(r34.xyz, r9.yzw);
    r12.w = saturate(r12.w + r34.w);
    r13.z = dot(r35.xyz, r9.yzw);
    r13.z = saturate(r13.z + r35.w);
    r12.w = r13.z * r12.w;
    r13.z = dot(r36.xyz, r9.yzw);
    r13.z = saturate(r13.z + r36.w);
    r12.w = r13.z * r12.w;
    r13.z = dot(r37.xyz, r9.yzw);
    r13.z = saturate(r13.z + r37.w);
    r12.w = r13.z * r12.w;
    r13.z = dot(r38.xyz, r9.yzw);
    r13.z = saturate(r13.z + r38.w);
    r12.w = r13.z * r12.w;
    r13.z = dot(r39.xyz, r9.yzw);
    r13.z = saturate(r13.z + r39.w);
    r15.x = r13.z * r12.w;
    r12.w = (int)r8.y & 1;
    r13.zw = r12.ww ? r15.xy : r15.zx;
    r14.xy = r27.zw;
    r14.z = r28.z;
    r12.w = dot(r11.xyz, r14.xyz);
    r14.x = dot(r9.yzw, r14.xyz);
    r14.x = r14.x + -r28.w;
    r14.y = cmp(r14.x >= 0);
    r14.x = max(abs(r14.x), r5.w);
    r14.x = r14.y ? r14.x : -r14.x;
    r12.w = max(1.00000001e-07, -r12.w);
    r12.w = r14.x / r12.w;
    r12.w = min(131072, abs(r12.w));
    r28.z = r29.z;
    r14.x = dot(r11.xyz, r28.xyz);
    r14.y = dot(r9.yzw, r28.xyz);
    r14.y = r14.y + -r29.w;
    r14.z = cmp(r14.y >= 0);
    ...
    r14.x = r14.y / r14.x;
    r12.w = min(abs(r14.x), r12.w);
    r29.z = r30.z;
    r14.x = dot(r11.xyz, r29.xyz);
    r14.y = dot(r9.yzw, r29.xyz);
    r14.y = r14.y + -r30.w;
    r14.z = cmp(r14.y >= 0);
    r14.y = max(abs(r14.y), r5.w);
    r14.y = r14.z ? r14.y : -r14.y;
    ...
    r12.w = min(abs(r14.x), r12.w);
    r30.z = r31.z;
    r14.x = dot(r11.xyz, r30.xyz);
    r14.y = dot(r9.yzw, r30.xyz);
    r14.y = r14.y + -r31.w;
    r14.z = cmp(r14.y >= 0);
    r14.y = max(abs(r14.y), r5.w);
    r14.y = r14.z ? r14.y : -r14.y;
    ...
    r12.w = min(abs(r14.x), r12.w);
    r31.z = r32.x;
    r14.x = dot(r11.xyz, r31.xyz);
    r14.y = dot(r9.yzw, r31.xyz);
    r14.y = r14.y + -r32.y;
    r14.z = cmp(r14.y >= 0);
    r14.y = max(abs(r14.y), r5.w);
    r14.y = r14.z ? r14.y : -r14.y;
    ...
    r12.w = min(abs(r14.x), r12.w);
    r33.zw = r32.zw;
    r14.x = dot(r11.zxy, r33.xzw);
    r14.y = dot(r9.wyz, r33.xzw);
    r14.y = r14.y + -r33.y;
    r14.z = cmp(r14.y >= 0);
    r14.y = max(abs(r14.y), r5.w);
    r14.y = r14.z ? r14.y : -r14.y;
    ...
    r14.xyz = r11.xyz * r12.www + r14.xyz;
    ...
    if (9 == 0) r14.y = 0; else if (9+16 < 32) {     r14.y = (uint)r27.y << (32-(9 + 16)); r14.y = (uint)r14.y >> (32-9);    } else r14.y = (uint)r27.y >> 16;
    r28.w = (uint)r14.y;
    r22.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r28.xyzw, r12.w).xyz;
    r27.yzw = (int3)r22.xyz & int3(-2147483648,-2147483648,-2147483648);
    r27.yzw = cmp((int3)r27.yzw == int3(2139095040,2139095040,2139095040));
    r12.w = (int)r27.z | (int)r27.y;
    r12.w = (int)r27.w | (int)r12.w;
    r22.xyz = r12.www ? float3(1,1,0) : r22.xyz;
    r30.x = dot(r9.yzw, r21.xyz);
    r30.y = dot(r9.yzw, r29.xyz);
    r30.z = dot(r9.yzw, r23.xyz);
    r24.xyz = saturate(r30.xyz * r24.xyz + float3(0.5,0.5,0.5));
    r25.z = r26.x;
    r24.xyz = r24.xyz * r25.xyz + r26.yzw;
    r28.x = dot(r3.xyz, r21.xyz);
    r28.y = dot(r3.xyz, r29.xyz);
    r28.z = dot(r3.xyz, r23.xyz);
    r21.xyz = cmp(float3(0,0,0) < r28.xyz);
    r16.z = r21.x ? 0 : 0.5;
    ...
    r25.xyz = r28.xyz * r28.xyz;
    r26.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r28.xyzw, 6).xyz;
    ...
    while (true) {
      ...
      if (r15.x != 0) {
        ...
        if (r8.w != 0) {
          ...
          r15.x = 1;
          while (true) {
            r15.w = cmp((int)r15.x >= (int)r14.x);
            if (r15.w != 0) break;
            r15.w = (int)r10.w + (int)r15.x;
          // Known bad code for instruction (needs manual fix):
          ...
          r35.z = samp0[]..swiz;
          r35.w = samp0[]..swiz;
            r15.w = dot(r30.xyz, r9.yzw);
            r15.w = saturate(r15.w + r30.w);
            r15.w = r29.x * r15.w;
            r16.z = dot(r31.xyz, r9.yzw);
            r16.z = saturate(r16.z + r31.w);
            r15.w = r16.z * r15.w;
            r16.z = dot(r32.xyz, r9.yzw);
            r16.z = saturate(r16.z + r32.w);
            r15.w = r16.z * r15.w;
            r16.z = dot(r33.xyz, r9.yzw);
            r16.z = saturate(r16.z + r33.w);
            r15.w = r16.z * r15.w;
            r16.z = dot(r34.xyz, r9.yzw);
            r16.z = saturate(r16.z + r34.w);
            r15.w = r16.z * r15.w;
            r16.z = dot(r35.xyz, r9.yzw);
            r16.z = saturate(r16.z + r35.w);
            r29.x = r16.z * r15.w;
            r16.w = (uint)r14.z >> 2;
            if (1 == 0) r17.z = 0; else if (1+2 < 32) {             r17.z = (uint)r14.z << (32-(1 + 2)); r17.z = (uint)r17.z >> (32-1);            } else r17.z = (uint)r14.z >> 2;
            r17.w = (int)r16.w & 2;
            r18.z = max(r29.y, r29.x);
            r15.w = -r15.w * r16.z + 1;
            r15.w = r29.y * r15.w;
            r2.y = r17.w ? r15.w : r18.z;
            r29.xy = r17.zz ? r29.xy : r2.xy;
            r15.x = (int)r15.x + 1;
            r14.z = r16.w;
          }
          ...
          if (r14.z != 0) {
            ...
            r2.y = r2.y * r27.x;
            r29.xzw = r25.xyz * r2.yyy;
            r31.xyz = r29.zzz * r21.xyw;
            r31.xyz = r23.xyz * r29.xxx + r31.xyz;
            r29.xzw = r24.xyz * r29.www + r31.xyz;
            r31.xyz = r29.xzw * r26.xyz;
            r14.z = dot(r31.xyz, float3(0.212599993,0.715200007,0.0722000003));
            r31.xyz = r29.xzw * r26.xyz + r28.xyz;
            r15.x = r14.z * r6.z;
            r29.xzw = r22.xyz * r2.yyy;
            r2.y = dot(r29.xzw, float3(0.212599993,0.715200007,0.0722000003));
            r2.y = r6.z * r14.z + r2.y;
            r2.y = r15.x / r2.y;
            r32.x = r28.w;
            r32.yz = r27.yz;
            r30.xyw = r29.zwx * r2.yyy + r32.yzx;
            r31.w = r30.w;
          } else {
            r31.xyzw = r28.xyzw;
            r30.xyz = r27.yzw;
  ...
  if (r1.z == 0) {
    ...
    while (true) {
      ...
      bitmask.y = ((~(-1 << r2.y)) << 0) & 0xffffffff;  r9.y = (((uint)0 << 0) & bitmask.y) | ((uint)r8.z & ~bitmask.y);
      r8.z = r8.w ? r9.y : r8.z;
      r8.w = cmp((int)r6.w == (int)r8.y);
      ...
      while (true) {
        ...
        r9.w = 1 << (int)r9.z;
        r10.w = (int)r9.w & (int)r9.y;
        if (r10.w != 0) {
          r9.y = (int)r9.w ^ (int)r9.y;
          r9.w = (int)r8.w + (int)r9.z;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=80)(mixed,mixed,mixed,mixed) r26.xyzw, r9.w, l(0), t11.xyzw
        r26.x = samp0[]..swiz;
        r26.y = samp0[]..swiz;
        r26.z = samp0[]..swiz;
        r26.w = samp0[]..swiz;
        ...
        r14.y = samp0[]..swiz;
          ...
          r9.w = r14.z ? r9.w : 0;
          if (r9.w != 0) {
            r9.z = (int)r8.y + (int)r9.z;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r26.xyzw, r9.z, l(0), t15.wxyz
          r26.x = samp0[]..swiz;
          r26.y = samp0[]..swiz;
          r26.z = samp0[]..swiz;
          r26.w = samp0[]..swiz;
          ...
          r13.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r27.xyzw, r9.z, l(116), t15.zwxy
          r27.x = samp0[]..swiz;
          r27.y = samp0[]..swiz;
          r27.z = samp0[]..swiz;
          r27.w = samp0[]..swiz;
            r14.xyz = v6.xyz + -r26.yzw;
            r9.w = (int)r27.w & 0x0000ffff;
            if (6 == 0) r10.w = 0; else if (6+25 < 32) {             r10.w = (uint)r27.w << (32-(6 + 25)); r10.w = (uint)r10.w >> (32-6);            } else r10.w = (uint)r27.w >> 25;
          // Known bad code for instruction (needs manual fix):
          ...
          r33.w = samp0[]..swiz;
            ...
            r12.w = r15.w * r12.w;
            r15.w = dot(r32.xyz, r14.xyz);
            r15.w = saturate(r15.w + r32.w);
            r12.w = r15.w * r12.w;
            r15.w = dot(r33.xyz, r14.xyz);
            r15.w = saturate(r15.w + r33.w);
            r15.x = r15.w * r12.w;
            r12.w = (int)r13.z & 1;
            r15.xw = r12.ww ? r15.xy : r15.zx;
            r12.w = r13.z;
            r28.xy = r15.xw;
            r16.w = 1;
            while (true) {
              r17.z = cmp((int)r16.w >= (int)r10.w);
              if (r17.z != 0) break;
              r17.z = (int)r9.w + (int)r16.w;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r29.xyzw, r17.z, l(0), t16.xyzw
            r29.x = samp0[]..swiz;
            r29.y = samp0[]..swiz;
            r29.z = samp0[]..swiz;
            r29.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r30.xyzw, r17.z, l(16), t16.xyzw
            r30.x = samp0[]..swiz;
            r30.y = samp0[]..swiz;
            r30.z = samp0[]..swiz;
            r30.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r31.xyzw, r17.z, l(32), t16.xyzw
            r31.x = samp0[]..swiz;
            r31.y = samp0[]..swiz;
            r31.z = samp0[]..swiz;
            r31.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r32.xyzw, r17.z, l(48), t16.xyzw
            r32.x = samp0[]..swiz;
            r32.y = samp0[]..swiz;
            r32.z = samp0[]..swiz;
            r32.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r33.xyzw, r17.z, l(64), t16.xyzw
            r33.x = samp0[]..swiz;
            r33.y = samp0[]..swiz;
            r33.z = samp0[]..swiz;
            r33.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r34.xyzw, r17.z, l(80), t16.xyzw
            r34.x = samp0[]..swiz;
            r34.y = samp0[]..swiz;
            r34.z = samp0[]..swiz;
            r34.w = samp0[]..swiz;
              ...
              r17.z = -r17.z * r17.w + 1;
              r17.z = r28.y * r17.z;
              r17.y = r26.w ? r17.z : r28.z;
              r28.xy = r21.ww ? r28.xy : r17.xy;
              r16.w = (int)r16.w + 1;
              r12.w = r18.w;
            }
            ...
            if (r10.w != 0) {
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r29.xyzw, r9.z, l(16), t15.xyzw
            r29.x = samp0[]..swiz;
            r29.y = samp0[]..swiz;
            r29.z = samp0[]..swiz;
            r29.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r30.xyzw, r9.z, l(32), t15.yxwz
            r30.x = samp0[]..swiz;
            r30.y = samp0[]..swiz;
            r30.z = samp0[]..swiz;
            r30.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r31.xyzw, r9.z, l(48), t15.xyzw
            r31.x = samp0[]..swiz;
            r31.y = samp0[]..swiz;
            r31.z = samp0[]..swiz;
            r31.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r32.xyzw, r9.z, l(64), t15.zwxy
            r32.x = samp0[]..swiz;
            r32.y = samp0[]..swiz;
            r32.z = samp0[]..swiz;
            r32.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r33.xyzw, r9.z, l(80), t15.xyzw
            r33.x = samp0[]..swiz;
            r33.y = samp0[]..swiz;
            r33.z = samp0[]..swiz;
            r33.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r34.xyzw, r9.z, l(132), t15.zwxy
            r34.x = samp0[]..swiz;
            r34.y = samp0[]..swiz;
            r34.z = samp0[]..swiz;
            r34.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r35.xyzw, r9.z, l(148), t15.zwxy
            r35.x = samp0[]..swiz;
            r35.y = samp0[]..swiz;
            r35.z = samp0[]..swiz;
            r35.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r36.xyzw, r9.z, l(164), t15.zwxy
            r36.x = samp0[]..swiz;
            r36.y = samp0[]..swiz;
            r36.z = samp0[]..swiz;
            r36.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r37.xyzw, r9.z, l(180), t15.zwxy
            r37.x = samp0[]..swiz;
            r37.y = samp0[]..swiz;
            r37.z = samp0[]..swiz;
            r37.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r38.xyzw, r9.z, l(196), t15.xyzw
            r38.x = samp0[]..swiz;
            r38.y = samp0[]..swiz;
            r38.z = samp0[]..swiz;
            r38.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r39.xy, r9.z, l(212), t15.xyxx
            r39.x = samp0[]..swiz;
            r39.y = samp0[]..swiz;
              r25.z = r28.y * r13.w + r25.z;
              r9.z = r9.w * r27.z;
              r27.z = r34.z;
              r9.w = dot(r11.xyz, r27.xyz);
              ...
              r9.w = min(abs(r10.w), r9.w);
              r36.z = r37.z;
              r10.w = dot(r11.xyz, r36.xyz);
              r12.w = dot(r14.xyz, r36.xyz);
              r12.w = r12.w + -r37.w;
              r13.z = cmp(r12.w >= 0);
              r12.w = max(abs(r12.w), r5.w);
              r12.w = r13.z ? r12.w : -r12.w;
              ...
              r9.w = min(abs(r10.w), r9.w);
              r37.z = r38.x;
              r10.w = dot(r11.xyz, r37.xyz);
              r12.w = dot(r14.xyz, r37.xyz);
              r12.w = r12.w + -r38.y;
              r13.z = cmp(r12.w >= 0);
              r12.w = max(abs(r12.w), r5.w);
              r12.w = r13.z ? r12.w : -r12.w;
              ...
              r9.w = min(abs(r10.w), r9.w);
              r39.zw = r38.zw;
              r10.w = dot(r11.zxy, r39.xzw);
              r12.w = dot(r14.zxy, r39.xzw);
              r12.w = r12.w + -r39.y;
              r13.z = cmp(r12.w >= 0);
              r12.w = max(abs(r12.w), r5.w);
              r12.w = r13.z ? r12.w : -r12.w;
              ...
              r17.yzw = r11.xyz * r9.www + r17.yzw;
              ...
              if (9 == 0) r10.w = 0; else if (9+16 < 32) {               r10.w = (uint)r27.w << (32-(9 + 16)); r10.w = (uint)r10.w >> (32-9);              } else r10.w = (uint)r27.w >> 16;
              r34.w = (uint)r10.w;
              r17.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r34.xyzw, r9.w).xyz;
              r28.xzw = (int3)r17.yzw & int3(-2147483648,-2147483648,-2147483648);
              r28.xzw = cmp((int3)r28.xzw == int3(2139095040,2139095040,2139095040));
              r9.w = (int)r28.z | (int)r28.x;
              r9.w = (int)r28.w | (int)r9.w;
              r17.yzw = r9.www ? float3(1,1,0) : r17.yzw;
              ...
              r9.w = (int)r27.y | (int)r27.x;
              r9.w = (int)r27.z | (int)r9.w;
              ...
              r10.w = r9.w * r6.z;
              r14.xyz = r17.yzw * r9.zzz;
              r9.z = dot(r14.xyz, float3(0.212599993,0.715200007,0.0722000003));
              r9.z = r6.z * r9.w + r9.z;
              r9.z = r10.w / r9.z;
              r26.x = r24.w;
              r26.yz = r25.xy;
              r25.xyw = r14.yzx * r9.zzz + r26.yzx;
              r24.w = r25.w;
            }
          }
        }
    ...
    if (r6.w != 0) {
      ...
      r7.w = 0;
      while (true) {
        r9.y = cmp((uint)r7.w >= (uint)r1.z);
        if (r9.y != 0) break;
        r13.z = (uint)r7.w >> 5;
        r14.xyz = (int3)r12.xyz + (int3)r13.xyz;
        r9.y = visibleProbes.Load(r14.xyzw).x;
        r9.z = cmp((int)r2.x == (int)r7.w);
        if (r2.y == 0) r9.w = 0; else if (r2.y+0 < 32) {         r9.w = (uint)r9.y << (32-(r2.y + 0)); r9.w = (uint)r9.w >> (32-r2.y);        } else r9.w = (uint)r9.y >> 0;
        r9.y = r9.z ? r9.w : r9.y;
        ...
        while (true) {
          ...
          r26.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=80)(mixed,mixed,mixed,mixed) r27.xy, r13.z, l(16), t11.xyxx
          r27.x = samp0[]..swiz;
          r27.y = samp0[]..swiz;
            r26.xyz = -v6.xyz + r26.xyz;
            r27.z = r26.w;
            ...
            r34.w = samp0[]..swiz;
              ...
              r40.y = samp0[]..swiz;
                ...
                r35.w = (uint)r13.w;
                r17.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r35.xyzw, r13.z).xyz;
                r29.xzw = (int3)r17.yzw & int3(-2147483648,-2147483648,-2147483648);
                r29.xzw = cmp((int3)r29.xzw == int3(2139095040,2139095040,2139095040));
                r13.z = (int)r29.z | (int)r29.x;
                r13.z = (int)r29.w | (int)r13.z;
                ...
                r27.xyz = r13.zzz ? float3(1,1,0) : r27.xyz;
                ...
                r12.w = r6.z * r13.z + r12.w;
                r12.w = r13.w / r12.w;
                r25.xyz = r17.yzw * r12.www + r25.xyz;
              }
            }
          }
        }
    ...
    r2.x = cmp(r23.w < 0.99000001);
    if (r2.x != 0) {
      r2.x = 1 + -r23.w;
      r2.y = sunConstants.globalProbeExposure * r2.x;
      r8.yzw = -globalProbeConstants.data[0].xyz + v6.xyz;
      r13.x = globalProbeConstants.data[0].w * r8.y;
      r13.yz = globalProbeConstants.data[1].xy * r8.zw;
      r8.yzw = saturate(float3(0.5,0.5,0.5) + r13.xyz);
      r13.xy = globalProbeConstants.data[1].zw * r8.yz;
      r13.z = globalProbeConstants.data[2].x * r8.w;
      r8.yzw = globalProbeConstants.data[2].yzw + r13.xyz;
      r9.yzw = cmp(float3(0,0,0) < r3.xyz);
      r13.xyz = r9.yzw ? float3(0,0,0) : float3(0.5,0.5,0.5);
      r13.w = 0;
      r9.yzw = r13.wwx + r8.yzw;
      r9.yzw = gProbeXArray.SampleLevel(samplerLinearClamp_s, r9.yzw, 0).xyz;
      r14.xyz = r3.xyz * r3.xyz;
      r14.xyz = r14.xyz * r2.yyy;
      r15.xyz = r13.wwy + r8.yzw;
      r15.xyz = gProbeYArray.SampleLevel(samplerLinearClamp_s, r15.xyz, 0).xyz;
      r15.xyz = r15.xyz * r14.yyy;
      r9.yzw = r9.yzw * r14.xxx + r15.xyz;
      r8.yzw = r13.wwz + r8.yzw;
      r8.yzw = gProbeZArray.SampleLevel(samplerLinearClamp_s, r8.yzw, 0).xyz;
      r8.yzw = r8.yzw * r14.zzz + r9.yzw;
      r3.w = 0;
      r9.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r3.xyzw, 6).xyz;
      r8.yzw = r9.yzw * r8.yzw;
      r2.y = dot(r8.yzw, float3(0.212599993,0.715200007,0.0722000003));
      r19.xyz = r22.xyz * r1.zzz + r8.yzw;
      r11.w = 0;
      r8.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r11.xyzw, r4.w).xyz;
      r1.z = sunConstants.globalProbeExposure * r2.x + -r2.y;
      r1.z = r0.y * r1.z + r2.y;
      r20.xyz = r8.yzw * r1.zzz + r20.xyz;
    }
  } else {
    r20.x = r19.w;
  }
  r2.xy = r0.xy * float2(0.984375,0.984375) + float2(0.0078125,0.0078125);
  r2.xy = gEnvBRDFGlass.SampleLevel(samplerLinear_s, r2.xy, 0).xy;
  r13.xyz = r20.yzx * r2.xxx;
  r2.xyz = r20.xyz * r2.yyy;
  r0.y = sqrt(r1.w);
  r0.y = r0.y * 0.5 + 0.5;
  r0.y = r0.y * r0.y;
  r1.z = 0.5 * r0.y;
  ...
  if (r5.w == 0) {
    ...
    if (r6.w != 0) {
      ...
      while (true) {
        ...
        if (r9.y != 0) break;
        r9.y = (uint)r6.w;
        r9.zw = -sunConstants.splitPinTransform[r9.y].xy + r8.yz;
        r9.z = max(abs(r9.z), abs(r9.w));
        r7.w = sunConstants.splitPinTransform[r9.y].z * r9.z;
        r9.y = cmp(r7.w < 1);
        if (r9.y != 0) {
          break;
        }
    ...
    if (r9.y != 0) {
      ...
      r9.zw = sunConstants.sstLightingConstants.coordScale * r14.zy;
      r9.zw = floor(r9.zw);
    ...
    r9.w = samp0[]..swiz;
      ...
      if (r10.w == 0) {
        ...
        r15.x = (int)r9.z + (int)r10.w;
        r9.z = (uint)r9.w >> 25;
        r9.z = (uint)r9.z;
        r14.xyz = r14.xyz * r9.zzz;
      ...
      r17.w = samp0[]..swiz;
        r16.xyz = r12.www ? r16.xyz : r17.xzw;
        r15.xyz = r10.www ? r15.xyz : r16.xyz;
        r9.z = (int)r15.z & 0xc0000000;
        if (r9.z == 0) {
          r9.z = (int)-r15.y + 6;
          r9.zw = (uint2)r14.zy >> (uint2)r9.zz;
        ...
        r18.y = samp0[]..swiz;
          r9.zw = r12.ww ? r17.xz : r18.xy;
          r15.xz = r10.ww ? r16.xw : r9.zw;
        }
        r9.z = (int)r15.z & 0xc0000000;
        if (r9.z == 0) {
        ...
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r12.w, r12.w, l(0), t23.xxxx
        r12.w = samp0[]..swiz;
          bitmask.x = ((~(-1 << 2)) << 3) & 0xffffffff;  r14.x = (((uint)r14.x << 3) & bitmask.x) | ((uint)0 & ~bitmask.x);
          bitmask.y = ((~(-1 << 2)) << 1) & 0xffffffff;  r14.y = (((uint)r14.y << 1) & bitmask.y) | ((uint)0 & ~bitmask.y);
          bitmask.w = ((~(-1 << 1)) << 4) & 0xffffffff;  r14.w = (((uint)r14.z << 4) & bitmask.w) | ((uint)0 & ~bitmask.w);
          r12.w = (uint)r12.w >> (uint)r14.x;
          r12.w = (int)r12.w & 255;
          r12.w = (uint)r12.w;
          r12.w = r12.w * r10.w;
          r12.w = r12.w * 0.00392156886 + r9.w;
          r14.x = (int)r14.y + 1;
          if (1 == 0) r14.y = 0; else if (1+1 < 32) {           r14.y = (uint)r14.z << (32-(1 + 1)); r14.y = (uint)r14.y >> (32-1);          } else r14.y = (uint)r14.z >> 1;
          r14.x = (int)r14.y + (int)r14.x;
          r14.x = (int)r14.x + (int)r15.x;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r14.x, r14.x, l(0), t23.xxxx
        r14.x = samp0[]..swiz;
          r14.x = (uint)r14.x >> (uint)r14.w;
          r14.x = (int)r14.x & 0x0000ffff;
          r14.x = (uint)r14.x;
          r10.w = r14.x * r10.w;
          r9.w = r10.w * 1.52590219e-05 + r9.w;
          r11.w = r15.w ? r12.w : r9.w;
        } else {
        ...
        r10.w = samp0[]..swiz;
          ...
          r9.w = f16tof32(r9.w);
          r10.w = r8.y * r12.w + r10.w;
          r9.w = r8.z * r9.w + r10.w;
          r11.w = r9.z ? r9.w : r11.w;
        }
      }
    ...
    if (r9.y == 0) {
      if (enableDitheredShadow == 0) {
        r8.w = (uint)r6.w;
        r9.yz = -sunConstants.splitPinTransform[r8.w].xy + r8.yz;
        r9.yz = sunConstants.splitPinTransform[r8.w].zz * r9.yz;
        r14.xy = r9.yz * float2(0.5,-0.5) + float2(0.5,0.5);
        r8.w = (int16)sunConstants.splitArrayOffset;
        r14.z = r8.w + r6.w;
        r8.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r14.xyz, r5.w).x;
        r9.y = gTransShadowmapArray.SampleLevel(samp0_s, r14.xyz, 0).x;
        r8.w = r9.y + r8.w;
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          r15.xy = r16.xy * r12.ww + r15.xy;
          r11.w = (int)r11.w + (int16)sunConstants.splitArrayOffset;
          r15.z = (uint)r11.w;
          r11.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r15.xyz, r5.w).x;
  ...
  if (r5.w != 0) {
    ...
    if (r5.w != 0) {
      ...
      if (sunConstants.sunCookieIndex != 0) {
        ...
        r14.w = 1;
        r6.w = dot(sunConstants.sunCookieTransform[0].xyzw, r14.xyzw);
      ...
      r17.z = samp0[]..swiz;
      r17.w = samp0[]..swiz;
        r9.y = abs(r3.w) * -0.200000003 + 0.400000006;
        r18.xyz = r3.xyz * r9.yyy + v6.xyz;
        r18.w = 1;
        r14.x = dot(r14.xyzw, r18.xyzw);
        r14.y = dot(r15.xyzw, r18.xyzw);
        r9.yz = r14.xy * float2(0.5,-0.5) + float2(0.5,0.5);
        r9.yz = r9.yz + r17.zw;
        r9.yz = r9.yz * r17.xy;
        r14.xy = r7.ww / r16.xz;
        r14.zw = float2(1,1) + -r14.xy;
        r14.zw = cmp(r9.yz >= r14.zw);
        r14.xy = cmp(r14.xy >= r9.yz);
        ...
        r15.y = samp0[]..swiz;
          ...
          r14.xy = r9.yz * r16.xz + r16.yw;
          r6.w = r6.w + r15.x;
          r6.w = r6.w / r15.y;
          r6.w = max(6.10351563e-05, r6.w);
          r9.y = (int)r9.w & 0x0000ffff;
          if (enableDitheredShadow != 0) {
            r15.x = -r6.x;
            r16.z = (uint)r9.y;
            r15.y = r7.x;
            ...
            r14.z = (uint)r9.y;
            r9.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r14.xyz, r6.w).x;
          }
          r6.w = r9.z * r9.z;
          r6.w = r6.w * r9.z;
        } else {
      ...
      r6.w = r6.w * r6.z;
      r3.w = cmp(0 < r3.w);
      r14.xyz = r6.www * r8.yzw + r19.xyz;
      r9.yzw = -v6.xyz * r0.zzz + sunConstants.wldDir.xyz;
      r0.z = dot(r9.yzw, r9.yzw);
      r0.z = rsqrt(r0.z);
      r9.yzw = r9.yzw * r0.zzz;
      r0.z = dot(r9.yzw, r5.xyz);
      r6.w = dot(r3.xyz, r9.yzw);
      r7.w = abs(r6.w) * r1.y + -abs(r6.w);
      ...
      r4.w = r6.z * r4.w;
      r4.w = 0.25 * r4.w;
      r9.yzw = r4.www * r8.yzw + r2.xyz;
      r0.z = saturate(1 + -r0.z);
      r0.z = log2(r0.z);
      r0.z = 3.4000001 * r0.z;
      r0.z = exp2(r0.z);
      r0.z = r4.w * r0.z;
      r15.xyz = r0.zzz * r8.zwy + r13.xyz;
      r14.w = r15.z;
      r19.w = r13.z;
      r19.xyzw = r3.wwww ? r14.xyzw : r19.xyzw;
      r15.zw = r9.yz;
      r13.zw = r2.xy;
  ...
  while (true) {
    ...
    while (true) {
      ...
      r32.y = samp0[]..swiz;
        ...
        r37.z = samp0[]..swiz;
        r37.w = samp0[]..swiz;
          if (3 == 0) r10.w = 0; else if (3+24 < 32) {           r10.w = (uint)r32.w << (32-(3 + 24)); r10.w = (uint)r10.w >> (32-3);          } else r10.w = (uint)r32.w >> 24;
          switch (r10.w) {
            case 4 :            r10.w = cmp(0 < r37.x);
            r38.xy = r36.zw;
            r38.z = r37.w;
            ...
            r41.xyz = r10.www ? r41.xyz : r31.yzw;
            r41.xyz = -v6.xyz + r41.xyz;
            r13.w = dot(r41.xyz, r41.xyz);
            r15.z = rsqrt(r13.w);
            r41.xyz = r41.xyz * r15.zzz;
            r15.z = dot(r3.xyz, r41.xyz);
            ...
            if (r19.w != 0) {
              ...
              r13.w = r21.w / r13.w;
              r13.w = min(1, r13.w);
              r41.xy = saturate(r19.ww * r33.xz + r33.yw);
              ...
              r19.w = cmp(0 < r13.w);
              if (r19.w != 0) {
                if (3 == 0) r19.w = 0; else if (3+27 < 32) {                 r19.w = (uint)r32.w << (32-(3 + 27)); r19.w = (uint)r19.w >> (32-3);                } else r19.w = (uint)r32.w >> 27;
                r19.w = cmp((int)r19.w != 1);
                if (r19.w != 0) {
                  r19.w = abs(r15.z) * -0.200000003 + 0.400000006;
                  r41.xyz = r3.xyz * r19.www + v6.xyz;
                  r41.xyz = r41.xyz + -r35.xyz;
                  r19.w = max(abs(r41.y), abs(r41.z));
                  r19.w = max(abs(r41.x), r19.w);
                  r19.w = r36.x / r19.w;
                  r19.w = r19.w + r36.y;
                  ...
                  while (true) {
                    ...
                    if (r27.w != 0) break;
                    r43.y = dot(icb[r26.w+0].yx, r14.xy);
                    r43.z = dot(icb[r26.w+0].yx, r14.yz);
                    r43.yz = r43.yz * r34.yy;
                    r43.x = r43.y * r9.x;
                    r43.w = r43.y * r8.x;
                    r42.xyz = r41.xyz * r21.www + r43.xzw;
                    r27.w = gOmniShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r42.xyzw, r19.w).x;
                ...
                if (r19.w != 0) {
                  ...
                  r38.xyz = r10.www ? r38.xyz : r31.yzw;
                  r38.xyz = -v6.xyz + r38.xyz;
                  r10.w = dot(r38.xyz, r38.xyz);
                  r10.w = rsqrt(r10.w);
                  r39.xyz = r38.xyz * r10.www;
                  ...
                  r41.w = samp0[]..swiz;
                    ...
                    r18.xyz = r3.xyz * r21.www + v6.xyz;
                    r21.w = dot(r40.xyzw, r18.xyzw);
                    r26.w = dot(r41.xyzw, r18.xyzw);
                    ...
                    r11.w = samp0[]..swiz;
                      ...
                      if (r6.z != 0) {
                        ...
                        while (true) {
                          ...
                          r21.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r41.xyz, r18.x).x;
                    ...
                    r41.w = samp0[]..swiz;
                      ...
                      r20.xyz = r3.xyz * r18.xxx + v6.xyz;
                      r18.x = dot(r40.xyzw, r20.xyzw);
                      r18.z = dot(r41.xyzw, r20.xyzw);
                      ...
                      r11.w = samp0[]..swiz;
                        ...
                        if (r6.z != 0) {
                          ...
                          while (true) {
                            ...
                            if (r26.w != 0) break;
                            r41.x = dot(icb[r21.w+0].xy, r7.xy);
                            r41.y = dot(icb[r21.w+0].yx, r7.xz);
                            r20.xy = r41.xy * r12.ww + r40.xy;
                            r20.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r20.xyz, r18.x).x;
                  ...
                  r11.w = r11.w + -r15.w;
                  r11.w = r1.w * r11.w + r15.w;
                  r11.w = r11.w * r13.w;
                  r32.x = r31.x;
                  r12.w = cmp(0 < r15.z);
                  r20.xyz = r11.www * r32.xyz + r9.yzw;
                  r11.w = saturate(dot(r3.xyz, r39.xyz));
                  r38.xyz = r38.xyz * r10.www + r5.xyz;
                  r10.w = dot(r38.xyz, r38.xyz);
                  r10.w = rsqrt(r10.w);
                  r38.xyz = r38.xyz * r10.www;
                  r10.w = dot(r38.xyz, r5.xyz);
                  r15.z = dot(r3.xyz, r38.xyz);
                  r15.w = abs(r15.z) * r1.y + -abs(r15.z);
                  r15.z = abs(r15.z) * r15.w + 1;
                  r15.w = r11.w * r0.y + r1.z;
                  r15.z = r15.z * r15.z;
                  r15.z = r15.z * r15.w;
                  r15.z = rcp(r15.z);
                  r11.w = r11.w * r19.w;
                  ...
                  r10.w = log2(r10.w);
                  r10.w = 3.4000001 * r10.w;
                  r10.w = exp2(r10.w);
                  r10.w = r11.w * r10.w;
                  r39.xyz = r10.www * r32.xyz + r16.xyz;
                  r9.yzw = r12.www ? r20.xyz : r9.yzw;
                  r16.xyz = r12.www ? r39.xyz : r16.xyz;
            ...
            r10.w = rsqrt(r10.w);
            r38.xyz = r20.xyz * r10.www;
            r11.w = dot(r3.xyz, r38.xyz);
            ...
            r39.w = samp0[]..swiz;
              ...
              r15.w = samp0[]..swiz;
                ...
                if (r13.w != 0) {
                  ...
                  r19.w = r43.z * r33.x;
                  r21.w = r43.w * r33.y + -1;
                  r19.w = r43.w * r33.y + -r19.w;
                  r19.w = saturate(r21.w / r19.w);
                  r21.w = r19.w * r19.w;
                  r19.w = r19.w * -2 + 3;
                  r13.w = r21.w * r19.w;
                }
                ...
                r33.y = samp0[]..swiz;
                r33.z = samp0[]..swiz;
                  r15.w = dot(r44.yzw, r21.xyz);
                  r18.x = dot(r33.xyz, r21.xyz);
                  r33.x = frac(r15.w);
                  r33.y = frac(r18.x);
                  r13.w = (int)r13.w + -1;
                  r33.z = (uint)r13.w;
              ...
              if (r13.w != 0) {
                ...
                if (r13.w != 0) {
                  ...
                  r15.w = dot(r40.xyzw, r22.xyzw);
                  r18.x = cmp(r15.w >= r13.w);
                  if (r18.x != 0) {
                  // Known bad code for instruction (needs manual fix):
                  ...
                  r39.y = samp0[]..swiz;
                    ...
                    if (r6.z != 0) {
                      ...
                      r18.x = 0;
                      while (true) {
                        r19.w = cmp((int)r18.x >= 8);
                        if (r19.w != 0) break;
                        r33.x = dot(icb[r18.x+0].xy, r25.xy);
                        r33.y = dot(icb[r18.x+0].yx, r25.xz);
                        r31.xy = r33.xy * r34.yy + r22.xy;
                        r19.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r31.xyz, r7.w).x;
                        r15.w = r19.w * 0.125 + r15.w;
                        r18.x = (int)r18.x + 1;
                      }
                    } else {
                      r22.z = (uint)r13.w;
                      r15.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r22.xyz, r7.w).x;
                    }
                    r7.w = r15.w * r15.w;
                    r7.w = r7.w * r15.w;
                  } else {
                ...
                if (r13.w != 0) {
                  ...
                  r37.w = samp0[]..swiz;
                    ...
                    r23.z = samp0[]..swiz;
                      ...
                      r15.z = r23.z * r22.z;
                      r19.w = r23.y * r22.z + r19.w;
                      r15.z = r19.w / r15.z;
                      r15.z = max(6.10351563e-05, r15.z);
                      r19.w = r23.x ? 0.000000 : 0;
                      if (r6.z != 0) {
                        r22.z = (uint)r19.w;
                        r23.xy = float2(0,0);
                        while (true) {
                        ...
                        r31.z = (uint)r19.w;
                        r23.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r31.xyz, r15.z).x;
                      }
                      r15.z = r23.x * r23.x;
                      r15.z = r15.z * r23.x;
                    } else {
                    ...
                    r36.w = samp0[]..swiz;
                      ...
                      r24.y = samp0[]..swiz;
                        ...
                        r15.z = r24.y * r22.z;
                        r19.w = r24.x * r22.z + r19.w;
                        r15.z = r19.w / r15.z;
                        r15.z = max(6.10351563e-05, r15.z);
                        r19.w = r23.y ? 0.000000 : 0;
                        if (r6.z != 0) {
                          r22.z = (uint)r19.w;
                          r23.yz = float2(0,0);
                          while (true) {
                          ...
                          r31.z = (uint)r19.w;
                          r23.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r31.xyz, r15.z).x;
                        }
                        r15.z = r23.y * r23.y;
                        r15.z = r15.z * r23.y;
                      } else {
                  ...
                  r15.z = r15.z + -r12.w;
                  r15.z = r1.w * r15.z + r12.w;
                  r15.z = r15.z * r7.w;
                  r11.w = cmp(0 < r11.w);
                  r22.xyz = r15.zzz * r21.xyw + r9.yzw;
                  r20.xyz = r20.xyz * r10.www + r5.xyz;
                  r10.w = dot(r20.xyz, r20.xyz);
                  r10.w = rsqrt(r10.w);
                  r20.xyz = r20.xyz * r10.www;
                  r10.w = dot(r20.xyz, r5.xyz);
                  r15.z = dot(r3.xyz, r20.xyz);
                  r18.x = abs(r15.z) * r1.y + -abs(r15.z);
                  ...
                  r10.w = exp2(r10.w);
                  r7.w = r10.w * r7.w;
                  r21.xyw = r7.www * r21.xyw + r16.xyz;
                  r9.yzw = r11.www ? r22.xyz : r9.yzw;
                  r16.xyz = r11.www ? r21.xyw : r16.xyz;
  ...
  r0.xyz = r29.xyz * r4.xyz + r0.xyz;
  r0.xyz = r8.yzw * r10.xyz + r0.xyz;
  r0.w = log2(r2.w);
  r0.w = 3.4000001 * r0.w;
  r0.w = exp2(r0.w);
  r1.y = 1 + -r1.x;
