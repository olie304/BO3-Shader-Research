    ...
    if_nz r10.w
      ...
      if_nz r10.z
        ...
        if_nz r12.w
          ...
          utof r32.w, r10.w
          sample_l_indexable(texturecubearray)(float,float,float,float) r17.yzw, r32.xyzw, t8.wxyz, s2, r10.z
          ...
          mov r24.x, r22.w
          mov r24.yz, r23.xxyx
          mad r23.xyw, r14.yzyx, r10.yyyy, r24.yzyx
          mov r22.w, r23.w
        endif 
      endif 
    endif 
...
if_nz r5.w
  ...
  mad r9.yzw, r9.yyzw, r15.zzzz, r10.yyzw
  mov r4.w, l(0)
  ...
  dp3 r4.w, r9.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
  mad r13.xyz, r20.xyzx, r1.zzzz, r9.yzwy
  mov r11.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r9.yzw, r11.xyzw, t8.wxyz, s2, r3.w
  mad r1.z, cb2[19].x, r5.w, -r4.w
  mad r1.z, r0.y, r1.z, r4.w
  mad r2.xyz, r9.yzwy, r1.zzzz, r2.xyzx
endif 
mad r7.zw, r0.xxxy, l(0.000000, 0.000000, 0.984375, 0.984375), l(0.000000, 0.000000, 0.00781250, 0.00781250)
sample_l_indexable(texture2d)(float,float,float,float) r7.zw, r7.zwzz, t5.zwxy, s2, l(0.000000)
mul r14.xyz, r2.yzxy, r7.zzzz
...
if_nz r5.w
  ...
  if_nz r5.w
    ...
    mad r15.xyz, r7.zzzz, r9.yzwy, r13.xyzx
