...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  if (r6.w != 0) {
    ...
    r4.w = dot(r13.xyz, float3(0.212599993,0.715200007,0.0722000003));
    r12.xyz = r19.xyz * r3.www + r13.xyz;
    r11.w = 0;
  ...
  r13.xy = r0.xy * float2(0.984375,0.984375) + float2(0.0078125,0.0078125);
    ...
    if (r11.w == 0) {
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          r17.x = r16.y ? sunConstants.splitPinTransform[r8.w].w : sunConstants.splitPinTransform[r11.w].w;
          r16.y = r16.y ? r8.w : r11.w;
  ...
  if (r6.w != 0) {
    ...
    if (r6.w != 0) {
      ...
      r15.xyz = -v7.xyz * r0.zzz + sunConstants.wldDir.xyz;
      r0.z = dot(r15.xyz, r15.xyz);
      r0.z = rsqrt(r0.z);
      r15.xyz = r15.xyz * r0.zzz;
      r0.z = dot(r15.xyz, r3.xyz);
            ...
            r39.w = samp0[]..swiz;
              ...
              if (r13.w != 0) {
                ...
                if (r13.w != 0) {
                  ...
                  r18.xyz = r18.xyz * r11.www + r3.xyz;
                  r11.w = dot(r18.xyz, r18.xyz);
                  r11.w = rsqrt(r11.w);
                  r18.xyz = r18.xyz * r11.www;
                  r11.w = dot(r18.xyz, r3.xyz);
                  r14.w = dot(r4.xyz, r18.xyz);
