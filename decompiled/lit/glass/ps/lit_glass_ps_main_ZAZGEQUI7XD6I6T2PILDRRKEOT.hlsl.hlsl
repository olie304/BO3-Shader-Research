// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:36:41 2021
...
r3.z = samp0[]..swiz;
  ...
  r13.xyz = r10.zwy * r4.yyy;
  r10.yzw = r10.yzw * r4.www;
  r1.y = sqrt(r4.z);
  r1.y = r1.y * 0.5 + 0.5;
  r1.y = r1.y * r1.y;
  r2.w = 0.5 * r1.y;
  ...
  if (r5.w == 0) {
    ...
    r5.w = -sunConstants.splitDepthOffset + r14.z;
    ...
    if (r8.z != 0) {
      ...
      while (true) {
        ...
        if (r11.w != 0) break;
        r11.w = (uint)r8.z;
        r15.xy = -sunConstants.splitPinTransform[r11.w].xy + r14.xy;
        r14.w = max(abs(r15.x), abs(r15.y));
        r9.w = sunConstants.splitPinTransform[r11.w].z * r14.w;
        r11.w = cmp(r9.w < 1);
        if (r11.w != 0) {
          break;
        }
    ...
    r15.w = samp0[]..swiz;
      ...
      r18.w = samp0[]..swiz;
        ...
        r15.y = samp0[]..swiz;
          ...
          r15.y = r14.x * r15.z + r15.y;
          r15.x = r14.y * r15.x + r15.y;
          r16.y = r14.w ? r15.x : r16.y;
        }
      }
      r14.z = -sunConstants.sstLightingConstants.constants.inchesPerTexel * 2 + r14.z;
      r14.z = cmp(r16.y < r14.z);
      r7.w = r14.z ? 0 : 1;
    }
    if (r11.w == 0) {
      if (enableDitheredShadow == 0) {
        r11.w = (uint)r8.z;
        r14.zw = -sunConstants.splitPinTransform[r11.w].xy + r14.xy;
        r14.zw = sunConstants.splitPinTransform[r11.w].zz * r14.zw;
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          r17.z = (uint)r16.y;
          r16.y = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r17.xyz, r5.w).x;
  ...
  if (r5.w != 0) {
    r5.w = cmp(0 < r7.w);
    if (r5.w != 0) {
      r5.w = sunConstants.specScale * r3.y;
      r5.w = r5.w * r4.w;
      if (sunConstants.sunCookieIndex != 0) {
        ...
        r14.z = (uint)r6.x;
        r6.xyz = gCookieArray.SampleLevel(samplerLinear_s, r14.xyz, 0).xyz;
      ...
      r17.z = samp0[]..swiz;
      r17.w = samp0[]..swiz;
        r9.w = abs(r4.y) * -0.200000003 + 0.400000006;
        r18.xyz = r2.xyz * r9.www + v7.xyz;
        r18.w = 1;
        ...
        r15.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r14.zw, r6.w, l(164), t12.xxxy
        r14.z = samp0[]..swiz;
        r14.w = samp0[]..swiz;
          r6.w = dot(r15.xyzw, r18.xyzw);
          ...
          if (enableDitheredShadow != 0) {
            ...
            while (true) {
              ...
              r15.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r6.w).x;
              r11.w = r15.w * 0.125 + r11.w;
              r14.w = (int)r14.w + 1;
            }
          } else {
            r15.z = (uint)r9.w;
            r11.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r15.xyz, r6.w).x;
          }
          r6.w = r11.w * r11.w;
          r6.w = r6.w * r11.w;
        } else {
      ...
      r6.w = r6.w * r7.w;
      r4.y = cmp(0 < r4.y);
      r14.xyz = r6.www * r6.xyz + r12.xyz;
      r15.xyz = -v7.xyz * r3.zzz + sunConstants.wldDir.xyz;
      r3.z = dot(r15.xyz, r15.xyz);
      r3.z = rsqrt(r3.z);
      r15.xyz = r15.xyz * r3.zzz;
      r3.z = dot(r15.xyz, r5.xyz);
      r6.w = dot(r2.xyz, r15.xyz);
      ...
      r4.w = r7.w * r4.w;
      r4.w = 0.25 * r4.w;
      r15.xyz = r4.www * r6.xyz + r10.yzw;
      r3.z = saturate(1 + -r3.z);
      r3.z = log2(r3.z);
      r3.z = 3.4000001 * r3.z;
      r3.z = exp2(r3.z);
      r3.z = r4.w * r3.z;
      r6.xyz = r3.zzz * r6.yzx + r13.xyz;
      r14.w = r6.z;
      r12.w = r13.z;
      r12.xyzw = r4.yyyy ? r14.xyzw : r12.xyzw;
      r6.zw = r15.xy;
      r13.zw = r10.yz;
      r6.xyzw = r4.yyyy ? r6.xyzw : r13.xyzw;
      r10.w = r4.y ? r15.z : r10.w;
      r13.z = r12.w;
      r13.xy = r6.xy;
      r10.yz = r6.zw;
    }
          ...
          switch (r11.w) {
              ...
              if (r23.w != 0) {
                ...
                if (r23.w != 0) {
                  ...
                  while (true) {
                    ...
                    if (r27.w != 0) break;
                    r43.y = dot(icb[r26.w+0].yx, r6.xy);
                    r43.z = dot(icb[r26.w+0].yx, r6.yz);
                ...
                if (r23.w != 0) {
                    ...
                    r12.w = samp0[]..swiz;
                      ...
                      if (r7.w != 0) {
                        ...
                        while (true) {
                          ...
                          if (r24.w != 0) break;
                          r42.x = dot(icb[r17.z+0].yx, r6.xw);
                  ...
                  r29.xyz = r13.www ? r39.xyz : r29.xyz;
            ...
            r39.w = samp0[]..swiz;
              ...
              r17.x = samp0[]..swiz;
                ...
                r19.w = r19.w / r23.w;
                r19.w = min(1, r19.w);
                r33.xy = saturate(r14.zz * r33.xz + r33.yw);
                ...
                r19.xy = r33.xy / r14.zz;
                r14.z = cmp(r42.w < 0.00048828125);
                if (r14.z != 0) {
                  r43.y = r44.x;
              ...
              r14.z = cmp(0 < r14.w);
              if (r14.z != 0) {
                if (3 == 0) r14.z = 0; else if (3+27 < 32) {                 r14.z = (uint)r32.w << (32-(3 + 27)); r14.z = (uint)r14.z >> (32-3);                } else r14.z = (uint)r32.w >> 27;
                r14.z = cmp((int)r14.z != 1);
                if (r14.z != 0) {
                  r14.z = abs(r12.w) * -0.200000003 + 0.400000006;
                  r20.xyz = r2.xyz * r14.zzz + v7.xyz;
                  r38.xyz = r37.xyz;
                  r14.z = dot(r38.xyzw, r20.xyzw);
                  r17.x = dot(r40.xyzw, r20.xyzw);
                  r23.w = cmp(r17.x >= r14.z);
                  if (r23.w != 0) {
                  // Known bad code for instruction (needs manual fix):
                ...
                if (r14.z != 0) {
                  ...
                  r14.w = r14.w + -r13.w;
                  r14.w = r4.z * r14.w + r13.w;
                  r14.w = r14.w * r9.w;
                  r12.w = cmp(0 < r12.w);
                  r21.xyz = r14.www * r19.xyw + r15.xyz;
                  r18.xyz = r18.xyz * r11.www + r5.xyz;
                  r11.w = dot(r18.xyz, r18.xyz);
                  r11.w = rsqrt(r11.w);
                  r18.xyz = r18.xyz * r11.www;
                  r11.w = dot(r18.xyz, r5.xyz);
                  r14.w = dot(r2.xyz, r18.xyz);
                  r18.x = abs(r14.w) * r3.y + -abs(r14.w);
  ...
  r3.xyz = r27.xyz * r3.xyz;
  r1.xyz = r28.xyz * r1.xzw + r3.xyz;
  r0.xyz = r26.xyz * r0.xyz + r1.xyz;
