...
r1.z = samp0[]..swiz;
  ...
  if (r2.z != 0) {
    ...
    r12.xyz = r19.xyz * r2.xxx + r13.xyz;
    r10.w = 0;
  ...
  r13.xyz = r9.zwy * r2.xxx;
  r2.xzw = r9.yzw * r2.zzz;
  r1.y = sqrt(r4.w);
  r1.y = r1.y * 0.5 + 0.5;
  r1.y = r1.y * r1.y;
  r3.w = 0.5 * r1.y;
  ...
  r1.y = r5.w * r1.y;
  r3.w = r5.w * r3.w;
  r5.w = dot(r3.xyz, sunConstants.wldDir.xyz);
  r6.y = saturate(r5.w);
  r6.w = cmp(0 >= r6.y);
  if (r6.w != 0) {
    r7.z = 0;
  ...
  if (r6.w == 0) {
    ...
    if (r7.w != 0) {
      ...
      while (true) {
        ...
        if (r10.w != 0) break;
        r10.w = (uint)r7.w;
        r14.xy = -sunConstants.splitPinTransform[r10.w].xy + r9.yz;
        r11.w = max(abs(r14.x), abs(r14.y));
        r8.w = sunConstants.splitPinTransform[r10.w].z * r11.w;
        r10.w = cmp(r8.w < 1);
        if (r10.w != 0) {
          break;
        }
    ...
    r14.w = samp0[]..swiz;
      ...
      r17.w = samp0[]..swiz;
        ...
        r14.y = samp0[]..swiz;
          ...
          r14.y = r9.y * r14.z + r14.y;
          r14.x = r9.z * r14.x + r14.y;
          r15.y = r11.w ? r14.x : r15.y;
        }
      }
    ...
    if (r10.w == 0) {
      if (enableDitheredShadow == 0) {
        r9.w = (uint)r7.w;
        r14.xy = -sunConstants.splitPinTransform[r9.w].xy + r9.yz;
        ...
        r14.z = r9.w + r7.w;
        r9.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r14.xyz, r6.w).x;
      ...
      if (enableDitheredShadow != 0) {
        ...
        r8.w = 28 * r8.w;
        r8.w = (uint)r8.w;
        r15.xy = -sunConstants.splitPinTransform[r9.w].xy + r9.yz;
        ...
        while (true) {
          ...
          if (r14.w != 0) break;
          r14.w = cmp((uint)r8.w < (uint)r11.w);
          r15.zw = r14.ww ? r9.yz : r15.xy;
          r16.x = r14.w ? sunConstants.splitPinTransform[r7.w].w : sunConstants.splitPinTransform[r9.w].w;
          ...
          r16.z = (uint)r14.w;
          r14.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r6.w).x;
  ...
  if (r6.w != 0) {
    ...
    if (r6.w != 0) {
        ...
        r14.w = samp0[]..swiz;
          ...
          if (enableDitheredShadow != 0) {
            ...
            while (true) {
              ...
              r15.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r7.w).x;
      ...
      r6.y = r7.z * r6.y;
      r6.y = 0.25 * r6.y;
      r15.xyz = r6.yyy * r9.yzw + r2.xzw;
      r1.z = saturate(1 + -r1.z);
      r1.z = log2(r1.z);
      r1.z = 3.4000001 * r1.z;
      r1.z = exp2(r1.z);
      r1.z = r6.y * r1.z;
      r16.xyz = r1.zzz * r9.zwy + r13.xyz;
      r14.w = r16.z;
      r12.w = r13.z;
          ...
          switch (r10.w) {
            ...
            if (r20.w != 0) {
              ...
              if (r20.w != 0) {
                ...
                if (r20.w != 0) {
                  r20.w = r32.x * r2.y;
                  r20.w = 0.25 * r20.w;
                  r24.w = dot(r38.xyz, r10.xyz);
                  r26.w = dot(r10.xyz, r40.xyz);
                  ...
                  r41.w = samp0[]..swiz;
                    ...
                    r18.xyz = r3.xyz * r24.www + v6.xyz;
                    r24.w = dot(r40.xyzw, r18.xyzw);
                    ...
                    r11.w = samp0[]..swiz;
                      ...
                      if (r7.z != 0) {
                        ...
                        while (true) {
                          ...
                          r24.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r41.xyz, r18.x).x;
            ...
            r39.w = samp0[]..swiz;
              ...
              r15.w = samp0[]..swiz;
                ...
                r33.y = samp0[]..swiz;
                r33.z = samp0[]..swiz;
                  r15.w = dot(r44.yzw, r20.xyz);
                  r18.x = dot(r33.xyz, r20.xyz);
                  r33.x = frac(r15.w);
                  r33.y = frac(r18.x);
                  r13.w = (int)r13.w + -1;
                  r33.z = (uint)r13.w;
              ...
              if (r13.w != 0) {
                  ...
                  r39.y = samp0[]..swiz;
                    ...
                    if (r7.z != 0) {
                      ...
                      while (true) {
                        ...
                        if (r24.w != 0) break;
                        r33.x = dot(icb[r18.x+0].xy, r24.xy);
                        r33.y = dot(icb[r18.x+0].yx, r24.xz);
                ...
                if (r13.w != 0) {
                  ...
                  r37.w = samp0[]..swiz;
                    ...
                    r31.xy = r18.xx / r36.xz;
                    r31.zw = float2(1,1) + -r31.xy;
                    r31.zw = cmp(r21.xy >= r31.zw);
                    ...
                    r31.y = samp0[]..swiz;
                      ...
                      if (r7.z != 0) {
                        ...
                        r32.z = (uint)r21.x;
                        r21.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r32.xyz, r15.z).x;
                      }
                      r15.z = r21.y * r21.y;
                      r15.z = r15.z * r21.y;
                    } else {
                    ...
                    r36.w = samp0[]..swiz;
                      ...
                      r23.y = samp0[]..swiz;
                        ...
                        if (r7.z != 0) {
                          ...
                          r31.z = (uint)r21.x;
                          r21.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r31.xyz, r15.z).x;
                        }
                        r15.z = r21.z * r21.z;
                        r15.z = r15.z * r21.z;
                      } else {
                  ...
                  r15.z = r15.z + -r12.w;
                  r15.z = r4.w * r15.z + r12.w;
                  r15.z = r15.z * r8.w;
                  r11.w = cmp(0 < r11.w);
                  r22.xyz = r15.zzz * r20.xyw + r16.xyz;
                  r19.xyz = r19.xyz * r10.www + r5.xyz;
                  r10.w = dot(r19.xyz, r19.xyz);
                  r10.w = rsqrt(r10.w);
                  r19.xyz = r19.xyz * r10.www;
                  r10.w = dot(r19.xyz, r5.xyz);
                  r15.z = dot(r3.xyz, r19.xyz);
                  r18.x = abs(r15.z) * r2.y + -abs(r15.z);
                  r15.z = abs(r15.z) * r18.x + 1;
                  r12.w = r12.w * r1.y + r3.w;
                  r15.z = r15.z * r15.z;
                  r12.w = r15.z * r12.w;
                  r12.w = rcp(r12.w);
                  r12.w = r12.w * r13.w;
