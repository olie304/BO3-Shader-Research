...
r1.z = samp0[]..swiz;
  ...
  if (r6.w != 0) {
    ...
    r12.xyz = r19.yzx * r4.www + r13.yzx;
    r11.w = 0;
  ...
  r13.xzw = r13.xxx * r10.yzw;
  r14.xyz = r13.yyy * r10.yzw;
  r1.y = sqrt(r2.z);
  r1.y = r1.y * 0.5 + 0.5;
  r1.y = r1.y * r1.y;
  r2.w = 0.5 * r1.y;
  ...
  if (r4.w == 0) {
    ...
    r13.y = samp0[]..swiz;
      r15.w = (int)r13.y & 0x40000000;
      r16.x = (uint)r13.y << 2;
      if (r15.w == 0) {
        r15.w = (int)r13.y & 0x01ffffff;
      ...
      r13.y = samp0[]..swiz;
        r13.y = r16.z ? r17.z : r13.y;
        r15.w = (uint)r13.y >> 13;
        r13.y = r16.y ? r15.w : r13.y;
        r13.y = (int)r13.y & 8191;
        r18.x = (int)r13.y + (int)r17.x;
      // Known bad code for instruction (needs manual fix):
      ...
      r18.w = samp0[]..swiz;
        r16.yzw = r13.yyy ? r16.yzw : r18.xzw;
        ...
        if (r11.w == 0) {
          ...
          bitmask.y = ((~(-1 << 1)) << 1) & 0xffffffff;  r13.y = (((uint)r17.y << 1) & bitmask.y) | ((uint)0 & ~bitmask.y);
          bitmask.y = ((~(-1 << 1)) << 0) & 0xffffffff;  r13.y = (((uint)r17.x << 0) & bitmask.y) | ((uint)r13.y & ~bitmask.y);
          r13.y = (int)r13.y * 10;
        ...
        r18.z = samp0[]..swiz;
          ...
          r13.y = (int)-r18.y + 6;
          r17.yz = (uint2)r15.zy >> (uint2)r13.yy;
          r13.y = (int)r18.z & 0xc0000000;
        ...
        r19.y = samp0[]..swiz;
          r17.yz = r13.yy ? r18.xz : r19.xy;
          r16.yw = r11.ww ? r17.xw : r17.yz;
        }
        r11.w = (int)r16.w & 0xc0000000;
        if (r11.w == 0) {
          if (14 == 0) r13.y = 0; else if (14+15 < 32) {           r13.y = (uint)r16.w << (32-(14 + 15)); r13.y = (uint)r13.y >> (32-14);          } else r13.y = (uint)r16.w >> 15;
          r13.y = (uint)r13.y;
        ...
        r16.z = samp0[]..swiz;
          ...
          r15.x = (uint)r15.x;
          r15.x = r15.x * r15.w;
          r15.x = r15.x * 0.00392156886 + r13.y;
          r15.y = (int)r17.z + 1;
        ...
        r15.y = samp0[]..swiz;
          ...
          r15.y = (uint)r15.y;
          r15.y = r15.y * r15.w;
          r13.y = r15.y * 1.52590219e-05 + r13.y;
          r16.x = r17.y ? r15.x : r13.y;
        } else {
          r13.y = (int)r16.w & 0x80000000;
          r15.x = (int)r16.y + 1;
        // Known bad code for instruction (needs manual fix):
        ...
        r15.x = samp0[]..swiz;
          ...
          r13.y = r10.z * r13.y + r15.x;
          r16.x = r11.w ? r13.y : r16.x;
        }
      }
    ...
    if (r9.w == 0) {
      ...
      if (enableDitheredShadow != 0) {
        ...
        r11.w = 0;
        while (true) {
          r13.y = cmp((uint)r11.w >= 8);
          if (r13.y != 0) break;
          r13.y = cmp((uint)r8.z < (uint)r11.w);
          r16.zw = r13.yy ? r10.yz : r16.xy;
          r15.w = r13.y ? sunConstants.splitPinTransform[r7.w].w : sunConstants.splitPinTransform[r9.w].w;
          r13.y = r13.y ? r7.w : r9.w;
          ...
          r17.z = (uint)r13.y;
          r13.y = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r17.xyz, r4.w).x;
  ...
  if (r4.w != 0) {
    r4.w = cmp(0 < r6.w);
    if (r4.w != 0) {
      r4.w = sunConstants.specScale * r2.y;
      r4.w = 0.25 * r4.w;
      if (sunConstants.sunCookieIndex != 0) {
        r5.w = 1;
        r7.w = dot(sunConstants.sunCookieTransform[0].xyzw, r5.xyzw);
        ...
        r16.y = samp0[]..swiz;
          ...
          if (enableDitheredShadow != 0) {
            ...
            while (true) {
              ...
              r10.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r17.xyz, r5.w).x;
      ...
      r5.w = -r1.x * 0.5 + 1;
      r5.w = -abs(r3.w) * r5.w + 1;
      r5.w = r5.w * r5.w;
      r5.w = -r5.w * 0.620000005 + 0.620000005;
      r5.w = r5.w + -abs(r3.w);
      r5.w = r2.z * r5.w + abs(r3.w);
      r5.w = r5.w * r6.w;
      r7.w = cmp(0 < r3.w);
      r15.xyz = r5.www * r5.yzx + r12.xyz;
      r3.w = saturate(r3.w);
      r10.yzw = -v7.xyz * r1.zzz + sunConstants.wldDir.xyz;
      r1.z = dot(r10.yzw, r10.yzw);
      r1.z = rsqrt(r1.z);
      r10.yzw = r10.yzw * r1.zzz;
      r1.z = dot(r10.yzw, r7.xyz);
      r5.w = dot(r3.xyz, r10.yzw);
      ...
      r3.w = r5.w * r3.w;
      r3.w = r3.w * r6.w;
      r16.yzw = r3.www * r5.xyz + r14.xyz;
      r1.z = saturate(1 + -r1.z);
      r1.z = log2(r1.z);
      r1.z = 3.4000001 * r1.z;
      r1.z = exp2(r1.z);
      r1.z = r3.w * r1.z;
      r5.xyz = r1.zzz * r5.xyz + r13.xzw;
      r15.w = r12.z;
      r12.w = r15.z;
  ...
  while (true) {
    ...
    if (r6.w != 0) break;
    r15.z = (uint)r4.w >> 5;
    r16.xyz = (int3)r6.xyz + (int3)r15.xyz;
      ...
      r35.y = samp0[]..swiz;
        ...
        r40.w = samp0[]..swiz;
          ...
          switch (r11.w) {
              ...
              if (r15.w != 0) {
                ...
                if (r15.w != 0) {
                  ...
                  while (true) {
                    ...
                    if (r26.w != 0) break;
                    r46.y = dot(icb[r25.w+0].yx, r5.xy);
                    r46.z = dot(icb[r25.w+0].yx, r5.yz);
                ...
                if (r15.w != 0) {
                    ...
                    r12.w = samp0[]..swiz;
                      ...
                      if (r7.w != 0) {
                        ...
                        while (true) {
                          ...
                          if (r27.w != 0) break;
                          r44.x = dot(icb[r26.w+0].yx, r5.xw);
                          r44.y = dot(icb[r26.w+0].xy, r8.xy);
                          r19.xy = r44.xy * r13.yy + r43.xy;
                  ...
                  r12.w = -abs(r15.z) * r1.x + 1;
                  r12.w = r12.w * r12.w;
                  r12.w = -r12.w * 0.620000005 + 0.620000005;
                  r12.w = r12.w + -abs(r15.z);
                  r12.w = r2.z * r12.w + abs(r15.z);
                  r12.w = r12.w * r14.w;
                  r35.x = r34.x;
                  r13.y = cmp(0 < r15.z);
                  r19.xyz = r12.www * r35.xyz + r16.xyz;
                  r15.z = saturate(dot(r3.xyz, r42.xyz));
                  r20.xyz = r41.xyz * r11.www + r7.xyz;
                  r11.w = dot(r20.xyz, r20.xyz);
                  r11.w = rsqrt(r11.w);
                  r20.xyz = r20.xyz * r11.www;
                  r11.w = dot(r20.xyz, r7.xyz);
                  r17.w = dot(r3.xyz, r20.xyz);
                  r20.x = abs(r17.w) * r2.y + -abs(r17.w);
                  ...
                  r16.xyz = r13.yyy ? r19.xyz : r16.xyz;
                  r31.xyz = r13.yyy ? r31.xyz : r42.xyz;
                  r32.xyz = r13.yyy ? r41.xyz : r32.xyz;
                  r33.xyz = r13.yyy ? r20.xyz : r33.xyz;
                }
              }
            }
            break;
            ...
            r12.w = dot(r3.xyz, r20.xyz);
            r13.y = cmp(0 < abs(r12.w));
            if (r13.y != 0) {
            // Known bad code for instruction (needs manual fix):
            ...
            r42.w = samp0[]..swiz;
              ...
              r15.z = samp0[]..swiz;
                ...
                r15.w = r15.w / r17.w;
                r15.w = min(1, r15.w);
                r36.xy = saturate(r13.yy * r36.xz + r36.yw);
                ...
                r21.xy = r36.xy / r13.yy;
                r13.y = cmp(r44.w < 0.00048828125);
                if (r13.y != 0) {
                  r45.y = r46.x;
              ...
              r13.y = cmp(0 < r14.w);
              if (r13.y != 0) {
                if (3 == 0) r13.y = 0; else if (3+27 < 32) {                 r13.y = (uint)r35.w << (32-(3 + 27)); r13.y = (uint)r13.y >> (32-3);                } else r13.y = (uint)r35.w >> 27;
                r13.y = cmp((int)r13.y != 1);
                if (r13.y != 0) {
                  r13.y = abs(r12.w) * -0.200000003 + 0.400000006;
                  r15.z = cmp(r12.w < 0);
                  r13.y = r15.z ? -r13.y : r13.y;
                  r22.xyz = r3.xyz * r13.yyy + v7.xyz;
                  r41.xyz = r40.xyz;
                  r13.y = dot(r41.xyzw, r22.xyzw);
                  r15.z = dot(r43.xyzw, r22.xyzw);
                  r15.w = cmp(r15.z >= r13.y);
                  if (r15.w != 0) {
                  // Known bad code for instruction (needs manual fix):
                ...
                if (r13.y != 0) {
                  ...
                  r14.w = -abs(r12.w) * r1.x + 1;
                  r14.w = r14.w * r14.w;
                  r14.w = -r14.w * 0.620000005 + 0.620000005;
                  r14.w = r14.w + -abs(r12.w);
                  r14.w = r2.z * r14.w + abs(r12.w);
                  r14.w = r14.w * r9.w;
                  r15.w = cmp(0 < r12.w);
                  r22.xyz = r14.www * r20.xyz + r16.xyz;
                  r12.w = saturate(r12.w);
                  r19.xyz = r19.xyz * r11.www + r7.xyz;
                  r11.w = dot(r19.xyz, r19.xyz);
                  r11.w = rsqrt(r11.w);
                  r19.xyz = r19.xyz * r11.www;
                  r11.w = dot(r19.xyz, r7.xyz);
                  r17.w = dot(r3.xyz, r19.xyz);
                  r19.x = abs(r17.w) * r2.y + -abs(r17.w);
