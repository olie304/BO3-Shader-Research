...
r1.x = samp0[]..swiz;
  ...
  r14.xyz = r9.zwy * r3.xxx;
  r9.yzw = r9.yzw * r3.yyy;
  r1.y = sqrt(r3.w);
  r1.y = r1.y * 0.5 + 0.5;
  r1.y = r1.y * r1.y;
  r1.z = 0.5 * r1.y;
  ...
  if (r3.y == 0) {
    ...
    r3.y = -sunConstants.splitDepthOffset + r10.w;
    ...
    if (r4.z != 0) {
      ...
      while (true) {
        ...
        if (r6.w != 0) break;
        r6.w = (uint)r4.z;
        r7.zw = -sunConstants.splitPinTransform[r6.w].xy + r10.yz;
        r7.z = max(abs(r7.z), abs(r7.w));
        r5.w = sunConstants.splitPinTransform[r6.w].z * r7.z;
        r6.w = cmp(r5.w < 1);
        if (r6.w != 0) {
          break;
        }
    ...
    r7.w = samp0[]..swiz;
      ...
      r15.w = samp0[]..swiz;
        r7.w = r7.w ? r17.z : r15.w;
        r15.w = (uint)r7.w >> 13;
        r7.z = r7.z ? r15.w : r7.w;
        r7.z = (int)r7.z & 8191;
      ...
      r18.w = samp0[]..swiz;
        ...
        r18.z = samp0[]..swiz;
          ...
          bitmask.z = ((~(-1 << 1)) << 0) & 0xffffffff;  r7.z = (((uint)r7.z << 0) & bitmask.z) | ((uint)r7.w & ~bitmask.z);
          r7.z = (int)r7.z * 10;
          r7.z = (uint)r15.w >> (uint)r7.z;
          r7.z = (int)r7.z & 1023;
          r19.x = (int)r7.z + (int)r18.x;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r19.y, r19.x, l(0), t23.xxxx
        r19.y = samp0[]..swiz;
          r7.zw = r12.ww ? r18.xz : r19.xy;
        ...
        r12.w = samp0[]..swiz;
          ...
          r12.w = (uint)r12.w;
          r12.w = r12.w * r8.w;
          r12.w = r12.w * 0.00392156886 + r7.w;
          r15.x = (int)r15.y + 1;
        ...
        r8.w = samp0[]..swiz;
          ...
          r7.w = f16tof32(r7.w);
          r8.w = r10.y * r12.w + r8.w;
          r7.w = r10.z * r7.w + r8.w;
          r11.w = r7.z ? r7.w : r11.w;
        }
      }
      r7.z = -sunConstants.sstLightingConstants.constants.inchesPerTexel * 2 + r10.w;
      r7.z = cmp(r11.w < r7.z);
      r4.y = r7.z ? 0 : 1;
    }
    if (r6.w == 0) {
      if (enableDitheredShadow == 0) {
        ...
        r15.z = r6.w + r4.z;
        r6.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r15.xyz, r3.y).x;
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          r16.xy = r11.ww ? r10.yz : r7.zw;
          r12.w = r11.w ? sunConstants.splitPinTransform[r4.z].w : sunConstants.splitPinTransform[r6.w].w;
          r11.w = r11.w ? r4.z : r6.w;
          ...
          r16.z = (uint)r11.w;
          r11.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r3.y).x;
  ...
  if (r3.y != 0) {
    ...
    if (r3.y != 0) {
      ...
      if (r5.w != 0) {
        ...
        r4.z = (int)r4.z + -1;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r5.w, r4.z, l(52), t12.xxxx
      r5.w = samp0[]..swiz;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r15.xyzw, r4.z, l(68), t12.xyzw
      r15.x = samp0[]..swiz;
      r15.y = samp0[]..swiz;
      r15.z = samp0[]..swiz;
      r15.w = samp0[]..swiz;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r16.xyzw, r4.z, l(84), t12.xyzw
      r16.x = samp0[]..swiz;
      r16.y = samp0[]..swiz;
      r16.z = samp0[]..swiz;
      r16.w = samp0[]..swiz;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r17.xyzw, r4.z, l(132), t12.xyzw
      r17.x = samp0[]..swiz;
      r17.y = samp0[]..swiz;
      r17.z = samp0[]..swiz;
      r17.w = samp0[]..swiz;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r18.xyzw, r4.z, l(148), t12.xyzw
      r18.x = samp0[]..swiz;
      r18.y = samp0[]..swiz;
      r18.z = samp0[]..swiz;
      r18.w = samp0[]..swiz;
        r6.w = abs(r2.w) * -0.200000003 + 0.400000006;
        r19.xyz = r2.xyz * r6.www + v6.xyz;
        r19.w = 1;
        ...
        if (r6.w == 0) {
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r6.w, r4.z, l(28), t12.xxxx
        r6.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r15.xyzw, r4.z, l(100), t12.xyzw
        r15.x = samp0[]..swiz;
        r15.y = samp0[]..swiz;
        r15.z = samp0[]..swiz;
        r15.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r16.xy, r4.z, l(164), t12.xyxx
        r16.x = samp0[]..swiz;
        r16.y = samp0[]..swiz;
          r4.z = dot(r15.xyzw, r19.xyzw);
          ...
          if (enableDitheredShadow != 0) {
            ...
            r15.z = (uint)r6.w;
            r7.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r15.xyz, r4.z).x;
          }
          r4.z = r7.z * r7.z;
          r4.z = r4.z * r7.z;
        } else {
      ...
      r3.x = r4.y * r3.x;
      r3.x = 0.25 * r3.x;
      r16.xyz = r3.xxx * r10.yzw + r9.yzw;
      r1.x = saturate(1 + -r1.x);
      r1.x = log2(r1.x);
      r1.x = 3.4000001 * r1.x;
      r1.x = exp2(r1.x);
      r1.x = r3.x * r1.x;
      r17.xyz = r1.xxx * r10.zwy + r14.xyz;
      r15.w = r17.z;
      r13.w = r14.z;
      ...
      r32.y = samp0[]..swiz;
        ...
        r37.w = samp0[]..swiz;
          ...
          switch (r7.w) {
            ...
            if (r20.w != 0) {
              ...
              if (r20.w != 0) {
                ...
                if (r20.w != 0) {
                  ...
                  r8.w = r24.w * r26.w + -r8.w;
                  r8.w = saturate(r8.w / r27.w);
                  r24.w = r27.w / r37.x;
                  r24.w = 10 * r24.w;
                  r24.w = min(1, r24.w);
                  r8.w = r8.w + -r11.w;
                  r8.w = r24.w * r8.w + r11.w;
                  ...
                  r8.w = r8.w + -r14.w;
                  r8.w = r3.w * r8.w + r14.w;
                  r8.w = r8.w * r12.w;
                  r32.x = r31.x;
                  r11.w = cmp(0 < r13.w);
                  r19.xyz = r8.www * r32.xyz + r16.xyz;
                  r8.w = saturate(dot(r2.xyz, r39.xyz));
                  r38.xyz = r38.xyz * r7.www + r6.xyz;
                  r7.w = dot(r38.xyz, r38.xyz);
                  r7.w = rsqrt(r7.w);
                  r38.xyz = r38.xyz * r7.www;
                  r7.w = dot(r38.xyz, r6.xyz);
                  r13.w = dot(r2.xyz, r38.xyz);
                  r14.w = abs(r13.w) * r3.z + -abs(r13.w);
                  r13.w = abs(r13.w) * r14.w + 1;
                  r14.w = r8.w * r1.y + r1.z;
                  r13.w = r13.w * r13.w;
                  r13.w = r13.w * r14.w;
                  r13.w = rcp(r13.w);
                  r8.w = r8.w * r20.w;
                  r8.w = r13.w * r8.w;
                  r8.w = r8.w * r12.w;
                  r38.xyz = r8.www * r32.xyz + r30.xyz;
                  r7.w = saturate(1 + -r7.w);
                  r7.w = log2(r7.w);
                  r7.w = 3.4000001 * r7.w;
                  r7.w = exp2(r7.w);
                  r7.w = r8.w * r7.w;
                  r39.xyz = r7.www * r32.xyz + r29.xyz;
            ...
            r7.w = rsqrt(r7.w);
            r38.xyz = r19.xyz * r7.www;
            r8.w = dot(r2.xyz, r38.xyz);
            r11.w = saturate(r8.w);
            r12.w = cmp(0 < r11.w);
            if (r12.w != 0) {
            // Known bad code for instruction (needs manual fix):
            ...
            r39.w = samp0[]..swiz;
              ...
              if (r12.w != 0) {
                  ...
                  r39.y = samp0[]..swiz;
                    ...
                    if (r5.w != 0) {
                      ...
                      while (true) {
                        ...
                        r24.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r31.xyz, r7.z).x;
                        r14.w = r24.w * 0.125 + r14.w;
                        r18.x = (int)r18.x + 1;
                      }
                    } else {
                      r21.z = (uint)r12.w;
                      r14.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r21.xyz, r7.z).x;
                    }
                    r7.z = r14.w * r14.w;
                    r7.z = r7.z * r14.w;
                  } else {
                ...
                if (r12.w != 0) {
                  ...
                  r18.x = cmp(0 < (uint)r13.w);
                  r18.x = r1.w ? r18.x : 0;
                  if (r18.x != 0) {
                    r13.w = (int)r13.w + numLights;
                    r13.w = (int)r13.w + -1;
                  // Known bad code for instruction (needs manual fix):
                                    ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r18.x, r13.w, l(52), t12.xxxx
                  r18.x = samp0[]..swiz;
                  // Known bad code for instruction (needs manual fix):
                  ...
                  r37.w = samp0[]..swiz;
                    ...
                    r22.y = samp0[]..swiz;
                    // Known bad code for instruction (needs manual fix):
                                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r31.xy, r13.w, l(164), t12.xyxx
                    r31.x = samp0[]..swiz;
                    r31.y = samp0[]..swiz;
                    ...
                    r36.w = samp0[]..swiz;
                      ...
                      r23.y = samp0[]..swiz;
                        ...
                        if (r5.w != 0) {
                          ...
                          r31.z = (uint)r21.x;
                          r21.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r31.xyz, r13.w).x;
                        }
                        r13.w = r21.z * r21.z;
                        r13.w = r13.w * r21.z;
                      } else {
                  ...
                  r13.w = r13.w + -r11.w;
                  r13.w = r3.w * r13.w + r11.w;
                  r13.w = r13.w * r7.z;
                  r8.w = cmp(0 < r8.w);
                  r22.xyz = r13.www * r20.xyw + r16.xyz;
                  ...
                  r18.x = abs(r13.w) * r3.z + -abs(r13.w);
                  r13.w = abs(r13.w) * r18.x + 1;
                  r11.w = r11.w * r1.y + r1.z;
                  r13.w = r13.w * r13.w;
                  r11.w = r13.w * r11.w;
                  r11.w = rcp(r11.w);
                  r11.w = r11.w * r12.w;
                  r7.z = r11.w * r7.z;
                  r7.z = 0.25 * r7.z;
                  r19.xyz = r7.zzz * r20.xyw + r30.xyz;
                  r7.w = saturate(1 + -r7.w);
                  r7.w = log2(r7.w);
                  r7.w = 3.4000001 * r7.w;
                  r7.w = exp2(r7.w);
                  r7.z = r7.z * r7.w;
                  r20.xyw = r7.zzz * r20.xyw + r29.xyz;
                  r16.xyz = r8.www ? r22.xyz : r16.xyz;
                  r29.xyz = r8.www ? r20.xyw : r29.xyz;
                  r30.xyz = r8.www ? r19.xyz : r30.xyz;
                }
              }
            }
            break;
