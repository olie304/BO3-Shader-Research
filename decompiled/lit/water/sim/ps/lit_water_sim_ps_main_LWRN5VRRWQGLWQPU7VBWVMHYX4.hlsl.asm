...
loop 
  ...
  mov r27.z, r28.z
  dp3 r16.w, r10.xyzx, r27.xyzx
  dp3 r17.w, r13.xyzx, r27.xyzx
  add r17.w, -r28.w, r17.w
  ge r20.w, r17.w, l(0.000000)
  ...
  min r15.w, r15.w, |r16.w|
  mov r32.zw, r31.zzzw
  dp3 r16.w, r10.zxyz, r32.xzwx
  dp3 r17.w, r13.zxyz, r32.xzwx
  ...
  mad r27.xyz, r10.xyzx, r15.wwww, r27.xyzx
  ...
  utof r28.w, r21.y
  sample_l_indexable(texturecubearray)(float,float,float,float) r21.yzw, r28.xyzw, t8.wxyz, s2, r15.w
  and r26.yzw, r21.yyzw, l(0, 0x7fffffff, 0x7fffffff, 0x7fffffff)
  ieq r26.yzw, r26.yyzw, l(0, 0x7f800000, 0x7f800000, 0x7f800000)
  or r15.w, r26.z, r26.y
  or r15.w, r26.w, r15.w
  movc r21.yzw, r15.wwww, l(0,1.000000,1.000000,0), r21.yyzw
  ...
  ieq r26.yzw, r26.yyzw, l(0, 0x7f800000, 0x7f800000, 0x7f800000)
  or r15.z, r26.z, r26.y
  or r15.z, r26.w, r15.z
  movc r25.xyz, r15.zzzz, l(1.000000,1.000000,0,0), r25.xyzx
  mov r27.xyzw, r18.yzwx
    ...
    if_nz r16.w
      ...
      if_nz r9.w
        ...
        loop 
          ...
          ushr r20.z, r16.z, l(2)
          ubfe r22.w, l(1), l(2), r16.z
          and r23.w, r20.z, l(2)
          max r24.w, r29.x, r29.y
          mad r17.z, -r17.z, r17.w, l(1.000000)
          mul r17.z, r17.z, r29.y
          movc r4.y, r23.w, r17.z, r24.w
          movc r29.xy, r22.wwww, r29.xyxx, r4.xyxx
        ...
        if_nz r16.z
          iadd r30.w, r28.w, l(257)
          mad r31.w, r29.y, r12.w, r27.w
          mul r4.y, r26.x, r4.y
          mul r26.yzw, r4.yyyy, r24.xxyz
          mul r29.xzw, r20.xxyw, r26.zzzz
          mad r29.xzw, r22.xxyz, r26.yyyy, r29.xxzw
          mad r26.yzw, r23.xxyz, r26.wwww, r29.xxzw
          mul r29.xzw, r25.xxyz, r26.yyzw
          dp3 r16.z, r29.xzwx, l(0.212600, 0.715200, 0.072200, 0.000000)
          mad r31.xyz, r26.yzwy, r25.xyzx, r27.xyzx
          mul r16.w, r9.y, r16.z
          mul r26.yzw, r4.yyyy, r21.yyzw
          dp3 r4.y, r26.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
          mad r4.y, r9.y, r16.z, r4.y
          div r4.y, r16.w, r4.y
          mad r30.xyz, r26.yzwy, r4.yyyy, r28.xyzx
        else 
          iadd r30.w, r28.w, l(1)
          mov r31.xyzw, r27.xyzw
          mov r30.xyz, r28.xyzx
        endif 
        mov r15.z, l(-1)
        mov r27.xyzw, r31.xyzw
        mov r28.xyzw, r30.xyzw
        break 
      endif 
    endif 
  endloop 
  if_nz r15.z
    mov r18.xyzw, r27.wxyz
...
if_z r0.y
  ...
  rcp r0.y, r0.y
  mov_sat r18.x, r18.x
  mul r9.yzw, r0.yyyy, r18.yyzw
  mul r19.xyz, r0.yyyy, r19.xyzx
  lt r0.z, r18.x, l(0.990000)
  if_nz r0.z
    iadd r19.w, r19.w, l(256)
    add r0.z, -r18.x, l(1.000000)
    ...
    mad r18.yzw, r18.yyzw, r0.yyyy, r11.xxyz
    mov r10.w, l(0)
...
if_nz r1.w
  ...
  add r1.w, r0.z, r6.w
  div r1.w, r0.z, r1.w
  mad r9.xyz, r7.xyzx, r1.wwww, r18.yzwy
...
movc r7.xyz, r0.yyyy, r9.xyzx, r18.yzwy
...
if_nz cb2[52].y
  if_nz cb2[53].y
    ...
    switch cb2[53].y
      ...
      break 
      case l(4)
      and r1.x, r19.w, l(255)
      break 
      case l(5)
      ubfe r1.x, l(8), l(8), r19.w
      break 
      default 
      mov r1.x, l(0)
      break 
...
mov o0.w, l(1.000000)
ret 
// Approximately 1636 instruction slots used
