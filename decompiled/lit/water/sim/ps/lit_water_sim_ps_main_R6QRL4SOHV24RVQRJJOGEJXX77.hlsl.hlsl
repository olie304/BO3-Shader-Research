...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r21.xyzw, r10.w, l(0), t15.wxyz
  r21.x = samp0[]..swiz;
  r21.y = samp0[]..swiz;
  r21.z = samp0[]..swiz;
  r21.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r22.xyzw, r10.w, l(16), t15.xyzw
  r22.x = samp0[]..swiz;
  r22.y = samp0[]..swiz;
  r22.z = samp0[]..swiz;
  r22.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r23.xyzw, r10.w, l(32), t15.yxwz
  r23.x = samp0[]..swiz;
  r23.y = samp0[]..swiz;
  r23.z = samp0[]..swiz;
  r23.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r24.xyzw, r10.w, l(48), t15.xyzw
  r24.x = samp0[]..swiz;
  r24.y = samp0[]..swiz;
  r24.z = samp0[]..swiz;
  r24.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r25.xyzw, r10.w, l(64), t15.zwxy
  r25.x = samp0[]..swiz;
  r25.y = samp0[]..swiz;
  r25.z = samp0[]..swiz;
  r25.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r26.xyzw, r10.w, l(80), t15.xyzw
  r26.x = samp0[]..swiz;
  r26.y = samp0[]..swiz;
  r26.z = samp0[]..swiz;
  r26.w = samp0[]..swiz;
  ...
  r11.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r27.xyzw, r10.w, l(116), t15.xyzw
  r27.x = samp0[]..swiz;
  r27.y = samp0[]..swiz;
  r27.z = samp0[]..swiz;
  r27.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r28.xyzw, r10.w, l(132), t15.zwxy
  r28.x = samp0[]..swiz;
  r28.y = samp0[]..swiz;
  r28.z = samp0[]..swiz;
  r28.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r29.xyzw, r10.w, l(148), t15.zwxy
  r29.x = samp0[]..swiz;
  r29.y = samp0[]..swiz;
  r29.z = samp0[]..swiz;
  r29.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r30.xyzw, r10.w, l(164), t15.zwxy
  r30.x = samp0[]..swiz;
  r30.y = samp0[]..swiz;
  r30.z = samp0[]..swiz;
  r30.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r31.xyzw, r10.w, l(180), t15.zwxy
  r31.x = samp0[]..swiz;
  r31.y = samp0[]..swiz;
  r31.z = samp0[]..swiz;
  r31.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r32.xyzw, r10.w, l(196), t15.xyzw
  r32.x = samp0[]..swiz;
  r32.y = samp0[]..swiz;
  r32.z = samp0[]..swiz;
  r32.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r33.xy, r10.w, l(212), t15.xyxx
  r33.x = samp0[]..swiz;
  r33.y = samp0[]..swiz;
    r14.xyz = v7.xyz + -r21.yzw;
    r13.z = dot(r14.xyz, r14.xyz);
    r13.z = sqrt(r13.z);
    r13.z = cmp(probeDebugRadius >= r13.z);
    r13.w = (int)r27.y & 0x0000ffff;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r34.xyzw, r13.w, l(0), t16.xyzw
  r34.x = samp0[]..swiz;
  r34.y = samp0[]..swiz;
  r34.z = samp0[]..swiz;
  r34.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r35.xyzw, r13.w, l(16), t16.xyzw
  r35.x = samp0[]..swiz;
  r35.y = samp0[]..swiz;
  r35.z = samp0[]..swiz;
  r35.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r36.xyzw, r13.w, l(32), t16.xyzw
  r36.x = samp0[]..swiz;
  r36.y = samp0[]..swiz;
  r36.z = samp0[]..swiz;
  r36.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r37.xyzw, r13.w, l(48), t16.xyzw
  r37.x = samp0[]..swiz;
  r37.y = samp0[]..swiz;
  r37.z = samp0[]..swiz;
  r37.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r38.xyzw, r13.w, l(64), t16.xyzw
  r38.x = samp0[]..swiz;
  r38.y = samp0[]..swiz;
  r38.z = samp0[]..swiz;
  r38.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r39.xyzw, r13.w, l(80), t16.xyzw
  r39.x = samp0[]..swiz;
  r39.y = samp0[]..swiz;
  r39.z = samp0[]..swiz;
  r39.w = samp0[]..swiz;
    r15.w = dot(r34.xyz, r14.xyz);
    r15.w = saturate(r15.w + r34.w);
    r16.w = dot(r35.xyz, r14.xyz);
    ...
    r16.w = min(abs(r17.w), r16.w);
    r33.zw = r32.zw;
    r17.w = dot(r12.zxy, r33.xzw);
    r18.w = dot(r14.zxy, r33.xzw);
    r18.w = r18.w + -r33.y;
    r21.w = cmp(r18.w >= 0);
    r18.w = max(abs(r18.w), r9.w);
    r18.w = r21.w ? r18.w : -r18.w;
    ...
    r28.xyz = r12.xyz * r16.www + r28.xyz;
    ...
    r27.yzw = cmp((int3)r27.yzw == int3(2139095040,2139095040,2139095040));
    r16.z = (int)r27.z | (int)r27.y;
    r16.z = (int)r27.w | (int)r16.z;
    r26.xyz = r16.zzz ? float3(1,1,0) : r26.xyz;
    r28.xyzw = r19.yzwx;
    r29.xyzw = r20.xyzw;
    r16.z = r10.z;
    r16.w = r11.y;
      ...
      if (r17.w != 0) {
        ...
        if (r13.z != 0) {
          ...
          r36.w = samp0[]..swiz;
            ...
            r30.x = r18.z * r18.w;
            r21.z = (uint)r17.z >> 2;
            if (1 == 0) r23.w = 0; else if (1+2 < 32) {             r23.w = (uint)r17.z << (32-(1 + 2)); r23.w = (uint)r23.w >> (32-1);            } else r23.w = (uint)r17.z >> 2;
            r24.w = (int)r21.z & 2;
            r25.w = max(r30.y, r30.x);
            r18.z = -r18.z * r18.w + 1;
            r18.z = r30.y * r18.z;
            r5.y = r24.w ? r18.z : r25.w;
            r30.xy = r23.ww ? r30.xy : r5.xy;
            r17.w = (int)r17.w + 1;
            r17.z = r21.z;
          }
          ...
          if (r17.z != 0) {
            r31.w = (int)r29.w + 257;
            r32.w = r30.y * r11.w + r28.w;
            r5.y = r5.y * r27.x;
            r27.yzw = r25.xyz * r5.yyy;
            r30.xzw = r27.zzz * r21.xyw;
            r30.xzw = r23.xyz * r27.yyy + r30.xzw;
            r27.yzw = r24.xyz * r27.www + r30.xzw;
            r30.xzw = r27.yzw * r26.xyz;
            r17.z = dot(r30.xzw, float3(0.212599993,0.715200007,0.0722000003));
            r32.xyz = r27.yzw * r26.xyz + r28.xyz;
            r17.w = r17.z * r10.y;
            r27.yzw = r22.yzw * r5.yyy;
            r5.y = dot(r27.yzw, float3(0.212599993,0.715200007,0.0722000003));
            r5.y = r10.y * r17.z + r5.y;
            r5.y = r17.w / r5.y;
            r31.xyz = r27.yzw * r5.yyy + r29.xyz;
          } else {
            r31.w = (int)r29.w + 1;
            r32.xyzw = r28.xyzw;
            r31.xyz = r29.xyz;
  ...
  if (r10.z == 0) {
    ...
    r4.xyz = r19.yzw * r0.zzz;
    r20.xyz = r20.xyz * r0.zzz;
    r5.x = cmp(r19.x < 0.99000001);
    if (r5.x != 0) {
      r20.w = (int)r20.w + 256;
      r5.x = 1 + -r19.x;
  ...
  r0.y = 0;
  r11.xyzw = rColorRamp.Sample(bilinearClamp_s, r0.xy).xyzw;
