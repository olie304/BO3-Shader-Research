...
r1.w = samp0[]..swiz;
  ...
  sincos(r0.y, r7.x, r9.x);
  r0.y = dot(-r6.xyz, r1.xyz);
  r0.y = r0.y + r0.y;
  r10.xyz = r1.xyz * -r0.yyy + -r6.xyz;
  r0.y = 1 + -r5.y;
  r0.y = 5 * r0.y;
  ...
  if (useSSR != 0) {
    ...
    r10.xyz = v9.xxx ? r10.xyz : r11.xyz;
    if (useLoopedSSR != 0) {
      ...
      r11.xyz = r12.xyz * float3(10,10,10) + r11.xyz;
      ...
      while (true) {
        ...
        r15.xy = r15.xy / r15.zz;
        r15.xy = r15.xy * float2(0.5,-0.5) + float2(0.5,0.5);
        r1.w = ifloatZSceneDownsampled.SampleLevel(bilinearClamp_s, r15.xy, 1).x;
        r5.y = cmp(abs(r1.w) < r14.z);
        r6.w = cmp(abs(r1.w) >= v0.w);
        r5.y = r5.y ? r6.w : 0;
        if (r5.y != 0) {
          r1.w = r14.z + -abs(r1.w);
          ...
          r15.xy = r15.xy / r15.zz;
          r15.xy = r15.xy * float2(0.5,-0.5) + float2(0.5,0.5);
          r15.xyz = iResolveScene.SampleLevel(bilinearClamp_s, r15.xy, 0).xyz;
      ...
      r10.xyz = viewProjectionMatrix._m30_m31_m33 + r10.xyz;
      r0.yz = r10.xy / r10.zz;
      r1.w = max(abs(r0.y), abs(r0.z));
      r0.yz = r0.yz * float2(0.5,-0.5) + float2(0.5,0.5);
      r5.y = ifloatZSceneDownsampled.SampleLevel(bilinearClamp_s, r0.yz, 0).x;
      r5.y = cmp(abs(r5.y) >= v0.w);
      r1.w = cmp(r1.w < 1);
      r1.w = r1.w ? r5.y : 0;
      r10.xyz = iResolveScene.Sample(bilinearClamp_s, r0.yz).xyz;
      if (r1.w != 0) {
        r9.yzw = relHDRExposure.xxx * r10.xyz;
      }
    }
  }
  ...
  if (r1.w == 0) {
    r10.xyz = sunConstants.sstLightingConstants.offToPinTransform._m10_m11_m12 * v6.yyy;
    r10.xyz = v6.xxx * sunConstants.sstLightingConstants.offToPinTransform._m00_m01_m02 + r10.xyz;
    r10.xyz = v6.zzz * sunConstants.sstLightingConstants.offToPinTransform._m20_m21_m22 + r10.xyz;
    r10.xyz = sunConstants.sstLightingConstants.offToPinTransform._m30_m31_m32 + r10.xyz;
    r1.w = -sunConstants.splitDepthOffset + r10.z;
    ...
    if (r6.w != 0) {
      ...
      while (true) {
        ...
        if (r11.x != 0) break;
        r11.x = (uint)r6.w;
        r11.yz = -sunConstants.splitPinTransform[r11.x].xy + r10.xy;
        r11.y = max(abs(r11.y), abs(r11.z));
        r10.w = sunConstants.splitPinTransform[r11.x].z * r11.y;
        r11.x = cmp(r10.w < 1);
        if (r11.x != 0) {
          break;
        }
    ...
    if (r11.x != 0) {
      ...
      r12.xz = rcp(r11.yy);
      r12.y = -r12.z;
      r11.yzw = r10.xyx * r12.xyz + r11.zwz;
    ...
    r12.y = samp0[]..swiz;
      ...
      r15.w = samp0[]..swiz;
        ...
        r11.z = samp0[]..swiz;
          ...
          r11.z = r10.x * r11.w + r11.z;
          r11.y = r10.y * r11.y + r11.z;
          r12.w = r12.y ? r11.y : r12.w;
        }
      }
      r10.z = -sunConstants.sstLightingConstants.constants.inchesPerTexel * 2 + r10.z;
      r10.z = cmp(r12.w < r10.z);
      r5.y = r10.z ? 0 : 1;
    }
    if (r11.x == 0) {
      if (enableDitheredShadow == 0) {
        r10.z = (uint)r6.w;
        r11.xy = -sunConstants.splitPinTransform[r10.z].xy + r10.xy;
        r11.xy = sunConstants.splitPinTransform[r10.z].zz * r11.xy;
        r11.xy = r11.xy * float2(0.5,-0.5) + float2(0.5,0.5);
        r10.z = (int16)sunConstants.splitArrayOffset;
        r11.z = r10.z + r6.w;
        r10.z = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r11.xyz, r1.w).x;
      ...
      if (enableDitheredShadow != 0) {
        ...
        r10.w = 28 * r10.w;
        r10.w = (uint)r10.w;
        r12.xy = -sunConstants.splitPinTransform[r10.z].xy + r10.xy;
        r12.xy = sunConstants.splitPinTransform[r10.z].zz * r12.xy;
        r12.xy = r12.xy * float2(0.5,-0.5) + float2(0.5,0.5);
        r10.xy = -sunConstants.splitPinTransform[r6.w].xy + r10.xy;
        r10.xy = sunConstants.splitPinTransform[r6.w].zz * r10.xy;
        ...
        while (true) {
          ...
          if (r12.w != 0) break;
          r12.w = cmp((uint)r10.w < (uint)r12.z);
          r13.xy = r12.ww ? r10.xy : r12.xy;
          r13.z = r12.w ? sunConstants.splitPinTransform[r6.w].w : sunConstants.splitPinTransform[r10.z].w;
          r12.w = r12.w ? r6.w : r10.z;
          r14.x = dot(icb[r12.z+0].yx, r11.xy);
          r14.y = dot(icb[r12.z+0].yx, r11.yz);
          r13.xy = r14.xy * r13.zz + r13.xy;
          r12.w = (int)r12.w + (int16)sunConstants.splitArrayOffset;
          r13.z = (uint)r12.w;
          r12.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r13.xyz, r1.w).x;
          r13.x = gTransShadowmapArray.SampleLevel(samp0_s, r13.xyz, 0).x;
          r12.w = r13.x + r12.w;
          r12.w = saturate(-1 + r12.w);
          r11.w = r12.w * 0.125 + r11.w;
          r12.z = (int)r12.z + 1;
        }
        r1.w = r11.w * r11.w;
        r5.y = r1.w * r11.w;
  ...
  r15.w = samp0[]..swiz;
    ...
    r10.z = dot(r13.xyzw, r16.xyzw);
    r10.w = cmp(r10.z < r0.y);
    r10.xy = r10.xy / r10.zz;
    r10.xy = r10.xy * float2(0.5,-0.5) + float2(0.5,0.5);
    r10.xy = r10.xy + r15.zw;
    r10.xy = r10.xy * r15.xy;
    r11.xy = r6.ww / r14.xz;
    r11.zw = float2(1,1) + -r11.xy;
    r11.zw = cmp(r10.xy >= r11.zw);
    r11.xy = cmp(r11.xy >= r10.xy);
    r11.xy = (int2)r11.xy | (int2)r11.zw;
    ...
    r11.y = samp0[]..swiz;
      ...
      r12.xy = r10.xy * r14.xz + r14.yw;
      r1.w = r11.y * r10.z;
      r0.y = r11.x * r10.z + r0.y;
      r0.y = r0.y / r1.w;
      r0.y = max(6.10351563e-05, r0.y);
      r1.w = r10.w ? 0.000000 : 0;
      if (enableDitheredShadow != 0) {
        r10.x = -r7.x;
        r11.z = (uint)r1.w;
        r10.y = r9.x;
        ...
        r9.x = 0;
        while (true) {
          r10.w = cmp((int)r9.x >= 8);
          if (r10.w != 0) break;
          r13.x = dot(icb[r9.x+0].yx, r10.xy);
          r13.y = dot(icb[r9.x+0].yx, r10.yz);
          r11.xy = r13.xy * r6.ww + r12.xy;
          r10.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r11.xyz, r0.y).x;
          r7.x = r10.w * 0.125 + r7.x;
          r9.x = (int)r9.x + 1;
        }
      } else {
        r12.z = (uint)r1.w;
        r7.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r12.xyz, r0.y).x;
      }
      r0.y = r7.x * r7.x;
      r0.y = r0.y * r7.x;
    } else {
  ...
  if (r1.w != 0) {
    if (sunConstants.sunCookieIndex != 0) {
      ...
      r10.w = 1;
      r1.w = dot(sunConstants.sunCookieTransform[0].xyzw, r10.xyzw);
      r6.w = dot(sunConstants.sunCookieTransform[1].xyzw, r10.xyzw);
      r10.x = frac(r1.w);
      r10.y = frac(r6.w);
    ...
    r5.y = r1.z * r1.z;
    r5.yz = r5.yy * specularLobeRoughnessControl.xz + float2(1,1);
    r5.yz = r5.yz * r5.yz;
    ...
    r6.xyz = r10.xyz * r1.zzz;
    r6.xyz = r6.xyz * r0.zzz + r9.yzw;
    r10.xyz = r10.xyz * r1.www;
    r6.xyz = r10.xyz * r0.zzz + r6.xyz;
  } else {
    r11.xyz = r7.yzw;
    r6.xyz = r9.yzw;
  }
  r7.xyz = r0.yyy ? r11.xyz : r7.yzw;
  r6.xyz = r0.yyy ? r6.xyz : r9.yzw;
  r4.yw = float2(0,0);
