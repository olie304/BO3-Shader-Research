...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  if (r5.x != 0) {
    ...
    r1.z = saturate(dot(r12.xyz, r9.xyz));
    r3.w = r0.y * r0.y;
  ...
  r1.w = saturate(invZFeatherDepth * r1.w);
  r1.w = r1.w * r0.w;
  r0.w = useSpecularZFeather ? r1.w : r0.w;
