...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:39:39 2021
//
//
// Buffer Definitions: 
//
...
//   float invZFeatherDepth;            // Offset:  312 Size:     4
...
//   bool useSpecularZFeather;          // Offset:  464 Size:     4
...
loop 
  ...
  mad r28.xyz, r10.xyzx, r15.wwww, r28.xyzx
  dp3 r16.w, r28.xyzx, r28.xyzx
  sqrt r16.w, r16.w
  div r15.w, r15.w, r16.w
  add r15.w, r15.w, r15.w
  sqrt r15.w, r15.w
  mad r15.w, r7.y, l(5.000000), r15.w
  ...
  ubfe r22.xy, l(6, 9, 0, 0), l(25, 16, 0, 0), r27.yyyy
  utof r29.w, r22.y
  sample_l_indexable(texturecubearray)(float,float,float,float) r22.yzw, r29.xyzw, t8.wxyz, s2, r15.w
  and r27.yzw, r22.yyzw, l(0, 0x7fffffff, 0x7fffffff, 0x7fffffff)
  ieq r27.yzw, r27.yyzw, l(0, 0x7f800000, 0x7f800000, 0x7f800000)
  or r15.w, r27.z, r27.y
  or r15.w, r27.w, r15.w
  movc r22.yzw, r15.wwww, l(0,1.000000,1.000000,0), r22.yyzw
    ...
    if_nz r17.z
      ...
      if_nz r9.w
        ...
        loop 
          ...
          dp3 r21.z, r31.xyzx, r13.xyzx
          add_sat r21.z, r31.w, r21.z
          mul r17.w, r17.w, r21.z
          dp3 r21.z, r32.xyzx, r13.xyzx
          add_sat r21.z, r32.w, r21.z
          mul r17.w, r17.w, r21.z
          dp3 r21.z, r33.xyzx, r13.xyzx
          add_sat r21.z, r33.w, r21.z
          mul r17.w, r17.w, r21.z
          dp3 r21.z, r34.xyzx, r13.xyzx
          add_sat r21.z, r34.w, r21.z
          mul r17.w, r17.w, r21.z
          dp3 r21.z, r35.xyzx, r13.xyzx
          add_sat r21.z, r35.w, r21.z
          mul r29.x, r17.w, r21.z
          ushr r23.w, r16.w, l(2)
          ubfe r24.w, l(1), l(2), r16.w
          and r25.w, r23.w, l(2)
          max r26.w, r29.x, r29.y
          mad r17.w, -r17.w, r21.z, l(1.000000)
          mul r17.w, r17.w, r29.y
          movc r4.y, r25.w, r17.w, r26.w
          movc r29.xy, r24.wwww, r29.xyxx, r4.xyxx
          iadd r17.z, r17.z, l(1)
          mov r16.w, r23.w
        endloop 
        mov_sat r29.y, r29.y
        mul r4.y, r12.w, r29.y
        lt r16.w, l(0.000000), r4.y
        if_nz r16.w
          iadd r16.w, r15.z, l(257)
          mad r30.z, r29.y, r12.w, r27.w
          mul r4.y, r27.x, r4.y
          ...
          mul r17.w, r9.y, r17.z
          mul r29.xzw, r4.yyyy, r22.yyzw
          dp3 r4.y, r29.xzwx, l(0.212600, 0.715200, 0.072200, 0.000000)
          mad r4.y, r9.y, r17.z, r4.y
          div r4.y, r17.w, r4.y
          mov r32.x, r28.w
          mov r32.yz, r27.yyzy
...
if_z r0.y
  ...
  mov r22.xyzw, r18.wxyz
  mov r23.xyz, r19.yzwy
  mov r23.w, r20.w
  mov r9.w, r0.z
  loop 
    ...
    loop 
      ...
      if_nz r13.z
        ...
        and r13.y, r26.y, r26.x
        and r13.y, r26.z, r13.y
        if_nz r13.y
          ...
          mov r17.w, l(1)
          loop 
            ige r21.w, r17.w, r15.w
            breakc_nz r21.w
            iadd r21.w, r14.w, r17.w
            ...
            movc r16.y, r29.w, r21.w, r30.x
            movc r29.xy, r29.zzzz, r29.xyxx, r16.xyxx
            iadd r17.w, r17.w, l(1)
            mov r14.x, r28.w
          endloop 
          mov_sat r29.y, r29.y
          mul r13.y, r13.z, r29.y
          ...
          if_nz r14.x
            ...
            mad r25.z, r29.y, r13.z, r25.z
            mul r13.x, r27.z, r13.y
            mov r27.z, r35.z
            dp3 r13.y, r10.xyzx, r27.xyzx
            dp3 r13.z, r28.xyzx, r27.xyzx
            ...
            sqrt r13.y, r13.y
            mad r13.y, r7.y, l(5.000000), r13.y
            ...
            utof r35.w, r13.z
            sample_l_indexable(texturecubearray)(float,float,float,float) r16.yzw, r35.xyzw, t8.wxyz, s2, r13.y
            and r29.xzw, r16.yyzw, l(0x7fffffff, 0, 0x7fffffff, 0x7fffffff)
            ieq r29.xzw, r29.xxzw, l(0x7f800000, 0, 0x7f800000, 0x7f800000)
            or r13.y, r29.z, r29.x
            or r13.y, r29.w, r13.y
            ...
            or r13.y, r28.y, r28.x
            or r13.y, r28.z, r13.y
            movc r27.xyz, r13.yyyy, l(1.000000,1.000000,0,0), r27.xyzx
            mul r28.xyz, r26.xyzx, r27.xyzx
            dp3 r13.y, r28.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
            mad r24.xyz, r26.xyzx, r27.xyzx, r24.xyzx
            mul r13.z, r9.y, r13.y
            ...
            mov r26.x, r24.w
            mov r26.yz, r25.xxyx
            mad r13.xyz, r16.yzwy, r13.xxxx, r26.xyzx
            mov r24.w, r13.x
            mov r25.xy, r13.yzyy
          else 
    ...
    endloop 
    mov r22.xyzw, r24.wxyz
    mov r23.xyzw, r25.xyzw
    iadd r9.w, r9.w, l(32)
  endloop 
  mov r20.xyzw, r23.zxyw
  lt r4.y, r20.x, l(1.000000)
  if_nz r4.y
    mov r12.xy, l(0,0,0,0)
    mov r13.w, l(0)
    mov r14.yz, l(0,0,1.000000,0)
    ...
    loop 
      ...
      loop 
        ...
        if_nz r21.w
          ...
          mov r27.z, r26.w
          lt r26.xyz, |r26.xyzx|, r27.zxyz
          and r19.w, r26.y, r26.x
          and r19.w, r26.z, r19.w
          if_nz r19.w
            ...
            dp3 r23.w, r30.xyzx, r29.xyzx
            add_sat r23.w, r30.w, r23.w
            dp3 r24.w, r31.xyzx, r29.xyzx
            ...
            mul r14.x, r23.w, r24.w
            and r23.w, r27.x, l(1)
            movc r27.zw, r23.wwww, r14.xxxy, r14.zzzx
            mov r14.x, r27.x
            mov r30.xy, r27.zwzz
            mov r23.w, l(1)
            loop 
              ige r24.w, r23.w, r21.w
              breakc_nz r24.w
              ...
              mad r24.w, -r24.w, r25.w, l(1.000000)
              mul r24.w, r24.w, r30.y
              movc r16.y, r30.z, r24.w, r30.w
            ...
            if_nz r19.w
              ...
              iadd r16.w, r16.w, l(257)
              mad r16.z, r14.x, r27.y, r16.z
              mul r14.x, r28.z, r16.y
              mov r28.z, r36.z
              dp3 r16.y, r10.xyzx, r28.xyzx
              ...
              mov r36.z, r37.z
              dp3 r17.w, r10.xyzx, r36.xyzx
              dp3 r19.w, r29.xyzx, r36.xyzx
              ...
              min r16.y, r16.y, |r17.w|
              mov r37.z, r38.z
              dp3 r17.w, r10.xyzx, r37.xyzx
              dp3 r19.w, r29.xyzx, r37.xyzx
              ...
              min r16.y, r16.y, |r17.w|
              mov r38.z, r39.z
              dp3 r17.w, r10.xyzx, r38.xyzx
              dp3 r19.w, r29.xyzx, r38.xyzx
              ...
              min r16.y, r16.y, |r17.w|
              mov r39.z, r40.x
              dp3 r17.w, r10.xyzx, r39.xyzx
              dp3 r19.w, r29.xyzx, r39.xyzx
              ...
              min r16.y, r16.y, |r17.w|
              mov r41.zw, r40.zzzw
              dp3 r17.w, r10.zxyz, r41.xzwx
              dp3 r19.w, r29.zxyz, r41.xzwx
              ...
              sqrt r16.y, r16.y
              mad r16.y, r7.y, l(5.000000), r16.y
              ...
              utof r36.w, r17.w
              sample_l_indexable(texturecubearray)(float,float,float,float) r27.xyz, r36.xyzw, t8.xyzw, s2, r16.y
              and r30.xzw, r27.xxyz, l(0x7fffffff, 0, 0x7fffffff, 0x7fffffff)
              ieq r30.xzw, r30.xxzw, l(0x7f800000, 0, 0x7f800000, 0x7f800000)
              or r16.y, r30.z, r30.x
              or r16.y, r30.w, r16.y
              movc r27.xyz, r16.yyyy, l(1.000000,1.000000,0,0), r27.xyzx
              ...
              mad r13.xyz, r26.xyzx, r28.xyzx, r13.xyzx
              mul r16.y, r9.y, r15.z
              mul r26.xyz, r14.xxxx, r27.xyzx
              dp3 r14.x, r26.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
              mad r14.x, r9.y, r15.z, r14.x
              div r14.x, r16.y, r14.x
              mad r25.xyz, r26.xyzx, r14.xxxx, r25.xyzx
            else 
  ...
  max r0.y, r20.x, l(1.000000)
  rcp r0.y, r0.y
  mov_sat r20.x, r20.x
  mul r18.xyz, r0.yyyy, r23.xyzx
  mul r19.xyz, r0.yyyy, r22.xyzx
  lt r0.z, r20.x, l(0.990000)
  if_nz r0.z
    iadd r20.w, r20.w, l(256)
    add r0.z, -r20.x, l(1.000000)
    mul r4.x, r0.z, cb2[19].x
    add r9.yzw, v6.xxyz, -cb2[35].xxyz
    mul r11.x, r9.y, cb2[35].w
    mul r11.yz, r9.zzwz, cb2[36].xxyx
    add_sat r9.yzw, r11.xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
    mul r11.xy, r9.yzyy, cb2[36].zwzz
    mul r11.z, r9.w, cb2[37].x
    add r9.yzw, r11.xxyz, cb2[37].yyzw
    lt r11.xyz, l(0.000000, 0.000000, 0.000000, 0.000000), r1.xyzx
    movc r11.xyz, r11.xyzx, l(0,0,0,0), l(0.500000,0.500000,0.500000,0)
    mov r11.w, l(0)
    add r12.xyz, r9.yzwy, r11.wwxw
    ...
    add r9.yzw, r9.yyzw, r11.wwwz
    sample_l_indexable(texture3d)(float,float,float,float) r9.yzw, r9.yzwy, t19.wxyz, s4, l(0.000000)
    mad r9.yzw, r9.yyzw, r13.zzzz, r12.xxyz
    mov r1.w, l(0)
    sample_l_indexable(texturecubearray)(float,float,float,float) r11.xyz, r1.xyzw, t8.xyzw, s2, l(6.000000)
    mul r9.yzw, r9.yyzw, r11.xxyz
    dp3 r1.w, r9.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
    mad r18.xyz, r23.xyzx, r0.yyyy, r9.yzwy
    mov r10.w, l(0)
    ...
    mad r19.xyz, r7.yzwy, r0.yyyy, r19.xyzx
  endif 
else 
  mov r19.x, r18.w
endif 
if_nz cb0[28].z
  ...
  dp3 r0.y, r2.yzwy, -r1.xyzx
  add r0.y, r0.y, r0.y
  mad r9.yzw, r1.xxyz, r0.yyyy, r2.yyzw
  movc r7.yzw, v9.xxxx, r7.yyzw, r9.yyzw
  if_nz cb0[28].w
    mul r9.yzw, v6.yyyy, cb1[5].xxyz
    mad r9.yzw, v6.xxxx, cb1[4].xxyz, r9.yyzw
    mad r9.yzw, v6.zzzz, cb1[6].xxyz, r9.yyzw
    mul r10.xyz, r7.yzwy, cb0[21].zzzz
    mul r11.xyz, r10.yyyy, cb1[5].xyzx
    mad r10.xyw, r10.xxxx, cb1[4].xyxz, r11.xyxz
    mad r10.xyz, r10.zzzz, cb1[6].xyzx, r10.xywx
    min r0.y, cb0[21].x, l(1000.000000)
    mad r9.yzw, r10.xxyz, l(0.000000, 10.000000, 10.000000, 10.000000), r9.yyzw
    ...
    loop 
      ...
      mul r13.xyz, r12.yyyy, cb1[1].xywx
      mad r13.xyz, r12.xxxx, cb1[0].xywx, r13.xyzx
      mad r13.xyz, r12.zzzz, cb1[2].xywx, r13.xyzx
      add r13.xyz, r13.xyzx, cb1[3].xywx
      max r1.w, |r13.y|, |r13.x|
      lt r1.w, r13.z, r1.w
      if_nz r1.w
        break 
      endif 
      div r4.xy, r13.xyxx, r13.zzzz
      ...
      if_nz r4.x
        ...
        mad r13.xyz, -r1.wwww, r10.xyzx, r12.xyzx
        mul r14.xyz, r13.yyyy, cb1[1].xywx
        mad r13.xyw, r13.xxxx, cb1[0].xyxw, r14.xyxz
        mad r13.xyz, r13.zzzz, cb1[2].xywx, r13.xywx
        add r13.xyz, r13.xyzx, cb1[3].xywx
        div r4.xy, r13.xyxx, r13.zzzz
        mad r4.xy, r4.xyxx, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
        sample_l_indexable(texture2d)(float,float,float,float) r13.xyz, r4.xyxx, t30.xyzw, s8, l(0.000000)
        mul r13.xyz, r13.xyzx, cb1[85].xxxx
    ...
    mul r9.yzw, r7.zzzz, cb1[9].xxyw
    mad r9.yzw, r7.yyyy, cb1[8].xxyw, r9.yyzw
    mad r7.yzw, r7.wwww, cb1[10].xxyw, r9.yyzw
    ...
    if_nz r1.w
      mul r19.xyz, r7.yzwy, cb1[85].xxxx
    endif 
  endif 
endif 
...
if_z r1.w
  ...
  if_nz r4.y
    ...
    mov r5.y, l(0)
    loop 
      ge r9.y, r4.y, l(3.000000)
      breakc_nz r9.y
      ftou r9.y, r4.y
      add r9.zw, r7.yyyz, -cb2[r9.y + 20].xxxy
      max r9.z, |r9.w|, |r9.z|
      mul r5.y, r9.z, cb2[r9.y + 20].z
      lt r9.y, r5.y, l(1.000000)
      if_nz r9.y
        break 
      endif 
  ...
  if_nz r9.y
    ...
    rcp r11.xz, r10.xxxx
    mov r11.y, -r11.z
    mad r10.xyz, r7.yzyy, r11.xyzx, r10.yzyy
    ...
    mul r9.zw, r10.zzzy, cb2[32].xxxx
    ...
    if_z r10.w
      ...
      if_z r9.z
        ...
        iadd r9.z, -r13.y, l(6)
        ushr r9.zw, r10.zzzy, r9.zzzz
        and r11.z, r13.z, l(0xc0000000)
        or r12.y, r13.z, l(0x40000000)
        bfi r9.w, l(1), l(1), r9.w, l(0)
        bfi r9.z, l(1), l(0), r9.z, r9.w
        imul null, r9.z, r9.z, l(10)
        ushr r9.z, r12.y, r9.z
        and r9.z, r9.z, l(1023)
        iadd r14.x, r9.z, r13.x
        ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r14.y, r14.x, l(0), t23.xxxx
        movc r9.zw, r11.zzzz, r13.xxxz, r14.xxxy
        movc r11.yw, r10.wwww, r12.xxxw, r9.zzzw
      endif 
      and r9.z, r11.w, l(0xc0000000)
      if_z r9.z
        ubfe r9.w, l(14), l(15), r11.w
        utof r9.w, r9.w
  ...
  if_z r9.y
    if_z cb2[58].y
      ftou r7.w, r4.y
      add r9.yz, r7.yyzy, -cb2[r7.w + 20].xxyx
      mul r9.yz, r9.yyzy, cb2[r7.w + 20].zzzz
      mad r10.xy, r9.yzyy, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
      itof r7.w, cb2[26].y
      add r10.z, r4.y, r7.w
      sample_c_lz_indexable(texture2darray)(float,float,float,float) r7.w, r10.xyzx, t13.xxxx, s13, r1.w
      sample_l_indexable(texture2darray)(float,float,float,float) r9.y, r10.xyzx, t31.yxzw, s0, l(0.000000)
      add r7.w, r7.w, r9.y
    ...
    if_nz cb2[58].y
      ...
      loop 
        uge r11.x, r10.w, l(8)
        breakc_nz r11.x
        ult r11.x, r5.y, r10.w
        movc r11.yz, r11.xxxx, r7.yyzy, r9.yyzy
        movc r11.w, r11.x, cb2[r4.y + 20].w, cb2[r7.w + 20].w
        movc r11.x, r11.x, r4.y, r7.w
        dp2 r12.x, icb[r10.w + 0].yxyy, r10.xyxx
        dp2 r12.y, icb[r10.w + 0].yxyy, r10.yzyy
        mad r12.xy, r12.xyxx, r11.wwww, r11.yzyy
        iadd r11.x, r11.x, cb2[26].y
        utof r12.z, r11.x
        sample_c_lz_indexable(texture2darray)(float,float,float,float) r11.x, r12.xyzx, t13.xxxx, s13, r1.w
        ...
        mad r9.w, r11.x, l(0.125000), r9.w
...
if_nz r4.y
  ...
  div r9.yz, r4.yyyy, r14.xxzx
  add r10.xy, -r9.yzyy, l(1.000000, 1.000000, 0.000000, 0.000000)
  ge r10.xy, r7.zwzz, r10.xyxx
  ge r9.yz, r9.yyzy, r7.zzwz
  or r9.yz, r9.yyzy, r10.xxyx
  or r9.y, r9.z, r9.y
  or r7.y, r7.y, r9.y
  if_z r7.y
    ...
    mad r10.xy, r7.zwzz, r14.xzxx, r14.ywyy
    mul r1.w, r5.y, r9.z
    mad r0.y, r9.y, r5.y, r0.y
    div r0.y, r0.y, r1.w
    ...
    if_nz cb2[58].y
      ...
      loop 
        ige r7.y, r7.x, l(8)
        breakc_nz r7.y
        dp2 r9.x, icb[r7.x + 0].yxyy, r11.xyxx
        dp2 r9.y, icb[r7.x + 0].yxyy, r11.yzyy
        mad r12.xy, r9.xyxx, r4.yyyy, r10.xyxx
        sample_c_lz_indexable(texture2darray)(float,float,float,float) r7.y, r12.xyzx, t9.xxxx, s13, r0.y
        mad r5.y, r7.y, l(0.125000), r5.y
        iadd r7.x, r7.x, l(1)
      endloop 
    else 
      utof r10.z, r1.w
      sample_c_lz_indexable(texture2darray)(float,float,float,float) r5.y, r10.xyzx, t9.xxxx, s13, r0.y
    endif 
    mul r0.y, r5.y, r5.y
    mul r0.y, r5.y, r0.y
  else 
...
if_nz r1.w
  ...
  add r1.w, r0.z, r6.w
  div r1.w, r0.z, r1.w
  mad r9.xyz, r7.xyzx, r1.wwww, r18.xyzx
  mad r10.xyz, -v6.xyzx, r5.zzzz, cb2[17].xyzx
  dp3 r1.w, r10.xyzx, r10.xyzx
  rsq r1.w, r1.w
  mul r10.xyz, r1.wwww, r10.xyzx
  dp3_sat r1.z, r1.xyzx, r10.xyzx
  dp3_sat r1.w, r10.xyzx, r6.xyzx
  mul r4.x, r1.z, r1.z
  mad r4.xy, r4.xxxx, cb0[15].xzxx, l(1.000000, 1.000000, 0.000000, 0.000000)
  mul r4.xy, r4.xyxx, r4.xyxx
  div r4.xy, cb0[15].ywyy, r4.xyxx
  mul r4.xy, r1.zzzz, r4.xyxx
  mul r1.z, r1.w, l(4.000000)
  div r1.zw, r4.xxxy, r1.zzzz
  mul r1.zw, r1.zzzw, cb0[16].xxxy
  mul r6.xyz, r1.zzzz, r7.xyzx
  mad r6.xyz, r6.xyzx, r0.zzzz, r19.xyzx
...
movc r7.xyz, r0.yyyy, r9.xyzx, r18.xyzx
movc r6.xyz, r0.yyyy, r6.xyzx, r19.xyzx
...
min r0.z, r0.z, l(500.000000)
mad r1.xy, r0.zzzz, r1.xyxx, v0.xyxx
add r4.xy, cb1[44].xyxx, l(-1.000000, -1.000000, 0.000000, 0.000000)
max r1.xy, r1.xyxx, l(0.000000, 0.000000, 0.000000, 0.000000)
min r1.xy, r4.xyxx, r1.xyxx
ftoi r10.xy, r1.xyxx
mov r10.zw, l(0,0,0,0)
ld_indexable(texture2d)(float,float,float,float) r0.z, r10.xyzw, t29.yzxw
...
sample_indexable(texture2d)(float,float,float,float) r4.xyw, r1.xyxx, t30.xywz, s9
if_z r0.x
  ftoi r10.xy, v0.xyxx
  mov r10.zw, l(0,0,0,0)
  ld_indexable(texture2d)(float,float,float,float) r4.xyw, r10.xyzw, t30.xywz
endif 
mul r10.xyz, r4.xywx, cb1[85].xxxx
add r0.x, r3.y, r3.y
mad r0.z, r3.y, l(2.000000), l(1.000000)
log r0.z, r0.z
mul r1.x, r0.z, l(0.08333334)
mov r1.y, l(0)
sample_indexable(texture2d)(float,float,float,float) r11.xyzw, r1.xyxx, t37.xyzw, s8
mul r11.xyz, r10.xyzx, r11.xyzx
mul r0.z, r9.w, r11.w
mad r9.xyz, r9.xyzx, r7.xyzx, -r11.xyzx
mad r9.xyz, r0.zzzz, r9.xyzx, r11.xyzx
mad r4.xyw, -r4.xyxw, cb1[85].xxxx, r9.xyxz
mad r4.xyw, r5.xxxx, r4.xyxw, r10.xyxz
mad r3.xyz, r3.xzwx, r7.xyzx, -r4.xywx
mad r3.xyz, r8.wwww, r3.xyzx, r4.xywx
mad r4.xyw, r6.xyxz, r0.wwww, r8.xyxz
add r0.z, -r4.z, l(1.000000)
mul r0.w, r0.z, r0.z
mul r0.w, r0.w, r0.w
mul r0.z, r0.w, r0.z
mad r0.z, r0.z, l(0.980000), l(0.020000)
mul_sat r0.x, r0.x, cb0[19].z
mul r0.x, r0.x, r0.z
movc r0.x, cb0[29].x, r0.x, r0.z
add r4.xyz, -r3.xyzx, r4.xywx
mad r0.xzw, r0.xxxx, r4.xxyz, r3.xxyz
mad r3.xyz, cb0[22].yzwy, r7.xyzx, -r0.xzwx
mad r3.xyz, r5.wwww, r3.xyzx, r0.xzwx
movc r0.xzw, cb0[28].yyyy, r3.xxyz, r0.xxzw
if_nz cb2[52].y
  if_nz cb2[53].y
    and r1.xy, r0.yyyy, r1.wzww
    switch cb2[53].y
      case l(1)
      mov r1.x, l(1)
      break 
      ...
      break 
      case l(4)
      and r1.x, r20.w, l(255)
      break 
      case l(5)
      ubfe r1.x, l(8), l(8), r20.w
      break 
      default 
      mov r1.x, l(0)
      break 
    endswitch 
    utof r0.y, r1.x
    mad r1.xyz, r0.yyyy, l(50.000000, 50.000000, 50.000000, 0.000000), -r0.xzwx
    mad r0.xzw, cb2[53].wwww, r1.xxyz, r0.xxzw
  endif 
endif 
...
if_nz r0.y
  ...
  if_nz r1.x
    mad r1.xy, r0.yyyy, cb2[15].xyxx, cb2[14].zwzz
  ...
  mad r1.xyz, r0.xzwx, r1.xyzx, r3.xyzx
else 
  mul r0.y, v6.z, cb2[6].x
  mad r1.w, cb2[6].x, v6.z, cb2[5].x
  lt r3.x, |r0.y|, l(0.000100)
  ...
  movc r0.y, r3.x, l(1.000000), r0.y
  div r0.y, r1.w, r0.y
  movc r0.y, r3.x, r3.z, r0.y
...
mov o0.w, l(1.000000)
ret 
// Approximately 2211 instruction slots used
