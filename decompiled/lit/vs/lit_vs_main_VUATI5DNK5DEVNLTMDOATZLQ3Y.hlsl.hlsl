...
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r1.xyzw, r0.x, l(16), t5.xwyz
...
r0.w = modelInstanceBuffer[]..swiz;
  ...
  r4.xyz = v0.xyz;
  r4.w = 1;
  r5.y = dot(r4.xyzw, r2.xyzw);
  r6.xyzw = viewProjectionMatrix._m10_m11_m12_m13 * r5.yyyy;
  r3.w = r1.x;
  r0.w = r1.z;
  r5.x = dot(r4.xyzw, r3.xyzw);
  r1.xyzw = r5.xxxx * viewProjectionMatrix._m00_m01_m02_m03 + r6.xyzw;
  r5.z = dot(r4.xyzw, r0.xyzw);
  r1.xyzw = r5.zzzz * viewProjectionMatrix._m20_m21_m22_m23 + r1.xyzw;
  o5.xyz = r5.xyz;
  ...
  r0.w = rsqrt(r0.w);
  o2.xyz = r4.xyz * r0.www;
  r4.xyz = v4.xyz * float3(2.00195694,2.00195694,2.00195694) + float3(-1.00195694,-1.00195694,-1.00195694);
  r5.x = dot(r4.xyz, r3.xyz);
  r5.y = dot(r4.xyz, r2.xyz);
  r5.z = dot(r4.xyz, r0.xyz);
  r0.w = dot(r5.xyz, r5.xyz);
  r0.w = rsqrt(r0.w);
  o3.xyz = r5.xyz * r0.www;
  r5.xyz = r4.yzx * r1.zxy;
  r1.xyz = r1.yzx * r4.zxy + -r5.xyz;
  r0.w = v4.w * 2 + -1;
