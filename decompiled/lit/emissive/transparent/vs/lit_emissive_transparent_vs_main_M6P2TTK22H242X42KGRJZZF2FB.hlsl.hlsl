// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:35:29 2021
...
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r1.x, v5.x, l(4), t4.xxxx
r1.x = shaderConstantSetBuffer[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) r1.x, r1.x, l(96), t0.xxxx
r1.x = shaderConstantSetBuffer[]..swiz;
  r1.yzw = v3.xyz * float3(2.00195694,2.00195694,2.00195694) + float3(-1.00195694,-1.00195694,-1.00195694);
  r0.xyz = r1.yzw * r1.xxx + v0.xyz;
// Known bad code for instruction (needs manual fix):
...
r0.z = shaderConstantSetBuffer[]..swiz;
  ...
  o3.xyz = frac(r0.xyz);
  p3.x = v5.x;
  r0.x = dot(r1.yzw, r2.xyz);
  r0.y = dot(r1.yzw, r4.xyz);
  r0.z = dot(r1.yzw, r5.xyz);
  ...
  r3.xyz = r1.wyz * r0.yzx;
  r0.xyz = r1.zwy * r0.zxy + -r3.xyz;
  r0.w = v4.w * 2 + -1;
