...
r0.z = samp0[]..swiz;
  ...
  r4.xyw = debugSpecularOverride.xyz + -r2.yzw;
  r2.yzw = debugSpecularOverride.www * r4.xyw + r2.yzw;
  r1.w = r3.y + -r3.x;
  r1.w = debugGlossOverride.w * r1.w + r3.x;
  r3.x = debugOcclusionOverride.x + -r2.x;
  r2.x = debugOcclusionOverride.w * r3.x + r2.x;
