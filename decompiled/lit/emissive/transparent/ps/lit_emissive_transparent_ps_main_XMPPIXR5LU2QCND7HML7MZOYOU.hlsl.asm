...
sample_indexable(texture2d)(float,float,float,float) r2.yzw, v1.yzyy, t22.wxyz, s3
...
movc r10.xyz, r0.wwww, l(1.000000,1.000000,1.000000,0), cb0[12].yzwy
...
mul r3.xzw, r2.wwww, r22.xxyz
lt r5.z, r22.w, l(0.990000)
if_nz r5.z
  add r5.z, -r22.w, l(1.000000)
  mul r5.w, r5.z, cb2[19].x
  add r9.yzw, v6.xxyz, -cb2[35].xxyz
  mul r15.x, r9.y, cb2[35].w
  mul r15.yz, r9.zzwz, cb2[36].xxyx
  add_sat r9.yzw, r15.xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
  mul r15.xy, r9.yzyy, cb2[36].zwzz
  mul r15.z, r9.w, cb2[37].x
  add r9.yzw, r15.xxyz, cb2[37].yyzw
  lt r11.yzw, l(0.000000, 0.000000, 0.000000, 0.000000), r7.xxyz
  movc r15.xyz, r11.yzwy, l(0,0,0,0), l(0.500000,0.500000,0.500000,0)
  mov r15.w, l(0)
  add r11.yzw, r9.yyzw, r15.wwwx
...
mul r15.xyz, r2.yyyy, r3.zwxz
mul r3.xyz, r2.wwww, r3.xzwx
sqrt r2.y, r2.z
mad r2.y, r2.y, l(0.500000), l(0.500000)
mul r2.y, r2.y, r2.y
mul r2.w, r2.y, l(0.500000)
mad r2.y, -r2.y, l(0.500000), l(1.000000)
mad r3.w, r2.x, r2.y, r2.w
mul r2.yw, r2.yyyw, r3.wwww
  ...
  if_z r10.w
    ...
    if_nz cb2[58].y
      ...
      loop 
        ...
        movc r13.w, r12.w, cb2[r7.w + 20].w, cb2[r9.w + 20].w
...
if_nz r5.w
  ...
  if_nz r5.w
    ...
    if_nz r8.w
      ...
      mad r20.xyz, r7.xyzx, r10.wwww, v6.xyzx
    ...
    mad r11.yzw, r5.zzzz, r9.yyzw, r3.xxyz
    add_sat r0.w, -r0.w, l(1.000000)
    mul r5.w, r0.w, r0.w
    mul r5.w, r5.w, r5.w
    mul r0.w, r0.w, r5.w
    mul r0.w, r0.w, r5.z
    mad r17.xyz, r0.wwww, r9.zwyz, r15.xyzx
    mov r16.w, r17.z
    mov r14.w, r15.z
    ...
    if_nz r12.w
      ...
      if_nz r10.w
        ...
        switch r10.w
          ...
          if_nz r17.w
            sqrt r17.w, r14.w
            mul r22.w, r35.x, r35.x
            div r14.w, r22.w, r14.w
            min r14.w, r14.w, l(1.000000)
            mad_sat r42.xy, r17.wwww, r34.xzxx, r34.ywyy
            ...
            if_nz r17.w
              ubfe r17.w, l(3), l(27), r33.w
              ine r17.w, r17.w, l(1)
              if_nz r17.w
                mad r17.w, |r15.w|, l(-0.200000), l(0.400000)
                mad r42.xyz, r7.xyzx, r17.wwww, v6.xyzx
                add r42.xyz, -r36.xyzx, r42.xyzx
                max r17.w, |r42.z|, |r42.y|
                max r17.w, r17.w, |r42.x|
                div r17.w, r37.x, r17.w
                add r17.w, r37.y, r17.w
                dp3 r22.w, r42.xyzx, r42.xyzx
                rsq r22.w, r22.w
                ...
                loop 
                  ...
                  mad r43.xyz, r42.xyzx, r22.wwww, r44.xzwx
                  sample_c_lz_indexable(texturecubearray)(float,float,float,float) r28.w, r43.xyzw, t10.xxxx, s13, r17.w
              ...
              if_nz r17.w
                ...
                if_nz r13.w
                  ...
                  mad r20.xyz, r7.xyzx, r22.wwww, v6.xyzx
                  dp4 r22.w, r41.xyzw, r20.xyzw
                  dp4 r27.w, r42.xyzw, r20.xyzw
                  ...
                  if_z r28.w
                    ...
                    mul r20.x, r27.w, r45.y
                    mad r20.y, r45.x, r27.w, r22.w
                  ...
                  if_z r20.y
                    ...
                    if_nz r6.w
                      ...
                      loop 
                        ...
                        dp2 r43.y, icb[r20.z + 0].xyxx, r5.xyxx
                        mad r42.xy, r43.xyxx, r13.wwww, r41.xyxx
                        sample_c_lz_indexable(texture2darray)(float,float,float,float) r22.w, r42.xyzx, t9.xxxx, s13, r20.x
                    ...
                    if_z r20.z
                      ...
                      if_nz r6.w
                        ...
                        loop 
                          ige r27.w, r22.w, l(8)
                          breakc_nz r27.w
                          dp2 r42.x, icb[r22.w + 0].xyxx, r6.xyxx
                          dp2 r42.y, icb[r22.w + 0].yxyy, r6.xzxx
                          mad r21.xy, r42.xyxx, r13.wwww, r41.xyxx
                ...
                mad r12.w, -r17.z, r2.x, l(1.000000)
                mul r12.w, r12.w, r12.w
                mad r12.w, -r12.w, l(0.620000), l(0.620000)
                add r12.w, -r17.z, r12.w
                mad r12.w, r2.z, r12.w, r17.z
                mul r12.w, r14.w, r12.w
                mov r33.x, r32.x
                lt r13.w, l(0.000000), r15.w
                mad r21.xyz, r12.wwww, r33.xyzx, r11.yzwy
                ...
                mad r17.z, |r15.w|, r0.y, -|r15.w|
                mad r15.w, |r15.w|, r17.z, l(1.000000)
                mad r17.z, r12.w, r2.y, r2.w
                ...
                movc r11.yzw, r13.wwww, r21.xxyz, r11.yyzw
                movc r18.xyz, r13.wwww, r40.xyzx, r18.xyzx
          ...
          if_nz r14.w
            ...
            if_nz r15.w
              ...
              if_nz r14.w
                ...
                exp r34.xy, r34.xyxx
                mul r20.x, r34.x, r44.z
                mad r22.w, r44.w, r34.y, l(-1.000000)
                mad r20.x, r44.w, r34.y, -r20.x
            ...
            if_nz r14.w
              ...
              if_nz r14.w
                ...
                mad r23.xyz, r7.xyzx, r14.wwww, v6.xyzx
                mov r39.xyz, r38.xyzx
                dp4 r14.w, r39.xyzw, r23.xyzw
                dp4 r17.z, r41.xyzw, r23.xyzw
                ge r17.w, r17.z, r14.w
                if_nz r17.w
                  ...
                  if_nz r6.w
                    ...
                    loop 
                      ige r20.x, r17.w, l(8)
                      breakc_nz r20.x
                      dp2 r34.x, icb[r17.w + 0].xyxx, r26.xyxx
                      dp2 r34.y, icb[r17.w + 0].yxyy, r26.xzxx
                      ...
                      mad r17.z, r20.x, l(0.125000), r17.z
                      iadd r17.w, r17.w, l(1)
                    endloop 
                  else 
                    utof r23.z, r14.w
                    sample_c_lz_indexable(texture2darray)(float,float,float,float) r17.z, r23.xyzx, t9.xxxx, s13, r8.w
                  endif 
                  mul r8.w, r17.z, r17.z
                  mul r8.w, r17.z, r8.w
                else 
                  mov r8.w, l(1.000000)
                endif 
              ...
              if_nz r14.w
                ...
                if_nz r17.w
                  ...
                  mad r24.xyz, r7.xyzx, r20.xxxx, v6.xyzx
                  dp4 r23.x, r32.xyzw, r24.xyzw
                  dp4 r23.y, r34.xyzw, r24.xyzw
                  dp4 r20.x, r35.xyzw, r24.xyzw
                  ...
                  if_z r24.x
                    ...
                    mad r32.xy, r23.xyxx, r37.xzxx, r37.ywyy
                    mul r15.w, r23.z, r24.z
                    mad r20.x, r24.y, r23.z, r20.x
                    div r15.w, r20.x, r15.w
                    ...
                    if_nz r6.w
                      ...
                      loop 
                        ...
                        mad r23.xy, r33.xyxx, r17.wwww, r32.xyxx
                  ...
                  if_nz r17.w
                    ...
                    mad r20.x, |r12.w|, l(-0.200000), l(0.400000)
                    mad r25.xyz, r7.xyzx, r20.xxxx, v6.xyzx
                    dp4 r23.x, r32.xyzw, r25.xyzw
                    dp4 r23.y, r33.xyzw, r25.xyzw
                    dp4 r20.x, r34.xyzw, r25.xyzw
                    ...
                    if_z r24.y
                      ...
                      if_nz r6.w
                        ...
                        loop 
                          ...
                          mad r23.xy, r25.xyxx, r17.wwww, r32.xyxx
                          sample_c_lz_indexable(texture2darray)(float,float,float,float) r23.x, r23.xyzx, t9.xxxx, s13, r15.w
                        ...
                        utof r32.z, r20.x
                        sample_c_lz_indexable(texture2darray)(float,float,float,float) r24.y, r32.xyzx, t9.xxxx, s13, r15.w
                      endif 
                      mul r15.w, r24.y, r24.y
                      mul r15.w, r24.y, r15.w
                    else 
                      mov r15.w, l(1.000000)
                    endif 
                    mul r8.w, r8.w, r15.w
                ...
                mad r23.xyz, r15.wwww, r22.xywx, r11.yzwy
                mad r21.xyz, r21.xyzx, r10.wwww, r10.xyzx
                dp3 r10.w, r21.xyzx, r21.xyzx
                rsq r10.w, r10.w
                mul r21.xyz, r10.wwww, r21.xyzx
                dp3 r10.w, r21.xyzx, r10.xyzx
                dp3 r15.w, r7.xyzx, r21.xyzx
                mad r17.w, |r15.w|, r0.y, -|r15.w|
                ...
                mad r21.xyz, r8.wwww, r22.xywx, r31.xyzx
                add_sat r10.w, -r10.w, l(1.000000)
                mul r13.w, r10.w, r10.w
                mul r13.w, r13.w, r13.w
                mul r10.w, r10.w, r13.w
                mul r8.w, r8.w, r10.w
                mad r22.xyw, r8.wwww, r22.xyxw, r18.xyxz
                movc r11.yzw, r12.wwww, r23.xxyz, r11.yyzw
                movc r18.xyz, r12.wwww, r22.xywx, r18.xyzx
...
mul r0.xyw, r0.xyxw, r29.xyxz
mad r0.xyw, r30.xyxz, r8.xyxz, r0.xyxw
