...
mad r2.xyz, r2.xyzx, r1.zzzz, r14.xyzx
dp3 r1.x, -v7.xyzx, -v7.xyzx
rsq r1.x, r1.x
mul r7.xyz, r1.xxxx, -v7.xyzx
dp3_sat r1.w, r7.xyzx, r3.xyzx
switch cb0[11].z
  case l(0)
...
exp r1.w, r1.w
movc r1.w, cb0[14].x, r1.w, r2.w
eq r2.w, cb0[12].y, l(0.000000)
movc r1.w, r2.w, l(1.000000), r1.w
mul r2.w, r3.w, cb0[12].x
mul r1.w, r1.w, r2.w
mul r1.z, r1.z, r1.w
...
add r1.w, r1.w, r1.w
mad r13.xyz, r4.xyzx, -r1.wwww, -r7.xyzx
...
if_z r6.w
  ...
  if_nz r10.z
    ...
    loop 
      ...
      ieq r14.z, r7.w, r10.w
      ubfe r14.w, r9.w, l(0), r11.w
...
if_z r6.w
  ...
  if_z r10.w
    ...
    if_nz cb2[58].y
      ...
      add r12.yz, r12.yyzy, -cb2[r9.w + 20].xxyx
      mul r12.yz, r12.yyzy, cb2[r9.w + 20].zzzz
      ...
      loop 
        ...
        movc r16.w, r13.w, cb2[r9.w + 20].w, cb2[r10.w + 20].w
        movc r13.w, r13.w, r9.w, r10.w
...
if_nz r6.w
  ...
  if_nz r6.w
    ...
    if_nz r9.w
      ...
      mad r10.z, |r6.y|, l(-0.200000), l(0.400000)
      mad r20.xyz, r4.xyzx, r10.zzzz, v7.xyzx
      ...
      if_z r11.w
        ...
        if_nz cb2[58].y
          ...
          loop 
            ...
            sample_c_lz_indexable(texture2darray)(float,float,float,float) r12.y, r18.xyzx, t9.xxxx, s13, r8.w
...
mov r9.w, l(0)
loop 
  uge r10.z, r9.w, cb2[0].x
  breakc_nz r10.z
  ushr r16.z, r9.w, l(5)
  iadd r17.xyz, r9.xyzx, r16.xyzx
  ld_indexable(texture2darray)(uint,uint,uint,uint) r10.z, r17.xyzw, t6.yzxw
  mov r12.yzw, r6.yyzw
          ...
          if_nz r26.w
            ...
            if_nz r26.w
              ...
              if_nz r26.w
                  ...
                  if_z r19.y
                    ...
                    if_nz r10.w
                      ...
                      loop 
                        ...
                        dp2 r42.y, icb[r19.z + 0].xyxx, r10.xyxx
                ...
                mad r38.xyz, r38.xyzx, r14.wwww, r7.xyzx
                dp3 r14.w, r38.xyzx, r38.xyzx
                rsq r14.w, r14.w
                mul r38.xyz, r14.wwww, r38.xyzx
                dp3 r14.w, r38.xyzx, r7.xyzx
          ...
          if_nz r16.w
            ...
            if_nz r16.w
              ...
              if_nz r16.w
                ...
                mad r20.xyz, r20.xyzx, r14.wwww, r7.xyzx
                dp3 r14.w, r20.xyzx, r20.xyzx
                rsq r14.w, r14.w
                mul r20.xyz, r14.wwww, r20.xyzx
                dp3 r14.w, r20.xyzx, r7.xyzx
