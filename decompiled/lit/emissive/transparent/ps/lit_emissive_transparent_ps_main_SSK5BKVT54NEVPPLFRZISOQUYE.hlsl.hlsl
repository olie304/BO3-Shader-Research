// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:34:48 2021
...
r0.w = samp0[]..swiz;
  ...
  r1.w = debugAlphaOverride.w * r1.w + r2.x;
  ...
  r2.x = r2.y + -r2.z;
  r2.x = debugGlossOverride.w * r2.x + r2.z;
  r2.y = -1 + debugOcclusionOverride.x;
  r2.y = debugOcclusionOverride.w * r2.y + 1;
  r6.xyz = v7.xxx ? v3.xyz : -v3.xyz;
  r2.z = dot(r6.xyz, r6.xyz);
  r2.z = rsqrt(r2.z);
  r6.xyz = r6.xyz * r2.zzz + -r5.xyz;
  r5.xyz = debugNormalOverride.www * r6.xyz + r5.xyz;
  ...
  r5.xyz = r5.xyz * r0.yyy + r15.xyz;
  r2.w = dot(r5.xyz, r5.xyz);
  r2.w = rsqrt(r2.w);
  r5.xyz = r5.xyz * r2.www;
  r7.y = r2.x * r0.y + r13.y;
  r3.xyz = r3.xyz * r0.yyy + r16.xyz;
  r0.w = gameTime.w + -r0.w;
  r0.x = saturate(r0.x);
  r0.x = hdrScale * r0.x;
  r8.xyz = cmp(r0.zzz == float3(3,2,1));
  r0.z = cmp(r0.z < 0);
  r9.xyz = r0.zzz ? float3(1,1,1) : emissiveTint1.xyz;
  r9.xyz = r8.zzz ? tint1.xyz : r9.xyz;
  ...
  if (r0.z != 0) {
    ...
    r11.x = dot(r10.xyz, v4.xyz);
    r11.y = dot(r10.xyz, v5.xyz);
    r0.z = dot(r10.xyz, v3.xyz);
    r2.x = cmp(0 < r0.z);
    r6.zw = -r11.xy / r0.zz;
    r2.xw = r2.xx ? r6.zw : 0;
    ...
    r2.xw = r2.xw * r0.zz;
    r2.xw = scaleUVs.xy * r2.xw;
    r2.xw = r6.zw * scaleUVs.xy + r2.xw;
    r2.xw = offsetUVs.xy * scaleUVs.xy + r2.xw;
    ...
    r11.y = r11.x;
    r11.z = r10.x;
    r12.x = dot(r11.yz, r2.xw);
    r11.x = -r10.x;
    r12.y = dot(r11.xy, r2.xw);
    r0.zw = scrollUVs.xy * r0.ww;
    r0.zw = r0.zw * scaleUVs.xy + r12.xy;
    r2.x = gameTime.w * zoomRate;
    r2.x = cos(r2.x);
    r2.x = r2.x * 0.5 + 0.5;
    r2.x = 1 + -r2.x;
    r2.w = zoomUVs.y + -zoomUVs.x;
    r2.x = r2.x * r2.w + zoomUVs.x;
    r0.zw = r0.zw / r2.xx;
    r0.zw = float2(0.5,0.5) + r0.zw;
    r2.xw = saturate(r0.zw);
    r9.xy = clampU ? r2.xw : r0.zw;
  }
  r0.z = dot(-v6.xyz, -v6.xyz);
  r0.z = rsqrt(r0.z);
  r10.xyz = -v6.xyz * r0.zzz;
  ...
  r2.x = log2(r0.w);
  r2.x = emissiveFalloffPower * r2.x;
  r2.x = exp2(r2.x);
  r0.w = 1 + -r0.w;
  r0.w = log2(r0.w);
  r0.w = emissiveFalloffPower * r0.w;
  r0.w = exp2(r0.w);
  r0.w = invertFalloff ? r0.w : r2.x;
  r2.x = cmp(emissiveFalloffPower == 0.000000);
  r0.w = r2.x ? 1 : r0.w;
  r0.x = r4.w * r0.x;
  r0.x = r0.x * r0.w;
  r0.x = r0.x * r0.y;
  ...
  r2.x = frac(r2.x);
  r4.y = gameTime.w * flickerSpeed + r2.x;
  r4.x = flickerSeed.x;
  r2.x = flickerLookupMap.SampleLevel(lookupSampler_s, r4.xy, 0).x;
  r2.x = log2(abs(r2.x));
  r2.x = flickerPower * r2.x;
  r2.x = exp2(r2.x);
  r2.w = flickerRange.y + -flickerRange.x;
  r2.x = r2.x * r2.w + flickerRange.x;
  r4.xyz = r2.xxx * r0.xyw;
  r0.x = cmp(isDepthHack != 0);
  r0.yw = (uint2)r6.yx;
  r2.x = dot(r0.wy, float2(0.0671105608,0.00583714992));
  r2.x = frac(r2.x);
  r2.xz = float2(52.9829178,0.0078125) * r2.xz;
  r2.x = frac(r2.x);
  r2.x = r2.x * 6.28318548 + gameTick.w;
  sincos(r2.x, r8.x, r9.x);
  r0.y = dot(r0.yw, float2(0.0671105608,0.00583714992));
  r0.y = frac(r0.y);
  r0.y = 52.9829178 * r0.y;
  r0.y = frac(r0.y);
  r0.y = r0.y * 6.28318548 + gameTick.w;
  sincos(r0.y, r2.x, r11.x);
  r7.x = saturate(dot(r5.xyz, r10.xyz));
  r0.y = dot(-r10.xyz, r5.xyz);
  r0.y = r0.y + r0.y;
  r12.xyz = r5.xyz * -r0.yyy + -r10.xyz;
  r0.y = 17 * r7.y;
  r0.y = exp2(r0.y);
  r0.y = 2 + r0.y;
  r0.y = 2 / r0.y;
  ...
  r40.w = samp0[]..swiz;
    ...
    r29.x = dot(r5.xyz, r22.xyz);
    r29.y = dot(r5.xyz, r30.xyz);
    r29.z = dot(r5.xyz, r24.xyz);
      ...
      if (r16.x != 0) {
        ...
        if (r9.w != 0) {
          ...
          r36.w = samp0[]..swiz;
            ...
            r16.w = -r16.w * r17.z + 1;
            r16.w = r30.y * r16.w;
            r6.y = r18.w ? r16.w : r19.z;
            r30.xy = r18.zz ? r30.xy : r6.xy;
            r16.x = (int)r16.x + 1;
            r15.z = r17.w;
          }
  ...
  if (r2.z == 0) {
    ...
    while (true) {
      ...
      bitmask.w = ((~(-1 << r6.y)) << 0) & 0xffffffff;  r10.w = (((uint)0 << 0) & bitmask.w) | ((uint)r8.w & ~bitmask.w);
        ...
        r15.y = samp0[]..swiz;
          ...
          r34.w = samp0[]..swiz;
            ...
            r40.y = samp0[]..swiz;
              ...
              r35.x = dot(r5.xyz, r27.xyz);
              r35.y = dot(r5.xyz, r28.xyz);
          ...
          r28.y = samp0[]..swiz;
            ...
            r35.w = samp0[]..swiz;
              ...
              r41.y = samp0[]..swiz;
                ...
                r36.x = dot(r5.xyz, r27.xyz);
                r36.y = dot(r5.xyz, r28.xyz);
                r36.z = dot(r5.xyz, r32.xyz);
    ...
    r20.xyz = r23.xyz * r2.zzz;
    r21.xyz = r24.xyz * r2.zzz;
    r2.w = cmp(r24.w < 0.99000001);
    if (r2.w != 0) {
      r2.w = 1 + -r24.w;
      r6.x = sunConstants.globalProbeExposure * r2.w;
      ...
      r6.xyz = r6.xyz * r15.zzz + r11.yzw;
      r5.w = 0;
      r11.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r5.xyzw, 6).xyz;
      r6.xyz = r11.yzw * r6.xyz;
      r5.w = dot(r6.xyz, float3(0.212599993,0.715200007,0.0722000003));
      r20.xyz = r23.xyz * r2.zzz + r6.xyz;
      r12.w = 0;
      r6.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r12.xyzw, r3.w).xyz;
      r2.z = sunConstants.globalProbeExposure * r2.w + -r5.w;
      r2.z = r7.y * r2.z + r5.w;
      r21.xyz = r6.xyz * r2.zzz + r21.xyz;
    }
  } else {
    r21.x = r20.w;
  }
  ...
  r6.xyz = r20.xyz * r2.yyy;
  r2.yw = r7.xy * float2(0.984375,0.984375) + float2(0.0078125,0.0078125);
  r2.yw = gEnvBRDFGeneric.SampleLevel(samplerLinear_s, r2.yw, 0).xy;
  r7.yzw = r21.xyz * r2.zzz;
  r14.xyz = r7.zwy * r2.yyy;
  r2.yzw = r7.yzw * r2.www;
  r3.w = sqrt(r0.w);
  r3.w = r3.w * 0.5 + 0.5;
  r3.w = r3.w * r3.w;
  r5.w = 0.5 * r3.w;
  ...
  if (r7.w != 0) {
    ...
    if (r7.w != 0) {
      ...
      r18.z = samp0[]..swiz;
      r18.w = samp0[]..swiz;
        r10.w = abs(r7.y) * -0.200000003 + 0.400000006;
      ...
      r8.w = dot(r5.xyz, r16.xyz);
      r9.w = abs(r8.w) * r0.y + -abs(r8.w);
      ...
      r15.w = r17.z;
      r6.w = r14.z;
      r6.xyzw = r7.yyyy ? r15.xyzw : r6.xyzw;
      r17.zw = r16.xy;
      r14.zw = r2.yz;
      r15.xyzw = r7.yyyy ? r17.xyzw : r14.xyzw;
      r2.w = r7.y ? r16.z : r2.w;
      r14.z = r6.w;
      r14.xy = r15.xy;
      r2.yz = r15.zw;
    }
