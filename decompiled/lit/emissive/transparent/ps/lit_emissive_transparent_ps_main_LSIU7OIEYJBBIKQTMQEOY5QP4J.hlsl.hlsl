...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  if (r2.z != 0) {
    ...
    r6.xyz = r3.xxx ? float3(1,0,1) : r1.xyz;
    r7.xyz = r3.yyy ? float3(0,1,1) : r1.xyz;
    r6.xyz = r0.xxx ? r6.xyz : r7.xyz;
    r3.xyw = r3.www ? float3(0,1,0) : r1.xyz;
    r1.xyz = r0.yyy ? r6.xyz : r3.xyw;
  }
  ...
  r2.xyz = debugNormalOverride.www * r2.xyz + r5.xyz;
...
r2.w = samp0[]..swiz;
            ...
            r27.w = samp0[]..swiz;
              ...
              r24.w = samp0[]..swiz;
                ...
                if (r23.y != 0) {
                  ...
                  r25.xyz = r26.xyz * r3.zzz;
                  r23.xyz = r23.xyz * r3.zzz;
                  r24.xyz = r24.xyz * r3.zzz;
                  r17.w = -17 * r13.w;
                  r17.w = exp2(r17.w);
                  r16.w = r17.w + r16.w;
                  r16.w = log2(r16.w);
  ...
  r3.xyz = r3.xyw * r1.www + r15.xyz;
  r3.w = cmp(0.5 < invertFalloff);
  if (r3.w != 0) {
  ...
  r3.w = rsqrt(r3.w);
  r7.xyz = -v6.xyz * r3.www;
  r4.x = saturate(dot(r7.xyz, r4.xyz));
  r6.xyzw = emissiveMap.Sample(colorSampler_s, r6.xy).xyzw;
  r4.yzw = emissiveTint1.xyz * r6.xyz;
  r5.z = log2(r4.x);
  ...
  r4.x = exp2(r4.x);
  r4.x = invertFalloff ? r4.x : r5.z;
  r5.z = cmp(emissiveFalloffPower == 0.000000);
  r4.x = r5.z ? 1 : r4.x;
  r5.z = hdrScale * r6.w;
  r4.x = r5.z * r4.x;
  r1.w = r4.x * r1.w;
  r4.xyz = r4.yzw * r1.www;
  r1.w = v2.x + v2.y;
  r1.w = v2.z + r1.w;
