...
sample_indexable(texture2d)(float,float,float,float) r0.z, v2.xyxx, t22.yzxw, s1
...
eq r11.xyz, r0.yyyy, l(3.000000, 2.000000, 1.000000, 0.000000)
...
if_nz r4.w
  ...
  mad r6.yzw, r21.xxyz, r2.wwww, r14.xxyz
  mov r13.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r14.xyz, r13.xyzw, t8.xyzw, s2, r4.z
...
mul r6.yzw, r2.wwww, r11.yyzw
mul r15.xyz, r4.zzzz, r6.zwyz
...
if_z r4.w
  ...
  if_z r10.w
    if_z cb2[58].y
      ...
      sample_c_lz_indexable(texture2darray)(float,float,float,float) r10.w, r16.xyzx, t13.xxxx, s13, r4.w
    ...
    if_nz cb2[58].y
      ...
      loop 
        ...
        utof r18.z, r13.w
        sample_c_lz_indexable(texture2darray)(float,float,float,float) r13.w, r18.xyzx, t13.xxxx, s13, r4.w
...
if_nz r4.w
  ...
  if_nz r4.w
    ...
    mad r11.yzw, r4.zzzz, r9.xxyz, r6.yyzw
    add_sat r0.y, -r0.y, l(1.000000)
    mul r4.w, r0.y, r0.y
    mul r4.w, r4.w, r4.w
    mul r0.y, r0.y, r4.w
    mul r0.y, r0.y, r4.z
    mad r9.xyz, r0.yyyy, r9.yzxy, r15.xyzx
    mov r16.w, r9.z
    mov r14.w, r15.z
    movc r14.xyzw, r2.wwww, r16.xyzw, r14.xyzw
    mov r9.zw, r11.yyyz
    mov r15.zw, r6.yyyz
    movc r9.xyzw, r2.wwww, r9.xyzw, r15.xyzw
    movc r6.w, r2.w, r11.w, r6.w
    mov r15.z, r14.w
    mov r15.xy, r9.xyxx
    mov r6.yz, r9.zzwz
  endif 
...
loop 
                    ...
                    if_z r19.z
                      ...
                      if_nz r5.w
                        ...
                        loop 
                          ige r26.w, r21.w, l(8)
                          breakc_nz r26.w
                          dp2 r42.x, icb[r21.w + 0].xyxx, r5.xyxx
                          dp2 r42.y, icb[r21.w + 0].yxyy, r5.xzxx
  ...
  iadd r4.z, r4.z, l(32)
endloop 
add r0.xyw, -r8.xyxz, l(1.000000, 1.000000, 0.000000, 1.000000)
mul r0.xyw, r0.xyxw, r28.xyxz
mad r0.xyw, r29.xyxz, r8.xyxz, r0.xyxw
mad r0.xyw, r11.yzyw, r1.xyxz, r0.xyxw
