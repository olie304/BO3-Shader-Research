...
mad r1.z, cb1[62].x, r1.w, cb0[12].x
mul_sat r1.z, r1.z, l(0.05882353)
...
if_nz r1.w
  ...
  movc r2.xyz, r2.wwww, r6.xywx, r7.xyzx
endif 
...
rsq r1.z, r1.z
mad r6.xyz, r6.xyzx, r1.zzzz, -r4.xyzx
...
ret 
// Approximately 3035 instruction slots used
