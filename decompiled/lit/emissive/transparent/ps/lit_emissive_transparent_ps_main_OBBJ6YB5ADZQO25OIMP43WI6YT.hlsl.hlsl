...
r1.w = samp0[]..swiz;
  ...
  if (r2.z != 0) {
    ...
    r8.xyz = r8.zzz ? float3(0,1,0) : r0.xyz;
    r0.xyz = r2.www ? r3.xyw : r8.xyz;
  }
  r3.xyw = debugColorOverride.xyz + -r0.xyz;
  r0.xyz = debugColorOverride.www * r3.xyw + r0.xyz;
  r2.z = debugAlphaOverride.x + -r1.w;
  r1.w = debugAlphaOverride.w * r2.z + r1.w;
  r3.xyw = debugSpecularOverride.xyz + -r1.xyz;
  r1.xyz = debugSpecularOverride.www * r3.xyw + r1.xyz;
  r2.y = r2.y + -r2.x;
  ...
  r40.w = samp0[]..swiz;
    ...
    r30.w = (uint)r19.w;
    r23.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r30.xyzw, r16.w).xyz;
    ...
    r23.xyz = r16.www ? float3(1,1,0) : r23.xyz;
      ...
      if (r17.w != 0) {
        ...
        if (r13.z != 0) {
          ...
          r36.w = samp0[]..swiz;
            ...
            r30.x = r18.z * r18.w;
            r19.w = (uint)r17.z >> 2;
            if (1 == 0) r22.z = 0; else if (1+2 < 32) {             r22.z = (uint)r17.z << (32-(1 + 2)); r22.z = (uint)r22.z >> (32-1);            } else r22.z = (uint)r17.z >> 2;
            r23.w = (int)r19.w & 2;
            r24.w = max(r30.y, r30.x);
            r18.z = -r18.z * r18.w + 1;
            r18.z = r30.y * r18.z;
            r19.y = r23.w ? r18.z : r24.w;
            r30.xy = r22.zz ? r30.xy : r19.xy;
            r17.w = (int)r17.w + 1;
            r17.z = r19.w;
          }
          ...
          if (r17.w != 0) {
            ...
            r18.z = r17.w * r6.w;
            r30.xzw = r23.xyz * r17.zzz;
            r17.z = dot(r30.xzw, float3(0.212599993,0.715200007,0.0722000003));
            r17.z = r6.w * r17.w + r17.z;
            r17.z = r18.z / r17.z;
            r33.x = r29.w;
            r33.yz = r28.yz;
            r31.xyw = r30.zwx * r17.zzz + r33.yzx;
            r32.w = r31.w;
          } else {
            r32.xyzw = r29.xyzw;
            r31.xyz = r28.yzw;
  ...
  if (r7.w == 0) {
      ...
      while (true) {
        ...
        r27.y = samp0[]..swiz;
          ...
          r34.w = samp0[]..swiz;
            ...
            r40.x = samp0[]..swiz;
            r40.y = samp0[]..swiz;
              r25.z = r30.y * r17.w + r25.z;
              r14.z = r15.x * r27.z;
              r27.z = r35.z;
              r15.x = dot(r12.xyz, r27.xyz);
              ...
              r26.x = r24.w;
              r26.yz = r25.xy;
              r25.xyw = r17.zwy * r14.zzz + r26.yzx;
              r24.w = r25.w;
            }
          }
        }
          ...
          r28.y = samp0[]..swiz;
            ...
            r36.w = samp0[]..swiz;
              ...
              r42.y = samp0[]..swiz;
                ...
                if (9 == 0) r17.z = 0; else if (9+16 < 32) {                 r17.z = (uint)r29.w << (32-(9 + 16)); r17.z = (uint)r17.z >> (32-9);                } else r17.z = (uint)r29.w >> 16;
                r37.w = (uint)r17.z;
                r17.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r37.xyzw, r17.y).xyz;
                r28.xyz = (int3)r17.yzw & int3(-2147483648,-2147483648,-2147483648);
                r28.xyz = cmp((int3)r28.xyz == int3(2139095040,2139095040,2139095040));
    ...
    if (r5.w != 0) {
      ...
      r3.w = r2.y * r3.w + r6.w;
      r21.xyz = r11.yzw * r3.www + r21.xyz;
    }
  } else {
    r21.x = r20.w;
  }
  ...
  if (r5.w != 0) {
    ...
    if (r5.w != 0) {
      ...
      r2.z = r5.w * r2.z;
      r2.z = r5.z * r2.z;
      r9.xyz = r2.zzz * r9.yzx + r14.xyz;
      r15.w = r9.z;
      r13.w = r14.z;
      r13.xyzw = r3.wwww ? r15.xyzw : r13.xyzw;
      r9.zw = r16.xy;
      r14.zw = r11.yz;
      r9.xyzw = r3.wwww ? r9.xyzw : r14.xyzw;
