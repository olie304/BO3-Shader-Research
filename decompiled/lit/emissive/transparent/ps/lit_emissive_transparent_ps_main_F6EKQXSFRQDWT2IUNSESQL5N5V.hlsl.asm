...
sample_indexable(texture2d)(float,float,float,float) r0.z, r1.xyxx, t25.yzxw, s6
sample_indexable(texture2d)(float,float,float,float) r0.w, r1.xyxx, t24.yzwx, s3
add r1.z, -cb0[11].x, cb0[11].y
mad r0.w, r0.w, r1.z, cb0[11].x
...
if_nz r0.y
  ...
  sample_indexable(texture2d)(float,float,float,float) r4.xyz, v2.xyxx, t30.xyzw, s5
      ...
      if_nz r14.w
        ...
        if_nz r14.w
          ...
          if_nz r14.w
            ...
            if_nz r19.z
              ubfe r14.w, l(4), l(24), r17.w
              ishl r14.w, l(1), r14.w
              ushr r15.w, r17.w, l(28)
              ishl r15.w, l(1), r15.w
              ieq r20.w, r19.z, l(4)
              if_nz r20.w
                and r20.w, r17.w, l(4095)
                ubfe r21.w, l(12), l(12), r17.w
                and r22.w, r18.w, l(1023)
              ...
              mul r14.w, r16.w, r25.w
            else 
              mov r16.xyz, l(0,0,0,0)
              mov r14.w, l(0)
            endif 
            ne r15.w, r17.x, l(1.000000)
            add r16.w, r16.w, r14.w
            mad_sat r16.w, r16.w, r17.x, -r17.x
            movc r14.w, r15.w, r16.w, r14.w
            if_nz r19.w
              ubfe r15.w, l(4), l(24), r18.y
              ishl r15.w, l(1), r15.w
              ushr r16.w, r18.y, l(28)
              ...
              if_nz r17.x
                ...
                add r17.xw, r25.zzzw, r27.xxxy
                mul r27.xy, r17.xwxx, cb1[84].xyxx
                ...
                sample_d_indexable(texture2darray)(float,float,float,float) r17.x, r27.xyzx, t45.xyzw, s4, r25.xyzx, r26.xyzx
              else 
                ieq r17.w, r19.w, l(4)
                if_nz r17.w
                  ...
                  mul r28.xyz, r24.zyzz, cb1[83].xyxx
                  mul r25.xyz, r25.xyzx, r28.xyzx
                  sample_d_indexable(texture2darray)(float,float,float,float) r17.x, r26.xyzx, t42.xyzw, s4, r27.xyzx, r25.xyzx
                else 
                  and r17.w, r18.y, l(4095)
                  ubfe r19.zw, l(0, 0, 12, 10), l(0, 0, 12, 20), r18.yyyw
                  utof r25.xz, r15.wwww
                  ...
                  mul r25.xyz, r25.xyzx, r28.xyzx
                  sample_d_indexable(texture2darray)(float,float,float,float) r17.x, r26.xyzx, t43.xyzw, s4, r27.xyzx, r25.xyzx
                endif 
              endif 
              mad r25.xyz, r17.xxxx, l(0.960000, 0.960000, 0.960000, 0.000000), l(0.040000, 0.040000, 0.040000, 0.000000)
              add_sat r15.w, -r17.x, l(1.000000)
            ...
            if_nz r17.x
              ...
              if_nz r15.w
                ...
                ishl r15.w, l(1), r17.z
                ushr r16.w, r18.z, l(28)
                ishl r16.w, l(1), r16.w
                and r17.z, r18.z, l(4095)
            ...
            if_nz r17.y
              ...
              if_nz r15.w
                ...
                ishl r15.w, l(1), r17.x
                ushr r16.w, r18.x, l(28)
                ishl r16.w, l(1), r16.w
                and r17.x, r18.x, l(4095)
                utof r18.xz, r15.wwww
                utof r18.y, r16.w
              ...
              mad r17.xyz, r20.xyzx, r15.wwww, r17.xyzx
              dp3 r15.w, r17.xyzx, r17.xyzx
              rsq r15.w, r15.w
              mul r17.xyz, r15.wwww, r17.xyzx
              add r15.w, -r14.w, l(1.000000)
              mul r18.xyz, r14.xyzx, r15.wwww
              mad r14.xyz, r17.xyzx, r14.wwww, r18.xyzx
            endif 
            add r15.w, -r14.w, l(1.000000)
            mul r17.xyz, r10.xyzx, r15.wwww
            mad r10.xyz, r16.xyzx, r14.wwww, r17.xyzx
            mul r16.xyz, r15.wwww, r15.xyzx
            mad r15.xyz, r25.xyzx, r14.wwww, r16.xyzx
            mad r9.w, r9.w, r15.w, r14.w
            mul r15.w, r11.w, r15.w
            mad r11.w, r13.w, r14.w, r15.w
          endif 
        endif 
      endif 
    endif 
...
if_nz r0.y
  ...
  mul r0.y, r0.y, r0.w
  round_ne r0.y, r0.y
  div r0.w, r0.y, cb0[11].w
  mul r2.w, r0.y, cb0[11].w
  ge r2.w, r2.w, -r2.w
  ...
  div r5.zw, -r11.xxxy, r0.yyyy
  and r0.yw, r0.wwww, r5.zzzw
  add r1.xy, r1.xyxx, l(-0.500000, -0.500000, 0.000000, 0.000000)
  add r2.w, cb0[15].y, l(0.000010)
  mul r0.yw, r0.yyyw, r2.wwww
  mul r0.yw, r0.yyyw, cb0[13].zzzw
  mad r0.yw, r1.xxxy, cb0[13].zzzw, r0.yyyw
  mad r0.yw, cb0[14].xxxy, cb0[13].zzzw, r0.yyyw
  ...
  mul r0.yw, cb0[13].xxxy, cb1[69].wwww
  mad r0.yw, r0.yyyw, cb0[13].zzzw, r11.xxxy
  ...
  movc r9.xy, cb0[15].zwzz, r1.xyxx, r0.ywyy
endif 
dp3 r0.y, -v7.xyzx, -v7.xyzx
rsq r0.y, r0.y
mul r10.xyz, r0.yyyy, -v7.xyzx
...
exp r0.w, r0.w
movc r0.w, cb0[20].x, r0.w, r1.x
eq r1.x, cb0[18].z, l(0.000000)
movc r0.w, r1.x, l(1.000000), r0.w
mul r1.x, r4.w, cb0[18].y
mul r0.w, r0.w, r1.x
mul r0.x, r0.x, r0.w
mul r4.xyz, r0.xxxx, r4.xyzx
add r0.x, v3.y, v3.x
...
frc r0.x, r0.x
mad r1.y, cb1[69].w, cb0[16].z, r0.x
mov r1.x, cb0[16].x
sample_l_indexable(texture2d)(float,float,float,float) r0.x, r1.xyxx, t26.xyzw, s7, l(0.000000)
log r0.x, |r0.x|
mul r0.x, r0.x, cb0[17].z
exp r0.x, r0.x
add r0.w, -cb0[17].x, cb0[17].y
mad r0.x, r0.x, r0.w, cb0[17].x
mul r4.xyz, r0.xxxx, r4.xyzx
...
dp3_sat r5.x, r3.xyzx, r10.xyzx
dp3 r0.w, -r10.xyzx, r3.xyzx
add r0.w, r0.w, r0.w
mad r13.xyz, r3.xyzx, -r0.wwww, -r10.xyzx
...
mad r5.zw, -r1.zzzz, l(0.000000, 0.000000, 10.000000, 5.000000), l(0.000000, 0.000000, 6.857410, 7.085000)
exp r4.w, r5.z
mul r4.w, r4.w, r5.x
...
rcp r1.z, r1.z
mov_sat r22.w, r22.w
mul r12.yzw, r1.zzzz, r21.xxyz
mul r14.xyz, r1.zzzz, r22.xyzx
...
if_nz r2.w
  ...
  mad r12.yzw, r21.xxyz, r1.zzzz, r15.xxyz
  mov r13.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r15.xyz, r13.xyzw, t8.xyzw, s2, r1.w
  mad r1.z, cb2[19].x, r2.w, -r3.w
  mad r1.z, r5.y, r1.z, r3.w
  mad r14.xyz, r15.xyzx, r1.zzzz, r14.xyzx
endif 
add r1.z, r0.z, r5.x
log r1.z, |r1.z|
mul r1.z, r1.z, r1.y
...
mul r12.yzw, r1.zzzz, r14.xxyz
mul r14.xyz, r5.yyyy, r12.zwyz
mul r5.yzw, r5.zzzz, r12.yyzw
sqrt r0.z, r1.y
mad r0.z, r0.z, l(0.500000), l(0.500000)
mul r0.z, r0.z, r0.z
mul r1.z, r0.z, l(0.500000)
mad r0.z, -r0.z, l(0.500000), l(1.000000)
mad r1.w, r5.x, r0.z, r1.z
mul r0.z, r0.z, r1.w
mul r1.z, r1.w, r1.z
dp3 r1.w, r3.xyzx, cb2[17].xyzx
mov_sat r2.w, r1.w
...
if_z r3.w
  ...
  if_z r9.z
    if_z cb2[58].y
      ...
      itof r9.z, cb2[26].y
      add r16.z, r6.w, r9.z
      sample_c_lz_indexable(texture2darray)(float,float,float,float) r9.z, r16.xyzx, t13.xxxx, s13, r3.w
...
if_nz r3.w
  ...
  if_nz r3.w
    ...
    if_nz r7.w
      ...
      mad r20.xyz, r3.xyzx, r8.wwww, v7.xyzx
    ...
    mad r6.w, -r2.w, r6.w, l(1.000000)
    mul r6.w, r6.w, r6.w
    mad r6.w, -r6.w, l(0.620000), l(0.620000)
    add r6.w, -r2.w, r6.w
    mad r6.w, r1.y, r6.w, r2.w
    mul r6.w, r4.w, r6.w
    ...
    dp3 r6.w, r3.xyzx, r12.yzwy
    mad r7.w, |r6.w|, r0.w, -|r6.w|
    ...
    mad r12.yzw, r2.wwww, r7.xxyz, r5.yyzw
    ...
    mov r16.w, r7.z
    mov r15.w, r14.z
    movc r15.xyzw, r1.wwww, r16.xyzw, r15.xyzw
    mov r7.zw, r12.yyyz
    mov r14.zw, r5.yyyz
    movc r7.xyzw, r1.wwww, r7.xyzw, r14.xyzw
    movc r5.w, r1.w, r12.w, r5.w
    mov r14.z, r15.w
    mov r14.xy, r7.xyxx
    mov r5.yz, r7.zzwz
  endif 
...
not r0.y, r0.x
mov r7.x, -r9.x
mad r1.w, -r5.x, l(0.500000), l(1.000000)
  ...
  loop 
    ...
    if_nz r9.w
      ...
      if_nz r9.z
        ...
        ubfe r9.z, l(3), l(24), r33.w
        switch r9.z
          case l(4)
          lt r9.z, l(0.000000), r38.x
          mov r39.xy, r37.zwzz
          mov r39.z, r38.w
          ...
          if_nz r15.w
            ...
            if_nz r15.w
              ...
              if_nz r15.w
                ...
                mad r42.xyz, r3.xyzx, r15.wwww, v7.xyzx
                ...
                loop 
                  ige r25.w, r21.w, l(8)
                  breakc_nz r25.w
                  dp2 r44.y, icb[r21.w + 0].yxyy, r7.xyxx
                  dp2 r44.z, icb[r21.w + 0].yxyy, r7.yzyy
              ...
              if_nz r15.w
                ...
                movc r39.xyz, r9.zzzz, r39.xyzx, r32.yzwy
                add r39.xyz, r39.xyzx, -v7.xyzx
                dp3 r9.z, r39.xyzx, r39.xyzx
                rsq r9.z, r9.z
                mul r40.xyz, r9.zzzz, r39.xyzx
                ...
                if_nz r10.w
                  ...
                  mad r19.xyz, r3.xyzx, r16.zzzz, v7.xyzx
                  ...
                  if_z r19.x
                    ...
                    if_nz r5.x
                      ...
                      loop 
                        ige r26.w, r25.w, l(8)
                        breakc_nz r26.w
                        dp2 r42.x, icb[r25.w + 0].yxyy, r7.xwxx
                        dp2 r42.y, icb[r25.w + 0].xyxx, r9.xyxx
                  ...
                  if_nz r10.w
                    ...
                    ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r42.xyzw, r9.w, l(116), t12.xyzw
                    mad r16.z, |r13.w|, l(-0.200000), l(0.400000)
                    mad r20.xyz, r3.xyzx, r16.zzzz, v7.xyzx
                ...
                dp3_sat r9.w, r3.xyzx, r40.xyzx
                mad r20.xyz, r39.xyzx, r9.zzzz, r10.xyzx
                dp3 r9.z, r20.xyzx, r20.xyzx
                rsq r9.z, r9.z
                mul r20.xyz, r9.zzzz, r20.xyzx
                dp3 r9.z, r20.xyzx, r10.xyzx
                ...
                mul r9.z, r9.z, r11.w
                mul r9.z, r9.z, r9.w
                mad r39.xyz, r9.zzzz, r33.xyzx, r30.xyzx
          ...
          dp3 r9.z, r19.xyzx, r19.xyzx
          rsq r9.z, r9.z
          mul r20.xyz, r9.zzzz, r19.xyzx
          dp3 r9.w, r3.xyzx, r20.xyzx
          mov_sat r10.w, r9.w
          ...
          if_nz r11.w
            ...
            if_nz r11.w
              ...
              if_nz r11.w
                ...
                mad r22.xyz, r3.xyzx, r11.wwww, v7.xyzx
                ...
                if_nz r15.w
                  ...
                  if_nz r5.x
                    ...
                    loop 
                      ...
                      sample_c_lz_indexable(texture2darray)(float,float,float,float) r16.z, r32.xyzx, t9.xxxx, s13, r8.w
              ...
              if_nz r11.w
                ...
                if_nz r15.w
                  ...
                  mad r23.xyz, r3.xyzx, r16.zzzz, v7.xyzx
                  ...
                  if_nz r15.w
                    ...
                    mad r16.z, |r9.w|, l(-0.200000), l(0.400000)
                    mad r24.xyz, r3.xyzx, r16.zzzz, v7.xyzx
                ...
                mad r19.xyz, r19.xyzx, r9.zzzz, r10.xyzx
                dp3 r9.z, r19.xyzx, r19.xyzx
                rsq r9.z, r9.z
                mul r19.xyz, r9.zzzz, r19.xyzx
                dp3 r9.z, r19.xyzx, r10.xyzx
                dp3 r13.w, r3.xyzx, r19.xyzx
                ...
                mad r19.xyz, r8.wwww, r20.xyzx, r31.xyzx
                add_sat r9.z, -r9.z, l(1.000000)
                mul r10.w, r9.z, r9.z
...
ret 
// Approximately 2347 instruction slots used
