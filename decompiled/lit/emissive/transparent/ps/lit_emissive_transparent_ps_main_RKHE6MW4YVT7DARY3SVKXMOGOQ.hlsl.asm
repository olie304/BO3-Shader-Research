...
movc r3.xy, r5.wwww, r3.xyxx, v1.yzyy
sample_indexable(texture2d)(float,float,float,float) r3.xyzw, r3.xyxx, t24.xyzw, s1
mul r3.xyz, r3.xyzx, cb0[13].xyzx
and r3.xyzw, r3.xyzw, r5.wwww
log r5.w, r1.w
mul r5.w, r5.w, cb0[12].y
exp r5.w, r5.w
add r1.w, -r1.w, l(1.000000)
log r1.w, r1.w
mul r1.w, r1.w, cb0[12].y
exp r1.w, r1.w
movc r1.w, cb0[14].x, r1.w, r5.w
eq r5.w, cb0[12].y, l(0.000000)
...
if_nz r2.z
  ...
  mad r10.yzw, r7.yyzw, r2.xxxx, r10.yyzw
endif 
...
if_nz r7.z
  ...
  if_nz r7.z
    ...
    mad r16.xyz, r7.yyyy, r10.yzwy, r2.xzwx
