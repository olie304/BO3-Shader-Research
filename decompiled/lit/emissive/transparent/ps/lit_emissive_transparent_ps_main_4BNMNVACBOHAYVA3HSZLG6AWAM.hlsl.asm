...
sample_indexable(texture2d)(float,float,float,float) r1.x, v2.xyxx, t24.xyzw, s6
...
mov r9.x, cb0[16].x
sample_l_indexable(texture2d)(float,float,float,float) r1.z, r9.xyxx, t25.yzxw, s7, l(0.000000)
log r1.z, |r1.z|
...
ret 
// Approximately 2311 instruction slots used
