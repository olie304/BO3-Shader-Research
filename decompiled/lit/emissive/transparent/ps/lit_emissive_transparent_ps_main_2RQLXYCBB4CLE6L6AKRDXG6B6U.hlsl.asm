...
sample_indexable(texture2d)(float,float,float,float) r0.x, v1.yzyy, t26.xyzw, s6
sample_indexable(texture2d)(float,float,float,float) r1.w, v1.yzyy, t25.yzwx, s3
add r2.x, -cb0[10].y, cb0[10].z
mad r1.w, r1.w, r2.x, cb0[10].y
...
mad r2.xyz, r5.xyzx, r2.xxxx, r7.xyzx
...
rsq r3.y, r3.y
mul r7.xyz, r2.xyzx, r3.yyyy
mad r2.y, r1.w, r0.y, r14.y
...
movc r10.xyz, r0.wwww, l(1.000000,1.000000,1.000000,0), cb0[12].xyzx
...
mad r4.xy, r4.xyxx, r2.zzzz, v1.yzyy
...
dp3 r0.z, -r10.xyzx, r7.xyzx
add r0.z, r0.z, r0.z
mad r12.xyz, r7.xyzx, -r0.zzzz, -r10.xyzx
...
mul r3.y, r2.z, l(5.000000)
mad r5.y, r2.z, l(5.000000), l(-2.500000)
mul_sat r5.y, r5.y, l(0.400000)
mul r5.y, r5.y, l(100.000000)
mad r5.zw, -r2.zzzz, l(0.000000, 0.000000, 10.000000, 5.000000), l(0.000000, 0.000000, 6.857410, 7.085000)
exp r5.z, r5.z
mul r5.z, r2.x, r5.z
mul r6.z, r2.z, r3.y
mad r5.w, -r6.z, l(2.015905), r5.w
exp r5.w, r5.w
mul r5.w, r2.x, r5.w
...
loop 
  ...
  ieq r9.w, r3.x, r6.w
  bfi r10.w, r3.z, l(0), l(0), r8.w
  movc r8.w, r9.w, r10.w, r8.w
  ieq r9.w, r3.w, r6.w
  ubfe r10.w, r6.z, l(0), r8.w
  movc r8.w, r9.w, r10.w, r8.w
  iadd r9.w, r6.w, cb2[0].x
    ...
    if_nz r11.w
      ...
      if_nz r11.z
        ...
        if_nz r13.w
          ...
          sqrt r11.z, r11.z
          mad r11.z, r2.z, l(5.000000), r11.z
...
if_nz r3.w
  ...
  loop 
    ...
    ieq r8.w, r3.x, r6.z
    ubfe r9.w, r3.z, l(0), r6.w
    movc r6.w, r8.w, r9.w, r6.w
    iadd r8.w, r6.z, cb2[0].x
...
rcp r2.z, r2.z
mov_sat r22.w, r22.w
mul r3.xzw, r2.zzzz, r21.xxyz
mul r5.yzw, r2.zzzz, r22.xxyz
...
if_nz r6.z
  ...
  mad r3.xzw, r21.xxyz, r2.zzzz, r11.yyzw
  mov r12.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r11.yzw, r12.xyzw, t8.wxyz, s2, r3.y
  mad r2.z, cb2[19].x, r6.z, -r6.w
  mad r2.z, r2.y, r2.z, r6.w
  mad r5.yzw, r11.yyzw, r2.zzzz, r5.yyzw
endif 
add r2.z, r0.x, r2.x
log r2.z, |r2.z|
mul r2.z, r1.w, r2.z
...
mul r5.yzw, r2.zzzz, r5.yyzw
mul r14.xyz, r6.zzzz, r5.zwyz
...
if_nz r6.w
  ...
  if_nz r6.w
    ...
    if_nz r9.w
      ...
      mad r10.w, |r2.z|, l(-0.200000), l(0.400000)
    ...
    mad r16.xyz, r6.zzzz, r11.yzwy, r5.yzwy
    add_sat r0.w, -r0.w, l(1.000000)
    mul r6.w, r0.w, r0.w
    mul r6.w, r6.w, r6.w
    mul r0.w, r0.w, r6.w
    mul r0.w, r0.w, r6.z
    mad r17.xyz, r0.wwww, r11.zwyz, r14.xyzx
    mov r15.w, r17.z
    mov r3.w, r14.z
    movc r3.xyzw, r2.zzzz, r15.xyzw, r3.xyzw
    mov r17.zw, r16.xxxy
    mov r14.zw, r5.yyyz
    movc r15.xyzw, r2.zzzz, r17.xyzw, r14.xyzw
    movc r5.w, r2.z, r16.z, r5.w
    mov r14.z, r3.w
    mov r14.xy, r15.xyxx
    mov r5.yz, r15.zzwz
  endif 
