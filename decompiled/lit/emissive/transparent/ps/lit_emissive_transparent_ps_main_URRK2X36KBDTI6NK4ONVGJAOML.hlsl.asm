...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:34:53 2021
//
//
// Buffer Definitions: 
//
...
//   uint zFeatherComputeSprites;       // Offset:  300 Size:     4 [unused]
//   float hdrScale;                    // Offset:  304 Size:     4
//   float emissiveFalloffPower;        // Offset:  308 Size:     4
...
and r7.xy, r5.wwww, l(0x10000000, 0x20000000, 0, 0)
if_nz r7.x
            ...
            if_nz r16.w
              ...
              if_nz r19.x
                ...
                if_nz r17.w
                  ...
                  ieq r17.w, r19.x, l(6)
                  movc r14.w, r17.w, l(0), l(1.000000)
                endif 
              else 
              ...
              if_nz r19.y
                ...
                mov r16.x, r15.x
                mul r20.xyz, r17.wwww, r16.xyzx
                mad r16.xyz, r19.xyzx, r16.wwww, r20.xyzx
                mov r15.x, r16.x
              endif 
              add r16.x, -r16.w, l(1.000000)
              mul r19.xyz, r11.xyzx, r16.xxxx
              mad r11.xyz, r18.xyzx, r16.wwww, r19.xyzx
              mov r17.z, r15.y
              mul r18.xyz, r16.xxxx, r17.xyzx
              mad r17.xyz, r27.xyzx, r16.wwww, r18.xyzx
              mul r17.w, r15.w, r16.x
              mad r15.z, r15.z, r16.x, r16.w
              mad r15.w, r14.w, r16.w, r17.w
              mov r15.y, r17.z
            endif 
          endif 
        endif 
...
if_nz r7.y
  ...
  mov r11.w, r6.w
  loop 
    uge r12.z, r11.w, r5.w
    breakc_nz r12.z
    ushr r11.z, r11.w, l(5)
    iadd r15.xyz, r9.xyzx, r11.xyzx
    ld_indexable(texture2darray)(uint,uint,uint,uint) r11.z, r15.xyzw, t35.yzxw
    ieq r12.z, r6.w, r11.w
    bfi r12.w, r7.y, l(0), l(0), r11.z
    movc r11.z, r12.z, r12.w, r11.z
    ieq r12.z, r9.w, r11.w
    ubfe r12.w, r10.x, l(0), r11.z
    movc r11.z, r12.z, r12.w, r11.z
    iadd r12.z, r4.w, r11.w
    ...
    loop 
      ...
      and r16.w, r12.w, r14.w
      if_nz r16.w
        xor r12.w, r12.w, r14.w
        iadd r14.w, r12.z, r13.w
            ...
            if_nz r14.w
              ...
              if_nz r24.w
                ...
                if_nz r19.w
                  ...
                  mul r30.xyz, r30.xyzx, r33.xyzx
                  sample_d_indexable(texture2darray)(float,float,float,float) r19.w, r31.xyzx, t45.yzwx, s4, r32.xyzx, r30.xyzx
                else 
                  ieq r20.w, r24.w, l(4)
                  if_nz r20.w
                    ...
                    mul r33.xyz, r29.zyzz, cb1[83].xyxx
                    mul r30.xyz, r30.xyzx, r33.xyzx
                    sample_d_indexable(texture2darray)(float,float,float,float) r19.w, r31.xyzx, t42.yzwx, s4, r32.xyzx, r30.xyzx
                  else 
                    and r20.w, r23.y, l(4095)
                    ubfe r22.xw, l(12, 0, 0, 10), l(12, 0, 0, 20), r23.yyyw
                    utof r30.xz, r16.wwww
                    ...
                    mul r30.xyz, r30.xyzx, r33.xyzx
                    sample_d_indexable(texture2darray)(float,float,float,float) r19.w, r31.xyzx, t43.yzwx, s4, r32.xyzx, r30.xyzx
                  endif 
                endif 
                mad r30.xyz, r19.wwww, l(0.960000, 0.960000, 0.960000, 0.000000), l(0.040000, 0.040000, 0.040000, 0.000000)
              ...
              if_nz r22.y
                ...
                mad r22.xyz, r25.xyzx, r16.wwww, r22.xyzx
              ...
              add r16.w, -r14.w, l(1.000000)
              mul r22.xyz, r15.xyzx, r16.wwww
              mad r15.xyz, r21.xyzx, r14.wwww, r22.xyzx
              mul r21.xyz, r16.wwww, r20.xyzx
              mad r20.xyz, r30.xyzx, r14.wwww, r21.xyzx
              mul r17.w, r16.w, r18.w
              mad r18.z, r18.z, r16.w, r14.w
              mad r18.w, r13.w, r14.w, r17.w
            endif 
          endif 
        endif 
      endif 
...
mad r0.xyz, r0.xyzx, r3.wwww, r7.xzwx
mad r0.w, r0.w, r3.w, r12.x
mad r2.yzw, r2.yyzw, r3.wwww, r13.xxyz
dp3 r4.w, r2.yzwy, r2.yzwy
rsq r4.w, r4.w
mul r5.xyz, r2.yzwy, r4.wwww
mad r6.y, r1.w, r3.w, r12.y
mad r1.xyz, r1.xyzx, r3.wwww, r14.xyzx
lt r1.w, l(0.500000), cb0[21].y
if_nz r1.w
  mul r1.w, cb0[12].w, cb0[12].z
  mul r2.y, r1.w, cb0[13].x
  mul r2.z, r2.y, cb1[69].w
  ge r2.z, r2.z, -r2.z
  ...
  mul r1.w, r1.w, r2.y
  round_ne r1.w, r1.w
  div r2.y, r1.w, cb0[12].w
  mul r2.z, r1.w, cb0[12].w
  ge r2.z, r2.z, -r2.z
  movc r2.z, r2.z, cb0[12].w, -cb0[12].w
  div r2.w, l(1.000000, 1.000000, 1.000000, 1.000000), r2.z
  mul r1.w, r1.w, r2.w
  frc r1.w, r1.w
  mul r1.w, r1.w, r2.z
  round_z r1.w, r1.w
  add r1.w, r1.w, v1.y
  div r7.x, r1.w, cb0[12].w
  round_z r1.w, r2.y
  add r1.w, r1.w, v1.z
  div r7.y, r1.w, cb0[12].z
else 
  ...
  div r2.zw, -r8.xxxy, r1.wwww
  and r2.yz, r2.zzwz, r2.yyyy
  add r6.zw, v1.yyyz, l(0.000000, 0.000000, -0.500000, -0.500000)
  add r1.w, cb0[16].y, l(0.000010)
  mul r2.yz, r1.wwww, r2.yyzy
  mul r2.yz, r2.yyzy, cb0[14].zzwz
  mad r2.yz, r6.zzwz, cb0[14].zzwz, r2.yyzy
  mad r2.yz, cb0[15].xxyx, cb0[14].zzwz, r2.yyzy
  ...
  mov r9.y, r9.x
  mov r9.z, r8.x
  dp2 r10.x, r9.yzyy, r2.yzyy
  mov r9.x, -r8.x
  dp2 r10.y, r9.xyxx, r2.yzyy
  mul r2.yz, cb0[14].xxyx, cb1[69].wwww
  mad r2.yz, r2.yyzy, cb0[14].zzwz, r10.xxyx
  ...
  div r2.yz, r2.yyzy, r1.wwww
  add r2.yz, r2.yyzy, l(0.000000, 0.500000, 0.500000, 0.000000)
  mov_sat r6.zw, r2.yyyz
  movc r7.xy, cb0[16].zwzz, r6.zwzz, r2.yzyy
endif 
dp3 r1.w, -v6.xyzx, -v6.xyzx
rsq r1.w, r1.w
mul r2.yzw, r1.wwww, -v6.xxyz
dp3_sat r4.x, r2.yzwy, r4.xyzx
sample_indexable(texture2d)(float,float,float,float) r7.xyzw, r7.xyxx, t29.xyzw, s1
mul r4.yzw, r7.xxyz, cb0[20].xxyz
log r6.z, r4.x
mul r6.z, r6.z, cb0[19].y
exp r6.z, r6.z
add r4.x, -r4.x, l(1.000000)
log r4.x, r4.x
mul r4.x, r4.x, cb0[19].y
exp r4.x, r4.x
movc r4.x, cb0[21].x, r4.x, r6.z
eq r6.z, cb0[19].y, l(0.000000)
movc r4.x, r6.z, l(1.000000), r4.x
mul r6.z, r7.w, cb0[19].x
mul r4.x, r4.x, r6.z
mul r3.w, r3.w, r4.x
...
frc r3.w, r3.w
mad r7.y, cb1[69].w, cb0[17].z, r3.w
mov r7.x, cb0[17].x
sample_l_indexable(texture2d)(float,float,float,float) r3.w, r7.xyxx, t26.yzwx, s7, l(0.000000)
log r3.w, |r3.w|
mul r3.w, r3.w, cb0[18].z
exp r3.w, r3.w
add r4.w, -cb0[18].x, cb0[18].y
mad r3.w, r3.w, r4.w, cb0[18].x
mul r4.xyz, r3.wwww, r4.xyzx
ine r3.w, cb1[92].x, l(0)
utof r6.zw, r3.zzzy
dp2 r7.x, r6.wzww, l(0.06711056, 0.00583715, 0.000000, 0.000000)
frc r7.x, r7.x
...
sincos r9.x, r10.x, r6.z
dp3_sat r6.x, r5.xyzx, r2.yzwy
dp3 r6.z, -r2.yzwy, r5.xyzx
add r6.z, r6.z, r6.z
mad r11.xyz, r5.xyzx, -r6.zzzz, -r2.yzwy
mul r6.z, r6.y, l(17.000000)
exp r6.z, r6.z
...
mad r8.w, r7.z, l(5.000000), l(-2.500000)
mul_sat r8.w, r8.w, l(0.400000)
mul r8.w, r8.w, l(100.000000)
mad r9.yz, -r7.zzzz, l(0.000000, 10.000000, 5.000000, 0.000000), l(0.000000, 6.857410, 7.085000, 0.000000)
exp r9.y, r9.y
mul r9.y, r6.x, r9.y
mul r9.w, r7.z, r7.w
...
loop 
  ...
  dp3 r29.x, r5.xyzx, r21.xyzx
  dp3 r29.y, r5.xyzx, r30.xyzx
  dp3 r29.z, r5.xyzx, r23.xyzx
...
if_z r9.z
      ...
      if_nz r14.x
        ...
        if_nz r13.w
          ...
          if_nz r14.x
            ...
            dp3 r35.x, r5.xyzx, r26.xyzx
            dp3 r35.y, r5.xyzx, r27.xyzx
        ...
        if_nz r17.w
          ...
          if_nz r17.z
            ...
            if_nz r17.z
              ...
              sqrt r16.w, r16.w
              mad r16.w, r7.z, l(5.000000), r16.w
  ...
  if_nz r3.y
    ...
    lt r10.yzw, l(0.000000, 0.000000, 0.000000, 0.000000), r5.xxyz
    ...
    mov r5.w, l(0)
    sample_l_indexable(texturecubearray)(float,float,float,float) r10.yzw, r5.xyzw, t8.wxyz, s2, l(6.000000)
    mul r9.yzw, r9.yyzw, r10.yyzw
    dp3 r3.z, r9.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
    mad r19.xyz, r22.xyzx, r3.xxxx, r9.yzwy
    mov r11.w, l(0)
    sample_l_indexable(texturecubearray)(float,float,float,float) r9.yzw, r11.xyzw, t8.wxyz, s2, r7.w
    mad r3.x, cb2[19].x, r3.y, -r3.z
    mad r3.x, r6.y, r3.x, r3.z
    mad r20.xyz, r9.yzwy, r3.xxxx, r20.xyzx
  endif 
else 
  mov r20.x, r19.w
endif 
...
if_z r7.w
  ...
  if_nz r10.y
    ...
    loop 
      ge r10.w, r10.y, l(3.000000)
      breakc_nz r10.w
      ftou r10.w, r10.y
      add r15.xy, r9.yzyy, -cb2[r10.w + 20].xyxx
  ...
  if_z r10.w
    ...
    if_nz cb2[58].y
      ...
      add r9.yz, r9.yyzy, -cb2[r10.y + 20].xxyx
      mul r9.yz, r9.yyzy, cb2[r10.y + 20].zzzz
      ...
      loop 
        ...
        movc r16.zw, r12.wwww, r9.yyyz, r16.xxxy
        movc r15.w, r12.w, cb2[r10.y + 20].w, cb2[r9.w + 20].w
        movc r12.w, r12.w, r10.y, r9.w
...
if_nz r7.w
  ...
  if_nz r7.w
    ...
    ushr r10.y, cb2[53].x, l(16)
    ult r10.z, l(0), r10.y
    and r10.z, r3.w, r10.z
    if_nz r10.z
      ...
      mad r10.w, |r6.y|, l(-0.200000), l(0.400000)
      ...
      if_z r10.w
        ...
        dp4 r10.y, r16.xyzw, r19.xyzw
        mov_sat r15.xy, r15.xyxx
        mad r16.xy, r15.xyxx, r17.xzxx, r17.ywyy
        add r10.y, r15.z, r10.y
        div r10.y, r10.y, r15.w
        ...
        if_nz cb2[58].y
          ...
          loop 
            ...
            mad r17.xy, r18.xyxx, r10.zzzz, r16.xyxx
            sample_c_lz_indexable(texture2darray)(float,float,float,float) r15.w, r17.xyzx, t9.xxxx, s13, r10.y
            mad r11.w, r15.w, l(0.125000), r11.w
            iadd r12.w, r12.w, l(1)
          endloop 
        else 
          utof r16.z, r10.w
          sample_c_lz_indexable(texture2darray)(float,float,float,float) r11.w, r16.xyzx, t9.xxxx, s13, r10.y
        endif 
        mul r10.y, r11.w, r11.w
    ...
    mad r10.y, -r6.x, l(0.500000), l(1.000000)
    mad r10.y, -r7.z, r10.y, l(1.000000)
    mul r10.y, r10.y, r10.y
    mad r10.y, -r10.y, l(0.620000), l(0.620000)
    add r10.y, -r7.z, r10.y
    mad r10.y, r6.w, r10.y, r7.z
    mul r10.y, r8.w, r10.y
    lt r6.y, l(0.000000), r6.y
    mad r15.xyz, r10.yyyy, r9.yzwy, r13.xyzx
    mad r10.yzw, -v6.xxyz, r1.wwww, cb2[17].xxyz
    dp3 r1.w, r10.yzwy, r10.yzwy
    rsq r1.w, r1.w
    mul r10.yzw, r1.wwww, r10.yyzw
    dp3 r1.w, r10.yzwy, r2.yzwy
    dp3 r10.y, r5.xyzx, r10.yzwy
    mad r10.z, |r10.y|, r6.z, -|r10.y|
    mad r10.y, |r10.y|, r10.z, l(1.000000)
    mad r7.z, r7.z, r2.x, r5.w
    mul r10.y, r10.y, r10.y
    mul r7.z, r7.z, r10.y
    rcp r7.z, r7.z
    mul r7.z, r7.w, r7.z
    ...
    mad r10.yzw, r7.zzzz, r9.yyzw, r3.xxyz
    add_sat r1.w, -r1.w, l(1.000000)
    mul r7.w, r1.w, r1.w
    mul r7.w, r7.w, r7.w
    mul r1.w, r1.w, r7.w
    mul r1.w, r1.w, r7.z
    mad r16.xyz, r1.wwww, r9.zwyz, r14.xyzx
    mov r15.w, r16.z
    mov r13.w, r14.z
    movc r13.xyzw, r6.yyyy, r15.xyzw, r13.xyzw
    mov r16.zw, r10.yyyz
    mov r14.zw, r3.xxxy
    movc r15.xyzw, r6.yyyy, r16.xyzw, r14.xyzw
    movc r3.z, r6.y, r10.w, r3.z
    mov r14.z, r13.w
    mov r14.xy, r15.xyxx
    mov r3.xy, r15.zwzz
  endif 
          ...
          if_nz r26.w
            ...
            if_nz r26.w
              ...
              if_nz r26.w
                ...
                mad r14.w, -r25.w, r6.x, l(1.000000)
                ...
                mad r38.xyz, r38.xyzx, r13.wwww, r2.yzwy
                dp3 r13.w, r38.xyzx, r38.xyzx
                rsq r13.w, r13.w
                mul r38.xyz, r13.wwww, r38.xyzx
                dp3 r13.w, r38.xyzx, r2.yzwy
                dp3 r19.x, r5.xyzx, r38.xyzx
                mad r21.w, |r19.x|, r6.z, -|r19.x|
                mad r19.x, |r19.x|, r21.w, l(1.000000)
                mad r21.w, r14.w, r2.x, r5.w
          ...
          if_nz r16.w
            ...
            if_nz r16.w
              ...
              if_nz r16.w
                ...
                mad r19.x, -r16.z, r6.x, l(1.000000)
                mul r19.x, r19.x, r19.x
                ...
                mad r20.xyz, r20.xyzx, r13.wwww, r2.yzwy
                dp3 r13.w, r20.xyzx, r20.xyzx
                rsq r13.w, r13.w
                mul r20.xyz, r13.wwww, r20.xyzx
                dp3 r13.w, r20.xyzx, r2.yzwy
                dp3 r19.x, r5.xyzx, r20.xyzx
                mad r20.x, |r19.x|, r6.z, -|r19.x|
                mad r19.x, |r19.x|, r20.x, l(1.000000)
                mad r16.z, r16.z, r2.x, r5.w
                mul r19.x, r19.x, r19.x
...
mov r4.w, l(1.000000)
movc r1.xyzw, cb0[20].wwww, r1.xyzw, r4.xyzw
...
ret 
// Approximately 3004 instruction slots used
