...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  r4.z = saturate(r4.z);
  r1.z = 1 + -r4.z;
  r0.xyz = r0.xyz * r1.zzz + r11.xyz;
  r0.w = r0.w * r1.z + r4.z;
  r2.xyz = r2.xyw * r1.zzz + r12.xyz;
  r1.w = dot(r2.xyz, r2.xyz);
  r1.w = rsqrt(r1.w);
  r2.xyz = r2.xyz * r1.www;
  r5.y = r1.y * r1.z + r4.w;
  r6.xyz = r1.zzz * float3(0.0399999991,0.0399999991,0.0399999991) + r13.xyz;
  r1.y = cmp(0.5 < invertFalloff);
  if (r1.y != 0) {
    ...
    r1.y = r1.w * r1.y;
    r1.y = round(r1.y);
    r1.w = r1.y / columnCount;
    r3.w = columnCount * r1.y;
    r3.w = cmp(r3.w >= -r3.w);
    ...
    r1.yw = r3.ww * r1.yw;
    r1.yw = scaleUVs.xy * r1.yw;
    r1.yw = r4.zw * scaleUVs.xy + r1.yw;
    r1.yw = offsetUVs.xy * scaleUVs.xy + r1.yw;
    ...
    r11.y = r11.x;
    r11.z = r10.x;
    r12.x = dot(r11.yz, r1.yw);
    r11.x = -r10.x;
    r12.y = dot(r11.xy, r1.yw);
    r1.yw = gameTime.ww * scrollUVs.xy;
    r1.yw = r1.yw * scaleUVs.xy + r12.xy;
    r3.w = gameTime.w * zoomRate;
    r3.w = cos(r3.w);
    r3.w = r3.w * 0.5 + 0.5;
    r3.w = 1 + -r3.w;
    r4.z = zoomUVs.y + -zoomUVs.x;
    r3.w = r3.w * r4.z + zoomUVs.x;
    r1.yw = r1.yw / r3.ww;
    r1.yw = float2(0.5,0.5) + r1.yw;
    r4.zw = saturate(r1.yw);
    r9.xy = clampU ? r4.zw : r1.yw;
  }
  r1.y = dot(-v7.xyz, -v7.xyz);
  r1.y = rsqrt(r1.y);
  r10.xyz = -v7.xyz * r1.yyy;
  ...
  r1.z = v3.x + v3.y;
  r1.z = v3.z + r1.z;
  r1.z = flickerSeed.y + r1.z;
  r1.z = frac(r1.z);
  r9.y = gameTime.w * flickerSpeed + r1.z;
  r9.x = flickerSeed.x;
  r1.z = flickerLookupMap.SampleLevel(lookupSampler_s, r9.xy, 0).x;
  r1.z = log2(abs(r1.z));
  r1.z = flickerPower * r1.z;
  r1.z = exp2(r1.z);
  r1.w = flickerRange.y + -flickerRange.x;
  r1.z = r1.z * r1.w + flickerRange.x;
  r3.xyz = r3.xyz * r1.zzz;
  ...
  while (true) {
    ...
    bitmask.w = ((~(-1 << r9.z)) << 0) & 0xffffffff;  r12.w = (((uint)0 << 0) & bitmask.w) | ((uint)r12.y & ~bitmask.w);
  ...
  if (r9.w != 0) {
    ...
    r10.w = 0;
    while (true) {
      r11.w = cmp((uint)r10.w >= (uint)r6.w);
      if (r11.w != 0) break;
      r14.z = (uint)r10.w >> 5;
      r15.xyz = (int3)r8.xyz + (int3)r14.xyz;
      r11.w = visibleProbes.Load(r15.xyzw).x;
      r14.z = cmp((int)r8.w == (int)r10.w);
      if (r9.z == 0) r14.w = 0; else if (r9.z+0 < 32) {       r14.w = (uint)r11.w << (32-(r9.z + 0)); r14.w = (uint)r14.w >> (32-r9.z);      } else r14.w = (uint)r11.w >> 0;
  ...
  r12.yzw = r21.xyz * r4.zzz;
  r14.xyz = r22.xyz * r4.zzz;
  ...
  if (r5.z != 0) {
    ...
    r12.yzw = r21.xyz * r4.zzz + r15.xyz;
    r13.w = 0;
    r15.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r13.xyzw, r4.w).xyz;
  ...
  if (r6.w == 0) {
    ...
    if (r10.w == 0) {
      ...
      if (enableDitheredShadow != 0) {
        ...
        r12.yz = -sunConstants.splitPinTransform[r9.z].xy + r12.yz;
        ...
        while (true) {
          ...
          r16.w = r13.w ? sunConstants.splitPinTransform[r9.z].w : sunConstants.splitPinTransform[r10.w].w;
  ...
  if (r6.w != 0) {
    ...
    if (r6.w != 0) {
      ...
      if (sunConstants.sunCookieIndex != 0) {
        r7.w = 1;
        r9.z = dot(sunConstants.sunCookieTransform[0].xyzw, r7.xyzw);
      ...
      r7.w = r7.w * r8.w;
      r4.z = cmp(0 < r4.z);
      r16.xyz = r7.www * r7.xyz + r15.xyz;
      r12.yzw = -v7.xyz * r1.yyy + sunConstants.wldDir.xyz;
      r1.y = dot(r12.yzw, r12.yzw);
      r1.y = rsqrt(r1.y);
      r12.yzw = r12.yzw * r1.yyy;
      r1.y = dot(r12.yzw, r10.xyz);
      r7.w = dot(r2.xyz, r12.yzw);
      r9.z = abs(r7.w) * r1.w + -abs(r7.w);
      ...
      r4.w = r8.w * r4.w;
      r4.w = 0.25 * r4.w;
      r12.yzw = r4.www * r7.xyz + r5.yzw;
      r1.y = saturate(1 + -r1.y);
      r6.w = r1.y * r1.y;
      r6.w = r6.w * r6.w;
      r1.y = r6.w * r1.y;
      r1.y = r4.w * r1.y;
      r7.xyz = r1.yyy * r7.yzx + r14.xyz;
      r16.w = r7.z;
      r15.w = r14.z;
      r15.xyzw = r4.zzzz ? r16.xyzw : r15.xyzw;
      r7.zw = r12.yz;
      r14.zw = r5.yz;
      r7.xyzw = r4.zzzz ? r7.xyzw : r14.xyzw;
      r5.w = r4.z ? r12.w : r5.w;
      r14.z = r15.w;
      r14.xy = r7.xy;
      r5.yz = r7.zw;
    }
              ...
              if (r16.w != 0) {
                ...
                if (r16.w != 0) {
                  ...
                  while (true) {
                    ...
                    if (r27.w != 0) break;
                    r44.y = dot(icb[r26.w+0].yx, r7.xy);
                    r44.z = dot(icb[r26.w+0].yx, r7.yz);
                    ...
                    r11.w = samp0[]..swiz;
                      ...
                      if (r8.w != 0) {
                        ...
                        while (true) {
                          ...
                          if (r21.w != 0) break;
                          r43.x = dot(icb[r19.z+0].yx, r7.xw);
                      ...
                      r11.w = samp0[]..swiz;
                        ...
                        if (r8.w != 0) {
                          ...
                          while (true) {
                            ...
                            if (r26.w != 0) break;
                            r42.x = dot(icb[r21.w+0].xy, r11.xy);
                            r42.y = dot(icb[r21.w+0].yx, r11.xz);
            ...
            r40.w = samp0[]..swiz;
              ...
              if (r14.w != 0) {
                  ...
                  r40.y = samp0[]..swiz;
                    ...
                    if (r8.w != 0) {
                      ...
                      while (true) {
                        ...
                        r19.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r32.xyz, r9.w).x;
                        r16.z = r19.x * 0.125 + r16.z;
                        r16.w = (int)r16.w + 1;
                      }
                    } else {
                      r22.z = (uint)r14.w;
                      r16.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r22.xyz, r9.w).x;
                    }
                    r9.w = r16.z * r16.z;
                    r9.w = r9.w * r16.z;
                  } else {
                ...
                if (r14.w != 0) {
                  ...
                  r20.xyz = r20.xyz * r10.www + r10.xyz;
                  r10.w = dot(r20.xyz, r20.xyz);
                  r10.w = rsqrt(r10.w);
                  r20.xyz = r20.xyz * r10.www;
                  r10.w = dot(r20.xyz, r10.xyz);
                  r15.w = dot(r2.xyz, r20.xyz);
                  r16.w = abs(r15.w) * r1.w + -abs(r15.w);
                  r15.w = abs(r15.w) * r16.w + 1;
                  r13.w = r13.w * r1.x + r2.w;
                  r15.w = r15.w * r15.w;
                  r13.w = r15.w * r13.w;
                  r13.w = rcp(r13.w);
                  r13.w = r13.w * r14.w;
