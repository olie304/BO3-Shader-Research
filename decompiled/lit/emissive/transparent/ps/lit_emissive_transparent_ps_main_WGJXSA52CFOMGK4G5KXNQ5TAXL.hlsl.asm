...
rsq r4.w, r4.w
mad r7.xyz, r7.xyzx, r4.wwww, -r3.xzwx
...
mad r3.xyz, r3.xzwx, r0.yyyy, r16.xyzx
dp3 r3.w, r3.xyzx, r3.xyzx
rsq r3.w, r3.w
mul r3.xyz, r3.wwww, r3.xyzx
mad r8.y, r0.w, r0.y, r14.y
mad r2.yzw, r2.yyzw, r0.yyyy, r17.xxyz
mov_sat r0.x, r0.x
...
utof r0.yw, r7.yyyx
dp2 r4.x, r0.wyww, l(0.06711056, 0.00583715, 0.000000, 0.000000)
frc r4.x, r4.x
mul r4.xw, r4.xxxw, l(52.982918, 0.000000, 0.000000, 0.00781250)
frc r4.x, r4.x
...
dp3_sat r8.x, r3.xyzx, r10.xyzx
dp3 r0.y, -r10.xyzx, r3.xyzx
add r0.y, r0.y, r0.y
mad r12.xyz, r3.xyzx, -r0.yyyy, -r10.xyzx
mul r0.y, r8.y, l(17.000000)
exp r0.y, r0.y
...
mad r7.z, r4.z, l(5.000000), l(-2.500000)
...
if_z r4.w
        ...
        if_nz r14.w
          ...
          if_nz r14.z
            ...
            if_nz r16.w
              ...
              sqrt r14.z, r14.z
              mad r14.z, r4.z, l(5.000000), r14.z
  ...
  rcp r4.z, r4.z
  mov_sat r24.w, r24.w
  mul r20.xyz, r4.zzzz, r23.xyzx
  mul r21.xyz, r4.zzzz, r24.xyzx
  ...
  if_nz r4.w
    ...
    mul r11.yzw, r7.xxxx, r11.yyzw
    add r15.xyz, r7.yzwy, r14.wwyw
    ...
    mad r9.yzw, r9.yyzw, r11.yyyy, r15.xxyz
    add r7.xyz, r7.yzwy, r14.wwzw
    sample_l_indexable(texture3d)(float,float,float,float) r7.xyz, r7.xyzx, t19.xyzw, s4, l(0.000000)
    mad r7.xyz, r7.xyzx, r11.wwww, r9.yzwy
    mov r3.w, l(0)
    ...
    mad r20.xyz, r23.xyzx, r4.zzzz, r7.xyzx
    mov r12.w, l(0)
    sample_l_indexable(texturecubearray)(float,float,float,float) r7.xyz, r12.xyzw, t8.xyzw, s2, r6.w
    mad r4.z, cb2[19].x, r4.w, -r3.w
    mad r3.w, r8.y, r4.z, r3.w
    mad r21.xyz, r7.xyzx, r3.wwww, r21.xyzx
  endif 
else 
  mov r21.x, r20.w
endif 
...
mad r4.z, r8.x, r2.x, r3.w
mul r2.x, r2.x, r4.z
mul r3.w, r3.w, r4.z
dp3 r4.z, r3.xyzx, cb2[17].xyzx
mov_sat r4.w, r4.z
...
if_nz r6.w
  ...
  if_nz r6.w
    ...
    mad r9.yzw, r4.wwww, r11.yyzw, r8.yyzw
    ...
    mov r15.w, r16.z
    mov r7.w, r14.z
    movc r7.xyzw, r4.zzzz, r15.xyzw, r7.xyzw
    mov r16.zw, r9.yyyz
    mov r14.zw, r8.yyyz
    movc r15.xyzw, r4.zzzz, r16.xyzw, r14.xyzw
    movc r8.w, r4.z, r9.w, r8.w
    mov r14.z, r7.w
    mov r14.xy, r15.xyxx
    mov r8.yz, r15.zzwz
  endif 
          ...
          if_nz r26.w
            ...
            if_nz r26.w
              ...
              if_nz r26.w
                ...
                mad r41.xyz, r3.xyzx, r26.wwww, v6.xyzx
              ...
              if_nz r26.w
                ...
                if_nz r16.z
                  ...
                  mad r19.xyz, r3.xyzx, r27.wwww, v6.xyzx
                ...
                mad r14.w, -r25.w, r4.z, l(1.000000)
          ...
          if_nz r16.w
            ...
            if_nz r16.w
              ...
              if_nz r16.w
                ...
                mad r22.xyz, r3.xyzx, r16.wwww, v6.xyzx
              ...
              if_nz r16.w
                ...
                mad r19.x, -r16.z, r4.z, l(1.000000)
                mul r19.x, r19.x, r19.x
...
mad r0.xyz, r29.xyzx, r2.yzwy, r0.xyzx
...
mov r5.w, l(1.000000)
movc r2.xyzw, cb0[13].xxxx, r2.xyzw, r5.xyzw
