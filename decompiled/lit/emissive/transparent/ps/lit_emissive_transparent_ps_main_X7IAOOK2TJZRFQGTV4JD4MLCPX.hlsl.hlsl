// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:34:58 2021
...
r0.z = samp0[]..swiz;
  ...
  if (r6.z != 0) {
    ...
    r6.z = 0;
    while (true) {
      r7.w = cmp((uint)r6.z >= numStaticDecals);
      if (r7.w != 0) break;
      r11.z = (uint)r6.z >> 5;
      r12.xyz = (int3)r10.xyz + (int3)r11.xyz;
      r7.w = visibleDecals.Load(r12.xyzw).x;
      r8.w = cmp((int)r0.y == (int)r6.z);
      if (r5.w == 0) r10.w = 0; else if (r5.w+0 < 32) {       r10.w = (uint)r7.w << (32-(r5.w + 0)); r10.w = (uint)r10.w >> (32-r5.w);      } else r10.w = (uint)r7.w >> 0;
      r7.w = r8.w ? r10.w : r7.w;
      r8.w = (int)r4.w + (int)r6.z;
      r17.xyzw = r13.xzwy;
      r12.xyz = r14.xyz;
      r18.yz = r15.yz;
      r19.xy = r16.xy;
              ...
              r22.w = samp0[]..swiz;
                ...
                if (r23.w != 0) {
                  ...
                  if (r16.w != 0) {
                    ...
                    r29.xyz = r32.xyz * r29.xyz;
                    r16.w = materialTexMask.SampleGrad(samplerLinearClamp_s, r30.xyz, r31.x, r29.x).x;
                  } else {
                    r18.w = cmp((int)r23.w == 4);
                    if (r18.w != 0) {
                ...
                if (r21.x != 0) {
                  ...
                  r11.z = samp0[]..swiz;
                    ...
                    r30.xyz = r33.xyz * r30.xyz;
                    r11.z = materialTexMask.SampleGrad(samplerLinearClamp_s, r31.xyz, r32.z, r30.z).x;
                  } else {
                ...
                if (r21.y != 0) {
                  ...
                  r16.w = rsqrt(r16.w);
                  r22.xyz = r26.xyz * r16.www;
                  r16.w = dot(-r25.xyz, -r25.xyz);
                  r16.w = rsqrt(r16.w);
                  r23.xyz = -r25.xyz * r16.www;
                  ...
                  r21.xyz = r24.xyz * r14.www + r21.xyz;
                  r14.w = dot(r21.xyz, r21.xyz);
                  r14.w = rsqrt(r14.w);
                  r21.xyz = r21.xyz * r14.www;
                  r14.w = 1 + -r11.w;
                  r18.x = r17.x;
                  r22.xyz = r18.xyz * r14.www;
                  r18.xyz = r21.xyz * r11.www + r22.xyz;
                  r17.x = r18.x;
                }
                r14.w = 1 + -r11.w;
                r21.xyz = r14.www * r12.xyz;
                r12.xyz = r20.xyz * r11.www + r21.xyz;
                r19.z = r17.y;
                r20.xyz = r19.xyz * r14.www;
                r19.xyz = r29.xyz * r11.www + r20.xyz;
                r15.w = r17.w * r14.w;
                r17.z = r17.z * r14.w + r11.w;
                r17.w = r11.z * r11.w + r15.w;
                r17.y = r19.z;
              }
            }
          }
  ...
  if (r6.w != 0) {
    ...
    r6.z = (int)-r5.w + numStaticDecals;
    r6.w = (int)r0.y & -32;
    r7.w = (int)r0.y + (int)-r6.w;
    r11.xy = float2(0,0);
    r12.w = 0;
    r9.w = 1;
    r17.xyz = r14.xyz;
    ...
    r8.w = r5.w;
    while (true) {
      r10.w = cmp((uint)r8.w >= (uint)r0.y);
      if (r10.w != 0) break;
      r11.z = (uint)r8.w >> 5;
      r12.xyz = (int3)r10.xyz + (int3)r11.xyz;
      r10.w = visibleDecals.Load(r12.xyzw).x;
      r11.z = cmp((int)r5.w == (int)r8.w);
      bitmask.w = ((~(-1 << r6.z)) << 0) & 0xffffffff;  r11.w = (((uint)0 << 0) & bitmask.w) | ((uint)r10.w & ~bitmask.w);
      r10.w = r11.z ? r11.w : r10.w;
      r11.z = cmp((int)r6.w == (int)r8.w);
      if (r7.w == 0) r11.w = 0; else if (r7.w+0 < 32) {       r11.w = (uint)r10.w << (32-(r7.w + 0)); r11.w = (uint)r11.w >> (32-r7.w);      } else r11.w = (uint)r10.w >> 0;
      r10.w = r11.z ? r11.w : r10.w;
      r11.z = (int)r4.w + (int)r8.w;
      r12.xyz = r17.xyz;
      r21.xyz = r18.xyz;
      r22.xyz = r19.xyz;
      r13.zw = r20.xy;
          ...
          r25.z = samp0[]..swiz;
            ...
            r28.w = samp0[]..swiz;
              ...
              r25.w = samp0[]..swiz;
                ...
                if (r31.x != 0) {
                  if (4 == 0) r15.w = 0; else if (4+24 < 32) {                   r15.w = (uint)r24.w << (32-(4 + 24)); r15.w = (uint)r15.w >> (32-4);                  } else r15.w = (uint)r24.w >> 24;
                  r15.w = 1 << (int)r15.w;
                  r16.w = (uint)r24.w >> 28;
                  r16.w = 1 << (int)r16.w;
                  r17.w = cmp((int)r31.x == 4);
                  if (r17.w != 0) {
                    r17.w = (int)r24.w & 4095;
                    if (12 == 0) r18.w = 0; else if (12+12 < 32) {                     r18.w = (uint)r24.w << (32-(12 + 12)); r18.w = (uint)r18.w >> (32-12);                    } else r18.w = (uint)r24.w >> 12;
                    r19.w = (int)r25.w & 1023;
                    r32.xz = (uint2)r15.ww;
                    r32.y = (uint)r16.w;
                ...
                r16.w = cmp(r24.x != 1.000000);
                r17.w = r15.w + r23.w;
                r17.w = saturate(r17.w * r24.x + -r24.x);
                r15.w = r16.w ? r17.w : r15.w;
                if (r31.y != 0) {
                  if (4 == 0) r16.w = 0; else if (4+24 < 32) {                   r16.w = (uint)r25.y << (32-(4 + 24)); r16.w = (uint)r16.w >> (32-4);                  } else r16.w = (uint)r25.y >> 24;
                  r16.w = 1 << (int)r16.w;
                  r17.w = (uint)r25.y >> 28;
                  r17.w = 1 << (int)r17.w;
                  r18.w = cmp((int)r31.y == 2);
                  if (r18.w != 0) {
                    ...
                    r18.w = materialTexMask.SampleGrad(samplerLinearClamp_s, r33.xyz, r31.x, r32.x).x;
                  } else {
                    r19.w = cmp((int)r31.y == 4);
                    if (r19.w != 0) {
                      ...
                      r18.w = materialTexBC7.SampleGrad(samplerLinearClamp_s, r32.xyz, r33.x, r31.x).x;
                    } else {
                      r19.w = (int)r25.y & 4095;
                      if (12 == 0) r24.x = 0; else if (12+12 < 32) {                       r24.x = (uint)r25.y << (32-(12 + 12)); r24.x = (uint)r24.x >> (32-12);                      } else r24.x = (uint)r25.y >> 12;
                      if (10 == 0) r24.w = 0; else if (10+20 < 32) {                       r24.w = (uint)r25.w << (32-(10 + 20)); r24.w = (uint)r24.w >> (32-10);                      } else r24.w = (uint)r25.w >> 20;
                      ...
                      r31.xyz = r34.xyz * r31.xyz;
                      r18.w = materialTexBC3.SampleGrad(samplerLinearClamp_s, r32.xyz, r33.x, r31.x).x;
                    }
                  }
                  r31.xyz = r18.www * float3(0.959999979,0.959999979,0.959999979) + float3(0.0399999991,0.0399999991,0.0399999991);
                ...
                if (r24.x != 0) {
                  ...
                  r14.w = samp0[]..swiz;
                    ...
                    r32.xyz = r35.xyz * r32.xyz;
                    r14.w = materialTexMask.SampleGrad(samplerLinearClamp_s, r33.xyz, r34.x, r32.x).x;
                  } else {
                    r16.w = cmp((int)r24.x == 6);
                    r14.w = r16.w ? 0 : 1;
                  }
                } else {
                  r14.w = 1;
                ...
                if (r24.y != 0) {
                  ...
                  r17.w = min(1, r17.w);
                  r18.w = dot(r29.xyz, r29.xyz);
                  r18.w = rsqrt(r18.w);
                  r24.xyz = r29.xyz * r18.www;
                  r18.w = dot(-r28.xyz, -r28.xyz);
                  r18.w = rsqrt(r18.w);
                  r25.xyz = -r28.xyz * r18.www;
                  ...
                  r24.xyz = r26.xyz * r16.www + r24.xyz;
                  r16.w = dot(r24.xyz, r24.xyz);
                  r16.w = rsqrt(r16.w);
                  r24.xyz = r24.xyz * r16.www;
                  r16.w = 1 + -r15.w;
                  r25.xyz = r21.xyz * r16.www;
                  r21.xyz = r24.xyz * r15.www + r25.xyz;
                }
                r16.w = 1 + -r15.w;
                r24.xyz = r16.www * r12.xyz;
                r12.xyz = r23.xyz * r15.www + r24.xyz;
                r23.xyz = r22.xyz * r16.www;
                r22.xyz = r31.xyz * r15.www + r23.xyz;
                r17.w = r16.w * r13.w;
                r13.z = r13.z * r16.w + r15.w;
                r13.w = r14.w * r15.w + r17.w;
              }
            }
          }
        }
  ...
  r0.w = r0.w * r0.y + r13.x;
  r2.xyz = r2.xyz * r0.yyy + r15.xyz;
  r3.x = dot(r2.xyz, r2.xyz);
  r3.x = rsqrt(r3.x);
  r7.xyz = r3.xxx * r2.xyz;
  r2.y = r1.w * r0.y + r13.y;
  ...
  r1.w = dot(r10.xyz, r3.yzw);
  r3.x = dot(r10.xyz, r4.xyz);
  r3.y = dot(r10.xyz, r5.xyz);
  r2.z = cmp(0 < r1.w);
  r3.xy = -r3.xy / r1.ww;
  r3.xy = r2.zz ? r3.xy : 0;
  r2.z = 9.99999975e-06 + relativeHDR;
  r3.xy = r3.xy * r2.zz + w1.xy;
  ...
  r2.x = saturate(dot(r7.xyz, r10.xyz));
  r0.y = dot(-r10.xyz, r7.xyz);
  r0.y = r0.y + r0.y;
  r12.xyz = r7.xyz * -r0.yyy + -r10.xyz;
  r0.y = 17 * r2.y;
  r0.y = exp2(r0.y);
  r0.y = 2 + r0.y;
  r0.y = 2 / r0.y;
  ...
  while (true) {
    ...
    r11.y = cmp((int)r2.w == (int)r9.w);
    bitmask.z = ((~(-1 << r5.w)) << 0) & 0xffffffff;  r11.z = (((uint)0 << 0) & bitmask.z) | ((uint)r10.w & ~bitmask.z);
    ...
    while (true) {
      ...
      if (r13.w != 0) {
        r11.z = (int)r11.z ^ (int)r13.z;
        r13.z = (int)r11.w + (int)r11.y;
      // Known bad code for instruction (needs manual fix):
      ...
      r14.y = samp0[]..swiz;
        ...
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r24.xyzw, r11.w, l(0), t15.wxyz
        r24.x = samp0[]..swiz;
        r24.y = samp0[]..swiz;
        r24.z = samp0[]..swiz;
        r24.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r13.zw, r11.w, l(96), t15.xxxy
        r13.z = samp0[]..swiz;
        r13.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r25.xyzw, r11.w, l(116), t15.zwxy
        r25.x = samp0[]..swiz;
        r25.y = samp0[]..swiz;
        r25.z = samp0[]..swiz;
        r25.w = samp0[]..swiz;
        ...
        r31.w = samp0[]..swiz;
          ...
          if (r15.x != 0) {
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r27.xyzw, r11.w, l(16), t15.xyzw
          r27.x = samp0[]..swiz;
          r27.y = samp0[]..swiz;
          r27.z = samp0[]..swiz;
          r27.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r28.xyzw, r11.w, l(32), t15.yxwz
          r28.x = samp0[]..swiz;
          r28.y = samp0[]..swiz;
          r28.z = samp0[]..swiz;
          r28.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r29.xyzw, r11.w, l(48), t15.xyzw
          r29.x = samp0[]..swiz;
          r29.y = samp0[]..swiz;
          r29.z = samp0[]..swiz;
          r29.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r30.xyzw, r11.w, l(64), t15.zwxy
          r30.x = samp0[]..swiz;
          r30.y = samp0[]..swiz;
          r30.z = samp0[]..swiz;
          r30.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r31.xyzw, r11.w, l(80), t15.xyzw
          r31.x = samp0[]..swiz;
          r31.y = samp0[]..swiz;
          r31.z = samp0[]..swiz;
          r31.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r32.xyzw, r11.w, l(132), t15.zwxy
          r32.x = samp0[]..swiz;
          r32.y = samp0[]..swiz;
          r32.z = samp0[]..swiz;
          r32.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r33.xyzw, r11.w, l(148), t15.zwxy
          r33.x = samp0[]..swiz;
          r33.y = samp0[]..swiz;
          r33.z = samp0[]..swiz;
          r33.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r34.xyzw, r11.w, l(164), t15.zwxy
          r34.x = samp0[]..swiz;
          r34.y = samp0[]..swiz;
          r34.z = samp0[]..swiz;
          r34.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r35.xyzw, r11.w, l(180), t15.zwxy
          r35.x = samp0[]..swiz;
          r35.y = samp0[]..swiz;
          r35.z = samp0[]..swiz;
          r35.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r36.xyzw, r11.w, l(196), t15.xyzw
          r36.x = samp0[]..swiz;
          r36.y = samp0[]..swiz;
          r36.z = samp0[]..swiz;
          r36.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r37.xy, r11.w, l(212), t15.xyxx
          r37.x = samp0[]..swiz;
          r37.y = samp0[]..swiz;
            r23.z = r26.y * r13.w + r23.z;
            r11.w = r13.z * r25.z;
            r25.z = r32.z;
            r13.z = dot(r12.xyz, r25.xyz);
            ...
            r17.yzw = r12.xyz * r13.zzz + r17.yzw;
            ...
            r32.x = dot(r7.xyz, r24.xyz);
            r32.y = dot(r7.xyz, r25.xyz);
            ...
            r13.w = r13.z * r4.w;
            r14.xyz = r17.yzw * r11.www;
            r11.w = dot(r14.xyz, float3(0.212599993,0.715200007,0.0722000003));
            r11.w = r4.w * r13.z + r11.w;
            r11.w = r13.w / r11.w;
            r24.x = r22.w;
            r24.yz = r23.xy;
            r23.xyw = r14.yzx * r11.www + r24.yzx;
            r22.w = r23.w;
          }
        }
      }
  ...
  if (r6.w != 0) {
    ...
    r8.w = 0;
    while (true) {
      r9.w = cmp((uint)r8.w >= (uint)r5.z);
      if (r9.w != 0) break;
      r13.z = (uint)r8.w >> 5;
      r14.xyz = (int3)r6.xyz + (int3)r13.xyz;
      r9.w = visibleProbes.Load(r14.xyzw).x;
      r10.w = cmp((int)r2.w == (int)r8.w);
      if (r5.w == 0) r13.z = 0; else if (r5.w+0 < 32) {       r13.z = (uint)r9.w << (32-(r5.w + 0)); r13.z = (uint)r13.z >> (32-r5.w);      } else r13.z = (uint)r9.w >> 0;
      r9.w = r10.w ? r13.z : r9.w;
        ...
        r25.y = samp0[]..swiz;
          ...
          r32.w = samp0[]..swiz;
            ...
            r38.y = samp0[]..swiz;
              ...
              r17.yzw = r12.xyz * r15.www + r17.yzw;
  ...
  if (r2.w != 0) {
    ...
    r4.z = dot(r14.xyz, float3(0.212599993,0.715200007,0.0722000003));
    r13.xyz = r20.xyz * r2.zzz + r14.xyz;
    r12.w = 0;
    r14.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r12.xyzw, r4.y).xyz;
    r2.z = sunConstants.globalProbeExposure * r2.w + -r4.z;
    r2.z = r2.y * r2.z + r4.z;
    r11.yzw = r14.xyz * r2.zzz + r11.yzw;
  }
  ...
  r14.xyz = r11.zwy * r2.yyy;
  r2.yzw = r11.yzw * r2.zzz;
  r4.y = sqrt(r1.w);
  r4.y = r4.y * 0.5 + 0.5;
  r4.y = r4.y * r4.y;
  r4.z = 0.5 * r4.y;
  ...
  if (r5.w != 0) {
    r5.w = cmp(0 < r6.w);
    if (r5.w != 0) {
      r5.w = sunConstants.specScale * r0.y;
      r5.w = r5.w * r5.z;
  ...
  while (true) {
    ...
    if (r5.w != 0) break;
    r16.z = (uint)r5.z >> 5;
    r17.xyz = (int3)r6.xyz + (int3)r16.xyz;
            ...
            if (r16.w != 0) {
              ...
              if (r16.w != 0) {
                ...
                if (r16.w != 0) {
                  ...
                  r10.w = r10.w + -r16.z;
                  r10.w = r1.w * r10.w + r16.z;
                  r10.w = r10.w * r13.w;
                  r33.x = r32.x;
                  r12.w = cmp(0 < r14.w);
                  r20.xyz = r10.www * r33.xyz + r17.xyz;
                  r10.w = saturate(dot(r7.xyz, r40.xyz));
