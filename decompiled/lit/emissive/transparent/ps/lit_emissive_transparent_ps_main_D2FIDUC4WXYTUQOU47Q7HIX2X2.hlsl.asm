...
//   float hdrScale;                    // Offset:  176 Size:     4
//   float emissiveFalloffPower;        // Offset:  180 Size:     4
//   float3 emissiveTint1;              // Offset:  192 Size:    12
//   bool relativeHDR;                  // Offset:  204 Size:     4
//   bool invertFalloff;                // Offset:  208 Size:     4
//   float layerDepth;                  // Offset:  212 Size:     4
//   float uvMotionToggle1;             // Offset:  216 Size:     4 [unused]
//      = 0x00000000 
...
if_nz r0.w
  ...
  sample_indexable(texture2d)(float,float,float,float) r4.xyz, v2.xyxx, t0.xyzw, s1
  add r0.x, r4.y, r4.x
...
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, v2.xyxx, t22.xyzw, s1
add r1.xyz, r1.xyzx, l(-1.000000, -1.000000, -1.000000, 0.000000)
mad r1.xyz, r2.wwww, r1.xyzx, l(1.000000, 1.000000, 1.000000, 0.000000)
mul r1.xyz, r1.xyzx, r2.xyzx
sample_indexable(texture2d)(float,float,float,float) r0.x, v2.xyxx, t26.xyzw, s6
sample_indexable(texture2d)(float,float,float,float) r0.w, v2.xyxx, t25.yzwx, s3
add r1.w, -cb0[10].y, cb0[10].z
mad r0.w, r0.w, r1.w, cb0[10].y
...
mad r2.xyz, r3.yzwy, r1.wwww, r2.xyzx
...
mad r2.w, r2.w, r1.w, r6.z
mad r2.xyz, r2.xyzx, r1.wwww, r14.xyzx
dp3 r3.x, r2.xyzx, r2.xyzx
rsq r3.x, r3.x
mul r7.xyz, r2.xyzx, r3.xxxx
mad r2.y, r0.w, r1.w, r6.w
mad r8.xyz, r1.wwww, l(0.040000, 0.040000, 0.040000, 0.000000), r15.xyzx
mov_sat r0.y, r0.y
mul r0.y, r0.y, cb0[11].x
eq r11.xyz, r0.zzzz, l(3.000000, 2.000000, 1.000000, 0.000000)
lt r0.z, r0.z, l(0.000000)
movc r12.xyz, r0.zzzz, l(1.000000,1.000000,1.000000,0), cb0[12].xyzx
movc r12.xyz, r11.zzzz, cb0[15].xyzx, r12.xyzx
...
add r2.z, cb0[13].y, l(0.000010)
mad r3.xy, r3.xyxx, r2.zzzz, v2.xyxx
sample_indexable(texture2d)(float,float,float,float) r3.xyzw, r3.xyxx, t29.xyzw, s1
mul r3.xyz, r11.xyzx, r3.xyzx
mov_sat r0.w, r0.w
log r2.z, r0.w
mul r2.z, r2.z, cb0[11].y
exp r2.z, r2.z
add r0.w, -r0.w, l(1.000000)
log r0.w, r0.w
mul r0.w, r0.w, cb0[11].y
exp r0.w, r0.w
movc r0.w, cb0[13].x, r0.w, r2.z
eq r2.z, cb0[11].y, l(0.000000)
...
utof r4.xy, r6.xyxx
dp2 r0.w, r4.yxyy, l(0.06711056, 0.00583715, 0.000000, 0.000000)
frc r0.w, r0.w
...
frc r0.w, r0.w
mad r0.w, r0.w, l(6.28318548), cb1[70].w
sincos r4.x, r11.x, r0.w
dp3_sat r2.x, r7.xyzx, r12.xyzx
dp3 r0.w, -r12.xyzx, r7.xyzx
add r0.w, r0.w, r0.w
mad r13.xyz, r7.xyzx, -r0.wwww, -r12.xyzx
...
if_nz r4.z
  ...
  mad r11.yzw, r21.xxyz, r2.zzzz, r15.xxyz
  mov r13.w, l(0)
  ...
  mad r14.xyz, r15.xyzx, r2.zzzz, r14.xyzx
endif 
add r2.z, r0.x, r2.x
log r2.z, |r2.z|
mul r2.z, r1.w, r2.z
...
mul r11.yzw, r2.zzzz, r14.xxyz
mul r14.xyz, r4.yyyy, r11.zwyz
mul r4.yzw, r4.zzzz, r11.yyzw
sqrt r0.x, r1.w
  ...
  if_z r10.w
    ...
    if_nz cb2[58].y
      ...
      loop 
        ...
        utof r18.z, r13.w
        sample_c_lz_indexable(texture2darray)(float,float,float,float) r13.w, r18.xyzx, t13.xxxx, s13, r5.w
...
if_nz r5.w
  ...
  if_nz r5.w
    ...
    if_nz r8.w
      ...
      mad r9.w, |r2.z|, l(-0.200000), l(0.400000)
      ...
      if_z r9.w
        ...
        if_nz cb2[58].y
          ...
          loop 
            ...
            sample_c_lz_indexable(texture2darray)(float,float,float,float) r11.z, r18.xyzx, t9.xxxx, s13, r7.w
    ...
    mad r11.yzw, r5.zzzz, r9.xxyz, r4.yyzw
    add_sat r0.z, -r0.z, l(1.000000)
    mul r5.w, r0.z, r0.z
    mul r5.w, r5.w, r5.w
    mul r0.z, r0.z, r5.w
    mul r0.z, r0.z, r5.z
    mad r9.xyz, r0.zzzz, r9.yzxy, r14.xyzx
    mov r16.w, r9.z
    mov r15.w, r14.z
    movc r15.xyzw, r2.zzzz, r16.xyzw, r15.xyzw
    mov r9.zw, r11.yyyz
    mov r14.zw, r4.yyyz
    movc r9.xyzw, r2.zzzz, r9.xyzw, r14.xyzw
    movc r4.w, r2.z, r11.w, r4.w
    mov r14.z, r15.w
    mov r14.xy, r9.xyxx
    mov r4.yz, r9.zzwz
  endif 
          ...
          if_nz r16.w
            ...
            if_nz r16.w
              ...
              if_nz r16.w
                ...
                mad r42.xyz, r7.xyzx, r16.wwww, v7.xyzx
              ...
              if_nz r16.w
                ...
                if_nz r13.w
                  ...
                  mad r19.xyz, r7.xyzx, r21.wwww, v7.xyzx
                ...
                mad r16.z, |r15.w|, r0.w, -|r15.w|
                mad r15.w, |r15.w|, r16.z, l(1.000000)
                mad r16.z, r12.w, r0.x, r2.y
          ...
          if_nz r14.w
            ...
            if_nz r14.w
              ...
              if_nz r14.w
                ...
                mad r22.xyz, r7.xyzx, r14.wwww, v7.xyzx
              ...
              if_nz r14.w
                ...
                if_nz r16.w
                  ...
                  mad r23.xyz, r7.xyzx, r19.xxxx, v7.xyzx
                  ...
                  if_nz r16.w
                    ...
                    mad r19.x, |r12.w|, l(-0.200000), l(0.400000)
                    mad r24.xyz, r7.xyzx, r19.xxxx, v7.xyzx
                ...
                dp3 r15.w, r7.xyzx, r20.xyzx
                mad r16.w, |r15.w|, r0.w, -|r15.w|
                mad r15.w, |r15.w|, r16.w, l(1.000000)
                mad r13.w, r13.w, r0.x, r2.y
                mul r15.w, r15.w, r15.w
...
mov r3.w, l(1.000000)
movc r1.xyzw, cb0[12].wwww, r1.xyzw, r3.xyzw
add r0.xyz, r0.xyzx, r1.xyzx
mul r0.w, r1.w, cb0[11].x
