...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:34:21 2021
//
//
// Buffer Definitions: 
//
...
//   uint zFeatherComputeSprites;       // Offset:  288 Size:     4 [unused]
...
// normalBodyMap                     texture  float4          2d            t30      1 
...
if_nz cb0[17].w
  ...
  sample_indexable(texture2d)(float,float,float,float) r3.xyz, v1.yzyy, t29.xyzw, s1
...
sample_indexable(texture2d)(float,float,float,float) r0.w, r1.xyxx, t25.yzwx, s6
sample_indexable(texture2d)(float,float,float,float) r1.z, r1.xyxx, t24.yzxw, s3
add r1.w, -cb0[11].x, cb0[11].y
mad r1.z, r1.z, r1.w, cb0[11].x
mul_sat r1.z, r1.z, l(0.05882353)
sample_indexable(texture2d)(float,float,float,float) r3.xyz, r1.xyxx, t22.xyzw, s5
...
if_nz r0.z
  ...
  sample_indexable(texture2d)(float,float,float,float) r4.xyz, v1.yzyy, t30.xyzw, s5
  ...
  mad r5.xy, r3.xyxx, r0.xxxx, r4.xyxx
  dp3 r3.z, r5.xyzx, r5.xyzx
  rsq r3.z, r3.z
  mul r3.xyw, r3.zzzz, r5.xyxz
  mad r2.w, r2.w, r0.x, r0.z
else 
...
if_nz r1.w
  ftoi r1.w, cb1[64].w
  lod r2.w, r1.xyxx, t21.y, s1
  lod r3.w, r1.xyxx, t21.x, s1
  lt r2.w, r2.w, r3.w
...
add r1.z, -r0.z, r1.z
mad r0.z, cb1[62].w, r1.z, r0.z
add r1.z, -r0.w, cb1[63].x
mad r0.w, cb1[63].w, r1.z, r0.w
movc r6.xyz, v7.xxxx, v3.xyzx, -v3.xyzx
dp3 r1.z, r6.xyzx, r6.xyzx
rsq r1.z, r1.z
mad r6.xyz, r6.xyzx, r1.zzzz, -r3.xyzx
mad r3.xyz, cb1[60].wwww, r6.xyzx, r3.xyzx
...
if_nz r0.y
  ...
  mul r0.y, r0.y, r0.z
  round_ne r0.y, r0.y
  div r0.z, r0.y, cb0[11].w
  mul r1.w, r0.y, cb0[11].w
  ge r1.w, r1.w, -r1.w
  ...
  round_z r0.y, r0.y
  add r0.y, r0.y, r1.x
  div r8.x, r0.y, cb0[11].w
  round_z r0.y, r0.z
  add r0.y, r0.y, r1.y
  div r8.y, r0.y, cb0[11].z
else 
  ...
  mul r0.yz, r0.yyzy, cb0[13].zzwz
  mad r0.yz, r1.xxyx, cb0[13].zzwz, r0.yyzy
  mad r0.yz, cb0[14].xxyx, cb0[13].zzwz, r0.yyzy
  ...
  mul r0.yz, cb0[13].xxyx, cb1[69].wwww
  mad r0.yz, r0.yyzy, cb0[13].zzwz, r10.xxyx
  mul r1.x, cb0[15].x, cb1[69].w
  sincos null, r1.x, r1.x
  mad r1.x, r1.x, l(0.500000), l(0.500000)
  add r1.x, -r1.x, l(1.000000)
  add r1.y, -cb0[14].z, cb0[14].w
  mad r1.x, r1.x, r1.y, cb0[14].z
  div r0.yz, r0.yyzy, r1.xxxx
  add r0.yz, r0.yyzy, l(0.000000, 0.500000, 0.500000, 0.000000)
  mov_sat r1.xy, r0.yzyy
  movc r8.xy, cb0[15].zwzz, r1.xyxx, r0.yzyy
endif 
dp3 r0.y, -v6.xyzx, -v6.xyzx
rsq r0.y, r0.y
mul r1.xyw, r0.yyyy, -v6.xyxz
dp3_sat r0.z, r1.xywx, r4.xyzx
sample_indexable(texture2d)(float,float,float,float) r4.xyzw, r8.xyxx, t37.xyzw, s1
mul r4.xyz, r4.xyzx, cb0[19].xyzx
log r2.w, r0.z
...
exp r0.z, r0.z
movc r0.z, cb0[20].x, r0.z, r2.w
eq r2.w, cb0[18].z, l(0.000000)
movc r0.z, r2.w, l(1.000000), r0.z
mul r2.w, r4.w, cb0[18].y
mul r0.z, r0.z, r2.w
mul r0.x, r0.x, r0.z
mul r4.xyz, r0.xxxx, r4.xyzx
add r0.x, v2.y, v2.x
...
frc r0.x, r0.x
mad r8.y, cb1[69].w, cb0[16].z, r0.x
mov r8.x, cb0[16].x
sample_l_indexable(texture2d)(float,float,float,float) r0.x, r8.xyxx, t26.xyzw, s7, l(0.000000)
log r0.x, |r0.x|
...
dp3_sat r7.x, r3.xyzx, r1.xywx
dp3 r0.z, -r1.xywx, r3.xyzx
add r0.z, r0.z, r0.z
mad r12.xyz, r3.xyzx, -r0.zzzz, -r1.xywx
...
loop 
  ...
  add r10.yzw, -r22.yyzw, v6.xxyz
  dp3 r9.w, r10.yzwy, r10.yzwy
  sqrt r9.w, r9.w
  ge r9.w, cb2[54].y, r9.w
  and r11.y, r28.y, l(0x0000ffff)
  ...
  dp3 r11.z, r35.xyzx, r10.yzwy
  add_sat r11.z, r35.w, r11.z
  dp3 r11.w, r36.xyzx, r10.yzwy
  add_sat r11.w, r36.w, r11.w
  mul r11.z, r11.w, r11.z
  dp3 r11.w, r37.xyzx, r10.yzwy
  add_sat r11.w, r37.w, r11.w
  mul r11.z, r11.w, r11.z
  dp3 r11.w, r38.xyzx, r10.yzwy
  add_sat r11.w, r38.w, r11.w
  mul r11.z, r11.w, r11.z
  dp3 r11.w, r39.xyzx, r10.yzwy
  add_sat r11.w, r39.w, r11.w
  mul r11.z, r11.w, r11.z
  dp3 r11.w, r40.xyzx, r10.yzwy
  add_sat r11.w, r40.w, r11.w
  mul r16.x, r11.w, r11.z
  and r11.z, r8.z, l(1)
  movc r11.zw, r11.zzzz, r16.xxxy, r16.zzzx
  mov r15.xy, r28.zwzz
  mov r15.z, r29.z
  dp3 r13.w, r12.xyzx, r15.xyzx
  dp3 r14.z, r10.yzwy, r15.xyzx
  add r14.z, -r29.w, r14.z
  ge r14.w, r14.z, l(0.000000)
  max r14.z, r6.z, |r14.z|
  ...
  ubfe r14.zw, l(0, 0, 6, 9), l(0, 0, 25, 16), r28.yyyy
  utof r29.w, r14.w
  sample_l_indexable(texturecubearray)(float,float,float,float) r15.xyz, r29.xyzw, t8.xyzw, s2, r13.w
  and r23.xyz, r15.xyzx, l(0x7fffffff, 0x7fffffff, 0x7fffffff, 0)
  ieq r23.xyz, r23.xyzx, l(0x7f800000, 0x7f800000, 0x7f800000, 0)
  or r13.w, r23.y, r23.x
  or r13.w, r23.z, r13.w
  movc r15.xyz, r13.wwww, l(1.000000,1.000000,0,0), r15.xyzx
  dp3 r23.x, r10.yzwy, r22.xyzx
  dp3 r23.y, r10.yzwy, r30.xyzx
  dp3 r23.z, r10.yzwy, r24.xyzx
  mad_sat r23.xyz, r23.xyzx, r25.xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
  mov r26.z, r27.x
  mad r23.xyz, r23.xyzx, r26.xyzx, r27.yzwy
  dp3 r29.x, r3.xyzx, r22.xyzx
  dp3 r29.y, r3.xyzx, r30.xyzx
  dp3 r29.z, r3.xyzx, r24.xyzx
  lt r22.xyz, l(0.000000, 0.000000, 0.000000, 0.000000), r29.xyzx
  movc r17.z, r22.x, l(0), l(0.500000)
  add r24.xyz, r17.xyzx, r23.xyzx
  ...
  loop 
    breakc_z r14.w
    firstbit_lo r16.x, r14.w
    ishl r16.x, l(1), r16.x
    and r16.w, r14.w, r16.x
    if_nz r16.w
      not r16.x, r16.x
      ...
      if_nz r9.w
        ...
        mov r16.w, l(1)
        loop 
          ige r17.z, r16.w, r14.z
          breakc_nz r17.z
          iadd r17.z, r11.y, r16.w
        ...
        if_nz r16.x
          mad r30.z, r29.y, r8.w, r28.w
          mul r6.y, r28.x, r6.y
          mul r29.xzw, r6.yyyy, r25.xxyz
          mul r31.xyz, r22.xywx, r29.zzzz
          mad r31.xyz, r24.xyzx, r29.xxxx, r31.xyzx
          mad r29.xzw, r23.xxyz, r29.wwww, r31.xxyz
          mul r31.xyz, r26.xyzx, r29.xzwx
          dp3 r16.x, r31.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
          mad r31.xyz, r29.xzwx, r26.xyzx, r27.xyzx
          mul r16.w, r6.w, r16.x
          mul r29.xzw, r6.yyyy, r15.xxyz
          dp3 r6.y, r29.xzwx, l(0.212600, 0.715200, 0.072200, 0.000000)
          mad r6.y, r6.w, r16.x, r6.y
          div r6.y, r16.w, r6.y
          mov r32.x, r27.w
          mov r32.yz, r28.yyzy
          ...
          mov r31.xyzw, r27.xyzw
          mov r30.xyz, r28.yzwy
        endif 
        mov r13.w, l(-1)
        mov r27.xyzw, r31.xyzw
        mov r28.yzw, r30.xxyz
        break 
      endif 
    endif 
  endloop 
  if_nz r13.w
    mov r20.xyzw, r27.xyzw
...
if_z r1.z
    ...
    loop 
      ...
      if_nz r11.y
        ...
        if_nz r10.w
          ...
          and r10.w, r28.w, l(0x0000ffff)
          ubfe r11.w, l(6), l(25), r28.w
          ...
          mul r13.w, r13.w, r14.z
          dp3 r14.z, r33.xyzx, r15.xyzx
          add_sat r14.z, r33.w, r14.z
          mul r13.w, r13.w, r14.z
          dp3 r14.z, r34.xyzx, r15.xyzx
          ...
          loop 
            ...
            add_sat r17.w, r33.w, r17.w
            mul r16.w, r16.w, r17.w
            dp3 r17.w, r34.xyzx, r15.xyzx
            add_sat r17.w, r34.w, r17.w
            mul r16.w, r16.w, r17.w
            dp3 r17.w, r35.xyzx, r15.xyzx
            add_sat r17.w, r35.w, r17.w
          ...
          if_nz r11.y
            ...
            mad r26.z, r29.y, r11.z, r26.z
            mul r10.z, r28.z, r10.w
            mov r28.z, r35.z
            dp3 r10.w, r12.xyzx, r28.xyzx
            dp3 r11.y, r15.xyzx, r28.xyzx
            add r11.y, -r35.w, r11.y
            ...
            dp3 r11.z, r15.xyzx, r37.xyzx
            add r11.z, -r38.w, r11.z
            ge r11.w, r11.z, l(0.000000)
            max r11.z, r6.z, |r11.z|
            movc r11.z, r11.w, r11.z, -r11.z
            max r11.y, -r11.y, l(0.00000010)
            ...
            min r10.w, r10.w, |r11.y|
            mov r38.z, r39.x
            dp3 r11.y, r12.xyzx, r38.xyzx
            dp3 r11.z, r15.xyzx, r38.xyzx
            ...
            min r10.w, r10.w, |r11.y|
            mov r40.zw, r39.zzzw
            dp3 r11.y, r12.zxyz, r40.xzwx
            dp3 r11.z, r15.zxyz, r40.xzwx
            add r11.z, -r40.y, r11.z
            ge r11.w, r11.z, l(0.000000)
            max r11.z, r6.z, |r11.z|
            movc r11.z, r11.w, r11.z, -r11.z
            max r11.y, -r11.y, l(0.00000010)
            ...
            mov r27.y, r30.z
            mov r27.z, r31.x
            dp3 r35.x, r11.yzwy, r27.xyzx
            mov r28.xy, r30.xwxx
            mov r28.z, r31.w
            dp3 r35.y, r11.yzwy, r28.xyzx
            mov r31.x, r30.y
            dp3 r35.z, r11.yzwy, r31.xyzx
            ubfe r11.y, l(9), l(16), r28.w
            utof r35.w, r11.y
            sample_l_indexable(texturecubearray)(float,float,float,float) r11.yzw, r35.xyzw, t8.wxyz, s2, r10.w
            and r18.yzw, r11.yyzw, l(0, 0x7fffffff, 0x7fffffff, 0x7fffffff)
            ieq r18.yzw, r18.yyzw, l(0, 0x7f800000, 0x7f800000, 0x7f800000)
            or r10.w, r18.z, r18.y
            or r10.w, r18.w, r10.w
            movc r11.yzw, r10.wwww, l(0,1.000000,1.000000,0), r11.yyzw
            ...
            lt r18.yzw, l(0.000000, 0.000000, 0.000000, 0.000000), r35.xxyz
            movc r17.z, r18.y, l(0), l(0.500000)
            add r27.xyz, r15.xyzx, r17.xyzx
            ...
            mul r28.xyz, r10.zzzz, r28.xyzx
            movc r19.z, r18.z, l(0), l(0.500000)
            add r29.xzw, r15.xxyz, r19.xxyz
            sample_l_indexable(texture3d)(float,float,float,float) r29.xzw, r29.xzwx, t18.xwyz, s4, l(0.000000)
            mul r29.xzw, r28.yyyy, r29.xxzw
            mad r27.xyz, r27.xyzx, r28.xxxx, r29.xzwx
            movc r22.z, r18.w, l(0), l(0.500000)
            ...
            mad r15.xyz, r15.xyzx, r28.zzzz, r27.xyzx
            sample_l_indexable(texturecubearray)(float,float,float,float) r18.yzw, r35.xyzw, t8.wxyz, s2, l(6.000000)
            and r27.xyz, r18.yzwy, l(0x7fffffff, 0x7fffffff, 0x7fffffff, 0)
            ieq r27.xyz, r27.xyzx, l(0x7f800000, 0x7f800000, 0x7f800000, 0)
            or r10.w, r27.y, r27.x
            or r10.w, r27.z, r10.w
            movc r18.yzw, r10.wwww, l(0,1.000000,1.000000,0), r18.yyzw
            mul r27.xyz, r15.xyzx, r18.yzwy
            dp3 r10.w, r27.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
            mad r25.xyz, r15.xyzx, r18.yzwy, r25.xyzx
            ...
            mov r15.x, r25.w
            mov r15.yz, r26.xxyx
            mad r26.xyw, r11.zwzy, r10.zzzz, r15.yzyx
            mov r25.w, r26.w
          endif 
        endif 
      endif 
        ...
        if_nz r15.x
          ...
          if_nz r14.w
            ...
            loop 
              ...
              movc r18.y, r27.w, r18.w, r29.w
              movc r30.xy, r22.wwww, r30.xyxx, r18.xyxx
              iadd r18.z, r18.z, l(1)
              mov r17.w, r21.w
            endloop 
            add_sat r14.w, -r9.w, r30.y
            ...
            if_nz r15.z
              ...
              mad r26.w, r14.w, r15.y, r26.w
              mul r14.z, r28.z, r15.x
              mov r28.z, r36.z
              ...
              mad r11.yzw, r18.yyzw, r27.xxyz, r11.yyzw
              ...
              mad r26.xyz, r15.xyzx, r14.zzzz, r26.xyzx
            endif 
          endif 
        endif 
      endloop 
  ...
  if_nz r4.w
    ...
    mov r14.w, l(0)
    add r10.yzw, r6.yyzw, r14.wwwx
    sample_l_indexable(texture3d)(float,float,float,float) r10.yzw, r10.yzwy, t17.wxyz, s4, l(0.000000)
    mul r11.yzw, r3.xxyz, r3.xxyz
    mul r11.yzw, r6.xxxx, r11.yyzw
    add r15.xyz, r6.yzwy, r14.wwyw
    ...
    mad r20.xyz, r23.xyzx, r1.zzzz, r6.xyzx
    mov r12.w, l(0)
    sample_l_indexable(texturecubearray)(float,float,float,float) r6.xyz, r12.xyzw, t8.xyzw, s2, r5.w
    mad r1.z, cb2[19].x, r4.w, -r3.w
    mad r1.z, r7.y, r1.z, r3.w
    mad r21.xyz, r6.xyzx, r1.zzzz, r21.xyzx
  endif 
else 
  mov r21.x, r20.w
endif 
...
if_nz r5.w
  ...
  if_nz r5.w
    ...
    if_nz r9.w
      ...
      mad r19.xyz, r3.xyzx, r11.yyyy, v6.xyzx
          ...
          if_nz r21.w
            ...
            if_nz r21.w
              ...
              if_nz r21.w
                ...
                mad r41.xyz, r3.xyzx, r21.wwww, v6.xyzx
              ...
              if_nz r21.w
                ...
                if_nz r13.w
                  ...
                  mad r19.xyz, r3.xyzx, r25.wwww, v6.xyzx
          ...
          if_nz r14.w
            ...
            if_nz r14.w
              ...
              if_nz r14.w
                ...
                mad r22.xyz, r3.xyzx, r14.wwww, v6.xyzx
              ...
              if_nz r14.w
                ...
                if_nz r19.x
                  ...
                  mad r23.xyz, r3.xyzx, r22.xxxx, v6.xyzx
                  ...
                  if_nz r19.x
                    ...
                    mad r22.x, |r12.w|, l(-0.200000), l(0.400000)
                    mad r24.xyz, r3.xyzx, r22.xxxx, v6.xyzx
...
movc r1.xyz, cb0[19].wwww, r1.xyzx, r4.xyzx
...
ret 
// Approximately 3034 instruction slots used
