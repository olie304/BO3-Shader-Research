...
movc r10.xyz, r0.zzzz, l(1.000000,1.000000,1.000000,0), cb0[12].yzwy
movc r10.xyz, r9.zzzz, cb0[15].xyzx, r10.xyzx
...
mul r4.y, r2.z, l(5.000000)
mad r4.z, r2.z, l(5.000000), l(-2.500000)
mul_sat r4.z, r4.z, l(0.400000)
mul r4.z, r4.z, l(100.000000)
mad r5.zw, -r2.zzzz, l(0.000000, 0.000000, 10.000000, 5.000000), l(0.000000, 0.000000, 6.857410, 7.085000)
exp r4.w, r5.z
mul r4.w, r2.x, r4.w
mul r4.w, r4.w, l(9.136810)
mul r5.z, r2.z, r4.y
mad r5.z, -r5.z, l(2.015905), r5.w
exp r5.z, r5.z
mul r5.z, r2.x, r5.z
mul r5.z, r5.z, l(9.708090)
max r4.w, r4.w, r5.z
...
loop 
  ...
  loop 
    ...
    and r13.w, r11.z, r13.z
    if_nz r13.w
      xor r11.z, r11.z, r13.z
      iadd r13.z, r11.w, r11.y
      ...
      if_nz r13.z
        ...
        if_nz r15.x
          ...
          mul r11.w, r25.z, r13.z
          mov r25.z, r32.z
          dp3 r13.z, r12.xyzx, r25.xyzx
          ...
          mad r17.yzw, r12.xxyz, r13.zzzz, r17.yyzw
          ...
          dp3 r32.x, r7.xyzx, r24.xyzx
          dp3 r32.y, r7.xyzx, r25.xyzx
          ...
          mul r13.w, r4.w, r13.z
          mul r14.xyz, r11.wwww, r17.yzwy
          dp3 r11.w, r14.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
          mad r11.w, r4.w, r13.z, r11.w
          div r11.w, r13.w, r11.w
          mov r24.x, r22.w
          mov r24.yz, r23.xxyx
          mad r23.xyw, r14.yzyx, r11.wwww, r24.yzyx
          mov r22.w, r23.w
        endif 
      endif 
    endif 
...
if_nz r6.w
  ...
  loop 
    ...
    ieq r10.w, r2.w, r8.w
    ubfe r13.z, r5.w, l(0), r9.w
    movc r9.w, r10.w, r13.z, r9.w
...
max r2.z, r21.w, l(1.000000)
rcp r2.z, r2.z
mov_sat r21.w, r21.w
mul r13.xyz, r2.zzzz, r20.xyzx
mul r11.yzw, r2.zzzz, r21.xxyz
lt r2.w, r21.w, l(0.990000)
if_nz r2.w
  add r2.w, -r21.w, l(1.000000)
  mul r4.z, r2.w, cb2[19].x
  ...
  dp3 r4.z, r14.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
  mad r13.xyz, r20.xyzx, r2.zzzz, r14.xyzx
  mov r12.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r14.xyz, r12.xyzw, t8.xyzw, s2, r4.y
  mad r2.z, cb2[19].x, r2.w, -r4.z
  mad r2.z, r2.y, r2.z, r4.z
  mad r11.yzw, r14.xxyz, r2.zzzz, r11.yyzw
endif 
...
mad r4.w, r2.x, r4.y, r4.z
mul r4.yz, r4.wwww, r4.yyzy
...
if_nz r5.w
  ...
  if_nz r5.w
    ...
    mad r16.xyz, r5.zzzz, r11.yzwy, r2.yzwy
...
if_z r0.w
  ftou r3.xy, v0.xyxx
  bfi r0.w, l(1), l(16), cb0[11].z, l(0)
  iadd r0.w, r0.w, l(1)
...
ret 
// Approximately 2645 instruction slots used
