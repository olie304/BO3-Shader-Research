...
if_nz r0.z
  ...
  add r1.w, r3.y, r3.x
  add_sat r1.w, r3.z, r1.w
  mul r2.xyz, r2.xyzx, r3.yyyy
  mad r1.xyz, r3.xxxx, r1.xyzx, r2.xyzx
  mad r0.xzw, r3.zzzz, r0.xxzw, r1.xxyz
  add r1.x, -r1.w, l(1.000000)
  add r1.yzw, -r0.xxzw, l(0.000000, 1.000000, 1.000000, 1.000000)
...
mad r0.xzw, r1.wwww, r0.xxzw, l(1.000000, 0.000000, 1.000000, 1.000000)
mul r0.xzw, r0.xxzw, r1.xxyz
sample_indexable(texture2d)(float,float,float,float) r1.xyz, v1.yzyy, t24.xyzw, s3
...
mad r2.z, cb1[62].x, r2.z, cb0[11].x
...
if_nz r2.w
  ...
  movc r9.xyz, r8.xxxx, l(1.000000,0,1.000000,0), r0.xzwx
  movc r8.xyw, r8.yyyy, l(0,1.000000,0,1.000000), r0.xzxw
  movc r8.xyw, r3.yyyy, r9.xyxz, r8.xyxw
  movc r9.xyz, r8.zzzz, l(0,1.000000,0,0), r0.xzwx
  movc r0.xzw, r3.xxxx, r8.xxyw, r9.xxyz
endif 
add r3.xyz, -r0.xzwx, cb1[58].xyzx
mad r0.xzw, cb1[58].wwww, r3.xxyz, r0.xxzw
add r2.w, -r1.w, cb1[59].x
mad r1.w, cb1[59].w, r2.w, r1.w
add r3.xyz, -r1.xyzx, cb1[61].xyzx
mad r1.xyz, cb1[61].wwww, r3.xyzx, r1.xyzx
add r2.z, -r2.y, r2.z
mad r2.y, cb1[62].w, r2.z, r2.y
add r2.z, -r2.x, cb1[63].x
mad r2.x, cb1[63].w, r2.z, r2.x
movc r3.xyz, v7.xxxx, v3.xyzx, -v3.xyzx
dp3 r2.z, r3.xyzx, r3.xyzx
rsq r2.z, r2.z
mad r3.xyz, r3.xyzx, r2.zzzz, -r7.xyzx
mad r3.xyz, cb1[60].wwww, r3.xyzx, r7.xyzx
...
mad r0.xzw, r0.xxzw, r0.yyyy, r15.xxyz
mad r1.w, r1.w, r0.y, r14.x
mad r3.xyz, r3.xyzx, r0.yyyy, r16.xyzx
dp3 r2.w, r3.xyzx, r3.xyzx
rsq r2.w, r2.w
mul r3.xyz, r2.wwww, r3.xyzx
mad r8.y, r2.y, r0.y, r14.y
mad r1.xyz, r1.xyzx, r0.yyyy, r17.xyzx
dp3 r2.y, -v6.xyzx, -v6.xyzx
rsq r2.y, r2.y
mul r9.xyz, r2.yyyy, -v6.xyzx
dp3 r2.w, r9.xyzx, r4.xyzx
dp3 r4.x, r9.xyzx, r5.xyzx
dp3 r4.y, r9.xyzx, r6.xyzx
...
frc r2.w, r2.w
mul r2.zw, r2.zzzw, l(0.000000, 0.000000, 0.00781250, 52.982918)
frc r2.w, r2.w
mad r2.w, r2.w, l(6.28318548), cb1[70].w
sincos r6.x, r10.x, r2.w
...
dp3_sat r8.x, r3.xyzx, r9.xyzx
dp3 r2.w, -r9.xyzx, r3.xyzx
add r2.w, r2.w, r2.w
mad r12.xyz, r3.xyzx, -r2.wwww, -r9.xyzx
...
if_z r2.z
  ...
  if_nz r5.z
    ...
    mad r20.xyz, r22.xyzx, r2.zzzz, r11.yzwy
    mov r12.w, l(0)
    sample_l_indexable(texturecubearray)(float,float,float,float) r11.yzw, r12.xyzw, t8.wxyz, s2, r5.w
    mad r2.z, cb2[19].x, r5.z, -r3.w
    mad r2.z, r8.y, r2.z, r3.w
    mad r21.xyz, r11.yzwy, r2.zzzz, r21.xyzx
  endif 
else 
  mov r21.x, r20.w
endif 
...
if_z r5.w
  ...
  if_nz r9.w
    ...
    movc r6.z, r10.w, l(0), l(1.000000)
  endif 
  if_z r9.w
    if_z cb2[58].y
      ftou r9.w, r6.w
...
if_nz r5.w
  ...
  if_nz r5.w
    ...
    add r6.w, -r5.z, r6.w
    mad r6.w, r5.y, r6.w, r5.z
    mul r6.w, r6.z, r6.w
    lt r3.w, l(0.000000), r3.w
    mad r15.xyz, r6.wwww, r11.yzwy, r13.xyzx
    mad r16.xyz, -v6.xyzx, r2.yyyy, cb2[17].xyzx
    dp3 r2.y, r16.xyzx, r16.xyzx
    rsq r2.y, r2.y
    mul r16.xyz, r2.yyyy, r16.xyzx
    dp3 r2.y, r16.xyzx, r9.xyzx
    dp3 r6.w, r3.xyzx, r16.xyzx
    mad r7.w, |r6.w|, r2.w, -|r6.w|
    mad r6.w, |r6.w|, r7.w, l(1.000000)
    mad r5.z, r5.z, r2.x, r2.z
    mul r6.w, r6.w, r6.w
    mul r5.z, r5.z, r6.w
    rcp r5.z, r5.z
    mul r5.z, r5.w, r5.z
    ...
    mul r2.y, r2.y, r5.w
    mul r2.y, r2.y, r5.z
    mad r17.xyz, r2.yyyy, r11.zwyz, r14.xyzx
    mov r15.w, r17.z
    mov r13.w, r14.z
          ...
          if_nz r16.w
            ...
            if_nz r16.w
              ...
              if_nz r16.w
                ...
                mad r42.xyz, r3.xyzx, r16.wwww, v6.xyzx
              ...
              if_nz r16.w
                ...
                mad r10.w, -r16.z, r3.w, l(1.000000)
...
mad r0.xyz, r11.yzwy, r0.xzwx, r1.xyzx
...
ret 
// Approximately 2953 instruction slots used
