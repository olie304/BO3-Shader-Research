// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:34:24 2021
...
r0.y = samp0[]..swiz;
  ...
  r3.xyz = r3.xyz * r0.xxx + r13.xyz;
  r0.w = dot(r3.xyz, r3.xyz);
  r0.w = rsqrt(r0.w);
  r3.xyz = r3.xyz * r0.www;
  r6.y = r0.y * r0.x + r5.w;
  r5.xyz = r5.xyz * r0.xxx + r14.xyz;
  ...
  r4.xyzw = emissiveMap.Sample(colorSampler_s, r7.xy).xyzw;
  ...
  r6.x = saturate(dot(r3.xyz, r10.xyz));
  ...
  r41.w = samp0[]..swiz;
    ...
    r30.x = dot(r3.xyz, r23.xyz);
    r30.y = dot(r3.xyz, r31.xyz);
    r30.z = dot(r3.xyz, r25.xyz);
