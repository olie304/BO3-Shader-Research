...
r1.w = samp0[]..swiz;
  ...
  r5.w = dot(r3.xyw, r3.xyw);
  r5.w = rsqrt(r5.w);
  r3.xyw = r5.www * r3.xyw;
  ...
  if (r3.z != 0) {
    ...
    r5.w = colorMap.CalculateLevelOfDetailUnclamped(colorSampler_s, v2.xy);
    r6.w = colorMap.CalculateLevelOfDetail(colorSampler_s, v2.xy);
    r5.w = cmp(r5.w < r6.w);
    r6.w = cmp(0 < r6.w);
    r7.xyz = (int3)r3.zzz & int3(1,2,4);
    r8.xyz = r7.xxx ? float3(1,0,1) : r1.xyz;
    r7.xyw = r7.yyy ? float3(0,1,1) : r1.xyz;
    r7.xyw = r6.www ? r8.xyz : r7.xyw;
    r8.xyz = r7.zzz ? float3(0,1,0) : r1.xyz;
    r1.xyz = r5.www ? r7.xyw : r8.xyz;
  }
  r7.xyz = debugColorOverride.xyz + -r1.xyz;
  r1.xyz = debugColorOverride.www * r7.xyz + r1.xyz;
  r3.z = debugAlphaOverride.x + -r2.w;
  r2.w = debugAlphaOverride.w * r3.z + r2.w;
  ...
  r1.w = rsqrt(r1.w);
  r7.xyz = r7.xyz * r1.www + -r3.xyw;
  r3.xyz = debugNormalOverride.www * r7.xyz + r3.xyw;
