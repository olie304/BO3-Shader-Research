...
sample_indexable(texture2d)(float,float,float,float) r3.xyz, v2.xyxx, t22.xyzw, s3
...
if_nz r2.z
  ftoi r2.z, cb1[64].w
  lod r2.w, v2.xyxx, t21.y, s1
  lod r3.x, v2.xyxx, t21.x, s1
  lt r2.w, r2.w, r3.x
...
loop 
  ...
  ld_indexable(texture2darray)(uint,uint,uint,uint) r9.w, r13.xyzw, t35.yzwx
  ieq r11.w, r4.w, r8.w
  ubfe r12.z, r6.w, l(0), r9.w
  movc r9.w, r11.w, r12.z, r9.w
  iadd r11.w, r5.w, r8.w
      ...
      if_nz r16.w
        ...
        if_nz r16.w
          ...
          if_nz r16.w
            ...
            if_nz r22.z
              ubfe r16.w, l(4), l(24), r20.w
              ishl r16.w, l(1), r16.w
              ushr r17.w, r20.w, l(28)
              ishl r17.w, l(1), r17.w
              ieq r18.w, r22.z, l(4)
              if_nz r18.w
                and r18.w, r20.w, l(4095)
                ubfe r23.w, l(12), l(12), r20.w
                and r24.w, r21.w, l(1023)
              ...
              mul r16.w, r19.w, r28.w
            else 
              mov r19.xyz, l(0,0,0,0)
              mov r16.w, l(0)
            endif 
            ne r17.w, r20.x, l(1.000000)
            add r18.w, r19.w, r16.w
            mad_sat r18.w, r18.w, r20.x, -r20.x
            movc r16.w, r17.w, r18.w, r16.w
            if_nz r22.w
              ubfe r17.w, l(4), l(24), r21.y
              ishl r17.w, l(1), r17.w
              ...
              if_nz r19.w
                ...
                mul r28.xyz, r28.xyzx, r31.xyzx
                sample_d_indexable(texture2darray)(float,float,float,float) r19.w, r29.xyzx, t45.yzwx, s4, r30.xyzx, r28.xyzx
              else 
                ieq r20.x, r22.w, l(4)
                if_nz r20.x
                  and r20.x, r21.y, l(4095)
                  ubfe r22.zw, l(0, 0, 12, 10), l(0, 0, 12, 20), r21.yyyw
                  utof r28.xz, r17.wwww
                  utof r28.y, r18.w
                  mad r29.xy, r22.xyxx, r28.zyzz, l(0.500000, 0.500000, 0.000000, 0.000000)
                  add r29.zw, r28.zzzy, l(0.000000, 0.000000, -0.500000, -0.500000)
                  ...
                  mul r31.xyz, r27.zyzz, cb1[83].xyxx
                  mul r28.xyz, r28.xyzx, r31.xyzx
                  sample_d_indexable(texture2darray)(float,float,float,float) r19.w, r29.xyzx, t42.yzwx, s4, r30.xyzx, r28.xyzx
                else 
                  and r20.x, r21.y, l(4095)
                  ubfe r22.zw, l(0, 0, 12, 10), l(0, 0, 12, 20), r21.yyyw
                  utof r28.xz, r17.wwww
                  ...
                  mul r28.xyz, r28.xyzx, r31.xyzx
                  sample_d_indexable(texture2darray)(float,float,float,float) r19.w, r29.xyzx, t43.yzwx, s4, r30.xyzx, r28.xyzx
                endif 
              endif 
              mad r28.xyz, r19.wwww, l(0.960000, 0.960000, 0.960000, 0.000000), l(0.040000, 0.040000, 0.040000, 0.000000)
            ...
            if_nz r20.x
              ...
              if_nz r17.w
                ...
                mul r29.xyz, r29.xyzx, r32.xyzx
                sample_d_indexable(texture2darray)(float,float,float,float) r15.w, r30.xyzx, t45.yzwx, s4, r31.xyzx, r29.xyzx
              else 
                ieq r17.w, r20.x, l(6)
            ...
            if_nz r20.y
              ...
              rsq r19.w, r19.w
              mul r21.xyz, r19.wwww, r25.xyzx
              dp3 r19.w, -r24.xyzx, -r24.xyzx
              rsq r19.w, r19.w
              mul r22.xyz, r19.wwww, -r24.xyzx
              ...
              mad r20.xyz, r23.xyzx, r17.wwww, r20.xyzx
              dp3 r17.w, r20.xyzx, r20.xyzx
              rsq r17.w, r17.w
              mul r20.xyz, r17.wwww, r20.xyzx
              add r17.w, -r16.w, l(1.000000)
              mul r21.xyz, r17.wwww, r17.xyzx
              mad r17.xyz, r20.xyzx, r16.wwww, r21.xyzx
            endif 
            add r17.w, -r16.w, l(1.000000)
            mul r20.xyz, r13.xyzx, r17.wwww
            mad r13.xyz, r19.xyzx, r16.wwww, r20.xyzx
            mul r19.xyz, r17.wwww, r18.xyzx
            mad r18.xyz, r28.xyzx, r16.wwww, r19.xyzx
            mad r12.z, r12.z, r17.w, r16.w
            mul r17.w, r12.w, r17.w
            mad r12.w, r15.w, r16.w, r17.w
          endif 
        endif 
      endif 
    endif 
...
endloop 
mov_sat r7.z, r7.z
add r3.z, -r7.z, l(1.000000)
mad r1.xyz, r1.xyzx, r3.zzzz, r14.xyzx
mad r0.w, r0.w, r3.z, r7.z
mad r2.yzw, r2.yyzw, r3.zzzz, r15.xxyz
dp3 r4.w, r2.yzwy, r2.yzwy
rsq r4.w, r4.w
mul r8.xyz, r2.yzwy, r4.wwww
mad r9.y, r1.w, r3.z, r7.w
mad r2.yzw, r3.xxyw, r3.zzzz, r16.xxyz
mov_sat r0.x, r0.x
mul r0.x, r0.x, cb0[11].w
eq r3.xyw, r0.zzzz, l(3.000000, 2.000000, 0.000000, 1.000000)
movc r12.xyz, r3.wwww, cb0[15].xyzx, cb0[12].yzwy
movc r12.xyz, r3.yyyy, cb0[16].xyzx, r12.xyzx
movc r3.xyw, r3.xxxx, cb0[17].xyxz, r12.xyxz
...
dp3_sat r9.x, r8.xyzx, r12.xyzx
dp3 r1.w, -r12.xyzx, r8.xyzx
add r1.w, r1.w, r1.w
mad r13.xyz, r8.xyzx, -r1.wwww, -r12.xyzx
mul r1.w, r9.y, l(17.000000)
exp r1.w, r1.w
add r1.w, r1.w, l(2.000000)
div r1.w, l(2.000000), r1.w
sqrt r4.y, r1.w
add r4.z, -r9.y, l(1.000000)
mul r4.w, r4.z, l(5.000000)
mad r5.z, r4.z, l(5.000000), l(-2.500000)
mul_sat r5.z, r5.z, l(0.400000)
mul r5.z, r5.z, l(100.000000)
mad r7.yz, -r4.zzzz, l(0.000000, 10.000000, 5.000000, 0.000000), l(0.000000, 6.857410, 7.085000, 0.000000)
exp r5.w, r7.y
mul r5.w, r5.w, r9.x
mul r5.w, r5.w, l(9.136810)
mul r6.w, r4.z, r4.w
mad r6.w, -r6.w, l(2.015905), r7.z
exp r6.w, r6.w
mul r6.w, r6.w, r9.x
...
loop 
  ...
  sqrt r12.w, r12.w
  mad r12.w, r4.z, l(5.000000), r12.w
...
if_z r6.w
  ...
  loop 
    ...
    ieq r12.w, r7.y, r9.w
    bfi r14.z, r7.z, l(0), l(0), r11.w
    movc r11.w, r12.w, r14.z, r11.w
    ieq r12.w, r7.w, r9.w
    ubfe r14.z, r9.z, l(0), r11.w
    movc r11.w, r12.w, r14.z, r11.w
    iadd r12.w, r9.w, cb2[0].x
      ...
      if_nz r15.y
        ...
        if_nz r15.x
          ...
          if_nz r15.z
            ...
            sqrt r15.x, r15.x
            mad r15.x, r4.z, l(5.000000), r15.x
  ...
  if_nz r7.w
    ...
    loop 
      ...
      ieq r11.w, r7.y, r9.z
      ubfe r12.w, r7.z, l(0), r9.w
      movc r9.w, r11.w, r12.w, r9.w
      ...
      loop 
        ...
        if_nz r17.w
          ...
          if_nz r16.w
            ...
            and r19.w, r18.z, l(1)
            movc r31.xy, r19.wwww, r16.xyxx, r16.zxzz
            mov r16.x, r18.z
            mov r32.xy, r31.xyxx
            mov r19.w, l(1)
            loop 
              ...
              movc r18.y, r30.w, r20.w, r31.z
              movc r32.xy, r28.wwww, r32.xyxx, r18.xyxx
              iadd r19.w, r19.w, l(1)
              mov r16.x, r26.w
            endloop 
            add_sat r16.x, -r12.w, r32.y
            ...
            if_nz r17.w
              ...
              mad r27.w, r16.x, r18.w, r27.w
              mul r14.w, r29.z, r16.w
              mov r29.z, r37.z
              ...
              sqrt r16.x, r16.x
              mad r16.x, r4.z, l(5.000000), r16.x
              ...
              utof r37.w, r16.w
              sample_l_indexable(texturecubearray)(float,float,float,float) r18.yzw, r37.xyzw, t8.wxyz, s2, r16.x
              and r31.xyz, r18.yzwy, l(0x7fffffff, 0x7fffffff, 0x7fffffff, 0)
              ieq r31.xyz, r31.xyzx, l(0x7f800000, 0x7f800000, 0x7f800000, 0)
              or r16.x, r31.y, r31.x
              or r16.x, r31.z, r16.x
              ...
              dp3 r16.x, r30.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
              mad r15.xyz, r28.xyzx, r29.xyzx, r15.xyzx
              mul r16.w, r5.w, r16.x
              mul r18.yzw, r14.wwww, r18.yyzw
              dp3 r14.w, r18.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
              mad r14.w, r5.w, r16.x, r14.w
              div r14.w, r16.w, r14.w
              mad r27.xyz, r18.yzwy, r14.wwww, r27.xyzx
            endif 
          endif 
        endif 
      endloop 
  ...
  if_nz r5.z
    ...
    add r7.yzw, v7.xxyz, -cb2[35].xxyz
    mul r14.x, r7.y, cb2[35].w
    mul r14.yz, r7.zzwz, cb2[36].xxyx
    add_sat r7.yzw, r14.xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
    mul r14.xy, r7.yzyy, cb2[36].zwzz
    mul r14.z, r7.w, cb2[37].x
    add r7.yzw, r14.xxyz, cb2[37].yyzw
    lt r14.xyz, l(0.000000, 0.000000, 0.000000, 0.000000), r8.xyzx
    movc r14.xyz, r14.xyzx, l(0,0,0,0), l(0.500000,0.500000,0.500000,0)
    mov r14.w, l(0)
    add r15.xyz, r7.yzwy, r14.wwxw
    ...
    add r7.yzw, r7.yyzw, r14.wwwz
    sample_l_indexable(texture3d)(float,float,float,float) r7.yzw, r7.yzwy, t19.wxyz, s4, l(0.000000)
    mad r7.yzw, r7.yyzw, r16.zzzz, r15.xxyz
    mov r8.w, l(0)
    sample_l_indexable(texturecubearray)(float,float,float,float) r14.xyz, r8.xyzw, t8.xyzw, s2, l(6.000000)
    mul r7.yzw, r7.yyzw, r14.xxyz
    dp3 r5.w, r7.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
    mad r21.xyz, r23.xyzx, r4.zzzz, r7.yzwy
    mov r13.w, l(0)
    sample_l_indexable(texturecubearray)(float,float,float,float) r7.yzw, r13.xyzw, t8.wxyz, s2, r4.w
    mad r4.z, cb2[19].x, r5.z, -r5.w
    mad r4.z, r9.y, r4.z, r5.w
    mad r22.xyz, r7.yzwy, r4.zzzz, r22.xyzx
  endif 
else 
  mov r22.x, r21.w
endif 
...
if_z r5.w
  ...
  if_nz r8.w
    ...
    loop 
      ...
      breakc_nz r12.w
      ftou r12.w, r8.w
      add r16.xy, r9.yzyy, -cb2[r12.w + 20].xyxx
      max r13.w, |r16.y|, |r16.x|
      mul r11.w, r13.w, cb2[r12.w + 20].z
  ...
  if_nz r12.w
    ...
    if_z r17.x
      ...
      if_z r13.w
        ...
        mad r16.y, r9.y, r16.z, r16.y
        mad r16.x, r9.z, r16.x, r16.y
  ...
  if_z r12.w
    ...
    if_nz cb2[58].y
      ...
      ftou r11.w, r11.w
      add r17.xy, r9.yzyy, -cb2[r9.w + 20].xyxx
      ...
      loop 
        uge r16.w, r13.w, l(8)
        breakc_nz r16.w
        ult r16.w, r11.w, r13.w
        movc r17.zw, r16.wwww, r9.yyyz, r17.xxxy
        movc r18.x, r16.w, cb2[r8.w + 20].w, cb2[r9.w + 20].w
        movc r16.w, r16.w, r8.w, r9.w
...
if_nz r5.w
  ...
  if_nz r5.w
    ...
    if_nz r10.x
      ...
      mad r10.y, |r4.w|, l(-0.200000), l(0.400000)
      mad r20.xyz, r8.xyzx, r10.yyyy, v7.xyzx
      mov r20.w, l(1.000000)
      dp4 r16.x, r16.xyzw, r20.xyzw
      dp4 r16.y, r17.xyzw, r20.xyzw
      mad r10.yz, r16.xxyx, l(0.000000, 0.500000, -0.500000, 0.000000), l(0.000000, 0.500000, 0.500000, 0.000000)
      add r10.yz, r19.zzwz, r10.yyzy
      mul r10.yz, r19.xxyx, r10.yyzy
      div r16.xy, r10.xxxx, r18.xzxx
      add r16.zw, -r16.xxxy, l(0.000000, 0.000000, 1.000000, 1.000000)
      ge r16.zw, r10.yyyz, r16.zzzw
      ge r16.xy, r16.xyxx, r10.yzyy
      ...
      if_z r10.w
        ...
        mad r16.xy, r10.yzyy, r18.xzxx, r18.ywyy
        add r8.w, r17.x, r8.w
        div r8.w, r8.w, r17.y
        ...
        if_nz cb2[58].y
          ...
          loop 
            ...
            mad r18.xy, r19.xyxx, r10.xxxx, r16.xyxx
          ...
          utof r16.z, r10.y
          sample_c_lz_indexable(texture2darray)(float,float,float,float) r10.z, r16.xyzx, t9.xxxx, s13, r8.w
        endif 
    ...
    mad r16.xyz, r5.zzzz, r9.yzwy, r7.yzwy
    add_sat r0.z, -r0.z, l(1.000000)
    mul r5.w, r0.z, r0.z
    mul r5.w, r5.w, r5.w
    mul r0.z, r0.z, r5.w
    mul r0.z, r0.z, r5.z
    mad r17.xyz, r0.zzzz, r9.zwyz, r15.xyzx
    mov r10.w, r17.z
    mov r14.w, r15.z
    movc r14.xyzw, r4.wwww, r10.xyzw, r14.xyzw
    mov r17.zw, r16.xxxy
    mov r15.zw, r7.yyyz
    movc r10.xyzw, r4.wwww, r17.xyzw, r15.xyzw
    movc r7.w, r4.w, r16.z, r7.w
    mov r15.z, r14.w
    mov r15.xy, r10.xyxx
    mov r7.yz, r10.zzwz
  endif 
...
loop 
  ...
  breakc_nz r6.w
  ushr r10.z, r5.w, l(5)
  iadd r16.xyz, r10.xyzx, r11.xyzx
      ...
      if_nz r11.w
        ...
        switch r11.w
          ...
          if_nz r24.w
            ...
            mad_sat r42.xy, r24.wwww, r34.xzxx, r34.ywyy
            ...
            if_nz r24.w
              ubfe r24.w, l(3), l(27), r33.w
              ine r24.w, r24.w, l(1)
              if_nz r24.w
                mad r24.w, |r15.w|, l(-0.200000), l(0.400000)
                mad r42.xyz, r8.xyzx, r24.wwww, v7.xyzx
                add r42.xyz, -r36.xyzx, r42.xyzx
                max r24.w, |r42.z|, |r42.y|
                max r24.w, r24.w, |r42.x|
                div r24.w, r37.x, r24.w
                add r24.w, r37.y, r24.w
                ...
                loop 
                  ...
                  mul r44.x, r7.x, r44.y
                  mul r44.w, r4.x, r44.y
                  mad r43.xyz, r42.xyzx, r25.wwww, r44.xzwx
                  sample_c_lz_indexable(texturecubearray)(float,float,float,float) r28.w, r43.xyzw, t10.xxxx, s13, r24.w
              ...
              if_nz r24.w
                ...
                if_nz r13.w
                  ...
                  mad r18.xyz, r8.xyzx, r25.wwww, v7.xyzx
                  dp4 r25.w, r41.xyzw, r18.xyzw
                  dp4 r27.w, r42.xyzw, r18.xyzw
                  ...
                  if_z r28.w
                    ...
                    mul r18.x, r27.w, r45.y
                    mad r18.y, r45.x, r27.w, r25.w
                  ...
                  if_z r18.y
                    ...
                    if_nz r8.w
                      ...
                      loop 
                        ...
                        sample_c_lz_indexable(texture2darray)(float,float,float,float) r25.w, r42.xyzx, t9.xxxx, s13, r18.x
                ...
                dp3 r15.w, r8.xyzx, r39.xyzx
                mad r18.x, |r15.w|, r1.w, -|r15.w|
                mad r15.w, |r15.w|, r18.x, l(1.000000)
                mad r18.x, r12.w, r2.x, r4.z
          ...
          if_nz r14.w
            ...
            if_nz r15.w
              ...
              mul r20.w, r35.x, r35.x
              dp3 r24.w, r46.xyzx, r46.xyzx
              ...
              mul r20.w, r20.w, r34.x
              mul r20.w, r34.y, r20.w
              mov r36.w, r37.x
              ...
              if_nz r14.w
                ...
                exp r34.xy, r34.xyxx
                mul r24.w, r34.x, r44.z
                mad r25.w, r44.w, r34.y, l(-1.000000)
                mad r24.w, r44.w, r34.y, -r24.w
              ...
              if_nz r14.w
                ...
                dp3 r18.x, r45.yzwy, r20.xyzx
                dp3 r20.x, r34.xyzx, r20.xyzx
                frc r34.x, r18.x
                frc r34.y, r20.x
            ...
            if_nz r14.w
                ...
                if_nz r24.w
                  ...
                  if_nz r8.w
                    ...
                    loop 
                      ige r25.w, r24.w, l(8)
                      breakc_nz r25.w
                      dp2 r34.x, icb[r24.w + 0].xyxx, r24.xyxx
                      dp2 r34.y, icb[r24.w + 0].yxyy, r24.xzxx
              ...
              if_nz r14.w
                ...
                if_nz r21.x
                  ...
                  mad r22.xyz, r8.xyzx, r21.yyyy, v7.xyzx
                  ...
                  if_z r22.x
                    ...
                    if_nz r8.w
                      ...
                      utof r33.z, r21.y
                      sample_c_lz_indexable(texture2darray)(float,float,float,float) r21.z, r33.xyzx, t9.xxxx, s13, r15.w
                    endif 
                  ...
                  if_nz r21.x
                    ...
                    mad r21.y, |r12.w|, l(-0.200000), l(0.400000)
                    mad r23.xyz, r8.xyzx, r21.yyyy, v7.xyzx
                ...
                dp3 r15.w, r8.xyzx, r19.xyzx
                mad r19.x, |r15.w|, r1.w, -|r15.w|
                mad r15.w, |r15.w|, r19.x, l(1.000000)
                mad r13.w, r13.w, r2.x, r4.z
                mul r15.w, r15.w, r15.w
                ...
                mad r19.xyz, r10.wwww, r20.xywx, r31.xyzx
                add_sat r11.w, -r11.w, l(1.000000)
                mul r13.w, r11.w, r11.w
                mul r13.w, r13.w, r13.w
                mul r11.w, r11.w, r13.w
                mul r10.w, r10.w, r11.w
                mad r20.xyw, r10.wwww, r20.xyxw, r30.xyxz
...
mad r2.xyz, r29.xyzx, r2.yzwy, r4.xyzx
mad r1.xyz, r27.xyzx, r1.xyzx, r2.xyzx
...
ret 
// Approximately 2585 instruction slots used
