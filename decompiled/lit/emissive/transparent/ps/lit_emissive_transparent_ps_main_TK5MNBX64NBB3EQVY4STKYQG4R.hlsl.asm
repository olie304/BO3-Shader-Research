...
if_nz r2.w
  ...
  movc r1.xyz, r3.xxxx, r8.xywx, r9.xyzx
endif 
...
rsq r2.z, r2.z
mad r8.xyz, r8.xyzx, r2.zzzz, -r7.xyzx
mad r7.xyz, cb1[60].wwww, r8.xyzx, r7.xyzx
...
and r8.zw, r0.yyyy, l(0, 0, 0x10000000, 0x20000000)
if_nz r8.z
          ...
          if_nz r15.z
            ...
            if_nz r15.z
              ...
              if_nz r22.w
                ...
                mul r28.xyz, r3.wwww, r29.xyzx
                mul r26.xyz, r3.wwww, r26.xyzx
                mul r27.xyz, r3.wwww, r27.xyzx
...
mad r1.xyz, r1.xyzx, r0.yyyy, r16.xyzx
mad r1.w, r1.w, r0.y, r15.x
mad r7.xyz, r7.xyzx, r0.yyyy, r17.xyzx
dp3 r2.w, r7.xyzx, r7.xyzx
rsq r2.w, r2.w
mul r7.xyz, r2.wwww, r7.xyzx
mad r9.y, r2.x, r0.y, r15.y
mad r3.xyz, r3.xyzx, r0.yyyy, r18.xyzx
mov_sat r0.x, r0.x
mul r0.x, r0.x, cb0[11].w
eq r10.xyz, r0.wwww, l(3.000000, 2.000000, 1.000000, 0.000000)
lt r0.w, r0.w, l(0.000000)
movc r11.xyz, r0.wwww, l(1.000000,1.000000,1.000000,0), cb0[12].yzwy
movc r11.xyz, r10.zzzz, cb0[15].xyzx, r11.xyzx
movc r10.yzw, r10.yyyy, cb0[16].xxyz, r11.xxyz
movc r10.xyz, r10.xxxx, cb0[17].xyzx, r10.yzwy
dp3 r0.w, -v6.xyzx, -v6.xyzx
rsq r0.w, r0.w
mul r11.xyz, r0.wwww, -v6.xyzx
dp3 r2.x, r11.xyzx, r4.xyzx
dp3 r4.x, r11.xyzx, r5.xyzx
dp3 r4.y, r11.xyzx, r6.xyzx
lt r2.w, l(0.000000), r2.x
div r4.xy, -r4.xyxx, r2.xxxx
...
exp r2.x, r2.x
movc r2.x, cb0[13].y, r2.x, r2.w
eq r2.w, cb0[12].x, l(0.000000)
movc r2.x, r2.w, l(1.000000), r2.x
mul r0.x, r0.x, r4.w
mul r0.x, r2.x, r0.x
mul r0.x, r0.y, r0.x
...
utof r2.xw, r8.yyyx
dp2 r0.y, r2.wxww, l(0.06711056, 0.00583715, 0.000000, 0.000000)
frc r0.y, r0.y
mul r0.y, r0.y, l(52.982918)
frc r0.y, r0.y
mad r0.y, r0.y, l(6.28318548), cb1[70].w
sincos r5.x, r6.x, r0.y
dp2 r0.y, r2.xwxx, l(0.06711056, 0.00583715, 0.000000, 0.000000)
frc r0.y, r0.y
mul r0.y, r0.y, l(52.982918)
frc r0.y, r0.y
mad r0.y, r0.y, l(6.28318548), cb1[70].w
sincos r2.x, r10.x, r0.y
dp3_sat r9.x, r7.xyzx, r11.xyzx
dp3 r0.y, -r11.xyzx, r7.xyzx
add r0.y, r0.y, r0.y
mad r12.xyz, r7.xyzx, -r0.yyyy, -r11.xyzx
...
loop 
  ...
  dp3 r30.x, r7.xyzx, r22.xyzx
  dp3 r30.y, r7.xyzx, r31.xyzx
  dp3 r30.z, r7.xyzx, r24.xyzx
...
if_z r2.z
  ...
  loop 
    ...
    ieq r11.w, r8.w, r10.z
    bfi r13.z, r9.z, l(0), l(0), r10.w
    movc r10.w, r11.w, r13.z, r10.w
    ieq r11.w, r9.w, r10.z
      ...
      if_nz r14.y
        ...
        if_nz r14.x
          ...
          if_nz r14.z
            ...
            sqrt r14.x, r14.x
            mad r14.x, r3.w, l(5.000000), r14.x
        ...
        if_nz r18.w
          ...
          if_nz r17.w
            ...
            if_nz r17.w
              ...
              dp3 r36.x, r7.xyzx, r26.xyzx
              dp3 r36.y, r7.xyzx, r28.xyzx
  ...
  lt r3.w, r23.w, l(0.990000)
  if_nz r3.w
    add r3.w, -r23.w, l(1.000000)
    mul r5.w, r3.w, cb2[19].x
    ...
    dp3 r5.w, r10.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
    mad r20.xyz, r22.xyzx, r2.zzzz, r10.yzwy
    mov r12.w, l(0)
    sample_l_indexable(texturecubearray)(float,float,float,float) r10.yzw, r12.xyzw, t8.wxyz, s2, r5.z
    mad r2.z, cb2[19].x, r3.w, -r5.w
    mad r2.z, r9.y, r2.z, r5.w
    mad r21.xyz, r10.yzwy, r2.zzzz, r21.xyzx
  endif 
else 
  mov r21.x, r20.w
endif 
...
mad r3.w, r9.x, r2.y, r2.z
mul r2.yz, r2.yyzy, r3.wwww
dp3 r3.w, r7.xyzx, cb2[17].xyzx
mov_sat r5.z, r3.w
  ...
  if_z r11.w
    ...
    if_nz cb2[58].y
      ...
      loop 
        ...
        movc r16.zw, r15.wwww, r10.yyyz, r16.xxxy
        ...
        utof r17.z, r15.w
        sample_c_lz_indexable(texture2darray)(float,float,float,float) r15.w, r17.xyzx, t13.xxxx, s13, r5.w
...
if_nz r5.w
  ...
  if_nz r5.w
    ...
    if_nz r8.w
      ...
      mad r19.xyz, r7.xyzx, r11.wwww, v6.xyzx
    ...
    mad r16.xyz, r5.zzzz, r10.yzwy, r9.yzwy
...
mov r15.x, -r5.x
not r0.w, r0.x
mad r3.w, -r9.x, l(0.500000), l(1.000000)
mov r16.xy, l(0,0,0,0)
mov r17.w, l(0)
mov r18.xyz, v6.xyzx
          ...
          if_nz r21.w
            ...
            if_nz r21.w
              ...
              if_nz r21.w
                    ...
                    if_z r19.z
                      ...
                      if_nz r7.w
                        ...
                        loop 
                          ige r27.w, r25.w, l(8)
                          breakc_nz r27.w
                          dp2 r42.x, icb[r25.w + 0].xyxx, r6.xyxx
                          dp2 r42.y, icb[r25.w + 0].yxyy, r6.xzxx
                ...
                mad r39.xyz, r39.xyzx, r11.wwww, r11.xyzx
                dp3 r11.w, r39.xyzx, r39.xyzx
                rsq r11.w, r11.w
                mul r39.xyz, r11.wwww, r39.xyzx
                dp3 r11.w, r39.xyzx, r11.xyzx
                dp3 r16.z, r7.xyzx, r39.xyzx
                mad r16.w, |r16.z|, r0.y, -|r16.z|
                mad r16.z, |r16.z|, r16.w, l(1.000000)
                mad r16.w, r12.w, r2.y, r2.z
          ...
          if_nz r14.w
            ...
            if_nz r14.w
              ...
              if_nz r14.w
                ...
                mad r20.xyz, r20.xyzx, r11.wwww, r11.xyzx
                dp3 r11.w, r20.xyzx, r20.xyzx
                rsq r11.w, r11.w
                mul r20.xyz, r11.wwww, r20.xyzx
                dp3 r11.w, r20.xyzx, r11.xyzx
                dp3 r16.z, r7.xyzx, r20.xyzx
                mad r19.x, |r16.z|, r0.y, -|r16.z|
                mad r16.z, |r16.z|, r19.x, l(1.000000)
                mad r13.w, r13.w, r2.y, r2.z
                mul r16.z, r16.z, r16.z
...
if_z r0.w
  ...
  if_nz r0.w
    ...
    bfi r2.y, l(1), l(0), cb0[11].z, r0.w
...
ret 
// Approximately 2988 instruction slots used
