...
r4.w = samp0[]..swiz;
  ...
  if (r7.z != 0) {
    r7.z = cmp(0 < r7.w);
    if (r7.z != 0) {
      r7.z = sunConstants.specScale * r2.y;
      r7.z = r7.z * r7.y;
