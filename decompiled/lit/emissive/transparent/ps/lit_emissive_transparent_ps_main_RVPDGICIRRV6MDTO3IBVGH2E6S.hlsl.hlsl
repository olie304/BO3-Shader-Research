...
r1.w = samp0[]..swiz;
  ...
  if (r2.y != 0) {
    ...
    r1.xyz = r2.zzz ? r3.xyw : r8.xyz;
  }
  r3.xyw = debugColorOverride.xyz + -r1.xyz;
  r1.xyz = debugColorOverride.www * r3.xyw + r1.xyz;
  r2.y = debugAlphaOverride.x + -r2.w;
  r2.y = debugAlphaOverride.w * r2.y + r2.w;
  ...
  r2.x = r2.x + -r1.w;
  r1.w = debugGlossOverride.w * r2.x + r1.w;
  r2.x = debugOcclusionOverride.x + -r0.x;
  r0.x = debugOcclusionOverride.w * r2.x + r0.x;
  r2.xzw = v7.xxx ? v3.xyz : -v3.xyz;
  r4.w = dot(r2.xzw, r2.xzw);
  r4.w = rsqrt(r4.w);
  r2.xzw = r2.xzw * r4.www + -r7.xyz;
  r2.xzw = debugNormalOverride.www * r2.xzw + r7.xyz;
  ...
  r2.y = r2.y * r0.y + r14.x;
  r2.xzw = r2.xzw * r0.yyy + r16.xyz;
  r3.z = dot(r2.xzw, r2.xzw);
  r3.z = rsqrt(r3.z);
  r8.xyz = r3.zzz * r2.xzw;
  r9.y = r1.w * r0.y + r14.y;
  r2.xzw = r3.xyw * r0.yyy + r17.xyz;
  r0.z = saturate(r0.z);
  r0.z = hdrScale * r0.z;
  r3.xyz = cmp(r0.www == float3(3,2,1));
  r0.w = cmp(r0.w < 0);
  r10.xyz = r0.www ? float3(1,1,1) : emissiveTint1.xyz;
  r10.xyz = r3.zzz ? tint1.xyz : r10.xyz;
  ...
  if (r7.w != 0) {
    ...
    if (r7.w != 0) {
      ...
      r11.y = abs(r10.w) * r0.z + -abs(r10.w);
  ...
  r0.xyz = float3(1,1,1) + -r2.xzw;
  r0.xyz = r27.xyz * r0.xyz;
  r0.xyz = r28.xyz * r2.xzw + r0.xyz;
