...
r1.w = samp0[]..swiz;
  ...
  r3.y = samp0[]..swiz;
  r3.z = samp0[]..swiz;
    r4.xyz = customizeMask.Sample(colorSampler_s, w1.xy).xyz;
    r0.x = r4.x + r4.y;
  ...
  r2.w = r2.w * r0.y + r14.x;
  r2.xyz = r2.xyz * r0.yyy + r15.xyz;
  r3.y = dot(r2.xyz, r2.xyz);
  r3.y = rsqrt(r3.y);
  r7.xyz = r3.yyy * r2.xyz;
  r2.y = r1.w * r0.y + r14.y;
  ...
  r5.xy = (uint2)r3.wz;
  r0.z = dot(r5.yx, float2(0.0671105608,0.00583714992));
  r0.z = frac(r0.z);
  r0.z = 52.9829178 * r0.z;
  r0.z = frac(r0.z);
  r0.z = r0.z * 6.28318548 + gameTick.w;
  sincos(r0.z, r6.x, r9.x);
  r0.z = dot(r5.xy, float2(0.0671105608,0.00583714992));
  r0.z = frac(r0.z);
  r0.z = 52.9829178 * r0.z;
  r0.z = frac(r0.z);
  r0.z = r0.z * 6.28318548 + gameTick.w;
  ...
  r3.y = 5 * r2.z;
  r5.y = r2.z * 5 + -2.5;
  r5.y = saturate(0.400000006 * r5.y);
  r5.y = 100 * r5.y;
  r5.zw = -r2.zz * float2(10,5) + float2(6.85740995,7.08500004);
  r5.z = exp2(r5.z);
  r5.z = r5.z * r2.x;
  r6.z = r3.y * r2.z;
  r5.w = -r6.z * 2.0159049 + r5.w;
  r5.w = exp2(r5.w);
  r5.w = r5.w * r2.x;
  ...
  r13.z = (uint)r3.x << 4;
  r3.x = (int)r5.w & -32;
  r3.z = (int)-r3.x + (int)r5.w;
  r3.w = numRefProbes & -32;
  r6.z = (int)-r3.w + numRefProbes;
  r14.xy = float2(0,0);
  r15.w = 0;
  r16.yz = float2(0,1);
  r17.xy = float2(0,0);
  ...
  while (true) {
    ...
    r9.w = cmp((int)r3.x == (int)r6.w);
    bitmask.w = ((~(-1 << r3.z)) << 0) & 0xffffffff;  r10.w = (((uint)0 << 0) & bitmask.w) | ((uint)r8.w & ~bitmask.w);
    r8.w = r9.w ? r10.w : r8.w;
    r9.w = cmp((int)r3.w == (int)r6.w);
    if (r6.z == 0) r10.w = 0; else if (r6.z+0 < 32) {     r10.w = (uint)r8.w << (32-(r6.z + 0)); r10.w = (uint)r10.w >> (32-r6.z);    } else r10.w = (uint)r8.w >> 0;
    r8.w = r9.w ? r10.w : r8.w;
    r9.w = (int)r6.w + numLights;
    r23.xyzw = r21.xyzw;
    r24.xyz = r22.yzw;
    r10.w = r8.w;
    while (true) {
  ...
  if (r3.w != 0) {
    ...
    r6.z = 0;
    while (true) {
      r6.w = cmp((uint)r6.z >= (uint)r5.w);
      if (r6.w != 0) break;
      r14.z = (uint)r6.z >> 5;
      r15.xyz = (int3)r13.xyz + (int3)r14.xyz;
      r6.w = visibleProbes.Load(r15.xyzw).x;
      r8.w = cmp((int)r3.x == (int)r6.z);
      if (r3.z == 0) r9.w = 0; else if (r3.z+0 < 32) {       r9.w = (uint)r6.w << (32-(r3.z + 0)); r9.w = (uint)r9.w >> (32-r3.z);      } else r9.w = (uint)r6.w >> 0;
      r6.w = r8.w ? r9.w : r6.w;
      r8.w = (int)r6.z + numLights;
      r24.xyzw = r23.xyzw;
      r15.xyz = r11.yzw;
      r9.w = r3.w;
      r10.w = r6.w;
  ...
  r3.xzw = r21.xyz * r2.zzz;
  r5.yzw = r22.xyz * r2.zzz;
  ...
  if (r6.z != 0) {
    ...
    r3.xzw = r21.xyz * r2.zzz + r11.yzw;
    r12.w = 0;
    r11.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r12.xyzw, r3.y).xyz;
    r2.z = sunConstants.globalProbeExposure * r6.z + -r6.w;
    r2.z = r2.y * r2.z + r6.w;
    r5.yzw = r11.yzw * r2.zzz + r5.yzw;
  }
  r2.z = r2.x + r0.x;
  r2.z = log2(abs(r2.z));
  r2.z = r2.z * r1.w;
  ...
  if (r6.w != 0) {
    r6.w = cmp(0 < r7.w);
    if (r6.w != 0) {
      r6.w = sunConstants.specScale * r0.z;
      r6.w = r6.w * r6.z;
      ...
      r18.z = samp0[]..swiz;
      r18.w = samp0[]..swiz;
        r10.w = abs(r2.z) * -0.200000003 + 0.400000006;
      ...
      r6.z = r7.w * r6.z;
      r6.z = 0.25 * r6.z;
      r16.xyz = r6.zzz * r11.yzw + r5.yzw;
      r0.w = saturate(1 + -r0.w);
      r6.w = r0.w * r0.w;
      r6.w = r6.w * r6.w;
      r0.w = r6.w * r0.w;
      r0.w = r6.z * r0.w;
      r17.xyz = r0.www * r11.zwy + r14.xyz;
      r15.w = r17.z;
      r3.w = r14.z;
      r3.xyzw = r2.zzzz ? r15.xyzw : r3.xyzw;
      r17.zw = r16.xy;
      r14.zw = r5.yz;
      r15.xyzw = r2.zzzz ? r17.xyzw : r14.xyzw;
      r5.w = r2.z ? r16.z : r5.w;
      r14.z = r3.w;
      r14.xy = r15.xy;
      r5.yz = r15.zw;
    }
            ...
            if (r16.w != 0) {
              ...
              if (r16.w != 0) {
                ...
                if (r16.w != 0) {
                  ...
                  r16.z = abs(r14.w) * r0.z + -abs(r14.w);
                  r14.w = abs(r14.w) * r16.z + 1;
                  r16.z = r10.w * r0.x + r2.y;
                  r14.w = r14.w * r14.w;
                  r14.w = r14.w * r16.z;
                  r14.w = rcp(r14.w);
                  r10.w = r10.w * r16.w;
            ...
            r40.w = samp0[]..swiz;
              ...
              if (r13.w != 0) {
                ...
                if (r13.w != 0) {
                  ...
                  r16.w = abs(r14.w) * r0.z + -abs(r14.w);
                  r14.w = abs(r14.w) * r16.w + 1;
                  r12.w = r12.w * r0.x + r2.y;
                  r14.w = r14.w * r14.w;
                  r12.w = r14.w * r12.w;
                  r12.w = rcp(r12.w);
                  r12.w = r12.w * r13.w;
