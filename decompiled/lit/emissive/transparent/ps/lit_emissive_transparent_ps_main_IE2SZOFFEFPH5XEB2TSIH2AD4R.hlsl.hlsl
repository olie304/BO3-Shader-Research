...
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r0.w, v3.w, l(4), t4.xxxx
r0.w = samp0[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) r5.xy, r0.w, l(36), t0.xyxx
r5.x = samp0[]..swiz;
r5.y = samp0[]..swiz;
  ...
  while (true) {
    ...
    r10.z = cmp((int)r0.w == (int)r7.w);
    if (r2.w == 0) r10.w = 0; else if (r2.w+0 < 32) {     r10.w = (uint)r9.w << (32-(r2.w + 0)); r10.w = (uint)r10.w >> (32-r2.w);    } else r10.w = (uint)r9.w >> 0;
  ...
  o0.w = r0.x * r0.w + r4.w;
  r2.xyz = r2.xyz * r0.www + r13.xyz;
  r0.x = dot(r2.xyz, r2.xyz);
  r0.x = rsqrt(r0.x);
  r2.xyz = r2.xyz * r0.xxx;
  r0.y = r0.y * r0.w + r6.w;
  r4.xyz = r4.xyz * r0.www + r14.xyz;
  r5.x = saturate(r5.x);
  r1.w = hdrScale * r5.x;
  r6.xyz = cmp(r5.yyy == float3(3,2,1));
  r3.x = cmp(r5.y < 0);
  r7.xyz = r3.xxx ? float3(1,1,1) : emissiveTint1.xyz;
  r7.xyz = r6.zzz ? tint1.xyz : r7.xyz;
  ...
  if (r3.x != 0) {
    ...
    r4.w = imageTime * r3.x;
    r5.x = gameTime.w * r4.w;
    r5.x = cmp(r5.x >= -r5.x);
    r5.x = r5.x ? r4.w : -r4.w;
    r5.y = 1 / r5.x;
    r5.y = gameTime.w * r5.y;
    r5.y = frac(r5.y);
    r5.x = r5.x * r5.y;
    r4.w = r5.x / r4.w;
    r3.x = r4.w * r3.x;
    ...
    r5.x = columnCount * r3.x;
    r5.x = cmp(r5.x >= -r5.x);
    r5.x = r5.x ? columnCount : -columnCount;
    r5.y = 1 / r5.x;
    r3.x = r5.y * r3.x;
    r3.x = frac(r3.x);
    r3.x = r5.x * r3.x;
    ...
    r10.x = dot(r7.xyz, v5.xyz);
    r10.y = dot(r7.xyz, v6.xyz);
    r3.x = dot(r7.xyz, v4.xyz);
    r4.w = cmp(0 < r3.x);
    r7.xy = -r10.xy / r3.xx;
    r7.xy = r4.ww ? r7.xy : 0;
    ...
    r10.y = r10.x;
    r10.z = r3.x;
    r11.x = dot(r10.yz, r7.xy);
    r10.x = -r3.x;
    r11.y = dot(r10.xy, r7.xy);
    r7.xy = gameTime.ww * scrollUVs.xy;
    r7.xy = r7.xy * scaleUVs.xy + r11.xy;
    ...
    r5.xy = clampU ? r7.zw : r7.xy;
  }
  r3.x = dot(-v7.xyz, -v7.xyz);
  r3.x = rsqrt(r3.x);
  r7.xyz = -v7.xyz * r3.xxx;
  r3.y = saturate(dot(r7.xyz, r3.yzw));
  r10.xyzw = emissiveMap.Sample(colorSampler_s, r5.xy).xyzw;
  ...
  r0.w = frac(r0.w);
  r5.y = gameTime.w * flickerSpeed + r0.w;
  r5.x = flickerSeed.x;
  r0.w = flickerLookupMap.SampleLevel(lookupSampler_s, r5.xy, 0).x;
  r0.w = log2(abs(r0.w));
  ...
  if (r6.w == 0) {
    ...
    if (r5.w != 0) {
      ...
      r20.xyz = r22.xyz * r5.yyy + r11.yzw;
      r12.w = 0;
      ...
      r2.w = r0.y * r5.y + r2.w;
      r21.xyz = r11.yzw * r2.www + r21.xyz;
    }
  } else {
    r21.x = r20.w;
  }
  ...
  if (r6.w != 0) {
    ...
    if (r6.w != 0) {
      ...
      r8.w = r8.w * r7.w;
      r2.w = cmp(0 < r2.w);
      r15.xyz = r8.www * r8.xyz + r13.xyz;
      r11.yzw = -v7.xyz * r3.xxx + sunConstants.wldDir.xyz;
      r3.x = dot(r11.yzw, r11.yzw);
      r3.x = rsqrt(r3.x);
      r11.yzw = r11.yzw * r3.xxx;
      r3.x = dot(r11.yzw, r7.xyz);
      ...
      r6.z = r7.w * r6.z;
      r6.z = 0.25 * r6.z;
      r11.yzw = r6.zzz * r8.xyz + r5.yzw;
      r3.x = saturate(1 + -r3.x);
      r6.w = r3.x * r3.x;
      r6.w = r6.w * r6.w;
      r3.x = r6.w * r3.x;
      r3.x = r6.z * r3.x;
      r8.xyz = r3.xxx * r8.yzx + r14.xyz;
      r15.w = r8.z;
      r13.w = r14.z;
      r13.xyzw = r2.wwww ? r15.xyzw : r13.xyzw;
      r8.zw = r11.yz;
      r14.zw = r5.yz;
      r8.xyzw = r2.wwww ? r8.xyzw : r14.xyzw;
            ...
            if (r24.w != 0) {
              ...
              if (r24.w != 0) {
                ...
                if (r24.w != 0) {
                  ...
                  r38.xyz = r38.xyz * r12.www + r7.xyz;
                  r12.w = dot(r38.xyz, r38.xyz);
                  r12.w = rsqrt(r12.w);
                  r38.xyz = r38.xyz * r12.www;
                  r12.w = dot(r38.xyz, r7.xyz);
            ...
            r39.w = samp0[]..swiz;
              ...
              if (r15.z != 0) {
                ...
                if (r15.z != 0) {
                  ...
                  r19.xyz = r19.xyz * r12.www + r7.xyz;
                  r12.w = dot(r19.xyz, r19.xyz);
                  r12.w = rsqrt(r12.w);
                  r19.xyz = r19.xyz * r12.www;
                  r12.w = dot(r19.xyz, r7.xyz);
