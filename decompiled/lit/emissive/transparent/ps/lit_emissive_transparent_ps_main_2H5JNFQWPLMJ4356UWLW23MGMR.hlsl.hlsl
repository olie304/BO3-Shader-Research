...
cbuffer _Globals : register(b0)
{
  ...
  uint ui3dWindow : packoffset(c11.z);
...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r4.xyz = r4.xyz * r1.www;
  r6.y = r1.x * r1.z + r5.z;
  r2.xyz = r2.xyz * r1.zzz + r14.xyz;
  r1.x = dot(-v7.xyz, -v7.xyz);
  r1.x = rsqrt(r1.x);
  r7.xyz = -v7.xyz * r1.xxx;
  r1.w = saturate(dot(r7.xyz, r3.xyz));
  switch (cb0[11].z) {
    case 0 :    r3.xyzw = ui3dUVSetup0.xyzw;
    break;
    case 1 :    r3.xyzw = ui3dUVSetup1.xyzw;
    break;
    case 2 :    r3.xyzw = ui3dUVSetup2.xyzw;
    break;
    case 3 :    r3.xyzw = ui3dUVSetup3.xyzw;
    break;
    case 4 :    r3.xyzw = ui3dUVSetup4.xyzw;
    break;
    case 5 :    r3.xyzw = ui3dUVSetup5.xyzw;
    break;
    default :
    break;
  }
  ...
  r3.xy = v2.xy * r3.xy + r3.zw;
  r3.xy = r2.ww ? r3.xy : v2.xy;
  ...
  r6.x = saturate(dot(r4.xyz, r7.xyz));
  r1.w = dot(-r7.xyz, r4.xyz);
  r1.w = r1.w + r1.w;
  r13.xyz = r4.xyz * -r1.www + -r7.xyz;
  r1.w = 17 * r6.y;
  r1.w = exp2(r1.w);
  r1.w = 2 + r1.w;
  r1.w = 2 / r1.w;
  ...
  r28.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r10.zw, r7.w, l(96), t15.xxxy
  r10.z = samp0[]..swiz;
  r10.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
  ...
  if (r6.w == 0) {
    ...
    while (true) {
      ...
      bitmask.w = ((~(-1 << r9.w)) << 0) & 0xffffffff;  r12.w = (((uint)0 << 0) & bitmask.w) | ((uint)r12.y & ~bitmask.w);
    ...
    if (r10.z != 0) {
      ...
      while (true) {
        ...
        r14.z = cmp((int)r7.w == (int)r10.w);
        if (r9.w == 0) r14.w = 0; else if (r9.w+0 < 32) {         r14.w = (uint)r11.w << (32-(r9.w + 0)); r14.w = (uint)r14.w >> (32-r9.w);        } else r14.w = (uint)r11.w >> 0;
  ...
  if (r6.w == 0) {
    ...
    if (r10.w == 0) {
      ...
      if (enableDitheredShadow != 0) {
        ...
        r12.yz = -sunConstants.splitPinTransform[r9.w].xy + r12.yz;
        r12.yz = sunConstants.splitPinTransform[r9.w].zz * r12.yz;
        ...
        while (true) {
          ...
          if (r13.w != 0) break;
          r13.w = cmp((uint)r10.z < (uint)r12.w);
          r17.zw = r13.ww ? r12.yz : r17.xy;
          r16.w = r13.w ? sunConstants.splitPinTransform[r9.w].w : sunConstants.splitPinTransform[r10.w].w;
          r13.w = r13.w ? r9.w : r10.w;
  ...
  if (r6.w != 0) {
    ...
    if (r6.w != 0) {
      ...
      r19.z = samp0[]..swiz;
      r19.w = samp0[]..swiz;
        r10.z = abs(r6.y) * -0.200000003 + 0.400000006;
        r20.xyz = r4.xyz * r10.zzz + v7.xyz;
        r20.w = 1;
        ...
        r16.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r12.yz, r8.w, l(164), t12.xxyx
        r12.y = samp0[]..swiz;
        r12.z = samp0[]..swiz;
          ...
          if (enableDitheredShadow != 0) {
            ...
            while (true) {
              ...
              r12.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r18.xyz, r8.w).x;
  ...
  r9.w = 0;
  while (true) {
    r10.z = cmp((uint)r9.w >= numLights);
    if (r10.z != 0) break;
    r16.z = (uint)r9.w >> 5;
    r17.xyz = (int3)r9.xyz + (int3)r16.xyz;
    r10.z = visibleLights.Load(r17.xyzw).x;
    r12.yzw = r6.yzw;
    r17.xyz = r28.xyz;
    r30.xyz = r29.xyz;
    r10.w = r7.w;
            ...
            if (r26.w != 0) {
              ...
              if (r26.w != 0) {
                ...
                if (r26.w != 0) {
                    ...
                    r15.w = samp0[]..swiz;
                      ...
                      if (r10.w != 0) {
                        ...
                        while (true) {
                          ...
                          r42.y = dot(icb[r19.z+0].xy, r10.xy);
                  ...
                  r38.xyz = r38.xyz * r14.www + r7.xyz;
                  r14.w = dot(r38.xyz, r38.xyz);
                  r14.w = rsqrt(r14.w);
                  r38.xyz = r38.xyz * r14.www;
                  r14.w = dot(r38.xyz, r7.xyz);
            ...
            r39.w = samp0[]..swiz;
              ...
              if (r16.w != 0) {
                ...
                if (r16.w != 0) {
                  ...
                  r20.xyz = r20.xyz * r14.www + r7.xyz;
                  r14.w = dot(r20.xyz, r20.xyz);
                  r14.w = rsqrt(r14.w);
                  r20.xyz = r20.xyz * r14.www;
                  r14.w = dot(r20.xyz, r7.xyz);
