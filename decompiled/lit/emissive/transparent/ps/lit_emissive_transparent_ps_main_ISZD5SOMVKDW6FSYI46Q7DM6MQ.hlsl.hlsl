...
r0.z = samp0[]..swiz;
  ...
  r3.xyz = r3.xzw * r0.yyy + r16.xyz;
  r3.w = dot(r3.xyz, r3.xyz);
  r3.w = rsqrt(r3.w);
  r3.xyz = r3.xyz * r3.www;
  r8.y = r0.w * r0.y + r14.y;
  r2.yzw = r2.yzw * r0.yyy + r17.xyz;
  r0.x = saturate(r0.x);
  r0.x = hdrScale * r0.x;
  ...
  r0.yw = (uint2)r7.yx;
  r4.x = dot(r0.wy, float2(0.0671105608,0.00583714992));
  r4.x = frac(r4.x);
  r4.xw = float2(52.9829178,0.0078125) * r4.xw;
  r4.x = frac(r4.x);
  ...
  r8.x = saturate(dot(r3.xyz, r10.xyz));
  r0.y = dot(-r10.xyz, r3.xyz);
  r0.y = r0.y + r0.y;
  r12.xyz = r3.xyz * -r0.yyy + -r10.xyz;
  r0.y = 17 * r8.y;
  r0.y = exp2(r0.y);
  r0.y = 2 + r0.y;
  r0.y = 2 / r0.y;
  ...
  if (r4.w == 0) {
    ...
    if (r8.z != 0) {
      ...
      r8.w = 0;
      while (true) {
        r10.w = cmp((uint)r8.w >= (uint)r4.w);
        if (r10.w != 0) break;
        r14.z = (uint)r8.w >> 5;
        r15.xyz = (int3)r13.xyz + (int3)r14.xyz;
        r10.w = visibleProbes.Load(r15.xyzw).x;
        r11.y = cmp((int)r7.x == (int)r8.w);
        if (r7.y == 0) r11.z = 0; else if (r7.y+0 < 32) {         r11.z = (uint)r10.w << (32-(r7.y + 0)); r11.z = (uint)r11.z >> (32-r7.y);        } else r11.z = (uint)r10.w >> 0;
    ...
    r20.xyz = r23.xyz * r4.zzz;
    r21.xyz = r24.xyz * r4.zzz;
    ...
    if (r4.w != 0) {
      ...
      r11.yzw = r11.yzw * r7.xxx;
      r15.xyz = r14.wwy + r7.yzw;
      r15.xyz = gProbeYArray.SampleLevel(samplerLinearClamp_s, r15.xyz, 0).xyz;
      r15.xyz = r15.xyz * r11.zzz;
      r9.yzw = r9.yzw * r11.yyy + r15.xyz;
      r7.xyz = r14.wwz + r7.yzw;
      r7.xyz = gProbeZArray.SampleLevel(samplerLinearClamp_s, r7.xyz, 0).xyz;
      r7.xyz = r7.xyz * r11.www + r9.yzw;
      r3.w = 0;
      r9.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r3.xyzw, 6).xyz;
      r7.xyz = r9.yzw * r7.xyz;
      r3.w = dot(r7.xyz, float3(0.212599993,0.715200007,0.0722000003));
      r20.xyz = r23.xyz * r4.zzz + r7.xyz;
      r12.w = 0;
      r7.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r12.xyzw, r6.w).xyz;
      r4.z = sunConstants.globalProbeExposure * r4.w + -r3.w;
      r3.w = r8.y * r4.z + r3.w;
      r21.xyz = r7.xyz * r3.www + r21.xyz;
    }
  } else {
    r21.x = r20.w;
  }
  ...
  r2.x = r4.z * r2.x;
  r3.w = r4.z * r3.w;
  r4.z = dot(r3.xyz, sunConstants.wldDir.xyz);
  r4.w = saturate(r4.z);
  r6.w = cmp(0 >= r4.w);
  if (r6.w != 0) {
    r9.y = 0;
  ...
  if (r6.w != 0) {
    r6.w = cmp(0 < r9.y);
    if (r6.w != 0) {
      r6.w = sunConstants.specScale * r0.y;
      r6.w = r6.w * r4.w;
      ...
      r15.w = r16.z;
      r7.w = r14.z;
      r7.xyzw = r4.zzzz ? r15.xyzw : r7.xyzw;
      r16.zw = r9.yz;
      r14.zw = r8.yz;
      r15.xyzw = r4.zzzz ? r16.xyzw : r14.xyzw;
      r8.w = r4.z ? r9.w : r8.w;
      r14.z = r7.w;
      r14.xy = r15.xy;
      r8.yz = r15.zw;
