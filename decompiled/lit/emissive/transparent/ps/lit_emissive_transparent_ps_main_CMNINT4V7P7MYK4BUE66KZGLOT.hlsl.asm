...
sample_indexable(texture2d)(float,float,float,float) r4.xyzw, r3.yzyy, t26.xyzw, s1
mul r3.yzw, r4.xxyz, cb0[12].yyzw
mov_sat r3.x, r3.x
log r4.x, r3.x
...
ret 
// Approximately 2981 instruction slots used
