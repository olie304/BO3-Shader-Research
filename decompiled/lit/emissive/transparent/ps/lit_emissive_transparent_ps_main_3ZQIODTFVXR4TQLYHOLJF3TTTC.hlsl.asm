...
mad r2.xyz, r2.xyzx, r2.wwww, r15.xyzx
dp3 r3.z, r2.xyzx, r2.xyzx
rsq r3.z, r3.z
mul r8.xyz, r2.xyzx, r3.zzzz
mad r2.y, r1.w, r2.w, r7.z
mad r3.xyz, r3.xywx, r2.wwww, r16.xyzx
mov_sat r0.x, r0.x
...
and r4.xy, r2.zzzz, r4.xyxx
add r2.z, cb0[13].z, l(0.000010)
mad r4.xy, r4.xyxx, r2.zzzz, v2.xyxx
...
mad r7.yz, -r2.wwww, l(0.000000, 10.000000, 5.000000, 0.000000), l(0.000000, 6.857410, 7.085000, 0.000000)
exp r5.w, r7.y
mul r5.w, r2.x, r5.w
...
if_z r6.w
  ...
  if_nz r7.w
    ...
    loop 
      ...
      ieq r14.z, r7.y, r11.w
      ubfe r14.w, r7.z, l(0), r12.w
  ...
  if_nz r5.z
    ...
    lt r9.yzw, l(0.000000, 0.000000, 0.000000, 0.000000), r8.xxyz
    movc r14.xyz, r9.yzwy, l(0,0,0,0), l(0.500000,0.500000,0.500000,0)
    mov r14.w, l(0)
    add r9.yzw, r7.yyzw, r14.wwwx
    ...
    mad r7.yzw, r7.yyzw, r15.zzzz, r9.yyzw
    mov r8.w, l(0)
    ...
    mad r21.xyz, r23.xyzx, r2.wwww, r7.yzwy
    mov r13.w, l(0)
    sample_l_indexable(texturecubearray)(float,float,float,float) r7.yzw, r13.xyzw, t8.wxyz, s2, r3.w
    mad r2.w, cb2[19].x, r5.z, -r5.w
    mad r2.w, r2.y, r2.w, r5.w
    mad r22.xyz, r7.yzwy, r2.wwww, r22.xyzx
  endif 
else 
  mov r22.x, r21.w
endif 
...
if_nz r5.z
  ...
  if_nz r5.z
    ...
    if_nz r8.w
      ...
      mad r19.xyz, r8.xyzx, r11.wwww, v7.xyzx
    ...
    mad r16.xyz, r3.wwww, r9.yzwy, r7.yzwy
    add_sat r0.y, -r0.y, l(1.000000)
    mul r5.z, r0.y, r0.y
    mul r5.z, r5.z, r5.z
    mul r0.y, r0.y, r5.z
    mul r0.y, r0.y, r3.w
    mad r17.xyz, r0.yyyy, r9.zwyz, r15.xyzx
    mov r10.w, r17.z
    mov r14.w, r15.z
    movc r14.xyzw, r2.wwww, r10.xyzw, r14.xyzw
    mov r17.zw, r16.xxxy
    mov r15.zw, r7.yyyz
    movc r10.xyzw, r2.wwww, r17.xyzw, r15.xyzw
          ...
          if_nz r16.w
            ...
            if_nz r16.w
              ...
              if_nz r16.w
                ...
                mad r42.xyz, r8.xyzx, r16.wwww, v7.xyzx
              ...
              if_nz r16.w
                ...
                if_nz r13.w
                  ...
                  mad r19.xyz, r8.xyzx, r21.wwww, v7.xyzx
          ...
          if_nz r14.w
            ...
            if_nz r14.w
              ...
              if_nz r14.w
                ...
                mad r22.xyz, r8.xyzx, r14.wwww, v7.xyzx
              ...
              if_nz r14.w
                ...
                if_nz r16.w
                  ...
                  mad r23.xyz, r8.xyzx, r19.xxxx, v7.xyzx
                  ...
                  if_nz r16.w
                    ...
                    mad r19.x, |r12.w|, l(-0.200000), l(0.400000)
                    mad r24.xyz, r8.xyzx, r19.xxxx, v7.xyzx
...
ret 
// Approximately 2629 instruction slots used
