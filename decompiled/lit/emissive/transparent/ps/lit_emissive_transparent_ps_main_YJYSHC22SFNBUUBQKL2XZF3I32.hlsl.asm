...
sample_indexable(texture2d)(float,float,float,float) r3.xyz, v2.xyxx, t24.xyzw, s3
...
if_nz r2.z
  ...
  movc r3.xyw, r3.xxxx, r7.xyxz, r6.xyxw
  movc r6.xyz, r6.zzzz, l(0,1.000000,0,0), r1.xyzx
  movc r1.xyz, r2.wwww, r3.xywx, r6.xyzx
endif 
...
loop 
  ...
  ieq r10.w, r4.w, r9.w
  ubfe r11.x, r5.w, l(0), r10.z
  movc r10.z, r10.w, r11.x, r10.z
  iadd r10.w, r5.z, r9.w
      ...
      if_nz r16.w
        ...
        if_nz r16.w
          ...
          if_nz r16.w
            ...
            if_nz r20.z
              ubfe r16.w, l(4), l(24), r18.w
              ishl r16.w, l(1), r16.w
              ushr r21.w, r18.w, l(28)
              ishl r21.w, l(1), r21.w
              ieq r22.w, r20.z, l(4)
              if_nz r22.w
                and r22.w, r18.w, l(4095)
                ubfe r23.w, l(12), l(12), r18.w
                and r24.w, r19.w, l(1023)
              ...
              mul r16.w, r17.w, r26.w
            else 
              mov r17.xyz, l(0,0,0,0)
              mov r16.w, l(0)
            endif 
            ne r18.w, r18.x, l(1.000000)
            add r17.w, r17.w, r16.w
            mad_sat r17.w, r17.w, r18.x, -r18.x
            movc r16.w, r18.w, r17.w, r16.w
            if_nz r20.w
              ubfe r17.w, l(4), l(24), r19.y
              ishl r17.w, l(1), r17.w
              ushr r18.x, r19.y, l(28)
              ishl r18.x, l(1), r18.x
              ieq r18.w, r20.w, l(2)
              if_nz r18.w
                ...
                sample_d_indexable(texture2darray)(float,float,float,float) r18.w, r28.xyzx, t45.yzwx, s4, r26.xyzx, r27.xyzx
              else 
                ieq r20.z, r20.w, l(4)
                if_nz r20.z
                  and r20.z, r19.y, l(4095)
                  ubfe r26.xy, l(12, 10, 0, 0), l(12, 20, 0, 0), r19.ywyy
                  utof r27.xz, r17.wwww
                  utof r27.y, r18.x
                  mad r26.zw, r20.xxxy, r27.zzzy, l(0.000000, 0.000000, 0.500000, 0.500000)
                  ...
                  utof r28.x, r20.z
                  utof r28.yz, r26.xxyx
                  add r20.zw, r26.zzzw, r28.xxxy
                  mul r28.xy, r20.zwzz, cb1[83].xyxx
                  mul r26.xyz, r24.zyzz, cb1[83].xyxx
                  mul r26.xyz, r27.xyzx, r26.xyzx
                  mul r29.xyz, r25.zyzz, cb1[83].xyxx
                  mul r27.xyz, r27.xyzx, r29.xyzx
                  ...
                  utof r28.yz, r26.xxyx
                  add r20.zw, r26.zzzw, r28.xxxy
                  mul r28.xy, r20.zwzz, cb1[83].zwzz
                  mul r26.xyz, r24.zyzz, cb1[83].zwzz
                  mul r26.xyz, r27.xyzx, r26.xyzx
              ...
              mad r26.xyz, r18.wwww, l(0.960000, 0.960000, 0.960000, 0.000000), l(0.040000, 0.040000, 0.040000, 0.000000)
              add_sat r17.w, -r18.w, l(1.000000)
            ...
            if_nz r18.x
              ...
              if_nz r17.w
                ...
                ishl r17.w, l(1), r18.z
                ushr r18.z, r19.z, l(28)
                ishl r18.z, l(1), r18.z
                and r19.y, r19.z, l(4095)
                and r15.w, r15.w, l(1023)
                utof r27.xz, r17.wwww
                utof r27.y, r18.z
                mad r20.zw, r20.xxxy, r27.zzzy, l(0.000000, 0.000000, 0.500000, 0.500000)
                add r28.xy, r27.zyzz, l(-0.500000, -0.500000, 0.000000, 0.000000)
                min r20.zw, r20.zzzw, r28.xxxy
                utof r28.x, r19.y
                utof r28.y, r18.w
                add r18.zw, r20.zzzw, r28.xxxy
            ...
            if_nz r18.y
              ...
              if_nz r17.w
                ...
                ishl r17.w, l(1), r18.x
                ushr r18.x, r19.x, l(28)
                ishl r18.x, l(1), r18.x
                and r18.w, r19.x, l(4095)
                utof r19.xz, r17.wwww
                utof r19.y, r18.x
              ...
              mul r19.xyz, r15.xyzx, r17.wwww
              mad r15.xyz, r18.xyzx, r16.wwww, r19.xyzx
            endif 
            add r17.w, -r16.w, l(1.000000)
            mul r18.xyz, r11.xyzx, r17.wwww
            mad r11.xyz, r17.xyzx, r16.wwww, r18.xyzx
            mul r17.xyz, r16.xyzx, r17.wwww
            mad r16.xyz, r26.xyzx, r16.wwww, r17.xyzx
            mad r12.w, r12.w, r17.w, r16.w
            mul r17.x, r13.w, r17.w
            mad r13.w, r15.w, r16.w, r17.x
          endif 
        endif 
      endif 
    endif 
...
mad r1.xyz, r1.xyzx, r3.zzzz, r12.xyzx
mad r0.w, r0.w, r3.z, r6.w
mad r2.yzw, r2.yyzw, r3.zzzz, r13.xxyz
dp3 r4.w, r2.yzwy, r2.yzwy
rsq r4.w, r4.w
mul r6.xyz, r2.yzwy, r4.wwww
mad r7.y, r1.w, r3.z, r7.w
mad r2.yzw, r3.xxyw, r3.zzzz, r14.xxyz
add r0.z, -r0.z, cb1[69].w
mov_sat r0.x, r0.x
mul r0.x, r0.x, cb0[18].x
eq r3.xyw, r0.yyyy, l(3.000000, 2.000000, 0.000000, 1.000000)
movc r10.xyz, r3.wwww, cb0[21].xyzx, cb0[19].xyzx
movc r10.xyz, r3.yyyy, cb0[22].xyzx, r10.xyzx
movc r3.xyw, r3.xxxx, cb0[23].xyxz, r10.xyxz
...
if_nz r0.y
  ...
  sincos r11.x, r12.x, r0.y
  mov r12.y, r12.x
  mov r12.z, r11.x
  dp2 r13.x, r12.yzyy, r5.zwzz
  mov r12.x, -r11.x
  dp2 r13.y, r12.xyxx, r5.zwzz
  mul r0.yz, r0.zzzz, cb0[13].xxyx
  mad r0.yz, r0.yyzy, cb0[13].zzwz, r13.xxyx
  ...
  mov_sat r5.zw, r0.yyyz
  movc r10.xy, cb0[15].zwzz, r5.zwzz, r0.yzyy
endif 
dp3 r0.y, -v7.xyzx, -v7.xyzx
rsq r0.y, r0.y
mul r11.xyz, r0.yyyy, -v7.xyzx
dp3_sat r0.z, r11.xyzx, r4.xyzx
sample_indexable(texture2d)(float,float,float,float) r4.xyzw, r10.xyxx, t26.xyzw, s1
...
frc r0.x, r0.x
mad r4.y, cb1[69].w, cb0[16].z, r0.x
mov r4.x, cb0[16].x
sample_l_indexable(texture2d)(float,float,float,float) r0.x, r4.xyxx, t25.xyzw, s5, l(0.000000)
log r0.x, |r0.x|
...
dp3_sat r7.x, r6.xyzx, r11.xyzx
dp3 r0.z, -r11.xyzx, r6.xyzx
add r0.z, r0.z, r0.z
mad r13.xyz, r6.xyzx, -r0.zzzz, -r11.xyzx
...
loop 
  ...
  sqrt r11.w, r11.w
  mad r11.w, r4.y, l(5.000000), r11.w
...
if_z r5.w
      ...
      if_nz r15.x
        ...
        if_nz r14.w
          ...
          if_nz r15.x
            ...
            sqrt r14.w, r14.w
            mad r14.w, r4.y, l(5.000000), r14.w
        ...
        if_nz r18.w
          ...
          if_nz r18.z
            ...
            if_nz r18.z
              ...
              sqrt r17.w, r17.w
              mad r17.w, r4.y, l(5.000000), r17.w
  ...
  max r4.y, r24.w, l(1.000000)
  rcp r4.y, r4.y
  mov_sat r24.w, r24.w
  mul r21.xyz, r4.yyyy, r23.xyzx
  mul r22.xyz, r4.yyyy, r24.xyzx
  ...
  if_nz r4.w
    ...
    dp3 r5.z, r12.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
    mad r21.xyz, r23.xyzx, r4.yyyy, r12.yzwy
    mov r13.w, l(0)
    sample_l_indexable(texturecubearray)(float,float,float,float) r12.yzw, r13.xyzw, t8.wxyz, s2, r4.z
    mad r4.y, cb2[19].x, r4.w, -r5.z
    mad r4.y, r7.y, r4.y, r5.z
    mad r22.xyz, r12.yzwy, r4.yyyy, r22.xyzx
  endif 
else 
  mov r22.x, r21.w
endif 
...
mul r7.yzw, r4.yyyy, r22.xxyz
mul r15.xyz, r4.zzzz, r7.zwyz
mul r4.yzw, r4.wwww, r7.yyzw
sqrt r2.x, r1.w
mad r2.x, r2.x, l(0.500000), l(0.500000)
mul r2.x, r2.x, r2.x
mul r5.z, r2.x, l(0.500000)
mad r2.x, -r2.x, l(0.500000), l(1.000000)
mad r5.w, r7.x, r2.x, r5.z
mul r2.x, r2.x, r5.w
mul r5.z, r5.w, r5.z
dp3 r5.w, r6.xyzx, cb2[17].xyzx
mov_sat r6.w, r5.w
...
if_nz r7.y
  ...
  if_nz r7.y
    ...
    if_nz cb2[23].x
      ...
      utof r16.z, r7.w
      sample_l_indexable(texture2darray)(float,float,float,float) r8.xyz, r16.xyzx, t20.xyzw, s2, l(0.000000)
    ...
    mad r7.yzw, r6.wwww, r8.xxyz, r4.yyzw
    ...
    mov r8.zw, r7.yyyz
    mov r15.zw, r4.yyyz
    movc r8.xyzw, r5.wwww, r8.xyzw, r15.xyzw
    movc r4.w, r5.w, r7.w, r4.w
    mov r15.z, r14.w
    mov r15.xy, r8.xyxx
    mov r4.yz, r8.zzwz
  endif 
...
ret 
// Approximately 2701 instruction slots used
