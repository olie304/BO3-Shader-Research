...
sample_indexable(texture2d)(float,float,float,float) r5.xyz, r1.xyxx, t24.xyzw, s5
add r5.xyz, r5.xyzx, l(-0.500000, -0.500000, -0.000000, 0.000000)
mad r5.xyz, cb0[11].wwww, r5.xyzx, l(0.500000, 0.500000, 0.000000, 0.000000)
...
if_nz r2.x
  ...
  mad r7.xy, r5.xyxx, r1.zzzz, r6.xyxx
  dp3 r4.w, r7.xyzx, r7.xyzx
  rsq r4.w, r4.w
  mul r5.xyw, r4.wwww, r7.xyxz
  mad r4.z, r4.z, r1.z, r2.x
else 
...
if_nz r4.y
  ftoi r4.y, cb1[64].w
  lod r4.z, r1.xyxx, t21.y, s1
  lod r4.w, r1.xyxx, t21.x, s1
  lt r4.z, r4.z, r4.w
  lt r4.w, l(0.000000), r4.w
  and r7.xyz, r4.yyyy, l(1, 2, 4, 0)
  movc r8.xyz, r7.xxxx, l(1.000000,0,1.000000,0), r2.yzwy
  movc r7.xyw, r7.yyyy, l(0,1.000000,0,1.000000), r2.yzyw
  movc r7.xyw, r4.wwww, r8.xyxz, r7.xyxw
  movc r8.xyz, r7.zzzz, l(0,1.000000,0,0), r2.yzwy
  movc r2.yzw, r4.zzzz, r7.xxyw, r8.xxyz
endif 
add r4.yzw, -r2.yyzw, cb1[58].xxyz
mad r2.yzw, cb1[58].wwww, r4.yyzw, r2.yyzw
add r4.yzw, -r3.xxyz, cb1[61].xxyz
mad r3.xyz, cb1[61].wwww, r4.yzwy, r3.xyzx
add r4.x, -r2.x, r4.x
mad r2.x, cb1[62].w, r4.x, r2.x
...
loop 
  ...
  dp3 r14.w, r35.xyzx, r11.yzwy
  add_sat r14.w, r35.w, r14.w
  dp3 r15.x, r36.xyzx, r11.yzwy
  add_sat r15.x, r36.w, r15.x
  mul r14.w, r14.w, r15.x
  dp3 r15.x, r37.xyzx, r11.yzwy
  add_sat r15.x, r37.w, r15.x
  mul r14.w, r14.w, r15.x
  dp3 r15.x, r38.xyzx, r11.yzwy
  add_sat r15.x, r38.w, r15.x
  mul r14.w, r14.w, r15.x
  dp3 r15.x, r39.xyzx, r11.yzwy
  add_sat r15.x, r39.w, r15.x
  mul r14.w, r14.w, r15.x
  dp3 r15.x, r40.xyzx, r11.yzwy
  ...
  dp3 r15.z, r11.yzwy, r35.xyzx
  add r15.z, -r29.w, r15.z
  ...
  mov r29.z, r30.z
  dp3 r15.z, r12.xyzx, r29.xyzx
  dp3 r16.x, r11.yzwy, r29.xyzx
  ...
  mov r30.z, r31.z
  dp3 r15.z, r12.xyzx, r30.xyzx
  dp3 r16.x, r11.yzwy, r30.xyzx
  ...
  min r14.w, r14.w, |r15.z|
  mov r31.z, r32.z
  dp3 r15.z, r12.xyzx, r31.xyzx
  dp3 r16.x, r11.yzwy, r31.xyzx
  ...
  min r14.w, r14.w, |r15.z|
  mov r32.z, r33.x
  dp3 r15.z, r12.xyzx, r32.xyzx
  dp3 r16.x, r11.yzwy, r32.xyzx
  ...
  min r14.w, r14.w, |r15.z|
  mov r34.zw, r33.zzzw
  dp3 r15.z, r12.zxyz, r34.xzwx
  dp3 r16.x, r11.wyzw, r34.xzwx
  ...
  mad r29.xyz, r12.xyzx, r14.wwww, r29.xyzx
  dp3 r15.z, r29.xyzx, r29.xyzx
  sqrt r15.z, r15.z
  ...
  utof r30.w, r16.w
  sample_l_indexable(texturecubearray)(float,float,float,float) r23.xyz, r30.xyzw, t8.xyzw, s2, r14.w
  and r28.yzw, r23.xxyz, l(0, 0x7fffffff, 0x7fffffff, 0x7fffffff)
  ieq r28.yzw, r28.yyzw, l(0, 0x7f800000, 0x7f800000, 0x7f800000)
  or r14.w, r28.z, r28.y
  or r14.w, r28.w, r14.w
  movc r23.xyz, r14.wwww, l(1.000000,1.000000,0,0), r23.xyzx
    ...
    if_nz r17.z
      ...
      if_nz r13.w
        ...
        loop 
          ...
          movc r5.y, r19.w, r17.w, r22.z
          movc r30.xy, r19.zzzz, r30.xyxx, r5.xyxx
          iadd r17.z, r17.z, l(1)
          mov r16.w, r18.w
        endloop 
        mov_sat r30.y, r30.y
        mul r5.y, r10.w, r30.y
        lt r16.w, l(0.000000), r5.y
        if_nz r16.w
...
if_z r4.w
  ...
  loop 
    ...
    ieq r11.y, r5.x, r10.z
    bfi r11.z, r5.y, l(0), l(0), r10.w
    movc r10.w, r11.y, r11.z, r10.w
    ieq r11.y, r9.w, r10.z
      ...
      if_nz r14.z
        ...
        if_nz r13.w
          ...
          if_nz r14.z
            ...
            dp3 r35.x, r7.xyzx, r27.xyzx
            dp3 r35.y, r7.xyzx, r28.xyzx
  ...
  rcp r4.w, r4.w
  mov_sat r24.w, r24.w
  mul r20.xyz, r4.wwww, r23.xyzx
  mul r21.xyz, r4.wwww, r24.xyzx
  ...
  if_nz r5.x
    ...
    lt r11.yzw, l(0.000000, 0.000000, 0.000000, 0.000000), r7.xxyz
    ...
    mov r7.w, l(0)
    sample_l_indexable(texturecubearray)(float,float,float,float) r11.yzw, r7.xyzw, t8.wxyz, s2, l(6.000000)
    mul r10.yzw, r10.yyzw, r11.yyzw
    dp3 r5.y, r10.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
    mad r20.xyz, r23.xyzx, r4.wwww, r10.yzwy
    mov r12.w, l(0)
    sample_l_indexable(texturecubearray)(float,float,float,float) r10.yzw, r12.xyzw, t8.wxyz, s2, r6.z
    mad r4.w, cb2[19].x, r5.x, -r5.y
    mad r4.w, r4.y, r4.w, r5.y
    mad r21.xyz, r10.yzwy, r4.wwww, r21.xyzx
  endif 
else 
  mov r21.x, r20.w
endif 
...
ret 
// Approximately 3072 instruction slots used
