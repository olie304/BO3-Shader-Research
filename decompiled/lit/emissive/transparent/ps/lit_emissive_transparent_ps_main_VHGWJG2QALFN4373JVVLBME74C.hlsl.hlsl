...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  r3.xy = r3.xy * r2.ww + v2.xy;
  r2.w = yTexture.Sample(ySampler_s, r3.xy).x;
  r4.x = -0.0625 + r2.w;
  ...
  r8.yzw = r22.xyz * r4.yyy;
  r15.xyz = r8.zwy * r4.zzz;
  r4.yzw = r8.yzw * r4.www;
  r1.y = sqrt(r2.w);
  r1.y = r1.y * 0.5 + 0.5;
  r1.y = r1.y * r1.y;
  r5.z = 0.5 * r1.y;
  ...
  if (r7.w != 0) {
    ...
    if (r7.w != 0) {
      ...
      r10.zw = r8.yz;
      r15.zw = r4.yz;
      r10.xyzw = r5.wwww ? r10.xyzw : r15.xyzw;
      r4.w = r5.w ? r8.w : r4.w;
      r15.z = r14.w;
      r15.xy = r10.xy;
      r4.yz = r10.zw;
