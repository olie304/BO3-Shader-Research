...
r0.w = samp0[]..swiz;
  ...
  r7.xyz = debugNormalOverride.www * r8.xyz + r7.xyz;
  ...
  r8.zw = (int2)r0.yy & int2(268435456,536870912);
  if (r8.z != 0) {
    ...
    while (true) {
      ...
      if (r4.w == 0) r8.z = 0; else if (r4.w+0 < 32) {       r8.z = (uint)r6.w << (32-(r4.w + 0)); r8.z = (uint)r8.z >> (32-r4.w);      } else r8.z = (uint)r6.w >> 0;
      r6.w = r7.w ? r8.z : r6.w;
  ...
  if (r8.w != 0) {
    ...
    r8.z = r4.w;
    while (true) {
      r8.w = cmp((uint)r8.z >= (uint)r0.y);
      if (r8.w != 0) break;
      r13.z = (uint)r8.z >> 5;
      r14.xyz = (int3)r12.xyz + (int3)r13.xyz;
      r8.w = visibleDecals.Load(r14.xyzw).x;
      r9.w = cmp((int)r4.w == (int)r8.z);
            ...
            r30.w = samp0[]..swiz;
              ...
              r27.w = samp0[]..swiz;
                ...
                if (r22.w != 0) {
                  ...
                  r28.xyz = r29.xyz * r3.www;
                  r26.xyz = r26.xyz * r3.www;
                  r27.xyz = r27.xyz * r3.www;
                  r19.w = -17 * r12.w;
                  r19.w = exp2(r19.w);
                  r18.w = r19.w + r18.w;
                  r18.w = log2(r18.w);
  ...
  r0.y = 1 + -r15.x;
  r1.xyz = r1.xyz * r0.yyy + r16.xyz;
  r1.w = r1.w * r0.y + r15.x;
  r7.xyz = r7.xyz * r0.yyy + r17.xyz;
  r2.w = dot(r7.xyz, r7.xyz);
  r2.w = rsqrt(r2.w);
  r7.xyz = r7.xyz * r2.www;
  r9.y = r2.x * r0.y + r15.y;
  r3.xyz = r3.xyz * r0.yyy + r18.xyz;
  r0.x = saturate(r0.x);
  r0.x = hdrScale * r0.x;
  r10.xyz = cmp(r0.www == float3(3,2,1));
  r0.w = cmp(r0.w < 0);
  r11.xyz = r0.www ? float3(1,1,1) : emissiveTint1.xyz;
  r11.xyz = r10.zzz ? tint1.xyz : r11.xyz;
  r10.yzw = r10.yyy ? tint2.xyz : r11.xyz;
  r10.xyz = r10.xxx ? tint3.xyz : r10.yzw;
  r0.w = dot(-v6.xyz, -v6.xyz);
  r0.w = rsqrt(r0.w);
  r11.xyz = -v6.xyz * r0.www;
  r2.x = dot(r11.xyz, r4.xyz);
  r4.x = dot(r11.xyz, r5.xyz);
  r4.y = dot(r11.xyz, r6.xyz);
  r2.w = cmp(0 < r2.x);
  r4.xy = -r4.xy / r2.xx;
  r4.xy = r2.ww ? r4.xy : 0;
  ...
  r2.xw = (uint2)r8.yx;
  r0.y = dot(r2.wx, float2(0.0671105608,0.00583714992));
  r0.y = frac(r0.y);
  r0.y = 52.9829178 * r0.y;
  r0.y = frac(r0.y);
  r0.y = r0.y * 6.28318548 + gameTick.w;
  sincos(r0.y, r5.x, r6.x);
  r0.y = dot(r2.xw, float2(0.0671105608,0.00583714992));
  r0.y = frac(r0.y);
  r0.y = 52.9829178 * r0.y;
  r0.y = frac(r0.y);
  r0.y = r0.y * 6.28318548 + gameTick.w;
  sincos(r0.y, r2.x, r10.x);
  r9.x = saturate(dot(r7.xyz, r11.xyz));
  r0.y = dot(-r11.xyz, r7.xyz);
  r0.y = r0.y + r0.y;
  r12.xyz = r7.xyz * -r0.yyy + -r11.xyz;
  r0.y = 17 * r9.y;
  r0.y = exp2(r0.y);
  r0.y = 2 + r0.y;
  r0.y = 2 / r0.y;
  ...
  if (r2.z == 0) {
    ...
    while (true) {
      ...
      r11.w = cmp((int)r8.w == (int)r10.z);
      bitmask.z = ((~(-1 << r9.z)) << 0) & 0xffffffff;  r13.z = (((uint)0 << 0) & bitmask.z) | ((uint)r10.w & ~bitmask.z);
      r10.w = r11.w ? r13.z : r10.w;
      r11.w = cmp((int)r9.w == (int)r10.z);
    ...
    if (r9.w != 0) {
      ...
      r11.w = 0;
      while (true) {
        r13.w = cmp((uint)r11.w >= (uint)r2.z);
        if (r13.w != 0) break;
        r13.z = (uint)r11.w >> 5;
        r14.xyz = (int3)r8.xyz + (int3)r13.xyz;
    ...
    r3.w = cmp(r23.w < 0.99000001);
    if (r3.w != 0) {
      r3.w = 1 + -r23.w;
      r5.w = sunConstants.globalProbeExposure * r3.w;
      ...
      r5.w = dot(r10.yzw, float3(0.212599993,0.715200007,0.0722000003));
      r20.xyz = r22.xyz * r2.zzz + r10.yzw;
      r12.w = 0;
      r10.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r12.xyzw, r5.z).xyz;
      r2.z = sunConstants.globalProbeExposure * r3.w + -r5.w;
      r2.z = r9.y * r2.z + r5.w;
      r21.xyz = r10.yzw * r2.zzz + r21.xyz;
    }
  } else {
    r21.x = r20.w;
  }
    ...
    if (r11.w == 0) {
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          r17.z = (uint)r15.w;
          r15.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r17.xyz, r5.w).x;
            ...
            if (r21.w != 0) {
              ...
              if (r21.w != 0) {
                ...
                if (r21.w != 0) {
                  ...
                  r39.xyz = r39.xyz * r11.www + r11.xyz;
                  r11.w = dot(r39.xyz, r39.xyz);
                  r11.w = rsqrt(r11.w);
                  r39.xyz = r39.xyz * r11.www;
                  r11.w = dot(r39.xyz, r11.xyz);
                  r16.z = dot(r7.xyz, r39.xyz);
                  r16.w = abs(r16.z) * r0.y + -abs(r16.z);
                  r16.z = abs(r16.z) * r16.w + 1;
                  r16.w = r12.w * r2.y + r2.z;
                  r16.z = r16.z * r16.z;
                  r16.z = r16.z * r16.w;
                  r16.z = rcp(r16.z);
                  r12.w = r12.w * r21.w;
            ...
            r40.w = samp0[]..swiz;
              ...
              if (r14.w != 0) {
                ...
                if (r14.w != 0) {
                  ...
                  r20.xyz = r20.xyz * r11.www + r11.xyz;
                  r11.w = dot(r20.xyz, r20.xyz);
                  r11.w = rsqrt(r11.w);
                  r20.xyz = r20.xyz * r11.www;
                  r11.w = dot(r20.xyz, r11.xyz);
                  r16.z = dot(r7.xyz, r20.xyz);
                  r19.x = abs(r16.z) * r0.y + -abs(r16.z);
                  r16.z = abs(r16.z) * r19.x + 1;
                  r13.w = r13.w * r2.y + r2.z;
                  r16.z = r16.z * r16.z;
                  r13.w = r16.z * r13.w;
                  r13.w = rcp(r13.w);
                  r13.w = r13.w * r14.w;
  ...
  r0.xyw = float3(1,1,1) + -r3.xyz;
  r0.xyw = r28.xyz * r0.xyw;
  r0.xyw = r29.xyz * r3.xyz + r0.xyw;
  r0.xyw = r10.yzw * r1.xyz + r0.xyw;
