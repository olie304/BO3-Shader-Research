// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:33:47 2021
...
r1.w = samp0[]..swiz;
  ...
  r1.z = samp0[]..swiz;
    r5.xyz = normalBodyMap.Sample(normalSampler_s, v2.xy).xyz;
    ...
    r1.w = min(1, r1.w);
    r6.xy = r4.xy * r1.zz + r5.xy;
    r5.x = dot(r6.xyz, r6.xyz);
    r5.x = rsqrt(r5.x);
    r4.xyw = r6.xyz * r5.xxx;
    r4.z = r4.z * r1.z + r1.w;
  } else {
  ...
  if (r1.w != 0) {
    ...
    r5.w = columnCount * r1.w;
    r5.w = cmp(r5.w >= -r5.w);
    r5.w = r5.w ? columnCount : -columnCount;
    r6.z = 1 / r5.w;
    r1.w = r6.z * r1.w;
    r1.w = frac(r1.w);
    r1.w = r5.w * r1.w;
    ...
    r1.xy = r1.xy / r1.ww;
    r1.xy = float2(0.5,0.5) + r1.xy;
    r6.zw = saturate(r1.xy);
    r8.xy = clampU ? r6.zw : r1.xy;
  }
  r1.x = dot(-v7.xyz, -v7.xyz);
  r1.x = rsqrt(r1.x);
  r11.xyz = -v7.xyz * r1.xxx;
  r1.y = saturate(dot(r11.xyz, r5.xyz));
  r5.xyzw = emissiveMap.Sample(colorSampler_s, r8.xy).xyzw;
  ...
  r3.w = exp2(r3.w);
  r5.x = flickerRange.y + -flickerRange.x;
  r3.w = r3.w * r5.x + flickerRange.x;
  ...
  while (true) {
    ...
    while (true) {
      ...
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=80)(mixed,mixed,mixed,mixed) r25.xyzw, r15.y, l(0), t11.xyzw
      r25.x = samp0[]..swiz;
      r25.y = samp0[]..swiz;
      r25.z = samp0[]..swiz;
      r25.w = samp0[]..swiz;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=80)(mixed,mixed,mixed,mixed) r26.xy, r15.y, l(16), t11.xyxx
      r26.x = samp0[]..swiz;
      r26.y = samp0[]..swiz;
        ...
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r25.xyzw, r15.x, l(0), t15.wxyz
        r25.x = samp0[]..swiz;
        r25.y = samp0[]..swiz;
        r25.z = samp0[]..swiz;
        r25.w = samp0[]..swiz;
        ...
        r15.z = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r26.xyzw, r15.x, l(116), t15.zwxy
        r26.x = samp0[]..swiz;
        r26.y = samp0[]..swiz;
        r26.z = samp0[]..swiz;
        r26.w = samp0[]..swiz;
        ...
        r33.w = samp0[]..swiz;
          ...
          if (r16.x != 0) {
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r29.xyzw, r15.x, l(16), t15.xyzw
          r29.x = samp0[]..swiz;
          r29.y = samp0[]..swiz;
          r29.z = samp0[]..swiz;
          r29.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r30.xyzw, r15.x, l(32), t15.yxwz
          r30.x = samp0[]..swiz;
          r30.y = samp0[]..swiz;
          r30.z = samp0[]..swiz;
          r30.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r31.xyzw, r15.x, l(48), t15.xyzw
          r31.x = samp0[]..swiz;
          r31.y = samp0[]..swiz;
          r31.z = samp0[]..swiz;
          r31.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r32.xyzw, r15.x, l(64), t15.zwxy
          r32.x = samp0[]..swiz;
          r32.y = samp0[]..swiz;
          r32.z = samp0[]..swiz;
          r32.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r33.xyzw, r15.x, l(80), t15.xyzw
          r33.x = samp0[]..swiz;
          r33.y = samp0[]..swiz;
          r33.z = samp0[]..swiz;
          r33.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r34.xyzw, r15.x, l(132), t15.zwxy
          r34.x = samp0[]..swiz;
          r34.y = samp0[]..swiz;
          r34.z = samp0[]..swiz;
          r34.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r35.xyzw, r15.x, l(148), t15.zwxy
          r35.x = samp0[]..swiz;
          r35.y = samp0[]..swiz;
          r35.z = samp0[]..swiz;
          r35.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r36.xyzw, r15.x, l(164), t15.zwxy
          r36.x = samp0[]..swiz;
          r36.y = samp0[]..swiz;
          r36.z = samp0[]..swiz;
          r36.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r37.xyzw, r15.x, l(180), t15.zwxy
          r37.x = samp0[]..swiz;
          r37.y = samp0[]..swiz;
          r37.z = samp0[]..swiz;
          r37.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r38.xyzw, r15.x, l(196), t15.xyzw
          r38.x = samp0[]..swiz;
          r38.y = samp0[]..swiz;
          r38.z = samp0[]..swiz;
          r38.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r39.xy, r15.x, l(212), t15.xyxx
          r39.x = samp0[]..swiz;
          r39.y = samp0[]..swiz;
            r24.z = r28.y * r15.z + r24.z;
            r15.x = r15.y * r26.z;
            r26.z = r34.z;
            r15.y = dot(r13.xyz, r26.xyz);
            ...
            r34.w = (uint)r15.z;
            r18.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r34.xyzw, r15.y).xyz;
            ...
            r25.x = r23.w;
            r25.yz = r24.xy;
            r24.xyw = r18.zwy * r15.xxx + r25.yzx;
            r23.w = r24.w;
          }
        }
      }
        ...
        r27.y = samp0[]..swiz;
          ...
          r34.w = samp0[]..swiz;
            ...
            r36.w = samp0[]..swiz;
              ...
              r25.w = -r25.w * r26.w + 1;
              r25.w = r30.y * r25.w;
              r18.y = r29.w ? r25.w : r30.z;
              r30.xy = r29.zz ? r30.xy : r18.xy;
              r20.w = (int)r20.w + 1;
              r16.x = r28.w;
            }
            r16.x = saturate(r30.y + -r15.y);
            r17.w = r16.x * r18.w;
            r18.y = cmp(0 < r17.w);
            if (r18.y != 0) {
            // Known bad code for instruction (needs manual fix):
            ...
            r40.y = samp0[]..swiz;
              ...
              r16.w = min(abs(r17.w), r16.w);
              r40.zw = r39.zw;
              r17.w = dot(r13.zxy, r40.xzw);
              r18.y = dot(r28.zxy, r40.xzw);
              r18.y = r18.y + -r40.y;
              r18.z = cmp(r18.y >= 0);
              r18.y = max(abs(r18.y), r6.w);
              r18.y = r18.z ? r18.y : -r18.y;
              ...
              r26.y = r29.z;
              r26.z = r31.x;
              r35.x = dot(r18.yzw, r26.xyz);
              r27.xy = r29.xw;
              r27.z = r31.w;
              r35.y = dot(r18.yzw, r27.xyz);
              r31.x = r29.y;
              ...
              r35.w = (uint)r17.w;
              r18.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r35.xyzw, r16.w).xyz;
  ...
  r12.yzw = r21.xyz * r5.www;
  r14.xyz = r22.xyz * r5.www;
  ...
  if (r6.w != 0) {
    ...
    r16.xyz = cmp(float3(0,0,0) < r4.xyz);
    ...
    r18.xyz = r4.xyz * r4.xyz;
    r18.xyz = r18.xyz * r7.zzz;
    ...
    r4.w = 0;
    r16.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r4.xyzw, 6).xyz;
    r15.xyz = r16.xyz * r15.xyz;
    r4.w = dot(r15.xyz, float3(0.212599993,0.715200007,0.0722000003));
    r12.yzw = r21.xyz * r5.www + r15.xyz;
    r13.w = 0;
    r15.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r13.xyzw, r6.z).xyz;
  ...
  r7.yzw = r14.xyz * r4.www;
  r14.xyz = r7.zwy * r6.zzz;
  ...
  if (r6.w != 0) {
    ...
    if (r6.w != 0) {
      ...
      r1.x = r6.w * r1.x;
      r1.x = r6.z * r1.x;
      r9.xyz = r1.xxx * r9.yzx + r14.xyz;
      r16.w = r9.z;
      r15.w = r14.z;
      r15.xyzw = r5.wwww ? r16.xyzw : r15.xyzw;
      r9.zw = r12.yz;
      r14.zw = r7.yz;
      r9.xyzw = r5.wwww ? r9.xyzw : r14.xyzw;
  ...
  if (r1.w == 0) {
    r3.xy = (uint2)v0.xy;
    bitmask.w = ((~(-1 << 1)) << 16) & 0xffffffff;  r1.w = (((uint)zFeatherComputeSprites << 16) & bitmask.w) | ((uint)0 & ~bitmask.w);
    r1.w = (int)r1.w + 1;
    // Needs manual fix for instruction:
    ...
    if (r1.w != 0) {
      ...
      r4.x = (uint)v0.z << 2;
      r1.w = (int)r1.w & 2046;
      bitmask.w = ((~(-1 << 11)) << 0) & 0xffffffff;  r1.w = (((uint)r1.w << 0) & bitmask.w) | ((uint)r4.x & ~bitmask.w);
