...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:33:41 2021
//
//
// Buffer Definitions: 
//
...
sample_indexable(texture2d)(float,float,float,float) r2.yzw, v2.xyxx, t25.wxyz, s5
...
exp r2.w, r2.w
movc r2.w, cb0[13].y, r2.w, r3.y
eq r3.y, cb0[12].x, l(0.000000)
movc r2.w, r3.y, l(1.000000), r2.w
mul r3.y, r4.w, cb0[11].w
mul r2.w, r2.w, r3.y
mul r2.w, r3.x, r2.w
...
ret 
// Approximately 2266 instruction slots used
