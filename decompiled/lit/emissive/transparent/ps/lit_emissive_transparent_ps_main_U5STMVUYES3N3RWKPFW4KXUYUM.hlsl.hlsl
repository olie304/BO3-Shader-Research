...
r0.z = samp0[]..swiz;
  ...
  r1.w = r1.w * r0.y + r13.x;
  r2.xyz = r2.xyz * r0.yyy + r15.xyz;
  r3.x = dot(r2.xyz, r2.xyz);
  r3.x = rsqrt(r3.x);
  r7.xyz = r3.xxx * r2.xyz;
  r2.y = r0.w * r0.y + r13.y;
  r8.xyz = r0.yyy * float3(0.0399999991,0.0399999991,0.0399999991) + r16.xyz;
  r0.x = saturate(r0.x);
  r0.x = hdrScale * r0.x;
  r9.xyzw = cmp(r0.zzzz == float4(4,3,2,1));
  r10.xyz = r9.www ? tint1.xyz : emissiveTint1.xyz;
  r10.xyz = r9.zzz ? tint2.xyz : r10.xyz;
  r9.yzw = r9.yyy ? tint3.xyz : r10.xyz;
  r9.xyz = r9.xxx ? tint4.xyz : r9.yzw;
  r0.z = dot(-v6.xyz, -v6.xyz);
  r0.z = rsqrt(r0.z);
  r10.xyz = -v6.xyz * r0.zzz;
  r0.w = dot(r10.xyz, r3.yzw);
  ...
  while (true) {
    ...
    r9.y = visibleProbes.Load(r15.xyzw).x;
    r9.z = cmp((int)r2.w == (int)r8.w);
    bitmask.w = ((~(-1 << r6.x)) << 0) & 0xffffffff;  r9.w = (((uint)0 << 0) & bitmask.w) | ((uint)r9.y & ~bitmask.w);
    r9.y = r9.z ? r9.w : r9.y;
    r9.z = cmp((int)r6.y == (int)r8.w);
    if (r6.w == 0) r9.w = 0; else if (r6.w+0 < 32) {     r9.w = (uint)r9.y << (32-(r6.w + 0)); r9.w = (uint)r9.w >> (32-r6.w);    } else r9.w = (uint)r9.y >> 0;
    r9.y = r9.z ? r9.w : r9.y;
  ...
  if (r6.y != 0) {
    ...
    r6.w = 0;
    while (true) {
      r8.w = cmp((uint)r6.w >= (uint)r6.z);
      if (r8.w != 0) break;
      r14.z = (uint)r6.w >> 5;
      r15.xyz = (int3)r13.xyz + (int3)r14.xyz;
      r8.w = visibleProbes.Load(r15.xyzw).x;
      r10.w = cmp((int)r2.w == (int)r6.w);
      if (r6.x == 0) r11.y = 0; else if (r6.x+0 < 32) {       r11.y = (uint)r8.w << (32-(r6.x + 0)); r11.y = (uint)r11.y >> (32-r6.x);      } else r11.y = (uint)r8.w >> 0;
      r8.w = r10.w ? r11.y : r8.w;
  ...
  r6.xyz = r21.xyz * r2.zzz;
  r9.yzw = r22.xyz * r2.zzz;
  ...
  if (r2.w != 0) {
    ...
    r6.xyz = r21.xyz * r2.zzz + r11.yzw;
    r12.w = 0;
    r11.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r12.xyzw, r4.z).xyz;
    r2.z = sunConstants.globalProbeExposure * r2.w + -r4.w;
    r2.z = r2.y * r2.z + r4.w;
    r9.yzw = r11.yzw * r2.zzz + r9.yzw;
  }
  ...
  r5.w = r2.x * r4.z + r4.w;
  r4.zw = r5.ww * r4.zw;
  r5.w = dot(r7.xyz, sunConstants.wldDir.xyz);
  r7.w = saturate(r5.w);
  r8.w = cmp(0 >= r7.w);
  if (r8.w != 0) {
    r9.y = 0;
  ...
  if (r8.w != 0) {
    ...
    if (r8.w != 0) {
      ...
      r18.z = samp0[]..swiz;
      r18.w = samp0[]..swiz;
        r10.w = abs(r5.w) * -0.200000003 + 0.400000006;
        r19.xyz = r7.xyz * r10.www + v6.xyz;
        r19.w = 1;
      ...
      r15.w = r16.z;
      r6.w = r14.z;
      r6.xyzw = r5.wwww ? r15.xyzw : r6.xyzw;
      r16.zw = r9.yz;
      r14.zw = r2.yz;
                      ...
                      r14.w = samp0[]..swiz;
                        ...
                        if (r8.w != 0) {
                          ...
                          while (true) {
                            ...
                            if (r29.w != 0) break;
                            r41.x = dot(icb[r27.w+0].xy, r5.xy);
                            r41.y = dot(icb[r27.w+0].yx, r5.xz);
