// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:34:12 2021
...
r0.y = samp0[]..swiz;
  ...
  r0.x = samp0[]..swiz;
    r4.xyz = normalBodyMap.Sample(normalSampler_s, v2.xy).xyz;
  ...
  r0.w = min(15, r0.w);
  r0.w = (uint)r0.w;
  r8.xy = (uint2)r1.wz >> int2(6,6);
  r8.z = (uint)r0.w << 4;
  r0.w = numStaticDecals & -32;
  r3.w = (int)-r0.w + numStaticDecals;
  r9.xy = float2(0,0);
  r10.w = 0;
  r7.w = 1;
  ...
  r6.w = 0;
  while (true) {
    r8.w = cmp((uint)r6.w >= numStaticDecals);
    if (r8.w != 0) break;
    r9.z = (uint)r6.w >> 5;
    r10.xyz = (int3)r8.xyz + (int3)r9.xyz;
    r8.w = visibleDecals.Load(r10.xyzw).x;
    r9.z = cmp((int)r0.w == (int)r6.w);
    if (r3.w == 0) r9.w = 0; else if (r3.w+0 < 32) {     r9.w = (uint)r8.w << (32-(r3.w + 0)); r9.w = (uint)r9.w >> (32-r3.w);    } else r9.w = (uint)r8.w >> 0;
    r8.w = r9.z ? r9.w : r8.w;
    ...
    while (true) {
      ...
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=80)(mixed,mixed,mixed,mixed) r16.xyzw, r14.w, l(0), t11.xyzw
      r16.x = samp0[]..swiz;
      r16.y = samp0[]..swiz;
      r16.z = samp0[]..swiz;
      r16.w = samp0[]..swiz;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=80)(mixed,mixed,mixed,mixed) r17.xy, r14.w, l(16), t11.xyxx
      r17.x = samp0[]..swiz;
      r17.y = samp0[]..swiz;
        ...
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=128)(mixed,mixed,mixed,mixed) r16.xyz, r13.w, l(0), t36.xyzx
        r16.x = samp0[]..swiz;
        r16.y = samp0[]..swiz;
        r16.z = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=128)(mixed,mixed,mixed,mixed) r17.xyz, r13.w, l(16), t36.xyzx
        r17.x = samp0[]..swiz;
        r17.y = samp0[]..swiz;
        r17.z = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=128)(mixed,mixed,mixed,mixed) r18.xyz, r13.w, l(32), t36.xyzx
        r18.x = samp0[]..swiz;
        r18.y = samp0[]..swiz;
        r18.z = samp0[]..swiz;
          r19.x = r16.x;
          ...
          r14.w = rsqrt(r14.w);
          r20.xyz = r19.xyz * r14.www;
          r14.w = dot(r20.xyz, v4.xyz);
          r14.w = cmp(r14.w >= 0.5);
          if (r14.w != 0) {
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=128)(mixed,mixed,mixed,mixed) r21.xyw, r13.w, l(48), t36.xyxz
          r21.x = samp0[]..swiz;
          r21.y = samp0[]..swiz;
          r21.w = samp0[]..swiz;
            r19.w = r21.x;
            ...
            if (r14.w != 0) {
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=128)(mixed,mixed,mixed,mixed) r16.xyzw, r13.w, l(64), t36.xyzw
            r16.x = samp0[]..swiz;
            r16.y = samp0[]..swiz;
            r16.z = samp0[]..swiz;
            r16.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=128)(mixed,mixed,mixed,mixed) r17.xyzw, r13.w, l(80), t36.xyzw
            r17.x = samp0[]..swiz;
            r17.y = samp0[]..swiz;
            r17.z = samp0[]..swiz;
            r17.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=128)(mixed,mixed,mixed,mixed) r18.xyzw, r13.w, l(96), t36.xyzw
            r18.x = samp0[]..swiz;
            r18.y = samp0[]..swiz;
            r18.z = samp0[]..swiz;
            r18.w = samp0[]..swiz;
              ...
              if (r19.z != 0) {
                if (4 == 0) r14.w = 0; else if (4+24 < 32) {                 r14.w = (uint)r17.w << (32-(4 + 24)); r14.w = (uint)r14.w >> (32-4);                } else r14.w = (uint)r17.w >> 24;
                r14.w = 1 << (int)r14.w;
                r15.w = (uint)r17.w >> 28;
                r15.w = 1 << (int)r15.w;
                r20.w = cmp((int)r19.z == 4);
                if (r20.w != 0) {
                  r20.w = (int)r17.w & 4095;
                  if (12 == 0) r21.w = 0; else if (12+12 < 32) {                   r21.w = (uint)r17.w << (32-(12 + 12)); r21.w = (uint)r21.w >> (32-12);                  } else r21.w = (uint)r17.w >> 12;
                  r22.w = (int)r18.w & 1023;
                  r25.xz = (uint2)r14.ww;
                  r25.y = (uint)r15.w;
              ...
              r15.w = cmp(r17.x != 1.000000);
              r16.w = r14.w + r16.w;
              r16.w = saturate(r16.w * r17.x + -r17.x);
              r14.w = r15.w ? r16.w : r14.w;
              if (r19.w != 0) {
                if (4 == 0) r15.w = 0; else if (4+24 < 32) {                 r15.w = (uint)r18.y << (32-(4 + 24)); r15.w = (uint)r15.w >> (32-4);                } else r15.w = (uint)r18.y >> 24;
                r15.w = 1 << (int)r15.w;
                r16.w = (uint)r18.y >> 28;
                r16.w = 1 << (int)r16.w;
                r17.x = cmp((int)r19.w == 2);
                if (r17.x != 0) {
                  r17.x = (int)r18.y & 4095;
                  ...
                  r27.x = (uint)r17.x;
                  r27.yz = (uint2)r25.xy;
                  r17.xw = r27.xy + r25.zw;
                  r27.xy = invMaskTexSizes.xy * r17.xw;
                  r25.xyz = invMaskTexSizes.xyx * r23.zyz;
                  r25.xyz = r25.xyz * r26.xyz;
                  r28.xyz = invMaskTexSizes.xyx * r24.zyz;
                  r26.xyz = r28.xyz * r26.xyz;
                  r17.x = materialTexMask.SampleGrad(samplerLinearClamp_s, r27.xyz, r25.x, r26.x).x;
                } else {
                  r17.w = cmp((int)r19.w == 4);
                  if (r17.w != 0) {
                    r17.w = (int)r18.y & 4095;
                    if (12 == 0) r19.z = 0; else if (12+12 < 32) {                     r19.z = (uint)r18.y << (32-(12 + 12)); r19.z = (uint)r19.z >> (32-12);                    } else r19.z = (uint)r18.y >> 12;
                    if (10 == 0) r19.w = 0; else if (10+20 < 32) {                     r19.w = (uint)r18.w << (32-(10 + 20)); r19.w = (uint)r19.w >> (32-10);                    } else r19.w = (uint)r18.w >> 20;
                    r25.xz = (uint2)r15.ww;
                    r25.y = (uint)r16.w;
                    r26.xy = r19.xy * r25.zy + float2(0.5,0.5);
                    r26.zw = float2(-0.5,-0.5) + r25.zy;
                    ...
                    r28.xyz = invBcTexSizes.xyx * r24.zyz;
                    r25.xyz = r28.xyz * r25.xyz;
                    r17.x = materialTexBC7.SampleGrad(samplerLinearClamp_s, r26.xyz, r27.x, r25.x).x;
                  } else {
                    r17.w = (int)r18.y & 4095;
                    if (12 == 0) r19.z = 0; else if (12+12 < 32) {                     r19.z = (uint)r18.y << (32-(12 + 12)); r19.z = (uint)r19.z >> (32-12);                    } else r19.z = (uint)r18.y >> 12;
                    if (10 == 0) r19.w = 0; else if (10+20 < 32) {                     r19.w = (uint)r18.w << (32-(10 + 20)); r19.w = (uint)r19.w >> (32-10);                    } else r19.w = (uint)r18.w >> 20;
                    ...
                    r25.xyz = r28.xyz * r25.xyz;
                    r17.x = materialTexBC3.SampleGrad(samplerLinearClamp_s, r26.xyz, r27.x, r25.x).x;
                  }
                }
                r25.xyz = r17.xxx * float3(0.959999979,0.959999979,0.959999979) + float3(0.0399999991,0.0399999991,0.0399999991);
                r15.w = saturate(1 + -r17.x);
              ...
              if (r17.y != 0) {
                ...
                r16.w = min(1, r16.w);
                r17.z = dot(r22.xyz, r22.xyz);
                r17.z = rsqrt(r17.z);
                r18.xyz = r22.xyz * r17.zzz;
                r17.z = dot(-r21.xyz, -r21.xyz);
                r17.z = rsqrt(r17.z);
                r19.xyz = -r21.xyz * r17.zzz;
                r20.xyz = r20.xyz * r0.xxx;
                r18.xyz = r18.xyz * r0.xxx;
                r19.xyz = r19.xyz * r0.xxx;
                r17.z = -17 * r13.w;
                r17.z = exp2(r17.z);
                r16.w = r17.z + r16.w;
                r16.w = log2(r16.w);
                ...
                r17.xyz = r20.xyz * r15.www + r17.xyz;
                r15.w = dot(r17.xyz, r17.xyz);
                r15.w = rsqrt(r15.w);
                r17.xyz = r17.xyz * r15.www;
                r15.w = 1 + -r14.w;
                r18.xyz = r15.www * r14.xyz;
                r14.xyz = r17.xyz * r14.www + r18.xyz;
              }
              r15.w = 1 + -r14.w;
              r17.xyz = r15.www * r10.xyz;
              r10.xyz = r16.xyz * r14.www + r17.xyz;
              r16.xyz = r15.xyz * r15.www;
              r15.xyz = r25.xyz * r14.www + r16.xyz;
              r9.w = r9.w * r15.w + r14.w;
              r15.w = r15.w * r11.w;
              r11.w = r13.w * r14.w + r15.w;
            }
          }
        }
      }
  ...
  r4.w = saturate(r4.w);
  r0.x = 1 + -r4.w;
  r2.xyz = r2.xyz * r0.xxx + r11.xyz;
  r3.xyz = r3.xyz * r0.xxx + r12.xyz;
  r0.w = dot(r3.xyz, r3.xyz);
  r0.w = rsqrt(r0.w);
  r3.xyz = r3.xyz * r0.www;
  r5.y = r0.y * r0.x + r5.w;
  r6.xyz = r0.xxx * float3(0.0399999991,0.0399999991,0.0399999991) + r13.xyz;
  r0.y = cmp(0.5 < invertFalloff);
  if (r0.y != 0) {
    r0.y = rowCount * columnCount;
    r0.w = imageTime * r0.y;
    r2.w = gameTime.w * r0.w;
    r2.w = cmp(r2.w >= -r2.w);
    r2.w = r2.w ? r0.w : -r0.w;
    r4.w = 1 / r2.w;
    ...
    r0.y = r0.w * r0.y;
    r0.y = round(r0.y);
    r0.w = r0.y / columnCount;
    r2.w = columnCount * r0.y;
    r2.w = cmp(r2.w >= -r2.w);
    ...
    r0.y = rsqrt(r0.y);
    r10.xyz = -v7.xyz * r0.yyy;
    r11.x = dot(r10.xyz, v5.xyz);
    r11.y = dot(r10.xyz, v6.xyz);
    r0.y = dot(r10.xyz, v4.xyz);
    r0.w = cmp(0 < r0.y);
    r5.zw = -r11.xy / r0.yy;
    r0.yw = r0.ww ? r5.zw : 0;
    r1.xy = float2(-0.5,-0.5) + r1.xy;
    r2.w = 9.99999975e-06 + layerDepth;
    r0.yw = r2.ww * r0.yw;
    r0.yw = scaleUVs.xy * r0.yw;
    r0.yw = r1.xy * scaleUVs.xy + r0.yw;
    r0.yw = offsetUVs.xy * scaleUVs.xy + r0.yw;
    ...
    r10.y = r10.x;
    r10.z = r1.x;
    r11.x = dot(r10.yz, r0.yw);
    r10.x = -r1.x;
    r11.y = dot(r10.xy, r0.yw);
    r0.yw = gameTime.ww * scrollUVs.xy;
    r0.yw = r0.yw * scaleUVs.xy + r11.xy;
    ...
    r1.xy = saturate(r0.yw);
    r9.xy = clampU ? r1.xy : r0.yw;
  }
  r0.y = dot(-v7.xyz, -v7.xyz);
  r0.y = rsqrt(r0.y);
  r10.xyz = -v7.xyz * r0.yyy;
  r0.w = saturate(dot(r10.xyz, r4.xyz));
  r4.xyzw = emissiveMap.Sample(colorSampler_s, r9.xy).xyzw;
  ...
  r0.x = frac(r0.x);
  r1.y = gameTime.w * flickerSpeed + r0.x;
  r1.x = flickerSeed.x;
  r0.x = flickerLookupMap.SampleLevel(lookupSampler_s, r1.xy, 0).x;
  r0.x = log2(abs(r0.x));
  r0.x = flickerPower * r0.x;
  r0.x = exp2(r0.x);
  r0.w = flickerRange.y + -flickerRange.x;
  r0.x = r0.x * r0.w + flickerRange.x;
  r4.xyz = r4.xyz * r0.xxx;
  r0.x = cmp(isDepthHack != 0);
  r1.xy = (uint2)r1.zw;
  r0.w = dot(r1.yx, float2(0.0671105608,0.00583714992));
  r0.w = frac(r0.w);
  r0.w = 52.9829178 * r0.w;
  r0.w = frac(r0.w);
  r0.w = r0.w * 6.28318548 + gameTick.w;
  sincos(r0.w, r9.x, r11.x);
  r0.w = dot(r1.xy, float2(0.0671105608,0.00583714992));
  r0.w = frac(r0.w);
  r0.w = 52.9829178 * r0.w;
  r0.w = frac(r0.w);
  r0.w = r0.w * 6.28318548 + gameTick.w;
  sincos(r0.w, r1.x, r12.x);
  r5.x = saturate(dot(r3.xyz, r10.xyz));
  r0.w = dot(-r10.xyz, r3.xyz);
  r0.w = r0.w + r0.w;
  r13.xyz = r3.xyz * -r0.www + -r10.xyz;
  r0.w = 17 * r5.y;
  r0.w = exp2(r0.w);
  r0.w = 2 + r0.w;
  r0.w = 2 / r0.w;
  ...
  r2.w = 100 * r2.w;
  r5.zw = -r1.zz * float2(10,5) + float2(6.85740995,7.08500004);
  r4.w = exp2(r5.z);
  r4.w = r5.x * r4.w;
  r4.w = 9.1368103 * r4.w;
  r5.z = r1.w * r1.z;
  ...
  while (true) {
    ...
    r11.w = cmp((int)r5.w == (int)r9.w);
    bitmask.y = ((~(-1 << r6.w)) << 0) & 0xffffffff;  r12.y = (((uint)0 << 0) & bitmask.y) | ((uint)r10.w & ~bitmask.y);
    r10.w = r11.w ? r12.y : r10.w;
    r11.w = cmp((int)r8.w == (int)r9.w);
    if (r9.z == 0) r12.y = 0; else if (r9.z+0 < 32) {     r12.y = (uint)r10.w << (32-(r9.z + 0)); r12.y = (uint)r12.y >> (32-r9.z);    } else r12.y = (uint)r10.w >> 0;
    r10.w = r11.w ? r12.y : r10.w;
    r11.w = (int)r9.w + numLights;
    r23.xyzw = r21.xyzw;
    r24.xyz = r22.yzw;
    r12.y = r10.w;
    while (true) {
      ...
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=80)(mixed,mixed,mixed,mixed) r25.xyzw, r12.w, l(0), t11.xyzw
      r25.x = samp0[]..swiz;
      r25.y = samp0[]..swiz;
      r25.z = samp0[]..swiz;
      r25.w = samp0[]..swiz;
      ...
      r15.y = samp0[]..swiz;
        ...
        r12.w = r15.z ? r12.w : 0;
        if (r12.w != 0) {
          r12.z = (int)r9.w + (int)r12.z;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r25.xyzw, r12.z, l(0), t15.wxyz
        r25.x = samp0[]..swiz;
        r25.y = samp0[]..swiz;
        r25.z = samp0[]..swiz;
        r25.w = samp0[]..swiz;
        ...
        r14.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r26.xyzw, r12.z, l(116), t15.zwxy
        r26.x = samp0[]..swiz;
        r26.y = samp0[]..swiz;
        r26.z = samp0[]..swiz;
        r26.w = samp0[]..swiz;
          r15.xyz = v7.xyz + -r25.yzw;
          r12.w = (int)r26.w & 0x0000ffff;
        ...
        r32.w = samp0[]..swiz;
          ...
          r38.y = samp0[]..swiz;
            ...
            r34.z = r35.z;
            r14.z = dot(r13.xyz, r34.xyz);
            r14.w = dot(r15.xyz, r34.xyz);
            r14.w = r14.w + -r35.w;
            r16.x = cmp(r14.w >= 0);
            r14.w = max(abs(r14.w), r2.w);
            r14.w = r16.x ? r14.w : -r14.w;
            ...
            r12.w = min(abs(r14.z), r12.w);
            r35.z = r36.z;
            r14.z = dot(r13.xyz, r35.xyz);
            r14.w = dot(r15.xyz, r35.xyz);
            r14.w = r14.w + -r36.w;
            r16.x = cmp(r14.w >= 0);
            r14.w = max(abs(r14.w), r2.w);
            r14.w = r16.x ? r14.w : -r14.w;
            ...
            r12.w = min(abs(r14.z), r12.w);
            r38.zw = r37.zw;
            r14.z = dot(r13.zxy, r38.xzw);
            r14.w = dot(r15.zxy, r38.xzw);
            r14.w = r14.w + -r38.y;
            r16.x = cmp(r14.w >= 0);
            r14.w = max(abs(r14.w), r2.w);
            r14.w = r16.x ? r14.w : -r14.w;
            ...
            r18.yzw = r13.xyz * r12.www + r18.yzw;
            ...
            if (9 == 0) r14.z = 0; else if (9+16 < 32) {             r14.z = (uint)r26.w << (32-(9 + 16)); r14.z = (uint)r14.z >> (32-9);            } else r14.z = (uint)r26.w >> 16;
            r33.w = (uint)r14.z;
            r18.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r33.xyzw, r12.w).xyz;
            ...
            r14.z = r12.w * r4.w;
            r15.xyz = r18.yzw * r12.zzz;
            r12.z = dot(r15.xyz, float3(0.212599993,0.715200007,0.0722000003));
            r12.z = r4.w * r12.w + r12.z;
            r12.z = r14.z / r12.z;
            r25.x = r23.w;
            r25.yz = r24.xy;
            r24.xyw = r15.yzx * r12.zzz + r25.yzx;
            r23.w = r24.w;
          }
        }
      }
  ...
  if (r8.w != 0) {
    ...
    r9.z = 0;
    while (true) {
      r9.w = cmp((uint)r9.z >= (uint)r5.z);
      if (r9.w != 0) break;
      r14.z = (uint)r9.z >> 5;
      r15.xyz = (int3)r8.xyz + (int3)r14.xyz;
      r9.w = visibleProbes.Load(r15.xyzw).x;
      r10.w = cmp((int)r5.w == (int)r9.z);
      if (r6.w == 0) r11.w = 0; else if (r6.w+0 < 32) {       r11.w = (uint)r9.w << (32-(r6.w + 0)); r11.w = (uint)r11.w >> (32-r6.w);      } else r11.w = (uint)r9.w >> 0;
      r9.w = r10.w ? r11.w : r9.w;
        ...
        r26.y = samp0[]..swiz;
          ...
          r33.w = samp0[]..swiz;
            ...
            r35.w = samp0[]..swiz;
              ...
              r20.w = -r20.w * r25.w + 1;
              r20.w = r29.y * r20.w;
              r18.y = r28.w ? r20.w : r29.z;
              r29.xy = r28.zz ? r29.xy : r18.xy;
              r19.w = (int)r19.w + 1;
              r16.x = r27.w;
            }
            r16.x = saturate(r29.y + -r11.w);
            r16.w = r16.x * r18.w;
            r17.w = cmp(0 < r16.w);
            if (r17.w != 0) {
            // Known bad code for instruction (needs manual fix):
  ...
  r12.yzw = r21.xyz * r1.zzz;
  r14.xyz = r22.xyz * r1.zzz;
  r2.w = cmp(r22.w < 0.99000001);
  if (r2.w != 0) {
    r2.w = 1 + -r22.w;
    ...
    r12.yzw = r21.xyz * r1.zzz + r15.xyz;
    r13.w = 0;
    r15.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r13.xyzw, r1.w).xyz;
    r1.z = sunConstants.globalProbeExposure * r2.w + -r3.w;
    r1.z = r5.y * r1.z + r3.w;
    r14.xyz = r15.xyz * r1.zzz + r14.xyz;
  }
  r1.z = r5.x + r0.z;
  r1.z = log2(abs(r1.z));
  r1.z = r1.y * r1.z;
  ...
  r12.yzw = r14.xyz * r1.zzz;
  r14.xyz = r12.zwy * r5.yyy;
  r5.yzw = r12.yzw * r5.zzz;
  r0.z = sqrt(r1.y);
  r0.z = r0.z * 0.5 + 0.5;
  r0.z = r0.z * r0.z;
  r1.z = 0.5 * r0.z;
  ...
  r0.z = r1.w * r0.z;
  r1.z = r1.z * r1.w;
  r1.w = dot(r3.xyz, sunConstants.wldDir.xyz);
  r2.w = saturate(r1.w);
  r3.w = cmp(0 >= r2.w);
  if (r3.w != 0) {
    r4.w = 0;
  ...
  if (r3.w == 0) {
    ...
    r3.w = -sunConstants.splitDepthOffset + r12.w;
    ...
    if (r6.w != 0) {
      ...
      while (true) {
        ...
        if (r9.z != 0) break;
        r9.z = (uint)r6.w;
        r16.xy = -sunConstants.splitPinTransform[r9.z].xy + r12.yz;
        r9.w = max(abs(r16.x), abs(r16.y));
        r8.w = sunConstants.splitPinTransform[r9.z].z * r9.w;
        r9.z = cmp(r8.w < 1);
        if (r9.z != 0) {
          break;
        }
    ...
    r10.w = samp0[]..swiz;
      ...
      r10.w = samp0[]..swiz;
        r10.w = r18.y ? r17.z : r10.w;
        r11.w = (uint)r10.w >> 13;
        r10.w = r18.x ? r11.w : r10.w;
      ...
      r19.w = samp0[]..swiz;
        ...
        if (r9.w == 0) {
          r9.w = (int)-r17.y + 6;
          r18.xy = (uint2)r16.zy >> (uint2)r9.ww;
          r9.w = (int)r17.z | 0x40000000;
          bitmask.w = ((~(-1 << 1)) << 1) & 0xffffffff;  r10.w = (((uint)r18.y << 1) & bitmask.w) | ((uint)0 & ~bitmask.w);
          bitmask.w = ((~(-1 << 1)) << 0) & 0xffffffff;  r10.w = (((uint)r18.x << 0) & bitmask.w) | ((uint)r10.w & ~bitmask.w);
          r10.w = (int)r10.w * 10;
        ...
        r19.z = samp0[]..swiz;
          ...
          r10.w = (int)-r19.y + 6;
          r17.yw = (uint2)r16.zy >> (uint2)r10.ww;
          r10.w = (int)r19.z & 0xc0000000;
          r11.w = (int)r19.z | 0x40000000;
          bitmask.w = ((~(-1 << 1)) << 1) & 0xffffffff;  r16.w = (((uint)r17.w << 1) & bitmask.w) | ((uint)0 & ~bitmask.w);
          bitmask.w = ((~(-1 << 1)) << 0) & 0xffffffff;  r16.w = (((uint)r17.y << 0) & bitmask.w) | ((uint)r16.w & ~bitmask.w);
          r16.w = (int)r16.w * 10;
          r11.w = (uint)r11.w >> (uint)r16.w;
          r11.w = (int)r11.w & 1023;
          r20.x = (int)r11.w + (int)r19.x;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r20.y, r20.x, l(0), t23.xxxx
        r20.y = samp0[]..swiz;
          r17.yw = r10.ww ? r19.xz : r20.xy;
          r17.xz = r9.ww ? r18.xw : r17.yw;
        }
        r9.w = (int)r17.z & 0xc0000000;
        if (r9.w == 0) {
        ...
        r16.w = samp0[]..swiz;
          ...
          r16.x = (uint)r16.x;
          r16.x = r16.x * r11.w;
          r16.x = r16.x * 0.00392156886 + r10.w;
          r16.y = (int)r18.y + 1;
        ...
        r16.y = samp0[]..swiz;
          ...
          r13.w = r17.w ? r16.x : r10.w;
        } else {
          r10.w = (int)r17.z & 0x80000000;
          r11.w = (int)r17.x + 1;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r11.w, r11.w, l(0), t23.xxxx
        r11.w = samp0[]..swiz;
          ...
          r11.w = r12.y * r16.x + r11.w;
          r10.w = r12.z * r10.w + r11.w;
          r13.w = r9.w ? r10.w : r13.w;
        }
      }
      r9.w = -sunConstants.sstLightingConstants.constants.inchesPerTexel * 2 + r12.w;
      r9.w = cmp(r13.w < r9.w);
      r4.w = r9.w ? 0 : 1;
    }
    if (r9.z == 0) {
      if (enableDitheredShadow == 0) {
        r9.z = (uint)r6.w;
        r16.xy = -sunConstants.splitPinTransform[r9.z].xy + r12.yz;
        r9.zw = sunConstants.splitPinTransform[r9.z].zz * r16.xy;
        r16.xy = r9.zw * float2(0.5,-0.5) + float2(0.5,0.5);
        r9.z = (int16)sunConstants.splitArrayOffset;
        r16.z = r9.z + r6.w;
        r9.z = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r3.w).x;
      ...
      if (enableDitheredShadow != 0) {
        ...
        r8.w = 28 * r8.w;
        r8.w = (uint)r8.w;
        r17.xy = -sunConstants.splitPinTransform[r9.z].xy + r12.yz;
        r17.xy = sunConstants.splitPinTransform[r9.z].zz * r17.xy;
        ...
        while (true) {
          ...
          if (r11.w != 0) break;
          r11.w = cmp((uint)r8.w < (uint)r10.w);
          r17.zw = r11.ww ? r12.yz : r17.xy;
          r12.w = r11.w ? sunConstants.splitPinTransform[r6.w].w : sunConstants.splitPinTransform[r9.z].w;
          r11.w = r11.w ? r6.w : r9.z;
          r18.x = dot(icb[r10.w+0].yx, r16.xy);
          r18.y = dot(icb[r10.w+0].yx, r16.yz);
          r18.xy = r18.xy * r12.ww + r17.zw;
  ...
  if (r3.w != 0) {
    r3.w = cmp(0 < r4.w);
    if (r3.w != 0) {
      r3.w = sunConstants.specScale * r0.w;
      r3.w = r3.w * r2.w;
      if (sunConstants.sunCookieIndex != 0) {
        r7.w = 1;
        r6.w = dot(sunConstants.sunCookieTransform[0].xyzw, r7.xyzw);
        ...
        r12.z = samp0[]..swiz;
          ...
          if (enableDitheredShadow != 0) {
            ...
            while (true) {
              ...
              r10.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r18.xyz, r6.w).x;
              r9.z = r10.w * 0.125 + r9.z;
              r9.w = (int)r9.w + 1;
            }
          } else {
            r16.z = (uint)r8.w;
            r9.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r6.w).x;
          }
          r6.w = r9.z * r9.z;
          r6.w = r6.w * r9.z;
        } else {
      ...
      r6.w = r6.w * r4.w;
      r1.w = cmp(0 < r1.w);
      r16.xyz = r6.www * r7.xyz + r15.xyz;
      r12.yzw = -v7.xyz * r0.yyy + sunConstants.wldDir.xyz;
      r0.y = dot(r12.yzw, r12.yzw);
      r0.y = rsqrt(r0.y);
      r12.yzw = r12.yzw * r0.yyy;
      r0.y = dot(r12.yzw, r10.xyz);
      r6.w = dot(r3.xyz, r12.yzw);
      r7.w = abs(r6.w) * r0.w + -abs(r6.w);
      ...
      r2.w = r4.w * r2.w;
      r2.w = 0.25 * r2.w;
      r12.yzw = r2.www * r7.xyz + r5.yzw;
      r0.y = saturate(1 + -r0.y);
      r3.w = r0.y * r0.y;
      r3.w = r3.w * r3.w;
      r0.y = r3.w * r0.y;
      r0.y = r2.w * r0.y;
      r7.xyz = r0.yyy * r7.yzx + r14.xyz;
      r16.w = r7.z;
      r15.w = r14.z;
      r15.xyzw = r1.wwww ? r16.xyzw : r15.xyzw;
      r7.zw = r12.yz;
      r14.zw = r5.yz;
      r7.xyzw = r1.wwww ? r7.xyzw : r14.xyzw;
      r5.w = r1.w ? r12.w : r5.w;
      r14.z = r15.w;
      r14.xy = r7.xy;
      r5.yz = r7.zw;
    }
  ...
  while (true) {
    ...
    r4.w = visibleLights.Load(r17.xyzw).x;
    r17.xyz = r12.yzw;
    r30.xyz = r28.xyz;
    r31.xyz = r29.xyz;
    r5.x = r2.w;
    ...
    while (true) {
      ...
      r33.y = samp0[]..swiz;
        ...
        r38.z = samp0[]..swiz;
        r38.w = samp0[]..swiz;
          if (3 == 0) r9.z = 0; else if (3+24 < 32) {           r9.z = (uint)r33.w << (32-(3 + 24)); r9.z = (uint)r9.z >> (32-3);          } else r9.z = (uint)r33.w >> 24;
          switch (r9.z) {
            case 4 :            r9.z = cmp(0 < r38.x);
            r39.xy = r37.zw;
            r39.z = r38.w;
            ...
            if (r15.w != 0) {
              ...
              r11.w = r16.z / r11.w;
              r11.w = min(1, r11.w);
              r16.zw = saturate(r15.ww * r34.xz + r34.yw);
              ...
              if (r15.w != 0) {
                ...
                if (r15.w != 0) {
                  ...
                  r42.xyz = r3.xyz * r15.www + v7.xyz;
                  r42.xyz = r42.xyz + -r36.xyz;
                  r15.w = max(abs(r42.y), abs(r42.z));
                  r15.w = max(abs(r42.x), r15.w);
                  r15.w = r37.x / r15.w;
                  r15.w = r15.w + r37.y;
                  r16.z = dot(r42.xyz, r42.xyz);
                  r16.z = rsqrt(r16.z);
                  r15.w = max(6.10351563e-05, r15.w);
                  r16.w = (int)r33.w & 0x0000ffff;
                  r43.w = (uint)r16.w;
                  r16.w = 0;
                  r21.w = 0;
                  while (true) {
                    ...
                    if (r25.w != 0) break;
                    r44.y = dot(icb[r21.w+0].yx, r7.xy);
                    r44.z = dot(icb[r21.w+0].yx, r7.yz);
                    r44.yz = r44.yz * r35.yy;
                    r44.x = r44.y * r12.x;
                    r44.w = r44.y * r1.x;
                    r43.xyz = r42.xyz * r16.zzz + r44.xzw;
                    r25.w = gOmniShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r43.xyzw, r15.w).x;
                ...
                if (r15.w != 0) {
                  r15.w = r33.x * r0.w;
                  r15.w = 0.25 * r15.w;
                  r16.z = dot(r39.xyz, r13.xyz);
                  r21.w = dot(r13.xyz, r41.xyz);
                  r25.w = -r16.z * r16.z + r38.x;
                  r9.w = r16.z * r21.w + -r9.w;
                  r9.w = saturate(r9.w / r25.w);
                  r16.z = r25.w / r38.x;
                  r16.z = 10 * r16.z;
                  r16.z = min(1, r16.z);
                  r9.w = r9.w + -r10.w;
                  r9.w = r16.z * r9.w + r10.w;
                  r39.xyz = r9.www * r39.xyz + r40.xyz;
                  r39.xyz = r9.zzz ? r39.xyz : r32.yzw;
                  r39.xyz = -v7.xyz + r39.xyz;
                  r9.z = dot(r39.xyz, r39.xyz);
                  r9.z = rsqrt(r9.z);
                  r40.xyz = r39.xyz * r9.zzz;
                  ...
                  r42.w = samp0[]..swiz;
                    ...
                    r19.xyz = r3.xyz * r16.zzz + v7.xyz;
                    r16.z = dot(r41.xyzw, r19.xyzw);
                    r21.w = dot(r42.xyzw, r19.xyzw);
                    r25.w = cmp(r21.w < r16.z);
                    if (r25.w == 0) {
                    // Known bad code for instruction (needs manual fix):
                    ...
                    r45.y = samp0[]..swiz;
                      ...
                      r19.x = r45.y * r21.w;
                      r16.z = r45.x * r21.w + r16.z;
                      r16.z = r16.z / r19.x;
                    } else {
                      r19.z = -1;
                    }
                    r19.x = (int)r25.w | (int)r19.z;
                    if (r19.x == 0) {
                    // Known bad code for instruction (needs manual fix):
                    ...
                    r9.w = samp0[]..swiz;
                      ...
                      if (r5.x != 0) {
                        ...
                        while (true) {
                          ...
                          if (r26.w != 0) break;
                          r42.x = dot(icb[r25.w+0].yx, r7.xw);
                          r42.y = dot(icb[r25.w+0].xy, r9.xy);
                          r19.xy = r42.xy * r10.ww + r41.xy;
                          r19.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r19.xyz, r16.z).x;
                          r21.w = r19.x * 0.125 + r21.w;
                          r25.w = (int)r25.w + 1;
                        }
                      } else {
                        r41.z = (uint)r9.w;
                        r21.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r41.xyz, r16.z).x;
                      }
                      r9.w = r21.w * r21.w;
                      r9.w = r9.w * r21.w;
                    } else {
                    ...
                    r42.w = samp0[]..swiz;
                      r16.z = abs(r13.w) * -0.200000003 + 0.400000006;
                      r20.xyz = r3.xyz * r16.zzz + v7.xyz;
                      r16.z = dot(r41.xyzw, r20.xyzw);
                      r19.x = dot(r42.xyzw, r20.xyzw);
                      r19.y = cmp(r19.x < r16.z);
                      if (r19.y == 0) {
                      // Known bad code for instruction (needs manual fix):
                                            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r41.xyzw, r9.w, l(68), t12.xyzw
                      r41.x = samp0[]..swiz;
                      ...
                      r9.w = samp0[]..swiz;
                        ...
                        if (r5.x != 0) {
                          ...
                          while (true) {
                            ...
                            if (r27.w != 0) break;
                            r41.x = dot(icb[r26.w+0].xy, r11.xy);
                            r41.y = dot(icb[r26.w+0].yx, r11.xz);
                            r19.xy = r41.xy * r10.ww + r20.xy;
                            r19.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r19.xyz, r16.z).x;
                          ...
                          r20.z = (uint)r9.w;
                          r25.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r20.xyz, r16.z).x;
                        }
                        r9.w = r25.w * r25.w;
                        r9.w = r9.w * r25.w;
                      } else {
                  ...
                  r9.w = r9.w + -r14.w;
                  r9.w = r1.y * r9.w + r14.w;
                  r9.w = r9.w * r11.w;
                  r33.x = r32.x;
                  r10.w = cmp(0 < r13.w);
                  r19.xyz = r9.www * r33.xyz + r17.xyz;
                  r9.w = saturate(dot(r3.xyz, r40.xyz));
                  r20.xyz = r39.xyz * r9.zzz + r10.xyz;
                  r9.z = dot(r20.xyz, r20.xyz);
                  r9.z = rsqrt(r9.z);
                  r20.xyz = r20.xyz * r9.zzz;
                  r9.z = dot(r20.xyz, r10.xyz);
                  r13.w = dot(r3.xyz, r20.xyz);
                  r14.w = abs(r13.w) * r0.w + -abs(r13.w);
                  r13.w = abs(r13.w) * r14.w + 1;
                  r14.w = r9.w * r0.z + r1.z;
                  r13.w = r13.w * r13.w;
                  r13.w = r13.w * r14.w;
                  r13.w = rcp(r13.w);
                  r9.w = r9.w * r15.w;
                  ...
                  r9.z = r11.w * r9.z;
                  r9.z = r9.w * r9.z;
                  r39.xyz = r9.zzz * r33.xyz + r30.xyz;
                  r17.xyz = r10.www ? r19.xyz : r17.xyz;
                  r30.xyz = r10.www ? r39.xyz : r30.xyz;
            ...
            r9.z = dot(r19.xyz, r19.xyz);
            r9.z = rsqrt(r9.z);
            r20.xyz = r19.xyz * r9.zzz;
            r9.w = dot(r3.xyz, r20.xyz);
            r10.w = saturate(r9.w);
            r11.w = cmp(0 < r10.w);
            if (r11.w != 0) {
            // Known bad code for instruction (needs manual fix):
            ...
            r40.w = samp0[]..swiz;
              ...
              r14.w = samp0[]..swiz;
                r45.xyz = -v7.xyz + r32.yzw;
                r15.w = r35.x * r35.x;
                r16.z = dot(r45.xyz, r45.xyz);
                r15.w = r15.w / r16.z;
                r15.w = min(1, r15.w);
                r34.xy = saturate(r11.ww * r34.xz + r34.yw);
              ...
              r11.w = cmp(0 < r13.w);
              if (r11.w != 0) {
                if (3 == 0) r11.w = 0; else if (3+27 < 32) {                 r11.w = (uint)r33.w << (32-(3 + 27)); r11.w = (uint)r11.w >> (32-3);                } else r11.w = (uint)r33.w >> 27;
                r11.w = cmp((int)r11.w != 1);
                if (r11.w != 0) {
                  r11.w = abs(r9.w) * -0.200000003 + 0.400000006;
                  r22.xyz = r3.xyz * r11.www + v7.xyz;
                  r39.xyz = r38.xyz;
                  r11.w = dot(r39.xyzw, r22.xyzw);
                  r14.w = dot(r41.xyzw, r22.xyzw);
                  r15.w = cmp(r14.w >= r11.w);
                  if (r15.w != 0) {
                  // Known bad code for instruction (needs manual fix):
                  ...
                  r40.y = samp0[]..swiz;
                    ...
                    r22.xy = r21.xy * r40.zw + r40.xy;
                    r8.w = r11.w / r14.w;
                    r8.w = max(6.10351563e-05, r8.w);
                    r11.w = (int)r33.w & 0x0000ffff;
                    if (r5.x != 0) {
                      r32.z = (uint)r11.w;
                      r14.w = 0;
                      r15.w = 0;
                      while (true) {
                        r16.z = cmp((int)r15.w >= 8);
                        if (r16.z != 0) break;
                        r21.x = dot(icb[r15.w+0].xy, r25.xy);
                        r21.y = dot(icb[r15.w+0].yx, r25.xz);
                        r32.xy = r21.xy * r35.yy + r22.xy;
                        r16.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r32.xyz, r8.w).x;
                        r14.w = r16.z * 0.125 + r14.w;
                        r15.w = (int)r15.w + 1;
                      }
                    } else {
                      r22.z = (uint)r11.w;
                ...
                if (r11.w != 0) {
                  ...
                  r38.w = samp0[]..swiz;
                    ...
                    r23.y = samp0[]..swiz;
                      ...
                      r13.w = r23.y * r22.x;
                      r16.z = r23.x * r22.x + r16.z;
                      r13.w = r16.z / r13.w;
                      r13.w = max(6.10351563e-05, r13.w);
                      r16.z = r22.y ? 0.000000 : 0;
                      if (r5.x != 0) {
                        r22.z = (uint)r16.z;
                        r21.xy = float2(0,0);
                        while (true) {
                    ...
                    r37.w = samp0[]..swiz;
                      ...
                      r23.y = samp0[]..swiz;
                        ...
                        r13.w = r23.y * r21.y;
                        r16.z = r23.x * r21.y + r16.z;
                        r13.w = r16.z / r13.w;
                        r13.w = max(6.10351563e-05, r13.w);
                        r16.z = r22.z ? 0.000000 : 0;
                        if (r5.x != 0) {
                          r22.z = (uint)r16.z;
                          r21.y = 0;
                          r23.x = 0;
                  ...
                  r13.w = r13.w + -r10.w;
                  r13.w = r1.y * r13.w + r10.w;
                  r13.w = r13.w * r8.w;
                  r9.w = cmp(0 < r9.w);
                  r22.xyz = r13.www * r20.xyz + r17.xyz;
                  r19.xyz = r19.xyz * r9.zzz + r10.xyz;
                  r9.z = dot(r19.xyz, r19.xyz);
                  r9.z = rsqrt(r9.z);
                  r19.xyz = r19.xyz * r9.zzz;
                  r9.z = dot(r19.xyz, r10.xyz);
                  r13.w = dot(r3.xyz, r19.xyz);
                  r15.w = abs(r13.w) * r0.w + -abs(r13.w);
                  r13.w = abs(r13.w) * r15.w + 1;
                  r10.w = r10.w * r0.z + r1.z;
                  r13.w = r13.w * r13.w;
                  r10.w = r13.w * r10.w;
                  r10.w = rcp(r10.w);
                  r10.w = r10.w * r11.w;
                  r8.w = r10.w * r8.w;
                  r8.w = 0.25 * r8.w;
                  r19.xyz = r8.www * r20.xyz + r31.xyz;
                  r9.z = saturate(1 + -r9.z);
                  r10.w = r9.z * r9.z;
                  r10.w = r10.w * r10.w;
                  r9.z = r10.w * r9.z;
