...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  if (r1.w != 0) {
    ...
    r10.x = dot(r2.yzw, v5.xyz);
    r10.y = dot(r2.yzw, v6.xyz);
    ...
    r11.y = r11.x;
    r11.z = r10.x;
    r12.x = dot(r11.yz, r2.yz);
    r11.x = -r10.x;
    r12.y = dot(r11.xy, r2.yz);
    r2.yz = gameTime.ww * scrollUVs.xy;
    r2.yz = r2.yz * scaleUVs.xy + r12.xy;
  ...
  r11.z = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r29.xyzw, r9.w, l(116), t15.xyzw
  r29.x = samp0[]..swiz;
  r29.y = samp0[]..swiz;
  r29.z = samp0[]..swiz;
  r29.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r30.xyzw, r9.w, l(132), t15.zwxy
  r30.x = samp0[]..swiz;
  r30.y = samp0[]..swiz;
  r30.z = samp0[]..swiz;
  r30.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r31.xyzw, r9.w, l(148), t15.zwxy
  r31.x = samp0[]..swiz;
  r31.y = samp0[]..swiz;
  r31.z = samp0[]..swiz;
  r31.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r32.xyzw, r9.w, l(164), t15.zwxy
  r32.x = samp0[]..swiz;
  r32.y = samp0[]..swiz;
  r32.z = samp0[]..swiz;
  r32.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r33.xyzw, r9.w, l(180), t15.zwxy
  r33.x = samp0[]..swiz;
  r33.y = samp0[]..swiz;
  r33.z = samp0[]..swiz;
  r33.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r34.xyzw, r9.w, l(196), t15.xyzw
  r34.x = samp0[]..swiz;
  r34.y = samp0[]..swiz;
  r34.z = samp0[]..swiz;
  r34.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r35.xy, r9.w, l(212), t15.xyxx
  r35.x = samp0[]..swiz;
  r35.y = samp0[]..swiz;
  ...
  r41.w = samp0[]..swiz;
    ...
    r31.x = dot(r5.xyz, r23.xyz);
    r31.y = dot(r5.xyz, r32.xyz);
    r31.z = dot(r5.xyz, r25.xyz);
  ...
  if (r9.z == 0) {
    ...
    if (r11.y != 0) {
      ...
      r12.z = 0;
      while (true) {
        r12.w = cmp((uint)r12.z >= (uint)r9.z);
        if (r12.w != 0) break;
        r14.z = (uint)r12.z >> 5;
        r15.xyz = (int3)r8.xyz + (int3)r14.xyz;
        r12.w = visibleProbes.Load(r15.xyzw).x;
        r14.z = cmp((int)r9.w == (int)r12.z);
    ...
    if (r6.w != 0) {
      ...
      r12.yzw = cmp(float3(0,0,0) < r5.xyz);
      ...
      r5.w = 0;
      r12.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r5.xyzw, 6).xyz;
      r11.yzw = r12.yzw * r11.yzw;
      r5.w = dot(r11.yzw, float3(0.212599993,0.715200007,0.0722000003));
      r21.xyz = r23.xyz * r3.www + r11.yzw;
      r13.w = 0;
      r11.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r13.xyzw, r6.z).xyz;
  ...
  r11.yzw = r22.xyz * r3.www;
  r15.xyz = r11.zwy * r6.yyy;
  r6.yzw = r11.yzw * r6.zzz;
  r2.x = sqrt(r3.z);
  r2.x = r2.x * 0.5 + 0.5;
  r2.x = r2.x * r2.x;
  r3.w = 0.5 * r2.x;
    ...
    if (r12.z == 0) {
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          r18.z = (uint)r17.x;
          r17.x = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r18.xyz, r9.z).x;
  ...
  if (r9.z != 0) {
    r9.z = cmp(0 < r9.w);
    if (r9.z != 0) {
      r9.z = sunConstants.specScale * r3.y;
      r9.z = r9.z * r8.w;
      if (sunConstants.sunCookieIndex != 0) {
        r7.w = 1;
        r10.w = dot(sunConstants.sunCookieTransform[0].xyzw, r7.xyzw);
      ...
      r19.w = samp0[]..swiz;
        ...
        r12.z = samp0[]..swiz;
          ...
          if (enableDitheredShadow != 0) {
            ...
            r16.z = (uint)r11.y;
            r11.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r7.w).x;
          }
          r7.w = r11.z * r11.z;
          r7.w = r7.w * r11.z;
        } else {
      ...
      r7.w = r9.w * r7.w;
      r7.w = 0.25 * r7.w;
      r11.yzw = r7.www * r7.xyz + r6.yzw;
      r1.w = saturate(1 + -r1.w);
      r8.w = r1.w * r1.w;
      r8.w = r8.w * r8.w;
      r1.w = r8.w * r1.w;
      r1.w = r7.w * r1.w;
      r7.xyz = r1.www * r7.yzx + r15.xyz;
      r16.w = r7.z;
      r14.w = r15.z;
                    ...
                    r15.w = samp0[]..swiz;
                      ...
                      if (r9.w != 0) {
                        ...
                        while (true) {
                          ...
                          r42.y = dot(icb[r19.z+0].xy, r9.xy);
