...
mad r0.w, cb1[62].x, r1.z, cb0[11].x
...
if_nz r1.z
  ...
  movc r2.xyz, r1.wwww, r5.xywx, r6.xyzx
endif 
...
mad r3.xyz, r3.xyzx, r0.xxxx, r13.xyzx
dp3 r0.w, r3.xyzx, r3.xyzx
rsq r0.w, r0.w
mul r3.xyz, r0.wwww, r3.xyzx
mad r6.y, r0.y, r0.x, r5.w
mad r5.xyz, r5.xyzx, r0.xxxx, r14.xyzx
...
if_nz r0.y
  ...
  round_z r0.y, r0.y
  add r0.y, r0.y, r1.x
  div r7.x, r0.y, cb0[11].w
  round_z r0.y, r0.w
  add r0.y, r0.y, r1.y
  div r7.y, r0.y, cb0[11].z
else 
  ...
  movc r7.xy, cb0[15].zwzz, r1.xyxx, r0.ywyy
endif 
dp3 r0.y, -v7.xyzx, -v7.xyzx
rsq r0.y, r0.y
mul r10.xyz, r0.yyyy, -v7.xyzx
dp3_sat r0.w, r10.xyzx, r4.xyzx
sample_indexable(texture2d)(float,float,float,float) r4.xyzw, r7.xyxx, t37.xyzw, s1
...
loop 
  ...
  dp3 r30.x, r3.xyzx, r23.xyzx
  dp3 r30.y, r3.xyzx, r31.xyzx
  dp3 r30.z, r3.xyzx, r25.xyzx
...
if_nz r3.w
  ...
  if_nz r3.w
    ...
    if_nz r7.z
      ...
      mad r20.xyz, r3.xyzx, r7.wwww, v7.xyzx
...
ret 
// Approximately 2682 instruction slots used
