...
add r3.z, cb0[14].z, l(0.000010)
mad r4.xy, r4.xyxx, r3.zzzz, v1.yzyy
...
exp r2.w, r2.w
movc r2.w, cb0[14].y, r2.w, r3.z
eq r3.z, cb0[13].x, l(0.000000)
...
loop 
  ...
  ieq r11.z, r3.w, r10.w
  bfi r11.w, r6.w, l(0), l(0), r11.y
...
max r3.z, r21.w, l(1.000000)
rcp r3.z, r3.z
mov_sat r21.w, r21.w
mul r11.yzw, r3.zzzz, r20.xxyz
mul r13.xyz, r3.zzzz, r21.xyzx
...
if_nz r3.w
  ...
  dp3 r5.z, r14.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
  mad r11.yzw, r20.xxyz, r3.zzzz, r14.xxyz
  mov r12.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r14.xyz, r12.xyzw, t8.xyzw, s2, r5.y
  mad r3.z, cb2[19].x, r3.w, -r5.z
  mad r3.z, r3.y, r3.z, r5.z
  mad r13.xyz, r14.xyzx, r3.zzzz, r13.xyzx
endif 
add r3.z, r1.w, r3.x
log r3.z, |r3.z|
mul r3.z, r2.w, r3.z
...
mul r5.yzw, r3.zzzz, r13.xxyz
mul r13.xyz, r3.yyyy, r5.zwyz
mul r3.yzw, r3.wwww, r5.yyzw
sqrt r1.w, r2.w
mad r1.w, r1.w, l(0.500000), l(0.500000)
mul r1.w, r1.w, r1.w
mul r5.y, r1.w, l(0.500000)
mad r1.w, -r1.w, l(0.500000), l(1.000000)
mad r5.z, r3.x, r1.w, r5.y
mul r1.w, r1.w, r5.z
mul r5.y, r5.z, r5.y
...
if_nz r6.z
  ...
  if_nz r6.z
    ...
    if_nz r8.w
      ...
      mad r19.xyz, r8.xyzx, r9.wwww, v6.xyzx
    ...
    mad r7.w, -r3.x, l(0.500000), l(1.000000)
    mad r7.w, -r5.w, r7.w, l(1.000000)
    mul r7.w, r7.w, r7.w
    mad r7.w, -r7.w, l(0.620000), l(0.620000)
    add r7.w, -r5.w, r7.w
    mad r7.w, r2.w, r7.w, r5.w
    mul r7.w, r6.w, r7.w
    lt r5.z, l(0.000000), r5.z
    mad r15.xyz, r7.wwww, r11.yzwy, r14.xyzx
    ...
    mad r16.xyz, r5.wwww, r11.yzwy, r3.yzwy
    add_sat r0.z, -r0.z, l(1.000000)
    mul r6.z, r0.z, r0.z
    mul r6.z, r6.z, r6.z
    mul r0.z, r0.z, r6.z
    mul r0.z, r0.z, r5.w
    mad r17.xyz, r0.zzzz, r11.zwyz, r13.xyzx
    mov r15.w, r17.z
    mov r14.w, r13.z
          ...
          if_nz r16.w
            ...
            if_nz r16.w
              ...
              if_nz r16.w
                ...
                mad r42.xyz, r8.xyzx, r16.wwww, v6.xyzx
              ...
              if_nz r16.w
                ...
                if_nz r12.w
                  ...
                  mad r19.xyz, r8.xyzx, r21.wwww, v6.xyzx
          ...
          if_nz r13.w
            ...
            if_nz r13.w
              ...
              if_nz r13.w
                ...
                mad r22.xyz, r8.xyzx, r13.wwww, v6.xyzx
              ...
              if_nz r13.w
                ...
                if_nz r16.w
                  ...
                  mad r23.xyz, r8.xyzx, r19.xxxx, v6.xyzx
                  ...
                  if_nz r16.w
                    ...
                    mad r19.x, |r10.w|, l(-0.200000), l(0.400000)
                    mad r24.xyz, r8.xyzx, r19.xxxx, v6.xyzx
...
ret 
// Approximately 2617 instruction slots used
