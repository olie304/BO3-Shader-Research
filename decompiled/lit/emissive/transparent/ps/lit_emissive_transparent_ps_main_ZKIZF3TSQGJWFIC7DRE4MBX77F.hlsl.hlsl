...
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r3.w, v3.w, l(8), t4.xxxx
r3.w = samp0[]..swiz;
  ...
  if (r6.z != 0) {
    ...
    if (r6.z != 0) {
      ...
      r11.yzw = -v7.xyz * r1.xxx + sunConstants.wldDir.xyz;
