...
sample_indexable(texture2d)(float,float,float,float) r3.xyzw, r7.xyxx, t26.xyzw, s1
...
mov r7.x, cb0[16].x
sample_l_indexable(texture2d)(float,float,float,float) r1.z, r7.xyxx, t25.yzxw, s7, l(0.000000)
log r1.z, |r1.z|
