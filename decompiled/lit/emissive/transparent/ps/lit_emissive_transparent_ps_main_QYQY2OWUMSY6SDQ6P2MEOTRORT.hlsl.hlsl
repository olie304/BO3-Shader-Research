...
r2.x = samp0[]..swiz;
  ...
  r13.z = (uint)r4.w << 4;
  r4.w = (int)r9.w & -32;
  r5.x = (int)-r4.w + (int)r9.w;
  r5.y = numRefProbes & -32;
  r10.y = (int)-r5.y + numRefProbes;
  r14.xy = float2(0,0);
  r15.w = 0;
  r16.yz = float2(0,1);
  r17.xy = float2(0,0);
  ...
  while (true) {
    ...
    r11.y = cmp((int)r4.w == (int)r10.z);
    bitmask.z = ((~(-1 << r5.x)) << 0) & 0xffffffff;  r11.z = (((uint)0 << 0) & bitmask.z) | ((uint)r10.w & ~bitmask.z);
    r10.w = r11.y ? r11.z : r10.w;
    r11.y = cmp((int)r5.y == (int)r10.z);
      ...
      r15.y = samp0[]..swiz;
        ...
        r32.w = samp0[]..swiz;
          ...
          r38.y = samp0[]..swiz;
            ...
            r33.w = (uint)r14.z;
            r18.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r33.xyzw, r13.w).xyz;
            ...
            r25.x = r23.w;
            r25.yz = r24.xy;
            r24.xyw = r15.yzx * r11.www + r25.yzx;
            r23.w = r24.w;
          }
        }
      }
  ...
  if (r5.y != 0) {
    ...
    r11.y = 0;
    while (true) {
      r11.z = cmp((uint)r11.y >= (uint)r9.w);
      if (r11.z != 0) break;
      r14.z = (uint)r11.y >> 5;
      r15.xyz = (int3)r13.xyz + (int3)r14.xyz;
      r11.z = visibleProbes.Load(r15.xyzw).x;
      r11.w = cmp((int)r4.w == (int)r11.y);
      if (r5.x == 0) r13.w = 0; else if (r5.x+0 < 32) {       r13.w = (uint)r11.z << (32-(r5.x + 0)); r13.w = (uint)r13.w >> (32-r5.x);      } else r13.w = (uint)r11.z >> 0;
  ...
  r5.xyw = r21.xyz * r4.www;
  r10.yzw = r22.xyz * r4.www;
  r6.w = cmp(r22.w < 0.99000001);
  if (r6.w != 0) {
    r6.w = 1 + -r22.w;
    r8.w = sunConstants.globalProbeExposure * r6.w;
    ...
    r14.xyz = cmp(float3(0,0,0) < r7.xyz);
    ...
    r7.w = 0;
    r14.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r7.xyzw, 6).xyz;
    r11.yzw = r14.xyz * r11.yzw;
    r7.w = dot(r11.yzw, float3(0.212599993,0.715200007,0.0722000003));
    r5.xyw = r21.xyz * r4.www + r11.yzw;
    r12.w = 0;
    r11.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r12.xyzw, r6.z).xyz;
    r4.w = sunConstants.globalProbeExposure * r6.w + -r7.w;
    r4.w = r4.y * r4.w + r7.w;
    r10.yzw = r11.yzw * r4.www + r10.yzw;
  }
  r4.w = r4.x + r3.w;
  r4.w = log2(abs(r4.w));
  r4.w = r5.z * r4.w;
