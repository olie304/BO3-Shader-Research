...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  if (r1.w != 0) {
    ...
    sincos(r1.w, r7.x, r10.x);
    r10.y = r10.x;
    r10.z = r7.x;
    r11.x = dot(r10.yz, r5.zw);
    r10.x = -r7.x;
    r11.y = dot(r10.xy, r5.zw);
    r5.zw = gameTime.ww * scrollUVs.xy;
    r5.zw = r5.zw * scaleUVs.xy + r11.xy;
