// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:34:14 2021
...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  r4.x = dot(r2.xyw, r2.xyw);
  r4.x = rsqrt(r4.x);
  r2.xyw = r4.xxx * r2.xyw;
  r4.x = glossRange.y + -glossRange.x;
  r4.x = debugGlossOverride.x * r4.x + glossRange.x;
  ...
  r0.z = debugOcclusionOverride.w * r0.z + 1;
  r5.xyz = v7.xxx ? v3.xyz : -v3.xyz;
  r0.w = dot(r5.xyz, r5.xyz);
  r0.w = rsqrt(r0.w);
  r5.xyz = r5.xyz * r0.www + -r2.xyw;
  r2.xyz = debugNormalOverride.www * r5.xyz + r2.xyw;
...
r5.z = samp0[]..swiz;
  ...
  r5.yw = (int2)r5.yy & int2(268435456,536870912);
  if (r5.y != 0) {
            ...
            r25.w = samp0[]..swiz;
              ...
              r22.w = samp0[]..swiz;
                ...
                if (r28.x != 0) {
                  ...
                  r14.w = (uint)r21.w >> 28;
                  r14.w = 1 << (int)r14.w;
                  r15.w = cmp((int)r28.x == 4);
                  if (r15.w != 0) {
                    r15.w = (int)r21.w & 4095;
                    if (12 == 0) r16.w = 0; else if (12+12 < 32) {                     r16.w = (uint)r21.w << (32-(12 + 12)); r16.w = (uint)r16.w >> (32-12);                    } else r16.w = (uint)r21.w >> 12;
                    r18.w = (int)r22.w & 1023;
                    r29.xz = (uint2)r10.ww;
                    r29.y = (uint)r14.w;
                ...
                r14.w = cmp(r21.x != 1.000000);
                r15.w = r10.w + r20.w;
                r15.w = saturate(r15.w * r21.x + -r21.x);
                r10.w = r14.w ? r15.w : r10.w;
                if (r28.y != 0) {
                  if (4 == 0) r14.w = 0; else if (4+24 < 32) {                   r14.w = (uint)r22.y << (32-(4 + 24)); r14.w = (uint)r14.w >> (32-4);                  } else r14.w = (uint)r22.y >> 24;
                  r14.w = 1 << (int)r14.w;
                  r15.w = (uint)r22.y >> 28;
                  r15.w = 1 << (int)r15.w;
                  r16.w = cmp((int)r28.y == 2);
                  if (r16.w != 0) {
                    ...
                    r16.w = materialTexMask.SampleGrad(samplerLinearClamp_s, r30.xyz, r28.x, r29.x).x;
                  } else {
                    r18.w = cmp((int)r28.y == 4);
                    if (r18.w != 0) {
                ...
                if (r21.x != 0) {
                  ...
                  r8.w = samp0[]..swiz;
                    ...
                    r29.xyz = r32.xyz * r29.xyz;
                    r8.w = materialTexMask.SampleGrad(samplerLinearClamp_s, r30.xyz, r31.x, r29.x).x;
                  } else {
                    r14.w = cmp((int)r21.x == 6);
                    r8.w = r14.w ? 0 : 1;
                  }
                } else {
                  r8.w = 1;
                ...
                if (r21.y != 0) {
                  ...
                  r16.w = rsqrt(r16.w);
                  r21.xyz = r26.xyz * r16.www;
                  r16.w = dot(-r25.xyz, -r25.xyz);
                  r16.w = rsqrt(r16.w);
                  r22.xyz = -r25.xyz * r16.www;
                  r23.xyz = r24.xyz * r3.xxx;
                  ...
                  r21.xyz = r23.xyz * r14.www + r21.xyz;
                  r11.z = dot(r21.xyz, r21.xyz);
                  r11.z = rsqrt(r11.z);
                  r21.xyz = r21.xyz * r11.zzz;
                  r11.z = 1 + -r10.w;
                  r18.x = r17.x;
                  r22.xyz = r18.xyz * r11.zzz;
                  r18.xyz = r21.xyz * r10.www + r22.xyz;
                  r17.x = r18.x;
                }
                r11.z = 1 + -r10.w;
                r21.xyz = r12.xyz * r11.zzz;
                r12.xyz = r20.xyz * r10.www + r21.xyz;
                r19.z = r17.y;
                r20.xyz = r19.xyz * r11.zzz;
                r19.xyz = r28.xyz * r10.www + r20.xyz;
                r11.w = r17.w * r11.z;
                r17.z = r17.z * r11.z + r10.w;
                r17.w = r8.w * r10.w + r11.w;
                r17.y = r19.z;
              }
            }
          }
  ...
  if (r5.w != 0) {
    ...
    r6.w = r4.w;
    while (true) {
      r7.w = cmp((uint)r6.w >= (uint)r2.w);
      if (r7.w != 0) break;
      r11.z = (uint)r6.w >> 5;
      r12.xyz = (int3)r10.xyz + (int3)r11.xyz;
      r7.w = visibleDecals.Load(r12.xyzw).x;
      r8.w = cmp((int)r4.w == (int)r6.w);
      bitmask.w = ((~(-1 << r5.y)) << 0) & 0xffffffff;  r10.w = (((uint)0 << 0) & bitmask.w) | ((uint)r7.w & ~bitmask.w);
      r7.w = r8.w ? r10.w : r7.w;
      r8.w = cmp((int)r5.w == (int)r6.w);
      if (r6.z == 0) r10.w = 0; else if (r6.z+0 < 32) {       r10.w = (uint)r7.w << (32-(r6.z + 0)); r10.w = (uint)r10.w >> (32-r6.z);      } else r10.w = (uint)r7.w >> 0;
      r7.w = r8.w ? r10.w : r7.w;
      r8.w = (int)r1.w + (int)r6.w;
      r12.xyz = r17.xyz;
      r21.xyz = r18.xyz;
      r22.xyz = r19.xyz;
      r11.zw = r20.xy;
      ...
      while (true) {
        ...
        r24.y = samp0[]..swiz;
          ...
          r25.z = samp0[]..swiz;
            ...
            r13.w = rsqrt(r13.w);
            r27.xyz = r26.xyz * r13.www;
            r13.w = dot(r27.xyz, v3.xyz);
            r13.w = cmp(r13.w >= 0.5);
            if (r13.w != 0) {
            // Known bad code for instruction (needs manual fix):
            ...
            r28.w = samp0[]..swiz;
              ...
              r25.w = samp0[]..swiz;
                ...
                if (r31.x != 0) {
                  if (4 == 0) r13.w = 0; else if (4+24 < 32) {                   r13.w = (uint)r24.w << (32-(4 + 24)); r13.w = (uint)r13.w >> (32-4);                  } else r13.w = (uint)r24.w >> 24;
                  r13.w = 1 << (int)r13.w;
                  r14.w = (uint)r24.w >> 28;
                  r14.w = 1 << (int)r14.w;
                  r15.w = cmp((int)r31.x == 4);
                  if (r15.w != 0) {
                    r15.w = (int)r24.w & 4095;
                    if (12 == 0) r16.w = 0; else if (12+12 < 32) {                     r16.w = (uint)r24.w << (32-(12 + 12)); r16.w = (uint)r16.w >> (32-12);                    } else r16.w = (uint)r24.w >> 12;
                    r17.w = (int)r25.w & 1023;
                    r32.xz = (uint2)r13.ww;
                    r32.y = (uint)r14.w;
                ...
                r14.w = cmp(r24.x != 1.000000);
                r15.w = r13.w + r23.w;
                r15.w = saturate(r15.w * r24.x + -r24.x);
                r13.w = r14.w ? r15.w : r13.w;
                if (r31.y != 0) {
                  if (4 == 0) r14.w = 0; else if (4+24 < 32) {                   r14.w = (uint)r25.y << (32-(4 + 24)); r14.w = (uint)r14.w >> (32-4);                  } else r14.w = (uint)r25.y >> 24;
                  r14.w = 1 << (int)r14.w;
                  r15.w = (uint)r25.y >> 28;
                  r15.w = 1 << (int)r15.w;
                  r16.w = cmp((int)r31.y == 2);
                  if (r16.w != 0) {
                    r16.w = (int)r25.y & 4095;
                    ...
                    r16.w = materialTexMask.SampleGrad(samplerLinearClamp_s, r33.xyz, r31.x, r32.x).x;
                  } else {
                    r17.w = cmp((int)r31.y == 4);
                    if (r17.w != 0) {
                      ...
                      r16.w = materialTexBC7.SampleGrad(samplerLinearClamp_s, r32.xyz, r33.x, r31.x).x;
                    } else {
                      r17.w = (int)r25.y & 4095;
                      if (12 == 0) r24.x = 0; else if (12+12 < 32) {                       r24.x = (uint)r25.y << (32-(12 + 12)); r24.x = (uint)r24.x >> (32-12);                      } else r24.x = (uint)r25.y >> 12;
                      if (10 == 0) r24.w = 0; else if (10+20 < 32) {                       r24.w = (uint)r25.w << (32-(10 + 20)); r24.w = (uint)r24.w >> (32-10);                      } else r24.w = (uint)r25.w >> 20;
                      ...
                      r31.xyz = r34.xyz * r31.xyz;
                      r16.w = materialTexBC3.SampleGrad(samplerLinearClamp_s, r32.xyz, r33.x, r31.x).x;
                    }
                  }
                  r31.xyz = r16.www * float3(0.959999979,0.959999979,0.959999979) + float3(0.0399999991,0.0399999991,0.0399999991);
                  r14.w = saturate(1 + -r16.w);
                ...
                if (r24.x != 0) {
                  ...
                  r13.z = samp0[]..swiz;
                    ...
                    r32.xyz = r35.xyz * r32.xyz;
                    r13.z = materialTexMask.SampleGrad(samplerLinearClamp_s, r33.xyz, r34.z, r32.z).x;
                  } else {
                    r14.w = cmp((int)r24.x == 6);
                    r13.z = r14.w ? 0 : 1;
                  }
                } else {
                  r13.z = 1;
                }
                r13.z = saturate(0.764705896 * r13.z);
                if (r24.y != 0) {
                  r14.w = cmp((int)r24.y == 3);
                  if (r14.w != 0) {
                  ...
                  r16.w = rsqrt(r16.w);
                  r24.xyz = r29.xyz * r16.www;
                  r16.w = dot(-r28.xyz, -r28.xyz);
                  r16.w = rsqrt(r16.w);
                  r25.xyz = -r28.xyz * r16.www;
                  r26.xyz = r27.xyz * r3.xxx;
                  r24.xyz = r24.xyz * r3.xxx;
                  ...
                  r24.xyz = r26.xyz * r14.www + r24.xyz;
                  r14.w = dot(r24.xyz, r24.xyz);
                  r14.w = rsqrt(r14.w);
                  r24.xyz = r24.xyz * r14.www;
                  r14.w = 1 + -r13.w;
                  r25.xyz = r21.xyz * r14.www;
                  r21.xyz = r24.xyz * r13.www + r25.xyz;
                }
                r14.w = 1 + -r13.w;
                r24.xyz = r14.www * r12.xyz;
                r12.xyz = r23.xyz * r13.www + r24.xyz;
                r23.xyz = r22.xyz * r14.www;
                r22.xyz = r31.xyz * r13.www + r23.xyz;
                r15.w = r14.w * r11.w;
                r11.z = r11.z * r14.w + r13.w;
                r11.w = r13.z * r13.w + r15.w;
              }
            }
          }
        }
  ...
  o0.w = r0.x * r1.w + r13.x;
  r2.xyz = r2.xyz * r1.www + r15.xyz;
  r0.x = dot(r2.xyz, r2.xyz);
  r0.x = rsqrt(r0.x);
  r2.xyz = r2.xyz * r0.xxx;
  r0.y = r0.y * r1.w + r13.y;
  r4.xyz = r4.xyz * r1.www + r16.xyz;
  r5.x = saturate(r5.x);
  r3.x = hdrScale * r5.x;
  r5.xyw = cmp(r5.zzz == float3(3,2,1));
  r4.w = cmp(r5.z < 0);
  r7.xyz = r4.www ? float3(1,1,1) : emissiveTint1.xyz;
  r7.xyz = r5.www ? tint1.xyz : r7.xyz;
  r5.yzw = r5.yyy ? tint2.xyz : r7.xyz;
  r5.xyz = r5.xxx ? tint3.xyz : r5.yzw;
  r4.w = cmp(0.5 < invertFalloff);
  if (r4.w != 0) {
    r4.w = rowCount * columnCount;
    r5.w = imageTime * r4.w;
    r6.z = gameTime.w * r5.w;
    r6.z = cmp(r6.z >= -r6.z);
    r6.z = r6.z ? r5.w : -r5.w;
    r6.w = 1 / r6.z;
    ...
    r4.w = r5.w * r4.w;
    r4.w = round(r4.w);
    r5.w = r4.w / columnCount;
    r6.z = columnCount * r4.w;
    r6.z = cmp(r6.z >= -r6.z);
    r6.z = r6.z ? columnCount : -columnCount;
    r6.w = 1 / r6.z;
    r4.w = r6.w * r4.w;
    r4.w = frac(r4.w);
    r4.w = r6.z * r4.w;
    ...
    r4.w = dot(r8.xyz, v3.xyz);
    r5.w = cmp(0 < r4.w);
    r6.zw = -r9.xy / r4.ww;
    r6.zw = r5.ww ? r6.zw : 0;
    r7.zw = float2(-0.5,-0.5) + w1.xy;
    ...
    r4.w = r4.w * r5.w + zoomUVs.x;
    r6.zw = r6.zw / r4.ww;
    r6.zw = float2(0.5,0.5) + r6.zw;
    r7.zw = saturate(r6.zw);
    r7.xy = clampU ? r7.zw : r6.zw;
  }
  r4.w = dot(-v6.xyz, -v6.xyz);
  r4.w = rsqrt(r4.w);
  r8.xyz = -v6.xyz * r4.www;
  r3.y = saturate(dot(r8.xyz, r3.yzw));
  r7.xyzw = emissiveMap.Sample(colorSampler_s, r7.xy).xyzw;
  ...
  r1.w = frac(r1.w);
  r5.y = gameTime.w * flickerSpeed + r1.w;
  r5.x = flickerSeed.x;
  r1.w = flickerLookupMap.SampleLevel(lookupSampler_s, r5.xy, 0).x;
  r1.w = log2(abs(r1.w));
  r1.w = flickerPower * r1.w;
  r1.w = exp2(r1.w);
  r3.w = flickerRange.y + -flickerRange.x;
  r1.w = r1.w * r3.w + flickerRange.x;
  ...
  sincos(r3.w, r7.x, r9.x);
  r3.w = dot(r5.xy, float2(0.0671105608,0.00583714992));
  r3.w = frac(r3.w);
  r3.w = 52.9829178 * r3.w;
  r3.w = frac(r3.w);
  r3.w = r3.w * 6.28318548 + gameTick.w;
  sincos(r3.w, r5.x, r10.x);
  r0.x = saturate(dot(r2.xyz, r8.xyz));
  r3.w = dot(-r8.xyz, r2.xyz);
  r3.w = r3.w + r3.w;
  r11.xyz = r2.xyz * -r3.www + -r8.xyz;
  r3.w = 17 * r0.y;
  r3.w = exp2(r3.w);
  r3.w = 2 + r3.w;
  r3.w = 2 / r3.w;
      ...
      if (r16.z != 0) {
        ...
        if (r8.w != 0) {
          ...
          r35.w = samp0[]..swiz;
            ...
            r16.w = -r16.w * r17.z + 1;
            r16.w = r29.y * r16.w;
            r6.y = r18.w ? r16.w : r21.z;
            r29.xy = r18.zz ? r29.xy : r6.xy;
            r16.z = (int)r16.z + 1;
            r15.w = r17.w;
          }
  ...
  if (r0.w == 0) {
    ...
    while (true) {
      ...
      r10.y = cmp((int)r6.x == (int)r8.w);
      bitmask.z = ((~(-1 << r6.y)) << 0) & 0xffffffff;  r10.z = (((uint)0 << 0) & bitmask.z) | ((uint)r9.w & ~bitmask.z);
      r9.w = r10.y ? r10.z : r9.w;
      r10.y = cmp((int)r7.z == (int)r8.w);
    ...
    if (r7.z != 0) {
      ...
      r7.w = 0;
      while (true) {
        r8.w = cmp((uint)r7.w >= (uint)r0.w);
        if (r8.w != 0) break;
        r13.z = (uint)r7.w >> 5;
        r14.xyz = (int3)r12.xyz + (int3)r13.xyz;
        r8.w = visibleProbes.Load(r14.xyzw).x;
        r9.w = cmp((int)r6.x == (int)r7.w);
        if (r6.y == 0) r12.w = 0; else if (r6.y+0 < 32) {         r12.w = (uint)r8.w << (32-(r6.y + 0)); r12.w = (uint)r12.w >> (32-r6.y);        } else r12.w = (uint)r8.w >> 0;
    ...
    if (r5.z != 0) {
      r5.z = 1 + -r23.w;
      r6.x = sunConstants.globalProbeExposure * r5.z;
      r6.yzw = -globalProbeConstants.data[0].xyz + v6.xyz;
      r13.x = globalProbeConstants.data[0].w * r6.y;
      r13.yz = globalProbeConstants.data[1].xy * r6.zw;
      r6.yzw = saturate(float3(0.5,0.5,0.5) + r13.xyz);
      r13.xy = globalProbeConstants.data[1].zw * r6.yz;
      r13.z = globalProbeConstants.data[2].x * r6.w;
      r6.yzw = globalProbeConstants.data[2].yzw + r13.xyz;
      r10.yzw = cmp(float3(0,0,0) < r2.xyz);
      r13.xyz = r10.yzw ? float3(0,0,0) : float3(0.5,0.5,0.5);
      r13.w = 0;
      r10.yzw = r13.wwx + r6.yzw;
      r10.yzw = gProbeXArray.SampleLevel(samplerLinearClamp_s, r10.yzw, 0).xyz;
      r14.xyz = r2.xyz * r2.xyz;
      r14.xyz = r14.xyz * r6.xxx;
      r15.xyz = r13.wwy + r6.yzw;
      ...
      r6.xyz = r13.wwz + r6.yzw;
      r6.xyz = gProbeZArray.SampleLevel(samplerLinearClamp_s, r6.xyz, 0).xyz;
      r6.xyz = r6.xyz * r14.zzz + r10.yzw;
      r2.w = 0;
      r10.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r2.xyzw, 6).xyz;
      r6.xyz = r10.yzw * r6.xyz;
      r2.w = dot(r6.xyz, float3(0.212599993,0.715200007,0.0722000003));
      r19.xyz = r22.xyz * r0.www + r6.xyz;
      r11.w = 0;
      r6.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r11.xyzw, r5.w).xyz;
      r0.w = sunConstants.globalProbeExposure * r5.z + -r2.w;
      r0.w = r0.y * r0.w + r2.w;
      r20.xyz = r6.xyz * r0.www + r20.xyz;
    }
  } else {
    r20.x = r19.w;
  }
  ...
  r10.yzw = r20.xyz * r0.www;
  r13.xyz = r10.zwy * r0.yyy;
  r0.yzw = r10.yzw * r0.zzz;
  r2.w = sqrt(r5.y);
  r2.w = r2.w * 0.5 + 0.5;
  r2.w = r2.w * r2.w;
  r5.z = 0.5 * r2.w;
  ...
  if (r7.w == 0) {
    ...
    if (r9.w != 0) {
      ...
      while (true) {
        ...
        if (r12.w != 0) break;
        r12.w = (uint)r9.w;
        r14.xy = -sunConstants.splitPinTransform[r12.w].xy + r10.yz;
        r14.x = max(abs(r14.x), abs(r14.y));
        r11.w = sunConstants.splitPinTransform[r12.w].z * r14.x;
        r12.w = cmp(r11.w < 1);
        if (r12.w != 0) {
          break;
        }
    ...
    if (r12.w == 0) {
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          r16.xy = r15.zz ? r10.yz : r15.xy;
          r15.w = r15.z ? sunConstants.splitPinTransform[r9.w].w : sunConstants.splitPinTransform[r10.w].w;
          r15.z = r15.z ? r9.w : r10.w;
          ...
          r16.z = (uint)r15.z;
          r15.z = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r7.w).x;
  ...
  if (r7.w != 0) {
    ...
    if (r7.w != 0) {
        ...
        r14.w = samp0[]..swiz;
          ...
          if (enableDitheredShadow != 0) {
            ...
            while (true) {
              ...
              r16.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r9.w).x;
              r14.w = r16.x * 0.125 + r14.w;
              r15.w = (int)r15.w + 1;
            }
          } else {
            r15.z = (uint)r12.w;
            r14.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r15.xyz, r9.w).x;
          }
          r9.w = r14.w * r14.w;
          r9.w = r9.w * r14.w;
        } else {
      ...
      r7.z = r8.w * r7.z;
      r7.z = 0.25 * r7.z;
      r15.xyz = r7.zzz * r10.yzw + r0.yzw;
      r4.w = saturate(1 + -r4.w);
      r7.w = r4.w * r4.w;
      r7.w = r7.w * r7.w;
      r4.w = r7.w * r4.w;
      r4.w = r7.z * r4.w;
      r16.xyz = r4.www * r10.zwy + r13.xyz;
      r14.w = r16.z;
      r6.w = r13.z;
      r6.xyzw = r5.wwww ? r14.xyzw : r6.xyzw;
      r16.zw = r15.xy;
      r13.zw = r0.yz;
      r14.xyzw = r5.wwww ? r16.xyzw : r13.xyzw;
      r0.w = r5.w ? r15.z : r0.w;
      r13.z = r6.w;
      r13.xy = r14.xy;
      r0.yz = r14.zw;
    }
  ...
  while (true) {
    ...
    r7.z = visibleLights.Load(r16.xyzw).x;
    r16.xyz = r10.yzw;
    r29.xyz = r27.xyz;
    r30.xyz = r28.xyz;
    r7.w = r5.w;
              ...
              if (r24.w != 0) {
                ...
                if (r24.w != 0) {
                  ...
                  while (true) {
                    ...
                    if (r28.w != 0) break;
                    r43.y = dot(icb[r27.w+0].yx, r14.xy);
                    r43.z = dot(icb[r27.w+0].yx, r14.yz);
            ...
            r39.w = samp0[]..swiz;
              ...
              if (r15.z != 0) {
                ...
                if (r15.z != 0) {
                  ...
                  r15.w = r15.w + -r13.w;
                  r15.w = r5.y * r15.w + r13.w;
                  r15.w = r15.w * r9.w;
                  r12.w = cmp(0 < r12.w);
                  r22.xyz = r15.www * r20.xyw + r16.xyz;
                  r19.xyz = r19.xyz * r11.www + r8.xyz;
                  r11.w = dot(r19.xyz, r19.xyz);
                  r11.w = rsqrt(r11.w);
                  ...
                  r9.w = r13.w * r9.w;
                  r9.w = 0.25 * r9.w;
                  r19.xyz = r9.www * r20.xyw + r30.xyz;
                  r11.w = saturate(1 + -r11.w);
                  r13.w = r11.w * r11.w;
                  r13.w = r13.w * r13.w;
                  r11.w = r13.w * r11.w;
                  r9.w = r11.w * r9.w;
                  r20.xyw = r9.www * r20.xyw + r29.xyz;
                  r16.xyz = r12.www ? r22.xyz : r16.xyz;
                  r29.xyz = r12.www ? r20.xyw : r29.xyz;
                  r30.xyz = r12.www ? r19.xyz : r30.xyz;
                }
              }
            }
            break;
