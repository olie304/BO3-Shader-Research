...
r0.z = samp0[]..swiz;
  ...
  r0.x = samp0[]..swiz;
    r5.xyz = normalBodyMap.Sample(normalSampler_s, w1.xy).xyz;
  ...
  r4.xyz = r4.xyz * r0.xxx + r15.xyz;
  r0.y = dot(r4.xyz, r4.xyz);
  r0.y = rsqrt(r0.y);
  r4.xyz = r4.xyz * r0.yyy;
  r7.y = r0.z * r0.x + r13.y;
  r3.xyz = r3.xyz * r0.xxx + r16.xyz;
  ...
  r0.z = saturate(dot(r1.xyw, r5.xyz));
  ...
  r7.x = saturate(dot(r4.xyz, r1.xyw));
  r0.z = dot(-r1.xyw, r4.xyz);
  r0.z = r0.z + r0.z;
  r12.xyz = r4.xyz * -r0.zzz + -r1.xyw;
  r0.z = 17 * r7.y;
  r0.z = exp2(r0.z);
  r0.z = 2 + r0.z;
  r0.z = 2 / r0.z;
  ...
  if (r6.y != 0) {
    ...
    while (true) {
      ...
      if (r6.x == 0) r9.w = 0; else if (r6.x+0 < 32) {       r9.w = (uint)r8.z << (32-(r6.x + 0)); r9.w = (uint)r9.w >> (32-r6.x);      } else r9.w = (uint)r8.z >> 0;
      r8.z = r8.w ? r9.w : r8.z;
  ...
  if (r3.w != 0) {
    ...
    r6.xyz = r21.xyz * r1.zzz + r11.yzw;
    r12.w = 0;
    r11.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r12.xyzw, r5.w).xyz;
    r1.z = sunConstants.globalProbeExposure * r3.w + -r4.w;
    r1.z = r7.y * r1.z + r4.w;
