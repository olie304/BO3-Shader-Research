...
exp r1.w, r1.w
movc r1.w, cb0[14].x, r1.w, r2.y
eq r2.y, cb0[12].y, l(0.000000)
movc r1.w, r2.y, l(1.000000), r1.w
mul r2.y, r3.w, cb0[12].x
mul r1.w, r1.w, r2.y
mul r1.w, r2.x, r1.w
...
add r2.y, r2.y, r2.y
mad r12.xyz, r4.xyzx, -r2.yyyy, -r8.xyzx
...
mad r9.zw, r1.xxxy, l(0.000000, 0.000000, 0.984375, 0.984375), l(0.000000, 0.000000, 0.00781250, 0.00781250)
sample_l_indexable(texture2d)(float,float,float,float) r9.zw, r9.zwzz, t5.zwxy, s2, l(0.000000)
mul r14.xyz, r9.zzzz, r11.zwyz
...
if_z r7.w
  ...
  if_z r10.w
    ...
    if_nz cb2[58].y
      ...
      add r15.xy, r15.xyxx, -cb2[r9.z + 20].xyxx
      mul r15.xy, r15.xyxx, cb2[r9.z + 20].zzzz
      ...
      loop 
        ...
        movc r17.w, r17.x, cb2[r9.z + 20].w, cb2[r10.w + 20].w
        movc r17.x, r17.x, r9.z, r10.w
...
if_nz r7.w
  ...
  if_nz r7.w
      ...
      if_z r9.w
        ...
        if_nz cb2[58].y
          ...
          loop 
            ...
            mad r17.xy, r18.xyxx, r9.zzzz, r16.xyxx
    ...
    mad r9.z, |r6.w|, r2.y, -|r6.w|
    mad r6.w, |r6.w|, r9.z, l(1.000000)
          ...
          if_nz r20.w
            ...
            if_nz r20.w
              ...
              if_nz r20.w
                ...
                mad r39.xyz, r39.xyzx, r10.wwww, r8.xyzx
                dp3 r10.w, r39.xyzx, r39.xyzx
                rsq r10.w, r10.w
                mul r39.xyz, r10.wwww, r39.xyzx
                dp3 r10.w, r39.xyzx, r8.xyzx
          ...
          if_nz r14.w
            ...
            if_nz r14.w
              ...
              if_nz r14.w
                ...
                mad r19.xyz, r19.xyzx, r10.wwww, r8.xyzx
                dp3 r10.w, r19.xyzx, r19.xyzx
                rsq r10.w, r10.w
...
if_z r0.w
  ftou r3.xy, v0.xyxx
  bfi r0.w, l(1), l(16), cb0[11].w, l(0)
  iadd r0.w, r0.w, l(1)
