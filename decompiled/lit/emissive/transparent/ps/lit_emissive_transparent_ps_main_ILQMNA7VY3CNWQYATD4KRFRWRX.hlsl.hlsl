...
r0.y = samp0[]..swiz;
  ...
  r0.z = debugAlphaOverride.w * r1.w + r0.z;
  ...
  r0.w = r0.w + -r2.x;
  r0.w = debugGlossOverride.w * r0.w + r2.x;
  r1.w = -1 + debugOcclusionOverride.x;
  r1.w = debugOcclusionOverride.w * r1.w + 1;
  r7.xyz = v8.xxx ? v4.xyz : -v4.xyz;
  r2.x = dot(r7.xyz, r7.xyz);
  r2.x = rsqrt(r2.x);
  r7.xyz = r7.xyz * r2.xxx + -r3.xzw;
  ...
  r6.w = saturate(r6.w);
  r2.x = 1 + -r6.w;
  r1.xyz = r1.xyz * r2.xxx + r14.xyz;
  r0.z = r0.z * r2.x + r6.w;
  r3.xyz = r3.xzw * r2.xxx + r15.xyz;
  r3.w = dot(r3.xyz, r3.xyz);
  r3.w = rsqrt(r3.w);
  r3.xyz = r3.xyz * r3.www;
  r8.y = r0.w * r2.x + r7.z;
  r2.yzw = r2.yzw * r2.xxx + r16.xyz;
  r0.x = saturate(r0.x);
  r0.x = hdrScale * r0.x;
  r9.xyz = cmp(r0.yyy == float3(3,2,1));
  r0.y = cmp(r0.y < 0);
  r12.xyz = r0.yyy ? float3(1,1,1) : emissiveTint1.xyz;
  r12.xyz = r9.zzz ? tint1.xyz : r12.xyz;
  ...
  r40.w = samp0[]..swiz;
    ...
    r29.xyz = r9.xyz * r16.www + r29.xyz;
  ...
  if (r7.w == 0) {
    ...
    while (true) {
      ...
      r14.x = cmp((int)r8.z == (int)r13.w);
      bitmask.y = ((~(-1 << r8.w)) << 0) & 0xffffffff;  r14.y = (((uint)0 << 0) & bitmask.y) | ((uint)r13.z & ~bitmask.y);
      r13.z = r14.x ? r14.y : r13.z;
      r14.x = cmp((int)r11.w == (int)r13.w);
        ...
        r27.y = samp0[]..swiz;
          ...
          r34.w = samp0[]..swiz;
            ...
            r40.y = samp0[]..swiz;
              ...
              r17.yzw = r9.xyz * r15.xxx + r17.yzw;
    ...
    if (r11.w != 0) {
      ...
      r12.w = 0;
      while (true) {
        r13.w = cmp((uint)r12.w >= (uint)r7.w);
        if (r13.w != 0) break;
        r13.z = (uint)r12.w >> 5;
        r14.xyz = (int3)r11.xyz + (int3)r13.xyz;
        r13.z = visibleProbes.Load(r14.xyzw).x;
        r13.w = cmp((int)r8.z == (int)r12.w);
          ...
          r28.y = samp0[]..swiz;
            ...
            r36.w = samp0[]..swiz;
              ...
              r42.y = samp0[]..swiz;
                ...
                r28.xyz = r9.xyz * r17.yyy + r28.xyz;
                ...
                r37.x = dot(r3.xyz, r27.xyz);
                r37.y = dot(r3.xyz, r29.xyz);
                r37.z = dot(r3.xyz, r33.xyz);
    ...
    r20.xyz = r22.xyz * r5.zzz;
    r21.xyz = r23.xyz * r5.zzz;
    ...
    if (r6.z != 0) {
      ...
      r20.xyz = r22.xyz * r5.zzz + r13.xyz;
      r9.w = 0;
      r13.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r9.xyzw, r5.w).xyz;
      r5.z = sunConstants.globalProbeExposure * r6.z + -r3.w;
      r3.w = r8.y * r5.z + r3.w;
      r21.xyz = r13.xyz * r3.www + r21.xyz;
    }
  } else {
    r21.x = r20.w;
  }
  ...
  if (r6.z == 0) {
    ...
    if (r7.w != 0) {
      ...
      while (true) {
        ...
        r9.w = sunConstants.splitPinTransform[r11.w].z * r12.w;
        r11.w = cmp(r9.w < 1);
        if (r11.w != 0) {
          break;
        }
    ...
    if (r11.w == 0) {
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          r17.w = r17.x ? sunConstants.splitPinTransform[r7.w].w : sunConstants.splitPinTransform[r11.w].w;
          r17.x = r17.x ? r7.w : r11.w;
  ...
  if (r6.z != 0) {
    r6.z = cmp(0 < r6.w);
    if (r6.z != 0) {
      r6.z = sunConstants.specScale * r0.w;
      r6.z = r6.z * r5.w;
              ...
              if (r20.w != 0) {
                ...
                if (r20.w != 0) {
                  ...
                  while (true) {
                    ...
                    if (r27.w != 0) break;
                    r44.y = dot(icb[r26.w+0].yx, r10.xy);
                    r44.z = dot(icb[r26.w+0].yx, r10.yz);
                ...
                if (r20.w != 0) {
                  r20.w = r33.x * r0.w;
                  r20.w = 0.25 * r20.w;
                  r24.w = dot(r39.xyz, r9.xyz);
                  r26.w = dot(r9.xyz, r41.xyz);
                      ...
                      r12.w = samp0[]..swiz;
                        ...
                        if (r7.w != 0) {
                          ...
                          while (true) {
                            ...
                            if (r26.w != 0) break;
                            r42.x = dot(icb[r24.w+0].xy, r7.xy);
                            r42.y = dot(icb[r24.w+0].yx, r7.xz);
                  ...
                  r15.z = dot(r3.xyz, r39.xyz);
                  r15.w = abs(r15.z) * r0.w + -abs(r15.z);
                  r15.z = abs(r15.z) * r15.w + 1;
                  r15.w = r12.w * r1.w + r3.w;
                  r15.z = r15.z * r15.z;
                  r15.z = r15.z * r15.w;
                  r15.z = rcp(r15.z);
                  r12.w = r12.w * r20.w;
            ...
            r40.w = samp0[]..swiz;
              ...
              if (r14.w != 0) {
                ...
                if (r14.w != 0) {
                  ...
                  r18.x = abs(r15.z) * r0.w + -abs(r15.z);
                  r15.z = abs(r15.z) * r18.x + 1;
                  r13.w = r13.w * r1.w + r3.w;
                  r15.z = r15.z * r15.z;
                  r13.w = r15.z * r13.w;
                  r13.w = rcp(r13.w);
                  r13.w = r13.w * r14.w;
  ...
  r0.xyw = float3(1,1,1) + -r2.yzw;
  r0.xyw = r28.xyz * r0.xyw;
  r0.xyw = r29.xyz * r2.yzw + r0.xyw;
  r0.xyw = r27.xyz * r1.xyz + r0.xyw;
