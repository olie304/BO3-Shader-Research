...
rsq r3.y, r3.y
mul r8.xyz, r2.yzwy, r3.yyyy
mad r2.y, r2.x, r3.x, r7.w
mad r1.yzw, r1.yyzw, r3.xxxx, r15.xxyz
...
and r4.xy, r3.yyyy, r4.xyxx
add r3.y, cb0[14].z, l(0.000010)
mad r4.xy, r4.xyxx, r3.yyyy, v2.xyxx
...
exp r2.w, r2.w
movc r2.w, cb0[14].y, r2.w, r3.y
eq r3.y, cb0[13].x, l(0.000000)
movc r2.w, r3.y, l(1.000000), r2.w
mul r3.y, r4.w, cb0[12].w
mul r2.w, r2.w, r3.y
mul r2.w, r3.x, r2.w
    ...
    if_nz r16.w
      ...
      if_nz r15.w
        ...
        if_nz r15.w
          ...
          mul r14.z, r25.z, r15.x
          mov r25.z, r33.z
          dp3 r15.x, r12.xyzx, r25.xyzx
          ...
          mov r24.x, r22.w
          mov r24.yz, r23.xxyx
          mad r23.xyw, r17.zwzy, r14.zzzz, r24.yzyx
          mov r22.w, r23.w
        endif 
      endif 
    endif 
      ...
      if_nz r18.w
        ...
        if_nz r17.w
          ...
          loop 
            ...
            movc r17.y, r29.w, r23.w, r30.x
            movc r29.xy, r29.zzzz, r29.xyxx, r17.xyxx
            iadd r19.w, r19.w, l(1)
            mov r15.x, r28.w
          endloop 
          add_sat r15.x, -r15.w, r29.y
          mul r17.y, r26.y, r15.x
          ...
          if_nz r17.w
            ...
            mad r24.w, r15.x, r26.y, r24.w
            mul r15.x, r27.z, r17.y
            mov r27.z, r35.z
            dp3 r17.y, r12.xyzx, r27.xyzx
            dp3 r17.z, r28.xyzx, r27.xyzx
            ...
            min r17.y, |r17.z|, r17.y
            mov r40.zw, r39.zzzw
            dp3 r17.z, r12.zxyz, r40.xzwx
            dp3 r17.w, r28.zxyz, r40.xzwx
            ...
            mad r26.xyz, r12.xyzx, r17.yyyy, r26.xyzx
            ...
            ubfe r17.z, l(9), l(16), r27.w
            utof r35.w, r17.z
            sample_l_indexable(texturecubearray)(float,float,float,float) r17.yzw, r35.xyzw, t8.wxyz, s2, r17.y
            ...
            mad r24.xyz, r17.yzwy, r15.xxxx, r24.xyzx
          endif 
        endif 
      endif 
    endloop 
...
if_nz r5.w
  ...
  lt r15.xyz, l(0.000000, 0.000000, 0.000000, 0.000000), r8.xyzx
  ...
  mov r8.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r15.xyz, r8.xyzw, t8.xyzw, s2, l(6.000000)
  mul r14.xyz, r14.xyzx, r15.xyzx
  dp3 r6.w, r14.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
  mad r11.yzw, r20.xxyz, r3.wwww, r14.xxyz
  mov r12.w, l(0)
  ...
  mad r13.xyz, r14.xyzx, r3.wwww, r13.xyzx
endif 
add r3.w, r1.x, r2.x
log r3.w, |r3.w|
mul r3.w, r3.w, r3.z
...
mul r11.yzw, r3.wwww, r13.xxyz
mul r13.xyz, r5.zzzz, r11.zwyz
...
if_nz r5.w
  ...
  if_nz r5.w
    ...
    mad r15.xyz, r7.wwww, r9.xyzx, r14.xyzx
    ...
    mul r2.z, r2.z, r5.w
    mul r2.z, r2.z, r5.z
    mad r9.xyz, r2.zzzz, r9.yzxy, r13.xyzx
    mov r15.w, r9.z
    mov r14.w, r13.z
    movc r14.xyzw, r3.wwww, r15.xyzw, r14.xyzw
    mov r9.zw, r16.xxxy
    mov r13.zw, r11.yyyz
    movc r9.xyzw, r3.wwww, r9.xyzw, r13.xyzw
...
ret 
// Approximately 2300 instruction slots used
