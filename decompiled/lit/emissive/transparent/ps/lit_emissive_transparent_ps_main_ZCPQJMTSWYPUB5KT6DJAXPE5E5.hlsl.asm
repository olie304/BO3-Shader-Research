...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:35:03 2021
//
//
// Buffer Definitions: 
//
...
mad r2.xyz, r2.xywx, r0.yyyy, r13.xyzx
dp3 r0.z, r2.xyzx, r2.xyzx
rsq r0.z, r0.z
mul r2.xyz, r0.zzzz, r2.xyzx
mad r5.y, r1.w, r0.y, r11.y
...
sample_indexable(texture2d)(float,float,float,float) r3.xyzw, r7.xyxx, t29.xyzw, s1
...
mov r7.x, cb0[16].x
sample_l_indexable(texture2d)(float,float,float,float) r0.y, r7.xyxx, t26.yxzw, s7, l(0.000000)
log r0.y, |r0.y|
mul r0.y, r0.y, cb0[17].z
exp r0.y, r0.y
add r1.w, -cb0[17].x, cb0[17].y
mad r0.y, r0.y, r1.w, cb0[17].x
mul r3.xyz, r0.yyyy, r3.xyzx
...
add r1.w, r1.w, r1.w
mad r12.xyz, r2.xyzx, -r1.wwww, -r8.xyzx
...
mad r7.zw, -r4.zzzz, l(0.000000, 0.000000, 10.000000, 5.000000), l(0.000000, 0.000000, 6.857410, 7.085000)
exp r5.w, r7.z
mul r5.w, r5.w, r5.x
    ...
    if_nz r11.y
      ...
      if_nz r10.w
        ...
        if_nz r11.y
          ...
          sqrt r10.w, r10.w
          mad r10.w, r4.z, l(5.000000), r10.w
...
if_nz r5.z
  ...
  mad r4.xyz, r21.xyzx, r0.xxxx, r11.yzwy
  mov r12.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r11.yzw, r12.xyzw, t8.wxyz, s2, r4.w
  mad r0.x, cb2[19].x, r5.z, -r2.w
  mad r0.x, r5.y, r0.x, r2.w
  mad r10.yzw, r11.yyzw, r0.xxxx, r10.yyzw
endif 
add r0.x, r0.w, r5.x
log r0.x, |r0.x|
mul r0.x, r0.x, r3.w
...
mul r10.yzw, r0.xxxx, r10.yyzw
mul r14.xyz, r5.yyyy, r10.zwyz
...
if_z r7.z
  ...
  if_z r11.y
    if_z cb2[58].y
      ...
      sample_c_lz_indexable(texture2darray)(float,float,float,float) r10.w, r15.xyzx, t13.xxxx, s13, r7.z
    ...
    if_nz cb2[58].y
      ...
      loop 
        ...
        utof r16.z, r13.w
        sample_c_lz_indexable(texture2darray)(float,float,float,float) r13.w, r16.xyzx, t13.xxxx, s13, r7.z
...
if_nz r7.z
  ...
  if_nz r7.z
    ...
    if_nz r9.w
      ...
      mad r11.y, |r2.w|, l(-0.200000), l(0.400000)
    ...
    mad r15.xyz, r8.wwww, r10.yzwy, r4.xyzx
    ...
    mad r11.yzw, r6.wwww, r10.yyzw, r5.yyzw
    ...
    mov r15.w, r16.z
    mov r4.w, r14.z
    movc r4.xyzw, r2.wwww, r15.xyzw, r4.xyzw
    mov r16.zw, r11.yyyz
    mov r14.zw, r5.yyyz
