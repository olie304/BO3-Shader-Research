...
r0.y = samp0[]..swiz;
  ...
  if (r4.w != 0) {
    ...
    r6.yzw = r21.xyz * r2.www + r14.xyz;
    r13.w = 0;
    r14.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r13.xyzw, r4.z).xyz;
  ...
  r6.yzw = r11.yzw * r2.www;
  r15.xyz = r6.zwy * r4.zzz;
  ...
  if (r4.w == 0) {
    ...
    r4.w = -sunConstants.splitDepthOffset + r11.w;
    ...
    if (r10.w == 0) {
      if (enableDitheredShadow == 0) {
        ...
        r16.z = r10.w + r7.w;
        r10.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r4.w).x;
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          r18.z = (uint)r13.w;
          r13.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r18.xyz, r4.w).x;
  ...
  if (r4.w != 0) {
    ...
    if (r4.w != 0) {
      ...
      r9.zw = r11.yz;
      r15.zw = r6.yz;
      r9.xyzw = r2.wwww ? r9.xyzw : r15.xyzw;
      r6.w = r2.w ? r11.w : r6.w;
      r15.z = r14.w;
      r15.xy = r9.xy;
      r6.yz = r9.zw;
    }
                      ...
                      r12.w = samp0[]..swiz;
                        ...
                        if (r5.w != 0) {
                          ...
                          while (true) {
                            ...
                            if (r26.w != 0) break;
                            r42.x = dot(icb[r21.w+0].xy, r5.xy);
                            r42.y = dot(icb[r21.w+0].yx, r5.xz);
