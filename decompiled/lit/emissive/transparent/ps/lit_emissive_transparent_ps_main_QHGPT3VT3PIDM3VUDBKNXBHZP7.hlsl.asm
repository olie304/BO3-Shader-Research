...
if_nz r1.w
  ...
  round_z r1.w, r1.w
  add r1.w, r1.w, v2.x
  div r9.x, r1.w, cb0[12].w
  round_z r1.w, r2.y
  add r1.w, r1.w, v2.y
  div r9.y, r1.w, cb0[12].z
else 
  dp3 r1.w, -v7.xyzx, -v7.xyzx
  rsq r1.w, r1.w
  mul r2.yzw, r1.wwww, -v7.xxyz
  dp3 r10.x, r2.yzwy, v5.xyzx
  dp3 r10.y, r2.yzwy, v6.xyzx
  dp3 r1.w, r2.yzwy, v4.xyzx
  lt r2.y, l(0.000000), r1.w
  div r2.zw, -r10.xxxy, r1.wwww
  ...
  mov r11.y, r11.x
  mov r11.z, r10.x
  dp2 r12.x, r11.yzyy, r2.yzyy
  mov r11.x, -r10.x
  dp2 r12.y, r11.xyxx, r2.yzyy
  mul r2.yz, cb0[14].xxyx, cb1[69].wwww
  mad r2.yz, r2.yyzy, cb0[14].zzwz, r12.xxyx
  ...
  movc r9.xy, cb0[16].zwzz, r6.zwzz, r2.yzyy
endif 
dp3 r1.w, -v7.xyzx, -v7.xyzx
rsq r1.w, r1.w
mul r2.yzw, r1.wwww, -v7.xxyz
dp3_sat r3.w, r2.yzwy, r4.xyzx
...
log r3.w, r3.w
mul r3.w, r3.w, cb0[19].y
exp r3.w, r3.w
movc r3.w, cb0[21].x, r3.w, r6.z
eq r6.z, cb0[19].y, l(0.000000)
movc r3.w, r6.z, l(1.000000), r3.w
...
add r3.x, v3.y, v3.x
add r3.x, r3.x, v3.z
add r3.x, r3.x, cb0[17].y
frc r3.x, r3.x
mad r9.y, cb1[69].w, cb0[17].z, r3.x
mov r9.x, cb0[17].x
sample_l_indexable(texture2d)(float,float,float,float) r3.x, r9.xyxx, t26.xyzw, s7, l(0.000000)
log r3.x, |r3.x|
mul r3.x, r3.x, cb0[18].z
exp r3.x, r3.x
add r3.w, -cb0[18].x, cb0[18].y
mad r3.x, r3.x, r3.w, cb0[18].x
mul r4.xyz, r3.xxxx, r4.xyzx
...
add r3.y, r3.y, r3.y
mad r13.xyz, r5.xyzx, -r3.yyyy, -r2.yzwy
...
loop 
  ...
  dp3 r31.x, r5.xyzx, r23.xyzx
  dp3 r31.y, r5.xyzx, r32.xyzx
  dp3 r31.z, r5.xyzx, r25.xyzx
...
if_z r9.z
  ...
  if_nz r6.w
    ...
    lt r12.yzw, l(0.000000, 0.000000, 0.000000, 0.000000), r5.xxyz
    ...
    mov r5.w, l(0)
    sample_l_indexable(texturecubearray)(float,float,float,float) r12.yzw, r5.xyzw, t8.wxyz, s2, l(6.000000)
    ...
    mov r13.w, l(0)
    sample_l_indexable(texturecubearray)(float,float,float,float) r11.yzw, r13.xyzw, t8.wxyz, s2, r6.z
    mad r3.w, cb2[19].x, r6.w, -r5.w
    mad r3.w, r6.y, r3.w, r5.w
...
mul r11.yzw, r3.wwww, r22.xxyz
mul r15.xyz, r6.yyyy, r11.zwyz
mul r6.yzw, r6.zzzz, r11.yyzw
sqrt r2.x, r3.z
mad r2.x, r2.x, l(0.500000), l(0.500000)
mul r2.x, r2.x, r2.x
mul r3.w, r2.x, l(0.500000)
mad r2.x, -r2.x, l(0.500000), l(1.000000)
mad r5.w, r6.x, r2.x, r3.w
mul r2.x, r2.x, r5.w
mul r3.w, r3.w, r5.w
dp3 r5.w, r5.xyzx, cb2[17].xyzx
mov_sat r8.w, r5.w
ge r9.z, l(0.000000), r8.w
if_nz r9.z
  mov r9.w, l(0)
endif 
if_z r9.z
  ...
  if_z r12.z
    ...
    if_nz cb2[58].y
      ...
      loop 
        ...
        utof r18.z, r17.x
        sample_c_lz_indexable(texture2darray)(float,float,float,float) r17.x, r18.xyzx, t13.xxxx, s13, r9.z
...
if_nz r9.z
  ...
  if_nz r9.z
    mul r9.z, r3.y, cb2[18].w
    mul r9.z, r8.w, r9.z
    if_nz cb2[23].x
      mov r7.w, l(1.000000)
      dp4 r10.w, cb2[24].xyzw, r7.xyzw
    ...
    if_nz r10.w
      ...
      if_z r11.w
        ...
        if_nz cb2[58].y
          ...
          utof r16.z, r11.y
          sample_c_lz_indexable(texture2darray)(float,float,float,float) r11.z, r16.xyzx, t9.xxxx, s13, r7.w
        endif 
    ...
    mad r10.w, |r7.w|, r3.y, -|r7.w|
    mad r7.w, |r7.w|, r10.w, l(1.000000)
    mad r8.w, r8.w, r2.x, r3.w
    mul r7.w, r7.w, r7.w
    mul r7.w, r8.w, r7.w
    rcp r7.w, r7.w
    mul r7.w, r9.z, r7.w
    ...
    mad r11.yzw, r7.wwww, r7.xxyz, r6.yyzw
    add_sat r1.w, -r1.w, l(1.000000)
    mul r8.w, r1.w, r1.w
    mul r8.w, r8.w, r8.w
    mul r1.w, r1.w, r8.w
    mul r1.w, r1.w, r7.w
    mad r7.xyz, r1.wwww, r7.yzxy, r15.xyzx
    mov r16.w, r7.z
    mov r14.w, r15.z
          ...
          if_nz r26.w
            ...
            if_nz r26.w
              ...
              if_nz r26.w
                  ...
                  if_z r19.y
                    ...
                    if_nz r9.w
                      ...
                      loop 
                        ...
                        dp2 r42.y, icb[r19.z + 0].xyxx, r9.xyxx
                ...
                mad r15.w, -r25.w, r5.w, l(1.000000)
          ...
          if_nz r16.w
            ...
            if_nz r16.w
              ...
              if_nz r16.w
                ...
                mad r19.x, -r16.z, r5.w, l(1.000000)
                mul r19.x, r19.x, r19.x
