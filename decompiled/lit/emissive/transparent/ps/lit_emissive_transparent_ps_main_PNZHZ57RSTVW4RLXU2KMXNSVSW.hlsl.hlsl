...
r5.w = samp0[]..swiz;
  ...
  r3.w = 1 + -r12.x;
  r0.xyz = r0.xyz * r3.www + r7.xzw;
  r0.w = r0.w * r3.w + r12.x;
  r2.yzw = r2.yzw * r3.www + r13.xyz;
  r4.w = dot(r2.yzw, r2.yzw);
  r4.w = rsqrt(r4.w);
  r5.xyz = r4.www * r2.yzw;
  r6.y = r1.w * r3.w + r12.y;
  r1.xyz = r1.xyz * r3.www + r14.xyz;
  r1.w = cmp(0.5 < invertFalloff);
  if (r1.w != 0) {
    r1.w = rowCount * columnCount;
    r2.y = imageTime * r1.w;
    r2.z = gameTime.w * r2.y;
    r2.z = cmp(r2.z >= -r2.z);
    r2.z = r2.z ? r2.y : -r2.y;
    r2.w = 1 / r2.z;
    ...
    r1.w = r2.y * r1.w;
    r1.w = round(r1.w);
    r2.y = r1.w / columnCount;
    r2.z = columnCount * r1.w;
    r2.z = cmp(r2.z >= -r2.z);
    ...
    r2.yz = r2.yz * r1.ww;
    r2.yz = scaleUVs.xy * r2.yz;
    r2.yz = r6.zw * scaleUVs.xy + r2.yz;
    r2.yz = offsetUVs.xy * scaleUVs.xy + r2.yz;
    ...
    r9.y = r9.x;
    r9.z = r8.x;
    r10.x = dot(r9.yz, r2.yz);
    r9.x = -r8.x;
    r10.y = dot(r9.xy, r2.yz);
    r2.yz = gameTime.ww * scrollUVs.xy;
    r2.yz = r2.yz * scaleUVs.xy + r10.xy;
    ...
    r6.zw = saturate(r2.yz);
    r7.xy = clampU ? r6.zw : r2.yz;
  }
  r1.w = dot(-v6.xyz, -v6.xyz);
  r1.w = rsqrt(r1.w);
  r2.yzw = -v6.xyz * r1.www;
  ...
  r4.yzw = emissiveTint1.xyz * r7.xyz;
  r6.z = log2(r4.x);
  r6.z = emissiveFalloffPower * r6.z;
  r6.z = exp2(r6.z);
  r4.x = 1 + -r4.x;
  r4.x = log2(r4.x);
  r4.x = emissiveFalloffPower * r4.x;
  r4.x = exp2(r4.x);
  r4.x = invertFalloff ? r4.x : r6.z;
  r6.z = cmp(emissiveFalloffPower == 0.000000);
  r4.x = r6.z ? 1 : r4.x;
  r6.z = hdrScale * r7.w;
  r4.x = r6.z * r4.x;
  r3.w = r4.x * r3.w;
  r4.xyz = r4.yzw * r3.www;
  r3.w = v2.x + v2.y;
  r3.w = v2.z + r3.w;
  r3.w = flickerSeed.y + r3.w;
  r3.w = frac(r3.w);
  r7.y = gameTime.w * flickerSpeed + r3.w;
  r7.x = flickerSeed.x;
  r3.w = flickerLookupMap.SampleLevel(lookupSampler_s, r7.xy, 0).x;
  r3.w = log2(abs(r3.w));
  ...
  r6.zw = (uint2)r3.zy;
  r7.x = dot(r6.wz, float2(0.0671105608,0.00583714992));
  r7.x = frac(r7.x);
  ...
  sincos(r6.z, r9.x, r10.x);
  r6.x = saturate(dot(r5.xyz, r2.yzw));
  r6.z = dot(-r2.yzw, r5.xyz);
  r6.z = r6.z + r6.z;
  r11.xyz = r5.xyz * -r6.zzz + -r2.yzw;
  r6.z = 17 * r6.y;
  r6.z = exp2(r6.z);
  r6.z = 2 + r6.z;
  r6.z = 2 / r6.z;
  ...
  while (true) {
    ...
    if (r10.y != 0) break;
    r3.z = (uint)r9.w >> 5;
    r13.xyz = (int3)r3.xyz + (int3)r12.xyz;
    r3.z = visibleProbes.Load(r13.xyzw).x;
  // Known bad code for instruction (needs manual fix):
  ...
  r39.w = samp0[]..swiz;
    ...
    r29.x = dot(r5.xyz, r21.xyz);
    r29.y = dot(r5.xyz, r30.xyz);
    r29.z = dot(r5.xyz, r23.xyz);
  ...
  if (r9.z == 0) {
        ...
        r14.y = samp0[]..swiz;
          ...
          r34.w = samp0[]..swiz;
            ...
            r40.y = samp0[]..swiz;
              ...
              r35.x = dot(r5.xyz, r26.xyz);
              r35.y = dot(r5.xyz, r27.xyz);
    ...
    if (r9.z != 0) {
      ...
      r9.w = 0;
      while (true) {
        r12.w = cmp((uint)r9.w >= (uint)r3.x);
        if (r12.w != 0) break;
        r13.z = (uint)r9.w >> 5;
        r14.xyz = (int3)r12.xyz + (int3)r13.xyz;
        r12.w = visibleProbes.Load(r14.xyzw).x;
        r13.z = cmp((int)r3.y == (int)r9.w);
    ...
    r20.xyz = r23.xyz * r3.xxx;
    r3.y = cmp(r23.w < 0.99000001);
    if (r3.y != 0) {
      r3.y = 1 + -r23.w;
      ...
      r10.yzw = cmp(float3(0,0,0) < r5.xyz);
      ...
      r5.w = 0;
      r10.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r5.xyzw, 6).xyz;
      r9.yzw = r10.yzw * r9.yzw;
      r3.z = dot(r9.yzw, float3(0.212599993,0.715200007,0.0722000003));
      r19.xyz = r22.xyz * r3.xxx + r9.yzw;
      r11.w = 0;
      r9.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r11.xyzw, r7.w).xyz;
      r3.x = sunConstants.globalProbeExposure * r3.y + -r3.z;
      r3.x = r6.y * r3.x + r3.z;
      r20.xyz = r9.yzw * r3.xxx + r20.xyz;
    }
  } else {
    r20.x = r19.w;
  }
  ...
  r13.xyz = r19.xyz * r2.xxx;
  r3.yz = r6.xy * float2(0.984375,0.984375) + float2(0.0078125,0.0078125);
  r3.yz = gEnvBRDFGeneric.SampleLevel(samplerLinear_s, r3.yz, 0).xy;
  r9.yzw = r20.xyz * r3.xxx;
  r14.xyz = r9.zwy * r3.yyy;
  r3.xyz = r9.yzw * r3.zzz;
  r2.x = sqrt(r6.w);
  r2.x = r2.x * 0.5 + 0.5;
  r2.x = r2.x * r2.x;
  r5.w = 0.5 * r2.x;
  ...
  r2.x = r6.y * r2.x;
  r5.w = r6.y * r5.w;
  r6.y = dot(r5.xyz, sunConstants.wldDir.xyz);
  r7.z = saturate(r6.y);
  r7.w = cmp(0 >= r7.z);
  if (r7.w != 0) {
    r8.w = 0;
  ...
  if (r7.w == 0) {
    ...
    if (r10.y != 0) {
      ...
      while (true) {
        ...
        if (r10.w != 0) break;
        r10.w = (uint)r10.y;
        r15.xy = -sunConstants.splitPinTransform[r10.w].xy + r9.yz;
    ...
    if (r10.w == 0) {
      ...
      if (enableDitheredShadow != 0) {
        ...
        r9.yz = -sunConstants.splitPinTransform[r10.y].xy + r9.yz;
        r9.yz = sunConstants.splitPinTransform[r10.y].zz * r9.yz;
        ...
        while (true) {
          ...
          r16.zw = r12.ww ? r9.yz : r16.xy;
          r15.w = r12.w ? sunConstants.splitPinTransform[r10.y].w : sunConstants.splitPinTransform[r9.w].w;
          r12.w = r12.w ? r10.y : r9.w;
  ...
  if (r7.w != 0) {
    r7.w = cmp(0 < r8.w);
    if (r7.w != 0) {
      r7.w = sunConstants.specScale * r6.z;
      r7.w = r7.w * r7.z;
      ...
      r10.y = viewmodelSunShadowRaw >> 16;
      r10.z = cmp(0 < (uint)r10.y);
      r10.z = r3.w ? r10.z : 0;
      if (r10.z != 0) {
      ...
      r10.z = samp0[]..swiz;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r15.xyzw, r10.y, l(68), t12.xyzw
      r15.x = samp0[]..swiz;
      r15.y = samp0[]..swiz;
      r15.z = samp0[]..swiz;
      r15.w = samp0[]..swiz;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r16.xyzw, r10.y, l(84), t12.xyzw
      r16.x = samp0[]..swiz;
      r16.y = samp0[]..swiz;
      r16.z = samp0[]..swiz;
      r16.w = samp0[]..swiz;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r17.xyzw, r10.y, l(132), t12.xyzw
      r17.x = samp0[]..swiz;
      r17.y = samp0[]..swiz;
      r17.z = samp0[]..swiz;
      r17.w = samp0[]..swiz;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r18.xyzw, r10.y, l(148), t12.xyzw
      r18.x = samp0[]..swiz;
      r18.y = samp0[]..swiz;
      r18.z = samp0[]..swiz;
      r18.w = samp0[]..swiz;
        r10.w = abs(r6.y) * -0.200000003 + 0.400000006;
        r19.xyz = r5.xyz * r10.www + v6.xyz;
        r19.w = 1;
        ...
        r10.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r16.xyzw, r10.y, l(100), t12.xyzw
        r16.x = samp0[]..swiz;
        r16.y = samp0[]..swiz;
        r16.z = samp0[]..swiz;
        r16.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r15.zw, r10.y, l(164), t12.xxxy
        r15.z = samp0[]..swiz;
        r15.w = samp0[]..swiz;
          ...
          if (enableDitheredShadow != 0) {
            ...
            while (true) {
              ...
              r17.xy = r18.xy * r10.zz + r16.xy;
              r15.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r17.xyz, r10.y).x;
              r11.w = r15.w * 0.125 + r11.w;
              r12.w = (int)r12.w + 1;
            }
          } else {
            r16.z = (uint)r10.w;
            r11.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r10.y).x;
          }
          r10.y = r11.w * r11.w;
          r10.y = r10.y * r11.w;
        } else {
      ...
      r10.y = -r7.z * r10.y + 1;
      r10.y = r10.y * r10.y;
      r10.y = -r10.y * 0.620000005 + 0.620000005;
      r10.y = r10.y + -r7.z;
      r10.y = r6.w * r10.y + r7.z;
      r10.y = r10.y * r8.w;
      r6.y = cmp(0 < r6.y);
      r15.xyz = r10.yyy * r9.yzw + r13.xyz;
      r10.yzw = -v6.xyz * r1.www + sunConstants.wldDir.xyz;
      r1.w = dot(r10.yzw, r10.yzw);
      r1.w = rsqrt(r1.w);
      r10.yzw = r10.yzw * r1.www;
      r1.w = dot(r10.yzw, r2.yzw);
      r10.y = dot(r5.xyz, r10.yzw);
      r10.z = abs(r10.y) * r6.z + -abs(r10.y);
      r10.y = abs(r10.y) * r10.z + 1;
      r7.z = r7.z * r2.x + r5.w;
      r10.y = r10.y * r10.y;
      r7.z = r10.y * r7.z;
      r7.z = rcp(r7.z);
      ...
      r7.z = r8.w * r7.z;
      r7.z = 0.25 * r7.z;
      r10.yzw = r7.zzz * r9.yzw + r3.xyz;
      r1.w = saturate(1 + -r1.w);
      r7.w = r1.w * r1.w;
      r7.w = r7.w * r7.w;
      r1.w = r7.w * r1.w;
      r1.w = r7.z * r1.w;
      r16.xyz = r1.www * r9.zwy + r14.xyz;
      r15.w = r16.z;
      r13.w = r14.z;
      r13.xyzw = r6.yyyy ? r15.xyzw : r13.xyzw;
      r16.zw = r10.yz;
      r14.zw = r3.xy;
      r15.xyzw = r6.yyyy ? r16.xyzw : r14.xyzw;
      r3.z = r6.y ? r10.w : r3.z;
      r14.z = r13.w;
      r14.xy = r15.xy;
      r3.xy = r15.zw;
    }
            ...
            if (r26.w != 0) {
              ...
              if (r26.w != 0) {
                ...
                if (r26.w != 0) {
                  ...
                  r38.xyz = r38.xyz * r13.www + r2.yzw;
                  r13.w = dot(r38.xyz, r38.xyz);
                  r13.w = rsqrt(r13.w);
                  r38.xyz = r38.xyz * r13.www;
                  r13.w = dot(r38.xyz, r2.yzw);
                  r19.x = dot(r5.xyz, r38.xyz);
                  r21.w = abs(r19.x) * r6.z + -abs(r19.x);
                  r19.x = abs(r19.x) * r21.w + 1;
                  r21.w = r14.w * r2.x + r5.w;
                  r19.x = r19.x * r19.x;
                  r19.x = r19.x * r21.w;
                  r19.x = rcp(r19.x);
                  r14.w = r14.w * r26.w;
            ...
            r39.w = samp0[]..swiz;
              ...
              if (r16.w != 0) {
                ...
                if (r16.w != 0) {
                  ...
                  r20.xyz = r20.xyz * r13.www + r2.yzw;
                  r13.w = dot(r20.xyz, r20.xyz);
                  r13.w = rsqrt(r13.w);
                  r20.xyz = r20.xyz * r13.www;
                  r13.w = dot(r20.xyz, r2.yzw);
                  r19.x = dot(r5.xyz, r20.xyz);
                  r20.x = abs(r19.x) * r6.z + -abs(r19.x);
                  r19.x = abs(r19.x) * r20.x + 1;
                  r16.z = r16.z * r2.x + r5.w;
                  r19.x = r19.x * r19.x;
                  r16.z = r19.x * r16.z;
                  r16.z = rcp(r16.z);
                  r16.z = r16.z * r16.w;
