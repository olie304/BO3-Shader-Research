// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:34:18 2021
...
r3.w = samp0[]..swiz;
  ...
  r3.yzw = emissiveTint1.xyz * r4.xyz;
  r3.x = saturate(r3.x);
  r4.x = log2(r3.x);
            ...
            if (r16.w != 0) {
              ...
              if (r16.w != 0) {
                ...
                if (r16.w != 0) {
                  ...
                  r16.z = abs(r14.w) * r4.y + -abs(r14.w);
            ...
            r40.w = samp0[]..swiz;
              ...
              if (r13.w != 0) {
                ...
                if (r13.w != 0) {
                  ...
                  r16.w = abs(r14.w) * r4.y + -abs(r14.w);
