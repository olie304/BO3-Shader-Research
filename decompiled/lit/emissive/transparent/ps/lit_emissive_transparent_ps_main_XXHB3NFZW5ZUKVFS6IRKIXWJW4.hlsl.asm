...
mad r0.xyz, r0.xyzx, r1.zzzz, r12.xyzx
mad r0.w, r0.w, r1.z, r4.w
mad r4.xyz, r4.xyzx, r1.zzzz, r13.xyzx
dp3 r1.w, r4.xyzx, r4.xyzx
rsq r1.w, r1.w
mul r4.xyz, r1.wwww, r4.xyzx
mad r6.y, r1.x, r1.z, r5.z
...
if_nz r1.x
  ...
  rsq r1.x, r1.x
  mul r10.xyz, r1.xxxx, -v7.xyzx
  dp3 r11.x, r10.xyzx, v5.xyzx
  dp3 r11.y, r10.xyzx, v6.xyzx
  dp3 r1.x, r10.xyzx, v4.xyzx
  lt r1.w, l(0.000000), r1.x
  div r5.zw, -r11.xxxy, r1.xxxx
  and r1.xw, r1.wwww, r5.zzzw
  ...
  mad r1.xw, r5.zzzw, cb0[13].zzzw, r1.xxxw
  ...
  mov r11.y, r11.x
  mov r11.z, r10.x
  dp2 r12.x, r11.yzyy, r1.xwxx
  mov r11.x, -r10.x
  dp2 r12.y, r11.xyxx, r1.xwxx
  mul r1.xw, cb0[13].xxxy, cb1[69].wwww
  mad r1.xw, r1.xxxw, cb0[13].zzzw, r12.xxxy
  ...
  movc r7.xy, cb0[15].zwzz, r5.zwzz, r1.xwxx
endif 
dp3 r1.x, -v7.xyzx, -v7.xyzx
rsq r1.x, r1.x
mul r10.xyz, r1.xxxx, -v7.xyzx
...
exp r1.w, r1.w
movc r1.w, cb0[22].y, r1.w, r2.w
eq r2.w, cb0[21].x, l(0.000000)
movc r1.w, r2.w, l(1.000000), r1.w
mul r2.w, r3.w, cb0[20].w
mul r1.w, r1.w, r2.w
mul r1.z, r1.z, r1.w
...
frc r1.z, r1.z
mad r7.y, cb1[69].w, cb0[16].z, r1.z
mov r7.x, cb0[16].x
sample_l_indexable(texture2d)(float,float,float,float) r1.z, r7.xyxx, t22.yzxw, s5, l(0.000000)
log r1.z, |r1.z|
...
add r1.w, r1.w, r1.w
mad r13.xyz, r4.xyzx, -r1.wwww, -r10.xyzx
mul r1.w, r6.y, l(17.000000)
exp r1.w, r1.w
...
if_z r6.w
  ...
  max r5.y, r24.w, l(1.000000)
  rcp r5.y, r5.y
  mov_sat r24.w, r24.w
  mul r21.xyz, r5.yyyy, r23.xyzx
  mul r22.xyz, r5.yyyy, r24.xyzx
...
mul r6.yzw, r4.wwww, r22.xxyz
mul r15.xyz, r5.yyyy, r6.zwyz
mul r5.yzw, r5.zzzz, r6.yyzw
sqrt r1.y, r2.w
mad r1.y, r1.y, l(0.500000), l(0.500000)
mul r1.y, r1.y, r1.y
mul r4.w, r1.y, l(0.500000)
mad r1.y, -r1.y, l(0.500000), l(1.000000)
mad r6.y, r6.x, r1.y, r4.w
mul r1.y, r1.y, r6.y
mul r4.w, r4.w, r6.y
dp3 r6.y, r4.xyzx, cb2[17].xyzx
mov_sat r6.z, r6.y
...
if_nz r6.w
  ...
  if_nz r6.w
    ...
    if_nz r8.w
      ...
      mad r9.w, |r6.y|, l(-0.200000), l(0.400000)
      mad r20.xyz, r4.xyzx, r9.wwww, v7.xyzx
    ...
    dp3 r1.x, r12.yzwy, r10.xyzx
    dp3 r7.w, r4.xyzx, r12.yzwy
    mad r8.w, |r7.w|, r1.w, -|r7.w|
    mad r7.w, |r7.w|, r8.w, l(1.000000)
    mad r6.z, r6.z, r1.y, r4.w
    mul r7.w, r7.w, r7.w
    mul r6.z, r6.z, r7.w
    rcp r6.z, r6.z
    mul r6.z, r6.w, r6.z
    ...
    mad r12.yzw, r6.zzzz, r8.xxyz, r5.yyzw
    add_sat r1.x, -r1.x, l(1.000000)
    mul r6.w, r1.x, r1.x
    mul r6.w, r6.w, r6.w
    mul r1.x, r1.x, r6.w
    mul r1.x, r1.x, r6.z
    mad r8.xyz, r1.xxxx, r8.yzxy, r15.xyzx
    mov r16.w, r8.z
    mov r14.w, r15.z
    movc r14.xyzw, r6.yyyy, r16.xyzw, r14.xyzw
    mov r8.zw, r12.yyyz
    mov r15.zw, r5.yyyz
    movc r8.xyzw, r6.yyyy, r8.xyzw, r15.xyzw
    movc r5.w, r6.y, r12.w, r5.w
    mov r15.z, r14.w
    mov r15.xy, r8.xyxx
    mov r5.yz, r8.zzwz
  endif 
                  ...
                  if_z r19.y
                    ...
                    if_nz r10.w
                      ...
                      loop 
                        ige r27.w, r19.z, l(8)
                        breakc_nz r27.w
                        dp2 r42.x, icb[r19.z + 0].yxyy, r8.xwxx
...
ret 
// Approximately 2646 instruction slots used
