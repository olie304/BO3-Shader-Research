...
//   float2 wind1Parms;                 // Offset:  288 Size:     8 [unused]
//   float2 wind2Parms;                 // Offset:  296 Size:     8 [unused]
//   float2 wind3Parms;                 // Offset:  304 Size:     8 [unused]
//   bool forceIsolateHack;             // Offset:  312 Size:     4 [unused]
//   float2 vertexColorScale;           // Offset:  320 Size:     8 [unused]
//   uint zFeatherComputeSprites;       // Offset:  328 Size:     4 [unused]
//   float hdrScale;                    // Offset:  332 Size:     4
//   float emissiveFalloffPower;        // Offset:  336 Size:     4
//   float3 emissiveTint1;              // Offset:  340 Size:    12
//   bool relativeHDR;                  // Offset:  352 Size:     4
//   bool invertFalloff;                // Offset:  356 Size:     4
//   float uvMotionToggle1;             // Offset:  360 Size:     4
//
// }
//
...
sample_indexable(texture2d)(float,float,float,float) r2.xyz, v2.xyxx, t21.xyzw, s3
...
mad r4.xyz, r3.xyzx, r2.xxxx, r4.xyzx
...
if_nz r1.z
  ...
  movc r5.xyz, r5.zzzz, l(0,1.000000,0,0), r0.xyzx
  movc r0.xyz, r1.wwww, r2.xywx, r5.xyzx
endif 
add r2.xyw, -r0.xyxz, cb1[58].xyxz
mad r0.xyz, cb1[58].wwww, r2.xywx, r0.xyzx
...
if_nz r1.x
  ...
  rsq r1.x, r1.x
  mul r8.xyz, r1.xxxx, -v7.xyzx
  dp3 r9.x, r8.xyzx, v5.xyzx
  dp3 r9.y, r8.xyzx, v6.xyzx
  dp3 r1.x, r8.xyzx, v4.xyzx
...
mul r3.xyz, r3.xyzx, cb0[21].yzwy
log r5.z, r2.w
mul r5.z, r5.z, cb0[21].x
exp r5.z, r5.z
add r2.w, -r2.w, l(1.000000)
log r2.w, r2.w
mul r2.w, r2.w, cb0[21].x
exp r2.w, r2.w
movc r2.w, cb0[22].y, r2.w, r5.z
eq r5.z, cb0[21].x, l(0.000000)
...
if_nz r6.z
  ...
  if_nz r6.z
    ...
    if_nz r7.w
      ...
      mad r20.xyz, r4.xyzx, r8.wwww, v7.xyzx
    ...
    mad r11.yzw, -v7.xxyz, r1.xxxx, cb2[17].xxyz
          ...
          if_nz r15.w
            ...
            if_nz r15.w
              ...
              if_nz r15.w
                ...
                mad r22.xyz, r4.xyzx, r15.wwww, v7.xyzx
...
mov r3.w, l(1.000000)
movc r1.xyzw, cb0[22].xxxx, r1.xyzw, r3.xyzw
add r0.xyz, r0.xyzx, r1.xyzx
mul r1.w, r1.w, cb0[20].w
...
ret 
// Approximately 2999 instruction slots used
