...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r4.w = saturate(r4.w);
  r1.z = 1 + -r4.w;
  r0.xyz = r0.xyz * r1.zzz + r13.xyz;
  r0.w = r0.w * r1.z + r4.w;
  r2.xyz = r2.xyw * r1.zzz + r14.xyz;
  r1.w = dot(r2.xyz, r2.xyz);
  r1.w = rsqrt(r1.w);
  r2.xyz = r2.xyz * r1.www;
  r7.y = r1.y * r1.z + r5.w;
  r8.xyz = r1.zzz * float3(0.0399999991,0.0399999991,0.0399999991) + r15.xyz;
  r1.yw = gameTime.ww * wobbleScroll.xy;
  r1.yw = v2.xy * wobbleScale.xy + r1.yw;
  r1.yw = wobbleMap.Sample(normalSampler_s, r1.yw).xy;
  r1.yw = r1.yw * float2(1.9921875,1.9921875) + float2(-1,-1);
  r1.yw = renderTargetSize.zw * r1.yw;
  r3.w = cmp(0.5 < uvMotionToggle1);
  if (r3.w != 0) {
    r3.w = rowCount * columnCount;
    r4.w = imageTime * r3.w;
    ...
    r3.w = r4.w * r3.w;
    r3.w = round(r3.w);
    r4.w = r3.w / columnCount;
    r5.w = columnCount * r3.w;
    r5.w = cmp(r5.w >= -r5.w);
    ...
    r6.zw = r6.zw * scaleUVs.xy + r14.xy;
    ...
    r11.xy = clampU ? r7.zw : r6.zw;
  }
  r6.zw = r1.yw * layer1Wobble + r11.xy;
  r11.xyzw = emissiveMap1.Sample(colorSampler_s, r6.zw).xyzw;
  r11.xyzw = emissiveTint1.xyzw * r11.xyzw;
  r11.xyz = r11.xyz * r11.www;
  r3.w = v3.x + v3.y;
  r3.w = v3.z + r3.w;
  r4.w = flickerSeed.y + r3.w;
  r4.w = frac(r4.w);
  r12.y = gameTime.w * flickerSpeed + r4.w;
  r12.x = flickerSeed.x;
  r4.w = flickerLookupMap.SampleLevel(lookupSampler_s, r12.xy, 0).x;
  r4.w = log2(abs(r4.w));
  r4.w = flickerPower * r4.w;
  r4.w = exp2(r4.w);
  r5.w = flickerRange.y + -flickerRange.x;
  r4.w = r4.w * r5.w + flickerRange.x;
  r11.xyz = r11.xyz * r4.www;
  r4.w = cmp(0.5 < uvMotionToggle2);
  if (r4.w != 0) {
    r4.w = columnCount2 * rowCount2;
    r5.w = imageTime2 * r4.w;
    ...
    r4.w = r5.w * r4.w;
    r4.w = round(r4.w);
    r5.w = r4.w / columnCount2;
    r6.z = columnCount2 * r4.w;
    r6.z = cmp(r6.z >= -r6.z);
    r6.z = r6.z ? columnCount2 : -columnCount2;
    r6.w = 1 / r6.z;
    r4.w = r6.w * r4.w;
    r4.w = frac(r4.w);
    r4.w = r6.z * r4.w;
    r4.w = trunc(r4.w);
    r4.w = v2.x + r4.w;
    r12.x = r4.w / columnCount2;
    r4.w = trunc(r5.w);
    r4.w = v2.y + r4.w;
    r12.y = r4.w / rowCount2;
  } else {
    r4.w = dot(-v7.xyz, -v7.xyz);
    r4.w = rsqrt(r4.w);
    r13.xyz = -v7.xyz * r4.www;
    r14.x = dot(r13.xyz, r4.xyz);
    r14.y = dot(r13.xyz, r5.xyz);
    r4.w = dot(r13.xyz, r3.xyz);
    r5.w = cmp(0 < r4.w);
    r6.zw = -r14.xy / r4.ww;
    r6.zw = r5.ww ? r6.zw : 0;
    r7.zw = float2(-0.5,-0.5) + v2.xy;
    r4.w = 9.99999975e-06 + layer2Depth;
    r6.zw = r6.zw * r4.ww;
    r6.zw = scaleUVs2.xy * r6.zw;
    r6.zw = r7.zw * scaleUVs2.xy + r6.zw;
    r6.zw = offsetUVs2.xy * scaleUVs2.xy + r6.zw;
    r4.w = rotateUVs2.y * gameTime.w + 1;
    r4.w = rotateUVs2.x * r4.w;
    r4.w = 0.0174532924 * r4.w;
    sincos(r4.w, r13.x, r14.x);
    r14.y = r14.x;
    r14.z = r13.x;
    ...
    r4.w = gameTime.w * zoomRate2;
    r4.w = cos(r4.w);
    r4.w = r4.w * 0.5 + 0.5;
    r4.w = 1 + -r4.w;
    r5.w = zoomUVs2.y + -zoomUVs2.x;
    r4.w = r4.w * r5.w + zoomUVs2.x;
    r6.zw = r6.zw / r4.ww;
    r6.zw = float2(0.5,0.5) + r6.zw;
    r7.zw = saturate(r6.zw);
  ...
  r6.zw = r1.yw * layer2Wobble + r12.xy;
  r12.xyzw = emissiveMap2.Sample(colorSampler_s, r6.zw).xyzw;
  r12.xyz = emissiveTint2.xyz * r12.xyz;
  r4.w = hdrScale * r12.w;
  r12.xyz = r12.xyz * r4.www;
  r4.w = clampV2 + r3.w;
  r4.w = frac(r4.w);
  r13.y = gameTime.w * clampV2 + r4.w;
  r13.x = clampV2;
  r4.w = flickerLookupMap.SampleLevel(lookupSampler_s, r13.xy, 0).x;
  r4.w = log2(abs(r4.w));
  r4.w = flickerPower2 * r4.w;
  r4.w = exp2(r4.w);
  r5.w = flickerRange2.y + -flickerRange2.x;
  r4.w = r4.w * r5.w + flickerRange2.x;
  r12.xyz = r12.xyz * r4.www;
  r4.w = 1 + -r12.w;
  r11.xyz = r11.xyz * r4.www + r12.xyz;
  r4.w = cmp(0.5 < uvMotionToggle3);
  if (r4.w != 0) {
    r4.w = columnCount3 * rowCount3;
    r5.w = imageTime3 * r4.w;
    r6.z = gameTime.w * r5.w;
    r6.z = cmp(r6.z >= -r6.z);
    r6.z = r6.z ? r5.w : -r5.w;
    r6.w = 1 / r6.z;
    ...
    r4.w = r5.w * r4.w;
    r4.w = round(r4.w);
    r5.w = r4.w / columnCount3;
    r6.z = columnCount3 * r4.w;
    r6.z = cmp(r6.z >= -r6.z);
    r6.z = r6.z ? columnCount3 : -columnCount3;
    r6.w = 1 / r6.z;
    r4.w = r6.w * r4.w;
    r4.w = frac(r4.w);
    r4.w = r6.z * r4.w;
    r4.w = trunc(r4.w);
    r4.w = v2.x + r4.w;
    r12.x = r4.w / columnCount3;
    r4.w = trunc(r5.w);
    r4.w = v2.y + r4.w;
    r12.y = r4.w / rowCount3;
  } else {
    r4.w = dot(-v7.xyz, -v7.xyz);
    r4.w = rsqrt(r4.w);
    r13.xyz = -v7.xyz * r4.www;
    ...
    r3.x = dot(r13.xyz, r3.xyz);
    r3.y = cmp(0 < r3.x);
    r3.xz = -r4.xy / r3.xx;
    r3.xy = r3.yy ? r3.xz : 0;
    r4.xy = float2(-0.5,-0.5) + v2.xy;
    r3.z = 9.99999975e-06 + layer3Depth;
    r3.xy = r3.xy * r3.zz;
    r3.xy = scaleUVs3.xy * r3.xy;
    r3.xy = r4.xy * scaleUVs3.xy + r3.xy;
    ...
    r3.z = r3.z * r4.x + zoomUVs3.x;
    r3.xy = r3.xy / r3.zz;
    r3.xy = float2(0.5,0.5) + r3.xy;
    r4.xy = saturate(r3.xy);
    r12.x = clampU3 ? r4.x : r3.x;
    r12.y = clampV3 ? r4.y : r3.y;
  }
  r1.yw = r1.yw * layer3Wobble + r12.xy;
  r4.xyzw = emissiveMap3.Sample(colorSampler_s, r1.yw).xyzw;
  r3.xyz = emissiveTint3.xyz * r4.xyz;
  r1.y = hdrScale * r4.w;
  ...
  r1.y = r1.y * r1.w + flickerRange3.x;
  r3.xyz = r3.xyz * r1.yyy;
  r1.y = 1 + -r4.w;
  r3.xyz = r11.xyz * r1.yyy + r3.xyz;
  ...
  if (r5.w != 0) {
    ...
    r12.yzw = r21.xyz * r5.yyy + r15.xyz;
    r13.w = 0;
  ...
  r1.x = r6.z * r1.x;
  r2.w = r6.z * r2.w;
  r6.z = dot(r2.xyz, sunConstants.wldDir.xyz);
  r6.w = saturate(r6.z);
  r7.y = cmp(0 >= r6.w);
  if (r7.y != 0) {
    r7.z = 0;
  ...
  if (r7.y != 0) {
    ...
    if (r7.y != 0) {
      ...
      r6.w = r7.z * r6.w;
      r6.w = 0.25 * r6.w;
      r7.yzw = r6.www * r9.xyz + r5.yzw;
      r1.y = saturate(1 + -r1.y);
      r8.w = r1.y * r1.y;
      r8.w = r8.w * r8.w;
      r1.y = r8.w * r1.y;
      r1.y = r6.w * r1.y;
      r9.xyz = r1.yyy * r9.yzx + r14.xyz;
      r16.w = r9.z;
      r15.w = r14.z;
      r15.xyzw = r6.zzzz ? r16.xyzw : r15.xyzw;
      r9.zw = r7.yz;
      r14.zw = r5.yz;
      r9.xyzw = r6.zzzz ? r9.xyzw : r14.xyzw;
      r5.w = r6.z ? r7.w : r5.w;
      r14.z = r15.w;
      r14.xy = r9.xy;
      r5.yz = r9.zw;
  ...
  while (true) {
    ...
    if (r8.w != 0) break;
    r7.z = (uint)r7.w >> 5;
    r16.xyz = (int3)r7.xyz + (int3)r10.xyz;
            ...
            if (r26.w != 0) {
              ...
              if (r26.w != 0) {
                ...
                if (r26.w != 0) {
                      ...
                      r14.w = samp0[]..swiz;
                        ...
                        if (r8.w != 0) {
                          ...
                          while (true) {
                            ...
                            if (r29.w != 0) break;
                            r41.x = dot(icb[r27.w+0].xy, r11.xy);
                            r41.y = dot(icb[r27.w+0].yx, r11.xz);
                  ...
                  r14.w = r14.w + -r25.w;
                  r14.w = r4.w * r14.w + r25.w;
                  r14.w = r14.w * r20.w;
                  r32.x = r31.x;
                  r15.w = cmp(0 < r24.w);
                  r19.xyz = r14.www * r32.xyz + r16.xyz;
                  r14.w = saturate(dot(r2.xyz, r39.xyz));
                  r38.xyz = r38.xyz * r13.www + r4.xyz;
                  r13.w = dot(r38.xyz, r38.xyz);
                  r13.w = rsqrt(r13.w);
                  r38.xyz = r38.xyz * r13.www;
                  r13.w = dot(r38.xyz, r4.xyz);
                  r18.x = dot(r2.xyz, r38.xyz);
                  r24.w = abs(r18.x) * r1.w + -abs(r18.x);
                  r18.x = abs(r18.x) * r24.w + 1;
                  r24.w = r14.w * r1.x + r2.w;
                  r18.x = r18.x * r18.x;
                  r18.x = r18.x * r24.w;
                  r18.x = rcp(r18.x);
                  r14.w = r14.w * r26.w;
