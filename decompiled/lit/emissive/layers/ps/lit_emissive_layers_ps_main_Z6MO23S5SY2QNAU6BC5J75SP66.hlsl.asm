...
mul r1.yw, cb0[34].xxxy, cb1[69].wwww
mad r1.yw, v2.xxxy, cb0[34].zzzw, r1.yyyw
sample_indexable(texture2d)(float,float,float,float) r1.yw, r1.ywyy, t38.zxwy, s5
mad r1.yw, r1.yyyw, l(0.000000, 1.99218750, 0.000000, 1.99218750), l(0.000000, -1.000000, 0.000000, -1.000000)
mul r1.yw, r1.yyyw, cb1[44].zzzw
...
if_nz r3.w
  ...
  round_z r3.w, r3.w
  add r3.w, r3.w, v2.x
  div r11.x, r3.w, cb0[11].w
  round_z r3.w, r4.w
  add r3.w, r3.w, v2.y
  div r11.y, r3.w, cb0[11].z
else 
  ...
  mad r6.zw, r6.zzzw, cb0[13].zzzw, r14.xxxy
  ...
  movc r11.xy, cb0[15].zwzz, r7.zwzz, r6.zwzz
endif 
mad r6.zw, r1.yyyw, cb0[35].xxxx, r11.xxxy
sample_indexable(texture2d)(float,float,float,float) r11.xyzw, r6.zwzz, t29.xyzw, s1
...
frc r4.w, r4.w
mad r12.y, cb1[69].w, cb0[16].z, r4.w
mov r12.x, cb0[16].x
sample_l_indexable(texture2d)(float,float,float,float) r4.w, r12.xyxx, t26.yzwx, s7, l(0.000000)
log r4.w, |r4.w|
...
if_nz r4.w
  ...
  mul r6.z, r4.w, cb0[21].x
  ge r6.z, r6.z, -r6.z
  movc r6.z, r6.z, cb0[21].x, -cb0[21].x
  div r6.w, l(1.000000, 1.000000, 1.000000, 1.000000), r6.z
  mul r4.w, r4.w, r6.w
  frc r4.w, r4.w
  mul r4.w, r4.w, r6.z
...
mad r6.zw, r1.yyyw, cb0[35].yyyy, r12.xxxy
sample_indexable(texture2d)(float,float,float,float) r12.xyzw, r6.zwzz, t30.xyzw, s1
mul r12.xyz, r12.xyzx, cb0[20].xyzx
mul r4.w, r12.w, cb0[18].w
mul r12.xyz, r4.wwww, r12.xyzx
add r4.w, r3.w, cb0[25].z
frc r4.w, r4.w
mad r13.y, cb1[69].w, cb0[25].w, r4.w
mov r13.x, cb0[25].y
sample_l_indexable(texture2d)(float,float,float,float) r4.w, r13.xyxx, t26.yzwx, s7, l(0.000000)
log r4.w, |r4.w|
...
if_nz r4.w
  ...
  ge r6.z, r6.z, -r6.z
  movc r6.z, r6.z, cb0[28].x, -cb0[28].x
  div r6.w, l(1.000000, 1.000000, 1.000000, 1.000000), r6.z
  mul r4.w, r4.w, r6.w
  frc r4.w, r4.w
  mul r4.w, r4.w, r6.z
  round_z r4.w, r4.w
  add r4.w, r4.w, v2.x
  div r12.x, r4.w, cb0[28].x
  round_z r4.w, r5.w
  add r4.w, r4.w, v2.y
  div r12.y, r4.w, cb0[27].w
else 
  dp3 r4.w, -v7.xyzx, -v7.xyzx
  rsq r4.w, r4.w
  mul r13.xyz, r4.wwww, -v7.xyzx
  ...
  add r3.z, cb0[31].y, l(0.000010)
  mul r3.xy, r3.zzzz, r3.xyxx
  mul r3.xy, r3.xyxx, cb0[29].zwzz
  mad r3.xy, r4.xyxx, cb0[29].zwzz, r3.xyxx
  ...
  mad r3.z, r3.z, r4.x, cb0[30].z
  div r3.xy, r3.xyxx, r3.zzzz
  add r3.xy, r3.xyxx, l(0.500000, 0.500000, 0.000000, 0.000000)
  mov_sat r4.xy, r3.xyxx
  movc r12.x, cb0[31].w, r4.x, r3.x
  movc r12.y, cb0[32].x, r4.y, r3.y
endif 
mad r1.yw, r1.yyyw, cb0[35].zzzz, r12.xxxy
sample_indexable(texture2d)(float,float,float,float) r4.xyzw, r1.ywyy, t37.xyzw, s1
mul r3.xyz, r4.xyzx, cb0[27].xyzx
mul r1.y, r4.w, cb0[18].w
mul r3.xyz, r1.yyyy, r3.xyzx
add r1.y, r3.w, cb0[32].z
frc r1.y, r1.y
...
ret 
// Approximately 2480 instruction slots used
