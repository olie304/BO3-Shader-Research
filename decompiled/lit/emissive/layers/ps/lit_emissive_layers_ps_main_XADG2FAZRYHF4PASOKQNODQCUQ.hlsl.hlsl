...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  if (r1.x != 0) {
    ...
    r12.y = r12.x;
    r12.z = r3.x;
    r13.x = dot(r12.yz, r1.xw);
    r12.x = -r3.x;
    r13.y = dot(r12.xy, r1.xw);
    r1.xw = gameTime.ww * scrollUVs.xy;
    r1.xw = r1.xw * scaleUVs.xy + r13.xy;
  ...
  if (r1.w != 0) {
    ...
    r1.w = r1.w * 0.5 + 0.5;
    r1.w = 1 + -r1.w;
    r3.x = zoomUVs2.y + -zoomUVs2.x;
    r1.w = r1.w * r3.x + zoomUVs2.x;
    r7.zw = r7.zw / r1.ww;
  ...
  r1.w = exp2(r1.w);
  r3.x = flickerRange2.y + -flickerRange2.x;
  r1.w = r1.w * r3.x + flickerRange2.x;
  r12.xyz = r12.xyz * r1.www;
  r1.w = 1 + -r12.w;
