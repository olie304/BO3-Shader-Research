...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:33:18 2021
//
//
// Buffer Definitions: 
//
...
sample_indexable(texture2d)(float,float,float,float) r2.x, r0.xyxx, t24.xyzw, s3
add r2.y, -cb0[11].x, cb0[11].y
mad r2.x, r2.x, r2.y, cb0[11].x
mul_sat r2.x, r2.x, l(0.05882353)
sample_indexable(texture2d)(float,float,float,float) r3.xyz, r0.xyxx, t22.xyzw, s5
...
if_nz r2.z
  ftoi r2.z, cb1[64].w
  lod r2.w, r0.xyxx, t0.y, s1
  lod r0.x, r0.xyxx, t0.x, s1
  lt r0.y, r2.w, r0.x
  lt r0.x, l(0.000000), r0.x
  and r3.xyw, r2.zzzz, l(1, 2, 0, 4)
  movc r8.xyz, r3.xxxx, l(1.000000,0,1.000000,0), r1.xyzx
  movc r9.xyz, r3.yyyy, l(0,1.000000,1.000000,0), r1.xyzx
  movc r8.xyz, r0.xxxx, r8.xyzx, r9.xyzx
  movc r3.xyw, r3.wwww, l(0,1.000000,0,0), r1.xyxz
  movc r1.xyz, r0.yyyy, r8.xyzx, r3.xywx
endif 
...
mad r1.xyz, r1.xyzx, r1.wwww, r15.xyzx
mad o0.w, r0.x, r1.w, r14.x
mad r2.xyz, r2.xyzx, r1.wwww, r16.xyzx
dp3 r0.x, r2.xyzx, r2.xyzx
rsq r0.x, r0.x
mul r2.xyz, r0.xxxx, r2.xyzx
mad r0.y, r0.y, r1.w, r14.y
mad r3.xyz, r3.xywx, r1.wwww, r17.xyzx
lt r3.w, l(0.500000), cb0[19].x
if_nz r3.w
  mul r3.w, cb0[11].w, cb0[11].z
  mul r4.w, r3.w, cb0[12].x
  ...
  mul r3.w, r3.w, r4.w
  round_ne r3.w, r3.w
  div r4.w, r3.w, cb0[11].w
  mul r5.w, r3.w, cb0[11].w
  ge r5.w, r5.w, -r5.w
  movc r5.w, r5.w, cb0[11].w, -cb0[11].w
  div r6.w, l(1.000000, 1.000000, 1.000000, 1.000000), r5.w
  mul r3.w, r3.w, r6.w
  frc r3.w, r3.w
  mul r3.w, r3.w, r5.w
  ...
  div r7.zw, r7.zzzw, r3.wwww
  add r7.zw, r7.zzzw, l(0.000000, 0.000000, 0.500000, 0.500000)
  mov_sat r8.zw, r7.zzzw
  movc r8.xy, cb0[15].zwzz, r8.zwzz, r7.zwzz
endif 
sample_indexable(texture2d)(float,float,float,float) r8.xyzw, r8.xyxx, t29.xyzw, s1
mul r8.xyzw, r8.xyzw, cb0[18].xyzw
mul r8.xyz, r8.wwww, r8.xyzx
add r3.w, v2.y, v2.x
add r3.w, r3.w, v2.z
add r4.w, r3.w, cb0[16].y
frc r4.w, r4.w
mad r9.y, cb1[69].w, cb0[16].z, r4.w
mov r9.x, cb0[16].x
sample_l_indexable(texture2d)(float,float,float,float) r4.w, r9.xyxx, t26.yzwx, s7, l(0.000000)
log r4.w, |r4.w|
mul r4.w, r4.w, cb0[17].z
exp r4.w, r4.w
add r5.w, -cb0[17].x, cb0[17].y
mad r4.w, r4.w, r5.w, cb0[17].x
mul r8.xyz, r4.wwww, r8.xyzx
lt r4.w, l(0.500000), cb0[24].z
if_nz r4.w
  mul r4.w, cb0[20].w, cb0[21].x
  mul r5.w, r4.w, cb0[21].y
  mul r6.w, r5.w, cb1[69].w
  ge r6.w, r6.w, -r6.w
  movc r6.w, r6.w, r5.w, -r5.w
  div r7.z, l(1.000000, 1.000000, 1.000000, 1.000000), r6.w
  mul r7.z, r7.z, cb1[69].w
  frc r7.z, r7.z
  mul r6.w, r6.w, r7.z
  div r5.w, r6.w, r5.w
  mul r4.w, r4.w, r5.w
  round_ne r4.w, r4.w
  div r5.w, r4.w, cb0[21].x
  mul r6.w, r4.w, cb0[21].x
  ge r6.w, r6.w, -r6.w
  movc r6.w, r6.w, cb0[21].x, -cb0[21].x
  div r7.z, l(1.000000, 1.000000, 1.000000, 1.000000), r6.w
  mul r4.w, r4.w, r7.z
  frc r4.w, r4.w
  mul r4.w, r4.w, r6.w
  round_z r4.w, r4.w
  add r4.w, r4.w, v1.y
  div r9.x, r4.w, cb0[21].x
  round_z r4.w, r5.w
  add r4.w, r4.w, v1.z
  div r9.y, r4.w, cb0[20].w
else 
  dp3 r4.w, -v6.xyzx, -v6.xyzx
  rsq r4.w, r4.w
  mul r10.xyz, r4.wwww, -v6.xyzx
  dp3 r11.x, r10.xyzx, r5.xyzx
  dp3 r11.y, r10.xyzx, r6.xyzx
  dp3 r4.w, r10.xyzx, r4.xyzx
  lt r5.w, l(0.000000), r4.w
  div r7.zw, -r11.xxxy, r4.wwww
  and r7.zw, r5.wwww, r7.zzzw
  add r9.zw, v1.yyyz, l(0.000000, 0.000000, -0.500000, -0.500000)
  add r4.w, cb0[24].y, l(0.000010)
  ...
  mad r4.w, cb0[21].w, cb1[69].w, l(1.000000)
  mul r4.w, r4.w, cb0[21].z
  ...
  mul r4.w, cb0[24].x, cb1[69].w
  sincos null, r4.w, r4.w
  mad r4.w, r4.w, l(0.500000), l(0.500000)
  add r4.w, -r4.w, l(1.000000)
  add r5.w, -cb0[23].z, cb0[23].w
  mad r4.w, r4.w, r5.w, cb0[23].z
  div r7.zw, r7.zzzw, r4.wwww
  add r7.zw, r7.zzzw, l(0.000000, 0.000000, 0.500000, 0.500000)
  mov_sat r9.zw, r7.zzzw
  movc r9.x, cb0[24].w, r9.z, r7.z
  movc r9.y, cb0[25].x, r9.w, r7.w
endif 
sample_indexable(texture2d)(float,float,float,float) r9.xyzw, r9.xyxx, t30.xyzw, s1
mul r9.xyz, r9.xyzx, cb0[20].xyzx
mul r4.w, r9.w, cb0[18].w
mul r9.xyz, r4.wwww, r9.xyzx
add r4.w, r3.w, cb0[25].z
frc r4.w, r4.w
mad r10.y, cb1[69].w, cb0[25].w, r4.w
mov r10.x, cb0[25].y
sample_l_indexable(texture2d)(float,float,float,float) r4.w, r10.xyxx, t26.yzwx, s7, l(0.000000)
log r4.w, |r4.w|
mul r4.w, r4.w, cb0[26].z
exp r4.w, r4.w
add r5.w, -cb0[26].x, cb0[26].y
mad r4.w, r4.w, r5.w, cb0[26].x
mul r9.xyz, r4.wwww, r9.xyzx
add r4.w, -r9.w, l(1.000000)
mad r8.xyz, r8.xyzx, r4.wwww, r9.xyzx
lt r4.w, l(0.500000), cb0[31].z
if_nz r4.w
  mul r4.w, cb0[27].w, cb0[28].x
  mul r5.w, r4.w, cb0[28].y
  mul r6.w, r5.w, cb1[69].w
  ge r6.w, r6.w, -r6.w
  movc r6.w, r6.w, r5.w, -r5.w
  div r7.z, l(1.000000, 1.000000, 1.000000, 1.000000), r6.w
  ...
  mul r4.w, r4.w, r5.w
  round_ne r4.w, r4.w
  div r5.w, r4.w, cb0[28].x
  mul r6.w, r4.w, cb0[28].x
  ge r6.w, r6.w, -r6.w
  movc r6.w, r6.w, cb0[28].x, -cb0[28].x
  div r7.z, l(1.000000, 1.000000, 1.000000, 1.000000), r6.w
  mul r4.w, r4.w, r7.z
  frc r4.w, r4.w
  mul r4.w, r4.w, r6.w
  round_z r4.w, r4.w
  add r4.w, r4.w, v1.y
  div r9.x, r4.w, cb0[28].x
  round_z r4.w, r5.w
  add r4.w, r4.w, v1.z
  div r9.y, r4.w, cb0[27].w
else 
  dp3 r4.w, -v6.xyzx, -v6.xyzx
  rsq r4.w, r4.w
  mul r10.xyz, r4.wwww, -v6.xyzx
  dp3 r5.x, r10.xyzx, r5.xyzx
  dp3 r5.y, r10.xyzx, r6.xyzx
  dp3 r4.x, r10.xyzx, r4.xyzx
  lt r4.y, l(0.000000), r4.x
  div r4.xz, -r5.xxyx, r4.xxxx
  and r4.xy, r4.xzxx, r4.yyyy
  add r4.zw, v1.yyyz, l(0.000000, 0.000000, -0.500000, -0.500000)
  add r5.x, cb0[31].y, l(0.000010)
  mul r4.xy, r4.xyxx, r5.xxxx
  mul r4.xy, r4.xyxx, cb0[29].zwzz
  mad r4.xy, r4.zwzz, cb0[29].zwzz, r4.xyxx
  mad r4.xy, cb0[30].xyxx, cb0[29].zwzz, r4.xyxx
  mad r4.z, cb0[28].w, cb1[69].w, l(1.000000)
  mul r4.z, r4.z, cb0[28].z
  mul r4.z, r4.z, l(0.01745329)
  sincos r5.x, r6.x, r4.z
  mov r6.y, r6.x
  mov r6.z, r5.x
  dp2 r10.x, r6.yzyy, r4.xyxx
  mov r6.x, -r5.x
  dp2 r10.y, r6.xyxx, r4.xyxx
  mul r4.xy, cb0[29].xyxx, cb1[69].wwww
  mad r4.xy, r4.xyxx, cb0[29].zwzz, r10.xyxx
  mul r4.z, cb0[31].x, cb1[69].w
  sincos null, r4.z, r4.z
  mad r4.z, r4.z, l(0.500000), l(0.500000)
  add r4.z, -r4.z, l(1.000000)
  add r4.w, -cb0[30].z, cb0[30].w
  mad r4.z, r4.z, r4.w, cb0[30].z
  div r4.xy, r4.xyxx, r4.zzzz
  add r4.xy, r4.xyxx, l(0.500000, 0.500000, 0.000000, 0.000000)
  mov_sat r4.zw, r4.xxxy
  movc r9.x, cb0[31].w, r4.z, r4.x
  movc r9.y, cb0[32].x, r4.w, r4.y
endif 
sample_indexable(texture2d)(float,float,float,float) r4.xyzw, r9.xyxx, t37.xyzw, s1
mul r4.xyz, r4.xyzx, cb0[27].xyzx
mul r5.x, r4.w, cb0[18].w
mul r4.xyz, r4.xyzx, r5.xxxx
add r3.w, r3.w, cb0[32].z
frc r3.w, r3.w
mad r5.y, cb1[69].w, cb0[32].w, r3.w
mov r5.x, cb0[32].y
sample_l_indexable(texture2d)(float,float,float,float) r3.w, r5.xyxx, t26.yzwx, s7, l(0.000000)
log r3.w, |r3.w|
mul r3.w, r3.w, cb0[33].z
exp r3.w, r3.w
add r5.x, -cb0[33].x, cb0[33].y
mad r3.w, r3.w, r5.x, cb0[33].x
mul r4.xyz, r3.wwww, r4.xyzx
add r3.w, -r4.w, l(1.000000)
mad r4.xyz, r8.xyzx, r3.wwww, r4.xyzx
...
utof r6.xy, r7.yxyy
dp2 r4.w, r6.yxyy, l(0.06711056, 0.00583715, 0.000000, 0.000000)
frc r4.w, r4.w
mul r4.w, r4.w, l(52.982918)
frc r4.w, r4.w
mad r4.w, r4.w, l(6.28318548), cb1[70].w
sincos r8.x, r9.x, r4.w
dp2 r4.w, r6.xyxx, l(0.06711056, 0.00583715, 0.000000, 0.000000)
frc r4.w, r4.w
mul r4.w, r4.w, l(52.982918)
frc r4.w, r4.w
mad r4.w, r4.w, l(6.28318548), cb1[70].w
sincos r6.x, r10.x, r4.w
dp3_sat r0.x, r2.xyzx, r5.xyzx
...
loop 
  ...
  sqrt r10.w, r10.w
  mad r10.w, r6.y, l(5.000000), r10.w
    ...
    if_nz r16.z
      ...
      if_nz r8.w
        ...
        loop 
          ...
          movc r7.y, r18.w, r16.w, r21.z
          movc r29.xy, r18.zzzz, r29.xyxx, r7.xyxx
          iadd r16.z, r16.z, l(1)
          mov r15.w, r17.w
        endloop 
        mov_sat r29.y, r29.y
        mul r7.y, r10.z, r29.y
        lt r15.w, l(0.000000), r7.y
        if_nz r15.w
          mad r30.z, r29.y, r10.z, r27.w
          mul r7.y, r27.x, r7.y
          mul r29.xzw, r7.yyyy, r25.xxyz
          ...
          mul r16.z, r7.z, r15.w
          mul r29.xzw, r7.yyyy, r22.xxyz
          dp3 r7.y, r29.xzwx, l(0.212600, 0.715200, 0.072200, 0.000000)
          mad r7.y, r7.z, r15.w, r7.y
          div r7.y, r16.z, r7.y
          mov r32.x, r28.w
          mov r32.yz, r27.yyzy
          mad r30.xyw, r29.zwzx, r7.yyyy, r32.yzyx
          mov r31.w, r30.w
        else 
...
if_z r0.w
  ...
  if_nz r6.y
    ...
    mul r13.x, r7.x, cb2[35].w
    mul r13.yz, r7.yyzy, cb2[36].xxyx
    add_sat r7.xyz, r13.xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
    mul r13.xy, r7.xyxx, cb2[36].zwzz
    mul r13.z, r7.z, cb2[37].x
    add r7.xyz, r13.xyzx, cb2[37].yzwy
    lt r10.yzw, l(0.000000, 0.000000, 0.000000, 0.000000), r2.xxyz
    movc r13.xyz, r10.yzwy, l(0,0,0,0), l(0.500000,0.500000,0.500000,0)
    mov r13.w, l(0)
    add r10.yzw, r7.xxyz, r13.wwwx
    ...
    add r7.xyz, r7.xyzx, r13.wwzw
    sample_l_indexable(texture3d)(float,float,float,float) r7.xyz, r7.xyzx, t19.xyzw, s4, l(0.000000)
    mad r7.xyz, r7.xyzx, r14.zzzz, r10.yzwy
    mov r2.w, l(0)
    sample_l_indexable(texturecubearray)(float,float,float,float) r10.yzw, r2.xyzw, t8.wxyz, s2, l(6.000000)
    mul r7.xyz, r7.xyzx, r10.yzwy
    dp3 r2.w, r7.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
    mad r19.xyz, r22.xyzx, r0.wwww, r7.xyzx
    mov r11.w, l(0)
    sample_l_indexable(texturecubearray)(float,float,float,float) r7.xyz, r11.xyzw, t8.xyzw, s2, r6.z
    mad r0.w, cb2[19].x, r6.y, -r2.w
    mad r0.w, r0.y, r0.w, r2.w
    mad r20.xyz, r7.xyzx, r0.wwww, r20.xyzx
  endif 
else 
  mov r20.x, r19.w
endif 
...
mul r6.yzw, r0.wwww, r20.xxyz
mul r13.xyz, r0.yyyy, r6.zwyz
mul r0.yzw, r0.zzzz, r6.yyzw
sqrt r2.w, r5.w
mad r2.w, r2.w, l(0.500000), l(0.500000)
mul r2.w, r2.w, r2.w
mul r6.y, r2.w, l(0.500000)
mad r2.w, -r2.w, l(0.500000), l(1.000000)
mad r6.z, r0.x, r2.w, r6.y
mul r2.w, r2.w, r6.z
mul r6.y, r6.z, r6.y
dp3 r6.z, r2.xyzx, cb2[17].xyzx
mov_sat r6.w, r6.z
ge r8.z, l(0.000000), r6.w
if_nz r8.z
  mov r8.w, l(0)
endif 
if_z r8.z
  ...
  add r8.z, r10.w, -cb2[17].w
  mad r8.z, -r8.z, l(0.00006104), l(1.000000)
  mov_sat r9.w, r8.z
  eq r9.w, r8.z, r9.w
  if_nz r9.w
    mov r9.w, l(0)
  ...
  if_z r12.w
    if_z cb2[58].y
      ...
      sample_c_lz_indexable(texture2darray)(float,float,float,float) r10.w, r14.xyzx, t13.xxxx, s13, r8.z
    ...
    if_nz cb2[58].y
      ...
      loop 
        ...
        utof r16.z, r15.z
        sample_c_lz_indexable(texture2darray)(float,float,float,float) r15.z, r16.xyzx, t13.xxxx, s13, r8.z
...
if_nz r8.z
  lt r8.z, l(0.000000), r8.w
  if_nz r8.z
    mul r8.z, r4.w, cb2[18].w
    mul r8.z, r6.w, r8.z
    if_nz cb2[23].x
    ...
    if_nz r11.w
      ...
      mad r12.w, |r6.z|, l(-0.200000), l(0.400000)
    ...
    add r9.w, -r6.w, r9.w
    mad r9.w, r5.w, r9.w, r6.w
    mul r9.w, r8.w, r9.w
    lt r6.z, l(0.000000), r6.z
    mad r14.xyz, r9.wwww, r10.yzwy, r7.xyzx
    ...
    mad r11.w, |r9.w|, r4.w, -|r9.w|
    mad r9.w, |r9.w|, r11.w, l(1.000000)
    mad r6.w, r6.w, r2.w, r6.y
    mul r9.w, r9.w, r9.w
    mul r6.w, r6.w, r9.w
    rcp r6.w, r6.w
    mul r6.w, r8.z, r6.w
    ...
    mad r15.xyz, r6.wwww, r10.yzwy, r0.yzwy
    ...
    mov r14.w, r16.z
    mov r7.w, r13.z
    movc r7.xyzw, r6.zzzz, r14.xyzw, r7.xyzw
    mov r16.zw, r15.xxxy
    mov r13.zw, r0.yyyz
    movc r14.xyzw, r6.zzzz, r16.xyzw, r13.xyzw
    movc r0.w, r6.z, r15.z, r0.w
    mov r13.z, r7.w
    mov r13.xy, r14.xyxx
    mov r0.yz, r14.zzwz
  endif 
...
movc r1.xyz, cb0[19].yyyy, r1.xyzx, r4.xyzx
...
ret 
// Approximately 3163 instruction slots used
