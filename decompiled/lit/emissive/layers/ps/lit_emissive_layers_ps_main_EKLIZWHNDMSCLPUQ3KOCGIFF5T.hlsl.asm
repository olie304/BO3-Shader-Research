...
mad r0.xyz, r0.xyzx, r1.wwww, r14.xyzx
mad r0.w, r0.w, r1.w, r13.x
mad r2.xyz, r2.xywx, r1.wwww, r15.xyzx
dp3 r2.w, r2.xyzx, r2.xyzx
rsq r2.w, r2.w
mul r2.xyz, r2.wwww, r2.xyzx
mad r7.y, r1.y, r1.w, r13.y
mad r8.xyz, r1.wwww, l(0.040000, 0.040000, 0.040000, 0.000000), r16.xyzx
mul r6.zw, cb0[34].xxxy, cb1[69].wwww
mad r6.zw, v1.yyyz, cb0[34].zzzw, r6.zzzw
sample_indexable(texture2d)(float,float,float,float) r6.zw, r6.zwzz, t38.zwxy, s5
mad r6.zw, r6.zzzw, l(0.000000, 0.000000, 1.99218750, 1.99218750), l(0.000000, 0.000000, -1.000000, -1.000000)
mul r6.zw, r6.zzzw, cb1[44].zzzw
...
if_nz r1.y
  ...
  div r7.zw, r7.zzzw, r1.yyyy
  add r7.zw, r7.zzzw, l(0.000000, 0.000000, 0.500000, 0.500000)
  mov_sat r9.zw, r7.zzzw
  movc r9.xy, cb0[15].zwzz, r9.zwzz, r7.zwzz
endif 
mad r7.zw, r6.zzzw, cb0[35].xxxx, r9.xxxy
sample_indexable(texture2d)(float,float,float,float) r9.xyzw, r7.zwzz, t29.xyzw, s1
mul r9.xyzw, r9.xyzw, cb0[18].xyzw
mul r9.xyz, r9.wwww, r9.xyzx
add r1.y, v2.y, v2.x
add r1.y, r1.y, v2.z
add r3.w, r1.y, cb0[16].y
frc r3.w, r3.w
mad r10.y, cb1[69].w, cb0[16].z, r3.w
mov r10.x, cb0[16].x
sample_l_indexable(texture2d)(float,float,float,float) r3.w, r10.xyxx, t26.yzwx, s7, l(0.000000)
log r3.w, |r3.w|
...
if_nz r3.w
  ...
  div r7.z, l(1.000000, 1.000000, 1.000000, 1.000000), r5.w
  ...
  round_z r3.w, r3.w
  add r3.w, r3.w, v1.y
  div r10.x, r3.w, cb0[21].x
  round_z r3.w, r4.w
  add r3.w, r3.w, v1.z
  div r10.y, r3.w, cb0[20].w
else 
  dp3 r3.w, -v6.xyzx, -v6.xyzx
  rsq r3.w, r3.w
  mul r11.xyz, r3.wwww, -v6.xyzx
  dp3 r12.x, r11.xyzx, r4.xyzx
  dp3 r12.y, r11.xyzx, r5.xyzx
  dp3 r3.w, r11.xyzx, r3.xyzx
  lt r4.w, l(0.000000), r3.w
  div r7.zw, -r12.xxxy, r3.wwww
  ...
  mad r7.zw, r10.zzzw, cb0[22].zzzw, r7.zzzw
  ...
  add r7.zw, r7.zzzw, l(0.000000, 0.000000, 0.500000, 0.500000)
  mov_sat r10.zw, r7.zzzw
  movc r10.x, cb0[24].w, r10.z, r7.z
  movc r10.y, cb0[25].x, r10.w, r7.w
endif 
mad r7.zw, r6.zzzw, cb0[35].yyyy, r10.xxxy
sample_indexable(texture2d)(float,float,float,float) r10.xyzw, r7.zwzz, t30.xyzw, s1
mul r10.xyz, r10.xyzx, cb0[20].xyzx
mul r3.w, r10.w, cb0[18].w
mul r10.xyz, r3.wwww, r10.xyzx
add r3.w, r1.y, cb0[25].z
frc r3.w, r3.w
mad r11.y, cb1[69].w, cb0[25].w, r3.w
mov r11.x, cb0[25].y
sample_l_indexable(texture2d)(float,float,float,float) r3.w, r11.xyxx, t26.yzwx, s7, l(0.000000)
log r3.w, |r3.w|
...
if_nz r3.w
  ...
  round_z r3.w, r3.w
  add r3.w, r3.w, v1.y
  div r10.x, r3.w, cb0[28].x
  round_z r3.w, r4.w
  add r3.w, r3.w, v1.z
  div r10.y, r3.w, cb0[27].w
else 
  dp3 r3.w, -v6.xyzx, -v6.xyzx
  rsq r3.w, r3.w
  mul r11.xyz, r3.wwww, -v6.xyzx
...
mad r3.xy, r6.zwzz, cb0[35].zzzz, r10.xyxx
...
mad r1.y, r1.y, r4.x, cb0[33].x
mul r3.xyz, r1.yyyy, r3.xyzx
add r1.y, -r3.w, l(1.000000)
mad r3.xyz, r9.xyzx, r1.yyyy, r3.xyzx
...
mul r7.yzw, r1.zzzz, r11.yyzw
mul r14.xyz, r5.zzzz, r7.zwyz
...
if_nz r5.w
  ...
  if_nz r5.w
    ...
    mad r16.xyz, -v6.xyzx, r1.yyyy, cb2[17].xyzx
    dp3 r1.y, r16.xyzx, r16.xyzx
    rsq r1.y, r1.y
    mul r16.xyz, r1.yyyy, r16.xyzx
    dp3 r1.y, r16.xyzx, r4.xyzx
    dp3 r9.z, r2.xyzx, r16.xyzx
    mad r9.w, |r9.z|, r4.w, -|r9.z|
    mad r9.z, |r9.z|, r9.w, l(1.000000)
    mad r5.z, r5.z, r1.x, r1.z
    mul r9.z, r9.z, r9.z
    mul r5.z, r5.z, r9.z
    rcp r5.z, r5.z
    mul r5.z, r5.w, r5.z
    ...
    mad r16.xyz, r5.zzzz, r11.yzwy, r7.yzwy
    add_sat r1.y, -r1.y, l(1.000000)
    mul r5.w, r1.y, r1.y
    mul r5.w, r5.w, r5.w
    mul r1.y, r1.y, r5.w
    mul r1.y, r1.y, r5.z
    mad r17.xyz, r1.yyyy, r11.zwyz, r14.xyzx
    mov r15.w, r17.z
    mov r6.w, r14.z
...
mad r1.xyz, r29.xyzx, r8.xyzx, r1.xyzx
...
ret 
// Approximately 2833 instruction slots used
