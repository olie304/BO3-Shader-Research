...
if_nz r1.w
  ...
  mov r15.y, r15.x
  mov r15.z, r14.x
  dp2 r16.x, r15.yzyy, r7.zwzz
  mov r15.x, -r14.x
  dp2 r16.y, r15.xyxx, r7.zwzz
  mul r7.zw, cb0[22].xxxy, cb1[69].wwww
  mad r7.zw, r7.zzzw, cb0[22].zzzw, r16.xxxy
  ...
  add r7.zw, r7.zzzw, l(0.000000, 0.000000, 0.500000, 0.500000)
  mov_sat r8.zw, r7.zzzw
  movc r13.x, cb0[24].w, r8.z, r7.z
  movc r13.y, cb0[25].x, r8.w, r7.w
endif 
...
mad r12.xyz, r12.xyzx, r1.wwww, r13.xyzx
...
if_nz r1.w
  ...
  movc r13.x, cb0[31].w, r4.x, r1.x
  movc r13.y, cb0[32].x, r4.y, r1.y
endif 
sample_indexable(texture2d)(float,float,float,float) r4.xyzw, r13.xyxx, t38.xyzw, s1
mul r1.xyw, r4.xyxz, cb0[27].xyxz
mul r2.w, r4.w, cb0[18].w
mul r1.xyw, r1.xyxw, r2.wwww
add r0.w, r0.w, cb0[32].z
frc r0.w, r0.w
mad r4.y, cb1[69].w, cb0[32].w, r0.w
mov r4.x, cb0[32].y
sample_l_indexable(texture2d)(float,float,float,float) r0.w, r4.xyxx, t26.yzwx, s7, l(0.000000)
log r0.w, |r0.w|
mul r0.w, r0.w, cb0[33].z
exp r0.w, r0.w
add r2.w, -cb0[33].x, cb0[33].y
mad r0.w, r0.w, r2.w, cb0[33].x
