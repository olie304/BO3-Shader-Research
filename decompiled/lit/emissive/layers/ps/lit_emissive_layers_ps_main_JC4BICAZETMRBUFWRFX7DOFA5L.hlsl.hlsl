...
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r7.zw, v2.w, l(4), t4.xxxy
r7.z = samp0[]..swiz;
r7.w = samp0[]..swiz;
  r10.xy = (int2)r7.ww & int2(268435456,536870912);
  if (r10.x != 0) {
          ...
          r23.z = samp0[]..swiz;
            ...
            r26.w = samp0[]..swiz;
              ...
              r23.w = samp0[]..swiz;
                ...
                r14.xyz = r21.xyz * r12.www + r22.xyz;
                r20.z = r18.y;
                r21.xyz = r20.xyz * r13.zzz;
                r20.xyz = r29.xyz * r12.www + r21.xyz;
                r13.w = r18.w * r13.z;
                r18.z = r18.z * r13.z + r12.w;
                r18.w = r9.w * r12.w + r13.w;
                r18.y = r20.z;
              }
            }
          }
  ...
  if (r10.y != 0) {
    ...
    while (true) {
      ...
      r13.z = (uint)r8.w >> 5;
      r14.xyz = (int3)r12.xyz + (int3)r13.xyz;
      r9.w = visibleDecals.Load(r14.xyzw).x;
      r10.y = cmp((int)r4.w == (int)r8.w);
      bitmask.w = ((~(-1 << r5.w)) << 0) & 0xffffffff;  r12.w = (((uint)0 << 0) & bitmask.w) | ((uint)r9.w & ~bitmask.w);
      r9.w = r10.y ? r12.w : r9.w;
      r10.y = cmp((int)r6.w == (int)r8.w);
      if (r7.w == 0) r12.w = 0; else if (r7.w+0 < 32) {       r12.w = (uint)r9.w << (32-(r7.w + 0)); r12.w = (uint)r12.w >> (32-r7.w);      } else r12.w = (uint)r9.w >> 0;
      r9.w = r10.y ? r12.w : r9.w;
      r10.y = (int)r1.w + (int)r8.w;
      r14.xyz = r18.xyz;
      r22.xyz = r19.xyz;
      r23.xyz = r20.xyz;
      r13.zw = r21.xy;
      ...
      while (true) {
        if (r12.w == 0) break;
        r15.z = firstbitlow((uint)r12.w);
        r15.w = 1 << (int)r15.z;
        r16.w = (int)r12.w & (int)r15.w;
        if (r16.w != 0) {
          r12.w = (int)r12.w ^ (int)r15.w;
          r15.w = (int)r10.y + (int)r15.z;
        // Known bad code for instruction (needs manual fix):
        ...
        r25.y = samp0[]..swiz;
          ...
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=128)(mixed,mixed,mixed,mixed) r24.xyz, r15.z, l(0), t36.xyzx
          r24.x = samp0[]..swiz;
          r24.y = samp0[]..swiz;
          r24.z = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=128)(mixed,mixed,mixed,mixed) r25.xyz, r15.z, l(16), t36.xyzx
          r25.x = samp0[]..swiz;
          r25.y = samp0[]..swiz;
          r25.z = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=128)(mixed,mixed,mixed,mixed) r26.xyz, r15.z, l(32), t36.xyzx
          r26.x = samp0[]..swiz;
          r26.y = samp0[]..swiz;
          r26.z = samp0[]..swiz;
            r27.x = r24.x;
            ...
            r15.w = dot(r28.xyz, r3.xyz);
            r15.w = cmp(r15.w >= 0.5);
            if (r15.w != 0) {
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=128)(mixed,mixed,mixed,mixed) r29.xyw, r15.z, l(48), t36.xyxz
            r29.x = samp0[]..swiz;
            r29.y = samp0[]..swiz;
            r29.w = samp0[]..swiz;
              r27.w = r29.x;
              ...
              if (r15.w != 0) {
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=128)(mixed,mixed,mixed,mixed) r24.xyzw, r15.z, l(64), t36.xyzw
              r24.x = samp0[]..swiz;
              r24.y = samp0[]..swiz;
              r24.z = samp0[]..swiz;
              r24.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=128)(mixed,mixed,mixed,mixed) r25.xyzw, r15.z, l(80), t36.xyzw
              r25.x = samp0[]..swiz;
              r25.y = samp0[]..swiz;
              r25.z = samp0[]..swiz;
              r25.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=128)(mixed,mixed,mixed,mixed) r26.xyzw, r15.z, l(96), t36.xyzw
              r26.x = samp0[]..swiz;
              r26.y = samp0[]..swiz;
              r26.z = samp0[]..swiz;
              r26.w = samp0[]..swiz;
                ...
                if (r32.x != 0) {
                  if (4 == 0) r15.w = 0; else if (4+24 < 32) {                   r15.w = (uint)r25.w << (32-(4 + 24)); r15.w = (uint)r15.w >> (32-4);                  } else r15.w = (uint)r25.w >> 24;
                  r15.w = 1 << (int)r15.w;
                  r16.w = (uint)r25.w >> 28;
                  r16.w = 1 << (int)r16.w;
                  r17.w = cmp((int)r32.x == 4);
                  if (r17.w != 0) {
                    r17.w = (int)r25.w & 4095;
                    if (12 == 0) r18.w = 0; else if (12+12 < 32) {                     r18.w = (uint)r25.w << (32-(12 + 12)); r18.w = (uint)r18.w >> (32-12);                    } else r18.w = (uint)r25.w >> 12;
                    r19.w = (int)r26.w & 1023;
                    r33.xz = (uint2)r15.ww;
                    r33.y = (uint)r16.w;
                ...
                r16.w = cmp(r25.x != 1.000000);
                r17.w = r15.w + r24.w;
                r17.w = saturate(r17.w * r25.x + -r25.x);
                r15.w = r16.w ? r17.w : r15.w;
                if (r32.y != 0) {
                  if (4 == 0) r16.w = 0; else if (4+24 < 32) {                   r16.w = (uint)r26.y << (32-(4 + 24)); r16.w = (uint)r16.w >> (32-4);                  } else r16.w = (uint)r26.y >> 24;
                  r16.w = 1 << (int)r16.w;
                  r17.w = (uint)r26.y >> 28;
                  r17.w = 1 << (int)r17.w;
                  r18.w = cmp((int)r32.y == 2);
                  if (r18.w != 0) {
                    ...
                    r18.w = materialTexMask.SampleGrad(samplerLinearClamp_s, r34.xyz, r32.x, r33.x).x;
                  } else {
                    r19.w = cmp((int)r32.y == 4);
                    if (r19.w != 0) {
                      ...
                      r18.w = materialTexBC7.SampleGrad(samplerLinearClamp_s, r33.xyz, r34.x, r32.x).x;
                    } else {
                      r19.w = (int)r26.y & 4095;
                      if (12 == 0) r25.x = 0; else if (12+12 < 32) {                       r25.x = (uint)r26.y << (32-(12 + 12)); r25.x = (uint)r25.x >> (32-12);                      } else r25.x = (uint)r26.y >> 12;
                      if (10 == 0) r25.w = 0; else if (10+20 < 32) {                       r25.w = (uint)r26.w << (32-(10 + 20)); r25.w = (uint)r25.w >> (32-10);                      } else r25.w = (uint)r26.w >> 20;
                      ...
                      r32.xyz = r35.xyz * r32.xyz;
                      r18.w = materialTexBC3.SampleGrad(samplerLinearClamp_s, r33.xyz, r34.x, r32.x).x;
                    }
                  }
                  r32.xyz = r18.www * float3(0.959999979,0.959999979,0.959999979) + float3(0.0399999991,0.0399999991,0.0399999991);
                ...
                if (r25.x != 0) {
                  r16.w = cmp((int)r25.x == 2);
                  if (r16.w != 0) {
                  // Known bad code for instruction (needs manual fix):
                                    ld_structured_indexable(structured_buffer, stride=128)(mixed,mixed,mixed,mixed) r15.z, r15.z, l(112), t36.xxxx
                  r15.z = samp0[]..swiz;
                    ...
                    r33.xyz = r36.xyz * r33.xyz;
                    r15.z = materialTexMask.SampleGrad(samplerLinearClamp_s, r34.xyz, r35.z, r33.z).x;
                  } else {
                    r16.w = cmp((int)r25.x == 6);
                    r15.z = r16.w ? 0 : 1;
                  }
                } else {
                  r15.z = 1;
                }
                r15.z = saturate(0.764705896 * r15.z);
                if (r25.y != 0) {
                  r16.w = cmp((int)r25.y == 3);
                  if (r16.w != 0) {
                  ...
                  r17.w = 0.333333343 * r17.w;
                  r17.w = min(1, r17.w);
                  r18.w = dot(r30.xyz, r30.xyz);
                  r18.w = rsqrt(r18.w);
                  r25.xyz = r30.xyz * r18.www;
                  r18.w = dot(-r29.xyz, -r29.xyz);
                  r18.w = rsqrt(r18.w);
                  r26.xyz = -r29.xyz * r18.www;
                  ...
                  r25.xyz = r27.xyz * r16.www + r25.xyz;
                  r16.w = dot(r25.xyz, r25.xyz);
                  r16.w = rsqrt(r16.w);
                  r25.xyz = r25.xyz * r16.www;
                  r16.w = 1 + -r15.w;
                  r26.xyz = r22.xyz * r16.www;
                  r22.xyz = r25.xyz * r15.www + r26.xyz;
                }
                r16.w = 1 + -r15.w;
                r25.xyz = r16.www * r14.xyz;
                r14.xyz = r24.xyz * r15.www + r25.xyz;
                r24.xyz = r23.xyz * r16.www;
                r23.xyz = r32.xyz * r15.www + r24.xyz;
                r17.w = r16.w * r13.w;
                r13.z = r13.z * r16.w + r15.w;
                r13.w = r15.z * r15.w + r17.w;
              }
            }
          }
        }
  ...
  r1.w = 1 + -r15.x;
  r0.xyz = r0.xyz * r1.www + r10.xzw;
  r0.w = r0.w * r1.w + r15.x;
  r6.xyz = r6.xyz * r1.www + r16.xyz;
  r2.w = dot(r6.xyz, r6.xyz);
  r2.w = rsqrt(r2.w);
  r6.xyz = r6.xyz * r2.www;
  r8.y = r1.x * r1.w + r15.y;
  r2.xyz = r2.xyz * r1.www + r17.xyz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) r1.x, r7.z, l(32), t0.xxxx
r1.x = samp0[]..swiz;
  r1.x = hdrScale * r1.x;
  r2.w = cmp(0.5 < uvMotionToggle1);
  if (r2.w != 0) {
    r2.w = rowCount * columnCount;
    r3.w = imageTime * r2.w;
    ...
    r2.w = r3.w * r2.w;
    r2.w = round(r2.w);
    r3.w = r2.w / columnCount;
    r4.w = columnCount * r2.w;
    r4.w = cmp(r4.w >= -r4.w);
  ...
  r9.xyz = emissiveTint1.xyz * r9.xyz;
  r2.w = r9.w * r1.x;
  r9.xyz = r9.xyz * r2.www;
  r2.w = v2.x + v2.y;
  r2.w = v2.z + r2.w;
  r3.w = flickerSeed.y + r2.w;
  r3.w = frac(r3.w);
