...
r2.w = samp0[]..swiz;
  ...
  if (r4.w != 0) {
    ...
    r3.yz = r3.yz * r3.ww;
    r3.yz = scaleUVs2.xy * r3.yz;
    r3.yz = r4.xy * scaleUVs2.xy + r3.yz;
    r3.yz = offsetUVs2.xy * scaleUVs2.xy + r3.yz;
    ...
    r3.yz = gameTime.ww * scrollUVs2.xy;
    r3.yz = r3.yz * scaleUVs2.xy + r10.xy;
    r3.w = gameTime.w * zoomRate2;
    r3.w = cos(r3.w);
    r3.w = r3.w * 0.5 + 0.5;
    r3.w = 1 + -r3.w;
    r4.x = zoomUVs2.y + -zoomUVs2.x;
    r3.w = r3.w * r4.x + zoomUVs2.x;
    r3.yz = r3.yz / r3.ww;
    r3.yz = float2(0.5,0.5) + r3.yz;
    r4.xy = saturate(r3.yz);
    r9.x = clampU2 ? r4.x : r3.y;
    r9.y = clampV2 ? r4.y : r3.z;
  }
  r4.xyzw = emissiveMap2.Sample(colorSampler_s, r9.xy).xyzw;
  r3.yzw = emissiveTint2.xyz * r4.xyz;
  r4.x = hdrScale * r4.w;
  r3.yzw = r4.xxx * r3.yzw;
  r3.x = clampV2 + r3.x;
  r3.x = frac(r3.x);
  r4.y = gameTime.w * clampV2 + r3.x;
  r4.x = clampV2;
  ...
  r3.x = r3.x * r4.x + flickerRange2.x;
