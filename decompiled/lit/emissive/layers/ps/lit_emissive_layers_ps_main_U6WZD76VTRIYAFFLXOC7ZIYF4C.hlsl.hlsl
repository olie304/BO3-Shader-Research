// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:33:14 2021
...
cbuffer _Globals : register(b0)
{
  ...
  float2 commonScale : packoffset(c27);
}
...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  if (r3.w != 0) {
    ...
    r4.x = 9.99999975e-06 + layer2Depth;
    r3.xy = r4.xx * r3.xy;
    r3.xy = scaleUVs2.xy * r3.xy;
    r3.xy = r3.zw * scaleUVs2.xy + r3.xy;
    r3.xy = offsetUVs2.xy * scaleUVs2.xy + r3.xy;
    r3.z = rotateUVs2.y * gameTime.w + 1;
    r3.z = rotateUVs2.x * r3.z;
    ...
    r3.xy = gameTime.ww * scrollUVs2.xy;
    r3.xy = r3.xy * scaleUVs2.xy + r12.xy;
    r3.z = gameTime.w * zoomRate2;
    r3.z = cos(r3.z);
    r3.z = r3.z * 0.5 + 0.5;
    r3.z = 1 + -r3.z;
    r3.w = zoomUVs2.y + -zoomUVs2.x;
    r3.z = r3.z * r3.w + zoomUVs2.x;
    r3.xy = r3.xy / r3.zz;
    r3.xy = float2(0.5,0.5) + r3.xy;
    r3.zw = saturate(r3.xy);
    r11.x = clampU2 ? r3.z : r3.x;
    r11.y = clampV2 ? r3.w : r3.y;
  }
  r3.xyzw = emissiveMap2.Sample(colorSampler_s, r11.xy).xyzw;
  r3.xyz = emissiveTint2.xyz * r3.xyz;
  r4.x = hdrScale * r3.w;
  r3.xyz = r4.xxx * r3.xyz;
  r1.w = clampV2 + r1.w;
  r1.w = frac(r1.w);
  r4.y = gameTime.w * clampV2 + r1.w;
  r4.x = clampV2;
  r1.w = flickerLookupMap.SampleLevel(lookupSampler_s, r4.xy, 0).x;
  r1.w = log2(abs(r1.w));
  r1.w = flickerPower2 * r1.w;
  r1.w = exp2(r1.w);
  r4.x = flickerRange2.y + -flickerRange2.x;
  r1.w = r1.w * r4.x + flickerRange2.x;
