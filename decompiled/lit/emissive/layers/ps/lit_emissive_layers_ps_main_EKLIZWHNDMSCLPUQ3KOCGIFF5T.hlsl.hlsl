// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:32:53 2021
...
cbuffer _Globals : register(b0)
{
  ...
  float2 wobbleScroll : packoffset(c34);
  float2 wobbleScale : packoffset(c34.z);
  float layer1Wobble : packoffset(c35);
  float layer2Wobble : packoffset(c35.y);
  float layer3Wobble : packoffset(c35.z);
}
...
Texture2D<float4> wobbleMap : register(t38);
...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  r3.w = v0.z * 64 + -63;
  r1.z = r1.z ? r3.w : r1.w;
  r1.yz = max(float2(0,9.99999994e-09), r1.yz);
  r1.z = rcp(r1.z);
  r6.xy = (uint2)v0.xy;
...
r3.w = samp0[]..swiz;
  ...
  r1.w = 1 + -r13.x;
  r0.xyz = r0.xyz * r1.www + r14.xyz;
  r0.w = r0.w * r1.w + r13.x;
  r2.xyz = r2.xyw * r1.www + r15.xyz;
  r2.w = dot(r2.xyz, r2.xyz);
  r2.w = rsqrt(r2.w);
  r2.xyz = r2.xyz * r2.www;
  r7.y = r1.y * r1.w + r13.y;
  r8.xyz = r1.www * float3(0.0399999991,0.0399999991,0.0399999991) + r16.xyz;
  r6.zw = gameTime.ww * wobbleScroll.xy;
  r6.zw = w1.xy * wobbleScale.xy + r6.zw;
  r6.zw = wobbleMap.Sample(normalSampler_s, r6.zw).xy;
  r6.zw = r6.zw * float2(1.9921875,1.9921875) + float2(-1,-1);
  r6.zw = renderTargetSize.zw * r6.zw;
  r1.y = cmp(0.5 < uvMotionToggle1);
  if (r1.y != 0) {
    ...
    r1.y = r3.w * r1.y;
    r1.y = round(r1.y);
    r3.w = r1.y / columnCount;
    r4.w = columnCount * r1.y;
    r4.w = cmp(r4.w >= -r4.w);
    ...
    r1.y = rsqrt(r1.y);
    r10.xyz = -v6.xyz * r1.yyy;
    r11.x = dot(r10.xyz, r4.xyz);
    r11.y = dot(r10.xyz, r5.xyz);
    r1.y = dot(r10.xyz, r3.xyz);
    r3.w = cmp(0 < r1.y);
    r7.zw = -r11.xy / r1.yy;
    r7.zw = r3.ww ? r7.zw : 0;
    r9.zw = float2(-0.5,-0.5) + w1.xy;
    r1.y = 9.99999975e-06 + layerDepth;
    r7.zw = r7.zw * r1.yy;
    r7.zw = scaleUVs.xy * r7.zw;
    r7.zw = r9.zw * scaleUVs.xy + r7.zw;
    r7.zw = offsetUVs.xy * scaleUVs.xy + r7.zw;
    r1.y = rotateUVs.y * gameTime.w + 1;
    r1.y = rotateUVs.x * r1.y;
    r1.y = 0.0174532924 * r1.y;
    sincos(r1.y, r10.x, r11.x);
    r11.y = r11.x;
    r11.z = r10.x;
    r12.x = dot(r11.yz, r7.zw);
    r11.x = -r10.x;
    r12.y = dot(r11.xy, r7.zw);
    r7.zw = gameTime.ww * scrollUVs.xy;
    r7.zw = r7.zw * scaleUVs.xy + r12.xy;
    r1.y = gameTime.w * zoomRate;
    r1.y = cos(r1.y);
    r1.y = r1.y * 0.5 + 0.5;
    r1.y = 1 + -r1.y;
    r3.w = zoomUVs.y + -zoomUVs.x;
    r1.y = r1.y * r3.w + zoomUVs.x;
    r7.zw = r7.zw / r1.yy;
    r7.zw = float2(0.5,0.5) + r7.zw;
    r9.zw = saturate(r7.zw);
    r9.xy = clampU ? r9.zw : r7.zw;
  }
  r7.zw = r6.zw * layer1Wobble + r9.xy;
  r9.xyzw = emissiveMap1.Sample(colorSampler_s, r7.zw).xyzw;
  r9.xyzw = emissiveTint1.xyzw * r9.xyzw;
  r9.xyz = r9.xyz * r9.www;
  r1.y = v2.x + v2.y;
  r1.y = v2.z + r1.y;
  r3.w = flickerSeed.y + r1.y;
  r3.w = frac(r3.w);
  r10.y = gameTime.w * flickerSpeed + r3.w;
  r10.x = flickerSeed.x;
  r3.w = flickerLookupMap.SampleLevel(lookupSampler_s, r10.xy, 0).x;
  r3.w = log2(abs(r3.w));
  ...
  if (r3.w != 0) {
    ...
    r3.w = trunc(r3.w);
    r3.w = w1.x + r3.w;
    r10.x = r3.w / columnCount2;
    r3.w = trunc(r4.w);
    r3.w = w1.y + r3.w;
    r10.y = r3.w / rowCount2;
  } else {
    r3.w = dot(-v6.xyz, -v6.xyz);
    r3.w = rsqrt(r3.w);
    r11.xyz = -v6.xyz * r3.www;
    r12.x = dot(r11.xyz, r4.xyz);
    r12.y = dot(r11.xyz, r5.xyz);
    r3.w = dot(r11.xyz, r3.xyz);
    r4.w = cmp(0 < r3.w);
    r7.zw = -r12.xy / r3.ww;
    r7.zw = r4.ww ? r7.zw : 0;
    r10.zw = float2(-0.5,-0.5) + w1.xy;
    r3.w = 9.99999975e-06 + layer2Depth;
    r7.zw = r7.zw * r3.ww;
    r7.zw = scaleUVs2.xy * r7.zw;
    r7.zw = r10.zw * scaleUVs2.xy + r7.zw;
    ...
    r7.zw = r7.zw / r3.ww;
    r7.zw = float2(0.5,0.5) + r7.zw;
    r10.zw = saturate(r7.zw);
    r10.x = clampU2 ? r10.z : r7.z;
    r10.y = clampV2 ? r10.w : r7.w;
  }
  r7.zw = r6.zw * layer2Wobble + r10.xy;
  r10.xyzw = emissiveMap2.Sample(colorSampler_s, r7.zw).xyzw;
  r10.xyz = emissiveTint2.xyz * r10.xyz;
  r3.w = hdrScale * r10.w;
  r10.xyz = r10.xyz * r3.www;
  r3.w = clampV2 + r1.y;
  r3.w = frac(r3.w);
  r11.y = gameTime.w * clampV2 + r3.w;
  r11.x = clampV2;
  ...
  if (r3.w != 0) {
    ...
    r3.w = trunc(r3.w);
    r3.w = w1.x + r3.w;
    r10.x = r3.w / columnCount3;
    r3.w = trunc(r4.w);
    r3.w = w1.y + r3.w;
    r10.y = r3.w / rowCount3;
  } else {
    r3.w = dot(-v6.xyz, -v6.xyz);
    r3.w = rsqrt(r3.w);
    r11.xyz = -v6.xyz * r3.www;
  ...
  r3.xy = r6.zw * layer3Wobble + r10.xy;
  r3.xyzw = emissiveMap3.Sample(colorSampler_s, r3.xy).xyzw;
  r3.xyz = emissiveTint3.xyz * r3.xyz;
  r4.x = hdrScale * r3.w;
  r3.xyz = r4.xxx * r3.xyz;
  r1.y = clampV3 + r1.y;
  r1.y = frac(r1.y);
  r4.y = gameTime.w * clampV3 + r1.y;
  r4.x = clampV3;
  r1.y = flickerLookupMap.SampleLevel(lookupSampler_s, r4.xy, 0).x;
  r1.y = log2(abs(r1.y));
  r1.y = flickerPower3 * r1.y;
  r1.y = exp2(r1.y);
  r4.x = flickerRange3.y + -flickerRange3.x;
  r1.y = r1.y * r4.x + flickerRange3.x;
  r3.xyz = r3.xyz * r1.yyy;
  r1.y = 1 + -r3.w;
  r3.xyz = r9.xyz * r1.yyy + r3.xyz;
  ...
  r13.z = (uint)r1.z << 4;
  r1.z = (int)r7.z & -32;
  r6.x = (int)-r1.z + (int)r7.z;
  r6.y = numRefProbes & -32;
  r7.w = (int)-r6.y + numRefProbes;
  r14.xy = float2(0,0);
  r15.w = 0;
  r16.yz = float2(0,1);
  r17.xy = float2(0,0);
  ...
  while (true) {
    ...
    r9.w = cmp((int)r1.z == (int)r8.w);
    bitmask.w = ((~(-1 << r6.x)) << 0) & 0xffffffff;  r10.w = (((uint)0 << 0) & bitmask.w) | ((uint)r9.z & ~bitmask.w);
    r9.z = r9.w ? r10.w : r9.z;
    r9.w = cmp((int)r6.y == (int)r8.w);
  ...
  if (r6.y != 0) {
    ...
    while (true) {
      ...
      r9.z = cmp((int)r1.z == (int)r7.w);
      if (r6.x == 0) r9.w = 0; else if (r6.x+0 < 32) {       r9.w = (uint)r8.w << (32-(r6.x + 0)); r9.w = (uint)r9.w >> (32-r6.x);      } else r9.w = (uint)r8.w >> 0;
      r8.w = r9.z ? r9.w : r8.w;
  ...
  r6.xyz = r21.xyz * r1.zzz;
  r11.yzw = r22.xyz * r1.zzz;
  r5.z = cmp(r22.w < 0.99000001);
  if (r5.z != 0) {
    r5.z = 1 + -r22.w;
    r6.w = sunConstants.globalProbeExposure * r5.z;
    ...
    r6.xyz = r21.xyz * r1.zzz + r14.xyz;
    r12.w = 0;
    r14.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r12.xyzw, r5.w).xyz;
    r1.z = sunConstants.globalProbeExposure * r5.z + -r2.w;
    r1.z = r7.y * r1.z + r2.w;
    r11.yzw = r14.xyz * r1.zzz + r11.yzw;
  }
  r1.z = r7.x + r1.x;
  r1.z = log2(abs(r1.z));
  r1.z = r5.y * r1.z;
  ...
  r7.yzw = r11.yzw * r1.zzz;
  r14.xyz = r7.zwy * r5.zzz;
  ...
  if (r5.w != 0) {
    r5.w = cmp(0 < r8.w);
    if (r5.w != 0) {
      r5.w = sunConstants.specScale * r4.w;
      r5.w = r5.w * r5.z;
      ...
      r9.z = r9.z * r8.w;
      r2.w = cmp(0 < r2.w);
      r15.xyz = r9.zzz * r11.yzw + r6.xyz;
      r16.xyz = -v6.xyz * r1.yyy + sunConstants.wldDir.xyz;
      r1.y = dot(r16.xyz, r16.xyz);
      r1.y = rsqrt(r1.y);
      r16.xyz = r16.xyz * r1.yyy;
      r1.y = dot(r16.xyz, r4.xyz);
      r9.z = dot(r2.xyz, r16.xyz);
      r9.w = abs(r9.z) * r4.w + -abs(r9.z);
      ...
      r5.z = r8.w * r5.z;
      r5.z = 0.25 * r5.z;
      r16.xyz = r5.zzz * r11.yzw + r7.yzw;
      r1.y = saturate(1 + -r1.y);
      r5.w = r1.y * r1.y;
      r5.w = r5.w * r5.w;
      r1.y = r5.w * r1.y;
      r1.y = r5.z * r1.y;
      r17.xyz = r1.yyy * r11.zwy + r14.xyz;
      r15.w = r17.z;
      r6.w = r14.z;
      r6.xyzw = r2.wwww ? r15.xyzw : r6.xyzw;
      r17.zw = r16.xy;
      r14.zw = r7.yz;
      r15.xyzw = r2.wwww ? r17.xyzw : r14.xyzw;
      r7.w = r2.w ? r16.z : r7.w;
      r14.z = r6.w;
      r14.xy = r15.xy;
      r7.yz = r15.zw;
    }
            ...
            if (r16.w != 0) {
              ...
              if (r16.w != 0) {
                ...
                if (r16.w != 0) {
                  ...
                  r10.w = saturate(dot(r2.xyz, r40.xyz));
                  r39.xyz = r39.xyz * r9.www + r4.xyz;
                  r9.w = dot(r39.xyz, r39.xyz);
                  r9.w = rsqrt(r9.w);
                  r39.xyz = r39.xyz * r9.www;
                  r9.w = dot(r39.xyz, r4.xyz);
                  r14.w = dot(r2.xyz, r39.xyz);
                  r16.z = abs(r14.w) * r4.w + -abs(r14.w);
                  r14.w = abs(r14.w) * r16.z + 1;
                  r16.z = r10.w * r1.x + r1.z;
                  r14.w = r14.w * r14.w;
                  r14.w = r14.w * r16.z;
                  r14.w = rcp(r14.w);
                  r10.w = r10.w * r16.w;
            ...
            r40.w = samp0[]..swiz;
              ...
              if (r13.w != 0) {
                ...
                if (r13.w != 0) {
                  ...
                  r20.xyz = r20.xyz * r9.www + r4.xyz;
                  r9.w = dot(r20.xyz, r20.xyz);
                  r9.w = rsqrt(r9.w);
                  r20.xyz = r20.xyz * r9.www;
                  r9.w = dot(r20.xyz, r4.xyz);
                  r14.w = dot(r2.xyz, r20.xyz);
                  r16.w = abs(r14.w) * r4.w + -abs(r14.w);
                  r14.w = abs(r14.w) * r16.w + 1;
                  r12.w = r12.w * r1.x + r1.z;
                  r14.w = r14.w * r14.w;
                  r12.w = r14.w * r12.w;
                  r12.w = rcp(r12.w);
                  r12.w = r12.w * r13.w;
  ...
  r1.xyz = float3(1,1,1) + -r8.xyz;
  r1.xyz = r28.xyz * r1.xyz;
  r1.xyz = r29.xyz * r8.xyz + r1.xyz;
