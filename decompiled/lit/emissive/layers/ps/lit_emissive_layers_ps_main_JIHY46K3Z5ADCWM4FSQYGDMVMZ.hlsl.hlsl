...
r2.w = samp0[]..swiz;
  ...
  r7.zw = gameTime.ww * wobbleScroll.xy;
  r7.zw = w1.xy * wobbleScale.xy + r7.zw;
  r7.zw = wobbleMap.Sample(normalSampler_s, r7.zw).xy;
  r7.zw = r7.zw * float2(1.9921875,1.9921875) + float2(-1,-1);
  r7.zw = renderTargetSize.zw * r7.zw;
  ...
  if (r1.x != 0) {
    ...
    r1.x = r1.x * r3.x + zoomUVs.x;
    r8.zw = r8.zw / r1.xx;
    r8.zw = float2(0.5,0.5) + r8.zw;
    r9.zw = saturate(r8.zw);
    r9.xy = clampU ? r9.zw : r8.zw;
  }
  r8.zw = r7.zw * layer1Wobble + r9.xy;
  r9.xyzw = emissiveMap1.Sample(colorSampler_s, r8.zw).xyzw;
  r9.xyzw = emissiveTint1.xyzw * r9.xyzw;
  r9.xyz = r9.xyz * r9.www;
  r1.x = v2.x + v2.y;
  r1.x = v2.z + r1.x;
  r3.x = flickerSeed.y + r1.x;
  r3.x = frac(r3.x);
  r10.y = gameTime.w * flickerSpeed + r3.x;
  r10.x = flickerSeed.x;
  r3.x = flickerLookupMap.SampleLevel(lookupSampler_s, r10.xy, 0).x;
  r3.x = log2(abs(r3.x));
  ...
  if (r3.x != 0) {
    ...
    r3.x = trunc(r3.x);
    r3.x = w1.x + r3.x;
    r10.x = r3.x / columnCount2;
    r3.x = trunc(r4.w);
    r3.x = w1.y + r3.x;
    r10.y = r3.x / rowCount2;
  } else {
    r3.x = dot(-v6.xyz, -v6.xyz);
    r3.x = rsqrt(r3.x);
    r11.xyz = -v6.xyz * r3.xxx;
    r12.x = dot(r11.xyz, r4.xyz);
    r12.y = dot(r11.xyz, r5.xyz);
    r3.x = dot(r11.xyz, r3.yzw);
    r4.w = cmp(0 < r3.x);
    r8.zw = -r12.xy / r3.xx;
    r8.zw = r4.ww ? r8.zw : 0;
    ...
    r8.zw = r10.zw * scaleUVs2.xy + r8.zw;
    ...
    r8.zw = r8.zw * scaleUVs2.xy + r12.xy;
    ...
    r8.zw = r8.zw / r3.xx;
    r8.zw = float2(0.5,0.5) + r8.zw;
    r10.zw = saturate(r8.zw);
    r10.x = clampU2 ? r10.z : r8.z;
    r10.y = clampV2 ? r10.w : r8.w;
  }
  r8.zw = r7.zw * layer2Wobble + r10.xy;
  r10.xyzw = emissiveMap2.Sample(colorSampler_s, r8.zw).xyzw;
  r10.xyz = emissiveTint2.xyz * r10.xyz;
  r3.x = hdrScale * r10.w;
  r10.xyz = r10.xyz * r3.xxx;
  r3.x = clampV2 + r1.x;
  r3.x = frac(r3.x);
  r11.y = gameTime.w * clampV2 + r3.x;
  r11.x = clampV2;
  r3.x = flickerLookupMap.SampleLevel(lookupSampler_s, r11.xy, 0).x;
  r3.x = log2(abs(r3.x));
  ...
  if (r3.x != 0) {
    ...
    r3.x = trunc(r3.x);
    r3.x = w1.x + r3.x;
    r10.x = r3.x / columnCount3;
    r3.x = trunc(r4.w);
    r3.x = w1.y + r3.x;
    r10.y = r3.x / rowCount3;
  } else {
    r3.x = dot(-v6.xyz, -v6.xyz);
    r3.x = rsqrt(r3.x);
    r11.xyz = -v6.xyz * r3.xxx;
  ...
  r3.xy = r7.zw * layer3Wobble + r10.xy;
  ...
  r1.x = r1.x * r4.x + flickerRange3.x;
  ...
  r8.x = saturate(dot(r2.xyz, r4.xyz));
  ...
  r40.w = samp0[]..swiz;
    ...
    r29.x = dot(r2.xyz, r22.xyz);
    r29.y = dot(r2.xyz, r30.xyz);
    r29.z = dot(r2.xyz, r24.xyz);
  ...
  if (r1.z == 0) {
    ...
    if (r5.z != 0) {
      ...
      r12.w = 0;
      r7.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r12.xyzw, r5.w).xyz;
