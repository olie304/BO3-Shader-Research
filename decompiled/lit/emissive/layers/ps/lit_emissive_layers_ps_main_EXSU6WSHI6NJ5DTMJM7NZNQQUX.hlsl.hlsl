...
r4.w = samp0[]..swiz;
  ...
  if (r1.w != 0) {
    ...
    r3.xy = r3.xy * scaleUVs2.xy + r10.xy;
    r1.w = gameTime.w * zoomRate2;
    r1.w = cos(r1.w);
    r1.w = r1.w * 0.5 + 0.5;
    r1.w = 1 + -r1.w;
    r3.z = zoomUVs2.y + -zoomUVs2.x;
    r1.w = r1.w * r3.z + zoomUVs2.x;
    r3.xy = r3.xy / r1.ww;
    r3.xy = float2(0.5,0.5) + r3.xy;
    r3.zw = saturate(r3.xy);
    r9.x = clampU2 ? r3.z : r3.x;
    r9.y = clampV2 ? r3.w : r3.y;
  }
  r3.xyzw = emissiveMap2.Sample(colorSampler_s, r9.xy).xyzw;
  r3.xyz = emissiveTint2.xyz * r3.xyz;
  r1.w = hdrScale * r3.w;
  r3.xyz = r3.xyz * r1.www;
  r1.z = clampV2 + r1.z;
  r1.z = frac(r1.z);
  r4.y = gameTime.w * clampV2 + r1.z;
  r4.x = clampV2;
  r1.z = flickerLookupMap.SampleLevel(lookupSampler_s, r4.xy, 0).x;
  r1.z = log2(abs(r1.z));
  r1.z = flickerPower2 * r1.z;
  r1.z = exp2(r1.z);
  r1.w = flickerRange2.y + -flickerRange2.x;
  r1.z = r1.z * r1.w + flickerRange2.x;
