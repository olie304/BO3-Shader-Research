...
Texture2D<float4> emissiveMap3 : register(t38);
...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  if (r1.w != 0) {
    ...
    r15.y = r15.x;
    r15.z = r14.x;
    r16.x = dot(r15.yz, r7.zw);
    r15.x = -r14.x;
    r16.y = dot(r15.xy, r7.zw);
    r7.zw = gameTime.ww * scrollUVs2.xy;
    r7.zw = r7.zw * scaleUVs2.xy + r16.xy;
    ...
    r7.zw = float2(0.5,0.5) + r7.zw;
    r8.zw = saturate(r7.zw);
    r13.x = clampU2 ? r8.z : r7.z;
    r13.y = clampV2 ? r8.w : r7.w;
  }
  ...
  r13.xyz = r13.xyz * r1.www;
  r1.w = 1 + -r13.w;
  r12.xyz = r12.xyz * r1.www + r13.xyz;
