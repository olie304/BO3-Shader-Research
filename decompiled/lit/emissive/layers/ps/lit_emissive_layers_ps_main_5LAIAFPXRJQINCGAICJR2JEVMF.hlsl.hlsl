...
r1.w = samp0[]..swiz;
  ...
  if (r0.w != 0) {
    ...
    r3.xy = r3.xy * scaleUVs2.xy + r11.xy;
    ...
    r10.x = clampU2 ? r3.z : r3.x;
    r10.y = clampV2 ? r3.w : r3.y;
  }
  r3.xyzw = emissiveMap2.Sample(colorSampler_s, r10.xy).xyzw;
  r3.xyz = emissiveTint2.xyz * r3.xyz;
  r0.w = hdrScale * r3.w;
  r3.xyz = r3.xyz * r0.www;
  r0.z = clampV2 + r0.z;
  r0.z = frac(r0.z);
  r4.y = gameTime.w * clampV2 + r0.z;
  r4.x = clampV2;
  r0.z = flickerLookupMap.SampleLevel(lookupSampler_s, r4.xy, 0).x;
  r0.z = log2(abs(r0.z));
  r0.z = flickerPower2 * r0.z;
  r0.z = exp2(r0.z);
  r0.w = flickerRange2.y + -flickerRange2.x;
  r0.z = r0.z * r0.w + flickerRange2.x;
