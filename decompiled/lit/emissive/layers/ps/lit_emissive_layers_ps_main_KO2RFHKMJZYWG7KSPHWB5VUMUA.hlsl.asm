...
//   float alphaLayer1;                 // Offset:  312 Size:     4
...
//   float alphaLayer2;                 // Offset:  428 Size:     4
...
//   float alphaLayer3;                 // Offset:  540 Size:     4
//
// }
//
...
// emissiveMap1                      texture  float4          2d            t24      1 
// emissiveMap2                      texture  float4          2d            t25      1 
// emissiveMap3                      texture  float4          2d            t26      1 
...
if_nz r1.z
  ...
  rsq r1.z, r1.z
  mul r9.xyz, r1.zzzz, -v6.xyzx
  dp3 r10.x, r9.xyzx, r4.xyzx
  dp3 r10.y, r9.xyzx, r5.xyzx
  dp3 r1.z, r9.xyzx, r3.xyzx
...
sample_indexable(texture2d)(float,float,float,float) r8.xyzw, r8.xyxx, t24.xyzw, s1
...
frc r1.w, r1.w
mad r9.y, cb1[69].w, cb0[16].z, r1.w
mov r9.x, cb0[16].x
sample_l_indexable(texture2d)(float,float,float,float) r1.w, r9.xyxx, t22.yzwx, s5, l(0.000000)
log r1.w, |r1.w|
...
if_nz r1.w
  ...
  round_z r1.w, r1.w
  add r1.w, r1.w, v1.y
  div r9.x, r1.w, cb0[21].x
  round_z r1.w, r3.w
  add r1.w, r1.w, v1.z
  div r9.y, r1.w, cb0[20].w
else 
  dp3 r1.w, -v6.xyzx, -v6.xyzx
  rsq r1.w, r1.w
  mul r10.xyz, r1.wwww, -v6.xyzx
  dp3 r11.x, r10.xyzx, r4.xyzx
  dp3 r11.y, r10.xyzx, r5.xyzx
  dp3 r1.w, r10.xyzx, r3.xyzx
  lt r3.w, l(0.000000), r1.w
  div r9.zw, -r11.xxxy, r1.wwww
  and r9.zw, r3.wwww, r9.zzzw
  add r10.xy, v1.yzyy, l(-0.500000, -0.500000, 0.000000, 0.000000)
  add r1.w, cb0[24].y, l(0.000010)
  mul r9.zw, r1.wwww, r9.zzzw
  mul r9.zw, r9.zzzw, cb0[22].zzzw
  mad r9.zw, r10.xxxy, cb0[22].zzzw, r9.zzzw
  mad r9.zw, cb0[23].xxxy, cb0[22].zzzw, r9.zzzw
  ...
  mov r11.y, r11.x
  mov r11.z, r10.x
  dp2 r12.x, r11.yzyy, r9.zwzz
  mov r11.x, -r10.x
  dp2 r12.y, r11.xyxx, r9.zwzz
  mul r9.zw, cb0[22].xxxy, cb1[69].wwww
  mad r9.zw, r9.zzzw, cb0[22].zzzw, r12.xxxy
  ...
  div r9.zw, r9.zzzw, r1.wwww
  add r9.zw, r9.zzzw, l(0.000000, 0.000000, 0.500000, 0.500000)
  mov_sat r10.xy, r9.zwzz
  movc r9.x, cb0[24].w, r10.x, r9.z
  movc r9.y, cb0[25].x, r10.y, r9.w
endif 
sample_indexable(texture2d)(float,float,float,float) r9.xyzw, r9.xyxx, t25.xyzw, s1
mul r9.xyz, r9.xyzx, cb0[20].xyzx
mul r1.w, r9.w, cb0[18].w
mul r9.xyz, r1.wwww, r9.xyzx
mul r9.xyz, r9.xyzx, cb0[26].wwww
add r1.w, r1.z, cb0[25].z
frc r1.w, r1.w
mad r10.y, cb1[69].w, cb0[25].w, r1.w
mov r10.x, cb0[25].y
sample_l_indexable(texture2d)(float,float,float,float) r1.w, r10.xyxx, t22.yzwx, s5, l(0.000000)
log r1.w, |r1.w|
...
mul r9.xyz, r1.wwww, r9.xyzx
mad r1.w, -r9.w, cb0[26].w, l(1.000000)
...
if_nz r1.w
  ...
  round_z r1.w, r1.w
  add r1.w, r1.w, v1.y
  div r9.x, r1.w, cb0[28].x
  round_z r1.w, r3.w
  add r1.w, r1.w, v1.z
  div r9.y, r1.w, cb0[27].w
else 
  dp3 r1.w, -v6.xyzx, -v6.xyzx
  rsq r1.w, r1.w
  mul r10.xyz, r1.wwww, -v6.xyzx
  ...
  mad r3.xy, r3.xyxx, cb0[29].zwzz, r10.xyxx
...
mul r3.xyz, r3.xyzx, cb0[33].wwww
add r1.z, r1.z, cb0[32].z
frc r1.z, r1.z
mad r4.y, cb1[69].w, cb0[32].w, r1.z
mov r4.x, cb0[32].y
sample_l_indexable(texture2d)(float,float,float,float) r1.z, r4.xyxx, t22.yzxw, s5, l(0.000000)
log r1.z, |r1.z|
...
mad r1.z, -r3.w, cb0[33].w, l(1.000000)
...
ret 
// Approximately 2815 instruction slots used
