...
mad r3.xyz, r3.xywx, r0.wwww, r16.xyzx
...
if_nz r1.w
  ...
  dp3 r12.x, r9.xyzx, r5.xyzx
  dp3 r12.y, r9.xyzx, r6.xyzx
...
mov r9.x, cb0[16].x
sample_l_indexable(texture2d)(float,float,float,float) r3.w, r9.xyxx, t26.yzwx, s7, l(0.000000)
log r3.w, |r3.w|
...
mul r3.w, r9.w, cb0[18].w
mul r9.xyz, r3.wwww, r9.xyzx
add r3.w, r1.w, cb0[25].z
frc r3.w, r3.w
mad r12.y, cb1[69].w, cb0[25].w, r3.w
mov r12.x, cb0[25].y
sample_l_indexable(texture2d)(float,float,float,float) r3.w, r12.xyxx, t26.yzwx, s7, l(0.000000)
log r3.w, |r3.w|
...
if_nz r3.w
  ...
  round_z r3.w, r3.w
  add r3.w, r3.w, v2.x
  div r9.x, r3.w, cb0[28].x
  round_z r3.w, r4.w
  add r3.w, r3.w, v2.y
  div r9.y, r3.w, cb0[27].w
else 
  dp3 r3.w, -v7.xyzx, -v7.xyzx
  rsq r3.w, r3.w
  mul r12.xyz, r3.wwww, -v7.xyzx
  ...
  mov r6.y, r6.x
  mov r6.z, r5.x
  dp2 r12.x, r6.yzyy, r4.xyxx
  mov r6.x, -r5.x
  dp2 r12.y, r6.xyxx, r4.xyxx
  mul r4.xy, cb0[29].xyxx, cb1[69].wwww
  mad r4.xy, r4.xyxx, cb0[29].zwzz, r12.xyxx
  mul r3.w, cb0[31].x, cb1[69].w
  sincos null, r3.w, r3.w
  mad r3.w, r3.w, l(0.500000), l(0.500000)
  add r3.w, -r3.w, l(1.000000)
  add r4.z, -cb0[30].z, cb0[30].w
  mad r3.w, r3.w, r4.z, cb0[30].z
...
mul r3.w, r4.w, cb0[18].w
mul r4.xyz, r3.wwww, r4.xyzx
add r1.w, r1.w, cb0[32].z
frc r1.w, r1.w
mad r5.y, cb1[69].w, cb0[32].w, r1.w
mov r5.x, cb0[32].y
sample_l_indexable(texture2d)(float,float,float,float) r1.w, r5.xyxx, t26.yzwx, s7, l(0.000000)
log r1.w, |r1.w|
mul r1.w, r1.w, cb0[33].z
exp r1.w, r1.w
add r3.w, -cb0[33].x, cb0[33].y
mad r1.w, r1.w, r3.w, cb0[33].x
...
add r3.w, r3.w, r3.w
mad r12.xyz, r2.xyzx, -r3.wwww, -r5.xyzx
...
if_z r7.z
  ...
  if_nz r6.z
    ...
    mad r20.xyz, r22.xyzx, r5.wwww, r9.yzwy
    mov r12.w, l(0)
    sample_l_indexable(texturecubearray)(float,float,float,float) r9.yzw, r12.xyzw, t8.wxyz, s2, r6.y
    mad r5.w, cb2[19].x, r6.z, -r2.w
    mad r2.w, r0.y, r5.w, r2.w
...
mul r14.xyz, r0.yyyy, r6.zwyz
mul r6.yzw, r0.zzzz, r6.yyzw
sqrt r0.y, r4.w
...
if_nz r7.z
  ...
  if_nz r7.z
    ...
    mad r15.xyz, r5.wwww, r9.yzwy, r6.yzwy
...
ret 
// Approximately 2802 instruction slots used
