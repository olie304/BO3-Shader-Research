...
//   float scriptControl;               // Offset:  312 Size:     4 [unused]
//
// }
//
...
if_nz r2.w
  ...
  mad r2.w, cb0[12].z, r1.x, l(1.000000)
  ...
  mul r3.xy, r1.xxxx, cb0[13].xyxx
  mad r3.xy, r3.xyxx, cb0[13].zwzz, r10.xyxx
...
ret 
// Approximately 2991 instruction slots used
