...
movc r4.x, v8.x, l(1.000000), l(-1.000000)
dp3 r4.y, v4.xyzx, v4.xyzx
rsq r4.y, r4.y
mul r4.yzw, r4.yyyy, v4.xxyz
mul r4.yzw, r4.xxxx, r4.yyzw
dp3 r5.x, v5.xyzx, v5.xyzx
rsq r5.x, r5.x
mul r5.xyz, r5.xxxx, v5.xyzx
        ...
        if_nz r13.z
          ...
          if_nz r13.z
            ...
            if_nz r21.y
              ...
              mul r23.xyz, r4.xxxx, r24.xyzx
              mul r21.xyz, r4.xxxx, r21.xyzx
              mul r22.xyz, r4.xxxx, r22.xyzx
...
mad r0.z, r0.w, r0.y, r3.w
mad r7.xyz, r7.xyzx, r0.yyyy, r16.xyzx
dp3 r0.w, r7.xyzx, r7.xyzx
rsq r0.w, r0.w
mul r7.xyz, r0.wwww, r7.xyzx
mad r9.y, r1.w, r0.y, r5.w
mad r3.xyz, r3.xyzx, r0.yyyy, r17.xyzx
lt r0.w, l(0.500000), cb0[20].x
if_nz r0.w
  ...
  round_z r0.w, r0.w
  add r0.w, r0.w, r1.x
  div r10.x, r0.w, cb0[12].w
  round_z r0.w, r1.w
  add r0.w, r0.w, r1.y
  div r10.y, r0.w, cb0[12].z
else 
  ...
  mad r8.zw, r8.zzzw, cb0[14].zzzw, r14.xxxy
...
if_nz r1.w
  ...
  dp3 r15.x, r14.xyzx, r5.xyzx
  dp3 r15.y, r14.xyzx, r6.xyzx
  dp3 r1.w, r14.xyzx, r4.yzwy
  lt r2.w, l(0.000000), r1.w
  div r8.zw, -r15.xxxy, r1.wwww
  ...
  mad r8.zw, r8.zzzw, cb0[23].zzzw, r15.xxxy
  ...
  add r8.zw, r8.zzzw, l(0.000000, 0.000000, 0.500000, 0.500000)
  mov_sat r9.zw, r8.zzzw
  movc r13.x, cb0[25].w, r9.z, r8.z
  movc r13.y, cb0[26].x, r9.w, r8.w
endif 
sample_indexable(texture2d)(float,float,float,float) r13.xyzw, r13.xyxx, t38.xyzw, s1
mul r13.xyz, r13.xyzx, cb0[21].xyzx
mul r1.w, r13.w, cb0[19].w
mul r13.xyz, r1.wwww, r13.xyzx
add r1.w, r0.w, cb0[26].z
frc r1.w, r1.w
mad r14.y, cb1[69].w, cb0[26].w, r1.w
mov r14.x, cb0[26].y
sample_l_indexable(texture2d)(float,float,float,float) r1.w, r14.xyxx, t29.yzwx, s7, l(0.000000)
log r1.w, |r1.w|
...
if_nz r1.w
  ...
  movc r13.x, cb0[32].w, r4.x, r1.x
  movc r13.y, cb0[33].x, r4.y, r1.y
endif 
sample_indexable(texture2d)(float,float,float,float) r4.xyzw, r13.xyxx, t46.xyzw, s1
mul r1.xyw, r4.xyxz, cb0[28].xyxz
mul r2.w, r4.w, cb0[19].w
mul r1.xyw, r1.xyxw, r2.wwww
add r0.w, r0.w, cb0[33].z
frc r0.w, r0.w
mad r4.y, cb1[69].w, cb0[33].w, r0.w
mov r4.x, cb0[33].y
sample_l_indexable(texture2d)(float,float,float,float) r0.w, r4.xyxx, t29.yzwx, s7, l(0.000000)
log r0.w, |r0.w|
mul r0.w, r0.w, cb0[34].z
exp r0.w, r0.w
add r2.w, -cb0[34].x, cb0[34].y
mad r0.w, r0.w, r2.w, cb0[34].x
mul r1.xyw, r0.wwww, r1.xyxw
add r0.w, -r4.w, l(1.000000)
mad r1.xyw, r10.xyxz, r0.wwww, r1.xyxw
      ...
      if_nz r19.w
        ...
        if_nz r18.w
          ...
          if_nz r18.w
            ...
            sqrt r18.y, r18.y
            mad r18.y, r5.y, l(5.000000), r18.y
...
if_nz r5.w
  ...
  dp3 r6.z, r15.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
  mad r10.yzw, r21.xxyz, r5.yyyy, r15.xxyz
  mov r13.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r15.xyz, r13.xyzw, t8.xyzw, s2, r5.z
  mad r5.y, cb2[19].x, r5.w, -r6.z
  mad r5.y, r9.y, r5.y, r6.z
  mad r14.xyz, r15.xyzx, r5.yyyy, r14.xyzx
endif 
add r5.y, r1.z, r9.x
log r5.y, |r5.y|
mul r5.y, r3.w, r5.y
...
if_nz r8.w
  ...
  if_nz r8.w
    ...
    if_nz r9.w
      ...
      mad r19.xyz, r7.xyzx, r12.wwww, v7.xyzx
    ...
    mad r9.yzw, r7.wwww, r10.yyzw, r5.yyzw
    ...
    mov r11.w, r16.z
    mov r15.w, r14.z
    movc r15.xyzw, r6.wwww, r11.xyzw, r15.xyzw
    mov r16.zw, r9.yyyz
    mov r14.zw, r5.yyyz
    movc r11.xyzw, r6.wwww, r16.xyzw, r14.xyzw
    movc r5.w, r6.w, r9.w, r5.w
    mov r14.z, r15.w
    mov r14.xy, r11.xyxx
    mov r5.yz, r11.zzwz
  endif 
          ...
          if_nz r27.w
            ...
            if_nz r27.w
              ...
              if_nz r27.w
                ...
                mad r41.xyz, r7.xyzx, r27.wwww, v7.xyzx
              ...
              if_nz r27.w
                ...
                if_nz r20.w
                  ...
                  mad r18.xyz, r7.xyzx, r28.wwww, v7.xyzx
                  ...
                  if_nz r18.x
                    ...
                    mad r19.xyz, r7.xyzx, r18.zzzz, v7.xyzx
                ...
                mad r15.w, -r26.w, r6.w, l(1.000000)
                mul r15.w, r15.w, r15.w
                mad r15.w, -r15.w, l(0.620000), l(0.620000)
                add r15.w, -r26.w, r15.w
                mad r15.w, r3.w, r15.w, r26.w
                mul r15.w, r24.w, r15.w
                mov r32.x, r31.x
                lt r18.x, l(0.000000), r25.w
                mad r19.xyz, r15.wwww, r32.xyzx, r16.xyzx
                dp3_sat r15.w, r7.xyzx, r39.xyzx
                mad r38.xyz, r38.xyzx, r14.wwww, r1.xywx
                dp3 r14.w, r38.xyzx, r38.xyzx
                rsq r14.w, r14.w
                mul r38.xyz, r14.wwww, r38.xyzx
                dp3 r14.w, r38.xyzx, r1.xywx
                dp3 r18.z, r7.xyzx, r38.xyzx
                mad r25.w, |r18.z|, r2.w, -|r18.z|
                mad r18.z, |r18.z|, r25.w, l(1.000000)
                mad r25.w, r15.w, r1.z, r6.z
          ...
          if_nz r18.z
            ...
            if_nz r18.z
              ...
              if_nz r18.z
                ...
                mad r21.xyz, r7.xyzx, r18.zzzz, v7.xyzx
              ...
              if_nz r18.z
                ...
                if_nz r21.x
                  ...
                  mad r22.xyz, r7.xyzx, r21.yyyy, v7.xyzx
                  ...
                  if_nz r21.x
                    ...
                    mad r21.y, |r15.w|, l(-0.200000), l(0.400000)
                    mad r23.xyz, r7.xyzx, r21.yyyy, v7.xyzx
