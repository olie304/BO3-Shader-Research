...
cbuffer _Globals : register(b0)
{
  ...
  float scriptControl : packoffset(c19.z);
}
...
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) r1.z, r8.x, l(0), t0.xxxx
r1.z = samp0[]..swiz;
  ...
  if (r1.w != 0) {
    ...
    r1.w = rotateUVs.y * r1.z + 1;
    r1.w = rotateUVs.x * r1.w;
    r1.w = 0.0174532924 * r1.w;
    sincos(r1.w, r4.x, r5.x);
    r5.y = r5.x;
    r5.z = r4.x;
    r9.x = dot(r5.yz, r3.xy);
    r5.x = -r4.x;
    r9.y = dot(r5.xy, r3.xy);
    r1.zw = scrollUVs.xy * r1.zz;
    ...
    r3.xy = saturate(r1.zw);
    r8.xy = clampU ? r3.xy : r1.zw;
  }
  r3.xyzw = emissiveMap1.Sample(colorSampler_s, r8.xy).xyzw;
  r3.xyzw = emissiveTint1.xyzw * r3.xyzw;
  r3.xyz = r3.xyz * r3.www;
  r1.z = v2.x + v2.y;
  r1.z = v2.z + r1.z;
  r1.z = flickerSeed.y + r1.z;
  r1.z = frac(r1.z);
  r4.y = gameTime.w * flickerSpeed + r1.z;
  r4.x = flickerSeed.x;
