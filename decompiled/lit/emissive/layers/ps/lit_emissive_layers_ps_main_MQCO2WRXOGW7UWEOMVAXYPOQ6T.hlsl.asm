...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:33:06 2021
//
//
// Buffer Definitions: 
//
...
mul r0.w, r2.w, v1.x
sample_indexable(texture2d)(float,float,float,float) r1.z, r0.yzyy, t22.yzxw, s3
...
sample_indexable(texture2d)(float,float,float,float) r4.xyz, r0.yzyy, t24.xyzw, s5
...
mad r7.xyz, r4.yzwy, r2.wwww, r7.xyzx
          ...
          if_nz r10.w
            ...
            if_nz r10.w
              ...
              if_nz r23.y
                ...
                mul r25.xyz, r4.xxxx, r26.xyzx
                mul r23.xyz, r4.xxxx, r23.xyzx
                mul r24.xyz, r4.xxxx, r24.xyzx
          ...
          if_nz r15.z
            ...
            if_nz r15.z
              ...
              if_nz r22.w
                ...
                mul r28.xyz, r4.xxxx, r29.xyzx
                mul r26.xyz, r4.xxxx, r26.xyzx
                mul r27.xyz, r4.xxxx, r27.xyzx
...
mov_sat r15.x, r15.x
add r0.z, -r15.x, l(1.000000)
mad r2.xyz, r2.xyzx, r0.zzzz, r16.xyzx
mad r0.w, r0.w, r0.z, r15.x
mad r7.xyz, r7.xyzx, r0.zzzz, r17.xyzx
dp3 r2.w, r7.xyzx, r7.xyzx
rsq r2.w, r2.w
mul r7.xyz, r2.wwww, r7.xyzx
mad r9.y, r1.w, r0.z, r15.y
mad r3.xyz, r3.xyzx, r0.zzzz, r18.xyzx
lt r1.w, l(0.500000), cb0[20].x
if_nz r1.w
  mul r1.w, cb0[12].w, cb0[12].z
  mul r2.w, r1.w, cb0[13].x
  ...
  mul r1.w, r1.w, r2.w
  round_ne r1.w, r1.w
  div r2.w, r1.w, cb0[12].w
  mul r3.w, r1.w, cb0[12].w
  ge r3.w, r3.w, -r3.w
  movc r3.w, r3.w, cb0[12].w, -cb0[12].w
  div r4.x, l(1.000000, 1.000000, 1.000000, 1.000000), r3.w
  mul r1.w, r1.w, r4.x
  frc r1.w, r1.w
  mul r1.w, r1.w, r3.w
  round_z r1.w, r1.w
  add r1.w, r1.w, r1.x
  div r10.x, r1.w, cb0[12].w
  round_z r1.w, r2.w
  add r1.w, r1.w, r1.y
  div r10.y, r1.w, cb0[12].z
else 
  dp3 r1.w, -v6.xyzx, -v6.xyzx
  rsq r1.w, r1.w
  mul r11.xyz, r1.wwww, -v6.xyzx
  dp3 r12.x, r11.xyzx, r5.xyzx
  dp3 r12.y, r11.xyzx, r6.xyzx
  dp3 r1.w, r11.xyzx, r4.yzwy
  lt r2.w, l(0.000000), r1.w
  div r8.zw, -r12.xxxy, r1.wwww
  ...
  mul r8.zw, r8.zzzw, cb0[14].zzzw
  mad r8.zw, r9.zzzw, cb0[14].zzzw, r8.zzzw
  mad r8.zw, cb0[15].xxxy, cb0[14].zzzw, r8.zzzw
  mad r1.w, cb0[13].z, cb1[69].w, l(1.000000)
  mul r1.w, r1.w, cb0[13].y
  mul r1.w, r1.w, l(0.01745329)
  sincos r4.x, r11.x, r1.w
  mov r11.y, r11.x
  mov r11.z, r4.x
  dp2 r12.x, r11.yzyy, r8.zwzz
  mov r11.x, -r4.x
  dp2 r12.y, r11.xyxx, r8.zwzz
  mul r8.zw, cb0[14].xxxy, cb1[69].wwww
  mad r8.zw, r8.zzzw, cb0[14].zzzw, r12.xxxy
  mul r1.w, cb0[16].x, cb1[69].w
  sincos null, r1.w, r1.w
  mad r1.w, r1.w, l(0.500000), l(0.500000)
  add r1.w, -r1.w, l(1.000000)
  add r2.w, -cb0[15].z, cb0[15].w
  mad r1.w, r1.w, r2.w, cb0[15].z
  div r8.zw, r8.zzzw, r1.wwww
  add r8.zw, r8.zzzw, l(0.000000, 0.000000, 0.500000, 0.500000)
  mov_sat r9.zw, r8.zzzw
  movc r10.xy, cb0[16].zwzz, r9.zwzz, r8.zwzz
endif 
...
add r1.w, v2.y, v2.x
add r1.w, r1.w, v2.z
add r2.w, r1.w, cb0[17].y
frc r2.w, r2.w
mad r11.y, cb1[69].w, cb0[17].z, r2.w
mov r11.x, cb0[17].x
sample_l_indexable(texture2d)(float,float,float,float) r2.w, r11.xyxx, t29.yzwx, s7, l(0.000000)
log r2.w, |r2.w|
mul r2.w, r2.w, cb0[18].z
exp r2.w, r2.w
add r3.w, -cb0[18].x, cb0[18].y
mad r2.w, r2.w, r3.w, cb0[18].x
mul r10.xyz, r2.wwww, r10.xyzx
lt r2.w, l(0.500000), cb0[25].z
if_nz r2.w
  mul r2.w, cb0[21].w, cb0[22].x
  mul r3.w, r2.w, cb0[22].y
  mul r4.x, r3.w, cb1[69].w
  ge r4.x, r4.x, -r4.x
  movc r4.x, r4.x, r3.w, -r3.w
  div r5.w, l(1.000000, 1.000000, 1.000000, 1.000000), r4.x
  ...
  mul r2.w, r2.w, r3.w
  round_ne r2.w, r2.w
  div r3.w, r2.w, cb0[22].x
  mul r4.x, r2.w, cb0[22].x
  ge r4.x, r4.x, -r4.x
  movc r4.x, r4.x, cb0[22].x, -cb0[22].x
  div r5.w, l(1.000000, 1.000000, 1.000000, 1.000000), r4.x
  mul r2.w, r2.w, r5.w
  frc r2.w, r2.w
  mul r2.w, r2.w, r4.x
  round_z r2.w, r2.w
  add r2.w, r1.x, r2.w
  div r11.x, r2.w, cb0[22].x
  round_z r2.w, r3.w
  add r2.w, r1.y, r2.w
  div r11.y, r2.w, cb0[21].w
else 
  dp3 r2.w, -v6.xyzx, -v6.xyzx
  rsq r2.w, r2.w
  mul r12.xyz, r2.wwww, -v6.xyzx
  dp3 r13.x, r12.xyzx, r5.xyzx
  dp3 r13.y, r12.xyzx, r6.xyzx
  dp3 r2.w, r12.xyzx, r4.yzwy
  lt r3.w, l(0.000000), r2.w
  div r8.zw, -r13.xxxy, r2.wwww
  and r8.zw, r3.wwww, r8.zzzw
  add r9.zw, r1.xxxy, l(0.000000, 0.000000, -0.500000, -0.500000)
  add r2.w, cb0[25].y, l(0.000010)
  mul r8.zw, r2.wwww, r8.zzzw
  mul r8.zw, r8.zzzw, cb0[23].zzzw
  mad r8.zw, r9.zzzw, cb0[23].zzzw, r8.zzzw
  mad r8.zw, cb0[24].xxxy, cb0[23].zzzw, r8.zzzw
  mad r2.w, cb0[22].w, cb1[69].w, l(1.000000)
  mul r2.w, r2.w, cb0[22].z
  mul r2.w, r2.w, l(0.01745329)
  sincos r4.x, r12.x, r2.w
  mov r12.y, r12.x
  mov r12.z, r4.x
  dp2 r13.x, r12.yzyy, r8.zwzz
  mov r12.x, -r4.x
  dp2 r13.y, r12.xyxx, r8.zwzz
  mul r8.zw, cb0[23].xxxy, cb1[69].wwww
  mad r8.zw, r8.zzzw, cb0[23].zzzw, r13.xxxy
  mul r2.w, cb0[25].x, cb1[69].w
  sincos null, r2.w, r2.w
  mad r2.w, r2.w, l(0.500000), l(0.500000)
  add r2.w, -r2.w, l(1.000000)
  add r3.w, -cb0[24].z, cb0[24].w
  mad r2.w, r2.w, r3.w, cb0[24].z
  div r8.zw, r8.zzzw, r2.wwww
  add r8.zw, r8.zzzw, l(0.000000, 0.000000, 0.500000, 0.500000)
  mov_sat r9.zw, r8.zzzw
  movc r11.x, cb0[25].w, r9.z, r8.z
  movc r11.y, cb0[26].x, r9.w, r8.w
endif 
sample_indexable(texture2d)(float,float,float,float) r11.xyzw, r11.xyxx, t38.xyzw, s1
mul r11.xyz, r11.xyzx, cb0[21].xyzx
mul r2.w, r11.w, cb0[19].w
mul r11.xyz, r2.wwww, r11.xyzx
add r2.w, r1.w, cb0[26].z
frc r2.w, r2.w
mad r12.y, cb1[69].w, cb0[26].w, r2.w
mov r12.x, cb0[26].y
sample_l_indexable(texture2d)(float,float,float,float) r2.w, r12.xyxx, t29.yzwx, s7, l(0.000000)
log r2.w, |r2.w|
mul r2.w, r2.w, cb0[27].z
exp r2.w, r2.w
add r3.w, -cb0[27].x, cb0[27].y
mad r2.w, r2.w, r3.w, cb0[27].x
mul r11.xyz, r2.wwww, r11.xyzx
add r2.w, -r11.w, l(1.000000)
mad r10.xyz, r10.xyzx, r2.wwww, r11.xyzx
lt r2.w, l(0.500000), cb0[32].z
if_nz r2.w
  mul r2.w, cb0[28].w, cb0[29].x
  mul r3.w, r2.w, cb0[29].y
  mul r4.x, r3.w, cb1[69].w
  ge r4.x, r4.x, -r4.x
  movc r4.x, r4.x, r3.w, -r3.w
  div r5.w, l(1.000000, 1.000000, 1.000000, 1.000000), r4.x
  ...
  mul r2.w, r2.w, r3.w
  round_ne r2.w, r2.w
  div r3.w, r2.w, cb0[29].x
  mul r4.x, r2.w, cb0[29].x
  ge r4.x, r4.x, -r4.x
  movc r4.x, r4.x, cb0[29].x, -cb0[29].x
  div r5.w, l(1.000000, 1.000000, 1.000000, 1.000000), r4.x
  mul r2.w, r2.w, r5.w
  frc r2.w, r2.w
  mul r2.w, r2.w, r4.x
  round_z r2.w, r2.w
  add r2.w, r1.x, r2.w
  div r11.x, r2.w, cb0[29].x
  round_z r2.w, r3.w
  add r2.w, r1.y, r2.w
  div r11.y, r2.w, cb0[28].w
else 
  dp3 r2.w, -v6.xyzx, -v6.xyzx
  rsq r2.w, r2.w
  mul r12.xyz, r2.wwww, -v6.xyzx
  dp3 r5.x, r12.xyzx, r5.xyzx
  dp3 r5.y, r12.xyzx, r6.xyzx
  dp3 r2.w, r12.xyzx, r4.yzwy
  lt r3.w, l(0.000000), r2.w
  div r4.xy, -r5.xyxx, r2.wwww
  and r4.xy, r3.wwww, r4.xyxx
  add r1.xy, r1.xyxx, l(-0.500000, -0.500000, 0.000000, 0.000000)
  add r2.w, cb0[32].y, l(0.000010)
  mul r4.xy, r2.wwww, r4.xyxx
  mul r4.xy, r4.xyxx, cb0[30].zwzz
  mad r1.xy, r1.xyxx, cb0[30].zwzz, r4.xyxx
  mad r1.xy, cb0[31].xyxx, cb0[30].zwzz, r1.xyxx
  mad r2.w, cb0[29].w, cb1[69].w, l(1.000000)
  mul r2.w, r2.w, cb0[29].z
  mul r2.w, r2.w, l(0.01745329)
  ...
  mad r1.xy, r1.xyxx, cb0[30].zwzz, r6.xyxx
  mul r2.w, cb0[32].x, cb1[69].w
  sincos null, r2.w, r2.w
  mad r2.w, r2.w, l(0.500000), l(0.500000)
  add r2.w, -r2.w, l(1.000000)
  add r3.w, -cb0[31].z, cb0[31].w
  mad r2.w, r2.w, r3.w, cb0[31].z
  div r1.xy, r1.xyxx, r2.wwww
  add r1.xy, r1.xyxx, l(0.500000, 0.500000, 0.000000, 0.000000)
  mov_sat r4.xy, r1.xyxx
  movc r11.x, cb0[32].w, r4.x, r1.x
  movc r11.y, cb0[33].x, r4.y, r1.y
endif 
sample_indexable(texture2d)(float,float,float,float) r4.xyzw, r11.xyxx, t46.xyzw, s1
mul r4.xyz, r4.xyzx, cb0[28].xyzx
mul r1.x, r4.w, cb0[19].w
mul r4.xyz, r1.xxxx, r4.xyzx
add r1.x, r1.w, cb0[33].z
frc r1.x, r1.x
mad r1.y, cb1[69].w, cb0[33].w, r1.x
mov r1.x, cb0[33].y
sample_l_indexable(texture2d)(float,float,float,float) r1.x, r1.xyxx, t29.xyzw, s7, l(0.000000)
log r1.x, |r1.x|
mul r1.x, r1.x, cb0[34].z
exp r1.x, r1.x
add r1.y, -cb0[34].x, cb0[34].y
mad r1.x, r1.x, r1.y, cb0[34].x
mul r1.xyw, r1.xxxx, r4.xyxz
add r2.w, -r4.w, l(1.000000)
mad r1.xyw, r10.xyxz, r2.wwww, r1.xyxw
mul r4.xyz, r0.zzzz, r1.xywx
...
dp3_sat r9.x, r7.xyzx, r1.xywx
dp3 r3.w, -r1.xywx, r7.xyzx
add r3.w, r3.w, r3.w
mad r12.xyz, r7.xyzx, -r3.wwww, -r1.xywx
mul r3.w, r9.y, l(17.000000)
exp r3.w, r3.w
add r3.w, r3.w, l(2.000000)
div r3.w, l(2.000000), r3.w
sqrt r5.y, r3.w
add r5.z, -r9.y, l(1.000000)
...
ftou r0.y, r0.y
ushr r13.xy, r8.xyxx, l(6, 6, 0, 0)
ishl r13.z, r0.y, l(4)
and r0.y, r8.z, l(-32)
iadd r8.x, -r0.y, r8.z
and r8.y, cb2[0].y, l(-32)
iadd r8.w, -r8.y, cb2[0].y
...
loop 
  ...
  ieq r10.w, r0.y, r9.z
  bfi r11.y, r8.x, l(0), l(0), r9.w
  movc r9.w, r10.w, r11.y, r9.w
  ieq r10.w, r8.y, r9.z
  ubfe r11.y, r8.w, l(0), r9.w
  movc r9.w, r10.w, r11.y, r9.w
...
rcp r0.y, r0.y
mov_sat r22.w, r22.w
mul r8.xyz, r0.yyyy, r21.xyzx
mul r11.yzw, r0.yyyy, r22.xxyz
lt r5.z, r22.w, l(0.990000)
if_nz r5.z
  add r5.z, -r22.w, l(1.000000)
  mul r6.z, r5.z, cb2[19].x
  ...
  dp3 r6.z, r14.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
  mad r8.xyz, r21.xyzx, r0.yyyy, r14.xyzx
  mov r12.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r14.xyz, r12.xyzw, t8.xyzw, s2, r5.w
  mad r0.y, cb2[19].x, r5.z, -r6.z
  mad r0.y, r9.y, r0.y, r6.z
  mad r11.yzw, r14.xxyz, r0.yyyy, r11.yyzw
endif 
add r0.y, r1.z, r9.x
log r0.y, |r0.y|
mul r0.y, r0.y, r5.y
...
mad r5.zw, r9.xxxy, l(0.000000, 0.000000, 0.984375, 0.984375), l(0.000000, 0.000000, 0.00781250, 0.00781250)
sample_l_indexable(texture2d)(float,float,float,float) r5.zw, r5.zwzz, t5.zwxy, s2, l(0.000000)
mul r9.yzw, r0.yyyy, r11.yyzw
...
if_z r6.z
  ...
  if_z r12.w
    if_z cb2[58].y
      ...
      itof r11.w, cb2[26].y
      add r15.z, r7.w, r11.w
      sample_c_lz_indexable(texture2darray)(float,float,float,float) r11.w, r15.xyzx, t13.xxxx, s13, r6.z
    ...
    if_nz cb2[58].y
      ...
      loop 
        uge r15.w, r13.w, l(8)
        breakc_nz r15.w
        ult r15.w, r10.w, r13.w
        movc r16.zw, r15.wwww, r11.yyyz, r16.xxxy
        movc r17.x, r15.w, cb2[r7.w + 20].w, cb2[r11.w + 20].w
        movc r15.w, r15.w, r7.w, r11.w
        ...
        utof r17.z, r15.w
        sample_c_lz_indexable(texture2darray)(float,float,float,float) r15.w, r17.xyzx, t13.xxxx, s13, r6.z
...
if_nz r6.z
  ...
  if_nz r6.z
    ...
    if_nz r10.w
      ...
      mad r19.xyz, r7.xyzx, r12.wwww, v6.xyzx
      ...
      if_z r12.w
        ...
        if_nz cb2[58].y
          ...
          loop 
            ...
            mad r17.xy, r18.xyxx, r10.wwww, r16.xyxx
          ...
          utof r16.z, r12.w
          sample_c_lz_indexable(texture2darray)(float,float,float,float) r13.w, r16.xyzx, t9.xxxx, s13, r7.w
        endif 
    ...
    mad r15.xyz, r7.wwww, r11.yzwy, r8.xyzx
    ...
    mad r10.w, |r7.w|, r3.w, -|r7.w|
    mad r7.w, |r7.w|, r10.w, l(1.000000)
    mad r5.w, r5.w, r0.y, r1.z
    mul r7.w, r7.w, r7.w
    mul r5.w, r5.w, r7.w
    rcp r5.w, r5.w
    mul r5.w, r6.z, r5.w
    ...
    mad r16.xyz, r5.wwww, r11.yzwy, r9.yzwy
    ...
    mov r15.w, r17.z
    mov r8.w, r14.z
    movc r8.xyzw, r5.zzzz, r15.xyzw, r8.xyzw
    mov r17.zw, r16.xxxy
    mov r14.zw, r9.yyyz
    movc r15.xyzw, r5.zzzz, r17.xyzw, r14.xyzw
    movc r9.w, r5.z, r16.z, r9.w
    mov r14.z, r8.w
    mov r14.xy, r15.xyxx
    mov r9.yz, r15.zzwz
  endif 
...
mov r15.x, -r6.x
not r0.z, r2.w
mad r5.z, -r9.x, l(0.500000), l(1.000000)
          ...
          if_nz r21.w
            ...
            if_nz r21.w
              ...
              if_nz r21.w
                ...
                mad r42.xyz, r7.xyzx, r21.wwww, v6.xyzx
              ...
              if_nz r21.w
                ...
                if_nz r13.w
                  ...
                  mad r19.xyz, r7.xyzx, r25.wwww, v6.xyzx
          ...
          if_nz r14.w
            ...
            if_nz r14.w
              ...
              if_nz r14.w
                ...
                mad r22.xyz, r7.xyzx, r14.wwww, v6.xyzx
              ...
              if_nz r14.w
                ...
                if_nz r19.x
                  ...
                  mad r23.xyz, r7.xyzx, r22.xxxx, v6.xyzx
                  ...
                  if_nz r19.x
                    ...
                    mad r22.x, |r12.w|, l(-0.200000), l(0.400000)
                    mad r24.xyz, r7.xyzx, r22.xxxx, v6.xyzx
...
mov r4.w, l(1.000000)
movc r2.xyzw, cb0[20].yyyy, r2.xyzw, r4.xyzw
add r1.xyz, r1.xyzx, r2.xyzx
mul r0.y, r2.w, cb0[19].w
...
ret 
// Approximately 2854 instruction slots used
