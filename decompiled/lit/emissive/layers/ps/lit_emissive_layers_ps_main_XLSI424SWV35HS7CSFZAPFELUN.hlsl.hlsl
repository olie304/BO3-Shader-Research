// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:33:18 2021
...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  r2.z = max(0, r2.z);
  r4.w = cmp(0 < debugStreamerControl.w);
  if (r4.w != 0) {
    r4.w = (int)debugStreamerControl.w;
    r5.w = colorMap.CalculateLevelOfDetailUnclamped(colorSampler_s, r0.xy);
    r0.x = colorMap.CalculateLevelOfDetail(colorSampler_s, r0.xy);
    r0.y = cmp(r5.w < r0.x);
    r0.x = cmp(0 < r0.x);
    r6.xyz = (int3)r4.www & int3(1,2,4);
...
r2.w = samp0[]..swiz;
  ...
  r1.w = 1 + -r14.x;
  r1.xyz = r1.xyz * r1.www + r15.xyz;
  o0.w = r0.x * r1.w + r14.x;
  r2.xyz = r2.xyz * r1.www + r16.xyz;
  r0.x = dot(r2.xyz, r2.xyz);
  r0.x = rsqrt(r0.x);
  r2.xyz = r2.xyz * r0.xxx;
  r0.y = r0.y * r1.w + r14.y;
  r6.xyz = r6.xyz * r1.www + r17.xyz;
  r3.x = cmp(0.5 < uvMotionToggle1);
  if (r3.x != 0) {
    r3.x = rowCount * columnCount;
    r4.w = imageTime * r3.x;
    ...
    r3.x = r4.w * r3.x;
    r3.x = round(r3.x);
    r4.w = r3.x / columnCount;
    r5.w = columnCount * r3.x;
    r5.w = cmp(r5.w >= -r5.w);
    ...
    r9.y = r9.x;
    r9.z = r3.x;
    r10.x = dot(r9.yz, r7.zw);
    r9.x = -r3.x;
    r10.y = dot(r9.xy, r7.zw);
    r7.zw = gameTime.ww * scrollUVs.xy;
    r7.zw = r7.zw * scaleUVs.xy + r10.xy;
  ...
  if (r4.w != 0) {
    ...
    r6.w = columnCount2 * r4.w;
    r6.w = cmp(r6.w >= -r6.w);
    r6.w = r6.w ? columnCount2 : -columnCount2;
    r7.z = 1 / r6.w;
    r4.w = r7.z * r4.w;
    r4.w = frac(r4.w);
    r4.w = r6.w * r4.w;
    ...
    r7.zw = r9.zw * scaleUVs2.xy + r7.zw;
    ...
    r7.zw = r7.zw * scaleUVs2.xy + r12.xy;
    ...
    r9.x = clampU2 ? r9.z : r7.z;
    r9.y = clampV2 ? r9.w : r7.w;
  }
  ...
  r4.w = clampV2 + r3.x;
  r4.w = frac(r4.w);
  r10.y = gameTime.w * clampV2 + r4.w;
  r10.x = clampV2;
  r4.w = flickerLookupMap.SampleLevel(lookupSampler_s, r10.xy, 0).x;
  r4.w = log2(abs(r4.w));
  ...
  if (r4.w != 0) {
    ...
    r6.w = columnCount3 * r4.w;
    r6.w = cmp(r6.w >= -r6.w);
    r6.w = r6.w ? columnCount3 : -columnCount3;
    r7.z = 1 / r6.w;
    r4.w = r7.z * r4.w;
    r4.w = frac(r4.w);
    r4.w = r6.w * r4.w;
    ...
    r3.w = 9.99999975e-06 + layer3Depth;
    r3.yz = r3.yz * r3.ww;
    r3.yz = scaleUVs3.xy * r3.yz;
    r3.yz = r4.xy * scaleUVs3.xy + r3.yz;
    r3.yz = offsetUVs3.xy * scaleUVs3.xy + r3.yz;
    r3.w = rotateUVs3.y * gameTime.w + 1;
    r3.w = rotateUVs3.x * r3.w;
    r3.w = 0.0174532924 * r3.w;
    sincos(r3.w, r4.x, r5.x);
    r5.y = r5.x;
    r5.z = r4.x;
    r10.x = dot(r5.yz, r3.yz);
    r5.x = -r4.x;
    r10.y = dot(r5.xy, r3.yz);
    r3.yz = gameTime.ww * scrollUVs3.xy;
    r3.yz = r3.yz * scaleUVs3.xy + r10.xy;
    r3.w = gameTime.w * zoomRate3;
    r3.w = cos(r3.w);
    r3.w = r3.w * 0.5 + 0.5;
    r3.w = 1 + -r3.w;
    r4.x = zoomUVs3.y + -zoomUVs3.x;
    r3.w = r3.w * r4.x + zoomUVs3.x;
    r3.yz = r3.yz / r3.ww;
    r3.yz = float2(0.5,0.5) + r3.yz;
    r4.xy = saturate(r3.yz);
    r9.x = clampU3 ? r4.x : r3.y;
    r9.y = clampV3 ? r4.y : r3.z;
  }
  r4.xyzw = emissiveMap3.Sample(colorSampler_s, r9.xy).xyzw;
  r3.yzw = emissiveTint3.xyz * r4.xyz;
  r4.x = hdrScale * r4.w;
  r3.yzw = r4.xxx * r3.yzw;
  r3.x = clampV3 + r3.x;
  r3.x = frac(r3.x);
  r4.y = gameTime.w * clampV3 + r3.x;
  r4.x = clampV3;
  r3.x = flickerLookupMap.SampleLevel(lookupSampler_s, r4.xy, 0).x;
  r3.x = log2(abs(r3.x));
  r3.x = flickerPower3 * r3.x;
  r3.x = exp2(r3.x);
  r4.x = flickerRange3.y + -flickerRange3.x;
  r3.x = r3.x * r4.x + flickerRange3.x;
      ...
      if (r16.z != 0) {
        ...
        if (r8.w != 0) {
          ...
          r35.w = samp0[]..swiz;
            ...
            r16.w = -r16.w * r17.z + 1;
            r16.w = r29.y * r16.w;
            r7.y = r18.w ? r16.w : r21.z;
            r29.xy = r18.zz ? r29.xy : r7.xy;
            r16.z = (int)r16.z + 1;
            r15.w = r17.w;
          }
          ...
          if (r15.w != 0) {
            ...
            r16.z = r15.w * r7.z;
            r29.xzw = r22.xyz * r7.yyy;
            r7.y = dot(r29.xzw, float3(0.212599993,0.715200007,0.0722000003));
            r7.y = r7.z * r15.w + r7.y;
            r7.y = r16.z / r7.y;
            r32.x = r28.w;
            r32.yz = r27.yz;
            r30.xyw = r29.zwx * r7.yyy + r32.yzx;
            r31.w = r30.w;
          } else {
            r31.xyzw = r28.xyzw;
            r30.xyz = r27.yzw;
  ...
  if (r0.w == 0) {
    ...
    while (true) {
      ...
      r10.y = cmp((int)r7.x == (int)r8.w);
      bitmask.z = ((~(-1 << r7.y)) << 0) & 0xffffffff;  r10.z = (((uint)0 << 0) & bitmask.z) | ((uint)r9.w & ~bitmask.z);
    ...
    if (r7.w != 0) {
      ...
      r8.z = 0;
      while (true) {
        r8.w = cmp((uint)r8.z >= (uint)r0.w);
        if (r8.w != 0) break;
        r13.z = (uint)r8.z >> 5;
        r14.xyz = (int3)r12.xyz + (int3)r13.xyz;
        r8.w = visibleProbes.Load(r14.xyzw).x;
        r9.w = cmp((int)r7.x == (int)r8.z);
        if (r7.y == 0) r12.w = 0; else if (r7.y+0 < 32) {         r12.w = (uint)r8.w << (32-(r7.y + 0)); r12.w = (uint)r12.w >> (32-r7.y);        } else r12.w = (uint)r8.w >> 0;
    ...
    if (r5.z != 0) {
      ...
      r13.x = globalProbeConstants.data[0].w * r7.x;
      r13.yz = globalProbeConstants.data[1].xy * r7.yz;
      r7.xyz = saturate(float3(0.5,0.5,0.5) + r13.xyz);
      r13.xy = globalProbeConstants.data[1].zw * r7.xy;
      r13.z = globalProbeConstants.data[2].x * r7.z;
      r7.xyz = globalProbeConstants.data[2].yzw + r13.xyz;
      r10.yzw = cmp(float3(0,0,0) < r2.xyz);
      r13.xyz = r10.yzw ? float3(0,0,0) : float3(0.5,0.5,0.5);
      r13.w = 0;
      r10.yzw = r13.wwx + r7.xyz;
      r10.yzw = gProbeXArray.SampleLevel(samplerLinearClamp_s, r10.yzw, 0).xyz;
      r14.xyz = r2.xyz * r2.xyz;
      r14.xyz = r14.xyz * r6.www;
      r15.xyz = r13.wwy + r7.xyz;
      ...
      r19.xyz = r22.xyz * r0.www + r7.xyz;
      r11.w = 0;
      r7.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r11.xyzw, r5.w).xyz;
      r0.w = sunConstants.globalProbeExposure * r5.z + -r2.w;
      r0.w = r0.y * r0.w + r2.w;
      r20.xyz = r7.xyz * r0.www + r20.xyz;
    }
  } else {
    r20.x = r19.w;
  }
  ...
  if (r8.z == 0) {
    ...
    r8.z = -sunConstants.splitDepthOffset + r10.w;
    ...
    if (r12.w == 0) {
      if (enableDitheredShadow == 0) {
        ...
        r14.z = r10.w + r9.w;
        r10.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r14.xyz, r8.z).x;
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          r16.z = (uint)r15.z;
          r15.z = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r8.z).x;
  ...
  if (r8.z != 0) {
    r8.z = cmp(0 < r8.w);
    if (r8.z != 0) {
      r8.z = sunConstants.specScale * r4.w;
      r8.z = r8.z * r6.w;
      ...
      r14.w = r16.z;
      r7.w = r13.z;
      r7.xyzw = r5.wwww ? r14.xyzw : r7.xyzw;
      r16.zw = r15.xy;
      r13.zw = r0.yz;
            ...
            if (r24.w != 0) {
              ...
              if (r24.w != 0) {
                ...
                if (r24.w != 0) {
                  ...
                  r38.xyz = r38.xyz * r11.www + r4.xyz;
                  r11.w = dot(r38.xyz, r38.xyz);
                  r11.w = rsqrt(r11.w);
                  r38.xyz = r38.xyz * r11.www;
                  r11.w = dot(r38.xyz, r4.xyz);
            ...
            r39.w = samp0[]..swiz;
              ...
              if (r15.z != 0) {
                ...
                if (r15.z != 0) {
                  ...
                  r19.xyz = r19.xyz * r11.www + r4.xyz;
                  r11.w = dot(r19.xyz, r19.xyz);
                  r11.w = rsqrt(r11.w);
                  r19.xyz = r19.xyz * r11.www;
                  r11.w = dot(r19.xyz, r4.xyz);
