...
sample_indexable(texture2d)(float,float,float,float) r0.w, r0.xyxx, t25.yzwx, s6
sample_indexable(texture2d)(float,float,float,float) r1.w, r0.xyxx, t24.yzwx, s3
add r2.x, -cb0[11].x, cb0[11].y
mad r1.w, r1.w, r2.x, cb0[11].x
mul_sat r1.w, r1.w, l(0.05882353)
sample_indexable(texture2d)(float,float,float,float) r2.xyz, r0.xyxx, t22.xyzw, s5
...
mad r6.xyz, r4.xyzx, r0.xxxx, r6.xyzx
...
and r6.zw, r3.wwww, l(0, 0, 0x10000000, 0x20000000)
if_nz r6.z
          ...
          if_nz r14.w
            ...
            if_nz r14.w
              ...
              if_nz r24.y
                ...
                mul r26.xyz, r2.zzzz, r27.xyzx
                mul r24.xyz, r2.zzzz, r24.xyzx
                mul r25.xyz, r2.zzzz, r25.xyzx
...
mad r2.xyz, r2.xywx, r0.yyyy, r15.xyzx
dp3 r0.z, r2.xyzx, r2.xyzx
rsq r0.z, r0.z
mul r2.xyz, r0.zzzz, r2.xyzx
mad r7.y, r1.w, r0.y, r13.y
...
if_nz r0.z
  ...
  mov r11.y, r11.x
  mov r11.z, r10.x
  dp2 r12.x, r11.yzyy, r6.zwzz
  mov r11.x, -r10.x
  dp2 r12.y, r11.xyxx, r6.zwzz
  mul r6.zw, cb0[13].xxxy, cb1[69].wwww
  mad r6.zw, r6.zzzw, cb0[13].zzzw, r12.xxxy
...
frc r1.w, r1.w
mad r10.y, cb1[69].w, cb0[16].z, r1.w
mov r10.x, cb0[16].x
sample_l_indexable(texture2d)(float,float,float,float) r1.w, r10.xyxx, t26.yzwx, s7, l(0.000000)
log r1.w, |r1.w|
...
if_nz r1.w
  ...
  round_z r1.w, r1.w
  add r1.w, r1.w, v1.y
  div r10.x, r1.w, cb0[21].x
  round_z r1.w, r3.w
  add r1.w, r1.w, v1.z
  div r10.y, r1.w, cb0[20].w
else 
  dp3 r1.w, -v6.xyzx, -v6.xyzx
  rsq r1.w, r1.w
  mul r11.xyz, r1.wwww, -v6.xyzx
...
mul r1.w, r10.w, cb0[18].w
mul r10.xyz, r1.wwww, r10.xyzx
add r1.w, r0.z, cb0[25].z
frc r1.w, r1.w
mad r11.y, cb1[69].w, cb0[25].w, r1.w
mov r11.x, cb0[25].y
sample_l_indexable(texture2d)(float,float,float,float) r1.w, r11.xyxx, t26.yzwx, s7, l(0.000000)
log r1.w, |r1.w|
...
if_nz r1.w
  ...
  round_z r1.w, r1.w
  add r1.w, r1.w, v1.y
  div r10.x, r1.w, cb0[28].x
  round_z r1.w, r3.w
  add r1.w, r1.w, v1.z
  div r10.y, r1.w, cb0[27].w
else 
  dp3 r1.w, -v6.xyzx, -v6.xyzx
  rsq r1.w, r1.w
  mul r11.xyz, r1.wwww, -v6.xyzx
...
mov r4.x, cb0[32].y
sample_l_indexable(texture2d)(float,float,float,float) r0.z, r4.xyxx, t26.yzxw, s7, l(0.000000)
log r0.z, |r0.z|
mul r0.z, r0.z, cb0[33].z
exp r0.z, r0.z
add r1.w, -cb0[33].x, cb0[33].y
mad r0.z, r0.z, r1.w, cb0[33].x
...
frc r1.w, r1.w
mad r1.w, r1.w, l(6.28318548), cb1[70].w
sincos r5.x, r11.x, r1.w
dp3_sat r7.x, r2.xyzx, r4.xyzx
dp3 r1.w, -r4.xyzx, r2.xyzx
add r1.w, r1.w, r1.w
mad r12.xyz, r2.xyzx, -r1.wwww, -r4.xyzx
...
loop 
  ...
  ieq r8.w, r0.x, r7.z
  bfi r9.z, r6.x, l(0), l(0), r7.w
  movc r7.w, r8.w, r9.z, r7.w
  ieq r8.w, r6.y, r7.z
  ubfe r9.z, r6.w, l(0), r7.w
  movc r7.w, r8.w, r9.z, r7.w
    ...
    if_nz r11.y
      ...
      if_nz r10.w
        ...
        if_nz r11.y
          ...
          mul r13.w, r5.w, r10.w
          mul r11.yzw, r9.wwww, r11.yyzw
          dp3 r9.w, r11.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
          mad r9.w, r5.w, r10.w, r9.w
          div r9.w, r13.w, r9.w
          mov r15.x, r23.w
          mov r15.yz, r24.xxyx
          mad r24.xyw, r11.zwzy, r9.wwww, r15.yzyx
          mov r23.w, r24.w
        endif 
      endif 
    endif 
      ...
      if_nz r13.w
        ...
        if_nz r10.w
          ...
          loop 
            ...
            mov r17.w, r20.w
          endloop 
          add_sat r10.w, -r8.w, r28.y
          mul r13.w, r14.w, r10.w
          ...
          if_nz r14.z
            ...
            mad r24.w, r10.w, r14.w, r24.w
            mul r9.w, r26.z, r13.w
            mov r26.z, r34.z
            dp3 r10.w, r12.xyzx, r26.xyzx
            ...
            min r10.w, r10.w, |r13.w|
            mov r39.zw, r38.zzzw
            dp3 r13.w, r12.zxyz, r39.xzwx
            dp3 r14.z, r27.zxyz, r39.xzwx
            ...
            mad r18.yzw, r12.xxyz, r10.wwww, r18.yyzw
            ...
            utof r34.w, r13.w
            sample_l_indexable(texturecubearray)(float,float,float,float) r18.yzw, r34.xyzw, t8.wxyz, s2, r10.w
            ...
            mul r13.w, r5.w, r10.w
            mul r18.yzw, r9.wwww, r18.yyzw
            dp3 r9.w, r18.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
            mad r9.w, r5.w, r10.w, r9.w
            div r9.w, r13.w, r9.w
            mad r24.xyz, r18.yzwy, r9.wwww, r24.xyzx
          endif 
        endif 
      endif 
    endloop 
...
rcp r0.x, r0.x
mov_sat r22.w, r22.w
mul r6.xyz, r0.xxxx, r21.xyzx
mul r11.yzw, r0.xxxx, r22.xxyz
...
if_nz r4.w
  ...
  mad r6.xyz, r21.xyzx, r0.xxxx, r14.xyzx
  mov r12.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r5.yzw, r12.xyzw, t8.wxyz, s2, r5.y
  mad r0.x, cb2[19].x, r4.w, -r2.w
  mad r0.x, r7.y, r0.x, r2.w
  mad r11.yzw, r5.yyzw, r0.xxxx, r11.yyzw
endif 
add r0.x, r0.w, r7.x
log r0.x, |r0.x|
mul r0.x, r0.x, r3.w
...
if_z r7.y
  ...
  if_nz r7.w
    ...
    loop 
      ...
      breakc_nz r9.z
      ftou r9.z, r7.w
      add r15.xy, r11.yzyy, -cb2[r9.z + 20].xyxx
      max r9.w, |r15.y|, |r15.x|
      mul r8.w, r9.w, cb2[r9.z + 20].z
      lt r9.z, r8.w, l(1.000000)
      if_nz r9.z
        break 
      endif 
  ...
  if_nz r9.z
    ...
    if_z r12.w
      ...
      if_z r9.w
        ...
        mad r12.w, r11.y, r15.x, r12.w
        mad r10.w, r11.z, r10.w, r12.w
  ...
  if_z r9.z
    if_z cb2[58].y
      ftou r9.z, r7.w
      add r15.xy, r11.yzyy, -cb2[r9.z + 20].xyxx
      mul r9.zw, r15.xxxy, cb2[r9.z + 20].zzzz
      mad r15.xy, r9.zwzz, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
      itof r9.z, cb2[26].y
      add r15.z, r7.w, r9.z
      sample_c_lz_indexable(texture2darray)(float,float,float,float) r9.z, r15.xyzx, t13.xxxx, s13, r7.y
    ...
    if_nz cb2[58].y
      ...
      ftou r8.w, r8.w
      add r16.xy, r11.yzyy, -cb2[r9.z + 20].xyxx
      mul r16.xy, r16.xyxx, cb2[r9.z + 20].zzzz
      ...
      loop 
        uge r11.w, r10.w, l(8)
        breakc_nz r11.w
        ult r11.w, r8.w, r10.w
        movc r16.zw, r11.wwww, r11.yyyz, r16.xxxy
        movc r12.w, r11.w, cb2[r7.w + 20].w, cb2[r9.z + 20].w
        movc r11.w, r11.w, r7.w, r9.z
...
if_nz r7.y
  ...
  if_nz r7.y
    ...
    if_nz r8.w
      ...
      mad r9.z, |r2.w|, l(-0.200000), l(0.400000)
      mad r19.xyz, r2.xyzx, r9.zzzz, v6.xyzx
      ...
      ge r15.zw, r9.zzzw, r15.zzzw
      ge r15.xy, r15.xyxx, r9.zwzz
      ...
      if_z r10.w
        ...
        if_nz cb2[58].y
          ...
          utof r15.z, r9.z
          sample_c_lz_indexable(texture2darray)(float,float,float,float) r9.w, r15.xyzx, t9.xxxx, s13, r7.w
        endif 
        mul r7.w, r9.w, r9.w
        mul r7.w, r9.w, r7.w
      else 
    ...
    add r7.w, -r4.w, r7.w
    mad r7.w, r3.w, r7.w, r4.w
    mul r7.w, r7.z, r7.w
    lt r2.w, l(0.000000), r2.w
    mad r15.xyz, r7.wwww, r11.yzwy, r6.xyzx
    mad r16.xyz, -v6.xyzx, r0.yyyy, cb2[17].xyzx
    ...
    mad r7.yzw, r4.wwww, r11.yyzw, r5.yyzw
    add_sat r0.y, -r0.y, l(1.000000)
    mul r8.w, r0.y, r0.y
    mul r8.w, r8.w, r8.w
    mul r0.y, r0.y, r8.w
    mul r0.y, r0.y, r4.w
    mad r16.xyz, r0.yyyy, r11.zwyz, r14.xyzx
    mov r15.w, r16.z
    mov r6.w, r14.z
    movc r6.xyzw, r2.wwww, r15.xyzw, r6.xyzw
    mov r16.zw, r7.yyyz
    mov r14.zw, r5.yyyz
    movc r15.xyzw, r2.wwww, r16.xyzw, r14.xyzw
    movc r5.w, r2.w, r7.w, r5.w
    mov r14.z, r6.w
    mov r14.xy, r15.xyxx
    mov r5.yz, r15.zzwz
  endif 
                  ...
                  if_z r18.y
                    ...
                    if_nz r7.w
                      ...
                      loop 
                        ...
                        dp2 r42.y, icb[r18.z + 0].xyxx, r9.xyxx
          ...
          if_nz r13.w
            ...
            if_nz r13.w
                ...
                if_nz r24.w
                  ...
                  if_nz r7.w
                    ...
                    loop 
                      ...
                      sample_c_lz_indexable(texture2darray)(float,float,float,float) r25.w, r31.xyzx, t9.xxxx, s13, r9.z
                      mad r18.x, r25.w, l(0.125000), r18.x
                      iadd r24.w, r24.w, l(1)
                    endloop 
                  else 
                    utof r21.z, r13.w
                    sample_c_lz_indexable(texture2darray)(float,float,float,float) r18.x, r21.xyzx, t9.xxxx, s13, r9.z
                  endif 
              ...
              if_nz r13.w
                ...
                mad r19.xyz, r9.zzzz, r20.xywx, r30.xyzx
                add_sat r9.w, -r9.w, l(1.000000)
                mul r12.w, r9.w, r9.w
                mul r12.w, r12.w, r12.w
                mul r9.w, r9.w, r12.w
                mul r9.z, r9.w, r9.z
                mad r20.xyw, r9.zzzz, r20.xyxw, r29.xyxz
...
mad r0.xyz, r28.xyzx, r8.xyzx, r0.xyzx
...
ret 
// Approximately 2830 instruction slots used
