...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  if (r1.w != 0) {
    ...
    r12.x = dot(r9.xyz, r4.xyz);
    r12.y = dot(r9.xyz, r5.xyz);
    r1.w = dot(r9.xyz, r3.yzw);
    r3.x = cmp(0 < r1.w);
    r7.zw = -r12.xy / r1.ww;
    r7.zw = r3.xx ? r7.zw : 0;
    ...
    r9.y = r9.x;
    r9.z = r3.x;
    r12.x = dot(r9.yz, r7.zw);
    r9.x = -r3.x;
    r12.y = dot(r9.xy, r7.zw);
    ...
    r1.w = r1.w * 0.5 + 0.5;
    r1.w = 1 + -r1.w;
    r3.x = zoomUVs.y + -zoomUVs.x;
    r1.w = r1.w * r3.x + zoomUVs.x;
    r7.zw = r7.zw / r1.ww;
  ...
  r1.w = v3.x + v3.y;
  r1.w = v3.z + r1.w;
  r3.x = flickerSeed.y + r1.w;
  r3.x = frac(r3.x);
  r9.y = gameTime.w * flickerSpeed + r3.x;
  r9.x = flickerSeed.x;
  r3.x = flickerLookupMap.SampleLevel(lookupSampler_s, r9.xy, 0).x;
  r3.x = log2(abs(r3.x));
  r3.x = flickerPower * r3.x;
  r3.x = exp2(r3.x);
  r4.w = flickerRange.y + -flickerRange.x;
  r3.x = r3.x * r4.w + flickerRange.x;
  r8.xyz = r8.xyz * r3.xxx;
  r3.x = cmp(0.5 < uvMotionToggle2);
  if (r3.x != 0) {
    r3.x = columnCount2 * rowCount2;
    r4.w = imageTime2 * r3.x;
    ...
    r3.x = r4.w * r3.x;
    r3.x = round(r3.x);
    r4.w = r3.x / columnCount2;
    r5.w = columnCount2 * r3.x;
    r5.w = cmp(r5.w >= -r5.w);
    ...
    r3.x = gameTime.w * zoomRate2;
    r3.x = cos(r3.x);
    r3.x = r3.x * 0.5 + 0.5;
    r3.x = 1 + -r3.x;
    r4.w = zoomUVs2.y + -zoomUVs2.x;
    r3.x = r3.x * r4.w + zoomUVs2.x;
    r7.zw = r7.zw / r3.xx;
    r7.zw = float2(0.5,0.5) + r7.zw;
  ...
  r3.x = clampV2 + r1.w;
  r3.x = frac(r3.x);
  r12.y = gameTime.w * clampV2 + r3.x;
  r12.x = clampV2;
  r3.x = flickerLookupMap.SampleLevel(lookupSampler_s, r12.xy, 0).x;
  r3.x = log2(abs(r3.x));
  r3.x = flickerPower2 * r3.x;
  r3.x = exp2(r3.x);
  r4.w = flickerRange2.y + -flickerRange2.x;
  r3.x = r3.x * r4.w + flickerRange2.x;
  r9.xyz = r9.xyz * r3.xxx;
  r3.x = 1 + -r9.w;
  r8.xyz = r8.xyz * r3.xxx + r9.xyz;
  r3.x = cmp(0.5 < uvMotionToggle3);
  if (r3.x != 0) {
    r3.x = columnCount3 * rowCount3;
    r4.w = imageTime3 * r3.x;
    r5.w = gameTime.w * r4.w;
    r5.w = cmp(r5.w >= -r5.w);
    r5.w = r5.w ? r4.w : -r4.w;
    r6.w = 1 / r5.w;
    ...
    r3.x = r4.w * r3.x;
    r3.x = round(r3.x);
    r4.w = r3.x / columnCount3;
    r5.w = columnCount3 * r3.x;
    r5.w = cmp(r5.w >= -r5.w);
  ...
  if (r7.z == 0) {
    ...
    if (r5.w != 0) {
      ...
      r20.xyz = r22.xyz * r5.yyy + r9.yzw;
      r12.w = 0;
      r9.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r12.xyzw, r5.z).xyz;
  ...
  r5.yzw = r21.xyz * r2.www;
  r14.xyz = r5.zwy * r0.yyy;
