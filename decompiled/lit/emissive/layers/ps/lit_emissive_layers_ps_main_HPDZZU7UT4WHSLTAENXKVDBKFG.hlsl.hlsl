...
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r1.x, v3.w, l(4), t4.xxxx
r1.x = samp0[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) r1.x, r1.x, l(32), t0.xxxx
r1.x = samp0[]..swiz;
  r1.x = hdrScale * r1.x;
  ...
  if (r1.w != 0) {
    ...
    r7.zw = r7.zw * scaleUVs.xy + r14.xy;
  ...
  r2.w = frac(r2.w);
  r12.y = gameTime.w * flickerSpeed + r2.w;
  r12.x = flickerSeed.x;
  ...
  if (r2.w != 0) {
    ...
    r2.w = trunc(r2.w);
    r2.w = v2.x + r2.w;
    r12.x = r2.w / columnCount2;
    r2.w = trunc(r3.w);
    r2.w = v2.y + r2.w;
    r12.y = r2.w / rowCount2;
  } else {
    r2.w = dot(-v7.xyz, -v7.xyz);
    r2.w = rsqrt(r2.w);
    r13.xyz = -v7.xyz * r2.www;
    r4.x = dot(r13.xyz, r4.xyz);
    r4.y = dot(r13.xyz, r5.xyz);
    r2.w = dot(r13.xyz, r3.xyz);
    r3.x = cmp(0 < r2.w);
    r3.yz = -r4.xy / r2.ww;
    r3.xy = r3.xx ? r3.yz : 0;
