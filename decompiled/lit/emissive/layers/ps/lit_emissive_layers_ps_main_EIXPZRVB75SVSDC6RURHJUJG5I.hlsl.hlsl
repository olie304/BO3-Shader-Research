...
r1.z = samp0[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) r1.z, r1.z, l(32), t0.xxxx
r1.z = samp0[]..swiz;
  r1.z = hdrScale * r1.z;
  ...
  if (r1.w != 0) {
    ...
    r2.y = cmp(0 < r1.w);
    r10.zw = -r12.xy / r1.ww;
    r10.zw = r2.yy ? r10.zw : 0;
    r11.xy = float2(-0.5,-0.5) + v2.xy;
    r1.w = 9.99999975e-06 + layerDepth;
    r10.zw = r10.zw * r1.ww;
    r10.zw = scaleUVs.xy * r10.zw;
    r10.zw = r11.xy * scaleUVs.xy + r10.zw;
    r10.zw = offsetUVs.xy * scaleUVs.xy + r10.zw;
    ...
    r12.y = r12.x;
    r12.z = r11.x;
    r13.x = dot(r12.yz, r10.zw);
    r12.x = -r11.x;
    r13.y = dot(r12.xy, r10.zw);
    r10.zw = gameTime.ww * scrollUVs.xy;
    r10.zw = r10.zw * scaleUVs.xy + r13.xy;
    r1.w = gameTime.w * zoomRate;
    r1.w = cos(r1.w);
    r1.w = r1.w * 0.5 + 0.5;
    r1.w = 1 + -r1.w;
    r2.y = zoomUVs.y + -zoomUVs.x;
    r1.w = r1.w * r2.y + zoomUVs.x;
    r10.zw = r10.zw / r1.ww;
    r10.zw = float2(0.5,0.5) + r10.zw;
    r11.xy = saturate(r10.zw);
    r10.xy = clampU ? r11.xy : r10.zw;
  }
  r10.xyzw = emissiveMap1.Sample(colorSampler_s, r10.xy).xyzw;
  r10.xyz = emissiveTint1.xyz * r10.xyz;
  r1.w = r10.w * r1.z;
  r10.xyz = r10.xyz * r1.www;
  r1.w = v3.x + v3.y;
  r1.w = v3.z + r1.w;
  r2.y = flickerSeed.y + r1.w;
  r2.y = frac(r2.y);
  r11.y = gameTime.w * flickerSpeed + r2.y;
  r11.x = flickerSeed.x;
  r2.y = flickerLookupMap.SampleLevel(lookupSampler_s, r11.xy, 0).x;
  r2.y = log2(abs(r2.y));
  r2.y = flickerPower * r2.y;
  r2.y = exp2(r2.y);
  r3.w = flickerRange.y + -flickerRange.x;
  r2.y = r2.y * r3.w + flickerRange.x;
  r10.xyz = r10.xyz * r2.yyy;
  r2.y = cmp(0.5 < uvMotionToggle2);
  if (r2.y != 0) {
    r2.y = columnCount2 * rowCount2;
    r3.w = imageTime2 * r2.y;
    ...
    r2.y = r3.w * r2.y;
    r2.y = round(r2.y);
    r3.w = r2.y / columnCount2;
    r4.w = columnCount2 * r2.y;
    r4.w = cmp(r4.w >= -r4.w);
    ...
    r2.y = trunc(r2.y);
    r2.y = v2.x + r2.y;
    r11.x = r2.y / columnCount2;
    r2.y = trunc(r3.w);
    r2.y = v2.y + r2.y;
    r11.y = r2.y / rowCount2;
  } else {
    r2.y = dot(-v7.xyz, -v7.xyz);
    r2.y = rsqrt(r2.y);
    r12.xyz = -v7.xyz * r2.yyy;
    ...
    r2.y = gameTime.w * zoomRate2;
    r2.y = cos(r2.y);
    r2.y = r2.y * 0.5 + 0.5;
    r2.y = 1 + -r2.y;
    r3.z = zoomUVs2.y + -zoomUVs2.x;
    r2.y = r2.y * r3.z + zoomUVs2.x;
    r3.xy = r3.xy / r2.yy;
