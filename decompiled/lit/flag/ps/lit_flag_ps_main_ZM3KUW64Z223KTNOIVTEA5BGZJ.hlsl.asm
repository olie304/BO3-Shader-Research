...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:36:00 2021
//
//
// Buffer Definitions: 
//
...
sample_indexable(texture2d)(float,float,float,float) r1.y, v2.xyxx, t26.yxzw, s5
add r1.z, -cb0[13].x, cb0[13].y
mad r1.y, r1.y, r1.z, cb0[13].x
mul_sat r1.y, r1.y, l(0.05882353)
sample_indexable(texture2d)(float,float,float,float) r2.yzw, v2.xyxx, t25.wxyz, s6
...
mad r3.xy, r4.xyxx, cb0[13].zzzz, r2.yzyy
dp3 r2.y, r3.xyzx, r3.xyzx
rsq r2.y, r2.y
mul r3.xyz, r2.yyyy, r3.xyzx
mad r2.y, r3.w, cb0[13].z, r2.w
...
mad r3.xy, r2.zwzz, cb0[15].yyyy, r3.xyxx
dp3 r2.z, r3.xyzx, r3.xyzx
rsq r2.z, r2.z
mul r3.xyz, r2.zzzz, r3.xyzx
mad r2.y, r3.w, cb0[15].y, r2.y
mad r3.xy, r4.xyxx, cb0[15].yyyy, r3.xyxx
dp3 r2.z, r3.xyzx, r3.xyzx
rsq r2.z, r2.z
mul r3.xyz, r2.zzzz, r3.xyzx
mad r2.y, r4.z, cb0[15].y, r2.y
...
rsq r2.z, r2.z
mul r3.xyz, r2.zzzz, r3.xyzx
mad r1.z, cb1[62].x, r1.z, cb0[13].x
...
mad r0.w, -r0.w, r1.w, cb1[59].x
mad o0.w, cb1[59].w, r0.w, r2.x
add r0.w, -r1.y, r1.z
mad r2.y, cb1[62].w, r0.w, r1.y
...
mad r1.xyz, cb1[60].wwww, r1.xyzx, r3.xyzx
mul r3.xyz, r0.xyzx, cb0[0].zzzz
ftou r2.zw, v0.xxxy
...
dp3_sat r2.x, r1.xyzx, r4.yzwy
dp3 r5.y, -r4.yzwy, r1.xyzx
add r5.y, r5.y, r5.y
mad r10.xyz, r1.xyzx, -r5.yyyy, -r4.yzwy
...
mul r9.yzw, r2.yyyy, r8.yyzw
mul r13.xyz, r2.zzzz, r8.yzwy
sqrt r0.w, r5.z
mad r0.w, r0.w, l(0.500000), l(0.500000)
mul r0.w, r0.w, r0.w
mul r1.w, r0.w, l(0.500000)
mad r0.w, -r0.w, l(0.500000), l(1.000000)
mad r2.y, r2.x, r0.w, r1.w
mul r0.w, r0.w, r2.y
mul r1.w, r1.w, r2.y
dp3 r2.y, r1.xyzx, cb2[17].xyzx
ge r2.z, l(0.000000), |r2.y|
if_nz r2.z
  mov r2.w, l(0)
endif 
if_z r2.z
  ...
  if_z r6.z
    if_z cb2[58].y
      ...
      itof r6.z, cb2[26].y
      add r14.z, r3.w, r6.z
      sample_c_lz_indexable(texture2darray)(float,float,float,float) r6.z, r14.xyzx, t13.xxxx, s13, r2.z
    ...
    if_nz cb2[58].y
      ...
      add r8.yz, r8.yyzy, -cb2[r3.w + 20].xxyx
      mul r8.yz, r8.yyzy, cb2[r3.w + 20].zzzz
      ...
      loop 
        ...
        movc r10.w, r8.w, cb2[r3.w + 20].w, cb2[r6.z + 20].w
        movc r8.w, r8.w, r3.w, r6.z
        ...
        utof r16.z, r8.w
        sample_c_lz_indexable(texture2darray)(float,float,float,float) r8.w, r16.xyzx, t13.xxxx, s13, r2.z
...
if_nz r2.z
  ...
  if_nz r2.z
    ...
    if_nz r5.w
      ...
      mad r6.z, |r2.y|, l(-0.200000), l(0.400000)
      lt r6.w, r2.y, l(0.000000)
      movc r6.z, r6.w, -r6.z, r6.z
      mad r18.xyz, r1.xyzx, r6.zzzz, v6.xyzx
      ...
      if_z r7.w
        ...
        if_nz cb2[58].y
          ...
          loop 
            ...
            sample_c_lz_indexable(texture2darray)(float,float,float,float) r10.w, r16.xyzx, t9.xxxx, s13, r3.w
            mad r6.w, r10.w, l(0.125000), r6.w
            iadd r7.w, r7.w, l(1)
          endloop 
        else 
          utof r14.z, r6.z
          sample_c_lz_indexable(texture2darray)(float,float,float,float) r6.w, r14.xyzx, t9.xxxx, s13, r3.w
        endif 
        mul r3.w, r6.w, r6.w
        mul r3.w, r6.w, r3.w
      else 
    ...
    add r3.w, -|r2.y|, r3.w
    mad r3.w, r5.z, r3.w, |r2.y|
    mul r3.w, r2.w, r3.w
    lt r5.w, l(0.000000), r2.y
    mad r14.xyz, r3.wwww, r8.zwyz, r12.xyzx
    mov_sat r2.y, r2.y
    mad r15.xyz, -v6.xyzx, r4.xxxx, cb2[17].xyzx
    dp3 r3.w, r15.xyzx, r15.xyzx
    rsq r3.w, r3.w
    mul r15.xyz, r3.wwww, r15.xyzx
    dp3 r3.w, r15.xyzx, r4.yzwy
    dp3 r4.x, r1.xyzx, r15.xyzx
    mad r6.z, |r4.x|, r5.y, -|r4.x|
    mad r4.x, |r4.x|, r6.z, l(1.000000)
    mad r6.z, r2.y, r0.w, r1.w
    mul r4.x, r4.x, r4.x
    mul r4.x, r6.z, r4.x
    rcp r4.x, r4.x
    mul r2.y, r2.z, r2.y
    mul r2.y, r2.y, r4.x
    mul r2.y, r2.w, r2.y
    mad r15.yzw, r2.yyyy, r8.yyzw, r13.xxyz
    add_sat r2.z, -r3.w, l(1.000000)
    mul r2.w, r2.z, r2.z
    mul r2.w, r2.w, r2.w
    mul r2.z, r2.w, r2.z
    mul r2.y, r2.z, r2.y
    mad r2.yzw, r2.yyyy, r8.yyzw, r9.yyzw
    mov r14.w, r12.z
    mov r12.w, r14.z
...
loop 
  ...
  ld_indexable(texture2darray)(uint,uint,uint,uint) r3.w, r17.xyzw, t6.yzwx
  mov r17.xyz, r8.yzwy
          ...
          if_nz r13.w
            ...
            if_nz r13.w
              ...
              if_nz r13.w
                ...
                mad r44.xyz, r1.xyzx, r13.wwww, v6.xyzx
              ...
              if_nz r13.w
                ...
                if_nz r10.w
                  ...
                  mad r19.xyz, r1.xyzx, r15.zzzz, v6.xyzx
                ...
                add r7.w, -|r12.w|, r7.w
                mad r7.w, r5.z, r7.w, |r12.w|
                mul r7.w, r11.w, r7.w
                mov r35.x, r34.x
                lt r10.w, l(0.000000), r12.w
                mad r19.xyz, r7.wwww, r35.xyzx, r17.xyzx
                dp3_sat r12.w, r1.xyzx, r42.xyzx
                mad r20.xyz, r41.xyzx, r6.wwww, r4.yzwy
                dp3 r6.w, r20.xyzx, r20.xyzx
                rsq r6.w, r6.w
                mul r20.xyz, r6.wwww, r20.xyzx
                dp3 r6.w, r20.xyzx, r4.yzwy
                dp3 r15.z, r1.xyzx, r20.xyzx
                mad r20.x, |r15.z|, r5.y, -|r15.z|
          ...
          if_nz r10.w
            ...
            if_nz r10.w
              ...
              if_nz r10.w
                ...
                mad r22.xyz, r1.xyzx, r10.wwww, v6.xyzx
              ...
              if_nz r10.w
                ...
                if_nz r13.w
                  ...
                  mad r23.xyz, r1.xyzx, r15.zzzz, v6.xyzx
                  ...
                  if_nz r13.w
                    ...
                    mad r24.xyz, r1.xyzx, r15.zzzz, v6.xyzx
...
ret 
// Approximately 2280 instruction slots used
