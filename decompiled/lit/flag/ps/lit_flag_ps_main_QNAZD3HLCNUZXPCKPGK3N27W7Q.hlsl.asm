...
mad r3.xy, r4.xyxx, cb0[12].zzzz, r1.xyxx
...
sample_indexable(texture2d)(float,float,float,float) r1.yzw, r4.xyxx, t26.wxyz, s5
...
mad r3.xy, r1.yzyy, cb0[14].yyyy, r3.xyxx
...
mad r1.xyz, r3.yzwy, r1.wwww, r1.xyzx
...
dp3_sat r6.x, r1.xyzx, r5.xyzx
dp3 r4.w, -r5.xyzx, r1.xyzx
add r4.w, r4.w, r4.w
mad r11.xyz, r1.xyzx, -r4.wwww, -r5.xyzx
...
if_nz r4.x
  ...
  lt r14.xyz, l(0.000000, 0.000000, 0.000000, 0.000000), r1.xyzx
  ...
  mad r13.xyz, r20.yzxy, r0.wwww, r10.zwyz
  mov r11.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r10.yzw, r11.xyzw, t8.wxyz, s2, r6.w
  mad r0.w, cb2[19].x, r4.x, -r1.w
  mad r0.w, r6.y, r0.w, r1.w
...
mad r4.x, r6.x, r0.w, r1.w
mul r0.w, r0.w, r4.x
mul r1.w, r1.w, r4.x
dp3 r4.x, r1.xyzx, cb2[17].xyzx
...
if_z r4.y
  ...
  if_z r10.y
    if_z cb2[58].y
      ...
      itof r9.w, cb2[26].y
      add r15.z, r7.w, r9.w
      sample_c_lz_indexable(texture2darray)(float,float,float,float) r9.w, r15.xyzx, t13.xxxx, s13, r4.y
    ...
    if_nz cb2[58].y
      ...
      loop 
        ...
        utof r16.z, r12.w
        sample_c_lz_indexable(texture2darray)(float,float,float,float) r12.w, r16.xyzx, t13.xxxx, s13, r4.y
...
if_nz r4.y
  ...
  if_nz r4.y
    ...
    if_nz r8.w
      ...
      mad r10.y, |r4.x|, l(-0.200000), l(0.400000)
      lt r10.z, r4.x, l(0.000000)
      movc r10.y, r10.z, -r10.y, r10.y
      mad r19.xyz, r1.xyzx, r10.yyyy, v6.xyzx
    ...
    mad r7.w, -|r4.x|, r7.w, l(1.000000)
    mul r7.w, r7.w, r7.w
    mad r7.w, -r7.w, l(0.620000), l(0.620000)
    add r7.w, -|r4.x|, r7.w
    mad r7.w, r5.w, r7.w, |r4.x|
    mul r7.w, r7.z, r7.w
    lt r8.w, l(0.000000), r4.x
    mad r15.xyz, r7.wwww, r9.zwyz, r13.xyzx
    mov_sat r4.x, r4.x
    ...
    dp3 r7.w, r1.xyzx, r10.yzwy
    mad r10.y, |r7.w|, r4.w, -|r7.w|
    mad r7.w, |r7.w|, r10.y, l(1.000000)
    mad r10.y, r4.x, r0.w, r1.w
    mul r7.w, r7.w, r7.w
    mul r7.w, r10.y, r7.w
    rcp r7.w, r7.w
    mul r4.x, r4.y, r4.x
    mul r4.x, r4.x, r7.w
    mul r4.x, r7.z, r4.x
    mad r16.yzw, r4.xxxx, r9.yyzw, r14.xxyz
    add_sat r3.w, -r3.w, l(1.000000)
    mul r4.y, r3.w, r3.w
    mul r4.y, r4.y, r4.y
    mul r3.w, r3.w, r4.y
    mul r3.w, r3.w, r4.x
    mad r9.yzw, r3.wwww, r9.yyzw, r6.yyzw
    mov r15.w, r13.z
    mov r13.w, r15.z
    movc r17.xyzw, r8.wwww, r15.zxyw, r13.zxyw
    mov r13.zw, r9.yyyz
    mov r15.zw, r6.yyyz
    movc r15.xyzw, r8.wwww, r13.xyzw, r15.xyzw
    mov r16.x, r9.w
    mov r14.w, r6.w
    movc r14.xyzw, r8.wwww, r16.yzwx, r14.xyzw
    mov r13.z, r17.w
    mov r13.xy, r15.xyxx
    mov r6.yz, r15.zzwz
    mov r6.w, r14.w
...
ret 
// Approximately 1973 instruction slots used
