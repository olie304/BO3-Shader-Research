...
sample_indexable(texture2d)(float,float,float,float) r3.xyz, r3.xyxx, t25.xyzw, s5
...
sample_indexable(texture2d)(float,float,float,float) r1.yzw, r3.xyxx, t26.wxyz, s5
mad r1.yz, r1.yyzy, l(0.000000, 1.99218750, 1.99218750, 0.000000), l(0.000000, -1.000000, -1.000000, 0.000000)
mul r1.w, r1.w, r1.w
mul r1.w, r1.w, l(0.33333334)
min r1.w, r1.w, l(1.000000)
sample_indexable(texture2d)(float,float,float,float) r3.xyz, r3.zwzz, t26.xyzw, s5
mad r3.xy, r3.xyxx, l(1.99218750, 1.99218750, 0.000000, 0.000000), l(-1.000000, -1.000000, 0.000000, 0.000000)
mul r2.w, r3.z, r3.z
...
mad r1.xyz, r3.xyzx, r1.yyyy, r4.xyzx
mad r1.xyz, r2.yzwy, r1.wwww, r1.xyzx
dp3 r0.w, r1.xyzx, r1.xyzx
rsq r0.w, r0.w
mul r1.xyz, r0.wwww, r1.xyzx
mul r2.xyz, r0.xyzx, cb0[0].zzzz
ftou r3.xy, v0.xyxx
...
ret 
// Approximately 1930 instruction slots used
