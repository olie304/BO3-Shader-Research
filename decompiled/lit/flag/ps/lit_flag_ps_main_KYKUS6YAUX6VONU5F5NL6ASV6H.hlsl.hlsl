...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r3.xy = r4.xy * detailScaleHeight + r1.xy;
  ...
  r1.yzw = flagRippleDetailMap.Sample(normalSampler_s, r4.xy).xyz;
  ...
  r3.w = min(1, r3.w);
  r3.xy = r1.yz * flagRippleHeight + r3.xy;
  ...
  r1.x = r3.w * flagRippleHeight + r1.x;
  r3.x = v7.x ? 1 : -1;
  ...
  r0.w = r1.x + r0.w;
  r0.w = log2(r0.w);
  r6.y = saturate(-0.0588235296 * r0.w);
  ...
  r6.x = saturate(dot(r1.xyz, r5.xyz));
  r4.w = dot(-r5.xyz, r1.xyz);
  r4.w = r4.w + r4.w;
  r11.xyz = r1.xyz * -r4.www + -r5.xyz;
  r4.w = 17 * r6.y;
  r4.w = exp2(r4.w);
  r4.w = 2 + r4.w;
  r4.w = 2 / r4.w;
  ...
  if (r4.x != 0) {
    ...
    r14.xyz = cmp(float3(0,0,0) < r1.xyz);
    ...
    r13.xyz = r20.yzx * r0.www + r10.zwy;
    r11.w = 0;
    r10.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r11.xyzw, r6.w).xyz;
    r0.w = sunConstants.globalProbeExposure * r4.x + -r1.w;
    r0.w = r6.y * r0.w + r1.w;
  ...
  r0.w = r4.x * r0.w;
  r1.w = r4.x * r1.w;
  r4.x = dot(r1.xyz, sunConstants.wldDir.xyz);
  r4.y = cmp(0 >= abs(r4.x));
  if (r4.y != 0) {
    r7.z = 0;
  }
  if (r4.y == 0) {
    ...
    if (r10.y == 0) {
      if (enableDitheredShadow == 0) {
        ...
        r15.z = r9.w + r7.w;
        r9.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r15.xyz, r4.y).x;
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          r16.z = (uint)r12.w;
          r12.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r4.y).x;
  ...
  if (r4.y != 0) {
    ...
    if (r4.y != 0) {
      ...
      r18.z = samp0[]..swiz;
      r18.w = samp0[]..swiz;
        r10.y = abs(r4.x) * -0.200000003 + 0.400000006;
        r10.z = cmp(r4.x < 0);
        r10.y = r10.z ? -r10.y : r10.y;
        r19.xyz = r1.xyz * r10.yyy + v6.xyz;
        r19.w = 1;
      ...
      r7.w = -r6.x * 0.5 + 1;
      r7.w = -abs(r4.x) * r7.w + 1;
      r7.w = r7.w * r7.w;
      r7.w = -r7.w * 0.620000005 + 0.620000005;
      r7.w = r7.w + -abs(r4.x);
      r7.w = r5.w * r7.w + abs(r4.x);
      r7.w = r7.w * r7.z;
      r8.w = cmp(0 < r4.x);
      r15.xyz = r7.www * r9.zwy + r13.xyz;
      r4.x = saturate(r4.x);
      ...
      r7.w = dot(r1.xyz, r10.yzw);
      r10.y = abs(r7.w) * r4.w + -abs(r7.w);
      r7.w = abs(r7.w) * r10.y + 1;
      r10.y = r4.x * r0.w + r1.w;
      r7.w = r7.w * r7.w;
      r7.w = r7.w * r10.y;
      r7.w = rcp(r7.w);
      r4.x = r4.x * r4.y;
      r4.x = r7.w * r4.x;
      r4.x = r4.x * r7.z;
      r16.yzw = r4.xxx * r9.yzw + r14.xyz;
      r3.w = saturate(1 + -r3.w);
      r4.y = r3.w * r3.w;
      r4.y = r4.y * r4.y;
      r3.w = r4.y * r3.w;
      r3.w = r4.x * r3.w;
      r9.yzw = r3.www * r9.yzw + r6.yzw;
      r15.w = r13.z;
      r13.w = r15.z;
      r17.xyzw = r8.wwww ? r15.zxyw : r13.zxyw;
      r13.zw = r9.yz;
      r15.zw = r6.yz;
      r15.xyzw = r8.wwww ? r13.xyzw : r15.xyzw;
      r16.x = r9.w;
      r14.w = r6.w;
      r14.xyzw = r8.wwww ? r16.yzwx : r14.xyzw;
      r13.z = r17.w;
      r13.xy = r15.xy;
      r6.yz = r15.zw;
      r6.w = r14.w;
            ...
            if (r17.w != 0) {
              ...
              if (r17.w != 0) {
                ...
                if (r17.w != 0) {
                  ...
                  r22.w = abs(r20.x) * r4.w + -abs(r20.x);
            ...
            r42.w = samp0[]..swiz;
              ...
              if (r14.w != 0) {
                ...
                if (r14.w != 0) {
                  ...
                  r21.x = abs(r20.x) * r4.w + -abs(r20.x);
  ...
  r1.xyz = r10.yzw * float3(0.0399999991,0.0399999991,0.0399999991) + r1.xyz;
  r0.xyz = r1.xyz + r0.xyz;
