...
// detailMap                         texture  float4          2d            t25      1 
// flagRippleDetailMap               texture  float4          2d            t26      1 
...
sample_indexable(texture2d)(float,float,float,float) r4.xyz, r4.xyxx, t25.xyzw, s5
...
mad r1.z, r2.w, cb0[12].z, r1.z
mul r4.xyzw, cb0[13].xyzw, cb1[69].wwww
mad r4.xyzw, v2.xyxy, cb0[14].xxxx, r4.xyzw
sample_indexable(texture2d)(float,float,float,float) r2.yzw, r4.xyxx, t26.wxyz, s5
mad r2.yz, r2.yyzy, l(0.000000, 1.99218750, 1.99218750, 0.000000), l(0.000000, -1.000000, -1.000000, 0.000000)
mul r2.w, r2.w, r2.w
mul r2.w, r2.w, l(0.33333334)
min r2.w, r2.w, l(1.000000)
sample_indexable(texture2d)(float,float,float,float) r4.xyz, r4.zwzz, t26.xyzw, s5
mad r4.xy, r4.xyxx, l(1.99218750, 1.99218750, 0.000000, 0.000000), l(-1.000000, -1.000000, 0.000000, 0.000000)
mul r3.w, r4.z, r4.z
mul r3.w, r3.w, l(0.33333334)
min r3.w, r3.w, l(1.000000)
mad r3.xy, r2.yzyy, cb0[14].yyyy, r3.xyxx
dp3 r2.y, r3.xyzx, r3.xyzx
rsq r2.y, r2.y
mul r3.xyz, r2.yyyy, r3.xyzx
mad r1.z, r2.w, cb0[14].y, r1.z
...
mad r2.yzw, r3.yyzw, r2.wwww, r4.xxyz
...
rsq r1.z, r1.z
mad r4.xyz, r4.xyzx, r1.zzzz, -r2.yzwy
mad r2.xyz, cb1[60].wwww, r4.xyzx, r2.yzwy
...
dp3_sat r1.x, r2.xyzx, r5.yzwy
dp3 r6.y, -r5.yzwy, r2.xyzx
add r6.y, r6.y, r6.y
mad r11.xyz, r2.xyzx, -r6.yyyy, -r5.yzwy
...
if_z r1.z
  ...
  if_nz r1.w
    ...
    mad r20.xyz, r22.xyzx, r1.zzzz, r9.yzwy
    mov r11.w, l(0)
    ...
    mad r21.xyz, r9.yzwy, r1.zzzz, r21.xyzx
  endif 
else 
  mov r21.x, r20.w
endif 
...
if_nz r1.w
  ...
  if_nz r1.w
    ...
    if_nz r6.w
      ...
      mad r19.xyz, r2.xyzx, r7.zzzz, v6.xyzx
          ...
          if_nz r14.w
            ...
            if_nz r14.w
              ...
              if_nz r14.w
                ...
                mad r45.xyz, r2.xyzx, r14.wwww, v6.xyzx
              ...
              if_nz r14.w
                ...
                if_nz r11.w
                  ...
                  mad r20.xyz, r2.xyzx, r16.zzzz, v6.xyzx
                  ...
                  if_nz r11.w
                    ...
                    mad r21.xyz, r2.xyzx, r16.zzzz, v6.xyzx
          ...
          if_nz r11.w
            ...
            if_nz r11.w
              ...
              if_nz r11.w
                ...
                mad r23.xyz, r2.xyzx, r11.wwww, v6.xyzx
              ...
              if_nz r11.w
                ...
                if_nz r14.w
                  ...
                  mad r24.xyz, r2.xyzx, r16.zzzz, v6.xyzx
                  ...
                  if_nz r14.w
                    ...
                    mad r25.xyz, r2.xyzx, r16.zzzz, v6.xyzx
...
ret 
// Approximately 2316 instruction slots used
