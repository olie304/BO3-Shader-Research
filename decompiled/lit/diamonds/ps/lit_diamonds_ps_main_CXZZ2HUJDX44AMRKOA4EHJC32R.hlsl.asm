...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:32:35 2021
//
//
// Buffer Definitions: 
//
...
sample_indexable(texture2d)(float,float,float,float) r2.w, r1.xyxx, t25.yzwx, s3
add r3.x, -cb0[12].x, cb0[12].y
mad r2.w, r2.w, r3.x, cb0[12].x
mul_sat r2.w, r2.w, l(0.05882353)
sample_indexable(texture2d)(float,float,float,float) r3.xyz, r1.xyxx, t24.xyzw, s5
...
utof r5.zw, r5.yyyx
dp2 r4.x, r5.wzww, l(0.06711056, 0.00583715, 0.000000, 0.000000)
frc r4.x, r4.x
mul r4.x, r4.x, l(52.982918)
frc r4.x, r4.x
mad r4.x, r4.x, l(6.28318548), cb1[70].w
sincos r8.x, r9.x, r4.x
dp2 r4.x, r5.zwzz, l(0.06711056, 0.00583715, 0.000000, 0.000000)
frc r4.x, r4.x
mul r4.x, r4.x, l(52.982918)
frc r4.x, r4.x
mad r4.x, r4.x, l(6.28318548), cb1[70].w
...
add r5.z, r5.z, r5.z
mad r11.xyz, r3.xyzx, -r5.zzzz, -r6.xyzx
mul r5.z, r7.y, l(17.000000)
exp r5.z, r5.z
add r5.z, r5.z, l(2.000000)
div r5.z, l(2.000000), r5.z
sqrt r5.w, r5.z
add r6.w, -r7.y, l(1.000000)
...
loop 
  ...
  ieq r10.w, r0.x, r10.y
  bfi r12.w, r5.x, l(0), l(0), r10.z
  movc r10.z, r10.w, r12.w, r10.z
  ieq r10.w, r5.y, r10.y
...
rcp r0.x, r0.x
mov_sat r21.w, r21.w
mul r10.yzw, r0.xxxx, r20.xxyz
mul r13.xyz, r0.xxxx, r21.xyzx
lt r5.x, r21.w, l(0.990000)
if_nz r5.x
  add r5.x, -r21.w, l(1.000000)
  ...
  mad r10.yzw, r20.xxyz, r0.xxxx, r14.xxyz
  mov r11.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r14.xyz, r11.xyzw, t8.xyzw, s2, r7.z
  mad r0.x, cb2[19].x, r5.x, -r3.w
  mad r0.x, r7.y, r0.x, r3.w
  mad r13.xyz, r14.xyzx, r0.xxxx, r13.xyzx
endif 
add r0.x, r1.w, r7.x
log r0.x, |r0.x|
mul r0.x, r0.x, r5.w
...
mul r7.yzw, r0.xxxx, r13.xxyz
mul r13.xyz, r5.xxxx, r7.zwyz
mul r7.yzw, r5.yyyy, r7.yyzw
sqrt r0.x, r5.w
mad r0.x, r0.x, l(0.500000), l(0.500000)
mul r0.x, r0.x, r0.x
mul r1.w, r0.x, l(0.500000)
mad r0.x, -r0.x, l(0.500000), l(1.000000)
mad r3.w, r7.x, r0.x, r1.w
mul r0.x, r0.x, r3.w
mul r1.w, r1.w, r3.w
...
if_z r5.y
  ...
  if_z r9.w
    if_z cb2[58].y
      ...
      itof r9.w, cb2[26].y
      add r15.z, r8.z, r9.w
      sample_c_lz_indexable(texture2darray)(float,float,float,float) r9.w, r15.xyzx, t13.xxxx, s13, r5.y
    ...
    if_nz cb2[58].y
      ...
      loop 
        ...
        utof r17.z, r12.w
        sample_c_lz_indexable(texture2darray)(float,float,float,float) r12.w, r17.xyzx, t13.xxxx, s13, r5.y
...
if_nz r5.y
  lt r5.y, l(0.000000), r6.w
  if_nz r5.y
    mul r5.y, r5.z, cb2[18].w
    mul r5.y, r5.x, r5.y
    if_nz cb2[23].x
    ...
    if_nz r8.w
      ...
      mad r19.xyz, r3.xyzx, r9.wwww, v7.xyzx
    ...
    mad r8.z, -r5.x, r8.z, l(1.000000)
    mul r8.z, r8.z, r8.z
    mad r8.z, -r8.z, l(0.620000), l(0.620000)
    add r8.z, -r5.x, r8.z
    mad r8.z, r5.w, r8.z, r5.x
    mul r8.z, r6.w, r8.z
    ...
    mad r8.w, |r8.z|, r5.z, -|r8.z|
    mad r8.z, |r8.z|, r8.w, l(1.000000)
    mad r5.x, r5.x, r0.x, r1.w
    mul r8.z, r8.z, r8.z
    mul r5.x, r5.x, r8.z
    rcp r5.x, r5.x
    mul r5.x, r5.y, r5.x
    ...
    mad r16.xyz, r5.xxxx, r10.yzwy, r7.yzwy
    add_sat r1.z, -r1.z, l(1.000000)
    mul r5.y, r1.z, r1.z
    mul r5.y, r5.y, r5.y
    mul r1.z, r1.z, r5.y
    mul r1.z, r1.z, r5.x
    mad r17.xyz, r1.zzzz, r10.zwyz, r13.xyzx
    mov r15.w, r17.z
    mov r14.w, r13.z
          ...
          if_nz r16.w
            ...
            if_nz r16.w
              ...
              if_nz r16.w
                ...
                mad r42.xyz, r3.xyzx, r16.wwww, v7.xyzx
              ...
              if_nz r16.w
                ...
                if_nz r12.w
                  ...
                  mad r19.xyz, r3.xyzx, r21.wwww, v7.xyzx
          ...
          if_nz r13.w
            ...
            if_nz r13.w
              ...
              if_nz r13.w
                ...
                mad r22.xyz, r3.xyzx, r13.wwww, v7.xyzx
              ...
              if_nz r13.w
                ...
                if_nz r16.w
                  ...
                  mad r23.xyz, r3.xyzx, r19.xxxx, v7.xyzx
                  ...
                  if_nz r16.w
                    ...
                    mad r19.x, |r11.w|, l(-0.200000), l(0.400000)
                    mad r24.xyz, r3.xyzx, r19.xxxx, v7.xyzx
...
ret 
// Approximately 1899 instruction slots used
