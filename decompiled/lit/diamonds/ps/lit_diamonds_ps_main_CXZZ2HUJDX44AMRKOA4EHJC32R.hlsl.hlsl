// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:32:35 2021
...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  r2.w = glossMap.Sample(specColorSampler_s, r1.xy).x;
  ...
  r5.zw = (uint2)r5.yx;
  r4.x = dot(r5.wz, float2(0.0671105608,0.00583714992));
  r4.x = frac(r4.x);
  r4.x = 52.9829178 * r4.x;
  r4.x = frac(r4.x);
  r4.x = r4.x * 6.28318548 + gameTick.w;
  sincos(r4.x, r8.x, r9.x);
  r4.x = dot(r5.zw, float2(0.0671105608,0.00583714992));
  r4.x = frac(r4.x);
  r4.x = 52.9829178 * r4.x;
  r4.x = frac(r4.x);
  r4.x = r4.x * 6.28318548 + gameTick.w;
  ...
  r12.z = (uint)r0.x << 4;
  r0.x = (int)r8.w & -32;
  r5.x = (int)-r0.x + (int)r8.w;
  r5.y = numRefProbes & -32;
  r9.w = (int)-r5.y + numRefProbes;
  r13.xy = float2(0,0);
  r14.w = 0;
  r15.yz = float2(0,1);
  r16.xy = float2(0,0);
  ...
  while (true) {
    ...
    r10.w = cmp((int)r0.x == (int)r10.y);
    bitmask.w = ((~(-1 << r5.x)) << 0) & 0xffffffff;  r12.w = (((uint)0 << 0) & bitmask.w) | ((uint)r10.z & ~bitmask.w);
    r10.z = r10.w ? r12.w : r10.z;
    r10.w = cmp((int)r5.y == (int)r10.y);
  ...
  if (r5.y != 0) {
    ...
    while (true) {
      ...
      r13.z = cmp((int)r0.x == (int)r9.w);
      if (r5.x == 0) r13.w = 0; else if (r5.x+0 < 32) {       r13.w = (uint)r12.w << (32-(r5.x + 0)); r13.w = (uint)r13.w >> (32-r5.x);      } else r13.w = (uint)r12.w >> 0;
  ...
  r10.yzw = r20.xyz * r0.xxx;
  r13.xyz = r21.xyz * r0.xxx;
  r5.x = cmp(r21.w < 0.99000001);
  if (r5.x != 0) {
    r5.x = 1 + -r21.w;
    ...
    r10.yzw = r20.xyz * r0.xxx + r14.xyz;
    r11.w = 0;
    r14.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r11.xyzw, r7.z).xyz;
    r0.x = sunConstants.globalProbeExposure * r5.x + -r3.w;
    r0.x = r7.y * r0.x + r3.w;
    r13.xyz = r14.xyz * r0.xxx + r13.xyz;
  }
  r0.x = r7.x + r1.w;
  r0.x = log2(abs(r0.x));
  r0.x = r5.w * r0.x;
  ...
  r7.yzw = r13.xyz * r0.xxx;
  r13.xyz = r7.zwy * r5.xxx;
  r7.yzw = r7.yzw * r5.yyy;
  r0.x = sqrt(r5.w);
  r0.x = r0.x * 0.5 + 0.5;
  r0.x = r0.x * r0.x;
  r1.w = 0.5 * r0.x;
  ...
  if (r5.y == 0) {
    ...
    if (r9.w == 0) {
      if (enableDitheredShadow == 0) {
        ...
        r15.z = r9.w + r8.z;
        r9.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r15.xyz, r5.y).x;
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          r17.z = (uint)r12.w;
          r12.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r17.xyz, r5.y).x;
  ...
  if (r5.y != 0) {
    r5.y = cmp(0 < r6.w);
    if (r5.y != 0) {
      r5.y = sunConstants.specScale * r5.z;
      r5.y = r5.y * r5.x;
      ...
      r5.x = r6.w * r5.x;
      r5.x = 0.25 * r5.x;
      r16.xyz = r5.xxx * r10.yzw + r7.yzw;
      r1.z = saturate(1 + -r1.z);
      r5.y = r1.z * r1.z;
      r5.y = r5.y * r5.y;
      r1.z = r5.y * r1.z;
      r1.z = r5.x * r1.z;
      r17.xyz = r1.zzz * r10.zwy + r13.xyz;
      r15.w = r17.z;
      r14.w = r13.z;
            ...
            if (r16.w != 0) {
              ...
              if (r16.w != 0) {
                ...
                if (r16.w != 0) {
                  ...
                  r11.w = r11.w + -r16.z;
                  r11.w = r5.w * r11.w + r16.z;
                  r11.w = r11.w * r13.w;
                  r33.x = r32.x;
                  r12.w = cmp(0 < r14.w);
                  r20.xyz = r11.www * r33.xyz + r17.xyz;
                  r11.w = saturate(dot(r3.xyz, r40.xyz));
                  r39.xyz = r39.xyz * r9.www + r6.xyz;
                  r9.w = dot(r39.xyz, r39.xyz);
                  r9.w = rsqrt(r9.w);
                  r39.xyz = r39.xyz * r9.www;
                  r9.w = dot(r39.xyz, r6.xyz);
                  r14.w = dot(r3.xyz, r39.xyz);
                  r16.z = abs(r14.w) * r5.z + -abs(r14.w);
                  r14.w = abs(r14.w) * r16.z + 1;
                  r16.z = r11.w * r0.x + r1.w;
                  r14.w = r14.w * r14.w;
                  r14.w = r14.w * r16.z;
                  r14.w = rcp(r14.w);
                  r11.w = r11.w * r16.w;
            ...
            r40.w = samp0[]..swiz;
              ...
              if (r13.w != 0) {
                ...
                if (r13.w != 0) {
                  ...
                  r14.w = r14.w + -r12.w;
                  r14.w = r5.w * r14.w + r12.w;
                  r14.w = r14.w * r8.w;
                  r11.w = cmp(0 < r11.w);
                  r22.xyz = r14.www * r21.xyw + r17.xyz;
                  r20.xyz = r20.xyz * r9.www + r6.xyz;
                  r9.w = dot(r20.xyz, r20.xyz);
                  r9.w = rsqrt(r9.w);
                  r20.xyz = r20.xyz * r9.www;
                  r9.w = dot(r20.xyz, r6.xyz);
                  r14.w = dot(r3.xyz, r20.xyz);
                  r16.w = abs(r14.w) * r5.z + -abs(r14.w);
                  r14.w = abs(r14.w) * r16.w + 1;
                  r12.w = r12.w * r0.x + r1.w;
                  r14.w = r14.w * r14.w;
                  r12.w = r14.w * r12.w;
                  r12.w = rcp(r12.w);
                  r12.w = r12.w * r13.w;
  ...
  r0.x = r0.x * r1.z + 1;
  r1.z = saturate(dot(r4.yzw, r6.xyz));
