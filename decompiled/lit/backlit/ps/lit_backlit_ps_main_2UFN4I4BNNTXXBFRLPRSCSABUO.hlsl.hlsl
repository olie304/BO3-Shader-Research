...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  if (r1.w != 0) {
    ...
    if (r1.w != 0) {
      ...
      r1.z = saturate(r1.z);
      r17.xyz = -v6.xyz * r5.www + sunConstants.wldDir.xyz;
