...
sample_indexable(texture2d)(float,float,float,float) r2.x, v1.yzyy, t29.xyzw, s3
...
if_nz r5.y
  ...
  if_nz r5.y
    ...
    mov_sat r2.w, r2.w
    mad r17.xyz, -v6.xyzx, r4.wwww, cb2[17].xyzx
