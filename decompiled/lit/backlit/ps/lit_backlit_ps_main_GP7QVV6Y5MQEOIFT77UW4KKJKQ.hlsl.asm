...
sample_indexable(texture2d)(float,float,float,float) r2.x, v1.yzyy, t25.xyzw, s5
...
sample_indexable(texture2d)(float,float,float,float) r3.x, v1.yzyy, t29.xyzw, s3
add r3.x, -r3.x, l(1.000000)
mul r3.xyz, r3.xxxx, cb0[13].xyzx
...
ret 
// Approximately 1958 instruction slots used
