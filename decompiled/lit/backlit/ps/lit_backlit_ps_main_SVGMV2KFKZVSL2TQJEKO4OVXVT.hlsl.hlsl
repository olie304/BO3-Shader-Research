...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r2.w = 1 + -r2.w;
  r4.xyz = backlightScatterColor.xyz * r2.www;
  ...
  if (r5.x != 0) {
    ...
    r10.yzw = r21.xyz * r2.www + r14.xyz;
    r12.w = 0;
    r14.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r12.xyzw, r7.w).xyz;
    r2.w = sunConstants.globalProbeExposure * r5.x + -r3.w;
    r2.w = r7.y * r2.w + r3.w;
  ...
  r10.yzw = r7.yzw * r5.xxx;
  r15.xyz = r7.yzw * r5.yyy;
  r0.w = sqrt(r6.w);
  r0.w = r0.w * 0.5 + 0.5;
  r0.w = r0.w * r0.w;
  r2.w = 0.5 * r0.w;
  ...
  if (r5.x == 0) {
    r7.yzw = sunConstants.sstLightingConstants.offToPinTransform._m10_m11_m12 * v5.yyy;
    r7.yzw = v5.xxx * sunConstants.sstLightingConstants.offToPinTransform._m00_m01_m02 + r7.yzw;
    r7.yzw = v5.zzz * sunConstants.sstLightingConstants.offToPinTransform._m20_m21_m22 + r7.yzw;
    r7.yzw = sunConstants.sstLightingConstants.offToPinTransform._m30_m31_m32 + r7.yzw;
    r5.x = -sunConstants.splitDepthOffset + r7.w;
    ...
    if (r9.w != 0) {
      ...
      r16.xz = rcp(r11.yy);
      r16.y = -r16.z;
      r11.yzw = r7.yzy * r16.xyz + r11.zwz;
    ...
    if (r9.w == 0) {
      if (enableDitheredShadow == 0) {
        ...
        r16.z = r8.z + r7.w;
        r7.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r5.x).x;
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          r17.xy = r12.ww ? r7.yz : r11.yz;
          r13.w = r12.w ? sunConstants.splitPinTransform[r8.z].w : sunConstants.splitPinTransform[r7.w].w;
          r12.w = r12.w ? r8.z : r7.w;
  ...
  if (r5.x != 0) {
    r5.x = cmp(0 < r5.y);
    if (r5.x != 0) {
      r5.x = sunConstants.specScale * r5.w;
      r5.x = 0.25 * r5.x;
      if (sunConstants.sunCookieIndex != 0) {
        r16.xyz = eyeOffset.xyz + v5.xyz;
        r16.w = 1;
        r7.y = dot(sunConstants.sunCookieTransform[0].xyzw, r16.xyzw);
        r7.z = dot(sunConstants.sunCookieTransform[1].xyzw, r16.xyzw);
        r16.xy = frac(r7.yz);
        r7.y = -1 + (int14)sunConstants.sunCookieIndex;
        r16.z = (uint)r7.y;
        r7.yzw = gCookieArray.SampleLevel(samplerLinear_s, r16.xyz, 0).xyz;
        ...
        r17.y = samp0[]..swiz;
          ...
          if (enableDitheredShadow != 0) {
            ...
            while (true) {
              ...
              r11.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r18.xyz, r8.z).x;
              r11.y = r11.w * 0.125 + r11.y;
              r11.z = (int)r11.z + 1;
            }
          } else {
            r16.z = (uint)r9.w;
            r11.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r8.z).x;
          }
          r8.z = r11.y * r11.y;
          r8.z = r8.z * r11.y;
        } else {
      ...
      r8.z = -r7.x * 0.5 + 1;
      r8.z = -abs(r3.w) * r8.z + 1;
      r8.z = r8.z * r8.z;
      r8.z = -r8.z * 0.620000005 + 0.620000005;
      r8.z = r8.z + -abs(r3.w);
      r8.z = r6.w * r8.z + abs(r3.w);
      r8.z = r8.z * r5.y;
      r8.w = cmp(0 < r3.w);
      r16.xyz = r8.zzz * r7.zwy + r14.xyz;
      r3.w = saturate(r3.w);
      r11.yzw = -v5.xyz * r4.www + sunConstants.wldDir.xyz;
      r4.w = dot(r11.yzw, r11.yzw);
      r4.w = rsqrt(r4.w);
      r11.yzw = r11.yzw * r4.www;
      r4.w = dot(r11.yzw, r6.xyz);
      r8.z = dot(r3.xyz, r11.yzw);
      r9.w = abs(r8.z) * r5.w + -abs(r8.z);
      r8.z = abs(r8.z) * r9.w + 1;
      r9.w = r3.w * r0.w + r2.w;
      r8.z = r8.z * r8.z;
      r8.z = r8.z * r9.w;
      r8.z = rcp(r8.z);
      ...
      r3.w = r8.z * r3.w;
      r3.w = r3.w * r5.y;
      r17.yzw = r3.www * r7.yzw + r15.xyz;
      r4.w = saturate(1 + -r4.w);
      r5.x = r4.w * r4.w;
      r5.x = r5.x * r5.x;
      r4.w = r5.x * r4.w;
      r3.w = r4.w * r3.w;
      r7.yzw = r3.www * r7.yzw + r10.yzw;
      r16.w = r14.z;
      r14.w = r16.z;
      r18.xyzw = r8.wwww ? r16.zxyw : r14.zxyw;
      r14.zw = r7.yz;
      r16.zw = r10.yz;
      r16.xyzw = r8.wwww ? r14.xyzw : r16.xyzw;
      r17.x = r7.w;
      r15.w = r10.w;
      r15.xyzw = r8.wwww ? r17.yzwx : r15.xyzw;
      r14.z = r18.w;
      r14.xy = r16.xy;
      r10.yz = r16.zw;
      r10.w = r15.w;
  ...
  while (true) {
    ...
    while (true) {
      ...
      r36.y = samp0[]..swiz;
        ...
        r41.z = samp0[]..swiz;
        r41.w = samp0[]..swiz;
          if (3 == 0) r9.w = 0; else if (3+24 < 32) {           r9.w = (uint)r36.w << (32-(3 + 24)); r9.w = (uint)r9.w >> (32-3);          } else r9.w = (uint)r36.w >> 24;
          switch (r9.w) {
            case 4 :            r9.w = cmp(0 < r41.x);
            r42.xy = r40.zw;
            r42.z = r41.w;
            ...
            if (r18.w != 0) {
              ...
              if (r18.w != 0) {
                ...
                if (r18.w != 0) {
                  r18.w = r36.x * r5.w;
                  r18.w = 0.25 * r18.w;
                  r22.w = dot(r42.xyz, r12.xyz);
                  r27.w = dot(r12.xyz, r44.xyz);
                  ...
                  r42.xyz = r9.www ? r42.xyz : r35.yzw;
                  r42.xyz = -v5.xyz + r42.xyz;
                  r9.w = dot(r42.xyz, r42.xyz);
                  r9.w = rsqrt(r9.w);
                  r43.xyz = r42.xyz * r9.www;
                  ...
                  r12.w = r6.w * r12.w + abs(r15.w);
                  r12.w = r12.w * r14.w;
                  r36.x = r35.x;
                  r13.w = cmp(0 < r15.w);
                  r21.xyz = r12.www * r36.xyz + r17.xyz;
                  r15.w = saturate(dot(r3.xyz, r43.xyz));
                  r42.xyz = r42.xyz * r9.www + r6.xyz;
                  r9.w = dot(r42.xyz, r42.xyz);
                  r9.w = rsqrt(r9.w);
                  r42.xyz = r42.xyz * r9.www;
                  r9.w = dot(r42.xyz, r6.xyz);
                  r20.x = dot(r3.xyz, r42.xyz);
                  r22.w = abs(r20.x) * r5.w + -abs(r20.x);
                  r20.x = abs(r20.x) * r22.w + 1;
                  r22.w = r15.w * r0.w + r2.w;
                  r20.x = r20.x * r20.x;
                  r20.x = r20.x * r22.w;
                  r20.x = rcp(r20.x);
                  r15.w = r15.w * r18.w;
                  ...
                  r9.w = r15.w * r9.w;
                  r9.w = r14.w * r9.w;
                  r43.xyz = r9.www * r36.xyz + r33.xyz;
            ...
            r9.w = rsqrt(r9.w);
            r42.xyz = r21.xyz * r9.www;
            r12.w = dot(r3.xyz, r42.xyz);
            ...
            r43.w = samp0[]..swiz;
              ...
              if (r13.w != 0) {
                  ...
                  r43.y = samp0[]..swiz;
                    ...
                    if (r7.w != 0) {
                      ...
                      while (true) {
                        ...
                        r20.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r35.xyz, r8.w).x;
                        r15.w = r20.x * 0.125 + r15.w;
                        r18.w = (int)r18.w + 1;
                      }
                    } else {
                      r23.z = (uint)r13.w;
                      r15.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r23.xyz, r8.w).x;
                    }
                    r8.w = r15.w * r15.w;
                    r8.w = r8.w * r15.w;
                  } else {
                ...
                if (r13.w != 0) {
                  ...
                  r12.w = r20.x * r12.w;
                  r8.w = r12.w * r8.w;
                  r21.xyz = r8.www * r22.xyw + r34.xyz;
                  r9.w = saturate(1 + -r9.w);
                  r12.w = r9.w * r9.w;
                  r12.w = r12.w * r12.w;
                  r9.w = r12.w * r9.w;
                  r8.w = r9.w * r8.w;
                  r25.xyz = r8.www * r22.xyw + r33.xyz;
  ...
  r3.xyz = r29.xyz * r4.xyz;
  r0.xyz = r11.yzw * r0.xyz + r3.xyz;
  r3.xyz = float3(1,1,1) + -r2.xyz;
  r3.xyz = r30.xyz * r3.xyz;
  r2.xyz = r31.xyz * r2.xyz + r3.xyz;
