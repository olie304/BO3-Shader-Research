...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  if (r5.x != 0) {
    ...
    if (r5.x != 0) {
      ...
      r3.w = saturate(r3.w);
      r11.yzw = -v6.xyz * r4.www + sunConstants.wldDir.xyz;
