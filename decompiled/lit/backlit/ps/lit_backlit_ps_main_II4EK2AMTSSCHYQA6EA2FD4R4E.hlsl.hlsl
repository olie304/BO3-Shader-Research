...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  r11.z = (uint)r2.w << 4;
  r2.w = (int)r8.y & -32;
  r3.x = (int)-r2.w + (int)r8.y;
  r3.y = numRefProbes & -32;
  r8.z = (int)-r3.y + numRefProbes;
  r12.xy = float2(0,0);
  r13.w = 0;
  r14.yz = float2(0,1);
  r15.xy = float2(0,0);
  ...
  r8.yzw = r19.xyz * r2.www;
  r9.yzw = r20.xyz * r2.www;
  ...
  if (r3.x != 0) {
    ...
    r8.yzw = r19.xyz * r2.www + r12.xyz;
    r10.w = 0;
    r12.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r10.xyzw, r6.z).xyz;
    r2.w = sunConstants.globalProbeExposure * r3.x + -r1.w;
    r1.w = r5.y * r2.w + r1.w;
  ...
  if (r3.x == 0) {
    ...
    r3.x = -sunConstants.splitDepthOffset + r8.w;
    ...
    if (r6.z == 0) {
      if (enableDitheredShadow == 0) {
        ...
        r14.z = r6.z + r5.y;
        r6.z = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r14.xyz, r3.x).x;
      ...
      if (enableDitheredShadow != 0) {
        ...
        r8.yz = -sunConstants.splitPinTransform[r5.y].xy + r8.yz;
        r8.yz = sunConstants.splitPinTransform[r5.y].zz * r8.yz;
        ...
        while (true) {
          ...
          r10.w = r8.w ? sunConstants.splitPinTransform[r5.y].w : sunConstants.splitPinTransform[r6.z].w;
          r8.w = r8.w ? r5.y : r6.z;
          ...
          r16.z = (uint)r8.w;
          r8.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r3.x).x;
  ...
  if (r3.x != 0) {
    ...
    if (r3.x != 0) {
      ...
      if (sunConstants.sunCookieIndex != 0) {
        ...
        r14.w = 1;
        r5.y = dot(sunConstants.sunCookieTransform[0].xyzw, r14.xyzw);
        r5.w = dot(sunConstants.sunCookieTransform[1].xyzw, r14.xyzw);
        r14.xy = frac(r5.yw);
        r5.y = -1 + (int14)sunConstants.sunCookieIndex;
        r14.z = (uint)r5.y;
      ...
      r5.w = samp0[]..swiz;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r14.xyzw, r5.y, l(68), t12.xyzw
      r14.x = samp0[]..swiz;
      r14.y = samp0[]..swiz;
      r14.z = samp0[]..swiz;
      r14.w = samp0[]..swiz;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r15.xyzw, r5.y, l(84), t12.xyzw
      r15.x = samp0[]..swiz;
      r15.y = samp0[]..swiz;
      r15.z = samp0[]..swiz;
      r15.w = samp0[]..swiz;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r16.xyzw, r5.y, l(132), t12.xyzw
      r16.x = samp0[]..swiz;
      r16.y = samp0[]..swiz;
      r16.z = samp0[]..swiz;
      r16.w = samp0[]..swiz;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r17.xyzw, r5.y, l(148), t12.xyzw
      r17.x = samp0[]..swiz;
      r17.y = samp0[]..swiz;
      r17.z = samp0[]..swiz;
      r17.w = samp0[]..swiz;
        ...
        if (r7.w == 0) {
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r7.w, r5.y, l(28), t12.xxxx
        r7.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r14.xyzw, r5.y, l(100), t12.xyzw
        r14.x = samp0[]..swiz;
        r14.y = samp0[]..swiz;
        r14.z = samp0[]..swiz;
        r14.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r15.xy, r5.y, l(164), t12.xyxx
        r15.x = samp0[]..swiz;
        r15.y = samp0[]..swiz;
          r5.y = dot(r14.xyzw, r18.xyzw);
          ...
          if (enableDitheredShadow != 0) {
            ...
            while (true) {
              ...
              r10.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r5.y).x;
              r6.w = r10.w * 0.125 + r6.w;
              r7.w = (int)r7.w + 1;
            }
          } else {
            r14.z = (uint)r6.z;
            r6.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r14.xyz, r5.y).x;
          }
          r5.y = r6.w * r6.w;
          r5.y = r5.y * r6.w;
        } else {
      ...
      r5.y = -r5.x * 0.5 + 1;
      r5.y = -abs(r2.w) * r5.y + 1;
      r5.y = r5.y * r5.y;
      r5.y = -r5.y * 0.620000005 + 0.620000005;
      r5.y = r5.y + -abs(r2.w);
      r5.y = r5.z * r5.y + abs(r2.w);
      r5.y = r5.y * r3.y;
      r5.w = cmp(0 < r2.w);
      r14.xyz = r5.yyy * r8.zwy + r12.xyz;
      r2.w = saturate(r2.w);
      ...
      r5.y = dot(r1.xyz, r15.xyz);
      r6.z = abs(r5.y) * r4.w + -abs(r5.y);
      r5.y = abs(r5.y) * r6.z + 1;
      r6.z = r2.w * r0.w + r1.w;
      r5.y = r5.y * r5.y;
      r5.y = r5.y * r6.z;
      r5.y = rcp(r5.y);
