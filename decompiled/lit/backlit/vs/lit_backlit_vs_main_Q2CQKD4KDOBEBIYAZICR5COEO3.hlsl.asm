...
mad r0.xyz, r5.xyzx, r3.yyyy, v0.xyzx
dp4 r6.y, r0.xyzw, r4.xyzw
mul r7.xyzw, r6.yyyy, cb1[9].xyzw
mov r2.w, r3.x
mov r1.w, r3.z
dp4 r6.x, r0.xyzw, r2.xyzw
mad r3.xyzw, r6.xxxx, cb1[8].xyzw, r7.xyzw
dp4 r6.z, r0.xyzw, r1.xyzw
mad r0.xyzw, r6.zzzz, cb1[10].xyzw, r3.xyzw
mov o6.xyz, r6.xyzx
...
mul r3.xyz, r0.yzxy, r5.zxyz
mad r0.xyz, r5.yzxy, r0.zxyz, -r3.xyzx
