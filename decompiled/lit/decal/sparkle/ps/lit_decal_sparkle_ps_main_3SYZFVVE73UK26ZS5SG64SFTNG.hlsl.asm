...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:32:33 2021
//
//
// Buffer Definitions: 
//
...
dcl_output o0.xyzw
dcl_temps 26
sample_indexable(texture2d)(float,float,float,float) r0.x, v2.zwzz, t21.xyzw, s3
ge r0.y, l(0.000000), r0.x
mul r0.zw, v2.xxxy, cb0[14].xxxy
sample_indexable(texture2d)(float,float,float,float) r1.xyz, r0.zwzz, t0.xyzw, s1
mul r0.zw, v2.xxxy, cb0[12].xxxy
...
loop 
  ...
  ieq r7.z, r1.w, r5.w
  bfi r7.w, r4.z, l(0), l(0), r6.w
  movc r6.w, r7.z, r7.w, r6.w
  ieq r7.z, r4.w, r5.w
  ubfe r7.w, r5.z, l(0), r6.w
  movc r6.w, r7.z, r7.w, r6.w
  iadd r7.z, r5.w, cb2[0].x
  mov r7.w, r11.x
  mov r8.x, r6.w
  loop 
    breakc_z r8.x
    firstbit_lo r8.y, r8.x
    ishl r8.z, l(1), r8.y
    and r9.w, r8.z, r8.x
    if_nz r9.w
      xor r8.x, r8.z, r8.x
      ...
      add r11.yzw, r12.xxyz, -v7.xxyz
      mov r13.z, r12.w
      lt r11.yzw, |r11.yyzw|, r13.zzxy
      and r8.z, r11.z, r11.y
      and r8.z, r11.w, r8.z
      if_nz r8.z
        iadd r8.y, r5.w, r8.y
        ...
        add r11.yzw, -r11.yyzw, v7.xxyz
        and r8.z, r8.y, l(0x0000ffff)
        ubfe r8.y, l(6), l(25), r8.y
        ...
        dp3 r9.w, r12.xyzx, r11.yzwy
        add_sat r9.w, r12.w, r9.w
        dp3 r12.x, r13.xyzx, r11.yzwy
        add_sat r12.x, r13.w, r12.x
        mul r9.w, r9.w, r12.x
        dp3 r12.x, r14.xyzx, r11.yzwy
        add_sat r12.x, r14.w, r12.x
        mul r9.w, r9.w, r12.x
        dp3 r12.x, r15.xyzx, r11.yzwy
        add_sat r12.x, r15.w, r12.x
        mul r9.w, r9.w, r12.x
        dp3 r12.x, r16.xyzx, r11.yzwy
        add_sat r12.x, r16.w, r12.x
        mul r9.w, r9.w, r12.x
        dp3 r12.x, r17.xyzx, r11.yzwy
        ...
        mov r12.w, l(1)
        loop 
          ige r13.x, r12.w, r8.y
          breakc_nz r13.x
          iadd r13.x, r8.z, r12.w
          ...
          dp3 r14.x, r14.xyzx, r11.yzwy
          add_sat r14.x, r14.w, r14.x
          mul r14.x, r12.x, r14.x
          dp3 r14.y, r15.xyzx, r11.yzwy
          add_sat r14.y, r15.w, r14.y
          mul r14.x, r14.y, r14.x
          dp3 r14.y, r16.xyzx, r11.yzwy
          add_sat r14.y, r16.w, r14.y
          mul r14.x, r14.y, r14.x
          dp3 r14.y, r17.xyzx, r11.yzwy
          add_sat r14.y, r17.w, r14.y
          mul r14.x, r14.y, r14.x
          dp3 r14.y, r18.xyzx, r11.yzwy
          add_sat r14.y, r18.w, r14.y
          mul r14.x, r14.y, r14.x
          dp3 r13.x, r13.xyzx, r11.yzwy
          add_sat r13.x, r13.w, r13.x
          mul r12.x, r13.x, r14.x
          ushr r13.y, r12.z, l(2)
          ubfe r13.z, l(1), l(2), r12.z
          and r13.w, r13.y, l(2)
          max r14.y, r12.x, r12.y
          mad r13.x, -r14.x, r13.x, l(1.000000)
          mul r13.x, r12.y, r13.x
          movc r10.y, r13.w, r13.x, r14.y
          movc r12.xy, r13.zzzz, r12.xyxx, r10.xyxx
          iadd r12.w, r12.w, l(1)
          mov r12.z, r13.y
        endloop 
        mov_sat r12.y, r12.y
        mul r8.y, r10.w, r12.y
        lt r8.y, l(0.000000), r8.y
        if_nz r8.y
          mad r7.w, r12.y, r10.w, r7.w
        endif 
      endif 
    endif 
  endloop 
    ...
    loop 
      ...
      if_nz r10.z
        ...
        if_nz r9.w
          ...
          dp3 r12.y, r14.xyzx, r11.yzwy
          add_sat r12.y, r14.w, r12.y
          mul r12.x, r12.y, r12.x
          ...
          loop 
            ...
            ushr r13.w, r9.x, l(2)
            ubfe r14.x, l(1), l(2), r9.x
            and r14.y, r13.w, l(2)
            max r14.z, r13.x, r13.y
            mad r12.w, -r12.w, r13.z, l(1.000000)
            mul r12.w, r12.w, r13.y
            movc r10.y, r14.y, r12.w, r14.z
            movc r13.xy, r14.xxxx, r13.xyxx, r10.xyxx
            iadd r12.z, r12.z, l(1)
            mov r9.x, r13.w
          endloop 
          add_sat r8.z, -r8.x, r13.y
          mul r9.x, r10.w, r8.z
          lt r9.x, l(0.000000), r9.x
          if_nz r9.x
            mad r7.w, r8.z, r10.w, r7.w
          endif 
        endif 
      endif 
    endloop 
...
if_nz r1.w
  ...
  mul r4.y, r4.y, cb2[19].x
  dp3 r4.z, v7.xyzx, v7.xyzx
  rsq r4.z, r4.z
  mul r7.xyz, r4.zzzz, v7.xyzx
  ...
  mul_sat r4.z, r4.z, l(4.000000)
  mad r5.z, r4.z, l(-2.000000), l(3.000000)
  mul r4.z, r4.z, r4.z
  mul r4.z, r4.z, r5.z
  mul r4.z, r4.z, r4.w
  mov r3.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r7.xyz, r3.xyzw, t8.xyzw, s2, r1.w
  mul r7.xyz, r4.zzzz, r7.xyzx
  mul r1.w, r4.y, r5.y
  mul r4.yzw, r1.wwww, r7.xxyz
else 
...
if_z r3.w
  mul r5.yzw, v7.yyyy, cb2[29].xxyz
  mad r5.yzw, v7.xxxx, cb2[28].xxyz, r5.yyzw
  mad r5.yzw, v7.zzzz, cb2[30].xxyz, r5.yyzw
  add r5.yzw, r5.yyzw, cb2[31].xxyz
  add r3.w, r5.w, -cb2[17].w
  ...
  if_nz r6.w
    ...
    mov r8.x, l(0)
    loop 
      ge r8.y, r6.w, l(3.000000)
      breakc_nz r8.y
      ftou r8.y, r6.w
      add r8.zw, r5.yyyz, -cb2[r8.y + 20].xxxy
      max r8.z, |r8.w|, |r8.z|
  ...
  if_nz r8.y
    ...
    rcp r10.xz, r9.xxxx
    mov r10.y, -r10.z
    mad r9.xyz, r5.yzyy, r10.xyzx, r9.yzyy
    ...
    if_z r9.w
      ...
      if_z r8.z
        ...
        mad r8.w, r5.z, r8.w, r9.x
        movc r10.x, r8.z, r8.w, r10.x
      endif 
    endif 
    mad r5.w, -cb2[27].z, l(2.000000), r5.w
    lt r5.w, r10.x, r5.w
    movc r5.x, r5.w, l(0), l(1.000000)
  endif 
  if_z r8.y
    if_z cb2[58].y
      ftou r5.w, r6.w
      add r8.yz, r5.yyzy, -cb2[r5.w + 20].xxyx
      mul r8.yz, r8.yyzy, cb2[r5.w + 20].zzzz
      mad r9.xy, r8.yzyy, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
      itof r5.w, cb2[26].y
      add r9.z, r5.w, r6.w
      sample_c_lz_indexable(texture2darray)(float,float,float,float) r5.w, r9.xyzx, t13.xxxx, s13, r3.w
    ...
    if_nz cb2[58].y
      ...
      ftou r5.w, r5.w
      add r8.xy, r5.yzyy, -cb2[r0.y + 20].xyxx
      ...
      add r5.yz, r5.yyzy, -cb2[r0.z + 20].xxyx
      mul r5.yz, r5.yyzy, cb2[r0.z + 20].zzzz
      ...
      loop 
        ...
        breakc_nz r8.w
        ult r8.w, r5.w, r8.z
        movc r9.xy, r8.wwww, r5.yzyy, r8.xyxx
...
if_nz r0.y
  ...
  if_nz r0.y
    ...
    if_nz cb2[23].x
      ...
      mov r5.w, l(1.000000)
      dp4 r0.z, cb2[24].xyzw, r5.xyzw
      dp4 r3.w, cb2[25].xyzw, r5.xyzw
      frc r5.x, r0.z
      frc r5.y, r3.w
      iadd r0.z, l(-1), cb2[23].x
      utof r5.z, r0.z
      sample_l_indexable(texture2darray)(float,float,float,float) r5.xyz, r5.xyzx, t20.xyzw, s2, l(0.000000)
    ...
    mov r5.w, r8.x
    mov r7.w, r4.y
    movc r7.xyzw, r0.zzzz, r5.xyzw, r7.xyzw
  ...
  loop 
    ...
    if_nz r5.z
      ...
      if_nz r3.w
        ...
        ubfe r5.z, l(3), l(24), r15.w
        switch r5.z
          case l(4)
          lt r5.z, l(0.000000), r17.x
          mad r18.xyz, -r17.yzwy, l(0.500000, 0.500000, 0.500000, 0.000000), r14.yzwy
          add r19.xyz, r18.xyzx, -v7.xyzx
          dp3 r5.w, r17.yzwy, r19.xyzx
          div_sat r6.w, -r5.w, r17.x
          mad r20.xyz, r6.wwww, r17.yzwy, r18.xyzx
          movc r20.xyz, r5.zzzz, r20.xyzx, r14.yzwy
          ...
          if_nz r11.w
            ...
            if_nz r7.w
              ...
              mad r5.w, r11.w, r12.w, -r5.w
              div_sat r5.w, r5.w, r13.w
              div r11.w, r13.w, r17.x
              mul r11.w, r11.w, l(10.000000)
              min r11.w, r11.w, l(1.000000)
              add r5.w, -r6.w, r5.w
              mad r5.w, r11.w, r5.w, r6.w
              mad r18.xyz, r5.wwww, r17.yzwy, r18.xyzx
              movc r18.xyz, r5.zzzz, r18.xyzx, r14.yzwy
              add r18.xyz, r18.xyzx, -v7.xyzx
              dp3 r5.z, r18.xyzx, r18.xyzx
              rsq r5.z, r5.z
              mul r18.xyz, r5.zzzz, r18.xyzx
              lt r5.z, l(0.000000), r10.w
              dp3 r5.w, r2.xyzx, -r18.xyzx
              add r6.w, -r0.w, r5.w
              ...
              mad r10.w, r5.w, l(-2.000000), l(3.000000)
              mul r5.w, r5.w, r5.w
              mul r5.w, r5.w, r10.w
              mul r10.w, r5.w, r6.w
              mov r15.x, r14.x
              ...
              mad_sat r5.w, -r6.w, r5.w, l(1.000000)
              mul r6.w, r5.w, r5.w
              mul r6.w, r6.w, r6.w
              mul r5.w, r5.w, r6.w
              mul r5.w, r5.w, r10.w
              mad r19.xyz, r5.wwww, r15.xyzx, r8.xyzx
              movc r8.xyz, r5.zzzz, r19.xyzx, r8.xyzx
              movc r13.xyz, r5.zzzz, r18.xyzx, r13.xyzx
            endif 
          endif 
          break 
          case l(2)
          ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r18.xyzw, r2.w, l(56), t12.wxyz
          add r19.xyz, r18.yzwy, -v7.xyzx
          dp3 r5.z, r19.xyzx, r19.xyzx
          rsq r5.z, r5.z
          mul r19.xyz, r5.zzzz, r19.xyzx
          dp3 r5.z, r1.xyzx, r19.xyzx
          ...
          if_nz r5.w
            ...
            if_nz r6.w
              ...
              add r25.xyz, r14.yzwy, -v7.xyzx
              mul r3.w, r3.w, r3.w
              dp3 r10.w, r25.xyzx, r25.xyzx
              div r3.w, r3.w, r10.w
              min r3.w, r3.w, l(1.000000)
              mad_sat r16.xy, r5.wwww, r16.xzxx, r16.ywyy
              ...
              div r10.xy, r16.xyxx, r5.wwww
              lt r5.w, r22.w, l(0.00048828)
              if_nz r5.w
                mov r23.y, r24.x
            ...
            if_nz r2.w
              ...
              mul_sat r5.z, r5.z, l(4.000000)
              mad r6.w, r5.z, l(-2.000000), l(3.000000)
              mul r5.z, r5.z, r5.z
              mul r5.z, r5.z, r6.w
              mul r6.w, r5.z, r5.w
              mul r14.xyz, r10.xywx, r6.wwww
              mad r14.xyz, r14.xyzx, r2.wwww, r13.xyzx
              mad_sat r2.w, -r5.w, r5.z, l(1.000000)
              mul r5.z, r2.w, r2.w
              mul r5.z, r5.z, r5.z
              mul r2.w, r2.w, r5.z
              mul r2.w, r2.w, r6.w
...
mov o0.w, l(1.000000)
ret 
// Approximately 1109 instruction slots used
