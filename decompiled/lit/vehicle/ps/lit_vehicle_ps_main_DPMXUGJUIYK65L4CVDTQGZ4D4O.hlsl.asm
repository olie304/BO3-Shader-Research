...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:38:50 2021
//
//
// Buffer Definitions: 
//
...
sample_indexable(texture2d)(float,float,float,float) r4.xyzw, v2.xyxx, t46.xyzw, s7
...
sample_indexable(texture2d)(float,float,float,float) r6.xyz, r6.xyxx, t30.xyzw, s5
mul r7.xy, v2.xyxx, cb0[5].xyxx
sample_indexable(texture2d)(float,float,float,float) r7.xyz, r7.xyxx, t37.xyzw, s5
mul r8.xy, v2.xyxx, cb0[4].xyxx
sample_indexable(texture2d)(float,float,float,float) r8.xyz, r8.xyxx, t38.xyzw, s5
if_nz r3.w
  mul r3.w, r4.x, cb0[13].y
  mov r8.xyz, r5.xyzx
else 
  lt r4.x, l(0.000000), r4.y
  if_nz r4.x
    mul r3.w, r4.y, cb0[13].x
    mov r8.xyz, r6.xyzx
  else 
    lt r4.x, l(0.000000), r4.z
    if_nz r4.x
      mul r3.w, r4.z, cb0[12].w
      mov r8.xyz, r7.xyzx
    else 
      lt r4.x, l(0.000000), r4.w
      if_nz r4.x
        mul r3.w, r4.w, cb0[12].z
      else 
...
add r2.x, r2.x, r2.y
log r2.x, r2.x
mul_sat r7.y, r2.x, l(-0.05882353)
mul r2.xzw, r3.yyyy, r6.xxyz
mad r2.xzw, r5.xxyz, r3.xxxx, r2.xxzw
mad r2.xzw, r4.xxyz, r3.zzzz, r2.xxzw
dp3 r3.w, r2.xzwx, r2.xzwx
rsq r3.w, r3.w
mul r8.xyz, r2.xzwx, r3.wwww
ftou r2.xz, v0.xxyx
...
dp3_sat r7.x, r8.xyzx, r9.xyzx
dp3 r5.w, -r9.xyzx, r8.xyzx
add r5.w, r5.w, r5.w
mad r14.xyz, r8.xyzx, -r5.wwww, -r9.xyzx
...
if_nz r7.w
  ...
  if_nz r7.w
    ...
    if_nz r11.w
      ...
      mad r19.xyz, r8.xyzx, r12.yyyy, v6.xyzx
      ...
      if_z r12.w
        ...
        if_nz cb2[58].y
          ...
          loop 
            ...
            sample_c_lz_indexable(texture2darray)(float,float,float,float) r13.y, r17.xyzx, t9.xxxx, s13, r7.w
            mad r12.z, r13.y, l(0.125000), r12.z
            iadd r12.w, r12.w, l(1)
          endloop 
        else 
          utof r15.z, r12.y
          sample_c_lz_indexable(texture2darray)(float,float,float,float) r12.z, r15.xyzx, t9.xxxx, s13, r7.w
        endif 
        mul r7.w, r12.z, r12.z
        mul r7.w, r12.z, r7.w
      else 
        mov r7.w, l(1.000000)
      endif 
    ...
    add r7.w, -r7.z, r7.w
    mad r7.z, r5.w, r7.w, r7.z
    mul r7.z, r9.w, r7.z
    mul r10.yzw, r10.yyzw, r7.zzzz
...
ftou r2.w, r2.w
ushr r15.xy, r2.xzxx, l(6, 6, 0, 0)
ishl r15.z, r2.w, l(4)
mov r16.y, -r10.x
not r2.x, r4.w
mad r2.z, -r7.x, l(0.500000), l(1.000000)
...
loop 
          ...
          if_nz r17.w
            ...
            if_nz r17.w
              ...
              if_nz r17.w
                ...
                mad r18.xyz, r8.xyzx, r17.wwww, v6.xyzx
                mov r34.z, r35.x
              ...
              if_nz r17.w
                ...
                if_nz r18.x
                  ...
                  mad r20.xyz, r8.xyzx, r18.yyyy, v6.xyzx
                  ...
                  if_nz r18.x
                    ...
                    ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r38.xyzw, r17.w, l(116), t12.xyzw
                    mad r18.y, |r15.w|, l(-0.200000), l(0.400000)
                    mad r21.xyz, r8.xyzx, r18.yyyy, v6.xyzx
                ...
                mad r17.w, -r17.z, r2.z, l(1.000000)
          ...
          if_nz r17.z
            ...
            if_nz r17.z
              ...
              if_nz r17.z
                ...
                mad r23.xyz, r8.xyzx, r17.zzzz, v6.xyzx
                mov r37.xy, r36.xyxx
              ...
              if_nz r17.z
                ...
                if_nz r17.w
                  ...
                  mad r25.xyz, r8.xyzx, r18.yyyy, v6.xyzx
                  ...
                  if_nz r17.w
                    ...
                    mad r18.y, |r11.w|, l(-0.200000), l(0.400000)
                    mad r26.xyz, r8.xyzx, r18.yyyy, v6.xyzx
                ...
                mad r17.z, -r15.w, r2.z, l(1.000000)
  ...
  iadd r6.w, r6.w, l(32)
endloop 
mul r10.xyzw, v2.xyxy, cb0[13].wwzz
mul r10.xyzw, r10.xyzw, l(4.000000, 4.000000, 4.000000, 4.000000)
sample_indexable(texture2d)(float,float,float,float) r2.z, r10.xyxx, t1.yzxw, s8
add r17.xyzw, v2.xyxy, l(0.500000, 0.500000, 0.500000, 0.500000)
mul r17.xyzw, r17.xyzw, cb0[13].wwzz
mul r17.xyzw, r17.xyzw, l(4.000000, 4.000000, 4.000000, 4.000000)
sample_indexable(texture2d)(float,float,float,float) r2.w, r17.xyxx, t1.yzwx, s8
sample_indexable(texture2d)(float,float,float,float) r10.xyz, r10.zwzz, t0.xyzw, s8
mad r7.zw, r10.xxxy, l(0.000000, 0.000000, 1.99218750, 1.99218750), l(0.000000, 0.000000, -1.000000, -1.000000)
...
add r5.xyz, -r1.xyzx, cb0[15].xyzx
mad r1.xyz, r2.zzzz, r5.xyzx, r1.xyzx
mad r3.xyz, r3.xyzx, r4.xxxx, -r8.xyzx
mad r3.xyz, r0.wwww, r3.xyzx, r8.xyzx
dp3 r2.z, r3.xyzx, r3.xyzx
rsq r2.z, r2.z
mul r3.xyz, r2.zzzz, r3.xyzx
mad r2.y, r2.y, r7.y, -r7.y
mad r2.y, r0.w, r2.y, r7.y
dp3_sat r2.z, r3.xyzx, r9.xyzx
dp3 r2.w, -r9.xyzx, r3.xyzx
add r2.w, r2.w, r2.w
mad r4.xyz, r3.xyzx, -r2.wwww, -r9.xyzx
...
if_z r5.z
  ...
  if_nz r6.w
    ...
    loop 
      ...
      breakc_nz r7.w
      ftou r7.w, r6.w
      add r10.xy, r6.xyxx, -cb2[r7.w + 20].xyxx
  ...
  if_z r7.w
    if_z cb2[58].y
      ...
      sample_l_indexable(texture2darray)(float,float,float,float) r7.w, r10.xyzx, t31.yzwx, s0, l(0.000000)
      add r6.z, r6.z, r7.w
    ...
    if_nz cb2[58].y
      ...
      loop 
        ...
        mad r7.w, r10.z, l(0.125000), r7.w
        iadd r9.w, r9.w, l(1)
      endloop 
      mul r5.z, r7.w, r7.w
      mul r5.w, r7.w, r5.z
...
if_nz r5.z
  ...
  if_nz r5.z
    ...
    if_nz r7.z
      ...
      mad r7.w, |r5.x|, l(-0.200000), l(0.400000)
      mad r20.xyz, r3.xyzx, r7.wwww, v6.xyzx
      mov r20.w, l(1.000000)
      ...
      if_z r7.w
        ...
        if_nz cb2[58].y
          ...
          loop 
            ...
            mad r10.xy, r18.xyxx, r7.zzzz, r17.xyxx
...
loop 
            ...
            if_nz r20.w
              ...
              if_nz r20.w
                ...
                if_nz r11.w
                  ...
                  mad r19.xyz, r3.xyzx, r22.wwww, v6.xyzx
                  ...
                  if_nz r11.w
                    ...
                    mad r21.xyz, r3.xyzx, r19.xxxx, v6.xyzx
          ...
          if_nz r15.w
            ...
            if_nz r15.w
              ...
              if_nz r15.w
                ...
                mad r23.xyz, r3.xyzx, r15.wwww, v6.xyzx
              ...
              if_nz r15.w
                ...
                if_nz r20.w
                  ...
                  mad r26.xyz, r3.xyzx, r23.xxxx, v6.xyzx
                  ...
                  if_nz r20.w
                    ...
                    mad r23.x, |r10.w|, l(-0.200000), l(0.400000)
                    mad r28.xyz, r3.xyzx, r23.xxxx, v6.xyzx
  ...
  iadd r5.z, r5.z, l(32)
endloop 
add r2.x, -r7.y, l(1.000000)
mad r2.z, r2.x, l(5.000000), l(-2.500000)
mul r2.yz, r2.xxzx, l(0.000000, 5.000000, 0.400000, 0.000000)
  ...
  loop 
    ...
    if_nz r6.y
      ...
      if_nz r6.x
        ...
        and r6.z, r23.w, l(0x0000ffff)
        ubfe r7.z, l(6), l(25), r23.w
        ...
        dp3 r7.w, r25.xyzx, r24.xyzx
        add_sat r7.w, r25.w, r7.w
        dp3 r9.w, r26.xyzx, r24.xyzx
        add_sat r9.w, r26.w, r9.w
        mul r7.w, r7.w, r9.w
        dp3 r9.w, r27.xyzx, r24.xyzx
        add_sat r9.w, r27.w, r9.w
        mul r7.w, r7.w, r9.w
        dp3 r9.w, r28.xyzx, r24.xyzx
        add_sat r9.w, r28.w, r9.w
        mul r7.w, r7.w, r9.w
        dp3 r9.w, r30.xyzx, r24.xyzx
        add_sat r9.w, r30.w, r9.w
        mul r7.w, r7.w, r9.w
        dp3 r9.w, r31.xyzx, r24.xyzx
        add_sat r9.w, r31.w, r9.w
        mul r9.x, r7.w, r9.w
        and r7.w, r6.x, l(1)
        movc r9.xw, r7.wwww, r9.xxxy, r9.zzzx
        mov r7.w, r6.x
        mov r25.xy, r9.xwxx
        mov r10.w, l(1)
        loop 
          ige r11.z, r10.w, r7.z
          breakc_nz r11.z
          ...
          dp3 r11.z, r26.xyzx, r24.xyzx
          add_sat r11.z, r26.w, r11.z
          mul r11.z, r11.z, r25.x
          dp3 r11.w, r27.xyzx, r24.xyzx
          add_sat r11.w, r27.w, r11.w
          mul r11.z, r11.w, r11.z
          dp3 r11.w, r28.xyzx, r24.xyzx
          add_sat r11.w, r28.w, r11.w
          mul r11.z, r11.w, r11.z
          dp3 r11.w, r30.xyzx, r24.xyzx
          add_sat r11.w, r30.w, r11.w
          mul r11.z, r11.w, r11.z
          dp3 r11.w, r31.xyzx, r24.xyzx
          add_sat r11.w, r31.w, r11.w
          mul r11.z, r11.w, r11.z
          dp3 r11.w, r32.xyzx, r24.xyzx
          add_sat r11.w, r32.w, r11.w
          mul r25.x, r11.w, r11.z
          ushr r12.x, r7.w, l(2)
          ubfe r13.x, l(1), l(2), r7.w
          and r15.w, r12.x, l(2)
          max r16.w, r25.x, r25.y
          mad r11.z, -r11.z, r11.w, l(1.000000)
          mul r11.z, r11.z, r25.y
          movc r11.y, r15.w, r11.z, r16.w
          movc r25.xy, r13.xxxx, r25.xyxx, r11.xyxx
          iadd r10.w, r10.w, l(1)
          mov r7.w, r12.x
        endloop 
        mov_sat r25.y, r25.y
        ...
        if_nz r6.z
          ...
          mad r21.z, r25.y, r6.y, r21.z
          mul r5.w, r23.z, r6.x
          mov r23.z, r32.z
          dp3 r6.x, r14.xyzx, r23.xyzx
          dp3 r6.y, r24.xyzx, r23.xyzx
          add r6.y, -r32.w, r6.y
          ...
          mov r32.z, r33.z
          dp3 r6.y, r14.xyzx, r32.xyzx
          dp3 r6.z, r24.xyzx, r32.xyzx
          add r6.z, -r33.w, r6.z
          ge r7.z, r6.z, l(0.000000)
          max r6.z, r2.z, |r6.z|
          ...
          min r6.x, |r6.y|, r6.x
          mov r33.z, r34.z
          dp3 r6.y, r14.xyzx, r33.xyzx
          dp3 r6.z, r24.xyzx, r33.xyzx
          add r6.z, -r34.w, r6.z
          ge r7.z, r6.z, l(0.000000)
          max r6.z, r2.z, |r6.z|
          movc r6.z, r7.z, r6.z, -r6.z
          ...
          min r6.x, |r6.y|, r6.x
          mov r37.zw, r36.zzzw
          dp3 r6.y, r14.zxyz, r37.xzwx
          dp3 r6.z, r24.zxyz, r37.xzwx
          add r6.z, -r37.y, r6.z
          ge r7.z, r6.z, l(0.000000)
          max r6.z, r2.z, |r6.z|
          movc r6.z, r7.z, r6.z, -r6.z
          ...
          mov r22.y, r26.z
          mov r22.z, r27.x
          dp3 r32.x, r11.yzwy, r22.xyzx
          mov r23.xy, r26.xwxx
          mov r23.z, r27.w
          dp3 r32.y, r11.yzwy, r23.xyzx
          mov r27.x, r26.y
          dp3 r32.z, r11.yzwy, r27.xyzx
          ubfe r6.y, l(9), l(16), r23.w
          utof r32.w, r6.y
          sample_l_indexable(texturecubearray)(float,float,float,float) r6.xyz, r32.xyzw, t8.xyzw, s2, r6.x
          dp3 r26.x, r24.xyzx, r22.xyzx
          dp3 r26.y, r24.xyzx, r23.xyzx
          dp3 r26.z, r24.xyzx, r27.xyzx
          mad_sat r11.yzw, r26.xxyz, r28.xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
          mov r30.z, r31.x
          mad r11.yzw, r11.yyzw, r30.xxyz, r31.yyzw
          dp3 r32.x, r8.xyzx, r22.xyzx
          dp3 r32.y, r8.xyzx, r23.xyzx
          dp3 r32.z, r8.xyzx, r27.xyzx
          lt r22.xyz, l(0.000000, 0.000000, 0.000000, 0.000000), r32.xyzx
          movc r10.z, r22.x, l(0), l(0.500000)
          add r23.xyz, r10.xyzx, r11.yzwy
    ...
    loop 
      ...
      if_nz r7.w
        ...
        if_nz r7.z
          ...
          dp3 r11.w, r27.xyzx, r25.xyzx
          add_sat r11.w, r27.w, r11.w
          mul r10.w, r10.w, r11.w
          dp3 r11.w, r28.xyzx, r25.xyzx
          add_sat r11.w, r28.w, r11.w
          mul r10.w, r10.w, r11.w
          dp3 r11.w, r30.xyzx, r25.xyzx
          add_sat r11.w, r30.w, r11.w
          mul r10.w, r10.w, r11.w
          dp3 r11.w, r31.xyzx, r25.xyzx
          add_sat r11.w, r31.w, r11.w
          mul r10.w, r10.w, r11.w
          dp3 r11.w, r32.xyzx, r25.xyzx
          add_sat r11.w, r32.w, r11.w
          mul r6.x, r10.w, r11.w
          and r10.w, r7.z, l(1)
          movc r26.xy, r10.wwww, r6.xyxx, r6.zxzz
          mov r6.x, r7.z
          mov r27.xy, r26.xyxx
          mov r10.w, l(1)
          loop 
            ...
            dp3 r11.w, r28.xyzx, r25.xyzx
            add_sat r11.w, r28.w, r11.w
            mul r11.w, r11.w, r27.x
            dp3 r12.x, r30.xyzx, r25.xyzx
            add_sat r12.x, r30.w, r12.x
            mul r11.w, r11.w, r12.x
            dp3 r12.x, r31.xyzx, r25.xyzx
            add_sat r12.x, r31.w, r12.x
            mul r11.w, r11.w, r12.x
            dp3 r12.x, r32.xyzx, r25.xyzx
            add_sat r12.x, r32.w, r12.x
            mul r11.w, r11.w, r12.x
            dp3 r12.x, r33.xyzx, r25.xyzx
            add_sat r12.x, r33.w, r12.x
            mul r11.w, r11.w, r12.x
            dp3 r12.x, r34.xyzx, r25.xyzx
            add_sat r12.x, r34.w, r12.x
            mul r27.x, r11.w, r12.x
            ushr r13.x, r6.x, l(2)
            ubfe r15.w, l(1), l(2), r6.x
            and r16.w, r13.x, l(2)
            max r20.w, r27.x, r27.y
            mad r11.w, -r11.w, r12.x, l(1.000000)
            mul r11.w, r11.w, r27.y
            movc r10.y, r16.w, r11.w, r20.w
            movc r27.xy, r15.wwww, r27.xyxx, r10.xyxx
            iadd r10.w, r10.w, l(1)
            mov r6.x, r13.x
          endloop 
          add_sat r6.x, -r5.y, r27.y
          mul r7.z, r7.w, r6.x
          lt r9.w, l(0.000000), r7.z
          if_nz r9.w
            ...
            mad r21.w, r6.x, r7.w, r21.w
            mul r6.x, r24.z, r7.z
            mov r24.z, r33.z
            dp3 r6.w, r14.xyzx, r24.xyzx
            dp3 r7.z, r25.xyzx, r24.xyzx
            add r7.z, -r33.w, r7.z
            ...
            mov r33.z, r34.z
            dp3 r7.z, r14.xyzx, r33.xyzx
            dp3 r7.w, r25.xyzx, r33.xyzx
            add r7.w, -r34.w, r7.w
            ge r9.w, r7.w, l(0.000000)
            max r7.w, r2.z, |r7.w|
            ...
            min r6.w, r6.w, |r7.z|
            mov r34.z, r35.z
            dp3 r7.z, r14.xyzx, r34.xyzx
            dp3 r7.w, r25.xyzx, r34.xyzx
            add r7.w, -r35.w, r7.w
            ge r9.w, r7.w, l(0.000000)
            max r7.w, r2.z, |r7.w|
            movc r7.w, r9.w, r7.w, -r7.w
            ...
            min r6.w, r6.w, |r7.z|
            mov r35.z, r36.z
            dp3 r7.z, r14.xyzx, r35.xyzx
            dp3 r7.w, r25.xyzx, r35.xyzx
            add r7.w, -r36.w, r7.w
            ge r9.w, r7.w, l(0.000000)
            max r7.w, r2.z, |r7.w|
            movc r7.w, r9.w, r7.w, -r7.w
            ...
            min r6.w, r6.w, |r7.z|
            mov r36.z, r37.x
            dp3 r7.z, r14.xyzx, r36.xyzx
            dp3 r7.w, r25.xyzx, r36.xyzx
            add r7.w, -r37.y, r7.w
            ge r9.w, r7.w, l(0.000000)
            max r7.w, r2.z, |r7.w|
            movc r7.w, r9.w, r7.w, -r7.w
            ...
            min r6.w, r6.w, |r7.z|
            mov r38.zw, r37.zzzw
            dp3 r7.z, r14.zxyz, r38.xzwx
            dp3 r7.w, r25.zxyz, r38.xzwx
            add r7.w, -r38.y, r7.w
            ge r9.w, r7.w, l(0.000000)
            max r7.w, r2.z, |r7.w|
            movc r7.w, r9.w, r7.w, -r7.w
            ...
            mov r23.y, r26.z
            mov r23.z, r28.x
            dp3 r33.x, r10.yzwy, r23.xyzx
            mov r24.xy, r26.xwxx
            mov r24.z, r28.w
            dp3 r33.y, r10.yzwy, r24.xyzx
            mov r28.x, r26.y
            dp3 r33.z, r10.yzwy, r28.xyzx
            ubfe r7.z, l(9), l(16), r24.w
            utof r33.w, r7.z
            sample_l_indexable(texturecubearray)(float,float,float,float) r10.yzw, r33.xyzw, t8.wxyz, s2, r6.w
            dp3 r26.x, r25.xyzx, r23.xyzx
            dp3 r26.y, r25.xyzx, r24.xyzx
            dp3 r26.z, r25.xyzx, r28.xyzx
            mad_sat r25.xyz, r26.xyzx, r30.xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
            mov r31.z, r32.x
            mad r25.xyz, r25.xyzx, r31.xyzx, r32.yzwy
            dp3 r33.x, r8.xyzx, r23.xyzx
            dp3 r33.y, r8.xyzx, r24.xyzx
            dp3 r33.z, r8.xyzx, r28.xyzx
            lt r23.xyz, l(0.000000, 0.000000, 0.000000, 0.000000), r33.xyzx
            movc r9.z, r23.x, l(0), l(0.500000)
            add r24.xyz, r9.xyzx, r25.xyzx
            ...
            mul r26.xyz, r6.xxxx, r26.xyzx
            movc r11.z, r23.y, l(0), l(0.500000)
            add r23.xyw, r11.xyxz, r25.xyxz
            ...
            dp3 r6.w, r25.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
            ...
            div r6.x, r7.z, r6.x
            mad r21.xyz, r10.yzwy, r6.xxxx, r21.xyzx
          endif 
        endif 
      endif 
    endloop 
    mov r17.xyzw, r21.xyzw
...
rcp r2.x, r2.x
mov_sat r19.w, r19.w
mul r3.xyz, r2.xxxx, r18.xyzx
mul r4.xyz, r2.xxxx, r19.xyzx
lt r2.z, r19.w, l(0.990000)
if_nz r2.z
  add r2.z, -r19.w, l(1.000000)
  mul r2.w, r2.z, cb2[19].x
  add r5.xyz, v6.xyzx, -cb2[35].xyzx
  ...
  lt r6.xyz, l(0.000000, 0.000000, 0.000000, 0.000000), r8.xyzx
  movc r6.xyz, r6.xyzx, l(0,0,0,0), l(0.500000,0.500000,0.500000,0)
  mov r6.w, l(0)
  add r9.xyz, r5.xyzx, r6.wwxw
  ...
  mov r8.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r6.xyz, r8.xyzw, t8.xyzw, s2, l(6.000000)
  mul r5.xyz, r5.xyzx, r6.xyzx
  dp3 r2.w, r5.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
  mad r3.xyz, r18.xyzx, r2.xxxx, r5.xyzx
  mov r14.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r5.xyz, r14.xyzw, t8.xyzw, s2, r2.y
  mad r2.x, cb2[19].x, r2.z, -r2.w
  mad r2.x, r7.y, r2.x, r2.w
  mad r4.xyz, r5.xyzx, r2.xxxx, r4.xyzx
endif 
mad r2.xyz, r3.xyzx, r1.wwww, r12.yzwy
...
mad r1.xy, r7.xyxx, l(0.984375, 0.984375, 0.000000, 0.000000), l(0.00781250, 0.00781250, 0.000000, 0.000000)
...
mov o0.w, r0.w
ret 
// Approximately 2925 instruction slots used
