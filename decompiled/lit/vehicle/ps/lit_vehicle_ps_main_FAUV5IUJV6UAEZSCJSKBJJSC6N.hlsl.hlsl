...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  r2.w = min(1, r2.w);
  r5.xyzw = detailNormalMask.Sample(detailMaskSampler_s, v2.xy).xyzw;
  r3.z = cmp(0 < r5.x);
  r6.xy = detailScale3.xy * v2.xy;
  r6.xyz = detailNormal1.Sample(normalSampler_s, r6.xy).xyz;
  r7.xy = detailScale2.xy * v2.xy;
  r7.xyz = detailNormal2.Sample(normalSampler_s, r7.xy).xyz;
  r8.xy = detailScale1.xy * v2.xy;
  r8.xyz = detailNormal3.Sample(normalSampler_s, r8.xy).xyz;
  r9.xy = detailScale.xy * v2.xy;
  ...
  if (r5.z != 0) {
    ...
    if (r5.z != 0) {
      ...
      r5.x = cmp(0 < r5.x);
      r10.xyz = -v6.xyz * r3.xxx + sunConstants.wldDir.xyz;
