...
sample_indexable(texture2d)(float,float,float,float) r3.xyz, v1.yzyy, t21.xyzw, s3
...
dp3_sat r5.x, r0.xyzx, r3.xyzx
dp3 r4.y, -r3.xyzx, r0.xyzx
add r4.y, r4.y, r4.y
mad r9.xyz, r0.xyzx, -r4.yyyy, -r3.xyzx
          ...
          if_nz r17.x
            ...
            if_nz r17.x
              ...
              if_nz r17.x
                ...
                mad r18.xyz, r18.xyzx, r12.wwww, r3.xyzx
                dp3 r12.w, r18.xyzx, r18.xyzx
                rsq r12.w, r12.w
                mul r18.xyz, r12.wwww, r18.xyzx
                dp3 r12.w, r18.xyzx, r3.xyzx
...
mad r0.xyz, r5.yzwy, r2.xyzx, r0.xyzx
...
ret 
// Approximately 1963 instruction slots used
