...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  r1.xy = r4.yz * detailScaleHeight2 + r0.yz;
  ...
  r0.xyz = r2.xzw * r0.zzz + r4.xyz;
  r1.x = dot(r0.xyz, r0.xyz);
  r1.x = rsqrt(r1.x);
  r0.xyz = r1.xxx * r0.xyz;
  r1.x = debugGlossOverride.x * r1.w + glossRange.x;
  ...
  if (r1.z != 0) {
    ...
    r4.xyz = r2.yyy ? float3(1,0,1) : r3.xyz;
    r5.xyz = r2.zzz ? float3(0,1,1) : r3.xyz;
    r2.xyz = r2.xxx ? r4.xyz : r5.xyz;
    r4.xyz = r2.www ? float3(0,1,0) : r3.xyz;
  ...
  o0.w = debugAlphaOverride.w * r1.z + r3.w;
  ...
  r1.x = r1.x + -r0.w;
  r4.y = debugGlossOverride.w * r1.x + r0.w;
  ...
  while (true) {
    ...
    if (r8.w != 0) break;
    r0.z = (uint)r8.z >> 5;
    r12.xyz = (int3)r0.xyz + (int3)r11.xyz;
    r0.z = visibleProbes.Load(r12.xyzw).x;
  ...
  r38.z = samp0[]..swiz;
  r38.w = samp0[]..swiz;
    r11.w = dot(r33.xyz, r12.xyz);
    r11.w = saturate(r11.w + r33.w);
    r13.w = dot(r34.xyz, r12.xyz);
    r13.w = saturate(r13.w + r34.w);
    r11.w = r13.w * r11.w;
    r13.w = dot(r35.xyz, r12.xyz);
    r13.w = saturate(r13.w + r35.w);
    r11.w = r13.w * r11.w;
    r13.w = dot(r36.xyz, r12.xyz);
    r13.w = saturate(r13.w + r36.w);
    r11.w = r13.w * r11.w;
    r13.w = dot(r37.xyz, r12.xyz);
      ...
      if (r15.z != 0) {
        ...
        if (r8.w != 0) {
          ...
          r34.w = samp0[]..swiz;
            ...
            r15.w = -r15.w * r16.z + 1;
            r15.w = r28.y * r15.w;
            r17.y = r20.z ? r15.w : r21.w;
            r28.xy = r17.ww ? r28.xy : r17.xy;
            r15.z = (int)r15.z + 1;
            r14.w = r16.w;
          }
          ...
          if (r15.z != 0) {
            ...
            r15.w = r15.z * r7.w;
            r28.xzw = r21.xyz * r14.www;
            r14.w = dot(r28.xzw, float3(0.212599993,0.715200007,0.0722000003));
            r14.w = r7.w * r15.z + r14.w;
            r14.w = r15.w / r14.w;
            r31.x = r27.w;
            r31.yz = r26.yz;
            r29.xyw = r28.zwx * r14.www + r31.yzx;
            r30.w = r29.w;
          } else {
            r30.xyzw = r27.xyzw;
            r29.xyz = r26.yzw;
  ...
  if (r8.y == 0) {
    ...
    while (true) {
      ...
      r9.z = cmp((int)r0.y == (int)r8.w);
      bitmask.w = ((~(-1 << r0.z)) << 0) & 0xffffffff;  r9.w = (((uint)0 << 0) & bitmask.w) | ((uint)r9.y & ~bitmask.w);
      r9.y = r9.z ? r9.w : r9.y;
    ...
    if (r8.y != 0) {
      ...
      r9.z = 0;
      while (true) {
        r9.w = cmp((uint)r9.z >= (uint)r0.x);
        if (r9.w != 0) break;
        r12.z = (uint)r9.z >> 5;
        r13.xyz = (int3)r11.xyz + (int3)r12.xyz;
        r9.w = visibleProbes.Load(r13.xyzw).x;
        r11.w = cmp((int)r0.y == (int)r9.z);
        if (r0.z == 0) r12.z = 0; else if (r0.z+0 < 32) {         r12.z = (uint)r9.w << (32-(r0.z + 0)); r12.z = (uint)r12.z >> (32-r0.z);        } else r12.z = (uint)r9.w >> 0;
    ...
    r18.xyz = r21.xyz * r0.xxx;
    r19.xyz = r22.xyz * r0.xxx;
    r0.y = cmp(r22.w < 0.99000001);
    if (r0.y != 0) {
      r0.y = 1 + -r22.w;
      ...
      r0.z = dot(r8.yzw, float3(0.212599993,0.715200007,0.0722000003));
      r18.xyz = r21.xyz * r0.xxx + r8.yzw;
      r10.w = 0;
  ...
  r0.yz = r4.xy * float2(0.984375,0.984375) + float2(0.0078125,0.0078125);
  r0.yz = gEnvBRDFGeneric.SampleLevel(samplerLinear_s, r0.yz, 0).xy;
  r8.yzw = r19.xyz * r0.xxx;
  r13.xyz = r8.zwy * r0.yyy;
  r0.xyz = r8.yzw * r0.zzz;
  r0.w = sqrt(r4.w);
  r0.w = r0.w * 0.5 + 0.5;
  r0.w = r0.w * r0.w;
  r1.w = 0.5 * r0.w;
  ...
  r0.w = r4.y * r0.w;
  r1.w = r4.y * r1.w;
  r4.y = dot(r1.xyz, sunConstants.wldDir.xyz);
  r5.w = saturate(r4.y);
  r6.z = cmp(0 >= r5.w);
  if (r6.z != 0) {
    r6.w = 0;
  ...
  if (r6.z != 0) {
    r6.z = cmp(0 < r6.w);
    if (r6.z != 0) {
      r6.z = sunConstants.specScale * r4.z;
      r6.z = r6.z * r5.w;
      ...
      r17.z = samp0[]..swiz;
      r17.w = samp0[]..swiz;
        r9.z = abs(r4.y) * -0.200000003 + 0.400000006;
        r18.xyz = r1.xyz * r9.zzz + v7.xyz;
        r18.w = 1;
      ...
      r2.w = dot(r9.yzw, r5.xyz);
      r7.w = dot(r1.xyz, r9.yzw);
      r9.y = abs(r7.w) * r4.z + -abs(r7.w);
      ...
      r5.w = r6.w * r5.w;
      r5.w = 0.25 * r5.w;
      r9.yzw = r5.www * r8.yzw + r0.xyz;
      r2.w = saturate(1 + -r2.w);
      r6.z = r2.w * r2.w;
      r6.z = r6.z * r6.z;
      r2.w = r6.z * r2.w;
      r2.w = r5.w * r2.w;
      r15.xyz = r2.www * r8.zwy + r13.xyz;
      r14.w = r15.z;
      r12.w = r13.z;
      r12.xyzw = r4.yyyy ? r14.xyzw : r12.xyzw;
      r15.zw = r9.yz;
      r13.zw = r0.xy;
      r14.xyzw = r4.yyyy ? r15.xyzw : r13.xyzw;
      r0.z = r4.y ? r9.w : r0.z;
      r13.z = r12.w;
      r13.xy = r14.xy;
      r0.xy = r14.zw;
            ...
            r38.w = samp0[]..swiz;
              ...
              if (r15.z != 0) {
                ...
                if (r15.z != 0) {
                  ...
                  r19.x = abs(r15.w) * r4.z + -abs(r15.w);
                  r15.w = abs(r15.w) * r19.x + 1;
                  r13.w = r13.w * r0.w + r1.w;
                  r15.w = r15.w * r15.w;
                  r13.w = r15.w * r13.w;
                  r13.w = rcp(r13.w);
                  r13.w = r13.w * r15.z;
