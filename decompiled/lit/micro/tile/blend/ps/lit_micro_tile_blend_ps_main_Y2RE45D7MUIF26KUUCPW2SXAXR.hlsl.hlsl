...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r0.w = min(1, r0.w);
  r4.xy = r1.xy * detailScaleHeight1 + r3.xy;
  r1.x = dot(r4.xyz, r4.xyz);
  r1.x = rsqrt(r1.x);
  r6.xyz = r4.xyz * r1.xxx;
  r6.w = r1.z * detailScaleHeight1 + r1.w;
  r4.xy = r0.yz * detailScaleHeight2 + r3.xy;
  r0.y = dot(r4.xyz, r4.xyz);
  r0.y = rsqrt(r0.y);
  r4.xyz = r4.xyz * r0.yyy;
  r4.w = r0.w * detailScaleHeight2 + r1.w;
  ...
  sincos(r4.x, r4.x, r9.x);
  r6.x = saturate(dot(r0.xyz, r3.xyz));
  r4.y = dot(-r3.xyz, r0.xyz);
  r4.y = r4.y + r4.y;
  r10.xyz = r0.xyz * -r4.yyy + -r3.xyz;
  r4.y = 17 * r6.y;
  r4.y = exp2(r4.y);
  r4.y = 2 + r4.y;
  r4.y = 2 / r4.y;
  ...
  r1.z = min(15, r1.z);
  r1.z = (uint)r1.z;
  r11.xy = (uint2)r1.xy >> int2(6,6);
  r11.z = (uint)r1.z << 4;
  r1.x = (int)r7.z & -32;
  r1.y = (int)-r1.x + (int)r7.z;
  ...
  while (true) {
    ...
    r9.z = cmp((int)r1.x == (int)r8.w);
    bitmask.w = ((~(-1 << r1.y)) << 0) & 0xffffffff;  r9.w = (((uint)0 << 0) & bitmask.w) | ((uint)r9.y & ~bitmask.w);
    r9.y = r9.z ? r9.w : r9.y;
      ...
      r13.y = samp0[]..swiz;
        ...
        r30.w = samp0[]..swiz;
          ...
          r36.y = samp0[]..swiz;
            ...
            r31.x = dot(r0.xyz, r23.xyz);
            r31.y = dot(r0.xyz, r24.xyz);
  ...
  if (r1.z != 0) {
    ...
    while (true) {
      ...
      r11.w = cmp((int)r1.x == (int)r7.w);
      if (r1.y == 0) r12.z = 0; else if (r1.y+0 < 32) {       r12.z = (uint)r8.w << (32-(r1.y + 0)); r12.z = (uint)r12.z >> (32-r1.y);      } else r12.z = (uint)r8.w >> 0;
  ...
  r12.xyz = r19.xyz * r1.xxx;
  r9.yzw = r20.xyz * r1.xxx;
  r1.y = cmp(r20.w < 0.99000001);
  if (r1.y != 0) {
    r1.y = 1 + -r20.w;
    ...
    r14.xyz = cmp(float3(0,0,0) < r0.xyz);
    ...
    r0.w = 0;
    r14.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r0.xyzw, 6).xyz;
    r13.xyz = r14.xyz * r13.xyz;
    r0.w = dot(r13.xyz, float3(0.212599993,0.715200007,0.0722000003));
    r12.xyz = r19.xyz * r1.xxx + r13.xyz;
    r10.w = 0;
  ...
  r1.xy = r6.xy * float2(0.984375,0.984375) + float2(0.0078125,0.0078125);
  r1.xy = gEnvBRDFGeneric.SampleLevel(samplerLinear_s, r1.xy, 0).xy;
  r13.xyz = r9.zwy * r1.xxx;
  r1.xyz = r9.yzw * r1.yyy;
  r0.w = sqrt(r4.z);
  r0.w = r0.w * 0.5 + 0.5;
  r0.w = r0.w * r0.w;
  r4.w = 0.5 * r0.w;
  ...
  r0.w = r5.w * r0.w;
  r4.w = r5.w * r4.w;
  r5.w = dot(r0.xyz, sunConstants.wldDir.xyz);
  r6.y = saturate(r5.w);
  r6.z = cmp(0 >= r6.y);
  if (r6.z != 0) {
    r6.w = 0;
  ...
  if (r6.z != 0) {
    r6.z = cmp(0 < r6.w);
    if (r6.z != 0) {
      r6.z = sunConstants.specScale * r4.y;
      r6.z = r6.z * r6.y;
      ...
      r15.xyz = -v7.xyz * r1.www + sunConstants.wldDir.xyz;
      r1.w = dot(r15.xyz, r15.xyz);
      r1.w = rsqrt(r1.w);
      r15.xyz = r15.xyz * r1.www;
      r1.w = dot(r15.xyz, r3.xyz);
      r7.z = dot(r0.xyz, r15.xyz);
      r7.w = abs(r7.z) * r4.y + -abs(r7.z);
      ...
      r6.y = r6.w * r6.y;
      r6.y = 0.25 * r6.y;
      r15.xyz = r6.yyy * r9.yzw + r1.xyz;
      r1.w = saturate(1 + -r1.w);
      r6.z = r1.w * r1.w;
      r6.z = r6.z * r6.z;
      r1.w = r6.z * r1.w;
      r1.w = r6.y * r1.w;
      r16.xyz = r1.www * r9.zwy + r13.xyz;
      r14.w = r16.z;
      r12.w = r13.z;
            ...
            if (r25.w != 0) {
              ...
              if (r25.w != 0) {
                ...
                if (r25.w != 0) {
                  ...
                  r12.w = r12.w + -r24.w;
                  r12.w = r4.z * r12.w + r24.w;
                  r12.w = r12.w * r19.w;
                  r31.x = r30.x;
                  r13.w = cmp(0 < r23.w);
                  r18.xyz = r12.www * r31.xyz + r15.xyz;
                  r12.w = saturate(dot(r0.xyz, r38.xyz));
                  r37.xyz = r37.xyz * r11.www + r3.xyz;
                  r11.w = dot(r37.xyz, r37.xyz);
                  r11.w = rsqrt(r11.w);
                  r37.xyz = r37.xyz * r11.www;
                  r11.w = dot(r37.xyz, r3.xyz);
                  r17.x = dot(r0.xyz, r37.xyz);
                  r23.w = abs(r17.x) * r4.y + -abs(r17.x);
                  r17.x = abs(r17.x) * r23.w + 1;
                  r23.w = r12.w * r0.w + r4.w;
                  r17.x = r17.x * r17.x;
                  r17.x = r17.x * r23.w;
                  r17.x = rcp(r17.x);
                  r12.w = r12.w * r25.w;
