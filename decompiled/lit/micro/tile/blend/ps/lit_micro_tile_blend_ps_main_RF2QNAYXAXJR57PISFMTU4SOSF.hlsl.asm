...
sample_indexable(texture2d)(float,float,float,float) r1.xyz, r1.xyxx, t22.xyzw, s3
...
mul r3.xy, r3.xyxx, cb0[6].xyxx
movc r0.yz, cb0[15].yyyy, r0.yyzy, r3.xxyx
sample_indexable(texture2d)(float,float,float,float) r3.xyzw, r0.yzyy, t25.xyzw, s1
...
sample_indexable(texture2d)(float,float,float,float) r0.yzw, r0.yzyy, t24.wxyz, s3
...
if_nz r1.w
  ...
  movc r4.xyz, r4.zzzz, l(0,1.000000,0,0), r2.xyzx
  movc r2.xyz, r3.xxxx, r3.yzwy, r4.xyzx
endif 
add r1.w, -r2.w, cb1[59].x
mad r3.w, cb1[59].w, r1.w, r2.w
eq r1.w, r3.w, l(0.000000)
if_nz r1.w
  mov o0.xyzw, l(0,0,0,0)
  ret 
endif 
sample_indexable(texture2d)(float,float,float,float) r4.xyz, v2.xyxx, t21.xyzw, s3
...
mul_sat r4.z, cb0[10].z, l(0.05882353)
mul_sat r4.w, cb0[14].y, l(0.05882353)
add r4.w, -r4.z, r4.w
mad r4.z, r0.x, r4.w, r4.z
...
mad r5.xy, r1.xyxx, cb0[11].zzzz, r4.xyxx
dp3 r1.x, r5.xyzx, r5.xyzx
rsq r1.x, r1.x
mul r6.xyz, r1.xxxx, r5.xyzx
mad r6.w, r1.z, cb0[11].z, r1.w
mad r5.xy, r0.yzyy, cb0[11].wwww, r4.xyxx
dp3 r0.y, r5.xyzx, r5.xyzx
rsq r0.y, r0.y
mul r5.xyz, r0.yyyy, r5.xyzx
mad r5.w, r0.w, cb0[11].w, r1.w
add r1.xyzw, -r6.xyzw, r5.xyzw
mad r0.xyzw, r0.xxxx, r1.xyzw, r6.xyzw
movc r1.x, v8.x, l(1.000000), l(-1.000000)
dp3 r1.y, v4.xyzx, v4.xyzx
rsq r1.y, r1.y
mul r4.xyw, r1.yyyy, v4.xyxz
...
mad r1.xzw, r5.xxyz, r0.xxxx, r1.xxzw
mad r0.xyz, r4.xywx, r0.zzzz, r1.xzwx
dp3 r1.x, r0.xyzx, r0.xyzx
rsq r1.x, r1.x
mul r0.xyz, r0.xyzx, r1.xxxx
mad r1.x, cb1[62].x, r2.w, cb0[10].y
...
movc r0.z, r0.z, r4.w, r2.w
max r0.z, r0.z, l(0.00000001)
rcp r0.z, r0.z
dp3 r2.w, -v7.xyzx, -v7.xyzx
rsq r2.w, r2.w
mul r6.xyz, r2.wwww, -v7.xyzx
...
loop 
  ...
  breakc_nz r9.w
  ushr r0.z, r9.z, l(5)
  iadd r13.xyz, r0.xyzx, r12.xyzx
  ld_indexable(texture2darray)(uint,uint,uint,uint) r0.z, r13.xyzw, t7.yzxw
...
mad r0.yz, r5.xxyx, l(0.000000, 0.984375, 0.984375, 0.000000), l(0.000000, 0.00781250, 0.00781250, 0.000000)
sample_l_indexable(texture2d)(float,float,float,float) r0.yz, r0.yzyy, t5.zxyw, s2, l(0.000000)
mul r9.yzw, r0.xxxx, r20.xxyz
mul r14.xyz, r0.yyyy, r9.zwyz
mul r0.xyz, r0.zzzz, r9.yzwy
sqrt r0.w, r5.w
...
if_nz r7.z
  ...
  if_nz r7.z
    ...
    if_nz r10.y
      ...
      mad r19.xyz, r1.xyzx, r10.zzzz, v7.xyzx
    ...
    mad r10.yzw, -v7.xxyz, r2.wwww, cb2[17].xxyz
    ...
    mad r10.yzw, r6.wwww, r9.yyzw, r0.xxyz
          ...
          if_nz r25.w
            ...
            if_nz r25.w
              ...
              if_nz r25.w
                ...
                mad r41.xyz, r1.xyzx, r25.wwww, v7.xyzx
              ...
              if_nz r25.w
                ...
                if_nz r14.w
                  ...
                  mad r19.xyz, r1.xyzx, r26.wwww, v7.xyzx
          ...
          if_nz r16.z
            ...
            if_nz r16.z
              ...
              if_nz r16.z
                ...
                mad r22.xyz, r1.xyzx, r16.zzzz, v7.xyzx
              ...
              if_nz r16.z
                ...
                if_nz r22.x
                  ...
                  mad r23.xyz, r1.xyzx, r22.yyyy, v7.xyzx
                  ...
                  if_nz r22.x
                    ...
                    mad r22.y, |r13.w|, l(-0.200000), l(0.400000)
                    mad r24.xyz, r1.xyzx, r22.yyyy, v7.xyzx
...
mad r0.xyz, r9.yzwy, r2.xyzx, r0.xyzx
