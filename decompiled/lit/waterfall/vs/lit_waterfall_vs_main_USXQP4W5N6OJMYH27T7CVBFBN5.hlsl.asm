...
mad r0.xyz, r0.xyzx, l(2.001957, 2.001957, 2.001957, 0.000000), l(-1.00195694, -1.00195694, -1.00195694, 0.000000)
mul r1.xzw, r2.yyzx, r0.zzxy
mad r1.xzw, r0.yyzx, r2.zzxy, -r1.xxzw
...
movc o2.xy, cb0[14].zwzz, r0.zwzz, r0.xyxx
mul r0.xy, cb0[18].yzyy, l(0.01745329, 0.01745329, 0.000000, 0.000000)
...
eq r0.xy, cb0[18].yzyy, l(0.000000, 0.000000, 0.000000, 0.000000)
and r0.x, r0.y, r0.x
movc r0.xy, r0.xxxx, l(0,1.000000,0,0), r0.zwzz
movc o2.zw, cb0[17].wwww, r0.xxxy, l(0,0,0,1.000000)
ret 
