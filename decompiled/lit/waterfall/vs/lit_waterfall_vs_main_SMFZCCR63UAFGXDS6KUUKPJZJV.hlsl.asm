...
mul r2.xy, r2.xyxx, cb0[12].zwzz
mad r2.xy, r2.zwzz, cb0[12].zwzz, r2.xyxx
mad r2.xy, cb0[13].xyxx, cb0[12].zwzz, r2.xyxx
...
mul r2.xy, cb0[12].xyxx, cb1[69].wwww
mad r2.xy, r2.xyxx, cb0[12].zwzz, r4.yzyy
...
movc o1.yz, cb0[14].zzwz, r2.zzwz, r2.xxyx
eq r2.xy, cb0[18].yzyy, l(0.000000, 0.000000, 0.000000, 0.000000)
and r0.w, r2.y, r2.x
mul r2.xy, cb0[18].yzyy, l(0.01745329, 0.01745329, 0.000000, 0.000000)
...
movc o6.xy, cb0[17].wwww, r2.xyxx, l(0,1.000000,0,0)
mov o1.x, v1.w
mov o2.xyz, r0.xyzx
mov o3.xyz, r3.xyzx
mov o4.xyz, r1.xyzx
