...
mad r0.xy, r0.xyxx, cb0[13].zwzz, r1.xyxx
...
movc o2.xy, cb0[15].zwzz, r0.zwzz, r0.xyxx
mul r0.xy, cb0[19].yzyy, l(0.01745329, 0.01745329, 0.000000, 0.000000)
...
eq r0.xy, cb0[19].yzyy, l(0.000000, 0.000000, 0.000000, 0.000000)
and r0.x, r0.y, r0.x
movc r0.xy, r0.xxxx, l(0,1.000000,0,0), r0.zwzz
movc o2.zw, cb0[18].wwww, r0.xxxy, l(0,0,0,1.000000)
ret 
