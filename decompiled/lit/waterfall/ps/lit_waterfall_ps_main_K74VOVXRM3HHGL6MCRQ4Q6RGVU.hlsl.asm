...
mul r0.w, r0.w, v1.x
sample_indexable(texture2d)(float,float,float,float) r2.x, v1.yzyy, t26.xyzw, s3
mul r2.yzw, r0.xxyz, cb0[18].xxyz
add r2.x, -r2.x, l(1.000000)
...
if_nz cb0[18].w
  ...
  rcp r3.xy, r3.xyxx
  eq r3.z, cb0[19].x, l(0.000000)
  div r3.w, l(1.000000, 1.000000, 1.000000, 1.000000), cb0[19].x
...
if_nz r3.y
  ...
  if_nz r3.y
    ...
    if_nz r7.w
      ...
      mad r18.xyz, r1.xyzx, r9.yyyy, v5.xyzx
