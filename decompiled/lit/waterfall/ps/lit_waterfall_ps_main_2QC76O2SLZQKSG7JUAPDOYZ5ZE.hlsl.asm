...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:39:25 2021
//
//
...
dcl_output o0.xyzw
dcl_temps 49
sample_indexable(texture2d)(float,float,float,float) r0.xyz, v2.xyxx, t22.xyzw, s3
sample_indexable(texture2d)(float,float,float,float) r0.w, v2.xyxx, t24.yzwx, s3
...
if_nz r1.x
  ftoi r1.x, cb1[64].w
  lod r1.y, v2.xyxx, t22.y, s3
  lod r1.z, v2.xyxx, t22.x, s3
  lt r1.y, r1.y, r1.z
...
sample_indexable(texture2d)(float,float,float,float) r2.z, v2.xyxx, t26.yzxw, s3
