...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  r0.w = w1.x * r0.w;
  r1.y = thicknessMap.Sample(colorSampler_s, v2.xy).x;
  ...
  if (useAlphaControls != 0) {
    ...
    r3.x = dot(r3.xyz, v3.xyz);
    r3.x = r3.x * r3.x;
    r3.x = saturate(r3.x * w2.x + w2.y);
    r3.x = r3.x * r0.w;
    r4.xy = (int2)v0.xy;
    r4.zw = float2(0,0);
