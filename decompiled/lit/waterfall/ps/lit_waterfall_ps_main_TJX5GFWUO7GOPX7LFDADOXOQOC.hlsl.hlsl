...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r3.x = thicknessMap.Sample(colorSampler_s, w1.xy).x;
  r3.yzw = backlightScatterColor.xyz * r0.xyz;
  r3.x = 1 + -r3.x;
  ...
  if (useAlphaControls != 0) {
    ...
    r3.w = dot(r4.xyz, v2.xyz);
    r3.w = r3.w * r3.w;
    r3.w = saturate(r3.w * v6.x + v6.y);
    r3.w = r3.w * r1.w;
    r4.xy = (int2)v0.xy;
    r4.zw = float2(0,0);
    r4.x = floatZSampler.Load(r4.xyz).x;
    r4.y = cmp(r4.x >= 0.984375);
    r4.z = 1.01587307 * r4.x;
    r4.x = r4.x * 64 + -63;
    r4.x = r4.y ? r4.x : r4.z;
    ...
    r4.xy = rcp(r4.xy);
    r4.z = cmp(zFeatherDistance == 0.000000);
    r4.w = 1 / zFeatherDistance;
    r4.z = r4.z ? 60000 : r4.w;
    r4.x = r4.x + -r4.y;
    r4.x = saturate(r4.x * r4.z);
    r1.w = r4.x * r3.w;
  }
  r4.xy = (uint2)v0.xy;
