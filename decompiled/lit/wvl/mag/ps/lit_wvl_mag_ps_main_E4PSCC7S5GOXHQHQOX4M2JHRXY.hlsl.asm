...
sample_indexable(texture2d)(float,float,float,float) r1.yzw, r1.yzyy, t26.wxyz, s5
lt r2.x, l(0.000000), cb1[64].w
if_nz r2.x
  ftoi r2.x, cb1[64].w
  lod r2.y, v2.xyxx, t0.y, s1
  lod r2.z, v2.xyxx, t0.x, s1
  lt r2.y, r2.y, r2.z
...
mad r4.xy, r1.yzyy, cb0[11].zzzz, r3.xyxx
dp3 r1.y, r4.xyzx, r4.xyzx
rsq r1.y, r1.y
mul r4.xyz, r1.yyyy, r4.xyzx
mad r1.y, r1.w, cb0[11].z, r3.z
...
rsq r1.z, r1.z
mul r3.xyz, r1.zzzz, r3.xyzx
mad r1.z, cb1[62].x, r3.w, cb0[11].x
...
if_nz r7.z
  ...
  if_nz r7.z
    ...
    mad r10.yzw, r6.wwww, r9.yyzw, r3.xxyz
...
ret 
// Approximately 2267 instruction slots used
