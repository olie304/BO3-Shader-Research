...
sample_indexable(texture2d)(float,float,float,float) r1.yzw, v2.xyxx, t22.wxyz, s5
...
frc r3.w, r3.w
mad r3.w, r3.w, l(6.28318548), cb1[70].w
sincos r5.x, r8.x, r3.w
dp3_sat r1.x, r2.xyzx, r4.xyzx
dp3 r3.w, -r4.xyzx, r2.xyzx
add r3.w, r3.w, r3.w
mad r9.xyz, r2.xyzx, -r3.wwww, -r4.xyzx
...
mul r5.zw, r5.yyyw, l(0.000000, 0.000000, 5.000000, 0.400000)
...
ftou r3.x, r3.x
ushr r10.xy, r1.zwzz, l(6, 6, 0, 0)
ishl r10.z, r3.x, l(4)
and r1.z, r6.w, l(-32)
iadd r1.w, -r1.z, r6.w
and r3.x, cb2[0].y, l(-32)
iadd r7.w, -r3.x, cb2[0].y
    ...
    if_nz r12.x
      ...
      if_nz r11.w
        ...
        if_nz r12.x
          ...
          sqrt r11.w, r11.w
          mad r11.w, r5.y, l(5.000000), r11.w
...
max r1.z, r19.w, l(1.000000)
rcp r1.z, r1.z
mov_sat r19.w, r19.w
mul r8.yzw, r1.zzzz, r18.xxyz
mul r11.xyz, r1.zzzz, r19.xyzx
lt r1.w, r19.w, l(0.990000)
if_nz r1.w
  add r1.w, -r19.w, l(1.000000)
  ...
  mad r8.yzw, r18.xxyz, r1.zzzz, r12.xxyz
  mov r9.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r5.yzw, r9.xyzw, t8.wxyz, s2, r5.z
  mad r1.z, cb2[19].x, r1.w, -r2.w
  mad r1.z, r1.y, r1.z, r2.w
  mad r11.xyz, r5.yzwy, r1.zzzz, r11.xyzx
endif 
add r1.z, r0.w, r1.x
log r1.z, |r1.z|
mul r1.z, r1.z, r4.w
...
mul r5.yzw, r1.zzzz, r11.xxyz
mul r11.xyz, r1.yyyy, r5.zwyz
mul r1.yzw, r1.wwww, r5.yyzw
sqrt r0.w, r4.w
mad r0.w, r0.w, l(0.500000), l(0.500000)
mul r0.w, r0.w, r0.w
mul r2.w, r0.w, l(0.500000)
mad r0.w, -r0.w, l(0.500000), l(1.000000)
mad r3.x, r1.x, r0.w, r2.w
mul r0.w, r0.w, r3.x
mul r2.w, r2.w, r3.x
...
if_nz r5.z
  ...
  if_nz r5.z
    ...
    if_nz r6.w
      ...
      mad r7.w, |r3.x|, l(-0.200000), l(0.400000)
      mad r17.xyz, r2.xyzx, r7.wwww, v6.xyzx
    ...
    mad r14.xyz, r5.yyyy, r8.yzwy, r1.yzwy
    add_sat r3.y, -r3.y, l(1.000000)
    mul r5.z, r3.y, r3.y
    mul r5.z, r5.z, r5.z
    mul r3.y, r3.y, r5.z
    mul r3.y, r3.y, r5.y
    mad r15.xyz, r3.yyyy, r8.zwyz, r11.xyzx
    mov r13.w, r15.z
    mov r12.w, r11.z
    movc r12.xyzw, r3.xxxx, r13.xyzw, r12.xyzw
    mov r15.zw, r14.xxxy
    mov r11.zw, r1.yyyz
    movc r13.xyzw, r3.xxxx, r15.xyzw, r11.xyzw
    movc r1.w, r3.x, r14.z, r1.w
    mov r11.z, r12.w
    mov r11.xy, r13.xyxx
    mov r1.yz, r13.zzwz
  endif 
...
loop 
  ...
  loop 
    ...
    if_nz r12.w
      ...
      and r11.w, r29.y, r29.x
      and r11.w, r29.z, r11.w
      if_nz r11.w
        ...
        ubfe r11.w, l(3), l(24), r30.w
        switch r11.w
          case l(4)
          lt r11.w, l(0.000000), r35.x
          mov r36.xy, r34.zwzz
          mov r36.z, r35.w
          ...
          div_sat r14.z, -r12.w, r35.x
          mad r39.xyz, r14.zzzz, r36.xyzx, r37.xyzx
          movc r39.xyz, r11.wwww, r39.xyzx, r29.yzwy
          add r39.xyz, r39.xyzx, -v6.xyzx
          dp3 r14.w, r39.xyzx, r39.xyzx
          rsq r19.w, r14.w
          mul r39.xyz, r19.wwww, r39.xyzx
          dp3 r19.w, r2.xyzx, r39.xyzx
          mov_sat r23.w, r19.w
          ...
          if_nz r24.w
            ...
            mul r14.w, r14.w, r39.x
            mul r14.w, r39.y, r14.w
            ...
            if_nz r24.w
              ...
              if_nz r24.w
                ...
                mad r39.xyz, r2.xyzx, r24.wwww, v6.xyzx
              ...
              if_nz r24.w
                ...
                movc r36.xyz, r11.wwww, r36.xyzx, r29.yzwy
                add r36.xyz, r36.xyzx, -v6.xyzx
                dp3 r11.w, r36.xyzx, r36.xyzx
                rsq r11.w, r11.w
                mul r37.xyz, r11.wwww, r36.xyzx
                ubfe r12.w, l(4), l(16), r30.w
                ult r14.z, l(0), r12.w
                and r14.z, r3.z, r14.z
                if_nz r14.z
                  ...
                  dp4 r25.w, r38.xyzw, r17.xyzw
                  dp4 r27.w, r39.xyzw, r17.xyzw
                  ...
                  if_z r28.w
                    ...
                    mul r17.x, r27.w, r42.y
                    mad r17.y, r42.x, r27.w, r25.w
                  ...
                  if_z r17.y
                    ...
                    if_nz r7.w
                      ...
                      loop 
                        ...
                        mad r39.xy, r40.xyxx, r14.zzzz, r38.xyxx
                        sample_c_lz_indexable(texture2darray)(float,float,float,float) r25.w, r39.xyzx, t9.xxxx, s13, r17.x
                  ...
                  ubfe r12.w, l(4), l(20), r30.w
                  ult r14.z, l(0), r12.w
                  and r14.z, r3.x, r14.z
                  if_nz r14.z
                    iadd r12.w, r12.w, cb2[0].x
                    iadd r12.w, r12.w, l(-1)
                    ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r14.z, r12.w, l(52), t12.xxxx
                    ...
                    if_z r17.z
                      ...
                      if_nz r7.w
                        ...
                        loop 
                          ...
                          mad r18.xy, r39.xyxx, r14.zzzz, r38.xyxx
                ...
                mad r12.w, -r23.w, r1.x, l(1.000000)
                mul r12.w, r12.w, r12.w
                mad r12.w, -r12.w, l(0.620000), l(0.620000)
                add r12.w, -r23.w, r12.w
                mad r12.w, r4.w, r12.w, r23.w
                mul r12.w, r14.w, r12.w
                mov r30.x, r29.x
                lt r14.z, l(0.000000), r19.w
                mad r18.xyz, r12.wwww, r30.xyzx, r8.yzwy
                dp3_sat r12.w, r2.xyzx, r37.xyzx
                mad r36.xyz, r36.xyzx, r11.wwww, r4.xyzx
                dp3 r11.w, r36.xyzx, r36.xyzx
                rsq r11.w, r11.w
                mul r36.xyz, r11.wwww, r36.xyzx
                dp3 r11.w, r36.xyzx, r4.xyzx
                dp3 r17.x, r2.xyzx, r36.xyzx
                mad r19.w, |r17.x|, r3.w, -|r17.x|
                mad r17.x, |r17.x|, r19.w, l(1.000000)
                mad r19.w, r12.w, r0.w, r2.w
                ...
                mul r12.w, r14.w, r12.w
                mad r36.xyz, r12.wwww, r30.xyzx, r28.xyzx
                add_sat r11.w, -r11.w, l(1.000000)
                mul r14.w, r11.w, r11.w
                mul r14.w, r14.w, r14.w
                mul r11.w, r11.w, r14.w
                mul r11.w, r11.w, r12.w
                mad r37.xyz, r11.wwww, r30.xyzx, r15.xyzx
                movc r8.yzw, r14.zzzz, r18.xxyz, r8.yyzw
                movc r15.xyz, r14.zzzz, r37.xyzx, r15.xyzx
                movc r28.xyz, r14.zzzz, r36.xyzx, r28.xyzx
              endif 
            endif 
          endif 
          break 
          ...
          if_nz r14.w
            ...
            if_nz r17.x
              ...
              mad_sat r31.xy, r14.wwww, r31.xzxx, r31.ywyy
              ...
              div r19.xy, r31.xyxx, r14.wwww
              lt r14.w, r40.w, l(0.00048828)
              if_nz r14.w
                mov r41.y, r42.x
            ...
            if_nz r14.w
                ...
                if_nz r24.w
                  ...
                  if_nz r7.w
                    ...
                    loop 
                      ...
                      sample_c_lz_indexable(texture2darray)(float,float,float,float) r25.w, r29.xyzx, t9.xxxx, s13, r10.w
              ...
              if_nz r14.w
                mul r14.w, r3.w, r30.x
                mul r14.w, r14.z, r14.w
                ubfe r17.x, l(4), l(16), r30.w
                ult r20.x, l(0), r17.x
                ...
                if_nz r20.x
                  ...
                  if_z r21.x
                    ...
                    if_nz r7.w
                      ...
                      utof r30.z, r20.y
                      sample_c_lz_indexable(texture2darray)(float,float,float,float) r20.z, r30.xyzx, t9.xxxx, s13, r17.x
                    endif 
                  ...
                  if_nz r20.x
                    ...
                    if_z r22.x
                      ...
                      if_nz r7.w
                        ...
                        utof r29.z, r20.y
                        sample_c_lz_indexable(texture2darray)(float,float,float,float) r22.x, r29.xyzx, t9.xxxx, s13, r17.x
                      endif 
                ...
                mad r18.x, |r17.x|, r3.w, -|r17.x|
                mad r17.x, |r17.x|, r18.x, l(1.000000)
                mad r14.z, r14.z, r0.w, r2.w
                mul r17.x, r17.x, r17.x
                ...
                mad r18.xyz, r10.wwww, r19.xywx, r28.xyzx
                add_sat r11.w, -r11.w, l(1.000000)
                mul r14.z, r11.w, r11.w
                mul r14.z, r14.z, r14.z
                mul r11.w, r11.w, r14.z
                mul r10.w, r10.w, r11.w
                mad r19.xyw, r10.wwww, r19.xyxw, r15.xyxz
                movc r8.yzw, r12.wwww, r21.xxyz, r8.yyzw
                movc r15.xyz, r12.wwww, r19.xywx, r15.xyzx
                movc r28.xyz, r12.wwww, r18.xyzx, r28.xyzx
              endif 
            endif 
          endif 
          break 
...
mad r0.xyz, r5.yzwy, r0.xyzx, r1.xyzx
