// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:37:11 2021
...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  float4 x1[4];
  float4 x2[4];
  r0.xyzw = colorMap.Sample(colorSampler_s, w1.xy).wxyz;
  ...
  r3.x = min(1, r3.x);
  r3.xyz = transColorTint.xyz * r3.xxx;
  r6.xyz = saturate(r0.yzw * float3(0.0199999996,0.0199999996,0.0199999996) + float3(0.0399999991,0.0399999991,0.0399999991));
  r7.xyz = specColorTint.xyz * r6.xyz;
  r3.xyz = r3.xyz * r0.yzw;
  r3.xyz = r5.xyz * r3.xyz;
  r0.yzw = r2.xyz * r0.yzw + r3.xyz;
...
r1.x = samp0[]..swiz;
  ...
  if (r0.x != 0) {
    ...
    r0.x = fogConstants.heightFalloff * v6.z;
