...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  if (r9.w != 0) {
    ...
    if (r9.w != 0) {
      ...
      r14.x = cmp(0 < r6.w);
      r6.w = saturate(r6.w);
      r14.yzw = -v7.xyz * r4.www + sunConstants.wldDir.xyz;
  ...
  r14.x = 0;
  while (true) {
    r16.w = cmp((uint)r14.x >= numLights);
    if (r16.w != 0) break;
    r20.z = (uint)r14.x >> 5;
    r21.xyz = (int3)r18.xyz + (int3)r20.xyz;
    r16.w = visibleLights.Load(r21.xyzw).x;
    r21.xyz = r28.xyz;
    r39.xyz = r29.xyz;
    r40.xyz = r30.xyz;
    r41.xyz = r31.xyz;
      ...
      r54.w = samp0[]..swiz;
        ...
        switch (r29.w) {
          ...
          if (r34.w != 0) {
            ...
            r32.w = r35.w / r32.w;
            r32.w = min(1, r32.w);
            r38.zw = saturate(r34.ww * r50.xz + r50.yw);
            ...
            if (r32.w != 0) {
              ...
              if (r23.y != 0) {
                ...
                r32.w = dot(r55.xyz, r11.xyz);
                r34.w = dot(r11.xyz, r57.xyz);
                ...
                r55.xyz = r55.xyz * r29.www + r6.xyz;
                r29.w = dot(r55.xyz, r55.xyz);
                r29.w = rsqrt(r29.w);
                r55.xyz = r55.xyz * r29.www;
                r29.w = dot(r2.xyz, r55.xyz);
                r33.w = dot(r55.xyz, r6.xyz);
          ...
          r58.w = samp0[]..swiz;
            ...
            r30.w = samp0[]..swiz;
              ...
              r31.w = r31.w / r32.w;
              r31.w = min(1, r31.w);
              r38.zw = saturate(r29.ww * r50.xz + r50.yw);
  ...
  r4.y = rcp(r4.y);
  r4.x = r4.x * r4.y;
  r4.yz = r1.ww * float2(0.5,0.5) + float2(0.333333343,1);
  r4.yz = float2(0.117647059,0.117647059) * r4.yz;
  r4.yz = r4.yz * r4.yz;
  x1[0].x = r4.y;
  r7.xyz = r10.xyz * r4.yyy + r8.xyz;
  r5.xy = cmp(r4.xx < r4.yz);
  r7.xy = renderTargetSize.xy * r7.xy;
  r9.xy = (int2)r7.xy;
  r9.zw = float2(0,0);
  r4.w = floatZSampler.Load(r9.xyz).x;
  r6.w = cmp(r4.w >= 0.984375);
  r7.x = 1.01587307 * r4.w;
  r4.w = r4.w * 64 + -63;
  r4.w = r6.w ? r4.w : r7.x;
  r4.w = max(9.99999994e-09, r4.w);
  r4.w = rcp(r4.w);
  x2[0].x = r4.w;
  r6.w = 0.0419999994 + r4.w;
  r6.w = r7.z * r6.w;
  r6.w = cmp(1 < r6.w);
  ...
  if (r4.y == 0) {
    r4.yz = r1.ww * float2(0.5,0.5) + float2(2.33333325,3);
    r4.yz = float2(0.117647059,0.117647059) * r4.yz;
    r4.w = x1[0].x;
    r5.x = x0[0].x;
    r4.y = r4.y * r4.y + -r4.w;
  ...
  if (r4.y == 0) {
    r4.yz = r1.ww * float2(0.5,0.5) + float2(3.33333325,4);
    r4.yz = float2(0.117647059,0.117647059) * r4.yz;
    r4.w = x1[0].x;
    r5.x = x0[0].x;
    r4.y = r4.y * r4.y + -r4.w;
  ...
  if (r4.y == 0) {
    r4.yz = r1.ww * float2(0.5,0.5) + float2(4.33333349,5);
    r4.yz = float2(0.117647059,0.117647059) * r4.yz;
    r4.w = x1[0].x;
    r5.x = x0[0].x;
    r4.y = r4.y * r4.y + -r4.w;
  ...
  if (r4.y == 0) {
    r4.yz = r1.ww * float2(0.5,0.5) + float2(5.33333349,6);
    r4.yz = float2(0.117647059,0.117647059) * r4.yz;
    r4.w = x1[0].x;
    r5.x = x0[0].x;
    r4.y = r4.y * r4.y + -r4.w;
  ...
  if (r4.y == 0) {
    r4.yz = r1.ww * float2(0.5,0.5) + float2(6.33333349,7);
    r4.yz = float2(0.117647059,0.117647059) * r4.yz;
    r4.w = x1[0].x;
    r5.x = x0[0].x;
    r4.y = r4.y * r4.y + -r4.w;
  ...
  if (r4.y == 0) {
    r4.yz = r1.ww * float2(0.5,0.5) + float2(7.33333349,8);
    r4.yz = float2(0.117647059,0.117647059) * r4.yz;
    r1.w = x1[0].x;
    r4.w = x0[0].x;
    r4.y = r4.y * r4.y + -r1.w;
  ...
  while (true) {
    ...
    r5.x = cmp((int)r1.z == (int)r4.z);
    bitmask.y = ((~(-1 << r1.w)) << 0) & 0xffffffff;  r5.y = (((uint)0 << 0) & bitmask.y) | ((uint)r4.w & ~bitmask.y);
    r4.w = r5.x ? r5.y : r4.w;
    r5.x = cmp((int)r4.x == (int)r4.z);
    if (r4.y == 0) r5.y = 0; else if (r4.y+0 < 32) {     r5.y = (uint)r4.w << (32-(r4.y + 0)); r5.y = (uint)r5.y >> (32-r4.y);    } else r5.y = (uint)r4.w >> 0;
    r4.w = r5.x ? r5.y : r4.w;
    r5.x = (int)r4.z + numLights;
    r19.xyzw = r15.xyzw;
    r20.xyz = r16.yzw;
    r5.y = r4.w;
    while (true) {
      if (r5.y == 0) break;
      r6.w = firstbitlow((uint)r5.y);
      r7.z = 1 << (int)r6.w;
      r7.w = (int)r5.y & (int)r7.z;
      if (r7.w != 0) {
      ...
      r8.y = samp0[]..swiz;
        ...
        r22.z = samp0[]..swiz;
        r22.w = samp0[]..swiz;
          r8.xyz = v7.xyz + -r21.yzw;
          r9.w = (int)r22.w & 0x0000ffff;
          if (6 == 0) r10.w = 0; else if (6+25 < 32) {           r10.w = (uint)r22.w << (32-(6 + 25)); r10.w = (uint)r10.w >> (32-6);          } else r10.w = (uint)r22.w >> 25;
        // Known bad code for instruction (needs manual fix):
        ...
        r33.w = samp0[]..swiz;
          ...
          r13.x = dot(r24.xyz, r8.xyz);
          r13.x = saturate(r13.x + r24.w);
          r12.w = r13.x * r12.w;
          r13.x = dot(r25.xyz, r8.xyz);
          r13.x = saturate(r13.x + r25.w);
          r12.w = r13.x * r12.w;
          r13.x = dot(r26.xyz, r8.xyz);
          r13.x = saturate(r13.x + r26.w);
          r12.w = r13.x * r12.w;
          r13.x = dot(r27.xyz, r8.xyz);
          r13.x = saturate(r13.x + r27.w);
          r12.w = r13.x * r12.w;
          r13.x = dot(r33.xyz, r8.xyz);
          r13.x = saturate(r13.x + r33.w);
          r9.x = r13.x * r12.w;
          r12.w = (int)r7.z & 1;
          r13.xy = r12.ww ? r9.xy : r9.zx;
          r9.x = r7.z;
          r17.xy = r13.xy;
          r12.w = 1;
          while (true) {
          ...
          r33.z = samp0[]..swiz;
          r33.w = samp0[]..swiz;
            r14.w = dot(r23.xyz, r8.xyz);
            r14.w = saturate(r14.w + r23.w);
            r14.w = r17.x * r14.w;
            r18.w = dot(r24.xyz, r8.xyz);
            r18.w = saturate(r18.w + r24.w);
            r14.w = r18.w * r14.w;
            r18.w = dot(r25.xyz, r8.xyz);
            r18.w = saturate(r18.w + r25.w);
            r14.w = r18.w * r14.w;
            r18.w = dot(r26.xyz, r8.xyz);
            r18.w = saturate(r18.w + r26.w);
            r14.w = r18.w * r14.w;
            r18.w = dot(r27.xyz, r8.xyz);
            r18.w = saturate(r18.w + r27.w);
            r14.w = r18.w * r14.w;
            r18.w = dot(r33.xyz, r8.xyz);
            r18.w = saturate(r18.w + r33.w);
            r17.x = r18.w * r14.w;
            r21.w = (uint)r9.x >> 2;
            if (1 == 0) r23.x = 0; else if (1+2 < 32) {             r23.x = (uint)r9.x << (32-(1 + 2)); r23.x = (uint)r23.x >> (32-1);            } else r23.x = (uint)r9.x >> 2;
            r23.y = (int)r21.w & 2;
            r23.z = max(r17.y, r17.x);
            r14.w = -r14.w * r18.w + 1;
            r14.w = r17.y * r14.w;
            r13.w = r23.y ? r14.w : r23.z;
            r17.xy = r23.xx ? r17.xy : r13.zw;
            r12.w = (int)r12.w + 1;
            r9.x = r21.w;
          }
          ...
          r42.y = samp0[]..swiz;
            ...
            r6.w = r7.z * r22.z;
            r22.z = r33.z;
            r7.z = dot(r11.xyz, r22.xyz);
            r7.w = dot(r8.xyz, r22.xyz);
            r7.w = r7.w + -r33.w;
            r9.x = cmp(r7.w >= 0);
            ...
            r33.z = r38.z;
            r7.w = dot(r11.xyz, r33.xyz);
            r9.x = dot(r8.xyz, r33.xyz);
            r9.x = r9.x + -r38.w;
            r9.w = cmp(r9.x >= 0);
            r9.x = max(100, abs(r9.x));
            r9.x = r9.w ? r9.x : -r9.x;
            r7.w = max(1.00000001e-07, -r7.w);
            r7.w = r9.x / r7.w;
            r7.z = min(r7.z, abs(r7.w));
            r38.z = r39.z;
            r7.w = dot(r11.xyz, r38.xyz);
            r9.x = dot(r8.xyz, r38.xyz);
            r9.x = r9.x + -r39.w;
            r9.w = cmp(r9.x >= 0);
            r9.x = max(100, abs(r9.x));
            r9.x = r9.w ? r9.x : -r9.x;
            ...
            r7.z = min(r7.z, abs(r7.w));
            r39.z = r40.z;
            r7.w = dot(r11.xyz, r39.xyz);
            r9.x = dot(r8.xyz, r39.xyz);
            r9.x = r9.x + -r40.w;
            r9.w = cmp(r9.x >= 0);
            r9.x = max(100, abs(r9.x));
            r9.x = r9.w ? r9.x : -r9.x;
            ...
            r7.z = min(r7.z, abs(r7.w));
            r40.z = r41.x;
            r7.w = dot(r11.xyz, r40.xyz);
            r9.x = dot(r8.xyz, r40.xyz);
            r9.x = r9.x + -r41.y;
            r9.w = cmp(r9.x >= 0);
            r9.x = max(100, abs(r9.x));
            r9.x = r9.w ? r9.x : -r9.x;
            ...
            r7.z = min(r7.z, abs(r7.w));
            r42.zw = r41.zw;
            r7.w = dot(r11.zxy, r42.xzw);
            r9.x = dot(r8.zxy, r42.xzw);
            r9.x = r9.x + -r42.y;
            r9.w = cmp(r9.x >= 0);
            r9.x = max(100, abs(r9.x));
            r9.x = r9.w ? r9.x : -r9.x;
            ...
            r13.xyw = r11.xyz * r7.zzz + r13.xyw;
            r7.w = dot(r13.xyw, r13.xyw);
            r7.w = sqrt(r7.w);
            r7.z = r7.z / r7.w;
            r7.z = r7.z + r7.z;
            r7.z = sqrt(r7.z);
            ...
            if (9 == 0) r7.w = 0; else if (9+16 < 32) {             r7.w = (uint)r22.w << (32-(9 + 16)); r7.w = (uint)r7.w >> (32-9);            } else r7.w = (uint)r22.w >> 16;
            r33.w = (uint)r7.w;
            r13.xyw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r33.xyzw, r7.z).xyz;
            ...
            r7.z = dot(r22.xyz, float3(0.212599993,0.715200007,0.0722000003));
            r19.xyz = r8.xyz * r21.xyz + r19.xyz;
            r7.w = 1.26815999 * r7.z;
            r8.xyz = r13.xyw * r6.www;
            r6.w = dot(r8.xyz, float3(0.212599993,0.715200007,0.0722000003));
            r6.w = r7.z * 1.26815999 + r6.w;
            r6.w = r7.w / r6.w;
            r21.x = r19.w;
            r21.yz = r20.xy;
            r20.xyw = r8.yzx * r6.www + r21.yzx;
            r19.w = r20.w;
          }
        }
      }
  ...
  if (r4.x != 0) {
    ...
    r6.w = 0;
    while (true) {
      r8.w = cmp((uint)r6.w >= (uint)r1.y);
      if (r8.w != 0) break;
      r4.z = (uint)r6.w >> 5;
      r7.xyz = (int3)r4.xyz + (int3)r18.xyz;
      r4.z = visibleProbes.Load(r7.xyzw).x;
      r7.x = cmp((int)r1.z == (int)r6.w);
      if (r1.w == 0) r7.y = 0; else if (r1.w+0 < 32) {       r7.y = (uint)r4.z << (32-(r1.w + 0)); r7.y = (uint)r7.y >> (32-r1.w);      } else r7.y = (uint)r4.z >> 0;
      r4.z = r7.x ? r7.y : r4.z;
        ...
        r22.y = samp0[]..swiz;
          ...
          r38.w = samp0[]..swiz;
            ...
            r40.w = samp0[]..swiz;
              ...
              r14.w = saturate(r14.w + r26.w);
              r14.w = r25.x * r14.w;
              r18.w = dot(r27.xyz, r23.xyz);
              r18.w = saturate(r18.w + r27.w);
              r14.w = r18.w * r14.w;
              r18.w = dot(r33.xyz, r23.xyz);
              r18.w = saturate(r18.w + r33.w);
              r14.w = r18.w * r14.w;
              r18.w = dot(r38.xyz, r23.xyz);
              r18.w = saturate(r18.w + r38.w);
              r14.w = r18.w * r14.w;
              r18.w = dot(r39.xyz, r23.xyz);
              r18.w = saturate(r18.w + r39.w);
              r14.w = r18.w * r14.w;
              r18.w = dot(r40.xyz, r23.xyz);
              ...
              r14.w = -r14.w * r18.w + 1;
              r14.w = r25.y * r14.w;
              r5.y = r23.w ? r14.w : r24.z;
              r25.xy = r21.ww ? r25.xy : r5.xy;
              r12.w = (int)r12.w + 1;
              r8.x = r20.w;
            }
            r5.y = saturate(r25.y + -r7.y);
            r8.x = r5.y * r17.y;
            r9.w = cmp(0 < r8.x);
            if (r9.w != 0) {
            // Known bad code for instruction (needs manual fix):
            ...
            r44.y = samp0[]..swiz;
              ...
              r5.y = r8.x * r22.z;
              r22.z = r39.z;
              r8.x = dot(r11.xyz, r22.xyz);
              r8.w = dot(r23.xyz, r22.xyz);
              r8.w = r8.w + -r39.w;
              r9.w = cmp(r8.w >= 0);
              r8.w = max(100, abs(r8.w));
              r8.w = r9.w ? r8.w : -r8.w;
              r8.x = max(1.00000001e-07, -r8.x);
              r8.x = r8.w / r8.x;
              r8.x = min(131072, abs(r8.x));
              r39.z = r40.z;
              r8.w = dot(r11.xyz, r39.xyz);
              r9.w = dot(r23.xyz, r39.xyz);
              r9.w = r9.w + -r40.w;
              r10.w = cmp(r9.w >= 0);
              ...
              r8.w = r9.w / r8.w;
              r8.x = min(r8.x, abs(r8.w));
              r40.z = r41.z;
              r8.w = dot(r11.xyz, r40.xyz);
              r9.w = dot(r23.xyz, r40.xyz);
              r9.w = r9.w + -r41.w;
              r10.w = cmp(r9.w >= 0);
              r9.w = max(100, abs(r9.w));
              r9.w = r10.w ? r9.w : -r9.w;
              ...
              r8.x = min(r8.x, abs(r8.w));
              r41.z = r42.z;
              r8.w = dot(r11.xyz, r41.xyz);
              r9.w = dot(r23.xyz, r41.xyz);
              r9.w = r9.w + -r42.w;
              r10.w = cmp(r9.w >= 0);
              r9.w = max(100, abs(r9.w));
              r9.w = r10.w ? r9.w : -r9.w;
              ...
              r8.x = min(r8.x, abs(r8.w));
              r42.z = r43.x;
              r8.w = dot(r11.xyz, r42.xyz);
              r9.w = dot(r23.xyz, r42.xyz);
              r9.w = r9.w + -r43.y;
              r10.w = cmp(r9.w >= 0);
              r9.w = max(100, abs(r9.w));
              r9.w = r10.w ? r9.w : -r9.w;
              ...
              r8.x = min(r8.x, abs(r8.w));
              r44.zw = r43.zw;
              r8.w = dot(r11.zxy, r44.xzw);
              r9.w = dot(r23.zxy, r44.xzw);
              r9.w = r9.w + -r44.y;
              r10.w = cmp(r9.w >= 0);
              r9.w = max(100, abs(r9.w));
              r9.w = r10.w ? r9.w : -r9.w;
              ...
              r22.xyz = r11.xyz * r8.xxx + r22.xyz;
              ...
              r21.y = r24.z;
              r21.z = r26.x;
              r39.x = dot(r22.xyz, r21.xyz);
              r40.xy = r24.xw;
              r40.z = r26.w;
              r39.y = dot(r22.xyz, r40.xyz);
              r26.x = r24.y;
              r39.z = dot(r22.xyz, r26.xyz);
              if (9 == 0) r8.w = 0; else if (9+16 < 32) {               r8.w = (uint)r22.w << (32-(9 + 16)); r8.w = (uint)r8.w >> (32-9);              } else r8.w = (uint)r22.w >> 16;
              r39.w = (uint)r8.w;
              r22.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r39.xyzw, r8.x).xyz;
              r24.x = dot(r23.xyz, r21.xyz);
              r24.y = dot(r23.xyz, r40.xyz);
              r24.z = dot(r23.xyz, r26.xyz);
              r23.xyz = saturate(r24.xyz * r27.xyz + float3(0.5,0.5,0.5));
              r33.z = r38.x;
              r23.xyz = r23.xyz * r33.xyz + r38.yzw;
              r39.x = dot(r2.xyz, r21.xyz);
              r39.y = dot(r2.xyz, r40.xyz);
              r39.z = dot(r2.xyz, r26.xyz);
              r21.xyz = cmp(float3(0,0,0) < r39.xyz);
              r9.z = r21.x ? 0 : 0.5;
              r24.xyz = r23.xyz + r9.xyz;
              r24.xyz = gProbeXArray.SampleLevel(samplerLinearClamp_s, r24.xyz, 0).xyz;
              r25.xzw = r39.xyz * r39.xyz;
              r25.xzw = r25.xzw * r5.yyy;
              r10.z = r21.y ? 0 : 0.5;
              r21.xyw = r23.xyz + r10.xyz;
              r21.xyw = gProbeYArray.SampleLevel(samplerLinearClamp_s, r21.xyw, 0).xyz;
              r21.xyw = r21.xyw * r25.zzz;
              r21.xyw = r24.xyz * r25.xxx + r21.xyw;
              r12.z = r21.z ? 0 : 0.5;
              r23.xyz = r23.xyz + r12.xyz;
              r23.xyz = gProbeZArray.SampleLevel(samplerLinearClamp_s, r23.xyz, 0).xyz;
              r21.xyz = r23.xyz * r25.www + r21.xyw;
              r23.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r39.xyzw, 6).xyz;
              r24.xyz = r23.xyz * r21.xyz;
              r8.x = dot(r24.xyz, float3(0.212599993,0.715200007,0.0722000003));
              r20.xyz = r21.xyz * r23.xyz + r20.xyz;
              r8.w = 1.26815999 * r8.x;
              r21.xyz = r22.xyz * r5.yyy;
              r5.y = dot(r21.xyz, float3(0.212599993,0.715200007,0.0722000003));
              r5.y = r8.x * 1.26815999 + r5.y;
              r5.y = r8.w / r5.y;
              r19.xyz = r21.xyz * r5.yyy + r19.xyz;
            }
          }
        }
      }
  ...
  if (useAlphaControls != 0) {
    ...
    r3.x = 1 / r1.w;
    r3.y = -r2.y * r3.x + 1;
    r1.zw = r1.zz ? float2(0,1) : r3.xy;
    r2.x = abs(r1.y) * abs(r1.y);
    r1.z = saturate(r2.x * r1.z + r1.w);
    r1.z = r1.z * r0.w;
    r6.xy = (int2)v0.xy;
    r6.zw = float2(0,0);
    r1.w = floatZSampler.Load(r6.xyz).x;
...
r1.z = samp0[]..swiz;
  r1.w = revealMap.Sample(revealSampler_s, v2.xy).x;
  ...
  r1.z = aoMap.Sample(aoSampler_s, v2.xy).x;
  r1.w = x2[0].x;
  r1.w = r1.w + -r5.z;
