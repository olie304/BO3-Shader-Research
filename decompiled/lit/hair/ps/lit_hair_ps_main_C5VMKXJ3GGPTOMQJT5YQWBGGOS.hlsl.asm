...
mad r2.xyz, r2.xyzx, r0.xyzx, r5.xyzx
mad r3.xyz, -r3.yzwy, cb0[11].xyzx, l(1.000000, 1.000000, 1.000000, 0.000000)
...
if_nz cb0[11].w
  ...
  mul r2.w, |r2.w|, |r2.w|
  mad_sat r2.x, r2.w, r2.x, r2.y
  mul r2.x, r0.w, r2.x
  ftoi r3.xy, v0.xyxx
  mov r3.zw, l(0,0,0,0)
  ld_indexable(texture2d)(float,float,float,float) r2.y, r3.xyzw, t0.yxzw
  ge r2.w, r2.y, l(0.984375)
  mul r3.x, r2.y, l(1.01587307)
  mad r2.y, r2.y, l(64.000000), l(-63.000000)
  movc r2.y, r2.w, r2.y, r3.x
  max r2.y, r2.y, l(0.00000001)
  rcp r2.y, r2.y
  div r2.w, l(1.000000, 1.000000, 1.000000, 1.000000), cb0[12].x
...
ret 
// Approximately 2367 instruction slots used
