...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  if (r10.w != 0) {
    ...
    if (r10.w != 0) {
      ...
      r13.w = cmp(0 < r9.w);
      r9.w = saturate(r9.w);
      r15.xyz = -v6.xyz * r3.xxx + sunConstants.wldDir.xyz;
  ...
  while (true) {
    ...
    if (r6.z != 0) break;
    r4.z = (uint)r5.w >> 5;
    r8.xyz = (int3)r4.xyz + (int3)r18.xyz;
    r4.z = visibleProbes.Load(r8.xyzw).x;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r16.xyzw, r5.w, l(0), t15.wxyz
  r16.x = samp0[]..swiz;
  r16.y = samp0[]..swiz;
  r16.z = samp0[]..swiz;
  r16.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r17.xyzw, r5.w, l(16), t15.xyzw
  r17.x = samp0[]..swiz;
  r17.y = samp0[]..swiz;
  r17.z = samp0[]..swiz;
  r17.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r19.xyzw, r5.w, l(32), t15.yxwz
  r19.x = samp0[]..swiz;
  r19.y = samp0[]..swiz;
  r19.z = samp0[]..swiz;
  r19.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r20.xyzw, r5.w, l(48), t15.xyzw
  r20.x = samp0[]..swiz;
  r20.y = samp0[]..swiz;
  r20.z = samp0[]..swiz;
  r20.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r21.xyzw, r5.w, l(64), t15.zwxy
  r21.x = samp0[]..swiz;
  r21.y = samp0[]..swiz;
  r21.z = samp0[]..swiz;
  r21.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r22.xyzw, r5.w, l(80), t15.xyzw
  r22.x = samp0[]..swiz;
  r22.y = samp0[]..swiz;
  r22.z = samp0[]..swiz;
  r22.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r6.zw, r5.w, l(96), t15.xxxy
  r6.z = samp0[]..swiz;
  r6.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r23.xyzw, r5.w, l(116), t15.xyzw
  r23.x = samp0[]..swiz;
  r23.y = samp0[]..swiz;
  r23.z = samp0[]..swiz;
  r23.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r24.xyzw, r5.w, l(132), t15.zwxy
  r24.x = samp0[]..swiz;
  r24.y = samp0[]..swiz;
  r24.z = samp0[]..swiz;
  r24.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r25.xyzw, r5.w, l(148), t15.zwxy
  r25.x = samp0[]..swiz;
  r25.y = samp0[]..swiz;
  r25.z = samp0[]..swiz;
  r25.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r26.xyzw, r5.w, l(164), t15.zwxy
  r26.x = samp0[]..swiz;
  r26.y = samp0[]..swiz;
  r26.z = samp0[]..swiz;
  r26.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r27.xyzw, r5.w, l(180), t15.zwxy
  r27.x = samp0[]..swiz;
  r27.y = samp0[]..swiz;
  r27.z = samp0[]..swiz;
  r27.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r33.xyzw, r5.w, l(196), t15.xyzw
  r33.x = samp0[]..swiz;
  r33.y = samp0[]..swiz;
  r33.z = samp0[]..swiz;
  r33.w = samp0[]..swiz;
  ...
  r39.x = samp0[]..swiz;
  r39.y = samp0[]..swiz;
    r8.xyz = v6.xyz + -r16.yzw;
    r7.w = dot(r8.xyz, r8.xyz);
    r7.w = sqrt(r7.w);
    r7.w = cmp(probeDebugRadius >= r7.w);
    r9.w = (int)r23.y & 0x0000ffff;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r40.xyzw, r9.w, l(0), t16.xyzw
  r40.x = samp0[]..swiz;
  r40.y = samp0[]..swiz;
  r40.z = samp0[]..swiz;
  r40.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r41.xyzw, r9.w, l(16), t16.xyzw
  r41.x = samp0[]..swiz;
  r41.y = samp0[]..swiz;
  r41.z = samp0[]..swiz;
  r41.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r42.xyzw, r9.w, l(32), t16.xyzw
  r42.x = samp0[]..swiz;
  r42.y = samp0[]..swiz;
  r42.z = samp0[]..swiz;
  r42.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r43.xyzw, r9.w, l(48), t16.xyzw
  r43.x = samp0[]..swiz;
  r43.y = samp0[]..swiz;
  r43.z = samp0[]..swiz;
  r43.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r44.xyzw, r9.w, l(64), t16.xyzw
  r44.x = samp0[]..swiz;
  r44.y = samp0[]..swiz;
  r44.z = samp0[]..swiz;
  r44.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r45.xyzw, r9.w, l(80), t16.xyzw
  r45.x = samp0[]..swiz;
  r45.y = samp0[]..swiz;
  r45.z = samp0[]..swiz;
  r45.w = samp0[]..swiz;
    r10.w = dot(r40.xyz, r8.xyz);
    r10.w = saturate(r10.w + r40.w);
    r11.w = dot(r41.xyz, r8.xyz);
    r11.w = saturate(r11.w + r41.w);
    r10.w = r11.w * r10.w;
    r11.w = dot(r42.xyz, r8.xyz);
    r11.w = saturate(r11.w + r42.w);
    r10.w = r11.w * r10.w;
    r11.w = dot(r43.xyz, r8.xyz);
    r11.w = saturate(r11.w + r43.w);
    r10.w = r11.w * r10.w;
    r11.w = dot(r44.xyz, r8.xyz);
    r11.w = saturate(r11.w + r44.w);
    r10.w = r11.w * r10.w;
    r11.w = dot(r45.xyz, r8.xyz);
    r11.w = saturate(r11.w + r45.w);
    r9.x = r11.w * r10.w;
    r10.w = r6.z ? 0.000000 : 0;
    r38.xy = r10.ww ? r9.xy : r9.zx;
    r40.xy = r23.zw;
    r40.z = r24.z;
    r9.x = dot(r12.xyz, r40.xyz);
    r10.w = dot(r8.xyz, r40.xyz);
    r10.w = r10.w + -r24.w;
    r11.w = cmp(r10.w >= 0);
    ...
    r11.w = dot(r8.xyz, r24.xyz);
    r11.w = r11.w + -r25.w;
    r13.w = cmp(r11.w >= 0);
    r11.w = max(abs(r11.w), r1.w);
    ...
    r9.x = min(abs(r10.w), r9.x);
    r39.zw = r33.zw;
    r10.w = dot(r12.zxy, r39.xzw);
    r11.w = dot(r8.zxy, r39.xzw);
    r11.w = r11.w + -r39.y;
    r13.w = cmp(r11.w >= 0);
    r11.w = max(abs(r11.w), r1.w);
    r11.w = r13.w ? r11.w : -r11.w;
    ...
    r24.x = r20.w;
    r24.yz = r21.zw;
    r24.xyz = r24.xyz + r8.xyz;
    r24.xyz = r12.xyz * r9.xxx + r24.xyz;
    ...
    r25.w = (uint)r17.y;
    r17.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r25.xyzw, r9.x).xyz;
    r23.yzw = (int3)r17.yzw & int3(-2147483648,-2147483648,-2147483648);
    r23.yzw = cmp((int3)r23.yzw == int3(2139095040,2139095040,2139095040));
    r9.x = (int)r23.z | (int)r23.y;
    r9.x = (int)r23.w | (int)r9.x;
    r17.yzw = r9.xxx ? float3(1,1,0) : r17.yzw;
    r24.x = dot(r8.xyz, r16.xyz);
    r24.y = dot(r8.xyz, r26.xyz);
    r24.z = dot(r8.xyz, r19.xyz);
    ...
    r9.x = (int)r23.z | (int)r23.y;
    r9.x = (int)r23.w | (int)r9.x;
    r22.xyz = r9.xxx ? float3(1,1,0) : r22.xyz;
    r24.xyzw = r14.xyzw;
    r23.yzw = r15.yzw;
    r9.x = r4.w;
    r10.z = r4.z;
    while (true) {
      ...
      if (r11.z != 0) {
        ...
        if (r7.w != 0) {
          ...
          r41.z = samp0[]..swiz;
          r41.w = samp0[]..swiz;
            r11.w = dot(r26.xyz, r8.xyz);
            r11.w = saturate(r11.w + r26.w);
            r11.w = r25.x * r11.w;
            r13.z = dot(r27.xyz, r8.xyz);
            r13.z = saturate(r13.z + r27.w);
            r11.w = r13.z * r11.w;
            r13.z = dot(r33.xyz, r8.xyz);
            r13.z = saturate(r13.z + r33.w);
            r11.w = r13.z * r11.w;
            r13.z = dot(r39.xyz, r8.xyz);
            r13.z = saturate(r13.z + r39.w);
            r11.w = r13.z * r11.w;
            r13.z = dot(r40.xyz, r8.xyz);
            r13.z = saturate(r13.z + r40.w);
            r11.w = r13.z * r11.w;
            r13.z = dot(r41.xyz, r8.xyz);
            r13.z = saturate(r13.z + r41.w);
            r25.x = r13.z * r11.w;
            r13.w = (uint)r10.w >> 2;
            if (1 == 0) r16.z = 0; else if (1+2 < 32) {             r16.z = (uint)r10.w << (32-(1 + 2)); r16.z = (uint)r16.z >> (32-1);            } else r16.z = (uint)r10.w >> 2;
            r18.w = (int)r13.w & 2;
            r19.w = max(r25.y, r25.x);
            r11.w = -r11.w * r13.z + 1;
            r11.w = r25.y * r11.w;
            r5.y = r18.w ? r11.w : r19.w;
            r25.xy = r16.zz ? r25.xy : r5.xy;
            r11.z = (int)r11.z + 1;
            r10.w = r13.w;
          }
          ...
          r10.w = cmp(0 < r5.y);
          if (r10.w != 0) {
            r26.z = r25.y * r6.w + r23.w;
            r5.y = r5.y * r23.x;
            r25.xzw = r21.xyz * r5.yyy;
            ...
            r11.z = r10.w * r3.x;
            r25.xzw = r17.yzw * r5.yyy;
            r5.y = dot(r25.xzw, float3(0.212599993,0.715200007,0.0722000003));
            r5.y = r3.x * r10.w + r5.y;
            r5.y = r11.z / r5.y;
            r33.x = r24.w;
            r33.yz = r23.yz;
            r26.xyw = r25.zwx * r5.yyy + r33.yzx;
            r27.w = r26.w;
          } else {
            r27.xyzw = r24.xyzw;
            r26.xyz = r23.yzw;
  ...
  if (r4.w == 0) {
    ...
    r5.y = r4.y;
    while (true) {
      r5.w = cmp((uint)r5.y >= numRefProbes);
      if (r5.w != 0) break;
      r8.z = (uint)r5.y >> 5;
      r9.xyz = (int3)r8.xyz + (int3)r18.xyz;
      r5.w = visibleProbes.Load(r9.xyzw).x;
      r6.z = cmp((int)r4.y == (int)r5.y);
      bitmask.w = ((~(-1 << r4.z)) << 0) & 0xffffffff;  r6.w = (((uint)0 << 0) & bitmask.w) | ((uint)r5.w & ~bitmask.w);
      r5.w = r6.z ? r6.w : r5.w;
      r6.z = cmp((int)r4.w == (int)r5.y);
      if (r5.x == 0) r6.w = 0; else if (r5.x+0 < 32) {       r6.w = (uint)r5.w << (32-(r5.x + 0)); r6.w = (uint)r6.w >> (32-r5.x);      } else r6.w = (uint)r5.w >> 0;
      r5.w = r6.z ? r6.w : r5.w;
      r6.z = (int)r5.y + numLights;
      r21.xyzw = r19.xyzw;
      r22.xyz = r20.yzw;
      r6.w = r5.w;
      while (true) {
        ...
        r23.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=80)(mixed,mixed,mixed,mixed) r9.xy, r8.z, l(16), t11.xyxx
        r9.x = samp0[]..swiz;
        r9.y = samp0[]..swiz;
          r23.xyz = -v6.xyz + r23.xyz;
          r9.z = r23.w;
          r9.xyz = cmp(abs(r23.xyz) < r9.zxy);
          r8.z = r9.y ? r9.x : 0;
          r8.z = r9.z ? r8.z : 0;
          if (r8.z != 0) {
            r7.w = (int)r5.y + (int)r7.w;
          // Known bad code for instruction (needs manual fix):
          ...
          r24.z = samp0[]..swiz;
          r24.w = samp0[]..swiz;
            r9.xyz = v6.xyz + -r23.yzw;
            r10.w = (int)r24.w & 0x0000ffff;
            if (6 == 0) r11.w = 0; else if (6+25 < 32) {             r11.w = (uint)r24.w << (32-(6 + 25)); r11.w = (uint)r11.w >> (32-6);            } else r11.w = (uint)r24.w >> 25;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r25.xyzw, r10.w, l(0), t16.xyzw
          r25.x = samp0[]..swiz;
          r25.y = samp0[]..swiz;
          r25.z = samp0[]..swiz;
          r25.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r26.xyzw, r10.w, l(16), t16.xyzw
          r26.x = samp0[]..swiz;
          r26.y = samp0[]..swiz;
          r26.z = samp0[]..swiz;
          r26.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r27.xyzw, r10.w, l(32), t16.xyzw
          r27.x = samp0[]..swiz;
          r27.y = samp0[]..swiz;
          r27.z = samp0[]..swiz;
          r27.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r33.xyzw, r10.w, l(48), t16.xyzw
          r33.x = samp0[]..swiz;
          r33.y = samp0[]..swiz;
          r33.z = samp0[]..swiz;
          r33.w = samp0[]..swiz;
          ...
          r40.z = samp0[]..swiz;
          r40.w = samp0[]..swiz;
            r13.z = dot(r25.xyz, r9.xyz);
            r13.z = saturate(r13.z + r25.w);
            r13.w = dot(r26.xyz, r9.xyz);
            r13.w = saturate(r13.w + r26.w);
            r13.z = r13.z * r13.w;
            r13.w = dot(r27.xyz, r9.xyz);
            r13.w = saturate(r13.w + r27.w);
            r13.z = r13.z * r13.w;
            r13.w = dot(r33.xyz, r9.xyz);
            r13.w = saturate(r13.w + r33.w);
            r13.z = r13.z * r13.w;
            r13.w = dot(r39.xyz, r9.xyz);
            r13.w = saturate(r13.w + r39.w);
            r13.z = r13.z * r13.w;
            r13.w = dot(r40.xyz, r9.xyz);
            r13.w = saturate(r13.w + r40.w);
            r10.x = r13.z * r13.w;
            r13.z = (int)r8.z & 1;
            r13.zw = r13.zz ? r10.xy : r10.zx;
            r10.x = r8.z;
            r25.xy = r13.zw;
            r16.w = 1;
            while (true) {
              r17.w = cmp((int)r16.w >= (int)r11.w);
              if (r17.w != 0) break;
              r17.w = (int)r10.w + (int)r16.w;
            // Known bad code for instruction (needs manual fix):
            ...
            r41.z = samp0[]..swiz;
            r41.w = samp0[]..swiz;
              r17.w = dot(r26.xyz, r9.xyz);
              r17.w = saturate(r17.w + r26.w);
              r17.w = r25.x * r17.w;
              r18.w = dot(r27.xyz, r9.xyz);
              r18.w = saturate(r18.w + r27.w);
              r17.w = r18.w * r17.w;
              r18.w = dot(r33.xyz, r9.xyz);
              r18.w = saturate(r18.w + r33.w);
              r17.w = r18.w * r17.w;
              r18.w = dot(r39.xyz, r9.xyz);
              r18.w = saturate(r18.w + r39.w);
              r17.w = r18.w * r17.w;
              r18.w = dot(r40.xyz, r9.xyz);
              r18.w = saturate(r18.w + r40.w);
              r17.w = r18.w * r17.w;
              r18.w = dot(r41.xyz, r9.xyz);
              r18.w = saturate(r18.w + r41.w);
              r25.x = r18.w * r17.w;
              r23.w = (uint)r10.x >> 2;
              if (1 == 0) r25.z = 0; else if (1+2 < 32) {               r25.z = (uint)r10.x << (32-(1 + 2)); r25.z = (uint)r25.z >> (32-1);              } else r25.z = (uint)r10.x >> 2;
              r25.w = (int)r23.w & 2;
              r26.x = max(r25.y, r25.x);
              r17.w = -r17.w * r18.w + 1;
              r17.w = r25.y * r17.w;
              r13.y = r25.w ? r17.w : r26.x;
              r25.xy = r25.zz ? r25.xy : r13.xy;
              r16.w = (int)r16.w + 1;
              r10.x = r23.w;
            }
            r25.y = saturate(r25.y);
            ...
            if (r10.x != 0) {
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r26.xyzw, r7.w, l(16), t15.xyzw
            r26.x = samp0[]..swiz;
            r26.y = samp0[]..swiz;
            r26.z = samp0[]..swiz;
            r26.w = samp0[]..swiz;
            ...
            r46.y = samp0[]..swiz;
              ...
              r24.x = r33.w;
              r24.yz = r39.zw;
              r13.yzw = r24.xyz + r9.xyz;
              r13.yzw = r12.xyz * r8.zzz + r13.yzw;
              ...
              r23.y = r26.z;
              r23.z = r27.x;
              r41.x = dot(r13.yzw, r23.xyz);
              r24.xy = r26.xw;
              r24.z = r27.w;
              r41.y = dot(r13.yzw, r24.xyz);
              r27.x = r26.y;
              r41.z = dot(r13.yzw, r27.xyz);
              if (9 == 0) r8.w = 0; else if (9+16 < 32) {               r8.w = (uint)r24.w << (32-(9 + 16)); r8.w = (uint)r8.w >> (32-9);              } else r8.w = (uint)r24.w >> 16;
              r41.w = (uint)r8.w;
              r13.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r41.xyzw, r8.z).xyz;
              r25.xzw = (int3)r13.yzw & int3(-2147483648,-2147483648,-2147483648);
              r25.xzw = cmp((int3)r25.xzw == int3(2139095040,2139095040,2139095040));
              r8.z = (int)r25.z | (int)r25.x;
              r8.z = (int)r25.w | (int)r8.z;
              r13.yzw = r8.zzz ? float3(1,1,0) : r13.yzw;
              r26.x = dot(r9.xyz, r23.xyz);
              r26.y = dot(r9.xyz, r24.xyz);
              r26.z = dot(r9.xyz, r27.xyz);
              r9.xyz = saturate(r26.xyz * r33.xyz + float3(0.5,0.5,0.5));
              r39.z = r40.x;
              r9.xyz = r9.xyz * r39.xyz + r40.yzw;
              r41.x = dot(r2.xyz, r23.xyz);
              r41.y = dot(r2.xyz, r24.xyz);
              ...
              r25.xzw = r41.xyz * r41.xyz;
              r25.xzw = r25.xzw * r7.www;
              r16.z = r23.y ? 0 : 0.5;
              r23.xyw = r16.xyz + r9.xyz;
              ...
              r8.z = (int)r24.y | (int)r24.x;
              r8.z = (int)r24.z | (int)r8.z;
              r23.xyz = r8.zzz ? float3(1,1,0) : r23.xyz;
              r24.xyz = r23.xyz * r9.xyz;
              r8.z = dot(r24.xyz, float3(0.212599993,0.715200007,0.0722000003));
              r21.xyz = r9.xyz * r23.xyz + r21.xyz;
              r8.w = r8.z * r3.x;
              r9.xyz = r13.yzw * r7.www;
              r7.w = dot(r9.xyz, float3(0.212599993,0.715200007,0.0722000003));
              r7.w = r3.x * r8.z + r7.w;
              r7.w = r8.w / r7.w;
              r23.x = r21.w;
              r23.yz = r22.xy;
              r22.xyw = r9.yzx * r7.www + r23.yzx;
              r21.w = r22.w;
            }
          }
        }
    ...
    if (r4.w != 0) {
      ...
      while (true) {
        ...
        r6.w = cmp((int)r4.y == (int)r5.w);
        if (r4.z == 0) r7.w = 0; else if (r4.z+0 < 32) {         r7.w = (uint)r6.z << (32-(r4.z + 0)); r7.w = (uint)r7.w >> (32-r4.z);        } else r7.w = (uint)r6.z >> 0;
        r6.z = r6.w ? r7.w : r6.z;
        r6.w = (int)r5.w + numLights;
        r22.xyzw = r17.xyzw;
        r9.xyz = r21.xyz;
        r7.w = r4.w;
        r8.z = r6.z;
        while (true) {
          ...
          r24.y = samp0[]..swiz;
            ...
            r23.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r24.xy, r8.w, l(96), t15.xyxx
            r24.x = samp0[]..swiz;
            r24.y = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r25.xyzw, r8.w, l(116), t15.zwxy
            r25.x = samp0[]..swiz;
            r25.y = samp0[]..swiz;
            r25.z = samp0[]..swiz;
            r25.w = samp0[]..swiz;
            ...
            r42.w = samp0[]..swiz;
              ...
              r43.w = samp0[]..swiz;
                ...
                r15.w = -r15.w * r16.w + 1;
                r15.w = r27.y * r15.w;
                r5.y = r23.w ? r15.w : r26.w;
                r27.xy = r21.ww ? r27.xy : r5.xy;
                r13.w = (int)r13.w + 1;
                r10.x = r18.w;
              }
              r5.y = saturate(r27.y + -r7.w);
              r10.x = r5.y * r24.y;
              r10.w = cmp(0 < r10.x);
              if (r10.w != 0) {
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r33.xyzw, r8.w, l(16), t15.xyzw
              r33.x = samp0[]..swiz;
              r33.y = samp0[]..swiz;
              r33.z = samp0[]..swiz;
              r33.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r39.xyzw, r8.w, l(32), t15.yxwz
              r39.x = samp0[]..swiz;
              r39.y = samp0[]..swiz;
              r39.z = samp0[]..swiz;
              r39.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r40.xyzw, r8.w, l(48), t15.xyzw
              r40.x = samp0[]..swiz;
              r40.y = samp0[]..swiz;
              r40.z = samp0[]..swiz;
              r40.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r41.xyzw, r8.w, l(64), t15.zwxy
              r41.x = samp0[]..swiz;
              r41.y = samp0[]..swiz;
              r41.z = samp0[]..swiz;
              r41.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r42.xyzw, r8.w, l(80), t15.xyzw
              r42.x = samp0[]..swiz;
              r42.y = samp0[]..swiz;
              r42.z = samp0[]..swiz;
              r42.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r43.xyzw, r8.w, l(132), t15.zwxy
              r43.x = samp0[]..swiz;
              r43.y = samp0[]..swiz;
              r43.z = samp0[]..swiz;
              r43.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r44.xyzw, r8.w, l(148), t15.zwxy
              r44.x = samp0[]..swiz;
              r44.y = samp0[]..swiz;
              r44.z = samp0[]..swiz;
              r44.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r45.xyzw, r8.w, l(164), t15.zwxy
              r45.x = samp0[]..swiz;
              r45.y = samp0[]..swiz;
              r45.z = samp0[]..swiz;
              r45.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r46.xyzw, r8.w, l(180), t15.zwxy
              r46.x = samp0[]..swiz;
              r46.y = samp0[]..swiz;
              r46.z = samp0[]..swiz;
              r46.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r47.xyzw, r8.w, l(196), t15.xyzw
              r47.x = samp0[]..swiz;
              r47.y = samp0[]..swiz;
              r47.z = samp0[]..swiz;
              r47.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r48.xy, r8.w, l(212), t15.xyxx
              r48.x = samp0[]..swiz;
              r48.y = samp0[]..swiz;
                r22.w = r5.y * r24.y + r22.w;
                r5.y = r10.x * r25.z;
                r25.z = r43.z;
                ...
                r24.xyz = r12.xyz * r8.www + r24.xyz;
                ...
                r43.w = (uint)r10.x;
                r24.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r43.xyzw, r8.w).xyz;
                ...
                r24.xyz = r8.www ? float3(1,1,0) : r24.xyz;
                ...
                r9.xyz = r23.xyz * r25.xyz + r9.xyz;
                r10.x = r8.w * r3.x;
                r23.xyz = r24.xyz * r5.yyy;
                r5.y = dot(r23.xyz, float3(0.212599993,0.715200007,0.0722000003));
                r5.y = r3.x * r8.w + r5.y;
                r5.y = r10.x / r5.y;
                r22.xyz = r23.xyz * r5.yyy + r22.xyz;
              }
            }
          }
        }
    ...
    r14.xyz = r19.xyz * r1.yyy;
    r15.xyz = r20.xyz * r1.yyy;
    r1.w = cmp(r20.w < 0.99000001);
    if (r1.w != 0) {
      r1.w = 1 + -r20.w;
      r3.x = sunConstants.globalProbeExposure * r1.w;
      r4.xyz = -globalProbeConstants.data[0].xyz + v6.xyz;
      r8.x = globalProbeConstants.data[0].w * r4.x;
      r8.yz = globalProbeConstants.data[1].xy * r4.yz;
      r4.xyz = saturate(float3(0.5,0.5,0.5) + r8.xyz);
      r8.xy = globalProbeConstants.data[1].zw * r4.xy;
      r8.z = globalProbeConstants.data[2].x * r4.z;
      r4.xyz = globalProbeConstants.data[2].yzw + r8.xyz;
      r5.xyw = cmp(float3(0,0,0) < r2.xyz);
      r8.xyz = r5.xyw ? float3(0,0,0) : float3(0.5,0.5,0.5);
      r8.w = 0;
      r5.xyw = r8.wwx + r4.xyz;
      r5.xyw = gProbeXArray.SampleLevel(samplerLinearClamp_s, r5.xyw, 0).xyz;
      r9.xyz = r2.xyz * r2.xyz;
      r9.xyz = r9.xyz * r3.xxx;
      r10.xyz = r8.wwy + r4.xyz;
      r10.xyz = gProbeYArray.SampleLevel(samplerLinearClamp_s, r10.xyz, 0).xyz;
      r10.xyz = r10.xyz * r9.yyy;
      r5.xyw = r5.xyw * r9.xxx + r10.xyz;
      r4.xyz = r8.wwz + r4.xyz;
      r4.xyz = gProbeZArray.SampleLevel(samplerLinearClamp_s, r4.xyz, 0).xyz;
      r4.xyz = r4.xyz * r9.zzz + r5.xyw;
      r2.w = 0;
...
r1.y = samp0[]..swiz;
  ...
  r1.y = r2.x * r1.y;
  r4.y = exp2(r1.y);
  r1.yw = saturate(alphaRevealSoftEdge * r4.xy + r1.ww);
  r1.z = r1.z + -r1.y;
  r1.y = r1.w + -r1.y;
  ...
  r4.xyz = r1.xzw * r35.xyz + r29.xyz;
  r5.xyz = r1.xzw * r36.xyz + r31.xyz;
  r1.xzw = r1.xzw * r37.xyz + r30.xyz;
  r2.xyz = r14.xyz * r1.yyy + r2.xyz;
  r4.xyz = r14.xyz * r1.yyy + r4.xyz;
  r6.xy = r6.xy * float2(0.984375,0.984375) + float2(0.0078125,0.0078125);
  r6.xy = gEnvBRDFGeneric.SampleLevel(samplerLinear_s, r6.xy, 0).xy;
  r8.xyz = r15.xyz * r1.yyy;
  r1.xyz = r8.xyz * r6.xxx + r1.xzw;
  r5.xyz = r8.xyz * r6.yyy + r5.xyz;
