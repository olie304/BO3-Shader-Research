...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:37:07 2021
//
//
// Buffer Definitions: 
//
...
mul r6.z, r0.z, r0.x
sqrt r6.z, r6.z
mad r6.w, -r6.x, l(0.500000), l(1.000000)
        ...
        if_nz r34.w
          ...
          if_nz r32.w
            ...
            if_nz r32.w
              ...
              mad r60.xyz, r2.xyzx, r32.wwww, v7.xyzx
            ...
            if_nz r59.w
              ...
              mad r23.xyz, r2.xyzx, r35.wwww, v7.xyzx
            ...
            if_nz r23.y
              ...
              mad r30.w, -|r33.w|, r6.w, l(1.000000)
        ...
        if_nz r29.w
          ...
          if_nz r24.x
            ...
            if_nz r24.y
              ...
              mad r25.x, -|r23.y|, r6.w, l(1.000000)
...
ftoi r13.xy, r6.zwzz
mov r13.zw, l(0,0,0,0)
ld_indexable(texture2d)(float,float,float,float) r3.x, r13.xyzw, t21.xyzw
ge r4.w, r3.x, l(0.984375)
mul r6.z, r3.x, l(1.01587307)
mad r3.x, r3.x, l(64.000000), l(-63.000000)
movc r3.x, r4.w, r3.x, r6.z
max r3.x, r3.x, l(0.00000001)
rcp r3.x, r3.x
mov x2[0].x, r3.x
add r4.w, r3.x, l(0.042000)
mul r4.w, r4.w, r8.z
...
if_nz r6.z
  ...
  rcp r6.z, r6.z
  movc r3.x, r5.x, r6.z, r3.x
  mov x2[0].x, r3.x
  add r3.x, r6.z, l(0.042000)
  mul r3.x, r3.x, r8.z
  lt r3.x, l(1.000000), r3.x
  and r3.x, r3.x, l(0x3f800000)
  mul r3.x, r3.x, r4.w
  movc r3.x, r5.x, r3.x, r4.w
  mov x0[0].x, r3.x
...
if_z r3.x
  ...
  mov r3.x, x1[0].x
  mov r4.w, x0[0].x
  mad r5.x, r5.x, r5.x, -r3.x
  mad r3.x, r4.w, r5.x, r3.x
  mov x1[0].x, r3.x
  mad r5.xzw, r11.xxyz, r3.xxxx, r10.xxyz
  lt r3.x, r0.z, r3.x
...
if_z r3.x
  ...
  mov r0.x, x1[0].x
  mov r3.x, x0[0].x
  mad r4.w, r5.x, r5.x, -r0.x
  mad r0.x, r3.x, r4.w, r0.x
  ...
  and r4.w, r4.w, l(0x3f800000)
  mul r4.w, r3.x, r4.w
  movc r0.x, r0.x, r4.w, r3.x
  mov x0[0].x, r0.x
  mov r0.x, x1[1].x
  mov r3.x, x0[1].x
  mad r4.w, r5.y, r5.y, -r0.x
  mad r0.x, r3.x, r4.w, r0.x
  ...
  ge r4.x, r0.z, l(0.984375)
  mul r4.y, r0.z, l(1.01587307)
  mad r0.z, r0.z, l(64.000000), l(-63.000000)
  movc r0.z, r4.x, r0.z, r4.y
  max r0.z, r0.z, l(0.00000001)
  rcp r0.z, r0.z
  mov r4.x, x2[1].x
  movc r4.x, r0.x, r0.z, r4.x
  mov x2[1].x, r4.x
  ...
  mul r0.z, r0.z, r3.x
  movc r0.x, r0.x, r0.z, r3.x
  mov x0[1].x, r0.x
endif 
mov r0.x, x0[0].x
mad r0.y, -cb1[62].w, r0.y, l(1.000000)
mul r0.z, r0.y, l(5.000000)
mad r3.x, r0.y, l(5.000000), l(-2.500000)
mul_sat r3.x, r3.x, l(0.400000)
...
if_z r4.y
        ...
        if_nz r13.w
          ...
          if_nz r11.w
            ...
            if_nz r11.w
              ...
              sqrt r10.x, r10.x
              mad r10.x, r0.y, l(5.000000), r10.x
  ...
  rcp r0.y, r0.y
  mov_sat r20.w, r20.w
  mul r15.xyz, r0.yyyy, r19.xyzx
  mul r16.xyz, r0.yyyy, r20.xyzx
  lt r3.x, r20.w, l(0.990000)
  if_nz r3.x
    add r3.x, -r20.w, l(1.000000)
    mul r4.x, r3.x, cb2[19].x
    add r4.yzw, v7.xxyz, -cb2[35].xxyz
...
if_nz cb0[11].w
  ...
  movc r2.xy, r0.zzzz, l(0,1.000000,0,0), r3.xyxx
  mul r0.z, |r0.y|, |r0.y|
  mad_sat r0.z, r0.z, r2.x, r2.y
  mul r0.z, r0.z, r0.w
  ftoi r3.xy, v0.xyxx
  mov r3.zw, l(0,0,0,0)
...
sample_indexable(texture2d)(float,float,float,float) r1.w, v2.xyxx, t29.yzwx, s7
mad_sat r0.z, r0.z, l(0.998000), l(0.001000)
add r2.x, -r0.z, l(1.000000)
mov_sat r2.y, cb0[13].x
log r0.z, r0.z
mul r0.z, r0.z, r2.y
exp r0.z, r0.z
mov r3.x, -r0.z
...
mul r0.z, r0.z, r2.y
exp r3.y, r0.z
mad_sat r2.xy, cb0[12].wwww, r3.xyxx, r2.xxxx
add r0.z, r1.w, -r2.x
add r1.w, -r2.x, r2.y
...
movc r0.x, r1.w, l(0.500000), r0.x
mov r1.w, x2[1].x
add r1.w, -r9.z, r1.w
lt r1.w, l(2.400000), |r1.w|
mov r2.x, x0[1].x
...
mad r3.xyz, r15.xyzx, r0.wwww, r3.xyzx
mad r4.xyz, r15.xyzx, r0.wwww, r4.xyzx
...
mad r2.xyz, r7.xyzx, r6.xxxx, r2.xyzx
...
mad r0.xyw, r3.xyxz, r1.xyxz, r0.xyxw
mad r1.xyz, -r6.xyzx, cb0[11].xyzx, l(1.000000, 1.000000, 1.000000, 0.000000)
...
if_nz r1.x
  ...
  mad r1.xyz, r1.wwww, r2.xyzx, r0.xywx
endif 
mul r0.xyw, r1.xyxz, cb1[85].yyyy
ge r1.xyz, r0.xywx, l(0.00006104, 0.00006104, 0.00006104, 0.000000)
and r0.xyw, r0.xyxw, r1.xyxz
min o0.xyz, r0.xywx, l(65024.000000, 65024.000000, 64512.000000, 0.000000)
mov o0.w, r0.z
ret 
