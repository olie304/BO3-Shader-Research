// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:36:58 2021
...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  float4 r0,r1,r2,r3,r4,r5,r6,r7,r8,r9,r10,r11,r12,r13,r14,r15,r16,r17,r18,r19,r20,r21,r22,r23,r24,r25,r26,r27,r28,r29,r30,r31,r32,r33,r34,r35,r36,r37,r38,r39,r40,r41,r42,r43,r44,r45,r46,r47,r48,r49,r50,r51,r52,r53,r54,r55,r56,r57,r58,r59,r60,r61,r62,r63,r64,r65,r66,r67;
  ...
  r2.y = r3.y + r2.y;
  r2.y = log2(r2.y);
  r2.xy = float2(-0.0588235296,-0.0588235296) * r2.xy;
  r2.xy = max(float2(0,0), r2.xy);
  r3.yzw = r6.xyz * r2.www;
  r3.yzw = r5.xyz * r2.zzz + r3.yzw;
  ...
  r9.z = 0.984375 * r6.w;
  r7.w = r6.w * 0.547037423 + 0.452962577;
  r11.yz = float2(0.547037423,0.452962577) * r7.ww;
  r7.w = min(1, abs(anisotropy));
  r2.y = r2.y + -r2.x;
  r2.x = r7.w * r2.y + r2.x;
  r2.y = cmp(anisotropy < 0);
  r2.x = 17 * r2.x;
  r14.y = exp2(r2.x);
  r14.xz = float2(1,1);
  r2.xy = r2.yy ? r14.xy : r14.yx;
  r2.xy = float2(2,2) + r2.xy;
  r2.xy = float2(2,2) / r2.xy;
  r7.w = dot(r3.xyz, sunConstants.wldDir.xyz);
  ...
  if (r10.w == 0) {
    ...
    if (r11.w != 0) {
      ...
      while (true) {
        ...
        if (r16.x != 0) break;
        r16.x = (uint)r11.w;
        r16.yz = -sunConstants.splitPinTransform[r16.x].xy + r15.xy;
        r16.y = max(abs(r16.y), abs(r16.z));
        r15.w = sunConstants.splitPinTransform[r16.x].z * r16.y;
        r16.x = cmp(r15.w < 1);
        if (r16.x != 0) {
          break;
        }
    ...
    if (r16.x != 0) {
      ...
      r17.xz = rcp(r16.yy);
      r17.y = -r17.z;
      r16.yzw = r15.xyx * r17.xyz + r16.zwz;
    ...
    if (r16.x == 0) {
      ...
      if (enableDitheredShadow != 0) {
        ...
        r15.w = 28 * r15.w;
        r15.w = (uint)r15.w;
        r17.xy = -sunConstants.splitPinTransform[r15.z].xy + r15.xy;
        r17.xy = sunConstants.splitPinTransform[r15.z].zz * r17.xy;
        ...
        while (true) {
          ...
          if (r17.w != 0) break;
          r17.w = cmp((uint)r15.w < (uint)r17.z);
          r18.xy = r17.ww ? r15.xy : r17.xy;
          r18.z = r17.w ? sunConstants.splitPinTransform[r11.w].w : sunConstants.splitPinTransform[r15.z].w;
          r17.w = r17.w ? r11.w : r15.z;
          ...
          r18.z = (uint)r17.w;
          r17.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r18.xyz, r10.w).x;
  ...
  r18.z = samp0[]..swiz;
  r18.w = samp0[]..swiz;
    r19.x = abs(r7.w) * -0.200000003 + 0.400000006;
    r19.y = cmp(r7.w < 0);
    r19.x = r19.y ? -r19.x : r19.x;
    r19.xyz = r3.xyz * r19.xxx + v6.xyz;
    r19.w = 1;
    ...
    r18.y = samp0[]..swiz;
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          if (r15.w != 0) break;
          r19.x = dot(icb[r15.z+0].yx, r17.xy);
          r19.y = dot(icb[r15.z+0].yx, r17.yz);
          r18.xy = r19.xy * r11.ww + r16.xy;
          r15.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r18.xyz, r10.w).x;
          r15.y = r15.w * 0.125 + r15.y;
          r15.z = (int)r15.z + 1;
        }
      } else {
        r16.z = (uint)r15.x;
        r15.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r10.w).x;
      }
      r10.w = r15.y * r15.y;
      r10.w = r10.w * r15.y;
    } else {
  ...
  if (r10.w != 0) {
    r10.w = cmp(0 < r14.y);
    if (r10.w != 0) {
      r10.w = sunConstants.specScale * 0.166666672;
      if (sunConstants.sunCookieIndex != 0) {
        r13.w = 1;
        r11.w = dot(sunConstants.sunCookieTransform[0].xyzw, r13.xyzw);
        r13.w = dot(sunConstants.sunCookieTransform[1].xyzw, r13.xyzw);
        r15.x = frac(r11.w);
        r15.y = frac(r13.w);
      ...
      r16.xy = r16.xy / r2.yx;
      r16.x = r16.y + r16.x;
      r5.w = abs(r5.w) * abs(r5.w) + r16.x;
      r16.x = r7.w * r11.y + r11.z;
      r5.w = r5.w * r5.w;
      r5.w = r5.w * r16.w;
      r5.w = r5.w * r16.x;
      r5.w = rcp(r5.w);
      r7.w = r7.w * r10.w;
      r5.w = r7.w * r5.w;
      r7.w = saturate(1 + -r15.w);
      r10.w = r7.w * r7.w;
      r10.w = r10.w * r10.w;
      r7.w = r10.w * r7.w;
      r7.w = r7.w * r5.w;
      r10.w = r13.w ? r11.w : 0;
      r16.xyz = r13.www ? float3(0,0,0) : r11.www;
      r17.xy = r13.ww ? r7.ww : 0;
      r18.xyz = r13.www ? r5.www : 0;
      r5.w = dot(r15.xyz, float3(0.212599993,0.715200007,0.0722000003));
      r5.w = r14.y * r5.w;
      r14.x = 1;
      r7.w = sunConstants.wldDir.x;
      r17.zw = sunConstants.wldDir.yz;
      r19.xy = r10.ww;
      r11.w = r17.y;
    } else {
      r14.xy = float2(0,0);
  ...
  r13.w = 0.0078125 * r4.w;
  r13.w = min(15, r13.w);
  r13.w = (uint)r13.w;
  r20.xy = (uint2)r2.zw >> int2(6,6);
  r20.z = (uint)r13.w << 4;
  r21.x = -r9.x;
  r2.z = -r6.w * 0.5 + 1;
  r2.w = r2.x * r2.y;
  ...
  r39.x = r11.w;
  r39.yz = r17.xy;
  r40.x = enableDitheredShadow;
  r40.y = r5.w;
  r19.zw = r14.xy;
  r6.w = 0;
  while (true) {
    r13.w = cmp((uint)r6.w >= numLights);
    if (r13.w != 0) break;
    r22.z = (uint)r6.w >> 5;
    r23.xyz = (int3)r20.xyz + (int3)r22.xyz;
    r13.w = visibleLights.Load(r23.xyzw).x;
    r23.xyz = r30.xyz;
    r41.xyz = r31.xyz;
    r42.xyz = r32.xyz;
    r43.xyz = r33.xyz;
    ...
    while (true) {
      ...
      r26.w = 1 << (int)r20.w;
      r29.w = (int)r18.w & (int)r26.w;
      if (r29.w != 0) {
        r18.w = (int)r18.w ^ (int)r26.w;
        r20.w = (int)r6.w + (int)r20.w;
      // Known bad code for instruction (needs manual fix):
      ...
      r56.z = samp0[]..swiz;
      r56.w = samp0[]..swiz;
        if (3 == 0) r26.w = 0; else if (3+24 < 32) {         r26.w = (uint)r51.w << (32-(3 + 24)); r26.w = (uint)r26.w >> (32-3);        } else r26.w = (uint)r51.w >> 24;
        switch (r26.w) {
          case 4 :          r26.w = cmp(0 < r56.x);
          r57.xy = r55.zw;
          r57.z = r56.w;
          r58.xyz = -r57.xyz * float3(0.5,0.5,0.5) + r50.yzw;
          r59.xyz = -v6.xyz + r58.xyz;
          r29.w = dot(r57.xyz, r59.xyz);
          r30.w = saturate(-r29.w / r56.x);
          r60.xyz = r30.www * r57.xyz + r58.xyz;
          r60.xyz = r26.www ? r60.xyz : r50.yzw;
          r60.xyz = -v6.xyz + r60.xyz;
          r31.w = dot(r60.xyz, r60.xyz);
          r32.w = rsqrt(r31.w);
          r60.xyz = r60.xyz * r32.www;
          r32.w = dot(r3.xyz, r60.xyz);
          ...
          if (r33.w != 0) {
            ...
            r31.w = r34.w / r31.w;
            r31.w = min(1, r31.w);
            r40.zw = saturate(r33.ww * r52.xz + r52.yw);
            r61.xy = r40.zw * r40.zw;
            r40.zw = r40.zw * float2(-2,-2) + float2(3,3);
            r40.zw = r61.xy * r40.zw;
            r31.w = r40.z * r31.w;
            r61.x = r31.w * r40.w;
            r31.w = cmp(0 < r61.x);
            if (r31.w != 0) {
              if (3 == 0) r40.z = 0; else if (3+27 < 32) {               r40.z = (uint)r51.w << (32-(3 + 27)); r40.z = (uint)r40.z >> (32-3);              } else r40.z = (uint)r51.w >> 27;
              if (4 == 0) r40.w = 0; else if (4+20 < 32) {               r40.w = (uint)r51.w << (32-(4 + 20)); r40.w = (uint)r40.w >> (32-4);              } else r40.w = (uint)r51.w >> 20;
              r31.w = cmp((int)r40.z != 1);
              if (r31.w != 0) {
                r31.w = abs(r32.w) * -0.200000003 + 0.400000006;
                r33.w = cmp(r32.w < 0);
                r31.w = r33.w ? -r31.w : r31.w;
                r62.xyz = r3.xyz * r31.www + v6.xyz;
                r62.xyz = r62.xyz + -r54.xyz;
                r31.w = max(abs(r62.y), abs(r62.z));
                r31.w = max(abs(r62.x), r31.w);
                r31.w = r55.x / r31.w;
                r31.w = r31.w + r55.y;
                r33.w = dot(r62.xyz, r62.xyz);
                r33.w = rsqrt(r33.w);
                r31.w = max(6.10351563e-05, r31.w);
                r34.w = (int)r51.w & 0x0000ffff;
                r63.w = (uint)r34.w;
                r61.y = 0;
                r34.w = 0;
                while (true) {
                  ...
                  if (r35.w != 0) break;
                  r64.y = dot(icb[r34.w+0].yx, r21.xy);
                  r64.z = dot(icb[r34.w+0].yx, r21.yz);
                  r64.yz = r64.yz * r53.yy;
                  r64.x = r64.y * r11.x;
                  r64.w = r64.y * r8.x;
                  r63.xyz = r62.xyz * r33.www + r64.xzw;
                  r35.w = gOmniShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r63.xyzw, r31.w).x;
                  r61.y = r35.w * 0.125 + r61.y;
                  r34.w = (int)r34.w + 1;
                }
              } else {
                r61.y = 1;
              ...
              r63.w = samp0[]..swiz;
                ...
                r25.xyz = r3.xyz * r34.www + v6.xyz;
                r34.w = dot(r62.xyzw, r25.xyzw);
                r35.w = dot(r63.xyzw, r25.xyzw);
                ...
                r40.z = samp0[]..swiz;
                r40.w = samp0[]..swiz;
                  r62.x = dot(r62.xyzw, r25.xyzw);
                  r62.y = dot(r63.xyzw, r25.xyzw);
                  r25.xy = r62.xy / r35.ww;
                  r25.xy = r25.xy * float2(0.5,-0.5) + float2(0.5,0.5);
                  r25.xy = r25.xy + r65.zw;
                  r25.xy = r25.xy * r65.xy;
                  r61.zw = r33.ww / r64.xz;
                  r62.xy = float2(1,1) + -r61.zw;
                  r62.xy = cmp(r25.xy >= r62.xy);
                  r61.zw = cmp(r61.zw >= r25.xy);
                  r61.zw = (int2)r61.zw | (int2)r62.xy;
                  r25.z = (int)r61.w | (int)r61.z;
                  r25.xy = saturate(r25.xy);
                  r62.xy = r25.xy * r64.xz + r64.yw;
                  r25.x = r40.w * r35.w;
                  r25.y = r40.z * r35.w + r34.w;
                  r25.x = r25.y / r25.x;
                } else {
                  r25.z = -1;
                }
                ...
                r25.y = samp0[]..swiz;
                  ...
                  if (r15.w != 0) {
                    ...
                    while (true) {
                      ...
                      if (r34.w != 0) break;
                      r64.x = dot(icb[r31.w+0].yx, r21.xw);
                      r64.y = dot(icb[r31.w+0].xy, r9.xy);
                      r63.xy = r64.xy * r33.ww + r62.xy;
                      r34.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r63.xyz, r25.x).x;
                      r25.z = r34.w * 0.125 + r25.z;
                      r31.w = (int)r31.w + 1;
                    }
                  } else {
                    r62.z = (uint)r25.y;
                    r25.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r62.xyz, r25.x).x;
                  }
                  r25.x = r25.z * r25.z;
                  r25.x = r25.x * r25.z;
                } else {
              ...
              r25.y = cmp(0 < r25.x);
              if (r25.y != 0) {
                r25.y = 0.166666672 * r51.x;
                r31.w = dot(r57.xyz, r12.xyz);
                r33.w = dot(r12.xyz, r59.xyz);
                r34.w = -r31.w * r31.w + r56.x;
                ...
                r57.xyz = r29.www * r57.xyz + r58.xyz;
                r57.xyz = r26.www ? r57.xyz : r50.yzw;
                r57.xyz = -v6.xyz + r57.xyz;
                r26.w = dot(r57.xyz, r57.xyz);
                r26.w = rsqrt(r26.w);
                r58.xyz = r57.xyz * r26.www;
                r29.w = -abs(r32.w) * r2.z + 1;
                r29.w = r29.w * r29.w;
                r29.w = -r29.w * 0.620000005 + 0.620000005;
                r29.w = r29.w + -abs(r32.w);
                r29.w = r29.w * 0.816496611 + abs(r32.w);
                r30.w = cmp(0 < r32.w);
                r31.w = saturate(dot(r3.xyz, r58.xyz));
                r57.xyz = r57.xyz * r26.www + r7.xyz;
                r26.w = dot(r57.xyz, r57.xyz);
                r26.w = rsqrt(r26.w);
                r57.xyz = r57.xyz * r26.www;
                r26.w = dot(r3.xyz, r57.xyz);
                r32.w = dot(r57.xyz, r7.xyz);
                r33.w = dot(r57.xyz, r5.xyz);
                r34.w = dot(r57.xyz, r6.xyz);
                r33.w = r33.w * r33.w;
                r33.w = r33.w / r2.x;
                r34.w = r34.w * r34.w;
                r34.w = r34.w / r2.y;
                r33.w = r34.w + r33.w;
                r26.w = abs(r26.w) * abs(r26.w) + r33.w;
                r33.w = r31.w * r11.y + r11.z;
                r26.w = r26.w * r26.w;
                r26.w = r26.w * r2.w;
                r26.w = r26.w * r33.w;
                r26.w = rcp(r26.w);
                r25.y = r31.w * r25.y;
                r25.y = r26.w * r25.y;
                r26.w = saturate(1 + -r32.w);
                r31.w = r26.w * r26.w;
                r31.w = r31.w * r31.w;
                r26.w = r31.w * r26.w;
                r26.w = r26.w * r25.y;
                r57.xyz = r30.www ? r29.www : 0;
                r29.w = r30.w ? 0 : r29.w;
                r58.xyz = r30.www ? r26.www : 0;
                r25.y = r30.w ? r25.y : 0;
                r51.x = r50.x;
                r26.w = dot(r51.xyz, float3(0.212599993,0.715200007,0.0722000003));
                r26.w = r26.w * r25.x;
                r30.w = cmp(r16.w < r26.w);
                if (r30.w != 0) {
                  r30.w = r22.z * r22.w;
                  r59.xyz = r30.www * r44.xyz;
                  r23.xyz = r59.xyz * r46.xyz + r23.xyz;
                  r41.xyz = r59.xyz * r49.xyz + r41.xyz;
                  r43.xyz = r59.xyz * r47.xyz + r43.xyz;
                  r42.xyz = r59.xyz * r48.xyz + r42.xyz;
                  r47.xyz = r25.yyy;
                  r16.w = r26.w;
                  r49.xyz = r29.www;
                  r44.xyz = r51.xyz;
                  ...
                  r57.xyw = r51.xyz * r25.xxx;
                  r23.xyz = r57.xyw * r57.zzz + r23.xyz;
                  r41.xyz = r57.xyw * r29.www + r41.xyz;
                  r43.xyz = r57.xyw * r25.yyy + r43.xyz;
                  r42.xyz = r57.xyw * r58.xyz + r42.xyz;
                }
              }
            }
          }
          break;
          case 2 :          r57.xy = r53.zw;
          r57.z = r54.w;
          r57.xyz = -v6.xyz + r57.xyz;
          r25.x = dot(r57.xyz, r57.xyz);
          r25.x = rsqrt(r25.x);
          r58.xyz = r57.xyz * r25.xxx;
          r25.y = dot(r3.xyz, r58.xyz);
          r26.w = cmp(0 < abs(r25.y));
          if (r26.w != 0) {
          // Known bad code for instruction (needs manual fix):
          ...
          r60.w = samp0[]..swiz;
            r62.xyz = r59.xyz;
            r62.w = r60.y;
            r26.w = dot(r62.xyzw, r24.xyzw);
            r29.w = cmp(r26.w < 1);
            if (r29.w != 0) {
              r61.xzw = float3(1,1,1);
              r63.x = 0;
            } else {
            // Known bad code for instruction (needs manual fix):
            ...
            r29.w = samp0[]..swiz;
              r67.xyz = -v6.xyz + r50.yzw;
              r30.w = r53.x * r53.x;
              r31.w = dot(r67.xyz, r67.xyz);
              r30.w = r30.w / r31.w;
              r30.w = min(1, r30.w);
              r40.zw = saturate(r26.ww * r52.xz + r52.yw);
              r52.xy = r40.zw * r40.zw;
              r40.zw = r40.zw * float2(-2,-2) + float2(3,3);
              r40.zw = r52.xy * r40.zw;
              r30.w = r40.z * r30.w;
              r30.w = r30.w * r40.w;
              r54.w = r55.x;
              r52.x = dot(r54.xyzw, r24.xyzw);
              r67.xyz = r55.yzw;
              r67.w = r56.w;
              r52.y = dot(r67.xyzw, r24.xyzw);
              r26.xy = r52.xy / r26.ww;
              r26.w = cmp(r64.w < 0.00048828125);
              if (r26.w != 0) {
                r65.y = r66.x;
                r40.zw = saturate(abs(r26.xy) * r65.zw + r65.xy);
                r52.xy = r40.zw * r40.zw;
                r40.zw = r40.zw * float2(-2,-2) + float2(3,3);
                r40.zw = r52.xy * r40.zw;
                r26.w = r40.z * r40.w;
                ...
                r64.w = r65.y;
                r52.xyzw = saturate(r64.xyzw * abs(r26.yyxx));
                r52.xyzw = log2(r52.xyzw);
                r52.xyzw = r65.xxxx * r52.xyzw;
                r52.xyzw = exp2(r52.xyzw);
                r40.zw = r52.xy + r52.zw;
                r40.zw = log2(r40.zw);
                r40.zw = r66.xx * r40.zw;
                r40.zw = exp2(r40.zw);
                r31.w = r65.z * r40.z;
                r32.w = r65.w * r40.w + -1;
                r31.w = r65.w * r40.w + -r31.w;
              ...
              r52.y = samp0[]..swiz;
              r52.z = samp0[]..swiz;
                r29.w = dot(r66.yzw, r26.xyz);
                r26.x = dot(r52.xyz, r26.xyz);
                r52.x = frac(r29.w);
                r52.y = frac(r26.x);
                r26.x = (int)r26.w + -1;
                r52.z = (uint)r26.x;
                r61.xzw = gCookieArray.SampleLevel(samplerLinear_s, r52.xyz, 0).xyz;
              } else {
                r61.xzw = float3(1,1,1);
              }
            }
            r50.yz = r51.yz;
            r26.xyw = r50.xyz * r61.xzw;
            r29.w = cmp(0 < r63.x);
            if (r29.w != 0) {
              if (3 == 0) r40.z = 0; else if (3+27 < 32) {               r40.z = (uint)r51.w << (32-(3 + 27)); r40.z = (uint)r40.z >> (32-3);              } else r40.z = (uint)r51.w >> 27;
              if (4 == 0) r40.w = 0; else if (4+20 < 32) {               r40.w = (uint)r51.w << (32-(4 + 20)); r40.w = (uint)r40.w >> (32-4);              } else r40.w = (uint)r51.w >> 20;
              r29.w = cmp((int)r40.z != 1);
              if (r29.w != 0) {
                r29.w = abs(r25.y) * -0.200000003 + 0.400000006;
                r30.w = cmp(r25.y < 0);
                r29.w = r30.w ? -r29.w : r29.w;
                r27.xyz = r3.xyz * r29.www + v6.xyz;
                r59.xyz = r56.xyz;
                r29.w = dot(r59.xyzw, r27.xyzw);
                r30.w = dot(r62.xyzw, r27.xyzw);
                r31.w = cmp(r30.w >= r29.w);
                if (r31.w != 0) {
                // Known bad code for instruction (needs manual fix):
                                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r60.y, r20.w, l(144), t12.xxxx
                r60.y = samp0[]..swiz;
                  r54.w = r55.x;
                  r50.x = dot(r54.xyzw, r27.xyzw);
                  r56.xyz = r55.yzw;
                  r50.y = dot(r56.xyzw, r27.xyzw);
                  r27.xy = r50.xy / r30.ww;
                  r27.xy = saturate(r27.xy * float2(0.5,-0.5) + float2(0.5,0.5));
                  r27.xy = r27.xy * r60.zw + r60.xy;
                  r20.w = r29.w / r30.w;
                  r20.w = max(6.10351563e-05, r20.w);
                  r29.w = (int)r51.w & 0x0000ffff;
                  if (r15.w != 0) {
                    r50.z = (uint)r29.w;
                    r30.w = 0;
                    r31.w = 0;
                    while (true) {
                      ...
                      if (r32.w != 0) break;
                      r52.x = dot(icb[r31.w+0].xy, r10.xy);
                      r52.y = dot(icb[r31.w+0].yx, r10.xz);
                      r50.xy = r52.xy * r53.yy + r27.xy;
                      r32.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r50.xyz, r20.w).x;
                      r30.w = r32.w * 0.125 + r30.w;
                      r31.w = (int)r31.w + 1;
                    }
                  } else {
                    r27.z = (uint)r29.w;
                    r30.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r27.xyz, r20.w).x;
                  }
                  r20.w = r30.w * r30.w;
                  r63.y = r20.w * r30.w;
                } else {
              ...
              r56.z = samp0[]..swiz;
              r56.w = samp0[]..swiz;
                r27.y = abs(r25.y) * -0.200000003 + 0.400000006;
                r27.z = cmp(r25.y < 0);
                r27.y = r27.z ? -r27.y : r27.y;
                r28.xyz = r3.xyz * r27.yyy + v6.xyz;
                r50.x = dot(r50.xyzw, r28.xyzw);
                r50.y = dot(r52.xyzw, r28.xyzw);
                r27.y = dot(r53.xyzw, r28.xyzw);
                r27.z = dot(r54.xyzw, r28.xyzw);
                r28.x = cmp(r27.z < r27.y);
                r28.yz = r50.xy / r27.zz;
                r28.yz = r28.yz * float2(0.5,-0.5) + float2(0.5,0.5);
                r28.yz = r28.yz + r56.zw;
                r28.yz = r28.yz * r56.xy;
                r40.zw = r27.xx / r55.xz;
                r50.xy = float2(1,1) + -r40.zw;
                r50.xy = cmp(r28.yz >= r50.xy);
                r40.zw = cmp(r40.zw >= r28.yz);
                r40.zw = (int2)r40.zw | (int2)r50.xy;
                r29.w = (int)r40.w | (int)r40.z;
                r28.x = (int)r28.x | (int)r29.w;
                if (r28.x == 0) {
                // Known bad code for instruction (needs manual fix):
                ...
                r40.w = samp0[]..swiz;
                  ...
                  r50.xy = r28.yz * r55.xz + r55.yw;
                  r20.w = r40.w * r27.z;
                  r27.y = r40.z * r27.z + r27.y;
                  r20.w = r27.y / r20.w;
                  r20.w = max(6.10351563e-05, r20.w);
                  r27.y = r28.x ? 0.000000 : 0;
                  if (r15.w != 0) {
                    r28.z = (uint)r27.y;
                    r27.z = 0;
                    r29.w = 0;
                    while (true) {
                      ...
                      if (r31.w != 0) break;
                      r52.x = dot(icb[r29.w+0].xy, r29.xy);
                      r52.y = dot(icb[r29.w+0].yx, r29.xz);
                      r28.xy = r52.xy * r27.xx + r50.xy;
                      r28.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r28.xyz, r20.w).x;
                      r27.z = r28.x * 0.125 + r27.z;
                      r29.w = (int)r29.w + 1;
                    }
                  } else {
                    r50.z = (uint)r27.y;
                    r27.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r50.xyz, r20.w).x;
                  }
                  r20.w = r27.z * r27.z;
                  r20.w = r20.w * r27.z;
                } else {
              ...
              r27.x = cmp(0 < r20.w);
              if (r27.x != 0) {
                r27.x = 0.166666672 * r51.x;
                r27.y = -abs(r25.y) * r2.z + 1;
                r27.y = r27.y * r27.y;
                r27.y = -r27.y * 0.620000005 + 0.620000005;
                r27.y = r27.y + -abs(r25.y);
                r27.y = r27.y * 0.816496611 + abs(r25.y);
                r28.x = cmp(0 < r25.y);
                r25.y = saturate(r25.y);
                r50.xyz = r57.xyz * r25.xxx + r7.xyz;
                r25.x = dot(r50.xyz, r50.xyz);
                r25.x = rsqrt(r25.x);
                r50.xyz = r50.xyz * r25.xxx;
                r25.x = dot(r3.xyz, r50.xyz);
                r28.y = dot(r50.xyz, r7.xyz);
                r28.z = dot(r50.xyz, r5.xyz);
                r29.w = dot(r50.xyz, r6.xyz);
                r28.z = r28.z * r28.z;
                r28.z = r28.z / r2.x;
                r29.w = r29.w * r29.w;
                r29.w = r29.w / r2.y;
                r28.z = r29.w + r28.z;
                r25.x = abs(r25.x) * abs(r25.x) + r28.z;
                r28.z = r25.y * r11.y + r11.z;
                r25.x = r25.x * r25.x;
                r25.x = r25.x * r2.w;
                r25.x = r25.x * r28.z;
                r25.x = rcp(r25.x);
                r25.y = r25.y * r27.x;
                r25.x = r25.x * r25.y;
                r25.y = saturate(1 + -r28.y);
                r27.x = r25.y * r25.y;
                r27.x = r27.x * r27.x;
                r25.y = r27.x * r25.y;
                r25.y = r25.x * r25.y;
                r50.xyz = r28.xxx ? r27.yyy : 0;
                r27.x = r28.x ? 0 : r27.y;
                r51.xyz = r28.xxx ? r25.yyy : 0;
                r25.x = r28.x ? r25.x : 0;
                r25.y = dot(r26.xyw, float3(0.212599993,0.715200007,0.0722000003));
                r25.y = r25.y * r20.w;
                r27.y = cmp(r16.w < r25.y);
                if (r27.y != 0) {
                  r27.y = r22.z * r22.w;
                  r28.xyz = r27.yyy * r44.xyz;
                  r23.xyz = r28.xyz * r46.xyz + r23.xyz;
                  r41.xyz = r28.xyz * r49.xyz + r41.xyz;
                  r43.xyz = r28.xyz * r47.xyz + r43.xyz;
                  r42.xyz = r28.xyz * r48.xyz + r42.xyz;
                  r47.xyz = r25.xxx;
                  r16.w = r25.y;
                  r49.xyz = r27.xxx;
                  r44.xyz = r26.xyw;
                  ...
                  r26.xyw = r20.www * r26.xyw;
                  r23.xyz = r26.xyw * r50.zzz + r23.xyz;
                  r41.xyz = r26.xyw * r27.xxx + r41.xyz;
                  r43.xyz = r26.xyw * r25.xxx + r43.xyz;
                  r42.xyz = r26.xyw * r51.xyz + r42.xyz;
                }
              }
            }
          }
  ...
  r2.z = 0;
  r2.xy = float2(1,-1) * r35.yx;
  r5.xyz = r35.zxy * r2.yzx;
  r5.xyz = r35.yzx * r2.zxy + -r5.xyz;
  r6.xyz = viewProjectionMatrix._m10_m11_m13 * r13.yyy;
  r6.xyz = r13.xxx * viewProjectionMatrix._m00_m01_m03 + r6.xyz;
  r6.xyz = r13.zzz * viewProjectionMatrix._m20_m21_m23 + r6.xyz;
  r6.xyz = r6.xyz + r8.yzw;
  r10.z = rcp(r6.z);
  r6.xy = r10.zz * r6.xy;
  r10.xy = r6.xy * float2(0.5,-0.5) + float2(0.5,0.5);
  r6.xyw = r35.xyz * float3(2.4000001,2.4000001,2.4000001) + r13.xyz;
  r2.w = dot(v0.xy, float2(0.0671105608,0.00583714992));
  r2.w = frac(r2.w);
  r2.w = 52.9829178 * r2.w;
  r2.w = frac(r2.w);
  r5.w = 3.14159989 * r2.w;
  sincos(r5.w, r8.x, r9.x);
  r11.xyz = r8.xxx * r5.xyz;
  r11.xyz = r9.xxx * r2.xyz + r11.xyz;
  r11.xyz = r11.xyz * float3(0.119999997,0.119999997,0.119999997) + r6.xyw;
  ...
  r9.xy = float2(0.5,-0.5) * r11.xy;
  r11.z = rcp(r11.z);
  r11.xy = r9.xy * r11.zz + float2(0.5,0.5);
  r13.xyz = -r10.xyz;
  r11.xyz = r13.xyz + r11.xyz;
  r15.xyz = r2.www * float3(3.14159989,0.5,0.5) + float3(3.14159989,0.333333343,1);
  sincos(r15.x, r8.x, r9.x);
  r5.xyz = r8.xxx * r5.xyz;
  r2.xyz = r9.xxx * r2.xyz + r5.xyz;
  r2.xyz = r2.xyz * float3(0.119999997,0.119999997,0.119999997) + r6.xyw;
  r5.xyz = viewProjectionMatrix._m10_m11_m13 * r2.yyy;
  r5.xyz = r2.xxx * viewProjectionMatrix._m00_m01_m03 + r5.xyz;
  r2.xyz = r2.zzz * viewProjectionMatrix._m20_m21_m23 + r5.xyz;
  r2.xyz = r2.xyz + r8.yzw;
  r2.xy = float2(0.5,-0.5) * r2.xy;
  r5.z = rcp(r2.z);
  r5.xy = r2.xy * r5.zz + r13.xy;
  r13.w = 0.5;
  r2.xyz = r5.xyz + r13.wwz;
  r5.x = dot(renderTargetSize.zw, renderTargetSize.zw);
  r5.y = dot(r11.xy, r11.xy);
  r5.xy = sqrt(r5.xy);
  r5.y = rcp(r5.y);
  r5.x = r5.x * r5.y;
  r5.yz = float2(0.117647059,0.117647059) * r15.yz;
  r5.yz = r5.yz * r5.yz;
  x1[0].x = r5.y;
  r6.xyw = r11.xyz * r5.yyy + r10.xyz;
  r8.xy = cmp(r5.xx < r5.yz);
  ...
  x0[0].x = r6.x;
  x1[1].x = r5.z;
  r8.xzw = r2.xyz * r5.zzz + r10.xyz;
  r6.yw = renderTargetSize.xy * r8.xz;
  r13.xy = (int2)r6.yw;
  r13.zw = float2(0,0);
  r6.y = floatZSampler.Load(r13.xyz).x;
  ...
  x0[1].x = r6.w;
  r7.w = r6.x + r6.w;
  r7.w = cmp(r7.w != 0.000000);
  if (r7.w != 0) {
    r8.xy = r2.ww * float2(0.5,0.5) + float2(1.33333337,2);
    r8.xy = float2(0.117647059,0.117647059) * r8.xy;
    r8.xy = r8.xy * r8.xy + -r5.yz;
    r5.y = r6.x * r8.x + r5.y;
    x1[0].x = r5.y;
    r8.xzw = r11.xyz * r5.yyy + r10.xyz;
    r5.y = cmp(r5.x < r5.y);
    r8.xz = renderTargetSize.xy * r8.xz;
    r13.xy = (int2)r8.xz;
    r13.zw = float2(0,0);
    r7.w = floatZSampler.Load(r13.xyz).x;
    r8.x = cmp(r7.w >= 0.984375);
    r8.z = 1.01587307 * r7.w;
    r7.w = r7.w * 64 + -63;
    r7.w = r8.x ? r7.w : r8.z;
  ...
  if (r5.y == 0) {
    r5.yz = r2.ww * float2(0.5,0.5) + float2(2.33333325,3);
    ...
    r5.y = r6.x * r5.y + r5.w;
    x1[0].x = r5.y;
    r8.xyz = r11.xyz * r5.yyy + r10.xyz;
    r5.y = cmp(r5.x < r5.y);
    r6.yw = renderTargetSize.xy * r8.xy;
    r13.xy = (int2)r6.yw;
    r13.zw = float2(0,0);
    r5.w = floatZSampler.Load(r13.xyz).x;
    r6.y = cmp(r5.w >= 0.984375);
    r6.w = 1.01587307 * r5.w;
    r5.w = r5.w * 64 + -63;
    r5.w = r6.y ? r5.w : r6.w;
    r5.w = max(9.99999994e-09, r5.w);
    r5.w = rcp(r5.w);
  ...
  if (r5.y == 0) {
    r5.yz = r2.ww * float2(0.5,0.5) + float2(3.33333325,4);
    r5.yz = float2(0.117647059,0.117647059) * r5.yz;
    r5.w = x1[0].x;
    r6.x = x0[0].x;
    r5.y = r5.y * r5.y + -r5.w;
  ...
  if (r5.y == 0) {
    r5.yz = r2.ww * float2(0.5,0.5) + float2(4.33333349,5);
    r5.yz = float2(0.117647059,0.117647059) * r5.yz;
    r5.w = x1[0].x;
    r6.x = x0[0].x;
    r5.y = r5.y * r5.y + -r5.w;
  ...
  if (r5.y == 0) {
    r5.yz = r2.ww * float2(0.5,0.5) + float2(5.33333349,6);
    r5.yz = float2(0.117647059,0.117647059) * r5.yz;
    r5.w = x1[0].x;
    r6.x = x0[0].x;
    r5.y = r5.y * r5.y + -r5.w;
  ...
  if (r5.y == 0) {
    r5.yz = r2.ww * float2(0.5,0.5) + float2(6.33333349,7);
    r5.yz = float2(0.117647059,0.117647059) * r5.yz;
    r5.w = x1[0].x;
    r6.x = x0[0].x;
    r5.y = r5.y * r5.y + -r5.w;
  ...
  if (r5.y == 0) {
    r5.yz = r2.ww * float2(0.5,0.5) + float2(7.33333349,8);
    r5.yz = float2(0.117647059,0.117647059) * r5.yz;
    r2.w = x1[0].x;
    r5.w = x0[0].x;
    r5.y = r5.y * r5.y + -r2.w;
    r2.w = r5.w * r5.y + r2.w;
    r6.xyw = r11.xyz * r2.www + r10.xyz;
    r2.w = cmp(r5.x < r2.w);
    r6.xy = renderTargetSize.xy * r6.xy;
    r8.xy = (int2)r6.xy;
    r8.zw = float2(0,0);
    r5.y = floatZSampler.Load(r8.xyz).x;
    r6.x = cmp(r5.y >= 0.984375);
    r6.y = 1.01587307 * r5.y;
    r5.y = r5.y * 64 + -63;
    r5.y = r6.x ? r5.y : r6.y;
  ...
  r2.x = min(r19.w, r2.x);
  r2.x = r19.z * r2.x;
  r2.xyz = r2.xxx * r34.xyz;
  r5.xyz = r2.xyz * r36.xyz + r30.xyz;
  r6.xyz = r2.xyz * r37.xyz + r31.xyz;
  r8.xyz = r2.xyz * r38.xyz + r33.xyz;
  r2.xyz = r2.xyz * r39.xyz + r32.xyz;
  r2.w = numRefProbes + -numOverrideProbes;
  r5.w = (int)r2.w & -32;
  r6.w = (int)r2.w + (int)-r5.w;
  ...
  r9.x = r5.w;
  while (true) {
    r9.y = cmp((uint)r9.x >= numRefProbes);
    if (r9.y != 0) break;
    r10.z = (uint)r9.x >> 5;
    r11.xyz = (int3)r10.xyz + (int3)r20.xyz;
    r9.y = visibleProbes.Load(r11.xyzw).x;
    r10.z = cmp((int)r5.w == (int)r9.x);
    bitmask.w = ((~(-1 << r6.w)) << 0) & 0xffffffff;  r10.w = (((uint)0 << 0) & bitmask.w) | ((uint)r9.y & ~bitmask.w);
    r9.y = r10.z ? r10.w : r9.y;
    r10.z = cmp((int)r7.w == (int)r9.x);
    if (r8.w == 0) r10.w = 0; else if (r8.w+0 < 32) {     r10.w = (uint)r9.y << (32-(r8.w + 0)); r10.w = (uint)r10.w >> (32-r8.w);    } else r10.w = (uint)r9.y >> 0;
    r9.y = r10.z ? r10.w : r9.y;
    r10.z = (int)r9.x + numLights;
    r21.xyzw = r18.xyzw;
    r22.xyz = r19.yzw;
    r10.w = r9.y;
    while (true) {
      ...
      r24.y = samp0[]..swiz;
        ...
        r24.w = samp0[]..swiz;
          ...
          if (6 == 0) r14.x = 0; else if (6+25 < 32) {           r14.x = (uint)r24.w << (32-(6 + 25)); r14.x = (uint)r14.x >> (32-6);          } else r14.x = (uint)r24.w >> 25;
        // Known bad code for instruction (needs manual fix):
        ...
        r31.w = samp0[]..swiz;
          ...
          r13.x = r15.w * r14.y;
          r14.y = (int)r11.y & 1;
          r26.xy = r14.yy ? r13.xy : r13.zx;
          r13.x = r11.y;
          r27.xy = r26.xy;
          r14.y = 1;
          while (true) {
            r15.w = cmp((int)r14.y >= (int)r14.x);
            if (r15.w != 0) break;
            r15.w = (int)r13.w + (int)r14.y;
          // Known bad code for instruction (needs manual fix):
          ...
          r33.w = samp0[]..swiz;
            ...
            r27.x = r16.w * r15.w;
            r17.w = (uint)r13.x >> 2;
            if (1 == 0) r20.w = 0; else if (1+2 < 32) {             r20.w = (uint)r13.x << (32-(1 + 2)); r20.w = (uint)r20.w >> (32-1);            } else r20.w = (uint)r13.x >> 2;
            r23.w = (int)r17.w & 2;
            r25.w = max(r27.y, r27.x);
            r15.w = -r15.w * r16.w + 1;
            r15.w = r27.y * r15.w;
            r14.w = r23.w ? r15.w : r25.w;
            r27.xy = r20.ww ? r27.xy : r14.zw;
            r14.y = (int)r14.y + 1;
            r13.x = r17.w;
          }
          ...
          r37.x = samp0[]..swiz;
          r37.y = samp0[]..swiz;
            r22.z = r27.y * r11.z + r22.z;
            r11.x = r11.y * r24.z;
            r24.z = r32.z;
            r11.y = dot(r12.xyz, r24.xyz);
            r11.z = dot(r25.xyz, r24.xyz);
            r11.z = r11.z + -r32.w;
            r13.x = cmp(r11.z >= 0);
            r11.z = max(100, abs(r11.z));
            r11.z = r13.x ? r11.z : -r11.z;
            r11.y = max(1.00000001e-07, -r11.y);
            r11.y = r11.z / r11.y;
            r11.y = min(131072, abs(r11.y));
            r32.z = r33.z;
            r11.z = dot(r12.xyz, r32.xyz);
            r13.x = dot(r25.xyz, r32.xyz);
            r13.x = r13.x + -r33.w;
            r13.w = cmp(r13.x >= 0);
            r13.x = max(100, abs(r13.x));
            ...
            r11.y = min(r11.y, abs(r11.z));
            r37.zw = r36.zw;
            r11.z = dot(r12.zxy, r37.xzw);
            r13.x = dot(r25.zxy, r37.xzw);
            r13.x = r13.x + -r37.y;
            r13.w = cmp(r13.x >= 0);
            r13.x = max(100, abs(r13.x));
            r13.x = r13.w ? r13.x : -r13.x;
            ...
            r24.x = r29.w;
            r24.yz = r30.zw;
            r14.xyw = r24.xyz + r25.xyz;
            r14.xyw = r12.xyz * r11.yyy + r14.xyw;
            r11.z = dot(r14.xyw, r14.xyw);
            r11.z = sqrt(r11.z);
            r11.y = r11.y / r11.z;
            r11.y = r11.y + r11.y;
            r11.y = sqrt(r11.y);
            ...
            r23.y = r26.z;
            r23.z = r28.x;
            r32.x = dot(r14.xyw, r23.xyz);
            r24.xy = r26.xw;
            r24.z = r28.w;
            r32.y = dot(r14.xyw, r24.xyz);
            r28.x = r26.y;
            r32.z = dot(r14.xyw, r28.xyz);
            if (9 == 0) r11.z = 0; else if (9+16 < 32) {             r11.z = (uint)r24.w << (32-(9 + 16)); r11.z = (uint)r11.z >> (32-9);            } else r11.z = (uint)r24.w >> 16;
            r32.w = (uint)r11.z;
            r14.xyw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r32.xyzw, r11.y).xyz;
            ...
            r11.z = 1.26815999 * r11.y;
            r14.xyw = r14.xyw * r11.xxx;
            r11.x = dot(r14.xyw, float3(0.212599993,0.715200007,0.0722000003));
            r11.x = r11.y * 1.26815999 + r11.x;
            r11.x = r11.z / r11.x;
            r23.x = r21.w;
            r23.yz = r22.xy;
            r22.xyw = r14.ywx * r11.xxx + r23.yzx;
            r21.w = r22.w;
          }
        }
      }
  ...
  if (r7.w != 0) {
    ...
    r8.w = 0;
    while (true) {
      r10.w = cmp((uint)r8.w >= (uint)r2.w);
      if (r10.w != 0) break;
      r10.z = (uint)r8.w >> 5;
      r11.xyz = (int3)r10.xyz + (int3)r20.xyz;
      r10.z = visibleProbes.Load(r11.xyzw).x;
      r10.w = cmp((int)r5.w == (int)r8.w);
      ...
      while (true) {
        ...
        r24.y = samp0[]..swiz;
          ...
          r25.w = samp0[]..swiz;
            ...
            if (6 == 0) r20.w = 0; else if (6+25 < 32) {             r20.w = (uint)r25.w << (32-(6 + 25)); r20.w = (uint)r20.w >> (32-6);            } else r20.w = (uint)r25.w >> 25;
          // Known bad code for instruction (needs manual fix):
          ...
          r32.w = samp0[]..swiz;
            ...
            r33.w = samp0[]..swiz;
              ...
              r23.w = -r23.w * r26.w + 1;
              r23.w = r27.y * r23.w;
              r9.y = r28.x ? r23.w : r28.y;
              r27.xy = r27.ww ? r27.xy : r9.xy;
              r21.w = (int)r21.w + 1;
              r13.x = r27.z;
            }
            r9.y = saturate(r27.y + -r13.w);
            r13.x = r9.y * r24.y;
            r16.w = cmp(0 < r13.x);
            if (r16.w != 0) {
            // Known bad code for instruction (needs manual fix):
            ...
            r38.y = samp0[]..swiz;
              ...
              r33.z = r34.z;
              r15.w = dot(r12.xyz, r33.xyz);
              r16.w = dot(r26.xyz, r33.xyz);
              r16.w = r16.w + -r34.w;
              r20.w = cmp(r16.w >= 0);
              r16.w = max(100, abs(r16.w));
              r16.w = r20.w ? r16.w : -r16.w;
              r15.w = max(1.00000001e-07, -r15.w);
              r15.w = r16.w / r15.w;
              r13.x = min(abs(r15.w), r13.x);
              r34.z = r35.z;
              r15.w = dot(r12.xyz, r34.xyz);
              ...
              r24.xyz = r12.xyz * r13.xxx + r24.xyz;
              ...
              r33.w = (uint)r15.w;
              r24.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r33.xyzw, r13.x).xyz;
  ...
  r10.xyz = r18.xyz * r2.www;
  r11.xyz = r19.xyz * r2.www;
  r5.w = cmp(r19.w < 0.99000001);
  if (r5.w != 0) {
    r5.w = 1 + -r19.w;
    r5.w = sunConstants.globalProbeExposure * r5.w;
    ...
    r10.xyz = r18.xyz * r2.www + r3.xyz;
    r12.w = 0;
    r3.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r12.xyzw, 5).xyz;
    r11.xyz = r3.xyz * r3.www + r11.xyz;
  }
  r3.xyz = r10.xyz * r0.www + r5.xyz;
  r5.xyz = r10.xyz * r0.www + r6.xyz;
  r9.w = 0;
  r6.xy = float2(0.0078125,0.0078125) + r9.zw;
  r6.xy = gEnvBRDFGeneric.SampleLevel(samplerLinear_s, r6.xy, 0).xy;
  r9.xyz = r11.xyz * r0.www;
  r2.xyz = r9.xyz * r6.xxx + r2.xyz;
  r6.xyz = r9.xyz * r6.yyy + r8.xyz;
  r0.w = dot(r4.xyz, r7.xyz);
  r2.w = 1 + -abs(r0.w);
  r2.w = r2.w * r2.w;
  r2.w = r2.w * 0.600000024 + 0.400000006;
  r2.w = min(1, r2.w);
  r4.xyz = transColorTint.xyz * r2.www;
  r7.xyz = saturate(r0.xyz * float3(0.0199999996,0.0199999996,0.0199999996) + float3(0.0399999991,0.0399999991,0.0399999991));
  r8.xyz = specColorTint.xyz * r7.xyz;
  r4.xyz = r4.xyz * r0.xyz;
  r4.xyz = r5.xyz * r4.xyz;
  r0.xyz = r3.xyz * r0.xyz + r4.xyz;
  r3.xyz = -r7.xyz * specColorTint.xyz + float3(1,1,1);
