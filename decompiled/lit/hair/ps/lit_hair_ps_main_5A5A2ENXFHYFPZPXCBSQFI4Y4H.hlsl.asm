...
if_nz r2.y
  ...
  movc r0.xyz, r2.zzzz, r7.xywx, r8.xyzx
endif 
...
movc r2.yzw, v6.xxxx, r4.xxyz, -r4.xxyz
dp3 r1.x, r2.yzwy, r2.yzwy
rsq r1.x, r1.x
mad r2.yzw, r2.yyzw, r1.xxxx, -r6.xxyz
...
max r2.xy, r2.xyxx, l(0.000000, 0.00000001, 0.000000, 0.000000)
rcp r2.y, r2.y
dp3 r2.z, -v5.xyzx, -v5.xyzx
rsq r2.z, r2.z
mul r8.xyz, r2.zzzz, -v5.xyzx
utof r7.zw, r1.yyyx
...
dp3 r1.z, r6.xyzx, cb2[17].xyzx
ge r2.x, l(0.000000), |r1.z|
if_nz r2.x
  mov r13.y, l(0)
endif 
if_z r2.x
  mul r15.xyz, v5.yyyy, cb2[29].xyzx
  mad r15.xyz, v5.xxxx, cb2[28].xyzx, r15.xyzx
  mad r15.xyz, v5.zzzz, cb2[30].xyzx, r15.xyzx
...
if_nz r2.x
  ...
  mad r8.w, |r1.z|, l(-0.200000), l(0.400000)
  lt r10.w, r1.z, l(0.000000)
  movc r8.w, r10.w, -r8.w, r8.w
  mad r19.xyz, r6.xyzx, r8.wwww, v5.xyzx
...
if_nz r2.x
  ...
  if_nz r2.x
    ...
    mad r7.w, -|r1.z|, r7.w, l(1.000000)
    mul r7.w, r7.w, r7.w
    mad r7.w, -r7.w, l(0.620000), l(0.620000)
    add r7.w, -|r1.z|, r7.w
    mad r7.w, r4.w, r7.w, |r1.z|
    lt r8.w, l(0.000000), r1.z
    mov_sat r1.z, r1.z
    mad r16.xyz, -v5.xyzx, r2.zzzz, cb2[17].xyzx
    dp3 r2.z, r16.xyzx, r16.xyzx
    rsq r2.z, r2.z
    mul r16.xyz, r2.zzzz, r16.xyzx
    dp3 r2.z, r6.xyzx, r16.xyzx
    ...
    mad r2.z, |r2.z|, |r2.z|, r13.w
    mad r13.w, r1.z, r5.w, r7.z
    mul r2.z, r2.z, r2.z
    mul r2.z, r13.z, r2.z
    mul r2.z, r13.w, r2.z
    rcp r2.z, r2.z
    ...
    and r13.zw, r2.xxxx, r8.wwww
    and r17.xyz, r1.zzzz, r8.wwww
        ...
        if_nz r30.w
          ...
          if_nz r28.w
            ...
            if_nz r28.w
              ...
              mad r61.xyz, r6.xyzx, r28.wwww, v5.xyzx
            ...
            if_nz r60.w
              ...
              mad r24.xyz, r6.xyzx, r31.wwww, v5.xyzx
            ...
            if_nz r24.y
              ...
              mad r19.w, -|r29.w|, r1.x, l(1.000000)
        ...
        if_nz r24.x
          ...
          if_nz r24.x
            ...
            if_nz r24.x
              ...
              mad r26.xyz, r6.xyzx, r24.xxxx, v5.xyzx
            ...
            if_nz r24.y
              ...
              mad r27.xyz, r6.xyzx, r24.yyyy, v5.xyzx
            ...
            if_nz r24.x
              ...
              mad r24.y, -|r19.w|, r1.x, l(1.000000)
...
mul r2.xyz, r1.yzxy, r34.zxyz
mad r2.xyz, r34.yzxy, r1.zxyz, -r2.xyzx
mul r3.xyz, r14.yyyy, cb1[9].xywx
mad r3.xyz, r14.xxxx, cb1[8].xywx, r3.xyzx
mad r3.xyz, r14.zzzz, cb1[10].xywx, r3.xyzx
add r3.xyz, r11.yzwy, r3.xyzx
rcp r5.z, r3.z
mul r3.xy, r3.xyxx, r5.zzzz
mad r5.xy, r3.xyxx, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
mad r3.xyw, r34.xyxz, l(2.400000, 2.400000, 0.000000, 2.400000), r14.xyxz
...
mul r9.xyz, r2.xyzx, r9.xxxx
mad r9.xyz, r10.xxxx, r1.xyzx, r9.xyzx
mad r9.xyz, r9.xyzx, l(0.120000, 0.120000, 0.120000, 0.000000), r3.xywx
mul r10.xyz, r9.yyyy, cb1[9].xywx
mad r9.xyw, r9.xxxx, cb1[8].xyxw, r10.xyxz
mad r9.xyz, r9.zzzz, cb1[10].xywx, r9.xywx
add r9.xyz, r11.yzwy, r9.xyzx
mul r7.zw, r9.xxxy, l(0.000000, 0.000000, 0.500000, -0.500000)
rcp r9.z, r9.z
mad r9.xy, r7.zwzz, r9.zzzz, l(0.500000, 0.500000, 0.000000, 0.000000)
mov r10.xyz, -r5.xyzx
add r9.xyz, r9.xyzx, r10.xyzx
add r4.w, r4.w, l(3.141600)
sincos r11.x, r13.x, r4.w
mul r2.xyz, r2.xyzx, r11.xxxx
mad r1.xyz, r13.xxxx, r1.xyzx, r2.xyzx
mad r1.xyz, r1.xyzx, l(0.120000, 0.120000, 0.120000, 0.000000), r3.xywx
mul r2.xyz, r1.yyyy, cb1[9].xywx
mad r2.xyz, r1.xxxx, cb1[8].xywx, r2.xyzx
mad r1.xyz, r1.zzzz, cb1[10].xywx, r2.xyzx
add r1.xyz, r11.yzwy, r1.xyzx
mul r1.xy, r1.xyxx, l(0.500000, -0.500000, 0.000000, 0.000000)
rcp r2.z, r1.z
mad r2.xy, r1.xyxx, r2.zzzz, r10.xyxx
mov r10.w, l(0.500000)
add r1.xyz, r10.wwzw, r2.xyzx
...
mov x1[0].x, r2.y
mad r3.xyw, r9.xyxz, r2.yyyy, r5.xyxz
lt r7.zw, r2.xxxx, r2.yyyz
...
rcp r3.x, r3.x
mov x2[0].x, r3.x
add r3.y, r3.x, l(0.042000)
mul r3.y, r3.y, r3.w
lt r3.y, l(1.000000), r3.y
and r3.y, r3.y, l(0x3f800000)
movc r3.y, r7.z, r3.y, l(1.000000)
mov x0[0].x, r3.y
mov x1[1].x, r2.z
mad r10.xyz, r1.xyzx, r2.zzzz, r5.xyzx
...
if_nz r5.w
  ...
  mad r2.y, r3.y, r7.z, r2.y
  mov x1[0].x, r2.y
  mad r10.xyz, r9.xyzx, r2.yyyy, r5.xyzx
  lt r2.y, r2.x, r2.y
  mul r10.xy, r10.xyxx, cb1[44].xyxx
  ftoi r11.xy, r10.xyxx
  mov r11.zw, l(0,0,0,0)
  ld_indexable(texture2d)(float,float,float,float) r5.w, r11.xyzw, t0.yzwx
  ge r7.z, r5.w, l(0.984375)
  mul r8.w, r5.w, l(1.01587307)
  mad r5.w, r5.w, l(64.000000), l(-63.000000)
  movc r5.w, r7.z, r5.w, r8.w
  max r5.w, r5.w, l(0.00000001)
  rcp r5.w, r5.w
  movc r3.x, r2.y, r5.w, r3.x
  mov x2[0].x, r3.x
  add r3.x, r5.w, l(0.042000)
  mul r3.x, r3.x, r10.z
  ...
  mov x0[0].x, r2.y
  mad r2.z, r4.w, r7.w, r2.z
  mov x1[1].x, r2.z
  mad r10.xyz, r1.xyzx, r2.zzzz, r5.xyzx
  lt r2.z, r2.x, r2.z
  mul r3.xy, r10.xyxx, cb1[44].xyxx
  ftoi r11.xy, r3.xyxx
  mov r11.zw, l(0,0,0,0)
  ...
  mad r3.x, r3.x, l(64.000000), l(-63.000000)
  movc r3.x, r3.y, r3.x, r5.w
  max r3.x, r3.x, l(0.00000001)
  rcp r3.x, r3.x
  movc r3.y, r2.z, r3.x, r3.w
  mov x2[1].x, r3.y
...
if_z r2.y
  ...
  mov r3.x, x1[0].x
  mov r3.y, x0[0].x
  mad r2.y, r2.y, r2.y, -r3.x
  mad r2.y, r3.y, r2.y, r3.x
  mov x1[0].x, r2.y
  mad r10.xyz, r9.xyzx, r2.yyyy, r5.xyzx
  lt r2.y, r2.x, r2.y
  mul r3.xw, r10.xxxy, cb1[44].xxxy
  ftoi r11.xy, r3.xwxx
  mov r11.zw, l(0,0,0,0)
  ld_indexable(texture2d)(float,float,float,float) r3.x, r11.xyzw, t0.xyzw
...
if_z r2.y
  ...
  mad r9.xyz, r9.xyzx, r2.yyyy, r5.xyzx
  lt r2.y, r2.x, r2.y
  mul r3.yw, r9.xxxy, cb1[44].xxxy
  ftoi r10.xy, r3.ywyy
  mov r10.zw, l(0,0,0,0)
  ld_indexable(texture2d)(float,float,float,float) r2.w, r10.xyzw, t0.yzwx
  ge r3.y, r2.w, l(0.984375)
  mul r3.w, r2.w, l(1.01587307)
  mad r2.w, r2.w, l(64.000000), l(-63.000000)
  movc r2.w, r3.y, r2.w, r3.w
  max r2.w, r2.w, l(0.00000001)
  rcp r2.w, r2.w
  mov r3.y, x2[0].x
  movc r3.y, r2.y, r2.w, r3.y
  mov x2[0].x, r3.y
  ...
  ftoi r5.xy, r1.xyxx
  mov r5.zw, l(0,0,0,0)
  ld_indexable(texture2d)(float,float,float,float) r1.x, r5.xyzw, t0.xyzw
...
mad r2.xyz, r1.xyzx, r35.xyzx, r29.xyzx
mad r3.xyz, r1.xyzx, r36.xyzx, r30.xyzx
mad r5.xyz, r1.xyzx, r37.xyzx, r32.xyzx
mad r1.xyz, r1.xyzx, r38.xyzx, r31.xyzx
mad r1.w, -cb1[62].w, r1.w, l(1.000000)
mul r2.w, r1.w, l(5.000000)
mad r3.w, r1.w, l(5.000000), l(-2.500000)
mul_sat r3.w, r3.w, l(0.400000)
mul r3.w, r3.w, l(100.000000)
mad r7.zw, -r1.wwww, l(0.000000, 0.000000, 10.000000, 5.000000), l(0.000000, 0.000000, 6.857410, 7.085000)
exp r4.w, r7.z
mul r4.w, r4.w, r7.x
...
loop 
  ...
  dp3 r28.x, r6.xyzx, r20.xyzx
  dp3 r28.y, r6.xyzx, r29.xyzx
  dp3 r28.z, r6.xyzx, r22.xyzx
    ...
    if_nz r14.z
      ...
      if_nz r8.w
        ...
        loop 
          ...
          movc r28.xy, r19.wwww, r28.xyxx, r16.xyxx
...
if_z r5.w
        ...
        if_nz r14.z
          ...
          if_nz r13.w
            ...
            if_nz r14.y
              ...
              sqrt r11.w, r11.w
              mad r11.w, r1.w, l(5.000000), r11.w
  ...
  rcp r1.w, r1.w
  mov_sat r22.w, r22.w
  mul r17.xyz, r1.wwww, r21.xyzx
  mul r18.xyz, r1.wwww, r22.xyzx
  lt r3.w, r22.w, l(0.990000)
  if_nz r3.w
    add r3.w, -r22.w, l(1.000000)
    mul r4.w, r3.w, cb2[19].x
    ...
    mad r17.xyz, r21.xyzx, r1.wwww, r6.xyzx
    mov r12.w, l(0)
    sample_l_indexable(texturecubearray)(float,float,float,float) r6.xyz, r12.xyzw, t8.xyzw, s2, r2.w
    mad r1.w, cb2[19].x, r3.w, -r4.w
    mad r1.w, r7.y, r1.w, r4.w
    mad r18.xyz, r6.xyzx, r1.wwww, r18.xyzx
  endif 
else 
  mov r18.x, r17.w
endif 
mad r2.xyz, r17.xyzx, r0.wwww, r2.xyzx
mad r3.xyz, r17.xyzx, r0.wwww, r3.xyzx
...
mad r1.xyz, r7.xyzx, r6.xxxx, r1.xyzx
