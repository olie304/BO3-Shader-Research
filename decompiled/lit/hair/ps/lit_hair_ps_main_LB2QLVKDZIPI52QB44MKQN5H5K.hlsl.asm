...
mad_sat r7.xyz, r0.xyzx, l(0.020000, 0.020000, 0.020000, 0.000000), l(0.040000, 0.040000, 0.040000, 0.000000)
mul r8.xyz, r7.xyzx, cb0[11].xyzx
mul r4.xyz, r0.xyzx, r4.xyzx
mul r4.xyz, r4.xyzx, r5.xyzx
mad r0.xyz, r3.xyzx, r0.xyzx, r4.xyzx
mad r3.xyz, -r7.xyzx, cb0[11].xyzx, l(1.000000, 1.000000, 1.000000, 0.000000)
...
if_nz cb0[12].w
  ...
  and r2.x, r2.y, r2.x
  mul r2.yw, cb0[13].yyyz, l(0.000000, 0.01745329, 0.000000, 0.01745329)
...
ret 
// Approximately 2369 instruction slots used
