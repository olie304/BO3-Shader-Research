...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:36:48 2021
//
//
// Buffer Definitions: 
//
...
if_nz r2.x
  ftoi r2.x, cb1[64].w
  lod r2.y, v1.yzyy, t21.y, s1
  lod r2.z, v1.yzyy, t21.x, s1
  lt r2.y, r2.y, r2.z
  ...
  movc r3.xyz, r3.zzzz, l(0,1.000000,0,0), r0.xyzx
  movc r0.xyz, r2.yyyy, r2.xzwx, r3.xyzx
endif 
...
add r1.x, -r1.z, r1.w
mad r2.y, cb1[62].w, r1.x, r1.z
add r1.x, -r1.y, cb1[63].x
mad r1.x, cb1[63].w, r1.x, r1.y
...
loop 
  ...
  add r30.xyz, -r16.yzwy, v5.xyzx
  dp3 r11.z, r30.xyzx, r30.xyzx
  sqrt r11.z, r11.z
  ge r11.z, cb2[54].y, r11.z
  and r12.w, r23.y, l(0x0000ffff)
  ...
  dp3 r13.z, r31.xyzx, r30.xyzx
  add_sat r13.z, r31.w, r13.z
  dp3 r13.w, r32.xyzx, r30.xyzx
  add_sat r13.w, r32.w, r13.w
  mul r13.z, r13.w, r13.z
  dp3 r13.w, r33.xyzx, r30.xyzx
  add_sat r13.w, r33.w, r13.w
  mul r13.z, r13.w, r13.z
  dp3 r13.w, r34.xyzx, r30.xyzx
  add_sat r13.w, r34.w, r13.w
  mul r13.z, r13.w, r13.z
  dp3 r13.w, r35.xyzx, r30.xyzx
  add_sat r13.w, r35.w, r13.w
  mul r13.z, r13.w, r13.z
  dp3 r13.w, r36.xyzx, r30.xyzx
  add_sat r13.w, r36.w, r13.w
  mul r12.x, r13.w, r13.z
  and r13.z, r11.x, l(1)
  movc r13.zw, r13.zzzz, r12.xxxy, r12.zzzx
  mov r31.xy, r23.zwzz
  mov r31.z, r24.z
  dp3 r12.x, r8.xyzx, r31.xyzx
  dp3 r16.w, r30.xyzx, r31.xyzx
  ...
  div r12.x, r16.w, r12.x
  min r12.x, |r12.x|, l(131072.000000)
  mov r24.z, r25.z
  dp3 r16.w, r8.xyzx, r24.xyzx
  dp3 r19.w, r30.xyzx, r24.xyzx
  add r19.w, -r25.w, r19.w
  ge r23.z, r19.w, l(0.000000)
  max r19.w, r4.w, |r19.w|
  movc r19.w, r23.z, r19.w, -r19.w
  max r16.w, -r16.w, l(0.00000010)
  div r16.w, r19.w, r16.w
  min r12.x, r12.x, |r16.w|
  mov r25.z, r26.z
  dp3 r16.w, r8.xyzx, r25.xyzx
  dp3 r19.w, r30.xyzx, r25.xyzx
  ...
  min r12.x, r12.x, |r16.w|
  mov r27.z, r28.x
  dp3 r16.w, r8.xyzx, r27.xyzx
  dp3 r19.w, r30.xyzx, r27.xyzx
  add r19.w, -r28.y, r19.w
  ge r23.z, r19.w, l(0.000000)
  max r19.w, r4.w, |r19.w|
  movc r19.w, r23.z, r19.w, -r19.w
  max r16.w, -r16.w, l(0.00000010)
  ...
  min r12.x, r12.x, |r16.w|
  mov r29.zw, r28.zzzw
  dp3 r16.w, r8.zxyz, r29.xzwx
  dp3 r19.w, r30.zxyz, r29.xzwx
  add r19.w, -r29.y, r19.w
  ge r23.z, r19.w, l(0.000000)
  max r19.w, r4.w, |r19.w|
  movc r19.w, r23.z, r19.w, -r19.w
  max r16.w, -r16.w, l(0.00000010)
  ...
  mov r24.x, r20.w
  mov r24.yz, r21.zzwz
  add r24.xyz, r30.xyzx, r24.xyzx
  mad r24.xyz, r8.xyzx, r12.xxxx, r24.xyzx
  dp3 r16.w, r24.xyzx, r24.xyzx
  sqrt r16.w, r16.w
  div r12.x, r12.x, r16.w
  add r12.x, r12.x, r12.x
  sqrt r12.x, r12.x
  mad r12.x, r2.w, l(5.000000), r12.x
  ...
  mov r18.x, r17.y
  dp3 r25.z, r24.xyzx, r18.xyzx
  ubfe r17.xy, l(6, 9, 0, 0), l(25, 16, 0, 0), r23.yyyy
  utof r25.w, r17.y
  sample_l_indexable(texturecubearray)(float,float,float,float) r17.yzw, r25.xyzw, t8.wxyz, s2, r12.x
  and r23.yzw, r17.yyzw, l(0, 0x7fffffff, 0x7fffffff, 0x7fffffff)
  ieq r23.yzw, r23.yyzw, l(0, 0x7f800000, 0x7f800000, 0x7f800000)
  or r12.x, r23.z, r23.y
  or r12.x, r23.w, r12.x
  movc r17.yzw, r12.xxxx, l(0,1.000000,1.000000,0), r17.yyzw
  dp3 r24.x, r30.xyzx, r16.xyzx
  dp3 r24.y, r30.xyzx, r26.xyzx
  dp3 r24.z, r30.xyzx, r18.xyzx
  mad_sat r20.xyz, r24.xyzx, r20.xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
  mov r21.z, r22.x
  mad r20.xyz, r20.xyzx, r21.xyzx, r22.yzwy
  dp3 r25.x, r6.xyzx, r16.xyzx
  dp3 r25.y, r6.xyzx, r26.xyzx
  dp3 r25.z, r6.xyzx, r18.xyzx
  sample_l_indexable(texture3d)(float,float,float,float) r16.xyz, r20.xyzx, t17.xyzw, s4, l(0.000000)
  add r18.xyz, r20.xyzx, l(0.000000, 0.000000, 0.500000, 0.000000)
  sample_l_indexable(texture3d)(float,float,float,float) r21.xyz, r18.xyzx, t17.xyzw, s4, l(0.000000)
  sample_l_indexable(texture3d)(float,float,float,float) r22.xyz, r20.xyzx, t18.xyzw, s4, l(0.000000)
  sample_l_indexable(texture3d)(float,float,float,float) r23.yzw, r18.xyzx, t18.wxyz, s4, l(0.000000)
  ...
  add r24.xyz, r22.xyzx, r23.yzwy
  add r24.xyz, r20.xyzx, r24.xyzx
  add r24.xyz, r18.xyzx, r24.xyzx
  mul r24.xyz, r7.yyyy, r24.xyzx
  add r16.xyz, r16.xyzx, r21.xyzx
  add r20.xyz, r20.xyzx, r16.xyzx
  add r18.xyz, r18.xyzx, r20.xyzx
  mul r18.xyz, r7.zzzz, r18.xyzx
  add r16.xyz, r22.xyzx, r16.xyzx
  add r16.xyz, r23.yzwy, r16.xyzx
  mul r16.xyz, r7.wwww, r16.xyzx
  mul r18.xyz, r18.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000)
  mad r18.xyz, r24.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000), r18.xyzx
  mad r16.xyz, r16.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000), r18.xyzx
  sample_l_indexable(texturecubearray)(float,float,float,float) r18.xyz, r25.xyzw, t8.xyzw, s2, l(6.000000)
  and r20.xyz, r18.xyzx, l(0x7fffffff, 0x7fffffff, 0x7fffffff, 0)
  ieq r20.xyz, r20.xyzx, l(0x7f800000, 0x7f800000, 0x7f800000, 0)
  or r12.x, r20.y, r20.x
  or r12.x, r20.z, r12.x
  movc r18.xyz, r12.xxxx, l(1.000000,1.000000,0,0), r18.xyzx
  mov r20.xyzw, r14.xyzw
  mov r21.xyz, r15.yzwy
  mov r12.x, r9.w
  mov r16.w, r10.z
  loop 
    breakc_z r16.w
    ...
    if_nz r19.w
      ...
      if_nz r11.z
        ...
        loop 
          ...
          dp3 r21.w, r24.xyzx, r30.xyzx
          add_sat r21.w, r24.w, r21.w
          mul r21.w, r21.w, r22.x
          dp3 r22.z, r25.xyzx, r30.xyzx
          add_sat r22.z, r25.w, r22.z
          mul r21.w, r21.w, r22.z
          dp3 r22.z, r26.xyzx, r30.xyzx
          add_sat r22.z, r26.w, r22.z
          mul r21.w, r21.w, r22.z
          dp3 r22.z, r27.xyzx, r30.xyzx
          add_sat r22.z, r27.w, r22.z
          mul r21.w, r21.w, r22.z
          dp3 r22.z, r28.xyzx, r30.xyzx
          add_sat r22.z, r28.w, r22.z
          mul r21.w, r21.w, r22.z
          dp3 r22.z, r29.xyzx, r30.xyzx
          add_sat r22.z, r29.w, r22.z
          mul r22.x, r21.w, r22.z
          ushr r22.w, r18.w, l(2)
          ubfe r23.y, l(1), l(2), r18.w
          and r23.z, r22.w, l(2)
          max r23.w, r22.x, r22.y
          mad r21.w, -r21.w, r22.z, l(1.000000)
          mul r21.w, r21.w, r22.y
          movc r13.y, r23.z, r21.w, r23.w
          movc r22.xy, r23.yyyy, r22.xyxx, r13.xyxx
          iadd r19.w, r19.w, l(1)
          mov r18.w, r22.w
        endloop 
        mov_sat r22.y, r22.y
        mul r13.y, r11.y, r22.y
        lt r18.w, l(0.000000), r13.y
        if_nz r18.w
          mad r24.z, r22.y, r11.y, r21.z
          mul r13.y, r23.x, r13.y
          mul r22.xzw, r13.yyyy, r16.xxyz
          mul r23.yzw, r18.xxyz, r22.xxzw
          dp3 r18.w, r23.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
          mad r25.xyz, r22.xzwx, r18.xyzx, r20.xyzx
          mul r19.w, r7.x, r18.w
          mul r22.xzw, r13.yyyy, r17.yyzw
          dp3 r13.y, r22.xzwx, l(0.212600, 0.715200, 0.072200, 0.000000)
          mad r13.y, r7.x, r18.w, r13.y
          div r13.y, r19.w, r13.y
          mov r26.x, r20.w
          mov r26.yz, r21.xxyx
          mad r24.xyw, r22.zwzx, r13.yyyy, r26.yzyx
          mov r25.w, r24.w
        else 
...
if_z r9.w
  ...
  loop 
    ...
    ieq r12.x, r10.x, r11.w
    bfi r12.y, r10.y, l(0), l(0), r11.z
    movc r11.z, r12.x, r12.y, r11.z
    ieq r12.x, r10.z, r11.w
      ...
      if_nz r16.z
        ...
        if_nz r13.w
          ...
          loop 
            ...
            movc r16.y, r26.w, r24.w, r27.x
            movc r26.xy, r26.zzzz, r26.xyxx, r16.xyxx
            iadd r22.w, r22.w, l(1)
            mov r13.x, r25.w
          endloop 
          mov_sat r26.y, r26.y
          mul r13.x, r16.w, r26.y
          ...
          if_nz r13.w
            ...
            mov r23.x, r28.w
            mov r23.yz, r29.zzwz
            add r16.yzw, r24.xxyz, r23.xxyz
            mad r16.yzw, r8.xxyz, r13.xxxx, r16.yyzw
            ...
            mov r22.y, r25.z
            mov r22.z, r27.x
            dp3 r31.x, r16.yzwy, r22.xyzx
            mov r23.xy, r25.xwxx
            mov r23.z, r27.w
            dp3 r31.y, r16.yzwy, r23.xyzx
            mov r27.x, r25.y
            dp3 r31.z, r16.yzwy, r27.xyzx
            ubfe r13.w, l(9), l(16), r23.w
            utof r31.w, r13.w
            sample_l_indexable(texturecubearray)(float,float,float,float) r16.yzw, r31.xyzw, t8.wxyz, s2, r13.x
            and r25.xyz, r16.yzwy, l(0x7fffffff, 0x7fffffff, 0x7fffffff, 0)
            ieq r25.xyz, r25.xyzx, l(0x7f800000, 0x7f800000, 0x7f800000, 0)
            or r13.x, r25.y, r25.x
            or r13.x, r25.z, r13.x
            movc r16.yzw, r13.xxxx, l(0,1.000000,1.000000,0), r16.yyzw
            ...
            mul r16.yzw, r12.zzzz, r16.yyzw
            dp3 r12.z, r16.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
            mad r12.z, r7.x, r13.x, r12.z
            div r12.z, r13.w, r12.z
            mov r22.x, r20.w
            mov r22.yz, r21.xxyx
            mad r21.xyw, r16.zwzy, r12.zzzz, r22.yzyx
            mov r20.w, r21.w
          endif 
        endif 
      endif 
  ...
  if_nz r10.z
    ...
    mov r10.w, l(0)
    loop 
      uge r11.w, r10.w, r9.w
      breakc_nz r11.w
      ushr r11.z, r10.w, l(5)
      iadd r12.xyz, r11.xyzx, r19.xyzx
      ld_indexable(texture2darray)(uint,uint,uint,uint) r11.z, r12.xyzw, t7.yzxw
      ieq r11.w, r10.x, r10.w
      ubfe r12.x, r10.y, l(0), r11.z
      ...
      loop 
        ...
        and r19.w, r15.w, r16.w
        if_nz r19.w
          xor r15.w, r15.w, r16.w
          iadd r16.w, r11.w, r16.z
          ...
          if_nz r16.w
            ...
            if_nz r16.w
              ...
              mul r13.x, r25.z, r16.y
              mov r25.z, r33.z
              dp3 r16.y, r8.xyzx, r25.xyzx
              dp3 r16.z, r26.xyzx, r25.xyzx
              ...
              mad r24.xyz, r8.xyzx, r16.yyyy, r24.xyzx
              dp3 r16.z, r24.xyzx, r24.xyzx
              sqrt r16.z, r16.z
              ...
              ubfe r16.z, l(9), l(16), r25.w
              utof r33.w, r16.z
              sample_l_indexable(texturecubearray)(float,float,float,float) r16.yzw, r33.xyzw, t8.wxyz, s2, r16.y
              and r24.xyz, r16.yzwy, l(0x7fffffff, 0x7fffffff, 0x7fffffff, 0)
              ieq r24.xyz, r24.xyzx, l(0x7f800000, 0x7f800000, 0x7f800000, 0)
              or r19.w, r24.y, r24.x
              or r19.w, r24.z, r19.w
              movc r16.yzw, r19.wwww, l(0,1.000000,1.000000,0), r16.yyzw
              dp3 r24.x, r26.xyzx, r23.xyzx
              dp3 r24.y, r26.xyzx, r25.xyzx
              dp3 r24.z, r26.xyzx, r29.xyzx
              mad_sat r24.xyz, r24.xyzx, r30.xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
              mov r31.z, r32.x
              mad r24.xyz, r24.xyzx, r31.xyzx, r32.yzwy
              dp3 r33.x, r6.xyzx, r23.xyzx
              dp3 r33.y, r6.xyzx, r25.xyzx
              dp3 r33.z, r6.xyzx, r29.xyzx
              sample_l_indexable(texture3d)(float,float,float,float) r23.xyz, r24.xyzx, t17.xyzw, s4, l(0.000000)
              add r25.xyz, r24.xyzx, l(0.000000, 0.000000, 0.500000, 0.000000)
              sample_l_indexable(texture3d)(float,float,float,float) r26.xyz, r25.xyzx, t17.xyzw, s4, l(0.000000)
              sample_l_indexable(texture3d)(float,float,float,float) r27.xzw, r24.xyzx, t18.xwyz, s4, l(0.000000)
              sample_l_indexable(texture3d)(float,float,float,float) r28.xyz, r25.xyzx, t18.xyzw, s4, l(0.000000)
              sample_l_indexable(texture3d)(float,float,float,float) r24.xyz, r24.xyzx, t19.xyzw, s4, l(0.000000)
              sample_l_indexable(texture3d)(float,float,float,float) r25.xyz, r25.xyzx, t19.xyzw, s4, l(0.000000)
              add r29.xyz, r27.xzwx, r28.xyzx
              add r29.xyz, r24.xyzx, r29.xyzx
              add r29.xyz, r25.xyzx, r29.xyzx
              mul r29.xyz, r7.yyyy, r29.xyzx
              add r23.xyz, r23.xyzx, r26.xyzx
              add r24.xyz, r24.xyzx, r23.xyzx
              add r24.xyz, r25.xyzx, r24.xyzx
              mul r24.xyz, r7.zzzz, r24.xyzx
              add r23.xyz, r27.xzwx, r23.xyzx
              add r23.xyz, r28.xyzx, r23.xyzx
              mul r23.xyz, r7.wwww, r23.xyzx
              mul r24.xyz, r24.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000)
              mad r24.xyz, r29.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000), r24.xyzx
              mad r23.xyz, r23.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000), r24.xyzx
              ...
              or r19.w, r25.z, r19.w
              movc r24.xyz, r19.wwww, l(1.000000,1.000000,0,0), r24.xyzx
              ...
              mul r21.w, r7.x, r19.w
              mul r16.yzw, r13.xxxx, r16.yyzw
              dp3 r13.x, r16.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
              mad r13.x, r7.x, r19.w, r13.x
              div r13.x, r21.w, r13.x
              mad r22.xyz, r16.yzwy, r13.xxxx, r22.xyzx
            endif 
          endif 
        endif 
      endloop 
  ...
  if_nz r4.w
    ...
    add r12.xyz, r10.xyzx, l(0.000000, 0.000000, 0.500000, 0.000000)
    sample_l_indexable(texture3d)(float,float,float,float) r13.xyz, r12.xyzx, t17.xyzw, s4, l(0.000000)
    sample_l_indexable(texture3d)(float,float,float,float) r16.xyz, r10.xyzx, t18.xyzw, s4, l(0.000000)
    sample_l_indexable(texture3d)(float,float,float,float) r18.xyz, r12.xyzx, t18.xyzw, s4, l(0.000000)
    ...
    add r11.xyz, r18.xyzx, r11.xyzx
    mul r7.yzw, r7.wwww, r11.xxyz
    ...
    mad r7.yzw, r7.yyzw, l(0.000000, 0.250000, 0.250000, 0.250000), r10.xxyz
    mul r7.xyz, r7.xxxx, r7.yzwy
    mov r6.w, l(0)
    ...
    mad r14.xyz, r17.xyzx, r2.wwww, r6.xyzx
    mov r8.w, l(0)
...
mad r3.xyz, r14.xyzx, r1.xxxx, r3.xyzx
...
ret 
// Approximately 2652 instruction slots used
