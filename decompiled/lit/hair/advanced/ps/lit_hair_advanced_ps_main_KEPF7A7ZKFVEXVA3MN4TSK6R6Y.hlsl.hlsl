...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r2.x = r2.x + -r1.w;
  r3.y = debugGlossOverride.w * r2.x + r1.w;
  r1.w = debugOcclusionOverride.x + -r2.y;
  r1.w = debugOcclusionOverride.w * r1.w + r2.y;
  ...
  r2.w = cavityMap.Sample(LinearSampler_s, v2.xy).x;
  ...
  r16.xyz = secondColorTint.xyz * r1.xyz;
  r3.z = sqrt(r9.z);
  r3.z = r3.z * 0.5 + 0.5;
  r3.z = r3.z * r3.z;
  r9.z = 0.5 * r3.z;
