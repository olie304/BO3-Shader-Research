...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r2.xyz = detailMap.Sample(normalSampler_s, r1.zw).xyz;
  ...
  r4.xyz = r1.yyy * r4.xyz + float3(0.0399999991,0.0399999991,0.0399999991);
  r1.y = aoMap.Sample(aoSampler_s, w1.xy).x;
  r2.w = glossRange.y + -glossRange.x;
  r0.w = r0.w * r2.w + glossRange.x;
  ...
  r2.z = min(1, r2.z);
  r5.xy = r2.xy * detailScaleHeight + r1.xz;
  r1.x = dot(r5.xyz, r5.xyz);
  r1.x = rsqrt(r1.x);
  r5.xyz = r5.xyz * r1.xxx;
  r1.x = r2.z * detailScaleHeight + r1.w;
  r1.z = v6.x ? 1 : -1;
  ...
  r5.xyz = debugSpecularOverride.xyz + -r4.xyz;
  r4.xyz = debugSpecularOverride.www * r5.xyz + r4.xyz;
  r1.x = r1.x + -r0.w;
  ...
  if (r9.y == 0) {
    ...
    if (r9.y != 0) {
      ...
      while (true) {
        ...
        r12.w = cmp((int)r2.y == (int)r10.z);
        if (r2.z == 0) r13.z = 0; else if (r2.z+0 < 32) {         r13.z = (uint)r10.w << (32-(r2.z + 0)); r13.z = (uint)r13.z >> (32-r2.z);        } else r13.z = (uint)r10.w >> 0;
  ...
  if (r7.z != 0) {
    ...
    if (r7.z != 0) {
      ...
      r10.yzw = -v5.xyz * r2.www + sunConstants.wldDir.xyz;
