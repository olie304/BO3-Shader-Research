...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r3.x = max(0, r3.x);
  r3.yzw = debugColorOverride.xyz + -r0.xyz;
  r0.xyz = debugColorOverride.www * r3.yzw + r0.xyz;
  r3.yzw = debugSpecularOverride.xyz + -r2.xyz;
  r2.xyz = debugSpecularOverride.www * r3.yzw + r2.xyz;
  r3.x = r3.x + -r0.w;
  r3.y = debugGlossOverride.w * r3.x + r0.w;
  r0.w = debugOcclusionOverride.x + -r2.w;
  r0.w = debugOcclusionOverride.w * r0.w + r2.w;
