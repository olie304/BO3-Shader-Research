...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:37:32 2021
//
//
...
if_nz r1.y
  ftoi r1.y, cb1[64].w
  lod r1.z, v1.yzyy, t21.y, s3
  lod r1.w, v1.yzyy, t21.x, s3
  lt r1.z, r1.z, r1.w
...
add r1.y, -r0.w, cb1[59].x
mad r2.w, cb1[59].w, r1.y, r0.w
...
sample_indexable(texture2d)(float,float,float,float) r1.yzw, v1.yzyy, t25.wxyz, s6
add r3.xyz, cb0[12].xyzx, l(-0.040000, -0.040000, -0.040000, 0.000000)
mad r3.xyz, r1.xxxx, r3.xyzx, l(0.040000, 0.040000, 0.040000, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r1.x, v1.yzyy, t29.xyzw, s7
add r3.w, -cb0[13].x, cb0[13].y
mad r0.w, r0.w, r3.w, cb0[13].x
mul_sat r0.w, r0.w, l(0.05882353)
add r1.yzw, r1.yyzw, l(0.000000, -0.500000, -0.500000, -0.000000)
mad r1.yzw, cb0[12].wwww, r1.yyzw, l(0.000000, 0.500000, 0.500000, 0.000000)
mad r1.yz, r1.yyzy, l(0.000000, 1.99218750, 1.99218750, 0.000000), l(0.000000, -1.000000, -1.000000, 0.000000)
dp2 r4.x, r1.yzyy, r1.yzyy
...
ret 
// Approximately 2278 instruction slots used
