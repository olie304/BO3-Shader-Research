...
add r5.y, r5.y, r5.y
mad r10.xyz, r2.xyzx, -r5.yyyy, -r4.yzwy
...
loop 
  ...
  ld_indexable(texture2darray)(uint,uint,uint,uint) r3.w, r13.xyzw, t7.yzwx
...
ret 
// Approximately 2222 instruction slots used
