...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:37:41 2021
//
//
// Buffer Definitions: 
//
...
dcl_output o0.xyzw
dcl_temps 45
sample_indexable(texture2d)(float,float,float,float) r0.xyzw, v2.xyxx, t21.xyzw, s3
...
mul r1.y, r0.w, r1.x
sample_indexable(texture2d)(float,float,float,float) r1.z, v2.xyxx, t24.yzxw, s5
add r2.xyz, cb0[12].xyzx, l(-0.040000, -0.040000, -0.040000, 0.000000)
mad r2.xyz, r1.zzzz, r2.xyzx, l(0.040000, 0.040000, 0.040000, 0.000000)
add_sat r1.z, -r1.z, l(1.000000)
mul r0.xyz, r0.xyzx, r1.zzzz
sample_indexable(texture2d)(float,float,float,float) r1.z, v2.xyxx, t29.yzxw, s7
sample_indexable(texture2d)(float,float,float,float) r1.w, v2.xyxx, t26.yzwx, s5
add r2.w, -cb0[13].x, cb0[13].y
mad r1.w, r1.w, r2.w, cb0[13].x
mul_sat r1.w, r1.w, l(0.05882353)
sample_indexable(texture2d)(float,float,float,float) r3.xyz, v2.xyxx, t25.xyzw, s6
...
mad r3.xyw, r4.yzyw, r3.wwww, r5.xyxz
dp3 r4.x, r3.xywx, r3.xywx
rsq r4.x, r4.x
mul r3.xyw, r3.xyxw, r4.xxxx
mad r2.w, cb1[62].x, r2.w, cb0[13].x
...
if_nz r3.z
  ftoi r3.z, cb1[64].w
  lod r4.x, v2.xyxx, t21.y, s3
  lod r4.y, v2.xyxx, t21.x, s3
  lt r4.x, r4.x, r4.y
...
if_z r1.z
  ...
  if_nz r1.w
    ...
    mad r19.xyz, r21.xyzx, r1.zzzz, r8.yzwy
    mov r10.w, l(0)
...
mul r8.yzw, r1.zzzz, r20.xxyz
mul r13.xyz, r1.yyyy, r8.zwyz
mul r1.yzw, r1.wwww, r8.yyzw
sqrt r0.w, r5.z
mad r0.w, r0.w, l(0.500000), l(0.500000)
mul r0.w, r0.w, r0.w
mul r2.w, r0.w, l(0.500000)
mad r0.w, -r0.w, l(0.500000), l(1.000000)
mad r3.w, r1.x, r0.w, r2.w
mul r0.w, r0.w, r3.w
mul r2.w, r2.w, r3.w
...
if_nz r6.z
  ...
  if_nz r6.z
    ...
    if_nz r9.y
      ...
      mad r18.xyz, r3.xyzx, r9.zzzz, v7.xyzx
    ...
    mad r9.yzw, -v7.xxyz, r4.xxxx, cb2[17].xxyz
    ...
    mad r9.yzw, r5.wwww, r8.yyzw, r1.yyzw
            ...
            if_nz r24.w
              ...
              if_nz r24.w
                ...
                if_nz r13.w
                  ...
                  mad r18.xyz, r3.xyzx, r25.wwww, v7.xyzx
          ...
          if_nz r15.z
            ...
            if_nz r15.z
              ...
              if_nz r15.z
                ...
                mad r21.xyz, r3.xyzx, r15.zzzz, v7.xyzx
              ...
              if_nz r15.z
                ...
                if_nz r21.x
                  ...
                  mad r22.xyz, r3.xyzx, r21.yyyy, v7.xyzx
                  ...
                  if_nz r21.x
                    ...
                    mad r21.y, |r12.w|, l(-0.200000), l(0.400000)
                    mad r23.xyz, r3.xyzx, r21.yyyy, v7.xyzx
