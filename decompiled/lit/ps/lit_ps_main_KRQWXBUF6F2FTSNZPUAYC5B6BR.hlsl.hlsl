...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r2.w = aoMap.Sample(aoSampler_s, v2.xy).x;
  ...
  if (r6.z != 0) {
    ...
    if (r6.z != 0) {
      ...
      r15.xyz = -v6.xyz * r2.zzz + sunConstants.wldDir.xyz;
