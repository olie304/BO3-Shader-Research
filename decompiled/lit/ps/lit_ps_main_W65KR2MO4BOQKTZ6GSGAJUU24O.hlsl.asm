...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:38:24 2021
//
//
// Buffer Definitions: 
//
...
sample_indexable(texture2d)(float,float,float,float) r1.x, v1.yzyy, t26.xyzw, s7
sample_indexable(texture2d)(float,float,float,float) r1.y, v1.yzyy, t25.yxzw, s5
add r1.z, -cb0[12].x, cb0[12].y
mad r1.y, r1.y, r1.z, cb0[12].x
mul_sat r1.y, r1.y, l(0.05882353)
sample_indexable(texture2d)(float,float,float,float) r2.xyz, v1.yzyy, t24.xyzw, s6
...
if_nz r1.w
  ftoi r1.w, cb1[64].w
  lod r2.z, v1.yzyy, t21.y, s3
  lod r3.x, v1.yzyy, t21.x, s3
  lt r2.z, r2.z, r3.x
