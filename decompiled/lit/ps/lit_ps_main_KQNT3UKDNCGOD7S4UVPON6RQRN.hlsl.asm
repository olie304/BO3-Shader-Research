...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:38:01 2021
//
//
// Buffer Definitions: 
//
...
sample_indexable(texture2d)(float,float,float,float) r0.x, v2.xyxx, t24.xyzw, s6
...
if_nz r2.z
  ...
  movc r1.xyz, r3.xxxx, r3.yzwy, r4.xyzx
endif 
...
mad r2.xyz, cb1[60].wwww, r0.yzwy, r2.xywx
ftou r0.yz, v0.xxyx
...
loop 
  ...
  ld_indexable(texture2darray)(uint,uint,uint,uint) r0.w, r13.xyzw, t7.yzwx
  ...
  dp3 r12.z, r34.xyzx, r9.yzwy
  add_sat r12.z, r34.w, r12.z
  dp3 r12.w, r35.xyzx, r9.yzwy
  add_sat r12.w, r35.w, r12.w
  mul r12.z, r12.w, r12.z
  dp3 r12.w, r36.xyzx, r9.yzwy
  add_sat r12.w, r36.w, r12.w
  mul r12.z, r12.w, r12.z
  dp3 r12.w, r37.xyzx, r9.yzwy
  add_sat r12.w, r37.w, r12.w
  mul r12.z, r12.w, r12.z
  dp3 r12.w, r38.xyzx, r9.yzwy
  add_sat r12.w, r38.w, r12.w
  mul r12.z, r12.w, r12.z
  dp3 r12.w, r39.xyzx, r9.yzwy
  ...
  mov r13.xy, r27.zwzz
  mov r13.z, r28.z
  dp3 r14.x, r10.xyzx, r13.xyzx
  dp3 r13.x, r9.yzwy, r13.xyzx
  add r13.x, -r28.w, r13.x
  ge r13.y, r13.x, l(0.000000)
  max r13.x, r6.w, |r13.x|
  movc r13.x, r13.y, r13.x, -r13.x
  max r13.y, -r14.x, l(0.00000010)
  div r13.x, r13.x, r13.y
  min r13.x, |r13.x|, l(131072.000000)
  mov r28.z, r29.z
  dp3 r13.y, r10.xyzx, r28.xyzx
  dp3 r13.z, r9.yzwy, r28.xyzx
  add r13.z, -r29.w, r13.z
  ...
  mov r29.z, r30.z
  dp3 r13.y, r10.xyzx, r29.xyzx
  dp3 r13.z, r9.yzwy, r29.xyzx
  add r13.z, -r30.w, r13.z
  ge r14.x, r13.z, l(0.000000)
  max r13.z, r6.w, |r13.z|
  movc r13.z, r14.x, r13.z, -r13.z
  max r13.y, -r13.y, l(0.00000010)
  ...
  min r13.x, |r13.y|, r13.x
  mov r30.z, r31.z
  dp3 r13.y, r10.xyzx, r30.xyzx
  dp3 r13.z, r9.yzwy, r30.xyzx
  add r13.z, -r31.w, r13.z
  ge r14.x, r13.z, l(0.000000)
  max r13.z, r6.w, |r13.z|
  movc r13.z, r14.x, r13.z, -r13.z
  max r13.y, -r13.y, l(0.00000010)
  ...
  min r13.x, |r13.y|, r13.x
  mov r31.z, r32.x
  dp3 r13.y, r10.xyzx, r31.xyzx
  dp3 r13.z, r9.yzwy, r31.xyzx
  add r13.z, -r32.y, r13.z
  ge r14.x, r13.z, l(0.000000)
  max r13.z, r6.w, |r13.z|
  movc r13.z, r14.x, r13.z, -r13.z
  max r13.y, -r13.y, l(0.00000010)
  ...
  min r13.x, |r13.y|, r13.x
  mov r33.zw, r32.zzzw
  dp3 r13.y, r10.zxyz, r33.xzwx
  dp3 r13.z, r9.wyzw, r33.xzwx
  add r13.z, -r33.y, r13.z
  ge r14.x, r13.z, l(0.000000)
  max r13.z, r6.w, |r13.z|
  movc r13.z, r14.x, r13.z, -r13.z
  max r13.y, -r13.y, l(0.00000010)
  ...
  mov r28.x, r24.w
  mov r28.yz, r25.zzwz
  add r28.xyz, r9.yzwy, r28.xyzx
  mad r28.xyz, r10.xyzx, r13.xxxx, r28.xyzx
  dp3 r13.y, r28.xyzx, r28.xyzx
  sqrt r13.y, r13.y
  div r13.x, r13.x, r13.y
  ...
  ubfe r13.yz, l(0, 6, 9, 0), l(0, 25, 16, 0), r27.yyyy
  utof r29.w, r13.z
  sample_l_indexable(texturecubearray)(float,float,float,float) r22.xyz, r29.xyzw, t8.xyzw, s2, r13.x
  and r27.yzw, r22.xxyz, l(0, 0x7fffffff, 0x7fffffff, 0x7fffffff)
  ieq r27.yzw, r27.yyzw, l(0, 0x7f800000, 0x7f800000, 0x7f800000)
  or r13.x, r27.z, r27.y
  or r13.x, r27.w, r13.x
  movc r22.xyz, r13.xxxx, l(1.000000,1.000000,0,0), r22.xyzx
  dp3 r28.x, r9.yzwy, r21.xyzx
  dp3 r28.y, r9.yzwy, r30.xyzx
  dp3 r28.z, r9.yzwy, r23.xyzx
  ...
  or r13.x, r27.z, r27.y
  or r13.x, r27.w, r13.x
  movc r26.xyz, r13.xxxx, l(1.000000,1.000000,0,0), r26.xyzx
  ...
  loop 
    breakc_z r13.z
    firstbit_lo r14.x, r13.z
    ishl r14.x, l(1), r14.x
    and r14.w, r13.z, r14.x
    if_nz r14.w
      not r14.x, r14.x
      ...
      if_nz r8.w
        ...
        mov r14.w, l(1)
        loop 
          ige r15.z, r14.w, r13.y
          breakc_nz r15.z
          iadd r15.z, r11.w, r14.w
          ...
          dp3 r15.z, r30.xyzx, r9.yzwy
          add_sat r15.z, r30.w, r15.z
          mul r15.z, r15.z, r29.x
          dp3 r15.w, r31.xyzx, r9.yzwy
          add_sat r15.w, r31.w, r15.w
          mul r15.z, r15.w, r15.z
          dp3 r15.w, r32.xyzx, r9.yzwy
          add_sat r15.w, r32.w, r15.w
          mul r15.z, r15.w, r15.z
          dp3 r15.w, r33.xyzx, r9.yzwy
          add_sat r15.w, r33.w, r15.w
          mul r15.z, r15.w, r15.z
          dp3 r15.w, r34.xyzx, r9.yzwy
          add_sat r15.w, r34.w, r15.w
          mul r15.z, r15.w, r15.z
          dp3 r15.w, r35.xyzx, r9.yzwy
          add_sat r15.w, r35.w, r15.w
          mul r29.x, r15.w, r15.z
          ushr r16.z, r14.x, l(2)
          ubfe r16.w, l(1), l(2), r14.x
          and r17.z, r16.z, l(2)
          max r17.w, r29.x, r29.y
          mad r15.z, -r15.z, r15.w, l(1.000000)
          mul r15.z, r15.z, r29.y
          movc r18.y, r17.z, r15.z, r17.w
          movc r29.xy, r16.wwww, r29.xyxx, r18.xyxx
          iadd r14.w, r14.w, l(1)
          mov r14.x, r16.z
        endloop 
        mov_sat r29.y, r29.y
        mul r14.x, r8.z, r29.y
        lt r14.w, l(0.000000), r14.x
        if_nz r14.w
          mad r30.z, r29.y, r8.z, r27.w
          mul r14.x, r27.x, r14.x
          mul r18.yzw, r14.xxxx, r25.xxyz
          mul r29.xzw, r18.zzzz, r21.xxyw
          mad r29.xzw, r23.xxyz, r18.yyyy, r29.xxzw
          mad r18.yzw, r24.xxyz, r18.wwww, r29.xxzw
          mul r29.xzw, r26.xxyz, r18.yyzw
          dp3 r14.w, r29.xzwx, l(0.212600, 0.715200, 0.072200, 0.000000)
          mad r31.xyz, r18.yzwy, r26.xyzx, r28.xyzx
          mul r15.z, r7.w, r14.w
          mul r18.yzw, r14.xxxx, r22.xxyz
          dp3 r14.x, r18.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
          mad r14.x, r7.w, r14.w, r14.x
          div r14.x, r15.z, r14.x
          mov r32.x, r28.w
          mov r32.yz, r27.yyzy
          mad r30.xyw, r18.zwzy, r14.xxxx, r32.yzyx
          mov r31.w, r30.w
        else 
...
if_z r0.y
      ...
      loop 
        ...
        if_nz r16.z
          ...
          if_nz r15.w
            ...
            and r18.w, r16.z, l(1)
            movc r28.xy, r18.wwww, r14.xyxx, r14.zxzz
            mov r14.x, r16.z
            mov r29.xy, r28.xyxx
            mov r18.w, l(1)
            loop 
  ...
  if_nz r0.z
    ...
    dp3 r0.w, r8.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
    mad r19.xyz, r21.xyzx, r0.yyyy, r8.yzwy
    mov r10.w, l(0)
    sample_l_indexable(texturecubearray)(float,float,float,float) r8.yzw, r10.xyzw, t8.wxyz, s2, r6.z
    mad r0.y, cb2[19].x, r0.z, -r0.w
    mad r0.y, r4.y, r0.y, r0.w
    mad r20.xyz, r8.yzwy, r0.yyyy, r20.xyzx
  endif 
else 
  mov r20.x, r19.w
endif 
...
mul r12.xyz, r0.xxxx, r19.xyzx
mad r0.xz, r4.xxyx, l(0.984375, 0.000000, 0.984375, 0.000000), l(0.00781250, 0.000000, 0.00781250, 0.000000)
sample_l_indexable(texture2d)(float,float,float,float) r0.xz, r0.xzxx, t5.xzyw, s2, l(0.000000)
mul r8.yzw, r0.yyyy, r20.xxyz
mul r13.xyz, r0.xxxx, r8.zwyz
mul r0.xyz, r0.zzzz, r8.yzwy
sqrt r0.w, r4.w
mad r0.w, r0.w, l(0.500000), l(0.500000)
mul r0.w, r0.w, r0.w
mul r2.w, r0.w, l(0.500000)
mad r0.w, -r0.w, l(0.500000), l(1.000000)
mad r4.y, r4.x, r0.w, r2.w
mul r0.w, r0.w, r4.y
mul r2.w, r2.w, r4.y
...
if_nz r6.z
  ...
  if_nz r6.z
    ...
    if_nz r9.y
      ...
      mad r18.xyz, r2.xyzx, r9.zzzz, v6.xyzx
    ...
    mad r9.yzw, -v6.xxyz, r1.wwww, cb2[17].xxyz
    dp3 r1.w, r9.yzwy, r9.yzwy
    rsq r1.w, r1.w
    mul r9.yzw, r1.wwww, r9.yyzw
    dp3 r1.w, r9.yzwy, r5.xyzx
    dp3 r7.w, r2.xyzx, r9.yzwy
    mad r9.y, |r7.w|, r4.z, -|r7.w|
    mad r7.w, |r7.w|, r9.y, l(1.000000)
    mad r5.w, r5.w, r0.w, r2.w
    mul r7.w, r7.w, r7.w
    mul r5.w, r5.w, r7.w
    rcp r5.w, r5.w
    mul r5.w, r6.z, r5.w
    ...
    mad r9.yzw, r5.wwww, r8.yyzw, r0.xxyz
    add_sat r1.w, -r1.w, l(1.000000)
    mul r6.z, r1.w, r1.w
    mul r6.z, r6.z, r6.z
    mul r1.w, r1.w, r6.z
    mul r1.w, r1.w, r5.w
    mad r15.xyz, r1.wwww, r8.zwyz, r13.xyzx
    mov r14.w, r15.z
    mov r12.w, r13.z
