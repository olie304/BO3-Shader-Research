...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r1.w = min(1, r1.w);
  r4.xy = r1.yz * detailScaleHeight + r3.xy;
  r1.y = dot(r4.xyz, r4.xyz);
  r1.y = rsqrt(r1.y);
  r4.xyz = r4.xyz * r1.yyy;
  r1.y = r1.w * detailScaleHeight + r3.z;
  r1.z = v6.x ? 1 : -1;
  ...
  r1.z = rsqrt(r1.z);
  r3.xyz = r3.xyz * r1.zzz;
  r1.z = debugGlossOverride.x * r3.w + glossRange.x;
  ...
  if (r9.y == 0) {
    ...
    while (true) {
      ...
      r10.z = cmp((int)r3.y == (int)r9.w);
      bitmask.w = ((~(-1 << r3.z)) << 0) & 0xffffffff;  r10.w = (((uint)0 << 0) & bitmask.w) | ((uint)r10.y & ~bitmask.w);
    ...
    if (r9.y != 0) {
      ...
      r10.z = 0;
      while (true) {
        r10.w = cmp((uint)r10.z >= (uint)r3.x);
        if (r10.w != 0) break;
        r13.z = (uint)r10.z >> 5;
        r14.xyz = (int3)r12.xyz + (int3)r13.xyz;
        r10.w = visibleProbes.Load(r14.xyzw).x;
        r12.w = cmp((int)r3.y == (int)r10.z);
        if (r3.z == 0) r13.z = 0; else if (r3.z+0 < 32) {         r13.z = (uint)r10.w << (32-(r3.z + 0)); r13.z = (uint)r13.z >> (32-r3.z);        } else r13.z = (uint)r10.w >> 0;
    ...
    if (r3.y != 0) {
      ...
      r3.x = sunConstants.globalProbeExposure * r3.y + -r1.w;
      r1.w = r5.y * r3.x + r1.w;
  ...
  if (r7.z != 0) {
    ...
    if (r7.z != 0) {
      ...
      r10.yzw = -v5.xyz * r3.www + sunConstants.wldDir.xyz;
      r3.w = dot(r10.yzw, r10.yzw);
      r3.w = rsqrt(r3.w);
      r10.yzw = r10.yzw * r3.www;
      r3.w = dot(r10.yzw, r6.xyz);
      ...
      r6.w = r7.w * r6.w;
      r6.w = 0.25 * r6.w;
      r10.yzw = r6.www * r9.yzw + r3.xyz;
      r3.w = saturate(1 + -r3.w);
      r7.z = r3.w * r3.w;
      r7.z = r7.z * r7.z;
      r3.w = r7.z * r3.w;
      r3.w = r6.w * r3.w;
      r16.xyz = r3.www * r9.zwy + r14.xyz;
      r15.w = r16.z;
      r13.w = r14.z;
