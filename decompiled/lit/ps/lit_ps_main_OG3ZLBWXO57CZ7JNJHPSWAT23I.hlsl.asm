...
sample_indexable(texture2d)(float,float,float,float) r1.x, v2.xyxx, t26.xyzw, s7
sample_indexable(texture2d)(float,float,float,float) r1.y, v2.xyxx, t25.yxzw, s5
add r1.z, -cb0[12].x, cb0[12].y
mad r1.y, r1.y, r1.z, cb0[12].x
mul_sat r1.y, r1.y, l(0.05882353)
sample_indexable(texture2d)(float,float,float,float) r2.xyz, v2.xyxx, t24.xyzw, s6
...
ret 
// Approximately 2225 instruction slots used
