...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:38:30 2021
//
//
...
//   float2 scopeDiameter;              // Offset:  200 Size:     8
//   float scopeCrush;                  // Offset:  208 Size:     4
//
// }
//
...
if_nz r1.z
  ...
  movc r3.xyz, r2.yyyy, l(1.000000,0,1.000000,0), r0.xyzx
  movc r4.xyz, r2.zzzz, l(0,1.000000,1.000000,0), r0.xyzx
  movc r2.xyz, r2.xxxx, r3.xyzx, r4.xyzx
  movc r3.xyz, r2.wwww, l(0,1.000000,0,0), r0.xyzx
  movc r0.xyz, r1.wwww, r2.xyzx, r3.xyzx
endif 
mad r0.w, -r0.w, v1.x, cb1[59].x
mad r2.w, cb1[59].w, r0.w, r1.x
...
add r5.xyz, -r3.xyzx, cb1[61].xyzx
mad r3.xyz, cb1[61].wwww, r5.xyzx, r3.xyzx
add r1.x, -r0.w, r1.x
...
mul r3.w, r3.w, r3.w
mul r3.w, r3.w, r4.x
mul r4.xyz, r3.xyzx, cb0[13].xxxx
mad r3.xyz, -r3.xyzx, cb0[13].xxxx, r3.xyzx
...
loop 
  ...
  mov r28.z, r29.z
  dp3 r15.x, r11.xyzx, r28.xyzx
  dp3 r15.w, r14.xyzx, r28.xyzx
  ...
  min r12.w, r12.w, |r15.x|
  mov r33.zw, r32.zzzw
  dp3 r15.x, r11.zxyz, r33.xzwx
  dp3 r15.w, r14.zxyz, r33.xzwx
    ...
    if_nz r16.w
      ...
      if_nz r9.w
        ...
        loop 
          ...
          movc r4.y, r21.z, r17.z, r22.w
          movc r29.xy, r18.wwww, r29.xyxx, r4.xyxx
          iadd r16.w, r16.w, l(1)
          mov r16.z, r18.z
        endloop 
        mov_sat r29.y, r29.y
        mul r4.y, r10.z, r29.y
        lt r16.z, l(0.000000), r4.y
        if_nz r16.z
...
if_z r4.y
  ...
  if_nz r7.w
    ...
    if_z r12.w
      ...
      iadd r16.x, r8.w, r12.w
      ushr r8.w, r11.w, l(25)
      utof r8.w, r8.w
      ...
      if_z r8.w
        ...
        movc r15.w, r8.w, r11.w, r15.w
      endif 
    endif 
    mad r8.w, -cb2[27].z, l(2.000000), r10.w
    lt r8.w, r15.w, r8.w
    movc r5.y, r8.w, l(0), l(1.000000)
  endif 
  if_z r7.w
    if_z cb2[58].y
      ftou r7.w, r6.w
...
if_nz r4.y
  ...
  if_nz r4.y
    ...
    if_nz r7.z
      ...
      mad r19.xyz, r1.xyzx, r7.wwww, v5.xyzx
    ...
    dp3 r4.z, r16.xyzx, r6.xyzx
    dp3 r6.w, r1.xyzx, r16.xyzx
    mad r7.z, |r6.w|, r5.z, -|r6.w|
    mad r6.w, |r6.w|, r7.z, l(1.000000)
    mad r4.x, r4.x, r0.w, r1.w
    mul r6.w, r6.w, r6.w
    mul r4.x, r4.x, r6.w
    rcp r4.x, r4.x
    mul r4.x, r4.y, r4.x
    ...
    mad r16.xyz, r4.xxxx, r10.yzwy, r9.yzwy
    add_sat r4.y, -r4.z, l(1.000000)
    mul r4.z, r4.y, r4.y
    mul r4.z, r4.z, r4.z
    mul r4.y, r4.z, r4.y
    mul r4.x, r4.y, r4.x
    mad r17.xyz, r4.xxxx, r10.zwyz, r14.xyzx
    mov r15.w, r17.z
    mov r13.w, r14.z
...
mov r4.z, l(0)
loop 
  uge r5.x, r4.z, cb2[0].x
  breakc_nz r5.x
  ushr r16.z, r4.z, l(5)
  iadd r17.xyz, r12.xyzx, r16.xyzx
  ld_indexable(texture2darray)(uint,uint,uint,uint) r5.x, r17.xyzw, t6.xyzw
    ...
    if_nz r8.w
      ...
      if_nz r7.w
        ...
        switch r7.w
          ...
          add r41.xyz, r40.xyzx, -v5.xyzx
          dp3 r8.w, r39.xyzx, r41.xyzx
          div_sat r11.w, -r8.w, r38.x
          ...
          if_nz r16.z
            ...
            if_nz r16.z
              ...
              if_nz r16.z
                ...
                mad r42.xyz, r1.xyzx, r16.zzzz, v5.xyzx
              ...
              if_nz r16.z
                ...
                if_nz r11.w
                  ...
                  mad r19.xyz, r1.xyzx, r16.wwww, v5.xyzx
                  ...
                  if_z r19.x
                    ...
                    if_nz r5.y
                      ...
                      loop 
                        ...
                        dp2 r42.y, icb[r26.w + 0].xyxx, r7.xyxx
                  ...
                  if_nz r11.w
                    ...
                    ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r42.xyzw, r8.w, l(116), t12.xyzw
                    mad r16.w, |r13.w|, l(-0.200000), l(0.400000)
                    mad r20.xyz, r1.xyzx, r16.wwww, v5.xyzx
                ...
                mad r8.w, -r14.w, r4.x, l(1.000000)
                mul r8.w, r8.w, r8.w
                mad r8.w, -r8.w, l(0.620000), l(0.620000)
                add r8.w, -r14.w, r8.w
                mad r8.w, r5.w, r8.w, r14.w
                mul r8.w, r12.w, r8.w
                mov r33.x, r32.x
                lt r11.w, l(0.000000), r13.w
                mad r19.xyz, r8.wwww, r33.xyzx, r17.xyzx
                dp3_sat r8.w, r1.xyzx, r40.xyzx
                mad r20.xyz, r39.xyzx, r7.wwww, r6.xyzx
                dp3 r7.w, r20.xyzx, r20.xyzx
                rsq r7.w, r7.w
                mul r20.xyz, r7.wwww, r20.xyzx
                dp3 r7.w, r20.xyzx, r6.xyzx
                dp3 r13.w, r1.xyzx, r20.xyzx
                mad r14.w, |r13.w|, r5.z, -|r13.w|
                mad r13.w, |r13.w|, r14.w, l(1.000000)
                mad r14.w, r8.w, r0.w, r1.w
                ...
                mul r8.w, r8.w, r13.w
                mul r8.w, r12.w, r8.w
                mad r20.xyz, r8.wwww, r33.xyzx, r31.xyzx
                add_sat r7.w, -r7.w, l(1.000000)
                mul r12.w, r7.w, r7.w
          ...
          if_nz r12.w
            ...
            if_nz r12.w
              ...
              if_nz r12.w
                ...
                mad r22.xyz, r1.xyzx, r12.wwww, v5.xyzx
                ...
                if_nz r16.z
                  ...
                  if_nz r5.y
                    ...
                    loop 
                      ...
                      sample_c_lz_indexable(texture2darray)(float,float,float,float) r16.w, r32.xyzx, t9.xxxx, s13, r7.z
              ...
              if_nz r12.w
                ...
                if_nz r16.z
                  ...
                  mad r23.xyz, r1.xyzx, r16.wwww, v5.xyzx
                  ...
                  if_nz r16.z
                    ...
                    mad r16.w, |r8.w|, l(-0.200000), l(0.400000)
                    mad r24.xyz, r1.xyzx, r16.wwww, v5.xyzx
                ...
                mad r16.z, |r13.w|, r5.z, -|r13.w|
                mad r13.w, |r13.w|, r16.z, l(1.000000)
                mad r11.w, r11.w, r0.w, r1.w
                mul r13.w, r13.w, r13.w
                ...
                movc r17.xyz, r8.wwww, r22.xyzx, r17.xyzx
                movc r30.xyz, r8.wwww, r20.xyzx, r30.xyzx
                movc r31.xyz, r8.wwww, r19.xyzx, r31.xyzx
              endif 
            endif 
          endif 
          break 
...
ret 
// Approximately 2281 instruction slots used
