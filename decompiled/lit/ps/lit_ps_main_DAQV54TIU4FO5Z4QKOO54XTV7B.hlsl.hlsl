...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r6.x = saturate(dot(r3.xyz, r4.xyz));
  r5.y = dot(-r4.xyz, r3.xyz);
  r5.y = r5.y + r5.y;
  r10.xyz = r3.xyz * -r5.yyy + -r4.xyz;
  r5.y = 17 * r6.y;
  r5.y = exp2(r5.y);
  r5.y = 2 + r5.y;
  r5.y = 2 / r5.y;
  ...
  r11.z = (uint)r0.w << 4;
  r0.w = (int)r7.w & -32;
  r2.x = (int)-r0.w + (int)r7.w;
  r2.y = numRefProbes & -32;
  r8.w = (int)-r2.y + numRefProbes;
  r12.xy = float2(0,0);
  r13.w = 0;
  r14.yz = float2(0,1);
  r15.xy = float2(0,0);
  ...
  while (true) {
    ...
    bitmask.w = ((~(-1 << r2.x)) << 0) & 0xffffffff;  r11.w = (((uint)0 << 0) & bitmask.w) | ((uint)r9.z & ~bitmask.w);
    r9.z = r9.w ? r11.w : r9.z;
    r9.w = cmp((int)r2.y == (int)r9.y);
  ...
  if (r2.y != 0) {
    ...
    while (true) {
      ...
      r12.z = cmp((int)r0.w == (int)r8.w);
      if (r2.x == 0) r12.w = 0; else if (r2.x+0 < 32) {       r12.w = (uint)r11.w << (32-(r2.x + 0)); r12.w = (uint)r12.w >> (32-r2.x);      } else r12.w = (uint)r11.w >> 0;
  ...
  if (r2.x != 0) {
    ...
    r2.y = dot(r13.xyz, float3(0.212599993,0.715200007,0.0722000003));
  ...
  r13.xyz = r9.yzw * r2.www;
  r2.xy = r6.xy * float2(0.984375,0.984375) + float2(0.0078125,0.0078125);
  r2.xy = gEnvBRDFGeneric.SampleLevel(samplerLinear_s, r2.xy, 0).xy;
  r6.yzw = r12.xyz * r0.www;
  r12.xyz = r6.zwy * r2.xxx;
  r2.xyw = r6.yzw * r2.yyy;
  r0.w = sqrt(r5.z);
  r0.w = r0.w * 0.5 + 0.5;
  r0.w = r0.w * r0.w;
  r3.w = 0.5 * r0.w;
  ...
  if (r6.z != 0) {
    ...
    if (r6.z != 0) {
      ...
      r15.xyz = -v5.xyz * r2.zzz + sunConstants.wldDir.xyz;
      r2.z = dot(r15.xyz, r15.xyz);
      r2.z = rsqrt(r2.z);
      r15.xyz = r15.xyz * r2.zzz;
      r2.z = dot(r15.xyz, r4.xyz);
      ...
      r6.y = r6.w * r6.y;
      r6.y = 0.25 * r6.y;
      r15.xyz = r6.yyy * r9.yzw + r2.xyw;
      r2.z = saturate(1 + -r2.z);
      r6.z = r2.z * r2.z;
      r6.z = r6.z * r6.z;
      r2.z = r6.z * r2.z;
      r2.z = r6.y * r2.z;
      r16.xyz = r2.zzz * r9.zwy + r12.xyz;
      r14.w = r16.z;
      r13.w = r12.z;
  ...
  r2.xyz = float3(0.959999979,0.959999979,0.959999979) * r26.xyz;
  r2.xyz = r27.xyz * float3(0.0399999991,0.0399999991,0.0399999991) + r2.xyz;
