...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  r0.z = r0.z + -r0.y;
  r4.y = debugGlossOverride.w * r0.z + r0.y;
  ...
  r1.w = rsqrt(r1.w);
  r0.yzw = r0.yzw * r1.www + -r2.xyw;
  r2.xyz = debugNormalOverride.www * r0.yzw + r2.xyw;
  r0.yz = (uint2)v0.xy;
  ...
  while (true) {
    ...
    r0.w = visibleProbes.Load(r13.xyzw).x;
  ...
  r26.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r8.yz, r0.z, l(96), t15.xxyx
  r8.y = samp0[]..swiz;
  r8.z = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
  ...
  if (r0.y == 0) {
    ...
    while (true) {
      ...
      r9.z = cmp((int)r0.z == (int)r8.w);
      bitmask.w = ((~(-1 << r0.w)) << 0) & 0xffffffff;  r9.w = (((uint)0 << 0) & bitmask.w) | ((uint)r9.y & ~bitmask.w);
      r9.y = r9.z ? r9.w : r9.y;
    ...
    if (r8.y != 0) {
      ...
      while (true) {
        ...
        r11.w = cmp((int)r0.z == (int)r9.z);
        if (r0.w == 0) r12.z = 0; else if (r0.w+0 < 32) {         r12.z = (uint)r9.w << (32-(r0.w + 0)); r12.z = (uint)r12.z >> (32-r0.w);        } else r12.z = (uint)r9.w >> 0;
    ...
    if (r0.z != 0) {
      ...
      r0.w = dot(r8.yzw, float3(0.212599993,0.715200007,0.0722000003));
      r19.xyz = r21.xyz * r0.yyy + r8.yzw;
      r10.w = 0;
  ...
  r12.xyz = r19.xyz * r0.xxx;
  r0.xz = r4.xy * float2(0.984375,0.984375) + float2(0.0078125,0.0078125);
  r0.xz = gEnvBRDFGeneric.SampleLevel(samplerLinear_s, r0.xz, 0).xy;
  r8.yzw = r20.xyz * r0.yyy;
  r13.xyz = r8.zwy * r0.xxx;
  ...
  if (r6.z != 0) {
    ...
    if (r6.z != 0) {
      ...
      r9.yzw = -v6.xyz * r1.www + sunConstants.wldDir.xyz;
      r1.w = dot(r9.yzw, r9.yzw);
      r1.w = rsqrt(r1.w);
      r9.yzw = r9.yzw * r1.www;
      r1.w = dot(r9.yzw, r5.xyz);
      r7.w = dot(r2.xyz, r9.yzw);
