...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r3.y = 1 + -r6.y;
  r3.y = 5 * r3.y;
  r5.yzw = -globalProbeConstants.data[0].xyz + v5.xyz;
  ...
  if (r6.z != 0) {
    ...
    if (r6.z != 0) {
      ...
      r11.xyz = -v5.xyz * r0.www + sunConstants.wldDir.xyz;
