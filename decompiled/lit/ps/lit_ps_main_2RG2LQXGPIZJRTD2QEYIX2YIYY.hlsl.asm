...
mul o0.w, r0.w, v1.w
sample_indexable(texture2d)(float,float,float,float) r0.w, v2.xyxx, t24.yzwx, s6
...
sample_indexable(texture2d)(float,float,float,float) r1.yzw, v2.xyxx, t21.wxyz, s5
