// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:38:19 2021
...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r1.xzw = normalMap.Sample(normalSampler_s, w1.xy).xyz;
