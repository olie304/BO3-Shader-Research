...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:38:07 2021
//
//
// Buffer Definitions: 
//
...
mul r1.y, r0.w, r1.x
sample_indexable(texture2d)(float,float,float,float) r1.z, v2.xyxx, t26.yzxw, s7
sample_indexable(texture2d)(float,float,float,float) r1.w, v2.xyxx, t25.yzwx, s5
...
if_nz r2.y
  ftoi r2.y, cb1[64].w
  lod r2.z, v2.xyxx, t21.y, s3
  lod r2.w, v2.xyxx, t21.x, s3
  lt r2.z, r2.z, r2.w
  lt r2.w, l(0.000000), r2.w
  and r4.xyz, r2.yyyy, l(1, 2, 4, 0)
  ...
  movc r0.xyz, r2.zzzz, r4.xywx, r5.xyzx
endif 
...
mov r1.zw, l(0,0,0,0)
loop 
  uge r2.x, r1.w, cb2[0].y
  breakc_nz r2.x
  ushr r12.z, r1.w, l(5)
  iadd r13.xyz, r11.xyzx, r12.xyzx
  ld_indexable(texture2darray)(uint,uint,uint,uint) r2.x, r13.xyzw, t7.xyzw
...
if_z r1.z
  ...
  if_nz r1.w
    ...
    dp3 r2.x, r8.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
...
loop 
  ...
  iadd r5.w, r5.w, l(32)
endloop 
add r1.xyz, -r2.yzwy, l(1.000000, 1.000000, 1.000000, 0.000000)
mul r1.xyz, r1.xyzx, r27.xyzx
mad r1.xyz, r28.xyzx, r2.yzwy, r1.xyzx
...
ret 
// Approximately 2226 instruction slots used
