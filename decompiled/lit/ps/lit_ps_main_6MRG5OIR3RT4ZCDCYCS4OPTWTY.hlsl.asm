...
sample_indexable(texture2d)(float,float,float,float) r1.xzw, v1.yzyy, t22.xwyz, s5
...
mad r0.w, r0.w, r3.w, cb0[11].x
mul_sat r0.w, r0.w, l(0.05882353)
add r1.xzw, r1.xxzw, l(-0.500000, 0.000000, -0.500000, -0.000000)
mad r1.xzw, cb0[10].wwww, r1.xxzw, l(0.500000, 0.000000, 0.500000, 0.000000)
...
mad r1.x, cb1[62].x, r3.w, cb0[11].x
