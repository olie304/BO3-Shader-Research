...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  r1.xyz = debugSpecularOverride.www * r4.xyz + r1.yzw;
  r0.w = r2.z + -r2.y;
  r4.y = debugGlossOverride.w * r0.w + r2.y;
  r0.w = debugOcclusionOverride.x + -r2.x;
  r0.w = debugOcclusionOverride.w * r0.w + r2.x;
  r2.xyz = v7.xxx ? v3.xyz : -v3.xyz;
  r1.w = dot(r2.xyz, r2.xyz);
  r1.w = rsqrt(r1.w);
  r2.xyz = r2.xyz * r1.www + -r3.xyw;
  r2.xyz = debugNormalOverride.www * r2.xyz + r3.xyw;
  r3.xy = (uint2)v0.xy;
            ...
            if (r15.z != 0) {
              ...
              if (r15.z != 0) {
                ...
                if (r15.z != 0) {
                  ...
                  r7.w = saturate(dot(r2.xyz, r39.xyz));
