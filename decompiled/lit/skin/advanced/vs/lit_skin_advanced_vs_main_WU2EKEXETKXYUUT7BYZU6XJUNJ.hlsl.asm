...
mad r3.xyz, r3.wwww, r3.xyzx, r0.xyzx
dp3 r3.w, r3.xyzx, r3.xyzx
rsq r3.w, r3.w
mul r3.xyz, r3.wwww, r3.xyzx
if_nz r1.x
  ne r3.w, v5.x, l(0.000000)
  if_nz r3.w
    iadd r3.w, r1.x, v6.x
    ...
    add r4.w, r8.w, r4.w
    mul r5.y, r4.w, v5.x
    dp3 r4.w, r8.xyzx, r0.xyzx
    mul r6.y, r4.w, v5.x
    dp3 r4.w, r8.xyzx, r1.yzwy
    mul r7.y, r4.w, v5.x
    dp3 r4.w, r8.xyzx, r3.xyzx
    mul r4.xy, r4.xwxx, v5.xxxx
    ...
    if_nz r3.w
      ...
      add r4.w, r9.w, r4.w
      mad r10.x, r4.w, v5.y, r5.x
      dp3 r4.w, r9.xyzx, r0.xyzx
      mad r6.x, r4.w, v5.y, r6.x
      dp3 r4.w, r9.xyzx, r1.yzwy
      mad r7.x, r4.w, v5.y, r7.x
      dp3 r4.w, r9.xyzx, r3.xyzx
      mad r4.x, r4.w, v5.y, r4.x
      ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r9.xyzw, r3.w, l(16), t5.xyzw
      dp3 r4.w, r9.xyzx, r2.xyzx
      add r4.w, r9.w, r4.w
      mad r10.y, r4.w, v5.y, r5.y
      dp3 r4.w, r9.xyzx, r0.xyzx
      mad r6.y, r4.w, v5.y, r6.y
      dp3 r4.w, r9.xyzx, r1.yzwy
      mad r7.y, r4.w, v5.y, r7.y
      dp3 r4.w, r9.xyzx, r3.xyzx
      mad r4.y, r4.w, v5.y, r4.y
      ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r9.xyzw, r3.w, l(32), t5.xyzw
      dp3 r4.w, r9.xyzx, r2.xyzx
      add r4.w, r9.w, r4.w
      mad r10.z, r4.w, v5.y, r5.z
      dp3 r4.w, r9.xyzx, r0.xyzx
      mad r6.z, r4.w, v5.y, r6.z
      dp3 r4.w, r9.xyzx, r1.yzwy
      mad r7.z, r4.w, v5.y, r7.z
      dp3 r4.w, r9.xyzx, r3.xyzx
      mad r4.z, r4.w, v5.y, r4.z
      ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r3.w, r3.w, l(48), t5.xxxx
      mad r8.z, r3.w, v5.y, r8.z
      ...
      if_nz r3.w
        ...
        dp3 r4.w, r9.xyzx, r2.xyzx
        add r4.w, r9.w, r4.w
        mad r11.x, r4.w, v5.z, r10.x
        dp3 r4.w, r9.xyzx, r0.xyzx
        mad r6.x, r4.w, v5.z, r6.x
        dp3 r4.w, r9.xyzx, r1.yzwy
        mad r7.x, r4.w, v5.z, r7.x
        dp3 r4.w, r9.xyzx, r3.xyzx
        mad r4.x, r4.w, v5.z, r4.x
        ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r9.xyzw, r3.w, l(16), t5.xyzw
        dp3 r4.w, r9.xyzx, r2.xyzx
        add r4.w, r9.w, r4.w
        mad r11.y, r4.w, v5.z, r10.y
        dp3 r4.w, r9.xyzx, r0.xyzx
        mad r6.y, r4.w, v5.z, r6.y
        dp3 r4.w, r9.xyzx, r1.yzwy
        mad r7.y, r4.w, v5.z, r7.y
        dp3 r4.w, r9.xyzx, r3.xyzx
        mad r4.y, r4.w, v5.z, r4.y
        ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r9.xyzw, r3.w, l(32), t5.xyzw
        dp3 r4.w, r9.xyzx, r2.xyzx
        add r4.w, r9.w, r4.w
        mad r11.z, r4.w, v5.z, r10.z
        dp3 r4.w, r9.xyzx, r0.xyzx
        mad r6.z, r4.w, v5.z, r6.z
        dp3 r4.w, r9.xyzx, r1.yzwy
        mad r7.z, r4.w, v5.z, r7.z
        dp3 r4.w, r9.xyzx, r3.xyzx
        mad r4.z, r4.w, v5.z, r4.z
        ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r3.w, r3.w, l(48), t5.xxxx
        mad r8.z, r3.w, v5.z, r8.z
...
mov r2.w, l(1.000000)
mov r5.w, r7.x
dp4 r10.x, r2.xyzw, r5.xyzw
mov r6.w, r7.y
dp4 r10.y, r2.xyzw, r6.xyzw
mov r9.w, r7.z
dp4 r10.z, r2.xyzw, r9.xyzw
dp3 r2.x, r0.xyzx, r5.xyzx
dp3 r2.y, r0.xyzx, r6.xyzx
dp3 r2.z, r0.xyzx, r9.xyzx
dp3 r0.x, r2.xyzx, r2.xyzx
rsq r0.x, r0.x
mul o4.xyz, r0.xxxx, r2.xyzx
dp3 r0.x, r1.yzwy, r5.xyzx
dp3 r0.y, r1.yzwy, r6.xyzx
