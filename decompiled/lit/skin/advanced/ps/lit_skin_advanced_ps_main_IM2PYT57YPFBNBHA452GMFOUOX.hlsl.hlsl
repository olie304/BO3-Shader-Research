// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:38:35 2021
...
cbuffer _Globals : register(b0)
{
  ...
  float scriptReplacement1 : packoffset(c15.w);
  bool enableGTAO : packoffset(c16);
}
...
Texture2D<float4> meltRevealMap : register(t47);
Texture2D<float4> meltNormalMap : register(t48);
...
r0.y = samp0[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) r0.xz, r0.x, l(0), t0.xxyx
r0.x = samp0[]..swiz;
r0.z = samp0[]..swiz;
  r0.w = transRevealMap.Sample(transitionSampler_s, w1.xy).x;
  r0.xz = saturate(r0.xz * float2(0.998000026,0.998000026) + float2(0.00100000005,0.00100000005));
  r1.xy = float2(1,1) + -r0.xz;
  ...
  r0.xz = r1.zz * r0.xz;
  r2.zw = exp2(r0.xz);
  r1.xyzw = saturate(transRevealSoftEdge * r2.xzyw + r1.xxyy);
  r0.x = -r1.x + r0.w;
  r0.zw = r1.yw + -r1.xz;
  r0.x = saturate(r0.x / r0.z);
  r0.z = meltRevealMap.Sample(transitionSampler_s, w1.xy).x;
  r0.z = r0.z + -r1.z;
  ...
  r1.w = r3.z * detailScaleHeight + r1.w;
  r3.x = cmp(0 < r3.w);
  ...
  r1.x = cmp(0 < r0.z);
  if (r1.x != 0) {
    r3.xyz = meltNormalMap.Sample(normalSampler_s, w1.xy).xyz;
    r3.xyz = float3(-0.5,-0.5,-0) + r3.xyz;
    r3.xyz = baseNormalHeight * r3.xyz + float3(0.5,0.5,0);
    r1.xy = r3.xy * float2(1.9921875,1.9921875) + float2(-1,-1);
    r3.x = r3.z * r3.z;
  ...
  r1.x = debugGlossOverride.x * r1.z + glossRange.x;
  ...
  if (r1.y != 0) {
    ...
    r2.xyz = r1.zzz ? r4.xyw : r5.xyz;
  }
  r1.yzw = debugColorOverride.xyz + -r2.xyz;
  r1.yzw = debugColorOverride.www * r1.yzw + r2.xyz;
  ...
  r1.x = 1 + -r1.x;
  r3.xyz = float3(1,0.5,0.5) * r1.xxx;
  ...
  if (enableGTAO != 0) {
    ...
    r3.w = frac(r3.w);
    r1.x = r3.w * 3.14159989 + r1.x;
    sincos(r1.x, r1.x, r7.x);
    r8.xyzw = float4(4.16666698,4.16666698,16.6666679,16.6666679) * renderTargetSize.zwzw;
    r7.y = r1.x;
    r9.xyzw = r8.xyzw * r7.xyxy + r4.zwzw;
    r10.xyzw = renderTargetSize.xyxy * r9.xyzw;
    r11.xy = (int2)r10.xy;
    r11.zw = float2(0,0);
    r1.x = floatZSampler.Load(r11.xyz).x;
    r3.w = cmp(r1.x >= 0.984375);
    r5.w = 1.01587307 * r1.x;
    r1.x = r1.x * 64 + -63;
    r1.x = r3.w ? r1.x : r5.w;
    ...
    r10.xyzw = r9.xyzw * r7.xyxy + r4.zwzw;
    ...
    r11.xyzw = r10.xyzw * r7.xyxy + r4.zwzw;
    ...
    r3.w = -r11.z * r3.w;
    r1.x = max(r3.w, r1.x);
    r8.xyzw = r8.xyzw * -r7.xyxy + r4.zwzw;
    r11.xyzw = renderTargetSize.xyxy * r8.xyzw;
    ...
    r11.z = rcp(r5.w);
    r11.xy = r11.zz * r8.zw;
    r8.xyz = r11.xyz + -r6.xyz;
    r5.w = dot(r8.xyz, r8.xyz);
    r5.w = rsqrt(r5.w);
    r5.w = -r8.z * r5.w;
    r3.w = max(r5.w, r3.w);
    r8.xyzw = r9.xyzw * -r7.xyxy + r4.zwzw;
    r9.xyzw = renderTargetSize.xyxy * r8.xyzw;
    ...
    r9.z = rcp(r5.w);
    r9.xy = r9.zz * r8.zw;
    r8.xyz = r9.xyz + -r6.xyz;
    r5.w = dot(r8.xyz, r8.xyz);
    r5.w = rsqrt(r5.w);
    r5.w = -r8.z * r5.w;
    r3.w = max(r5.w, r3.w);
    r8.xyzw = r10.xyzw * -r7.xyxy + r4.xyzw;
    r9.xyzw = renderTargetSize.xyxy * r8.xyzw;
    r9.xyzw = (int4)r9.zwxy;
    r10.xy = r9.zw;
    r10.zw = float2(0,0);
    ...
    r4.x = -r6.z * r4.x;
    r3.w = max(r4.x, r3.w);
    r4.xy = viewSpaceScaleBias.xy * r7.xy;
    ...
    r5.y = 1 + -abs(r1.x);
    r5.y = sqrt(r5.y);
    r5.z = abs(r1.x) * -0.0187292993 + 0.0742610022;
    r5.z = r5.z * abs(r1.x) + -0.212114394;
    r5.z = r5.z * abs(r1.x) + 1.57072878;
    r5.w = r5.z * r5.y;
  ...
  r0.y = 1 + -r12.x;
  o2.xyz = r1.yzw * r0.yyy + r7.xzw;
  r0.z = r2.x * r0.y + r12.x;
  r1.yzw = r2.yzw * r0.yyy + r13.xyz;
  r2.x = dot(r1.yzw, r1.yzw);
  r2.x = rsqrt(r2.x);
  r2.xyz = r2.xxx * r1.yzw;
  r5.y = r0.w * r0.y + r12.y;
  r0.y = log2(abs(r1.x));
  r1.xyz = float3(0.600000024,0.850000024,0.870000005) * r0.yyy;
  r1.xyz = exp2(r1.xyz);
  ...
  if (r6.w != 0) {
    ...
    if (r6.w != 0) {
      ...
      r8.w = dot(r2.xyz, r14.xyz);
      r12.w = abs(r8.w) * r3.w + -abs(r8.w);
            ...
            if (r33.w != 0) {
              ...
              if (r31.w != 0) {
                ...
                if (r31.w != 0) {
                  ...
                  r29.w = dot(r2.xyz, r58.xyz);
                  r30.w = abs(r29.w) * r3.w + -abs(r29.w);
            ...
            r61.w = samp0[]..swiz;
              ...
              if (r23.x != 0) {
                ...
                if (r23.x != 0) {
                  ...
                  r25.x = dot(r2.xyz, r25.xyz);
                  r25.y = abs(r25.x) * r3.w + -abs(r25.x);
  ...
  r10.z = rcp(r10.z);
  r10.xy = r5.zw * r10.zz + float2(0.5,0.5);
  r12.xyz = -r8.xyz;
  ...
  r6.z = rcp(r4.z);
  r6.xy = r4.xy * r6.zz + r12.xy;
  r12.w = 0.5;
  r4.xyz = r6.xyz + r12.wwz;
  ...
  r1.w = rcp(r1.w);
  r0.w = r1.w * r0.w;
  r5.zw = r0.yy * float2(0.5,0.5) + float2(0.333333343,1);
  r5.zw = float2(0.117647059,0.117647059) * r5.zw;
  r5.zw = r5.zw * r5.zw;
  x1[0].x = r5.z;
  r6.xyz = r10.xyz * r5.zzz + r8.xyz;
  r7.xy = cmp(r0.ww < r5.zw);
  r6.xy = renderTargetSize.xy * r6.xy;
  r9.xy = (int2)r6.xy;
  r9.zw = float2(0,0);
  r1.w = floatZSampler.Load(r9.xyz).x;
  r3.w = cmp(r1.w >= 0.984375);
  ...
  if (r6.y != 0) {
    ...
    r6.yz = r6.yz * r6.yz + -r5.zw;
    r5.z = r3.w * r6.y + r5.z;
    x1[0].x = r5.z;
    r7.xyw = r10.xyz * r5.zzz + r8.xyz;
    r5.z = cmp(r0.w < r5.z);
    ...
    r3.w = r6.x * r6.z + r5.w;
    x1[1].x = r3.w;
    r6.yzw = r4.xyz * r3.www + r8.xyz;
    r3.w = cmp(r0.w < r3.w);
    r5.zw = renderTargetSize.xy * r6.yz;
    r9.xy = (int2)r5.zw;
    r9.zw = float2(0,0);
  ...
  if (r1.w == 0) {
    r5.zw = r0.yy * float2(0.5,0.5) + float2(2.33333325,3);
    r5.zw = float2(0.117647059,0.117647059) * r5.zw;
    r1.w = x1[0].x;
    r3.w = x0[0].x;
    r4.w = r5.z * r5.z + -r1.w;
  ...
  if (r1.w == 0) {
    r5.zw = r0.yy * float2(0.5,0.5) + float2(3.33333325,4);
    r5.zw = float2(0.117647059,0.117647059) * r5.zw;
    r1.w = x1[0].x;
    r3.w = x0[0].x;
    r4.w = r5.z * r5.z + -r1.w;
  ...
  if (r1.w == 0) {
    r5.zw = r0.yy * float2(0.5,0.5) + float2(4.33333349,5);
    r5.zw = float2(0.117647059,0.117647059) * r5.zw;
    r1.w = x1[0].x;
    r3.w = x0[0].x;
    r4.w = r5.z * r5.z + -r1.w;
  ...
  if (r1.w == 0) {
    r5.zw = r0.yy * float2(0.5,0.5) + float2(5.33333349,6);
    r5.zw = float2(0.117647059,0.117647059) * r5.zw;
    r1.w = x1[0].x;
    r3.w = x0[0].x;
    r4.w = r5.z * r5.z + -r1.w;
  ...
  if (r1.w == 0) {
    r5.zw = r0.yy * float2(0.5,0.5) + float2(6.33333349,7);
    r5.zw = float2(0.117647059,0.117647059) * r5.zw;
    r1.w = x1[0].x;
    r3.w = x0[0].x;
    r4.w = r5.z * r5.z + -r1.w;
  ...
  if (r1.w == 0) {
    r5.zw = r0.yy * float2(0.5,0.5) + float2(7.33333349,8);
    r5.zw = float2(0.117647059,0.117647059) * r5.zw;
    r0.y = x1[0].x;
    r1.w = x0[0].x;
    r3.w = r5.z * r5.z + -r0.y;
  ...
  r1.w = 100 * r1.w;
  r5.zw = -r0.yy * float2(10,5) + float2(6.85740995,7.08500004);
  r3.w = exp2(r5.z);
  r3.w = r5.x * r3.w;
  r3.w = 9.1368103 * r3.w;
  r4.w = r0.w * r0.y;
  r4.w = -r4.w * 2.0159049 + r5.w;
  r4.w = exp2(r4.w);
  r4.w = r5.x * r4.w;
  ...
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r20.xyzw, r5.z, l(0), t15.wxyz
  r20.x = samp0[]..swiz;
  r20.y = samp0[]..swiz;
  r20.z = samp0[]..swiz;
  r20.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r21.xyzw, r5.z, l(16), t15.xyzw
  r21.x = samp0[]..swiz;
  r21.y = samp0[]..swiz;
  r21.z = samp0[]..swiz;
  r21.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r22.xyzw, r5.z, l(32), t15.yxwz
  r22.x = samp0[]..swiz;
  r22.y = samp0[]..swiz;
  r22.z = samp0[]..swiz;
  r22.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r23.xyzw, r5.z, l(48), t15.xyzw
  r23.x = samp0[]..swiz;
  r23.y = samp0[]..swiz;
  r23.z = samp0[]..swiz;
  r23.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r24.xyzw, r5.z, l(64), t15.zwxy
  r24.x = samp0[]..swiz;
  r24.y = samp0[]..swiz;
  r24.z = samp0[]..swiz;
  r24.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r25.xyzw, r5.z, l(80), t15.xyzw
  r25.x = samp0[]..swiz;
  r25.y = samp0[]..swiz;
  r25.z = samp0[]..swiz;
  r25.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r9.zw, r5.z, l(96), t15.xxxy
  r9.z = samp0[]..swiz;
  r9.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r26.xyzw, r5.z, l(116), t15.xyzw
  r26.x = samp0[]..swiz;
  r26.y = samp0[]..swiz;
  r26.z = samp0[]..swiz;
  r26.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r27.xyzw, r5.z, l(132), t15.zwxy
  r27.x = samp0[]..swiz;
  r27.y = samp0[]..swiz;
  r27.z = samp0[]..swiz;
  r27.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r28.xyzw, r5.z, l(148), t15.zwxy
  r28.x = samp0[]..swiz;
  r28.y = samp0[]..swiz;
  r28.z = samp0[]..swiz;
  r28.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r29.xyzw, r5.z, l(164), t15.zwxy
  r29.x = samp0[]..swiz;
  r29.y = samp0[]..swiz;
  r29.z = samp0[]..swiz;
  r29.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r30.xyzw, r5.z, l(180), t15.zwxy
  r30.x = samp0[]..swiz;
  r30.y = samp0[]..swiz;
  r30.z = samp0[]..swiz;
  r30.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r31.xyzw, r5.z, l(196), t15.xyzw
  r31.x = samp0[]..swiz;
  r31.y = samp0[]..swiz;
  r31.z = samp0[]..swiz;
  r31.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r32.xy, r5.z, l(212), t15.xyxx
  r32.x = samp0[]..swiz;
  r32.y = samp0[]..swiz;
  ...
  if (r4.w == 0) {
    ...
    if (r1.w != 0) {
      ...
      r18.xyz = r20.xyz * r0.yyy + r2.xyz;
      r11.w = 0;
      r2.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r11.xyzw, r0.w).xyz;
      r0.y = sunConstants.globalProbeExposure * r1.w + -r2.w;
      r0.y = r5.y * r0.y + r2.w;
      r19.xyz = r2.xyz * r0.yyy + r19.xyz;
    }
  } else {
    r19.x = r18.w;
  }
  r2.xyz = r18.xyz * r1.xyz + r6.xyz;
  r1.xyz = r18.xyz * r1.xyz + r7.xyz;
  ...
  r4.xyz = r19.xyz * r0.yyy + r4.xyz;
  r5.xyz = r19.xyz * r0.www + r8.xyz;
  r1.xyz = r1.xyz * r3.xyz + r2.xyz;
  r2.xyz = float3(0.972000003,0.972000003,0.972000003) * r4.xyz;
  r2.xyz = r5.xyz * float3(0.0280000009,0.0280000009,0.0280000009) + r2.xyz;
