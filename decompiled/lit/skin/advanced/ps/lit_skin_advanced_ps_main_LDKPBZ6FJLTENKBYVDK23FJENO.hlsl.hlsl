// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:38:36 2021
...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  if (enableGTAO != 0) {
    ...
    r10.xy = (int2)r10.zw;
    r10.zw = float2(0,0);
    r1.z = floatZSampler.Load(r10.xyz).x;
    ...
    r11.xy = (int2)r11.zw;
    r11.zw = float2(0,0);
    r1.z = floatZSampler.Load(r11.xyz).x;
    r2.w = cmp(r1.z >= 0.984375);
    r3.w = 1.01587307 * r1.z;
    r1.z = r1.z * 64 + -63;
    r1.z = r2.w ? r1.z : r3.w;
    ...
    r4.y = 1 + -abs(r1.z);
    r4.y = sqrt(r4.y);
    r5.x = abs(r1.z) * -0.0187292993 + 0.0742610022;
    r5.x = r5.x * abs(r1.z) + -0.212114394;
    r5.x = r5.x * abs(r1.z) + 1.57072878;
    r5.y = r5.x * r4.y;
    r5.y = r5.y * -2 + 3.14159274;
    r1.z = cmp(r1.z < -r1.z);
    r1.z = r1.z ? r5.y : 0;
    ...
    r2.w = debugOcclusionOverride.x + -r1.z;
    r1.z = debugOcclusionOverride.w * r2.w + r1.z;
...
r3.w = samp0[]..swiz;
  ...
  r37.z = samp0[]..swiz;
  r37.w = samp0[]..swiz;
    r13.w = dot(r32.xyz, r9.xyz);
    r13.w = saturate(r13.w + r32.w);
    r14.w = dot(r33.xyz, r9.xyz);
    r14.w = saturate(r14.w + r33.w);
    r13.w = r14.w * r13.w;
    r14.w = dot(r34.xyz, r9.xyz);
    r14.w = saturate(r14.w + r34.w);
    r13.w = r14.w * r13.w;
    r14.w = dot(r35.xyz, r9.xyz);
    r14.w = saturate(r14.w + r35.w);
    r13.w = r14.w * r13.w;
    r14.w = dot(r36.xyz, r9.xyz);
    r14.w = saturate(r14.w + r36.w);
    r13.w = r14.w * r13.w;
    r14.w = dot(r37.xyz, r9.xyz);
    r14.w = saturate(r14.w + r37.w);
    r10.x = r14.w * r13.w;
    r13.w = (int)r8.z & 1;
    r15.zw = r13.ww ? r10.xy : r10.zx;
    r32.xy = r25.zw;
    r32.z = r26.z;
    r10.x = dot(r11.xyz, r32.xyz);
    r13.w = dot(r9.xyz, r32.xyz);
    r13.w = r13.w + -r26.w;
    r14.w = cmp(r13.w >= 0);
    ...
    r13.w = r14.w / r13.w;
    r10.x = min(abs(r13.w), r10.x);
    r27.z = r28.z;
    r13.w = dot(r11.xyz, r27.xyz);
    r14.w = dot(r9.xyz, r27.xyz);
    r14.w = r14.w + -r28.w;
    r17.w = cmp(r14.w >= 0);
    r14.w = max(abs(r14.w), r4.w);
    r14.w = r17.w ? r14.w : -r14.w;
    ...
    r26.x = r22.w;
    r26.yz = r23.zw;
    r26.xyz = r26.xyz + r9.xyz;
    r26.xyz = r11.xyz * r10.xxx + r26.xyz;
    ...
    r27.w = (uint)r20.y;
    r20.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r27.xyzw, r10.x).xyz;
    r25.yzw = (int3)r20.yzw & int3(-2147483648,-2147483648,-2147483648);
    r25.yzw = cmp((int3)r25.yzw == int3(2139095040,2139095040,2139095040));
    r10.x = (int)r25.z | (int)r25.y;
    r10.x = (int)r25.w | (int)r10.x;
    r20.yzw = r10.xxx ? float3(1,1,0) : r20.yzw;
    r26.x = dot(r9.xyz, r19.xyz);
    r26.y = dot(r9.xyz, r28.xyz);
    r26.z = dot(r9.xyz, r21.xyz);
    r22.xyz = saturate(r26.xyz * r22.xyz + float3(0.5,0.5,0.5));
    r23.z = r24.x;
    r22.xyz = r22.xyz * r23.xyz + r24.yzw;
    r27.x = dot(r2.xyz, r19.xyz);
    r27.y = dot(r2.xyz, r28.xyz);
    r27.z = dot(r2.xyz, r21.xyz);
    r19.xyz = cmp(float3(0,0,0) < r27.xyz);
    r12.z = r19.x ? 0 : 0.5;
    r21.xyz = r22.xyz + r12.xyz;
    ...
    while (true) {
      if (r12.z == 0) break;
      r13.z = firstbitlow((uint)r12.z);
      r13.z = 1 << (int)r13.z;
      r13.w = (int)r12.z & (int)r13.z;
      if (r13.w != 0) {
        r13.z = ~(int)r13.z;
        r12.z = (int)r12.z & (int)r13.z;
        if (r10.w != 0) {
          r13.z = r8.z;
          r27.xy = r15.zw;
          r13.w = 1;
          while (true) {
            r14.z = cmp((int)r13.w >= (int)r20.x);
            if (r14.z != 0) break;
            r14.z = (int)r12.w + (int)r13.w;
          // Known bad code for instruction (needs manual fix):
          ...
          r33.z = samp0[]..swiz;
          r33.w = samp0[]..swiz;
            r14.z = dot(r28.xyz, r9.xyz);
            r14.z = saturate(r14.z + r28.w);
            r14.z = r27.x * r14.z;
            r14.w = dot(r29.xyz, r9.xyz);
            r14.w = saturate(r14.w + r29.w);
            r14.z = r14.z * r14.w;
            r14.w = dot(r30.xyz, r9.xyz);
            r14.w = saturate(r14.w + r30.w);
            r14.z = r14.z * r14.w;
            r14.w = dot(r31.xyz, r9.xyz);
            r14.w = saturate(r14.w + r31.w);
            r14.z = r14.z * r14.w;
            r14.w = dot(r32.xyz, r9.xyz);
            ...
            r27.x = r14.z * r14.w;
            r17.w = (uint)r13.z >> 2;
            if (1 == 0) r19.z = 0; else if (1+2 < 32) {             r19.z = (uint)r13.z << (32-(1 + 2)); r19.z = (uint)r19.z >> (32-1);            } else r19.z = (uint)r13.z >> 2;
            r21.w = (int)r17.w & 2;
            r22.w = max(r27.y, r27.x);
            r14.z = -r14.z * r14.w + 1;
            r14.z = r27.y * r14.z;
            r15.y = r21.w ? r14.z : r22.w;
            r27.xy = r19.zz ? r27.xy : r15.xy;
            r13.w = (int)r13.w + 1;
            r13.z = r17.w;
          }
  ...
  if (r5.w == 0) {
      ...
      while (true) {
        ...
        r25.y = samp0[]..swiz;
          ...
          r32.w = samp0[]..swiz;
            ...
            r15.w = 1;
            while (true) {
              r17.w = cmp((int)r15.w >= (int)r13.w);
              if (r17.w != 0) break;
              r17.w = (int)r12.w + (int)r15.w;
            // Known bad code for instruction (needs manual fix):
            ...
            r33.w = samp0[]..swiz;
              ...
              r17.w = -r17.w * r19.w + 1;
              r17.w = r27.y * r17.w;
              r14.y = r27.z ? r17.w : r27.w;
              r27.xy = r26.ww ? r27.xy : r14.xy;
              r15.w = (int)r15.w + 1;
              r12.x = r24.w;
            }
            r27.y = saturate(r27.y);
            ...
            r38.x = samp0[]..swiz;
            r38.y = samp0[]..swiz;
              r23.z = r27.y * r10.z + r23.z;
              r10.x = r10.y * r25.z;
              r25.z = r33.z;
              r10.y = dot(r11.xyz, r25.xyz);
              r10.z = dot(r26.xyz, r25.xyz);
              r10.z = r10.z + -r33.w;
              r12.x = cmp(r10.z >= 0);
              ...
              r10.y = min(r10.y, abs(r10.z));
              r35.z = r36.z;
              r10.z = dot(r11.xyz, r35.xyz);
              r12.x = dot(r26.xyz, r35.xyz);
              r12.x = r12.x + -r36.w;
              r12.w = cmp(r12.x >= 0);
              r12.x = max(abs(r12.x), r4.w);
              r12.x = r12.w ? r12.x : -r12.x;
              ...
              r10.y = min(r10.y, abs(r10.z));
              r36.z = r37.x;
              r10.z = dot(r11.xyz, r36.xyz);
              r12.x = dot(r26.xyz, r36.xyz);
              r12.x = r12.x + -r37.y;
              r12.w = cmp(r12.x >= 0);
              r12.x = max(abs(r12.x), r4.w);
              r12.x = r12.w ? r12.x : -r12.x;
              ...
              r10.y = min(r10.y, abs(r10.z));
              r38.zw = r37.zw;
              r10.z = dot(r11.zxy, r38.xzw);
              r12.x = dot(r26.zxy, r38.xzw);
              r12.x = r12.x + -r38.y;
              r12.w = cmp(r12.x >= 0);
              r12.x = max(abs(r12.x), r4.w);
              r12.x = r12.w ? r12.x : -r12.x;
              ...
              if (9 == 0) r10.z = 0; else if (9+16 < 32) {               r10.z = (uint)r25.w << (32-(9 + 16)); r10.z = (uint)r10.z >> (32-9);              } else r10.z = (uint)r25.w >> 16;
              r33.w = (uint)r10.z;
              r14.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r33.xyzw, r10.y).xyz;
              r27.xzw = (int3)r14.yzw & int3(-2147483648,-2147483648,-2147483648);
              r27.xzw = cmp((int3)r27.xzw == int3(2139095040,2139095040,2139095040));
              r10.y = (int)r27.z | (int)r27.x;
              r10.y = (int)r27.w | (int)r10.y;
              r14.yzw = r10.yyy ? float3(1,1,0) : r14.yzw;
              ...
              r10.y = (int)r26.y | (int)r26.x;
              r10.y = (int)r26.z | (int)r10.y;
              r25.xyz = r10.yyy ? float3(1,1,0) : r25.xyz;
              r26.xyz = r25.xyz * r24.xyz;
              r10.y = dot(r26.xyz, float3(0.212599993,0.715200007,0.0722000003));
              ...
              r24.x = r22.w;
              r24.yz = r23.xy;
              r23.xyw = r14.zwy * r10.xxx + r24.yzx;
              r22.w = r23.w;
            }
          }
        }
          ...
          r26.y = samp0[]..swiz;
            ...
            r33.w = samp0[]..swiz;
              ...
              r35.w = samp0[]..swiz;
                ...
                r18.w = -r18.w * r22.w + 1;
                r18.w = r29.y * r18.w;
                r13.y = r27.w ? r18.w : r28.z;
                r29.xy = r25.ww ? r29.xy : r13.xy;
                r17.w = (int)r17.w + 1;
                r10.x = r24.w;
              }
              r10.x = saturate(r29.y + -r9.y);
              r13.y = r10.x * r13.w;
              r13.z = cmp(0 < r13.y);
              if (r13.z != 0) {
              // Known bad code for instruction (needs manual fix):
              ...
              r39.x = samp0[]..swiz;
              r39.y = samp0[]..swiz;
                r23.w = r10.x * r13.w + r23.w;
                r10.x = r13.y * r26.z;
                r26.z = r34.z;
                r12.w = dot(r11.xyz, r26.xyz);
                r13.y = dot(r27.xyz, r26.xyz);
                r13.y = r13.y + -r34.w;
                r13.z = cmp(r13.y >= 0);
                ...
                r12.w = min(abs(r13.y), r12.w);
                r36.z = r37.z;
                r13.y = dot(r11.xyz, r36.xyz);
                r13.z = dot(r27.xyz, r36.xyz);
                r13.z = r13.z + -r37.w;
                r13.w = cmp(r13.z >= 0);
                r13.z = max(abs(r13.z), r4.w);
                r13.z = r13.w ? r13.z : -r13.z;
                ...
                r12.w = min(abs(r13.y), r12.w);
                r37.z = r38.x;
                r13.y = dot(r11.xyz, r37.xyz);
                r13.z = dot(r27.xyz, r37.xyz);
                r13.z = r13.z + -r38.y;
                r13.w = cmp(r13.z >= 0);
                r13.z = max(abs(r13.z), r4.w);
                r13.z = r13.w ? r13.z : -r13.z;
                ...
                r12.w = min(abs(r13.y), r12.w);
                r39.zw = r38.zw;
                r13.y = dot(r11.zxy, r39.xzw);
                r13.z = dot(r27.zxy, r39.xzw);
                r13.z = r13.z + -r39.y;
                r13.w = cmp(r13.z >= 0);
                r13.z = max(abs(r13.z), r4.w);
                r13.z = r13.w ? r13.z : -r13.z;
                ...
                r25.y = r28.z;
                r25.z = r30.x;
                r34.x = dot(r13.yzw, r25.xyz);
                r26.xy = r28.xw;
                r26.z = r30.w;
                r34.y = dot(r13.yzw, r26.xyz);
                r30.x = r28.y;
                r34.z = dot(r13.yzw, r30.xyz);
                if (9 == 0) r13.y = 0; else if (9+16 < 32) {                 r13.y = (uint)r26.w << (32-(9 + 16)); r13.y = (uint)r13.y >> (32-9);                } else r13.y = (uint)r26.w >> 16;
                r34.w = (uint)r13.y;
                r13.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r34.xyzw, r12.w).xyz;
                r28.xyz = (int3)r13.yzw & int3(-2147483648,-2147483648,-2147483648);
                ...
                r12.z = (int)r27.y | (int)r27.x;
                r12.z = (int)r27.z | (int)r12.z;
                r26.xyz = r12.zzz ? float3(1,1,0) : r26.xyz;
                r27.xyz = r26.xyz * r25.xyz;
                r12.z = dot(r27.xyz, float3(0.212599993,0.715200007,0.0722000003));
                ...
                r10.x = r12.w / r10.x;
                r23.xyz = r13.yzw * r10.xxx + r23.xyz;
              }
            }
          }
        }
    ...
    if (r4.w != 0) {
      ...
      r1.w = r5.y * r1.w + r2.w;
      r18.xyz = r2.xyz * r1.www + r18.xyz;
    }
  } else {
    r18.x = r16.w;
  }
  r2.xyz = r16.xyz * r0.yzw + r4.xyz;
  r0.yzw = r16.xyz * r0.yzw + r6.xyz;
  ...
  r1.xyz = r18.xyz * r4.xxx + r1.xyz;
  r4.xyz = r18.xyz * r4.yyy + r7.xyz;
