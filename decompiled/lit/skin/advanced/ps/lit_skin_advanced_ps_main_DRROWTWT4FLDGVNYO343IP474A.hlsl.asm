...
sample_indexable(texture2d)(float,float,float,float) r1.w, r1.xyxx, t38.yzwx, s7
if_nz r1.z
  ...
  add r1.z, -cb0[14].x, cb0[14].y
  mad r1.z, r1.w, r1.z, cb0[14].x
...
mad r1.z, r4.w, cb0[12].z, r1.z
lt r3.w, l(0.000000), r1.w
sample_indexable(texture2d)(float,float,float,float) r4.xyz, r1.xyxx, t37.xyzw, s7
if_nz r3.w
  ...
  mad r3.xy, r1.xyxx, r1.wwww, r3.xyxx
  dp3 r1.x, r3.xyzx, r3.xyzx
  rsq r1.x, r1.x
  mul r3.xyz, r1.xxxx, r3.xyzx
  mad r1.z, r3.w, r1.w, r1.z
endif 
lt r1.x, l(0.000000), r0.z
if_nz r1.x
  sample_indexable(texture2d)(float,float,float,float) r1.xyw, v1.yzyy, t48.xywz, s5
  add r1.xyw, r1.xyxw, l(-0.500000, -0.500000, 0.000000, -0.000000)
  mad r1.xyw, cb0[11].wwww, r1.xyxw, l(0.500000, 0.500000, 0.000000, 0.000000)
  ...
  mad r3.xy, r1.xyxx, r0.zzzz, r3.xyxx
  dp3 r1.x, r3.xyzx, r3.xyzx
  rsq r1.x, r1.x
  mul r3.xyz, r1.xxxx, r3.xyzx
  mad r1.z, r1.w, r0.z, r1.z
endif 
...
mad r1.xyz, r1.xywx, r3.zzzz, r3.xywx
...
if_nz cb0[16].x
  ...
  ld_indexable(texture2d)(float,float,float,float) r1.w, r11.xyzw, t21.yzwx
  ge r3.w, r1.w, l(0.984375)
  mul r5.w, r1.w, l(1.01587307)
  mad r1.w, r1.w, l(64.000000), l(-63.000000)
  movc r1.w, r3.w, r1.w, r5.w
  ...
  sqrt r5.y, r5.y
  mad r5.z, |r1.w|, l(-0.01872930), l(0.074261)
  mad r5.z, r5.z, |r1.w|, l(-0.21211439)
  mad r5.z, r5.z, |r1.w|, l(1.57072878)
  mul r5.w, r5.y, r5.z
  mad r5.w, r5.w, l(-2.000000), l(3.14159274)
  lt r1.w, r1.w, -r1.w
  and r1.w, r1.w, r5.w
  mad r1.w, r5.z, r5.y, r1.w
...
mad o2.xyz, r2.xyzx, r0.yyyy, r7.xzwx
mad r0.z, r2.w, r0.y, r12.x
mad r1.xyz, r1.xyzx, r0.yyyy, r13.xyzx
dp3 r2.x, r1.xyzx, r1.xyzx
rsq r2.x, r2.x
mul r2.xyz, r1.xyzx, r2.xxxx
mad r1.y, r0.w, r0.y, r12.y
log r0.y, |r1.w|
...
if_nz r6.w
  ...
  if_nz r6.w
    ...
    mad r7.z, -r1.x, l(0.500000), l(1.000000)
...
mov r18.x, -r7.x
not r0.y, r1.z
mad r4.x, -r1.x, l(0.500000), l(1.000000)
...
mul r1.zw, r10.xxxy, l(0.000000, 0.000000, 0.500000, -0.500000)
rcp r10.z, r10.z
mad r10.xy, r1.zwzz, r10.zzzz, l(0.500000, 0.500000, 0.000000, 0.000000)
mov r12.xyz, -r8.xyzx
...
mul r1.zw, r4.xxxy, l(0.000000, 0.000000, 0.500000, -0.500000)
rcp r4.z, r4.z
mad r4.xy, r1.zwzz, r4.zzzz, r12.xyxx
...
rcp r1.z, r1.z
mul r0.w, r0.w, r1.z
mad r1.zw, r0.yyyy, l(0.000000, 0.000000, 0.500000, 0.500000), l(0.000000, 0.000000, 0.33333334, 1.000000)
mul r1.zw, r1.zzzw, l(0.000000, 0.000000, 0.11764706, 0.11764706)
mul r1.zw, r1.zzzw, r1.zzzw
mov x1[0].x, r1.z
mad r6.xyz, r10.xyzx, r1.zzzz, r8.xyzx
lt r7.xy, r0.wwww, r1.zwzz
...
mov x0[0].x, r4.w
mov x1[1].x, r1.w
mad r6.xyz, r4.xyzx, r1.wwww, r8.xyzx
mul r6.xy, r6.xyxx, cb1[44].xyxx
ftoi r9.xy, r6.xyxx
mov r9.zw, l(0,0,0,0)
ld_indexable(texture2d)(float,float,float,float) r5.w, r9.xyzw, t21.yzwx
...
if_nz r6.y
  ...
  mad r6.yz, r6.yyzy, r6.yyzy, -r1.zzwz
  mad r1.z, r4.w, r6.y, r1.z
  mov x1[0].x, r1.z
  mad r7.xyw, r10.xyxz, r1.zzzz, r8.xyxz
  lt r1.z, r0.w, r1.z
  ...
  mul r3.w, r3.w, r4.w
  movc r1.z, r1.z, r3.w, r4.w
  mov x0[0].x, r1.z
  mad r1.w, r6.x, r6.z, r1.w
  mov x1[1].x, r1.w
  mad r6.yzw, r4.xxyz, r1.wwww, r8.xxyz
  lt r1.w, r0.w, r1.w
...
if_z r1.z
  mad r1.zw, r0.yyyy, l(0.000000, 0.000000, 0.500000, 0.500000), l(0.000000, 0.000000, 2.33333325, 3.000000)
  mul r1.zw, r1.zzzw, l(0.000000, 0.000000, 0.11764706, 0.11764706)
  mov r3.w, x1[0].x
  mov r4.w, x0[0].x
  mad r1.z, r1.z, r1.z, -r3.w
  mad r1.z, r4.w, r1.z, r3.w
  mov x1[0].x, r1.z
  mad r6.xyz, r10.xyzx, r1.zzzz, r8.xyzx
  lt r1.z, r0.w, r1.z
  mul r6.xy, r6.xyxx, cb1[44].xyxx
...
if_z r1.z
  mad r1.zw, r0.yyyy, l(0.000000, 0.000000, 0.500000, 0.500000), l(0.000000, 0.000000, 3.33333325, 4.000000)
  mul r1.zw, r1.zzzw, l(0.000000, 0.000000, 0.11764706, 0.11764706)
  mov r3.w, x1[0].x
  mov r4.w, x0[0].x
  mad r1.z, r1.z, r1.z, -r3.w
...
if_z r1.z
  mad r1.zw, r0.yyyy, l(0.000000, 0.000000, 0.500000, 0.500000), l(0.000000, 0.000000, 4.33333349, 5.000000)
  mul r1.zw, r1.zzzw, l(0.000000, 0.000000, 0.11764706, 0.11764706)
  mov r3.w, x1[0].x
  mov r4.w, x0[0].x
  mad r1.z, r1.z, r1.z, -r3.w
...
if_z r1.z
  mad r1.zw, r0.yyyy, l(0.000000, 0.000000, 0.500000, 0.500000), l(0.000000, 0.000000, 5.33333349, 6.000000)
  mul r1.zw, r1.zzzw, l(0.000000, 0.000000, 0.11764706, 0.11764706)
  mov r3.w, x1[0].x
  mov r4.w, x0[0].x
  mad r1.z, r1.z, r1.z, -r3.w
...
if_z r1.z
  mad r1.zw, r0.yyyy, l(0.000000, 0.000000, 0.500000, 0.500000), l(0.000000, 0.000000, 6.33333349, 7.000000)
  mul r1.zw, r1.zzzw, l(0.000000, 0.000000, 0.11764706, 0.11764706)
  mov r3.w, x1[0].x
  mov r4.w, x0[0].x
  mad r1.z, r1.z, r1.z, -r3.w
...
if_z r1.z
  mad r1.zw, r0.yyyy, l(0.000000, 0.000000, 0.500000, 0.500000), l(0.000000, 0.000000, 7.33333349, 8.000000)
  mul r1.zw, r1.zzzw, l(0.000000, 0.000000, 0.11764706, 0.11764706)
  mov r0.y, x1[0].x
  mov r3.w, x0[0].x
  mad r1.z, r1.z, r1.z, -r0.y
  mad r0.y, r3.w, r1.z, r0.y
  mad r6.xyz, r10.xyzx, r0.yyyy, r8.xyzx
  lt r0.y, r0.w, r0.y
  mul r6.xy, r6.xyxx, cb1[44].xyxx
  ftoi r9.xy, r6.xyxx
  mov r9.zw, l(0,0,0,0)
  ld_indexable(texture2d)(float,float,float,float) r1.z, r9.xyzw, t21.yzxw
...
movc r0.w, r0.w, l(-0.500000), -r1.z
add r0.y, r0.w, r0.y
...
mad r1.z, r0.y, l(5.000000), l(-2.500000)
...
if_nz r1.z
  ...
  mad r9.xyz, r18.xyzx, r0.yyyy, r2.xyzx
  mov r11.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r2.xyz, r11.xyzw, t8.xyzw, s2, r0.w
  mad r0.y, cb2[19].x, r1.z, -r1.w
  mad r0.y, r1.y, r0.y, r1.w
  mad r10.xyz, r2.xyzx, r0.yyyy, r10.xyzx
endif 
mad r2.xyz, r9.xyzx, r5.xyzx, r6.xyzx
mad r5.xyz, r9.xyzx, r5.xyzx, r7.xyzx
mad r0.yw, r1.xxxy, l(0.000000, 0.984375, 0.000000, 0.984375), l(0.000000, 0.00781250, 0.000000, 0.00781250)
sample_l_indexable(texture2d)(float,float,float,float) r0.yw, r0.ywyy, t5.zxwy, s2, l(0.000000)
mad r1.xyz, r10.xyzx, r0.yyyy, r4.xyzx
...
if_nz r0.w
  ...
  mul r0.w, r0.w, r4.w
  mad r1.xyz, -r1.xyzx, r0.yyyy, r4.xyzx
  mad r2.xyz, r0.wwww, r1.xyzx, r3.xyzx
endif 
...
mul o2.w, r0.x, r0.z
ret 
// Approximately 3632 instruction slots used
