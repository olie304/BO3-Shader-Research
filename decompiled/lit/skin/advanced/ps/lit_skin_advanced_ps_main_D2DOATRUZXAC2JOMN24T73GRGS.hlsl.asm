...
sample_indexable(texture2d)(float,float,float,float) r1.yzw, v1.yzyy, t22.wxyz, s5
...
sample_indexable(texture2d)(float,float,float,float) r3.xyz, r3.xyxx, t26.xyzw, s5
...
if_nz cb0[11].w
  ...
  ld_indexable(texture2d)(float,float,float,float) r1.w, r10.xyzw, t0.yzwx
  ...
  ld_indexable(texture2d)(float,float,float,float) r1.w, r12.xyzw, t0.yzwx
  ge r2.w, r1.w, l(0.984375)
  mul r3.w, r1.w, l(1.01587307)
  mad r1.w, r1.w, l(64.000000), l(-63.000000)
  movc r1.w, r2.w, r1.w, r3.w
  ...
  ld_indexable(texture2d)(float,float,float,float) r1.w, r13.xyzw, t0.yzwx
  ge r2.w, r1.w, l(0.984375)
  mul r3.w, r1.w, l(1.01587307)
  mad r1.w, r1.w, l(64.000000), l(-63.000000)
  movc r1.w, r2.w, r1.w, r3.w
  ...
  sqrt r4.y, r4.y
  mad r5.x, |r1.w|, l(-0.01872930), l(0.074261)
  mad r5.x, r5.x, |r1.w|, l(-0.21211439)
  mad r5.x, r5.x, |r1.w|, l(1.57072878)
  mul r5.y, r4.y, r5.x
  mad r5.y, r5.y, l(-2.000000), l(3.14159274)
  lt r1.w, r1.w, -r1.w
  and r1.w, r1.w, r5.y
  mad r1.w, r5.x, r4.y, r1.w
  mad r1.y, -r2.w, r3.w, -r1.y
  max r1.y, r1.y, l(-1.570800)
  mad r1.y, r2.w, r3.w, r1.y
  mad r1.w, -r2.w, r3.w, r1.w
  min r1.w, r1.w, l(1.570800)
  mad r1.w, r2.w, r3.w, r1.w
    ...
    if_nz r10.z
      ...
      if_nz r10.y
        ...
        if_nz r12.x
          ...
          mov r31.z, r32.z
          dp3 r10.z, r11.xyzx, r31.xyzx
          dp3 r12.x, r24.xyzx, r31.xyzx
          ...
          mov r32.z, r33.z
          dp3 r10.z, r11.xyzx, r32.xyzx
          dp3 r12.x, r24.xyzx, r32.xyzx
          ...
          min r10.y, |r10.z|, r10.y
          mov r36.zw, r35.zzzw
          dp3 r10.z, r11.zxyz, r36.xzwx
          dp3 r12.x, r24.zxyz, r36.xzwx
          ...
          utof r31.w, r10.z
          sample_l_indexable(texturecubearray)(float,float,float,float) r14.yzw, r31.xyzw, t8.wxyz, s2, r10.y
          ...
          mov r22.x, r20.w
          mov r22.yz, r21.xxyx
          mad r21.xyw, r14.zwzy, r10.xxxx, r22.yzyx
          mov r20.w, r21.w
        endif 
      endif 
    endif 
...
if_nz r8.x
    ...
    loop 
      ...
      if_nz r13.w
        ...
        if_nz r13.z
          ...
          mul r10.x, r17.w, r20.w
          and r17.w, r13.z, l(1)
          movc r26.xy, r17.wwww, r10.xyxx, r10.zxzz
          mov r10.x, r13.z
          mov r27.xy, r26.xyxx
          mov r17.w, l(1)
          loop 
            ...
            movc r13.y, r26.z, r20.w, r26.w
            movc r27.xy, r25.wwww, r27.xyxx, r13.xyxx
            iadd r17.w, r17.w, l(1)
            mov r10.x, r23.w
          endloop 
          add_sat r10.x, -r9.y, r27.y
          ...
          if_nz r13.z
            ...
            mad r21.w, r10.x, r13.w, r21.w
            mul r10.x, r24.z, r13.y
            mov r24.z, r32.z
            dp3 r12.w, r11.xyzx, r24.xyzx
            ...
            mov r23.y, r26.z
            mov r23.z, r28.x
            dp3 r32.x, r13.yzwy, r23.xyzx
            mov r24.xy, r26.xwxx
            mov r24.z, r28.w
            dp3 r32.y, r13.yzwy, r24.xyzx
            mov r28.x, r26.y
            dp3 r32.z, r13.yzwy, r28.xyzx
            ubfe r13.y, l(9), l(16), r24.w
            utof r32.w, r13.y
            sample_l_indexable(texturecubearray)(float,float,float,float) r13.yzw, r32.xyzw, t8.wxyz, s2, r12.w
            ...
            movc r15.z, r23.z, l(0), l(0.500000)
            ...
            dp3 r12.z, r25.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
            mad r22.xyz, r23.xyzx, r24.xyzx, r22.xyzx
            ...
            mad r21.xyz, r13.yzwy, r10.xxxx, r21.xyzx
          endif 
        endif 
      endif 
    endloop 
  ...
  endloop 
  mov r19.xyzw, r16.zxyw
  mov r18.xyz, r20.xyzx
  mov r19.xyzw, r19.yzxw
else 
  mov r19.x, r18.w
endif 
max r1.w, r19.w, l(1.000000)
rcp r1.w, r1.w
mov_sat r19.w, r19.w
mul r8.xyz, r1.wwww, r18.xyzx
mul r9.xyz, r1.wwww, r19.xyzx
...
if_nz r4.w
  ...
  mad r8.xyz, r18.xyzx, r1.wwww, r2.xyzx
  mov r11.w, l(0)
...
mad r2.xyz, r8.xyzx, r0.yzwy, r4.xyzx
mad r0.yzw, r8.xxyz, r0.yyzw, r6.xxyz
...
mad r1.xyz, r9.xyzx, r4.xxxx, r1.xyzx
mad r4.xyz, r9.xyzx, r4.yyyy, r7.xyzx
...
mov o2.w, r0.x
ret 
// Approximately 3564 instruction slots used
