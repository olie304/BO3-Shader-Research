...
sample_indexable(texture2d)(float,float,float,float) r0.w, v2.xyxx, t37.yzwx, s7
mad_sat r0.y, r0.y, l(0.998000), l(0.001000)
add r1.x, -r0.y, l(1.000000)
mov_sat r1.y, cb0[14].w
log r0.y, r0.y
mul r0.y, r0.y, r1.y
exp r0.y, r0.y
mov r2.x, -r0.y
...
mul r0.y, r0.y, r1.y
exp r2.y, r0.y
mad_sat r1.xy, cb0[14].zzzz, r2.xyxx, r1.xxxx
add r0.y, r0.w, -r1.x
add r0.w, -r1.x, r1.y
div_sat r0.y, r0.y, r0.w
mul r1.xy, v2.xyxx, cb0[15].xyxx
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, v2.xyxx, t21.xyzw, s1
...
sample_indexable(texture2d)(float,float,float,float) r3.xyzw, r1.xyxx, t26.xyzw, s7
sample_indexable(texture2d)(float,float,float,float) r4.x, r1.xyxx, t30.xyzw, s7
if_nz r1.w
...
mad r4.xy, r3.xyxx, l(1.99218750, 1.99218750, 0.000000, 0.000000), l(-1.000000, -1.000000, 0.000000, 0.000000)
...
mad r4.xyz, r3.xyzx, r4.zzzz, r4.xywx
      ...
      if_nz r13.w
        ...
        if_nz r13.w
          ...
          if_nz r13.w
            ...
            add r14.w, -r13.w, l(1.000000)
            mul r18.xyz, r11.xyzx, r14.wwww
            mad r11.xyz, r17.xyzx, r13.wwww, r18.xyzx
...
mad r2.xyz, r2.xyzx, r1.xxxx, r12.xyzx
mad o0.w, r2.w, r1.x, r4.w
mad r4.xyz, r4.xyzx, r1.xxxx, r13.xyzx
dp3 r1.z, r4.xyzx, r4.xyzx
rsq r1.z, r1.z
mul r4.xyz, r1.zzzz, r4.xyzx
mad r6.y, r1.y, r1.x, r5.z
mad r1.yzw, r1.xxxx, l(0.000000, 0.040000, 0.040000, 0.040000), r14.xxyz
add r5.zw, r0.yyyy, l(0.000000, 0.000000, -0.010000, -0.800000)
...
exp r2.w, r2.w
max r3.w, r5.w, l(0.000000)
mad r5.z, r3.w, l(-2.000000), l(3.000000)
mul r3.w, r3.w, r3.w
mad r3.w, -r5.z, r3.w, l(1.000000)
log r3.w, r3.w
mul r3.w, r3.w, cb0[18].z
exp r3.w, r3.w
mul r2.w, r2.w, r3.w
mad_sat r0.y, r2.w, l(0.990000), -r0.y
mul r0.y, r0.y, cb0[15].z
mov_sat r0.x, r0.x
mul r0.x, r0.x, r0.y
eq r7.xyz, r0.zzzz, l(3.000000, 2.000000, 1.000000, 0.000000)
movc r10.xyz, r7.zzzz, cb0[20].xyzx, cb0[16].xyzx
movc r7.yzw, r7.yyyy, cb0[21].xxyz, r10.xxyz
movc r7.xyz, r7.xxxx, cb0[22].xyzx, r7.yzwy
mul r0.yz, cb0[18].xxyx, cb1[69].wwww
mad r0.yz, v2.xxyx, cb0[17].yyzy, r0.yyzy
dp3 r2.w, -v7.xyzx, -v7.xyzx
rsq r2.w, r2.w
mul r10.xyz, r2.wwww, -v7.xyzx
dp3_sat r3.x, r10.xyzx, r3.xyzx
sample_indexable(texture2d)(float,float,float,float) r11.xyzw, r0.yzyy, t38.xyzw, s1
mul r3.yzw, r7.xxyz, r11.xxyz
log r0.y, r3.x
...
exp r0.z, r0.z
movc r0.y, cb0[17].x, r0.z, r0.y
eq r0.z, cb0[15].w, l(0.000000)
...
dp3 r3.y, -r10.xyzx, r4.xyzx
add r3.y, r3.y, r3.y
mad r12.xyz, r4.xyzx, -r3.yyyy, -r10.xyzx
...
mad r6.zw, -r3.wwww, l(0.000000, 0.000000, 10.000000, 5.000000), l(0.000000, 0.000000, 6.857410, 7.085000)
exp r6.z, r6.z
mul r6.z, r6.z, r6.x
mul r7.w, r3.w, r5.z
    ...
    if_nz r14.z
      ...
      if_nz r14.y
        ...
        if_nz r15.x
          ...
          sqrt r14.y, r14.y
          mad r14.y, r3.w, l(5.000000), r14.y
...
mad r5.zw, r6.xxxy, l(0.000000, 0.000000, 0.984375, 0.984375), l(0.000000, 0.000000, 0.00781250, 0.00781250)
sample_l_indexable(texture2d)(float,float,float,float) r5.zw, r5.zwzz, t5.zwxy, s2, l(0.000000)
mul r6.yzw, r3.wwww, r13.xxyz
mul r13.xyz, r5.zzzz, r6.zwyz
...
if_nz r5.w
  ...
  if_nz r5.w
    ...
    if_nz cb2[23].x
      mov r8.w, l(1.000000)
      dp4 r9.w, cb2[24].xyzw, r8.xyzw
      dp4 r8.x, cb2[25].xyzw, r8.xyzw
      frc r15.x, r9.w
      frc r15.y, r8.x
      iadd r8.x, l(-1), cb2[23].x
      utof r15.z, r8.x
    ...
    if_nz r9.w
      ...
      mad r19.xyz, r4.xyzx, r10.wwww, v7.xyzx
    ...
    add r8.w, -r5.z, r8.w
    mad r8.w, r3.z, r8.w, r5.z
    mul r8.w, r7.w, r8.w
    lt r4.w, l(0.000000), r4.w
    mad r15.xyz, r8.wwww, r8.xyzx, r14.xyzx
    mad r11.yzw, -v7.xxyz, r2.wwww, cb2[17].xxyz
    dp3 r2.w, r11.yzwy, r11.yzwy
    rsq r2.w, r2.w
    mul r11.yzw, r2.wwww, r11.yyzw
    dp3 r2.w, r11.yzwy, r10.xyzx
    dp3 r8.w, r4.xyzx, r11.yzwy
    mad r9.w, |r8.w|, r3.y, -|r8.w|
    mad r8.w, |r8.w|, r9.w, l(1.000000)
    mad r5.z, r5.z, r0.w, r3.w
    mul r8.w, r8.w, r8.w
    mul r5.z, r5.z, r8.w
    rcp r5.z, r5.z
    mul r5.z, r5.w, r5.z
    ...
    mad r11.yzw, r5.zzzz, r8.xxyz, r6.yyzw
    add_sat r2.w, -r2.w, l(1.000000)
    mul r5.w, r2.w, r2.w
    mul r5.w, r5.w, r5.w
    mul r2.w, r2.w, r5.w
    mul r2.w, r2.w, r5.z
    mad r8.xyz, r2.wwww, r8.yzxy, r13.xyzx
    mov r15.w, r8.z
    mov r14.w, r13.z
    movc r14.xyzw, r4.wwww, r15.xyzw, r14.xyzw
    mov r8.zw, r11.yyyz
    mov r13.zw, r6.yyyz
    movc r8.xyzw, r4.wwww, r8.xyzw, r13.xyzw
...
loop 
  ...
  ld_indexable(texture2darray)(uint,uint,uint,uint) r6.x, r16.xyzw, t6.xyzw
          ...
          if_nz r24.w
            ...
            if_nz r24.w
              ...
              if_nz r24.w
                ...
                mad r41.xyz, r4.xyzx, r24.wwww, v7.xyzx
                ...
                loop 
                  ige r28.w, r27.w, l(8)
                  breakc_nz r28.w
                  dp2 r43.y, icb[r27.w + 0].yxyy, r8.xyxx
                  dp2 r43.z, icb[r27.w + 0].yxyy, r8.yzyy
              ...
              if_nz r24.w
                ...
                if_nz r14.w
                  ...
                  mad r18.xyz, r4.xyzx, r25.wwww, v7.xyzx
                    ...
                    if_z r18.z
                      ...
                      if_nz r7.w
                        ...
                        loop 
                          ige r27.w, r25.w, l(8)
                          breakc_nz r27.w
                          dp2 r41.x, icb[r25.w + 0].xyxx, r7.xyxx
                          dp2 r41.y, icb[r25.w + 0].yxyy, r7.xzxx
                ...
                mad r18.x, |r15.w|, r3.y, -|r15.w|
                mad r15.w, |r15.w|, r18.x, l(1.000000)
                mad r18.x, r13.w, r0.w, r3.w
          ...
          if_nz r15.z
            ...
            if_nz r15.z
              ...
              if_nz r15.z
                ...
                mad r21.xyz, r4.xyzx, r15.zzzz, v7.xyzx
...
mad r1.xyz, r28.xyzx, r1.yzwy, r3.xyzx
