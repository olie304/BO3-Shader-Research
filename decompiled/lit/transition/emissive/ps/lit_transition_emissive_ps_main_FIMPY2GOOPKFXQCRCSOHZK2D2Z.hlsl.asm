...
sample_indexable(texture2d)(float,float,float,float) r3.y, r1.xyxx, t30.yxzw, s7
if_nz r3.x
  add r3.xzw, cb0[13].xxyz, l(-1.000000, 0.000000, -1.000000, -1.000000)
  mad r3.xzw, r4.wwww, r3.xxzw, l(1.000000, 0.000000, 1.000000, 1.000000)
  add r5.x, -cb0[14].x, cb0[14].y
  mad r3.y, r3.y, r5.x, cb0[14].x
  mul_sat r3.y, r3.y, l(0.05882353)
  mul r4.w, r0.z, r4.w
  mad r3.xzw, r4.xxyz, r3.xxzw, -r2.xxyz
  mad r2.xyz, r4.wwww, r3.xzwx, r2.xyzx
...
if_nz r4.x
  add r4.xyz, r5.xyzx, l(-0.500000, -0.500000, -0.000000, 0.000000)
  mad r4.xyz, cb0[13].wwww, r4.xyzx, l(0.500000, 0.500000, 0.000000, 0.000000)
  mad r1.xy, r4.xyxx, l(1.99218750, 1.99218750, 0.000000, 0.000000), l(-1.000000, -1.000000, 0.000000, 0.000000)
  mul r4.x, r4.z, r4.z
  mul r4.x, r4.x, l(0.33333334)
  min r4.x, r4.x, l(1.000000)
  mad r3.xy, r1.xyxx, r4.wwww, r3.xyxx
  dp3 r1.x, r3.xywx, r3.xywx
  rsq r1.x, r1.x
  mul r3.xyw, r1.xxxx, r3.xyxw
  mad r3.z, r4.x, r4.w, r3.z
endif 
...
mad r2.xyz, r2.xyzx, r0.yyyy, r13.xyzx
mad o0.w, r2.w, r0.y, r12.x
mad r3.xyz, r3.xyzx, r0.yyyy, r14.xyzx
dp3 r1.x, r3.xyzx, r3.xyzx
rsq r1.x, r1.x
mul r3.xyz, r1.xxxx, r3.xyzx
mad r1.y, r1.y, r0.y, r12.y
mad r6.xyz, r0.yyyy, l(0.040000, 0.040000, 0.040000, 0.000000), r15.xyzx
add r5.zw, r0.zzzz, l(0.000000, 0.000000, -0.010000, -0.800000)
mul r5.zw, r5.zzzw, l(0.000000, 0.000000, 1.26582277, 5.00000048)
mov_sat r5.z, r5.z
mad r2.w, r5.z, l(-2.000000), l(3.000000)
mul r4.w, r5.z, r5.z
mul r2.w, r2.w, r4.w
log r2.w, r2.w
...
sample_indexable(texture2d)(float,float,float,float) r9.xyzw, r0.zwzz, t38.xyzw, s1
mul r4.yzw, r7.xxyz, r9.xxyz
log r0.z, r4.x
...
dp3_sat r1.x, r3.xyzx, r8.xyzx
dp3 r4.y, -r8.xyzx, r3.xyzx
add r4.y, r4.y, r4.y
mad r11.xyz, r3.xyzx, -r4.yyyy, -r8.xyzx
mul r4.y, r1.y, l(17.000000)
exp r4.y, r4.y
...
mad r6.w, r1.x, r3.w, r4.w
mul r3.w, r3.w, r6.w
mul r4.w, r4.w, r6.w
dp3 r6.w, r3.xyzx, cb2[17].xyzx
mov_sat r7.z, r6.w
...
if_nz r7.w
  ...
  if_nz r7.w
    ...
    if_nz r11.w
      ...
      mad r18.xyz, r3.xyzx, r12.wwww, v6.xyzx
    ...
    add r9.w, -r7.z, r9.w
    mad r9.w, r4.z, r9.w, r7.z
    mul r9.w, r8.w, r9.w
    lt r6.w, l(0.000000), r6.w
    mad r14.xyz, r9.wwww, r10.yzwy, r5.xyzx
    ...
    mov r14.w, r16.z
    mov r5.w, r13.z
    movc r5.xyzw, r6.wwww, r14.xyzw, r5.xyzw
    mov r16.zw, r15.xxxy
    mov r13.zw, r1.yyyz
    movc r14.xyzw, r6.wwww, r16.xyzw, r13.xyzw
    movc r1.w, r6.w, r15.z, r1.w
    mov r13.z, r5.w
    mov r13.xy, r14.xyxx
    mov r1.yz, r14.zzwz
  endif 
          ...
          if_nz r24.w
            ...
            if_nz r24.w
              ...
              if_nz r24.w
                ...
                mad r41.xyz, r3.xyzx, r24.wwww, v6.xyzx
...
mad r1.xyz, r28.xyzx, r6.xyzx, r1.xyzx
