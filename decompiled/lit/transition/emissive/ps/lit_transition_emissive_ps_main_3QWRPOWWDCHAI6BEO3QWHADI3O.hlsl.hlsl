...
r0.x = samp0[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) r0.y, r0.x, l(0), t0.xxxx
r0.y = samp0[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) r0.xz, r0.x, l(36), t0.xxyx
r0.x = samp0[]..swiz;
r0.z = samp0[]..swiz;
  r0.w = transRevealMap.Sample(transitionSampler_s, v2.xy).x;
  r0.y = saturate(r0.y * 0.998000026 + 0.00100000005);
  r1.x = 1 + -r0.y;
  r1.y = saturate(transRevealRamp);
  r0.y = log2(r0.y);
  r0.y = r1.y * r0.y;
  r0.y = exp2(r0.y);
  r2.x = -r0.y;
  ...
  r0.y = r1.y * r0.y;
  r2.y = exp2(r0.y);
  r1.xy = saturate(transRevealSoftEdge * r2.xy + r1.xx);
  r0.y = -r1.x + r0.w;
  r0.w = r1.y + -r1.x;
  r0.y = saturate(r0.y / r0.w);
  r1.xy = transScale.xy * v2.xy;
  ...
  r1.w = cmp(0 < r0.y);
  r3.xyzw = transColorMap.Sample(transitionSampler_s, r1.xy).xyzw;
  r4.x = transGlossMap.Sample(transitionSampler_s, r1.xy).x;
  if (r1.w != 0) {
    r4.yzw = float3(-1,-1,-1) + transColorTint.xyz;
    r4.yzw = r3.www * r4.yzw + float3(1,1,1);
    r1.w = transGlossRange.y + -transGlossRange.x;
    r1.w = r4.x * r1.w + transGlossRange.x;
    r1.w = saturate(0.0588235296 * r1.w);
    r3.w = r3.w * r0.y;
    r3.xyz = r3.xyz * r4.yzw + -r2.xyz;
  ...
  r4.xy = r3.xy * float2(1.9921875,1.9921875) + float2(-1,-1);
  ...
  r1.z = min(15, r1.z);
  r1.z = (uint)r1.z;
  r9.xy = (uint2)r5.yx >> int2(6,6);
  r9.z = (uint)r1.z << 4;
  r1.z = numStaticDecals & -32;
  r3.w = (int)-r1.z + numStaticDecals;
  r10.xy = float2(0,0);
  r11.w = 0;
  r8.w = 1;
  ...
  while (true) {
    ...
    r7.w = cmp((int)r1.z == (int)r5.w);
    if (r3.w == 0) r9.w = 0; else if (r3.w+0 < 32) {     r9.w = (uint)r6.w << (32-(r3.w + 0)); r9.w = (uint)r9.w >> (32-r3.w);    } else r9.w = (uint)r6.w >> 0;
    r6.w = r7.w ? r9.w : r6.w;
        ...
        r19.z = samp0[]..swiz;
          ...
          r22.w = samp0[]..swiz;
            ...
            r19.w = samp0[]..swiz;
              ...
              r14.w = 1 + -r13.w;
              r18.xyz = r14.www * r11.xyz;
              r11.xyz = r17.xyz * r13.www + r18.xyz;
  ...
  r4.w = saturate(r4.w);
  r1.x = 1 + -r4.w;
  r2.xyz = r2.xyz * r1.xxx + r12.xyz;
  o0.w = r2.w * r1.x + r4.w;
  r4.xyz = r4.xyz * r1.xxx + r13.xyz;
  r1.z = dot(r4.xyz, r4.xyz);
  r1.z = rsqrt(r1.z);
  r4.xyz = r4.xyz * r1.zzz;
  r6.y = r1.y * r1.x + r5.z;
  r1.yzw = r1.xxx * float3(0.0399999991,0.0399999991,0.0399999991) + r14.xyz;
  r5.zw = float2(-0.00999999978,-0.800000012) + r0.yy;
  r5.zw = float2(1.26582277,5.00000048) * r5.zw;
  r5.z = saturate(r5.z);
  r2.w = r5.z * -2 + 3;
  r3.w = r5.z * r5.z;
  r2.w = r3.w * r2.w;
  ...
  r3.w = exp2(r3.w);
  r2.w = r3.w * r2.w;
  r0.y = saturate(r2.w * 0.99000001 + -r0.y);
  r0.y = hdrScale * r0.y;
  r0.x = saturate(r0.x);
  r0.x = r0.y * r0.x;
  r7.xyz = cmp(r0.zzz == float3(3,2,1));
  r10.xyz = r7.zzz ? tint1.xyz : emissiveTint1.xyz;
  r7.yzw = r7.yyy ? tint2.xyz : r10.xyz;
  r7.xyz = r7.xxx ? tint3.xyz : r7.yzw;
  r0.yz = gameTime.ww * emissiveScrollUVs.xy;
  r0.yz = v2.xy * invertFalloff + r0.yz;
  r2.w = dot(-v7.xyz, -v7.xyz);
  r2.w = rsqrt(r2.w);
  r10.xyz = -v7.xyz * r2.www;
  r3.x = saturate(dot(r10.xyz, r3.xyz));
  r11.xyzw = emissiveMap.Sample(colorSampler_s, r0.yz).xyzw;
  r3.yzw = r11.xyz * r7.xyz;
  r0.y = log2(r3.x);
  r0.y = emissiveFalloffPower * r0.y;
  r0.y = exp2(r0.y);
  r0.z = 1 + -r3.x;
  r0.z = log2(r0.z);
  r0.z = emissiveFalloffPower * r0.z;
  r0.z = exp2(r0.z);
  r0.y = invertFalloff ? r0.z : r0.y;
  r0.z = cmp(emissiveFalloffPower == 0.000000);
  r0.y = r0.z ? 1 : r0.y;
  r0.x = r11.w * r0.x;
  r0.x = r0.x * r0.y;
  r0.x = r0.x * r1.x;
  ...
  r5.w = 100 * r5.w;
  r6.zw = -r3.ww * float2(10,5) + float2(6.85740995,7.08500004);
  r6.z = exp2(r6.z);
  r6.z = r6.x * r6.z;
  r7.w = r5.z * r3.w;
  ...
  while (true) {
    ...
    bitmask.w = ((~(-1 << r9.w)) << 0) & 0xffffffff;  r13.w = (((uint)0 << 0) & bitmask.w) | ((uint)r11.w & ~bitmask.w);
  ...
  if (r10.w != 0) {
    ...
    r13.w = 0;
    while (true) {
      r15.w = cmp((uint)r13.w >= (uint)r6.w);
      if (r15.w != 0) break;
      r13.z = (uint)r13.w >> 5;
      r14.xyz = (int3)r9.xyz + (int3)r13.xyz;
      r13.z = visibleProbes.Load(r14.xyzw).x;
      r14.x = cmp((int)r7.w == (int)r13.w);
      if (r9.w == 0) r14.y = 0; else if (r9.w+0 < 32) {       r14.y = (uint)r13.z << (32-(r9.w + 0)); r14.y = (uint)r14.y >> (32-r9.w);      } else r14.y = (uint)r13.z >> 0;
  ...
  if (r5.w != 0) {
    ...
    r11.yzw = r20.xyz * r3.www + r14.xyz;
    r12.w = 0;
    r14.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r12.xyzw, r5.z).xyz;
    r3.w = sunConstants.globalProbeExposure * r5.w + -r4.w;
    r3.w = r6.y * r3.w + r4.w;
    r13.xyz = r14.xyz * r3.www + r13.xyz;
  }
  r3.w = r6.x + r0.w;
  r3.w = log2(abs(r3.w));
  r3.w = r3.z * r3.w;
  ...
  r5.zw = r6.xy * float2(0.984375,0.984375) + float2(0.0078125,0.0078125);
  r5.zw = gEnvBRDFGeneric.SampleLevel(samplerLinear_s, r5.zw, 0).xy;
  r6.yzw = r13.xyz * r3.www;
  r13.xyz = r6.zwy * r5.zzz;
  r6.yzw = r6.yzw * r5.www;
  r0.w = sqrt(r3.z);
  r0.w = r0.w * 0.5 + 0.5;
  r0.w = r0.w * r0.w;
  r3.w = 0.5 * r0.w;
  ...
  if (r5.w != 0) {
    ...
    if (r5.w != 0) {
      ...
      if (sunConstants.sunCookieIndex != 0) {
        r8.w = 1;
        r9.w = dot(sunConstants.sunCookieTransform[0].xyzw, r8.xyzw);
        r8.x = dot(sunConstants.sunCookieTransform[1].xyzw, r8.xyzw);
        r15.x = frac(r9.w);
        r15.y = frac(r8.x);
        r8.x = -1 + (int14)sunConstants.sunCookieIndex;
        r15.z = (uint)r8.x;
      ...
      r8.w = r8.w * r7.w;
      r4.w = cmp(0 < r4.w);
      r15.xyz = r8.www * r8.xyz + r14.xyz;
      r11.yzw = -v7.xyz * r2.www + sunConstants.wldDir.xyz;
      r2.w = dot(r11.yzw, r11.yzw);
      r2.w = rsqrt(r2.w);
      r11.yzw = r11.yzw * r2.www;
      r2.w = dot(r11.yzw, r10.xyz);
      r8.w = dot(r4.xyz, r11.yzw);
      r9.w = abs(r8.w) * r3.y + -abs(r8.w);
      ...
      r5.z = r7.w * r5.z;
      r5.z = 0.25 * r5.z;
      r11.yzw = r5.zzz * r8.xyz + r6.yzw;
      r2.w = saturate(1 + -r2.w);
      r5.w = r2.w * r2.w;
      r5.w = r5.w * r5.w;
      r2.w = r5.w * r2.w;
      r2.w = r5.z * r2.w;
      r8.xyz = r2.www * r8.yzx + r13.xyz;
      r15.w = r8.z;
      r14.w = r13.z;
      r14.xyzw = r4.wwww ? r15.xyzw : r14.xyzw;
      r8.zw = r11.yz;
      r13.zw = r6.yz;
      r8.xyzw = r4.wwww ? r8.xyzw : r13.xyzw;
      r6.w = r4.w ? r11.w : r6.w;
      r13.z = r14.w;
      r13.xy = r8.xy;
      r6.yz = r8.zw;
    }
  ...
  while (true) {
    ...
    r6.x = visibleLights.Load(r16.xyzw).x;
    r16.xyz = r11.yzw;
    r29.xyz = r27.xyz;
    r30.xyz = r28.xyz;
    r7.w = r5.z;
              ...
              if (r24.w != 0) {
                ...
                if (r24.w != 0) {
                  ...
                  while (true) {
                    ...
                    if (r28.w != 0) break;
                    r43.y = dot(icb[r27.w+0].yx, r8.xy);
                    r43.z = dot(icb[r27.w+0].yx, r8.yz);
                ...
                if (r24.w != 0) {
                    ...
                    r13.w = samp0[]..swiz;
                      ...
                      if (r7.w != 0) {
                        ...
                        while (true) {
                          ...
                          if (r25.w != 0) break;
                          r42.x = dot(icb[r18.z+0].yx, r8.xw);
                      ...
                      r13.w = samp0[]..swiz;
                        ...
                        if (r7.w != 0) {
                          ...
                          while (true) {
                            ...
                            if (r27.w != 0) break;
                            r41.x = dot(icb[r25.w+0].xy, r7.xy);
                            r41.y = dot(icb[r25.w+0].yx, r7.xz);
                  ...
                  r18.x = abs(r15.w) * r3.y + -abs(r15.w);
                  r15.w = abs(r15.w) * r18.x + 1;
                  r18.x = r13.w * r0.w + r3.w;
                  r15.w = r15.w * r15.w;
                  r15.w = r15.w * r18.x;
                  r15.w = rcp(r15.w);
                  r13.w = r13.w * r24.w;
            ...
            r39.w = samp0[]..swiz;
              ...
              if (r15.z != 0) {
                ...
                if (r15.z != 0) {
                  ...
                  r19.x = abs(r15.w) * r3.y + -abs(r15.w);
