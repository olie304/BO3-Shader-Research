...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:38:48 2021
//
//
// Buffer Definitions: 
//
...
//   bool invertFalloff;                // Offset:  272 Size:     4
//   float2 emissiveScaleUVs;           // Offset:  276 Size:     8
//   float2 emissiveScrollUVs;          // Offset:  288 Size:     8
//   float edgeHighlightPower;          // Offset:  296 Size:     4
//   float scriptReplacement;           // Offset:  300 Size:     4 [unused]
//   float2 scriptReplacementEmissive;  // Offset:  304 Size:     8 [unused]
//   float3 tint1;                      // Offset:  320 Size:    12
//   float3 tint2;                      // Offset:  336 Size:    12
//   float3 tint3;                      // Offset:  352 Size:    12
//
// }
//
...
// transColorMap                     texture  float4          2d            t26      1 
// transNormalMap                    texture  float4          2d            t29      1 
// transGlossMap                     texture  float4          2d            t30      1 
// gTransShadowmapArray              texture   float     2darray            t31      1 
// visibleDecals                     texture    uint     2darray            t35      1 
// forwardDecalConstants             texture  struct         r/o            t36      1 
// transRevealMap                    texture  float4          2d            t37      1 
...
sample_indexable(texture2d)(float,float,float,float) r1.x, v1.yzyy, t37.xyzw, s7
mad_sat r0.z, r0.z, l(0.998000), l(0.001000)
add r1.y, -r0.z, l(1.000000)
mov_sat r1.z, cb0[14].w
log r0.z, r0.z
mul r0.z, r0.z, r1.z
exp r0.z, r0.z
mov r2.x, -r0.z
...
mul r0.z, r0.z, r1.z
exp r2.y, r0.z
mad_sat r1.yz, cb0[14].zzzz, r2.xxyx, r1.yyyy
add r0.z, -r1.y, r1.x
add r1.x, -r1.y, r1.z
div_sat r0.z, r0.z, r1.x
mul r1.xy, v1.yzyy, cb0[15].xyxx
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, v1.yzyy, t21.xyzw, s1
...
mad r1.w, r1.w, r3.x, cb0[12].x
mul_sat r1.w, r1.w, l(0.05882353)
lt r3.y, l(0.000000), r0.z
sample_indexable(texture2d)(float,float,float,float) r4.xyzw, r1.xyxx, t26.xyzw, s7
sample_indexable(texture2d)(float,float,float,float) r3.z, r1.xyxx, t30.yzxw, s7
if_nz r3.y
...
sample_indexable(texture2d)(float,float,float,float) r4.xyz, v1.yzyy, t22.xyzw, s5
...
sample_indexable(texture2d)(float,float,float,float) r5.xyz, r1.xyxx, t29.xyzw, s7
if_nz r3.w
  ...
  mad r1.xy, r5.xyxx, l(1.99218750, 1.99218750, 0.000000, 0.000000), l(-1.000000, -1.000000, 0.000000, 0.000000)
  mul r3.w, r5.z, r5.z
  mul r3.w, r3.w, l(0.33333334)
  min r3.w, r3.w, l(1.000000)
  mad r4.xy, r1.xyxx, r3.zzzz, r4.xyxx
...
rsq r1.y, r1.y
mul r6.xyz, r1.yyyy, v4.xyzx
mul r6.xyz, r1.xxxx, r6.xyzx
dp3 r1.y, v5.xyzx, v5.xyzx
rsq r1.y, r1.y
mul r7.xyz, r1.yyyy, v5.xyzx
mul r7.xyz, r1.xxxx, r7.xyzx
mul r1.y, r1.w, l(-17.000000)
exp r1.y, r1.y
add r1.y, r1.y, r3.y
log r1.y, r1.y
...
mad r1.w, cb1[62].x, r3.x, cb0[12].x
...
if_nz r3.x
  ftoi r3.x, cb1[64].w
  lod r3.y, v1.yzyy, t21.y, s1
  lod r3.z, v1.yzyy, t21.x, s1
  lt r3.y, r3.y, r3.z
  lt r3.z, l(0.000000), r3.z
  and r6.xyz, r3.xxxx, l(1, 2, 4, 0)
  movc r7.xyz, r6.xxxx, l(1.000000,0,1.000000,0), r2.xyzx
  movc r6.xyw, r6.yyyy, l(0,1.000000,0,1.000000), r2.xyxz
  movc r3.xzw, r3.zzzz, r7.xxyz, r6.xxyw
  movc r6.xyz, r6.zzzz, l(0,1.000000,0,0), r2.xyzx
  movc r2.xyz, r3.yyyy, r3.xzwx, r6.xyzx
endif 
add r3.xyz, -r2.xyzx, cb1[58].xyzx
mad r2.xyz, cb1[58].wwww, r3.xyzx, r2.xyzx
add r3.x, -r2.w, cb1[59].x
mad r2.w, cb1[59].w, r3.x, r2.w
          ...
          if_nz r14.w
            ...
            if_nz r14.w
              ...
              if_nz r24.y
                ...
                mul r26.xyz, r1.xxxx, r27.xyzx
                mul r24.xyz, r1.xxxx, r24.xyzx
                mul r25.xyz, r1.xxxx, r25.xyzx
...
mad o0.w, r2.w, r0.y, r13.x
mad r4.xyz, r4.xyzx, r0.yyyy, r15.xyzx
dp3 r1.x, r4.xyzx, r4.xyzx
rsq r1.x, r1.x
mul r4.xyz, r1.xxxx, r4.xyzx
mad r1.y, r1.y, r0.y, r13.y
mad r3.xyz, r3.xyzx, r0.yyyy, r16.xyzx
add r6.zw, r0.zzzz, l(0.000000, 0.000000, -0.010000, -0.800000)
mul r6.zw, r6.zzzw, l(0.000000, 0.000000, 1.26582277, 5.00000048)
mov_sat r6.z, r6.z
mad r2.w, r6.z, l(-2.000000), l(3.000000)
mul r3.w, r6.z, r6.z
mul r2.w, r2.w, r3.w
log r2.w, r2.w
...
exp r3.w, r3.w
mul r2.w, r2.w, r3.w
mad_sat r0.z, r2.w, l(0.990000), -r0.z
mul r0.z, r0.z, cb0[15].z
mov_sat r0.x, r0.x
mul r0.x, r0.x, r0.z
eq r7.xyz, r0.wwww, l(3.000000, 2.000000, 1.000000, 0.000000)
movc r8.xyz, r7.zzzz, cb0[20].xyzx, cb0[16].xyzx
movc r7.yzw, r7.yyyy, cb0[21].xxyz, r8.xxyz
movc r7.xyz, r7.xxxx, cb0[22].xyzx, r7.yzwy
mul r0.zw, cb0[18].xxxy, cb1[69].wwww
mad r0.zw, v1.yyyz, cb0[17].yyyz, r0.zzzw
dp3 r2.w, -v6.xyzx, -v6.xyzx
rsq r2.w, r2.w
mul r8.xyz, r2.wwww, -v6.xyzx
dp3_sat r3.w, r8.xyzx, r5.xyzx
sample_indexable(texture2d)(float,float,float,float) r5.xyzw, r0.zwzz, t38.xyzw, s1
...
exp r0.w, r0.w
movc r0.z, cb0[17].x, r0.w, r0.z
eq r0.w, cb0[15].w, l(0.000000)
...
dp3 r3.w, -r8.xyzx, r4.xyzx
add r3.w, r3.w, r3.w
mad r11.xyz, r4.xyzx, -r3.wwww, -r8.xyzx
mul r3.w, r1.y, l(17.000000)
exp r3.w, r3.w
add r3.w, r3.w, l(2.000000)
div r3.w, l(2.000000), r3.w
sqrt r5.y, r3.w
add r5.z, -r1.y, l(1.000000)
...
if_z r1.w
  ...
  max r1.w, r23.w, l(1.000000)
  rcp r1.w, r1.w
  mov_sat r23.w, r23.w
  mul r19.xyz, r1.wwww, r22.xyzx
  mul r20.xyz, r1.wwww, r23.xyzx
  ...
  if_nz r5.z
    ...
    mad r19.xyz, r22.xyzx, r1.wwww, r6.xyzx
    mov r11.w, l(0)
    sample_l_indexable(texturecubearray)(float,float,float,float) r6.xyz, r11.xyzw, t8.xyzw, s2, r5.w
    mad r1.w, cb2[19].x, r5.z, -r4.w
    mad r1.w, r1.y, r1.w, r4.w
    mad r20.xyz, r6.xyzx, r1.wwww, r20.xyzx
  endif 
else 
  mov r20.x, r19.w
endif 
...
mul r10.yzw, r1.wwww, r20.xxyz
mul r13.xyz, r1.yyyy, r10.zwyz
mul r1.yzw, r1.zzzz, r10.yyzw
sqrt r4.w, r5.y
mad r4.w, r4.w, l(0.500000), l(0.500000)
mul r4.w, r4.w, r4.w
mul r5.z, r4.w, l(0.500000)
mad r4.w, -r4.w, l(0.500000), l(1.000000)
mad r5.w, r1.x, r4.w, r5.z
mul r4.w, r4.w, r5.w
mul r5.z, r5.w, r5.z
...
if_nz r7.w
  ...
  if_nz r7.w
    ...
    if_nz r11.w
      ...
      mad r18.xyz, r4.xyzx, r12.wwww, v6.xyzx
    ...
    mad r9.w, -r1.x, l(0.500000), l(1.000000)
    ...
    mad r15.xyz, r7.zzzz, r10.yzwy, r1.yzwy
    add_sat r2.w, -r2.w, l(1.000000)
    mul r7.w, r2.w, r2.w
    mul r7.w, r7.w, r7.w
    mul r2.w, r2.w, r7.w
    mul r2.w, r2.w, r7.z
    mad r16.xyz, r2.wwww, r10.zwyz, r13.xyzx
    mov r14.w, r16.z
    mov r6.w, r13.z
          ...
          if_nz r24.w
            ...
            if_nz r24.w
              ...
              if_nz r24.w
                ...
                mad r41.xyz, r4.xyzx, r24.wwww, v6.xyzx
              ...
              if_nz r24.w
                ...
                if_nz r13.w
                  ...
                  mad r18.xyz, r4.xyzx, r25.wwww, v6.xyzx
                ...
                mad r12.w, -r20.w, r1.x, l(1.000000)
          ...
          if_nz r15.z
            ...
            if_nz r15.z
              ...
              if_nz r15.z
                ...
                mad r21.xyz, r4.xyzx, r15.zzzz, v6.xyzx
              ...
              if_nz r15.z
                ...
                if_nz r21.x
                  ...
                  mad r22.xyz, r4.xyzx, r21.yyyy, v6.xyzx
                  ...
                  if_nz r21.x
                    ...
                    mad r21.y, |r12.w|, l(-0.200000), l(0.400000)
                    mad r23.xyz, r4.xyzx, r21.yyyy, v6.xyzx
                ...
                mad r15.w, -r13.w, r1.x, l(1.000000)
                mul r15.w, r15.w, r15.w
...
mad r1.xyz, r10.yzwy, r2.xyzx, r1.xyzx
...
movc r0.xyz, cb0[16].wwww, r2.xyzx, r0.xyzx
...
ret 
// Approximately 3001 instruction slots used
