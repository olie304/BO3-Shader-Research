...
mad r3.xyw, r4.xyxz, r3.wwww, r5.xyxz
...
if_nz r1.w
  ...
  movc r2.xyz, r3.zzzz, r5.xywx, r6.xyzx
endif 
add r5.xyz, -r2.xyzx, cb1[58].xyzx
mad r2.xyz, cb1[58].wwww, r5.xyzx, r2.xyzx
add r1.w, -r2.w, cb1[59].x
mad r1.w, cb1[59].w, r1.w, r2.w
...
rsq r1.z, r1.z
mad r6.xyz, r6.xyzx, r1.zzzz, -r3.xywx
mad r3.xyz, cb1[60].wwww, r6.xyzx, r3.xywx
...
mad r2.xyz, r2.xyzx, r1.xxxx, r13.xyzx
mad o0.w, r1.w, r1.x, r4.w
mad r3.xyz, r3.xyzx, r1.xxxx, r14.xyzx
dp3 r1.z, r3.xyzx, r3.xyzx
rsq r1.z, r1.z
mul r3.xyz, r1.zzzz, r3.xyzx
mad r7.y, r1.y, r1.x, r5.w
mad r1.yzw, r5.xxyz, r1.xxxx, r15.xxyz
add r5.xy, r0.yyyy, l(-0.010000, -0.800000, 0.000000, 0.000000)
mul r5.xy, r5.xyxx, l(1.26582277, 5.00000048, 0.000000, 0.000000)
mov_sat r5.x, r5.x
mad r2.w, r5.x, l(-2.000000), l(3.000000)
mul r4.w, r5.x, r5.x
mul r2.w, r2.w, r4.w
log r2.w, r2.w
mul r2.w, r2.w, cb0[18].z
exp r2.w, r2.w
max r4.w, r5.y, l(0.000000)
...
mov_sat r0.x, r0.x
mul r0.x, r0.x, r0.y
eq r5.xyz, r0.zzzz, l(3.000000, 2.000000, 1.000000, 0.000000)
movc r8.xyz, r5.zzzz, cb0[20].xyzx, cb0[16].xyzx
movc r5.yzw, r5.yyyy, cb0[21].xxyz, r8.xxyz
movc r5.xyz, r5.xxxx, cb0[22].xyzx, r5.yzwy
mul r0.yz, cb0[18].xxyx, cb1[69].wwww
mad r0.yz, v2.xxyx, cb0[17].yyzy, r0.yyzy
dp3 r2.w, -v7.xyzx, -v7.xyzx
rsq r2.w, r2.w
mul r8.xyz, r2.wwww, -v7.xyzx
dp3_sat r4.x, r8.xyzx, r4.xyzx
sample_indexable(texture2d)(float,float,float,float) r11.xyzw, r0.yzyy, t38.xyzw, s1
mul r4.yzw, r5.xxyz, r11.xxyz
log r0.y, r4.x
...
add r4.y, r4.y, r4.y
mad r12.xyz, r3.xyzx, -r4.yyyy, -r8.xyzx
...
if_z r7.z
  ...
  max r4.w, r23.w, l(1.000000)
  rcp r4.w, r4.w
  mov_sat r23.w, r23.w
  mul r20.xyz, r4.wwww, r22.xyzx
...
if_nz r5.w
  ...
  if_nz r5.w
    ...
    mul r2.w, r2.w, r5.w
    mul r2.w, r2.w, r5.z
    mad r9.xyz, r2.wwww, r9.yzxy, r14.xyzx
    mov r15.w, r9.z
    mov r13.w, r14.z
    movc r13.xyzw, r4.wwww, r15.xyzw, r13.xyzw
    mov r9.zw, r11.yyyz
    mov r14.zw, r7.yyyz
    movc r9.xyzw, r4.wwww, r9.xyzw, r14.xyzw
          ...
          if_nz r24.w
            ...
            if_nz r24.w
              ...
              if_nz r24.w
                ...
                mad r41.xyz, r3.xyzx, r24.wwww, v7.xyzx
