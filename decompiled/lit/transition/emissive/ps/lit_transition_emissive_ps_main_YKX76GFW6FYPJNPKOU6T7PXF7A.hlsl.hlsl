...
r0.z = samp0[]..swiz;
  ...
  r3.y = transGlossMap.Sample(transitionSampler_s, r1.xy).x;
  if (r3.x != 0) {
    r3.xzw = float3(-1,-1,-1) + transColorTint.xyz;
    r3.xzw = r4.www * r3.xzw + float3(1,1,1);
    r5.x = transGlossRange.y + -transGlossRange.x;
    r3.y = r3.y * r5.x + transGlossRange.x;
    r3.y = saturate(0.0588235296 * r3.y);
    r4.w = r4.w * r0.y;
    r3.xzw = r4.xyz * r3.xzw + -r2.xyz;
    r2.xyz = r4.www * r3.xzw + r2.xyz;
    r3.x = r3.y * 2 + -1;
    r3.x = r4.w * r3.x + 1;
  ...
  if (r4.x != 0) {
    r4.xyz = float3(-0.5,-0.5,-0) + r5.xyz;
    r4.xyz = transNormalHeight * r4.xyz + float3(0.5,0.5,0);
    r1.xy = r4.xy * float2(1.9921875,1.9921875) + float2(-1,-1);
    r4.x = r4.z * r4.z;
    r4.x = 0.333333343 * r4.x;
    r4.x = min(1, r4.x);
    r3.xy = r1.xy * r4.ww + r3.xy;
  ...
  r3.xyw = r4.xyz * r3.www + r5.xyz;
  r1.z = dot(r3.xyw, r3.xyw);
  r1.z = rsqrt(r1.z);
  r3.xyw = r3.xyw * r1.zzz;
  ...
  r1.z = rsqrt(r1.z);
  r6.xyz = r6.xyz * r1.zzz + -r3.xyw;
  r3.xyz = debugNormalOverride.www * r6.xyz + r3.xyw;
  ...
  r4.w = saturate(r4.w);
  r1.x = 1 + -r4.w;
  r2.xyz = r2.xyz * r1.xxx + r13.xyz;
  o0.w = r1.w * r1.x + r4.w;
  r3.xyz = r3.xyz * r1.xxx + r14.xyz;
  r1.z = dot(r3.xyz, r3.xyz);
  r1.z = rsqrt(r1.z);
  r3.xyz = r3.xyz * r1.zzz;
  r7.y = r1.y * r1.x + r5.w;
  r1.yzw = r5.xyz * r1.xxx + r15.xyz;
  r5.xy = float2(-0.00999999978,-0.800000012) + r0.yy;
  r5.xy = float2(1.26582277,5.00000048) * r5.xy;
  r5.x = saturate(r5.x);
  r2.w = r5.x * -2 + 3;
  r4.w = r5.x * r5.x;
  r2.w = r4.w * r2.w;
  ...
  r0.x = saturate(r0.x);
  r0.x = r0.y * r0.x;
  r5.xyz = cmp(r0.zzz == float3(3,2,1));
  r8.xyz = r5.zzz ? tint1.xyz : emissiveTint1.xyz;
  r5.yzw = r5.yyy ? tint2.xyz : r8.xyz;
  ...
  r2.w = rsqrt(r2.w);
  r8.xyz = -v7.xyz * r2.www;
  r4.x = saturate(dot(r8.xyz, r4.xyz));
  r11.xyzw = emissiveMap.Sample(colorSampler_s, r0.yz).xyzw;
  r4.yzw = r11.xyz * r5.xyz;
  r0.y = log2(r4.x);
  ...
  if (r7.z == 0) {
    ...
    r20.xyz = r22.xyz * r4.www;
    r21.xyz = r23.xyz * r4.www;
    ...
    if (r5.w != 0) {
      ...
      r20.xyz = r22.xyz * r4.www + r11.yzw;
      r12.w = 0;
      r11.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r12.xyzw, r5.z).xyz;
      r4.w = sunConstants.globalProbeExposure * r5.w + -r3.w;
      r3.w = r7.y * r4.w + r3.w;
  ...
  if (r5.w != 0) {
    ...
    if (r5.w != 0) {
      ...
      r2.w = r5.w * r2.w;
      r2.w = r5.z * r2.w;
      r9.xyz = r2.www * r9.yzx + r14.xyz;
      r15.w = r9.z;
      r13.w = r14.z;
      r13.xyzw = r4.wwww ? r15.xyzw : r13.xyzw;
      r9.zw = r11.yz;
      r14.zw = r7.yz;
      r9.xyzw = r4.wwww ? r9.xyzw : r14.xyzw;
            ...
            r39.w = samp0[]..swiz;
              ...
              if (r15.z != 0) {
                ...
                if (r15.z != 0) {
                  ...
                  r19.xyz = r19.xyz * r12.www + r8.xyz;
                  r12.w = dot(r19.xyz, r19.xyz);
                  r12.w = rsqrt(r12.w);
                  r19.xyz = r19.xyz * r12.www;
                  r12.w = dot(r19.xyz, r8.xyz);
