...
r5.w = samp0[]..swiz;
  ...
  r4.w = glossRange.y + -glossRange.x;
  r4.w = debugGlossOverride.x * r4.w + glossRange.x;
  r4.w = saturate(0.0588235296 * r4.w);
  r8.xyz = float3(-0.0320000015,-0.0320000015,-0.0320000015) + debugSpecularOverride.xyz;
  r8.xyz = debugSpecularOverride.www * r8.xyz + float3(0.0320000015,0.0320000015,0.0320000015);
  r4.w = r4.w + -r0.w;
  r4.w = debugGlossOverride.w * r4.w + r0.w;
  r9.yzw = v10.xxx ? v4.xyz : -v4.xyz;
  r6.w = dot(r9.yzw, r9.yzw);
  r6.w = rsqrt(r6.w);
  r9.yzw = r9.yzw * r6.www + -r2.yzw;
  r11.xyz = debugNormalOverride.www * r9.yzw + r2.yzw;
  r2.yzw = sqrt(r3.xyz);
  r9.yzw = r3.www * r6.xyz;
  r9.yzw = r9.yzw * r5.xxx;
  r12.xyz = -r9.yzw * float3(0.5,0.5,0.5) + v7.xyz;
  r9.yz = (uint2)v0.xy;
  ...
  r10.yz = (uint2)r9.zy;
  r7.w = dot(r10.zy, float2(0.0671105608,0.00583714992));
  r7.w = frac(r7.w);
  r7.w = 52.9829178 * r7.w;
  r7.w = frac(r7.w);
  r7.w = r7.w * 6.28318548 + gameTick.w;
  sincos(r7.w, r13.x, r14.x);
  r7.w = dot(r10.yz, float2(0.0671105608,0.00583714992));
  r7.w = frac(r7.w);
  r7.w = 52.9829178 * r7.w;
  r7.w = frac(r7.w);
  r7.w = r7.w * 6.28318548 + gameTick.w;
  sincos(r7.w, r15.x, r16.x);
  r4.w = 17 * r4.w;
  r4.w = exp2(r4.w);
  r7.w = 2 + r4.w;
  r7.w = 2 / r7.w;
  ...
  r9.w = -sunConstants.splitDepthOffset + r15.w;
  r9.w = -r9.w * 6.10351563e-05 + 1;
  r13.z = saturate(r9.w);
  r13.z = cmp(r9.w == r13.z);
  if (r13.z != 0) {
    r13.zw = float2(0,0);
    while (true) {
      r14.w = cmp(r13.z >= 3);
  ...
  if (r14.w == 0) {
    if (enableDitheredShadow == 0) {
      ...
      r19.z = r14.w + r13.z;
      r14.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r19.xyz, r9.w).x;
    ...
    if (enableDitheredShadow != 0) {
      ...
      while (true) {
        ...
        r20.z = (uint)r18.z;
        r18.z = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r20.xyz, r9.w).x;
    ...
    r16.z = samp0[]..swiz;
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          r15.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r21.xyz, r9.w).x;
          r14.w = r15.z * 0.125 + r14.w;
          r15.y = (int)r15.y + 1;
        }
      } else {
        r19.z = (uint)r13.w;
        r14.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r19.xyz, r9.w).x;
      }
      r9.w = r14.w * r14.w;
      r9.w = r9.w * r14.w;
    } else {
  ...
  if (r9.w != 0) {
    ...
    r9.w = saturate(dot(r1.xyz, sunConstants.wldDir.xyz));
    ...
    r13.z = r13.z * r13.z;
    r13.w = 1.25 * r13.z;
    r16.yz = r4.xy * float2(0.795454562,0.795454562) + float2(-0.795454562,-0.795454562);
    r19.x = dot(sunConstants.wldDir.xyz, v8.xyz);
    r19.y = dot(sunConstants.wldDir.xyz, v9.xyz);
    ...
    r13.z = cmp(0 < r9.w);
    if (r13.z != 0) {
      r13.z = sunConstants.specScale * r7.w;
      r13.z = 0.25 * r13.z;
      r19.xyz = -r12.xyz * r8.www + sunConstants.wldDir.xyz;
      r13.w = dot(r19.xyz, r19.xyz);
      r13.w = rsqrt(r13.w);
      r19.xyz = r19.xyz * r13.www;
      r13.w = dot(r1.xyz, r19.xyz);
      r14.w = r4.w * 0.125 + 0.25;
      ...
      r9.w = r9.w * r13.z;
      r13.z = 0.25 * r7.w;
      r20.xyz = r9.www / r13.zzz;
      r9.w = dot(r19.xyz, sunConstants.wldDir.xyz);
        ...
        r54.w = samp0[]..swiz;
          ...
          if (r26.y != 0) {
            ...
            if (r24.y != 0) {
              ...
              r25.x = cmp(0 < r24.y);
              if (r25.x != 0) {
                r46.xyz = -r12.xyz * r8.www + r56.xyz;
  ...
  r4.xyw = viewProjectionMatrix._m10_m11_m13 * r17.yyy;
  r4.xyw = r17.xxx * viewProjectionMatrix._m00_m01_m03 + r4.xyw;
  r4.xyw = r17.zzz * viewProjectionMatrix._m20_m21_m23 + r4.xyw;
  r4.xyw = r4.xyw + r7.xyz;
  r6.z = rcp(r4.w);
  r4.xy = r6.zz * r4.xy;
  r6.xy = r4.xy * float2(0.5,-0.5) + float2(0.5,0.5);
  r9.yzw = r30.xyz * float3(2.4000001,2.4000001,2.4000001) + r17.xyz;
  r13.xyz = r9.xxx * r2.yzw;
  r13.xyz = r10.xxx * r0.xyz + r13.xyz;
  r13.xyz = r13.xyz * float3(0.119999997,0.119999997,0.119999997) + r9.yzw;
  r14.xyz = viewProjectionMatrix._m10_m11_m13 * r13.yyy;
  r13.xyw = r13.xxx * viewProjectionMatrix._m00_m01_m03 + r14.xyz;
  r13.xyz = r13.zzz * viewProjectionMatrix._m20_m21_m23 + r13.xyw;
  r13.xyz = r13.xyz + r7.xyz;
  r4.xy = float2(0.5,-0.5) * r13.xy;
  r13.z = rcp(r13.z);
  r13.xy = r4.xy * r13.zz + float2(0.5,0.5);
  r14.xyz = -r6.xyz;
  ...
  r7.z = rcp(r0.z);
  r7.xy = r0.xy * r7.zz + r14.xy;
  r14.w = 0.5;
  r0.xyz = r7.xyz + r14.wwz;
  ...
  r1.w = saturate(dot(r11.xyz, r10.yzw));
  ...
  while (true) {
    ...
    if (r6.w != 0) break;
    r9.z = (uint)r6.z >> 5;
    r13.xyz = (int3)r9.xyz + (int3)r19.xyz;
    r6.w = visibleProbes.Load(r13.xyzw).x;
  // Known bad code for instruction (needs manual fix):
  ...
  r40.w = samp0[]..swiz;
    ...
    r14.w = dot(r36.xyz, r13.xyz);
    r14.w = saturate(r14.w + r36.w);
    r12.w = r14.w * r12.w;
    r14.w = dot(r37.xyz, r13.xyz);
    r14.w = saturate(r14.w + r37.w);
    r12.w = r14.w * r12.w;
    r14.w = dot(r38.xyz, r13.xyz);
    r14.w = saturate(r14.w + r38.w);
    r12.w = r14.w * r12.w;
    r14.w = dot(r39.xyz, r13.xyz);
    r14.w = saturate(r14.w + r39.w);
    r12.w = r14.w * r12.w;
    r14.w = dot(r40.xyz, r13.xyz);
    r14.w = saturate(r14.w + r40.w);
    r14.x = r14.w * r12.w;
    r12.w = (int)r9.z & 1;
    r14.xw = r12.ww ? r14.xy : r14.zx;
    r35.xy = r28.zw;
    r35.z = r29.z;
    r12.w = dot(r7.xyz, r35.xyz);
    r15.w = dot(r13.xyz, r35.xyz);
    r15.w = r15.w + -r29.w;
    r16.w = cmp(r15.w >= 0);
    ...
    r15.w = r16.w / r15.w;
    r12.w = min(abs(r15.w), r12.w);
    r30.z = r31.z;
    r15.w = dot(r7.xyz, r30.xyz);
    ...
    r12.w = min(abs(r15.w), r12.w);
    r34.zw = r33.zw;
    r15.w = dot(r7.zxy, r34.xzw);
    r16.w = dot(r13.zxy, r34.xzw);
    r16.w = r16.w + -r34.y;
    r17.w = cmp(r16.w >= 0);
    r16.w = max(abs(r16.w), r4.w);
    r16.w = r17.w ? r16.w : -r16.w;
    ...
    r29.x = r25.w;
    r29.yz = r26.zw;
    r29.xyz = r29.xyz + r13.xyz;
    r29.xyz = r7.xyz * r12.www + r29.xyz;
    ...
    r30.w = (uint)r18.w;
    r23.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r30.xyzw, r12.w).xyz;
    r28.yzw = (int3)r23.xyz & int3(-2147483648,-2147483648,-2147483648);
    r28.yzw = cmp((int3)r28.yzw == int3(2139095040,2139095040,2139095040));
    r12.w = (int)r28.z | (int)r28.y;
    r12.w = (int)r28.w | (int)r12.w;
    r23.xyz = r12.www ? float3(1,1,0) : r23.xyz;
    r29.x = dot(r13.xyz, r22.xyz);
    r29.y = dot(r13.xyz, r31.xyz);
    r29.z = dot(r13.xyz, r24.xyz);
    r25.xyz = saturate(r29.xyz * r25.xyz + float3(0.5,0.5,0.5));
    r26.z = r27.x;
    r25.xyz = r25.xyz * r26.xyz + r27.yzw;
    r30.x = dot(r11.xyz, r22.xyz);
    r30.y = dot(r11.xyz, r31.xyz);
    r30.z = dot(r11.xyz, r24.xyz);
    ...
    while (true) {
      ...
      if (r16.z != 0) {
        ...
        if (r8.w != 0) {
          ...
          r16.z = 1;
          while (true) {
            r16.w = cmp((int)r16.z >= (int)r18.z);
            if (r16.w != 0) break;
            r16.w = (int)r10.x + (int)r16.z;
          // Known bad code for instruction (needs manual fix):
          ...
          r36.w = samp0[]..swiz;
            ...
            r16.w = -r16.w * r17.z + 1;
            r16.w = r30.y * r16.w;
            r18.y = r19.w ? r16.w : r22.z;
            r30.xy = r18.ww ? r30.xy : r18.xy;
            r16.z = (int)r16.z + 1;
            r15.w = r17.w;
          }
          ...
          if (r16.z != 0) {
            ...
            r16.w = r16.z * r1.w;
            r30.xzw = r23.xyz * r15.www;
            r15.w = dot(r30.xzw, float3(0.212599993,0.715200007,0.0722000003));
            r15.w = r1.w * r16.z + r15.w;
            r15.w = r16.w / r15.w;
            r33.x = r29.w;
            r33.yz = r28.yz;
            r31.xyw = r30.zwx * r15.www + r33.yzx;
            r32.w = r31.w;
          } else {
            r32.xyzw = r29.xyzw;
            r31.xyz = r28.yzw;
  ...
  if (r5.w == 0) {
    ...
    while (true) {
      ...
      r9.w = cmp((int)r6.z == (int)r9.y);
      bitmask.x = ((~(-1 << r6.w)) << 0) & 0xffffffff;  r10.x = (((uint)0 << 0) & bitmask.x) | ((uint)r9.z & ~bitmask.x);
      r9.z = r9.w ? r10.x : r9.z;
      r9.w = cmp((int)r8.w == (int)r9.y);
      if (r9.x == 0) r10.x = 0; else if (r9.x+0 < 32) {       r10.x = (uint)r9.z << (32-(r9.x + 0)); r10.x = (uint)r10.x >> (32-r9.x);      } else r10.x = (uint)r9.z >> 0;
      r9.z = r9.w ? r10.x : r9.z;
      ...
      while (true) {
        if (r10.x == 0) break;
        r12.w = firstbitlow((uint)r10.x);
        r13.z = 1 << (int)r12.w;
        r13.w = (int)r10.x & (int)r13.z;
        if (r13.w != 0) {
          r10.x = (int)r10.x ^ (int)r13.z;
          r13.z = (int)r9.w + (int)r12.w;
        // Known bad code for instruction (needs manual fix):
        ...
        r14.y = samp0[]..swiz;
          ...
          r14.z = r27.w;
          r14.xyz = cmp(abs(r27.xyz) < r14.zxy);
          r13.z = r14.y ? r14.x : 0;
          r13.z = r14.z ? r13.z : 0;
          if (r13.z != 0) {
          ...
          r34.w = samp0[]..swiz;
            ...
            r35.w = samp0[]..swiz;
              ...
              r19.w = r29.x * r19.w;
              r22.w = dot(r31.xyz, r14.xyz);
              r22.w = saturate(r22.w + r31.w);
              r19.w = r22.w * r19.w;
              r22.w = dot(r32.xyz, r14.xyz);
              r22.w = saturate(r22.w + r32.w);
              r19.w = r22.w * r19.w;
              r22.w = dot(r33.xyz, r14.xyz);
              r22.w = saturate(r22.w + r33.w);
              r19.w = r22.w * r19.w;
              r22.w = dot(r34.xyz, r14.xyz);
              r22.w = saturate(r22.w + r34.w);
              r19.w = r22.w * r19.w;
              r22.w = dot(r35.xyz, r14.xyz);
            ...
            r40.x = samp0[]..swiz;
            r40.y = samp0[]..swiz;
              r26.z = r29.y * r13.w + r26.z;
              r12.w = r13.z * r28.z;
              r28.z = r35.z;
              r13.z = dot(r7.xyz, r28.xyz);
              r13.w = dot(r14.xyz, r28.xyz);
              r13.w = r13.w + -r35.w;
              r15.x = cmp(r13.w >= 0);
              ...
              r13.z = min(r13.z, abs(r13.w));
              r38.z = r39.x;
              r13.w = dot(r7.xyz, r38.xyz);
              r15.x = dot(r14.xyz, r38.xyz);
              r15.x = r15.x + -r39.y;
              r15.w = cmp(r15.x >= 0);
              r15.x = max(abs(r15.x), r4.w);
              r15.x = r15.w ? r15.x : -r15.x;
              ...
              r13.z = min(r13.z, abs(r13.w));
              r40.zw = r39.zw;
              r13.w = dot(r7.zxy, r40.xzw);
              r15.x = dot(r14.zxy, r40.xzw);
              r15.x = r15.x + -r40.y;
              r15.w = cmp(r15.x >= 0);
              r15.x = max(abs(r15.x), r4.w);
              r15.x = r15.w ? r15.x : -r15.x;
              ...
              r28.x = r32.w;
              r28.yz = r33.zw;
              r17.yzw = r28.xyz + r14.xyz;
              r17.yzw = r7.xyz * r13.zzz + r17.yzw;
              ...
              r27.y = r30.z;
              r27.z = r31.x;
              r35.x = dot(r17.yzw, r27.xyz);
              r28.xy = r30.xw;
              r28.z = r31.w;
              r35.y = dot(r17.yzw, r28.xyz);
              r31.x = r30.y;
              r35.z = dot(r17.yzw, r31.xyz);
              if (9 == 0) r13.w = 0; else if (9+16 < 32) {               r13.w = (uint)r28.w << (32-(9 + 16)); r13.w = (uint)r13.w >> (32-9);              } else r13.w = (uint)r28.w >> 16;
              r35.w = (uint)r13.w;
              ...
              r30.x = dot(r14.xyz, r27.xyz);
              r30.y = dot(r14.xyz, r28.xyz);
              r30.z = dot(r14.xyz, r31.xyz);
              r14.xyz = saturate(r30.xyz * r32.xyz + float3(0.5,0.5,0.5));
              r33.z = r34.x;
              r14.xyz = r14.xyz * r33.xyz + r34.yzw;
              r35.x = dot(r11.xyz, r27.xyz);
              r35.y = dot(r11.xyz, r28.xyz);
              r35.z = dot(r11.xyz, r31.xyz);
              r27.xyz = cmp(float3(0,0,0) < r35.xyz);
              r16.z = r27.x ? 0 : 0.5;
              r28.xyz = r16.xyz + r14.xyz;
              r28.xyz = gProbeXArray.SampleLevel(samplerLinearClamp_s, r28.xyz, 0).xyz;
              r29.xzw = r35.xyz * r35.xyz;
              r29.xzw = r29.xzw * r12.www;
              r18.z = r27.y ? 0 : 0.5;
              r27.xyw = r18.xyz + r14.xyz;
              ...
              r14.xyz = r14.xyz * r29.www + r27.xyw;
              ...
              r27.x = r25.w;
              r27.yz = r26.xy;
              r26.xyw = r14.yzx * r12.www + r27.yzx;
              r25.w = r26.w;
            }
          }
        }
    ...
    if (r8.w != 0) {
      ...
      r9.w = 0;
      while (true) {
        r10.x = cmp((uint)r9.w >= (uint)r5.w);
        if (r10.x != 0) break;
        r9.z = (uint)r9.w >> 5;
        r13.xyz = (int3)r9.xyz + (int3)r19.xyz;
        r9.z = visibleProbes.Load(r13.xyzw).x;
        r10.x = cmp((int)r6.z == (int)r9.w);
        if (r6.w == 0) r12.w = 0; else if (r6.w+0 < 32) {         r12.w = (uint)r9.z << (32-(r6.w + 0)); r12.w = (uint)r12.w >> (32-r6.w);        } else r12.w = (uint)r9.z >> 0;
        r9.z = r10.x ? r12.w : r9.z;
          ...
          r28.y = samp0[]..swiz;
            ...
            r35.w = samp0[]..swiz;
              ...
              r37.w = samp0[]..swiz;
                ...
                r21.w = r25.w * r21.w;
                r25.w = dot(r36.xyz, r29.xyz);
                r25.w = saturate(r25.w + r36.w);
                r21.w = r25.w * r21.w;
                r25.w = dot(r37.xyz, r29.xyz);
                r25.w = saturate(r25.w + r37.w);
                r31.x = r25.w * r21.w;
                r27.w = (uint)r14.x >> 2;
                ...
                r21.w = -r21.w * r25.w + 1;
                r21.w = r31.y * r21.w;
                r16.y = r30.z ? r21.w : r30.w;
                r31.xy = r29.ww ? r31.xy : r16.xy;
                r19.w = (int)r19.w + 1;
                r14.x = r27.w;
              }
              r14.x = saturate(r31.y + -r12.w);
              r16.y = r14.x * r16.w;
              r16.z = cmp(0 < r16.y);
              if (r16.z != 0) {
              // Known bad code for instruction (needs manual fix):
              ...
              r41.y = samp0[]..swiz;
                ...
                r14.x = r16.y * r28.z;
                r28.z = r36.z;
                r15.w = dot(r7.xyz, r28.xyz);
                r16.y = dot(r29.xyz, r28.xyz);
                r16.y = r16.y + -r36.w;
                r16.z = cmp(r16.y >= 0);
                ...
                r36.z = r37.z;
                r16.y = dot(r7.xyz, r36.xyz);
                r16.z = dot(r29.xyz, r36.xyz);
                r16.z = r16.z + -r37.w;
                r16.w = cmp(r16.z >= 0);
                ...
                r37.z = r38.z;
                r16.y = dot(r7.xyz, r37.xyz);
                r16.z = dot(r29.xyz, r37.xyz);
                r16.z = r16.z + -r38.w;
                r16.w = cmp(r16.z >= 0);
                r16.z = max(abs(r16.z), r4.w);
                r16.z = r16.w ? r16.z : -r16.z;
                ...
                r15.w = min(abs(r16.y), r15.w);
                r38.z = r39.z;
                r16.y = dot(r7.xyz, r38.xyz);
                r16.z = dot(r29.xyz, r38.xyz);
                r16.z = r16.z + -r39.w;
                r16.w = cmp(r16.z >= 0);
                r16.z = max(abs(r16.z), r4.w);
                r16.z = r16.w ? r16.z : -r16.z;
                ...
                r15.w = min(abs(r16.y), r15.w);
                r39.z = r40.x;
                r16.y = dot(r7.xyz, r39.xyz);
                r16.z = dot(r29.xyz, r39.xyz);
                r16.z = r16.z + -r40.y;
                r16.w = cmp(r16.z >= 0);
                r16.z = max(abs(r16.z), r4.w);
                r16.z = r16.w ? r16.z : -r16.z;
                ...
                r15.w = min(abs(r16.y), r15.w);
                r41.zw = r40.zw;
                r16.y = dot(r7.zxy, r41.xzw);
                r16.z = dot(r29.zxy, r41.xzw);
                r16.z = r16.z + -r41.y;
                r16.w = cmp(r16.z >= 0);
                r16.z = max(abs(r16.z), r4.w);
                r16.z = r16.w ? r16.z : -r16.z;
                ...
                r16.yzw = r7.xyz * r15.www + r16.yzw;
                ...
                if (9 == 0) r16.y = 0; else if (9+16 < 32) {                 r16.y = (uint)r28.w << (32-(9 + 16)); r16.y = (uint)r16.y >> (32-9);                } else r16.y = (uint)r28.w >> 16;
                r36.w = (uint)r16.y;
                r16.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r36.xyzw, r15.w).xyz;
                ...
                r36.x = dot(r11.xyz, r27.xyz);
                r36.y = dot(r11.xyz, r28.xyz);
                r36.z = dot(r11.xyz, r32.xyz);
                ...
                r13.xyz = r27.xyz * r28.xyz + r13.xyz;
                r15.w = r15.z * r1.w;
    ...
    r20.xyz = r23.xyz * r0.www;
    r21.xyz = r24.xyz * r0.www;
    r1.w = cmp(r24.w < 0.99000001);
    if (r1.w != 0) {
      r1.w = 1 + -r24.w;
      r4.w = sunConstants.globalProbeExposure * r1.w;
      r9.xyz = -globalProbeConstants.data[0].xyz + r12.xyz;
      r12.x = globalProbeConstants.data[0].w * r9.x;
      r12.yz = globalProbeConstants.data[1].xy * r9.yz;
      r9.xyz = saturate(float3(0.5,0.5,0.5) + r12.xyz);
      r12.xy = globalProbeConstants.data[1].zw * r9.xy;
      r12.z = globalProbeConstants.data[2].x * r9.z;
      r9.xyz = globalProbeConstants.data[2].yzw + r12.xyz;
      r12.xyz = cmp(float3(0,0,0) < r11.xyz);
      r12.xyz = r12.xyz ? float3(0,0,0) : float3(0.5,0.5,0.5);
      r12.w = 0;
      r13.xyz = r12.wwx + r9.xyz;
      r13.xyz = gProbeXArray.SampleLevel(samplerLinearClamp_s, r13.xyz, 0).xyz;
      r14.xyz = r11.xyz * r11.xyz;
      r14.xyz = r14.xyz * r4.www;
      r15.xyz = r12.wwy + r9.xyz;
