// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:35:51 2021
...
r0.w = modelInstanceBuffer[]..swiz;
  ...
  r0.x = (int)r1.w + (int)v6.x;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r1.xyz, r0.x, l(0), t5.xyzx
...
r0.z = modelInstanceBuffer[]..swiz;
  ...
  r3.y = r2.x;
  r3.z = r0.x;
  r3.xyz = r1.www ? r3.xyz : float3(1,0,0);
  r4.x = r1.y;
  r4.y = r2.y;
  r4.z = r0.y;
  r2.xyw = r1.www ? r4.xyz : float3(0,1,0);
  r0.x = r1.z;
  r0.y = r2.z;
  r0.xyz = r1.www ? r0.xyz : float3(0,0,1);
  if (r0.w != 0) {
  // Known bad code for instruction (needs manual fix):
  ...
  p2.x = dot(r3.xyz, r1.xyz);
  p2.y = dot(r3.xyz, r4.xyz);
  p2.z = dot(r3.xyz, r5.xyz);
  o7.x = dot(r2.xyw, r1.xyz);
  o7.y = dot(r2.xyw, r4.xyz);
  o7.z = dot(r2.xyw, r5.xyz);
  o8.x = dot(r0.xyz, r1.xyz);
  o8.y = dot(r0.xyz, r4.xyz);
  o8.z = dot(r0.xyz, r5.xyz);
  o2.x = v7.x;
  o1.x = v1.w;
  p1.xy = v2.xy;
  o6.xyz = r8.xyz;
