  ...
  out float2 o3 : SV_TARGET3)
{
  ...
  r0.x = -r0.x * v1.x + debugOcclusionOverride.x;
  o2.z = debugOcclusionOverride.w * r0.x + r0.y;
  r0.xyz = v6.xxx ? v2.xyz : -v2.xyz;
  r2.w = dot(r0.xyz, r0.xyz);
  r2.w = rsqrt(r2.w);
  r0.xyz = r0.xyz * r2.www + -r2.xyz;
  r2.yzw = debugNormalOverride.www * r0.xyz + r2.xyz;
  ...
  r6.x = 1;
  r2.x = 0;
  r2.xyzw = r1.wwww ? r6.xyzw : r2.xyzw;
  r0.z = r1.w ? r3.x : r0.z;
  r1.w = cmp(r0.z == r3.y);
  r6.yzw = float3(-1,1,-1) * r2.yzw;
  r3.x = 2 + r0.z;
