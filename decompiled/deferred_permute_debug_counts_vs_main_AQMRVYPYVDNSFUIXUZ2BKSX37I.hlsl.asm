...
// ------------------------------ ---------- ------- ----------- -------------- ------
// codeBuffer0                       texture    uint         buf             t0      1 
...
dcl_output o1.xyzw
dcl_temps 5
ld_indexable(buffer)(uint,uint,uint,uint) r0.x, l(0, 0, 0, 0), t0.xyzw
mov r0.y, r0.x
mov r0.z, l(1)
loop 
  ige r0.w, r0.z, l(64)
...
utof r0.xy, r0.xyxx
div r0.x, r0.x, r0.y
mad r0.x, r0.x, cb3[0].y, -v0.x
add r0.x, r0.x, l(1.000000)
movc r0.x, r0.z, r0.x, v0.x
utof r0.z, r1.x
div r0.y, r0.z, r0.y
mad r0.x, r0.y, cb3[0].y, r0.x
add r0.x, r0.x, l(1.000000)
