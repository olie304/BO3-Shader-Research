...
sample_indexable(texture2d)(float,float,float,float) r1.xyzw, r0.yzyy, t15.xyzw, s5
...
sample_indexable(texture2d)(float,float,float,float) r1.w, r3.xwxx, t7.yzwx, s2
...
sample_indexable(texture2d)(float,float,float,float) r5.xyzw, r0.yzyy, t14.xyzw, s1
...
sample_indexable(texture2d)(float,float,float,float) r7.xyz, r0.yzyy, t11.xyzw, s3
...
mad r3.yz, r7.xxyx, l(0.000000, 1.99218750, 1.99218750, 0.000000), l(0.000000, -1.000000, -1.000000, 0.000000)
mul r1.w, r7.z, r7.z
...
mad r2.xy, r3.yzyy, cb0[11].wwww, r1.xyxx
...
if_nz r1.w
  ...
  movc r4.xyz, r3.zzzz, r5.xywx, r6.xyzx
endif 
