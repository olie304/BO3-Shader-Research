...
dp3_sat r2.x, r11.xyzx, r3.xyzx
dp3 r0.w, -r3.xyzx, r11.xyzx
add r0.w, r0.w, r0.w
mad r12.xyz, r11.xyzx, -r0.wwww, -r3.xyzx
...
mad r3.xy, -r1.wwww, l(10.000000, 5.000000, 0.000000, 0.000000), l(6.857410, 7.085000, 0.000000, 0.000000)
exp r3.x, r3.x
mul r3.x, r2.x, r3.x
mul r3.z, r1.w, r2.z
...
ushr r0.y, r0.y, l(24)
uge r3.z, r0.y, r3.y
ult r4.z, r0.y, cb2[0].y
and r3.z, r3.z, r4.z
if_nz r3.z
  imul null, r3.z, r0.y, l(14)
  if_nz r1.z
    add r13.yzw, cb1[24].xxyz, cb10[r3.z + 0].xxyz
    mov r13.x, l(16)
    store_structured u2.xyzw, cb2[52].x, l(880), r13.xyzw
  endif 
  add r13.xyz, r10.xyzx, -cb10[r3.z + 0].xyzx
  and r4.z, l(0x0000ffff), cb10[r3.z + 7].z
  ubfe r5.w, l(6), l(25), cb10[r3.z + 7].z
  imul null, r6.w, r4.z, l(6)
  dp3 r7.w, cb11[r6.w + 0].xyzx, r13.xyzx
  add_sat r7.w, r7.w, cb11[r6.w + 0].w
  dp3 r8.w, cb11[r6.w + 1].xyzx, r13.xyzx
  add_sat r8.w, r8.w, cb11[r6.w + 1].w
  mul r7.w, r7.w, r8.w
  dp3 r8.w, cb11[r6.w + 2].xyzx, r13.xyzx
  add_sat r8.w, r8.w, cb11[r6.w + 2].w
  mul r7.w, r7.w, r8.w
  dp3 r8.w, cb11[r6.w + 3].xyzx, r13.xyzx
  add_sat r8.w, r8.w, cb11[r6.w + 3].w
  mul r7.w, r7.w, r8.w
  dp3 r8.w, cb11[r6.w + 4].xyzx, r13.xyzx
  add_sat r8.w, r8.w, cb11[r6.w + 4].w
  mul r7.w, r7.w, r8.w
  dp3 r8.w, cb11[r6.w + 5].xyzx, r13.xyzx
  add_sat r6.w, r8.w, cb11[r6.w + 5].w
  mul r14.x, r6.w, r7.w
  and r6.w, l(1), cb10[r3.z + 6].x
  mov r14.yz, l(0,0,1.000000,0)
  movc r14.xy, r6.wwww, r14.xyxx, r14.zxzz
  mov r15.x, l(1.000000)
  mov r6.w, cb10[r3.z + 6].x
  mov r16.xy, r14.xyxx
  mov r7.w, l(1)
  loop 
    ige r8.w, r7.w, r5.w
    ...
    dp3 r9.w, cb11[r8.w + 0].xyzx, r13.xyzx
    add_sat r9.w, r9.w, cb11[r8.w + 0].w
    mul r9.w, r9.w, r16.x
    dp3 r10.w, cb11[r8.w + 1].xyzx, r13.xyzx
    add_sat r10.w, r10.w, cb11[r8.w + 1].w
    mul r9.w, r9.w, r10.w
    dp3 r10.w, cb11[r8.w + 2].xyzx, r13.xyzx
    add_sat r10.w, r10.w, cb11[r8.w + 2].w
    mul r9.w, r9.w, r10.w
    dp3 r10.w, cb11[r8.w + 3].xyzx, r13.xyzx
    add_sat r10.w, r10.w, cb11[r8.w + 3].w
    mul r9.w, r9.w, r10.w
    dp3 r10.w, cb11[r8.w + 4].xyzx, r13.xyzx
    add_sat r10.w, r10.w, cb11[r8.w + 4].w
    mul r9.w, r9.w, r10.w
    dp3 r10.w, cb11[r8.w + 5].xyzx, r13.xyzx
    add_sat r8.w, r10.w, cb11[r8.w + 5].w
    mul r16.x, r8.w, r9.w
    ushr r10.w, r6.w, l(2)
    ubfe r13.w, l(1), l(2), r6.w
    and r14.z, r10.w, l(2)
    max r14.w, r16.x, r16.y
    mad r8.w, -r9.w, r8.w, l(1.000000)
    mul r8.w, r8.w, r16.y
    movc r15.y, r14.z, r8.w, r14.w
    movc r16.xy, r13.wwww, r16.xyxx, r15.xyxx
    iadd r7.w, r7.w, l(1)
    mov r6.w, r10.w
  endloop 
  mov_sat r16.y, r16.y
  mul r4.z, r16.y, cb10[r3.z + 6].y
  ...
  if_nz r5.w
    if_nz r1.z
      ...
      store_structured u2.x, cb2[52].x, l(896), r4.z
    endif 
    mul r5.w, r4.z, cb10[r3.z + 7].y
    mov r14.x, cb10[r3.z + 7].w
    mov r14.yz, cb10[r3.z + 8].xxyx
    dp3 r6.w, r12.xyzx, r14.xyzx
    dp3 r7.w, r13.xyzx, r14.xyzx
    add r7.w, r7.w, -cb10[r3.z + 8].z
    ...
    mov r14.x, cb10[r3.z + 8].w
    mov r14.yz, cb10[r3.z + 9].xxyx
    dp3 r7.w, r12.xyzx, r14.xyzx
    dp3 r8.w, r13.xyzx, r14.xyzx
    add r8.w, r8.w, -cb10[r3.z + 9].z
    ...
    div r7.w, r8.w, r7.w
    min r6.w, r6.w, |r7.w|
    mov r14.x, cb10[r3.z + 9].w
    mov r14.yz, cb10[r3.z + 10].xxyx
    dp3 r7.w, r12.xyzx, r14.xyzx
    dp3 r8.w, r13.xyzx, r14.xyzx
    add r8.w, r8.w, -cb10[r3.z + 10].z
    ge r9.w, r8.w, l(0.000000)
    max r8.w, r2.w, |r8.w|
    movc r8.w, r9.w, r8.w, -r8.w
    max r7.w, -r7.w, l(0.00000010)
    div r7.w, r8.w, r7.w
    min r6.w, r6.w, |r7.w|
    mov r14.x, cb10[r3.z + 10].w
    mov r14.yz, cb10[r3.z + 11].xxyx
    dp3 r7.w, r12.xyzx, r14.xyzx
    dp3 r8.w, r13.xyzx, r14.xyzx
    add r8.w, r8.w, -cb10[r3.z + 11].z
    ge r9.w, r8.w, l(0.000000)
    max r8.w, r2.w, |r8.w|
    movc r8.w, r9.w, r8.w, -r8.w
    max r7.w, -r7.w, l(0.00000010)
    div r7.w, r8.w, r7.w
    min r6.w, r6.w, |r7.w|
    mov r14.x, cb10[r3.z + 11].w
    mov r14.yz, cb10[r3.z + 12].xxyx
    dp3 r7.w, r12.xyzx, r14.xyzx
    dp3 r8.w, r13.xyzx, r14.xyzx
    add r8.w, r8.w, -cb10[r3.z + 12].z
    ge r9.w, r8.w, l(0.000000)
    max r8.w, r2.w, |r8.w|
    movc r8.w, r9.w, r8.w, -r8.w
    max r7.w, -r7.w, l(0.00000010)
    div r7.w, r8.w, r7.w
    min r6.w, r6.w, |r7.w|
    mov r14.x, cb10[r3.z + 12].w
    mov r14.yz, cb10[r3.z + 13].xxyx
    dp3 r7.w, r12.xyzx, r14.xyzx
    dp3 r8.w, r13.xyzx, r14.xyzx
    add r8.w, r8.w, -cb10[r3.z + 13].z
    ge r9.w, r8.w, l(0.000000)
    max r8.w, r2.w, |r8.w|
    movc r8.w, r9.w, r8.w, -r8.w
    max r7.w, -r7.w, l(0.00000010)
    div r7.w, r8.w, r7.w
    min r6.w, r6.w, |r7.w|
    add r14.x, r13.x, cb10[r3.z + 3].w
    add r14.yz, r13.yyzy, cb10[r3.z + 4].xxyx
    mad r14.xyz, r12.xyzx, r6.wwww, r14.xyzx
    dp3 r7.w, r14.xyzx, r14.xyzx
    sqrt r7.w, r7.w
    div r6.w, r6.w, r7.w
    add r6.w, r6.w, r6.w
    sqrt r6.w, r6.w
    mad r6.w, r1.w, l(5.000000), r6.w
    add r6.w, r6.w, l(-0.844800)
    mov r15.x, cb10[r3.z + 0].w
    mov r15.y, cb10[r3.z + 1].z
    mov r15.z, cb10[r3.z + 2].y
    dp3 r16.x, r14.xyzx, r15.xyzx
    mov r17.xy, cb10[r3.z + 1].xwxx
    mov r17.z, cb10[r3.z + 2].z
    dp3 r16.y, r14.xyzx, r17.xyzx
    mov r18.x, cb10[r3.z + 1].y
    mov r18.yz, cb10[r3.z + 2].xxwx
    dp3 r16.z, r14.xyzx, r18.xyzx
    ubfe r7.w, l(9), l(16), cb10[r3.z + 7].z
    utof r16.w, r7.w
    sample_l_indexable(texturecubearray)(float,float,float,float) r14.xyz, r16.xyzw, t8.xyzw, s2, r6.w
    ...
    mad_sat r13.xyz, r19.xyzx, cb10[r3.z + 3].xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
    mul r19.xy, r13.xyxx, cb10[r3.z + 4].zwzz
    mul r19.z, r13.z, cb10[r3.z + 5].x
    add r13.xyz, r19.xyzx, cb10[r3.z + 5].yzwy
    dp3 r16.x, r11.xyzx, r15.xyzx
    dp3 r16.y, r11.xyzx, r17.xyzx
    dp3 r16.z, r11.xyzx, r18.xyzx
    ...
    or r3.z, r16.y, r16.x
    or r3.z, r16.z, r3.z
    movc r15.xyz, r3.zzzz, l(1.000000,1.000000,0,0), r15.xyzx
    mul r13.xyz, r13.xyzx, r15.xyzx
    dp3 r3.z, r13.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
    mul r6.w, r3.z, r3.x
    mul r14.xyz, r5.wwww, r14.xyzx
    dp3 r5.w, r14.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
    mad r3.z, r3.x, r3.z, r5.w
    div r3.z, r6.w, r3.z
...
if_nz r3.y
  ...
  if_nz r1.z
    and r3.y, r3.z, l(1)
    imad r3.y, r3.y, l(20), l(880)
    add r15.yzw, cb1[24].xxyz, cb10[r0.y + 0].xxyz
    mov r15.x, l(16)
    store_structured u2.xyzw, cb2[52].x, r3.y, r15.xyzw
  endif 
  iadd r3.y, r3.z, l(1)
  add r15.xyz, r10.xyzx, -cb10[r0.y + 0].xyzx
  and r5.w, l(0x0000ffff), cb10[r0.y + 7].z
  ubfe r6.w, l(6), l(25), cb10[r0.y + 7].z
  imul null, r7.w, r5.w, l(6)
  dp3 r8.w, cb11[r7.w + 0].xyzx, r15.xyzx
  add_sat r8.w, r8.w, cb11[r7.w + 0].w
  dp3 r9.w, cb11[r7.w + 1].xyzx, r15.xyzx
  add_sat r9.w, r9.w, cb11[r7.w + 1].w
  mul r8.w, r8.w, r9.w
  dp3 r9.w, cb11[r7.w + 2].xyzx, r15.xyzx
  add_sat r9.w, r9.w, cb11[r7.w + 2].w
  mul r8.w, r8.w, r9.w
  dp3 r9.w, cb11[r7.w + 3].xyzx, r15.xyzx
  add_sat r9.w, r9.w, cb11[r7.w + 3].w
  mul r8.w, r8.w, r9.w
  dp3 r9.w, cb11[r7.w + 4].xyzx, r15.xyzx
  add_sat r9.w, r9.w, cb11[r7.w + 4].w
  mul r8.w, r8.w, r9.w
  dp3 r9.w, cb11[r7.w + 5].xyzx, r15.xyzx
  add_sat r7.w, r9.w, cb11[r7.w + 5].w
  mul r16.x, r7.w, r8.w
  and r7.w, l(1), cb10[r0.y + 6].x
  mov r16.yz, l(0,0,1.000000,0)
  movc r16.xy, r7.wwww, r16.xyxx, r16.zxzz
  ...
  loop 
    ...
    dp3 r10.w, cb11[r9.w + 0].xyzx, r15.xyzx
    ...
    and r15.w, r13.w, l(2)
    max r16.z, r18.x, r18.y
    mad r9.w, -r10.w, r9.w, l(1.000000)
    mul r9.w, r9.w, r18.y
    movc r17.y, r15.w, r9.w, r16.z
    movc r18.xy, r14.wwww, r18.xyxx, r17.xyxx
    iadd r8.w, r8.w, l(1)
    mov r7.w, r13.w
  endloop 
  add_sat r5.w, -r4.z, r18.y
  mul r6.w, r5.w, cb10[r0.y + 6].y
  ...
  if_nz r7.w
    ...
    and r8.w, r1.z, r8.w
    if_nz r8.w
      imad r16.xy, r7.wwww, l(20, 20, 0, 0), l(860, 876, 0, 0)
      ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r7.w, cb2[52].x, r16.x, u2.xxxx
      or r7.w, r7.w, l(32)
      store_structured u2.x, cb2[52].x, r16.x, r7.w
      store_structured u2.x, cb2[52].x, r16.y, r6.w
    endif 
    iadd r3.y, r3.z, l(257)
    mad r5.w, r5.w, cb10[r0.y + 6].y, r4.z
    mul r6.w, r6.w, cb10[r0.y + 7].y
    mov r16.x, cb10[r0.y + 7].w
    mov r16.yz, cb10[r0.y + 8].xxyx
    dp3 r7.w, r12.xyzx, r16.xyzx
    dp3 r8.w, r15.xyzx, r16.xyzx
    ...
    utof r18.w, r2.w
    sample_l_indexable(texturecubearray)(float,float,float,float) r16.xyz, r18.xyzw, t8.xyzw, s2, r1.w
    and r21.xyz, r16.xyzx, l(0x7fffffff, 0x7fffffff, 0x7fffffff, 0)
    ieq r21.xyz, r21.xyzx, l(0x7f800000, 0x7f800000, 0x7f800000, 0)
    or r1.w, r21.y, r21.x
    or r1.w, r21.z, r1.w
    movc r16.xyz, r1.wwww, l(1.000000,1.000000,0,0), r16.xyzx
...
ge r0.y, r4.z, l(1.000000)
bfi r1.w, l(8), l(0), r3.y, r3.z
movc r0.y, r0.y, r1.w, r3.y
max r1.w, r5.w, l(1.000000)
rcp r1.w, r1.w
mov_sat r5.w, r5.w
mul r3.xyz, r1.wwww, r13.xyzx
mul r14.xyz, r1.wwww, r14.xyzx
lt r2.w, r5.w, l(0.990000)
if_nz r2.w
  ...
  dp3 r4.z, r11.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
  mad r3.xyz, r13.xyzx, r1.wwww, r11.xyzx
  mov r12.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r11.xyz, r12.xyzw, t8.xyzw, s2, r2.z
  mad r1.w, cb2[19].x, r2.w, -r4.z
  mad r1.w, r2.y, r1.w, r4.z
...
mad r2.xyz, r3.xyzx, r5.xyzx, r2.xyzx
...
ret 
// Approximately 898 instruction slots used
