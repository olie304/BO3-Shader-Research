  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r1.y = r1.w * r1.x + glossRange.x;
  r1.w = glossRange2.y + -glossRange2.x;
  r1.z = r1.z * r1.w + glossRange2.x;
  r1.yz = saturate(float2(0.0588235296,0.0588235296) * r1.yz);
  r1.z = r1.z + -r1.y;
  r1.y = r0.z * r1.z + r1.y;
  r1.z = aoMap.Sample(aoSampler_s, r0.xy).x;
  r2.zw = r7.xy * float2(1.9921875,1.9921875) + float2(-1,-1);
  r1.w = r7.z * r7.z;
  ...
  r2.w = r1.w * detailScaleHeight2 + r0.w;
  ...
  if (r1.y != 0) {
    ...
    r1.w = colorMap.CalculateLevelOfDetailUnclamped(colorSampler_s, r0.xy);
    ...
    r3.xyw = r0.xxx ? r4.xyz : r3.xyw;
    r4.xyz = r3.zzz ? float3(0,1,0) : r5.xyz;
    r5.xyz = r0.yyy ? r3.xyw : r4.xyz;
  }
  r3.xyz = debugColorOverride.xyz + -r5.xyz;
  r3.xyz = debugColorOverride.www * r3.xyz + r5.xyz;
  r0.x = debugAlphaOverride.x + -r5.w;
  r0.x = debugAlphaOverride.w * r0.x + r5.w;
  ...
  r1.z = debugOcclusionOverride.w * r0.w + r1.z;
  r5.xyz = v5.xyz * r0.zzz + -r2.xyz;
