...
r7.y = samp0[]..swiz;
  ...
  r13.xyz = -r10.yzw * float3(0.5,0.5,0.5) + v7.xyz;
  r7.zw = (uint2)v0.xy;
  ...
  if (r10.z != 0) {
    ...
    r20.x = dot(sunConstants.wldDir.xyz, v8.xyz);
    r20.y = dot(sunConstants.wldDir.xyz, v9.xyz);
        ...
        r55.w = samp0[]..swiz;
          ...
          if (r27.y != 0) {
            ...
            if (r25.y != 0) {
              ...
              r26.x = r26.x * r26.x;
              r30.w = 1.25 * r26.x;
              r46.x = dot(r57.xyz, v8.xyz);
              r46.y = dot(r57.xyz, v9.xyz);
