...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r4.w = debugAlphaOverride.w * r0.w + r1.x;
  ...
  if (r5.y != 0) {
    ...
    if (r5.y != 0) {
      ...
      r2.w = saturate(r2.w);
      r17.xyz = -v5.xyz * r3.www + sunConstants.wldDir.xyz;
  ...
  r0.w = (int)r4.w & 0x7f800000;
  r0.w = cmp((int)r0.w == 0x7f800000);
  r2.xyzw = cmp(r4.xyzw == float4(0,0,0,0));
  r2.xy = r2.zw ? r2.xy : 0;
  r1.w = r2.y ? r2.x : 0;
  ...
  o0.xyzw = r0.wwww ? float4(0,0,0,0) : r4.xyzw;
  return;
}