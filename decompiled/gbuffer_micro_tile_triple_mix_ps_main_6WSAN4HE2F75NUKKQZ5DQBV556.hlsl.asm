...
sample_indexable(texture2d)(float,float,float,float) r0.xy, r0.xyxx, t18.xyzw, s5
ne r1.xyzw, cb0[23].xyzw, l(0.000000, 1.000000, 0.000000, 1.000000)
or r0.z, r1.y, r1.x
or r0.z, r1.z, r0.z
or r0.z, r1.w, r0.z
add_sat r0.w, r0.x, -cb0[23].x
add r1.xy, -cb0[23].xzxx, cb0[23].ywyy
max r1.x, r1.x, l(0.000100)
div r0.w, r0.w, r1.x
min r0.w, r0.w, l(1.000000)
mad r0.w, r0.w, r1.y, cb0[23].z
movc r0.x, r0.z, r0.w, r0.x
ne r1.xyzw, cb0[24].xyzw, l(0.000000, 1.000000, 0.000000, 1.000000)
or r0.z, r1.y, r1.x
or r0.z, r1.z, r0.z
or r0.z, r1.w, r0.z
add_sat r0.w, r0.y, -cb0[24].x
add r1.xy, -cb0[24].xzxx, cb0[24].ywyy
max r1.x, r1.x, l(0.000100)
div r0.w, r0.w, r1.x
min r0.w, r0.w, l(1.000000)
mad r0.w, r0.w, r1.y, cb0[24].z
...
mov r5.x, -r3.x
add r1.yz, v1.yyzy, l(0.000000, -0.500000, -0.500000, 0.000000)
mov r5.y, r4.x
mov r5.z, r3.x
dp2 r3.x, r1.yzyy, r5.yzyy
dp2 r3.y, r1.yzyy, r5.xyxx
add r3.zw, r3.xxxy, v2.yyyx
add r1.w, v2.z, l(0.500000)
add r3.zw, r1.wwww, r3.zzzw
add r3.xy, r3.xyxx, l(0.500000, 0.500000, 0.000000, 0.000000)
mul r4.xyzw, r3.zwxy, cb0[5].xyxy
movc r4.xy, cb0[16].xxxx, r4.xyxx, r4.zwzz
mul r3.xyzw, r3.xyzw, cb0[21].xyxy
...
mad r5.xyz, r3.wwww, r5.xyzx, l(1.000000, 1.000000, 1.000000, 0.000000)
mul r3.xyz, r3.xyzx, r5.xyzx
sample_indexable(texture2d)(float,float,float,float) r2.w, r4.xyxx, t6.yzwx, s2
...
sample_indexable(texture2d)(float,float,float,float) r3.w, r4.xyxx, t9.yzwx, s2
...
add r6.zw, r6.xxxy, v2.yyyx
add r6.zw, r1.wwww, r6.zzzw
add r6.xy, r6.xyxx, l(0.500000, 0.500000, 0.000000, 0.000000)
mul r7.xyzw, r6.zwxy, cb0[6].xyxy
movc r7.xy, cb0[16].yyyy, r7.xyxx, r7.zwzz
mul r6.xyzw, r6.xyzw, cb0[21].zwzw
movc r6.xy, cb0[16].yyyy, r6.zwzz, r6.xyxx
sample_indexable(texture2d)(float,float,float,float) r6.xyzw, r6.xyxx, t15.xyzw, s1
add r8.xyz, cb0[14].xyzx, l(-1.000000, -1.000000, -1.000000, 0.000000)
mad r8.xyz, r6.wwww, r8.xyzx, l(1.000000, 1.000000, 1.000000, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r4.w, r7.xyxx, t19.yzwx, s2
...
sample_indexable(texture2d)(float,float,float,float) r10.xyz, r7.xyxx, t12.xyzw, s3
...
add r1.yz, r11.xxyx, v2.yyxy
add r1.yz, r1.wwww, r1.yyzy
mul r7.zw, r1.yyyz, cb0[7].xxxy
add r11.xy, r11.xyxx, l(0.500000, 0.500000, 0.000000, 0.000000)
mul r11.zw, r11.xxxy, cb0[7].xxxy
movc r7.zw, cb0[18].wwww, r7.zzzw, r11.zzzw
mul r1.yz, r1.yyzy, cb0[22].xxyx
mul r11.xy, r11.xyxx, cb0[22].xyxx
movc r1.yz, cb0[18].wwww, r1.yyzy, r11.xxyx
sample_indexable(texture2d)(float,float,float,float) r11.xyzw, r1.yzyy, t17.xyzw, s1
add r1.yzw, cb0[17].xxyz, l(0.000000, -1.000000, -1.000000, -1.000000)
mad r1.yzw, r11.wwww, r1.yyzw, l(0.000000, 1.000000, 1.000000, 1.000000)
sample_indexable(texture2d)(float,float,float,float) r12.xyz, r7.zwzz, t16.xyzw, s3
sample_indexable(texture2d)(float,float,float,float) r5.w, r7.zwzz, t20.yzwx, s2
add r13.xyz, cb0[20].xyzx, l(-0.040000, -0.040000, -0.040000, 0.000000)
mad r13.xyz, r5.wwww, r13.xyzx, l(0.040000, 0.040000, 0.040000, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r6.w, r7.xyxx, t14.yzwx, s2
mad r6.xyz, r6.xyzx, r8.xyzx, -r3.xyzx
mad r3.xyz, r0.xxxx, r6.xyzx, r3.xyzx
mad r1.yzw, r11.xxyz, r1.yyzw, -r3.xxyz
mad r1.yzw, r0.yyyy, r1.yyzw, r3.xxyz
add r3.x, -r2.w, r4.w
mad r2.w, r0.x, r3.x, r2.w
add r3.xyz, -r5.xyzx, r9.xyzx
mad r3.xyz, r0.xxxx, r3.xyzx, r5.xyzx
add r5.xyz, -r3.xyzx, r13.xyzx
mad r3.xyz, r0.yyyy, r5.xyzx, r3.xyzx
add r4.w, -r2.w, r5.w
mad r2.w, r0.y, r4.w, r2.w
add r2.w, -r2.w, l(1.000000)
mul r1.yzw, r1.yyzw, r2.wwww
add r2.w, -cb0[11].x, cb0[11].y
mad r3.w, r3.w, r2.w, cb0[11].x
mul_sat r3.w, r3.w, l(0.05882353)
add r4.w, -cb0[15].x, cb0[15].y
mad r4.w, r6.w, r4.w, cb0[15].x
mul_sat r4.w, r4.w, l(0.05882353)
mul_sat r5.x, cb0[18].y, l(0.05882353)
add r4.w, -r3.w, r4.w
mad r3.w, r0.x, r4.w, r3.w
add r4.w, -r3.w, r5.x
mad r3.w, r0.y, r4.w, r3.w
sample_indexable(texture2d)(float,float,float,float) r4.w, v1.yzyy, t10.yzwx, s4
mad r5.xy, r10.xyxx, l(1.99218750, 1.99218750, 0.000000, 0.000000), l(-1.000000, -1.000000, 0.000000, 0.000000)
mul r5.z, r10.z, r10.z
mul r5.z, r5.z, l(0.33333334)
min r5.z, r5.z, l(1.000000)
mad r2.xy, r4.xyxx, cb0[12].xxxx, r0.zwzz
dp3 r4.x, r2.xyzx, r2.xyzx
rsq r4.x, r4.x
mul r6.xyz, r2.xyzx, r4.xxxx
mad r6.w, r4.z, cb0[12].x, r1.x
mad r2.xy, r5.xyxx, cb0[12].yyyy, r0.zwzz
dp3 r4.x, r2.xyzx, r2.xyzx
rsq r4.x, r4.x
mul r7.xyz, r2.xyzx, r4.xxxx
mad r7.w, r5.z, cb0[12].y, r1.x
mad r4.xy, r12.xyxx, l(1.99218750, 1.99218750, 0.000000, 0.000000), l(-1.000000, -1.000000, 0.000000, 0.000000)
mul r4.z, r12.z, r12.z
mul r4.z, r4.z, l(0.33333334)
min r4.z, r4.z, l(1.000000)
mad r2.xy, r4.xyxx, cb0[16].zzzz, r0.zwzz
dp3 r0.z, r2.xyzx, r2.xyzx
rsq r0.z, r0.z
mul r5.xyz, r0.zzzz, r2.xyzx
mad r5.w, r4.z, cb0[16].z, r1.x
add r7.xyzw, -r6.xyzw, r7.xyzw
mad r6.xyzw, r0.xxxx, r7.xyzw, r6.xyzw
add r5.xyzw, r5.xyzw, -r6.xyzw
mad r0.xyzw, r0.yyyy, r5.xyzw, r6.xyzw
...
rsq r2.y, r2.y
mul r7.xyz, r2.yyyy, v5.xyzx
mul r7.xyz, r1.xxxx, r7.xyzx
mul r2.y, r3.w, l(-17.000000)
exp r2.y, r2.y
add r0.w, r0.w, r2.y
log r0.w, r0.w
...
mad r2.y, cb1[62].x, r2.w, cb0[11].x
...
if_nz r2.z
  ...
  movc r7.xyz, r6.xxxx, l(1.000000,0,1.000000,0), r1.yzwy
  movc r6.xyw, r6.yyyy, l(0,1.000000,0,1.000000), r1.yzyw
  movc r6.xyw, r3.wwww, r7.xyxz, r6.xyxw
  movc r7.xyz, r6.zzzz, l(0,1.000000,0,0), r1.yzwy
  movc r1.yzw, r2.wwww, r6.xxyw, r7.xxyz
endif 
add r6.xyz, -r1.yzwy, cb1[58].xyzx
mad o0.xyz, cb1[58].wwww, r6.xyzx, r1.yzwy
add r1.yzw, -r3.xxyz, cb1[61].xxyz
mad r1.yzw, cb1[61].wwww, r1.yyzw, r3.xxyz
mad r2.y, r2.y, l(1.000000), -r0.w
mad r0.w, cb1[62].w, r2.y, r0.w
add r2.y, -r4.w, cb1[63].x
mad o2.z, cb1[63].w, r2.y, r4.w
mad r2.xyz, v3.xyzx, r2.xxxx, -r0.xyzx
mad r2.yzw, cb1[60].wwww, r2.xxyz, r0.xxyz
...
mad r3.xyz, r4.xyzx, r1.xxxx, -r0.zzzz
max r1.x, r3.z, r3.y
max r1.x, r1.x, r3.x
max r0.z, r0.z, r1.x
eq r1.x, r0.z, r3.x
...
ieq r0.z, r0.w, r0.z
movc r0.zw, r0.zzzz, r2.xxxy, r2.xxxz
