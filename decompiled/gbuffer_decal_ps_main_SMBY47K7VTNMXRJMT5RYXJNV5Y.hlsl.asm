...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:28:09 2021
//
//
// Buffer Definitions: 
//
...
rsq r5.x, r5.x
mul r5.xyz, r5.xxxx, v6.xyzx
dp3 r5.w, v7.xyzx, v7.xyzx
rsq r5.w, r5.w
mul r6.xyz, r5.wwww, v7.xyzx
...
dp3 r4.y, r3.xywx, r3.xywx
rsq r4.y, r4.y
mul r3.xyw, r3.xyxw, r4.yyyy
...
if_nz r3.z
  ftoi r3.z, cb1[64].w
  lod r4.y, r0.yzyy, t9.y, s2
  lod r0.y, r0.yzyy, t9.x, s2
  lt r0.z, r4.y, r0.y
  lt r0.y, l(0.000000), r0.y
  and r4.yzw, r3.zzzz, l(0, 1, 2, 4)
  movc r5.xyz, r4.yyyy, l(1.000000,0,1.000000,0), r1.xyzx
  movc r6.xyz, r4.zzzz, l(0,1.000000,1.000000,0), r1.xyzx
  movc r5.xyz, r0.yyyy, r5.xyzx, r6.xyzx
  movc r4.yzw, r4.wwww, l(0,0,1.000000,0), r1.xxyz
  movc r1.xyz, r0.zzzz, r5.xyzx, r4.yzwy
endif 
add r4.yzw, -r1.xxyz, cb1[58].xxyz
mad r1.xyz, cb1[58].wwww, r4.yzwy, r1.xyzx
add r0.y, -r0.x, cb1[59].x
mad r0.x, cb1[59].w, r0.y, r0.x
add r4.yzw, -r2.xxyz, cb1[61].xxyz
mad r2.xyz, cb1[61].wwww, r4.yzwy, r2.xyzx
add r0.y, -r1.w, r2.w
mad r0.y, cb1[62].w, r0.y, r1.w
add r0.z, -r0.w, cb1[63].x
mad r5.z, cb1[63].w, r0.z, r0.w
mad r4.xyz, v5.xyzx, r4.xxxx, -r3.xywx
