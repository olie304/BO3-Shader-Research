...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r0.w = -r0.w * r1.x + debugAlphaOverride.x;
  r1.w = debugAlphaOverride.w * r0.w + r1.y;
  ...
  if (r2.w == 0) {
    ...
    if (r9.y != 0) {
      ...
      r10.z = 0;
      while (true) {
        r10.w = cmp((uint)r10.z >= (uint)r2.w);
        if (r10.w != 0) break;
        r13.z = (uint)r10.z >> 5;
        r14.xyz = (int3)r12.xyz + (int3)r13.xyz;
  ...
  if (r7.z != 0) {
    ...
    if (r7.z != 0) {
      ...
      r10.yzw = -v7.xyz * r5.xxx + sunConstants.wldDir.xyz;
