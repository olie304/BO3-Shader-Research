...
sample_indexable(texture2d)(float,float,float,float) r0.z, v2.xyxx, t12.yzxw, s5
add r0.z, -r0.x, r0.z
add r0.x, -r0.x, r0.y
...
sample_indexable(texture2d)(float,float,float,float) r2.xyz, v2.xyxx, t14.xyzw, s1
...
sample_indexable(texture2d)(float,float,float,float) r2.xyz, v2.xyxx, t15.xyzw, s3
...
sample_indexable(texture2d)(float,float,float,float) r5.xyz, v2.xyxx, t9.xyzw, s3
...
sample_indexable(texture2d)(float,float,float,float) r1.w, v2.xyxx, t16.yzwx, s2
mad r1.w, r1.w, r2.y, cb0[10].y
mul_sat r1.w, r1.w, l(0.05882353)
mul r1.w, r1.w, l(-17.000000)
exp r1.w, r1.w
...
mov o1.w, r0.x
sample_indexable(texture2d)(float,float,float,float) r0.y, v2.xyxx, t11.yxzw, s4
