...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:27:09 2021
//
//
// Buffer Definitions: 
//
...
if_nz r1.x
  ...
  if_nz r1.y
    ...
    add r1.y, r7.w, r1.y
    mul r5.z, r1.y, v5.x
    dp3 r1.y, r7.xyzx, r0.xyzx
    mul r6.z, r1.y, v5.x
    dp3 r1.y, r7.xyzx, r3.xyzx
    mul r4.z, r1.y, v5.x
    ...
    if_nz r1.y
      ...
      dp3 r1.y, r7.xyzx, r2.xyzx
      add r1.y, r7.w, r1.y
      mad r8.z, r1.y, v5.y, r5.z
      dp3 r1.y, r7.xyzx, r0.xyzx
      mad r6.z, r1.y, v5.y, r6.z
      dp3 r1.y, r7.xyzx, r3.xyzx
      mad r4.z, r1.y, v5.y, r4.z
      ...
      if_nz r1.y
        ...
        dp3 r1.y, r7.xyzx, r2.xyzx
        add r1.y, r7.w, r1.y
        mad r9.z, r1.y, v5.z, r8.z
        dp3 r1.y, r7.xyzx, r0.xyzx
        mad r6.z, r1.y, v5.z, r6.z
        dp3 r1.y, r7.xyzx, r3.xyzx
        mad r4.z, r1.y, v5.z, r4.z
        ...
        if_nz r1.y
          ...
          dp3 r1.y, r7.xyzx, r2.xyzx
          add r1.y, r7.w, r1.y
          mad r10.x, r1.y, v5.w, r9.x
          dp3 r1.y, r7.xyzx, r0.xyzx
          mad r6.x, r1.y, v5.w, r6.x
          dp3 r1.y, r7.xyzx, r3.xyzx
          mad r4.x, r1.y, v5.w, r4.x
          ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r7.xyzw, r1.x, l(16), t5.xyzw
          dp3 r1.y, r7.xyzx, r2.xyzx
          add r1.y, r7.w, r1.y
          mad r10.y, r1.y, v5.w, r9.y
          dp3 r1.y, r7.xyzx, r0.xyzx
          mad r6.y, r1.y, v5.w, r6.y
          dp3 r1.y, r7.xyzx, r3.xyzx
          mad r4.y, r1.y, v5.w, r4.y
          ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r7.xyzw, r1.x, l(32), t5.xyzw
          dp3 r1.x, r7.xyzx, r2.xyzx
          add r1.x, r7.w, r1.x
          mad r10.z, r1.x, v5.w, r9.z
          dp3 r1.x, r7.xyzx, r0.xyzx
          mad r6.z, r1.x, v5.w, r6.z
          dp3 r1.x, r7.xyzx, r3.xyzx
...
add r1.xyw, r7.xyxz, -cb1[24].xyxz
mov r2.w, l(1.000000)
mov r5.w, r1.x
dp4 r7.x, r2.xyzw, r5.xyzw
mov r6.w, r1.y
dp4 r7.y, r2.xyzw, r6.xyzw
mov r8.w, r1.w
dp4 r7.z, r2.xyzw, r8.xyzw
dp3 r2.x, r0.xyzx, r5.xyzx
dp3 r2.y, r0.xyzx, r6.xyzx
dp3 r2.z, r0.xyzx, r8.xyzx
...
dp3 r0.z, r4.xyzx, r8.xyzx
dp3 r0.w, r0.xyzx, r0.xyzx
rsq r0.w, r0.w
mul o4.xyz, r0.wwww, r0.xyzx
mul r0.xyzw, r7.yyyy, cb1[9].xyzw
mad r0.xyzw, r7.xxxx, cb1[8].xyzw, r0.xyzw
mad r0.xyzw, r7.zzzz, cb1[10].xyzw, r0.xyzw
  ...
  if_nz r0.x
    ...
    if_nz r0.y
      ...
      if_nz r0.y
        ...
        dp3 r0.z, r2.xyzx, v0.xyzx
        add r0.z, r2.w, r0.z
        mad r1.x, r0.z, v5.y, r1.x
        ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r2.xyzw, r0.y, l(16), t8.xyzw
        dp3 r0.z, r2.xyzx, v0.xyzx
        add r0.z, r2.w, r0.z
        mad r1.y, r0.z, v5.y, r1.y
        ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r2.xyzw, r0.y, l(32), t8.xyzw
        dp3 r0.y, r2.xyzx, v0.xyzx
        add r0.y, r2.w, r0.y
        mad r1.z, r0.y, v5.y, r1.z
        ...
        if_nz r0.y
          ...
          dp3 r0.z, r2.xyzx, v0.xyzx
          add r0.z, r2.w, r0.z
          mad r1.x, r0.z, v5.z, r1.x
          ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r2.xyzw, r0.y, l(16), t8.xyzw
          dp3 r0.z, r2.xyzx, v0.xyzx
          add r0.z, r2.w, r0.z
          mad r1.y, r0.z, v5.z, r1.y
          ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r2.xyzw, r0.y, l(32), t8.xyzw
          dp3 r0.y, r2.xyzx, v0.xyzx
          add r0.y, r2.w, r0.y
          mad r1.z, r0.y, v5.z, r1.z
