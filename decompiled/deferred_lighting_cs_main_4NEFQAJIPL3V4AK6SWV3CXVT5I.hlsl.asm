...
add r0.w, r0.w, r0.w
mad r15.xyz, r12.xyzx, -r0.wwww, -r10.yzwy
...
loop 
  ...
  loop 
    ...
    ishl r14.y, l(1), r13.w
    not r14.y, r14.y
    and r13.z, r13.z, r14.y
    ...
    loop 
      ...
      dp3 r25.z, cb11[r20.w + 0].xyzx, r14.yzwy
      add_sat r25.z, r25.z, cb11[r20.w + 0].w
      mul r25.z, r25.z, r25.x
      dp3 r25.w, cb11[r20.w + 1].xyzx, r14.yzwy
      add_sat r25.w, r25.w, cb11[r20.w + 1].w
      mul r25.z, r25.w, r25.z
      dp3 r25.w, cb11[r20.w + 2].xyzx, r14.yzwy
      add_sat r25.w, r25.w, cb11[r20.w + 2].w
      mul r25.z, r25.w, r25.z
      dp3 r25.w, cb11[r20.w + 3].xyzx, r14.yzwy
      add_sat r25.w, r25.w, cb11[r20.w + 3].w
      mul r25.z, r25.w, r25.z
      dp3 r25.w, cb11[r20.w + 4].xyzx, r14.yzwy
      add_sat r25.w, r25.w, cb11[r20.w + 4].w
      mul r25.z, r25.w, r25.z
      dp3 r25.w, cb11[r20.w + 5].xyzx, r14.yzwy
      add_sat r20.w, r25.w, cb11[r20.w + 5].w
      mul r25.x, r20.w, r25.z
      ushr r25.w, r16.x, l(2)
      ubfe r26.x, l(1), l(2), r16.x
      and r26.y, r25.w, l(2)
      max r26.z, r25.x, r25.y
      mad r20.w, -r25.z, r20.w, l(1.000000)
      mul r20.w, r20.w, r25.y
      movc r18.y, r26.y, r20.w, r26.z
      movc r25.xy, r26.xxxx, r25.xyxx, r18.xyxx
    ...
    if_nz r16.w
      mad r24.z, r25.y, cb10[r13.w + 6].y, r24.z
      ...
      div r17.w, r18.y, r17.w
      min r16.w, r16.w, |r17.w|
      add r26.x, r14.y, cb10[r13.w + 3].w
      add r26.yz, r14.zzwz, cb10[r13.w + 4].xxyx
      mad r18.yzw, r15.xxyz, r16.wwww, r26.xxyz
      ...
      utof r27.w, r17.w
      sample_l_indexable(texturecubearray)(float,float,float,float) r18.yzw, r27.xyzw, t8.wxyz, s2, r16.w
      dp3 r30.x, r14.yzwy, r26.xyzx
      dp3 r30.y, r14.yzwy, r28.xyzx
      dp3 r30.z, r14.yzwy, r29.xyzx
      mad_sat r14.yzw, r30.xxyz, cb10[r13.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
      mul r30.xy, r14.yzyy, cb10[r13.w + 4].zwzz
      mul r30.z, r14.w, cb10[r13.w + 5].x
      add r14.yzw, r30.xxyz, cb10[r13.w + 5].yyzw
      ...
      mad r23.xyz, r14.yzwy, r25.xzwx, r23.xyzx
      mul r14.y, r3.w, r13.w
      mul r18.yzw, r16.xxxx, r18.yyzw
      dp3 r14.z, r18.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r13.w, r3.w, r13.w, r14.z
      div r13.w, r14.y, r13.w
      mov r26.x, r23.w
      mov r26.yz, r24.xxyx
      mad r24.xyw, r18.zwzy, r13.wwww, r26.yzyx
      mov r23.w, r24.w
    endif 
  endloop 
...
if_nz r7.w
  ...
  loop 
    ...
    loop 
      ...
      iadd r18.z, r8.w, r18.z
      imul null, r18.z, r18.z, l(14)
      add r25.xyz, r11.xyzx, -cb10[r18.z + 0].xyzx
      ...
      dp3 r26.x, cb11[r20.w + 1].xyzx, r25.xyzx
      add_sat r26.x, r26.x, cb11[r20.w + 1].w
      mul r25.w, r25.w, r26.x
      dp3 r26.x, cb11[r20.w + 2].xyzx, r25.xyzx
      add_sat r26.x, r26.x, cb11[r20.w + 2].w
      mul r25.w, r25.w, r26.x
      dp3 r26.x, cb11[r20.w + 3].xyzx, r25.xyzx
      add_sat r26.x, r26.x, cb11[r20.w + 3].w
      mul r25.w, r25.w, r26.x
      dp3 r26.x, cb11[r20.w + 4].xyzx, r25.xyzx
      add_sat r26.x, r26.x, cb11[r20.w + 4].w
      mul r25.w, r25.w, r26.x
      dp3 r26.x, cb11[r20.w + 5].xyzx, r25.xyzx
      add_sat r20.w, r26.x, cb11[r20.w + 5].w
      mul r16.x, r20.w, r25.w
      and r20.w, l(1), cb10[r18.z + 6].x
      movc r26.xy, r20.wwww, r16.xyxx, r16.zxzz
      ...
      loop 
        ...
        dp3 r26.z, cb11[r25.w + 0].xyzx, r25.xyzx
        add_sat r26.z, r26.z, cb11[r25.w + 0].w
        mul r26.z, r26.z, r27.x
        dp3 r26.w, cb11[r25.w + 1].xyzx, r25.xyzx
        add_sat r26.w, r26.w, cb11[r25.w + 1].w
        mul r26.z, r26.w, r26.z
        dp3 r26.w, cb11[r25.w + 2].xyzx, r25.xyzx
        add_sat r26.w, r26.w, cb11[r25.w + 2].w
        mul r26.z, r26.w, r26.z
        dp3 r26.w, cb11[r25.w + 3].xyzx, r25.xyzx
        add_sat r26.w, r26.w, cb11[r25.w + 3].w
        mul r26.z, r26.w, r26.z
        dp3 r26.w, cb11[r25.w + 4].xyzx, r25.xyzx
        add_sat r26.w, r26.w, cb11[r25.w + 4].w
        mul r26.z, r26.w, r26.z
        dp3 r26.w, cb11[r25.w + 5].xyzx, r25.xyzx
      ...
      if_nz r18.w
        ...
        mov r26.x, cb10[r18.z + 7].w
        mov r26.yz, cb10[r18.z + 8].xxyx
        ...
        mov r26.x, cb10[r18.z + 8].w
        mov r26.yz, cb10[r18.z + 9].xxyx
        dp3 r18.w, r15.xyzx, r26.xyzx
        dp3 r19.w, r25.xyzx, r26.xyzx
        ...
        mov r26.x, cb10[r18.z + 9].w
        mov r26.yz, cb10[r18.z + 10].xxyx
        dp3 r18.w, r15.xyzx, r26.xyzx
        dp3 r19.w, r25.xyzx, r26.xyzx
        ...
        div r18.w, r19.w, r18.w
        min r18.y, |r18.w|, r18.y
        mov r26.x, cb10[r18.z + 10].w
        mov r26.yz, cb10[r18.z + 11].xxyx
        dp3 r18.w, r15.xyzx, r26.xyzx
        dp3 r19.w, r25.xyzx, r26.xyzx
        ...
        div r18.w, r19.w, r18.w
        min r18.y, |r18.w|, r18.y
        mov r26.x, cb10[r18.z + 11].w
        mov r26.yz, cb10[r18.z + 12].xxyx
        dp3 r18.w, r15.xyzx, r26.xyzx
        dp3 r19.w, r25.xyzx, r26.xyzx
        ...
        div r18.w, r19.w, r18.w
        min r18.y, |r18.w|, r18.y
        mov r26.x, cb10[r18.z + 12].w
        mov r26.yz, cb10[r18.z + 13].xxyx
        dp3 r18.w, r15.xyzx, r26.xyzx
        dp3 r19.w, r25.xyzx, r26.xyzx
        ...
        div r18.w, r19.w, r18.w
        min r18.y, |r18.w|, r18.y
        add r26.x, r25.x, cb10[r18.z + 3].w
        add r26.yz, r25.yyzy, cb10[r18.z + 4].xxyx
        ...
        mov r28.x, cb10[r18.z + 0].w
        mov r28.y, cb10[r18.z + 1].z
        mov r28.z, cb10[r18.z + 2].y
        dp3 r29.x, r26.xyzx, r28.xyzx
        mov r30.xy, cb10[r18.z + 1].xwxx
        mov r30.z, cb10[r18.z + 2].z
        dp3 r29.y, r26.xyzx, r30.xyzx
        mov r31.x, cb10[r18.z + 1].y
        mov r31.yz, cb10[r18.z + 2].xxwx
        ...
        mad_sat r25.xyz, r32.xyzx, cb10[r18.z + 3].xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
        mul r32.xy, r25.xyxx, cb10[r18.z + 4].zwzz
        mul r32.z, r25.z, cb10[r18.z + 5].x
        add r18.yzw, r32.xxyz, cb10[r18.z + 5].yyzw
        ...
        mad r18.yzw, r18.yyzw, r28.zzzz, r25.xxyw
        sample_l_indexable(texturecubearray)(float,float,float,float) r25.xyz, r29.xyzw, t8.xyzw, s2, l(6.000000)
        mul r27.xzw, r18.yyzw, r25.xxyz
        dp3 r17.z, r27.xzwx, l(0.212600, 0.715200, 0.072200, 0.000000)
        mad r14.yzw, r18.yyzw, r25.xxyz, r14.yyzw
        mul r18.y, r3.w, r17.z
        mul r25.xyz, r16.xxxx, r26.xyzx
        dp3 r16.x, r25.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
        mad r16.x, r3.w, r17.z, r16.x
        div r16.x, r18.y, r16.x
        mad r24.xyz, r25.xyzx, r16.xxxx, r24.xyzx
      endif 
    endloop 
...
if_nz r0.z
  ...
  mov r15.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r3.yzw, r15.xyzw, t8.wxyz, s2, r3.y
  mad r0.y, cb2[19].x, r0.z, -r2.w
  mad r0.y, r2.y, r0.y, r2.w
  mad r14.yzw, r3.yyzw, r0.yyyy, r14.yyzw
endif 
...
switch r1.w
  ...
  div_sat r2.w, -r2.y, cb9[r0.x + 6].y
  mad r21.xyz, r2.wwww, r18.xyzx, r19.xyzx
  movc r21.xyz, r1.wwww, r21.xyzx, cb9[r0.x + 0].xyzx
  add r21.xyz, -r11.xyzx, r21.xyzx
  dp3 r4.w, r21.xyzx, r21.xyzx
  rsq r5.z, r4.w
  mul r21.xyz, r5.zzzz, r21.xyzx
  dp3 r5.z, r12.xyzx, r21.xyzx
  mov_sat r6.w, r5.z
  movc r6.w, r3.x, |r5.z|, r6.w
  ...
  if_nz r7.w
    ...
    mad_sat r21.xy, r7.wwww, cb9[r0.x + 2].xzxx, cb9[r0.x + 2].ywyy
    ...
    if_nz r7.w
      ...
      if_nz r7.w
        ...
        loop 
          ige r15.w, r12.w, l(8)
          breakc_nz r15.w
          dp2 r22.y, icb[r12.w + 0].yxyy, r23.xyxx
          dp2 r22.z, icb[r12.w + 0].yxyy, r23.yzyy
          mul r25.yz, r22.yyzy, cb9[r0.x + 3].yyyy
          mul r25.x, r22.x, r25.y
          mul r25.w, r21.x, r25.y
          mad r24.xyz, r21.yzwy, r8.wwww, r25.xzwx
          sample_c_lz_indexable(texturecubearray)(float,float,float,float) r15.w, r24.xyzw, t10.xxxx, s13, r7.w
          mad r9.w, r15.w, l(0.125000), r9.w
      ...
      if_nz r7.w
        ...
        mad r12.w, -r8.w, r8.w, cb9[r0.x + 6].y
        mad r2.y, r8.w, r9.w, -r2.y
        div_sat r2.y, r2.y, r12.w
        div r8.w, r12.w, cb9[r0.x + 6].y
        mul r8.w, r8.w, l(10.000000)
        min r8.w, r8.w, l(1.000000)
        add r2.y, -r2.w, r2.y
        mad r2.y, r8.w, r2.y, r2.w
        mad r15.xyz, r2.yyyy, r18.xyzx, r19.xyzx
        movc r15.xyz, r1.wwww, r15.xyzx, cb9[r0.x + 0].xyzx
        add r15.xyz, -r11.xyzx, r15.xyzx
        dp3 r1.w, r15.xyzx, r15.xyzx
        rsq r1.w, r1.w
        mul r18.xyz, r1.wwww, r15.xyzx
        ubfe r2.y, l(4), l(16), cb9[r0.x + 1].w
        ult r2.w, l(0), r2.y
        and r2.w, r10.x, r2.w
        if_nz r2.w
          iadd r2.y, r2.y, cb2[0].x
          imad r2.y, r2.y, l(15), l(-15)
          mad r2.w, |r5.z|, l(-0.200000), l(0.400000)
          lt r8.w, r5.z, l(0.000000)
          and r8.w, r3.x, r8.w
          movc r2.w, r8.w, -r2.w, r2.w
          mad r19.xyz, r12.xyzx, r2.wwww, r11.xyzx
          mov r20.xyz, cb9[r2.y + 6].yzwy
          mov r20.w, cb9[r2.y + 7].x
          mov r19.w, l(1.000000)
          dp4 r2.w, r20.xyzw, r19.xyzw
          mov r20.xyz, cb9[r2.y + 7].yzwy
          mov r20.w, cb9[r2.y + 8].x
          dp4 r8.w, r20.xyzw, r19.xyzw
          lt r9.w, r8.w, r2.w
          if_z r9.w
            mov r20.xyz, cb9[r2.y + 4].yzwy
            mov r20.w, cb9[r2.y + 5].x
            dp4 r20.x, r20.xyzw, r19.xyzw
            mov r21.xyz, cb9[r2.y + 5].yzwy
            mov r21.w, cb9[r2.y + 6].x
            dp4 r20.y, r21.xyzw, r19.xyzw
            div r19.xy, r20.xyxx, r8.wwww
            mad r19.xy, r19.xyxx, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
            add r20.x, r19.x, cb9[r2.y + 9].w
            add r20.y, r19.y, cb9[r2.y + 10].x
            mul r19.xy, r20.xyxx, cb9[r2.y + 9].yzyy
            div r19.zw, cb9[r2.y + 3].yyyy, cb9[r2.y + 8].yyyw
            ...
            or r12.w, r19.w, r19.z
            if_z r12.w
              mov_sat r19.xy, r19.xyxx
              mad r20.x, r19.x, cb9[r2.y + 8].y, cb9[r2.y + 8].z
              mad r20.y, r19.y, cb9[r2.y + 8].w, cb9[r2.y + 9].x
              mul r15.w, r8.w, cb9[r2.y + 10].z
              mad r2.w, cb9[r2.y + 10].y, r8.w, r2.w
              div r2.w, r2.w, r15.w
            endif 
          else 
            mov r12.w, l(-1)
          ...
          if_z r8.w
            ...
            and r8.w, l(0x0000ffff), cb9[r2.y + 1].w
            if_nz cb2[58].y
              mov r19.x, -r13.x
              utof r21.z, r8.w
              mov r19.y, r14.x
              ...
              loop 
                ige r15.w, r12.w, l(8)
                breakc_nz r15.w
                dp2 r22.x, icb[r12.w + 0].yxyy, r19.xyxx
                dp2 r22.y, icb[r12.w + 0].yxyy, r19.yzyy
                mad r21.xy, r22.xyxx, cb9[r2.y + 3].yyyy, r20.xyxx
                sample_c_lz_indexable(texture2darray)(float,float,float,float) r15.w, r21.xyzx, t9.xxxx, s13, r2.w
                mad r9.w, r15.w, l(0.125000), r9.w
                iadd r12.w, r12.w, l(1)
              endloop 
            else 
              utof r20.z, r8.w
              sample_c_lz_indexable(texture2darray)(float,float,float,float) r9.w, r20.xyzx, t9.xxxx, s13, r2.w
            endif 
            mul r2.y, r9.w, r9.w
            mul r2.y, r9.w, r2.y
          else 
          ...
          ubfe r2.y, l(4), l(20), cb9[r0.x + 1].w
          ult r2.w, l(0), r2.y
          not r8.w, r10.x
          and r2.w, r2.w, r8.w
          if_nz r2.w
        ...
        add r2.y, -r6.w, r2.y
        mad r2.y, r1.z, r2.y, r6.w
        mul r2.y, r4.w, r2.y
        mov r19.x, cb9[r0.x + 0].w
        mov r19.yz, cb9[r0.x + 1].xxyx
        mul r20.xyz, r2.yyyy, r19.xyzx
        lt r2.w, l(0.000000), r5.z
        mad r20.xyz, r13.yzwy, r2.zzzz, r20.xyzx
        dp3_sat r5.z, r12.xyzx, r18.xyzx
        mad r15.xyz, r15.xyzx, r1.wwww, r10.yzwy
        dp3 r1.w, r15.xyzx, r15.xyzx
        rsq r1.w, r1.w
        mul r15.xyz, r1.wwww, r15.xyzx
        dp3 r1.w, r15.xyzx, r10.yzwy
        dp3 r6.w, r12.xyzx, r15.xyzx
        mad r8.w, |r6.w|, r0.w, -|r6.w|
        mad r6.w, |r6.w|, r8.w, l(1.000000)
        mad r8.w, r5.z, r0.y, r0.z
        mul r6.w, r6.w, r6.w
        mul r6.w, r8.w, r6.w
        rcp r6.w, r6.w
        mul r5.z, r7.w, r5.z
        mul r5.z, r5.z, r6.w
        mul r4.w, r4.w, r5.z
        mad r15.xyz, r4.wwww, r19.xyzx, r14.yzwy
        add_sat r1.w, -r1.w, l(1.000000)
        mul r5.z, r1.w, r1.w
        mul r5.z, r5.z, r5.z
        mul r1.w, r1.w, r5.z
        mul r1.w, r1.w, r4.w
        mad r18.xyz, r1.wwww, r19.xyzx, r17.xyzx
        mad r19.xyz, r2.yyyy, r19.xyzx, r16.xyzx
        and r19.xyz, r3.xxxx, r19.xyzx
        movc r3.yzw, r2.wwww, r20.xxyz, r3.yyzw
        movc r16.xyz, r2.wwww, r16.xyzx, r19.xyzx
        movc r17.xyz, r2.wwww, r18.xyzx, r17.xyzx
        movc r14.yzw, r2.wwww, r15.xxyz, r14.yyzw
      endif 
    endif 
  endif 
  break 
  ...
  rsq r1.w, r1.w
  mul r18.xyz, r1.wwww, r15.xyzx
  dp3 r2.y, r12.xyzx, r18.xyzx
  mov_sat r2.w, r2.y
  movc r4.w, r3.x, |r2.y|, r2.w
  lt r5.z, l(0.000000), r4.w
  if_nz r5.z
    mov r18.xyz, cb9[r0.x + 7].yzwy
    mov r18.w, cb9[r0.x + 8].x
    mov r11.w, l(1.000000)
    dp4 r5.z, r18.xyzw, r11.xyzw
    lt r6.w, r5.z, l(1.000000)
    if_nz r6.w
      ...
      mad_sat r20.xy, r5.zzzz, cb9[r0.x + 2].xzxx, cb9[r0.x + 2].ywyy
      ...
      div r20.xy, r20.xyxx, r5.zzzz
      lt r5.z, cb9[r0.x + 10].w, l(0.00048828)
      if_nz r5.z
        mad_sat r21.xy, |r20.xyxx|, cb9[r0.x + 12].xyxx, cb9[r0.x + 12].zwzz
        mul r21.zw, r21.xxxy, r21.xxxy
        mad r21.xy, r21.xyxx, l(-2.000000, -2.000000, 0.000000, 0.000000), l(3.000000, 3.000000, 0.000000, 0.000000)
        mul r21.xy, r21.xyxx, r21.zwzz
        mul r5.z, r21.y, r21.x
      else 
        ...
        exp r21.xy, r21.xyxx
        mul r8.w, r21.x, cb9[r0.x + 12].x
        mad r9.w, cb9[r0.x + 12].y, r21.y, l(-1.000000)
        mad r8.w, cb9[r0.x + 12].y, r21.y, -r8.w
    ...
    if_nz r5.z
      ubfe r5.z, l(3), l(27), cb9[r0.x + 1].w
      ine r5.z, r5.z, l(1)
      if_nz r5.z
        mad r5.z, |r2.y|, l(-0.200000), l(0.400000)
        lt r7.w, r2.y, l(0.000000)
        and r7.w, r3.x, r7.w
        ...
        if_nz r8.w
          ...
          if_nz cb2[58].y
            ...
            loop 
              ige r11.w, r9.w, l(8)
              breakc_nz r11.w
              dp2 r22.x, icb[r9.w + 0].yxyy, r18.xyxx
              dp2 r22.y, icb[r9.w + 0].yxyy, r18.yzyy
              mad r21.xy, r22.xyxx, cb9[r0.x + 3].yyyy, r20.xyxx
              sample_c_lz_indexable(texture2darray)(float,float,float,float) r11.w, r21.xyzx, t9.xxxx, s13, r5.z
      ...
      if_nz r6.w
        ...
        if_nz r8.w
          ...
          mad r8.w, |r2.y|, l(-0.200000), l(0.400000)
          lt r9.w, r2.y, l(0.000000)
          and r9.w, r3.x, r9.w
          ...
          if_z r11.w
            ...
            div r18.xy, r20.xyxx, r9.wwww
            mad r18.xy, r18.xyxx, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
            add r20.x, r18.x, cb9[r7.w + 9].w
            add r20.y, r18.y, cb9[r7.w + 10].x
            mul r18.xy, r20.xyxx, cb9[r7.w + 9].yzyy
            ...
            if_z r12.w
              ...
              mad r20.x, r18.x, cb9[r7.w + 8].y, cb9[r7.w + 8].z
              mad r20.y, r18.y, cb9[r7.w + 8].w, cb9[r7.w + 9].x
              mul r15.w, r9.w, cb9[r7.w + 10].z
          ...
          if_z r9.w
            ...
            if_nz cb2[58].y
              ...
              loop 
                ige r15.w, r12.w, l(8)
                breakc_nz r15.w
                dp2 r22.x, icb[r12.w + 0].yxyy, r18.xyxx
                dp2 r22.y, icb[r12.w + 0].yxyy, r18.yzyy
                mad r21.xy, r22.xyxx, cb9[r7.w + 3].yyyy, r20.xyxx
              ...
              utof r20.z, r9.w
              sample_c_lz_indexable(texture2darray)(float,float,float,float) r11.w, r20.xyzx, t9.xxxx, s13, r8.w
            endif 
          ...
          if_nz r7.w
            ...
            mad r7.w, |r2.y|, l(-0.200000), l(0.400000)
            lt r8.w, r2.y, l(0.000000)
            and r8.w, r3.x, r8.w
            movc r7.w, r8.w, -r7.w, r7.w
            ...
            if_z r9.w
              ...
              ge r18.zw, r18.zzzw, r18.xxxy
              or r18.zw, r18.zzzw, r20.xxxy
              or r10.x, r18.w, r18.z
              if_z r10.x
                mov_sat r18.xy, r18.xyxx
                mad r20.x, r18.x, cb9[r0.x + 8].y, cb9[r0.x + 8].z
                mad r20.y, r18.y, cb9[r0.x + 8].w, cb9[r0.x + 9].x
                mul r11.w, r8.w, cb9[r0.x + 10].z
                mad r7.w, cb9[r0.x + 10].y, r8.w, r7.w
                div r7.w, r7.w, r11.w
              endif 
            else 
              mov r10.x, l(-1)
            ...
            if_z r8.w
              ...
              if_nz cb2[58].y
                ...
                loop 
                  ige r11.w, r10.x, l(8)
                  breakc_nz r11.w
                  dp2 r22.x, icb[r10.x + 0].yxyy, r18.xyxx
                  dp2 r22.y, icb[r10.x + 0].yxyy, r18.yzyy
                  mad r21.xy, r22.xyxx, cb9[r0.x + 3].yyyy, r20.xyxx
                  sample_c_lz_indexable(texture2darray)(float,float,float,float) r11.w, r21.xyzx, t9.xxxx, s13, r7.w
        ...
        add r0.x, -r4.w, r0.x
        mad r0.x, r1.z, r0.x, r4.w
        mul r0.x, r5.z, r0.x
        mul r18.xyz, r19.xyzx, r0.xxxx
        lt r1.z, l(0.000000), r2.y
        mad r2.xyz, r13.yzwy, r2.zzzz, r18.xyzx
        mad r13.xyz, r15.xyzx, r1.wwww, r10.yzwy
        dp3 r1.w, r13.xyzx, r13.xyzx
        rsq r1.w, r1.w
        mul r13.xyz, r1.wwww, r13.xyzx
        dp3 r1.w, r13.xyzx, r10.yzwy
        dp3 r4.w, r12.xyzx, r13.xyzx
        mad r0.w, |r4.w|, r0.w, -|r4.w|
        ...
        mad r10.xyz, r0.yyyy, r19.xyzx, r14.yzwy
        add_sat r0.z, -r1.w, l(1.000000)
        mul r0.w, r0.z, r0.z
        mul r0.w, r0.w, r0.w
        mul r0.z, r0.w, r0.z
        mul r0.y, r0.z, r0.y
        mad r0.yzw, r0.yyyy, r19.xxyz, r17.xxyz
        mad r12.xyz, r0.xxxx, r19.xyzx, r16.xyzx
        and r12.xyz, r3.xxxx, r12.xyzx
        movc r3.yzw, r1.zzzz, r2.xxyz, r3.yyzw
        movc r16.xyz, r1.zzzz, r16.xyzx, r12.xyzx
        movc r17.xyz, r1.zzzz, r0.yzwy, r17.xyzx
        movc r14.yzw, r1.zzzz, r10.xxyz, r14.yyzw
      endif 
    endif 
  endif 
  break 
...
mul r5.xyz, r17.xyzx, l(0.960000, 0.960000, 0.960000, 0.000000)
mad r5.xyz, r14.yzwy, l(0.040000, 0.040000, 0.040000, 0.000000), r5.xyzx
add r0.xyz, r0.xyzx, r5.xyzx
add r5.xyz, -r2.xyzx, l(1.000000, 1.000000, 1.000000, 0.000000)
mul r5.xyz, r5.xyzx, r17.xyzx
mad r2.xyz, r14.yzwy, r2.xyzx, r5.xyzx
