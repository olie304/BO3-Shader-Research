  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r5.yzw = colorMapDetail2.Sample(colorSampler_s, r2.yz).xyz;
  ...
  r2.z = r5.z * r2.z;
  r6.y = exp2(r2.z);
  r5.yz = saturate(alphaRevealSoftEdge * r6.xy + r5.yy);
  r2.y = -r5.y + r2.y;
  r2.z = r5.z + -r5.y;
  ...
  r2.xzw = r7.xyz * r0.yyy;
  r2.xzw = r6.xyz * r0.xxx + r2.xzw;
  r0.xyz = r5.xyz * r0.zzz + r2.xzw;
  ...
  if (r1.z != 0) {
    ...
    r2.xzw = r2.xxx ? r6.xyz : r5.xyw;
    r5.xyz = r5.zzz ? float3(0,1,0) : r3.xyz;
    r3.xyz = r1.www ? r2.xzw : r5.xyz;
  }
  r2.xzw = debugColorOverride.xyz + -r3.xyz;
  r2.xzw = debugColorOverride.www * r2.xzw + r3.xyz;
  r1.z = debugAlphaOverride.x + -r2.y;
  r1.z = debugAlphaOverride.w * r1.z + r2.y;
