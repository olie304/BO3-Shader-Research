...
sample_indexable(texture2d)(float,float,float,float) r5.xyzw, r13.xyxx, t46.xyzw, s1
...
mov r8.w, l(0)
loop 
  uge r11.w, r8.w, cb2[0].x
  breakc_nz r11.w
  ushr r11.z, r8.w, l(5)
  iadd r16.xyz, r11.xyzx, r12.xyzx
  ld_indexable(texture2darray)(uint,uint,uint,uint) r11.z, r16.xyzw, t6.yzxw
            ...
            if_nz r27.w
              ...
              if_nz r27.w
                ...
                loop 
                  ige r38.w, r30.w, l(8)
                  breakc_nz r38.w
                  dp2 r43.y, icb[r30.w + 0].yxyy, r9.xyxx
                  dp2 r43.z, icb[r30.w + 0].yxyy, r9.yzyy
...
ret 
// Approximately 2863 instruction slots used
