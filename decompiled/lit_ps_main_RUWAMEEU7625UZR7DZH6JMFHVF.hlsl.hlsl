...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  if (r3.w == 0) {
    r8.xyz = sunConstants.sstLightingConstants.offToPinTransform._m10_m11_m12 * v7.yyy;
    r8.xyz = v7.xxx * sunConstants.sstLightingConstants.offToPinTransform._m00_m01_m02 + r8.xyz;
    r8.xyz = v7.zzz * sunConstants.sstLightingConstants.offToPinTransform._m20_m21_m22 + r8.xyz;
  ...
  if (r3.w != 0) {
    ...
    if (r3.w != 0) {
      ...
      r12.xyz = -v7.xyz * r5.xxx + sunConstants.wldDir.xyz;
