...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:34:28 2021
//
//
// Buffer Definitions: 
//
...
mad r5.xyz, r4.xyzx, r3.xxxx, r5.xyzx
...
if_nz r2.z
  ...
  movc r6.xyz, r3.xxxx, l(1.000000,0,1.000000,0), r1.xyzx
  movc r7.xyz, r3.yyyy, l(0,1.000000,1.000000,0), r1.xyzx
  movc r6.xyz, r0.xxxx, r6.xyzx, r7.xyzx
  movc r3.xyw, r3.wwww, l(0,1.000000,0,0), r1.xyxz
  movc r1.xyz, r0.yyyy, r6.xyzx, r3.xywx
endif 
...
mad r2.xyz, cb1[60].wwww, r2.xyzx, r5.xyzx
...
mad r3.xyz, r3.xywx, r1.wwww, r15.xyzx
lt r3.w, l(0.500000), cb0[20].y
if_nz r3.w
  ...
  round_z r3.w, r3.w
  add r3.w, r3.w, v1.y
  div r6.x, r3.w, cb0[11].w
  round_z r3.w, r4.w
  add r3.w, r3.w, v1.z
  div r6.y, r3.w, cb0[11].z
else 
...
rsq r3.w, r3.w
mul r7.xyz, r3.wwww, -v6.xyzx
dp3_sat r4.x, r7.xyzx, r4.xyzx
sample_indexable(texture2d)(float,float,float,float) r6.xyzw, r6.xyxx, t29.xyzw, s1
mul r4.yzw, r6.xxyz, cb0[19].xxyz
log r5.z, r4.x
...
exp r4.x, r4.x
movc r4.x, cb0[20].x, r4.x, r5.z
eq r5.z, cb0[18].y, l(0.000000)
movc r4.x, r5.z, l(1.000000), r4.x
mul r5.z, r6.w, cb0[18].x
mul r4.x, r4.x, r5.z
mul r1.w, r1.w, r4.x
...
mov r6.x, cb0[16].x
sample_l_indexable(texture2d)(float,float,float,float) r1.w, r6.xyxx, t26.yzwx, s7, l(0.000000)
log r1.w, |r1.w|
...
if_nz r6.z
  ...
  if_nz r6.z
    ...
    mul r3.w, r3.w, r6.z
    mul r3.w, r3.w, r5.w
    mad r16.xyz, r3.wwww, r9.zwyz, r14.xyzx
    mov r15.w, r16.z
    mov r13.w, r14.z
...
ret 
// Approximately 3007 instruction slots used
