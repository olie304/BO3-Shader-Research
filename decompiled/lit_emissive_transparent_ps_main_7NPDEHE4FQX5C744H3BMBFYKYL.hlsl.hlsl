...
r0.y = samp0[]..swiz;
  ...
  r0.x = samp0[]..swiz;
    ...
    r0.y = min(1, r0.y);
    r6.xy = r4.xy * r0.xx + r5.xy;
    r2.w = dot(r6.xyz, r6.xyz);
    r2.w = rsqrt(r2.w);
    r4.xyw = r6.xyz * r2.www;
    r1.w = r1.w * r0.x + r0.y;
  } else {
  ...
  r0.w = debugGlossOverride.x * r1.z + glossRange.x;
  r0.yw = saturate(float2(-0.0588235296,0.0588235296) * r0.yw);
  r0.w = -17 * r0.w;
  r0.w = exp2(r0.w);
  r0.w = r1.w + r0.w;
  r0.w = log2(r0.w);
  ...
  if (r1.z != 0) {
    ...
    r1.w = colorMap.CalculateLevelOfDetailUnclamped(colorSampler_s, r1.xy);
    r2.w = colorMap.CalculateLevelOfDetail(colorSampler_s, r1.xy);
    r1.w = cmp(r1.w < r2.w);
    r2.w = cmp(0 < r2.w);
    r6.xyz = (int3)r1.zzz & int3(1,2,4);
    r7.xyz = r6.xxx ? float3(1,0,1) : r2.xyz;
    r6.xyw = r6.yyy ? float3(0,1,1) : r2.xyz;
    r6.xyw = r2.www ? r7.xyz : r6.xyw;
    r7.xyz = r6.zzz ? float3(0,1,0) : r2.xyz;
    r2.xyz = r1.www ? r6.xyw : r7.xyz;
  }
  r6.xyz = debugColorOverride.xyz + -r2.xyz;
  r2.xyz = debugColorOverride.www * r6.xyz + r2.xyz;
  r6.xyz = debugSpecularOverride.xyz + -r3.xyz;
  r3.xyz = debugSpecularOverride.www * r6.xyz + r3.xyz;
  r0.w = r0.w + -r0.y;
  r0.y = debugGlossOverride.w * r0.w + r0.y;
  ...
  r4.xyz = debugNormalOverride.www * r6.xyz + r4.xyz;
  ...
  while (true) {
    ...
    r9.w = cmp((int)r0.w == (int)r6.w);
    if (r3.w == 0) r10.z = 0; else if (r3.w+0 < 32) {     r10.z = (uint)r7.w << (32-(r3.w + 0)); r10.z = (uint)r10.z >> (32-r3.w);    } else r10.z = (uint)r7.w >> 0;
        ...
        r19.z = samp0[]..swiz;
          ...
          r22.w = samp0[]..swiz;
            ...
            r19.w = samp0[]..swiz;
              ...
              if (r20.z != 0) {
                if (4 == 0) r14.w = 0; else if (4+24 < 32) {                 r14.w = (uint)r18.w << (32-(4 + 24)); r14.w = (uint)r14.w >> (32-4);                } else r14.w = (uint)r18.w >> 24;
                r14.w = 1 << (int)r14.w;
                r15.w = (uint)r18.w >> 28;
                r15.w = 1 << (int)r15.w;
              ...
              if (r18.y != 0) {
                ...
                r15.xyz = r18.xyz * r14.www + r19.xyz;
              }
              r15.w = 1 + -r14.w;
              r18.xyz = r15.www * r11.xyz;
              r11.xyz = r17.xyz * r14.www + r18.xyz;
              r17.xyz = r16.xyz * r15.www;
              r16.xyz = r26.xyz * r14.www + r17.xyz;
              r10.z = r10.z * r15.w + r14.w;
              r15.w = r15.w * r10.w;
              r10.w = r13.w * r14.w + r15.w;
            }
          }
        }
      }
  ...
  if (r0.y != 0) {
    ...
    r7.xy = clampU ? r1.xy : r0.yw;
  }
  r0.y = dot(-v7.xyz, -v7.xyz);
  r0.y = rsqrt(r0.y);
  r10.xyz = -v7.xyz * r0.yyy;
  r0.w = saturate(dot(r10.xyz, r5.xyz));
  r5.xyzw = emissiveMap.Sample(colorSampler_s, r7.xy).xyzw;
  ...
  r6.x = saturate(dot(r4.xyz, r10.xyz));
  ...
  while (true) {
    ...
    if (r6.w != 0) break;
    r14.z = (uint)r6.z >> 5;
    r15.xyz = (int3)r9.xyz + (int3)r14.xyz;
    r6.w = visibleProbes.Load(r15.xyzw).x;
  // Known bad code for instruction (needs manual fix):
  ...
  r41.z = samp0[]..swiz;
  r41.w = samp0[]..swiz;
    r11.w = dot(r36.xyz, r12.yzw);
    r11.w = saturate(r11.w + r36.w);
    r14.z = dot(r37.xyz, r12.yzw);
    r14.z = saturate(r14.z + r37.w);
    r11.w = r14.z * r11.w;
    r14.z = dot(r38.xyz, r12.yzw);
    r14.z = saturate(r14.z + r38.w);
    r11.w = r14.z * r11.w;
    r14.z = dot(r39.xyz, r12.yzw);
    r14.z = saturate(r14.z + r39.w);
    r11.w = r14.z * r11.w;
    r14.z = dot(r40.xyz, r12.yzw);
    r14.z = saturate(r14.z + r40.w);
    r11.w = r14.z * r11.w;
    r14.z = dot(r41.xyz, r12.yzw);
    ...
    r31.z = r32.z;
    r15.x = dot(r13.xyz, r31.xyz);
    r15.y = dot(r12.yzw, r31.xyz);
    r15.y = r15.y + -r32.w;
    r15.z = cmp(r15.y >= 0);
    r15.y = max(abs(r15.y), r2.w);
    r15.y = r15.z ? r15.y : -r15.y;
    ...
    r11.w = min(abs(r15.x), r11.w);
    r32.z = r33.z;
    r15.x = dot(r13.xyz, r32.xyz);
    r15.y = dot(r12.yzw, r32.xyz);
    r15.y = r15.y + -r33.w;
    r15.z = cmp(r15.y >= 0);
    r15.y = max(abs(r15.y), r2.w);
    r15.y = r15.z ? r15.y : -r15.y;
    ...
    r11.w = min(abs(r15.x), r11.w);
    r33.z = r34.x;
    r15.x = dot(r13.xyz, r33.xyz);
    r15.y = dot(r12.yzw, r33.xyz);
    r15.y = r15.y + -r34.y;
    r15.z = cmp(r15.y >= 0);
    r15.y = max(abs(r15.y), r2.w);
    r15.y = r15.z ? r15.y : -r15.y;
    ...
    r11.w = min(abs(r15.x), r11.w);
    r35.zw = r34.zw;
    r15.x = dot(r13.zxy, r35.xzw);
    r15.y = dot(r12.wyz, r35.xzw);
    r15.y = r15.y + -r35.y;
    r15.z = cmp(r15.y >= 0);
    r15.y = max(abs(r15.y), r2.w);
    r15.y = r15.z ? r15.y : -r15.y;
    ...
    r15.x = r26.w;
    r15.yz = r27.zw;
    r15.xyz = r15.xyz + r12.yzw;
    r15.xyz = r13.xyz * r11.www + r15.xyz;
    ...
    if (6 == 0) r15.x = 0; else if (6+25 < 32) {     r15.x = (uint)r29.y << (32-(6 + 25)); r15.x = (uint)r15.x >> (32-6);    } else r15.x = (uint)r29.y >> 25;
    if (9 == 0) r15.y = 0; else if (9+16 < 32) {     r15.y = (uint)r29.y << (32-(9 + 16)); r15.y = (uint)r15.y >> (32-9);    } else r15.y = (uint)r29.y >> 16;
    r30.w = (uint)r15.y;
    r24.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r30.xyzw, r11.w).xyz;
    ...
    r32.x = dot(r12.yzw, r23.xyz);
    r32.y = dot(r12.yzw, r31.xyz);
    r32.z = dot(r12.yzw, r25.xyz);
    r26.xyz = saturate(r32.xyz * r26.xyz + float3(0.5,0.5,0.5));
    r27.z = r28.x;
    r26.xyz = r26.xyz * r27.xyz + r28.yzw;
    r30.x = dot(r4.xyz, r23.xyz);
    r30.y = dot(r4.xyz, r31.xyz);
    r30.z = dot(r4.xyz, r25.xyz);
    ...
    while (true) {
      ...
      if (r16.x != 0) {
        ...
        if (r9.w != 0) {
          ...
          r37.z = samp0[]..swiz;
          r37.w = samp0[]..swiz;
            r16.w = dot(r32.xyz, r12.yzw);
            r16.w = saturate(r16.w + r32.w);
            r16.w = r31.x * r16.w;
            r17.z = dot(r33.xyz, r12.yzw);
            r17.z = saturate(r17.z + r33.w);
            r16.w = r17.z * r16.w;
            r17.z = dot(r34.xyz, r12.yzw);
            r17.z = saturate(r17.z + r34.w);
            r16.w = r17.z * r16.w;
            r17.z = dot(r35.xyz, r12.yzw);
            r17.z = saturate(r17.z + r35.w);
            r16.w = r17.z * r16.w;
            r17.z = dot(r36.xyz, r12.yzw);
            r17.z = saturate(r17.z + r36.w);
            r16.w = r17.z * r16.w;
            r17.z = dot(r37.xyz, r12.yzw);
            r17.z = saturate(r17.z + r37.w);
            r31.x = r17.z * r16.w;
            r17.w = (uint)r15.z >> 2;
            if (1 == 0) r18.z = 0; else if (1+2 < 32) {             r18.z = (uint)r15.z << (32-(1 + 2)); r18.z = (uint)r18.z >> (32-1);            } else r18.z = (uint)r15.z >> 2;
            r18.w = (int)r17.w & 2;
            r19.z = max(r31.y, r31.x);
            r16.w = -r16.w * r17.z + 1;
            r16.w = r31.y * r16.w;
            r20.y = r18.w ? r16.w : r19.z;
            r31.xy = r18.zz ? r31.xy : r20.xy;
            r16.x = (int)r16.x + 1;
            r15.z = r17.w;
          }
          ...
          r16.x = cmp(0 < r15.z);
          if (r16.x != 0) {
            r32.z = r31.y * r7.w + r29.w;
            r15.z = r15.z * r29.x;
            r20.yzw = r27.xyz * r15.zzz;
            r31.xzw = r23.xyw * r20.zzz;
            r31.xzw = r25.xyz * r20.yyy + r31.xzw;
            r20.yzw = r26.xyz * r20.www + r31.xzw;
            r31.xzw = r20.yzw * r28.xyz;
            r16.x = dot(r31.xzw, float3(0.212599993,0.715200007,0.0722000003));
            r33.xyz = r20.yzw * r28.xyz + r30.xyz;
            r16.w = r16.x * r3.w;
            r20.yzw = r24.xyz * r15.zzz;
            r15.z = dot(r20.yzw, float3(0.212599993,0.715200007,0.0722000003));
            r15.z = r3.w * r16.x + r15.z;
            r15.z = r16.w / r15.z;
            r34.x = r30.w;
            r34.yz = r29.yz;
            r32.xyw = r20.zwy * r15.zzz + r34.yzx;
            r33.w = r32.w;
          } else {
            r33.xyzw = r30.xyzw;
            r32.xyz = r29.yzw;
  ...
  if (r5.w == 0) {
    ...
    while (true) {
      ...
      r11.w = cmp((int)r6.z == (int)r9.w);
      bitmask.y = ((~(-1 << r6.w)) << 0) & 0xffffffff;  r12.y = (((uint)0 << 0) & bitmask.y) | ((uint)r10.w & ~bitmask.y);
      r10.w = r11.w ? r12.y : r10.w;
      r11.w = cmp((int)r7.z == (int)r9.w);
      if (r7.w == 0) r12.y = 0; else if (r7.w+0 < 32) {       r12.y = (uint)r10.w << (32-(r7.w + 0)); r12.y = (uint)r12.y >> (32-r7.w);      } else r12.y = (uint)r10.w >> 0;
      r10.w = r11.w ? r12.y : r10.w;
        ...
        r15.y = samp0[]..swiz;
          ...
          r34.w = samp0[]..swiz;
            ...
            r35.w = samp0[]..swiz;
              ...
              r19.w = r20.w * r19.w;
              r20.w = dot(r34.xyz, r15.xyz);
              r20.w = saturate(r20.w + r34.w);
              r19.w = r20.w * r19.w;
              r20.w = dot(r35.xyz, r15.xyz);
            ...
            r40.y = samp0[]..swiz;
              ...
              r12.w = min(abs(r14.z), r12.w);
              r40.zw = r39.zw;
              r14.z = dot(r13.zxy, r40.xzw);
              r14.w = dot(r15.zxy, r40.xzw);
              r14.w = r14.w + -r40.y;
              r16.x = cmp(r14.w >= 0);
              r14.w = max(abs(r14.w), r2.w);
              r14.w = r16.x ? r14.w : -r14.w;
              ...
              r12.z = r3.w * r12.w + r12.z;
              r12.z = r14.z / r12.z;
              r27.x = r25.w;
              r27.yz = r26.xy;
              r26.xyw = r15.yzx * r12.zzz + r27.yzx;
              r25.w = r26.w;
            }
          }
        }
          ...
          r28.y = samp0[]..swiz;
            ...
            r35.w = samp0[]..swiz;
              ...
              r37.w = samp0[]..swiz;
                ...
                r31.xy = r29.ww ? r31.xy : r18.xy;
                r19.w = (int)r19.w + 1;
                r16.x = r27.w;
              }
              r16.x = saturate(r31.y + -r11.w);
              r16.w = r16.x * r18.w;
              r17.w = cmp(0 < r16.w);
              if (r17.w != 0) {
              // Known bad code for instruction (needs manual fix):
              ...
              r41.y = samp0[]..swiz;
                ...
                r36.w = (uint)r16.w;
                r18.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r36.xyzw, r16.x).xyz;
    ...
    if (r2.w != 0) {
      ...
      r21.xyz = r23.xyz * r1.zzz + r12.yzw;
      r13.w = 0;
      r12.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r13.xyzw, r1.w).xyz;
      r1.z = sunConstants.globalProbeExposure * r2.w + -r3.w;
      r1.z = r6.y * r1.z + r3.w;
      r22.xyz = r12.yzw * r1.zzz + r22.xyz;
    }
  } else {
    r22.x = r21.w;
  }
  ...
  r12.yzw = r22.xyz * r1.zzz;
  r15.xyz = r12.zwy * r6.yyy;
  r6.yzw = r12.yzw * r6.zzz;
  r0.z = sqrt(r1.y);
  r0.z = r0.z * 0.5 + 0.5;
  r0.z = r0.z * r0.z;
  r1.z = 0.5 * r0.z;
  ...
  if (r3.w == 0) {
    ...
    if (r5.w != 0) {
      ...
      while (true) {
        ...
        if (r7.w != 0) break;
        r7.w = (uint)r5.w;
        r16.xy = -sunConstants.splitPinTransform[r7.w].xy + r12.yz;
        r9.w = max(abs(r16.x), abs(r16.y));
        r7.z = sunConstants.splitPinTransform[r7.w].z * r9.w;
        r7.w = cmp(r7.z < 1);
        if (r7.w != 0) {
          break;
        }
    ...
    if (r7.w == 0) {
      ...
      if (enableDitheredShadow != 0) {
        ...
        r7.z = 28 * r7.z;
        r7.z = (uint)r7.z;
        r17.xy = -sunConstants.splitPinTransform[r7.w].xy + r12.yz;
        r17.xy = sunConstants.splitPinTransform[r7.w].zz * r17.xy;
        ...
        while (true) {
          ...
          if (r11.w != 0) break;
          r11.w = cmp((uint)r7.z < (uint)r10.w);
  ...
  if (r3.w != 0) {
    ...
    if (r3.w != 0) {
      ...
      if (sunConstants.sunCookieIndex != 0) {
        r8.w = 1;
        r5.w = dot(sunConstants.sunCookieTransform[0].xyzw, r8.xyzw);
        r7.z = dot(sunConstants.sunCookieTransform[1].xyzw, r8.xyzw);
        r8.x = frac(r5.w);
        r8.y = frac(r7.z);
        r5.w = -1 + (int14)sunConstants.sunCookieIndex;
        r8.z = (uint)r5.w;
        r8.xyz = gCookieArray.SampleLevel(samplerLinear_s, r8.xyz, 0).xyz;
      ...
      r19.z = samp0[]..swiz;
      r19.w = samp0[]..swiz;
        r7.w = abs(r1.w) * -0.200000003 + 0.400000006;
        r20.xyz = r4.xyz * r7.www + v7.xyz;
        r20.w = 1;
        ...
        r17.y = samp0[]..swiz;
          ...
          if (enableDitheredShadow != 0) {
            ...
            while (true) {
              ...
              r18.xy = r19.xy * r7.zz + r16.xy;
              r10.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r18.xyz, r5.w).x;
      ...
      r2.w = r4.w * r2.w;
      r2.w = 0.25 * r2.w;
      r12.yzw = r2.www * r8.xyz + r6.yzw;
      r0.y = saturate(1 + -r0.y);
      r3.w = r0.y * r0.y;
      r3.w = r3.w * r3.w;
      r0.y = r3.w * r0.y;
      r0.y = r2.w * r0.y;
      r8.xyz = r0.yyy * r8.yzx + r15.xyz;
      r16.w = r8.z;
      r14.w = r15.z;
      r14.xyzw = r1.wwww ? r16.xyzw : r14.xyzw;
      r8.zw = r12.yz;
      r15.zw = r6.yz;
      r8.xyzw = r1.wwww ? r8.xyzw : r15.xyzw;
      r6.w = r1.w ? r12.w : r6.w;
      r15.z = r14.w;
      r15.xy = r8.xy;
      r6.yz = r8.zw;
    }
  ...
  while (true) {
    ...
    if (r4.w != 0) break;
    r16.z = (uint)r3.w >> 5;
    r17.xyz = (int3)r9.xyz + (int3)r16.xyz;
    ...
    while (true) {
      ...
      r33.y = samp0[]..swiz;
        ...
        r38.z = samp0[]..swiz;
        r38.w = samp0[]..swiz;
          if (3 == 0) r7.w = 0; else if (3+24 < 32) {           r7.w = (uint)r33.w << (32-(3 + 24)); r7.w = (uint)r7.w >> (32-3);          } else r7.w = (uint)r33.w >> 24;
          switch (r7.w) {
            case 4 :            r7.w = cmp(0 < r38.x);
            r39.xy = r37.zw;
            r39.z = r38.w;
              ...
              if (r15.w != 0) {
                ...
                if (r15.w != 0) {
                  ...
                  while (true) {
                    ...
                    if (r25.w != 0) break;
                    r44.y = dot(icb[r21.w+0].yx, r8.xy);
                    r44.z = dot(icb[r21.w+0].yx, r8.yz);
                ...
                if (r15.w != 0) {
                  ...
                  r39.xyz = r7.www ? r39.xyz : r32.yzw;
                  r39.xyz = -v7.xyz + r39.xyz;
                  r7.w = dot(r39.xyz, r39.xyz);
                  r7.w = rsqrt(r7.w);
                  r40.xyz = r39.xyz * r7.www;
                    ...
                    r9.w = samp0[]..swiz;
                      ...
                      if (r5.w != 0) {
                        ...
                        while (true) {
                          ...
                          if (r26.w != 0) break;
                          r42.x = dot(icb[r25.w+0].yx, r8.xw);
                          r42.y = dot(icb[r25.w+0].xy, r7.xy);
                  ...
                  r9.w = saturate(dot(r4.xyz, r40.xyz));
                  r20.xyz = r39.xyz * r7.www + r10.xyz;
                  r7.w = dot(r20.xyz, r20.xyz);
                  r7.w = rsqrt(r7.w);
                  r20.xyz = r20.xyz * r7.www;
                  r7.w = dot(r20.xyz, r10.xyz);
                  r13.w = dot(r4.xyz, r20.xyz);
                  ...
                  r7.w = r11.w * r7.w;
                  r7.w = r9.w * r7.w;
                  r39.xyz = r7.www * r33.xyz + r30.xyz;
            ...
            r40.w = samp0[]..swiz;
              ...
              if (r11.w != 0) {
                  ...
                  r40.y = samp0[]..swiz;
                    ...
                    if (r5.w != 0) {
                      ...
                      while (true) {
                        ...
                        r16.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r32.xyz, r7.z).x;
                        r14.w = r16.z * 0.125 + r14.w;
                        r15.w = (int)r15.w + 1;
                      }
                    } else {
                      r22.z = (uint)r11.w;
                      r14.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r22.xyz, r7.z).x;
                    }
                    r7.z = r14.w * r14.w;
                    r7.z = r7.z * r14.w;
                  } else {
                ...
                if (r11.w != 0) {
                  ...
                  r19.xyz = r19.xyz * r7.www + r10.xyz;
                  r7.w = dot(r19.xyz, r19.xyz);
                  r7.w = rsqrt(r7.w);
                  r19.xyz = r19.xyz * r7.www;
                  r7.w = dot(r19.xyz, r10.xyz);
                  r13.w = dot(r4.xyz, r19.xyz);
                  ...
                  r7.z = r10.w * r7.z;
                  r7.z = 0.25 * r7.z;
                  r19.xyz = r7.zzz * r20.xyz + r31.xyz;
                  r7.w = saturate(1 + -r7.w);
                  r10.w = r7.w * r7.w;
                  r10.w = r10.w * r10.w;
                  r7.w = r10.w * r7.w;
                  r7.z = r7.z * r7.w;
                  r20.xyz = r7.zzz * r20.xyz + r30.xyz;
