...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:39:53 2021
//
//
// Buffer Definitions: 
//
...
sample_indexable(texture2d)(float,float,float,float) r4.xyz, r4.xyxx, t26.xyzw, s5
...
mad r3.xy, r4.xyxx, cb0[11].zzzz, r2.xyxx
dp3 r2.x, r3.xyzx, r3.xyzx
rsq r2.x, r2.x
mul r3.xyz, r2.xxxx, r3.xyzx
mad r2.x, r2.w, cb0[11].z, r2.z
...
mad r2.yzw, r5.xxyz, r3.xxxx, r2.yyzw
mad r2.yzw, r4.xxyz, r3.zzzz, r2.yyzw
...
mad r1.xyz, cb1[60].wwww, r1.xyzx, r2.yzwy
ftou r2.xy, v0.xyxx
...
ret 
// Approximately 2217 instruction slots used
