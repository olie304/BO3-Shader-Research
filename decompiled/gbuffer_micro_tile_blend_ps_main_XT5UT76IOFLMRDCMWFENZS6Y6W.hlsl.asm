...
movc r0.zw, cb0[17].xxxx, r1.xxxy, r0.zzzw
...
sample_indexable(texture2d)(float,float,float,float) r4.xyz, v2.xyxx, t6.xyzw, s2
...
mad r4.xy, r2.xyxx, cb0[13].zzzz, r2.zwzz
...
exp r2.y, r2.y
add r2.y, r2.y, -cb0[18].x
add r3.w, -cb0[18].x, l(1.000000)
...
mad r3.w, r0.w, cb0[13].w, r1.w
mad r5.w, r0.y, cb0[13].z, r1.w
mad r4.xy, r1.xyxx, cb0[13].wwww, r2.zwzz
...
add r0.y, -cb0[16].x, cb0[16].y
mad r0.y, r0.z, r0.y, cb0[16].x
