...
if_nz r13.z
  ...
  if_nz r13.y
    ...
    if_nz r15.w
      ...
      utof r20.w, r8.w
      sample_l_indexable(texturecubearray)(float,float,float,float) r18.xyz, r20.xyzw, t8.xyzw, s2, r5.w
...
if_nz r5.w
  ...
  mov r14.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r13.yzw, r14.xyzw, t8.wxyz, s2, r7.w
  mad r0.x, cb2[19].x, r5.w, -r8.w
...
mul r0.x, r6.w, r0.x
mul r13.yzw, r2.zzzz, r17.xxyz
and r15.xyz, r0.wwww, r13.yzwy
...
ubfe r2.y, l(3), l(24), cb9[r0.y + 1].w
switch r2.y
  case l(4)
  lt r2.y, l(0.000000), cb9[r0.y + 6].y
  ...
  add r20.xyz, -r10.xyzx, r19.xyzx
  dp3 r2.w, r18.xyzx, r20.xyzx
  div_sat r4.z, -r2.w, cb9[r0.y + 6].y
  mad r21.xyz, r4.zzzz, r18.xyzx, r19.xyzx
  movc r21.xyz, r2.yyyy, r21.xyzx, cb9[r0.y + 0].xyzx
  ...
  if_nz r8.w
    ...
    mad_sat r21.xy, r8.wwww, cb9[r0.y + 2].xzxx, cb9[r0.y + 2].ywyy
    ...
    if_nz r8.w
      ...
      if_nz r8.w
        ...
        max r8.w, r8.w, |r21.y|
        div r8.w, cb9[r0.y + 5].x, r8.w
        add r8.w, r8.w, cb9[r0.y + 5].y
      ...
      if_nz r8.w
        ...
        mad r14.xyz, r2.wwww, r18.xyzx, r19.xyzx
        movc r14.xyz, r2.yyyy, r14.xyzx, cb9[r0.y + 0].xyzx
        add r14.xyz, -r10.xyzx, r14.xyzx
        dp3 r2.y, r14.xyzx, r14.xyzx
        rsq r2.y, r2.y
        mul r18.xyz, r2.yyyy, r14.xyzx
        ubfe r2.w, l(4), l(16), cb9[r0.y + 1].w
        ult r4.z, l(0), r2.w
        and r4.z, r9.z, r4.z
        if_nz r4.z
          ...
          ubfe r2.w, l(4), l(20), cb9[r0.y + 1].w
          ult r4.z, l(0), r2.w
          not r11.w, r9.z
          and r4.z, r4.z, r11.w
          if_nz r4.z
        ...
        mad r20.xyz, r17.xyzx, r2.zzzz, r20.xyzx
        dp3_sat r6.w, r11.xyzx, r18.xyzx
        ...
        mul r6.w, r6.w, r7.w
        mul r5.w, r5.w, r6.w
        mad r14.xyz, r5.wwww, r19.xyzx, r9.xywx
        add_sat r2.y, -r2.y, l(1.000000)
        mul r6.w, r2.y, r2.y
        mul r6.w, r6.w, r6.w
        mul r2.y, r2.y, r6.w
        mul r2.y, r2.y, r5.w
        mad r18.xyz, r2.yyyy, r19.xyzx, r16.xyzx
        mad r19.xyz, r2.wwww, r19.xyzx, r15.xyzx
        and r19.xyz, r0.wwww, r19.xyzx
        movc r13.yzw, r4.zzzz, r20.xxyz, r13.yyzw
        movc r15.xyz, r4.zzzz, r15.xyzx, r19.xyzx
        movc r16.xyz, r4.zzzz, r18.xyzx, r16.xyzx
        movc r9.xyw, r4.zzzz, r14.xyxz, r9.xyxw
      endif 
    endif 
  endif 
  break 
  ...
  if_nz r6.w
    ...
    if_nz r7.w
      ...
      add r20.xyz, -r10.xyzx, cb9[r0.y + 0].xyzx
      mul r8.w, cb9[r0.y + 3].x, cb9[r0.y + 3].x
      dp3 r11.w, r20.xyzx, r20.xyzx
      div r8.w, r8.w, r11.w
      min r8.w, r8.w, l(1.000000)
      mad_sat r20.xy, r6.wwww, cb9[r0.y + 2].xzxx, cb9[r0.y + 2].ywyy
      ...
      if_nz r6.w
        ...
        mad r11.w, cb9[r0.y + 12].y, r21.y, l(-1.000000)
      ...
      if_nz r6.w
        ...
        dp3 r8.w, cb9[r0.y + 13].xyzx, r20.xyzx
        ...
        if_nz r10.w
          ...
          if_nz cb2[58].y
            ...
            loop 
              ige r12.w, r11.w, l(8)
              breakc_nz r12.w
              dp2 r22.x, icb[r11.w + 0].yxyy, r18.xyxx
              dp2 r22.y, icb[r11.w + 0].yxyy, r18.yzyy
      ...
      if_nz r7.w
        ...
        if_nz r10.w
          ...
          if_z r12.w
            ...
            div r18.xy, r20.xyxx, r11.wwww
            mad r18.xy, r18.xyxx, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
            add r20.x, r18.x, cb9[r8.w + 9].w
            add r20.y, r18.y, cb9[r8.w + 10].x
            mul r18.xy, r20.xyxx, cb9[r8.w + 9].yzyy
            ...
            if_z r14.w
              ...
              mad r20.x, r18.x, cb9[r8.w + 8].y, cb9[r8.w + 8].z
              mad r20.y, r18.y, cb9[r8.w + 8].w, cb9[r8.w + 9].x
          ...
          if_z r11.w
            ...
            if_nz cb2[58].y
              ...
              loop 
                ige r15.w, r14.w, l(8)
                breakc_nz r15.w
                dp2 r22.x, icb[r14.w + 0].yxyy, r18.xyxx
                dp2 r22.y, icb[r14.w + 0].yxyy, r18.yzyy
            ...
            if_z r9.z
              ...
              if_nz cb2[58].y
                ...
                loop 
                  ige r11.w, r10.w, l(8)
                  breakc_nz r11.w
                  dp2 r22.x, icb[r10.w + 0].yxyy, r18.xyxx
                  dp2 r22.y, icb[r10.w + 0].yxyy, r18.yzyy
                  mad r21.xy, r22.xyxx, cb9[r0.y + 3].yyyy, r20.xyxx
        ...
        mad r2.xzw, r17.xxyz, r2.zzzz, r18.xxyz
        mad r14.xyz, r14.xyzx, r2.yyyy, r12.xyzx
        dp3 r2.y, r14.xyzx, r14.xyzx
        rsq r2.y, r2.y
        mul r14.xyz, r2.yyyy, r14.xyzx
        ...
        mad r11.xyz, r0.xxxx, r19.xyzx, r9.xywx
        add_sat r0.z, -r2.y, l(1.000000)
        mul r1.w, r0.z, r0.z
        mul r1.w, r1.w, r1.w
        mul r0.z, r0.z, r1.w
        mul r0.x, r0.z, r0.x
        mad r12.xyz, r0.xxxx, r19.xyzx, r16.xyzx
        mad r0.xyz, r0.yyyy, r19.xyzx, r15.xyzx
        and r0.xyz, r0.xyzx, r0.wwww
        movc r13.yzw, r1.zzzz, r2.xxzw, r13.yyzw
        movc r15.xyz, r1.zzzz, r15.xyzx, r0.xyzx
        movc r16.xyz, r1.zzzz, r12.xyzx, r16.xyzx
        movc r9.xyw, r1.zzzz, r11.xyxz, r9.xyxw
      endif 
    endif 
  endif 
  break 
...
add r2.x, r0.y, r2.z
mul r0.xyz, r3.yzwy, r13.yzwy
mad r0.xyz, r15.xyzx, r2.xyzx, r0.xyzx
...
mad r2.xyz, r13.yzwy, r3.yzwy, r2.xyzx
...
ret 
// Approximately 1832 instruction slots used
