...
void main( 
  ...
  out float3 o2 : POSITION0,
  out float4 o3 : BLENDWEIGHT0,
  out uint4 o4 : BLENDINDICES0)
{
...
// unknown dcl_: dcl_resource_structured t5, 64
  ...
  r0.z = shadowParams.y + v0.z;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r1.x, l(0), l(0), t4.xxxx
r1.x = modelInstanceBuffer[]..swiz;
  if (r1.x != 0) {
    r1.y = cmp(v1.x != 0.000000);
    if (r1.y != 0) {
      r1.y = (int)r1.x + (int)v2.x;
    // Known bad code for instruction (needs manual fix):
    ...
    r3.w = modelInstanceBuffer[]..swiz;
      ...
      r1.y = r1.y + r3.w;
      r2.yz = v1.xx * r1.zy;
      r1.y = cmp(v1.y != 0.000000);
      if (r1.y != 0) {
        r1.y = (int)r1.x + (int)v2.y;
      // Known bad code for instruction (needs manual fix):
      ...
      r4.w = modelInstanceBuffer[]..swiz;
        ...
        r1.y = r1.y + r4.w;
        r3.z = r1.y * v1.y + r2.z;
        r1.y = cmp(v1.z != 0.000000);
        if (r1.y != 0) {
          r1.y = (int)r1.x + (int)v2.z;
        // Known bad code for instruction (needs manual fix):
        ...
        r5.w = modelInstanceBuffer[]..swiz;
          ...
          r1.y = r1.y + r5.w;
          r4.z = r1.y * v1.z + r3.z;
          r1.y = cmp(v1.w != 0.000000);
          if (r1.y != 0) {
            r1.x = (int)r1.x + (int)v2.w;
          // Known bad code for instruction (needs manual fix):
...
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r1.x, l(0), l(12), t4.xxxx
r1.x = modelInstanceBuffer[]..swiz;
  if (r1.x != 0) {
  // Known bad code for instruction (needs manual fix):
