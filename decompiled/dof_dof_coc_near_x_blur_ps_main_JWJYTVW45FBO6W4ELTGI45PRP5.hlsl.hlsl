  ...
  out float o0 : SV_TARGET0)
{
  ...
  r0.x = codeTexture0.Sample(bilinearClamp_s, v1.xy).x;
  r1.xyzw = postFxControl0.zxwy + v1.xxxx;
  r2.xz = r1.yw;
  r2.yw = v1.yy;
  r0.y = codeTexture0.Sample(bilinearClamp_s, r2.xy).x;
  r0.z = codeTexture0.Sample(bilinearClamp_s, r2.zw).x;
  r0.y = 0.234375 * r0.y;
  r0.x = r0.x * 0.01953125 + r0.y;
  r0.x = r0.z * 0.4921875 + r0.x;
  r1.yw = v1.yy;
  r0.y = codeTexture0.Sample(bilinearClamp_s, r1.xy).x;
  r0.z = codeTexture0.Sample(bilinearClamp_s, r1.zw).x;
  r0.x = r0.y * 0.234375 + r0.x;
  r0.x = r0.z * 0.01953125 + r0.x;
  r0.y = codeTexture1.Sample(bilinearClamp_s, v1.zw).x;
  r0.x = max(r0.y, r0.x);
  o0.x = r0.x * 2 + -r0.y;
  return;
}