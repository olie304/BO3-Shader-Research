...
cbuffer _Globals : register(b0)
{
  ...
  float blurAmount : packoffset(c11.z);
}
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r1.x = saturate(scriptVector2.x);
  r1.x = blurAmount * r1.x;
  r1.x = r1.x * r0.w;
  r1.xy = renderTargetSize.zw * r1.xx;
  r1.x = max(r1.x, r1.y);
  r2.xyzw = saturate(r1.xxxx * float4(-0.563089311,-0.268058598,-0.107148901,-0.652221084) + v1.xyxy);
  r3.xyzw = frameBuffer.Sample(bilinearSampler_s, r2.xy).xyzw;
  r2.xyzw = frameBuffer.Sample(bilinearSampler_s, r2.zw).xyzw;
  r2.xyzw = r3.xyzw + r2.xyzw;
  r3.xyzw = saturate(r1.xxxx * float4(-0.297493488,0.236788303,-0.940281689,0.287647098) + v1.xyxy);
  ...
  r3.xyzw = saturate(r1.xxxx * float4(0.374713004,-0.33693859,0.4578771,-0.749875307) + v1.xyxy);
  r4.xyzw = frameBuffer.Sample(bilinearSampler_s, r3.xy).xyzw;
  r3.xyzw = frameBuffer.Sample(bilinearSampler_s, r3.zw).xyzw;
  r2.xyzw = r4.xyzw + r2.xyzw;
  r2.xyzw = r2.xyzw + r3.xyzw;
  r3.xyzw = saturate(r1.xxxx * float4(-0.4427737,-0.886700988,0.788797915,-0.427877992) + v1.xyxy);
  r4.xyzw = frameBuffer.Sample(bilinearSampler_s, r3.xy).xyzw;
  r3.xyzw = frameBuffer.Sample(bilinearSampler_s, r3.zw).xyzw;
  r2.xyzw = r4.xyzw + r2.xyzw;
  r2.xyzw = r2.xyzw + r3.xyzw;
  r3.xyzw = saturate(r1.xxxx * float4(-0.0290644299,-0.2007249,0.427763313,0.165135205) + v1.xyxy);
  r4.xyzw = frameBuffer.Sample(bilinearSampler_s, r3.xy).xyzw;
  r3.xyzw = frameBuffer.Sample(bilinearSampler_s, r3.zw).xyzw;
  r2.xyzw = r4.xyzw + r2.xyzw;
  r2.xyzw = r2.xyzw + r3.xyzw;
  r3.xyzw = saturate(r1.xxxx * float4(-0.230788201,0.640438676,-0.657632113,0.674599111) + v1.xyxy);
  r4.xyzw = frameBuffer.Sample(bilinearSampler_s, r3.xy).xyzw;
  r3.xyzw = frameBuffer.Sample(bilinearSampler_s, r3.zw).xyzw;
  r2.xyzw = r4.xyzw + r2.xyzw;
  r2.xyzw = r2.xyzw + r3.xyzw;
  r3.xyzw = saturate(r1.xxxx * float4(0.869136691,0.00676916121,0.283670396,0.930419683) + v1.xyxy);
  r1.xyzw = saturate(r1.xxxx * float4(0.512029588,0.590522408,-0.968446076,-0.189363196) + v1.xyxy);
  r4.xyzw = frameBuffer.Sample(bilinearSampler_s, r3.xy).xyzw;
  r3.xyzw = frameBuffer.Sample(bilinearSampler_s, r3.zw).xyzw;
  r2.xyzw = r4.xyzw + r2.xyzw;
  r2.xyzw = r2.xyzw + r3.xyzw;
