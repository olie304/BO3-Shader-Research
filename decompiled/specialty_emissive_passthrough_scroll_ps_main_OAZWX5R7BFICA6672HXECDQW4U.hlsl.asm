...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:41:05 2021
//
//
// Buffer Definitions: 
//
...
dcl_output o0.xyzw
dcl_temps 6
sample_indexable(texture2d)(float,float,float,float) r0.x, v1.yzyy, t24.xyzw, s1
eq r0.y, r0.x, l(0.000000)
dp3 r0.z, -v6.xyzx, -v6.xyzx
rsq r0.z, r0.z
mul r1.xyz, r0.zzzz, -v6.xyzx
dp3 r2.x, r1.xyzx, v4.xyzx
dp3 r2.y, r1.xyzx, v5.xyzx
...
if_nz r0.y
  ...
  if_nz r0.y
    ...
    if_nz r0.z
      ...
      movc r0.zw, r1.wwww, r4.xxxy, r0.zzzw
...
if_nz r0.x
  ...
  mul r1.yzw, r0.xxxx, cb2[11].xxyz
  ...
  mad r1.xyz, r0.xxxx, r2.xyzx, r0.yzwy
endif 
