...
loop 
  ieq r15.y, r13.w, l(2)
  breakc_nz r15.y
  movc r15.y, r13.w, r0.y, r10.w
  uge r15.z, r15.y, r9.w
...
loop 
  ieq r18.w, r13.w, l(2)
  breakc_nz r18.w
  movc r18.w, r13.w, r0.y, r10.w
  ult r19.w, r18.w, r9.w
  if_nz r19.w
...
bfi r4.w, l(8), l(0), r20.y, r24.w
movc r0.y, r0.y, r4.w, r20.y
max r4.w, r20.x, l(1.000000)
rcp r4.w, r4.w
mov_sat r20.x, r20.x
mul r17.xyz, r4.wwww, r15.yzwy
...
if_nz r7.w
  ...
  mad r17.xyz, r15.yzwy, r4.wwww, r19.xyzx
  mov r16.w, l(0)
  ...
  mad r18.xyz, r15.yzwy, r4.wwww, r18.xyzx
endif 
...
ret 
// Approximately 2143 instruction slots used
