...
sample_indexable(texture2d)(float,float,float,float) r0.yzw, v1.yzyy, t9.wxyz, s3
...
sample_indexable(texture2d)(float,float,float,float) r4.x, r2.xwxx, t10.xyzw, s2
sample_indexable(texture2d)(float,float,float,float) r4.yzw, r2.xwxx, t12.wxyz, s3
mad r2.xw, r4.yyyz, l(1.99218750, 0.000000, 0.000000, 1.99218750), l(-1.000000, 0.000000, 0.000000, -1.000000)
mul r4.y, r4.w, r4.w
...
mul r4.zw, r4.zzzw, cb0[6].xxxy
movc r2.yz, cb0[15].yyyy, r2.yyzy, r4.zzwz
sample_indexable(texture2d)(float,float,float,float) r5.xyzw, r2.yzyy, t17.xyzw, s1
sample_indexable(texture2d)(float,float,float,float) r1.w, r2.yzyy, t14.yzwx, s1
...
sample_indexable(texture2d)(float,float,float,float) r6.xyz, r2.yzyy, t15.xyzw, s3
add r5.xyzw, -r3.xyzw, r5.xyzw
mad r3.xyzw, r0.xxxx, r5.xyzw, r3.xyzw
add r2.y, -cb0[11].x, cb0[11].y
mad r2.z, r4.x, r2.y, cb0[11].x
mul_sat r2.z, r2.z, l(0.05882353)
add r4.x, -cb0[14].x, cb0[14].y
mad r1.w, r1.w, r4.x, cb0[14].x
mul_sat r1.w, r1.w, l(0.05882353)
add r1.w, -r2.z, r1.w
mad r1.w, r0.x, r1.w, r2.z
sample_indexable(texture2d)(float,float,float,float) r2.z, v1.yzyy, t11.yzxw, s4
mad r4.xz, r6.xxyx, l(1.99218750, 0.000000, 1.99218750, 0.000000), l(-1.000000, 0.000000, -1.000000, 0.000000)
mul r4.w, r6.z, r6.z
mul r4.w, r4.w, l(0.33333334)
min r4.yw, r4.yyyw, l(0.000000, 1.000000, 0.000000, 1.000000)
mad r1.xy, r2.xwxx, cb0[12].xxxx, r0.yzyy
dp3 r2.x, r1.xyzx, r1.xyzx
rsq r2.x, r2.x
mul r5.xyz, r1.xyzx, r2.xxxx
mad r5.w, r4.y, cb0[12].x, r0.w
mad r1.xy, r4.xzxx, cb0[12].yyyy, r0.yzyy
dp3 r0.y, r1.xyzx, r1.xyzx
rsq r0.y, r0.y
mul r6.xyz, r0.yyyy, r1.xyzx
mad r6.w, r4.w, cb0[12].y, r0.w
...
mul r1.x, r1.w, l(-17.000000)
exp r1.x, r1.x
add r0.w, r0.w, r1.x
log r0.w, r0.w
mul_sat r0.w, r0.w, l(-0.05882353)
mul r1.xzw, r0.yyyy, r6.xxyz
mad r1.xzw, r5.xxyz, r0.xxxx, r1.xxzw
mad r0.xyz, r4.xyzx, r0.zzzz, r1.xzwx
dp3 r1.x, r0.xyzx, r0.xyzx
rsq r1.x, r1.x
mul r0.xyz, r0.xyzx, r1.xxxx
mad r1.x, cb1[62].x, r2.y, cb0[11].x
...
if_nz r1.z
  ...
  movc r2.xyw, r2.xxxx, r5.xyxz, r4.xyxw
  movc r4.xyz, r4.zzzz, l(0,1.000000,0,0), r3.xyzx
  movc r3.xyz, r1.wwww, r2.xywx, r4.xyzx
endif 
