...
rsq r2.w, r2.w
sample_indexable(texture2d)(float,float,float,float) r6.xyz, r0.xyxx, t15.xyzw, s1
mul r6.xyz, r6.xyzx, v8.xyzx
sample_indexable(texture2d)(float,float,float,float) r3.w, r0.xyxx, t17.yzwx, s2
mad r1.w, r3.w, r1.w, cb0[10].y
mul_sat r1.w, r1.w, l(0.05882353)
sample_indexable(texture2d)(float,float,float,float) r7.xyz, r0.xyxx, t16.xyzw, s3
add r7.xyz, r7.xyzx, l(-0.500000, -0.500000, -0.000000, 0.000000)
mad r7.xyz, cb0[10].xxxx, r7.xyzx, l(0.500000, 0.500000, 0.000000, 0.000000)
...
mul r0.y, r0.y, r4.x
exp r5.y, r0.y
mad_sat r4.xy, cb0[8].xxxx, r5.xyxx, r3.wwww
add r0.x, r0.x, -r4.x
add r0.y, -r4.x, r4.y
div_sat r0.x, r0.x, r0.y
ge r0.y, r0.x, l(0.990000)
and r0.y, r0.y, l(0x3f800000)
mad r1.xyz, r1.xyzx, v8.xyzx, -r6.xyzx
mad r1.xyz, r0.yyyy, r1.xyzx, r6.xyzx
add r0.w, r0.w, -r1.w
mad r0.w, r0.y, r0.w, r1.w
min r4.z, r0.z, l(1.000000)
...
dp2 r5.y, r2.xzxx, r1.yzyy
dp3 r0.z, r2.xyzx, r3.xyzx
add r0.z, |r0.z|, l(1.000000)
rsq r0.z, r0.z
mul r1.yz, r0.zzzz, r5.xxyx
...
mov r4.xyw, l(0.040000,0.500000,0,1.000000)
