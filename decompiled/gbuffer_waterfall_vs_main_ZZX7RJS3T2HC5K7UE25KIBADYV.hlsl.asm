...
sincos r2.xy, r3.xy, r0.yzyy
mul r0.yz, r2.xxyx, l(0.000000, 7.500000, 3.000000, 0.000000)
add r0.y, r0.z, r0.y
...
mad r2.xyz, r0.xxxx, r0.yzwy, v0.xyzx
...
mov r5.z, r7.w
add r1.yzw, r5.xxyz, -cb1[24].xxyz
mov r6.w, r1.z
mov r2.w, l(1.000000)
dp4 r5.y, r2.xyzw, r6.xyzw
mul r8.xyzw, r5.yyyy, cb1[9].xyzw
mov r4.w, r1.y
mov r7.w, r1.w
dp4 r5.x, r2.xyzw, r4.xyzw
mad r8.xyzw, r5.xxxx, cb1[8].xyzw, r8.xyzw
dp4 r5.z, r2.xyzw, r7.xyzw
mad r8.xyzw, r5.zzzz, cb1[10].xyzw, r8.xyzw
add o0.xyzw, r8.xyzw, cb1[11].xyzw
mov o1.xyzw, v1.xyzw
mul r1.yz, cb0[15].xxzx, l(0.000000, 27.239243, 25.132742, 0.000000)
mul r1.yz, r3.xxyx, r1.yyzy
mul r3.xy, r3.xyxx, cb0[15].ywyy
mul r3.xy, r3.xyxx, l(27.239243, 25.132742, 0.000000, 0.000000)
add r1.w, r3.y, r3.x
add r1.y, r1.z, r1.y
mul r1.z, cb0[16].x, l(34.456177)
mad r1.y, r1.z, r1.x, r1.y
mul r1.x, r1.x, cb0[16].y
mad r1.x, r1.x, l(34.456177), r1.w
mul r1.xy, r1.xyxx, v1.yyyy
mul r1.xy, r1.xyxx, l(0.025000, 0.025000, 0.000000, 0.000000)
mad r1.z, v4.w, l(2.000000), l(-1.000000)
mad r3.xyz, v4.xyzx, l(2.001957, 2.001957, 2.001957, 0.000000), l(-1.00195694, -1.00195694, -1.00195694, 0.000000)
mul r8.xyz, r0.wyzw, r3.yzxy
mad r8.xyz, r0.zwyz, r3.zxyz, -r8.xyzx
mul r8.xyz, r1.zzzz, r8.xyzx
dp3 r1.w, r8.xyzx, r8.xyzx
rsq r1.w, r1.w
mul r8.xyz, r1.wwww, r8.xyzx
mul r8.xyz, r1.xxxx, r8.xyzx
mad r1.xyw, r1.yyyy, r3.xyxz, r8.xyxz
...
mul r1.xyw, r3.yzyx, r0.wywz
mad r1.xyw, r0.zwzy, r3.zxzy, -r1.xyxw
mul r1.xyz, r1.zzzz, r1.xywx
dp3 r8.x, r1.xyzx, r4.xyzx
dp3 r8.y, r1.xyzx, r6.xyzx
dp3 r8.z, r1.xyzx, r7.xyzx
dp3 r1.x, r8.xyzx, r8.xyzx
rsq r1.x, r1.x
mul r1.xyz, r1.xxxx, r8.xyzx
dp3 r1.w, -r5.xyzx, -r5.xyzx
rsq r1.w, r1.w
mul r5.xyz, r1.wwww, -r5.xyzx
dp3 r8.y, r5.xyzx, r1.xyzx
mov o5.xyz, r1.xyzx
dp3 r1.x, r0.yzwy, r4.xyzx
dp3 r4.x, r3.xyzx, r4.xyzx
dp3 r1.y, r0.yzwy, r6.xyzx
...
dp3 r1.x, r5.xyzx, r0.yzwy
mov o3.xyz, r0.yzwy
dp3 r0.y, r4.xyzx, r4.xyzx
rsq r0.y, r0.y
mul r0.yzw, r0.yyyy, r4.xxyz
dp3 r8.x, r5.xyzx, r0.yzwy
mov o4.xyz, r0.yzwy
div r0.yz, -r8.xxyx, r1.xxxx
