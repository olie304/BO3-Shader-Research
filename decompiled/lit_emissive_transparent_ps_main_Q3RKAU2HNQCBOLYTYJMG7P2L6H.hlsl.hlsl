...
r0.z = samp0[]..swiz;
  ...
  r2.y = r1.w * r2.w + r6.w;
  r8.xyz = r2.www * float3(0.0399999991,0.0399999991,0.0399999991) + r15.xyz;
  r0.x = saturate(r0.x);
  r0.x = hdrScale * r0.x;
  r11.xyz = cmp(r0.zzz == float3(3,2,1));
  r0.z = cmp(r0.z < 0);
  r12.xyz = r0.zzz ? float3(1,1,1) : emissiveTint1.xyz;
  ...
  r4.w = 100 * r4.w;
  r6.yz = -r2.ww * float2(10,5) + float2(6.85740995,7.08500004);
  r5.w = exp2(r6.y);
  r5.w = r5.w * r2.x;
  r5.w = 9.1368103 * r5.w;
  r6.y = r4.z * r2.w;
  ...
  if (r8.w != 0) {
    ...
    r10.w = 0;
    while (true) {
      r12.w = cmp((uint)r10.w >= (uint)r6.y);
      if (r12.w != 0) break;
      r14.z = (uint)r10.w >> 5;
      r15.xyz = (int3)r10.xyz + (int3)r14.xyz;
      r12.w = visibleProbes.Load(r15.xyzw).x;
      r14.z = cmp((int)r6.z == (int)r10.w);
  ...
  if (r4.w != 0) {
    ...
    r14.xyz = r21.xyz * r2.www + r11.yzw;
    r13.w = 0;
    r11.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r13.xyzw, r4.z).xyz;
    r2.w = sunConstants.globalProbeExposure * r4.w + -r5.w;
    r2.w = r2.y * r2.w + r5.w;
    r6.yzw = r11.yzw * r2.www + r6.yzw;
  }
  ...
  if (r5.w == 0) {
    ...
    if (r8.w != 0) {
      ...
      while (true) {
        ...
        if (r12.w != 0) break;
        r12.w = (uint)r8.w;
        r16.xy = -sunConstants.splitPinTransform[r12.w].xy + r11.yz;
    ...
    if (r12.w == 0) {
      ...
      if (enableDitheredShadow != 0) {
        ...
        r10.w = 28 * r10.w;
        r10.w = (uint)r10.w;
        r17.xy = -sunConstants.splitPinTransform[r11.w].xy + r11.yz;
        ...
        while (true) {
          ...
          if (r16.w != 0) break;
          r16.w = cmp((uint)r10.w < (uint)r13.w);
          r17.zw = r16.ww ? r11.yz : r17.xy;
          r18.x = r16.w ? sunConstants.splitPinTransform[r8.w].w : sunConstants.splitPinTransform[r11.w].w;
          r16.w = r16.w ? r8.w : r11.w;
  ...
  if (r5.w != 0) {
    ...
    if (r5.w != 0) {
      ...
      r19.w = samp0[]..swiz;
        ...
        r17.y = samp0[]..swiz;
          ...
          if (enableDitheredShadow != 0) {
            ...
            r16.z = (uint)r10.w;
            r11.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r8.w).x;
          }
          r8.w = r11.y * r11.y;
          r8.w = r8.w * r11.y;
        } else {
      ...
      r4.w = r7.w * r4.w;
      r4.w = 0.25 * r4.w;
      r11.yzw = r4.www * r9.xyz + r6.yzw;
      r0.z = saturate(1 + -r0.z);
      r5.w = r0.z * r0.z;
      r5.w = r5.w * r5.w;
      r0.z = r5.w * r0.z;
      r0.z = r4.w * r0.z;
      r9.xyz = r0.zzz * r9.yzx + r15.xyz;
      r16.w = r9.z;
      r14.w = r15.z;
      r14.xyzw = r4.zzzz ? r16.xyzw : r14.xyzw;
      r9.zw = r11.yz;
      r15.zw = r6.yz;
      r9.xyzw = r4.zzzz ? r9.xyzw : r15.xyzw;
      r6.w = r4.z ? r11.w : r6.w;
      r15.z = r14.w;
      r15.xy = r9.xy;
      r6.yz = r9.zw;
    }
              ...
              if (r21.w != 0) {
                ...
                if (r21.w != 0) {
                  ...
                  while (true) {
                    ...
                    if (r28.w != 0) break;
                    r44.y = dot(icb[r27.w+0].yx, r9.xy);
                    r44.z = dot(icb[r27.w+0].yx, r9.yz);
            ...
            r40.w = samp0[]..swiz;
              ...
              if (r15.w != 0) {
                  ...
                  r40.y = samp0[]..swiz;
                    ...
                    if (r7.w != 0) {
                      ...
                      while (true) {
                        ...
                        r25.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r32.xyz, r10.w).x;
                        r16.w = r25.w * 0.125 + r16.w;
                        r19.x = (int)r19.x + 1;
                      }
                    } else {
                      r22.z = (uint)r15.w;
                      r16.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r22.xyz, r10.w).x;
                    }
                    r10.w = r16.w * r16.w;
                    r10.w = r10.w * r16.w;
                  } else {
                ...
                if (r15.w != 0) {
                  ...
                  r16.z = r16.z + -r14.w;
                  r16.z = r2.z * r16.z + r14.w;
                  r16.z = r16.z * r10.w;
                  r13.w = cmp(0 < r13.w);
                  r23.xyz = r16.zzz * r21.xyw + r17.xyz;
                  r20.xyz = r20.xyz * r12.www + r12.xyz;
                  r12.w = dot(r20.xyz, r20.xyz);
                  r12.w = rsqrt(r12.w);
