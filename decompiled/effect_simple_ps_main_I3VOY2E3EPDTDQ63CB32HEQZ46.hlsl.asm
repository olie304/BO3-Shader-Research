...
//   uint zFeatherComputeSprites;       // Offset:  192 Size:     4
...
dp3 r1.z, r2.xyzx, v11.xyzx
sample_d_indexable(texture2d)(float,float,float,float) r3.xyz, r0.xyxx, t22.xyzw, s1, r0.zwzz, r1.xyxx
...
mul_sat r3.z, cb0[11].y, l(0.05882353)
dp3 r3.w, v11.xyzx, v11.xyzx
rsq r3.w, r3.w
mul r4.xyz, r3.wwww, v11.xyzx
dp3 r3.w, v12.xyzx, v12.xyzx
rsq r3.w, r3.w
mul r5.xyz, r3.wwww, v12.xyzx
dp3 r3.w, v13.xyzx, v13.xyzx
rsq r3.w, r3.w
mul r6.xyz, r3.wwww, v13.xyzx
...
utof r1.w, r1.w
mov r2.w, l(0)
sample_l_indexable(texturecubearray)(float,float,float,float) r2.xyz, r2.xyzw, t8.xyzw, s2, r1.w
...
mul r4.xyz, v14.xyzx, l(0.014000, 0.014000, 0.014000, 0.000000)
mul r3.xzw, r2.xxyz, r3.xxxx
mad r5.xyz, -v14.xyzx, l(0.014000, 0.014000, 0.014000, 0.000000), l(1.000000, 1.000000, 1.000000, 0.000000)
mul r2.xyz, r2.xyzx, r3.yyyy
mul r2.xyz, r4.xyzx, r2.xyzx
mad r2.xyz, r3.xzwx, r5.xyzx, r2.xyzx
add r1.w, r2.y, r2.x
add r1.w, r2.z, r1.w
mul r1.w, r1.w, l(0.33333334)
dp3 r2.x, v1.xyzx, l(0.299000, 0.587000, 0.114000, 0.000000)
max r2.x, r2.x, l(0.000100)
min r2.x, r2.x, cb1[85].x
div r2.x, r2.x, cb2[19].x
mul r1.w, r1.w, r2.x
sample_d_indexable(texture2d)(float,float,float,float) r0.xyzw, r0.xyxx, t21.xyzw, s1, r0.zwzz, r1.xyxx
dp3 r1.x, r0.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
add r2.xyz, -r0.xyzx, r1.xxxx
mad r2.xyz, cb0[12].yyyy, r2.xyzx, r0.xyzx
eq r3.xyzw, cb0[13].xyzw, l(0.000000, 1.000000, 0.000000, 1.000000)
and r1.x, r3.y, r3.x
and r1.x, r3.z, r1.x
and r1.x, r3.w, r1.x
max r1.y, r0.w, l(0.000100)
div_sat r3.xyz, r2.xyzx, r1.yyyy
...
ge r2.y, r1.x, l(0.984375)
mul r2.z, r1.x, l(1.01587307)
mad r1.x, r1.x, l(64.000000), l(-63.000000)
movc r1.x, r2.y, r1.x, r2.z
...
rcp r2.y, r2.y
add r2.z, cb0[14].y, -cb1[24].z
mul r2.z, r2.z, cb0[14].z
mul r2.w, v4.z, cb0[14].z
lt r3.x, r2.z, r2.w
mul r2.z, r2.z, r2.y
div r2.z, r2.z, r2.w
ne r2.w, v5.y, l(1.000000)
div r3.yzw, r0.xxyz, r1.yyyy
add r1.y, r0.w, v1.w
mad_sat r4.w, r1.y, v5.y, -v5.y
mul r4.xyz, r3.yzwy, r4.wwww
movc r0.xyzw, r2.wwww, r4.xyzw, r0.xyzw
movc r1.y, r2.w, l(1.000000), v1.w
lt r2.w, r2.y, r1.x
add r1.x, r1.x, -r2.y
mul_sat r1.x, r2.x, r1.x
movc r1.x, r2.w, r1.x, l(1.000000)
add r2.y, -r2.y, r2.z
mul r2.x, r2.x, r2.y
...
and r0.xyzw, r0.xyzw, r3.xxxx
mul r1.x, r0.w, r1.w
mad r1.xyz, r0.xyzx, v1.xyzx, r1.xxxx
...
if_z r2.x
  ftou r2.xy, v0.xyxx
  bfi r3.x, l(1), l(16), cb0[12].x, l(0)
  iadd r3.x, r3.x, l(1)
  ...
  if_nz r3.x
    ...
    bfi r3.y, l(1), l(0), cb0[12].x, r0.x
