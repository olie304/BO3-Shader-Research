...
rsq r1.y, r1.y
mul r11.xyz, r1.yyyy, -v7.xyzx
dp3 r1.w, r11.xyzx, r3.xyzx
dp3 r3.x, r11.xyzx, r4.xyzx
dp3 r3.y, r11.xyzx, r5.xyzx
...
dp3_sat r7.x, r2.xyzx, r11.xyzx
dp3 r1.w, -r11.xyzx, r2.xyzx
add r1.w, r1.w, r1.w
mad r13.xyz, r2.xyzx, -r1.wwww, -r11.xyzx
...
if_nz r5.z
  ...
  if_nz r5.z
    ...
    dp3 r1.y, r12.yzwy, r11.xyzx
    dp3 r6.w, r2.xyzx, r12.yzwy
    mad r8.w, |r6.w|, r1.w, -|r6.w|
    ...
    mad r12.yzw, r4.wwww, r9.xxyz, r7.yyzw
          ...
          if_nz r16.w
            ...
            if_nz r16.w
              ...
              if_nz r16.w
                ...
                mad r39.xyz, r39.xyzx, r10.wwww, r11.xyzx
                dp3 r10.w, r39.xyzx, r39.xyzx
                rsq r10.w, r10.w
                mul r39.xyz, r10.wwww, r39.xyzx
                dp3 r10.w, r39.xyzx, r11.xyzx
          ...
          if_nz r14.w
            ...
            if_nz r14.w
              ...
              if_nz r14.w
                ...
                mad r20.xyz, r20.xyzx, r10.wwww, r11.xyzx
                dp3 r10.w, r20.xyzx, r20.xyzx
                rsq r10.w, r10.w
                mul r20.xyz, r10.wwww, r20.xyzx
                dp3 r10.w, r20.xyzx, r11.xyzx
...
ret 
// Approximately 2288 instruction slots used
