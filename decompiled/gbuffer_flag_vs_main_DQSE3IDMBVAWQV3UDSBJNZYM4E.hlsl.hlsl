...
r8.w = gpuSkinBase[]..swiz;
  ...
  r0.y = rsqrt(r0.y);
  o5.xyz = r3.xyz * r0.yyy;
  r3.xyzw = viewProjectionMatrix._m10_m11_m12_m13 * r10.yyyy;
  r3.xyzw = r10.xxxx * viewProjectionMatrix._m00_m01_m02_m03 + r3.xyzw;
  r3.xyzw = r10.zzzz * viewProjectionMatrix._m20_m21_m22_m23 + r3.xyzw;
  ...
  r3.w = gpuSkinBase[]..swiz;
    ...
    if (r0.y != 0) {
      ...
      r2.xyw = -r7.xyz + r1.yzw;
      r1.x = dot(r5.xyzw, r5.xyzw);
      r1.x = rsqrt(r1.x);
      ...
      r7.w = r5.y * r6.y + r6.w;
      r9.x = 1 + -r7.w;
      r11.x = r5.z * r6.x + -r1.x;
      r9.y = r5.y * r6.x + -r6.z;
      r12.xy = r5.yx * r6.xx + r6.zw;
      r12.z = r5.z * r6.y + -r8.z;
      r5.xyz = r5.zwy * r6.yyy + r8.zyx;
      r9.z = r5.y;
      r6.x = dot(r2.xyw, r9.xyz);
      r12.w = 1 + -r12.y;
      r6.y = dot(r2.xwy, r12.xzw);
      r11.yz = r5.xz * float2(1,-1) + float2(0,1);
      r6.z = dot(r2.xyw, r11.xyz);
