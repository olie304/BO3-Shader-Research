  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.x = -postFxControlF.y + r0.x;
  r0.x = cmp(0 < r0.x);
  r0.y = postFxControl0.w / r0.y;
  r0.y = postFxControl0.x * r0.y;
  r0.y = postFxControl0.y / r0.y;
  r0.y = -1 + r0.y;
  r0.y = postFxControl0.z * r0.y;
  r0.y = postFxControl1.x * abs(r0.y);
  r0.y = min(15.5, r0.y);
  o0.w = r0.x ? 0 : r0.y;
  r0.xyz = codeTexture2.Sample(samp0_s, v1.xy).xyz;
  r0.xyz = r0.xyz * r0.xyz;
  o0.xyz = r0.xyz * float3(4,4,4) + float3(0.001953125,0.001953125,0.001953125);
  return;
}