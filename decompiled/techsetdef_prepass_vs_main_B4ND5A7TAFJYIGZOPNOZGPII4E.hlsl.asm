...
if_nz r0.w
  ...
  if_nz r1.x
    ...
    mul r2.z, r1.x, v2.x
    ne r1.x, v2.y, l(0.000000)
    if_nz r1.x
      iadd r1.x, r0.w, v3.y
      ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r4.xyzw, r1.x, l(0), t5.xyzw
      dp3 r1.y, r4.xyzx, v0.xyzx
      add r1.y, r4.w, r1.y
      mad r3.x, r1.y, v2.y, r3.x
      dp3 r1.y, r4.xyzx, r0.xyzx
      mad r2.x, r1.y, v2.y, r2.x
      ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r4.xyzw, r1.x, l(16), t5.xyzw
      dp3 r1.y, r4.xyzx, v0.xyzx
      add r1.y, r4.w, r1.y
      mad r3.y, r1.y, v2.y, r3.y
      dp3 r1.y, r4.xyzx, r0.xyzx
      mad r2.y, r1.y, v2.y, r2.y
      ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r1.xyzw, r1.x, l(32), t5.xyzw
      dp3 r2.w, r1.xyzx, v0.xyzx
      add r1.w, r1.w, r2.w
      mad r3.z, r1.w, v2.y, r3.z
      dp3 r1.x, r1.xyzx, r0.xyzx
      mad r2.z, r1.x, v2.y, r2.z
      ne r1.x, v2.z, l(0.000000)
      if_nz r1.x
        iadd r1.x, r0.w, v3.z
        ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r4.xyzw, r1.x, l(0), t5.xyzw
        dp3 r1.y, r4.xyzx, v0.xyzx
        add r1.y, r4.w, r1.y
        mad r3.x, r1.y, v2.z, r3.x
        dp3 r1.y, r4.xyzx, r0.xyzx
        mad r2.x, r1.y, v2.z, r2.x
        ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r4.xyzw, r1.x, l(16), t5.xyzw
        dp3 r1.y, r4.xyzx, v0.xyzx
        add r1.y, r4.w, r1.y
        mad r3.y, r1.y, v2.z, r3.y
        dp3 r1.y, r4.xyzx, r0.xyzx
        mad r2.y, r1.y, v2.z, r2.y
        ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r1.xyzw, r1.x, l(32), t5.xyzw
        dp3 r2.w, r1.xyzx, v0.xyzx
        add r1.w, r1.w, r2.w
        mad r3.z, r1.w, v2.z, r3.z
        dp3 r1.x, r1.xyzx, r0.xyzx
        mad r2.z, r1.x, v2.z, r2.z
        ne r1.x, v2.w, l(0.000000)
        if_nz r1.x
          iadd r1.x, r0.w, v3.w
          ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r4.xyzw, r1.x, l(0), t5.xyzw
          dp3 r1.y, r4.xyzx, v0.xyzx
          ...
          dp3 r1.y, r4.xyzx, r0.xyzx
          mad r2.x, r1.y, v2.w, r2.x
          ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r4.xyzw, r1.x, l(16), t5.xyzw
          dp3 r1.y, r4.xyzx, v0.xyzx
          add r1.y, r4.w, r1.y
          mad r3.y, r1.y, v2.w, r3.y
          dp3 r1.y, r4.xyzx, r0.xyzx
          mad r2.y, r1.y, v2.w, r2.y
          ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r1.xyzw, r1.x, l(32), t5.xyzw
          dp3 r2.w, r1.xyzx, v0.xyzx
          add r1.w, r1.w, r2.w
          mad r3.z, r1.w, v2.w, r3.z
          dp3 r1.x, r1.xyzx, r0.xyzx
          mad r2.z, r1.x, v2.w, r2.z
        endif 
      endif 
    endif 
  else 
...
dp3 o1.z, r0.xyzx, r1.yzwy
and r0.x, r1.x, l(0x0fffffff)
if_nz r0.x
  if_nz r0.x
    ne r0.y, v2.x, l(0.000000)
    if_nz r0.y
      iadd r0.y, r0.x, v3.x
      ...
      if_nz r0.y
        ...
        dp3 r0.z, r2.xyzx, v0.xyzx
        add r0.z, r2.w, r0.z
        mad r1.x, r0.z, v2.y, r1.x
        ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r2.xyzw, r0.y, l(16), t8.xyzw
        dp3 r0.z, r2.xyzx, v0.xyzx
        add r0.z, r2.w, r0.z
        mad r1.y, r0.z, v2.y, r1.y
        ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r2.xyzw, r0.y, l(32), t8.xyzw
        dp3 r0.y, r2.xyzx, v0.xyzx
        add r0.y, r2.w, r0.y
        mad r1.z, r0.y, v2.y, r1.z
        ...
        if_nz r0.y
          ...
          dp3 r0.z, r2.xyzx, v0.xyzx
          add r0.z, r2.w, r0.z
          mad r1.x, r0.z, v2.z, r1.x
          ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r2.xyzw, r0.y, l(16), t8.xyzw
          dp3 r0.z, r2.xyzx, v0.xyzx
          add r0.z, r2.w, r0.z
          mad r1.y, r0.z, v2.z, r1.y
          ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r2.xyzw, r0.y, l(32), t8.xyzw
          dp3 r0.y, r2.xyzx, v0.xyzx
          add r0.y, r2.w, r0.y
          mad r1.z, r0.y, v2.z, r1.z
          ...
          if_nz r0.y
            ...
            dp3 r0.z, r2.xyzx, v0.xyzx
            add r0.z, r2.w, r0.z
            mad r1.x, r0.z, v2.w, r1.x
            ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r2.xyzw, r0.y, l(16), t8.xyzw
            dp3 r0.z, r2.xyzx, v0.xyzx
            add r0.z, r2.w, r0.z
            mad r1.y, r0.z, v2.w, r1.y
            ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r2.xyzw, r0.y, l(32), t8.xyzw
            dp3 r0.y, r2.xyzx, v0.xyzx
            add r0.y, r2.w, r0.y
            mad r1.z, r0.y, v2.w, r1.z
          endif 
        endif 
      endif 
    else 
