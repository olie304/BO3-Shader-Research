...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r1.y = debugAlphaOverride.x + -r0.w;
  r2.w = debugAlphaOverride.w * r1.y + r0.w;
  ...
  r3.xyz = r1.xxx * r3.xyz + float3(0.0399999991,0.0399999991,0.0399999991);
  ...
  r4.yzw = r6.xyz * r1.yyy + r4.yzw;
  r4.xyz = r5.xyz * r4.xxx + r4.yzw;
  r1.y = dot(r4.xyz, r4.xyz);
  r1.y = rsqrt(r1.y);
  r4.xyz = r4.xyz * r1.yyy;
  r1.y = debugGlossOverride.x * r3.w + glossRange.x;
  ...
  r1.y = r1.y + -r0.w;
  r5.y = debugGlossOverride.w * r1.y + r0.w;
