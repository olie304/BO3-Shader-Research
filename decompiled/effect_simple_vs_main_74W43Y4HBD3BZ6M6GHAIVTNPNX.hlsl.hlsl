...
r3.x = outdoorOcclusionTree[]..swiz;
  ...
  r7.w = outdoorOcclusionTree[]..swiz;
    ...
    r7.z = outdoorOcclusionTree[]..swiz;
      ...
      r5.y = (int)r7.z | 0x40000000;
      bitmask.w = ((~(-1 << 1)) << 1) & 0xffffffff;  r3.w = (((uint)r3.w << 1) & bitmask.w) | ((uint)0 & ~bitmask.w);
      bitmask.x = ((~(-1 << 1)) << 0) & 0xffffffff;  r3.x = (((uint)r3.x << 0) & bitmask.x) | ((uint)r3.w & ~bitmask.x);
      r3.x = (int)r3.x * 10;
      r3.x = (uint)r5.y >> (uint)r3.x;
      r3.x = (int)r3.x & 1023;
    ...
    r8.y = outdoorOcclusionTree[]..swiz;
      r3.xw = r4.ww ? r7.xz : r8.xy;
      r5.xz = r0.yy ? r6.xw : r3.xw;
    }
    r0.y = (int)r5.z & 0xc0000000;
    if (r0.y == 0) {
      if (14 == 0) r3.x = 0; else if (14+15 < 32) {       r3.x = (uint)r5.z << (32-(14 + 15)); r3.x = (uint)r3.x >> (32-14);      } else r3.x = (uint)r5.z >> 15;
      r3.x = (uint)r3.x;
  ...
  r0.y = dot(r4.xyz, pinToWorldZ.xyz);
