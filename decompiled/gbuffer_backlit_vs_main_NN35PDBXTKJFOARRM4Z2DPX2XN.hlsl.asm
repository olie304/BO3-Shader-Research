...
mad r8.xyz, v3.xyzx, l(2.001957, 2.001957, 2.001957, 0.000000), l(-1.00195694, -1.00195694, -1.00195694, 0.000000)
mad r7.xyz, r8.xyzx, r1.wwww, v0.xyzx
dp4 r9.x, r7.xyzw, r3.xyzw
mov r5.w, r4.y
mov r6.w, r4.z
dp4 r9.y, r7.xyzw, r5.xyzw
dp4 r9.z, r7.xyzw, r6.xyzw
add r4.xyz, r9.xyzx, cb1[24].xyzx
mad r1.y, r1.y, l(0.900000), r4.x
mul r1.y, r1.y, l(0.700000)
sincos r1.y, null, r1.y
mad r1.w, r2.x, l(0.700000), r4.x
...
mul r2.x, r2.w, r2.x
mul r7.z, r2.z, r2.x
mul r2.xw, cb2[38].zzzw, cb2[38].yyyy
mul r1.yw, r1.yyyw, r2.xxxw
mul r7.xy, r2.zzzz, r1.ywyy
mul r7.xyz, r7.xyzx, l(0.110000, 0.130000, 0.090000, 0.000000)
mad r7.x, r1.x, l(0.010000), r7.x
...
mul r1.x, r2.y, r1.x
mov o1.xy, r2.yzyy
mad r7.y, r1.x, l(0.010000), r7.y
add r1.xyz, r4.xyzx, r7.xyzx
...
mul r2.xyz, r0.yzxy, r8.zxyz
mad r0.xyz, r8.yzxy, r0.zxyz, -r2.xyzx
...
mul r0.xyzw, r1.yyyy, cb7[1].xyzw
mad r0.xyzw, r1.xxxx, cb7[0].xyzw, r0.xyzw
mad r0.xyzw, r1.zzzz, cb7[2].xyzw, r0.xyzw
