...
r0.y = samp0[]..swiz;
  ...
  r0.y = (uint)r0.y >> 24;
  r13.z = cmp((uint)r0.y >= (uint)r12.w);
  r13.w = cmp((uint)r0.y < numRefProbes);
  r13.z = r13.w ? r13.z : 0;
  if (r13.z != 0) {
    r13.z = (int)r0.y * 14;
    if (r2.w != 0) {
      r18.yzw = refProbeConstantsCB[r13.z].data[0].xyz + eyeOffset.xyz;
      r18.x = 16;
      GBufferDiffuseColor[viewID].880 = u2.xyzw;
    }
    r15.yzw = -refProbeConstantsCB[r13.z].data[0].xyz + r5.xyz;
    r13.w = 0x0000ffff & (int)refProbeConstantsCB[r13.z].data[7].z;
    if (6 == 0) r14.w = 0; else if (6+25 < 32) {     r14.w = (uint)refProbeConstantsCB[r13.z].data[7].z << (32-(6 + 25)); r14.w = (uint)r14.w >> (32-6);    } else r14.w = (uint)refProbeConstantsCB[r13.z].data[7].z >> 25;
    r16.y = (int)r13.w * 6;
    ...
    r18.x = r16.z * r16.y;
    r16.y = 1 & (int)refProbeConstantsCB[r13.z].data[6].x;
    r18.yz = float2(0,1);
    r16.yz = r16.yy ? r18.xy : r18.zx;
    r18.x = 1;
    r16.w = refProbeConstantsCB[r13.z].data[6].x;
    r19.xy = r16.yz;
    r18.z = 1;
    while (true) {
      ...
      r19.x = r19.z * r18.w;
      r19.w = (uint)r16.w >> 2;
      if (1 == 0) r20.x = 0; else if (1+2 < 32) {       r20.x = (uint)r16.w << (32-(1 + 2)); r20.x = (uint)r20.x >> (32-1);      } else r20.x = (uint)r16.w >> 2;
      r20.y = (int)r19.w & 2;
    ...
    r13.w = refProbeConstantsCB[r13.z].data[6].y * r19.y;
    r14.w = cmp(0 < r13.w);
    if (r14.w != 0) {
      if (r2.w != 0) {
      // Known bad code for instruction (needs manual fix):
      ...
      r14.w = refProbeConstantsCB[r13.z].data[7].y * r13.w;
      r18.x = refProbeConstantsCB[r13.z].data[7].w;
      r18.yz = refProbeConstantsCB[r13.z].data[8].xy;
      ...
      r18.x = refProbeConstantsCB[r13.z].data[8].w;
      r18.yz = refProbeConstantsCB[r13.z].data[9].xy;
      ...
      r18.x = refProbeConstantsCB[r13.z].data[9].w;
      r18.yz = refProbeConstantsCB[r13.z].data[10].xy;
      r16.z = dot(r17.xyz, r18.xyz);
      r16.w = dot(r15.yzw, r18.xyz);
      ...
      r16.z = r16.w / r16.z;
      r16.y = min(r16.y, abs(r16.z));
      r18.x = refProbeConstantsCB[r13.z].data[10].w;
      r18.yz = refProbeConstantsCB[r13.z].data[11].xy;
      r16.z = dot(r17.xyz, r18.xyz);
      r16.w = dot(r15.yzw, r18.xyz);
      ...
      r16.z = r16.w / r16.z;
      r16.y = min(r16.y, abs(r16.z));
      r18.x = refProbeConstantsCB[r13.z].data[11].w;
      r18.yz = refProbeConstantsCB[r13.z].data[12].xy;
      r16.z = dot(r17.xyz, r18.xyz);
      r16.w = dot(r15.yzw, r18.xyz);
      ...
      r16.z = r16.w / r16.z;
      r16.y = min(r16.y, abs(r16.z));
      r18.x = refProbeConstantsCB[r13.z].data[12].w;
      r18.yz = refProbeConstantsCB[r13.z].data[13].xy;
      r16.z = dot(r17.xyz, r18.xyz);
      r16.w = dot(r15.yzw, r18.xyz);
      ...
      r16.z = r16.w / r16.z;
      r16.y = min(r16.y, abs(r16.z));
      r18.x = refProbeConstantsCB[r13.z].data[3].w + r15.y;
      r18.yz = refProbeConstantsCB[r13.z].data[4].xy + r15.zw;
      r18.xyz = r17.xyz * r16.yyy + r18.xyz;
      ...
      r19.x = refProbeConstantsCB[r13.z].data[0].w;
      r19.y = refProbeConstantsCB[r13.z].data[1].z;
      r19.z = refProbeConstantsCB[r13.z].data[2].y;
      r20.x = dot(r18.xyz, r19.xyz);
      r21.xy = refProbeConstantsCB[r13.z].data[1].xw;
      r21.z = refProbeConstantsCB[r13.z].data[2].z;
      r20.y = dot(r18.xyz, r21.xyz);
      r22.x = refProbeConstantsCB[r13.z].data[1].y;
      r22.yz = refProbeConstantsCB[r13.z].data[2].xw;
      ...
      r20.w = (uint)r16.z;
      r16.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r20.xyzw, r16.y).xyz;
      ...
      r16.yzw = r18.xxx ? float3(1,1,0) : r16.yzw;
      r18.x = dot(r15.yzw, r19.xyz);
      r18.y = dot(r15.yzw, r21.xyz);
      r18.z = dot(r15.yzw, r22.xyz);
      r15.yzw = saturate(r18.xyz * refProbeConstantsCB[r13.z].data[3].xyz + float3(0.5,0.5,0.5));
      r18.xy = refProbeConstantsCB[r13.z].data[4].zw * r15.yz;
      r18.z = refProbeConstantsCB[r13.z].data[5].x * r15.w;
      r15.yzw = refProbeConstantsCB[r13.z].data[5].yzw + r18.xyz;
      ...
      r18.x = r13.z * r10.w;
      r16.yzw = r16.yzw * r14.www;
      r14.w = dot(r16.yzw, float3(0.212599993,0.715200007,0.0722000003));
      r13.z = r10.w * r13.z + r14.w;
      r13.z = r18.x / r13.z;
      ...
      r13.zw = float2(1.40129846e-45,0);
    }
  } else {
    r15.yzw = float3(0,0,0);
    r16.yzw = float3(0,0,0);
  ...
  r12.w = cmp((uint)r0.y < (uint)r12.w);
  if (r12.w != 0) {
    r0.y = (int)r0.y * 14;
    if (r2.w != 0) {
      r12.w = (int)r13.z & 1;
    ...
    r14.w = saturate(r21.y + -r13.w);
    r18.w = refProbeConstantsCB[r0.y].data[6].y * r14.w;
    r19.x = cmp(0 < r18.w);
    if (r19.x != 0) {
      r19.x = (int)r12.w & 3;
      r19.y = (int)r19.x + -1;
      ...
      r12.w = (int)r13.z + 257;
      r14.w = r14.w * refProbeConstantsCB[r0.y].data[6].y + r13.w;
      ...
      r19.w = cmp(r19.z >= 0);
      r9.w = max(abs(r19.z), r9.w);
      r9.w = r19.w ? r9.w : -r9.w;
      r19.y = max(1.00000001e-07, -r19.y);
      r9.w = r9.w / r19.y;
      r9.w = min(r19.x, abs(r9.w));
      ...
      r19.xyz = r6.www ? float3(1,1,0) : r19.xyz;
  ...
  r0.y = cmp(r13.w >= 1);
  bitmask.w = ((~(-1 << 8)) << 0) & 0xffffffff;  r6.w = (((uint)r12.w << 0) & bitmask.w) | ((uint)r13.z & ~bitmask.w);
  r0.y = r0.y ? r6.w : r12.w;
  r6.w = max(1, r14.w);
  r6.w = rcp(r6.w);
  r14.w = saturate(r14.w);
  r18.xyz = r15.yzw * r6.www;
  r16.yzw = r16.yzw * r6.www;
  r9.w = cmp(r14.w < 0.99000001);
  if (r9.w != 0) {
    r0.y = (int)r0.y + 256;
    r9.w = 1 + -r14.w;
    ...
    r10.w = dot(r19.xyz, float3(0.212599993,0.715200007,0.0722000003));
    r18.xyz = r15.yzw * r6.www + r19.xyz;
    r17.w = 0;
    r15.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r17.xyzw, r8.w).xyz;
    r6.w = sunConstants.globalProbeExposure * r9.w + -r10.w;
    r6.w = r2.y * r6.w + r10.w;
    r16.yzw = r15.yzw * r6.www + r16.yzw;
  }
  r6.w = r2.x + r4.z;
  r6.w = log2(abs(r6.w));
  r6.w = r6.w * r2.z;
  ...
  if (r8.w != 0) {
    ...
    if (r8.w != 0) {
        ...
        if (r10.w == 0) {
          ...
          if (enableDitheredShadow != 0) {
            ...
            while (true) {
              ...
              if (r13.w != 0) break;
              r25.x = dot(icb[r13.z+0].yx, r23.xy);
              r25.y = dot(icb[r13.z+0].yx, r23.yz);
              r24.xy = r25.xy * lightConstantsCB[r9.w].data[3].yy + r22.xy;
              r13.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r24.xyz, r10.w).x;
              r12.w = r13.w * 0.125 + r12.w;
              r13.z = (int)r13.z + 1;
            }
          } else {
            r22.z = (uint)r11.w;
            r12.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r22.xyz, r10.w).x;
          }
          r9.w = r12.w * r12.w;
          r9.w = r9.w * r12.w;
        } else {
      ...
      r3.y = cmp(0 < r3.y);
      r18.xyz = r18.xyz * r4.zzz + r22.xyz;
      r22.xyz = -r5.xyz * r1.zzz + sunConstants.wldDir.xyz;
      r1.z = dot(r22.xyz, r22.xyz);
      r1.z = rsqrt(r1.z);
      r22.xyz = r22.xyz * r1.zzz;
      r1.z = dot(r22.xyz, r12.xyz);
      r4.z = dot(r11.xyz, r22.xyz);
      ...
      r3.z = r7.w * r3.z;
      r3.z = 0.25 * r3.z;
      r22.yzw = r3.zzz * r15.yzw + r21.xyz;
      r1.z = saturate(1 + -r1.z);
      r4.z = r1.z * r1.z;
      r4.z = r4.z * r4.z;
      r1.z = r4.z * r1.z;
      r1.z = r3.z * r1.z;
      r23.xyz = r1.zzz * r15.yzw + r16.yzw;
      r15.yzw = r3.www * r15.yzw + r20.zxy;
      r24.xyz = r0.www ? r15.zwy : 0;
      r18.w = r20.z;
      r19.w = r24.z;
  ...
  r3.y = (uint)renderTargetSize.x;
  r3.y = (int)r3.y + 7;
  r3.y = (uint)r3.y >> 3;
  r3.y = mad((int)r0.z, (int)r3.y, (int)r0.x);
  r3.y = (uint)r3.y << 5;
  r3.z = ~(int)r3.x;
  r18.x = -r13.x;
  r2.x = -r2.x * 0.5 + 1;
    ...
    while (true) {
      ...
      if (r13.w != 0) {
        ...
        if (r17.w != 0) {
          ...
          r22.yzw = lightConstantsCB[r12.w].data[0].xyz + eyeOffset.xyz;
          GBufferDiffuseColor[viewID].r14.w = u2.xyzw;
        }
        r14.w = (int)r10.w + 1;
        r40.xy = lightConstantsCB[r12.w].data[3].zw + -r5.xy;
        r40.z = lightConstantsCB[r12.w].data[4].x + -r5.z;
        r17.w = dot(r40.xyz, r40.xyz);
        r17.w = rsqrt(r17.w);
        r22.yzw = r40.xyz * r17.www;
        r19.w = lightConstantsCB[r12.w].data[1].z * r1.w;
        r19.w = 0.25 * r19.w;
        r20.w = dot(r11.xyz, r22.yzw);
        r21.w = saturate(r20.w);
        r22.y = r0.w ? abs(r20.w) : r21.w;
        r22.z = cmp(0 < r22.y);
        if (r22.z != 0) {
          r41.xyz = lightConstantsCB[r12.w].data[7].yzw;
          r41.w = lightConstantsCB[r12.w].data[8].x;
          r22.z = dot(r41.xyzw, r5.xyzw);
          r22.w = cmp(r22.z < 1);
          if (r22.w != 0) {
            r42.xyz = float3(1,1,1);
            r22.w = 0;
          } else {
            r43.xyz = lightConstantsCB[r12.w].data[0].xyz + -r5.xyz;
            r24.w = lightConstantsCB[r12.w].data[3].x * lightConstantsCB[r12.w].data[3].x;
            r29.w = dot(r43.xyz, r43.xyz);
            r24.w = r24.w / r29.w;
            r24.w = min(1, r24.w);
            r43.xy = saturate(r22.zz * lightConstantsCB[r12.w].data[2].xz + lightConstantsCB[r12.w].data[2].yw);
            r43.zw = r43.xy * r43.xy;
            r43.xy = r43.xy * float2(-2,-2) + float2(3,3);
            r43.xy = r43.zw * r43.xy;
            r24.w = r43.x * r24.w;
            r24.w = r24.w * r43.y;
            r43.xyz = lightConstantsCB[r12.w].data[4].yzw;
            r43.w = lightConstantsCB[r12.w].data[5].x;
            r43.x = dot(r43.xyzw, r5.xyzw);
            r44.xyz = lightConstantsCB[r12.w].data[5].yzw;
            r44.w = lightConstantsCB[r12.w].data[6].x;
            r43.y = dot(r44.xyzw, r5.xyzw);
            r24.xy = r43.xy / r22.zz;
            r22.z = cmp(lightConstantsCB[r12.w].data[10].w < 0.00048828125);
            if (r22.z != 0) {
              r43.xy = saturate(abs(r24.xy) * lightConstantsCB[r12.w].data[12].xy + lightConstantsCB[r12.w].data[12].zw);
              r43.zw = r43.xy * r43.xy;
              r43.xy = r43.xy * float2(-2,-2) + float2(3,3);
              r43.xy = r43.zw * r43.xy;
              r22.z = r43.x * r43.y;
            } else {
              r43.xyzw = saturate(lightConstantsCB[r12.w].data[11].xyzw * abs(r24.yyxx));
              r43.xyzw = log2(r43.xyzw);
              r43.xyzw = lightConstantsCB[r12.w].data[12].zzzz * r43.xyzw;
              r43.xyzw = exp2(r43.xyzw);
              r43.xy = r43.xy + r43.zw;
              r43.xy = log2(r43.xy);
              r43.xy = lightConstantsCB[r12.w].data[12].ww * r43.xy;
              r43.xy = exp2(r43.xy);
              r29.w = lightConstantsCB[r12.w].data[12].x * r43.x;
              r31.w = lightConstantsCB[r12.w].data[12].y * r43.y + -1;
              r29.w = lightConstantsCB[r12.w].data[12].y * r43.y + -r29.w;
              r29.w = saturate(r31.w / r29.w);
              r31.w = r29.w * r29.w;
              r29.w = r29.w * -2 + 3;
              r22.z = r31.w * r29.w;
            }
            r22.w = r24.w * r22.z;
            r22.z = 255 & (int)lightConstantsCB[r12.w].data[14].w;
            if (r22.z != 0) {
              r24.w = dot(lightConstantsCB[r12.w].data[13].xyz, r24.xyz);
              r43.x = lightConstantsCB[r12.w].data[13].w;
              r43.yz = lightConstantsCB[r12.w].data[14].xy;
          ...
          r43.x = lightConstantsCB[r12.w].data[0].w;
          r43.yz = lightConstantsCB[r12.w].data[1].xy;
          ...
          if (r22.z != 0) {
            ...
            r29.w = r29.w ? r2.w : 0;
            if (r29.w != 0) {
              r42.xy = mad((int2)r22.zz, int2(24,24), int2(88,104));
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r22.z, cb2[52].x, r42.x, u2.xxxx
            r22.z = samp0[]..swiz;
              r22.z = (int)r22.z | 4;
              GBufferDiffuseColor[viewID].r42.x = u2.x;
              GBufferDiffuseColor[viewID].r42.y = u2.x;
            }
            r22.z = (int)r10.w + 257;
            r13.w = cmp((int)r13.w != 1);
            if (r13.w != 0) {
              r13.w = abs(r20.w) * -0.200000003 + 0.400000006;
              r29.w = cmp(r20.w < 0);
              r29.w = r0.w ? r29.w : 0;
              r13.w = r29.w ? -r13.w : r13.w;
              r25.xyz = r11.xyz * r13.www + r5.xyz;
              r42.xyz = lightConstantsCB[r12.w].data[6].yzw;
              r42.w = lightConstantsCB[r12.w].data[7].x;
              r13.w = dot(r42.xyzw, r25.xyzw);
              r29.w = dot(r41.xyzw, r25.xyzw);
              r31.w = cmp(r29.w >= r13.w);
              if (r31.w != 0) {
                r41.xyz = lightConstantsCB[r12.w].data[4].yzw;
                r41.w = lightConstantsCB[r12.w].data[5].x;
                r41.x = dot(r41.xyzw, r25.xyzw);
                r42.xyz = lightConstantsCB[r12.w].data[5].yzw;
                r42.w = lightConstantsCB[r12.w].data[6].x;
                r41.y = dot(r42.xyzw, r25.xyzw);
                r25.xy = r41.xy / r29.ww;
                r25.xy = saturate(r25.xy * float2(0.5,-0.5) + float2(0.5,0.5));
                r41.x = r25.x * lightConstantsCB[r12.w].data[8].y + lightConstantsCB[r12.w].data[8].z;
                r41.y = r25.y * lightConstantsCB[r12.w].data[8].w + lightConstantsCB[r12.w].data[9].x;
                r13.w = r13.w / r29.w;
                r13.w = max(6.10351563e-05, r13.w);
                r25.x = 0x0000ffff & (int)lightConstantsCB[r12.w].data[1].w;
                if (r9.w != 0) {
                  r42.z = (uint)r25.x;
                  r25.yz = float2(0,0);
                  while (true) {
                    ...
                    if (r29.w != 0) break;
                    r43.x = dot(icb[r25.z+0].yx, r18.xy);
                    r43.y = dot(icb[r25.z+0].yx, r18.yz);
                    r42.xy = r43.xy * lightConstantsCB[r12.w].data[3].yy + r41.xy;
                    r29.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r42.xyz, r13.w).x;
                    r25.y = r29.w * 0.125 + r25.y;
                    r25.z = (int)r25.z + 1;
                  }
                } else {
                  r41.z = (uint)r25.x;
                  r25.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r41.xyz, r13.w).x;
                }
                r13.w = r25.y * r25.y;
                r13.w = r13.w * r25.y;
              } else {
            ...
            r22.w = cmp(0 < r13.w);
            if (r22.w != 0) {
              if (4 == 0) r22.w = 0; else if (4+16 < 32) {               r22.w = (uint)lightConstantsCB[r12.w].data[1].w << (32-(4 + 16)); r22.w = (uint)r22.w >> (32-4);              } else r22.w = (uint)lightConstantsCB[r12.w].data[1].w >> 16;
              r25.x = cmp(0 < (uint)r22.w);
              r25.x = r25.x ? r3.x : 0;
              if (r25.x != 0) {
                r22.w = (int)r22.w + numLights;
                r22.w = mad((int)r22.w, 15, -15);
                r25.x = abs(r20.w) * -0.200000003 + 0.400000006;
                r25.z = cmp(r20.w < 0);
                r25.z = r0.w ? r25.z : 0;
                r25.x = r25.z ? -r25.x : r25.x;
                r26.xyz = r11.xyz * r25.xxx + r5.xyz;
                r41.xyz = lightConstantsCB[r22.w].data[6].yzw;
                r41.w = lightConstantsCB[r22.w].data[7].x;
                r25.x = dot(r41.xyzw, r26.xyzw);
                r41.xyz = lightConstantsCB[r22.w].data[7].yzw;
                r41.w = lightConstantsCB[r22.w].data[8].x;
                r25.z = dot(r41.xyzw, r26.xyzw);
                r29.w = cmp(r25.z < r25.x);
                if (r29.w == 0) {
                  r41.xyz = lightConstantsCB[r22.w].data[4].yzw;
                  r41.w = lightConstantsCB[r22.w].data[5].x;
                  r41.x = dot(r41.xyzw, r26.xyzw);
                  r42.xyz = lightConstantsCB[r22.w].data[5].yzw;
                  r42.w = lightConstantsCB[r22.w].data[6].x;
                  r41.y = dot(r42.xyzw, r26.xyzw);
                  r26.xy = r41.xy / r25.zz;
                  r26.xy = r26.xy * float2(0.5,-0.5) + float2(0.5,0.5);
                  r41.x = lightConstantsCB[r22.w].data[9].w + r26.x;
                  r41.y = lightConstantsCB[r22.w].data[10].x + r26.y;
                  r26.xy = lightConstantsCB[r22.w].data[9].yz * r41.xy;
                  r41.xy = lightConstantsCB[r22.w].data[3].yy / lightConstantsCB[r22.w].data[8].yw;
                  r41.zw = float2(1,1) + -r41.xy;
                  r41.zw = cmp(r26.xy >= r41.zw);
                  r41.xy = cmp(r41.xy >= r26.xy);
                  r41.xy = (int2)r41.xy | (int2)r41.zw;
                  r26.z = (int)r41.y | (int)r41.x;
                  if (r26.z == 0) {
                    r26.xy = saturate(r26.xy);
                    r41.x = r26.x * lightConstantsCB[r22.w].data[8].y + lightConstantsCB[r22.w].data[8].z;
                    r41.y = r26.y * lightConstantsCB[r22.w].data[8].w + lightConstantsCB[r22.w].data[9].x;
                    r26.x = lightConstantsCB[r22.w].data[10].z * r25.z;
                    r25.x = lightConstantsCB[r22.w].data[10].y * r25.z + r25.x;
                    r25.x = r25.x / r26.x;
                  }
                } else {
                  r26.z = -1;
                }
                r25.z = (int)r29.w | (int)r26.z;
                if (r25.z == 0) {
                  r25.x = max(6.10351563e-05, r25.x);
                  r25.z = 0x0000ffff & (int)lightConstantsCB[r22.w].data[1].w;
                  if (r9.w != 0) {
                    r26.z = (uint)r25.z;
                    r29.w = 0;
                    r31.w = 0;
                    while (true) {
                      ...
                      if (r32.w != 0) break;
                      r42.x = dot(icb[r31.w+0].yx, r18.xw);
                      r42.y = dot(icb[r31.w+0].xy, r13.xy);
                      r26.xy = r42.xy * lightConstantsCB[r22.w].data[3].yy + r41.xy;
                      r26.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r26.xyz, r25.x).x;
                      r29.w = r26.x * 0.125 + r29.w;
                      r31.w = (int)r31.w + 1;
                    }
                  } else {
                    r41.z = (uint)r25.z;
                    r29.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r41.xyz, r25.x).x;
                  }
                  r22.w = r29.w * r29.w;
                  r22.w = r22.w * r29.w;
                } else {
                ...
                if (4 == 0) r22.w = 0; else if (4+20 < 32) {                 r22.w = (uint)lightConstantsCB[r12.w].data[1].w << (32-(4 + 20)); r22.w = (uint)r22.w >> (32-4);                } else r22.w = (uint)lightConstantsCB[r12.w].data[1].w >> 20;
                r25.x = cmp(0 < (uint)r22.w);
                r25.x = r25.x ? r3.z : 0;
                if (r25.x != 0) {
                  r22.w = (int)r22.w + numLights;
                  ...
                  r25.z = r0.w ? r25.z : 0;
                  r25.x = r25.z ? -r25.x : r25.x;
                  r27.xyz = r11.xyz * r25.xxx + r5.xyz;
                  r41.xyz = lightConstantsCB[r22.w].data[6].yzw;
                  r41.w = lightConstantsCB[r22.w].data[7].x;
                  r25.x = dot(r41.xyzw, r27.xyzw);
                  r41.xyz = lightConstantsCB[r22.w].data[7].yzw;
                  r41.w = lightConstantsCB[r22.w].data[8].x;
                  r25.z = dot(r41.xyzw, r27.xyzw);
                  r26.x = cmp(r25.z < r25.x);
                  if (r26.x == 0) {
                    r41.xyz = lightConstantsCB[r22.w].data[4].yzw;
                    r41.w = lightConstantsCB[r22.w].data[5].x;
                    r41.x = dot(r41.xyzw, r27.xyzw);
                    r42.xyz = lightConstantsCB[r22.w].data[5].yzw;
                    r42.w = lightConstantsCB[r22.w].data[6].x;
                    r41.y = dot(r42.xyzw, r27.xyzw);
                    r26.yz = r41.xy / r25.zz;
                    r26.yz = r26.yz * float2(0.5,-0.5) + float2(0.5,0.5);
                    r27.x = lightConstantsCB[r22.w].data[9].w + r26.y;
                    r27.y = lightConstantsCB[r22.w].data[10].x + r26.z;
                    r26.yz = lightConstantsCB[r22.w].data[9].yz * r27.xy;
                    r27.xy = lightConstantsCB[r22.w].data[3].yy / lightConstantsCB[r22.w].data[8].yw;
                    r41.xy = float2(1,1) + -r27.xy;
                    r41.xy = cmp(r26.yz >= r41.xy);
                    r27.xy = cmp(r27.xy >= r26.yz);
                    r27.xy = (int2)r27.xy | (int2)r41.xy;
                    r27.x = (int)r27.y | (int)r27.x;
                    if (r27.x == 0) {
                      r26.yz = saturate(r26.yz);
                      r41.x = r26.y * lightConstantsCB[r22.w].data[8].y + lightConstantsCB[r22.w].data[8].z;
                      r41.y = r26.z * lightConstantsCB[r22.w].data[8].w + lightConstantsCB[r22.w].data[9].x;
                      r26.y = lightConstantsCB[r22.w].data[10].z * r25.z;
                      r25.x = lightConstantsCB[r22.w].data[10].y * r25.z + r25.x;
                      r25.x = r25.x / r26.y;
                    }
                  } else {
                  ...
                  if (r25.z == 0) {
                    ...
                    if (r9.w != 0) {
                      ...
                      r41.z = (uint)r25.z;
                      r27.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r41.xyz, r25.x).x;
                    }
                    r22.w = r27.x * r27.x;
                    r22.w = r22.w * r27.x;
                  } else {
              ...
              r22.w = r22.w + -r22.y;
              r22.y = r2.z * r22.w + r22.y;
              r22.y = r22.y * r13.w;
              r20.w = cmp(0 < r20.w);
              r26.xyz = r22.yyy * r24.xyw + r36.xyz;
              r40.xyz = r40.xyz * r17.www + r12.xyz;
              r17.w = dot(r40.xyz, r40.xyz);
              r17.w = rsqrt(r17.w);
              r40.xyz = r40.xyz * r17.www;
              r17.w = dot(r40.xyz, r12.xyz);
              r22.w = dot(r11.xyz, r40.xyz);
              r25.x = abs(r22.w) * r1.w + -abs(r22.w);
              r22.w = abs(r22.w) * r25.x + 1;
              r25.x = r21.w * r2.y + r6.w;
              r22.w = r22.w * r22.w;
              r22.w = r22.w * r25.x;
              r22.w = rcp(r22.w);
              r19.w = r21.w * r19.w;
              r19.w = r22.w * r19.w;
              r19.w = r19.w * r13.w;
              r40.xyz = r19.www * r24.xyw + r39.xyz;
              r17.w = saturate(1 + -r17.w);
              r21.w = r17.w * r17.w;
              r21.w = r21.w * r21.w;
              r17.w = r21.w * r17.w;
              r17.w = r19.w * r17.w;
              r41.xyz = r17.www * r24.xyw + r38.xyz;
              r24.xyw = r22.yyy * r24.xyw + r37.xyz;
              r24.xyw = r0.www ? r24.xyw : r37.xyz;
              r36.xyz = r20.www ? r26.xyz : r36.xyz;
              r37.xyz = r20.www ? r37.xyz : r24.xyw;
              r38.xyz = r20.www ? r41.xyz : r38.xyz;
              r39.xyz = r20.www ? r40.xyz : r39.xyz;
              r17.w = (int)r22.z & 255;
              r19.w = (int)r17.w + -1;
              r19.w = cmp((uint)r19.w < 32);
              r19.w = r19.w ? r2.w : 0;
              if (r19.w != 0) {
                r22.yw = mad((int2)r17.ww, int2(24,24), int2(88,108));
              // Known bad code for instruction (needs manual fix):
        ...
        if (r13.z != 0) {
          ...
          if (r14.w != 0) {
            ...
            r23.yzw = lightConstantsCB[r12.w].data[0].xyz + eyeOffset.xyz;
            GBufferDiffuseColor[viewID].r13.w = u2.xyzw;
          }
          r13.w = (int)r10.w + 1;
          r14.w = lightConstantsCB[r12.w].data[1].z * r1.w;
          r14.w = 0.25 * r14.w;
          r17.w = cmp(0 < lightConstantsCB[r12.w].data[6].y);
          r26.xy = lightConstantsCB[r12.w].data[5].zw;
          r26.z = lightConstantsCB[r12.w].data[6].x;
          r22.yzw = -r26.xyz * float3(0.5,0.5,0.5) + lightConstantsCB[r12.w].data[0].xyz;
          r23.yzw = r22.yzw + -r5.xyz;
          r19.w = dot(r26.xyz, r17.xyz);
          r20.w = dot(r26.xyz, r23.yzw);
          r21.w = dot(r17.xyz, r23.yzw);
          r23.y = -r19.w * r19.w + lightConstantsCB[r12.w].data[6].y;
          r19.w = r19.w * r21.w + -r20.w;
          r20.w = saturate(-r20.w / lightConstantsCB[r12.w].data[6].y);
          r19.w = saturate(r19.w / r23.y);
          r21.w = r23.y / lightConstantsCB[r12.w].data[6].y;
          r21.w = 10 * r21.w;
          r21.w = min(1, r21.w);
          r19.w = r19.w + -r20.w;
          r19.w = r21.w * r19.w + r20.w;
          r23.yzw = r19.www * r26.xyz + r22.yzw;
          r22.yzw = r20.www * r26.xyz + r22.yzw;
          r22.yzw = r17.www ? r22.yzw : lightConstantsCB[r12.w].data[0].xyz;
          r23.yzw = r17.www ? r23.yzw : lightConstantsCB[r12.w].data[0].xyz;
          r23.yzw = r23.yzw + -r5.xyz;
          r22.yzw = r22.yzw + -r5.xyz;
          r17.w = dot(r23.yzw, r23.yzw);
          r17.w = rsqrt(r17.w);
          r24.xyw = r23.yzw * r17.www;
          r19.w = dot(r22.yzw, r22.yzw);
          r20.w = rsqrt(r19.w);
          r22.yzw = r22.yzw * r20.www;
          r20.w = dot(r11.xyz, r22.yzw);
          r21.w = saturate(r20.w);
          r21.w = r0.w ? abs(r20.w) : r21.w;
          r22.y = cmp(0 < r21.w);
          if (r22.y != 0) {
            r22.y = sqrt(r19.w);
            r22.z = lightConstantsCB[r12.w].data[3].x * lightConstantsCB[r12.w].data[3].x;
            r19.w = r22.z / r19.w;
            r19.w = min(1, r19.w);
            r22.yz = saturate(r22.yy * lightConstantsCB[r12.w].data[2].xz + lightConstantsCB[r12.w].data[2].yw);
            r25.xz = r22.yz * r22.yz;
            r22.yz = r22.yz * float2(-2,-2) + float2(3,3);
            r22.yz = r25.xz * r22.yz;
            r19.w = r22.y * r19.w;
            r19.w = r19.w * r22.z;
            r22.y = cmp(0 < r19.w);
            if (r22.y != 0) {
              r22.y = (int)r13.w & 255;
              r22.z = (int)r22.y + -1;
              r22.z = cmp((uint)r22.z < 32);
              r22.z = r22.z ? r2.w : 0;
              if (r22.z != 0) {
                r22.yz = mad((int2)r22.yy, int2(24,24), int2(88,104));
              // Known bad code for instruction (needs manual fix):
              ...
              if (r13.z != 0) {
                r13.z = abs(r20.w) * -0.200000003 + 0.400000006;
                r22.z = cmp(r20.w < 0);
                r22.z = r0.w ? r22.z : 0;
                r13.z = r22.z ? -r13.z : r13.z;
                r26.xyz = r11.xyz * r13.zzz + r5.xyz;
                r26.xyz = -lightConstantsCB[r12.w].data[4].yzw + r26.xyz;
                r13.z = max(abs(r26.y), abs(r26.z));
                r13.z = max(abs(r26.x), r13.z);
                r13.z = lightConstantsCB[r12.w].data[5].x / r13.z;
                r13.z = lightConstantsCB[r12.w].data[5].y + r13.z;
                r22.z = dot(r26.xyz, r26.xyz);
                r22.z = rsqrt(r22.z);
                r13.z = max(6.10351563e-05, r13.z);
                r22.w = 0x0000ffff & (int)lightConstantsCB[r12.w].data[1].w;
                r40.w = (uint)r22.w;
                r22.w = 0;
                r25.x = 0;
                while (true) {
                  r25.z = cmp((int)r25.x >= 8);
                  if (r25.z != 0) break;
                  r27.y = dot(icb[r25.x+0].xy, r14.xy);
                  r27.z = dot(icb[r25.x+0].yx, r14.xz);
                  r41.yz = lightConstantsCB[r12.w].data[3].yy * r27.yz;
                  r41.x = r41.y * r16.x;
                  r41.w = r41.y * r15.x;
                  r40.xyz = r26.xyz * r22.zzz + r41.xzw;
                  r25.z = gOmniShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r40.xyzw, r13.z).x;
                  r22.w = r25.z * 0.125 + r22.w;
                  r25.x = (int)r25.x + 1;
                }
              } else {
                r22.w = 1;
              ...
              r19.w = cmp(0 < r13.z);
              if (r19.w != 0) {
                if (4 == 0) r19.w = 0; else if (4+16 < 32) {                 r19.w = (uint)lightConstantsCB[r12.w].data[1].w << (32-(4 + 16)); r19.w = (uint)r19.w >> (32-4);                } else r19.w = (uint)lightConstantsCB[r12.w].data[1].w >> 16;
                r22.z = cmp(0 < (uint)r19.w);
                r22.z = r22.z ? r3.x : 0;
                if (r22.z != 0) {
                  r19.w = (int)r19.w + numLights;
                  r19.w = mad((int)r19.w, 15, -15);
                  r22.z = abs(r20.w) * -0.200000003 + 0.400000006;
                  r25.x = cmp(r20.w < 0);
                  r25.x = r0.w ? r25.x : 0;
                  r22.z = r25.x ? -r22.z : r22.z;
                  r28.xyz = r11.xyz * r22.zzz + r5.xyz;
                  ...
                  r25.x = dot(r40.xyzw, r28.xyzw);
                  r25.z = cmp(r25.x < r22.z);
                  if (r25.z == 0) {
                    r40.xyz = lightConstantsCB[r19.w].data[4].yzw;
                    r40.w = lightConstantsCB[r19.w].data[5].x;
                    r26.x = dot(r40.xyzw, r28.xyzw);
                    r40.xyz = lightConstantsCB[r19.w].data[5].yzw;
                    r40.w = lightConstantsCB[r19.w].data[6].x;
                    r26.y = dot(r40.xyzw, r28.xyzw);
                    r26.xy = r26.xy / r25.xx;
                    r26.xy = r26.xy * float2(0.5,-0.5) + float2(0.5,0.5);
                    r28.x = lightConstantsCB[r19.w].data[9].w + r26.x;
                    r28.y = lightConstantsCB[r19.w].data[10].x + r26.y;
                    r26.xy = lightConstantsCB[r19.w].data[9].yz * r28.xy;
                    r27.yz = lightConstantsCB[r19.w].data[3].yy / lightConstantsCB[r19.w].data[8].yw;
                    r28.xy = float2(1,1) + -r27.yz;
                    r28.xy = cmp(r26.xy >= r28.xy);
                    r27.yz = cmp(r27.yz >= r26.xy);
                    r27.yz = (int2)r27.yz | (int2)r28.xy;
                    r26.z = (int)r27.z | (int)r27.y;
                    if (r26.z == 0) {
                      r26.xy = saturate(r26.xy);
                      r28.x = r26.x * lightConstantsCB[r19.w].data[8].y + lightConstantsCB[r19.w].data[8].z;
                      r28.y = r26.y * lightConstantsCB[r19.w].data[8].w + lightConstantsCB[r19.w].data[9].x;
                      r26.x = lightConstantsCB[r19.w].data[10].z * r25.x;
                      r22.z = lightConstantsCB[r19.w].data[10].y * r25.x + r22.z;
                      r22.z = r22.z / r26.x;
                    }
                  } else {
                    r26.z = -1;
                  ...
                  if (r25.x == 0) {
                    ...
                    r25.x = 0x0000ffff & (int)lightConstantsCB[r19.w].data[1].w;
                    if (r9.w != 0) {
                      r26.z = (uint)r25.x;
                      r25.z = 0;
                      r27.y = 0;
                      while (true) {
                        ...
                        r26.xy = r40.xy * lightConstantsCB[r19.w].data[3].yy + r28.xy;
                        r26.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r26.xyz, r22.z).x;
                        r25.z = r26.x * 0.125 + r25.z;
                        r27.y = (int)r27.y + 1;
                      }
                    } else {
                      r28.z = (uint)r25.x;
                      r25.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r28.xyz, r22.z).x;
                    }
                    r19.w = r25.z * r25.z;
                    r19.w = r19.w * r25.z;
                  } else {
                  ...
                  if (4 == 0) r19.w = 0; else if (4+20 < 32) {                   r19.w = (uint)lightConstantsCB[r12.w].data[1].w << (32-(4 + 20)); r19.w = (uint)r19.w >> (32-4);                  } else r19.w = (uint)lightConstantsCB[r12.w].data[1].w >> 20;
                  r22.z = cmp(0 < (uint)r19.w);
                  r22.z = r22.z ? r3.z : 0;
                  if (r22.z != 0) {
                    r19.w = (int)r19.w + numLights;
                    ...
                    r25.x = r0.w ? r25.x : 0;
                    r22.z = r25.x ? -r22.z : r22.z;
                    r30.xyz = r11.xyz * r22.zzz + r5.xyz;
                    r40.xyz = lightConstantsCB[r19.w].data[6].yzw;
                    r40.w = lightConstantsCB[r19.w].data[7].x;
                    r22.z = dot(r40.xyzw, r30.xyzw);
                    r40.xyz = lightConstantsCB[r19.w].data[7].yzw;
                    r40.w = lightConstantsCB[r19.w].data[8].x;
                    r25.x = dot(r40.xyzw, r30.xyzw);
                    r26.x = cmp(r25.x < r22.z);
                    if (r26.x == 0) {
                      r40.xyz = lightConstantsCB[r19.w].data[4].yzw;
                      r40.w = lightConstantsCB[r19.w].data[5].x;
                      r28.x = dot(r40.xyzw, r30.xyzw);
                      r40.xyz = lightConstantsCB[r19.w].data[5].yzw;
                      r40.w = lightConstantsCB[r19.w].data[6].x;
                      r28.y = dot(r40.xyzw, r30.xyzw);
                      r26.yz = r28.xy / r25.xx;
                      r26.yz = r26.yz * float2(0.5,-0.5) + float2(0.5,0.5);
                      r28.x = lightConstantsCB[r19.w].data[9].w + r26.y;
                      r28.y = lightConstantsCB[r19.w].data[10].x + r26.z;
                      r26.yz = lightConstantsCB[r19.w].data[9].yz * r28.xy;
                      r27.yz = lightConstantsCB[r19.w].data[3].yy / lightConstantsCB[r19.w].data[8].yw;
                      r28.xy = float2(1,1) + -r27.yz;
                      r28.xy = cmp(r26.yz >= r28.xy);
                      r27.yz = cmp(r27.yz >= r26.yz);
                      r27.yz = (int2)r27.yz | (int2)r28.xy;
                      r27.y = (int)r27.z | (int)r27.y;
                      if (r27.y == 0) {
                        r26.yz = saturate(r26.yz);
                        r28.x = r26.y * lightConstantsCB[r19.w].data[8].y + lightConstantsCB[r19.w].data[8].z;
                        r28.y = r26.z * lightConstantsCB[r19.w].data[8].w + lightConstantsCB[r19.w].data[9].x;
                        r26.y = lightConstantsCB[r19.w].data[10].z * r25.x;
                        r22.z = lightConstantsCB[r19.w].data[10].y * r25.x + r22.z;
                        r22.z = r22.z / r26.y;
                      }
                    } else {
                    ...
                    if (r25.x == 0) {
                      ...
                      if (r9.w != 0) {
                        ...
                        r27.yz = float2(0,0);
                        while (true) {
                          r30.x = cmp((int)r27.z >= 8);
                          if (r30.x != 0) break;
                          r30.x = dot(icb[r27.z+0].xy, r32.xy);
                          r30.y = dot(icb[r27.z+0].yx, r32.xz);
                          r26.xy = r30.xy * lightConstantsCB[r19.w].data[3].yy + r28.xy;
                          r26.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r26.xyz, r22.z).x;
                        ...
                        r28.z = (uint)r25.x;
                        r27.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r28.xyz, r22.z).x;
                      }
                      r19.w = r27.y * r27.y;
                      r19.w = r19.w * r27.y;
                    } else {
                ...
                r19.w = r19.w + -r21.w;
                r19.w = r2.z * r19.w + r21.w;
                r19.w = r19.w * r13.z;
                r26.x = lightConstantsCB[r12.w].data[0].w;
                r26.yz = lightConstantsCB[r12.w].data[1].xy;
                r12.w = cmp(0 < r20.w);
                r28.xyz = r19.www * r26.xyz + r36.xyz;
                r20.w = saturate(dot(r11.xyz, r24.xyw));
                r23.yzw = r23.yzw * r17.www + r12.xyz;
                r17.w = dot(r23.yzw, r23.yzw);
                r17.w = rsqrt(r17.w);
                r23.yzw = r23.yzw * r17.www;
                r17.w = dot(r23.yzw, r12.xyz);
                r21.w = dot(r11.xyz, r23.yzw);
                r22.z = abs(r21.w) * r1.w + -abs(r21.w);
                r21.w = abs(r21.w) * r22.z + 1;
                r22.z = r20.w * r2.y + r6.w;
                r21.w = r21.w * r21.w;
                r21.w = r21.w * r22.z;
                r21.w = rcp(r21.w);
                r14.w = r20.w * r14.w;
                r14.w = r21.w * r14.w;
                r14.w = r14.w * r13.z;
                r23.yzw = r14.www * r26.xyz + r39.xyz;
                r17.w = saturate(1 + -r17.w);
                r20.w = r17.w * r17.w;
                r20.w = r20.w * r20.w;
                r17.w = r20.w * r17.w;
                r14.w = r17.w * r14.w;
                r24.xyw = r14.www * r26.xyz + r38.xyz;
                r26.xyz = r19.www * r26.xyz + r37.xyz;
                r26.xyz = r0.www ? r26.xyz : r37.xyz;
                r36.xyz = r12.www ? r28.xyz : r36.xyz;
                r37.xyz = r12.www ? r37.xyz : r26.xyz;
                r38.xyz = r12.www ? r24.xyw : r38.xyz;
                r39.xyz = r12.www ? r23.yzw : r39.xyz;
                r12.w = (int)r22.y & 255;
                r14.w = (int)r12.w + -1;
                r14.w = cmp((uint)r14.w < 32);
                r14.w = r14.w ? r2.w : 0;
                if (r14.w != 0) {
                  r23.yz = mad((int2)r12.ww, int2(24,24), int2(88,108));
                // Known bad code for instruction (needs manual fix):
  ...
  r4.xyw = float3(0.959999979,0.959999979,0.959999979) * r34.xyz;
  r4.xyw = r35.xyz * float3(0.0399999991,0.0399999991,0.0399999991) + r4.xyw;
  r2.xyz = r4.xyw + r2.xyz;
  r4.xyw = float3(1,1,1) + -r3.xyz;
  r4.xyw = r34.xyz * r4.xyw;
  r3.xyz = r35.xyz * r3.xyz + r4.xyw;
