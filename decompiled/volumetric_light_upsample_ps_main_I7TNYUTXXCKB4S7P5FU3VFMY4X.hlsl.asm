...
utof r0.yz, r0.yyzy
rcp r0.yz, r0.yyzy
add r1.xy, v0.xyxx, l(1.000000, 1.000000, 0.000000, 0.000000)
add r1.xy, r1.xyxx, r1.xyxx
div r1.xy, r1.xyxx, cb8[7].xxxx
...
add r0.x, r3.y, r3.x
mad r0.x, r2.z, r1.z, r0.x
mad r0.x, r2.w, r1.w, r0.x
gather4_indexable(texture2d)(float,float,float,float) r1.xyzw, r0.yzyy, t0.xyzw, s1.x
dp4 r1.x, r3.zwyx, r1.xyzw
gather4_indexable(texture2d)(float,float,float,float) r2.xyzw, r0.yzyy, t0.xyzw, s1.y
gather4_indexable(texture2d)(float,float,float,float) r4.xyzw, r0.yzyy, t0.xyzw, s1.z
dp4 r1.z, r3.zwyx, r4.xyzw
dp4 r1.y, r3.zwyx, r2.xyzw
