...
sample_indexable(texture2d)(float,float,float,float) r0.w, v2.xyxx, t25.yzwx, s5
sample_indexable(texture2d)(float,float,float,float) r2.xyz, v2.xyxx, t24.xyzw, s6
sample_indexable(texture2d)(float,float,float,float) r2.w, v2.xyxx, t26.yzwx, s7
add r3.x, -cb0[12].x, cb0[12].y
mad r0.w, r0.w, r3.x, cb0[12].x
...
mad r2.x, cb1[62].x, r3.x, cb0[12].x
...
rsq r2.z, r2.z
mad r5.xyz, r5.xyzx, r2.zzzz, -r3.yzwy
mad r3.xyz, cb1[60].wwww, r5.xyzx, r3.yzwy
ftou r2.zw, v0.xxxy
...
if_nz r7.z
  ...
  if_nz r7.z
    ...
    mad r10.yzw, r6.wwww, r9.yyzw, r2.yyzw
...
mad r2.xyz, r29.xyzx, r4.xyzx, r2.xyzx
