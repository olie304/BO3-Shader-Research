...
discard_nz r1.w
sample_indexable(texture2d)(float,float,float,float) r2.xy, v1.xyxx, t7.xyzw, s1
mad r2.xy, r2.xyxx, l(2.000000, 2.000000, 0.000000, 0.000000), l(-1.000000, -1.000000, 0.000000, 0.000000)
mul r2.zw, v2.wwww, cb1[44].zzzw
mul r2.zw, r2.zzzw, cb3[0].xxxx
mul r2.zw, r0.zzzz, r2.zzzw
mad r0.xy, r2.zwzz, r2.xyxx, r0.xyxx
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r0.xyxx, t0.xyzw, s1
mul r0.xyz, r0.wwww, r1.xyzx
mul r0.w, v2.z, l(0.03333334)
mul r0.xyz, r0.wwww, r0.xyzx
mad r0.xyz, r2.xyzx, l(0.00003052, 0.00003052, 0.00003052, 0.000000), r0.xyzx
