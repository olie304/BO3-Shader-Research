...
r0.y = samp0[]..swiz;
  ...
  if (r4.z != 0) {
    ...
    if (r4.z != 0) {
      ...
      r0.w = r4.z * r0.w;
      r0.w = r2.w * r0.w;
      r14.yzw = r0.www * r13.yzw + r18.xyz;
  ...
  switch (r0.w) {
    ...
    r20.xyz = r0.www ? r20.xyz : lightConstantsCB[r0.x].data[0].xyz;
    ...
    if (r7.w != 0) {
      ...
      if (r7.w != 0) {
        ...
        if (r7.w != 0) {
          ...
          r9.xyz = r0.www ? r9.xyz : lightConstantsCB[r0.x].data[0].xyz;
          r9.xyz = r9.xyz + -r10.xyz;
          r0.w = dot(r9.xyz, r9.xyz);
          r0.w = rsqrt(r0.w);
          r13.yzw = r9.xyz * r0.www;
          ...
          r0.w = r5.w * r0.w;
          r0.w = r4.z * r0.w;
          r13.yzw = r0.www * r15.xyz + r18.xyz;
