...
sample_indexable(texture2d)(float,float,float,float) r3.xyz, r3.xyxx, t22.xyzw, s3
...
and r6.zw, r2.wwww, l(0, 0, 0x10000000, 0x20000000)
if_nz r6.z
...
mov_sat r13.x, r13.x
add r1.z, -r13.x, l(1.000000)
mad r0.xyz, r0.xyzx, r1.zzzz, r14.xyzx
mad r0.w, r0.w, r1.z, r13.x
mad r2.xyz, r2.xyzx, r1.zzzz, r15.xyzx
dp3 r1.w, r2.xyzx, r2.xyzx
rsq r1.w, r1.w
mul r2.xyz, r1.wwww, r2.xyzx
mad r7.y, r1.x, r1.z, r13.y
mad r8.xyz, r1.zzzz, l(0.040000, 0.040000, 0.040000, 0.000000), r16.xyzx
...
frc r1.w, r1.w
mul r1.yw, r1.yyyw, l(0.000000, 0.00781250, 0.000000, 52.982918)
frc r1.w, r1.w
mad r1.w, r1.w, l(6.28318548), cb1[70].w
sincos r5.x, r10.x, r1.w
    ...
    if_nz r11.z
      ...
      if_nz r11.y
        ...
        if_nz r11.w
          ...
          sqrt r11.y, r11.y
          mad r11.y, r4.z, l(5.000000), r11.y
      ...
      if_nz r14.z
        ...
        if_nz r13.w
          ...
          loop 
            ...
            mov r16.x, r25.w
          endloop 
          add_sat r13.w, -r8.w, r28.y
          mul r14.z, r14.w, r13.w
          ...
          if_nz r16.x
            ...
            mad r24.w, r13.w, r14.w, r24.w
            mul r10.w, r26.z, r14.z
            mov r26.z, r34.z
            ...
            utof r34.w, r14.z
            sample_l_indexable(texturecubearray)(float,float,float,float) r18.yzw, r34.xyzw, t8.wxyz, s2, r13.w
            ...
            mul r14.z, r5.w, r13.w
            mul r18.yzw, r10.wwww, r18.yyzw
            dp3 r10.w, r18.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
            mad r10.w, r5.w, r13.w, r10.w
            div r10.w, r14.z, r10.w
            mad r24.xyz, r18.yzwy, r10.wwww, r24.xyzx
          endif 
        endif 
      endif 
    endloop 
  ...
  if_z r10.w
    ...
    if_nz cb2[58].y
      ...
      loop 
        ...
        utof r17.z, r13.w
        sample_c_lz_indexable(texture2darray)(float,float,float,float) r13.w, r17.xyzx, t13.xxxx, s13, r5.z
...
if_nz r5.z
  ...
  if_nz r5.z
    ...
    mad r16.xyz, r4.wwww, r11.yzwy, r7.yzwy
    ...
    mov r15.w, r17.z
    mov r6.w, r14.z
    movc r6.xyzw, r4.zzzz, r15.xyzw, r6.xyzw
    mov r17.zw, r16.xxxy
    mov r14.zw, r7.yyyz
    movc r15.xyzw, r4.zzzz, r17.xyzw, r14.xyzw
    movc r7.w, r4.z, r16.z, r7.w
    mov r14.z, r6.w
    mov r14.xy, r15.xyxx
    mov r7.yz, r15.zzwz
  endif 
...
mov r15.x, -r5.x
not r1.x, r1.z
mad r4.z, -r7.x, l(0.500000), l(1.000000)
mov r16.xy, l(0,0,0,0)
mov r17.w, l(0)
mov r18.xyz, v6.xyzx
          ...
          if_nz r16.w
            ...
            if_nz r16.w
              ...
              if_nz r16.w
                ...
                mad r16.z, |r14.w|, r1.w, -|r14.w|
                mad r14.w, |r14.w|, r16.z, l(1.000000)
                mad r16.z, r10.w, r1.y, r2.w
          ...
          if_nz r13.w
            ...
            if_nz r13.w
              ...
              if_nz r13.w
                ...
                mad r14.w, -r12.w, r4.z, l(1.000000)
                mul r14.w, r14.w, r14.w
                ...
                mad r16.w, |r14.w|, r1.w, -|r14.w|
                mad r14.w, |r14.w|, r16.w, l(1.000000)
                mad r12.w, r12.w, r1.y, r2.w
                mul r14.w, r14.w, r14.w
...
ret 
// Approximately 2601 instruction slots used
