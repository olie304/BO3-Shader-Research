...
loop 
  ...
  switch r10.w
    ...
    mov r35.xy, cb9[r9.w + 5].zwzz
    mov r35.z, cb9[r9.w + 6].x
    mad r20.yzw, -r35.xxyz, l(0.000000, 0.500000, 0.500000, 0.500000), cb9[r9.w + 0].xxyz
    ...
    if_nz r18.w
      ...
      mad_sat r37.xy, r18.wwww, cb9[r9.w + 2].xzxx, cb9[r9.w + 2].ywyy
      ...
      if_nz r18.w
        ...
        if_nz r18.w
          ...
          lt r28.w, r14.w, l(0.000000)
          and r28.w, r0.w, r28.w
          movc r18.w, r28.w, -r18.w, r18.w
          mad r37.xyz, r11.xyzx, r18.wwww, r5.xyzx
        ...
        lt r18.w, l(0.000000), r13.w
        if_nz r18.w
          mul r18.w, r1.z, cb9[r9.w + 1].z
          mul r18.w, r18.w, l(0.250000)
          dp3 r28.w, r35.xyzx, r17.xyzx
          dp3 r30.w, r17.xyzx, r36.xyzx
              ...
              if_z r22.x
                ...
                if_nz cb2[58].y
                  ...
                  loop 
                    ige r30.w, r28.w, l(8)
                    breakc_nz r30.w
                    dp2 r37.x, icb[r28.w + 0].xyxx, r14.xyxx
                    dp2 r37.y, icb[r28.w + 0].yxyy, r14.xzxx
    ...
    mov_sat r13.z, r12.w
    movc r13.w, r0.w, |r12.w|, r13.z
    lt r14.w, l(0.000000), r13.w
    if_nz r14.w
      mov r35.xyz, cb9[r9.w + 7].yzwy
      mov r35.w, cb9[r9.w + 8].x
      dp4 r14.w, r35.xyzw, r5.xyzw
      lt r17.w, r14.w, l(1.000000)
      if_nz r17.w
        mov r20.yzw, l(0,1.000000,1.000000,1.000000)
        mov r17.w, l(0)
      else 
        add r21.yzw, -r5.xxyz, cb9[r9.w + 0].xxyz
        mul r18.w, cb9[r9.w + 3].x, cb9[r9.w + 3].x
        dp3 r21.y, r21.yzwy, r21.yzwy
        div r18.w, r18.w, r21.y
        min r18.w, r18.w, l(1.000000)
        mad_sat r21.yz, r14.wwww, cb9[r9.w + 2].xxzx, cb9[r9.w + 2].yywy
        ...
        div r24.xy, r36.xyxx, r14.wwww
        lt r14.w, cb9[r9.w + 10].w, l(0.00048828)
        if_nz r14.w
          mad_sat r21.yz, |r24.xxyx|, cb9[r9.w + 12].xxyx, cb9[r9.w + 12].zzwz
          mul r36.xy, r21.yzyy, r21.yzyy
          mad r21.yz, r21.yyzy, l(0.000000, -2.000000, -2.000000, 0.000000), l(0.000000, 3.000000, 3.000000, 0.000000)
          mul r21.yz, r21.yyzy, r36.xxyx
          mul r14.w, r21.z, r21.y
        else 
          mul_sat r36.xyzw, |r24.yyxx|, cb9[r9.w + 11].xyzw
          log r36.xyzw, r36.xyzw
          mul r36.xyzw, r36.xyzw, cb9[r9.w + 12].zzzz
          exp r36.xyzw, r36.xyzw
          add r21.yz, r36.zzwz, r36.xxyx
          log r21.yz, r21.yyzy
          mul r21.yz, r21.yyzy, cb9[r9.w + 12].wwww
          exp r21.yz, r21.yyzy
          mul r21.y, r21.y, cb9[r9.w + 12].x
          mad r21.w, cb9[r9.w + 12].y, r21.z, l(-1.000000)
          mad r21.y, cb9[r9.w + 12].y, r21.z, -r21.y
          div_sat r21.y, r21.w, r21.y
          mul r21.z, r21.y, r21.y
          mad r21.y, r21.y, l(-2.000000), l(3.000000)
          mul r14.w, r21.y, r21.z
        endif 
        mul r17.w, r14.w, r18.w
        and r14.w, l(255), cb9[r9.w + 14].w
        if_nz r14.w
          dp3 r18.w, cb9[r9.w + 13].xyzx, r24.xyzx
          mov r36.x, cb9[r9.w + 13].w
          mov r36.yz, cb9[r9.w + 14].xxyx
      ...
      mov r36.x, cb9[r9.w + 0].w
      mov r36.yz, cb9[r9.w + 1].xxyx
      mul r20.yzw, r20.yyzw, r36.xxyz
      lt r14.w, l(0.000000), r17.w
      if_nz r14.w
        ubfe r14.w, l(3), l(27), cb9[r9.w + 1].w
        and r18.w, r10.w, l(7)
        ...
        if_nz r14.w
          ...
          if_nz r21.z
            ...
            mad r25.x, r21.z, cb9[r9.w + 8].y, cb9[r9.w + 8].z
            mad r25.y, r21.w, cb9[r9.w + 8].w, cb9[r9.w + 9].x
            div r14.w, r14.w, r21.y
            max r14.w, r14.w, l(0.00006104)
            and r21.y, l(0x0000ffff), cb9[r9.w + 1].w
            if_nz cb2[58].y
              utof r35.z, r21.y
              ...
              loop 
                ...
                mad r35.xy, r24.xyxx, cb9[r9.w + 3].yyyy, r25.xyxx
                sample_c_lz_indexable(texture2darray)(float,float,float,float) r22.x, r35.xyzx, t9.xxxx, s13, r14.w
                mad r21.z, r22.x, l(0.125000), r21.z
                iadd r21.w, r21.w, l(1)
              endloop 
            else 
              utof r25.z, r21.y
              sample_c_lz_indexable(texture2darray)(float,float,float,float) r21.z, r25.xyzx, t9.xxxx, s13, r14.w
            endif 
        ...
        if_nz r17.w
          mul r17.w, r1.z, cb9[r9.w + 1].z
          mul r17.w, r13.z, r17.w
          ubfe r21.y, l(4), l(16), cb9[r9.w + 1].w
          ult r21.w, l(0), r21.y
          ...
          if_nz r21.w
            ...
            if_nz r21.y
              ...
              mad r27.xyz, r11.xyzx, r21.yyyy, r5.xyzx
              mov r35.xyz, cb9[r9.w + 6].yzwy
              mov r35.w, cb9[r9.w + 7].x
              ...
              if_z r22.x
                ...
                mad r24.yw, r24.yyyw, l(0.000000, 0.500000, 0.000000, -0.500000), l(0.000000, 0.500000, 0.000000, 0.500000)
                add r25.x, r24.y, cb9[r9.w + 9].w
                add r25.y, r24.w, cb9[r9.w + 10].x
                mul r24.yw, r25.xxxy, cb9[r9.w + 9].yyyz
                ...
                if_z r25.x
                  mov_sat r24.yw, r24.yyyw
                  mad r26.x, r24.y, cb9[r9.w + 8].y, cb9[r9.w + 8].z
                  mad r26.y, r24.w, cb9[r9.w + 8].w, cb9[r9.w + 9].x
                  mul r24.y, r21.w, cb9[r9.w + 10].z
                  mad r21.y, cb9[r9.w + 10].y, r21.w, r21.y
              ...
              if_z r21.w
                ...
                if_nz cb2[58].y
                  ...
                  loop 
                    ...
                    mad r25.xy, r27.xyxx, cb9[r9.w + 3].yyyy, r26.xyxx
          ...
          mad r25.xyz, r9.wwww, r20.yzwy, r31.xyzx
          mad r23.xyz, r23.xyzx, r11.wwww, r12.xyzx
          dp3 r11.w, r23.xyzx, r23.xyzx
          rsq r11.w, r11.w
          mul r23.xyz, r11.wwww, r23.xyzx
          dp3 r11.w, r23.xyzx, r12.xyzx
          dp3 r13.w, r11.xyzx, r23.xyzx
          mad r21.y, |r13.w|, r1.z, -|r13.w|
          ...
          mad r26.xyz, r11.wwww, r20.yzwy, r33.xyzx
          mad r20.yzw, r9.wwww, r20.yyzw, r32.xxyz
...
ret 
// Approximately 1162 instruction slots used
