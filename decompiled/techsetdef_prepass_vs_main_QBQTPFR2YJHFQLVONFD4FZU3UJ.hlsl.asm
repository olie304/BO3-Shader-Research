...
//   bool forceIsolateHack;             // Offset:  184 Size:     4 [unused]
//   float2 vertexColorScale;           // Offset:  192 Size:     8
//
// }
//
...
mov r6.w, l(1.000000)
mov r5.xyz, r3.xyzx
dp4 r3.x, r6.xyzw, r5.xyzw
mov r7.xyz, r4.xyzx
mov r7.w, r2.y
mov r1.w, r2.z
dp4 r3.z, r6.xyzw, r1.xyzw
dp4 r3.y, r6.xyzw, r7.xyzw
add r1.xyz, r3.xyzx, cb1[24].xyzx
mul r0.w, cb1[69].w, cb2[38].y
mad r1.w, r0.w, l(0.900000), r1.x
mul r0.w, r0.w, l(0.900000)
mad r0.w, r3.w, l(0.100000), r0.w
...
mad r2.y, r2.x, l(0.700000), r1.x
mul r2.x, r2.x, l(0.700000)
mad r2.x, r4.w, l(0.100000), r2.x
mul r2.x, r2.x, l(0.070000)
sincos null, r2.x, r2.x
mad r0.w, r2.x, l(0.500000), r0.w
add r0.w, r0.w, l(0.500000)
mul r0.w, r0.w, l(0.500000)
mul r2.x, r2.y, l(0.700000)
sincos null, r2.x, r2.x
mul r2.y, r1.w, r2.x
mul r2.z, v0.z, l(0.010000)
mul r2.y, r2.z, r2.y
mul r2.zw, v1.xxxy, cb0[12].xxxy
mul r4.xy, cb2[38].zwzz, cb2[38].yyyy
mul r1.w, r1.w, r4.x
mul r2.x, r2.x, r4.y
mul r3.yz, r2.wwww, r2.xxyx
mul r3.x, r2.w, r1.w
mul r2.xyw, r3.xyxz, l(0.110000, 0.130000, 0.000000, 0.090000)
dp2 r1.w, v0.xzxx, v0.xzxx
sqrt r1.w, r1.w
mul r1.w, r1.w, cb2[38].y
mul r1.w, r1.w, cb2[38].z
mul r1.w, r0.w, r1.w
mul r1.w, r2.z, r1.w
mad r2.x, r1.w, l(0.010000), r2.x
dp2 r1.w, v0.yzyy, v0.yzyy
sqrt r1.w, r1.w
mul r1.w, r1.w, cb2[38].y
mul r1.w, r1.w, cb2[38].w
mul r0.w, r0.w, r1.w
mul r0.w, r2.z, r0.w
mad r2.y, r0.w, l(0.010000), r2.y
...
mul r3.xyzw, cb1[9].xyzw, -cb1[24].yyyy
mad r3.xyzw, -cb1[24].xxxx, cb1[8].xyzw, r3.xyzw
mad r3.xyzw, -cb1[24].zzzz, cb1[10].xyzw, r3.xyzw
add r3.xyzw, r3.xyzw, cb1[11].xyzw
add o0.xyzw, r2.xyzw, r3.xyzw
mad r2.xyz, v2.xyzx, l(2.001957, 2.001957, 2.001957, 0.000000), l(-1.00195694, -1.00195694, -1.00195694, 0.000000)
dp3 o1.x, r2.xyzx, r5.xyzx
dp3 o1.y, r2.xyzx, r7.xyzx
dp3 o1.z, r2.xyzx, r0.xyzx
