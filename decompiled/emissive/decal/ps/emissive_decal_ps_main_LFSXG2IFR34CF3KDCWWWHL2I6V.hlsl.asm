...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:25:54 2021
//
//
// Buffer Definitions: 
//
...
//   float hdrScale;                    // Offset:  200 Size:     4
//   float emissiveFalloffPower;        // Offset:  204 Size:     4
...
// cbcrSampler                       sampler      NA          NA             s3      1 
// yTexture                          texture  float4          2d             t0      1 
// cbcrTexture                       texture  float4          2d            t21      1 
...
sample_indexable(texture2d)(float,float,float,float) r1.xy, v2.xyxx, t21.xyzw, s3
...
mul r2.xyz, r1.xyzx, l(0.07739938, 0.07739938, 0.07739938, 0.000000)
...
movc r0.xyz, cb0[13].wwww, r1.xyzx, r0.xyzx
