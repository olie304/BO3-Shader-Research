// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:25:56 2021
...
cbuffer _Globals : register(b0)
{
  ...
  float2 scriptControl : packoffset(c20.y);
...
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) r1.xy, r1.x, l(36), t0.xyxx
r1.x = colorSampler[]..swiz;
r1.y = colorSampler[]..swiz;
  r1.x = saturate(r1.x);
  r1.x = hdrScale * r1.x;
  r1.yzw = cmp(r1.yyy == float3(3,2,1));
