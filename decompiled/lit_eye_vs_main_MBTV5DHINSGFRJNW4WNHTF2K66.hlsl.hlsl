...
r5.w = modelInstanceBuffer[]..swiz;
  ...
  o3.x = v5.x;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r0.xyz, r1.x, l(0), t5.xyzx
...
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r3.xyz, r1.x, l(32), t5.xyzx
...
r3.z = modelInstanceBuffer[]..swiz;
  ...
  r7.x = dot(r6.xyz, r2.xyz);
  r7.y = dot(r6.xyz, r4.xyz);
