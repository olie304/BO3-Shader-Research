...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r3.x = min(1, r3.x);
  r3.yzw = saturate(r0.yzw * float3(0.0199999996,0.0199999996,0.0199999996) + float3(0.0399999991,0.0399999991,0.0399999991));
  r6.xyz = specColorTint.xyz * r3.yzw;
  r7.xyz = r3.xxx * r0.yzw;
  r5.xyz = r7.xyz * r5.xyz;
  r0.yzw = r2.xyz * r0.yzw + r5.xyz;
