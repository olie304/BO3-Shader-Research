...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r2.y = rcp(r2.y);
  r2.z = -eyeOffset.z + useOldHDRScale;
  r2.z = useOldHDRScale * r2.z;
  r2.w = useOldHDRScale * v4.z;
  r3.x = cmp(r2.z < r2.w);
  r2.z = r2.y * r2.z;
  r2.z = r2.z / r2.w;
  r2.w = cmp(v5.y != 1.000000);
  r3.yzw = r0.xyz / r1.yyy;
  r1.y = v1.w + r0.w;
  r4.w = saturate(r1.y * v5.y + -v5.y);
  r4.xyz = r4.www * r3.yzw;
