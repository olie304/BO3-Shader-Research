...
//   uint numDigits;                    // Offset:  224 Size:     4
//
// }
//
...
dcl_output o0.xyzw
dcl_temps 4
mul r0.xy, v2.xyxx, l(0.100000, 1.000000, 0.000000, 0.000000)
...
iadd r1.y, cb0[14].x, l(-1)
utof r1.z, cb0[14].x
mul r1.z, r1.z, v2.x
ftou r1.xw, r1.xxxz
iadd r1.y, -r1.w, r1.y
utof r1.y, r1.y
mul r1.y, r1.y, l(3.321928)
exp r1.y, r1.y
ftou r1.y, r1.y
udiv r1.w, null, r1.x, r1.y
imul null, r1.y, r1.y, l(10)
udiv r1.x, null, r1.x, r1.y
imad r1.x, r1.x, l(-10), r1.w
frc r1.y, r1.z
utof r1.x, r1.x
mul r1.x, r1.x, l(0.100000)
mad r1.x, r1.y, l(0.100000), r1.x
mov r1.y, v2.y
sample_d_indexable(texture2d)(float,float,float,float) r0.xyzw, r1.xyxx, t21.xyzw, s1, r0.zwzz, r0.xyxx
