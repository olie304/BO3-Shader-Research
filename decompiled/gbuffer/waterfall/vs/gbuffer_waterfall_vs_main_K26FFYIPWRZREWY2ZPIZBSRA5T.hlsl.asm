...
mov o1.xyzw, v1.xyzw
mul r1.yz, cb0[16].xxzx, l(0.000000, 27.239243, 25.132742, 0.000000)
mul r1.yz, r3.xxyx, r1.yyzy
mul r3.xy, r3.xyxx, cb0[16].ywyy
mul r3.xy, r3.xyxx, l(27.239243, 25.132742, 0.000000, 0.000000)
add r1.w, r3.y, r3.x
add r1.y, r1.z, r1.y
mul r1.z, cb0[17].x, l(34.456177)
...
mad r0.yz, r0.yyzy, cb0[13].zzwz, r1.xxyx
...
movc o2.xy, cb0[15].zwzz, r1.xyxx, r0.yzyy
ine r0.y, r0.x, l(0)
