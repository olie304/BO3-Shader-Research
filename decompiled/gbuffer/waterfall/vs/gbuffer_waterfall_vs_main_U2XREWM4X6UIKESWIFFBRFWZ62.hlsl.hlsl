...
r4.y = modelInstanceBuffer[]..swiz;
  ...
  r5.w = 1;
  r6.w = r8.x;
  r10.x = dot(r5.xyzw, r6.xyzw);
  r7.w = r8.y;
  r10.y = dot(r5.xyzw, r7.xyzw);
  r9.w = r8.z;
  r10.z = dot(r5.xyzw, r9.xyzw);
  ...
  r5.x = dot(r1.yzw, r6.xyz);
  r5.y = dot(r1.yzw, r7.xyz);
  r5.z = dot(r1.yzw, r9.xyz);
  r0.w = dot(r5.xyz, r5.xyz);
  r0.w = rsqrt(r0.w);
  r1.yzw = r5.xyz * r0.www;
  r5.x = dot(r2.xyz, r6.xyz);
  r5.y = dot(r2.xyz, r7.xyz);
  r5.z = dot(r2.xyz, r9.xyz);
  r0.w = dot(r5.xyz, r5.xyz);
  r0.w = rsqrt(r0.w);
  r2.xyz = r5.xyz * r0.www;
  r5.xyzw = viewProjectionMatrix._m10_m11_m12_m13 * r10.yyyy;
  r5.xyzw = r10.xxxx * viewProjectionMatrix._m00_m01_m02_m03 + r5.xyzw;
  r5.xyzw = r10.zzzz * viewProjectionMatrix._m20_m21_m22_m23 + r5.xyzw;
  o0.xyzw = viewProjectionMatrix._m30_m31_m32_m33 + r5.xyzw;
  r0.w = (int)r4.x & 0x0fffffff;
  if (r0.w != 0) {
    if (r0.w != 0) {
      r2.w = cmp(v5.x != 0.000000);
      if (r2.w != 0) {
        r2.w = (int)r0.w + (int)v6.x;
      // Known bad code for instruction (needs manual fix):
      ...
      r6.w = modelInstanceBuffer[]..swiz;
        ...
        r5.y = v5.x * r4.x;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r6.xyzw, r2.w, l(32), t8.xyzw
      r6.x = modelInstanceBuffer[]..swiz;
      r6.y = modelInstanceBuffer[]..swiz;
      r6.z = modelInstanceBuffer[]..swiz;
      r6.w = modelInstanceBuffer[]..swiz;
        ...
        if (r2.w != 0) {
          r2.w = (int)r0.w + (int)v6.y;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r6.xyzw, r2.w, l(0), t8.xyzw
        r6.x = modelInstanceBuffer[]..swiz;
        r6.y = modelInstanceBuffer[]..swiz;
        r6.z = modelInstanceBuffer[]..swiz;
        r6.w = modelInstanceBuffer[]..swiz;
          ...
          r6.x = r4.x * v5.y + r5.x;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r7.xyzw, r2.w, l(16), t8.xyzw
        r7.x = modelInstanceBuffer[]..swiz;
        r7.y = modelInstanceBuffer[]..swiz;
        r7.z = modelInstanceBuffer[]..swiz;
        r7.w = modelInstanceBuffer[]..swiz;
          ...
          r6.y = r4.x * v5.y + r5.y;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r7.xyzw, r2.w, l(32), t8.xyzw
        r7.x = modelInstanceBuffer[]..swiz;
        r7.y = modelInstanceBuffer[]..swiz;
        r7.z = modelInstanceBuffer[]..swiz;
        r7.w = modelInstanceBuffer[]..swiz;
          ...
          if (r2.w != 0) {
            r2.w = (int)r0.w + (int)v6.z;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r7.xyzw, r2.w, l(0), t8.xyzw
          r7.x = modelInstanceBuffer[]..swiz;
          r7.y = modelInstanceBuffer[]..swiz;
          r7.z = modelInstanceBuffer[]..swiz;
          r7.w = modelInstanceBuffer[]..swiz;
            ...
            r7.x = r4.x * v5.z + r6.x;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r8.xyzw, r2.w, l(16), t8.xyzw
          r8.x = modelInstanceBuffer[]..swiz;
          r8.y = modelInstanceBuffer[]..swiz;
          r8.z = modelInstanceBuffer[]..swiz;
          r8.w = modelInstanceBuffer[]..swiz;
            r4.x = dot(r8.xyz, r3.xyz);
            r4.x = r4.x + r8.w;
            r7.y = r4.x * v5.z + r6.y;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r8.xyzw, r2.w, l(32), t8.xyzw
          r8.x = modelInstanceBuffer[]..swiz;
          r8.y = modelInstanceBuffer[]..swiz;
          r8.z = modelInstanceBuffer[]..swiz;
          r8.w = modelInstanceBuffer[]..swiz;
            ...
            if (r2.w != 0) {
              r2.w = (int)r0.w + (int)v6.w;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r8.xyzw, r2.w, l(0), t8.xyzw
            r8.x = modelInstanceBuffer[]..swiz;
            r8.y = modelInstanceBuffer[]..swiz;
            r8.z = modelInstanceBuffer[]..swiz;
            r8.w = modelInstanceBuffer[]..swiz;
              ...
              r8.x = r4.x * v5.w + r7.x;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r9.xyzw, r2.w, l(16), t8.xyzw
            r9.x = modelInstanceBuffer[]..swiz;
            r9.y = modelInstanceBuffer[]..swiz;
            r9.z = modelInstanceBuffer[]..swiz;
            r9.w = modelInstanceBuffer[]..swiz;
              r4.x = dot(r9.xyz, r3.xyz);
              r4.x = r4.x + r9.w;
              r8.y = r4.x * v5.w + r7.y;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r9.xyzw, r2.w, l(32), t8.xyzw
            r9.x = modelInstanceBuffer[]..swiz;
            r9.y = modelInstanceBuffer[]..swiz;
            r9.z = modelInstanceBuffer[]..swiz;
            r9.w = modelInstanceBuffer[]..swiz;
    ...
    if (r1.x != 0) {
      ...
      r6.w = modelInstanceBuffer[]..swiz;
        ...
        r6.w = modelInstanceBuffer[]..swiz;
          ...
          r6.x = r4.x * v5.y + r5.x;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r7.xyzw, r2.w, l(16), t5.xyzw
        r7.x = modelInstanceBuffer[]..swiz;
        r7.y = modelInstanceBuffer[]..swiz;
        r7.z = modelInstanceBuffer[]..swiz;
        r7.w = modelInstanceBuffer[]..swiz;
          ...
          r6.y = r4.x * v5.y + r5.y;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r7.xyzw, r2.w, l(32), t5.xyzw
        r7.x = modelInstanceBuffer[]..swiz;
        r7.y = modelInstanceBuffer[]..swiz;
        r7.z = modelInstanceBuffer[]..swiz;
        r7.w = modelInstanceBuffer[]..swiz;
          ...
          r2.w = cmp(v5.z != 0.000000);
          if (r2.w != 0) {
            r2.w = (int)r1.x + (int)v6.z;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r7.xyzw, r2.w, l(0), t5.xyzw
          r7.x = modelInstanceBuffer[]..swiz;
          r7.y = modelInstanceBuffer[]..swiz;
          r7.z = modelInstanceBuffer[]..swiz;
          r7.w = modelInstanceBuffer[]..swiz;
  ...
  if (r0.w != 0) {
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r4.xyzw, r0.w, l(0), t8.xyzw
  r4.x = modelInstanceBuffer[]..swiz;
  r4.y = modelInstanceBuffer[]..swiz;
  r4.z = modelInstanceBuffer[]..swiz;
  r4.w = modelInstanceBuffer[]..swiz;
  ...
  r5.w = modelInstanceBuffer[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r6.xyzw, r0.w, l(32), t8.xywz
  r6.x = modelInstanceBuffer[]..swiz;
  r6.y = modelInstanceBuffer[]..swiz;
  r6.z = modelInstanceBuffer[]..swiz;
  r6.w = modelInstanceBuffer[]..swiz;
  ...
  r6.xyz = -motionVectorConstants.prevFrameEyeOffset.xyz + r6.xyz;
  r3.w = 1;
  r4.w = r6.x;
  r0.w = dot(r3.xyzw, r4.xyzw);
  r5.w = r6.y;
  r1.x = dot(r3.xyzw, r5.xyzw);
  r7.w = r6.z;
  r2.w = dot(r3.xyzw, r7.xyzw);
  r3.xyzw = motionVectorConstants.prevFrameOffToClpMatrixFull._m10_m11_m12_m13 * r1.xxxx;
  r3.xyzw = r0.wwww * motionVectorConstants.prevFrameOffToClpMatrixFull._m00_m01_m02_m03 + r3.xyzw;
  r3.xyzw = r2.wwww * motionVectorConstants.prevFrameOffToClpMatrixFull._m20_m21_m22_m23 + r3.xyzw;
  o6.xyzw = motionVectorConstants.prevFrameOffToClpMatrixFull._m30_m31_m32_m33 + r3.xyzw;
  r0.w = dot(-r10.xyz, -r10.xyz);
  r0.w = rsqrt(r0.w);
  r3.xyz = -r10.xyz * r0.www;
  r4.x = dot(r3.xyz, r1.yzw);
