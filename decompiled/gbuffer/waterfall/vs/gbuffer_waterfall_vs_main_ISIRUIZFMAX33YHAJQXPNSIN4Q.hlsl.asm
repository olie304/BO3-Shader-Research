...
dp3 r5.x, r1.yzwy, r6.xyzx
dp3 r5.y, r1.yzwy, r7.xyzx
dp3 r5.z, r1.yzwy, r9.xyzx
dp3 r0.w, r5.xyzx, r5.xyzx
rsq r0.w, r0.w
mul r1.yzw, r0.wwww, r5.xxyz
dp3 r5.x, r2.xyzx, r6.xyzx
dp3 r5.y, r2.xyzx, r7.xyzx
dp3 r5.z, r2.xyzx, r9.xyzx
dp3 r0.w, r5.xyzx, r5.xyzx
rsq r0.w, r0.w
mul r2.xyz, r0.wwww, r5.xyzx
mul r5.xyzw, r10.yyyy, cb1[9].xyzw
mad r5.xyzw, r10.xxxx, cb1[8].xyzw, r5.xyzw
mad r5.xyzw, r10.zzzz, cb1[10].xyzw, r5.xyzw
add o0.xyzw, r5.xyzw, cb1[11].xyzw
and r0.w, r4.x, l(0x0fffffff)
if_nz r0.w
  if_nz r0.w
...
add r6.xyz, r6.xyzx, -cb7[12].xyzx
mov r3.w, l(1.000000)
mov r4.w, r6.x
dp4 r0.w, r3.xyzw, r4.xyzw
mov r5.w, r6.y
dp4 r1.x, r3.xyzw, r5.xyzw
mov r7.w, r6.z
dp4 r2.w, r3.xyzw, r7.xyzw
mul r3.xyzw, r1.xxxx, cb7[1].xyzw
mad r3.xyzw, r0.wwww, cb7[0].xyzw, r3.xyzw
mad r3.xyzw, r2.wwww, cb7[2].xyzw, r3.xyzw
add o6.xyzw, r3.xyzw, cb7[3].xyzw
dp3 r0.w, -r10.xyzx, -r10.xyzx
rsq r0.w, r0.w
mul r3.xyz, r0.wwww, -r10.xyzx
dp3 r4.x, r3.xyzx, r1.yzwy
dp3 r4.y, r3.xyzx, r2.xyzx
dp3 r0.w, r3.xyzx, r0.xyzx
lt r1.x, l(0.000000), r0.w
div r3.xy, -r4.xyxx, r0.wwww
and r3.xy, r1.xxxx, r3.xyxx
...
mov r4.y, r4.x
mov r4.z, r1.x
dp2 r5.x, r4.yzyy, r3.xyxx
mov r4.x, -r1.x
dp2 r5.y, r4.xyxx, r3.xyxx
mul r3.xy, cb0[12].xyxx, cb1[69].wwww
mad r3.xy, r3.xyxx, cb0[12].zwzz, r5.xyxx
...
movc o2.xy, cb0[14].zwzz, r3.zwzz, r3.xyxx
mov o1.xyzw, v1.xyzw
mov o3.xyz, r0.xyzx
mov o4.xyz, r1.yzwy
mov o5.xyz, r2.xyzx
