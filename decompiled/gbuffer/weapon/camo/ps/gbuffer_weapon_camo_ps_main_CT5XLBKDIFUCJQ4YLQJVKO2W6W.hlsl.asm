...
// camoDetailMap                     texture  float4          2d            t17      1 
...
mul r0.x, r0.y, r3.w
sample_indexable(texture2d)(float,float,float,float) r4.xyz, r2.xyxx, t9.xyzw, s2
sample_indexable(texture2d)(float,float,float,float) r5.z, r2.xyxx, t12.yzxw, s4
sample_indexable(texture2d)(float,float,float,float) r0.y, r2.xyxx, t11.yxzw, s2
ftoi r1.w, r2.w
and r2.zw, r1.wwww, l(0, 0, 8, 2)
if_nz r2.z
  sample_indexable(texture2d)(float,float,float,float) r1.w, v1.yzyy, t16.yzwx, s2
  add r2.z, r0.y, -r1.w
  mad r0.y, r0.w, r2.z, r1.w
endif 
add r0.w, -cb0[11].x, cb0[11].y
mad r0.y, r0.y, r0.w, cb0[11].x
mul_sat r0.y, r0.y, l(0.05882353)
sample_indexable(texture2d)(float,float,float,float) r6.xyz, r2.xyxx, t10.xyzw, s3
...
sample_indexable(texture2d)(float,float,float,float) r1.yzw, r1.yzyy, t17.wxyz, s3
...
mad r7.xy, r1.yzyy, r1.xxxx, r6.xyxx
...
if_nz r2.w
  ...
  mad r6.xy, r2.xyxx, r0.zzzz, r1.xyxx
...
mad r2.xyw, r6.xyxz, r2.xxxx, r7.xyxz
...
mul r6.xyz, r3.xyzx, l(0.70710677, -1.41421354, 0.70710677, 0.000000)
