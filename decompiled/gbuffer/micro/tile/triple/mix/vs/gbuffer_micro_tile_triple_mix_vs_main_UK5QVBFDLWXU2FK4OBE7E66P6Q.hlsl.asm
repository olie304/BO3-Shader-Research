...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:31:30 2021
//
//
// Buffer Definitions: 
//
...
rsq r0.z, r0.z
mul o4.xyz, r0.zzzz, r6.xyzx
mad r6.xyz, v4.xyzx, l(2.001957, 2.001957, 2.001957, 0.000000), l(-1.00195694, -1.00195694, -1.00195694, 0.000000)
dp3 r7.x, r6.xyzx, r1.xyzx
dp3 r7.y, r6.xyzx, r3.xyzx
dp3 r7.z, r6.xyzx, r4.xyzx
dp3 r0.z, r7.xyzx, r7.xyzx
rsq r0.z, r0.z
mul o5.xyz, r0.zzzz, r7.xyzx
mul r7.xyz, r5.zxyz, r6.yzxy
mad r5.xyz, r5.yzxy, r6.zxyz, -r7.xyzx
mad r0.z, v4.w, l(2.000000), l(-1.000000)
