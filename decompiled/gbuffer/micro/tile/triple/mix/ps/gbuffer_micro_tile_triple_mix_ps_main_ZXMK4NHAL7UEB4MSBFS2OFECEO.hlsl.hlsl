  ...
  out float2 o3 : SV_TARGET3)
{
  ...
  r2.z = mixMap.Sample(mixSampler_s, r2.zw).x;
  r2.w = saturate(alphaRevealRamp1);
  r4.xy = saturate(v1.xy * float2(0.998000026,0.998000026) + float2(0.00100000005,0.00100000005));
  r4.zw = log2(r4.xy);
  ...
  r2.w = r5.z * r2.w;
  r5.y = exp2(r2.w);
  r4.xz = saturate(alphaRevealSoftEdge1 * r5.xy + r4.xx);
  r2.z = -r4.x + r2.z;
  r2.w = r4.z + -r4.x;
  ...
  r5.xyz = float3(-1,-1,-1) + colorTint2.xyz;
  r5.xyz = r3.www * r5.xyz + float3(1,1,1);
  r3.xyz = r3.xyz * r5.xyz + -r0.xyz;
  ...
  r0.w = exp2(r2.w);
  r5.x = -r0.w;
  r4.xy = saturate(alphaRevealSoftEdge2 * r5.xy + r4.yy);
  r0.w = r4.y + -r4.x;
  r4.yz = mixScale1.xy * v2.xy;
  r2.w = mixMap1.Sample(mixSampler_s, r4.yz).x;
  r2.w = r2.w + -r4.x;
