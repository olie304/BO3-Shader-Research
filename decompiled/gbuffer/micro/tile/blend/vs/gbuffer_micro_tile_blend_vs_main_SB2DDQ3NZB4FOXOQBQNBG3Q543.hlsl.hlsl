...
r1.z = modelInstanceBuffer[]..swiz;
  ...
  r0.w = r0.z * 0.899999976 + r1.x;
  r0.w = 0.0700000003 * r0.w;
  r0.w = sin(r0.w);
  r0.w = r0.w * 0.5 + 0.5;
  r1.w = gameTime.w * weather.windSpeed + 0.5;
  r2.x = r1.w * 0.699999988 + r1.y;
  o3.xyz = frac(r1.xyz);
  r1.x = 0.0700000003 * r2.x;
  r1.x = cos(r1.x);
  r0.w = r1.x * 0.5 + r0.w;
  r0.w = 0.5 + r0.w;
  r0.w = 0.5 * r0.w;
  r0.x = r0.x * r0.w;
  r1.xy = vertexColorScale.xy * v1.xy;
  r0.x = r1.x * r0.x;
// Known bad code for instruction (needs manual fix):
...
r5.w = modelInstanceBuffer[]..swiz;
  ...
  r0.y = r0.z * 0.899999976 + r3.x;
  r0.y = 0.699999988 * r0.y;
  r0.y = sin(r0.y);
  r0.z = r1.w * 0.699999988 + r3.x;
  ...
  r1.z = r1.z * r1.w;
  r6.z = r1.z * r1.y;
  r1.zw = weather.windSpeed * weather.windDirSin;
  r0.yz = r1.zw * r0.yz;
  r6.xy = r0.yz * r1.yy;
