...
cbuffer _Globals : register(b0)
{
  ...
  float3 backlightScatterColor : packoffset(c11);
  float2 mixScale : packoffset(c12);
  float detailScaleHeight1 : packoffset(c12.z);
  float detailScaleHeight2 : packoffset(c12.w);
  ...
  out float2 o3 : SV_TARGET3)
{
  ...
  r4.yzw = r5.xyz * r4.yzw + -r3.xyz;
  r3.xyz = r0.xxx * r4.yzw + r3.xyz;
  ...
  r4.w = r3.w * detailScaleHeight2 + r0.w;
  ...
  if (r1.w != 0) {
    ...
    r7.xyz = r6.xxx ? float3(1,0,1) : r3.xyz;
    r6.xyw = r6.yyy ? float3(0,1,1) : r3.xyz;
    r6.xyw = r2.yyy ? r7.xyz : r6.xyw;
    r7.xyz = r6.zzz ? float3(0,1,0) : r3.xyz;
    r3.xyz = r2.xxx ? r6.xyw : r7.xyz;
  }
  ...
  r0.x = thicknessMap.Sample(colorSampler_s, v2.xy).x;
  r0.x = 1 + -r0.x;
  r1.yzw = backlightScatterColor.xyz * r2.xyw;
  r0.y = r1.w * r0.x;
  r5.zw = v7.xy / v7.ww;
  r6.xy = float2(0.5,0.5) * renderTargetSize.xy;
  r7.x = r6.x * r5.z;
  r7.y = -r6.y * r5.w;
  r5.zw = renderTargetSize.xy * float2(0.5,0.5) + r7.xy;
  r5.zw = v0.xy + -r5.zw;
  r0.z = r5.x + r5.y;
  r0.z = r4.z * r1.x + r0.z;
  r0.z = 0.5 * r0.z;
  r4.xyz = r4.xyz * r1.xxx + -r0.zzz;
  r1.x = max(r4.y, r4.z);
  r1.x = max(r4.x, r1.x);
  r0.z = max(r1.x, r0.z);
  r1.x = cmp(r0.z == r4.x);
  ...
  r6.x = 1;
  r3.x = 0;
  r3.xyzw = r1.xxxx ? r6.xyzw : r3.xyzw;
  r0.z = r1.x ? r1.w : r0.z;
  r1.x = cmp(r0.z == r4.y);
  r6.yzw = float3(-1,1,-1) * r3.yzw;
  r1.w = 2 + r0.z;
  ...
  r0.z = rsqrt(r0.z);
  r1.xw = r3.yz * r0.zz;
  o1.xy = r1.xw * float2(0.588235319,0.588235319) + float2(0.5,0.5);
