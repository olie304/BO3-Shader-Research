...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:30:44 2021
//
//
// Buffer Definitions: 
//
...
sample_indexable(texture2d)(float,float,float,float) r5.xyz, r5.xyxx, t34.xyzw, s2
...
dp3_sat r3.w, r12.xyzx, cb2[39].yzwy
log r3.w, r3.w
mul r3.w, r3.w, cb0[18].w
exp r3.w, r3.w
add r3.w, r3.w, -cb0[18].z
add r5.w, -cb0[18].z, l(1.000000)
max r5.w, r5.w, l(0.000100)
div_sat r3.w, r3.w, r5.w
...
sample_indexable(texture2d)(float,float,float,float) r3.w, r4.xyxx, t39.yzwx, s1
sample_indexable(texture2d)(float,float,float,float) r13.xyz, r4.xyxx, t40.xyzw, s1
sample_indexable(texture2d)(float,float,float,float) r4.x, r4.xyxx, t41.xyzw, s2
dp3_sat r4.y, r12.xyzx, cb2[40].xyzx
log r4.y, r4.y
mul r4.y, r4.y, cb0[19].y
exp r4.y, r4.y
add r4.y, r4.y, -cb0[19].x
add r4.z, -cb0[19].x, l(1.000000)
max r4.z, r4.z, l(0.000100)
div_sat r4.y, r4.y, r4.z
mul r2.y, r2.y, r4.y
mad r4.yzw, r6.xxyz, cb2[41].xxyz, -r3.xxyz
mad r3.xyz, r2.zzzz, r4.yzwy, r3.xyzx
mad r4.yzw, r13.xxyz, cb2[42].xxyz, -r3.xxyz
mad r3.xyz, r2.yyyy, r4.yzwy, r3.xyzx
...
mad r7.w, r1.w, cb0[11].z, r0.z
mad r1.xy, r4.zwzz, cb0[11].wwww, r0.xyxx
dp3 r1.w, r1.xyzx, r1.xyzx
rsq r1.w, r1.w
mul r5.xyz, r1.wwww, r1.xyzx
mad r5.w, r3.w, cb0[11].w, r0.z
mad r1.w, r4.x, l(1.99218750), l(-1.000000)
mul r3.w, r4.x, r4.x
mul r3.w, r3.w, l(0.33333334)
min r3.w, r3.w, l(1.000000)
mad r1.xy, r1.wwww, cb0[15].zzzz, r0.xyxx
dp3 r0.x, r1.xyzx, r1.xyzx
rsq r0.x, r0.x
mul r1.xyz, r0.xxxx, r1.xyzx
mad r1.w, r3.w, cb0[15].z, r0.z
add r5.xyzw, -r7.xyzw, r5.xyzw
mad r5.xyzw, r2.zzzz, r5.xyzw, r7.xyzw
add r1.xyzw, r1.xyzw, -r5.xyzw
mad r1.xyzw, r2.yyyy, r1.xyzw, r5.xyzw
mul r0.x, r0.w, l(-17.000000)
exp r0.x, r0.x
add r0.x, r0.x, r1.w
log r0.x, r0.x
mul_sat r0.x, r0.x, l(-0.05882353)
mul r0.yzw, r1.yyyy, r11.xxyz
mad r0.yzw, r10.xxyz, r1.xxxx, r0.yyzw
mad r0.yzw, r9.xxyz, r1.zzzz, r0.yyzw
