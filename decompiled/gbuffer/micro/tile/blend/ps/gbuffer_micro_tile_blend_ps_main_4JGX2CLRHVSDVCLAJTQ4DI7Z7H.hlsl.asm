...
//   float2 revealScale;                // Offset:  180 Size:     8
//   float2 mixScale;                   // Offset:  192 Size:     8 [unused]
...
sample_indexable(texture2d)(float,float,float,float) r4.xyz, r2.xwxx, t9.xyzw, s2
...
mad r1.xyz, r2.xzwx, r1.xxxx, -r0.zzzz
max r1.w, r1.z, r1.y
max r1.w, r1.w, r1.x
max r0.z, r0.z, r1.w
eq r1.x, r0.z, r1.x
