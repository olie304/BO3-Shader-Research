  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r3.xyz = detailMap1.Sample(normalSampler_s, r3.xy).xyz;
  ...
  r7.y = r6.x;
  r7.z = r5.x;
  r5.x = dot(r1.yz, r7.yz);
  r5.y = dot(r1.yz, r7.xy);
  r3.zw = v2.yx + r5.xy;
  r3.zw = r3.zw + r1.ww;
  r3.zw = detailScale2.xy * r3.zw;
  r5.xy = float2(0.5,0.5) + r5.xy;
  r5.xy = detailScale2.xy * r5.xy;
  r3.zw = useUVOffsets1 ? r3.zw : r5.xy;
  r5.xyzw = colorMapDetail2.Sample(colorSampler_s, r3.zw).xyzw;
  r6.xyz = float3(-1,-1,-1) + colorTint1.xyz;
  r6.xyz = r5.www * r6.xyz + float3(1,1,1);
  r7.xyz = detailMap2.Sample(normalSampler_s, r3.zw).xyz;
  sincos(rotateUVs3, r8.x, r9.x);
  r10.x = -r8.x;
  r10.y = r9.x;
  r10.z = r8.x;
  r8.x = dot(r1.yz, r10.yz);
  r8.y = dot(r1.yz, r10.xy);
  r1.yz = v2.yx + r8.xy;
  r1.yz = r1.yz + r1.ww;
  r1.yz = detailScale3.xy * r1.yz;
  r3.zw = float2(0.5,0.5) + r8.xy;
  r3.zw = detailScale3.xy * r3.zw;
  r1.yz = useUVOffsets3 ? r1.yz : r3.zw;
  r8.xyzw = colorMapDetail3.Sample(colorSampler_s, r1.yz).xyzw;
  r9.xyz = float3(-1,-1,-1) + colorTint2.xyz;
  r9.xyz = r8.www * r9.xyz + float3(1,1,1);
  r1.yzw = detailMap3.Sample(normalSampler_s, r1.yz).xyz;
  r5.xyz = r5.xyz * r6.xyz + -r4.xyz;
  r4.xyz = r0.xxx * r5.xyz + r4.xyz;
  r5.xyz = r8.xyz * r9.xyz + -r4.xyz;
  ...
  r5.xy = r7.xy * float2(1.9921875,1.9921875) + float2(-1,-1);
  r5.z = r7.z * r7.z;
  ...
  r6.w = r2.w * detailScaleHeight1 + r1.x;
  ...
  r1.w = min(1, r1.w);
  r2.xy = r1.yz * useUVOffsets1 + r0.zw;
  r0.z = dot(r2.xyz, r2.xyz);
  r0.z = rsqrt(r0.z);
  r2.xyz = r2.xyz * r0.zzz;
  r2.w = r1.w * useUVOffsets1 + r1.x;
  ...
  r3.xyw = r7.xyz * r0.yyy;
  r3.xyw = r6.xyz * r0.xxx + r3.xyw;
  r0.xyz = r5.xyz * r0.zzz + r3.xyw;
  r1.z = dot(r0.xyz, r0.xyz);
  r1.z = rsqrt(r1.z);
  r0.xyz = r1.zzz * r0.xyz;
  r1.z = debugGlossOverride.x * r3.z + glossRange.x;
  ...
  if (r1.w != 0) {
    ...
    r6.xyz = r3.yyy ? float3(1,0,1) : r4.xyz;
    r7.xyz = r3.zzz ? float3(0,1,1) : r4.xyz;
    r3.xyz = r3.xxx ? r6.xyz : r7.xyz;
    r6.xyz = r3.www ? float3(0,1,0) : r4.xyz;
    r4.xyz = r2.www ? r3.xyz : r6.xyz;
  }
  r3.xyz = debugColorOverride.xyz + -r4.xyz;
  o0.xyz = debugColorOverride.www * r3.xyz + r4.xyz;
  ...
  r1.z = debugOcclusionOverride.x + -r4.w;
  o2.z = debugOcclusionOverride.w * r1.z + r4.w;
