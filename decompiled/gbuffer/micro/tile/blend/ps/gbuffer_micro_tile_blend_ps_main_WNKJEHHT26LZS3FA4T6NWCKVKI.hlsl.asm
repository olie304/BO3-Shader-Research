...
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r0.xyxx, t16.xyzw, s1
...
mad_sat r1.z, v1.x, l(0.998000), l(0.001000)
log r2.w, r1.z
add r1.z, -r1.z, l(1.000000)
mov_sat r3.x, cb0[11].w
mul r2.w, r2.w, r3.x
exp r2.w, r2.w
mov r4.x, -r2.w
log r2.w, r1.z
mul r2.w, r2.w, r3.x
exp r4.y, r2.w
mad_sat r3.xy, cb0[11].zzzz, r4.xyxx, r1.zzzz
mul r3.zw, v2.xxxy, cb0[12].xxxy
sample_indexable(texture2d)(float,float,float,float) r1.z, r3.zwzz, t11.yzxw, s5
add r1.z, -r3.x, r1.z
add r2.w, -r3.x, r3.y
div_sat r1.z, r1.z, r2.w
mad r1.xyw, r1.zzzz, r2.xyxz, r1.xyxw
sample_indexable(texture2d)(float,float,float,float) r2.x, r0.xyxx, t17.xyzw, s2
sample_indexable(texture2d)(float,float,float,float) r2.y, r0.zwzz, t6.yxzw, s2
add r2.z, -r2.y, r2.x
mad r2.z, r1.z, r2.z, r2.y
add r2.z, -r2.z, l(1.000000)
mul o0.xyz, r1.xywx, r2.zzzz
mov o0.w, l(1.000000)
sample_indexable(texture2d)(float,float,float,float) r1.x, r0.xyxx, t15.xyzw, s2
sample_indexable(texture2d)(float,float,float,float) r3.xyz, r0.xyxx, t14.xyzw, s3
add r0.x, -cb0[16].x, cb0[16].y
mad r0.x, r1.x, r0.x, cb0[16].x
mul_sat r0.x, r0.x, l(0.05882353)
sample_indexable(texture2d)(float,float,float,float) r0.y, r0.zwzz, t9.yxzw, s2
sample_indexable(texture2d)(float,float,float,float) r1.xyw, r0.zwzz, t12.xywz, s3
...
mad r4.w, r0.y, cb0[13].y, r2.z
mul r0.y, r1.w, r1.w
mad r1.xy, r1.xyxx, l(1.99218750, 1.99218750, 0.000000, 0.000000), l(-1.000000, -1.000000, 0.000000, 0.000000)
mad r5.xy, r1.xyxx, cb0[13].xxxx, r3.xyxx
mul r0.y, r0.y, l(0.33333334)
min r0.y, r0.y, l(1.000000)
mad r6.w, r0.y, cb0[13].x, r2.z
mad r7.xy, r0.zwzz, cb0[13].yyyy, r3.xyxx
...
rsq r1.x, r1.x
mul r1.xyw, r1.xxxx, v5.xyxz
mul r1.xyw, r0.wwww, r1.xyxw
mad r0.xyz, r1.xywx, r3.xxxx, r0.xyzx
dp3 r1.x, v4.xyzx, v4.xyzx
rsq r1.x, r1.x
mul r1.xyw, r1.xxxx, v4.xyxz
mul r3.xyw, r0.wwww, r1.xyxw
mad r0.xyz, r3.xywx, r3.zzzz, r0.xyzx
add r2.z, r3.y, r3.x
mad r2.z, r1.w, r0.w, r2.z
...
mov r4.x, l(1)
mov r3.x, l(0)
mad r0.xyz, r1.xywx, r0.wwww, -r2.zzzz
max r0.w, r0.z, r0.y
max r0.w, r0.w, r0.x
max r0.w, r0.w, r2.z
eq r0.x, r0.w, r0.x
...
eq r0.x, r0.x, r0.z
mov r4.x, l(3)
movc r0.xyzw, r0.xxxx, r4.xyzw, r3.xyzw
add r1.x, r0.z, r0.y
add r3.z, r0.w, r1.x
mad r3.x, -r0.z, l(3.000000), r3.z
add r3.y, -r0.y, r0.w
utof r0.x, r0.x
mul o1.w, r0.x, l(0.33333334)
mul r0.xyz, r3.xyzx, l(0.40824831, 0.70710677, 0.57735026, 0.000000)
...
add r1.xyw, cb0[10].xyxz, l(-0.040000, -0.040000, 0.000000, -0.040000)
