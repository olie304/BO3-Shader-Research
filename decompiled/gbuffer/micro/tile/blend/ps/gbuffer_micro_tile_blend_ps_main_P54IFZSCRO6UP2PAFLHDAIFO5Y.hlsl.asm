...
sample_indexable(texture2d)(float,float,float,float) r0.x, v2.xyxx, t9.xyzw, s1
...
mul r7.x, r4.z, r6.x
mul r7.y, r4.w, -r6.y
mad r4.zw, cb1[44].xxxy, l(0.000000, 0.000000, 0.500000, 0.500000), r7.xxxy
...
max r0.z, r0.z, r1.x
eq r1.x, r0.z, r2.x
mul r6.yzw, r5.yyzw, l(0.000000, 1.000000, -1.000000, -1.000000)
add r1.w, r0.z, l(2.000000)
mov r6.x, l(1)
mov r5.x, l(0)
movc r5.xyzw, r1.xxxx, r6.xyzw, r5.xyzw
...
mov r2.x, l(3)
movc r2.xyzw, r0.zzzz, r2.xyzw, r5.xyzw
add r0.z, r2.z, r2.y
add r5.z, r2.w, r0.z
add r5.y, -r2.y, r2.w
mad r5.x, -r2.z, l(3.000000), r5.z
mul r2.yzw, r5.xxyz, l(0.000000, 0.40824831, 0.70710677, 0.57735026)
