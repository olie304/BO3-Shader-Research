...
sample_indexable(texture2d)(float,float,float,float) r0.x, r0.xyxx, t16.xyzw, s5
sample_indexable(texture2d)(float,float,float,float) r0.yzw, v1.yzyy, t7.wxyz, s3
...
movc r2.yz, cb0[16].yyyy, r2.yyzy, r5.yyzy
sample_indexable(texture2d)(float,float,float,float) r6.xyzw, r2.yzyy, t15.xyzw, s1
add r5.yzw, cb0[14].xxyz, l(0.000000, -1.000000, -1.000000, -1.000000)
...
sample_indexable(texture2d)(float,float,float,float) r6.w, r2.yzyy, t14.yzwx, s2
sample_indexable(texture2d)(float,float,float,float) r8.xyz, r2.yzyy, t12.xyzw, s3
...
mad r6.w, r5.x, cb0[12].x, r0.w
mad r1.xy, r5.yzyy, cb0[12].yyyy, r0.yzyy
dp3 r0.y, r1.xyzx, r1.xyzx
rsq r0.y, r0.y
mul r5.xyz, r0.yyyy, r1.xyzx
mad r5.w, r3.w, cb0[12].y, r0.w
...
rsq r1.z, r1.z
mul r7.xyz, r1.zzzz, v4.xyzx
mul r7.xyz, r1.xxxx, r7.xyzx
dp3 r1.z, v5.xyzx, v5.xyzx
rsq r1.z, r1.z
mul r8.xyz, r1.zzzz, v5.xyzx
