...
movc r2.xy, cb0[15].yyyy, r2.xyxx, r2.zwzz
...
sample_indexable(texture2d)(float,float,float,float) r4.xyz, v2.xyxx, t6.xyzw, s3
...
mad r4.xy, r0.zwzz, cb0[11].zzzz, r2.zwzz
...
dp3_sat r0.w, r7.xyzx, cb2[39].yzwy
log r0.w, r0.w
mul r0.w, r0.w, cb0[16].y
exp r0.w, r0.w
add r0.w, r0.w, -cb0[16].x
...
mov r4.x, l(1)
mov r3.x, l(0)
movc r2.xyzw, r1.xxxx, r4.xyzw, r3.xyzw
mul r3.yzw, r2.yyzw, l(0.000000, -1.000000, 1.000000, -1.000000)
add r4.x, r0.z, l(2.000000)
movc r0.z, r1.x, r4.x, r0.z
eq r1.x, r0.z, r1.y
mov r3.x, l(2)
...
mad r0.z, r0.w, r0.z, cb0[14].x
add r0.w, -cb0[10].y, cb0[10].z
mad r0.y, r0.y, r0.w, cb0[10].y
