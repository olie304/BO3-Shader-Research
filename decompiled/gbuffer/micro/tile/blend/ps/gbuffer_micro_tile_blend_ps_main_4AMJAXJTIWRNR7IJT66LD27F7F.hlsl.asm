...
sample_indexable(texture2d)(float,float,float,float) r1.xyzw, r0.yzyy, t12.xyzw, s3
...
sample_indexable(texture2d)(float,float,float,float) r3.xyz, v2.xyxx, t9.xyzw, s1
...
sample_indexable(texture2d)(float,float,float,float) r6.xyz, r4.xwxx, t7.xyzw, s2
...
sample_indexable(texture2d)(float,float,float,float) r6.xyzw, r0.yzyy, t11.xyzw, s1
...
mul_sat r4.y, cb0[14].y, l(0.05882353)
add r4.y, -r3.w, r4.y
mad r3.w, r0.x, r4.y, r3.w
...
mad r4.w, r1.w, cb0[11].z, r1.z
mad r2.xy, r0.yzyy, cb0[11].wwww, r1.xyxx
dp3 r0.y, r2.xyzx, r2.xyzx
rsq r0.y, r0.y
mul r5.xyz, r0.yyyy, r2.xyzx
mad r5.w, r0.w, cb0[11].w, r1.z
add r1.xyzw, -r4.xyzw, r5.xyzw
mad r0.xyzw, r0.xxxx, r1.xyzw, r4.xyzw
...
if_nz r1.w
  ...
  movc r3.xyz, r2.wwww, r5.xywx, r6.xyzx
endif 
