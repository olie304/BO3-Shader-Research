  ...
  out float2 o3 : SV_TARGET3)
{
  ...
  r0.zw = useUVOffsets1 ? r2.xy : r2.zw;
  ...
  r0.xy = r0.xy + r1.zz;
  r3.xyzw = colorMapTile2.xyxy * r0.xyzw;
  r0.xyzw = detailScale2.xyxy * r0.xyzw;
  r0.xy = useUVOffsets1 ? r0.xy : r0.zw;
  r0.xyz = detailMap2.Sample(normalSampler_s, r0.xy).xyz;
  r3.xy = useUVOffsets1 ? r3.xy : r3.zw;
  r3.xyzw = colorMapDetail2.Sample(colorSampler_s, r3.xy).xyzw;
  ...
  r1.z = mixMap.Sample(mixSampler_s, r4.xy).x;
  r2.w = saturate(-levelsControls.x + r1.z);
  r4.xy = levelsControls.yw + -levelsControls.xz;
  r3.w = max(9.99999975e-05, r4.x);
  r2.w = r2.w / r3.w;
  r2.w = min(1, r2.w);
  r2.w = r2.w * r4.y + levelsControls.z;
  r0.w = r0.w ? r1.z : r2.w;
  r2.xyz = r0.www * r3.xyz + r2.xyz;
  o0.xyz = v1.xyz * r2.xyz;
  o0.w = 1;
  r0.z = r0.z * r0.z;
