...
add r3.xw, r4.xxxy, v3.yyyx
add r1.w, v3.z, l(0.500000)
add r3.xw, r1.wwww, r3.xxxw
...
sample_indexable(texture2d)(float,float,float,float) r2.w, r3.xwxx, t7.yzwx, s2
sample_indexable(texture2d)(float,float,float,float) r5.xyz, r3.xwxx, t10.xyzw, s3
...
add r3.yz, r5.xxyx, v3.yyxy
add r3.yz, r1.wwww, r3.yyzy
mul r3.yz, r3.yyzy, cb0[6].xxyx
add r5.xy, r5.xyxx, l(0.500000, 0.500000, 0.000000, 0.000000)
mul r5.xy, r5.xyxx, cb0[6].xyxx
movc r3.yz, cb0[15].yyyy, r3.yyzy, r5.xxyx
sample_indexable(texture2d)(float,float,float,float) r5.xyzw, r3.yzyy, t15.xyzw, s1
...
sample_indexable(texture2d)(float,float,float,float) r1.w, r3.yzyy, t14.yzwx, s2
sample_indexable(texture2d)(float,float,float,float) r7.xyz, r3.yzyy, t12.xyzw, s3
...
mad r2.w, r2.w, r3.y, cb0[10].y
mul_sat r2.w, r2.w, l(0.05882353)
add r3.z, -cb0[14].x, cb0[14].y
mad r1.w, r1.w, r3.z, cb0[14].x
mul_sat r1.w, r1.w, l(0.05882353)
add r1.w, -r2.w, r1.w
mad r1.w, r0.x, r1.w, r2.w
sample_indexable(texture2d)(float,float,float,float) r2.w, v2.xyxx, t9.yzwx, s4
mad r4.xy, r7.xyxx, l(1.99218750, 1.99218750, 0.000000, 0.000000), l(-1.000000, -1.000000, 0.000000, 0.000000)
mul r3.z, r7.z, r7.z
mul r3.z, r3.z, l(0.33333334)
min r3.z, r3.z, l(1.000000)
mad r1.xy, r3.xwxx, cb0[11].zzzz, r0.yzyy
dp3 r3.x, r1.xyzx, r1.xyzx
rsq r3.x, r3.x
mul r5.xyz, r1.xyzx, r3.xxxx
mad r5.w, r4.w, cb0[11].z, r0.w
mad r1.xy, r4.xyxx, cb0[11].wwww, r0.yzyy
dp3 r0.y, r1.xyzx, r1.xyzx
rsq r0.y, r0.y
mul r4.xyz, r0.yyyy, r1.xyzx
mad r4.w, r3.z, cb0[11].w, r0.w
...
rsq r1.y, r1.y
mul r3.xzw, r1.yyyy, v4.xxyz
mul r4.xyz, r1.xxxx, r3.xzwx
...
if_nz r1.w
  ...
  movc r2.xyz, r3.yyyy, r5.xywx, r6.xyzx
endif 
