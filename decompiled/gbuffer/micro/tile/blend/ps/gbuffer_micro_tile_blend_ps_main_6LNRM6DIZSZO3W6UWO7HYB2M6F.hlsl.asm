...
mul r13.xy, v1.yzyy, cb0[18].xyxx
...
sample_indexable(texture2d)(float,float,float,float) r1.w, v1.yzyy, t9.yzwx, s4
...
mad r1.xyz, v3.xyzx, r2.wwww, -r0.yzwy
