  ...
  out float2 o3 : SV_TARGET3)
{
  ...
  r0.x = 1 + -r0.x;
  r1.yzw = backlightScatterColor.xyz * r3.xyz;
  r0.y = r1.w * r0.x;
  r4.zw = v6.xy / v6.ww;
  r6.xy = float2(0.5,0.5) * renderTargetSize.xy;
  r7.x = r6.x * r4.z;
  r7.y = -r6.y * r4.w;
  r4.zw = renderTargetSize.xy * float2(0.5,0.5) + r7.xy;
  r4.zw = v0.xy + -r4.zw;
  r0.z = r4.x + r4.y;
  r0.z = r2.w * r1.x + r0.z;
  r0.z = 0.5 * r0.z;
  r2.xyz = r2.xzw * r1.xxx + -r0.zzz;
  r1.x = max(r2.y, r2.z);
  r1.x = max(r2.x, r1.x);
  r0.z = max(r1.x, r0.z);
  r1.x = cmp(r0.z == r2.x);
  ...
  r2.x = 3;
  r2.xyzw = r0.zzzz ? r2.xyzw : r5.xyzw;
  r0.z = r2.y + r2.z;
  r5.z = r0.z + r2.w;
  r5.y = r2.w + -r2.y;
  r5.x = -r2.z * 3 + r5.z;
  r2.yzw = float3(0.408248305,0.707106769,0.577350259) * r5.xyz;
  r0.z = 1 + abs(r2.w);
  r0.z = rsqrt(r0.z);
  r1.xw = r2.yz * r0.zz;
  ...
  r0.zw = float2(0.100000001,0.100000001) * abs(r4.zw);
  r0.zw = min(float2(1,1), r0.zw);
  r0.zw = r0.zw + -r0.xy;
  r0.xy = r0.zw * float2(0.5,0.5) + r0.xy;
  r0.zw = cmp(r4.zw >= float2(0,0));
