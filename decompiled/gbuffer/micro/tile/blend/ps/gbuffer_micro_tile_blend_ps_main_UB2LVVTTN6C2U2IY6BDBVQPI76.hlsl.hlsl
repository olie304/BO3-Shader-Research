...
Texture2D<float4> glossMapDetail2 : register(t15);
Texture2D<float4> colorMapDetail2 : register(t16);
  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r2.w = r3.x * r2.w;
  r4.y = exp2(r2.w);
  r3.xy = saturate(alphaRevealSoftEdge * r4.xy + r1.zz);
  r3.zw = revealScale.xy * v2.xy;
  r1.z = revealMap.Sample(revealSampler_s, r3.zw).x;
  r1.z = r1.z + -r3.x;
  r2.w = r3.y + -r3.x;
