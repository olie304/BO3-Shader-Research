...
movc r1.xy, cb0[15].xxxx, r2.xyxx, r2.zwzz
...
mul r2.zw, r0.xxxy, cb0[16].xxxy
mul r0.xy, r0.xyxx, cb0[6].xyxx
mul r3.xy, r2.xyxx, cb0[16].xyxx
mul r2.xy, r2.xyxx, cb0[6].xyxx
movc r0.xy, cb0[15].yyyy, r0.xyxx, r2.xyxx
movc r2.xy, cb0[15].yyyy, r2.zwzz, r3.xyxx
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r2.xyxx, t14.xyzw, s1
...
eq r3.xyzw, cb0[17].xyzw, l(0.000000, 1.000000, 0.000000, 1.000000)
and r1.z, r3.y, r3.x
and r1.z, r3.z, r1.z
and r1.z, r3.w, r1.z
mul r3.xy, v2.xyxx, cb0[11].xyxx
sample_indexable(texture2d)(float,float,float,float) r2.w, r3.xyxx, t15.yzwx, s5
add_sat r3.x, r2.w, -cb0[17].x
add r3.yz, -cb0[17].xxzx, cb0[17].yywy
max r3.y, r3.y, l(0.000100)
div r3.x, r3.x, r3.y
min r3.x, r3.x, l(1.000000)
mad r3.x, r3.x, r3.z, cb0[17].z
movc r1.z, r1.z, r2.w, r3.x
