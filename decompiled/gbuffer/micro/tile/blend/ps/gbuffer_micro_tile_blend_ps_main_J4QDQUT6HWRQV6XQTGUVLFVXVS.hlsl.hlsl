...
cbuffer _Globals : register(b0)
{
  ...
  float2 colorMapTile1 : packoffset(c15.z);
  float2 colorMapTile2 : packoffset(c16);
...
Texture2D<float4> glossMapDetail2 : register(t12);
  ...
  out float2 o3 : SV_TARGET3)
{
  ...
  r1.w = 0.5 + v3.z;
  r2.xw = r2.xw + r1.ww;
  r3.zw = detailScale1.xy * r2.xw;
  r3.xy = float2(0.5,0.5) + r3.xy;
  r4.xy = detailScale1.xy * r3.xy;
  r3.zw = useUVOffsets1 ? r3.zw : r4.xy;
  r2.xw = useUVOffsets1 * r2.xw;
  r3.xy = useUVOffsets1 * r3.xy;
  r2.xw = useUVOffsets1 ? r2.xw : r3.xy;
  r4.xyzw = colorMap.Sample(colorSampler_s, r2.xw).xyzw;
  r5.xyz = float3(-1,-1,-1) + colorTint.xyz;
  r5.xyz = r4.www * r5.xyz + float3(1,1,1);
  r4.xyz = r5.xyz * r4.xyz;
  r2.x = glossMap.Sample(specColorSampler_s, r3.zw).x;
  r3.xyz = detailMap1.Sample(normalSampler_s, r3.zw).xyz;
  ...
  r2.yz = v3.yx + r5.xy;
  r2.yz = r2.yz + r1.ww;
  r3.zw = detailScale2.xy * r2.yz;
  r5.xy = float2(0.5,0.5) + r5.xy;
  r5.zw = detailScale2.xy * r5.xy;
  r3.zw = useUVOffsets1 ? r3.zw : r5.zw;
  r2.yz = colorMapTile2.xy * r2.yz;
  r5.xy = colorMapTile2.xy * r5.xy;
  r2.yz = useUVOffsets1 ? r2.yz : r5.xy;
  ...
  r1.w = glossMapDetail2.Sample(specColorSampler_s, r3.zw).x;
  r7.xyz = detailMap2.Sample(normalSampler_s, r3.zw).xyz;
  ...
  r6.xyz = r6.xyz * r0.xxx + r7.xyz;
  r0.xyz = r5.xyz * r0.zzz + r6.xyz;
  r1.z = dot(r0.xyz, r0.xyz);
  r1.z = rsqrt(r1.z);
  r0.xyz = r1.zzz * r0.xyz;
  r1.z = debugGlossOverride.x * r2.y + glossRange.x;
  ...
  if (r1.w != 0) {
    ...
    r7.xyz = r6.xxx ? float3(1,0,1) : r4.xyz;
    r6.xyw = r6.yyy ? float3(0,1,1) : r4.xyz;
    r6.xyw = r2.zzz ? r7.xyz : r6.xyw;
    r7.xyz = r6.zzz ? float3(0,1,0) : r4.xyz;
    r4.xyz = r2.yyy ? r6.xyw : r7.xyz;
  }
  r2.yzw = debugColorOverride.xyz + -r4.xyz;
  o0.xyz = debugColorOverride.www * r2.yzw + r4.xyz;
  ...
  r1.z = debugOcclusionOverride.x + -r2.x;
  o2.z = debugOcclusionOverride.w * r1.z + r2.x;
  r1.yzw = v4.xyz * r1.yyy + -r0.xyz;
  r4.yzw = debugNormalOverride.www * r1.yzw + r0.xyz;
  r0.xy = v7.xy / v7.ww;
