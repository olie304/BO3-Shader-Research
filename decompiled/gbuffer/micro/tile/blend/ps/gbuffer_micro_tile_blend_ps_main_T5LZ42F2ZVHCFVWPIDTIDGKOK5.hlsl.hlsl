  ...
  out float2 o3 : SV_TARGET3)
{
  ...
  r1.w = glossMap.Sample(specColorSampler_s, r4.xw).x;
  ...
  r5.w = r2.w * detailScaleHeight1 + r1.z;
  r2.xy = r4.yz * detailScaleHeight2 + r1.xy;
  r1.x = dot(r2.xyz, r2.xyz);
  r1.x = rsqrt(r1.x);
  r2.xyz = r2.xyz * r1.xxx;
  r2.w = r1.w * detailScaleHeight2 + r1.z;
