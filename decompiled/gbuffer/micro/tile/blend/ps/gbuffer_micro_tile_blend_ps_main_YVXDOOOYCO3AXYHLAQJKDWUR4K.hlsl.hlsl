  ...
  out float2 o3 : SV_TARGET3)
{
  ...
  r4.w = saturate(dot(r11.xyz, weather.weatherVector.xyz));
  r4.w = log2(r4.w);
  r4.w = weatherHarshness * r4.w;
  r4.w = exp2(r4.w);
  r4.w = -weatherThreshold + r4.w;
  r5.w = 1 + -weatherThreshold;
  r5.w = max(9.99999975e-05, r5.w);
  r4.w = saturate(r4.w / r5.w);
  r2.yz = useUVOffsets1 * r2.yz;
  r11.xy = useUVOffsets1 * w1.xy;
  ...
  r4.z = min(1, r4.z);
  r6.w = r3.w * detailScaleHeight1 + r0.z;
  r1.xy = r4.xy * detailScaleHeight2 + r0.xy;
  r0.x = dot(r1.xyz, r1.xyz);
  r0.x = rsqrt(r0.x);
  r5.xyz = r1.xyz * r0.xxx;
  r5.w = r4.z * detailScaleHeight2 + r0.z;
  r4.xyzw = r5.xyzw + -r6.xyzw;
  ...
  r0.yzw = r10.xyz * r4.yyy;
  r0.yzw = r9.xyz * r4.xxx + r0.yzw;
  r0.yzw = r8.xyz * r4.zzz + r0.yzw;
