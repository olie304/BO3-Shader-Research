...
sample_indexable(texture2d)(float,float,float,float) r2.x, r3.zwzz, t7.xyzw, s2
sample_indexable(texture2d)(float,float,float,float) r3.xyz, r3.zwzz, t10.xyzw, s3
...
sample_indexable(texture2d)(float,float,float,float) r1.w, r3.zwzz, t12.yzwx, s2
sample_indexable(texture2d)(float,float,float,float) r7.xyz, r3.zwzz, t11.xyzw, s3
...
mad r1.w, r1.w, r2.z, cb0[14].x
mul_sat r1.w, r1.w, l(0.05882353)
add r1.w, -r2.x, r1.w
mad r1.w, r0.x, r1.w, r2.x
sample_indexable(texture2d)(float,float,float,float) r2.x, v2.xyxx, t9.xyzw, s4
mad r3.zw, r7.xxxy, l(0.000000, 0.000000, 1.99218750, 1.99218750), l(0.000000, 0.000000, -1.000000, -1.000000)
mul r2.z, r7.z, r7.z
mul r2.z, r2.z, l(0.33333334)
min r2.z, r2.z, l(1.000000)
mad r1.xy, r3.xyxx, cb0[11].zzzz, r0.yzyy
dp3 r3.x, r1.xyzx, r1.xyzx
rsq r3.x, r3.x
mul r5.xyz, r1.xyzx, r3.xxxx
mad r5.w, r2.w, cb0[11].z, r0.w
mad r1.xy, r3.zwzz, cb0[11].wwww, r0.yzyy
...
if_nz r1.w
  ...
  movc r6.xyw, r2.zzzz, r7.xyxz, r6.xyxw
  movc r7.xyz, r6.zzzz, l(0,1.000000,0,0), r4.xyzx
  movc r4.xyz, r2.yyyy, r6.xywx, r7.xyzx
endif 
add r2.yzw, -r4.xxyz, cb1[58].xxyz
mad o0.xyz, cb1[58].wwww, r2.yzwy, r4.xyzx
