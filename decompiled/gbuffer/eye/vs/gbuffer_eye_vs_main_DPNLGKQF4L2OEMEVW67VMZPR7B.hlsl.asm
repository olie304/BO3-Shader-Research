...
// TEXCOORD                13   xy         11     NONE   float   xy  
//
vs_5_0
...
mov o1.w, v1.w
mov o2.xy, v2.xyxx
add r0.yzw, v1.xxzy, l(0.000000, -0.500000, -0.500000, -0.500000)
mul r0.yzw, r0.yyzw, l(0.000000, 4.000000, 4.000000, 4.000000)
mul r1.w, v1.w, l(4.000000)
max r1.w, r1.w, l(0.000100)
div r0.yzw, r0.yyzw, r1.wwww
add r0.w, r0.w, l(-0.400000)
mad o11.xy, r0.yzyy, l(1.000000, -1.000000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
...
dp3 r9.x, r6.xyzx, r1.xyzx
dp3 r9.y, r6.xyzx, r3.xyzx
dp3 r9.z, r6.xyzx, r4.xyzx
dp3 r0.y, r9.xyzx, r9.xyzx
rsq r0.y, r0.y
mul o4.xyz, r0.yyyy, r9.xyzx
mad r9.xyz, v4.xyzx, l(2.001957, 2.001957, 2.001957, 0.000000), l(-1.00195694, -1.00195694, -1.00195694, 0.000000)
dp3 r10.x, r9.xyzx, r1.xyzx
dp3 r10.y, r9.xyzx, r3.xyzx
dp3 r10.z, r9.xyzx, r4.xyzx
dp3 r0.y, r10.xyzx, r10.xyzx
rsq r0.y, r0.y
mul o5.xyz, r0.yyyy, r10.xyzx
mul r10.xyz, r6.zxyz, r9.yzxy
mad r6.xyz, r6.yzxy, r9.zxyz, -r10.xyzx
mad r0.y, v4.w, l(2.000000), l(-1.000000)
mul r6.xyz, r0.yyyy, r6.xyzx
dp3 r1.x, r6.xyzx, r1.xyzx
dp3 r1.y, r6.xyzx, r3.xyzx
