...
mad r3.xyzw, r3.zzzz, cb1[10].xyzw, r5.xyzw
...
mad r5.xyzw, r3.xyxy, l(-1.000000, 0.000000, -1.000000, 1.000000), r4.xyxy
sample_l_indexable(texture2d)(float,float,float,float) r2.y, r5.xyxx, t6.yxzw, s1, l(0.000000)
sample_l_indexable(texture2d)(float,float,float,float) r3.z, r5.zwzz, t6.yzxw, s1, l(0.000000)
mad r5.xyzw, r3.xyxy, l(0.000000, -1.000000, 0.000000, 1.000000), r4.xyxy
sample_l_indexable(texture2d)(float,float,float,float) r3.w, r5.xyxx, t6.yzwx, s1, l(0.000000)
sample_l_indexable(texture2d)(float,float,float,float) r4.z, r5.zwzz, t6.yzxw, s1, l(0.000000)
mad r5.xyzw, r3.xyxy, l(1.000000, -1.000000, 1.000000, 0.000000), r4.xyxy
sample_l_indexable(texture2d)(float,float,float,float) r4.w, r5.xyxx, t6.yzwx, s1, l(0.000000)
...
mad r3.y, |r5.x|, l(2.000000), |r4.w|
add r3.y, |r3.x|, r3.y
add r3.y, -|r1.w|, r3.y
mad r2.y, -|r2.y|, l(2.000000), r3.y
add r2.y, -|r3.z|, r2.y
mad r3.y, |r4.z|, l(2.000000), |r3.z|
add r3.x, |r3.x|, r3.y
add r1.w, -|r1.w|, r3.x
