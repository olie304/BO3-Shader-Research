...
sample_l_indexable(texture2d)(float,float,float,float) r0.w, r3.zwzz, t6.yzwx, s1, l(0.000000)
...
sample_l_indexable(texture2d)(float,float,float,float) r3.z, r5.xyxx, t6.yzxw, s1, l(0.000000)
...
sample_l_indexable(texture2d)(float,float,float,float) r4.z, r5.xyxx, t6.yzxw, s1, l(0.000000)
sample_l_indexable(texture2d)(float,float,float,float) r4.w, r5.zwzz, t6.yzwx, s1, l(0.000000)
add r3.xy, r3.xyxx, r4.xyxx
sample_l_indexable(texture2d)(float,float,float,float) r3.x, r3.xyxx, t6.xyzw, s1, l(0.000000)
mad r3.y, |r4.w|, l(2.000000), |r4.z|
add r3.y, |r3.x|, r3.y
add r3.y, -|r0.w|, r3.y
