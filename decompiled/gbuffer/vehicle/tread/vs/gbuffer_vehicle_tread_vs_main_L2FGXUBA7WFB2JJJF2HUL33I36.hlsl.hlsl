...
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r3.xy, v7.x, l(0), t4.xyxx
r3.x = colorSampler[]..swiz;
r3.y = colorSampler[]..swiz;
  r0.w = (int)r2.x + (int)r3.x;
// Known bad code for instruction (needs manual fix):
...
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) r4.xy, r3.y, l(16), t0.xyxx
r4.x = colorSampler[]..swiz;
r4.y = colorSampler[]..swiz;
  r0.w = cmp(reverseTread != 0.000000);
  r0.w = r0.w ? r4.y : r4.x;
  r4.xy = r0.ww * scrollUVs.xy + v2.xy;
  r0.w = treadHeightMap.SampleLevel(colorSampler_s, r4.xy, 0).x;
  r0.w = treadDepth * r0.w;
  r3.xyz = r3.xzw * r0.www + r9.xyz;
  ...
  r5.xy = r4.xy + -r4.zw;
  r0.w = treadHeightMap.SampleLevel(colorSampler_s, r5.xy, 0).x;
  r5.xyzw = r4.zwzw * float4(-1,0,-1,1) + r4.xyxy;
  r1.w = treadHeightMap.SampleLevel(colorSampler_s, r5.xy, 0).x;
  r2.x = treadHeightMap.SampleLevel(colorSampler_s, r5.zw, 0).x;
  r5.xyzw = r4.zwzw * float4(0,-1,0,1) + r4.xyxy;
  r3.w = treadHeightMap.SampleLevel(colorSampler_s, r5.xy, 0).x;
  r5.x = treadHeightMap.SampleLevel(colorSampler_s, r5.zw, 0).x;
  r6.xyzw = r4.zwzw * float4(1,-1,1,0) + r4.xyxy;
  r5.y = treadHeightMap.SampleLevel(colorSampler_s, r6.xy, 0).x;
  r5.z = treadHeightMap.SampleLevel(colorSampler_s, r6.zw, 0).x;
  r4.zw = r4.xy + r4.zw;
  r4.z = treadHeightMap.SampleLevel(colorSampler_s, r4.zw, 0).x;
  r4.w = abs(r5.z) * 2 + abs(r5.y);
  r4.w = r4.w + abs(r4.z);
  r4.w = r4.w + -abs(r0.w);
  r1.w = -abs(r1.w) * 2 + r4.w;
  r1.w = r1.w + -abs(r2.x);
  r2.x = abs(r5.x) * 2 + abs(r2.x);
  r2.x = r2.x + abs(r4.z);
  r0.w = r2.x + -abs(r0.w);
  r0.w = -abs(r3.w) * 2 + r0.w;
  r0.w = r0.w + -abs(r5.y);
  r5.x = -r1.w;
  r5.y = -r0.w;
  r0.w = max(9.99999975e-05, treadDepth);
  r5.z = 1 / r0.w;
  r0.w = dot(r5.xyz, r5.xyz);
  r0.w = rsqrt(r0.w);
  r5.xyz = r5.xyz * r0.www;
  r2.xyz = r5.yyy * r2.yzw;
  ...
  r1.x = cmp(r0.x < -0.800000012);
  r0.w = (int)r0.w | (int)r1.x;
  r1.xyz = r0.www ? float3(1,0,0) : float3(0,0,1);
...
r7.y = colorSampler[]..swiz;
r7.z = colorSampler[]..swiz;
  r8.x = dot(r0.xyz, r5.xyz);
  r8.y = dot(r0.xyz, r6.xyz);
  r8.z = dot(r0.xyz, r7.xyz);
  r0.x = dot(r8.xyz, r8.xyz);
  r0.x = rsqrt(r0.x);
  o2.xyz = r8.xyz * r0.xxx;
