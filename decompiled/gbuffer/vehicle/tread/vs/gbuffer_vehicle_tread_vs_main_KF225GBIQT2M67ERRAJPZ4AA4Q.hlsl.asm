...
ne r0.w, cb0[15].y, l(0.000000)
movc r0.w, r0.w, r4.y, r4.x
mad r4.xy, r0.wwww, cb0[12].xyxx, v2.xyxx
sample_l_indexable(texture2d)(float,float,float,float) r0.w, r4.xyxx, t6.yzwx, s1, l(0.000000)
mul r0.w, r0.w, cb0[15].x
mad r3.xyz, r3.xzwx, r0.wwww, r9.xyzx
...
sample_l_indexable(texture2d)(float,float,float,float) r0.w, r5.xyxx, t6.yzwx, s1, l(0.000000)
...
sample_l_indexable(texture2d)(float,float,float,float) r2.x, r5.zwzz, t6.xyzw, s1, l(0.000000)
mad r5.xyzw, r4.zwzw, l(0.000000, -1.000000, 0.000000, 1.000000), r4.xyxy
sample_l_indexable(texture2d)(float,float,float,float) r3.w, r5.xyxx, t6.yzwx, s1, l(0.000000)
sample_l_indexable(texture2d)(float,float,float,float) r5.x, r5.zwzz, t6.xyzw, s1, l(0.000000)
mad r6.xyzw, r4.zwzw, l(1.000000, -1.000000, 1.000000, 0.000000), r4.xyxy
sample_l_indexable(texture2d)(float,float,float,float) r5.y, r6.xyxx, t6.yxzw, s1, l(0.000000)
sample_l_indexable(texture2d)(float,float,float,float) r5.z, r6.zwzz, t6.yzxw, s1, l(0.000000)
add r4.zw, r4.zzzw, r4.xxxy
sample_l_indexable(texture2d)(float,float,float,float) r4.z, r4.zwzz, t6.yzxw, s1, l(0.000000)
mad r4.w, |r5.z|, l(2.000000), |r5.y|
add r4.w, |r4.z|, r4.w
add r4.w, -|r0.w|, r4.w
mad r1.w, -|r1.w|, l(2.000000), r4.w
add r1.w, -|r2.x|, r1.w
mad r2.x, |r5.x|, l(2.000000), |r2.x|
add r2.x, |r4.z|, r2.x
add r0.w, -|r0.w|, r2.x
mad r0.w, -|r3.w|, l(2.000000), r0.w
add r0.w, -|r5.y|, r0.w
mov r5.x, -r1.w
mov r5.y, -r0.w
max r0.w, cb0[15].x, l(0.000100)
div r5.z, l(1.000000, 1.000000, 1.000000, 1.000000), r0.w
dp3 r0.w, r5.xyzx, r5.xyzx
rsq r0.w, r0.w
mul r5.xyz, r0.wwww, r5.xyzx
mul r2.xyz, r2.yzwy, r5.yyyy
...
lt r1.x, r0.x, l(-0.800000)
or r0.w, r0.w, r1.x
movc r1.xyz, r0.wwww, l(1.000000,0,0,0), l(0,0,1.000000,0)
...
dp3 r8.x, r0.xyzx, r5.xyzx
dp3 r8.y, r0.xyzx, r6.xyzx
dp3 r8.z, r0.xyzx, r7.xyzx
dp3 r0.x, r8.xyzx, r8.xyzx
rsq r0.x, r0.x
mul o2.xyz, r0.xxxx, r8.xyzx
...
mov o1.yz, r4.xxyx
ret 
// Approximately 436 instruction slots used
