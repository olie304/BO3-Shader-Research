...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:31:38 2021
//
//
// Buffer Definitions: 
//
...
if_z v7.x
  ...
  mul r0.w, r0.w, r1.w
  sample_indexable(texture2d)(float,float,float,float) r3.xyzw, v2.xyxx, t10.xyzw, s1
...
mov r6.x, l(1)
mov r4.x, l(0)
movc r4.xyzw, r1.wwww, r6.xyzw, r4.xyzw
...
add r0.xy, |r3.zwzz|, l(-10.000000, -10.000000, 0.000000, 0.000000)
mul_sat r0.xy, r0.xyxx, l(0.03333334, 0.03333334, 0.000000, 0.000000)
mul r0.zw, |r3.zzzw|, l(0.000000, 0.000000, 0.100000, 0.100000)
...
ge r0.zw, r3.zzzw, l(0.000000, 0.000000, 0.000000, 0.000000)
