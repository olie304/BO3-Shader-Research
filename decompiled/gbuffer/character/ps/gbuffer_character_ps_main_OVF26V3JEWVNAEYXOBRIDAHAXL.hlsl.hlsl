  ...
  out float2 o3 : SV_TARGET3)
{
  ...
  if (r0.w != 0) {
    ...
    r1.x = colorMap.CalculateLevelOfDetailUnclamped(colorSampler_s, v2.xy);
    r1.y = colorMap.CalculateLevelOfDetail(colorSampler_s, v2.xy);
    r1.x = cmp(r1.x < r1.y);
    r1.y = cmp(0 < r1.y);
    r2.xyz = (int3)r0.www & int3(1,2,4);
    r3.xyz = r2.xxx ? float3(1,0,1) : r0.xyz;
    r2.xyw = r2.yyy ? float3(0,1,1) : r0.xyz;
    r1.yzw = r1.yyy ? r3.xyz : r2.xyw;
    r2.xyz = r2.zzz ? float3(0,1,0) : r0.xyz;
    r0.xyz = r1.xxx ? r1.yzw : r2.xyz;
  }
  ...
  o0.xyz = debugColorOverride.www * r3.xyz + r0.xyz;
  r0.xy = debugNormalOverride.xy + -r1.xy;
  r0.xy = debugNormalOverride.ww * r0.xy + r1.xy;
  r1.xyz = debugSpecularOverride.xyz + -r2.xyz;
  r1.xyz = debugSpecularOverride.www * r1.xyz + r2.xyz;
  r0.z = debugGlossOverride.x + -r0.w;
  r0.z = debugGlossOverride.w * r0.z + r0.w;
  r0.w = debugOcclusionOverride.x + -r1.w;
  o2.z = debugOcclusionOverride.w * r0.w + r1.w;
  r2.xyz = v5.xyz * r0.yyy;
  r0.xyw = v4.xyz * r0.xxx + r2.xyz;
  r0.xyw = v3.xyz * r2.www + r0.xyw;
  r1.w = dot(r0.xyw, r0.xyw);
  r1.w = rsqrt(r1.w);
  r2.yzw = r1.www * r0.xyw;
  r3.xy = v7.xy / v7.ww;
  r3.zw = float2(0.5,0.5) * renderTargetSize.xy;
  r4.x = r3.x * r3.z;
  r4.y = r3.y * -r3.w;
  r3.xy = renderTargetSize.xy * float2(0.5,0.5) + r4.xy;
  r3.xy = v0.xy + -r3.xy;
  r3.z = r2.y + r2.z;
  r3.z = r0.w * r1.w + r3.z;
  r3.z = 0.5 * r3.z;
  r0.xyw = r0.xyw * r1.www + -r3.zzz;
  r1.w = max(r0.y, r0.w);
  r1.w = max(r1.w, r0.x);
  r1.w = max(r3.z, r1.w);
  r0.x = cmp(r0.x == r1.w);
  ...
  r4.y = r2.w + -r2.y;
  r4.x = -r2.z * 3 + r4.z;
  r0.xyw = float3(0.408248305,0.707106769,0.577350259) * r4.xyz;
  r0.w = 1 + abs(r0.w);
  r0.w = rsqrt(r0.w);
  r0.xy = r0.xy * r0.ww;
