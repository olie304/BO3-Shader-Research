...
mul r3.xyzw, r3.xyzw, v1.xyzw
add r8.xyz, cb0[10].xyzx, l(-1.000000, -1.000000, -1.000000, 0.000000)
mad r8.xyz, r3.wwww, r8.xyzx, l(1.000000, 1.000000, 1.000000, 0.000000)
...
mad r8.xyz, v4.xyzx, r2.yyyy, r8.xyzx
mad r2.yzw, v3.xxyz, r2.wwww, r8.xxyz
dp3 r4.w, r2.yzwy, r2.yzwy
rsq r4.w, r4.w
mul r8.yzw, r2.yyzw, r4.wwww
...
dp3 r1.x, r9.xyzx, l(0.299000, 0.587000, 0.114000, 0.000000)
dp2 r1.y, r7.xyxx, r6.xzxx
mad r1.y, r7.z, r5.z, r1.y
add_sat r0.x, r0.x, r1.y
add r4.xyz, -r1.xxxx, r9.xyzx
mad r1.xyz, r0.xxxx, r4.xyzx, r1.xxxx
dp2 r0.x, r7.xyxx, r6.ywyy
mad r0.x, r7.z, r5.w, r0.x
add_sat r1.xyz, r0.xxxx, r1.xyzx
movc o0.xyz, r3.wwww, r0.yzwy, r3.xyzx
movc r0.xyz, r3.wwww, r1.xyzx, r9.xyzx
...
mad r2.yzw, r2.yyzw, r4.wwww, -r0.wwww
max r1.z, r2.w, r2.z
max r1.z, r1.z, r2.y
max r0.w, r0.w, r1.z
eq r1.z, r0.w, r2.y
mul r3.yzw, r8.yyzw, l(0.000000, 1.000000, -1.000000, -1.000000)
add r2.y, r0.w, l(2.000000)
mov r3.x, l(1)
mov r8.x, l(0)
movc r3.xyzw, r1.zzzz, r3.xyzw, r8.xyzw
