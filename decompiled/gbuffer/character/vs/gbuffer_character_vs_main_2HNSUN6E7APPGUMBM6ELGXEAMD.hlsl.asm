...
mul r2.yzw, r2.wwww, cb1[5].xxyz
mad r2.yzw, r0.wwww, cb1[4].xxyz, r2.yyzw
mad r2.xyz, r2.xxxx, cb1[6].xyzx, r2.yzwy
...
add r3.yzw, r6.xxyz, -cb1[24].xxyz
mov r4.w, l(1.000000)
mov r2.w, r3.y
...
mad r4.xyzw, r2.zzzz, cb1[10].xyzw, r4.xyzw
...
mul r3.yzw, r3.yyyy, cb1[5].xxyz
mad r3.yzw, r2.wwww, cb1[4].xxyz, r3.yyzw
mad r0.xyz, r0.xxxx, cb1[6].xyzx, r3.yzwy
