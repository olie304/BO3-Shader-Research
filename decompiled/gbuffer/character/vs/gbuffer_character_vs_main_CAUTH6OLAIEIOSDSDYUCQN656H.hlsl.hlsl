...
r6.z = gpuSkinBase[]..swiz;
  ...
  r2.y = dot(r2.yzw, r6.xyz);
  r2.xzw = viewMatrix._m10_m11_m12 * r2.xxx;
  r2.xzw = r1.www * viewMatrix._m00_m01_m02 + r2.xzw;
  r2.xyz = r2.yyy * viewMatrix._m20_m21_m22 + r2.xzw;
  r1.w = dot(r2.xyz, r2.xyz);
  r1.w = rsqrt(r1.w);
  o5.xyz = r2.xyz * r1.www;
// Known bad code for instruction (needs manual fix):
...
r5.z = gpuSkinBase[]..swiz;
  ...
  r6.xyz = viewMatrix._m10_m11_m12 * r1.www;
  r0.yzw = r0.www * viewMatrix._m00_m01_m02 + r6.xyz;
  r0.xyz = r0.xxx * viewMatrix._m20_m21_m22 + r0.yzw;
