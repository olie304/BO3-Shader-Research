...
dcl_output o1.xyzw
dcl_temps 11
sample_indexable(texture2d)(float,float,float,float) r0.x, v2.xyxx, t6.xyzw, s1
mul r0.y, r0.x, v1.w
...
sample_indexable(texture2d)(float,float,float,float) r3.xyz, v2.xyxx, t9.xyzw, s4
...
mad r4.xyzw, v2.xyxy, cb0[14].xyxy, l(0.250000, 0.000000, -0.550000, 0.300000)
...
mad r6.xyzw, v2.xyxy, cb0[14].xyxy, l(0.600000, 0.850000, 0.500000, -0.750000)
...
sample_indexable(texture2d)(float,float,float,float) r1.w, v2.xyxx, t10.yzwx, s3
...
if_nz r1.w
  ftoi r1.w, cb1[64].w
  lod r2.w, v2.xyxx, t7.y, s2
  lod r3.w, v2.xyxx, t7.x, s2
  lt r2.w, r2.w, r3.w
...
mad r0.x, -r0.x, v1.w, cb1[59].x
mad o0.w, cb1[59].w, r0.x, r0.y
add r0.x, -r0.z, r0.w
mad r0.x, cb1[62].w, r0.x, r0.z
movc r0.yzw, v7.xxxx, r2.xxyz, -r2.xxyz
