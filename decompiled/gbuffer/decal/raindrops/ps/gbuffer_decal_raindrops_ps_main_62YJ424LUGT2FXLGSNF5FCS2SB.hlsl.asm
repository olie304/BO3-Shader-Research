...
// volDecalRevealTexture             texture   float          2d            t12      1 
// rippleMap                         texture  float4          2d            t14      1 
...
sample_indexable(texture2d)(float,float,float,float) r1.z, r1.zwzz, t12.yzxw, s2
mul r0.w, r0.w, r1.z
...
sample_indexable(texture2d)(float,float,float,float) r4.xyz, r1.xyxx, t10.xyzw, s4
...
dp3_sat r4.z, r3.xyzx, cb2[39].yzwy
lt r5.x, l(0.400000), r4.z
if_nz r5.x
  mul r5.xy, r0.yyyy, cb1[1].zwzz
  mad r0.xy, r0.xxxx, cb1[0].zwzz, r5.xyxx
  mad r0.xy, r0.zzzz, cb1[2].zwzz, r0.xyxx
  add r0.xy, r0.xyxx, cb1[3].zwzz
  div r0.x, r0.x, r0.y
  mad r5.xyzw, cb1[69].wwww, l(1.000000, 0.830000, 0.970000, 1.130000), l(0.000000, 0.230000, 0.470000, 0.710000)
  add r6.xyzw, cb2[38].xxxx, l(-0.000000, -0.250000, -0.500000, -0.750000)
  mul_sat r6.xyzw, r6.xyzw, l(4.000000, 4.000000, 4.000000, 4.000000)
  mad r7.xyzw, r1.xyxy, cb0[14].xyxy, l(0.250000, 0.000000, -0.550000, 0.300000)
  mul r7.xyzw, r7.xyzw, cb2[39].xxxx
  sample_indexable(texture2d)(float,float,float,float) r8.xyzw, r7.xyxx, t14.xyzw, s4
  mad r0.yz, r8.yyzy, l(0.000000, 2.000000, 2.000000, 0.000000), l(0.000000, -1.000000, -1.000000, 0.000000)
  mad r5.x, r5.x, cb0[13].w, r8.w
  frc r5.x, r5.x
  add r7.x, r8.x, r5.x
  add r7.x, r7.x, l(-1.000000)
  mad r9.xyzw, r6.xyzw, l(0.800000, 0.800000, 0.800000, 0.800000), l(0.200000, 0.200000, 0.200000, 0.200000)
  add r5.x, -r5.x, r9.x
  max r5.x, r5.x, l(0.000000)
  mul r5.x, r8.x, r5.x
  mul r7.x, r7.x, l(9.000000)
  max r7.x, r7.x, l(0.000000)
  min r7.x, r7.x, l(3.000000)
  mul r7.x, r7.x, l(3.14159274)
  sincos r7.x, null, r7.x
  mul r5.x, r5.x, r7.x
  mul r5.x, r5.x, l(0.350000)
  mul r0.yz, r0.yyzy, r5.xxxx
  sample_indexable(texture2d)(float,float,float,float) r7.xyzw, r7.zwzz, t14.xyzw, s4
  mad r7.yz, r7.yyzy, l(0.000000, 2.000000, 2.000000, 0.000000), l(0.000000, -1.000000, -1.000000, 0.000000)
  mad r5.x, r5.y, cb0[13].w, r7.w
  frc r5.x, r5.x
  add r5.y, r7.x, r5.x
  ...
  max r5.x, r5.x, l(0.000000)
  mul r5.x, r7.x, r5.x
  mul r5.y, r5.y, l(9.000000)
  max r5.y, r5.y, l(0.000000)
  min r5.y, r5.y, l(3.000000)
  mul r5.y, r5.y, l(3.14159274)
  sincos r5.y, null, r5.y
  mul r5.x, r5.y, r5.x
  mul r5.x, r5.x, l(0.350000)
  mul r5.xy, r5.xxxx, r7.yzyy
  mad r7.xyzw, r1.xyxy, cb0[14].xyxy, l(0.600000, 0.850000, 0.500000, -0.750000)
  mul r7.xyzw, r7.xyzw, cb2[39].xxxx
  sample_indexable(texture2d)(float,float,float,float) r8.xyzw, r7.xyxx, t14.xyzw, s4
  mad r7.xy, r8.yzyy, l(2.000000, 2.000000, 0.000000, 0.000000), l(-1.000000, -1.000000, 0.000000, 0.000000)
  mad r5.z, r5.z, cb0[13].w, r8.w
  frc r5.z, r5.z
  add r8.y, r8.x, r5.z
  ...
  mul r5.z, r8.x, r5.z
  mul r8.x, r8.y, l(9.000000)
  max r8.x, r8.x, l(0.000000)
  min r8.x, r8.x, l(3.000000)
  mul r8.x, r8.x, l(3.14159274)
  sincos r8.x, null, r8.x
  mul r5.z, r5.z, r8.x
  mul r5.z, r5.z, l(0.350000)
  mul r7.xy, r5.zzzz, r7.xyxx
  sample_indexable(texture2d)(float,float,float,float) r8.xyzw, r7.zwzz, t14.xyzw, s4
  mad r7.zw, r8.yyyz, l(0.000000, 0.000000, 2.000000, 2.000000), l(0.000000, 0.000000, -1.000000, -1.000000)
  mad r5.z, r5.w, cb0[13].w, r8.w
  frc r5.z, r5.z
  add r5.w, r8.x, r5.z
  ...
  mul r5.z, r5.w, r5.z
  mul r5.z, r5.z, l(0.350000)
  mul r5.zw, r5.zzzz, r7.zzzw
  add r4.z, r4.z, l(-0.400000)
  mul r4.z, r4.z, l(1.66666663)
  ...
  max r7.z, |r5.w|, |r5.z|
  max r4.z, r4.z, r7.z
  mul r7.z, r1.w, cb0[14].z
  mul r4.z, r4.z, l(10.000000)
  min r4.z, r4.z, l(1.000000)
  mad r7.w, r1.z, r0.w, -r7.z
  mad r8.w, r4.z, r7.w, r7.z
  add r0.x, r0.x, l(-0.001000)
  mul_sat r0.x, r0.x, l(111.111115)
  mad r4.z, r0.x, l(-2.000000), l(3.000000)
  mul r0.x, r0.x, r0.x
  mul r0.x, r0.x, r4.z
  mul r6.xyzw, r0.xxxx, r6.xyzw
  mad r4.xy, r0.yzyy, r6.xxxx, r4.xyxx
  dp3 r0.x, r4.xywx, r4.xywx
  rsq r0.x, r0.x
  mul r0.xyz, r0.xxxx, r4.xywx
  mad r0.xy, r5.xyxx, r6.yyyy, r0.xyxx
  dp3 r4.z, r0.xyzx, r0.xyzx
  rsq r4.z, r4.z
  mul r0.xyz, r0.xyzx, r4.zzzz
  mad r0.xy, r7.xyxx, r6.zzzz, r0.xyxx
  dp3 r4.z, r0.xyzx, r0.xyzx
  rsq r4.z, r4.z
  mul r0.xyz, r0.xyzx, r4.zzzz
  mad r0.xy, r5.zwzz, r6.wwww, r0.xyxx
  dp3 r4.z, r0.xyzx, r0.xyzx
  rsq r4.z, r4.z
  mul r4.xyw, r0.xyxz, r4.zzzz
else 
  mov r8.w, r1.w
endif 
sample_indexable(texture2d)(float,float,float,float) r0.x, r1.xyxx, t11.xyzw, s3
...
mad r4.xyz, r5.xyzx, r4.xxxx, r6.xyzx
mad r3.xyz, r3.xyzx, r4.wwww, r4.xyzx
...
lt r0.z, l(0.000000), cb1[64].w
if_nz r0.z
  ftoi r0.z, cb1[64].w
  lod r3.w, r1.xyxx, t9.y, s2
  lod r1.x, r1.xyxx, t9.x, s2
  lt r1.y, r3.w, r1.x
  lt r1.x, l(0.000000), r1.x
  and r4.xyz, r0.zzzz, l(1, 2, 4, 0)
  movc r5.xyz, r4.xxxx, l(1.000000,0,1.000000,0), r2.xyzx
  movc r4.xyw, r4.yyyy, l(0,1.000000,0,1.000000), r2.xyxz
  movc r4.xyw, r1.xxxx, r5.xyxz, r4.xyxw
  movc r5.xyz, r4.zzzz, l(0,1.000000,0,0), r2.xyzx
  movc r2.xyz, r1.yyyy, r4.xywx, r5.xyzx
endif 
add r4.xyz, -r2.xyzx, cb1[58].xyzx
mad o0.xyz, cb1[58].wwww, r4.xyzx, r2.xyzx
mad r0.z, -r1.z, r0.w, cb1[59].x
mad o0.w, cb1[59].w, r0.z, r1.w
add r0.y, -r0.x, r0.y
mad r0.x, cb1[62].w, r0.y, r0.x
mad r0.yzw, v5.xxyz, r2.wwww, -r3.xxyz
mad r0.yzw, cb1[60].wwww, r0.yyzw, r3.xxyz
ftou r1.xy, v0.xyxx
mov r1.zw, l(0,0,0,0)
ld_indexable(texture2d)(float,float,float,float) r1.xy, r1.xyzw, t6.zwxy
