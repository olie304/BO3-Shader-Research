  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r1.x = imageTime * r0.w;
  r1.y = gameTime.w * r1.x;
  r1.y = cmp(r1.y >= -r1.y);
  r1.y = r1.y ? r1.x : -r1.x;
  r1.z = 1 / r1.y;
  r1.z = gameTime.w * r1.z;
  r1.z = frac(r1.z);
  r1.y = r1.y * r1.z;
  r1.x = r1.y / r1.x;
  r0.w = r1.x * r0.w;
  r0.w = round(r0.w);
  r1.x = r0.w / columnCount;
  r1.y = columnCount * r0.w;
  r1.y = cmp(r1.y >= -r1.y);
  r1.y = r1.y ? columnCount : -columnCount;
  r1.z = 1 / r1.y;
  r0.w = r1.z * r0.w;
  r0.w = frac(r0.w);
  r0.w = r1.y * r0.w;
  r0.w = trunc(r0.w);
  r0.y = r0.y + r0.w;
  r2.x = r0.y / columnCount;
  r0.y = trunc(r1.x);
  r0.y = r0.z + r0.y;
  r2.y = r0.y / rowCount;
  r1.xyzw = colorMap.Sample(colorSampler_s, r2.xy).xyzw;
  r0.yzw = v8.xyz * r1.xyz;
  r0.x = r1.w * r0.x;
  r1.x = thicknessMap.Sample(colorSampler_s, r2.xy).x;
  r1.x = 1 + -r1.x;
  r0.w = r1.x * r0.w;
  r1.yz = (uint2)v0.xy;
  r2.y = r0.y * r1.x + -r0.w;
