...
mul r1.x, r0.w, cb0[12].x
mul r1.y, r1.x, cb1[69].w
ge r1.y, r1.y, -r1.y
movc r1.y, r1.y, r1.x, -r1.x
div r1.z, l(1.000000, 1.000000, 1.000000, 1.000000), r1.y
mul r1.z, r1.z, cb1[69].w
frc r1.z, r1.z
mul r1.y, r1.z, r1.y
div r1.x, r1.y, r1.x
mul r0.w, r0.w, r1.x
round_ne r0.w, r0.w
div r1.x, r0.w, cb0[11].w
mul r1.y, r0.w, cb0[11].w
ge r1.y, r1.y, -r1.y
movc r1.y, r1.y, cb0[11].w, -cb0[11].w
div r1.z, l(1.000000, 1.000000, 1.000000, 1.000000), r1.y
mul r0.w, r0.w, r1.z
frc r0.w, r0.w
mul r0.w, r0.w, r1.y
...
sample_indexable(texture2d)(float,float,float,float) r1.xyzw, r2.xyxx, t7.xyzw, s1
mul r0.yzw, r1.xxyz, v8.xxyz
mul r0.x, r0.x, r1.w
sample_indexable(texture2d)(float,float,float,float) r1.x, r2.xyxx, t9.xyzw, s1
add r1.x, -r1.x, l(1.000000)
mul r0.w, r0.w, r1.x
ftou r1.yz, v0.xxyx
mad r2.y, r0.y, r1.x, -r0.w
mad r0.y, r2.y, l(0.500000), r0.w
mad r2.z, r0.z, r1.x, -r0.y
mad r2.x, r2.z, l(0.500000), r0.y
and r0.yz, r1.yyzy, l(0, 1, 1, 0)
ieq r0.y, r0.z, r0.y
