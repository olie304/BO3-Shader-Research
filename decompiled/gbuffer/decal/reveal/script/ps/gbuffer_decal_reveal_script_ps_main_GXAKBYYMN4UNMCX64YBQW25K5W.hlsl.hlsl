...
Texture2D<float4> revealMap : register(t11);
Texture2D<float4> transitionDiffuse : register(t12);
Texture2D<float4> transitionNormal : register(t14);
...
// unknown dcl_: dcl_resource_structured t4, 24
  ...
  if (r2.x != 0) {
    ...
    r4.w = colorMap.CalculateLevelOfDetail(colorSampler_s, r0.xy);
    r2.z = cmp(r2.z < r4.w);
    r4.w = cmp(0 < r4.w);
  ...
  r1.w = r1.w + -r3.w;
  r1.w = debugGlossOverride.w * r1.w + r3.w;
  r2.y = -1 + debugOcclusionOverride.x;
  r8.z = debugOcclusionOverride.w * r2.y + 1;
  r9.xyz = v5.xyz * r2.www + -r6.xyz;
  r6.xyz = debugNormalOverride.www * r9.xyz + r6.xyz;
  r9.xyz = transitionDiffuse.Sample(colorSampler_s, r0.xy).xyz;
  r9.xyz = v8.xyz * r9.xyz;
  r10.xyz = transitionNormal.Sample(normalSampler_s, r0.xy).xyz;
  r10.xyz = float3(-0.5,-0.5,-0) + r10.xyz;
  r10.xyz = baseNormalHeight * r10.xyz + float3(0.5,0.5,0);
  r2.yz = r10.xy * float2(1.9921875,1.9921875) + float2(-1,-1);
  ...
  if (r2.x != 0) {
    ...
    r2.y = colorMap.CalculateLevelOfDetailUnclamped(colorSampler_s, r0.xy);
    r2.z = colorMap.CalculateLevelOfDetail(colorSampler_s, r0.xy);
    r2.y = cmp(r2.y < r2.z);
    r2.z = cmp(0 < r2.z);
    r4.xyz = (int3)r2.xxx & int3(1,2,4);
    r5.xyz = r4.xxx ? float3(1,0,1) : r9.xyz;
    r4.xyw = r4.yyy ? float3(0,1,1) : r9.xyz;
    r4.xyw = r2.zzz ? r5.xyz : r4.xyw;
    r5.xyz = r4.zzz ? float3(0,1,0) : r9.xyz;
    r9.xyz = r2.yyy ? r4.xyw : r5.xyz;
  }
  r2.xyz = debugColorOverride.xyz + -r9.xyz;
  r2.xyz = debugColorOverride.www * r2.xyz + r9.xyz;
  r0.z = r0.z * 1 + -r0.w;
  r0.z = debugGlossOverride.w * r0.z + r0.w;
  r4.xyz = v5.xyz * r2.www + -r3.xyz;
...
r0.w = colorSampler[]..swiz;
  ...
  r0.y = saturate(r0.w * 0.998000026 + 0.00100000005);
  r0.w = 1 + -r0.y;
  ...
  r0.y = r2.w * r0.y;
  r4.y = exp2(r0.y);
  r0.yw = saturate(alphaRevealParms.xx * r4.xy + r0.ww);
  r0.x = r0.x + -r0.y;
  r0.y = r0.w + -r0.y;
  ...
  r1.xy = (uint2)v0.xy;
  r1.zw = float2(0,0);
  r0.yw = resolvedNormal.Load(r1.xyz).zw;
  r1.z = cmp(0 < r0.y);
  r0.w = r0.w * 3 + 0.5;
  r0.w = (uint)r0.w;
  ...
  r8.xy = r0.yz * float2(1,0.5) + float2(0,0.5);
  r8.w = 1;
  o2.xyzw = r8.xyzw * r0.xxxx;
  o0.w = r0.x;
  o1.w = r0.x;
  return;
}