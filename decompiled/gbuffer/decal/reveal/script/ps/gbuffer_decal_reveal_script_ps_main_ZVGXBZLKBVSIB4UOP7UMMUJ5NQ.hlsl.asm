...
dcl_output o2.xyzw
dcl_temps 10
sample_indexable(texture2d)(float,float,float,float) r0.xyz, v2.xyxx, t9.xyzw, s2
...
sample_indexable(texture2d)(float,float,float,float) r0.w, v2.xyxx, t14.yzwx, s5
sample_indexable(texture2d)(float,float,float,float) r1.w, v2.xyxx, t12.yzwx, s3
add r2.x, -cb0[12].x, cb0[12].y
mad r1.w, r1.w, r2.x, cb0[12].x
mul_sat r1.w, r1.w, l(0.05882353)
sample_indexable(texture2d)(float,float,float,float) r2.yzw, v2.xyxx, t11.wxyz, s4
...
if_nz r2.w
  ftoi r3.w, cb1[64].w
  lod r4.w, v2.xyxx, t9.y, s2
  lod r5.w, v2.xyxx, t9.x, s2
  lt r4.w, r4.w, r5.w
...
movc r8.xyz, v7.xxxx, v4.xyzx, -v4.xyzx
dp3 r2.y, r8.xyzx, r8.xyzx
rsq r2.y, r2.y
mad r9.xyz, r8.xyzx, r2.yyyy, -r3.xyzx
mad r3.xyz, cb1[60].wwww, r9.xyzx, r3.xyzx
sample_indexable(texture2d)(float,float,float,float) r9.xyz, v2.xyxx, t16.xyzw, s2
mul r1.xyz, r1.xyzx, r9.xyzx
mul r1.xyz, r1.xyzx, v1.xyzx
sample_indexable(texture2d)(float,float,float,float) r3.w, v2.xyxx, t18.yzwx, s3
mad r2.x, r3.w, r2.x, cb0[12].x
mul_sat r2.x, r2.x, l(0.05882353)
sample_indexable(texture2d)(float,float,float,float) r9.xyz, v2.xyxx, t17.xyzw, s4
...
if_nz r2.w
  ftoi r2.w, cb1[64].w
  lod r3.w, v2.xyxx, t9.y, s2
  lod r4.w, v2.xyxx, t9.x, s2
  lt r3.w, r3.w, r4.w
...
sample_indexable(texture2d)(float,float,float,float) r2.w, v2.xyxx, t7.yzwx, s1
