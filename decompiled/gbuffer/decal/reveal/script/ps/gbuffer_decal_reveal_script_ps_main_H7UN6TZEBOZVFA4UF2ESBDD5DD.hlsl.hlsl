...
// unknown dcl_: dcl_resource_structured t4, 24
  ...
  r10.xyz = transitionNormal.Sample(normalSampler_s, v2.xy).xyz;
...
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r2.x, v3.x, l(4), t4.xxxx
