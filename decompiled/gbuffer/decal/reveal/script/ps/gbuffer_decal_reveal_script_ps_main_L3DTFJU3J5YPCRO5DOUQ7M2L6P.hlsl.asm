...
sample_indexable(texture2d)(float,float,float,float) r2.xyz, v1.yzyy, t16.xyzw, s2
...
mul r1.x, r1.x, r1.y
exp r3.y, r1.x
mad_sat r1.xy, cb0[8].xxxx, r3.xyxx, r0.wwww
sample_indexable(texture2d)(float,float,float,float) r0.w, v1.yzyy, t7.yzwx, s1
add r0.w, -r1.x, r0.w
add r1.x, -r1.x, r1.y
div_sat r0.w, r0.w, r1.x
ge r1.x, r0.w, l(0.990000)
...
mad r1.yzw, r5.xxyz, r1.wwww, r3.xxyz
dp3 r0.x, r1.yzwy, r1.yzwy
rsq r0.x, r0.x
sample_indexable(texture2d)(float,float,float,float) r3.xyz, v1.yzyy, t17.xyzw, s4
...
mad r1.yzw, r1.yyzw, r0.xxxx, -r2.xxyz
mad r1.yzw, r1.xxxx, r1.yyzw, r2.xxyz
ftou r2.xy, v0.xyxx
mov r2.zw, l(0,0,0,0)
ld_indexable(texture2d)(float,float,float,float) r2.xy, r2.xyzw, t6.zwxy
mad r0.x, r2.y, l(3.000000), l(0.500000)
ftou r0.x, r0.x
...
mul r1.yz, r0.xxxx, r3.xxyx
mad r3.xy, r1.yzyy, l(0.58823532, 0.58823532, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r0.x, v1.yzyy, t12.xyzw, s3
add r1.y, -cb0[12].x, cb0[12].y
mad r0.x, r0.x, r1.y, cb0[12].x
...
log r0.x, r0.x
mul_sat r0.x, r0.x, l(-0.05882353)
sample_indexable(texture2d)(float,float,float,float) r0.z, v1.yzyy, t18.yzxw, s3
mad r0.z, r0.z, r1.y, cb0[12].x
...
ge r0.y, r2.x, l(0.500000)
lt r0.z, l(0.000000), r2.x
movc r0.y, r0.y, l(0.500000), l(0.00146628)
mad r3.z, r0.x, l(0.49755621), r0.y
and r0.xyz, r0.zzzz, r3.xyzx
mul o1.xyz, r0.wwww, r0.xyzx
mov o1.w, r0.w
sample_indexable(texture2d)(float,float,float,float) r0.x, v1.yzyy, t14.xyzw, s5
