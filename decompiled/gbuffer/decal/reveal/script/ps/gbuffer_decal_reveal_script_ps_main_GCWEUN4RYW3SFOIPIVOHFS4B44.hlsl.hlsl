...
// unknown dcl_: dcl_resource_structured t4, 24
  ...
  r0.w = rsqrt(r0.w);
  r6.xyz = transitionDiffuse.Sample(colorSampler_s, r0.xy).xyz;
  r6.xyz = v8.xyz * r6.xyz;
  r7.xyz = transitionNormal.Sample(normalSampler_s, r0.xy).xyz;
...
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r2.w, l(0), l(4), t4.xxxx
r2.w = colorSampler[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) r2.w, r2.w, l(0), t0.xxxx
r2.w = colorSampler[]..swiz;
  r0.x = revealMap.Sample(revealSampler_s, r0.xy).x;
  r0.y = saturate(r2.w * 0.998000026 + 0.00100000005);
  r2.w = 1 + -r0.y;
  r3.w = saturate(alphaRevealParms.y);
  r0.y = log2(r0.y);
  r0.y = r3.w * r0.y;
  r0.y = exp2(r0.y);
  r4.x = -r0.y;
  ...
  r0.y = r3.w * r0.y;
  r4.y = exp2(r0.y);
  r4.xy = saturate(alphaRevealParms.xx * r4.xy + r2.ww);
  r0.x = -r4.x + r0.x;
  r0.y = r4.y + -r4.x;
  r0.x = saturate(r0.x / r0.y);
  r0.y = cmp(r0.x >= 0.99000001);
  r0.y = r0.y ? 1.000000 : 0;
  r1.xyz = r1.xyz * v8.xyz + -r6.xyz;
  ...
  r4.y = dot(r2.xz, r1.yz);
  r0.w = dot(r2.xyz, r3.xyz);
  r0.w = 1 + abs(r0.w);
  r0.w = rsqrt(r0.w);
  r1.yz = r4.xy * r0.ww;
  r2.xy = r1.yz * float2(0.588235319,0.588235319) + float2(0.5,0.5);
  r0.y = cmp(r0.y >= 0.5);
  r0.y = r0.y ? 0.5 : 0.00146627566;
  r2.z = r0.z * 0.49755621 + r0.y;
  r0.yzw = r1.xxx ? r2.xyz : 0;
