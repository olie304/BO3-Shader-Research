...
// revealMap                         texture  float4          2d            t14      1 
// transitionDiffuse                 texture  float4          2d            t15      1 
// transitionNormal                  texture  float4          2d            t16      1 
// transitionGloss                   texture  float4          2d            t17      1 
...
sample_indexable(texture2d)(float,float,float,float) r0.z, r0.xyxx, t12.yzxw, s4
...
sample_indexable(texture2d)(float,float,float,float) r2.xyz, r0.xyxx, t10.xyzw, s3
...
mad r4.w, cb1[62].x, r1.w, cb0[10].y
...
if_nz r5.w
  ftoi r6.x, cb1[64].w
  lod r6.y, r0.xyxx, t9.y, s1
  lod r6.z, r0.xyxx, t9.x, s1
  lt r6.y, r6.y, r6.z
  lt r6.z, l(0.000000), r6.z
  and r7.xyz, r6.xxxx, l(1, 2, 4, 0)
  movc r8.xyz, r7.xxxx, l(1.000000,0,1.000000,0), r1.xyzx
  movc r7.xyw, r7.yyyy, l(0,1.000000,0,1.000000), r1.xyxz
  movc r6.xzw, r6.zzzz, r8.xxyz, r7.xxyw
  movc r7.xyz, r7.zzzz, l(0,1.000000,0,0), r1.xyzx
  movc r1.xyz, r6.yyyy, r6.xzwx, r7.xyzx
endif 
...
add r2.z, -r0.w, r2.z
mad r0.w, cb1[62].w, r2.z, r0.w
add r2.z, -r0.z, cb1[63].x
mad r0.z, cb1[63].w, r2.z, r0.z
mad r7.xyz, v5.xyzx, r3.xxxx, -r2.xywx
mad r2.xyz, cb1[60].wwww, r7.xyzx, r2.xywx
sample_indexable(texture2d)(float,float,float,float) r7.xyz, r0.xyxx, t15.xyzw, s1
mul r7.xyz, r7.xyzx, v8.xyzx
sample_indexable(texture2d)(float,float,float,float) r2.w, r0.xyxx, t17.yzwx, s2
mad r1.w, r2.w, r1.w, cb0[10].y
mul_sat r1.w, r1.w, l(0.05882353)
sample_indexable(texture2d)(float,float,float,float) r8.xyz, r0.xyxx, t16.xyzw, s3
add r8.xyz, r8.xyzx, l(-0.500000, -0.500000, -0.000000, 0.000000)
mad r8.xyz, cb0[10].xxxx, r8.xyzx, l(0.500000, 0.500000, 0.000000, 0.000000)
...
mul r5.xyz, r5.xyzx, r8.yyyy
mad r4.xyz, r4.xyzx, r8.xxxx, r5.xyzx
...
if_nz r5.w
  ftoi r2.w, cb1[64].w
  lod r4.x, r0.xyxx, t9.y, s1
  lod r4.y, r0.xyxx, t9.x, s1
  lt r4.x, r4.x, r4.y
  lt r4.y, l(0.000000), r4.y
  and r5.xyz, r2.wwww, l(1, 2, 4, 0)
  movc r8.xyz, r5.xxxx, l(1.000000,0,1.000000,0), r7.xyzx
  movc r5.xyw, r5.yyyy, l(0,1.000000,0,1.000000), r7.xyxz
  movc r5.xyw, r4.yyyy, r8.xyxz, r5.xyxw
  movc r8.xyz, r5.zzzz, l(0,1.000000,0,0), r7.xyzx
  movc r7.xyz, r4.xxxx, r5.xywx, r8.xyzx
endif 
add r4.xyz, -r7.xyzx, cb1[58].xyzx
mad r4.xyz, cb1[58].wwww, r4.xyzx, r7.xyzx
mad r2.w, r4.w, l(1.000000), -r1.w
mad r1.w, cb1[62].w, r2.w, r1.w
add r2.w, cb1[63].x, l(-1.000000)
mad r2.w, cb1[63].w, r2.w, l(1.000000)
mad r5.xyz, v5.xyzx, r3.xxxx, -r3.yzwy
...
sample_indexable(texture2d)(float,float,float,float) r0.x, r0.xyxx, t14.xyzw, s5
...
mad r2.z, r0.w, l(0.49755621), r0.y
and r0.yzw, r1.zzzz, r2.xxyz
mul o1.xyz, r0.xxxx, r0.yzwy
add r2.y, -r6.z, r6.x
mad r0.y, r2.y, l(0.500000), r6.z
add r2.z, -r0.y, r6.y
