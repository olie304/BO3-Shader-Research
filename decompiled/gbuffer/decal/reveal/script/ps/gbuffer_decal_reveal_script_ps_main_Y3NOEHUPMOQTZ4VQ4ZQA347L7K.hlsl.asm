...
sample_indexable(texture2d)(float,float,float,float) r0.z, v1.yzyy, t10.yzxw, s3
add r0.z, -r0.x, r0.z
add r0.x, -r0.x, r0.y
...
sample_indexable(texture2d)(float,float,float,float) r2.xyz, v1.yzyy, t12.xyzw, s2
...
sample_indexable(texture2d)(float,float,float,float) r5.xyz, v1.yzyy, t9.xyzw, s2
