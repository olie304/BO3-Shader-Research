...
// unknown dcl_: dcl_resource_structured t4, 24
  ...
  r2.xyz = transitionDiffuse.Sample(colorSampler_s, v2.xy).xyz;
...
r0.w = revealSampler[]..swiz;
  ...
  r1.w = log2(r0.w);
  r0.w = 1 + -r0.w;
  r2.x = saturate(alphaRevealParms.y);
  r1.w = r2.x * r1.w;
  r1.w = exp2(r1.w);
  r3.x = -r1.w;
  r1.w = log2(r0.w);
  r1.w = r2.x * r1.w;
  r3.y = exp2(r1.w);
  r2.xy = saturate(alphaRevealParms.xx * r3.xy + r0.ww);
  r0.w = revealMap.Sample(revealSampler_s, v2.xy).x;
  r0.w = r0.w + -r2.x;
  r1.w = r2.y + -r2.x;
  r0.w = saturate(r0.w / r1.w);
  r1.w = cmp(r0.w >= 0.99000001);
  ...
  r2.z = min(1, r2.z);
  r0.z = r2.z * detailScaleHeight + r0.z;
  ...
  r1.xyz = r5.xyz * r1.zzz + r3.xyz;
  r0.x = dot(r1.xyz, r1.xyz);
  r0.x = rsqrt(r0.x);
  r3.xyz = transitionNormal.Sample(normalSampler_s, v2.xy).xyz;
  ...
  r0.x = log2(r0.x);
  r0.x = saturate(-0.0588235296 * r0.x);
  r0.z = transitionGloss.Sample(specColorSampler_s, v2.xy).x;
  r0.z = r0.z * r2.y + glossRange.x;
