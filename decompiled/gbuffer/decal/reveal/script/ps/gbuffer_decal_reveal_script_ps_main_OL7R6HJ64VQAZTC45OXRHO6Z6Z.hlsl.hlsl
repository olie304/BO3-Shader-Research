...
Texture2D<float4> revealMap : register(t12);
Texture2D<float4> transitionDiffuse : register(t14);
Texture2D<float4> transitionNormal : register(t15);
Texture2D<float4> transitionGloss : register(t16);
...
// unknown dcl_: dcl_resource_structured t4, 24
  ...
  r2.xzw = r3.xyz * r2.xxx + r6.xyz;
  r1.z = dot(r2.xzw, r2.xzw);
  r1.z = rsqrt(r1.z);
  r2.xzw = r2.xzw * r1.zzz;
  r1.z = debugGlossOverride.x * r1.y + glossRange.x;
  ...
  r1.w = r1.w + -r1.x;
  r1.x = debugGlossOverride.w * r1.w + r1.x;
  ...
  r1.w = rsqrt(r1.w);
  r8.xyz = r7.xyz * r1.www + -r2.xzw;
  r2.xzw = debugNormalOverride.www * r8.xyz + r2.xzw;
  r8.xyz = transitionDiffuse.Sample(colorSampler_s, v2.xy).xyz;
  r8.xyz = v1.xyz * r8.xyz;
  r3.w = transitionGloss.Sample(specColorSampler_s, v2.xy).x;
  r1.y = r3.w * r1.y + glossRange.x;
  r1.y = saturate(0.0588235296 * r1.y);
  r9.xyz = transitionNormal.Sample(normalSampler_s, v2.xy).xyz;
  ...
  if (r2.y != 0) {
    ...
    r3.w = cmp(r3.w < r4.x);
    r4.x = cmp(0 < r4.x);
    r4.yzw = (int3)r2.yyy & int3(1,2,4);
    r5.xyz = r4.yyy ? float3(1,0,1) : r8.xyz;
    r9.xyz = r4.zzz ? float3(0,1,1) : r8.xyz;
    r4.xyz = r4.xxx ? r5.xyz : r9.xyz;
    r5.xyz = r4.www ? float3(0,1,0) : r8.xyz;
    r8.xyz = r3.www ? r4.xyz : r5.xyz;
  }
  r4.xyz = debugColorOverride.xyz + -r8.xyz;
  r4.xyz = debugColorOverride.www * r4.xyz + r8.xyz;
  r1.z = r1.z + -r1.y;
...
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r1.w, v3.x, l(4), t4.xxxx
r1.w = colorSampler[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) r1.w, r1.w, l(0), t0.xxxx
r1.w = colorSampler[]..swiz;
  r2.y = revealMap.Sample(revealSampler_s, v2.xy).x;
  r1.w = saturate(r1.w * 0.998000026 + 0.00100000005);
  r3.w = 1 + -r1.w;
  ...
  r2.z = r1.x * 0.49755621 + r0.z;
  r1.xyz = r1.yyy ? r2.xyz : 0;
