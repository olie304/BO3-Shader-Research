  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r4.x = specColorMap.Sample(specColorSampler_s, r2.xw).x;
  r4.yzw = float3(-0.0399999991,-0.0399999991,-0.0399999991) + specColorTint.xyz;
  r4.yzw = r4.xxx * r4.yzw + float3(0.0399999991,0.0399999991,0.0399999991);
  r5.x = glossMap.Sample(specColorSampler_s, r2.xw).x;
  r5.yzw = detailMap1.Sample(normalSampler_s, r2.xw).xyz;
  r2.xw = r5.yz * float2(1.9921875,1.9921875) + float2(-1,-1);
  r5.y = r5.w * r5.w;
  r5.y = 0.333333343 * r5.y;
  r5.y = min(1, r5.y);
  ...
  r5.zw = float2(0.5,0.5) + r6.xy;
  r5.zw = detailScale2.xy * r5.zw;
  r2.yz = useUVOffsets1 ? r2.yz : r5.zw;
  ...
  r6.w = r5.y * detailScaleHeight1 + r0.w;
  r1.xy = r5.xz * detailScaleHeight2 + r0.yz;
  r0.y = dot(r1.xyz, r1.xyz);
  r0.y = rsqrt(r0.y);
  r5.xyz = r1.xyz * r0.yyy;
  r5.w = r4.w * detailScaleHeight2 + r0.w;
  ...
  r2.xyw = r7.xyz * r0.yyy;
  r2.xyw = r6.xyz * r0.xxx + r2.xyw;
  r0.xyz = r5.xyz * r0.zzz + r2.xyw;
  ...
  if (r1.z != 0) {
    ...
    r5.xyz = r5.zzz ? float3(0,1,0) : r3.xyz;
    r3.xyz = r1.www ? r2.xyw : r5.xyz;
  }
  ...
  r3.xyz = debugSpecularOverride.xyz + -r4.xyz;
  r3.xyz = debugSpecularOverride.www * r3.xyz + r4.xyz;
  r1.x = r1.x + -r0.w;
  r0.w = debugGlossOverride.w * r1.x + r0.w;
  r1.x = debugOcclusionOverride.x + -r2.z;
  r4.z = debugOcclusionOverride.w * r1.x + r2.z;
  r1.xyw = v4.xyz * r1.yyy + -r0.xyz;
