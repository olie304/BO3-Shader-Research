...
sample_indexable(texture2d)(float,float,float,float) r3.xyz, v2.xyxx, t11.xyzw, s4
...
sample_indexable(texture2d)(float,float,float,float) r0.z, v2.xyxx, t14.yzxw, s5
mov r0.w, l(1.000000)
