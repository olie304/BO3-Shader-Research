  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r4.w = r3.w * detailScaleHeight1 + r1.w;
  r3.xy = r1.xy * detailScaleHeight2 + r2.xy;
  ...
  r2.x = rsqrt(r2.x);
  r4.xyz = v6.xyz * r2.xxx;
  r2.x = dot(v7.xyz, v7.xyz);
  r2.x = rsqrt(r2.x);
  r6.xyz = v7.xyz * r2.xxx;
  r2.x = -17 * r2.w;
  r2.x = exp2(r2.x);
  r1.w = r2.x + r1.w;
  r1.w = log2(r1.w);
  r1.w = saturate(-0.0588235296 * r1.w);
  r2.xyw = r6.xyz * r1.yyy;
  r2.xyw = r4.xyz * r1.xxx + r2.xyw;
  r1.xyz = r3.xyz * r1.zzz + r2.xyw;
  r2.x = dot(r1.xyz, r1.xyz);
  r2.x = rsqrt(r2.x);
  r1.xyz = r2.xxx * r1.xyz;
  r2.x = debugGlossOverride.x * r2.z + glossRange.x;
  r2.x = saturate(0.0588235296 * r2.x);
  r2.y = cmp(0 < debugStreamerControl.w);
  if (r2.y != 0) {
    r2.y = (int)debugStreamerControl.w;
    r2.z = colorMap.CalculateLevelOfDetailUnclamped(colorSampler_s, r0.yz);
    r0.y = colorMap.CalculateLevelOfDetail(colorSampler_s, r0.yz);
    r0.z = cmp(r2.z < r0.y);
    r0.y = cmp(0 < r0.y);
    r2.yzw = (int3)r2.yyy & int3(1,2,4);
    r3.xyz = r2.yyy ? float3(1,0,1) : r5.xyz;
    r4.xyz = r2.zzz ? float3(0,1,1) : r5.xyz;
    r3.xyz = r0.yyy ? r3.xyz : r4.xyz;
    r2.yzw = r2.www ? float3(0,1,0) : r5.xyz;
    r5.xyz = r0.zzz ? r3.xyz : r2.yzw;
  }
  r2.yzw = debugColorOverride.xyz + -r5.xyz;
  r2.yzw = debugColorOverride.www * r2.yzw + r5.xyz;
  ...
  r4.z = debugOcclusionOverride.w * r0.z + 1;
  r5.xyz = v5.xyz * r0.www + -r1.xyz;
  r1.xyz = debugNormalOverride.www * r5.xyz + r1.xyz;
  o0.xyz = r2.yzw * r0.xxx;
  r2.xy = (uint2)v0.xy;
  r2.zw = float2(0,0);
