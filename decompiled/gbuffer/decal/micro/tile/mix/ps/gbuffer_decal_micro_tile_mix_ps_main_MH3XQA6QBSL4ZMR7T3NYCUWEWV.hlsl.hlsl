  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r4.w = r1.w * detailScaleHeight1 + r0.w;
  r3.xy = r1.xy * detailScaleHeight2 + r2.xy;
  r1.x = dot(r3.xyz, r3.xyz);
  r1.x = rsqrt(r1.x);
  r3.xyz = r3.xyz * r1.xxx;
  r3.w = r1.z * detailScaleHeight2 + r0.w;
  r1.xyzw = r3.xyzw + -r4.xyzw;
  r1.xyzw = r0.zzzz * r1.xyzw + r4.xyzw;
  ...
  r1.xyw = r4.xyz * r1.xxx + r2.xyw;
  r1.xyz = r3.xyz * r1.zzz + r1.xyw;
  r1.w = dot(r1.xyz, r1.xyz);
  r1.w = rsqrt(r1.w);
  r1.xyz = r1.xyz * r1.www;
  r1.w = debugGlossOverride.x * r2.z + glossRange.x;
  ...
  if (r2.x != 0) {
    ...
    r0.y = cmp(r2.y < r0.x);
    r0.x = cmp(0 < r0.x);
    r2.xyz = (int3)r2.xxx & int3(1,2,4);
    r3.xyz = r2.xxx ? float3(1,0,1) : r5.xyz;
    r2.xyw = r2.yyy ? float3(0,1,1) : r5.xyz;
    r2.xyw = r0.xxx ? r3.xyz : r2.xyw;
    r3.xyz = r2.zzz ? float3(0,1,0) : r5.xyz;
    r5.xyz = r0.yyy ? r2.xyw : r3.xyz;
  }
  r2.xyz = debugColorOverride.xyz + -r5.xyz;
  r2.xyz = debugColorOverride.www * r2.xyz + r5.xyz;
  ...
  r4.z = debugOcclusionOverride.w * r0.w + 1;
  r5.xyz = v5.xyz * r0.zzz + -r1.xyz;
