...
mad r2.z, r2.z, r2.w, cb0[15].x
mul_sat r2.z, r2.z, l(0.05882353)
add r2.z, -r1.x, r2.z
mad r1.x, r0.z, r2.z, r1.x
sample_indexable(texture2d)(float,float,float,float) r6.z, r0.xyxx, t14.yzxw, s4
mad r0.xy, r9.xyxx, l(1.99218750, 1.99218750, 0.000000, 0.000000), l(-1.000000, -1.000000, 0.000000, 0.000000)
mul r2.z, r9.z, r9.z
...
mad r3.xy, r0.xyxx, cb0[13].yyyy, r2.xyxx
dp3 r0.x, r3.xyzx, r3.xyzx
rsq r0.x, r0.x
mul r3.xyz, r0.xxxx, r3.xyzx
mad r3.w, r2.z, cb0[13].y, r0.w
add r2.xyzw, -r7.xyzw, r3.xyzw
mad r0.xyzw, r0.zzzz, r2.xyzw, r7.xyzw
...
mad r0.xyz, r2.xyzx, r0.zzzz, r3.xyzx
dp3 r1.x, r0.xyzx, r0.xyzx
rsq r1.x, r1.x
mul r0.xyz, r0.xyzx, r1.xxxx
mul o0.xyz, r5.wwww, r5.xyzx
ftou r2.xy, v0.xyxx
mov r2.zw, l(0,0,0,0)
...
movc r2.z, r2.z, l(0.500000), l(0.00146628)
mad r0.z, r0.w, l(0.49755621), r2.z
and r0.xyz, r0.xyzx, r1.xxxx
mul o1.xyz, r5.wwww, r0.xyzx
add r0.y, -r1.w, r1.y
mad r0.w, r0.y, l(0.500000), r1.w
add r0.z, -r0.w, r1.z
mad r0.x, r0.z, l(0.500000), r0.w
and r1.xy, r2.xyxx, l(1, 1, 0, 0)
ieq r0.w, r1.y, r1.x
movc r0.xy, r0.wwww, r0.xyxx, r0.xzxx
mad r6.xy, r0.xyxx, l(1.000000, 0.500000, 0.000000, 0.000000), l(0.000000, 0.500000, 0.000000, 0.000000)
mov r6.w, l(1.000000)
mul o2.xyzw, r5.wwww, r6.xyzw
mov o0.w, r5.w
mov o1.w, r5.w
ret 
