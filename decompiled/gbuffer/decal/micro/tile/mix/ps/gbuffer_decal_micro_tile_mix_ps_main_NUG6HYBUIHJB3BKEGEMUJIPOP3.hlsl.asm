...
sample_indexable(texture2d)(float,float,float,float) r0.x, r0.xyxx, t15.xyzw, s3
sample_indexable(texture2d)(float,float,float,float) r0.yzw, v1.yzyy, t9.wxyz, s2
...
sample_indexable(texture2d)(float,float,float,float) r4.xyz, r2.xwxx, t10.xyzw, s2
...
sample_indexable(texture2d)(float,float,float,float) r1.w, r2.yzyy, t11.yzwx, s1
add r4.yzw, cb0[13].xxyz, l(0.000000, -1.000000, -1.000000, -1.000000)
mad r4.yzw, r1.wwww, r4.yyzw, l(0.000000, 1.000000, 1.000000, 1.000000)
mul r5.xyz, r4.yzwy, r5.xyzx
sample_indexable(texture2d)(float,float,float,float) r4.yzw, r2.yzyy, t12.wxyz, s2
...
mad r5.w, r4.x, cb0[12].x, r0.w
mad r1.xy, r4.yzyy, cb0[12].yyyy, r0.yzyy
dp3 r0.y, r1.xyzx, r1.xyzx
rsq r0.y, r0.y
mul r4.xyz, r0.yyyy, r1.xyzx
mad r4.w, r2.z, cb0[12].y, r0.w
