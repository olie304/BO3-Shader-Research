...
// volDecalRevealTexture             texture   float          2d            t15      1 
// detailMap1                        texture  float4          2d            t16      1 
// tintMask2                         texture  float4          2d            t17      1 
// detailMap2                        texture  float4          2d            t18      1 
// glossMapDetail2                   texture  float4          2d            t19      1 
// colorMapDetail2                   texture  float4          2d            t20      1 
...
sample_indexable(texture2d)(float,float,float,float) r0.w, r2.xyxx, t15.yzwx, s2
mul r0.x, r0.x, r0.w
mad r0.yz, r0.yyzy, v12.zzwz, v12.xxyx
mul r1.xyz, r1.xyzx, l(0.100000, 0.100000, 0.100000, 0.000000)
frc r1.xyz, r1.xyzx
mul r2.xy, r0.yzyy, cb0[12].zwzz
sample_indexable(texture2d)(float,float,float,float) r0.w, r2.xyxx, t22.yzwx, s6
sample_indexable(texture2d)(float,float,float,float) r2.xyz, r0.yzyy, t11.xyzw, s4
...
movc r4.xy, cb0[16].xxxx, r4.zwzz, r4.xyxx
...
sample_indexable(texture2d)(float,float,float,float) r3.w, r4.xyxx, t12.yzwx, s3
sample_indexable(texture2d)(float,float,float,float) r4.xyz, r4.xyxx, t16.xyzw, s4
...
movc r1.xy, cb0[16].yyyy, r1.xyxx, r2.zwzz
sample_indexable(texture2d)(float,float,float,float) r6.xyz, r1.xyxx, t20.xyzw, s2
sample_indexable(texture2d)(float,float,float,float) r1.z, r1.xyxx, t17.yzxw, s2
...
sample_indexable(texture2d)(float,float,float,float) r1.z, r1.xyxx, t19.yzxw, s3
sample_indexable(texture2d)(float,float,float,float) r8.xyz, r1.xyxx, t18.xyzw, s4
mad r6.xyz, r6.xyzx, r7.xyzx, -r5.xyzx
mad r5.xyz, r0.wwww, r6.xyzx, r5.xyzx
mul r5.xyz, r5.xyzx, v8.xyzx
mul r1.xy, r0.yzyy, cb0[16].zwzz
...
mul r0.x, r0.x, r2.z
exp r6.y, r0.x
mad_sat r2.zw, cb0[10].xxxx, r6.xxxy, r1.yyyy
add r0.x, r1.x, -r2.z
add r1.x, -r2.z, r2.w
div_sat r0.x, r0.x, r1.x
add r1.x, -cb0[12].x, cb0[12].y
mad r1.y, r3.w, r1.x, cb0[12].x
add r2.z, -cb0[15].x, cb0[15].y
mad r1.z, r1.z, r2.z, cb0[15].x
mul_sat r1.yz, r1.yyzy, l(0.000000, 0.05882353, 0.05882353, 0.000000)
add r1.z, -r1.y, r1.z
mad r1.y, r0.w, r1.z, r1.y
sample_indexable(texture2d)(float,float,float,float) r1.z, r0.yzyy, t14.yzxw, s5
...
mad r3.xy, r4.xyxx, cb0[13].xxxx, r2.xyxx
dp3 r4.x, r3.xyzx, r3.xyzx
rsq r4.x, r4.x
mul r6.xyz, r3.xyzx, r4.xxxx
mad r6.w, r4.z, cb0[13].x, r1.w
mad r3.xy, r2.zwzz, cb0[13].yyyy, r2.xyxx
dp3 r2.x, r3.xyzx, r3.xyzx
rsq r2.x, r2.x
mul r2.xyz, r2.xxxx, r3.xyzx
mad r2.w, r3.w, cb0[13].y, r1.w
add r2.xyzw, -r6.xyzw, r2.xyzw
mad r2.xyzw, r0.wwww, r2.xyzw, r6.xyzw
...
if_nz r1.w
  ftoi r1.w, cb1[64].w
  lod r2.w, r0.yzyy, t9.y, s2
  lod r0.y, r0.yzyy, t9.x, s2
  lt r0.z, r2.w, r0.y
  lt r0.y, l(0.000000), r0.y
  and r3.xyz, r1.wwww, l(1, 2, 4, 0)
  movc r4.xyz, r3.xxxx, l(1.000000,0,1.000000,0), r5.xyzx
  movc r3.xyw, r3.yyyy, l(0,1.000000,0,1.000000), r5.xyxz
  movc r3.xyw, r0.yyyy, r4.xyxz, r3.xyxw
  movc r4.xyz, r3.zzzz, l(0,1.000000,0,0), r5.xyzx
  movc r5.xyz, r0.zzzz, r3.xywx, r4.xyzx
endif 
add r3.xyz, -r5.xyzx, cb1[58].xyzx
mad r3.xyz, cb1[58].wwww, r3.xyzx, r5.xyzx
...
add r0.y, -r1.y, r1.x
mad r0.y, cb1[62].w, r0.y, r1.y
add r0.z, -r1.z, cb1[63].x
mad r1.z, cb1[63].w, r0.z, r1.z
...
dp2 r6.y, r2.xzxx, r3.zwzz
dp3 r0.w, r2.xyzx, r5.xyzx
add r0.w, |r0.w|, l(1.000000)
rsq r0.w, r0.w
mul r2.xy, r0.wwww, r6.xyxx
...
and r0.yzw, r2.xxyz, r2.wwww
mul o1.xyz, r0.xxxx, r0.yzwy
add r2.y, -r4.z, r4.x
mad r0.y, r2.y, l(0.500000), r4.z
add r2.z, -r0.y, r4.y
mad r2.x, r2.z, l(0.500000), r0.y
and r0.yz, r3.xxyx, l(0, 1, 1, 0)
ieq r0.y, r0.z, r0.y
