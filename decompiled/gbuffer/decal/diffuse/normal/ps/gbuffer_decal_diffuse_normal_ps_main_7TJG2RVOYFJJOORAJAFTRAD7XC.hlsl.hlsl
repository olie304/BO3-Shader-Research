// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:27:20 2021
  ...
  out float4 o1 : SV_TARGET1)
{
  ...
  r0.xy = normalMap.Sample(normalSampler_s, r0.xy).xy;
  ...
  r1.yz = float2(-1.22474492,1.22474492) * r2.xz;
