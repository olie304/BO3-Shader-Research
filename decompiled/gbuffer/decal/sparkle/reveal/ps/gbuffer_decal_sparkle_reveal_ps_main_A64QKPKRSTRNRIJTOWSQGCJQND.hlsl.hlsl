  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r0.xyzw = scaleReveal * v2.xyxy;
  r1.xyzw = normalScrolling.xyzw * gameTime.wwww + r0.xyzw;
  r0.xy = scaleReveal ? r0.zw : v2.xy;
  r0.xy = revealScale.xy * r0.xy;
  r0.x = revealMap.Sample(revealSampler_s, r0.xy).x;
  r0.yzw = normalMap.Sample(normalSampler_s, r1.zw).xyz;
  r1.xyz = normalMap.Sample(normalSampler_s, r1.xy).xyz;
  r1.xyz = float3(-0.5,-0.5,-0) + r1.xyz;
  r1.xyz = normalHeights.xxx * r1.xyz + float3(0.5,0.5,0);
  r0.yzw = float3(-0.5,-0.5,-0) + r0.yzw;
  r0.yzw = normalHeights.yyy * r0.yzw + float3(0.5,0.5,0);
  r1.xy = r1.xy * float2(1.9921875,1.9921875) + float2(-1,-1);
  r1.z = r1.z * r1.z;
  r1.z = 0.333333343 * r1.z;
  r1.z = min(1, r1.z);
  r0.yz = r0.yz * float2(1.9921875,1.9921875) + r1.xy;
  r0.w = r0.w * r0.w;
  ...
  r0.y = rsqrt(r0.y);
  r1.xyz = r1.xyz * r0.yyy;
  r2.xyz = v6.xxx ? v3.xyz : -v3.xyz;
  r0.y = dot(r2.xyz, r2.xyz);
  r0.y = rsqrt(r0.y);
  r2.xyz = r2.xyz * r0.yyy + -r1.xyz;
  r2.xyz = debugNormalOverride.www * r2.xyz + r1.xyz;
  r3.zw = float2(0,0);
  r3.xy = (uint2)v0.xy;
  ...
  r0.z = max(0, r0.z);
  r0.w = r2.w + -r0.z;
  r0.z = debugGlossOverride.w * r0.w + r0.z;
  r0.w = cmp(r0.y >= 0.5);
  r0.y = cmp(0 < r0.y);
  r0.w = r0.w ? 0.5 : 0.00146627566;
  r2.z = r0.z * 0.49755621 + r0.w;
  r0.yzw = r0.yyy ? r2.xyz : 0;
  r2.x = saturate(w1.x * 0.998000026 + 0.00100000005);
  r2.y = log2(r2.x);
  r2.x = 1 + -r2.x;
  ...
  r2.x = debugAlphaOverride.x + -r0.x;
  r0.x = debugAlphaOverride.w * r2.x + r0.x;
  o1.xyz = r0.yzw * r0.xxx;
  o1.w = r0.x;
  r0.yz = -subpixelOffset.xy + v0.xy;
  r0.yz = renderTargetSize.zw * r0.yz;
  r0.yz = r0.yz * float2(2,-2) + float2(-1,1);
  r2.x = inverseProjectionMatrix._m00 * r0.y;
  r2.y = inverseProjectionMatrix._m11 * r0.z;
  r2.z = 1;
  r0.yzw = v0.zzz * r2.xyz;
  r2.xyz = inverseViewMatrix._m10_m11_m12 * r0.zzz;
  r2.xyz = r0.yyy * inverseViewMatrix._m00_m01_m02 + r2.xyz;
  r0.yzw = r0.www * inverseViewMatrix._m20_m21_m22 + r2.xyz;
  r2.x = dot(-r0.yzw, -r0.yzw);
  r2.x = rsqrt(r2.x);
  r0.yzw = r2.xxx * -r0.yzw;
  r0.y = saturate(dot(r1.xyz, r0.yzw));
  r0.y = log2(r0.y);
  r0.y = specFadePower * r0.y;
  r0.y = exp2(r0.y);
  r1.xyz = float3(0.0399999991,0.0399999991,0.0399999991) + -specColorTint.xyz;
  r0.yzw = r0.yyy * r1.xyz + specColorTint.xyz;
  r1.xyz = debugSpecularOverride.xyz + -r0.yzw;
  r0.yzw = debugSpecularOverride.www * r1.xyz + r0.yzw;
  r1.y = r0.y + -r0.w;
  r0.y = r1.y * 0.5 + r0.w;
  r1.z = r0.z + -r0.y;
  r1.x = r1.z * 0.5 + r0.y;
  r0.yz = r1.ww ? r1.xy : r1.xz;
