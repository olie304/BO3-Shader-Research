...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:28:00 2021
//
//
// Buffer Definitions: 
//
...
if_nz r3.z
  ftoi r3.z, cb1[64].w
  lod r3.w, r0.yzyy, t7.y, s1
  lod r0.y, r0.yzyy, t7.x, s1
  lt r0.z, r3.w, r0.y
  lt r0.y, l(0.000000), r0.y
  and r4.xyw, r3.zzzz, l(1, 2, 0, 4)
  ...
  movc r4.xyw, r4.wwww, l(0,1.000000,0,0), r1.xyxz
  movc r1.xyz, r0.zzzz, r6.xyzx, r4.xywx
endif 
...
mad r3.xyz, v5.xyzx, r4.zzzz, -r5.xyzx
