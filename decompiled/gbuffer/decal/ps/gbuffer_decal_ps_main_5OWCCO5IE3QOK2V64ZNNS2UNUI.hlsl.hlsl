...
Texture2D<float> volDecalRevealTexture : register(t14);
  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  if (r2.x != 0) {
    ...
    r0.z = cmp(r2.z < r0.y);
    r0.y = cmp(0 < r0.y);
    r2.xzw = (int3)r2.xxx & int3(1,2,4);
    r4.xyz = r2.xxx ? float3(1,0,1) : r1.xyz;
    r5.xyz = r2.zzz ? float3(0,1,1) : r1.xyz;
    r4.xyz = r0.yyy ? r4.xyz : r5.xyz;
    r2.xzw = r2.www ? float3(0,1,0) : r1.xyz;
    r1.xyz = r0.zzz ? r4.xyz : r2.xzw;
  }
