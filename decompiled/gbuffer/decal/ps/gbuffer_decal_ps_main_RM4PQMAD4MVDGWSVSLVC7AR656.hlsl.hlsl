  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r2.w = aoMap.Sample(aoSampler_s, r0.yz).x;
  ...
  r0.yzw = debugSpecularOverride.xyz + -r2.xyz;
  r0.yzw = debugSpecularOverride.www * r0.yzw + r2.xyz;
  r1.w = r3.y + -r3.x;
  r1.w = debugGlossOverride.w * r1.w + r3.x;
  r2.x = debugOcclusionOverride.x + -r2.w;
  r2.z = debugOcclusionOverride.w * r2.x + r2.w;
