  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  if (r3.z != 0) {
    ...
    r4.y = colorMap.CalculateLevelOfDetailUnclamped(colorSampler_s, r0.yz);
    r0.y = colorMap.CalculateLevelOfDetail(colorSampler_s, r0.yz);
    r0.z = cmp(r4.y < r0.y);
    r0.y = cmp(0 < r0.y);
    r4.yzw = (int3)r3.zzz & int3(1,2,4);
    r5.xyz = r4.yyy ? float3(1,0,1) : r1.xyz;
    r6.xyz = r4.zzz ? float3(0,1,1) : r1.xyz;
    r5.xyz = r0.yyy ? r5.xyz : r6.xyz;
    r4.yzw = r4.www ? float3(0,1,0) : r1.xyz;
    r1.xyz = r0.zzz ? r5.xyz : r4.yzw;
  }
  r4.yzw = debugColorOverride.xyz + -r1.xyz;
  r1.xyz = debugColorOverride.www * r4.yzw + r1.xyz;
  r0.y = debugAlphaOverride.x + -r0.x;
  r0.x = debugAlphaOverride.w * r0.y + r0.x;
  r4.yzw = debugSpecularOverride.xyz + -r2.xyz;
  r2.xyz = debugSpecularOverride.www * r4.yzw + r2.xyz;
  r0.y = r2.w + -r1.w;
  r0.y = debugGlossOverride.w * r0.y + r1.w;
  r0.z = debugOcclusionOverride.x + -r0.w;
  r5.z = debugOcclusionOverride.w * r0.z + r0.w;
  r4.xyz = v5.xyz * r4.xxx + -r3.xyw;
