...
mul r0.w, r0.x, r2.w
sample_indexable(texture2d)(float,float,float,float) r1.z, r0.yzyy, t12.yzxw, s4
sample_indexable(texture2d)(float,float,float,float) r1.w, r1.xyxx, t11.yzwx, s2
add r3.x, -cb0[11].x, cb0[11].y
mad r1.w, r1.w, r3.x, cb0[11].x
mul_sat r1.w, r1.w, l(0.05882353)
sample_indexable(texture2d)(float,float,float,float) r3.yzw, r1.xyxx, t10.wxyz, s3
...
mad r1.xy, r3.yzyy, l(1.99218750, 1.99218750, 0.000000, 0.000000), l(-1.000000, -1.000000, 0.000000, 0.000000)
...
mad r1.x, cb1[62].x, r3.x, cb0[11].x
...
if_nz r1.y
  ...
  movc r3.xyz, r3.zzzz, l(0,1.000000,0,0), r2.xyzx
...
add r1.y, -r1.z, cb1[63].x
mad r5.z, cb1[63].w, r1.y, r1.z
mad r1.yzw, v5.xxyz, r3.wwww, -r4.xxyz
