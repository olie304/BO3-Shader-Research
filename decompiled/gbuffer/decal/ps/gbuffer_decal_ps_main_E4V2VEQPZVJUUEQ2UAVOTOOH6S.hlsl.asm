...
sample_indexable(texture2d)(float,float,float,float) r0.w, r0.yzyy, t12.yzwx, s3
add r1.w, -cb0[12].x, cb0[12].y
mad r0.w, r0.w, r1.w, cb0[12].x
mul_sat r0.w, r0.w, l(0.05882353)
sample_indexable(texture2d)(float,float,float,float) r3.xyz, r0.yzyy, t11.xyzw, s4
...
sample_indexable(texture2d)(float,float,float,float) r5.xyz, r0.yzyy, t15.xyzw, s4
...
mad r4.xy, r0.yzyy, cb0[12].zzzz, r3.xyxx
dp3 r0.y, r4.xyzx, r4.xyzx
rsq r0.y, r0.y
mul r3.xyw, r0.yyyy, r4.xyxz
mad r0.y, r3.z, cb0[12].z, r1.w
