...
sample_indexable(texture2d)(float,float,float,float) r1.xyzw, r0.yzyy, t7.xyzw, s1
sample_indexable(texture2d)(float,float,float,float) r0.w, r0.yzyy, t9.yzwx, s1
...
mul r0.w, r0.x, r1.w
sample_indexable(texture2d)(float,float,float,float) r2.x, r0.yzyy, t10.xyzw, s2
...
sample_indexable(texture2d)(float,float,float,float) r2.x, r0.yzyy, t14.xyzw, s4
sample_indexable(texture2d)(float,float,float,float) r3.x, r0.yzyy, t12.xyzw, s2
add r3.y, -cb0[12].x, cb0[12].y
mad r3.x, r3.x, r3.y, cb0[12].x
mul_sat r3.x, r3.x, l(0.05882353)
sample_indexable(texture2d)(float,float,float,float) r4.xyz, r0.yzyy, t11.xyzw, s3
...
mul r4.yz, r0.yyzy, cb0[4].xxyx
sample_indexable(texture2d)(float,float,float,float) r4.yzw, r4.yzyy, t15.wxyz, s3
...
mad r5.xy, r4.yzyy, cb0[12].zzzz, r3.zwzz
dp3 r3.z, r5.xyzx, r5.xyzx
rsq r3.z, r3.z
mul r5.xyz, r3.zzzz, r5.xyzx
mad r3.z, r4.w, cb0[12].z, r4.x
...
mul_sat r3.xy, r3.xyxx, l(-0.05882353, 0.05882353, 0.000000, 0.000000)
...
if_nz r3.z
  ...
  movc r5.xyw, r0.yyyy, r6.xyxz, r5.xyxw
  movc r6.xyz, r5.zzzz, l(0,1.000000,0,0), r1.xyzx
  movc r1.xyz, r0.zzzz, r5.xywx, r6.xyzx
endif 
add r5.xyz, -r1.xyzx, cb1[58].xyzx
mad r1.xyz, cb1[58].wwww, r5.xyzx, r1.xyzx
mad r0.x, -r1.w, r0.x, cb1[59].x
mad r0.x, cb1[59].w, r0.x, r0.w
add r0.yzw, -r2.yyzw, cb1[61].xxyz
mad r0.yzw, cb1[61].wwww, r0.yyzw, r2.yyzw
add r1.w, -r3.x, r3.y
mad r1.w, cb1[62].w, r1.w, r3.x
add r2.y, -r2.x, cb1[63].x
mad r2.z, cb1[63].w, r2.y, r2.x
mad r3.xyz, v5.xyzx, r3.wwww, -r4.xyzx
mad r3.xyz, cb1[60].wwww, r3.xyzx, r4.xyzx
mul o0.xyz, r0.xxxx, r1.xyzx
ftou r4.xy, v0.xyxx
mov r4.zw, l(0,0,0,0)
ld_indexable(texture2d)(float,float,float,float) r1.xy, r4.xyzw, t6.zwxy
...
mad r3.z, r1.w, l(0.49755621), r1.x
and r1.xyz, r1.zzzz, r3.xyzx
mul o1.xyz, r0.xxxx, r1.xyzx
add r1.y, -r0.w, r0.y
mad r0.y, r1.y, l(0.500000), r0.w
add r1.z, -r0.y, r0.z
mad r1.x, r1.z, l(0.500000), r0.y
and r0.yz, r4.xxyx, l(0, 1, 1, 0)
ieq r0.y, r0.z, r0.y
