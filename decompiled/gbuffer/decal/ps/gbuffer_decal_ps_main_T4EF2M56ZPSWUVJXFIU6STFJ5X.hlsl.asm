...
dcl_output o2.xyzw
dcl_temps 8
add r0.xy, v2.xyxx, v3.xyxx
add r0.xy, r0.xyxx, v3.zzzz
...
sample_indexable(texture2d)(float,float,float,float) r2.yzw, r0.xyxx, t9.wxyz, s2
...
mad r0.xy, r2.yzyy, l(1.99218750, 1.99218750, 0.000000, 0.000000), l(-1.000000, -1.000000, 0.000000, 0.000000)
...
mad r3.xyz, r3.xyzx, r2.yyyy, r4.xyzx
dp3 r0.x, r3.xyzx, r3.xyzx
rsq r0.x, r0.x
mul r3.xyz, r0.xxxx, r3.xyzx
mad r0.x, cb1[62].x, r0.w, cb0[11].x
...
if_nz r0.y
  ftoi r0.y, cb1[64].w
  lod r0.w, v2.xyxx, t6.y, s1
  lod r2.y, v2.xyxx, t6.x, s1
  lt r0.w, r0.w, r2.y
  lt r2.y, l(0.000000), r2.y
  and r4.xyz, r0.yyyy, l(1, 2, 4, 0)
...
mad r3.z, r0.x, l(0.49755621), r0.z
and r0.xzw, r1.zzzz, r3.xxyz
mul o1.xyz, r0.yyyy, r0.xzwx
add r3.y, -r2.w, r2.y
mad r0.x, r3.y, l(0.500000), r2.w
add r3.z, -r0.x, r2.z
mad r3.x, r3.z, l(0.500000), r0.x
and r0.xz, r1.xxyx, l(1, 0, 1, 0)
ieq r0.x, r0.z, r0.x
movc r0.xz, r0.xxxx, r3.xxyx, r3.xxzx
mad r4.xy, r0.xzxx, l(1.000000, 0.500000, 0.000000, 0.000000), l(0.000000, 0.500000, 0.000000, 0.000000)
mov r4.w, l(1.000000)
mul o2.xyzw, r0.yyyy, r4.xyzw
mov o0.w, r0.y
mov o1.w, r0.y
ret 
