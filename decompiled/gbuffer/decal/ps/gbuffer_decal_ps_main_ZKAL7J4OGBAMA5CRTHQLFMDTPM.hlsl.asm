...
// volDecalRevealTexture             texture   float          2d            t17      1 
...
sample_indexable(texture2d)(float,float,float,float) r0.w, r1.xyxx, t17.yzwx, s2
mul r0.x, r0.x, r0.w
...
sample_indexable(texture2d)(float,float,float,float) r0.w, r0.yzyy, t15.yzwx, s5
sample_indexable(texture2d)(float,float,float,float) r1.w, r0.yzyy, t14.yzwx, s3
add r2.w, -cb0[13].x, cb0[13].y
mad r1.w, r1.w, r2.w, cb0[13].x
mul_sat r1.w, r1.w, l(0.05882353)
sample_indexable(texture2d)(float,float,float,float) r3.xyz, r0.yzyy, t12.xyzw, s4
...
mul r5.xy, r0.yzyy, cb0[4].xyxx
sample_indexable(texture2d)(float,float,float,float) r5.xyz, r5.xyxx, t16.xyzw, s4
...
mad r4.xy, r5.xyxx, cb0[13].zzzz, r3.xyxx
dp3 r3.x, r4.xyzx, r4.xyzx
rsq r3.x, r3.x
mul r4.xyz, r3.xxxx, r4.xyzx
mad r3.x, r3.w, cb0[13].z, r3.z
...
if_nz r3.x
  ftoi r3.x, cb1[64].w
  lod r3.z, r0.yzyy, t9.y, s2
  lod r0.y, r0.yzyy, t9.x, s2
  lt r0.z, r3.z, r0.y
  lt r0.y, l(0.000000), r0.y
  and r3.xzw, r3.xxxx, l(1, 0, 2, 4)
  movc r5.xyz, r3.xxxx, l(1.000000,0,1.000000,0), r1.xyzx
  movc r6.xyz, r3.zzzz, l(0,1.000000,1.000000,0), r1.xyzx
  movc r5.xyz, r0.yyyy, r5.xyzx, r6.xyzx
  movc r3.xzw, r3.wwww, l(0,0,1.000000,0), r1.xxyz
  movc r1.xyz, r0.zzzz, r5.xyzx, r3.xzwx
endif 
add r3.xzw, -r1.xxyz, cb1[58].xxyz
mad r1.xyz, cb1[58].wwww, r3.xzwx, r1.xyzx
add r0.y, -r0.x, cb1[59].x
mad r0.x, cb1[59].w, r0.y, r0.x
add r3.xzw, -r2.xxyz, cb1[61].xxyz
mad r2.xyz, cb1[61].wwww, r3.xzwx, r2.xyzx
add r0.y, -r1.w, r2.w
mad r0.y, cb1[62].w, r0.y, r1.w
add r0.z, -r0.w, cb1[63].x
mad r5.z, cb1[63].w, r0.z, r0.w
mad r3.xyz, v5.xyzx, r3.yyyy, -r4.xyzx
...
mul r6.xy, r4.xzxx, l(-1.22474492, 1.22474492, 0.000000, 0.000000)
mul r7.xyz, r4.xyzx, l(0.70710677, -1.41421354, 0.70710677, 0.000000)
