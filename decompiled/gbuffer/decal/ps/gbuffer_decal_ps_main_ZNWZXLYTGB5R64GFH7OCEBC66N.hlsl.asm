...
mul r0.x, r0.x, r1.w
sample_indexable(texture2d)(float,float,float,float) r2.z, r0.yzyy, t12.yzxw, s4
sample_indexable(texture2d)(float,float,float,float) r0.w, r0.yzyy, t11.yzwx, s2
...
sample_indexable(texture2d)(float,float,float,float) r5.xyz, r0.yzyy, t14.xyzw, s3
...
mad r4.xy, r0.yzyy, cb0[11].zzzz, r3.xyxx
dp3 r0.y, r4.xyzx, r4.xyzx
rsq r0.y, r0.y
mul r3.xyw, r0.yyyy, r4.xyxz
mad r0.y, r3.z, cb0[11].z, r1.w
