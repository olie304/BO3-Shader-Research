...
sample_indexable(texture2d)(float,float,float,float) r2.xyz, r1.xyxx, t9.xyzw, s2
sample_indexable(texture2d)(float,float,float,float) r0.w, r1.xyxx, t10.yzwx, s2
...
mul r0.x, r0.x, r1.w
exp r3.y, r0.x
mad_sat r1.zw, cb0[10].xxxx, r3.xxxy, r1.zzzz
add r0.x, r0.w, -r1.z
add r0.w, -r1.z, r1.w
div_sat r0.x, r0.x, r0.w
add r0.w, -cb0[12].x, cb0[12].y
mul_sat r1.z, cb0[12].y, l(0.05882353)
sample_indexable(texture2d)(float,float,float,float) r1.xyw, r1.xyxx, t11.xywz, s3
...
if_nz r1.x
  ftoi r1.x, cb1[64].w
  lod r1.y, r0.yzyy, t9.y, s2
  lod r0.y, r0.yzyy, t9.x, s2
  lt r0.z, r1.y, r0.y
  lt r0.y, l(0.000000), r0.y
  and r1.xyw, r1.xxxx, l(1, 2, 0, 4)
  movc r4.xyz, r1.xxxx, l(1.000000,0,1.000000,0), r2.xyzx
  movc r5.xyz, r1.yyyy, l(0,1.000000,1.000000,0), r2.xyzx
  movc r4.xyz, r0.yyyy, r4.xyzx, r5.xyzx
  movc r1.xyw, r1.wwww, l(0,1.000000,0,0), r2.xyxz
  movc r2.xyz, r0.zzzz, r4.xyzx, r1.xywx
endif 
add r1.xyw, -r2.xyxz, cb1[58].xyxz
mad r1.xyw, cb1[58].wwww, r1.xyxw, r2.xyxz
