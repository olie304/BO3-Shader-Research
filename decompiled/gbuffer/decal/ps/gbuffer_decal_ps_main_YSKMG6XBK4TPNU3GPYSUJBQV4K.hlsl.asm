...
if_nz r2.z
  ...
  movc r4.xyz, r3.yyyy, l(1.000000,0,1.000000,0), r1.xyzx
  movc r5.xyz, r3.zzzz, l(0,1.000000,1.000000,0), r1.xyzx
  movc r4.xyz, r0.yyyy, r4.xyzx, r5.xyzx
  movc r3.yzw, r3.wwww, l(0,0,1.000000,0), r1.xxyz
  movc r1.xyz, r0.zzzz, r4.xyzx, r3.yzwy
endif 
...
mad r5.xyz, v5.xyzx, r3.xxxx, -r2.xywx
