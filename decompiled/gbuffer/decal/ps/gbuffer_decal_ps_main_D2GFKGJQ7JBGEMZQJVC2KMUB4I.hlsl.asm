...
sample_indexable(texture2d)(float,float,float,float) r0.w, r0.yzyy, t14.yzwx, s5
sample_indexable(texture2d)(float,float,float,float) r1.w, r0.yzyy, t12.yzwx, s3
add r2.x, -cb0[12].x, cb0[12].y
mad r1.w, r1.w, r2.x, cb0[12].x
mul_sat r1.w, r1.w, l(0.05882353)
sample_indexable(texture2d)(float,float,float,float) r2.yzw, r0.yzyy, t11.wxyz, s4
...
mul r6.xy, r3.xzxx, l(-1.22474492, 1.22474492, 0.000000, 0.000000)
