...
mul r1.x, r0.w, v1.x
sample_indexable(texture2d)(float,float,float,float) r1.y, v1.yzyy, t11.yxzw, s4
sample_indexable(texture2d)(float,float,float,float) r1.z, v1.yzyy, t10.yzxw, s2
...
if_nz r2.x
  ftoi r2.x, cb1[64].w
  lod r3.x, v1.yzyy, t6.y, s1
  lod r3.y, v1.yzyy, t6.x, s1
  lt r3.x, r3.x, r3.y
...
mad r1.yzw, cb1[60].wwww, r1.yyzw, r2.yyzw
