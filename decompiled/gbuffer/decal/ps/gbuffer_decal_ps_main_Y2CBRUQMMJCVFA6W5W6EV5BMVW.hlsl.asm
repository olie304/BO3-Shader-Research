...
sample_indexable(texture2d)(float,float,float,float) r2.z, r0.xyxx, t12.yzxw, s4
...
sample_indexable(texture2d)(float,float,float,float) r0.xyw, r0.xyxx, t10.xywz, s3
...
mad r0.xyw, r3.yzyw, r3.xxxx, r0.xyxw
...
dp3 r5.x, r0.xywx, r5.xyzx
dp2 r5.y, r0.xwxx, r4.xyxx
dp3 r0.x, r0.xywx, r3.xyzx
add r0.x, |r0.x|, l(1.000000)
rsq r0.x, r0.x
mul r0.xy, r0.xxxx, r5.xyxx
mad r3.xy, r0.xyxx, l(0.58823532, 0.58823532, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
ge r0.x, r1.x, l(0.500000)
movc r0.x, r0.x, l(0.500000), l(0.00146628)
mad r3.z, r0.z, l(0.49755621), r0.x
and r0.xyz, r1.zzzz, r3.xyzx
mul o1.xyz, r1.wwww, r0.xyzx
mov r2.xyw, l(0.040000,0.500000,0,1.000000)
mul o2.xyzw, r1.wwww, r2.xyzw
mov o0.w, r1.w
mov o1.w, r1.w
ret 
