...
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r0.yzyy, t9.xyzw, s2
...
mad r2.x, cb1[62].x, r2.x, cb0[14].x
...
if_nz r2.z
  ...
  movc r1.xyz, r0.zzzz, r5.xyzx, r3.xywx
endif 
...
mad r2.z, cb1[63].w, r2.x, l(1.000000)
mad r3.xyz, v5.xyzx, r3.zzzz, -r4.xyzx
