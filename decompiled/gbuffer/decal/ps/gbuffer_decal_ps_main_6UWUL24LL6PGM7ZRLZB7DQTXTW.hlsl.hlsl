  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r0.x = r1.w * r0.x;
  r3.y = exp2(r0.x);
  r1.zw = saturate(alphaRevealSoftEdge * r3.xy + r1.zz);
  r0.x = -r1.z + r0.w;
  r0.w = r1.w + -r1.z;
  r0.x = saturate(r0.x / r0.w);
  r0.w = glossRange.y + -glossRange.x;
  r1.z = saturate(0.0588235296 * glossRange.y);
  r1.xyw = normalMap.Sample(normalSampler_s, r1.xy).xyz;
  ...
  if (r1.x != 0) {
    ...
    r1.y = colorMap.CalculateLevelOfDetailUnclamped(colorSampler_s, r0.yz);
    r0.y = colorMap.CalculateLevelOfDetail(colorSampler_s, r0.yz);
    r0.z = cmp(r1.y < r0.y);
    r0.y = cmp(0 < r0.y);
    r1.xyw = (int3)r1.xxx & int3(1,2,4);
    r4.xyz = r1.xxx ? float3(1,0,1) : r2.xyz;
    r5.xyz = r1.yyy ? float3(0,1,1) : r2.xyz;
    r4.xyz = r0.yyy ? r4.xyz : r5.xyz;
    r1.xyw = r1.www ? float3(0,1,0) : r2.xyz;
    r2.xyz = r0.zzz ? r4.xyz : r1.xyw;
  }
  r1.xyw = debugColorOverride.xyz + -r2.xyz;
  r1.xyw = debugColorOverride.www * r1.xyw + r2.xyz;
  ...
  r0.y = r0.w + -r1.z;
  r0.y = debugGlossOverride.w * r0.y + r1.z;
