...
sample_indexable(texture2d)(float,float,float,float) r1.x, v2.xyxx, t14.xyzw, s5
sample_indexable(texture2d)(float,float,float,float) r2.x, v2.xyxx, t12.xyzw, s3
...
movc r2.yzw, v6.xxxx, v3.xxyz, -v3.xxyz
