  ...
  out float4 o1 : SV_TARGET1)
{
  ...
  r2.xyz = normalMap.Sample(normalSampler_s, r1.xy).xyz;
  r2.xyz = float3(-0.5,-0.5,-0) + r2.xyz;
  r2.xyz = normalHeights.xxx * r2.xyz + float3(0.5,0.5,0);
  ...
  r1.x = min(1, r1.x);
  r1.yzw = normalMap.Sample(normalSampler_s, r1.zw).xyz;
  r1.yzw = float3(-0.5,-0.5,-0) + r1.yzw;
  r1.yzw = normalHeights.yyy * r1.yzw + float3(0.5,0.5,0);
  r0.zw = r1.yz * float2(1.9921875,1.9921875) + r0.zw;
  r1.y = r1.w * r1.w;
  r1.y = 0.333333343 * r1.y;
  r1.y = min(1, r1.y);
  r3.xy = float2(-1,-1) + r0.zw;
