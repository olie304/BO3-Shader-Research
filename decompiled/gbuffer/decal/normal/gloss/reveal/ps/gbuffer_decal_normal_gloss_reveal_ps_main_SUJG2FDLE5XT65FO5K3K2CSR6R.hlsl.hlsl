  ...
  out float4 o1 : SV_TARGET1)
{
  ...
  r1.xyzw = normalTiling.xyxy * r0.yzyz;
  r2.xy = scaleReveal ? r1.zw : r0.yz;
  r2.xy = revealScale.xy * r2.xy;
  ...
  r1.xyzw = normalScrolling.xyzw * gameTime.wwww + r1.xyzw;
  ...
  r3.x = min(1, r3.x);
  r3.yzw = normalMap.Sample(normalSampler_s, r1.zw).xyz;
  r3.yzw = float3(-0.5,-0.5,-0) + r3.yzw;
  r3.yzw = normalHeights.yyy * r3.yzw + float3(0.5,0.5,0);
  r1.xy = r3.yz * float2(1.9921875,1.9921875) + r1.xy;
  r1.z = r3.w * r3.w;
  ...
  r1.xyw = r3.yzw * r1.www + r4.xyz;
  r3.y = dot(r1.xyw, r1.xyw);
  r3.y = rsqrt(r3.y);
  ...
  if (r2.w != 0) {
    ...
    r0.z = cmp(r3.y < r0.y);
    r0.y = cmp(0 < r0.y);
    r3.yzw = (int3)r2.www & int3(1,2,4);
    r4.xyz = r3.yyy ? float3(1,0,1) : r2.xyz;
    r5.xyz = r3.zzz ? float3(0,1,1) : r2.xyz;
    r4.xyz = r0.yyy ? r4.xyz : r5.xyz;
    r3.yzw = r3.www ? float3(0,1,0) : r2.xyz;
    r2.xyz = r0.zzz ? r4.xyz : r3.yzw;
  }
  r3.yzw = debugColorOverride.xyz + -r2.xyz;
  o0.xyz = debugColorOverride.www * r3.yzw + r2.xyz;
  r0.y = debugAlphaOverride.x + -r0.x;
  r0.x = debugAlphaOverride.w * r0.y + r0.x;
  r0.y = r1.z + -r0.w;
  r0.y = debugGlossOverride.w * r0.y + r0.w;
  r2.xyz = v5.xyz * r3.xxx + -r1.xyw;
  r1.xyz = debugNormalOverride.www * r2.xyz + r1.xyw;
  r2.xy = (uint2)v0.xy;
  r2.zw = float2(0,0);
