...
sample_indexable(texture2d)(float,float,float,float) r0.y, r0.yzyy, t10.yxzw, s3
add r0.z, -cb0[11].y, cb0[11].z
mad r0.y, r0.y, r0.z, cb0[11].y
...
mad r2.xyz, cb0[15].xxxx, r2.xyzx, l(0.500000, 0.500000, 0.000000, 0.000000)
...
sample_indexable(texture2d)(float,float,float,float) r1.yzw, r1.zwzz, t9.wxyz, s4
add r1.yzw, r1.yyzw, l(0.000000, -0.500000, -0.500000, -0.000000)
mad r1.yzw, cb0[15].yyyy, r1.yyzw, l(0.000000, 0.500000, 0.500000, 0.000000)
mad r0.zw, r1.yyyz, l(0.000000, 0.000000, 1.99218750, 1.99218750), r0.zzzw
mul r1.y, r1.w, r1.w
