  ...
  out float4 o1 : SV_TARGET1)
{
  ...
  if (useOrientedNormalMap == 0) {
    ...
    r8.xy = r5.xy / r3.ww;
    r8.z = -r8.x;
    r5.x = dot(v2.xy, r8.yz);
    r5.y = dot(v2.xy, -r8.xy);
    ...
    r6.xy = r6.xy / r3.ww;
    r6.z = -r6.x;
    r7.x = dot(v2.xy, r6.yz);
    r7.y = dot(v2.xy, -r6.xy);
    ...
    r6.xy = r4.xy / r3.ww;
    r6.z = -r6.x;
    r4.x = dot(v2.xy, r6.yz);
    r4.y = dot(v2.xy, -r6.xy);
