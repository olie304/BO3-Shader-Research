...
sample_indexable(texture2d)(float,float,float,float) r0.yz, r0.yzyy, t9.zxyw, s3
add r0.yz, r0.yyzy, l(0.000000, -0.500000, -0.500000, 0.000000)
mad r0.yz, cb0[11].wwww, r0.yyzy, l(0.000000, 0.500000, 0.500000, 0.000000)
