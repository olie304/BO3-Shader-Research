  ...
  out float4 o1 : SV_TARGET1)
{
  ...
  r0.yz = normalMap.Sample(normalSampler_s, r0.yz).xy;
  r0.yz = float2(-0.5,-0.5) + r0.yz;
  r0.yz = baseNormalHeight * r0.yz + float2(0.5,0.5);
