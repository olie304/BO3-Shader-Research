...
min r0.w, r2.y, r2.x
min r0.w, r2.z, r0.w
mad r1.xy, r1.yzyy, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
mad r1.zw, r1.xxxy, v10.zzzw, v10.xxxy
max r1.zw, r1.zzzw, v11.xxxy
min r1.zw, r1.zzzw, v11.zzzw
sample_indexable(texture2d)(float,float,float,float) r1.z, r1.zwzz, t15.yzxw, s2
mul r0.w, r0.w, r1.z
...
mad r1.xy, r1.xyxx, cb0[13].zwzz, r0.xyxx
...
mov r3.y, r3.x
mov r3.z, r2.x
dp2 r4.x, r3.yzyy, r1.xyxx
mov r3.x, -r2.x
dp2 r4.y, r3.xyxx, r1.xyxx
mul r1.xy, cb0[13].xyxx, cb1[69].wwww
mad r1.zw, r1.xxxy, cb0[13].zzzw, r4.xxxy
mul r0.z, cb0[15].x, cb1[69].w
sincos null, r0.z, r0.z
mad r0.z, r0.z, l(0.500000), l(0.500000)
add r0.z, -r0.z, l(1.000000)
add r2.x, -cb0[14].z, cb0[14].w
mad r0.z, r0.z, r2.x, cb0[14].z
div r1.zw, r1.zzzw, r0.zzzz
add r1.zw, r1.zzzw, l(0.000000, 0.000000, 0.500000, 0.500000)
mov_sat r2.xy, r1.zwzz
movc r1.zw, cb0[15].zzzw, r2.xxxy, r1.zzzw
add r1.zw, r1.zzzw, l(0.000000, 0.000000, -0.500000, -0.500000)
mad r0.xy, r1.zwzz, cb0[13].zwzz, r0.xyxx
mad r0.xy, cb0[14].xyxx, cb0[13].zwzz, r0.xyxx
dp2 r2.x, r3.yzyy, r0.xyxx
dp2 r2.y, r3.xyxx, r0.xyxx
mad r0.xy, r1.xyxx, cb0[13].zwzz, r2.xyxx
div r0.xy, r0.xyxx, r0.zzzz
add r0.xy, r0.xyxx, l(0.500000, 0.500000, 0.000000, 0.000000)
mov_sat r1.xy, r0.xyxx
movc r0.xy, cb0[15].zwzz, r1.xyxx, r0.xyxx
sample_indexable(texture2d)(float,float,float,float) r1.xyz, r0.xyxx, t9.xyzw, s2
sample_indexable(texture2d)(float,float,float,float) r0.z, r0.xyxx, t10.yzxw, s2
...
mul r2.xy, r0.xyxx, cb0[10].zwzz
sample_indexable(texture2d)(float,float,float,float) r0.z, r2.xyxx, t7.yzxw, s1
mad_sat r0.w, r0.w, l(0.998000), l(0.001000)
...
sample_indexable(texture2d)(float,float,float,float) r0.w, r0.xyxx, t14.yzwx, s5
sample_indexable(texture2d)(float,float,float,float) r1.w, r0.xyxx, t12.yzwx, s3
add r2.x, -cb0[12].x, cb0[12].y
mad r1.w, r1.w, r2.x, cb0[12].x
mul_sat r1.w, r1.w, l(0.05882353)
sample_indexable(texture2d)(float,float,float,float) r2.yzw, r0.xyxx, t11.wxyz, s4
...
mad r5.xyz, r5.xyzx, r2.yyyy, r6.xyzx
...
if_nz r2.y
  ftoi r2.y, cb1[64].w
  lod r2.z, r0.xyxx, t9.y, s2
  lod r0.x, r0.xyxx, t9.x, s2
  lt r0.y, r2.z, r0.x
...
mad r5.xyz, v5.xyzx, r3.yyyy, -r3.xzwx
mad r3.xyz, cb1[60].wwww, r5.xyzx, r3.xzwx
