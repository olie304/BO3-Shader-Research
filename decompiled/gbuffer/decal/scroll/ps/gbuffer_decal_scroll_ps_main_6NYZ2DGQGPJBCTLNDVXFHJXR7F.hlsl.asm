...
sample_indexable(texture2d)(float,float,float,float) r2.z, r0.xyxx, t14.yzxw, s5
sample_indexable(texture2d)(float,float,float,float) r0.w, r0.xyxx, t12.yzwx, s3
add r1.w, -cb0[12].x, cb0[12].y
mad r0.w, r0.w, r1.w, cb0[12].x
mul_sat r0.w, r0.w, l(0.05882353)
sample_indexable(texture2d)(float,float,float,float) r3.xyz, r0.xyxx, t11.xyzw, s4
...
mad r3.xyz, r3.yzwy, r1.wwww, r4.xyzx
...
mad r3.z, r0.w, l(0.49755621), r0.x
and r0.xyw, r1.xxxx, r3.xyxz
mul o1.xyz, r0.zzzz, r0.xywx
mov r2.xyw, l(0.040000,0.500000,0,1.000000)
mul o2.xyzw, r0.zzzz, r2.xyzw
mov o0.w, r0.z
mov o1.w, r0.z
ret 
