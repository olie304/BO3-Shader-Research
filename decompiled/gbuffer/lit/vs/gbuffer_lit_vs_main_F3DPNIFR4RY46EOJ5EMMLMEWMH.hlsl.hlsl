...
r0.y = modelInstanceBuffer[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r5.x, r0.y, l(12), t5.xxxx
r5.x = modelInstanceBuffer[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r5.y, r0.y, l(28), t5.xxxx
r5.y = modelInstanceBuffer[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r5.z, r0.y, l(44), t5.xxxx
r5.z = modelInstanceBuffer[]..swiz;
  ...
  r0.z = rsqrt(r0.z);
  o4.xyz = r6.xyz * r0.zzz;
  r6.xyz = v4.xyz * float3(2.00195694,2.00195694,2.00195694) + float3(-1.00195694,-1.00195694,-1.00195694);
  r7.x = dot(r6.xyz, r1.xyz);
  r7.y = dot(r6.xyz, r3.xyz);
  r7.z = dot(r6.xyz, r4.xyz);
  r0.z = dot(r7.xyz, r7.xyz);
  r0.z = rsqrt(r0.z);
  o5.xyz = r7.xyz * r0.zzz;
  r7.xyz = r6.yzx * r5.zxy;
  r5.xyz = r5.yzx * r6.zxy + -r7.xyz;
  r0.z = v4.w * 2 + -1;
