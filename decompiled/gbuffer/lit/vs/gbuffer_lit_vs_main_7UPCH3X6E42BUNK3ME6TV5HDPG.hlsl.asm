...
mad r7.xyz, v3.xyzx, l(2.001957, 2.001957, 2.001957, 0.000000), l(-1.00195694, -1.00195694, -1.00195694, 0.000000)
mad r6.xyz, r7.xyzx, r4.xxxx, v0.xyzx
dp4 r8.x, r6.xyzw, r3.xyzw
mov r5.w, r4.y
mov r1.w, r4.z
dp4 r8.y, r6.xyzw, r5.xyzw
dp4 r8.z, r6.xyzw, r1.xyzw
add r4.xyz, r8.xyzx, cb1[24].xyzx
...
add r4.xyz, r4.xyzx, -cb7[12].xyzx
...
mul r2.xyz, r0.yzxy, r7.zxyz
mad r0.xyz, r7.yzxy, r0.zxyz, -r2.xyzx
...
mul r0.xyzw, r4.yyyy, cb7[1].xyzw
mad r0.xyzw, r4.xxxx, cb7[0].xyzw, r0.xyzw
mad r0.xyzw, r4.zzzz, cb7[2].xyzw, r0.xyzw
