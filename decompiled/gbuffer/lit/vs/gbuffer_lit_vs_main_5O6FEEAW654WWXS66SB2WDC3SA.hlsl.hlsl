// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:29:52 2021
...
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r2.xyzw, v6.x, l(4), t4.xyzw
...
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r3.xyzw, r2.w, l(48), t5.xyzw
...
r3.w = shaderConstantSetBuffer[]..swiz;
  r3.xyzw = r2.wwww ? r3.xyzw : float4(0,0,0,0);
  r1.w = cmp(0 != r3.w);
  if (r1.w != 0) {
    r1.w = (uint)r3.w;
    if (r1.w != 0) {
      r2.w = (int)r1.w + (int)v5.x;
    // Known bad code for instruction (needs manual fix):
        ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r4.xyzw, r2.w, l(0), t5.xyzw
    ...
    r7.w = shaderConstantSetBuffer[]..swiz;
      ...
      r4.z = v4.x * r2.w;
      r2.w = cmp(v4.y != 0.000000);
      if (r2.w != 0) {
        r2.w = (int)r1.w + (int)v5.y;
      // Known bad code for instruction (needs manual fix):
      ...
      r7.w = shaderConstantSetBuffer[]..swiz;
        ...
        r2.w = dot(r7.xyz, r1.xyz);
        r4.z = r2.w * v4.y + r4.z;
        r2.w = cmp(v4.z != 0.000000);
        if (r2.w != 0) {
          r2.w = (int)r1.w + (int)v5.z;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r7.xyzw, r2.w, l(0), t5.xyzw
        r7.x = shaderConstantSetBuffer[]..swiz;
        r7.y = shaderConstantSetBuffer[]..swiz;
    ...
    if (r1.w != 0) {
      ...
      r5.xyz = r8.xyz * v4.yyy + r5.xyz;
      r3.xyw = r7.xyz * v4.yyy + r3.xyw;
      r6.xyz = r9.xyz * v4.yyy + r6.xyz;
      ...
      if (r1.w != 0) {
        ...
        r10.xyz = r10.xyz + r11.xyz;
        r8.xyz = r10.xyz + r8.xyz;
        r5.xyz = r8.xyz * v4.zzz + r5.xyz;
        r3.xyw = r7.xyz * v4.zzz + r3.xyw;
        r6.xyz = r9.xyz * v4.zzz + r6.xyz;
        ...
        if (r1.w != 0) {
          ...
          r12.y = r7.y * r10.x + -r10.z;
          r14.xy = r7.yx * r10.xx + r10.zw;
          ...
          r3.xyw = r7.xyz * v4.www + r3.xyw;
          r6.xyz = r9.xyz * v4.www + r6.xyz;
        }
      }
    }
...
r7.w = shaderConstantSetBuffer[]..swiz;
  ...
  r3.xyzw = viewProjectionMatrix._m10_m11_m12_m13 * r2.zzzz;
  r1.xyzw = r1.wwww * viewProjectionMatrix._m00_m01_m02_m03 + r3.xyzw;
  r1.xyzw = r2.wwww * viewProjectionMatrix._m20_m21_m22_m23 + r1.xyzw;
  ...
  r3.w = shaderConstantSetBuffer[]..swiz;
    ...
    if (r0.x != 0) {
      ...
      r9.z = r5.y;
      r6.x = dot(r1.xyw, r9.xyz);
      r8.w = 1 + -r8.y;
      r6.y = dot(r1.xwy, r8.xzw);
      r10.yz = r5.xz * float2(1,-1) + float2(0,1);
      r6.z = dot(r1.xyw, r10.xyz);
      r1.xyw = r6.xyz + r2.yzw;
      ...
      if (r0.x != 0) {
        ...
        if (r0.x != 0) {
          ...
          if (r0.x != 0) {
            ...
            r4.xyzw = r1.zzzz * r4.xyzw + r5.xyzw;
            r1.xyw = r1.xyw + -r0.xyz;
            r0.xyz = r1.zzz * r1.xyw + r0.xyz;
            r1.xyz = v0.xyz + -r2.yzw;
...
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r0.xy, v6.x, l(8), t4.xyxx
r0.x = shaderConstantSetBuffer[]..swiz;
r0.y = shaderConstantSetBuffer[]..swiz;
...
r0.w = shaderConstantSetBuffer[]..swiz;
  ...
  r5.y = r4.w;
  r5.z = r0.w;
  r5.xyw = -motionVectorConstants.prevFrameEyeOffset.xyz + r5.xyz;
  r3.w = 1;
  r1.w = r5.x;
...
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) o1.x, r2.x, l(0), t0.xxxx
r1.x = shaderConstantSetBuffer[]..swiz;
  p1.xy = v1.xy;
  return;
}