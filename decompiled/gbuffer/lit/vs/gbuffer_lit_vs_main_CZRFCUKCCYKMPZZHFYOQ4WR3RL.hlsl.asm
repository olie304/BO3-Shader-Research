...
mul r6.xyzw, r0.wwww, cb1[9].xyzw
mov r1.w, r2.x
mov r4.w, r2.z
dp4 r0.w, r5.xyzw, r1.xyzw
mad r2.xyzw, r0.wwww, cb1[8].xyzw, r6.xyzw
...
dp3 r6.x, r2.xyzx, r1.xyzx
dp3 r6.y, r2.xyzx, r3.xyzx
dp3 r6.z, r2.xyzx, r4.xyzx
...
mad r2.xyz, r2.yzxy, r6.zxyz, -r7.xyzx
