// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:29:51 2021
...
r4.w = shaderConstantSetBuffer[]..swiz;
  ...
  if (r2.w != 0) {
    ...
    if (r2.w != 0) {
      ...
      if (r2.w != 0) {
        ...
        if (r2.w != 0) {
          ...
          r11.z = r7.y;
          r9.x = dot(r0.yzw, r11.xyz);
          r13.w = 1 + -r13.y;
          r9.y = dot(r0.ywz, r13.xzw);
          r12.yz = r7.xz * float2(1,-1) + float2(0,1);
          r9.z = dot(r0.yzw, r12.xyz);
          r7.x = dot(r1.xyz, r11.xyz);
          r7.y = dot(r1.xzy, r13.xzw);
          r7.z = dot(r1.xyz, r12.xyz);
          r10.x = dot(r2.xyz, r11.xyz);
          r10.y = dot(r2.xzy, r13.xzw);
          r10.z = dot(r2.xyz, r12.xyz);
          r0.yzw = r9.xyz + r5.xyz;
          r0.yzw = r0.yzw + r8.xyz;
          r6.xyz = r0.yzw * v5.www + r6.xyz;
    ...
    r0.y = rsqrt(r0.y);
    r1.xyz = r3.yzw * r0.yyy;
    r0.y = dot(r4.xyw, r4.xyw);
    r0.y = rsqrt(r0.y);
    r2.xyz = r4.xyw * r0.yyy;
  }
  r0.yzw = r2.yzx * r1.zxy;
  r0.yzw = r1.yzx * r2.zxy + -r0.yzw;
