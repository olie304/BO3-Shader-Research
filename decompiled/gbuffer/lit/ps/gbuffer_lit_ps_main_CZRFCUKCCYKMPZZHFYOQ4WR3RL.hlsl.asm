...
sample_indexable(texture2d)(float,float,float,float) r0.x, v2.xyxx, t10.xyzw, s5
sample_indexable(texture2d)(float,float,float,float) r0.y, v2.xyxx, t9.yxzw, s3
add r0.z, -cb0[12].x, cb0[12].y
mad r0.y, r0.y, r0.z, cb0[12].x
mul_sat r0.y, r0.y, l(0.05882353)
sample_indexable(texture2d)(float,float,float,float) r1.xyz, v2.xyxx, t7.xyzw, s4
