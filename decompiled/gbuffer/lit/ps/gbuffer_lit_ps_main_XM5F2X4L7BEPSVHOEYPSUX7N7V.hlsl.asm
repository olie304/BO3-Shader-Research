...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:29:39 2021
//
//
// Buffer Definitions: 
//
...
sample_indexable(texture2d)(float,float,float,float) r0.w, v2.xyxx, t12.yzwx, s4
sample_indexable(texture2d)(float,float,float,float) r1.x, v2.xyxx, t11.xyzw, s2
add r1.y, -cb0[11].x, cb0[11].y
mad r1.x, r1.x, r1.y, cb0[11].x
mul_sat r1.x, r1.x, l(0.05882353)
sample_indexable(texture2d)(float,float,float,float) r1.yzw, v2.xyxx, t10.wxyz, s3
...
sample_indexable(texture2d)(float,float,float,float) r3.xyzw, v2.xyxx, t18.xyzw, s5
