// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:29:04 2021
...
cbuffer _Globals : register(b0)
{
  ...
  float vertPush : packoffset(c15.w);
  float scriptPush : packoffset(c16);
}
...
r0.x = colorSampler[]..swiz;
  ...
  r3.xy = r2.yz * float2(1.9921875,1.9921875) + float2(-1,-1);
  ...
  r0.z = debugGlossOverride.x * r2.x + glossRange.x;
  ...
  if (r1.w != 0) {
    ...
    r2.yzw = r2.yyy ? r7.xyz : r6.xyw;
    r6.xyz = r6.zzz ? float3(0,1,0) : r1.xyz;
    r1.xyz = r2.xxx ? r2.yzw : r6.xyz;
  }
  ...
  r2.yzw = debugNormalOverride.www * r2.xyz + r3.xyz;
  r0.zw = v7.xy / v7.ww;
