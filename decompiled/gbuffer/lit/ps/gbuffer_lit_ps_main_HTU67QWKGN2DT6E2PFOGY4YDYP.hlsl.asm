...
sample_indexable(texture2d)(float,float,float,float) r0.w, v1.yzyy, t10.yzwx, s5
sample_indexable(texture2d)(float,float,float,float) r1.x, v1.yzyy, t9.xyzw, s3
add r1.y, -cb0[12].x, cb0[12].y
mad r1.x, r1.x, r1.y, cb0[12].x
mul_sat r1.x, r1.x, l(0.05882353)
sample_indexable(texture2d)(float,float,float,float) r2.xyz, v1.yzyy, t7.xyzw, s4
...
if_nz r1.z
  ftoi r1.z, cb1[64].w
  lod r1.w, v1.yzyy, t6.y, s2
  lod r2.x, v1.yzyy, t6.x, s2
  lt r1.w, r1.w, r2.x
...
mad r2.xyz, r3.xyzx, r2.zzzz, -r0.wwww
max r1.w, r2.z, r2.y
max r1.w, r1.w, r2.x
max r0.w, r0.w, r1.w
eq r1.w, r0.w, r2.x
