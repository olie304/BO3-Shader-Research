...
sample_indexable(texture2d)(float,float,float,float) r1.x, v2.xyxx, t10.xyzw, s2
add r1.y, -cb0[12].x, cb0[12].y
mad r1.x, r1.x, r1.y, cb0[12].x
mul_sat r1.x, r1.x, l(0.05882353)
sample_indexable(texture2d)(float,float,float,float) r1.yzw, v2.xyxx, t9.wxyz, s3
