...
sample_indexable(texture2d)(float,float,float,float) r1.xyzw, v1.yzyy, t6.xyzw, s2
mad r0.xyz, r1.wwww, r0.xyzx, l(1.000000, 1.000000, 1.000000, 0.000000)
add r2.xyz, -r0.xyzx, cb0[11].xyzx
mad r0.xyz, r1.zzzz, r2.xyzx, r0.xyzx
add r2.xyz, -r0.xyzx, cb0[10].xyzx
mad r0.xyz, r1.yyyy, r2.xyzx, r0.xyzx
add r1.yzw, -r0.xxyz, cb0[13].xxyz
mad r0.xyz, r1.xxxx, r1.yzwy, r0.xyzx
sample_indexable(texture2d)(float,float,float,float) r1.xyz, v1.yzyy, t0.xyzw, s1
mul o0.xyz, r0.xyzx, r1.xyzx
mov o0.w, l(1.000000)
sample_indexable(texture2d)(float,float,float,float) r0.xyz, v1.yzyy, t7.xyzw, s4
add r0.xyz, r0.xyzx, l(-0.500000, -0.500000, -0.000000, 0.000000)
mad r0.xyz, cb0[13].wwww, r0.xyzx, l(0.500000, 0.500000, 0.000000, 0.000000)
...
sample_indexable(texture2d)(float,float,float,float) r0.x, v1.yzyy, t9.xyzw, s3
