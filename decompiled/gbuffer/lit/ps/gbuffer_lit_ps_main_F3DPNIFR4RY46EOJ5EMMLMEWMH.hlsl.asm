...
sample_indexable(texture2d)(float,float,float,float) r4.xyz, r0.xyxx, t9.xyzw, s2
...
mad r2.xyz, r4.xyzx, r2.zzzz, r5.xyzx
dp3 r3.w, r2.xyzx, r2.xyzx
rsq r3.w, r3.w
mul r2.xyz, r2.xyzx, r3.wwww
mad r0.z, cb1[62].x, r0.z, cb0[11].x
...
mad r5.yzw, cb1[60].wwww, r5.xxyz, r2.xxyz
...
mul r6.x, r0.y, r2.x
mul r6.y, r0.w, -r2.y
mad r0.yw, cb1[44].xxxy, l(0.000000, 0.500000, 0.000000, 0.500000), r6.xxxy
add r0.yw, -r0.yyyw, v0.xxxy
add r1.w, r4.y, r4.x
mad r1.w, r3.z, r2.w, r1.w
mul r1.w, r1.w, l(0.500000)
mad r2.xyz, r3.xyzx, r2.wwww, -r1.wwww
max r2.w, r2.z, r2.y
max r2.w, r2.w, r2.x
max r1.w, r1.w, r2.w
eq r2.x, r1.w, r2.x
...
ge r0.yz, r0.yywy, l(0.000000, 0.000000, 0.000000, 0.000000)
