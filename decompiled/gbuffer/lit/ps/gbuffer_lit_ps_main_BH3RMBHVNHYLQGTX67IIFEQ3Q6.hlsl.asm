...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:29:03 2021
//
//
// Buffer Definitions: 
//
...
sample_indexable(texture2d)(float,float,float,float) r2.yzw, v1.yzyy, t9.wxyz, s4
...
mad r2.x, cb1[62].x, r2.x, cb0[13].x
...
if_nz r2.y
  ftoi r2.y, cb1[64].w
  lod r2.z, v1.yzyy, t6.y, s2
  lod r2.w, v1.yzyy, t6.x, s2
  lt r2.z, r2.z, r2.w
