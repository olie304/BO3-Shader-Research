...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:29:23 2021
//
//
// Buffer Definitions: 
//
...
sample_indexable(texture2d)(float,float,float,float) r0.w, v1.yzyy, t7.yzwx, s3
...
sample_indexable(texture2d)(float,float,float,float) r0.x, v1.yzyy, t11.xyzw, s5
sample_indexable(texture2d)(float,float,float,float) r0.y, v1.yzyy, t10.yxzw, s3
add r0.z, -cb0[13].x, cb0[13].y
mad r0.y, r0.y, r0.z, cb0[13].x
mul_sat r0.y, r0.y, l(0.05882353)
sample_indexable(texture2d)(float,float,float,float) r2.xyz, v1.yzyy, t9.xyzw, s4
