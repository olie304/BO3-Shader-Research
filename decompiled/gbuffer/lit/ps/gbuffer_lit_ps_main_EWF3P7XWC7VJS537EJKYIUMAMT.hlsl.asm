...
sample_indexable(texture2d)(float,float,float,float) r0.x, v1.yzyy, t12.xyzw, s4
sample_indexable(texture2d)(float,float,float,float) r0.y, v1.yzyy, t11.yxzw, s2
...
ftou r2.xy, v0.xyxx
add r3.y, -r1.z, r1.x
mad r0.y, r3.y, l(0.500000), r1.z
add r3.z, -r0.y, r1.y
mad r3.x, r3.z, l(0.500000), r0.y
and r1.xy, r2.xyxx, l(1, 1, 0, 0)
ieq r0.y, r1.y, r1.x
movc r1.xy, r0.yyyy, r3.xyxx, r3.xzxx
