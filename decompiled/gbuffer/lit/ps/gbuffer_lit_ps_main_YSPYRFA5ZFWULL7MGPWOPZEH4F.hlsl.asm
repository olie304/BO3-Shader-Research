...
add_sat r1.z, -r0.w, l(1.000000)
mul o0.xyz, r0.xyzx, r1.zzzz
mov o0.w, l(1.000000)
sample_indexable(texture2d)(float,float,float,float) r0.x, r1.xyxx, t9.xyzw, s2
...
mad r0.y, r0.y, cb0[12].z, r0.z
add r0.x, r0.x, r0.y
log r0.x, r0.x
mul_sat r0.x, r0.x, l(-0.05882353)
mad o1.z, r0.x, l(0.49755621), l(0.00146628)
mad r0.xy, r1.xyxx, cb0[12].zzzz, r1.zwzz
