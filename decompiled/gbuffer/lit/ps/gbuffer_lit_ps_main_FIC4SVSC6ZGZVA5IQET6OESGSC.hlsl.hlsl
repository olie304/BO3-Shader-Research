...
r1.w = colorSampler[]..swiz;
  ...
  r1.w = min(1, r1.w);
  r2.xyzw = detailNormalMask.Sample(detailMaskSampler_s, v2.xy).xyzw;
  r3.w = cmp(0 < r2.x);
  ...
  if (r3.w != 0) {
    r2.x = detailScaleHeight3 * r2.x;
    r7.xyz = r4.xyz;
  } else {
    r3.w = cmp(0 < r2.y);
    if (r3.w != 0) {
      r2.x = detailScaleHeight2 * r2.y;
      r7.xyz = r5.xyz;
    } else {
      r2.y = cmp(0 < r2.z);
      if (r2.y != 0) {
        r2.x = detailScaleHeight1 * r2.z;
        r7.xyz = r6.xyz;
      } else {
        r2.y = cmp(0 < r2.w);
        if (r2.y != 0) {
          r2.x = detailScaleHeight * r2.w;
        } else {
          r7.xyz = float3(0,0,0);
          r2.x = 0;
        }
  ...
  r2.yz = r7.xy * float2(1.9921875,1.9921875) + float2(-1,-1);
  r2.w = r7.z * r7.z;
  r2.w = 0.333333343 * r2.w;
  r2.w = min(1, r2.w);
  r3.xy = r2.yz * r2.xx + r0.zw;
