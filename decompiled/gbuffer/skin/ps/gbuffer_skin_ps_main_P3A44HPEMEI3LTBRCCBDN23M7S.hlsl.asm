...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:31:32 2021
//
//
// Buffer Definitions: 
//
...
//   float4 tensionParms;               // Offset:  176 Size:    16
//
// }
//
...
// stretchNormal                     texture  float4          2d            t12      1 
// compressNormal                    texture  float4          2d            t14      1 
...
mul_sat r1.zw, v7.xxxy, cb0[11].wwww
log r1.zw, r1.zzzw
mul r1.zw, r1.zzzw, cb0[11].zzzz
exp r1.zw, r1.zzzw
lt r2.x, r1.w, r1.z
sample_indexable(texture2d)(float,float,float,float) r2.yzw, v2.xyxx, t14.wxyz, s3
sample_indexable(texture2d)(float,float,float,float) r3.xyz, v2.xyxx, t12.xyzw, s3
movc r2.yzw, r2.xxxx, r2.yyzw, r3.xxyz
movc r1.z, r2.x, r1.z, r1.w
movc r1.w, r2.x, cb0[11].y, cb0[11].x
sample_indexable(texture2d)(float,float,float,float) r3.xyz, v2.xyxx, t6.xyzw, s3
...
mad r3.xy, r2.xyxx, cb0[10].wwww, r3.xyxx
dp3 r2.x, r3.xyzx, r3.xyzx
rsq r2.x, r2.x
mul r2.xyz, r2.xxxx, r3.xyzx
mad r1.z, r1.w, cb0[10].w, r1.z
...
mad r5.xyz, cb1[58].wwww, r5.xyzx, r0.xyzx
mad r0.x, r1.y, l(1.000000), -r1.x
mad r0.x, cb1[62].w, r0.x, r1.x
add r0.y, -r0.w, cb1[63].x
mad o2.z, cb1[63].w, r0.y, r0.w
movc r0.yzw, v8.xxxx, v3.xxyz, -v3.xxyz
dp3 r1.x, r0.yzwy, r0.yzwy
rsq r1.x, r1.x
mad r0.yzw, r0.yyzw, r1.xxxx, -r2.xxyz
mad r2.yzw, cb1[60].wwww, r0.yyzw, r2.xxyz
sample_indexable(texture2d)(float,float,float,float) r0.y, v2.xyxx, t11.yxzw, s1
mov_sat r0.y, r0.y
add r0.y, -r0.y, l(1.000000)
mov r5.w, l(0.500000)
mul r0.yzw, r0.yyyy, r5.xxww
mov r1.x, l(1.000000)
mul r0.w, r0.w, r5.z
...
ftou r2.xy, v0.xyxx
mad r3.y, r0.y, r1.x, -r0.w
mad r0.x, r3.y, l(0.500000), r0.w
mad r3.z, r0.z, r5.y, -r0.x
