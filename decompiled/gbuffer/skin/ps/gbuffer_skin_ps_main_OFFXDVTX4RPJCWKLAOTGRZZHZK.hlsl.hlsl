  ...
  out float2 o3 : SV_TARGET3)
{
  ...
  o0.xyz = r0.xyz;
  r1.xy = saturate(tensionParms.ww * v6.xy);
  r1.xy = log2(r1.xy);
  r1.xy = tensionParms.zz * r1.xy;
  r1.xy = exp2(r1.xy);
  r0.w = cmp(r1.y < r1.x);
  r1.x = r0.w ? r1.x : r1.y;
  r1.y = r0.w ? tensionParms.y : tensionParms.x;
  r1.x = r1.x * r1.y;
  r1.yzw = compressNormal.Sample(normalSampler_s, w1.xy).xyz;
  r2.xyz = stretchNormal.Sample(normalSampler_s, w1.xy).xyz;
  ...
  r1.xy = r2.xy * detailScaleHeight + r1.xy;
  r1.w = dot(r1.xyz, r1.xyz);
  r1.w = rsqrt(r1.w);
  r1.xyz = r1.xyz * r1.www;
  ...
  r0.w = saturate(r0.w);
  r0.w = 1 + -r0.w;
  r1.xyz = float3(1,0.5,0.5) * r0.www;
  r0.z = r1.z * r0.z;
  r2.y = r1.x * r0.x + -r0.z;
  r0.x = r2.y * 0.5 + r0.z;
  r2.z = r1.y * r0.y + -r0.x;
