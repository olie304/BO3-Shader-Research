...
r3.w = gpuSkinBase[]..swiz;
  ...
  if (r1.w != 0) {
    ...
    r7.w = gpuSkinBase[]..swiz;
      ...
      r4.z = v5.x * r2.z;
    // Known bad code for instruction (needs manual fix):
        ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r2.y, r2.y, l(48), t5.xxxx
    r2.y = gpuSkinBase[]..swiz;
      r7.z = v5.x * r2.y;
    ...
    if (r1.w != 0) {
      ...
      r12.xyz = r10.xxx * r6.xzw;
      r1.w = r10.y * r6.w;
      r10.zw = r10.zz * r6.wz;
      r7.w = r6.y * r10.y + r10.w;
      r13.x = 1 + -r7.w;
      r14.x = r6.z * r10.x + -r1.w;
      r13.y = r6.y * r10.x + -r10.z;
      r15.xy = r6.yx * r10.xx + r10.zw;
      r15.z = r6.z * r10.y + -r12.z;
      r6.xyz = r6.zwy * r10.yyy + r12.zyx;
      r13.z = r6.y;
      r10.x = dot(r9.xyz, r13.xyz);
      r15.w = 1 + -r15.y;
      r10.y = dot(r9.xzy, r15.xzw);
      r14.yz = r6.xz * float2(1,-1) + float2(0,1);
      r10.z = dot(r9.xyz, r14.xyz);
      r6.x = dot(r0.xyz, r13.xyz);
      r6.y = dot(r0.xzy, r15.xzw);
      r6.z = dot(r0.xyz, r14.xyz);
      ...
      if (r1.w != 0) {
        ...
        if (r1.w != 0) {
          ...
          r1.w = r10.y * r6.w;
          r10.zw = r10.zz * r6.wz;
          r3.z = r6.y * r10.y + r10.w;
          r12.x = 1 + -r3.z;
          r13.x = r6.z * r10.x + -r1.w;
          r12.y = r6.y * r10.x + -r10.z;
          r14.xy = r6.yx * r10.xx + r10.zw;
