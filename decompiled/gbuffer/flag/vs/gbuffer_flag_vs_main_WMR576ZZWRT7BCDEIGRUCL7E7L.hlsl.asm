...
mul r5.xyzw, r1.zzzz, cb1[9].xyzw
mov r4.w, r3.y
mov r7.w, r3.w
dp4 r1.z, r2.xyzw, r4.xyzw
mad r5.xyzw, r1.zzzz, cb1[8].xyzw, r5.xyzw
dp4 r1.z, r2.xyzw, r7.xyzw
mad r5.xyzw, r1.zzzz, cb1[10].xyzw, r5.xyzw
add o0.xyzw, r5.xyzw, cb1[11].xyzw
log r3.yzw, |v1.xxyz|
mul r3.yzw, r3.yyzw, l(0.000000, 2.200000, 2.200000, 2.200000)
exp o1.xyz, r3.yzwy
mov o1.w, l(1.000000)
mov o2.xy, v2.xyxx
mul r1.zw, cb0[15].xxxz, l(0.000000, 0.000000, 25.132742, 34.456177)
mul r1.z, r1.x, r1.z
mul r3.y, cb0[14].z, l(27.239243)
mad r1.z, r3.y, r3.x, r1.z
mul r3.x, r3.x, cb0[14].w
mad r1.z, r1.w, r1.y, r1.z
mul r1.xy, r1.xyxx, cb0[15].ywyy
mul r1.z, r1.z, v1.y
mul r1.xz, r1.xxzx, l(25.132742, 0.000000, 0.025000, 0.000000)
mad r1.x, r3.x, l(27.239243), r1.x
...
mad r1.xzw, r1.zzzz, r3.xxyz, r5.xxyz
...
mul r1.xzw, r3.yyzx, r0.wwyz
mad r0.yzw, r0.zzwy, r3.zzxy, -r1.xxzw
