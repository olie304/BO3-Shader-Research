...
mul r3.w, cb0[19].x, l(34.456177)
mul r4.w, r1.x, cb0[19].y
add r2.x, r2.y, r2.x
...
rsq r0.y, r0.y
mul o5.xyz, r0.yyyy, r3.xyzx
mul r3.xyzw, r10.yyyy, cb1[9].xyzw
mad r3.xyzw, r10.xxxx, cb1[8].xyzw, r3.xyzw
mad r3.xyzw, r10.zzzz, cb1[10].xyzw, r3.xyzw
