...
r4.w = gpuSkinBase[]..swiz;
  ...
  if (r1.w != 0) {
    ...
    r10.x = dot(r2.yzw, r11.xyz);
    r10.y = dot(r2.ywz, r13.xzw);
    r10.z = dot(r2.yzw, r12.xyz);
    ...
    if (r1.w != 0) {
      ...
      r9.x = dot(r2.yzw, r13.xyz);
      r9.y = dot(r2.ywz, r15.xzw);
      r9.z = dot(r2.yzw, r14.xyz);
      ...
      if (r1.w != 0) {
        ...
        if (r1.w != 0) {
          ...
          r7.x = dot(r2.yzw, r11.xyz);
          r7.y = dot(r2.ywz, r13.xzw);
          r7.z = dot(r2.yzw, r12.xyz);
          r5.xyz = r9.xyz + r5.xyz;
          r5.xyz = r5.xyz + r8.xyz;
          r6.xyz = r5.xyz * v5.www + r6.xyz;
          r3.yzw = r1.xyz * v5.www + r3.yzw;
    ...
    r1.x = rsqrt(r1.x);
    r0.yzw = r3.yzw * r1.xxx;
    r1.x = dot(r4.xyw, r4.xyw);
    r1.x = rsqrt(r1.x);
    r2.yzw = r4.xyw * r1.xxx;
  }
  r1.xyz = r2.zwy * r0.wyz;
  r1.xyz = r0.zwy * r2.wyz + -r1.xyz;
