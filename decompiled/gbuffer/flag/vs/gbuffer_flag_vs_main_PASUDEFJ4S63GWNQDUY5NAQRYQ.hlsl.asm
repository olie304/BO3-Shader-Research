...
mul r5.xyzw, r0.xxxx, cb1[9].xyzw
mov r4.w, r3.y
mov r7.w, r3.w
dp4 r0.x, r2.xyzw, r4.xyzw
mad r5.xyzw, r0.xxxx, cb1[8].xyzw, r5.xyzw
dp4 r0.x, r2.xyzw, r7.xyzw
mad r2.xyzw, r0.xxxx, cb1[10].xyzw, r5.xyzw
...
mul r0.x, r1.x, r1.z
mul r1.z, cb0[14].z, l(27.239243)
mad r0.x, r1.z, r3.x, r0.x
mul r1.z, r3.x, cb0[14].w
