...
mov o1.w, l(1.000000)
mov o2.xy, v2.xyxx
mul r1.yz, cb0[18].xxzx, l(0.000000, 27.239243, 25.132742, 0.000000)
mul r1.yz, r3.xxyx, r1.yyzy
mul r3.xy, r3.xyxx, cb0[18].ywyy
mul r3.xy, r3.xyxx, l(27.239243, 25.132742, 0.000000, 0.000000)
add r1.w, r3.y, r3.x
add r1.y, r1.z, r1.y
mul r1.z, cb0[19].x, l(34.456177)
mad r1.y, r1.z, r1.x, r1.y
mul r1.x, r1.x, cb0[19].y
...
mul r5.xyz, r0.wyzw, r3.yzxy
mad r5.xyz, r0.zwyz, r3.zxyz, -r5.xyzx
mul r5.xyz, r1.zzzz, r5.xyzx
dp3 r1.w, r5.xyzx, r5.xyzx
rsq r1.w, r1.w
mul r5.xyz, r1.wwww, r5.xyzx
mul r5.xyz, r1.xxxx, r5.xyzx
mad r1.xyw, r1.yyyy, r3.xyxz, r5.xyxz
