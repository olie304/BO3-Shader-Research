// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:26:59 2021
  ...
  out float2 o3 : SV_TARGET3)
{
  ...
  if (r2.w != 0) {
    ...
    r5.z = colorMap.CalculateLevelOfDetail(colorSampler_s, v2.xy);
    r4.w = cmp(r4.w < r5.z);
    r5.z = cmp(0 < r5.z);
  ...
  o2.z = debugOcclusionOverride.w * r1.z + r1.x;
  r1.xzw = v8.xxx ? v3.xyz : -v3.xyz;
  r2.w = dot(r1.xzw, r1.xzw);
  r2.w = rsqrt(r2.w);
  r1.xzw = r1.xzw * r2.www + -r3.xyz;
  r6.yzw = debugNormalOverride.www * r1.xzw + r3.xyz;
  r1.xz = tintScale.xy * v2.xy;
  r1.xz = tintBlendMask.Sample(tintBlendSampler_s, r1.xz).xy;
  r3.xyz = float3(-1,-1,-1) + clothPrimaryTint.xyz;
  r3.xyz = r1.xxx * r3.xyz + float3(1,1,1);
  r7.xyz = clothSecondaryTint.xyz + -r3.xyz;
  r1.xzw = r1.zzz * r7.xyz + r3.xyz;
  r1.xzw = float3(-1,-1,-1) + r1.xzw;
  r1.xzw = r0.www * r1.xzw + float3(1,1,1);
  r3.xyz = r1.xzw * r0.xyz;
  ...
  r5.z = rsqrt(r5.z);
  r7.xyz = -v7.xyz * r5.zzz;
  r5.z = saturate(dot(r6.yzw, r7.xyz));
  r5.z = 1 + -r5.z;
  ...
  r0.w = r0.w + r4.w;
  r0.w = min(1, r0.w);
  r0.xyz = r0.xyz * r1.xzw + -r2.xyz;
  r0.xyz = r4.www * r0.xyz + r2.xyz;
  r1.xzw = r3.xyz * r0.www;
  o0.xyz = r2.www ? r1.xzw : r3.xyz;
  r0.xyz = r2.www ? r0.xyz : r2.xyz;
  r1.xz = v6.xy / v6.ww;
  r2.xy = float2(0.5,0.5) * renderTargetSize.xy;
  r3.x = r2.x * r1.x;
  r3.y = -r2.y * r1.z;
  r1.xz = renderTargetSize.xy * float2(0.5,0.5) + r3.xy;
  r1.xz = v0.xy + -r1.xz;
  r0.w = r5.x + r5.y;
  r0.w = r4.z * r3.w + r0.w;
  r0.w = 0.5 * r0.w;
  r2.xyz = r4.xyz * r3.www + -r0.www;
  r1.w = max(r2.y, r2.z);
  r1.w = max(r2.x, r1.w);
  r0.w = max(r1.w, r0.w);
  r1.w = cmp(r0.w == r2.x);
  r3.yzw = float3(1,-1,-1) * r6.yzw;
  r2.x = 2 + r0.w;
  r3.x = 1;
  r6.x = 0;
  r3.xyzw = r1.wwww ? r3.xyzw : r6.xyzw;
  r0.w = r1.w ? r2.x : r0.w;
  r1.w = cmp(r0.w == r2.y);
