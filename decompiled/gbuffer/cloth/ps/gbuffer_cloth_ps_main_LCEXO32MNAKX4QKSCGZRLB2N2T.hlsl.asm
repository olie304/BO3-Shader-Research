...
sqrt r4.w, r4.w
dp3 r5.z, -v5.xyzx, -v5.xyzx
rsq r5.z, r5.z
mul r7.xyz, r5.zzzz, -v5.xyzx
...
mad r1.yzw, r4.xxyz, r3.wwww, -r0.wwww
max r2.x, r1.w, r1.z
max r2.x, r1.y, r2.x
max r0.w, r0.w, r2.x
eq r1.y, r0.w, r1.y
mul r2.yzw, r6.yyzw, l(0.000000, 1.000000, -1.000000, -1.000000)
add r3.x, r0.w, l(2.000000)
mov r2.x, l(1)
mov r6.x, l(0)
movc r2.xyzw, r1.yyyy, r2.xyzw, r6.xyzw
