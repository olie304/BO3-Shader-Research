  ...
  out float2 o3 : SV_TARGET3)
{
  ...
  r2.y = cmp(0 < r4.x);
  r2.zw = detailScale3.xy * v2.xy;
  r5.xyz = detailNormal1.Sample(normalSampler_s, r2.zw).xyz;
  r2.zw = detailScale2.xy * v2.xy;
  ...
  r0.x = r0.x + r2.w;
  r0.x = min(1, r0.x);
  r0.yzw = r0.yzw * r5.xyz + float3(-0.0399999991,-0.0399999991,-0.0399999991);
  r0.yzw = r2.www * r0.yzw + float3(0.0399999991,0.0399999991,0.0399999991);
  r5.xyz = r6.xyz * r0.xxx;
  o0.xyz = r1.zzz ? r5.xyz : r6.xyz;
  r0.xyz = r1.zzz ? r0.yzw : float3(0.0399999991,0.0399999991,0.0399999991);
  r4.zw = v6.xy / v6.ww;
  ...
  r5.x = 1;
  r3.x = 0;
  r3.xyzw = r1.zzzz ? r5.xyzw : r3.xyzw;
  r0.w = r1.z ? r1.w : r0.w;
  r1.z = cmp(r0.w == r2.y);
  r5.yzw = float3(-1,1,-1) * r3.yzw;
  r1.w = 2 + r0.w;
