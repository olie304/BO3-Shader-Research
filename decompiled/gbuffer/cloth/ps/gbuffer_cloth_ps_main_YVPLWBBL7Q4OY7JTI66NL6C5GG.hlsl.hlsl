...
r0.x = colorSampler[]..swiz;
  ...
  if (r3.z != 0) {
    ...
    r4.xyz = float3(0.0399999991,0.0399999991,0.0399999991) + -r2.xyz;
  ...
  o2.z = debugOcclusionOverride.w * r1.w + r2.w;
  r3.xyz = v8.xxx ? v3.xyz : -v3.xyz;
