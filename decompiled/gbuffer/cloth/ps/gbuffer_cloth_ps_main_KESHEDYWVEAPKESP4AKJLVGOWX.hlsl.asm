...
discard_nz r1.y
sample_indexable(texture2d)(float,float,float,float) r1.y, v1.yzyy, t9.yxzw, s4
sample_indexable(texture2d)(float,float,float,float) r1.z, v1.yzyy, t7.yzxw, s2
...
mul r1.yz, v1.yyzy, cb0[11].yyzy
sample_indexable(texture2d)(float,float,float,float) r1.yz, r1.yzyy, t12.zxyw, s6
...
sample_indexable(texture2d)(float,float,float,float) r0.w, v1.yzyy, t11.yzwx, s5
mul r4.w, r0.w, cb0[11].x
...
mul r5.z, r5.w, r5.z
exp r5.z, r5.z
mad_sat r0.w, -r0.w, cb0[11].x, l(1.000000)
add r0.w, r5.z, r0.w
