  ...
  out float2 o3 : SV_TARGET3)
{
  ...
  o0.xyz = r2.www ? r1.yzw : r3.xyz;
  r0.xyz = r2.www ? r0.xyz : r2.xyz;
  r1.yz = v6.xy / v6.ww;
  r2.xy = float2(0.5,0.5) * renderTargetSize.xy;
  r3.x = r2.x * r1.y;
  r3.y = -r2.y * r1.z;
  r1.yz = renderTargetSize.xy * float2(0.5,0.5) + r3.xy;
  r1.yz = v0.xy + -r1.yz;
  r0.w = r5.x + r5.y;
  r0.w = r4.z * r3.w + r0.w;
  r0.w = 0.5 * r0.w;
