...
mad r2.xy, r1.xyxx, cb0[10].wwww, r0.yzyy
...
mul r0.x, r0.y, r0.x
exp r0.x, r0.x
sample_indexable(texture2d)(float,float,float,float) r0.y, v1.yzyy, t11.yxzw, s5
mad_sat r0.z, -r0.y, cb0[11].x, l(1.000000)
...
sample_indexable(texture2d)(float,float,float,float) r5.xyzw, v1.yzyy, t0.xyzw, s1
mul_sat r0.w, r5.w, v1.x
mad r4.xyz, r0.wwww, r4.xyzx, l(1.000000, 1.000000, 1.000000, 0.000000)
mul r6.xyz, r4.xyzx, r5.xyzx
mad r4.xyz, r5.xyzx, r4.xyzx, l(-0.040000, -0.040000, -0.040000, 0.000000)
mad r4.xyz, r0.xxxx, r4.xyzx, l(0.040000, 0.040000, 0.040000, 0.000000)
movc r4.xyz, r0.yyyy, r4.xyzx, l(0.040000,0.040000,0.040000,0)
mul r0.xzw, r0.zzzz, r6.xxyz
movc o0.xyz, r0.yyyy, r0.xzwx, r6.xyzx
mov o0.w, l(1.000000)
mad r0.xyz, r2.xyzx, r1.wwww, -r1.xxxx
max r0.w, r0.z, r0.y
max r0.w, r0.w, r0.x
max r0.w, r0.w, r1.x
eq r0.x, r0.w, r0.x
add r1.x, r0.w, l(2.000000)
movc r0.w, r0.x, r1.x, r0.w
eq r0.y, r0.w, r0.y
add r1.x, r0.w, l(2.000000)
movc r0.w, r0.y, r1.x, r0.w
eq r0.z, r0.w, r0.z
