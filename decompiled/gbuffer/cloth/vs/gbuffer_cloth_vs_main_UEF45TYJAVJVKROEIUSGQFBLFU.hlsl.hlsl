// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:27:12 2021
...
r1.y = shaderConstantSetBuffer[]..swiz;
  ...
  r0.xyz = r6.xyz * r1.yyy + v0.xyz;
  r7.y = dot(r0.xyzw, r4.xyzw);
  r8.xyzw = viewProjectionMatrix._m10_m11_m12_m13 * r7.yyyy;
  r2.w = r3.x;
  r5.w = r3.z;
  r7.x = dot(r0.xyzw, r2.xyzw);
  r3.xyzw = r7.xxxx * viewProjectionMatrix._m00_m01_m02_m03 + r8.xyzw;
  r7.z = dot(r0.xyzw, r5.xyzw);
  r0.xyzw = r7.zzzz * viewProjectionMatrix._m20_m21_m22_m23 + r3.xyzw;
  o7.xyz = r7.xyz;
  ...
  r3.xyz = r6.zxy * r0.yzx;
  r0.xyz = r6.yzx * r0.zxy + -r3.xyz;
  r0.w = v4.w * 2 + -1;
