...
sample_indexable(texture2d)(float,float,float,float) r3.xyzw, r1.xyxx, t10.xyzw, s3
...
mov r3.zw, l(0,0,0,0)
ftou r3.xy, v0.xyxx
ld_indexable(texture2d)(float,float,float,float) r2.xy, r3.xyzw, t6.zwxy
and r3.xy, r3.xyxx, l(1, 1, 0, 0)
ieq r0.w, r3.y, r3.x
mad r2.y, r2.y, l(3.000000), l(0.500000)
ftou r2.y, r2.y
and r3.xyzw, r2.yyyy, l(2, 1, 2, 1)
movc r3.xyzw, r3.zwxy, l(-0.57735026,-0.57735026,1,1), l(0.57735026,0.57735026,0,0)
xor r2.y, r3.w, r3.z
movc r3.z, r2.y, l(-0.57735026), l(0.57735026)
...
mul r0.xy, r2.yyyy, r3.xyxx
mad r0.xy, r0.xyxx, l(0.58823532, 0.58823532, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r2.yz, r1.xyxx, t11.yxwz, s2
sample_indexable(texture2d)(float,float,float,float) r3.xyzw, r1.xyxx, t9.xyzw, s2
add r1.x, -cb0[12].x, cb0[12].y
mad r1.x, r2.y, r1.x, cb0[12].x
mul r1.y, r2.w, r2.z
mul r2.y, r2.w, r3.w
