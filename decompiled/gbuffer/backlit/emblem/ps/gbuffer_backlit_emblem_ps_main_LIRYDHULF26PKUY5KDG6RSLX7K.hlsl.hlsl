// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:26:06 2021
...
cbuffer _Globals : register(b0)
{
  ...
  float4 emblemSCALEandOFFSET : packoffset(c13);
}
...
Texture2D<float4> codeEmblemTexture1 : register(t9);
  ...
  out float2 o3 : SV_TARGET3)
{
  ...
  r5.yz = w1.xy * emblemSCALEandOFFSET.xy + emblemSCALEandOFFSET.zw;
  r2.z = 1 + -r5.y;
  r5.x = v6.x ? r5.y : r2.z;
  r2.zw = float2(-0.5,-0.5) + r5.xz;
  r2.z = max(abs(r2.z), abs(r2.w));
  r2.z = cmp(0.5 < r2.z);
  r2.z = r2.z ? 0 : 1;
  r5.xyzw = codeEmblemTexture1.Sample(colorSampler_s, r5.xz).xyzw;
  r5.xyz = r5.xyz * r2.zzz;
  r2.z = -r5.w * r2.z + 1;
  r0.xyz = r0.xyz * r2.zzz + r5.xyz;
  ...
  r2.y = max(r2.w, r2.y);
  r2.w = cmp(r2.y == r3.x);
  r6.yzw = float3(1,-1,-1) * r1.yzw;
  r3.x = 2 + r2.y;
  r6.x = 1;
  r1.x = 0;
  r1.xyzw = r2.wwww ? r6.xyzw : r1.xyzw;
  r2.y = r2.w ? r3.x : r2.y;
  r2.w = cmp(r2.y == r3.y);
  r6.yzw = float3(-1,1,-1) * r1.yzw;
  r3.x = 2 + r2.y;
