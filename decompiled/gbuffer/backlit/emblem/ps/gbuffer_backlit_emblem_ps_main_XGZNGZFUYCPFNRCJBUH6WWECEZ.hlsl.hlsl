// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:26:07 2021
...
Texture2D<float4> codeEmblemTexture2 : register(t9);
  ...
  out float2 o3 : SV_TARGET3)
{
  ...
  r2.z = cmp(0.5 < r2.z);
  r2.z = r2.z ? 0 : 1;
  r5.xyzw = codeEmblemTexture2.Sample(colorSampler_s, r5.xz).xyzw;
