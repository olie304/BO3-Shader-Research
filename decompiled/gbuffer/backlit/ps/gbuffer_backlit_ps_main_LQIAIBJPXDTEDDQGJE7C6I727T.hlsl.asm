...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:26:19 2021
//
//
// Buffer Definitions: 
//
...
sample_indexable(texture2d)(float,float,float,float) r2.yzw, v2.xyxx, t7.wxyz, s3
...
mad r2.yzw, cb1[60].wwww, r2.xxyz, r3.xxzw
dp3 r3.x, l(0.212600, 0.715200, 0.072200, 0.000000), r1.xyzx
lt r3.x, l(0.091000), r3.x
if_nz r3.x
  div r3.xz, v6.xxyx, v6.wwww
  mul r6.xyzw, cb1[44].xyxy, l(0.500000, 0.500000, 0.500000, -0.500000)
  mad r3.xz, r3.xxzx, r6.zzwz, r6.xxyx
  add r3.xz, -r3.xxzx, v0.xxyx
  add r3.w, r5.y, r5.x
  mad r3.w, r4.z, r3.y, r3.w
  mul r3.w, r3.w, l(0.500000)
  mad r6.xyz, r4.xyzx, r3.yyyy, -r3.wwww
  max r4.w, r6.z, r6.y
  max r4.w, r4.w, r6.x
  max r3.w, r3.w, r4.w
  eq r4.w, r3.w, r6.x
  mul r7.yzw, r2.yyzw, l(0.000000, 1.000000, -1.000000, -1.000000)
  add r5.z, r3.w, l(2.000000)
  mov r7.x, l(1)
  mov r2.x, l(0)
  movc r7.xyzw, r4.wwww, r7.xyzw, r2.xyzw
  movc r3.w, r4.w, r5.z, r3.w
  eq r4.w, r3.w, r6.y
  ...
  add r1.xy, |r3.xzxx|, l(-10.000000, -10.000000, 0.000000, 0.000000)
  mul_sat r1.xy, r1.xyxx, l(0.03333334, 0.03333334, 0.000000, 0.000000)
  mul r5.zw, |r3.xxxz|, l(0.000000, 0.000000, 0.100000, 0.100000)
  ...
  ge r3.xz, r3.xxzx, l(0.000000, 0.000000, 0.000000, 0.000000)
  movc o3.xy, r3.xzxx, r1.xyxx, -r1.xyxx
  mov o0.xyz, r0.xyzx
  mov o0.w, l(1.000000)
...
sample_indexable(texture2d)(float,float,float,float) r1.x, v2.xyxx, t11.xyzw, s1
mul r3.xzw, r0.xxyz, cb0[13].xxyz
...
add r1.z, r5.y, r5.x
mad r1.z, r4.z, r3.y, r1.z
mul r1.z, r1.z, l(0.500000)
mad r4.xyz, r4.xyzx, r3.yyyy, -r1.zzzz
max r3.y, r4.z, r4.y
max r3.y, r3.y, r4.x
max r1.z, r1.z, r3.y
eq r3.y, r1.z, r4.x
...
mov r6.x, l(1)
mov r2.x, l(0)
movc r2.xyzw, r3.yyyy, r6.xyzw, r2.xyzw
movc r1.z, r3.y, r3.w, r1.z
eq r3.y, r1.z, r4.y
mul r6.yzw, r2.yyzw, l(0.000000, -1.000000, 1.000000, -1.000000)
add r3.w, r1.z, l(2.000000)
mov r6.x, l(2)
...
ftou r1.zw, v0.xxxy
mad r2.y, r3.x, r1.x, -r1.y
mad r1.y, r2.y, l(0.500000), r1.y
mad r2.z, r3.z, r1.x, -r1.y
