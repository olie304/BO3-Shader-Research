// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:26:16 2021
  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r6.xyz = debugSpecularOverride.xyz + -r1.xyz;
  r1.xyz = debugSpecularOverride.www * r6.xyz + r1.xyz;
  r2.x = r2.x + -r1.w;
  r1.w = debugGlossOverride.w * r2.x + r1.w;
  r2.x = debugOcclusionOverride.x + -r0.w;
  r0.w = debugOcclusionOverride.w * r2.x + r0.w;
  r2.xyw = v5.xxx ? v2.xyz : -v2.xyz;
  r3.w = dot(r2.xyw, r2.xyw);
  r3.w = rsqrt(r3.w);
  r2.xyw = r2.xyw * r3.www + -r3.xyz;
  r3.yzw = debugNormalOverride.www * r2.xyw + r3.xyz;
  ...
  if (r2.x != 0) {
    ...
    r7.x = 1;
    r3.x = 0;
    r7.xyzw = r2.yyyy ? r7.xyzw : r3.xyzw;
    r2.x = r2.y ? r2.w : r2.x;
    r2.y = cmp(r2.x == r6.y);
    r8.yzw = float3(-1,1,-1) * r7.yzw;
    r2.w = 2 + r2.x;
    r8.x = 2;
    r7.xyzw = r2.yyyy ? r8.xyzw : r7.xyzw;
    r2.x = r2.y ? r2.w : r2.x;
    r2.x = cmp(r2.x == r6.z);
    ...
    r7.y = r6.w + -r6.y;
    r7.x = -r6.z * 3 + r7.z;
    r2.xyw = float3(0.408248305,0.707106769,0.577350259) * r7.xyz;
    r2.w = 1 + abs(r2.w);
    r2.w = rsqrt(r2.w);
    r2.xy = r2.xy * r2.ww;
    o1.xy = r2.xy * float2(0.588235319,0.588235319) + float2(0.5,0.5);
  ...
  r2.xyw = backlightScatterColor.xyz * r0.xyz;
  r1.x = 1 + -r1.x;
  r1.y = r2.w * r1.x;
  r1.z = r5.x + r5.y;
  r1.z = r4.z * r2.z + r1.z;
  r1.z = 0.5 * r1.z;
  r4.xyz = r4.xyz * r2.zzz + -r1.zzz;
  r2.z = max(r4.y, r4.z);
  r2.z = max(r4.x, r2.z);
  r1.z = max(r2.z, r1.z);
  r2.z = cmp(r1.z == r4.x);
  ...
  r5.x = 1;
  r3.x = 0;
  r3.xyzw = r2.zzzz ? r5.xyzw : r3.xyzw;
  r1.z = r2.z ? r2.w : r1.z;
  r2.z = cmp(r1.z == r4.y);
  r5.yzw = float3(-1,1,-1) * r3.yzw;
  r2.w = 2 + r1.z;
