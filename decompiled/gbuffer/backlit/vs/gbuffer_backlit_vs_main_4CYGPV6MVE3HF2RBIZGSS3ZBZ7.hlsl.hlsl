// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:26:28 2021
...
// unknown dcl_: dcl_resource_structured t5, 64
  ...
  r0.x = dot(v0.xz, v0.xz);
  r0.x = sqrt(r0.x);
  r0.x = weather.windSpeed * r0.x;
  r0.x = weather.windDirSin * r0.x;
  r0.y = weather.windSpeed * gameTime.w;
  r0.z = 0.899999976 * r0.y;
...
r1.x = modelInstanceBuffer[]..swiz;
  r0.z = r1.x * 0.100000001 + r0.z;
  r0.z = 0.0700000003 * r0.z;
  r0.z = sin(r0.z);
  r0.z = r0.z * 0.5 + 0.5;
  r1.x = gameTime.w * weather.windSpeed + 0.5;
  r1.y = 0.699999988 * r1.x;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r1.z, r0.w, l(28), t5.xxxx
r1.z = modelInstanceBuffer[]..swiz;
  r1.y = r1.z * 0.100000001 + r1.y;
  ...
  r0.z = 0.5 * r0.z;
  r0.x = r0.x * r0.z;
  r1.yz = vertexColorScale.xy * v1.xy;
  r0.x = r1.y * r0.x;
// Known bad code for instruction (needs manual fix):
...
r5.w = modelInstanceBuffer[]..swiz;
  ...
  r6.xyz = v0.xyz;
  r6.w = 1;
  r7.x = dot(r6.xyzw, r2.xyzw);
  r4.w = r3.y;
  r5.w = r3.z;
  r7.y = dot(r6.xyzw, r4.xyzw);
  r7.z = dot(r6.xyzw, r5.xyzw);
  r3.xyz = eyeOffset.xyz + r7.xyz;
  r0.y = r0.y * 0.899999976 + r3.x;
  r0.y = 0.699999988 * r0.y;
  r0.y = sin(r0.y);
  r0.w = r1.x * 0.699999988 + r3.x;
  r0.w = 0.699999988 * r0.w;
  r0.w = cos(r0.w);
  r1.x = r0.y * r0.w;
  r1.w = 0.00999999978 * v0.z;
  r1.x = r1.x * r1.w;
  r6.z = r1.x * r1.z;
  r1.xw = weather.windSpeed * weather.windDirSin;
  r0.yw = r1.xw * r0.yw;
  r6.xy = r0.yw * r1.zz;
  r6.xyz = float3(0.109999999,0.129999995,0.0900000036) * r6.xyz;
  r6.x = r0.x * 0.00999999978 + r6.x;
  r0.x = dot(v0.yz, v0.yz);
  r0.x = sqrt(r0.x);
  r0.x = weather.windSpeed * r0.x;
  r0.x = weather.windDirCos * r0.x;
  r0.x = r0.x * r0.z;
  r0.x = r0.x * r1.y;
  o1.xy = r1.yz;
  r6.y = r0.x * 0.00999999978 + r6.y;
  ...
  r1.xyzw = r0.zzzz * viewProjectionMatrix._m20_m21_m22_m23 + r1.xyzw;
