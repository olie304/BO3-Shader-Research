// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:26:29 2021
...
cbuffer _Globals : register(b0)
{
  ...
  float3 backlightScatterColor : packoffset(c14);
}
...
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r2.x, r1.w, l(12), t5.xxxx
r2.x = shaderConstantSetBuffer[]..swiz;
  r1.z = r2.x * 0.100000001 + r1.z;
  r1.z = 0.0700000003 * r1.z;
  r1.z = sin(r1.z);
  r1.z = r1.z * 0.5 + 0.5;
  r2.x = gameTime.w * weather.windSpeed + 0.5;
  r2.y = 0.699999988 * r2.x;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r2.z, r1.w, l(28), t5.xxxx
r2.z = shaderConstantSetBuffer[]..swiz;
  r2.y = r2.z * 0.100000001 + r2.y;
...
r6.w = shaderConstantSetBuffer[]..swiz;
  ...
  r7.w = 1;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r1.w, v5.x, l(4), t4.xxxx
r1.w = shaderConstantSetBuffer[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) r1.w, r1.w, l(96), t0.xxxx
r1.w = shaderConstantSetBuffer[]..swiz;
  r8.xyz = v3.xyz * float3(2.00195694,2.00195694,2.00195694) + float3(-1.00195694,-1.00195694,-1.00195694);
  r7.xyz = r8.xyz * r1.www + v0.xyz;
  r9.x = dot(r7.xyzw, r3.xyzw);
  r5.w = r4.y;
  r6.w = r4.z;
  r9.y = dot(r7.xyzw, r5.xyzw);
  r9.z = dot(r7.xyzw, r6.xyzw);
  r4.xyz = eyeOffset.xyz + r9.xyz;
  r1.y = r1.y * 0.899999976 + r4.x;
  r1.y = 0.699999988 * r1.y;
  r1.y = sin(r1.y);
  r1.w = r2.x * 0.699999988 + r4.x;
  ...
  r1.yw = r2.xw * r1.yw;
  r7.xy = r1.yw * r2.zz;
  r7.xyz = float3(0.109999999,0.129999995,0.0900000036) * r7.xyz;
  r7.x = r1.x * 0.00999999978 + r7.x;
  ...
  r2.z = dot(r0.xyz, r6.xyz);
  r0.w = dot(r2.xyz, r2.xyz);
  r0.w = rsqrt(r0.w);
  o4.xyz = r2.xyz * r0.www;
  r2.xyz = r8.zxy * r0.yzx;
  r0.xyz = r8.yzx * r0.zxy + -r2.xyz;
  r0.w = v4.w * 2 + -1;
