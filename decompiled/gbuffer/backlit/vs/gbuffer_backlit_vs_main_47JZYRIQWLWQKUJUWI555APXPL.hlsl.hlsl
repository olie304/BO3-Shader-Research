...
r4.w = modelInstanceBuffer[]..swiz;
  ...
  r4.y = r3.x;
  r4.x = -r1.x;
  r1.w = dot(r4.xy, r0.yz);
  r1.z = dot(r4.yz, r0.yz);
  r0.yz = gameTime.ww * scrollUVs.xy;
  r0.yz = r0.yz * scaleUVs.xy + r1.zw;
