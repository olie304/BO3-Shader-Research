...
sqrt r0.x, r0.x
mul r0.x, r0.x, cb2[38].y
mul r0.x, r0.x, cb2[38].z
mul r0.y, cb1[69].w, cb2[38].y
mul r0.z, r0.y, l(0.900000)
...
mov r4.w, r3.y
mov r5.w, r3.z
dp4 r7.y, r6.xyzw, r4.xyzw
dp4 r7.z, r6.xyzw, r5.xyzw
add r3.xyz, r7.xyzx, cb1[24].xyzx
mad r0.y, r0.y, l(0.900000), r3.x
mul r0.y, r0.y, l(0.700000)
sincos r0.y, null, r0.y
mad r0.w, r1.x, l(0.700000), r3.x
mul r0.w, r0.w, l(0.700000)
sincos null, r0.w, r0.w
mul r1.x, r0.w, r0.y
mul r1.w, v0.z, l(0.010000)
mul r1.x, r1.w, r1.x
mul r6.z, r1.z, r1.x
mul r1.xw, cb2[38].zzzw, cb2[38].yyyy
mul r0.yw, r0.yyyw, r1.xxxw
mul r6.xy, r1.zzzz, r0.ywyy
mul r6.xyz, r6.xyzx, l(0.110000, 0.130000, 0.090000, 0.000000)
mad r6.x, r0.x, l(0.010000), r6.x
dp2 r0.x, v0.yzyy, v0.yzyy
sqrt r0.x, r0.x
mul r0.x, r0.x, cb2[38].y
mul r0.x, r0.x, cb2[38].w
mul r0.x, r0.z, r0.x
mul r0.x, r1.y, r0.x
mov o1.xy, r1.yzyy
mad r6.y, r0.x, l(0.010000), r6.y
...
mul r6.xyz, r1.zxyz, r3.yzxy
mad r1.xyz, r1.yzxy, r3.zxyz, -r6.xyzx
