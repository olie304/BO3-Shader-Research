...
sample_indexable(texture2d)(float,float,float,float) r0.w, r1.xyxx, t6.yzwx, s2
sample_indexable(texture2d)(float,float,float,float) r1.x, r1.xyxx, t9.xyzw, s2
add_sat r1.y, -r0.w, l(1.000000)
mul r0.xyz, r0.xyzx, r1.yyyy
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, v2.xyxx, t12.xyzw, s5
mul r3.xyzw, r2.xyzw, cb0[13].yzwx
mul r1.yzw, r3.xxyz, v1.xxyz
mul r1.yzw, r2.wwww, r1.yyzw
add r2.x, -r2.w, l(1.000000)
mad o0.xyz, r0.xyzx, r2.xxxx, r1.yzwy
mov o0.w, l(1.000000)
add r0.x, -cb0[12].x, cb0[12].y
mad r0.y, r1.x, r0.x, cb0[12].x
mad r0.x, cb0[12].w, r0.x, cb0[12].x
...
sample_indexable(texture2d)(float,float,float,float) r3.xyz, r1.zwzz, t11.xyzw, s3
mul r1.z, r3.z, r3.z
mad r2.yz, r3.xxyx, l(0.000000, 1.99218750, 1.99218750, 0.000000), l(0.000000, -1.000000, -1.000000, 0.000000)
mad r3.xy, r2.yzyy, cb0[12].zzzz, r1.xyxx
dp2 r1.x, r1.xyxx, r1.xyxx
add r1.x, -r1.x, l(1.000000)
max r1.x, r1.x, l(0.000000)
sqrt r3.z, r1.x
mul r1.x, r1.z, l(0.33333334)
min r1.x, r1.x, l(1.000000)
mad r0.z, r1.x, cb0[12].z, r0.z
...
mad r0.xyz, r0.xyzx, r2.xxxx, r3.wwww
add r1.y, -r0.z, r0.x
