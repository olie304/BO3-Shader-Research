  ...
  out float2 o3 : SV_TARGET3)
{
  ...
  r1.xyzw = baseColorMap.Sample(baseColorSampler_s, v2.xy).xyzw;
  r1.xyz = colorTint1.xyz * r1.xyz;
  ...
  r2.xy = r2.xy * detailScaleHeight + r1.xy;
  ...
  r0.y = r0.z * detailScaleHeight + r0.y;
  r0.x = r0.y + r0.x;
  r0.x = log2(r0.x);
  r0.x = saturate(-0.0588235296 * r0.x);
  r0.x = r0.x * r1.w;
