...
cbuffer _Globals : register(b0)
{
  ...
  float baseGloss : packoffset(c11.w);
  float3 colorTint1 : packoffset(c12);
}
...
Texture2D<float4> baseColorMap : register(t11);
  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r5.xyzw = baseColorMap.Sample(baseColorSampler_s, v2.xy).xyzw;
  r5.xyz = colorTint1.xyz * r5.xyz;
  r5.xyz = v1.xyz * r5.xyz;
  r2.w = 1 + -r5.w;
