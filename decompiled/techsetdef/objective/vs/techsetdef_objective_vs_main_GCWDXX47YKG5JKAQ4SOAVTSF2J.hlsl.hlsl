...
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r2.xyz, r0.x, l(0), t5.xyzx
...
r3.z = modelInstanceBuffer[]..swiz;
  ...
  r0.yzw = r1.xxx * viewMatrix._m00_m01_m02 + r0.yzw;
  o2.xyz = r0.xxx * viewMatrix._m20_m21_m22 + r0.yzw;
  return;
}