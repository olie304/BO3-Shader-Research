...
void main( 
  ...
  float w1 : TEXCOORD2,
  float4 v2 : COLOR0,
  nointerpolation float2 v3 : TEXCOORD1,
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.xy = v1.xy / w1.xz;
  r1.xyzw = codeTexture0.Sample(samp0_s, r0.xy).xyzw;
  r0.zw = cmp(abs(r0.xy) < float2(0.0199999996,0.0199999996));
  r0.xy = cmp(float2(0.980000019,0.980000019) < abs(r0.xy));
  r0.xz = (int2)r0.yw | (int2)r0.xz;
  r0.x = (int)r0.x | (int)r0.z;
  r0.yz = renderTargetSize.zw * v0.xy;
  r2.xyzw = codeTexture1.Sample(samp0_s, r0.yz).xyzw;
  if (r0.x != 0) {
    o0.xyzw = float4(32768,32768,32768,32768);
    return;
  }
  ...
  r0.xyzw = v3.yyyy * r0.xyzw;
  r0.xyzw = r1.xyzw * v3.xxxx + r0.xyzw;
