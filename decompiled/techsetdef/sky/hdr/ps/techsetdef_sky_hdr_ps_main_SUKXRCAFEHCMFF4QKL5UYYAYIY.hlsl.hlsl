...
cbuffer _Globals : register(b0)
{
  ...
  float3 skyOrigin : packoffset(c10.y);
  float skyHorizonOffset : packoffset(c11);
}
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r1.xyz = colorMap.Sample(colorSampler_s, r0.xyz).xyz;
  r0.w = -r0.z;
  r2.xyz = colorMap.Sample(colorSampler_s, r0.xyw).xyz;
  r2.xyz = r2.xyz + -r1.xyz;
  r1.xyz = skyRotationTransition.www * r2.xyz + r1.xyz;
