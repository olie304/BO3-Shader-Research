...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:43:23 2021
//
//
// Buffer Definitions: 
//
...
//   float3 skyOrigin;                  // Offset:  164 Size:    12
//   float skyHorizonOffset;            // Offset:  176 Size:     4
//
// }
//
...
// colorMap                          texture  float4        cube             t0      1 
...
lt r1.x, r0.w, cb0[11].x
mad_sat r0.x, -v1.z, r0.x, cb0[11].x
max r0.x, r0.x, l(0.000100)
div r0.x, v3.z, r0.x
min r0.x, r0.x, l(131072.000000)
movc r0.x, r1.x, r0.x, l(131072.000000)
add r1.xyz, v3.xyzx, cb0[10].yzwy
mad r0.xyz, r0.yzwy, r0.xxxx, r1.xyzx
dp3 r0.w, r0.xyzx, r0.xyzx
rsq r0.w, r0.w
mul r0.xyz, r0.wwww, r0.xyzx
sample_indexable(texturecube)(float,float,float,float) r1.xyz, r0.xyzx, t0.xyzw, s1
mov r0.w, -r0.z
sample_indexable(texturecube)(float,float,float,float) r2.xyz, r0.xywx, t0.xyzw, s1
add r2.xyz, -r1.xyzx, r2.xyzx
mad r1.xyz, cb1[57].wwww, r2.xyzx, r1.xyzx
