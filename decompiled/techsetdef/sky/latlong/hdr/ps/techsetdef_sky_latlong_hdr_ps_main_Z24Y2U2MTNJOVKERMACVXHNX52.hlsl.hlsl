// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:43:26 2021
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.x = rsqrt(r0.x);
  r0.y = saturate(-v1.z * r0.x + skyHorizonOffset);
  r0.xzw = v1.yxz * r0.xxx;
  r0.y = max(9.99999975e-05, r0.y);
  r0.y = v3.z / r0.y;
  r0.y = min(131072, r0.y);
  r1.x = cmp(r0.w < skyHorizonOffset);
  r0.y = r1.x ? r0.y : 131072;
  r1.xyz = skyOrigin.yxz + v3.yxz;
  ...
  r0.x = r0.x ? r1.x : 0;
  r2.x = r0.x ? -r0.w : r0.w;
  r0.x = abs(r0.z) * -0.0187292993 + 0.0742610022;
  r0.x = r0.x * abs(r0.z) + -0.212114394;
  r0.x = r0.x * abs(r0.z) + 1.57072878;
  r0.y = 1 + -abs(r0.z);
  r0.y = sqrt(r0.y);
  r0.z = r0.x * r0.y;
  r0.z = r0.z * -2 + 3.14159274;
  r0.z = r1.y ? r0.z : 0;
  r2.yz = r0.xx * r0.yy + r0.zz;
  r0.xyz = r2.xyz * float3(-0.159154937,0.318309873,-0.318309873) + float3(0.5,0,1);
  r1.xyz = colorMap.Sample(colorSampler_s, r0.xz).xyz;
  r0.xyz = colorMap.Sample(colorSampler_s, r0.xy).xyz;
  r1.xyz = r1.xyz + -r0.xyz;
  r0.xyz = skyRotationTransition.www * r1.xyz + r0.xyz;
