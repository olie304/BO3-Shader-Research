...
//   float skyScale;                    // Offset:  160 Size:     4
//   float skyFogFraction;              // Offset:  164 Size:     4 [unused]
//   float3 skyOrigin;                  // Offset:  176 Size:    12
//   float skyHorizonOffset;            // Offset:  188 Size:     4
//
// }
//
...
lt r1.x, r0.w, cb0[11].w
mad_sat r0.x, -v1.z, r0.x, cb0[11].w
max r0.x, r0.x, l(0.000100)
div r0.x, v3.z, r0.x
min r0.x, r0.x, l(131072.000000)
movc r0.x, r1.x, r0.x, l(131072.000000)
add r1.xyz, v3.xyzx, cb0[11].xyzx
...
ge r1.z, r1.z, -r1.z
and r1.x, r1.z, r1.x
movc r2.x, r1.x, -r0.w, r0.w
add r0.w, -|r0.z|, l(1.000000)
sqrt r0.w, r0.w
mad r1.x, |r0.z|, l(-0.01872930), l(0.074261)
mad r1.x, r1.x, |r0.z|, l(-0.21211439)
mad r1.x, r1.x, |r0.z|, l(1.57072878)
mul r1.z, r0.w, r1.x
mad r1.z, r1.z, l(-2.000000), l(3.14159274)
and r1.y, r1.y, r1.z
mad r2.yz, r1.xxxx, r0.wwww, r1.yyyy
mad r1.xyz, r2.xyzx, l(-0.15915494, 0.31830987, -0.31830987, 0.000000), l(0.500000, 0.000000, 1.000000, 0.000000)
...
mad r1.xyz, cb1[57].wwww, r1.xyzx, r2.xyzx
dp3 r2.x, r1.xyzx, cb1[51].xyzx
dp3 r2.y, r1.xyzx, cb1[52].xyzx
dp3 r2.z, r1.xyzx, cb1[53].xyzx
dp3 r3.x, r1.xyzx, cb1[54].xyzx
dp3 r3.y, r1.xyzx, cb1[55].xyzx
dp3 r3.z, r1.xyzx, cb1[56].xyzx
mov r1.x, cb1[51].w
mov r1.y, cb1[52].w
mov r1.z, cb1[53].w
...
mul r1.xyz, r0.xyzx, cb0[10].xxxx
...
if_nz r0.w
  ...
  mul r0.w, r0.w, r2.w
  mad r0.xyz, -r0.xyzx, cb0[10].xxxx, r2.xyzx
