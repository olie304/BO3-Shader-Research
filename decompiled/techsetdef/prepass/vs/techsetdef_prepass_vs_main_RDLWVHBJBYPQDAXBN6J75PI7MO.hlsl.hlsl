...
r0.w = modelInstanceBuffer[]..swiz;
  r1.xyz = v1.xyz * float3(2.00195694,2.00195694,2.00195694) + float3(-1.00195694,-1.00195694,-1.00195694);
  o1.x = dot(r1.xyz, r0.yzw);
// Known bad code for instruction (needs manual fix):
...
r2.z = modelInstanceBuffer[]..swiz;
  o1.z = dot(r1.xyz, r2.xyz);
  o1.y = dot(r1.xyz, r0.yzw);
  return;
}