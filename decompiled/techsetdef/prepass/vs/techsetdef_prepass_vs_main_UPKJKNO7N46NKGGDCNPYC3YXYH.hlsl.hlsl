...
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r1.xyzw, v6.x, l(0), t4.xyzw
...
r1.w = shaderConstantSetBuffer[]..swiz;
  if (r1.x != 0) {
    ...
    r2.w = shaderConstantSetBuffer[]..swiz;
      r3.x = dot(r2.xyz, v0.xyz);
      r2.w = r3.x + r2.w;
      r3.x = v4.x * r2.w;
      r2.x = dot(r2.xyz, r0.xyz);
    // Known bad code for instruction (needs manual fix):
  ...
  r2.xyzw = r0.wwww * viewProjectionMatrix._m00_m01_m02_m03 + r2.xyzw;
  r2.xyzw = r1.wwww * viewProjectionMatrix._m20_m21_m22_m23 + r2.xyzw;
  o0.xyzw = viewProjectionMatrix._m30_m31_m32_m33 + r2.xyzw;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r1.xw, v6.x, l(8), t4.xxxy
r1.x = shaderConstantSetBuffer[]..swiz;
r1.w = shaderConstantSetBuffer[]..swiz;
  if (r1.w != 0) {
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r2.xyz, r1.w, l(0), t5.xyzx
  r2.x = shaderConstantSetBuffer[]..swiz;
  r2.y = shaderConstantSetBuffer[]..swiz;
  r2.z = shaderConstantSetBuffer[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r3.xyz, r1.w, l(16), t5.xyzx
  r3.x = shaderConstantSetBuffer[]..swiz;
  r3.y = shaderConstantSetBuffer[]..swiz;
  r3.z = shaderConstantSetBuffer[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r4.xyz, r1.w, l(32), t5.xyzx
  r4.x = shaderConstantSetBuffer[]..swiz;
  r4.y = shaderConstantSetBuffer[]..swiz;
  r4.z = shaderConstantSetBuffer[]..swiz;
  } else {
