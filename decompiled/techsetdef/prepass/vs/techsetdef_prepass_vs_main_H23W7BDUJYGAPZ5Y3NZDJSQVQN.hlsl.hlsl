...
// unknown dcl_: dcl_resource_structured t8, 64
  ...
  r0.xyz = v1.xyz * float3(2.00195694,2.00195694,2.00195694) + float3(-1.00195694,-1.00195694,-1.00195694);
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r1.xyz, v4.x, l(8), t4.xyzx
...
r2.w = gpuSkinBase[]..swiz;
  ...
  if (r0.w != 0) {
    ...
    r5.w = gpuSkinBase[]..swiz;
      ...
      r3.yz = v2.xx * r1.wz;
      r1.z = cmp(v2.y != 0.000000);
      if (r1.z != 0) {
        r1.z = (int)r0.w + (int)v3.y;
      // Known bad code for instruction (needs manual fix):
      ...
      r5.w = gpuSkinBase[]..swiz;
        ...
        r1.z = dot(r5.xyz, r0.xyz);
        r3.z = r1.z * v2.y + r3.z;
        r1.z = cmp(v2.z != 0.000000);
        if (r1.z != 0) {
          r1.z = (int)r0.w + (int)v3.z;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r5.xyzw, r1.z, l(0), t5.xyzw
        r5.x = gpuSkinBase[]..swiz;
        r5.y = gpuSkinBase[]..swiz;
        ...
        r5.w = gpuSkinBase[]..swiz;
          ...
          r1.z = dot(r5.xyz, r0.xyz);
          r3.z = r1.z * v2.z + r3.z;
          r1.z = cmp(v2.w != 0.000000);
          if (r1.z != 0) {
            r0.w = (int)r0.w + (int)v3.w;
          // Known bad code for instruction (needs manual fix):
    ...
    r4.xyz = v2.xxx * r2.xyw;
    r2.xyw = v2.xxx * r5.xyz;
    r0.w = cmp(v2.y != 0.000000);
    if (r0.w != 0) {
      r3.x = v3.y;
      r5.xyzw = gpuSkinQuat.Load(r3.xyz).xyzw;
      r6.xyzw = gpuSkinQuat.Load(r3.xwz).xyzw;
      ...
      r4.xyz = r6.xyz * v2.yyy + r4.xyz;
      r2.xyw = r5.xyz * v2.yyy + r2.xyw;
      r0.w = cmp(v2.z != 0.000000);
      if (r0.w != 0) {
        r3.x = v3.z;
        r5.xyzw = gpuSkinQuat.Load(r3.xyz).xyzw;
        r6.xyzw = gpuSkinQuat.Load(r3.xwz).xyzw;
        ...
        r7.xyz = r8.xyz + r9.xyz;
        r6.xyz = r7.xyz + r6.xyz;
        r4.xyz = r6.xyz * v2.zzz + r4.xyz;
        r2.xyw = r5.xyz * v2.zzz + r2.xyw;
        r0.w = cmp(v2.w != 0.000000);
        if (r0.w != 0) {
          r3.x = v3.w;
          r5.xyzw = gpuSkinQuat.Load(r3.xyz).xyzw;
          r6.xyzw = gpuSkinQuat.Load(r3.xwz).xyzw;
          ...
          r4.xyz = r3.xyz * v2.www + r4.xyz;
          r2.xyw = r5.xyz * v2.www + r2.xyw;
        }
      }
    }
...
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r1.yz, v4.x, l(8), t4.xxyx
r1.y = gpuSkinBase[]..swiz;
r1.z = gpuSkinBase[]..swiz;
...
r4.z = gpuSkinBase[]..swiz;
  ...
  if (r0.x != 0) {
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r0.xy, v4.x, l(16), t4.xyxx
  ...
  r3.w = gpuSkinBase[]..swiz;
    ...
    if (r0.x != 0) {
      ...
      r4.w = gpuSkinBase[]..swiz;
        ...
        r0.y = r0.y + r4.w;
        r3.yz = v2.xx * r0.zy;
        r0.y = cmp(v2.y != 0.000000);
        if (r0.y != 0) {
          r0.y = (int)r0.x + (int)v3.y;
        // Known bad code for instruction (needs manual fix):
        ...
        r4.w = gpuSkinBase[]..swiz;
          ...
          r4.w = gpuSkinBase[]..swiz;
            ...
            r0.y = r0.y + r4.w;
            r3.z = r0.y * v2.z + r3.z;
            r0.y = cmp(v2.w != 0.000000);
            if (r0.y != 0) {
              r0.x = (int)r0.x + (int)v3.w;
            // Known bad code for instruction (needs manual fix):
      ...
      r3.xyz = v2.xxx * r0.xyz;
      r0.x = cmp(v2.y != 0.000000);
      if (r0.x != 0) {
        r4.x = v3.y;
        r5.xyzw = gpuSkinQuat.Load(r4.xyz).xyzw;
        r6.xyzw = gpuSkinQuat.Load(r4.xwz).xyzw;
        ...
        r1.xzw = r6.xyz + r2.xyw;
        r0.xyz = r1.xzw + r0.xyz;
        r3.xyz = r0.xyz * v2.yyy + r3.xyz;
        r0.x = cmp(v2.z != 0.000000);
        if (r0.x != 0) {
          r4.x = v3.z;
          r5.xyzw = gpuSkinQuat.Load(r4.xyz).xyzw;
          r6.xyzw = gpuSkinQuat.Load(r4.xwz).xyzw;
          ...
          r1.xzw = r6.xyz + r2.xyw;
          r0.xyz = r1.xzw + r0.xyz;
          r3.xyz = r0.xyz * v2.zzz + r3.xyz;
          r0.x = cmp(v2.w != 0.000000);
          if (r0.x != 0) {
            r4.x = v3.w;
            r5.xyzw = gpuSkinQuat.Load(r4.xyz).xyzw;
            r6.xyzw = gpuSkinQuat.Load(r4.xwz).xyzw;
  ...
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r0.x, v4.x, l(16), t4.xxxx
  r0.x = gpuSkinBase[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r2.xyzw, r0.x, l(48), t5.xyzw
  r2.x = gpuSkinBase[]..swiz;
...
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r0.x, v4.x, l(12), t4.xxxx
r0.x = gpuSkinBase[]..swiz;
