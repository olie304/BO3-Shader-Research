...
r6.w = shaderConstantSetBuffer[]..swiz;
  ...
  r7.xyz = r6.xyz;
  r1.z = dot(r4.xyzw, r7.xyzw);
  r3.xyzw = viewProjectionMatrix._m10_m11_m12_m13 * r1.yyyy;
  r3.xyzw = r0.wwww * viewProjectionMatrix._m00_m01_m02_m03 + r3.xyzw;
...
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) r0.x, r2.y, l(0), t0.xxxx
