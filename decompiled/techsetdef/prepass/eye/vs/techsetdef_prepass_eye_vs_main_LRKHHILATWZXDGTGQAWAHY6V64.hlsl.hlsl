...
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r1.xy, v5.x, l(8), t4.xyxx
r1.x = modelInstanceBuffer[]..swiz;
r1.y = modelInstanceBuffer[]..swiz;
  if (r1.y != 0) {
  // Known bad code for instruction (needs manual fix):
  ...
  if (r1.y != 0) {
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r3.xyz, r1.y, l(0), t5.xyzx
  r3.x = modelInstanceBuffer[]..swiz;
  r3.y = modelInstanceBuffer[]..swiz;
  r3.z = modelInstanceBuffer[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r4.xyz, r1.y, l(16), t5.xyzx
  r4.x = modelInstanceBuffer[]..swiz;
  r4.y = modelInstanceBuffer[]..swiz;
  r4.z = modelInstanceBuffer[]..swiz;
  // Known bad code for instruction (needs manual fix):
...
r3.z = modelInstanceBuffer[]..swiz;
  r1.yzw = r0.www ? r3.xyz : float3(1,0,0);
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r0.y, v5.x, l(12), t4.xxxx
r0.y = modelInstanceBuffer[]..swiz;
  if (r0.y != 0) {
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r3.xyz, r0.y, l(0), t5.xyzx
  r3.x = modelInstanceBuffer[]..swiz;
  r3.y = modelInstanceBuffer[]..swiz;
  r3.z = modelInstanceBuffer[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r4.xyz, r0.y, l(16), t5.xyzx
  r4.x = modelInstanceBuffer[]..swiz;
  r4.y = modelInstanceBuffer[]..swiz;
  r4.z = modelInstanceBuffer[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r5.xyz, r0.y, l(32), t5.xyzx
  r5.x = modelInstanceBuffer[]..swiz;
  r5.y = modelInstanceBuffer[]..swiz;
  r5.z = modelInstanceBuffer[]..swiz;
  } else {
  ...
  r0.z = rsqrt(r0.z);
  r1.yzw = r3.xyz * r0.zzz;
  r3.xy = float2(-0.5,-0.5) + v1.xy;
  r0.z = dot(r3.xy, r3.xy);
  r0.z = sqrt(r0.z);
  r2.w = -0.224999994 + r0.z;
  r3.x = cmp(r2.w < 0);
  r0.z = 0.888888955 * r0.z;
  r2.w = r2.w * 1.09090912 + 0.200000003;
  r0.z = r3.x ? r0.z : r2.w;
  r0.z = r0.z * r0.z;
  r0.z = saturate(-r0.z * 18.3999996 + 1);
  r0.z = 0.101000004 * r0.z;
  r1.yzw = -r1.yzw * r0.zzz + r2.xyz;
  ...
  r0.z = (int)r1.x & 0x0fffffff;
  if (r0.z != 0) {
    if (r0.z != 0) {
      r1.x = cmp(v3.x != 0.000000);
      if (r1.x != 0) {
        r1.x = (int)r0.z + (int)v4.x;
      // Known bad code for instruction (needs manual fix):
      ...
      r3.w = modelInstanceBuffer[]..swiz;
        ...
        r2.y = v3.x * r1.y;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r1.xyzw, r1.x, l(32), t8.xyzw
      r1.x = modelInstanceBuffer[]..swiz;
      r1.y = modelInstanceBuffer[]..swiz;
      r1.z = modelInstanceBuffer[]..swiz;
      r1.w = modelInstanceBuffer[]..swiz;
    ...
    if (r0.w != 0) {
      ...
      r1.w = modelInstanceBuffer[]..swiz;
        ...
        r2.x = v3.x * r1.x;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r1.xyzw, r0.x, l(16), t5.xyzw
      r1.x = modelInstanceBuffer[]..swiz;
      r1.y = modelInstanceBuffer[]..swiz;
      r1.z = modelInstanceBuffer[]..swiz;
      r1.w = modelInstanceBuffer[]..swiz;
        ...
        r2.y = v3.x * r1.x;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r1.xyzw, r0.x, l(32), t5.xyzw
      r1.x = modelInstanceBuffer[]..swiz;
      r1.y = modelInstanceBuffer[]..swiz;
      r1.z = modelInstanceBuffer[]..swiz;
      r1.w = modelInstanceBuffer[]..swiz;
        r0.x = dot(r1.xyz, v0.xyz);
        r0.x = r0.x + r1.w;
        r2.z = v3.x * r0.x;
        r0.x = cmp(v3.y != 0.000000);
        if (r0.x != 0) {
          r0.x = (int)r0.w + (int)v4.y;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r1.xyzw, r0.x, l(0), t5.xyzw
        r1.x = modelInstanceBuffer[]..swiz;
        r1.y = modelInstanceBuffer[]..swiz;
