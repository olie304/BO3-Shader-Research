...
r1.x = modelInstanceBuffer[]..swiz;
  ...
  r4.w = modelInstanceBuffer[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r5.xyzw, r1.x, l(32), t5.xywz
  ...
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r4.xyz, r1.x, l(32), t5.xyzx
  r4.x = modelInstanceBuffer[]..swiz;
  r4.y = modelInstanceBuffer[]..swiz;
  r4.z = modelInstanceBuffer[]..swiz;
  } else {
...
r3.z = modelInstanceBuffer[]..swiz;
  ...
  r0.w = sqrt(r0.w);
  r1.x = -0.224999994 + r0.w;
  r1.y = cmp(r1.x < 0);
  r0.w = 0.888888955 * r0.w;
  r1.x = r1.x * 1.09090912 + 0.200000003;
  r0.w = r1.y ? r0.w : r1.x;
  r0.w = r0.w * r0.w;
  r0.w = saturate(-r0.w * 18.3999996 + 1);
  r0.w = 0.101000004 * r0.w;
