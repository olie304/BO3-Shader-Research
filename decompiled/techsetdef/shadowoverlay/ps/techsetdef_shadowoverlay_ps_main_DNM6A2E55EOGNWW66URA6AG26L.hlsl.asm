...
// ------------------------------ ---------- ------- ----------- -------------- ------
// shadowoverlaySampler              sampler      NA          NA             s1      1 
...
dcl_output o0.xyzw
dcl_temps 1
mad r0.xy, v2.xyxx, cb3[1].xzxx, cb3[1].ywyy
round_z r0.z, cb3[0].x
sample_l_indexable(texture2darray)(float,float,float,float) r0.x, r0.xyzx, t0.xyzw, s1, cb3[0].w
