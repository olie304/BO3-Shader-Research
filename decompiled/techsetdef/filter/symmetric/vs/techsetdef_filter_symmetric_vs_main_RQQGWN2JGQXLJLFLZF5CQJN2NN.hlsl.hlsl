...
r0.w = modelInstanceBuffer[]..swiz;
  ...
  o1.xy = filterTap[0].xy + v1.xy;
  o1.zw = -filterTap[0].xy + v1.xy;
  o2.xy = filterTap[1].xy + v1.xy;
  o2.zw = -filterTap[1].xy + v1.xy;
  o3.xy = filterTap[2].xy + v1.xy;
  o3.zw = -filterTap[2].xy + v1.xy;
  o4.xy = filterTap[3].xy + v1.xy;
  o4.zw = -filterTap[3].xy + v1.xy;
  o5.xy = filterTap[4].xy + v1.xy;
  o5.zw = -filterTap[4].xy + v1.xy;
  o6.xy = filterTap[5].xy + v1.xy;
  o6.zw = -filterTap[5].xy + v1.xy;
  o7.xy = filterTap[6].xy + v1.xy;
  o7.zw = -filterTap[6].xy + v1.xy;
  o8.xy = filterTap[7].xy + v1.xy;
  o8.zw = -filterTap[7].xy + v1.xy;
  return;
}