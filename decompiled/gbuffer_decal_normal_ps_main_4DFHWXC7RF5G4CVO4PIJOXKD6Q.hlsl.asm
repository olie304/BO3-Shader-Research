...
// alphaMaskMap                      texture  float4          2d            t10      1 
...
mul r0.x, r0.w, r0.x
sample_indexable(texture2d)(float,float,float,float) r1.xy, r0.yzyy, t7.xyzw, s1
...
sample_indexable(texture2d)(float,float,float,float) r2.z, r0.yzyy, t9.yzxw, s2
ftou r3.xy, v0.xyxx
mov r3.zw, l(0,0,0,0)
ld_indexable(texture2d)(float,float,float,float) r0.yz, r3.xyzw, t6.xzwy
...
movc r1.z, r0.y, l(0.500000), l(0.00146628)
and r0.yzw, r0.wwww, r1.xxyz
mul o1.xyz, r0.xxxx, r0.yzwy
mov r2.xyw, l(0,0.500000,0,1.000000)
