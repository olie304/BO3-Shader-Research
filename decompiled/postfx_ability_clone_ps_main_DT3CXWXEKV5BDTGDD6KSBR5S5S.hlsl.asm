...
//   float2 gridScale;                  // Offset:  192 Size:     8
//   float2 gridScroll;                 // Offset:  200 Size:     8
//   float2 offsetScale;                // Offset:  208 Size:     8
//   float2 offsetScroll;               // Offset:  216 Size:     8
//   float2 offsetPixels;               // Offset:  224 Size:     8
//
// }
//
...
// sonarDepthTexture                 texture  float4          2d             t6      1 
...
mul r1.xy, cb0[14].xyxx, cb1[44].zwzz
mul r1.zw, cb0[13].zzzw, cb1[69].wwww
mad r1.zw, v1.xxxy, cb0[13].xxxy, r1.zzzw
sample_indexable(texture2d)(float,float,float,float) r1.zw, r1.zwzz, t9.zwxy, s1
mad r1.zw, r1.zzzw, l(0.000000, 0.000000, 2.000000, 2.000000), l(0.000000, 0.000000, -1.000000, -1.000000)
mad r1.xy, r1.zwzz, r1.xyxx, v1.xyxx
sample_indexable(texture2d)(float,float,float,float) r1.x, r1.xyxx, t6.xyzw, s1
lt r1.x, l(0.000000), r1.x
mul r1.yz, cb0[12].zzwz, cb1[69].wwww
mad r1.yz, v1.xxyx, cb0[12].xxyx, r1.yyzy
sample_indexable(texture2d)(float,float,float,float) r1.y, r1.yzyy, t7.yxzw, s1
if_z r1.x
  mov r1.y, l(0)
endif 
mul r1.x, r1.y, cb3[0].x
