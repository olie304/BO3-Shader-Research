...
mov r6.x, l(1)
mov r5.x, l(0)
movc r5.xyzw, r2.yyyy, r6.xyzw, r5.xyzw
...
mov r3.x, l(3)
movc r3.xyzw, r1.wwww, r3.xyzw, r5.xyzw
add r1.w, r3.z, r3.y
add r5.z, r3.w, r1.w
add r5.y, -r3.y, r3.w
mad r5.x, -r3.z, l(3.000000), r5.z
mul r3.yzw, r5.xxyz, l(0.000000, 0.40824831, 0.70710677, 0.57735026)
