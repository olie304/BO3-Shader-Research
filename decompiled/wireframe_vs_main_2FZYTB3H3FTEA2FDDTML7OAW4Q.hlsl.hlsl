...
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r0.x, v1.x, l(12), t4.xxxx
...
r0.w = modelInstanceBuffer[]..swiz;
  ...
  r0.xyzw = scriptVector2.xyzw * r1.yyyy;
  r0.xyzw = r1.xxxx * scriptVector1.xyzw + r0.xyzw;
  r0.xyzw = r1.zzzz * scriptVector3.xyzw + r0.xyzw;
  r0.xyzw = scriptVector4.xyzw + r0.xyzw;
  r1.x = cmp(0 < scriptVector0.x);
  o1.xyzw = r1.xxxx ? r0.xyzw : float4(0,0,0,1);
  return;
}