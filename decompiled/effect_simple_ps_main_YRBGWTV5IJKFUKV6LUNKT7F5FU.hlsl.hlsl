...
cbuffer _Globals : register(b0)
{
  ...
  float zClipPlane : packoffset(c13.y);
  float zClipPlaneDir : packoffset(c13.z);
}
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r2.xyzw = colorMap.SampleGrad(colorSampler_s, v3.xy, r0.xyxx, r0.zwzz).xyzw;
  r3.xy = cmp(v5.xy != float2(0,1));
  if (r3.x != 0) {
    r0.xyzw = colorMap.SampleGrad(colorSampler_s, v3.zw, r0.xyxx, r0.zwzz).xyzw;
    r0.xyzw = r0.xyzw + -r2.xyzw;
    r2.xyzw = v5.xxxx * r0.xyzw + r2.xyzw;
  }
  r0.x = dot(r2.xyz, float3(0.212599993,0.715200007,0.0722000003));
  r0.xyz = r0.xxx + -r2.xyz;
  r0.xyz = desaturationAmount * r0.xyz + r2.xyz;
  r4.xyzw = cmp(levelsControls.xyzw == float4(0,1,0,1));
  r0.w = r4.y ? r4.x : 0;
  r0.w = r4.z ? r0.w : 0;
  r0.w = r4.w ? r0.w : 0;
  r1.w = max(9.99999975e-05, r2.w);
  r3.xzw = saturate(r0.xyz / r1.www);
  r3.xzw = saturate(-levelsControls.xxx + r3.xzw);
  r4.xy = levelsControls.yw + -levelsControls.xz;
  r4.x = max(9.99999975e-05, r4.x);
  r3.xzw = r3.xzw / r4.xxx;
  r3.xzw = min(float3(1,1,1), r3.xzw);
  r3.xzw = r3.xzw * r4.yyy + levelsControls.zzz;
  r4.xyz = cmp(float3(0.0404499993,0.0404499993,0.0404499993) >= r3.xzw);
  r5.xyz = float3(0.0773993805,0.0773993805,0.0773993805) * r3.xzw;
  r3.xzw = float3(0.0549999997,0.0549999997,0.0549999997) + r3.xzw;
  r3.xzw = float3(0.947867334,0.947867334,0.947867334) * abs(r3.xzw);
  r3.xzw = log2(r3.xzw);
  r3.xzw = float3(2.4000001,2.4000001,2.4000001) * r3.xzw;
  r3.xzw = exp2(r3.xzw);
  r3.xzw = r4.xyz ? r5.xyz : r3.xzw;
  r3.xzw = r3.xzw * r2.www;
  r2.xyz = r0.www ? r0.xyz : r3.xzw;
  r0.xy = (int2)v0.xy;
  r0.zw = float2(0,0);
  ...
  r0.xz = rcp(r0.xz);
  r0.w = -eyeOffset.z + useOldHDRScale;
  r0.w = useOldHDRScale * r0.w;
  r3.x = useOldHDRScale * v4.z;
  r3.z = cmp(r0.w < r3.x);
  r0.w = r0.z * r0.w;
  r0.w = r0.w / r3.x;
  r4.xyz = r2.xyz / r1.www;
  r1.w = v1.w + r2.w;
  r5.w = saturate(r1.w * v5.y + -v5.y);
  r5.xyz = r5.www * r4.xyz;
  r2.xyzw = r3.yyyy ? r5.xyzw : r2.xyzw;
  r1.w = r3.y ? 1 : v1.w;
  r3.x = cmp(r0.z < r0.x);
  r0.x = r0.x + -r0.z;
