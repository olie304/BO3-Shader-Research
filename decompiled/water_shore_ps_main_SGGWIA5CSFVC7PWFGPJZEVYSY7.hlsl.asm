...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:44:09 2021
//
//
// Buffer Definitions: 
//
...
if_nz r3.w
  ...
  mad r12.xyz, r0.xyzx, r6.zzzz, v5.xyzx
...
mad r7.xyz, -v5.xyzx, r4.xxxx, cb2[17].xyzx
...
if_nz r0.w
  ...
  if_nz r1.x
    ...
    lt r2.y, l(0.010000), |v5.z|
    mul r2.z, v5.z, cb2[15].z
