...
movc r2.yz, cb0[17].yyyy, r2.yyzy, r4.xxyx
sample_indexable(texture2d)(float,float,float,float) r4.xyzw, r2.yzyy, t10.xyzw, s1
add r5.xyz, cb0[15].xyzx, l(-1.000000, -1.000000, -1.000000, 0.000000)
mad r5.xyz, r4.wwww, r5.xyzx, l(1.000000, 1.000000, 1.000000, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r6.xyz, r2.yzyy, t9.xyzw, s2
...
mul_sat r2.z, cb0[16].y, l(0.05882353)
add r2.z, -r2.y, r2.z
...
mad r1.xy, r2.xwxx, cb0[13].zzzz, r0.yzyy
dp3 r2.x, r1.xyzx, r1.xyzx
rsq r2.x, r2.x
mul r5.xyz, r1.xyzx, r2.xxxx
mad r5.w, r3.w, cb0[13].z, r0.w
mad r1.xy, r4.xyxx, cb0[13].wwww, r0.yzyy
dp3 r0.y, r1.xyzx, r1.xyzx
rsq r0.y, r0.y
mul r4.xyz, r0.yyyy, r1.xyzx
mad r4.w, r2.z, cb0[13].w, r0.w
