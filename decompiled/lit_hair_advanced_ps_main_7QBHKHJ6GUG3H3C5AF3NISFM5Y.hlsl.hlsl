...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  r1.z = normalMap.Sample(normalSampler_s, v2.xy).z;
  ...
  r2.z = cavityMap.Sample(LinearSampler_s, v2.xy).x;
  r4.xyzw = flowMap.Sample(LinearSampler_s, v2.xy).xyzw;
  r2.w = 0.173648 * r4.w;
  ...
  r6.xyz = v7.xxx ? v4.xyz : -v4.xyz;
  r4.w = dot(r6.xyz, r6.xyz);
  r4.w = rsqrt(r4.w);
  r6.xyz = r6.xyz * r4.www;
  r7.xyz = v7.xxx ? v5.xyz : -v5.xyz;
  ...
  if (r10.z != 0) {
    ...
    r3.w = -r3.w * r3.w + 1;
    r17.xyz = sqrt(r3.www);
    r18.xyz = -v6.xyz * r7.www + sunConstants.wldDir.xyz;
