  ...
  out float2 o3 : SV_TARGET3)
{
  ...
  o0.xyz = r1.xyw;
  r1.xyw = backlightScatterColor.xyz * r1.xyw;
  o0.w = 1;
  r2.x = glossMapDetail2.Sample(specColorSampler_s, r0.xy).x;
  ...
  r3.xy = r3.xy * detailScaleHeight1 + r2.xy;
  r0.y = 0.333333343 * r0.y;
  r0.y = min(1, r0.y);
  ...
  r0.xyz = r3.xyz * r2.zzz + r0.xyz;
  r1.z = r3.x + r3.y;
  r1.z = r2.w * r0.w + r1.z;
  r1.z = 0.5 * r1.z;
  r2.z = dot(r0.xyz, r0.xyz);
  r2.z = rsqrt(r2.z);
  r3.yzw = r2.zzz * r0.xyz;
  r4.yzw = float3(1,-1,-1) * r3.yzw;
  r4.x = 1;
  r3.x = 0;
  r0.xyz = r2.xyw * r0.www + -r1.zzz;
  r0.w = max(r0.y, r0.z);
  r0.w = max(r0.x, r0.w);
  r0.w = max(r1.z, r0.w);
  r0.x = cmp(r0.w == r0.x);
  r2.xyzw = r0.xxxx ? r4.xyzw : r3.xyzw;
  ...
  r0.xyz = float3(0.408248305,0.707106769,0.577350259) * r2.xyz;
  r0.z = 1 + abs(r0.z);
  r0.z = rsqrt(r0.z);
  r0.xy = r0.xy * r0.zz;
