...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:27:00 2021
//
//
// Buffer Definitions: 
//
...
sample_indexable(texture2d)(float,float,float,float) r3.x, v2.xyxx, t10.xyzw, s2
...
sample_indexable(texture2d)(float,float,float,float) r3.w, r0.yzyy, t16.yzwx, s5
if_nz r3.z
  mul r3.z, r4.w, v1.w
  ...
  mul r3.z, r0.x, r3.z
  mad r4.xyz, r4.xyzx, v1.xyzx, -r2.xyzx
...
sample_indexable(texture2d)(float,float,float,float) r4.xyz, v2.xyxx, t9.xyzw, s3
...
mul r4.zw, v2.xxxy, cb0[4].xxxy
sample_indexable(texture2d)(float,float,float,float) r6.xyz, r4.zwzz, t12.xyzw, s3
...
mad r5.xy, r4.zwzz, cb0[12].zzzz, r4.xyxx
dp3 r4.x, r5.xyzx, r5.xyzx
rsq r4.x, r4.x
mul r4.xyz, r4.xxxx, r5.xyzx
mad r3.w, r5.w, cb0[12].z, r3.w
...
if_nz r4.w
  ...
  mad r4.xy, r0.yzyy, r3.zzzz, r4.xyxx
  dp3 r0.y, r4.xyzx, r4.xyzx
  rsq r0.y, r0.y
  mul r4.xyz, r0.yyyy, r4.xyzx
  mad r3.w, r4.w, r3.z, r3.w
endif 
...
if_nz r3.y
  ftoi r3.y, cb1[64].w
  lod r3.z, v2.xyxx, t6.y, s1
  lod r3.w, v2.xyxx, t6.x, s1
  lt r3.z, r3.z, r3.w
  lt r3.w, l(0.000000), r3.w
  and r7.xyz, r3.yyyy, l(1, 2, 4, 0)
  movc r8.xyz, r7.xxxx, l(1.000000,0,1.000000,0), r2.xyzx
  movc r7.xyw, r7.yyyy, l(0,1.000000,0,1.000000), r2.xyxz
  movc r7.xyw, r3.wwww, r8.xyxz, r7.xyxw
  movc r8.xyz, r7.zzzz, l(0,1.000000,0,0), r2.xyzx
  movc r2.xyz, r3.zzzz, r7.xywx, r8.xyzx
endif 
...
add r3.yzw, -r1.xxyz, cb1[61].xxyz
mad r1.xyz, cb1[61].wwww, r3.yzwy, r1.xyzx
add r2.w, -r0.z, r3.x
mad r0.z, cb1[62].w, r2.w, r0.z
add r2.w, -r0.w, cb1[63].x
mad o2.z, cb1[63].w, r2.w, r0.w
movc r3.xyz, v9.xxxx, v4.xyzx, -v4.xyzx
dp3 r0.w, r3.xyzx, r3.xyzx
rsq r0.w, r0.w
mad r3.xyz, r3.xyzx, r0.wwww, -r4.xyzx
mad r3.yzw, cb1[60].wwww, r3.xxyz, r4.xxyz
mul r4.xy, v2.xyxx, cb0[16].xyxx
...
mad r4.xzw, r4.xxxx, r7.xxyz, l(1.000000, 0.000000, 1.000000, 1.000000)
add r7.xyz, -r4.xzwx, cb1[43].xyzx
mad r4.xyz, r4.yyyy, r7.xyzx, r4.xzwx
add_sat r0.w, -r0.x, r1.w
add r4.xyz, r4.xyzx, l(-1.000000, -1.000000, -1.000000, 0.000000)
mad r4.xyz, r0.wwww, r4.xyzx, l(1.000000, 1.000000, 1.000000, 0.000000)
mul r7.xyz, r2.xyzx, r4.xyzx
sample_indexable(texture2d)(float,float,float,float) r0.w, v2.xyxx, t18.yzwx, s6
mul r1.w, r0.w, cb0[15].z
...
sqrt r2.w, r2.w
dp3 r4.w, -v8.xyzx, -v8.xyzx
rsq r4.w, r4.w
mul r8.xyz, r4.wwww, -v8.xyzx
...
movc o0.xyz, r1.wwww, r4.xyzx, r7.xyzx
...
add r1.w, r6.y, r6.x
mad r1.w, r5.z, r0.y, r1.w
mul r1.w, r1.w, l(0.500000)
mad r2.xyz, r5.xyzx, r0.yyyy, -r1.wwww
max r0.y, r2.z, r2.y
max r0.y, r0.y, r2.x
max r0.y, r0.y, r1.w
eq r1.w, r0.y, r2.x
