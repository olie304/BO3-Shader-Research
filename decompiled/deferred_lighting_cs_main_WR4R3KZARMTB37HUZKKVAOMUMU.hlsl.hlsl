...
r0.y = samplerLinear[]..swiz;
  ...
  r0.y = (uint)r0.y >> 24;
  r4.z = cmp((uint)r0.y >= (uint)r3.z);
  r5.w = cmp((uint)r0.y < numRefProbes);
  r4.z = r4.z ? r5.w : 0;
  if (r4.z != 0) {
    r4.z = (int)r0.y * 14;
    if (r1.z != 0) {
      r13.yzw = refProbeConstantsCB[r4.z].data[0].xyz + eyeOffset.xyz;
      r13.x = 16;
      GBufferDiffuseColor[viewID].880 = u2.xyzw;
    }
    r13.xyz = -refProbeConstantsCB[r4.z].data[0].xyz + r10.xyz;
    r5.w = 0x0000ffff & (int)refProbeConstantsCB[r4.z].data[7].z;
    if (6 == 0) r6.w = 0; else if (6+25 < 32) {     r6.w = (uint)refProbeConstantsCB[r4.z].data[7].z << (32-(6 + 25)); r6.w = (uint)r6.w >> (32-6);    } else r6.w = (uint)refProbeConstantsCB[r4.z].data[7].z >> 25;
    r7.w = (int)r5.w * 6;
    r8.w = dot(refProbeAttenuationConstantsCB[r7.w].data[0].xyz, r13.xyz);
    r8.w = saturate(refProbeAttenuationConstantsCB[r7.w].data[0].w + r8.w);
    r9.w = dot(refProbeAttenuationConstantsCB[r7.w].data[1].xyz, r13.xyz);
    r9.w = saturate(refProbeAttenuationConstantsCB[r7.w].data[1].w + r9.w);
    r8.w = r9.w * r8.w;
    r9.w = dot(refProbeAttenuationConstantsCB[r7.w].data[2].xyz, r13.xyz);
    r9.w = saturate(refProbeAttenuationConstantsCB[r7.w].data[2].w + r9.w);
    r8.w = r9.w * r8.w;
    r9.w = dot(refProbeAttenuationConstantsCB[r7.w].data[3].xyz, r13.xyz);
    r9.w = saturate(refProbeAttenuationConstantsCB[r7.w].data[3].w + r9.w);
    r8.w = r9.w * r8.w;
    r9.w = dot(refProbeAttenuationConstantsCB[r7.w].data[4].xyz, r13.xyz);
    r9.w = saturate(refProbeAttenuationConstantsCB[r7.w].data[4].w + r9.w);
    r8.w = r9.w * r8.w;
    r9.w = dot(refProbeAttenuationConstantsCB[r7.w].data[5].xyz, r13.xyz);
    r7.w = saturate(refProbeAttenuationConstantsCB[r7.w].data[5].w + r9.w);
    r14.x = r8.w * r7.w;
    r7.w = 1 & (int)refProbeConstantsCB[r4.z].data[6].x;
    r14.yz = float2(0,1);
    r14.xy = r7.ww ? r14.xy : r14.zx;
    r15.x = 1;
    r7.w = refProbeConstantsCB[r4.z].data[6].x;
    r16.xy = r14.xy;
    r8.w = 1;
    while (true) {
      ...
      r9.w = (int)r9.w * 6;
      r10.w = dot(refProbeAttenuationConstantsCB[r9.w].data[0].xyz, r13.xyz);
      r10.w = saturate(refProbeAttenuationConstantsCB[r9.w].data[0].w + r10.w);
      r10.w = r16.x * r10.w;
      r13.w = dot(refProbeAttenuationConstantsCB[r9.w].data[1].xyz, r13.xyz);
      r13.w = saturate(refProbeAttenuationConstantsCB[r9.w].data[1].w + r13.w);
      r10.w = r13.w * r10.w;
      r13.w = dot(refProbeAttenuationConstantsCB[r9.w].data[2].xyz, r13.xyz);
      r13.w = saturate(refProbeAttenuationConstantsCB[r9.w].data[2].w + r13.w);
      r10.w = r13.w * r10.w;
      r13.w = dot(refProbeAttenuationConstantsCB[r9.w].data[3].xyz, r13.xyz);
      r13.w = saturate(refProbeAttenuationConstantsCB[r9.w].data[3].w + r13.w);
      r10.w = r13.w * r10.w;
      r13.w = dot(refProbeAttenuationConstantsCB[r9.w].data[4].xyz, r13.xyz);
      r13.w = saturate(refProbeAttenuationConstantsCB[r9.w].data[4].w + r13.w);
      r10.w = r13.w * r10.w;
      r13.w = dot(refProbeAttenuationConstantsCB[r9.w].data[5].xyz, r13.xyz);
      r9.w = saturate(refProbeAttenuationConstantsCB[r9.w].data[5].w + r13.w);
      r16.x = r10.w * r9.w;
      r13.w = (uint)r7.w >> 2;
      if (1 == 0) r14.z = 0; else if (1+2 < 32) {       r14.z = (uint)r7.w << (32-(1 + 2)); r14.z = (uint)r14.z >> (32-1);      } else r14.z = (uint)r7.w >> 2;
      r14.w = (int)r13.w & 2;
      r15.z = max(r16.y, r16.x);
      r9.w = -r10.w * r9.w + 1;
      r9.w = r16.y * r9.w;
      r15.y = r14.w ? r9.w : r15.z;
      r16.xy = r14.zz ? r16.xy : r15.xy;
      r8.w = (int)r8.w + 1;
      r7.w = r13.w;
    }
    r16.y = saturate(r16.y);
    r5.w = refProbeConstantsCB[r4.z].data[6].y * r16.y;
    r6.w = cmp(0 < r5.w);
    if (r6.w != 0) {
      if (r1.z != 0) {
      // Known bad code for instruction (needs manual fix):
      ...
      r6.w = refProbeConstantsCB[r4.z].data[7].y * r5.w;
      r14.x = refProbeConstantsCB[r4.z].data[7].w;
      r14.yz = refProbeConstantsCB[r4.z].data[8].xy;
      r7.w = dot(r12.xyz, r14.xyz);
      r8.w = dot(r13.xyz, r14.xyz);
      r8.w = -refProbeConstantsCB[r4.z].data[8].z + r8.w;
      r9.w = cmp(r8.w >= 0);
      ...
      r14.x = refProbeConstantsCB[r4.z].data[8].w;
      r14.yz = refProbeConstantsCB[r4.z].data[9].xy;
      r8.w = dot(r12.xyz, r14.xyz);
      r9.w = dot(r13.xyz, r14.xyz);
      r9.w = -refProbeConstantsCB[r4.z].data[9].z + r9.w;
      r10.w = cmp(r9.w >= 0);
      ...
      r14.x = refProbeConstantsCB[r4.z].data[9].w;
      r14.yz = refProbeConstantsCB[r4.z].data[10].xy;
      r8.w = dot(r12.xyz, r14.xyz);
      r9.w = dot(r13.xyz, r14.xyz);
      r9.w = -refProbeConstantsCB[r4.z].data[10].z + r9.w;
      r10.w = cmp(r9.w >= 0);
      r9.w = max(abs(r9.w), r2.w);
      r9.w = r10.w ? r9.w : -r9.w;
      r8.w = max(1.00000001e-07, -r8.w);
      r8.w = r9.w / r8.w;
      r7.w = min(abs(r8.w), r7.w);
      r14.x = refProbeConstantsCB[r4.z].data[10].w;
      r14.yz = refProbeConstantsCB[r4.z].data[11].xy;
      r8.w = dot(r12.xyz, r14.xyz);
      r9.w = dot(r13.xyz, r14.xyz);
      r9.w = -refProbeConstantsCB[r4.z].data[11].z + r9.w;
      r10.w = cmp(r9.w >= 0);
      r9.w = max(abs(r9.w), r2.w);
      r9.w = r10.w ? r9.w : -r9.w;
      r8.w = max(1.00000001e-07, -r8.w);
      r8.w = r9.w / r8.w;
      r7.w = min(abs(r8.w), r7.w);
      r14.x = refProbeConstantsCB[r4.z].data[11].w;
      r14.yz = refProbeConstantsCB[r4.z].data[12].xy;
      r8.w = dot(r12.xyz, r14.xyz);
      r9.w = dot(r13.xyz, r14.xyz);
      r9.w = -refProbeConstantsCB[r4.z].data[12].z + r9.w;
      r10.w = cmp(r9.w >= 0);
      r9.w = max(abs(r9.w), r2.w);
      r9.w = r10.w ? r9.w : -r9.w;
      r8.w = max(1.00000001e-07, -r8.w);
      r8.w = r9.w / r8.w;
      r7.w = min(abs(r8.w), r7.w);
      r14.x = refProbeConstantsCB[r4.z].data[12].w;
      r14.yz = refProbeConstantsCB[r4.z].data[13].xy;
      r8.w = dot(r12.xyz, r14.xyz);
      r9.w = dot(r13.xyz, r14.xyz);
      r9.w = -refProbeConstantsCB[r4.z].data[13].z + r9.w;
      r10.w = cmp(r9.w >= 0);
      r9.w = max(abs(r9.w), r2.w);
      r9.w = r10.w ? r9.w : -r9.w;
      r8.w = max(1.00000001e-07, -r8.w);
      r8.w = r9.w / r8.w;
      r7.w = min(abs(r8.w), r7.w);
      r14.x = refProbeConstantsCB[r4.z].data[3].w + r13.x;
      r14.yz = refProbeConstantsCB[r4.z].data[4].xy + r13.yz;
      r14.xyz = r12.xyz * r7.www + r14.xyz;
      ...
      r15.x = refProbeConstantsCB[r4.z].data[0].w;
      r15.y = refProbeConstantsCB[r4.z].data[1].z;
      r15.z = refProbeConstantsCB[r4.z].data[2].y;
      r16.x = dot(r14.xyz, r15.xyz);
      r17.xy = refProbeConstantsCB[r4.z].data[1].xw;
      r17.z = refProbeConstantsCB[r4.z].data[2].z;
      r16.y = dot(r14.xyz, r17.xyz);
      r18.x = refProbeConstantsCB[r4.z].data[1].y;
      r18.yz = refProbeConstantsCB[r4.z].data[2].xw;
      r16.z = dot(r14.xyz, r18.xyz);
      if (9 == 0) r8.w = 0; else if (9+16 < 32) {       r8.w = (uint)refProbeConstantsCB[r4.z].data[7].z << (32-(9 + 16)); r8.w = (uint)r8.w >> (32-9);      } else r8.w = (uint)refProbeConstantsCB[r4.z].data[7].z >> 16;
      r16.w = (uint)r8.w;
      r14.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r16.xyzw, r7.w).xyz;
      ...
      r13.xyz = saturate(r19.xyz * refProbeConstantsCB[r4.z].data[3].xyz + float3(0.5,0.5,0.5));
      r19.xy = refProbeConstantsCB[r4.z].data[4].zw * r13.xy;
      r19.z = refProbeConstantsCB[r4.z].data[5].x * r13.z;
      r13.xyz = refProbeConstantsCB[r4.z].data[5].yzw + r19.xyz;
      ...
      r4.z = (int)r16.y | (int)r16.x;
      r4.z = (int)r16.z | (int)r4.z;
      r15.xyz = r4.zzz ? float3(1,1,0) : r15.xyz;
      r13.xyz = r15.xyz * r13.xyz;
      r4.z = dot(r13.xyz, float3(0.212599993,0.715200007,0.0722000003));
      r7.w = r4.z * r3.y;
  ...
  r3.z = cmp((uint)r0.y < (uint)r3.z);
  if (r3.z != 0) {
    r0.y = (int)r0.y * 14;
    if (r1.z != 0) {
      r3.z = (int)r4.z & 1;
      r3.z = mad((int)r3.z, 20, 880);
      r15.yzw = refProbeConstantsCB[r0.y].data[0].xyz + eyeOffset.xyz;
      r15.x = 16;
      GBufferDiffuseColor[viewID].r3.z = u2.xyzw;
    }
    r3.z = (int)r4.z + 1;
    ...
    while (true) {
      ...
      r10.w = (int)r10.w * 6;
      r13.w = dot(refProbeAttenuationConstantsCB[r10.w].data[0].xyz, r15.xyz);
      r13.w = saturate(refProbeAttenuationConstantsCB[r10.w].data[0].w + r13.w);
      r13.w = r18.x * r13.w;
      r14.w = dot(refProbeAttenuationConstantsCB[r10.w].data[1].xyz, r15.xyz);
      r14.w = saturate(refProbeAttenuationConstantsCB[r10.w].data[1].w + r14.w);
      r13.w = r14.w * r13.w;
      r14.w = dot(refProbeAttenuationConstantsCB[r10.w].data[2].xyz, r15.xyz);
      r14.w = saturate(refProbeAttenuationConstantsCB[r10.w].data[2].w + r14.w);
      r13.w = r14.w * r13.w;
      r14.w = dot(refProbeAttenuationConstantsCB[r10.w].data[3].xyz, r15.xyz);
      r14.w = saturate(refProbeAttenuationConstantsCB[r10.w].data[3].w + r14.w);
      r13.w = r14.w * r13.w;
      r14.w = dot(refProbeAttenuationConstantsCB[r10.w].data[4].xyz, r15.xyz);
      r14.w = saturate(refProbeAttenuationConstantsCB[r10.w].data[4].w + r14.w);
      r13.w = r14.w * r13.w;
      r14.w = dot(refProbeAttenuationConstantsCB[r10.w].data[5].xyz, r15.xyz);
      r10.w = saturate(refProbeAttenuationConstantsCB[r10.w].data[5].w + r14.w);
      r18.x = r13.w * r10.w;
      r14.w = (uint)r8.w >> 2;
      if (1 == 0) r15.w = 0; else if (1+2 < 32) {       r15.w = (uint)r8.w << (32-(1 + 2)); r15.w = (uint)r15.w >> (32-1);      } else r15.w = (uint)r8.w >> 2;
      r16.z = (int)r14.w & 2;
      r16.w = max(r18.y, r18.x);
      r10.w = -r13.w * r10.w + 1;
      r10.w = r18.y * r10.w;
      r17.y = r16.z ? r10.w : r16.w;
      r18.xy = r15.ww ? r18.xy : r17.xy;
      r9.w = (int)r9.w + 1;
      r8.w = r14.w;
    }
    r6.w = saturate(r18.y + -r5.w);
    ...
    if (r8.w != 0) {
      ...
      r9.w = r1.z ? r9.w : 0;
      if (r9.w != 0) {
        r16.xy = mad((int2)r8.ww, int2(20,20), int2(860,876));
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r8.w, cb2[52].x, r16.x, u2.xxxx
      ...
      r3.z = (int)r4.z + 257;
      r6.w = r6.w * refProbeConstantsCB[r0.y].data[6].y + r5.w;
      r7.w = refProbeConstantsCB[r0.y].data[7].y * r7.w;
      ...
      r13.w = cmp(r10.w >= 0);
      r2.w = max(abs(r10.w), r2.w);
      r2.w = r13.w ? r2.w : -r2.w;
      r9.w = max(1.00000001e-07, -r9.w);
      r2.w = r2.w / r9.w;
      r2.w = min(r8.w, abs(r2.w));
  ...
  r0.y = cmp(r5.w >= 1);
  bitmask.w = ((~(-1 << 8)) << 0) & 0xffffffff;  r1.w = (((uint)r3.z << 0) & bitmask.w) | ((uint)r4.z & ~bitmask.w);
  r0.y = r0.y ? r1.w : r3.z;
  r1.w = max(1, r6.w);
  r1.w = rcp(r1.w);
  r6.w = saturate(r6.w);
  r15.xyz = r13.xyz * r1.www;
  r14.xyz = r14.xyz * r1.www;
  r2.w = cmp(r6.w < 0.99000001);
  if (r2.w != 0) {
    r0.y = (int)r0.y + 256;
    r2.w = 1 + -r6.w;
    ...
    r15.xyz = r13.xyz * r1.www + r11.xyz;
    r12.w = 0;
