...
r0.y = colorSampler[]..swiz;
  if (r0.x != 0) {
    r0.z = cmp(v2.x != 0.000000);
    if (r0.z != 0) {
      r0.z = (int)r0.x + (int)v3.x;
    // Known bad code for instruction (needs manual fix):
...
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) r0.xy, r0.y, l(16), t0.xyxx
r0.x = colorSampler[]..swiz;
r0.y = colorSampler[]..swiz;
...
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r2.x, v5.x, l(12), t4.xxxx
r2.x = colorSampler[]..swiz;
  if (r2.x != 0) {
  // Known bad code for instruction (needs manual fix):
  ...
  r2.w = colorSampler[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r3.xyz, r2.x, l(16), t5.xyzx
  r3.x = colorSampler[]..swiz;
  r3.y = colorSampler[]..swiz;
  r3.z = colorSampler[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r4.xyz, r2.x, l(32), t5.xyzx
