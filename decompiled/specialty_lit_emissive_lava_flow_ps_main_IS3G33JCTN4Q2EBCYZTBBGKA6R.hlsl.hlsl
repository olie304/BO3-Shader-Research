...
r0.z = samp0[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) r0.zw, r0.z, l(36), t0.xxxy
r0.z = samp0[]..swiz;
r0.w = samp0[]..swiz;
  r0.z = saturate(r0.z);
  r0.z = useOrientedNormalMap * r0.z;
  r8.xyz = cmp(r0.www == float3(3,2,1));
  r9.xyz = r8.zzz ? tint1.xyz : emissiveTint1.xyz;
  r8.yzw = r8.yyy ? tint2.xyz : r9.xyz;
  r8.xyz = r8.xxx ? tint3.xyz : r8.yzw;
  r0.w = dot(-v7.xyz, -v7.xyz);
  r0.w = rsqrt(r0.w);
  r9.xyz = -v7.xyz * r0.www;
  r10.x = dot(r9.xyz, v5.xyz);
  r10.y = dot(r9.xyz, v6.xyz);
  r2.w = dot(r9.xyz, v4.xyz);
  r3.w = cmp(0 < r2.w);
  r10.xy = -r10.xy / r2.ww;
  r10.xy = r3.ww ? r10.xy : 0;
  r10.zw = float2(-0.5,-0.5) + v2.xy;
  r2.w = 9.99999975e-06 + layerDepth;
  r10.xy = r10.xy * r2.ww;
  r10.xy = scaleUVs.xy * r10.xy;
  r10.xy = r10.zw * scaleUVs.xy + r10.xy;
  r10.xy = offsetUVs.xy * scaleUVs.xy + r10.xy;
  r2.w = rotateUVs.y * gameTime.w + 1;
  r2.w = rotateUVs.x * r2.w;
  r2.w = 0.0174532924 * r2.w;
  sincos(r2.w, r11.x, r12.x);
  r12.y = r12.x;
  r12.z = r11.x;
  r13.x = dot(r12.yz, r10.xy);
  r12.x = -r11.x;
  r13.y = dot(r12.xy, r10.xy);
  r10.xy = gameTime.ww * scrollUVs.xy;
  r10.xy = r10.xy * scaleUVs.xy + r13.xy;
  r2.w = gameTime.w * zoomRate;
  r2.w = cos(r2.w);
  r2.w = r2.w * 0.5 + 0.5;
  r2.w = 1 + -r2.w;
  r3.w = zoomUVs.y + -zoomUVs.x;
  r2.w = r2.w * r3.w + zoomUVs.x;
  r10.xy = r10.xy / r2.ww;
  r10.xy = float2(0.5,0.5) + r10.xy;
  r10.zw = saturate(r10.xy);
  r10.xy = clampU ? r10.zw : r10.xy;
  r1.y = saturate(dot(r9.xyz, r1.yzw));
  r10.xyzw = emissiveMap.Sample(colorSampler_s, r10.xy).xyzw;
  ...
  r0.z = r0.z * r1.y;
  r0.z = r0.z * r1.x;
  r1.xyz = r8.xyz * r0.zzz;
  r0.z = v3.x + v3.y;
  r0.z = v3.z + r0.z;
  r0.z = flickerSeed.y + r0.z;
  r0.z = frac(r0.z);
  r8.y = gameTime.w * flickerSpeed + r0.z;
  r8.x = flickerSeed.x;
  r0.z = flickerLookupMap.SampleLevel(lookupSampler_s, r8.xy, 0).x;
  r0.z = log2(abs(r0.z));
  ...
  r6.w = 100 * r6.w;
  r8.zw = -r2.ww * float2(10,5) + float2(6.85740995,7.08500004);
  r7.w = exp2(r8.z);
  r7.w = r7.w * r0.x;
  r7.w = 9.1368103 * r7.w;
  r8.z = r3.w * r2.w;
  ...
  if (r8.z == 0) {
    ...
    if (r10.w != 0) {
      ...
      r12.y = 0;
      while (true) {
        r12.z = cmp((uint)r12.y >= (uint)r8.z);
        if (r12.z != 0) break;
        r14.z = (uint)r12.y >> 5;
        r15.xyz = (int3)r7.xyz + (int3)r14.xyz;
  ...
  r8.zw = r0.xy * float2(0.984375,0.984375) + float2(0.0078125,0.0078125);
  r8.zw = gEnvBRDFGeneric.SampleLevel(samplerLinear_s, r8.zw, 0).xy;
  r14.xyz = r22.yzx * r8.zzz;
  r11.yzw = r22.xyz * r8.www;
  r0.y = sqrt(r2.z);
  r0.y = r0.y * 0.5 + 0.5;
  r0.y = r0.y * r0.y;
  r2.w = 0.5 * r0.y;
    ...
    if (r9.w == 0) {
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          r15.w = r13.w ? sunConstants.splitPinTransform[r8.z].w : sunConstants.splitPinTransform[r9.w].w;
  ...
  if (r6.w != 0) {
    ...
    if (r6.w != 0) {
      ...
      r18.w = samp0[]..swiz;
        ...
        r15.zw = cmp(r12.yz >= r15.zw);
        r15.xy = cmp(r15.xy >= r12.yz);
      ...
      r12.yzw = -v7.xyz * r0.www + sunConstants.wldDir.xyz;
      r0.w = dot(r12.yzw, r12.yzw);
      r0.w = rsqrt(r0.w);
      r12.yzw = r12.yzw * r0.www;
      r0.w = dot(r12.yzw, r9.xyz);
                    ...
                    r10.w = samp0[]..swiz;
                      ...
                      if (r7.w != 0) {
                        ...
                        while (true) {
                          ...
                          r43.y = dot(icb[r18.z+0].xy, r8.xy);
            ...
            r40.w = samp0[]..swiz;
              ...
              if (r14.w != 0) {
                  ...
                  r40.y = samp0[]..swiz;
                    ...
                    if (r7.w != 0) {
                      ...
                      while (true) {
                        ...
                        r21.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r32.xyz, r8.w).x;
                ...
                if (r14.w != 0) {
                  ...
                  r19.xyz = r19.xyz * r9.www + r9.xyz;
                  r9.w = dot(r19.xyz, r19.xyz);
                  r9.w = rsqrt(r9.w);
                  r19.xyz = r19.xyz * r9.www;
                  r9.w = dot(r19.xyz, r9.xyz);
                  ...
                  r8.w = r13.w * r8.w;
                  r8.w = 0.25 * r8.w;
                  r19.xyz = r8.www * r20.xyw + r31.xyz;
                  r9.w = saturate(1 + -r9.w);
                  r13.w = r9.w * r9.w;
                  r13.w = r13.w * r13.w;
                  r9.w = r13.w * r9.w;
                  r8.w = r9.w * r8.w;
                  r20.xyw = r8.www * r20.xyw + r30.xyz;
