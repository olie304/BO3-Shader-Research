  ...
  out float2 o0 : SV_TARGET0)
{
  ...
  r0.y = r0.x * 64 + -63;
  r0.yz = max(float2(9.99999994e-09,9.99999994e-09), r0.yx);
  r0.x = cmp(r0.x >= 0.984375);
  r0.yz = postFxControl2.xy / r0.yz;
  r0.x = r0.x ? r0.y : r0.z;
  r0.x = rcp(r0.x);
  r0.x = r0.x * postFxControl1.x + postFxControl1.y;
  r0.x = saturate(r0.x * postFxControl1.z + postFxControl1.w);
  r0.yz = -v1.xy + v0.xy;
  r0.y = codeTexture1.Sample(bilinearClamp_s, r0.yz).x;
  r1.xyzw = v1.xyxy * float4(1,-1,-1,1) + v0.xyxy;
  r0.z = codeTexture1.Sample(bilinearClamp_s, r1.xy).x;
  r0.w = codeTexture1.Sample(bilinearClamp_s, r1.zw).x;
  r0.y = r0.y + r0.z;
  r0.y = r0.y + r0.w;
  r0.zw = v1.xy + v0.xy;
  r0.z = codeTexture1.Sample(bilinearClamp_s, r0.zw).x;
  r0.y = r0.y + r0.z;
  r0.y = 0.25 * r0.y;
  o0.xy = max(r0.yy, r0.xx);
  return;
}