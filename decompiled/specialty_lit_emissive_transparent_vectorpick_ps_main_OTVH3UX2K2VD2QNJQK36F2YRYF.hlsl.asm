...
mov_sat r1.y, v2.z
mul r1.y, r1.y, cb0[11].w
eq r11.xyz, v2.wwww, l(3.000000, 2.000000, 1.000000, 0.000000)
...
mad r3.yz, r3.yyzy, r3.wwww, v2.xxyx
sample_indexable(texture2d)(float,float,float,float) r4.xyzw, r3.yzyy, t25.xyzw, s1
mul r3.yzw, r11.xxyz, r4.xxyz
mov_sat r3.x, r3.x
log r4.x, r3.x
...
mul r1.y, r3.x, r1.y
mul r1.y, r1.z, r1.y
mul r3.xyz, r1.yyyy, r3.yzwy
ine r1.y, cb1[92].x, l(0)
utof r4.xy, r6.xyxx
dp2 r1.z, r4.yxyy, l(0.06711056, 0.00583715, 0.000000, 0.000000)
frc r1.z, r1.z
...
frc r1.z, r1.z
mad r1.z, r1.z, l(6.28318548), cb1[70].w
sincos r4.x, r11.x, r1.z
dp3_sat r7.x, r2.xyzx, r12.xyzx
dp3 r1.z, -r12.xyzx, r2.xyzx
add r1.z, r1.z, r1.z
mad r13.xyz, r2.xyzx, -r1.zzzz, -r12.xyzx
...
if_z r5.z
  ...
  if_z r10.w
    if_z cb2[58].y
      ...
      itof r10.w, cb2[26].y
      add r16.z, r6.w, r10.w
      sample_c_lz_indexable(texture2darray)(float,float,float,float) r10.w, r16.xyzx, t13.xxxx, s13, r5.z
    ...
    if_nz cb2[58].y
      ...
      ftou r8.w, r8.w
      add r17.xy, r11.yzyy, -cb2[r10.w + 20].xyxx
      ...
      loop 
        ...
        movc r17.zw, r13.wwww, r11.yyyz, r17.xxxy
        movc r16.w, r13.w, cb2[r6.w + 20].w, cb2[r10.w + 20].w
...
if_nz r5.z
  ...
  if_nz r5.z
      ...
      if_z r9.w
        ...
        if_nz cb2[58].y
          ...
          loop 
            ...
            sample_c_lz_indexable(texture2darray)(float,float,float,float) r11.z, r18.xyzx, t9.xxxx, s13, r6.w
    ...
    mad r11.yzw, r4.wwww, r9.xxyz, r7.yyzw
    add_sat r1.w, -r1.w, l(1.000000)
    mul r5.z, r1.w, r1.w
    mul r5.z, r5.z, r5.z
    mul r1.w, r1.w, r5.z
    mul r1.w, r1.w, r4.w
    mad r9.xyz, r1.wwww, r9.yzxy, r14.xyzx
    mov r16.w, r9.z
    mov r15.w, r14.z
    movc r15.xyzw, r4.zzzz, r16.xyzw, r15.xyzw
    mov r9.zw, r11.yyyz
    mov r14.zw, r7.yyyz
    movc r9.xyzw, r4.zzzz, r9.xyzw, r14.xyzw
    movc r7.w, r4.z, r11.w, r7.w
    mov r14.z, r15.w
    mov r14.xy, r9.xyxx
    mov r7.yz, r9.zzwz
  endif 
          ...
          if_nz r14.w
            ...
            if_nz r14.w
              ...
              if_nz r14.w
                ...
                mad r20.xyz, r20.xyzx, r10.wwww, r12.xyzx
                dp3 r10.w, r20.xyzx, r20.xyzx
                rsq r10.w, r10.w
                mul r20.xyz, r10.wwww, r20.xyzx
                dp3 r10.w, r20.xyzx, r12.xyzx
                dp3 r15.w, r2.xyzx, r20.xyzx
                mad r16.w, |r15.w|, r1.z, -|r15.w|
                ...
                movc r17.xyz, r12.wwww, r22.xyzx, r17.xyzx
