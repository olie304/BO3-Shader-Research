...
mul r0.w, r0.x, r1.w
sample_indexable(texture2d)(float,float,float,float) r2.x, r0.yzyy, t12.xyzw, s4
sample_indexable(texture2d)(float,float,float,float) r2.y, r0.yzyy, t11.yxzw, s2
add r2.z, -cb0[11].x, cb0[11].y
mad r2.y, r2.y, r2.z, cb0[11].x
mul_sat r2.y, r2.y, l(0.05882353)
sample_indexable(texture2d)(float,float,float,float) r3.xyz, r0.yzyy, t10.xyzw, s3
...
if_nz r2.w
  ...
  movc r1.xyz, r0.zzzz, r4.xywx, r5.xyzx
endif 
...
mad r4.xyz, v5.xyzx, r3.wwww, -r3.xyzx
