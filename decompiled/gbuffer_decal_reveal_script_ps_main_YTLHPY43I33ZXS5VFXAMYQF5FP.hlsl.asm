...
// colorMap                          texture  float4          2d            t10      1 
// tintMask                          texture  float4          2d            t11      1 
// normalMap                         texture  float4          2d            t12      1 
// glossMap                          texture  float4          2d            t14      1 
// aoMap                             texture  float4          2d            t15      1 
// detailMap                         texture  float4          2d            t16      1 
// transitionDiffuse                 texture  float4          2d            t17      1 
// transitionNormal                  texture  float4          2d            t18      1 
// transitionGloss                   texture  float4          2d            t19      1 
...
sample_indexable(texture2d)(float,float,float,float) r1.xyz, r0.xyxx, t10.xyzw, s2
sample_indexable(texture2d)(float,float,float,float) r0.z, r0.xyxx, t11.yzxw, s2
...
sample_indexable(texture2d)(float,float,float,float) r0.z, r0.xyxx, t15.yzxw, s5
sample_indexable(texture2d)(float,float,float,float) r0.w, r0.xyxx, t14.yzwx, s3
add r1.w, -cb0[12].x, cb0[12].y
mad r0.w, r0.w, r1.w, cb0[12].x
mul_sat r0.w, r0.w, l(0.05882353)
sample_indexable(texture2d)(float,float,float,float) r3.xyz, r0.xyxx, t12.xyzw, s4
...
mul r3.zw, r0.xxxy, cb0[4].xxxy
sample_indexable(texture2d)(float,float,float,float) r5.xyz, r3.zwzz, t16.xyzw, s4
...
mad r3.xyz, r4.xyzx, r3.zzzz, r7.xyzx
dp3 r4.w, r3.xyzx, r3.xyzx
rsq r4.w, r4.w
mul r3.xyz, r3.xyzx, r4.wwww
mad r4.w, cb1[62].x, r1.w, cb0[12].x
mul_sat r4.w, r4.w, l(0.05882353)
mul r5.w, r4.w, l(-17.000000)
exp r5.w, r5.w
add r2.w, r2.w, r5.w
log r2.w, r2.w
...
if_nz r5.w
  ftoi r6.w, cb1[64].w
  lod r7.x, r0.xyxx, t10.y, s2
  lod r7.y, r0.xyxx, t10.x, s2
  lt r7.x, r7.x, r7.y
  lt r7.y, l(0.000000), r7.y
  and r8.xyz, r6.wwww, l(1, 2, 4, 0)
  ...
  movc r1.xyz, r7.xxxx, r7.yzwy, r8.xyzx
endif 
...
add r2.w, -r0.w, r2.w
mad r0.w, cb1[62].w, r2.w, r0.w
add r2.w, -r0.z, cb1[63].x
mad r0.z, cb1[63].w, r2.w, r0.z
mad r8.xyz, v5.xyzx, r3.wwww, -r3.xyzx
mad r3.xyz, cb1[60].wwww, r8.xyzx, r3.xyzx
sample_indexable(texture2d)(float,float,float,float) r8.xyz, r0.xyxx, t17.xyzw, s2
mul r2.xyz, r2.xyzx, r8.xyzx
mul r2.xyz, r2.xyzx, v8.xyzx
sample_indexable(texture2d)(float,float,float,float) r2.w, r0.xyxx, t19.yzwx, s3
mad r1.w, r2.w, r1.w, cb0[12].x
mul_sat r1.w, r1.w, l(0.05882353)
sample_indexable(texture2d)(float,float,float,float) r8.xyz, r0.xyxx, t18.xyzw, s4
...
mad r5.xyz, r5.xyzx, r8.xxxx, r6.xyzx
...
mad_sat r0.y, r3.w, l(0.998000), l(0.001000)
...
ftou r1.xy, v0.xyxx
mov r1.zw, l(0,0,0,0)
ld_indexable(texture2d)(float,float,float,float) r0.yz, r1.xyzw, t7.xzwy
lt r1.z, l(0.000000), r0.y
mad r0.z, r0.z, l(3.000000), l(0.500000)
ftou r0.z, r0.z
and r4.xyzw, r0.zzzz, l(2, 1, 2, 1)
movc r4.xyzw, r4.zwxy, l(-0.57735026,-0.57735026,1,1), l(0.57735026,0.57735026,0,0)
xor r0.z, r4.w, r4.z
movc r4.z, r0.z, l(-0.57735026), l(0.57735026)
mul r5.xy, r4.xzxx, l(-1.22474492, 1.22474492, 0.000000, 0.000000)
mul r6.xyz, r4.xyzx, l(0.70710677, -1.41421354, 0.70710677, 0.000000)
dp3 r6.x, r3.xyzx, r6.xyzx
dp2 r6.y, r3.xzxx, r5.xyxx
dp3 r0.z, r3.xyzx, r4.xyzx
add r0.z, |r0.z|, l(1.000000)
rsq r0.z, r0.z
mul r3.xy, r0.zzzz, r6.xyxx
...
mad r3.z, r0.w, l(0.49755621), r0.y
and r0.yzw, r1.zzzz, r3.xxyz
mul o1.xyz, r0.xxxx, r0.yzwy
add r3.y, -r7.z, r7.x
mad r0.y, r3.y, l(0.500000), r7.z
add r3.z, -r0.y, r7.y
