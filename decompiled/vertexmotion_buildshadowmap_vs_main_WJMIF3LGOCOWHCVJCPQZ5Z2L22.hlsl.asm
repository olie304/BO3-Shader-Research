...
mad r3.x, cb1[69].w, cb2[38].y, l(0.500000)
mul r3.y, r3.x, l(0.700000)
mad r0.w, r0.w, l(0.900000), r1.y
mul r0.w, r0.w, l(0.700000)
sincos r0.w, null, r0.w
mad r3.x, r3.x, l(0.700000), r1.y
mul r3.x, r3.x, l(0.700000)
sincos null, r3.x, r3.x
mul r3.z, r2.z, l(0.010000)
...
mul r0.w, r3.z, r0.w
mul r5.z, r0.z, r0.w
mul r3.xzw, r5.xxyz, l(0.110000, 0.000000, 0.130000, 0.090000)
mad r0.z, r1.x, l(0.100000), r2.w
mul r0.z, r0.z, l(0.070000)
sincos r0.z, null, r0.z
mad r0.z, r0.z, l(0.500000), l(0.500000)
mad r0.x, r0.x, l(0.100000), r3.y
...
mul r0.x, r0.x, r0.z
mul r0.x, r0.y, r0.x
mad r3.z, r0.x, l(0.010000), r3.z
add r0.xyz, r1.yzwy, r3.xzwx
