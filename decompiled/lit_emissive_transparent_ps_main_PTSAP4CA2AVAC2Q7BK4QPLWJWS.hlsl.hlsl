...
r2.w = samp0[]..swiz;
  r5.zw = (int2)r2.ww & int2(268435456,536870912);
  if (r5.z != 0) {
  ...
  o0.w = r0.x * r1.w + r12.x;
  r2.xyz = r2.xyz * r1.www + r14.xyz;
  r0.x = dot(r2.xyz, r2.xyz);
  r0.x = rsqrt(r0.x);
  r2.xyz = r2.xyz * r0.xxx;
  r0.y = r0.y * r1.w + r12.y;
  r4.xyz = r4.xyz * r1.www + r15.xyz;
  r3.x = cmp(0.5 < invertFalloff);
  if (r3.x != 0) {
    ...
    r7.y = r7.x;
    r7.z = r3.x;
    r8.x = dot(r7.yz, r5.zw);
    r7.x = -r3.x;
    r8.y = dot(r7.xy, r5.zw);
    r5.zw = gameTime.ww * scrollUVs.xy;
    r5.zw = r5.zw * scaleUVs.xy + r8.xy;
    ...
    r6.xy = clampU ? r6.zw : r5.zw;
  }
  r3.x = dot(-v6.xyz, -v6.xyz);
  r3.x = rsqrt(r3.x);
  r7.xyz = -v6.xyz * r3.xxx;
  r3.y = saturate(dot(r7.xyz, r3.yzw));
  ...
  r6.w = 100 * r6.w;
  r9.yz = -r5.ww * float2(10,5) + float2(6.85740995,7.08500004);
  r7.w = exp2(r9.y);
  r7.w = r7.w * r0.x;
  r7.w = 9.1368103 * r7.w;
  r8.w = r6.z * r5.w;
  ...
  r39.z = samp0[]..swiz;
  r39.w = samp0[]..swiz;
    r13.w = dot(r34.xyz, r10.yzw);
    r13.w = saturate(r13.w + r34.w);
    r14.x = dot(r35.xyz, r10.yzw);
    r14.x = saturate(r14.x + r35.w);
    r13.w = r14.x * r13.w;
    r14.x = dot(r36.xyz, r10.yzw);
    r14.x = saturate(r14.x + r36.w);
    r13.w = r14.x * r13.w;
    r14.x = dot(r37.xyz, r10.yzw);
    r14.x = saturate(r14.x + r37.w);
    r13.w = r14.x * r13.w;
    r14.x = dot(r38.xyz, r10.yzw);
    r14.x = saturate(r14.x + r38.w);
    r13.w = r14.x * r13.w;
    r14.x = dot(r39.xyz, r10.yzw);
    ...
    r28.z = r29.z;
    r14.z = dot(r11.xyz, r28.xyz);
    r15.x = dot(r10.yzw, r28.xyz);
    r15.x = r15.x + -r29.w;
    r15.w = cmp(r15.x >= 0);
    ...
    r29.z = r30.z;
    r14.z = dot(r11.xyz, r29.xyz);
    r15.x = dot(r10.yzw, r29.xyz);
    r15.x = r15.x + -r30.w;
    r15.w = cmp(r15.x >= 0);
    r15.x = max(abs(r15.x), r6.w);
    r15.x = r15.w ? r15.x : -r15.x;
    ...
    r13.w = min(abs(r14.z), r13.w);
    r30.z = r31.z;
    r14.z = dot(r11.xyz, r30.xyz);
    r15.x = dot(r10.yzw, r30.xyz);
    r15.x = r15.x + -r31.w;
    r15.w = cmp(r15.x >= 0);
    r15.x = max(abs(r15.x), r6.w);
    r15.x = r15.w ? r15.x : -r15.x;
    ...
    r13.w = min(abs(r14.z), r13.w);
    r31.z = r32.x;
    r14.z = dot(r11.xyz, r31.xyz);
    r15.x = dot(r10.yzw, r31.xyz);
    r15.x = r15.x + -r32.y;
    r15.w = cmp(r15.x >= 0);
    r15.x = max(abs(r15.x), r6.w);
    r15.x = r15.w ? r15.x : -r15.x;
    ...
    r13.w = min(abs(r14.z), r13.w);
    r33.zw = r32.zw;
    r14.z = dot(r11.zxy, r33.xzw);
    r15.x = dot(r10.wyz, r33.xzw);
    r15.x = r15.x + -r33.y;
    r15.w = cmp(r15.x >= 0);
    r15.x = max(abs(r15.x), r6.w);
    r15.x = r15.w ? r15.x : -r15.x;
    ...
    r28.xyz = r11.xyz * r13.www + r28.xyz;
    r14.z = dot(r28.xyz, r28.xyz);
    r14.z = sqrt(r14.z);
    r13.w = r13.w / r14.z;
    r13.w = r13.w + r13.w;
    r13.w = sqrt(r13.w);
    ...
    r29.w = (uint)r15.w;
    r22.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r29.xyzw, r13.w).xyz;
    r27.yzw = (int3)r22.xyz & int3(-2147483648,-2147483648,-2147483648);
    r27.yzw = cmp((int3)r27.yzw == int3(2139095040,2139095040,2139095040));
    r13.w = (int)r27.z | (int)r27.y;
    r13.w = (int)r27.w | (int)r13.w;
    r22.xyz = r13.www ? float3(1,1,0) : r22.xyz;
    ...
    while (true) {
      ...
      if (r16.z != 0) {
        ...
        if (r12.w != 0) {
          ...
          r35.z = samp0[]..swiz;
          r35.w = samp0[]..swiz;
            r16.w = dot(r30.xyz, r10.yzw);
            r16.w = saturate(r16.w + r30.w);
            r16.w = r29.x * r16.w;
            r17.z = dot(r31.xyz, r10.yzw);
            r17.z = saturate(r17.z + r31.w);
            r16.w = r17.z * r16.w;
            r17.z = dot(r32.xyz, r10.yzw);
            r17.z = saturate(r17.z + r32.w);
            r16.w = r17.z * r16.w;
            r17.z = dot(r33.xyz, r10.yzw);
            r17.z = saturate(r17.z + r33.w);
            r16.w = r17.z * r16.w;
            r17.z = dot(r34.xyz, r10.yzw);
            r17.z = saturate(r17.z + r34.w);
            r16.w = r17.z * r16.w;
            r17.z = dot(r35.xyz, r10.yzw);
            ...
            r16.w = -r16.w * r17.z + 1;
            r16.w = r29.y * r16.w;
            r5.y = r18.w ? r16.w : r21.z;
            r29.xy = r18.zz ? r29.xy : r5.xy;
            r16.z = (int)r16.z + 1;
            r15.w = r17.w;
          }
          ...
          r15.w = cmp(0 < r5.y);
          if (r15.w != 0) {
            r30.z = r29.y * r9.w + r27.w;
            r5.y = r5.y * r27.x;
            r29.xzw = r25.xyz * r5.yyy;
            ...
            r16.z = r15.w * r7.w;
            r29.xzw = r22.xyz * r5.yyy;
            r5.y = dot(r29.xzw, float3(0.212599993,0.715200007,0.0722000003));
            r5.y = r7.w * r15.w + r5.y;
            r5.y = r16.z / r5.y;
            r32.x = r28.w;
            r32.yz = r27.yz;
            r30.xyw = r29.zwx * r5.yyy + r32.yzx;
            r31.w = r30.w;
          } else {
            r31.xyzw = r28.xyzw;
            r30.xyz = r27.yzw;
  ...
  if (r0.w == 0) {
    ...
    while (true) {
      ...
      r10.y = cmp((int)r5.x == (int)r9.z);
      bitmask.z = ((~(-1 << r5.y)) << 0) & 0xffffffff;  r10.z = (((uint)0 << 0) & bitmask.z) | ((uint)r9.w & ~bitmask.z);
      r9.w = r10.y ? r10.z : r9.w;
      r10.y = cmp((int)r8.w == (int)r9.z);
    ...
    if (r8.w != 0) {
      ...
      r10.y = 0;
      while (true) {
        r10.z = cmp((uint)r10.y >= (uint)r0.w);
        if (r10.z != 0) break;
        r13.z = (uint)r10.y >> 5;
        r14.xyz = (int3)r12.xyz + (int3)r13.xyz;
        r10.z = visibleProbes.Load(r14.xyzw).x;
        r10.w = cmp((int)r5.x == (int)r10.y);
        if (r5.y == 0) r12.w = 0; else if (r5.y+0 < 32) {         r12.w = (uint)r10.z << (32-(r5.y + 0)); r12.w = (uint)r12.w >> (32-r5.y);        } else r12.w = (uint)r10.z >> 0;
    ...
    if (r5.x != 0) {
      ...
      r11.w = 0;
      r9.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r11.xyzw, r6.z).xyz;
      r0.w = sunConstants.globalProbeExposure * r5.x + -r2.w;
      r0.w = r0.y * r0.w + r2.w;
  ...
  r5.xyw = r20.xyz * r0.www;
  r14.xyz = r5.ywx * r0.yyy;
  r0.yzw = r5.xyw * r0.zzz;
  r2.w = sqrt(r5.z);
  r2.w = r2.w * 0.5 + 0.5;
  r2.w = r2.w * r2.w;
  r5.x = 0.5 * r2.w;
  ...
  r2.w = r5.y * r2.w;
  r5.x = r5.x * r5.y;
  r5.y = dot(r2.xyz, sunConstants.wldDir.xyz);
  r5.w = saturate(r5.y);
  r6.z = cmp(0 >= r5.w);
  if (r6.z != 0) {
    r6.w = 0;
    ...
    if (r10.y == 0) {
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          r16.z = (uint)r12.w;
          r12.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r6.z).x;
  ...
  if (r6.z != 0) {
    ...
    if (r6.z != 0) {
      ...
      r18.z = samp0[]..swiz;
      r18.w = samp0[]..swiz;
        r10.y = abs(r5.y) * -0.200000003 + 0.400000006;
        r19.xyz = r2.xyz * r10.yyy + v6.xyz;
        r19.w = 1;
        ...
        r16.y = samp0[]..swiz;
          ...
          if (enableDitheredShadow != 0) {
            ...
            r15.z = (uint)r10.y;
            r10.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r15.xyz, r7.w).x;
          }
          r7.w = r10.z * r10.z;
          r7.w = r7.w * r10.z;
        } else {
      ...
      r7.w = r7.w * r6.w;
      r5.y = cmp(0 < r5.y);
      r15.xyz = r7.www * r9.yzw + r13.xyz;
      r10.yzw = -v6.xyz * r3.xxx + sunConstants.wldDir.xyz;
      r3.x = dot(r10.yzw, r10.yzw);
      r3.x = rsqrt(r3.x);
      r10.yzw = r10.yzw * r3.xxx;
      r3.x = dot(r10.yzw, r7.xyz);
      r7.w = dot(r2.xyz, r10.yzw);
      r8.w = abs(r7.w) * r4.w + -abs(r7.w);
      ...
      r5.w = r6.w * r5.w;
      r5.w = 0.25 * r5.w;
      r10.yzw = r5.www * r9.yzw + r0.yzw;
      r3.x = saturate(1 + -r3.x);
      r6.z = r3.x * r3.x;
      r6.z = r6.z * r6.z;
      r3.x = r6.z * r3.x;
      r3.x = r5.w * r3.x;
      r16.xyz = r3.xxx * r9.zwy + r14.xyz;
      r15.w = r16.z;
      r13.w = r14.z;
            ...
            if (r21.w != 0) {
              ...
              if (r21.w != 0) {
                ...
                if (r21.w != 0) {
                  ...
                  r32.x = r31.x;
                  r13.w = cmp(0 < r16.z);
                  r20.xyz = r12.www * r32.xyz + r10.yzw;
                  ...
                  r16.w = abs(r16.z) * r4.w + -abs(r16.z);
                  r16.z = abs(r16.z) * r16.w + 1;
                  r16.w = r12.w * r2.w + r5.x;
                  r16.z = r16.z * r16.z;
                  r16.z = r16.z * r16.w;
                  r16.z = rcp(r16.z);
                  r12.w = r12.w * r21.w;
                  ...
                  r11.w = r14.w * r11.w;
                  r11.w = r12.w * r11.w;
                  r39.xyz = r11.www * r32.xyz + r17.xyz;
                  r10.yzw = r13.www ? r20.xyz : r10.yzw;
            ...
            r39.w = samp0[]..swiz;
              ...
              if (r14.w != 0) {
                ...
                if (r14.w != 0) {
                  ...
                  r16.z = r16.z * r8.w;
                  r12.w = cmp(0 < r12.w);
                  r23.xyz = r16.zzz * r21.xyw + r10.yzw;
                  r20.xyz = r20.xyz * r11.www + r7.xyz;
                  r11.w = dot(r20.xyz, r20.xyz);
                  r11.w = rsqrt(r11.w);
                  r20.xyz = r20.xyz * r11.www;
                  r11.w = dot(r20.xyz, r7.xyz);
                  r16.z = dot(r2.xyz, r20.xyz);
                  r19.x = abs(r16.z) * r4.w + -abs(r16.z);
                  r16.z = abs(r16.z) * r19.x + 1;
                  r13.w = r13.w * r2.w + r5.x;
                  r16.z = r16.z * r16.z;
                  r13.w = r16.z * r13.w;
                  r13.w = rcp(r13.w);
                  r13.w = r13.w * r14.w;
                  ...
                  r10.yzw = r12.www ? r23.xyz : r10.yzw;
  ...
  r1.xyz = r3.yzw * r0.www;
  r1.xyz = relativeHDR ? r1.xyz : r3.yzw;
