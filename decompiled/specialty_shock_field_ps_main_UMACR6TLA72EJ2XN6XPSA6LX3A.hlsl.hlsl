// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:42:50 2021
...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  r4.xyzw = emissiveMap.Sample(colorSampler_s, w1.xy).xyzw;
...
r2.w = samp0[]..swiz;
  ...
  r2.z = saturate(dot(v3.xyz, r6.xyz));
  ...
  if (r9.w != 0) {
    ...
    if (r9.w != 0) {
      ...
      r8.z = cmp(0 < r8.z);
      r14.xyz = -v6.xyz * r2.yyy + sunConstants.wldDir.xyz;
  ...
  r2.y = cmp(r2.x < 1);
  if (r2.y != 0) {
    r2.y = edgeColorMap.Sample(colorSampler_s, w1.xy).w;
    r5.xyzw = edgeEmissiveMap.Sample(colorSampler_s, w1.xy).xyzw;
  ...
  r0.w = r0.w * r4.w;
  r2.x = alphaMask.Sample(colorSampler_s, v7.xy).x;
