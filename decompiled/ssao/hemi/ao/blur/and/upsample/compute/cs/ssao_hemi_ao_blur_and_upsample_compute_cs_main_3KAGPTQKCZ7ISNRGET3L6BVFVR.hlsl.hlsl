...
Texture2D<float> codeTexture4 : register(t4);
...
r1.x = LinearSampler[]..swiz;
  ...
  r3.xyzw = codeTexture4.Gather(LinearSampler_s, r0.zw).xyzw;
  r4.xyzw = codeTexture1.Gather(LinearSampler_s, r0.zw).xyzw;
  r0.xyzw = codeTexture0.Gather(LinearSampler_s, r0.xy).xyzw;
  r5.xyzw = r4.xxxx + -r0.xyzw;
  r5.xyzw = hemiAOGlobals.upsampleTolerance + abs(r5.xyzw);
  r5.xyzw = float4(9,3,1,3) / r5.xyzw;
  r4.x = dot(r5.xyzw, float4(1,1,1,1));
  r4.x = hemiAOGlobals.noiseFilterStrength + r4.x;
  r5.x = dot(r1.yzwx, r5.xyzw);
  r5.x = hemiAOGlobals.noiseFilterStrength + r5.x;
  r3.x = r5.x * r3.x;
  r3.x = r3.x / r4.x;
  r5.xyzw = r4.yyyy + -r0.yzwx;
  r5.xyzw = hemiAOGlobals.upsampleTolerance + abs(r5.xyzw);
  r5.xyzw = float4(9,3,1,3) / r5.xyzw;
  r4.x = dot(r5.xyzw, float4(1,1,1,1));
  r4.y = dot(r1.zwxy, r5.xyzw);
  r4.xy = hemiAOGlobals.noiseFilterStrength + r4.xy;
  r3.y = r4.y * r3.y;
  r3.y = r3.y / r4.x;
  r5.xyzw = r4.zzzz + -r0.zwxy;
  r5.xyzw = hemiAOGlobals.upsampleTolerance + abs(r5.xyzw);
  r5.xyzw = float4(9,3,1,3) / r5.xyzw;
  r4.x = dot(r5.xyzw, float4(1,1,1,1));
  r4.y = dot(r1.wxyz, r5.xyzw);
  r4.xy = hemiAOGlobals.noiseFilterStrength + r4.xy;
  r3.z = r4.y * r3.z;
  r3.z = r3.z / r4.x;
  r0.xyzw = r4.wwww + -r0.wxyz;
  r0.xyzw = hemiAOGlobals.upsampleTolerance + abs(r0.xyzw);
  r0.xyzw = float4(9,3,1,3) / r0.xyzw;
  r4.x = dot(r0.xyzw, float4(1,1,1,1));
  r4.x = hemiAOGlobals.noiseFilterStrength + r4.x;
