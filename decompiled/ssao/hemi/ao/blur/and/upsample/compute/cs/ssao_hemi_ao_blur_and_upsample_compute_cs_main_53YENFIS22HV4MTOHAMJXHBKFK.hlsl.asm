...
// codeTexture4                      texture   float          2d             t4      1 
...
gather4_indexable(texture2d)(float,float,float,float) r4.xyzw, r0.zwzz, t1.xyzw, s2.x
gather4_indexable(texture2d)(float,float,float,float) r0.xyzw, r0.xyxx, t0.xyzw, s2.x
add r5.xyzw, -r0.xyzw, r4.xxxx
...
add r5.x, r5.x, cb5[8].x
mul r3.x, r3.x, r5.x
div r3.x, r3.x, r4.x
add r5.xyzw, -r0.yzwx, r4.yyyy
add r5.xyzw, |r5.xyzw|, cb5[8].wwww
div r5.xyzw, l(9.000000, 3.000000, 1.000000, 3.000000), r5.xyzw
dp4 r4.x, r5.xyzw, l(1.000000, 1.000000, 1.000000, 1.000000)
dp4 r4.y, r1.zwxy, r5.xyzw
add r4.xy, r4.xyxx, cb5[8].xxxx
mul r3.y, r3.y, r4.y
div r3.y, r3.y, r4.x
add r5.xyzw, -r0.zwxy, r4.zzzz
add r5.xyzw, |r5.xyzw|, cb5[8].wwww
div r5.xyzw, l(9.000000, 3.000000, 1.000000, 3.000000), r5.xyzw
dp4 r4.x, r5.xyzw, l(1.000000, 1.000000, 1.000000, 1.000000)
dp4 r4.y, r1.wxyz, r5.xyzw
add r4.xy, r4.xyxx, cb5[8].xxxx
mul r3.z, r3.z, r4.y
div r3.z, r3.z, r4.x
add r0.xyzw, -r0.wxyz, r4.wwww
add r0.xyzw, |r0.xyzw|, cb5[8].wwww
div r0.xyzw, l(9.000000, 3.000000, 1.000000, 3.000000), r0.xyzw
dp4 r4.x, r0.xyzw, l(1.000000, 1.000000, 1.000000, 1.000000)
add r4.x, r4.x, cb5[8].x
