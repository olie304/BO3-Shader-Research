...
if_nz r13.z
  ...
  if_nz r16.x
    ...
    sqrt r16.y, r16.y
    mad r16.y, r7.w, l(5.000000), r16.y
...
if_nz r13.z
  ...
  if_nz r13.y
    ...
    mov r17.w, l(1)
    loop 
      ige r18.z, r17.w, r13.z
      breakc_nz r18.z
      iadd r18.z, r13.y, r17.w
    ...
    mul r13.z, r13.y, cb10[r0.y + 6].y
    lt r16.w, l(0.000000), r13.z
    if_nz r16.w
      mad r13.w, r13.y, cb10[r0.y + 6].y, r13.w
      mul r13.y, r13.z, cb10[r0.y + 7].y
      mov r18.x, cb10[r0.y + 7].w
      mov r18.yz, cb10[r0.y + 8].xxyx
      dp3 r13.z, r15.xyzx, r18.xyzx
      dp3 r16.w, r17.xyzx, r18.xyzx
      add r16.w, r16.w, -cb10[r0.y + 8].z
      ...
      utof r20.w, r10.w
      sample_l_indexable(texturecubearray)(float,float,float,float) r18.xyz, r20.xyzw, t8.xyzw, s2, r7.w
...
lt r7.w, r13.w, l(0.990000)
if_nz r7.w
  add r7.w, -r13.w, l(1.000000)
  ...
  mad r17.xyz, r14.yzwy, r0.yyyy, r13.yzwy
  mov r15.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r13.yzw, r15.xyzw, t8.wxyz, s2, r9.w
  mad r0.y, cb2[19].x, r7.w, -r10.w
  mad r0.y, r2.y, r0.y, r10.w
  mad r16.xyz, r13.yzwy, r0.yyyy, r16.xyzx
endif 
add r0.y, -r0.w, l(1.000000)
mad r9.xyz, r16.xyzx, r0.yyyy, r9.xyzx
