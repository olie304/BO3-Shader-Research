...
// codeTexture2                      texture  float4          2d             t6      1 
...
max r0.y, r0.x, l(0.00000001)
add r0.x, r0.x, -cb8[15].y
lt r0.x, l(0.000000), r0.x
div r0.y, cb8[0].w, r0.y
mul r0.y, r0.y, cb8[0].x
div r0.y, cb8[0].y, r0.y
add r0.y, r0.y, l(-1.000000)
mul r0.y, r0.y, cb8[0].z
mul r0.y, |r0.y|, cb8[1].x
min r0.y, r0.y, l(15.500000)
...
mad o0.xyz, r0.xyzx, l(4.000000, 4.000000, 4.000000, 0.000000), l(0.00195313, 0.00195313, 0.00195313, 0.000000)
ret 
