...
mul r0.zw, r1.xxxy, l(0.000000, 0.000000, 3.631899, 3.631899)
add r0.z, r0.w, r0.z
add r0.w, cb0[0].y, cb1[69].w
mul r0.w, r0.w, cb0[0].x
mad r0.z, r0.w, l(5.65486670), r0.z
mad r0.xy, r0.wwww, l(9.424778, 7.539823, 0.000000, 0.000000), r0.xyxx
sincos r0.xy, r1.xy, r0.xyxx
sincos r2.x, r3.x, r0.z
mul r0.x, r0.x, l(3.000000)
mad r0.x, r2.x, l(7.500000), r0.x
...
mov r5.y, r6.w
mov r5.z, r7.w
add r3.yzw, r5.xxyz, -cb1[24].xxyz
mov r6.w, r3.z
...
mov o2.xy, v2.xyxx
mov o3.x, v5.x
mul r1.zw, cb0[12].xxxz, l(0.000000, 0.000000, 25.132742, 34.456177)
mul r0.x, r1.x, r1.z
mul r1.z, cb0[11].z, l(27.239243)
mad r0.x, r1.z, r3.x, r0.x
mul r1.z, r3.x, cb0[11].w
mad r0.x, r1.w, r1.y, r0.x
mul r1.xy, r1.xyxx, cb0[12].ywyy
mul r0.x, r0.x, v1.y
mul r0.x, r0.x, l(0.025000)
mul r1.x, r1.x, l(25.132742)
mad r1.x, r1.z, l(27.239243), r1.x
mad r1.x, r1.y, l(34.456177), r1.x
mul r1.x, r1.x, v1.y
