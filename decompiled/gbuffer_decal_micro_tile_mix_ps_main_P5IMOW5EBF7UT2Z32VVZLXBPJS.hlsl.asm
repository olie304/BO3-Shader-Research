...
mad r2.w, r4.z, r2.w, cb0[13].x
add r3.w, -cb0[16].x, cb0[16].y
mad r2.z, r2.z, r3.w, cb0[16].x
mul_sat r2.zw, r2.zzzw, l(0.000000, 0.000000, 0.05882353, 0.05882353)
add r2.z, -r2.w, r2.z
mad r2.z, r0.w, r2.z, r2.w
sample_indexable(texture2d)(float,float,float,float) r5.z, r0.yzyy, t15.yzxw, s5
mad r0.yz, r10.xxyx, l(0.000000, 1.99218750, 1.99218750, 0.000000), l(0.000000, -1.000000, -1.000000, 0.000000)
...
mul r4.xyz, r3.yyyy, r4.xyzx
mad r2.xyz, r2.xywx, r3.xxxx, r4.xyzx
mad r0.yzw, r0.yyzw, r3.zzzz, r2.xxyz
...
dp2 r4.y, r0.ywyy, r2.zwzz
dp3 r0.y, r0.yzwy, r3.xyzx
add r0.y, |r0.y|, l(1.000000)
rsq r0.y, r0.y
mul r0.yz, r0.yyyy, r4.xxyx
mad r3.xy, r0.yzyy, l(0.58823532, 0.58823532, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
ge r0.y, r1.x, l(0.500000)
movc r0.y, r0.y, l(0.500000), l(0.00146628)
mad r3.z, r1.w, l(0.49755621), r0.y
and r0.yzw, r1.zzzz, r3.xxyz
mul o1.xyz, r0.xxxx, r0.yzwy
add r1.y, -r6.z, r6.x
mad r0.y, r1.y, l(0.500000), r6.z
add r1.z, -r0.y, r6.y
