...
loop 
  ieq r9.w, r0.y, l(2)
  breakc_nz r9.w
  movc r9.w, r0.y, r0.x, r9.x
  uge r12.w, r9.w, r8.w
  ult r13.y, r9.w, cb2[0].y
  and r12.w, r12.w, r13.y
  if_nz r12.w
    imul null, r9.w, r9.w, l(14)
    add r13.yzw, r10.xxyz, -cb10[r9.w + 0].xxyz
    and r12.w, l(0x0000ffff), cb10[r9.w + 7].z
    ubfe r15.w, l(6), l(25), cb10[r9.w + 7].z
    ...
    and r16.w, l(1), cb10[r9.w + 6].x
    movc r17.zw, r16.wwww, r15.xxxy, r15.zzzx
    mov r15.x, cb10[r9.w + 6].x
    mov r22.xy, r17.zwzz
    mov r16.w, l(1)
    loop 
      ...
      dp3 r19.w, cb11[r18.w + 0].xyzx, r13.yzwy
      add_sat r19.w, r19.w, cb11[r18.w + 0].w
      mul r19.w, r19.w, r22.x
      dp3 r22.z, cb11[r18.w + 1].xyzx, r13.yzwy
      add_sat r22.z, r22.z, cb11[r18.w + 1].w
      mul r19.w, r19.w, r22.z
      dp3 r22.z, cb11[r18.w + 2].xyzx, r13.yzwy
      add_sat r22.z, r22.z, cb11[r18.w + 2].w
      mul r19.w, r19.w, r22.z
      dp3 r22.z, cb11[r18.w + 3].xyzx, r13.yzwy
      add_sat r22.z, r22.z, cb11[r18.w + 3].w
      mul r19.w, r19.w, r22.z
      dp3 r22.z, cb11[r18.w + 4].xyzx, r13.yzwy
      add_sat r22.z, r22.z, cb11[r18.w + 4].w
      mul r19.w, r19.w, r22.z
      dp3 r22.z, cb11[r18.w + 5].xyzx, r13.yzwy
      add_sat r18.w, r22.z, cb11[r18.w + 5].w
      mul r22.x, r18.w, r19.w
      ushr r22.z, r15.x, l(2)
      ubfe r22.w, l(1), l(2), r15.x
      and r23.x, r22.z, l(2)
      max r23.y, r22.x, r22.y
      mad r18.w, -r19.w, r18.w, l(1.000000)
      mul r18.w, r18.w, r22.y
      movc r17.y, r23.x, r18.w, r23.y
      movc r22.xy, r22.wwww, r22.xyxx, r17.xyxx
      iadd r16.w, r16.w, l(1)
      mov r15.x, r22.z
    endloop 
    mov_sat r22.y, r22.y
    mul r12.w, r22.y, cb10[r9.w + 6].y
    lt r15.x, l(0.000000), r12.w
    if_nz r15.x
      mad r21.w, r22.y, cb10[r9.w + 6].y, r21.w
      mul r12.w, r12.w, cb10[r9.w + 7].y
      mov r23.x, cb10[r9.w + 7].w
      mov r23.yz, cb10[r9.w + 8].xxyx
      dp3 r15.x, r14.xyzx, r23.xyzx
      dp3 r15.w, r13.yzwy, r23.xyzx
      add r15.w, r15.w, -cb10[r9.w + 8].z
      ...
      mov r23.x, cb10[r9.w + 8].w
      mov r23.yz, cb10[r9.w + 9].xxyx
      dp3 r15.w, r14.xyzx, r23.xyzx
      dp3 r16.w, r13.yzwy, r23.xyzx
      add r16.w, r16.w, -cb10[r9.w + 9].z
      ...
      mov r23.x, cb10[r9.w + 9].w
      mov r23.yz, cb10[r9.w + 10].xxyx
      dp3 r15.w, r14.xyzx, r23.xyzx
      dp3 r16.w, r13.yzwy, r23.xyzx
      add r16.w, r16.w, -cb10[r9.w + 10].z
      ge r17.y, r16.w, l(0.000000)
      max r16.w, r6.w, |r16.w|
      movc r16.w, r17.y, r16.w, -r16.w
      max r15.w, -r15.w, l(0.00000010)
      div r15.w, r16.w, r15.w
      min r15.x, |r15.w|, r15.x
      mov r23.x, cb10[r9.w + 10].w
      mov r23.yz, cb10[r9.w + 11].xxyx
      dp3 r15.w, r14.xyzx, r23.xyzx
      dp3 r16.w, r13.yzwy, r23.xyzx
      add r16.w, r16.w, -cb10[r9.w + 11].z
      ge r17.y, r16.w, l(0.000000)
      max r16.w, r6.w, |r16.w|
      movc r16.w, r17.y, r16.w, -r16.w
      max r15.w, -r15.w, l(0.00000010)
      div r15.w, r16.w, r15.w
      min r15.x, |r15.w|, r15.x
      mov r23.x, cb10[r9.w + 11].w
      mov r23.yz, cb10[r9.w + 12].xxyx
      dp3 r15.w, r14.xyzx, r23.xyzx
      dp3 r16.w, r13.yzwy, r23.xyzx
      add r16.w, r16.w, -cb10[r9.w + 12].z
      ge r17.y, r16.w, l(0.000000)
      max r16.w, r6.w, |r16.w|
      movc r16.w, r17.y, r16.w, -r16.w
      max r15.w, -r15.w, l(0.00000010)
      div r15.w, r16.w, r15.w
      min r15.x, |r15.w|, r15.x
      mov r23.x, cb10[r9.w + 12].w
      mov r23.yz, cb10[r9.w + 13].xxyx
      dp3 r15.w, r14.xyzx, r23.xyzx
      dp3 r16.w, r13.yzwy, r23.xyzx
      add r16.w, r16.w, -cb10[r9.w + 13].z
      ge r17.y, r16.w, l(0.000000)
      max r16.w, r6.w, |r16.w|
      movc r16.w, r17.y, r16.w, -r16.w
      max r15.w, -r15.w, l(0.00000010)
      div r15.w, r16.w, r15.w
      min r15.x, |r15.w|, r15.x
      add r23.x, r13.y, cb10[r9.w + 3].w
      add r23.yz, r13.zzwz, cb10[r9.w + 4].xxyx
      mad r17.yzw, r14.xxyz, r15.xxxx, r23.xxyz
      ...
      mov r23.x, cb10[r9.w + 0].w
      mov r23.y, cb10[r9.w + 1].z
      mov r23.z, cb10[r9.w + 2].y
      dp3 r24.x, r17.yzwy, r23.xyzx
      mov r25.xy, cb10[r9.w + 1].xwxx
      mov r25.z, cb10[r9.w + 2].z
      dp3 r24.y, r17.yzwy, r25.xyzx
      mov r26.x, cb10[r9.w + 1].y
      mov r26.yz, cb10[r9.w + 2].xxwx
      dp3 r24.z, r17.yzwy, r26.xyzx
      ubfe r15.w, l(9), l(16), cb10[r9.w + 7].z
      utof r24.w, r15.w
      sample_l_indexable(texturecubearray)(float,float,float,float) r17.yzw, r24.xyzw, t8.wxyz, s2, r15.x
      dp3 r27.x, r13.yzwy, r23.xyzx
      dp3 r27.y, r13.yzwy, r25.xyzx
      dp3 r27.z, r13.yzwy, r26.xyzx
      mad_sat r13.yzw, r27.xxyz, cb10[r9.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
      mul r27.xy, r13.yzyy, cb10[r9.w + 4].zwzz
      mul r27.z, r13.w, cb10[r9.w + 5].x
      add r13.yzw, r27.xxyz, cb10[r9.w + 5].yyzw
      ...
      movc r19.z, r22.w, l(0), l(0.500000)
      ...
      mad r13.yzw, r13.yyzw, r25.zzzz, r23.xxyz
      sample_l_indexable(texturecubearray)(float,float,float,float) r22.xzw, r24.xyzw, t8.xwyz, s2, l(6.000000)
      mul r23.xyz, r13.yzwy, r22.xzwx
      dp3 r9.w, r23.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r20.xyz, r13.yzwy, r22.xzwx, r20.xyzx
      mul r13.y, r7.w, r9.w
      ...
      mov r23.x, r20.w
      mov r23.yz, r21.yyzy
      mad r21.xyz, r17.yzwy, r9.wwww, r23.xyzx
      mov r20.w, r21.x
    endif 
  endif 
  iadd r0.y, r0.y, l(1)
...
if_nz r0.y
  ...
  loop 
    ...
    if_nz r12.w
      imul null, r9.w, r9.w, l(14)
      add r23.xyz, r10.xyzx, -cb10[r9.w + 0].xyzx
      and r12.w, l(0x0000ffff), cb10[r9.w + 7].z
      ubfe r15.w, l(6), l(25), cb10[r9.w + 7].z
      imul null, r16.w, r12.w, l(6)
      dp3 r17.z, cb11[r16.w + 0].xyzx, r23.xyzx
      add_sat r17.z, r17.z, cb11[r16.w + 0].w
      dp3 r17.w, cb11[r16.w + 1].xyzx, r23.xyzx
      add_sat r17.w, r17.w, cb11[r16.w + 1].w
      mul r17.z, r17.w, r17.z
      dp3 r17.w, cb11[r16.w + 2].xyzx, r23.xyzx
      add_sat r17.w, r17.w, cb11[r16.w + 2].w
      mul r17.z, r17.w, r17.z
      dp3 r17.w, cb11[r16.w + 3].xyzx, r23.xyzx
      add_sat r17.w, r17.w, cb11[r16.w + 3].w
      mul r17.z, r17.w, r17.z
      dp3 r17.w, cb11[r16.w + 4].xyzx, r23.xyzx
      add_sat r17.w, r17.w, cb11[r16.w + 4].w
      mul r17.z, r17.w, r17.z
      dp3 r17.w, cb11[r16.w + 5].xyzx, r23.xyzx
      add_sat r16.w, r17.w, cb11[r16.w + 5].w
      mul r15.x, r16.w, r17.z
      and r16.w, l(1), cb10[r9.w + 6].x
      movc r17.zw, r16.wwww, r15.xxxy, r15.zzzx
      ...
      loop 
        ...
        iadd r18.w, r12.w, r16.w
        imul null, r18.w, r18.w, l(6)
        dp3 r19.w, cb11[r18.w + 0].xyzx, r23.xyzx
        add_sat r19.w, r19.w, cb11[r18.w + 0].w
        mul r19.w, r19.w, r24.x
        dp3 r23.w, cb11[r18.w + 1].xyzx, r23.xyzx
        add_sat r23.w, r23.w, cb11[r18.w + 1].w
        mul r19.w, r19.w, r23.w
        dp3 r23.w, cb11[r18.w + 2].xyzx, r23.xyzx
        add_sat r23.w, r23.w, cb11[r18.w + 2].w
        mul r19.w, r19.w, r23.w
        dp3 r23.w, cb11[r18.w + 3].xyzx, r23.xyzx
        add_sat r23.w, r23.w, cb11[r18.w + 3].w
        mul r19.w, r19.w, r23.w
        dp3 r23.w, cb11[r18.w + 4].xyzx, r23.xyzx
        add_sat r23.w, r23.w, cb11[r18.w + 4].w
        mul r19.w, r19.w, r23.w
        dp3 r23.w, cb11[r18.w + 5].xyzx, r23.xyzx
        add_sat r18.w, r23.w, cb11[r18.w + 5].w
        mul r24.x, r18.w, r19.w
        ushr r23.w, r15.x, l(2)
        ubfe r24.z, l(1), l(2), r15.x
        and r24.w, r23.w, l(2)
        max r25.x, r24.x, r24.y
        mad r18.w, -r19.w, r18.w, l(1.000000)
        mul r18.w, r18.w, r24.y
        movc r17.y, r24.w, r18.w, r25.x
        movc r24.xy, r24.zzzz, r24.xyxx, r17.xyxx
        iadd r16.w, r16.w, l(1)
        mov r15.x, r23.w
      endloop 
      add_sat r12.w, -r21.w, r24.y
      mul r15.x, r12.w, cb10[r9.w + 6].y
      lt r15.w, l(0.000000), r15.x
      if_nz r15.w
        mad r22.w, r12.w, cb10[r9.w + 6].y, r22.w
        mul r12.w, r15.x, cb10[r9.w + 7].y
        mov r25.x, cb10[r9.w + 7].w
        mov r25.yz, cb10[r9.w + 8].xxyx
        dp3 r15.x, r14.xyzx, r25.xyzx
        dp3 r15.w, r23.xyzx, r25.xyzx
        add r15.w, r15.w, -cb10[r9.w + 8].z
        ge r16.w, r15.w, l(0.000000)
        max r15.w, r6.w, |r15.w|
        movc r15.w, r16.w, r15.w, -r15.w
        ...
        div r15.w, r16.w, r15.w
        min r15.x, |r15.w|, r15.x
        add r25.x, r23.x, cb10[r9.w + 3].w
        add r25.yz, r23.yyzy, cb10[r9.w + 4].xxyx
        mad r17.yzw, r14.xxyz, r15.xxxx, r25.xxyz
        dp3 r15.w, r17.yzwy, r17.yzwy
        sqrt r15.w, r15.w
        div r15.x, r15.x, r15.w
        add r15.x, r15.x, r15.x
        ...
        dp3 r26.x, r17.yzwy, r25.xyzx
        mov r27.xy, cb10[r9.w + 1].xwxx
        mov r27.z, cb10[r9.w + 2].z
        dp3 r26.y, r17.yzwy, r27.xyzx
        mov r28.x, cb10[r9.w + 1].y
        mov r28.yz, cb10[r9.w + 2].xxwx
        dp3 r26.z, r17.yzwy, r28.xyzx
        ubfe r15.w, l(9), l(16), cb10[r9.w + 7].z
        utof r26.w, r15.w
        sample_l_indexable(texturecubearray)(float,float,float,float) r17.yzw, r26.xyzw, t8.wxyz, s2, r15.x
        dp3 r29.x, r23.xyzx, r25.xyzx
        dp3 r29.y, r23.xyzx, r27.xyzx
        dp3 r29.z, r23.xyzx, r28.xyzx
        mad_sat r23.xyz, r29.xyzx, cb10[r9.w + 3].xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
        mul r29.xy, r23.xyxx, cb10[r9.w + 4].zwzz
        mul r29.z, r23.z, cb10[r9.w + 5].x
        add r23.xyz, r29.xyzx, cb10[r9.w + 5].yzwy
        ...
        movc r19.z, r24.w, l(0), l(0.500000)
        ...
        mad r13.yzw, r23.xxyz, r24.xxzw, r13.yyzw
        mul r15.x, r7.w, r9.w
        mul r17.yzw, r12.wwww, r17.yyzw
        dp3 r12.w, r17.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
        mad r9.w, r7.w, r9.w, r12.w
        div r9.w, r15.x, r9.w
        mad r22.xyz, r17.yzwy, r9.wwww, r22.xyzx
      endif 
    endif 
    iadd r0.y, r0.y, l(1)
  endloop 
...
if_nz r0.y
  ...
  mov r14.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r16.xyz, r14.xyzw, t8.xyzw, s2, r5.w
...
switch r2.y
  ...
  mad r9.xyw, -r19.xyxz, l(0.500000, 0.500000, 0.000000, 0.500000), cb9[r1.w + 0].xyxz
  add r20.xyz, -r10.xyzx, r9.xywx
  dp3 r2.w, r19.xyzx, r20.xyzx
  div_sat r4.z, -r2.w, cb9[r1.w + 6].y
  mad r21.xyz, r4.zzzz, r19.xyzx, r9.xywx
  ...
  if_nz r8.w
    ...
    if_nz r8.w
      ...
      if_nz r8.w
        ...
        mad r9.xyw, r2.wwww, r19.xyxz, r9.xyxw
        movc r9.xyw, r2.yyyy, r9.xyxw, cb9[r1.w + 0].xyxz
        add r9.xyw, -r10.xyxz, r9.xyxw
        dp3 r2.y, r9.xywx, r9.xywx
        rsq r2.y, r2.y
        mul r14.xyz, r2.yyyy, r9.xywx
        ...
        mad r20.xyz, r13.yzwy, r2.zzzz, r20.xyzx
        dp3_sat r6.w, r11.xyzx, r14.xyzx
        mad r9.xyw, r9.xyxw, r2.yyyy, r12.xyxz
        dp3 r2.y, r9.xywx, r9.xywx
        rsq r2.y, r2.y
        mul r9.xyw, r2.yyyy, r9.xyxw
        dp3 r2.y, r9.xywx, r12.xyzx
        dp3 r7.w, r11.xyzx, r9.xywx
        mad r9.x, |r7.w|, r0.z, -|r7.w|
        mad r7.w, |r7.w|, r9.x, l(1.000000)
        mad r9.x, r6.w, r0.x, r0.y
        mul r7.w, r7.w, r7.w
        mul r7.w, r9.x, r7.w
        rcp r7.w, r7.w
        mul r6.w, r8.w, r6.w
        mul r6.w, r6.w, r7.w
        mul r5.w, r5.w, r6.w
        mad r9.xyw, r5.wwww, r19.xyxz, r15.xyxz
        ...
        movc r15.xyz, r4.zzzz, r9.xywx, r15.xyzx
      endif 
    endif 
  endif 
  break 
  ...
  if_nz r6.w
    ...
    if_nz r6.w
      ...
      if_nz r7.w
        ...
        mul r1.z, r6.w, r1.z
        mul r19.xyz, r9.xywx, r1.zzzz
        lt r1.w, l(0.000000), r2.w
        mad r2.xzw, r13.yyzw, r2.zzzz, r19.xxyz
        mad r13.xyz, r14.xyzx, r2.yyyy, r12.xyzx
        dp3 r2.y, r13.xyzx, r13.xyzx
        rsq r2.y, r2.y
        mul r13.xyz, r2.yyyy, r13.xyzx
        dp3 r2.y, r13.xyzx, r12.xyzx
        dp3 r3.x, r11.xyzx, r13.xyzx
        ...
        mad r11.xyz, r0.xxxx, r9.xywx, r15.xyzx
        add_sat r0.y, -r2.y, l(1.000000)
        mul r0.z, r0.y, r0.y
        mul r0.z, r0.z, r0.z
        mul r0.y, r0.z, r0.y
        mul r0.x, r0.y, r0.x
        mad r0.xyz, r0.xxxx, r9.xywx, r18.xyzx
        mad r9.xyz, r1.zzzz, r9.xywx, r17.xyzx
        and r9.xyz, r0.wwww, r9.xyzx
        movc r16.xyz, r1.wwww, r2.xzwx, r16.xyzx
        movc r17.xyz, r1.wwww, r17.xyzx, r9.xyzx
        movc r18.xyz, r1.wwww, r0.xyzx, r18.xyzx
        movc r15.xyz, r1.wwww, r11.xyzx, r15.xyzx
      endif 
    endif 
  endif 
  break 
...
ret 
// Approximately 1427 instruction slots used
