  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r6.y = r5.x;
  r6.z = r4.x;
  r4.x = dot(r0.xy, r6.yz);
  r4.y = dot(r0.xy, r6.xy);
  r2.zw = r4.xy + r1.yx;
  r1.z = 0.5 + r1.z;
  r2.zw = r2.zw + r1.zz;
  r2.zw = detailScale1.xy * r2.zw;
  r4.xy = float2(0.5,0.5) + r4.xy;
  r4.xy = detailScale1.xy * r4.xy;
  r2.zw = useUVOffsets1 ? r2.zw : r4.xy;
  r4.xyzw = colorMap.Sample(colorSampler_s, r2.zw).xyzw;
  r1.w = tintMask.Sample(colorSampler_s, r2.zw).x;
  r5.xyz = float3(-1,-1,-1) + colorTint.xyz;
  r5.xyz = r1.www * r5.xyz + float3(1,1,1);
  r4.xyz = r5.xyz * r4.xyz;
  r5.xyz = detailMap1.Sample(normalSampler_s, r2.zw).xyz;
  ...
  r7.y = r6.x;
  r7.z = r5.x;
  r5.x = dot(r0.xy, r7.yz);
  r5.y = dot(r0.xy, r7.xy);
  r0.xy = r5.xy + r1.yx;
  r0.xy = r0.xy + r1.zz;
  ...
  r5.xyzw = colorMapDetail2.Sample(colorSampler_s, r0.xy).xyzw;
  r1.x = tintMask2.Sample(colorSampler_s, r0.xy).x;
  r6.xyz = float3(-1,-1,-1) + colorTint1.xyz;
  r1.xyz = r1.xxx * r6.xyz + float3(1,1,1);
  r5.xyz = r5.xyz * r1.xyz;
  r1.xyz = detailMap2.Sample(normalSampler_s, r0.xy).xyz;
  r5.xyzw = r5.xyzw + -r4.xyzw;
  r4.xyzw = r0.zzzz * r5.xyzw + r4.xyzw;
  r4.xyz = v8.xyz * r4.xyz;
  ...
  r0.y = r1.z * r1.z;
  r0.xy = float2(-17,0.333333343) * r0.xy;
  r0.yw = min(float2(1,1), r0.yw);
  r3.xy = r2.zw * detailScaleHeight1 + r2.xy;
  r1.z = dot(r3.xyz, r3.xyz);
  r1.z = rsqrt(r1.z);
  r5.xyz = r3.xyz * r1.zzz;
  r5.w = r1.w * detailScaleHeight1 + r0.w;
  r3.xy = r1.xy * detailScaleHeight2 + r2.xy;
  r1.x = dot(r3.xyz, r3.xyz);
  r1.x = rsqrt(r1.x);
  r1.xyz = r3.xyz * r1.xxx;
  r1.w = r0.y * detailScaleHeight2 + r0.w;
  r1.xyzw = r1.xyzw + -r5.xyzw;
  r1.xyzw = r0.zzzz * r1.xyzw + r5.xyzw;
  ...
  r0.yzw = r0.yzw * r1.zzz + r1.xyw;
  r1.x = dot(r0.yzw, r0.yzw);
  r1.x = rsqrt(r1.x);
  r0.yzw = r1.xxx * r0.yzw;
  o0.xyz = r4.xyz * r4.www;
  r1.xy = (uint2)v0.xy;
  r1.zw = float2(0,0);
  ...
  o1.xyz = r0.xyz * r4.www;
  o2.xyzw = float4(0.0399999991,0.5,1,1) * r4.wwww;
  o0.w = r4.w;
  o1.w = r4.w;
  return;
}