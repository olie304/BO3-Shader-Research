...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:29:04 2021
//
//
// Buffer Definitions: 
//
...
//   float vertPush;                    // Offset:  252 Size:     4 [unused]
...
sample_indexable(texture2d)(float,float,float,float) r2.z, r0.yzyy, t14.yzxw, s5
if_nz r2.y
  ...
  mul r2.y, r3.w, v1.w
  add r2.w, -cb0[14].x, cb0[14].y
  mad r2.z, r2.z, r2.w, cb0[14].x
...
mad r3.xy, r2.yzyy, l(1.99218750, 1.99218750, 0.000000, 0.000000), l(-1.000000, -1.000000, 0.000000, 0.000000)
...
sample_indexable(texture2d)(float,float,float,float) r4.xyz, r0.yzyy, t12.xyzw, s5
if_nz r2.z
...
mad r0.z, cb1[62].x, r2.x, cb0[12].x
...
if_nz r1.w
  ...
  movc r2.yzw, r2.yyyy, r7.xxyz, r6.xxyw
  movc r6.xyz, r6.zzzz, l(0,1.000000,0,0), r1.xyzx
  movc r1.xyz, r2.xxxx, r2.yzwy, r6.xyzx
endif 
...
mad r2.yzw, cb1[60].wwww, r2.xxyz, r3.xxyz
div r0.zw, v7.xxxy, v7.wwww
mul r3.xy, cb1[44].xyxx, l(0.500000, 0.500000, 0.000000, 0.000000)
mul r6.x, r0.z, r3.x
mul r6.y, r0.w, -r3.y
mad r0.zw, cb1[44].xxxy, l(0.000000, 0.000000, 0.500000, 0.500000), r6.xxxy
add r0.zw, -r0.zzzw, v0.xxxy
add r1.w, r5.y, r5.x
mad r1.w, r4.z, r0.x, r1.w
mul r1.w, r1.w, l(0.500000)
mad r3.xyz, r4.xyzx, r0.xxxx, -r1.wwww
max r0.x, r3.z, r3.y
max r0.x, r0.x, r3.x
max r0.x, r0.x, r1.w
eq r1.w, r0.x, r3.x
