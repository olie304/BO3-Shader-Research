...
//   float solidBeam;                   // Offset:  160 Size:     4
//   float noiseThreshold;              // Offset:  164 Size:     4
//
// }
//
...
mul r0.y, r0.w, r1.x
mul r0.z, r0.w, -r1.y
mul r1.yzw, r0.yyzw, l(0.000000, 1.69885421, 0.95560545, 1.000000)
mul r0.xyz, r0.yzwy, l(0.06115875, 0.03440180, 0.036000, 0.000000)
frc r0.xyz, r0.xyzx
lt r0.xyz, l(0.900000, 0.900000, 0.900000, 0.000000), r0.xyzx
mov r1.x, cb1[69].w
...
dp4 r2.x, r1.xyzw, l(81.239487, 17.348024, 37.349838, 59.394840)
frc r1.z, r2.x
dp4 r1.x, r1.xyzw, l(81.239487, 17.348024, 37.349838, 59.394840)
frc r1.x, r1.x
lt r1.x, cb0[10].y, r1.x
mul r1.y, cb1[69].w, l(0.100000)
frc r1.y, r1.y
mad r1.y, r1.y, l(2000.000000), l(50.000000)
add r0.w, -r0.w, r1.y
add r0.w, -r0.w, l(50.000000)
lt r1.y, l(50.000000), r0.w
...
add r0.y, r0.y, -r1.y
add r2.xyzw, v1.xyxy, l(-0.00078125, 0.000000, 0.00078125, 0.000000)
