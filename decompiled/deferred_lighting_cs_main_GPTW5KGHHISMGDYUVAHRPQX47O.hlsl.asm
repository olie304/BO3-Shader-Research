...
mad r9.w, r7.w, l(5.000000), l(-2.500000)
...
mul r12.w, r7.w, r8.w
mad r12.w, -r12.w, l(2.015905), r15.z
exp r12.w, r12.w
...
loop 
  ieq r15.w, r13.w, l(2)
  breakc_nz r15.w
  movc r15.w, r13.w, r0.x, r15.y
  uge r18.w, r15.w, r12.w
  ...
  if_nz r18.w
    ...
    if_nz r18.w
      ...
      sqrt r18.w, r18.w
      mad r18.w, r7.w, l(5.000000), r18.w
...
rcp r7.w, r7.w
mov_sat r20.x, r20.x
mul r17.xyz, r7.wwww, r25.xyzx
mul r18.xyz, r7.wwww, r26.xyzx
lt r9.w, r20.x, l(0.990000)
if_nz r9.w
  ...
  mad r17.xyz, r25.xyzx, r7.wwww, r19.xyzx
  mov r16.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r19.xyz, r16.xyzw, t8.xyzw, s2, r8.w
  mad r7.w, cb2[19].x, r9.w, -r10.w
  mad r7.w, r2.y, r7.w, r10.w
  mad r18.xyz, r19.xyzx, r7.wwww, r18.xyzx
endif 
...
loop 
  ...
  switch r9.w
    ...
    rsq r15.y, r13.w
    mul r38.xyz, r15.yyyy, r38.xyzx
    dp3 r15.y, r11.xyzx, r38.xyzx
    mov_sat r15.w, r15.y
    movc r15.w, r3.w, |r15.y|, r15.w
    ...
    if_nz r16.w
      ...
      if_nz r16.w
        ...
        ine r16.w, r16.w, l(1)
        if_nz r16.w
          mad r16.w, |r15.y|, l(-0.200000), l(0.400000)
          lt r18.w, r15.y, l(0.000000)
        ...
        if_nz r16.w
          ...
          if_nz r12.w
            ...
            mad r12.w, |r15.y|, l(-0.200000), l(0.400000)
            lt r18.w, r15.y, l(0.000000)
            and r18.w, r3.w, r18.w
          ...
          mad r21.yzw, r15.yyyy, r23.xxyz, r35.xxyz
          ...
          if_nz r11.w
            imad r15.yw, r10.wwww, l(0, 24, 0, 24), l(0, 88, 0, 108)
            ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r10.w, cb2[52].x, r15.y, u2.xxxx
            or r10.w, r10.w, l(8)
            store_structured u2.x, cb2[52].x, r15.y, r10.w
    ...
    if_nz r15.y
      ...
      dp4 r15.y, r36.xyzw, r5.xyzw
      lt r15.w, r15.y, l(1.000000)
      if_nz r15.w
        ...
        mad_sat r22.yz, r15.yyyy, cb9[r8.w + 2].xxzx, cb9[r8.w + 2].yywy
        ...
        div r25.xy, r37.xyxx, r15.yyyy
        lt r15.y, cb9[r8.w + 10].w, l(0.00048828)
        if_nz r15.y
          mad_sat r22.yz, |r25.xxyx|, cb9[r8.w + 12].xxyx, cb9[r8.w + 12].zzwz
          mul r24.yz, r22.yyzy, r22.yyzy
          mad r22.yz, r22.yyzy, l(0.000000, -2.000000, -2.000000, 0.000000), l(0.000000, 3.000000, 3.000000, 0.000000)
          mul r22.yz, r22.yyzy, r24.yyzy
          mul r15.y, r22.z, r22.y
        else 
          ...
          mul r15.y, r17.w, r18.w
        endif 
        mul r15.w, r15.y, r16.w
        and r15.y, l(255), cb9[r8.w + 14].w
        if_nz r15.y
      ...
      lt r15.y, l(0.000000), r15.w
      if_nz r15.y
        ubfe r15.y, l(3), l(27), cb9[r8.w + 1].w
        and r16.w, r9.w, l(7)
          ...
          if_nz r18.w
            ...
            if_nz cb2[58].y
              ...
              loop 
                ...
                sample_c_lz_indexable(texture2darray)(float,float,float,float) r22.z, r36.xyzx, t9.xxxx, s13, r15.y
                mad r18.w, r22.z, l(0.125000), r18.w
                iadd r22.y, r22.y, l(1)
              endloop 
            else 
              utof r26.z, r17.w
              sample_c_lz_indexable(texture2darray)(float,float,float,float) r18.w, r26.xyzx, t9.xxxx, s13, r15.y
            endif 
            mul r15.y, r18.w, r18.w
            mul r15.y, r18.w, r15.y
          else 
        ...
        if_nz r15.w
          mul r15.w, r2.z, cb9[r8.w + 1].z
          mul r15.w, r12.w, r15.w
          ...
          if_nz r10.w
            ...
            store_structured u2.x, cb2[52].x, r21.z, r15.y
          endif 
          iadd r6.w, r6.w, l(0x00010101)
        else 
          mov r6.w, r16.w
...
mad r4.xyz, r32.xyzx, r6.xyzx, r4.xyzx
