...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  if (r9.z != 0) {
    ...
    if (r9.w != 0) {
      ...
      r10.w = saturate(r2.w);
      r17.xyz = -v7.xyz * r4.zzz + sunConstants.wldDir.xyz;
