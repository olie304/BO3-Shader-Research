  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.xy = v0.xy + v0.xy;
  r0.xy = (int2)r0.xy;
  r0.zw = (int2)postFxConst00.xx;
  r1.xyzw = sceneColor.Load(r0.xyw, int3(0, 0, 0)).xyzw;
  r2.xyzw = r1.xyzw * r1.wwww;
  r3.xyzw = sceneColor.Load(r0.xyw).xyzw;
  r2.xyzw = r3.xyzw * r3.wwww + r2.xyzw;
  r1.x = r3.w + r1.w;
  r3.xyzw = sceneColor.Load(r0.xyw, int3(0, 0, 0)).xyzw;
  r0.xyzw = sceneColor.Load(r0.xyz, int3(0, 0, 0)).xyzw;
  r2.xyzw = r3.xyzw * r3.wwww + r2.xyzw;
  r1.x = r3.w + r1.x;
  r1.x = r1.x + r0.w;
