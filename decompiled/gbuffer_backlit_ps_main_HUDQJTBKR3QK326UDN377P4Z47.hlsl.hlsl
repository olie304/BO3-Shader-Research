  ...
  out float2 o3 : SV_TARGET3)
{
  ...
  if (r2.x != 0) {
    ...
    r2.xy = r2.xy * r6.zw + r6.xy;
    r2.xy = v0.xy + -r2.xy;
    r2.w = r5.x + r5.y;
    r2.w = r4.z * r2.z + r2.w;
    r2.w = 0.5 * r2.w;
    r6.xyz = r4.xyz * r2.zzz + -r2.www;
    r4.w = max(r6.y, r6.z);
    r4.w = max(r6.x, r4.w);
    r2.w = max(r4.w, r2.w);
    r4.w = cmp(r2.w == r6.x);
  ...
  r6.x = 1;
  r3.x = 0;
  r3.xyzw = r2.zzzz ? r6.xyzw : r3.xyzw;
  r1.z = r2.z ? r2.w : r1.z;
  r2.z = cmp(r1.z == r4.y);
  r6.yzw = float3(-1,1,-1) * r3.yzw;
  r2.w = 2 + r1.z;
