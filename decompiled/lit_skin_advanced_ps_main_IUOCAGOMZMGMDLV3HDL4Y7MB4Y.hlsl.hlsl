...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  r1.zw = saturate(tensionParms.ww * v8.xy);
  r1.zw = log2(r1.zw);
  r1.zw = tensionParms.zz * r1.zw;
  r1.zw = exp2(r1.zw);
  r2.x = cmp(r1.w < r1.z);
  r2.yzw = compressNormal.Sample(normalSampler_s, w1.xy).xyz;
  r3.xyz = stretchNormal.Sample(normalSampler_s, w1.xy).xyz;
  r2.yzw = r2.xxx ? r2.yzw : r3.xyz;
  r1.z = r2.x ? r1.z : r1.w;
  r1.w = r2.x ? tensionParms.y : tensionParms.x;
  ...
  r1.w = min(1, r1.w);
  r3.xy = r2.xy * detailScaleHeight + r3.xy;
  r2.x = dot(r3.xyz, r3.xyz);
  r2.x = rsqrt(r2.x);
  r2.xyz = r3.xyz * r2.xxx;
  r1.z = r1.w * detailScaleHeight + r1.z;
  r1.w = v9.x ? 1 : -1;
...
r3.w = samp0[]..swiz;
  ...
  while (true) {
    ...
    r2.w = visibleProbes.Load(r12.xyzw).x;
  // Known bad code for instruction (needs manual fix):
  ...
  r33.x = samp0[]..swiz;
  r33.y = samp0[]..swiz;
    r12.xyz = v7.xyz + -r21.yzw;
    r3.w = dot(r12.xyz, r12.xyz);
    r3.w = sqrt(r3.w);
    r3.w = cmp(probeDebugRadius >= r3.w);
    r4.w = (int)r27.y & 0x0000ffff;
  // Known bad code for instruction (needs manual fix):
  ...
  r39.z = samp0[]..swiz;
  r39.w = samp0[]..swiz;
    r6.w = dot(r34.xyz, r12.xyz);
    r6.w = saturate(r6.w + r34.w);
    r8.w = dot(r35.xyz, r12.xyz);
    r8.w = saturate(r8.w + r35.w);
    r6.w = r8.w * r6.w;
    r8.w = dot(r36.xyz, r12.xyz);
    r8.w = saturate(r8.w + r36.w);
    r6.w = r8.w * r6.w;
    r8.w = dot(r37.xyz, r12.xyz);
    r8.w = saturate(r8.w + r37.w);
    r6.w = r8.w * r6.w;
    r8.w = dot(r38.xyz, r12.xyz);
    r8.w = saturate(r8.w + r38.w);
    r6.w = r8.w * r6.w;
    r8.w = dot(r39.xyz, r12.xyz);
    r8.w = saturate(r8.w + r39.w);
    r13.x = r8.w * r6.w;
    r6.w = (int)r5.z & 1;
    r10.zw = r6.ww ? r13.xy : r13.zx;
    r34.xy = r27.zw;
    r34.z = r28.z;
    r6.w = dot(r7.xyz, r34.xyz);
    r8.w = dot(r12.xyz, r34.xyz);
    r8.w = r8.w + -r28.w;
    r9.w = cmp(r8.w >= 0);
    r8.w = max(abs(r8.w), r1.x);
    r8.w = r9.w ? r8.w : -r8.w;
    r6.w = max(1.00000001e-07, -r6.w);
    r6.w = r8.w / r6.w;
    r6.w = min(131072, abs(r6.w));
    r28.z = r29.z;
    r8.w = dot(r7.xyz, r28.xyz);
    r9.w = dot(r12.xyz, r28.xyz);
    r9.w = r9.w + -r29.w;
    r13.x = cmp(r9.w >= 0);
    r9.w = max(abs(r9.w), r1.x);
    r9.w = r13.x ? r9.w : -r9.w;
    r8.w = max(1.00000001e-07, -r8.w);
    r8.w = r9.w / r8.w;
    r6.w = min(abs(r8.w), r6.w);
    r29.z = r30.z;
    r8.w = dot(r7.xyz, r29.xyz);
    r9.w = dot(r12.xyz, r29.xyz);
    r9.w = r9.w + -r30.w;
    r13.x = cmp(r9.w >= 0);
    r9.w = max(abs(r9.w), r1.x);
    r9.w = r13.x ? r9.w : -r9.w;
    ...
    r6.w = min(abs(r8.w), r6.w);
    r31.z = r32.x;
    r8.w = dot(r7.xyz, r31.xyz);
    r9.w = dot(r12.xyz, r31.xyz);
    r9.w = r9.w + -r32.y;
    r13.x = cmp(r9.w >= 0);
    r9.w = max(abs(r9.w), r1.x);
    r9.w = r13.x ? r9.w : -r9.w;
    ...
    r6.w = min(abs(r8.w), r6.w);
    r33.zw = r32.zw;
    r8.w = dot(r7.zxy, r33.xzw);
    r9.w = dot(r12.zxy, r33.xzw);
    r9.w = r9.w + -r33.y;
    r13.x = cmp(r9.w >= 0);
    r9.w = max(abs(r9.w), r1.x);
    r9.w = r13.x ? r9.w : -r9.w;
    ...
    r28.x = r24.w;
    r28.yz = r25.zw;
    r28.xyz = r28.xyz + r12.xyz;
    r28.xyz = r7.xyz * r6.www + r28.xyz;
    r8.w = dot(r28.xyz, r28.xyz);
    r8.w = sqrt(r8.w);
    r6.w = r6.w / r8.w;
    r6.w = r6.w + r6.w;
    r6.w = sqrt(r6.w);
    ...
    while (true) {
      ...
      if (r13.w != 0) {
        ...
        if (r3.w != 0) {
          ...
          r13.w = 1;
          while (true) {
            r14.z = cmp((int)r13.w >= (int)r13.x);
            if (r14.z != 0) break;
            r14.z = (int)r4.w + (int)r13.w;
          // Known bad code for instruction (needs manual fix):
          ...
          r35.z = samp0[]..swiz;
          r35.w = samp0[]..swiz;
            r14.z = dot(r30.xyz, r12.xyz);
            r14.z = saturate(r14.z + r30.w);
            r14.z = r29.x * r14.z;
            r14.w = dot(r31.xyz, r12.xyz);
            r14.w = saturate(r14.w + r31.w);
            r14.z = r14.z * r14.w;
            r14.w = dot(r32.xyz, r12.xyz);
            r14.w = saturate(r14.w + r32.w);
            r14.z = r14.z * r14.w;
            r14.w = dot(r33.xyz, r12.xyz);
            r14.w = saturate(r14.w + r33.w);
            r14.z = r14.z * r14.w;
            r14.w = dot(r34.xyz, r12.xyz);
            r14.w = saturate(r14.w + r34.w);
            r14.z = r14.z * r14.w;
            r14.w = dot(r35.xyz, r12.xyz);
            r14.w = saturate(r14.w + r35.w);
            r29.x = r14.z * r14.w;
            r15.z = (uint)r9.w >> 2;
            if (1 == 0) r15.w = 0; else if (1+2 < 32) {             r15.w = (uint)r9.w << (32-(1 + 2)); r15.w = (uint)r15.w >> (32-1);            } else r15.w = (uint)r9.w >> 2;
            r16.z = (int)r15.z & 2;
            r16.w = max(r29.y, r29.x);
            r14.z = -r14.z * r14.w + 1;
            r14.z = r29.y * r14.z;
            r17.y = r16.z ? r14.z : r16.w;
            r29.xy = r15.ww ? r29.xy : r17.xy;
            r13.w = (int)r13.w + 1;
            r9.w = r15.z;
          }
  ...
  if (r1.z == 0) {
    ...
    while (true) {
      ...
      while (true) {
        ...
        r12.y = samp0[]..swiz;
          ...
          r12.z = r25.w;
          r12.xyz = cmp(abs(r25.xyz) < r12.zxy);
          r10.z = r12.y ? r12.x : 0;
          r10.z = r12.z ? r10.z : 0;
          if (r10.z != 0) {
          ...
          r32.w = samp0[]..swiz;
            ...
            r33.w = samp0[]..swiz;
              ...
              r17.w = r18.w * r17.w;
              r18.w = dot(r32.xyz, r12.xyz);
              r18.w = saturate(r18.w + r32.w);
              r17.w = r18.w * r17.w;
              r18.w = dot(r33.xyz, r12.xyz);
            ...
            r38.y = samp0[]..swiz;
              ...
              r25.y = r28.z;
              r25.z = r29.x;
              r33.x = dot(r15.yzw, r25.xyz);
              r26.xy = r28.xw;
              r26.z = r29.w;
              r33.y = dot(r15.yzw, r26.xyz);
              r29.x = r28.y;
              ...
              r10.z = (int)r27.z | (int)r27.x;
              r10.z = (int)r27.w | (int)r10.z;
              r15.yzw = r10.zzz ? float3(1,1,0) : r15.yzw;
              r28.x = dot(r12.xyz, r25.xyz);
              r28.y = dot(r12.xyz, r26.xyz);
              r28.z = dot(r12.xyz, r29.xyz);
              r12.xyz = saturate(r28.xyz * r30.xyz + float3(0.5,0.5,0.5));
              r31.z = r32.x;
              r12.xyz = r12.xyz * r31.xyz + r32.yzw;
              r33.x = dot(r11.xyz, r25.xyz);
              r33.y = dot(r11.xyz, r26.xyz);
              r33.z = dot(r11.xyz, r29.xyz);
              r25.xyz = cmp(float3(0,0,0) < r33.xyz);
              r14.z = r25.x ? 0 : 0.5;
              r26.xyz = r14.xyz + r12.xyz;
              r26.xyz = gProbeXArray.SampleLevel(samplerLinearClamp_s, r26.xyz, 0).xyz;
              r27.xzw = r33.xyz * r33.xyz;
              r27.xzw = r27.xzw * r9.www;
              r16.z = r25.y ? 0 : 0.5;
              r25.xyw = r16.xyz + r12.xyz;
              ...
              r12.xyz = r12.xyz * r27.www + r25.xyw;
              ...
              r25.x = r23.w;
              r25.yz = r24.xy;
              r24.xyw = r12.yzx * r9.www + r25.yzx;
              r23.w = r24.w;
            }
          }
        }
        ...
        while (true) {
          ...
          r27.y = samp0[]..swiz;
            ...
            r34.w = samp0[]..swiz;
              ...
              r15.w = dot(r30.xyz, r28.xyz);
              r15.w = saturate(r15.w + r30.w);
              r15.z = r15.z * r15.w;
              r15.w = dot(r31.xyz, r28.xyz);
              r15.w = saturate(r15.w + r31.w);
              r15.z = r15.z * r15.w;
              r15.w = dot(r32.xyz, r28.xyz);
              r15.w = saturate(r15.w + r32.w);
              r15.z = r15.z * r15.w;
              r15.w = dot(r33.xyz, r28.xyz);
              r15.w = saturate(r15.w + r33.w);
              r15.z = r15.z * r15.w;
              r15.w = dot(r34.xyz, r28.xyz);
              ...
              r35.w = samp0[]..swiz;
                ...
                r29.xy = r24.ww ? r29.xy : r15.xy;
                r16.w = (int)r16.w + 1;
                r13.x = r20.w;
              }
              r10.z = saturate(r29.y + -r6.w);
              r13.x = r10.z * r10.w;
              r13.w = cmp(0 < r13.x);
              if (r13.w != 0) {
              // Known bad code for instruction (needs manual fix):
              ...
              r40.x = samp0[]..swiz;
              r40.y = samp0[]..swiz;
                r25.w = r10.z * r10.w + r25.w;
                r9.w = r13.x * r27.z;
                r27.z = r35.z;
                r10.z = dot(r7.xyz, r27.xyz);
                ...
                r10.z = min(r10.z, abs(r10.w));
                r37.z = r38.z;
                r10.w = dot(r7.xyz, r37.xyz);
                r13.x = dot(r28.xyz, r37.xyz);
                r13.x = r13.x + -r38.w;
                r13.w = cmp(r13.x >= 0);
                r13.x = max(abs(r13.x), r1.x);
                r13.x = r13.w ? r13.x : -r13.x;
                ...
                r10.z = min(r10.z, abs(r10.w));
                r38.z = r39.x;
                r10.w = dot(r7.xyz, r38.xyz);
                r13.x = dot(r28.xyz, r38.xyz);
                r13.x = r13.x + -r39.y;
                r13.w = cmp(r13.x >= 0);
                r13.x = max(abs(r13.x), r1.x);
                r13.x = r13.w ? r13.x : -r13.x;
                ...
                r10.z = min(r10.z, abs(r10.w));
                r40.zw = r39.zw;
                r10.w = dot(r7.zxy, r40.xzw);
                r13.x = dot(r28.zxy, r40.xzw);
                r13.x = r13.x + -r40.y;
                r13.w = cmp(r13.x >= 0);
                r13.x = max(abs(r13.x), r1.x);
                r13.x = r13.w ? r13.x : -r13.x;
                ...
                r35.w = (uint)r10.w;
                r15.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r35.xyzw, r10.z).xyz;
                r29.xzw = (int3)r15.yzw & int3(-2147483648,-2147483648,-2147483648);
                r29.xzw = cmp((int3)r29.xzw == int3(2139095040,2139095040,2139095040));
                r10.z = (int)r29.z | (int)r29.x;
                r10.z = (int)r29.w | (int)r10.z;
                r15.yzw = r10.zzz ? float3(1,1,0) : r15.yzw;
                ...
                r35.x = dot(r11.xyz, r26.xyz);
                r35.y = dot(r11.xyz, r27.xyz);
                ...
                r10.z = (int)r28.y | (int)r28.x;
                r10.z = (int)r28.z | (int)r10.z;
                r27.xyz = r10.zzz ? float3(1,1,0) : r27.xyz;
                r28.xyz = r27.xyz * r26.xyz;
                r10.z = dot(r28.xyz, float3(0.212599993,0.715200007,0.0722000003));
                r12.xyz = r26.xyz * r27.xyz + r12.xyz;
                r10.w = r10.z * r1.y;
    ...
    r1.x = cmp(r22.w < 0.99000001);
    if (r1.x != 0) {
      r1.x = 1 + -r22.w;
      r1.y = sunConstants.globalProbeExposure * r1.x;
      ...
      r1.yzw = r14.xyz * r1.yyy;
      r14.xyz = r12.wwy + r10.xyz;
      ...
      r1.yzw = r10.xyz * r1.www + r13.xyz;
      r11.w = 0;
      r10.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r11.xyzw, 6).xyz;
      r1.yzw = r10.xyz * r1.yzw;
      r2.w = dot(r1.yzw, float3(0.212599993,0.715200007,0.0722000003));
      r19.xyz = r21.xyz * r0.yyy + r1.yzw;
      r7.w = 0;
      r1.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r7.xyzw, r0.w).xyz;
      r0.y = sunConstants.globalProbeExposure * r1.x + -r2.w;
      r0.y = r5.y * r0.y + r2.w;
      r20.xyz = r1.yzw * r0.yyy + r20.xyz;
    }
  } else {
    r20.x = r19.w;
  }
  r1.xyz = r19.xyz * r6.xyz + r4.xyz;
  r4.xyz = r19.xyz * r6.xyz + r8.xyz;
