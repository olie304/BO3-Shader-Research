// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:42:33 2021
...
r0.x = samp0[]..swiz;
  ...
  r1.z = r1.z * r2.w + glossRange.x;
  r1.z = saturate(0.0588235296 * r1.z);
  r3.xy = renderTargetSize.zw * extraCamWarpAmount;
  ...
  r6.xy = gameTime.ww * wobbleNormalScroll2.xy;
  ...
  r8.y = r8.x;
  r8.z = r7.x;
  r9.x = dot(r8.yz, r4.yz);
  r8.x = -r7.x;
  r9.y = dot(r8.xy, r4.yz);
  r6.zw = gameTime.ww * wobbleNormalScroll1.xy;
  r6.zw = r9.xy * detailScale.xy + r6.zw;
  r6.zw = float2(0.5,0.5) + r6.zw;
  r7.xyz = detailMap.Sample(normalSampler_s, r6.zw).xyz;
  r6.zw = r7.xy * float2(1.9921875,1.9921875) + float2(-1,-1);
  r4.w = r7.z * r7.z;
  r4.w = 0.333333343 * r4.w;
  r4.xw = min(float2(1,1), r4.xw);
  r0.x = detailScaleHeight * r0.x;
  r5.xy = r6.zw * r0.xx + r3.zw;
  r3.z = dot(r5.xyz, r5.xyz);
  r3.z = rsqrt(r3.z);
  r5.xyz = r5.xyz * r3.zzz;
  r3.z = r4.w * r0.x + r4.x;
  r4.xw = r7.xy * float2(2,2) + float2(-1,-1);
  r4.xw = r4.xw * r3.xy;
  r4.xw = r4.xw * r0.xx + w1.xy;
  r3.w = wobbleNormalRotate2.y * gameTime.w + 1;
  r3.w = wobbleNormalRotate2.x * r3.w;
  ...
  r8.x = -r7.x;
  r9.y = dot(r8.xy, r4.yz);
  r4.yz = r9.xy * detailScale.xy + r6.xy;
  r4.yz = float2(0.5,0.5) + r4.yz;
  r6.xyz = detailMap.Sample(normalSampler_s, r4.yz).xyz;
  r4.yz = r6.xy * float2(1.9921875,1.9921875) + float2(-1,-1);
  r3.w = r6.z * r6.z;
  r3.w = 0.333333343 * r3.w;
  r3.w = min(1, r3.w);
  r5.xy = r4.yz * r0.xx + r5.xy;
  r4.y = dot(r5.xyz, r5.xyz);
  r4.y = rsqrt(r4.y);
  r5.xyz = r5.xyz * r4.yyy;
  r3.z = r3.w * r0.x + r3.z;
  r4.yz = r6.xy * float2(2,2) + float2(-1,-1);
  r3.xy = r4.yz * r3.xy;
  r3.xy = r3.xy * r0.xx + r4.xw;
  r0.x = v7.x ? 1 : -1;
  ...
  if (r2.w != 0) {
    ...
    r6.xyz = r5.xxx ? float3(1,0,1) : r0.yzw;
    r5.xyw = r5.yyy ? float3(0,1,1) : r0.yzw;
    r5.xyw = r3.www ? r6.xyz : r5.xyw;
    r6.xyz = r5.zzz ? float3(0,1,0) : r0.yzw;
    r0.yzw = r3.zzz ? r5.xyw : r6.xyz;
  }
  r5.xyz = debugColorOverride.xyz + -r0.yzw;
  r0.yzw = debugColorOverride.www * r5.xyz + r0.yzw;
  r1.w = -r1.w * v1.x + debugAlphaOverride.x;
  o0.w = debugAlphaOverride.w * r1.w + r1.x;
  r5.xyz = debugSpecularOverride.xyz + -r2.xyz;
  r2.xyz = debugSpecularOverride.www * r5.xyz + r2.xyz;
  r1.x = r1.z + -r0.x;
  r5.y = debugGlossOverride.w * r1.x + r0.x;
  r0.x = debugOcclusionOverride.x + -r1.y;
  r0.x = debugOcclusionOverride.w * r0.x + r1.y;
  r1.xyz = v7.xxx ? v3.xyz : -v3.xyz;
  r1.w = dot(r1.xyz, r1.xyz);
  r1.w = rsqrt(r1.w);
  r1.xyz = r1.xyz * r1.www + -r4.xyz;
  r1.xyz = debugNormalOverride.www * r1.xyz + r4.xyz;
  r2.w = cmp(extracamSelect == 4);
  if (r2.w != 0) {
    r4.xyz = extracamTexture4.Sample(extracamSampler_s, r3.xy).xyz;
  } else {
    r2.w = cmp(extracamSelect == 3);
    if (r2.w != 0) {
      r4.xyz = extracamTexture3.Sample(extracamSampler_s, r3.xy).xyz;
    } else {
      r2.w = cmp(extracamSelect == 2);
      if (r2.w != 0) {
        r4.xyz = extracamTexture2.Sample(extracamSampler_s, r3.xy).xyz;
      } else {
        r4.xyz = extracamTexture1.Sample(extracamSampler_s, r3.xy).xyz;
      }
    }
  }
  r3.xyz = hdrControl0.www * r4.xyz;
  r4.xy = (uint2)v0.xy;
  ...
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r19.xyzw, r5.w, l(0), t15.wxyz
  r19.x = samp0[]..swiz;
  r19.y = samp0[]..swiz;
  r19.z = samp0[]..swiz;
  r19.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r20.xyzw, r5.w, l(16), t15.xyzw
  r20.x = samp0[]..swiz;
  r20.y = samp0[]..swiz;
  r20.z = samp0[]..swiz;
  r20.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r21.xyzw, r5.w, l(32), t15.yxwz
  r21.x = samp0[]..swiz;
  r21.y = samp0[]..swiz;
  r21.z = samp0[]..swiz;
  r21.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r10.yzw, r5.w, l(48), t15.xxyz
  r10.y = samp0[]..swiz;
  r10.z = samp0[]..swiz;
  r10.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r22.xyzw, r5.w, l(72), t15.xyzw
  r22.x = samp0[]..swiz;
  r22.y = samp0[]..swiz;
  r22.z = samp0[]..swiz;
  r22.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r23.xyzw, r5.w, l(88), t15.xyzw
  r23.x = samp0[]..swiz;
  r23.y = samp0[]..swiz;
  r23.z = samp0[]..swiz;
  r23.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r7.zw, r5.w, l(116), t15.xxxy
  r7.z = samp0[]..swiz;
  r7.w = samp0[]..swiz;
    r13.xyz = v6.xyz + -r19.yzw;
    r8.w = dot(r13.xyz, r13.xyz);
    r8.w = sqrt(r8.w);
    r8.w = cmp(probeDebugRadius >= r8.w);
    r11.w = (int)r7.w & 0x0000ffff;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r24.xyzw, r11.w, l(0), t16.xyzw
  r24.x = samp0[]..swiz;
  r24.y = samp0[]..swiz;
  r24.z = samp0[]..swiz;
  r24.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r25.xyzw, r11.w, l(16), t16.xyzw
  r25.x = samp0[]..swiz;
  r25.y = samp0[]..swiz;
  r25.z = samp0[]..swiz;
  r25.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r26.xyzw, r11.w, l(32), t16.xyzw
  r26.x = samp0[]..swiz;
  r26.y = samp0[]..swiz;
  r26.z = samp0[]..swiz;
  r26.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r27.xyzw, r11.w, l(48), t16.xyzw
  r27.x = samp0[]..swiz;
  r27.y = samp0[]..swiz;
  r27.z = samp0[]..swiz;
  r27.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r28.xyzw, r11.w, l(64), t16.xyzw
  r28.x = samp0[]..swiz;
  r28.y = samp0[]..swiz;
  r28.z = samp0[]..swiz;
  r28.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r29.xyzw, r11.w, l(80), t16.xyzw
  r29.x = samp0[]..swiz;
  r29.y = samp0[]..swiz;
  r29.z = samp0[]..swiz;
  r29.w = samp0[]..swiz;
    r12.z = dot(r24.xyz, r13.xyz);
    r12.z = saturate(r12.z + r24.w);
    r12.w = dot(r25.xyz, r13.xyz);
    r12.w = saturate(r12.w + r25.w);
    r12.z = r12.z * r12.w;
    r12.w = dot(r26.xyz, r13.xyz);
    r12.w = saturate(r12.w + r26.w);
    r12.z = r12.z * r12.w;
    r12.w = dot(r27.xyz, r13.xyz);
    r12.w = saturate(r12.w + r27.w);
    r12.z = r12.z * r12.w;
    r12.w = dot(r28.xyz, r13.xyz);
    r12.w = saturate(r12.w + r28.w);
    r12.z = r12.z * r12.w;
    r12.w = dot(r29.xyz, r13.xyz);
    ...
    r19.y = r20.z;
    r19.z = r21.x;
    r24.x = dot(r13.xyz, r19.xyz);
    r25.xy = r20.xw;
    r25.z = r21.w;
    r24.y = dot(r13.xyz, r25.xyz);
    r21.x = r20.y;
    r24.z = dot(r13.xyz, r21.xyz);
    r10.yzw = saturate(r24.xyz * r10.yzw + float3(0.5,0.5,0.5));
    r20.x = r22.w;
    r20.yz = r23.xy;
    r10.yzw = r10.yzw * r22.xyz + r20.xyz;
    r19.x = dot(r1.xyz, r19.xyz);
    r19.y = dot(r1.xyz, r25.xyz);
    r19.z = dot(r1.xyz, r21.xyz);
    r20.xyz = cmp(float3(0,0,0) < r19.xyz);
    r15.z = r20.x ? 0 : 0.5;
    r21.xyz = r15.xyz + r10.yzw;
    r21.xyz = gProbeXArray.SampleLevel(samplerLinearClamp_s, r21.xyz, 0).xyz;
    r16.z = r20.y ? 0 : 0.5;
    r20.xyw = r16.xyz + r10.yzw;
    r20.xyw = gProbeYArray.SampleLevel(samplerLinearClamp_s, r20.xyw, 0).xyz;
    r17.z = r20.z ? 0 : 0.5;
    r10.yzw = r17.xyz + r10.yzw;
    r10.yzw = gProbeZArray.SampleLevel(samplerLinearClamp_s, r10.yzw, 0).xyz;
    r22.xyz = r19.xyz * r19.xyz;
    if (6 == 0) r14.x = 0; else if (6+25 < 32) {     r14.x = (uint)r7.w << (32-(6 + 25)); r14.x = (uint)r14.x >> (32-6);    } else r14.x = (uint)r7.w >> 25;
    if (9 == 0) r14.w = 0; else if (9+16 < 32) {     r14.w = (uint)r7.w << (32-(9 + 16)); r14.w = (uint)r14.w >> (32-9);    } else r14.w = (uint)r7.w >> 16;
    r19.w = (uint)r14.w;
    r19.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r19.xyzw, 6).xyz;
    ...
    while (true) {
      ...
      if (r15.w != 0) {
        ...
        if (r8.w != 0) {
          ...
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r25.xyzw, r16.z, l(0), t16.xyzw
          r25.x = samp0[]..swiz;
          r25.y = samp0[]..swiz;
          r25.z = samp0[]..swiz;
          r25.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r26.xyzw, r16.z, l(16), t16.xyzw
          r26.x = samp0[]..swiz;
          r26.y = samp0[]..swiz;
          r26.z = samp0[]..swiz;
          r26.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r27.xyzw, r16.z, l(32), t16.xyzw
          r27.x = samp0[]..swiz;
          r27.y = samp0[]..swiz;
          r27.z = samp0[]..swiz;
          r27.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r28.xyzw, r16.z, l(48), t16.xyzw
          r28.x = samp0[]..swiz;
          r28.y = samp0[]..swiz;
          r28.z = samp0[]..swiz;
          r28.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r29.xyzw, r16.z, l(64), t16.xyzw
          r29.x = samp0[]..swiz;
          r29.y = samp0[]..swiz;
          r29.z = samp0[]..swiz;
          r29.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r30.xyzw, r16.z, l(80), t16.xyzw
          r30.x = samp0[]..swiz;
          r30.y = samp0[]..swiz;
          r30.z = samp0[]..swiz;
          r30.w = samp0[]..swiz;
            ...
            r19.w = (int)r17.z & 2;
            r20.z = max(r23.y, r23.x);
            r16.z = -r16.z * r16.w + 1;
            r16.z = r23.y * r16.z;
            r4.y = r19.w ? r16.z : r20.z;
            r23.xy = r17.ww ? r23.xy : r4.xy;
            r15.w = (int)r15.w + 1;
            r15.z = r17.z;
          }
          ...
          r15.z = cmp(0 < r4.y);
          if (r15.z != 0) {
            r25.w = r23.y * r23.w + r24.w;
            r4.y = r4.y * r7.z;
            r26.xyz = r22.xyz * r4.yyy;
            r27.xyz = r26.yyy * r20.xyw;
            r26.xyw = r21.xyz * r26.xxx + r27.xyz;
            r26.xyz = r10.yzw * r26.zzz + r26.xyw;
            r25.xyz = r26.xyz * r19.xyz + r24.xyz;
          } else {
            r25.xyzw = r24.xyzw;
          }
          r7.w = -1;
  ...
  if (r2.w == 0) {
    ...
    while (true) {
      ...
      r8.w = cmp((int)r4.x == (int)r7.z);
      bitmask.y = ((~(-1 << r4.y)) << 0) & 0xffffffff;  r10.y = (((uint)0 << 0) & bitmask.y) | ((uint)r7.w & ~bitmask.y);
      r7.w = r8.w ? r10.y : r7.w;
      r8.w = cmp((int)r5.w == (int)r7.z);
      if (r6.w == 0) r10.y = 0; else if (r6.w+0 < 32) {       r10.y = (uint)r7.w << (32-(r6.w + 0)); r10.y = (uint)r10.y >> (32-r6.w);      } else r10.y = (uint)r7.w >> 0;
      r7.w = r8.w ? r10.y : r7.w;
        ...
        r13.y = samp0[]..swiz;
          ...
          r29.w = samp0[]..swiz;
            ...
            r27.w = samp0[]..swiz;
              ...
              r22.y = dot(r1.xyz, r29.xyz);
              r22.z = dot(r1.xyz, r26.xyz);
              ...
              r10.z = (int)r22.y | (int)r22.x;
              r10.z = (int)r22.z | (int)r10.z;
              r16.yzw = r10.zzz ? float3(1,1,0) : r16.yzw;
    ...
    if (r5.w != 0) {
      ...
      r6.w = 0;
      while (true) {
        r7.z = cmp((uint)r6.w >= (uint)r2.w);
        if (r7.z != 0) break;
        r12.z = (uint)r6.w >> 5;
        r13.xyz = (int3)r11.xyz + (int3)r12.xyz;
        r7.z = visibleProbes.Load(r13.xyzw).x;
        r7.w = cmp((int)r4.x == (int)r6.w);
        if (r4.y == 0) r8.w = 0; else if (r4.y+0 < 32) {         r8.w = (uint)r7.z << (32-(r4.y + 0)); r8.w = (uint)r8.w >> (32-r4.y);        } else r8.w = (uint)r7.z >> 0;
        r7.z = r7.w ? r8.w : r7.z;
        ...
        while (true) {
          ...
          r13.y = samp0[]..swiz;
            ...
            r23.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r24.xyzw, r10.z, l(88), t15.zxyw
            r24.x = samp0[]..swiz;
            r24.y = samp0[]..swiz;
            r24.z = samp0[]..swiz;
            r24.w = samp0[]..swiz;
            ...
            r27.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r28.xyzw, r10.w, l(48), t16.xyzw
            r28.x = samp0[]..swiz;
            r28.y = samp0[]..swiz;
            r28.z = samp0[]..swiz;
            r28.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r29.xyzw, r10.w, l(64), t16.xyzw
            r29.x = samp0[]..swiz;
            r29.y = samp0[]..swiz;
            r29.z = samp0[]..swiz;
            r29.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r30.xyzw, r10.w, l(80), t16.xyzw
            r30.x = samp0[]..swiz;
            r30.y = samp0[]..swiz;
            r30.z = samp0[]..swiz;
            r30.w = samp0[]..swiz;
              r14.w = dot(r25.xyz, r13.xyz);
              ...
              r31.w = samp0[]..swiz;
                ...
                r16.w = -r16.w * r17.w + 1;
                r16.w = r25.y * r16.w;
                r16.y = r23.w ? r16.w : r25.z;
                r25.xy = r19.ww ? r25.xy : r16.xy;
                r16.z = (int)r16.z + 1;
                r15.w = r18.w;
              }
              r10.w = saturate(r25.y + -r8.w);
              r11.w = r10.w * r24.w;
              r14.x = cmp(0 < r11.w);
              if (r14.x != 0) {
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r26.xyzw, r10.z, l(16), t15.xyzw
              r26.x = samp0[]..swiz;
              r26.y = samp0[]..swiz;
              r26.z = samp0[]..swiz;
              r26.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r27.xyzw, r10.z, l(32), t15.yxwz
              r27.x = samp0[]..swiz;
              r27.y = samp0[]..swiz;
              r27.z = samp0[]..swiz;
              r27.w = samp0[]..swiz;
              ...
              r16.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r28.xyzw, r10.z, l(72), t15.xyzw
              r28.x = samp0[]..swiz;
              r28.y = samp0[]..swiz;
              r28.z = samp0[]..swiz;
              r28.w = samp0[]..swiz;
                r22.w = r10.w * r24.w + r22.w;
                r10.z = r11.w * r12.z;
                r23.y = r26.z;
                r23.z = r27.x;
                r29.x = dot(r13.xyz, r23.xyz);
                r30.xy = r26.xw;
                r30.z = r27.w;
                r29.y = dot(r13.xyz, r30.xyz);
                r27.x = r26.y;
                r29.z = dot(r13.xyz, r27.xyz);
                r13.xyz = saturate(r29.xyz * r16.yzw + float3(0.5,0.5,0.5));
                r24.x = r28.w;
                r13.xyz = r13.xyz * r28.xyz + r24.xyz;
                r23.x = dot(r1.xyz, r23.xyz);
                r23.y = dot(r1.xyz, r30.xyz);
                r23.z = dot(r1.xyz, r27.xyz);
                r16.yzw = cmp(float3(0,0,0) < r23.xyz);
                r15.z = r16.y ? 0 : 0.5;
                r24.xyz = r15.xyz + r13.xyz;
                r24.xyz = gProbeXArray.SampleLevel(samplerLinearClamp_s, r24.xyz, 0).xyz;
                r25.xzw = r23.xyz * r23.xyz;
                r25.xzw = r25.xzw * r10.zzz;
                r17.z = r16.z ? 0 : 0.5;
                r26.xyz = r17.xyz + r13.xyz;
                r26.xyz = gProbeYArray.SampleLevel(samplerLinearClamp_s, r26.xyz, 0).xyz;
                r26.xyz = r26.xyz * r25.zzz;
                r24.xyz = r24.xyz * r25.xxx + r26.xyz;
                r19.z = r16.w ? 0 : 0.5;
                r13.xyz = r19.xyz + r13.xyz;
                r13.xyz = gProbeZArray.SampleLevel(samplerLinearClamp_s, r13.xyz, 0).xyz;
                r13.xyz = r13.xyz * r25.www + r24.xyz;
                if (9 == 0) r10.z = 0; else if (9+16 < 32) {                 r10.z = (uint)r12.w << (32-(9 + 16)); r10.z = (uint)r10.z >> (32-9);                } else r10.z = (uint)r12.w >> 16;
                r23.w = (uint)r10.z;
                r16.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r23.xyzw, 6).xyz;
                r23.xyz = (int3)r16.yzw & int3(-2147483648,-2147483648,-2147483648);
                r23.xyz = cmp((int3)r23.xyz == int3(2139095040,2139095040,2139095040));
                r10.z = (int)r23.y | (int)r23.x;
                r10.z = (int)r23.z | (int)r10.z;
                r16.yzw = r10.zzz ? float3(1,1,0) : r16.yzw;
                r22.xyz = r13.xyz * r16.yzw + r22.xyz;
              }
            }
          }
        }
    ...
    if (r2.w != 0) {
      ...
      r18.xyz = r10.yzw * r12.xyz + r18.xyz;
    }
  }
  r1.w = r5.x + r0.x;
  r1.w = log2(abs(r1.w));
  ...
  if (r4.y == 0) {
    ...
    if (r5.w != 0) {
      ...
      while (true) {
        ...
        if (r7.z != 0) break;
        r7.z = (uint)r5.w;
        r14.xy = -sunConstants.splitPinTransform[r7.z].xy + r10.yz;
    ...
    r8.w = samp0[]..swiz;
      ...
      r17.w = samp0[]..swiz;
        ...
        r11.w = samp0[]..swiz;
          ...
          r8.w = r10.z * r8.w + r11.w;
          r14.w = r7.w ? r8.w : r14.w;
        }
      }
    ...
    if (r7.z == 0) {
      if (enableDitheredShadow == 0) {
        r7.z = (uint)r5.w;
        r14.xy = -sunConstants.splitPinTransform[r7.z].xy + r10.yz;
        r7.zw = sunConstants.splitPinTransform[r7.z].zz * r14.xy;
        r14.xy = r7.zw * float2(0.5,-0.5) + float2(0.5,0.5);
        r7.z = (int16)sunConstants.splitArrayOffset;
        r14.z = r7.z + r5.w;
        r7.z = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r14.xyz, r4.y).x;
      ...
      if (enableDitheredShadow != 0) {
        ...
        r6.w = 28 * r6.w;
        r6.w = (uint)r6.w;
        r15.xy = -sunConstants.splitPinTransform[r7.z].xy + r10.yz;
        r15.xy = sunConstants.splitPinTransform[r7.z].zz * r15.xy;
        ...
        while (true) {
          ...
          r16.x = dot(icb[r8.w+0].yx, r14.xy);
          r16.y = dot(icb[r8.w+0].yx, r14.yz);
  ...
  if (r4.y != 0) {
    ...
    if (r4.y != 0) {
      ...
      if (sunConstants.sunCookieIndex != 0) {
        ...
        r6.w = dot(sunConstants.sunCookieTransform[1].xyzw, r14.xyzw);
        r14.x = frac(r5.w);
        r14.y = frac(r6.w);
      ...
      r17.w = samp0[]..swiz;
        ...
        r14.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r15.xy, r5.w, l(164), t12.xyxx
        r15.x = samp0[]..swiz;
        r15.y = samp0[]..swiz;
          r5.w = dot(r14.xyzw, r18.xyzw);
          ...
          if (enableDitheredShadow != 0) {
            ...
            r14.z = (uint)r7.z;
            r7.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r14.xyz, r5.w).x;
          }
          r5.w = r7.w * r7.w;
          r5.w = r5.w * r7.w;
        } else {
      ...
      r4.x = r5.y * r4.x;
      r4.x = 0.25 * r4.x;
      r15.xyz = r4.xxx * r10.yzw + r3.xyz;
      r3.w = saturate(1 + -r3.w);
      r4.y = r3.w * r3.w;
      r4.y = r4.y * r4.y;
      r3.w = r4.y * r3.w;
      r3.w = r4.x * r3.w;
      r16.xyz = r3.www * r10.zwy + r13.xyz;
      r14.w = r16.z;
      r12.w = r13.z;
      r12.xyzw = r2.wwww ? r14.xyzw : r12.xyzw;
      r16.zw = r15.xy;
      r13.zw = r3.xy;
      r14.xyzw = r2.wwww ? r16.xyzw : r13.xyzw;
      r3.z = r2.w ? r15.z : r3.z;
      r13.z = r12.w;
      r13.xy = r14.xy;
      r3.xy = r14.zw;
    }
            ...
            if (r24.w != 0) {
              ...
              if (r24.w != 0) {
                ...
                if (r24.w != 0) {
                  r24.w = r31.x * r4.w;
                  r24.w = 0.25 * r24.w;
                  r25.w = dot(r37.xyz, r9.yzw);
                  r27.w = dot(r9.yzw, r39.xyz);
                    ...
                    r12.w = samp0[]..swiz;
                      ...
                      if (r7.z != 0) {
                        ...
                        while (true) {
                          ...
                          r41.y = dot(icb[r18.z+0].xy, r7.xy);
                      ...
                      r12.w = samp0[]..swiz;
                        ...
                        if (r7.z != 0) {
                          ...
                          while (true) {
                            ...
                            if (r27.w != 0) break;
                            r40.x = dot(icb[r25.w+0].xy, r8.xy);
                            r40.y = dot(icb[r25.w+0].yx, r8.xz);
                  ...
                  r31.x = r30.x;
                  r13.w = cmp(0 < r15.w);
                  r19.xyz = r12.www * r31.xyz + r10.yzw;
                  r12.w = saturate(dot(r1.xyz, r38.xyz));
                  r37.xyz = r37.xyz * r11.www + r6.xyz;
                  r11.w = dot(r37.xyz, r37.xyz);
                  r11.w = rsqrt(r11.w);
                  r37.xyz = r37.xyz * r11.www;
                  r11.w = dot(r37.xyz, r6.xyz);
                  r15.w = dot(r1.xyz, r37.xyz);
                  r18.x = abs(r15.w) * r4.w + -abs(r15.w);
                  r15.w = abs(r15.w) * r18.x + 1;
                  r18.x = r12.w * r0.x + r1.w;
                  r15.w = r15.w * r15.w;
                  r15.w = r15.w * r18.x;
                  r15.w = rcp(r15.w);
                  r12.w = r12.w * r24.w;
                  ...
                  r10.yzw = r13.www ? r19.xyz : r10.yzw;
            ...
            r38.w = samp0[]..swiz;
              ...
              if (r15.z != 0) {
                ...
                if (r15.z != 0) {
                  ...
                  r15.w = r15.w * r8.w;
                  r12.w = cmp(0 < r12.w);
                  r22.xyz = r15.www * r20.xyw + r10.yzw;
                  r19.xyz = r19.xyz * r11.www + r6.xyz;
                  r11.w = dot(r19.xyz, r19.xyz);
                  r11.w = rsqrt(r11.w);
                  r19.xyz = r19.xyz * r11.www;
                  r11.w = dot(r19.xyz, r6.xyz);
                  r15.w = dot(r1.xyz, r19.xyz);
                  r19.x = abs(r15.w) * r4.w + -abs(r15.w);
                  r15.w = abs(r15.w) * r19.x + 1;
                  r13.w = r13.w * r0.x + r1.w;
                  r15.w = r15.w * r15.w;
                  r13.w = r15.w * r13.w;
                  r13.w = rcp(r13.w);
                  r13.w = r13.w * r15.z;
                  r8.w = r13.w * r8.w;
                  r8.w = 0.25 * r8.w;
                  r19.xyz = r8.www * r20.xyw + r29.xyz;
                  r11.w = saturate(1 + -r11.w);
                  r13.w = r11.w * r11.w;
                  r13.w = r13.w * r13.w;
                  r11.w = r13.w * r11.w;
                  r8.w = r11.w * r8.w;
                  r20.xyw = r8.www * r20.xyw + r16.xyz;
                  r10.yzw = r12.www ? r22.xyz : r10.yzw;
