...
r0.y = samplerLinear[]..swiz;
  ...
  while (true) {
    r7.w = cmp((int)r6.w == 2);
    if (r7.w != 0) break;
    r7.w = r6.w ? r0.x : r13.z;
    r8.w = cmp((uint)r7.w >= (uint)r4.z);
    ...
    if (r8.w != 0) {
      ...
      r26.w = (int)r25.w + 1;
      r15.yzw = -refProbeConstantsCB[r7.w].data[0].xyz + r11.xyz;
      ...
      while (true) {
        ...
        r16.w = -r18.y * r16.w + 1;
        r16.w = r27.y * r16.w;
        r21.y = r19.x ? r16.w : r19.w;
        r27.xy = r18.ww ? r27.xy : r21.xy;
        r14.w = (int)r14.w + 1;
        r10.w = r18.z;
      }
      r27.y = saturate(r27.y);
      r8.w = refProbeConstantsCB[r7.w].data[6].y * r27.y;
      r9.w = cmp(0 < r8.w);
      if (r9.w != 0) {
        r9.w = (int)r26.w & 7;
        r10.w = (int)r9.w + -1;
        ...
        r25.w = (int)r25.w + 257;
        r25.z = r27.y * refProbeConstantsCB[r7.w].data[6].y + r25.z;
        r8.w = refProbeConstantsCB[r7.w].data[7].y * r8.w;
        r28.x = refProbeConstantsCB[r7.w].data[7].w;
        r28.yz = refProbeConstantsCB[r7.w].data[8].xy;
        ...
        r28.x = refProbeConstantsCB[r7.w].data[8].w;
        r28.yz = refProbeConstantsCB[r7.w].data[9].xy;
        r10.w = dot(r17.xyz, r28.xyz);
        r14.w = dot(r15.yzw, r28.xyz);
        r14.w = -refProbeConstantsCB[r7.w].data[9].z + r14.w;
        r16.y = cmp(r14.w >= 0);
        ...
        r28.x = refProbeConstantsCB[r7.w].data[9].w;
        r28.yz = refProbeConstantsCB[r7.w].data[10].xy;
        r10.w = dot(r17.xyz, r28.xyz);
        r14.w = dot(r15.yzw, r28.xyz);
        r14.w = -refProbeConstantsCB[r7.w].data[10].z + r14.w;
        r16.y = cmp(r14.w >= 0);
        r14.w = max(abs(r14.w), r3.z);
        r14.w = r16.y ? r14.w : -r14.w;
        r10.w = max(1.00000001e-07, -r10.w);
        r10.w = r14.w / r10.w;
        r9.w = min(abs(r10.w), r9.w);
        r28.x = refProbeConstantsCB[r7.w].data[10].w;
        r28.yz = refProbeConstantsCB[r7.w].data[11].xy;
        r10.w = dot(r17.xyz, r28.xyz);
        r14.w = dot(r15.yzw, r28.xyz);
        r14.w = -refProbeConstantsCB[r7.w].data[11].z + r14.w;
        r16.y = cmp(r14.w >= 0);
        r14.w = max(abs(r14.w), r3.z);
        r14.w = r16.y ? r14.w : -r14.w;
        r10.w = max(1.00000001e-07, -r10.w);
        r10.w = r14.w / r10.w;
        r9.w = min(abs(r10.w), r9.w);
        r28.x = refProbeConstantsCB[r7.w].data[11].w;
        r28.yz = refProbeConstantsCB[r7.w].data[12].xy;
        r10.w = dot(r17.xyz, r28.xyz);
        r14.w = dot(r15.yzw, r28.xyz);
        r14.w = -refProbeConstantsCB[r7.w].data[12].z + r14.w;
        r16.y = cmp(r14.w >= 0);
        r14.w = max(abs(r14.w), r3.z);
        r14.w = r16.y ? r14.w : -r14.w;
        r10.w = max(1.00000001e-07, -r10.w);
        r10.w = r14.w / r10.w;
        r9.w = min(abs(r10.w), r9.w);
        r28.x = refProbeConstantsCB[r7.w].data[12].w;
        r28.yz = refProbeConstantsCB[r7.w].data[13].xy;
        r10.w = dot(r17.xyz, r28.xyz);
        r14.w = dot(r15.yzw, r28.xyz);
        r14.w = -refProbeConstantsCB[r7.w].data[13].z + r14.w;
        r16.y = cmp(r14.w >= 0);
        r14.w = max(abs(r14.w), r3.z);
        r14.w = r16.y ? r14.w : -r14.w;
        r10.w = max(1.00000001e-07, -r10.w);
        r10.w = r14.w / r10.w;
        r9.w = min(abs(r10.w), r9.w);
        r28.x = refProbeConstantsCB[r7.w].data[3].w + r15.y;
        r28.yz = refProbeConstantsCB[r7.w].data[4].xy + r15.zw;
        r16.yzw = r17.xyz * r9.www + r28.xyz;
        ...
        r28.x = refProbeConstantsCB[r7.w].data[0].w;
        r28.y = refProbeConstantsCB[r7.w].data[1].z;
        r28.z = refProbeConstantsCB[r7.w].data[2].y;
        r29.x = dot(r16.yzw, r28.xyz);
        r30.xy = refProbeConstantsCB[r7.w].data[1].xw;
        r30.z = refProbeConstantsCB[r7.w].data[2].z;
        r29.y = dot(r16.yzw, r30.xyz);
        r31.x = refProbeConstantsCB[r7.w].data[1].y;
        r31.yz = refProbeConstantsCB[r7.w].data[2].xw;
        ...
        r29.w = (uint)r10.w;
        r16.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r29.xyzw, r9.w).xyz;
        r18.yzw = (int3)r16.yzw & int3(-2147483648,-2147483648,-2147483648);
        r18.yzw = cmp((int3)r18.yzw == int3(2139095040,2139095040,2139095040));
        r9.w = (int)r18.z | (int)r18.y;
        r9.w = (int)r18.w | (int)r9.w;
        r16.yzw = r9.www ? float3(1,1,0) : r16.yzw;
        r32.x = dot(r15.yzw, r28.xyz);
        r32.y = dot(r15.yzw, r30.xyz);
        r32.z = dot(r15.yzw, r31.xyz);
        r15.yzw = saturate(r32.xyz * refProbeConstantsCB[r7.w].data[3].xyz + float3(0.5,0.5,0.5));
        r32.xy = refProbeConstantsCB[r7.w].data[4].zw * r15.yz;
        r32.z = refProbeConstantsCB[r7.w].data[5].x * r15.w;
        r15.yzw = refProbeConstantsCB[r7.w].data[5].yzw + r32.xyz;
        ...
        r7.w = (int)r27.z | (int)r27.x;
        r7.w = (int)r27.w | (int)r7.w;
        r18.yzw = r7.www ? float3(1,1,0) : r18.yzw;
        r27.xzw = r18.yzw * r15.yzw;
        r7.w = dot(r27.xzw, float3(0.212599993,0.715200007,0.0722000003));
        r24.xyz = r15.yzw * r18.yzw + r24.xyz;
        r9.w = r7.w * r3.w;
        r15.yzw = r16.yzw * r8.www;
        r8.w = dot(r15.yzw, float3(0.212599993,0.715200007,0.0722000003));
        r7.w = r3.w * r7.w + r8.w;
        r7.w = r9.w / r7.w;
        r28.x = r24.w;
        r28.yz = r25.xy;
        r15.yzw = r15.yzw * r7.www + r28.xyz;
        r24.w = r15.y;
        r25.xy = r15.zw;
      } else {
        r26.xyz = r25.xyz;
  ...
  while (true) {
    ...
    if (r8.w != 0) {
      ...
      r21.y = (int)r16.z + 1;
      r18.yzw = -refProbeConstantsCB[r7.w].data[0].xyz + r11.xyz;
      r8.w = 0x0000ffff & (int)refProbeConstantsCB[r7.w].data[7].z;
      if (6 == 0) r9.w = 0; else if (6+25 < 32) {       r9.w = (uint)refProbeConstantsCB[r7.w].data[7].z << (32-(6 + 25)); r9.w = (uint)r9.w >> (32-6);      } else r9.w = (uint)refProbeConstantsCB[r7.w].data[7].z >> 25;
      r10.w = (int)r8.w * 6;
      r14.w = dot(refProbeAttenuationConstantsCB[r10.w].data[0].xyz, r18.yzw);
      r14.w = saturate(refProbeAttenuationConstantsCB[r10.w].data[0].w + r14.w);
      r16.w = dot(refProbeAttenuationConstantsCB[r10.w].data[1].xyz, r18.yzw);
      r16.w = saturate(refProbeAttenuationConstantsCB[r10.w].data[1].w + r16.w);
      r14.w = r16.w * r14.w;
      r16.w = dot(refProbeAttenuationConstantsCB[r10.w].data[2].xyz, r18.yzw);
      r16.w = saturate(refProbeAttenuationConstantsCB[r10.w].data[2].w + r16.w);
      r14.w = r16.w * r14.w;
      r16.w = dot(refProbeAttenuationConstantsCB[r10.w].data[3].xyz, r18.yzw);
      r16.w = saturate(refProbeAttenuationConstantsCB[r10.w].data[3].w + r16.w);
      r14.w = r16.w * r14.w;
      r16.w = dot(refProbeAttenuationConstantsCB[r10.w].data[4].xyz, r18.yzw);
      r16.w = saturate(refProbeAttenuationConstantsCB[r10.w].data[4].w + r16.w);
      r14.w = r16.w * r14.w;
      r16.w = dot(refProbeAttenuationConstantsCB[r10.w].data[5].xyz, r18.yzw);
      r10.w = saturate(refProbeAttenuationConstantsCB[r10.w].data[5].w + r16.w);
      r19.x = r14.w * r10.w;
      r10.w = 1 & (int)refProbeConstantsCB[r7.w].data[6].x;
      r19.xw = r10.ww ? r19.xy : r19.zx;
      r10.w = refProbeConstantsCB[r7.w].data[6].x;
      r27.xy = r19.xw;
      r14.w = 1;
      while (true) {
        ...
        r16.w = (int)r8.w + (int)r14.w;
        r16.w = (int)r16.w * 6;
        r20.w = dot(refProbeAttenuationConstantsCB[r16.w].data[0].xyz, r18.yzw);
        r20.w = saturate(refProbeAttenuationConstantsCB[r16.w].data[0].w + r20.w);
        r20.w = r27.x * r20.w;
        r22.w = dot(refProbeAttenuationConstantsCB[r16.w].data[1].xyz, r18.yzw);
        r22.w = saturate(refProbeAttenuationConstantsCB[r16.w].data[1].w + r22.w);
        r20.w = r22.w * r20.w;
        r22.w = dot(refProbeAttenuationConstantsCB[r16.w].data[2].xyz, r18.yzw);
        r22.w = saturate(refProbeAttenuationConstantsCB[r16.w].data[2].w + r22.w);
        r20.w = r22.w * r20.w;
        r22.w = dot(refProbeAttenuationConstantsCB[r16.w].data[3].xyz, r18.yzw);
        r22.w = saturate(refProbeAttenuationConstantsCB[r16.w].data[3].w + r22.w);
        r20.w = r22.w * r20.w;
        r22.w = dot(refProbeAttenuationConstantsCB[r16.w].data[4].xyz, r18.yzw);
        r22.w = saturate(refProbeAttenuationConstantsCB[r16.w].data[4].w + r22.w);
        r20.w = r22.w * r20.w;
        r22.w = dot(refProbeAttenuationConstantsCB[r16.w].data[5].xyz, r18.yzw);
        r16.w = saturate(refProbeAttenuationConstantsCB[r16.w].data[5].w + r22.w);
        r27.x = r20.w * r16.w;
        r22.w = (uint)r10.w >> 2;
        if (1 == 0) r23.w = 0; else if (1+2 < 32) {         r23.w = (uint)r10.w << (32-(1 + 2)); r23.w = (uint)r23.w >> (32-1);        } else r23.w = (uint)r10.w >> 2;
        r26.w = (int)r22.w & 2;
        r27.z = max(r27.y, r27.x);
        r16.w = -r20.w * r16.w + 1;
        r16.w = r27.y * r16.w;
        r21.w = r26.w ? r16.w : r27.z;
        r27.xy = r23.ww ? r27.xy : r21.zw;
        r14.w = (int)r14.w + 1;
        r10.w = r22.w;
      }
      r8.w = saturate(r27.y + -r25.z);
      ...
      if (r10.w != 0) {
        ...
        r14.w = r2.z ? r14.w : 0;
        if (r14.w != 0) {
          r19.xw = mad((int2)r10.ww, int2(20,20), int2(860,876));
        // Known bad code for instruction (needs manual fix):
        ...
        r16.z = (int)r16.z + 257;
        r16.y = r8.w * refProbeConstantsCB[r7.w].data[6].y + r16.y;
        r8.w = refProbeConstantsCB[r7.w].data[7].y * r9.w;
        r28.x = refProbeConstantsCB[r7.w].data[7].w;
        r28.yz = refProbeConstantsCB[r7.w].data[8].xy;
        r9.w = dot(r17.xyz, r28.xyz);
        r10.w = dot(r18.yzw, r28.xyz);
        r10.w = -refProbeConstantsCB[r7.w].data[8].z + r10.w;
        r14.w = cmp(r10.w >= 0);
        r10.w = max(abs(r10.w), r3.z);
        r10.w = r14.w ? r10.w : -r10.w;
        ...
        r10.w = r14.w / r10.w;
        r9.w = min(abs(r10.w), r9.w);
        r28.x = refProbeConstantsCB[r7.w].data[3].w + r18.y;
        r28.yz = refProbeConstantsCB[r7.w].data[4].xy + r18.zw;
        r27.xzw = r17.xyz * r9.www + r28.xyz;
        r10.w = dot(r27.xzw, r27.xzw);
        r10.w = sqrt(r10.w);
        r9.w = r9.w / r10.w;
        r9.w = r9.w + r9.w;
        r9.w = sqrt(r9.w);
        ...
        if (9 == 0) r10.w = 0; else if (9+16 < 32) {         r10.w = (uint)refProbeConstantsCB[r7.w].data[7].z << (32-(9 + 16)); r10.w = (uint)r10.w >> (32-9);        } else r10.w = (uint)refProbeConstantsCB[r7.w].data[7].z >> 16;
        r29.w = (uint)r10.w;
        r27.xzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r29.xyzw, r9.w).xyz;
        r32.xyz = (int3)r27.xzw & int3(-2147483648,-2147483648,-2147483648);
        r32.xyz = cmp((int3)r32.xyz == int3(2139095040,2139095040,2139095040));
        r9.w = (int)r32.y | (int)r32.x;
        r9.w = (int)r32.z | (int)r9.w;
        r27.xzw = r9.www ? float3(1,1,0) : r27.xzw;
        r32.x = dot(r18.yzw, r28.xyz);
        r32.y = dot(r18.yzw, r30.xyz);
        r32.z = dot(r18.yzw, r31.xyz);
        r18.yzw = saturate(r32.xyz * refProbeConstantsCB[r7.w].data[3].xyz + float3(0.5,0.5,0.5));
        r32.xy = refProbeConstantsCB[r7.w].data[4].zw * r18.yz;
        r32.z = refProbeConstantsCB[r7.w].data[5].x * r18.w;
        r18.yzw = refProbeConstantsCB[r7.w].data[5].yzw + r32.xyz;
        r29.x = dot(r12.xyz, r28.xyz);
        r29.y = dot(r12.xyz, r30.xyz);
        r29.z = dot(r12.xyz, r31.xyz);
        r28.xyz = cmp(float3(0,0,0) < r29.xyz);
        r20.z = r28.x ? 0 : 0.5;
        r30.xyz = r20.xyz + r18.yzw;
        ...
        r18.yzw = r18.yzw * r31.zzz + r28.xyw;
        ...
        r28.xyz = r7.www ? float3(1,1,0) : r28.xyz;
        r29.xyz = r28.xyz * r18.yzw;
        r7.w = dot(r29.xyz, float3(0.212599993,0.715200007,0.0722000003));
        r15.yzw = r18.yzw * r28.xyz + r15.yzw;
        r9.w = r7.w * r3.w;
        r18.yzw = r27.xzw * r8.www;
        r8.w = dot(r18.yzw, float3(0.212599993,0.715200007,0.0722000003));
        r7.w = r3.w * r7.w + r8.w;
        r7.w = r9.w / r7.w;
        r26.xyz = r18.yzw * r7.www + r26.xyz;
      } else {
        r21.x = r16.y;
        r16.yz = r21.xy;
      }
  ...
  r0.x = cmp(r25.z >= 1);
  bitmask.w = ((~(-1 << 8)) << 0) & 0xffffffff;  r2.w = (((uint)r16.z << 0) & bitmask.w) | ((uint)r25.w & ~bitmask.w);
  r0.x = r0.x ? r2.w : r16.z;
  r2.w = max(1, r16.y);
  r2.w = rcp(r2.w);
  r16.y = saturate(r16.y);
  r18.xyz = r15.yzw * r2.www;
  r19.xyz = r26.xyz * r2.www;
  ...
  if (r3.z != 0) {
    ...
    r2.w = r2.y * r2.w + r3.w;
    r19.xyz = r15.yzw * r2.www + r19.xyz;
  }
  r2.w = r2.x + r5.z;
  r2.w = log2(abs(r2.w));
  r2.w = r2.w * r1.w;
  ...
  if (enableCountDebug != 0) {
    if (debugDrawOverlayType != 0) {
      switch (cb2[53].y) {
        case 1 :        r0.y = (int)r5.z & 3;
        break;
        case 2 :        if (2 == 0) r0.y = 0; else if (2+8 < 32) {         r0.y = (uint)r5.z << (32-(2 + 8)); r0.y = (uint)r0.y >> (32-2);        } else r0.y = (uint)r5.z >> 8;
        break;
        case 3 :        r0.y = (uint)r5.z >> 16;
        break;
