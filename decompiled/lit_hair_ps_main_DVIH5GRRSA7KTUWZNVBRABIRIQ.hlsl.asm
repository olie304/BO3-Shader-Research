...
sample_indexable(texture2d)(float,float,float,float) r1.x, v2.xyxx, t26.xyzw, s6
sample_indexable(texture2d)(float,float,float,float) r1.y, v2.xyxx, t25.yxzw, s3
...
if_nz r7.w
  ...
  mad r19.xyz, r2.xyzx, r11.yyyy, v7.xyzx
        ...
        if_nz r33.w
          ...
          if_nz r31.w
            ...
            if_nz r31.w
              ...
              mad r61.xyz, r2.xyzx, r31.wwww, v7.xyzx
            ...
            if_nz r39.w
              ...
              mad r24.xyz, r2.xyzx, r34.wwww, v7.xyzx
...
mad r15.xyz, r1.yyyy, l(3.141600, 0.500000, 0.500000, 0.000000), l(3.141600, 0.33333334, 1.000000, 0.000000)
sincos r6.x, r10.x, r15.x
...
rcp r3.w, r3.w
mul r1.z, r1.z, r3.w
mul r5.xy, r15.yzyy, l(0.11764706, 0.11764706, 0.000000, 0.000000)
...
ftoi r10.xy, r6.xyxx
mov r10.zw, l(0,0,0,0)
ld_indexable(texture2d)(float,float,float,float) r5.z, r10.xyzw, t21.yzxw
...
if_nz r6.x
  ...
  ftoi r10.xy, r8.xyxx
  mov r10.zw, l(0,0,0,0)
  ld_indexable(texture2d)(float,float,float,float) r6.x, r10.xyzw, t21.xyzw
  ...
  ftoi r10.xy, r5.xyxx
  mov r10.zw, l(0,0,0,0)
  ld_indexable(texture2d)(float,float,float,float) r5.x, r10.xyzw, t21.xyzw
...
if_z r3.w
  ...
  ftoi r10.xy, r5.yzyy
  mov r10.zw, l(0,0,0,0)
  ld_indexable(texture2d)(float,float,float,float) r5.y, r10.xyzw, t21.yxzw
...
ret 
// Approximately 2389 instruction slots used
