...
sample_indexable(texture2d)(float,float,float,float) r0.w, v6.xyxx, t10.yzwx, s1
mul r1.yzw, r0.xxyz, cb0[15].xxyz
...
ftou r2.zw, v0.xxxy
mad r3.y, r1.y, r0.w, -r1.w
mad r1.x, r3.y, l(0.500000), r1.w
mad r3.z, r1.z, r0.w, -r1.x
mad r3.x, r3.z, l(0.500000), r1.x
and r1.xy, r2.zwzz, l(1, 1, 0, 0)
ieq r0.w, r1.y, r1.x
...
mul r1.zw, |r2.xxxy|, l(0.000000, 0.000000, 0.100000, 0.100000)
...
ge r1.zw, r2.xxxy, l(0.000000, 0.000000, 0.000000, 0.000000)
