...
sample_indexable(texture2d)(float,float,float,float) r1.xyzw, r0.xyxx, t7.xyzw, s1
sample_indexable(texture2d)(float,float,float,float) r0.z, r0.xyxx, t9.yzxw, s1
...
mad r0.w, r0.w, r2.x, cb0[11].x
mul_sat r0.w, r0.w, l(0.05882353)
sample_indexable(texture2d)(float,float,float,float) r2.yzw, r0.xyxx, t10.wxyz, s3
