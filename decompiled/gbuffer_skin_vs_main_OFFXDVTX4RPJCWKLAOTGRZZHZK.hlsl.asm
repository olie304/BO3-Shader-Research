...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:31:33 2021
//
//
// Buffer Definitions: 
//
...
// TENSION                  0   xyz         6     NONE   float   xyz 
//
vs_5_0
...
if_nz r1.w
    ...
    if_nz r2.z
      ...
      if_nz r2.z
        ...
        if_nz r2.z
          ...
          dp3 r2.z, r8.xyzx, v0.xyzx
          add r2.z, r8.w, r2.z
          mad r5.z, r2.z, v5.w, r5.z
          dp3 r2.z, r8.xyzx, r0.xyzx
          mad r6.z, r2.z, v5.w, r6.z
          dp3 r2.z, r8.xyzx, r1.xyzx
          mad r4.z, r2.z, v5.w, r4.z
  ...
  ld_indexable(texture2d)(float,float,float,float) r9.xyzw, r4.xyzz, t3.xyzw
  ld_indexable(texture2d)(float,float,float,float) r10.xyzw, r4.xwzz, t3.xyzw
  ld_indexable(texture2d)(float,float,float,float) r3.xyw, r4.xzzz, t1.xywz
  add r8.xyzw, -r6.xyzw, r8.xyzw
  mad r6.xyzw, r3.zzzz, r8.xyzw, r6.xyzw
  add r8.xyzw, -r9.xyzw, r10.xyzw
  mad r8.xyzw, r3.zzzz, r8.xyzw, r9.xyzw
  add r9.xyz, -r3.xywx, v0.xyzx
  dp4 r1.w, r6.xyzw, r6.xyzw
  rsq r1.w, r1.w
  mul r6.xyzw, r1.wwww, r6.xyzw
  add r10.xyz, r6.xyzx, r6.xyzx
  mul r11.xyz, r6.xzwx, r10.xxxx
  mul r1.w, r6.w, r10.y
  mul r2.zw, r6.wwwz, r10.zzzz
  mad r7.w, r6.y, r10.y, r2.w
  add r12.x, -r7.w, l(1.000000)
  mad r13.x, r6.z, r10.x, -r1.w
  mad r12.y, r6.y, r10.x, -r2.z
  mad r14.xy, r6.yxyy, r10.xxxx, r2.zwzz
  mad r14.z, r6.z, r10.y, -r11.z
  mad r6.xyz, r6.zwyz, r10.yyyy, r11.zyxz
  mov r12.z, r6.y
  ...
  add r3.xyw, r8.xyxz, r3.xyxw
  mul r5.xyz, r3.xywx, v5.xxxx
  mul r3.xyw, r6.xyxz, v5.xxxx
  mul r6.xyz, r9.xyzx, v5.xxxx
  mul r7.z, r8.w, v5.x
  ne r1.w, v5.y, l(0.000000)
  if_nz r1.w
    mov r4.x, v6.y
    ld_indexable(texture2d)(float,float,float,float) r8.xyzw, r4.xyzz, t2.xyzw
    ld_indexable(texture2d)(float,float,float,float) r9.xyzw, r4.xwzz, t2.xyzw
    ld_indexable(texture2d)(float,float,float,float) r10.xyzw, r4.xyzz, t3.xyzw
    ld_indexable(texture2d)(float,float,float,float) r11.xyzw, r4.xwzz, t3.xyzw
    ld_indexable(texture2d)(float,float,float,float) r12.xyz, r4.xzzz, t1.xyzw
    add r9.xyzw, -r8.xyzw, r9.xyzw
    mad r8.xyzw, r3.zzzz, r9.xyzw, r8.xyzw
    add r9.xyzw, -r10.xyzw, r11.xyzw
    mad r9.xyzw, r3.zzzz, r9.xyzw, r10.xyzw
    ...
    dp3 r8.x, r0.xyzx, r14.xyzx
    dp3 r8.y, r0.xzyx, r16.xzwx
    dp3 r8.z, r0.xyzx, r15.xyzx
    ...
    mad r5.xyz, r9.xyzx, v5.yyyy, r5.xyzx
    mad r3.xyw, r8.xyxz, v5.yyyy, r3.xyxw
    mad r6.xyz, r10.xyzx, v5.yyyy, r6.xyzx
    mad r7.z, r9.w, v5.y, r7.z
    ...
    if_nz r1.w
      ...
      add r11.xyz, r12.xyzx, r11.xyzx
      add r9.xyz, r9.xyzx, r11.xyzx
      mad r5.xyz, r9.xyzx, v5.zzzz, r5.xyzx
      mad r3.xyw, r8.xyxz, v5.zzzz, r3.xyxw
      mad r6.xyz, r10.xyzx, v5.zzzz, r6.xyzx
      mad r7.z, r9.w, v5.z, r7.z
      ...
      if_nz r1.w
        ...
        mul r1.w, r8.w, r11.y
        mul r2.zw, r8.wwwz, r11.zzzz
        mad r3.z, r8.y, r11.y, r2.w
        add r13.x, -r3.z, l(1.000000)
        ...
        mad r6.xyz, r10.xyzx, v5.wwww, r6.xyzx
        mad r7.z, r9.w, v5.w, r7.z
      endif 
    endif 
  endif 
...
if_nz r0.x
  ...
  if_nz r0.x
    ...
    ld_indexable(texture2d)(float,float,float,float) r0.xyz, r3.xyzz, t3.xyzw
    ...
    mul r8.xyz, r4.xzwx, r5.xxxx
    mul r5.w, r4.w, r5.y
    mul r9.xy, r4.wzww, r5.zzzz
    mad r5.z, r4.y, r5.y, r9.y
    add r10.x, -r5.z, l(1.000000)
    mad r11.x, r4.z, r5.x, -r5.w
    mad r10.y, r4.y, r5.x, -r9.x
    mad r9.xy, r4.yxyy, r5.xxxx, r9.xyxx
    mad r9.z, r4.z, r5.y, -r8.z
    mad r4.xyz, r4.zwyz, r5.yyyy, r8.zyxz
    mov r10.z, r4.y
    dp3 r5.x, r1.xywx, r10.xyzx
    add r9.w, -r9.y, l(1.000000)
    dp3 r5.y, r1.xwyx, r9.xzwx
    mad r11.yz, r4.xxzx, l(0.000000, 1.000000, -1.000000, 0.000000), l(0.000000, 0.000000, 1.000000, 0.000000)
    dp3 r5.z, r1.xywx, r11.xyzx
    add r1.xyw, r6.xyxz, r5.xyxz
    add r0.xyz, r0.xyzx, r1.xywx
    mul r2.xyz, r0.xyzx, v5.xxxx
    ...
    if_nz r0.x
      ...
      add r1.xyw, r6.xyxz, r5.xyxz
      add r0.xyz, r0.xyzx, r1.xywx
      mad r2.xyz, r0.xyzx, v5.yyyy, r2.xyzx
      ...
      if_nz r0.x
        ...
        add r1.xyw, r6.xyxz, r5.xyxz
        add r0.xyz, r0.xyzx, r1.xywx
        mad r2.xyz, r0.xyzx, v5.zzzz, r2.xyzx
        ...
        if_nz r0.x
          ...
          mad r9.x, r4.z, r5.x, -r1.w
          mad r8.y, r4.y, r5.x, -r5.z
          mad r10.xy, r4.yxyy, r5.xxxx, r5.zwzz
          mad r10.z, r4.z, r5.y, -r6.z
          mad r4.xyz, r4.zwyz, r5.yyyy, r6.zyxz
          mov r8.z, r4.y
          dp3 r5.x, r1.xyzx, r8.xyzx
          add r10.w, -r10.y, l(1.000000)
          dp3 r5.y, r1.xzyx, r10.xzwx
...
mov o6.xyz, r7.xyzx
ret 
// Approximately 846 instruction slots used
