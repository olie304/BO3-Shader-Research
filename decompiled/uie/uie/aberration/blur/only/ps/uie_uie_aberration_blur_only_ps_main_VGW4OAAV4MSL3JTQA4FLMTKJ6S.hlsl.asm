...
utof r0.xy, r0.xyxx
div r0.xy, l(0.500000, 0.500000, 0.000000, 0.000000), r0.xyxx
frc r0.zw, v2.xxxy
sample_indexable(texture2d)(float,float,float,float) r1.xyzw, r0.zwzz, t6.xyzw, s1
mul r0.xy, r0.xyxx, cb3[3].xyxx
...
loop 
  ...
  mov r3.z, l(-3.000000)
  loop 
    lt r3.w, l(3.000000), r3.z
    breakc_nz r3.w
    mul r3.x, r0.x, r3.z
    add r3.xw, r3.xxxy, v2.xxxy
    max r3.xw, r3.xxxw, cb3[7].xxxy
    min r3.xw, r3.xxxw, cb3[7].zzzw
    sample_indexable(texture2d)(float,float,float,float) r5.xyz, r3.xwxx, t0.xyzw, s1
    mad r4.xyz, icb[r2.w + 0].xxxx, r5.xyzx, r4.xyzx
    iadd r2.w, r2.w, l(1)
...
endloop 
mul r0.xyz, r2.xyzx, cb3[1].xxxx
dp3_sat r0.w, r0.xyzx, l(0.350000, 0.500000, 0.150000, 0.000000)
mul r1.xyz, r1.xyzx, l(0.000002, 0.000002, 0.000002, 0.000000)
add_sat r1.w, r1.w, r1.w
mul r1.xyz, r1.wwww, r1.xyzx
mad r0.xyz, r0.xyzx, l(0.700000, 0.700000, 1.000000, 0.000000), r1.xyzx
mul o0.w, r0.w, v1.w
...
frc r1.y, r0.w
resinfo_indexable(texture2d)(float,float,float,float)_uint r1.zw, l(0), t7.zwxy
