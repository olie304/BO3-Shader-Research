...
// ------------------------------ ---------- ------- ----------- -------------- ------
// clampNoMipBilinearSampler         sampler      NA          NA             s1      1 
// tileMipBilinearSampler            sampler      NA          NA             s2      1 
...
add r0.zw, r0.yyyy, l(0.000000, 0.000000, 3.14159274, 1.57079637)
add r0.z, -r0.z, l(3.14159274)
min r0.z, r0.z, r0.w
mul_sat r0.z, r0.z, l(200.000000)
mad r0.w, r0.z, l(-2.000000), l(3.000000)
mul r0.z, r0.z, r0.z
mul r0.z, r0.z, r0.w
mul r0.w, r0.y, l(0.31830987)
sincos r1.x, r2.x, r0.y
div r3.x, r0.w, cb3[2].x
round_ni r0.y, cb1[69].w
mad r0.y, r0.y, l(0.125000), r0.w
div r4.x, r0.w, cb3[1].z
add r5.y, r0.y, l(0.500000)
mul r5.x, cb3[0].x, cb1[69].w
sample_indexable(texture2d)(float,float,float,float) r5.xyzw, r5.xyxx, t6.xyzw, s2
mad r0.y, -r5.y, cb3[0].y, l(1.000000)
mul r1.yzw, r5.xxzw, cb3[0].yyyy
mul r0.y, r0.y, r0.y
add r0.w, -cb3[2].z, cb3[2].y
mad r0.y, r0.y, r0.w, cb3[2].z
add r0.w, r0.x, l(-0.380000)
mad_sat r3.y, r0.w, r0.y, l(0.500000)
...
mad r0.yw, r1.zzzw, r0.yyyy, cb3[1].xxxx
mad r1.y, -r1.y, l(0.200000), l(1.000000)
mul r1.y, r0.x, r1.y
add r0.xy, -r0.ywyy, r0.xxxx
mad_sat r4.yz, r0.xxyx, cb3[1].wwww, l(0.000000, 0.500000, 0.500000, 0.000000)
mul r0.x, r1.y, l(1.250000)
sample_indexable(texture2d)(float,float,float,float) r5.xyzw, r4.wzww, t9.xyzw, s2
sample_indexable(texture2d)(float,float,float,float) r4.xyzw, r4.xyxx, t9.xyzw, s2
add r4.xyzw, r5.xyzw, r4.xyzw
mad r3.xyzw, r3.xyzw, r0.zzzz, r4.xyzw
mul r2.x, r0.x, r2.x
mul r2.y, r0.x, r1.x
