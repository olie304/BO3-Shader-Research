...
dcl_output o0.xyzw
dcl_temps 1
add r0.x, v2.y, -cb3[7].y
add r0.y, -cb3[7].y, cb3[7].w
div r0.x, r0.x, r0.y
mul r0.x, r0.x, cb3[0].x
round_ni r0.x, r0.x
add r0.y, cb3[0].x, l(-1.000000)
add r0.z, -r0.x, r0.y
add r0.w, -cb3[2].x, l(1.000000)
div r0.y, r0.w, r0.y
mad r0.z, r0.z, r0.y, cb3[1].x
mad r0.x, -r0.x, r0.y, cb3[1].x
div r0.xy, r0.xzxx, cb3[2].xxxx
add r0.xy, -r0.xyxx, v2.xxxx
max r0.x, r0.x, l(0.000000)
min r0.x, r0.x, v2.x
max r0.y, r0.y, v2.x
min r0.y, r0.y, l(1.000000)
lt r0.z, cb3[1].x, l(0.000000)
