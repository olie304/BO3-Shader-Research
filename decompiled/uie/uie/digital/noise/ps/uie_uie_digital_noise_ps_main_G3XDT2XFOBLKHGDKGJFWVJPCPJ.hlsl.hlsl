  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.y = frac(r0.z);
  r0.zw = v0.xy / scriptVector1.xx;
  colorMapSampler1.GetDimensions(0, uiDest.x, uiDest.y, uiDest.z);
  r1.xy = uiDest.xy;
  r1.xy = (uint2)r1.xy;
