  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.x = r0.x ? r0.w : 0;
  r1.y = r0.y * r0.z + r0.x;
  r0.x = scriptVector0.x * 1.57079637 + -9.99999975e-05;
  r0.xy = r1.xy + -r0.xx;
  r0.xy = saturate(float2(5000,5000) * r0.xy);
