...
sample_indexable(texture2d)(float,float,float,float) r1.xyz, v2.xyxx, t22.xyzw, s3
sample_indexable(texture2d)(float,float,float,float) r1.w, v2.xyxx, t26.yzwx, s6
sample_indexable(texture2d)(float,float,float,float) r2.x, v2.xyxx, t25.xyzw, s3
add r2.y, -cb0[12].x, cb0[12].y
mad r2.x, r2.x, r2.y, cb0[12].x
mul_sat r2.x, r2.x, l(0.05882353)
sample_indexable(texture2d)(float,float,float,float) r2.yzw, v2.xyxx, t24.wxyz, s5
...
mad r2.zw, r3.xxxy, cb0[13].zzzw, r2.zzzw
...
add r3.x, -r3.x, l(1.000000)
add r3.y, -cb0[14].z, cb0[14].w
mad r3.x, r3.x, r3.y, cb0[14].z
div r2.zw, r2.zzzw, r3.xxxx
add r2.zw, r2.zzzw, l(0.000000, 0.000000, 0.500000, 0.500000)
mov_sat r3.xy, r2.zwzz
movc r2.zw, cb0[15].zzzw, r3.xxxy, r2.zzzw
dp3_sat r3.x, r6.xyzx, r4.xyzx
...
sample_indexable(texture2d)(float,float,float,float) r2.w, v2.xyxx, t30.yzwx, s7
mul_sat r2.z, r2.z, l(0.998000)
mad_sat r3.y, -cb0[8].x, l(0.500000), r2.z
add r6.w, r2.z, -r3.y
add r3.y, r2.w, -r3.y
div r6.w, l(1.000000, 1.000000, 1.000000, 1.000000), r6.w
mul_sat r3.y, r3.y, r6.w
...
add r6.w, -r2.z, r6.w
add r2.z, -r2.z, r2.w
div r2.w, l(1.000000, 1.000000, 1.000000, 1.000000), r6.w
...
min r2.w, r2.w, l(1.000000)
mul r2.w, r2.w, r4.w
mul r9.xyz, r2.wwww, cb0[17].xyzx
mad_sat r4.xyz, r4.xyzx, r2.zzzz, r9.xyzx
log r2.z, r3.x
...
add r2.w, r2.w, r2.w
mad r12.xyz, r5.xyzx, -r2.wwww, -r6.xyzx
...
if_nz r8.w
  ...
  if_nz r8.w
    ...
    mov r13.w, r7.z
    and r13.xyzw, r4.wwww, r13.xyzw
    mov r7.zw, r11.yyyz
    and r7.xyzw, r4.wwww, r7.xyzw
    and r0.w, r4.w, r11.w
  else 
...
loop 
  ...
  ieq r6.w, r3.z, r6.y
  bfi r7.z, r3.w, l(0), l(0), r6.z
  movc r6.z, r6.w, r7.z, r6.z
  ieq r6.w, r4.w, r6.y
  ubfe r7.z, r6.x, l(0), r6.z
  movc r6.z, r6.w, r7.z, r6.z
  ...
  loop 
    ...
    if_nz r9.x
      ...
      if_nz r8.w
        ...
        dp3 r11.x, r25.xyzx, r23.xyzx
        add_sat r11.x, r25.w, r11.x
        mul r10.w, r10.w, r11.x
        dp3 r11.x, r26.xyzx, r23.xyzx
        add_sat r11.x, r26.w, r11.x
        mul r10.w, r10.w, r11.x
        dp3 r11.x, r29.xyzx, r23.xyzx
        add_sat r11.x, r29.w, r11.x
        mul r10.w, r10.w, r11.x
        dp3 r11.x, r30.xyzx, r23.xyzx
        add_sat r11.x, r30.w, r11.x
        mul r10.w, r10.w, r11.x
        dp3 r11.x, r31.xyzx, r23.xyzx
        ...
        if_nz r9.x
          ...
          mad_sat r14.yzw, r25.xxyz, r29.xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
          mov r30.z, r31.x
          ...
          mad r7.w, r3.x, r8.w, r7.w
          div r7.w, r10.x, r7.w
          mov r21.x, r19.w
          mov r21.yz, r20.xxyx
          mad r20.xyw, r9.yzyx, r7.wwww, r21.yzyx
          mov r19.w, r20.w
        endif 
      endif 
    endif 
...
if_nz r4.w
  ...
  loop 
    ...
    breakc_nz r8.w
    ushr r6.z, r6.w, l(5)
    iadd r7.xyz, r6.xyzx, r8.xyzx
    ld_indexable(texture2darray)(uint,uint,uint,uint) r6.z, r7.xyzw, t7.yzxw
    ieq r7.x, r3.z, r6.w
    ubfe r7.y, r3.w, l(0), r6.z
    ...
    loop 
      ...
      if_nz r10.w
        ...
        if_nz r9.w
          ...
          and r9.w, r23.w, l(0x0000ffff)
          ubfe r10.w, l(6), l(25), r23.w
          ...
          dp3 r11.x, r25.xyzx, r24.xyzx
          add_sat r11.x, r25.w, r11.x
          dp3 r14.w, r26.xyzx, r24.xyzx
          add_sat r14.w, r26.w, r14.w
          mul r11.x, r11.x, r14.w
          ...
          add_sat r14.w, r32.w, r14.w
          mul r9.x, r11.x, r14.w
          and r11.x, r13.z, l(1)
          movc r25.xy, r11.xxxx, r9.xyxx, r9.zxzz
          mov r9.x, r13.z
          mov r26.xy, r25.xyxx
          mov r11.x, l(1)
          loop 
            ige r14.w, r11.x, r10.w
            breakc_nz r14.w
            iadd r14.w, r9.w, r11.x
          ...
          if_nz r10.w
            ...
            mad r20.w, r9.x, r13.w, r20.w
            mul r8.w, r23.z, r9.w
            mov r23.z, r33.z
            dp3 r9.x, r12.xyzx, r23.xyzx
            ...
            dp3 r10.w, r24.xyzx, r33.xyzx
            add r10.w, -r34.w, r10.w
            ...
            min r9.x, |r9.w|, r9.x
            mov r35.z, r36.z
            dp3 r9.w, r12.xyzx, r35.xyzx
            dp3 r10.w, r24.xyzx, r35.xyzx
            ...
            min r9.x, |r9.w|, r9.x
            mov r36.z, r37.x
            dp3 r9.w, r12.xyzx, r36.xyzx
            dp3 r10.w, r24.xyzx, r36.xyzx
            add r10.w, -r37.y, r10.w
            ge r11.x, r10.w, l(0.000000)
            max r10.w, r2.w, |r10.w|
            movc r10.w, r11.x, r10.w, -r10.w
            max r9.w, -r9.w, l(0.00000010)
            ...
            min r9.x, |r9.w|, r9.x
            mov r38.zw, r37.zzzw
            dp3 r9.w, r12.zxyz, r38.xzwx
            dp3 r10.w, r24.zxyz, r38.xzwx
            ...
            mov r23.x, r30.w
            mov r23.yz, r31.zzwz
            add r13.yzw, r24.xxyz, r23.xxyz
            mad r13.yzw, r12.xxyz, r9.xxxx, r13.yyzw
            ...
            mov r22.y, r25.z
            mov r22.z, r29.x
            dp3 r33.x, r13.yzwy, r22.xyzx
            mov r23.xy, r25.xwxx
            mov r23.z, r29.w
            dp3 r33.y, r13.yzwy, r23.xyzx
            mov r29.x, r25.y
            dp3 r33.z, r13.yzwy, r29.xyzx
            ubfe r9.w, l(9), l(16), r23.w
            utof r33.w, r9.w
            sample_l_indexable(texturecubearray)(float,float,float,float) r13.yzw, r33.xyzw, t8.wxyz, s2, r9.x
            dp3 r25.x, r24.xyzx, r22.xyzx
            dp3 r25.y, r24.xyzx, r23.xyzx
            dp3 r25.z, r24.xyzx, r29.xyzx
            mad_sat r24.xyz, r25.xyzx, r30.xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
            mov r31.z, r32.x
            mad r24.xyz, r24.xyzx, r31.xyzx, r32.yzwy
            dp3 r33.x, r5.xyzx, r22.xyzx
            dp3 r33.y, r5.xyzx, r23.xyzx
            dp3 r33.z, r5.xyzx, r29.xyzx
            lt r22.xyz, l(0.000000, 0.000000, 0.000000, 0.000000), r33.xyzx
            movc r10.z, r22.x, l(0), l(0.500000)
            add r23.xyz, r10.xyzx, r24.xyzx
            sample_l_indexable(texture3d)(float,float,float,float) r23.xyz, r23.xyzx, t17.xyzw, s4, l(0.000000)
            mul r25.xyz, r33.xyzx, r33.xyzx
            ...
            mad r8.w, r3.x, r9.x, r8.w
            div r8.w, r9.w, r8.w
            mad r20.xyz, r13.yzwy, r8.wwww, r20.xyzx
          endif 
        endif 
      endif 
    endloop 
...
if_nz r2.w
  ...
  mov r12.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r5.xyz, r12.xyzw, t8.xyzw, s2, r2.z
  mad r0.w, cb2[19].x, r2.w, -r3.w
  mad r0.w, r2.y, r0.w, r3.w
  mad r6.xyz, r5.xyzx, r0.wwww, r6.xyzx
endif 
mad r3.xyz, r3.xyzx, r1.wwww, r11.yzwy
...
mad r2.xzw, r5.xxyz, r2.xxxx, r27.xxyz
mad r5.xyz, r5.xyzx, r2.yyyy, r28.xyzx
