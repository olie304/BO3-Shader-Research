...
loop 
  ieq r15.y, r14.w, l(2)
  breakc_nz r15.y
  movc r15.y, r14.w, r0.y, r14.z
  uge r15.z, r15.y, r14.y
  ...
  if_nz r15.z
    ...
    add r17.yzw, r11.xxyz, -cb10[r15.y + 0].xxyz
...
loop 
  ieq r18.w, r14.w, l(2)
  breakc_nz r18.w
  movc r18.w, r14.w, r0.y, r14.z
  ult r19.w, r18.w, r14.y
  if_nz r19.w
...
ret 
// Approximately 2162 instruction slots used
