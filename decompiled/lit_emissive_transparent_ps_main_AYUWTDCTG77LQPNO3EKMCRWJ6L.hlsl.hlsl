...
r3.w = samp0[]..swiz;
  ...
  r27.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r10.yz, r8.z, l(96), t15.xxyx
  r10.y = samp0[]..swiz;
  r10.z = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
  ...
  if (r6.z != 0) {
    ...
    if (r6.z != 0) {
      ...
      if (sunConstants.sunCookieIndex != 0) {
        ...
        r8.z = dot(sunConstants.sunCookieTransform[1].xyzw, r16.xyzw);
        r16.x = frac(r7.w);
        r16.y = frac(r8.z);
      ...
      r1.x = dot(r11.yzw, r7.xyz);
      r7.w = dot(r4.xyz, r11.yzw);
      r8.z = abs(r7.w) * r2.w + -abs(r7.w);
            ...
            r39.w = samp0[]..swiz;
              ...
              if (r15.w != 0) {
                ...
                if (r15.w != 0) {
                  ...
                  r20.xyz = r20.xyz * r12.www + r7.xyz;
                  r12.w = dot(r20.xyz, r20.xyz);
                  r12.w = rsqrt(r12.w);
                  r20.xyz = r20.xyz * r12.www;
                  r12.w = dot(r20.xyz, r7.xyz);
