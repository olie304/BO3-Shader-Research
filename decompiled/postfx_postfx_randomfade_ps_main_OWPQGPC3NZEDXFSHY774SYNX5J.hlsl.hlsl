  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.x = gameTime.w;
  r0.yz = v1.xy;
  r0.x = dot(r0.xyz, float3(81.2394867,17.3480244,37.3498383));
  r0.x = frac(r0.x);
  r0.zw = v1.xy;
  r1.x = dot(r0.xzw, float3(81.2394867,17.3480244,37.3498383));
  r0.y = frac(r1.x);
  r1.x = dot(r0.xyw, float3(81.2394867,17.3480244,37.3498383));
  r0.z = frac(r1.x);
  r1.x = dot(r0.xyz, float3(81.2394867,17.3480244,37.3498383));
  r0.w = frac(r1.x);
  ...
  r0.yzw = (int3)r1.xyz & int3(2139095040,2139095040,2139095040);
  r0.yzw = cmp((int3)r0.yzw != int3(2139095040,2139095040,2139095040));
  r1.xyz = float3(3.05175781e-05,3.05175781e-05,3.05175781e-05) * r1.xyz;
  o0.w = r1.w;
  r0.yzw = r0.yzw ? r1.xyz : float3(2,2,2);
