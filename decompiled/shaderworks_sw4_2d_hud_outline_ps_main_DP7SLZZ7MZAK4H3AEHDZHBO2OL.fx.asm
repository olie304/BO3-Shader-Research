...
sample_indexable(texture2d)(float,float,float,float) r0.xyz, r0.zwzz, t0.xyzw, s1
...
mul r0.w, v1.y, l(1510.092529)
sincos r0.w, null, r0.w
mad r0.w, r0.w, l(0.500000), l(0.500000)
mul o0.x, r0.x, r0.w
mul r0.xy, r0.wwww, r0.yzyy
mul o0.yz, r0.xxyx, l(0.000000, 0.08333334, 0.08333334, 0.000000)
mov o0.w, l(1.000000)
ret 
