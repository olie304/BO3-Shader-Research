...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  r2.x = dot(r1.yzw, v2.xyz);
  r3.x = dot(r1.yzw, v3.xyz);
  r3.y = dot(r1.yzw, v4.xyz);
  r2.z = cmp(0 < r2.x);
  r3.xy = -r3.xy / r2.xx;
  r2.zw = r2.zz ? r3.xy : 0;
  r3.xy = float2(-0.5,-0.5) + w1.xy;
  ...
  r2.x = saturate(r2.x);
  r2.z = dot(-r1.yzw, v2.xyz);
  r2.z = r2.z + r2.z;
  r8.xyz = v2.xyz * -r2.zzz + -r1.yzw;
  r2.z = 17 * r2.y;
  r2.z = exp2(r2.z);
  r2.z = 2 + r2.z;
  r2.z = 2 / r2.z;
  ...
  r36.w = samp0[]..swiz;
    ...
    r26.x = dot(v2.xyz, r18.xyz);
    r26.y = dot(v2.xyz, r27.xyz);
    r26.z = dot(v2.xyz, r20.xyz);
  ...
  if (r2.w == 0) {
        ...
        r11.y = samp0[]..swiz;
          ...
          r30.w = samp0[]..swiz;
            ...
            r36.y = samp0[]..swiz;
              ...
              r31.x = dot(v2.xyz, r23.xyz);
              r31.y = dot(v2.xyz, r24.xyz);
              r31.z = dot(v2.xyz, r27.xyz);
          ...
          r24.y = samp0[]..swiz;
            ...
            r31.w = samp0[]..swiz;
              ...
              r37.y = samp0[]..swiz;
                ...
                r32.x = dot(v2.xyz, r23.xyz);
                r32.y = dot(v2.xyz, r24.xyz);
                r32.z = dot(v2.xyz, r28.xyz);
    ...
    if (r3.x != 0) {
      ...
      r6.yzw = -globalProbeConstants.data[0].xyz + v5.xyz;
      ...
      r7.yzw = cmp(float3(0,0,0) < v2.xyz);
  ...
  if (noReceiveShadow == 0) {
    r4.z = dot(v2.xyz, sunConstants.wldDir.xyz);
    r4.z = cmp(0 >= abs(r4.z));
    if (r4.z != 0) {
      r4.w = 0;
    }
