...
if_nz cb0[23].x
  sample_indexable(texture2d)(float,float,float,float) r7.xy, v2.xyxx, t26.xyzw, s6
...
eq r8.xyz, r0.wwww, l(3.000000, 2.000000, 1.000000, 0.000000)
movc r9.xyz, r8.zzzz, cb0[25].xyzx, cb0[21].xyzx
movc r8.yzw, r8.yyyy, cb0[26].xxyz, r9.xxyz
movc r8.xyz, r8.xxxx, cb0[27].xyzx, r8.yzwy
dp3 r0.w, -v7.xyzx, -v7.xyzx
rsq r0.w, r0.w
mul r9.xyz, r0.wwww, -v7.xyzx
dp3 r10.x, r9.xyzx, v5.xyzx
dp3 r10.y, r9.xyzx, v6.xyzx
dp3 r2.w, r9.xyzx, v4.xyzx
lt r3.w, l(0.000000), r2.w
div r10.xy, -r10.xyxx, r2.wwww
and r10.xy, r3.wwww, r10.xyxx
add r10.zw, v2.xxxy, l(0.000000, 0.000000, -0.500000, -0.500000)
add r2.w, cb0[14].y, l(0.000010)
mul r10.xy, r2.wwww, r10.xyxx
mul r10.xy, r10.xyxx, cb0[12].zwzz
mad r10.xy, r10.zwzz, cb0[12].zwzz, r10.xyxx
mad r10.xy, cb0[13].xyxx, cb0[12].zwzz, r10.xyxx
mad r2.w, cb0[11].w, cb1[69].w, l(1.000000)
mul r2.w, r2.w, cb0[11].z
mul r2.w, r2.w, l(0.01745329)
sincos r11.x, r12.x, r2.w
mov r12.y, r12.x
mov r12.z, r11.x
dp2 r13.x, r12.yzyy, r10.xyxx
mov r12.x, -r11.x
dp2 r13.y, r12.xyxx, r10.xyxx
mul r10.xy, cb0[12].xyxx, cb1[69].wwww
mad r10.xy, r10.xyxx, cb0[12].zwzz, r13.xyxx
mul r2.w, cb0[14].x, cb1[69].w
sincos null, r2.w, r2.w
mad r2.w, r2.w, l(0.500000), l(0.500000)
add r2.w, -r2.w, l(1.000000)
add r3.w, -cb0[13].z, cb0[13].w
mad r2.w, r2.w, r3.w, cb0[13].z
div r10.xy, r10.xyxx, r2.wwww
add r10.xy, r10.xyxx, l(0.500000, 0.500000, 0.000000, 0.000000)
mov_sat r10.zw, r10.xxxy
movc r10.xy, cb0[14].zwzz, r10.zwzz, r10.xyxx
...
mul r0.z, r1.y, r0.z
mul r0.z, r1.x, r0.z
mul r1.xyz, r0.zzzz, r8.xyzx
add r0.z, v3.y, v3.x
add r0.z, r0.z, v3.z
add r0.z, r0.z, cb0[15].y
frc r0.z, r0.z
mad r8.y, cb1[69].w, cb0[15].z, r0.z
mov r8.x, cb0[15].x
sample_l_indexable(texture2d)(float,float,float,float) r0.z, r8.xyxx, t25.yzxw, s5, l(0.000000)
log r0.z, |r0.z|
...
dp3_sat r0.x, r4.xyzx, r9.xyzx
dp3 r2.y, -r9.xyzx, r4.xyzx
add r2.y, r2.y, r2.y
mad r13.xyz, r4.xyzx, -r2.yyyy, -r9.xyzx
...
mad r8.zw, r0.xxxy, l(0.000000, 0.000000, 0.984375, 0.984375), l(0.000000, 0.000000, 0.00781250, 0.00781250)
sample_l_indexable(texture2d)(float,float,float,float) r8.zw, r8.zwzz, t5.zwxy, s2, l(0.000000)
mul r14.xyz, r8.zzzz, r22.yzxy
mul r11.yzw, r8.wwww, r22.xxyz
sqrt r0.y, r2.z
  ...
  if_z r9.w
    ...
    if_nz cb2[58].y
      ...
      loop 
        ...
        movc r15.w, r13.w, cb2[r8.z + 20].w, cb2[r9.w + 20].w
...
if_nz r6.w
  ...
  if_nz r6.w
    ...
    if_nz r8.z
      ...
      mad r19.xyz, r4.xyzx, r8.wwww, v7.xyzx
      ...
      div r15.xy, r8.zzzz, r17.xzxx
      add r15.zw, -r15.xxxy, l(0.000000, 0.000000, 1.000000, 1.000000)
      ge r15.zw, r12.yyyz, r15.zzzw
      ge r15.xy, r15.xyxx, r12.yzyy
      ...
      if_z r8.w
        ...
        if_nz cb2[58].y
          ...
          loop 
            ...
            mad r17.xy, r18.xyxx, r8.zzzz, r15.xyxx
    ...
    mad r12.yzw, -v7.xxyz, r0.wwww, cb2[17].xxyz
    dp3 r0.w, r12.yzwy, r12.yzwy
    rsq r0.w, r0.w
    mul r12.yzw, r0.wwww, r12.yyzw
    dp3 r0.w, r12.yzwy, r9.xyzx
    ...
    mul r0.w, r0.w, r5.w
    mul r0.w, r0.w, r4.w
    mad r5.xyz, r0.wwww, r5.yzxy, r14.xyzx
    mov r15.w, r5.z
    mov r21.w, r14.z
          ...
          if_nz r14.w
            ...
            if_nz r14.w
                ...
                if_nz r18.x
                  ...
                  if_nz r7.w
                    ...
                    loop 
                      ...
                      sample_c_lz_indexable(texture2darray)(float,float,float,float) r21.w, r32.xyzx, t9.xxxx, s13, r8.w
              ...
              if_nz r14.w
                ...
                mad r19.xyz, r19.xyzx, r9.wwww, r9.xyzx
                dp3 r9.w, r19.xyzx, r19.xyzx
                rsq r9.w, r9.w
                mul r19.xyz, r9.wwww, r19.xyzx
                dp3 r9.w, r19.xyzx, r9.xyzx
