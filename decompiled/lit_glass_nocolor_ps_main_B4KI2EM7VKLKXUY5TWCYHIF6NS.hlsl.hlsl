...
r2.w = samp0[]..swiz;
  r5.xy = (int2)r2.ww & int2(268435456,536870912);
  if (r5.x != 0) {
    r6.xyz = eyeOffset.xyz + v6.xyz;
    r2.w = 0.0078125 * r0.w;
    r2.w = min(15, r2.w);
    r2.w = (uint)r2.w;
    r7.xy = (uint2)r2.xy >> int2(6,6);
    r7.z = (uint)r2.w << 4;
    ...
    r4.w = 0;
    while (true) {
      r7.w = cmp((uint)r4.w >= numStaticDecals);
      if (r7.w != 0) break;
      r8.z = (uint)r4.w >> 5;
      r9.xyz = (int3)r7.xyz + (int3)r8.xyz;
      r7.w = visibleDecals.Load(r9.xyzw).x;
      r8.z = cmp((int)r2.w == (int)r4.w);
      if (r3.w == 0) r8.w = 0; else if (r3.w+0 < 32) {       r8.w = (uint)r7.w << (32-(r3.w + 0)); r8.w = (uint)r8.w >> (32-r3.w);      } else r8.w = (uint)r7.w >> 0;
      r7.w = r8.z ? r8.w : r7.w;
      r8.z = (int)r2.z + (int)r4.w;
      r13.xyzw = r10.xzwy;
      r9.xyz = r5.xzw;
      r14.yz = r11.yz;
      r15.xy = r12.xy;
      ...
      while (true) {
        ...
        r17.y = samp0[]..swiz;
          ...
          r18.z = samp0[]..swiz;
            ...
            r21.w = samp0[]..swiz;
              r19.w = r21.x;
              r19.x = dot(r6.xyzw, r19.xyzw);
              r22.x = r16.y;
              r22.y = r17.y;
              r22.z = r18.y;
              r22.w = r21.y;
              r19.y = dot(r6.xyzw, r22.xyzw);
              r21.x = r16.z;
              r21.y = r17.z;
              r21.z = r18.z;
              r19.z = dot(r6.xyzw, r21.xyzw);
              ...
              r18.w = samp0[]..swiz;
                ...
                r14.x = 1 + -r12.w;
                r17.xyz = r14.xxx * r9.xyz;
                r9.xyz = r16.xyz * r12.www + r17.xyz;
                r15.z = r13.y;
                r16.xyz = r15.xyz * r14.xxx;
                r15.xyz = r25.xyz * r12.www + r16.xyz;
                r14.w = r14.x * r13.w;
                r13.z = r13.z * r14.x + r12.w;
                r13.w = r11.w * r12.w + r14.w;
                r13.y = r15.z;
              }
            }
          }
  ...
  if (r5.y != 0) {
    ...
    r8.w = r3.w;
    while (true) {
      r10.z = cmp((uint)r8.w >= (uint)r2.w);
      if (r10.z != 0) break;
      r8.z = (uint)r8.w >> 5;
      r9.xyz = (int3)r7.xyz + (int3)r8.xyz;
      r8.z = visibleDecals.Load(r9.xyzw).x;
      r9.x = cmp((int)r3.w == (int)r8.w);
      bitmask.y = ((~(-1 << r4.w)) << 0) & 0xffffffff;  r9.y = (((uint)0 << 0) & bitmask.y) | ((uint)r8.z & ~bitmask.y);
      r8.z = r9.x ? r9.y : r8.z;
      ...
      while (true) {
        ...
        r21.y = samp0[]..swiz;
          ...
          r22.z = samp0[]..swiz;
            ...
            r11.w = rsqrt(r11.w);
            r24.xyz = r23.xyz * r11.www;
            r11.w = dot(r24.xyz, v3.xyz);
            r11.w = cmp(r11.w >= 0.5);
            if (r11.w != 0) {
            // Known bad code for instruction (needs manual fix):
            ...
            r25.w = samp0[]..swiz;
              r23.w = r25.x;
              r23.x = dot(r6.xyzw, r23.xyzw);
              r26.x = r20.y;
              r26.y = r21.y;
              r26.z = r22.y;
              r26.w = r25.y;
              r23.y = dot(r6.xyzw, r26.xyzw);
              r25.x = r20.z;
              r25.y = r21.z;
              r25.z = r22.z;
              r23.z = dot(r6.xyzw, r25.xyzw);
              ...
              r22.w = samp0[]..swiz;
                ...
                if (r28.x != 0) {
                  if (4 == 0) r11.w = 0; else if (4+24 < 32) {                   r11.w = (uint)r21.w << (32-(4 + 24)); r11.w = (uint)r11.w >> (32-4);                  } else r11.w = (uint)r21.w >> 24;
                  r11.w = 1 << (int)r11.w;
                  r12.w = (uint)r21.w >> 28;
                  r12.w = 1 << (int)r12.w;
                  r13.w = cmp((int)r28.x == 4);
                  if (r13.w != 0) {
                    r13.w = (int)r21.w & 4095;
                    if (12 == 0) r14.w = 0; else if (12+12 < 32) {                     r14.w = (uint)r21.w << (32-(12 + 12)); r14.w = (uint)r14.w >> (32-12);                    } else r14.w = (uint)r21.w >> 12;
                    r15.w = (int)r22.w & 1023;
                    r29.xz = (uint2)r11.ww;
                    r29.y = (uint)r12.w;
                ...
                r12.w = cmp(r21.x != 1.000000);
                r13.w = r11.w + r20.w;
                r13.w = saturate(r13.w * r21.x + -r21.x);
                r11.w = r12.w ? r13.w : r11.w;
                if (r28.y != 0) {
                  if (4 == 0) r12.w = 0; else if (4+24 < 32) {                   r12.w = (uint)r22.y << (32-(4 + 24)); r12.w = (uint)r12.w >> (32-4);                  } else r12.w = (uint)r22.y >> 24;
                  r12.w = 1 << (int)r12.w;
                  r13.w = (uint)r22.y >> 28;
                  r13.w = 1 << (int)r13.w;
                  r14.w = cmp((int)r28.y == 2);
                  if (r14.w != 0) {
                    ...
                    r14.w = materialTexMask.SampleGrad(samplerLinearClamp_s, r30.xyz, r28.x, r29.x).x;
                  } else {
                    r15.w = cmp((int)r28.y == 4);
                    if (r15.w != 0) {
                      ...
                      r14.w = materialTexBC7.SampleGrad(samplerLinearClamp_s, r29.xyz, r30.x, r28.x).x;
                    } else {
                      r15.w = (int)r22.y & 4095;
                      if (12 == 0) r21.x = 0; else if (12+12 < 32) {                       r21.x = (uint)r22.y << (32-(12 + 12)); r21.x = (uint)r21.x >> (32-12);                      } else r21.x = (uint)r22.y >> 12;
                      if (10 == 0) r21.w = 0; else if (10+20 < 32) {                       r21.w = (uint)r22.w << (32-(10 + 20)); r21.w = (uint)r21.w >> (32-10);                      } else r21.w = (uint)r22.w >> 20;
                      ...
                      r28.xyz = r31.xyz * r28.xyz;
                      r14.w = materialTexBC3.SampleGrad(samplerLinearClamp_s, r29.xyz, r30.x, r28.x).x;
                    }
                  }
                  r28.xyz = r14.www * float3(0.959999979,0.959999979,0.959999979) + float3(0.0399999991,0.0399999991,0.0399999991);
                ...
                if (r21.y != 0) {
                  ...
                  r14.w = rsqrt(r14.w);
                  r21.xyz = r26.xyz * r14.www;
                  r14.w = dot(-r25.xyz, -r25.xyz);
                  r14.w = rsqrt(r14.w);
                  r22.xyz = -r25.xyz * r14.www;
                  r23.xyz = r24.xyz * r1.zzz;
                  ...
                  r21.xyz = r23.xyz * r12.www + r21.xyz;
                ...
                r12.w = 1 + -r11.w;
                r21.xyz = r17.xyz * r12.www;
                r17.xyz = r20.xyz * r11.www + r21.xyz;
                r20.xyz = r19.xyz * r12.www;
                r19.xyz = r28.xyz * r11.www + r20.xyz;
                r13.w = r12.w * r9.z;
  ...
  r1.z = 1 + -r10.x;
  r3.xyz = colorTint.xyz * r1.zzz + r5.xzw;
  r0.z = r0.z * r1.z + r10.x;
  r1.xyw = r1.xyw * r1.zzz + r11.xyz;
  r2.z = dot(r1.xyw, r1.xyw);
  r2.z = rsqrt(r2.z);
  r4.xyz = r2.zzz * r1.xyw;
  r1.y = r0.x * r1.z + r10.y;
  r5.xyz = r1.zzz * float3(0.0799999982,0.0799999982,0.0799999982) + r12.xyz;
  r0.x = dot(-v6.xyz, -v6.xyz);
  r0.x = rsqrt(r0.x);
  r6.xyz = -v6.xyz * r0.xxx;
  ...
  r1.w = r1.w + r1.w;
  r11.xyz = r4.xyz * -r1.www + -r6.xyz;
  r1.w = 17 * r1.y;
  r1.w = exp2(r1.w);
  r1.w = 2 + r1.w;
  r1.w = 2 / r1.w;
  r2.z = sqrt(r1.w);
  r7.zw = float2(1,1) + -r1.yx;
  r2.w = 5 * r7.z;
  r3.w = r7.z * 5 + -2.5;
  r3.w = saturate(0.400000006 * r3.w);
  r3.w = 100 * r3.w;
  r9.yz = -r7.zz * float2(10,5) + float2(6.85740995,7.08500004);
  r5.w = exp2(r9.y);
  r5.w = r5.w * r1.x;
  r5.w = 9.1368103 * r5.w;
  r6.w = r2.w * r7.z;
  r6.w = -r6.w * 2.0159049 + r9.z;
  r6.w = exp2(r6.w);
  r6.w = r6.w * r1.x;
      ...
      if (r15.w != 0) {
        ...
        if (r9.w != 0) {
          ...
          r35.w = samp0[]..swiz;
            ...
            r16.z = -r16.z * r16.w + 1;
            r16.z = r29.y * r16.z;
            r2.y = r18.z ? r16.z : r18.w;
            r29.xy = r17.ww ? r29.xy : r2.xy;
            r15.w = (int)r15.w + 1;
            r15.x = r17.z;
          }
  ...
  if (r0.w == 0) {
    ...
    while (true) {
      ...
      bitmask.y = ((~(-1 << r2.y)) << 0) & 0xffffffff;  r10.y = (((uint)0 << 0) & bitmask.y) | ((uint)r9.z & ~bitmask.y);
    ...
    if (r6.w != 0) {
      ...
      r8.w = 0;
      while (true) {
        r10.y = cmp((uint)r8.w >= (uint)r0.w);
        if (r10.y != 0) break;
        r13.z = (uint)r8.w >> 5;
        r14.xyz = (int3)r12.xyz + (int3)r13.xyz;
        r10.y = visibleProbes.Load(r14.xyzw).x;
        r10.z = cmp((int)r2.x == (int)r8.w);
        if (r2.y == 0) r10.w = 0; else if (r2.y+0 < 32) {         r10.w = (uint)r10.y << (32-(r2.y + 0)); r10.w = (uint)r10.w >> (32-r2.y);        } else r10.w = (uint)r10.y >> 0;
    ...
    if (r2.x != 0) {
      ...
      r19.xyz = r22.xyz * r0.www + r9.yzw;
      r11.w = 0;
      r9.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r11.xyzw, r2.w).xyz;
      r0.w = sunConstants.globalProbeExposure * r2.x + -r2.y;
      r0.w = r1.y * r0.w + r2.y;
  ...
  r13.xyz = r19.xyz * r0.yyy;
  r2.xy = r1.xy * float2(0.984375,0.984375) + float2(0.0078125,0.0078125);
  r2.xy = gEnvBRDFGlass.SampleLevel(samplerLinear_s, r2.xy, 0).xy;
  r9.yzw = r20.xyz * r0.www;
  r14.xyz = r9.zwy * r2.xxx;
  r2.xyw = r9.yzw * r2.yyy;
  r0.y = sqrt(r2.z);
  r0.y = r0.y * 0.5 + 0.5;
  r0.y = r0.y * r0.y;
  r0.w = 0.5 * r0.y;
  ...
  r1.y = r1.x * r0.y + r0.w;
  r0.yw = r1.yy * r0.yw;
  r1.y = dot(r4.xyz, sunConstants.wldDir.xyz);
  r3.w = saturate(r1.y);
  r4.w = cmp(0 >= r3.w);
  if (r4.w != 0) {
    r5.w = 0;
  ...
  if (r4.w == 0) {
    ...
    r4.w = -sunConstants.splitDepthOffset + r9.w;
    ...
    if (r6.w != 0) {
      ...
      while (true) {
        ...
        r7.z = sunConstants.splitPinTransform[r8.w].z * r10.y;
        r8.w = cmp(r7.z < 1);
        if (r8.w != 0) {
          break;
        }
    ...
    if (r8.w == 0) {
      if (enableDitheredShadow == 0) {
        ...
        r15.z = r8.w + r6.w;
        r8.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r15.xyz, r4.w).x;
      ...
      if (enableDitheredShadow != 0) {
        ...
        r9.yz = -sunConstants.splitPinTransform[r6.w].xy + r9.yz;
        r9.yz = sunConstants.splitPinTransform[r6.w].zz * r9.yz;
        ...
        while (true) {
          ...
          r16.z = (uint)r11.w;
          r11.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r4.w).x;
  ...
  if (r4.w != 0) {
    r4.w = cmp(0 < r5.w);
    if (r4.w != 0) {
      r4.w = sunConstants.specScale * r1.w;
      r4.w = r4.w * r3.w;
      ...
      r18.z = samp0[]..swiz;
      r18.w = samp0[]..swiz;
        r8.w = abs(r1.y) * -0.200000003 + 0.400000006;
        ...
        r16.y = samp0[]..swiz;
          ...
          if (enableDitheredShadow != 0) {
            ...
            r15.z = (uint)r8.w;
            r10.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r15.xyz, r6.w).x;
          }
          r6.w = r10.y * r10.y;
          r6.w = r6.w * r10.y;
        } else {
      ...
      r6.w = r6.w * r5.w;
      r1.y = cmp(0 < r1.y);
      r15.xyz = r6.www * r9.yzw + r13.xyz;
      r10.yzw = -v6.xyz * r0.xxx + sunConstants.wldDir.xyz;
      r0.x = dot(r10.yzw, r10.yzw);
      r0.x = rsqrt(r0.x);
      r10.yzw = r10.yzw * r0.xxx;
      r0.x = dot(r10.yzw, r6.xyz);
      r6.w = dot(r4.xyz, r10.yzw);
      r7.z = abs(r6.w) * r1.w + -abs(r6.w);
      ...
      r3.w = r5.w * r3.w;
      r3.w = 0.25 * r3.w;
      r10.yzw = r3.www * r9.yzw + r2.xyw;
      r0.x = saturate(1 + -r0.x);
      r0.x = log2(r0.x);
      r0.x = 3.4000001 * r0.x;
      r0.x = exp2(r0.x);
      r0.x = r3.w * r0.x;
      r16.xyz = r0.xxx * r9.zwy + r14.xyz;
      r15.w = r16.z;
      r13.w = r14.z;
      r13.xyzw = r1.yyyy ? r15.xyzw : r13.xyzw;
      r16.zw = r10.yz;
      r14.zw = r2.xy;
      r15.xyzw = r1.yyyy ? r16.xyzw : r14.xyzw;
      r2.w = r1.y ? r10.w : r2.w;
      r14.z = r13.w;
      r14.xy = r15.xy;
      r2.xy = r15.zw;
    }
        ...
        r37.w = samp0[]..swiz;
          ...
          switch (r8.w) {
            ...
            if (r16.w != 0) {
              ...
              if (r16.w != 0) {
                ...
                if (r16.w != 0) {
                  ...
                  r16.z = abs(r14.w) * r1.w + -abs(r14.w);
                  r14.w = abs(r14.w) * r16.z + 1;
                  r16.z = r11.w * r0.y + r0.w;
                  r14.w = r14.w * r14.w;
                  r14.w = r14.w * r16.z;
                  r14.w = rcp(r14.w);
                  r11.w = r11.w * r16.w;
            ...
            r39.w = samp0[]..swiz;
              ...
              r44.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r16.z, r7.z, l(236), t12.xxxx
              r16.z = samp0[]..swiz;
              ...
              if (r13.w != 0) {
                  ...
                  r39.y = samp0[]..swiz;
                    ...
                    if (r5.w != 0) {
                      ...
                      while (true) {
                        ...
                        r19.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r31.xyz, r7.z).x;
                        r16.z = r19.x * 0.125 + r16.z;
                        r16.w = (int)r16.w + 1;
                      }
                    } else {
                      r22.z = (uint)r13.w;
                      r16.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r22.xyz, r7.z).x;
                    }
                    r7.z = r16.z * r16.z;
                    r7.z = r7.z * r16.z;
                  } else {
                ...
                if (r13.w != 0) {
                  ...
                  r16.w = abs(r14.w) * r1.w + -abs(r14.w);
                  r14.w = abs(r14.w) * r16.w + 1;
                  r12.w = r12.w * r0.y + r0.w;
                  r14.w = r14.w * r14.w;
                  r12.w = r14.w * r12.w;
                  r12.w = rcp(r12.w);
                  r12.w = r12.w * r13.w;
                  r7.z = r12.w * r7.z;
                  r7.z = 0.25 * r7.z;
                  r20.xyz = r7.zzz * r21.xyw + r30.xyz;
                  r8.w = saturate(1 + -r8.w);
                  r8.w = log2(r8.w);
                  r8.w = 3.4000001 * r8.w;
                  r8.w = exp2(r8.w);
                  r7.z = r8.w * r7.z;
                  r21.xyw = r7.zzz * r21.xyw + r17.xyz;
  ...
  r0.xyw = float3(1,1,1) + -r5.xyz;
  r0.xyw = r28.xyz * r0.xyw;
  r0.xyw = r29.xyz * r5.xyz + r0.xyw;
  r0.xyw = r9.yzw * r3.xyz + r0.xyw;
  r1.x = log2(r7.w);
  r1.x = 3.4000001 * r1.x;
  r1.x = exp2(r1.x);
  r1.y = 1 + -r0.z;
  ...
  if (r0.z != 0) {
    ...
    r0.z = fogConstants.heightFalloff * v6.z;
