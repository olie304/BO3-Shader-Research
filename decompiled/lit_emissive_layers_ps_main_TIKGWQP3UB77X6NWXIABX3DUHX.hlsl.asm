...
utof r6.xy, r8.xyxx
dp2 r2.w, r6.yxyy, l(0.06711056, 0.00583715, 0.000000, 0.000000)
frc r2.w, r2.w
mul r2.w, r2.w, l(52.982918)
frc r2.w, r2.w
mad r2.w, r2.w, l(6.28318548), cb1[70].w
sincos r7.x, r8.x, r2.w
dp2 r2.w, r6.xyxx, l(0.06711056, 0.00583715, 0.000000, 0.000000)
frc r2.w, r2.w
mul r2.w, r2.w, l(52.982918)
frc r2.w, r2.w
mad r2.w, r2.w, l(6.28318548), cb1[70].w
...
add r2.w, r2.w, r2.w
mad r13.xyz, r4.xyzx, -r2.wwww, -r5.xyzx
...
loop 
  ...
  dp3 r14.w, r36.xyzx, r10.yzwy
  add_sat r14.w, r36.w, r14.w
  dp3 r15.x, r37.xyzx, r10.yzwy
  add_sat r15.x, r37.w, r15.x
  mul r14.w, r14.w, r15.x
  dp3 r15.x, r38.xyzx, r10.yzwy
  add_sat r15.x, r38.w, r15.x
  mul r14.w, r14.w, r15.x
  dp3 r15.x, r39.xyzx, r10.yzwy
  add_sat r15.x, r39.w, r15.x
  mul r14.w, r14.w, r15.x
  dp3 r15.x, r40.xyzx, r10.yzwy
  add_sat r15.x, r40.w, r15.x
  mul r14.w, r14.w, r15.x
  dp3 r15.x, r41.xyzx, r10.yzwy
  ...
  dp3 r30.x, r10.yzwy, r23.xyzx
  dp3 r30.y, r10.yzwy, r32.xyzx
  dp3 r30.z, r10.yzwy, r25.xyzx
    ...
    if_nz r17.z
      ...
      if_nz r12.w
        ...
        loop 
          ...
          dp3 r18.z, r33.xyzx, r10.yzwy
          add_sat r18.z, r33.w, r18.z
          mul r17.w, r17.w, r18.z
          dp3 r18.z, r34.xyzx, r10.yzwy
          add_sat r18.z, r34.w, r18.z
          mul r17.w, r17.w, r18.z
          dp3 r18.z, r35.xyzx, r10.yzwy
          add_sat r18.z, r35.w, r18.z
          mul r17.w, r17.w, r18.z
          dp3 r18.z, r36.xyzx, r10.yzwy
          add_sat r18.z, r36.w, r18.z
          mul r17.w, r17.w, r18.z
          dp3 r18.z, r37.xyzx, r10.yzwy
...
if_z r7.z
        ...
        if_nz r18.w
          ...
          if_nz r18.z
            ...
            if_nz r18.z
              ...
              sqrt r17.w, r17.w
              mad r17.w, r5.w, l(5.000000), r17.w
  ...
  if_nz r6.z
    ...
    mad r21.xyz, r23.xyzx, r5.wwww, r10.yzwy
    mov r13.w, l(0)
    sample_l_indexable(texturecubearray)(float,float,float,float) r10.yzw, r13.xyzw, t8.wxyz, s2, r6.y
    mad r5.w, cb2[19].x, r6.z, -r4.w
...
if_z r7.w
  ...
  if_nz r10.y
    ...
    loop 
      ...
      breakc_nz r10.w
      ftou r10.w, r10.y
      add r16.xy, r9.yzyy, -cb2[r10.w + 20].xyxx
      max r12.w, |r16.y|, |r16.x|
      mul r10.z, r12.w, cb2[r10.w + 20].z
  ...
  if_nz r10.w
    ...
    if_z r16.w
      ...
      if_z r12.w
        ...
        mad r16.x, r9.y, r16.y, r16.x
        mad r13.w, r9.z, r13.w, r16.x
  ...
  if_z r10.w
    ...
    if_nz cb2[58].y
      ...
      loop 
        uge r13.w, r12.w, l(8)
        breakc_nz r13.w
        ult r13.w, r10.z, r12.w
        movc r17.zw, r13.wwww, r9.yyyz, r17.xxxy
        movc r16.w, r13.w, cb2[r10.y + 20].w, cb2[r9.w + 20].w
        movc r13.w, r13.w, r10.y, r9.w
...
if_nz r7.w
  ...
  if_nz r7.w
    ...
    if_nz cb2[23].x
      mov r11.w, l(1.000000)
      dp4 r9.y, cb2[24].xyzw, r11.xyzw
      dp4 r9.z, cb2[25].xyzw, r11.xyzw
      frc r11.xy, r9.yzyy
      ...
      if_z r10.w
        ...
        if_nz cb2[58].y
          ...
          loop 
            ige r13.w, r12.w, l(8)
            breakc_nz r13.w
            dp2 r18.x, icb[r12.w + 0].yxyy, r11.xyxx
            dp2 r18.y, icb[r12.w + 0].yxyy, r11.yzyy
            mad r17.xy, r18.xyxx, r10.zzzz, r16.xyxx
            sample_c_lz_indexable(texture2darray)(float,float,float,float) r13.w, r17.xyzx, t9.xxxx, s13, r10.y
    ...
    mad r10.yzw, r7.zzzz, r9.yyzw, r6.yyzw
    add_sat r0.z, -r0.z, l(1.000000)
    mul r7.w, r0.z, r0.z
    mul r7.w, r7.w, r7.w
    mul r0.z, r0.z, r7.w
    mul r0.z, r0.z, r7.z
    mad r16.xyz, r0.zzzz, r9.zwyz, r15.xyzx
    mov r11.w, r16.z
    mov r14.w, r15.z
    movc r14.xyzw, r5.wwww, r11.xyzw, r14.xyzw
    mov r16.zw, r10.yyyz
    mov r15.zw, r6.yyyz
    movc r11.xyzw, r5.wwww, r16.xyzw, r15.xyzw
    movc r6.w, r5.w, r10.w, r6.w
    mov r15.z, r14.w
    mov r15.xy, r11.xyxx
    mov r6.yz, r11.zzwz
  endif 
            ...
            if_nz r26.w
              ...
              if_nz r26.w
                ...
                loop 
                  ige r30.w, r29.w, l(8)
                  breakc_nz r30.w
                  dp2 r43.y, icb[r29.w + 0].yxyy, r11.xyxx
                  dp2 r43.z, icb[r29.w + 0].yxyy, r11.yzyy
              ...
              if_nz r26.w
                ...
                if_nz r15.w
                  ...
                  mad r18.xyz, r4.xyzx, r27.wwww, v7.xyzx
                ...
                mad r14.w, -r25.w, r5.w, l(1.000000)
          ...
          if_nz r18.x
            ...
            if_nz r18.x
              ...
              if_nz r18.x
                ...
                mad r21.xyz, r4.xyzx, r18.xxxx, v7.xyzx
                ...
                if_nz r20.y
                  ...
                  if_nz r9.z
                    ...
                    loop 
                      ...
                      sample_c_lz_indexable(texture2darray)(float,float,float,float) r24.w, r33.xyzx, t9.xxxx, s13, r12.w
                      mad r20.x, r24.w, l(0.125000), r20.x
                      iadd r20.y, r20.y, l(1)
                    endloop 
                  else 
                    utof r21.z, r18.x
                    sample_c_lz_indexable(texture2darray)(float,float,float,float) r20.x, r21.xyzx, t9.xxxx, s13, r12.w
                  endif 
...
movc r1.xyz, cb0[19].yyyy, r3.xyzx, r1.xyzx
