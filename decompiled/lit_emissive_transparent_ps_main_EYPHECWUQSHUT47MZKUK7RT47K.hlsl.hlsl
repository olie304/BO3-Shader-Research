...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  if (r2.z != 0) {
    ...
    r4.y = colorMap.CalculateLevelOfDetail(colorSampler_s, w1.xy);
    r4.x = cmp(r4.x < r4.y);
    r4.y = cmp(0 < r4.y);
...
r2.w = samp0[]..swiz;
  ...
  r1.x = rsqrt(r1.x);
  r8.xyz = -v6.xyz * r1.xxx;
  r3.x = saturate(dot(r8.xyz, r3.yzw));
  ...
  r6.x = saturate(dot(r2.xyz, r8.xyz));
  r4.w = dot(-r8.xyz, r2.xyz);
  r4.w = r4.w + r4.w;
  r12.xyz = r2.xyz * -r4.www + -r8.xyz;
  r4.w = 17 * r6.y;
  r4.w = exp2(r4.w);
  r4.w = 2 + r4.w;
  r4.w = 2 / r4.w;
  ...
  if (r1.z == 0) {
    ...
    if (r5.x != 0) {
      ...
      r1.z = sunConstants.globalProbeExposure * r5.x + -r2.w;
      r1.z = r6.y * r1.z + r2.w;
