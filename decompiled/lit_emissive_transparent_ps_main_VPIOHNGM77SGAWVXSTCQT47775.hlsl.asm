...
if_nz r2.z
  ...
  mul r3.y, r2.w, cb1[69].w
  ge r3.y, r3.y, -r3.y
  movc r3.y, r3.y, r2.w, -r2.w
  ...
  mul r3.y, r2.z, cb0[12].w
  ge r3.y, r3.y, -r3.y
  movc r3.y, r3.y, cb0[12].w, -cb0[12].w
  div r4.w, l(1.000000, 1.000000, 1.000000, 1.000000), r3.y
  mul r2.z, r2.z, r4.w
  frc r2.z, r2.z
  mul r2.z, r2.z, r3.y
  ...
  mad r3.y, cb0[13].z, cb1[69].w, l(1.000000)
  mul r3.y, r3.y, cb0[13].y
  mul r3.y, r3.y, l(0.01745329)
  sincos r9.x, r10.x, r3.y
  mov r10.y, r10.x
  mov r10.z, r9.x
  ...
  mad r2.zw, r2.zzzw, cb0[14].zzzw, r11.xxxy
  mul r3.y, cb0[16].x, cb1[69].w
  sincos null, r3.y, r3.y
  mad r3.y, r3.y, l(0.500000), l(0.500000)
  add r3.y, -r3.y, l(1.000000)
  add r4.w, -cb0[15].z, cb0[15].w
  mad r3.y, r3.y, r4.w, cb0[15].z
...
frc r2.w, r2.w
mad r3.y, cb1[69].w, cb0[17].z, r2.w
mov r3.x, cb0[17].x
sample_l_indexable(texture2d)(float,float,float,float) r2.w, r3.xyxx, t26.yzwx, s7, l(0.000000)
log r2.w, |r2.w|
mul r2.w, r2.w, cb0[18].z
exp r2.w, r2.w
add r3.x, -cb0[18].x, cb0[18].y
mad r2.w, r2.w, r3.x, cb0[18].x
mul r4.xyz, r2.wwww, r4.xyzx
...
add r3.y, r3.y, r3.y
mad r12.xyz, r5.xyzx, -r3.yyyy, -r9.xyzx
...
mul r9.w, r3.w, r6.z
mad r9.w, -r9.w, l(2.015905), r11.z
exp r9.w, r9.w
mul r9.w, r2.x, r9.w
...
if_nz r6.w
  ...
  mad r3.w, cb2[19].x, r6.w, -r5.w
  mad r3.w, r2.y, r3.w, r5.w
...
mad r6.zw, r2.xxxy, l(0.000000, 0.000000, 0.984375, 0.984375), l(0.000000, 0.000000, 0.00781250, 0.00781250)
sample_l_indexable(texture2d)(float,float,float,float) r6.zw, r6.zwzz, t5.zwxy, s2, l(0.000000)
mul r11.yzw, r3.wwww, r13.xxyz
mul r13.xyz, r6.zzzz, r11.zwyz
mul r11.yzw, r6.wwww, r11.yyzw
sqrt r1.w, r3.z
...
if_nz r6.z
  ...
  if_nz r6.z
    ...
    if_nz r8.w
      ...
      mad r19.xyz, r5.xyzx, r9.wwww, v7.xyzx
    ...
    mad r16.xyz, r5.wwww, r7.xyzx, r11.yzwy
    add_sat r2.z, -r2.z, l(1.000000)
    mul r6.z, r2.z, r2.z
    mul r6.z, r6.z, r6.z
    mul r2.z, r2.z, r6.z
    mul r2.z, r2.z, r5.w
    mad r7.xyz, r2.zzzz, r7.yzxy, r13.xyzx
    mov r15.w, r7.z
    mov r14.w, r13.z
    movc r14.xyzw, r3.wwww, r15.xyzw, r14.xyzw
    mov r7.zw, r16.xxxy
    mov r13.zw, r11.yyyz
    movc r7.xyzw, r3.wwww, r7.xyzw, r13.xyzw
          ...
          if_nz r20.w
            ...
            if_nz r20.w
              ...
              if_nz r20.w
                ...
                mad r42.xyz, r5.xyzx, r20.wwww, v7.xyzx
              ...
              if_nz r20.w
                ...
                if_nz r13.w
                  ...
                  mad r18.xyz, r5.xyzx, r24.wwww, v7.xyzx
                  ...
                  if_z r18.y
                    ...
                    if_nz r6.w
                      ...
                      loop 
                        ige r24.w, r18.z, l(8)
                        breakc_nz r24.w
                        dp2 r43.x, icb[r18.z + 0].yxyy, r7.xwxx
                  ...
                  if_nz r13.w
                    ...
                    mad r19.xyz, r5.xyzx, r18.xxxx, v7.xyzx
          ...
          if_nz r14.w
            ...
            if_nz r14.w
              ...
              if_nz r14.w
                ...
                mad r21.xyz, r5.xyzx, r14.wwww, v7.xyzx
...
ret 
// Approximately 2320 instruction slots used
