...
r3.w = samp0[]..swiz;
  ...
  r12.z = (uint)r2.x << 4;
  r2.x = (int)r8.z & -32;
  r2.y = (int)-r2.x + (int)r8.z;
  r2.z = numRefProbes & -32;
  r8.w = (int)-r2.z + numRefProbes;
  r13.xy = float2(0,0);
  r14.w = 0;
  r15.yz = float2(0,1);
  r16.xy = float2(0,0);
  ...
  while (true) {
    ...
    bitmask.w = ((~(-1 << r2.y)) << 0) & 0xffffffff;  r10.w = (((uint)0 << 0) & bitmask.w) | ((uint)r10.y & ~bitmask.w);
  ...
  if (r2.z != 0) {
    ...
    while (true) {
      ...
      if (r2.y == 0) r13.z = 0; else if (r2.y+0 < 32) {       r13.z = (uint)r9.w << (32-(r2.y + 0)); r13.z = (uint)r13.z >> (32-r2.y);      } else r13.z = (uint)r9.w >> 0;
  ...
  if (r7.z != 0) {
    ...
    if (r7.z != 0) {
      ...
      r7.y = r7.w * r7.y;
      r7.y = 0.25 * r7.y;
      r16.xyz = r7.yyy * r10.yzw + r2.xyz;
      r0.z = saturate(1 + -r0.z);
      r7.z = r0.z * r0.z;
      r7.z = r7.z * r7.z;
      r0.z = r7.z * r0.z;
      r0.z = r7.y * r0.z;
      r17.xyz = r0.zzz * r10.zwy + r14.xyz;
      r15.w = r17.z;
      r13.w = r14.z;
