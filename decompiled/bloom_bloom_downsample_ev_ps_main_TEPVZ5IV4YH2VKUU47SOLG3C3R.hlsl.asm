...
//   float4 postFxBloom25;              // Offset: 1680 Size:    16
...
dcl_constantbuffer CB8[106], immediateIndexed
...
mul r0.x, r0.x, l(5.55555534)
log r0.x, r0.x
lt r0.y, r0.x, l(0.000000)
mul r0.xz, r0.xxxx, cb8[105].xxyx
movc r0.x, r0.y, r0.x, r0.z
exp r0.x, r0.x
mul o0.x, r0.x, cb8[105].z
ret 
