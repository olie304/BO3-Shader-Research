...
if_nz r0.y
  ...
  dp3 r5.w, r17.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
  mad r15.xyz, r20.xyzx, r0.xxxx, r17.xyzx
  mov r14.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r17.xyz, r14.xyzw, t8.xyzw, s2, r7.w
  mad r0.x, cb2[19].x, r0.y, -r5.w
  mad r0.x, r2.y, r0.x, r5.w
...
mul r0.x, r6.w, r0.x
mul r16.xyz, r2.zzzz, r15.xyzx
and r17.xyz, r0.wwww, r16.xyzx
...
imul null, r1.w, r13.w, l(15)
ubfe r2.y, l(3), l(24), cb9[r1.w + 1].w
switch r2.y
  case l(4)
  lt r2.y, l(0.000000), cb9[r1.w + 6].y
  mov r19.xy, cb9[r1.w + 5].zwzz
  mov r19.z, cb9[r1.w + 6].x
  mad r13.yzw, -r19.xxyz, l(0.000000, 0.500000, 0.500000, 0.500000), cb9[r1.w + 0].xxyz
  add r20.xyz, -r10.xyzx, r13.yzwy
  dp3 r2.w, r19.xyzx, r20.xyzx
  div_sat r4.z, -r2.w, cb9[r1.w + 6].y
  mad r21.xyz, r4.zzzz, r19.xyzx, r13.yzwy
  movc r21.xyz, r2.yyyy, r21.xyzx, cb9[r1.w + 0].xyzx
  ...
  mov_sat r7.w, r6.w
  movc r7.w, r0.w, |r6.w|, r7.w
  lt r8.w, l(0.000000), r7.w
  if_nz r8.w
    sqrt r8.w, r5.w
    mul r11.w, cb9[r1.w + 3].x, cb9[r1.w + 3].x
    div r5.w, r11.w, r5.w
    min r5.w, r5.w, l(1.000000)
    mad_sat r21.xy, r8.wwww, cb9[r1.w + 2].xzxx, cb9[r1.w + 2].ywyy
    ...
    if_nz r8.w
      ubfe r8.w, l(3), l(27), cb9[r1.w + 1].w
      ine r8.w, r8.w, l(1)
      if_nz r8.w
        utof r21.xy, r1.yxyy
        dp2 r8.w, r21.xyxx, l(0.06711056, 0.00583715, 0.000000, 0.000000)
        frc r8.w, r8.w
        mul r8.w, r8.w, l(52.982918)
        frc r8.w, r8.w
        mad r8.w, r8.w, l(6.28318548), cb1[70].w
        sincos r21.x, r22.x, r8.w
        mad r8.w, |r6.w|, l(-0.200000), l(0.400000)
        lt r11.w, r6.w, l(0.000000)
        and r11.w, r0.w, r11.w
        movc r8.w, r11.w, -r8.w, r8.w
        mad r21.yzw, r11.xxyz, r8.wwww, r10.xxyz
        add r21.yzw, r21.yyzw, -cb9[r1.w + 4].yyzw
        max r8.w, |r21.w|, |r21.z|
        max r8.w, r8.w, |r21.y|
        div r8.w, cb9[r1.w + 5].x, r8.w
        add r8.w, r8.w, cb9[r1.w + 5].y
        dp3 r11.w, r21.yzwy, r21.yzwy
        rsq r11.w, r11.w
        max r8.w, r8.w, l(0.00006104)
        and r12.w, l(0x0000ffff), cb9[r1.w + 1].w
        mov r23.x, -r3.x
        utof r24.w, r12.w
        mov r23.y, r13.x
        mov r23.z, r3.x
        ...
        loop 
          ige r15.w, r14.w, l(8)
          breakc_nz r15.w
          dp2 r22.y, icb[r14.w + 0].yxyy, r23.xyxx
          dp2 r22.z, icb[r14.w + 0].yxyy, r23.yzyy
          mul r25.yz, r22.yyzy, cb9[r1.w + 3].yyyy
          mul r25.x, r22.x, r25.y
          mul r25.w, r21.x, r25.y
          mad r24.xyz, r21.yzwy, r11.wwww, r25.xzwx
          sample_c_lz_indexable(texturecubearray)(float,float,float,float) r15.w, r24.xyzw, t10.xxxx, s13, r8.w
      ...
      lt r8.w, l(0.000000), r5.w
      if_nz r8.w
        mul r8.w, r0.z, cb9[r1.w + 1].z
        mul r8.w, r8.w, l(0.250000)
        dp3 r11.w, r19.xyzx, r14.xyzx
        dp3 r12.w, r14.xyzx, r20.xyzx
        mad r14.x, -r11.w, r11.w, cb9[r1.w + 6].y
        mad r2.w, r11.w, r12.w, -r2.w
        div_sat r2.w, r2.w, r14.x
        div r11.w, r14.x, cb9[r1.w + 6].y
        mul r11.w, r11.w, l(10.000000)
        min r11.w, r11.w, l(1.000000)
        add r2.w, -r4.z, r2.w
        mad r2.w, r11.w, r2.w, r4.z
        mad r13.yzw, r2.wwww, r19.xxyz, r13.yyzw
        movc r13.yzw, r2.yyyy, r13.yyzw, cb9[r1.w + 0].xxyz
        add r13.yzw, -r10.xxyz, r13.yyzw
        dp3 r2.y, r13.yzwy, r13.yzwy
        rsq r2.y, r2.y
        mul r14.xyz, r2.yyyy, r13.yzwy
        ubfe r2.w, l(4), l(16), cb9[r1.w + 1].w
        ult r4.z, l(0), r2.w
        and r4.z, r9.z, r4.z
        if_nz r4.z
          ...
          if_z r12.w
            ...
            if_z r14.w
              ...
              mul r15.w, r11.w, cb9[r2.w + 10].z
              mad r4.z, cb9[r2.w + 10].y, r11.w, r4.z
              div r4.z, r4.z, r15.w
            endif 
          else 
            mov r14.w, l(-1)
          ...
          if_z r11.w
            ...
            and r11.w, l(0x0000ffff), cb9[r2.w + 1].w
            if_nz cb2[58].y
              mov r19.x, -r3.x
              utof r21.z, r11.w
              mov r19.y, r13.x
              ...
              loop 
                ige r15.w, r14.w, l(8)
                breakc_nz r15.w
                dp2 r22.x, icb[r14.w + 0].yxyy, r19.xyxx
                dp2 r22.y, icb[r14.w + 0].yxyy, r19.yzyy
                mad r21.xy, r22.xyxx, cb9[r2.w + 3].yyyy, r20.xyxx
                sample_c_lz_indexable(texture2darray)(float,float,float,float) r15.w, r21.xyzx, t9.xxxx, s13, r4.z
                mad r12.w, r15.w, l(0.125000), r12.w
                iadd r14.w, r14.w, l(1)
              endloop 
            else 
          ...
          ubfe r2.w, l(4), l(20), cb9[r1.w + 1].w
          ult r4.z, l(0), r2.w
          not r11.w, r9.z
          and r4.z, r4.z, r11.w
          if_nz r4.z
        ...
        mad r2.w, -r7.w, r2.w, l(1.000000)
        mul r2.w, r2.w, r2.w
        mad r2.w, -r2.w, l(0.620000), l(0.620000)
        add r2.w, -r7.w, r2.w
        mad r2.w, r1.z, r2.w, r7.w
        mul r2.w, r5.w, r2.w
        mov r19.x, cb9[r1.w + 0].w
        mov r19.yz, cb9[r1.w + 1].xxyx
        mul r20.xyz, r2.wwww, r19.xyzx
        lt r4.z, l(0.000000), r6.w
        mad r20.xyz, r15.xyzx, r2.zzzz, r20.xyzx
        dp3_sat r6.w, r11.xyzx, r14.xyzx
        mad r13.yzw, r13.yyzw, r2.yyyy, r12.xxyz
        dp3 r2.y, r13.yzwy, r13.yzwy
        rsq r2.y, r2.y
        mul r13.yzw, r2.yyyy, r13.yyzw
        dp3 r2.y, r13.yzwy, r12.xyzx
        dp3 r7.w, r11.xyzx, r13.yzwy
        mad r11.w, |r7.w|, r0.z, -|r7.w|
        mad r7.w, |r7.w|, r11.w, l(1.000000)
        mad r11.w, r6.w, r0.x, r0.y
        mul r7.w, r7.w, r7.w
        mul r7.w, r11.w, r7.w
        rcp r7.w, r7.w
        mul r6.w, r8.w, r6.w
        mul r6.w, r6.w, r7.w
        mul r5.w, r5.w, r6.w
        mad r13.yzw, r5.wwww, r19.xxyz, r9.xxyw
        add_sat r2.y, -r2.y, l(1.000000)
        mul r6.w, r2.y, r2.y
        mul r6.w, r6.w, r6.w
        mul r2.y, r2.y, r6.w
        mul r2.y, r2.y, r5.w
        mad r14.xyz, r2.yyyy, r19.xyzx, r18.xyzx
        mad r19.xyz, r2.wwww, r19.xyzx, r17.xyzx
        and r19.xyz, r0.wwww, r19.xyzx
        movc r16.xyz, r4.zzzz, r20.xyzx, r16.xyzx
        movc r17.xyz, r4.zzzz, r17.xyzx, r19.xyzx
        movc r18.xyz, r4.zzzz, r14.xyzx, r18.xyzx
        movc r9.xyw, r4.zzzz, r13.yzyw, r9.xyxw
      endif 
    endif 
  endif 
  break 
  case l(2)
  add r14.xy, -r10.xyxx, cb9[r1.w + 3].zwzz
  add r14.z, -r10.z, cb9[r1.w + 4].x
  dp3 r2.y, r14.xyzx, r14.xyzx
  rsq r2.y, r2.y
  mul r13.yzw, r2.yyyy, r14.xxyz
  dp3 r2.w, r11.xyzx, r13.yzwy
  mov_sat r4.z, r2.w
  movc r5.w, r0.w, |r2.w|, r4.z
  lt r6.w, l(0.000000), r5.w
  if_nz r6.w
    mov r19.xyz, cb9[r1.w + 7].yzwy
    mov r19.w, cb9[r1.w + 8].x
    ...
    if_nz r7.w
      ...
      add r20.xyz, -r10.xyzx, cb9[r1.w + 0].xyzx
      mul r8.w, cb9[r1.w + 3].x, cb9[r1.w + 3].x
      dp3 r11.w, r20.xyzx, r20.xyzx
      div r8.w, r8.w, r11.w
      min r8.w, r8.w, l(1.000000)
      mad_sat r20.xy, r6.wwww, cb9[r1.w + 2].xzxx, cb9[r1.w + 2].ywyy
      ...
      mul r8.w, r8.w, r20.x
      mul r8.w, r20.y, r8.w
      mov r20.xyz, cb9[r1.w + 4].yzwy
      mov r20.w, cb9[r1.w + 5].x
      dp4 r20.x, r20.xyzw, r10.xyzw
      mov r21.xyz, cb9[r1.w + 5].yzwy
      mov r21.w, cb9[r1.w + 6].x
      dp4 r20.y, r21.xyzw, r10.xyzw
      div r20.xy, r20.xyxx, r6.wwww
      lt r6.w, cb9[r1.w + 10].w, l(0.00048828)
      if_nz r6.w
        mad_sat r21.xy, |r20.xyxx|, cb9[r1.w + 12].xyxx, cb9[r1.w + 12].zwzz
        mul r21.zw, r21.xxxy, r21.xxxy
        mad r21.xy, r21.xyxx, l(-2.000000, -2.000000, 0.000000, 0.000000), l(3.000000, 3.000000, 0.000000, 0.000000)
        mul r21.xy, r21.xyxx, r21.zwzz
        mul r6.w, r21.y, r21.x
      else 
        mul_sat r21.xyzw, |r20.yyxx|, cb9[r1.w + 11].xyzw
        log r21.xyzw, r21.xyzw
        mul r21.xyzw, r21.xyzw, cb9[r1.w + 12].zzzz
        exp r21.xyzw, r21.xyzw
        add r21.xy, r21.zwzz, r21.xyxx
        log r21.xy, r21.xyxx
        mul r21.xy, r21.xyxx, cb9[r1.w + 12].wwww
        exp r21.xy, r21.xyxx
        mul r10.w, r21.x, cb9[r1.w + 12].x
        mad r11.w, cb9[r1.w + 12].y, r21.y, l(-1.000000)
        mad r10.w, cb9[r1.w + 12].y, r21.y, -r10.w
      ...
      mul r7.w, r6.w, r8.w
      and r6.w, l(255), cb9[r1.w + 14].w
      if_nz r6.w
        mov r20.z, l(1.000000)
        dp3 r8.w, cb9[r1.w + 13].xyzx, r20.xyzx
        mov r21.x, cb9[r1.w + 13].w
        mov r21.yz, cb9[r1.w + 14].xxyx
        dp3 r10.w, r21.xyzx, r20.xyzx
        frc r20.x, r8.w
        frc r20.y, r10.w
        iadd r6.w, r6.w, l(-1)
        utof r20.z, r6.w
    ...
    mov r20.x, cb9[r1.w + 0].w
    mov r20.yz, cb9[r1.w + 1].xxyx
    mul r13.yzw, r13.yyzw, r20.xxyz
    lt r6.w, l(0.000000), r7.w
    if_nz r6.w
      ubfe r6.w, l(3), l(27), cb9[r1.w + 1].w
      ine r6.w, r6.w, l(1)
      if_nz r6.w
        ...
        mad r20.xyz, r11.xyzx, r6.wwww, r10.xyzx
        mov r21.xyz, cb9[r1.w + 6].yzwy
        mov r21.w, cb9[r1.w + 7].x
        mov r20.w, l(1.000000)
        dp4 r6.w, r21.xyzw, r20.xyzw
        dp4 r8.w, r19.xyzw, r20.xyzw
        ge r10.w, r8.w, r6.w
        if_nz r10.w
          mov r19.xyz, cb9[r1.w + 4].yzwy
          mov r19.w, cb9[r1.w + 5].x
          ...
          mad r20.x, r19.x, cb9[r1.w + 8].y, cb9[r1.w + 8].z
          mad r20.y, r19.y, cb9[r1.w + 8].w, cb9[r1.w + 9].x
          div r6.w, r6.w, r8.w
          max r6.w, r6.w, l(0.00006104)
          and r8.w, l(0x0000ffff), cb9[r1.w + 1].w
          if_nz cb2[58].y
            mov r19.x, -r3.x
            utof r21.z, r8.w
            mov r19.y, r13.x
            ...
            loop 
              ige r12.w, r11.w, l(8)
              breakc_nz r12.w
              dp2 r22.x, icb[r11.w + 0].yxyy, r19.xyxx
              dp2 r22.y, icb[r11.w + 0].yxyy, r19.yzyy
              mad r21.xy, r22.xyxx, cb9[r1.w + 3].yyyy, r20.xyxx
              sample_c_lz_indexable(texture2darray)(float,float,float,float) r12.w, r21.xyzx, t9.xxxx, s13, r6.w
              mad r10.w, r12.w, l(0.125000), r10.w
              iadd r11.w, r11.w, l(1)
            endloop 
          else 
            utof r20.z, r8.w
            sample_c_lz_indexable(texture2darray)(float,float,float,float) r10.w, r20.xyzx, t9.xxxx, s13, r6.w
          endif 
      ...
      if_nz r7.w
        mul r7.w, r0.z, cb9[r1.w + 1].z
        mul r7.w, r4.z, r7.w
        ubfe r8.w, l(4), l(16), cb9[r1.w + 1].w
        ult r10.w, l(0), r8.w
        ...
        if_nz r10.w
          ...
          ubfe r1.w, l(4), l(20), cb9[r1.w + 1].w
          ult r8.w, l(0), r1.w
          not r9.z, r9.z
          and r8.w, r8.w, r9.z
          if_nz r8.w
            iadd r1.w, r1.w, cb2[0].x
            imad r1.w, r1.w, l(15), l(-15)
            mad r8.w, |r2.w|, l(-0.200000), l(0.400000)
            lt r9.z, r2.w, l(0.000000)
            and r9.z, r0.w, r9.z
            movc r8.w, r9.z, -r8.w, r8.w
            mad r19.xyz, r11.xyzx, r8.wwww, r10.xyzx
            mov r20.xyz, cb9[r1.w + 6].yzwy
            mov r20.w, cb9[r1.w + 7].x
            mov r19.w, l(1.000000)
            dp4 r8.w, r20.xyzw, r19.xyzw
            mov r20.xyz, cb9[r1.w + 7].yzwy
            mov r20.w, cb9[r1.w + 8].x
            dp4 r9.z, r20.xyzw, r19.xyzw
            lt r10.w, r9.z, r8.w
            if_z r10.w
              mov r20.xyz, cb9[r1.w + 4].yzwy
              mov r20.w, cb9[r1.w + 5].x
              ...
              mov r21.w, cb9[r1.w + 6].x
              dp4 r20.y, r21.xyzw, r19.xyzw
              div r19.xy, r20.xyxx, r9.zzzz
              mad r19.xy, r19.xyxx, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
              add r20.x, r19.x, cb9[r1.w + 9].w
              add r20.y, r19.y, cb9[r1.w + 10].x
              mul r19.xy, r20.xyxx, cb9[r1.w + 9].yzyy
              div r19.zw, cb9[r1.w + 3].yyyy, cb9[r1.w + 8].yyyw
              add r20.xy, -r19.zwzz, l(1.000000, 1.000000, 0.000000, 0.000000)
              ge r20.xy, r19.xyxx, r20.xyxx
              ge r19.zw, r19.zzzw, r19.xxxy
              or r19.zw, r19.zzzw, r20.xxxy
              or r11.w, r19.w, r19.z
              if_z r11.w
                mov_sat r19.xy, r19.xyxx
                mad r20.x, r19.x, cb9[r1.w + 8].y, cb9[r1.w + 8].z
                mad r20.y, r19.y, cb9[r1.w + 8].w, cb9[r1.w + 9].x
                mul r12.w, r9.z, cb9[r1.w + 10].z
                mad r8.w, cb9[r1.w + 10].y, r9.z, r8.w
                div r8.w, r8.w, r12.w
              endif 
            else 
              mov r11.w, l(-1)
            ...
            if_z r9.z
              max r8.w, r8.w, l(0.00006104)
              and r9.z, l(0x0000ffff), cb9[r1.w + 1].w
              if_nz cb2[58].y
                mov r19.x, -r3.x
                utof r21.z, r9.z
                mov r19.y, r13.x
                ...
                loop 
                  ige r11.w, r10.w, l(8)
                  breakc_nz r11.w
                  dp2 r22.x, icb[r10.w + 0].yxyy, r19.xyxx
                  dp2 r22.y, icb[r10.w + 0].yxyy, r19.yzyy
                  mad r21.xy, r22.xyxx, cb9[r1.w + 3].yyyy, r20.xyxx
                ...
                utof r20.z, r9.z
                sample_c_lz_indexable(texture2darray)(float,float,float,float) r3.x, r20.xyzx, t9.xxxx, s13, r8.w
              endif 
              mul r1.w, r3.x, r3.x
              mul r1.w, r3.x, r1.w
            else 
        ...
        mad r1.w, -r2.x, l(0.500000), l(1.000000)
        mad r1.w, -r5.w, r1.w, l(1.000000)
        mul r1.w, r1.w, r1.w
        mad r1.w, -r1.w, l(0.620000), l(0.620000)
        add r1.w, -r5.w, r1.w
        mad r1.z, r1.z, r1.w, r5.w
        mul r1.z, r6.w, r1.z
        mul r19.xyz, r13.yzwy, r1.zzzz
        lt r1.w, l(0.000000), r2.w
        mad r2.xzw, r15.xxyz, r2.zzzz, r19.xxyz
        mad r14.xyz, r14.xyzx, r2.yyyy, r12.xyzx
        dp3 r2.y, r14.xyzx, r14.xyzx
        rsq r2.y, r2.y
        mul r14.xyz, r2.yyyy, r14.xyzx
        dp3 r2.y, r14.xyzx, r12.xyzx
        dp3 r3.x, r11.xyzx, r14.xyzx
        mad r0.z, |r3.x|, r0.z, -|r3.x|
        ...
        mad r11.xyz, r0.xxxx, r13.yzwy, r9.xywx
        add_sat r0.y, -r2.y, l(1.000000)
        mul r0.z, r0.y, r0.y
        mul r0.z, r0.z, r0.z
        mul r0.y, r0.z, r0.y
        mul r0.x, r0.y, r0.x
        mad r0.xyz, r0.xxxx, r13.yzwy, r18.xyzx
        mad r12.xyz, r1.zzzz, r13.yzwy, r17.xyzx
        and r12.xyz, r0.wwww, r12.xyzx
        movc r16.xyz, r1.wwww, r2.xzwx, r16.xyzx
        movc r17.xyz, r1.wwww, r17.xyzx, r12.xyzx
        movc r18.xyz, r1.wwww, r0.xyzx, r18.xyzx
        movc r9.xyw, r1.wwww, r11.xyxz, r9.xyxw
      endif 
    endif 
  endif 
  break 
...
mad r0.xyz, r17.xyzx, r2.xyzx, r0.xyzx
...
ret 
// Approximately 1853 instruction slots used
