...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  if (r6.w != 0) {
    ...
    r14.xyz = r21.xyz * r2.www + r12.yzw;
    r13.w = 0;
    r12.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r13.xyzw, r3.w).xyz;
    r2.w = sunConstants.globalProbeExposure * r6.w + -r4.w;
    r2.w = r0.y * r2.w + r4.w;
    r11.yzw = r12.yzw * r2.www + r11.yzw;
  }
  ...
  if (r6.w == 0) {
    ...
    r13.w = samp0[]..swiz;
      ...
      r19.z = samp0[]..swiz;
        r18.y = 0;
        r19.y = 1;
        r17.yzw = r10.www ? r18.xyz : r19.xyz;
      ...
      r19.w = samp0[]..swiz;
        ...
        r17.yzw = r10.www ? r18.xyz : r17.yzw;
        r10.w = (int)r17.w & 0xc0000000;
        if (r10.w == 0) {
          r10.w = (int)-r17.z + 6;
          r18.xy = (uint2)r16.zy >> (uint2)r10.ww;
          ...
          r18.x = (int)r10.w + (int)r17.y;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r18.w, r18.x, l(0), t23.xxxx
        r18.w = samp0[]..swiz;
          r18.yz = (int2)r17.zz + int2(1,2);
          r10.w = (int)-r18.y + 6;
          r19.xy = (uint2)r16.zy >> (uint2)r10.ww;
    ...
    if (r9.w == 0) {
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          r16.w = r13.w ? sunConstants.splitPinTransform[r8.w].w : sunConstants.splitPinTransform[r9.w].w;
          ...
          r18.z = (uint)r13.w;
          r13.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r18.xyz, r6.w).x;
  ...
  if (r6.w != 0) {
    ...
    if (r6.w != 0) {
      ...
      if (sunConstants.sunCookieIndex != 0) {
        ...
        r16.z = (uint)r5.x;
        r5.xyz = gCookieArray.SampleLevel(samplerLinear_s, r16.xyz, 0).xyz;
      ...
      r0.z = r5.w * r0.z;
      r0.z = r4.w * r0.z;
      r5.xyz = r0.zzz * r5.yzx + r15.xyz;
      r16.w = r5.z;
      r14.w = r15.z;
      r14.xyzw = r3.wwww ? r16.xyzw : r14.xyzw;
      r5.zw = r12.yz;
      r15.zw = r11.yz;
      r5.xyzw = r3.wwww ? r5.xyzw : r15.xyzw;
            ...
            if (r16.w != 0) {
              ...
              if (r16.w != 0) {
                ...
                if (r16.w != 0) {
                    ...
                    r10.w = samp0[]..swiz;
                      ...
                      if (r7.w != 0) {
                        ...
                        while (true) {
                          ...
                          if (r21.w != 0) break;
                          r43.x = dot(icb[r19.z+0].yx, r5.xw);
                  ...
                  r15.w = dot(r4.xyz, r39.xyz);
                  r16.z = abs(r15.w) * r2.y + -abs(r15.w);
                  r15.w = abs(r15.w) * r16.z + 1;
                  r16.z = r10.w * r0.y + r2.w;
                  r15.w = r15.w * r15.w;
                  r15.w = r15.w * r16.z;
                  r15.w = rcp(r15.w);
                  r10.w = r10.w * r16.w;
            ...
            r40.w = samp0[]..swiz;
              ...
              if (r14.w != 0) {
                  ...
                  r40.y = samp0[]..swiz;
                    ...
                    if (r7.w != 0) {
                      ...
                      while (true) {
                        ...
                        r19.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r32.xyz, r9.z).x;
                        r16.z = r19.x * 0.125 + r16.z;
                        r16.w = (int)r16.w + 1;
                      }
                    } else {
                      r22.z = (uint)r14.w;
                      r16.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r22.xyz, r9.z).x;
                    }
                    r9.z = r16.z * r16.z;
                    r9.z = r9.z * r16.z;
                  } else {
                ...
                if (r14.w != 0) {
                  ...
                  r15.w = dot(r4.xyz, r20.xyz);
                  r16.w = abs(r15.w) * r2.y + -abs(r15.w);
                  ...
                  r9.z = r13.w * r9.z;
                  r9.z = 0.25 * r9.z;
                  r20.xyz = r9.zzz * r21.xyw + r31.xyz;
                  r9.w = saturate(1 + -r9.w);
                  r13.w = r9.w * r9.w;
                  r13.w = r13.w * r13.w;
                  r9.w = r13.w * r9.w;
                  r9.z = r9.z * r9.w;
                  r21.xyw = r9.zzz * r21.xyw + r30.xyz;
