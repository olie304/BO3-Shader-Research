...
r0.y = samp0[]..swiz;
  ...
  r6.w = 1 + -r2.y;
  r6.w = 5 * r6.w;
  r15.yzw = -globalProbeConstants.data[0].xyz + r5.xyz;
  ...
  r16.yzw = cmp(float3(0,0,0) < r11.xyz);
  r18.xyz = r16.yzw ? float3(0,0,0) : float3(0.5,0.5,0.5);
  r18.w = 0;
  r16.yzw = r18.wwx + r15.yzw;
  r16.yzw = gProbeXArray.SampleLevel(samplerLinearClamp_s, r16.yzw, 0).xyz;
  r19.xyz = r11.xyz * r11.xyz;
  r19.xyz = sunConstants.globalProbeExposure * r19.xyz;
  r20.xyz = r18.wwy + r15.yzw;
  r20.xyz = gProbeYArray.SampleLevel(samplerLinearClamp_s, r20.xyz, 0).xyz;
  r20.xyz = r20.xyz * r19.yyy;
  r16.yzw = r16.yzw * r19.xxx + r20.xyz;
  r15.yzw = r18.wwz + r15.yzw;
  r15.yzw = gProbeZArray.SampleLevel(samplerLinearClamp_s, r15.yzw, 0).xyz;
  r15.yzw = r15.yzw * r19.zzz + r16.yzw;
  r11.w = 0;
  r16.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r11.xyzw, 6).xyz;
  r15.yzw = r16.yzw * r15.yzw;
  r8.w = dot(r15.yzw, float3(0.212599993,0.715200007,0.0722000003));
  r17.w = 0;
  r16.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r17.xyzw, r6.w).xyz;
  ...
  while (true) {
    ...
    switch (r8.w) {
      ...
      r13.z = rsqrt(r12.w);
      r38.xyz = r38.xyz * r13.zzz;
      r13.z = dot(r11.xyz, r38.xyz);
      r13.w = saturate(r13.z);
      r13.w = r0.w ? abs(r13.z) : r13.w;
      r14.w = cmp(0 < r13.w);
      if (r14.w != 0) {
        r14.w = sqrt(r12.w);
        ...
        r12.w = r17.w / r12.w;
        r12.w = min(1, r12.w);
        r38.xy = saturate(r14.ww * lightConstantsCB[r7.w].data[2].xz + lightConstantsCB[r7.w].data[2].yw);
        ...
        if (r14.w != 0) {
          ...
          if (r14.w != 0) {
            ...
            r38.xyz = r11.xyz * r14.www + r5.xyz;
            r38.xyz = -lightConstantsCB[r7.w].data[4].yzw + r38.xyz;
            r14.w = max(abs(r38.y), abs(r38.z));
            r14.w = max(abs(r38.x), r14.w);
            ...
            while (true) {
              ...
              if (r21.w != 0) break;
              r40.y = dot(icb[r20.w+0].yx, r22.xy);
              r40.z = dot(icb[r20.w+0].yx, r22.yz);
              r40.yz = lightConstantsCB[r7.w].data[3].yy * r40.yz;
              r40.x = r40.y * r16.x;
              r40.w = r40.y * r15.x;
              r39.xyz = r38.xyz * r18.www + r40.xzw;
              r21.w = gOmniShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r39.xyzw, r14.w).x;
              r19.w = r21.w * 0.125 + r19.w;
              r20.w = (int)r20.w + 1;
            }
          } else {
            r19.w = 1;
          ...
          if (r14.w != 0) {
            ...
            r14.w = 0.25 * r14.w;
            r18.w = dot(r36.xyz, r17.xyz);
            r20.w = dot(r17.xyz, r37.xyz);
            r21.w = -r18.w * r18.w + lightConstantsCB[r7.w].data[6].y;
            r10.w = r18.w * r20.w + -r10.w;
            r10.w = saturate(r10.w / r21.w);
            r18.w = r21.w / lightConstantsCB[r7.w].data[6].y;
            r18.w = 10 * r18.w;
            r18.w = min(1, r18.w);
            r10.w = r10.w + -r11.w;
            ...
            if (r11.w != 0) {
              ...
              r18.w = dot(r37.xyzw, r25.xyzw);
              r20.w = cmp(r18.w < r11.w);
              if (r20.w == 0) {
                ...
                if (r21.w == 0) {
                  ...
                  r25.x = lightConstantsCB[r10.w].data[10].z * r18.w;
              ...
              if (r18.w == 0) {
                ...
                if (enableDitheredShadow != 0) {
                  ...
                  while (true) {
                    ...
                    if (r27.w != 0) break;
                    r38.x = dot(icb[r21.w+0].yx, r22.xw);
                    r38.y = dot(icb[r21.w+0].xy, r13.xy);
                    ...
                    r20.w = r25.x * 0.125 + r20.w;
                    r21.w = (int)r21.w + 1;
                  }
                } else {
                  r37.z = (uint)r18.w;
                  r20.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r37.xyz, r11.w).x;
                }
                r10.w = r20.w * r20.w;
                r10.w = r10.w * r20.w;
              } else {
                ...
                if (r18.w == 0) {
                  ...
                  if (enableDitheredShadow != 0) {
                    ...
                    while (true) {
                      ...
                      if (r31.w != 0) break;
                      r37.x = dot(icb[r27.w+0].xy, r14.xy);
                      r37.y = dot(icb[r27.w+0].yx, r14.xz);
                      r25.xy = r37.xy * lightConstantsCB[r10.w].data[3].yy + r26.xy;
                      r25.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r25.xyz, r11.w).x;
                    ...
                    r26.z = (uint)r18.w;
                    r21.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r26.xyz, r11.w).x;
                  }
                  r10.w = r21.w * r21.w;
                  r10.w = r10.w * r21.w;
                } else {
            ...
            r10.w = r10.w + -r13.w;
            r10.w = r2.z * r10.w + r13.w;
            r10.w = r10.w * r12.w;
            r25.x = lightConstantsCB[r7.w].data[0].w;
            r25.yz = lightConstantsCB[r7.w].data[1].xy;
            r11.w = cmp(0 < r13.z);
            r26.xyz = r10.www * r25.xyz + r15.yzw;
            r13.z = saturate(dot(r11.xyz, r36.xyz));
            r23.yzw = r23.yzw * r9.www + r12.xyz;
            r9.w = dot(r23.yzw, r23.yzw);
            r9.w = rsqrt(r9.w);
            r23.yzw = r23.yzw * r9.www;
            r9.w = dot(r23.yzw, r12.xyz);
            r13.w = dot(r11.xyz, r23.yzw);
            r18.w = abs(r13.w) * r1.w + -abs(r13.w);
            r13.w = abs(r13.w) * r18.w + 1;
            r18.w = r13.z * r2.y + r6.w;
            r13.w = r13.w * r13.w;
            r13.w = r13.w * r18.w;
            r13.w = rcp(r13.w);
            r13.z = r13.z * r14.w;
            r13.z = r13.w * r13.z;
            r13.z = r13.z * r12.w;
            r23.yzw = r13.zzz * r25.xyz + r16.yzw;
      ...
      if (r13.z != 0) {
        ...
        if (r13.w != 0) {
          ...
          r17.w = dot(r24.yzw, r24.yzw);
          r14.w = r14.w / r17.w;
          r14.w = min(1, r14.w);
          r24.yz = saturate(r13.zz * lightConstantsCB[r7.w].data[2].xz + lightConstantsCB[r7.w].data[2].yw);
          r26.xy = r24.yz * r24.yz;
          r24.yz = r24.yz * float2(-2,-2) + float2(3,3);
          r24.yz = r26.xy * r24.yz;
          r14.w = r24.y * r14.w;
          r14.w = r14.w * r24.z;
          r37.xyz = lightConstantsCB[r7.w].data[4].yzw;
          r37.w = lightConstantsCB[r7.w].data[5].x;
          r26.x = dot(r37.xyzw, r5.xyzw);
          r37.xyz = lightConstantsCB[r7.w].data[5].yzw;
          r37.w = lightConstantsCB[r7.w].data[6].x;
          r26.y = dot(r37.xyzw, r5.xyzw);
          ...
          if (r13.z != 0) {
            ...
            r24.yz = exp2(r24.yz);
            r17.w = lightConstantsCB[r7.w].data[12].x * r24.y;
            r18.w = lightConstantsCB[r7.w].data[12].y * r24.z + -1;
            r17.w = lightConstantsCB[r7.w].data[12].y * r24.z + -r17.w;
          ...
          if (r13.z != 0) {
            r14.w = dot(lightConstantsCB[r7.w].data[13].xyz, r27.xyz);
            r26.x = lightConstantsCB[r7.w].data[13].w;
            r26.yz = lightConstantsCB[r7.w].data[14].xy;
            r17.w = dot(r26.xyz, r27.xyz);
            r26.x = frac(r14.w);
            r26.y = frac(r17.w);
            r13.z = (int)r13.z + -1;
            r26.z = (uint)r13.z;
        ...
        if (r13.z != 0) {
          ...
          r17.w = r17.w ? r2.w : 0;
          if (r17.w != 0) {
            r24.yz = mad((int2)r14.ww, int2(24,24), int2(88,104));
          // Known bad code for instruction (needs manual fix):
          ...
          if (r13.z != 0) {
            ...
            if (r18.w != 0) {
              ...
              r26.y = r24.z * lightConstantsCB[r7.w].data[8].w + lightConstantsCB[r7.w].data[9].x;
              r13.z = r13.z / r17.w;
              ...
              if (enableDitheredShadow != 0) {
                ...
                while (true) {
                  ...
                  r28.xy = r27.xy * lightConstantsCB[r7.w].data[3].yy + r26.xy;
                  r24.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r28.xyz, r13.z).x;
                  r18.w = r24.z * 0.125 + r18.w;
                  r24.y = (int)r24.y + 1;
                }
              } else {
                r26.z = (uint)r17.w;
                r18.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r26.xyz, r13.z).x;
              }
              r13.z = r18.w * r18.w;
              r13.z = r13.z * r18.w;
            } else {
          ...
          if (r13.w != 0) {
            ...
            if (r24.y != 0) {
              ...
              if (r24.w == 0) {
                ...
                r27.x = lightConstantsCB[r17.w].data[9].w + r26.x;
                r27.y = lightConstantsCB[r17.w].data[10].x + r26.y;
                r26.xy = lightConstantsCB[r17.w].data[9].yz * r27.xy;
                ...
                if (r26.z == 0) {
                  ...
                  r28.x = r26.x * lightConstantsCB[r17.w].data[8].y + lightConstantsCB[r17.w].data[8].z;
                  r28.y = r26.y * lightConstantsCB[r17.w].data[8].w + lightConstantsCB[r17.w].data[9].x;
                  r26.x = lightConstantsCB[r17.w].data[10].z * r24.z;
                  r24.y = lightConstantsCB[r17.w].data[10].y * r24.z + r24.y;
                  r24.y = r24.y / r26.x;
                }
              } else {
                r26.z = -1;
              }
              r24.z = (int)r24.w | (int)r26.z;
              if (r24.z == 0) {
                r24.y = max(6.10351563e-05, r24.y);
                r24.z = 0x0000ffff & (int)lightConstantsCB[r17.w].data[1].w;
                if (enableDitheredShadow != 0) {
                  r26.z = (uint)r24.z;
                  r24.w = 0;
                  r27.x = 0;
                  while (true) {
                    r27.y = cmp((int)r27.x >= 8);
                    if (r27.y != 0) break;
                    r29.x = dot(icb[r27.x+0].xy, r32.xy);
                    r29.y = dot(icb[r27.x+0].yx, r32.xz);
                    r26.xy = r29.xy * lightConstantsCB[r17.w].data[3].yy + r28.xy;
                    r26.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r26.xyz, r24.y).x;
                    r24.w = r26.x * 0.125 + r24.w;
                    r27.x = (int)r27.x + 1;
                  }
                } else {
                  r28.z = (uint)r24.z;
              ...
              if (r17.w != 0) {
                ...
                r24.y = cmp(r10.w < 0);
                r24.y = r0.w ? r24.y : 0;
                r17.w = r24.y ? -r17.w : r17.w;
                r30.xyz = r11.xyz * r17.www + r5.xyz;
                r36.xyz = lightConstantsCB[r7.w].data[6].yzw;
                r36.w = lightConstantsCB[r7.w].data[7].x;
                r17.w = dot(r36.xyzw, r30.xyzw);
                r36.xyz = lightConstantsCB[r7.w].data[7].yzw;
                r36.w = lightConstantsCB[r7.w].data[8].x;
                r24.y = dot(r36.xyzw, r30.xyzw);
                r24.z = cmp(r24.y < r17.w);
                if (r24.z == 0) {
                  r36.xyz = lightConstantsCB[r7.w].data[4].yzw;
                  r36.w = lightConstantsCB[r7.w].data[5].x;
                  r26.x = dot(r36.xyzw, r30.xyzw);
                  r36.xyz = lightConstantsCB[r7.w].data[5].yzw;
                  r36.w = lightConstantsCB[r7.w].data[6].x;
                  r26.y = dot(r36.xyzw, r30.xyzw);
                  r26.xy = r26.xy / r24.yy;
                  r26.xy = r26.xy * float2(0.5,-0.5) + float2(0.5,0.5);
                  r27.x = lightConstantsCB[r7.w].data[9].w + r26.x;
                  r27.y = lightConstantsCB[r7.w].data[10].x + r26.y;
                  r26.xy = lightConstantsCB[r7.w].data[9].yz * r27.xy;
                  ...
                  if (r26.z == 0) {
                    r26.xy = saturate(r26.xy);
                    r28.x = r26.x * lightConstantsCB[r7.w].data[8].y + lightConstantsCB[r7.w].data[8].z;
                    r28.y = r26.y * lightConstantsCB[r7.w].data[8].w + lightConstantsCB[r7.w].data[9].x;
                    r26.x = lightConstantsCB[r7.w].data[10].z * r24.y;
                    r17.w = lightConstantsCB[r7.w].data[10].y * r24.y + r17.w;
                    r17.w = r17.w / r26.x;
                  }
                } else {
                  r26.z = -1;
                }
                r24.y = (int)r24.z | (int)r26.z;
                if (r24.y == 0) {
                  ...
                  if (enableDitheredShadow != 0) {
                    ...
                    while (true) {
                      r27.y = cmp((int)r27.x >= 8);
                      if (r27.y != 0) break;
                      r29.x = dot(icb[r27.x+0].xy, r33.xy);
                      r29.y = dot(icb[r27.x+0].yx, r33.xz);
                      r26.xy = r29.xy * lightConstantsCB[r7.w].data[3].yy + r28.xy;
                      r26.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r26.xyz, r17.w).x;
                      r24.z = r26.x * 0.125 + r24.z;
                      r27.x = (int)r27.x + 1;
                    }
                  } else {
                    r28.z = (uint)r24.y;
                    r24.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r28.xyz, r17.w).x;
                  }
                  r7.w = r24.z * r24.z;
                  r7.w = r7.w * r24.z;
                } else {
            ...
            r7.w = r7.w + -r12.w;
            r7.w = r2.z * r7.w + r12.w;
            r7.w = r7.w * r13.z;
            r10.w = cmp(0 < r10.w);
            r26.xyz = r7.www * r23.yzw + r15.yzw;
            ...
            r17.w = abs(r12.w) * r1.w + -abs(r12.w);
            r12.w = abs(r12.w) * r17.w + 1;
            ...
            r9.w = r12.w * r9.w;
            r9.w = r11.w * r9.w;
            r27.xyw = r9.www * r23.yzw + r35.xyz;
            r23.yzw = r7.www * r23.yzw + r34.xyz;
            r23.yzw = r0.www ? r23.yzw : r34.xyz;
            r15.yzw = r10.www ? r26.xyz : r15.yzw;
            r34.xyz = r10.www ? r34.xyz : r23.yzw;
            r35.xyz = r10.www ? r27.xyw : r35.xyz;
