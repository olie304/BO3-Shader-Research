...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r3.w = debugAlphaOverride.w * r0.w + r2.x;
  r0.w = r1.x + -r1.y;
  ...
  r1.z = rsqrt(r1.z);
  r4.xyz = r4.xyz * r1.zzz + -r2.yzw;
  r2.xyz = debugNormalOverride.www * r4.xyz + r2.yzw;
  r4.xyz = flagParams.zzz * r0.xyz;
  r1.zw = (uint2)v0.xy;
  ...
  r1.x = saturate(dot(r2.xyz, r5.yzw));
  r6.y = dot(-r5.yzw, r2.xyz);
  r6.y = r6.y + r6.y;
  r11.xyz = r2.xyz * -r6.yyy + -r5.yzw;
  r6.y = 17 * r1.y;
  r6.y = exp2(r6.y);
  r6.y = 2 + r6.y;
  r6.y = 2 / r6.y;
  ...
  r1.xyz = r31.xyz * float3(0.0399999991,0.0399999991,0.0399999991) + r1.xyz;
  r0.xyz = r1.xyz + r0.xyz;
