...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:42:28 2021
//
//
// Buffer Definitions: 
//
...
//   uint zFeatherComputeSprites;       // Offset:  208 Size:     4 [unused]
//   float hdrScale;                    // Offset:  212 Size:     4
//   float emissiveFalloffPower;        // Offset:  216 Size:     4
//   float3 emissiveTint1;              // Offset:  224 Size:    12
//   bool relativeHDR;                  // Offset:  236 Size:     4
//   bool invertFalloff;                // Offset:  240 Size:     4
//   float layerDepth;                  // Offset:  244 Size:     4
//   float uvMotionToggle1;             // Offset:  248 Size:     4 [unused]
//      = 0x00000000 
//
// }
//
...
add r3.z, cb0[15].y, l(0.000010)
mad r3.xy, r3.xyxx, r3.zzzz, v1.yzyy
sample_indexable(texture2d)(float,float,float,float) r3.xyzw, r3.xyxx, t22.xyzw, s1
...
exp r2.w, r2.w
movc r2.w, cb0[15].x, r2.w, r4.x
eq r4.x, cb0[13].z, l(0.000000)
movc r2.w, r4.x, l(1.000000), r2.w
mul r3.w, r3.w, cb0[13].y
mul r2.w, r2.w, r3.w
mul r1.w, r1.w, r2.w
...
frc r2.w, r2.w
mad r2.w, r2.w, l(6.28318548), cb1[70].w
sincos r4.x, r11.x, r2.w
dp3_sat r8.x, r6.xyzx, r9.xyzx
dp3 r2.w, -r9.xyzx, r6.xyzx
add r2.w, r2.w, r2.w
mad r12.xyz, r6.xyzx, -r2.wwww, -r9.xyzx
...
mov r3.w, l(1.000000)
movc r1.xyzw, cb0[14].wwww, r1.xyzw, r3.xyzw
...
ret 
// Approximately 2933 instruction slots used
