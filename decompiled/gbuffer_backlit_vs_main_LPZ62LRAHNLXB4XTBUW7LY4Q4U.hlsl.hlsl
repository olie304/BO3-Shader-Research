...
r1.w = modelInstanceBuffer[]..swiz;
  ...
  r3.y = r2.x;
  r3.x = -r1.x;
  r0.w = dot(r3.xy, r0.xy);
  r0.z = dot(r3.yz, r0.xy);
  r0.xy = gameTime.ww * scrollUVs.xy;
  r0.xy = r0.xy * scaleUVs.xy + r0.zw;
