...
r0.w = samp0[]..swiz;
  ...
  r0.y = 1 + -r12.x;
  r2.xyz = r2.xyz * r0.yyy + r13.xyz;
  o0.w = r2.w * r0.y + r12.x;
  r3.xyz = r3.xyz * r0.yyy + r14.xyz;
  r1.x = dot(r3.xyz, r3.xyz);
  r1.x = rsqrt(r1.x);
  r3.xyz = r3.xyz * r1.xxx;
  r1.y = r1.y * r0.y + r12.y;
  r6.xyz = r0.yyy * float3(0.0399999991,0.0399999991,0.0399999991) + r15.xyz;
  r5.zw = float2(-0.00999999978,-0.800000012) + r0.zz;
  ...
  r9.xyzw = emissiveMap.Sample(colorSampler_s, r0.zw).xyzw;
  r4.yzw = r9.xyz * r7.xyz;
  r0.z = log2(r4.x);
  ...
  r1.w = min(15, r1.w);
  r1.w = (uint)r1.w;
  r12.xy = (uint2)r5.xy >> int2(6,6);
  r12.z = (uint)r1.w << 4;
  r1.w = (int)r7.z & -32;
  r5.x = (int)-r1.w + (int)r7.z;
  ...
  while (true) {
    ...
    r10.y = cmp((int)r1.w == (int)r8.w);
    bitmask.z = ((~(-1 << r5.x)) << 0) & 0xffffffff;  r10.z = (((uint)0 << 0) & bitmask.z) | ((uint)r9.w & ~bitmask.z);
    r9.w = r10.y ? r10.z : r9.w;
    r10.y = cmp((int)r5.y == (int)r8.w);
  ...
  if (r5.y != 0) {
    ...
    while (true) {
      ...
      if (r5.x == 0) r12.w = 0; else if (r5.x+0 < 32) {       r12.w = (uint)r8.w << (32-(r5.x + 0)); r12.w = (uint)r12.w >> (32-r5.x);      } else r12.w = (uint)r8.w >> 0;
  ...
  if (r4.w != 0) {
    ...
    r5.xyw = r20.xyz * r1.www + r13.xyz;
    r11.w = 0;
    r13.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r11.xyzw, r5.z).xyz;
    r1.w = sunConstants.globalProbeExposure * r4.w + -r3.w;
    r1.w = r1.y * r1.w + r3.w;
  ...
  r3.w = r6.w * r3.w;
  r4.w = r6.w * r4.w;
  r6.w = dot(r3.xyz, sunConstants.wldDir.xyz);
  r7.z = saturate(r6.w);
  r7.w = cmp(0 >= r7.z);
  if (r7.w != 0) {
    r8.w = 0;
  ...
  if (r7.w != 0) {
    r7.w = cmp(0 < r8.w);
    if (r7.w != 0) {
      r7.w = sunConstants.specScale * r4.y;
      r7.w = r7.w * r7.z;
      ...
      r14.w = r16.z;
      r5.w = r13.z;
      r5.xyzw = r6.wwww ? r14.xyzw : r5.xyzw;
      r16.zw = r15.xy;
      r13.zw = r1.yz;
      r14.xyzw = r6.wwww ? r16.xyzw : r13.xyzw;
      r1.w = r6.w ? r15.z : r1.w;
      r13.z = r5.w;
      r13.xy = r14.xy;
      r1.yz = r14.zw;
    }
