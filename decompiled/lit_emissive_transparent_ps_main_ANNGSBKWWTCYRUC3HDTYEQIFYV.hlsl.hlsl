...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  if (r2.z != 0) {
    ...
    r3.y = columnCount * r2.z;
    r3.y = cmp(r3.y >= -r3.y);
    r3.y = r3.y ? columnCount : -columnCount;
    r4.w = 1 / r3.y;
    r2.z = r4.w * r2.z;
    r2.z = frac(r2.z);
    r2.z = r3.y * r2.z;
    ...
    r2.zw = r2.zw * scaleUVs.xy + r11.xy;
  ...
  r2.w = frac(r2.w);
  r3.y = gameTime.w * flickerSpeed + r2.w;
  r3.x = flickerSeed.x;
  r2.w = flickerLookupMap.SampleLevel(lookupSampler_s, r3.xy, 0).x;
  r2.w = log2(abs(r2.w));
  r2.w = flickerPower * r2.w;
  r2.w = exp2(r2.w);
  r3.x = flickerRange.y + -flickerRange.x;
  r2.w = r2.w * r3.x + flickerRange.x;
  r4.xyz = r4.xyz * r2.www;
  ...
  if (r11.z != 0) {
    ...
    r11.w = 0;
    while (true) {
      r13.w = cmp((uint)r11.w >= (uint)r9.w);
      if (r13.w != 0) break;
      r13.z = (uint)r11.w >> 5;
      r14.xyz = (int3)r8.xyz + (int3)r13.xyz;
      r13.z = visibleProbes.Load(r14.xyzw).x;
  ...
  if (r6.w != 0) {
    ...
    r3.w = sunConstants.globalProbeExposure * r6.w + -r5.w;
    r3.w = r2.y * r3.w + r5.w;
  ...
  r6.zw = r2.xy * float2(0.984375,0.984375) + float2(0.0078125,0.0078125);
  r6.zw = gEnvBRDFGeneric.SampleLevel(samplerLinear_s, r6.zw, 0).xy;
  r11.yzw = r13.xyz * r3.www;
  r13.xyz = r11.zwy * r6.zzz;
  ...
  r1.w = r3.w * r1.w;
  r2.y = r3.w * r2.y;
  r3.w = dot(r5.xyz, sunConstants.wldDir.xyz);
  r5.w = saturate(r3.w);
  r6.z = cmp(0 >= r5.w);
  if (r6.z != 0) {
    r6.w = 0;
  ...
  if (r6.z == 0) {
    ...
    r6.z = -sunConstants.splitDepthOffset + r15.z;
    ...
    if (r10.w == 0) {
      if (enableDitheredShadow == 0) {
        ...
        r16.z = r10.w + r8.w;
        r10.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r6.z).x;
      ...
      if (enableDitheredShadow != 0) {
        ...
        r15.xy = -sunConstants.splitPinTransform[r8.w].xy + r15.xy;
        ...
        while (true) {
          ...
          r17.w = r17.x ? sunConstants.splitPinTransform[r8.w].w : sunConstants.splitPinTransform[r10.w].w;
          r17.x = r17.x ? r8.w : r10.w;
          ...
          r18.z = (uint)r17.x;
          r17.x = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r18.xyz, r6.z).x;
  ...
  if (r6.z != 0) {
    ...
    if (r6.z != 0) {
      ...
      if (sunConstants.sunCookieIndex != 0) {
        r7.w = 1;
        r8.w = dot(sunConstants.sunCookieTransform[0].xyzw, r7.xyzw);
      ...
      r5.w = r6.w * r5.w;
      r5.w = 0.25 * r5.w;
      r16.xyz = r5.www * r7.xyz + r11.yzw;
      r2.z = saturate(1 + -r2.z);
      r6.z = r2.z * r2.z;
      r6.z = r6.z * r6.z;
      r2.z = r6.z * r2.z;
      r2.z = r5.w * r2.z;
      r7.xyz = r2.zzz * r7.yzx + r13.xyz;
      r15.w = r7.z;
      r14.w = r13.z;
      r14.xyzw = r3.wwww ? r15.xyzw : r14.xyzw;
      r7.zw = r16.xy;
      r13.zw = r11.yz;
      r7.xyzw = r3.wwww ? r7.xyzw : r13.xyzw;
            ...
            if (r20.w != 0) {
              ...
              if (r20.w != 0) {
                ...
                if (r20.w != 0) {
                    ...
                    r12.w = samp0[]..swiz;
                      ...
                      if (r6.w != 0) {
                        ...
                        while (true) {
                          ...
                          if (r24.w != 0) break;
                          r43.x = dot(icb[r18.z+0].yx, r7.xw);
                          r43.y = dot(icb[r18.z+0].xy, r6.xy);
                  ...
                  r12.w = saturate(dot(r5.xyz, r40.xyz));
                  r39.xyz = r39.xyz * r10.www + r9.xyz;
                  r10.w = dot(r39.xyz, r39.xyz);
                  r10.w = rsqrt(r10.w);
                  r39.xyz = r39.xyz * r10.www;
                  r10.w = dot(r39.xyz, r9.xyz);
                  r15.z = dot(r5.xyz, r39.xyz);
            ...
            r40.w = samp0[]..swiz;
              ...
              if (r14.w != 0) {
                ...
                if (r14.w != 0) {
                  ...
                  r19.xyz = r19.xyz * r10.www + r9.xyz;
                  r10.w = dot(r19.xyz, r19.xyz);
                  r10.w = rsqrt(r10.w);
                  r19.xyz = r19.xyz * r10.www;
                  r10.w = dot(r19.xyz, r9.xyz);
                  r15.z = dot(r5.xyz, r19.xyz);
