...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  r2.y = 1 + -r5.y;
  r2.y = 5 * r2.y;
  r4.yzw = -globalProbeConstants.data[0].xyz + v5.xyz;
  ...
  if (r5.z == 0) {
    r7.xyz = sunConstants.sstLightingConstants.offToPinTransform._m10_m11_m12 * v5.yyy;
    r7.xyz = v5.xxx * sunConstants.sstLightingConstants.offToPinTransform._m00_m01_m02 + r7.xyz;
    r7.xyz = v5.zzz * sunConstants.sstLightingConstants.offToPinTransform._m20_m21_m22 + r7.xyz;
  ...
  if (r5.z != 0) {
    ...
    if (r5.z != 0) {
      ...
      r10.xyz = -v5.xyz * r0.www + sunConstants.wldDir.xyz;
