  ...
  out float2 o3 : SV_TARGET3)
{
  ...
  r0.xy = r0.xy + r1.zz;
  r2.zw = colorMapTile2.xy * r0.xy;
  r0.xy = detailScale2.xy * r0.xy;
  r3.xy = colorMapTile2.xy * r2.xy;
  r2.xy = detailScale2.xy * r2.xy;
  r0.xy = useUVOffsets1 ? r0.xy : r2.xy;
  r2.xy = useUVOffsets1 ? r2.zw : r3.xy;
  r2.xyzw = colorMapDetail2.Sample(colorSampler_s, r2.xy).xyzw;
  ...
  r2.w = mixMap.Sample(mixSampler_s, r3.xy).x;
  r3.x = saturate(-levelsControls.x + r2.w);
  r3.yz = levelsControls.yw + -levelsControls.xz;
  r3.y = max(9.99999975e-05, r3.y);
  r3.x = r3.x / r3.y;
  r3.x = min(1, r3.x);
  r3.x = r3.x * r3.z + levelsControls.z;
  r1.z = r1.z ? r2.w : r3.x;
  r1.xyw = r1.zzz * r2.xyz + r1.xyw;
  o0.xyz = v1.xyz * r1.xyw;
  o0.w = 1;
