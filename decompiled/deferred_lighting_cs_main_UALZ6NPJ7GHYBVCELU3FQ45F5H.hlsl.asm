...
loop 
  ...
  if_nz r13.w
    ...
    if_nz r2.z
      ...
      store_structured u2.xyzw, cb2[52].x, r13.w, r18.xyzw
    endif 
    ...
    movc r16.yz, r16.yyyy, r19.xxyx, r19.zzxz
    mov r16.w, cb10[r13.z + 6].x
    mov r27.xy, r16.yzyy
    mov r18.y, l(1)
    loop 
      ige r18.z, r18.y, r14.w
      breakc_nz r18.z
      iadd r18.z, r13.w, r18.y
    ...
    if_nz r14.w
      ...
      mad r25.z, r27.y, cb10[r13.z + 6].y, r25.z
      mul r13.w, r13.w, cb10[r13.z + 7].y
      mov r28.x, cb10[r13.z + 7].w
      mov r28.yz, cb10[r13.z + 8].xxyx
      dp3 r14.w, r17.xyzx, r28.xyzx
      dp3 r16.y, r15.yzwy, r28.xyzx
      add r16.y, r16.y, -cb10[r13.z + 8].z
      ...
      mov r28.x, cb10[r13.z + 8].w
      mov r28.yz, cb10[r13.z + 9].xxyx
      ...
      mov r28.x, cb10[r13.z + 9].w
      mov r28.yz, cb10[r13.z + 10].xxyx
      dp3 r16.y, r17.xyzx, r28.xyzx
      dp3 r16.z, r15.yzwy, r28.xyzx
      ...
      div r16.y, r16.z, r16.y
      min r14.w, r14.w, |r16.y|
      mov r28.x, cb10[r13.z + 10].w
      mov r28.yz, cb10[r13.z + 11].xxyx
      dp3 r16.y, r17.xyzx, r28.xyzx
      dp3 r16.z, r15.yzwy, r28.xyzx
      ...
      div r16.y, r16.z, r16.y
      min r14.w, r14.w, |r16.y|
      mov r28.x, cb10[r13.z + 11].w
      mov r28.yz, cb10[r13.z + 12].xxyx
      dp3 r16.y, r17.xyzx, r28.xyzx
      dp3 r16.z, r15.yzwy, r28.xyzx
      ...
      div r16.y, r16.z, r16.y
      min r14.w, r14.w, |r16.y|
      mov r28.x, cb10[r13.z + 12].w
      mov r28.yz, cb10[r13.z + 13].xxyx
      dp3 r16.y, r17.xyzx, r28.xyzx
      dp3 r16.z, r15.yzwy, r28.xyzx
      ...
      div r16.y, r16.z, r16.y
      min r14.w, r14.w, |r16.y|
      add r28.x, r15.y, cb10[r13.z + 3].w
      add r28.yz, r15.zzwz, cb10[r13.z + 4].xxyx
      mad r16.yzw, r17.xxyz, r14.wwww, r28.xxyz
      dp3 r18.y, r16.yzwy, r16.yzwy
      sqrt r18.y, r18.y
      ...
      mov r28.x, cb10[r13.z + 0].w
      mov r28.y, cb10[r13.z + 1].z
      mov r28.z, cb10[r13.z + 2].y
      dp3 r29.x, r16.yzwy, r28.xyzx
      mov r30.xy, cb10[r13.z + 1].xwxx
      mov r30.z, cb10[r13.z + 2].z
      dp3 r29.y, r16.yzwy, r30.xyzx
      mov r31.x, cb10[r13.z + 1].y
      mov r31.yz, cb10[r13.z + 2].xxwx
      dp3 r29.z, r16.yzwy, r31.xyzx
      ubfe r16.y, l(9), l(16), cb10[r13.z + 7].z
      utof r29.w, r16.y
      sample_l_indexable(texturecubearray)(float,float,float,float) r16.yzw, r29.xyzw, t8.wxyz, s2, r14.w
      ...
      mad_sat r15.yzw, r32.xxyz, cb10[r13.z + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
      mul r32.xy, r15.yzyy, cb10[r13.z + 4].zwzz
      mul r32.z, r15.w, cb10[r13.z + 5].x
      add r15.yzw, r32.xxyz, cb10[r13.z + 5].yyzw
      ...
      or r13.z, r27.z, r27.x
      or r13.z, r27.w, r13.z
      movc r18.yzw, r13.zzzz, l(0,1.000000,1.000000,0), r18.yyzw
...
loop 
  ieq r14.w, r12.w, l(2)
  breakc_nz r14.w
  movc r14.w, r12.w, r0.y, r10.w
  ult r16.y, r14.w, r9.w
  if_nz r16.y
    imul null, r14.w, r14.w, l(14)
    if_nz r2.z
      and r16.y, r13.w, l(15)
      imad r16.y, r16.y, l(20), l(880)
      add r18.yzw, cb1[24].xxyz, cb10[r14.w + 0].xxyz
      store_structured u2.xyzw, cb2[52].x, r16.y, r18.xyzw
    endif 
    iadd r21.y, r13.w, l(1)
    add r16.yzw, r5.xxyz, -cb10[r14.w + 0].xxyz
    and r18.y, l(0x0000ffff), cb10[r14.w + 7].z
    ubfe r18.z, l(6), l(25), cb10[r14.w + 7].z
    imul null, r18.w, r18.y, l(6)
    dp3 r19.w, cb11[r18.w + 0].xyzx, r16.yzwy
    add_sat r19.w, r19.w, cb11[r18.w + 0].w
    dp3 r20.w, cb11[r18.w + 1].xyzx, r16.yzwy
    add_sat r20.w, r20.w, cb11[r18.w + 1].w
    mul r19.w, r19.w, r20.w
    dp3 r20.w, cb11[r18.w + 2].xyzx, r16.yzwy
    add_sat r20.w, r20.w, cb11[r18.w + 2].w
    mul r19.w, r19.w, r20.w
    dp3 r20.w, cb11[r18.w + 3].xyzx, r16.yzwy
    add_sat r20.w, r20.w, cb11[r18.w + 3].w
    mul r19.w, r19.w, r20.w
    dp3 r20.w, cb11[r18.w + 4].xyzx, r16.yzwy
    add_sat r20.w, r20.w, cb11[r18.w + 4].w
    mul r19.w, r19.w, r20.w
    dp3 r20.w, cb11[r18.w + 5].xyzx, r16.yzwy
    add_sat r18.w, r20.w, cb11[r18.w + 5].w
    mul r19.x, r18.w, r19.w
    and r18.w, l(1), cb10[r14.w + 6].x
    movc r19.xw, r18.wwww, r19.xxxy, r19.zzzx
    mov r18.w, cb10[r14.w + 6].x
    mov r27.xy, r19.xwxx
    mov r20.w, l(1)
    loop 
      ige r22.w, r20.w, r18.z
      breakc_nz r22.w
      iadd r22.w, r18.y, r20.w
      imul null, r22.w, r22.w, l(6)
      dp3 r23.w, cb11[r22.w + 0].xyzx, r16.yzwy
      ...
      ushr r26.w, r18.w, l(2)
      ubfe r27.z, l(1), l(2), r18.w
      and r27.w, r26.w, l(2)
      max r28.x, r27.x, r27.y
      mad r22.w, -r23.w, r22.w, l(1.000000)
      mul r22.w, r22.w, r27.y
      movc r21.w, r27.w, r22.w, r28.x
      movc r27.xy, r27.zzzz, r27.xyxx, r21.zwzz
      iadd r20.w, r20.w, l(1)
      mov r18.w, r26.w
    endloop 
    add_sat r18.y, -r25.z, r27.y
    mul r18.z, r18.y, cb10[r14.w + 6].y
    lt r18.w, l(0.000000), r18.z
    if_nz r18.w
      and r18.w, r21.y, l(31)
      iadd r19.x, r18.w, l(-1)
      ult r19.x, r19.x, l(32)
      and r19.x, r2.z, r19.x
      if_nz r19.x
        imad r19.xw, r18.wwww, l(20, 0, 0, 20), l(860, 0, 0, 876)
        ...
        store_structured u2.x, cb2[52].x, r19.w, r18.z
      endif 
      iadd r13.w, r13.w, l(257)
      mad r13.z, r18.y, cb10[r14.w + 6].y, r13.z
      mul r18.y, r18.z, cb10[r14.w + 7].y
      ...
      dp3 r19.x, r16.yzwy, r28.xyzx
      add r19.x, r19.x, -cb10[r14.w + 9].z
      ...
      dp3 r18.w, r17.xyzx, r28.xyzx
      dp3 r19.x, r16.yzwy, r28.xyzx
      add r19.x, r19.x, -cb10[r14.w + 10].z
      ge r19.w, r19.x, l(0.000000)
      max r19.x, r7.w, |r19.x|
      movc r19.x, r19.w, r19.x, -r19.x
      max r18.w, -r18.w, l(0.00000010)
      ...
      dp3 r18.w, r17.xyzx, r28.xyzx
      dp3 r19.x, r16.yzwy, r28.xyzx
      add r19.x, r19.x, -cb10[r14.w + 11].z
      ge r19.w, r19.x, l(0.000000)
      max r19.x, r7.w, |r19.x|
      movc r19.x, r19.w, r19.x, -r19.x
      max r18.w, -r18.w, l(0.00000010)
      ...
      dp3 r18.w, r17.xyzx, r28.xyzx
      dp3 r19.x, r16.yzwy, r28.xyzx
      add r19.x, r19.x, -cb10[r14.w + 12].z
      ge r19.w, r19.x, l(0.000000)
      max r19.x, r7.w, |r19.x|
      movc r19.x, r19.w, r19.x, -r19.x
      max r18.w, -r18.w, l(0.00000010)
      ...
      dp3 r18.w, r17.xyzx, r28.xyzx
      dp3 r19.x, r16.yzwy, r28.xyzx
      add r19.x, r19.x, -cb10[r14.w + 13].z
      ge r19.w, r19.x, l(0.000000)
      max r19.x, r7.w, |r19.x|
      movc r19.x, r19.w, r19.x, -r19.x
      max r18.w, -r18.w, l(0.00000010)
      ...
      mad r27.xzw, r17.xxyz, r18.zzzz, r28.xxyz
      dp3 r18.w, r27.xzwx, r27.xzwx
      sqrt r18.w, r18.w
      div r18.z, r18.z, r18.w
      add r18.z, r18.z, r18.z
      sqrt r18.z, r18.z
      mad r18.z, r3.z, l(5.000000), r18.z
      ...
      utof r29.w, r18.w
      sample_l_indexable(texturecubearray)(float,float,float,float) r27.xzw, r29.xyzw, t8.xwyz, s2, r18.z
      ...
      movc r27.xzw, r18.zzzz, l(1.000000,0,1.000000,0), r27.xxzw
      ...
      mul r31.xyz, r18.yyyy, r31.xyzx
      movc r22.z, r28.y, l(0), l(0.500000)
      add r28.xyw, r16.yzyw, r22.xyxz
      ...
      mad r15.yzw, r16.yyzw, r28.xxyz, r15.yyzw
      mul r16.y, r8.w, r14.w
      mul r18.yzw, r18.yyyy, r27.xxzw
      dp3 r16.z, r18.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r14.w, r8.w, r14.w, r16.z
      div r14.w, r16.y, r14.w
...
bfi r3.z, l(8), l(0), r13.w, r25.w
movc r0.y, r0.y, r3.z, r13.w
max r3.z, r13.z, l(1.000000)
rcp r3.z, r3.z
mov_sat r13.z, r13.z
mul r16.yzw, r3.zzzz, r15.yyzw
mul r18.xyz, r3.zzzz, r26.xyzx
...
if_nz r7.w
  ...
  mad r16.yzw, r15.yyzw, r3.zzzz, r19.xxyz
  mov r17.w, l(0)
...
mul r15.yzw, r3.zzzz, r18.xxyz
mul r18.xyz, r13.zzzz, r15.zwyz
...
if_nz r4.z
  ...
  if_nz r4.z
    ...
    mad r20.xyz, r6.wwww, r16.yzwy, r19.xyzx
    ...
    mul r0.w, r0.w, r4.z
    mul r0.w, r0.w, r3.y
    mad r22.xyz, r0.wwww, r16.zwyz, r18.xyzx
    mov r20.w, r22.z
    mov r19.w, r18.z
    movc r19.xyzw, r2.wwww, r20.xyzw, r19.xyzw
    mov r22.zw, r21.xxxy
    mov r18.zw, r15.yyyz
    movc r20.xyzw, r2.wwww, r22.xyzw, r18.xyzw
...
ret 
// Approximately 2139 instruction slots used
