  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r2.w = r3.w * r1.x + glossRange.x;
  r3.w = glossRange2.y + -glossRange2.x;
  r2.z = r2.z * r3.w + glossRange2.x;
  r2.zw = saturate(float2(0.0588235296,0.0588235296) * r2.zw);
  r2.z = r2.z + -r2.w;
  r2.z = r0.z * r2.z + r2.w;
  r2.w = aoMap.Sample(aoSampler_s, r0.xy).x;
  r6.xy = r9.xy * float2(1.9921875,1.9921875) + float2(-1,-1);
  r3.w = r9.z * r9.z;
  ...
  r3.xy = r6.xy * detailScaleHeight2 + r2.xy;
  r2.x = dot(r3.xyz, r3.xyz);
  r2.x = rsqrt(r2.x);
  r4.xyz = r3.xyz * r2.xxx;
  r4.w = r3.w * detailScaleHeight2 + r0.w;
  r3.xyzw = r4.xyzw + -r7.xyzw;
  r3.xyzw = r0.zzzz * r3.xyzw + r7.xyzw;
  ...
  r4.z = debugOcclusionOverride.w * r0.w + r2.w;
