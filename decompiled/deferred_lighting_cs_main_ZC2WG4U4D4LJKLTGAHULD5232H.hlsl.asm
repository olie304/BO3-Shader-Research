...
loop 
  ieq r17.z, r17.y, l(2)
  breakc_nz r17.z
  movc r17.z, r17.y, r0.y, r17.x
  uge r17.w, r17.z, r15.w
  ...
  if_nz r17.w
    ...
    add r18.yzw, r11.xxyz, -cb10[r17.z + 0].xxyz
...
loop 
  ...
  if_nz r22.w
    ...
    dp3 r27.z, cb11[r26.w + 0].xyzx, r18.yzwy
    add_sat r27.z, r27.z, cb11[r26.w + 0].w
    dp3 r27.w, cb11[r26.w + 1].xyzx, r18.yzwy
    add_sat r27.w, r27.w, cb11[r26.w + 1].w
    mul r27.z, r27.w, r27.z
    dp3 r27.w, cb11[r26.w + 2].xyzx, r18.yzwy
    add_sat r27.w, r27.w, cb11[r26.w + 2].w
    mul r27.z, r27.w, r27.z
    dp3 r27.w, cb11[r26.w + 3].xyzx, r18.yzwy
    add_sat r27.w, r27.w, cb11[r26.w + 3].w
    mul r27.z, r27.w, r27.z
    dp3 r27.w, cb11[r26.w + 4].xyzx, r18.yzwy
    add_sat r27.w, r27.w, cb11[r26.w + 4].w
    mul r27.z, r27.w, r27.z
    dp3 r27.w, cb11[r26.w + 5].xyzx, r18.yzwy
    add_sat r26.w, r27.w, cb11[r26.w + 5].w
    mul r19.x, r26.w, r27.z
    and r26.w, l(1), cb10[r20.w + 6].x
    movc r27.zw, r26.wwww, r19.xxxy, r19.zzzx
    mov r19.x, cb10[r20.w + 6].x
    mov r28.xy, r27.zwzz
    mov r26.w, l(1)
    loop 
      ige r28.z, r26.w, r23.w
      breakc_nz r28.z
      iadd r28.z, r22.w, r26.w
      imul null, r28.z, r28.z, l(6)
      dp3 r28.w, cb11[r28.z + 0].xyzx, r18.yzwy
      add_sat r28.w, r28.w, cb11[r28.z + 0].w
      mul r28.w, r28.w, r28.x
      dp3 r29.x, cb11[r28.z + 1].xyzx, r18.yzwy
      add_sat r29.x, r29.x, cb11[r28.z + 1].w
      mul r28.w, r28.w, r29.x
      dp3 r29.x, cb11[r28.z + 2].xyzx, r18.yzwy
      add_sat r29.x, r29.x, cb11[r28.z + 2].w
      mul r28.w, r28.w, r29.x
      dp3 r29.x, cb11[r28.z + 3].xyzx, r18.yzwy
      add_sat r29.x, r29.x, cb11[r28.z + 3].w
      mul r28.w, r28.w, r29.x
      dp3 r29.x, cb11[r28.z + 4].xyzx, r18.yzwy
      add_sat r29.x, r29.x, cb11[r28.z + 4].w
      mul r28.w, r28.w, r29.x
      dp3 r29.x, cb11[r28.z + 5].xyzx, r18.yzwy
      add_sat r28.z, r29.x, cb11[r28.z + 5].w
      mul r28.x, r28.z, r28.w
      ushr r29.x, r19.x, l(2)
      ubfe r29.y, l(1), l(2), r19.x
      and r29.z, r29.x, l(2)
      max r29.w, r28.x, r28.y
      mad r28.z, -r28.w, r28.z, l(1.000000)
      mul r28.z, r28.z, r28.y
      movc r21.w, r29.z, r28.z, r29.w
      movc r28.xy, r29.yyyy, r28.xyxx, r21.zwzz
      iadd r26.w, r26.w, l(1)
      mov r19.x, r29.x
    endloop 
    add_sat r19.x, -r25.z, r28.y
    mul r21.w, r19.x, cb10[r20.w + 6].y
    lt r22.w, l(0.000000), r21.w
    if_nz r22.w
      and r22.w, r27.y, l(31)
      iadd r23.w, r22.w, l(-1)
      ult r23.w, r23.w, l(32)
      and r23.w, r6.w, r23.w
      if_nz r23.w
        imad r27.zw, r22.wwww, l(0, 0, 20, 20), l(0, 0, 860, 876)
        ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r22.w, cb2[52].x, r27.z, u2.xxxx
        or r22.w, r22.w, l(32)
        store_structured u2.x, cb2[52].x, r27.z, r22.w
        store_structured u2.x, cb2[52].x, r27.w, r21.w
      endif 
      iadd r21.y, r21.y, l(257)
      mad r21.x, r19.x, cb10[r20.w + 6].y, r21.x
      ...
      div r22.w, r23.w, r22.w
      min r21.w, r21.w, |r22.w|
      add r29.x, r18.y, cb10[r20.w + 3].w
      add r29.yz, r18.zzwz, cb10[r20.w + 4].xxyx
      mad r28.xzw, r16.xxyz, r21.wwww, r29.xxyz
      dp3 r22.w, r28.xzwx, r28.xzwx
      sqrt r22.w, r22.w
      ...
      utof r30.w, r22.w
      sample_l_indexable(texturecubearray)(float,float,float,float) r28.xzw, r30.xyzw, t8.xwyz, s2, r21.w
      ...
      or r21.w, r33.z, r21.w
      movc r28.xzw, r21.wwww, l(1.000000,0,1.000000,0), r28.xxzw
      dp3 r33.x, r18.yzwy, r29.xyzx
      dp3 r33.y, r18.yzwy, r31.xyzx
      dp3 r33.z, r18.yzwy, r32.xyzx
      mad_sat r18.yzw, r33.xxyz, cb10[r20.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
      mul r33.xy, r18.yzyy, cb10[r20.w + 4].zwzz
      mul r33.z, r18.w, cb10[r20.w + 5].x
      add r18.yzw, r33.xxyz, cb10[r20.w + 5].yyzw
      dp3 r30.x, r12.xyzx, r29.xyzx
      dp3 r30.y, r12.xyzx, r31.xyzx
      dp3 r30.z, r12.xyzx, r32.xyzx
      ...
      add r18.yzw, r18.yyzw, r23.xxyz
      sample_l_indexable(texture3d)(float,float,float,float) r18.yzw, r18.yzwy, t19.wxyz, s4, l(0.000000)
      mad r18.yzw, r18.yyzw, r32.zzzz, r29.xxyw
      ...
      or r20.z, r30.z, r20.z
      movc r29.xyz, r20.zzzz, l(1.000000,1.000000,0,0), r29.xyzx
      mul r30.xyz, r18.yzwy, r29.xyzx
      dp3 r20.z, r30.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r17.yzw, r18.yyzw, r29.xxyz, r17.yyzw
      mul r18.y, r15.z, r20.z
      mul r28.xzw, r19.xxxx, r28.xxzw
      dp3 r18.z, r28.xzwx, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r18.z, r15.z, r20.z, r18.z
      div r18.y, r18.y, r18.z
      mad r26.xyz, r28.xzwx, r18.yyyy, r26.xyzx
    else 
      mov r27.x, r21.x
      mov r21.xy, r27.xyxx
    endif 
...
bfi r9.w, l(8), l(0), r21.y, r25.w
movc r0.y, r0.y, r9.w, r21.y
max r9.w, r21.x, l(1.000000)
rcp r9.w, r9.w
mov_sat r21.x, r21.x
mul r15.yzw, r9.wwww, r17.yyzw
mul r18.xyz, r9.wwww, r26.xyzx
lt r17.x, r21.x, l(0.990000)
if_nz r17.x
  iadd r0.y, r0.y, l(256)
  add r17.x, -r21.x, l(1.000000)
  mul r18.w, r17.x, cb2[19].x
  ...
  mad r15.yzw, r17.yyzw, r9.wwww, r19.xxyz
  mov r16.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r17.yzw, r16.xyzw, t8.wxyz, s2, r13.w
  mad r9.w, cb2[19].x, r17.x, -r12.w
  mad r9.w, r2.y, r9.w, r12.w
  mad r18.xyz, r17.yzwy, r9.wwww, r18.xyzx
endif 
