...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  r10.w = (int)r10.z & -32;
  r11.y = (int)-r10.w + (int)r10.z;
  r11.z = numRefProbes & -32;
  r11.w = (int)-r11.z + numRefProbes;
  r13.xy = float2(0,0);
  r14.w = 0;
  r15.yz = float2(0,1);
  r16.xy = float2(0,0);
  ...
  while (true) {
    ...
    bitmask.y = ((~(-1 << r11.y)) << 0) & 0xffffffff;  r14.y = (((uint)0 << 0) & bitmask.y) | ((uint)r13.z & ~bitmask.y);
    r13.z = r14.x ? r14.y : r13.z;
    r14.x = cmp((int)r11.z == (int)r13.w);
    if (r11.w == 0) r14.y = 0; else if (r11.w+0 < 32) {     r14.y = (uint)r13.z << (32-(r11.w + 0)); r14.y = (uint)r14.y >> (32-r11.w);    } else r14.y = (uint)r13.z >> 0;
    r13.z = r14.x ? r14.y : r13.z;
      ...
      r24.y = samp0[]..swiz;
        ...
        r32.w = samp0[]..swiz;
          ...
          r33.w = samp0[]..swiz;
            ...
            r18.w = -r18.w * r23.w + 1;
            r18.w = r27.y * r18.w;
            r5.y = r27.w ? r18.w : r28.x;
            r27.xy = r27.zz ? r27.xy : r5.xy;
            r17.w = (int)r17.w + 1;
            r15.x = r26.w;
          }
          ...
          r38.y = samp0[]..swiz;
            ...
            r24.xyz = r12.xyz * r14.zzz + r24.xyz;
            ...
            r5.y = r10.y * r14.z + r5.y;
            r5.y = r15.x / r5.y;
            r24.x = r21.w;
            r24.yz = r22.xy;
            r22.xyw = r23.yzx * r5.yyy + r24.yzx;
            r21.w = r22.w;
          }
        }
      }
  ...
  if (r5.x != 0) {
    ...
    r11.w = 0;
    while (true) {
      r13.w = cmp((uint)r11.w >= (uint)r10.z);
      if (r13.w != 0) break;
      r13.z = (uint)r11.w >> 5;
      r14.xyz = (int3)r4.xyz + (int3)r13.xyz;
      r13.z = visibleProbes.Load(r14.xyzw).x;
      r13.w = cmp((int)r10.w == (int)r11.w);
      if (r11.y == 0) r14.x = 0; else if (r11.y+0 < 32) {       r14.x = (uint)r13.z << (32-(r11.y + 0)); r14.x = (uint)r14.x >> (32-r11.y);      } else r14.x = (uint)r13.z >> 0;
        ...
        r25.y = samp0[]..swiz;
          ...
          r33.w = samp0[]..swiz;
            ...
            r34.w = samp0[]..swiz;
              ...
              r27.w = -r27.w * r28.z + 1;
              r27.w = r28.y * r27.w;
              r5.y = r29.y ? r27.w : r29.z;
              r28.xy = r29.xx ? r28.xy : r5.xy;
              r24.w = (int)r24.w + 1;
              r15.x = r28.w;
            }
            r5.y = saturate(r28.y + -r15.w);
            r15.x = r5.y * r25.y;
            r18.w = cmp(0 < r15.x);
            if (r18.w != 0) {
            // Known bad code for instruction (needs manual fix):
            ...
            r39.y = samp0[]..swiz;
              ...
              r25.xyz = r12.xyz * r15.xxx + r25.xyz;
              ...
              r16.z = r15.x * r10.y;
              r24.xyz = r25.xyz * r5.yyy;
              r5.y = dot(r24.xyz, float3(0.212599993,0.715200007,0.0722000003));
              r5.y = r10.y * r15.x + r5.y;
              r5.y = r16.z / r5.y;
              r23.xyz = r24.xyz * r5.yyy + r23.xyz;
            }
          }
        }
      }
  ...
  r4.xyz = r19.xyz * r0.zzz;
  r10.yzw = r20.xyz * r0.zzz;
  r5.x = cmp(r20.w < 0.99000001);
  if (r5.x != 0) {
    r5.x = 1 + -r20.w;
    ...
    r4.xyz = r19.xyz * r0.zzz + r11.yzw;
    r12.w = 0;
    r11.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r12.xyzw, r8.w).xyz;
    r0.z = sunConstants.globalProbeExposure * r5.x + -r1.w;
    r0.z = r6.y * r0.z + r1.w;
    r10.yzw = r11.yzw * r0.zzz + r10.yzw;
  }
  if (useSSR != 0) {
    r0.z = dot(r2.yzw, r1.xyz);
    r0.z = r0.z + r0.z;
    r11.yzw = r1.xyz * -r0.zzz + r2.yzw;
    r0.z = dot(r2.yzw, -r1.xyz);
    r0.z = r0.z + r0.z;
    r12.xyz = r1.xyz * r0.zzz + r2.yzw;
    r11.yzw = v10.xxx ? r11.yzw : r12.xyz;
    if (useLoopedSSR != 0) {
      ...
      while (true) {
        ...
        r5.y = cmp(abs(r5.x) < r15.z);
        r6.y = cmp(abs(r5.x) >= v0.w);
        r5.y = r5.y ? r6.y : 0;
        if (r5.y != 0) {
          r5.x = r15.z + -abs(r5.x);
          r5.x = ssrParams.w * r5.x;
          r16.xyz = -r5.xxx * r13.xyz + r15.xyz;
          ...
          r5.xy = r16.xy / r16.zz;
          r5.xy = r5.xy * float2(0.5,-0.5) + float2(0.5,0.5);
          r16.xyz = iResolveScene.SampleLevel(bilinearClamp_s, r5.xy, 0).xyz;
      ...
      r0.z = cmp(r0.z < 1);
      r0.z = r0.z ? r1.w : 0;
      r11.yzw = iResolveScene.Sample(bilinearClamp_s, r5.xy).xyz;
      if (r0.z != 0) {
        r10.yzw = relHDRExposure.xxx * r11.yzw;
      }
    }
  }
  ...
  if (r5.x == 0) {
    ...
    r5.x = -sunConstants.splitDepthOffset + r11.w;
    ...
    if (r6.y != 0) {
      ...
      while (true) {
        ...
        if (r9.w != 0) break;
        r9.w = (uint)r6.y;
        r12.xy = -sunConstants.splitPinTransform[r9.w].xy + r11.yz;
        r12.x = max(abs(r12.x), abs(r12.y));
        r8.w = sunConstants.splitPinTransform[r9.w].z * r12.x;
        r9.w = cmp(r8.w < 1);
        if (r9.w != 0) {
          break;
        }
    ...
    if (r9.w != 0) {
      ...
      r13.xz = rcp(r12.xx);
      r13.y = -r13.z;
      r12.xyz = r11.yzy * r13.xyz + r12.yzy;
    ...
    r13.x = samp0[]..swiz;
      ...
      r15.w = samp0[]..swiz;
        ...
        if (r12.w == 0) {
          r12.w = (int)-r13.y + 6;
          r14.xy = (uint2)r12.zy >> (uint2)r12.ww;
        ...
        r15.z = samp0[]..swiz;
          ...
          r13.y = (int)-r15.y + 6;
          r14.yz = (uint2)r12.zy >> (uint2)r13.yy;
        ...
        r14.z = samp0[]..swiz;
          ...
          r12.x = (uint)r14.z >> (uint)r15.x;
          r12.x = (int)r12.x & 255;
          r12.x = (uint)r12.x;
          r12.x = r12.x * r14.x;
          r12.x = r12.x * 0.00392156886 + r13.y;
          r12.y = (int)r15.y + 1;
        ...
        r12.y = samp0[]..swiz;
          ...
          r12.y = (uint)r12.y;
          r12.y = r12.y * r14.x;
          r12.y = r12.y * 1.52590219e-05 + r13.y;
          r13.z = r14.y ? r12.x : r12.y;
        } else {
    ...
    if (r9.w == 0) {
      if (enableDitheredShadow == 0) {
        r9.w = (uint)r6.y;
        r12.xy = -sunConstants.splitPinTransform[r9.w].xy + r11.yz;
        r12.xy = sunConstants.splitPinTransform[r9.w].zz * r12.xy;
        r12.xy = r12.xy * float2(0.5,-0.5) + float2(0.5,0.5);
        r9.w = (int16)sunConstants.splitArrayOffset;
        r12.z = r9.w + r6.y;
        r9.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r12.xyz, r5.x).x;
      ...
      if (enableDitheredShadow != 0) {
        ...
        r8.w = 28 * r8.w;
        r8.w = (uint)r8.w;
        r13.xy = -sunConstants.splitPinTransform[r9.w].xy + r11.yz;
        r13.xy = sunConstants.splitPinTransform[r9.w].zz * r13.xy;
        r13.xy = r13.xy * float2(0.5,-0.5) + float2(0.5,0.5);
        r11.yz = -sunConstants.splitPinTransform[r6.y].xy + r11.yz;
        r11.yz = sunConstants.splitPinTransform[r6.y].zz * r11.yz;
        ...
        while (true) {
          ...
          if (r13.z != 0) break;
          r13.z = cmp((uint)r8.w < (uint)r12.w);
          r14.xy = r13.zz ? r11.yz : r13.xy;
          r13.w = r13.z ? sunConstants.splitPinTransform[r6.y].w : sunConstants.splitPinTransform[r9.w].w;
          r13.z = r13.z ? r6.y : r9.w;
          r15.x = dot(icb[r12.w+0].yx, r12.xy);
          r15.y = dot(icb[r12.w+0].yx, r12.yz);
          r14.xy = r15.xy * r13.ww + r14.xy;
          r13.z = (int)r13.z + (int16)sunConstants.splitArrayOffset;
          r14.z = (uint)r13.z;
          r13.z = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r14.xyz, r5.x).x;
  ...
  r17.w = samp0[]..swiz;
    ...
    r18.w = 1;
    r12.x = dot(r12.xyzw, r18.xyzw);
    r12.y = dot(r13.xyzw, r18.xyzw);
    r0.z = dot(r14.xyzw, r18.xyzw);
    r8.w = dot(r15.xyzw, r18.xyzw);
    r9.w = cmp(r8.w < r0.z);
    r11.yz = r12.xy / r8.ww;
    r11.yz = r11.yz * float2(0.5,-0.5) + float2(0.5,0.5);
    r11.yz = r11.yz + r17.zw;
    r11.yz = r11.yz * r17.xy;
    r12.xy = r6.yy / r16.xz;
    ...
    r12.y = samp0[]..swiz;
      ...
      r13.xy = r11.yz * r16.xz + r16.yw;
      r5.x = r12.y * r8.w;
      r0.z = r12.x * r8.w + r0.z;
      r0.z = r0.z / r5.x;
      ...
      if (enableDitheredShadow != 0) {
        ...
        r9.w = 0;
        while (true) {
          r10.x = cmp((int)r9.w >= 8);
          if (r10.x != 0) break;
          r11.x = dot(icb[r9.w+0].yx, r12.xy);
          r11.y = dot(icb[r9.w+0].yx, r12.yz);
          r14.xy = r11.xy * r6.yy + r13.xy;
          r10.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r14.xyz, r0.z).x;
          r8.w = r10.x * 0.125 + r8.w;
          r9.w = (int)r9.w + 1;
        }
      } else {
        r13.z = (uint)r5.x;
        r8.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r13.xyz, r0.z).x;
      }
      r0.z = r8.w * r8.w;
      r0.z = r0.z * r8.w;
    } else {
  ...
  if (r5.x != 0) {
    ...
    r0.y = r1.w + r0.y;
    r0.y = r1.w / r0.y;
    r11.xyz = r3.xyz * r0.yyy + r4.xyz;
    r12.xyz = -v7.xyz * r6.zzz + sunConstants.wldDir.xyz;
    r0.y = dot(r12.xyz, r12.xyz);
    r0.y = rsqrt(r0.y);
    r12.xyz = r12.xyz * r0.yyy;
    r0.y = saturate(dot(r1.xyz, r12.xyz));
    r3.w = saturate(dot(r12.xyz, r9.xyz));
    r5.x = r0.y * r0.y;
    r5.xy = r5.xx * specularLobeRoughnessControl.xz + float2(1,1);
    r5.xy = r5.xy * r5.xy;
  ...
  r4.xyz = r0.zzz ? r11.xyz : r4.xyz;
  r3.xyz = r0.zzz ? r3.xyz : r10.yzw;
  r9.xyzw = colorMap.Sample(colorSampler_s, r5.zw).xyzw;
  r0.yz = viewMatrix._m10_m11 * r1.yy;
  r0.yz = r1.xx * viewMatrix._m00_m01 + r0.yz;
  r0.yz = r1.zz * viewMatrix._m20_m21 + r0.yz;
  r1.x = 1 + r4.w;
  r1.x = log2(r1.x);
  r1.x = lobeWeightingThicknessRefraction.w * r1.x;
  r1.x = min(500, r1.x);
  r0.yz = r1.xx * r0.yz + v0.xy;
  ...
  r1.w = r4.w * 2 + 1;
  r1.w = log2(r1.w);
  r5.x = 0.0833333358 * r1.w;
  r5.y = 0;
  r10.xyzw = rColorRamp.Sample(bilinearClamp_s, r5.xy).xyzw;
  r5.xyw = r10.xyz * r0.xyz;
  r1.w = r10.w * r9.w;
  r9.xyz = r9.xyz * r4.xyz + -r5.xyw;
  r5.xyw = r1.www * r9.xyz + r5.xyw;
  r1.xyz = -r1.xyz * relHDRExposure.xxx + r5.xyw;
  r0.xyz = r6.xxx * r1.xyz + r0.xyz;
  r1.xyz = r8.xyz * r4.xyz + -r0.xyz;
  ...
  r1.xyz = foamColor.xyz * r4.xyz + -r0.xyz;
