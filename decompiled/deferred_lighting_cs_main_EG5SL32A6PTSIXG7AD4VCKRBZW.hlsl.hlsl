...
r0.y = samplerLinear[]..swiz;
  ...
  r5.xyzw = gSSAOTexture.Gather(samplerLinearClamp_s, r4.zw).xyzw;
  r6.xyzw = gSSAODepthTexture.Gather(samplerLinearClamp_s, r4.zw).xyzw;
  r4.zw = float2(0.5,0.5) * r4.xy;
  r4.zw = frac(r4.zw);
  r7.xy = float2(1,1) + -r4.wz;
  r8.y = r7.y * r7.x;
  r8.xz = r7.xy * r4.zw;
  r8.w = r4.z * r4.w;
  r0.w = dot(r5.xyzw, r8.xyzw);
  r6.xyzw = r6.xyzw + -r0.zzzz;
  r4.z = min(abs(r6.z), abs(r6.w));
  r4.z = min(abs(r6.y), r4.z);
  r4.z = min(abs(r6.x), r4.z);
  r4.w = max(abs(r6.z), abs(r6.w));
  r4.w = max(abs(r6.y), r4.w);
  r4.w = max(abs(r6.x), r4.w);
  r6.xyz = cmp(r4.zzz == abs(r6.yzw));
  r4.z = r6.x ? r5.y : r5.x;
  r4.z = r6.y ? r5.z : r4.z;
  r4.z = r6.z ? r5.w : r4.z;
  r5.x = 0.00999999978 * r0.z;
  r4.w = cmp(r5.x < r4.w);
  r0.w = r4.w ? r4.z : r0.w;
  r0.w = r3.z * r0.w;
  if (showAO != 0) {
  ...
  r11.w = 0;
  r11.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r11.xyzw, r1.z).xyz;
  r1.z = sunConstants.globalProbeExposure + -r1.w;
  r1.z = r2.y * r1.z + r1.w;
