  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r1.xyz = sonarColorSampler_C1_P0.Sample(sonarColorSampler_C1_P0_sampler_s, r0.xy).xyz;
  r0.xyz = sonarColorSampler_C1_P0.Sample(sonarColorSampler_C1_P0_sampler_s, r0.zw).xyz;
  r0.xyz = r1.xyz + r0.xyz;
  r1.xyzw = BlurAmount * float4(-0.00695913937,0.00457136985,-0.00203344994,0.00620715972) + v1.xyxy;
  r2.xyz = sonarColorSampler_C1_P0.Sample(sonarColorSampler_C1_P0_sampler_s, r1.xy).xyz;
  r1.xyz = sonarColorSampler_C1_P0.Sample(sonarColorSampler_C1_P0_sampler_s, r1.zw).xyz;
  ...
  r0.w = 1510.09253 * v1.y;
  r0.w = sin(r0.w);
  r0.w = r0.w * 0.5 + 0.5;
  o0.x = r0.w * r0.x;
  r0.xy = r0.yz * r0.ww;
  o0.yz = float2(0.0833333358,0.0833333358) * r0.xy;
  o0.w = 1;
  return;
}