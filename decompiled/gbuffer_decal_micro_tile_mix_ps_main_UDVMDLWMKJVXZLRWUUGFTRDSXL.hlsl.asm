...
sample_indexable(texture2d)(float,float,float,float) r0.w, r2.xyxx, t12.yzwx, s2
mul r0.x, r0.x, r0.w
mad r0.yz, r0.yyzy, v12.zzwz, v12.xxyx
mul r1.xyz, r1.xyzx, l(0.100000, 0.100000, 0.100000, 0.000000)
frc r1.xyz, r1.xyzx
mul r2.xy, r0.yzyy, cb0[12].zwzz
sample_indexable(texture2d)(float,float,float,float) r0.w, r2.xyxx, t18.yzwx, s4
sample_indexable(texture2d)(float,float,float,float) r2.xyz, r0.yzyy, t11.xyzw, s3
...
sample_indexable(texture2d)(float,float,float,float) r6.xyz, r1.xyxx, t17.xyzw, s2
sample_indexable(texture2d)(float,float,float,float) r1.z, r1.xyxx, t15.yzxw, s2
...
sample_indexable(texture2d)(float,float,float,float) r1.xyz, r1.xyxx, t16.xyzw, s3
mad r6.xyz, r6.xyzx, r7.xyzx, -r5.xyzx
mad r5.xyz, r0.wwww, r6.xyzx, r5.xyzx
mul r5.xyz, r5.xyzx, v8.xyzx
mul r2.zw, r0.yyyz, cb0[16].zzzw
...
mul r0.x, r0.x, r4.z
exp r6.y, r0.x
mad_sat r4.zw, cb0[10].xxxx, r6.xxxy, r2.wwww
add r0.x, r2.z, -r4.z
add r2.z, -r4.z, r4.w
div_sat r0.x, r0.x, r2.z
add r2.z, -cb0[12].x, cb0[12].y
mul_sat r2.w, cb0[12].y, l(0.05882353)
mul_sat r4.z, cb0[15].y, l(0.05882353)
add r4.z, -r2.w, r4.z
mad r2.w, r0.w, r4.z, r2.w
...
mad r4.w, r3.w, cb0[13].x, r1.w
mad r3.xy, r1.xyxx, cb0[13].yyyy, r2.xyxx
dp3 r1.x, r3.xyzx, r3.xyzx
rsq r1.x, r1.x
mul r3.xyz, r1.xxxx, r3.xyzx
mad r3.w, r1.z, cb0[13].y, r1.w
...
rsq r2.x, r2.x
mul r4.xyz, r2.xxxx, v6.xyzx
dp3 r2.x, v7.xyzx, v7.xyzx
rsq r2.x, r2.x
mul r6.xyz, r2.xxxx, v7.xyzx
mul r2.x, r2.w, l(-17.000000)
exp r2.x, r2.x
add r1.w, r1.w, r2.x
log r1.w, r1.w
mul_sat r1.w, r1.w, l(-0.05882353)
mul r2.xyw, r1.yyyy, r6.xyxz
mad r2.xyw, r4.xyxz, r1.xxxx, r2.xyxw
mad r1.xyz, r3.xyzx, r1.zzzz, r2.xywx
dp3 r2.x, r1.xyzx, r1.xyzx
rsq r2.x, r2.x
mul r1.xyz, r1.xyzx, r2.xxxx
mad r2.x, cb1[62].x, r2.z, cb0[12].x
mul_sat r2.x, r2.x, l(0.05882353)
lt r2.y, l(0.000000), cb1[64].w
if_nz r2.y
  ftoi r2.y, cb1[64].w
  lod r2.z, r0.yzyy, t9.y, s2
  lod r0.y, r0.yzyy, t9.x, s2
  lt r0.z, r2.z, r0.y
  lt r0.y, l(0.000000), r0.y
  and r2.yzw, r2.yyyy, l(0, 1, 2, 4)
  movc r3.xyz, r2.yyyy, l(1.000000,0,1.000000,0), r5.xyzx
  movc r4.xyz, r2.zzzz, l(0,1.000000,1.000000,0), r5.xyzx
  movc r3.xyz, r0.yyyy, r3.xyzx, r4.xyzx
  movc r2.yzw, r2.wwww, l(0,0,1.000000,0), r5.xxyz
  movc r5.xyz, r0.zzzz, r3.xyzx, r2.yzwy
endif 
add r2.yzw, -r5.xxyz, cb1[58].xxyz
mad r2.yzw, cb1[58].wwww, r2.yyzw, r5.xxyz
...
mad r4.z, cb1[63].w, r0.z, l(1.000000)
mad r5.xyz, v5.xyzx, r0.wwww, -r1.xyzx
mad r1.xyz, cb1[60].wwww, r5.xyzx, r1.xyzx
mul o0.xyz, r0.xxxx, r2.yzwy
ftou r2.xy, v0.xyxx
mov r2.zw, l(0,0,0,0)
