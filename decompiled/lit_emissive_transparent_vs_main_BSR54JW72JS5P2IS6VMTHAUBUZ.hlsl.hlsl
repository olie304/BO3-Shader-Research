// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:35:15 2021
...
r1.z = gpuSkinBase[]..swiz;
  ...
  if (forceIsolateHack != 0) {
    ...
    r2.w = r1.z * 0.899999976 + r2.x;
    r2.w = 0.699999988 * r2.w;
    r2.w = sin(r2.w);
    r3.x = r1.w * 0.699999988 + r2.x;
    ...
    r1.x = r1.z * 0.899999976 + r1.x;
    r1.x = 0.0700000003 * r1.x;
    r1.x = sin(r1.x);
    r1.x = r1.x * 0.5 + 0.5;
    r1.y = r1.w * 0.699999988 + r1.y;
