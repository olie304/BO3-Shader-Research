...
r1.w = samp0[]..swiz;
  ...
  while (true) {
    ...
    r11.w = cmp((int)r0.y == (int)r11.y);
    bitmask.w = ((~(-1 << r0.z)) << 0) & 0xffffffff;  r13.w = (((uint)0 << 0) & bitmask.w) | ((uint)r11.z & ~bitmask.w);
      ...
      r15.y = samp0[]..swiz;
        ...
        r32.w = samp0[]..swiz;
          ...
          r38.y = samp0[]..swiz;
            ...
            r4.y = dot(r15.xyz, float3(0.212599993,0.715200007,0.0722000003));
            r4.y = r7.w * r14.z + r4.y;
            r4.y = r14.w / r4.y;
            r24.x = r22.w;
            r24.yz = r23.xy;
            r23.xyw = r15.yzx * r4.yyy + r24.yzx;
            r22.w = r23.w;
          }
        }
      }
  ...
  if (r4.x != 0) {
    ...
    r10.w = 0;
    while (true) {
      r13.w = cmp((uint)r10.w >= (uint)r9.z);
      if (r13.w != 0) break;
      r14.z = (uint)r10.w >> 5;
      r15.xyz = (int3)r13.xyz + (int3)r14.xyz;
      r13.w = visibleProbes.Load(r15.xyzw).x;
      r14.z = cmp((int)r0.y == (int)r10.w);
      if (r0.z == 0) r14.w = 0; else if (r0.z+0 < 32) {       r14.w = (uint)r13.w << (32-(r0.z + 0)); r14.w = (uint)r14.w >> (32-r0.z);      } else r14.w = (uint)r13.w >> 0;
      ...
      while (true) {
        ...
        r25.y = samp0[]..swiz;
          ...
          r33.w = samp0[]..swiz;
            ...
            r16.x = r25.z * r24.w;
            r24.w = (int)r25.x & 1;
            r25.zw = r24.ww ? r16.xy : r16.zx;
            r16.x = r25.x;
            r28.xy = r25.zw;
            r24.w = 1;
            while (true) {
              r27.w = cmp((int)r24.w >= (int)r19.w);
              if (r27.w != 0) break;
            ...
            r34.w = samp0[]..swiz;
              ...
              r28.x = r28.z * r27.w;
              r28.w = (uint)r16.x >> 2;
              if (1 == 0) r29.x = 0; else if (1+2 < 32) {               r29.x = (uint)r16.x << (32-(1 + 2)); r29.x = (uint)r29.x >> (32-1);              } else r29.x = (uint)r16.x >> 2;
              r29.y = (int)r28.w & 2;
            ...
            r39.y = samp0[]..swiz;
              ...
              r25.xyz = r12.xyz * r16.xxx + r25.xyz;
              ...
              r34.w = (uint)r17.w;
              r25.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r34.xyzw, r16.x).xyz;
  ...
  if (useSSR != 0) {
    ...
    if (useLoopedSSR != 0) {
      ...
      r15.xyz = ssrParams.zzz * r7.yzw;
      r16.xyz = viewMatrix._m10_m11_m12 * r15.yyy;
      r15.xyw = r15.xxx * viewMatrix._m00_m01_m02 + r16.xyz;
      r15.xyz = r15.zzz * viewMatrix._m20_m21_m22 + r15.xyw;
      r0.y = min(1000, ssrParams.x);
      r12.xyz = r15.xyz * float3(10,10,10) + r12.xyz;
      ...
      while (true) {
        ...
        r18.xyz = r17.xxx * projectionMatrix._m00_m01_m03 + r18.xyz;
        r18.xyz = r17.zzz * projectionMatrix._m20_m21_m23 + r18.xyz;
        r18.xyz = projectionMatrix._m30_m31_m33 + r18.xyz;
        r1.w = max(abs(r18.x), abs(r18.y));
        r1.w = cmp(r18.z < r1.w);
        if (r1.w != 0) {
          break;
        }
        ...
        r4.x = cmp(abs(r1.w) < r17.z);
        r4.y = cmp(abs(r1.w) >= v0.w);
        r4.x = r4.y ? r4.x : 0;
        if (r4.x != 0) {
          r1.w = r17.z + -abs(r1.w);
          r1.w = ssrParams.w * r1.w;
          r18.xyz = -r1.www * r15.xyz + r17.xyz;
          r19.xyz = projectionMatrix._m10_m11_m13 * r18.yyy;
          r18.xyw = r18.xxx * projectionMatrix._m00_m01_m03 + r19.xyz;
          r18.xyz = r18.zzz * projectionMatrix._m20_m21_m23 + r18.xyw;
          r18.xyz = projectionMatrix._m30_m31_m33 + r18.xyz;
          r4.xy = r18.xy / r18.zz;
          r4.xy = r4.xy * float2(0.5,-0.5) + float2(0.5,0.5);
          r18.xyz = iResolveScene.SampleLevel(bilinearClamp_s, r4.xy, 0).xyz;
          r18.xyz = relHDRExposure.xxx * r18.xyz;
          r16.xyz = r18.xyz;
          break;
        }
        r0.z = (int)r0.z + 1;
      ...
      r12.xyz = viewProjectionMatrix._m10_m11_m13 * r7.zzz;
      r12.xyz = r7.yyy * viewProjectionMatrix._m00_m01_m03 + r12.xyz;
      r7.yzw = r7.www * viewProjectionMatrix._m20_m21_m23 + r12.xyz;
      ...
      if (r1.w != 0) {
        r14.xyz = relHDRExposure.xxx * r7.yzw;
      }
    }
  }
  ...
  if (r1.w == 0) {
    ...
    if (r4.y != 0) {
      ...
      while (true) {
        ...
        if (r9.z != 0) break;
        r9.z = (uint)r4.y;
        r12.xy = -sunConstants.splitPinTransform[r9.z].xy + r7.yz;
        r9.w = max(abs(r12.x), abs(r12.y));
    ...
    if (r9.z != 0) {
      ...
      r15.xz = rcp(r12.xx);
      r15.y = -r15.z;
      r12.xyz = r7.yzy * r15.xyz + r12.yzy;
      ...
      r12.xyz = min(r12.xyz, r15.xyz);
      r15.xy = sunConstants.sstLightingConstants.coordScale * r12.zy;
      r15.xy = floor(r15.xy);
    ...
    r10.w = samp0[]..swiz;
      ...
      r16.z = samp0[]..swiz;
        ...
        r18.xy = (uint2)r12.zy >> (uint2)r17.yy;
      ...
      r12.w = samp0[]..swiz;
        r12.w = r18.y ? r16.z : r12.w;
        r14.w = (uint)r12.w >> 13;
        r12.w = r18.x ? r14.w : r12.w;
      ...
      r17.w = samp0[]..swiz;
        ...
        if (r9.w == 0) {
          r9.w = (int)-r15.y + 6;
          r16.xy = (uint2)r12.zy >> (uint2)r9.ww;
        ...
        r16.w = samp0[]..swiz;
          ...
          r9.w = (int)-r16.y + 6;
          r15.yw = (uint2)r12.zy >> (uint2)r9.ww;
          r9.w = (int)r16.w & 0xc0000000;
          r10.w = (int)r16.w | 0x40000000;
          bitmask.w = ((~(-1 << 1)) << 1) & 0xffffffff;  r12.w = (((uint)r15.w << 1) & bitmask.w) | ((uint)0 & ~bitmask.w);
          bitmask.w = ((~(-1 << 1)) << 0) & 0xffffffff;  r12.w = (((uint)r15.y << 0) & bitmask.w) | ((uint)r12.w & ~bitmask.w);
          r12.w = (int)r12.w * 10;
        ...
        r17.z = samp0[]..swiz;
          ...
          r10.w = (int)-r17.y + 6;
          r15.yw = (uint2)r12.zy >> (uint2)r10.ww;
        ...
        r14.w = samp0[]..swiz;
          ...
          r12.x = (uint)r14.w >> (uint)r16.x;
          r12.x = (int)r12.x & 255;
          r12.x = (uint)r12.x;
          r12.x = r12.x * r12.w;
          r12.x = r12.x * 0.00392156886 + r10.w;
          r12.y = (int)r16.y + 1;
        ...
        r12.y = samp0[]..swiz;
          ...
          r12.y = (uint)r12.y;
          r12.y = r12.y * r12.w;
          r10.w = r12.y * 1.52590219e-05 + r10.w;
          r13.w = r15.w ? r12.x : r10.w;
        } else {
        ...
        r12.x = samp0[]..swiz;
          ...
          r12.x = r7.y * r12.y + r12.x;
          r10.w = r7.z * r10.w + r12.x;
    ...
    if (r9.z == 0) {
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          if (r13.w != 0) break;
          r13.w = cmp((uint)r6.w < (uint)r12.w);
          r15.xy = r13.ww ? r7.yz : r9.zw;
          r14.w = r13.w ? sunConstants.splitPinTransform[r4.y].w : sunConstants.splitPinTransform[r7.w].w;
          r13.w = r13.w ? r4.y : r7.w;
          ...
          r15.z = (uint)r13.w;
          r13.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r15.xyz, r1.w).x;
  ...
  r19.w = samp0[]..swiz;
    ...
    r7.zw = r7.zw * r19.xy;
    r9.zw = r4.yy / r18.xz;
    r12.xy = float2(1,1) + -r9.zw;
    r12.xy = cmp(r7.zw >= r12.xy);
    r9.zw = cmp(r9.zw >= r7.zw);
    r9.zw = (int2)r9.zw | (int2)r12.xy;
    ...
    r9.w = samp0[]..swiz;
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          r7.z = cmp((int)r7.y >= 8);
          if (r7.z != 0) break;
          r17.x = dot(icb[r7.y+0].yx, r15.xy);
          r17.y = dot(icb[r7.y+0].yx, r15.yz);
          r16.xy = r17.xy * r4.yy + r12.xy;
          r7.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r0.y).x;
  ...
  if (r1.w != 0) {
    ...
    r1.w = r5.w + r0.z;
    r1.w = r0.z / r1.w;
    r12.xyz = r7.yzw * r1.www + r11.yzw;
    r15.xyz = -v6.xyz * r5.zzz + sunConstants.wldDir.xyz;
    r1.w = dot(r15.xyz, r15.xyz);
    r1.w = rsqrt(r1.w);
    r15.xyz = r15.xyz * r1.www;
    r1.w = saturate(dot(r1.xyz, r15.xyz));
    r4.x = saturate(dot(r15.xyz, r6.xyz));
    r4.y = r1.w * r1.w;
    ...
    r15.xyz = r7.yzw * r4.xxx;
    r15.xyz = r15.xyz * r0.zzz + r14.xyz;
    r7.yzw = r7.yzw * r4.yyy;
    r7.yzw = r7.yzw * r0.zzz + r15.xyz;
  } else {
    r12.xyz = r11.yzw;
    r7.yzw = r14.xyz;
  }
  r11.yzw = r0.yyy ? r12.xyz : r11.yzw;
  r7.yzw = r0.yyy ? r7.yzw : r14.xyz;
  r12.x = -r9.x;
  r14.xy = float2(0,0);
  r15.w = 0;
  r16.xyz = v6.xyz;
  ...
  while (true) {
    ...
    r14.z = (uint)r0.z >> 5;
    r15.xyz = (int3)r13.xyz + (int3)r14.xyz;
    r1.w = visibleLights.Load(r15.xyzw).x;
    r15.xyz = r22.xyz;
    r24.xyz = r23.xyz;
    r4.x = r0.y;
    r4.y = r1.w;
    while (true) {
      if (r4.y == 0) break;
      r5.z = firstbitlow((uint)r4.y);
      r6.w = 1 << (int)r5.z;
      r9.z = (int)r4.y & (int)r6.w;
      if (r9.z != 0) {
        r4.y = (int)r4.y ^ (int)r6.w;
        r5.z = (int)r0.z + (int)r5.z;
      // Known bad code for instruction (needs manual fix):
      ...
      r31.w = samp0[]..swiz;
        ...
        switch (r6.w) {
          ...
          r34.xyz = -v6.xyz + r33.xyz;
          r9.z = dot(r32.xyz, r34.xyz);
          r9.z = saturate(-r9.z / r31.x);
          r32.xyz = r9.zzz * r32.xyz + r33.xyz;
          r32.xyz = r6.www ? r32.xyz : r25.xyz;
          r32.xyz = -v6.xyz + r32.xyz;
          r6.w = dot(r32.xyz, r32.xyz);
          r9.z = rsqrt(r6.w);
          r33.xyz = r32.xyz * r9.zzz;
          r9.w = dot(r1.xyz, r33.xyz);
          r10.w = saturate(r9.w);
          r10.w = useSpecularZFeather ? abs(r9.w) : r10.w;
          r13.w = cmp(0 < r10.w);
          if (r13.w != 0) {
            r13.w = sqrt(r6.w);
            r14.z = r28.y * r28.y;
            r6.w = r14.z / r6.w;
            r6.w = min(1, r6.w);
            r14.z = saturate(r13.w * r27.y + r27.z);
            r13.w = saturate(r13.w * r27.w + r28.x);
            r14.w = r14.z * r14.z;
            r14.z = r14.z * -2 + 3;
            r14.z = r14.w * r14.z;
            r6.w = r14.z * r6.w;
            ...
            r13.w = cmp(0 < r6.w);
            if (r13.w != 0) {
              if (3 == 0) r14.z = 0; else if (3+27 < 32) {               r14.z = (uint)r27.x << (32-(3 + 27)); r14.z = (uint)r14.z >> (32-3);              } else r14.z = (uint)r27.x >> 27;
              if (4 == 0) r14.w = 0; else if (4+20 < 32) {               r14.w = (uint)r27.x << (32-(4 + 20)); r14.w = (uint)r14.w >> (32-4);              } else r14.w = (uint)r27.x >> 20;
              r13.w = cmp((int)r14.z != 1);
              if (r13.w != 0) {
                r13.w = abs(r9.w) * -0.200000003 + 0.400000006;
                r14.z = cmp(r9.w < 0);
                r14.z = r5.y ? r14.z : 0;
                r13.w = r14.z ? -r13.w : r13.w;
                r33.xyz = r1.xyz * r13.www + v6.xyz;
                r29.z = r30.x;
                ...
                while (true) {
                  ...
                  if (r22.w != 0) break;
                  r35.y = dot(icb[r21.w+0].yx, r12.xy);
                  r35.z = dot(icb[r21.w+0].yx, r12.yz);
                  r35.yz = r35.yz * r28.zz;
                  r35.x = r35.y * r11.x;
                  r35.w = r35.y * r7.x;
                  r34.xyz = r33.xyz * r14.zzz + r35.xzw;
                  r22.w = gOmniShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r34.xyzw, r13.w).x;
                  r18.w = r22.w * 0.125 + r18.w;
                  r21.w = (int)r21.w + 1;
                }
              } else {
                r18.w = 1;
              ...
              r34.w = samp0[]..swiz;
                ...
                r9.w = cmp(r9.w < 0);
                r9.w = r5.y ? r9.w : 0;
                r9.w = r9.w ? -r14.w : r14.w;
                r17.xyz = r1.xyz * r9.www + v6.xyz;
                r9.w = dot(r33.xyzw, r17.xyzw);
                r14.w = dot(r34.xyzw, r17.xyzw);
                r21.w = cmp(r14.w < r9.w);
                if (r21.w == 0) {
                // Known bad code for instruction (needs manual fix):
                ...
                r37.x = samp0[]..swiz;
                r37.y = samp0[]..swiz;
                  r33.x = dot(r33.xyzw, r17.xyzw);
                  r33.y = dot(r34.xyzw, r17.xyzw);
                  r17.xy = r33.xy / r14.ww;
                  r17.xy = r17.xy * float2(0.5,-0.5) + float2(0.5,0.5);
                  r17.xy = r17.xy + r36.zw;
                  r17.xy = r17.xy * r36.xy;
                  r33.xy = r14.zz / r35.xz;
                  r33.zw = float2(1,1) + -r33.xy;
                  r33.zw = cmp(r17.xy >= r33.zw);
                  r33.xy = cmp(r33.xy >= r17.xy);
                  r33.xy = (int2)r33.xy | (int2)r33.zw;
                  r17.z = (int)r33.y | (int)r33.x;
                  r17.xy = saturate(r17.xy);
                  r33.xy = r17.xy * r35.xz + r35.yw;
                  r17.x = r37.y * r14.w;
                  r9.w = r37.x * r14.w + r9.w;
                  r9.w = r9.w / r17.x;
                } else {
                  r17.z = -1;
                }
                r14.w = (int)r21.w | (int)r17.z;
                if (r14.w == 0) {
                // Known bad code for instruction (needs manual fix):
                ...
                r13.w = samp0[]..swiz;
                  ...
                  if (r4.x != 0) {
                    ...
                    while (true) {
                      r22.w = cmp((int)r21.w >= 8);
                      if (r22.w != 0) break;
                      r34.x = dot(icb[r21.w+0].yx, r12.xw);
                      r34.y = dot(icb[r21.w+0].xy, r9.xy);
                      r17.xy = r34.xy * r14.zz + r33.xy;
                      r17.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r17.xyz, r9.w).x;
                      r14.w = r17.x * 0.125 + r14.w;
                      r21.w = (int)r21.w + 1;
                    }
                  } else {
                    r33.z = (uint)r13.w;
                    r14.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r33.xyz, r9.w).x;
                  }
                  r9.w = r14.w * r14.w;
                  r9.w = r9.w * r14.w;
                } else {
              ...
              if (r9.w != 0) {
                r26.z = r25.w;
                r17.xyz = r6.www * r26.zxy;
                r6.w = r10.w + r5.w;
                r6.w = r10.w / r6.w;
                r15.xyz = r17.xyz * r6.www + r15.xyz;
                r32.xyz = r32.xyz * r9.zzz + r6.xyz;
                r6.w = dot(r32.xyz, r32.xyz);
                r6.w = rsqrt(r6.w);
                r32.xyz = r32.xyz * r6.www;
                r6.w = saturate(dot(r1.xyz, r32.xyz));
                r9.z = saturate(dot(r32.xyz, r6.xyz));
                r9.w = r6.w * r6.w;
                ...
                r32.xyz = r17.xyz * r9.zzz;
                r32.xyz = r32.xyz * r10.www + r24.xyz;
                r17.xyz = r17.xyz * r9.www;
                r24.xyz = r17.xyz * r10.www + r32.xyz;
              }
            }
          }
          break;
          ...
          r6.w = rsqrt(r6.w);
          r32.xyz = r17.xyz * r6.www;
          r9.z = dot(r1.xyz, r32.xyz);
          r9.w = saturate(r9.z);
          r9.w = useSpecularZFeather ? abs(r9.z) : r9.w;
          r10.w = cmp(0 < r9.w);
          if (r10.w != 0) {
          // Known bad code for instruction (needs manual fix):
          ...
          r33.w = samp0[]..swiz;
            ...
            r14.z = samp0[]..swiz;
              ...
              r21.w = r21.w / r22.w;
              r21.w = min(1, r21.w);
              r22.w = saturate(r10.w * r27.y + r27.z);
              r23.w = saturate(r10.w * r27.w + r28.x);
              r24.w = r22.w * r22.w;
              r22.w = r22.w * -2 + 3;
              r22.w = r24.w * r22.w;
              r21.w = r22.w * r21.w;
              ...
              r21.w = r22.w * r21.w;
              r29.zw = r30.xy;
              r25.x = dot(r29.xyzw, r16.xyzw);
              r39.xy = r30.zw;
              r39.zw = r31.zw;
              r25.y = dot(r39.xyzw, r16.xyzw);
              r18.xy = r25.xy / r10.ww;
              r10.w = cmp(r36.w < 0.00048828125);
              if (r10.w != 0) {
                r37.y = r38.x;
                r25.xy = saturate(abs(r18.xy) * r37.zw + r37.xy);
                ...
                r36.w = r37.y;
                r36.xyzw = saturate(r36.xyzw * abs(r18.yyxx));
            ...
            r10.w = cmp(0 < r13.w);
            if (r10.w != 0) {
              if (3 == 0) r18.x = 0; else if (3+27 < 32) {               r18.x = (uint)r27.x << (32-(3 + 27)); r18.x = (uint)r18.x >> (32-3);              } else r18.x = (uint)r27.x >> 27;
              if (4 == 0) r18.y = 0; else if (4+20 < 32) {               r18.y = (uint)r27.x << (32-(4 + 20)); r18.y = (uint)r18.y >> (32-4);              } else r18.y = (uint)r27.x >> 20;
              r10.w = cmp((int)r18.x != 1);
              if (r10.w != 0) {
                r10.w = abs(r9.z) * -0.200000003 + 0.400000006;
                r14.z = cmp(r9.z < 0);
                r14.z = r5.y ? r14.z : 0;
                r10.w = r14.z ? -r10.w : r10.w;
                r19.xyz = r1.xyz * r10.www + v6.xyz;
                r32.xy = r31.xy;
                r10.w = dot(r32.xyzw, r19.xyzw);
                r14.z = dot(r34.xyzw, r19.xyzw);
                r18.x = cmp(r14.z >= r10.w);
                if (r18.x != 0) {
                // Known bad code for instruction (needs manual fix):
                ...
                r33.y = samp0[]..swiz;
                  r29.zw = r30.xy;
                  r26.x = dot(r29.xyzw, r19.xyzw);
                  r31.xy = r30.zw;
                  r26.y = dot(r31.xyzw, r19.xyzw);
                  r19.xy = r26.xy / r14.zz;
                  r19.xy = saturate(r19.xy * float2(0.5,-0.5) + float2(0.5,0.5));
                  r19.xy = r19.xy * r33.zx + r33.wy;
                  r5.z = r10.w / r14.z;
                  ...
                  if (r4.x != 0) {
                    ...
                    while (true) {
                      ...
                      if (r21.w != 0) break;
                      r27.x = dot(icb[r18.x+0].xy, r10.xy);
                      r27.y = dot(icb[r18.x+0].yx, r10.xz);
                      r26.xy = r27.xy * r28.zz + r19.xy;
                      r21.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r26.xyz, r5.z).x;
                      r14.z = r21.w * 0.125 + r14.z;
                      r18.x = (int)r18.x + 1;
                    }
                  } else {
                    r19.z = (uint)r10.w;
              ...
              r31.z = samp0[]..swiz;
              r31.w = samp0[]..swiz;
                r18.x = abs(r9.z) * -0.200000003 + 0.400000006;
                r9.z = cmp(r9.z < 0);
                r9.z = r5.y ? r9.z : 0;
                r9.z = r9.z ? -r18.x : r18.x;
                r20.xyz = r1.xyz * r9.zzz + v6.xyz;
                r18.x = dot(r26.xyzw, r20.xyzw);
                r18.y = dot(r27.xyzw, r20.xyzw);
                r9.z = dot(r28.xyzw, r20.xyzw);
                r19.x = dot(r29.xyzw, r20.xyzw);
                r19.y = cmp(r19.x < r9.z);
                r18.xy = r18.xy / r19.xx;
                r18.xy = r18.xy * float2(0.5,-0.5) + float2(0.5,0.5);
                r18.xy = r18.xy + r31.zw;
                r18.xy = r18.xy * r31.xy;
                r20.xy = r13.ww / r30.xz;
                r26.xy = float2(1,1) + -r20.xy;
                r26.xy = cmp(r18.xy >= r26.xy);
                r20.xy = cmp(r20.xy >= r18.xy);
                r20.xy = (int2)r20.xy | (int2)r26.xy;
                r19.z = (int)r20.y | (int)r20.x;
                r19.y = (int)r19.y | (int)r19.z;
                if (r19.y == 0) {
                // Known bad code for instruction (needs manual fix):
                ...
                r20.y = samp0[]..swiz;
                  ...
                  r26.xy = r18.xy * r30.xz + r30.yw;
                  r10.w = r20.y * r19.x;
                  r9.z = r20.x * r19.x + r9.z;
                  r9.z = r9.z / r10.w;
                  r9.z = max(6.10351563e-05, r9.z);
                  r10.w = r19.y ? 0.000000 : 0;
                  if (r4.x != 0) {
                    r19.z = (uint)r10.w;
                    r18.xy = float2(0,0);
                    while (true) {
                      r20.x = cmp((int)r18.y >= 8);
                      if (r20.x != 0) break;
                      r20.x = dot(icb[r18.y+0].xy, r21.xy);
                      r20.y = dot(icb[r18.y+0].yx, r21.xz);
                      r19.xy = r20.xy * r13.ww + r26.xy;
                      r19.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r19.xyz, r9.z).x;
                      r18.x = r19.x * 0.125 + r18.x;
                      r18.y = (int)r18.y + 1;
                    }
                  } else {
                    r26.z = (uint)r10.w;
                    r18.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r26.xyz, r9.z).x;
                  }
                  r9.z = r18.x * r18.x;
                  r9.z = r9.z * r18.x;
                } else {
              ...
              r9.z = cmp(0 < r5.z);
              if (r9.z != 0) {
                r19.xyz = r5.zzz * r25.xyz;
                r5.z = r9.w + r5.w;
                r5.z = r9.w / r5.z;
                r15.xyz = r19.xyz * r5.zzz + r15.xyz;
                r17.xyz = r17.xyz * r6.www + r6.xyz;
                r5.z = dot(r17.xyz, r17.xyz);
                r5.z = rsqrt(r5.z);
                r17.xyz = r17.xyz * r5.zzz;
                r5.z = saturate(dot(r1.xyz, r17.xyz));
                r6.w = saturate(dot(r17.xyz, r6.xyz));
                r9.z = r5.z * r5.z;
                r17.xy = r9.zz * specularLobeRoughnessControl.xz + float2(1,1);
                r17.xy = r17.xy * r17.xy;
                r17.xy = specularLobeRoughnessControl.yw / r17.xy;
                r17.xy = r17.xy * r5.zz;
                r5.z = 4 * r6.w;
                r17.xy = r17.xy / r5.zz;
                r17.xy = lobeWeightingThicknessRefraction.xy * r17.xy;
                r20.xyz = r19.xyz * r17.xxx;
                r20.xyz = r20.xyz * r9.www + r24.xyz;
                r17.xyz = r19.xyz * r17.yyy;
                r24.xyz = r17.xyz * r9.www + r20.xyz;
              }
            }
          }
          break;
