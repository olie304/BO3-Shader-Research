...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:36:13 2021
//
//
// Buffer Definitions: 
//
...
//   float2 glossScale1;                // Offset:  192 Size:     8
//   float2 glossScale2;                // Offset:  200 Size:     8
//   float2 glossRange2;                // Offset:  208 Size:     8
//
// }
//
...
// mixMap                            texture  float4          2d            t22      1 
// gSunShadowTree                    texture  struct         r/o            t23      1 
// glossMap2                         texture  float4          2d            t24      1 
...
dcl_output o0.xyzw
dcl_temps 46
sample_indexable(texture2d)(float,float,float,float) r0.x, v2.xyxx, t22.xyzw, s5
mul r1.xyzw, v2.xyxy, cb0[12].xyzw
sample_indexable(texture2d)(float,float,float,float) r0.y, r1.xyxx, t21.yxzw, s1
add r0.z, -cb0[10].y, cb0[10].z
mad r0.y, r0.y, r0.z, cb0[10].y
mul_sat r0.y, r0.y, l(0.05882353)
sample_indexable(texture2d)(float,float,float,float) r0.z, r1.zwzz, t24.yzxw, s1
add r0.w, -cb0[13].x, cb0[13].y
mad r0.z, r0.z, r0.w, cb0[13].x
mul_sat r0.z, r0.z, l(0.05882353)
add r0.z, -r0.y, r0.z
mad r0.x, r0.x, r0.z, r0.y
sample_indexable(texture2d)(float,float,float,float) r0.yzw, v2.xyxx, t0.wxyz, s3
...
sqrt r1.x, r1.x
mul r0.w, r0.w, r0.w
mul r0.xw, r0.xxxw, l(-17.000000, 0.000000, 0.000000, 0.33333334)
...
add r2.y, r2.y, r2.y
mad r11.xyz, r4.xyzx, -r2.yyyy, -r3.xyzx
mul r2.y, r0.y, l(17.000000)
exp r2.y, r2.y
add r2.y, r2.y, l(2.000000)
div r2.y, l(2.000000), r2.y
sqrt r2.z, r2.y
add r7.zw, -r0.yyyx, l(0.000000, 0.000000, 1.000000, 1.000000)
mul r2.w, r7.z, l(5.000000)
mad r3.w, r7.z, l(5.000000), l(-2.500000)
...
loop 
  ...
  ld_indexable(texture2darray)(uint,uint,uint,uint) r10.y, r13.xyzw, t7.yxzw
  ...
  sqrt r15.w, r15.w
  mad r15.w, r7.z, l(5.000000), r15.w
...
if_z r8.w
    ...
    loop 
      ...
      if_nz r15.w
        ...
        if_nz r14.w
          ...
          and r17.w, r16.z, l(1)
          movc r28.xy, r17.wwww, r14.xyxx, r14.zxzz
          mov r14.x, r16.z
          mov r29.xy, r28.xyxx
          mov r17.w, l(1)
          loop 
          ...
          if_nz r14.w
            ...
            mul r13.z, r26.z, r14.x
            mov r26.z, r34.z
            dp3 r14.x, r11.xyzx, r26.xyzx
            ...
            sqrt r14.x, r14.x
            mad r14.x, r7.z, l(5.000000), r14.x
            ...
            utof r34.w, r14.w
            sample_l_indexable(texturecubearray)(float,float,float,float) r16.yzw, r34.xyzw, t8.wxyz, s2, r14.x
            and r28.xyz, r16.yzwy, l(0x7fffffff, 0x7fffffff, 0x7fffffff, 0)
            ieq r28.xyz, r28.xyzx, l(0x7f800000, 0x7f800000, 0x7f800000, 0)
            or r14.x, r28.y, r28.x
            or r14.x, r28.z, r14.x
            movc r16.yzw, r14.xxxx, l(0,1.000000,1.000000,0), r16.yyzw
            ...
            mov r25.x, r23.w
            mov r25.yz, r24.xxyx
            mad r24.xyw, r16.zwzy, r13.zzzz, r25.yzyx
            mov r23.w, r24.w
          endif 
        endif 
      endif 
      ...
      loop 
        ...
        if_nz r17.w
          ...
          if_nz r16.w
            ...
            and r18.w, r27.x, l(1)
            movc r27.zw, r18.wwww, r14.xxxy, r14.zzzx
            mov r14.x, r27.x
            mov r30.xy, r27.zwzz
            mov r18.w, l(1)
            loop 
              ...
              mul r20.w, r20.w, r24.w
              dp3 r24.w, r34.xyzx, r29.xyzx
              add_sat r24.w, r34.w, r24.w
              mul r20.w, r20.w, r24.w
              dp3 r24.w, r35.xyzx, r29.xyzx
              add_sat r24.w, r35.w, r24.w
              mul r20.w, r20.w, r24.w
              dp3 r24.w, r36.xyzx, r29.xyzx
              ...
              movc r16.y, r30.z, r20.w, r30.w
              movc r30.xy, r29.wwww, r30.xyxx, r16.xyxx
              iadd r18.w, r18.w, l(1)
              mov r14.x, r26.w
            endloop 
            add_sat r14.x, -r14.w, r30.y
            mul r16.y, r27.y, r14.x
            ...
            if_nz r16.w
              ...
              mad r25.w, r14.x, r27.y, r25.w
              mul r14.x, r28.z, r16.y
              mov r28.z, r36.z
              dp3 r16.y, r11.xyzx, r28.xyzx
              ...
              min r16.y, |r16.z|, r16.y
              mov r38.z, r39.z
              dp3 r16.z, r11.xyzx, r38.xyzx
              dp3 r16.w, r29.xyzx, r38.xyzx
              add r16.w, -r39.w, r16.w
              ge r17.w, r16.w, l(0.000000)
              max r16.w, r3.w, |r16.w|
              movc r16.w, r17.w, r16.w, -r16.w
              max r16.z, -r16.z, l(0.00000010)
              ...
              min r16.y, |r16.z|, r16.y
              mov r39.z, r40.x
              dp3 r16.z, r11.xyzx, r39.xyzx
              dp3 r16.w, r29.xyzx, r39.xyzx
              ...
              min r16.y, |r16.z|, r16.y
              mov r41.zw, r40.zzzw
              dp3 r16.z, r11.zxyz, r41.xzwx
              dp3 r16.w, r29.zxyz, r41.xzwx
              add r16.w, -r41.y, r16.w
              ge r17.w, r16.w, l(0.000000)
              max r16.w, r3.w, |r16.w|
              movc r16.w, r17.w, r16.w, -r16.w
              max r16.z, -r16.z, l(0.00000010)
              ...
              mad r27.xyz, r11.xyzx, r16.yyyy, r27.xyzx
              dp3 r16.z, r27.xyzx, r27.xyzx
              sqrt r16.z, r16.z
              div r16.y, r16.y, r16.z
              add r16.y, r16.y, r16.y
              sqrt r16.y, r16.y
              mad r16.y, r7.z, l(5.000000), r16.y
              ...
              ubfe r16.z, l(9), l(16), r28.w
              utof r36.w, r16.z
              sample_l_indexable(texturecubearray)(float,float,float,float) r16.yzw, r36.xyzw, t8.wxyz, s2, r16.y
  ...
  if_nz r6.w
    ...
    mul r12.x, r10.y, cb2[35].w
    mul r12.yz, r10.zzwz, cb2[36].xxyx
    add_sat r10.yzw, r12.xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
    mul r12.xy, r10.yzyy, cb2[36].zwzz
    mul r12.z, r10.w, cb2[37].x
    add r10.yzw, r12.xxyz, cb2[37].yyzw
    lt r12.xyz, l(0.000000, 0.000000, 0.000000, 0.000000), r4.xyzx
    movc r12.xyz, r12.xyzx, l(0,0,0,0), l(0.500000,0.500000,0.500000,0)
    mov r12.w, l(0)
    add r13.xyz, r10.yzwy, r12.wwxw
    ...
    add r10.yzw, r10.yyzw, r12.wwwz
    sample_l_indexable(texture3d)(float,float,float,float) r10.yzw, r10.yzwy, t19.wxyz, s4, l(0.000000)
    mad r10.yzw, r10.yyzw, r14.zzzz, r13.xxyz
    mov r4.w, l(0)
    sample_l_indexable(texturecubearray)(float,float,float,float) r12.xyz, r4.xyzw, t8.xyzw, s2, l(6.000000)
    mul r10.yzw, r10.yyzw, r12.xxyz
    dp3 r4.w, r10.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
    mad r19.xyz, r21.xyzx, r3.wwww, r10.yzwy
    mov r11.w, l(0)
    sample_l_indexable(texturecubearray)(float,float,float,float) r10.yzw, r11.xyzw, t8.wxyz, s2, r2.w
...
mad r10.yz, r0.xxyx, l(0.000000, 0.984375, 0.984375, 0.000000), l(0.000000, 0.00781250, 0.00781250, 0.000000)
sample_l_indexable(texture2d)(float,float,float,float) r10.yz, r10.yzyy, t5.zxyw, s2, l(0.000000)
mul r12.xyz, r10.yyyy, r20.yzxy
mul r10.yzw, r10.zzzz, r20.xxyz
sqrt r0.y, r2.z
...
if_z r6.w
  ...
  if_nz r8.w
    ...
    mov r9.w, l(0)
    loop 
      ge r11.w, r8.w, l(3.000000)
      breakc_nz r11.w
      ftou r11.w, r8.w
      add r14.xy, r13.xyxx, -cb2[r11.w + 20].xyxx
      max r13.w, |r14.y|, |r14.x|
  ...
  if_nz r11.w
    ...
    if_z r15.x
      ...
      mov r16.y, l(0)
      mov r17.y, l(1)
      movc r15.xzw, r13.wwww, r16.xxyz, r17.xxyz
      movc r17.yz, r13.wwww, l(0,6,1,0), l(0,5,2,0)
      ...
      movc r15.xzw, r13.wwww, r16.xxyz, r15.xxzw
      and r13.w, r15.w, l(0xc0000000)
      if_z r13.w
        iadd r13.w, -r15.z, l(6)
        ushr r16.xy, r14.zyzz, r13.wwww
        ...
        ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r17.z, r17.x, l(0), t23.xxxx
        mov r17.y, r16.z
        movc r17.xyz, r13.wwww, r16.xywx, r17.xyzx
        ...
        movc r15.xw, r13.wwww, r16.xxxw, r16.yyyz
      endif 
      and r13.w, r15.w, l(0xc0000000)
      if_z r13.w
        ...
        movc r15.y, r13.w, r14.x, r15.y
      endif 
    endif 
    mad r13.z, -cb2[27].z, l(2.000000), r13.z
    lt r13.z, r15.y, r13.z
    movc r7.z, r13.z, l(0), l(1.000000)
  endif 
  if_z r11.w
    if_z cb2[58].y
      ftou r11.w, r8.w
      ...
      itof r11.w, cb2[26].y
      add r14.z, r8.w, r11.w
      sample_c_lz_indexable(texture2darray)(float,float,float,float) r11.w, r14.xyzx, t13.xxxx, s13, r6.w
    ...
    if_nz cb2[58].y
      ...
      loop 
        uge r15.y, r15.x, l(8)
        breakc_nz r15.y
        ult r15.y, r9.w, r15.x
        movc r15.zw, r15.yyyy, r13.xxxy, r13.zzzw
        movc r16.x, r15.y, cb2[r8.w + 20].w, cb2[r11.w + 20].w
        movc r15.y, r15.y, r8.w, r11.w
        dp2 r17.x, icb[r15.x + 0].yxyy, r14.xyxx
        dp2 r17.y, icb[r15.x + 0].yxyy, r14.yzyy
        mad r16.xy, r17.xyxx, r16.xxxx, r15.zwzz
        iadd r15.y, r15.y, cb2[26].y
        utof r16.z, r15.y
        sample_c_lz_indexable(texture2darray)(float,float,float,float) r15.y, r16.xyzx, t13.xxxx, s13, r6.w
        sample_l_indexable(texture2darray)(float,float,float,float) r15.z, r16.xyzx, t31.yzxw, s0, l(0.000000)
        add r15.y, r15.z, r15.y
        add_sat r15.y, r15.y, l(-1.000000)
        mad r14.w, r15.y, l(0.125000), r14.w
...
if_nz r6.w
  ...
  if_nz r6.w
    ...
    if_nz r8.w
      ...
      mad r17.xyz, r4.xyzx, r9.wwww, v7.xyzx
      ...
      if_z r9.w
        ...
        if_nz cb2[58].y
          ...
          loop 
            ...
            mad r15.xy, r16.xyxx, r8.wwww, r14.xyxx
            sample_c_lz_indexable(texture2darray)(float,float,float,float) r14.w, r15.xyzx, t9.xxxx, s13, r5.w
            mad r11.w, r14.w, l(0.125000), r11.w
            iadd r13.w, r13.w, l(1)
          endloop 
        else 
          utof r14.z, r9.w
          sample_c_lz_indexable(texture2darray)(float,float,float,float) r11.w, r14.xyzx, t9.xxxx, s13, r5.w
        endif 
    ...
    mad r13.xyz, r5.wwww, r5.xyzx, r19.xyzx
    mad r14.xyz, -v7.xyzx, r0.zzzz, cb2[17].xyzx
    ...
    mad r14.xyz, r4.wwww, r5.xyzx, r10.yzwy
    add_sat r0.z, -r0.z, l(1.000000)
    log r0.z, r0.z
    mul r0.z, r0.z, l(3.400000)
    exp r0.z, r0.z
    mul r0.z, r0.z, r4.w
    mad r5.xyz, r0.zzzz, r5.yzxy, r12.xyzx
    mov r13.w, r5.z
    mov r19.w, r12.z
    movc r19.xyzw, r3.wwww, r13.xyzw, r19.xyzw
    mov r5.zw, r14.xxxy
    mov r12.zw, r10.yyyz
    movc r5.xyzw, r3.wwww, r5.xyzw, r12.xyzw
    movc r10.w, r3.w, r14.z, r10.w
    mov r12.z, r19.w
    mov r12.xy, r5.xyxx
    mov r10.yz, r5.zzwz
  endif 
    ...
    if_nz r12.w
      ...
      if_nz r11.w
        ...
        switch r11.w
          ...
          rsq r18.w, r13.w
          mul r41.xyz, r18.wwww, r41.xyzx
          dp3 r18.w, r4.xyzx, r41.xyzx
          mov_sat r19.w, r18.w
            ...
            if_nz r23.w
              ...
              if_nz r23.w
                ...
                if_nz r13.z
                  ...
                  mad r24.w, |r18.w|, l(-0.200000), l(0.400000)
                  mad r16.xyz, r4.xyzx, r24.wwww, v7.xyzx
                  dp4 r24.w, r40.xyzw, r16.xyzw
                  dp4 r26.w, r41.xyzw, r16.xyzw
                  ...
                  if_z r27.w
                    ...
                    dp4 r40.x, r40.xyzw, r16.xyzw
                    dp4 r40.y, r41.xyzw, r16.xyzw
                    div r16.xy, r40.xyxx, r26.wwww
                    mad r16.xy, r16.xyxx, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
                    add r16.xy, r43.zwzz, r16.xyxx
                    mul r16.xy, r43.xyxx, r16.xyxx
                    div r40.xy, r13.zzzz, r42.xzxx
                    add r40.zw, -r40.xxxy, l(0.000000, 0.000000, 1.000000, 1.000000)
                    ge r40.zw, r16.xxxy, r40.zzzw
                    ge r40.xy, r40.xyxx, r16.xyxx
                    or r40.xy, r40.xyxx, r40.zwzz
                    or r16.z, r40.y, r40.x
                    mov_sat r16.xy, r16.xyxx
                    mad r40.xy, r16.xyxx, r42.xzxx, r42.ywyy
                    mul r16.x, r26.w, r44.y
                    mad r16.y, r44.x, r26.w, r24.w
                    div r16.x, r16.y, r16.x
                  else 
                    mov r16.z, l(-1)
                  endif 
                  or r16.y, r27.w, r16.z
                  if_z r16.y
                    ...
                    if_nz r7.z
                      ...
                      loop 
                        ige r24.w, r16.z, l(8)
                        breakc_nz r24.w
                        dp2 r42.x, icb[r16.z + 0].yxyy, r5.xwxx
                        dp2 r42.y, icb[r16.z + 0].xyxx, r7.xyxx
                        mad r41.xy, r42.xyxx, r13.zzzz, r40.xyxx
                        sample_c_lz_indexable(texture2darray)(float,float,float,float) r24.w, r41.xyzx, t9.xxxx, s13, r16.x
                        mad r16.y, r24.w, l(0.125000), r16.y
                        iadd r16.z, r16.z, l(1)
                      endloop 
                    else 
                      utof r40.z, r12.w
                      sample_c_lz_indexable(texture2darray)(float,float,float,float) r16.y, r40.xyzx, t9.xxxx, s13, r16.x
                    endif 
                  ...
                  if_nz r13.z
                    ...
                    ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r40.xyzw, r12.w, l(100), t12.xyzw
                    ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r41.xyzw, r12.w, l(116), t12.xyzw
                    mad r16.x, |r18.w|, l(-0.200000), l(0.400000)
                    mad r17.xyz, r4.xyzx, r16.xxxx, v7.xyzx
                    dp4 r16.x, r40.xyzw, r17.xyzw
                    dp4 r16.z, r41.xyzw, r17.xyzw
                    lt r24.w, r16.z, r16.x
                    if_z r24.w
                      ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r40.xyzw, r12.w, l(68), t12.xyzw
                      ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r41.xyzw, r12.w, l(84), t12.xyzw
                      ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r42.xyzw, r12.w, l(132), t12.xyzw
                      ...
                      mul r17.x, r16.z, r44.y
                      mad r16.x, r44.x, r16.z, r16.x
                      div r16.x, r16.x, r17.x
                    else 
                      mov r17.z, l(-1)
                    endif 
                    or r16.z, r24.w, r17.z
                    if_z r16.z
                      ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r12.w, r12.w, l(28), t12.xxxx
                      max r16.x, r16.x, l(0.00006104)
                      and r12.w, r12.w, l(0x0000ffff)
                      if_nz r7.z
                        ...
                        loop 
                          ...
                          mad r17.xy, r41.xyxx, r13.zzzz, r40.xyxx
                        ...
                        utof r40.z, r12.w
                        sample_c_lz_indexable(texture2darray)(float,float,float,float) r16.z, r40.xyzx, t9.xxxx, s13, r16.x
                      endif 
                ...
                mov r32.x, r31.x
                lt r13.z, l(0.000000), r18.w
                mad r17.xyz, r12.wwww, r32.xyzx, r14.xyzx
                ...
                dp3 r16.x, r4.xyzx, r38.xyzx
                mad r18.w, |r16.x|, r2.y, -|r16.x|
                mad r16.x, |r16.x|, r18.w, l(1.000000)
                mad r18.w, r12.w, r0.y, r2.w
                mul r16.x, r16.x, r16.x
                mul r16.x, r18.w, r16.x
                rcp r16.x, r16.x
                ...
                movc r14.xyz, r13.zzzz, r17.xyzx, r14.xyzx
          ...
          if_nz r13.w
            ...
            mov r40.w, r39.y
            dp4 r13.w, r40.xyzw, r15.xyzw
            lt r16.x, r13.w, l(1.000000)
            if_nz r16.x
              ...
              mov r35.w, r36.x
              dp4 r33.x, r35.xyzw, r15.xyzw
              mov r45.xyz, r36.yzwy
              mov r45.w, r37.w
              dp4 r33.y, r45.xyzw, r15.xyzw
              div r18.xy, r33.xyxx, r13.wwww
              lt r13.w, r42.w, l(0.00048828)
              if_nz r13.w
                mov r43.y, r44.x
                mad_sat r33.xy, |r18.xyxx|, r43.zwzz, r43.xyxx
                mul r33.zw, r33.xxxy, r33.xxxy
                mad r33.xy, r33.xyxx, l(-2.000000, -2.000000, 0.000000, 0.000000), l(3.000000, 3.000000, 0.000000, 0.000000)
                mul r33.xy, r33.xyxx, r33.zwzz
                ...
                mov r42.w, r43.y
                mul_sat r33.xyzw, |r18.yyxx|, r42.xyzw
            ...
            mov r31.yz, r32.yyzy
            mul r18.xyw, r41.xyxz, r31.xyxz
            lt r13.w, l(0.000000), r16.x
            if_nz r13.w
              ...
              if_nz r13.w
                ...
                dp4 r19.w, r40.xyzw, r20.xyzw
                ge r23.w, r19.w, r13.w
                if_nz r23.w
                  ...
                  if_nz r7.z
                    ...
                    loop 
                      ...
                      mad r19.w, r24.w, l(0.125000), r19.w
                      iadd r23.w, r23.w, l(1)
                    endloop 
                  else 
                    utof r20.z, r13.w
                    sample_c_lz_indexable(texture2darray)(float,float,float,float) r19.w, r20.xyzx, t9.xxxx, s13, r9.w
                  endif 
                  mul r9.w, r19.w, r19.w
                  mul r9.w, r19.w, r9.w
                else 
                  mov r9.w, l(1.000000)
                endif 
              ...
              if_nz r13.w
                ...
                if_nz r20.x
                  ...
                  if_z r21.x
                    ...
                    mul r16.x, r20.z, r31.y
                    mad r20.y, r31.x, r20.z, r20.y
                    div r16.x, r20.y, r16.x
                    max r16.x, r16.x, l(0.00006104)
                    ...
                    if_nz r7.z
                      ...
                      loop 
                        ...
                        sample_c_lz_indexable(texture2darray)(float,float,float,float) r21.x, r21.xyzx, t9.xxxx, s13, r16.x
                        mad r20.z, r21.x, l(0.125000), r20.z
                        iadd r23.w, r23.w, l(1)
                      endloop 
                    else 
                      utof r32.z, r20.y
                      sample_c_lz_indexable(texture2darray)(float,float,float,float) r20.z, r32.xyzx, t9.xxxx, s13, r16.x
                    endif 
                    mul r16.x, r20.z, r20.z
                    mul r16.x, r20.z, r16.x
                  else 
                    mov r16.x, l(1.000000)
                  endif 
                  mul r9.w, r9.w, r16.x
                else 
                  ubfe r16.x, l(4), l(20), r32.w
                  ult r20.x, l(0), r16.x
                  ...
                  if_nz r20.x
                    ...
                    if_z r22.x
                      ...
                      if_nz r7.z
                        ...
                        utof r31.z, r20.y
                        sample_c_lz_indexable(texture2darray)(float,float,float,float) r22.x, r31.xyzx, t9.xxxx, s13, r16.x
                      endif 
                      mul r16.x, r22.x, r22.x
                      mul r16.x, r22.x, r16.x
                    else 
                      mov r16.x, l(1.000000)
                    endif 
                    mul r9.w, r9.w, r16.x
                ...
                mad r16.x, -r13.z, r0.x, l(1.000000)
                mul r16.x, r16.x, r16.x
                mad r16.x, -r16.x, l(0.620000), l(0.620000)
                add r16.x, -r13.z, r16.x
                mad r16.x, r2.z, r16.x, r13.z
                mul r16.x, r9.w, r16.x
                lt r12.w, l(0.000000), r12.w
                mad r21.xyz, r16.xxxx, r18.xywx, r14.xyzx
                mad r17.xyz, r17.xyzx, r11.wwww, r3.xyzx
                dp3 r11.w, r17.xyzx, r17.xyzx
                rsq r11.w, r11.w
                mul r17.xyz, r11.wwww, r17.xyzx
                dp3 r11.w, r17.xyzx, r3.xyzx
                dp3 r16.x, r4.xyzx, r17.xyzx
                mad r17.x, |r16.x|, r2.y, -|r16.x|
                mad r16.x, |r16.x|, r17.x, l(1.000000)
                ...
                mad r17.xyz, r9.wwww, r18.xywx, r30.xyzx
                add_sat r11.w, -r11.w, l(1.000000)
                log r11.w, r11.w
                mul r11.w, r11.w, l(3.400000)
                exp r11.w, r11.w
                mul r9.w, r9.w, r11.w
                mad r18.xyw, r9.wwww, r18.xyxw, r29.xyxz
                movc r14.xyz, r12.wwww, r21.xyzx, r14.xyzx
                movc r29.xyz, r12.wwww, r18.xywx, r29.xyzx
                movc r30.xyz, r12.wwww, r17.xyzx, r30.xyzx
              endif 
            endif 
          endif 
          break 
...
mad r0.xyz, r26.xyzx, r9.xyzx, r0.xyzx
log r0.w, r7.w
