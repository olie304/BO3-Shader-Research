...
Texture2D<float4> temporalHistoryLumaTex2 : register(t9);
Texture2D<float4> temporalHistoryLumaTex3 : register(t10);
Texture2D<float4> velocityTex0 : register(t11);
Texture2D<float4> velocityTex1 : register(t12);
Texture2D<float4> filmicHistoryTex1 : register(t14);
Texture2D<float4> depthTex : register(t15);
...
// unknown dcl_: dcl_uav_structured_opc u6, 8
  ...
  r2.xy = velocityTex1.SampleLevel(bilinearSampler_s, r1.xy, 0).xy;
  r2.zw = float2(-0.5,-0.5) + abs(r2.xy);
  r2.zw = saturate(r2.zw + r2.zw);
  r3.xy = abs(r2.xy) + abs(r2.xy);
  r3.xy = min(float2(1,1), r3.xy);
  r3.xy = float2(10,10) * r3.xy;
  r2.zw = r2.zw * float2(30,30) + r3.xy;
  r2.xy = cmp(r2.xy >= float2(0,0));
  r2.xy = r2.xy ? r2.zw : -r2.zw;
  r2.zw = postFxControl0.xy + v1.xy;
  r3.xyz = colorTex.SampleLevel(bilinearSampler_s, r2.zw, 0).xyz;
  r2.zw = postFxControl0.zw + r1.xy;
  r4.xyz = temporalHistoryTex1.SampleLevel(bilinearSampler_s, r2.zw, 0).xyz;
  ...
  r5.x = dot(r5.xyz, float3(0.212599993,0.715200007,0.0722000003));
  r6.xyz = float3(3.05175781e-05,3.05175781e-05,3.05175781e-05) * r4.xyz;
  r6.xyz = (uint3)r6.xyz >> int3(1,1,1);
  r6.xyz = (int3)r6.xyz + int3(532487680,532487680,532487680);
  r5.y = dot(r6.xyz, float3(0.212599993,0.715200007,0.0722000003));
  r2.zw = renderTargetSize.zw * r2.xy + -r0.zw;
  r2.zw = r2.zw * float2(2,2) + r0.zw;
  r6.xyzw = temporalHistoryLumaTex1.Gather(bilinearSampler_s, r1.xy, int2(0, 0)).xyzw;
  r5.zw = -renderTargetSize.zw * r2.xy + r1.xy;
  r2.zw = r5.zw + -r2.zw;
  r7.xyzw = temporalHistoryLumaTex3.Gather(bilinearSampler_s, r2.zw, int2(0, 0)).xyzw;
  r6.xyzw = -r7.xyzw + r6.xyzw;
  r2.z = dot(abs(r6.xyzw), float4(10,10,10,10));
  r2.z = 1 + -r2.z;
  r2.z = max(0, r2.z);
  r2.w = temporalHistoryLumaTex2.SampleLevel(bilinearSampler_s, r5.zw, 0).x;
  r2.w = r5.x + -r2.w;
  r2.w = -abs(r2.w) * 40 + 1;
  r2.w = max(0, r2.w);
  r2.z = min(r2.z, r2.w);
  r6.xyz = colorTex.SampleLevel(bilinearSampler_s, r1.zw, 0).xyz;
  r7.xyzw = renderTargetSize.zwzw * float4(1,0,0,1) + v1.xyxy;
  r8.xyz = colorTex.SampleLevel(bilinearSampler_s, r7.xy, 0).xyz;
  r7.xyz = colorTex.SampleLevel(bilinearSampler_s, r7.zw, 0).xyz;
  r1.zw = renderTargetSize.zw * float2(0,-1) + v1.xy;
  r9.xyz = colorTex.SampleLevel(bilinearSampler_s, r1.zw, 0).xyz;
  r10.xyz = min(r9.xyz, r7.xyz);
  r10.xyz = min(r10.xyz, r8.xyz);
  r10.xyz = min(r10.xyz, r6.xyz);
  r10.xyz = min(r10.xyz, r3.xyz);
  r7.xyz = max(r9.xyz, r7.xyz);
  r7.xyz = max(r8.xyz, r7.xyz);
  r6.xyz = max(r7.xyz, r6.xyz);
  r6.xyz = max(r6.xyz, r3.xyz);
  r7.xyz = max(r10.xyz, r4.xyz);
  r8.xyz = max(r6.xyz, r4.xyz);
  r6.xyz = max(r10.xyz, r6.xyz);
  r6.xyz = min(r8.xyz, r6.xyz);
  r6.xyz = min(r7.xyz, r6.xyz);
  r4.xyz = -r6.xyz + r4.xyz;
  r4.xyz = r2.zzz * r4.xyz + r6.xyz;
  r1.z = dot(r0.xy, r0.xy);
  r1.w = dot(r2.xy, r2.xy);
  r1.z = max(r1.z, r1.w);
  r1.z = (uint)r1.z >> 1;
  r1.z = (int)r1.z + 0x1fbd1df5;
  r1.z = saturate(40 + -r1.z);
  r0.xy = -r2.xy + r0.xy;
  ...
  r0.z = saturate(r0.z * 6.66666651 + -0.333333343);
  r0.x = dot(r0.xy, r0.xy);
  r0.x = (uint)r0.x >> 1;
  r0.x = (int)r0.x + 0x1fbd1df5;
  ...
  if (r0.x != 0) {
    ...
    r4.xy = r1.xy * r1.xy;
    r4.zw = r4.xy + r4.xy;
    r5.yz = r4.xy * float2(2,2) + -r1.xy;
    r5.yz = -r4.xy * r1.xy + r5.yz;
    r4.zw = r4.xy * r1.xy + -r4.zw;
    r4.zw = float2(1,1) + r4.zw;
    r6.xy = r1.xy * r1.xy + r1.xy;
    r6.xy = -r4.xy * r1.xy + r6.xy;
    r1.xy = r4.xy * r1.xy + -r4.xy;
    ...
    r3.xyz = r3.xyz * r5.zzz + r8.xyz;
    r7.zw = r6.wy;
    r8.xyz = filmicHistoryTex1.SampleLevel(bilinearSampler_s, r7.xz, 0).xyz;
    r8.xyz = r8.xyz * r1.xxx;
    r3.xyz = r8.xyz * r5.zzz + r3.xyz;
    r8.xyz = filmicHistoryTex1.SampleLevel(bilinearSampler_s, r6.xy, 0).xyz;
    r8.xyz = r8.xyz * r5.yyy;
    r3.xyz = r8.xyz * r4.yyy + r3.xyz;
    r8.xyz = filmicHistoryTex1.SampleLevel(bilinearSampler_s, r6.zy, 0).xyz;
    r8.xyz = r8.xyz * r4.xxx;
    r3.xyz = r8.xyz * r4.yyy + r3.xyz;
    r8.xyz = filmicHistoryTex1.SampleLevel(bilinearSampler_s, r7.xw, 0).xyz;
    r8.xyz = r8.xyz * r1.xxx;
    r3.xyz = r8.xyz * r4.yyy + r3.xyz;
    r6.y = r7.y;
    r4.yzw = filmicHistoryTex1.SampleLevel(bilinearSampler_s, r6.xy, 0).xyz;
    r4.yzw = r4.yzw * r5.yyy;
    r3.xyz = r4.yzw * r1.yyy + r3.xyz;
    r4.yzw = filmicHistoryTex1.SampleLevel(bilinearSampler_s, r6.zy, 0).xyz;
    r4.xyz = r4.yzw * r4.xxx;
    r3.xyz = r4.xyz * r1.yyy + r3.xyz;
    r4.xyz = filmicHistoryTex1.SampleLevel(bilinearSampler_s, r7.xy, 0).xyz;
    ...
    r0.z = 255 * r0.z;
    r0.z = (uint)r0.z;
    r0.yz = (uint2)r0.yz << int2(12,24);
    r0.y = (int)r0.y | (int)r0.z;
    r1.y = (int)r0.x | (int)r0.y;
