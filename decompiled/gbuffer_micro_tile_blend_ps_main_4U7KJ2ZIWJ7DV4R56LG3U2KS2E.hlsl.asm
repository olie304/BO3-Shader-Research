...
mad r1.x, r1.x, r1.y, cb0[15].x
mul_sat r1.x, r1.x, l(0.05882353)
sample_indexable(texture2d)(float,float,float,float) r1.y, r0.zwzz, t9.yxzw, s2
add r1.w, -cb0[11].x, cb0[11].y
mad r1.y, r1.y, r1.w, cb0[11].x
...
sample_indexable(texture2d)(float,float,float,float) r3.xyz, r0.xyxx, t17.xyzw, s2
mul r0.x, r2.z, r2.z
mad r1.yw, r2.xxxy, l(0.000000, 1.99218750, 0.000000, 1.99218750), l(0.000000, -1.000000, 0.000000, -1.000000)
...
mad r4.w, r0.x, cb0[12].y, r0.y
sample_indexable(texture2d)(float,float,float,float) r5.xyz, r0.zwzz, t11.xyzw, s3
sample_indexable(texture2d)(float,float,float,float) r0.xzw, r0.zwzz, t6.xwyz, s2
mul r2.z, r5.z, r5.z
mad r5.xy, r5.xyxx, l(1.99218750, 1.99218750, 0.000000, 0.000000), l(-1.000000, -1.000000, 0.000000, 0.000000)
mad r5.xy, r5.xyxx, cb0[12].xxxx, r2.xyxx
mul r2.z, r2.z, l(0.33333334)
min r2.z, r2.z, l(1.000000)
mad r6.w, r2.z, cb0[12].x, r0.y
mad r7.xy, r1.ywyy, cb0[12].yyyy, r2.xyxx
...
mad r2.xyzw, r1.zzzz, r2.xyzw, r6.xyzw
add r0.y, r1.x, r2.w
log r0.y, r0.y
...
mov r4.x, l(2)
add r3.w, r0.y, l(2.000000)
movc r0.y, r1.x, r3.w, r0.y
eq r1.x, r0.y, r1.y
...
mul r1.xyw, r4.xyxz, l(0.40824831, 0.70710677, 0.000000, 0.57735026)
...
add r1.xyw, -r0.xzxw, r3.xyxz
mad r0.xyz, r1.zzzz, r1.xywx, r0.xzwx
add r1.y, -r0.z, r0.x
