...
sample_indexable(texture2d)(float,float,float,float) r3.xyz, r0.xyxx, t12.xyzw, s3
...
sample_indexable(texture2d)(float,float,float,float) r1.xyw, r0.zwzz, t11.xywz, s3
...
mad r4.w, r0.y, cb0[12].y, r2.z
mul r0.y, r1.w, r1.w
mad r1.xy, r1.xyxx, l(1.99218750, 1.99218750, 0.000000, 0.000000), l(-1.000000, -1.000000, 0.000000, 0.000000)
mad r5.xy, r1.xyxx, cb0[12].xxxx, r3.xyxx
mul r0.y, r0.y, l(0.33333334)
min r0.y, r0.y, l(1.000000)
mad r6.w, r0.y, cb0[12].x, r2.z
mad r7.xy, r0.zwzz, cb0[12].yyyy, r3.xyxx
