...
//   float Speed;                       // Offset:  160 Size:     4
//   float Power;                       // Offset:  164 Size:     4
//   float4 MaxFlickerColor;            // Offset:  176 Size:    16
//   float Coarseness;                  // Offset:  192 Size:     4
//   float4 MinFlickerColor;            // Offset:  208 Size:    16
//
// }
//
...
// ------------------------------ ---------- ------- ----------- -------------- ------
// Noise_Texture_Sampler             sampler      NA          NA             s1      1 
// Lookup_Sampler                    sampler      NA          NA             s2      1 
// Noise_Texture                     texture  float4          2d             t0      1 
// Lookup                            texture  float4          2d             t6      1 
...
dcl_output o0.xyzw
dcl_temps 2
mul r0.x, cb0[10].x, cb1[69].w
mov r0.y, v1.y
sample_indexable(texture2d)(float,float,float,float) r0.x, r0.xyxx, t6.xyzw, s2
log r0.x, r0.x
mul r0.x, r0.x, cb0[10].y
exp r0.x, r0.x
add r1.xyzw, cb0[11].xyzw, -cb0[13].xyzw
mad r0.xyzw, r0.xxxx, r1.xyzw, cb0[13].xyzw
div r1.xy, v1.xyxx, cb0[12].xxxx
sample_indexable(texture2d)(float,float,float,float) r1.xy, r1.xyxx, t0.xwyz, s1
mad r1.z, -r0.w, r1.y, l(1.000000)
