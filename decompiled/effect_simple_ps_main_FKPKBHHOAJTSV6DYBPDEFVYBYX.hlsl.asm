...
mul r2.zw, cb0[19].xxxy, cb0[19].zzzw
mad r2.zw, r2.xxxy, cb0[19].xxxy, r2.zzzw
mul r3.xy, cb0[20].zwzz, cb1[69].wwww
mad r1.w, cb0[20].y, cb1[69].w, l(1.000000)
...
sample_d_indexable(texture2d)(float,float,float,float) r3.xyzw, r2.zwzz, t21.xyzw, s1, r0.zwzz, r1.xyxx
...
and r1.w, r5.z, r1.w
and r1.w, r5.w, r1.w
max r2.z, r3.w, l(0.000100)
div_sat r5.xyz, r4.xyzx, r2.zzzz
add_sat r5.xyz, r5.xyzx, -cb0[17].xxxx
add r6.xy, -cb0[17].xzxx, cb0[17].ywyy
max r2.w, r6.x, l(0.000100)
...
movc r3.xyz, r1.wwww, r4.xyzx, r5.xyzx
ftoi r4.xy, v0.xyxx
mov r4.zw, l(0,0,0,0)
ld_indexable(texture2d)(float,float,float,float) r1.w, r4.xyzw, t0.yzwx
eq r2.w, v6.z, l(0.000000)
div r4.x, l(1.000000, 1.000000, 1.000000, 1.000000), v6.z
movc r2.w, r2.w, l(60000.000000), r4.x
...
rcp r4.x, r4.x
ne r4.y, v6.y, l(1.000000)
div r5.xyz, r3.xyzx, r2.zzzz
add r2.z, r3.w, v1.w
mad_sat r6.y, r2.z, v6.y, -v6.y
mul r6.xzw, r5.xxyz, r6.yyyy
movc r3.xyzw, r4.yyyy, r6.xzwy, r3.xyzw
mov r6.x, l(1.000000)
movc r4.yz, r4.yyyy, r6.xxyx, v1.wwww
lt r2.z, r4.x, r1.w
add r1.w, r1.w, -r4.x
...
mul r1.zw, cb0[21].xxxy, cb0[21].zzzw
mad r1.zw, r2.xxxy, cb0[21].xxxy, r1.zzzw
mul r2.xy, cb0[22].zwzz, cb1[69].wwww
mad r2.w, cb0[22].y, cb1[69].w, l(1.000000)
mul r2.w, r2.w, cb0[22].x
mul r2.w, r2.w, l(0.01745329)
sincos r4.x, r5.x, r2.w
mov r5.y, r5.x
mov r5.z, r4.x
dp2 r6.x, r5.yzyy, r1.zwzz
mov r5.x, -r4.x
dp2 r6.y, r5.xyxx, r1.zwzz
mad r1.zw, r2.xxxy, cb0[21].xxxy, r6.xxxy
add r1.zw, r1.zzzw, l(0.000000, 0.000000, 0.500000, 0.500000)
sample_d_indexable(texture2d)(float,float,float,float) r1.z, r1.zwzz, t22.yzxw, s1, r0.zwzz, r1.xyxx
mul r1.z, r2.z, r1.z
dp3 r1.w, v1.xyzx, l(0.299000, 0.587000, 0.114000, 0.000000)
...
mul r1.z, r1.z, r1.w
mad r2.xyz, v2.xyzx, r1.zzzz, v1.xyzx
mul r0.xy, r0.xyxx, cb0[18].yzyy
sample_d_indexable(texture2d)(float,float,float,float) r0.x, r0.xyxx, t24.xyzw, s1, r0.zwzz, r1.xyxx
...
if_z r2.x
  ftou r2.xy, v0.xyxx
  bfi r3.x, l(1), l(16), cb0[15].w, l(0)
  iadd r3.x, r3.x, l(1)
  ...
  if_nz r3.x
    ...
    bfi r3.y, l(1), l(0), cb0[15].w, r0.x
