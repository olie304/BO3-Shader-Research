...
mad r3.yzw, v3.xxyz, l(0.000000, 2.001957, 2.001957, 2.001957), l(0.000000, -1.00195694, -1.00195694, -1.00195694)
mul r6.xyz, r3.yzwy, cb0[18].zzzz
mul r6.xyz, r3.xxxx, r6.xyzx
mad r0.xyz, r6.xyzx, v1.wwww, v0.xyzx
dp4 r6.y, r0.xyzw, r4.xyzw
mul r7.xyzw, r6.yyyy, cb1[9].xyzw
mov r2.w, r1.y
mov r5.w, r1.w
dp4 r6.x, r0.xyzw, r2.xyzw
mad r7.xyzw, r6.xxxx, cb1[8].xyzw, r7.xyzw
dp4 r6.z, r0.xyzw, r5.xyzw
mad r7.xyzw, r6.zzzz, cb1[10].xyzw, r7.xyzw
mov o7.xyz, r6.xyzx
add o0.xyzw, r7.xyzw, cb1[11].xyzw
log r1.yzw, |v1.xxyz|
mul r1.yzw, r1.yyzw, l(0.000000, 2.200000, 2.200000, 2.200000)
exp o1.xyz, r1.yzwy
mul r6.xyzw, r3.yyzz, r0.zyxz
mul r6.xyzw, r6.xyzw, l(0.01388889, 0.01388889, 0.01388889, 0.01388889)
add r1.yz, r6.zzwz, r6.xxyx
mul r6.xy, r3.wwww, r0.xyxx
mov o8.xyz, r0.xyzx
mad o2.zw, r6.xxxy, l(0.000000, 0.000000, 0.01388889, 0.01388889), r1.yyyz
mov o2.xy, v2.xyxx
...
frc o3.xyz, r0.xyzx
mov o3.w, v5.x
dp3 r0.x, r3.yzwy, r2.xyzx
dp3 r0.y, r3.yzwy, r4.xyzx
dp3 r0.z, r3.yzwy, r5.xyzx
...
mul r1.xyz, r0.yzxy, r3.wyzw
mad r0.xyz, r3.zwyz, r0.zxyz, -r1.xyzx
