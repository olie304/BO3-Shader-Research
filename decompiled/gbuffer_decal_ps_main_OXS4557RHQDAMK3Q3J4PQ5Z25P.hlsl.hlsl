  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r1.w = r1.w * r0.y;
  r2.x = specColorMap.Sample(specColorSampler_s, r0.zw).x;
  ...
  r3.z = aoMap.Sample(aoSampler_s, r0.zw).x;
  r2.x = glossMap.Sample(specColorSampler_s, r0.zw).x;
  r4.x = glossRange.y + -glossRange.x;
  r2.x = r2.x * r4.x + glossRange.x;
  ...
  r1.zw = float2(-1.22474492,1.22474492) * r5.xz;
  r6.xyz = float3(0.707106769,-1.41421354,0.707106769) * r5.xyz;
  r6.x = dot(r4.xyz, r6.xyz);
  r6.y = dot(r4.xz, r1.zw);
  r0.z = dot(r4.xyz, r5.xyz);
  r0.z = 1 + abs(r0.z);
  r0.z = rsqrt(r0.z);
  r1.zw = r6.xy * r0.zz;
  r4.xy = r1.zw * float2(0.588235319,0.588235319) + float2(0.5,0.5);
  r0.y = cmp(r0.y >= 0.5);
  r0.y = r0.y ? 0.5 : 0.00146627566;
  r4.z = r2.x * 0.49755621 + r0.y;
  r0.yzw = r0.www ? r4.xyz : 0;
