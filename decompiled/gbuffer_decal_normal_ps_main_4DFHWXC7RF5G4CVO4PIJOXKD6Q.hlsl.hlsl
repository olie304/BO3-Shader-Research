...
SamplerState aoSampler_s : register(s2);
...
Texture2D<float4> alphaMaskMap : register(t10);
  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r0.w = alphaMaskMap.Sample(normalSampler_s, r0.yz).x;
  r0.x = r0.x * r0.w;
  r1.xy = normalMap.Sample(normalSampler_s, r0.yz).xy;
  ...
  r0.y = cmp(r0.y >= 0.5);
  r1.z = r0.y ? 0.5 : 0.00146627566;
  r0.yzw = r0.www ? r1.xyz : 0;
  o1.xyz = r0.yzw * r0.xxx;
  r2.xyw = float3(0,0.5,1);
