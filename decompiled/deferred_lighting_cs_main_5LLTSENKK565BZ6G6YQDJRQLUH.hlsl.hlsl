...
r0.y = samplerLinear[]..swiz;
  ...
  r6.w = dot(r4.yzw, float3(0.212599993,0.715200007,0.0722000003));
  r14.w = 0;
  ...
  r15.xyz = r4.yzw * r5.xxx;
  r16.xyz = r3.zzz ? r15.xyz : 0;
  ...
  switch (r6.w) {
    ...
    r14.w = saturate(r12.w);
    r14.w = r3.z ? abs(r12.w) : r14.w;
    r15.w = cmp(0 < r14.w);
    if (r15.w != 0) {
      r15.w = sqrt(r10.w);
      ...
      if (r15.w != 0) {
        ...
        if (r15.w != 0) {
          ...
          r21.yzw = r12.xyz * r15.www + r11.xyz;
        ...
        r15.w = cmp(0 < r10.w);
        if (r15.w != 0) {
          r15.w = lightConstantsCB[r0.x].data[1].z * r0.w;
          r15.w = 0.25 * r15.w;
          r16.w = dot(r18.xyz, r14.xyz);
          r14.x = dot(r14.xyz, r20.xyz);
          r14.y = -r16.w * r16.w + lightConstantsCB[r0.x].data[6].y;
          r8.w = r16.w * r14.x + -r8.w;
          ...
          r14.xyz = r8.www * r18.xyz + r19.xyz;
          r14.xyz = r7.www ? r14.xyz : lightConstantsCB[r0.x].data[0].xyz;
          r14.xyz = r14.xyz + -r11.xyz;
          r7.w = dot(r14.xyz, r14.xyz);
          r7.w = rsqrt(r7.w);
          r18.xyz = r14.xyz * r7.www;
          ...
          r12.w = r14.x * r12.w;
          r12.w = r12.w * r10.w;
          r14.xyz = r12.www * r19.xyz + r13.yzw;
          ...
          r13.yzw = r9.www ? r14.xyz : r13.yzw;
          if (r2.z != 0) {
          // Known bad code for instruction (needs manual fix):
    ...
    if (r12.w != 0) {
      ...
      if (r11.w != 0) {
          ...
          if (r15.w != 0) {
            ...
            if (enableDitheredShadow != 0) {
              ...
              while (true) {
                ...
                r17.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r21.xyz, r11.w).x;
                r15.w = r17.y * 0.125 + r15.w;
                r16.w = (int)r16.w + 1;
              }
            } else {
              r20.z = (uint)r12.w;
              r15.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r20.xyz, r11.w).x;
            }
            r11.w = r15.w * r15.w;
            r11.w = r11.w * r15.w;
          } else {
        ...
        if (r12.w != 0) {
          ...
          r12.w = r12.w * r9.w;
          if (4 == 0) r14.w = 0; else if (4+16 < 32) {           r14.w = (uint)lightConstantsCB[r0.x].data[1].w << (32-(4 + 16)); r14.w = (uint)r14.w >> (32-4);          } else r14.w = (uint)lightConstantsCB[r0.x].data[1].w >> 16;
          ...
          if (r15.w != 0) {
            ...
            r16.w = r3.z ? r16.w : 0;
            r15.w = r16.w ? -r15.w : r15.w;
            r18.xyz = r12.xyz * r15.www + r11.xyz;
            r20.xyz = lightConstantsCB[r14.w].data[6].yzw;
            r20.w = lightConstantsCB[r14.w].data[7].x;
            r18.w = 1;
            r15.w = dot(r20.xyzw, r18.xyzw);
            r20.xyz = lightConstantsCB[r14.w].data[7].yzw;
            r20.w = lightConstantsCB[r14.w].data[8].x;
            r16.w = dot(r20.xyzw, r18.xyzw);
            r17.y = cmp(r16.w < r15.w);
            if (r17.y == 0) {
              r20.xyz = lightConstantsCB[r14.w].data[4].yzw;
              r20.w = lightConstantsCB[r14.w].data[5].x;
              r20.x = dot(r20.xyzw, r18.xyzw);
              r21.xyz = lightConstantsCB[r14.w].data[5].yzw;
              r21.w = lightConstantsCB[r14.w].data[6].x;
              r20.y = dot(r21.xyzw, r18.xyzw);
              r18.xy = r20.xy / r16.ww;
              r18.xy = r18.xy * float2(0.5,-0.5) + float2(0.5,0.5);
              r20.x = lightConstantsCB[r14.w].data[9].w + r18.x;
              r20.y = lightConstantsCB[r14.w].data[10].x + r18.y;
              r18.xy = lightConstantsCB[r14.w].data[9].yz * r20.xy;
              r18.zw = lightConstantsCB[r14.w].data[3].yy / lightConstantsCB[r14.w].data[8].yw;
              ...
              if (r18.z == 0) {
                ...
                r20.x = r18.x * lightConstantsCB[r14.w].data[8].y + lightConstantsCB[r14.w].data[8].z;
                r20.y = r18.y * lightConstantsCB[r14.w].data[8].w + lightConstantsCB[r14.w].data[9].x;
                r18.x = lightConstantsCB[r14.w].data[10].z * r16.w;
                r15.w = lightConstantsCB[r14.w].data[10].y * r16.w + r15.w;
                r15.w = r15.w / r18.x;
              }
            } else {
              r18.z = -1;
            ...
            if (r16.w == 0) {
              r15.w = max(6.10351563e-05, r15.w);
              r16.w = 0x0000ffff & (int)lightConstantsCB[r14.w].data[1].w;
              if (enableDitheredShadow != 0) {
                r18.x = -r4.x;
                r21.z = (uint)r16.w;
                r18.y = r13.x;
                ...
                while (true) {
                  ...
                  r21.xy = r22.xy * lightConstantsCB[r14.w].data[3].yy + r20.xy;
            ...
            if (r1.z != 0) {
              ...
              r14.w = dot(r20.xyzw, r18.xyzw);
              r15.w = cmp(r14.w < r1.z);
              if (r15.w == 0) {
                r20.xyz = lightConstantsCB[r0.x].data[4].yzw;
                r20.w = lightConstantsCB[r0.x].data[5].x;
                r20.x = dot(r20.xyzw, r18.xyzw);
                ...
                if (r16.w == 0) {
                  ...
                  r20.x = r18.x * lightConstantsCB[r0.x].data[8].y + lightConstantsCB[r0.x].data[8].z;
                  r20.y = r18.y * lightConstantsCB[r0.x].data[8].w + lightConstantsCB[r0.x].data[9].x;
                  r17.y = lightConstantsCB[r0.x].data[10].z * r14.w;
                  r1.z = lightConstantsCB[r0.x].data[10].y * r14.w + r1.z;
                  r1.z = r1.z / r17.y;
                }
              } else {
                r16.w = -1;
              ...
              if (r14.w == 0) {
                ...
                if (enableDitheredShadow != 0) {
                  ...
                  r13.x = 0;
                  while (true) {
                    r15.w = cmp((int)r13.x >= 8);
                    if (r15.w != 0) break;
                    r22.x = dot(icb[r13.x+0].yx, r18.xy);
                    r22.y = dot(icb[r13.x+0].yx, r18.yz);
                    r21.xy = r22.xy * lightConstantsCB[r0.x].data[3].yy + r20.xy;
                    r15.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r21.xyz, r1.z).x;
                    r4.x = r15.w * 0.125 + r4.x;
                    r13.x = (int)r13.x + 1;
                  }
                } else {
                  r20.z = (uint)r14.w;
  ...
  r4.z = -r2.y * 0.5 + r0.x;
  r4.x = r4.z + r2.y;
  r2.xyw = r15.xyz * r6.xyz;
  r2.xyw = r16.xyz * r4.xyz + r2.xyw;
  r3.xyw = float3(0.959999979,0.959999979,0.959999979) * r17.xzw;
  r3.xyw = r13.yzw * float3(0.0399999991,0.0399999991,0.0399999991) + r3.xyw;
  r2.xyw = r3.xyw + r2.xyw;
  r3.xyw = float3(1,1,1) + -r4.xyz;
  r3.xyw = r17.xzw * r3.xyw;
  r3.xyw = r13.yzw * r4.xyz + r3.xyw;
  r3.xyw = r15.xyz * r6.xyz + r3.xyw;
