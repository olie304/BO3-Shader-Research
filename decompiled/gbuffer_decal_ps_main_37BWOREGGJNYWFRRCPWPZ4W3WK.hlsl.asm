...
sample_indexable(texture2d)(float,float,float,float) r3.xyz, r0.yzyy, t10.xyzw, s2
...
mul r3.yz, r0.yyzy, cb0[4].xxyx
sample_indexable(texture2d)(float,float,float,float) r3.yzw, r3.yzyy, t11.wxyz, s2
...
mad r4.xy, r3.yzyy, cb0[11].zzzz, r2.zwzz
dp3 r2.z, r4.xyzx, r4.xyzx
rsq r2.z, r2.z
mul r4.xyz, r2.zzzz, r4.xyzx
mad r2.z, r3.w, cb0[11].z, r3.x
...
mad r4.z, cb1[63].w, r2.x, l(1.000000)
mad r2.xyz, v5.xyzx, r2.wwww, -r3.xyzx
mad r2.xyz, cb1[60].wwww, r2.xyzx, r3.xyzx
mul o0.xyz, r0.xxxx, r1.xyzx
ftou r3.xy, v0.xyxx
mov r3.zw, l(0,0,0,0)
ld_indexable(texture2d)(float,float,float,float) r1.xy, r3.xyzw, t6.zwxy
...
mad r2.z, r1.w, l(0.49755621), r1.x
and r1.xyz, r1.zzzz, r2.xyzx
