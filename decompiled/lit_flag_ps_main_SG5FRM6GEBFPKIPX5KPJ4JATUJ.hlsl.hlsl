// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:35:58 2021
...
SamplerState colorSampler00_s : register(s3);
...
Texture2D<float4> colorMap00 : register(t22);
StructuredBuffer<gSunShadowTree> gSunShadowTree : register(t23);
Texture2D<float4> normalMap : register(t24);
Texture2D<float4> detailMap : register(t25);
Texture2D<float4> flagRippleDetailMap : register(t26);
...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  r1.xyz = r3.xyz * r1.yyy + r4.xyz;
  r1.xyz = r2.yzw * r1.www + r1.xyz;
  r0.w = dot(r1.xyz, r1.xyz);
  r0.w = rsqrt(r0.w);
  r1.xyz = r1.xyz * r0.www;
  r2.xyz = flagParams.zzz * r0.xyz;
  r3.xy = (uint2)v0.xy;
  ...
  if (r3.y != 0) {
    ...
    if (r3.y != 0) {
      ...
      r3.x = saturate(r3.x);
      r9.yzw = -v6.xyz * r2.www + sunConstants.wldDir.xyz;
