...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  r2.yzw = v6.xxx ? r4.xyz : -r4.xyz;
  r1.x = dot(r2.yzw, r2.yzw);
  r1.x = rsqrt(r1.x);
  r2.yzw = r2.yzw * r1.xxx + -r6.xyz;
  ...
  r2.w = v0.z * 64 + -63;
  r2.y = r2.y ? r2.w : r2.z;
  r2.xy = max(float2(0,9.99999994e-09), r2.xy);
  r2.y = rcp(r2.y);
  ...
  r9.zw = float2(2,2) / r9.zw;
  r1.z = dot(r6.xyz, sunConstants.wldDir.xyz);
  r2.x = cmp(0 >= abs(r1.z));
  if (r2.x != 0) {
    r13.y = 0;
  }
  if (r2.x == 0) {
    r15.xyz = sunConstants.sstLightingConstants.offToPinTransform._m10_m11_m12 * v5.yyy;
    r15.xyz = v5.xxx * sunConstants.sstLightingConstants.offToPinTransform._m00_m01_m02 + r15.xyz;
    r15.xyz = v5.zzz * sunConstants.sstLightingConstants.offToPinTransform._m20_m21_m22 + r15.xyz;
  ...
  r18.z = samp0[]..swiz;
  r18.w = samp0[]..swiz;
    r8.w = abs(r1.z) * -0.200000003 + 0.400000006;
    r10.w = cmp(r1.z < 0);
    r8.w = r10.w ? -r8.w : r8.w;
    r19.xyz = r6.xyz * r8.www + v5.xyz;
    r19.w = 1;
  ...
  if (r2.x != 0) {
    ...
    if (r2.x != 0) {
      ...
      r7.w = -r7.x * 0.5 + 1;
      r7.w = -abs(r1.z) * r7.w + 1;
      r7.w = r7.w * r7.w;
      r7.w = -r7.w * 0.620000005 + 0.620000005;
      r7.w = r7.w + -abs(r1.z);
      r7.w = r4.w * r7.w + abs(r1.z);
      r8.w = cmp(0 < r1.z);
      r1.z = saturate(r1.z);
      r16.xyz = -v5.xyz * r2.zzz + sunConstants.wldDir.xyz;
      r2.z = dot(r16.xyz, r16.xyz);
      r2.z = rsqrt(r2.z);
      r16.xyz = r16.xyz * r2.zzz;
      r2.z = dot(r6.xyz, r16.xyz);
      ...
      r14.w = r14.w / r9.w;
      r13.w = r14.w + r13.w;
      r2.z = abs(r2.z) * abs(r2.z) + r13.w;
      r13.w = r1.z * r5.w + r7.z;
      r2.z = r2.z * r2.z;
      r2.z = r2.z * r13.z;
      r2.z = r2.z * r13.w;
      r2.z = rcp(r2.z);
      ...
      r13.zw = r8.ww ? r2.xx : 0;
      r17.xyz = r8.www ? r1.zzz : 0;
  ...
  r2.xyz = r34.zxy * r1.yzx;
  r2.xyz = r34.yzx * r1.zxy + -r2.xyz;
  r3.xyz = viewProjectionMatrix._m10_m11_m13 * r14.yyy;
  r3.xyz = r14.xxx * viewProjectionMatrix._m00_m01_m03 + r3.xyz;
  r3.xyz = r14.zzz * viewProjectionMatrix._m20_m21_m23 + r3.xyz;
  r3.xyz = r3.xyz + r11.yzw;
  r5.z = rcp(r3.z);
  r3.xy = r5.zz * r3.xy;
  r5.xy = r3.xy * float2(0.5,-0.5) + float2(0.5,0.5);
  r3.xyw = r34.xyz * float3(2.4000001,2.4000001,2.4000001) + r14.xyz;
  ...
  r9.xyz = r10.xxx * r1.xyz + r9.xyz;
  r9.xyz = r9.xyz * float3(0.119999997,0.119999997,0.119999997) + r3.xyw;
  r10.xyz = viewProjectionMatrix._m10_m11_m13 * r9.yyy;
  r9.xyw = r9.xxx * viewProjectionMatrix._m00_m01_m03 + r10.xyz;
  r9.xyz = r9.zzz * viewProjectionMatrix._m20_m21_m23 + r9.xyw;
  r9.xyz = r9.xyz + r11.yzw;
  r7.zw = float2(0.5,-0.5) * r9.xy;
  r9.z = rcp(r9.z);
  r9.xy = r7.zw * r9.zz + float2(0.5,0.5);
  r10.xyz = -r5.xyz;
  r9.xyz = r10.xyz + r9.xyz;
  r4.w = 3.14159989 + r4.w;
  sincos(r4.w, r11.x, r13.x);
  r2.xyz = r11.xxx * r2.xyz;
  r1.xyz = r13.xxx * r1.xyz + r2.xyz;
  r1.xyz = r1.xyz * float3(0.119999997,0.119999997,0.119999997) + r3.xyw;
  r2.xyz = viewProjectionMatrix._m10_m11_m13 * r1.yyy;
  r2.xyz = r1.xxx * viewProjectionMatrix._m00_m01_m03 + r2.xyz;
  r1.xyz = r1.zzz * viewProjectionMatrix._m20_m21_m23 + r2.xyz;
  r1.xyz = r1.xyz + r11.yzw;
  r1.xy = float2(0.5,-0.5) * r1.xy;
  r2.z = rcp(r1.z);
  r2.xy = r1.xy * r2.zz + r10.xy;
  r10.w = 0.5;
  r1.xyz = r2.xyz + r10.wwz;
  ...
  r2.yz = r2.yz * r2.yz;
  x1[0].x = r2.y;
  r3.xyw = r9.xyz * r2.yyy + r5.xyz;
  r7.zw = cmp(r2.xx < r2.yz);
  ...
  if (r5.w != 0) {
    ...
    r7.z = cmp(r5.w >= 0.984375);
    r8.w = 1.01587307 * r5.w;
    r5.w = r5.w * 64 + -63;
    r5.w = r7.z ? r5.w : r8.w;
    ...
    r10.xyz = r1.xyz * r2.zzz + r5.xyz;
    r2.z = cmp(r2.x < r2.z);
    r3.xy = renderTargetSize.xy * r10.xy;
    r11.xy = (int2)r3.xy;
    r11.zw = float2(0,0);
  ...
  if (r2.y == 0) {
    ...
    r10.xyz = r9.xyz * r2.yyy + r5.xyz;
    r2.y = cmp(r2.x < r2.y);
    r3.xw = renderTargetSize.xy * r10.xy;
    r11.xy = (int2)r3.xw;
    r11.zw = float2(0,0);
    r3.x = floatZSampler.Load(r11.xyz).x;
  ...
  if (r2.y == 0) {
    ...
    r2.y = r2.y * r2.y + -r2.w;
    r2.y = r3.x * r2.y + r2.w;
    r9.xyz = r9.xyz * r2.yyy + r5.xyz;
    r2.y = cmp(r2.x < r2.y);
    r3.yw = renderTargetSize.xy * r9.xy;
    r10.xy = (int2)r3.yw;
    r10.zw = float2(0,0);
    r2.w = floatZSampler.Load(r10.xyz).x;
    r3.y = cmp(r2.w >= 0.984375);
    r3.w = 1.01587307 * r2.w;
    r2.w = r2.w * 64 + -63;
    r2.w = r3.y ? r2.w : r3.w;
    ...
    r5.xy = (int2)r1.xy;
    r5.zw = float2(0,0);
    r1.x = floatZSampler.Load(r5.xyz).x;
  ...
  r2.xyz = r1.xyz * r35.xyz + r29.xyz;
  r3.xyz = r1.xyz * r36.xyz + r30.xyz;
  r5.xyz = r1.xyz * r37.xyz + r32.xyz;
  r1.xyz = r1.xyz * r38.xyz + r31.xyz;
  r1.w = -debugGlossOverride.w * r1.w + 1;
  r2.w = 5 * r1.w;
  r3.w = r1.w * 5 + -2.5;
  r3.w = saturate(0.400000006 * r3.w);
  r3.w = 100 * r3.w;
  r7.zw = -r1.ww * float2(10,5) + float2(6.85740995,7.08500004);
  r4.w = exp2(r7.z);
  r4.w = r7.x * r4.w;
  r4.w = 9.1368103 * r4.w;
  r5.w = r2.w * r1.w;
  ...
  r25.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r9.zw, r7.z, l(96), t15.xxxy
  r9.z = samp0[]..swiz;
  r9.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
  ...
  r38.w = samp0[]..swiz;
    ...
    r28.x = dot(r6.xyz, r20.xyz);
    r28.y = dot(r6.xyz, r29.xyz);
    r28.z = dot(r6.xyz, r22.xyz);
  ...
  if (r5.w == 0) {
    ...
    if (r8.w != 0) {
      ...
      r9.w = 0;
      while (true) {
        r11.w = cmp((uint)r9.w >= (uint)r5.w);
        if (r11.w != 0) break;
        r9.z = (uint)r9.w >> 5;
        r10.xyz = (int3)r9.xyz + (int3)r19.xyz;
        r9.z = visibleProbes.Load(r10.xyzw).x;
        r10.x = cmp((int)r7.z == (int)r9.w);
    ...
    r17.xyz = r21.xyz * r1.www;
    r18.xyz = r22.xyz * r1.www;
    r3.w = cmp(r22.w < 0.99000001);
    if (r3.w != 0) {
      r3.w = 1 + -r22.w;
      r4.w = sunConstants.globalProbeExposure * r3.w;
      ...
      r17.xyz = r21.xyz * r1.www + r6.xyz;
      r12.w = 0;
      r6.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r12.xyzw, r2.w).xyz;
      r1.w = sunConstants.globalProbeExposure * r3.w + -r4.w;
      r1.w = r7.y * r1.w + r4.w;
      r18.xyz = r6.xyz * r1.www + r18.xyz;
    }
  } else {
    r18.x = r17.w;
  }
  r2.xyz = r17.xyz * r0.www + r2.xyz;
  r3.xyz = r17.xyz * r0.www + r3.xyz;
  ...
  r2.xyz = -r4.xyz * specColorTint.xyz + float3(1,1,1);
