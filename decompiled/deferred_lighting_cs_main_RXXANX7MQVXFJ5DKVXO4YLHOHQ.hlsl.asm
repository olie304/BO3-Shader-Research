...
if_nz r15.z
  ...
  add r16.yzw, r11.xxyz, -cb10[r15.z + 0].xxyz
  and r15.w, l(0x0000ffff), cb10[r15.z + 7].z
  ubfe r18.x, l(6), l(25), cb10[r15.z + 7].z
  imul null, r18.y, r15.w, l(6)
  ...
  if_nz r18.x
    mul r18.x, r15.w, cb10[r15.z + 7].y
    mov r19.x, cb10[r15.z + 7].w
    mov r19.yz, cb10[r15.z + 8].xxyx
    dp3 r18.y, r17.xyzx, r19.xyzx
    dp3 r18.z, r16.yzwy, r19.xyzx
    add r18.z, r18.z, -cb10[r15.z + 8].z
    ge r18.w, r18.z, l(0.000000)
    max r18.z, r13.w, |r18.z|
    ...
    div r18.z, r18.w, r18.z
    min r18.y, |r18.z|, r18.y
    add r19.x, r16.y, cb10[r15.z + 3].w
    add r19.yz, r16.zzwz, cb10[r15.z + 4].xxyx
    mad r19.xyz, r17.xyzx, r18.yyyy, r19.xyzx
    dp3 r18.z, r19.xyzx, r19.xyzx
    sqrt r18.z, r18.z
    div r18.y, r18.y, r18.z
    add r18.y, r18.y, r18.y
    sqrt r18.y, r18.y
    mad r18.y, r7.w, l(5.000000), r18.y
    add r18.y, r18.y, l(-0.844800)
    mov r20.x, cb10[r15.z + 0].w
    mov r20.y, cb10[r15.z + 1].z
    mov r20.z, cb10[r15.z + 2].y
    dp3 r21.x, r19.xyzx, r20.xyzx
    mov r22.xy, cb10[r15.z + 1].xwxx
    mov r22.z, cb10[r15.z + 2].z
    dp3 r21.y, r19.xyzx, r22.xyzx
    mov r23.x, cb10[r15.z + 1].y
    mov r23.yz, cb10[r15.z + 2].xxwx
    dp3 r21.z, r19.xyzx, r23.xyzx
    ubfe r18.z, l(9), l(16), cb10[r15.z + 7].z
    utof r21.w, r18.z
    sample_l_indexable(texturecubearray)(float,float,float,float) r18.yzw, r21.xyzw, t8.wxyz, s2, r18.y
    dp3 r19.x, r16.yzwy, r20.xyzx
    dp3 r19.y, r16.yzwy, r22.xyzx
    dp3 r19.z, r16.yzwy, r23.xyzx
    mad_sat r16.yzw, r19.xxyz, cb10[r15.z + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
    mul r19.xy, r16.yzyy, cb10[r15.z + 4].zwzz
    mul r19.z, r16.w, cb10[r15.z + 5].x
    add r16.yzw, r19.xxyz, cb10[r15.z + 5].yyzw
    dp3 r21.x, r12.xyzx, r20.xyzx
    dp3 r21.y, r12.xyzx, r22.xyzx
    dp3 r21.z, r12.xyzx, r23.xyzx
    lt r19.xyz, l(0.000000, 0.000000, 0.000000, 0.000000), r21.xyzx
    movc r20.z, r19.x, l(0), l(0.500000)
    mov r20.xy, l(0,0,0,0)
    add r20.xyz, r16.yzwy, r20.xyzx
    ...
    mad r19.xyw, r20.xyxz, r22.xxxx, r19.xyxw
    movc r20.z, r19.z, l(0), l(0.500000)
    mov r20.xy, l(0,0,0,0)
    add r16.yzw, r16.yyzw, r20.xxyz
    ...
    sample_l_indexable(texturecubearray)(float,float,float,float) r19.xyz, r21.xyzw, t8.xyzw, s2, l(6.000000)
    mul r16.yzw, r16.yyzw, r19.xxyz
    dp3 r15.z, r16.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
    mul r19.x, r14.w, r15.z
    mul r18.xyz, r18.xxxx, r18.yzwy
    dp3 r18.w, r18.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
    mad r15.z, r14.w, r15.z, r18.w
...
lt r15.z, r15.w, l(1.000000)
if_nz r15.z
  ult r15.y, r0.y, r15.y
  if_nz r15.y
    imul null, r0.y, r0.y, l(14)
    add r19.xyz, r11.xyzx, -cb10[r0.y + 0].xyzx
    and r15.y, l(0x0000ffff), cb10[r0.y + 7].z
    ubfe r15.z, l(6), l(25), cb10[r0.y + 7].z
    ...
    loop 
      ...
      mov r18.w, r21.z
    endloop 
    add_sat r15.y, -r15.w, r22.y
    mul r15.z, r15.y, cb10[r0.y + 6].y
    lt r18.w, l(0.000000), r15.z
    if_nz r18.w
      mad r15.w, r15.y, cb10[r0.y + 6].y, r15.w
      mul r15.y, r15.z, cb10[r0.y + 7].y
      mov r20.x, cb10[r0.y + 7].w
      mov r20.yz, cb10[r0.y + 8].xxyx
      dp3 r15.z, r17.xyzx, r20.xyzx
      ...
      min r15.z, r15.z, |r18.w|
      mov r20.x, cb10[r0.y + 9].w
      mov r20.yz, cb10[r0.y + 10].xxyx
      dp3 r18.w, r17.xyzx, r20.xyzx
      dp3 r19.w, r19.xyzx, r20.xyzx
      add r19.w, r19.w, -cb10[r0.y + 10].z
      ge r20.x, r19.w, l(0.000000)
      max r19.w, r13.w, |r19.w|
      movc r19.w, r20.x, r19.w, -r19.w
      max r18.w, -r18.w, l(0.00000010)
      ...
      dp3 r18.w, r17.xyzx, r20.xyzx
      dp3 r19.w, r19.xyzx, r20.xyzx
      add r19.w, r19.w, -cb10[r0.y + 11].z
      ge r20.x, r19.w, l(0.000000)
      max r19.w, r13.w, |r19.w|
      movc r19.w, r20.x, r19.w, -r19.w
      max r18.w, -r18.w, l(0.00000010)
      ...
      dp3 r18.w, r17.xyzx, r20.xyzx
      dp3 r19.w, r19.xyzx, r20.xyzx
      add r19.w, r19.w, -cb10[r0.y + 12].z
      ge r20.x, r19.w, l(0.000000)
      max r19.w, r13.w, |r19.w|
      movc r19.w, r20.x, r19.w, -r19.w
      max r18.w, -r18.w, l(0.00000010)
      ...
      dp3 r18.w, r17.xyzx, r20.xyzx
      dp3 r19.w, r19.xyzx, r20.xyzx
      add r19.w, r19.w, -cb10[r0.y + 13].z
      ge r20.x, r19.w, l(0.000000)
      max r13.w, r13.w, |r19.w|
      ...
      mul r7.w, r0.y, r14.w
      mul r19.xyz, r15.yyyy, r20.xyzx
      dp3 r13.w, r19.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r0.y, r14.w, r0.y, r13.w
      div r0.y, r7.w, r0.y
      mad r18.xyz, r19.xyzx, r0.yyyy, r18.xyzx
    endif 
  endif 
endif 
max r0.y, r15.w, l(1.000000)
rcp r0.y, r0.y
mov_sat r15.w, r15.w
...
if_nz r7.w
  ...
  mul r20.x, r15.y, cb2[35].w
  mul r20.yz, r15.zzwz, cb2[36].xxyx
  add_sat r15.yzw, r20.xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
  mul r20.xy, r15.yzyy, cb2[36].zwzz
  mul r20.z, r15.w, cb2[37].x
  add r15.yzw, r20.xxyz, cb2[37].yyzw
  lt r20.xyz, l(0.000000, 0.000000, 0.000000, 0.000000), r12.xyzx
  movc r20.xyz, r20.xyzx, l(0,0,0,0), l(0.500000,0.500000,0.500000,0)
  mov r20.w, l(0)
  add r21.xyz, r15.yzwy, r20.wwxw
