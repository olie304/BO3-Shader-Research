...
Texture2D<float4> codeTexture0 : register(t2);
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.x = frac(r0.x);
  r0.x = r0.x * 2 + -1;
  r0.x = postFxControl0.w * r0.x;
  r1.xz = postFxControl1.xx;
  r1.y = 0;
  r0.yz = float2(-0.5,-0.5) + v1.xy;
  r0.w = dot(r0.yz, r0.yz);
  r1.w = sqrt(r0.w);
  r1.w = postFxControl0.z * r1.w;
  r1.xyz = r1.xyz * float3(0.150000006,1.5,-0.150000006) + r1.www;
  r1.xyz = r0.www * r1.xyz + float3(1,1,1);
  r1.xyz = postFxControl1.zzz * r1.xyz;
  r2.xyz = r1.xyz * r0.yyy + float3(0.5,0.5,0.5);
  r1.xyz = r1.xyz * r0.zzz + float3(0.5,0.5,0.5);
  r0.yz = float2(2,1.125) * r0.yz;
  r0.y = dot(r0.yz, r0.yz);
  r0.y = sqrt(r0.y);
  r0.yz = saturate(-postFxControl0.xy * r0.yy + float2(1,1));
  r3.x = r2.z;
  r3.y = r1.z;
  r3.z = colorMapSampler.Sample(samp0_s, r3.xy).z;
  r2.w = r1.x;
  r3.x = colorMapSampler.Sample(samp0_s, r2.xw).x;
  r1.w = r2.y;
  r3.w = 1;
  r3.y = colorMapSampler.Sample(samp0_s, r1.wy).y;
  r1.xyzw = codeTexture0.Sample(bilinearClamp_s, r1.wy).xyzw;
  r2.xyzw = -r1.xyzw * postFxControl2.xyzw + r3.xyzw;
  r1.xyzw = postFxControl2.xyzw * r1.xyzw;
  r1.xyzw = r0.yyyy * r2.xyzw + r1.xyzw;
  r2.xyzw = lensFilter.Sample(bilinearClamp_s, v1.xy).xyzw;
  r2.xyzw = saturate(postFxControl1.yyyy + r2.xyzw);
  r1.xyzw = r2.xyzw * r1.xyzw;
  r0.y = dot(r1.xyz, float3(0.349999994,0.5,0.150000006));
  r0.w = 1 + -r0.y;
  r0.w = r0.w * r0.w;
  r1.xyzw = r0.xxxx * r0.wwww + r1.xyzw;
  r1.xyz = r1.xyz + -r0.yyy;
  o0.w = r1.w;
  o0.xyz = r0.zzz * r1.xyz + r0.yyy;
  return;
}