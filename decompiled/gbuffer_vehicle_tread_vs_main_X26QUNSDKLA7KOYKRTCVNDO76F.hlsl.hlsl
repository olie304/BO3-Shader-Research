...
r4.y = colorSampler[]..swiz;
  ...
  r3.xyzw = r3.zzzz * viewProjectionMatrix._m20_m21_m22_m23 + r5.xyzw;
  ...
  r5.xyzw = r3.xyxy * float4(-1,0,-1,1) + r4.xyxy;
  r2.y = treadHeightMap.SampleLevel(colorSampler_s, r5.xy, 0).x;
  r3.z = treadHeightMap.SampleLevel(colorSampler_s, r5.zw, 0).x;
  r5.xyzw = r3.xyxy * float4(0,-1,0,1) + r4.xyxy;
  r3.w = treadHeightMap.SampleLevel(colorSampler_s, r5.xy, 0).x;
  r4.z = treadHeightMap.SampleLevel(colorSampler_s, r5.zw, 0).x;
  r5.xyzw = r3.xyxy * float4(1,-1,1,0) + r4.xyxy;
  r4.w = treadHeightMap.SampleLevel(colorSampler_s, r5.xy, 0).x;
  r5.x = treadHeightMap.SampleLevel(colorSampler_s, r5.zw, 0).x;
  r3.xy = r4.xy + r3.xy;
  r3.x = treadHeightMap.SampleLevel(colorSampler_s, r3.xy, 0).x;
  r3.y = abs(r5.x) * 2 + abs(r4.w);
  r3.y = r3.y + abs(r3.x);
  r3.y = r3.y + -abs(r1.w);
  r2.y = -abs(r2.y) * 2 + r3.y;
  r2.y = r2.y + -abs(r3.z);
  r3.y = abs(r4.z) * 2 + abs(r3.z);
  r3.x = r3.y + abs(r3.x);
  r1.w = r3.x + -abs(r1.w);
  r1.w = -abs(r3.w) * 2 + r1.w;
  r1.w = r1.w + -abs(r4.w);
  r3.x = -r2.y;
  r3.y = -r1.w;
  ...
  r3.x = dot(r0.xyz, r3.xyz);
  r3.y = dot(r0.xyz, r5.xyz);
  r3.z = dot(r0.xyz, r6.xyz);
  r0.x = dot(r3.xyz, r3.xyz);
  r0.x = rsqrt(r0.x);
  o2.xyz = r3.xyz * r0.xxx;
  if (r0.w != 0) {
  // Known bad code for instruction (needs manual fix):
