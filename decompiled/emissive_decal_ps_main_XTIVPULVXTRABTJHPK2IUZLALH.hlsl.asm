...
//   float uvMotionToggle;              // Offset:  380 Size:     4 [unused]
//
// }
//
...
eq r1.yzw, r1.yyyy, l(0.000000, 3.000000, 2.000000, 1.000000)
movc r2.xyz, r1.wwww, cb0[21].xyzx, cb0[19].yzwy
movc r2.xyz, r1.zzzz, cb0[22].xyzx, r2.xyzx
movc r1.yzw, r1.yyyy, cb0[23].xxyz, r2.xxyz
...
dp3_sat r1.y, r1.yzwy, r2.xyzx
eq r1.z, cb0[19].x, l(0.000000)
log r1.y, r1.y
