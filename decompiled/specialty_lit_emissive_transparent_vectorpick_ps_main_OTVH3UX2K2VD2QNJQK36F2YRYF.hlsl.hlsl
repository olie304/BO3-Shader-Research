...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  r1.y = saturate(w2.x);
  r1.y = hdrScale * r1.y;
  r11.xyz = cmp(w2.yww == float3(3,2,1));
  ...
  r1.y = r1.y * r3.x;
  r1.y = r1.y * r1.z;
  r3.xyz = r3.yzw * r1.yyy;
  r1.y = cmp(isDepthHack != 0);
  r4.xy = (uint2)r6.xy;
  r1.z = dot(r4.yx, float2(0.0671105608,0.00583714992));
  r1.z = frac(r1.z);
  ...
  r1.z = frac(r1.z);
  r1.z = r1.z * 6.28318548 + gameTick.w;
  sincos(r1.z, r4.x, r11.x);
  r7.x = saturate(dot(r2.xyz, r12.xyz));
  r1.z = dot(-r12.xyz, r2.xyz);
  r1.z = r1.z + r1.z;
  r13.xyz = r2.xyz * -r1.zzz + -r12.xyz;
  r1.z = 17 * r7.y;
  r1.z = exp2(r1.z);
  r1.z = 2 + r1.z;
  r1.z = 2 / r1.z;
  ...
  while (true) {
    ...
    bitmask.w = ((~(-1 << r7.w)) << 0) & 0xffffffff;  r12.w = (((uint)0 << 0) & bitmask.w) | ((uint)r11.z & ~bitmask.w);
  ...
  if (r8.w != 0) {
    ...
    while (true) {
      ...
      if (r7.w == 0) r14.w = 0; else if (r7.w+0 < 32) {       r14.w = (uint)r12.w << (32-(r7.w + 0)); r14.w = (uint)r14.w >> (32-r7.w);      } else r14.w = (uint)r12.w >> 0;
  ...
  if (r5.z != 0) {
    ...
    r11.yzw = r21.xyz * r4.zzz + r15.xyz;
    r13.w = 0;
  ...
  if (r5.z != 0) {
    ...
    if (r5.z != 0) {
        ...
        r17.y = samp0[]..swiz;
          ...
          if (enableDitheredShadow != 0) {
            ...
            while (true) {
              ...
              r11.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r18.xyz, r6.w).x;
      ...
      r1.w = dot(r11.yzw, r12.xyz);
      r6.w = dot(r2.xyz, r11.yzw);
      ...
      r4.w = r5.w * r4.w;
      r4.w = 0.25 * r4.w;
      r11.yzw = r4.www * r9.xyz + r7.yzw;
      r1.w = saturate(1 + -r1.w);
      r5.z = r1.w * r1.w;
      r5.z = r5.z * r5.z;
      r1.w = r5.z * r1.w;
      r1.w = r4.w * r1.w;
      r9.xyz = r1.www * r9.yzx + r14.xyz;
      r16.w = r9.z;
      r15.w = r14.z;
            ...
            if (r16.w != 0) {
              ...
              if (r16.w != 0) {
                ...
                if (r16.w != 0) {
                  ...
                  r12.w = r12.w + -r16.z;
                  r12.w = r4.y * r12.w + r16.z;
                  r12.w = r12.w * r14.w;
                  r33.x = r32.x;
                  r13.w = cmp(0 < r15.w);
                  r20.xyz = r12.www * r33.xyz + r17.xyz;
                  r12.w = saturate(dot(r2.xyz, r40.xyz));
                  ...
                  r16.z = abs(r15.w) * r1.z + -abs(r15.w);
                  r15.w = abs(r15.w) * r16.z + 1;
                  r16.z = r12.w * r1.x + r2.w;
                  r15.w = r15.w * r15.w;
                  r15.w = r15.w * r16.z;
                  r15.w = rcp(r15.w);
                  r12.w = r12.w * r16.w;
            ...
            r40.w = samp0[]..swiz;
              ...
              if (r14.w != 0) {
                ...
                if (r14.w != 0) {
                  ...
                  r16.w = abs(r15.w) * r1.z + -abs(r15.w);
