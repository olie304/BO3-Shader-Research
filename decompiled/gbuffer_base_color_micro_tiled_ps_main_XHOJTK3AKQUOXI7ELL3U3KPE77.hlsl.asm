...
// baseColorSampler                  sampler      NA          NA             s3      1 
// colorMap                          texture  float4          2d             t0      1 
// normalMap                         texture  float4          2d             t6      1 
// detailMap                         texture  float4          2d             t7      1 
// baseColorMap                      texture  float4          2d             t9      1 
...
sample_indexable(texture2d)(float,float,float,float) r5.xyzw, v2.xyxx, t9.xyzw, s3
...
mad r2.w, cb0[11].w, r0.w, cb0[11].x
