...
loop 
  ieq r10.w, r9.w, l(2)
  breakc_nz r10.w
  movc r10.w, r9.w, r0.x, r14.y
  uge r12.w, r10.w, r8.w
  ult r13.w, r10.w, cb2[0].y
  ...
  if_nz r12.w
    ...
    if_nz r2.w
      ...
      add r17.yzw, cb1[24].xxyz, cb10[r10.w + 0].xxyz
    ...
    ubfe r13.w, l(6), l(25), cb10[r10.w + 7].z
    imul null, r14.w, r12.w, l(6)
    dp3 r17.y, cb11[r14.w + 0].xyzx, r15.yzwy
    add_sat r17.y, r17.y, cb11[r14.w + 0].w
    dp3 r17.z, cb11[r14.w + 1].xyzx, r15.yzwy
    add_sat r17.z, r17.z, cb11[r14.w + 1].w
    mul r17.y, r17.z, r17.y
    dp3 r17.z, cb11[r14.w + 2].xyzx, r15.yzwy
    add_sat r17.z, r17.z, cb11[r14.w + 2].w
    mul r17.y, r17.z, r17.y
    dp3 r17.z, cb11[r14.w + 3].xyzx, r15.yzwy
    add_sat r17.z, r17.z, cb11[r14.w + 3].w
    mul r17.y, r17.z, r17.y
    dp3 r17.z, cb11[r14.w + 4].xyzx, r15.yzwy
    add_sat r17.z, r17.z, cb11[r14.w + 4].w
    mul r17.y, r17.z, r17.y
    dp3 r17.z, cb11[r14.w + 5].xyzx, r15.yzwy
    add_sat r14.w, r17.z, cb11[r14.w + 5].w
    mul r18.x, r14.w, r17.y
    and r14.w, l(1), cb10[r10.w + 6].x
    movc r17.yz, r14.wwww, r18.xxyx, r18.zzxz
    mov r14.w, cb10[r10.w + 6].x
    mov r26.xy, r17.yzyy
    mov r17.w, l(1)
    loop 
      ige r18.x, r17.w, r13.w
      breakc_nz r18.x
      iadd r18.x, r12.w, r17.w
      imul null, r18.x, r18.x, l(6)
      dp3 r18.w, cb11[r18.x + 0].xyzx, r15.yzwy
      add_sat r18.w, r18.w, cb11[r18.x + 0].w
      mul r18.w, r18.w, r26.x
      dp3 r19.w, cb11[r18.x + 1].xyzx, r15.yzwy
      add_sat r19.w, r19.w, cb11[r18.x + 1].w
      mul r18.w, r18.w, r19.w
      dp3 r19.w, cb11[r18.x + 2].xyzx, r15.yzwy
      add_sat r19.w, r19.w, cb11[r18.x + 2].w
      mul r18.w, r18.w, r19.w
      dp3 r19.w, cb11[r18.x + 3].xyzx, r15.yzwy
      add_sat r19.w, r19.w, cb11[r18.x + 3].w
      mul r18.w, r18.w, r19.w
      dp3 r19.w, cb11[r18.x + 4].xyzx, r15.yzwy
      add_sat r19.w, r19.w, cb11[r18.x + 4].w
      mul r18.w, r18.w, r19.w
      dp3 r19.w, cb11[r18.x + 5].xyzx, r15.yzwy
      add_sat r18.x, r19.w, cb11[r18.x + 5].w
      mul r26.x, r18.x, r18.w
      ushr r19.w, r14.w, l(2)
      ubfe r21.w, l(1), l(2), r14.w
      and r22.w, r19.w, l(2)
      max r26.z, r26.x, r26.y
      mad r18.x, -r18.w, r18.x, l(1.000000)
      mul r18.x, r18.x, r26.y
      movc r20.y, r22.w, r18.x, r26.z
      movc r26.xy, r21.wwww, r26.xyxx, r20.xyxx
      iadd r17.w, r17.w, l(1)
      mov r14.w, r19.w
    endloop 
    mov_sat r26.y, r26.y
    mul r12.w, r26.y, cb10[r10.w + 6].y
    ...
    if_nz r13.w
      ...
      add r17.y, r17.y, -cb10[r10.w + 9].z
      ...
      dp3 r14.w, r16.xyzx, r27.xyzx
      dp3 r17.y, r15.yzwy, r27.xyzx
      add r17.y, r17.y, -cb10[r10.w + 10].z
      ge r17.z, r17.y, l(0.000000)
      max r17.y, r6.w, |r17.y|
      movc r17.y, r17.z, r17.y, -r17.y
      max r14.w, -r14.w, l(0.00000010)
      ...
      dp3 r14.w, r16.xyzx, r27.xyzx
      dp3 r17.y, r15.yzwy, r27.xyzx
      add r17.y, r17.y, -cb10[r10.w + 11].z
      ge r17.z, r17.y, l(0.000000)
      max r17.y, r6.w, |r17.y|
      movc r17.y, r17.z, r17.y, -r17.y
      max r14.w, -r14.w, l(0.00000010)
      ...
      dp3 r14.w, r16.xyzx, r27.xyzx
      dp3 r17.y, r15.yzwy, r27.xyzx
      add r17.y, r17.y, -cb10[r10.w + 12].z
      ge r17.z, r17.y, l(0.000000)
      max r17.y, r6.w, |r17.y|
      movc r17.y, r17.z, r17.y, -r17.y
      max r14.w, -r14.w, l(0.00000010)
      ...
      dp3 r14.w, r16.xyzx, r27.xyzx
      dp3 r17.y, r15.yzwy, r27.xyzx
      add r17.y, r17.y, -cb10[r10.w + 13].z
      ge r17.z, r17.y, l(0.000000)
      max r17.y, r6.w, |r17.y|
      movc r17.y, r17.z, r17.y, -r17.y
      max r14.w, -r14.w, l(0.00000010)
      div r14.w, r17.y, r14.w
      min r13.w, r13.w, |r14.w|
      add r27.x, r15.y, cb10[r10.w + 3].w
      add r27.yz, r15.zzwz, cb10[r10.w + 4].xxyx
      mad r17.yzw, r16.xxyz, r13.wwww, r27.xxyz
      ...
      mad_sat r15.yzw, r31.xxyz, cb10[r10.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
      mul r31.xy, r15.yzyy, cb10[r10.w + 4].zwzz
      mul r31.z, r15.w, cb10[r10.w + 5].x
      add r15.yzw, r31.xxyz, cb10[r10.w + 5].yyzw
      ...
      movc r26.xzw, r10.wwww, l(1.000000,0,1.000000,0), r26.xxzw
      ...
      mul r15.yzw, r12.wwww, r17.yyzw
      dp3 r12.w, r15.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r10.w, r7.w, r10.w, r12.w
      div r10.w, r13.w, r10.w
      mov r27.x, r23.w
      mov r27.yz, r24.xxyx
      mad r15.yzw, r15.yyzw, r10.wwww, r27.xxyz
      mov r23.w, r15.y
      mov r24.xy, r15.zwzz
    else 
...
loop 
  ...
  breakc_nz r10.w
  movc r10.w, r9.w, r0.x, r14.y
  ult r12.w, r10.w, r8.w
  if_nz r12.w
    imul null, r10.w, r10.w, l(14)
    if_nz r2.w
      and r12.w, r20.y, l(15)
      imad r12.w, r12.w, l(20), l(880)
      add r17.yzw, cb1[24].xxyz, cb10[r10.w + 0].xxyz
      store_structured u2.xyzw, cb2[52].x, r12.w, r17.xyzw
    endif 
    iadd r26.y, r20.y, l(1)
    add r17.yzw, r5.xxyz, -cb10[r10.w + 0].xxyz
    and r12.w, l(0x0000ffff), cb10[r10.w + 7].z
    ubfe r13.w, l(6), l(25), cb10[r10.w + 7].z
    imul null, r14.w, r12.w, l(6)
    dp3 r18.w, cb11[r14.w + 0].xyzx, r17.yzwy
    add_sat r18.w, r18.w, cb11[r14.w + 0].w
    dp3 r19.w, cb11[r14.w + 1].xyzx, r17.yzwy
    add_sat r19.w, r19.w, cb11[r14.w + 1].w
    mul r18.w, r18.w, r19.w
    dp3 r19.w, cb11[r14.w + 2].xyzx, r17.yzwy
    add_sat r19.w, r19.w, cb11[r14.w + 2].w
    mul r18.w, r18.w, r19.w
    dp3 r19.w, cb11[r14.w + 3].xyzx, r17.yzwy
    add_sat r19.w, r19.w, cb11[r14.w + 3].w
    mul r18.w, r18.w, r19.w
    dp3 r19.w, cb11[r14.w + 4].xyzx, r17.yzwy
    add_sat r19.w, r19.w, cb11[r14.w + 4].w
    mul r18.w, r18.w, r19.w
    dp3 r19.w, cb11[r14.w + 5].xyzx, r17.yzwy
    add_sat r14.w, r19.w, cb11[r14.w + 5].w
    mul r18.x, r14.w, r18.w
    and r14.w, l(1), cb10[r10.w + 6].x
    movc r18.xw, r14.wwww, r18.xxxy, r18.zzzx
    mov r14.w, cb10[r10.w + 6].x
    mov r27.xy, r18.xwxx
    mov r19.w, l(1)
    loop 
      ige r21.w, r19.w, r13.w
      breakc_nz r21.w
      iadd r21.w, r12.w, r19.w
      ...
      ubfe r26.z, l(1), l(2), r14.w
      and r26.w, r25.w, l(2)
      max r27.z, r27.x, r27.y
      mad r21.w, -r22.w, r21.w, l(1.000000)
      mul r21.w, r21.w, r27.y
      movc r20.w, r26.w, r21.w, r27.z
      movc r27.xy, r26.zzzz, r27.xyxx, r20.zwzz
      iadd r19.w, r19.w, l(1)
      mov r14.w, r25.w
    endloop 
    add_sat r12.w, -r24.z, r27.y
    mul r13.w, r12.w, cb10[r10.w + 6].y
    lt r14.w, l(0.000000), r13.w
    if_nz r14.w
      and r14.w, r26.y, l(31)
      iadd r18.x, r14.w, l(-1)
      ult r18.x, r18.x, l(32)
      and r18.x, r2.w, r18.x
      if_nz r18.x
        imad r18.xw, r14.wwww, l(20, 0, 0, 20), l(860, 0, 0, 876)
        ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r14.w, cb2[52].x, r18.x, u2.xxxx
        or r14.w, r14.w, l(32)
        store_structured u2.x, cb2[52].x, r18.x, r14.w
        store_structured u2.x, cb2[52].x, r18.w, r13.w
      endif 
      iadd r20.y, r20.y, l(257)
      mad r20.x, r12.w, cb10[r10.w + 6].y, r20.x
      mul r12.w, r13.w, cb10[r10.w + 7].y
      mov r28.x, cb10[r10.w + 7].w
      mov r28.yz, cb10[r10.w + 8].xxyx
      dp3 r13.w, r16.xyzx, r28.xyzx
      dp3 r14.w, r17.yzwy, r28.xyzx
      add r14.w, r14.w, -cb10[r10.w + 8].z
      ge r18.x, r14.w, l(0.000000)
      max r14.w, r6.w, |r14.w|
      movc r14.w, r18.x, r14.w, -r14.w
      max r13.w, -r13.w, l(0.00000010)
      div r13.w, r14.w, r13.w
      min r13.w, |r13.w|, l(131072.000000)
      mov r28.x, cb10[r10.w + 8].w
      mov r28.yz, cb10[r10.w + 9].xxyx
      dp3 r14.w, r16.xyzx, r28.xyzx
      dp3 r18.x, r17.yzwy, r28.xyzx
      add r18.x, r18.x, -cb10[r10.w + 9].z
      ge r18.w, r18.x, l(0.000000)
      max r18.x, r6.w, |r18.x|
      movc r18.x, r18.w, r18.x, -r18.x
      max r14.w, -r14.w, l(0.00000010)
      div r14.w, r18.x, r14.w
      min r13.w, r13.w, |r14.w|
      mov r28.x, cb10[r10.w + 9].w
      mov r28.yz, cb10[r10.w + 10].xxyx
      dp3 r14.w, r16.xyzx, r28.xyzx
      dp3 r18.x, r17.yzwy, r28.xyzx
      add r18.x, r18.x, -cb10[r10.w + 10].z
      ge r18.w, r18.x, l(0.000000)
      max r18.x, r6.w, |r18.x|
      movc r18.x, r18.w, r18.x, -r18.x
      max r14.w, -r14.w, l(0.00000010)
      div r14.w, r18.x, r14.w
      min r13.w, r13.w, |r14.w|
      mov r28.x, cb10[r10.w + 10].w
      mov r28.yz, cb10[r10.w + 11].xxyx
      dp3 r14.w, r16.xyzx, r28.xyzx
      dp3 r18.x, r17.yzwy, r28.xyzx
      add r18.x, r18.x, -cb10[r10.w + 11].z
      ge r18.w, r18.x, l(0.000000)
      max r18.x, r6.w, |r18.x|
      movc r18.x, r18.w, r18.x, -r18.x
      max r14.w, -r14.w, l(0.00000010)
      div r14.w, r18.x, r14.w
      min r13.w, r13.w, |r14.w|
      mov r28.x, cb10[r10.w + 11].w
      mov r28.yz, cb10[r10.w + 12].xxyx
      dp3 r14.w, r16.xyzx, r28.xyzx
      dp3 r18.x, r17.yzwy, r28.xyzx
      add r18.x, r18.x, -cb10[r10.w + 12].z
      ge r18.w, r18.x, l(0.000000)
      max r18.x, r6.w, |r18.x|
      movc r18.x, r18.w, r18.x, -r18.x
      max r14.w, -r14.w, l(0.00000010)
      div r14.w, r18.x, r14.w
      min r13.w, r13.w, |r14.w|
      mov r28.x, cb10[r10.w + 12].w
      mov r28.yz, cb10[r10.w + 13].xxyx
      dp3 r14.w, r16.xyzx, r28.xyzx
      dp3 r18.x, r17.yzwy, r28.xyzx
      add r18.x, r18.x, -cb10[r10.w + 13].z
      ge r18.w, r18.x, l(0.000000)
      max r18.x, r6.w, |r18.x|
      movc r18.x, r18.w, r18.x, -r18.x
      max r14.w, -r14.w, l(0.00000010)
      div r14.w, r18.x, r14.w
      min r13.w, r13.w, |r14.w|
      add r28.x, r17.y, cb10[r10.w + 3].w
      add r28.yz, r17.zzwz, cb10[r10.w + 4].xxyx
      mad r27.xzw, r16.xxyz, r13.wwww, r28.xxyz
      ...
      ubfe r14.w, l(9), l(16), cb10[r10.w + 7].z
      utof r29.w, r14.w
      sample_l_indexable(texturecubearray)(float,float,float,float) r27.xzw, r29.xyzw, t8.xwyz, s2, r13.w
      and r32.xyz, r27.xzwx, l(0x7fffffff, 0x7fffffff, 0x7fffffff, 0)
      ieq r32.xyz, r32.xyzx, l(0x7f800000, 0x7f800000, 0x7f800000, 0)
      or r13.w, r32.y, r32.x
      or r13.w, r32.z, r13.w
      ...
      mad_sat r17.yzw, r32.xxyz, cb10[r10.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
      mul r32.xy, r17.yzyy, cb10[r10.w + 4].zwzz
      mul r32.z, r17.w, cb10[r10.w + 5].x
      add r17.yzw, r32.xxyz, cb10[r10.w + 5].yyzw
      ...
      or r10.w, r29.y, r29.x
      or r10.w, r29.z, r10.w
      movc r28.xyz, r10.wwww, l(1.000000,1.000000,0,0), r28.xyzx
      mul r29.xyz, r17.yzwy, r28.xyzx
      dp3 r10.w, r29.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r15.yzw, r17.yyzw, r28.xxyz, r15.yyzw
      mul r13.w, r7.w, r10.w
      mul r17.yzw, r12.wwww, r27.xxzw
      dp3 r12.w, r17.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r10.w, r7.w, r10.w, r12.w
      div r10.w, r13.w, r10.w
      mad r25.xyz, r17.yzwy, r10.wwww, r25.xyzx
    else 
      mov r26.x, r20.x
      mov r20.xy, r26.xyxx
    endif 
...
lt r6.w, r20.x, l(0.990000)
if_nz r6.w
  iadd r0.x, r0.x, l(256)
  add r6.w, -r20.x, l(1.000000)
...
if_nz r0.y
  ...
  mad r3.xyz, r0.yyyy, r4.xywx, r2.xyzx
endif 
