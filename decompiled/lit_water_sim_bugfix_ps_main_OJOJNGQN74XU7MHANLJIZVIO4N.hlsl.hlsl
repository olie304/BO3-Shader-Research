...
r1.w = samp0[]..swiz;
  ...
  r4.xyw = r6.xyz * r0.www + r8.xyz;
  r0.z = 1 + -r4.z;
  r0.w = r0.z * r0.z;
  r0.w = r0.w * r0.w;
  r0.z = r0.z * r0.w;
  r0.z = r0.z * 0.980000019 + 0.0199999996;
  r0.x = saturate(invZFeatherDepth * r0.x);
  r0.x = r0.z * r0.x;
  r0.x = useSpecularZFeather ? r0.x : r0.z;
  r4.xyz = r4.xyw + -r3.xyz;
