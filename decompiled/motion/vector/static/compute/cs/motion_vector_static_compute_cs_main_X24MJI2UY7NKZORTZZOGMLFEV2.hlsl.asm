...
if_nz r1.x
  ...
  mul r2.xy, r1.yzyy, cb7[14].xyxx
  mov r2.z, l(1.000000)
  mul r1.xyz, r1.xxxx, r2.xyzx
  mul r2.xyz, r1.yyyy, cb7[9].xyzx
  mad r1.xyw, r1.xxxx, cb7[8].xyxz, r2.xyxz
  mad r1.xyz, r1.zzzz, cb7[10].xyzx, r1.xywx
  add r1.xyz, r1.xyzx, cb7[11].xyzx
  add r1.xyz, r1.xyzx, cb7[13].xyzx
  mul r2.xyz, r1.yyyy, cb7[1].xywx
  mad r1.xyw, r1.xxxx, cb7[0].xyxw, r2.xyxz
  mad r1.xyz, r1.zzzz, cb7[2].xywx, r1.xywx
  add r1.xyz, r1.xyzx, cb7[3].xywx
  div r1.xy, r1.xyxx, r1.zzzz
  mad r1.xy, r1.xyxx, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
  mad r0.zw, r0.zzzw, cb1[44].zzzw, -r1.xxxy
  mul r0.xy, r0.zwzz, cb1[44].xyxx
endif 
add r1.xyzw, |r0.xyxx|, l(-10.000000, -10.000000, -10.000000, -10.000000)
mul_sat r1.xyzw, r1.xyzw, l(0.03333334, 0.03333334, 0.03333334, 0.03333334)
mul r2.xyzw, |r0.xyxx|, l(0.100000, 0.100000, 0.100000, 0.100000)
min r2.xyzw, r2.xyzw, l(1.000000, 1.000000, 1.000000, 1.000000)
add r2.xyzw, -r1.wyww, r2.xyzw
mad r1.xyzw, r2.xyzw, l(0.500000, 0.500000, 0.500000, 0.500000), r1.xyzw
ge r0.xyzw, r0.xyxx, l(0.000000, 0.000000, 0.000000, 0.000000)
movc r0.xyzw, r0.xyzw, r1.xyzw, -r1.wyww
