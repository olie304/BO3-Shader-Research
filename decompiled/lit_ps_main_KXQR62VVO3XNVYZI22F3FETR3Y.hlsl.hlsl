// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:38:02 2021
...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  if (r1.z != 0) {
    ...
    r2.x = colorMap.CalculateLevelOfDetail(colorSampler_s, v2.xy);
    r1.w = cmp(r1.w < r2.x);
    r2.x = cmp(0 < r2.x);
    r2.yzw = (int3)r1.zzz & int3(1,2,4);
    r3.xyz = r2.yyy ? float3(1,0,1) : r0.xyz;
    r4.xyz = r2.zzz ? float3(0,1,1) : r0.xyz;
    r2.xyz = r2.xxx ? r3.xyz : r4.xyz;
    r3.xyz = r2.www ? float3(0,1,0) : r0.xyz;
    r0.xyz = r1.www ? r2.xyz : r3.xyz;
  }
  r0.w = -r0.w * w1.x + debugAlphaOverride.x;
  r2.w = debugAlphaOverride.w * r0.w + r1.x;
  r0.w = cmp(r2.w == 0.000000);
  if (r0.w != 0) {
    o0.xyzw = float4(0,0,0,0);
    return;
  }
  r0.w = glossMap.Sample(specColorSampler_s, v2.xy).x;
  r1.xzw = normalMap.Sample(normalSampler_s, v2.xy).xyz;
  ...
  r0.w = r0.w * r3.w + glossRange.x;
  r0.w = saturate(0.0588235296 * r0.w);
  r1.xzw = float3(-0.5,-0.5,-0) + r1.xzw;
  r1.xzw = baseNormalHeight * r1.xzw + float3(0.5,0.5,0);
  r1.xz = r1.xz * float2(1.9921875,1.9921875) + float2(-1,-1);
  ...
  r1.w = min(1, r1.w);
  r4.y = v7.x ? 1 : -1;
  r4.z = dot(v3.xyz, v3.xyz);
  r4.z = rsqrt(r4.z);
  r5.xyz = v3.xyz * r4.zzz;
  ...
  r4.yzw = r6.xyz * r1.xxx + r4.yzw;
  r4.xyz = r5.xyz * r4.xxx + r4.yzw;
  r1.x = dot(r4.xyz, r4.xyz);
  r1.x = rsqrt(r1.x);
  r4.xyz = r4.xyz * r1.xxx;
  r1.x = debugGlossOverride.x * r3.w + glossRange.x;
  ...
  r5.xyz = debugSpecularOverride.xyz + -r3.xyz;
  r3.xyz = debugSpecularOverride.www * r5.xyz + r3.xyz;
  r1.x = r1.x + -r0.w;
  r5.y = debugGlossOverride.w * r1.x + r0.w;
  ...
  r4.xyzw = renderTargetSize.zwzw * scopeDiameter.xxyy;
  r5.zw = renderTargetSize.zw * v0.xy;
  ...
  r3.w = r3.w * r3.w;
  r3.w = r4.x * r3.w;
  r4.xyz = scopeCrush * r3.xyz;
  r3.xyz = -r3.xyz * scopeCrush + r3.xyz;
  ...
  r5.zw = (uint2)r4.yx;
  r6.w = dot(r5.wz, float2(0.0671105608,0.00583714992));
  r6.w = frac(r6.w);
  ...
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r21.xyzw, r9.y, l(0), t15.wxyz
  r21.x = samp0[]..swiz;
  r21.y = samp0[]..swiz;
  r21.z = samp0[]..swiz;
  r21.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r22.xyzw, r9.y, l(16), t15.xyzw
  r22.x = samp0[]..swiz;
  r22.y = samp0[]..swiz;
  r22.z = samp0[]..swiz;
  r22.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r23.xyzw, r9.y, l(32), t15.yxwz
  r23.x = samp0[]..swiz;
  r23.y = samp0[]..swiz;
  r23.z = samp0[]..swiz;
  r23.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r24.xyzw, r9.y, l(48), t15.xyzw
  r24.x = samp0[]..swiz;
  r24.y = samp0[]..swiz;
  r24.z = samp0[]..swiz;
  r24.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r25.xyzw, r9.y, l(64), t15.zwxy
  r25.x = samp0[]..swiz;
  r25.y = samp0[]..swiz;
  r25.z = samp0[]..swiz;
  r25.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r26.xyzw, r9.y, l(80), t15.xyzw
  r26.x = samp0[]..swiz;
  r26.y = samp0[]..swiz;
  r26.z = samp0[]..swiz;
  r26.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r10.yz, r9.y, l(96), t15.xxyx
  r10.y = samp0[]..swiz;
  r10.z = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r27.xyzw, r9.y, l(116), t15.xyzw
  r27.x = samp0[]..swiz;
  r27.y = samp0[]..swiz;
  r27.z = samp0[]..swiz;
  r27.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r28.xyzw, r9.y, l(132), t15.zwxy
  r28.x = samp0[]..swiz;
  r28.y = samp0[]..swiz;
  r28.z = samp0[]..swiz;
  r28.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r29.xyzw, r9.y, l(148), t15.zwxy
  r29.x = samp0[]..swiz;
  r29.y = samp0[]..swiz;
  r29.z = samp0[]..swiz;
  r29.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r30.xyzw, r9.y, l(164), t15.zwxy
  r30.x = samp0[]..swiz;
  r30.y = samp0[]..swiz;
  r30.z = samp0[]..swiz;
  r30.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r31.xyzw, r9.y, l(180), t15.zwxy
  r31.x = samp0[]..swiz;
  r31.y = samp0[]..swiz;
  r31.z = samp0[]..swiz;
  r31.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r32.xyzw, r9.y, l(196), t15.xyzw
  r32.x = samp0[]..swiz;
  r32.y = samp0[]..swiz;
  r32.z = samp0[]..swiz;
  r32.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r33.xy, r9.y, l(212), t15.xyxx
  r33.x = samp0[]..swiz;
  r33.y = samp0[]..swiz;
  ...
  r39.w = samp0[]..swiz;
    ...
    r28.z = r29.z;
    r15.x = dot(r11.xyz, r28.xyz);
    r15.w = dot(r14.xyz, r28.xyz);
    r15.w = r15.w + -r29.w;
    r16.w = cmp(r15.w >= 0);
    ...
    r12.w = min(abs(r15.x), r12.w);
    r33.zw = r32.zw;
    r15.x = dot(r11.zxy, r33.xzw);
    r15.w = dot(r14.zxy, r33.xzw);
    r15.w = r15.w + -r33.y;
    r16.w = cmp(r15.w >= 0);
    r15.w = max(abs(r15.w), r7.w);
    r15.w = r16.w ? r15.w : -r15.w;
      ...
      if (r16.w != 0) {
        ...
        if (r9.w != 0) {
          ...
          r35.w = samp0[]..swiz;
            ...
            r17.z = -r17.z * r17.w + 1;
            r17.z = r29.y * r17.z;
            r4.y = r21.z ? r17.z : r22.w;
            r29.xy = r18.ww ? r29.xy : r4.xy;
            r16.w = (int)r16.w + 1;
            r16.z = r18.z;
          }
  ...
  if (r3.w == 0) {
    ...
    while (true) {
      ...
      r10.z = cmp((int)r4.x == (int)r9.w);
      bitmask.w = ((~(-1 << r4.y)) << 0) & 0xffffffff;  r10.w = (((uint)0 << 0) & bitmask.w) | ((uint)r10.y & ~bitmask.w);
    ...
    if (r9.y != 0) {
      ...
      r10.z = 0;
      while (true) {
        r10.w = cmp((uint)r10.z >= (uint)r3.w);
        if (r10.w != 0) break;
        r13.z = (uint)r10.z >> 5;
        r14.xyz = (int3)r12.xyz + (int3)r13.xyz;
        r10.w = visibleProbes.Load(r14.xyzw).x;
        r12.w = cmp((int)r4.x == (int)r10.z);
        if (r4.y == 0) r13.z = 0; else if (r4.y+0 < 32) {         r13.z = (uint)r10.w << (32-(r4.y + 0)); r13.z = (uint)r13.z >> (32-r4.y);        } else r13.z = (uint)r10.w >> 0;
    ...
    if (r4.x != 0) {
      ...
      r19.xyz = r22.xyz * r3.www + r9.yzw;
      r11.w = 0;
      r9.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r11.xyzw, r7.z).xyz;
      r3.w = sunConstants.globalProbeExposure * r4.x + -r1.w;
      r1.w = r5.y * r3.w + r1.w;
  ...
  if (r4.y == 0) {
    ...
    // Known bad code for instruction (needs manual fix):
        ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r11.w, r8.w, l(0), t23.xxxx
    r11.w = samp0[]..swiz;
      r12.w = (int)r11.w & 0x40000000;
      r15.w = (uint)r11.w << 2;
      if (r12.w == 0) {
        r12.w = (int)r11.w & 0x01ffffff;
        r16.x = (int)r8.w + (int)r12.w;
        r8.w = (uint)r11.w >> 25;
        r8.w = (uint)r8.w;
  ...
  if (r4.y != 0) {
    r4.y = cmp(0 < r5.y);
    if (r4.y != 0) {
      r4.y = sunConstants.specScale * r5.z;
      r4.y = r4.y * r4.x;
      ...
      r16.xyz = -v6.xyz * r4.zzz + sunConstants.wldDir.xyz;
      r4.z = dot(r16.xyz, r16.xyz);
      r4.z = rsqrt(r4.z);
      r16.xyz = r16.xyz * r4.zzz;
      r4.z = dot(r16.xyz, r6.xyz);
      r6.w = dot(r1.xyz, r16.xyz);
      r7.z = abs(r6.w) * r5.z + -abs(r6.w);
      ...
      r4.x = r5.y * r4.x;
      r4.x = 0.25 * r4.x;
      r16.xyz = r4.xxx * r10.yzw + r9.yzw;
      r4.y = saturate(1 + -r4.z);
      r4.z = r4.y * r4.y;
      r4.z = r4.z * r4.z;
      r4.y = r4.y * r4.z;
      r4.x = r4.x * r4.y;
      r17.xyz = r4.xxx * r10.zwy + r14.xyz;
      r15.w = r17.z;
      r13.w = r14.z;
  ...
  r4.z = 0;
  while (true) {
    r5.x = cmp((uint)r4.z >= numLights);
    if (r5.x != 0) break;
    r16.z = (uint)r4.z >> 5;
    r17.xyz = (int3)r12.xyz + (int3)r16.xyz;
    r5.x = visibleLights.Load(r17.xyzw).x;
    r17.xyz = r10.yzw;
    r30.xyz = r28.xyz;
    r31.xyz = r29.xyz;
    r5.y = r4.y;
      ...
      r33.y = samp0[]..swiz;
        ...
        r38.w = samp0[]..swiz;
          ...
          switch (r7.w) {
            ...
            r8.w = dot(r39.xyz, r41.xyz);
            r11.w = saturate(-r8.w / r38.x);
            ...
            if (r16.z != 0) {
              ...
              if (r16.z != 0) {
                ...
                if (r16.z != 0) {
                  ...
                  r8.w = r16.w * r25.w + -r8.w;
                  r8.w = saturate(r8.w / r26.w);
                  r16.w = r26.w / r38.x;
                  r16.zw = float2(0.25,10) * r16.zw;
                  r16.w = min(1, r16.w);
                  r8.w = r8.w + -r11.w;
                  r8.w = r16.w * r8.w + r11.w;
                  r39.xyz = r8.www * r39.xyz + r40.xyz;
                  r39.xyz = r7.www ? r39.xyz : r32.yzw;
                  r39.xyz = -v6.xyz + r39.xyz;
                  r7.w = dot(r39.xyz, r39.xyz);
                  r7.w = rsqrt(r7.w);
                  r40.xyz = r39.xyz * r7.www;
                  if (4 == 0) r8.w = 0; else if (4+16 < 32) {                   r8.w = (uint)r33.w << (32-(4 + 16)); r8.w = (uint)r8.w >> (32-4);                  } else r8.w = (uint)r33.w >> 16;
                  ...
                  r11.w = samp0[]..swiz;
                  // Known bad code for instruction (needs manual fix):
                                    ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r41.xyzw, r8.w, l(100), t12.xyzw
                  r41.x = samp0[]..swiz;
                  r41.y = samp0[]..swiz;
                  r41.z = samp0[]..swiz;
                  r41.w = samp0[]..swiz;
                  // Known bad code for instruction (needs manual fix):
                                    ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r42.xyzw, r8.w, l(116), t12.xyzw
                  r42.x = samp0[]..swiz;
                  r42.y = samp0[]..swiz;
                  r42.z = samp0[]..swiz;
                  r42.w = samp0[]..swiz;
                    r16.w = abs(r13.w) * -0.200000003 + 0.400000006;
                    r19.xyz = r1.xyz * r16.www + v6.xyz;
                    r16.w = dot(r41.xyzw, r19.xyzw);
                    r25.w = dot(r42.xyzw, r19.xyzw);
                    r26.w = cmp(r25.w < r16.w);
                    if (r26.w == 0) {
                    // Known bad code for instruction (needs manual fix):
                                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r41.xyzw, r8.w, l(68), t12.xyzw
                    r41.x = samp0[]..swiz;
                    r41.y = samp0[]..swiz;
                    r41.z = samp0[]..swiz;
                    r41.w = samp0[]..swiz;
                    // Known bad code for instruction (needs manual fix):
                                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r42.xyzw, r8.w, l(84), t12.xyzw
                    r42.x = samp0[]..swiz;
                    r42.y = samp0[]..swiz;
                    r42.z = samp0[]..swiz;
                    r42.w = samp0[]..swiz;
                    // Known bad code for instruction (needs manual fix):
                                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r43.xyzw, r8.w, l(132), t12.xyzw
                    r43.x = samp0[]..swiz;
                    r43.y = samp0[]..swiz;
                    r43.z = samp0[]..swiz;
                    r43.w = samp0[]..swiz;
                    // Known bad code for instruction (needs manual fix):
                                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r44.xyzw, r8.w, l(148), t12.xyzw
                    r44.x = samp0[]..swiz;
                    r44.y = samp0[]..swiz;
                    r44.z = samp0[]..swiz;
                    r44.w = samp0[]..swiz;
                    // Known bad code for instruction (needs manual fix):
                                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r45.xy, r8.w, l(164), t12.xyxx
                    r45.x = samp0[]..swiz;
                    r45.y = samp0[]..swiz;
                    ...
                    r8.w = samp0[]..swiz;
                      ...
                      if (r5.y != 0) {
                        ...
                        while (true) {
                          ...
                          r42.y = dot(icb[r26.w+0].xy, r7.xy);
                    ...
                    if (4 == 0) r8.w = 0; else if (4+20 < 32) {                     r8.w = (uint)r33.w << (32-(4 + 20)); r8.w = (uint)r8.w >> (32-4);                    } else r8.w = (uint)r33.w >> 20;
                    r11.w = cmp(0 < (uint)r8.w);
                    r11.w = r3.w ? r11.w : 0;
                    if (r11.w != 0) {
                      r8.w = (int)r8.w + numLights;
                  ...
                  r8.w = r8.w + -r14.w;
                  r8.w = r5.w * r8.w + r14.w;
                  r8.w = r8.w * r12.w;
                  r33.x = r32.x;
                  r11.w = cmp(0 < r13.w);
                  r19.xyz = r8.www * r33.xyz + r17.xyz;
                  r8.w = saturate(dot(r1.xyz, r40.xyz));
                  r20.xyz = r39.xyz * r7.www + r6.xyz;
                  r7.w = dot(r20.xyz, r20.xyz);
                  r7.w = rsqrt(r7.w);
                  r20.xyz = r20.xyz * r7.www;
                  r7.w = dot(r20.xyz, r6.xyz);
                  r13.w = dot(r1.xyz, r20.xyz);
                  r14.w = abs(r13.w) * r5.z + -abs(r13.w);
                  r13.w = abs(r13.w) * r14.w + 1;
                  r14.w = r8.w * r0.w + r1.w;
                  r13.w = r13.w * r13.w;
                  r13.w = r13.w * r14.w;
                  r13.w = rcp(r13.w);
                  r8.w = r8.w * r16.z;
                  r8.w = r13.w * r8.w;
                  r8.w = r8.w * r12.w;
                  r20.xyz = r8.www * r33.xyz + r31.xyz;
                  r7.w = saturate(1 + -r7.w);
                  r12.w = r7.w * r7.w;
                  r12.w = r12.w * r12.w;
                  r7.w = r12.w * r7.w;
            ...
            r40.w = samp0[]..swiz;
              ...
              if (r12.w != 0) {
                  ...
                  r40.y = samp0[]..swiz;
                    ...
                    if (r5.y != 0) {
                      ...
                      while (true) {
                        ...
                        r16.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r32.xyz, r7.z).x;
                ...
                if (r12.w != 0) {
                  ...
                  r16.z = abs(r13.w) * r5.z + -abs(r13.w);
                  r13.w = abs(r13.w) * r16.z + 1;
                  r11.w = r11.w * r0.w + r1.w;
                  r13.w = r13.w * r13.w;
                  r11.w = r13.w * r11.w;
                  r11.w = rcp(r11.w);
                  r11.w = r11.w * r12.w;
                  ...
                  r17.xyz = r8.www ? r22.xyz : r17.xyz;
                  r30.xyz = r8.www ? r20.xyz : r30.xyz;
                  r31.xyz = r8.www ? r19.xyz : r31.xyz;
                }
              }
            }
            break;
  ...
  if (r0.w == 0) {
    ...
    if (r0.w != 0) {
      ...
      r3.w = (uint)v0.z << 2;
      r0.w = (int)r0.w & 2046;
      bitmask.y = ((~(-1 << 11)) << 0) & 0xffffffff;  r1.y = (((uint)r0.w << 0) & bitmask.y) | ((uint)r3.w & ~bitmask.y);
  ...
  o0.xyzw = r0.wwww ? float4(0,0,0,0) : r2.xyzw;
  return;
}