...
//   float3 colorDispersion;            // Offset:  320 Size:    12 [unused]
//
// }
//
...
dp4 r2.y, r3.xyzw, l(81.239487, 17.348024, 37.349838, 59.394840)
frc r3.w, r2.y
mad r4.xyzw, r0.xxxx, l(13.007200, 13.007200, 13.007200, 13.007200), l(0.345000, 9.350000, 1.345000, 12.040000)
mad r4.xyzw, r2.xxxx, l(3.345730, 3.345730, 3.345730, 3.345730), r4.xyzw
dp4 r2.y, r4.xyzw, l(81.239487, 17.348024, 37.349838, 59.394840)
frc r4.x, r2.y
dp4 r2.y, r4.xyzw, l(81.239487, 17.348024, 37.349838, 59.394840)
frc r4.y, r2.y
dp4 r2.y, r4.xyzw, l(81.239487, 17.348024, 37.349838, 59.394840)
...
dp4 r2.y, r4.xyzw, l(81.239487, 17.348024, 37.349838, 59.394840)
frc r2.y, r2.y
mad r2.zw, r3.zzzw, l(0.000000, 0.000000, 2.000000, 2.000000), l(0.000000, 0.000000, -1.000000, -1.000000)
mul r5.xy, r2.zwzz, l(1.000000, 1.77777779, 0.000000, 0.000000)
ge r4.w, r0.w, -r0.w
frc r0.w, |r0.w|
...
dp4 r0.x, r6.xyzw, l(81.239487, 17.348024, 37.349838, 59.394840)
frc r0.x, r0.x
add r5.zw, -cb0[12].zzzw, cb0[13].xxxy
mad r5.zw, r3.xxxx, r5.zzzw, cb0[12].zzzw
add r6.xy, -cb0[14].ywyy, cb0[14].xzxx
mad r0.w, r3.z, r6.x, cb0[14].y
mad r2.x, r3.w, r6.y, cb0[14].w
add r3.xz, -cb0[17].wwyw, cb0[17].zzxz
mad r3.x, r3.y, r3.x, cb0[17].w
add r3.yw, -cb0[16].yyyw, cb0[16].xxxz
mad r1.w, r1.w, r3.y, cb0[16].y
mad o2.w, r4.x, r3.z, cb0[17].y
mad r3.y, r4.y, r3.w, cb0[16].w
mul r3.y, r3.y, cb0[10].z
mul r3.y, r3.y, l(30.000000)
add r3.zw, -cb0[15].yyyw, cb0[15].xxxz
mad r3.z, r4.z, r3.z, cb0[15].y
mad r6.x, r2.y, r3.w, cb0[15].w
add r2.y, -cb0[18].y, cb0[18].x
mad r1.z, r1.z, r2.y, cb0[18].y
mad r4.xz, -cb0[11].zzwz, l(1.000000, 0.000000, 1.77777779, 0.000000), r5.xxyx
dp2 r2.y, r4.xzxx, r4.xzxx
rsq r2.y, r2.y
mul r4.xz, r2.yyyy, r4.xxzx
mul r0.yz, r0.yyzy, r5.zzwz
max r2.y, r6.x, l(0.000100)
div r6.y, l(1.000000, 1.000000, 1.000000, 1.000000), r2.y
add r2.y, r1.x, -r3.z
div_sat r3.w, r2.y, r1.y
add r5.zw, r6.xxxy, l(0.000000, 0.000000, -1.000000, -1.000000)
mad r5.zw, r3.wwww, r5.zzzw, l(0.000000, 0.000000, 1.000000, 1.000000)
mul r0.yz, r0.yyzy, r5.zzwz
div r3.y, r3.y, r5.z
...
movc r1.y, r3.y, l(1.000000), r1.y
mul o2.z, r0.w, r1.y
min r0.w, |r4.x|, |r4.z|
max r1.y, |r4.x|, |r4.z|
...
sincos r2.x, r6.x, r0.w
mov r6.y, r6.x
mov r6.z, r2.x
dp2 r7.x, r6.yzyy, r0.yzyy
mov r6.x, -r2.x
dp2 r7.y, r6.xyxx, r0.yzyy
lt r0.y, r3.z, r1.x
mul r0.z, r2.y, r2.y
mul r0.zw, r0.zzzz, r4.xxxz
mul r0.zw, r1.wwww, r0.zzzw
mad r0.zw, r0.zzzw, l(0.000000, 0.000000, 0.010000, 0.010000), r5.xxxy
movc r0.yz, r0.yyyy, r0.zzwz, r5.xxyx
mad r1.yz, r2.zzwz, l(0.000000, 1.000000, 1.77777779, 0.000000), r7.xxyx
mad_sat o1.zw, r1.yyyz, l(0.000000, 0.000000, 0.500000, 0.500000), l(0.000000, 0.000000, 0.500000, 0.500000)
add r0.yz, r0.yyzy, r7.xxyx
lt r0.w, r1.x, r3.z
mul r1.x, r3.x, l(0.010000)
mul r1.yz, r0.xxxx, r4.xxzx
mad r1.xy, r1.xxxx, r1.yzyy, r0.yzyy
movc r0.xy, r0.wwww, r1.xyxx, r0.yzyy
mul r0.z, r4.y, cb0[11].x
