// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:43:10 2021
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  if (r0.x != 0) {
    r0.xyz = extracamTexture4.Sample(extracamSampler_s, w1.xy).xyz;
  } else {
    r0.w = cmp(extracamSelect == 3);
    if (r0.w != 0) {
      r0.xyz = extracamTexture3.Sample(extracamSampler_s, w1.xy).xyz;
    } else {
      r0.w = cmp(extracamSelect == 2);
      if (r0.w != 0) {
        r0.xyz = extracamTexture2.Sample(extracamSampler_s, w1.xy).xyz;
      } else {
        r0.xyz = extracamTexture1.Sample(extracamSampler_s, w1.xy).xyz;
      }
    }
  }
  ...
  if (r0.w != 0) {
    ...
    if (r1.w != 0) {
      ...
      r3.w = fogConstants.atmospherefogheightdensityscale.x * v5.z;
