  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.xyzw = codeTexture0.Sample(bilinearClamp_s, v0.yw).xyzw;
  ...
  r1.xyzw = codeTexture0.Sample(bilinearClamp_s, v0.zw).xyzw;
  ...
  r1.xyzw = codeTexture0.Sample(bilinearClamp_s, v1.yz).xyzw;
