...
loop 
  ...
  sqrt r10.w, r10.w
  mad r10.w, r5.w, l(5.000000), r10.w
    ...
    if_nz r16.z
      ...
      if_nz r8.w
        ...
        loop 
          ...
          movc r4.y, r18.w, r16.w, r21.z
          movc r29.xy, r18.zzzz, r29.xyxx, r4.xyxx
          iadd r16.z, r16.z, l(1)
          mov r15.w, r17.w
        endloop 
        mov_sat r29.y, r29.y
        mul r4.y, r10.z, r29.y
        lt r15.w, l(0.000000), r4.y
        if_nz r15.w
...
if_z r3.w
  ...
  if_nz r4.x
    ...
    mul r13.x, r7.y, cb2[35].w
    mul r13.yz, r7.zzwz, cb2[36].xxyx
    add_sat r7.yzw, r13.xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
    mul r13.xy, r7.yzyy, cb2[36].zwzz
    mul r13.z, r7.w, cb2[37].x
    add r7.yzw, r13.xxyz, cb2[37].yyzw
    lt r8.zw, l(0.000000, 0.000000, 0.000000, 0.000000), r1.xxxy
    movc r13.xy, r8.zwzz, l(0,0,0,0), l(0.500000,0.500000,0,0)
    mov r13.z, l(0)
    add r10.yzw, r7.yyzw, r13.zzzx
    ...
    mad r10.yzw, r10.yyzw, r14.xxxx, r13.xxyz
    lt r0.y, l(0.000000), r0.y
    movc r13.z, r0.y, l(0), l(0.500000)
    mov r13.xy, l(0,0,0,0)
    add r7.yzw, r7.yyzw, r13.xxyz
    sample_l_indexable(texture3d)(float,float,float,float) r7.yzw, r7.yzwy, t19.wxyz, s4, l(0.000000)
    mad r7.yzw, r7.yyzw, r14.zzzz, r10.yyzw
    mov r1.w, l(0)
    sample_l_indexable(texturecubearray)(float,float,float,float) r10.yzw, r1.xyzw, t8.wxyz, s2, l(6.000000)
    mul r7.yzw, r7.yyzw, r10.yyzw
    dp3 r0.y, r7.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
    mad r19.xyz, r22.xyzx, r3.wwww, r7.yzwy
    mov r11.w, l(0)
    ...
    mad r20.xyz, r7.yzwy, r0.yyyy, r20.xyzx
  endif 
else 
  mov r20.x, r19.w
endif 
mul r7.yzw, r20.xxyz, cb0[17].yyyy
if_nz cb0[43].w
  ...
  mov r11.w, |r11.z|
  mad r10.yzw, r11.xxyw, r0.yyyy, v6.xxyz
  ...
  and r0.y, r0.y, r1.w
  sample_indexable(texture2d)(float,float,float,float) r10.yzw, r4.xyxx, t29.wxyz, s5
  if_nz r0.y
    mul r10.yzw, r10.yyzw, cb1[85].xxxx
    mul r10.yzw, r10.yyzw, cb0[18].xxxx
...
if_z r2.z
  ...
  if_nz r3.w
    ...
    loop 
      ...
      breakc_nz r4.y
      ftou r4.y, r3.w
      add r8.zw, r10.yyyz, -cb2[r4.y + 20].xxxy
      max r5.w, |r8.w|, |r8.z|
  ...
  if_nz r4.y
    ...
    mul r8.zw, r11.zzzy, cb2[32].xxxx
    ...
    if_z r8.z
      ...
      if_z r5.w
        ...
        iadd r5.w, -r14.y, l(6)
        ushr r13.yw, r11.zzzy, r5.wwww
        and r5.w, r14.w, l(0xc0000000)
        or r6.w, r14.w, l(0x40000000)
        bfi r8.z, l(1), l(1), r13.w, l(0)
        bfi r8.z, l(1), l(0), r13.y, r8.z
        ...
        mov r15.y, r14.z
        movc r15.xyz, r5.wwww, r14.xywx, r15.xyzx
        iadd r6.w, -r15.y, l(6)
        ushr r13.yw, r11.zzzy, r6.wwww
        and r6.w, r15.z, l(0xc0000000)
        or r8.z, r15.z, l(0x40000000)
        ...
        movc r13.yw, r6.wwww, r15.xxxz, r16.xxxy
        movc r13.xz, r5.wwww, r14.xxwx, r13.yywy
      endif 
      and r5.w, r13.z, l(0xc0000000)
      if_z r5.w
        ubfe r6.w, l(14), l(15), r13.z
        utof r6.w, r6.w
        ...
        f16tof32 r6.w, r6.w
        mad r8.z, r10.y, r9.w, r8.z
        mad r6.w, r10.z, r6.w, r8.z
        movc r8.w, r5.w, r6.w, r8.w
      endif 
    endif 
    mad r5.w, -cb2[27].z, l(2.000000), r10.w
    lt r5.w, r8.w, r5.w
  ...
  if_z r4.y
    if_z cb2[58].y
      ...
      mad r11.xy, r8.zwzz, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
      itof r4.y, cb2[26].y
      add r11.z, r3.w, r4.y
      sample_c_lz_indexable(texture2darray)(float,float,float,float) r4.y, r11.xyzx, t13.xxxx, s13, r2.z
      sample_l_indexable(texture2darray)(float,float,float,float) r5.w, r11.xyzx, t31.yzwx, s0, l(0.000000)
      add r4.y, r4.y, r5.w
    ...
    if_nz cb2[58].y
      ...
      add r10.yz, r10.yyzy, -cb2[r3.w + 20].xxyx
      mul r10.yz, r10.yyzy, cb2[r3.w + 20].zzzz
      ...
      loop 
        ...
        breakc_nz r9.w
        ult r9.w, r4.x, r6.w
        movc r13.xy, r9.wwww, r10.yzyy, r8.zwzz
        movc r10.w, r9.w, cb2[r3.w + 20].w, cb2[r4.y + 20].w
        movc r9.w, r9.w, r3.w, r4.y
        dp2 r14.x, icb[r6.w + 0].yxyy, r11.xyxx
        dp2 r14.y, icb[r6.w + 0].yxyy, r11.yzyy
...
if_nz r2.z
  ...
  add r10.yz, -r8.zzwz, l(0.000000, 1.000000, 1.000000, 0.000000)
  ge r10.yz, r4.xxyx, r10.yyzy
  ge r8.zw, r8.zzzw, r4.xxxy
  or r8.zw, r8.zzzw, r10.yyyz
  or r0.y, r8.w, r8.z
  if_z r0.y
...
mad r11.xyz, -v6.xyzx, r4.zzzz, cb2[17].xyzx
dp3 r0.y, r11.xyzx, r11.xyzx
rsq r0.y, r0.y
mul r11.xyz, r0.yyyy, r11.xyzx
dp3_sat r0.y, r1.xyzx, r11.xyzx
...
div r2.z, r2.z, r2.w
mul r0.y, r0.y, r2.z
mul r11.xyz, r0.yyyy, r10.yzwy
add r0.y, r1.w, r1.w
div r0.y, r1.w, r0.y
mul r13.xyz, r0.yyyy, r10.yzwy
...
mov r25.xyz, r10.yzwy
mov r26.xyz, r11.xyzx
mov r0.y, cb2[58].y
mov r1.w, l(0)
loop 
  ...
  ld_indexable(texture2darray)(uint,uint,uint,uint) r2.z, r16.xyzw, t6.yzxw
        ...
        if_nz r8.z
          ...
          if_nz r8.z
            ...
            if_nz r8.z
              ...
              mad r37.xyz, r1.xyzx, r8.zzzz, v6.xyzx
              mov r33.z, r34.x
              ...
              loop 
                ige r13.w, r12.w, l(8)
                breakc_nz r13.w
                dp2 r39.y, icb[r12.w + 0].yxyy, r14.xyxx
                dp2 r39.z, icb[r12.w + 0].yxyy, r14.yzyy
            ...
            if_nz r8.w
              ...
              mad r18.xyz, r1.xyzx, r5.wwww, v6.xyzx
              dp4 r5.w, r37.xyzw, r18.xyzw
              dp4 r9.w, r38.xyzw, r18.xyzw
              lt r12.w, r9.w, r5.w
              if_z r12.w
              ...
              if_z r9.w
                ...
                if_nz r2.w
                  ...
                  loop 
                    ige r13.w, r12.w, l(8)
                    breakc_nz r13.w
                    dp2 r38.x, icb[r12.w + 0].yxyy, r14.xwxx
                    dp2 r38.y, icb[r12.w + 0].xyxx, r8.xyxx
                    mad r37.xy, r38.xyxx, r8.wwww, r18.xyxx
            ...
            if_nz r5.w
              mad r18.xyz, -v6.xyzx, r4.zzzz, r36.xyzx
              dp3 r5.w, r18.xyzx, r18.xyzx
              rsq r5.w, r5.w
              mul r18.xyz, r5.wwww, r18.xyzx
              dp3_sat r5.w, r1.xyzx, r18.xyzx
              dp3_sat r8.z, r18.xyzx, r6.xyzx
              dp3_sat r8.w, r18.xyzx, r36.xyzx
              mov r30.z, r29.w
              mul r18.xyz, r30.zxyz, r4.yyyy
              add r4.y, r4.w, r6.w
              div r4.y, r6.w, r4.y
              mad r16.xyz, r18.xyzx, r4.yyyy, r16.xyzx
              mad r27.xyz, r18.xyzx, r6.wwww, r27.xyzx
              ...
              log r5.w, r5.w
              mul r15.zw, r5.wwww, cb0[14].xxxy
              exp r15.zw, r15.zzzw
              dp2 r5.w, r15.zwzz, cb0[15].xyxx
              mul r4.y, r6.w, r4.y
              mul r6.w, r8.z, l(12.566371)
              div r4.y, r4.y, r6.w
              mul r4.y, r4.y, r5.w
              mad r28.xyz, r18.xyzx, r4.yyyy, r28.xyzx
            endif 
          endif 
        endif 
        break 
        ...
        if_nz r6.w
          ...
          if_nz r8.z
            ...
            if_nz r6.w
              ...
              add r15.zw, r40.zzzw, r40.xxxy
              log r15.zw, r15.zzzw
              mul r15.zw, r15.zzzw, r42.xxxx
              exp r15.zw, r15.zzzw
              mul r13.w, r15.z, r41.z
              mad r15.z, r41.w, r15.w, l(-1.000000)
              mad r13.w, r41.w, r15.w, -r13.w
              div_sat r13.w, r15.z, r13.w
              mul r15.z, r13.w, r13.w
              mad r13.w, r13.w, l(-2.000000), l(3.000000)
              mul r6.w, r13.w, r15.z
            endif 
            mul r8.z, r6.w, r12.w
            and r6.w, r8.w, l(255)
            if_nz r6.w
          ...
          if_nz r6.w
            ubfe r15.zw, l(0, 0, 3, 4), l(0, 0, 27, 20), r31.xxxx
            ine r6.w, r15.z, l(1)
            if_nz r6.w
              mad r6.w, |r4.y|, l(-0.200000), l(0.400000)
              mad r21.xyz, r1.xyzx, r6.wwww, v6.xyzx
              mov r36.xy, r35.xyxx
            ...
            if_nz r15.w
              ...
              if_z r13.w
                ...
                mad r22.xy, r15.zwzz, r33.xzxx, r33.ywyy
                ...
                if_nz r2.w
                  ...
                  loop 
                    ...
                    sample_c_lz_indexable(texture2darray)(float,float,float,float) r15.z, r21.xyzx, t9.xxxx, s13, r4.y
            ...
            if_nz r4.y
              mad r21.xyz, -v6.xyzx, r4.zzzz, r18.xyzx
              dp3 r4.y, r21.xyzx, r21.xyzx
              rsq r4.y, r4.y
              mul r21.xyz, r4.yyyy, r21.xyzx
              dp3_sat r4.y, r1.xyzx, r21.xyzx
              dp3_sat r6.w, r21.xyzx, r6.xyzx
              dp3_sat r8.z, r21.xyzx, r18.xyzx
              mul r18.xyz, r20.xywx, r4.xxxx
              add r4.x, r4.w, r5.w
              div r4.x, r5.w, r4.x
              mad r16.xyz, r18.xyzx, r4.xxxx, r16.xyzx
              mad r27.xyz, r18.xyzx, r5.wwww, r27.xyzx
              ...
              log r4.y, r4.y
              mul r15.zw, r4.yyyy, cb0[14].xxxy
              exp r15.zw, r15.zzzw
              dp2 r4.y, r15.zwzz, cb0[15].xyxx
              mul r4.x, r5.w, r4.x
              mul r5.w, r6.w, l(12.566371)
              div r4.x, r4.x, r5.w
              mul r4.x, r4.x, r4.y
              mad r28.xyz, r18.xyzx, r4.xxxx, r28.xyzx
            endif 
          endif 
        endif 
        break 
  ...
  iadd r1.w, r1.w, l(32)
endloop 
add r1.xyz, r7.yzwy, r26.xyzx
add r4.xyz, r19.xyzx, r24.xyzx
add r6.xyz, r19.xyzx, r25.xyzx
