...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r2.x = specColorMap.Sample(specColorSampler_s, v2.xy).x;
  ...
  if (r7.y != 0) {
    ...
    if (r7.y != 0) {
      ...
      r16.xyz = -v7.xyz * r3.www + sunConstants.wldDir.xyz;
