...
ishl r10.z, r1.y, l(4)
and r1.y, cb2[57].z, l(-32)
iadd r2.w, -r1.y, cb2[57].z
...
mad r0.xyz, r0.xyzx, r1.yyyy, r13.xyzx
mad r0.w, r0.w, r1.y, r3.w
mad r2.xyz, r2.xyzx, r1.yyyy, r14.xyzx
dp3 r1.z, r2.xyzx, r2.xyzx
rsq r1.z, r1.z
mul r2.xyz, r1.zzzz, r2.xyzx
mad r7.y, r1.x, r1.y, r4.w
mad r1.xzw, r1.yyyy, l(0.040000, 0.000000, 0.040000, 0.040000), r15.xxyz
dp3 r3.w, -v7.xyzx, -v7.xyzx
rsq r3.w, r3.w
mul r8.xyz, r3.wwww, -v7.xyzx
dp3 r3.x, r8.xyzx, r3.xyzx
dp3 r4.x, r8.xyzx, r4.xyzx
dp3 r4.y, r8.xyzx, r5.xyzx
lt r3.y, l(0.000000), r3.x
div r4.xy, -r4.xyxx, r3.xxxx
and r3.yz, r3.yyyy, r4.xxyx
add r4.x, cb0[14].y, l(0.000010)
mad r3.yz, r3.yyzy, r4.xxxx, v2.xxyx
sample_indexable(texture2d)(float,float,float,float) r4.xyzw, r3.yzyy, t24.xyzw, s1
mul r4.xyz, r4.xyzx, cb0[13].xyzx
mov_sat r3.x, r3.x
log r3.y, r3.x
mul r3.y, r3.y, cb0[12].y
exp r3.y, r3.y
add r3.x, -r3.x, l(1.000000)
log r3.x, r3.x
mul r3.x, r3.x, cb0[12].y
exp r3.x, r3.x
movc r3.x, cb0[14].x, r3.x, r3.y
eq r3.y, cb0[12].y, l(0.000000)
movc r3.x, r3.y, l(1.000000), r3.x
mul r3.y, r4.w, cb0[12].x
mul r3.x, r3.x, r3.y
mul r1.y, r1.y, r3.x
...
dp3_sat r7.x, r2.xyzx, r8.xyzx
dp3 r3.y, -r8.xyzx, r2.xyzx
add r3.y, r3.y, r3.y
mad r12.xyz, r2.xyzx, -r3.yyyy, -r8.xyzx
...
if_nz r11.y
  ...
  mov r15.w, l(0)
  loop 
    uge r16.w, r15.w, r7.w
    breakc_nz r16.w
    ushr r13.z, r15.w, l(5)
    iadd r14.xyz, r10.xyzx, r13.xyzx
    ld_indexable(texture2darray)(uint,uint,uint,uint) r13.z, r14.xyzw, t7.yzxw
    ieq r14.x, r8.w, r15.w
...
max r5.z, r21.w, l(1.000000)
rcp r5.z, r5.z
mov_sat r21.w, r21.w
mul r13.xyz, r5.zzzz, r20.xyzx
mul r11.yzw, r5.zzzz, r21.xxyz
...
if_z r8.w
  ...
  if_z r15.y
    if_z cb2[58].y
      ...
      itof r11.w, cb2[26].y
      add r16.z, r11.w, r12.w
      sample_c_lz_indexable(texture2darray)(float,float,float,float) r11.w, r16.xyzx, t13.xxxx, s13, r8.w
    ...
    if_nz cb2[58].y
      ...
      add r11.yz, r11.yyzy, -cb2[r12.w + 20].xxyx
      mul r11.yz, r11.yyzy, cb2[r12.w + 20].zzzz
      ...
      loop 
        ...
        movc r17.w, r17.x, cb2[r12.w + 20].w, cb2[r11.w + 20].w
        movc r17.x, r17.x, r12.w, r11.w
...
if_nz r8.w
  ...
  if_nz r8.w
      ...
      if_z r12.w
        ...
        if_nz cb2[58].y
          ...
          loop 
            ...
            sample_c_lz_indexable(texture2darray)(float,float,float,float) r15.w, r17.xyzx, t9.xxxx, s13, r9.w
    ...
    add r9.w, -r6.w, r9.w
    mad r9.w, r3.z, r9.w, r6.w
    mul r9.w, r10.w, r9.w
    lt r5.w, l(0.000000), r5.w
    mad r15.xyz, r9.wwww, r9.xyzx, r13.xyzx
    mad r11.yzw, -v7.xxyz, r3.wwww, cb2[17].xxyz
    dp3 r3.w, r11.yzwy, r11.yzwy
    rsq r3.w, r3.w
    mul r11.yzw, r3.wwww, r11.yyzw
    dp3 r3.w, r11.yzwy, r8.xyzx
    dp3 r9.w, r2.xyzx, r11.yzwy
    mad r11.y, |r9.w|, r3.y, -|r9.w|
    ...
    mad r11.yzw, r6.wwww, r9.xxyz, r7.yyzw
    add_sat r3.w, -r3.w, l(1.000000)
    mul r8.w, r3.w, r3.w
    mul r8.w, r8.w, r8.w
    mul r3.w, r3.w, r8.w
    mul r3.w, r3.w, r6.w
    mad r9.xyz, r3.wwww, r9.yzxy, r14.xyzx
    mov r15.w, r9.z
    mov r13.w, r14.z
...
loop 
  ...
  loop 
    ...
    and r15.z, r12.w, r14.w
    if_nz r15.z
      xor r12.w, r12.w, r14.w
      iadd r13.w, r7.x, r13.w
          ...
          if_nz r18.x
            ...
            if_nz r18.x
                ...
                if_nz r20.y
                  ...
                  if_nz r10.w
                    ...
                    loop 
                      ...
                      sample_c_lz_indexable(texture2darray)(float,float,float,float) r24.w, r33.xyzx, t9.xxxx, s13, r13.w
              ...
              if_nz r18.x
                ...
                mad r23.xyz, r13.wwww, r31.xyzx, r29.xyzx
...
mov r4.w, l(1.000000)
movc r1.xyzw, cb0[13].wwww, r1.xyzw, r4.xyzw
...
ret 
// Approximately 2244 instruction slots used
