...
//   float aberrationPixels;            // Offset:  184 Size:     4
//   float3 aberrationFactors;          // Offset:  192 Size:    12
//   float2 aberrationScroll;           // Offset:  208 Size:     8
//
// }
//
...
mad r1.xy, cb1[69].wwww, cb0[13].xyxx, v1.xyxx
sample_indexable(texture2d)(float,float,float,float) r0.w, r1.xyxx, t7.yzwx, s1
mul r0.w, r0.w, r2.y
mul r0.w, r0.w, cb0[11].z
mul r1.xy, r0.wwww, cb1[44].zwzz
mad r1.zw, r1.xxxy, cb0[12].zzzz, v1.xxxy
mad r2.xyzw, r1.xyxy, cb0[12].xxyy, v1.xyxy
sample_indexable(texture2d)(float,float,float,float) r1.z, r1.zwzz, t0.xyzw, s1
sample_indexable(texture2d)(float,float,float,float) r1.x, r2.xyxx, t0.xyzw, s1
sample_indexable(texture2d)(float,float,float,float) r1.y, r2.zwzz, t0.xyzw, s1
