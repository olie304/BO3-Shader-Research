...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:42:32 2021
//
//
// Buffer Definitions: 
//
...
//   uint extracamSelect;               // Offset:  204 Size:     4
//   float scriptControl;               // Offset:  208 Size:     4 [unused]
//   float extraCamWarpAmount;          // Offset:  212 Size:     4
//   float2 wobbleNormalScroll1;        // Offset:  216 Size:     8
//   float2 wobbleNormalRotate1;        // Offset:  224 Size:     8
//   float2 wobbleNormalScroll2;        // Offset:  232 Size:     8
//   float2 wobbleNormalRotate2;        // Offset:  240 Size:     8
//
// }
//
...
// extracamSampler                   sampler      NA          NA             s7      1 
...
// extracamTexture1                  texture  float4          2d            t30      1 
// gTransShadowmapArray              texture   float     2darray            t31      1 
// extracamTexture2                  texture  float4          2d            t37      1 
// extracamTexture3                  texture  float4          2d            t38      1 
// extracamTexture4                  texture  float4          2d            t46      1 
...
mad r1.z, r1.z, r2.w, cb0[12].x
mul_sat r1.z, r1.z, l(0.05882353)
mul r3.xy, cb0[13].yyyy, cb1[44].zwzz
sample_indexable(texture2d)(float,float,float,float) r4.xyz, v1.yzyy, t24.xyzw, s5
...
mad r4.w, cb0[14].y, cb1[69].w, l(1.000000)
mul r4.w, r4.w, cb0[14].x
mul r4.w, r4.w, l(0.01745329)
sincos r7.x, r8.x, r4.w
mov r8.y, r8.x
mov r8.z, r7.x
dp2 r9.x, r8.yzyy, r4.yzyy
mov r8.x, -r7.x
dp2 r9.y, r8.xyxx, r4.yzyy
mul r6.zw, cb0[13].zzzw, cb1[69].wwww
mad r6.zw, r9.xxxy, cb0[4].xxxy, r6.zzzw
add r6.zw, r6.zzzw, l(0.000000, 0.000000, 0.500000, 0.500000)
sample_indexable(texture2d)(float,float,float,float) r7.xyz, r6.zwzz, t29.xyzw, s5
mad r6.zw, r7.xxxy, l(0.000000, 0.000000, 1.99218750, 1.99218750), l(0.000000, 0.000000, -1.000000, -1.000000)
mul r4.w, r7.z, r7.z
mul r4.w, r4.w, l(0.33333334)
min r4.xw, r4.xxxw, l(1.000000, 0.000000, 0.000000, 1.000000)
mul r0.x, r0.x, cb0[12].z
mad r5.xy, r6.zwzz, r0.xxxx, r3.zwzz
dp3 r3.z, r5.xyzx, r5.xyzx
rsq r3.z, r3.z
mul r5.xyz, r3.zzzz, r5.xyzx
mad r3.z, r4.w, r0.x, r4.x
mad r4.xw, r7.xxxy, l(2.000000, 0.000000, 0.000000, 2.000000), l(-1.000000, 0.000000, 0.000000, -1.000000)
mul r4.xw, r3.xxxy, r4.xxxw
mad r4.xw, r4.xxxw, r0.xxxx, v1.yyyz
mad r3.w, cb0[15].y, cb1[69].w, l(1.000000)
...
mov r8.x, -r7.x
dp2 r9.y, r8.xyxx, r4.yzyy
mad r4.yz, r9.xxyx, cb0[4].xxyx, r6.xxyx
add r4.yz, r4.yyzy, l(0.000000, 0.500000, 0.500000, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r6.xyz, r4.yzyy, t29.xyzw, s5
...
mad r5.xy, r4.yzyy, r0.xxxx, r5.xyxx
dp3 r4.y, r5.xyzx, r5.xyzx
rsq r4.y, r4.y
mul r5.xyz, r4.yyyy, r5.xyzx
mad r3.z, r3.w, r0.x, r3.z
mad r4.yz, r6.xxyx, l(0.000000, 2.000000, 2.000000, 0.000000), l(0.000000, -1.000000, -1.000000, 0.000000)
mul r3.xy, r3.xyxx, r4.yzyy
mad r3.xy, r3.xyxx, r0.xxxx, r4.xwxx
...
mad r4.xyz, r4.xyzx, r5.zzzz, r5.xywx
...
if_nz r2.w
  ftoi r2.w, cb1[64].w
  lod r3.z, v1.yzyy, t21.y, s1
  lod r3.w, v1.yzyy, t21.x, s1
  lt r3.z, r3.z, r3.w
  lt r3.w, l(0.000000), r3.w
  and r5.xyz, r2.wwww, l(1, 2, 4, 0)
  movc r6.xyz, r5.xxxx, l(1.000000,0,1.000000,0), r0.yzwy
  movc r5.xyw, r5.yyyy, l(0,1.000000,0,1.000000), r0.yzyw
  movc r5.xyw, r3.wwww, r6.xyxz, r5.xyxw
  movc r6.xyz, r5.zzzz, l(0,1.000000,0,0), r0.yzwy
  movc r0.yzw, r3.zzzz, r5.xxyw, r6.xxyz
endif 
add r5.xyz, -r0.yzwy, cb1[58].xyzx
mad r0.yzw, cb1[58].wwww, r5.xxyz, r0.yyzw
mad r1.w, -r1.w, v1.x, cb1[59].x
mad o0.w, cb1[59].w, r1.w, r1.x
add r5.xyz, -r2.xyzx, cb1[61].xyzx
mad r2.xyz, cb1[61].wwww, r5.xyzx, r2.xyzx
add r1.x, -r0.x, r1.z
mad r5.y, cb1[62].w, r1.x, r0.x
add r0.x, -r1.y, cb1[63].x
mad r0.x, cb1[63].w, r0.x, r1.y
movc r1.xyz, v7.xxxx, v3.xyzx, -v3.xyzx
dp3 r1.w, r1.xyzx, r1.xyzx
rsq r1.w, r1.w
mad r1.xyz, r1.xyzx, r1.wwww, -r4.xyzx
mad r1.xyz, cb1[60].wwww, r1.xyzx, r4.xyzx
ieq r2.w, cb0[12].w, l(4)
if_nz r2.w
  sample_indexable(texture2d)(float,float,float,float) r4.xyz, r3.xyxx, t46.xyzw, s7
else 
  ieq r2.w, cb0[12].w, l(3)
  if_nz r2.w
    sample_indexable(texture2d)(float,float,float,float) r4.xyz, r3.xyxx, t38.xyzw, s7
  else 
    ieq r2.w, cb0[12].w, l(2)
    if_nz r2.w
      sample_indexable(texture2d)(float,float,float,float) r4.xyz, r3.xyxx, t37.xyzw, s7
    else 
      sample_indexable(texture2d)(float,float,float,float) r4.xyz, r3.xyxx, t30.xyzw, s7
    endif 
  endif 
endif 
mul r3.xyz, r4.xyzx, cb1[26].wwww
ftou r4.xy, v0.xyxx
...
add r4.w, r4.w, r4.w
mad r9.yzw, r1.xxyz, -r4.wwww, -r6.xxyz
...
loop 
  ...
  add r13.xyz, -r19.yzwy, v6.xyzx
  dp3 r8.w, r13.xyzx, r13.xyzx
  sqrt r8.w, r8.w
  ge r8.w, cb2[54].y, r8.w
  and r11.w, r7.w, l(0x0000ffff)
  ...
  mov r19.y, r20.z
  mov r19.z, r21.x
  dp3 r24.x, r13.xyzx, r19.xyzx
  mov r25.xy, r20.xwxx
  mov r25.z, r21.w
  dp3 r24.y, r13.xyzx, r25.xyzx
  mov r21.x, r20.y
  dp3 r24.z, r13.xyzx, r21.xyzx
  mad_sat r10.yzw, r24.xxyz, r10.yyzw, l(0.000000, 0.500000, 0.500000, 0.500000)
  mov r20.x, r22.w
  mov r20.yz, r23.xxyx
  mad r10.yzw, r10.yyzw, r22.xxyz, r20.xxyz
  dp3 r19.x, r1.xyzx, r19.xyzx
  dp3 r19.y, r1.xyzx, r25.xyzx
  dp3 r19.z, r1.xyzx, r21.xyzx
  lt r20.xyz, l(0.000000, 0.000000, 0.000000, 0.000000), r19.xyzx
  movc r15.z, r20.x, l(0), l(0.500000)
  add r21.xyz, r10.yzwy, r15.xyzx
  ...
  ubfe r14.xw, l(6, 0, 0, 9), l(25, 0, 0, 16), r7.wwww
  utof r19.w, r14.w
  sample_l_indexable(texturecubearray)(float,float,float,float) r19.xyz, r19.xyzw, t8.xyzw, s2, l(6.000000)
    ...
    if_nz r15.w
      ...
      if_nz r8.w
        ...
        loop 
          ...
          mul r23.x, r16.w, r16.z
          ushr r17.z, r15.z, l(2)
          ubfe r17.w, l(1), l(2), r15.z
          and r19.w, r17.z, l(2)
          max r20.z, r23.x, r23.y
          mad r16.z, -r16.z, r16.w, l(1.000000)
          mul r16.z, r16.z, r23.y
          movc r4.y, r19.w, r16.z, r20.z
          movc r23.xy, r17.wwww, r23.xyxx, r4.xyxx
          iadd r15.w, r15.w, l(1)
          mov r15.z, r17.z
        endloop 
        mov_sat r23.y, r23.y
        mul r4.y, r23.w, r23.y
        lt r15.z, l(0.000000), r4.y
        if_nz r15.z
          mad r25.w, r23.y, r23.w, r24.w
          mul r4.y, r7.z, r4.y
          mul r26.xyz, r4.yyyy, r22.xyzx
          mul r27.xyz, r20.xywx, r26.yyyy
          mad r26.xyw, r21.xyxz, r26.xxxx, r27.xyxz
          mad r26.xyz, r10.yzwy, r26.zzzz, r26.xywx
          mad r25.xyz, r26.xyzx, r19.xyzx, r24.xyzx
        else 
...
if_z r2.w
  ...
  loop 
    ...
    ieq r8.w, r4.x, r7.z
    bfi r10.y, r4.y, l(0), l(0), r7.w
    movc r7.w, r8.w, r10.y, r7.w
    ieq r8.w, r5.w, r7.z
    ubfe r10.y, r6.w, l(0), r7.w
    movc r7.w, r8.w, r10.y, r7.w
    ...
    loop 
      ...
      and r11.w, r10.w, r10.y
      if_nz r11.w
        xor r10.y, r10.w, r10.y
        iadd r10.w, r8.w, r10.z
        ...
        mov r13.z, r22.w
        lt r13.xyz, |r22.xyzx|, r13.zxyz
        and r10.w, r13.y, r13.x
        and r10.w, r13.z, r10.w
        if_nz r10.w
          iadd r10.z, r7.z, r10.z
          ...
          add r13.xyz, -r22.yzwy, v6.xyzx
          and r10.w, r12.w, l(0x0000ffff)
          ubfe r11.w, l(6), l(25), r12.w
          ...
          dp3 r15.w, r26.xyzx, r13.xyzx
          add_sat r15.w, r26.w, r15.w
          mul r14.w, r14.w, r15.w
          dp3 r15.w, r27.xyzx, r13.xyzx
          add_sat r15.w, r27.w, r15.w
          mul r14.w, r14.w, r15.w
          dp3 r15.w, r28.xyzx, r13.xyzx
          add_sat r15.w, r28.w, r15.w
          mul r14.w, r14.w, r15.w
          dp3 r15.w, r29.xyzx, r13.xyzx
          ...
          if_nz r11.w
            ...
            mad r21.w, r24.y, r23.w, r21.w
            mul r10.z, r12.z, r10.w
            mov r22.y, r25.z
            mov r22.z, r26.x
            dp3 r28.x, r13.xyzx, r22.xyzx
            mov r29.xy, r25.xwxx
            mov r29.z, r26.w
            dp3 r28.y, r13.xyzx, r29.xyzx
            mov r26.x, r25.y
            dp3 r28.z, r13.xyzx, r26.xyzx
            mad_sat r13.xyz, r28.xyzx, r16.yzwy, l(0.500000, 0.500000, 0.500000, 0.000000)
            mov r23.x, r27.w
            mad r13.xyz, r13.xyzx, r27.xyzx, r23.xyzx
            dp3 r22.x, r1.xyzx, r22.xyzx
            dp3 r22.y, r1.xyzx, r29.xyzx
            dp3 r22.z, r1.xyzx, r26.xyzx
            lt r16.yzw, l(0.000000, 0.000000, 0.000000, 0.000000), r22.xxyz
            movc r15.z, r16.y, l(0), l(0.500000)
            add r23.xyz, r13.xyzx, r15.xyzx
            sample_l_indexable(texture3d)(float,float,float,float) r23.xyz, r23.xyzx, t17.xyzw, s4, l(0.000000)
            mul r24.xzw, r22.xxyz, r22.xxyz
            mul r24.xzw, r10.zzzz, r24.xxzw
            movc r17.z, r16.z, l(0), l(0.500000)
            add r25.xyz, r13.xyzx, r17.xyzx
            sample_l_indexable(texture3d)(float,float,float,float) r25.xyz, r25.xyzx, t18.xyzw, s4, l(0.000000)
            mul r25.xyz, r24.zzzz, r25.xyzx
            mad r23.xyz, r23.xyzx, r24.xxxx, r25.xyzx
            movc r19.z, r16.w, l(0), l(0.500000)
            ...
            mad r13.xyz, r13.xyzx, r24.wwww, r23.xyzx
            ubfe r10.z, l(9), l(16), r12.w
            utof r22.w, r10.z
            sample_l_indexable(texturecubearray)(float,float,float,float) r16.yzw, r22.xyzw, t8.wxyz, s2, l(6.000000)
            and r22.xyz, r16.yzwy, l(0x7fffffff, 0x7fffffff, 0x7fffffff, 0)
            ieq r22.xyz, r22.xyzx, l(0x7f800000, 0x7f800000, 0x7f800000, 0)
            or r10.z, r22.y, r22.x
            or r10.z, r22.z, r10.z
            movc r16.yzw, r10.zzzz, l(0,1.000000,1.000000,0), r16.yyzw
            mad r21.xyz, r13.xyzx, r16.yzwy, r21.xyzx
          endif 
        endif 
      endif 
    endloop 
  ...
  if_nz r5.w
    ...
    loop 
      ...
      ushr r12.z, r6.w, l(5)
      iadd r13.xyz, r11.xyzx, r12.xyzx
      ld_indexable(texture2darray)(uint,uint,uint,uint) r7.z, r13.xyzw, t7.yzxw
      ieq r7.w, r4.x, r6.w
      ubfe r8.w, r4.y, l(0), r7.z
        ...
        if_nz r11.w
          ...
          if_nz r10.w
            ...
            loop 
              ...
              movc r16.y, r23.w, r16.w, r25.z
              movc r25.xy, r19.wwww, r25.xyxx, r16.xyxx
              iadd r16.z, r16.z, l(1)
              mov r15.w, r18.w
            endloop 
            add_sat r10.w, -r8.w, r25.y
            mul r11.w, r24.w, r10.w
            ...
            if_nz r14.x
              ...
              mad r22.w, r10.w, r24.w, r22.w
              mul r10.z, r12.z, r11.w
              mov r23.y, r26.z
              mov r23.z, r27.x
              dp3 r29.x, r13.xyzx, r23.xyzx
              mov r30.xy, r26.xwxx
              mov r30.z, r27.w
              dp3 r29.y, r13.xyzx, r30.xyzx
              mov r27.x, r26.y
              dp3 r29.z, r13.xyzx, r27.xyzx
              mad_sat r13.xyz, r29.xyzx, r16.yzwy, l(0.500000, 0.500000, 0.500000, 0.000000)
              mov r24.x, r28.w
              mad r13.xyz, r13.xyzx, r28.xyzx, r24.xyzx
              dp3 r23.x, r1.xyzx, r23.xyzx
              dp3 r23.y, r1.xyzx, r30.xyzx
              dp3 r23.z, r1.xyzx, r27.xyzx
              lt r16.yzw, l(0.000000, 0.000000, 0.000000, 0.000000), r23.xxyz
              movc r15.z, r16.y, l(0), l(0.500000)
              ...
              mul r25.xzw, r23.xxyz, r23.xxyz
              mul r25.xzw, r10.zzzz, r25.xxzw
              movc r17.z, r16.z, l(0), l(0.500000)
              add r26.xyz, r13.xyzx, r17.xyzx
              sample_l_indexable(texture3d)(float,float,float,float) r26.xyz, r26.xyzx, t18.xyzw, s4, l(0.000000)
              mul r26.xyz, r25.zzzz, r26.xyzx
              mad r24.xyz, r24.xyzx, r25.xxxx, r26.xyzx
              movc r19.z, r16.w, l(0), l(0.500000)
              add r13.xyz, r13.xyzx, r19.xyzx
              sample_l_indexable(texture3d)(float,float,float,float) r13.xyz, r13.xyzx, t19.xyzw, s4, l(0.000000)
              mad r13.xyz, r13.xyzx, r25.wwww, r24.xyzx
              ubfe r10.z, l(9), l(16), r12.w
              utof r23.w, r10.z
              sample_l_indexable(texturecubearray)(float,float,float,float) r16.yzw, r23.xyzw, t8.wxyz, s2, l(6.000000)
              and r23.xyz, r16.yzwy, l(0x7fffffff, 0x7fffffff, 0x7fffffff, 0)
              ieq r23.xyz, r23.xyzx, l(0x7f800000, 0x7f800000, 0x7f800000, 0)
              or r10.z, r23.y, r23.x
              or r10.z, r23.z, r10.z
              movc r16.yzw, r10.zzzz, l(0,1.000000,1.000000,0), r16.yyzw
              mad r22.xyz, r13.xyzx, r16.yzwy, r22.xyzx
            endif 
          endif 
        endif 
      endloop 
  ...
  rcp r2.w, r2.w
  mov_sat r20.w, r20.w
  mul r18.xyz, r2.wwww, r20.xyzx
  lt r2.w, r20.w, l(0.990000)
  if_nz r2.w
    ...
    mad r18.xyz, r10.yzwy, r12.xyzx, r18.xyzx
  endif 
endif 
add r1.w, r0.x, r5.x
log r1.w, |r1.w|
...
if_z r4.y
  ...
  if_nz r5.w
    ...
    loop 
      ...
      breakc_nz r7.z
      ftou r7.z, r5.w
      add r14.xy, r10.yzyy, -cb2[r7.z + 20].xyxx
  ...
  if_nz r7.z
    ...
    if_z r11.w
      ...
      if_z r7.w
        ...
        f16tof32 r8.w, r8.w
        mad r11.w, r10.y, r14.x, r11.w
        mad r8.w, r10.z, r8.w, r11.w
        movc r14.w, r7.w, r8.w, r14.w
      endif 
    endif 
  ...
  if_z r7.z
    if_z cb2[58].y
      ftou r7.z, r5.w
      add r14.xy, r10.yzyy, -cb2[r7.z + 20].xyxx
      mul r7.zw, r14.xxxy, cb2[r7.z + 20].zzzz
      mad r14.xy, r7.zwzz, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
      itof r7.z, cb2[26].y
      add r14.z, r5.w, r7.z
      sample_c_lz_indexable(texture2darray)(float,float,float,float) r7.z, r14.xyzx, t13.xxxx, s13, r4.y
    ...
    if_nz cb2[58].y
      ...
      ftou r6.w, r6.w
      add r15.xy, r10.yzyy, -cb2[r7.z + 20].xyxx
      mul r15.xy, r15.xyxx, cb2[r7.z + 20].zzzz
      ...
      loop 
        ...
        breakc_nz r10.w
        ult r10.w, r6.w, r8.w
        movc r15.zw, r10.wwww, r10.yyyz, r15.xxxy
        movc r11.w, r10.w, cb2[r5.w + 20].w, cb2[r7.z + 20].w
        movc r10.w, r10.w, r5.w, r7.z
        dp2 r16.x, icb[r8.w + 0].yxyy, r14.xyxx
        dp2 r16.y, icb[r8.w + 0].yxyy, r14.yzyy
        mad r16.xy, r16.xyxx, r11.wwww, r15.zwzz
        iadd r10.w, r10.w, cb2[26].y
        utof r16.z, r10.w
        sample_c_lz_indexable(texture2darray)(float,float,float,float) r10.w, r16.xyzx, t13.xxxx, s13, r4.y
...
if_nz r4.y
  lt r4.y, l(0.000000), r5.y
  if_nz r4.y
    mul r4.y, r4.w, cb2[18].w
    mul r4.y, r4.x, r4.y
    if_nz cb2[23].x
      add r14.xyz, v6.xyzx, cb1[24].xyzx
      mov r14.w, l(1.000000)
      dp4 r5.w, cb2[24].xyzw, r14.xyzw
      dp4 r6.w, cb2[25].xyzw, r14.xyzw
      frc r14.x, r5.w
      frc r14.y, r6.w
    ...
    if_nz r6.w
      ...
      mad r18.xyz, r1.xyzx, r7.zzzz, v6.xyzx
      ...
      if_z r8.w
        ...
        if_nz cb2[58].y
          ...
          utof r14.z, r7.z
          sample_c_lz_indexable(texture2darray)(float,float,float,float) r7.w, r14.xyzx, t9.xxxx, s13, r5.w
        endif 
        mul r5.w, r7.w, r7.w
        mul r5.w, r7.w, r5.w
      else 
    ...
    mad r5.w, -r4.x, r5.w, l(1.000000)
    mul r5.w, r5.w, r5.w
    mad r5.w, -r5.w, l(0.620000), l(0.620000)
    add r5.w, -r4.x, r5.w
    mad r5.w, r5.z, r5.w, r4.x
    mul r5.w, r5.y, r5.w
    lt r2.w, l(0.000000), r2.w
    mad r14.xyz, r5.wwww, r10.yzwy, r12.xyzx
    ...
    mad r6.w, |r5.w|, r4.w, -|r5.w|
    mad r5.w, |r5.w|, r6.w, l(1.000000)
    mad r4.x, r4.x, r0.x, r1.w
    mul r5.w, r5.w, r5.w
    mul r4.x, r4.x, r5.w
    rcp r4.x, r4.x
    mul r4.x, r4.y, r4.x
    ...
    mad r15.xyz, r4.xxxx, r10.yzwy, r3.xyzx
          ...
          if_nz r24.w
            ...
            if_nz r24.w
              ...
              if_nz r24.w
                ...
                mad r40.xyz, r1.xyzx, r24.wwww, v6.xyzx
                ...
                loop 
                  ...
                  mul r42.x, r10.x, r42.y
                  mul r42.w, r9.x, r42.y
              ...
              lt r24.w, l(0.000000), r15.z
              if_nz r24.w
                mul r24.w, r4.w, r31.x
                mul r24.w, r24.w, l(0.250000)
                dp3 r25.w, r37.xyzx, r9.yzwy
                dp3 r27.w, r9.yzwy, r39.xyzx
                ...
                if_nz r13.w
                  ...
                  mad r18.xyz, r1.xyzx, r25.wwww, v6.xyzx
                  ...
                  if_z r18.y
                    ...
                    if_nz r7.z
                      ...
                      loop 
                        ...
                        dp2 r41.y, icb[r18.z + 0].xyxx, r7.xyxx
                  ...
                  if_nz r13.w
                    ...
                    mad r19.xyz, r1.xyzx, r18.xxxx, v6.xyzx
                    ...
                    if_z r18.z
                      ...
                      if_nz r7.z
                        ...
                        loop 
                          ige r27.w, r25.w, l(8)
                          breakc_nz r27.w
                          dp2 r40.x, icb[r25.w + 0].xyxx, r8.xyxx
                          dp2 r40.y, icb[r25.w + 0].yxyy, r8.xzxx
                ...
                movc r10.yzw, r13.wwww, r19.xxyz, r10.yyzw
          ...
          if_nz r15.z
            ...
            if_nz r15.z
              ...
              if_nz r15.z
                ...
                mad r21.xyz, r1.xyzx, r15.zzzz, v6.xyzx
                ...
                if_nz r24.w
                  ...
                  if_nz r7.z
                    ...
                    loop 
                      ...
                      sample_c_lz_indexable(texture2darray)(float,float,float,float) r25.w, r30.xyzx, t9.xxxx, s13, r8.w
              ...
              mul r8.w, r8.w, r15.w
              lt r15.z, l(0.000000), r8.w
              if_nz r15.z
                mul r15.z, r4.w, r31.x
                ...
                if_nz r21.x
                  ...
                  mad r22.xyz, r1.xyzx, r21.yyyy, v6.xyzx
                  ...
                  if_nz r21.x
                    ...
                    mad r21.y, |r12.w|, l(-0.200000), l(0.400000)
                    mad r23.xyz, r1.xyzx, r21.yyyy, v6.xyzx
                ...
                mad r15.w, -r13.w, r3.w, l(1.000000)
                mul r15.w, r15.w, r15.w
                mad r15.w, -r15.w, l(0.620000), l(0.620000)
                add r15.w, -r13.w, r15.w
                mad r15.w, r5.z, r15.w, r13.w
                mul r15.w, r8.w, r15.w
                lt r12.w, l(0.000000), r12.w
                mad r22.xyz, r15.wwww, r20.xywx, r10.yzwy
                mad r19.xyz, r19.xyzx, r11.wwww, r6.xyzx
                dp3 r11.w, r19.xyzx, r19.xyzx
                rsq r11.w, r11.w
                mul r19.xyz, r11.wwww, r19.xyzx
                dp3 r11.w, r19.xyzx, r6.xyzx
                dp3 r15.w, r1.xyzx, r19.xyzx
                mad r19.x, |r15.w|, r4.w, -|r15.w|
                mad r15.w, |r15.w|, r19.x, l(1.000000)
                mad r13.w, r13.w, r0.x, r1.w
                mul r15.w, r15.w, r15.w
                ...
                mad r19.xyz, r8.wwww, r20.xywx, r29.xyzx
                add_sat r11.w, -r11.w, l(1.000000)
                mul r13.w, r11.w, r11.w
                mul r13.w, r13.w, r13.w
                mul r11.w, r11.w, r13.w
                mul r8.w, r8.w, r11.w
                mad r20.xyw, r8.wwww, r20.xyxw, r16.xyxz
                movc r10.yzw, r12.wwww, r22.xxyz, r10.yyzw
...
mad r0.xyz, r5.xywx, r0.yzwy, r1.xyzx
...
ret 
// Approximately 1950 instruction slots used
