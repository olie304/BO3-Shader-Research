...
//   float3 colorTint;                  // Offset:  192 Size:    12
//   bool scaleReveal;                  // Offset:  204 Size:     4
//   float2 normalTiling;               // Offset:  208 Size:     8
...
dcl_output o1.xyzw
dcl_temps 6
mul r0.xyzw, v1.yzyz, cb0[13].xyxy
movc r1.xy, cb0[12].wwww, r0.zwzz, v1.yzyy
mul r1.xy, r1.xyxx, cb0[10].zwzz
sample_indexable(texture2d)(float,float,float,float) r1.x, r1.xyxx, t6.xyzw, s1
...
add r1.yzw, cb0[12].xxyz, l(0.000000, -1.000000, -1.000000, -1.000000)
mad r1.yzw, r1.xxxx, r1.yyzw, l(0.000000, 1.000000, 1.000000, 1.000000)
sample_indexable(texture2d)(float,float,float,float) r2.x, v1.yzyy, t10.xyzw, s3
add r2.y, -cb0[11].y, cb0[11].z
mad r2.x, r2.x, r2.y, cb0[11].y
mul_sat r2.x, r2.x, l(0.05882353)
mad r0.xyzw, cb0[14].xyzw, cb1[69].wwww, r0.xyzw
sample_indexable(texture2d)(float,float,float,float) r3.xyz, r0.xyxx, t9.xyzw, s4
...
sample_indexable(texture2d)(float,float,float,float) r3.xyz, r0.zwzz, t9.xyzw, s4
add r3.xyz, r3.xyzx, l(-0.500000, -0.500000, -0.000000, 0.000000)
mad r3.xyz, cb0[15].yyyy, r3.xyzx, l(0.500000, 0.500000, 0.000000, 0.000000)
mad r0.xy, r3.xyxx, l(1.99218750, 1.99218750, 0.000000, 0.000000), r0.xyxx
mul r0.z, r3.z, r3.z
mul r0.z, r0.z, l(0.33333334)
min r0.z, r0.z, l(1.000000)
add r4.xy, r0.xyxx, l(-1.000000, -1.000000, 0.000000, 0.000000)
dp3 r0.x, r4.xyzx, r4.xyzx
rsq r0.x, r0.x
mul r0.xyw, r0.xxxx, r4.xyxz
add r0.z, r0.z, r2.z
movc r2.z, v5.x, l(1.000000), l(-1.000000)
...
dp3 r2.z, r0.xywx, r0.xywx
rsq r2.z, r2.z
mul r0.xyw, r0.xyxw, r2.zzzz
mad r2.y, cb1[62].x, r2.y, cb0[11].y
...
if_nz r2.y
  ...
  and r3.xyz, r2.yyyy, l(1, 2, 4, 0)
  movc r4.xyz, r3.xxxx, l(1.000000,0,1.000000,0), r1.yzwy
  movc r3.xyw, r3.yyyy, l(0,1.000000,0,1.000000), r1.yzyw
  movc r3.xyw, r2.wwww, r4.xyxz, r3.xyxw
  movc r4.xyz, r3.zzzz, l(0,1.000000,0,0), r1.yzwy
  movc r1.yzw, r2.zzzz, r3.xxyw, r4.xxyz
endif 
add r2.yzw, -r1.yyzw, cb1[58].xxyz
mad o0.xyz, cb1[58].wwww, r2.yzwy, r1.yzwy
add r1.y, -r1.x, cb1[59].x
mad r1.x, cb1[59].w, r1.y, r1.x
add r0.z, -r2.x, r0.z
mad r0.z, cb1[62].w, r0.z, r2.x
movc r1.yzw, v5.xxxx, v2.xxyz, -v2.xxyz
dp3 r2.x, r1.yzwy, r1.yzwy
rsq r2.x, r2.x
mad r1.yzw, r1.yyzw, r2.xxxx, -r0.xxyw
mad r0.xyw, cb1[60].wwww, r1.yzyw, r0.xyxw
ftou r2.xy, v0.xyxx
mov r2.zw, l(0,0,0,0)
ld_indexable(texture2d)(float,float,float,float) r1.yz, r2.xyzw, t0.xzwy
...
dp3 r4.x, r0.xywx, r4.xyzx
dp2 r4.y, r0.xwxx, r3.xyxx
dp3 r0.x, r0.xywx, r2.xyzx
add r0.x, |r0.x|, l(1.000000)
rsq r0.x, r0.x
mul r0.xy, r0.xxxx, r4.xyxx
mad r2.xy, r0.xyxx, l(0.58823532, 0.58823532, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
ge r0.x, r1.y, l(0.500000)
movc r0.x, r0.x, l(0.500000), l(0.00146628)
mad r2.z, r0.z, l(0.49755621), r0.x
and r0.xyz, r1.wwww, r2.xyzx
