...
if_nz r3.z
  ftoi r3.z, cb1[64].w
  lod r5.w, v2.xyxx, t22.y, s1
  lod r6.w, v2.xyxx, t22.x, s1
  lt r5.w, r5.w, r6.w
  ...
  movc r7.xyw, r6.wwww, r8.xyxz, r7.xyxw
  movc r8.xyz, r7.zzzz, l(0,1.000000,0,0), r1.xyzx
  movc r1.xyz, r5.wwww, r7.xywx, r8.xyzx
endif 
add r7.xyz, -r1.xyzx, cb1[58].xyzx
mad r1.xyz, cb1[58].wwww, r7.xyzx, r1.xyzx
add r3.z, -r2.w, cb1[59].x
mad r2.w, cb1[59].w, r3.z, r2.w
...
rsq r1.w, r1.w
mad r7.xyz, r7.xyzx, r1.wwww, -r3.xywx
mad r3.xyz, cb1[60].wwww, r7.xyzx, r3.xywx
ge r1.w, v0.z, l(0.984375)
mul r3.w, v0.z, l(1.01587307)
mad r5.w, v0.z, l(64.000000), l(-63.000000)
movc r1.w, r1.w, r5.w, r3.w
