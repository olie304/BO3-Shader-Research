...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  r13.xy = (int2)r6.zw;
  r13.zw = float2(0,0);
  r3.x = floatZSampler.Load(r13.xyz).x;
  r4.w = cmp(r3.x >= 0.984375);
  r6.z = 1.01587307 * r3.x;
  r3.x = r3.x * 64 + -63;
  r3.x = r4.w ? r3.x : r6.z;
  r3.x = max(9.99999994e-09, r3.x);
  r3.x = rcp(r3.x);
  x2[0].x = r3.x;
  r4.w = 0.0419999994 + r3.x;
  r4.w = r8.z * r4.w;
  r4.w = cmp(1 < r4.w);
  ...
  r0.z = 5 * r0.y;
  r3.x = r0.y * 5 + -2.5;
  r3.x = saturate(0.400000006 * r3.x);
  r3.x = 100 * r3.x;
  ...
  if (r4.y == 0) {
    ...
    r15.xyz = r19.xyz * r0.yyy;
    r16.xyz = r20.xyz * r0.yyy;
    r3.x = cmp(r20.w < 0.99000001);
    if (r3.x != 0) {
      r3.x = 1 + -r20.w;
      r4.x = sunConstants.globalProbeExposure * r3.x;
      r4.yzw = -globalProbeConstants.data[0].xyz + v7.xyz;
      ...
      r15.xyz = r19.xyz * r0.yyy + r2.xyz;
      r12.w = 0;
      r2.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r12.xyzw, r0.z).xyz;
      r0.y = sunConstants.globalProbeExposure * r3.x + -r2.w;
      r0.y = r6.y * r0.y + r2.w;
      r16.xyz = r2.xyz * r0.yyy + r16.xyz;
    }
  } else {
    r16.x = r15.w;
  }
  ...
  if (useAlphaControls != 0) {
    ...
    r3.x = 1 / r2.x;
    r3.y = -r2.y * r3.x + 1;
    r2.xy = r0.zz ? float2(0,1) : r3.xy;
    r0.z = abs(r0.y) * abs(r0.y);
    r0.z = saturate(r0.z * r2.x + r2.y);
    r0.z = r0.w * r0.z;
    r3.xy = (int2)v0.xy;
    r3.zw = float2(0,0);
...
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r0.z, v3.x, l(4), t4.xxxx
r0.z = samp0[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) r0.z, r0.z, l(0), t0.xxxx
r0.z = samp0[]..swiz;
