...
//   float4 postFxBloom04;              // Offset: 1344 Size:    16
//   float4 postFxBloom05;              // Offset: 1360 Size:    16
...
dcl_constantbuffer CB8[86], immediateIndexed
...
mul r0.xyz, r0.xyzx, cb8[84].xyzx
mul r1.xyz, r0.wwww, cb8[85].xyzx
mad r0.xyz, r0.xyzx, l(0.11111111, 0.11111111, 0.11111111, 0.000000), r1.xyzx
