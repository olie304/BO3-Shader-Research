...
r1.w = samp0[]..swiz;
  ...
  r3.xyw = r4.xyz * r3.xxx + r7.xyz;
  r2.z = dot(r3.xyw, r3.xyw);
  r2.z = rsqrt(r2.z);
  r3.xyw = r3.xyw * r2.zzz;
  r2.z = cmp(v0.z >= 0.984375);
  r2.w = 1.01587307 * v0.z;
  r4.w = v0.z * 64 + -63;
  r2.z = r2.z ? r4.w : r2.w;
  r2.yz = max(float2(0,9.99999994e-09), r2.yz);
  r2.z = rcp(r2.z);
  r7.xy = (uint2)v0.xy;
  ...
  r7.xyz = r21.xyz * r2.zzz;
  r11.yzw = r22.xyz * r2.zzz;
