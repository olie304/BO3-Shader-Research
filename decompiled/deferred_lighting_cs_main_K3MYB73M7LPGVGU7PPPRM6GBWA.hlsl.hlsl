// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:23:35 2021
...
r0.y = samplerLinear[]..swiz;
  ...
  r9.x = cmp((uint)r0.x >= (uint)r8.w);
  r9.y = cmp((uint)r0.x < numRefProbes);
  r9.x = r9.y ? r9.x : 0;
  if (r9.x != 0) {
    r9.x = (int)r0.x * 14;
    r13.yzw = -refProbeConstantsCB[r9.x].data[0].xyz + r10.xyz;
    r9.y = 0x0000ffff & (int)refProbeConstantsCB[r9.x].data[7].z;
    if (6 == 0) r9.w = 0; else if (6+25 < 32) {     r9.w = (uint)refProbeConstantsCB[r9.x].data[7].z << (32-(6 + 25)); r9.w = (uint)r9.w >> (32-6);    } else r9.w = (uint)refProbeConstantsCB[r9.x].data[7].z >> 25;
    r12.w = (int)r9.y * 6;
    ...
    r15.x = r15.x * r12.w;
    r12.w = 1 & (int)refProbeConstantsCB[r9.x].data[6].x;
    r15.yz = float2(0,1);
    r15.xy = r12.ww ? r15.xy : r15.zx;
    r16.x = 1;
    r12.w = refProbeConstantsCB[r9.x].data[6].x;
    r17.xy = r15.xy;
    r15.z = 1;
    while (true) {
      r15.w = cmp((int)r15.z >= (int)r9.w);
      if (r15.w != 0) break;
      r15.w = (int)r9.y + (int)r15.z;
      r15.w = (int)r15.w * 6;
    ...
    r9.y = refProbeConstantsCB[r9.x].data[6].y * r17.y;
    r9.w = cmp(0 < r9.y);
    if (r9.w != 0) {
      r9.w = refProbeConstantsCB[r9.x].data[7].y * r9.y;
      r15.x = refProbeConstantsCB[r9.x].data[7].w;
      r15.yz = refProbeConstantsCB[r9.x].data[8].xy;
      r12.w = dot(r14.xyz, r15.xyz);
      r15.x = dot(r13.yzw, r15.xyz);
      r15.x = -refProbeConstantsCB[r9.x].data[8].z + r15.x;
      r15.y = cmp(r15.x >= 0);
      ...
      r15.x = refProbeConstantsCB[r9.x].data[8].w;
      r15.yz = refProbeConstantsCB[r9.x].data[9].xy;
      r15.w = dot(r14.xyz, r15.xyz);
      r15.x = dot(r13.yzw, r15.xyz);
      r15.x = -refProbeConstantsCB[r9.x].data[9].z + r15.x;
      r15.y = cmp(r15.x >= 0);
      r15.x = max(abs(r15.x), r6.w);
      r15.x = r15.y ? r15.x : -r15.x;
      ...
      r15.x = refProbeConstantsCB[r9.x].data[9].w;
      r15.yz = refProbeConstantsCB[r9.x].data[10].xy;
      r15.w = dot(r14.xyz, r15.xyz);
      r15.x = dot(r13.yzw, r15.xyz);
      r15.x = -refProbeConstantsCB[r9.x].data[10].z + r15.x;
      r15.y = cmp(r15.x >= 0);
      r15.x = max(abs(r15.x), r6.w);
      r15.x = r15.y ? r15.x : -r15.x;
      r15.y = max(1.00000001e-07, -r15.w);
      r15.x = r15.x / r15.y;
      r12.w = min(abs(r15.x), r12.w);
      r15.x = refProbeConstantsCB[r9.x].data[10].w;
      r15.yz = refProbeConstantsCB[r9.x].data[11].xy;
      r15.w = dot(r14.xyz, r15.xyz);
      r15.x = dot(r13.yzw, r15.xyz);
      r15.x = -refProbeConstantsCB[r9.x].data[11].z + r15.x;
      r15.y = cmp(r15.x >= 0);
      r15.x = max(abs(r15.x), r6.w);
      r15.x = r15.y ? r15.x : -r15.x;
      r15.y = max(1.00000001e-07, -r15.w);
      r15.x = r15.x / r15.y;
      r12.w = min(abs(r15.x), r12.w);
      r15.x = refProbeConstantsCB[r9.x].data[11].w;
      r15.yz = refProbeConstantsCB[r9.x].data[12].xy;
      r15.w = dot(r14.xyz, r15.xyz);
      r15.x = dot(r13.yzw, r15.xyz);
      r15.x = -refProbeConstantsCB[r9.x].data[12].z + r15.x;
      r15.y = cmp(r15.x >= 0);
      r15.x = max(abs(r15.x), r6.w);
      r15.x = r15.y ? r15.x : -r15.x;
      r15.y = max(1.00000001e-07, -r15.w);
      r15.x = r15.x / r15.y;
      r12.w = min(abs(r15.x), r12.w);
      r15.x = refProbeConstantsCB[r9.x].data[12].w;
      r15.yz = refProbeConstantsCB[r9.x].data[13].xy;
      r15.w = dot(r14.xyz, r15.xyz);
      r15.x = dot(r13.yzw, r15.xyz);
      r15.x = -refProbeConstantsCB[r9.x].data[13].z + r15.x;
      r15.y = cmp(r15.x >= 0);
      r15.x = max(abs(r15.x), r6.w);
      r15.x = r15.y ? r15.x : -r15.x;
      r15.y = max(1.00000001e-07, -r15.w);
      r15.x = r15.x / r15.y;
      r12.w = min(abs(r15.x), r12.w);
      r15.x = refProbeConstantsCB[r9.x].data[3].w + r13.y;
      r15.yz = refProbeConstantsCB[r9.x].data[4].xy + r13.zw;
      ...
      r16.x = refProbeConstantsCB[r9.x].data[0].w;
      r16.y = refProbeConstantsCB[r9.x].data[1].z;
      r16.z = refProbeConstantsCB[r9.x].data[2].y;
      r17.x = dot(r15.xyz, r16.xyz);
      r18.xy = refProbeConstantsCB[r9.x].data[1].xw;
      r18.z = refProbeConstantsCB[r9.x].data[2].z;
      r17.y = dot(r15.xyz, r18.xyz);
      r19.x = refProbeConstantsCB[r9.x].data[1].y;
      r19.yz = refProbeConstantsCB[r9.x].data[2].xw;
      r17.z = dot(r15.xyz, r19.xyz);
      if (9 == 0) r15.x = 0; else if (9+16 < 32) {       r15.x = (uint)refProbeConstantsCB[r9.x].data[7].z << (32-(9 + 16)); r15.x = (uint)r15.x >> (32-9);      } else r15.x = (uint)refProbeConstantsCB[r9.x].data[7].z >> 16;
      r17.w = (uint)r15.x;
      ...
      r13.yzw = saturate(r20.xyz * refProbeConstantsCB[r9.x].data[3].xyz + float3(0.5,0.5,0.5));
      r20.xy = refProbeConstantsCB[r9.x].data[4].zw * r13.yz;
      r20.z = refProbeConstantsCB[r9.x].data[5].x * r13.w;
      r13.yzw = refProbeConstantsCB[r9.x].data[5].yzw + r20.xyz;
      ...
      r9.x = dot(r13.yzw, float3(0.212599993,0.715200007,0.0722000003));
      r12.w = r9.x * r7.w;
      r15.xyz = r15.xyz * r9.www;
      r9.w = dot(r15.xyz, float3(0.212599993,0.715200007,0.0722000003));
      r9.x = r7.w * r9.x + r9.w;
      r9.x = r12.w / r9.x;
      r15.xyz = r15.xyz * r9.xxx;
    } else {
  ...
  if (r9.x != 0) {
    ...
    if (r8.w != 0) {
      ...
      if (6 == 0) r9.x = 0; else if (6+25 < 32) {       r9.x = (uint)refProbeConstantsCB[r0.x].data[7].z << (32-(6 + 25)); r9.x = (uint)r9.x >> (32-6);      } else r9.x = (uint)refProbeConstantsCB[r0.x].data[7].z >> 25;
      r9.w = (int)r8.w * 6;
      r12.w = dot(refProbeAttenuationConstantsCB[r9.w].data[0].xyz, r16.xyz);
      r12.w = saturate(refProbeAttenuationConstantsCB[r9.w].data[0].w + r12.w);
      r15.w = dot(refProbeAttenuationConstantsCB[r9.w].data[1].xyz, r16.xyz);
      r15.w = saturate(refProbeAttenuationConstantsCB[r9.w].data[1].w + r15.w);
      r12.w = r15.w * r12.w;
      r15.w = dot(refProbeAttenuationConstantsCB[r9.w].data[2].xyz, r16.xyz);
      r15.w = saturate(refProbeAttenuationConstantsCB[r9.w].data[2].w + r15.w);
      r12.w = r15.w * r12.w;
      r15.w = dot(refProbeAttenuationConstantsCB[r9.w].data[3].xyz, r16.xyz);
      r15.w = saturate(refProbeAttenuationConstantsCB[r9.w].data[3].w + r15.w);
      r12.w = r15.w * r12.w;
      r15.w = dot(refProbeAttenuationConstantsCB[r9.w].data[4].xyz, r16.xyz);
      r15.w = saturate(refProbeAttenuationConstantsCB[r9.w].data[4].w + r15.w);
      r12.w = r15.w * r12.w;
      r15.w = dot(refProbeAttenuationConstantsCB[r9.w].data[5].xyz, r16.xyz);
      r9.w = saturate(refProbeAttenuationConstantsCB[r9.w].data[5].w + r15.w);
      r17.x = r12.w * r9.w;
      r9.w = 1 & (int)refProbeConstantsCB[r0.x].data[6].x;
      r17.yz = float2(0,1);
      r17.xy = r9.ww ? r17.xy : r17.zx;
      r18.x = 1;
      r9.w = refProbeConstantsCB[r0.x].data[6].x;
      r19.xy = r17.xy;
      r12.w = 1;
      while (true) {
        r15.w = cmp((int)r12.w >= (int)r9.x);
        if (r15.w != 0) break;
        r15.w = (int)r8.w + (int)r12.w;
        r15.w = (int)r15.w * 6;
        ...
        r16.w = r19.x * r16.w;
        r17.z = dot(refProbeAttenuationConstantsCB[r15.w].data[1].xyz, r16.xyz);
        r17.z = saturate(refProbeAttenuationConstantsCB[r15.w].data[1].w + r17.z);
        r16.w = r17.z * r16.w;
        r17.z = dot(refProbeAttenuationConstantsCB[r15.w].data[2].xyz, r16.xyz);
        r17.z = saturate(refProbeAttenuationConstantsCB[r15.w].data[2].w + r17.z);
        r16.w = r17.z * r16.w;
        r17.z = dot(refProbeAttenuationConstantsCB[r15.w].data[3].xyz, r16.xyz);
        r17.z = saturate(refProbeAttenuationConstantsCB[r15.w].data[3].w + r17.z);
        r16.w = r17.z * r16.w;
        r17.z = dot(refProbeAttenuationConstantsCB[r15.w].data[4].xyz, r16.xyz);
        r17.z = saturate(refProbeAttenuationConstantsCB[r15.w].data[4].w + r17.z);
        r16.w = r17.z * r16.w;
        r17.z = dot(refProbeAttenuationConstantsCB[r15.w].data[5].xyz, r16.xyz);
        ...
        r15.w = -r16.w * r15.w + 1;
        r15.w = r19.y * r15.w;
        r18.y = r18.z ? r15.w : r18.w;
        r19.xy = r17.ww ? r19.xy : r18.xy;
        r12.w = (int)r12.w + 1;
        r9.w = r17.z;
      }
      r8.w = saturate(r19.y + -r9.y);
      r9.x = refProbeConstantsCB[r0.x].data[6].y * r8.w;
      r9.w = cmp(0 < r9.x);
      if (r9.w != 0) {
        r9.y = r8.w * refProbeConstantsCB[r0.x].data[6].y + r9.y;
        r8.w = refProbeConstantsCB[r0.x].data[7].y * r9.x;
        r17.x = refProbeConstantsCB[r0.x].data[7].w;
        r17.yz = refProbeConstantsCB[r0.x].data[8].xy;
        r9.x = dot(r14.xyz, r17.xyz);
        r9.w = dot(r16.xyz, r17.xyz);
        r9.w = -refProbeConstantsCB[r0.x].data[8].z + r9.w;
        r12.w = cmp(r9.w >= 0);
        r9.w = max(abs(r9.w), r6.w);
        ...
        r9.w = dot(r14.xyz, r17.xyz);
        r12.w = dot(r16.xyz, r17.xyz);
        r12.w = -refProbeConstantsCB[r0.x].data[9].z + r12.w;
        r15.w = cmp(r12.w >= 0);
        ...
        r9.w = dot(r14.xyz, r17.xyz);
        r12.w = dot(r16.xyz, r17.xyz);
        r12.w = -refProbeConstantsCB[r0.x].data[10].z + r12.w;
        r15.w = cmp(r12.w >= 0);
        r12.w = max(abs(r12.w), r6.w);
        r12.w = r15.w ? r12.w : -r12.w;
        r9.w = max(1.00000001e-07, -r9.w);
        ...
        r9.w = dot(r14.xyz, r17.xyz);
        r12.w = dot(r16.xyz, r17.xyz);
        r12.w = -refProbeConstantsCB[r0.x].data[11].z + r12.w;
        r15.w = cmp(r12.w >= 0);
        r12.w = max(abs(r12.w), r6.w);
        r12.w = r15.w ? r12.w : -r12.w;
        r9.w = max(1.00000001e-07, -r9.w);
        ...
        r9.w = dot(r14.xyz, r17.xyz);
        r12.w = dot(r16.xyz, r17.xyz);
        r12.w = -refProbeConstantsCB[r0.x].data[12].z + r12.w;
        r15.w = cmp(r12.w >= 0);
        r12.w = max(abs(r12.w), r6.w);
        r12.w = r15.w ? r12.w : -r12.w;
        r9.w = max(1.00000001e-07, -r9.w);
        ...
        r9.w = dot(r14.xyz, r17.xyz);
        r12.w = dot(r16.xyz, r17.xyz);
        r12.w = -refProbeConstantsCB[r0.x].data[13].z + r12.w;
        r15.w = cmp(r12.w >= 0);
        r6.w = max(abs(r12.w), r6.w);
        r6.w = r15.w ? r6.w : -r6.w;
        r9.w = max(1.00000001e-07, -r9.w);
        r6.w = r6.w / r9.w;
  ...
  r0.x = rcp(r0.x);
  r9.y = saturate(r9.y);
  r16.xyz = r13.yzw * r0.xxx;
  r15.xyz = r15.xyz * r0.xxx;
  r2.w = cmp(r9.y < 0.99000001);
  if (r2.w != 0) {
    r2.w = 1 + -r9.y;
    ...
    r9.xyw = r9.xyw * r19.zzz + r18.xyz;
    r11.w = 0;
    r17.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r11.xyzw, 6).xyz;
    r9.xyw = r17.xyz * r9.xyw;
    r6.w = dot(r9.xyw, float3(0.212599993,0.715200007,0.0722000003));
    r16.xyz = r13.yzw * r0.xxx + r9.xyw;
    r14.w = 0;
    r9.xyw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r14.xyzw, r5.w).xyz;
    r0.x = sunConstants.globalProbeExposure * r2.w + -r6.w;
    r0.x = r2.y * r0.x + r6.w;
    r15.xyz = r9.xyw * r0.xxx + r15.xyz;
  }
  r0.x = r4.z * r1.w + r2.x;
  r0.x = log2(abs(r0.x));
  r0.x = r1.z * r0.x;
  ...
  r9.xyw = r16.xyz * r2.zzz;
  r13.yzw = r0.www ? r9.xyw : 0;
  ...
  r1.w = r2.y * r1.w;
  r0.y = (int)r0.y * 15;
  if (3 == 0) r2.y = 0; else if (3+24 < 32) {   r2.y = (uint)lightConstantsCB[r0.y].data[1].w << (32-(3 + 24)); r2.y = (uint)r2.y >> (32-3);  } else r2.y = (uint)lightConstantsCB[r0.y].data[1].w >> 24;
  switch (r2.y) {
    case 4 :    r2.y = cmp(0 < lightConstantsCB[r0.y].data[6].y);
    ...
    r2.w = dot(r18.xyz, r20.xyz);
    r4.z = saturate(-r2.w / lightConstantsCB[r0.y].data[6].y);
    r21.xyz = r4.zzz * r18.xyz + r19.xyz;
    r21.xyz = r2.yyy ? r21.xyz : lightConstantsCB[r0.y].data[0].xyz;
    ...
    if (r8.w != 0) {
      r8.w = sqrt(r5.w);
      r11.w = lightConstantsCB[r0.y].data[3].x * lightConstantsCB[r0.y].data[3].x;
      r5.w = r11.w / r5.w;
      r5.w = min(1, r5.w);
      r21.xy = saturate(r8.ww * lightConstantsCB[r0.y].data[2].xz + lightConstantsCB[r0.y].data[2].yw);
      ...
      if (r8.w != 0) {
        ...
        if (r8.w != 0) {
          ...
          r8.w = lightConstantsCB[r0.y].data[5].x / r8.w;
          r8.w = lightConstantsCB[r0.y].data[5].y + r8.w;
        ...
        r8.w = cmp(0 < r5.w);
        if (r8.w != 0) {
          r8.w = lightConstantsCB[r0.y].data[1].z * r0.z;
          r8.w = 0.25 * r8.w;
          r11.w = dot(r18.xyz, r14.xyz);
          r12.w = dot(r14.xyz, r20.xyz);
          r14.x = -r11.w * r11.w + lightConstantsCB[r0.y].data[6].y;
          r2.w = r11.w * r12.w + -r2.w;
          r2.w = saturate(r2.w / r14.x);
          r11.w = r14.x / lightConstantsCB[r0.y].data[6].y;
          r11.w = 10 * r11.w;
          r11.w = min(1, r11.w);
          r2.w = r2.w + -r4.z;
          r2.w = r11.w * r2.w + r4.z;
          r14.xyz = r2.www * r18.xyz + r19.xyz;
          r14.xyz = r2.yyy ? r14.xyz : lightConstantsCB[r0.y].data[0].xyz;
          r14.xyz = r14.xyz + -r10.xyz;
          r2.y = dot(r14.xyz, r14.xyz);
          r2.y = rsqrt(r2.y);
          r18.xyz = r14.xyz * r2.yyy;
          if (4 == 0) r2.w = 0; else if (4+16 < 32) {           r2.w = (uint)lightConstantsCB[r0.y].data[1].w << (32-(4 + 16)); r2.w = (uint)r2.w >> (32-4);          } else r2.w = (uint)lightConstantsCB[r0.y].data[1].w >> 16;
          ...
          if (r4.z != 0) {
            ...
            if (4 == 0) r2.w = 0; else if (4+20 < 32) {             r2.w = (uint)lightConstantsCB[r0.y].data[1].w << (32-(4 + 20)); r2.w = (uint)r2.w >> (32-4);            } else r2.w = (uint)lightConstantsCB[r0.y].data[1].w >> 20;
            r4.z = cmp(0 < (uint)r2.w);
            r11.w = ~(int)r9.z;
            r4.z = r4.z ? r11.w : 0;
            if (r4.z != 0) {
          ...
          r4.z = cmp(0 < r6.w);
          r20.xyz = r16.xyz * r2.zzz + r20.xyz;
          r6.w = saturate(dot(r11.xyz, r18.xyz));
          r14.xyz = r14.xyz * r2.yyy + r12.xyz;
          r2.y = dot(r14.xyz, r14.xyz);
          r2.y = rsqrt(r2.y);
          r14.xyz = r14.xyz * r2.yyy;
          r2.y = dot(r14.xyz, r12.xyz);
          r7.w = dot(r11.xyz, r14.xyz);
          r11.w = abs(r7.w) * r0.z + -abs(r7.w);
          r7.w = abs(r7.w) * r11.w + 1;
          r11.w = r6.w * r0.x + r1.w;
          r7.w = r7.w * r7.w;
          r7.w = r7.w * r11.w;
          r7.w = rcp(r7.w);
          r6.w = r6.w * r8.w;
          r6.w = r7.w * r6.w;
          r5.w = r6.w * r5.w;
          r14.xyz = r5.www * r19.xyz + r15.xyz;
          r2.y = saturate(1 + -r2.y);
          r6.w = r2.y * r2.y;
          r6.w = r6.w * r6.w;
          r2.y = r6.w * r2.y;
          r2.y = r5.w * r2.y;
          r18.xyz = r2.yyy * r19.xyz + r17.xyz;
          r19.xyz = r2.www * r19.xyz + r13.yzw;
          r19.xyz = r0.www ? r19.xyz : 0;
          r9.xyw = r4.zzz ? r20.xyz : r9.xyw;
          r13.yzw = r4.zzz ? r13.yzw : r19.xyz;
          r17.xyz = r4.zzz ? r18.xyz : r17.xyz;
          r15.xyz = r4.zzz ? r14.xyz : r15.xyz;
        }
      }
    }
    break;
    ...
    if (r6.w != 0) {
      ...
      if (r7.w != 0) {
        ...
        r20.xyz = lightConstantsCB[r0.y].data[0].xyz + -r10.xyz;
        r8.w = lightConstantsCB[r0.y].data[3].x * lightConstantsCB[r0.y].data[3].x;
        r11.w = dot(r20.xyz, r20.xyz);
        r8.w = r8.w / r11.w;
        r8.w = min(1, r8.w);
        r20.xy = saturate(r6.ww * lightConstantsCB[r0.y].data[2].xz + lightConstantsCB[r0.y].data[2].yw);
        ...
        if (r6.w != 0) {
          ...
          r11.w = lightConstantsCB[r0.y].data[12].y * r21.y + -1;
        ...
        if (r6.w != 0) {
          r20.z = 1;
          r8.w = dot(lightConstantsCB[r0.y].data[13].xyz, r20.xyz);
      ...
      if (r6.w != 0) {
          ...
          if (r10.w != 0) {
            ...
            if (enableDitheredShadow != 0) {
              ...
              while (true) {
                ...
                if (r12.w != 0) break;
                r22.x = dot(icb[r11.w+0].yx, r18.xy);
                r22.y = dot(icb[r11.w+0].yx, r18.yz);
        ...
        if (r7.w != 0) {
          ...
          if (r10.w != 0) {
            ...
            r18.xyz = r11.xyz * r10.www + r10.xyz;
            ...
            if (r11.w == 0) {
              ...
              if (enableDitheredShadow != 0) {
                ...
                while (true) {
                  r15.w = cmp((int)r14.w >= 8);
                  if (r15.w != 0) break;
                  r22.x = dot(icb[r14.w+0].yx, r18.xy);
                  r22.y = dot(icb[r14.w+0].yx, r18.yz);
          ...
          r0.x = r6.w * r0.x;
          r0.x = 0.25 * r0.x;
          r11.xyz = r0.xxx * r19.xyz + r15.xyz;
          r0.z = saturate(1 + -r2.y);
          r1.w = r0.z * r0.z;
          r1.w = r1.w * r1.w;
          r0.z = r1.w * r0.z;
          r0.x = r0.x * r0.z;
          r12.xyz = r0.xxx * r19.xyz + r17.xyz;
          r0.xyz = r0.yyy * r19.xyz + r13.yzw;
          r0.xyz = r0.www ? r0.xyz : 0;
          r9.xyw = r1.zzz ? r2.xzw : r9.xyw;
          r13.yzw = r1.zzz ? r13.yzw : r0.xyz;
          r17.xyz = r1.zzz ? r12.xyz : r17.xyz;
