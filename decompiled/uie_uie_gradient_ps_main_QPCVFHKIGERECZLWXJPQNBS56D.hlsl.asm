...
dcl_output o0.xyzw
dcl_temps 2
add r0.x, -cb3[2].x, l(1.000000)
max r0.y, v2.x, l(0.010000)
min r0.y, r0.y, l(0.990000)
add r0.z, r0.y, -cb3[2].x
div r0.x, r0.z, r0.x
mad r0.x, r0.x, l(0.500000), l(0.500000)
div r0.z, r0.y, cb3[2].x
lt r0.y, r0.y, cb3[2].x
mul r0.z, r0.z, l(0.500000)
movc r0.x, r0.y, r0.z, r0.x
add r1.xyzw, -cb3[0].xyzw, cb3[1].xyzw
mad r0.xyzw, r0.xxxx, r1.xyzw, cb3[0].xyzw
