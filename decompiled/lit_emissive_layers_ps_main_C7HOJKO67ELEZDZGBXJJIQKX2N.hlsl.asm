...
//   float2 wobbleScroll;               // Offset:  544 Size:     8
//   float2 wobbleScale;                // Offset:  552 Size:     8
//   float layer1Wobble;                // Offset:  560 Size:     4
//   float layer2Wobble;                // Offset:  564 Size:     4
//   float layer3Wobble;                // Offset:  568 Size:     4
//
// }
//
...
// wobbleMap                         texture  float4          2d            t38      1 
...
mul r7.zw, cb0[34].xxxy, cb1[69].wwww
mad r7.zw, v1.yyyz, cb0[34].zzzw, r7.zzzw
sample_indexable(texture2d)(float,float,float,float) r7.zw, r7.zwzz, t38.zwxy, s5
mad r7.zw, r7.zzzw, l(0.000000, 0.000000, 1.99218750, 1.99218750), l(0.000000, 0.000000, -1.000000, -1.000000)
mul r7.zw, r7.zzzw, cb1[44].zzzw
...
if_nz r1.x
  ...
  div r8.zw, r8.zzzw, r1.xxxx
  add r8.zw, r8.zzzw, l(0.000000, 0.000000, 0.500000, 0.500000)
  mov_sat r9.zw, r8.zzzw
  movc r9.xy, cb0[15].zwzz, r9.zwzz, r8.zwzz
endif 
mad r8.zw, r7.zzzw, cb0[35].xxxx, r9.xxxy
sample_indexable(texture2d)(float,float,float,float) r9.xyzw, r8.zwzz, t29.xyzw, s1
...
if_nz r3.x
  ...
  div r8.zw, -r12.xxxy, r3.xxxx
  and r8.zw, r4.wwww, r8.zzzw
  add r10.zw, v1.yyyz, l(0.000000, 0.000000, -0.500000, -0.500000)
  add r3.x, cb0[24].y, l(0.000010)
  mul r8.zw, r3.xxxx, r8.zzzw
  mul r8.zw, r8.zzzw, cb0[22].zzzw
  mad r8.zw, r10.zzzw, cb0[22].zzzw, r8.zzzw
  ...
  mad r8.zw, r8.zzzw, cb0[22].zzzw, r12.xxxy
  ...
  div r8.zw, r8.zzzw, r3.xxxx
  add r8.zw, r8.zzzw, l(0.000000, 0.000000, 0.500000, 0.500000)
  mov_sat r10.zw, r8.zzzw
  movc r10.x, cb0[24].w, r10.z, r8.z
  movc r10.y, cb0[25].x, r10.w, r8.w
endif 
mad r8.zw, r7.zzzw, cb0[35].yyyy, r10.xxxy
sample_indexable(texture2d)(float,float,float,float) r10.xyzw, r8.zwzz, t30.xyzw, s1
...
mad r3.xy, r7.zwzz, cb0[35].zzzz, r10.xyxx
sample_indexable(texture2d)(float,float,float,float) r3.xyzw, r3.xyxx, t37.xyzw, s1
...
ret 
// Approximately 3167 instruction slots used
