...
SamplerState nearestClamp_s : register(s2);
  ...
  out float3 o0 : SV_TARGET0)
{
  ...
  r0.x = codeTexture1.Sample(nearestClamp_s, v0.xy).x;
  r0.x = saturate(postFxControl2.w * r0.x);
  r0.y = sqrt(r0.x);
  r1.xy = v1.xy * r0.yy;
  r1.zw = -r1.xy;
  r1.xyzw = v0.xyxy + r1.zyxw;
  r2.xyz = codeTexture0.Sample(bilinearClamp_s, r1.xy).xyz;
  r1.xyz = codeTexture0.Sample(bilinearClamp_s, r1.zw).xyz;
  r0.zw = v1.xy * r0.yy + v0.xy;
  r3.xy = -v1.xy * r0.yy + v0.xy;
  r3.xyz = codeTexture0.Sample(bilinearClamp_s, r3.xy).xyz;
  r0.yzw = codeTexture0.Sample(bilinearClamp_s, r0.zw).xyz;
  r0.yzw = r0.yzw + r2.xyz;
  r0.yzw = r0.yzw + r1.xyz;
  r0.yzw = r0.yzw + r3.xyz;
  r1.xyz = codeTexture2.Sample(bilinearClamp_s, v0.xy).xyz;
  r1.xyz = -r0.yzw * float3(0.25,0.25,0.25) + r1.xyz;
