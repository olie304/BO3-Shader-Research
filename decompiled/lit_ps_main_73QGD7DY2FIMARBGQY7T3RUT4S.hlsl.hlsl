...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  r0.x = specColorMap.Sample(specColorSampler_s, v2.xy).x;
  r2.xyz = float3(-0.0399999991,-0.0399999991,-0.0399999991) + specColorTint.xyz;
  r2.xyz = r0.xxx * r2.xyz + float3(0.0399999991,0.0399999991,0.0399999991);
  ...
  r0.w = r1.z + -r1.y;
  r4.y = debugGlossOverride.w * r0.w + r1.y;
  ...
  if (r2.w == 0) {
        ...
        r13.y = samp0[]..swiz;
          ...
          r32.w = samp0[]..swiz;
            ...
            r38.y = samp0[]..swiz;
              ...
              r33.x = dot(r1.xyz, r25.xyz);
              r33.y = dot(r1.xyz, r26.xyz);
    ...
    if (r8.y != 0) {
      ...
      while (true) {
        ...
        r11.w = cmp((int)r3.x == (int)r9.z);
        if (r3.y == 0) r12.z = 0; else if (r3.y+0 < 32) {         r12.z = (uint)r9.w << (32-(r3.y + 0)); r12.z = (uint)r12.z >> (32-r3.y);        } else r12.z = (uint)r9.w >> 0;
    ...
    if (r3.x != 0) {
      ...
      r9.yzw = cmp(float3(0,0,0) < r1.xyz);
      ...
      r1.w = 0;
      r9.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r1.xyzw, 6).xyz;
      r8.yzw = r9.yzw * r8.yzw;
      r1.w = dot(r8.yzw, float3(0.212599993,0.715200007,0.0722000003));
      r18.xyz = r21.xyz * r2.www + r8.yzw;
      r10.w = 0;
  ...
  r8.yzw = r19.xyz * r1.www;
  r13.xyz = r8.zwy * r3.xxx;
  ...
  if (r3.y == 0) {
    ...
    if (r5.w != 0) {
      ...
      while (true) {
        ...
        if (r6.w != 0) break;
        r6.w = (uint)r5.w;
        r14.xy = -sunConstants.splitPinTransform[r6.w].xy + r9.yz;
        r7.w = max(abs(r14.x), abs(r14.y));
        r6.z = sunConstants.splitPinTransform[r6.w].z * r7.w;
        r6.w = cmp(r6.z < 1);
        if (r6.w != 0) {
          break;
        }
    ...
    if (r6.w == 0) {
      if (enableDitheredShadow == 0) {
        ...
        r14.z = r6.w + r5.w;
        r6.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r14.xyz, r3.y).x;
      ...
      if (enableDitheredShadow != 0) {
        ...
        r6.z = 28 * r6.z;
        r6.z = (uint)r6.z;
        r15.xy = -sunConstants.splitPinTransform[r6.w].xy + r9.yz;
  ...
  if (r3.y != 0) {
    ...
    if (r3.y != 0) {
      ...
      r17.w = samp0[]..swiz;
        ...
        r14.w = samp0[]..swiz;
          ...
          if (enableDitheredShadow != 0) {
            ...
            r15.z = (uint)r6.w;
            r7.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r15.xyz, r5.w).x;
          }
          r5.w = r7.w * r7.w;
          r5.w = r5.w * r7.w;
        } else {
      ...
      r6.z = abs(r5.w) * r4.z + -abs(r5.w);
      r5.w = abs(r5.w) * r6.z + 1;
      r3.x = r3.x * r0.w + r1.w;
      r5.w = r5.w * r5.w;
      r3.x = r5.w * r3.x;
      r3.x = rcp(r3.x);
      ...
      r3.x = r4.y * r3.x;
      r3.x = 0.25 * r3.x;
      r15.xyz = r3.xxx * r9.yzw + r8.yzw;
      r3.y = saturate(1 + -r3.z);
      r3.z = r3.y * r3.y;
      r3.z = r3.z * r3.z;
      r3.y = r3.y * r3.z;
      r3.x = r3.x * r3.y;
      r16.xyz = r3.xxx * r9.zwy + r13.xyz;
      r14.w = r16.z;
      r12.w = r13.z;
  ...
  r3.z = 0;
  while (true) {
    r4.x = cmp((uint)r3.z >= numLights);
    if (r4.x != 0) break;
    r15.z = (uint)r3.z >> 5;
    r16.xyz = (int3)r11.xyz + (int3)r15.xyz;
    r4.x = visibleLights.Load(r16.xyzw).x;
    r16.xyz = r9.yzw;
    r29.xyz = r27.xyz;
    r30.xyz = r28.xyz;
    r4.y = r3.y;
    ...
    while (true) {
      ...
      r32.y = samp0[]..swiz;
        ...
        r37.z = samp0[]..swiz;
        r37.w = samp0[]..swiz;
          if (3 == 0) r6.w = 0; else if (3+24 < 32) {           r6.w = (uint)r32.w << (32-(3 + 24)); r6.w = (uint)r6.w >> (32-3);          } else r6.w = (uint)r32.w >> 24;
          switch (r6.w) {
            case 4 :            r6.w = cmp(0 < r37.x);
            r38.xy = r36.zw;
            r38.z = r37.w;
            r39.xyz = -r38.xyz * float3(0.5,0.5,0.5) + r31.yzw;
            r40.xyz = -v6.xyz + r39.xyz;
            r7.w = dot(r38.xyz, r40.xyz);
            r10.w = saturate(-r7.w / r37.x);
            r41.xyz = r10.www * r38.xyz + r39.xyz;
            r41.xyz = r6.www ? r41.xyz : r31.yzw;
            r41.xyz = -v6.xyz + r41.xyz;
            r11.w = dot(r41.xyz, r41.xyz);
            r12.w = rsqrt(r11.w);
            r41.xyz = r41.xyz * r12.www;
            r12.w = dot(r1.xyz, r41.xyz);
            ...
            if (r15.z != 0) {
              ...
              if (r15.z != 0) {
                ...
                if (r15.z != 0) {
                  ...
                  r7.w = r15.w * r24.w + -r7.w;
                  r7.w = saturate(r7.w / r25.w);
                  r15.w = r25.w / r37.x;
                  r15.zw = float2(0.25,10) * r15.zw;
                  r15.w = min(1, r15.w);
                  r7.w = r7.w + -r10.w;
                  r7.w = r15.w * r7.w + r10.w;
                  r38.xyz = r7.www * r38.xyz + r39.xyz;
                  r38.xyz = r6.www ? r38.xyz : r31.yzw;
                  r38.xyz = -v6.xyz + r38.xyz;
                  r6.w = dot(r38.xyz, r38.xyz);
                  r6.w = rsqrt(r6.w);
                  r39.xyz = r38.xyz * r6.www;
                  if (4 == 0) r7.w = 0; else if (4+16 < 32) {                   r7.w = (uint)r32.w << (32-(4 + 16)); r7.w = (uint)r7.w >> (32-4);                  } else r7.w = (uint)r32.w >> 16;
                  ...
                  r41.w = samp0[]..swiz;
                    ...
                    r7.w = samp0[]..swiz;
                      ...
                      if (r4.y != 0) {
                        ...
                        while (true) {
                          ...
                          r41.y = dot(icb[r25.w+0].xy, r6.xy);
                    ...
                    if (4 == 0) r7.w = 0; else if (4+20 < 32) {                     r7.w = (uint)r32.w << (32-(4 + 20)); r7.w = (uint)r7.w >> (32-4);                    } else r7.w = (uint)r32.w >> 20;
                    r10.w = cmp(0 < (uint)r7.w);
                    r10.w = r2.w ? r10.w : 0;
                    if (r10.w != 0) {
                      r7.w = (int)r7.w + numLights;
                      ...
                      r7.w = samp0[]..swiz;
                        ...
                        if (r4.y != 0) {
                          ...
                          while (true) {
                            ...
                            if (r27.w != 0) break;
                            r40.x = dot(icb[r26.w+0].xy, r7.xy);
                            r40.y = dot(icb[r26.w+0].yx, r7.xz);
                  ...
                  r7.w = r7.w + -r13.w;
                  r7.w = r4.w * r7.w + r13.w;
                  r7.w = r7.w * r11.w;
                  r32.x = r31.x;
                  r10.w = cmp(0 < r12.w);
                  r18.xyz = r7.www * r32.xyz + r16.xyz;
                  r7.w = saturate(dot(r1.xyz, r39.xyz));
                  r19.xyz = r38.xyz * r6.www + r5.xyz;
                  r6.w = dot(r19.xyz, r19.xyz);
                  r6.w = rsqrt(r6.w);
                  r19.xyz = r19.xyz * r6.www;
                  r6.w = dot(r19.xyz, r5.xyz);
                  r12.w = dot(r1.xyz, r19.xyz);
                  r13.w = abs(r12.w) * r4.z + -abs(r12.w);
                  r12.w = abs(r12.w) * r13.w + 1;
                  r13.w = r7.w * r0.w + r1.w;
                  r12.w = r12.w * r12.w;
                  r12.w = r12.w * r13.w;
                  r12.w = rcp(r12.w);
                  r7.w = r7.w * r15.z;
                  r7.w = r12.w * r7.w;
                  r7.w = r7.w * r11.w;
                  r19.xyz = r7.www * r32.xyz + r30.xyz;
                  r6.w = saturate(1 + -r6.w);
                  r11.w = r6.w * r6.w;
                  r11.w = r11.w * r11.w;
                  r6.w = r11.w * r6.w;
                  r6.w = r7.w * r6.w;
                  r38.xyz = r6.www * r32.xyz + r29.xyz;
            ...
            r6.w = rsqrt(r6.w);
            r19.xyz = r18.xyz * r6.www;
            r7.w = dot(r1.xyz, r19.xyz);
            r10.w = saturate(r7.w);
            r11.w = cmp(0 < r10.w);
            if (r11.w != 0) {
            // Known bad code for instruction (needs manual fix):
            ...
            r39.w = samp0[]..swiz;
              ...
              if (r11.w != 0) {
                  ...
                  r39.y = samp0[]..swiz;
                    ...
                    if (r4.y != 0) {
                      ...
                      while (true) {
                        ...
                        r15.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r31.xyz, r6.z).x;
                        r13.w = r15.w * 0.125 + r13.w;
                        r15.z = (int)r15.z + 1;
                      }
                    } else {
                      r21.z = (uint)r11.w;
                      r13.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r21.xyz, r6.z).x;
                    }
                    r6.z = r13.w * r13.w;
                    r6.z = r6.z * r13.w;
                  } else {
                ...
                if (r11.w != 0) {
                  ...
                  r37.z = samp0[]..swiz;
                  r37.w = samp0[]..swiz;
                    r15.w = abs(r7.w) * -0.200000003 + 0.400000006;
                    r22.xyz = r1.xyz * r15.www + v6.xyz;
                  ...
                  r12.w = r12.w + -r10.w;
                  r12.w = r4.w * r12.w + r10.w;
                  r12.w = r12.w * r6.z;
                  r7.w = cmp(0 < r7.w);
                  r21.xyz = r12.www * r19.xyz + r16.xyz;
                  r18.xyz = r18.xyz * r6.www + r5.xyz;
                  r6.w = dot(r18.xyz, r18.xyz);
                  r6.w = rsqrt(r6.w);
                  r18.xyz = r18.xyz * r6.www;
                  r6.w = dot(r18.xyz, r5.xyz);
                  r12.w = dot(r1.xyz, r18.xyz);
                  r15.z = abs(r12.w) * r4.z + -abs(r12.w);
                  ...
                  r6.z = r10.w * r6.z;
                  r6.z = 0.25 * r6.z;
                  r18.xyz = r6.zzz * r19.xyz + r30.xyz;
                  r6.w = saturate(1 + -r6.w);
                  r10.w = r6.w * r6.w;
                  r10.w = r10.w * r10.w;
                  r6.w = r10.w * r6.w;
                  r6.z = r6.z * r6.w;
                  r19.xyz = r6.zzz * r19.xyz + r29.xyz;
                  r16.xyz = r7.www ? r21.xyz : r16.xyz;
                  r29.xyz = r7.www ? r19.xyz : r29.xyz;
                  r30.xyz = r7.www ? r18.xyz : r30.xyz;
                }
              }
            }
            break;
