...
add r0.x, r4.w, r4.w
mad r0.y, r4.w, l(2.000000), l(1.000000)
log r0.y, r0.y
mul r1.x, r0.y, l(0.08333334)
mov r1.y, l(0)
...
mad r9.xyz, r0.yyyy, r9.xyzx, r11.xyzx
...
mad r3.xyz, r3.xyzx, r0.wwww, r7.yzwy
add r0.y, -r5.z, l(1.000000)
mul r0.w, r0.y, r0.y
mul r0.w, r0.w, r0.w
mul r0.y, r0.w, r0.y
mad r0.y, r0.y, l(0.980000), l(0.020000)
mul_sat r0.x, r0.x, cb0[19].z
mul r0.x, r0.x, r0.y
movc r0.x, cb0[29].x, r0.x, r0.y
add r3.xyz, -r5.xywx, r3.xyzx
