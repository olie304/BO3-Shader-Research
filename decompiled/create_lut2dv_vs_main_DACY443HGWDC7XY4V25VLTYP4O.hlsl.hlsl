...
// unknown dcl_: dcl_resource_structured t5, 64
  ...
  baseLut2DSampler.GetDimensions(0, uiDest.x, uiDest.y, uiDest.z);
  r0.x = uiDest.y;
  r0.x = (uint)r0.x;
  r0.x = 32 / r0.x;
  r1.xyzw = postFxControlE.xyzw * r0.xxxx;
  r0.xyzw = v1.yyyy * r0.xxxx + r1.xyzw;
  o0.yw = r0.xy;
  o1.yw = r0.zw;
  o0.xz = v1.xx;
  o1.xz = v1.xx;
...
r0.x = baseLut2DSampler[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r1.xyzw, r0.x, l(0), t5.xyzw
r1.x = baseLut2DSampler[]..swiz;
r1.y = baseLut2DSampler[]..swiz;
r1.z = baseLut2DSampler[]..swiz;
r1.w = baseLut2DSampler[]..swiz;
  r2.x = r1.w;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r3.xyzw, r0.x, l(16), t5.xyzw
r3.x = baseLut2DSampler[]..swiz;
r3.y = baseLut2DSampler[]..swiz;
r3.z = baseLut2DSampler[]..swiz;
r3.w = baseLut2DSampler[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r0.xyzw, r0.x, l(32), t5.xyzw
r0.x = baseLut2DSampler[]..swiz;
r0.y = baseLut2DSampler[]..swiz;
r0.z = baseLut2DSampler[]..swiz;
r0.w = baseLut2DSampler[]..swiz;
  r2.y = r3.w;
  r2.z = r0.w;
  ...
  o2.xyzw = viewProjectionMatrix._m30_m31_m32_m33 + r0.xyzw;
  return;
}