...
mul r1.x, r0.w, v1.w
sample_indexable(texture2d)(float,float,float,float) r1.y, v2.xyxx, t29.yxzw, s6
sample_indexable(texture2d)(float,float,float,float) r1.z, v2.xyxx, t26.yzxw, s3
add r1.w, -cb0[11].x, cb0[11].y
mad r1.z, r1.z, r1.w, cb0[11].x
mul_sat r1.z, r1.z, l(0.05882353)
sample_indexable(texture2d)(float,float,float,float) r2.xyz, v2.xyxx, t25.xyzw, s5
...
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, v2.xyxx, t37.xyzw, s1
...
dp3_sat r5.z, v4.xyzx, r6.xyzx
lt r5.w, cb0[15].w, l(0.500000)
add r6.w, -r5.z, l(1.000000)
...
mad r7.x, v0.z, l(64.000000), l(-63.000000)
movc r5.w, r5.w, r7.x, r6.w
max r5.w, r5.w, l(0.00000001)
rcp r5.w, r5.w
ftou r7.xy, v0.xyxx
ine r6.w, cb1[92].x, l(0)
utof r7.zw, r7.yyyx
dp2 r8.x, r7.wzww, l(0.06711056, 0.00583715, 0.000000, 0.000000)
frc r8.x, r8.x
mul r8.x, r8.x, l(52.982918)
frc r8.x, r8.x
mad r8.x, r8.x, l(6.28318548), cb1[70].w
...
sincos r10.x, r11.x, r7.z
dp3_sat r5.x, r1.xyzx, r6.xyzx
dp3 r7.z, -r6.xyzx, r1.xyzx
add r7.z, r7.z, r7.z
mad r12.xyz, r1.xyzx, -r7.zzzz, -r6.xyzx
mul r7.z, r5.y, l(17.000000)
exp r7.z, r7.z
add r7.z, r7.z, l(2.000000)
...
mad r9.w, r5.x, r8.z, r8.w
mul r8.zw, r8.zzzw, r9.wwww
dp3 r9.w, r1.xyzx, cb2[17].xyzx
mov_sat r10.y, r9.w
...
if_z r10.z
  ...
  add r10.z, r11.w, -cb2[17].w
  mad r10.z, -r10.z, l(0.00006104), l(1.000000)
  mov_sat r13.x, r10.z
  eq r13.x, r10.z, r13.x
  if_nz r13.x
    mov r13.xy, l(0,0,0,0)
    loop 
      ge r13.z, r13.x, l(3.000000)
      breakc_nz r13.z
      ftou r13.z, r13.x
      add r14.xy, r11.yzyy, -cb2[r13.z + 20].xyxx
      max r13.w, |r14.y|, |r14.x|
      mul r13.y, r13.w, cb2[r13.z + 20].z
      lt r13.z, r13.y, l(1.000000)
      if_nz r13.z
        break 
      endif 
  ...
  if_nz r13.z
    ...
    rcp r15.xz, r14.xxxx
    mov r15.y, -r15.z
    mad r14.xyz, r11.yzyy, r15.xyzx, r14.yzyy
    ...
    if_z r15.x
      ...
      if_z r13.w
        ...
        mad r14.y, r11.y, r14.z, r14.y
        mad r14.x, r11.z, r14.x, r14.y
        movc r15.y, r13.w, r14.x, r15.y
      endif 
    endif 
    mad r11.w, -cb2[27].z, l(2.000000), r11.w
    lt r11.w, r15.y, r11.w
    movc r10.w, r11.w, l(0), l(1.000000)
  endif 
  if_z r13.z
    if_z cb2[58].y
      ftou r11.w, r13.x
      add r13.zw, r11.yyyz, -cb2[r11.w + 20].xxxy
      ...
      itof r11.w, cb2[26].y
      add r14.z, r11.w, r13.x
      sample_c_lz_indexable(texture2darray)(float,float,float,float) r11.w, r14.xyzx, t13.xxxx, s13, r10.z
      ...
      mul r10.w, r11.w, r13.z
    endif 
    if_nz cb2[58].y
      mov r14.x, -r8.x
      ftou r11.w, r13.x
      add r13.x, r13.x, l(1.000000)
      min r13.x, r13.x, l(2.000000)
      add r13.y, -r13.y, l(1.000000)
      mul r13.y, r13.y, l(28.000000)
      ftou r13.xy, r13.xyxx
      add r13.zw, r11.yyyz, -cb2[r11.w + 20].xxxy
      mul r13.zw, r13.zzzw, cb2[r11.w + 20].zzzz
      mad r13.zw, r13.zzzw, l(0.000000, 0.000000, 0.500000, -0.500000), l(0.000000, 0.000000, 0.500000, 0.500000)
      add r11.yz, r11.yyzy, -cb2[r13.x + 20].xxyx
      mul r11.yz, r11.yyzy, cb2[r13.x + 20].zzzz
      ...
      loop 
        uge r15.y, r15.x, l(8)
        breakc_nz r15.y
        ult r15.y, r13.y, r15.x
        movc r15.zw, r15.yyyy, r11.yyyz, r13.zzzw
        movc r16.x, r15.y, cb2[r13.x + 20].w, cb2[r11.w + 20].w
        movc r15.y, r15.y, r13.x, r11.w
        ...
        utof r16.z, r15.y
        sample_c_lz_indexable(texture2darray)(float,float,float,float) r15.y, r16.xyzx, t13.xxxx, s13, r10.z
...
if_nz r10.z
  ...
  if_nz r10.z
    mul r10.z, r7.z, cb2[18].w
    mul r10.z, r10.y, r10.z
    if_nz cb2[23].x
      add r13.xyz, v7.xyzx, cb1[24].xyzx
      mov r13.w, l(1.000000)
      dp4 r11.y, cb2[24].xyzw, r13.xyzw
      dp4 r11.z, cb2[25].xyzw, r13.xyzw
      frc r13.xy, r11.yzyy
    ...
    ushr r13.x, cb2[53].x, l(16)
    ult r13.y, l(0), r13.x
    and r13.y, r6.w, r13.y
    if_nz r13.y
      iadd r13.x, r13.x, cb2[0].x
      ...
      mad r18.xyz, r1.xyzx, r13.zzzz, v7.xyzx
      ...
      if_z r14.x
        ...
        dp4 r13.x, r15.xyzw, r18.xyzw
        mov_sat r13.zw, r13.zzzw
        mad r15.xy, r13.zwzz, r16.xzxx, r16.ywyy
        add r13.x, r14.y, r13.x
        div r13.x, r13.x, r14.z
        max r13.x, r13.x, l(0.00006104)
        and r13.z, r14.x, l(0x0000ffff)
        if_nz cb2[58].y
          mov r14.x, -r8.x
          utof r16.z, r13.z
          mov r14.y, r9.x
          ...
          loop 
            ...
            mad r16.xy, r17.xyxx, r13.yyyy, r15.xyxx
            sample_c_lz_indexable(texture2darray)(float,float,float,float) r15.w, r16.xyzx, t9.xxxx, s13, r13.x
            mad r13.w, r15.w, l(0.125000), r13.w
            iadd r14.w, r14.w, l(1)
          endloop 
        else 
          utof r15.z, r13.z
          sample_c_lz_indexable(texture2darray)(float,float,float,float) r13.w, r15.xyzx, t9.xxxx, s13, r13.x
        endif 
      ...
      and r13.x, cb2[53].x, l(0x0000ffff)
      ult r13.y, l(0), r13.x
      not r13.z, r6.w
    ...
    mad r13.x, -r5.x, l(0.500000), l(1.000000)
    mad r13.x, -r10.y, r13.x, l(1.000000)
    mul r13.x, r13.x, r13.x
    mad r13.x, -r13.x, l(0.620000), l(0.620000)
    add r13.x, -r10.y, r13.x
    mad r13.x, r7.w, r13.x, r10.y
    mul r13.x, r10.w, r13.x
    mul r13.xyz, r11.yzwy, r13.xxxx
    lt r9.w, l(0.000000), r9.w
    mad r14.xyz, -v7.xyzx, r4.wwww, cb2[17].xyzx
    dp3 r4.w, r14.xyzx, r14.xyzx
    rsq r4.w, r4.w
    mul r14.xyz, r4.wwww, r14.xyzx
    dp3 r4.w, r14.xyzx, r6.xyzx
    dp3 r14.x, r1.xyzx, r14.xyzx
    mad r14.y, |r14.x|, r7.z, -|r14.x|
    mad r14.x, |r14.x|, r14.y, l(1.000000)
    mad r10.y, r10.y, r8.z, r8.w
    ...
    mul r14.xyz, r11.yzwy, r10.yyyy
    add_sat r4.w, -r4.w, l(1.000000)
    mul r10.z, r4.w, r4.w
    mul r10.z, r10.z, r10.z
    mul r4.w, r4.w, r10.z
    mul r4.w, r4.w, r10.y
    mul r15.xyz, r11.zwyz, r4.wwww
    mov r13.w, r15.z
    and r13.xyzw, r9.wwww, r13.xyzw
    mov r15.zw, r14.xxxy
...
mul r9.w, r5.w, l(0.00781250)
min r9.w, r9.w, l(15.000000)
ftou r9.w, r9.w
ushr r14.xy, r7.xyxx, l(6, 6, 0, 0)
ishl r14.z, r9.w, l(4)
mov r16.x, -r8.x
not r7.x, r6.w
mad r7.y, -r5.x, l(0.500000), l(1.000000)
...
mov r11.y, l(0)
loop 
  uge r11.z, r11.y, cb2[0].x
  breakc_nz r11.z
  ushr r17.z, r11.y, l(5)
  iadd r18.xyz, r14.xyzx, r17.xyzx
  ld_indexable(texture2darray)(uint,uint,uint,uint) r11.z, r18.xyzw, t6.yzxw
  mov r18.xyz, r10.yzwy
  ...
  loop 
    ...
    and r22.w, r14.w, r17.w
    if_nz r22.w
      xor r14.w, r14.w, r17.w
      iadd r17.z, r11.y, r17.z
      ...
      and r17.w, r33.y, r33.x
      and r17.w, r33.z, r17.w
      if_nz r17.w
        ...
        ubfe r17.w, l(3), l(24), r34.w
        switch r17.w
          case l(4)
          lt r17.w, l(0.000000), r39.x
          mov r40.xy, r38.zwzz
          mov r40.z, r39.w
          mad r41.xyz, -r40.xyzx, l(0.500000, 0.500000, 0.500000, 0.000000), r33.yzwy
          add r42.xyz, r41.xyzx, -v7.xyzx
          dp3 r22.w, r40.xyzx, r42.xyzx
          div_sat r26.w, -r22.w, r39.x
          mad r43.xyz, r26.wwww, r40.xyzx, r41.xyzx
          movc r43.xyz, r17.wwww, r43.xyzx, r33.yzwy
          add r43.xyz, r43.xyzx, -v7.xyzx
          dp3 r27.w, r43.xyzx, r43.xyzx
          rsq r28.w, r27.w
          mul r43.xyz, r28.wwww, r43.xyzx
          dp3 r28.w, r1.xyzx, r43.xyzx
          mov_sat r29.w, r28.w
          lt r30.w, l(0.000000), r29.w
          if_nz r30.w
            sqrt r30.w, r27.w
            mul r31.w, r36.x, r36.x
            div r27.w, r31.w, r27.w
            min r27.w, r27.w, l(1.000000)
            mad_sat r43.xy, r30.wwww, r35.xzxx, r35.ywyy
            ...
            mul r27.w, r27.w, r43.x
            mul r27.w, r43.y, r27.w
            lt r30.w, l(0.000000), r27.w
            if_nz r30.w
              ubfe r30.w, l(3), l(27), r34.w
              ine r30.w, r30.w, l(1)
              if_nz r30.w
                mad r30.w, |r28.w|, l(-0.200000), l(0.400000)
                mad r43.xyz, r1.xyzx, r30.wwww, v7.xyzx
                add r43.xyz, -r37.xyzx, r43.xyzx
                max r30.w, |r43.z|, |r43.y|
                max r30.w, r30.w, |r43.x|
                div r30.w, r38.x, r30.w
                add r30.w, r38.y, r30.w
                dp3 r31.w, r43.xyzx, r43.xyzx
                rsq r31.w, r31.w
                max r30.w, r30.w, l(0.00006104)
                and r32.w, r34.w, l(0x0000ffff)
                utof r44.w, r32.w
                mov r32.w, l(0)
                mov r40.w, l(0)
                loop 
                  ige r41.w, r40.w, l(8)
                  breakc_nz r41.w
                  dp2 r45.y, icb[r40.w + 0].yxyy, r16.xyxx
                  dp2 r45.z, icb[r40.w + 0].yxyy, r16.yzyy
                  mul r45.yz, r36.yyyy, r45.yyzy
                  mul r45.x, r11.x, r45.y
                  mul r45.w, r10.x, r45.y
                  mad r44.xyz, r43.xyzx, r31.wwww, r45.xzwx
                  sample_c_lz_indexable(texturecubearray)(float,float,float,float) r41.w, r44.xyzw, t10.xxxx, s13, r30.w
                  mad r32.w, r41.w, l(0.125000), r32.w
                  iadd r40.w, r40.w, l(1)
                endloop 
              else 
              ...
              lt r30.w, l(0.000000), r27.w
              if_nz r30.w
                mul r30.w, r7.z, r34.x
                mul r30.w, r30.w, l(0.250000)
                dp3 r31.w, r40.xyzx, r12.xyzx
                dp3 r40.w, r12.xyzx, r42.xyzx
                mad r41.w, -r31.w, r31.w, r39.x
                mad r22.w, r31.w, r40.w, -r22.w
                div_sat r22.w, r22.w, r41.w
                div r31.w, r41.w, r39.x
                mul r31.w, r31.w, l(10.000000)
                min r31.w, r31.w, l(1.000000)
                add r22.w, -r26.w, r22.w
                mad r22.w, r31.w, r22.w, r26.w
                mad r40.xyz, r22.wwww, r40.xyzx, r41.xyzx
                movc r40.xyz, r17.wwww, r40.xyzx, r33.yzwy
                add r40.xyz, r40.xyzx, -v7.xyzx
                dp3 r17.w, r40.xyzx, r40.xyzx
                rsq r17.w, r17.w
                mul r41.xyz, r17.wwww, r40.xyzx
                ubfe r22.w, l(4), l(16), r34.w
                ult r26.w, l(0), r22.w
                and r26.w, r6.w, r26.w
                if_nz r26.w
                  ...
                  mad r20.xyz, r1.xyzx, r31.wwww, v7.xyzx
                  dp4 r31.w, r42.xyzw, r20.xyzw
                  dp4 r40.w, r43.xyzw, r20.xyzw
                  lt r41.w, r40.w, r31.w
                  if_z r41.w
                    ...
                    mul r20.x, r40.w, r46.y
                    mad r20.y, r46.x, r40.w, r31.w
                    div r20.x, r20.y, r20.x
                  else 
                    mov r20.z, l(-1)
                  endif 
                  or r20.y, r41.w, r20.z
                  if_z r20.y
                    ...
                    if_nz r11.w
                      ...
                      loop 
                        ige r31.w, r22.w, l(8)
                        breakc_nz r31.w
                        dp2 r44.x, icb[r22.w + 0].yxyy, r16.xwxx
                        dp2 r44.y, icb[r22.w + 0].xyxx, r8.xyxx
                        mad r43.xy, r44.xyxx, r26.wwww, r42.xyxx
                        sample_c_lz_indexable(texture2darray)(float,float,float,float) r31.w, r43.xyzx, t9.xxxx, s13, r20.x
                        mad r20.z, r31.w, l(0.125000), r20.z
                        iadd r22.w, r22.w, l(1)
                      endloop 
                    else 
                      utof r42.z, r20.y
                  ...
                  if_nz r20.y
                    ...
                    mad r22.w, |r28.w|, l(-0.200000), l(0.400000)
                    mad r21.xyz, r1.xyzx, r22.wwww, v7.xyzx
                    dp4 r22.w, r42.xyzw, r21.xyzw
                    dp4 r26.w, r43.xyzw, r21.xyzw
                    lt r31.w, r26.w, r22.w
                    if_z r31.w
                      ...
                      mul r21.x, r26.w, r46.y
                      mad r21.y, r46.x, r26.w, r22.w
                      div r21.x, r21.y, r21.x
                    else 
                      mov r21.z, l(-1)
                    endif 
                    or r21.y, r31.w, r21.z
                    if_z r21.y
                      ...
                      if_nz r11.w
                        ...
                        loop 
                          ige r22.w, r21.z, l(8)
                          breakc_nz r22.w
                          dp2 r44.x, icb[r21.z + 0].xyxx, r9.xyxx
                          dp2 r44.y, icb[r21.z + 0].yxyy, r9.xzxx
                          mad r43.xy, r44.xyxx, r20.yyyy, r42.xyxx
                          sample_c_lz_indexable(texture2darray)(float,float,float,float) r22.w, r43.xyzx, t9.xxxx, s13, r21.x
                          mad r21.y, r22.w, l(0.125000), r21.y
                ...
                mad r20.x, -r29.w, r7.y, l(1.000000)
                mul r20.x, r20.x, r20.x
                mad r20.x, -r20.x, l(0.620000), l(0.620000)
                add r20.x, -r29.w, r20.x
                mad r20.x, r7.w, r20.x, r29.w
                mul r20.x, r27.w, r20.x
                mov r34.x, r33.x
                lt r20.y, l(0.000000), r28.w
                mad r42.xyz, r20.xxxx, r34.xyzx, r18.xyzx
                dp3_sat r20.x, r1.xyzx, r41.xyzx
                mad r40.xyz, r40.xyzx, r17.wwww, r6.xyzx
                dp3 r17.w, r40.xyzx, r40.xyzx
                rsq r17.w, r17.w
                mul r40.xyz, r17.wwww, r40.xyzx
                dp3 r17.w, r40.xyzx, r6.xyzx
                dp3 r21.x, r1.xyzx, r40.xyzx
                mad r21.z, |r21.x|, r7.z, -|r21.x|
                mad r21.x, |r21.x|, r21.z, l(1.000000)
                mad r21.z, r20.x, r8.z, r8.w
                mul r21.x, r21.x, r21.x
                mul r21.x, r21.z, r21.x
                rcp r21.x, r21.x
                mul r20.x, r30.w, r20.x
                ...
                mad r41.xyz, r17.wwww, r34.xyzx, r31.xyzx
          ...
          if_nz r21.x
            ...
            mov r43.w, r42.y
            dp4 r21.x, r43.xyzw, r19.xyzw
            lt r21.z, r21.x, l(1.000000)
            if_nz r21.z
              ...
              mul r26.w, r26.w, r35.x
              mul r26.w, r35.y, r26.w
              mov r37.w, r38.x
              dp4 r35.x, r37.xyzw, r19.xyzw
              mov r48.xyz, r38.yzwy
              mov r48.w, r39.w
              dp4 r35.y, r48.xyzw, r19.xyzw
              div r22.xy, r35.xyxx, r21.xxxx
              lt r21.x, r45.w, l(0.00048828)
              if_nz r21.x
                mov r46.y, r47.x
            ...
            mov r33.yz, r34.yyzy
            mul r22.xyw, r44.xyxz, r33.xyxz
            lt r21.x, l(0.000000), r21.z
            if_nz r21.x
              ubfe r21.x, l(3), l(27), r34.w
              ine r21.x, r21.x, l(1)
              if_nz r21.x
                mad r21.x, |r20.x|, l(-0.200000), l(0.400000)
                mad r23.xyz, r1.xyzx, r21.xxxx, v7.xyzx
                mov r41.xyz, r39.xyzx
                dp4 r21.x, r41.xyzw, r23.xyzw
                dp4 r26.w, r43.xyzw, r23.xyzw
                ge r27.w, r26.w, r21.x
                if_nz r27.w
                  ...
                  div r17.z, r21.x, r26.w
                  max r17.z, r17.z, l(0.00006104)
                  and r21.x, r34.w, l(0x0000ffff)
                  if_nz r11.w
                    utof r33.z, r21.x
                    mov r26.w, l(0)
                    mov r27.w, l(0)
                    loop 
                      ige r28.w, r27.w, l(8)
                      breakc_nz r28.w
                      dp2 r35.x, icb[r27.w + 0].xyxx, r26.xyxx
                      dp2 r35.y, icb[r27.w + 0].yxyy, r26.xzxx
                      mad r33.xy, r35.xyxx, r36.yyyy, r23.xyxx
                      sample_c_lz_indexable(texture2darray)(float,float,float,float) r28.w, r33.xyzx, t9.xxxx, s13, r17.z
                      mad r26.w, r28.w, l(0.125000), r26.w
                      iadd r27.w, r27.w, l(1)
                    endloop 
                  else 
                    utof r23.z, r21.x
                    sample_c_lz_indexable(texture2darray)(float,float,float,float) r26.w, r23.xyzx, t9.xxxx, s13, r17.z
                  endif 
                  mul r17.z, r26.w, r26.w
                  mul r17.z, r26.w, r17.z
                else 
              ...
              lt r21.x, l(0.000000), r17.z
              if_nz r21.x
                mul r21.x, r7.z, r34.x
                mul r21.x, r20.y, r21.x
                ubfe r21.z, l(4), l(16), r34.w
                ult r23.x, l(0), r21.z
                ...
                if_nz r23.x
                  ...
                  mad r24.xyz, r1.xyzx, r23.yyyy, v7.xyzx
                  dp4 r33.x, r33.xyzw, r24.xyzw
                  dp4 r33.y, r35.xyzw, r24.xyzw
                  dp4 r23.y, r36.xyzw, r24.xyzw
                  dp4 r23.z, r37.xyzw, r24.xyzw
                  lt r24.x, r23.z, r23.y
                  div r24.yz, r33.xxyx, r23.zzzz
                  mad r24.yz, r24.yyzy, l(0.000000, 0.500000, -0.500000, 0.000000), l(0.000000, 0.500000, 0.500000, 0.000000)
                  add r24.yz, r39.zzwz, r24.yyzy
                  mul r24.yz, r39.xxyx, r24.yyzy
                  div r33.xy, r23.xxxx, r38.xzxx
                  add r33.zw, -r33.xxxy, l(0.000000, 0.000000, 1.000000, 1.000000)
                  ge r33.zw, r24.yyyz, r33.zzzw
                  ge r33.xy, r33.xyxx, r24.yzyy
                  or r33.xy, r33.xyxx, r33.zwzz
                  or r27.w, r33.y, r33.x
                  or r24.x, r24.x, r27.w
                  if_z r24.x
                    ...
                    mad r34.xy, r24.yzyy, r38.xzxx, r38.ywyy
                    mul r21.z, r23.z, r33.y
                    mad r23.y, r33.x, r23.z, r23.y
                    div r21.z, r23.y, r21.z
                    max r21.z, r21.z, l(0.00006104)
                    and r23.y, r24.x, l(0x0000ffff)
                    if_nz r11.w
                      utof r24.z, r23.y
                      mov r23.z, l(0)
                      mov r27.w, l(0)
                      loop 
                        ige r28.w, r27.w, l(8)
                        breakc_nz r28.w
                        dp2 r33.x, icb[r27.w + 0].xyxx, r27.xyxx
                        dp2 r33.y, icb[r27.w + 0].yxyy, r27.xzxx
                        mad r24.xy, r33.xyxx, r23.xxxx, r34.xyxx
                        sample_c_lz_indexable(texture2darray)(float,float,float,float) r24.x, r24.xyzx, t9.xxxx, s13, r21.z
                        mad r23.z, r24.x, l(0.125000), r23.z
                        iadd r27.w, r27.w, l(1)
                      endloop 
                    else 
                      utof r34.z, r23.y
                      sample_c_lz_indexable(texture2darray)(float,float,float,float) r23.z, r34.xyzx, t9.xxxx, s13, r21.z
                    endif 
                    mul r21.z, r23.z, r23.z
                    mul r21.z, r23.z, r21.z
                  else 
                    mov r21.z, l(1.000000)
                  endif 
                  mul r17.z, r17.z, r21.z
                else 
                  ubfe r21.z, l(4), l(20), r34.w
                  ult r23.x, l(0), r21.z
                  and r23.x, r7.x, r23.x
                  if_nz r23.x
                    iadd r21.z, r21.z, cb2[0].x
                    iadd r21.z, r21.z, l(-1)
                    ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r23.x, r21.z, l(52), t12.xxxx
                    ...
                    mad r23.y, |r20.x|, l(-0.200000), l(0.400000)
                    mad r25.xyz, r1.xyzx, r23.yyyy, v7.xyzx
                    dp4 r24.x, r33.xyzw, r25.xyzw
                    dp4 r24.y, r34.xyzw, r25.xyzw
                    dp4 r23.y, r35.xyzw, r25.xyzw
                    dp4 r24.z, r36.xyzw, r25.xyzw
                    lt r25.x, r24.z, r23.y
                    ...
                    if_z r25.x
                      ...
                      mul r21.z, r24.z, r25.z
                      mad r23.y, r25.y, r24.z, r23.y
                      div r21.z, r23.y, r21.z
                      max r21.z, r21.z, l(0.00006104)
                      and r23.y, r25.x, l(0x0000ffff)
                      if_nz r11.w
                        utof r24.z, r23.y
                        ...
                        loop 
                          ...
                          mad r24.xy, r34.xyxx, r23.xxxx, r33.xyxx
                          sample_c_lz_indexable(texture2darray)(float,float,float,float) r24.x, r24.xyzx, t9.xxxx, s13, r21.z
                        ...
                        utof r33.z, r23.y
                        sample_c_lz_indexable(texture2darray)(float,float,float,float) r25.x, r33.xyzx, t9.xxxx, s13, r21.z
                      endif 
                      mul r21.z, r25.x, r25.x
                      mul r21.z, r25.x, r21.z
                    else 
                      mov r21.z, l(1.000000)
                    endif 
                    mul r17.z, r17.z, r21.z
                ...
                mad r21.z, -r20.y, r7.y, l(1.000000)
                mul r21.z, r21.z, r21.z
                mad r21.z, -r21.z, l(0.620000), l(0.620000)
                add r21.z, -r20.y, r21.z
                mad r21.z, r7.w, r21.z, r20.y
                mul r21.z, r17.z, r21.z
                lt r20.x, l(0.000000), r20.x
                mad r24.xyz, r21.zzzz, r22.xywx, r18.xyzx
                mad r33.xyz, r40.xyzx, r17.wwww, r6.xyzx
                dp3 r17.w, r33.xyzx, r33.xyzx
                rsq r17.w, r17.w
                mul r33.xyz, r17.wwww, r33.xyzx
                dp3 r17.w, r33.xyzx, r6.xyzx
                dp3 r21.z, r1.xyzx, r33.xyzx
                mad r23.x, |r21.z|, r7.z, -|r21.z|
                mad r21.z, |r21.z|, r23.x, l(1.000000)
                mad r20.y, r20.y, r8.z, r8.w
                mul r21.z, r21.z, r21.z
                mul r20.y, r20.y, r21.z
                rcp r20.y, r20.y
                mul r20.y, r21.x, r20.y
                mul r17.z, r17.z, r20.y
                mul r17.z, r17.z, l(0.250000)
                mad r33.xyz, r17.zzzz, r22.xywx, r32.xyzx
                add_sat r17.w, -r17.w, l(1.000000)
                mul r20.y, r17.w, r17.w
                mul r20.y, r20.y, r20.y
                mul r17.w, r17.w, r20.y
                mul r17.z, r17.w, r17.z
                mad r22.xyw, r17.zzzz, r22.xyxw, r31.xyxz
                movc r18.xyz, r20.xxxx, r24.xyzx, r18.xyzx
                movc r31.xyz, r20.xxxx, r22.xywx, r31.xyzx
                movc r32.xyz, r20.xxxx, r33.xyzx, r32.xyzx
              endif 
            endif 
          endif 
          break 
...
mul r6.x, r4.w, l(5.000000)
mad r6.y, r4.w, l(5.000000), l(-2.500000)
mul_sat r6.y, r6.y, l(0.400000)
mul r6.y, r6.y, l(100.000000)
mad r6.zw, -r4.wwww, l(0.000000, 0.000000, 10.000000, 5.000000), l(0.000000, 0.000000, 6.857410, 7.085000)
exp r6.z, r6.z
mul r6.z, r5.x, r6.z
mul r7.x, r4.w, r6.x
mad r6.w, -r7.x, l(2.015905), r6.w
exp r6.w, r6.w
mul r6.w, r5.x, r6.w
...
loop 
  ...
  add r34.xyz, -r19.yzwy, v7.xyzx
  dp3 r8.z, r34.xyzx, r34.xyzx
  sqrt r8.z, r8.z
  ge r8.z, cb2[54].y, r8.z
  and r9.w, r25.y, l(0x0000ffff)
  ...
  dp3 r10.x, r35.xyzx, r34.xyzx
  add_sat r10.x, r35.w, r10.x
  dp3 r11.w, r36.xyzx, r34.xyzx
  add_sat r11.w, r36.w, r11.w
  mul r10.x, r10.x, r11.w
  dp3 r11.w, r37.xyzx, r34.xyzx
  add_sat r11.w, r37.w, r11.w
  mul r10.x, r10.x, r11.w
  dp3 r11.w, r38.xyzx, r34.xyzx
  add_sat r11.w, r38.w, r11.w
  mul r10.x, r10.x, r11.w
  dp3 r11.w, r39.xyzx, r34.xyzx
  add_sat r11.w, r39.w, r11.w
  mul r10.x, r10.x, r11.w
  dp3 r11.w, r40.xyzx, r34.xyzx
  add_sat r11.w, r40.w, r11.w
  mul r9.x, r10.x, r11.w
  and r10.x, r8.x, l(1)
  movc r16.zw, r10.xxxx, r9.xxxy, r9.zzzx
  mov r35.xy, r25.zwzz
  mov r35.z, r26.z
  dp3 r9.x, r12.xyzx, r35.xyzx
  dp3 r10.x, r34.xyzx, r35.xyzx
  add r10.x, -r26.w, r10.x
  ge r11.w, r10.x, l(0.000000)
  max r10.x, r6.y, |r10.x|
  movc r10.x, r11.w, r10.x, -r10.x
  max r9.x, -r9.x, l(0.00000010)
  div r9.x, r10.x, r9.x
  min r9.x, |r9.x|, l(131072.000000)
  mov r26.z, r27.z
  dp3 r10.x, r12.xyzx, r26.xyzx
  dp3 r11.w, r34.xyzx, r26.xyzx
  add r11.w, -r27.w, r11.w
  ge r13.w, r11.w, l(0.000000)
  max r11.w, r6.y, |r11.w|
  movc r11.w, r13.w, r11.w, -r11.w
  max r10.x, -r10.x, l(0.00000010)
  div r10.x, r11.w, r10.x
  min r9.x, r9.x, |r10.x|
  mov r27.z, r28.z
  dp3 r10.x, r12.xyzx, r27.xyzx
  ...
  min r9.x, r9.x, |r10.x|
  mov r28.z, r31.z
  dp3 r10.x, r12.xyzx, r28.xyzx
  dp3 r11.w, r34.xyzx, r28.xyzx
  add r11.w, -r31.w, r11.w
  ge r13.w, r11.w, l(0.000000)
  max r11.w, r6.y, |r11.w|
  movc r11.w, r13.w, r11.w, -r11.w
  max r10.x, -r10.x, l(0.00000010)
  ...
  min r9.x, r9.x, |r10.x|
  mov r31.z, r32.x
  dp3 r10.x, r12.xyzx, r31.xyzx
  dp3 r11.w, r34.xyzx, r31.xyzx
  add r11.w, -r32.y, r11.w
  ge r13.w, r11.w, l(0.000000)
  max r11.w, r6.y, |r11.w|
  movc r11.w, r13.w, r11.w, -r11.w
  max r10.x, -r10.x, l(0.00000010)
  ...
  min r9.x, r9.x, |r10.x|
  mov r33.zw, r32.zzzw
  dp3 r10.x, r12.zxyz, r33.xzwx
  dp3 r11.w, r34.zxyz, r33.xzwx
  ...
  mov r26.x, r22.w
  mov r26.yz, r23.zzwz
  add r26.xyz, r34.xyzx, r26.xyzx
  mad r26.xyz, r12.xyzx, r9.xxxx, r26.xyzx
  dp3 r10.x, r26.xyzx, r26.xyzx
  sqrt r10.x, r10.x
  div r9.x, r9.x, r10.x
  add r9.x, r9.x, r9.x
  sqrt r9.x, r9.x
  mad r9.x, r4.w, l(5.000000), r9.x
  ...
  utof r27.w, r20.y
  sample_l_indexable(texturecubearray)(float,float,float,float) r20.yzw, r27.xyzw, t8.wxyz, s2, r9.x
  and r25.yzw, r20.yyzw, l(0, 0x7fffffff, 0x7fffffff, 0x7fffffff)
  ieq r25.yzw, r25.yyzw, l(0, 0x7f800000, 0x7f800000, 0x7f800000)
  or r9.x, r25.z, r25.y
  or r9.x, r25.w, r9.x
  movc r20.yzw, r9.xxxx, l(0,1.000000,1.000000,0), r20.yyzw
  dp3 r26.x, r34.xyzx, r19.xyzx
  dp3 r26.y, r34.xyzx, r28.xyzx
  dp3 r26.z, r34.xyzx, r21.xyzx
  ...
  movc r11.z, r19.x, l(0), l(0.500000)
  ...
  loop 
    breakc_z r10.x
    firstbit_lo r11.z, r10.x
    ishl r11.z, l(1), r11.z
    and r11.w, r10.x, r11.z
    if_nz r11.w
      not r11.z, r11.z
      ...
      if_nz r8.z
        ...
        mov r11.w, l(1)
        loop 
          ige r13.z, r11.w, r20.x
          breakc_nz r13.z
          iadd r13.z, r9.w, r11.w
          ...
          add_sat r13.z, r28.w, r13.z
          mul r13.z, r13.z, r27.x
          dp3 r13.w, r31.xyzx, r34.xyzx
          add_sat r13.w, r31.w, r13.w
          mul r13.z, r13.w, r13.z
          dp3 r13.w, r32.xyzx, r34.xyzx
          add_sat r13.w, r32.w, r13.w
          mul r13.z, r13.w, r13.z
          dp3 r13.w, r33.xyzx, r34.xyzx
          add_sat r13.w, r33.w, r13.w
          mul r13.z, r13.w, r13.z
          dp3 r13.w, r35.xyzx, r34.xyzx
          add_sat r13.w, r35.w, r13.w
          mul r13.z, r13.w, r13.z
          dp3 r13.w, r36.xyzx, r34.xyzx
          add_sat r13.w, r36.w, r13.w
          mul r27.x, r13.w, r13.z
          ushr r14.w, r11.z, l(2)
          ubfe r15.z, l(1), l(2), r11.z
          and r15.w, r14.w, l(2)
          max r19.z, r27.x, r27.y
          mad r13.z, -r13.z, r13.w, l(1.000000)
          mul r13.z, r13.z, r27.y
          movc r16.y, r15.w, r13.z, r19.z
          movc r27.xy, r15.zzzz, r27.xyxx, r16.xyxx
          iadd r11.w, r11.w, l(1)
          mov r11.z, r14.w
        endloop 
        mov_sat r27.y, r27.y
        mul r11.z, r8.y, r27.y
        lt r11.w, l(0.000000), r11.z
        if_nz r11.w
          mad r28.z, r27.y, r8.y, r25.w
          mul r11.z, r25.x, r11.z
          mul r27.xzw, r11.zzzz, r23.xxyz
          mul r31.xyz, r19.xywx, r27.zzzz
          mad r31.xyz, r21.xyzx, r27.xxxx, r31.xyzx
          mad r27.xzw, r22.xxyz, r27.wwww, r31.xxyz
          mul r31.xyz, r24.xyzx, r27.xzwx
          dp3 r11.w, r31.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
          mad r31.xyz, r27.xzwx, r24.xyzx, r26.xyzx
          mul r13.z, r6.z, r11.w
          mul r27.xzw, r11.zzzz, r20.yyzw
          dp3 r11.z, r27.xzwx, l(0.212600, 0.715200, 0.072200, 0.000000)
          mad r11.z, r6.z, r11.w, r11.z
          div r11.z, r13.z, r11.z
          mov r32.x, r26.w
          mov r32.yz, r25.yyzy
          mad r28.xyw, r27.zwzx, r11.zzzz, r32.yzyx
          mov r31.w, r28.w
        else 
          mov r31.xyzw, r26.xyzw
          mov r28.xyz, r25.yzwy
        endif 
        mov r9.x, l(-1)
        mov r26.xyzw, r31.xyzw
...
if_z r6.w
  ...
  mov r8.w, r7.x
  loop 
    uge r10.x, r8.w, cb2[0].y
    breakc_nz r10.x
    ushr r8.z, r8.w, l(5)
    iadd r9.xyz, r8.xyzx, r14.xyzx
    ld_indexable(texture2darray)(uint,uint,uint,uint) r8.z, r9.xyzw, t7.yzxw
    ieq r9.x, r7.x, r8.w
    bfi r9.y, r7.y, l(0), l(0), r8.z
    ...
    loop 
      ...
      if_nz r11.w
        ...
        and r10.x, r24.y, r24.x
        and r10.x, r24.z, r10.x
        if_nz r10.x
          iadd r9.z, r8.w, r9.z
          ...
          and r13.w, r15.z, l(1)
          movc r27.xy, r13.wwww, r11.xyxx, r11.zxzz
          mov r11.x, r15.z
          mov r28.xy, r27.xyxx
          mov r13.w, l(1)
          loop 
            ...
            mul r14.w, r14.w, r16.w
            dp3 r16.w, r35.xyzx, r26.xyzx
            add_sat r16.w, r35.w, r16.w
            mul r14.w, r14.w, r16.w
            dp3 r16.w, r36.xyzx, r26.xyzx
            add_sat r16.w, r36.w, r16.w
            mul r28.x, r14.w, r16.w
            ushr r19.w, r11.x, l(2)
            ubfe r24.w, l(1), l(2), r11.x
            and r26.w, r19.w, l(2)
            max r27.z, r28.x, r28.y
            mad r14.w, -r14.w, r16.w, l(1.000000)
            mul r14.w, r14.w, r28.y
            movc r15.y, r26.w, r14.w, r27.z
            movc r28.xy, r24.wwww, r28.xyxx, r15.xyxx
            iadd r13.w, r13.w, l(1)
            mov r11.x, r19.w
          endloop 
          mov_sat r28.y, r28.y
          mul r10.x, r15.w, r28.y
          lt r11.x, l(0.000000), r10.x
          if_nz r11.x
            ...
            min r10.x, r10.x, |r11.x|
            mov r36.z, r37.z
            dp3 r11.x, r12.xyzx, r36.xyzx
            dp3 r11.w, r26.xyzx, r36.xyzx
            ...
            dp3 r11.w, r26.xyzx, r37.xyzx
            add r11.w, -r38.w, r11.w
            ge r13.w, r11.w, l(0.000000)
            max r11.w, r6.y, |r11.w|
            movc r11.w, r13.w, r11.w, -r11.w
            max r11.x, -r11.x, l(0.00000010)
            ...
            mad r15.yzw, r12.xxyz, r10.xxxx, r15.yyzw
            dp3 r11.x, r15.yzwy, r15.yzwy
            sqrt r11.x, r11.x
            div r10.x, r10.x, r11.x
            add r10.x, r10.x, r10.x
            sqrt r10.x, r10.x
            mad r10.x, r4.w, l(5.000000), r10.x
            add r10.x, r10.x, l(-0.844800)
            mov r24.y, r27.z
            mov r24.z, r31.x
            dp3 r35.x, r15.yzwy, r24.xyzx
            mov r25.xy, r27.xwxx
            mov r25.z, r31.w
            dp3 r35.y, r15.yzwy, r25.xyzx
            mov r31.x, r27.y
            dp3 r35.z, r15.yzwy, r31.xyzx
            ubfe r11.x, l(9), l(16), r25.w
            utof r35.w, r11.x
            sample_l_indexable(texturecubearray)(float,float,float,float) r15.yzw, r35.xyzw, t8.wxyz, s2, r10.x
            and r27.xyz, r15.yzwy, l(0x7fffffff, 0x7fffffff, 0x7fffffff, 0)
            ieq r27.xyz, r27.xyzx, l(0x7f800000, 0x7f800000, 0x7f800000, 0)
            or r10.x, r27.y, r27.x
            or r10.x, r27.z, r10.x
            movc r15.yzw, r10.xxxx, l(0,1.000000,1.000000,0), r15.yyzw
            ...
            dp3 r35.x, r1.xyzx, r24.xyzx
            dp3 r35.y, r1.xyzx, r25.xyzx
            ...
            mul r11.x, r6.z, r10.x
            mul r15.yzw, r9.zzzz, r15.yyzw
            dp3 r9.z, r15.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
            mad r9.z, r6.z, r10.x, r9.z
            div r9.z, r11.x, r9.z
            mov r24.x, r22.w
            mov r24.yz, r23.xxyx
            mad r23.xyw, r15.zwzy, r9.zzzz, r24.yzyx
            mov r22.w, r23.w
          endif 
        endif 
      endif 
  ...
  if_nz r7.z
    ...
    loop 
      ...
      ld_indexable(texture2darray)(uint,uint,uint,uint) r8.z, r9.xyzw, t7.yzxw
      ieq r8.w, r7.x, r7.w
      ubfe r9.x, r7.y, l(0), r8.z
      movc r8.z, r8.w, r9.x, r8.z
      ...
      loop 
        ...
        if_nz r15.z
          ...
          if_nz r14.w
            ...
            mul r11.x, r18.w, r19.w
            and r18.w, r15.z, l(1)
            movc r28.xy, r18.wwww, r11.xyxx, r11.zxzz
            mov r11.x, r15.z
            mov r31.xy, r28.xyxx
            mov r18.w, l(1)
            loop 
              ...
              dp3 r23.w, r34.xyzx, r27.xyzx
              add_sat r23.w, r34.w, r23.w
              mul r19.w, r19.w, r23.w
              dp3 r23.w, r35.xyzx, r27.xyzx
              add_sat r23.w, r35.w, r23.w
              mul r19.w, r19.w, r23.w
              dp3 r23.w, r36.xyzx, r27.xyzx
              add_sat r23.w, r36.w, r23.w
              mul r19.w, r19.w, r23.w
              dp3 r23.w, r37.xyzx, r27.xyzx
              add_sat r23.w, r37.w, r23.w
              mul r31.x, r19.w, r23.w
              ushr r25.w, r11.x, l(2)
              ubfe r27.w, l(1), l(2), r11.x
              and r28.z, r25.w, l(2)
              max r28.w, r31.x, r31.y
              mad r19.w, -r19.w, r23.w, l(1.000000)
              mul r19.w, r19.w, r31.y
              movc r15.y, r28.z, r19.w, r28.w
              movc r31.xy, r27.wwww, r31.xyxx, r15.xyxx
              iadd r18.w, r18.w, l(1)
              mov r11.x, r25.w
            endloop 
            add_sat r11.x, -r10.x, r31.y
            mul r14.w, r15.w, r11.x
            ...
            if_nz r15.y
              ...
              mad r15.yzw, r12.xxyz, r13.wwww, r15.yyzw
              ...
              utof r36.w, r14.w
              sample_l_indexable(texturecubearray)(float,float,float,float) r15.yzw, r36.xyzw, t8.wxyz, s2, r13.w
              ...
              dp3 r28.z, r27.xyzx, r32.xyzx
              mad_sat r27.xyz, r28.xyzx, r33.xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
              mov r34.z, r35.x
              mad r27.xyz, r27.xyzx, r34.xyzx, r35.yzwy
              dp3 r36.x, r1.xyzx, r25.xyzx
              dp3 r36.y, r1.xyzx, r26.xyzx
              dp3 r36.z, r1.xyzx, r32.xyzx
              lt r25.xyz, l(0.000000, 0.000000, 0.000000, 0.000000), r36.xyzx
              movc r13.z, r25.x, l(0), l(0.500000)
              add r26.xyz, r13.xyzx, r27.xyzx
              sample_l_indexable(texture3d)(float,float,float,float) r26.xyz, r26.xyzx, t17.xyzw, s4, l(0.000000)
              mul r28.xyz, r36.xyzx, r36.xyzx
              ...
              mad r9.xyz, r25.xyzx, r26.xyzx, r9.xyzx
              mul r13.w, r6.z, r13.z
              mul r15.yzw, r11.xxxx, r15.yyzw
              dp3 r11.x, r15.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
              mad r11.x, r6.z, r13.z, r11.x
              div r11.x, r13.w, r11.x
              mad r24.xyz, r15.yzwy, r11.xxxx, r24.xyzx
            endif 
          endif 
        endif 
      endloop 
  ...
  rcp r4.w, r4.w
  mov_sat r21.w, r21.w
  mul r17.xyz, r4.wwww, r20.xyzx
  mul r18.xyz, r4.wwww, r21.xyzx
  lt r6.y, r21.w, l(0.990000)
  if_nz r6.y
    add r6.y, -r21.w, l(1.000000)
    mul r6.z, r6.y, cb2[19].x
    add r7.xyz, v7.xyzx, -cb2[35].xyzx
    mul r8.x, r7.x, cb2[35].w
    mul r8.yz, r7.yyzy, cb2[36].xxyx
    add_sat r7.xyz, r8.xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
    mul r8.xy, r7.xyxx, cb2[36].zwzz
    mul r8.z, r7.z, cb2[37].x
    add r7.xyz, r8.xyzx, cb2[37].yzwy
    lt r8.xyz, l(0.000000, 0.000000, 0.000000, 0.000000), r1.xyzx
    movc r8.xyz, r8.xyzx, l(0,0,0,0), l(0.500000,0.500000,0.500000,0)
    mov r8.w, l(0)
    add r9.xyz, r7.xyzx, r8.wwxw
    ...
    add r13.xyz, r7.xyzx, r8.wwyw
    sample_l_indexable(texture3d)(float,float,float,float) r13.xyz, r13.xyzx, t18.xyzw, s4, l(0.000000)
    mul r13.xyz, r11.yyyy, r13.xyzx
    mad r9.xyz, r9.xyzx, r11.xxxx, r13.xyzx
    add r7.xyz, r7.xyzx, r8.wwzw
    sample_l_indexable(texture3d)(float,float,float,float) r7.xyz, r7.xyzx, t19.xyzw, s4, l(0.000000)
    mad r7.xyz, r7.xyzx, r11.zzzz, r9.xyzx
    mov r1.w, l(0)
    sample_l_indexable(texturecubearray)(float,float,float,float) r8.xyz, r1.xyzw, t8.xyzw, s2, l(6.000000)
    mul r7.xyz, r7.xyzx, r8.xyzx
    dp3 r1.z, r7.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
    mad r17.xyz, r20.xyzx, r4.wwww, r7.xyzx
    mov r12.w, l(0)
    sample_l_indexable(texturecubearray)(float,float,float,float) r6.xzw, r12.xyzw, t8.xwyz, s2, r6.x
    mad r1.w, cb2[19].x, r6.y, -r1.z
    mad r1.z, r5.y, r1.w, r1.z
    mad r18.xyz, r6.xzwx, r1.zzzz, r18.xyzx
  endif 
else 
  mov r18.x, r17.w
endif 
mad r6.xyz, r17.xyzx, r0.wwww, r10.yzwy
mad r1.zw, r5.xxxy, l(0.000000, 0.000000, 0.984375, 0.984375), l(0.000000, 0.000000, 0.00781250, 0.00781250)
sample_l_indexable(texture2d)(float,float,float,float) r1.zw, r1.zwzz, t5.zwxy, s2, l(0.000000)
mul r7.xyz, r0.wwww, r18.xyzx
mad r8.xyz, r7.xyzx, r1.zzzz, r29.xyzx
mad r7.xyz, r7.xyzx, r1.wwww, r30.xyzx
add r9.xyz, -r4.xyzx, l(1.000000, 1.000000, 1.000000, 0.000000)
mul r8.xyz, r8.xyzx, r9.xyzx
mad r4.xyz, r7.xyzx, r4.xyzx, r8.xyzx
mad r0.xyz, r6.xyzx, r0.xyzx, r4.xyzx
ftoi r4.xy, v0.xyxx
mov r4.zw, l(0,0,0,0)
ld_indexable(texture2d)(float,float,float,float) r0.w, r4.xyzw, t21.yzwx
ge r1.z, r0.w, l(0.984375)
mul r1.w, r0.w, l(1.01587307)
mad r0.w, r0.w, l(64.000000), l(-63.000000)
movc r0.w, r1.z, r0.w, r1.w
max r0.w, r0.w, l(0.00000001)
rcp r0.w, r0.w
eq r1.z, cb0[16].y, l(0.000000)
div r1.w, l(1.000000, 1.000000, 1.000000, 1.000000), cb0[16].y
movc r1.z, r1.z, l(60000.000000), r1.w
add r0.w, -r5.w, r0.w
mul_sat r0.w, r1.z, r0.w
lt r1.z, r0.w, l(1.000000)
if_nz r1.z
  sample_indexable(texture2d)(float,float,float,float) r1.z, v2.xyxx, t46.xywz, s1
  sample_indexable(texture2d)(float,float,float,float) r4.xyzw, v2.xyxx, t47.xyzw, s1
  mul r4.xyz, r4.wwww, r4.xyzx
  add r1.w, -r1.z, r3.w
  mad r1.z, r0.w, r1.w, r1.z
  add r6.xyzw, r2.xyzw, -r4.xyzw
  mad r2.xyzw, r0.wwww, r6.xyzw, r4.xyzw
...
mul r0.w, r2.w, r0.w
sample_indexable(texture2d)(float,float,float,float) r1.z, v2.zwzz, t38.yzxw, s1
mad r1.xy, r1.xyxx, cb0[16].zzzz, v0.xyxx
mul r1.xy, r1.xyxx, cb1[44].zwzz
sample_indexable(texture2d)(float,float,float,float) r1.xyw, r1.xyxx, t30.xywz, s1
mul r2.xyz, r1.xywx, cb1[85].xxxx
mad_sat r0.w, r0.w, r5.z, r3.w
mul r0.w, r0.w, cb0[16].x
mul r0.w, r1.z, r0.w
mad r0.xyz, -r1.xywx, cb1[85].xxxx, r0.xyzx
...
min r3.xyz, r0.xyzx, l(65024.000000, 65024.000000, 64512.000000, 0.000000)
mov o0.xyzw, r3.xyzw
ret 
// Approximately 2270 instruction slots used
