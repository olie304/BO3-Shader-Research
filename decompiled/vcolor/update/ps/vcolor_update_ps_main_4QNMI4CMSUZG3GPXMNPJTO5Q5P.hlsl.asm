...
dcl_constantbuffer CB8[31], immediateIndexed
dcl_sampler s0, mode_default
dcl_resource_texture2d (float,float,float,float) t0
dcl_input_ps linear v1.xyz
dcl_output o0.xyz
dcl_temps 5
sample_indexable(texture2d)(float,float,float,float) r0.xyz, v1.xzxx, t0.xyzw, s0
mul r0.xyz, r0.xyzx, cb8[14].yyyy
sample_indexable(texture2d)(float,float,float,float) r1.xyz, v1.xyxx, t0.xyzw, s0
mad r0.xyz, r1.xyzx, cb8[14].xxxx, r0.xyzx
dp3 r0.w, r0.xyzx, cb8[16].xyzx
mad_sat r1.xyzw, r0.wwww, cb8[17].xzyw, cb8[18].xzyw
mul r1.y, r1.w, r1.y
...
add r3.x, r0.w, cb8[19].w
dp3 r0.w, r2.xyzx, cb8[22].xyzx
add r3.y, r0.w, cb8[22].w
dp3 r0.w, r2.xyzx, cb8[25].xyzx
add r3.z, r0.w, cb8[25].w
dp3_sat r0.w, r3.xyzx, r1.xyzx
log r0.w, r0.w
mul r0.w, r0.w, cb8[28].w
exp r3.x, r0.w
dp3 r0.w, r2.xyzx, cb8[20].xyzx
add r4.x, r0.w, cb8[20].w
dp3 r0.w, r2.xyzx, cb8[23].xyzx
add r4.y, r0.w, cb8[23].w
dp3 r0.w, r2.xyzx, cb8[26].xyzx
add r4.z, r0.w, cb8[26].w
dp3_sat r0.w, r4.xyzx, r1.xyzx
log r0.w, r0.w
mul r0.w, r0.w, cb8[29].w
exp r3.y, r0.w
dp3 r0.w, r2.xyzx, cb8[21].xyzx
add r4.x, r0.w, cb8[21].w
dp3 r0.w, r2.xyzx, cb8[24].xyzx
add r4.y, r0.w, cb8[24].w
dp3 r0.w, r2.xyzx, cb8[27].xyzx
add r4.z, r0.w, cb8[27].w
dp3_sat r0.w, r4.xyzx, r1.xyzx
log r0.w, r0.w
mul r0.w, r0.w, cb8[30].w
exp r3.z, r0.w
dp3_sat r1.x, r3.xyzx, cb8[28].xyzx
dp3_sat r1.y, r3.xyzx, cb8[29].xyzx
dp3_sat r1.z, r3.xyzx, cb8[30].xyzx
mad r0.xyz, -r0.xyzx, r0.xyzx, r1.xyzx
mad r0.xyz, cb8[16].wwww, r0.xyzx, r2.xyzx
dp3 r0.w, r0.xyzx, cb8[0].xyzx
add_sat r0.w, r0.w, cb8[0].w
sqrt r1.x, r0.w
dp3 r0.w, r0.xyzx, cb8[1].xyzx
dp3 r0.x, r0.xyzx, cb8[2].xyzx
add_sat r0.x, r0.x, cb8[2].w
sqrt r1.z, r0.x
add_sat r0.x, r0.w, cb8[1].w
sqrt r1.y, r0.x
dp3 r0.x, r1.xyzx, cb8[16].xyzx
mad_sat r2.xyzw, r0.xxxx, cb8[3].xyzw, cb8[4].xyzw
mad_sat r0.xyzw, r0.xxxx, cb8[5].xyzw, cb8[6].xyzw
dp4 r1.w, r2.xyzw, cb8[8].xyzw
dp4 r3.x, r0.xyzw, cb8[9].xyzw
add r1.w, r1.w, r3.x
add r3.x, r1.w, cb8[7].x
dp4 r1.w, r2.xyzw, cb8[10].xyzw
dp4 r2.x, r2.xyzw, cb8[12].xyzw
dp4 r2.y, r0.xyzw, cb8[11].xyzw
dp4 r0.x, r0.xyzw, cb8[13].xyzw
add r0.x, r0.x, r2.x
add r3.z, r0.x, cb8[7].z
add r0.x, r1.w, r2.y
add r3.y, r0.x, cb8[7].y
add r0.xyz, -r1.xyzx, r3.xyzx
mad o0.xyz, cb8[7].wwww, r0.xyzx, r1.xyzx
ret 
