  ...
  out float3 o0 : SV_TARGET0)
{
  ...
  r0.xyz = baseLut2DSampler.Sample(samp0_s, v1.xz).xyz;
  r0.xyz = postFxControlE.yyy * r0.xyz;
  r1.xyz = baseLut2DSampler.Sample(samp0_s, v1.xy).xyz;
  r0.xyz = r1.xyz * postFxControlE.xxx + r0.xyz;
  r0.w = dot(r0.xyz, postFxConst00.xyz);
  r1.xyzw = saturate(r0.wwww * postFxConst01.xzyw + postFxConst02.xzyw);
  r1.y = r1.y * r1.w;
  ...
  r3.x = postFxConst03.w + r0.w;
  r0.w = dot(r2.xyz, postFxConst06.xyz);
  r3.y = postFxConst06.w + r0.w;
  r0.w = dot(r2.xyz, postFxConst09.xyz);
  r3.z = postFxConst09.w + r0.w;
  r0.w = saturate(dot(r3.xyz, r1.xyz));
  r0.w = log2(r0.w);
  r0.w = postFxConst12.w * r0.w;
  r3.x = exp2(r0.w);
  r0.w = dot(r2.xyz, postFxConst04.xyz);
  r4.x = postFxConst04.w + r0.w;
  r0.w = dot(r2.xyz, postFxConst07.xyz);
  r4.y = postFxConst07.w + r0.w;
  r0.w = dot(r2.xyz, postFxConst10.xyz);
  r4.z = postFxConst10.w + r0.w;
  r0.w = saturate(dot(r4.xyz, r1.xyz));
  r0.w = log2(r0.w);
  r0.w = postFxConst13.w * r0.w;
  r3.y = exp2(r0.w);
  r0.w = dot(r2.xyz, postFxConst05.xyz);
  r4.x = postFxConst05.w + r0.w;
  r0.w = dot(r2.xyz, postFxConst08.xyz);
  r4.y = postFxConst08.w + r0.w;
  r0.w = dot(r2.xyz, postFxConst11.xyz);
  r4.z = postFxConst11.w + r0.w;
  r0.w = saturate(dot(r4.xyz, r1.xyz));
  r0.w = log2(r0.w);
  r0.w = postFxConst14.w * r0.w;
  r3.z = exp2(r0.w);
  r1.x = saturate(dot(r3.xyz, postFxConst12.xyz));
  r1.y = saturate(dot(r3.xyz, postFxConst13.xyz));
  r1.z = saturate(dot(r3.xyz, postFxConst14.xyz));
  r0.xyz = -r0.xyz * r0.xyz + r1.xyz;
  r0.xyz = postFxConst00.www * r0.xyz + r2.xyz;
  r0.w = dot(r0.xyz, postFxControl0.xyz);
  r0.w = saturate(postFxControl0.w + r0.w);
  r1.x = sqrt(r0.w);
  r0.w = dot(r0.xyz, postFxControl1.xyz);
  r0.x = dot(r0.xyz, postFxControl2.xyz);
  r0.x = saturate(postFxControl2.w + r0.x);
  r1.z = sqrt(r0.x);
  r0.x = saturate(postFxControl1.w + r0.w);
  r1.y = sqrt(r0.x);
  r0.x = dot(r1.xyz, postFxConst00.xyz);
  r2.xyzw = saturate(r0.xxxx * postFxControl3.xyzw + postFxControl4.xyzw);
  r0.xyzw = saturate(r0.xxxx * postFxControl5.xyzw + postFxControl6.xyzw);
  r1.w = dot(r2.xyzw, postFxControl8.xyzw);
  r3.x = dot(r0.xyzw, postFxControl9.xyzw);
  r1.w = r3.x + r1.w;
  r3.x = postFxControl7.x + r1.w;
  r1.w = dot(r2.xyzw, postFxControlA.xyzw);
  r2.x = dot(r2.xyzw, postFxControlC.xyzw);
  r2.y = dot(r0.xyzw, postFxControlB.xyzw);
  r0.x = dot(r0.xyzw, postFxControlD.xyzw);
  r0.x = r2.x + r0.x;
  r3.z = postFxControl7.z + r0.x;
  r0.x = r2.y + r1.w;
  r3.y = postFxControl7.y + r0.x;
  r0.xyz = r3.xyz + -r1.xyz;
  o0.xyz = postFxControl7.www * r0.xyz + r1.xyz;
  return;
}