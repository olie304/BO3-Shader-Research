...
r0.y = samp0[]..swiz;
  ...
  r15.y = r0.z;
  while (true) {
    r15.z = cmp((uint)r15.y >= numRefProbes);
    if (r15.z != 0) break;
    r15.z = (uint)r15.y >> 5;
    r15.z = (int)r0.y + (int)r15.z;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r15.z, r15.z, l(0), t26.xxxx
  r15.z = samp0[]..swiz;
    r15.w = cmp((int)r0.z == (int)r15.y);
    bitmask.w = ((~(-1 << r14.y)) << 0) & 0xffffffff;  r17.w = (((uint)0 << 0) & bitmask.w) | ((uint)r15.z & ~bitmask.w);
    r15.z = r15.w ? r17.w : r15.z;
    r15.w = cmp((int)r14.z == (int)r15.y);
    if (r14.w == 0) r17.w = 0; else if (r14.w+0 < 32) {     r17.w = (uint)r15.z << (32-(r14.w + 0)); r17.w = (uint)r17.w >> (32-r14.w);    } else r17.w = (uint)r15.z >> 0;
    r15.z = r15.w ? r17.w : r15.z;
    r24.xyzw = r22.xyzw;
    r25.xyz = r23.yzw;
    r15.w = r15.z;
    while (true) {
      ...
      r17.w = (int)r15.y + (int)r17.w;
      r17.w = (int)r17.w * 14;
      r26.xyz = -refProbeConstantsCB[r17.w].data[0].xyz + r11.xyz;
      ...
      while (true) {
        ...
        r20.w = -r21.w * r20.w + 1;
        r20.w = r28.y * r20.w;
        r19.y = r27.w ? r20.w : r28.z;
        r28.xy = r27.zz ? r28.xy : r19.xy;
        r19.w = (int)r19.w + 1;
        r17.x = r26.w;
      }
      r28.y = saturate(r28.y);
      r17.x = refProbeConstantsCB[r17.w].data[6].y * r28.y;
      r18.w = cmp(0 < r17.x);
      if (r18.w != 0) {
        r25.z = r28.y * refProbeConstantsCB[r17.w].data[6].y + r25.z;
        r17.x = refProbeConstantsCB[r17.w].data[7].y * r17.x;
        r27.x = refProbeConstantsCB[r17.w].data[7].w;
        r27.yz = refProbeConstantsCB[r17.w].data[8].xy;
        r18.w = dot(r16.xyz, r27.xyz);
        r19.y = dot(r26.xyz, r27.xyz);
        ...
        r19.yzw = r16.xyz * r18.www + r27.xyz;
        ...
        r29.w = (uint)r19.y;
        r19.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r29.xyzw, r18.w).xyz;
        r32.x = dot(r26.xyz, r27.xyz);
        r32.y = dot(r26.xyz, r30.xyz);
        r32.z = dot(r26.xyz, r31.xyz);
        r26.xyz = saturate(r32.xyz * refProbeConstantsCB[r17.w].data[3].xyz + float3(0.5,0.5,0.5));
        r32.xy = refProbeConstantsCB[r17.w].data[4].zw * r26.xy;
        r32.z = refProbeConstantsCB[r17.w].data[5].x * r26.z;
        r26.xyz = refProbeConstantsCB[r17.w].data[5].yzw + r32.xyz;
        r29.x = dot(r12.xyz, r27.xyz);
        r29.y = dot(r12.xyz, r30.xyz);
        r29.z = dot(r12.xyz, r31.xyz);
        r27.xyz = cmp(float3(0,0,0) < r29.xyz);
        r18.z = r27.x ? 0 : 0.5;
        r28.xzw = r26.xyz + r18.xyz;
        r28.xzw = gProbeXArray.SampleLevel(samplerLinearClamp_s, r28.xzw, 0).xyz;
        r30.xyz = r29.xyz * r29.xyz;
        r30.xyz = r30.xyz * r17.xxx;
        r20.z = r27.y ? 0 : 0.5;
        r27.xyw = r26.xyz + r20.xyz;
        r27.xyw = gProbeYArray.SampleLevel(samplerLinearClamp_s, r27.xyw, 0).xyz;
        r27.xyw = r27.xyw * r30.yyy;
        r27.xyw = r28.xzw * r30.xxx + r27.xyw;
        r21.z = r27.z ? 0 : 0.5;
        r26.xyz = r26.xyz + r21.xyz;
        r26.xyz = gProbeZArray.SampleLevel(samplerLinearClamp_s, r26.xyz, 0).xyz;
        r26.xyz = r26.xyz * r30.zzz + r27.xyw;
        r27.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r29.xyzw, 6).xyz;
        r28.xzw = r27.xyz * r26.xyz;
        r17.w = dot(r28.xzw, float3(0.212599993,0.715200007,0.0722000003));
        ...
        r26.x = r24.w;
        r26.yz = r25.xy;
        r25.xyw = r19.zwy * r17.xxx + r26.yzx;
        r24.w = r25.w;
      }
    }
    r22.xyzw = r24.xyzw;
  ...
  if (r14.z != 0) {
    ...
    r17.w = samp0[]..swiz;
      r18.w = cmp((int)r0.z == (int)r14.w);
      if (r14.y == 0) r19.z = 0; else if (r14.y+0 < 32) {       r19.z = (uint)r17.w << (32-(r14.y + 0)); r19.z = (uint)r19.z >> (32-r14.y);      } else r19.z = (uint)r17.w >> 0;
      ...
      while (true) {
        if (r19.z == 0) break;
        r19.w = firstbitlow((uint)r19.z);
        r20.w = 1 << (int)r19.w;
        r20.w = ~(int)r20.w;
        r19.z = (int)r19.z & (int)r20.w;
        r19.w = (int)r14.w + (int)r19.w;
        r19.w = (int)r19.w * 14;
        r27.xyz = -refProbeConstantsCB[r19.w].data[0].xyz + r11.xyz;
        r20.w = 0x0000ffff & (int)refProbeConstantsCB[r19.w].data[7].z;
        if (6 == 0) r21.w = 0; else if (6+25 < 32) {         r21.w = (uint)refProbeConstantsCB[r19.w].data[7].z << (32-(6 + 25)); r21.w = (uint)r21.w >> (32-6);        } else r21.w = (uint)refProbeConstantsCB[r19.w].data[7].z >> 25;
        r26.w = (int)r20.w * 6;
        r27.w = dot(refProbeAttenuationConstantsCB[r26.w].data[0].xyz, r27.xyz);
        r27.w = saturate(refProbeAttenuationConstantsCB[r26.w].data[0].w + r27.w);
        r28.x = dot(refProbeAttenuationConstantsCB[r26.w].data[1].xyz, r27.xyz);
        r28.x = saturate(refProbeAttenuationConstantsCB[r26.w].data[1].w + r28.x);
        r27.w = r28.x * r27.w;
        r28.x = dot(refProbeAttenuationConstantsCB[r26.w].data[2].xyz, r27.xyz);
        r28.x = saturate(refProbeAttenuationConstantsCB[r26.w].data[2].w + r28.x);
        r27.w = r28.x * r27.w;
        r28.x = dot(refProbeAttenuationConstantsCB[r26.w].data[3].xyz, r27.xyz);
        r28.x = saturate(refProbeAttenuationConstantsCB[r26.w].data[3].w + r28.x);
        r27.w = r28.x * r27.w;
        r28.x = dot(refProbeAttenuationConstantsCB[r26.w].data[4].xyz, r27.xyz);
        r28.x = saturate(refProbeAttenuationConstantsCB[r26.w].data[4].w + r28.x);
        r27.w = r28.x * r27.w;
        r28.x = dot(refProbeAttenuationConstantsCB[r26.w].data[5].xyz, r27.xyz);
        r26.w = saturate(refProbeAttenuationConstantsCB[r26.w].data[5].w + r28.x);
        r17.x = r27.w * r26.w;
        r26.w = 1 & (int)refProbeConstantsCB[r19.w].data[6].x;
        r28.xy = r26.ww ? r17.xy : r17.zx;
        r17.x = refProbeConstantsCB[r19.w].data[6].x;
        r29.xy = r28.xy;
        r26.w = 1;
        while (true) {
          r27.w = cmp((int)r26.w >= (int)r21.w);
          if (r27.w != 0) break;
          r27.w = (int)r20.w + (int)r26.w;
          r27.w = (int)r27.w * 6;
          ...
          r27.w = -r28.z * r27.w + 1;
          r27.w = r29.y * r27.w;
          r19.y = r29.w ? r27.w : r30.x;
          r29.xy = r29.zz ? r29.xy : r19.xy;
          r26.w = (int)r26.w + 1;
          r17.x = r28.w;
        }
        r17.x = saturate(r29.y + -r18.w);
        r19.y = refProbeConstantsCB[r19.w].data[6].y * r17.x;
        r20.w = cmp(0 < r19.y);
        if (r20.w != 0) {
          r25.w = r17.x * refProbeConstantsCB[r19.w].data[6].y + r25.w;
          r17.x = refProbeConstantsCB[r19.w].data[7].y * r19.y;
          ...
          r21.w = -refProbeConstantsCB[r19.w].data[9].z + r21.w;
          r26.w = cmp(r21.w >= 0);
          ...
          r20.w = dot(r16.xyz, r28.xyz);
          r21.w = dot(r27.xyz, r28.xyz);
          r21.w = -refProbeConstantsCB[r19.w].data[10].z + r21.w;
          r26.w = cmp(r21.w >= 0);
          r21.w = max(abs(r21.w), r8.w);
          r21.w = r26.w ? r21.w : -r21.w;
          r20.w = max(1.00000001e-07, -r20.w);
          ...
          r20.w = dot(r16.xyz, r28.xyz);
          r21.w = dot(r27.xyz, r28.xyz);
          r21.w = -refProbeConstantsCB[r19.w].data[11].z + r21.w;
          r26.w = cmp(r21.w >= 0);
          r21.w = max(abs(r21.w), r8.w);
          r21.w = r26.w ? r21.w : -r21.w;
          r20.w = max(1.00000001e-07, -r20.w);
          ...
          r20.w = dot(r16.xyz, r28.xyz);
          r21.w = dot(r27.xyz, r28.xyz);
          r21.w = -refProbeConstantsCB[r19.w].data[12].z + r21.w;
          r26.w = cmp(r21.w >= 0);
          r21.w = max(abs(r21.w), r8.w);
          r21.w = r26.w ? r21.w : -r21.w;
          r20.w = max(1.00000001e-07, -r20.w);
          ...
          r20.w = dot(r16.xyz, r28.xyz);
          r21.w = dot(r27.xyz, r28.xyz);
          r21.w = -refProbeConstantsCB[r19.w].data[13].z + r21.w;
          r26.w = cmp(r21.w >= 0);
          r21.w = max(abs(r21.w), r8.w);
          r21.w = r26.w ? r21.w : -r21.w;
          r20.w = max(1.00000001e-07, -r20.w);
          r20.w = r21.w / r20.w;
          r19.y = min(abs(r20.w), r19.y);
          r28.x = refProbeConstantsCB[r19.w].data[3].w + r27.x;
          r28.yz = refProbeConstantsCB[r19.w].data[4].xy + r27.yz;
          ...
          r27.xyz = saturate(r34.xyz * refProbeConstantsCB[r19.w].data[3].xyz + float3(0.5,0.5,0.5));
          r34.xy = refProbeConstantsCB[r19.w].data[4].zw * r27.xy;
          r34.z = refProbeConstantsCB[r19.w].data[5].x * r27.z;
          r27.xyz = refProbeConstantsCB[r19.w].data[5].yzw + r34.xyz;
  ...
  if (r4.w != 0) {
    ...
    if (r4.w != 0) {
      ...
      if (sunConstants.sunCookieIndex != 0) {
        ...
        r19.w = 1;
        r5.z = dot(sunConstants.sunCookieTransform[0].xyzw, r19.xyzw);
      ...
      if (r7.w != 0) {
        ...
        r20.x = lightConstantsCB[r5.z].data[9].w + r15.y;
        r20.y = lightConstantsCB[r5.z].data[10].x + r15.z;
        r15.yz = lightConstantsCB[r5.z].data[9].yz * r20.xy;
        ...
        if (r7.w == 0) {
          ...
          r19.x = r15.y * lightConstantsCB[r5.z].data[8].y + lightConstantsCB[r5.z].data[8].z;
          r19.y = r15.z * lightConstantsCB[r5.z].data[8].w + lightConstantsCB[r5.z].data[9].x;
      ...
      r5.z = r5.z * r6.w;
      r3.z = cmp(0 < r3.z);
      r19.xyz = r5.zzz * r14.yzw + r17.xyz;
  ...
  while (true) {
    ...
    switch (r5.z) {
      ...
      r31.xy = lightConstantsCB[r4.w].data[5].zw;
      r31.z = lightConstantsCB[r4.w].data[6].x;
      r15.yzw = -r31.xyz * float3(0.5,0.5,0.5) + lightConstantsCB[r4.w].data[0].xyz;
      r32.xyz = r15.yzw + -r11.xyz;
      r6.w = dot(r31.xyz, r32.xyz);
      r7.w = saturate(-r6.w / lightConstantsCB[r4.w].data[6].y);
      r33.xyz = r7.www * r31.xyz + r15.yzw;
        ...
        if (r13.w != 0) {
          ...
          if (r13.w != 0) {
            ...
            while (true) {
              ...
              r21.w = gOmniShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r34.xyzw, r13.w).x;
          ...
          if (r13.w != 0) {
            ...
            r21.w = -r16.w * r16.w + lightConstantsCB[r4.w].data[6].y;
            r6.w = r16.w * r18.w + -r6.w;
            r6.w = saturate(r6.w / r21.w);
            r16.w = r21.w / lightConstantsCB[r4.w].data[6].y;
            r16.w = 10 * r16.w;
            r16.w = min(1, r16.w);
            r6.w = r6.w + -r7.w;
            r6.w = r16.w * r6.w + r7.w;
            r15.yzw = r6.www * r31.xyz + r15.yzw;
            r15.yzw = r5.zzz ? r15.yzw : lightConstantsCB[r4.w].data[0].xyz;
            r15.yzw = r15.yzw + -r11.xyz;
            r5.z = dot(r15.yzw, r15.yzw);
            r5.z = rsqrt(r5.z);
            r31.xyz = r15.yzw * r5.zzz;
            ...
            if (r7.w != 0) {
              ...
              if (r18.w == 0) {
                ...
                r32.x = lightConstantsCB[r6.w].data[9].w + r20.x;
                r32.y = lightConstantsCB[r6.w].data[10].x + r20.y;
                r20.xy = lightConstantsCB[r6.w].data[9].yz * r32.xy;
                ...
                if (r20.z == 0) {
                  ...
                  r32.x = r20.x * lightConstantsCB[r6.w].data[8].y + lightConstantsCB[r6.w].data[8].z;
                  r32.y = r20.y * lightConstantsCB[r6.w].data[8].w + lightConstantsCB[r6.w].data[9].x;
                  r20.x = lightConstantsCB[r6.w].data[10].z * r16.w;
              ...
              if (r16.w == 0) {
                ...
                if (enableDitheredShadow != 0) {
                  ...
                  while (true) {
                    ...
                    r33.y = dot(icb[r21.w+0].xy, r3.xy);
                    r20.xy = r33.xy * lightConstantsCB[r6.w].data[3].yy + r32.xy;
                    r20.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r20.xyz, r7.w).x;
              ...
              if (r7.w != 0) {
                ...
                r6.w = mad((int)r6.w, 15, -15);
                r7.w = abs(r9.w) * -0.200000003 + 0.400000006;
                r22.xyz = r12.xyz * r7.www + r11.xyz;
                r32.xyz = lightConstantsCB[r6.w].data[6].yzw;
                r32.w = lightConstantsCB[r6.w].data[7].x;
                r7.w = dot(r32.xyzw, r22.xyzw);
                r32.xyz = lightConstantsCB[r6.w].data[7].yzw;
                r32.w = lightConstantsCB[r6.w].data[8].x;
                r16.w = dot(r32.xyzw, r22.xyzw);
                r20.x = cmp(r16.w < r7.w);
                if (r20.x == 0) {
                  r32.xyz = lightConstantsCB[r6.w].data[4].yzw;
                  r32.w = lightConstantsCB[r6.w].data[5].x;
                  ...
                  r22.x = lightConstantsCB[r6.w].data[9].w + r20.y;
                  r22.y = lightConstantsCB[r6.w].data[10].x + r20.z;
                  r20.yz = lightConstantsCB[r6.w].data[9].yz * r22.xy;
                  r22.xy = lightConstantsCB[r6.w].data[3].yy / lightConstantsCB[r6.w].data[8].yw;
                  ...
                  if (r21.w == 0) {
                    ...
                    r22.x = r20.y * lightConstantsCB[r6.w].data[8].y + lightConstantsCB[r6.w].data[8].z;
                    r22.y = r20.z * lightConstantsCB[r6.w].data[8].w + lightConstantsCB[r6.w].data[9].x;
                    r20.y = lightConstantsCB[r6.w].data[10].z * r16.w;
                    r7.w = lightConstantsCB[r6.w].data[10].y * r16.w + r7.w;
                    r7.w = r7.w / r20.y;
                  }
                } else {
                ...
                if (r16.w == 0) {
                  ...
                  if (enableDitheredShadow != 0) {
                    ...
                    while (true) {
                      ...
                      if (r27.w != 0) break;
                      r32.x = dot(icb[r26.w+0].xy, r13.xy);
                      r32.y = dot(icb[r26.w+0].yx, r13.xz);
                      r20.xy = r32.xy * lightConstantsCB[r6.w].data[3].yy + r22.xy;
                      r20.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r20.xyz, r7.w).x;
                    ...
                    r22.z = (uint)r16.w;
                    r21.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r22.xyz, r7.w).x;
                  }
                  r6.w = r21.w * r21.w;
                  r6.w = r6.w * r21.w;
                } else {
            ...
            r6.w = r6.w * r8.w;
            r20.x = lightConstantsCB[r4.w].data[0].w;
            r20.yz = lightConstantsCB[r4.w].data[1].xy;
            r7.w = cmp(0 < r9.w);
            r22.xyz = r6.www * r20.xyz + r14.yzw;
            r6.w = saturate(dot(r12.xyz, r31.xyz));
            r15.yzw = r15.yzw * r5.zzz + r10.yzw;
            r5.z = dot(r15.yzw, r15.yzw);
            r5.z = rsqrt(r5.z);
            r15.yzw = r15.yzw * r5.zzz;
            r5.z = dot(r15.yzw, r10.yzw);
            ...
            r6.w = r9.w * r6.w;
            r6.w = r6.w * r8.w;
            r15.yzw = r6.www * r20.xyz + r30.xyz;
            r5.z = saturate(1 + -r5.z);
            r8.w = r5.z * r5.z;
            r8.w = r8.w * r8.w;
            r5.z = r8.w * r5.z;
            r5.z = r6.w * r5.z;
            r20.xyz = r5.zzz * r20.xyz + r29.xyz;
            r14.yzw = r7.www ? r22.xyz : r14.yzw;
            r29.xyz = r7.www ? r20.xyz : r29.xyz;
            r30.xyz = r7.www ? r15.yzw : r30.xyz;
          }
        }
      }
      break;
      case 2 :      r20.xy = lightConstantsCB[r4.w].data[3].zw + -r11.xy;
      r20.z = lightConstantsCB[r4.w].data[4].x + -r11.z;
      r5.z = dot(r20.xyz, r20.xyz);
      r5.z = rsqrt(r5.z);
      r15.yzw = r20.xyz * r5.zzz;
      r6.w = dot(r12.xyz, r15.yzw);
      r7.w = saturate(r6.w);
      r8.w = cmp(0 < r7.w);
      if (r8.w != 0) {
        r31.xyz = lightConstantsCB[r4.w].data[7].yzw;
        r31.w = lightConstantsCB[r4.w].data[8].x;
        r8.w = dot(r31.xyzw, r11.xyzw);
        r9.w = cmp(r8.w < 1);
        if (r9.w != 0) {
          r15.yzw = float3(1,1,1);
          r9.w = 0;
        } else {
          r22.xyz = lightConstantsCB[r4.w].data[0].xyz + -r11.xyz;
          r12.w = lightConstantsCB[r4.w].data[3].x * lightConstantsCB[r4.w].data[3].x;
          r13.w = dot(r22.xyz, r22.xyz);
          r12.w = r12.w / r13.w;
          r12.w = min(1, r12.w);
          r22.xy = saturate(r8.ww * lightConstantsCB[r4.w].data[2].xz + lightConstantsCB[r4.w].data[2].yw);
          ...
          r22.x = dot(r32.xyzw, r11.xyzw);
          r32.xyz = lightConstantsCB[r4.w].data[5].yzw;
          r32.w = lightConstantsCB[r4.w].data[6].x;
          r22.y = dot(r32.xyzw, r11.xyzw);
          r21.xy = r22.xy / r8.ww;
          r8.w = cmp(lightConstantsCB[r4.w].data[10].w < 0.00048828125);
          if (r8.w != 0) {
            r22.xy = saturate(abs(r21.xy) * lightConstantsCB[r4.w].data[12].xy + lightConstantsCB[r4.w].data[12].zw);
            r32.xy = r22.xy * r22.xy;
            r22.xy = r22.xy * float2(-2,-2) + float2(3,3);
            r22.xy = r32.xy * r22.xy;
            r8.w = r22.x * r22.y;
          } else {
            r32.xyzw = saturate(lightConstantsCB[r4.w].data[11].xyzw * abs(r21.yyxx));
            r32.xyzw = log2(r32.xyzw);
            r32.xyzw = lightConstantsCB[r4.w].data[12].zzzz * r32.xyzw;
            r32.xyzw = exp2(r32.xyzw);
            r22.xy = r32.xy + r32.zw;
            r22.xy = log2(r22.xy);
            r22.xy = lightConstantsCB[r4.w].data[12].ww * r22.xy;
            r22.xy = exp2(r22.xy);
            r13.w = lightConstantsCB[r4.w].data[12].x * r22.x;
            r16.w = lightConstantsCB[r4.w].data[12].y * r22.y + -1;
            r13.w = lightConstantsCB[r4.w].data[12].y * r22.y + -r13.w;
          ...
          if (r8.w != 0) {
            r12.w = dot(lightConstantsCB[r4.w].data[13].xyz, r21.xyz);
            r22.x = lightConstantsCB[r4.w].data[13].w;
            r22.yz = lightConstantsCB[r4.w].data[14].xy;
        ...
        r22.x = lightConstantsCB[r4.w].data[0].w;
        r22.yz = lightConstantsCB[r4.w].data[1].xy;
        ...
        if (r8.w != 0) {
          ...
          if (r8.w != 0) {
            ...
            r23.xyz = r12.xyz * r8.www + r11.xyz;
            r32.xyz = lightConstantsCB[r4.w].data[6].yzw;
            r32.w = lightConstantsCB[r4.w].data[7].x;
            r8.w = dot(r32.xyzw, r23.xyzw);
            r12.w = dot(r31.xyzw, r23.xyzw);
            r13.w = cmp(r12.w >= r8.w);
            if (r13.w != 0) {
              r31.xyz = lightConstantsCB[r4.w].data[4].yzw;
              r31.w = lightConstantsCB[r4.w].data[5].x;
              r21.x = dot(r31.xyzw, r23.xyzw);
              r31.xyz = lightConstantsCB[r4.w].data[5].yzw;
              r31.w = lightConstantsCB[r4.w].data[6].x;
              r21.y = dot(r31.xyzw, r23.xyzw);
              r21.xy = r21.xy / r12.ww;
              r21.xy = saturate(r21.xy * float2(0.5,-0.5) + float2(0.5,0.5));
              r22.x = r21.x * lightConstantsCB[r4.w].data[8].y + lightConstantsCB[r4.w].data[8].z;
              r22.y = r21.y * lightConstantsCB[r4.w].data[8].w + lightConstantsCB[r4.w].data[9].x;
              r8.w = r8.w / r12.w;
              ...
              if (enableDitheredShadow != 0) {
                ...
                while (true) {
                  ...
                  r23.xy = r21.xy * lightConstantsCB[r4.w].data[3].yy + r22.xy;
                  r21.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r23.xyz, r8.w).x;
                  r13.w = r21.x * 0.125 + r13.w;
                  r16.w = (int)r16.w + 1;
                }
              } else {
                r22.z = (uint)r12.w;
          ...
          if (r9.w != 0) {
            ...
            if (r16.w != 0) {
              ...
              r24.xyz = r12.xyz * r16.www + r11.xyz;
              r31.xyz = lightConstantsCB[r12.w].data[6].yzw;
              r31.w = lightConstantsCB[r12.w].data[7].x;
              r16.w = dot(r31.xyzw, r24.xyzw);
              r31.xyz = lightConstantsCB[r12.w].data[7].yzw;
              r31.w = lightConstantsCB[r12.w].data[8].x;
              r21.x = dot(r31.xyzw, r24.xyzw);
              r21.y = cmp(r21.x < r16.w);
              if (r21.y == 0) {
                r31.xyz = lightConstantsCB[r12.w].data[4].yzw;
                r31.w = lightConstantsCB[r12.w].data[5].x;
                r22.x = dot(r31.xyzw, r24.xyzw);
                r31.xyz = lightConstantsCB[r12.w].data[5].yzw;
                r31.w = lightConstantsCB[r12.w].data[6].x;
                ...
                if (r22.z == 0) {
                  ...
                  r22.x = lightConstantsCB[r12.w].data[10].z * r21.x;
                  r16.w = lightConstantsCB[r12.w].data[10].y * r21.x + r16.w;
                  r16.w = r16.w / r22.x;
                }
              } else {
                r22.z = -1;
              ...
              if (r21.x == 0) {
                ...
                r21.x = 0x0000ffff & (int)lightConstantsCB[r12.w].data[1].w;
                if (enableDitheredShadow != 0) {
                  r22.z = (uint)r21.x;
                  r21.y = 0;
                  r24.x = 0;
                  while (true) {
                    ...
                    r22.xy = r31.xy * lightConstantsCB[r12.w].data[3].yy + r23.xy;
              ...
              if (r12.w != 0) {
                ...
                r25.xyz = r12.xyz * r12.www + r11.xyz;
                r31.xyz = lightConstantsCB[r4.w].data[6].yzw;
                r31.w = lightConstantsCB[r4.w].data[7].x;
                r12.w = dot(r31.xyzw, r25.xyzw);
                r31.xyz = lightConstantsCB[r4.w].data[7].yzw;
                r31.w = lightConstantsCB[r4.w].data[8].x;
                r16.w = dot(r31.xyzw, r25.xyzw);
                r21.x = cmp(r16.w < r12.w);
                if (r21.x == 0) {
                  r31.xyz = lightConstantsCB[r4.w].data[4].yzw;
                  r31.w = lightConstantsCB[r4.w].data[5].x;
                  ...
                  if (r22.z == 0) {
                    ...
                    r22.x = lightConstantsCB[r4.w].data[10].z * r16.w;
                ...
                if (r16.w == 0) {
                  ...
                  if (enableDitheredShadow != 0) {
                    ...
                    while (true) {
                      ...
                      r22.xy = r25.xy * lightConstantsCB[r4.w].data[3].yy + r23.xy;
                    ...
                    r23.z = (uint)r16.w;
                    r21.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r23.xyz, r12.w).x;
                  }
                  r4.w = r21.x * r21.x;
                  r4.w = r4.w * r21.x;
                } else {
            ...
            r4.w = r4.w * r8.w;
            r6.w = cmp(0 < r6.w);
            r22.xyz = r4.www * r15.yzw + r14.yzw;
            r20.xyz = r20.xyz * r5.zzz + r10.yzw;
            r4.w = dot(r20.xyz, r20.xyz);
            r4.w = rsqrt(r4.w);
            r20.xyz = r20.xyz * r4.www;
            r4.w = dot(r20.xyz, r10.yzw);
            ...
            r5.z = r8.w * r5.z;
            r5.z = 0.25 * r5.z;
            r20.xyz = r5.zzz * r15.yzw + r30.xyz;
            r4.w = saturate(1 + -r4.w);
            r7.w = r4.w * r4.w;
            r7.w = r7.w * r7.w;
            r4.w = r7.w * r4.w;
            r4.w = r5.z * r4.w;
            r15.yzw = r4.www * r15.yzw + r29.xyz;
            r14.yzw = r6.www ? r22.xyz : r14.yzw;
            r29.xyz = r6.www ? r15.yzw : r29.xyz;
            r30.xyz = r6.www ? r20.xyz : r30.xyz;
          }
        }
      }
      break;
