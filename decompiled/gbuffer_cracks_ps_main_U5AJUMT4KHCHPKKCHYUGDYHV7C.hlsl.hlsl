...
Texture2D<float4> crackMap : register(t12);
Texture2D<float4> crackNormalMap : register(t14);
...
r2.w = colorSampler[]..swiz;
  ...
  r2.w = saturate(r2.w);
  r3.w = r3.w * -v1.x + 1;
  r5.w = saturate(r8.w * 0.998000026 + 0.00100000005);
  r6.w = saturate(r3.w);
  r3.w = saturate(alphaRevealParms.x + r3.w);
  r7.z = alphaRevealParms.y + alphaRevealParms.y;
  r5.w = log2(r5.w);
  r5.w = r7.z * r5.w;
  r5.w = exp2(r5.w);
  r3.w = r3.w + -r6.w;
