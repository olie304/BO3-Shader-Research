...
ld_indexable(texture2d)(float,float,float,float) r0.w, r1.xyzw, t1.yzwx
mul o0.xyz, r0.xyzx, r2.xyzx
mad r0.x, r0.w, l(64.000000), l(-63.000000)
max r0.xy, r0.xwxx, l(0.00000001, 0.00000001, 0.000000, 0.000000)
ge r0.z, r0.w, l(0.984375)
div r0.xy, cb8[2].zwzz, r0.xyxx
movc r0.x, r0.z, r0.x, r0.y
mul r0.x, r0.x, l(25.400000)
div r0.x, cb8[3].y, r0.x
add r0.x, r0.x, l(-1.000000)
mul r0.x, r0.x, cb8[3].z
