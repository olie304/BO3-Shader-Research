...
r1.w = shaderConstantSetBuffer[]..swiz;
  ...
  o1.xyz = exp2(r0.xyz);
  p1.x = v1.w;
  r0.x = cmp(0 < scriptVectorOffset);
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r0.y, v5.x, l(4), t4.xxxx
r0.y = shaderConstantSetBuffer[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) r0.zw, r0.y, l(36), t0.xxxy
r0.z = shaderConstantSetBuffer[]..swiz;
r0.w = shaderConstantSetBuffer[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) r3.xy, r0.y, l(52), t0.xyxx
r3.x = shaderConstantSetBuffer[]..swiz;
r3.y = shaderConstantSetBuffer[]..swiz;
  r0.xz = r0.xx ? r3.xy : r0.zw;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) r3.xy, r0.y, l(68), t0.xyxx
r3.x = shaderConstantSetBuffer[]..swiz;
r3.y = shaderConstantSetBuffer[]..swiz;
  r5.xyzw = cmp(float4(4,3,2,1) < scriptVectorOffset);
  r0.xz = r5.ww ? r3.xy : r0.xz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) r3.xy, r0.y, l(84), t0.xyxx
r3.x = shaderConstantSetBuffer[]..swiz;
r3.y = shaderConstantSetBuffer[]..swiz;
  r0.xz = r5.zz ? r3.xy : r0.xz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) r3.xy, r0.y, l(100), t0.xyxx
r3.x = shaderConstantSetBuffer[]..swiz;
r3.y = shaderConstantSetBuffer[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) r0.yw, r0.y, l(116), t0.xxxy
r0.y = shaderConstantSetBuffer[]..swiz;
r0.w = shaderConstantSetBuffer[]..swiz;
  r0.xz = r5.yy ? r3.xy : r0.xz;
  p2.xy = r5.xx ? r0.yw : r0.xz;
  o2.xy = v2.xy;
  o3.x = v5.x;
