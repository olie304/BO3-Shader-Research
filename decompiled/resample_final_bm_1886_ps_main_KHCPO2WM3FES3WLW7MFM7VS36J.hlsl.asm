...
movc r0.xyz, r1.xyzx, r0.xyzx, l(2.000000,2.000000,2.000000,0)
mad r1.xy, v1.xyxx, cb8[0].xyxx, cb8[0].zwzz
sample_indexable(texture2d)(float,float,float,float) r0.w, r1.xyxx, t1.yzwx, s2
mul r0.w, r0.w, cb8[1].x
mul r1.xy, v0.xyxx, l(0.025000, 0.025000, 0.000000, 0.000000)
...
mad r0.xz, r1.yyxy, r0.yyyy, r0.xxzx
mul r0.xyz, r0.xyzx, cb8[1].yyyy
max r0.xyz, r0.xyzx, l(0.000000, 0.000000, 0.000000, 0.000000)
log r0.xyz, r0.xyzx
mul r0.xyz, r0.xyzx, cb8[1].zzzz
exp r0.xyz, r0.xyzx
add o0.xyz, r0.xyzx, -cb8[1].wwww
ret 
