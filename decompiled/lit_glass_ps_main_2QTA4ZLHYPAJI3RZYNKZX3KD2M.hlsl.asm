...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:36:30 2021
//
//
...
mul r14.xyz, r3.xxxx, r9.zwyz
mul r9.yzw, r3.yyyy, r9.yyzw
sqrt r1.y, r3.w
...
if_z r3.y
  ...
  if_nz r4.z
    ...
    mov r5.w, l(0)
    loop 
      ge r6.w, r4.z, l(3.000000)
      breakc_nz r6.w
      ftou r6.w, r4.z
      add r7.zw, r10.yyyz, -cb2[r6.w + 20].xxxy
      max r7.z, |r7.w|, |r7.z|
      mul r5.w, r7.z, cb2[r6.w + 20].z
  ...
  if_nz r6.w
    ...
    if_z r8.w
      ...
      movc r7.w, r7.w, r17.z, r15.w
      ushr r15.w, r7.w, l(13)
      movc r7.z, r7.z, r15.w, r7.w
      and r7.z, r7.z, l(8191)
      ...
      if_z r7.z
        ...
        bfi r7.z, l(1), l(0), r7.z, r7.w
        imul null, r7.z, r7.z, l(10)
        ushr r7.z, r15.w, r7.z
        and r7.z, r7.z, l(1023)
        iadd r19.x, r7.z, r18.x
        ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r19.y, r19.x, l(0), t23.xxxx
        movc r7.zw, r12.wwww, r18.xxxz, r19.xxxy
      ...
      if_z r7.z
        ...
        mad r12.w, r12.w, l(0.00392157), r7.w
        ...
        ishl r8.w, r16.z, l(2)
        ushr r12.w, r7.w, l(16)
        f16tof32 r12.w, r12.w
        and r7.w, r7.w, l(0x0000ffff)
        f16tof32 r7.w, r7.w
        mad r8.w, r10.y, r12.w, r8.w
        mad r7.w, r10.z, r7.w, r8.w
        movc r11.w, r7.z, r7.w, r11.w
      endif 
    endif 
    mad r7.z, -cb2[27].z, l(2.000000), r10.w
    lt r7.z, r11.w, r7.z
    movc r4.y, r7.z, l(0), l(1.000000)
  endif 
  if_z r6.w
    if_z cb2[58].y
      ftou r6.w, r4.z
      ...
      itof r6.w, cb2[26].y
      add r15.z, r4.z, r6.w
      sample_c_lz_indexable(texture2darray)(float,float,float,float) r6.w, r15.xyzx, t13.xxxx, s13, r3.y
    ...
    if_nz cb2[58].y
      ...
      loop 
        ...
        movc r16.xy, r11.wwww, r10.yzyy, r7.zwzz
        movc r12.w, r11.w, cb2[r4.z + 20].w, cb2[r6.w + 20].w
        movc r11.w, r11.w, r4.z, r6.w
        ...
        utof r16.z, r11.w
        sample_c_lz_indexable(texture2darray)(float,float,float,float) r11.w, r16.xyzx, t13.xxxx, s13, r3.y
...
if_nz r3.y
  ...
  if_nz r3.y
    ...
    if_nz r5.w
      ...
      mad r19.xyz, r2.xyzx, r6.wwww, v6.xyzx
      ...
      if_z r6.w
        ...
        if_nz cb2[58].y
          ...
          loop 
            ...
            mad r17.xy, r18.xyxx, r5.wwww, r15.xyxx
            sample_c_lz_indexable(texture2darray)(float,float,float,float) r8.w, r17.xyzx, t9.xxxx, s13, r4.z
            mad r7.z, r8.w, l(0.125000), r7.z
            iadd r7.w, r7.w, l(1)
          endloop 
        else 
          utof r15.z, r6.w
          sample_c_lz_indexable(texture2darray)(float,float,float,float) r7.z, r15.xyzx, t9.xxxx, s13, r4.z
        endif 
        mul r4.z, r7.z, r7.z
        mul r4.z, r7.z, r4.z
      else 
    ...
    mad r16.xyz, r3.xxxx, r10.yzwy, r9.yzwy
    add_sat r1.x, -r1.x, l(1.000000)
    log r1.x, r1.x
    mul r1.x, r1.x, l(3.400000)
    exp r1.x, r1.x
    mul r1.x, r1.x, r3.x
    mad r17.xyz, r1.xxxx, r10.zwyz, r14.xyzx
    mov r15.w, r17.z
    mov r13.w, r14.z
    ...
    if_nz r8.w
      ...
      if_nz r7.w
        ...
        switch r7.w
            ...
            if_nz r20.w
              ...
              if_nz r20.w
                ...
                if_nz r11.w
                  ...
                  mad r18.xyz, r2.xyzx, r24.wwww, v6.xyzx
                ...
                mad r8.w, -r14.w, r2.w, l(1.000000)
                mul r8.w, r8.w, r8.w
                mad r8.w, -r8.w, l(0.620000), l(0.620000)
                add r8.w, -r14.w, r8.w
                mad r8.w, r3.w, r8.w, r14.w
                mul r8.w, r12.w, r8.w
                mov r32.x, r31.x
                lt r11.w, l(0.000000), r13.w
                mad r19.xyz, r8.wwww, r32.xyzx, r16.xyzx
                dp3_sat r8.w, r2.xyzx, r39.xyzx
                mad r38.xyz, r38.xyzx, r7.wwww, r6.xyzx
                dp3 r7.w, r38.xyzx, r38.xyzx
                rsq r7.w, r7.w
                mul r38.xyz, r7.wwww, r38.xyzx
                dp3 r7.w, r38.xyzx, r6.xyzx
                dp3 r13.w, r2.xyzx, r38.xyzx
                mad r14.w, |r13.w|, r3.z, -|r13.w|
                mad r13.w, |r13.w|, r14.w, l(1.000000)
                mad r14.w, r8.w, r1.y, r1.z
                ...
                mul r8.w, r8.w, r13.w
                mul r8.w, r12.w, r8.w
                mad r38.xyz, r8.wwww, r32.xyzx, r30.xyzx
                add_sat r7.w, -r7.w, l(1.000000)
                log r7.w, r7.w
                mul r7.w, r7.w, l(3.400000)
                exp r7.w, r7.w
                mul r7.w, r7.w, r8.w
                mad r39.xyz, r7.wwww, r32.xyzx, r29.xyzx
          ...
          rsq r7.w, r7.w
          mul r38.xyz, r7.wwww, r19.xyzx
          dp3 r8.w, r2.xyzx, r38.xyzx
          mov_sat r11.w, r8.w
          ...
          if_nz r12.w
            ...
            if_nz r13.w
              ...
              if_nz r12.w
                ...
                mul r12.w, r20.w, r24.w
              endif 
              mul r13.w, r12.w, r18.x
            ...
            if_nz r12.w
                ...
                if_nz r18.x
                  ...
                  if_nz r5.w
                    ...
                    loop 
                      ...
                      sample_c_lz_indexable(texture2darray)(float,float,float,float) r24.w, r31.xyzx, t9.xxxx, s13, r7.z
                      mad r14.w, r24.w, l(0.125000), r14.w
                      iadd r18.x, r18.x, l(1)
                    endloop 
                  else 
                    utof r21.z, r12.w
                    sample_c_lz_indexable(texture2darray)(float,float,float,float) r14.w, r21.xyzx, t9.xxxx, s13, r7.z
                  endif 
              ...
              mul r7.z, r7.z, r13.w
              lt r12.w, l(0.000000), r7.z
              if_nz r12.w
                mul r12.w, r3.z, r32.x
                ...
                if_nz r18.x
                  ...
                  mad r22.xyz, r2.xyzx, r21.xxxx, v6.xyzx
                  ...
                  if_z r22.y
                    ...
                    mul r13.w, r22.x, r31.y
                    mad r21.x, r31.x, r22.x, r21.z
                    div r13.w, r21.x, r13.w
                  ...
                  if_nz r18.x
                    ...
                    mad r21.x, |r8.w|, l(-0.200000), l(0.400000)
                    mad r23.xyz, r2.xyzx, r21.xxxx, v6.xyzx
                    ...
                    if_z r22.z
                      ...
                      if_nz r5.w
                        ...
                        utof r31.z, r21.x
                        sample_c_lz_indexable(texture2darray)(float,float,float,float) r21.z, r31.xyzx, t9.xxxx, s13, r13.w
                      endif 
                ...
                mad r18.x, |r13.w|, r3.z, -|r13.w|
                mad r13.w, |r13.w|, r18.x, l(1.000000)
                mad r11.w, r11.w, r1.y, r1.z
                mul r13.w, r13.w, r13.w
                ...
                mad r19.xyz, r7.zzzz, r20.xywx, r30.xyzx
                add_sat r7.w, -r7.w, l(1.000000)
                log r7.w, r7.w
                mul r7.w, r7.w, l(3.400000)
                exp r7.w, r7.w
                mul r7.z, r7.w, r7.z
                mad r20.xyw, r7.zzzz, r20.xyxw, r29.xyxz
                movc r16.xyz, r8.wwww, r22.xyzx, r16.xyzx
                movc r29.xyz, r8.wwww, r20.xywx, r29.xyzx
                movc r30.xyz, r8.wwww, r19.xyzx, r30.xyzx
              endif 
            endif 
          endif 
          break 
...
mad r2.xyz, r28.xyzx, r5.xyzx, r2.xyzx
...
if_z r2.x
  ...
  if_nz r2.w
    ...
    bfi r3.y, l(1), l(0), cb0[11].z, r1.x
...
ret 
// Approximately 2946 instruction slots used
