...
sample_indexable(texture2d)(float,float,float,float) r0.z, v2.xyxx, t10.yzxw, s4
...
sample_indexable(texture2d)(float,float,float,float) r6.xyzw, v2.xyxx, t12.xyzw, s5
mul r7.xyzw, r6.xyzw, cb0[13].yzwx
mul r6.xyz, r7.xyzx, v1.xyzx
...
movc r0.yzw, v8.xxxx, v4.xxyz, -v4.xxyz
