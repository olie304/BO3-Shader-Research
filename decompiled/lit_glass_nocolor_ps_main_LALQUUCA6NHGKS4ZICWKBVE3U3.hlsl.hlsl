...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r0.y = -1 + debugOcclusionOverride.x;
  r0.y = debugOcclusionOverride.w * r0.y + 1;
  r1.xyw = v8.xxx ? v4.xyz : -v4.xyz;
  r0.z = dot(r1.xyw, r1.xyw);
  r0.z = rsqrt(r0.z);
  r1.xyw = r1.xyw * r0.zzz + -r2.xyz;
  r1.xyw = debugNormalOverride.www * r1.xyw + r2.xyz;
  r0.z = tintAmount * 0.920000017 + 0.0799999982;
  ...
  while (true) {
    ...
    r7.w = cmp((int)r0.w == (int)r6.w);
    if (r2.w == 0) r8.x = 0; else if (r2.w+0 < 32) {     r8.x = (uint)r7.z << (32-(r2.w + 0)); r8.x = (uint)r8.x >> (32-r2.w);    } else r8.x = (uint)r7.z >> 0;
    r7.z = r7.w ? r8.x : r7.z;
    r7.w = (int)r2.z + (int)r6.w;
    r8.xyz = r9.xyz;
    r12.xyz = r10.xyz;
    r13.xyz = r11.xyz;
    r9.w = r3.w;
        ...
        r16.z = samp0[]..swiz;
          ...
          r19.w = samp0[]..swiz;
            ...
            r16.w = samp0[]..swiz;
              ...
              if (r17.z != 0) {
                if (4 == 0) r13.w = 0; else if (4+24 < 32) {                 r13.w = (uint)r15.w << (32-(4 + 24)); r13.w = (uint)r13.w >> (32-4);                } else r13.w = (uint)r15.w >> 24;
                r13.w = 1 << (int)r13.w;
                r18.w = (uint)r15.w >> 28;
                r18.w = 1 << (int)r18.w;
                r19.w = cmp((int)r17.z == 4);
                if (r19.w != 0) {
                  r19.w = (int)r15.w & 4095;
                  if (12 == 0) r20.w = 0; else if (12+12 < 32) {                   r20.w = (uint)r15.w << (32-(12 + 12)); r20.w = (uint)r20.w >> (32-12);                  } else r20.w = (uint)r15.w >> 12;
                  r21.w = (int)r16.w & 1023;
                  r23.xz = (uint2)r13.ww;
                  r23.y = (uint)r18.w;
              ...
              r15.w = cmp(r15.x != 1.000000);
              r14.w = r13.w + r14.w;
              r14.w = saturate(r14.w * r15.x + -r15.x);
              r13.w = r15.w ? r14.w : r13.w;
              if (r17.w != 0) {
                if (4 == 0) r14.w = 0; else if (4+24 < 32) {                 r14.w = (uint)r16.y << (32-(4 + 24)); r14.w = (uint)r14.w >> (32-4);                } else r14.w = (uint)r16.y >> 24;
                r14.w = 1 << (int)r14.w;
                r15.x = (uint)r16.y >> 28;
                r15.x = 1 << (int)r15.x;
                r15.w = cmp((int)r17.w == 2);
                if (r15.w != 0) {
                  ...
                  r25.x = (uint)r15.w;
                  r25.yz = (uint2)r23.xy;
                  r23.xz = r25.xy + r23.zw;
                  r25.xy = invMaskTexSizes.xy * r23.xz;
                  r23.xyz = invMaskTexSizes.xyx * r21.zyz;
                  r23.xyz = r23.xyz * r24.xyz;
                  r26.xyz = invMaskTexSizes.xyx * r22.zyz;
                  r24.xyz = r26.xyz * r24.xyz;
                  r15.w = materialTexMask.SampleGrad(samplerLinearClamp_s, r25.xyz, r23.x, r24.x).x;
                } else {
                  r17.z = cmp((int)r17.w == 4);
                  if (r17.z != 0) {
                    r17.z = (int)r16.y & 4095;
                    if (12 == 0) r23.x = 0; else if (12+12 < 32) {                     r23.x = (uint)r16.y << (32-(12 + 12)); r23.x = (uint)r23.x >> (32-12);                    } else r23.x = (uint)r16.y >> 12;
                    if (10 == 0) r23.y = 0; else if (10+20 < 32) {                     r23.y = (uint)r16.w << (32-(10 + 20)); r23.y = (uint)r23.y >> (32-10);                    } else r23.y = (uint)r16.w >> 20;
                    r24.xz = (uint2)r14.ww;
                    r24.y = (uint)r15.x;
                    ...
                    r25.x = (uint)r17.z;
                    r25.yz = (uint2)r23.xy;
                    r17.zw = r25.xy + r23.zw;
                    r25.xy = invBcTexSizes.xy * r17.zw;
                    r23.xyz = invBcTexSizes.xyx * r21.zyz;
                    r23.xyz = r23.xyz * r24.xyz;
                    r26.xyz = invBcTexSizes.xyx * r22.zyz;
                    r24.xyz = r26.xyz * r24.xyz;
                    r15.w = materialTexBC7.SampleGrad(samplerLinearClamp_s, r25.xyz, r23.x, r24.x).x;
                  } else {
                    r17.z = (int)r16.y & 4095;
                    if (12 == 0) r23.x = 0; else if (12+12 < 32) {                     r23.x = (uint)r16.y << (32-(12 + 12)); r23.x = (uint)r23.x >> (32-12);                    } else r23.x = (uint)r16.y >> 12;
                    if (10 == 0) r23.y = 0; else if (10+20 < 32) {                     r23.y = (uint)r16.w << (32-(10 + 20)); r23.y = (uint)r23.y >> (32-10);                    } else r23.y = (uint)r16.w >> 20;
                    ...
                    r25.yz = (uint2)r23.xy;
                    r17.zw = r25.xy + r23.zw;
                    r25.xy = invBcTexSizes.zw * r17.zw;
                    r23.xyz = invBcTexSizes.zwz * r21.zyz;
                    r23.xyz = r23.xyz * r24.xyz;
                    r26.xyz = invBcTexSizes.zwz * r22.zyz;
                    r24.xyz = r26.xyz * r24.xyz;
                    r15.w = materialTexBC3.SampleGrad(samplerLinearClamp_s, r25.xyz, r23.x, r24.x).x;
                  }
                }
                r23.xyz = r15.www * float3(0.959999979,0.959999979,0.959999979) + float3(0.0399999991,0.0399999991,0.0399999991);
                r14.w = saturate(1 + -r15.w);
              ...
              if (r15.x != 0) {
                ...
                r12.w = samp0[]..swiz;
                  ...
                  r15.z = (uint)r16.z >> 28;
                  r15.z = 1 << (int)r15.z;
                  r16.y = (int)r16.z & 4095;
                  r12.w = (int)r12.w & 1023;
                  r24.xz = (uint2)r14.ww;
                  r24.y = (uint)r15.z;
                  r17.zw = r17.xy * r24.zy + float2(0.5,0.5);
                  r25.xy = float2(-0.5,-0.5) + r24.zy;
                  r17.zw = min(r25.xy, r17.zw);
                  r25.x = (uint)r16.y;
                  r25.y = (uint)r15.w;
                  r15.zw = r25.xy + r17.zw;
                  ...
                  r24.xyz = r27.xyz * r24.xyz;
                  r12.w = materialTexMask.SampleGrad(samplerLinearClamp_s, r25.xyz, r26.x, r24.x).x;
                } else {
                  r14.w = cmp((int)r15.x == 6);
                  r12.w = r14.w ? 0 : 1;
                }
              } else {
                r12.w = 1;
              ...
              if (r15.y != 0) {
                ...
                r14.w = dot(r15.xy, r15.xy);
                r14.w = 1 + -r14.w;
                r14.w = max(0, r14.w);
                r14.w = sqrt(r14.w);
                r15.z = r15.z * r15.z;
                r15.z = 0.333333343 * r15.z;
                r15.z = min(1, r15.z);
                r15.w = dot(r20.xyz, r20.xyz);
                r15.w = rsqrt(r15.w);
                r16.xyz = r20.xyz * r15.www;
                r15.w = dot(-r19.xyz, -r19.xyz);
                r15.w = rsqrt(r15.w);
                r17.xyz = -r19.xyz * r15.www;
                ...
                r15.z = r15.z + r15.w;
                r15.z = log2(r15.z);
                r15.z = -0.0588235296 * r15.z;
                r12.w = max(0, r15.z);
                r15.yzw = r17.xyz * r15.yyy;
                r15.xyz = r16.xyz * r15.xxx + r15.yzw;
                r15.xyz = r18.xyz * r14.www + r15.xyz;
                r14.w = dot(r15.xyz, r15.xyz);
                r14.w = rsqrt(r14.w);
                r15.xyz = r15.xyz * r14.www;
                r14.w = 1 + -r13.w;
                r16.xyz = r14.www * r12.xyz;
                r12.xyz = r15.xyz * r13.www + r16.xyz;
              }
              r14.w = 1 + -r13.w;
              r15.xyz = r14.www * r8.xyz;
              r8.xyz = r14.xyz * r13.www + r15.xyz;
              r14.xyz = r14.www * r13.xyz;
              r13.xyz = r23.xyz * r13.www + r14.xyz;
              r9.w = r9.w * r14.w + r13.w;
              r14.x = r14.w * r10.w;
              r10.w = r12.w * r13.w + r14.x;
            }
          }
        }
      }
  ...
  r3.w = saturate(r3.w);
  r0.w = 1 + -r3.w;
  r3.xyz = colorTint.xyz * r0.www + r9.xyz;
  r0.z = r0.z * r0.w + r3.w;
  r1.xyz = r1.xyw * r0.www + r10.xyz;
  r1.w = dot(r1.xyz, r1.xyz);
  r1.w = rsqrt(r1.w);
  r1.xyz = r1.xyz * r1.www;
  r4.y = r0.x * r0.w + r4.w;
  r7.xyz = r0.www * float3(0.0799999982,0.0799999982,0.0799999982) + r11.xyz;
  r0.x = dot(-v7.xyz, -v7.xyz);
  r0.x = rsqrt(r0.x);
  r8.xyz = -v7.xyz * r0.xxx;
  ...
  r4.x = saturate(dot(r1.xyz, r8.xyz));
  r2.y = dot(-r8.xyz, r1.xyz);
  r2.y = r2.y + r2.y;
  r12.xyz = r1.xyz * -r2.yyy + -r8.xyz;
  r2.y = 17 * r4.y;
  r2.y = exp2(r2.y);
  r2.y = 2 + r2.y;
  r2.y = 2 / r2.y;
  ...
  r3.w = 100 * r3.w;
  r9.zw = -r4.zz * float2(10,5) + float2(6.85740995,7.08500004);
  r6.w = exp2(r9.z);
  r6.w = r6.w * r4.x;
  r6.w = 9.1368103 * r6.w;
  r7.w = r2.w * r4.z;
  r7.w = -r7.w * 2.0159049 + r9.w;
  r7.w = exp2(r7.w);
  r7.w = r7.w * r4.x;
  ...
  if (r7.w == 0) {
    ...
    r21.xyz = r23.xyz * r3.www;
    r4.z = cmp(r23.w < 0.99000001);
    if (r4.z != 0) {
      r4.z = 1 + -r23.w;
      r6.w = sunConstants.globalProbeExposure * r4.z;
      ...
      r1.w = dot(r11.yzw, float3(0.212599993,0.715200007,0.0722000003));
      r20.xyz = r22.xyz * r3.www + r11.yzw;
      r12.w = 0;
      ...
      r1.w = r4.y * r2.w + r1.w;
      r21.xyz = r11.yzw * r1.www + r21.xyz;
    }
  } else {
    r21.x = r20.w;
  }
  ...
  r13.xyz = r20.xyz * r0.yyy;
  r4.yz = r4.xy * float2(0.984375,0.984375) + float2(0.0078125,0.0078125);
  r4.yz = gEnvBRDFGlass.SampleLevel(samplerLinear_s, r4.yz, 0).xy;
  r11.yzw = r21.xyz * r1.www;
  r14.xyz = r11.zwy * r4.yyy;
  r11.yzw = r11.yzw * r4.zzz;
  r0.y = sqrt(r2.z);
  r0.y = r0.y * 0.5 + 0.5;
  r0.y = r0.y * r0.y;
  r1.w = 0.5 * r0.y;
  ...
  if (r4.y == 0) {
    ...
    r4.y = -sunConstants.splitDepthOffset + r15.z;
    ...
    if (r6.w != 0) {
      ...
      while (true) {
        ...
        if (r8.w != 0) break;
        r8.w = (uint)r6.w;
        r9.zw = -sunConstants.splitPinTransform[r8.w].xy + r15.xy;
    ...
    if (r8.w != 0) {
      ...
      r9.zw = sunConstants.sstLightingConstants.coordScale * r16.zy;
      r9.zw = floor(r9.zw);
    ...
    r9.w = samp0[]..swiz;
      ...
      r17.z = samp0[]..swiz;
        r9.zw = (uint2)r16.zy >> int2(6,6);
        r10.w = (int)r17.z & 0xc0000000;
        r15.w = (int)r17.x + 1;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r15.w, r15.w, l(0), t23.xxxx
      r15.w = samp0[]..swiz;
        r9.w = r9.w ? r17.z : r15.w;
        r15.w = (uint)r9.w >> 13;
        r9.z = r9.z ? r15.w : r9.w;
        r9.z = (int)r9.z & 8191;
      ...
      r18.z = samp0[]..swiz;
        ...
        r9.zw = (uint2)r16.zy >> (uint2)r19.yy;
      ...
      r16.w = samp0[]..swiz;
        r9.w = r9.w ? r18.z : r16.w;
        r16.w = (uint)r9.w >> 13;
        r9.z = r9.z ? r16.w : r9.w;
        r9.z = (int)r9.z & 8191;
        r19.x = (int)r9.z + (int)r18.x;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r19.w, r19.x, l(0), t23.xxxx
      r19.w = samp0[]..swiz;
        r18.xyz = r15.www ? r18.xyz : r19.xzw;
        r17.xyz = r10.www ? r17.xyz : r18.xyz;
        r9.z = (int)r17.z & 0xc0000000;
        if (r9.z == 0) {
          r9.z = (int)-r17.y + 6;
          r9.zw = (uint2)r16.zy >> (uint2)r9.zz;
        ...
        r18.w = samp0[]..swiz;
          ...
          r9.z = (int)-r18.y + 6;
          r9.zw = (uint2)r16.zy >> (uint2)r9.zz;
          r10.w = r18.w ? -2.000000 : 0;
          r15.w = (int)r18.w | 0x40000000;
          bitmask.w = ((~(-1 << 1)) << 1) & 0xffffffff;  r9.w = (((uint)r9.w << 1) & bitmask.w) | ((uint)0 & ~bitmask.w);
          bitmask.z = ((~(-1 << 1)) << 0) & 0xffffffff;  r9.z = (((uint)r9.z << 0) & bitmask.z) | ((uint)r9.w & ~bitmask.z);
          r9.z = (int)r9.z * 10;
          r9.z = (uint)r15.w >> (uint)r9.z;
          r9.z = (int)r9.z & 1023;
          r19.x = (int)r9.z + (int)r18.x;
        // Known bad code for instruction (needs manual fix):
        ...
        r19.z = samp0[]..swiz;
          ...
          bitmask.z = ((~(-1 << 1)) << 0) & 0xffffffff;  r9.z = (((uint)r9.z << 0) & bitmask.z) | ((uint)r9.w & ~bitmask.z);
          r9.z = (int)r9.z * 10;
          r9.z = (uint)r16.w >> (uint)r9.z;
          r9.z = (int)r9.z & 1023;
          r20.x = (int)r9.z + (int)r19.x;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r20.y, r20.x, l(0), t23.xxxx
        r20.y = samp0[]..swiz;
          r9.zw = r15.ww ? r19.xz : r20.xy;
        ...
        r15.w = samp0[]..swiz;
          ...
          r15.w = (uint)r15.w >> (uint)r16.x;
          r15.w = (int)r15.w & 255;
          r15.w = (uint)r15.w;
          r15.w = r15.w * r10.w;
          r15.w = r15.w * 0.00392156886 + r9.w;
          r16.x = (int)r16.y + 1;
        ...
        r10.w = samp0[]..swiz;
          ...
          r9.w = f16tof32(r9.w);
          r10.w = r15.x * r15.w + r10.w;
          r9.w = r15.y * r9.w + r10.w;
          r12.w = r9.z ? r9.w : r12.w;
        }
      }
      r9.z = -sunConstants.sstLightingConstants.constants.inchesPerTexel * 2 + r15.z;
      r9.z = cmp(r12.w < r9.z);
      r4.z = r9.z ? 0 : 1;
    }
    if (r8.w == 0) {
      if (enableDitheredShadow == 0) {
        ...
        r16.z = r8.w + r6.w;
        r8.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r4.y).x;
      ...
      if (enableDitheredShadow != 0) {
        ...
        r15.xy = -sunConstants.splitPinTransform[r6.w].xy + r15.xy;
        r15.xy = sunConstants.splitPinTransform[r6.w].zz * r15.xy;
        ...
        r12.w = 0;
        while (true) {
          r15.z = cmp((uint)r12.w >= 8);
          if (r15.z != 0) break;
          r15.z = cmp((uint)r7.w < (uint)r12.w);
          r17.xy = r15.zz ? r15.xy : r9.zw;
          r15.w = r15.z ? sunConstants.splitPinTransform[r6.w].w : sunConstants.splitPinTransform[r8.w].w;
          r15.z = r15.z ? r6.w : r8.w;
          ...
          r17.z = (uint)r15.z;
          r15.z = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r17.xyz, r4.y).x;
          r15.w = gTransShadowmapArray.SampleLevel(samp0_s, r17.xyz, 0).x;
          r15.z = r15.z + r15.w;
          r15.z = saturate(-1 + r15.z);
          r10.w = r15.z * 0.125 + r10.w;
          r12.w = (int)r12.w + 1;
        }
        r4.y = r10.w * r10.w;
        r4.z = r4.y * r10.w;
  ...
  if (r4.y != 0) {
    r4.y = cmp(0 < r4.z);
    if (r4.y != 0) {
      r4.y = sunConstants.specScale * r2.y;
      r4.y = r4.y * r3.w;
      if (sunConstants.sunCookieIndex != 0) {
        r5.w = 1;
        r6.w = dot(sunConstants.sunCookieTransform[0].xyzw, r5.xyzw);
      ...
      r18.w = samp0[]..swiz;
        ...
        r15.zw = cmp(r9.zw >= r15.zw);
        r15.xy = cmp(r15.xy >= r9.zw);
        r15.xy = (int2)r15.xy | (int2)r15.zw;
        r7.w = (int)r15.y | (int)r15.x;
        if (r7.w == 0) {
        // Known bad code for instruction (needs manual fix):
        ...
        r16.y = samp0[]..swiz;
          ...
          if (enableDitheredShadow != 0) {
            ...
            while (true) {
              r9.w = cmp((int)r9.z >= 8);
              if (r9.w != 0) break;
              r18.x = dot(icb[r9.z+0].yx, r16.xy);
              r18.y = dot(icb[r9.z+0].yx, r16.yz);
              r17.xy = r18.xy * r6.ww + r15.xy;
              r9.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r17.xyz, r5.w).x;
      ...
      r5.w = r5.w * r4.z;
      r2.w = cmp(0 < r2.w);
      r15.xyz = r5.www * r5.xyz + r13.xyz;
      r16.xyz = -v7.xyz * r0.xxx + sunConstants.wldDir.xyz;
      r0.x = dot(r16.xyz, r16.xyz);
      r0.x = rsqrt(r0.x);
      r16.xyz = r16.xyz * r0.xxx;
      r0.x = dot(r16.xyz, r8.xyz);
      r5.w = dot(r1.xyz, r16.xyz);
      ...
      r3.w = r4.z * r3.w;
      r3.w = 0.25 * r3.w;
      r16.xyz = r3.www * r5.xyz + r11.yzw;
      r0.x = saturate(1 + -r0.x);
      r0.x = log2(r0.x);
      r0.x = 3.4000001 * r0.x;
      r0.x = exp2(r0.x);
      r0.x = r3.w * r0.x;
      r5.xyz = r0.xxx * r5.yzx + r14.xyz;
      r15.w = r5.z;
      r13.w = r14.z;
      r13.xyzw = r2.wwww ? r15.xyzw : r13.xyzw;
      r5.zw = r16.xy;
      r14.zw = r11.yz;
      r5.xyzw = r2.wwww ? r5.xyzw : r14.xyzw;
      r11.w = r2.w ? r16.z : r11.w;
      r14.z = r13.w;
      r14.xy = r5.xy;
      r11.yz = r5.zw;
    }
  ...
  while (true) {
    ...
    if (r7.w != 0) break;
    r4.z = (uint)r6.w >> 5;
    r15.xyz = (int3)r4.xyz + (int3)r6.xyz;
    r4.z = visibleLights.Load(r15.xyzw).x;
    r15.xyz = r26.xyz;
    r29.xyz = r27.xyz;
    r30.xyz = r28.xyz;
    r7.w = r3.w;
    ...
    while (true) {
      ...
      if (r10.w != 0) {
        ...
        r9.z = (int)r6.w + (int)r9.z;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=80)(mixed,mixed,mixed,mixed) r31.xyzw, r9.z, l(0), t11.xyzw
      r31.x = samp0[]..swiz;
      r31.y = samp0[]..swiz;
      r31.z = samp0[]..swiz;
      r31.w = samp0[]..swiz;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=80)(mixed,mixed,mixed,mixed) r32.xy, r9.z, l(16), t11.xyxx
      r32.x = samp0[]..swiz;
      r32.y = samp0[]..swiz;
        ...
        if (r9.w != 0) {
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r31.xyzw, r9.z, l(0), t12.wxyz
        r31.x = samp0[]..swiz;
        r31.y = samp0[]..swiz;
        r31.z = samp0[]..swiz;
        r31.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r32.xyzw, r9.z, l(16), t12.zxyw
        r32.x = samp0[]..swiz;
        r32.y = samp0[]..swiz;
        r32.z = samp0[]..swiz;
        r32.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r33.xyzw, r9.z, l(32), t12.xyzw
        r33.x = samp0[]..swiz;
        r33.y = samp0[]..swiz;
        r33.z = samp0[]..swiz;
        r33.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r34.xyzw, r9.z, l(48), t12.xyzw
        r34.x = samp0[]..swiz;
        r34.y = samp0[]..swiz;
        r34.z = samp0[]..swiz;
        r34.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r35.xyzw, r9.z, l(64), t12.yzwx
        r35.x = samp0[]..swiz;
        r35.y = samp0[]..swiz;
        r35.z = samp0[]..swiz;
        r35.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r36.xyzw, r9.z, l(80), t12.xyzw
        r36.x = samp0[]..swiz;
        r36.y = samp0[]..swiz;
        r36.z = samp0[]..swiz;
        r36.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r37.xyzw, r9.z, l(96), t12.yzwx
        r37.x = samp0[]..swiz;
        r37.y = samp0[]..swiz;
        r37.z = samp0[]..swiz;
        r37.w = samp0[]..swiz;
          ...
          switch (r9.w) {
            ...
            if (r23.w != 0) {
              ...
              if (r23.w != 0) {
                ...
                if (r23.w != 0) {
                  r23.w = r32.x * r2.y;
                  r23.w = 0.25 * r23.w;
                  r24.w = dot(r38.xyz, r12.xyz);
                  r26.w = dot(r12.xyz, r40.xyz);
                  r27.w = -r24.w * r24.w + r37.x;
                  r10.w = r24.w * r26.w + -r10.w;
                  r10.w = saturate(r10.w / r27.w);
                  r24.w = r27.w / r37.x;
                  r24.w = 10 * r24.w;
                  r24.w = min(1, r24.w);
                  r10.w = r10.w + -r12.w;
                  r10.w = r24.w * r10.w + r12.w;
                    ...
                    r10.w = samp0[]..swiz;
                      ...
                      if (r7.w != 0) {
                        ...
                        while (true) {
                          ...
                          r42.y = dot(icb[r17.z+0].xy, r9.xy);
                      ...
                      r10.w = samp0[]..swiz;
                        ...
                        if (r7.w != 0) {
                          ...
                          while (true) {
                            ...
                            if (r26.w != 0) break;
                            r41.x = dot(icb[r24.w+0].xy, r10.xy);
                            r41.y = dot(icb[r24.w+0].yx, r10.xz);
                            r18.xy = r41.xy * r12.ww + r40.xy;
                  ...
                  r10.w = r10.w + -r19.w;
                  r10.w = r2.z * r10.w + r19.w;
                  r10.w = r10.w * r13.w;
                  r32.x = r31.x;
                  r12.w = cmp(0 < r14.w);
                  r18.xyz = r10.www * r32.xyz + r15.xyz;
                  r10.w = saturate(dot(r1.xyz, r39.xyz));
                  r38.xyz = r38.xyz * r9.www + r8.xyz;
                  r9.w = dot(r38.xyz, r38.xyz);
                  r9.w = rsqrt(r9.w);
                  r38.xyz = r38.xyz * r9.www;
                  r9.w = dot(r38.xyz, r8.xyz);
                  r14.w = dot(r1.xyz, r38.xyz);
                  r17.x = abs(r14.w) * r2.y + -abs(r14.w);
                  r14.w = abs(r14.w) * r17.x + 1;
                  r17.x = r10.w * r0.y + r1.w;
                  r14.w = r14.w * r14.w;
                  r14.w = r14.w * r17.x;
                  r14.w = rcp(r14.w);
                  r10.w = r10.w * r23.w;
            ...
            r9.w = rsqrt(r9.w);
            r38.xyz = r18.xyz * r9.www;
            r10.w = dot(r1.xyz, r38.xyz);
            r12.w = saturate(r10.w);
            r13.w = cmp(0 < r12.w);
            if (r13.w != 0) {
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r38.xyzw, r9.z, l(112), t12.yzwx
            r38.x = samp0[]..swiz;
            r38.y = samp0[]..swiz;
            r38.z = samp0[]..swiz;
            r38.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r39.xyzw, r9.z, l(128), t12.zxyw
            r39.x = samp0[]..swiz;
            r39.y = samp0[]..swiz;
            r39.z = samp0[]..swiz;
            r39.w = samp0[]..swiz;
              ...
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r42.xyzw, r9.z, l(172), t12.yzwx
              r42.x = samp0[]..swiz;
              r42.y = samp0[]..swiz;
              r42.z = samp0[]..swiz;
              r42.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r43.xyzw, r9.z, l(188), t12.wxyz
              r43.x = samp0[]..swiz;
              r43.y = samp0[]..swiz;
              r43.z = samp0[]..swiz;
              r43.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r44.xyzw, r9.z, l(204), t12.xyzw
              r44.x = samp0[]..swiz;
              r44.y = samp0[]..swiz;
              r44.z = samp0[]..swiz;
              r44.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r17.x, r9.z, l(236), t12.xxxx
              r17.x = samp0[]..swiz;
                ...
                if (r13.w != 0) {
                // Known bad code for instruction (needs manual fix):
                                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r33.xyz, r9.z, l(220), t12.xyzx
                r33.x = samp0[]..swiz;
                r33.y = samp0[]..swiz;
                r33.z = samp0[]..swiz;
              ...
              if (r13.w != 0) {
                ...
                if (r13.w != 0) {
                  ...
                  if (r23.w != 0) {
                  // Known bad code for instruction (needs manual fix):
                                    ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r39.y, r9.z, l(144), t12.xxxx
                  r39.y = samp0[]..swiz;
                    r35.w = r36.x;
                    ...
                    if (r7.w != 0) {
                      ...
                      while (true) {
                        ...
                        r24.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r31.xyz, r9.z).x;
                        r17.x = r24.w * 0.125 + r17.x;
                        r23.w = (int)r23.w + 1;
                      }
                    } else {
                      r20.z = (uint)r13.w;
                      r17.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r20.xyz, r9.z).x;
                    }
                    r9.z = r17.x * r17.x;
                    r9.z = r9.z * r17.x;
                  } else {
                ...
                if (r13.w != 0) {
                  ...
                  r14.w = r14.w + -r12.w;
                  r14.w = r2.z * r14.w + r12.w;
                  r14.w = r14.w * r9.z;
                  r10.w = cmp(0 < r10.w);
                  r21.xyz = r14.www * r19.xyw + r15.xyz;
                  r18.xyz = r18.xyz * r9.www + r8.xyz;
                  r9.w = dot(r18.xyz, r18.xyz);
                  r9.w = rsqrt(r9.w);
                  r18.xyz = r18.xyz * r9.www;
                  r9.w = dot(r18.xyz, r8.xyz);
                  r14.w = dot(r1.xyz, r18.xyz);
                  r18.x = abs(r14.w) * r2.y + -abs(r14.w);
                  r14.w = abs(r14.w) * r18.x + 1;
                  r12.w = r12.w * r0.y + r1.w;
                  r14.w = r14.w * r14.w;
                  r12.w = r14.w * r12.w;
                  r12.w = rcp(r12.w);
                  r12.w = r12.w * r13.w;
                  r9.z = r12.w * r9.z;
                  r9.z = 0.25 * r9.z;
                  r18.xyz = r9.zzz * r19.xyw + r30.xyz;
                  r9.w = saturate(1 + -r9.w);
                  r9.w = log2(r9.w);
                  r9.w = 3.4000001 * r9.w;
                  r9.w = exp2(r9.w);
                  r9.z = r9.z * r9.w;
                  r19.xyw = r9.zzz * r19.xyw + r29.xyz;
                  r15.xyz = r10.www ? r21.xyz : r15.xyz;
                  r29.xyz = r10.www ? r19.xyw : r29.xyz;
                  r30.xyz = r10.www ? r18.xyz : r30.xyz;
                }
              }
            }
            break;
  ...
  r0.xyw = float3(1,1,1) + -r7.xyz;
  r0.xyw = r27.xyz * r0.xyw;
  r0.xyw = r28.xyz * r7.xyz + r0.xyw;
  r0.xyw = r26.xyz * r3.xyz + r0.xyw;
  r1.x = log2(r4.w);
  r1.x = 3.4000001 * r1.x;
  r1.x = exp2(r1.x);
  r1.y = 1 + -r0.z;
  ...
  if (r0.z != 0) {
    ...
    if (r2.w != 0) {
      ...
      r2.w = r0.z * fogConstants.atmospherefogdistancedensityscale.x + fogConstants.atmospherefogdistanceoffset.x;
    ...
    r3.x = sqrt(r2.w);
    r0.z = r0.z * r3.x + fogConstants.expAdd;
    r0.z = exp2(r0.z);
    r0.z = min(1, r0.z);
    r0.z = 1 + -r0.z;
    r2.w = rsqrt(r2.w);
