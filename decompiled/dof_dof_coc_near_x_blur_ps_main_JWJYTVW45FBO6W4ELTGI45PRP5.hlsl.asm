...
add r1.xyzw, v1.xxxx, cb8[0].zxwy
mov r2.xz, r1.yywy
mov r2.yw, v1.yyyy
...
mul r0.y, r0.y, l(0.234375)
mad r0.x, r0.x, l(0.01953125), r0.y
mad r0.x, r0.z, l(0.49218750), r0.x
mov r1.yw, v1.yyyy
...
mad r0.x, r0.y, l(0.234375), r0.x
mad r0.x, r0.z, l(0.01953125), r0.x
sample_indexable(texture2d)(float,float,float,float) r0.y, v1.zwzz, t1.yxzw, s0
max r0.x, r0.x, r0.y
mad o0.x, r0.x, l(2.000000), -r0.y
ret 
