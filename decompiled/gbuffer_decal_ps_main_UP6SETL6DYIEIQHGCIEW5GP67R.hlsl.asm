...
sample_indexable(texture2d)(float,float,float,float) r2.x, v1.yzyy, t12.xyzw, s4
sample_indexable(texture2d)(float,float,float,float) r2.y, v1.yzyy, t11.yxzw, s2
...
movc r4.xyz, v5.xxxx, v2.xyzx, -v2.xyzx
...
ftou r4.xy, v0.xyxx
mov r4.zw, l(0,0,0,0)
ld_indexable(texture2d)(float,float,float,float) r0.xy, r4.xyzw, t0.zwxy
...
mad r3.z, r1.w, l(0.49755621), r0.x
...
mad r2.xy, r0.xyxx, l(1.000000, 0.500000, 0.000000, 0.000000), l(0.000000, 0.500000, 0.000000, 0.000000)
mov r2.w, l(1.000000)
mul o2.xyzw, r0.wwww, r2.xyzw
mov o0.w, r0.w
mov o1.w, r0.w
ret 
