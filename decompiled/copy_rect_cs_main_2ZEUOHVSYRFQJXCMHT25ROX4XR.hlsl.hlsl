...
Texture2DArray<uint4> TexSrc : register(t0);
...
// unknown dcl_: dcl_thread_group 8, 8, 1
  r0.xyz = (uint3)vThreadGroupID.xyz << int3(3,3,0);
  r0.xyz = (int3)r0.xyz + (int3)vThreadIDInGroup.xyz;
  r1.xyz = cmp((uint3)r0.xyz < (uint3)postFxConst00.xyz);
  r0.w = r1.y ? r1.x : 0;
  r0.w = r1.z ? r0.w : 0;
  if (r0.w != 0) {
    r1.xyzw = (int4)r0.xyzz + (int4)postFxConst02.xyzz;
    r0.xyz = (int3)r0.xyz + (int3)postFxConst01.xyz;
    r0.w = 0;
    r0.xyzw = TexSrc.Load(r0.xyzw).xyzw;
