...
//   float4 postFxBloom08;              // Offset: 1408 Size:    16
//   float4 postFxBloom09;              // Offset: 1424 Size:    16
...
dcl_constantbuffer CB8[90], immediateIndexed
...
mul r0.w, r0.w, l(0.07692308)
mul r0.xyz, r0.xyzx, cb8[88].xyzx
mul r1.xyz, r0.wwww, cb8[89].xyzx
mad r0.xyz, r0.xyzx, l(0.07692308, 0.07692308, 0.07692308, 0.000000), r1.xyzx
