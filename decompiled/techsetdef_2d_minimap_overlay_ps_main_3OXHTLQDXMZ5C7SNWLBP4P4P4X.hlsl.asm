...
// minimapMask                       texture  float4          2d             t6      1 
...
dcl_output o0.xyzw
dcl_temps 3
sample_indexable(texture2d)(float,float,float,float) r0.x, v2.xyxx, t6.wxyz, s1
add r0.y, r0.x, l(-0.50196081)
mov o0.w, r0.x
lt r0.x, r0.y, l(0.000000)
discard_nz r0.x
add r0.xy, v2.xyxx, l(-0.500000, -0.500000, 0.000000, 0.000000)
mul r0.x, r0.x, cb3[1].y
sincos r1.x, r2.x, cb3[1].x
mul r0.z, r0.y, r1.x
mul r0.y, r0.y, r2.x
mad r1.y, r0.x, r1.x, r0.y
mad r0.x, r0.x, r2.x, -r0.z
div r1.x, r0.x, cb3[1].y
mad r0.xy, r1.xyxx, cb3[0].zwzz, cb3[0].xyxx
