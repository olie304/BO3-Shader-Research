...
cbuffer _Globals : register(b0)
{
  ...
  float scriptHDRControl : packoffset(c26.w);
}
...
r8.x = samp0[]..swiz;
r8.y = samp0[]..swiz;
  r8.yz = (int2)r8.yy & int2(268435456,536870912);
  if (r8.y != 0) {
    ...
    while (true) {
      ...
      r8.y = cmp((int)r4.w == (int)r6.w);
      if (r5.w == 0) r8.w = 0; else if (r5.w+0 < 32) {       r8.w = (uint)r7.w << (32-(r5.w + 0)); r8.w = (uint)r8.w >> (32-r5.w);      } else r8.w = (uint)r7.w >> 0;
      r7.w = r8.y ? r8.w : r7.w;
      r8.y = (int)r3.w + (int)r6.w;
      r17.xyzw = r13.xzwy;
      r12.xyz = r14.xyz;
      r18.yz = r15.yz;
      r19.xy = r16.xy;
        ...
        r21.y = samp0[]..swiz;
          ...
          r22.z = samp0[]..swiz;
            ...
            r25.w = samp0[]..swiz;
              ...
              r22.z = samp0[]..swiz;
              r22.w = samp0[]..swiz;
                r27.x = dot(r6.xyz, r26.xyz);
                r27.y = dot(r6.xyz, r25.xyz);
                r28.x = dot(r7.xyz, r26.xyz);
                r28.y = dot(r7.xyz, r25.xyz);
  ...
  if (r8.z != 0) {
    ...
    r8.z = r5.w;
    while (true) {
      r8.w = cmp((uint)r8.z >= (uint)r4.w);
      if (r8.w != 0) break;
      r11.z = (uint)r8.z >> 5;
      r12.xyz = (int3)r10.xyz + (int3)r11.xyz;
      r8.w = visibleDecals.Load(r12.xyzw).x;
      r10.w = cmp((int)r5.w == (int)r8.z);
      bitmask.z = ((~(-1 << r6.w)) << 0) & 0xffffffff;  r11.z = (((uint)0 << 0) & bitmask.z) | ((uint)r8.w & ~bitmask.z);
      r8.w = r10.w ? r11.z : r8.w;
      r10.w = cmp((int)r7.w == (int)r8.z);
      if (r8.y == 0) r11.z = 0; else if (r8.y+0 < 32) {       r11.z = (uint)r8.w << (32-(r8.y + 0)); r11.z = (uint)r11.z >> (32-r8.y);      } else r11.z = (uint)r8.w >> 0;
      r8.w = r10.w ? r11.z : r8.w;
      r10.w = (int)r3.w + (int)r8.z;
      r12.xyz = r17.xyz;
      r21.xyz = r18.xyz;
      r22.xyz = r19.xyz;
      r11.zw = r20.xy;
        ...
        r24.y = samp0[]..swiz;
          ...
          r25.z = samp0[]..swiz;
            ...
            r28.w = samp0[]..swiz;
              ...
              r25.z = samp0[]..swiz;
              r25.w = samp0[]..swiz;
                r30.x = dot(r6.xyz, r29.xyz);
                r30.y = dot(r6.xyz, r28.xyz);
                r31.x = dot(r7.xyz, r29.xyz);
                r31.y = dot(r7.xyz, r28.xyz);
  ...
  r2.y = 1 + -r13.x;
  r0.xyz = r0.xyz * r2.yyy + r14.xyz;
  r0.w = r0.w * r2.y + r13.x;
  r1.yzw = r1.yzw * r2.yyy + r15.xyz;
  r3.w = dot(r1.yzw, r1.yzw);
  r3.w = rsqrt(r3.w);
  r6.xyz = r3.www * r1.yzw;
  r1.y = r1.x * r2.y + r13.y;
  r7.xyz = r2.yyy * float3(0.0399999991,0.0399999991,0.0399999991) + r16.xyz;
// Known bad code for instruction (needs manual fix):
...
r1.z = samp0[]..swiz;
  ...
  if (r1.w != 0) {
    ...
    r8.zw = -r10.xy / r1.ww;
    r8.zw = r3.ww ? r8.zw : 0;
    r9.xy = float2(-0.5,-0.5) + w1.xy;
    r1.w = 9.99999975e-06 + layerDepth;
    r8.zw = r8.zw * r1.ww;
    r8.zw = scaleUVs.xy * r8.zw;
    r8.zw = r9.xy * scaleUVs.xy + r8.zw;
    ...
    r10.y = r10.x;
    r10.z = r9.x;
    r11.x = dot(r10.yz, r8.zw);
    r10.x = -r9.x;
    r11.y = dot(r10.xy, r8.zw);
    r8.zw = gameTime.ww * scrollUVs.xy;
    r8.zw = r8.zw * scaleUVs.xy + r11.xy;
    ...
    r9.xy = saturate(r8.zw);
    r8.xy = clampU ? r9.xy : r8.zw;
  }
  r8.xyzw = emissiveMap1.Sample(colorSampler_s, r8.xy).xyzw;
  r8.xyz = emissiveTint1.xyz * r8.xyz;
  r1.w = r8.w * r1.z;
