...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:42:31 2021
//
//
// Buffer Definitions: 
//
...
//   float2 wind1Parms;                 // Offset:  184 Size:     8
//   float2 wind2Parms;                 // Offset:  192 Size:     8
//   float2 wind3Parms;                 // Offset:  200 Size:     8
//   uint zFeatherComputeSprites;       // Offset:  208 Size:     4 [unused]
//   float hdrScale;                    // Offset:  212 Size:     4 [unused]
//   float emissiveFalloffPower;        // Offset:  216 Size:     4 [unused]
//   float3 emissiveTint1;              // Offset:  224 Size:    12 [unused]
//   bool relativeHDR;                  // Offset:  236 Size:     4 [unused]
//   bool invertFalloff;                // Offset:  240 Size:     4 [unused]
...
mul r1.w, cb0[11].z, l(27.239243)
mul r3.z, r2.x, cb0[11].w
mul r5.xy, cb0[12].xzxx, l(25.132742, 34.456177, 0.000000, 0.000000)
mul r5.zw, r3.xxxy, cb0[12].yyyw
mul r3.x, r3.x, r5.x
