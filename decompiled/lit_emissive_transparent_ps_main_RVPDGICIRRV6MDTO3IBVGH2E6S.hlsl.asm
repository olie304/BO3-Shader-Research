...
mad r2.yz, r3.xxyx, l(0.000000, 1.99218750, 1.99218750, 0.000000), l(0.000000, -1.000000, -1.000000, 0.000000)
...
mad r2.x, cb1[62].x, r2.x, cb0[10].y
...
if_nz r2.y
  ...
  movc r1.xyz, r2.zzzz, r3.xywx, r8.xyzx
endif 
add r3.xyw, -r1.xyxz, cb1[58].xyxz
mad r1.xyz, cb1[58].wwww, r3.xywx, r1.xyzx
add r2.y, -r2.w, cb1[59].x
mad r2.y, cb1[59].w, r2.y, r2.w
...
add r2.x, -r0.x, cb1[63].x
mad r0.x, cb1[63].w, r2.x, r0.x
movc r2.xzw, v7.xxxx, v3.xxyz, -v3.xxyz
dp3 r4.w, r2.xzwx, r2.xzwx
rsq r4.w, r4.w
mad r2.xzw, r2.xxzw, r4.wwww, -r7.xxyz
mad r2.xzw, cb1[60].wwww, r2.xxzw, r7.xxyz
...
mad r2.y, r2.y, r0.y, r14.x
mad r2.xzw, r2.xxzw, r0.yyyy, r16.xxyz
dp3 r3.z, r2.xzwx, r2.xzwx
rsq r3.z, r3.z
mul r8.xyz, r2.xzwx, r3.zzzz
mad r9.y, r1.w, r0.y, r14.y
mad r2.xzw, r3.xxyw, r0.yyyy, r17.xxyz
mov_sat r0.z, r0.z
mul r0.z, r0.z, cb0[11].x
eq r3.xyz, r0.wwww, l(3.000000, 2.000000, 1.000000, 0.000000)
lt r0.w, r0.w, l(0.000000)
movc r10.xyz, r0.wwww, l(1.000000,1.000000,1.000000,0), cb0[12].xyzx
movc r10.xyz, r3.zzzz, cb0[15].xyzx, r10.xyzx
...
add r3.w, cb0[13].y, l(0.000010)
mad r4.xy, r4.xyxx, r3.wwww, v1.yzyy
sample_indexable(texture2d)(float,float,float,float) r5.xyzw, r4.xyxx, t29.xyzw, s1
...
exp r1.w, r1.w
movc r1.w, cb0[13].x, r1.w, r3.w
eq r3.w, cb0[11].y, l(0.000000)
...
mul r0.x, r0.x, r0.x
mul r5.z, r0.x, l(0.500000)
mad r0.x, -r0.x, l(0.500000), l(1.000000)
mad r5.w, r9.x, r0.x, r5.z
mul r0.x, r0.x, r5.w
mul r5.z, r5.w, r5.z
...
if_nz r7.w
  ...
  if_nz r7.w
    ...
    mad r11.y, |r10.w|, r0.z, -|r10.w|
    mad r10.w, |r10.w|, r11.y, l(1.000000)
    mad r6.w, r6.w, r0.x, r5.z
    mul r10.w, r10.w, r10.w
    mul r6.w, r6.w, r10.w
    rcp r6.w, r6.w
    mul r6.w, r7.w, r6.w
...
loop 
  ...
  iadd r7.w, r7.w, l(32)
endloop 
add r0.xyz, -r2.xzwx, l(1.000000, 1.000000, 1.000000, 0.000000)
mul r0.xyz, r0.xyzx, r27.xyzx
mad r0.xyz, r28.xyzx, r2.xzwx, r0.xyzx
...
ret 
// Approximately 2963 instruction slots used
