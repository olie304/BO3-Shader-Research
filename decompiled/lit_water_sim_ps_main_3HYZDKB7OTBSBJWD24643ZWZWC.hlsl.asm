...
loop 
  ...
  ieq r14.w, r11.w, r13.w
  bfi r15.x, r13.x, l(0), l(0), r14.z
  movc r14.z, r14.w, r15.x, r14.z
  ieq r14.w, r13.y, r13.w
  ubfe r15.x, r13.z, l(0), r14.z
  movc r14.z, r14.w, r15.x, r14.z
  iadd r14.w, r13.w, cb2[0].x
    ...
    if_nz r16.w
      ...
      if_nz r15.z
        ...
        loop 
          ...
          movc r6.y, r28.z, r18.w, r28.w
          movc r28.xy, r27.wwww, r28.xyxx, r6.xyxx
        ...
        if_nz r15.z
          ...
          sqrt r15.y, r15.y
          mad r15.y, r10.y, l(5.000000), r15.y
...
if_nz r6.x
  ...
  mov r16.w, l(0)
  loop 
    uge r17.w, r16.w, r11.z
    breakc_nz r17.w
    ushr r14.z, r16.w, l(5)
    iadd r15.xyz, r4.xyzx, r14.xyzx
    ld_indexable(texture2darray)(uint,uint,uint,uint) r14.z, r15.xyzw, t7.yzxw
    ieq r15.x, r11.w, r16.w
    ubfe r15.y, r13.x, l(0), r14.z
      ...
      if_nz r19.w
        ...
        if_nz r18.w
          ...
          loop 
            ...
            movc r6.y, r30.x, r25.w, r30.y
            movc r29.xy, r29.wwww, r29.xyxx, r6.xyxx
            iadd r24.w, r24.w, l(1)
            mov r16.x, r29.z
          endloop 
          add_sat r6.y, -r15.y, r29.y
          ...
          if_nz r18.w
            ...
            sqrt r16.x, r16.x
            mad r16.x, r10.y, l(5.000000), r16.x
            ...
            div r6.y, r17.z, r6.y
            mad r23.xyz, r25.xyzx, r6.yyyy, r23.xyzx
          endif 
        endif 
      endif 
    endloop 
...
max r4.x, r21.w, l(1.000000)
rcp r4.x, r4.x
mov_sat r21.w, r21.w
mul r11.yzw, r4.xxxx, r20.xxyz
mul r13.xyz, r4.xxxx, r21.xyzx
lt r4.y, r21.w, l(0.990000)
if_nz r4.y
  add r4.y, -r21.w, l(1.000000)
  ...
  mad r11.yzw, r20.xxyz, r4.xxxx, r14.xxyz
  mov r12.w, l(0)
  ...
  mad r13.xyz, r10.yzwy, r2.wwww, r13.xyzx
endif 
if_nz cb0[28].z
  ...
  if_nz cb0[28].w
    ...
    mul r12.xyz, r4.xyzx, cb0[21].zzzz
    ...
    mad r10.yzw, r12.xxyz, l(0.000000, 10.000000, 10.000000, 10.000000), r10.yyzw
    ...
    loop 
      ...
      max r6.x, |r16.y|, |r16.x|
      lt r6.x, r16.z, r6.x
      if_nz r6.x
        break 
      endif 
      div r6.xy, r16.xyxx, r16.zzzz
      ...
      if_nz r6.y
        ...
        mad r16.xyz, -r6.xxxx, r12.xyzx, r15.xyzx
        ...
        div r6.xy, r16.xyxx, r16.zzzz
        mad r6.xy, r6.xyxx, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
        sample_l_indexable(texture2d)(float,float,float,float) r16.xyz, r6.xyxx, t30.xyzw, s8, l(0.000000)
    ...
    if_nz r2.w
      mul r13.xyz, r4.xyzx, cb1[85].xxxx
    endif 
  endif 
endif 
...
if_z r4.y
  ...
  if_nz r4.w
    ...
    loop 
      ...
      breakc_nz r6.y
      ftou r6.y, r4.w
      add r12.xy, r10.yzyy, -cb2[r6.y + 20].xyxx
      max r12.x, |r12.y|, |r12.x|
      mul r6.x, r12.x, cb2[r6.y + 20].z
  ...
  if_nz r6.y
    ...
    rcp r14.xz, r12.xxxx
    mov r14.y, -r14.z
    mad r12.xyz, r10.yzyy, r14.xyzx, r12.yzyy
    ...
    mul r14.xy, r12.zyzz, cb2[32].xxxx
    round_ni r14.xy, r14.xyxx
    mul r12.w, r14.y, cb2[27].x
    mad r12.w, r12.w, cb2[32].x, r14.x
    ftou r12.w, r12.w
    ...
    if_z r14.x
      ...
      ushr r14.xz, r12.zzyz, l(6, 0, 6, 0)
      ...
      mov r15.y, l(0)
      mov r16.y, l(1)
      movc r14.xzw, r12.wwww, r15.xxyz, r16.xxyz
      movc r16.yz, r12.wwww, l(0,6,1,0), l(0,5,2,0)
      ushr r17.xy, r12.zyzz, r16.yyyy
      ...
      movc r14.xzw, r12.wwww, r15.xxyz, r14.xxzw
      and r12.w, r14.w, l(0xc0000000)
      if_z r12.w
        iadd r12.w, -r14.z, l(6)
        ...
        ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r16.z, r16.x, l(0), t23.xxxx
        mov r16.y, r15.z
        movc r16.xyz, r12.wwww, r15.xywx, r16.xyzx
        iadd r13.w, -r16.y, l(6)
        ushr r15.yz, r12.zzyz, r13.wwww
        ...
        movc r14.xw, r12.wwww, r15.xxxw, r15.yyyz
      endif 
      and r12.w, r14.w, l(0xc0000000)
      if_z r12.w
        ...
        ushr r12.x, r15.x, r16.x
        and r12.x, r12.x, l(255)
        utof r12.x, r12.x
        mul r12.x, r14.z, r12.x
        mad r12.x, r12.x, l(0.00392157), r13.w
        ...
        utof r12.y, r12.y
        mul r12.y, r14.z, r12.y
        mad r12.y, r12.y, l(0.00001526), r13.w
        movc r14.y, r15.y, r12.x, r12.y
      else 
        and r12.x, r14.w, l(0x80000000)
        iadd r12.y, r14.x, l(1)
        ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r12.y, r12.y, l(0), t23.xxxx
        movc r12.x, r12.x, r12.y, l(0)
        ishl r12.y, r14.w, l(2)
        ushr r12.z, r12.x, l(16)
        and r12.x, r12.x, l(0x0000ffff)
        f16tof32 r12.xz, r12.xxzx
        mad r12.y, r10.y, r12.z, r12.y
        mad r12.x, r10.z, r12.x, r12.y
        movc r14.y, r12.w, r12.x, r14.y
      endif 
    endif 
  ...
  if_z r6.y
    if_z cb2[58].y
      ftou r6.y, r4.w
      add r12.xy, r10.yzyy, -cb2[r6.y + 20].xyxx
      mul r12.xy, r12.xyxx, cb2[r6.y + 20].zzzz
    ...
    if_nz cb2[58].y
      ...
      ftou r6.x, r6.x
      add r14.xy, r10.yzyy, -cb2[r6.y + 20].xyxx
      ...
      loop 
        uge r13.w, r12.w, l(8)
        breakc_nz r13.w
        ult r13.w, r6.x, r12.w
        movc r14.zw, r13.wwww, r10.yyyz, r14.xxxy
        movc r15.x, r13.w, cb2[r4.w + 20].w, cb2[r6.y + 20].w
        movc r13.w, r13.w, r4.w, r6.y
        ...
        utof r15.z, r13.w
        sample_c_lz_indexable(texture2darray)(float,float,float,float) r13.w, r15.xyzx, t13.xxxx, s13, r4.y
...
if_nz r4.w
  ...
  div r12.xy, r4.wwww, r17.xzxx
  add r12.zw, -r12.xxxy, l(0.000000, 0.000000, 1.000000, 1.000000)
  ge r12.zw, r6.xxxy, r12.zzzw
  ge r12.xy, r12.xyxx, r6.xyxx
  or r12.xy, r12.xyxx, r12.zwzz
  or r10.w, r12.y, r12.x
  ...
  if_z r10.z
    ...
    mul r4.y, r10.y, r12.y
    mad r2.w, r12.x, r10.y, r2.w
    div r2.w, r2.w, r4.y
    ...
    if_nz cb2[58].y
      ...
      loop 
        ige r10.x, r6.y, l(8)
        breakc_nz r10.x
        dp2 r10.x, icb[r6.y + 0].yxyy, r12.xyxx
        dp2 r10.y, icb[r6.y + 0].yxyy, r12.yzyy
        mad r15.xy, r10.xyxx, r4.wwww, r14.xyxx
        sample_c_lz_indexable(texture2darray)(float,float,float,float) r10.x, r15.xyzx, t9.xxxx, s13, r2.w
...
if_nz r4.y
  ...
  add r3.w, r4.x, r9.w
  div r3.w, r4.x, r3.w
  mad r4.yzw, r3.xxyz, r3.wwww, r11.yyzw
  ...
  mad r9.xyz, r9.xyzx, r4.xxxx, r13.xyzx
...
movc r4.xyz, r2.wwww, r4.yzwy, r11.yzwy
movc r3.xyz, r2.wwww, r3.xyzx, r13.xyzx
...
mul r10.xyz, r6.xywx, r10.xyzx
mul r0.x, r9.w, r10.w
mad r9.xyz, r9.xyzx, r4.xyzx, -r10.xyzx
mad r9.xyz, r0.xxxx, r9.xyzx, r10.xyzx
mad r2.xyz, -r2.xyzx, cb1[85].xxxx, r9.xyzx
mad r2.xyz, r1.wwww, r2.xyzx, r6.xywx
mad r6.xyw, r8.xyxz, r4.xyxz, -r2.xyxz
mad r2.xyz, r7.xxxx, r6.xywx, r2.xyzx
