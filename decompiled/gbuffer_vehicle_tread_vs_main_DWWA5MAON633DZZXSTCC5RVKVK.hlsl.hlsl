...
r2.y = colorSampler[]..swiz;
  if (r2.x != 0) {
    ...
    r6.x = colorSampler[]..swiz;
    r6.y = colorSampler[]..swiz;
    r6.z = colorSampler[]..swiz;
    r6.w = colorSampler[]..swiz;
      r2.z = dot(r6.xyz, v0.xyz);
      r2.z = r2.z + r6.w;
      r4.y = v5.x * r2.z;
    ...
    r6.w = colorSampler[]..swiz;
      ...
      r6.w = colorSampler[]..swiz;
        ...
        r6.w = colorSampler[]..swiz;
          ...
          r6.z = colorSampler[]..swiz;
          r6.w = colorSampler[]..swiz;
            r2.x = dot(r6.xyz, v0.xyz);
            r2.x = r2.x + r6.w;
            r4.x = r2.x * v5.w + r4.x;
            r2.x = dot(r6.xyz, r0.xyz);
            r5.x = r2.x * v5.w + r5.x;
  ...
  r2.xzw = r1.yzx * r0.zxy;
  r2.xzw = r0.yzx * r1.zxy + -r2.xzw;
...
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) r4.xy, r2.y, l(16), t0.xyxx
r4.x = colorSampler[]..swiz;
r4.y = colorSampler[]..swiz;
  r1.w = cmp(reverseTread != 0.000000);
  r1.w = r1.w ? r4.y : r4.x;
  r4.xy = r1.ww * scrollUVs.xy + v2.xy;
  r1.w = treadHeightMap.SampleLevel(colorSampler_s, r4.xy, 0).x;
  r1.w = treadDepth * r1.w;
  r3.xyz = r3.xyz * r1.www + r8.xyz;
  r5.xyzw = viewProjectionMatrix._m10_m11_m12_m13 * r3.yyyy;
  r5.xyzw = r3.xxxx * viewProjectionMatrix._m00_m01_m02_m03 + r5.xyzw;
  r5.xyzw = r3.zzzz * viewProjectionMatrix._m20_m21_m22_m23 + r5.xyzw;
  ...
  r5.xy = r4.xy + -r4.zw;
  r1.w = treadHeightMap.SampleLevel(colorSampler_s, r5.xy, 0).x;
  r5.xyzw = r4.zwzw * float4(-1,0,-1,1) + r4.xyxy;
  r2.y = treadHeightMap.SampleLevel(colorSampler_s, r5.xy, 0).x;
  r3.w = treadHeightMap.SampleLevel(colorSampler_s, r5.zw, 0).x;
  r5.xyzw = r4.zwzw * float4(0,-1,0,1) + r4.xyxy;
  r5.x = treadHeightMap.SampleLevel(colorSampler_s, r5.xy, 0).x;
  r5.y = treadHeightMap.SampleLevel(colorSampler_s, r5.zw, 0).x;
  r6.xyzw = r4.zwzw * float4(1,-1,1,0) + r4.xyxy;
  r5.z = treadHeightMap.SampleLevel(colorSampler_s, r6.xy, 0).x;
  r5.w = treadHeightMap.SampleLevel(colorSampler_s, r6.zw, 0).x;
  r4.zw = r4.xy + r4.zw;
  r4.z = treadHeightMap.SampleLevel(colorSampler_s, r4.zw, 0).x;
  r4.w = abs(r5.w) * 2 + abs(r5.z);
  r4.w = r4.w + abs(r4.z);
  r4.w = r4.w + -abs(r1.w);
  r2.y = -abs(r2.y) * 2 + r4.w;
  r2.y = r2.y + -abs(r3.w);
  r3.w = abs(r5.y) * 2 + abs(r3.w);
  r3.w = r3.w + abs(r4.z);
  r1.w = r3.w + -abs(r1.w);
  r1.w = -abs(r5.x) * 2 + r1.w;
  r1.w = r1.w + -abs(r5.z);
  r5.x = -r2.y;
  r5.y = -r1.w;
  r1.w = max(9.99999975e-05, treadDepth);
  r5.z = 1 / r1.w;
  r1.w = dot(r5.xyz, r5.xyz);
  r1.w = rsqrt(r1.w);
  r5.xyz = r5.xyz * r1.www;
  r2.xyz = r5.yyy * r2.xzw;
  r1.xyz = r5.xxx * r1.xyz + r2.xyz;
  r0.xyz = r5.zzz * r0.xyz + r1.xyz;
  r1.x = dot(r0.xyz, r0.xyz);
  r1.x = rsqrt(r1.x);
  r0.xyz = r1.xxx * r0.xyz;
  r1.x = cmp(0.800000012 < r0.x);
  r1.y = cmp(r0.x < -0.800000012);
  r1.x = (int)r1.y | (int)r1.x;
  r1.xyz = r1.xxx ? float3(1,0,0) : float3(0,0,1);
  ...
  if (r0.w != 0) {
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r5.xyz, r0.w, l(0), t5.xyzx
  r5.x = colorSampler[]..swiz;
  r5.y = colorSampler[]..swiz;
  r5.z = colorSampler[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r6.xyz, r0.w, l(16), t5.xyzx
  r6.x = colorSampler[]..swiz;
  r6.y = colorSampler[]..swiz;
  r6.z = colorSampler[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r7.xyz, r0.w, l(32), t5.xyzx
  r7.x = colorSampler[]..swiz;
  r7.y = colorSampler[]..swiz;
  r7.z = colorSampler[]..swiz;
  } else {
    r5.xyz = float3(1,0,0);
    r6.xyz = float3(0,1,0);
    r7.xyz = float3(0,0,1);
  ...
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r5.xyz, r0.w, l(16), t5.xyzx
  r5.x = colorSampler[]..swiz;
  r5.y = colorSampler[]..swiz;
  r5.z = colorSampler[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r6.xyz, r0.w, l(32), t5.xyzx
  r6.x = colorSampler[]..swiz;
  r6.y = colorSampler[]..swiz;
  r6.z = colorSampler[]..swiz;
  } else {
  ...
  r0.z = colorSampler[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r1.xyz, r0.w, l(16), t5.xyzx
