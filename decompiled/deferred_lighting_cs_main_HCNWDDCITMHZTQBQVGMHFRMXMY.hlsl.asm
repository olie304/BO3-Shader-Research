...
loop 
  ...
  if_nz r14.w
    ...
    if_nz r1.w
      ...
      add r13.yzw, cb1[24].xxyz, cb10[r12.w + 0].xxyz
      store_structured u2.xyzw, cb2[52].x, r14.w, r13.xyzw
    endif 
    iadd r21.w, r20.w, l(1)
    add r13.yzw, r4.xxyw, -cb10[r12.w + 0].xxyz
    ...
    dp3 r22.x, cb11[r17.w + 1].xyzx, r13.yzwy
    add_sat r22.x, r22.x, cb11[r17.w + 1].w
    mul r18.w, r18.w, r22.x
    dp3 r22.x, cb11[r17.w + 2].xyzx, r13.yzwy
    add_sat r22.x, r22.x, cb11[r17.w + 2].w
    mul r18.w, r18.w, r22.x
    dp3 r22.x, cb11[r17.w + 3].xyzx, r13.yzwy
    add_sat r22.x, r22.x, cb11[r17.w + 3].w
    mul r18.w, r18.w, r22.x
    dp3 r22.x, cb11[r17.w + 4].xyzx, r13.yzwy
    add_sat r22.x, r22.x, cb11[r17.w + 4].w
    mul r18.w, r18.w, r22.x
    dp3 r22.x, cb11[r17.w + 5].xyzx, r13.yzwy
    add_sat r17.w, r22.x, cb11[r17.w + 5].w
    mul r14.x, r17.w, r18.w
    and r17.w, l(1), cb10[r12.w + 6].x
    movc r22.xy, r17.wwww, r14.xyxx, r14.zxzz
    mov r14.x, cb10[r12.w + 6].x
    mov r23.xy, r22.xyxx
    mov r17.w, l(1)
    loop 
      ...
      dp3 r22.z, cb11[r18.w + 0].xyzx, r13.yzwy
      add_sat r22.z, r22.z, cb11[r18.w + 0].w
      ...
      mul r23.x, r18.w, r22.z
      ushr r22.w, r14.x, l(2)
      ubfe r23.z, l(1), l(2), r14.x
      and r23.w, r22.w, l(2)
      max r24.x, r23.x, r23.y
      mad r18.w, -r22.z, r18.w, l(1.000000)
      mul r18.w, r18.w, r23.y
      movc r16.y, r23.w, r18.w, r24.x
      movc r23.xy, r23.zzzz, r23.xyxx, r16.xyxx
      iadd r17.w, r17.w, l(1)
      mov r14.x, r22.w
    endloop 
    mov_sat r23.y, r23.y
    mul r14.x, r23.y, cb10[r12.w + 6].y
    ...
    if_nz r14.w
      ...
      if_nz r15.w
        imad r22.xy, r14.wwww, l(20, 20, 0, 0), l(860, 876, 0, 0)
        ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r14.w, cb2[52].x, r22.x, u2.xxxx
        or r14.w, r14.w, l(32)
        store_structured u2.x, cb2[52].x, r22.x, r14.w
        store_structured u2.x, cb2[52].x, r22.y, r14.x
      endif 
      iadd r20.w, r20.w, l(257)
      mad r20.z, r23.y, cb10[r12.w + 6].y, r20.z
      mul r14.x, r14.x, cb10[r12.w + 7].y
      mov r22.x, cb10[r12.w + 7].w
      mov r22.yz, cb10[r12.w + 8].xxyx
      ...
      mov r22.x, cb10[r12.w + 8].w
      mov r22.yz, cb10[r12.w + 9].xxyx
      ...
      mov r22.x, cb10[r12.w + 9].w
      mov r22.yz, cb10[r12.w + 10].xxyx
      dp3 r15.w, r11.xyzx, r22.xyzx
      dp3 r16.y, r13.yzwy, r22.xyzx
      ...
      div r15.w, r16.y, r15.w
      min r14.w, r14.w, |r15.w|
      mov r22.x, cb10[r12.w + 10].w
      mov r22.yz, cb10[r12.w + 11].xxyx
      dp3 r15.w, r11.xyzx, r22.xyzx
      dp3 r16.y, r13.yzwy, r22.xyzx
      ...
      div r15.w, r16.y, r15.w
      min r14.w, r14.w, |r15.w|
      mov r22.x, cb10[r12.w + 11].w
      mov r22.yz, cb10[r12.w + 12].xxyx
      dp3 r15.w, r11.xyzx, r22.xyzx
      dp3 r16.y, r13.yzwy, r22.xyzx
      ...
      div r15.w, r16.y, r15.w
      min r14.w, r14.w, |r15.w|
      mov r22.x, cb10[r12.w + 12].w
      mov r22.yz, cb10[r12.w + 13].xxyx
      dp3 r15.w, r11.xyzx, r22.xyzx
      dp3 r16.y, r13.yzwy, r22.xyzx
      ...
      div r15.w, r16.y, r15.w
      min r14.w, r14.w, |r15.w|
      add r22.x, r13.y, cb10[r12.w + 3].w
      add r22.yz, r13.zzwz, cb10[r12.w + 4].xxyx
      mad r22.xyz, r11.xyzx, r14.wwww, r22.xyzx
      ...
      utof r25.w, r15.w
      sample_l_indexable(texturecubearray)(float,float,float,float) r22.xyz, r25.xyzw, t8.xyzw, s2, r14.w
      and r23.xzw, r22.xxyz, l(0x7fffffff, 0, 0x7fffffff, 0x7fffffff)
      ieq r23.xzw, r23.xxzw, l(0x7f800000, 0, 0x7f800000, 0x7f800000)
      or r14.w, r23.z, r23.x
      or r14.w, r23.w, r14.w
      movc r22.xyz, r14.wwww, l(1.000000,1.000000,0,0), r22.xyzx
      dp3 r28.x, r13.yzwy, r24.xyzx
      dp3 r28.y, r13.yzwy, r26.xyzx
      dp3 r28.z, r13.yzwy, r27.xyzx
      mad_sat r13.yzw, r28.xxyz, cb10[r12.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
      mul r28.xy, r13.yzyy, cb10[r12.w + 4].zwzz
      mul r28.z, r13.w, cb10[r12.w + 5].x
      add r13.yzw, r28.xxyz, cb10[r12.w + 5].yyzw
      ...
      movc r23.xzw, r12.wwww, l(1.000000,0,1.000000,0), r23.xxzw
...
loop 
  ...
  breakc_nz r12.w
  movc r12.w, r9.w, r0.y, r8.w
  ult r14.w, r12.w, r7.w
  if_nz r14.w
    imul null, r12.w, r12.w, l(14)
    if_nz r1.w
      and r14.w, r16.y, l(15)
      imad r14.w, r14.w, l(20), l(880)
      add r13.yzw, cb1[24].xxyz, cb10[r12.w + 0].xxyz
      store_structured u2.xyzw, cb2[52].x, r14.w, r13.xyzw
    endif 
    ...
    mul r14.x, r17.w, r18.w
    and r17.w, l(1), cb10[r12.w + 6].x
    movc r23.zw, r17.wwww, r14.xxxy, r14.zzzx
    mov r14.x, cb10[r12.w + 6].x
    mov r24.xy, r23.zwzz
    mov r17.w, l(1)
    loop 
      ...
      movc r16.w, r24.w, r18.w, r25.x
      movc r24.xy, r24.zzzz, r24.xyxx, r16.zwzz
      iadd r17.w, r17.w, l(1)
      mov r14.x, r22.w
    endloop 
    add_sat r14.x, -r20.z, r24.y
    mul r14.w, r14.x, cb10[r12.w + 6].y
    lt r15.w, l(0.000000), r14.w
    if_nz r15.w
      and r15.w, r23.y, l(31)
      iadd r16.w, r15.w, l(-1)
      ult r16.w, r16.w, l(32)
      and r16.w, r1.w, r16.w
      if_nz r16.w
        imad r23.zw, r15.wwww, l(0, 0, 20, 20), l(0, 0, 860, 876)
        ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r15.w, cb2[52].x, r23.z, u2.xxxx
        or r15.w, r15.w, l(32)
        store_structured u2.x, cb2[52].x, r23.z, r15.w
        store_structured u2.x, cb2[52].x, r23.w, r14.w
      endif 
      iadd r16.y, r16.y, l(257)
      mad r16.x, r14.x, cb10[r12.w + 6].y, r16.x
      mul r14.x, r14.w, cb10[r12.w + 7].y
      mov r25.x, cb10[r12.w + 7].w
      mov r25.yz, cb10[r12.w + 8].xxyx
      dp3 r14.w, r11.xyzx, r25.xyzx
      ...
      div r15.w, r16.w, r15.w
      min r14.w, r14.w, |r15.w|
      add r25.x, r13.y, cb10[r12.w + 3].w
      add r25.yz, r13.zzwz, cb10[r12.w + 4].xxyx
      mad r24.xzw, r11.xxyz, r14.wwww, r25.xxyz
      dp3 r15.w, r24.xzwx, r24.xzwx
      sqrt r15.w, r15.w
      div r14.w, r14.w, r15.w
      add r14.w, r14.w, r14.w
      sqrt r14.w, r14.w
      ...
      ubfe r15.w, l(9), l(16), cb10[r12.w + 7].z
      utof r26.w, r15.w
      sample_l_indexable(texturecubearray)(float,float,float,float) r24.xzw, r26.xyzw, t8.xwyz, s2, r14.w
      ...
      movc r24.xzw, r14.wwww, l(1.000000,0,1.000000,0), r24.xxzw
      dp3 r29.x, r13.yzwy, r25.xyzx
      dp3 r29.y, r13.yzwy, r27.xyzx
      dp3 r29.z, r13.yzwy, r28.xyzx
      mad_sat r13.yzw, r29.xxyz, cb10[r12.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
      mul r29.xy, r13.yzyy, cb10[r12.w + 4].zwzz
      mul r29.z, r13.w, cb10[r12.w + 5].x
      add r13.yzw, r29.xxyz, cb10[r12.w + 5].yyzw
      ...
      mad r12.w, r6.w, r12.w, r13.z
      div r12.w, r13.y, r12.w
      mad r22.xyz, r24.xzwx, r12.wwww, r22.xyzx
    else 
      mov r23.x, r16.x
      mov r16.xy, r23.xyxx
    endif 
