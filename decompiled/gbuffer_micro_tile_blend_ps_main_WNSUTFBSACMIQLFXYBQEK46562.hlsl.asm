...
movc r0.zw, cb0[16].xxxx, r1.xxxy, r0.zzzw
...
movc r2.xy, cb0[16].yyyy, r2.xyxx, r2.zwzz
sample_indexable(texture2d)(float,float,float,float) r3.xyz, r2.xyxx, t33.xyzw, s1
mad r3.xyz, r3.xyzx, cb2[41].xyzx, -r1.xyzx
mul r2.zw, v2.xxxy, cb0[16].zzzw
movc r0.xy, cb0[16].xxxx, r0.xyxx, r2.zwzz
sample_indexable(texture2d)(float,float,float,float) r0.x, r0.xyxx, t12.xyzw, s1
sample_indexable(texture2d)(float,float,float,float) r4.xyz, r0.zwzz, t11.xyzw, s3
...
mad r5.xy, r2.zwzz, cb0[12].xxxx, r4.xyxx
...
rsq r2.w, r2.w
mul r9.xyz, r2.wwww, v5.xyzx
mul r9.xyz, r2.zzzz, r9.xyzx
mad r8.xyz, r9.xyzx, r6.xxxx, r8.xyzx
dp3 r2.w, v4.xyzx, v4.xyzx
rsq r2.w, r2.w
mul r10.xyz, r2.wwww, v4.xyzx
mul r11.xyz, r2.zzzz, r10.xyzx
mad r8.xyz, r11.xyzx, r6.zzzz, r8.xyzx
dp3 r2.w, r8.xyzx, r8.xyzx
rsq r2.w, r2.w
mul r8.xyz, r2.wwww, r8.xyzx
dp3_sat r2.w, r8.xyzx, cb2[39].yzwy
log r2.w, r2.w
mul r2.w, r2.w, cb0[17].y
exp r2.w, r2.w
add r2.w, r2.w, -cb0[17].x
add r3.w, -cb0[17].x, l(1.000000)
max r3.w, r3.w, l(0.000100)
div_sat r2.w, r2.w, r3.w
mul r0.x, r0.x, r2.w
mad r1.xyz, r0.xxxx, r3.xyzx, r1.xyzx
mul r1.xyz, r1.xyzx, v1.xyzx
sample_indexable(texture2d)(float,float,float,float) r2.w, r0.zwzz, t6.yzwx, s2
sample_indexable(texture2d)(float,float,float,float) r0.z, r0.zwzz, t9.yzxw, s2
mad r0.w, r0.x, -r2.w, r2.w
add r0.w, -r0.w, l(1.000000)
mul o0.xyz, r0.wwww, r1.xyzx
mov o0.w, l(1.000000)
sample_indexable(texture2d)(float,float,float,float) r1.xyz, r2.xyxx, t34.xyzw, s3
sample_indexable(texture2d)(float,float,float,float) r0.w, r2.xyxx, t32.yzwx, s1
...
mad r3.w, r1.z, cb0[12].y, r1.w
mad r6.w, r0.y, cb0[12].x, r1.w
mad r5.xy, r1.xyxx, cb0[12].yyyy, r4.xyxx
dp3 r0.y, r5.xyzx, r5.xyzx
rsq r0.y, r0.y
mul r3.xyz, r0.yyyy, r5.xyzx
add r1.xyzw, r3.xyzw, -r6.xyzw
mad r1.xyzw, r0.xxxx, r1.xyzw, r6.xyzw
mul r3.xyz, r1.yyyy, r7.xyzx
mad r3.xyz, r9.xyzx, r1.xxxx, r3.xyzx
mad r1.xyz, r11.xyzx, r1.zzzz, r3.xyzx
add r0.y, r11.y, r11.x
mad r0.y, r10.z, r2.z, r0.y
...
mad r1.xyz, r10.xyzx, r2.zzzz, -r0.yyyy
max r2.x, r1.z, r1.y
max r2.x, r1.x, r2.x
max r0.y, r0.y, r2.x
eq r1.x, r0.y, r1.x
...
add r0.yzw, cb0[10].xxyz, l(0.000000, -0.040000, -0.040000, -0.040000)
mad r0.yzw, r2.wwww, r0.yyzw, l(0.000000, 0.040000, 0.040000, 0.040000)
add r1.xyz, -r0.yzwy, l(0.040000, 0.040000, 0.040000, 0.000000)
