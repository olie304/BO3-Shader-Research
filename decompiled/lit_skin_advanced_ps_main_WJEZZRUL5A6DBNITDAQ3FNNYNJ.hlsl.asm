...
//   float scriptReplacement1;          // Offset:  252 Size:     4 [unused]
//   bool enableGTAO;                   // Offset:  256 Size:     4
//
// }
//
...
// meltRevealMap                     texture  float4          2d            t47      1 
// meltNormalMap                     texture  float4          2d            t48      1 
...
sample_indexable(texture2d)(float,float,float,float) r0.w, v1.yzyy, t46.yzwx, s7
mad_sat r0.xz, r0.xxzx, l(0.998000, 0.000000, 0.998000, 0.000000), l(0.001000, 0.000000, 0.001000, 0.000000)
add r1.xy, -r0.xzxx, l(1.000000, 1.000000, 0.000000, 0.000000)
mov_sat r1.z, cb0[14].w
log r0.xz, r0.xxzx
mul r0.xz, r0.xxzx, r1.zzzz
exp r0.xz, r0.xxzx
mov r2.xy, -r0.xzxx
log r0.xz, r1.xxyx
mul r0.xz, r0.xxzx, r1.zzzz
exp r2.zw, r0.xxxz
mad_sat r1.xyzw, cb0[14].zzzz, r2.xzyw, r1.xxyy
add r0.x, r0.w, -r1.x
add r0.zw, -r1.xxxz, r1.yyyw
div_sat r0.x, r0.x, r0.z
sample_indexable(texture2d)(float,float,float,float) r0.z, v1.yzyy, t47.yzxw, s7
add r0.z, -r1.z, r0.z
...
sample_indexable(texture2d)(float,float,float,float) r3.xyzw, r1.xyxx, t30.xyzw, s7
sample_indexable(texture2d)(float,float,float,float) r4.x, r1.xyxx, t38.xyzw, s7
if_nz r1.w
  ...
  mad r1.w, r4.x, r1.w, cb0[14].x
  mul_sat r1.w, r1.w, l(0.05882353)
  mul r3.w, r0.x, r3.w
  mad r3.xyz, r3.xyzx, r4.yzwy, -r2.xyzx
...
sample_indexable(texture2d)(float,float,float,float) r5.xyz, r5.xyxx, t29.xyzw, s5
...
mad r4.xy, r5.xyxx, cb0[12].zzzz, r3.xyxx
dp3 r3.x, r4.xyzx, r4.xyzx
rsq r3.x, r3.x
mul r4.xyz, r3.xxxx, r4.xyzx
mad r1.w, r3.z, cb0[12].z, r1.w
lt r3.x, l(0.000000), r3.w
sample_indexable(texture2d)(float,float,float,float) r5.xyz, r1.xyxx, t37.xyzw, s7
if_nz r3.x
  add r3.xyz, r5.xyzx, l(-0.500000, -0.500000, -0.000000, 0.000000)
  ...
  mad r4.xy, r1.xyxx, r3.wwww, r4.xyxx
...
if_nz r1.x
  sample_indexable(texture2d)(float,float,float,float) r3.xyz, v1.yzyy, t48.xyzw, s5
  add r3.xyz, r3.xyzx, l(-0.500000, -0.500000, -0.000000, 0.000000)
  mad r3.xyz, cb0[11].wwww, r3.xyzx, l(0.500000, 0.500000, 0.000000, 0.000000)
  mad r1.xy, r3.xyxx, l(1.99218750, 1.99218750, 0.000000, 0.000000), l(-1.000000, -1.000000, 0.000000, 0.000000)
  mul r3.x, r3.z, r3.z
  mul r3.x, r3.x, l(0.33333334)
  min r3.x, r3.x, l(1.000000)
  mad r4.xy, r1.xyxx, r0.zzzz, r4.xyxx
  dp3 r1.x, r4.xyzx, r4.xyzx
  rsq r1.x, r1.x
  mul r4.xyz, r1.xxxx, r4.xyzx
...
rsq r1.x, r1.x
mul r5.xyz, r1.xxxx, v4.xyzx
mul r5.xyz, r0.zzzz, r5.xyzx
dp3 r1.x, v5.xyzx, v5.xyzx
rsq r1.x, r1.x
mul r6.xyz, r1.xxxx, v5.xyzx
...
mad r4.xyw, r5.xyxz, r4.xxxx, r6.xyxz
mad r3.xyz, r3.xyzx, r4.zzzz, r4.xywx
dp3 r1.x, r3.xyzx, r3.xyzx
rsq r1.x, r1.x
mul r3.xyz, r1.xxxx, r3.xyzx
mad r1.x, cb1[62].x, r1.z, cb0[12].x
...
if_nz r1.y
  ...
  lod r1.w, v1.yzyy, t22.x, s1
  lt r1.z, r1.z, r1.w
  lt r1.w, l(0.000000), r1.w
  and r4.xyz, r1.yyyy, l(1, 2, 4, 0)
  movc r5.xyz, r4.xxxx, l(1.000000,0,1.000000,0), r2.xyzx
  movc r4.xyw, r4.yyyy, l(0,1.000000,0,1.000000), r2.xyxz
  movc r4.xyw, r1.wwww, r5.xyxz, r4.xyxw
  movc r5.xyz, r4.zzzz, l(0,1.000000,0,0), r2.xyzx
  movc r2.xyz, r1.zzzz, r4.xywx, r5.xyzx
endif 
add r1.yzw, -r2.xxyz, cb1[58].xxyz
mad r1.yzw, cb1[58].wwww, r1.yyzw, r2.xxyz
add r2.x, -r2.w, cb1[59].x
mad r2.x, cb1[59].w, r2.x, r2.w
add r1.x, -r0.w, r1.x
mad r0.w, cb1[62].w, r1.x, r0.w
movc r2.yzw, v7.xxxx, v3.xxyz, -v3.xxyz
dp3 r1.x, r2.yzwy, r2.yzwy
rsq r1.x, r1.x
mad r2.yzw, r2.yyzw, r1.xxxx, -r3.xxyz
mad r2.yzw, cb1[60].wwww, r2.yyzw, r3.xxyz
sample_indexable(texture2d)(float,float,float,float) r1.x, v1.yzyy, t3.xyzw, s1
add r1.x, -r1.x, l(1.000000)
mul r3.xyz, r1.xxxx, l(1.000000, 0.500000, 0.500000, 0.000000)
...
if_nz cb0[16].x
  ...
  frc r3.w, r3.w
  mad r1.x, r3.w, l(3.141600), r1.x
  sincos r1.x, r7.x, r1.x
  mul r8.xyzw, cb1[44].zwzw, l(4.166667, 4.166667, 16.666668, 16.666668)
  mov r7.y, r1.x
  mad r9.xyzw, r8.xyzw, r7.xyxy, r4.zwzw
  mul r10.xyzw, r9.xyzw, cb1[44].xyxy
  ftoi r11.xy, r10.xyxx
  mov r11.zw, l(0,0,0,0)
  ld_indexable(texture2d)(float,float,float,float) r1.x, r11.xyzw, t21.xyzw
  ge r3.w, r1.x, l(0.984375)
  mul r5.w, r1.x, l(1.01587307)
  ...
  mad r10.xyzw, r9.xyzw, r7.xyxy, r4.zwzw
  ...
  mad r11.xyzw, r10.xyzw, r7.xyxy, r4.zwzw
  ...
  mul r3.w, r3.w, -r11.z
  max r1.x, r1.x, r3.w
  mad r8.xyzw, r8.xyzw, -r7.xyxy, r4.zwzw
  mul r11.xyzw, r8.xyzw, cb1[44].xyxy
  ...
  rcp r11.z, r5.w
  mul r11.xy, r8.zwzz, r11.zzzz
  add r8.xyz, -r6.xyzx, r11.xyzx
  dp3 r5.w, r8.xyzx, r8.xyzx
  rsq r5.w, r5.w
  mul r5.w, r5.w, -r8.z
  max r3.w, r3.w, r5.w
  mad r8.xyzw, r9.xyzw, -r7.xyxy, r4.zwzw
  mul r9.xyzw, r8.xyzw, cb1[44].xyxy
  ...
  max r5.w, r5.w, l(0.00000001)
  rcp r9.z, r5.w
  mul r9.xy, r8.zwzz, r9.zzzz
  add r8.xyz, -r6.xyzx, r9.xyzx
  dp3 r5.w, r8.xyzx, r8.xyzx
  rsq r5.w, r5.w
  mul r5.w, r5.w, -r8.z
  max r3.w, r3.w, r5.w
  mad r8.xyzw, r10.xyzw, -r7.xyxy, r4.xyzw
  mul r9.xyzw, r8.xyzw, cb1[44].xyxy
  ftoi r9.xyzw, r9.zwxy
  mov r10.xy, r9.zwzz
  mov r10.zw, l(0,0,0,0)
  ...
  sqrt r5.y, r5.y
  mad r5.z, |r1.x|, l(-0.01872930), l(0.074261)
  mad r5.z, r5.z, |r1.x|, l(-0.21211439)
  mad r5.z, r5.z, |r1.x|, l(1.57072878)
  mul r5.w, r5.y, r5.z
  mad r5.w, r5.w, l(-2.000000), l(3.14159274)
  lt r1.x, r1.x, -r1.x
  and r1.x, r1.x, r5.w
  mad r1.x, r5.z, r5.y, r1.x
...
mad o2.xyz, r1.yzwy, r0.yyyy, r7.xzwx
mad r0.z, r2.x, r0.y, r12.x
mad r1.yzw, r2.yyzw, r0.yyyy, r13.xxyz
dp3 r2.x, r1.yzwy, r1.yzwy
rsq r2.x, r2.x
mul r2.xyz, r1.yzwy, r2.xxxx
mad r5.y, r0.w, r0.y, r12.y
log r0.y, |r1.x|
mul r1.xyz, r0.yyyy, l(0.600000, 0.850000, 0.870000, 0.000000)
exp r1.xyz, r1.xyzx
...
add r3.w, r3.w, r3.w
mad r11.xyz, r2.xyzx, -r3.wwww, -r6.xyzx
...
if_nz r6.w
  ...
  if_nz r6.w
    ...
    dp3 r8.w, r2.xyzx, r14.xyzx
    mad r12.w, |r8.w|, r3.w, -|r8.w|
          ...
          if_nz r33.w
            ...
            if_nz r31.w
              ...
              if_nz r31.w
                ...
                mad r63.xyz, r2.xyzx, r31.wwww, v6.xyzx
              ...
              if_nz r31.w
                ...
                if_nz r30.w
                  ...
                  mad r22.xyz, r2.xyzx, r33.wwww, v6.xyzx
                  ...
                  if_nz r22.y
                    ...
                    mad r23.xyz, r2.xyzx, r29.wwww, v6.xyzx
                ...
                dp3 r29.w, r2.xyzx, r58.xyzx
                mad r30.w, |r29.w|, r3.w, -|r29.w|
            ...
            if_nz r23.x
              ...
              if_nz r23.x
                ...
                if_nz r24.y
                  ...
                  mad r26.xyz, r2.xyzx, r24.wwww, v6.xyzx
                  ...
                  if_nz r24.y
                    ...
                    lt r25.x, r22.y, l(0.000000)
                    movc r24.w, r25.x, -r24.w, r24.w
                    mad r27.xyz, r2.xyzx, r24.wwww, v6.xyzx
                ...
                dp3 r25.x, r2.xyzx, r25.xyzx
                mad r25.y, |r25.x|, r3.w, -|r25.x|
...
mul r5.zw, r10.xxxy, l(0.000000, 0.000000, 0.500000, -0.500000)
rcp r10.z, r10.z
mad r10.xy, r5.zwzz, r10.zzzz, l(0.500000, 0.500000, 0.000000, 0.000000)
mov r12.xyz, -r8.xyzx
...
rcp r6.z, r4.z
mad r6.xy, r4.xyxx, r6.zzzz, r12.xyxx
mov r12.w, l(0.500000)
add r4.xyz, r12.wwzw, r6.xyzx
...
rcp r1.w, r1.w
mul r0.w, r0.w, r1.w
mad r5.zw, r0.yyyy, l(0.000000, 0.000000, 0.500000, 0.500000), l(0.000000, 0.000000, 0.33333334, 1.000000)
mul r5.zw, r5.zzzw, l(0.000000, 0.000000, 0.11764706, 0.11764706)
mul r5.zw, r5.zzzw, r5.zzzw
mov x1[0].x, r5.z
mad r6.xyz, r10.xyzx, r5.zzzz, r8.xyzx
lt r7.xy, r0.wwww, r5.zwzz
mul r6.xy, r6.xyxx, cb1[44].xyxx
ftoi r9.xy, r6.xyxx
mov r9.zw, l(0,0,0,0)
ld_indexable(texture2d)(float,float,float,float) r1.w, r9.xyzw, t21.yzwx
ge r3.w, r1.w, l(0.984375)
...
rcp r1.w, r1.w
mov x2[0].x, r1.w
add r3.w, r1.w, l(0.042000)
mul r3.w, r3.w, r6.z
lt r3.w, l(1.000000), r3.w
and r3.w, r3.w, l(0x3f800000)
movc r3.w, r7.x, r3.w, l(1.000000)
mov x0[0].x, r3.w
mov x1[1].x, r5.w
mad r6.xyz, r4.xyzx, r5.wwww, r8.xyzx
mul r6.xy, r6.xyxx, cb1[44].xyxx
ftoi r9.xy, r6.xyxx
mov r9.zw, l(0,0,0,0)
...
if_nz r6.y
  ...
  mad r6.yz, r6.yyzy, r6.yyzy, -r5.zzwz
  mad r5.z, r3.w, r6.y, r5.z
  mov x1[0].x, r5.z
  mad r7.xyw, r10.xyxz, r5.zzzz, r8.xyxz
  lt r5.z, r0.w, r5.z
  ...
  rcp r6.y, r6.y
  movc r1.w, r5.z, r6.y, r1.w
  mov x2[0].x, r1.w
  add r1.w, r6.y, l(0.042000)
  mul r1.w, r1.w, r7.w
  lt r1.w, l(1.000000), r1.w
  and r1.w, r1.w, l(0x3f800000)
  mul r1.w, r1.w, r3.w
  movc r1.w, r5.z, r1.w, r3.w
  mov x0[0].x, r1.w
  mad r3.w, r6.x, r6.z, r5.w
  mov x1[1].x, r3.w
  mad r6.yzw, r4.xxyz, r3.wwww, r8.xxyz
  lt r3.w, r0.w, r3.w
  mul r5.zw, r6.yyyz, cb1[44].xxxy
  ftoi r9.xy, r5.zwzz
  mov r9.zw, l(0,0,0,0)
  ld_indexable(texture2d)(float,float,float,float) r5.z, r9.xyzw, t21.yzxw
  ge r5.w, r5.z, l(0.984375)
  mul r6.y, r5.z, l(1.01587307)
  mad r5.z, r5.z, l(64.000000), l(-63.000000)
  movc r5.z, r5.w, r5.z, r6.y
  max r5.z, r5.z, l(0.00000001)
  rcp r5.z, r5.z
  movc r4.w, r3.w, r5.z, r4.w
  mov x2[1].x, r4.w
  add r4.w, r5.z, l(0.042000)
  mul r4.w, r4.w, r6.w
  lt r4.w, l(1.000000), r4.w
  and r4.w, r4.w, l(0x3f800000)
  mul r4.w, r4.w, r6.x
  movc r3.w, r3.w, r4.w, r6.x
  mov x0[1].x, r3.w
  add r1.w, r1.w, r3.w
...
if_z r1.w
  mad r5.zw, r0.yyyy, l(0.000000, 0.000000, 0.500000, 0.500000), l(0.000000, 0.000000, 2.33333325, 3.000000)
  mul r5.zw, r5.zzzw, l(0.000000, 0.000000, 0.11764706, 0.11764706)
  mov r1.w, x1[0].x
  mov r3.w, x0[0].x
  mad r4.w, r5.z, r5.z, -r1.w
  mad r1.w, r3.w, r4.w, r1.w
  mov x1[0].x, r1.w
  mad r6.xyz, r10.xyzx, r1.wwww, r8.xyzx
  lt r1.w, r0.w, r1.w
  mul r6.xy, r6.xyxx, cb1[44].xyxx
  ftoi r9.xy, r6.xyxx
  mov r9.zw, l(0,0,0,0)
  ...
  mad r4.w, r4.w, l(64.000000), l(-63.000000)
  movc r4.w, r5.z, r4.w, r6.x
  max r4.w, r4.w, l(0.00000001)
  rcp r4.w, r4.w
  mov r5.z, x2[0].x
  movc r5.z, r1.w, r4.w, r5.z
  mov x2[0].x, r5.z
  ...
  mov r3.w, x1[1].x
  mov r4.w, x0[1].x
  mad r5.z, r5.w, r5.w, -r3.w
  mad r3.w, r4.w, r5.z, r3.w
  mov x1[1].x, r3.w
  mad r6.xyz, r4.xyzx, r3.wwww, r8.xyzx
  lt r3.w, r0.w, r3.w
  ...
  rcp r5.z, r5.z
  mov r5.w, x2[1].x
  movc r5.w, r3.w, r5.z, r5.w
  mov x2[1].x, r5.w
  add r5.z, r5.z, l(0.042000)
  mul r5.z, r5.z, r6.z
  lt r5.z, l(1.000000), r5.z
  and r5.z, r5.z, l(0x3f800000)
  mul r5.z, r4.w, r5.z
  movc r3.w, r3.w, r5.z, r4.w
  mov x0[1].x, r3.w
  add r1.w, r1.w, r3.w
  eq r1.w, r1.w, l(0.000000)
else 
...
if_z r1.w
  mad r5.zw, r0.yyyy, l(0.000000, 0.000000, 0.500000, 0.500000), l(0.000000, 0.000000, 3.33333325, 4.000000)
  mul r5.zw, r5.zzzw, l(0.000000, 0.000000, 0.11764706, 0.11764706)
  mov r1.w, x1[0].x
  mov r3.w, x0[0].x
  mad r4.w, r5.z, r5.z, -r1.w
...
if_z r1.w
  mad r5.zw, r0.yyyy, l(0.000000, 0.000000, 0.500000, 0.500000), l(0.000000, 0.000000, 4.33333349, 5.000000)
  mul r5.zw, r5.zzzw, l(0.000000, 0.000000, 0.11764706, 0.11764706)
  mov r1.w, x1[0].x
  mov r3.w, x0[0].x
  mad r4.w, r5.z, r5.z, -r1.w
...
if_z r1.w
  mad r5.zw, r0.yyyy, l(0.000000, 0.000000, 0.500000, 0.500000), l(0.000000, 0.000000, 5.33333349, 6.000000)
  mul r5.zw, r5.zzzw, l(0.000000, 0.000000, 0.11764706, 0.11764706)
  mov r1.w, x1[0].x
  mov r3.w, x0[0].x
  mad r4.w, r5.z, r5.z, -r1.w
...
if_z r1.w
  mad r5.zw, r0.yyyy, l(0.000000, 0.000000, 0.500000, 0.500000), l(0.000000, 0.000000, 6.33333349, 7.000000)
  mul r5.zw, r5.zzzw, l(0.000000, 0.000000, 0.11764706, 0.11764706)
  mov r1.w, x1[0].x
  mov r3.w, x0[0].x
  mad r4.w, r5.z, r5.z, -r1.w
...
if_z r1.w
  mad r5.zw, r0.yyyy, l(0.000000, 0.000000, 0.500000, 0.500000), l(0.000000, 0.000000, 7.33333349, 8.000000)
  mul r5.zw, r5.zzzw, l(0.000000, 0.000000, 0.11764706, 0.11764706)
  mov r0.y, x1[0].x
  mov r1.w, x0[0].x
  mad r3.w, r5.z, r5.z, -r0.y
  ...
  and r3.w, r3.w, l(0x3f800000)
  mul r3.w, r1.w, r3.w
  movc r0.y, r0.y, r3.w, r1.w
  mov x0[0].x, r0.y
  mov r0.y, x1[1].x
  mov r1.w, x0[1].x
  mad r3.w, r5.w, r5.w, -r0.y
  mad r0.y, r1.w, r3.w, r0.y
  ...
  movc r0.w, r3.w, r0.w, r4.x
  max r0.w, r0.w, l(0.00000001)
  rcp r0.w, r0.w
  mov r3.w, x2[1].x
  movc r3.w, r0.y, r0.w, r3.w
  mov x2[1].x, r3.w
...
mad r5.zw, -r0.yyyy, l(0.000000, 0.000000, 10.000000, 5.000000), l(0.000000, 0.000000, 6.857410, 7.085000)
exp r3.w, r5.z
mul r3.w, r3.w, r5.x
mul r3.w, r3.w, l(9.136810)
mul r4.w, r0.y, r0.w
mad r4.w, -r4.w, l(2.015905), r5.w
exp r4.w, r4.w
mul r4.w, r4.w, r5.x
...
loop 
  ...
  add r10.xyz, -r20.yzwy, v6.xyzx
  dp3 r6.w, r10.xyzx, r10.xyzx
  sqrt r6.w, r6.w
  ge r6.w, cb2[54].y, r6.w
  and r7.w, r26.y, l(0x0000ffff)
  ...
  dp3 r8.w, r33.xyzx, r10.xyzx
  add_sat r8.w, r33.w, r8.w
  dp3 r12.w, r34.xyzx, r10.xyzx
  add_sat r12.w, r34.w, r12.w
  mul r8.w, r8.w, r12.w
  dp3 r12.w, r35.xyzx, r10.xyzx
  add_sat r12.w, r35.w, r12.w
  mul r8.w, r8.w, r12.w
  dp3 r12.w, r36.xyzx, r10.xyzx
  add_sat r12.w, r36.w, r12.w
  mul r8.w, r8.w, r12.w
  dp3 r12.w, r37.xyzx, r10.xyzx
  add_sat r12.w, r37.w, r12.w
  mul r8.w, r8.w, r12.w
  dp3 r12.w, r38.xyzx, r10.xyzx
  add_sat r12.w, r38.w, r12.w
  mul r12.x, r8.w, r12.w
  and r8.w, r9.z, l(1)
  movc r12.xw, r8.wwww, r12.xxxy, r12.zzzx
  mov r33.xy, r26.zwzz
  mov r33.z, r27.z
  dp3 r8.w, r11.xyzx, r33.xyzx
  ...
  mad r27.xyz, r11.xyzx, r8.wwww, r27.xyzx
  dp3 r13.w, r27.xyzx, r27.xyzx
  sqrt r13.w, r13.w
  div r8.w, r8.w, r13.w
  add r8.w, r8.w, r8.w
  sqrt r8.w, r8.w
  mad r8.w, r0.y, l(5.000000), r8.w
  ...
  utof r28.w, r16.w
  sample_l_indexable(texturecubearray)(float,float,float,float) r21.xyz, r28.xyzw, t8.xyzw, s2, r8.w
  and r26.yzw, r21.xxyz, l(0, 0x7fffffff, 0x7fffffff, 0x7fffffff)
  ieq r26.yzw, r26.yyzw, l(0, 0x7f800000, 0x7f800000, 0x7f800000)
  or r8.w, r26.z, r26.y
  or r8.w, r26.w, r8.w
  movc r21.xyz, r8.wwww, l(1.000000,1.000000,0,0), r21.xyzx
  ...
  loop 
    ...
    if_nz r14.z
      ...
      if_nz r6.w
        ...
        mov r14.z, l(1)
        loop 
          ige r14.w, r14.z, r16.z
          breakc_nz r14.w
          iadd r14.w, r7.w, r14.z
          ...
          ubfe r16.w, l(1), l(2), r13.w
          and r17.w, r15.w, l(2)
          max r20.z, r28.x, r28.y
          mad r14.w, -r14.w, r15.z, l(1.000000)
          mul r14.w, r14.w, r28.y
          movc r16.y, r17.w, r14.w, r20.z
          movc r28.xy, r16.wwww, r28.xyxx, r16.xyxx
...
if_z r4.w
      ...
      loop 
        ...
        if_nz r14.w
          ...
          if_nz r14.z
            ...
            and r17.w, r14.z, l(1)
            movc r28.xy, r17.wwww, r12.xyxx, r12.zxzz
            mov r12.x, r14.z
            mov r29.xy, r28.xyxx
            mov r17.w, l(1)
            loop 
            ...
            if_nz r14.z
              ...
              movc r16.z, r25.z, l(0), l(0.500000)
              ...
              mad r10.xyz, r25.xyzx, r26.xyzx, r10.xyzx
              mul r13.w, r3.w, r13.z
              mul r14.yzw, r12.xxxx, r14.yyzw
              dp3 r12.x, r14.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
              mad r12.x, r3.w, r13.z, r12.x
              div r12.x, r13.w, r12.x
              mad r24.xyz, r14.yzwy, r12.xxxx, r24.xyzx
            endif 
          endif 
        endif 
      endloop 
      mov r22.xyzw, r24.xyzw
      mov r23.xyz, r10.xyzx
      iadd r7.w, r7.w, l(32)
    endloop 
  ...
  if_nz r1.w
    ...
    mad r9.xyz, r9.xyzx, r13.zzzz, r12.xyzx
    mov r2.w, l(0)
    ...
    mad r18.xyz, r20.xyzx, r0.yyyy, r2.xyzx
    mov r11.w, l(0)
    sample_l_indexable(texturecubearray)(float,float,float,float) r2.xyz, r11.xyzw, t8.xyzw, s2, r0.w
    mad r0.y, cb2[19].x, r1.w, -r2.w
    mad r0.y, r5.y, r0.y, r2.w
    mad r19.xyz, r2.xyzx, r0.yyyy, r19.xyzx
  endif 
else 
  mov r19.x, r18.w
endif 
mad r2.xyz, r18.xyzx, r1.xyzx, r6.xyzx
mad r1.xyz, r18.xyzx, r1.xyzx, r7.xyzx
...
mad r4.xyz, r19.xyzx, r0.yyyy, r4.xyzx
mad r5.xyz, r19.xyzx, r0.wwww, r8.xyzx
mad r1.xyz, r1.xyzx, r3.xyzx, r2.xyzx
mul r2.xyz, r4.xyzx, l(0.972000, 0.972000, 0.972000, 0.000000)
mad r2.xyz, r5.xyzx, l(0.028000, 0.028000, 0.028000, 0.000000), r2.xyzx
...
mul o2.w, r0.x, r0.z
ret 
// Approximately 3965 instruction slots used
