...
mad r1.xy, r2.xyxx, cb0[10].wwww, r0.yzyy
dp3 r0.y, r1.xyzx, r1.xyzx
rsq r0.y, r0.y
mul r1.xyz, r0.yyyy, r1.xyzx
mad r0.y, r1.w, cb0[10].w, r0.w
...
mul r4.x, r0.y, r3.z
mul r4.y, r0.w, -r3.w
mad r0.yw, cb1[44].xxxy, l(0.000000, 0.500000, 0.000000, 0.500000), r4.xxxy
add r0.yw, -r0.yyyw, v0.xxxy
add r2.w, r3.y, r3.x
mad r2.w, r2.z, r0.z, r2.w
mul r2.w, r2.w, l(0.500000)
mad r2.xyz, r2.xyzx, r0.zzzz, -r2.wwww
max r0.z, r2.z, r2.y
max r0.z, r0.z, r2.x
max r0.z, r0.z, r2.w
eq r2.x, r0.z, r2.x
mul r3.yzw, r1.yyzw, l(0.000000, 1.000000, -1.000000, -1.000000)
add r2.w, r0.z, l(2.000000)
mov r3.x, l(1)
mov r1.x, l(0)
movc r1.xyzw, r2.xxxx, r3.xyzw, r1.xyzw
movc r0.z, r2.x, r2.w, r0.z
eq r2.x, r0.z, r2.y
mul r3.yzw, r1.yyzw, l(0.000000, -1.000000, 1.000000, -1.000000)
...
add r0.xz, |r0.yywy|, l(-10.000000, 0.000000, -10.000000, 0.000000)
mul_sat r0.xz, r0.xxzx, l(0.03333334, 0.000000, 0.03333334, 0.000000)
mul r1.xy, |r0.ywyy|, l(0.100000, 0.100000, 0.000000, 0.000000)
min r1.xy, r1.xyxx, l(1.000000, 1.000000, 0.000000, 0.000000)
add r1.xy, -r0.xzxx, r1.xyxx
mad r0.xz, r1.xxyx, l(0.500000, 0.000000, 0.500000, 0.000000), r0.xxzx
ge r0.yw, r0.yyyw, l(0.000000, 0.000000, 0.000000, 0.000000)
movc o3.xy, r0.ywyy, r0.xzxx, -r0.xzxx
mov o0.w, l(1.000000)
