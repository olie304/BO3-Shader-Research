...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  r1.z = r1.z + -r1.y;
  r3.y = debugGlossOverride.w * r1.z + r1.y;
  r1.y = debugOcclusionOverride.x + -r1.x;
  r1.x = debugOcclusionOverride.w * r1.y + r1.x;
  r1.yzw = v7.xxx ? v2.xyz : -v2.xyz;
  r2.z = dot(r1.yzw, r1.yzw);
  r2.z = rsqrt(r2.z);
  r1.yzw = r1.yzw * r2.zzz + -r2.xyw;
  r2.xyz = debugNormalOverride.www * r1.yzw + r2.xyw;
  r0.w = v1.x * r0.w;
  ...
  if (useAlphaControls != 0) {
    ...
    r3.z = dot(r4.xyz, v2.xyz);
    r3.z = r3.z * r3.z;
    r3.z = saturate(r3.z * v6.x + v6.y);
    r3.z = r3.z * r0.w;
    r4.xy = (int2)v0.xy;
    r4.zw = float2(0,0);
  ...
  r3.x = saturate(dot(r2.xyz, r4.yzw));
  r5.y = dot(-r4.yzw, r2.xyz);
  r5.y = r5.y + r5.y;
  r10.xyz = r2.xyz * -r5.yyy + -r4.yzw;
  r5.y = 17 * r3.y;
  r5.y = exp2(r5.y);
  r5.y = 2 + r5.y;
  r5.y = 2 / r5.y;
  ...
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r21.xyzw, r3.z, l(0), t15.wxyz
  r21.x = samp0[]..swiz;
  r21.y = samp0[]..swiz;
  r21.z = samp0[]..swiz;
  r21.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r22.xyzw, r3.z, l(16), t15.xyzw
  r22.x = samp0[]..swiz;
  r22.y = samp0[]..swiz;
  r22.z = samp0[]..swiz;
  r22.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r23.xyzw, r3.z, l(32), t15.yxwz
  r23.x = samp0[]..swiz;
  r23.y = samp0[]..swiz;
  r23.z = samp0[]..swiz;
  r23.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r24.xyzw, r3.z, l(48), t15.xyzw
  r24.x = samp0[]..swiz;
  r24.y = samp0[]..swiz;
  r24.z = samp0[]..swiz;
  r24.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r25.xyzw, r3.z, l(64), t15.zwxy
  r25.x = samp0[]..swiz;
  r25.y = samp0[]..swiz;
  r25.z = samp0[]..swiz;
  r25.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r26.xyzw, r3.z, l(80), t15.xyzw
  r26.x = samp0[]..swiz;
  r26.y = samp0[]..swiz;
  r26.z = samp0[]..swiz;
  r26.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r8.yz, r3.z, l(96), t15.xxyx
  r8.y = samp0[]..swiz;
  r8.z = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r27.xyzw, r3.z, l(116), t15.xyzw
  r27.x = samp0[]..swiz;
  r27.y = samp0[]..swiz;
  r27.z = samp0[]..swiz;
  r27.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r28.xyzw, r3.z, l(132), t15.zwxy
  r28.x = samp0[]..swiz;
  r28.y = samp0[]..swiz;
  r28.z = samp0[]..swiz;
  r28.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r29.xyzw, r3.z, l(148), t15.zwxy
  r29.x = samp0[]..swiz;
  r29.y = samp0[]..swiz;
  r29.z = samp0[]..swiz;
  r29.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r30.xyzw, r3.z, l(164), t15.zwxy
  r30.x = samp0[]..swiz;
  r30.y = samp0[]..swiz;
  r30.z = samp0[]..swiz;
  r30.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r31.xyzw, r3.z, l(180), t15.zwxy
  r31.x = samp0[]..swiz;
  r31.y = samp0[]..swiz;
  r31.z = samp0[]..swiz;
  r31.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r32.xyzw, r3.z, l(196), t15.xyzw
  r32.x = samp0[]..swiz;
  r32.y = samp0[]..swiz;
  r32.z = samp0[]..swiz;
  r32.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r33.xy, r3.z, l(212), t15.xyxx
  r33.x = samp0[]..swiz;
  r33.y = samp0[]..swiz;
  ...
  if (r0.w == 0) {
    ...
    while (true) {
      ...
      r9.z = cmp((int)r3.z == (int)r8.w);
      bitmask.w = ((~(-1 << r3.w)) << 0) & 0xffffffff;  r9.w = (((uint)0 << 0) & bitmask.w) | ((uint)r9.y & ~bitmask.w);
      r9.y = r9.z ? r9.w : r9.y;
    ...
    if (r8.y != 0) {
      ...
      while (true) {
        ...
        r11.w = cmp((int)r3.z == (int)r9.z);
        if (r3.w == 0) r12.z = 0; else if (r3.w+0 < 32) {         r12.z = (uint)r9.w << (32-(r3.w + 0)); r12.z = (uint)r12.z >> (32-r3.w);        } else r12.z = (uint)r9.w >> 0;
    ...
    r19.xyz = r21.xyz * r0.www;
    r20.xyz = r22.xyz * r0.www;
    r3.z = cmp(r22.w < 0.99000001);
    if (r3.z != 0) {
      r3.z = 1 + -r22.w;
      ...
      r19.xyz = r21.xyz * r0.www + r8.yzw;
      r10.w = 0;
      r8.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r10.xyzw, r6.z).xyz;
      r0.w = sunConstants.globalProbeExposure * r3.z + -r2.w;
      r0.w = r3.y * r0.w + r2.w;
      r20.xyz = r8.yzw * r0.www + r20.xyz;
    }
  } else {
    r20.x = r19.w;
  }
  ...
  r9.yzw = r8.yzw * r3.yyy;
  r13.xyz = r8.yzw * r3.zzz;
  r0.w = sqrt(r5.z);
  r0.w = r0.w * 0.5 + 0.5;
  r0.w = r0.w * r0.w;
  r1.x = 0.5 * r0.w;
  ...
  if (r3.y == 0) {
    ...
    if (r6.z == 0) {
      if (enableDitheredShadow == 0) {
        ...
        r14.z = r6.z + r3.w;
        r6.z = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r14.xyz, r3.y).x;
      ...
      if (enableDitheredShadow != 0) {
        ...
        r8.yz = -sunConstants.splitPinTransform[r3.w].xy + r8.yz;
        r8.yz = sunConstants.splitPinTransform[r3.w].zz * r8.yz;
        ...
        while (true) {
          ...
          r10.w = r8.w ? sunConstants.splitPinTransform[r3.w].w : sunConstants.splitPinTransform[r6.z].w;
          r8.w = r8.w ? r3.w : r6.z;
          ...
          r16.z = (uint)r8.w;
          r8.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r3.y).x;
  ...
  if (r3.y != 0) {
    r3.y = cmp(0 < r3.z);
    if (r3.y != 0) {
      r3.y = sunConstants.specScale * r5.y;
      r3.y = 0.25 * r3.y;
      if (sunConstants.sunCookieIndex != 0) {
        r14.xyz = eyeOffset.xyz + v5.xyz;
        r14.w = 1;
        r3.w = dot(sunConstants.sunCookieTransform[0].xyzw, r14.xyzw);
      ...
      r5.w = cmp(0 < (uint)r3.w);
      r5.w = r5.x ? r5.w : 0;
      if (r5.w != 0) {
        r3.w = (int)r3.w + numLights;
        r3.w = (int)r3.w + -1;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r5.w, r3.w, l(52), t12.xxxx
      r5.w = samp0[]..swiz;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r14.xyzw, r3.w, l(68), t12.xyzw
      r14.x = samp0[]..swiz;
      r14.y = samp0[]..swiz;
      r14.z = samp0[]..swiz;
      r14.w = samp0[]..swiz;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r15.xyzw, r3.w, l(84), t12.xyzw
      r15.x = samp0[]..swiz;
      r15.y = samp0[]..swiz;
      r15.z = samp0[]..swiz;
      r15.w = samp0[]..swiz;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r16.xyzw, r3.w, l(132), t12.xyzw
      r16.x = samp0[]..swiz;
      r16.y = samp0[]..swiz;
      r16.z = samp0[]..swiz;
      r16.w = samp0[]..swiz;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r17.xyzw, r3.w, l(148), t12.xyzw
      r17.x = samp0[]..swiz;
      r17.y = samp0[]..swiz;
      r17.z = samp0[]..swiz;
      r17.w = samp0[]..swiz;
        r6.z = abs(r2.w) * -0.200000003 + 0.400000006;
        r6.w = cmp(r2.w < 0);
        r6.z = r6.w ? -r6.z : r6.z;
        ...
        if (r7.w == 0) {
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r7.w, r3.w, l(28), t12.xxxx
        r7.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r14.xyzw, r3.w, l(100), t12.xyzw
        r14.x = samp0[]..swiz;
        r14.y = samp0[]..swiz;
        r14.z = samp0[]..swiz;
        r14.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r15.xy, r3.w, l(164), t12.xyxx
        r15.x = samp0[]..swiz;
        r15.y = samp0[]..swiz;
          r3.w = dot(r14.xyzw, r18.xyzw);
          ...
          if (enableDitheredShadow != 0) {
            ...
            while (true) {
              ...
              r10.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r3.w).x;
              r6.w = r10.w * 0.125 + r6.w;
              r7.w = (int)r7.w + 1;
            }
          } else {
            r14.z = (uint)r6.z;
            r6.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r14.xyz, r3.w).x;
          }
          r3.w = r6.w * r6.w;
          r3.w = r3.w * r6.w;
        } else {
      ...
      r3.w = -r3.x * 0.5 + 1;
      r3.w = -abs(r2.w) * r3.w + 1;
      r3.w = r3.w * r3.w;
      r3.w = -r3.w * 0.620000005 + 0.620000005;
      r3.w = r3.w + -abs(r2.w);
      r3.w = r5.z * r3.w + abs(r2.w);
      r3.w = r3.w * r3.z;
      r5.w = cmp(0 < r2.w);
      r14.xyz = r3.www * r8.zwy + r12.xyz;
      r2.w = saturate(r2.w);
      r15.xyz = -v5.xyz * r4.xxx + sunConstants.wldDir.xyz;
      r3.w = dot(r15.xyz, r15.xyz);
      r3.w = rsqrt(r3.w);
      r15.xyz = r15.xyz * r3.www;
      r3.w = dot(r15.xyz, r4.yzw);
      r4.x = dot(r2.xyz, r15.xyz);
      r6.z = abs(r4.x) * r5.y + -abs(r4.x);
      r4.x = abs(r4.x) * r6.z + 1;
      r6.z = r2.w * r0.w + r1.x;
      r4.x = r4.x * r4.x;
      r4.x = r4.x * r6.z;
      r4.x = rcp(r4.x);
      ...
      r2.w = r4.x * r2.w;
      r2.w = r2.w * r3.z;
      r15.yzw = r2.www * r8.yzw + r13.xyz;
      r3.y = saturate(1 + -r3.w);
      r3.z = r3.y * r3.y;
      r3.z = r3.z * r3.z;
      r3.y = r3.y * r3.z;
      r2.w = r3.y * r2.w;
      r3.yzw = r2.www * r8.yzw + r9.yzw;
      r14.w = r12.z;
      r12.w = r14.z;
            ...
            if (r16.w != 0) {
              ...
              if (r16.w != 0) {
                ...
                if (r16.w != 0) {
                  ...
                  r12.w = r5.z * r12.w + abs(r15.w);
                  r12.w = r12.w * r15.z;
                  r34.x = r33.x;
                  r13.w = cmp(0 < r15.w);
                  r20.xyz = r12.www * r34.xyz + r17.xyz;
                  r15.w = saturate(dot(r2.xyz, r41.xyz));
                  r40.xyz = r40.xyz * r11.www + r4.yzw;
                  r11.w = dot(r40.xyz, r40.xyz);
                  r11.w = rsqrt(r11.w);
                  r40.xyz = r40.xyz * r11.www;
                  r11.w = dot(r40.xyz, r4.yzw);
                  r19.x = dot(r2.xyz, r40.xyz);
                  r21.w = abs(r19.x) * r5.y + -abs(r19.x);
                  r19.x = abs(r19.x) * r21.w + 1;
                  r21.w = r15.w * r0.w + r1.x;
                  r19.x = r19.x * r19.x;
                  r19.x = r19.x * r21.w;
                  r19.x = rcp(r19.x);
                  r15.w = r15.w * r16.w;
            ...
            r41.w = samp0[]..swiz;
              ...
              if (r13.w != 0) {
                ...
                if (r13.w != 0) {
                  ...
                  r15.z = r5.z * r15.z + abs(r12.w);
                  r15.z = r15.z * r10.w;
                  r16.w = cmp(0 < r12.w);
                  r22.xyz = r15.zzz * r21.xyw + r17.xyz;
                  r12.w = saturate(r12.w);
                  r20.xyz = r20.xyz * r11.www + r4.yzw;
                  r11.w = dot(r20.xyz, r20.xyz);
                  r11.w = rsqrt(r11.w);
                  r20.xyz = r20.xyz * r11.www;
                  r11.w = dot(r20.xyz, r4.yzw);
                  r19.x = dot(r2.xyz, r20.xyz);
                  r20.x = abs(r19.x) * r5.y + -abs(r19.x);
                  r19.x = abs(r19.x) * r20.x + 1;
                  r20.x = r12.w * r0.w + r1.x;
                  r19.x = r19.x * r19.x;
                  r19.x = r19.x * r20.x;
                  r19.x = rcp(r19.x);
                  r12.w = r12.w * r13.w;
  ...
  r0.xyz = r3.yzw * r0.xyz + r1.xyz;
  r1.xyz = float3(0.959999979,0.959999979,0.959999979) * r29.xyz;
  r1.xyz = r8.yzw * float3(0.0399999991,0.0399999991,0.0399999991) + r1.xyz;
  r0.xyz = r1.xyz + r0.xyz;
