...
sqrt r0.w, r0.w
add r1.x, r0.w, l(-0.225000)
lt r1.y, r1.x, l(0.000000)
mul r0.w, r0.w, l(0.88888896)
mad r1.x, r1.x, l(1.09090912), l(0.200000)
movc r0.w, r1.y, r0.w, r1.x
mul r0.w, r0.w, r0.w
mad_sat r0.w, -r0.w, l(18.400000), l(1.000000)
mul r0.w, r0.w, l(0.101000)
