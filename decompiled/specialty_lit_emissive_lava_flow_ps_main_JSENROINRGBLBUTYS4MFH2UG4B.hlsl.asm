...
if_nz r6.w
  ...
  if_nz r6.w
    ...
    if_nz r8.w
      ...
      mad r20.xyz, r4.xyzx, r9.zzzz, v7.xyzx
    ...
    mul r0.z, r0.z, r5.w
    mul r0.z, r0.z, r4.w
    mad r5.xyz, r0.zzzz, r5.yzxy, r15.xyzx
    mov r16.w, r5.z
    mov r14.w, r15.z
...
ret 
// Approximately 2443 instruction slots used
