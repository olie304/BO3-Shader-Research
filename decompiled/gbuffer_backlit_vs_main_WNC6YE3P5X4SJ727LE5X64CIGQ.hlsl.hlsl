// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:26:42 2021
...
r1.w = shaderConstantSetBuffer[]..swiz;
  ...
  r1.xyzw = r1.zzzz * viewProjectionMatrix._m20_m21_m22_m23 + r2.xyzw;
  ...
  r1.y = dot(r0.xyz, r5.xyz);
  r1.z = dot(r0.xyz, r6.xyz);
  r0.w = dot(r1.xyz, r1.xyz);
  r0.w = rsqrt(r0.w);
  o4.xyz = r1.xyz * r0.www;
  r1.xyz = r8.zxy * r0.yzx;
  r0.xyz = r8.yzx * r0.zxy + -r1.xyz;
  r0.w = v4.w * 2 + -1;
