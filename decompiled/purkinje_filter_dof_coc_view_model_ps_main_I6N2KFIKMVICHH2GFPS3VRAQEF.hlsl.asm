...
// lensFilter                        texture  float4          2d             t2      1 
...
dcl_output o1.x
dcl_temps 3
mad r0.xy, v1.xyxx, cb8[5].xyxx, cb8[5].zwzz
dp2 r0.x, r0.xyxx, r0.xyxx
sqrt r0.x, r0.x
mad_sat r0.x, r0.x, cb8[8].z, cb8[8].w
...
dp3 r2.w, r2.xyzx, cb8[0].xyzx
mad r0.yzw, -r0.yyzw, r1.yyzw, r2.wwww
mad o0.xyz, r0.xxxx, r0.yzwy, r2.xyzx
mad r0.x, r1.x, l(64.000000), l(-63.000000)
max r0.x, r0.x, l(0.00000001)
max r0.y, r1.x, l(0.00000001)
ge r0.z, r1.x, l(0.984375)
div r0.xy, cb8[2].zwzz, r0.xyxx
movc r0.x, r0.z, r0.x, r0.y
mul r0.y, r0.x, l(25.400000)
mad_sat r0.x, r0.x, cb8[9].x, cb8[9].y
exp r0.x, r0.x
div r0.x, l(1.000000, 1.000000, 1.000000, 1.000000), r0.x
add r0.x, -r0.x, l(1.000000)
mul r0.x, r0.x, cb8[9].z
mul r0.x, r0.x, cb8[9].w
div r0.y, cb8[3].y, r0.y
add r0.y, r0.y, l(-1.000000)
mul r0.y, r0.y, cb8[3].z
mul r0.y, r0.y, cb8[3].w
mad o1.x, r0.y, l(0.500000), r0.x
ret 
