...
//   float2 movieRectBottomLeft;        // Offset:  160 Size:     8
//   float2 movieRectUpperRight;        // Offset:  168 Size:     8
//
// }
//
...
add r0.xy, -cb0[10].xyxx, cb0[10].zwzz
mad o1.xy, v1.xyxx, r0.xyxx, cb0[10].xyxx
ret 
