...
r0.w = samp0[]..swiz;
  ...
  r11.z = (uint)r2.x << 4;
  r2.x = (int)r8.w & -32;
  r2.y = (int)-r2.x + (int)r8.w;
  r2.z = numRefProbes & -32;
  r9.w = (int)-r2.z + numRefProbes;
  r12.xy = float2(0,0);
  r13.w = 0;
  r14.yz = float2(0,1);
  r15.xy = float2(0,0);
  ...
  while (true) {
    ...
    r12.w = cmp((int)r2.x == (int)r11.w);
    bitmask.x = ((~(-1 << r2.y)) << 0) & 0xffffffff;  r13.x = (((uint)0 << 0) & bitmask.x) | ((uint)r12.z & ~bitmask.x);
    r12.z = r12.w ? r13.x : r12.z;
    r12.w = cmp((int)r2.z == (int)r11.w);
      ...
      r24.y = samp0[]..swiz;
        ...
        r31.w = samp0[]..swiz;
          ...
          r37.y = samp0[]..swiz;
            ...
            r32.w = (uint)r14.x;
            r16.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r32.xyzw, r13.z).xyz;
            ...
            r32.x = dot(r4.xyz, r23.xyz);
            r32.y = dot(r4.xyz, r24.xyz);
            ...
            r23.x = r21.w;
            r23.yz = r22.xy;
            r22.xyw = r16.zwy * r13.yyy + r23.yzx;
            r21.w = r22.w;
          }
        }
      }
  ...
  if (r2.z != 0) {
    ...
    while (true) {
      ...
      r12.z = cmp((int)r2.x == (int)r9.w);
      if (r2.y == 0) r12.w = 0; else if (r2.y+0 < 32) {       r12.w = (uint)r11.w << (32-(r2.y + 0)); r12.w = (uint)r12.w >> (32-r2.y);      } else r12.w = (uint)r11.w >> 0;
      ...
      while (true) {
        ...
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=80)(mixed,mixed,mixed,mixed) r24.xyzw, r16.z, l(0), t11.xyzw
        r24.x = samp0[]..swiz;
        r24.y = samp0[]..swiz;
        r24.z = samp0[]..swiz;
        r24.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=80)(mixed,mixed,mixed,mixed) r25.xy, r16.z, l(16), t11.xyxx
        r25.x = samp0[]..swiz;
        r25.y = samp0[]..swiz;
          ...
          r32.w = samp0[]..swiz;
            ...
            r34.w = samp0[]..swiz;
              ...
              r24.w = -r24.w * r26.w + 1;
              r24.w = r28.y * r24.w;
              r16.y = r28.z ? r24.w : r28.w;
              r28.xy = r27.ww ? r28.xy : r16.xy;
              r22.w = (int)r22.w + 1;
              r14.x = r27.z;
            }
            ...
            r38.x = samp0[]..swiz;
            r38.y = samp0[]..swiz;
              r23.w = r14.x * r16.w + r23.w;
              r14.x = r16.y * r25.z;
              r25.z = r33.z;
              r15.w = dot(r10.xyz, r25.xyz);
              r16.y = dot(r26.xyz, r25.xyz);
              r16.y = r16.y + -r33.w;
              r16.z = cmp(r16.y >= 0);
              ...
              r15.w = min(abs(r16.y), r15.w);
              r38.zw = r37.zw;
              r16.y = dot(r10.zxy, r38.xzw);
              r16.z = dot(r26.zxy, r38.xzw);
              r16.z = r16.z + -r38.y;
              r16.w = cmp(r16.z >= 0);
              r16.z = max(abs(r16.z), r7.w);
              r16.z = r16.w ? r16.z : -r16.z;
              ...
              r24.y = r27.z;
              r24.z = r29.x;
              r33.x = dot(r16.yzw, r24.xyz);
              r25.xy = r27.xw;
              r25.z = r29.w;
              r33.y = dot(r16.yzw, r25.xyz);
              r29.x = r27.y;
              r33.z = dot(r16.yzw, r29.xyz);
              if (9 == 0) r16.y = 0; else if (9+16 < 32) {               r16.y = (uint)r25.w << (32-(9 + 16)); r16.y = (uint)r16.y >> (32-9);              } else r16.y = (uint)r25.w >> 16;
              r33.w = (uint)r16.y;
              r16.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r33.xyzw, r15.w).xyz;
  ...
  if (r2.y != 0) {
    ...
    r12.xyz = r19.xyz * r2.xxx + r14.xyz;
    r10.w = 0;
    r14.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r10.xyzw, r6.w).xyz;
  ...
  r14.xyz = r13.yzx * r2.xxx;
  r2.xyz = r13.xyz * r2.yyy;
  r0.y = sqrt(r6.y);
  r0.y = r0.y * 0.5 + 0.5;
  r0.y = r0.y * r0.y;
  r4.w = 0.5 * r0.y;
  ...
  if (r7.w == 0) {
    ...
    if (r8.w != 0) {
      ...
      while (true) {
        ...
        if (r10.w != 0) break;
        r10.w = (uint)r8.w;
        r15.xy = -sunConstants.splitPinTransform[r10.w].xy + r13.xy;
    ...
    r13.w = samp0[]..swiz;
      ...
      r18.w = samp0[]..swiz;
        ...
        r15.x = samp0[]..swiz;
          ...
          r15.x = r13.x * r15.y + r15.x;
          r13.w = r13.y * r13.w + r15.x;
    ...
    if (r10.w == 0) {
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          if (r16.x != 0) break;
          r16.x = cmp((uint)r9.w < (uint)r15.w);
          r16.yz = r16.xx ? r13.xy : r13.zw;
          r16.w = r16.x ? sunConstants.splitPinTransform[r8.w].w : sunConstants.splitPinTransform[r10.w].w;
          r16.x = r16.x ? r8.w : r10.w;
  ...
  if (r7.w != 0) {
    ...
    if (r7.w != 0) {
        ...
        r15.w = samp0[]..swiz;
          ...
          if (enableDitheredShadow != 0) {
            ...
            while (true) {
              ...
              r15.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r17.xyz, r8.w).x;
              r11.w = r15.w * 0.125 + r11.w;
              r13.w = (int)r13.w + 1;
            }
          } else {
            r16.z = (uint)r10.w;
            r11.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r8.w).x;
          }
          r8.w = r11.w * r11.w;
          r8.w = r8.w * r11.w;
        } else {
      ...
      r6.w = r8.z * r6.w;
      r6.w = 0.25 * r6.w;
      r16.xyz = r6.www * r13.xyz + r2.xyz;
      r0.w = saturate(1 + -r0.w);
      r7.w = r0.w * r0.w;
      r7.w = r7.w * r7.w;
      r0.w = r7.w * r0.w;
      r0.w = r6.w * r0.w;
      r13.xyz = r0.www * r13.yzx + r14.xyz;
      r15.w = r13.z;
      r12.w = r14.z;
      r12.xyzw = r6.zzzz ? r15.xyzw : r12.xyzw;
      r13.zw = r16.xy;
      r14.zw = r2.xy;
      r13.xyzw = r6.zzzz ? r13.xyzw : r14.xyzw;
      r2.z = r6.z ? r16.z : r2.z;
      r14.z = r12.w;
      r14.xy = r13.xy;
      r2.xy = r13.zw;
    }
            ...
            if (r20.w != 0) {
              ...
              if (r20.w != 0) {
                ...
                if (r20.w != 0) {
                    ...
                    r11.w = samp0[]..swiz;
                      ...
                      if (r8.z != 0) {
                        ...
                        while (true) {
                          ...
                          if (r24.w != 0) break;
                          r43.x = dot(icb[r18.z+0].yx, r13.xw);
                  ...
                  r11.w = r11.w + -r15.w;
                  r11.w = r6.y * r11.w + r15.w;
                  r11.w = r11.w * r14.w;
                  r33.x = r32.x;
                  r12.w = cmp(0 < r15.z);
                  r19.xyz = r11.www * r33.xyz + r16.xyz;
                  ...
                  r15.w = abs(r15.z) * r3.w + -abs(r15.z);
                  r15.z = abs(r15.z) * r15.w + 1;
                  r15.w = r11.w * r0.y + r4.w;
                  r15.z = r15.z * r15.z;
                  r15.z = r15.z * r15.w;
                  r15.z = rcp(r15.z);
                  r11.w = r11.w * r20.w;
            ...
            r40.w = samp0[]..swiz;
              ...
              if (r14.w != 0) {
                ...
                if (r14.w != 0) {
                  ...
                  r18.x = abs(r15.z) * r3.w + -abs(r15.z);
