// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:23:11 2021
...
r0.y = samplerLinear[]..swiz;
  ...
  r9.x = (uint)renderTargetSize.x;
  r9.x = (int)r9.x + 7;
  r9.x = (uint)r9.x >> 3;
  r0.x = mad((int)r0.y, (int)r9.x, (int)r0.x);
  r0.y = (uint)r0.x << 5;
  bitmask.x = ((~(-1 << 27)) << 5) & 0xffffffff;  r0.x = (((uint)r0.x << 5) & bitmask.x) | ((uint)16 & ~bitmask.x);
  r9.x = (int)r8.w & -32;
  r9.y = (int)r8.w + (int)-r9.x;
  r9.w = numRefProbes & -32;
  r12.w = (int)-r9.w + numRefProbes;
  r17.yz = float2(0,1);
  r18.xy = float2(0,0);
  r19.x = 1;
  r20.xy = float2(0,0);
  ...
  r13.w = samplerLinear[]..swiz;
    r14.w = cmp((int)r9.x == (int)r13.z);
    bitmask.y = ((~(-1 << r9.y)) << 0) & 0xffffffff;  r15.y = (((uint)0 << 0) & bitmask.y) | ((uint)r13.w & ~bitmask.y);
    r13.w = r14.w ? r15.y : r13.w;
    r14.w = cmp((int)r9.w == (int)r13.z);
    ...
    while (true) {
      ...
      r15.y = (int)r15.y * 14;
      r26.xyz = -refProbeConstantsCB[r15.y].data[0].xyz + r10.xyz;
  ...
  if (r9.w != 0) {
    ...
    r12.w = 0;
    while (true) {
      r13.z = cmp((uint)r12.w >= (uint)r8.w);
      if (r13.z != 0) break;
      r13.z = (uint)r12.w >> 5;
    ...
    r13.z = samplerLinear[]..swiz;
      r13.w = cmp((int)r9.x == (int)r12.w);
      if (r9.y == 0) r14.w = 0; else if (r9.y+0 < 32) {       r14.w = (uint)r13.z << (32-(r9.y + 0)); r14.w = (uint)r14.w >> (32-r9.y);      } else r14.w = (uint)r13.z >> 0;
      ...
      while (true) {
        ...
        r18.w = 1 << (int)r17.w;
        r18.w = ~(int)r18.w;
        r14.w = (int)r14.w & (int)r18.w;
        r17.w = (int)r12.w + (int)r17.w;
        r17.w = (int)r17.w * 14;
        r27.xyz = -refProbeConstantsCB[r17.w].data[0].xyz + r10.xyz;
  ...
  if (r2.w != 0) {
    ...
    r16.w = 0;
    r17.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r16.xyzw, r5.w).xyz;
