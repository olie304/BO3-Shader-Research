  ...
  out float2 o3 : SV_TARGET3)
{
  ...
  r1.xzw = v6.xxx ? v2.xyz : -v2.xyz;
  r2.w = dot(r1.xzw, r1.xzw);
  r2.w = rsqrt(r2.w);
  r1.xzw = r1.xzw * r2.www + -r2.xyz;
  r2.yzw = debugNormalOverride.www * r1.xzw + r2.xyz;
  r1.xz = v5.xy / v5.ww;
  r4.zw = float2(0.5,0.5) * renderTargetSize.xy;
  r5.x = r4.z * r1.x;
  r5.y = -r4.w * r1.z;
  r1.xz = renderTargetSize.xy * float2(0.5,0.5) + r5.xy;
  r1.xz = v0.xy + -r1.xz;
  r1.w = r4.x + r4.y;
  r1.w = r3.z * r1.y + r1.w;
  r1.w = 0.5 * r1.w;
  r3.xyz = r3.xyz * r1.yyy + -r1.www;
  r1.y = max(r3.y, r3.z);
  r1.y = max(r3.x, r1.y);
  r1.y = max(r1.w, r1.y);
  r1.w = cmp(r1.y == r3.x);
  ...
  r1.y = rsqrt(r1.y);
  r1.yw = r2.yz * r1.yy;
  o1.xy = r1.yw * float2(0.588235319,0.588235319) + float2(0.5,0.5);
