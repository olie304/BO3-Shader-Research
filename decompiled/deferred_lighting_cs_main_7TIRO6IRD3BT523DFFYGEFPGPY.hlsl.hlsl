...
r0.y = samp0[]..swiz;
  ...
  r0.y = (uint)r0.y >> 24;
  r13.y = cmp((uint)r0.y >= (uint)r12.w);
  r13.z = cmp((uint)r0.y < numRefProbes);
  r13.y = r13.z ? r13.y : 0;
  if (r13.y != 0) {
    r13.y = (int)r0.y * 14;
    if (r2.w != 0) {
    ...
    r15.xyz = -refProbeConstantsCB[r13.y].data[0].xyz + r5.yzw;
  ...
  if (r12.w != 0) {
    ...
    r12.w = (int)r13.y + 1;
    r17.xyz = -refProbeConstantsCB[r0.y].data[0].xyz + r5.yzw;
    ...
    r15.w = refProbeConstantsCB[r0.y].data[6].y * r13.w;
    r16.w = cmp(0 < r15.w);
    if (r16.w != 0) {
      r16.w = (int)r12.w & 3;
      r17.w = (int)r16.w + -1;
      ...
      r12.w = (int)r13.y + 257;
      r13.w = r13.w * refProbeConstantsCB[r0.y].data[6].y + r13.z;
  ...
  if (r2.y != 0) {
    ...
    if (r2.y != 0) {
        ...
        if (r10.w == 0) {
          ...
          if (enableDitheredShadow != 0) {
            ...
            while (true) {
              ...
              r15.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r21.xyz, r10.w).x;
      ...
      r2.x = cmp(0 < r4.y);
      r4.xyw = r17.xyz * r5.xxx + r19.xyz;
      r17.xyz = -r5.yzw * r0.www + sunConstants.wldDir.xyz;
      r0.w = dot(r17.xyz, r17.xyz);
      r0.w = rsqrt(r0.w);
      r17.xyz = r17.xyz * r0.www;
      r0.w = dot(r17.xyz, r12.xyz);
      r2.z = dot(r11.xyz, r17.xyz);
      ...
      r0.w = r2.y * r0.w;
      r0.w = r1.w * r0.w;
      r12.xyz = r0.www * r18.xyz + r15.xzw;
      r17.xyz = r1.zzz * r18.xyz + r14.xyz;
      r17.xyz = r3.zzz ? r17.xyz : 0;
      r13.yzw = r2.xxx ? r4.xyw : r13.yzw;
      r14.xyz = r2.xxx ? r14.xyz : r17.xyz;
      r15.xzw = r2.xxx ? r12.xyz : r15.xzw;
