...
r0.y = samp0[]..swiz;
  ...
  r0.z = w1.x * r1.w;
  r2.xyz = specColorMap.Sample(specColorSampler_s, v2.xy).xyz;
  ...
  r3.yzw = normalMap.Sample(normalSampler_s, v2.xy).xyz;
  ...
  r1.w = r3.x + -r2.w;
  r1.w = debugGlossOverride.w * r1.w + r2.w;
  r2.w = debugOcclusionOverride.x + -r0.w;
  r0.w = debugOcclusionOverride.w * r2.w + r0.w;
  r3.xyz = v8.xxx ? v4.xyz : -v4.xyz;
  r2.w = dot(r3.xyz, r3.xyz);
  r2.w = rsqrt(r2.w);
  r3.xyz = r3.xyz * r2.www + -r4.xzw;
  ...
  while (true) {
    ...
    if (r4.w == 0) r11.w = 0; else if (r4.w+0 < 32) {     r11.w = (uint)r8.w << (32-(r4.w + 0)); r11.w = (uint)r11.w >> (32-r4.w);    } else r11.w = (uint)r8.w >> 0;
    r8.w = r9.w ? r11.w : r8.w;
    r9.w = (int)r3.w + (int)r7.w;
    r13.xyz = r14.xyz;
    r17.xyz = r15.xyz;
    r18.xyz = r16.xyz;
    r11.w = r5.w;
  ...
  r1.w = dot(r12.xyz, r5.xyz);
  r5.x = dot(r12.xyz, r6.xyz);
  r5.y = dot(r12.xyz, r7.xyz);
  r4.y = cmp(0 < r1.w);
  r5.xy = -r5.xy / r1.ww;
  r4.yw = r4.yy ? r5.xy : 0;
  r5.x = 9.99999975e-06 + relativeHDR;
  r4.yw = r4.yw * r5.xx + v2.xy;
  r5.xyzw = emissiveMap.Sample(colorSampler_s, r4.yw).xyzw;
  r5.xyz = r5.xyz * r9.xyz;
  r1.w = saturate(r1.w);
  r4.y = log2(r1.w);
  r4.y = emissiveFalloffPower * r4.y;
  r4.y = exp2(r4.y);
  r1.w = 1 + -r1.w;
  r1.w = log2(r1.w);
  r1.w = emissiveFalloffPower * r1.w;
  r1.w = exp2(r1.w);
  r1.w = relativeHDR ? r1.w : r4.y;
  r4.y = cmp(emissiveFalloffPower == 0.000000);
  r1.w = r4.y ? 1 : r1.w;
  r0.x = r5.w * r0.x;
  r0.x = r0.x * r1.w;
  r0.x = r0.x * r2.w;
  ...
  r4.w = 100 * r4.w;
  r6.zw = -r4.yy * float2(10,5) + float2(6.85740995,7.08500004);
  r6.z = exp2(r6.z);
  r6.z = r8.x * r6.z;
  r7.w = r4.z * r4.y;
  ...
  if (r6.w == 0) {
    ...
    if (r4.w != 0) {
      ...
      r4.y = sunConstants.globalProbeExposure * r4.w + -r3.w;
      r3.w = r8.y * r4.y + r3.w;
  ...
  r4.yz = r8.xy * float2(0.984375,0.984375) + float2(0.0078125,0.0078125);
  r4.yz = gEnvBRDFGeneric.SampleLevel(samplerLinear_s, r4.yz, 0).xy;
  r8.yzw = r22.xyz * r3.www;
  r15.xyz = r8.zwy * r4.yyy;
  r4.yzw = r8.yzw * r4.zzz;
  r0.w = sqrt(r2.w);
  r0.w = r0.w * 0.5 + 0.5;
  r0.w = r0.w * r0.w;
  r3.w = 0.5 * r0.w;
