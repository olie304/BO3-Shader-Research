  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.xyzw = v1.zxwy * r0.xxxx;
  r1.xz = r0.yw;
  r1.yw = float2(0,0);
  r1.xyzw = v0.xyxy + -r1.xyzw;
  r2.xyzw = codeTexture1.Sample(bilinearClamp_s, r1.xy).xyzw;
  r1.xyzw = codeTexture1.Sample(bilinearClamp_s, r1.zw).xyzw;
  r3.xyzw = r2.xyzw + r1.xyzw;
  r0.yw = float2(0,0);
  r4.xyzw = v0.xyxy + -r0.xyzw;
  ...
  r4.xyzw = codeTexture1.Sample(bilinearClamp_s, r0.xy).xyzw;
