...
sample_indexable(texture2d)(float,float,float,float) r0.x, r0.xyxx, t19.xyzw, s6
sample_indexable(texture2d)(float,float,float,float) r0.yzw, v1.yzyy, t10.wxyz, s4
...
sample_indexable(texture2d)(float,float,float,float) r3.w, r2.xwxx, t11.yzwx, s3
sample_indexable(texture2d)(float,float,float,float) r4.xyz, r2.xwxx, t14.xyzw, s4
...
movc r2.yz, cb0[16].yyyy, r2.yyzy, r4.yyzy
sample_indexable(texture2d)(float,float,float,float) r4.yzw, r2.yzyy, t18.wxyz, s2
sample_indexable(texture2d)(float,float,float,float) r1.w, r2.yzyy, t15.yzwx, s2
...
sample_indexable(texture2d)(float,float,float,float) r1.w, r2.yzyy, t17.yzwx, s3
sample_indexable(texture2d)(float,float,float,float) r6.xyz, r2.yzyy, t16.xyzw, s4
mad r4.yzw, r4.yyzw, r5.xxyz, -r3.xxyz
...
mul r2.z, r2.z, r4.z
exp r5.y, r2.z
mad_sat r4.yz, cb0[10].xxxx, r5.xxyx, r4.yyyy
add r2.y, r2.y, -r4.y
add r2.z, -r4.y, r4.z
div_sat r2.y, r2.y, r2.z
add r2.z, -cb0[12].x, cb0[12].y
mad r3.w, r3.w, r2.z, cb0[12].x
mul_sat r3.w, r3.w, l(0.05882353)
add r4.y, -cb0[15].x, cb0[15].y
mad r1.w, r1.w, r4.y, cb0[15].x
mul_sat r1.w, r1.w, l(0.05882353)
add r1.w, -r3.w, r1.w
mad r1.w, r0.x, r1.w, r3.w
sample_indexable(texture2d)(float,float,float,float) r3.w, v1.yzyy, t12.yzwx, s5
...
mad r5.w, r4.x, cb0[13].x, r0.w
mad r1.xy, r4.yzyy, cb0[13].yyyy, r0.yzyy
dp3 r0.y, r1.xyzx, r1.xyzx
rsq r0.y, r0.y
mul r6.xyz, r0.yyyy, r1.xyzx
mad r6.w, r4.w, cb0[13].y, r0.w
...
if_nz r1.z
  ...
  movc r2.xzw, r2.xxxx, r5.xxyz, r4.xxyw
  movc r4.xyz, r4.zzzz, l(0,1.000000,0,0), r3.xyzx
  movc r3.xyz, r1.wwww, r2.xzwx, r4.xyzx
endif 
