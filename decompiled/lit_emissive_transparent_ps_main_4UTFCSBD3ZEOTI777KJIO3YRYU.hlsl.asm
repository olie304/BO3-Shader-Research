...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:33:49 2021
//
//
...
if_nz r1.w
  ...
  mad r6.xy, r4.xyxx, r1.zzzz, r5.xyxx
  dp3 r5.x, r6.xyzx, r6.xyzx
  rsq r5.x, r5.x
  mul r4.xyw, r5.xxxx, r6.xyxz
  mad r4.z, r4.z, r1.z, r1.w
else 
...
if_nz r1.w
  ...
  mul r5.w, r1.w, cb0[12].w
  ge r5.w, r5.w, -r5.w
  movc r5.w, r5.w, cb0[12].w, -cb0[12].w
  div r6.z, l(1.000000, 1.000000, 1.000000, 1.000000), r5.w
  mul r1.w, r1.w, r6.z
  frc r1.w, r1.w
  mul r1.w, r1.w, r5.w
  ...
  mul r6.zw, r6.zzzw, cb0[14].zzzw
  mad r1.xy, r1.xyxx, cb0[14].zwzz, r6.zwzz
  ...
  add r1.xy, r1.xyxx, l(0.500000, 0.500000, 0.000000, 0.000000)
  mov_sat r6.zw, r1.xxxy
  movc r8.xy, cb0[16].zwzz, r6.zwzz, r1.xyxx
endif 
dp3 r1.x, -v7.xyzx, -v7.xyzx
rsq r1.x, r1.x
mul r11.xyz, r1.xxxx, -v7.xyzx
dp3_sat r1.y, r11.xyzx, r5.xyzx
...
loop 
  ...
  loop 
    ...
    if_nz r15.z
      ...
      and r15.y, r25.y, r25.x
      and r15.y, r25.z, r15.y
      if_nz r15.y
        ...
        if_nz r16.x
          ...
          mad r24.z, r28.y, r15.z, r24.z
          mul r15.x, r26.z, r15.y
          mov r26.z, r34.z
          dp3 r15.y, r13.xyzx, r26.xyzx
          ...
          utof r34.w, r15.z
          sample_l_indexable(texturecubearray)(float,float,float,float) r18.yzw, r34.xyzw, t8.wxyz, s2, r15.y
          ...
          dp3 r15.y, r27.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
          ...
          mov r25.x, r23.w
          mov r25.yz, r24.xxyx
          mad r24.xyw, r18.zwzy, r15.xxxx, r25.yzyx
          mov r23.w, r24.w
        endif 
      endif 
    endif 
    ...
    loop 
      ...
      if_nz r18.z
        ...
        if_nz r17.w
          ...
          and r20.w, r18.z, l(1)
          movc r29.xy, r20.wwww, r16.xyxx, r16.zxzz
          mov r16.x, r18.z
          mov r30.xy, r29.xyxx
          mov r20.w, l(1)
          loop 
            ...
            movc r18.y, r29.w, r25.w, r30.z
            movc r30.xy, r29.zzzz, r30.xyxx, r18.xyxx
            iadd r20.w, r20.w, l(1)
            mov r16.x, r28.w
          endloop 
          add_sat r16.x, -r15.y, r30.y
          ...
          if_nz r18.y
            ...
            mul r16.x, r27.z, r17.w
            mov r27.z, r35.z
            dp3 r16.w, r13.xyzx, r27.xyzx
            ...
            min r16.w, r16.w, |r17.w|
            mov r40.zw, r39.zzzw
            dp3 r17.w, r13.zxyz, r40.xzwx
            dp3 r18.y, r28.zxyz, r40.xzwx
            ...
            mov r26.y, r29.z
            mov r26.z, r31.x
            dp3 r35.x, r18.yzwy, r26.xyzx
            mov r27.xy, r29.xwxx
            mov r27.z, r31.w
            dp3 r35.y, r18.yzwy, r27.xyzx
            mov r31.x, r29.y
            dp3 r35.z, r18.yzwy, r31.xyzx
            ubfe r17.w, l(9), l(16), r27.w
            utof r35.w, r17.w
            sample_l_indexable(texturecubearray)(float,float,float,float) r18.yzw, r35.xyzw, t8.wxyz, s2, r16.w
            ...
            movc r17.z, r26.x, l(0), l(0.500000)
...
max r5.w, r22.w, l(1.000000)
rcp r5.w, r5.w
mov_sat r22.w, r22.w
mul r12.yzw, r5.wwww, r21.xxyz
mul r14.xyz, r5.wwww, r22.xyzx
...
if_nz r6.w
  ...
  lt r16.xyz, l(0.000000, 0.000000, 0.000000, 0.000000), r4.xyzx
  ...
  mov r4.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r16.xyz, r4.xyzw, t8.xyzw, s2, l(6.000000)
  mul r15.xyz, r15.xyzx, r16.xyzx
  dp3 r4.w, r15.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
  mad r12.yzw, r21.xxyz, r5.wwww, r15.xxyz
  mov r13.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r15.xyz, r13.xyzw, t8.xyzw, s2, r6.z
  mad r5.w, cb2[19].x, r6.w, -r4.w
  mad r4.w, r7.y, r5.w, r4.w
  mad r14.xyz, r15.xyzx, r4.wwww, r14.xyzx
endif 
add r4.w, r2.w, r7.x
log r4.w, |r4.w|
mul r4.w, r4.w, r5.z
...
mul r7.yzw, r4.wwww, r14.xxyz
mul r14.xyz, r6.zzzz, r7.zwyz
...
if_nz r6.w
  ...
  if_nz r6.w
    ...
    mad r16.xyz, r9.wwww, r9.xyzx, r15.xyzx
    ...
    mul r1.x, r1.x, r6.w
    mul r1.x, r1.x, r6.z
    mad r9.xyz, r1.xxxx, r9.yzxy, r14.xyzx
    mov r16.w, r9.z
    mov r15.w, r14.z
    movc r15.xyzw, r5.wwww, r16.xyzw, r15.xyzw
    mov r9.zw, r12.yyyz
    mov r14.zw, r7.yyyz
    movc r9.xyzw, r5.wwww, r9.xyzw, r14.xyzw
...
ret 
// Approximately 2385 instruction slots used
