...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:42:24 2021
//
//
// Buffer Definitions: 
//
...
mad r6.xyz, r3.xyzx, r2.xxxx, r6.xyzx
...
if_nz r1.z
  ...
  and r7.xyz, r1.zzzz, l(1, 2, 4, 0)
  movc r8.xyz, r7.xxxx, l(1.000000,0,1.000000,0), r0.xyzx
  movc r7.xyw, r7.yyyy, l(0,1.000000,0,1.000000), r0.xyxz
  movc r2.xyw, r2.xxxx, r8.xyxz, r7.xyxw
  movc r7.xyz, r7.zzzz, l(0,1.000000,0,0), r0.xyzx
  movc r0.xyz, r1.wwww, r2.xywx, r7.xyzx
endif 
          ...
          if_nz r14.w
            ...
            if_nz r14.w
              ...
              if_nz r25.y
                ...
                mul r27.xyz, r2.zzzz, r28.xyzx
                mul r25.xyz, r2.zzzz, r25.xyzx
                mul r26.xyz, r2.zzzz, r26.xyzx
...
mad r2.xyz, r2.xywx, r1.wwww, r17.xyzx
mov_sat r1.x, v7.x
...
sample_indexable(texture2d)(float,float,float,float) r4.xyzw, r3.yzyy, t22.xyzw, s1
mul r3.yzw, r9.xxyz, r4.xxyz
mov_sat r3.x, r3.x
log r4.x, r3.x
...
dp3_sat r8.x, r6.xyzx, r10.xyzx
dp3 r1.w, -r10.xyzx, r6.xyzx
add r1.w, r1.w, r1.w
mad r12.xyz, r6.xyzx, -r1.wwww, -r10.xyzx
...
if_z r1.z
        ...
        if_nz r17.w
          ...
          if_nz r17.z
            ...
            if_nz r17.z
              ...
              sqrt r16.w, r16.w
              mad r16.w, r4.z, l(5.000000), r16.w
  ...
  lt r4.z, r23.w, l(0.990000)
  if_nz r4.z
    add r4.z, -r23.w, l(1.000000)
    ...
    lt r13.xyz, l(0.000000, 0.000000, 0.000000, 0.000000), r6.xyzx
    ...
    mov r6.w, l(0)
    sample_l_indexable(texturecubearray)(float,float,float,float) r13.xyz, r6.xyzw, t8.xyzw, s2, l(6.000000)
    ...
    mad r1.z, cb2[19].x, r4.z, -r5.z
    mad r1.z, r8.y, r1.z, r5.z
...
mad r4.z, r8.x, r1.y, r1.z
mul r1.yz, r1.yyzy, r4.zzzz
dp3 r4.z, r6.xyzx, cb2[17].xyzx
mov_sat r4.w, r4.z
...
if_nz r5.z
  ...
  if_nz r5.z
    ...
    mul r2.w, r2.w, r5.z
    mul r2.w, r2.w, r4.w
    mad r17.xyz, r2.wwww, r11.zwyz, r14.xyzx
    mov r15.w, r17.z
    mov r13.w, r14.z
    movc r13.xyzw, r4.zzzz, r15.xyzw, r13.xyzw
    mov r17.zw, r16.xxxy
    mov r14.zw, r8.yyyz
    movc r15.xyzw, r4.zzzz, r17.xyzw, r14.xyzw
    movc r8.w, r4.z, r16.z, r8.w
    mov r14.z, r13.w
    mov r14.xy, r15.xyxx
    mov r8.yz, r15.zzwz
  endif 
          ...
          if_nz r16.w
            ...
            if_nz r16.w
              ...
              if_nz r16.w
                ...
                dp3_sat r10.w, r6.xyzx, r40.xyzx
...
ret 
// Approximately 2938 instruction slots used
