...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  r1.w = r3.w * detailScaleHeight + r1.w;
  r2.w = v8.x ? 1 : -1;
  ...
  r1.z = rsqrt(r1.z);
  r7.xyz = r7.xyz * r1.zzz + -r2.xyz;
  r2.xyz = debugNormalOverride.www * r7.xyz + r2.xyz;
  ...
  r8.x = saturate(dot(r2.xyz, r9.xyz));
  r1.w = dot(-r9.xyz, r2.xyz);
  r1.w = r1.w + r1.w;
  r13.xyz = r2.xyz * -r1.www + -r9.xyz;
  r1.w = 17 * r8.y;
  r1.w = exp2(r1.w);
  r1.w = 2 + r1.w;
  r1.w = 2 / r1.w;
  ...
  if (r6.w == 0) {
    ...
    if (r5.z != 0) {
      ...
      r21.xyz = r23.xyz * r4.zzz + r12.yzw;
      r13.w = 0;
  ...
  if (r5.z == 0) {
    ...
    if (r6.w != 0) {
      ...
      while (true) {
        ...
        r7.w = sunConstants.splitPinTransform[r9.w].z * r11.w;
        r9.w = cmp(r7.w < 1);
        if (r9.w != 0) {
          break;
        }
  ...
  if (r5.z != 0) {
    ...
    if (r5.z != 0) {
      ...
      r6.w = r6.w * r5.w;
      r4.z = cmp(0 < r4.z);
      r16.xyz = r6.www * r10.xyz + r14.xyz;
      ...
      r16.w = r10.z;
      r14.w = r15.z;
      r14.xyzw = r4.zzzz ? r16.xyzw : r14.xyzw;
      r10.zw = r12.yz;
      r15.zw = r8.yz;
      r10.xyzw = r4.zzzz ? r10.xyzw : r15.xyzw;
      r8.w = r4.z ? r12.w : r8.w;
      r15.z = r14.w;
      r15.xy = r10.xy;
      r8.yz = r10.zw;
    }
