...
sample_indexable(texture2d)(float,float,float,float) r0.x, r0.xyxx, t16.xyzw, s4
...
sample_indexable(texture2d)(float,float,float,float) r4.xyz, r2.xwxx, t11.xyzw, s3
...
sample_indexable(texture2d)(float,float,float,float) r4.xyz, r2.yzyy, t15.xyzw, s2
...
sample_indexable(texture2d)(float,float,float,float) r6.xyz, r2.yzyy, t14.xyzw, s3
mad r4.xyz, r4.xyzx, r5.xyzx, -r3.xyzx
mad r3.xyz, r0.xxxx, r4.xyzx, r3.xyzx
mul r2.yz, v1.yyzy, cb0[16].zzwz
mul r2.yz, r2.yyzy, cb0[10].zzwz
sample_indexable(texture2d)(float,float,float,float) r1.w, r2.yzyy, t6.yzwx, s1
mad_sat r2.y, v1.x, l(0.998000), l(0.001000)
add r2.z, -r2.y, l(1.000000)
mov_sat r4.x, cb0[10].y
log r2.y, r2.y
mul r2.y, r2.y, r4.x
exp r2.y, r2.y
mov r5.x, -r2.y
...
mul r2.y, r2.y, r4.x
exp r5.y, r2.y
mad_sat r2.yz, cb0[10].xxxx, r5.xxyx, r2.zzzz
add r1.w, r1.w, -r2.y
add r2.y, -r2.y, r2.z
div_sat r1.w, r1.w, r2.y
add r2.y, -cb0[12].x, cb0[12].y
mul_sat r2.z, cb0[12].y, l(0.05882353)
mul_sat r4.x, cb0[15].y, l(0.05882353)
add r4.x, -r2.z, r4.x
mad r2.z, r0.x, r4.x, r2.z
...
mad r5.w, r3.w, cb0[13].x, r0.w
mad r1.xy, r4.xyxx, cb0[13].yyyy, r0.yzyy
dp3 r0.y, r1.xyzx, r1.xyzx
rsq r0.y, r0.y
mul r6.xyz, r0.yyyy, r1.xyzx
mad r6.w, r4.z, cb0[13].y, r0.w
...
mul r2.xzw, r0.yyyy, r6.xxyz
mad r2.xzw, r5.xxyz, r0.xxxx, r2.xxzw
mad r0.xyz, r4.xyzx, r0.zzzz, r2.xzwx
dp3 r1.x, r0.xyzx, r0.xyzx
rsq r1.x, r1.x
mul r0.xyz, r0.xyzx, r1.xxxx
mad r1.x, cb1[62].x, r2.y, cb0[12].x
mul_sat r1.x, r1.x, l(0.05882353)
lt r1.z, l(0.000000), cb1[64].w
if_nz r1.z
  ftoi r1.z, cb1[64].w
  lod r2.x, v1.yzyy, t7.y, s2
  lod r2.y, v1.yzyy, t7.x, s2
  lt r2.x, r2.x, r2.y
  ...
  movc r2.yzw, r2.yyyy, r5.xxyz, r4.xxyw
  movc r4.xyz, r4.zzzz, l(0,1.000000,0,0), r3.xyzx
  movc r3.xyz, r2.xxxx, r2.yzwy, r4.xyzx
endif 
add r2.xyz, -r3.xyzx, cb1[58].xyzx
mad r2.xyz, cb1[58].wwww, r2.xyzx, r3.xyzx
add r1.z, -r1.w, cb1[59].x
mad r1.z, cb1[59].w, r1.z, r1.w
...
mad r4.z, cb1[63].w, r1.x, l(1.000000)
