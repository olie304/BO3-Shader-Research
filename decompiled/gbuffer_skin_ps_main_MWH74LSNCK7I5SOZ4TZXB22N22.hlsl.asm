...
mov o0.xyz, r0.xyzx
mul_sat r1.xy, v6.xyxx, cb0[11].wwww
log r1.xy, r1.xyxx
mul r1.xy, r1.xyxx, cb0[11].zzzz
exp r1.xy, r1.xyxx
lt r0.w, r1.y, r1.x
movc r1.x, r0.w, r1.x, r1.y
movc r1.y, r0.w, cb0[11].y, cb0[11].x
mul r1.x, r1.y, r1.x
sample_indexable(texture2d)(float,float,float,float) r1.yzw, v2.xyxx, t14.wxyz, s3
sample_indexable(texture2d)(float,float,float,float) r2.xyz, v2.xyxx, t12.xyzw, s3
movc r1.yzw, r0.wwww, r1.yyzw, r2.xxyz
...
mad r1.xy, r1.yzyy, r1.xxxx, r2.xyxx
