  ...
  out float2 o3 : SV_TARGET3)
{
  ...
  r3.y = r3.y + -r2.w;
  r2.w = r0.x * r3.y + r2.w;
  r3.y = aoMap.Sample(aoSampler_s, v2.xy).x;
  ...
  r1.xzw = v4.xyz * r1.xxx + -r4.xyz;
  r4.yzw = debugNormalOverride.www * r1.xzw + r4.xyz;
  r1.xz = v7.xy / v7.ww;
  r3.yw = float2(0.5,0.5) * renderTargetSize.xy;
  r5.x = r3.y * r1.x;
  r5.y = -r3.w * r1.z;
