  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.zw = -postFxControl0.xz + r0.xy;
  r0.z = dot(r0.zw, r0.zw);
  r0.z = -7.21347533e-05 * r0.z;
  r0.z = exp2(r0.z);
  r1.xy = -postFxControl1.xz + r0.xy;
  r0.w = dot(r1.xy, r1.xy);
  r0.w = -7.21347533e-05 * r0.w;
  r0.w = exp2(r0.w);
  r0.z = r0.z + r0.w;
  r1.xy = -postFxControl2.xz + r0.xy;
  r0.w = dot(r1.xy, r1.xy);
  r0.w = -7.21347533e-05 * r0.w;
  r0.w = exp2(r0.w);
  r0.z = r0.z + r0.w;
  r1.xy = -postFxControl3.xz + r0.xy;
  r0.w = dot(r1.xy, r1.xy);
  r0.w = -7.21347533e-05 * r0.w;
  r0.w = exp2(r0.w);
  r0.z = r0.z + r0.w;
  r1.xy = -postFxControl4.xz + r0.xy;
  r0.w = dot(r1.xy, r1.xy);
  r0.w = -7.21347533e-05 * r0.w;
  r0.w = exp2(r0.w);
  r0.z = r0.z + r0.w;
  r1.xy = -postFxControl5.xz + r0.xy;
  r0.w = dot(r1.xy, r1.xy);
  r0.w = -7.21347533e-05 * r0.w;
  r0.w = exp2(r0.w);
  r0.z = r0.z + r0.w;
  r1.xy = -postFxControl6.xz + r0.xy;
  r0.w = dot(r1.xy, r1.xy);
  r0.w = -7.21347533e-05 * r0.w;
  r0.w = exp2(r0.w);
  r0.z = r0.z + r0.w;
  r1.xy = -postFxControl7.xz + r0.xy;
  r0.w = dot(r1.xy, r1.xy);
  r0.w = -7.21347533e-05 * r0.w;
  r0.w = exp2(r0.w);
  r0.z = r0.z + r0.w;
  r1.xy = -postFxControl8.xz + r0.xy;
  r0.w = dot(r1.xy, r1.xy);
  r0.w = -7.21347533e-05 * r0.w;
  r0.w = exp2(r0.w);
  r0.z = r0.z + r0.w;
  r1.xy = -postFxControl9.xz + r0.xy;
  r0.w = dot(r1.xy, r1.xy);
  r0.w = -7.21347533e-05 * r0.w;
  r0.w = exp2(r0.w);
  r0.z = r0.z + r0.w;
  r1.xy = -postFxControlA.xz + r0.xy;
  r0.w = dot(r1.xy, r1.xy);
  r0.w = -7.21347533e-05 * r0.w;
  r0.w = exp2(r0.w);
  r0.z = r0.z + r0.w;
  r1.xy = -postFxControlB.xz + r0.xy;
  r0.w = dot(r1.xy, r1.xy);
  r0.w = -7.21347533e-05 * r0.w;
  r0.w = exp2(r0.w);
  r0.z = r0.z + r0.w;
  r1.xy = -postFxControlC.xz + r0.xy;
  r0.w = dot(r1.xy, r1.xy);
  r0.w = -7.21347533e-05 * r0.w;
  r0.w = exp2(r0.w);
  r0.z = r0.z + r0.w;
  r1.xy = -postFxControlD.xz + r0.xy;
  r0.w = dot(r1.xy, r1.xy);
  r0.w = -7.21347533e-05 * r0.w;
  r0.w = exp2(r0.w);
  r0.z = r0.z + r0.w;
  r1.xy = -postFxControlE.xz + r0.xy;
  r0.xw = -postFxControlF.xz + r0.xy;
  r0.x = dot(r0.xw, r0.xw);
  r0.x = -7.21347533e-05 * r0.x;
  r0.x = exp2(r0.x);
  r0.w = dot(r1.xy, r1.xy);
  r0.w = -7.21347533e-05 * r0.w;
  r0.w = exp2(r0.w);
  ...
  r0.x = 10 * r0.x;
  r0.x = frac(r0.x);
  r0.xy = cmp(r0.xy < float2(0.5,10));
  r0.x = (int)r0.x | (int)r0.y;
  r0.x = r0.x ? 0 : 0.5;
  r1.xyzw = float4(0,-0.00138888892,0,0.00138888892) + v1.xyxy;
  r0.y = floatZSampler.Sample(samp0_s, r1.zw).x;
  r0.z = floatZSampler.Sample(samp0_s, r1.xy).x;
  ...
  r0.xyzw = float4(7.62939453e-05,-3.05175781e-05,-3.05175781e-05,-1) * r0.xyzw;
