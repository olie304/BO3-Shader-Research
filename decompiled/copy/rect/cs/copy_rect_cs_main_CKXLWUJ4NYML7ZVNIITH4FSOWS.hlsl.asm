...
// ------------------------------ ---------- ------- ----------- -------------- ------
// TexSrc                            texture   uint4     2darray             t0      1 
// TexDest                               UAV   uint4     2darray             u0      1 
...
dcl_constantbuffer CB8[19], immediateIndexed
...
ishl r0.xyz, vThreadGroupID.xyzx, l(3, 3, 0, 0)
iadd r0.xyz, r0.xyzx, vThreadIDInGroup.xyzx
ult r1.xyz, r0.xyzx, cb8[16].xyzx
and r0.w, r1.y, r1.x
and r0.w, r1.z, r0.w
if_nz r0.w
  iadd r1.xyzw, r0.xyzz, cb8[18].xyzz
  iadd r0.xyz, r0.xyzx, cb8[17].xyzx
  mov r0.w, l(0)
  ld_indexable(texture2darray)(uint,uint,uint,uint) r0.xyzw, r0.xyzw, t0.xyzw
