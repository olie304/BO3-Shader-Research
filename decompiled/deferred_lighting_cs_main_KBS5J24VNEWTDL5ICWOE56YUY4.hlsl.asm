...
loop 
  ...
  if_nz r9.w
    ...
    if_nz r2.w
      ...
      store_structured u2.xyzw, cb2[52].x, r9.w, r15.xyzw
    endif 
    ...
    dp3 r16.w, cb11[r12.w + 1].xyzx, r15.yzwy
    add_sat r16.w, r16.w, cb11[r12.w + 1].w
    mul r13.w, r13.w, r16.w
    dp3 r16.w, cb11[r12.w + 2].xyzx, r15.yzwy
    add_sat r16.w, r16.w, cb11[r12.w + 2].w
    mul r13.w, r13.w, r16.w
    dp3 r16.w, cb11[r12.w + 3].xyzx, r15.yzwy
    add_sat r16.w, r16.w, cb11[r12.w + 3].w
    mul r13.w, r13.w, r16.w
    dp3 r16.w, cb11[r12.w + 4].xyzx, r15.yzwy
    add_sat r16.w, r16.w, cb11[r12.w + 4].w
    mul r13.w, r13.w, r16.w
    dp3 r16.w, cb11[r12.w + 5].xyzx, r15.yzwy
    ...
    mov r13.w, l(1)
    loop 
      ige r17.w, r13.w, r10.w
      breakc_nz r17.w
      iadd r17.w, r9.w, r13.w
      imul null, r17.w, r17.w, l(6)
      dp3 r19.w, cb11[r17.w + 0].xyzx, r15.yzwy
      add_sat r19.w, r19.w, cb11[r17.w + 0].w
      mul r19.w, r19.w, r24.x
      dp3 r20.w, cb11[r17.w + 1].xyzx, r15.yzwy
      add_sat r20.w, r20.w, cb11[r17.w + 1].w
      mul r19.w, r19.w, r20.w
      dp3 r20.w, cb11[r17.w + 2].xyzx, r15.yzwy
      add_sat r20.w, r20.w, cb11[r17.w + 2].w
      mul r19.w, r19.w, r20.w
      dp3 r20.w, cb11[r17.w + 3].xyzx, r15.yzwy
      add_sat r20.w, r20.w, cb11[r17.w + 3].w
      mul r19.w, r19.w, r20.w
      dp3 r20.w, cb11[r17.w + 4].xyzx, r15.yzwy
      add_sat r20.w, r20.w, cb11[r17.w + 4].w
      mul r19.w, r19.w, r20.w
      dp3 r20.w, cb11[r17.w + 5].xyzx, r15.yzwy
      add_sat r17.w, r20.w, cb11[r17.w + 5].w
      mul r24.x, r17.w, r19.w
      ushr r20.w, r12.w, l(2)
      ubfe r24.z, l(1), l(2), r12.w
      and r24.w, r20.w, l(2)
      max r25.x, r24.x, r24.y
      mad r17.w, -r19.w, r17.w, l(1.000000)
      mul r17.w, r17.w, r24.y
      movc r18.y, r24.w, r17.w, r25.x
      movc r24.xy, r24.zzzz, r24.xyxx, r18.xyxx
      iadd r13.w, r13.w, l(1)
      mov r12.w, r20.w
    endloop 
    mov_sat r24.y, r24.y
    mul r9.w, r24.y, cb10[r8.w + 6].y
    ...
    if_nz r10.w
      ...
      if_nz r12.w
        imad r16.xw, r10.wwww, l(20, 0, 0, 20), l(860, 0, 0, 876)
        ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r10.w, cb2[52].x, r16.x, u2.xxxx
        or r10.w, r10.w, l(32)
        store_structured u2.x, cb2[52].x, r16.x, r10.w
        store_structured u2.x, cb2[52].x, r16.w, r9.w
      endif 
      iadd r22.w, r22.w, l(257)
      mad r22.z, r24.y, cb10[r8.w + 6].y, r22.z
      ...
      div r12.w, r13.w, r12.w
      min r10.w, r10.w, |r12.w|
      add r25.x, r15.y, cb10[r8.w + 3].w
      add r25.yz, r15.zzwz, cb10[r8.w + 4].xxyx
      mad r24.xzw, r14.xxyz, r10.wwww, r25.xxyz
      dp3 r12.w, r24.xzwx, r24.xzwx
      sqrt r12.w, r12.w
      div r10.w, r10.w, r12.w
      add r10.w, r10.w, r10.w
      sqrt r10.w, r10.w
      mad r10.w, r3.y, l(5.000000), r10.w
      ...
      utof r26.w, r12.w
      sample_l_indexable(texturecubearray)(float,float,float,float) r24.xzw, r26.xyzw, t8.xwyz, s2, r10.w
      ...
      movc r24.xzw, r10.wwww, l(1.000000,0,1.000000,0), r24.xxzw
      dp3 r29.x, r15.yzwy, r25.xyzx
      dp3 r29.y, r15.yzwy, r27.xyzx
      dp3 r29.z, r15.yzwy, r28.xyzx
      mad_sat r15.yzw, r29.xxyz, cb10[r8.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
      mul r29.xy, r15.yzyy, cb10[r8.w + 4].zwzz
      mul r29.z, r15.w, cb10[r8.w + 5].x
      add r15.yzw, r29.xxyz, cb10[r8.w + 5].yyzw
...
loop 
  ...
  if_nz r9.w
    ...
    loop 
      ...
      dp3 r20.w, cb11[r17.w + 5].xyzx, r15.yzwy
      add_sat r17.w, r20.w, cb11[r17.w + 5].w
      mul r26.x, r17.w, r19.w
      ushr r20.w, r12.w, l(2)
      ubfe r23.w, l(1), l(2), r12.w
      and r24.w, r20.w, l(2)
      max r25.z, r26.x, r26.y
      mad r17.w, -r19.w, r17.w, l(1.000000)
      mul r17.w, r17.w, r26.y
      movc r18.w, r24.w, r17.w, r25.z
      movc r26.xy, r23.wwww, r26.xyxx, r18.zwzz
      iadd r13.w, r13.w, l(1)
      mov r12.w, r20.w
    endloop 
    add_sat r9.w, -r22.z, r26.y
    mul r10.w, r9.w, cb10[r8.w + 6].y
    lt r12.w, l(0.000000), r10.w
    if_nz r12.w
      and r12.w, r25.y, l(31)
      ...
      mad r18.x, r9.w, cb10[r8.w + 6].y, r18.x
      ...
      div r12.w, r13.w, r12.w
      min r10.w, r10.w, |r12.w|
      add r27.x, r15.y, cb10[r8.w + 3].w
      add r27.yz, r15.zzwz, cb10[r8.w + 4].xxyx
      mad r26.xzw, r14.xxyz, r10.wwww, r27.xxyz
      dp3 r12.w, r26.xzwx, r26.xzwx
      sqrt r12.w, r12.w
      div r10.w, r10.w, r12.w
      add r10.w, r10.w, r10.w
      sqrt r10.w, r10.w
      ...
      ubfe r12.w, l(9), l(16), cb10[r8.w + 7].z
      utof r28.w, r12.w
      sample_l_indexable(texturecubearray)(float,float,float,float) r26.xzw, r28.xyzw, t8.xwyz, s2, r10.w
      and r31.xyz, r26.xzwx, l(0x7fffffff, 0x7fffffff, 0x7fffffff, 0)
      ieq r31.xyz, r31.xyzx, l(0x7f800000, 0x7f800000, 0x7f800000, 0)
      or r10.w, r31.y, r31.x
      or r10.w, r31.z, r10.w
      ...
      mad_sat r15.yzw, r31.xxyz, cb10[r8.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
      mul r31.xy, r15.yzyy, cb10[r8.w + 4].zwzz
      mul r31.z, r15.w, cb10[r8.w + 5].x
      add r15.yzw, r31.xxyz, cb10[r8.w + 5].yyzw
      ...
      or r8.w, r28.y, r28.x
      or r8.w, r28.z, r8.w
      movc r27.xyz, r8.wwww, l(1.000000,1.000000,0,0), r27.xyzx
      ...
      mul r10.w, r6.w, r8.w
      mul r15.yzw, r9.wwww, r26.xxzw
      dp3 r9.w, r15.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r8.w, r6.w, r8.w, r9.w
      div r8.w, r10.w, r8.w
      mad r24.xyz, r15.yzwy, r8.wwww, r24.xyzx
    else 
      mov r25.x, r18.x
      mov r18.xy, r25.xyxx
    endif 
...
mul r0.y, r0.y, r4.z
mul r2.y, r2.y, r4.z
imul null, r4.z, r13.z, l(15)
ubfe r6.w, l(3), l(24), cb9[r4.z + 1].w
switch r6.w
  case l(4)
  if_nz r2.w
    add r17.yzw, cb1[24].xxyz, cb9[r4.z + 0].xxyz
    mov r17.x, l(2)
    store_structured u2.xyzw, cb2[52].x, l(112), r17.xyzw
  endif 
  lt r7.w, l(0.000000), cb9[r4.z + 6].y
  mov r17.xy, cb9[r4.z + 5].zwzz
  mov r17.z, cb9[r4.z + 6].x
  mad r13.yzw, -r17.xxyz, l(0.000000, 0.500000, 0.500000, 0.500000), cb9[r4.z + 0].xxyz
  add r18.xyz, -r5.xyzx, r13.yzwy
  dp3 r8.w, r17.xyzx, r18.xyzx
  div_sat r9.w, -r8.w, cb9[r4.z + 6].y
  mad r19.xyz, r9.wwww, r17.xyzx, r13.yzwy
  movc r19.xyz, r7.wwww, r19.xyzx, cb9[r4.z + 0].xyzx
  ...
  if_nz r14.w
    sqrt r14.w, r10.w
    mul r15.w, cb9[r4.z + 3].x, cb9[r4.z + 3].x
    div r10.w, r15.w, r10.w
    min r10.w, r10.w, l(1.000000)
    mad_sat r19.xy, r14.wwww, cb9[r4.z + 2].xzxx, cb9[r4.z + 2].ywyy
    ...
    if_nz r14.w
      ubfe r14.w, l(3), l(27), cb9[r4.z + 1].w
      if_nz r2.w
      ...
      if_nz r14.w
        ...
        add r19.yzw, r19.yyzw, -cb9[r4.z + 4].yyzw
        max r14.w, |r19.w|, |r19.z|
        max r14.w, r14.w, |r19.y|
        div r14.w, cb9[r4.z + 5].x, r14.w
        add r14.w, r14.w, cb9[r4.z + 5].y
        dp3 r15.w, r19.yzwy, r19.yzwy
        rsq r15.w, r15.w
        max r14.w, r14.w, l(0.00006104)
        and r16.w, l(0x0000ffff), cb9[r4.z + 1].w
        mov r21.x, -r3.x
        utof r22.w, r16.w
        mov r21.y, r13.x
        mov r21.z, r3.x
        ...
        loop 
          ...
          mul r23.yz, r20.yyzy, cb9[r4.z + 3].yyyy
      ...
      lt r14.w, l(0.000000), r10.w
      if_nz r14.w
        mul r14.w, r1.w, cb9[r4.z + 1].z
        dp3 r15.w, r17.xyzx, r14.xyzx
        dp3 r14.x, r14.xyzx, r18.xyzx
        mad r14.y, -r15.w, r15.w, cb9[r4.z + 6].y
        mad r8.w, r15.w, r14.x, -r8.w
        div_sat r8.w, r8.w, r14.y
        div r14.x, r14.y, cb9[r4.z + 6].y
        mul r14.xw, r14.xxxw, l(10.000000, 0.000000, 0.000000, 0.250000)
        min r14.x, r14.x, l(1.000000)
        add r8.w, -r9.w, r8.w
        mad r8.w, r14.x, r8.w, r9.w
        mad r13.yzw, r8.wwww, r17.xxyz, r13.yyzw
        movc r13.yzw, r7.wwww, r13.yyzw, cb9[r4.z + 0].xxyz
        add r13.yzw, -r5.xxyz, r13.yyzw
        dp3 r7.w, r13.yzwy, r13.yzwy
        rsq r7.w, r7.w
        mul r14.xyz, r7.wwww, r13.yzwy
        ubfe r8.w, l(4), l(16), cb9[r4.z + 1].w
        ult r9.w, l(0), r8.w
        and r9.w, r1.z, r9.w
        if_nz r9.w
          ...
          ubfe r8.w, l(4), l(20), cb9[r4.z + 1].w
          ult r9.w, l(0), r8.w
          not r15.w, r1.z
          and r9.w, r9.w, r15.w
          if_nz r9.w
        ...
        mul r8.w, r10.w, r8.w
        mov r17.x, cb9[r4.z + 0].w
        mov r17.yz, cb9[r4.z + 1].xxyx
        lt r9.w, l(0.000000), r11.w
        mad r18.xyz, r8.wwww, r17.xyzx, r3.yzwy
        dp3_sat r8.w, r11.xyzx, r14.xyzx
        mad r13.yzw, r13.yyzw, r7.wwww, r12.xxyz
        dp3 r7.w, r13.yzwy, r13.yzwy
        rsq r7.w, r7.w
        mul r13.yzw, r7.wwww, r13.yyzw
        dp3 r7.w, r13.yzwy, r12.xyzx
        dp3 r11.w, r11.xyzx, r13.yzwy
        mad r12.w, |r11.w|, r1.w, -|r11.w|
        mad r11.w, |r11.w|, r12.w, l(1.000000)
        mad r12.w, r8.w, r0.y, r2.y
        ...
        mul r8.w, r8.w, r11.w
        mul r8.w, r10.w, r8.w
        mad r13.yzw, r8.wwww, r17.xxyz, r15.xxyz
        add_sat r7.w, -r7.w, l(1.000000)
        mul r11.w, r7.w, r7.w
        mul r11.w, r11.w, r11.w
        mul r7.w, r7.w, r11.w
        mul r7.w, r7.w, r8.w
        mad r14.xyz, r7.wwww, r17.xyzx, r16.xyzx
        movc r3.yzw, r9.wwww, r18.xxyz, r3.yyzw
        movc r16.xyz, r9.wwww, r14.xyzx, r16.xyzx
        movc r15.xyz, r9.wwww, r13.yzwy, r15.xyzx
        if_nz r2.w
  ...
  case l(2)
  if_nz r2.w
    add r14.yzw, cb1[24].xxyz, cb9[r4.z + 0].xxyz
    mov r14.x, l(2)
    store_structured u2.xyzw, cb2[52].x, l(112), r14.xyzw
  endif 
  add r14.xy, -r5.xyxx, cb9[r4.z + 3].zwzz
  add r14.z, -r5.z, cb9[r4.z + 4].x
  dp3 r7.w, r14.xyzx, r14.xyzx
  rsq r7.w, r7.w
  mul r13.yzw, r7.wwww, r14.xxyz
  dp3 r8.w, r11.xyzx, r13.yzwy
  mov_sat r9.w, r8.w
  lt r10.w, l(0.000000), r9.w
  if_nz r10.w
    ...
    if_nz r11.w
      ...
      lt r5.w, cb9[r4.z + 10].w, l(0.00048828)
      if_nz r5.w
        mad_sat r19.xy, |r18.xyxx|, cb9[r4.z + 12].xyxx, cb9[r4.z + 12].zwzz
        mul r19.zw, r19.xxxy, r19.xxxy
        mad r19.xy, r19.xyxx, l(-2.000000, -2.000000, 0.000000, 0.000000), l(3.000000, 3.000000, 0.000000, 0.000000)
        mul r19.xy, r19.xyxx, r19.zwzz
        mul r5.w, r19.y, r19.x
      else 
        mul_sat r19.xyzw, |r18.yyxx|, cb9[r4.z + 11].xyzw
        log r19.xyzw, r19.xyzw
        mul r19.xyzw, r19.xyzw, cb9[r4.z + 12].zzzz
        exp r19.xyzw, r19.xyzw
        add r19.xy, r19.zwzz, r19.xyxx
        log r19.xy, r19.xyxx
        mul r19.xy, r19.xyxx, cb9[r4.z + 12].wwww
        exp r19.xy, r19.xyxx
        mul r10.w, r19.x, cb9[r4.z + 12].x
        mad r14.w, cb9[r4.z + 12].y, r19.y, l(-1.000000)
        mad r10.w, cb9[r4.z + 12].y, r19.y, -r10.w
      ...
      and r5.w, l(255), cb9[r4.z + 14].w
      if_nz r5.w
        mov r18.z, l(1.000000)
        dp3 r10.w, cb9[r4.z + 13].xyzx, r18.xyzx
        mov r19.x, cb9[r4.z + 13].w
        mov r19.yz, cb9[r4.z + 14].xxyx
    ...
    mov r18.x, cb9[r4.z + 0].w
    mov r18.yz, cb9[r4.z + 1].xxyx
    mul r13.yzw, r13.yyzw, r18.xxyz
    lt r5.w, l(0.000000), r11.w
    if_nz r5.w
      ubfe r5.w, l(3), l(27), cb9[r4.z + 1].w
      if_nz r2.w
      ...
      if_nz r5.w
        ...
        if_nz r12.w
          ...
          mad r18.x, r17.x, cb9[r4.z + 8].y, cb9[r4.z + 8].z
          mad r18.y, r17.y, cb9[r4.z + 8].w, cb9[r4.z + 9].x
          div r5.w, r5.w, r10.w
          ...
          if_nz cb2[58].y
            ...
            loop 
              ige r15.w, r14.w, l(8)
              breakc_nz r15.w
              dp2 r20.x, icb[r14.w + 0].yxyy, r17.xyxx
              dp2 r20.y, icb[r14.w + 0].yxyy, r17.yzyy
              mad r19.xy, r20.xyxx, cb9[r4.z + 3].yyyy, r18.xyxx
      ...
      if_nz r10.w
        mul r10.w, r1.w, cb9[r4.z + 1].z
        mul r10.w, r9.w, r10.w
        ubfe r11.w, l(4), l(16), cb9[r4.z + 1].w
        ult r12.w, l(0), r11.w
        ...
        if_nz r12.w
          ...
          mad r17.xyz, r11.xyzx, r12.wwww, r5.xyzx
          ...
          if_z r15.w
            ...
            mad r17.xy, r17.xyxx, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
            add r18.x, r17.x, cb9[r11.w + 9].w
            add r18.y, r17.y, cb9[r11.w + 10].x
            mul r17.xy, r18.xyxx, cb9[r11.w + 9].yzyy
            div r17.zw, cb9[r11.w + 3].yyyy, cb9[r11.w + 8].yyyw
            add r18.xy, -r17.zwzz, l(1.000000, 1.000000, 0.000000, 0.000000)
            ge r18.xy, r17.xyxx, r18.xyxx
            ge r17.zw, r17.zzzw, r17.xxxy
            or r17.zw, r17.zzzw, r18.xxxy
            ...
            if_z r16.w
              mov_sat r17.xy, r17.xyxx
              mad r18.x, r17.x, cb9[r11.w + 8].y, cb9[r11.w + 8].z
              mad r18.y, r17.y, cb9[r11.w + 8].w, cb9[r11.w + 9].x
              mul r17.x, r14.w, cb9[r11.w + 10].z
          ...
          and r1.z, r1.z, r11.w
          if_nz r1.z
            iadd r1.z, r4.z, cb2[0].x
            imad r1.z, r1.z, l(15), l(-15)
            mad r4.z, |r8.w|, l(-0.200000), l(0.400000)
            mad r17.xyz, r11.xyzx, r4.zzzz, r5.xyzx
            mov r18.xyz, cb9[r1.z + 6].yzwy
            mov r18.w, cb9[r1.z + 7].x
            mov r17.w, l(1.000000)
            dp4 r4.z, r18.xyzw, r17.xyzw
            mov r18.xyz, cb9[r1.z + 7].yzwy
            mov r18.w, cb9[r1.z + 8].x
            ...
            if_z r12.w
              ...
              dp4 r18.y, r19.xyzw, r17.xyzw
              div r17.xy, r18.xyxx, r11.wwww
              mad r17.xy, r17.xyxx, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
              add r18.x, r17.x, cb9[r1.z + 9].w
              add r18.y, r17.y, cb9[r1.z + 10].x
              mul r17.xy, r18.xyxx, cb9[r1.z + 9].yzyy
              div r17.zw, cb9[r1.z + 3].yyyy, cb9[r1.z + 8].yyyw
              add r18.xy, -r17.zwzz, l(1.000000, 1.000000, 0.000000, 0.000000)
              ge r18.xy, r17.xyxx, r18.xyxx
              ge r17.zw, r17.zzzw, r17.xxxy
              or r17.zw, r17.zzzw, r18.xxxy
              or r14.w, r17.w, r17.z
              if_z r14.w
                mov_sat r17.xy, r17.xyxx
                mad r18.x, r17.x, cb9[r1.z + 8].y, cb9[r1.z + 8].z
                mad r18.y, r17.y, cb9[r1.z + 8].w, cb9[r1.z + 9].x
                mul r15.w, r11.w, cb9[r1.z + 10].z
                mad r4.z, cb9[r1.z + 10].y, r11.w, r4.z
                div r4.z, r4.z, r15.w
              endif 
            else 
              mov r14.w, l(-1)
            ...
            if_z r11.w
              ...
              if_nz cb2[58].y
                ...
                loop 
                  ...
                  mad r19.xy, r20.xyxx, cb9[r1.z + 3].yyyy, r18.xyxx
                  sample_c_lz_indexable(texture2darray)(float,float,float,float) r13.x, r19.xyzx, t9.xxxx, s13, r4.z
                  mad r3.x, r13.x, l(0.125000), r3.x
                  iadd r12.w, r12.w, l(1)
                endloop 
              else 
                utof r18.z, r11.w
                sample_c_lz_indexable(texture2darray)(float,float,float,float) r3.x, r18.xyzx, t9.xxxx, s13, r4.z
              endif 
              mul r1.z, r3.x, r3.x
              mul r1.z, r3.x, r1.z
            else 
        ...
        mad r17.xyz, r1.zzzz, r13.yzwy, r3.yzwy
        ...
        mad r11.xyz, r0.yyyy, r13.yzwy, r15.xyzx
        ...
        movc r15.xyz, r2.xxxx, r11.xyzx, r15.xyzx
        if_nz r2.w
...
mad r2.xyz, r15.xyzx, r4.xyzx, r2.xyzx
mad r2.xyz, r3.yzwy, r6.xyzx, r2.xyzx
