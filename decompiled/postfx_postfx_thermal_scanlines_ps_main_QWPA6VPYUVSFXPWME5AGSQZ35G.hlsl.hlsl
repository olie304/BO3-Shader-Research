  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.x = rcp(r0.x);
  r0.x = cmp(postFxControl0.y < r0.x);
  ...
  r2.xyzw = colorMapSampler.Sample(samp0_s, v1.xy).xyzw;
  r1.xyzw = -r2.xyzw + r1.xyzw;
  r1.xyzw = postFxControl0.xxxx * r1.xyzw + r2.xyzw;
  r1.xyzw = float4(3.05175781e-05,3.05175781e-05,3.05175781e-05,1) * r1.xyzw;
  r0.xyzw = r1.xyzw * r1.xyzw + r0.xyzw;
  r1.x = 800 * v1.y;
  r1.x = sin(r1.x);
  r1.x = r1.x * 0.300000012 + 0.699999988;
  r0.y = r1.x * r0.y;
  o0.w = r0.w;
  o0.xyz = float3(0,32768,0) * r0.xyz;
  return;
}