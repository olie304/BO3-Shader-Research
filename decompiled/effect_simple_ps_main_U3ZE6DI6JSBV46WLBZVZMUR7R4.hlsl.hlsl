// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:25:10 2021
...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r3.y = rcp(r3.y);
  r3.z = -eyeOffset.z + useOldHDRScale;
  r3.z = useOldHDRScale * r3.z;
  r4.x = useOldHDRScale * v5.z;
  r4.y = cmp(r3.z < r4.x);
  r3.z = r3.y * r3.z;
  r3.z = r3.z / r4.x;
  r4.x = cmp(v6.y != 1.000000);
  r5.xyz = r2.xyz / r3.www;
  r3.w = v1.w + r2.w;
  r6.y = saturate(r3.w * v6.y + -v6.y);
  r6.xzw = r6.yyy * r5.xyz;
  r2.xyzw = r4.xxxx ? r6.xzwy : r2.xyzw;
  r6.x = 1;
  r4.xz = r4.xx ? r6.xy : v1.ww;
  r3.w = cmp(r3.y < r1.w);
  r1.w = -r3.y + r1.w;
  ...
  r2.xyzw = r2.xyzw * r4.xxxx;
  r2.xyzw = r2.xyzw * r1.zzzz;
  r2.xyz = r4.yyy ? r2.xyz : 0;
  r3.x = r2.w;
  r1.zw = r4.yy ? r3.xy : 0;
  ...
  r1.xyw = v3.xyz * r1.zzz;
  r3.xyz = v11.xyz * r1.zzz;
  r0.xyz = r2.xyz * r0.xyz + -r1.xyw;
  r0.xyz = v3.www * r0.xyz + r1.xyw;
  ...
  if (r1.x == 0) {
    r3.xy = (uint2)v0.xy;
    bitmask.x = ((~(-1 << 1)) << 16) & 0xffffffff;  r1.x = (((uint)zFeatherComputeSprites << 16) & bitmask.x) | ((uint)0 & ~bitmask.x);
    r1.x = (int)r1.x + 1;
    // Needs manual fix for instruction:
    imm_atomic_iadd r4.x, u6, r3.xyxx, r1.x
    InterlockedAdd(dest, imm_value, orig_value);
    r3.zw = (int2)r4.xx & int2(65535,65535);
    r1.x = cmp((uint)r3.w < oitMaxEntries);
    if (r1.x != 0) {
      r1.x = max(r2.y, r2.z);
      r1.x = max(r2.x, r1.x);
      r1.x = (int)r1.x & 0x7f800000;
      r1.x = (int)r1.x + 0x00800000;
      r2.xyz = r2.xyz + r1.xxx;
      if (8 == 0) r1.y = 0; else if (8+15 < 32) {       r1.y = (uint)r2.x << (32-(8 + 15)); r1.y = (uint)r1.y >> (32-8);      } else r1.y = (uint)r2.x >> 15;
      r2.xy = (uint2)r2.yz >> int2(15,15);
      bitmask.x = ((~(-1 << 8)) << 8) & 0xffffffff;  r2.x = (((uint)r2.x << 8) & bitmask.x) | ((uint)0 & ~bitmask.x);
      bitmask.y = ((~(-1 << 8)) << 16) & 0xffffffff;  r2.y = (((uint)r2.y << 16) & bitmask.y) | ((uint)0 & ~bitmask.y);
      r1.y = (int)r1.y + (int)r2.x;
      r1.y = (int)r2.y + (int)r1.y;
      r1.x = (uint)r1.x << 1;
      r4.xzw = (int3)r1.xxx + (int3)r1.yyy;
      r1.z = saturate(r1.z);
      r1.x = 2046 * r1.z;
      r1.x = (uint)r1.x;
      r1.y = (uint)v0.z << 2;
      ...
      bitmask.y = ((~(-1 << 1)) << 0) & 0xffffffff;  r4.y = (((uint)zFeatherComputeSprites << 0) & bitmask.y) | ((uint)r1.x & ~bitmask.y);
    // No code for instruction (needs manual fix):
        store_uav_typed u7.xyzw, r3.xyzw, r4.xyzw
      r1.x = -1;
    } else {
      r1.x = 0;
    }
