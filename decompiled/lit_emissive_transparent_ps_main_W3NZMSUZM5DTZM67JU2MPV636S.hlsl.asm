...
//   uint ui3dWindow;                   // Offset:  184 Size:     4
...
//   float4 ui3dUVSetup0;               // Offset: 1184 Size:    16
//   float4 ui3dUVSetup1;               // Offset: 1200 Size:    16
//   float4 ui3dUVSetup2;               // Offset: 1216 Size:    16
//   float4 ui3dUVSetup3;               // Offset: 1232 Size:    16
//   float4 ui3dUVSetup4;               // Offset: 1248 Size:    16
//   float4 ui3dUVSetup5;               // Offset: 1264 Size:    16
...
rsq r1.x, r1.x
mul r7.xyz, r1.xxxx, -v6.xyzx
dp3_sat r2.w, r7.xyzx, r3.xyzx
switch cb0[11].z
  case l(0)
  mov r3.xyzw, cb1[74].xyzw
  break 
  case l(1)
  mov r3.xyzw, cb1[75].xyzw
  break 
  case l(2)
  mov r3.xyzw, cb1[76].xyzw
  break 
  case l(3)
  mov r3.xyzw, cb1[77].xyzw
  break 
  case l(4)
  mov r3.xyzw, cb1[78].xyzw
  break 
  case l(5)
  mov r3.xyzw, cb1[79].xyzw
  break 
  default 
  break 
endswitch 
...
mad r3.xy, v1.yzyy, r3.xyxx, r3.zwzz
movc r3.xy, r5.zzzz, r3.xyxx, v1.yzyy
sample_indexable(texture2d)(float,float,float,float) r3.xyzw, r3.xyxx, t24.xyzw, s1
mul r3.xyz, r3.xyzx, cb0[13].xyzx
and r3.xyzw, r3.xyzw, r5.zzzz
log r5.z, r2.w
mul r5.z, r5.z, cb0[12].y
exp r5.z, r5.z
add r2.w, -r2.w, l(1.000000)
log r2.w, r2.w
mul r2.w, r2.w, cb0[12].y
exp r2.w, r2.w
movc r2.w, cb0[14].x, r2.w, r5.z
eq r5.z, cb0[12].y, l(0.000000)
...
dp3_sat r6.x, r4.xyzx, r7.xyzx
dp3 r2.w, -r7.xyzx, r4.xyzx
add r2.w, r2.w, r2.w
mad r12.xyz, r4.xyzx, -r2.wwww, -r7.xyzx
...
if_nz r6.z
  ...
  if_nz r6.z
      ...
      if_z r8.w
        ...
        if_nz cb2[58].y
          ...
          loop 
            ...
            mad r18.xy, r19.xyxx, r8.zzzz, r16.xyxx
    ...
    dp3 r1.x, r11.yzwy, r7.xyzx
    dp3 r7.w, r4.xyzx, r11.yzwy
    mad r8.z, |r7.w|, r2.w, -|r7.w|
          ...
          if_nz r26.w
            ...
            if_nz r26.w
              ...
              if_nz r26.w
                ...
                mad r38.xyz, r38.xyzx, r12.wwww, r7.xyzx
                dp3 r12.w, r38.xyzx, r38.xyzx
                rsq r12.w, r12.w
                mul r38.xyz, r12.wwww, r38.xyzx
                dp3 r12.w, r38.xyzx, r7.xyzx
          ...
          if_nz r15.w
            ...
            if_nz r15.w
              ...
              if_nz r15.w
                ...
                mad r20.xyz, r20.xyzx, r12.wwww, r7.xyzx
                dp3 r12.w, r20.xyzx, r20.xyzx
                rsq r12.w, r12.w
                mul r20.xyz, r12.wwww, r20.xyzx
                dp3 r12.w, r20.xyzx, r7.xyzx
...
if_z r0.w
  ...
  if_nz r0.w
    ...
    bfi r2.y, l(1), l(0), cb0[11].w, r0.w
...
ret 
// Approximately 2997 instruction slots used
