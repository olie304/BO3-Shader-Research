...
r0.z = samp0[]..swiz;
  ...
  r3.xzw = r21.xyz * r2.www;
  r9.yzw = r22.xyz * r2.www;
  ...
  r1.w = r2.w * r1.w;
  r2.y = r2.y * r2.w;
  r2.w = dot(r7.xyz, sunConstants.wldDir.xyz);
  r5.z = saturate(r2.w);
  r5.w = cmp(0 >= r5.z);
  if (r5.w != 0) {
    r6.w = 0;
    ...
    if (r10.w == 0) {
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          r15.w = r13.w ? sunConstants.splitPinTransform[r7.w].w : sunConstants.splitPinTransform[r10.w].w;
  ...
  if (r5.w != 0) {
    ...
    if (r5.w != 0) {
      ...
      r15.w = r17.z;
      r3.w = r14.z;
      r3.xyzw = r2.wwww ? r15.xyzw : r3.xyzw;
      r17.zw = r16.xy;
      r14.zw = r9.yz;
            ...
            if (r16.w != 0) {
              ...
              if (r16.w != 0) {
                ...
                if (r16.w != 0) {
                  ...
                  r39.xyz = r39.xyz * r8.www + r10.xyz;
                  r8.w = dot(r39.xyz, r39.xyz);
                  r8.w = rsqrt(r8.w);
                  r39.xyz = r39.xyz * r8.www;
                  r8.w = dot(r39.xyz, r10.xyz);
                  r14.w = dot(r7.xyz, r39.xyz);
                  r16.z = abs(r14.w) * r0.y + -abs(r14.w);
                  r14.w = abs(r14.w) * r16.z + 1;
                  r16.z = r10.w * r1.w + r2.y;
                  r14.w = r14.w * r14.w;
                  r14.w = r14.w * r16.z;
                  r14.w = rcp(r14.w);
                  r10.w = r10.w * r16.w;
                  ...
                  r8.w = r13.w * r8.w;
                  r8.w = r10.w * r8.w;
                  r40.xyz = r8.www * r33.xyz + r30.xyz;
            ...
            r40.w = samp0[]..swiz;
              ...
              if (r13.w != 0) {
                  ...
                  r40.y = samp0[]..swiz;
                    ...
                    if (r5.w != 0) {
                      ...
                      while (true) {
                        ...
                        r19.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r32.xyz, r7.w).x;
                ...
                if (r13.w != 0) {
                  ...
                  r20.xyz = r20.xyz * r8.www + r10.xyz;
                  r8.w = dot(r20.xyz, r20.xyz);
                  r8.w = rsqrt(r8.w);
                  r20.xyz = r20.xyz * r8.www;
                  r8.w = dot(r20.xyz, r10.xyz);
                  ...
                  r7.w = r12.w * r7.w;
                  r7.w = 0.25 * r7.w;
                  r20.xyz = r7.www * r21.xyw + r31.xyz;
                  r8.w = saturate(1 + -r8.w);
                  r12.w = r8.w * r8.w;
                  r12.w = r12.w * r12.w;
                  r8.w = r12.w * r8.w;
                  r7.w = r8.w * r7.w;
                  r21.xyw = r7.www * r21.xyw + r30.xyz;
