// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:34:10 2021
...
r0.y = samp0[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) r0.xzw, r0.x, l(32), t0.yxxz
r0.x = samp0[]..swiz;
r0.z = samp0[]..swiz;
r0.w = samp0[]..swiz;
  ...
  r9.xy = (int2)r0.yy & int2(268435456,536870912);
  if (r9.x != 0) {
  ...
  r0.y = 1 + -r14.x;
  r1.xyz = r1.xyz * r0.yyy + r9.xzw;
  r1.w = r1.w * r0.y + r14.x;
  r2.yzw = r2.yzw * r0.yyy + r15.xyz;
  r3.y = dot(r2.yzw, r2.yzw);
  r3.y = rsqrt(r3.y);
  r7.xyz = r3.yyy * r2.yzw;
  r2.y = r2.x * r0.y + r14.y;
  r8.xyz = r0.yyy * float3(0.0399999991,0.0399999991,0.0399999991) + r16.xyz;
  r0.x = saturate(r0.x);
  r0.x = hdrScale * r0.x;
  r9.xyz = cmp(r0.www == float3(3,2,1));
  r0.w = cmp(r0.w < 0);
  r10.xyz = r0.www ? float3(1,1,1) : emissiveTint1.xyz;
  r10.xyz = r9.zzz ? tint1.xyz : r10.xyz;
  r9.yzw = r9.yyy ? tint2.xyz : r10.xyz;
  r9.xyz = r9.xxx ? tint3.xyz : r9.yzw;
  r0.w = dot(-v6.xyz, -v6.xyz);
  r0.w = rsqrt(r0.w);
  r10.xyz = -v6.xyz * r0.www;
  r2.z = dot(r10.xyz, r4.xyz);
  ...
  r2.zw = (uint2)r3.wz;
  r0.y = dot(r2.wz, float2(0.0671105608,0.00583714992));
  r0.y = frac(r0.y);
  r0.y = 52.9829178 * r0.y;
  r0.y = frac(r0.y);
  r0.y = r0.y * 6.28318548 + gameTick.w;
  sincos(r0.y, r5.x, r6.x);
  r0.y = dot(r2.zw, float2(0.0671105608,0.00583714992));
  r0.y = frac(r0.y);
  r0.y = 52.9829178 * r0.y;
  r0.y = frac(r0.y);
  r0.y = r0.y * 6.28318548 + gameTick.w;
  ...
  r5.z = 100 * r5.z;
  r9.yz = -r2.ww * float2(10,5) + float2(6.85740995,7.08500004);
  r5.w = exp2(r9.y);
  r5.w = r5.w * r2.x;
  r5.w = 9.1368103 * r5.w;
  r6.w = r3.y * r2.w;
  ...
  r13.z = (uint)r3.x << 4;
  r3.x = (int)r6.w & -32;
  r3.z = (int)-r3.x + (int)r6.w;
  r3.w = numRefProbes & -32;
  r8.w = (int)-r3.w + numRefProbes;
  r14.xy = float2(0,0);
  r15.w = 0;
  r16.yz = float2(0,1);
  r17.xy = float2(0,0);
  ...
  while (true) {
    ...
    bitmask.w = ((~(-1 << r3.z)) << 0) & 0xffffffff;  r10.w = (((uint)0 << 0) & bitmask.w) | ((uint)r9.z & ~bitmask.w);
    r9.z = r9.w ? r10.w : r9.z;
    r9.w = cmp((int)r3.w == (int)r9.y);
    if (r8.w == 0) r10.w = 0; else if (r8.w+0 < 32) {     r10.w = (uint)r9.z << (32-(r8.w + 0)); r10.w = (uint)r10.w >> (32-r8.w);    } else r10.w = (uint)r9.z >> 0;
    r9.z = r9.w ? r10.w : r9.z;
  ...
  if (r3.w != 0) {
    ...
    r8.w = 0;
    while (true) {
      r10.w = cmp((uint)r8.w >= (uint)r6.w);
      if (r10.w != 0) break;
      r14.z = (uint)r8.w >> 5;
      r15.xyz = (int3)r13.xyz + (int3)r14.xyz;
      r10.w = visibleProbes.Load(r15.xyzw).x;
      r11.y = cmp((int)r3.x == (int)r8.w);
      if (r3.z == 0) r11.z = 0; else if (r3.z+0 < 32) {       r11.z = (uint)r10.w << (32-(r3.z + 0)); r11.z = (uint)r11.z >> (32-r3.z);      } else r11.z = (uint)r10.w >> 0;
  ...
  r3.xzw = r22.xyz * r2.www;
  r5.z = cmp(r22.w < 0.99000001);
  if (r5.z != 0) {
    r5.z = 1 + -r22.w;
    r5.w = sunConstants.globalProbeExposure * r5.z;
    r9.yzw = -globalProbeConstants.data[0].xyz + v6.xyz;
    r15.x = globalProbeConstants.data[0].w * r9.y;
    r15.yz = globalProbeConstants.data[1].xy * r9.zw;
    r9.yzw = saturate(float3(0.5,0.5,0.5) + r15.xyz);
    r15.xy = globalProbeConstants.data[1].zw * r9.yz;
    r15.z = globalProbeConstants.data[2].x * r9.w;
    r9.yzw = globalProbeConstants.data[2].yzw + r15.xyz;
    r11.yzw = cmp(float3(0,0,0) < r7.xyz);
    r15.xyz = r11.yzw ? float3(0,0,0) : float3(0.5,0.5,0.5);
    r15.w = 0;
    r11.yzw = r15.wwx + r9.yzw;
    r11.yzw = gProbeXArray.SampleLevel(samplerLinearClamp_s, r11.yzw, 0).xyz;
    r16.xyz = r7.xyz * r7.xyz;
    r16.xyz = r16.xyz * r5.www;
    r17.xyz = r15.wwy + r9.yzw;
    ...
    r9.yzw = r15.wwz + r9.yzw;
    r9.yzw = gProbeZArray.SampleLevel(samplerLinearClamp_s, r9.yzw, 0).xyz;
    r9.yzw = r9.yzw * r16.zzz + r11.yzw;
    r7.w = 0;
    r11.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r7.xyzw, 6).xyz;
    r9.yzw = r11.yzw * r9.yzw;
    r5.w = dot(r9.yzw, float3(0.212599993,0.715200007,0.0722000003));
    r14.xyz = r21.xyz * r2.www + r9.yzw;
    r12.w = 0;
    r9.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r12.xyzw, r3.y).xyz;
    r2.w = sunConstants.globalProbeExposure * r5.z + -r5.w;
    r2.w = r2.y * r2.w + r5.w;
    r3.xzw = r9.yzw * r2.www + r3.xzw;
  }
  ...
  r3.w = r2.x * r2.y + r2.w;
  r2.yw = r3.ww * r2.yw;
  r3.w = dot(r7.xyz, sunConstants.wldDir.xyz);
  r5.z = saturate(r3.w);
  r5.w = cmp(0 >= r5.z);
  if (r5.w != 0) {
    r6.w = 0;
  ...
  if (r5.w == 0) {
    ...
    if (r7.w != 0) {
      ...
      while (true) {
        ...
        if (r10.w != 0) break;
        r10.w = (uint)r7.w;
        r11.yz = -sunConstants.splitPinTransform[r10.w].xy + r9.yz;
        r11.y = max(abs(r11.y), abs(r11.z));
        r8.w = sunConstants.splitPinTransform[r10.w].z * r11.y;
        r10.w = cmp(r8.w < 1);
        if (r10.w != 0) {
          break;
        }
    ...
    r13.w = samp0[]..swiz;
      ...
      r18.w = samp0[]..swiz;
        ...
        r11.z = samp0[]..swiz;
          ...
          r11.z = r9.y * r11.w + r11.z;
          r11.y = r9.z * r11.y + r11.z;
    ...
    if (r10.w == 0) {
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          r17.xy = r12.ww ? r9.yz : r11.yz;
          r13.w = r12.w ? sunConstants.splitPinTransform[r7.w].w : sunConstants.splitPinTransform[r9.w].w;
  ...
  if (r5.w != 0) {
    ...
    if (r5.w != 0) {
        ...
        r17.y = samp0[]..swiz;
          ...
          if (enableDitheredShadow != 0) {
            ...
            while (true) {
              ...
              r11.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r18.xyz, r7.w).x;
              r11.y = r11.w * 0.125 + r11.y;
              r11.z = (int)r11.z + 1;
            }
          } else {
            r16.z = (uint)r10.w;
            r11.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r7.w).x;
          }
          r7.w = r11.y * r11.y;
          r7.w = r7.w * r11.y;
        } else {
      ...
      r7.w = r7.w * r6.w;
      r3.w = cmp(0 < r3.w);
      r16.xyz = r7.www * r9.yzw + r14.xyz;
      r11.yzw = -v6.xyz * r0.www + sunConstants.wldDir.xyz;
      r0.w = dot(r11.yzw, r11.yzw);
      r0.w = rsqrt(r0.w);
      r11.yzw = r11.yzw * r0.www;
      r0.w = dot(r11.yzw, r10.xyz);
      ...
      r5.z = r6.w * r5.z;
      r5.z = 0.25 * r5.z;
      r11.yzw = r5.zzz * r9.yzw + r3.xyz;
      r0.w = saturate(1 + -r0.w);
      r5.w = r0.w * r0.w;
      r5.w = r5.w * r5.w;
      r0.w = r5.w * r0.w;
      r0.w = r5.z * r0.w;
      r17.xyz = r0.www * r9.zwy + r15.xyz;
      r16.w = r17.z;
      r14.w = r15.z;
        ...
        r38.w = samp0[]..swiz;
          ...
          switch (r10.w) {
            ...
            if (r17.w != 0) {
              ...
              r14.w = r22.w / r14.w;
              r14.w = min(1, r14.w);
              r42.xy = saturate(r17.ww * r34.xz + r34.yw);
              ...
              r17.w = cmp(0 < r14.w);
              if (r17.w != 0) {
                if (3 == 0) r17.w = 0; else if (3+27 < 32) {                 r17.w = (uint)r33.w << (32-(3 + 27)); r17.w = (uint)r17.w >> (32-3);                } else r17.w = (uint)r33.w >> 27;
                r17.w = cmp((int)r17.w != 1);
                if (r17.w != 0) {
                  r17.w = abs(r15.w) * -0.200000003 + 0.400000006;
                  r42.xyz = r7.xyz * r17.www + v6.xyz;
                  r42.xyz = r42.xyz + -r36.xyz;
                  r17.w = max(abs(r42.y), abs(r42.z));
                  r17.w = max(abs(r42.x), r17.w);
                  r17.w = r37.x / r17.w;
                  r17.w = r17.w + r37.y;
                  r22.w = dot(r42.xyz, r42.xyz);
                  r22.w = rsqrt(r22.w);
                  ...
                  while (true) {
                    ...
                    if (r28.w != 0) break;
                    r44.y = dot(icb[r27.w+0].yx, r16.xy);
                    r44.z = dot(icb[r27.w+0].yx, r16.yz);
                    r44.yz = r44.yz * r35.yy;
                    r44.x = r44.y * r11.x;
                    r44.w = r44.y * r9.x;
                    r43.xyz = r42.xyz * r22.www + r44.xzw;
                    r28.w = gOmniShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r43.xyzw, r17.w).x;
                ...
                if (r17.w != 0) {
                  r17.w = r33.x * r0.y;
                  r17.w = 0.25 * r17.w;
                  r22.w = dot(r39.xyz, r12.xyz);
                  r27.w = dot(r12.xyz, r41.xyz);
                  r28.w = -r22.w * r22.w + r38.x;
                  ...
                  r42.w = samp0[]..swiz;
                    ...
                    r20.xyz = r7.xyz * r22.www + v6.xyz;
                    r22.w = dot(r41.xyzw, r20.xyzw);
                    r27.w = dot(r42.xyzw, r20.xyzw);
                    ...
                    r12.w = samp0[]..swiz;
                      ...
                      if (r6.w != 0) {
                        ...
                        while (true) {
                          ...
                          r43.y = dot(icb[r20.z+0].xy, r5.xy);
                          r42.xy = r43.xy * r13.ww + r41.xy;
                          r22.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r42.xyz, r20.x).x;
                      ...
                      r12.w = samp0[]..swiz;
                        ...
                        if (r6.w != 0) {
                          ...
                          while (true) {
                            ...
                            if (r27.w != 0) break;
                            r42.x = dot(icb[r22.w+0].xy, r6.xy);
                            r42.y = dot(icb[r22.w+0].yx, r6.xz);
                            r21.xy = r42.xy * r13.ww + r41.xy;
                  ...
                  r12.w = r12.w + -r17.z;
                  r12.w = r2.z * r12.w + r17.z;
                  r12.w = r12.w * r14.w;
                  r33.x = r32.x;
                  r13.w = cmp(0 < r15.w);
                  r21.xyz = r12.www * r33.xyz + r11.yzw;
                  r12.w = saturate(dot(r7.xyz, r40.xyz));
                  r39.xyz = r39.xyz * r10.www + r10.xyz;
                  r10.w = dot(r39.xyz, r39.xyz);
                  r10.w = rsqrt(r10.w);
                  r39.xyz = r39.xyz * r10.www;
                  r10.w = dot(r39.xyz, r10.xyz);
                  r15.w = dot(r7.xyz, r39.xyz);
                  r17.z = abs(r15.w) * r0.y + -abs(r15.w);
                  r15.w = abs(r15.w) * r17.z + 1;
                  r17.z = r12.w * r2.y + r2.w;
                  r15.w = r15.w * r15.w;
                  r15.w = r15.w * r17.z;
                  r15.w = rcp(r15.w);
                  r12.w = r12.w * r17.w;
                  ...
                  r11.yzw = r13.www ? r21.xyz : r11.yzw;
                  r18.xyz = r13.www ? r40.xyz : r18.xyz;
            ...
            r40.w = samp0[]..swiz;
              ...
              r45.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r17.z, r8.w, l(236), t12.xxxx
              r17.z = samp0[]..swiz;
                r46.xyz = -v6.xyz + r32.yzw;
                r17.w = r35.x * r35.x;
                r20.x = dot(r46.xyz, r46.xyz);
                r17.w = r17.w / r20.x;
                r17.w = min(1, r17.w);
                ...
                r34.y = samp0[]..swiz;
                r34.z = samp0[]..swiz;
                  r17.z = dot(r45.yzw, r22.xyz);
                  r17.w = dot(r34.xyz, r22.xyz);
                  r34.xy = frac(r17.zw);
                  r14.w = (int)r14.w + -1;
                  r34.z = (uint)r14.w;
              ...
              if (r14.w != 0) {
                ...
                if (r14.w != 0) {
                  ...
                  r23.xyz = r7.xyz * r14.www + v6.xyz;
                  r39.xyz = r38.xyz;
                  r14.w = dot(r39.xyzw, r23.xyzw);
                  r17.z = dot(r41.xyzw, r23.xyzw);
                  r17.w = cmp(r17.z >= r14.w);
                  if (r17.w != 0) {
                  // Known bad code for instruction (needs manual fix):
                  ...
                  r40.y = samp0[]..swiz;
                    ...
                    if (r6.w != 0) {
                      ...
                      while (true) {
                        ...
                        if (r20.x != 0) break;
                        r34.x = dot(icb[r17.w+0].xy, r26.xy);
                        r34.y = dot(icb[r17.w+0].yx, r26.xz);
                        r32.xy = r34.xy * r35.yy + r23.xy;
                        r20.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r32.xyz, r8.w).x;
                        r17.z = r20.x * 0.125 + r17.z;
                        r17.w = (int)r17.w + 1;
                      }
                    } else {
                      r23.z = (uint)r14.w;
                      r17.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r23.xyz, r8.w).x;
                    }
                    r8.w = r17.z * r17.z;
                    r8.w = r8.w * r17.z;
                  } else {
                ...
                if (r14.w != 0) {
                  ...
                  r17.w = cmp(0 < (uint)r15.w);
                  r17.w = r0.x ? r17.w : 0;
                  if (r17.w != 0) {
                    r15.w = (int)r15.w + numLights;
                    r15.w = (int)r15.w + -1;
                  // Known bad code for instruction (needs manual fix):
                                    ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r17.w, r15.w, l(52), t12.xxxx
                  r17.w = samp0[]..swiz;
                  // Known bad code for instruction (needs manual fix):
                  ...
                  r38.w = samp0[]..swiz;
                    ...
                    r24.xyz = r7.xyz * r20.xxx + v6.xyz;
                    r23.x = dot(r32.xyzw, r24.xyzw);
                    r23.y = dot(r34.xyzw, r24.xyzw);
                    r20.x = dot(r35.xyzw, r24.xyzw);
                    ...
                    r37.w = samp0[]..swiz;
                      r20.x = abs(r12.w) * -0.200000003 + 0.400000006;
                      r25.xyz = r7.xyz * r20.xxx + v6.xyz;
                      r23.x = dot(r32.xyzw, r25.xyzw);
                      r23.y = dot(r33.xyzw, r25.xyzw);
                      r20.x = dot(r34.xyzw, r25.xyzw);
                      ...
                      r25.y = samp0[]..swiz;
                        ...
                        if (r6.w != 0) {
                          ...
                          r32.z = (uint)r20.x;
                          r24.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r32.xyz, r15.w).x;
                        }
                        r15.w = r24.y * r24.y;
                        r15.w = r15.w * r24.y;
                      } else {
                  ...
                  r15.w = r15.w * r8.w;
                  r12.w = cmp(0 < r12.w);
                  r23.xyz = r15.www * r22.xyw + r11.yzw;
                  r21.xyz = r21.xyz * r10.www + r10.xyz;
                  r10.w = dot(r21.xyz, r21.xyz);
                  r10.w = rsqrt(r10.w);
                  r21.xyz = r21.xyz * r10.www;
                  r10.w = dot(r21.xyz, r10.xyz);
                  r15.w = dot(r7.xyz, r21.xyz);
                  r17.w = abs(r15.w) * r0.y + -abs(r15.w);
                  r15.w = abs(r15.w) * r17.w + 1;
                  ...
                  r8.w = r13.w * r8.w;
                  r8.w = 0.25 * r8.w;
                  r21.xyz = r8.www * r22.xyw + r31.xyz;
                  r10.w = saturate(1 + -r10.w);
                  r13.w = r10.w * r10.w;
                  r13.w = r13.w * r13.w;
                  r10.w = r13.w * r10.w;
                  r8.w = r10.w * r8.w;
                  r22.xyw = r8.www * r22.xyw + r18.xyz;
                  r11.yzw = r12.www ? r23.xyz : r11.yzw;
                  r18.xyz = r12.www ? r22.xyw : r18.xyz;
                  r31.xyz = r12.www ? r21.xyz : r31.xyz;
                }
              }
            }
            break;
