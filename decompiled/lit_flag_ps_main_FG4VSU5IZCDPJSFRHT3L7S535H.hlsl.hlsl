...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  r4.xyz = flagRippleDetailMap.Sample(normalSampler_s, r3.xy).xyz;
  r1.zw = r4.xy * float2(1.9921875,1.9921875) + float2(-1,-1);
  r2.w = r4.z * r4.z;
  r2.w = 0.333333343 * r2.w;
  r2.w = min(1, r2.w);
  ...
  r3.z = min(1, r3.z);
  r2.xy = r1.zw * flagRippleHeight + r2.xy;
  r1.z = dot(r2.xyz, r2.xyz);
  r1.z = rsqrt(r1.z);
  r2.xyz = r2.xyz * r1.zzz;
  r1.y = r2.w * flagRippleHeight + r1.y;
  r2.xy = r3.xy * flagRippleHeight + r2.xy;
  r1.z = dot(r2.xyz, r2.xyz);
  r1.z = rsqrt(r1.z);
  r2.xyz = r2.xyz * r1.zzz;
  r1.y = r3.z * flagRippleHeight + r1.y;
  r1.z = v7.x ? 1 : -1;
  ...
  while (true) {
    ...
    bitmask.w = ((~(-1 << r1.w)) << 0) & 0xffffffff;  r9.w = (((uint)0 << 0) & bitmask.w) | ((uint)r9.y & ~bitmask.w);
    r9.y = r9.z ? r9.w : r9.y;
    r9.z = cmp((int)r3.w == (int)r8.w);
  ...
  if (r3.w != 0) {
    ...
    while (true) {
      ...
      r11.w = cmp((int)r1.z == (int)r8.z);
      if (r1.w == 0) r12.z = 0; else if (r1.w+0 < 32) {       r12.z = (uint)r8.w << (32-(r1.w + 0)); r12.z = (uint)r12.z >> (32-r1.w);      } else r12.z = (uint)r8.w >> 0;
