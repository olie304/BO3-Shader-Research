...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  r1.y = rsqrt(r1.y);
  r11.xyz = -v7.xyz * r1.yyy;
  r1.w = dot(r11.xyz, r3.xyz);
  r3.x = dot(r11.xyz, r4.xyz);
  r3.y = dot(r11.xyz, r5.xyz);
  r3.z = cmp(0 < r1.w);
  r3.xy = -r3.xy / r1.ww;
  r3.xy = r3.zz ? r3.xy : 0;
  r3.z = 9.99999975e-06 + relativeHDR;
  r3.xy = r3.xy * r3.zz + v2.xy;
  ...
  r7.x = saturate(dot(r2.xyz, r11.xyz));
  r1.w = dot(-r11.xyz, r2.xyz);
  r1.w = r1.w + r1.w;
  r13.xyz = r2.xyz * -r1.www + -r11.xyz;
  r1.w = 17 * r7.y;
  r1.w = exp2(r1.w);
  r1.w = 2 + r1.w;
  r1.w = 2 / r1.w;
  ...
  if (r5.z == 0) {
    ...
    if (r10.w == 0) {
      if (enableDitheredShadow == 0) {
        ...
        r16.z = r10.w + r6.w;
        r10.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r5.z).x;
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          r16.w = r13.w ? sunConstants.splitPinTransform[r6.w].w : sunConstants.splitPinTransform[r10.w].w;
          r13.w = r13.w ? r6.w : r10.w;
  ...
  if (r5.z != 0) {
    ...
    if (r5.z != 0) {
      ...
      if (sunConstants.sunCookieIndex != 0) {
        r9.w = 1;
        r6.w = dot(sunConstants.sunCookieTransform[0].xyzw, r9.xyzw);
        ...
        r17.y = samp0[]..swiz;
          ...
          if (enableDitheredShadow != 0) {
            ...
            while (true) {
              ...
              r12.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r18.xyz, r6.w).x;
      ...
      r9.zw = r12.yz;
      r14.zw = r7.yz;
      r9.xyzw = r4.zzzz ? r9.xyzw : r14.xyzw;
      r7.w = r4.z ? r12.w : r7.w;
      r14.z = r15.w;
      r14.xy = r9.xy;
      r7.yz = r9.zw;
    }
  ...
  while (true) {
    ...
    while (true) {
      ...
      r10.w = 1 << (int)r8.w;
      r11.w = (int)r7.x & (int)r10.w;
      if (r11.w != 0) {
        r7.x = (int)r7.x ^ (int)r10.w;
            ...
            if (r16.w != 0) {
              ...
              if (r16.w != 0) {
                ...
                if (r16.w != 0) {
                  ...
                  r39.xyz = r39.xyz * r10.www + r11.xyz;
                  r10.w = dot(r39.xyz, r39.xyz);
                  r10.w = rsqrt(r10.w);
                  r39.xyz = r39.xyz * r10.www;
                  r10.w = dot(r39.xyz, r11.xyz);
            ...
            r40.w = samp0[]..swiz;
              ...
              if (r14.w != 0) {
                ...
                if (r14.w != 0) {
                  ...
                  r20.xyz = r20.xyz * r10.www + r11.xyz;
                  r10.w = dot(r20.xyz, r20.xyz);
                  r10.w = rsqrt(r10.w);
                  r20.xyz = r20.xyz * r10.www;
                  r10.w = dot(r20.xyz, r11.xyz);
