...
if_nz r2.w
  ...
  mad r2.w, r2.w, r4.x, cb0[23].z
  div r1.xy, r1.xyxx, r2.wwww
  add r1.xy, r1.xyxx, l(0.500000, 0.500000, 0.000000, 0.000000)
  mov_sat r4.xy, r1.xyxx
  movc r11.x, cb0[24].w, r4.x, r1.x
  movc r11.y, cb0[25].x, r4.y, r1.y
endif 
...
ret 
// Approximately 2766 instruction slots used
