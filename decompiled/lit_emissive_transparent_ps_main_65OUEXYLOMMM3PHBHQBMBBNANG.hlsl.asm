      ...
      if_nz r15.w
        ...
        if_nz r13.w
          ...
          if_nz r13.w
            ...
            mov r23.w, r25.x
            dp4 r23.x, r7.xyzw, r23.xyzw
            mov r26.x, r20.y
            mov r26.y, r21.y
            mov r26.z, r22.y
            mov r26.w, r25.y
            dp4 r23.y, r7.xyzw, r26.xyzw
            mov r25.x, r20.z
            mov r25.y, r21.z
            mov r25.z, r22.z
            dp4 r23.z, r7.xyzw, r25.xyzw
            ...
            if_nz r13.w
              ...
              dp3 r27.x, r4.xyzx, r26.xyzx
              dp3 r27.y, r4.xyzx, r25.xyzx
              dp3 r28.x, r5.xyzx, r26.xyzx
              dp3 r28.y, r5.xyzx, r25.xyzx
...
mov_sat r11.x, r11.x
add r2.y, -r11.x, l(1.000000)
mad r0.xyz, r0.xyzx, r2.yyyy, r6.xzwx
mad r0.w, r0.w, r2.y, r11.x
mad r1.yzw, r1.yyzw, r2.yyyy, r12.xxyz
dp3 r3.w, r1.yzwy, r1.yzwy
rsq r3.w, r3.w
mul r4.xyz, r1.yzwy, r3.wwww
mad r1.y, r1.x, r2.y, r11.y
mad r5.xyz, r2.yyyy, l(0.040000, 0.040000, 0.040000, 0.000000), r13.xyzx
...
if_nz r1.z
  ...
  round_z r1.z, r1.z
  add r1.z, r1.z, v2.x
  div r6.x, r1.z, cb0[11].w
  round_z r1.z, r1.w
  add r1.z, r1.z, v2.y
  div r6.y, r1.z, cb0[11].z
else 
  dp3 r1.z, -v7.xyzx, -v7.xyzx
  rsq r1.z, r1.z
  mul r7.xyz, r1.zzzz, -v7.xyzx
  dp3 r8.x, r7.xyzx, v5.xyzx
  dp3 r8.y, r7.xyzx, v6.xyzx
  dp3 r1.z, r7.xyzx, v4.xyzx
  lt r1.w, l(0.000000), r1.z
  div r6.zw, -r8.xxxy, r1.zzzz
  and r1.zw, r1.wwww, r6.zzzw
  ...
  mad r1.zw, r6.zzzw, cb0[13].zzzw, r1.zzzw
  ...
  mov r8.y, r8.x
  mov r8.z, r7.x
  dp2 r9.x, r8.yzyy, r1.zwzz
  mov r8.x, -r7.x
  dp2 r9.y, r8.xyxx, r1.zwzz
  ...
  mad r3.w, r3.w, r5.w, cb0[14].z
  div r1.zw, r1.zzzw, r3.wwww
  add r1.zw, r1.zzzw, l(0.000000, 0.000000, 0.500000, 0.500000)
  mov_sat r6.zw, r1.zzzw
  movc r6.xy, cb0[15].zwzz, r6.zwzz, r1.zwzz
endif 
dp3 r1.z, -v7.xyzx, -v7.xyzx
rsq r1.z, r1.z
mul r7.xyz, r1.zzzz, -v7.xyzx
dp3_sat r1.w, r7.xyzx, r3.xyzx
sample_indexable(texture2d)(float,float,float,float) r3.xyzw, r6.xyxx, t24.xyzw, s1
mul r3.xyz, r3.xyzx, cb0[21].yzwy
log r5.w, r1.w
mul r5.w, r5.w, cb0[21].x
exp r5.w, r5.w
add r1.w, -r1.w, l(1.000000)
log r1.w, r1.w
mul r1.w, r1.w, cb0[21].x
exp r1.w, r1.w
movc r1.w, cb0[22].y, r1.w, r5.w
eq r5.w, cb0[21].x, l(0.000000)
...
mov r6.x, cb0[16].x
sample_l_indexable(texture2d)(float,float,float,float) r1.w, r6.xyxx, t22.yzwx, s5, l(0.000000)
log r1.w, |r1.w|
...
frc r2.y, r2.y
mad r2.y, r2.y, l(6.28318548), cb1[70].w
sincos r6.x, r10.x, r2.y
dp3_sat r1.x, r4.xyzx, r7.xyzx
...
mad r8.zw, -r6.yyyy, l(0.000000, 0.000000, 10.000000, 5.000000), l(0.000000, 0.000000, 6.857410, 7.085000)
exp r7.w, r8.z
mul r7.w, r1.x, r7.w
    ...
    if_nz r13.w
      ...
      if_nz r13.z
        ...
        if_nz r15.x
          ...
          sqrt r13.z, r13.z
          mad r13.z, r6.y, l(5.000000), r13.z
          ...
          dp3 r32.x, r4.xyzx, r24.xyzx
          dp3 r32.y, r4.xyzx, r25.xyzx
...
if_nz r2.z
  ...
  mov r11.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r6.yzw, r11.xyzw, t8.wxyz, s2, r6.z
  mad r2.x, cb2[19].x, r2.z, -r2.w
  mad r2.x, r1.y, r2.x, r2.w
  mad r10.yzw, r6.yyzw, r2.xxxx, r10.yyzw
endif 
...
if_nz r6.w
  ...
  if_nz r6.w
    ...
    mad r16.xyz, r6.zzzz, r10.yzwy, r2.xzwx
    ...
    mov r17.zw, r16.xxxy
    mov r14.zw, r2.xxxz
    movc r15.xyzw, r6.yyyy, r17.xyzw, r14.xyzw
    movc r2.w, r6.y, r16.z, r2.w
    mov r14.z, r13.w
    mov r14.xy, r15.xyxx
    mov r2.xz, r15.zzwz
  endif 
