...
loop 
  ...
  if_nz r16.w
    ...
    endloop 
    mov_sat r24.y, r24.y
    mul r16.x, r24.y, cb10[r14.w + 6].y
    lt r16.w, l(0.000000), r16.x
    if_nz r16.w
      mad r22.w, r24.y, cb10[r14.w + 6].y, r22.w
      ...
      div r17.w, r18.y, r17.w
      min r16.w, r16.w, |r17.w|
      add r25.x, r23.x, cb10[r14.w + 3].w
      add r25.yz, r23.yyzy, cb10[r14.w + 4].xxyx
      mad r18.yzw, r15.xxyz, r16.wwww, r25.xxyz
      ...
      mov r23.x, r21.w
      mov r23.yz, r22.yyzy
      mad r22.xyz, r18.yzwy, r14.wwww, r23.xyzx
      mov r21.w, r22.x
    endif 
  endif 
  iadd r14.z, r14.z, l(1)
endloop 
lt r14.z, r22.w, l(1.000000)
if_nz r14.z
  mov r16.yz, l(0,0,1.000000,0)
  mov r17.xy, l(0,0,0,0)
  mov r18.x, l(1.000000)
  ...
  loop 
    ...
    breakc_nz r14.w
    movc r14.w, r14.z, r0.y, r14.y
    ult r16.w, r14.w, r13.w
    if_nz r16.w
      imul null, r14.w, r14.w, l(14)
      add r25.xyz, r10.xyzx, -cb10[r14.w + 0].xyzx
      and r16.w, l(0x0000ffff), cb10[r14.w + 7].z
      ubfe r17.w, l(6), l(25), cb10[r14.w + 7].z
      imul null, r18.z, r16.w, l(6)
      ...
      mul r16.w, r16.x, cb10[r14.w + 6].y
      lt r17.w, l(0.000000), r16.w
      if_nz r17.w
        mad r23.w, r16.x, cb10[r14.w + 6].y, r23.w
        mul r16.x, r16.w, cb10[r14.w + 7].y
        ...
        mad r14.w, r13.z, r14.w, r16.x
        div r14.w, r16.w, r14.w
        mad r23.xyz, r18.yzwy, r14.wwww, r23.xyzx
      endif 
    endif 
    iadd r14.z, r14.z, l(1)
  endloop 
...
lt r9.w, r22.w, l(0.990000)
if_nz r9.w
  add r9.w, -r22.w, l(1.000000)
  mul r16.x, r9.w, cb2[19].x
  add r16.yzw, r10.xxyz, -cb2[35].xxyz
  mul r17.x, r16.y, cb2[35].w
  mul r17.yz, r16.zzwz, cb2[36].xxyx
  add_sat r16.yzw, r17.xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
  mul r17.xy, r16.yzyy, cb2[36].zwzz
  mul r17.z, r16.w, cb2[37].x
  add r16.yzw, r17.xxyz, cb2[37].yyzw
  lt r17.xyz, l(0.000000, 0.000000, 0.000000, 0.000000), r11.xyzx
  movc r17.xyz, r17.xyzx, l(0,0,0,0), l(0.500000,0.500000,0.500000,0)
  mov r17.w, l(0)
  add r18.xyz, r16.yzwy, r17.wwxw
  ...
  mul r19.xyz, r16.xxxx, r19.xyzx
  add r20.xyz, r16.yzwy, r17.wwyw
  ...
  mov r15.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r15.xyz, r15.xyzw, t8.xyzw, s2, r12.w
