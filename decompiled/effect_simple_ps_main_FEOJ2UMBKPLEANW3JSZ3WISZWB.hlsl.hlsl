...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r4.y = rcp(r4.y);
  r4.z = -eyeOffset.z + useOldHDRScale;
  r4.z = useOldHDRScale * r4.z;
  r4.w = useOldHDRScale * v5.z;
  r5.x = cmp(r4.z < r4.w);
  r4.z = r4.y * r4.z;
  r4.z = r4.z / r4.w;
  r5.yzw = r2.xyz / r3.www;
  r3.w = v1.w + r2.w;
  r6.y = saturate(r3.w * v6.y + -v6.y);
  r6.xzw = r6.yyy * r5.yzw;
  ...
  r1.xyz = v3.xyz * r3.yyy;
  r3.xzw = v11.xyz * r3.yyy;
  r0.xyz = r2.xyz * r0.xyz + -r1.xyz;
  r0.xyz = v3.www * r0.xyz + r1.xyz;
  r0.xyz = r0.xyz * v10.xyz + r3.xzw;
  ...
  if (r2.x == 0) {
    ...
    r3.x = (int)r3.x + 1;
    // Needs manual fix for instruction:
    imm_atomic_iadd r4.x, u6, r2.xyxx, r3.x
    InterlockedAdd(dest, imm_value, orig_value);
    r2.zw = r4.xx ? float2(0,0) : 0;
    ...
    if (r3.x != 0) {
      ...
      r1.y = (uint)r3.x << 1;
      r4.xzw = (int3)r1.yyy + (int3)r1.xxx;
      r3.y = saturate(r3.y);
      r1.x = 2046 * r3.y;
      r1.x = (uint)r1.x;
      r1.y = (uint)v0.z << 2;
    ...
    // No code for instruction (needs manual fix):
        store_uav_typed u7.xyzw, r2.xyzw, r4.xyzw
      r1.x = -1;
    } else {
      r1.x = 0;
    }
