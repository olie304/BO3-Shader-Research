  ...
  out float3 o0 : SV_TARGET0)
{
  ...
  r1.xyz = postFxConst11.xyz * r0.www;
  r0.xyz = r0.xyz * postFxConst08.xyz + r1.xyz;
  r1.xyz = codeTexture1.Sample(biLinearClamp_s, v0.xy).xyz;
  r0.xyz = r1.xyz + r0.xyz;
  r0.w = 1;
  r1.x = saturate(dot(r0.xyzw, postFxConst14.xyzw));
  r1.y = saturate(dot(r0.xyzw, postFxConst15.xyzw));
  r1.z = saturate(dot(r0.xyzw, postFxConst16.xyzw));
  o0.xyz = float3(256,256,256) * r1.xyz;
  return;
}