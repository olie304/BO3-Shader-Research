...
if_nz r4.z
  ...
  if_nz r4.z
      ...
      if_z r11.w
        ...
        if_nz cb2[58].y
          ...
          loop 
            ...
            mad r15.w, r19.y, l(0.125000), r15.w
    ...
    mul r0.z, r0.z, r4.z
    mul r0.z, r0.z, r3.z
    mad r22.xyz, r0.zzzz, r14.yzwy, r19.xzwx
    mad r14.yzw, r8.wwww, r14.yyzw, r18.zzxy
    and r23.xyz, r0.wwww, r14.zwyz
    mov r16.w, r18.z
    mov r17.w, r23.z
    movc r17.xyzw, r4.wwww, r16.xyzw, r17.xyzw
    mov r18.zw, r22.xxxy
    mov r23.zw, r19.xxxz
    movc r16.xyzw, r4.wwww, r18.xyzw, r23.xyzw
    mov r21.x, r22.z
    mov r20.w, r19.w
    movc r20.xyzw, r4.wwww, r21.yzwx, r20.xyzw
    if_nz r6.w
  ...
  loop 
    ...
    if_nz r18.w
      ...
      if_nz r20.w
        ...
        store_structured u2.xyzw, cb2[52].x, r19.y, r21.xyzw
      endif 
      ...
      rsq r20.w, r20.w
      mul r21.yzw, r20.wwww, r39.xxyz
      mul r23.w, r2.z, cb9[r15.w + 1].z
      ...
      if_nz r28.w
        ...
        if_nz r23.x
          ...
          if_nz r18.w
            ...
            dp4 r18.w, r42.xyzw, r24.xyzw
            dp4 r23.y, r40.xyzw, r24.xyzw
            ge r28.w, r23.y, r18.w
            if_nz r28.w
              ...
              if_nz r11.w
                ...
                loop 
                  ige r32.w, r31.w, l(8)
                  breakc_nz r32.w
                  dp2 r42.x, icb[r31.w + 0].yxyy, r16.xyxx
                  dp2 r42.y, icb[r31.w + 0].yxyy, r16.yzyy
                ...
                utof r40.z, r23.y
                sample_c_lz_indexable(texture2darray)(float,float,float,float) r28.w, r40.xyzx, t9.xxxx, s13, r18.w
              endif 
          ...
          mul r18.w, r18.w, r30.w
          lt r23.y, l(0.000000), r18.w
          if_nz r23.y
              ...
              if_z r24.y
                ...
                if_nz r11.w
                  ...
                  loop 
                    ige r31.w, r30.w, l(8)
                    breakc_nz r31.w
                    dp2 r42.x, icb[r30.w + 0].yxyy, r16.xwxx
            ...
            mad r24.x, |r23.y|, r2.z, -|r23.y|
            mad r23.y, |r23.y|, r24.x, l(1.000000)
            mad r24.x, r21.z, r1.w, r2.y
            mul r23.y, r23.y, r23.y
            ...
            if_nz r21.y
              imad r21.yz, r20.wwww, l(0, 24, 24, 0), l(0, 88, 108, 0)
              ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r20.w, cb2[52].x, r21.y, u2.xxxx
              or r20.w, r20.w, l(8)
              store_structured u2.x, cb2[52].x, r21.y, r20.w
      ...
      if_nz r17.w
        ...
        movc r21.yzw, r20.wwww, r21.yyzw, cb9[r15.w + 0].xxyz
        movc r22.yzw, r20.wwww, r23.xxyw, cb9[r15.w + 0].xxyz
        add r22.yzw, -r10.xxyz, r22.yyzw
        add r21.yzw, -r10.xxyz, r21.yyzw
        dp3 r20.w, r22.yzwy, r22.yzwy
        rsq r20.w, r20.w
        mul r23.xyw, r20.wwww, r22.yzyw
        ...
        if_nz r21.w
          ...
          if_nz r24.x
            ...
            if_nz r17.w
              ...
              max r17.w, |r25.z|, |r25.y|
              max r17.w, r17.w, |r25.x|
            ...
            mul r17.w, r21.w, r26.y
            lt r21.w, l(0.000000), r17.w
            if_nz r21.w
              ...
              mad r22.yzw, r22.yyzw, r20.wwww, r12.xxyz
              dp3 r20.w, r22.yzwy, r22.yzwy
              rsq r20.w, r20.w
              mul r22.yzw, r20.wwww, r22.yyzw
              dp3 r20.w, r22.yzwy, r12.xyzx
              dp3 r21.w, r11.xyzx, r22.yzwy
              mad r22.y, |r21.w|, r2.z, -|r21.w|
              mad r21.w, |r21.w|, r22.y, l(1.000000)
              mad r22.y, r21.y, r1.w, r2.y
              mul r21.w, r21.w, r21.w
