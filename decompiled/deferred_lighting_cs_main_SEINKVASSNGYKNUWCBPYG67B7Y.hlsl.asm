...
mad r16.xy, -r4.wwww, l(10.000000, 5.000000, 0.000000, 0.000000), l(6.857410, 7.085000, 0.000000, 0.000000)
exp r8.w, r16.x
mul r8.w, r2.x, r8.w
mul r8.w, r8.w, l(9.136810)
mul r9.w, r4.w, r6.w
mad r9.w, -r9.w, l(2.015905), r16.y
exp r9.w, r9.w
mul r9.w, r2.x, r9.w
...
if_nz cb2[54].x
  ...
  loop 
    uge r28.z, r27.w, cb2[0].y
    breakc_nz r28.z
    ushr r28.z, r27.w, l(5)
    iadd r28.z, r9.w, r28.z
...
if_nz r12.w
  ...
  ubfe r16.w, l(6), l(25), r13.w
  imul null, r17.w, r9.w, l(6)
  ...
  loop 
    ...
    breakc_nz r21.w
    iadd r21.w, r9.w, r18.w
    imul null, r21.w, r21.w, l(6)
    dp3 r27.w, cb11[r21.w + 0].xyzx, r27.xyzx
    add_sat r27.w, r27.w, cb11[r21.w + 0].w
    mul r27.w, r27.w, r33.x
    dp3 r28.y, cb11[r21.w + 1].xyzx, r27.xyzx
    add_sat r28.y, r28.y, cb11[r21.w + 1].w
    mul r27.w, r27.w, r28.y
    dp3 r28.y, cb11[r21.w + 2].xyzx, r27.xyzx
    add_sat r28.y, r28.y, cb11[r21.w + 2].w
    mul r27.w, r27.w, r28.y
    dp3 r28.y, cb11[r21.w + 3].xyzx, r27.xyzx
    add_sat r28.y, r28.y, cb11[r21.w + 3].w
    mul r27.w, r27.w, r28.y
    dp3 r28.y, cb11[r21.w + 4].xyzx, r27.xyzx
    add_sat r28.y, r28.y, cb11[r21.w + 4].w
    mul r27.w, r27.w, r28.y
    dp3 r28.y, cb11[r21.w + 5].xyzx, r27.xyzx
    add_sat r21.w, r28.y, cb11[r21.w + 5].w
    mul r33.x, r21.w, r27.w
    ushr r28.y, r17.w, l(2)
    ubfe r28.z, l(1), l(2), r17.w
    and r28.w, r28.y, l(2)
    max r29.w, r33.x, r33.y
    mad r21.w, -r27.w, r21.w, l(1.000000)
    mul r21.w, r21.w, r33.y
    movc r32.y, r28.w, r21.w, r29.w
  ...
  if_nz r9.w
    ...
    or r13.w, r21.y, r21.x
    or r13.w, r21.z, r13.w
    movc r19.xyz, r13.wwww, l(1.000000,1.000000,0,0), r19.xyzx
...
if_z r12.w
  ...
  and r16.x, r12.w, l(-32)
  iadd r16.y, r12.w, -r16.x
  ...
  loop 
    ...
    loop 
      ...
      if_nz r21.w
        ...
        mad r31.xyz, r15.xyzx, r20.wwww, r31.xyzx
  ...
  if_nz r7.w
    ...
    mad r16.xyz, r25.xyzx, r4.wwww, r17.xyzx
    mov r15.w, l(0)
    sample_l_indexable(texturecubearray)(float,float,float,float) r17.xyz, r15.xyzw, t8.xyzw, s2, r6.w
