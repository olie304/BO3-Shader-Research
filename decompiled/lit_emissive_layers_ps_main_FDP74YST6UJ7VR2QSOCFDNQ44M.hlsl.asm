...
if_nz r1.x
  ...
  mov r12.y, r12.x
  mov r12.z, r3.x
  dp2 r13.x, r12.yzyy, r1.xwxx
  mov r12.x, -r3.x
  dp2 r13.y, r12.xyxx, r1.xwxx
  mul r1.xw, cb0[13].xxxy, cb1[69].wwww
  mad r1.xw, r1.xxxw, cb0[13].zzzw, r13.xxxy
...
if_nz r1.w
  ...
  add r3.x, -cb0[23].z, cb0[23].w
  mad r1.w, r1.w, r3.x, cb0[23].z
...
exp r1.w, r1.w
add r3.x, -cb0[26].x, cb0[26].y
mad r1.w, r1.w, r3.x, cb0[26].x
mul r12.xyz, r1.wwww, r12.xyzx
...
ret 
// Approximately 2804 instruction slots used
