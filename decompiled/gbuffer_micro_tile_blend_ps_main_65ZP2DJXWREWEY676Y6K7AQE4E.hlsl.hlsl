...
cbuffer _Globals : register(b0)
{
  ...
  float2 revealScale : packoffset(c11.y);
  ...
  out float2 o3 : SV_TARGET3)
{
  ...
  r1.z = r2.w * r1.z;
  r4.y = exp2(r1.z);
  r4.xy = saturate(alphaRevealSoftEdge * r4.xy + r0.ww);
  r4.zw = revealScale.xy * v2.xy;
  r0.w = revealMap.Sample(revealSampler_s, r4.zw).x;
  r0.w = r0.w + -r4.x;
  r1.z = r4.y + -r4.x;
