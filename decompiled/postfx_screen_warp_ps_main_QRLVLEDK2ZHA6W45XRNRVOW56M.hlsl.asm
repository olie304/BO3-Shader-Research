...
//   float refractionAmount;            // Offset:  172 Size:     4
//   float2 normalScroll;               // Offset:  176 Size:     8
//   float2 normalTile;                 // Offset:  184 Size:     8
//   float blurAmount;                  // Offset:  192 Size:     4
//   float2 blurScroll;                 // Offset:  196 Size:     8
//   float2 blurTile;                   // Offset:  208 Size:     8
//
// }
//
...
// blurMask                          texture  float4          2d             t9      1 
...
lt r1.xy, l(0.000000, 0.000000, 0.000000, 0.000000), cb3[0].xwxx
mad r1.z, r0.x, r0.y, l(1.000000)
mul r1.zw, r0.zzzw, r1.zzzz
...
movc r0.xy, r1.xxxx, r1.zwzz, r0.xyxx
if_nz r1.y
  mul r0.zw, cb0[11].xxxy, cb1[69].wwww
  mad r0.zw, v1.xxxy, cb0[11].zzzw, r0.zzzw
  frc r0.zw, r0.zzzw
  mul r1.xy, cb0[10].wwww, cb1[44].zwzz
  ...
  mul r0.zw, r0.zzzw, cb3[0].wwww
  mul r0.zw, r0.zzzw, r1.xxxy
else 
  mov r0.zw, l(0,0,0,0)
endif 
add r0.xy, r0.zwzz, r0.xyxx
mul r0.z, cb0[12].x, cb3[2].x
lt r0.w, l(0.000000), r0.z
if_nz r0.w
  mul r1.xy, cb0[12].yzyy, cb1[69].wwww
  mad r1.xy, v1.xyxx, cb0[13].xyxx, r1.xyxx
  frc r1.xy, r1.xyxx
  sample_indexable(texture2d)(float,float,float,float) r0.w, r1.xyxx, t9.yzwx, s1
  mul r0.z, r0.w, r0.z
  mul r0.zw, r0.zzzz, cb1[44].zzzw
  max r0.z, r0.w, r0.z
  mad_sat r1.xyzw, r0.zzzz, l(-0.60068172, 0.41903731, -0.20014110, -0.25657189), r0.xyxy
  ...
  mad_sat r2.xyzw, r0.zzzz, l(0.06684364, 0.49094659, -0.697239, -0.45906171), r0.xyxy
  ...
  add r1.xyzw, r1.xyzw, r2.xyzw
  mad_sat r2.xyzw, r0.zzzz, l(0.22192720, -0.52654648, 0.63864481, 0.11727790), r0.xyxy
  sample_indexable(texture2d)(float,float,float,float) r3.xyzw, r2.xyxx, t0.xyzw, s1
  add r1.xyzw, r1.xyzw, r3.xyzw
  sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r2.zwzz, t0.xyzw, s1
  add r1.xyzw, r1.xyzw, r2.xyzw
  mul o0.xyzw, r1.xyzw, l(0.16666667, 0.16666667, 0.16666667, 0.16666667)
else 
