...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  while (true) {
    ...
    if (r4.w == 0) r9.y = 0; else if (r4.w+0 < 32) {     r9.y = (uint)r8.z << (32-(r4.w + 0)); r9.y = (uint)r9.y >> (32-r4.w);    } else r9.y = (uint)r8.z >> 0;
    r8.z = r9.x ? r9.y : r8.z;
      ...
      r17.y = samp0[]..swiz;
        ...
        r18.z = samp0[]..swiz;
          ...
          r21.w = samp0[]..swiz;
            ...
            r18.z = samp0[]..swiz;
            r18.w = samp0[]..swiz;
              r23.x = dot(r4.xyz, r22.xyz);
              r23.y = dot(r4.xyz, r21.xyz);
              r24.x = dot(r5.xyz, r22.xyz);
              r24.y = dot(r5.xyz, r21.xyz);
  ...
  r5.w = saturate(r5.w);
  r2.x = 1 + -r5.w;
  r0.xyz = r0.xyz * r2.xxx + r10.xyz;
  r0.w = r0.w * r2.x + r5.w;
  r1.yzw = r1.yzw * r2.xxx + r11.xyz;
  r2.y = dot(r1.yzw, r1.yzw);
  r2.y = rsqrt(r2.y);
  r4.xyz = r2.yyy * r1.yzw;
  r1.y = r1.x * r2.x + r7.w;
  r5.xyz = r2.xxx * float3(0.0399999991,0.0399999991,0.0399999991) + r12.xyz;
  r1.z = dot(-v7.xyz, -v7.xyz);
  r1.z = rsqrt(r1.z);
  r8.xyz = -v7.xyz * r1.zzz;
  ...
  r3.xy = r2.yy ? r3.xy : v2.xy;
  r3.xyzw = emissiveMap.Sample(colorSampler_s, r3.xy).xyzw;
  r3.xyz = emissiveTint1.xyz * r3.xyz;
  r3.xyzw = r2.yyyy ? r3.xyzw : 0;
  r2.y = log2(r1.w);
  r2.y = emissiveFalloffPower * r2.y;
  r2.y = exp2(r2.y);
  r1.w = 1 + -r1.w;
  r1.w = log2(r1.w);
  r1.w = emissiveFalloffPower * r1.w;
  r1.w = exp2(r1.w);
  r1.w = invertFalloff ? r1.w : r2.y;
  r2.y = cmp(emissiveFalloffPower == 0.000000);
  r1.w = r2.y ? 1 : r1.w;
  r2.y = hdrScale * r3.w;
  r1.w = r2.y * r1.w;
  r1.w = r1.w * r2.x;
  ...
  if (r11.y != 0) {
    ...
    r15.w = 0;
    while (true) {
      r16.w = cmp((uint)r15.w >= (uint)r9.z);
      if (r16.w != 0) break;
      r13.z = (uint)r15.w >> 5;
      r14.xyz = (int3)r7.xyz + (int3)r13.xyz;
      r13.z = visibleProbes.Load(r14.xyzw).x;
  ...
  if (r7.w != 0) {
    ...
    r2.w = sunConstants.globalProbeExposure * r7.w + -r4.w;
    r2.w = r1.y * r2.w + r4.w;
    r11.yzw = r14.xyz * r2.www + r11.yzw;
  }
  r9.zw = r1.xy * float2(0.984375,0.984375) + float2(0.0078125,0.0078125);
  r9.zw = gEnvBRDFGeneric.SampleLevel(samplerLinear_s, r9.zw, 0).xy;
  r14.xyz = r11.zwy * r9.zzz;
  ...
  if (r7.w == 0) {
    ...
    r7.w = -sunConstants.splitDepthOffset + r15.z;
    ...
    if (r10.w == 0) {
      if (enableDitheredShadow == 0) {
        ...
        r16.z = r10.w + r9.z;
        r10.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r7.w).x;
      ...
      if (enableDitheredShadow != 0) {
        ...
        r15.xy = -sunConstants.splitPinTransform[r9.z].xy + r15.xy;
        r15.xy = sunConstants.splitPinTransform[r9.z].zz * r15.xy;
        ...
        while (true) {
          ...
          r17.w = r17.x ? sunConstants.splitPinTransform[r9.z].w : sunConstants.splitPinTransform[r10.w].w;
          r17.x = r17.x ? r9.z : r10.w;
  ...
  if (r7.w != 0) {
    r7.w = cmp(0 < r8.w);
    if (r7.w != 0) {
      r7.w = sunConstants.specScale * r2.y;
      r7.w = r7.w * r5.w;
      if (sunConstants.sunCookieIndex != 0) {
        r6.w = 1;
        r9.z = dot(sunConstants.sunCookieTransform[0].xyzw, r6.xyzw);
      ...
      r9.z = cmp(0 < (uint)r6.w);
      r9.z = r1.w ? r9.z : 0;
      if (r9.z != 0) {
        r6.w = (int)r6.w + numLights;
        r6.w = (int)r6.w + -1;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r9.z, r6.w, l(52), t12.xxxx
      r9.z = samp0[]..swiz;
      // Known bad code for instruction (needs manual fix):
      ...
      r5.w = r8.w * r5.w;
      r5.w = 0.25 * r5.w;
      r16.xyz = r5.www * r6.xyz + r11.yzw;
      r1.z = saturate(1 + -r1.z);
      r6.w = r1.z * r1.z;
      r6.w = r6.w * r6.w;
      r1.z = r6.w * r1.z;
      r1.z = r5.w * r1.z;
      r6.xyz = r1.zzz * r6.yzx + r14.xyz;
      r15.w = r6.z;
      r13.w = r14.z;
      r13.xyzw = r4.wwww ? r15.xyzw : r13.xyzw;
      r6.zw = r16.xy;
      r14.zw = r11.yz;
      r6.xyzw = r4.wwww ? r6.xyzw : r14.xyzw;
              ...
              if (r20.w != 0) {
                ...
                if (r20.w != 0) {
                  ...
                  while (true) {
                    ...
                    if (r27.w != 0) break;
                    r44.y = dot(icb[r26.w+0].yx, r6.xy);
                    r44.z = dot(icb[r26.w+0].yx, r6.yz);
                ...
                if (r20.w != 0) {
                    ...
                    r12.w = samp0[]..swiz;
                      ...
                      if (r8.w != 0) {
                        ...
                        while (true) {
                          ...
                          if (r24.w != 0) break;
                          r43.x = dot(icb[r18.z+0].yx, r6.xw);
                  ...
                  r39.xyz = r39.xyz * r10.www + r8.xyz;
                  r10.w = dot(r39.xyz, r39.xyz);
                  r10.w = rsqrt(r10.w);
                  r39.xyz = r39.xyz * r10.www;
                  r10.w = dot(r39.xyz, r8.xyz);
            ...
            r40.w = samp0[]..swiz;
              ...
              if (r14.w != 0) {
                ...
                if (r14.w != 0) {
                  ...
                  r19.xyz = r19.xyz * r10.www + r8.xyz;
                  r10.w = dot(r19.xyz, r19.xyz);
                  r10.w = rsqrt(r10.w);
