...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  r10.z = (uint)r1.y << 4;
  r1.y = numStaticDecals & -32;
  r2.w = (int)-r1.y + numStaticDecals;
  r11.xy = float2(0,0);
  r12.w = 0;
  r9.w = 1;
  ...
  while (true) {
    ...
    r6.w = cmp((int)r1.y == (int)r5.w);
    if (r2.w == 0) r7.w = 0; else if (r2.w+0 < 32) {     r7.w = (uint)r6.z << (32-(r2.w + 0)); r7.w = (uint)r7.w >> (32-r2.w);    } else r7.w = (uint)r6.z >> 0;
    r6.z = r6.w ? r7.w : r6.z;
  ...
  r3.w = saturate(r3.w);
  r1.y = 1 + -r3.w;
  r0.xyz = r0.xyz * r1.yyy + r13.xyz;
  r0.w = r0.w * r1.y + r3.w;
  r2.xyz = r2.xyz * r1.yyy + r14.xyz;
  r1.z = dot(r2.xyz, r2.xyz);
  r1.z = rsqrt(r1.z);
  r2.xyz = r2.xyz * r1.zzz;
  r7.y = r1.x * r1.y + r4.w;
  r1.xzw = r1.yyy * float3(0.0399999991,0.0399999991,0.0399999991) + r15.xyz;
  r3.w = dot(-v7.xyz, -v7.xyz);
  r3.w = rsqrt(r3.w);
  r8.xyz = -v7.xyz * r3.www;
  r3.x = dot(r8.xyz, r3.xyz);
  r4.x = dot(r8.xyz, r4.xyz);
  r4.y = dot(r8.xyz, r5.xyz);
  r3.y = cmp(0 < r3.x);
  r4.xy = -r4.xy / r3.xx;
  r3.yz = r3.yy ? r4.xy : 0;
  r4.x = 9.99999975e-06 + invertFalloff;
  r3.yz = r3.yz * r4.xx + v2.xy;
  ...
  r7.x = saturate(dot(r2.xyz, r8.xyz));
  r3.y = dot(-r8.xyz, r2.xyz);
  r3.y = r3.y + r3.y;
  r12.xyz = r2.xyz * -r3.yyy + -r8.xyz;
  r3.y = 17 * r7.y;
  r3.y = exp2(r3.y);
  r3.y = 2 + r3.y;
  r3.y = 2 / r3.y;
  ...
  r13.xyz = r20.xyz * r5.zzz;
  r11.yzw = r21.xyz * r5.zzz;
  ...
  if (r6.w != 0) {
    ...
    r13.xyz = r20.xyz * r5.zzz + r14.xyz;
    r12.w = 0;
    r14.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r12.xyzw, r5.w).xyz;
    r5.z = sunConstants.globalProbeExposure * r6.w + -r2.w;
    r2.w = r7.y * r5.z + r2.w;
  ...
  if (r8.w == 0) {
    ...
    if (r15.y == 0) {
      if (enableDitheredShadow == 0) {
        ...
        r16.z = r12.w + r11.w;
        r11.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r8.w).x;
      ...
      if (enableDitheredShadow != 0) {
        ...
        r11.yz = -sunConstants.splitPinTransform[r12.w].xy + r11.yz;
        r11.yz = sunConstants.splitPinTransform[r12.w].zz * r11.yz;
        ...
        while (true) {
          ...
          r17.w = r17.x ? sunConstants.splitPinTransform[r12.w].w : sunConstants.splitPinTransform[r11.w].w;
          r17.x = r17.x ? r12.w : r11.w;
  ...
  if (r8.w != 0) {
    ...
    if (r8.w != 0) {
      ...
      if (sunConstants.sunCookieIndex != 0) {
        r9.w = 1;
        r11.y = dot(sunConstants.sunCookieTransform[0].xyzw, r9.xyzw);
      ...
      r11.y = cmp(0 < (uint)r9.w);
      r11.y = r1.y ? r11.y : 0;
      if (r11.y != 0) {
        r9.w = (int)r9.w + numLights;
        r9.w = (int)r9.w + -1;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r11.y, r9.w, l(52), t12.xxxx
      r11.y = samp0[]..swiz;
      // Known bad code for instruction (needs manual fix):
        ...
        r16.y = samp0[]..swiz;
          ...
          if (enableDitheredShadow != 0) {
            ...
            while (true) {
              ...
              r15.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r17.xyz, r9.w).x;
              r11.w = r15.w * 0.125 + r11.w;
              r12.w = (int)r12.w + 1;
            }
          } else {
            r15.z = (uint)r11.z;
            r11.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r15.xyz, r9.w).x;
          }
          r9.w = r11.w * r11.w;
          r9.w = r9.w * r11.w;
        } else {
      ...
      r9.w = r9.w * r10.w;
      r5.w = cmp(0 < r5.w);
      r15.xyz = r9.www * r9.xyz + r13.xyz;
      r11.yzw = -v7.xyz * r3.www + sunConstants.wldDir.xyz;
      r3.w = dot(r11.yzw, r11.yzw);
      r3.w = rsqrt(r3.w);
      r11.yzw = r11.yzw * r3.www;
      r3.w = dot(r11.yzw, r8.xyz);
      r9.w = dot(r2.xyz, r11.yzw);
      r11.y = abs(r9.w) * r3.y + -abs(r9.w);
      r9.w = abs(r9.w) * r11.y + 1;
      r6.w = r6.w * r2.w + r5.z;
      r9.w = r9.w * r9.w;
      r6.w = r9.w * r6.w;
      r6.w = rcp(r6.w);
      ...
      r6.w = r10.w * r6.w;
      r6.w = 0.25 * r6.w;
      r11.yzw = r6.www * r9.xyz + r7.yzw;
      r3.w = saturate(1 + -r3.w);
      r8.w = r3.w * r3.w;
      r8.w = r8.w * r8.w;
      r3.w = r8.w * r3.w;
      r3.w = r6.w * r3.w;
      r9.xyz = r3.www * r9.yzx + r14.xyz;
      r15.w = r9.z;
      r13.w = r14.z;
        ...
        r37.w = samp0[]..swiz;
          ...
          switch (r14.w) {
            ...
            r39.w = samp0[]..swiz;
              ...
              r44.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r24.w, r13.w, l(236), t12.xxxx
              r24.w = samp0[]..swiz;
              ...
              if (r18.x != 0) {
                  ...
                  r39.y = samp0[]..swiz;
                    ...
                    if (r10.w != 0) {
                      ...
                      while (true) {
                        ...
                        r24.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r33.xyz, r13.w).x;
                ...
                if (r18.x != 0) {
                  ...
                  r20.y = r20.y + -r15.w;
                  r20.y = r3.z * r20.y + r15.w;
                  r20.y = r20.y * r13.w;
                  r15.z = cmp(0 < r15.z);
                  r22.xyz = r20.yyy * r31.xyz + r16.xyz;
                  r19.xyz = r19.xyz * r14.www + r8.xyz;
                  r14.w = dot(r19.xyz, r19.xyz);
                  r14.w = rsqrt(r14.w);
                  r19.xyz = r19.xyz * r14.www;
                  r14.w = dot(r19.xyz, r8.xyz);
                  r19.x = dot(r2.xyz, r19.xyz);
                  r19.y = abs(r19.x) * r3.y + -abs(r19.x);
                  r19.x = abs(r19.x) * r19.y + 1;
                  r15.w = r15.w * r2.w + r5.z;
                  r19.x = r19.x * r19.x;
                  r15.w = r19.x * r15.w;
                  r15.w = rcp(r15.w);
                  r15.w = r15.w * r18.x;
                  ...
                  r14.w = r15.w * r14.w;
                  r13.w = r14.w * r13.w;
                  r23.xyz = r13.www * r31.xyz + r29.xyz;
