...
if_nz r2.w
  ...
  if_nz r2.w
    ...
    if_nz r2.w
      ...
      if_nz r2.w
        ...
        mov r11.z, r7.y
        dp3 r9.x, r0.yzwy, r11.xyzx
        add r13.w, -r13.y, l(1.000000)
        dp3 r9.y, r0.ywzy, r13.xzwx
        mad r12.yz, r7.xxzx, l(0.000000, 1.000000, -1.000000, 0.000000), l(0.000000, 0.000000, 1.000000, 0.000000)
        dp3 r9.z, r0.yzwy, r12.xyzx
        dp3 r7.x, r1.xyzx, r11.xyzx
        dp3 r7.y, r1.xzyx, r13.xzwx
        dp3 r7.z, r1.xyzx, r12.xyzx
        dp3 r10.x, r2.xyzx, r11.xyzx
        ...
        mad r6.xyz, r0.yzwy, v5.wwww, r6.xyzx
  ...
  rsq r0.y, r0.y
  mul r1.xyz, r0.yyyy, r3.yzwy
  dp3 r0.y, r4.xywx, r4.xywx
  rsq r0.y, r0.y
  mul r2.xyz, r0.yyyy, r4.xywx
endif 
