...
sample_indexable(texture2d)(float,float,float,float) r1.x, v1.yzyy, t10.xyzw, s3
...
sample_indexable(texture2d)(float,float,float,float) r1.x, v1.yzyy, t14.xyzw, s5
sample_indexable(texture2d)(float,float,float,float) r2.x, v1.yzyy, t12.xyzw, s3
...
sample_indexable(texture2d)(float,float,float,float) r3.yzw, r3.yzyy, t15.wxyz, s4
...
mad r4.xy, r3.yzyy, cb0[13].zzzz, r2.zwzz
dp3 r2.z, r4.xyzx, r4.xyzx
rsq r2.z, r2.z
mul r4.xyz, r2.zzzz, r4.xyzx
mad r2.z, r3.w, cb0[13].z, r3.x
...
add r2.y, -r1.x, cb1[63].x
mad r4.z, cb1[63].w, r2.y, r1.x
movc r2.yzw, v5.xxxx, v2.xxyz, -v2.xxyz
...
dp2 r6.y, r2.ywyy, r3.zwzz
dp3 r0.y, r2.yzwy, r5.xyzx
add r0.y, |r0.y|, l(1.000000)
rsq r0.y, r0.y
mul r2.yz, r0.yyyy, r6.xxyx
mad r5.xy, r2.yzyy, l(0.58823532, 0.58823532, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
ge r0.x, r0.x, l(0.500000)
movc r0.x, r0.x, l(0.500000), l(0.00146628)
mad r5.z, r2.x, l(0.49755621), r0.x
and r0.xyz, r0.zzzz, r5.xyzx
mul o1.xyz, r0.wwww, r0.xyzx
add r0.y, -r1.w, r1.y
mad r1.x, r0.y, l(0.500000), r1.w
add r0.z, -r1.x, r1.z
