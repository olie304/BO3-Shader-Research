...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:41:19 2021
//
//
// Buffer Definitions: 
//
...
//   bool enableFlipbook;               // Offset:  200 Size:     4
//   float2 uvScale;                    // Offset:  208 Size:     8
...
// colorMap00                        texture  float4          2d             t0      1 
...
if_nz cb0[12].z
  ...
  mul r0.w, cb0[13].y, cb0[13].x
  div r0.z, r0.z, r0.w
  sincos r1.x, r2.x, r0.z
  frc r0.zw, r0.xxxy
  add r0.zw, r0.zzzw, l(0.000000, 0.000000, -0.500000, -0.500000)
  mul r1.yz, r0.zzwz, r2.xxxx
  mad r2.x, r1.x, r0.w, r1.y
  mad r2.y, -r1.x, r0.z, r1.z
  add_sat r0.zw, r2.xxxy, l(0.000000, 0.000000, 0.500000, 0.500000)
  mul r1.x, cb0[11].w, cb0[11].z
  mul r1.y, r1.x, cb0[12].x
  ...
  mul r1.x, r1.x, r1.y
  round_ne r1.x, r1.x
  div r1.y, r1.x, cb0[11].w
  mul r1.z, r1.x, cb0[11].w
  ge r1.z, r1.z, -r1.z
  movc r1.z, r1.z, cb0[11].w, -cb0[11].w
  div r1.w, l(1.000000, 1.000000, 1.000000, 1.000000), r1.z
  mul r1.x, r1.w, r1.x
  frc r1.x, r1.x
  mul r1.x, r1.x, r1.z
  round_z r1.x, r1.x
  add r0.z, r0.z, r1.x
  div r0.x, r0.z, cb0[11].w
  round_z r0.z, r1.y
  add r0.z, r0.z, r0.w
  div r0.y, r0.z, cb0[11].z
endif 
sample_indexable(texture2d)(float,float,float,float) r0.xyzw, r0.xyxx, t0.xyzw, s1
mul r1.x, cb0[12].y, cb1[85].x
mul r1.xyz, r1.xxxx, cb0[14].xyzx
...
if_nz r1.w
  ...
  mad r3.xyz, r1.wwww, r0.xyzx, r2.xyzx
endif 
