...
sample_indexable(texture2d)(float,float,float,float) r0.xy, r0.xyxx, t15.xyzw, s4
...
movc r3.xy, cb0[15].xxxx, r3.zwzz, r3.xyxx
...
mov r7.y, r6.x
mov r7.z, r5.x
dp2 r5.x, r1.yzyy, r7.yzyy
dp2 r5.y, r1.yzyy, r7.xyxx
add r3.zw, r5.xxxy, v2.yyyx
add r3.zw, r1.wwww, r3.zzzw
mul r3.zw, r3.zzzw, cb0[6].xxxy
add r5.xy, r5.xyxx, l(0.500000, 0.500000, 0.000000, 0.000000)
mul r5.xy, r5.xyxx, cb0[6].xyxx
movc r3.zw, cb0[15].yyyy, r3.zzzw, r5.xxxy
sample_indexable(texture2d)(float,float,float,float) r5.xyzw, r3.zwzz, t11.xyzw, s1
...
sample_indexable(texture2d)(float,float,float,float) r7.xyz, r3.zwzz, t10.xyzw, s2
sincos r8.x, r9.x, cb0[17].z
mov r10.x, -r8.x
mov r10.y, r9.x
mov r10.z, r8.x
dp2 r8.x, r1.yzyy, r10.yzyy
dp2 r8.y, r1.yzyy, r10.xyxx
add r1.yz, r8.xxyx, v2.yyxy
add r1.yz, r1.wwww, r1.yyzy
mul r1.yz, r1.yyzy, cb0[7].xxyx
add r3.zw, r8.xxxy, l(0.000000, 0.000000, 0.500000, 0.500000)
mul r3.zw, r3.zzzw, cb0[7].xxxy
movc r1.yz, cb0[17].wwww, r1.yyzy, r3.zzwz
sample_indexable(texture2d)(float,float,float,float) r8.xyzw, r1.yzyy, t14.xyzw, s1
add r9.xyz, cb0[16].xyzx, l(-1.000000, -1.000000, -1.000000, 0.000000)
mad r9.xyz, r8.wwww, r9.xyzx, l(1.000000, 1.000000, 1.000000, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r1.yzw, r1.yzyy, t12.wxyz, s2
mad r5.xyz, r5.xyzx, r6.xyzx, -r4.xyzx
mad r4.xyz, r0.xxxx, r5.xyzx, r4.xyzx
mad r5.xyz, r8.xyzx, r9.xyzx, -r4.xyzx
...
mul_sat r5.x, cb0[17].y, l(0.05882353)
add r4.w, -r3.w, r4.w
mad r3.w, r0.x, r4.w, r3.w
add r4.w, -r3.w, r5.x
mad r3.w, r0.y, r4.w, r3.w
sample_indexable(texture2d)(float,float,float,float) r4.w, v1.yzyy, t7.yzwx, s3
mad r5.xy, r7.xyxx, l(1.99218750, 1.99218750, 0.000000, 0.000000), l(-1.000000, -1.000000, 0.000000, 0.000000)
mul r5.z, r7.z, r7.z
mul r5.z, r5.z, l(0.33333334)
min r5.z, r5.z, l(1.000000)
mad r2.xy, r3.xyxx, cb0[11].zzzz, r0.zwzz
dp3 r3.x, r2.xyzx, r2.xyzx
rsq r3.x, r3.x
mul r6.xyz, r2.xyzx, r3.xxxx
mad r6.w, r2.w, cb0[11].z, r1.x
mad r2.xy, r5.xyxx, cb0[11].wwww, r0.zwzz
dp3 r2.w, r2.xyzx, r2.xyzx
rsq r2.w, r2.w
mul r7.xyz, r2.wwww, r2.xyzx
mad r7.w, r5.z, cb0[11].w, r1.x
...
mad r2.xy, r1.yzyy, cb0[15].zzzz, r0.zwzz
dp3 r0.z, r2.xyzx, r2.xyzx
rsq r0.z, r0.z
mul r2.xyz, r0.zzzz, r2.xyzx
mad r2.w, r1.w, cb0[15].z, r1.x
add r1.xyzw, -r6.xyzw, r7.xyzw
mad r1.xyzw, r0.xxxx, r1.xyzw, r6.xyzw
...
mul r1.z, r3.w, l(-17.000000)
exp r1.z, r1.z
add r0.w, r0.w, r1.z
log r0.w, r0.w
mul_sat r0.w, r0.w, l(-0.05882353)
mul r3.xyw, r0.yyyy, r7.xyxz
mad r3.xyw, r6.xyxz, r0.xxxx, r3.xyxw
mad r0.xyz, r5.xyzx, r0.zzzz, r3.xywx
dp3 r1.z, r0.xyzx, r0.xyzx
rsq r1.z, r1.z
mul r0.xyz, r0.xyzx, r1.zzzz
mad r1.z, cb1[62].x, r3.z, cb0[10].y
...
if_nz r1.w
  ...
  movc r6.xyz, r3.yyyy, l(1.000000,0,1.000000,0), r4.xyzx
  movc r7.xyz, r3.zzzz, l(0,1.000000,1.000000,0), r4.xyzx
  movc r3.xyz, r3.xxxx, r6.xyzx, r7.xyzx
  movc r6.xyz, r3.wwww, l(0,1.000000,0,0), r4.xyzx
  movc r4.xyz, r2.wwww, r3.xyzx, r6.xyzx
endif 
add r3.xyz, -r4.xyzx, cb1[58].xyzx
mad o0.xyz, cb1[58].wwww, r3.xyzx, r4.xyzx
...
add r1.z, -r4.w, cb1[63].x
mad o2.z, cb1[63].w, r1.z, r4.w
mad r1.yzw, v3.xxyz, r1.yyyy, -r0.xxyz
mad r4.yzw, cb1[60].wwww, r1.yyzw, r0.xxyz
...
mad r1.xyz, r2.xyzx, r1.xxxx, -r0.zzzz
max r1.w, r1.z, r1.y
max r1.w, r1.w, r1.x
max r0.z, r0.z, r1.w
eq r1.x, r0.z, r1.x
