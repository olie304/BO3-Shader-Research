...
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r2.yzw, r1.w, l(0), t5.xxyz
r2.y = gpuSkinBase[]..swiz;
r2.z = gpuSkinBase[]..swiz;
...
r6.z = gpuSkinBase[]..swiz;
  ...
  r3.xyz = r1.www * viewMatrix._m00_m01_m02 + r3.xyz;
  r2.yzw = r2.zzz * viewMatrix._m20_m21_m22 + r3.xyz;
  r1.w = dot(r2.yzw, r2.yzw);
  r1.w = rsqrt(r1.w);
  o5.xyz = r2.yzw * r1.www;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r2.yz, v7.x, l(8), t4.xxyx
r2.y = gpuSkinBase[]..swiz;
r2.z = gpuSkinBase[]..swiz;
...
r6.w = gpuSkinBase[]..swiz;
  ...
  r4.xyzw = r3.xxxx * viewProjectionMatrix._m00_m01_m02_m03 + r4.xyzw;
  r4.xyzw = r3.zzzz * viewProjectionMatrix._m20_m21_m22_m23 + r4.xyzw;
  o0.xyzw = viewProjectionMatrix._m30_m31_m32_m33 + r4.xyzw;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r1.w, v7.x, l(12), t4.xxxx
r1.w = gpuSkinBase[]..swiz;
  r2.z = (int)r0.w + (int)r1.w;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r4.xyz, r2.z, l(0), t5.xyzx
r4.x = gpuSkinBase[]..swiz;
r4.y = gpuSkinBase[]..swiz;
r4.z = gpuSkinBase[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r5.xyz, r2.z, l(16), t5.xyzx
r5.x = gpuSkinBase[]..swiz;
r5.y = gpuSkinBase[]..swiz;
r5.z = gpuSkinBase[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r6.xyz, r2.z, l(32), t5.xyzx
r6.x = gpuSkinBase[]..swiz;
r6.y = gpuSkinBase[]..swiz;
r6.z = gpuSkinBase[]..swiz;
  ...
  r7.xyz = viewMatrix._m10_m11_m12 * r2.www;
  r7.xyz = r2.zzz * viewMatrix._m00_m01_m02 + r7.xyz;
  r0.xyz = r0.xxx * viewMatrix._m20_m21_m22 + r7.xyz;
  r2.z = dot(r0.xyz, r0.xyz);
  r2.z = rsqrt(r2.z);
  o3.xyz = r2.zzz * r0.xyz;
  ...
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r4.xyzw, r0.x, l(48), t5.xyzw
  r4.x = gpuSkinBase[]..swiz;
  r4.y = gpuSkinBase[]..swiz;
  r4.z = gpuSkinBase[]..swiz;
  r4.w = gpuSkinBase[]..swiz;
  ...
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r5.xyzw, r0.y, l(48), t8.xyzw
  r5.x = gpuSkinBase[]..swiz;
  r5.y = gpuSkinBase[]..swiz;
  r5.z = gpuSkinBase[]..swiz;
  r5.w = gpuSkinBase[]..swiz;
    ...
    if (r0.x != 0) {
      ...
      r6.w = gpuSkinBase[]..swiz;
        ...
        r6.w = gpuSkinBase[]..swiz;
          ...
          r6.w = gpuSkinBase[]..swiz;
            ...
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r6.xyzw, r0.x, l(0), t8.xyzw
            r6.x = gpuSkinBase[]..swiz;
            r6.y = gpuSkinBase[]..swiz;
            r6.z = gpuSkinBase[]..swiz;
            r6.w = gpuSkinBase[]..swiz;
      ...
      r0.xyz = gpuSkinPos.Load(r6.xyz).xyz;
      r1.xyz = gpuSkinPos.Load(r6.xwz).xyz;
      r2.xzw = gpuSkinBase.Load(r6.xzz).xyz;
      r8.xyzw = r8.xyzw + -r7.xyzw;
      r7.xyzw = r4.zzzz * r8.xyzw + r7.xyzw;
      r1.xyz = r1.xyz + -r0.xyz;
      r0.xyz = r4.zzz * r1.xyz + r0.xyz;
      r1.xyz = v0.xyz + -r2.xzw;
      r3.w = dot(r7.xyzw, r7.xyzw);
      r3.w = rsqrt(r3.w);
      r7.xyzw = r7.xyzw * r3.wwww;
      r4.xyw = r7.xyz + r7.xyz;
      r8.xyz = r7.xzw * r4.xxx;
      r3.w = r7.w * r4.y;
      r9.xy = r7.wz * r4.ww;
      r4.w = r7.y * r4.y + r9.y;
      r10.x = 1 + -r4.w;
      r11.x = r7.z * r4.x + -r3.w;
      r10.y = r7.y * r4.x + -r9.x;
      r9.xy = r7.yx * r4.xx + r9.xy;
      r9.z = r7.z * r4.y + -r8.z;
      r4.xyw = r7.zwy * r4.yyy + r8.zyx;
      r10.z = r4.y;
      r7.x = dot(r1.xyz, r10.xyz);
      r9.w = 1 + -r9.y;
      r7.y = dot(r1.xzy, r9.xzw);
      r11.yz = r4.xw * float2(1,-1) + float2(0,1);
      r7.z = dot(r1.xyz, r11.xyz);
      r1.xyz = r7.xyz + r2.xzw;
      r0.xyz = r1.xyz + r0.xyz;
      r5.xyz = v5.xxx * r0.xyz;
      ...
      if (r0.x != 0) {
        ...
        if (r0.x != 0) {
          ...
          if (r0.x != 0) {
            ...
            r0.xyz = r4.zzz * r1.xyz + r0.xyz;
            r1.xyz = v0.xyz + -r2.xzw;
            r3.w = dot(r6.xyzw, r6.xyzw);
            r3.w = rsqrt(r3.w);
            r4.xyzw = r6.xyzw * r3.wwww;
            r6.xyz = r4.xyz + r4.xyz;
            r7.xyz = r6.xxx * r4.xzw;
            r3.w = r6.y * r4.w;
            r6.zw = r6.zz * r4.wz;
            r7.w = r4.y * r6.y + r6.w;
            r8.x = 1 + -r7.w;
            r9.x = r4.z * r6.x + -r3.w;
            r8.y = r4.y * r6.x + -r6.z;
            r10.xy = r4.yx * r6.xx + r6.zw;
            r10.z = r4.z * r6.y + -r7.z;
            r4.xyz = r4.zwy * r6.yyy + r7.zyx;
            r8.z = r4.y;
            r6.x = dot(r1.xyz, r8.xyz);
            r10.w = 1 + -r10.y;
            r6.y = dot(r1.xzy, r10.xzw);
            r9.yz = r4.xz * float2(1,-1) + float2(0,1);
            r6.z = dot(r1.xyz, r9.xyz);
            r1.xyz = r6.xyz + r2.xzw;
            r0.xyz = r1.xyz + r0.xyz;
            r5.xyz = r0.xyz * v5.www + r5.xyz;
          }
        }
      }
    }
