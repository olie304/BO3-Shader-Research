// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:42:51 2021
...
r2.z = samp0[]..swiz;
r2.w = samp0[]..swiz;
  r7.xyz = cmp(float3(0.0404499993,0.0404499993,0.0404499993) >= r2.yzw);
  r8.xyz = float3(0.0773993805,0.0773993805,0.0773993805) * r2.yzw;
  ...
  r2.yzw = exp2(r2.yzw);
  r2.yzw = r7.xyz ? r8.xyz : r2.yzw;
  r7.xyz = r6.xyz * r2.yzw;
  r0.xyz = r2.yzw * r0.xyz;
  r2.y = dot(-v6.xyz, -v6.xyz);
  r2.y = rsqrt(r2.y);
  r8.xyz = -v6.xyz * r2.yyy;
  r2.z = saturate(dot(v3.xyz, r8.xyz));
  ...
  r5.x = saturate(dot(r3.xyz, r8.xyz));
  r7.y = dot(-r8.xyz, r3.xyz);
  r7.y = r7.y + r7.y;
  r12.xyz = r3.xyz * -r7.yyy + -r8.xyz;
  r7.y = 17 * r5.y;
  r7.y = exp2(r7.y);
  r7.y = 2 + r7.y;
  r7.y = 2 / r7.y;
  ...
  if (r10.w != 0) {
    r10.w = cmp(0 < r11.y);
    if (r10.w != 0) {
      r10.w = sunConstants.specScale * r7.y;
      r10.w = r10.w * r9.w;
      ...
      r11.z = r11.z + -r9.w;
      r11.z = r7.z * r11.z + r9.w;
      r11.z = r11.z * r11.y;
      r14.xyz = r11.zzz * r13.xyz;
      r9.z = cmp(0 < r9.z);
      r15.xyz = -v6.xyz * r2.yyy + sunConstants.wldDir.xyz;
      r2.y = dot(r15.xyz, r15.xyz);
      r2.y = rsqrt(r2.y);
      r15.xyz = r15.xyz * r2.yyy;
      r2.y = dot(r15.xyz, r8.xyz);
      r11.z = dot(r3.xyz, r15.xyz);
      r11.w = abs(r11.z) * r7.y + -abs(r11.z);
            ...
            r42.w = samp0[]..swiz;
              ...
              if (r21.z != 0) {
                ...
                if (r21.z != 0) {
                  ...
                  r22.y = r22.y + -r21.x;
                  r22.y = r7.z * r22.y + r21.x;
                  r22.y = r22.y * r17.w;
                  r20.y = cmp(0 < r20.y);
                  r24.xyz = r22.yyy * r33.xyz + r18.xyz;
                  r25.xyz = r40.xyz * r20.xxx + r8.xyz;
                  r20.x = dot(r25.xyz, r25.xyz);
                  r20.x = rsqrt(r20.x);
                  r25.xyz = r25.xyz * r20.xxx;
                  r20.x = dot(r25.xyz, r8.xyz);
                  r22.y = dot(r3.xyz, r25.xyz);
                  r22.w = abs(r22.y) * r7.y + -abs(r22.y);
                  r22.y = abs(r22.y) * r22.w + 1;
                  r21.x = r21.x * r7.w + r8.w;
                  r22.y = r22.y * r22.y;
                  r21.x = r22.y * r21.x;
                  r21.x = rcp(r21.x);
                  r21.x = r21.x * r21.z;
  ...
  r5.z = max(0, r5.z);
  r7.xy = -r2.yy * float2(10,5) + float2(6.85740995,7.08500004);
  r5.w = exp2(r7.x);
  r5.w = r5.x * r5.w;
  ...
  r7.xyz = r19.xyz * r2.yyy;
  r8.xyz = r20.xyz * r2.yyy;
  r5.z = cmp(r20.w < 0.99000001);
  if (r5.z != 0) {
    r5.z = 1 + -r20.w;
    ...
    r7.xyz = r19.xyz * r2.yyy + r3.xyz;
    r12.w = 0;
    r3.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r12.xyzw, r4.w).xyz;
    r2.y = sunConstants.globalProbeExposure * r5.z + -r3.w;
    r2.y = r5.y * r2.y + r3.w;
    r8.xyz = r3.xyz * r2.yyy + r8.xyz;
  }
  ...
  r7.xyz = r8.xyz * r2.xxx;
  r5.xzw = r7.xyz * r5.xxx + r29.xyz;
  r7.xyz = r7.xyz * r5.yyy + r30.xyz;
  r5.xyz = float3(0.959999979,0.959999979,0.959999979) * r5.xzw;
  r5.xyz = r7.xyz * float3(0.0399999991,0.0399999991,0.0399999991) + r5.xyz;
  ...
  r3.x = 1 / zFeather;
  r2.y = r2.y ? 60000 : r3.x;
  r2.x = r2.x + -r2.w;
  r2.x = saturate(r2.x * r2.y);
  r2.y = cmp(r2.x < 1);
  if (r2.y != 0) {
    r2.y = edgeColorMap.Sample(colorSampler_s, w1.xy).w;
    r3.xyzw = edgeEmissiveMap.Sample(colorSampler_s, w1.xy).xyzw;
    r3.xyz = r3.xyz * r3.www;
    r0.w = r0.w * v1.x + -r2.y;
    r0.w = r2.x * r0.w + r2.y;
    r5.xyzw = r6.xyzw + -r3.xyzw;
    r6.xyzw = r2.xxxx * r5.xyzw + r3.xyzw;
  ...
  r3.xyz = relHDRExposure.xxx * r4.xyz;
