...
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r3.x, v2.x, l(8), t4.xxxx
r3.x = samp0[]..swiz;
  r3.xy = (int2)r3.xx & int2(268435456,536870912);
  if (r3.x != 0) {
    ...
    r3.w = 0;
    while (true) {
      r5.w = cmp((uint)r3.w >= numStaticDecals);
      if (r5.w != 0) break;
      r6.z = (uint)r3.w >> 5;
      r7.xyz = (int3)r5.xyz + (int3)r6.xyz;
      r5.w = visibleDecals.Load(r7.xyzw).x;
      r6.z = cmp((int)r3.x == (int)r3.w);
      if (r3.z == 0) r6.w = 0; else if (r3.z+0 < 32) {       r6.w = (uint)r5.w << (32-(r3.z + 0)); r6.w = (uint)r6.w >> (32-r3.z);      } else r6.w = (uint)r5.w >> 0;
      r5.w = r6.z ? r6.w : r5.w;
      r6.z = (int)r2.w + (int)r3.w;
      r10.xyzw = r8.xyzw;
      r7.xyz = r9.xyz;
      r6.w = r5.w;
      while (true) {
        if (r6.w == 0) break;
        r9.w = firstbitlow((uint)r6.w);
        r11.x = 1 << (int)r9.w;
        r11.y = (int)r6.w & (int)r11.x;
        if (r11.y != 0) {
          r6.w = (int)r6.w ^ (int)r11.x;
          r11.x = (int)r6.z + (int)r9.w;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=80)(mixed,mixed,mixed,mixed) r12.xyzw, r11.x, l(0), t11.xyzw
        r12.x = samp0[]..swiz;
        r12.y = samp0[]..swiz;
        r12.z = samp0[]..swiz;
        r12.w = samp0[]..swiz;
        ...
        r11.y = samp0[]..swiz;
          ...
          r11.z = r12.w;
          r11.xyz = cmp(abs(r12.xyz) < r11.zxy);
          r11.x = r11.y ? r11.x : 0;
          r11.x = r11.z ? r11.x : 0;
          if (r11.x != 0) {
            r9.w = (int)r3.w + (int)r9.w;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=128)(mixed,mixed,mixed,mixed) r11.xyz, r9.w, l(0), t36.xyzx
          r11.x = samp0[]..swiz;
          r11.y = samp0[]..swiz;
          r11.z = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=128)(mixed,mixed,mixed,mixed) r12.xyz, r9.w, l(16), t36.xyzx
          r12.x = samp0[]..swiz;
          r12.y = samp0[]..swiz;
          r12.z = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=128)(mixed,mixed,mixed,mixed) r13.xyz, r9.w, l(32), t36.xyzx
          r13.x = samp0[]..swiz;
          r13.y = samp0[]..swiz;
          r13.z = samp0[]..swiz;
            r14.x = r11.x;
            r14.y = r12.x;
            r14.z = r13.x;
            r11.x = dot(r14.xyz, r14.xyz);
            r11.x = rsqrt(r11.x);
            r15.xyz = r14.xyz * r11.xxx;
            r11.x = dot(r15.xyz, v3.xyz);
            r11.x = cmp(r11.x >= 0.5);
            if (r11.x != 0) {
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=128)(mixed,mixed,mixed,mixed) r15.xyw, r9.w, l(48), t36.xyxz
            r15.x = samp0[]..swiz;
            r15.y = samp0[]..swiz;
            r15.w = samp0[]..swiz;
              r14.w = r15.x;
              ...
              if (r11.x != 0) {
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=128)(mixed,mixed,mixed,mixed) r11.xyzw, r9.w, l(64), t36.xyzw
              r11.x = samp0[]..swiz;
              r11.y = samp0[]..swiz;
              r11.z = samp0[]..swiz;
              r11.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=128)(mixed,mixed,mixed,mixed) r12.xyzw, r9.w, l(80), t36.xyzw
              r12.x = samp0[]..swiz;
              r12.y = samp0[]..swiz;
              r12.z = samp0[]..swiz;
              r12.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=128)(mixed,mixed,mixed,mixed) r13.x, r9.w, l(108), t36.xxxx
              r13.x = samp0[]..swiz;
                r17.x = dot(r0.yzw, r16.xyz);
                r17.y = dot(r0.yzw, r15.xyz);
                r16.x = dot(r2.xyz, r16.xyz);
                r16.y = dot(r2.xyz, r15.xyz);
                r13.yz = r14.yz * float2(0.5,-0.5) + float2(0.5,0.5);
                r14.xyz = float3(0.5,-0.5,0.5) * r17.xyx;
                ...
                if (r12.y != 0) {
                  ...
                  r14.w = (uint)r12.w >> 28;
                  r14.w = 1 << (int)r14.w;
                  r15.w = cmp((int)r12.y == 4);
                  if (r15.w != 0) {
                    r15.w = (int)r12.w & 4095;
                    if (12 == 0) r16.x = 0; else if (12+12 < 32) {                     r16.x = (uint)r12.w << (32-(12 + 12)); r16.x = (uint)r16.x >> (32-12);                    } else r16.x = (uint)r12.w >> 12;
                    r16.y = (int)r13.x & 1023;
                    r17.xz = (uint2)r13.ww;
                    r17.y = (uint)r14.w;
                    r16.zw = r13.yz * r17.zy + float2(0.5,0.5);
                    r18.xy = float2(-0.5,-0.5) + r17.zy;
                    r16.zw = min(r18.xy, r16.zw);
                    r18.x = (uint)r15.w;
                    r18.yz = (uint2)r16.xy;
                    r16.xz = r18.xy + r16.zw;
                    r18.xy = invBcTexSizes.xy * r16.xz;
                    ...
                    if (r12.y != 0) {
                      ...
                      r15.w = (int)r13.x & 1023;
                      r17.xz = (uint2)r13.ww;
                      r17.y = (uint)r14.w;
                      r18.xy = r13.yz * r17.zy + float2(0.5,0.5);
                ...
                if (r12.z != 0) {
                // Known bad code for instruction (needs manual fix):
                                ld_structured_indexable(structured_buffer, stride=128)(mixed,mixed,mixed,mixed) r9.w, r9.w, l(100), t36.xxxx
                r9.w = samp0[]..swiz;
                  if (4 == 0) r12.x = 0; else if (4+24 < 32) {                   r12.x = (uint)r9.w << (32-(4 + 24)); r12.x = (uint)r12.x >> (32-4);                  } else r12.x = (uint)r9.w >> 24;
                  r12.y = (uint)r9.w >> 28;
                  r12.xy = int2(1,1) << (int2)r12.xy;
                  r12.w = cmp((int)r12.z == 2);
                  if (r12.w != 0) {
                    r12.w = (int)r9.w & 4095;
                    if (12 == 0) r13.w = 0; else if (12+12 < 32) {                     r13.w = (uint)r9.w << (32-(12 + 12)); r13.w = (uint)r13.w >> (32-12);                    } else r13.w = (uint)r9.w >> 12;
                    if (10 == 0) r14.w = 0; else if (10+20 < 32) {                     r14.w = (uint)r13.x << (32-(10 + 20)); r14.w = (uint)r14.w >> (32-10);                    } else r14.w = (uint)r13.x >> 20;
                    r16.xyz = (uint3)r12.xyx;
                    r17.xy = r13.yz * r16.zy + float2(0.5,0.5);
                    ...
                    if (r12.z != 0) {
                      ...
                      r12.z = (int)r9.w & 4095;
                      if (12 == 0) r9.w = 0; else if (12+12 < 32) {                       r9.w = (uint)r9.w << (32-(12 + 12)); r9.w = (uint)r9.w >> (32-12);                      } else r9.w = (uint)r9.w >> 12;
                      if (10 == 0) r13.x = 0; else if (10+20 < 32) {                       r13.x = (uint)r13.x << (32-(10 + 20)); r13.x = (uint)r13.x >> (32-10);                      } else r13.x = (uint)r13.x >> 20;
                      r16.xyz = (uint3)r12.xyx;
                      r12.xy = r13.yz * r16.xy + float2(0.5,0.5);
                      r13.yz = float2(-0.5,-0.5) + r16.zy;
                      r12.xy = min(r13.yz, r12.xy);
                      r17.x = (uint)r12.z;
                      r17.y = (uint)r9.w;
  ...
  if (r3.y != 0) {
    ...
    r4.x = numDynamicDecals + numStaticDecals;
    r4.y = 0.0078125 * r0.x;
    r4.y = min(15, r4.y);
    r4.y = (uint)r4.y;
    r5.xy = (uint2)r1.xy >> int2(6,6);
    r5.z = (uint)r4.y << 4;
    r4.y = numStaticDecals & -32;
    r4.z = (int)-r4.y + numStaticDecals;
    r4.w = (int)r4.x & -32;
    r5.w = (int)-r4.w + (int)r4.x;
    r6.xy = float2(0,0);
    r7.w = 0;
    r3.w = 1;
    r10.xyzw = r8.xyzw;
    ...
    r6.w = r4.y;
    while (true) {
      r9.w = cmp((uint)r6.w >= (uint)r4.x);
      if (r9.w != 0) break;
      r6.z = (uint)r6.w >> 5;
      r7.xyz = (int3)r5.xyz + (int3)r6.xyz;
      r6.z = visibleDecals.Load(r7.xyzw).x;
      r7.x = cmp((int)r4.y == (int)r6.w);
      bitmask.y = ((~(-1 << r4.z)) << 0) & 0xffffffff;  r7.y = (((uint)0 << 0) & bitmask.y) | ((uint)r6.z & ~bitmask.y);
      r6.z = r7.x ? r7.y : r6.z;
      r7.x = cmp((int)r4.w == (int)r6.w);
      if (r5.w == 0) r7.y = 0; else if (r5.w+0 < 32) {       r7.y = (uint)r6.z << (32-(r5.w + 0)); r7.y = (uint)r7.y >> (32-r5.w);      } else r7.y = (uint)r6.z >> 0;
      r6.z = r7.x ? r7.y : r6.z;
      r7.x = (int)r2.w + (int)r6.w;
      r12.xyzw = r10.xyzw;
      r13.xyz = r11.xyz;
      r7.y = r6.z;
      while (true) {
        ...
        r9.w = 1 << (int)r7.z;
        r11.w = (int)r7.y & (int)r9.w;
        if (r11.w != 0) {
          r7.y = (int)r7.y ^ (int)r9.w;
          r9.w = (int)r7.z + (int)r7.x;
        // Known bad code for instruction (needs manual fix):
        ...
        r14.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=80)(mixed,mixed,mixed,mixed) r15.xy, r9.w, l(16), t11.xyxx
        r15.x = samp0[]..swiz;
        r15.y = samp0[]..swiz;
          ...
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=128)(mixed,mixed,mixed,mixed) r14.xyz, r7.z, l(0), t36.xyzx
          r14.x = samp0[]..swiz;
          r14.y = samp0[]..swiz;
          r14.z = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=128)(mixed,mixed,mixed,mixed) r15.xyz, r7.z, l(16), t36.xyzx
          r15.x = samp0[]..swiz;
          r15.y = samp0[]..swiz;
          r15.z = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=128)(mixed,mixed,mixed,mixed) r16.xyz, r7.z, l(32), t36.xyzx
          r16.x = samp0[]..swiz;
          r16.y = samp0[]..swiz;
          r16.z = samp0[]..swiz;
            r17.x = r14.x;
            ...
            r9.w = rsqrt(r9.w);
            r18.xyz = r17.xyz * r9.www;
            r9.w = dot(r18.xyz, v3.xyz);
            r9.w = cmp(r9.w >= 0.5);
            if (r9.w != 0) {
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=128)(mixed,mixed,mixed,mixed) r18.xyw, r7.z, l(48), t36.xyxz
            r18.x = samp0[]..swiz;
            r18.y = samp0[]..swiz;
            r18.w = samp0[]..swiz;
              r17.w = r18.x;
              r17.x = dot(r3.xyzw, r17.xyzw);
              r19.x = r14.y;
              r19.y = r15.y;
              r19.z = r16.y;
              r19.w = r18.y;
              r17.y = dot(r3.xyzw, r19.xyzw);
              r18.x = r14.z;
              r18.y = r15.z;
              r18.z = r16.z;
              r17.z = dot(r3.xyzw, r18.xyzw);
              r14.xyz = cmp(abs(r17.xyz) < float3(1,1,1));
              r9.w = r14.y ? r14.x : 0;
              r9.w = r14.z ? r9.w : 0;
              if (r9.w != 0) {
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=128)(mixed,mixed,mixed,mixed) r14.xyzw, r7.z, l(64), t36.xyzw
              r14.x = samp0[]..swiz;
              r14.y = samp0[]..swiz;
              r14.z = samp0[]..swiz;
              r14.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=128)(mixed,mixed,mixed,mixed) r15.xyzw, r7.z, l(80), t36.xyzw
              r15.x = samp0[]..swiz;
              r15.y = samp0[]..swiz;
              r15.z = samp0[]..swiz;
              r15.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=128)(mixed,mixed,mixed,mixed) r9.w, r7.z, l(108), t36.xxxx
              r9.w = samp0[]..swiz;
                r16.x = dot(r0.yzw, r19.xyz);
                r16.y = dot(r0.yzw, r18.xyz);
                r19.x = dot(r2.xyz, r19.xyz);
                r19.y = dot(r2.xyz, r18.xyz);
                r16.zw = r17.yz * float2(0.5,-0.5) + float2(0.5,0.5);
                r17.xyz = float3(0.5,-0.5,0.5) * r16.xyx;
                r18.xyz = float3(0.5,-0.5,0.5) * r19.xyx;
                r15.yz = (int2)r15.yz & int2(65535,65535);
                if (r15.y != 0) {
                  if (4 == 0) r11.w = 0; else if (4+24 < 32) {                   r11.w = (uint)r15.w << (32-(4 + 24)); r11.w = (uint)r11.w >> (32-4);                  } else r11.w = (uint)r15.w >> 24;
                  r11.w = 1 << (int)r11.w;
                  r13.w = (uint)r15.w >> 28;
                  r13.w = 1 << (int)r13.w;
                  r16.x = cmp((int)r15.y == 4);
                  if (r16.x != 0) {
                    r16.x = r15.w ? 0.000000 : 0;
                    if (12 == 0) r16.y = 0; else if (12+12 < 32) {                     r16.y = (uint)r15.w << (32-(12 + 12)); r16.y = (uint)r16.y >> (32-12);                    } else r16.y = (uint)r15.w >> 12;
                    r17.w = r9.w ? 0.000000 : 0;
                    r19.xz = (uint2)r11.ww;
                    r19.y = (uint)r13.w;
                    r20.xy = r16.zw * r19.zy + float2(0.5,0.5);
                    r20.zw = float2(-0.5,-0.5) + r19.zy;
                    r20.xy = min(r20.xy, r20.zw);
                    r21.xy = (uint2)r16.xy;
                    r16.xy = r21.xy + r20.xy;
                    r20.xy = invBcTexSizes.xy * r16.xy;
                    r20.z = (uint)r17.w;
                    r21.xyz = invBcTexSizes.xyx * r17.zyz;
                    r21.xyz = r21.xyz * r19.xyz;
                    r22.xyz = invBcTexSizes.xyx * r18.zyz;
                    r19.xyz = r22.xyz * r19.xyz;
                    r19.xyzw = materialTexBC7.SampleGrad(samplerLinearClamp_s, r20.xyz, r21.xyzx, r19.xyzx).xyzw;
                  } else {
                    r15.y = cmp((int)r15.y == 1);
                    if (r15.y != 0) {
                      r15.y = r15.w ? 0.000000 : 0;
                      ...
                      r20.xz = (uint2)r11.ww;
                      r20.y = (uint)r13.w;
                      r21.xy = r16.zw * r20.zy + float2(0.5,0.5);
                      r21.zw = float2(-0.5,-0.5) + r20.zy;
                      r21.xy = min(r21.xy, r21.zw);
                      r22.xy = (uint2)r15.yw;
                      r15.yw = r22.xy + r21.xy;
                      r21.xy = invBcTexSizes.zw * r15.yw;
                      r21.z = (uint)r16.x;
                      r22.xyz = invBcTexSizes.zwz * r17.zyz;
                      r22.xyz = r22.xyz * r20.xyz;
                      r23.xyz = invBcTexSizes.zwz * r18.zyz;
                      r20.xyz = r23.xyz * r20.xyz;
                      r19.xyzw = materialTexBC3.SampleGrad(samplerLinearClamp_s, r21.xyz, r22.xyzx, r20.xyzx).xyzw;
                    } else {
                      r19.xyzw = float4(1,1,1,1);
                    }
                  }
                ...
                if (r15.z != 0) {
                // Known bad code for instruction (needs manual fix):
                                ld_structured_indexable(structured_buffer, stride=128)(mixed,mixed,mixed,mixed) r7.z, r7.z, l(100), t36.xxxx
                r7.z = samp0[]..swiz;
                  if (4 == 0) r13.w = 0; else if (4+24 < 32) {                   r13.w = (uint)r7.z << (32-(4 + 24)); r13.w = (uint)r13.w >> (32-4);                  } else r13.w = (uint)r7.z >> 24;
                  r13.w = 1 << (int)r13.w;
                  r14.w = (uint)r7.z >> 28;
                  r14.w = 1 << (int)r14.w;
                  r15.x = cmp((int)r15.z == 2);
                  if (r15.x != 0) {
                    r15.x = (int)r7.z & 4095;
                    if (12 == 0) r15.y = 0; else if (12+12 < 32) {                     r15.y = (uint)r7.z << (32-(12 + 12)); r15.y = (uint)r15.y >> (32-12);                    } else r15.y = (uint)r7.z >> 12;
                    if (10 == 0) r15.w = 0; else if (10+20 < 32) {                     r15.w = (uint)r9.w << (32-(10 + 20)); r15.w = (uint)r15.w >> (32-10);                    } else r15.w = (uint)r9.w >> 20;
                    r19.xz = (uint2)r13.ww;
                    r19.y = (uint)r14.w;
                    r16.xy = r16.zw * r19.zy + float2(0.5,0.5);
                    r20.xy = float2(-0.5,-0.5) + r19.zy;
                    r16.xy = min(r20.xy, r16.xy);
                    r20.xyz = (uint3)r15.xyw;
                    r15.xy = r20.xy + r16.xy;
                    r20.xy = invMaskTexSizes.xy * r15.xy;
                    r15.xyw = invMaskTexSizes.xyx * r17.zyz;
                    r15.xyw = r15.xyw * r19.xyz;
                    r21.xyz = invMaskTexSizes.xyx * r18.zyz;
                    r19.xyz = r21.xyz * r19.xyz;
                    r15.x = materialTexMask.SampleGrad(samplerLinearClamp_s, r20.xyz, r15.x, r19.x).x;
                  } else {
                    r15.y = cmp((int)r15.z == 4);
                    if (r15.y != 0) {
                      r15.y = (int)r7.z & 4095;
                      if (12 == 0) r15.z = 0; else if (12+12 < 32) {                       r15.z = (uint)r7.z << (32-(12 + 12)); r15.z = (uint)r15.z >> (32-12);                      } else r15.z = (uint)r7.z >> 12;
                      if (10 == 0) r15.w = 0; else if (10+20 < 32) {                       r15.w = (uint)r9.w << (32-(10 + 20)); r15.w = (uint)r15.w >> (32-10);                      } else r15.w = (uint)r9.w >> 20;
                      r19.xz = (uint2)r13.ww;
                      r19.y = (uint)r14.w;
                      r16.xy = r16.zw * r19.zy + float2(0.5,0.5);
                      r20.xy = float2(-0.5,-0.5) + r19.zy;
                      r16.xy = min(r20.xy, r16.xy);
                      r20.xyz = (uint3)r15.yzw;
                      r15.yz = r20.xy + r16.xy;
                      r20.xy = invBcTexSizes.xy * r15.yz;
                      r15.yzw = invBcTexSizes.xyx * r17.zyz;
                      r15.yzw = r15.yzw * r19.xyz;
                      r21.xyz = invBcTexSizes.xyx * r18.zyz;
                      r19.xyz = r21.xyz * r19.xyz;
                      r15.x = materialTexBC7.SampleGrad(samplerLinearClamp_s, r20.xyz, r15.y, r19.x).x;
                    } else {
                      r15.y = (int)r7.z & 4095;
                      if (12 == 0) r7.z = 0; else if (12+12 < 32) {                       r7.z = (uint)r7.z << (32-(12 + 12)); r7.z = (uint)r7.z >> (32-12);                      } else r7.z = (uint)r7.z >> 12;
                      if (10 == 0) r9.w = 0; else if (10+20 < 32) {                       r9.w = (uint)r9.w << (32-(10 + 20)); r9.w = (uint)r9.w >> (32-10);                      } else r9.w = (uint)r9.w >> 20;
                      r19.xz = (uint2)r13.ww;
                      r19.y = (uint)r14.w;
                      r15.zw = r16.zw * r19.xy + float2(0.5,0.5);
                      r16.xy = float2(-0.5,-0.5) + r19.zy;
                      r15.zw = min(r16.xy, r15.zw);
                      r16.x = (uint)r15.y;
                      r16.y = (uint)r7.z;
                      r15.yz = r16.xy + r15.zw;
                      r16.xy = invBcTexSizes.zw * r15.yz;
                      r16.z = (uint)r9.w;
                      r15.yzw = invBcTexSizes.zwz * r17.xyz;
                      r15.yzw = r15.yzw * r19.xyz;
                      r17.xyz = invBcTexSizes.zwz * r18.xyz;
                      r17.xyz = r17.xyz * r19.xyz;
                      r15.x = materialTexBC3.SampleGrad(samplerLinearClamp_s, r16.xyz, r15.y, r17.x).x;
                    }
                  }
                  r15.yzw = r15.xxx * float3(0.959999979,0.959999979,0.959999979) + float3(0.0399999991,0.0399999991,0.0399999991);
                  r7.z = saturate(1 + -r15.x);
                  r14.xyz = r14.xyz * r7.zzz;
                } else {
                  r15.yzw = float3(0.0399999991,0.0399999991,0.0399999991);
                }
                r7.z = 1 + -r11.w;
                r16.xyz = r13.xyz * r7.zzz;
                r13.xyz = r14.xyz * r11.www + r16.xyz;
                r14.xyz = r12.xyz * r7.zzz;
                r12.xyz = r15.yzw * r11.www + r14.xyz;
                r12.w = r12.w * r7.z + r11.w;
              }
            }
          }
        }
  ...
  r4.x = 0.5 * r4.x;
  r4.yz = floor(r2.xy);
  r4.yz = r4.yz / flowParams.xx;
  r4.yz = flowMap.Sample(flowSampler_s, r4.yz).xy;
  r4.yz = r4.yz + r4.yz;
  ...
  if (useSpecularZFeather != 0) {
    ...
    r4.w = dot(r6.zw, r6.xy);
    r4.w = sqrt(r4.w);
    r4.w = r4.w * normalsFlowScaleMin.y + normalsFlowScaleMin.x;
    r6.xy = normalAdjustAndGloss.xy * r4.ww;
  } else {
  ...
  if (useOrientedNormalMap == 0) {
    ...
    r6.zw = r4.yz * float2(-1,1) + float2(1,-1);
    r6.zw = r6.zw * r3.xx + r0.zw;
    r6.zw = normalMap.SampleLevel(normalSampler_s, r6.zw, r4.x).xy;
    r7.xy = r5.xy * float2(-1,1) + float2(1,-1);
    r7.xy = r7.xy * r3.xx + r0.zw;
    r7.xy = normalMap.SampleLevel(normalSampler_s, r7.xy, r4.x).xy;
    r7.xy = r7.xy + -r6.zw;
    r6.zw = r3.zz * r7.xy + r6.zw;
    r7.xy = r5.zw * float2(-1,1) + float2(1,-1);
    r7.xy = r7.xy * r3.xx + r0.zw;
    r7.xy = normalMap.SampleLevel(normalSampler_s, r7.xy, r4.x).xy;
    r7.zw = r2.xy * float2(-1,1) + float2(1,-1);
    r0.zw = r7.zw * r3.xx + r0.zw;
    r0.zw = normalMap.SampleLevel(normalSampler_s, r0.zw, r4.x).xy;
    r0.zw = r0.zw + -r7.xy;
    r0.zw = r3.zz * r0.zw + r7.xy;
    r0.zw = r0.zw + -r6.zw;
    r0.zw = r3.ww * r0.zw + r6.zw;
    r0.zw = r0.zw * r6.xx + r6.yy;
  } else {
    r3.xy = r4.yz * float2(-1,1) + float2(1,-1);
    r4.y = dot(r3.xy, r3.xy);
    r4.y = sqrt(r4.y);
    r4.y = max(9.99999975e-06, r4.y);
    r7.xy = r3.xy / r4.yy;
    r7.z = -r7.x;
    r3.x = dot(w1.xy, r7.yz);
    r3.y = dot(w1.xy, -r7.xy);
    r10.xy = normalMapScale.xy * r3.xy;
    r3.x = gameTime.w * r4.y;
    r10.z = -r3.x * flowParams.y + r10.y;
    r3.xy = normalMap.SampleLevel(normalSampler_s, r10.xz, r4.x).xy;
    r3.xy = r3.xy * r6.xx + r6.yy;
    r10.x = dot(r3.xy, r7.yz);
    r10.y = dot(r3.xy, -r7.xy);
    r3.xy = r5.xy * float2(-1,1) + float2(1,-1);
    r4.y = dot(r3.xy, r3.xy);
    r4.y = sqrt(r4.y);
    r4.y = max(9.99999975e-06, r4.y);
    r7.xy = r3.xy / r4.yy;
    ...
    r3.x = dot(w1.xy, r7.yz);
    r3.y = dot(w1.xy, -r7.xy);
    r11.xy = normalMapScale.xy * r3.xy;
    r3.x = gameTime.w * r4.y;
    r11.z = -r3.x * flowParams.y + r11.y;
    r3.xy = normalMap.SampleLevel(normalSampler_s, r11.xz, r4.x).xy;
    r3.xy = r3.xy * r6.xx + r6.yy;
    r5.x = dot(r3.xy, r7.yz);
    r5.y = dot(r3.xy, -r7.xy);
    r3.xy = r5.xy + -r10.xy;
    r3.xy = r3.zz * r3.xy + r10.xy;
    r4.yz = r5.zw * float2(-1,1) + float2(1,-1);
    r4.w = dot(r4.yz, r4.yz);
    r4.w = sqrt(r4.w);
    r4.w = max(9.99999975e-06, r4.w);
    r5.xy = r4.yz / r4.ww;
    r5.z = -r5.x;
    r7.x = dot(w1.xy, r5.yz);
    r7.y = dot(w1.xy, -r5.xy);
    r7.xy = normalMapScale.xy * r7.xy;
    r4.y = gameTime.w * r4.w;
    r7.z = -r4.y * flowParams.y + r7.y;
    r4.yz = normalMap.SampleLevel(normalSampler_s, r7.xz, r4.x).xy;
    r4.yz = r4.yz * r6.xx + r6.yy;
    r7.x = dot(r4.yz, r5.yz);
    r7.y = dot(r4.yz, -r5.xy);
    ...
    r5.xy = r2.xy / r4.yy;
    r5.z = -r5.x;
    r2.x = dot(w1.xy, r5.yz);
    r2.y = dot(w1.xy, -r5.xy);
    r10.xy = normalMapScale.xy * r2.xy;
    r2.x = gameTime.w * r4.y;
    r10.z = -r2.x * flowParams.y + r10.y;
    r2.xy = normalMap.SampleLevel(normalSampler_s, r10.xz, r4.x).xy;
    r2.xy = r2.xy * r6.xx + r6.yy;
    r4.x = dot(r2.xy, r5.yz);
    r4.y = dot(r2.xy, -r5.xy);
    r2.xy = r4.xy + -r7.xy;
    r2.xy = r3.zz * r2.xy + r7.xy;
    r2.xy = r2.xy + -r3.xy;
  ...
  if (useFoam != 0) {
    r5.x = foamBase.Sample(foamSampler_s, v7.xy).x;
    r5.y = foamBase.Sample(foamSampler_s, v7.zw).x;
    r5.z = foamBase.Sample(foamSampler_s, v8.xy).x;
    r5.w = foamBase.Sample(foamSampler_s, v8.zw).x;
    r5.x = r5.x + r5.y;
    r5.x = r5.x + r5.z;
    r5.x = r5.x + r5.w;
    r5.x = foamColorScale * r5.x;
    r5.y = flowMap.Sample(flowSampler_s, w1.xy).z;
    r5.y = foamSpacing.y * r5.y + foamSpacing.x;
    r5.x = max(0, r5.x);
    r5.x = log2(r5.x);
    r5.x = r5.y * r5.x;
    r5.x = exp2(r5.x);
    r5.y = foamZFeather * r0.w;
    r5.y = min(1, r5.y);
    r5.z = r5.x * r5.y;
    r5.x = -r5.x * r5.y + 1;
    r5.x = normalAdjustAndGloss.z * r5.x;
  } else {
    r5.z = 0;
    r5.x = normalAdjustAndGloss.z;
  }
  r5.y = dot(-v6.xyz, -v6.xyz);
  r5.y = rsqrt(r5.y);
  r6.xyz = -v6.xyz * r5.yyy;
  r7.xy = (uint2)r1.xy;
  ...
  r7.z = 100 * r7.z;
  r10.yz = -r6.ww * float2(10,5) + float2(6.85740995,7.08500004);
  r7.w = exp2(r10.y);
  r7.w = r7.w * r5.w;
  r7.w = 9.1368103 * r7.w;
  r9.w = r7.y * r6.w;
  r9.w = -r9.w * 2.0159049 + r10.z;
  r9.w = exp2(r9.w);
  r9.w = r9.w * r5.w;
  ...
  r13.w = r10.y;
  while (true) {
    r15.w = cmp((uint)r13.w >= numRefProbes);
    if (r15.w != 0) break;
    r13.z = (uint)r13.w >> 5;
    r14.xyz = (int3)r12.xyz + (int3)r13.xyz;
    r13.z = visibleProbes.Load(r14.xyzw).x;
    r14.x = cmp((int)r10.y == (int)r13.w);
    bitmask.y = ((~(-1 << r10.z)) << 0) & 0xffffffff;  r14.y = (((uint)0 << 0) & bitmask.y) | ((uint)r13.z & ~bitmask.y);
    r13.z = r14.x ? r14.y : r13.z;
    r14.x = cmp((int)r10.w == (int)r13.w);
      ...
      r24.y = samp0[]..swiz;
        ...
        r32.w = samp0[]..swiz;
          ...
          r33.w = samp0[]..swiz;
            ...
            r18.w = -r18.w * r23.w + 1;
            r18.w = r27.y * r18.w;
            r4.y = r27.w ? r18.w : r28.x;
            r27.xy = r27.zz ? r27.xy : r4.xy;
            r17.w = (int)r17.w + 1;
            r15.x = r26.w;
          }
          ...
          r38.y = samp0[]..swiz;
            ...
            r24.xyz = r11.xyz * r14.zzz + r24.xyz;
            r15.x = dot(r24.xyz, r24.xyz);
            r15.x = sqrt(r15.x);
            r14.z = r14.z / r15.x;
            r14.z = r14.z + r14.z;
            r14.z = sqrt(r14.z);
            ...
            r33.w = (uint)r15.x;
            r24.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r33.xyzw, r14.z).xyz;
  ...
  if (r4.x != 0) {
    ...
    while (true) {
      ...
      r14.xyz = (int3)r12.xyz + (int3)r13.xyz;
      r13.z = visibleProbes.Load(r14.xyzw).x;
      r13.w = cmp((int)r10.y == (int)r12.w);
      if (r10.z == 0) r14.x = 0; else if (r10.z+0 < 32) {       r14.x = (uint)r13.z << (32-(r10.z + 0)); r14.x = (uint)r14.x >> (32-r10.z);      } else r14.x = (uint)r13.z >> 0;
      ...
      while (true) {
        ...
        r25.y = samp0[]..swiz;
          ...
          r26.w = samp0[]..swiz;
            ...
            if (6 == 0) r22.w = 0; else if (6+25 < 32) {             r22.w = (uint)r26.w << (32-(6 + 25)); r22.w = (uint)r22.w >> (32-6);            } else r22.w = (uint)r26.w >> 25;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r28.xyzw, r18.w, l(0), t16.xyzw
          r28.x = samp0[]..swiz;
          r28.y = samp0[]..swiz;
          ...
          r33.w = samp0[]..swiz;
            ...
            r25.z = dot(r29.xyz, r27.xyz);
            r25.z = saturate(r25.z + r29.w);
            r24.w = r25.z * r24.w;
            r25.z = dot(r30.xyz, r27.xyz);
            r25.z = saturate(r25.z + r30.w);
            r24.w = r25.z * r24.w;
            r25.z = dot(r31.xyz, r27.xyz);
            r25.z = saturate(r25.z + r31.w);
            r24.w = r25.z * r24.w;
            r25.z = dot(r32.xyz, r27.xyz);
            r25.z = saturate(r25.z + r32.w);
            r24.w = r25.z * r24.w;
            r25.z = dot(r33.xyz, r27.xyz);
            r25.z = saturate(r25.z + r33.w);
            r15.x = r25.z * r24.w;
            r24.w = (int)r25.x & 1;
            r25.zw = r24.ww ? r15.xy : r15.zx;
            r15.x = r25.x;
            r28.xy = r25.zw;
            r24.w = 1;
            while (true) {
              r27.w = cmp((int)r24.w >= (int)r22.w);
              if (r27.w != 0) break;
              r27.w = (int)r18.w + (int)r24.w;
            // Known bad code for instruction (needs manual fix):
            ...
            r34.w = samp0[]..swiz;
              ...
              r27.w = r28.x * r27.w;
              r28.z = dot(r30.xyz, r27.xyz);
              r28.z = saturate(r28.z + r30.w);
              r27.w = r28.z * r27.w;
              ...
              r28.x = r28.z * r27.w;
              r28.w = (uint)r15.x >> 2;
              if (1 == 0) r29.x = 0; else if (1+2 < 32) {               r29.x = (uint)r15.x << (32-(1 + 2)); r29.x = (uint)r29.x >> (32-1);              } else r29.x = (uint)r15.x >> 2;
              r29.y = (int)r28.w & 2;
              r29.z = max(r28.y, r28.x);
              r27.w = -r27.w * r28.z + 1;
              r27.w = r28.y * r27.w;
              r4.y = r29.y ? r27.w : r29.z;
              r28.xy = r29.xx ? r28.xy : r4.xy;
              r24.w = (int)r24.w + 1;
              r15.x = r28.w;
            }
            r4.y = saturate(r28.y + -r15.w);
            r15.x = r4.y * r25.y;
            r18.w = cmp(0 < r15.x);
            if (r18.w != 0) {
            // Known bad code for instruction (needs manual fix):
            ...
            r39.y = samp0[]..swiz;
              ...
              r34.z = r35.z;
              r17.w = dot(r11.xyz, r34.xyz);
              r18.w = dot(r27.xyz, r34.xyz);
              r18.w = r18.w + -r35.w;
              r22.w = cmp(r18.w >= 0);
              r18.w = max(abs(r18.w), r7.z);
              r18.w = r22.w ? r18.w : -r18.w;
              r17.w = max(1.00000001e-07, -r17.w);
              r17.w = r18.w / r17.w;
              r15.x = min(abs(r17.w), r15.x);
              r35.z = r36.z;
              r17.w = dot(r11.xyz, r35.xyz);
              r18.w = dot(r27.xyz, r35.xyz);
              r18.w = r18.w + -r36.w;
              r22.w = cmp(r18.w >= 0);
              r18.w = max(abs(r18.w), r7.z);
              r18.w = r22.w ? r18.w : -r18.w;
              ...
              r15.x = min(abs(r17.w), r15.x);
              r36.z = r37.z;
              r17.w = dot(r11.xyz, r36.xyz);
              r18.w = dot(r27.xyz, r36.xyz);
              r18.w = r18.w + -r37.w;
              r22.w = cmp(r18.w >= 0);
              r18.w = max(abs(r18.w), r7.z);
              r18.w = r22.w ? r18.w : -r18.w;
              ...
              r15.x = min(abs(r17.w), r15.x);
              r39.zw = r38.zw;
              r17.w = dot(r11.zxy, r39.xzw);
              r18.w = dot(r27.zxy, r39.xzw);
              r18.w = r18.w + -r39.y;
              r22.w = cmp(r18.w >= 0);
              r18.w = max(abs(r18.w), r7.z);
              r18.w = r22.w ? r18.w : -r18.w;
  ...
  r10.yzw = r19.xyz * r4.xxx;
  r12.xyz = r20.xyz * r4.xxx;
  r4.y = cmp(r20.w < 0.99000001);
  if (r4.y != 0) {
    r4.y = 1 + -r20.w;
    r6.w = sunConstants.globalProbeExposure * r4.y;
    ...
    r10.yzw = r19.xyz * r4.xxx + r13.xyz;
    r11.w = 0;
    r7.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r11.xyzw, r7.y).xyz;
    r4.x = sunConstants.globalProbeExposure * r4.y + -r2.w;
    r2.w = r5.x * r4.x + r2.w;
    r12.xyz = r7.yzw * r2.www + r12.xyz;
  }
  if (useSSR != 0) {
    r2.w = dot(r3.xyz, r2.xyz);
    r2.w = r2.w + r2.w;
    r7.yzw = r2.xyz * -r2.www + r3.xyz;
    r2.w = dot(r3.xyz, -r2.xyz);
    r2.w = r2.w + r2.w;
    r11.xyz = r2.xyz * r2.www + r3.xyz;
    r7.yzw = v9.xxx ? r7.yzw : r11.xyz;
    if (useLoopedSSR != 0) {
      r11.xyz = viewMatrix._m10_m11_m12 * v6.yyy;
      r11.xyz = v6.xxx * viewMatrix._m00_m01_m02 + r11.xyz;
      r11.xyz = v6.zzz * viewMatrix._m20_m21_m22 + r11.xyz;
      r13.xyz = ssrParams.zzz * r7.yzw;
      ...
      r11.xyz = r13.xyz * float3(10,10,10) + r11.xyz;
      ...
      while (true) {
        ...
        r4.y = ifloatZSceneDownsampled.SampleLevel(bilinearClamp_s, r16.xy, 1).x;
        r5.x = cmp(abs(r4.y) < r15.z);
        r6.w = cmp(abs(r4.y) >= v0.w);
        r5.x = r5.x ? r6.w : 0;
        if (r5.x != 0) {
          r4.y = r15.z + -abs(r4.y);
          r4.y = ssrParams.w * r4.y;
          r16.xyz = -r4.yyy * r13.xyz + r15.xyz;
      ...
      r11.xyz = viewProjectionMatrix._m10_m11_m13 * r7.zzz;
      r11.xyz = r7.yyy * viewProjectionMatrix._m00_m01_m03 + r11.xyz;
      r7.yzw = r7.www * viewProjectionMatrix._m20_m21_m23 + r11.xyz;
      r7.yzw = viewProjectionMatrix._m30_m31_m33 + r7.yzw;
      r4.xy = r7.yz / r7.ww;
      r2.w = max(abs(r4.x), abs(r4.y));
      r4.xy = r4.xy * float2(0.5,-0.5) + float2(0.5,0.5);
      r5.x = ifloatZSceneDownsampled.SampleLevel(bilinearClamp_s, r4.xy, 0).x;
      r5.x = cmp(abs(r5.x) >= v0.w);
      r2.w = cmp(r2.w < 1);
      r2.w = r2.w ? r5.x : 0;
      r7.yzw = iResolveScene.Sample(bilinearClamp_s, r4.xy).xyz;
      if (r2.w != 0) {
        r12.xyz = relHDRExposure.xxx * r7.yzw;
      }
    }
  }
  ...
  if (r4.y == 0) {
    ...
    r4.y = -sunConstants.splitDepthOffset + r7.w;
    ...
    if (r6.w != 0) {
      ...
      while (true) {
        ...
        if (r11.x != 0) break;
        r11.x = (uint)r6.w;
        r11.yz = -sunConstants.splitPinTransform[r11.x].xy + r7.yz;
        r11.y = max(abs(r11.y), abs(r11.z));
        r9.w = sunConstants.splitPinTransform[r11.x].z * r11.y;
        r11.x = cmp(r9.w < 1);
        if (r11.x != 0) {
          break;
        }
    ...
    if (r11.x != 0) {
      ...
      r13.xz = rcp(r11.yy);
      r13.y = -r13.z;
      r11.yzw = r7.yzy * r13.xyz + r11.zwz;
      ...
      r11.yzw = min(r11.yzw, r13.xyz);
      r13.xy = sunConstants.sstLightingConstants.coordScale * r11.wz;
      r13.xy = floor(r13.xy);
      r12.w = sunConstants.sstLightingConstants.constants.dimensionInTiles.x * r13.y;
      r12.w = r12.w * sunConstants.sstLightingConstants.coordScale + r13.x;
      r12.w = (uint)r12.w;
    ...
    r13.x = samp0[]..swiz;
      r13.y = (int)r13.x & 0x40000000;
      r13.z = (uint)r13.x << 2;
      if (r13.y == 0) {
        r13.y = (int)r13.x & 0x01ffffff;
        r14.x = (int)r12.w + (int)r13.y;
        r12.w = (uint)r13.x >> 25;
        r12.w = (uint)r12.w;
      ...
      r13.w = samp0[]..swiz;
        r13.y = r13.y ? r14.z : r13.w;
        r13.w = (uint)r13.y >> 13;
        r13.x = r13.x ? r13.w : r13.y;
      ...
      r15.z = samp0[]..swiz;
        r14.y = 0;
        r15.y = 1;
        r13.xyw = r12.www ? r14.xyz : r15.xyz;
      ...
      r15.y = samp0[]..swiz;
        r15.y = r16.y ? r13.w : r15.y;
        r16.y = (uint)r15.y >> 13;
        r15.y = r16.x ? r16.y : r15.y;
        r15.y = (int)r15.y & 8191;
        r15.x = (int)r13.x + (int)r15.y;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r15.w, r15.x, l(0), t23.xxxx
      r15.w = samp0[]..swiz;
        r13.xyw = r14.www ? r13.xyw : r15.xzw;
        r13.xyw = r12.www ? r14.xyz : r13.xyw;
        r12.w = (int)r13.w & 0xc0000000;
        if (r12.w == 0) {
          r12.w = (int)-r13.y + 6;
          r14.xy = (uint2)r11.wz >> (uint2)r12.ww;
          ...
          r14.x = (int)r14.x * 10;
          r12.w = (uint)r12.w >> (uint)r14.x;
          r12.w = (int)r12.w & 1023;
          r14.x = (int)r12.w + (int)r13.x;
        // Known bad code for instruction (needs manual fix):
        ...
        r14.w = samp0[]..swiz;
          ...
          r12.w = (int)-r14.y + 6;
          r15.xy = (uint2)r11.wz >> (uint2)r12.ww;
          r12.w = (int)r14.w & 0xc0000000;
          r13.y = (int)r14.w | 0x40000000;
        ...
        r15.z = samp0[]..swiz;
          ...
          r13.y = (int)-r15.y + 6;
          r14.yz = (uint2)r11.wz >> (uint2)r13.yy;
          r13.y = (int)r15.z & 0xc0000000;
          r15.y = (int)r15.z | 0x40000000;
        ...
        r16.y = samp0[]..swiz;
          r14.yz = r13.yy ? r15.xz : r16.xy;
          r13.xw = r12.ww ? r14.xw : r14.yz;
        }
        r12.w = (int)r13.w & 0xc0000000;
        if (r12.w == 0) {
          if (14 == 0) r13.y = 0; else if (14+15 < 32) {           r13.y = (uint)r13.w << (32-(14 + 15)); r13.y = (uint)r13.y >> (32-14);          } else r13.y = (uint)r13.w >> 15;
          r13.y = (uint)r13.y;
          r13.y = sunConstants.sstLightingConstants.constants.spanInInches * r13.y;
          r13.y = 6.10388815e-05 * r13.y;
          r14.xy = (int2)r13.ww & int2(32767,536870912);
          r14.x = (uint)r14.x;
          r14.x = sunConstants.sstLightingConstants.constants.spanInInches * r14.x;
          r14.x = 3.05185094e-05 * r14.x;
          r14.z = (int)r11.z & 3;
          r14.z = (int)r13.x + (int)r14.z;
          r14.z = (int)r14.z + 1;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r14.z, r14.z, l(0), t23.xxxx
        r14.z = samp0[]..swiz;
          bitmask.x = ((~(-1 << 2)) << 3) & 0xffffffff;  r15.x = (((uint)r11.y << 3) & bitmask.x) | ((uint)0 & ~bitmask.x);
          bitmask.y = ((~(-1 << 2)) << 1) & 0xffffffff;  r15.y = (((uint)r11.z << 1) & bitmask.y) | ((uint)0 & ~bitmask.y);
          bitmask.z = ((~(-1 << 1)) << 4) & 0xffffffff;  r15.z = (((uint)r11.w << 4) & bitmask.z) | ((uint)0 & ~bitmask.z);
          r11.y = (uint)r14.z >> (uint)r15.x;
          r11.y = (int)r11.y & 255;
          r11.y = (uint)r11.y;
          r11.y = r11.y * r14.x;
          r11.y = r11.y * 0.00392156886 + r13.y;
          r11.z = (int)r15.y + 1;
          ...
          r11.z = (int)r11.z + (int)r13.x;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r11.z, r11.z, l(0), t23.xxxx
        r11.z = samp0[]..swiz;
          r11.z = (uint)r11.z >> (uint)r15.z;
          r11.z = (int)r11.z & 0x0000ffff;
          r11.z = (uint)r11.z;
          r11.z = r11.z * r14.x;
          r11.z = r11.z * 1.52590219e-05 + r13.y;
          r13.z = r14.y ? r11.y : r11.z;
        } else {
          r11.y = (int)r13.w & 0x80000000;
          r11.z = (int)r13.x + 1;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r11.z, r11.z, l(0), t23.xxxx
        r11.z = samp0[]..swiz;
    ...
    if (r11.x == 0) {
      if (enableDitheredShadow == 0) {
        r7.w = (uint)r6.w;
        r11.xy = -sunConstants.splitPinTransform[r7.w].xy + r7.yz;
        r11.xy = sunConstants.splitPinTransform[r7.w].zz * r11.xy;
        r11.xy = r11.xy * float2(0.5,-0.5) + float2(0.5,0.5);
        r7.w = (int16)sunConstants.splitArrayOffset;
        r11.z = r7.w + r6.w;
        r7.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r11.xyz, r4.y).x;
      ...
      if (enableDitheredShadow != 0) {
        ...
        r9.w = 28 * r9.w;
        r9.w = (uint)r9.w;
        r13.xy = -sunConstants.splitPinTransform[r7.w].xy + r7.yz;
        ...
        r12.w = 0;
        while (true) {
          r13.z = cmp((uint)r12.w >= 8);
          if (r13.z != 0) break;
          r13.z = cmp((uint)r9.w < (uint)r12.w);
          r14.xy = r13.zz ? r7.yz : r13.xy;
          r13.w = r13.z ? sunConstants.splitPinTransform[r6.w].w : sunConstants.splitPinTransform[r7.w].w;
          r13.z = r13.z ? r6.w : r7.w;
          r15.x = dot(icb[r12.w+0].yx, r11.xy);
          r15.y = dot(icb[r12.w+0].yx, r11.yz);
          r14.xy = r15.xy * r13.ww + r14.xy;
          r13.z = (int)r13.z + (int16)sunConstants.splitArrayOffset;
          r14.z = (uint)r13.z;
          r13.z = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r14.xyz, r4.y).x;
          r13.w = gTransShadowmapArray.SampleLevel(samp0_s, r14.xyz, 0).x;
          r13.z = r13.z + r13.w;
          r13.z = saturate(-1 + r13.z);
          r11.w = r13.z * 0.125 + r11.w;
          r12.w = (int)r12.w + 1;
        }
        r4.y = r11.w * r11.w;
        r5.x = r4.y * r11.w;
  ...
  if (r6.w != 0) {
    ...
    r4.y = (int)r4.y + -1;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r6.w, r4.y, l(52), t12.xxxx
  r6.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r11.xyzw, r4.y, l(68), t12.xyzw
  r11.x = samp0[]..swiz;
  r11.y = samp0[]..swiz;
  r11.z = samp0[]..swiz;
  r11.w = samp0[]..swiz;
  ...
  r17.w = samp0[]..swiz;
    ...
    r18.xyz = r2.xyz * r2.www + v6.xyz;
    r18.w = 1;
    r11.x = dot(r11.xyzw, r18.xyzw);
    r11.y = dot(r13.xyzw, r18.xyzw);
    r2.w = dot(r14.xyzw, r18.xyzw);
    r7.y = dot(r15.xyzw, r18.xyzw);
    r7.z = cmp(r7.y < r2.w);
    r11.xy = r11.xy / r7.yy;
    r11.xy = r11.xy * float2(0.5,-0.5) + float2(0.5,0.5);
    r11.xy = r11.xy + r17.zw;
    r11.xy = r11.xy * r17.xy;
    r11.zw = r6.ww / r16.xz;
    r13.xy = float2(1,1) + -r11.zw;
    r13.xy = cmp(r11.xy >= r13.xy);
    r11.zw = cmp(r11.zw >= r11.xy);
    r11.zw = (int2)r11.zw | (int2)r13.xy;
    r7.w = (int)r11.w | (int)r11.z;
    r7.z = (int)r7.z | (int)r7.w;
    if (r7.z == 0) {
    // Known bad code for instruction (needs manual fix):
        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r7.z, r4.y, l(28), t12.xxxx
    r7.z = samp0[]..swiz;
    // Known bad code for instruction (needs manual fix):
        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r11.zw, r4.y, l(164), t12.xxxy
    r11.z = samp0[]..swiz;
    r11.w = samp0[]..swiz;
      r11.xy = saturate(r11.xy);
      r13.xy = r11.xy * r16.xz + r16.yw;
      r4.y = r11.w * r7.y;
      r2.w = r11.z * r7.y + r2.w;
      r2.w = r2.w / r4.y;
      r2.w = max(6.10351563e-05, r2.w);
      r4.y = r7.z ? 0.000000 : 0;
      if (enableDitheredShadow != 0) {
        r11.x = -r7.x;
        r14.z = (uint)r4.y;
        r11.y = r10.x;
        ...
        while (true) {
          r7.z = cmp((int)r7.y >= 8);
          if (r7.z != 0) break;
          r15.x = dot(icb[r7.y+0].yx, r11.xy);
          r15.y = dot(icb[r7.y+0].yx, r11.yz);
          r14.xy = r15.xy * r6.ww + r13.xy;
          r7.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r14.xyz, r2.w).x;
          r7.x = r7.z * 0.125 + r7.x;
          r7.y = (int)r7.y + 1;
        }
      } else {
        r13.z = (uint)r4.y;
        r7.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r13.xyz, r2.w).x;
      }
      r2.w = r7.x * r7.x;
      r2.w = r2.w * r7.x;
    } else {
  ...
  if (r4.y != 0) {
    if (sunConstants.sunCookieIndex != 0) {
      ...
      r7.w = 1;
      r4.y = dot(sunConstants.sunCookieTransform[0].xyzw, r7.xyzw);
      r6.w = dot(sunConstants.sunCookieTransform[1].xyzw, r7.xyzw);
      r7.x = frac(r4.y);
      r7.y = frac(r6.w);
    ...
    r4.y = r5.w + r4.x;
    r4.y = r4.x / r4.y;
    r11.xyz = r7.xyz * r4.yyy + r10.yzw;
    r5.xyw = -v6.xyz * r5.yyy + sunConstants.wldDir.xyz;
    r4.y = dot(r5.xyw, r5.xyw);
    r4.y = rsqrt(r4.y);
    r5.xyw = r5.xyw * r4.yyy;
    r4.y = saturate(dot(r2.xyz, r5.xyw));
    r5.x = saturate(dot(r5.xyw, r6.xyz));
    r5.y = r4.y * r4.y;
    r5.yw = r5.yy * specularLobeRoughnessControl.xz + float2(1,1);
    r5.yw = r5.yw * r5.yw;
    r5.yw = specularLobeRoughnessControl.yw / r5.yw;
    r5.yw = r5.yw * r4.yy;
    r4.y = 4 * r5.x;
    r5.xy = r5.yw / r4.yy;
    r5.xy = lobeWeightingThicknessRefraction.xy * r5.xy;
    r6.xyz = r7.xyz * r5.xxx;
    r6.xyz = r6.xyz * r4.xxx + r12.xyz;
    r5.xyw = r7.xyz * r5.yyy;
    r5.xyw = r5.xyw * r4.xxx + r6.xyz;
  } else {
    r11.xyz = r10.yzw;
    r5.xyw = r12.xyz;
  }
  r6.xyz = r2.www ? r11.xyz : r10.yzw;
  r5.xyw = r2.www ? r5.xyw : r12.xyz;
  ...
  r2.xyz = r3.www * r2.xyz + r4.xyw;
  r4.xyw = r9.xyz * r6.xyz + -r2.xyz;
  r2.xyz = r8.www * r4.xyw + r2.xyz;
  r0.xyw = r5.xyw * r0.yyy + r8.xyz;
  r2.w = 1 + -r4.z;
  r3.w = r2.w * r2.w;
  r3.w = r3.w * r3.w;
  r2.w = r3.w * r2.w;
  ...
  if (r2.x != 0) {
    ...
    if (r2.y != 0) {
      ...
      r2.yzw = fogConstants.blendAmount * r2.yzw + r4.xyz;
    } else {
      r3.w = r2.x * fogConstants.atmospherefogdistancedensityscale.x + fogConstants.atmospherefogdistanceoffset.x;
      r3.w = fogConstants.atmospherefogdensityatcamera.x * r3.w;
      ...
      r4.y = r4.y * r3.w;
      r3.w = r4.x ? r4.y : r3.w;
      r4.xyz = fogConstants.atmosphereTotalDensity.xyz * r3.www;
      r2.yzw = exp2(r4.xyz);
    }
    ...
    r3.w = dot(fogConstants.wldSunFogDir.xyz, -r3.xyz);
    r4.x = -fogConstants.atmosphereMieSchlickK * fogConstants.atmosphereMieSchlickK + 1;
    r4.y = fogConstants.atmosphereMieSchlickK * -r3.w + 1;
    r4.y = r4.y * r4.y;
    r4.y = 12.566371 * r4.y;
    r4.x = r4.x / r4.y;
    ...
    r3.w = saturate(r3.w);
    r3.w = r3.w * r3.w + 1;
    r3.w = r3.w * 0.0596831031 + -1;
    r3.w = fogConstants.atmospheresunstrength * r3.w + 1;
    r4.xyz = fogConstants.atmosphereMieDensity.xyz * r2.xxx;
    r4.xyz = r3.www * fogConstants.atmosphereRayleighDensity.xyz + r4.xyz;
    r4.xyz = fogConstants.atmosphereInScatterIntensity * r4.xyz;
    r5.xyz = float3(1,1,1) + -r2.yzw;
    r4.xyz = r5.xyz * r4.xyz;
    r2.xyz = r0.xyw * r2.yzw + r4.xyz;
  } else {
    r2.w = fogConstants.heightFalloff * v6.z;
    r3.w = fogConstants.heightFalloff * v6.z + fogConstants.K0;
    r4.x = cmp(abs(r2.w) < 9.99999975e-05);
    r4.y = min(64, r3.w);
