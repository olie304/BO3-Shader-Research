...
r1.w = gpuSkinBase[]..swiz;
  ...
  r3.x = dot(r0.xy, r2.xy);
  r3.y = dot(r0.xy, skyRotationTransition.xy);
  r0.x = cmp(skyRotationTransition.z < 0);
  r3.z = r0.x ? -r0.z : r0.z;
  r0.xyz = eyeOffset.xyz + -skyBoxCenter.xyz;
  r0.xyz = r0.xyz / abs(skyRotationTransition.zzz);
  r2.x = dot(r0.xy, r2.xy);
  r2.y = dot(r0.xy, skyRotationTransition.xy);
  r2.z = r0.z;
