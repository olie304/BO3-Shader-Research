...
uge r15.z, r0.x, r15.y
ult r15.w, r0.x, cb2[0].y
and r15.z, r15.w, r15.z
if_nz r15.z
  imul null, r15.z, r0.x, l(14)
  if_nz r6.w
    add r16.yzw, cb1[24].xxyz, cb10[r15.z + 0].xxyz
    mov r16.x, l(16)
    store_structured u2.xyzw, cb2[52].x, l(880), r16.xyzw
  endif 
  add r16.xyz, r5.xyzx, -cb10[r15.z + 0].xyzx
  and r15.w, l(0x0000ffff), cb10[r15.z + 7].z
  ubfe r16.w, l(6), l(25), cb10[r15.z + 7].z
  ...
  endloop 
  mov_sat r19.y, r19.y
  mul r15.w, r19.y, cb10[r15.z + 6].y
  ...
  if_nz r16.w
    ...
    div r17.y, r17.z, r17.y
    min r17.x, |r17.y|, r17.x
    mov r18.x, cb10[r15.z + 10].w
    mov r18.yz, cb10[r15.z + 11].xxyx
    dp3 r17.y, r14.xyzx, r18.xyzx
    dp3 r17.z, r16.xyzx, r18.xyzx
    add r17.z, r17.z, -cb10[r15.z + 11].z
    ge r17.w, r17.z, l(0.000000)
    max r17.z, r12.w, |r17.z|
    movc r17.z, r17.w, r17.z, -r17.z
    max r17.y, -r17.y, l(0.00000010)
    div r17.y, r17.z, r17.y
    min r17.x, |r17.y|, r17.x
    mov r18.x, cb10[r15.z + 11].w
    mov r18.yz, cb10[r15.z + 12].xxyx
    dp3 r17.y, r14.xyzx, r18.xyzx
    dp3 r17.z, r16.xyzx, r18.xyzx
    add r17.z, r17.z, -cb10[r15.z + 12].z
    ge r17.w, r17.z, l(0.000000)
    max r17.z, r12.w, |r17.z|
    movc r17.z, r17.w, r17.z, -r17.z
    max r17.y, -r17.y, l(0.00000010)
    div r17.y, r17.z, r17.y
    min r17.x, |r17.y|, r17.x
    mov r18.x, cb10[r15.z + 12].w
    mov r18.yz, cb10[r15.z + 13].xxyx
    dp3 r17.y, r14.xyzx, r18.xyzx
    dp3 r17.z, r16.xyzx, r18.xyzx
    add r17.z, r17.z, -cb10[r15.z + 13].z
    ge r17.w, r17.z, l(0.000000)
    max r17.z, r12.w, |r17.z|
    movc r17.z, r17.w, r17.z, -r17.z
    max r17.y, -r17.y, l(0.00000010)
    div r17.y, r17.z, r17.y
    min r17.x, |r17.y|, r17.x
    add r18.x, r16.x, cb10[r15.z + 3].w
    add r18.yz, r16.yyzy, cb10[r15.z + 4].xxyx
    mad r17.yzw, r14.xxyz, r17.xxxx, r18.xxyz
    ...
    mov r18.x, cb10[r15.z + 0].w
    mov r18.y, cb10[r15.z + 1].z
    mov r18.z, cb10[r15.z + 2].y
    dp3 r19.x, r17.yzwy, r18.xyzx
    mov r20.xy, cb10[r15.z + 1].xwxx
    mov r20.z, cb10[r15.z + 2].z
    dp3 r19.y, r17.yzwy, r20.xyzx
    mov r21.x, cb10[r15.z + 1].y
    mov r21.yz, cb10[r15.z + 2].xxwx
    dp3 r19.z, r17.yzwy, r21.xyzx
    ubfe r17.y, l(9), l(16), cb10[r15.z + 7].z
    utof r19.w, r17.y
    ...
    mad_sat r16.xyz, r22.xyzx, cb10[r15.z + 3].xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
    mul r22.xy, r16.xyxx, cb10[r15.z + 4].zwzz
    mul r22.z, r16.z, cb10[r15.z + 5].x
    add r16.xyz, r22.xyzx, cb10[r15.z + 5].yzwy
    ...
    mul r17.w, r15.z, r15.x
    mul r17.xyz, r16.wwww, r17.xyzx
    dp3 r16.w, r17.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
    mad r15.z, r15.x, r15.z, r16.w
...
if_nz r15.y
  ...
  if_nz r6.w
    ...
    mov r18.x, l(16)
    store_structured u2.xyzw, cb2[52].x, r15.y, r18.xyzw
  endif 
  ...
  mov r18.w, cb10[r0.x + 6].x
  mov r21.xy, r19.xyxx
  mov r19.z, l(1)
  loop 
    ige r19.w, r19.z, r17.w
    breakc_nz r19.w
    iadd r19.w, r16.w, r19.z
    ...
    mov r18.w, r20.w
  endloop 
  add_sat r16.w, -r15.w, r21.y
  mul r17.w, r16.w, cb10[r0.x + 6].y
  lt r18.w, l(0.000000), r17.w
  if_nz r18.w
    and r18.w, r15.y, l(3)
    iadd r19.x, r18.w, l(-1)
    ult r19.x, r19.x, l(32)
    and r19.x, r6.w, r19.x
    if_nz r19.x
      imad r19.xy, r18.wwww, l(20, 20, 0, 0), l(860, 876, 0, 0)
      ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r18.w, cb2[52].x, r19.x, u2.xxxx
      or r18.w, r18.w, l(32)
      store_structured u2.x, cb2[52].x, r19.x, r18.w
    ...
    mov r19.x, cb10[r0.x + 7].w
    mov r19.yz, cb10[r0.x + 8].xxyx
    dp3 r18.w, r14.xyzx, r19.xyzx
    dp3 r19.x, r18.xyzx, r19.xyzx
    add r19.x, r19.x, -cb10[r0.x + 8].z
    ge r19.y, r19.x, l(0.000000)
    max r19.x, r12.w, |r19.x|
    ...
    dp3 r19.w, r14.xyzx, r19.xyzx
    dp3 r19.x, r18.xyzx, r19.xyzx
    add r19.x, r19.x, -cb10[r0.x + 9].z
    ge r19.y, r19.x, l(0.000000)
    max r19.x, r12.w, |r19.x|
    movc r19.x, r19.y, r19.x, -r19.x
    ...
    dp3 r19.w, r14.xyzx, r19.xyzx
    dp3 r19.x, r18.xyzx, r19.xyzx
    add r19.x, r19.x, -cb10[r0.x + 10].z
    ge r19.y, r19.x, l(0.000000)
    max r19.x, r12.w, |r19.x|
    movc r19.x, r19.y, r19.x, -r19.x
    max r19.y, -r19.w, l(0.00000010)
    ...
    dp3 r19.w, r14.xyzx, r19.xyzx
    dp3 r19.x, r18.xyzx, r19.xyzx
    add r19.x, r19.x, -cb10[r0.x + 11].z
    ge r19.y, r19.x, l(0.000000)
    max r19.x, r12.w, |r19.x|
    movc r19.x, r19.y, r19.x, -r19.x
    max r19.y, -r19.w, l(0.00000010)
    ...
    dp3 r19.w, r14.xyzx, r19.xyzx
    dp3 r19.x, r18.xyzx, r19.xyzx
    add r19.x, r19.x, -cb10[r0.x + 12].z
    ge r19.y, r19.x, l(0.000000)
    max r19.x, r12.w, |r19.x|
    movc r19.x, r19.y, r19.x, -r19.x
    max r19.y, -r19.w, l(0.00000010)
    ...
    dp3 r19.w, r14.xyzx, r19.xyzx
    dp3 r19.x, r18.xyzx, r19.xyzx
    add r19.x, r19.x, -cb10[r0.x + 13].z
    ge r19.y, r19.x, l(0.000000)
    max r12.w, r12.w, |r19.x|
    movc r12.w, r19.y, r12.w, -r12.w
    max r19.x, -r19.w, l(0.00000010)
    div r12.w, r12.w, r19.x
    min r12.w, |r12.w|, r18.w
    add r19.x, r18.x, cb10[r0.x + 3].w
    add r19.yz, r18.yyzy, cb10[r0.x + 4].xxyx
    mad r19.xyz, r14.xyzx, r12.wwww, r19.xyzx
...
bfi r8.w, l(8), l(0), r15.y, r15.z
movc r0.x, r0.x, r8.w, r15.y
max r8.w, r16.w, l(1.000000)
rcp r8.w, r8.w
mov_sat r16.w, r16.w
mul r15.xyz, r8.wwww, r16.xyzx
...
if_nz r12.w
  ...
  mad r15.xyz, r16.xyzx, r8.wwww, r18.xyzx
  mov r14.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r16.xyz, r14.xyzw, t8.xyzw, s2, r10.w
  mad r8.w, cb2[19].x, r12.w, -r11.w
  mad r8.w, r2.y, r8.w, r11.w
  mad r17.xyz, r16.xyzx, r8.wwww, r17.xyzx
endif 
...
if_nz r3.z
  ...
  if_nz r3.z
    mul r3.z, r2.w, cb2[18].w
    mul r3.z, r7.w, r3.z
    if_nz cb2[23].x
      add r16.xyz, r5.xyzx, cb1[24].xyzx
      mov r16.w, l(1.000000)
      dp4 r4.z, cb2[24].xyzw, r16.xyzw
    ...
    if_nz r8.w
      ...
      mad r18.xyz, r11.xyzx, r8.wwww, r5.xyzx
      ...
      if_z r8.w
        ...
        if_nz cb2[58].y
          ...
          loop 
            ...
            sample_c_lz_indexable(texture2darray)(float,float,float,float) r14.w, r20.xyzx, t9.xxxx, s13, r8.w
    ...
    mad r19.xyz, r3.zzzz, r16.xyzx, r13.yzwy
    add_sat r2.z, -r2.z, l(1.000000)
    mul r4.z, r2.z, r2.z
    mul r4.z, r4.z, r4.z
    mul r2.z, r2.z, r4.z
    mul r2.z, r2.z, r3.z
    mad r16.xyz, r2.zzzz, r16.yzxy, r17.xyzx
    mov r18.w, r16.z
    mov r15.w, r17.z
    movc r15.xyzw, r3.wwww, r18.xyzw, r15.xyzw
    mov r16.zw, r19.xxxy
    mov r17.zw, r13.yyyz
    movc r16.xyzw, r3.wwww, r16.xyzw, r17.xyzw
...
switch r3.z
  case l(4)
  if_nz r6.w
    add r16.yzw, cb1[24].xxyz, cb9[r0.y + 0].xxyz
    mov r16.x, l(2)
    store_structured u2.xyzw, cb2[52].x, l(136), r16.xyzw
  endif 
  iadd r3.z, r2.z, l(1)
  lt r3.w, l(0.000000), cb9[r0.y + 6].y
  mov r16.xy, cb9[r0.y + 5].zwzz
  mov r16.z, cb9[r0.y + 6].x
  mad r18.xyz, -r16.xyzx, l(0.500000, 0.500000, 0.500000, 0.000000), cb9[r0.y + 0].xyzx
  add r19.xyz, -r5.xyzx, r18.xyzx
  dp3 r4.z, r16.xyzx, r19.xyzx
  div_sat r7.w, -r4.z, cb9[r0.y + 6].y
  mad r20.xyz, r7.wwww, r16.xyzx, r18.xyzx
  movc r20.xyz, r3.wwww, r20.xyzx, cb9[r0.y + 0].xyzx
  ...
  if_nz r11.w
    ...
    mad_sat r20.xy, r11.wwww, cb9[r0.y + 2].xzxx, cb9[r0.y + 2].ywyy
    ...
    if_nz r11.w
      ...
      if_nz r11.w
        ...
        mad r14.xyz, r4.zzzz, r16.xyzx, r18.xyzx
        movc r14.xyz, r3.wwww, r14.xyzx, cb9[r0.y + 0].xyzx
        add r14.xyz, -r5.xyzx, r14.xyzx
        dp3 r3.w, r14.xyzx, r14.xyzx
        rsq r3.w, r3.w
        mul r16.xyz, r3.wwww, r14.xyzx
        ...
        dp3_sat r4.z, r11.xyzx, r16.xyzx
        ...
        mul r3.w, r3.w, r9.w
        mul r3.w, r3.w, r4.z
        mad r16.xyz, r3.wwww, r18.xyzx, r17.zxyz
        movc r15.xyz, r7.wwww, r19.xyzx, r15.xyzx
        movc r17.xyz, r7.wwww, r16.yzxy, r17.xyzx
  ...
  if_nz r8.w
    mov r16.xyz, cb9[r0.y + 7].yzwy
    mov r16.w, cb9[r0.y + 8].x
    mov r5.w, l(1.000000)
    dp4 r8.w, r16.xyzw, r5.xyzw
    ...
    if_nz r9.w
      ...
      mad_sat r19.xy, r8.wwww, cb9[r0.y + 2].xzxx, cb9[r0.y + 2].ywyy
      ...
      if_nz r5.w
        ...
        exp r20.xy, r20.xyxx
        mul r8.w, r20.x, cb9[r0.y + 12].x
        mad r11.w, cb9[r0.y + 12].y, r20.y, l(-1.000000)
        mad r8.w, cb9[r0.y + 12].y, r20.y, -r8.w
    ...
    if_nz r5.w
      ...
      if_nz r5.w
        ...
        ge r11.w, r10.w, r5.w
        if_nz r11.w
          mov r16.xyz, cb9[r0.y + 4].yzwy
          mov r16.w, cb9[r0.y + 5].x
          ...
          mad r19.x, r16.x, cb9[r0.y + 8].y, cb9[r0.y + 8].z
          mad r19.y, r16.y, cb9[r0.y + 8].w, cb9[r0.y + 9].x
          div r5.w, r5.w, r10.w
      ...
      if_nz r9.w
        mul r9.w, r2.w, cb9[r0.y + 1].z
        mul r9.w, r7.w, r9.w
        ubfe r10.w, l(4), l(16), cb9[r0.y + 1].w
        ult r11.w, l(0), r10.w
        ...
        if_nz r11.w
          ...
          mad r16.xyz, r11.xyzx, r11.wwww, r5.xyzx
          ...
          if_nz r1.z
            ...
            mad r16.xyz, r11.xyzx, r1.zzzz, r5.xyzx
            ...
            if_z r11.w
              ...
              mad r16.xy, r16.xyxx, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
              add r19.x, r16.x, cb9[r0.y + 9].w
              add r19.y, r16.y, cb9[r0.y + 10].x
              mul r16.xy, r19.xyxx, cb9[r0.y + 9].yzyy
              div r16.zw, cb9[r0.y + 3].yyyy, cb9[r0.y + 8].yyyw
              add r19.xy, -r16.zwzz, l(1.000000, 1.000000, 0.000000, 0.000000)
              ge r19.xy, r16.xyxx, r19.xyxx
              ge r16.zw, r16.zzzw, r16.xxxy
              or r16.zw, r16.zzzw, r19.xxxy
              ...
              if_z r12.w
                ...
                mad r19.x, r16.x, cb9[r0.y + 8].y, cb9[r0.y + 8].z
                mad r19.y, r16.y, cb9[r0.y + 8].w, cb9[r0.y + 9].x
                mul r14.w, r10.w, cb9[r0.y + 10].z
                mad r1.z, cb9[r0.y + 10].y, r10.w, r1.z
                div r1.z, r1.z, r14.w
              endif 
            else 
              mov r12.w, l(-1)
        ...
        add r0.y, -r7.w, r0.y
        mad r0.y, r3.y, r0.y, r7.w
        mul r0.y, r5.w, r0.y
        lt r1.z, l(0.000000), r4.z
        mad r16.xyz, r0.yyyy, r18.xyzx, r15.xyzx
        mad r3.xyw, r14.xyxz, r3.wwww, r12.xyxz
        dp3 r0.y, r3.xywx, r3.xywx
        rsq r0.y, r0.y
        mul r3.xyw, r0.yyyy, r3.xyxw
        dp3 r0.y, r3.xywx, r12.xyzx
        dp3 r2.x, r11.xyzx, r3.xywx
        mad r2.w, |r2.x|, r2.w, -|r2.x|
        mad r2.x, |r2.x|, r2.w, l(1.000000)
        ...
        mad r2.xyw, r1.wwww, r18.xyxz, r13.yzyw
        add_sat r0.y, -r0.y, l(1.000000)
        mul r3.x, r0.y, r0.y
        mul r3.x, r3.x, r3.x
        mul r0.y, r0.y, r3.x
        mul r0.y, r0.y, r1.w
        mad r3.xyw, r0.yyyy, r18.xyxz, r17.zxzy
        movc r15.xyz, r1.zzzz, r16.xyzx, r15.xyzx
        movc r17.xyz, r1.zzzz, r3.ywxy, r17.xyzx
...
mad r2.xyw, r15.xyxz, r6.xyxz, r2.xyxw
...
ret 
// Approximately 2479 instruction slots used
