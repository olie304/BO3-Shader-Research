...
r1.w = modelInstanceBuffer[]..swiz;
  ...
  r5.w = r6.y;
  r4.y = dot(r3.xyzw, r5.xyzw);
  r7.w = r6.z;
  r3.x = dot(r3.xyzw, r7.xyzw);
  r3.yzw = viewMatrix._m10_m11_m12 * r4.yyy;
  r3.yzw = r4.xxx * viewMatrix._m00_m01_m02 + r3.yzw;
  r3.xyz = r3.xxx * viewMatrix._m20_m21_m22 + r3.yzw;
  ...
  r4.xyz = viewMatrix._m10_m11_m12 * r4.xxx;
  r4.xyz = r3.www * viewMatrix._m00_m01_m02 + r4.xyz;
  r1.xyz = r1.xxx * viewMatrix._m20_m21_m22 + r4.xyz;
