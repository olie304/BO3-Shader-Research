...
if_nz r0.w
  ...
  if_nz r0.w
    ...
    mul r3.yz, r1.wwzw, v2.xxxx
    ne r1.z, v2.y, l(0.000000)
    if_nz r1.z
      iadd r1.z, r0.w, v3.y
      ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r5.xyzw, r1.z, l(0), t5.xyzw
      dp3 r1.w, r5.xyzx, v0.xyzx
      add r1.w, r5.w, r1.w
      mad r4.x, r1.w, v2.y, r4.x
      dp3 r1.w, r5.xyzx, r0.xyzx
      mad r3.x, r1.w, v2.y, r3.x
      ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r5.xyzw, r1.z, l(16), t5.xyzw
      dp3 r1.w, r5.xyzx, v0.xyzx
      add r1.w, r5.w, r1.w
      mad r4.y, r1.w, v2.y, r4.y
      dp3 r1.w, r5.xyzx, r0.xyzx
      mad r3.y, r1.w, v2.y, r3.y
      ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r5.xyzw, r1.z, l(32), t5.xyzw
      dp3 r1.z, r5.xyzx, v0.xyzx
      add r1.z, r5.w, r1.z
      mad r4.z, r1.z, v2.y, r4.z
      dp3 r1.z, r5.xyzx, r0.xyzx
      mad r3.z, r1.z, v2.y, r3.z
      ne r1.z, v2.z, l(0.000000)
      if_nz r1.z
        iadd r1.z, r0.w, v3.z
        ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r5.xyzw, r1.z, l(0), t5.xyzw
        dp3 r1.w, r5.xyzx, v0.xyzx
        add r1.w, r5.w, r1.w
        mad r4.x, r1.w, v2.z, r4.x
        dp3 r1.w, r5.xyzx, r0.xyzx
        mad r3.x, r1.w, v2.z, r3.x
        ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r5.xyzw, r1.z, l(16), t5.xyzw
        dp3 r1.w, r5.xyzx, v0.xyzx
        add r1.w, r5.w, r1.w
        mad r4.y, r1.w, v2.z, r4.y
        dp3 r1.w, r5.xyzx, r0.xyzx
        mad r3.y, r1.w, v2.z, r3.y
        ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r5.xyzw, r1.z, l(32), t5.xyzw
        dp3 r1.z, r5.xyzx, v0.xyzx
        add r1.z, r5.w, r1.z
        mad r4.z, r1.z, v2.z, r4.z
        dp3 r1.z, r5.xyzx, r0.xyzx
        mad r3.z, r1.z, v2.z, r3.z
        ne r1.z, v2.w, l(0.000000)
        if_nz r1.z
          iadd r0.w, r0.w, v3.w
          ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r5.xyzw, r0.w, l(0), t5.xyzw
          dp3 r1.z, r5.xyzx, v0.xyzx
          add r1.z, r5.w, r1.z
          mad r4.x, r1.z, v2.w, r4.x
          dp3 r1.z, r5.xyzx, r0.xyzx
          mad r3.x, r1.z, v2.w, r3.x
          ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r5.xyzw, r0.w, l(16), t5.xyzw
          dp3 r1.z, r5.xyzx, v0.xyzx
          add r1.z, r5.w, r1.z
          mad r4.y, r1.z, v2.w, r4.y
          dp3 r1.z, r5.xyzx, r0.xyzx
          mad r3.y, r1.z, v2.w, r3.y
  ...
  mul r4.xyz, r2.xywx, v2.xxxx
  mul r2.xyw, r5.xyxz, v2.xxxx
  ...
  if_nz r0.w
    ...
    mad r4.xyz, r6.xyzx, v2.yyyy, r4.xyzx
    mad r2.xyw, r5.xyxz, v2.yyyy, r2.xyxw
    ...
    if_nz r0.w
      ...
      add r7.xyz, r9.xyzx, r8.xyzx
      add r6.xyz, r6.xyzx, r7.xyzx
      mad r4.xyz, r6.xyzx, v2.zzzz, r4.xyzx
      mad r2.xyw, r5.xyxz, v2.zzzz, r2.xyxw
      ...
      if_nz r0.w
        ...
        mad r4.xyz, r3.xyzx, v2.wwww, r4.xyzx
        mad r2.xyw, r5.xyxz, v2.wwww, r2.xyxw
      endif 
    endif 
  endif 
...
dp3 o1.x, r0.xyzx, r2.xyzx
dp3 o1.y, r0.xyzx, r3.xyzx
dp3 o1.z, r0.xyzx, r4.xyzx
...
if_nz r0.x
  ...
  if_nz r0.x
    ...
    mul r3.xyz, r0.xyzx, v2.xxxx
    ne r0.x, v2.y, l(0.000000)
    if_nz r0.x
      mov r4.x, v3.y
      ld_indexable(texture2d)(float,float,float,float) r5.xyzw, r4.xyzz, t2.xyzw
      ld_indexable(texture2d)(float,float,float,float) r6.xyzw, r4.xwzz, t2.xyzw
      ...
      add r1.xzw, r2.xxyw, r6.xxyz
      add r0.xyz, r0.xyzx, r1.xzwx
      mad r3.xyz, r0.xyzx, v2.yyyy, r3.xyzx
      ne r0.x, v2.z, l(0.000000)
      if_nz r0.x
        mov r4.x, v3.z
        ld_indexable(texture2d)(float,float,float,float) r5.xyzw, r4.xyzz, t2.xyzw
        ld_indexable(texture2d)(float,float,float,float) r6.xyzw, r4.xwzz, t2.xyzw
        ...
        add r1.xzw, r2.xxyw, r6.xxyz
        add r0.xyz, r0.xyzx, r1.xzwx
        mad r3.xyz, r0.xyzx, v2.zzzz, r3.xyzx
        ne r0.x, v2.w, l(0.000000)
        if_nz r0.x
          mov r4.x, v3.w
          ld_indexable(texture2d)(float,float,float,float) r5.xyzw, r4.xyzz, t2.xyzw
          ld_indexable(texture2d)(float,float,float,float) r6.xyzw, r4.xwzz, t2.xyzw
          ...
          add r0.xyz, r0.xyzx, r1.xzwx
          mad r3.xyz, r0.xyzx, v2.wwww, r3.xyzx
        endif 
      endif 
    endif 
  endif 
