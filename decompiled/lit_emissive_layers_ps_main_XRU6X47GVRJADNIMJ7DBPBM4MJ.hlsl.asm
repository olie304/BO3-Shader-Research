...
sample_indexable(texture2d)(float,float,float,float) r10.xyzw, r10.xyxx, t24.xyzw, s1
mul r10.xyzw, r10.xyzw, cb0[18].xyzw
mul r10.xyz, r10.wwww, r10.xyzx
mul r10.xyz, r10.xyzx, cb0[19].zzzz
add r1.z, v3.y, v3.x
add r1.z, r1.z, v3.z
...
mov r11.x, cb0[16].x
sample_l_indexable(texture2d)(float,float,float,float) r1.w, r11.xyxx, t22.yzwx, s5, l(0.000000)
log r1.w, |r1.w|
...
sample_indexable(texture2d)(float,float,float,float) r11.xyzw, r11.xyxx, t25.xyzw, s1
mul r11.xyz, r11.xyzx, cb0[20].xyzx
mul r1.w, r11.w, cb0[18].w
mul r11.xyz, r1.wwww, r11.xyzx
mul r11.xyz, r11.xyzx, cb0[26].wwww
add r1.w, r1.z, cb0[25].z
frc r1.w, r1.w
mad r12.y, cb1[69].w, cb0[25].w, r1.w
mov r12.x, cb0[25].y
sample_l_indexable(texture2d)(float,float,float,float) r1.w, r12.xyxx, t22.yzwx, s5, l(0.000000)
log r1.w, |r1.w|
...
mul r11.xyz, r1.wwww, r11.xyzx
mad r1.w, -r11.w, cb0[26].w, l(1.000000)
