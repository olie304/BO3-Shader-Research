...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:40:58 2021
//
//
...
if_z r1.w
  ...
  if_nz r1.w
    ...
    mov_sat r2.w, r0.w
    mul r2.w, r2.w, l(2046.000000)
    ftou r2.w, r2.w
    ishl r3.w, v0.z, l(2)
    and r2.w, r2.w, l(2046)
    bfi r2.w, l(11), l(0), r2.w, r3.w
    bfi r1.y, l(1), l(0), cb0[11].z, r2.w
