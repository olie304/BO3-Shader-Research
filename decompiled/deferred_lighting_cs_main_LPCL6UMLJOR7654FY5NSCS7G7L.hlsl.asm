...
loop 
  ieq r14.w, r13.w, l(2)
  breakc_nz r14.w
  movc r14.w, r13.w, r0.y, r13.z
  uge r15.y, r14.w, r12.w
  ...
  if_nz r15.y
    ...
    add r15.yzw, r5.xxyz, -cb10[r14.w + 0].xxyz
...
bfi r6.w, l(8), l(0), r16.z, r25.w
movc r0.y, r0.y, r6.w, r16.z
max r6.w, r16.y, l(1.000000)
rcp r6.w, r6.w
mov_sat r16.y, r16.y
mul r18.xyz, r6.wwww, r15.yzwy
mul r19.xyz, r6.wwww, r26.xyzx
lt r9.w, r16.y, l(0.990000)
if_nz r9.w
  iadd r0.y, r0.y, l(256)
  add r9.w, -r16.y, l(1.000000)
  ...
  mad r18.xyz, r15.yzwy, r6.wwww, r16.yzwy
  mov r17.w, l(0)
  ...
  mad r19.xyz, r15.yzwy, r6.wwww, r19.xyzx
endif 
add r6.w, r4.z, r2.x
log r6.w, |r6.w|
mul r6.w, r2.z, r6.w
...
mul r20.xyz, r4.zzzz, r18.xyzx
and r21.xyz, r0.wwww, r20.yzxy
...
if_nz r8.w
  ...
  if_nz r8.w
    ...
    mad r22.yzw, r3.zzzz, r15.yyzw, r19.xxyz
    ...
    mad r15.yzw, r3.wwww, r15.yyzw, r21.zzxy
    ...
    mov r21.zw, r23.xxxy
    mov r24.zw, r16.yyyz
    movc r18.xyzw, r3.yyyy, r21.xyzw, r24.xyzw
    mov r22.x, r23.z
    mov r19.w, r16.w
    movc r19.xyzw, r3.yyyy, r22.yzwx, r19.xyzw
    if_nz r2.w
...
ret 
// Approximately 2186 instruction slots used
