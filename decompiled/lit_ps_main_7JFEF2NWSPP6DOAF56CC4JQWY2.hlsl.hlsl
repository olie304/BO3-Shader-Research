...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  if (r5.z != 0) {
    ...
    if (r5.z != 0) {
      ...
      r14.xyz = -v6.xyz * r2.www + sunConstants.wldDir.xyz;
  ...
  while (true) {
    ...
    r7.w = visibleLights.Load(r14.xyzw).x;
    r14.xyz = r8.yzw;
    r27.xyz = r25.xyz;
    r28.xyz = r26.xyz;
    r9.w = r6.z;
      ...
      r30.y = samp0[]..swiz;
        ...
        r35.w = samp0[]..swiz;
          ...
          switch (r12.w) {
            ...
            r13.z = dot(r36.xyz, r38.xyz);
            r13.w = saturate(-r13.z / r35.x);
            r39.xyz = r13.www * r36.xyz + r37.xyz;
              ...
              if (r24.w != 0) {
                ...
                if (r24.w != 0) {
                  ...
                  while (true) {
                    ...
                    if (r28.w != 0) break;
                    r41.y = dot(icb[r27.w+0].yx, r5.xy);
                    r41.z = dot(icb[r27.w+0].yx, r5.yz);
                ...
                if (r24.w != 0) {
                  ...
                  r36.xyz = r13.zzz * r36.xyz + r37.xyz;
                  r36.xyz = r12.www ? r36.xyz : r29.yzw;
                  r36.xyz = -v6.xyz + r36.xyz;
                  r12.w = dot(r36.xyz, r36.xyz);
                  r12.w = rsqrt(r12.w);
                  r37.xyz = r36.xyz * r12.www;
                  if (4 == 0) r13.z = 0; else if (4+16 < 32) {                   r13.z = (uint)r30.w << (32-(4 + 16)); r13.z = (uint)r13.z >> (32-4);                  } else r13.z = (uint)r30.w >> 16;
                  ...
                  r13.w = samp0[]..swiz;
                  // Known bad code for instruction (needs manual fix):
                                    ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r38.xyzw, r13.z, l(100), t12.xyzw
                  r38.x = samp0[]..swiz;
                  r38.y = samp0[]..swiz;
                  r38.z = samp0[]..swiz;
                  r38.w = samp0[]..swiz;
                  // Known bad code for instruction (needs manual fix):
                                    ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r39.xyzw, r13.z, l(116), t12.xyzw
                  r39.x = samp0[]..swiz;
                  r39.y = samp0[]..swiz;
                  r39.z = samp0[]..swiz;
                  r39.w = samp0[]..swiz;
                    r25.w = abs(r22.w) * -0.200000003 + 0.400000006;
                    r16.xyz = r1.xyz * r25.www + v6.xyz;
                    r25.w = dot(r38.xyzw, r16.xyzw);
                    r27.w = dot(r39.xyzw, r16.xyzw);
                    r28.w = cmp(r27.w < r25.w);
                    if (r28.w == 0) {
                    // Known bad code for instruction (needs manual fix):
                                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r38.xyzw, r13.z, l(68), t12.xyzw
                    r38.x = samp0[]..swiz;
                    r38.y = samp0[]..swiz;
                    r38.z = samp0[]..swiz;
                    r38.w = samp0[]..swiz;
                    // Known bad code for instruction (needs manual fix):
                                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r39.xyzw, r13.z, l(84), t12.xyzw
                    r39.x = samp0[]..swiz;
                    r39.y = samp0[]..swiz;
                    r39.z = samp0[]..swiz;
                    r39.w = samp0[]..swiz;
                    // Known bad code for instruction (needs manual fix):
                                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r40.xyzw, r13.z, l(132), t12.xyzw
                    r40.x = samp0[]..swiz;
                    r40.y = samp0[]..swiz;
                    r40.z = samp0[]..swiz;
                    r40.w = samp0[]..swiz;
                    // Known bad code for instruction (needs manual fix):
                                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r41.xyzw, r13.z, l(148), t12.xyzw
                    r41.x = samp0[]..swiz;
                    r41.y = samp0[]..swiz;
                    r41.z = samp0[]..swiz;
                    r41.w = samp0[]..swiz;
                    // Known bad code for instruction (needs manual fix):
                                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r42.xy, r13.z, l(164), t12.xyxx
                    r42.x = samp0[]..swiz;
                    r42.y = samp0[]..swiz;
                    ...
                    r13.z = samp0[]..swiz;
                      ...
                      if (r9.w != 0) {
                        ...
                        while (true) {
                          ...
                          if (r25.w != 0) break;
                          r40.x = dot(icb[r16.z+0].yx, r5.xw);
                          r40.y = dot(icb[r16.z+0].xy, r6.xy);
                          r39.xy = r40.xy * r13.ww + r38.xy;
                    ...
                    if (4 == 0) r13.z = 0; else if (4+20 < 32) {                     r13.z = (uint)r30.w << (32-(4 + 20)); r13.z = (uint)r13.z >> (32-4);                    } else r13.z = (uint)r30.w >> 20;
                    r13.w = cmp(0 < (uint)r13.z);
                    r13.w = r13.w ? r2.w : 0;
                    if (r13.w != 0) {
                      r13.z = (int)r13.z + numLights;
                  ...
                  r13.z = r13.z + -r23.w;
                  r13.z = r4.z * r13.z + r23.w;
                  r13.z = r13.z * r18.w;
                  r30.x = r29.x;
                  r13.w = cmp(0 < r22.w);
                  r17.xyz = r13.zzz * r30.xyz + r14.xyz;
                  r13.z = saturate(dot(r1.xyz, r37.xyz));
                  r36.xyz = r36.xyz * r12.www + r3.xyz;
                  r12.w = dot(r36.xyz, r36.xyz);
                  r12.w = rsqrt(r12.w);
                  r36.xyz = r36.xyz * r12.www;
                  r12.w = dot(r36.xyz, r3.xyz);
                  r16.x = dot(r1.xyz, r36.xyz);
                  r22.w = abs(r16.x) * r4.y + -abs(r16.x);
                  r16.x = abs(r16.x) * r22.w + 1;
                  r22.w = r13.z * r0.w + r1.w;
                  r16.x = r16.x * r16.x;
                  r16.x = r16.x * r22.w;
                  r16.x = rcp(r16.x);
                  r13.z = r13.z * r24.w;
                  r13.z = r16.x * r13.z;
                  r13.z = r13.z * r18.w;
                  r36.xyz = r13.zzz * r30.xyz + r28.xyz;
                  r12.w = saturate(1 + -r12.w);
                  r16.x = r12.w * r12.w;
                  r16.x = r16.x * r16.x;
                  r12.w = r16.x * r12.w;
                  r12.w = r13.z * r12.w;
                  r37.xyz = r12.www * r30.xyz + r27.xyz;
                  r14.xyz = r13.www ? r17.xyz : r14.xyz;
                  r27.xyz = r13.www ? r37.xyz : r27.xyz;
                  r28.xyz = r13.www ? r36.xyz : r28.xyz;
                }
              }
            }
            break;
            ...
            r12.w = rsqrt(r12.w);
            r36.xyz = r17.xyz * r12.www;
            r13.z = dot(r1.xyz, r36.xyz);
            ...
            r37.w = samp0[]..swiz;
              ...
              if (r16.x != 0) {
                  ...
                  r37.y = samp0[]..swiz;
                    ...
                    if (r9.w != 0) {
                      ...
                      while (true) {
                        ...
                        r22.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r31.xyz, r11.w).x;
                        r18.x = r22.w * 0.125 + r18.x;
                        r18.y = (int)r18.y + 1;
                      }
                    } else {
                      r19.z = (uint)r16.x;
                      r18.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r19.xyz, r11.w).x;
                    }
                    r11.w = r18.x * r18.x;
                    r11.w = r11.w * r18.x;
                  } else {
                ...
                if (r16.x != 0) {
                  ...
                  r36.z = samp0[]..swiz;
                  r36.w = samp0[]..swiz;
                    r19.x = abs(r13.z) * -0.200000003 + 0.400000006;
                  ...
                  r18.y = r18.y + -r13.w;
                  r18.y = r4.z * r18.y + r13.w;
                  r18.y = r18.y * r11.w;
                  r13.z = cmp(0 < r13.z);
                  r20.xyz = r18.yyy * r29.xyz + r14.xyz;
                  r17.xyz = r17.xyz * r12.www + r3.xyz;
                  r12.w = dot(r17.xyz, r17.xyz);
                  r12.w = rsqrt(r12.w);
                  r17.xyz = r17.xyz * r12.www;
                  r12.w = dot(r17.xyz, r3.xyz);
                  ...
                  r11.w = r13.w * r11.w;
                  r11.w = 0.25 * r11.w;
                  r17.xyz = r11.www * r29.xyz + r28.xyz;
                  r12.w = saturate(1 + -r12.w);
                  r13.w = r12.w * r12.w;
                  r13.w = r13.w * r13.w;
                  r12.w = r13.w * r12.w;
                  r11.w = r12.w * r11.w;
                  r21.xyz = r11.www * r29.xyz + r27.xyz;
                  r14.xyz = r13.zzz ? r20.xyz : r14.xyz;
                  r27.xyz = r13.zzz ? r21.xyz : r27.xyz;
                  r28.xyz = r13.zzz ? r17.xyz : r28.xyz;
                }
              }
            }
            break;
