...
mul r0.w, r0.x, r1.w
sample_indexable(texture2d)(float,float,float,float) r2.xyz, r0.yzyy, t10.xyzw, s2
sample_indexable(texture2d)(float,float,float,float) r2.w, r0.yzyy, t14.yzwx, s4
...
add r0.yzw, -r2.xxyz, cb1[61].xxyz
mad r0.yzw, cb1[61].wwww, r0.yyzw, r2.xxyz
add r1.w, -r3.x, r3.y
mad r1.w, cb1[62].w, r1.w, r3.x
add r2.x, -r2.w, cb1[63].x
mad r2.z, cb1[63].w, r2.x, r2.w
