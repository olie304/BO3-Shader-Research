...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  if (useAlphaControls != 0) {
    ...
    r3.z = dot(r4.xyz, v3.xyz);
    r3.z = r3.z * r3.z;
    r3.z = saturate(r3.z * w2.x + w2.y);
    r3.z = r3.z * r0.w;
    r4.xy = (int2)v0.xy;
    r4.zw = float2(0,0);
  ...
  if (r3.y != 0) {
    ...
    if (r3.y != 0) {
      ...
      r2.w = saturate(r2.w);
      r15.xyz = -v6.xyz * r4.xxx + sunConstants.wldDir.xyz;
