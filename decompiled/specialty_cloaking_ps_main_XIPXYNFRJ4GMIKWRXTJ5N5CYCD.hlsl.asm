...
//   float EdgeAmount;                  // Offset:  184 Size:     4
//   float EdgeHarshness;               // Offset:  188 Size:     4
//   float3 SceneTint;                  // Offset:  192 Size:    12
//   float PulseWidth;                  // Offset:  204 Size:     4
//   float Speed;                       // Offset:  208 Size:     4
//   float Scale;                       // Offset:  212 Size:     4
//   float PatternScale;                // Offset:  216 Size:     4
//   float scriptFaker;                 // Offset:  220 Size:     4 [unused]
//
// }
//
...
// trilinearSampler                  sampler      NA          NA             s3      1 
...
dcl_output o0.xyzw
dcl_temps 6
mul r0.xy, v2.xyxx, cb0[13].zzzz
mul r0.z, cb0[13].x, cb1[69].w
mad r0.zw, r0.zzzz, l(0.000000, 0.000000, 0.001000, 0.001000), v2.xxxy
sample_indexable(texture2d)(float,float,float,float) r0.zw, r0.zwzz, t21.zwxy, s1
add r0.zw, r0.zzzw, l(0.000000, 0.000000, -0.500000, -0.500000)
mad r0.zw, cb0[10].wwww, r0.zzzw, l(0.000000, 0.000000, 0.500000, 0.500000)
mad r0.zw, r0.zzzw, l(0.000000, 0.000000, 1.99218750, 1.99218750), l(0.000000, 0.000000, -1.000000, -1.000000)
...
sample_indexable(texture2d)(float,float,float,float) r0.x, r0.xyxx, t24.xyzw, s3
add_sat r0.y, r0.x, l(0.010000)
add r0.y, r0.y, l(-0.010000)
add r1.xy, r1.xxxx, l(0.400000, -0.010000, 0.000000, 0.000000)
div r0.y, l(1.000000, 1.000000, 1.000000, 1.000000), r0.y
mul_sat r0.y, r0.y, r1.y
mad r1.y, r0.y, l(-2.000000), l(3.000000)
mul r0.y, r0.y, r0.y
mul r0.y, r0.y, r1.y
add r0.x, -r0.x, l(1.000000)
mad r0.x, r0.x, l(0.500000), l(0.500000)
mul r1.y, cb1[69].w, l(1.200000)
mad r1.y, v0.z, l(10000.000000), r1.y
sincos r1.y, null, r1.y
max r1.y, r1.y, l(0.000000)
eq r1.z, cb0[12].w, l(0.000000)
mul r1.w, cb0[12].w, l(0.500000)
div r1.w, l(1.000000, 1.000000, 1.000000, 1.000000), r1.w
mul_sat r2.w, r1.w, r1.y
mad r3.x, r2.w, l(-2.000000), l(3.000000)
mul r2.w, r2.w, r2.w
mul r2.w, r2.w, r3.x
mad r1.y, -cb0[12].w, l(0.500000), r1.y
...
mad r2.xyz, cb0[12].xyzx, cb0[11].zzzz, l(-1.000000, -1.000000, -1.000000, 0.000000)
mad r2.xyz, r0.xxxx, r2.xyzx, l(1.000000, 1.000000, 1.000000, 0.000000)
mul r1.yw, cb0[13].yyyy, cb1[44].zzzw
mov r3.xyz, v7.xyzx
mov r3.w, l(1.000000)
add r3.xyzw, r3.xyzw, cb1[69].wwww
mul r3.xyzw, r3.xyzw, cb0[13].xxxx
round_ni r3.xyzw, r3.xyzw
max r0.x, cb0[13].x, l(1.000000)
...
dp4 r0.x, r3.xyzw, l(81.239487, 17.348024, 37.349838, 59.394840)
frc r3.y, r0.x
add r3.zw, r1.yyyw, r1.yyyw
mad r3.xy, r3.xyxx, r3.zwzz, -r1.ywyy
mul r3.xy, r3.xyxx, l(0.010000, 0.010000, 0.000000, 0.000000)
mul r0.xz, r0.zzwz, r1.yywy
mov_sat r1.x, r1.x
mul r0.xz, r0.xxzx, r1.xxxx
mad_sat r0.xz, v0.xxyx, cb1[44].zzwz, r0.xxzx
min r0.w, r1.z, l(1.000000)
mad r0.w, r0.w, l(1.500000), l(1.500000)
mul r1.xz, r0.wwww, r3.xxyx
lt r2.w, l(0.000000), r0.y
if_nz r2.w
  mul r1.xz, r0.yyyy, r1.xxzx
  mul r1.xy, r1.ywyy, r1.xzxx
  mad_sat r4.xyzw, r1.xyxy, l(0.200000, 0.130000, -0.140000, 0.190000), r0.xzxz
  sample_l_indexable(texture2d)(float,float,float,float) r5.x, r4.xyxx, t22.xyzw, s3, l(0.000000)
  sample_l_indexable(texture2d)(float,float,float,float) r5.y, r4.zwzz, t22.xyzw, s3, l(0.000000)
  mad_sat r1.xy, r1.xyxx, l(0.130000, -0.180000, 0.000000, 0.000000), r0.xzxx
  sample_l_indexable(texture2d)(float,float,float,float) r5.z, r1.xyxx, t22.xyzw, s3, l(0.000000)
else 
  mad r0.xy, r3.xyxx, r0.wwww, r0.xzxx
  sample_l_indexable(texture2d)(float,float,float,float) r5.xyz, r0.xyxx, t22.xyzw, s3, l(0.000000)
endif 
mul r0.xyz, r2.xyzx, r5.xyzx
...
if_nz r0.w
  ...
  mul r0.w, r0.w, r3.w
  mad r0.xyz, -r0.xyzx, cb1[85].xxxx, r3.xyzx
