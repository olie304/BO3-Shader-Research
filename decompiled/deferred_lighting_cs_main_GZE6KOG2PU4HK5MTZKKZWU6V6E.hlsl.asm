...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:23:25 2021
//
//
// Buffer Definitions: 
//
...
if_z r4.z
  mul r14.xyz, r10.yyyy, cb2[29].xyzx
  mad r14.xyz, r10.xxxx, cb2[28].xyzx, r14.xyzx
  mad r14.xyz, r10.zzzz, cb2[30].xyzx, r14.xyzx
  add r14.xyz, r14.xyzx, cb2[31].xyzx
  add r4.z, r14.z, -cb2[17].w
  ...
  if_nz r6.w
    ...
    loop 
      ...
      breakc_nz r8.w
      ftou r8.w, r6.w
      add r15.xy, r14.xyxx, -cb2[r8.w + 20].xyxx
  ...
  if_nz r8.w
    ...
    if_z r12.w
      ...
      if_z r9.w
        ...
        mad r12.w, r14.x, r15.x, r12.w
        mad r10.w, r14.y, r10.w, r12.w
        movc r14.w, r9.w, r10.w, r14.w
      endif 
    endif 
    mad r9.w, -cb2[27].z, l(2.000000), r14.z
    lt r9.w, r14.w, r9.w
  ...
  if_z r8.w
    if_z cb2[58].y
      ftou r8.w, r6.w
      add r14.zw, r14.xxxy, -cb2[r8.w + 20].xxxy
      mul r14.zw, r14.zzzw, cb2[r8.w + 20].zzzz
    ...
    if_nz cb2[58].y
      ...
      loop 
        ...
        movc r16.xy, r12.wwww, r14.xyxx, r14.zwzz
        movc r15.w, r12.w, cb2[r6.w + 20].w, cb2[r8.w + 20].w
        ...
        utof r16.z, r12.w
        sample_c_lz_indexable(texture2darray)(float,float,float,float) r12.w, r16.xyzx, t13.xxxx, s13, r4.z
...
mad r14.xy, -r4.zzzz, l(10.000000, 5.000000, 0.000000, 0.000000), l(6.857410, 7.085000, 0.000000, 0.000000)
exp r8.w, r14.x
mul r8.w, r2.x, r8.w
mul r8.w, r8.w, l(9.136810)
mul r9.w, r4.z, r6.w
mad r9.w, -r9.w, l(2.015905), r14.y
exp r9.w, r9.w
mul r9.w, r2.x, r9.w
...
if_nz cb2[54].x
  ...
  loop 
    ...
    mov r38.xyz, r25.xyzx
    mov r39.xy, r26.yxyy
    mov r26.w, r10.w
    mov r27.w, r27.z
    mov r28.w, r28.z
    mov r38.w, r12.w
    mov r40.xyzw, r21.zwxy
...
if_nz r10.w
  if_nz r2.z
    add r30.yzw, r25.xxyz, cb1[24].xxyz
    mov r30.x, l(16)
    store_structured u2.xyzw, cb2[52].x, l(880), r30.xyzw
  endif 
  add r25.xyz, r10.xyzx, -r25.xyzx
  and r9.w, r12.w, l(0x0000ffff)
  ubfe r14.w, l(6), l(25), r12.w
  imul null, r15.w, r9.w, l(6)
  dp3 r16.w, cb11[r15.w + 0].xyzx, r25.xyzx
  add_sat r16.w, r16.w, cb11[r15.w + 0].w
  dp3 r18.z, cb11[r15.w + 1].xyzx, r25.xyzx
  add_sat r18.z, r18.z, cb11[r15.w + 1].w
  mul r16.w, r16.w, r18.z
  dp3 r18.z, cb11[r15.w + 2].xyzx, r25.xyzx
  add_sat r18.z, r18.z, cb11[r15.w + 2].w
  mul r16.w, r16.w, r18.z
  dp3 r18.z, cb11[r15.w + 3].xyzx, r25.xyzx
  add_sat r18.z, r18.z, cb11[r15.w + 3].w
  mul r16.w, r16.w, r18.z
  dp3 r18.z, cb11[r15.w + 4].xyzx, r25.xyzx
  add_sat r18.z, r18.z, cb11[r15.w + 4].w
  mul r16.w, r16.w, r18.z
  dp3 r18.z, cb11[r15.w + 5].xyzx, r25.xyzx
  add_sat r15.w, r18.z, cb11[r15.w + 5].w
  mul r30.x, r15.w, r16.w
  and r15.w, r17.w, l(1)
  mov r30.yz, l(0,0,1.000000,0)
  movc r18.zw, r15.wwww, r30.xxxy, r30.zzzx
  ...
  loop 
    ...
    breakc_nz r19.w
    iadd r19.w, r9.w, r16.w
    imul null, r19.w, r19.w, l(6)
    dp3 r25.w, cb11[r19.w + 0].xyzx, r25.xyzx
    add_sat r25.w, r25.w, cb11[r19.w + 0].w
    mul r25.w, r25.w, r31.x
    dp3 r26.y, cb11[r19.w + 1].xyzx, r25.xyzx
    add_sat r26.y, r26.y, cb11[r19.w + 1].w
    mul r25.w, r25.w, r26.y
    dp3 r26.y, cb11[r19.w + 2].xyzx, r25.xyzx
    add_sat r26.y, r26.y, cb11[r19.w + 2].w
    mul r25.w, r25.w, r26.y
    dp3 r26.y, cb11[r19.w + 3].xyzx, r25.xyzx
    add_sat r26.y, r26.y, cb11[r19.w + 3].w
    mul r25.w, r25.w, r26.y
    dp3 r26.y, cb11[r19.w + 4].xyzx, r25.xyzx
    add_sat r26.y, r26.y, cb11[r19.w + 4].w
    mul r25.w, r25.w, r26.y
    dp3 r26.y, cb11[r19.w + 5].xyzx, r25.xyzx
    add_sat r19.w, r26.y, cb11[r19.w + 5].w
    mul r31.x, r19.w, r25.w
    ushr r26.y, r15.w, l(2)
    ubfe r26.z, l(1), l(2), r15.w
    and r26.w, r26.y, l(2)
    max r27.w, r31.x, r31.y
    mad r19.w, -r25.w, r19.w, l(1.000000)
    mul r19.w, r19.w, r31.y
    movc r30.y, r26.w, r19.w, r27.w
    movc r31.xy, r26.zzzz, r31.xyxx, r30.xyxx
    iadd r16.w, r16.w, l(1)
    mov r15.w, r26.y
  endloop 
  mov_sat r31.y, r31.y
  mul r30.w, r18.x, r31.y
  ...
  if_nz r9.w
    ...
    mul r9.w, r18.y, r30.w
    dp3 r14.w, r13.xyzx, r19.xyzx
    dp3 r15.w, r25.xyzx, r19.xyzx
    ...
    dp3 r15.w, r13.xyzx, r21.xyzx
    dp3 r16.w, r25.xyzx, r21.xyzx
    ...
    div r15.w, r16.w, r15.w
    min r14.w, r14.w, |r15.w|
    dp3 r15.w, r13.xyzx, r22.xyzx
    dp3 r16.w, r25.xyzx, r22.xyzx
    ...
    div r15.w, r16.w, r15.w
    min r14.w, r14.w, |r15.w|
    add r17.xyz, r17.xyzx, r25.xyzx
    mad r17.xyz, r13.xyzx, r14.wwww, r17.xyzx
    ...
    dp3 r18.y, r17.xyzx, r14.xyzx
    dp3 r18.z, r17.xyzx, r27.xyzx
    ubfe r12.w, l(9), l(16), r12.w
    utof r18.w, r12.w
    sample_l_indexable(texturecubearray)(float,float,float,float) r17.xyz, r18.xyzw, t8.xyzw, s2, r14.w
    and r19.xyz, r17.xyzx, l(0x7fffffff, 0x7fffffff, 0x7fffffff, 0)
    ...
    dp3 r19.x, r25.xyzx, r29.xyzx
    dp3 r19.y, r25.xyzx, r14.xyzx
    dp3 r19.z, r25.xyzx, r27.xyzx
    mad_sat r15.xyz, r19.xyzx, r15.xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
    mad r15.xyz, r15.xyzx, r16.xyzx, r28.xyzx
    dp3 r18.x, r11.xyzx, r29.xyzx
    dp3 r18.y, r11.xyzx, r14.xyzx
    dp3 r18.z, r11.xyzx, r27.xyzx
    lt r14.xyz, l(0.000000, 0.000000, 0.000000, 0.000000), r18.xyzx
    ...
    movc r20.z, r14.y, l(0), l(0.500000)
    mov r20.xy, l(0,0,0,0)
    add r14.xyw, r15.xyxz, r20.xyxz
    sample_l_indexable(texture3d)(float,float,float,float) r14.xyw, r14.xywx, t18.xywz, s4, l(0.000000)
    mul r14.xyw, r19.yyyy, r14.xyxw
    mad r14.xyw, r16.xyxz, r19.xxxx, r14.xyxw
    ...
    mad r14.xyz, r15.xyzx, r19.zzzz, r14.xywx
    sample_l_indexable(texturecubearray)(float,float,float,float) r15.xyz, r18.xyzw, t8.xyzw, s2, l(6.000000)
    ...
    mul r14.x, r8.w, r12.w
    mul r14.yzw, r9.wwww, r17.xxyz
...
if_z r10.w
  ...
  and r14.x, r10.w, l(-32)
  iadd r14.y, r10.w, -r14.x
  ...
  loop 
    ...
    ieq r19.w, r14.x, r16.w
    bfi r20.w, r14.y, l(0), l(0), r17.w
    movc r17.w, r19.w, r20.w, r17.w
    ieq r19.w, r14.z, r16.w
    ubfe r20.w, r14.w, l(0), r17.w
    movc r17.w, r19.w, r20.w, r17.w
    ...
    loop 
      ...
      if_nz r18.y
        ...
        sqrt r18.y, r18.y
        mad r18.y, r4.z, l(5.000000), r18.y
  ...
  loop 
    ...
    ieq r16.w, r14.x, r14.z
    ubfe r17.w, r14.y, l(0), r14.w
    ...
    loop 
      ...
      if_nz r19.w
        ...
        mad r29.xyz, r13.xyzx, r18.wwww, r29.xyzx
        dp3 r19.w, r29.xyzx, r29.xyzx
        sqrt r19.w, r19.w
        div r18.w, r18.w, r19.w
        add r18.w, r18.w, r18.w
        sqrt r18.w, r18.w
        mad r18.w, r4.z, l(5.000000), r18.w
  ...
  endloop 
  ge r4.z, r22.z, l(1.000000)
  and r7.w, r22.w, l(0x0000ff00)
  bfi r7.w, l(8), l(0), r25.y, r7.w
  movc r9.w, r4.z, r7.w, r25.y
  max r4.z, r25.x, l(1.000000)
  rcp r4.z, r4.z
  mov_sat r25.x, r25.x
  mul r14.xyz, r4.zzzz, r23.xyzx
  ...
  if_nz r7.w
    ...
    mad r14.xyz, r23.xyzx, r4.zzzz, r15.xyzx
    mov r13.w, l(0)
    ...
    mad r30.xyz, r13.xyzx, r4.zzzz, r30.xyzx
  endif 
else 
...
if_nz r2.y
  ...
  if_nz r2.y
    ...
    if_nz r7.w
      ...
      mad r17.xyz, r11.xyzx, r7.wwww, r10.xyzx
      ...
      if_z r7.w
        ...
        if_nz cb2[58].y
          ...
          loop 
            ...
            sample_c_lz_indexable(texture2darray)(float,float,float,float) r12.w, r19.xyzx, t9.xxxx, s13, r7.w
    ...
    add r1.z, -r4.y, r1.z
    mad r1.z, r1.w, r1.z, r4.y
    mul r1.z, r4.w, r1.z
    lt r1.w, l(0.000000), r2.w
    mad r17.xyz, r1.zzzz, r16.xyzx, r13.xyzx
    mad r18.xyz, -r10.xyzx, r0.zzzz, cb2[17].xyzx
    ...
    mul r0.z, r0.z, r1.z
    mul r0.z, r0.z, r0.w
    mad r4.xyz, r0.zzzz, r16.xyzx, r14.xzwx
    movc r13.xyz, r1.wwww, r17.xyzx, r13.xyzx
    movc r14.xzw, r1.wwww, r4.xxyz, r14.xxzw
...
mad r2.xyw, r13.xyxz, r5.yzyw, r2.xyxw
...
ret 
// Approximately 1774 instruction slots used
