  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r4.y = r3.x;
  r4.x = -r2.x;
  r2.y = dot(r4.xy, r1.xy);
  r2.x = dot(r4.yz, r1.xy);
  r1.xy = gameTime.ww * scrollUVs.xy;
  r1.xy = r1.xy * scaleUVs.xy + r2.xy;
  ...
  r0.w = hdrScale * r0.w;
  r1.xyzw = distortionScaleUVs.xyzw * w1.xyyz;
  r1.xy = gameTime.ww * relativeHDR + r1.xy;
  r1.xy = distortionMap.Sample(colorSampler_s, r1.xy).xy;
  r1.xy = r1.xy * float2(1.9921875,1.9921875) + float2(-1,-1);
  r2.xy = renderTargetSize.zw * relativeHDR;
