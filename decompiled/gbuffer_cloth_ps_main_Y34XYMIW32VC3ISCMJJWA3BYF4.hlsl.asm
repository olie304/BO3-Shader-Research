...
sample_indexable(texture2d)(float,float,float,float) r1.x, v2.xyxx, t6.xyzw, s2
...
sample_indexable(texture2d)(float,float,float,float) r2.x, v2.xyxx, t9.xyzw, s2
...
sample_indexable(texture2d)(float,float,float,float) r4.xyzw, v2.xyxx, t16.xyzw, s5
...
mul r7.xyz, r0.yzwy, r6.xyzx
sample_indexable(texture2d)(float,float,float,float) r0.x, v2.xyxx, t17.xyzw, s6
mul r2.y, r0.x, cb0[12].z
...
mul r2.w, r2.w, r4.w
exp r2.w, r2.w
mad_sat r0.x, -r0.x, cb0[12].z, l(1.000000)
add r0.x, r2.w, r0.x
min r0.x, r0.x, l(1.000000)
mad r0.yzw, r0.yyzw, r6.xxyz, -r1.yyzw
mad r0.yzw, r2.wwww, r0.yyzw, r1.yyzw
mul r6.xyz, r0.xxxx, r7.xyzx
movc o0.xyz, r2.yyyy, r6.xyzx, r7.xyzx
movc r0.xyz, r2.yyyy, r0.yzwy, r1.yzwy
