...
mul_sat r1.zw, v6.xxxy, cb0[11].wwww
log r1.zw, r1.zzzw
mul r1.zw, r1.zzzw, cb0[11].zzzz
exp r1.zw, r1.zzzw
lt r2.x, r1.w, r1.z
sample_indexable(texture2d)(float,float,float,float) r2.yzw, v1.yzyy, t14.wxyz, s3
sample_indexable(texture2d)(float,float,float,float) r3.xyz, v1.yzyy, t12.xyzw, s3
movc r2.yzw, r2.xxxx, r2.yyzw, r3.xxyz
movc r1.z, r2.x, r1.z, r1.w
movc r1.w, r2.x, cb0[11].y, cb0[11].x
sample_indexable(texture2d)(float,float,float,float) r3.xyz, v1.yzyy, t6.xyzw, s3
...
movc r0.yzw, v7.xxxx, v2.xxyz, -v2.xxyz
dp3 r1.x, r0.yzwy, r0.yzwy
rsq r1.x, r1.x
mad r0.yzw, r0.yyzw, r1.xxxx, -r2.xxyz
mad r2.yzw, cb1[60].wwww, r0.yyzw, r2.xxyz
sample_indexable(texture2d)(float,float,float,float) r0.y, v1.yzyy, t11.yxzw, s1
mov_sat r0.y, r0.y
