...
r2.w = gpuSkinBase[]..swiz;
  ...
  if (r0.w != 0) {
    ...
    r5.w = gpuSkinBase[]..swiz;
      ...
      r3.yz = v2.xx * r1.zy;
      r1.y = cmp(v2.y != 0.000000);
      if (r1.y != 0) {
        r1.y = (int)r0.w + (int)v3.y;
      // Known bad code for instruction (needs manual fix):
      ...
      r5.w = gpuSkinBase[]..swiz;
        ...
        r1.y = dot(r5.xyz, r0.xyz);
        r3.z = r1.y * v2.y + r3.z;
        r1.y = cmp(v2.z != 0.000000);
        if (r1.y != 0) {
          r1.y = (int)r0.w + (int)v3.z;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r5.xyzw, r1.y, l(0), t5.xyzw
        r5.x = gpuSkinBase[]..swiz;
        r5.y = gpuSkinBase[]..swiz;
    ...
    r4.xyz = v2.xxx * r1.yzw;
    r1.yzw = v2.xxx * r5.xyz;
    ...
    if (r0.w != 0) {
      ...
      r4.xyz = r2.xyw * v2.yyy + r4.xyz;
      r1.yzw = r5.xyz * v2.yyy + r1.yzw;
      ...
      if (r0.w != 0) {
        ...
        r6.xyz = r7.xyz + r8.xyz;
        r2.xyw = r6.xyz + r2.xyw;
        r4.xyz = r2.xyw * v2.zzz + r4.xyz;
        r1.yzw = r5.xyz * v2.zzz + r1.yzw;
        ...
        if (r0.w != 0) {
          ...
          r4.xyz = r2.xyz * v2.www + r4.xyz;
          r1.yzw = r5.xyz * v2.www + r1.yzw;
        }
      }
    }
...
r3.w = gpuSkinBase[]..swiz;
  ...
  r4.w = 1;
  r1.w = r5.x;
  r6.x = dot(r4.xyzw, r1.xyzw);
  r2.w = r5.y;
  r6.y = dot(r4.xyzw, r2.xyzw);
  r5.xyz = r3.xyz;
  ...
  r0.xyzw = viewProjectionMatrix._m10_m11_m12_m13 * r6.yyyy;
  r0.xyzw = r6.xxxx * viewProjectionMatrix._m00_m01_m02_m03 + r0.xyzw;
  r0.xyzw = r6.zzzz * viewProjectionMatrix._m20_m21_m22_m23 + r0.xyzw;
  o4.xyzw = viewProjectionMatrix._m30_m31_m32_m33 + r0.xyzw;
  o2.xyz = r6.xyz;
  o3.x = v4.x;
  return;
}