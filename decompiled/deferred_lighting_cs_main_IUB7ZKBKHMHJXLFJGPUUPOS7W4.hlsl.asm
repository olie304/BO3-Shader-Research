...
imad r0.y, r0.z, r14.y, r0.y
bfi r0.y, l(27), l(5), r0.y, l(16)
and r0.z, r13.w, l(-32)
iadd r14.y, -r0.z, r13.w
...
loop 
  ...
  bfi r17.w, r14.y, l(0), l(0), r15.z
  movc r15.z, r15.w, r17.w, r15.z
  ieq r15.w, r14.z, r15.y
...
if_nz r14.z
  ...
  loop 
    ...
    ieq r18.w, r0.z, r14.w
    ubfe r19.z, r14.y, l(0), r17.w
...
if_nz r4.w
  ...
  if_nz r4.w
    ...
    if_nz r7.w
      ...
      add r20.x, r15.y, cb9[r5.z + 9].w
      add r20.y, r15.z, cb9[r5.z + 10].x
      mul r15.yz, r20.xxyx, cb9[r5.z + 9].yyzy
      ...
      if_z r7.w
        ...
        mad r19.x, r15.y, cb9[r5.z + 8].y, cb9[r5.z + 8].z
        mad r19.y, r15.z, cb9[r5.z + 8].w, cb9[r5.z + 9].x
    ...
    mad r19.xyz, r5.zzzz, r14.yzwy, r17.xyzx
...
loop 
  ...
  switch r5.z
    ...
    mov r31.xy, cb9[r4.w + 5].zwzz
    mov r31.z, cb9[r4.w + 6].x
    mad r15.yzw, -r31.xxyz, l(0.000000, 0.500000, 0.500000, 0.500000), cb9[r4.w + 0].xxyz
    add r32.xyz, -r11.xyzx, r15.yzwy
    dp3 r6.w, r31.xyzx, r32.xyzx
    div_sat r7.w, -r6.w, cb9[r4.w + 6].y
    mad r33.xyz, r7.wwww, r31.xyzx, r15.yzwy
    ...
    if_nz r13.w
      sqrt r13.w, r8.w
      mul r16.w, cb9[r4.w + 3].x, cb9[r4.w + 3].x
      div r8.w, r16.w, r8.w
      ...
      if_nz r13.w
        ...
        if_nz r13.w
          ...
          loop 
            ...
            sample_c_lz_indexable(texturecubearray)(float,float,float,float) r21.w, r34.xyzw, t10.xxxx, s13, r13.w
        ...
        if_nz r13.w
          ...
          mad r21.w, -r16.w, r16.w, cb9[r4.w + 6].y
          mad r6.w, r16.w, r18.w, -r6.w
          div_sat r6.w, r6.w, r21.w
          div r16.w, r21.w, cb9[r4.w + 6].y
          mul r16.w, r16.w, l(10.000000)
          min r16.w, r16.w, l(1.000000)
          add r6.w, -r7.w, r6.w
          mad r6.w, r16.w, r6.w, r7.w
          mad r15.yzw, r6.wwww, r31.xxyz, r15.yyzw
          movc r15.yzw, r5.zzzz, r15.yyzw, cb9[r4.w + 0].xxyz
          add r15.yzw, -r11.xxyz, r15.yyzw
          dp3 r5.z, r15.yzwy, r15.yzwy
          rsq r5.z, r5.z
          mul r31.xyz, r5.zzzz, r15.yzwy
          ...
          if_nz r7.w
            ...
            if_z r18.w
              ...
              add r32.x, r20.x, cb9[r6.w + 9].w
              add r32.y, r20.y, cb9[r6.w + 10].x
              mul r20.xy, r32.xyxx, cb9[r6.w + 9].yzyy
              ...
              if_z r20.z
                ...
                mad r32.x, r20.x, cb9[r6.w + 8].y, cb9[r6.w + 8].z
                mad r32.y, r20.y, cb9[r6.w + 8].w, cb9[r6.w + 9].x
                mul r20.x, r16.w, cb9[r6.w + 10].z
                mad r7.w, cb9[r6.w + 10].y, r16.w, r7.w
                div r7.w, r7.w, r20.x
              endif 
            else 
              mov r20.z, l(-1)
            ...
            if_z r16.w
              max r7.w, r7.w, l(0.00006104)
              and r16.w, l(0x0000ffff), cb9[r6.w + 1].w
              if_nz cb2[58].y
                utof r20.z, r16.w
                mov r18.w, l(0)
                mov r21.w, l(0)
                loop 
                  ...
                  dp2 r33.y, icb[r21.w + 0].xyxx, r3.xyxx
                  mad r20.xy, r33.xyxx, cb9[r6.w + 3].yyyy, r32.xyxx
                  sample_c_lz_indexable(texture2darray)(float,float,float,float) r20.x, r20.xyzx, t9.xxxx, s13, r7.w
            ...
            if_nz r7.w
              ...
              imad r6.w, r6.w, l(15), l(-15)
              mad r7.w, |r9.w|, l(-0.200000), l(0.400000)
              mad r22.xyz, r12.xyzx, r7.wwww, r11.xyzx
              mov r32.xyz, cb9[r6.w + 6].yzwy
              mov r32.w, cb9[r6.w + 7].x
              dp4 r7.w, r32.xyzw, r22.xyzw
              mov r32.xyz, cb9[r6.w + 7].yzwy
              mov r32.w, cb9[r6.w + 8].x
              ...
              if_z r20.x
                ...
                add r22.x, r20.y, cb9[r6.w + 9].w
                add r22.y, r20.z, cb9[r6.w + 10].x
                mul r20.yz, r22.xxyx, cb9[r6.w + 9].yyzy
              ...
              if_z r16.w
                ...
                if_nz cb2[58].y
                  ...
                  loop 
                    ige r27.w, r26.w, l(8)
                    breakc_nz r27.w
                    dp2 r32.x, icb[r26.w + 0].xyxx, r13.xyxx
                    dp2 r32.y, icb[r26.w + 0].yxyy, r13.xzxx
                    mad r20.xy, r32.xyxx, cb9[r6.w + 3].yyyy, r22.xyxx
                    sample_c_lz_indexable(texture2darray)(float,float,float,float) r20.x, r20.xyzx, t9.xxxx, s13, r7.w
                  ...
                  utof r22.z, r16.w
                  sample_c_lz_indexable(texture2darray)(float,float,float,float) r21.w, r22.xyzx, t9.xxxx, s13, r7.w
                endif 
                mul r6.w, r21.w, r21.w
                mul r6.w, r21.w, r6.w
              else 
                mov r6.w, l(1.000000)
              endif 
          ...
          mul r6.w, r8.w, r6.w
          mov r20.x, cb9[r4.w + 0].w
          mov r20.yz, cb9[r4.w + 1].xxyx
          lt r7.w, l(0.000000), r9.w
          mad r22.xyz, r6.wwww, r20.xyzx, r14.yzwy
          dp3_sat r6.w, r12.xyzx, r31.xyzx
          mad r15.yzw, r15.yyzw, r5.zzzz, r10.yyzw
          dp3 r5.z, r15.yzwy, r15.yzwy
          rsq r5.z, r5.z
          mul r15.yzw, r5.zzzz, r15.yyzw
          dp3 r5.z, r15.yzwy, r10.yzwy
          ...
          mul r6.w, r6.w, r9.w
          mul r6.w, r8.w, r6.w
          mad r15.yzw, r6.wwww, r20.xxyz, r30.xxyz
          add_sat r5.z, -r5.z, l(1.000000)
          mul r8.w, r5.z, r5.z
          mul r8.w, r8.w, r8.w
          mul r5.z, r5.z, r8.w
          mul r5.z, r5.z, r6.w
          mad r20.xyz, r5.zzzz, r20.xyzx, r29.xyzx
          movc r14.yzw, r7.wwww, r22.xxyz, r14.yyzw
          movc r29.xyz, r7.wwww, r20.xyzx, r29.xyzx
          movc r30.xyz, r7.wwww, r15.yzwy, r30.xyzx
        endif 
      endif 
    endif 
    break 
    case l(2)
    add r20.xy, -r11.xyxx, cb9[r4.w + 3].zwzz
    add r20.z, -r11.z, cb9[r4.w + 4].x
    dp3 r5.z, r20.xyzx, r20.xyzx
    rsq r5.z, r5.z
    mul r15.yzw, r5.zzzz, r20.xxyz
    dp3 r6.w, r12.xyzx, r15.yzwy
    mov_sat r7.w, r6.w
    lt r8.w, l(0.000000), r7.w
    if_nz r8.w
      mov r31.xyz, cb9[r4.w + 7].yzwy
      mov r31.w, cb9[r4.w + 8].x
      dp4 r8.w, r31.xyzw, r11.xyzw
      lt r9.w, r8.w, l(1.000000)
      if_nz r9.w
        mov r15.yzw, l(0,1.000000,1.000000,1.000000)
        mov r9.w, l(0)
      else 
        add r22.xyz, -r11.xyzx, cb9[r4.w + 0].xyzx
        mul r12.w, cb9[r4.w + 3].x, cb9[r4.w + 3].x
        dp3 r13.w, r22.xyzx, r22.xyzx
        div r12.w, r12.w, r13.w
        min r12.w, r12.w, l(1.000000)
        mad_sat r22.xy, r8.wwww, cb9[r4.w + 2].xzxx, cb9[r4.w + 2].ywyy
        ...
        mul r12.w, r12.w, r22.x
        mul r12.w, r22.y, r12.w
        mov r32.xyz, cb9[r4.w + 4].yzwy
        mov r32.w, cb9[r4.w + 5].x
        dp4 r22.x, r32.xyzw, r11.xyzw
        mov r32.xyz, cb9[r4.w + 5].yzwy
        mov r32.w, cb9[r4.w + 6].x
        dp4 r22.y, r32.xyzw, r11.xyzw
        div r21.xy, r22.xyxx, r8.wwww
        lt r8.w, cb9[r4.w + 10].w, l(0.00048828)
        if_nz r8.w
          mad_sat r22.xy, |r21.xyxx|, cb9[r4.w + 12].xyxx, cb9[r4.w + 12].zwzz
          mul r32.xy, r22.xyxx, r22.xyxx
          mad r22.xy, r22.xyxx, l(-2.000000, -2.000000, 0.000000, 0.000000), l(3.000000, 3.000000, 0.000000, 0.000000)
          mul r22.xy, r22.xyxx, r32.xyxx
          mul r8.w, r22.y, r22.x
        else 
          mul_sat r32.xyzw, |r21.yyxx|, cb9[r4.w + 11].xyzw
          log r32.xyzw, r32.xyzw
          mul r32.xyzw, r32.xyzw, cb9[r4.w + 12].zzzz
          exp r32.xyzw, r32.xyzw
          add r22.xy, r32.zwzz, r32.xyxx
          log r22.xy, r22.xyxx
          mul r22.xy, r22.xyxx, cb9[r4.w + 12].wwww
          exp r22.xy, r22.xyxx
          mul r13.w, r22.x, cb9[r4.w + 12].x
          mad r16.w, cb9[r4.w + 12].y, r22.y, l(-1.000000)
          mad r13.w, cb9[r4.w + 12].y, r22.y, -r13.w
          div_sat r13.w, r16.w, r13.w
          mul r16.w, r13.w, r13.w
          mad r13.w, r13.w, l(-2.000000), l(3.000000)
          mul r8.w, r13.w, r16.w
        endif 
        mul r9.w, r8.w, r12.w
        and r8.w, l(255), cb9[r4.w + 14].w
        if_nz r8.w
          dp3 r12.w, cb9[r4.w + 13].xyzx, r21.xyzx
          mov r22.x, cb9[r4.w + 13].w
          mov r22.yz, cb9[r4.w + 14].xxyx
      ...
      mov r22.x, cb9[r4.w + 0].w
      mov r22.yz, cb9[r4.w + 1].xxyx
      ...
      if_nz r8.w
        ...
        if_nz r8.w
          ...
          mad r23.xyz, r12.xyzx, r8.wwww, r11.xyzx
          mov r32.xyz, cb9[r4.w + 6].yzwy
          mov r32.w, cb9[r4.w + 7].x
          dp4 r8.w, r32.xyzw, r23.xyzw
          dp4 r12.w, r31.xyzw, r23.xyzw
          ge r13.w, r12.w, r8.w
          if_nz r13.w
            mov r31.xyz, cb9[r4.w + 4].yzwy
            mov r31.w, cb9[r4.w + 5].x
            dp4 r21.x, r31.xyzw, r23.xyzw
            mov r31.xyz, cb9[r4.w + 5].yzwy
            mov r31.w, cb9[r4.w + 6].x
            ...
            mad r22.x, r21.x, cb9[r4.w + 8].y, cb9[r4.w + 8].z
            mad r22.y, r21.y, cb9[r4.w + 8].w, cb9[r4.w + 9].x
            div r8.w, r8.w, r12.w
            ...
            if_nz cb2[58].y
              ...
              loop 
                ...
                mad r23.xy, r21.xyxx, cb9[r4.w + 3].yyyy, r22.xyxx
                sample_c_lz_indexable(texture2darray)(float,float,float,float) r21.x, r23.xyzx, t9.xxxx, s13, r8.w
                mad r13.w, r21.x, l(0.125000), r13.w
        ...
        if_nz r9.w
          ...
          ult r16.w, l(0), r12.w
          and r16.w, r10.x, r16.w
          if_nz r16.w
            iadd r12.w, r12.w, cb2[0].x
            imad r12.w, r12.w, l(15), l(-15)
            mad r16.w, |r6.w|, l(-0.200000), l(0.400000)
            mad r24.xyz, r12.xyzx, r16.wwww, r11.xyzx
            mov r31.xyz, cb9[r12.w + 6].yzwy
            mov r31.w, cb9[r12.w + 7].x
            dp4 r16.w, r31.xyzw, r24.xyzw
            mov r31.xyz, cb9[r12.w + 7].yzwy
            mov r31.w, cb9[r12.w + 8].x
            dp4 r21.x, r31.xyzw, r24.xyzw
            lt r21.y, r21.x, r16.w
            if_z r21.y
              mov r31.xyz, cb9[r12.w + 4].yzwy
              mov r31.w, cb9[r12.w + 5].x
              dp4 r22.x, r31.xyzw, r24.xyzw
              mov r31.xyz, cb9[r12.w + 5].yzwy
              mov r31.w, cb9[r12.w + 6].x
              ...
              if_z r22.z
                ...
                mul r22.x, r21.x, cb9[r12.w + 10].z
                mad r16.w, cb9[r12.w + 10].y, r21.x, r16.w
            ...
            if_z r21.x
              ...
              and r21.x, l(0x0000ffff), cb9[r12.w + 1].w
              if_nz cb2[58].y
                utof r22.z, r21.x
                mov r21.y, l(0)
                mov r24.x, l(0)
                loop 
                  ...
                  mad r22.xy, r31.xyxx, cb9[r12.w + 3].yyyy, r23.xyxx
            ...
            if_nz r12.w
              ...
              mad r25.xyz, r12.xyzx, r12.wwww, r11.xyzx
              mov r31.xyz, cb9[r4.w + 6].yzwy
              mov r31.w, cb9[r4.w + 7].x
              dp4 r12.w, r31.xyzw, r25.xyzw
              mov r31.xyz, cb9[r4.w + 7].yzwy
              mov r31.w, cb9[r4.w + 8].x
              dp4 r16.w, r31.xyzw, r25.xyzw
              lt r21.x, r16.w, r12.w
              if_z r21.x
                mov r31.xyz, cb9[r4.w + 4].yzwy
                mov r31.w, cb9[r4.w + 5].x
                ...
                if_z r22.z
                  ...
                  mul r22.x, r16.w, cb9[r4.w + 10].z
                  mad r12.w, cb9[r4.w + 10].y, r16.w, r12.w
              ...
              if_z r16.w
                ...
                and r16.w, l(0x0000ffff), cb9[r4.w + 1].w
                if_nz cb2[58].y
                  utof r22.z, r16.w
                  mov r21.x, l(0)
                  mov r24.x, l(0)
                  loop 
                    ...
                    mad r22.xy, r25.xyxx, cb9[r4.w + 3].yyyy, r23.xyxx
          ...
          mad r22.xyz, r4.wwww, r15.yzwy, r14.yzwy
          mad r20.xyz, r20.xyzx, r5.zzzz, r10.yzwy
          dp3 r4.w, r20.xyzx, r20.xyzx
          rsq r4.w, r4.w
          mul r20.xyz, r4.wwww, r20.xyzx
          dp3 r4.w, r20.xyzx, r10.yzwy
          ...
          mad r20.xyz, r5.zzzz, r15.yzwy, r30.xyzx
          add_sat r4.w, -r4.w, l(1.000000)
          mul r7.w, r4.w, r4.w
          mul r7.w, r7.w, r7.w
          mul r4.w, r4.w, r7.w
          mul r4.w, r4.w, r5.z
          mad r15.yzw, r4.wwww, r15.yyzw, r29.xxyz
          movc r14.yzw, r6.wwww, r22.xxyz, r14.yyzw
          movc r29.xyz, r6.wwww, r15.yzwy, r29.xyzx
          movc r30.xyz, r6.wwww, r20.xyzx, r30.xyzx
        endif 
      endif 
    endif 
    break 
...
ret 
// Approximately 1848 instruction slots used
