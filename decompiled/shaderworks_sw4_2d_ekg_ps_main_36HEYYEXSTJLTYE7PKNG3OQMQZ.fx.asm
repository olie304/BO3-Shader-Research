...
//   float YOffset;                     // Offset:  160 Size:     4
//   float Speed;                       // Offset:  164 Size:     4
//   float MaxAmplitude;                // Offset:  168 Size:     4
//
// }
//
...
// ------------------------------ ---------- ------- ----------- -------------- ------
// EKG_Sampler                       sampler      NA          NA             s1      1 
// EKG                               texture  float4          2d             t0      1 
...
dcl_output o0.xyzw
dcl_temps 3
mul r0.x, cb0[10].z, cb3[0].w
mad r0.y, -cb0[10].z, cb3[0].w, l(1.000000)
mad r1.y, cb0[10].x, r0.y, v2.y
mad r0.y, cb1[69].w, cb0[10].y, cb3[0].x
...
lt r0.w, r0.w, v2.x
round_ni r0.y, r0.y
mad r0.y, r0.y, l(0.250000), cb3[0].y
mad r1.x, v2.x, cb3[0].z, r0.y
sample_indexable(texture2d)(float,float,float,float) r0.y, r1.xyxx, t0.yxzw, s1
add r1.z, r1.x, l(0.002000)
sample_indexable(texture2d)(float,float,float,float) r1.z, r1.zyzz, t0.yzxw, s1
if_nz r0.w
  mov r2.xyzw, l(0,0,0,0)
else 
  mad r0.z, r0.z, l(2.000000), -v2.x
  mul r0.z, r0.z, r0.z
  mad r0.z, -r0.z, r0.z, l(1.000000)
  add r0.y, r0.y, l(-0.500000)
  mad r0.y, r0.y, r0.x, l(0.500000)
  add r0.w, r1.z, l(-0.500000)
  mad r0.x, r0.w, r0.x, l(0.500000)
  add r0.xy, -r0.xyxx, l(1.000000, 1.000000, 0.000000, 0.000000)
  add r0.x, -r0.y, r0.x
  mul r0.x, r0.x, l(499.999969)
  mad r0.y, r0.x, r1.x, -r0.y
  mad r0.w, -r0.x, r1.x, r1.y
  add r0.y, r0.y, r0.w
  mad r0.x, r0.x, r0.x, l(1.000000)
  sqrt r0.x, r0.x
  div r0.x, r0.y, r0.x
  mad r0.x, -|r0.x|, l(25.000000), l(1.000000)
