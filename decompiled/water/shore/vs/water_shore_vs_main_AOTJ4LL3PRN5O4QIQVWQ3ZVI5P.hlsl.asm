...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:44:17 2021
//
//
// Buffer Definitions: 
//
...
//   float4 shoreUVControl;             // Offset:  304 Size:    16
...
//   float4 foamMaskScroll01;           // Offset:  464 Size:    16
//   float4 foamMaskScroll23;           // Offset:  480 Size:    16
//   float4 foamMaskScale01;            // Offset:  496 Size:    16
//   float4 foamMaskScale23;            // Offset:  512 Size:    16
...
//   float foamWaveIncrease;            // Offset:  548 Size:     4
...
dcl_output o8.xyzw
dcl_temps 7
dp2 r0.x, v0.xyxx, cb0[35].xyxx
dp2 r0.y, v0.xyxx, cb0[36].xyxx
dp2 r0.z, v0.xyxx, cb0[37].xyxx
dp2 r0.w, v0.xyxx, cb0[38].xyxx
mad r0.xyzw, -cb0[41].xyzw, cb1[69].wwww, r0.xyzw
sincos r1.x, null, r0.x
sincos null, r0.xyzw, r0.xyzw
mul r2.xyzw, v1.xxxx, cb0[39].xyzw
mul r1.yz, r2.xxxx, -cb0[35].zzwz
mul r1.yz, r1.xxxx, r1.yyzy
mad r1.yz, cb0[40].xxxx, r1.yyzy, v0.xxyx
mul r3.xy, r2.yyyy, -cb0[36].zwzz
mul r3.xy, r1.xxxx, r3.xyxx
mad r1.yz, cb0[40].yyyy, r3.xxyx, r1.yyzy
mul r3.xy, r2.zzzz, -cb0[37].zwzz
mul r3.xy, r1.xxxx, r3.xyxx
mad r1.yz, cb0[40].zzzz, r3.xxyx, r1.yyzy
mul r3.xy, r2.wwww, -cb0[38].zwzz
dp4 r0.x, r2.xyzw, r0.xyzw
mul r0.yz, r1.xxxx, r3.xxyx
mad r1.xy, cb0[40].wwww, r0.yzyy, r1.yzyy
mov r2.xyz, v0.xyzx
mov r2.w, l(0)
mul r0.y, -r0.x, cb0[34].y
add r1.z, r0.x, v0.z
min r1.w, r0.y, l(0.000000)
movc r0.xyzw, cb0[42].yyyy, r1.xyzw, r2.xyzw
mov o6.z, r0.w
mov r0.w, l(1.000000)
...
mad o6.xy, v0.xyxx, cb0[19].xyxx, cb0[19].zwzz
mul r0.xyzw, cb0[29].xyzw, cb1[69].wwww
mad o7.xyzw, v0.xyxy, cb0[31].xyzw, r0.xyzw
mul r0.xyzw, cb0[30].xyzw, cb1[69].wwww
mad o8.xyzw, v0.xyxy, cb0[32].xyzw, r0.xyzw
ret 
