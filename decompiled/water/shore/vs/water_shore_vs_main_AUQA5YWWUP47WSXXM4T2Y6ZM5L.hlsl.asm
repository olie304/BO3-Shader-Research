...
dcl_temps 5
if_nz cb0[43].y
  mul r0.xyzw, v1.xxxx, cb0[40].xyzw
  dp2 r1.x, v0.xyxx, cb0[36].xyxx
  dp2 r1.y, v0.xyxx, cb0[37].xyxx
  dp2 r1.z, v0.xyxx, cb0[38].xyxx
  dp2 r1.w, v0.xyxx, cb0[39].xyxx
  mad r1.xyzw, -cb0[42].xyzw, cb1[69].wwww, r1.xyzw
  sincos null, r2.xyzw, r1.xyzw
  sincos r1.x, null, r1.x
  dp4 r1.y, r0.xyzw, r2.xyzw
  add r2.z, r1.y, v0.z
  mul r1.yz, r0.xxxx, -cb0[36].zzwz
  mul r1.yz, r1.xxxx, r1.yyzy
  mad r1.yz, cb0[41].xxxx, r1.yyzy, v0.xxyx
  mul r0.xy, r0.yyyy, -cb0[37].zwzz
  mul r0.xy, r1.xxxx, r0.xyxx
  mad r0.xy, cb0[41].yyyy, r0.xyxx, r1.yzyy
  mul r1.yz, r0.zzzz, -cb0[38].zzwz
  mul r1.yz, r1.xxxx, r1.yyzy
  mad r0.xy, cb0[41].zzzz, r1.yzyy, r0.xyxx
  mul r0.zw, r0.wwww, -cb0[39].zzzw
  mul r0.zw, r1.xxxx, r0.zzzw
  mad r2.xy, cb0[41].wwww, r0.zwzz, r0.xyxx
