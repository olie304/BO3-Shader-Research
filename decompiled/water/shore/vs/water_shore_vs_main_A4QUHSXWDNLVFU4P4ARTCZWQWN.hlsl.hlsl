...
// unknown dcl_: dcl_resource_structured t5, 64
  ...
  if (useFoam != 0) {
    r0.xyz = waveAmplitude.xyz * v1.xxx;
    r1.x = dot(v0.xy, wave0K.xy);
    r1.y = dot(v0.xy, wave1K.xy);
    r1.z = dot(v0.xy, wave2K.xy);
    r1.xyz = -waveFrequency.xyz * gameTime.www + r1.xyz;
    r1.yzw = cos(r1.xyz);
    r0.w = sin(r1.x);
    r1.x = dot(r0.xyz, r1.yzw);
    r1.z = v0.z + r1.x;
    r2.xy = -wave0K.zw * r0.xx;
    r2.xy = r2.xy * r0.ww;
    r2.xy = waveSteepness.xx * r2.xy + v0.xy;
    r0.xy = -wave1K.zw * r0.yy;
    r0.xy = r0.xy * r0.ww;
    r0.xy = waveSteepness.yy * r0.xy + r2.xy;
    r2.xy = -wave2K.zw * r0.zz;
    r0.zw = r2.xy * r0.ww;
    r1.xy = waveSteepness.zz * r0.zw + r0.xy;
  ...
  r0.w = modelInstanceBuffer[]..swiz;
    ...
    r1.xyzw = viewProjectionMatrix._m10_m11_m12_m13 * r2.xxxx;
