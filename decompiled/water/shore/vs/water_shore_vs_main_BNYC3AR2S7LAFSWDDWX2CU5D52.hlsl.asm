...
dcl_output o8.xyzw
dcl_temps 9
mad o6.xy, v2.xyxx, cb0[19].xyxx, cb0[19].zwzz
mul r0.xyzw, cb0[29].xyzw, cb1[69].wwww
mad o7.xyzw, v2.xyxy, cb0[31].xyzw, r0.xyzw
mul r0.xyzw, cb0[30].xyzw, cb1[69].wwww
mad o8.xyzw, v2.xyxy, cb0[32].xyzw, r0.xyzw
if_nz cb0[41].y
  ...
  mul r3.xyz, v1.xxxx, cb0[38].xyzx
  dp2 r4.x, v2.xyxx, cb0[35].xyxx
  dp2 r4.y, v2.xyxx, cb0[36].xyxx
  dp2 r4.z, v2.xyxx, cb0[37].xyxx
  mad r4.xyz, -cb0[40].xyzx, cb1[69].wwww, r4.xyzx
  sincos null, r4.yzw, r4.xxyz
  sincos r0.w, null, r4.x
  dp3 r1.w, r3.xyzx, r4.yzwy
  mad r0.xyz, r0.xyzx, r1.wwww, v0.xyzx
  mul r3.xw, r3.xxxx, -cb0[35].zzzw
  mul r3.xw, r0.wwww, r3.xxxw
  mul r4.xy, r3.yyyy, -cb0[36].zwzz
  mul r4.xy, r0.wwww, r4.xyxx
  mul r4.xy, r4.xyxx, cb0[39].yyyy
  mad r3.xy, cb0[39].xxxx, r3.xwxx, r4.xyxx
  mul r3.zw, r3.zzzz, -cb0[37].zzzw
  mul r3.zw, r0.wwww, r3.zzzw
  mad r3.xy, cb0[39].zzzz, r3.zwzz, r3.xyxx
  mul r2.xyz, r2.xyzx, r3.yyyy
  mad r1.xyz, r3.xxxx, r1.xyzx, r2.xyzx
  add r0.xyz, r0.xyzx, r1.xyzx
  mul r1.x, -r1.w, cb0[34].y
  min o6.z, r1.x, l(0.000000)
else 
  mov r0.xyz, v0.xyzx
  mov o6.z, l(0)
endif 
