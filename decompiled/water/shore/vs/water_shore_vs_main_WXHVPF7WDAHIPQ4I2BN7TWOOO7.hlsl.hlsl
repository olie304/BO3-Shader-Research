// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:44:25 2021
...
void main( 
  ...
  out float2 p2 : TEXCOORD6,
  out float3 o3 : TEXCOORD1,
  out float p3 : TEXCOORD9,
...
// unknown dcl_: dcl_resource_structured t5, 64
  ...
  r0.xyz = -waveFrequency.xyz * gameTime.www + r0.xyz;
  r0.w = sin(r0.x);
  r0.xyz = cos(r0.xyz);
  r1.xyz = waveAmplitude.xyz * v1.xxx;
  r2.xy = -wave0K.zw * r1.xx;
  r2.xy = r2.xy * r0.ww;
  r2.xy = waveSteepness.xx * r2.xy + v0.xy;
  r2.zw = -wave1K.zw * r1.yy;
  r2.zw = r2.zw * r0.ww;
  r2.xy = waveSteepness.yy * r2.zw + r2.xy;
  r2.zw = -wave2K.zw * r1.zz;
  r0.x = dot(r1.xyz, r0.xyz);
  r0.yz = r2.zw * r0.ww;
  r1.xy = waveSteepness.zz * r0.yz + r2.xy;
  r2.xyz = v0.xyz;
  r2.w = 0;
...
r1.w = modelInstanceBuffer[]..swiz;
  ...
  o1.xyz = exp2(r0.xyz);
  p1.x = v1.w;
  p2.xy = v0.xy * shoreUVControl.xy + shoreUVControl.zw;
  o2.xy = v2.xy;
