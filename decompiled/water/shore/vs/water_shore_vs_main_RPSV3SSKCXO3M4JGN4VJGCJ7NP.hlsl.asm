...
mad r0.xyz, -cb0[41].xyzx, cb1[69].wwww, r0.xyzx
sincos r0.w, null, r0.x
sincos null, r0.xyz, r0.xyzx
mul r1.xyz, v1.xxxx, cb0[39].xyzx
mul r2.xy, r1.xxxx, -cb0[36].zwzz
mul r2.xy, r0.wwww, r2.xyxx
mad r2.xy, cb0[40].xxxx, r2.xyxx, v0.xyxx
mul r2.zw, r1.yyyy, -cb0[37].zzzw
mul r2.zw, r0.wwww, r2.zzzw
mad r2.xy, cb0[40].yyyy, r2.zwzz, r2.xyxx
mul r2.zw, r1.zzzz, -cb0[38].zzzw
dp3 r0.x, r1.xyzx, r0.xyzx
mul r0.yz, r0.wwww, r2.zzwz
mad r1.xy, cb0[40].zzzz, r0.yzyy, r2.xyxx
mov r2.xyz, v0.xyzx
mov r2.w, l(0)
...
mad o6.xy, v0.xyxx, cb0[16].xyxx, cb0[16].zwzz
