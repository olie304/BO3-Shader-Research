...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  if (r5.w == 0) {
    ...
    if (r6.z != 0) {
      ...
      while (true) {
        ...
        if (r8.x != 0) break;
        r8.x = (uint)r6.z;
        r8.yz = -sunConstants.splitPinTransform[r8.x].xy + r7.yz;
        r8.y = max(abs(r8.y), abs(r8.z));
        r6.w = sunConstants.splitPinTransform[r8.x].z * r8.y;
        r8.x = cmp(r6.w < 1);
        if (r8.x != 0) {
          break;
        }
    ...
    if (r8.x == 0) {
      if (enableDitheredShadow == 0) {
        r7.w = (uint)r6.z;
        r8.xy = -sunConstants.splitPinTransform[r7.w].xy + r7.yz;
        ...
        r8.z = r7.w + r6.z;
        r7.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r8.xyz, r5.w).x;
      ...
      if (enableDitheredShadow != 0) {
        ...
        r6.w = 28 * r6.w;
        r6.zw = (uint2)r6.zw;
        r9.xy = -sunConstants.splitPinTransform[r7.w].xy + r7.yz;
        r9.xy = sunConstants.splitPinTransform[r7.w].zz * r9.xy;
        r9.xy = r9.xy * float2(0.5,-0.5) + float2(0.5,0.5);
        r7.yz = -sunConstants.splitPinTransform[r6.z].xy + r7.yz;
        r7.yz = sunConstants.splitPinTransform[r6.z].zz * r7.yz;
        ...
        while (true) {
          ...
          if (r9.w != 0) break;
          r9.w = cmp((uint)r6.w < (uint)r9.z);
          r10.xy = r9.ww ? r7.yz : r9.xy;
          r10.z = r9.w ? sunConstants.splitPinTransform[r6.z].w : sunConstants.splitPinTransform[r7.w].w;
          r9.w = r9.w ? r6.z : r7.w;
          ...
          r10.z = (uint)r9.w;
          r9.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r10.xyz, r5.w).x;
  ...
  r11.w = samp0[]..swiz;
    ...
    r12.xyz = r0.xyz * r0.www + v5.xyz;
    r12.w = 1;
    r8.x = dot(r8.xyzw, r12.xyzw);
    r8.y = dot(r9.xyzw, r12.xyzw);
    r7.yz = r8.xy * float2(0.5,-0.5) + float2(0.5,0.5);
    r7.yz = r7.yz + r11.zw;
    r7.yz = r7.yz * r11.xy;
    r8.xy = r6.zz / r10.xz;
    r8.zw = float2(1,1) + -r8.xy;
    r8.zw = cmp(r7.yz >= r8.zw);
    r8.xy = cmp(r8.xy >= r7.yz);
    ...
    r0.w = samp0[]..swiz;
    // Known bad code for instruction (needs manual fix):
        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r8.xyzw, r5.w, l(100), t12.xyzw
    r8.x = samp0[]..swiz;
    r8.y = samp0[]..swiz;
    r8.z = samp0[]..swiz;
    r8.w = samp0[]..swiz;
    // Known bad code for instruction (needs manual fix):
        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r9.xy, r5.w, l(164), t12.xyxx
    r9.x = samp0[]..swiz;
    r9.y = samp0[]..swiz;
      r5.w = dot(r8.xyzw, r12.xyzw);
      r7.yz = saturate(r7.yz);
      r8.xy = r7.yz * r10.xz + r10.yw;
      r5.w = r5.w + r9.x;
      r5.w = r5.w / r9.y;
      ...
      if (enableDitheredShadow != 0) {
        ...
        r8.z = (uint)r0.w;
        r6.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r8.xyz, r5.w).x;
      }
      r0.w = r6.x * r6.x;
      r0.w = r0.w * r6.x;
    } else {
  ...
  r7.xyz = -v5.xyz * r4.xxx + sunConstants.wldDir.xyz;
  ...
  r2.xzw = r6.xyz * r0.yyy + r17.xyz;
  r4.xyz = r6.xyz * r3.www + r17.xyz;
