...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  r4.xyz = r18.xyz * r2.www;
  r7.yzw = r19.xyz * r2.www;
  r4.w = cmp(r19.w < 0.99000001);
  if (r4.w != 0) {
    r4.w = 1 + -r19.w;
    r6.w = sunConstants.globalProbeExposure * r4.w;
    r8.yzw = -globalProbeConstants.data[0].xyz + v6.xyz;
    r10.x = globalProbeConstants.data[0].w * r8.y;
    r10.yz = globalProbeConstants.data[1].xy * r8.zw;
    r8.yzw = saturate(float3(0.5,0.5,0.5) + r10.xyz);
    r10.xy = globalProbeConstants.data[1].zw * r8.yz;
    r10.z = globalProbeConstants.data[2].x * r8.w;
    r8.yzw = globalProbeConstants.data[2].yzw + r10.xyz;
    r10.xy = cmp(float2(0,0) < r1.xy);
    r10.xy = r10.xy ? float2(0,0) : float2(0.5,0.5);
    r10.z = 0;
    r11.xyz = r10.zzx + r8.yzw;
    r11.xyz = gProbeXArray.SampleLevel(samplerLinearClamp_s, r11.xyz, 0).xyz;
    r12.xyz = r1.xyz * r1.xyz;
    r12.xyz = r12.xyz * r6.www;
    r10.xyz = r10.zzy + r8.yzw;
    ...
    r8.yzw = r8.yzw * r12.zzz + r10.xyz;
    r1.w = 0;
    r10.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r1.xyzw, 6).xyz;
    r8.yzw = r10.xyz * r8.yzw;
    r0.y = dot(r8.yzw, float3(0.212599993,0.715200007,0.0722000003));
    r4.xyz = r18.xyz * r2.www + r8.yzw;
    r9.w = 0;
    r8.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r9.xyzw, r5.w).xyz;
    r1.w = sunConstants.globalProbeExposure * r4.w + -r0.y;
    r0.y = r2.z * r1.w + r0.y;
    r7.yzw = r8.yzw * r0.yyy + r7.yzw;
  }
  r7.yzw = probeReflectionLevel * r7.yzw;
  ...
  if (r2.z == 0) {
    ...
    if (r4.w != 0) {
      ...
      while (true) {
        ...
        if (r6.w != 0) break;
        r6.w = (uint)r4.w;
        r9.xy = -sunConstants.splitPinTransform[r6.w].xy + r8.yz;
        r9.x = max(abs(r9.x), abs(r9.y));
        r5.w = sunConstants.splitPinTransform[r6.w].z * r9.x;
        r6.w = cmp(r5.w < 1);
        if (r6.w != 0) {
          break;
        }
    ...
    if (r6.w == 0) {
      ...
      if (enableDitheredShadow != 0) {
        ...
        r5.w = 28 * r5.w;
        r5.w = (uint)r5.w;
        r10.xy = -sunConstants.splitPinTransform[r6.w].xy + r8.yz;
        r10.xy = sunConstants.splitPinTransform[r6.w].zz * r10.xy;
        r10.xy = r10.xy * float2(0.5,-0.5) + float2(0.5,0.5);
        r8.yz = -sunConstants.splitPinTransform[r4.w].xy + r8.yz;
        r8.yz = sunConstants.splitPinTransform[r4.w].zz * r8.yz;
        ...
        while (true) {
          ...
          if (r10.z != 0) break;
          r10.z = cmp((uint)r5.w < (uint)r9.w);
          r11.xy = r10.zz ? r8.yz : r10.xy;
          r10.w = r10.z ? sunConstants.splitPinTransform[r4.w].w : sunConstants.splitPinTransform[r6.w].w;
          r10.z = r10.z ? r4.w : r6.w;
          ...
          r11.z = (uint)r10.z;
          r10.z = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r11.xyz, r2.z).x;
  ...
  r12.w = samp0[]..swiz;
    ...
    r8.yz = r9.xy * float2(0.5,-0.5) + float2(0.5,0.5);
    r8.yz = r8.yz + r12.zw;
    r8.yz = r8.yz * r12.xy;
    r9.xy = r4.ww / r11.xz;
    r9.zw = float2(1,1) + -r9.xy;
    r9.zw = cmp(r8.yz >= r9.zw);
    r9.xy = cmp(r9.xy >= r8.yz);
    r9.xy = (int2)r9.xy | (int2)r9.zw;
    r0.y = (int)r9.y | (int)r9.x;
    if (r0.y == 0) {
    // Known bad code for instruction (needs manual fix):
    ...
    r10.y = samp0[]..swiz;
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          r7.x = cmp((int)r6.w >= 8);
          if (r7.x != 0) break;
          r8.x = dot(icb[r6.w+0].yx, r10.xy);
          r8.y = dot(icb[r6.w+0].yx, r10.yz);
          r11.xy = r8.xy * r4.ww + r9.xy;
  ...
  r8.xyz = sunConstants.color.xyz * r2.www;
  r9.xyz = -v6.xyz * r3.www + sunConstants.wldDir.xyz;
  r0.y = dot(r9.xyz, r9.xyz);
  r0.y = rsqrt(r0.y);
  r9.xyz = r9.xyz * r0.yyy;
  r0.y = saturate(dot(r1.xyz, r9.xyz));
  r1.x = saturate(dot(r9.xyz, sunConstants.wldDir.xyz));
  ...
  r1.x = r1.w + r1.w;
  r1.x = r1.w / r1.x;
  r6.xyz = r8.xyz * r0.yyy + r7.yzw;
  r1.xyz = r8.xyz * r1.xxx + r4.xyz;
  r4.xyz = r8.xyz * r1.www + r4.xyz;
  r1.xyz = r1.xyz * r3.xyz;
  r0.xyz = r4.xyz * r0.xzw + -r1.xyz;
