...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  r4.xyz = detailMap.Sample(normalSampler_s, r3.xy).xyz;
  r3.zw = r4.xy * float2(1.9921875,1.9921875) + float2(-1,-1);
  r2.w = r4.z * r4.z;
  r2.w = 0.333333343 * r2.w;
  r2.w = min(1, r2.w);
  r2.xy = r3.zw * detailScaleHeight + r1.yz;
  ...
  r1.y = rsqrt(r1.y);
  r2.xyz = r2.xyz * r1.yyy;
  r1.y = specOcclusionMap.Sample(colorSampler_s, r3.xy).x;
  r1.y = -1 + r1.y;
  r1.y = detailScaleHeight * r1.y + 1;
  r1.w = thicknessMap.Sample(colorSampler_s, w1.xy).x;
  r1.w = 1 + -r1.w;
  r3.xyz = float3(1,0.5,0.5) * r1.www;
  ...
  if (enableGTAO != 0) {
    ...
    r5.x = 1 + -abs(r1.w);
    r5.x = sqrt(r5.x);
    r5.y = abs(r1.w) * -0.0187292993 + 0.0742610022;
    r5.y = r5.y * abs(r1.w) + -0.212114394;
    r5.y = r5.y * abs(r1.w) + 1.57072878;
    r5.z = r5.y * r5.x;
...
r4.z = samp0[]..swiz;
  ...
  if (r6.y != 0) {
    r6.yw = r3.ww * float2(0.5,0.5) + float2(1.33333337,2);
  ...
  r5.z = 100 * r5.z;
  r8.xy = -r3.ww * float2(10,5) + float2(6.85740995,7.08500004);
  r5.w = exp2(r8.x);
  r5.w = r5.x * r5.w;
  r5.w = 9.1368103 * r5.w;
  r6.w = r4.w * r3.w;
      ...
      r23.y = samp0[]..swiz;
        ...
        r30.w = samp0[]..swiz;
          ...
          r36.y = samp0[]..swiz;
            ...
            r22.x = r20.w;
            r22.yz = r21.xy;
            r21.xyw = r14.zwy * r10.yyy + r22.yzx;
            r20.w = r21.w;
          }
        }
      }
        ...
        r24.y = samp0[]..swiz;
          ...
          r31.w = samp0[]..swiz;
            ...
            while (true) {
              ...
              if (r22.w != 0) break;
              r22.w = (int)r15.w + (int)r17.w;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r28.xyzw, r22.w, l(0), t16.xyzw
            r28.x = samp0[]..swiz;
            r28.y = samp0[]..swiz;
            r28.z = samp0[]..swiz;
            r28.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r29.xyzw, r22.w, l(16), t16.xyzw
            r29.x = samp0[]..swiz;
            r29.y = samp0[]..swiz;
            r29.z = samp0[]..swiz;
            r29.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r30.xyzw, r22.w, l(32), t16.xyzw
            r30.x = samp0[]..swiz;
            r30.y = samp0[]..swiz;
            r30.z = samp0[]..swiz;
            r30.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r31.xyzw, r22.w, l(48), t16.xyzw
            r31.x = samp0[]..swiz;
            r31.y = samp0[]..swiz;
            r31.z = samp0[]..swiz;
            r31.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r32.xyzw, r22.w, l(64), t16.xyzw
            r32.x = samp0[]..swiz;
            r32.y = samp0[]..swiz;
            r32.z = samp0[]..swiz;
            r32.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r33.xyzw, r22.w, l(80), t16.xyzw
            r33.x = samp0[]..swiz;
            r33.y = samp0[]..swiz;
            r33.z = samp0[]..swiz;
            r33.w = samp0[]..swiz;
              ...
              r22.w = -r22.w * r23.w + 1;
              r22.w = r27.y * r22.w;
              r14.y = r26.w ? r22.w : r27.z;
              r27.xy = r26.zz ? r27.xy : r14.xy;
              r17.w = (int)r17.w + 1;
              r12.x = r25.w;
            }
            r12.x = saturate(r27.y + -r10.y);
            r14.y = r12.x * r14.w;
            r14.z = cmp(0 < r14.y);
            if (r14.z != 0) {
            // Known bad code for instruction (needs manual fix):
            ...
            r37.y = samp0[]..swiz;
              ...
              r33.z = r34.z;
              r14.y = dot(r11.xyz, r33.xyz);
              r14.z = dot(r25.xyz, r33.xyz);
              r14.z = r14.z + -r34.w;
              r14.w = cmp(r14.z >= 0);
              r14.z = max(abs(r14.z), r5.z);
              r14.z = r14.w ? r14.z : -r14.z;
              ...
              r13.w = min(abs(r14.y), r13.w);
              r37.zw = r36.zw;
              r14.y = dot(r11.zxy, r37.xzw);
              r14.z = dot(r25.zxy, r37.xzw);
              r14.z = r14.z + -r37.y;
              r14.w = cmp(r14.z >= 0);
              r14.z = max(abs(r14.z), r5.z);
              r14.z = r14.w ? r14.z : -r14.z;
              ...
              if (9 == 0) r14.y = 0; else if (9+16 < 32) {               r14.y = (uint)r24.w << (32-(9 + 16)); r14.y = (uint)r14.y >> (32-9);              } else r14.y = (uint)r24.w >> 16;
              r32.w = (uint)r14.y;
              r14.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r32.xyzw, r13.w).xyz;
  ...
  r8.xyz = r18.xyz * r3.www;
  r9.xyz = r19.xyz * r3.www;
  r5.z = cmp(r19.w < 0.99000001);
  if (r5.z != 0) {
    r5.z = 1 + -r19.w;
    ...
    r8.xyz = r18.xyz * r3.www + r2.xyz;
    r11.w = 0;
    r2.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r11.xyzw, r4.w).xyz;
    r3.w = sunConstants.globalProbeExposure * r5.z + -r2.w;
    r2.w = r5.y * r3.w + r2.w;
    r9.xyz = r2.xyz * r2.www + r9.xyz;
  }
