...
r0.w = shaderConstantSetBuffer[]..swiz;
  ...
  r0.x = dot(r2.xzw, r3.xyz);
  r0.y = dot(r2.xzw, r5.xyz);
  r0.z = dot(r2.xzw, r7.xyz);
  r0.w = dot(r0.xyz, r0.xyz);
  r0.w = rsqrt(r0.w);
...
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) r0.xy, r2.y, l(36), t0.xyxx
r0.x = shaderConstantSetBuffer[]..swiz;
r0.y = shaderConstantSetBuffer[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) r0.zw, r2.y, l(52), t0.xxxy
r0.z = shaderConstantSetBuffer[]..swiz;
r0.w = shaderConstantSetBuffer[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) r1.xy, r2.y, l(68), t0.xyxx
r1.x = shaderConstantSetBuffer[]..swiz;
r1.y = shaderConstantSetBuffer[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) r1.zw, r2.y, l(84), t0.xxxy
r1.z = shaderConstantSetBuffer[]..swiz;
r1.w = shaderConstantSetBuffer[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) r2.xz, r2.y, l(100), t0.xxyx
r2.x = shaderConstantSetBuffer[]..swiz;
r2.z = shaderConstantSetBuffer[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) r2.yw, r2.y, l(116), t0.xxxy
r2.y = shaderConstantSetBuffer[]..swiz;
r2.w = shaderConstantSetBuffer[]..swiz;
  r3.xyzw = cmp(float4(4,3,2,1) < scriptVectorOffset);
  r4.x = cmp(0 < scriptVectorOffset);
  r0.xy = r4.xx ? r0.zw : r0.xy;
  r0.xy = r3.ww ? r1.xy : r0.xy;
  r0.xy = r3.zz ? r1.zw : r0.xy;
  r0.xy = r3.yy ? r2.xz : r0.xy;
  o7.xy = r3.xx ? r2.yw : r0.xy;
  o1.x = v1.w;
  p1.xy = v2.xy;
  o6.xyz = r8.xyz;
  o2.x = v7.x;
