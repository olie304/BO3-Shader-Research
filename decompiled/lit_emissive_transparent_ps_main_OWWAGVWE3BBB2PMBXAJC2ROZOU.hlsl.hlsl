...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  r3.xy = -r3.xy / r1.ww;
  r3.xy = r2.yy ? r3.xy : 0;
  r2.y = 9.99999975e-06 + relativeHDR;
  r3.xy = r3.xy * r2.yy + v2.xy;
  r2.y = yTexture.Sample(ySampler_s, r3.xy).x;
  r4.x = -0.0625 + r2.y;
