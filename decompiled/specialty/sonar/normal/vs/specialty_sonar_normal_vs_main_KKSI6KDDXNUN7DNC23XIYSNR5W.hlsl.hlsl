...
r6.w = gpuSkinBase[]..swiz;
  ...
  r1.xy = v3.zz * v0.xy;
  r0.xyzw = float4(0.0416666679,0.0416666679,0.0416666679,0.0416666679) * r0.xyzw;
  r0.xy = r0.xy + r0.zw;
  o7.xy = r1.xy * float2(0.0416666679,0.0416666679) + r0.xy;
  o8.xyz = eyeOffset.xyz + r8.xyz;
  o1.x = v1.w;
  p1.xy = v2.xy;
  o6.xyz = r8.xyz;
  o2.x = v7.x;
