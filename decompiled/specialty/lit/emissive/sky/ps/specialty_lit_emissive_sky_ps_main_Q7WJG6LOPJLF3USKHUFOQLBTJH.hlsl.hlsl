// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:42:10 2021
...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r5.w = min(1, r5.w);
  r6.y = v8.x ? 1 : -1;
  r6.z = dot(v3.xyz, v3.xyz);
  r6.z = rsqrt(r6.z);
  r7.xyz = v3.xyz * r6.zzz;
  ...
  r6.w = 5 * r4.w;
  r8.z = r4.w * 5 + -2.5;
  r8.z = 0.400000006 * r8.z;
  r8.z = max(0, r8.z);
  r9.zw = -r4.ww * float2(10,5) + float2(6.85740995,7.08500004);
  r8.w = exp2(r9.z);
  r8.w = r9.x * r8.w;
  r8.zw = float2(100,9.1368103) * r8.zw;
  r9.z = r6.w * r4.w;
  ...
  r13.z = (uint)r2.z << 4;
  r2.y = (int)r9.z & -32;
  r2.z = (int)-r2.y + (int)r9.z;
  r2.w = numRefProbes & -32;
  r9.w = (int)-r2.w + numRefProbes;
  r14.xy = float2(0,0);
  r15.w = 0;
  r16.yz = float2(0,1);
  r17.xy = float2(0,0);
      ...
      r15.y = samp0[]..swiz;
        ...
        r32.w = samp0[]..swiz;
          ...
          r38.y = samp0[]..swiz;
            ...
            r25.x = r23.w;
            r25.yz = r24.xy;
            r24.xyw = r15.yzx * r13.www + r25.yzx;
            r23.w = r24.w;
          }
        }
      }
  ...
  if (r2.z != 0) {
    ...
    r16.xyz = cmp(float3(0,0,0) < r5.xyz);
    ...
    r5.w = 0;
    r16.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r5.xyzw, 6).xyz;
    r15.xyz = r16.xyz * r15.xyz;
    r2.w = dot(r15.xyz, float3(0.212599993,0.715200007,0.0722000003));
    r14.xyz = r21.xyz * r2.yyy + r15.xyz;
    r12.w = 0;
    r15.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r12.xyzw, r6.w).xyz;
    r2.y = sunConstants.globalProbeExposure * r2.z + -r2.w;
    r2.y = r9.y * r2.y + r2.w;
    r11.yzw = r15.xyz * r2.yyy + r11.yzw;
  }
    ...
    if (r6.w == 0) {
      ...
      if (r8.w != 0) {
        ...
        while (true) {
          ...
          r10.w = sunConstants.splitPinTransform[r11.y].z * r11.z;
          r11.y = cmp(r10.w < 1);
          if (r11.y != 0) {
            break;
          }
      ...
      if (r11.y == 0) {
        ...
        if (enableDitheredShadow != 0) {
          ...
          while (true) {
            ...
            if (r13.w != 0) break;
            r13.w = cmp((uint)r10.w < (uint)r12.w);
            r17.xy = r13.ww ? r9.yz : r11.yz;
  ...
  if (r8.w != 0) {
    ...
    if (r8.w != 0) {
      ...
      if (sunConstants.sunCookieIndex != 0) {
        ...
        r16.w = 1;
        r9.y = dot(sunConstants.sunCookieTransform[0].xyzw, r16.xyzw);
        r9.z = dot(sunConstants.sunCookieTransform[1].xyzw, r16.xyzw);
        r16.xy = frac(r9.yz);
      ...
      if (noReceiveShadow == 0) {
        ...
        r19.z = samp0[]..swiz;
        r19.w = samp0[]..swiz;
          r11.z = abs(r6.w) * -0.200000003 + 0.400000006;
          r11.w = cmp(r6.w < 0);
          r11.z = r11.w ? -r11.z : r11.z;
          r20.xyz = r5.xyz * r11.zzz + v6.xyz;
          r20.w = 1;
          r16.x = dot(r16.xyzw, r20.xyzw);
          r16.y = dot(r17.xyzw, r20.xyzw);
          r11.zw = r16.xy * float2(0.5,-0.5) + float2(0.5,0.5);
          r11.zw = r11.zw + r19.zw;
          r11.zw = r11.zw * r19.xy;
          r16.xy = r11.yy / r18.xz;
          r16.zw = float2(1,1) + -r16.xy;
          r16.zw = cmp(r11.zw >= r16.zw);
          r16.xy = cmp(r16.xy >= r11.zw);
          ...
          r17.x = samp0[]..swiz;
          r17.y = samp0[]..swiz;
            r10.w = dot(r16.xyzw, r20.xyzw);
            r11.zw = saturate(r11.zw);
            r16.xy = r11.zw * r18.xz + r18.yw;
            r10.w = r10.w + r17.x;
            r10.w = r10.w / r17.y;
            ...
            if (enableDitheredShadow != 0) {
              ...
              while (true) {
                ...
                r18.xy = r19.xy * r11.yy + r16.xy;
                r13.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r18.xyz, r10.w).x;
                r11.w = r13.w * 0.125 + r11.w;
                r12.w = (int)r12.w + 1;
              }
            } else {
              r16.z = (uint)r11.z;
              r11.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r10.w).x;
            }
            r10.w = r11.w * r11.w;
            r10.w = r10.w * r11.w;
          } else {
      ...
      r10.w = r3.w * r10.w + abs(r6.w);
      r10.w = r10.w * r8.z;
      r11.y = cmp(0 < r6.w);
      r16.xyz = r10.www * r9.yzw + r14.xyz;
      r6.w = saturate(r6.w);
      r17.xyz = -v6.xyz * r0.xxx + sunConstants.wldDir.xyz;
      r0.x = dot(r17.xyz, r17.xyz);
      r0.x = rsqrt(r0.x);
      r17.xyz = r17.xyz * r0.xxx;
      r0.x = dot(r17.xyz, r0.yzw);
      r10.w = dot(r5.xyz, r17.xyz);
      r11.z = abs(r10.w) * r3.y + -abs(r10.w);
      r10.w = abs(r10.w) * r11.z + 1;
      r11.z = r6.w * r4.w + r5.w;
      r10.w = r10.w * r10.w;
      r10.w = r10.w * r11.z;
      r10.w = rcp(r10.w);
      r6.w = r6.w * r8.w;
      r6.w = r10.w * r6.w;
      r6.w = r6.w * r8.z;
      r17.xyz = r6.www * r9.yzw + r2.yzw;
      r0.x = saturate(1 + -r0.x);
      r8.z = r0.x * r0.x;
      r8.z = r8.z * r8.z;
      r0.x = r8.z * r0.x;
      r0.x = r6.w * r0.x;
      r18.xyz = r0.xxx * r9.zwy + r15.xyz;
      r16.w = r18.z;
      r14.w = r15.z;
      r14.xyzw = r11.yyyy ? r16.xyzw : r14.xyzw;
      r18.zw = r17.xy;
      r15.zw = r2.yz;
      r16.xyzw = r11.yyyy ? r18.xyzw : r15.xyzw;
      r2.w = r11.y ? r17.z : r2.w;
      r15.z = r14.w;
      r15.xy = r16.xy;
      r2.yz = r16.zw;
    }
  ...
  while (true) {
    ...
    r9.z = visibleLights.Load(r17.xyzw).x;
    r17.xyz = r11.yzw;
    r30.xyz = r28.xyz;
    r31.xyz = r29.xyz;
    r9.w = r8.z;
      ...
      r33.y = samp0[]..swiz;
        ...
        r38.w = samp0[]..swiz;
          ...
          switch (r13.w) {
            ...
            r25.w = rsqrt(r21.w);
            r42.xyz = r42.xyz * r25.www;
            r25.w = dot(r5.xyz, r42.xyz);
            ...
            if (r26.w != 0) {
              ...
              r21.w = r27.w / r21.w;
              r21.w = min(1, r21.w);
              r42.xy = saturate(r26.ww * r34.xz + r34.yw);
              ...
              r26.w = cmp(0 < r21.w);
              if (r26.w != 0) {
                if (3 == 0) r26.w = 0; else if (3+27 < 32) {                 r26.w = (uint)r33.w << (32-(3 + 27)); r26.w = (uint)r26.w >> (32-3);                } else r26.w = (uint)r33.w >> 27;
                r26.w = cmp((int)r26.w != 1);
                if (r26.w != 0) {
                  r26.w = abs(r25.w) * -0.200000003 + 0.400000006;
                  r27.w = cmp(r25.w < 0);
                  r26.w = r27.w ? -r26.w : r26.w;
                  r42.xyz = r5.xyz * r26.www + v6.xyz;
                  r42.xyz = r42.xyz + -r36.xyz;
                  r26.w = max(abs(r42.y), abs(r42.z));
                  r26.w = max(abs(r42.x), r26.w);
                  r26.w = r37.x / r26.w;
                  r26.w = r26.w + r37.y;
                  r27.w = dot(r42.xyz, r42.xyz);
                  r27.w = rsqrt(r27.w);
                  r26.w = max(6.10351563e-05, r26.w);
                  r28.w = (int)r33.w & 0x0000ffff;
                  r43.w = (uint)r28.w;
                  r28.w = 0;
                  r29.w = 0;
                  while (true) {
                    ...
                    if (r30.w != 0) break;
                    r44.y = dot(icb[r29.w+0].yx, r16.xy);
                    r44.z = dot(icb[r29.w+0].yx, r16.yz);
                    r44.yz = r44.yz * r35.yy;
                    r44.x = r44.y * r11.x;
                    r44.w = r44.y * r3.x;
                    r43.xyz = r42.xyz * r27.www + r44.xzw;
                    r30.w = gOmniShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r43.xyzw, r26.w).x;
                ...
                if (r26.w != 0) {
                  r26.w = r33.x * r3.y;
                  r26.w = 0.25 * r26.w;
                  r27.w = dot(r39.xyz, r12.xyz);
                  r29.w = dot(r12.xyz, r41.xyz);
                  r30.w = -r27.w * r27.w + r38.x;
                    ...
                    r14.w = samp0[]..swiz;
                      ...
                      if (r9.w != 0) {
                        ...
                        while (true) {
                          ...
                          r27.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r42.xyz, r19.x).x;
                  ...
                  r14.w = saturate(dot(r5.xyz, r40.xyz));
                  r39.xyz = r39.xyz * r13.www + r0.yzw;
                  r13.w = dot(r39.xyz, r39.xyz);
                  r13.w = rsqrt(r13.w);
                  r39.xyz = r39.xyz * r13.www;
                  r13.w = dot(r39.xyz, r0.yzw);
            ...
            r40.w = samp0[]..swiz;
              ...
              if (r15.w != 0) {
                  ...
                  r40.y = samp0[]..swiz;
                    ...
                    if (r9.w != 0) {
                      ...
                      while (true) {
                        ...
                        if (r27.w != 0) break;
                        r34.x = dot(icb[r26.w+0].xy, r25.xy);
                        r34.y = dot(icb[r26.w+0].yx, r25.xz);
                        r32.xy = r34.xy * r35.yy + r22.xy;
                        r27.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r32.xyz, r12.w).x;
                ...
                if (r15.w != 0) {
                  r15.w = r33.x * r3.y;
                  r15.w = 0.25 * r15.w;
                  if (4 == 0) r19.x = 0; else if (4+16 < 32) {                   r19.x = (uint)r33.w << (32-(4 + 16)); r19.x = (uint)r19.x >> (32-4);                  } else r19.x = (uint)r33.w >> 16;
                  ...
                  r38.w = samp0[]..swiz;
                    ...
                    r32.y = samp0[]..swiz;
                      ...
                      if (r9.w != 0) {
                        ...
                        while (true) {
                          r27.w = cmp((int)r26.w >= 8);
                          if (r27.w != 0) break;
                          r32.x = dot(icb[r26.w+0].xy, r26.xy);
                          r32.y = dot(icb[r26.w+0].yx, r26.xz);
                        ...
                        r33.z = (uint)r22.y;
                        r22.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r33.xyz, r19.x).x;
                      }
                      r19.x = r22.z * r22.z;
                      r19.x = r19.x * r22.z;
                    } else {
                    ...
                    if (4 == 0) r19.x = 0; else if (4+20 < 32) {                     r19.x = (uint)r33.w << (32-(4 + 20)); r19.x = (uint)r19.x >> (32-4);                    } else r19.x = (uint)r33.w >> 20;
                    r22.x = cmp(0 < (uint)r19.x);
                    r22.x = r22.x ? r0.x : 0;
                    if (r22.x != 0) {
                      r19.x = (int)r19.x + numLights;
                    ...
                    r37.w = samp0[]..swiz;
                      ...
                      r24.z = samp0[]..swiz;
                        ...
                        if (r9.w != 0) {
                          ...
                          r32.z = (uint)r22.y;
                          r24.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r32.xyz, r19.x).x;
                        }
                        r19.x = r24.x * r24.x;
                        r19.x = r19.x * r24.x;
                      } else {
                  ...
                  r19.x = r19.x * r12.w;
                  r22.x = cmp(0 < r14.w);
                  r23.xyz = r19.xxx * r21.xyw + r17.xyz;
                  ...
                  r14.w = r19.x * r14.w;
                  r12.w = r14.w * r12.w;
                  r20.xyz = r12.www * r21.xyw + r31.xyz;
                  r13.w = saturate(1 + -r13.w);
                  r14.w = r13.w * r13.w;
                  r14.w = r14.w * r14.w;
                  r13.w = r14.w * r13.w;
                  r12.w = r13.w * r12.w;
                  r21.xyw = r12.www * r21.xyw + r30.xyz;
  ...
  r0.w = (int)r7.w & 0x7f800000;
  r0.w = cmp((int)r0.w == 0x7f800000);
  r2.xyzw = cmp(r7.xyzw == float4(0,0,0,0));
  r2.xy = r2.zw ? r2.xy : 0;
  r1.w = r2.y ? r2.x : 0;
  ...
  o0.xyzw = r0.wwww ? float4(0,0,0,0) : r7.xyzw;
  return;
}