// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:42:23 2021
...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  r0.xyzw = colorTiling.xy * w1.xyyz;
  ...
  r5.x = dot(r4.xyz, v4.xyz);
  r5.y = dot(r4.xyz, v5.xyz);
  r3.w = dot(r4.xyz, v3.xyz);
  r4.w = cmp(0 < r3.w);
  r5.xy = -r5.xy / r3.ww;
  r5.xy = r4.ww ? r5.xy : 0;
...
r6.y = samp0[]..swiz;
  ...
  if (r0.z == 0) {
    ...
    if (r0.w != 0) {
      ...
      r8.yzw = -globalProbeConstants.data[0].xyz + v6.xyz;
  ...
  if (r6.w != 0) {
    ...
    if (r6.w != 0) {
      ...
      r13.xyz = -v6.xyz * r1.www + sunConstants.wldDir.xyz;
