...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:42:21 2021
//
//
// Buffer Definitions: 
//
...
loop 
  ...
  loop 
    ...
    if_nz r12.z
      ...
      and r12.y, r22.y, r22.x
      and r12.y, r22.z, r12.y
      if_nz r12.y
        ...
        loop 
          ...
          mul r25.x, r17.w, r22.w
          ushr r24.w, r13.x, l(2)
          ubfe r25.z, l(1), l(2), r13.x
          and r25.w, r24.w, l(2)
          max r26.x, r25.x, r25.y
          mad r17.w, -r17.w, r22.w, l(1.000000)
          mul r17.w, r17.w, r25.y
          movc r15.y, r25.w, r17.w, r26.x
          movc r25.xy, r25.zzzz, r25.xyxx, r15.xyxx
          iadd r16.w, r16.w, l(1)
          mov r13.x, r24.w
        endloop 
        mov_sat r25.y, r25.y
        mul r12.y, r12.z, r25.y
        ...
        if_nz r13.x
          ...
          mad r21.z, r25.y, r12.z, r21.z
          mul r12.x, r23.z, r12.y
          mov r23.z, r31.z
          dp3 r12.y, r9.xyzx, r23.xyzx
          ...
          mov r31.z, r32.z
          dp3 r12.z, r9.xyzx, r31.xyzx
          dp3 r13.x, r24.xyzx, r31.xyzx
          ...
          mov r32.z, r33.z
          dp3 r12.z, r9.xyzx, r32.xyzx
          dp3 r13.x, r24.xyzx, r32.xyzx
          ...
          min r12.y, |r12.z|, r12.y
          mov r36.zw, r35.zzzw
          dp3 r12.z, r9.zxyz, r36.xzwx
          dp3 r13.x, r24.zxyz, r36.xzwx
          ...
          utof r31.w, r12.z
          sample_l_indexable(texturecubearray)(float,float,float,float) r15.yzw, r31.xyzw, t8.wxyz, s2, r12.y
          ...
          dp3 r12.y, r24.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
          ...
          mov r22.x, r20.w
          mov r22.yz, r21.xxyx
          mad r21.xyw, r15.zwzy, r12.xxxx, r22.yzyx
          mov r20.w, r21.w
        endif 
      endif 
    endif 
    ...
    loop 
      ...
      if_nz r15.z
        ...
        if_nz r14.w
          ...
          mul r13.x, r17.w, r21.w
          and r17.w, r15.z, l(1)
          movc r26.xy, r17.wwww, r13.xyxx, r13.zxzz
          mov r13.x, r15.z
          mov r27.xy, r26.xyxx
          mov r17.w, l(1)
          loop 
            ...
            movc r15.y, r26.w, r21.w, r27.z
            movc r27.xy, r26.zzzz, r27.xyxx, r15.xyxx
            iadd r17.w, r17.w, l(1)
            mov r13.x, r25.w
          endloop 
          add_sat r13.x, -r11.z, r27.y
          ...
          if_nz r15.y
            ...
            mul r13.x, r24.z, r14.w
            mov r24.z, r32.z
            dp3 r13.w, r9.xyzx, r24.xyzx
            ...
            min r13.w, r13.w, |r14.w|
            mov r37.zw, r36.zzzw
            dp3 r14.w, r9.zxyz, r37.xzwx
            dp3 r15.y, r25.zxyz, r37.xzwx
            ...
            utof r32.w, r14.w
            sample_l_indexable(texturecubearray)(float,float,float,float) r15.yzw, r32.xyzw, t8.wxyz, s2, r13.w
            ...
            mad r12.xyz, r23.xyzx, r24.xyzx, r12.xyzx
...
max r0.z, r19.w, l(1.000000)
rcp r0.z, r0.z
mov_sat r19.w, r19.w
mul r11.xyz, r0.zzzz, r18.xyzx
mul r8.yzw, r0.zzzz, r19.xxyz
lt r0.w, r19.w, l(0.990000)
if_nz r0.w
  add r0.w, -r19.w, l(1.000000)
  mul r3.w, r0.w, cb2[19].x
  add r12.xyz, v7.xyzx, -cb2[35].xyzx
  ...
  mad r11.xyz, r18.xyzx, r0.zzzz, r12.xyzx
  mov r9.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r12.xyz, r9.xyzw, t8.xyzw, s2, r6.z
  mad r0.z, cb2[19].x, r0.w, -r2.w
  mad r0.z, r0.y, r0.z, r2.w
  mad r8.yzw, r12.xxyz, r0.zzzz, r8.yyzw
endif 
...
mul r12.xyz, r0.yyyy, r8.zwyz
mul r0.yzw, r0.zzzz, r8.yyzw
sqrt r2.w, r5.z
...
if_z r6.w
  ...
  if_nz r9.w
    ...
    loop 
      ...
      breakc_nz r13.x
      ftou r13.x, r9.w
      add r13.yz, r8.yyzy, -cb2[r13.x + 20].xxyx
  ...
  if_nz r13.x
    ...
    rcp r14.xz, r13.yyyy
    mov r14.y, -r14.z
    mad r13.yzw, r8.yyzy, r14.xxyz, r13.zzwz
    ...
    if_z r14.z
      ...
      if_z r14.y
        ...
        mad r13.z, r8.y, r13.w, r13.z
        mad r13.y, r8.z, r13.y, r13.z
  ...
  if_z r13.x
    if_z cb2[58].y
      ...
      itof r8.w, cb2[26].y
      add r13.z, r8.w, r9.w
      sample_c_lz_indexable(texture2darray)(float,float,float,float) r8.w, r13.xyzx, t13.xxxx, s13, r6.w
    ...
    if_nz cb2[58].y
      ...
      loop 
        ...
        movc r15.xy, r14.wwww, r8.yzyy, r14.xyxx
        movc r15.z, r14.w, cb2[r9.w + 20].w, cb2[r8.w + 20].w
        movc r14.w, r14.w, r9.w, r8.w
        ...
        utof r15.z, r14.w
        sample_c_lz_indexable(texture2darray)(float,float,float,float) r14.w, r15.xyzx, t13.xxxx, s13, r6.w
...
if_nz r6.w
  ...
  if_nz r6.w
    ...
    if_nz cb2[23].x
      ...
      dp4 r8.y, cb2[24].xyzw, r13.xyzw
      dp4 r8.z, cb2[25].xyzw, r13.xyzw
      frc r13.xy, r8.yzyy
    ...
    if_nz r10.w
      ...
      mad r17.x, |r5.w|, l(-0.200000), l(0.400000)
      mad r17.xyz, r2.xyzx, r17.xxxx, v7.xyzx
      ...
      if_z r13.z
        ...
        if_nz cb2[58].y
          ...
          loop 
            ...
            sample_c_lz_indexable(texture2darray)(float,float,float,float) r13.w, r16.xyzx, t9.xxxx, s13, r9.w
            mad r13.y, r13.w, l(0.125000), r13.y
            iadd r13.z, r13.z, l(1)
          endloop 
        else 
          utof r14.z, r13.x
          sample_c_lz_indexable(texture2darray)(float,float,float,float) r13.y, r14.xyzx, t9.xxxx, s13, r9.w
        endif 
    ...
    mad r13.xyz, r9.wwww, r8.yzwy, r11.xyzx
    mad r14.xyz, -v7.xyzx, r1.wwww, cb2[17].xyzx
    dp3 r1.w, r14.xyzx, r14.xyzx
    rsq r1.w, r1.w
    mul r14.xyz, r1.wwww, r14.xyzx
    dp3 r1.w, r14.xyzx, r4.xyzx
    dp3 r9.w, r2.xyzx, r14.xyzx
    ...
    mad r14.xyz, r6.zzzz, r8.yzwy, r0.yzwy
    ...
    mov r15.zw, r14.xxxy
    mov r12.zw, r0.yyyz
    movc r13.xyzw, r5.wwww, r15.xyzw, r12.xyzw
    movc r0.w, r5.w, r14.z, r0.w
    mov r12.z, r11.w
    mov r12.xy, r13.xyxx
    mov r0.yz, r13.zzwz
  endif 
    ...
    if_nz r12.w
      ...
      if_nz r11.w
        ...
        switch r11.w
          ...
          div_sat r14.z, -r12.w, r36.x
          mad r40.xyz, r14.zzzz, r37.xyzx, r38.xyzx
          ...
          if_nz r24.w
            ...
            mul r14.w, r14.w, r40.x
            mul r14.w, r40.y, r14.w
            ...
            if_nz r24.w
              ...
              if_nz r24.w
                ...
                loop 
                  ige r28.w, r27.w, l(8)
                  breakc_nz r28.w
                  dp2 r42.y, icb[r27.w + 0].yxyy, r13.xyxx
                  dp2 r42.z, icb[r27.w + 0].yxyy, r13.yzyy
              ...
              if_nz r24.w
                ...
                add r12.w, -r14.z, r12.w
                mad r12.w, r25.w, r12.w, r14.z
                ...
                if_nz r14.z
                  ...
                  mad r17.xyz, r2.xyzx, r25.wwww, v7.xyzx
                  dp4 r25.w, r39.xyzw, r17.xyzw
                  dp4 r27.w, r40.xyzw, r17.xyzw
                  ...
                  if_z r28.w
                    ...
                    mul r17.x, r27.w, r43.y
                    mad r17.y, r43.x, r27.w, r25.w
                    div r17.x, r17.y, r17.x
                  else 
                    mov r17.z, l(-1)
                  endif 
                  or r17.y, r28.w, r17.z
                  if_z r17.y
                    ...
                    if_nz r7.w
                      ...
                      loop 
                        ige r25.w, r17.z, l(8)
                        breakc_nz r25.w
                        dp2 r41.x, icb[r17.z + 0].yxyy, r13.xwxx
                        dp2 r41.y, icb[r17.z + 0].xyxx, r6.xyxx
                        mad r40.xy, r41.xyxx, r14.zzzz, r39.xyxx
                        sample_c_lz_indexable(texture2darray)(float,float,float,float) r25.w, r40.xyzx, t9.xxxx, s13, r17.x
                        mad r17.y, r25.w, l(0.125000), r17.y
                  ...
                  if_nz r14.z
                    ...
                    ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r39.xyzw, r12.w, l(100), t12.xyzw
                    ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r40.xyzw, r12.w, l(116), t12.xyzw
                    mad r17.x, |r19.w|, l(-0.200000), l(0.400000)
                    mad r18.xyz, r2.xyzx, r17.xxxx, v7.xyzx
                    dp4 r17.x, r39.xyzw, r18.xyzw
                    dp4 r17.z, r40.xyzw, r18.xyzw
                    lt r25.w, r17.z, r17.x
                    if_z r25.w
                      ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r39.xyzw, r12.w, l(68), t12.xyzw
                      ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r40.xyzw, r12.w, l(84), t12.xyzw
                      ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r41.xyzw, r12.w, l(132), t12.xyzw
                    ...
                    if_z r17.z
                      ...
                      if_nz r7.w
                        ...
                        loop 
                          ...
                          mad r18.xy, r40.xyxx, r14.zzzz, r39.xyxx
                ...
                mad r19.w, |r17.x|, r5.y, -|r17.x|
                mad r17.x, |r17.x|, r19.w, l(1.000000)
                mad r19.w, r12.w, r2.w, r3.w
                ...
                movc r15.xyz, r14.zzzz, r18.xyzx, r15.xyzx
                movc r28.xyz, r14.zzzz, r38.xyzx, r28.xyzx
                movc r29.xyz, r14.zzzz, r37.xyzx, r29.xyzx
              endif 
            endif 
          endif 
          break 
          ...
          if_nz r14.w
            ...
            mov r39.w, r38.y
            dp4 r14.w, r39.xyzw, r16.xyzw
            lt r17.x, r14.w, l(1.000000)
            if_nz r17.x
              ...
              mad_sat r32.xy, r14.wwww, r32.xzxx, r32.ywyy
              ...
              if_nz r14.w
                ...
                mul r14.w, r24.w, r25.w
              endif 
              mul r17.x, r14.w, r23.w
              and r14.w, r19.w, l(255)
              if_nz r14.w
            ...
            lt r14.w, l(0.000000), r17.x
            if_nz r14.w
              ubfe r14.w, l(3), l(27), r31.w
              ine r14.w, r14.w, l(1)
              if_nz r14.w
                mad r14.w, |r12.w|, l(-0.200000), l(0.400000)
                mad r20.xyz, r2.xyzx, r14.wwww, v7.xyzx
                mov r37.xyz, r36.xyzx
                dp4 r14.w, r37.xyzw, r20.xyzw
                dp4 r23.w, r39.xyzw, r20.xyzw
                ge r24.w, r23.w, r14.w
                if_nz r24.w
                  ...
                  div r10.w, r14.w, r23.w
                  max r10.w, r10.w, l(0.00006104)
                  and r14.w, r31.w, l(0x0000ffff)
                  if_nz r7.w
                    utof r30.z, r14.w
                    mov r23.w, l(0)
                    mov r24.w, l(0)
              ...
              if_nz r14.w
                mul r14.w, r5.y, r31.x
                mul r14.w, r14.z, r14.w
                ubfe r17.x, l(4), l(16), r31.w
                ult r20.x, l(0), r17.x
                ...
                if_nz r20.x
                  ...
                  if_z r21.x
                    ...
                    mul r17.x, r20.z, r30.y
                    mad r20.y, r30.x, r20.z, r20.y
                    div r17.x, r20.y, r17.x
                    max r17.x, r17.x, l(0.00006104)
                    ...
                    if_nz r7.w
                      ...
                      loop 
                        ...
                        sample_c_lz_indexable(texture2darray)(float,float,float,float) r21.x, r21.xyzx, t9.xxxx, s13, r17.x
                        mad r20.z, r21.x, l(0.125000), r20.z
                        iadd r24.w, r24.w, l(1)
                      endloop 
                    else 
                      utof r31.z, r20.y
                      sample_c_lz_indexable(texture2darray)(float,float,float,float) r20.z, r31.xyzx, t9.xxxx, s13, r17.x
                    endif 
                    mul r17.x, r20.z, r20.z
                    mul r17.x, r20.z, r17.x
                  else 
                  ...
                  if_nz r20.x
                    ...
                    if_z r22.x
                      ...
                      if_nz r7.w
                        ...
                        utof r30.z, r20.y
                        sample_c_lz_indexable(texture2darray)(float,float,float,float) r22.x, r30.xyzx, t9.xxxx, s13, r17.x
                      endif 
                      mul r17.x, r22.x, r22.x
                      mul r17.x, r22.x, r17.x
                    else 
                      mov r17.x, l(1.000000)
                    endif 
                    mul r10.w, r10.w, r17.x
                ...
                mad r17.x, -r14.z, r0.x, l(1.000000)
                mul r17.x, r17.x, r17.x
                mad r17.x, -r17.x, l(0.620000), l(0.620000)
                add r17.x, -r14.z, r17.x
                mad r17.x, r5.z, r17.x, r14.z
                mul r17.x, r10.w, r17.x
                lt r12.w, l(0.000000), r12.w
                mad r21.xyz, r17.xxxx, r19.xywx, r15.xyzx
                mad r18.xyz, r18.xyzx, r11.wwww, r4.xyzx
                dp3 r11.w, r18.xyzx, r18.xyzx
                rsq r11.w, r11.w
                mul r18.xyz, r11.wwww, r18.xyzx
                dp3 r11.w, r18.xyzx, r4.xyzx
                dp3 r17.x, r2.xyzx, r18.xyzx
                mad r18.x, |r17.x|, r5.y, -|r17.x|
                mad r17.x, |r17.x|, r18.x, l(1.000000)
                mad r14.z, r14.z, r2.w, r3.w
                mul r17.x, r17.x, r17.x
                ...
                mad r18.xyz, r10.wwww, r19.xywx, r29.xyzx
                add_sat r11.w, -r11.w, l(1.000000)
                mul r14.z, r11.w, r11.w
                ...
                movc r28.xyz, r12.wwww, r19.xywx, r28.xyzx
...
ret 
// Approximately 1940 instruction slots used
