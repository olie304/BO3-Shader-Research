...
r7.y = samp0[]..swiz;
  ...
  r3.y = 1 + -r12.x;
  r0.xyz = r0.xyz * r3.yyy + r13.xyz;
  o0.w = r0.w * r3.y + r12.x;
  r2.yzw = r2.yzw * r3.yyy + r14.xyz;
  r0.w = dot(r2.yzw, r2.yzw);
  r0.w = rsqrt(r0.w);
  r5.xyz = r2.yzw * r0.www;
  r2.y = r2.x * r3.y + r12.y;
  r1.xyz = r1.xyz * r3.yyy + r15.xyz;
  r0.w = dot(-v6.xyz, -v6.xyz);
  r0.w = rsqrt(r0.w);
  r6.xyz = -v6.xyz * r0.www;
  r8.x = dot(r6.xyz, v4.xyz);
  r8.y = dot(r6.xyz, v5.xyz);
  r2.z = dot(r6.xyz, v3.xyz);
  r2.w = cmp(0 < r2.z);
  r7.yz = -r8.xy / r2.zz;
  r2.zw = r2.ww ? r7.yz : 0;
  r7.yz = float2(-0.5,-0.5) + w1.xy;
  r3.y = 9.99999975e-06 + layerDepth;
  r2.zw = r3.yy * r2.zw;
  r2.zw = scaleUVs.xy * r2.zw;
  r2.zw = r7.yz * scaleUVs.xy + r2.zw;
  r2.zw = offsetUVs.xy * scaleUVs.xy + r2.zw;
  r3.y = rotateUVs.y * gameTime.w + 1;
  r3.y = rotateUVs.x * r3.y;
  r3.xy = float2(0.0078125,0.0174532924) * r3.xy;
  ...
  r3.y = gameTime.w * zoomRate;
  r3.y = cos(r3.y);
  r3.y = r3.y * 0.5 + 0.5;
  r3.y = 1 + -r3.y;
  r4.w = zoomUVs.y + -zoomUVs.x;
  r3.y = r3.y * r4.w + zoomUVs.x;
  r2.zw = r2.zw / r3.yy;
  r2.zw = float2(0.5,0.5) + r2.zw;
  r7.yz = saturate(r2.zw);
  r2.zw = clampU ? r7.yz : r2.zw;
...
r2.z = samp0[]..swiz;
  ...
  r6.w = r6.w * r6.w;
  r6.w = r7.x * r6.w;
  r7.x = saturate(alphaRevealParms.x * 0.5 + r2.z);
  r7.x = r7.x + -r2.z;
  r2.z = r2.w + -r2.z;
  r2.w = 1 / r7.x;
  ...
  r2.w = min(1, r2.w);
  r2.w = r4.w * r2.w;
  r7.xyz = emissiveTint1.xyz * r2.www;
  r4.xyz = saturate(r4.xyz * r2.zzz + r7.xyz);
  r2.z = log2(r3.y);
  ...
  r7.xy = (uint2)r3.wz;
  r2.w = dot(r7.yx, float2(0.0671105608,0.00583714992));
  r2.w = frac(r2.w);
  r2.w = 52.9829178 * r2.w;
  r2.w = frac(r2.w);
  r2.w = r2.w * 6.28318548 + gameTick.w;
  sincos(r2.w, r8.x, r9.x);
  r2.w = dot(r7.xy, float2(0.0671105608,0.00583714992));
  r2.w = frac(r2.w);
  r2.w = 52.9829178 * r2.w;
  r2.w = frac(r2.w);
  r2.w = r2.w * 6.28318548 + gameTick.w;
  sincos(r2.w, r7.x, r10.x);
  r2.x = saturate(dot(r5.xyz, r6.xyz));
  r2.w = dot(-r6.xyz, r5.xyz);
  r2.w = r2.w + r2.w;
  r11.xyz = r5.xyz * -r2.www + -r6.xyz;
  r2.w = 17 * r2.y;
  r2.w = exp2(r2.w);
  r2.w = 2 + r2.w;
  r2.w = 2 / r2.w;
  ...
  r4.w = r7.y * r4.w;
  r6.w = r7.y * r6.w;
  r7.y = dot(r5.xyz, sunConstants.wldDir.xyz);
  r7.z = saturate(r7.y);
  r7.w = cmp(0 >= r7.z);
  if (r7.w != 0) {
    r8.z = 0;
  ...
  if (r7.w == 0) {
    ...
    if (r12.x == 0) {
      if (enableDitheredShadow == 0) {
        ...
        r12.z = r10.w + r8.w;
        r10.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r12.xyz, r7.w).x;
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          r14.z = r13.w ? sunConstants.splitPinTransform[r8.w].w : sunConstants.splitPinTransform[r10.w].w;
          ...
          r14.z = (uint)r13.w;
          r13.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r14.xyz, r7.w).x;
  ...
  if (r7.w != 0) {
    ...
    if (r7.w != 0) {
      ...
      if (sunConstants.sunCookieIndex != 0) {
        ...
        r12.w = 1;
        r8.w = dot(sunConstants.sunCookieTransform[0].xyzw, r12.xyzw);
      ...
      r15.z = samp0[]..swiz;
      r15.w = samp0[]..swiz;
        r16.x = abs(r7.y) * -0.200000003 + 0.400000006;
        ...
        r15.y = samp0[]..swiz;
          ...
          if (enableDitheredShadow != 0) {
            ...
            r13.z = (uint)r12.x;
            r12.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r13.xyz, r8.w).x;
          }
          r8.w = r12.y * r12.y;
          r8.w = r8.w * r12.y;
        } else {
      ...
      r8.w = r3.y * r8.w + r7.z;
      r8.w = r8.w * r8.z;
      r12.xyz = r8.www * r10.yzw;
      r7.y = cmp(0 < r7.y);
      r13.xyz = -v6.xyz * r0.www + sunConstants.wldDir.xyz;
      r0.w = dot(r13.xyz, r13.xyz);
      r0.w = rsqrt(r0.w);
      r13.xyz = r13.xyz * r0.www;
      r0.w = dot(r13.xyz, r6.xyz);
      r8.w = dot(r5.xyz, r13.xyz);
      r9.w = abs(r8.w) * r2.w + -abs(r8.w);
      ...
      r7.z = r8.z * r7.z;
      r7.z = 0.25 * r7.z;
      r13.xyz = r7.zzz * r10.yzw;
      r0.w = saturate(1 + -r0.w);
      r7.w = r0.w * r0.w;
      r7.w = r7.w * r7.w;
      r0.w = r7.w * r0.w;
      r0.w = r7.z * r0.w;
      r14.xyz = r0.www * r10.zwy;
      r12.w = r14.z;
      r12.xyzw = r7.yyyy ? r12.xyzw : 0;
      r14.zw = r13.xy;
      r14.xyzw = r7.yyyy ? r14.xyzw : 0;
      r0.w = r7.y ? r13.z : 0;
    } else {
      r12.xyzw = float4(0,0,0,0);
                    ...
                    r19.y = samp0[]..swiz;
                      ...
                      if (r9.w != 0) {
                        ...
                        while (true) {
                          ...
                          r42.y = dot(icb[r21.w+0].xy, r8.xy);
                      ...
                      r19.x = samp0[]..swiz;
                        ...
                        if (r9.w != 0) {
                          ...
                          while (true) {
                            ...
                            if (r21.w != 0) break;
                            r42.x = dot(icb[r20.z+0].xy, r9.xy);
                            r42.y = dot(icb[r20.z+0].yx, r9.xz);
            ...
            r40.w = samp0[]..swiz;
              ...
              if (r20.x != 0) {
                ...
                if (r20.x != 0) {
                  ...
                  r20.z = r20.z + -r19.y;
                  r20.z = r3.y * r20.z + r19.y;
                  r20.z = r20.z * r16.z;
                  r19.x = cmp(0 < r19.x);
                  r23.xyz = r20.zzz * r21.xyw + r10.yzw;
                  r31.xyz = r38.xyz * r16.www + r6.xyz;
                  r16.w = dot(r31.xyz, r31.xyz);
                  r16.w = rsqrt(r16.w);
                  r31.xyz = r31.xyz * r16.www;
                  r16.w = dot(r31.xyz, r6.xyz);
                  r20.z = dot(r5.xyz, r31.xyz);
                  r22.x = abs(r20.z) * r2.w + -abs(r20.z);
                  r20.z = abs(r20.z) * r22.x + 1;
                  r19.y = r19.y * r4.w + r6.w;
                  r20.z = r20.z * r20.z;
                  r19.y = r20.z * r19.y;
                  r19.y = rcp(r19.y);
                  r19.y = r19.y * r20.x;
  ...
  while (true) {
    ...
    if (r6.z != 0) break;
    r8.z = (uint)r6.y >> 5;
    r9.xyz = (int3)r8.xyz + (int3)r13.xyz;
    r6.z = visibleProbes.Load(r9.xyzw).x;
    r6.w = cmp((int)r3.z == (int)r6.y);
    bitmask.x = ((~(-1 << r3.w)) << 0) & 0xffffffff;  r7.x = (((uint)0 << 0) & bitmask.x) | ((uint)r6.z & ~bitmask.x);
    r6.z = r6.w ? r7.x : r6.z;
    r6.w = cmp((int)r4.w == (int)r6.y);
    if (r6.x == 0) r7.x = 0; else if (r6.x+0 < 32) {     r7.x = (uint)r6.z << (32-(r6.x + 0)); r7.x = (uint)r7.x >> (32-r6.x);    } else r7.x = (uint)r6.z >> 0;
    r6.z = r6.w ? r7.x : r6.z;
    ...
    while (true) {
      ...
      r9.y = samp0[]..swiz;
        ...
        r31.w = samp0[]..swiz;
          ...
          r12.w = dot(r25.xyz, r23.xyz);
          r12.w = saturate(r12.w + r25.w);
          r10.w = r12.w * r10.w;
          r12.w = dot(r26.xyz, r23.xyz);
          r12.w = saturate(r12.w + r26.w);
          r10.w = r12.w * r10.w;
          r12.w = dot(r27.xyz, r23.xyz);
          r12.w = saturate(r12.w + r27.w);
          r10.w = r12.w * r10.w;
          r12.w = dot(r30.xyz, r23.xyz);
          r12.w = saturate(r12.w + r30.w);
          r10.w = r12.w * r10.w;
          r12.w = dot(r31.xyz, r23.xyz);
          ...
          r37.y = samp0[]..swiz;
            ...
            r14.yzw = saturate(r25.xyz * r27.xyz + float3(0.5,0.5,0.5));
            r30.z = r31.x;
            ...
            r8.z = dot(r9.xyz, float3(0.212599993,0.715200007,0.0722000003));
            r8.z = r3.x * r8.w + r8.z;
            r8.z = r10.x / r8.z;
            r21.x = r19.w;
            r21.yz = r20.xy;
            r20.xyw = r9.yzx * r8.zzz + r21.yzx;
            r19.w = r20.w;
          }
        }
      }
  ...
  if (r4.w != 0) {
    ...
    r6.w = 0;
    while (true) {
      r7.x = cmp((uint)r6.w >= (uint)r3.y);
      if (r7.x != 0) break;
      r6.z = (uint)r6.w >> 5;
      r8.xyz = (int3)r6.xyz + (int3)r13.xyz;
      r6.z = visibleProbes.Load(r8.xyzw).x;
      r7.x = cmp((int)r3.z == (int)r6.w);
      if (r3.w == 0) r8.x = 0; else if (r3.w+0 < 32) {       r8.x = (uint)r6.z << (32-(r3.w + 0)); r8.x = (uint)r8.x >> (32-r3.w);      } else r8.x = (uint)r6.z >> 0;
      r6.z = r7.x ? r8.x : r6.z;
      ...
      while (true) {
        if (r10.w == 0) break;
        r12.z = firstbitlow((uint)r10.w);
        r12.w = 1 << (int)r12.z;
        r13.w = (int)r10.w & (int)r12.w;
        if (r13.w != 0) {
          r10.w = (int)r10.w ^ (int)r12.w;
          r12.w = (int)r7.x + (int)r12.z;
        // Known bad code for instruction (needs manual fix):
        ...
        r22.y = samp0[]..swiz;
          ...
          r32.w = samp0[]..swiz;
            ...
            r9.x = r15.w * r14.w;
            r14.w = (int)r22.x & 1;
            r22.zw = r14.ww ? r9.xy : r9.zx;
            r9.x = r22.x;
            r25.xy = r22.zw;
            r14.w = 1;
            while (true) {
              r15.w = cmp((int)r14.w >= (int)r13.w);
              if (r15.w != 0) break;
            ...
            r33.w = samp0[]..swiz;
              ...
              r15.w = r19.w * r15.w;
              r19.w = dot(r32.xyz, r24.xyz);
              r19.w = saturate(r19.w + r32.w);
              r15.w = r19.w * r15.w;
              r19.w = dot(r33.xyz, r24.xyz);
              r19.w = saturate(r19.w + r33.w);
              r25.x = r19.w * r15.w;
              r21.w = (uint)r9.x >> 2;
              if (1 == 0) r24.w = 0; else if (1+2 < 32) {               r24.w = (uint)r9.x << (32-(1 + 2)); r24.w = (uint)r24.w >> (32-1);              } else r24.w = (uint)r9.x >> 2;
              r25.z = (int)r21.w & 2;
              r25.w = max(r25.y, r25.x);
              r15.w = -r15.w * r19.w + 1;
              r15.w = r25.y * r15.w;
              r12.y = r25.z ? r15.w : r25.w;
              r25.xy = r24.ww ? r25.xy : r12.xy;
              r14.w = (int)r14.w + 1;
              r9.x = r21.w;
            }
            r9.x = saturate(r25.y + -r9.w);
            r12.y = r9.x * r22.y;
            r12.w = cmp(0 < r12.y);
            if (r12.w != 0) {
            // Known bad code for instruction (needs manual fix):
            ...
            r38.x = samp0[]..swiz;
            r38.y = samp0[]..swiz;
              r20.w = r9.x * r22.y + r20.w;
              r9.x = r12.y * r23.z;
              r23.z = r33.z;
              r12.y = dot(r11.xyz, r23.xyz);
              r12.z = dot(r24.xyz, r23.xyz);
              r12.z = r12.z + -r33.w;
              r12.w = cmp(r12.z >= 0);
              r12.z = max(abs(r12.z), r2.w);
              r12.z = r12.w ? r12.z : -r12.z;
              r12.y = max(1.00000001e-07, -r12.y);
              r12.y = r12.z / r12.y;
              r12.y = min(131072, abs(r12.y));
              r33.z = r34.z;
              r12.z = dot(r11.xyz, r33.xyz);
              r12.w = dot(r24.xyz, r33.xyz);
              r12.w = r12.w + -r34.w;
              r13.w = cmp(r12.w >= 0);
              ...
              r34.z = r35.z;
              r12.z = dot(r11.xyz, r34.xyz);
              r12.w = dot(r24.xyz, r34.xyz);
              r12.w = r12.w + -r35.w;
              r13.w = cmp(r12.w >= 0);
              r12.w = max(abs(r12.w), r2.w);
              r12.w = r13.w ? r12.w : -r12.w;
              ...
              r12.y = min(r12.y, abs(r12.z));
              r35.z = r36.z;
              r12.z = dot(r11.xyz, r35.xyz);
              r12.w = dot(r24.xyz, r35.xyz);
              r12.w = r12.w + -r36.w;
              r13.w = cmp(r12.w >= 0);
              r12.w = max(abs(r12.w), r2.w);
              r12.w = r13.w ? r12.w : -r12.w;
              ...
              r12.y = min(r12.y, abs(r12.z));
              r36.z = r37.x;
              r12.z = dot(r11.xyz, r36.xyz);
              r12.w = dot(r24.xyz, r36.xyz);
              r12.w = r12.w + -r37.y;
              r13.w = cmp(r12.w >= 0);
              r12.w = max(abs(r12.w), r2.w);
              r12.w = r13.w ? r12.w : -r12.w;
              ...
              r12.y = min(r12.y, abs(r12.z));
              r38.zw = r37.zw;
              r12.z = dot(r11.zxy, r38.xzw);
              r12.w = dot(r24.zxy, r38.xzw);
              r12.w = r12.w + -r38.y;
              r13.w = cmp(r12.w >= 0);
              r12.w = max(abs(r12.w), r2.w);
              r12.w = r13.w ? r12.w : -r12.w;
              ...
              r22.xyz = r11.xyz * r12.yyy + r22.xyz;
              ...
              r21.y = r26.z;
              r21.z = r27.x;
              r33.x = dot(r22.xyz, r21.xyz);
              r23.xy = r26.xw;
              r23.z = r27.w;
              r33.y = dot(r22.xyz, r23.xyz);
              r27.x = r26.y;
              r33.z = dot(r22.xyz, r27.xyz);
              if (9 == 0) r12.z = 0; else if (9+16 < 32) {               r12.z = (uint)r23.w << (32-(9 + 16)); r12.z = (uint)r12.z >> (32-9);              } else r12.z = (uint)r23.w >> 16;
              r33.w = (uint)r12.z;
              r12.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r33.xyzw, r12.y).xyz;
              r22.x = dot(r24.xyz, r21.xyz);
              r22.y = dot(r24.xyz, r23.xyz);
              r22.z = dot(r24.xyz, r27.xyz);
              r22.xyz = saturate(r22.xyz * r30.xyz + float3(0.5,0.5,0.5));
              r31.z = r32.x;
              r22.xyz = r22.xyz * r31.xyz + r32.yzw;
              r33.x = dot(r5.xyz, r21.xyz);
              r33.y = dot(r5.xyz, r23.xyz);
              r33.z = dot(r5.xyz, r27.xyz);
              r21.xyz = cmp(float3(0,0,0) < r33.xyz);
              r10.z = r21.x ? 0 : 0.5;
              r23.xyz = r22.xyz + r10.xyz;
              r23.xyz = gProbeXArray.SampleLevel(samplerLinearClamp_s, r23.xyz, 0).xyz;
              r24.xyz = r33.xyz * r33.xyz;
              r24.xyz = r24.xyz * r9.xxx;
              r14.z = r21.y ? 0 : 0.5;
              r21.xyw = r22.xyz + r14.xyz;
              r21.xyw = gProbeYArray.SampleLevel(samplerLinearClamp_s, r21.xyw, 0).xyz;
              ...
              r22.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r33.xyzw, 6).xyz;
              r23.xyz = r22.xyz * r21.xyz;
              r10.z = dot(r23.xyz, float3(0.212599993,0.715200007,0.0722000003));
              r8.xyz = r21.xyz * r22.xyz + r8.xyz;
              r13.w = r10.z * r3.x;
              r12.yzw = r12.yzw * r9.xxx;
              r9.x = dot(r12.yzw, float3(0.212599993,0.715200007,0.0722000003));
              r9.x = r3.x * r10.z + r9.x;
              r9.x = r13.w / r9.x;
              r20.xyz = r12.yzw * r9.xxx + r20.xyz;
            }
          }
        }
      }
  ...
  if (r2.w != 0) {
    ...
    r11.w = 0;
    r5.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r11.xyzw, r2.z).xyz;
    r0.w = sunConstants.globalProbeExposure * r2.w + -r3.w;
    r0.w = r2.y * r0.w + r3.w;
    r6.xyz = r5.xyz * r0.www + r6.xyz;
  }
  r3.xyz = r3.xyz * r1.www + r7.yzw;
  ...
  r2.xzw = r5.xyz * r2.xxx + r28.xyz;
  r5.xyz = r5.xyz * r2.yyy + r29.xyz;
