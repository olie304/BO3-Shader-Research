...
add r1.xyzw, -v2.xyxy, l(1.000000, 1.000000, 1.000000, 1.000000)
mul r2.xy, r1.zwzz, cb0[11].zwzz
mul r1.xyzw, r1.xyzw, cb0[12].xyzw
mul r2.xy, r2.xyxx, l(3.631899, 3.631899, 0.000000, 0.000000)
add r0.w, r2.y, r2.x
add r2.x, cb0[0].y, cb1[69].w
mul r2.x, r2.x, cb0[0].x
mad r0.w, r2.x, l(5.65486670), r0.w
mul r1.xyzw, r1.xyzw, l(8.377581, 8.377581, 20.268339, 20.268339)
add r1.xy, r1.ywyy, r1.xzxx
mad r1.xy, r2.xxxx, l(9.424778, 7.539823, 0.000000, 0.000000), r1.xyxx
sincos r0.w, null, r0.w
sincos r1.xy, null, r1.xyxx
mul r1.x, r1.x, l(3.000000)
mad r0.w, r0.w, l(7.500000), r1.x
mad r0.w, r1.y, l(1.700000), r0.w
mul r0.w, r0.w, v1.y
mad r1.xyz, r0.wwww, r0.xyzx, r3.xyzx
...
mad r2.xyzw, r2.xxxx, cb1[8].xyzw, r3.xyzw
