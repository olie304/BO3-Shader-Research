...
r5.w = modelInstanceBuffer[]..swiz;
  ...
  r2.w = r3.x;
  r5.w = r3.z;
  r3.x = dot(r1.xyzw, r5.xyzw);
  r1.x = dot(r1.xyzw, r2.xyzw);
  r1.xyzw = r1.xxxx * viewProjectionMatrix._m00_m01_m02_m03 + r4.xyzw;
  r1.xyzw = r3.xxxx * viewProjectionMatrix._m20_m21_m22_m23 + r1.xyzw;
...
r1.z = modelInstanceBuffer[]..swiz;
  o1.x = dot(r0.yzw, r1.xyz);
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r1.xyz, r0.x, l(16), t5.xyzx
r1.x = modelInstanceBuffer[]..swiz;
r1.y = modelInstanceBuffer[]..swiz;
r1.z = modelInstanceBuffer[]..swiz;
// Known bad code for instruction (needs manual fix):
...
r2.y = modelInstanceBuffer[]..swiz;
r2.z = modelInstanceBuffer[]..swiz;
  o1.z = dot(r0.yzw, r2.xyz);
  o1.y = dot(r0.yzw, r1.xyz);
  return;
}