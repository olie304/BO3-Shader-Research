...
add r2.xyzw, -v2.xyxy, l(1.000000, 1.000000, 1.000000, 1.000000)
mul r1.yz, r2.zzwz, cb0[11].zzwz
mul r2.xyzw, r2.xyzw, cb0[12].xyzw
mul r1.yz, r1.yyzy, l(0.000000, 3.631899, 3.631899, 0.000000)
add r0.w, r1.z, r1.y
add r1.y, cb0[0].y, cb1[69].w
mul r1.y, r1.y, cb0[0].x
mad r0.w, r1.y, l(5.65486670), r0.w
mul r2.xyzw, r2.xyzw, l(8.377581, 8.377581, 20.268339, 20.268339)
add r1.zw, r2.yyyw, r2.xxxz
mad r1.yz, r1.yyyy, l(0.000000, 9.424778, 7.539823, 0.000000), r1.zzwz
sincos r0.w, null, r0.w
sincos r1.yz, null, r1.yyzy
mul r1.y, r1.y, l(3.000000)
mad r0.w, r0.w, l(7.500000), r1.y
mad r0.w, r1.z, l(1.700000), r0.w
mul r0.w, r0.w, v1.y
mad r2.xyz, r0.wwww, r0.xyzx, r4.xyzx
...
mov r5.xyz, r1.xyzx
dp4 r1.x, r2.xyzw, r5.xyzw
mul r2.xyzw, r3.xxxx, cb1[9].xyzw
...
dp3 o1.y, r0.xyzx, r2.xyzx
dp3 o1.z, r0.xyzx, r3.xyzx
ret 
