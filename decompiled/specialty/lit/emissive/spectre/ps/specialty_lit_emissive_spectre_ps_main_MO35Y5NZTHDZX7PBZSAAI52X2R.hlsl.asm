...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:42:16 2021
//
//
...
movc r7.w, v8.x, l(1.000000), l(-1.000000)
...
movc r10.xyz, v8.xxxx, v4.xyzx, -v4.xyzx
  ...
  if_nz r5.y
    ...
    if_z cb0[27].z
      ...
      if_nz r6.w
        ...
        mad r21.xyz, r7.xyzx, r7.wwww, v7.xyzx
    ...
    mov_sat r4.z, r4.z
    mad r18.xyz, -v7.xyzx, r0.yyyy, cb2[17].xyzx
      ...
      if_nz r10.w
        ...
        switch r10.w
          ...
          if_nz r15.w
            ...
            mad_sat r17.zw, r15.wwww, r36.xxxz, r36.yyyw
            mul r44.xy, r17.zwzz, r17.zwzz
            mad r17.zw, r17.zzzw, l(0.000000, 0.000000, -2.000000, -2.000000), l(0.000000, 0.000000, 3.000000, 3.000000)
            mul r17.zw, r17.zzzw, r44.xxxy
            ...
            if_nz r15.w
              ...
              if_nz r15.w
                ...
                mad r44.xyz, r7.xyzx, r15.wwww, v7.xyzx
                ...
                and r17.z, r35.w, l(0x0000ffff)
                utof r45.w, r17.z
                mov r17.zw, l(0,0,0,0)
                loop 
                  ige r22.w, r17.w, l(8)
                  breakc_nz r22.w
                  dp2 r46.y, icb[r17.w + 0].yxyy, r9.xyxx
                  dp2 r46.z, icb[r17.w + 0].yxyy, r9.yzyy
                  mul r46.yz, r37.yyyy, r46.yyzy
                  mul r46.x, r5.x, r46.y
                  mul r46.w, r3.x, r46.y
                  mad r45.xyz, r44.xyzx, r16.wwww, r46.xzwx
                  sample_c_lz_indexable(texturecubearray)(float,float,float,float) r22.w, r45.xyzw, t10.xxxx, s13, r15.w
                  mad r17.z, r22.w, l(0.125000), r17.z
              ...
              if_nz r15.w
                ...
                dp3 r16.w, r41.xyzx, r13.xyzx
                dp3 r17.w, r13.xyzx, r43.xyzx
                mad r22.w, -r16.w, r16.w, r40.x
                mad r11.w, r16.w, r17.w, -r11.w
                div_sat r11.w, r11.w, r22.w
                div r16.w, r22.w, r40.x
                mul r16.w, r16.w, l(10.000000)
                min r16.w, r16.w, l(1.000000)
                add r11.w, -r12.w, r11.w
                mad r11.w, r16.w, r11.w, r12.w
                ...
                if_nz r12.w
                  ...
                  mad r20.xyz, r7.xyzx, r16.wwww, v7.xyzx
                  dp4 r16.w, r43.xyzw, r20.xyzw
                  dp4 r17.w, r44.xyzw, r20.xyzw
                  lt r22.w, r17.w, r16.w
                  if_z r22.w
                    ...
                    mul r20.x, r17.w, r47.y
                    mad r16.w, r47.x, r17.w, r16.w
                    div r16.w, r16.w, r20.x
                  else 
                    mov r20.z, l(-1)
                  endif 
                  ...
                  if_z r17.w
                    ...
                    if_nz r6.w
                      ...
                      loop 
                        ige r26.w, r22.w, l(8)
                        breakc_nz r26.w
                        dp2 r44.x, icb[r22.w + 0].yxyy, r9.xwxx
                        dp2 r44.y, icb[r22.w + 0].xyxx, r4.xyxx
                        mad r20.xy, r44.xyxx, r12.wwww, r43.xyxx
                        sample_c_lz_indexable(texture2darray)(float,float,float,float) r20.x, r20.xyzx, t9.xxxx, s13, r16.w
                        mad r17.w, r20.x, l(0.125000), r17.w
                        iadd r22.w, r22.w, l(1)
                      endloop 
                    else 
                      utof r43.z, r11.w
                      sample_c_lz_indexable(texture2darray)(float,float,float,float) r17.w, r43.xyzx, t9.xxxx, s13, r16.w
                    endif 
                  ...
                  if_nz r12.w
                    ...
                    movc r16.w, r20.x, -r16.w, r16.w
                    mad r21.xyz, r7.xyzx, r16.wwww, v7.xyzx
                    dp4 r16.w, r43.xyzw, r21.xyzw
                    ...
                    if_z r20.y
                      ...
                      mad r16.w, r47.x, r20.x, r16.w
                      div r16.w, r16.w, r22.w
                    else 
                      mov r20.z, l(-1)
                    endif 
                    ...
                    if_z r20.x
                      ...
                      if_nz r6.w
                        ...
                        loop 
                          ...
                          mad r20.xy, r43.xyxx, r12.wwww, r21.xyxx
                          sample_c_lz_indexable(texture2darray)(float,float,float,float) r20.x, r20.xyzx, t9.xxxx, s13, r16.w
                        ...
                        utof r21.z, r11.w
                        sample_c_lz_indexable(texture2darray)(float,float,float,float) r22.w, r21.xyzx, t9.xxxx, s13, r16.w
                      endif 
                      mul r11.w, r22.w, r22.w
                      mul r11.w, r22.w, r11.w
                    else 
                      mov r11.w, l(1.000000)
                    endif 
                    mul r13.w, r11.w, r13.w
                ...
                mad r11.w, -|r14.w|, r4.z, l(1.000000)
                mul r11.w, r11.w, r11.w
                mad r11.w, -r11.w, l(0.620000), l(0.620000)
                add r11.w, -|r14.w|, r11.w
                mad r11.w, r3.z, r11.w, |r14.w|
                mul r11.w, r13.w, r11.w
                mov r35.x, r34.x
                lt r12.w, l(0.000000), r14.w
                mad r20.xyz, r11.wwww, r35.xyzx, r18.xyzx
                dp3_sat r11.w, r7.xyzx, r42.xyzx
                mad r21.xyz, r41.xyzx, r10.wwww, r2.xyzx
                dp3 r10.w, r21.xyzx, r21.xyzx
                rsq r10.w, r10.w
                mul r21.xyz, r10.wwww, r21.xyzx
                dp3 r10.w, r21.xyzx, r2.xyzx
                dp3 r14.w, r7.xyzx, r21.xyzx
                mad r16.w, |r14.w|, r3.y, -|r14.w|
                mad r14.w, |r14.w|, r16.w, l(1.000000)
                mad r16.w, r11.w, r2.w, r3.w
                ...
                mul r11.w, r13.w, r11.w
                mad r21.xyz, r11.wwww, r35.xyzx, r33.xyzx
                ...
                movc r32.xyz, r12.wwww, r41.xyzx, r32.xyzx
                movc r33.xyz, r12.wwww, r21.xyzx, r33.xyzx
              endif 
            endif 
          endif 
          break 
          ...
          rsq r10.w, r10.w
          mul r21.xyz, r10.wwww, r20.xyzx
          dp3 r11.w, r7.xyzx, r21.xyzx
          ...
          if_nz r12.w
            ...
            if_nz r13.w
              ...
              div r22.xy, r36.xyxx, r12.wwww
              lt r12.w, r44.w, l(0.00048828)
              if_nz r12.w
                mov r45.y, r46.x
                ...
                div_sat r16.w, r26.w, r16.w
                mul r26.w, r16.w, r16.w
                mad r16.w, r16.w, l(-2.000000), l(3.000000)
                mul r12.w, r16.w, r26.w
              endif 
              ...
              if_nz r12.w
                ...
                dp3 r14.w, r46.yzwy, r22.xyzx
                dp3 r15.w, r36.xyzx, r22.xyzx
                frc r36.x, r14.w
                frc r36.y, r15.w
                iadd r12.w, r12.w, l(-1)
                utof r36.z, r12.w
            ...
            if_nz r12.w
              ...
              if_nz r12.w
                ...
                movc r12.w, r14.w, -r12.w, r12.w
                mad r23.xyz, r7.xyzx, r12.wwww, v7.xyzx
                mov r41.xyz, r40.xyzx
                dp4 r12.w, r41.xyzw, r23.xyzw
                dp4 r14.w, r43.xyzw, r23.xyzw
                ...
                if_nz r15.w
                  ...
                  if_nz r6.w
                    ...
                    loop 
                      ...
                      sample_c_lz_indexable(texture2darray)(float,float,float,float) r16.w, r34.xyzx, t9.xxxx, s13, r8.w
                      mad r14.w, r16.w, l(0.125000), r14.w
                      iadd r15.w, r15.w, l(1)
                    endloop 
                  else 
                    utof r23.z, r12.w
                    sample_c_lz_indexable(texture2darray)(float,float,float,float) r14.w, r23.xyzx, t9.xxxx, s13, r8.w
                  endif 
              ...
              if_nz r12.w
                ...
                if_nz r15.w
                  ...
                  movc r16.w, r22.x, -r16.w, r16.w
                  mad r24.xyz, r7.xyzx, r16.wwww, v7.xyzx
                  dp4 r22.x, r34.xyzw, r24.xyzw
                  dp4 r22.y, r36.xyzw, r24.xyzw
                  dp4 r16.w, r37.xyzw, r24.xyzw
                  dp4 r23.x, r38.xyzw, r24.xyzw
                  lt r23.y, r23.x, r16.w
                  ...
                  if_z r23.y
                    ...
                    mad r16.w, r24.x, r23.x, r16.w
                    div r13.w, r16.w, r13.w
                    max r13.w, r13.w, l(0.00006104)
                    and r16.w, r23.y, l(0x0000ffff)
                    if_nz r6.w
                      utof r23.z, r16.w
                      ...
                      loop 
                        ...
                        mad r23.xy, r24.xyxx, r15.wwww, r34.xyxx
                      ...
                      utof r34.z, r16.w
                      sample_c_lz_indexable(texture2darray)(float,float,float,float) r22.x, r34.xyzx, t9.xxxx, s13, r13.w
                    endif 
                  ...
                  if_nz r15.w
                    ...
                    if_z r23.z
                      ...
                      mad r16.w, r24.x, r22.y, r16.w
                      div r13.w, r16.w, r13.w
                      max r13.w, r13.w, l(0.00006104)
                      and r16.w, r23.z, l(0x0000ffff)
                      if_nz r6.w
                        utof r23.z, r16.w
                        mov r22.y, l(0)
                        mov r24.x, l(0)
                        loop 
                          ...
                          mad r23.xy, r34.xyxx, r15.wwww, r25.xyxx
                          sample_c_lz_indexable(texture2darray)(float,float,float,float) r23.x, r23.xyzx, t9.xxxx, s13, r13.w
                ...
                dp3 r13.w, r7.xyzx, r20.xyzx
                mad r16.w, |r13.w|, r3.y, -|r13.w|
                ...
                movc r33.xyz, r15.wwww, r20.xyzx, r33.xyzx
              endif 
            endif 
          endif 
          break 
