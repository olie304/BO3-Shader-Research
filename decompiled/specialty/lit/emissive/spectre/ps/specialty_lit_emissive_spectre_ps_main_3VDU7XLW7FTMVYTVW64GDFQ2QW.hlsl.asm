...
movc r7.y, v7.x, l(1.000000), l(-1.000000)
dp3 r7.z, v3.xyzx, v3.xyzx
rsq r7.z, r7.z
mul r8.xyz, r7.zzzz, v3.xyzx
mul r8.xyz, r7.yyyy, r8.xyzx
dp3 r7.z, v4.xyzx, v4.xyzx
rsq r7.z, r7.z
mul r9.xyz, r7.zzzz, v4.xyzx
mul r9.xyz, r7.yyyy, r9.xyzx
dp3 r7.z, v5.xyzx, v5.xyzx
rsq r7.z, r7.z
mul r10.xyz, r7.zzzz, v5.xyzx
  ...
  if_nz r6.w
    ...
    if_z cb0[27].z
      ...
      if_nz r8.w
        ...
        mad r20.xyz, r7.xyzx, r9.wwww, v6.xyzx
...
ret 
// Approximately 2108 instruction slots used
