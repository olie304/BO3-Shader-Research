// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:42:18 2021
...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r5.zw = r7.xy * float2(1.9921875,1.9921875) + float2(-1,-1);
  r2.w = dot(r5.zw, r5.zw);
  r2.w = 1 + -r2.w;
  r2.w = max(0, r2.w);
  r2.w = sqrt(r2.w);
  r7.x = r7.z * r7.z;
  r7.x = 0.333333343 * r7.x;
  r7.x = min(1, r7.x);
  r7.y = v8.x ? 1 : -1;
  r7.z = dot(v4.xyz, v4.xyz);
  r7.z = rsqrt(r7.z);
  r8.xyz = v4.xyz * r7.zzz;
  r8.xyz = r8.xyz * r7.yyy;
  r7.z = dot(v5.xyz, v5.xyz);
  r7.z = rsqrt(r7.z);
  r9.xyz = v5.xyz * r7.zzz;
  r9.xyz = r9.xyz * r7.yyy;
  r7.z = dot(v6.xyz, v6.xyz);
  r7.z = rsqrt(r7.z);
  r10.xyz = v6.xyz * r7.zzz;
  ...
  r0.w = specularMask.Sample(revealSampler_s, r5.zw).x;
  r2.w = 9.99999975e-06 + layerDepth;
  r1.zw = r1.zw * r2.ww + r3.xy;
  r1.zw = float2(0.5,0.5) + r1.zw;
  r5.zw = saturate(r1.zw);
  r1.zw = clampU ? r5.zw : r1.zw;
  r1.zw = r4.xy * r4.zw + r1.zw;
  r8.xyzw = emissiveMap.Sample(colorSampler_s, r1.zw).xyzw;
  r8.xyzw = emissiveTint1.xyzw * r8.xyzw;
  r9.xyz = saturate(r8.xyz);
  r9.xyz = log2(r9.xyz);
  r9.xyz = alphaCooling * r9.xyz;
  r9.xyz = exp2(r9.xyz);
  r0.z = saturate(r0.z);
  r1.z = log2(r0.z);
...
r1.w = samp0[]..swiz;
  ...
  r0.z = frac(r0.z);
  r11.y = gameTime.w * flickerSpeed + r0.z;
  r11.x = flickerSeed.x;
  r0.z = flickerLookupMap.SampleLevel(lookupSampler_s, r11.xy, 0).x;
  r0.z = log2(abs(r0.z));
  ...
  r11.xyz = r11.xyz / hdrScale;
  r1.w = saturate(dot(r11.xyz, float3(0.298999995,0.587000012,0.114)));
  r1.w = r6.w * w1.x + r1.w;
  ...
  r1.x = r1.w * r1.x;
  r1.y = revealMap.Sample(revealSampler_s, r5.xy).x;
  r1.z = saturate(w1.x * 0.998000026 + 0.00100000005);
  r1.w = 1 + -r1.z;
  ...
  r10.x = saturate(dot(r7.xyz, r2.xyz));
  r3.y = dot(-r2.xyz, r7.xyz);
  r3.y = r3.y + r3.y;
  r12.xyz = r7.xyz * -r3.yyy + -r2.xyz;
  r3.y = 17 * r10.y;
  r3.y = exp2(r3.y);
  r3.y = 2 + r3.y;
  r3.y = 2 / r3.y;
  ...
  r1.w = min(15, r1.w);
  r1.w = (uint)r1.w;
  r13.xy = (uint2)r1.yz >> int2(6,6);
  r13.z = (uint)r1.w << 4;
  r1.y = (int)r6.w & -32;
  r1.z = (int)-r1.y + (int)r6.w;
  r1.w = numRefProbes & -32;
  r8.w = (int)-r1.w + numRefProbes;
  r14.xy = float2(0,0);
  r15.w = 0;
  r16.yz = float2(0,1);
  r17.xy = float2(0,0);
  ...
  while (true) {
    ...
    r10.z = visibleProbes.Load(r15.xyzw).x;
    r10.w = cmp((int)r1.y == (int)r9.w);
    bitmask.y = ((~(-1 << r1.z)) << 0) & 0xffffffff;  r11.y = (((uint)0 << 0) & bitmask.y) | ((uint)r10.z & ~bitmask.y);
    r10.z = r10.w ? r11.y : r10.z;
    r10.w = cmp((int)r1.w == (int)r9.w);
    if (r8.w == 0) r11.y = 0; else if (r8.w+0 < 32) {     r11.y = (uint)r10.z << (32-(r8.w + 0)); r11.y = (uint)r11.y >> (32-r8.w);    } else r11.y = (uint)r10.z >> 0;
    r10.z = r10.w ? r11.y : r10.z;
  ...
  if (r1.w != 0) {
    ...
    r8.w = 0;
    while (true) {
      r9.w = cmp((uint)r8.w >= (uint)r6.w);
      if (r9.w != 0) break;
      r14.z = (uint)r8.w >> 5;
      r15.xyz = (int3)r13.xyz + (int3)r14.xyz;
      r9.w = visibleProbes.Load(r15.xyzw).x;
      r10.z = cmp((int)r1.y == (int)r8.w);
      if (r1.z == 0) r10.w = 0; else if (r1.z+0 < 32) {       r10.w = (uint)r9.w << (32-(r1.z + 0)); r10.w = (uint)r10.w >> (32-r1.z);      } else r10.w = (uint)r9.w >> 0;
  ...
  if (r1.z != 0) {
    ...
    r14.xyz = r21.xyz * r1.yyy + r15.xyz;
    r12.w = 0;
    r15.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r12.xyzw, r4.z).xyz;
    r1.y = sunConstants.globalProbeExposure * r1.z + -r1.w;
    r1.y = r10.y * r1.y + r1.w;
    r11.yzw = r15.xyz * r1.yyy + r11.yzw;
  }
  r1.yz = r10.xy * float2(0.984375,0.984375) + float2(0.0078125,0.0078125);
  r1.yz = gEnvBRDFGeneric.SampleLevel(samplerLinear_s, r1.yz, 0).xy;
  r15.xyz = r11.zwy * r1.yyy;
  r1.yzw = r11.yzw * r1.zzz;
  r3.w = sqrt(r3.z);
  r3.w = r3.w * 0.5 + 0.5;
  r3.w = r3.w * r3.w;
  r4.z = 0.5 * r3.w;
  r3.w = -r3.w * 0.5 + 1;
  r4.w = r10.x * r3.w + r4.z;
  r3.w = r4.w * r3.w;
  r4.z = r4.z * r4.w;
    ...
    if (r4.w == 0) {
      ...
      if (r8.w == 0) {
        if (enableDitheredShadow == 0) {
          ...
          r16.z = r8.w + r6.w;
          r8.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r4.w).x;
        ...
        if (enableDitheredShadow != 0) {
          ...
          while (true) {
            ...
            r17.z = (uint)r11.w;
            r11.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r17.xyz, r4.w).x;
  ...
  if (r6.w != 0) {
    ...
    if (r6.w != 0) {
      ...
      r7.w = -r10.x * 0.5 + 1;
      r7.w = -abs(r4.w) * r7.w + 1;
      r7.w = r7.w * r7.w;
      r7.w = -r7.w * 0.620000005 + 0.620000005;
      r7.w = r7.w + -abs(r4.w);
      r7.w = r3.z * r7.w + abs(r4.w);
      r7.w = r7.w * r5.w;
      r8.w = cmp(0 < r4.w);
      r16.xyz = r7.www * r10.yzw + r14.xyz;
      r4.w = saturate(r4.w);
      r11.yzw = -v7.xyz * r0.yyy + sunConstants.wldDir.xyz;
      r0.y = dot(r11.yzw, r11.yzw);
      r0.y = rsqrt(r0.y);
      r11.yzw = r11.yzw * r0.yyy;
      r0.y = dot(r11.yzw, r2.xyz);
      ...
      r4.w = r7.w * r4.w;
      r4.w = r4.w * r5.w;
      r11.yzw = r4.www * r10.yzw + r1.yzw;
      r0.y = saturate(1 + -r0.y);
      r5.w = r0.y * r0.y;
      r5.w = r5.w * r5.w;
      r0.y = r5.w * r0.y;
      r0.y = r4.w * r0.y;
      r17.xyz = r0.yyy * r10.zwy + r15.xyz;
      r16.w = r17.z;
      r14.w = r15.z;
      r14.xyzw = r8.wwww ? r16.xyzw : r14.xyzw;
      r17.zw = r11.yz;
      r15.zw = r1.yz;
      r16.xyzw = r8.wwww ? r17.xyzw : r15.xyzw;
      r1.w = r8.w ? r11.w : r1.w;
      r15.z = r14.w;
      r15.xy = r16.xy;
      r1.yz = r16.zw;
    }
  ...
  while (true) {
    ...
    if (r7.w != 0) break;
    r10.z = (uint)r6.w >> 5;
    r17.xyz = (int3)r10.xyz + (int3)r13.xyz;
            ...
            if (r21.w != 0) {
              ...
              if (r21.w != 0) {
                ...
                if (r21.w != 0) {
                  ...
                  r25.w = cmp(r15.w < 0);
                  r21.w = r25.w ? -r21.w : r21.w;
                  r42.xyz = r7.xyz * r21.www + v7.xyz;
                    ...
                    r12.w = samp0[]..swiz;
                      ...
                      if (r8.w != 0) {
                        ...
                        while (true) {
                          ...
                          r43.y = dot(icb[r19.z+0].xy, r4.xy);
                      ...
                      r12.w = samp0[]..swiz;
                        ...
                        if (r8.w != 0) {
                          ...
                          while (true) {
                            ...
                            if (r27.w != 0) break;
                            r42.x = dot(icb[r25.w+0].xy, r5.xy);
                            r42.y = dot(icb[r25.w+0].yx, r5.xz);
              ...
              if (r13.w != 0) {
                  ...
                  r40.y = samp0[]..swiz;
                    ...
                    if (r8.w != 0) {
                      ...
                      while (true) {
                        ...
                        r25.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r32.xyz, r10.z).x;
                        r15.w = r25.w * 0.125 + r15.w;
                        r19.x = (int)r19.x + 1;
                      }
                    } else {
                      r22.z = (uint)r13.w;
                      r15.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r22.xyz, r10.z).x;
                    }
                    r10.z = r15.w * r15.w;
                    r10.z = r10.z * r15.w;
                  } else {
                ...
                if (r13.w != 0) {
                  ...
                  r38.w = samp0[]..swiz;
                    ...
                    r22.y = cmp(r12.w < 0);
                    r22.x = r22.y ? -r22.x : r22.x;
                    r23.xyz = r7.xyz * r22.xxx + v7.xyz;
                    ...
                    r32.y = samp0[]..swiz;
                      ...
                      if (r8.w != 0) {
                        ...
                        r33.z = (uint)r22.x;
                        r22.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r33.xyz, r14.w).x;
                      }
                      r14.w = r22.y * r22.y;
                      r14.w = r14.w * r22.y;
                    } else {
                    ...
                    r37.w = samp0[]..swiz;
                      r22.x = abs(r12.w) * -0.200000003 + 0.400000006;
                      r22.z = cmp(r12.w < 0);
                      r22.x = r22.z ? -r22.x : r22.x;
                      r24.xyz = r7.xyz * r22.xxx + v7.xyz;
                      ...
                      r24.y = samp0[]..swiz;
                        ...
                        if (r8.w != 0) {
                          ...
                          r32.z = (uint)r22.x;
                          r22.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r32.xyz, r14.w).x;
                        }
                        r14.w = r22.z * r22.z;
                        r14.w = r14.w * r22.z;
                      } else {
                  ...
                  r14.w = r3.z * r14.w + abs(r12.w);
                  r14.w = r14.w * r10.z;
                  r19.x = cmp(0 < r12.w);
                  r23.xyz = r14.www * r21.xyw + r17.xyz;
                  r12.w = saturate(r12.w);
                  r20.xyz = r20.xyz * r10.www + r2.xyz;
                  r10.w = dot(r20.xyz, r20.xyz);
                  r10.w = rsqrt(r10.w);
                  r20.xyz = r20.xyz * r10.www;
                  r10.w = dot(r20.xyz, r2.xyz);
                  r14.w = dot(r7.xyz, r20.xyz);
                  r20.x = abs(r14.w) * r3.y + -abs(r14.w);
                  r14.w = abs(r14.w) * r20.x + 1;
                  r20.x = r12.w * r3.w + r4.z;
                  r14.w = r14.w * r14.w;
                  r14.w = r14.w * r20.x;
                  r14.w = rcp(r14.w);
                  r12.w = r12.w * r13.w;
                  r12.w = r14.w * r12.w;
                  r10.z = r12.w * r10.z;
                  r20.xyz = r10.zzz * r21.xyw + r31.xyz;
                  r10.w = saturate(1 + -r10.w);
                  r12.w = r10.w * r10.w;
                  r12.w = r12.w * r12.w;
                  r10.w = r12.w * r10.w;
                  r10.z = r10.z * r10.w;
                  r21.xyw = r10.zzz * r21.xyw + r30.xyz;
                  r17.xyz = r19.xxx ? r23.xyz : r17.xyz;
                  r30.xyz = r19.xxx ? r21.xyw : r30.xyz;
                  r31.xyz = r19.xxx ? r20.xyz : r31.xyz;
                }
              }
            }
            break;
  ...
  r1.yzw = r29.xyz * r0.www;
  r2.xyz = r28.xyz * r0.www;
  r2.xyz = float3(0.959999979,0.959999979,0.959999979) * r2.xyz;
  r1.yzw = r1.yzw * float3(0.0399999991,0.0399999991,0.0399999991) + r2.xyz;
  r1.yzw = r11.yzw * r6.xyz + r1.yzw;
  r0.y = 1 + -coolingFactor;
  r0.y = r1.x * r0.y;
  r2.xyz = r8.xyz * r0.zzz + -r9.xyz;
  r0.yzw = r0.yyy * r2.xyz + r9.xyz;
  r1.x = w1.x * r1.x;
  r2.w = r1.x * r0.x;
  r0.x = dot(r1.yzw, float3(0.298999995,0.587000012,0.114));
  r0.x = max(9.99999975e-05, r0.x);
  r0.x = max(relHDRExposure.x, r0.x);
  r3.xyz = r0.yzw * r0.xxx;
  r0.xyz = relativeHDR ? r3.xyz : r0.yzw;
