...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  r4.w = outlineMap.Sample(colorSampler_s, w1.xy).w;
  r5.xyzw = w1.xyyz + r6.xyzz;
  ...
  if (r6.y != 0) {
    ...
    if (r6.y != 0) {
      ...
      r11.yzw = -v6.xyz * r1.www + sunConstants.wldDir.xyz;
