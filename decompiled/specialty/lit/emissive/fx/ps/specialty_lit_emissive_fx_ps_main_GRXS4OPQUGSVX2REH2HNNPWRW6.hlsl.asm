...
add r2.w, r2.w, r2.w
mad r12.xyz, r6.xyzx, -r2.wwww, -r0.yzwy
mul r2.w, r10.y, l(17.000000)
exp r2.w, r2.w
...
mad r8.z, r3.w, l(5.000000), l(-2.500000)
...
mul r9.w, r3.w, r4.w
mad r9.w, -r9.w, l(2.015905), r10.w
exp r9.w, r9.w
mul r9.w, r9.w, r10.x
...
loop 
  ...
  ieq r11.z, r2.x, r10.w
  bfi r11.w, r2.y, l(0), l(0), r11.y
  movc r11.y, r11.z, r11.w, r11.y
  ieq r11.z, r2.z, r10.w
  ubfe r11.w, r10.z, l(0), r11.y
  movc r11.y, r11.z, r11.w, r11.y
    ...
    if_nz r14.w
      ...
      if_nz r14.z
        ...
        if_nz r16.x
          ...
          dp3 r33.x, r6.xyzx, r25.xyzx
          dp3 r33.y, r6.xyzx, r26.xyzx
...
rcp r2.x, r2.x
mov_sat r22.w, r22.w
mul r11.yzw, r2.xxxx, r21.xxyz
mul r14.xyz, r2.xxxx, r22.xyzx
...
if_nz r2.y
  ...
  lt r16.xyz, l(0.000000, 0.000000, 0.000000, 0.000000), r6.xyzx
  ...
  mov r6.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r16.xyz, r6.xyzw, t8.xyzw, s2, l(6.000000)
  mul r15.xyz, r15.xyzx, r16.xyzx
  dp3 r2.z, r15.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
  mad r11.yzw, r21.xxyz, r2.xxxx, r15.xxyz
  mov r12.w, l(0)
  ...
  mad r14.xyz, r15.xyzx, r2.xxxx, r14.xyzx
endif 
add r2.x, r5.x, r10.x
log r2.x, |r2.x|
mul r2.x, r2.x, r3.y
  ...
  if_z r5.x
    ...
    if_nz r8.z
      ...
      loop 
        ...
        breakc_nz r9.w
        ftou r9.w, r8.z
        add r11.yz, r10.yyzy, -cb2[r9.w + 20].xxyx
    ...
    if_z r9.w
      if_z cb2[58].y
        ...
        itof r9.w, cb2[26].y
        add r16.z, r8.z, r9.w
        sample_c_lz_indexable(texture2darray)(float,float,float,float) r9.w, r16.xyzx, t13.xxxx, s13, r5.x
      ...
      if_nz cb2[58].y
        ...
        loop 
          ...
          movc r17.xy, r12.wwww, r10.yzyy, r11.yzyy
  ...
  if_nz r8.z
    ...
    if_z cb0[26].y
      ...
      if_nz r9.w
        ...
        mad r11.y, |r5.x|, l(-0.200000), l(0.400000)
        lt r11.z, r5.x, l(0.000000)
        movc r11.y, r11.z, -r11.y, r11.y
        mad r20.xyz, r6.xyzx, r11.yyyy, v6.xyzx
    ...
    mul r5.x, r5.x, r8.w
    mul r5.x, r6.w, r5.x
    mad r11.yzw, r5.xxxx, r10.yyzw, r2.xxyz
    add_sat r0.x, -r0.x, l(1.000000)
    mul r6.w, r0.x, r0.x
    mul r6.w, r6.w, r6.w
    mul r0.x, r0.x, r6.w
    mul r0.x, r0.x, r5.x
    mad r17.xyz, r0.xxxx, r10.zwyz, r14.xyzx
    mov r16.w, r17.z
    mov r15.w, r14.z
    movc r15.xyzw, r9.wwww, r16.xyzw, r15.xyzw
    mov r17.zw, r11.yyyz
    mov r14.zw, r2.xxxy
    movc r16.xyzw, r9.wwww, r17.xyzw, r14.xyzw
    movc r2.z, r9.w, r11.w, r2.z
    mov r14.z, r15.w
    mov r14.xy, r16.xyxx
    mov r2.xy, r16.zwzz
  endif 
...
not r0.x, r1.z
mad r5.x, -r10.x, l(0.500000), l(1.000000)
mov r10.x, -r8.x
...
loop 
  ...
  loop 
    ...
    if_nz r15.w
      ...
      and r14.w, r32.y, r32.x
      and r14.w, r32.z, r14.w
      if_nz r14.w
        ...
        ubfe r14.w, l(3), l(24), r33.w
        switch r14.w
          case l(4)
          lt r14.w, l(0.000000), r38.x
          mov r39.xy, r37.zwzz
          mov r39.z, r38.w
          mad r40.xyz, -r39.xyzx, l(0.500000, 0.500000, 0.500000, 0.000000), r32.yzwy
          add r41.xyz, r40.xyzx, -v6.xyzx
          dp3 r15.w, r39.xyzx, r41.xyzx
          div_sat r16.z, -r15.w, r38.x
          mad r42.xyz, r16.zzzz, r39.xyzx, r40.xyzx
          movc r42.xyz, r14.wwww, r42.xyzx, r32.yzwy
          ...
          if_nz r25.w
            ...
            mul r16.w, r16.w, r42.x
            mul r16.w, r42.y, r16.w
            lt r25.w, l(0.000000), r16.w
            if_nz r25.w
              ...
              if_nz r25.w
                ...
                loop 
                  ige r29.w, r28.w, l(8)
                  breakc_nz r29.w
                  dp2 r44.y, icb[r28.w + 0].yxyy, r10.xyxx
                  dp2 r44.z, icb[r28.w + 0].yxyy, r10.yzyy
              ...
              if_nz r25.w
                ...
                mad r15.w, r26.w, r28.w, -r15.w
                div_sat r15.w, r15.w, r29.w
                div r26.w, r29.w, r38.x
                mul r26.w, r26.w, l(10.000000)
                min r26.w, r26.w, l(1.000000)
                add r15.w, -r16.z, r15.w
                mad r15.w, r26.w, r15.w, r16.z
                mad r39.xyz, r15.wwww, r39.xyzx, r40.xyzx
                movc r39.xyz, r14.wwww, r39.xyzx, r32.yzwy
                add r39.xyz, r39.xyzx, -v6.xyzx
                dp3 r14.w, r39.xyzx, r39.xyzx
                rsq r14.w, r14.w
                mul r40.xyz, r14.wwww, r39.xyzx
                  ...
                  if_z r19.y
                    ...
                    if_nz r9.w
                      ...
                      loop 
                        ...
                        mad r42.xy, r43.xyxx, r16.zzzz, r41.xyxx
                    ...
                    if_z r19.z
                      ...
                      if_nz r9.w
                        ...
                        loop 
                          ...
                          mad r20.xy, r42.xyxx, r16.zzzz, r41.xyxx
                ...
                mad r15.w, -|r21.w|, r5.x, l(1.000000)
                mul r15.w, r15.w, r15.w
                mad r15.w, -r15.w, l(0.620000), l(0.620000)
                add r15.w, -|r21.w|, r15.w
                mad r15.w, r3.y, r15.w, |r21.w|
                mul r15.w, r16.w, r15.w
                mov r33.x, r32.x
                lt r16.z, l(0.000000), r21.w
                mad r20.xyz, r15.wwww, r33.xyzx, r17.xyzx
                dp3_sat r15.w, r6.xyzx, r40.xyzx
                mad r39.xyz, r39.xyzx, r14.wwww, r0.yzwy
                dp3 r14.w, r39.xyzx, r39.xyzx
                rsq r14.w, r14.w
                mul r39.xyz, r14.wwww, r39.xyzx
                dp3 r14.w, r39.xyzx, r0.yzwy
                dp3 r19.x, r6.xyzx, r39.xyzx
                mad r21.w, |r19.x|, r2.w, -|r19.x|
                mad r19.x, |r19.x|, r21.w, l(1.000000)
                mad r21.w, r15.w, r3.w, r4.w
                mul r19.x, r19.x, r19.x
                mul r19.x, r21.w, r19.x
                rcp r19.x, r19.x
                mul r15.w, r25.w, r15.w
                mul r15.w, r15.w, r19.x
                mul r15.w, r16.w, r15.w
                mad r39.xyz, r15.wwww, r33.xyzx, r31.xyzx
                add_sat r14.w, -r14.w, l(1.000000)
                mul r16.w, r14.w, r14.w
                mul r16.w, r16.w, r16.w
                mul r14.w, r14.w, r16.w
                mul r14.w, r14.w, r15.w
                mad r40.xyz, r14.wwww, r33.xyzx, r30.xyzx
                movc r17.xyz, r16.zzzz, r20.xyzx, r17.xyzx
                movc r30.xyz, r16.zzzz, r40.xyzx, r30.xyzx
                movc r31.xyz, r16.zzzz, r39.xyzx, r31.xyzx
              endif 
            endif 
          endif 
          break 
          ...
          rsq r14.w, r14.w
          mul r39.xyz, r14.wwww, r20.xyzx
          dp3 r15.w, r6.xyzx, r39.xyzx
          ...
          if_nz r16.z
            ...
            if_nz r16.z
              ...
              ine r16.z, r16.z, l(1)
              if_nz r16.z
                mad r16.z, |r15.w|, l(-0.200000), l(0.400000)
                lt r19.x, r15.w, l(0.000000)
                movc r16.z, r19.x, -r16.z, r16.z
                mad r22.xyz, r6.xyzx, r16.zzzz, v6.xyzx
                ...
                if_nz r25.w
                  ...
                  if_nz r9.w
                    ...
                    loop 
                      ...
                      sample_c_lz_indexable(texture2darray)(float,float,float,float) r26.w, r32.xyzx, t9.xxxx, s13, r13.w
                      mad r19.x, r26.w, l(0.125000), r19.x
                      iadd r25.w, r25.w, l(1)
                    endloop 
                  else 
                    utof r22.z, r16.z
                    sample_c_lz_indexable(texture2darray)(float,float,float,float) r19.x, r22.xyzx, t9.xxxx, s13, r13.w
                  endif 
              ...
              lt r16.z, l(0.000000), r13.w
              if_nz r16.z
                mul r16.z, r2.w, r33.x
                ...
                mad r20.xyz, r13.wwww, r21.xywx, r31.xyzx
                add_sat r14.w, -r14.w, l(1.000000)
                mul r15.w, r14.w, r14.w
                mul r15.w, r15.w, r15.w
                mul r14.w, r14.w, r15.w
                mul r13.w, r13.w, r14.w
                mad r21.xyw, r13.wwww, r21.xyxw, r30.xyxz
...
ret 
// Approximately 2166 instruction slots used
