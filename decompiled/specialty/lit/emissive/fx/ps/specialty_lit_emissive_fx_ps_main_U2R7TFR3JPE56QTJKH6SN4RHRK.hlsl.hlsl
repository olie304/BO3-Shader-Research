...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  r7.w = 100 * r7.w;
  r9.zw = -r5.zz * float2(10,5) + float2(6.85740995,7.08500004);
  r8.w = exp2(r9.z);
  r8.w = r8.w * r5.x;
  r8.w = 9.1368103 * r8.w;
  r9.z = r5.w * r5.z;
  ...
  r5.yzw = r21.xyz * r2.xxx;
  r15.xyz = r5.zwy * r2.yyy;
    ...
    if (r5.z == 0) {
      ...
      r9.w = samp0[]..swiz;
        ...
        r19.w = samp0[]..swiz;
          ...
          r13.w = samp0[]..swiz;
            ...
            r13.w = (uint)r13.w;
            r13.w = r13.w * r10.w;
            r13.w = r13.w * 0.00392156886 + r9.w;
            r16.x = (int)r16.y + 1;
      ...
      if (r8.w == 0) {
        if (enableDitheredShadow == 0) {
          ...
          r16.z = r8.w + r6.w;
          r8.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r5.z).x;
        ...
        if (enableDitheredShadow != 0) {
          ...
          while (true) {
            ...
            r17.z = (uint)r12.w;
            r12.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r17.xyz, r5.z).x;
  ...
  if (r6.w != 0) {
    ...
    if (r6.w != 0) {
          ...
          r17.y = samp0[]..swiz;
            ...
            if (enableDitheredShadow != 0) {
              ...
              while (true) {
                ...
                r12.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r18.xyz, r7.w).x;
                r9.w = r12.w * 0.125 + r9.w;
                r10.w = (int)r10.w + 1;
              }
            } else {
              r16.z = (uint)r9.z;
              r9.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r7.w).x;
            }
            r7.w = r9.w * r9.w;
            r7.w = r7.w * r9.w;
          } else {
      ...
      r7.w = r7.w + -abs(r5.z);
      r7.w = r3.z * r7.w + abs(r5.z);
      r7.w = r7.w * r5.w;
      r8.w = cmp(0 < r5.z);
      r16.xyz = r7.www * r11.yzw + r14.xyz;
      r5.z = saturate(r5.z);
        ...
        r39.w = samp0[]..swiz;
          ...
          switch (r9.w) {
            ...
            if (r15.w != 0) {
              ...
              r13.w = r17.z / r13.w;
              r13.w = min(1, r13.w);
              r17.zw = saturate(r15.ww * r35.xz + r35.yw);
              r43.xy = r17.zw * r17.zw;
              r17.zw = r17.zw * float2(-2,-2) + float2(3,3);
              r17.zw = r43.xy * r17.zw;
              r13.w = r17.z * r13.w;
              r13.w = r13.w * r17.w;
              r15.w = cmp(0 < r13.w);
              if (r15.w != 0) {
                ...
                if (r15.w != 0) {
                  ...
                  while (true) {
                    ...
                    if (r26.w != 0) break;
                    r45.y = dot(icb[r22.w+0].yx, r16.xy);
                    r45.z = dot(icb[r22.w+0].yx, r16.yz);
                    r45.yz = r45.yz * r36.yy;
                    r45.x = r45.y * r11.x;
                    r45.w = r45.y * r3.x;
                    r44.xyz = r43.xyz * r17.zzz + r45.xzw;
                    r26.w = gOmniShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r44.xyzw, r15.w).x;
                ...
                if (r15.w != 0) {
                  r15.w = r34.x * r3.y;
                  r15.w = 0.25 * r15.w;
                  r17.z = dot(r40.xyz, r12.xyz);
                  r22.w = dot(r12.xyz, r42.xyz);
                  r26.w = -r17.z * r17.z + r39.x;
                  r10.w = r17.z * r22.w + -r10.w;
                  r10.w = saturate(r10.w / r26.w);
                  r17.z = r26.w / r39.x;
                  r17.z = 10 * r17.z;
                  r17.z = min(1, r17.z);
                  r10.w = r10.w + -r12.w;
                  r10.w = r17.z * r10.w + r12.w;
                  ...
                  r43.w = samp0[]..swiz;
                    ...
                    r22.w = cmp(r14.w < 0);
                    r17.z = r22.w ? -r17.z : r17.z;
                    r20.xyz = r6.xyz * r17.zzz + v6.xyz;
                    r17.z = dot(r42.xyzw, r20.xyzw);
                    r22.w = dot(r43.xyzw, r20.xyzw);
                    r26.w = cmp(r22.w < r17.z);
                    if (r26.w == 0) {
                    // Known bad code for instruction (needs manual fix):
                    ...
                    r46.y = samp0[]..swiz;
                      ...
                      r20.x = r46.y * r22.w;
                      r17.z = r46.x * r22.w + r17.z;
                      r17.z = r17.z / r20.x;
                    } else {
                      r20.z = -1;
                    }
                    r20.x = (int)r26.w | (int)r20.z;
                    if (r20.x == 0) {
                    // Known bad code for instruction (needs manual fix):
                    ...
                    r10.w = samp0[]..swiz;
                      ...
                      if (r7.w != 0) {
                        ...
                        while (true) {
                          ...
                          r43.y = dot(icb[r26.w+0].xy, r9.xy);
                          r20.xy = r43.xy * r12.ww + r42.xy;
                        ...
                        r42.z = (uint)r10.w;
                        r22.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r42.xyz, r17.z).x;
                      }
                      r10.w = r22.w * r22.w;
                      r10.w = r10.w * r22.w;
                    } else {
                    ...
                    r43.w = samp0[]..swiz;
                      r17.z = abs(r14.w) * -0.200000003 + 0.400000006;
                      r20.x = cmp(r14.w < 0);
                      r17.z = r20.x ? -r17.z : r17.z;
                      r21.xyz = r6.xyz * r17.zzz + v6.xyz;
                      r17.z = dot(r42.xyzw, r21.xyzw);
                      r20.x = dot(r43.xyzw, r21.xyzw);
                      r20.y = cmp(r20.x < r17.z);
                      if (r20.y == 0) {
                      // Known bad code for instruction (needs manual fix):
                                            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r42.xyzw, r10.w, l(68), t12.xyzw
                      r42.x = samp0[]..swiz;
                      ...
                      r46.y = samp0[]..swiz;
                        ...
                        r21.xy = r21.xy * r44.xz + r44.yw;
                        r26.w = r46.y * r20.x;
                        r17.z = r46.x * r20.x + r17.z;
                        r17.z = r17.z / r26.w;
                      } else {
                        r20.z = -1;
                      }
                      ...
                      r10.w = samp0[]..swiz;
                        ...
                        if (r7.w != 0) {
                          ...
                          r21.z = (uint)r10.w;
                          r26.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r21.xyz, r17.z).x;
                        }
                        r10.w = r26.w * r26.w;
                        r10.w = r10.w * r26.w;
                      } else {
                  ...
                  r10.w = r14.w * r10.w;
                  r10.w = r10.w * r13.w;
                  r21.xyz = r10.www * r34.xyz + r32.xyz;
                  r9.w = saturate(1 + -r9.w);
                  r13.w = r9.w * r9.w;
                  r13.w = r13.w * r13.w;
                  r9.w = r13.w * r9.w;
                  r9.w = r10.w * r9.w;
                  r40.xyz = r9.www * r34.xyz + r31.xyz;
                  r18.xyz = r12.www ? r20.xyz : r18.xyz;
                  r31.xyz = r12.www ? r40.xyz : r31.xyz;
                  r32.xyz = r12.www ? r21.xyz : r32.xyz;
                }
              }
            }
            break;
            ...
            r9.w = rsqrt(r9.w);
            r21.xyz = r20.xyz * r9.www;
            r10.w = dot(r6.xyz, r21.xyz);
            r12.w = cmp(0 < abs(r10.w));
            if (r12.w != 0) {
            // Known bad code for instruction (needs manual fix):
            ...
            r41.w = samp0[]..swiz;
              ...
              r14.w = samp0[]..swiz;
                ...
                r15.w = r36.x * r36.x;
                r17.z = dot(r46.xyz, r46.xyz);
                r15.w = r15.w / r17.z;
                r15.w = min(1, r15.w);
                r35.xy = saturate(r12.ww * r35.xz + r35.yw);
                ...
                r46.xyz = r38.yzw;
                r46.w = r39.w;
                r35.y = dot(r46.xyzw, r19.xyzw);
                r22.xy = r35.xy / r12.ww;
                r12.w = cmp(r43.w < 0.00048828125);
                if (r12.w != 0) {
                  r44.y = r45.x;
                  r35.xy = saturate(abs(r22.xy) * r44.zw + r44.xy);
                  r35.zw = r35.xy * r35.xy;
                  r35.xy = r35.xy * float2(-2,-2) + float2(3,3);
                  r35.xy = r35.zw * r35.xy;
                  r12.w = r35.x * r35.y;
                  ...
                  r43.w = r44.y;
                  r35.xyzw = saturate(r43.xyzw * abs(r22.yyxx));
                  ...
                  r17.z = r44.z * r35.x;
                  r27.w = r44.w * r35.y + -1;
                  r17.z = r44.w * r35.y + -r17.z;
                  r17.z = saturate(r27.w / r17.z);
                  r27.w = r17.z * r17.z;
                  r17.z = r17.z * -2 + 3;
                  r12.w = r27.w * r17.z;
                }
                ...
                r35.y = samp0[]..swiz;
                r35.z = samp0[]..swiz;
                  r14.w = dot(r45.yzw, r22.xyz);
                  r15.w = dot(r35.xyz, r22.xyz);
                  r35.x = frac(r14.w);
                  r35.y = frac(r15.w);
                  r12.w = (int)r12.w + -1;
                  r35.z = (uint)r12.w;
                  r21.xyz = gCookieArray.SampleLevel(samplerLinear_s, r35.xyz, 0).xyz;
                } else {
                  r21.xyz = float3(1,1,1);
                }
              }
              r33.yz = r34.yz;
              r21.xyz = r33.xyz * r21.xyz;
              r12.w = cmp(0 < r13.w);
              if (r12.w != 0) {
                if (3 == 0) r12.w = 0; else if (3+27 < 32) {                 r12.w = (uint)r34.w << (32-(3 + 27)); r12.w = (uint)r12.w >> (32-3);                } else r12.w = (uint)r34.w >> 27;
                r12.w = cmp((int)r12.w != 1);
                if (r12.w != 0) {
                  r12.w = abs(r10.w) * -0.200000003 + 0.400000006;
                  r14.w = cmp(r10.w < 0);
                  r12.w = r14.w ? -r12.w : r12.w;
                  r23.xyz = r6.xyz * r12.www + v6.xyz;
                  r40.xyz = r39.xyz;
                  r12.w = dot(r40.xyzw, r23.xyzw);
                  r14.w = dot(r42.xyzw, r23.xyzw);
                  ...
                  r41.y = samp0[]..swiz;
                    ...
                    r39.xyz = r38.yzw;
                    r22.y = dot(r39.xyzw, r23.xyzw);
                    r22.xy = r22.xy / r14.ww;
                    r22.xy = saturate(r22.xy * float2(0.5,-0.5) + float2(0.5,0.5));
                    r23.xy = r22.xy * r41.zw + r41.xy;
                    r9.z = r12.w / r14.w;
                    r9.z = max(6.10351563e-05, r9.z);
                    r12.w = (int)r34.w & 0x0000ffff;
                    if (r7.w != 0) {
                      r33.z = (uint)r12.w;
                      r14.w = 0;
                      r15.w = 0;
                      while (true) {
                        r17.z = cmp((int)r15.w >= 8);
                        if (r17.z != 0) break;
                        r22.x = dot(icb[r15.w+0].xy, r26.xy);
                        r22.y = dot(icb[r15.w+0].yx, r26.xz);
                        r33.xy = r22.xy * r36.yy + r23.xy;
                        r17.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r33.xyz, r9.z).x;
                        r14.w = r17.z * 0.125 + r14.w;
                        r15.w = (int)r15.w + 1;
                      }
                    } else {
                      r23.z = (uint)r12.w;
                      r14.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r23.xyz, r9.z).x;
                    }
                    r9.z = r14.w * r14.w;
                    r9.z = r9.z * r14.w;
                  } else {
                ...
                if (r12.w != 0) {
                  ...
                  r39.z = samp0[]..swiz;
                  r39.w = samp0[]..swiz;
                    r17.z = abs(r10.w) * -0.200000003 + 0.400000006;
                    r22.x = cmp(r10.w < 0);
                    r17.z = r22.x ? -r17.z : r17.z;
                    r24.xyz = r6.xyz * r17.zzz + v6.xyz;
                    r22.x = dot(r33.xyzw, r24.xyzw);
                    r22.y = dot(r35.xyzw, r24.xyzw);
                    r17.z = dot(r36.xyzw, r24.xyzw);
                    r23.x = dot(r37.xyzw, r24.xyzw);
                    r23.y = cmp(r23.x < r17.z);
                    r22.xy = r22.xy / r23.xx;
                    r22.xy = r22.xy * float2(0.5,-0.5) + float2(0.5,0.5);
                    r22.xy = r22.xy + r39.zw;
                    r22.xy = r22.xy * r39.xy;
                    r24.xy = r15.ww / r38.xz;
                    ...
                    r24.y = samp0[]..swiz;
                      ...
                      r13.w = r24.y * r23.x;
                      r17.z = r24.x * r23.x + r17.z;
                      r13.w = r17.z / r13.w;
                      r13.w = max(6.10351563e-05, r13.w);
                      r17.z = r23.y ? 0.000000 : 0;
                      if (r7.w != 0) {
                        r23.z = (uint)r17.z;
                        r22.xy = float2(0,0);
                        while (true) {
                        ...
                        r33.z = (uint)r17.z;
                        r22.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r33.xyz, r13.w).x;
                      }
                      r13.w = r22.x * r22.x;
                      r13.w = r13.w * r22.x;
                    } else {
                    ...
                    r38.w = samp0[]..swiz;
                      ...
                      r24.y = samp0[]..swiz;
                        ...
                        r25.xy = r23.xy * r37.xz + r37.yw;
                        r13.w = r24.y * r22.y;
                        r17.z = r24.x * r22.y + r17.z;
                        r13.w = r17.z / r13.w;
                        r13.w = max(6.10351563e-05, r13.w);
                        r17.z = r23.z ? 0.000000 : 0;
                        if (r7.w != 0) {
                          r23.z = (uint)r17.z;
                          r22.y = 0;
                          r24.x = 0;
                          while (true) {
                            ...
                            if (r24.y != 0) break;
                            r33.x = dot(icb[r24.x+0].xy, r28.xy);
                            r33.y = dot(icb[r24.x+0].yx, r28.xz);
                            r23.xy = r33.xy * r15.ww + r25.xy;
                            r23.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r23.xyz, r13.w).x;
                          ...
                          r25.z = (uint)r17.z;
                          r22.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r25.xyz, r13.w).x;
                        }
                        r13.w = r22.y * r22.y;
                        r13.w = r13.w * r22.y;
                      } else {
                  ...
                  r13.w = -abs(r10.w) * r5.x + 1;
                  r13.w = r13.w * r13.w;
                  r13.w = -r13.w * 0.620000005 + 0.620000005;
                  r13.w = r13.w + -abs(r10.w);
                  r13.w = r3.z * r13.w + abs(r10.w);
                  r13.w = r13.w * r9.z;
                  r15.w = cmp(0 < r10.w);
                  r23.xyz = r13.www * r21.xyz + r18.xyz;
                  r10.w = saturate(r10.w);
                  r20.xyz = r20.xyz * r9.www + r0.yzw;
                  r9.w = dot(r20.xyz, r20.xyz);
                  r9.w = rsqrt(r9.w);
                  r20.xyz = r20.xyz * r9.www;
                  r9.w = dot(r20.xyz, r0.yzw);
                  r13.w = dot(r6.xyz, r20.xyz);
                  r17.z = abs(r13.w) * r3.y + -abs(r13.w);
                  r13.w = abs(r13.w) * r17.z + 1;
                  r17.z = r10.w * r3.w + r5.y;
                  r13.w = r13.w * r13.w;
                  r13.w = r13.w * r17.z;
                  r13.w = rcp(r13.w);
                  ...
                  r10.w = r13.w * r10.w;
                  r9.z = r10.w * r9.z;
                  r20.xyz = r9.zzz * r21.xyz + r32.xyz;
                  r9.w = saturate(1 + -r9.w);
                  r10.w = r9.w * r9.w;
                  r10.w = r10.w * r10.w;
                  r9.w = r10.w * r9.w;
                  r9.z = r9.z * r9.w;
                  r21.xyz = r9.zzz * r21.xyz + r31.xyz;
                  r18.xyz = r15.www ? r23.xyz : r18.xyz;
                  r31.xyz = r15.www ? r21.xyz : r31.xyz;
                  r32.xyz = r15.www ? r20.xyz : r32.xyz;
                }
              }
            }
            break;
