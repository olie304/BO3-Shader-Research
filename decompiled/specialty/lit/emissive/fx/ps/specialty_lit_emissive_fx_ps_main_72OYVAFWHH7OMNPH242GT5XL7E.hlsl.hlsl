...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  if (r7.w != 0) {
    ...
    if (r7.w != 0) {
      ...
      r5.x = saturate(r5.x);
      r12.yzw = -v7.xyz * r0.xxx + sunConstants.wldDir.xyz;
