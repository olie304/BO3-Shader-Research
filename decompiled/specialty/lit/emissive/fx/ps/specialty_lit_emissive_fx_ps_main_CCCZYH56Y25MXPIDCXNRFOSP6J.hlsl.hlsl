// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:41:38 2021
...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r8.z = max(0, r8.z);
  r10.zw = -r3.ww * float2(10,5) + float2(6.85740995,7.08500004);
  r8.w = exp2(r10.z);
  r8.w = r10.x * r8.w;
  r8.zw = float2(100,9.1368103) * r8.zw;
  r9.w = r4.w * r3.w;
  r9.w = -r9.w * 2.0159049 + r10.w;
  r9.w = exp2(r9.w);
  r9.w = r10.x * r9.w;
  ...
  r13.z = (uint)r2.y << 4;
  r2.x = (int)r9.w & -32;
  r2.y = (int)-r2.x + (int)r9.w;
  r2.z = numRefProbes & -32;
  r10.z = (int)-r2.z + numRefProbes;
  r14.xy = float2(0,0);
  r15.w = 0;
  r16.yz = float2(0,1);
  r17.xy = float2(0,0);
  ...
  while (true) {
    ...
    r11.z = cmp((int)r2.x == (int)r10.w);
    bitmask.w = ((~(-1 << r2.y)) << 0) & 0xffffffff;  r11.w = (((uint)0 << 0) & bitmask.w) | ((uint)r11.y & ~bitmask.w);
    r11.y = r11.z ? r11.w : r11.y;
    r11.z = cmp((int)r2.z == (int)r10.w);
    if (r10.z == 0) r11.w = 0; else if (r10.z+0 < 32) {     r11.w = (uint)r11.y << (32-(r10.z + 0)); r11.w = (uint)r11.w >> (32-r10.z);    } else r11.w = (uint)r11.y >> 0;
    r11.y = r11.z ? r11.w : r11.y;
      ...
      r15.y = samp0[]..swiz;
        ...
        r32.w = samp0[]..swiz;
          ...
          r38.y = samp0[]..swiz;
            ...
            r33.x = dot(r6.xyz, r25.xyz);
            r33.y = dot(r6.xyz, r26.xyz);
  ...
  if (r2.z != 0) {
    ...
    r10.z = 0;
    while (true) {
      r10.w = cmp((uint)r10.z >= (uint)r9.w);
      if (r10.w != 0) break;
      r14.z = (uint)r10.z >> 5;
      r15.xyz = (int3)r13.xyz + (int3)r14.xyz;
      r10.w = visibleProbes.Load(r15.xyzw).x;
      r13.w = cmp((int)r2.x == (int)r10.z);
      if (r2.y == 0) r14.z = 0; else if (r2.y+0 < 32) {       r14.z = (uint)r10.w << (32-(r2.y + 0)); r14.z = (uint)r14.z >> (32-r2.y);      } else r14.z = (uint)r10.w >> 0;
      r10.w = r13.w ? r14.z : r10.w;
      r13.w = (int)r10.z + numLights;
      r24.xyzw = r23.xyzw;
      r15.xyz = r11.yzw;
      r14.z = r2.z;
      r14.w = r10.w;
  ...
  r11.yzw = r21.xyz * r2.xxx;
  r14.xyz = r22.xyz * r2.xxx;
  ...
  if (r2.y != 0) {
    ...
    r16.xyz = cmp(float3(0,0,0) < r6.xyz);
    ...
    r6.w = 0;
    r16.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r6.xyzw, 6).xyz;
    r15.xyz = r16.xyz * r15.xyz;
    r2.z = dot(r15.xyz, float3(0.212599993,0.715200007,0.0722000003));
    r11.yzw = r21.xyz * r2.xxx + r15.xyz;
    r12.w = 0;
    r15.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r12.xyzw, r4.w).xyz;
  ...
  r10.yzw = r14.xyz * r2.xxx;
  r14.xyz = r10.zwy * r2.yyy;
  r2.xyz = r10.yzw * r2.zzz;
  r3.w = sqrt(r3.y);
  r3.w = r3.w * 0.5 + 0.5;
  r3.w = r3.w * r3.w;
  r4.w = 0.5 * r3.w;
  r3.w = -r3.w * 0.5 + 1;
  r5.x = r10.x * r3.w + r4.w;
  r3.w = r5.x * r3.w;
  r4.w = r5.x * r4.w;
  if (noReceiveShadow == 0) {
    ...
    if (r5.x == 0) {
      ...
      r5.x = -sunConstants.splitDepthOffset + r10.w;
      ...
      if (r8.z != 0) {
        ...
        while (true) {
          ...
          if (r9.w != 0) break;
          r9.w = (uint)r8.z;
          r11.yz = -sunConstants.splitPinTransform[r9.w].xy + r10.yz;
          r11.y = max(abs(r11.y), abs(r11.z));
          r8.w = sunConstants.splitPinTransform[r9.w].z * r11.y;
          r9.w = cmp(r8.w < 1);
          if (r9.w != 0) {
            break;
          }
      ...
      if (r9.w == 0) {
        if (enableDitheredShadow == 0) {
          ...
          r16.z = r9.w + r8.z;
          r9.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r5.x).x;
        ...
        if (enableDitheredShadow != 0) {
          ...
          while (true) {
            ...
            r17.xy = r12.ww ? r10.yz : r11.yz;
            r13.w = r12.w ? sunConstants.splitPinTransform[r8.z].w : sunConstants.splitPinTransform[r9.w].w;
            ...
            r17.z = (uint)r12.w;
            r12.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r17.xyz, r5.x).x;
  ...
  if (r8.z != 0) {
    ...
    if (r8.z != 0) {
      ...
      if (noReceiveShadow == 0) {
        ...
        r19.z = samp0[]..swiz;
        r19.w = samp0[]..swiz;
          r11.y = abs(r5.x) * -0.200000003 + 0.400000006;
          r11.z = cmp(r5.x < 0);
          r11.y = r11.z ? -r11.y : r11.y;
          r20.xyz = r6.xyz * r11.yyy + v6.xyz;
          r20.w = 1;
      ...
      r8.w = -r10.x * 0.5 + 1;
      r8.w = -abs(r5.x) * r8.w + 1;
      r8.w = r8.w * r8.w;
      r8.w = -r8.w * 0.620000005 + 0.620000005;
      r8.w = r8.w + -abs(r5.x);
      r8.w = r3.y * r8.w + abs(r5.x);
      r8.w = r8.w * r6.w;
      r9.w = cmp(0 < r5.x);
      r16.xyz = r8.www * r10.yzw + r15.xyz;
      r5.x = saturate(r5.x);
      r11.yzw = -v6.xyz * r0.xxx + sunConstants.wldDir.xyz;
      r0.x = dot(r11.yzw, r11.yzw);
      r0.x = rsqrt(r0.x);
      r11.yzw = r11.yzw * r0.xxx;
      r0.x = dot(r11.yzw, r0.yzw);
      r8.w = dot(r6.xyz, r11.yzw);
      r11.y = abs(r8.w) * r2.w + -abs(r8.w);
      r8.w = abs(r8.w) * r11.y + 1;
      r11.y = r5.x * r3.w + r4.w;
      r8.w = r8.w * r8.w;
      r8.w = r8.w * r11.y;
      r8.w = rcp(r8.w);
      r5.x = r5.x * r8.z;
      r5.x = r8.w * r5.x;
      r5.x = r5.x * r6.w;
      r11.yzw = r5.xxx * r10.yzw + r2.xyz;
      r0.x = saturate(1 + -r0.x);
      r6.w = r0.x * r0.x;
      r6.w = r6.w * r6.w;
      r0.x = r6.w * r0.x;
      r0.x = r5.x * r0.x;
      r17.xyz = r0.xxx * r10.zwy + r14.xyz;
      r16.w = r17.z;
      r15.w = r14.z;
      r15.xyzw = r9.wwww ? r16.xyzw : r15.xyzw;
      r17.zw = r11.yz;
      r14.zw = r2.xy;
      r16.xyzw = r9.wwww ? r17.xyzw : r14.xyzw;
      r2.z = r9.w ? r11.w : r2.z;
      r14.z = r15.w;
      r14.xy = r16.xy;
      r2.xy = r16.zw;
    }
  ...
  while (true) {
    ...
    while (true) {
      ...
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=80)(mixed,mixed,mixed,mixed) r32.xyzw, r13.w, l(0), t11.xyzw
      r32.x = samp0[]..swiz;
      r32.y = samp0[]..swiz;
      r32.z = samp0[]..swiz;
      r32.w = samp0[]..swiz;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=80)(mixed,mixed,mixed,mixed) r33.xy, r13.w, l(16), t11.xyxx
      r33.x = samp0[]..swiz;
      r33.y = samp0[]..swiz;
        ...
        if (r14.w != 0) {
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r32.xyzw, r13.w, l(0), t12.wxyz
        r32.x = samp0[]..swiz;
        r32.y = samp0[]..swiz;
        r32.z = samp0[]..swiz;
        r32.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r33.xyzw, r13.w, l(16), t12.zxyw
        r33.x = samp0[]..swiz;
        r33.y = samp0[]..swiz;
        r33.z = samp0[]..swiz;
        r33.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r34.xyzw, r13.w, l(32), t12.xyzw
        r34.x = samp0[]..swiz;
        r34.y = samp0[]..swiz;
        r34.z = samp0[]..swiz;
        r34.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r35.xyzw, r13.w, l(48), t12.xyzw
        r35.x = samp0[]..swiz;
        r35.y = samp0[]..swiz;
        r35.z = samp0[]..swiz;
        r35.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r36.xyzw, r13.w, l(64), t12.yzwx
        r36.x = samp0[]..swiz;
        r36.y = samp0[]..swiz;
        r36.z = samp0[]..swiz;
        r36.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r37.xyzw, r13.w, l(80), t12.xyzw
        r37.x = samp0[]..swiz;
        r37.y = samp0[]..swiz;
        r37.z = samp0[]..swiz;
        r37.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r38.xyzw, r13.w, l(96), t12.yzwx
        r38.x = samp0[]..swiz;
        r38.y = samp0[]..swiz;
        r38.z = samp0[]..swiz;
        r38.w = samp0[]..swiz;
          if (3 == 0) r14.w = 0; else if (3+24 < 32) {           r14.w = (uint)r33.w << (32-(3 + 24)); r14.w = (uint)r14.w >> (32-3);          } else r14.w = (uint)r33.w >> 24;
          switch (r14.w) {
            case 4 :            r14.w = cmp(0 < r38.x);
            r39.xy = r37.zw;
            r39.z = r38.w;
            r40.xyz = -r39.xyz * float3(0.5,0.5,0.5) + r32.yzw;
            r41.xyz = -v6.xyz + r40.xyz;
            r15.w = dot(r39.xyz, r41.xyz);
            r16.z = saturate(-r15.w / r38.x);
            r42.xyz = r16.zzz * r39.xyz + r40.xyz;
            r42.xyz = r14.www ? r42.xyz : r32.yzw;
              ...
              if (r25.w != 0) {
                ...
                if (r25.w != 0) {
                  ...
                  while (true) {
                    ...
                    if (r29.w != 0) break;
                    r44.y = dot(icb[r28.w+0].yx, r10.xy);
                    r44.z = dot(icb[r28.w+0].yx, r10.yz);
                ...
                if (r25.w != 0) {
                  ...
                  r15.w = r26.w * r28.w + -r15.w;
                  r15.w = saturate(r15.w / r29.w);
                  r26.w = r29.w / r38.x;
                  r26.w = 10 * r26.w;
                  r26.w = min(1, r26.w);
                  r15.w = r15.w + -r16.z;
                  r15.w = r26.w * r15.w + r16.z;
                  r39.xyz = r15.www * r39.xyz + r40.xyz;
                  r39.xyz = r14.www ? r39.xyz : r32.yzw;
                  r39.xyz = -v6.xyz + r39.xyz;
                  r14.w = dot(r39.xyz, r39.xyz);
                  r14.w = rsqrt(r14.w);
                  r40.xyz = r39.xyz * r14.www;
                  ...
                  r16.z = samp0[]..swiz;
                  // Known bad code for instruction (needs manual fix):
                                    ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r41.xyzw, r15.w, l(100), t12.xyzw
                  r41.x = samp0[]..swiz;
                  r41.y = samp0[]..swiz;
                  r41.z = samp0[]..swiz;
                  r41.w = samp0[]..swiz;
                  // Known bad code for instruction (needs manual fix):
                                    ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r42.xyzw, r15.w, l(116), t12.xyzw
                  r42.x = samp0[]..swiz;
                  r42.y = samp0[]..swiz;
                  r42.z = samp0[]..swiz;
                  r42.w = samp0[]..swiz;
                    ...
                    r19.xyz = r6.xyz * r26.www + v6.xyz;
                    r26.w = dot(r41.xyzw, r19.xyzw);
                    r28.w = dot(r42.xyzw, r19.xyzw);
                    r29.w = cmp(r28.w < r26.w);
                    if (r29.w == 0) {
                    // Known bad code for instruction (needs manual fix):
                                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r41.xyzw, r15.w, l(68), t12.xyzw
                    r41.x = samp0[]..swiz;
                    r41.y = samp0[]..swiz;
                    r41.z = samp0[]..swiz;
                    r41.w = samp0[]..swiz;
                    // Known bad code for instruction (needs manual fix):
                                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r42.xyzw, r15.w, l(84), t12.xyzw
                    r42.x = samp0[]..swiz;
                    r42.y = samp0[]..swiz;
                    r42.z = samp0[]..swiz;
                    r42.w = samp0[]..swiz;
                    // Known bad code for instruction (needs manual fix):
                                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r43.xyzw, r15.w, l(132), t12.xyzw
                    r43.x = samp0[]..swiz;
                    r43.y = samp0[]..swiz;
                    r43.z = samp0[]..swiz;
                    r43.w = samp0[]..swiz;
                    // Known bad code for instruction (needs manual fix):
                                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r44.xyzw, r15.w, l(148), t12.xyzw
                    r44.x = samp0[]..swiz;
                    r44.y = samp0[]..swiz;
                    r44.z = samp0[]..swiz;
                    r44.w = samp0[]..swiz;
                    // Known bad code for instruction (needs manual fix):
                                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r45.xy, r15.w, l(164), t12.xyxx
                    r45.x = samp0[]..swiz;
                    r45.y = samp0[]..swiz;
                  ...
                  r15.w = -abs(r21.w) * r5.x + 1;
                  r15.w = r15.w * r15.w;
                  r15.w = -r15.w * 0.620000005 + 0.620000005;
                  r15.w = r15.w + -abs(r21.w);
                  r15.w = r3.y * r15.w + abs(r21.w);
                  r15.w = r15.w * r16.w;
                  r33.x = r32.x;
                  r16.z = cmp(0 < r21.w);
                  r20.xyz = r15.www * r33.xyz + r17.xyz;
                  r15.w = saturate(dot(r6.xyz, r40.xyz));
                  r39.xyz = r39.xyz * r14.www + r0.yzw;
                  r14.w = dot(r39.xyz, r39.xyz);
                  r14.w = rsqrt(r14.w);
                  r39.xyz = r39.xyz * r14.www;
                  r14.w = dot(r39.xyz, r0.yzw);
                  r19.x = dot(r6.xyz, r39.xyz);
                  r21.w = abs(r19.x) * r2.w + -abs(r19.x);
                  r19.x = abs(r19.x) * r21.w + 1;
                  r21.w = r15.w * r3.w + r4.w;
                  r19.x = r19.x * r19.x;
                  r19.x = r19.x * r21.w;
                  r19.x = rcp(r19.x);
                  r15.w = r15.w * r25.w;
                  r15.w = r19.x * r15.w;
                  r15.w = r15.w * r16.w;
                  r39.xyz = r15.www * r33.xyz + r31.xyz;
                  r14.w = saturate(1 + -r14.w);
                  r16.w = r14.w * r14.w;
                  r16.w = r16.w * r16.w;
                  r14.w = r16.w * r14.w;
                  r14.w = r15.w * r14.w;
                  r40.xyz = r14.www * r33.xyz + r30.xyz;
                  r17.xyz = r16.zzz ? r20.xyz : r17.xyz;
                  r30.xyz = r16.zzz ? r40.xyz : r30.xyz;
                  r31.xyz = r16.zzz ? r39.xyz : r31.xyz;
                }
              }
            }
            break;
            ...
            r14.w = rsqrt(r14.w);
            r39.xyz = r20.xyz * r14.www;
            r15.w = dot(r6.xyz, r39.xyz);
            r16.z = cmp(0 < abs(r15.w));
            if (r16.z != 0) {
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r39.xyzw, r13.w, l(112), t12.yzwx
            r39.x = samp0[]..swiz;
            r39.y = samp0[]..swiz;
            r39.z = samp0[]..swiz;
            r39.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r40.xyzw, r13.w, l(128), t12.zxyw
            r40.x = samp0[]..swiz;
            r40.y = samp0[]..swiz;
            r40.z = samp0[]..swiz;
            r40.w = samp0[]..swiz;
              ...
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r43.xyzw, r13.w, l(172), t12.yzwx
              r43.x = samp0[]..swiz;
              r43.y = samp0[]..swiz;
              r43.z = samp0[]..swiz;
              r43.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r44.xyzw, r13.w, l(188), t12.wxyz
              r44.x = samp0[]..swiz;
              r44.y = samp0[]..swiz;
              r44.z = samp0[]..swiz;
              r44.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r45.xyzw, r13.w, l(204), t12.xyzw
              r45.x = samp0[]..swiz;
              r45.y = samp0[]..swiz;
              r45.z = samp0[]..swiz;
              r45.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r19.x, r13.w, l(236), t12.xxxx
              r19.x = samp0[]..swiz;
                ...
                if (r16.z != 0) {
                // Known bad code for instruction (needs manual fix):
                                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r34.xyz, r13.w, l(220), t12.xyzx
                r34.x = samp0[]..swiz;
                r34.y = samp0[]..swiz;
                r34.z = samp0[]..swiz;
              ...
              if (r16.z != 0) {
                ...
                if (r16.z != 0) {
                  r16.z = abs(r15.w) * -0.200000003 + 0.400000006;
                  r19.x = cmp(r15.w < 0);
                  r16.z = r19.x ? -r16.z : r16.z;
                  r22.xyz = r6.xyz * r16.zzz + v6.xyz;
                  r39.xyz = r38.xyz;
                  ...
                  if (r25.w != 0) {
                  // Known bad code for instruction (needs manual fix):
                                    ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r40.y, r13.w, l(144), t12.xxxx
                  r40.y = samp0[]..swiz;
                    r36.w = r37.x;
                    ...
                    if (r9.w != 0) {
                      ...
                      while (true) {
                        ...
                        r26.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r32.xyz, r13.w).x;
                        r19.x = r26.w * 0.125 + r19.x;
                        r25.w = (int)r25.w + 1;
                      }
                    } else {
                      r22.z = (uint)r16.z;
                      r19.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r22.xyz, r13.w).x;
                    }
                    r13.w = r19.x * r19.x;
                    r13.w = r13.w * r19.x;
                  } else {
                ...
                if (r16.z != 0) {
                  ...
                  r16.w = -abs(r15.w) * r5.x + 1;
                  r16.w = r16.w * r16.w;
                  r16.w = -r16.w * 0.620000005 + 0.620000005;
                  r16.w = r16.w + -abs(r15.w);
                  r16.w = r3.y * r16.w + abs(r15.w);
                  r16.w = r16.w * r13.w;
                  r22.x = cmp(0 < r15.w);
                  r23.xyz = r16.www * r21.xyw + r17.xyz;
                  r15.w = saturate(r15.w);
                  r20.xyz = r20.xyz * r14.www + r0.yzw;
                  r14.w = dot(r20.xyz, r20.xyz);
                  r14.w = rsqrt(r14.w);
                  r20.xyz = r20.xyz * r14.www;
                  r14.w = dot(r20.xyz, r0.yzw);
                  r16.w = dot(r6.xyz, r20.xyz);
                  r20.x = abs(r16.w) * r2.w + -abs(r16.w);
                  r16.w = abs(r16.w) * r20.x + 1;
                  r20.x = r15.w * r3.w + r4.w;
                  r16.w = r16.w * r16.w;
                  r16.w = r16.w * r20.x;
                  r16.w = rcp(r16.w);
                  r15.w = r15.w * r16.z;
                  r15.w = r16.w * r15.w;
                  r13.w = r15.w * r13.w;
                  r20.xyz = r13.www * r21.xyw + r31.xyz;
                  r14.w = saturate(1 + -r14.w);
                  r15.w = r14.w * r14.w;
                  r15.w = r15.w * r15.w;
                  r14.w = r15.w * r14.w;
                  r13.w = r14.w * r13.w;
                  r21.xyw = r13.www * r21.xyw + r30.xyz;
