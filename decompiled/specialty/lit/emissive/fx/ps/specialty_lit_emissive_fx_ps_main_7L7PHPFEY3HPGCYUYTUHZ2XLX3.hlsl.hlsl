...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r3.zw = r5.yz * float2(1.9921875,1.9921875) + float2(-1,-1);
  r5.y = dot(r3.zw, r3.zw);
  r5.y = 1 + -r5.y;
  r5.y = max(0, r5.y);
  r5.y = sqrt(r5.y);
  r5.z = r5.w * r5.w;
  ...
  r9.y = max(0, r5.x);
  r5.xzw = r8.xyz * r3.www;
  r5.xzw = r7.xyz * r3.zzz + r5.xzw;
  r5.xyz = r6.xyz * r5.yyy + r5.xzw;
  ...
  if (r1.w != 0) {
    ...
    r6.xy = clampU ? r3.zw : r1.xy;
  }
  r1.xy = r3.xy * distortionAmount + r6.xy;
  ...
  while (true) {
    ...
    r11.y = cmp((int)r2.x == (int)r9.w);
    bitmask.z = ((~(-1 << r2.y)) << 0) & 0xffffffff;  r11.z = (((uint)0 << 0) & bitmask.z) | ((uint)r10.w & ~bitmask.z);
    r10.w = r11.y ? r11.z : r10.w;
    r11.y = cmp((int)r2.z == (int)r9.w);
  ...
  if (r2.z != 0) {
    ...
    while (true) {
      ...
      r10.w = cmp((int)r2.x == (int)r9.z);
      if (r2.y == 0) r13.w = 0; else if (r2.y+0 < 32) {       r13.w = (uint)r9.w << (32-(r2.y + 0)); r13.w = (uint)r13.w >> (32-r2.y);      } else r13.w = (uint)r9.w >> 0;
  ...
  if (r2.y != 0) {
    ...
    r14.xyz = r21.xyz * r2.xxx + r15.xyz;
    r12.w = 0;
    ...
    r2.x = r9.y * r2.x + r2.z;
    r11.yzw = r15.xyz * r2.xxx + r11.yzw;
  }
  r2.xy = r9.xy * float2(0.984375,0.984375) + float2(0.0078125,0.0078125);
  r2.xy = gEnvBRDFGeneric.SampleLevel(samplerLinear_s, r2.xy, 0).xy;
  r15.xyz = r11.zwy * r2.xxx;
  r2.xyz = r11.yzw * r2.yyy;
  r3.w = sqrt(r3.y);
  r3.w = r3.w * 0.5 + 0.5;
  r3.w = r3.w * r3.w;
  r4.w = 0.5 * r3.w;
  ...
  if (r8.z != 0) {
    ...
    if (r8.z != 0) {
      ...
      r8.w = -r9.x * 0.5 + 1;
      r8.w = -abs(r5.w) * r8.w + 1;
      r8.w = r8.w * r8.w;
      r8.w = -r8.w * 0.620000005 + 0.620000005;
      r8.w = r8.w + -abs(r5.w);
      r8.w = r3.y * r8.w + abs(r5.w);
      r8.w = r8.w * r6.w;
      r10.w = cmp(0 < r5.w);
      ...
      r16.w = r17.z;
      r14.w = r15.z;
      r14.xyzw = r10.wwww ? r16.xyzw : r14.xyzw;
      r17.zw = r11.yz;
      r15.zw = r2.xy;
      r16.xyzw = r10.wwww ? r17.xyzw : r15.xyzw;
      r2.z = r10.w ? r11.w : r2.z;
      r15.z = r14.w;
      r15.xy = r16.xy;
      r2.xy = r16.zw;
    }
            ...
            if (r25.w != 0) {
              ...
              if (r25.w != 0) {
                ...
                if (r25.w != 0) {
                  ...
                  r13.w = r3.y * r13.w + abs(r21.w);
                  r13.w = r13.w * r15.w;
                  r33.x = r32.x;
                  r14.w = cmp(0 < r21.w);
                  r20.xyz = r13.www * r33.xyz + r17.xyz;
                  r13.w = saturate(dot(r5.xyz, r40.xyz));
            ...
            r40.w = samp0[]..swiz;
              ...
              if (r14.w != 0) {
                ...
                if (r14.w != 0) {
                  ...
                  r15.w = dot(r5.xyz, r20.xyz);
                  r20.x = abs(r15.w) * r2.w + -abs(r15.w);
  ...
  if (r0.w == 0) {
    ...
    r0.w = (int)r0.w + 1;
    // Needs manual fix for instruction:
    imm_atomic_iadd r3.x, u6, r2.xyxx, r0.w
    ...
    if (r0.w != 0) {
      ...
      r3.x = (uint)v0.z << 2;
      r0.w = (int)r0.w & 2046;
      bitmask.w = ((~(-1 << 11)) << 0) & 0xffffffff;  r0.w = (((uint)r0.w << 0) & bitmask.w) | ((uint)r3.x & ~bitmask.w);
