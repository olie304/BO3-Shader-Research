...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  while (true) {
    ...
    if (r8.w != 0) break;
    r10.z = (uint)r7.w >> 5;
    r16.xyz = (int3)r10.xyz + (int3)r12.xyz;
