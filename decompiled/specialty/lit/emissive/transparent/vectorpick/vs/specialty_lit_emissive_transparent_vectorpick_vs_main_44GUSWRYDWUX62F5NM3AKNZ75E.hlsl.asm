...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:42:27 2021
//
//
// Buffer Definitions: 
//
...
//   float hdrScale;                    // Offset:  188 Size:     4 [unused]
//   float emissiveFalloffPower;        // Offset:  192 Size:     4 [unused]
//   float3 emissiveTint1;              // Offset:  196 Size:    12 [unused]
//   bool relativeHDR;                  // Offset:  208 Size:     4 [unused]
//   bool invertFalloff;                // Offset:  212 Size:     4 [unused]
//   float layerDepth;                  // Offset:  216 Size:     4 [unused]
//   float uvMotionToggle1;             // Offset:  220 Size:     4 [unused]
//      = 0x00000000 
//   float scriptVectorOffset;          // Offset:  224 Size:     4
//   float2 scriptControl;              // Offset:  228 Size:     8 [unused]
//   float3 tint1;                      // Offset:  240 Size:    12 [unused]
//   float3 tint2;                      // Offset:  256 Size:    12 [unused]
//   float3 tint3;                      // Offset:  272 Size:    12 [unused]
//
// }
//
...
lt r3.xyzw, l(4.000000, 3.000000, 2.000000, 1.000000), cb0[14].xxxx
lt r4.x, l(0.000000), cb0[14].x
movc r0.xy, r4.xxxx, r0.zwzz, r0.xyxx
movc r0.xy, r3.wwww, r1.xyxx, r0.xyxx
movc r0.xy, r3.zzzz, r1.zwzz, r0.xyxx
movc r0.xy, r3.yyyy, r2.xzxx, r0.xyxx
movc o7.xy, r3.xxxx, r2.ywyy, r0.xyxx
mov o1.x, v1.w
mov o1.yz, v2.xxyx
mov o6.xyz, r8.xyzx
mov o2.x, v7.x
