// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:42:26 2021
...
cbuffer _Globals : register(b0)
{
  ...
  float scriptVectorOffset : packoffset(c14);
  float2 scriptControl : packoffset(c14.y);
...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  r7.xyz = v8.xxx ? v3.xyz : -v3.xyz;
  r1.z = dot(r7.xyz, r7.xyz);
  r1.z = rsqrt(r1.z);
  r7.xyz = r7.xyz * r1.zzz + -r2.xyw;
...
r2.w = samp0[]..swiz;
            ...
            r26.w = samp0[]..swiz;
              ...
              r23.w = samp0[]..swiz;
                ...
                if (r22.y != 0) {
                  ...
                  r24.xyz = r25.xyz * r3.xxx;
                  r22.xyz = r22.xyz * r3.xxx;
                  r23.xyz = r23.xyz * r3.xxx;
                  r17.w = -17 * r9.w;
                  r17.w = exp2(r17.w);
                  r16.w = r17.w + r16.w;
                  r16.w = log2(r16.w);
            ...
            r29.w = samp0[]..swiz;
              ...
              r26.w = samp0[]..swiz;
                ...
                if (r25.y != 0) {
                  ...
                  r27.xyz = r28.xyz * r3.xxx;
                  r25.xyz = r25.xyz * r3.xxx;
                  r26.xyz = r26.xyz * r3.xxx;
                  r17.w = -17 * r14.z;
                  r17.w = exp2(r17.w);
                  r16.w = r17.w + r16.w;
                  r16.w = log2(r16.w);
  ...
  r6.xyz = r6.xyz * r1.www + r17.xyz;
  r1.x = saturate(v7.x);
  r1.x = hdrScale * r1.x;
  r9.xyz = cmp(v7.yyy == float3(3,2,1));
  ...
  r3.x = rsqrt(r3.x);
  r10.xyz = -v6.xyz * r3.xxx;
  r3.y = dot(r10.xyz, r3.yzw);
  r4.x = dot(r10.xyz, r4.xyz);
  r4.y = dot(r10.xyz, r5.xyz);
  r3.z = cmp(0 < r3.y);
  r4.xy = -r4.xy / r3.yy;
  r3.zw = r3.zz ? r4.xy : 0;
  r4.x = 9.99999975e-06 + relativeHDR;
  r3.zw = r3.zw * r4.xx + w1.xy;
  r4.xyzw = emissiveMap.Sample(colorSampler_s, r3.zw).xyzw;
  ...
  r1.x = cmp(isDepthHack != 0);
  r3.yz = (uint2)r7.yx;
  r1.w = dot(r3.zy, float2(0.0671105608,0.00583714992));
  r1.w = frac(r1.w);
  r1.zw = float2(0.0078125,52.9829178) * r1.zw;
  r1.w = frac(r1.w);
  ...
  r8.x = saturate(dot(r2.xyz, r10.xyz));
  r1.w = dot(-r10.xyz, r2.xyz);
  r1.w = r1.w + r1.w;
  r13.xyz = r2.xyz * -r1.www + -r10.xyz;
  r1.w = 17 * r8.y;
  r1.w = exp2(r1.w);
  r1.w = 2 + r1.w;
  r1.w = 2 / r1.w;
  ...
  r5.z = 100 * r5.z;
  r7.zw = -r3.zz * float2(10,5) + float2(6.85740995,7.08500004);
  r5.w = exp2(r7.z);
  r5.w = r8.x * r5.w;
  r5.w = 9.1368103 * r5.w;
  r6.w = r3.w * r3.z;
  ...
  r41.z = samp0[]..swiz;
  r41.w = samp0[]..swiz;
    r12.y = dot(r36.xyz, r11.yzw);
    r12.y = saturate(r12.y + r36.w);
    ...
    r16.x = r12.y * r12.z;
    r12.y = (int)r8.z & 1;
    r12.yz = r12.yy ? r16.xy : r16.zx;
    r15.xy = r29.zw;
    r15.z = r30.z;
    r12.w = dot(r13.xyz, r15.xyz);
    r14.z = dot(r11.yzw, r15.xyz);
    r14.z = r14.z + -r30.w;
    r14.w = cmp(r14.z >= 0);
    ...
    r30.z = r31.z;
    r14.z = dot(r13.xyz, r30.xyz);
    r14.w = dot(r11.yzw, r30.xyz);
    r14.w = r14.w + -r31.w;
    r15.x = cmp(r14.w >= 0);
    ...
    r14.z = r14.w / r14.z;
    r12.w = min(abs(r14.z), r12.w);
    r31.z = r32.z;
    r14.z = dot(r13.xyz, r31.xyz);
    r14.w = dot(r11.yzw, r31.xyz);
    r14.w = r14.w + -r32.w;
    r15.x = cmp(r14.w >= 0);
    r14.w = max(abs(r14.w), r5.z);
    r14.w = r15.x ? r14.w : -r14.w;
    ...
    r12.w = min(abs(r14.z), r12.w);
    r32.z = r33.z;
    r14.z = dot(r13.xyz, r32.xyz);
    r14.w = dot(r11.yzw, r32.xyz);
    r14.w = r14.w + -r33.w;
    r15.x = cmp(r14.w >= 0);
    r14.w = max(abs(r14.w), r5.z);
    r14.w = r15.x ? r14.w : -r14.w;
    ...
    r12.w = min(abs(r14.z), r12.w);
    r33.z = r34.x;
    r14.z = dot(r13.xyz, r33.xyz);
    r14.w = dot(r11.yzw, r33.xyz);
    r14.w = r14.w + -r34.y;
    r15.x = cmp(r14.w >= 0);
    r14.w = max(abs(r14.w), r5.z);
    r14.w = r15.x ? r14.w : -r14.w;
    ...
    r12.w = min(abs(r14.z), r12.w);
    r35.zw = r34.zw;
    r14.z = dot(r13.zxy, r35.xzw);
    r14.w = dot(r11.wyz, r35.xzw);
    r14.w = r14.w + -r35.y;
    r15.x = cmp(r14.w >= 0);
    r14.w = max(abs(r14.w), r5.z);
    r14.w = r15.x ? r14.w : -r14.w;
    ...
    r15.xyz = r13.xyz * r12.www + r15.xyz;
    ...
    r31.xy = r24.xw;
    r31.z = r25.w;
    r30.y = dot(r15.xyz, r31.xyz);
    r25.x = r24.y;
    r30.z = dot(r15.xyz, r25.xyz);
    if (6 == 0) r14.z = 0; else if (6+25 < 32) {     r14.z = (uint)r29.y << (32-(6 + 25)); r14.z = (uint)r14.z >> (32-6);    } else r14.z = (uint)r29.y >> 25;
    if (9 == 0) r14.w = 0; else if (9+16 < 32) {     r14.w = (uint)r29.y << (32-(9 + 16)); r14.w = (uint)r14.w >> (32-9);    } else r14.w = (uint)r29.y >> 16;
    r30.w = (uint)r14.w;
    r15.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r30.xyzw, r12.w).xyz;
    r24.xyz = (int3)r15.xyz & int3(-2147483648,-2147483648,-2147483648);
    r24.xyz = cmp((int3)r24.xyz == int3(2139095040,2139095040,2139095040));
    r12.w = (int)r24.y | (int)r24.x;
    r12.w = (int)r24.z | (int)r12.w;
    r15.xyz = r12.www ? float3(1,1,0) : r15.xyz;
    r24.x = dot(r11.yzw, r23.xyz);
    r24.y = dot(r11.yzw, r31.xyz);
    r24.z = dot(r11.yzw, r25.xyz);
    r24.xyz = saturate(r24.xyz * r26.xyz + float3(0.5,0.5,0.5));
    r27.z = r28.x;
    r24.xyz = r24.xyz * r27.xyz + r28.yzw;
    r30.x = dot(r2.xyz, r23.xyz);
    r30.y = dot(r2.xyz, r31.xyz);
    r30.z = dot(r2.xyz, r25.xyz);
    r23.xyz = cmp(float3(0,0,0) < r30.xyz);
    r17.z = r23.x ? 0 : 0.5;
    r25.xyz = r24.xyz + r17.xyz;
    r25.xyz = gProbeXArray.SampleLevel(samplerLinearClamp_s, r25.xyz, 0).xyz;
    r18.z = r23.y ? 0 : 0.5;
    r23.xyw = r24.xyz + r18.xyz;
    ...
    while (true) {
      ...
      if (r16.w != 0) {
        ...
        if (r9.w != 0) {
          ...
          r16.w = cmp(0 < r16.x);
          if (r16.w != 0) {
            r31.z = r30.y * r8.w + r29.w;
            r16.x = r16.x * r29.x;
            r20.yzw = r26.xyz * r16.xxx;
            r30.xzw = r23.xyw * r20.zzz;
            r30.xzw = r25.xyz * r20.yyy + r30.xzw;
            r20.yzw = r24.xyz * r20.www + r30.xzw;
            r30.xzw = r20.yzw * r27.xyz;
            r16.w = dot(r30.xzw, float3(0.212599993,0.715200007,0.0722000003));
            r32.xyz = r20.yzw * r27.xyz + r28.xyz;
            r17.z = r16.w * r5.w;
            r20.yzw = r16.xxx * r15.xyz;
            r16.x = dot(r20.yzw, float3(0.212599993,0.715200007,0.0722000003));
            r16.x = r5.w * r16.w + r16.x;
            r16.x = r17.z / r16.x;
            r33.x = r28.w;
            r33.yz = r29.yz;
            r31.xyw = r20.zwy * r16.xxx + r33.yzx;
            r32.w = r31.w;
          } else {
            r32.xyzw = r28.xyzw;
            r31.xyz = r29.yzw;
  ...
  if (r1.z == 0) {
    ...
    r6.w = (int)r1.z & -32;
    r7.w = (int)r1.z + (int)-r6.w;
    r8.z = numRefProbes & -32;
    r8.w = (int)-r8.z + numRefProbes;
    r14.xy = float2(0,0);
    r15.w = 0;
    r16.yz = float2(0,1);
    r17.xy = float2(0,0);
    ...
    while (true) {
      ...
      r11.y = cmp((int)r6.w == (int)r9.w);
      bitmask.z = ((~(-1 << r7.w)) << 0) & 0xffffffff;  r11.z = (((uint)0 << 0) & bitmask.z) | ((uint)r10.w & ~bitmask.z);
      r10.w = r11.y ? r11.z : r10.w;
      r11.y = cmp((int)r8.z == (int)r9.w);
      if (r8.w == 0) r11.z = 0; else if (r8.w+0 < 32) {       r11.z = (uint)r10.w << (32-(r8.w + 0)); r11.z = (uint)r11.z >> (32-r8.w);      } else r11.z = (uint)r10.w >> 0;
      r10.w = r11.y ? r11.z : r10.w;
      ...
      while (true) {
        ...
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=80)(mixed,mixed,mixed,mixed) r27.xyzw, r12.y, l(0), t11.xyzw
        r27.x = samp0[]..swiz;
        r27.y = samp0[]..swiz;
        r27.z = samp0[]..swiz;
        r27.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=80)(mixed,mixed,mixed,mixed) r15.xy, r12.y, l(16), t11.xyxx
        r15.x = samp0[]..swiz;
        r15.y = samp0[]..swiz;
          r12.yzw = -v6.xyz + r27.xyz;
          r15.z = r27.w;
          r12.yzw = cmp(abs(r12.yzw) < r15.zxy);
          r12.y = r12.z ? r12.y : 0;
          r12.y = r12.w ? r12.y : 0;
          if (r12.y != 0) {
          ...
          r34.w = samp0[]..swiz;
            ...
            r40.x = samp0[]..swiz;
            r40.y = samp0[]..swiz;
              r26.z = r29.y * r12.z + r26.z;
              r11.w = r12.y * r28.z;
              r28.z = r35.z;
              r12.y = dot(r13.xyz, r28.xyz);
              r12.z = dot(r15.xyz, r28.xyz);
              r12.z = r12.z + -r35.w;
              r12.w = cmp(r12.z >= 0);
              r12.z = max(abs(r12.z), r5.z);
              ...
              r18.yzw = r13.xyz * r12.yyy + r18.yzw;
              r12.z = dot(r18.yzw, r18.yzw);
              r12.z = sqrt(r12.z);
              r12.y = r12.y / r12.z;
              r12.y = r12.y + r12.y;
              r12.y = sqrt(r12.y);
              ...
              if (9 == 0) r12.z = 0; else if (9+16 < 32) {               r12.z = (uint)r28.w << (32-(9 + 16)); r12.z = (uint)r12.z >> (32-9);              } else r12.z = (uint)r28.w >> 16;
              r35.w = (uint)r12.z;
              r12.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r35.xyzw, r12.y).xyz;
              r18.yzw = (int3)r12.yzw & int3(-2147483648,-2147483648,-2147483648);
              r18.yzw = cmp((int3)r18.yzw == int3(2139095040,2139095040,2139095040));
              r14.z = (int)r18.z | (int)r18.y;
              r14.z = (int)r18.w | (int)r14.z;
              r12.yzw = r14.zzz ? float3(1,1,0) : r12.yzw;
              ...
              r11.w = r5.w * r14.z + r11.w;
              r11.w = r14.w / r11.w;
              r15.x = r25.w;
              r15.yz = r26.xy;
              r26.xyw = r12.zwy * r11.www + r15.yzx;
              r25.w = r26.w;
            }
          }
        }
    ...
    if (r8.z != 0) {
      ...
      while (true) {
        ...
        if (r7.w == 0) r12.y = 0; else if (r7.w+0 < 32) {         r12.y = (uint)r9.w << (32-(r7.w + 0)); r12.y = (uint)r12.y >> (32-r7.w);        } else r12.y = (uint)r9.w >> 0;
          ...
          r28.y = samp0[]..swiz;
            ...
            r35.w = samp0[]..swiz;
              ...
              r36.w = samp0[]..swiz;
                ...
                r20.w = -r20.w * r22.w + 1;
                r20.w = r30.y * r20.w;
                r18.y = r30.z ? r20.w : r30.w;
                r30.xy = r29.ww ? r30.xy : r18.xy;
                r19.w = (int)r19.w + 1;
                r16.x = r27.w;
              }
              r15.y = saturate(r30.y + -r14.z);
              r16.x = r15.y * r15.z;
              r16.w = cmp(0 < r16.x);
              if (r16.w != 0) {
              // Known bad code for instruction (needs manual fix):
              ...
              r41.y = samp0[]..swiz;
                ...
                r36.x = dot(r2.xyz, r27.xyz);
                r36.y = dot(r2.xyz, r28.xyz);
                ...
                r12.yzw = r27.xyz * r28.xyz + r12.yzw;
                r15.z = r15.y * r5.w;
                r18.yzw = r18.yzw * r15.xxx;
                r15.x = dot(r18.yzw, float3(0.212599993,0.715200007,0.0722000003));
                r15.x = r5.w * r15.y + r15.x;
                r15.x = r15.z / r15.x;
                r26.xyz = r18.yzw * r15.xxx + r26.xyz;
              }
            }
          }
        }
    ...
    r22.xyz = r24.xyz * r1.zzz;
    r3.z = cmp(r24.w < 0.99000001);
    if (r3.z != 0) {
      r3.z = 1 + -r24.w;
      r5.z = sunConstants.globalProbeExposure * r3.z;
      ...
      r12.yzw = cmp(float3(0,0,0) < r2.xyz);
      ...
      r2.w = 0;
      r12.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r2.xyzw, 6).xyz;
      r11.yzw = r12.yzw * r11.yzw;
      r2.w = dot(r11.yzw, float3(0.212599993,0.715200007,0.0722000003));
      r21.xyz = r23.xyz * r1.zzz + r11.yzw;
      r13.w = 0;
      r11.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r13.xyzw, r3.w).xyz;
      r1.z = sunConstants.globalProbeExposure * r3.z + -r2.w;
      r1.z = r8.y * r1.z + r2.w;
      r22.xyz = r11.yzw * r1.zzz + r22.xyz;
    }
  } else {
    r22.x = r21.w;
  }
  ...
  r8.yzw = r22.xyz * r1.zzz;
  r15.xyz = r8.zwy * r3.zzz;
  r8.yzw = r8.yzw * r3.www;
  r1.y = sqrt(r3.y);
  r1.y = r1.y * 0.5 + 0.5;
  r1.y = r1.y * r1.y;
  r1.z = 0.5 * r1.y;
  ...
  if (r3.w == 0) {
    ...
    if (r5.w != 0) {
      ...
      while (true) {
        ...
        if (r7.w != 0) break;
        r7.w = (uint)r5.w;
        r12.yz = -sunConstants.splitPinTransform[r7.w].xy + r11.yz;
    ...
    if (r7.w != 0) {
      ...
      r16.xz = rcp(r12.yy);
      r16.y = -r16.z;
      r12.yzw = r11.yzy * r16.xyz + r12.zwz;
      ...
      r12.yzw = min(r12.yzw, r16.xyz);
      r16.xy = sunConstants.sstLightingConstants.coordScale * r12.wz;
      r16.xy = floor(r16.xy);
    ...
    r10.w = samp0[]..swiz;
      ...
      r18.z = samp0[]..swiz;
        ...
        r19.xy = (uint2)r12.wz >> (uint2)r18.yy;
      ...
      r18.w = samp0[]..swiz;
        ...
        if (r9.w == 0) {
          r9.w = (int)-r16.z + 6;
          r17.xy = (uint2)r12.wz >> (uint2)r9.ww;
        ...
        r17.w = samp0[]..swiz;
          ...
          r9.w = (int)-r17.y + 6;
          r18.xy = (uint2)r12.wz >> (uint2)r9.ww;
        ...
        r18.z = samp0[]..swiz;
          ...
          r10.w = (int)-r18.y + 6;
          r17.yz = (uint2)r12.wz >> (uint2)r10.ww;
        ...
        r16.z = samp0[]..swiz;
          bitmask.x = ((~(-1 << 2)) << 3) & 0xffffffff;  r17.x = (((uint)r12.y << 3) & bitmask.x) | ((uint)0 & ~bitmask.x);
          bitmask.z = ((~(-1 << 2)) << 1) & 0xffffffff;  r17.z = (((uint)r12.z << 1) & bitmask.z) | ((uint)0 & ~bitmask.z);
          bitmask.w = ((~(-1 << 1)) << 4) & 0xffffffff;  r17.w = (((uint)r12.w << 4) & bitmask.w) | ((uint)0 & ~bitmask.w);
          r12.y = (uint)r16.z >> (uint)r17.x;
          r12.y = (int)r12.y & 255;
          r12.y = (uint)r12.y;
          r12.y = r12.y * r13.w;
          r12.y = r12.y * 0.00392156886 + r10.w;
          r12.z = (int)r17.z + 1;
        ...
        r12.y = samp0[]..swiz;
          ...
          r12.y = (uint)r16.w << 2;
          r12.z = (uint)r10.w >> 16;
          r12.z = f16tof32(r12.z);
          r10.w = (int)r10.w & 0x0000ffff;
          r10.w = f16tof32(r10.w);
          r12.y = r11.y * r12.z + r12.y;
          r10.w = r11.z * r10.w + r12.y;
          r16.x = r9.w ? r10.w : r16.x;
        }
      }
      r9.w = -sunConstants.sstLightingConstants.constants.inchesPerTexel * 2 + r11.w;
      r9.w = cmp(r16.x < r9.w);
      r5.z = r9.w ? 0 : 1;
    }
    if (r7.w == 0) {
      if (enableDitheredShadow == 0) {
        ...
        r16.xy = r12.yz * float2(0.5,-0.5) + float2(0.5,0.5);
        r7.w = (int16)sunConstants.splitArrayOffset;
        r16.z = r7.w + r5.w;
        r7.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r3.w).x;
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          r17.z = (uint)r11.w;
          r11.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r17.xyz, r3.w).x;
  ...
  if (r3.w != 0) {
    ...
    if (r3.w != 0) {
        ...
        r17.y = samp0[]..swiz;
          ...
          if (enableDitheredShadow != 0) {
            ...
            while (true) {
              ...
              r18.xy = r19.xy * r6.ww + r16.xy;
              r12.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r18.xyz, r5.w).x;
              r9.w = r12.y * 0.125 + r9.w;
              r10.w = (int)r10.w + 1;
            }
          } else {
            r16.z = (uint)r7.w;
            r9.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r5.w).x;
          }
          r5.w = r9.w * r9.w;
          r5.w = r5.w * r9.w;
        } else {
      ...
      r5.w = r5.w * r5.z;
      r2.w = cmp(0 < r2.w);
      r16.xyz = r5.www * r11.yzw + r14.xyz;
      r12.yzw = -v6.xyz * r3.xxx + sunConstants.wldDir.xyz;
      r3.x = dot(r12.yzw, r12.yzw);
      r3.x = rsqrt(r3.x);
      r12.yzw = r12.yzw * r3.xxx;
      r3.x = dot(r12.yzw, r10.xyz);
      r5.w = dot(r2.xyz, r12.yzw);
      r6.w = abs(r5.w) * r1.w + -abs(r5.w);
      ...
      r3.z = r5.z * r3.z;
      r3.z = 0.25 * r3.z;
      r12.yzw = r3.zzz * r11.yzw + r8.yzw;
      r3.x = saturate(1 + -r3.x);
      r3.w = r3.x * r3.x;
      r3.w = r3.w * r3.w;
      r3.x = r3.x * r3.w;
      r3.x = r3.z * r3.x;
      r17.xyz = r3.xxx * r11.zwy + r15.xyz;
      r16.w = r17.z;
      r14.w = r15.z;
      r14.xyzw = r2.wwww ? r16.xyzw : r14.xyzw;
      r17.zw = r12.yz;
      r15.zw = r8.yz;
      r16.xyzw = r2.wwww ? r17.xyzw : r15.xyzw;
  ...
  r3.w = 0;
  while (true) {
    r5.z = cmp((uint)r3.w >= numLights);
    if (r5.z != 0) break;
    r17.z = (uint)r3.w >> 5;
    r18.xyz = (int3)r7.xyz + (int3)r17.xyz;
    r5.z = visibleLights.Load(r18.xyzw).x;
    r12.yzw = r11.yzw;
    r18.xyz = r29.xyz;
    r31.xyz = r30.xyz;
    r5.w = r3.z;
    ...
    while (true) {
      ...
      r8.x = 1 << (int)r7.w;
      r9.w = (int)r6.w & (int)r8.x;
      if (r9.w != 0) {
        r6.w = (int)r6.w ^ (int)r8.x;
      ...
      r33.y = samp0[]..swiz;
        ...
        r38.z = samp0[]..swiz;
        r38.w = samp0[]..swiz;
          if (3 == 0) r8.x = 0; else if (3+24 < 32) {           r8.x = (uint)r33.w << (32-(3 + 24)); r8.x = (uint)r8.x >> (32-3);          } else r8.x = (uint)r33.w >> 24;
          switch (r8.x) {
            case 4 :            r8.x = cmp(0 < r38.x);
            r39.xy = r37.zw;
            r39.z = r38.w;
            r40.xyz = -r39.xyz * float3(0.5,0.5,0.5) + r32.yzw;
            r41.xyz = -v6.xyz + r40.xyz;
            r9.w = dot(r39.xyz, r41.xyz);
            r10.w = saturate(-r9.w / r38.x);
            r42.xyz = r10.www * r39.xyz + r40.xyz;
            r42.xyz = r8.xxx ? r42.xyz : r32.yzw;
            r42.xyz = -v6.xyz + r42.xyz;
            r13.w = dot(r42.xyz, r42.xyz);
            r14.w = rsqrt(r13.w);
            r42.xyz = r42.xyz * r14.www;
            r14.w = dot(r2.xyz, r42.xyz);
            ...
            if (r17.z != 0) {
              ...
              r13.w = r17.w / r13.w;
              r13.w = min(1, r13.w);
              r17.zw = saturate(r17.zz * r34.xz + r34.yw);
              r42.xy = r17.zw * r17.zw;
              r17.zw = r17.zw * float2(-2,-2) + float2(3,3);
              r17.zw = r42.xy * r17.zw;
              r13.w = r17.z * r13.w;
              r13.w = r13.w * r17.w;
              r17.z = cmp(0 < r13.w);
              if (r17.z != 0) {
                if (3 == 0) r17.z = 0; else if (3+27 < 32) {                 r17.z = (uint)r33.w << (32-(3 + 27)); r17.z = (uint)r17.z >> (32-3);                } else r17.z = (uint)r33.w >> 27;
                r17.z = cmp((int)r17.z != 1);
                if (r17.z != 0) {
                  r17.z = abs(r14.w) * -0.200000003 + 0.400000006;
                  r42.xyz = r2.xyz * r17.zzz + v6.xyz;
                  r42.xyz = r42.xyz + -r36.xyz;
                  r17.z = max(abs(r42.y), abs(r42.z));
                  r17.z = max(abs(r42.x), r17.z);
                  r17.z = r37.x / r17.z;
                  r17.z = r17.z + r37.y;
                  r17.w = dot(r42.xyz, r42.xyz);
                  r17.w = rsqrt(r17.w);
                  ...
                  while (true) {
                    ...
                    if (r27.w != 0) break;
                    r44.y = dot(icb[r26.w+0].yx, r16.xy);
                    r44.z = dot(icb[r26.w+0].yx, r16.yz);
                    r44.yz = r44.yz * r35.yy;
                    r44.x = r44.y * r12.x;
                    r44.w = r44.y * r11.x;
                    r43.xyz = r42.xyz * r17.www + r44.xzw;
                    r27.w = gOmniShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r43.xyzw, r17.z).x;
                    r22.w = r27.w * 0.125 + r22.w;
                    r26.w = (int)r26.w + 1;
                  }
                } else {
                  r22.w = 1;
                ...
                if (r17.z != 0) {
                  r17.z = r33.x * r1.w;
                  r17.w = dot(r39.xyz, r13.xyz);
                  r26.w = dot(r13.xyz, r41.xyz);
                  r27.w = -r17.w * r17.w + r38.x;
                  r9.w = r17.w * r26.w + -r9.w;
                  r9.w = saturate(r9.w / r27.w);
                  r17.w = r27.w / r38.x;
                  r17.zw = float2(0.25,10) * r17.zw;
                  r17.w = min(1, r17.w);
                  r9.w = r9.w + -r10.w;
                  r9.w = r17.w * r9.w + r10.w;
                  r39.xyz = r9.www * r39.xyz + r40.xyz;
                  r39.xyz = r8.xxx ? r39.xyz : r32.yzw;
                  r39.xyz = -v6.xyz + r39.xyz;
                  r8.x = dot(r39.xyz, r39.xyz);
                  r8.x = rsqrt(r8.x);
                  r40.xyz = r39.xyz * r8.xxx;
                  ...
                  r42.w = samp0[]..swiz;
                    ...
                    r17.w = dot(r41.xyzw, r20.xyzw);
                    r26.w = dot(r42.xyzw, r20.xyzw);
                    r27.w = cmp(r26.w < r17.w);
                    if (r27.w == 0) {
                    // Known bad code for instruction (needs manual fix):
                    ...
                    r45.y = samp0[]..swiz;
                      ...
                      r20.x = r45.y * r26.w;
                      r17.w = r45.x * r26.w + r17.w;
                      r17.w = r17.w / r20.x;
                    } else {
                      r20.z = -1;
                    }
                    r20.x = (int)r27.w | (int)r20.z;
                    if (r20.x == 0) {
                    // Known bad code for instruction (needs manual fix):
                    ...
                    r9.w = samp0[]..swiz;
                      ...
                      if (r5.w != 0) {
                        ...
                        while (true) {
                          ...
                          if (r28.w != 0) break;
                          r42.x = dot(icb[r27.w+0].yx, r16.xw);
                          r42.y = dot(icb[r27.w+0].xy, r5.xy);
                          r20.xy = r42.xy * r10.ww + r41.xy;
                          r20.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r20.xyz, r17.w).x;
                          r26.w = r20.x * 0.125 + r26.w;
                          r27.w = (int)r27.w + 1;
                        }
                      } else {
                        r41.z = (uint)r9.w;
                        r26.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r41.xyz, r17.w).x;
                      }
                      r9.w = r26.w * r26.w;
                      r9.w = r9.w * r26.w;
                    } else {
                    ...
                    r42.w = samp0[]..swiz;
                      r17.w = abs(r14.w) * -0.200000003 + 0.400000006;
                      r21.xyz = r2.xyz * r17.www + v6.xyz;
                      r17.w = dot(r41.xyzw, r21.xyzw);
                      r20.x = dot(r42.xyzw, r21.xyzw);
                      r20.y = cmp(r20.x < r17.w);
                      if (r20.y == 0) {
                      // Known bad code for instruction (needs manual fix):
                                            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r41.xyzw, r9.w, l(68), t12.xyzw
                      r41.x = samp0[]..swiz;
                      ...
                      r45.y = samp0[]..swiz;
                        ...
                        r21.xy = r21.xy * r43.xz + r43.yw;
                        r27.w = r45.y * r20.x;
                        r17.w = r45.x * r20.x + r17.w;
                        r17.w = r17.w / r27.w;
                      } else {
                        r20.z = -1;
                      }
                      ...
                      r9.w = samp0[]..swiz;
                        ...
                        if (r5.w != 0) {
                          ...
                          while (true) {
                            ...
                            if (r29.w != 0) break;
                            r41.x = dot(icb[r28.w+0].xy, r9.xy);
                            r41.y = dot(icb[r28.w+0].yx, r9.xz);
                            r20.xy = r41.xy * r10.ww + r21.xy;
                            r20.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r20.xyz, r17.w).x;
                            r27.w = r20.x * 0.125 + r27.w;
                            r28.w = (int)r28.w + 1;
                          }
                        } else {
                          r21.z = (uint)r9.w;
                          r27.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r21.xyz, r17.w).x;
                        }
                        r9.w = r27.w * r27.w;
                        r9.w = r9.w * r27.w;
                      } else {
                  ...
                  r9.w = r9.w + -r15.w;
                  r9.w = r3.y * r9.w + r15.w;
                  r9.w = r9.w * r13.w;
                  r33.x = r32.x;
                  r10.w = cmp(0 < r14.w);
                  r20.xyz = r9.www * r33.xyz + r12.yzw;
                  r9.w = saturate(dot(r2.xyz, r40.xyz));
                  r21.xyz = r39.xyz * r8.xxx + r10.xyz;
                  r8.x = dot(r21.xyz, r21.xyz);
                  r8.x = rsqrt(r8.x);
                  r21.xyz = r21.xyz * r8.xxx;
                  r8.x = dot(r21.xyz, r10.xyz);
                  r14.w = dot(r2.xyz, r21.xyz);
                  r15.w = abs(r14.w) * r1.w + -abs(r14.w);
                  r14.w = abs(r14.w) * r15.w + 1;
                  r15.w = r9.w * r1.y + r1.z;
                  r14.w = r14.w * r14.w;
                  r14.w = r14.w * r15.w;
                  r14.w = rcp(r14.w);
                  r9.w = r9.w * r17.z;
                  r9.w = r14.w * r9.w;
                  r9.w = r9.w * r13.w;
                  r21.xyz = r9.www * r33.xyz + r31.xyz;
                  r8.x = saturate(1 + -r8.x);
                  r13.w = r8.x * r8.x;
                  r13.w = r13.w * r13.w;
                  r8.x = r13.w * r8.x;
                  r8.x = r9.w * r8.x;
                  r39.xyz = r8.xxx * r33.xyz + r18.xyz;
                  r12.yzw = r10.www ? r20.xyz : r12.yzw;
                  r18.xyz = r10.www ? r39.xyz : r18.xyz;
                  r31.xyz = r10.www ? r21.xyz : r31.xyz;
                }
              }
            }
            break;
            ...
            r8.x = dot(r20.xyz, r20.xyz);
            r8.x = rsqrt(r8.x);
            r21.xyz = r20.xyz * r8.xxx;
            r9.w = dot(r2.xyz, r21.xyz);
            r10.w = saturate(r9.w);
            r13.w = cmp(0 < r10.w);
            if (r13.w != 0) {
            // Known bad code for instruction (needs manual fix):
            ...
            r40.w = samp0[]..swiz;
              ...
              r15.w = samp0[]..swiz;
                r45.xyz = -v6.xyz + r32.yzw;
                r17.z = r35.x * r35.x;
                r17.w = dot(r45.xyz, r45.xyz);
                r17.z = r17.z / r17.w;
                r17.z = min(1, r17.z);
                ...
                r45.xyz = r37.yzw;
                r45.w = r38.w;
                r34.y = dot(r45.xyzw, r19.xyzw);
                r22.xy = r34.xy / r13.ww;
                r13.w = cmp(r42.w < 0.00048828125);
                if (r13.w != 0) {
                  r43.y = r44.x;
                  r34.xy = saturate(abs(r22.xy) * r43.zw + r43.xy);
                  r34.zw = r34.xy * r34.xy;
                  r34.xy = r34.xy * float2(-2,-2) + float2(3,3);
                  r34.xy = r34.zw * r34.xy;
                  r13.w = r34.x * r34.y;
                  ...
                  r42.w = r43.y;
                  r34.xyzw = saturate(r42.xyzw * abs(r22.yyxx));
                  ...
                  r17.w = r43.z * r34.x;
                  r28.w = r43.w * r34.y + -1;
                  r17.w = r43.w * r34.y + -r17.w;
                  r17.w = saturate(r28.w / r17.w);
                  r28.w = r17.w * r17.w;
                  r17.w = r17.w * -2 + 3;
                  r13.w = r28.w * r17.w;
                }
                ...
                r34.y = samp0[]..swiz;
                r34.z = samp0[]..swiz;
                  r15.w = dot(r44.yzw, r22.xyz);
                  r17.z = dot(r34.xyz, r22.xyz);
                  r34.x = frac(r15.w);
                  r34.y = frac(r17.z);
                  r13.w = (int)r13.w + -1;
                  r34.z = (uint)r13.w;
                  r21.xyz = gCookieArray.SampleLevel(samplerLinear_s, r34.xyz, 0).xyz;
                } else {
                  r21.xyz = float3(1,1,1);
                }
              }
              r32.yz = r33.yz;
              r21.xyz = r32.xyz * r21.xyz;
              r13.w = cmp(0 < r14.w);
              if (r13.w != 0) {
                ...
                if (r13.w != 0) {
                  ...
                  r23.xyz = r2.xyz * r13.www + v6.xyz;
                  r39.xyz = r38.xyz;
                  r13.w = dot(r39.xyzw, r23.xyzw);
                  r15.w = dot(r41.xyzw, r23.xyzw);
                  r17.z = cmp(r15.w >= r13.w);
                  if (r17.z != 0) {
                  // Known bad code for instruction (needs manual fix):
                  ...
                  r40.y = samp0[]..swiz;
                    ...
                    r38.xyz = r37.yzw;
                    r22.y = dot(r38.xyzw, r23.xyzw);
                    r17.zw = r22.xy / r15.ww;
                    r17.zw = saturate(r17.zw * float2(0.5,-0.5) + float2(0.5,0.5));
                    r23.xy = r17.zw * r40.zw + r40.xy;
                    r7.w = r13.w / r15.w;
                    ...
                    if (r5.w != 0) {
                      ...
                      while (true) {
                        ...
                        if (r17.w != 0) break;
                        r22.x = dot(icb[r17.z+0].xy, r26.xy);
                        r22.y = dot(icb[r17.z+0].yx, r26.xz);
                        r32.xy = r22.xy * r35.yy + r23.xy;
                        r17.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r32.xyz, r7.w).x;
                        r15.w = r17.w * 0.125 + r15.w;
                        r17.z = (int)r17.z + 1;
                      }
                    } else {
                      r23.z = (uint)r13.w;
                      r15.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r23.xyz, r7.w).x;
                    }
                    r7.w = r15.w * r15.w;
                    r7.w = r7.w * r15.w;
                  } else {
                ...
                if (r13.w != 0) {
                  ...
                  r38.w = samp0[]..swiz;
                    ...
                    r24.y = samp0[]..swiz;
                      ...
                      r14.w = r24.y * r23.x;
                      r17.w = r24.x * r23.x + r17.w;
                      r14.w = r17.w / r14.w;
                      r14.w = max(6.10351563e-05, r14.w);
                      r17.w = r23.y ? 0.000000 : 0;
                      if (r5.w != 0) {
                        r23.z = (uint)r17.w;
                        r22.xy = float2(0,0);
                        while (true) {
                        ...
                        r32.z = (uint)r17.w;
                        r22.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r32.xyz, r14.w).x;
                      }
                      r14.w = r22.x * r22.x;
                      r14.w = r14.w * r22.x;
                    } else {
                    ...
                    r37.w = samp0[]..swiz;
                      ...
                      r24.y = samp0[]..swiz;
                        ...
                        r25.xy = r23.xy * r36.xz + r36.yw;
                        r14.w = r24.y * r22.y;
                        r17.w = r24.x * r22.y + r17.w;
                        r14.w = r17.w / r14.w;
                        r14.w = max(6.10351563e-05, r14.w);
                        r17.w = r23.z ? 0.000000 : 0;
                        if (r5.w != 0) {
                          r23.z = (uint)r17.w;
                          r22.y = 0;
                          r24.x = 0;
                          while (true) {
                            ...
                            if (r24.y != 0) break;
                            r32.x = dot(icb[r24.x+0].xy, r28.xy);
                            r32.y = dot(icb[r24.x+0].yx, r28.xz);
                            r23.xy = r32.xy * r17.zz + r25.xy;
                            r23.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r23.xyz, r14.w).x;
                          ...
                          r25.z = (uint)r17.w;
                          r22.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r25.xyz, r14.w).x;
                        }
                        r14.w = r22.y * r22.y;
                        r14.w = r14.w * r22.y;
                      } else {
                  ...
                  r14.w = r14.w + -r10.w;
                  r14.w = r3.y * r14.w + r10.w;
                  r14.w = r14.w * r7.w;
                  r9.w = cmp(0 < r9.w);
                  r23.xyz = r14.www * r21.xyz + r12.yzw;
                  r20.xyz = r20.xyz * r8.xxx + r10.xyz;
                  r8.x = dot(r20.xyz, r20.xyz);
                  r8.x = rsqrt(r8.x);
                  r20.xyz = r20.xyz * r8.xxx;
                  r8.x = dot(r20.xyz, r10.xyz);
                  r14.w = dot(r2.xyz, r20.xyz);
                  r17.z = abs(r14.w) * r1.w + -abs(r14.w);
                  r14.w = abs(r14.w) * r17.z + 1;
                  r10.w = r10.w * r1.y + r1.z;
                  r14.w = r14.w * r14.w;
                  r10.w = r14.w * r10.w;
                  r10.w = rcp(r10.w);
                  r10.w = r10.w * r13.w;
                  r7.w = r10.w * r7.w;
                  r7.w = 0.25 * r7.w;
                  r20.xyz = r7.www * r21.xyz + r31.xyz;
                  r8.x = saturate(1 + -r8.x);
                  r10.w = r8.x * r8.x;
                  r10.w = r10.w * r10.w;
                  r8.x = r10.w * r8.x;
                  r7.w = r8.x * r7.w;
                  r21.xyz = r7.www * r21.xyz + r18.xyz;
                  r12.yzw = r9.www ? r23.xyz : r12.yzw;
                  r18.xyz = r9.www ? r21.xyz : r18.xyz;
