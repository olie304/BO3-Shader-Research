...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  r1.z = saturate(w2.x);
  r1.z = hdrScale * r1.z;
  r10.xyz = cmp(w2.yww == float3(3,2,1));
  ...
  if (r10.z != 0) {
    ...
    while (true) {
      ...
      if (r10.y == 0) r13.w = 0; else if (r10.y+0 < 32) {       r13.w = (uint)r11.w << (32-(r10.y + 0)); r13.w = (uint)r13.w >> (32-r10.y);      } else r13.w = (uint)r11.w >> 0;
  ...
  if (r4.w != 0) {
    ...
    r2.w = r1.y * r2.w + r5.w;
    r10.yzw = r14.xyz * r2.www + r10.yzw;
  }
  r4.zw = r1.xy * float2(0.984375,0.984375) + float2(0.0078125,0.0078125);
  r4.zw = gEnvBRDFGeneric.SampleLevel(samplerLinear_s, r4.zw, 0).xy;
  r14.xyz = r10.zwy * r4.zzz;
  ...
  if (r5.w != 0) {
    ...
    if (r5.w != 0) {
      ...
      r8.zw = r16.xy;
      r14.zw = r10.yz;
      r8.xyzw = r4.zzzz ? r8.xyzw : r14.xyzw;
      r10.w = r4.z ? r16.z : r10.w;
      r14.z = r13.w;
      r14.xy = r8.xy;
      r10.yz = r8.zw;
    }
                    ...
                    r12.w = samp0[]..swiz;
                      ...
                      if (r6.w != 0) {
                        ...
                        while (true) {
                          ...
                          r43.y = dot(icb[r18.z+0].xy, r4.xy);
                      ...
                      r12.w = samp0[]..swiz;
                        ...
                        if (r6.w != 0) {
                          ...
                          while (true) {
                            ...
                            if (r26.w != 0) break;
                            r42.x = dot(icb[r24.w+0].xy, r5.xy);
                            r42.y = dot(icb[r24.w+0].yx, r5.xz);
            ...
            r40.w = samp0[]..swiz;
              ...
              if (r14.w != 0) {
                ...
                if (r14.w != 0) {
                  ...
                  r19.xyz = r19.xyz * r11.www + r11.xyz;
                  r11.w = dot(r19.xyz, r19.xyz);
                  r11.w = rsqrt(r11.w);
                  r19.xyz = r19.xyz * r11.www;
                  r11.w = dot(r19.xyz, r11.xyz);
