...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  r1.x = saturate(w2.x);
  r1.x = hdrScale * r1.x;
  r9.xyz = cmp(w2.yww == float3(3,2,1));
  ...
  sincos(r1.z, r5.x, r7.x);
  r1.z = dot(r4.xy, float2(0.0671105608,0.00583714992));
  r1.z = frac(r1.z);
  r1.z = 52.9829178 * r1.z;
  r1.z = frac(r1.z);
  r1.z = r1.z * 6.28318548 + gameTick.w;
  sincos(r1.z, r4.x, r9.x);
  r8.x = saturate(dot(r2.xyz, r12.xyz));
  ...
  r5.z = 100 * r5.z;
  r8.zw = -r4.zz * float2(10,5) + float2(6.85740995,7.08500004);
  r5.w = exp2(r8.z);
  r5.w = r8.x * r5.w;
  r5.w = 9.1368103 * r5.w;
  r6.w = r4.w * r4.z;
  r6.w = -r6.w * 2.0159049 + r8.w;
  r6.w = exp2(r6.w);
  r6.w = r8.x * r6.w;
  ...
  if (r6.w == 0) {
    ...
    if (r5.z != 0) {
      ...
      r21.xyz = r23.xyz * r4.zzz + r9.yzw;
      r13.w = 0;
      r9.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r13.xyzw, r4.w).xyz;
      r4.z = sunConstants.globalProbeExposure * r5.z + -r2.w;
      r2.w = r8.y * r4.z + r2.w;
      r22.xyz = r9.yzw * r2.www + r22.xyz;
    }
  } else {
    r22.x = r21.w;
  }
  ...
  r4.zw = r8.xy * float2(0.984375,0.984375) + float2(0.0078125,0.0078125);
  r4.zw = gEnvBRDFGeneric.SampleLevel(samplerLinear_s, r4.zw, 0).xy;
  r8.yzw = r22.xyz * r2.www;
  r15.xyz = r8.zwy * r4.zzz;
  r8.yzw = r8.yzw * r4.www;
  r1.y = sqrt(r4.y);
  r1.y = r1.y * 0.5 + 0.5;
  r1.y = r1.y * r1.y;
  r2.w = 0.5 * r1.y;
  ...
  if (r5.z == 0) {
    ...
    if (r6.w != 0) {
      ...
      while (true) {
        ...
        r7.w = sunConstants.splitPinTransform[r11.w].z * r12.w;
        r11.w = cmp(r7.w < 1);
        if (r11.w != 0) {
          break;
        }
  ...
  if (r5.z != 0) {
    ...
    if (r5.z != 0) {
      ...
      if (sunConstants.sunCookieIndex != 0) {
        ...
        r7.w = dot(sunConstants.sunCookieTransform[1].xyzw, r10.xyzw);
        r10.x = frac(r6.w);
        r10.y = frac(r7.w);
      ...
      r18.z = samp0[]..swiz;
      r18.w = samp0[]..swiz;
        r11.w = abs(r4.z) * -0.200000003 + 0.400000006;
      ...
      r4.w = r5.w * r4.w;
      r4.w = 0.25 * r4.w;
      r16.xyz = r4.www * r9.yzw + r8.yzw;
      r1.w = saturate(1 + -r1.w);
      r5.z = r1.w * r1.w;
      r5.z = r5.z * r5.z;
      r1.w = r5.z * r1.w;
      r1.w = r4.w * r1.w;
      r17.xyz = r1.www * r9.zwy + r15.xyz;
      r10.w = r17.z;
      r14.w = r15.z;
      r14.xyzw = r4.zzzz ? r10.xyzw : r14.xyzw;
      r17.zw = r16.xy;
      r15.zw = r8.yz;
      r10.xyzw = r4.zzzz ? r17.xyzw : r15.xyzw;
      r8.w = r4.z ? r16.z : r8.w;
      r15.z = r14.w;
      r15.xy = r10.xy;
      r8.yz = r10.zw;
    }
                      ...
                      r12.w = samp0[]..swiz;
                        ...
                        if (r6.w != 0) {
                          ...
                          while (true) {
                            ...
                            if (r26.w != 0) break;
                            r42.x = dot(icb[r21.w+0].xy, r7.xy);
                            r42.y = dot(icb[r21.w+0].yx, r7.xz);
