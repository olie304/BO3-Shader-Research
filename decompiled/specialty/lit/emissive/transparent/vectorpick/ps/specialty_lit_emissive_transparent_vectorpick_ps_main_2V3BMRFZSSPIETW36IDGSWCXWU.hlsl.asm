...
eq r8.xyz, v7.yyyy, l(3.000000, 2.000000, 1.000000, 0.000000)
movc r9.xyz, r8.zzzz, cb0[15].xyzx, cb0[12].yzwy
movc r8.yzw, r8.yyyy, cb0[16].xxyz, r9.xxyz
movc r8.xyz, r8.xxxx, cb0[17].xyzx, r8.yzwy
...
dp3_sat r1.x, r6.xyzx, r9.xyzx
dp3 r2.y, -r9.xyzx, r6.xyzx
add r2.y, r2.y, r2.y
mad r11.xyz, r6.xyzx, -r2.yyyy, -r9.xyzx
...
if_nz r5.w
  ...
  if_nz r5.w
    ...
    mul r1.w, r1.w, r5.w
    mul r1.w, r1.w, r5.z
    mad r17.xyz, r1.wwww, r10.zwyz, r14.xyzx
    mov r15.w, r17.z
    mov r13.w, r14.z
                    ...
                    if_z r19.z
                      ...
                      if_nz r6.w
                        ...
                        loop 
                          ige r26.w, r21.w, l(8)
                          breakc_nz r26.w
                          dp2 r42.x, icb[r21.w + 0].xyxx, r8.xyxx
                          dp2 r42.y, icb[r21.w + 0].yxyy, r8.xzxx
