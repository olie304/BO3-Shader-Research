...
mad r3.yz, r3.yyzy, r4.xxxx, v1.yyzy
...
utof r3.xy, r6.yxyy
dp2 r1.w, r3.yxyy, l(0.06711056, 0.00583715, 0.000000, 0.000000)
frc r1.w, r1.w
mul r1.zw, r1.zzzw, l(0.000000, 0.000000, 0.00781250, 52.982918)
frc r1.w, r1.w
mad r1.w, r1.w, l(6.28318548), cb1[70].w
sincos r5.x, r9.x, r1.w
dp2 r1.w, r3.xyxx, l(0.06711056, 0.00583715, 0.000000, 0.000000)
frc r1.w, r1.w
mul r1.w, r1.w, l(52.982918)
frc r1.w, r1.w
mad r1.w, r1.w, l(6.28318548), cb1[70].w
sincos r3.x, r11.x, r1.w
dp3_sat r7.x, r2.xyzx, r10.xyzx
dp3 r1.w, -r10.xyzx, r2.xyzx
add r1.w, r1.w, r1.w
mad r12.xyz, r2.xyzx, -r1.wwww, -r10.xyzx
...
loop 
  ...
  ieq r9.w, r1.z, r7.w
  bfi r10.w, r6.x, l(0), l(0), r8.w
  movc r8.w, r9.w, r10.w, r8.w
  ieq r9.w, r6.y, r7.w
  ubfe r10.w, r7.z, l(0), r8.w
  movc r8.w, r9.w, r10.w, r8.w
...
lt r3.z, r22.w, l(0.990000)
if_nz r3.z
  add r3.z, -r22.w, l(1.000000)
  mul r5.w, r3.z, cb2[19].x
...
if_nz r5.z
  ...
  if_nz r5.z
    ...
    mad r8.w, -r3.z, r8.w, l(1.000000)
    mul r8.w, r8.w, r8.w
    mad r8.w, -r8.w, l(0.620000), l(0.620000)
    add r8.w, -r3.z, r8.w
    mad r8.w, r3.y, r8.w, r3.z
    mul r8.w, r5.w, r8.w
    ...
    mad r16.xyz, r3.zzzz, r11.yzwy, r7.yzwy
    add_sat r3.w, -r3.w, l(1.000000)
    mul r5.z, r3.w, r3.w
    mul r5.z, r5.z, r5.z
    mul r3.w, r3.w, r5.z
    mul r3.z, r3.w, r3.z
    mad r17.xyz, r3.zzzz, r11.zwyz, r14.xyzx
    mov r15.w, r17.z
    mov r6.w, r14.z
...
not r2.w, r1.y
mad r3.z, -r7.x, l(0.500000), l(1.000000)
mov r15.x, -r5.x
mov r16.xy, l(0,0,0,0)
mov r17.w, l(0)
mov r18.xyz, v6.xyzx
...
ret 
// Approximately 2605 instruction slots used
