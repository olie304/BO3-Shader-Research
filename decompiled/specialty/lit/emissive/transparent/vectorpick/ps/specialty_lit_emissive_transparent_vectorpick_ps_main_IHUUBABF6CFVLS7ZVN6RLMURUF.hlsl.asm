...
eq r9.xyz, v2.wwww, l(3.000000, 2.000000, 1.000000, 0.000000)
...
frc r1.z, r1.z
mad r1.z, r1.z, l(6.28318548), cb1[70].w
sincos r4.x, r9.x, r1.z
dp3_sat r8.x, r2.xyzx, r12.xyzx
dp3 r1.z, -r12.xyzx, r2.xyzx
add r1.z, r1.z, r1.z
mad r13.xyz, r2.xyzx, -r1.zzzz, -r12.xyzx
mul r1.z, r8.y, l(17.000000)
exp r1.z, r1.z
...
if_z r6.w
  ...
  if_nz r5.z
    ...
    mad r9.yzw, r9.yyzw, r16.zzzz, r15.xxyz
    mov r2.w, l(0)
    sample_l_indexable(texturecubearray)(float,float,float,float) r14.xyz, r2.xyzw, t8.xyzw, s2, l(6.000000)
    mul r9.yzw, r9.yyzw, r14.xxyz
    dp3 r2.w, r9.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
    mad r21.xyz, r23.xyzx, r4.zzzz, r9.yzwy
    mov r13.w, l(0)
    sample_l_indexable(texturecubearray)(float,float,float,float) r9.yzw, r13.xyzw, t8.wxyz, s2, r4.w
    mad r4.z, cb2[19].x, r5.z, -r2.w
    mad r2.w, r8.y, r4.z, r2.w
    mad r22.xyz, r9.yzwy, r2.wwww, r22.xyzx
  endif 
else 
  mov r22.x, r21.w
endif 
...
if_z r5.z
  ...
  if_nz r6.w
    ...
    mov r7.w, l(0)
    loop 
      ge r11.w, r6.w, l(3.000000)
      breakc_nz r11.w
      ftou r11.w, r6.w
      add r16.xy, r9.yzyy, -cb2[r11.w + 20].xyxx
      max r12.w, |r16.y|, |r16.x|
      mul r7.w, r12.w, cb2[r11.w + 20].z
      lt r11.w, r7.w, l(1.000000)
      if_nz r11.w
        break 
      endif 
...
if_nz r5.z
  ...
  if_nz r5.z
    ...
    if_nz r7.w
      ...
      if_z r10.z
        ...
        if_nz cb2[58].y
          ...
          utof r16.z, r10.x
          sample_c_lz_indexable(texture2darray)(float,float,float,float) r10.y, r16.xyzx, t9.xxxx, s13, r6.w
        endif 
    ...
    mad r10.xyz, r6.wwww, r9.yzwy, r14.xyzx
    mad r16.xyz, -v7.xyzx, r1.wwww, cb2[17].xyzx
    dp3 r1.w, r16.xyzx, r16.xyzx
    rsq r1.w, r1.w
    mul r16.xyz, r1.wwww, r16.xyzx
    dp3 r1.w, r16.xyzx, r12.xyzx
    ...
    mad r16.xyz, r4.wwww, r9.yzwy, r8.yzwy
    add_sat r1.w, -r1.w, l(1.000000)
    mul r5.z, r1.w, r1.w
    mul r5.z, r5.z, r5.z
    mul r1.w, r1.w, r5.z
    mul r1.w, r1.w, r4.w
    mad r17.xyz, r1.wwww, r9.zwyz, r15.xyzx
    mov r10.w, r17.z
    mov r14.w, r15.z
    movc r14.xyzw, r4.zzzz, r10.xyzw, r14.xyzw
    mov r17.zw, r16.xxxy
    mov r15.zw, r8.yyyz
    movc r10.xyzw, r4.zzzz, r17.xyzw, r15.xyzw
          ...
          if_nz r14.w
            ...
            if_nz r14.w
              ...
              if_nz r14.w
                ...
                mad r20.xyz, r20.xyzx, r11.wwww, r12.xyzx
                dp3 r11.w, r20.xyzx, r20.xyzx
                rsq r11.w, r11.w
...
ret 
// Approximately 2584 instruction slots used
