...
dp3_sat r8.x, r6.xyzx, r12.xyzx
dp3 r1.z, -r12.xyzx, r6.xyzx
add r1.z, r1.z, r1.z
mad r13.xyz, r6.xyzx, -r1.zzzz, -r12.xyzx
...
if_z r5.w
  ...
  if_nz r4.w
    ...
    mad r4.y, r8.y, r4.y, r5.z
    mad r22.xyz, r9.yzwy, r4.yyyy, r22.xyzx
  endif 
else 
  mov r22.x, r21.w
endif 
...
mul r8.yzw, r4.yyyy, r22.xxyz
mul r15.xyz, r4.zzzz, r8.zwyz
mul r4.yzw, r4.wwww, r8.yyzw
sqrt r1.y, r2.w
mad r1.y, r1.y, l(0.500000), l(0.500000)
mul r1.y, r1.y, r1.y
mul r5.z, r1.y, l(0.500000)
mad r1.y, -r1.y, l(0.500000), l(1.000000)
mad r5.w, r8.x, r1.y, r5.z
mul r1.y, r1.y, r5.w
mul r5.z, r5.w, r5.z
...
if_nz r7.w
  ...
  if_nz r7.w
    ...
    if_nz r8.w
      ...
      mad r19.xyz, r6.xyzx, r11.wwww, v7.xyzx
    ...
    mad r8.w, |r8.z|, r1.z, -|r8.z|
    mad r8.z, |r8.z|, r8.w, l(1.000000)
    mad r6.w, r6.w, r1.y, r5.z
    mul r8.z, r8.z, r8.z
    mul r6.w, r6.w, r8.z
    rcp r6.w, r6.w
    mul r6.w, r7.w, r6.w
    ...
    mul r1.w, r1.w, r7.w
    mul r1.w, r1.w, r6.w
    mad r16.xyz, r1.wwww, r9.zwyz, r15.xyzx
    mov r10.w, r16.z
    mov r14.w, r15.z
    movc r14.xyzw, r5.wwww, r10.xyzw, r14.xyzw
    mov r16.zw, r8.yyyz
    mov r15.zw, r4.yyyz
    movc r10.xyzw, r5.wwww, r16.xyzw, r15.xyzw
    movc r4.w, r5.w, r8.w, r4.w
    mov r15.z, r14.w
    mov r15.xy, r10.xyxx
    mov r4.yz, r10.zzwz
  endif 
          ...
          if_nz r26.w
            ...
            if_nz r26.w
              ...
              if_nz r26.w
                ...
                mad r24.w, |r18.x|, r1.z, -|r18.x|
                mad r18.x, |r18.x|, r24.w, l(1.000000)
                mad r24.w, r14.w, r1.y, r5.z
          ...
          if_nz r18.x
            ...
            if_nz r18.x
              ...
              if_nz r18.x
                ...
                mad r19.y, |r19.x|, r1.z, -|r19.x|
                mad r19.x, |r19.x|, r19.y, l(1.000000)
                mad r15.w, r15.w, r1.y, r5.z
...
ret 
// Approximately 2578 instruction slots used
