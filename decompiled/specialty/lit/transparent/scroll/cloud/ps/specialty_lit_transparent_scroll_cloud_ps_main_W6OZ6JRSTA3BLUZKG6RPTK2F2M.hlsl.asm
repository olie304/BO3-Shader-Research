...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:42:39 2021
//
//
// Buffer Definitions: 
//
...
mov_sat r2.x, r2.x
dp3 r2.z, -r1.yzwy, v3.xyzx
add r2.z, r2.z, r2.z
mad r8.xyz, v3.xyzx, -r2.zzzz, -r1.yzwy
  ...
  loop 
    ...
    if_nz r10.w
      ...
      if_nz r10.z
        ...
        dp3 r14.z, r23.xyzx, r11.xyzx
        add_sat r14.z, r23.w, r14.z
        dp3 r14.w, r24.xyzx, r11.xyzx
        add_sat r14.w, r24.w, r14.w
        mul r14.z, r14.w, r14.z
        dp3 r14.w, r25.xyzx, r11.xyzx
        ...
        if_nz r12.x
          ...
          mad r20.z, r23.y, r10.w, r20.z
          mul r9.w, r22.z, r10.z
          mov r22.z, r29.z
          dp3 r10.z, r8.xyzx, r22.xyzx
          ...
          mov r29.z, r30.z
          dp3 r10.w, r8.xyzx, r29.xyzx
          dp3 r12.x, r11.xyzx, r29.xyzx
          ...
          mov r30.z, r31.z
          dp3 r10.w, r8.xyzx, r30.xyzx
          dp3 r12.x, r11.xyzx, r30.xyzx
          ...
          min r10.z, |r10.w|, r10.z
          mov r34.zw, r33.zzzw
          dp3 r10.w, r8.zxyz, r34.xzwx
          dp3 r12.x, r11.zxyz, r34.xzwx
          ...
          mov r21.y, r24.z
          mov r21.z, r25.x
          dp3 r29.x, r14.yzwy, r21.xyzx
          mov r22.xy, r24.xwxx
          mov r22.z, r25.w
          dp3 r29.y, r14.yzwy, r22.xyzx
          mov r25.x, r24.y
          dp3 r29.z, r14.yzwy, r25.xyzx
          ubfe r10.w, l(9), l(16), r22.w
          utof r29.w, r10.w
          sample_l_indexable(texturecubearray)(float,float,float,float) r14.yzw, r29.xyzw, t8.wxyz, s2, r10.z
          dp3 r24.x, r11.xyzx, r21.xyzx
          dp3 r24.y, r11.xyzx, r22.xyzx
          dp3 r24.z, r11.xyzx, r25.xyzx
          mad_sat r11.xyz, r24.xyzx, r26.xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
          mov r27.z, r28.x
          mad r11.xyz, r11.xyzx, r27.xyzx, r28.yzwy
          dp3 r29.x, v3.xyzx, r21.xyzx
          dp3 r29.y, v3.xyzx, r22.xyzx
          dp3 r29.z, v3.xyzx, r25.xyzx
          ...
          mad r11.xyz, r11.xyzx, r23.wwww, r21.xywx
          sample_l_indexable(texturecubearray)(float,float,float,float) r21.xyz, r29.xyzw, t8.xyzw, s2, l(6.000000)
          mul r22.xyz, r11.xyzx, r21.xyzx
          dp3 r10.z, r22.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
          mad r19.xyz, r11.xyzx, r21.xyzx, r19.xyzx
          ...
          mov r21.x, r19.w
          mov r21.yz, r20.xxyx
          mad r20.xyw, r11.yzyx, r9.wwww, r21.yzyx
          mov r19.w, r20.w
        endif 
      endif 
    endif 
...
if_nz r3.y
  ...
  loop 
    ...
    ieq r9.w, r2.w, r6.z
    ubfe r10.z, r3.x, l(0), r6.w
    movc r6.w, r9.w, r10.z, r6.w
    iadd r9.w, r6.z, cb2[0].x
      ...
      if_nz r14.z
        ...
        if_nz r13.w
          ...
          if_nz r14.y
            ...
            mad r20.w, r12.x, r14.w, r20.w
            mul r12.x, r22.z, r13.w
            mov r22.z, r30.z
            ...
            ubfe r13.w, l(9), l(16), r22.w
            utof r30.w, r13.w
            sample_l_indexable(texturecubearray)(float,float,float,float) r14.yzw, r30.xyzw, t8.wxyz, s2, r12.w
            ...
            dp3 r30.x, v3.xyzx, r21.xyzx
            dp3 r30.y, v3.xyzx, r22.xyzx
            dp3 r30.z, v3.xyzx, r26.xyzx
            lt r21.xyz, l(0.000000, 0.000000, 0.000000, 0.000000), r30.xyzx
            movc r13.z, r21.x, l(0), l(0.500000)
            add r22.xyz, r13.xyzx, r23.xyzx
            sample_l_indexable(texture3d)(float,float,float,float) r22.xyz, r22.xyzx, t17.xyzw, s4, l(0.000000)
            mul r24.xyz, r30.xyzx, r30.xyzx
            ...
            mad r11.xyz, r21.xyzx, r22.xyzx, r11.xyzx
            ...
            mad r20.xyz, r14.yzwy, r12.xxxx, r20.xyzx
          endif 
        endif 
      endif 
    endloop 
...
rcp r2.w, r2.w
mov_sat r18.w, r18.w
mul r10.xyz, r2.wwww, r17.xyzx
mul r3.xyw, r2.wwww, r18.xyxz
lt r4.w, r18.w, l(0.990000)
if_nz r4.w
  add r4.w, -r18.w, l(1.000000)
  mul r5.w, r4.w, cb2[19].x
  add r6.yzw, v6.xxyz, -cb2[35].xxyz
  mul r11.x, r6.y, cb2[35].w
  mul r11.yz, r6.zzwz, cb2[36].xxyx
  add_sat r6.yzw, r11.xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
  mul r11.xy, r6.yzyy, cb2[36].zwzz
  mul r11.z, r6.w, cb2[37].x
  add r6.yzw, r11.xxyz, cb2[37].yyzw
  lt r7.yzw, l(0.000000, 0.000000, 0.000000, 0.000000), v3.xxyz
  movc r11.xyz, r7.yzwy, l(0,0,0,0), l(0.500000,0.500000,0.500000,0)
  mov r11.w, l(0)
  add r7.yzw, r6.yyzw, r11.wwwx
  sample_l_indexable(texture3d)(float,float,float,float) r7.yzw, r7.yzwy, t17.wxyz, s4, l(0.000000)
  mul r12.xyz, v3.xyzx, v3.xyzx
  mul r12.xyz, r5.wwww, r12.xyzx
  add r13.xyz, r6.yzwy, r11.wwyw
  ...
  mad r7.yzw, r7.yyzw, r12.xxxx, r13.xxyz
  add r6.yzw, r6.yyzw, r11.wwwz
  sample_l_indexable(texture3d)(float,float,float,float) r6.yzw, r6.yzwy, t19.wxyz, s4, l(0.000000)
  mad r6.yzw, r6.yyzw, r12.zzzz, r7.yyzw
  mov r11.xyz, v3.xyzx
  mov r11.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r7.yzw, r11.xyzw, t8.wxyz, s2, l(6.000000)
  mul r6.yzw, r6.yyzw, r7.yyzw
  dp3 r5.w, r6.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
  mad r10.xyz, r17.xyzx, r2.wwww, r6.yzwy
  mov r8.w, l(0)
  ...
  mad r3.xyw, r6.yzyw, r2.wwww, r3.xyxw
endif 
  ...
  if_z r4.z
    ...
    if_nz r5.w
      ...
      loop 
        ...
        breakc_nz r7.z
        ftou r7.z, r5.w
        add r12.xy, r6.yzyy, -cb2[r7.z + 20].xyxx
    ...
    if_nz r7.z
      ...
      rcp r13.xz, r12.xxxx
      mov r13.y, -r13.z
      mad r12.xyz, r6.yzyy, r13.xyzx, r12.yzyy
      ...
      if_z r9.w
        ...
        movc r9.w, r16.y, r14.z, r9.w
        ushr r13.w, r9.w, l(13)
        movc r9.w, r16.x, r13.w, r9.w
        ...
        if_z r7.w
          ...
          iadd r7.w, -r14.y, l(6)
          ushr r13.yw, r12.zzzy, r7.wwww
          and r7.w, r14.w, l(0xc0000000)
          or r8.w, r14.w, l(0x40000000)
          bfi r9.w, l(1), l(1), r13.w, l(0)
          bfi r9.w, l(1), l(0), r13.y, r9.w
        ...
        if_z r7.w
          ...
          mad r12.x, r12.x, l(0.00392157), r8.w
    ...
    if_z r7.z
      if_z cb2[58].y
        ...
        itof r6.w, cb2[26].y
        add r12.z, r5.w, r6.w
        sample_c_lz_indexable(texture2darray)(float,float,float,float) r6.w, r12.xyzx, t13.xxxx, s13, r4.z
      ...
      if_nz cb2[58].y
        ...
        loop 
          ...
          breakc_nz r12.w
          ult r12.w, r7.y, r9.w
          movc r13.xy, r12.wwww, r6.yzyy, r7.zwzz
          movc r13.z, r12.w, cb2[r5.w + 20].w, cb2[r6.w + 20].w
          movc r12.w, r12.w, r5.w, r6.w
          dp2 r14.x, icb[r9.w + 0].yxyy, r12.xyxx
          dp2 r14.y, icb[r9.w + 0].yxyy, r12.yzyy
          mad r13.xy, r14.xyxx, r13.zzzz, r13.xyxx
          iadd r12.w, r12.w, cb2[26].y
          utof r13.z, r12.w
          sample_c_lz_indexable(texture2darray)(float,float,float,float) r12.w, r13.xyzx, t13.xxxx, s13, r4.z
...
if_nz r5.w
  ...
  if_nz r5.w
    ...
    if_nz cb2[23].x
      ...
      dp4 r6.y, cb2[24].xyzw, r12.xyzw
      dp4 r6.z, cb2[25].xyzw, r12.xyzw
      frc r12.xy, r6.yzyy
      iadd r6.y, l(-1), cb2[23].x
      utof r12.z, r6.y
      sample_l_indexable(texture2darray)(float,float,float,float) r6.yzw, r12.xyzx, t20.wxyz, s2, l(0.000000)
    ...
    if_z cb0[20].w
      ...
      if_nz r7.z
        ...
        mad r16.xyz, v3.xyzx, r7.wwww, v6.xyzx
        ...
        if_z r7.w
          ...
          if_nz cb2[58].y
            ...
            loop 
              ige r12.w, r9.w, l(8)
              breakc_nz r12.w
              dp2 r15.x, icb[r9.w + 0].yxyy, r12.xyxx
              dp2 r15.y, icb[r9.w + 0].yxyy, r12.yzyy
              mad r14.xy, r15.xyxx, r7.zzzz, r13.xyxx
              sample_c_lz_indexable(texture2darray)(float,float,float,float) r12.w, r14.xyzx, t9.xxxx, s13, r7.y
              mad r8.w, r12.w, l(0.125000), r8.w
              iadd r9.w, r9.w, l(1)
            endloop 
          else 
            utof r13.z, r7.w
            sample_c_lz_indexable(texture2darray)(float,float,float,float) r8.w, r13.xyzx, t9.xxxx, s13, r7.y
          endif 
          mul r7.y, r8.w, r8.w
          mul r7.y, r8.w, r7.y
        else 
    ...
    mad r12.xyz, r7.yyyy, r6.yzwy, r10.xyzx
    mov_sat r4.z, r4.z
    mad r13.xyz, -v6.xyzx, r1.xxxx, cb2[17].xyzx
    dp3 r1.x, r13.xyzx, r13.xyzx
    rsq r1.x, r1.x
    mul r13.xyz, r1.xxxx, r13.xyzx
    dp3 r1.x, r13.xyzx, r1.yzwy
    dp3 r7.y, v3.xyzx, r13.xyzx
    ...
    mul r4.z, r4.z, r7.y
    mul r4.z, r4.w, r4.z
    mad r13.xyz, r4.zzzz, r6.yzwy, r3.xywx
    add_sat r1.x, -r1.x, l(1.000000)
    mul r4.w, r1.x, r1.x
    mul r4.w, r4.w, r4.w
    mul r1.x, r1.x, r4.w
    mul r1.x, r1.x, r4.z
    mad r14.xyz, r1.xxxx, r6.zwyz, r11.xyzx
    mov r12.w, r14.z
    mov r10.w, r11.z
    movc r10.xyzw, r7.zzzz, r12.xyzw, r10.xyzw
    mov r14.zw, r13.xxxy
    mov r11.zw, r3.xxxy
    movc r12.xyzw, r7.zzzz, r14.xyzw, r11.xyzw
    movc r3.w, r7.z, r13.z, r3.w
    mov r11.z, r10.w
    mov r11.xy, r12.xyxx
    mov r3.xy, r12.zwzz
  endif 
...
loop 
  ...
  ld_indexable(texture2darray)(uint,uint,uint,uint) r5.w, r14.xyzw, t6.yzwx
  mov r7.yzw, r6.yyzw
  ...
  loop 
    ...
    if_nz r13.z
      ...
      and r11.w, r28.y, r28.x
      and r11.w, r28.z, r11.w
      if_nz r11.w
        ...
        ubfe r11.w, l(3), l(24), r29.w
        switch r11.w
          case l(4)
          lt r11.w, l(0.000000), r34.x
          mov r35.xy, r33.zwzz
          mov r35.z, r34.w
          mad r36.xyz, -r35.xyzx, l(0.500000, 0.500000, 0.500000, 0.000000), r28.yzwy
          add r37.xyz, r36.xyzx, -v6.xyzx
          dp3 r13.z, r35.xyzx, r37.xyzx
          div_sat r13.w, -r13.z, r34.x
          mad r38.xyz, r13.wwww, r35.xyzx, r36.xyzx
          movc r38.xyz, r11.wwww, r38.xyzx, r28.yzwy
          add r38.xyz, r38.xyzx, -v6.xyzx
          dp3 r18.w, r38.xyzx, r38.xyzx
          rsq r22.w, r18.w
          mul r38.xyz, r22.wwww, r38.xyzx
          dp3 r22.w, v3.xyzx, r38.xyzx
          ...
          if_nz r23.w
            ...
            if_nz r23.w
              ...
              if_nz r23.w
                ...
                mad r38.xyz, v3.xyzx, r23.wwww, v6.xyzx
                ...
                loop 
                  ige r27.w, r26.w, l(8)
                  breakc_nz r27.w
                  dp2 r40.y, icb[r26.w + 0].yxyy, r12.xyxx
                  dp2 r40.z, icb[r26.w + 0].yxyy, r12.yzyy
              ...
              if_nz r23.w
                ...
                mad r13.z, r24.w, r26.w, -r13.z
                div_sat r13.z, r13.z, r27.w
                div r24.w, r27.w, r34.x
                mul r24.w, r24.w, l(10.000000)
                min r24.w, r24.w, l(1.000000)
                add r13.z, -r13.w, r13.z
                mad r13.z, r24.w, r13.z, r13.w
                mad r35.xyz, r13.zzzz, r35.xyzx, r36.xyzx
                movc r35.xyz, r11.wwww, r35.xyzx, r28.yzwy
                add r35.xyz, r35.xyzx, -v6.xyzx
                dp3 r11.w, r35.xyzx, r35.xyzx
                rsq r11.w, r11.w
                mul r36.xyz, r11.wwww, r35.xyzx
                ubfe r13.z, l(4), l(16), r29.w
                ult r13.w, l(0), r13.z
                ...
                if_nz r13.w
                  ...
                  mad r16.xyz, v3.xyzx, r24.wwww, v6.xyzx
                  dp4 r24.w, r37.xyzw, r16.xyzw
                  dp4 r26.w, r38.xyzw, r16.xyzw
                  ...
                  if_z r27.w
                    ...
                    dp4 r37.x, r37.xyzw, r16.xyzw
                    dp4 r37.y, r38.xyzw, r16.xyzw
                    div r16.xy, r37.xyxx, r26.wwww
                    mad r16.xy, r16.xyxx, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
                    add r16.xy, r40.zwzz, r16.xyxx
                    mul r16.xy, r40.xyxx, r16.xyxx
                    div r37.xy, r13.wwww, r39.xzxx
                    add r37.zw, -r37.xxxy, l(0.000000, 0.000000, 1.000000, 1.000000)
                    ge r37.zw, r16.xxxy, r37.zzzw
                    ge r37.xy, r37.xyxx, r16.xyxx
                    or r37.xy, r37.xyxx, r37.zwzz
                    or r16.z, r37.y, r37.x
                    mov_sat r16.xy, r16.xyxx
                    mad r37.xy, r16.xyxx, r39.xzxx, r39.ywyy
                    mul r16.x, r26.w, r41.y
                    mad r16.y, r41.x, r26.w, r24.w
                  ...
                  if_z r16.y
                    ...
                    if_nz r8.w
                      ...
                      loop 
                        ige r24.w, r16.z, l(8)
                        breakc_nz r24.w
                        dp2 r39.x, icb[r16.z + 0].yxyy, r12.xwxx
                        dp2 r39.y, icb[r16.z + 0].xyxx, r4.xyxx
                        mad r38.xy, r39.xyxx, r13.wwww, r37.xyxx
                        sample_c_lz_indexable(texture2darray)(float,float,float,float) r24.w, r38.xyzx, t9.xxxx, s13, r16.x
                        mad r16.y, r24.w, l(0.125000), r16.y
                        iadd r16.z, r16.z, l(1)
                      endloop 
                    else 
                      utof r37.z, r13.z
                      sample_c_lz_indexable(texture2darray)(float,float,float,float) r16.y, r37.xyzx, t9.xxxx, s13, r16.x
                    endif 
                  ...
                  if_nz r13.w
                    ...
                    lt r16.z, r22.w, l(0.000000)
                    movc r16.x, r16.z, -r16.x, r16.x
                    mad r17.xyz, v3.xyzx, r16.xxxx, v6.xyzx
                    dp4 r16.x, r37.xyzw, r17.xyzw
                    dp4 r16.z, r38.xyzw, r17.xyzw
                    ...
                    if_z r24.w
                      ...
                      mul r17.x, r16.z, r41.y
                      mad r16.x, r41.x, r16.z, r16.x
                    ...
                    if_z r16.z
                      ...
                      if_nz r8.w
                        ...
                        loop 
                          ...
                          mad r17.xy, r38.xyxx, r13.wwww, r37.xyxx
                        ...
                        utof r37.z, r13.z
                        sample_c_lz_indexable(texture2darray)(float,float,float,float) r16.z, r37.xyzx, t9.xxxx, s13, r16.x
                      endif 
                ...
                mad r13.z, -|r22.w|, r2.x, l(1.000000)
                mul r13.z, r13.z, r13.z
                mad r13.z, -r13.z, l(0.620000), l(0.620000)
                add r13.z, -|r22.w|, r13.z
                mad r13.z, r3.z, r13.z, |r22.w|
                mul r13.z, r18.w, r13.z
                mov r29.x, r28.x
                lt r13.w, l(0.000000), r22.w
                mad r17.xyz, r13.zzzz, r29.xyzx, r7.yzwy
                dp3_sat r13.z, v3.xyzx, r36.xyzx
                mad r35.xyz, r35.xyzx, r11.wwww, r1.yzwy
                dp3 r11.w, r35.xyzx, r35.xyzx
                rsq r11.w, r11.w
                mul r35.xyz, r11.wwww, r35.xyzx
                dp3 r11.w, r35.xyzx, r1.yzwy
                dp3 r16.x, v3.xyzx, r35.xyzx
                mad r22.w, |r16.x|, r2.z, -|r16.x|
                mad r16.x, |r16.x|, r22.w, l(1.000000)
                mad r22.w, r13.z, r2.y, r2.w
                mul r16.x, r16.x, r16.x
                mul r16.x, r22.w, r16.x
                rcp r16.x, r16.x
                mul r13.z, r23.w, r13.z
                mul r13.z, r13.z, r16.x
                mul r13.z, r18.w, r13.z
                mad r35.xyz, r13.zzzz, r29.xyzx, r27.xyzx
                add_sat r11.w, -r11.w, l(1.000000)
                mul r16.x, r11.w, r11.w
                mul r16.x, r16.x, r16.x
                mul r11.w, r11.w, r16.x
                mul r11.w, r11.w, r13.z
                mad r36.xyz, r11.wwww, r29.xyzx, r14.xyzx
                movc r7.yzw, r13.wwww, r17.xxyz, r7.yyzw
                movc r14.xyz, r13.wwww, r36.xyzx, r14.xyzx
                movc r27.xyz, r13.wwww, r35.xyzx, r27.xyzx
              endif 
            endif 
          endif 
          break 
          ...
          rsq r11.w, r11.w
          mul r35.xyz, r11.wwww, r17.xyzx
          dp3 r13.z, v3.xyzx, r35.xyzx
          ...
          if_nz r13.w
            ...
            if_nz r16.x
              ...
              mov r32.w, r33.x
              dp4 r30.x, r32.xyzw, r15.xyzw
              mov r42.xyz, r33.yzwy
              mov r42.w, r34.w
              dp4 r30.y, r42.xyzw, r15.xyzw
              div r18.xy, r30.xyxx, r13.wwww
              lt r13.w, r39.w, l(0.00048828)
              if_nz r13.w
                mov r40.y, r41.x
            ...
            if_nz r13.w
              ubfe r13.w, l(3), l(27), r29.w
              ine r13.w, r13.w, l(1)
              if_nz r13.w
                mad r13.w, |r13.z|, l(-0.200000), l(0.400000)
                lt r22.w, r13.z, l(0.000000)
                movc r13.w, r22.w, -r13.w, r13.w
                mad r19.xyz, v3.xyzx, r13.wwww, v6.xyzx
                mov r35.xyz, r34.xyzx
                dp4 r13.w, r35.xyzw, r19.xyzw
                dp4 r22.w, r37.xyzw, r19.xyzw
                ge r23.w, r22.w, r13.w
                if_nz r23.w
              ...
              if_nz r13.w
                mul r13.w, r2.z, r29.x
                mul r13.w, r13.w, l(0.250000)
                ubfe r16.x, l(4), l(16), r29.w
                ult r19.x, l(0), r16.x
                ...
                if_nz r19.x
                  ...
                  mad r19.y, |r13.z|, l(-0.200000), l(0.400000)
                  lt r19.z, r13.z, l(0.000000)
                  movc r19.y, r19.z, -r19.y, r19.y
                  mad r20.xyz, v3.xyzx, r19.yyyy, v6.xyzx
                  ...
                  if_z r20.x
                    ...
                    mul r16.x, r19.z, r28.y
                    mad r19.y, r28.x, r19.z, r19.y
                    div r16.x, r19.y, r16.x
                    max r16.x, r16.x, l(0.00006104)
                    ...
                    if_nz r8.w
                      ...
                      loop 
                        ...
                        sample_c_lz_indexable(texture2darray)(float,float,float,float) r20.x, r20.xyzx, t9.xxxx, s13, r16.x
                        mad r19.z, r20.x, l(0.125000), r19.z
                        iadd r23.w, r23.w, l(1)
                      endloop 
                    else 
                      utof r29.z, r19.y
                      sample_c_lz_indexable(texture2darray)(float,float,float,float) r19.z, r29.xyzx, t9.xxxx, s13, r16.x
                    endif 
                    mul r16.x, r19.z, r19.z
                    mul r16.x, r19.z, r16.x
                  else 
                    mov r16.x, l(1.000000)
                  endif 
                  mul r10.w, r10.w, r16.x
                else 
                  ubfe r16.x, l(4), l(20), r29.w
                  ult r19.x, l(0), r16.x
                  ...
                  if_nz r19.x
                    ...
                    mad r19.y, |r13.z|, l(-0.200000), l(0.400000)
                    lt r20.x, r13.z, l(0.000000)
                    movc r19.y, r20.x, -r19.y, r19.y
                    mad r21.xyz, v3.xyzx, r19.yyyy, v6.xyzx
                    ...
                    if_z r21.x
                      ...
                      if_nz r8.w
                        ...
                        utof r28.z, r19.y
                        sample_c_lz_indexable(texture2darray)(float,float,float,float) r21.x, r28.xyzx, t9.xxxx, s13, r16.x
                      endif 
                      mul r16.x, r21.x, r21.x
                      mul r16.x, r21.x, r16.x
                    else 
                      mov r16.x, l(1.000000)
                    endif 
                    mul r10.w, r10.w, r16.x
                ...
                mad r16.x, -|r13.z|, r2.x, l(1.000000)
                mul r16.x, r16.x, r16.x
                mad r16.x, -r16.x, l(0.620000), l(0.620000)
                add r16.x, -|r13.z|, r16.x
                mad r16.x, r3.z, r16.x, |r13.z|
                mul r16.x, r10.w, r16.x
                lt r19.x, l(0.000000), r13.z
                mad r20.xyz, r16.xxxx, r18.xywx, r7.yzwy
                mov_sat r13.z, r13.z
                mad r17.xyz, r17.xyzx, r11.wwww, r1.yzwy
                dp3 r11.w, r17.xyzx, r17.xyzx
                rsq r11.w, r11.w
                mul r17.xyz, r11.wwww, r17.xyzx
                dp3 r11.w, r17.xyzx, r1.yzwy
                dp3 r16.x, v3.xyzx, r17.xyzx
                mad r17.x, |r16.x|, r2.z, -|r16.x|
                mad r16.x, |r16.x|, r17.x, l(1.000000)
                mad r17.x, r13.z, r2.y, r2.w
                mul r16.x, r16.x, r16.x
                mul r16.x, r17.x, r16.x
                rcp r16.x, r16.x
                ...
                mad r18.xyw, r10.wwww, r18.xyxw, r14.xyxz
                movc r7.yzw, r19.xxxx, r20.xxyz, r7.yyzw
                movc r14.xyz, r19.xxxx, r18.xywx, r14.xyzx
...
ret 
// Approximately 1945 instruction slots used
