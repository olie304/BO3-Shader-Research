...
add r2.z, r2.z, r2.z
mad r9.xyz, v3.xyzx, -r2.zzzz, -r1.yzwy
    ...
    if_nz r11.w
      ...
      if_nz r11.z
        ...
        if_nz r13.x
          ...
          dp3 r30.x, v3.xyzx, r22.xyzx
          dp3 r30.y, v3.xyzx, r23.xyzx
      ...
      if_nz r15.z
        ...
        if_nz r14.w
          ...
          if_nz r15.y
            ...
            dp3 r31.x, v3.xyzx, r22.xyzx
            dp3 r31.y, v3.xyzx, r23.xyzx
            dp3 r31.z, v3.xyzx, r27.xyzx
...
rcp r2.w, r2.w
mov_sat r19.w, r19.w
mul r11.xyz, r2.wwww, r18.xyzx
mul r4.xyw, r2.wwww, r19.xyxz
...
if_nz r5.w
  ...
  lt r8.yzw, l(0.000000, 0.000000, 0.000000, 0.000000), v3.xxyz
  movc r12.xyz, r8.yzwy, l(0,0,0,0), l(0.500000,0.500000,0.500000,0)
  mov r12.w, l(0)
  add r8.yzw, r7.yyzw, r12.wwwx
  sample_l_indexable(texture3d)(float,float,float,float) r8.yzw, r8.yzwy, t17.wxyz, s4, l(0.000000)
  mul r13.xyz, v3.xyzx, v3.xyzx
  mul r13.xyz, r6.wwww, r13.xyzx
  add r14.xyz, r7.yzwy, r12.wwyw
  ...
  mad r8.yzw, r8.yyzw, r13.xxxx, r14.xxyz
  add r7.yzw, r7.yyzw, r12.wwwz
  sample_l_indexable(texture3d)(float,float,float,float) r7.yzw, r7.yzwy, t19.wxyz, s4, l(0.000000)
  mad r7.yzw, r7.yyzw, r13.zzzz, r8.yyzw
  mov r12.xyz, v3.xyzx
  mov r12.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r8.yzw, r12.xyzw, t8.wxyz, s2, l(6.000000)
  mul r7.yzw, r7.yyzw, r8.yyzw
  dp3 r6.w, r7.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
  mad r11.xyz, r18.xyzx, r2.wwww, r7.yzwy
  mov r9.w, l(0)
  ...
  mad r4.xyw, r7.yzyw, r2.wwww, r4.xyxw
endif 
  ...
  if_z r5.z
    ...
    if_nz r6.w
      ...
      loop 
        ...
        breakc_nz r8.z
        ftou r8.z, r6.w
        add r13.xy, r7.yzyy, -cb2[r8.z + 20].xyxx
        max r8.w, |r13.y|, |r13.x|
    ...
    if_nz r8.z
      ...
      rcp r14.xz, r13.xxxx
      mov r14.y, -r14.z
      mad r13.xyz, r7.yzyy, r14.xyzx, r13.yzyy
      ...
      mul r8.w, r14.y, cb2[27].x
      mad r8.w, r8.w, cb2[32].x, r14.x
      ftou r8.w, r8.w
      ...
      if_z r10.w
        ...
        movc r9.w, r15.y, r14.z, r9.w
        ushr r10.w, r9.w, l(13)
        movc r9.w, r15.x, r10.w, r9.w
        ...
        movc r16.yz, r8.wwww, l(0,6,1,0), l(0,5,2,0)
        ...
        movc r10.w, r17.y, r15.z, r10.w
        ushr r14.w, r10.w, l(13)
        movc r10.w, r17.x, r14.w, r10.w
        ...
        movc r15.xyz, r9.wwww, r15.xyzx, r16.xzwx
        movc r14.xyz, r8.wwww, r14.xyzx, r15.xyzx
        and r8.w, r14.z, l(0xc0000000)
        if_z r8.w
          iadd r8.w, -r14.y, l(6)
          ushr r15.xy, r13.zyzz, r8.wwww
          or r8.w, r14.z, l(0x40000000)
          bfi r9.w, l(1), l(1), r15.y, l(0)
          bfi r9.w, l(1), l(0), r15.x, r9.w
          ...
          iadd r8.w, -r15.y, l(6)
          ushr r14.yw, r13.zzzy, r8.wwww
          and r8.w, r15.w, l(0xc0000000)
          or r9.w, r15.w, l(0x40000000)
          bfi r10.w, l(1), l(1), r14.w, l(0)
          bfi r10.w, l(1), l(0), r14.y, r10.w
          ...
          mov r16.y, r15.z
          movc r16.xyz, r8.wwww, r15.xywx, r16.xyzx
          iadd r9.w, -r16.y, l(6)
          ushr r14.yw, r13.zzzy, r9.wwww
          ...
          movc r14.yw, r9.wwww, r16.xxxz, r17.xxxy
          movc r14.xz, r8.wwww, r15.xxwx, r14.yywy
        endif 
        and r8.w, r14.z, l(0xc0000000)
        if_z r8.w
          ubfe r9.w, l(14), l(15), r14.z
          utof r9.w, r9.w
    ...
    if_z r8.z
      if_z cb2[58].y
        ...
        sample_l_indexable(texture2darray)(float,float,float,float) r8.z, r13.xyzx, t31.yzxw, s0, l(0.000000)
        add r7.w, r7.w, r8.z
      ...
      if_nz cb2[58].y
        ...
        loop 
          uge r13.w, r10.w, l(8)
          breakc_nz r13.w
          ult r13.w, r8.y, r10.w
          movc r14.xy, r13.wwww, r7.yzyy, r8.zwzz
          movc r14.z, r13.w, cb2[r6.w + 20].w, cb2[r7.w + 20].w
          movc r13.w, r13.w, r6.w, r7.w
          ...
          utof r14.z, r13.w
          sample_c_lz_indexable(texture2darray)(float,float,float,float) r13.w, r14.xyzx, t13.xxxx, s13, r5.z
...
if_nz r6.w
  ...
  if_nz r6.w
    ...
    if_nz cb2[23].x
      ...
      dp4 r7.y, cb2[24].xyzw, r13.xyzw
      dp4 r7.z, cb2[25].xyzw, r13.xyzw
      frc r13.xy, r7.yzyy
      iadd r7.y, l(-1), cb2[23].x
      utof r13.z, r7.y
      sample_l_indexable(texture2darray)(float,float,float,float) r7.yzw, r13.xyzx, t20.wxyz, s2, l(0.000000)
    ...
    if_z cb0[20].w
      ...
      if_nz r8.z
        ...
        mad r17.xyz, v3.xyzx, r8.wwww, v6.xyzx
        ...
        if_z r8.w
          ...
          if_nz cb2[58].y
            ...
            loop 
              ...
              sample_c_lz_indexable(texture2darray)(float,float,float,float) r13.w, r15.xyzx, t9.xxxx, s13, r8.y
              mad r9.w, r13.w, l(0.125000), r9.w
              iadd r10.w, r10.w, l(1)
            endloop 
          else 
            utof r14.z, r8.w
            sample_c_lz_indexable(texture2darray)(float,float,float,float) r9.w, r14.xyzx, t9.xxxx, s13, r8.y
          endif 
          mul r8.y, r9.w, r9.w
          mul r8.y, r9.w, r8.y
        else 
    ...
    mad r13.xyz, r8.yyyy, r7.yzwy, r11.xyzx
    mov_sat r5.z, r5.z
    mad r14.xyz, -v6.xyzx, r1.xxxx, cb2[17].xyzx
    dp3 r1.x, r14.xyzx, r14.xyzx
    rsq r1.x, r1.x
    mul r14.xyz, r1.xxxx, r14.xyzx
    dp3 r1.x, r14.xyzx, r1.yzwy
    dp3 r8.y, v3.xyzx, r14.xyzx
    ...
    mul r5.z, r5.z, r8.y
    mul r5.z, r5.w, r5.z
    mad r14.xyz, r5.zzzz, r7.yzwy, r4.xywx
    add_sat r1.x, -r1.x, l(1.000000)
    mul r5.w, r1.x, r1.x
    mul r5.w, r5.w, r5.w
    mul r1.x, r1.x, r5.w
    mul r1.x, r1.x, r5.z
    mad r15.xyz, r1.xxxx, r7.zwyz, r12.xyzx
    mov r13.w, r15.z
    mov r11.w, r12.z
    movc r11.xyzw, r8.zzzz, r13.xyzw, r11.xyzw
    mov r15.zw, r14.xxxy
    mov r12.zw, r4.xxxy
    movc r13.xyzw, r8.zzzz, r15.xyzw, r12.xyzw
    movc r4.w, r8.z, r14.z, r4.w
    mov r12.z, r11.w
    mov r12.xy, r13.xyxx
    mov r4.xy, r13.zwzz
  endif 
        ...
        switch r12.w
          ...
          if_nz r24.w
            ...
            if_nz r24.w
              ...
              if_nz r24.w
                ...
                mad r39.xyz, v3.xyzx, r24.wwww, v6.xyzx
              ...
              if_nz r24.w
                ...
                if_nz r14.w
                  ...
                  mad r17.xyz, v3.xyzx, r25.wwww, v6.xyzx
                  ...
                  if_z r17.y
                    ...
                    if_nz r9.w
                      ...
                      loop 
                        ...
                        dp2 r40.y, icb[r17.z + 0].xyxx, r5.xyxx
                  ...
                  if_nz r14.w
                    ...
                    lt r17.z, r23.w, l(0.000000)
                    movc r17.x, r17.z, -r17.x, r17.x
                    mad r18.xyz, v3.xyzx, r17.xxxx, v6.xyzx
                ...
                mad r14.z, -|r23.w|, r2.x, l(1.000000)
                mul r14.z, r14.z, r14.z
                mad r14.z, -r14.z, l(0.620000), l(0.620000)
                add r14.z, -|r23.w|, r14.z
                mad r14.z, r4.z, r14.z, |r23.w|
                mul r14.z, r19.w, r14.z
                mov r30.x, r29.x
                lt r14.w, l(0.000000), r23.w
                mad r18.xyz, r14.zzzz, r30.xyzx, r8.yzwy
                dp3_sat r14.z, v3.xyzx, r37.xyzx
                mad r36.xyz, r36.xyzx, r12.wwww, r1.yzwy
                dp3 r12.w, r36.xyzx, r36.xyzx
                rsq r12.w, r12.w
                mul r36.xyz, r12.wwww, r36.xyzx
                dp3 r12.w, r36.xyzx, r1.yzwy
                dp3 r17.x, v3.xyzx, r36.xyzx
                mad r23.w, |r17.x|, r2.z, -|r17.x|
                mad r17.x, |r17.x|, r23.w, l(1.000000)
                mad r23.w, r14.z, r2.y, r2.w
                mul r17.x, r17.x, r17.x
                mul r17.x, r23.w, r17.x
                rcp r17.x, r17.x
                mul r14.z, r24.w, r14.z
          ...
          if_nz r14.w
            ...
            if_nz r14.w
              ...
              ine r14.w, r14.w, l(1)
              if_nz r14.w
                mad r14.w, |r14.z|, l(-0.200000), l(0.400000)
                lt r23.w, r14.z, l(0.000000)
                movc r14.w, r23.w, -r14.w, r14.w
                mad r20.xyz, v3.xyzx, r14.wwww, v6.xyzx
              ...
              if_nz r14.w
                ...
                if_nz r20.x
                  ...
                  mad r20.y, |r14.z|, l(-0.200000), l(0.400000)
                  lt r20.z, r14.z, l(0.000000)
                  movc r20.y, r20.z, -r20.y, r20.y
                  mad r21.xyz, v3.xyzx, r20.yyyy, v6.xyzx
                  ...
                  if_nz r20.x
                    ...
                    mad r20.y, |r14.z|, l(-0.200000), l(0.400000)
                    lt r21.x, r14.z, l(0.000000)
                    movc r20.y, r21.x, -r20.y, r20.y
                    mad r22.xyz, v3.xyzx, r20.yyyy, v6.xyzx
                ...
                mad r17.x, -|r14.z|, r2.x, l(1.000000)
                mul r17.x, r17.x, r17.x
                mad r17.x, -r17.x, l(0.620000), l(0.620000)
                add r17.x, -|r14.z|, r17.x
                mad r17.x, r4.z, r17.x, |r14.z|
                mul r17.x, r11.w, r17.x
                lt r20.x, l(0.000000), r14.z
                mad r21.xyz, r17.xxxx, r19.xywx, r8.yzwy
                mov_sat r14.z, r14.z
                mad r18.xyz, r18.xyzx, r12.wwww, r1.yzwy
                dp3 r12.w, r18.xyzx, r18.xyzx
                rsq r12.w, r12.w
                mul r18.xyz, r12.wwww, r18.xyzx
                dp3 r12.w, r18.xyzx, r1.yzwy
                dp3 r17.x, v3.xyzx, r18.xyzx
                mad r18.x, |r17.x|, r2.z, -|r17.x|
                mad r17.x, |r17.x|, r18.x, l(1.000000)
                mad r18.x, r14.z, r2.y, r2.w
                mul r17.x, r17.x, r17.x
                mul r17.x, r18.x, r17.x
                rcp r17.x, r17.x
                ...
                add_sat r12.w, -r12.w, l(1.000000)
                mul r14.z, r12.w, r12.w
                mul r14.z, r14.z, r14.z
                mul r12.w, r12.w, r14.z
                mul r11.w, r11.w, r12.w
                mad r19.xyw, r11.wwww, r19.xyxw, r15.xyxz
                movc r8.yzw, r20.xxxx, r21.xxyz, r8.yyzw
                movc r15.xyz, r20.xxxx, r19.xywx, r15.xyzx
...
if_z r0.w
  ...
  and r2.zw, r4.xxxx, l(0, 0, 0x0000ffff, 0x0000ffff)
...
ret 
// Approximately 1988 instruction slots used
