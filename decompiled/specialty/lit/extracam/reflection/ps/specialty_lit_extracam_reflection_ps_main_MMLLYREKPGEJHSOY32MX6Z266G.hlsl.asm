...
mul o0.w, r1.w, v1.w
sample_indexable(texture2d)(float,float,float,float) r1.x, v2.xyxx, t22.xyzw, s3
...
mul r2.yz, cb0[13].yyyy, cb1[44].zzwz
...
mul r5.xy, cb0[14].zwzz, cb1[69].wwww
...
mov r7.y, r7.x
mov r7.z, r6.x
dp2 r8.x, r7.yzyy, r3.zwzz
mov r7.x, -r6.x
dp2 r8.y, r7.xyxx, r3.zwzz
mul r5.zw, cb0[13].zzzw, cb1[69].wwww
mad r5.zw, r8.xxxy, cb0[4].xxxy, r5.zzzw
add r5.zw, r5.zzzw, l(0.000000, 0.000000, 0.500000, 0.500000)
sample_indexable(texture2d)(float,float,float,float) r6.xyz, r5.zwzz, t29.xyzw, s5
...
mov r7.x, -r6.x
dp2 r8.y, r7.xyxx, r3.zwzz
mad r3.zw, r8.xxxy, cb0[4].xxxy, r5.xxxy
...
mul r4.w, r4.w, l(0.33333334)
min r4.w, r4.w, l(1.000000)
mad r4.xy, r3.zwzz, r0.xxxx, r4.xyxx
...
mul r2.yz, r2.yyzy, r3.zzwz
mad r2.yz, r2.yyzy, r0.xxxx, r3.xxyx
...
mul r0.x, r2.x, l(-17.000000)
exp r0.x, r0.x
add r0.x, r0.x, r2.w
log r0.x, r0.x
mul_sat r7.y, r0.x, l(-0.05882353)
...
rsq r0.x, r0.x
mul r3.xyz, r0.xxxx, r3.xyzx
ieq r0.x, cb0[12].w, l(4)
if_nz r0.x
  sample_indexable(texture2d)(float,float,float,float) r4.xyz, r2.yzyy, t46.xyzw, s7
else 
  ieq r0.x, cb0[12].w, l(3)
  if_nz r0.x
    sample_indexable(texture2d)(float,float,float,float) r4.xyz, r2.yzyy, t38.xyzw, s7
  else 
    ieq r0.x, cb0[12].w, l(2)
    if_nz r0.x
      sample_indexable(texture2d)(float,float,float,float) r4.xyz, r2.yzyy, t37.xyzw, s7
    else 
      sample_indexable(texture2d)(float,float,float,float) r4.xyz, r2.yzyy, t30.xyzw, s7
    endif 
  endif 
endif 
mul r2.xyz, r4.xyzx, cb1[26].wwww
ftou r4.xy, v0.xyxx
ge r0.x, v0.z, l(0.984375)
mul r2.w, v0.z, l(1.01587307)
mad r4.z, v0.z, l(64.000000), l(-63.000000)
movc r0.x, r0.x, r4.z, r2.w
...
dp3_sat r7.x, r3.xyzx, r5.xyzx
dp3 r4.w, -r5.xyzx, r3.xyzx
add r4.w, r4.w, r4.w
mad r6.yzw, r3.xxyz, -r4.wwww, -r5.xxyz
  ...
  loop 
    ...
    if_nz r11.w
      ...
      if_nz r10.w
        ...
        dp3 r15.w, r24.xyzx, r13.xyzx
        add_sat r15.w, r24.w, r15.w
        ...
        loop 
          ...
          dp3 r16.w, r24.xyzx, r13.xyzx
          add_sat r16.w, r24.w, r16.w
          mul r16.w, r16.w, r23.x
          dp3 r17.w, r25.xyzx, r13.xyzx
          ...
          ubfe r21.w, l(1), l(2), r15.w
          and r23.z, r18.w, l(2)
          max r23.w, r23.x, r23.y
          mad r16.w, -r16.w, r17.w, l(1.000000)
          mul r16.w, r16.w, r23.y
          movc r16.y, r23.z, r16.w, r23.w
          movc r23.xy, r21.wwww, r23.xyxx, r16.xyxx
          iadd r16.z, r16.z, l(1)
          mov r15.w, r18.w
        endloop 
        mov_sat r23.y, r23.y
        mul r10.w, r22.w, r23.y
        ...
        if_nz r11.w
          ...
          mad r20.w, r23.y, r22.w, r20.w
          mul r10.z, r12.z, r10.w
          mov r21.y, r24.z
          mov r21.z, r25.x
          dp3 r27.x, r13.xyzx, r21.xyzx
          mov r28.xy, r24.xwxx
          mov r28.z, r25.w
          dp3 r27.y, r13.xyzx, r28.xyzx
          mov r25.x, r24.y
          dp3 r27.z, r13.xyzx, r25.xyzx
          mad_sat r13.xyz, r27.xyzx, r16.yzwy, l(0.500000, 0.500000, 0.500000, 0.000000)
          mov r22.x, r26.w
          mad r13.xyz, r13.xyzx, r26.xyzx, r22.xyzx
          dp3 r21.x, r3.xyzx, r21.xyzx
          dp3 r21.y, r3.xyzx, r28.xyzx
          dp3 r21.z, r3.xyzx, r25.xyzx
          lt r16.yzw, l(0.000000, 0.000000, 0.000000, 0.000000), r21.xxyz
          movc r15.z, r16.y, l(0), l(0.500000)
          add r22.xyz, r13.xyzx, r15.xyzx
          sample_l_indexable(texture3d)(float,float,float,float) r22.xyz, r22.xyzx, t17.xyzw, s4, l(0.000000)
          mul r23.xzw, r21.xxyz, r21.xxyz
          mul r23.xzw, r10.zzzz, r23.xxzw
          movc r17.z, r16.z, l(0), l(0.500000)
          add r24.xyz, r13.xyzx, r17.xyzx
          ...
          movc r18.z, r16.w, l(0), l(0.500000)
          ...
          mad r13.xyz, r13.xyzx, r23.wwww, r22.xyzx
          ...
          mad r20.xyz, r13.xyzx, r16.yzwy, r20.xyzx
        endif 
      endif 
    endif 
  endloop 
      ...
      if_nz r11.w
        ...
        if_nz r10.w
          ...
          loop 
            ...
            mov r15.w, r18.w
          endloop 
          add_sat r10.w, -r9.w, r24.y
          mul r11.w, r23.w, r10.w
          ...
          if_nz r14.x
            ...
            dp3 r22.x, r3.xyzx, r22.xyzx
            dp3 r22.y, r3.xyzx, r29.xyzx
            dp3 r22.z, r3.xyzx, r26.xyzx
...
max r0.x, r19.w, l(1.000000)
rcp r0.x, r0.x
mov_sat r19.w, r19.w
mul r10.yzw, r0.xxxx, r19.xxyz
lt r0.x, r19.w, l(0.990000)
if_nz r0.x
  add r0.x, -r19.w, l(1.000000)
  mul r0.x, r0.x, cb2[19].x
  ...
  mov r3.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r13.xyz, r3.xyzw, t8.xyzw, s2, l(6.000000)
  mad r10.yzw, r12.xxyz, r13.xxyz, r10.yyzw
endif 
add r0.x, r1.x, r7.x
log r0.x, |r0.x|
mul r0.x, r0.x, r5.w
...
if_z r4.y
  ...
  if_nz r7.z
    mov r7.zw, l(0,0,0,0)
    loop 
      ge r8.z, r7.z, l(3.000000)
      breakc_nz r8.z
      ftou r8.z, r7.z
      add r14.xy, r10.yzyy, -cb2[r8.z + 20].xyxx
  ...
  if_nz r8.z
    ...
    if_z r11.w
      ...
      if_z r8.w
        ...
        movc r14.w, r8.w, r9.w, r14.w
      endif 
    endif 
    mad r8.w, -cb2[27].z, l(2.000000), r10.w
    lt r8.w, r14.w, r8.w
    movc r7.y, r8.w, l(0), l(1.000000)
  endif 
  if_z r8.z
    if_z cb2[58].y
      ftou r8.z, r7.z
      add r14.xy, r10.yzyy, -cb2[r8.z + 20].xyxx
      mul r8.zw, r14.xxxy, cb2[r8.z + 20].zzzz
      mad r14.xy, r8.zwzz, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
      itof r8.z, cb2[26].y
      add r14.z, r7.z, r8.z
      sample_c_lz_indexable(texture2darray)(float,float,float,float) r8.z, r14.xyzx, t13.xxxx, s13, r4.y
    ...
    if_nz cb2[58].y
      ...
      ftou r7.zw, r7.zzzw
      add r15.xy, r10.yzyy, -cb2[r8.z + 20].xyxx
      mul r15.xy, r15.xyxx, cb2[r8.z + 20].zzzz
      ...
      loop 
        ...
        movc r11.w, r10.w, cb2[r7.z + 20].w, cb2[r8.z + 20].w
        movc r10.w, r10.w, r7.z, r8.z
...
if_nz r4.y
  ...
  if_nz r4.y
    ...
    if_nz r7.w
      ...
      mad r18.xyz, r3.xyzx, r8.zzzz, v7.xyzx
      mov r18.w, l(1.000000)
      dp4 r14.x, r14.xyzw, r18.xyzw
      dp4 r14.y, r15.xyzw, r18.xyzw
      mad r8.zw, r14.xxxy, l(0.000000, 0.000000, 0.500000, -0.500000), l(0.000000, 0.000000, 0.500000, 0.500000)
      add r8.zw, r17.zzzw, r8.zzzw
      mul r8.zw, r17.xxxy, r8.zzzw
      div r14.xy, r7.wwww, r16.xzxx
      add r14.zw, -r14.xxxy, l(0.000000, 0.000000, 1.000000, 1.000000)
      ge r14.zw, r8.zzzw, r14.zzzw
      ge r14.xy, r14.xyxx, r8.zwzz
      ...
      if_z r9.w
        ...
        mad r14.xy, r8.zwzz, r16.xzxx, r16.ywyy
        add r7.z, r15.x, r7.z
        div r7.z, r7.z, r15.y
        ...
        if_nz cb2[58].y
          ...
          loop 
            ...
            sample_c_lz_indexable(texture2darray)(float,float,float,float) r11.w, r16.xyzx, t9.xxxx, s13, r7.z
            mad r8.w, r11.w, l(0.125000), r8.w
            iadd r9.w, r9.w, l(1)
          endloop 
        else 
          utof r14.z, r8.z
          sample_c_lz_indexable(texture2darray)(float,float,float,float) r8.w, r14.xyzx, t9.xxxx, s13, r7.z
        endif 
        mul r7.z, r8.w, r8.w
        mul r7.z, r8.w, r7.z
      else 
    ...
    mad r7.yzw, r4.xxxx, r10.yyzw, r2.xxyz
    add_sat r2.w, -r2.w, l(1.000000)
    mul r4.y, r2.w, r2.w
    mul r4.y, r4.y, r4.y
    mul r2.w, r2.w, r4.y
    mul r2.w, r2.w, r4.x
    mad r15.xyz, r2.wwww, r10.zwyz, r13.xyzx
    mov r14.w, r15.z
    mov r12.w, r13.z
    movc r12.xyzw, r3.wwww, r14.xyzw, r12.xyzw
    mov r15.zw, r7.yyyz
    mov r13.zw, r2.xxxy
    movc r14.xyzw, r3.wwww, r15.xyzw, r13.xyzw
    movc r2.z, r3.w, r7.w, r2.z
    mov r13.z, r12.w
    mov r13.xy, r14.xyxx
    mov r2.xy, r14.zwzz
  endif 
...
mov r25.y, r14.x
mov r25.z, r8.x
mov r10.yzw, r12.xxyz
mov r26.xyz, r13.zxyz
mov r27.xyz, r2.xyzx
mov r4.x, cb2[58].y
mov r4.y, l(0)
loop 
  uge r7.w, r4.y, cb2[0].x
  breakc_nz r7.w
  ushr r7.z, r4.y, l(5)
  iadd r15.xyz, r7.xyzx, r11.xyzx
  ...
  loop 
    ...
    if_nz r11.w
      ...
      if_nz r9.w
        ...
        ubfe r9.w, l(3), l(24), r31.w
        switch r9.w
          case l(4)
          lt r9.w, l(0.000000), r36.x
          mov r37.xy, r35.zwzz
          mov r37.z, r36.w
          mad r38.xyz, -r37.xyzx, l(0.500000, 0.500000, 0.500000, 0.000000), r30.yzwy
          add r39.xyz, r38.xyzx, -v7.xyzx
          dp3 r11.w, r37.xyzx, r39.xyzx
          div_sat r12.w, -r11.w, r36.x
          mad r40.xyz, r12.wwww, r37.xyzx, r38.xyzx
          movc r40.xyz, r9.wwww, r40.xyzx, r30.yzwy
          add r40.xyz, r40.xyzx, -v7.xyzx
          dp3 r13.w, r40.xyzx, r40.xyzx
          rsq r19.w, r13.w
          mul r40.xyz, r19.wwww, r40.xyzx
          dp3 r19.w, r3.xyzx, r40.xyzx
          mov_sat r23.w, r19.w
          ...
          if_nz r24.w
            ...
            mul r13.w, r13.w, r40.x
            mul r13.w, r40.y, r13.w
            ...
            if_nz r24.w
              ...
              if_nz r24.w
                ...
                mad r40.xyz, r3.xyzx, r24.wwww, v7.xyzx
              ...
              if_nz r24.w
                ...
                dp3 r25.w, r37.xyzx, r6.yzwy
                dp3 r27.w, r6.yzwy, r39.xyzx
                ...
                mad r37.xyz, r11.wwww, r37.xyzx, r38.xyzx
                movc r37.xyz, r9.wwww, r37.xyzx, r30.yzwy
                add r37.xyz, r37.xyzx, -v7.xyzx
                dp3 r9.w, r37.xyzx, r37.xyzx
                rsq r9.w, r9.w
                mul r38.xyz, r9.wwww, r37.xyzx
                ubfe r11.w, l(4), l(16), r31.w
                ult r12.w, l(0), r11.w
                ...
                if_nz r12.w
                  ...
                  mad r17.xyz, r3.xyzx, r25.wwww, v7.xyzx
                  ...
                  if_z r17.y
                    ...
                    if_nz r7.w
                      ...
                      loop 
                        ...
                        dp2 r41.y, icb[r17.z + 0].xyxx, r8.xyxx
                        mad r40.xy, r41.xyxx, r12.wwww, r39.xyxx
                  ...
                  if_nz r12.w
                    ...
                    mad r18.xyz, r3.xyzx, r17.xxxx, v7.xyzx
                    ...
                    if_z r17.z
                      ...
                      if_nz r7.w
                        ...
                        loop 
                          ige r27.w, r25.w, l(8)
                          breakc_nz r27.w
                          dp2 r40.x, icb[r25.w + 0].xyxx, r9.xyxx
                          dp2 r40.y, icb[r25.w + 0].yxyy, r9.xzxx
                          mad r18.xy, r40.xyxx, r12.wwww, r39.xyxx
                ...
                mad r11.w, -r23.w, r3.w, l(1.000000)
                mul r11.w, r11.w, r11.w
                mad r11.w, -r11.w, l(0.620000), l(0.620000)
                add r11.w, -r23.w, r11.w
                mad r11.w, r5.w, r11.w, r23.w
                mul r11.w, r13.w, r11.w
                mov r31.x, r30.x
                lt r12.w, l(0.000000), r19.w
                mad r18.xyz, r11.wwww, r31.xyzx, r15.xyzx
                dp3_sat r11.w, r3.xyzx, r38.xyzx
                mad r37.xyz, r37.xyzx, r9.wwww, r5.xyzx
                dp3 r9.w, r37.xyzx, r37.xyzx
                rsq r9.w, r9.w
                mul r37.xyz, r9.wwww, r37.xyzx
                dp3 r9.w, r37.xyzx, r5.xyzx
                dp3 r17.x, r3.xyzx, r37.xyzx
                mad r19.w, |r17.x|, r4.w, -|r17.x|
                mad r17.x, |r17.x|, r19.w, l(1.000000)
                mad r19.w, r11.w, r0.x, r1.x
                ...
                mul r11.w, r13.w, r11.w
                mad r37.xyz, r11.wwww, r31.xyzx, r29.xyzx
                add_sat r9.w, -r9.w, l(1.000000)
                mul r13.w, r9.w, r9.w
                mul r13.w, r13.w, r13.w
                mul r9.w, r9.w, r13.w
                mul r9.w, r9.w, r11.w
                mad r38.xyz, r9.wwww, r31.xyzx, r28.xyzx
                movc r15.xyz, r12.wwww, r18.xyzx, r15.xyzx
                movc r28.xyz, r12.wwww, r38.xyzx, r28.xyzx
                movc r29.xyz, r12.wwww, r37.xyzx, r29.xyzx
              endif 
            endif 
          endif 
          break 
          ...
          rsq r9.w, r9.w
          mul r37.xyz, r9.wwww, r18.xyzx
          dp3 r11.w, r3.xyzx, r37.xyzx
          mov_sat r12.w, r11.w
          ...
          if_nz r13.w
            ...
            if_nz r17.x
              ...
              mad_sat r32.xy, r13.wwww, r32.xzxx, r32.ywyy
              ...
              div r19.xy, r32.xyxx, r13.wwww
              lt r13.w, r41.w, l(0.00048828)
              if_nz r13.w
                mov r42.y, r43.x
              ...
              mul r17.x, r13.w, r23.w
              and r13.w, r19.w, l(255)
              if_nz r13.w
            ...
            if_nz r13.w
              ...
              if_nz r13.w
                ...
                if_nz r24.w
                  ...
                  div r8.w, r13.w, r23.w
                  max r8.w, r8.w, l(0.00006104)
                  and r13.w, r31.w, l(0x0000ffff)
                  if_nz r7.w
                    utof r30.z, r13.w
                    mov r23.w, l(0)
                    mov r24.w, l(0)
              ...
              if_nz r13.w
                ...
                if_nz r20.x
                  ...
                  mad r20.y, |r11.w|, l(-0.200000), l(0.400000)
                  mad r21.xyz, r3.xyzx, r20.yyyy, v7.xyzx
                  ...
                  if_nz r20.x
                    ...
                    mad r20.y, |r11.w|, l(-0.200000), l(0.400000)
                    mad r22.xyz, r3.xyzx, r20.yyyy, v7.xyzx
                ...
                mad r17.x, -r12.w, r3.w, l(1.000000)
                mul r17.x, r17.x, r17.x
                mad r17.x, -r17.x, l(0.620000), l(0.620000)
                add r17.x, -r12.w, r17.x
                mad r17.x, r5.w, r17.x, r12.w
                mul r17.x, r8.w, r17.x
                lt r11.w, l(0.000000), r11.w
                mad r21.xyz, r17.xxxx, r19.xywx, r15.xyzx
                mad r18.xyz, r18.xyzx, r9.wwww, r5.xyzx
                dp3 r9.w, r18.xyzx, r18.xyzx
                rsq r9.w, r9.w
                mul r18.xyz, r9.wwww, r18.xyzx
                dp3 r9.w, r18.xyzx, r5.xyzx
                dp3 r17.x, r3.xyzx, r18.xyzx
                mad r18.x, |r17.x|, r4.w, -|r17.x|
                mad r17.x, |r17.x|, r18.x, l(1.000000)
                mad r12.w, r12.w, r0.x, r1.x
                mul r17.x, r17.x, r17.x
                ...
                mad r18.xyz, r8.wwww, r19.xywx, r29.xyzx
                add_sat r9.w, -r9.w, l(1.000000)
                mul r12.w, r9.w, r9.w
                mul r12.w, r12.w, r12.w
                mul r9.w, r9.w, r12.w
                mul r8.w, r8.w, r9.w
                mad r19.xyw, r8.wwww, r19.xyxw, r28.xyxz
                movc r15.xyz, r11.wwww, r21.xyzx, r15.xyzx
                movc r28.xyz, r11.wwww, r19.xywx, r28.xyzx
                movc r29.xyz, r11.wwww, r18.xyzx, r29.xyzx
              endif 
            endif 
          endif 
          break 
...
mad r1.xyz, r27.xyzx, r1.yzwy, r2.xyzx
mad r0.xyz, r10.yzwy, r0.yzwy, r1.xyzx
...
ret 
// Approximately 1729 instruction slots used
