// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:41:19 2021
...
r0.w = modelInstanceBuffer[]..swiz;
  ...
  r0.xyzw = v3.xxyy * v0.zyxz;
  r1.xy = v3.zz * v0.xy;
  r0.xyzw = float4(0.013888889,0.013888889,0.013888889,0.013888889) * r0.xyzw;
  r0.xy = r0.xy + r0.zw;
  o6.xy = r1.xy * float2(0.013888889,0.013888889) + r0.xy;
  o1.x = v1.w;
  p1.xy = v2.xy;
  o5.xyz = r8.xyz;
  return;
