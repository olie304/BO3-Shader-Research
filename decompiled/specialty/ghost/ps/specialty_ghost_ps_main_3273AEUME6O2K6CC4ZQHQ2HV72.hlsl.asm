...
//   float alphaRevealSoftEdge;         // Offset:  184 Size:     4 [unused]
//   float alphaRevealRamp;             // Offset:  188 Size:     4 [unused]
//   float2 revealScale;                // Offset:  192 Size:     8 [unused]
//   float edgeAmount;                  // Offset:  200 Size:     4
//   float edgeHarshness;               // Offset:  204 Size:     4
...
// TEXCOORD                10   xyz         8     NONE   float     z 
...
dp3_sat r0.y, v4.xyzx, r0.yzwy
add r0.xz, -r0.xxyx, l(1.000000, 0.000000, 1.000000, 0.000000)
log r0.z, r0.z
mul r0.z, r0.z, cb0[12].w
exp r0.z, r0.z
mul_sat r0.z, r0.z, cb0[12].z
mul r0.w, cb0[12].w, l(3.000000)
log r0.y, r0.y
mul r0.y, r0.y, r0.w
exp r0.y, r0.y
mad r0.y, r0.y, l(0.500000), r0.z
min r0.y, r0.y, l(1.000000)
mul_sat r0.z, v8.z, l(0.01666667)
mul r0.w, r0.z, r0.z
mul r0.z, r0.w, r0.z
mul r0.y, r0.z, r0.y
mul r1.xyz, cb0[12].zzzz, cb0[13].xyzx
mul r0.x, r0.x, r0.y
