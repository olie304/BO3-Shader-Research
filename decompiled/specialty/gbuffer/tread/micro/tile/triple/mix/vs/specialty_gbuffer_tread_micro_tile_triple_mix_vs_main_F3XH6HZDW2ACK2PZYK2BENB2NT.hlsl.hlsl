// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:41:14 2021
...
r0.w = shaderConstantSetBuffer[]..swiz;
  ...
  r4.w = 1;
  r3.w = r6.x;
  r1.w = dot(r4.xyzw, r3.xyzw);
  r5.w = r6.y;
  r3.w = dot(r4.xyzw, r5.xyzw);
  r7.w = r6.z;
  r4.x = dot(r4.xyzw, r7.xyzw);
  r6.x = dot(r0.xyz, r3.xyz);
  r6.y = dot(r0.xyz, r5.xyz);
  r6.z = dot(r0.xyz, r7.xyz);
  r0.x = dot(r6.xyz, r6.xyz);
  r0.x = rsqrt(r0.x);
  o3.xyz = r6.xyz * r0.xxx;
  ...
  r1.xyzw = r4.xxxx * viewProjectionMatrix._m20_m21_m22_m23 + r1.xyzw;
  ...
  o2.xyz = frac(r0.xyz);
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) r0.xy, r2.y, l(16), t0.xyxx
r0.x = shaderConstantSetBuffer[]..swiz;
r0.y = shaderConstantSetBuffer[]..swiz;
  r0.z = cmp(reverseTread != 0.000000);
  r0.x = r0.z ? r0.y : r0.x;
  p1.xy = r0.xx * scrollUVs.xy + v2.xy;
  o1.x = v1.w;
  return;
}