// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:42:44 2021
...
r4.w = shaderConstantSetBuffer[]..swiz;
  ...
  if (r2.w != 0) {
    ...
    if (r2.w != 0) {
      ...
      r7.x = dot(r1.xyz, r13.xyz);
      r7.y = dot(r1.xzy, r15.xzw);
      r7.z = dot(r1.xyz, r14.xyz);
      ...
      if (r2.w != 0) {
        ...
        if (r2.w != 0) {
          ...
          r2.w = r10.y * r7.w;
          r10.zw = r10.zz * r7.wz;
          r4.z = r7.y * r10.y + r10.w;
          r12.x = 1 + -r4.z;
          r13.x = r7.z * r10.x + -r2.w;
          ...
          r7.x = dot(r1.xyz, r12.xyz);
          r7.y = dot(r1.xzy, r14.xzw);
          r7.z = dot(r1.xyz, r13.xyz);
          r9.x = dot(r2.xyz, r12.xyz);
          r9.y = dot(r2.xzy, r14.xzw);
          r9.z = dot(r2.xyz, r13.xyz);
          r5.xyz = r10.xyz + r5.xyz;
          r5.xyz = r5.xyz + r8.xyz;
          r6.xyz = r5.xyz * v5.www + r6.xyz;
          r3.yzw = r7.xyz * v5.www + r3.yzw;
          r4.xyw = r9.xyz * v5.www + r4.xyw;
        }
      }
    }
    r2.w = dot(r3.yzw, r3.yzw);
    r2.w = rsqrt(r2.w);
    r1.xyz = r3.yzw * r2.www;
    r2.w = dot(r4.xyw, r4.xyw);
    r2.w = rsqrt(r2.w);
    r2.xyz = r4.xyw * r2.www;
  }
  r3.yzw = r2.yzx * r1.zxy;
  r3.yzw = r1.yzx * r2.zxy + -r3.yzw;
...
r7.w = shaderConstantSetBuffer[]..swiz;
  ...
  r6.w = 1;
  r4.w = r8.x;
  r9.x = dot(r6.xyzw, r4.xyzw);
  r5.w = r8.y;
  r9.y = dot(r6.xyzw, r5.xyzw);
  r8.xyz = r7.xyz;
  ...
  r1.x = dot(r3.yzw, r4.xyz);
  r1.y = dot(r3.yzw, r5.xyz);
  r1.z = dot(r3.yzw, r8.xyz);
  r0.x = dot(r1.xyz, r1.xyz);
  r0.x = rsqrt(r0.x);
