// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:40:52 2021
...
r7.w = shaderConstantSetBuffer[]..swiz;
  ...
  r4.z = dot(r2.yzw, r8.xyz);
  r0.w = dot(r4.xyz, r4.xyz);
  r0.w = rsqrt(r0.w);
  r2.xyz = r4.xyz * r0.www;
  r4.xyzw = viewProjectionMatrix._m10_m11_m12_m13 * r9.yyyy;
  r4.xyzw = r9.xxxx * viewProjectionMatrix._m00_m01_m02_m03 + r4.xyzw;
  r4.xyzw = r9.zzzz * viewProjectionMatrix._m20_m21_m22_m23 + r4.xyzw;
...
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r4.x, r0.w, l(12), t5.xxxx
r4.x = shaderConstantSetBuffer[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r4.y, r0.w, l(28), t5.xxxx
r4.y = shaderConstantSetBuffer[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r4.z, r0.w, l(44), t5.xxxx
r4.z = shaderConstantSetBuffer[]..swiz;
  r3.xzw = float3(0.100000001,0.100000001,0.100000001) * r4.xyz;
  o2.xyz = frac(r3.xzw);
  r0.w = cmp(0.5 < uvMotionToggle);
  if (r0.w != 0) {
    ...
    r0.w = rsqrt(r0.w);
    r3.xzw = -r9.xyz * r0.www;
    r5.x = dot(r3.xzw, r1.xyz);
    r5.y = dot(r3.xzw, r2.xyz);
    ...
    r3.xz = r3.xz * r0.ww;
    r3.xz = scaleUVs.xy * r3.xz;
    r3.xz = r5.xy * scaleUVs.xy + r3.xz;
    r3.xz = offsetUVs.xy * scaleUVs.xy + r3.xz;
    ...
    r6.y = r6.x;
    r6.z = r5.x;
    r7.x = dot(r6.yz, r3.xz);
    r6.x = -r5.x;
    r7.y = dot(r6.xy, r3.xz);
    r3.xz = gameTime.ww * scrollUVs.xy;
    r3.xz = r3.xz * scaleUVs.xy + r7.xy;
    ...
    r5.xy = saturate(r3.xz);
    r4.xy = clampU ? r5.xy : r3.xz;
  }
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) r3.xz, r3.y, l(36), t0.xxyx
r3.x = shaderConstantSetBuffer[]..swiz;
r3.z = shaderConstantSetBuffer[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) r5.xy, r3.y, l(52), t0.xyxx
r5.x = shaderConstantSetBuffer[]..swiz;
r5.y = shaderConstantSetBuffer[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) r5.zw, r3.y, l(68), t0.xxxy
r5.z = shaderConstantSetBuffer[]..swiz;
r5.w = shaderConstantSetBuffer[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) r3.yw, r3.y, l(84), t0.xxxy
r3.y = shaderConstantSetBuffer[]..swiz;
r3.w = shaderConstantSetBuffer[]..swiz;
  r6.xyz = cmp(float3(2,1,0) < relativeHDR);
  r3.xz = r6.zz ? r5.xy : r3.xz;
  r3.xz = r6.yy ? r5.zw : r3.xz;
  o7.xy = r6.xx ? r3.yw : r3.xz;
  r4.z = v1.w;
  o1.xyz = r4.zxy;
  o3.xyz = r0.xyz;
  o4.xyz = r1.xyz;
