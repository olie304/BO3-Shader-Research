// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:40:51 2021
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r1.x = saturate(w2.x);
  r1.x = hdrScale * r1.x;
  r1.yzw = cmp(w2.yww == float3(3,2,1));
  r2.xyz = r1.www ? tint1.xyz : emissiveTint1.xyz;
  r2.xyz = r1.zzz ? tint2.xyz : r2.xyz;
  r1.yzw = r1.yyy ? tint3.xyz : r2.xyz;
  ...
  r1.z = cmp(emissiveFalloffPower == 0.000000);
  r1.y = log2(r1.y);
  ...
  if (r0.w != 0) {
    ...
    if (r1.x != 0) {
      ...
      r0.w = r0.w * fogConstants.atmospherefogdistancedensityscale.x + fogConstants.atmospherefogdistanceoffset.x;
      r0.w = fogConstants.atmospherefogdensityatcamera.x * r0.w;
      r1.w = cmp(0.00999999978 < abs(v7.z));
      r2.x = fogConstants.atmospherefogheightdensityscale.x * v7.z;
      r2.y = -1.44269502 * r2.x;
      r2.y = exp2(r2.y);
      r2.y = 1 + -r2.y;
      r2.x = r2.y / r2.x;
      r2.x = r2.x * r0.w;
      r0.w = r1.w ? r2.x : r0.w;
      r2.xyz = fogConstants.atmosphereTotalDensity.xyz * r0.www;
      r1.xyz = exp2(r2.xyz);
    }
