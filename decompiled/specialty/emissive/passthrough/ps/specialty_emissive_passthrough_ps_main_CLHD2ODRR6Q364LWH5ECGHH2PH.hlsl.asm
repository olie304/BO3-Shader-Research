...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:41:01 2021
//
//
...
if_nz r1.w
  ...
  if_nz r2.w
    ...
    mul r2.w, r2.w, cb2[9].x
    lt r3.w, l(0.010000), |r2.z|
    mul r4.w, r2.z, cb2[14].x
  ...
  mad r2.xyzw, r2.xxxx, r4.xyzw, cb2[4].xyzw
  mul r1.w, r1.w, r2.w
  mad r2.xyz, -r0.xyzx, cb0[11].wwww, r2.xyzx
  mad r3.xyz, r1.wwww, r2.xyzx, r1.xyzx
endif 
