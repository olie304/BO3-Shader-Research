// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:41:02 2021
...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  if (r1.w != 0) {
    ...
    if (r2.w != 0) {
      ...
      r2.w = fogConstants.atmosphereskyfogdensityatcamera.x * r2.w;
      r3.w = cmp(0.00999999978 < abs(r2.z));
      r4.w = fogConstants.atmosphereskyfogheightdensityscale.x * r2.z;
    ...
    r1.w = fogConstants.skyHeightFalloff * r2.z;
    r2.w = fogConstants.skyHeightFalloff * r2.z + fogConstants.skyK0;
    r3.w = cmp(abs(r1.w) < 9.99999975e-05);
    r4.x = min(64, r2.w);
    r4.x = 1.44269502 * r4.x;
    r4.x = exp2(r4.x);
    r4.y = saturate(fogConstants.skyK0b);
    r4.z = cmp(r2.w < 0);
    r2.w = 1 + r2.w;
    r2.w = r4.z ? r4.x : r2.w;
    r2.w = -fogConstants.skyK0b + r2.w;
    r1.w = r3.w ? 1 : r1.w;
    r1.w = r2.w / r1.w;
    r1.w = r3.w ? r4.y : r1.w;
    ...
    r2.xyzw = r2.xxxx * r4.xyzw + fogConstants.sunFogColor.xyzw;
    r1.w = r2.w * r1.w;
    r2.xyz = -r0.xyz * hdrScale + r2.xyz;
