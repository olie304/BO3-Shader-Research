...
// unknown dcl_: dcl_resource_structured t4, 24
  ...
  r0.x = alphaMap.Sample(colorSampler_s, w1.xy).x;
  ...
  r3.y = r3.x;
  r3.z = r2.x;
  r4.x = dot(r3.yz, r0.zw);
  r3.x = -r2.x;
  r4.y = dot(r3.xy, r0.zw);
  r0.zw = gameTime.ww * scrollUVs.xy;
  r0.zw = r0.zw * scaleUVs.xy + r4.xy;
  ...
  r0.zw = clampU ? r2.xy : r0.zw;
  r2.xyzw = emissiveMap.Sample(colorSampler_s, r0.zw).xyzw;
  if (r0.y != 0) {
    ...
    if (r0.y != 0) {
      ...
      r3.y = cmp(abs(r1.w) < 9.99999975e-05);
      r3.z = min(64, r3.x);
      ...
      r3.y = sqrt(r3.x);
      r1.w = r1.w * r3.y + fogConstants.expAdd;
      r1.w = exp2(r1.w);
      r1.w = min(1, r1.w);
      r1.w = 1 + -r1.w;
      r3.x = rsqrt(r3.x);
  ...
  r0.y = exp2(r0.y);
  r0.y = relativeHDR ? r0.y : r0.z;
  r0.z = cmp(emissiveFalloffPower == 0.000000);
  r0.y = r0.z ? 1 : r0.y;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r0.z, v2.w, l(4), t4.xxxx
...
r1.z = colorSampler[]..swiz;
  r1.x = saturate(r1.x);
  r0.z = hdrScale * r1.x;
  r1.xzw = cmp(r1.zzz == float3(3,2,1));
  r3.xyz = r1.www ? tint1.xyz : emissiveTint1.xyz;
  r3.xyz = r1.zzz ? tint2.xyz : r3.xyz;
  r1.xzw = r1.xxx ? tint3.xyz : r3.xyz;
  ...
  r1.x = frac(r1.x);
  r2.y = gameTime.w * flickerSpeed + r1.x;
  r2.x = flickerSeed.x;
  r1.x = flickerLookupMap.SampleLevel(lookupSampler_s, r2.xy, 0).x;
  r1.x = log2(abs(r1.x));
  r1.x = flickerPower * r1.x;
  r1.x = exp2(r1.x);
  r1.z = flickerRange.y + -flickerRange.x;
  r1.x = r1.x * r1.z + flickerRange.x;
  r0.yzw = r1.xxx * r0.yzw;
  r1.xzw = relHDRExposure.xxx * r0.yzw;
  r0.yzw = relativeHDR ? r1.xzw : r0.yzw;
  o0.w = r1.y * r0.x;
  ...
  if (r0.x != 0) {
    ...
    r1.yzw = fogConstants.atmosphereMieDensity.xyz * r0.xxx;
    ...
    r2.x = cmp(abs(r0.x) < 9.99999975e-05);
    r2.y = min(64, r1.w);
    ...
    r2.x = sqrt(r1.w);
    r0.x = r0.x * r2.x + fogConstants.expAdd;
    r0.x = exp2(r0.x);
    r0.x = min(1, r0.x);
    r0.x = 1 + -r0.x;
    r1.w = rsqrt(r1.w);
