...
r7.w = modelInstanceBuffer[]..swiz;
  ...
  o2.xy = v2.xy;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r2.x, r0.x, l(12), t5.xxxx
r2.x = modelInstanceBuffer[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r2.y, r0.x, l(28), t5.xxxx
r2.y = modelInstanceBuffer[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r2.z, r0.x, l(44), t5.xxxx
r2.z = modelInstanceBuffer[]..swiz;
  r1.yzw = float3(0.100000001,0.100000001,0.100000001) * r2.xyz;
  o3.xyz = frac(r1.yzw);
  p3.x = v5.x;
