...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:40:57 2021
//
//
...
if_nz cb0[12].x
  ...
  mad r5.yz, r5.yyzy, r3.wwww, v1.yyzy
  ...
  mad r2.xy, r2.xyxx, r3.wwww, v1.yzyy
  ...
  mad r3.xy, r3.xyxx, r3.wwww, v1.yzyy
  ...
  mad r1.xy, r1.xyxx, r3.wwww, v1.yzyy
...
mul r2.xyz, r1.xyzx, cb0[11].wwww
...
if_nz r1.w
  ...
  if_nz r2.w
    ...
    mul r5.xyz, r2.wwww, cb2[12].xyzx
    exp r4.xyz, r5.xyzx
  endif 
  ...
  mad r4.xyzw, r2.wwww, r4.xyzw, cb2[4].xyzw
  mul r1.w, r1.w, r4.w
  mad r1.xyz, -r1.xyzx, cb0[11].wwww, r4.xyzx
...
eq r2.xyzw, r0.xyzw, l(0.000000, 0.000000, 0.000000, 0.000000)
...
if_z r1.w
  ...
  if_nz r1.w
    ...
    iadd r1.x, r1.z, r1.x
    ishl r1.y, r1.w, l(1)
    iadd r1.xzw, r1.yyyy, r1.xxxx
    mov_sat r3.w, r0.w
    mul r3.w, r3.w, l(2046.000000)
    ftou r3.w, r3.w
    ishl r4.x, v0.z, l(2)
    and r3.w, r3.w, l(2046)
    bfi r3.w, l(11), l(0), r3.w, r4.x
    bfi r1.y, l(1), l(0), cb0[11].z, r3.w
