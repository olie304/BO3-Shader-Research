...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:40:54 2021
//
//
...
//   uint zFeatherComputeSprites;       // Offset:  268 Size:     4
//   float hdrScale;                    // Offset:  272 Size:     4
//   float emissiveFalloffPower;        // Offset:  276 Size:     4
//   float frameDarken;                 // Offset:  280 Size:     4 [unused]
//   float warpAmount;                  // Offset:  284 Size:     4 [unused]
//   float3 emissiveTint1;              // Offset:  288 Size:    12
//   float3 scriptControl;              // Offset:  304 Size:    12 [unused]
//   float3 tint1;                      // Offset:  320 Size:    12 [unused]
//   float3 tint2;                      // Offset:  336 Size:    12 [unused]
//   float3 tint3;                      // Offset:  352 Size:    12 [unused]
//   bool relativeHDR;                  // Offset:  364 Size:     4
//   bool invertFalloff;                // Offset:  368 Size:     4
//   float uvMotionToggle1;             // Offset:  372 Size:     4 [unused]
//   float4 scanlineConsts;             // Offset:  384 Size:    16 [unused]
//   float minimumOpacity;              // Offset:  400 Size:     4
//
// }
//
...
// TEXCOORD                 4      w        2     NONE    uint       
// TEXCOORD                 1   xyz         3     NONE   float   xyz 
// TEXCOORD                 2   xyz         4     NONE   float   xyz 
// TEXCOORD                 3   xyz         5     NONE   float   xyz 
// OFFPOSITION              0   xyz         6     NONE   float   xyz 
// TEXCOORD                 9   xy          7     NONE   float       
// TEXCOORD                10   xyz         8     NONE   float       
...
exp r0.x, r0.x
movc r0.x, cb0[23].x, r0.x, r1.x
eq r1.x, cb0[17].y, l(0.000000)
...
if_z r0.w
  ftou r3.xy, v0.xyxx
  bfi r0.w, l(1), l(16), cb0[16].w, l(0)
  iadd r0.w, r0.w, l(1)
  ...
  if_nz r0.w
    ...
    bfi r2.y, l(1), l(0), cb0[16].w, r0.w
