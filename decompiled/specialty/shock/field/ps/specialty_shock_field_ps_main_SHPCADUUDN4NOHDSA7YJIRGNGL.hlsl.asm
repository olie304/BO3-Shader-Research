...
mul r1.w, r0.w, v1.w
sample_indexable(texture2d)(float,float,float,float) r2.x, v2.xyxx, t26.xyzw, s6
sample_indexable(texture2d)(float,float,float,float) r2.y, v2.xyxx, t25.yxzw, s3
...
sample_indexable(texture2d)(float,float,float,float) r4.xyzw, v2.xyxx, t30.xyzw, s1
mul r2.yzw, r4.xxyz, cb0[10].xxyz
dp3 r5.x, -v7.xyzx, -v7.xyzx
rsq r5.x, r5.x
mul r5.yzw, r5.xxxx, -v7.xxyz
dp3_sat r6.x, v4.xyzx, r5.yzwy
lt r6.y, cb0[15].w, l(0.500000)
add r6.z, -r6.x, l(1.000000)
movc r6.x, r6.y, r6.z, r6.x
mul_sat r6.x, r6.x, cb0[15].y
log r6.x, r6.x
mul r6.x, r6.x, cb0[15].z
exp r6.x, r6.x
mul r6.y, r4.w, r6.x
mul r4.xyz, r2.yzwy, r6.yyyy
...
dp3_sat r7.x, r3.xyzx, r5.yzwy
dp3 r6.z, -r5.yzwy, r3.xyzx
add r6.z, r6.z, r6.z
mad r12.xyz, r3.xyzx, -r6.zzzz, -r5.yzwy
...
mov r16.x, -r8.x
not r2.z, r6.y
mad r2.w, -r7.x, l(0.500000), l(1.000000)
...
loop 
          ...
          if_nz r31.w
            ...
            if_nz r31.w
              ...
              if_nz r31.w
                ...
                mad r39.xyz, r39.xyzx, r22.wwww, r5.yzwy
                dp3 r21.x, r39.xyzx, r39.xyzx
                rsq r21.x, r21.x
                mul r39.xyz, r21.xxxx, r39.xyzx
                dp3 r21.x, r39.xyzx, r5.yzwy
                dp3 r21.z, r3.xyzx, r39.xyzx
                mad r22.w, |r21.z|, r6.z, -|r21.z|
          ...
          if_nz r21.z
            ...
            if_nz r21.z
              ...
              if_nz r21.z
                ...
                mad r25.xyz, r39.xyzx, r20.xxxx, r5.yzwy
                dp3 r20.x, r25.xyzx, r25.xyzx
                rsq r20.x, r20.x
                mul r25.xyz, r20.xxxx, r25.xyzx
                dp3 r20.x, r25.xyzx, r5.yzwy
                dp3 r22.y, r3.xyzx, r25.xyzx
                mad r22.w, |r22.y|, r6.z, -|r22.y|
  ...
  iadd r8.w, r8.w, l(32)
endloop 
add r2.z, -r7.y, l(1.000000)
mul r2.w, r2.z, l(5.000000)
mad r5.x, r2.z, l(5.000000), l(-2.500000)
mul r5.x, r5.x, l(0.400000)
max r5.x, r5.x, l(0.000000)
mad r5.yz, -r2.zzzz, l(0.000000, 10.000000, 5.000000, 0.000000), l(0.000000, 6.857410, 7.085000, 0.000000)
exp r5.y, r5.y
mul r5.y, r5.y, r7.x
mul r5.w, r2.z, r2.w
mad r5.z, -r5.w, l(2.015905), r5.z
exp r5.z, r5.z
mul r5.z, r5.z, r7.x
mul r5.xyz, r5.xyzx, l(100.000000, 9.136810, 9.708090, 0.000000)
max r5.y, r5.z, r5.y
max r5.y, r5.y, l(1.268160)
iadd r5.z, cb2[0].y, -cb2[58].x
and r5.w, r5.z, l(-32)
iadd r6.y, -r5.w, r5.z
      ...
      if_nz r13.w
        ...
        if_nz r11.w
          ...
          if_nz r13.w
            ...
            sqrt r11.x, r11.x
            mad r11.x, r2.z, l(5.000000), r11.x
...
max r2.z, r19.w, l(1.000000)
rcp r2.z, r2.z
mov_sat r19.w, r19.w
mul r5.xyz, r2.zzzz, r18.xyzx
mul r6.yzw, r2.zzzz, r19.xxyz
...
if_nz r5.w
  ...
  mad r5.xyz, r18.xyzx, r2.zzzz, r8.xyzx
  mov r12.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r8.xyz, r12.xyzw, t8.xyzw, s2, r2.w
  mad r2.z, cb2[19].x, r5.w, -r3.z
  mad r2.z, r7.y, r2.z, r3.z
  mad r6.yzw, r8.xxyz, r2.zzzz, r6.yyzw
endif 
mad r5.xyz, r5.xyzx, r2.xxxx, r10.yzwy
mad r2.zw, r7.xxxy, l(0.000000, 0.000000, 0.984375, 0.984375), l(0.000000, 0.000000, 0.00781250, 0.00781250)
sample_l_indexable(texture2d)(float,float,float,float) r2.zw, r2.zwzz, t5.zwxy, s2, l(0.000000)
mul r6.yzw, r2.xxxx, r6.yyzw
mad r7.xyz, r6.yzwy, r2.zzzz, r29.xyzx
mad r2.xzw, r6.yyzw, r2.wwww, r30.xxyz
mul r6.yzw, r7.xxyz, l(0.000000, 0.960000, 0.960000, 0.960000)
mad r2.xzw, r2.xxzw, l(0.040000, 0.000000, 0.040000, 0.040000), r6.yyzw
mad r0.xyz, r5.xyzx, r0.xyzx, r2.xzwx
ftoi r5.xy, v0.xyxx
mov r5.zw, l(0,0,0,0)
ld_indexable(texture2d)(float,float,float,float) r2.x, r5.xyzw, t0.xyzw
...
if_nz r2.y
  sample_indexable(texture2d)(float,float,float,float) r2.y, v2.xyxx, t38.xwyz, s1
  sample_indexable(texture2d)(float,float,float,float) r5.xyzw, v2.xyxx, t46.xyzw, s1
  mul r5.xyz, r5.wwww, r5.xyzx
  mad r0.w, r0.w, v1.w, -r2.y
  mad r0.w, r2.x, r0.w, r2.y
  add r7.xyzw, r4.xyzw, -r5.xyzw
  mad r4.xyzw, r2.xxxx, r7.xyzw, r5.xyzw
...
mul r0.w, r4.w, r0.w
sample_indexable(texture2d)(float,float,float,float) r2.x, v2.zwzz, t37.xyzw, s1
mad r2.yz, r3.xxyx, cb0[16].zzzz, v0.xxyx
mul r2.yz, r2.yyzy, cb1[44].zzwz
sample_indexable(texture2d)(float,float,float,float) r2.yzw, r2.yzyy, t29.wxyz, s1
mul r3.xyz, r2.yzwy, cb1[85].xxxx
mad_sat r0.w, r0.w, r6.x, r1.w
mul r0.w, r0.w, cb0[16].x
mul r0.w, r2.x, r0.w
mad r0.xyz, -r2.yzwy, cb1[85].xxxx, r0.xyzx
