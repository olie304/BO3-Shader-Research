...
if_nz r9.w
  ...
  if_nz r9.w
    ...
    mad r14.xyz, -v6.xyzx, r5.xxxx, cb2[17].xyzx
...
if_nz r2.y
  ...
  sample_indexable(texture2d)(float,float,float,float) r5.xyzw, v1.yzyy, t46.xyzw, s1
...
mov o0.xyzw, r1.xyzw
ret 
// Approximately 1920 instruction slots used
