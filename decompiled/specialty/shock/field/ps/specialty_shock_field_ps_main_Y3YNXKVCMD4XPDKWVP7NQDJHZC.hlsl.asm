...
sample_indexable(texture2d)(float,float,float,float) r2.x, v1.yzyy, t24.xyzw, s1
...
if_nz r10.w
  ...
  if_nz r10.w
    ...
    mad r15.xyz, -v6.xyzx, r2.yyyy, cb2[17].xyzx
...
if_nz r2.y
  ...
  sample_indexable(texture2d)(float,float,float,float) r3.xyzw, v1.yzyy, t47.xyzw, s1
