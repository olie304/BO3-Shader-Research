...
sample_indexable(texture2d)(float,float,float,float) r4.x, v1.yzyy, t26.xyzw, s6
...
if_nz r1.w
  sample_indexable(texture2d)(float,float,float,float) r1.w, v1.yzyy, t38.xyzw, s1
  sample_indexable(texture2d)(float,float,float,float) r2.xyzw, v1.yzyy, t46.xyzw, s1
...
mul r0.w, r6.w, r0.w
sample_indexable(texture2d)(float,float,float,float) r1.w, v7.xyxx, t37.yzwx, s1
...
ret 
// Approximately 2308 instruction slots used
