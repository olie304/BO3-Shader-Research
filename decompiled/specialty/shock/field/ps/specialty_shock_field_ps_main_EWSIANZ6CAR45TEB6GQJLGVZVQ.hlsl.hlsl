...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  r2.yzw = colorTint.xyz * r4.xyz;
  r5.x = dot(-v6.xyz, -v6.xyz);
  r5.x = rsqrt(r5.x);
  r5.yzw = -v6.xyz * r5.xxx;
  r6.x = saturate(dot(v3.xyz, r5.yzw));
  r6.y = cmp(emissiveFalloffDir < 0.5);
  r6.z = 1 + -r6.x;
  r6.x = r6.y ? r6.z : r6.x;
  r6.x = saturate(emissiveFalloffScale * r6.x);
  r6.x = log2(r6.x);
  r6.x = emissiveFalloffPow * r6.x;
  r6.x = exp2(r6.x);
  r6.y = r6.x * r4.w;
  r4.xyz = r6.yyy * r2.yzw;
  ...
  r7.x = saturate(dot(r3.xyz, r5.yzw));
  r6.z = dot(-r5.yzw, r3.xyz);
  r6.z = r6.z + r6.z;
  r12.xyz = r3.xyz * -r6.zzz + -r5.yzw;
  r6.z = 17 * r7.y;
  r6.z = exp2(r6.z);
  r6.z = 2 + r6.z;
  r6.z = 2 / r6.z;
  ...
  if (r9.w != 0) {
    r9.w = cmp(0 < r10.y);
    if (r9.w != 0) {
      r9.w = sunConstants.specScale * r6.z;
      r9.w = r9.w * r8.w;
            ...
            if (r31.w != 0) {
              ...
              if (r31.w != 0) {
                ...
                if (r31.w != 0) {
                  ...
                  r39.xyz = r39.xyz * r22.www + r5.yzw;
                  r21.x = dot(r39.xyz, r39.xyz);
                  r21.x = rsqrt(r21.x);
                  r39.xyz = r39.xyz * r21.xxx;
                  r21.x = dot(r39.xyz, r5.yzw);
                  r21.z = dot(r3.xyz, r39.xyz);
                  r22.w = abs(r21.z) * r6.z + -abs(r21.z);
            ...
            r42.w = samp0[]..swiz;
              ...
              if (r21.z != 0) {
                ...
                if (r21.z != 0) {
                  ...
                  r25.xyz = r39.xyz * r20.xxx + r5.yzw;
                  r20.x = dot(r25.xyz, r25.xyz);
                  r20.x = rsqrt(r20.x);
                  r25.xyz = r25.xyz * r20.xxx;
                  r20.x = dot(r25.xyz, r5.yzw);
                  r22.y = dot(r3.xyz, r25.xyz);
                  r22.w = abs(r22.y) * r6.z + -abs(r22.y);
  ...
  r2.w = 5 * r2.z;
  r5.x = r2.z * 5 + -2.5;
  r5.x = 0.400000006 * r5.x;
  r5.x = max(0, r5.x);
  r5.yz = -r2.zz * float2(10,5) + float2(6.85740995,7.08500004);
  r5.y = exp2(r5.y);
  r5.y = r7.x * r5.y;
  r5.w = r2.w * r2.z;
  r5.z = -r5.w * 2.0159049 + r5.z;
  r5.z = exp2(r5.z);
  r5.z = r7.x * r5.z;
  r5.xyz = float3(100,9.1368103,9.70808983) * r5.xyz;
  r5.y = max(r5.y, r5.z);
  r5.y = max(1.26815999, r5.y);
  r5.z = numRefProbes + -numOverrideProbes;
  r5.w = (int)r5.z & -32;
  r6.y = (int)-r5.w + (int)r5.z;
  ...
  if (r6.z != 0) {
    ...
    r6.w = 0;
    while (true) {
      r7.z = cmp((uint)r6.w >= (uint)r5.z);
      if (r7.z != 0) break;
      r8.z = (uint)r6.w >> 5;
      r9.xyz = (int3)r8.xyz + (int3)r15.xyz;
      r7.z = visibleProbes.Load(r9.xyzw).x;
      r7.w = cmp((int)r5.w == (int)r6.w);
  ...
  r5.xyz = r18.xyz * r2.zzz;
  r6.yzw = r19.xyz * r2.zzz;
  ...
  if (r5.w != 0) {
    ...
    r5.xyz = r18.xyz * r2.zzz + r8.xyz;
    r12.w = 0;
    r8.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r12.xyzw, r2.w).xyz;
    r2.z = sunConstants.globalProbeExposure * r5.w + -r3.z;
    r2.z = r7.y * r2.z + r3.z;
    r6.yzw = r8.xyz * r2.zzz + r6.yzw;
  }
  r5.xyz = r5.xyz * r2.xxx + r10.yzw;
  r2.zw = r7.xy * float2(0.984375,0.984375) + float2(0.0078125,0.0078125);
  r2.zw = gEnvBRDFGeneric.SampleLevel(samplerLinear_s, r2.zw, 0).xy;
  r6.yzw = r6.yzw * r2.xxx;
  r7.xyz = r6.yzw * r2.zzz + r29.xyz;
  r2.xzw = r6.yzw * r2.www + r30.xyz;
  r6.yzw = float3(0.959999979,0.959999979,0.959999979) * r7.xyz;
  r2.xzw = r2.xzw * float3(0.0399999991,0.0399999991,0.0399999991) + r6.yzw;
  r0.xyz = r5.xyz * r0.xyz + r2.xzw;
  r5.xy = (int2)v0.xy;
  r5.zw = float2(0,0);
  ...
  if (r2.y != 0) {
    ...
    r4.xyzw = r2.xxxx * r7.xyzw + r5.xyzw;
  ...
  r2.yz = r3.xy * distortionAmount + v0.xy;
  r2.yz = renderTargetSize.zw * r2.yz;
  r2.yzw = resolvedPostSun.Sample(colorSampler_s, r2.yz).xyz;
  r3.xyz = relHDRExposure.xxx * r2.yzw;
  r0.w = saturate(r0.w * r6.x + r1.w);
  r0.w = shieldOpacity * r0.w;
  r0.w = r0.w * r2.x;
  r0.xyz = -r2.yzw * relHDRExposure.xxx + r0.xyz;
