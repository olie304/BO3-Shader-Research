...
mul r1.x, r0.w, v1.w
sample_indexable(texture2d)(float,float,float,float) r1.yzw, v2.xyxx, t25.wxyz, s5
...
if_nz r1.y
  ftoi r1.y, cb1[64].w
  lod r1.z, v2.xyxx, t22.y, s1
  lod r2.w, v2.xyxx, t22.x, s1
  lt r1.z, r1.z, r2.w
...
sample_indexable(texture2d)(float,float,float,float) r4.x, v2.xyxx, t29.xyzw, s6
...
if_nz r1.w
  sample_indexable(texture2d)(float,float,float,float) r1.w, v2.xyxx, t46.xyzw, s1
  sample_indexable(texture2d)(float,float,float,float) r2.xyzw, v2.xyxx, t47.xyzw, s1
...
mul r0.w, r6.w, r0.w
sample_indexable(texture2d)(float,float,float,float) r1.w, v2.zwzz, t38.yzwx, s1
