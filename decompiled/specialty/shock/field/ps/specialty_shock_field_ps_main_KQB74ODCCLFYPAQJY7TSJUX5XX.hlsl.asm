...
sample_indexable(texture2d)(float,float,float,float) r2.x, v2.xyxx, t22.xyzw, s1
...
if_nz r10.w
  ...
  if_nz r10.w
    ...
    mad r15.xyz, -v7.xyzx, r4.wwww, cb2[17].xyzx
...
if_nz r2.y
  ...
  sample_indexable(texture2d)(float,float,float,float) r3.xyzw, v2.xyxx, t46.xyzw, s1
