...
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, v2.xyxx, t30.xyzw, s1
mul r6.xyz, r2.xyzx, cb0[10].xyzx
dp3 r4.w, -v7.xyzx, -v7.xyzx
rsq r4.w, r4.w
mul r7.xyz, r4.wwww, -v7.xyzx
dp3_sat r5.z, v4.xyzx, r7.xyzx
...
if_nz r1.z
  sample_indexable(texture2d)(float,float,float,float) r1.z, v2.xyxx, t38.xywz, s1
  sample_indexable(texture2d)(float,float,float,float) r4.xyzw, v2.xyxx, t46.xyzw, s1
...
mul r0.w, r2.w, r0.w
sample_indexable(texture2d)(float,float,float,float) r1.z, v2.zwzz, t37.yzxw, s1
...
mov o0.xyzw, r3.xyzw
ret 
// Approximately 2259 instruction slots used
