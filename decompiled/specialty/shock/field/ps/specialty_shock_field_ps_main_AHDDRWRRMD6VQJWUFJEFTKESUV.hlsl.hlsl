// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:42:46 2021
...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  r7.y = max(0, r2.y);
  r3.yzw = r6.xyz * r2.www;
  r2.yzw = r5.xyz * r2.zzz + r3.yzw;
  r2.yzw = r4.xyz * r3.xxx + r2.yzw;
  r3.x = dot(r2.yzw, r2.yzw);
  r3.x = rsqrt(r3.x);
  r3.xyz = r3.xxx * r2.yzw;
  r4.xyzw = emissiveMap.Sample(colorSampler_s, v2.xy).xyzw;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r2.y, v3.x, l(4), t4.xxxx
r2.y = samp0[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) r2.yzw, r2.y, l(32), t0.xxyz
r2.y = samp0[]..swiz;
r2.z = samp0[]..swiz;
r2.w = samp0[]..swiz;
  r5.xyz = cmp(float3(0.0404499993,0.0404499993,0.0404499993) >= r2.yzw);
  r6.xyz = float3(0.0773993805,0.0773993805,0.0773993805) * r2.yzw;
  r2.yzw = float3(0.0549999997,0.0549999997,0.0549999997) + r2.yzw;
  r2.yzw = float3(0.947867334,0.947867334,0.947867334) * r2.yzw;
  r2.yzw = log2(r2.yzw);
  r2.yzw = float3(2.4000001,2.4000001,2.4000001) * r2.yzw;
  r2.yzw = exp2(r2.yzw);
  r2.yzw = r5.xyz ? r6.xyz : r2.yzw;
  r5.xyz = r4.xyz * r2.yzw;
  r0.xyz = r2.yzw * r0.xyz;
  r2.y = dot(-v7.xyz, -v7.xyz);
  r2.y = rsqrt(r2.y);
  r6.xyz = -v7.xyz * r2.yyy;
  r2.z = saturate(dot(v4.xyz, r6.xyz));
  r2.w = cmp(emissiveFalloffDir < 0.5);
  r5.w = 1 + -r2.z;
  r2.z = r2.w ? r5.w : r2.z;
  r2.z = saturate(emissiveFalloffScale * r2.z);
  r2.z = log2(r2.z);
  r2.z = emissiveFalloffPow * r2.z;
  r2.z = exp2(r2.z);
  r2.w = r4.w * r2.z;
  ...
  r7.zw = (uint2)r5.yx;
  r5.w = dot(r7.wz, float2(0.0671105608,0.00583714992));
  r5.w = frac(r5.w);
  r5.w = 52.9829178 * r5.w;
  r5.w = frac(r5.w);
  r5.w = r5.w * 6.28318548 + gameTick.w;
  sincos(r5.w, r8.x, r9.x);
  r5.w = dot(r7.zw, float2(0.0671105608,0.00583714992));
  r5.w = frac(r5.w);
  r5.w = 52.9829178 * r5.w;
  r5.w = frac(r5.w);
  r5.w = r5.w * 6.28318548 + gameTick.w;
  ...
  r8.z = r7.x * r7.z + r7.w;
  r7.zw = r8.zz * r7.zw;
  r8.z = dot(r3.xyz, sunConstants.wldDir.xyz);
  r8.w = saturate(r8.z);
  r9.w = cmp(0 >= r8.w);
  if (r9.w != 0) {
    r10.y = 0;
  ...
  if (r9.w == 0) {
    ...
    if (r13.x == 0) {
      if (enableDitheredShadow == 0) {
        ...
        r13.z = r11.w + r10.z;
        r11.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r13.xyz, r9.w).x;
      ...
      if (enableDitheredShadow != 0) {
        ...
        r11.yz = -sunConstants.splitPinTransform[r10.z].xy + r11.yz;
        r11.yz = sunConstants.splitPinTransform[r10.z].zz * r11.yz;
        ...
        while (true) {
          ...
          r15.z = r14.w ? sunConstants.splitPinTransform[r10.z].w : sunConstants.splitPinTransform[r11.w].w;
          r14.w = r14.w ? r10.z : r11.w;
          ...
          r15.z = (uint)r14.w;
          r14.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r15.xyz, r9.w).x;
  ...
  if (r9.w != 0) {
    r9.w = cmp(0 < r10.y);
    if (r9.w != 0) {
      r9.w = sunConstants.specScale * r5.w;
      r9.w = r9.w * r8.w;
      if (sunConstants.sunCookieIndex != 0) {
        r13.xyz = eyeOffset.xyz + v7.xyz;
        r13.w = 1;
        r10.z = dot(sunConstants.sunCookieTransform[0].xyzw, r13.xyzw);
        r10.w = dot(sunConstants.sunCookieTransform[1].xyzw, r13.xyzw);
        r13.xy = frac(r10.zw);
        r10.z = -1 + (int14)sunConstants.sunCookieIndex;
        r13.z = (uint)r10.z;
      ...
      r10.w = samp0[]..swiz;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r13.xyzw, r10.z, l(68), t12.xyzw
      r13.x = samp0[]..swiz;
      r13.y = samp0[]..swiz;
      r13.z = samp0[]..swiz;
      r13.w = samp0[]..swiz;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r14.xyzw, r10.z, l(84), t12.xyzw
      r14.x = samp0[]..swiz;
      r14.y = samp0[]..swiz;
      r14.z = samp0[]..swiz;
      r14.w = samp0[]..swiz;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r15.xyzw, r10.z, l(132), t12.xyzw
      r15.x = samp0[]..swiz;
      r15.y = samp0[]..swiz;
      r15.z = samp0[]..swiz;
      r15.w = samp0[]..swiz;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r16.xyzw, r10.z, l(148), t12.xyzw
      r16.x = samp0[]..swiz;
      r16.y = samp0[]..swiz;
      r16.z = samp0[]..swiz;
      r16.w = samp0[]..swiz;
        r17.x = abs(r8.z) * -0.200000003 + 0.400000006;
        r17.xyz = r3.xyz * r17.xxx + v7.xyz;
        r17.w = 1;
        ...
        r13.z = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r14.xyzw, r10.z, l(100), t12.xyzw
        r14.x = samp0[]..swiz;
        r14.y = samp0[]..swiz;
        r14.z = samp0[]..swiz;
        r14.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r16.xy, r10.z, l(164), t12.xyxx
        r16.x = samp0[]..swiz;
        r16.y = samp0[]..swiz;
          r10.z = dot(r14.xyzw, r17.xyzw);
          r13.xy = saturate(r13.xy);
          r14.xy = r13.xy * r15.xz + r15.yw;
          r10.z = r10.z + r16.x;
          r10.z = r10.z / r16.y;
          r10.z = max(6.10351563e-05, r10.z);
          r13.x = r13.z ? 0.000000 : 0;
          if (enableDitheredShadow != 0) {
            r15.x = -r8.x;
            r16.z = (uint)r13.x;
            r15.y = r9.x;
            ...
            while (true) {
              ...
              r16.xy = r17.xy * r10.ww + r14.xy;
              r13.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r10.z).x;
              r13.y = r13.w * 0.125 + r13.y;
              r13.z = (int)r13.z + 1;
            }
          } else {
            r14.z = (uint)r13.x;
            r13.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r14.xyz, r10.z).x;
          }
          r10.z = r13.y * r13.y;
          r10.z = r10.z * r13.y;
        } else {
      ...
      r10.z = r10.z + -r8.w;
      r10.z = r6.w * r10.z + r8.w;
      r10.z = r10.z * r10.y;
      r13.xyz = r10.zzz * r11.yzw;
      r8.z = cmp(0 < r8.z);
      r14.xyz = -v7.xyz * r2.yyy + sunConstants.wldDir.xyz;
      r2.y = dot(r14.xyz, r14.xyz);
      r2.y = rsqrt(r2.y);
      r14.xyz = r14.xyz * r2.yyy;
      r2.y = dot(r14.xyz, r6.xyz);
      r10.z = dot(r3.xyz, r14.xyz);
      r10.w = abs(r10.z) * r5.w + -abs(r10.z);
      r10.z = abs(r10.z) * r10.w + 1;
      r8.w = r8.w * r7.z + r7.w;
      r10.z = r10.z * r10.z;
      r8.w = r10.z * r8.w;
      r8.w = rcp(r8.w);
      ...
      r8.w = r10.y * r8.w;
      r8.w = 0.25 * r8.w;
      r10.yzw = r8.www * r11.yzw;
      r2.y = saturate(1 + -r2.y);
      r9.w = r2.y * r2.y;
      r9.w = r9.w * r9.w;
      r2.y = r9.w * r2.y;
      r2.y = r8.w * r2.y;
      r14.xyz = r2.yyy * r11.zwy;
      r13.w = r14.z;
      r13.xyzw = r8.zzzz ? r13.xyzw : 0;
      r14.zw = r10.yz;
      r14.xyzw = r8.zzzz ? r14.xyzw : 0;
      r2.y = r8.z ? r10.w : 0;
    } else {
  ...
  while (true) {
    ...
    while (true) {
      ...
      r32.w = samp0[]..swiz;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=80)(mixed,mixed,mixed,mixed) r33.xy, r17.w, l(16), t11.xyxx
      r33.x = samp0[]..swiz;
      r33.y = samp0[]..swiz;
        ...
        if (r22.w != 0) {
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r32.xyzw, r17.w, l(0), t12.wxyz
        r32.x = samp0[]..swiz;
        r32.y = samp0[]..swiz;
        r32.z = samp0[]..swiz;
        r32.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r33.xyzw, r17.w, l(16), t12.zxyw
        r33.x = samp0[]..swiz;
        r33.y = samp0[]..swiz;
        r33.z = samp0[]..swiz;
        r33.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r34.xyzw, r17.w, l(32), t12.xyzw
        r34.x = samp0[]..swiz;
        r34.y = samp0[]..swiz;
        r34.z = samp0[]..swiz;
        r34.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r35.xyzw, r17.w, l(48), t12.xyzw
        r35.x = samp0[]..swiz;
        r35.y = samp0[]..swiz;
        r35.z = samp0[]..swiz;
        r35.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r36.xyzw, r17.w, l(64), t12.yzwx
        r36.x = samp0[]..swiz;
        r36.y = samp0[]..swiz;
        r36.z = samp0[]..swiz;
        r36.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r37.xyzw, r17.w, l(80), t12.xyzw
        r37.x = samp0[]..swiz;
        r37.y = samp0[]..swiz;
        r37.z = samp0[]..swiz;
        r37.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r38.xyzw, r17.w, l(96), t12.yzwx
        r38.x = samp0[]..swiz;
        r38.y = samp0[]..swiz;
        r38.z = samp0[]..swiz;
        r38.w = samp0[]..swiz;
          if (3 == 0) r22.w = 0; else if (3+24 < 32) {           r22.w = (uint)r33.w << (32-(3 + 24)); r22.w = (uint)r22.w >> (32-3);          } else r22.w = (uint)r33.w >> 24;
          switch (r22.w) {
            case 4 :            r22.w = cmp(0 < r38.x);
            r39.xy = r37.zw;
            r39.z = r38.w;
            r40.xyz = -r39.xyz * float3(0.5,0.5,0.5) + r32.yzw;
            r41.xyz = -v7.xyz + r40.xyz;
            r26.w = dot(r39.xyz, r41.xyz);
            r27.w = saturate(-r26.w / r38.x);
            r42.xyz = r27.www * r39.xyz + r40.xyz;
            r42.xyz = r22.www ? r42.xyz : r32.yzw;
            r42.xyz = -v7.xyz + r42.xyz;
            r28.w = dot(r42.xyz, r42.xyz);
            r29.w = rsqrt(r28.w);
            r42.xyz = r42.xyz * r29.www;
            r29.w = dot(r3.xyz, r42.xyz);
            ...
            if (r31.w != 0) {
              ...
              r28.w = r39.w / r28.w;
              r28.w = min(1, r28.w);
              r42.xy = saturate(r31.ww * r34.xz + r34.yw);
              ...
              r31.w = cmp(0 < r28.w);
              if (r31.w != 0) {
                if (3 == 0) r31.w = 0; else if (3+27 < 32) {                 r31.w = (uint)r33.w << (32-(3 + 27)); r31.w = (uint)r31.w >> (32-3);                } else r31.w = (uint)r33.w >> 27;
                r31.w = cmp((int)r31.w != 1);
                if (r31.w != 0) {
                  r31.w = abs(r29.w) * -0.200000003 + 0.400000006;
                  r42.xyz = r3.xyz * r31.www + v7.xyz;
                  r42.xyz = r42.xyz + -r36.xyz;
                  r31.w = max(abs(r42.y), abs(r42.z));
                  r31.w = max(abs(r42.x), r31.w);
                  r31.w = r37.x / r31.w;
                  r31.w = r31.w + r37.y;
                  r39.w = dot(r42.xyz, r42.xyz);
                  r39.w = rsqrt(r39.w);
                  r31.w = max(6.10351563e-05, r31.w);
                  r40.w = (int)r33.w & 0x0000ffff;
                  r43.w = (uint)r40.w;
                  r40.w = 0;
                  r41.w = 0;
                  while (true) {
                    ...
                    if (r42.w != 0) break;
                    r44.y = dot(icb[r41.w+0].yx, r16.xy);
                    r44.z = dot(icb[r41.w+0].yx, r16.yz);
                    r44.yz = r44.yz * r35.yy;
                    r44.x = r44.y * r11.x;
                    r44.w = r44.y * r10.x;
                    r43.xyz = r42.xyz * r39.www + r44.xzw;
                    r42.w = gOmniShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r43.xyzw, r31.w).x;
                ...
                if (r31.w != 0) {
                  r31.w = r33.x * r5.w;
                  r31.w = 0.25 * r31.w;
                  r39.w = dot(r39.xyz, r12.xyz);
                  r41.x = dot(r12.xyz, r41.xyz);
                  r41.y = -r39.w * r39.w + r38.x;
                  r26.w = r39.w * r41.x + -r26.w;
                  r26.w = saturate(r26.w / r41.y);
                  r39.w = r41.y / r38.x;
                  r39.w = 10 * r39.w;
                  r39.w = min(1, r39.w);
                  r26.w = r26.w + -r27.w;
                  r26.w = r39.w * r26.w + r27.w;
                  r39.xyz = r26.www * r39.xyz + r40.xyz;
                  r39.xyz = r22.www ? r39.xyz : r32.yzw;
                  r39.xyz = -v7.xyz + r39.xyz;
                  r22.w = dot(r39.xyz, r39.xyz);
                  r22.w = rsqrt(r22.w);
                  r40.xyz = r39.xyz * r22.www;
                  if (4 == 0) r26.w = 0; else if (4+16 < 32) {                   r26.w = (uint)r33.w << (32-(4 + 16)); r26.w = (uint)r26.w >> (32-4);                  } else r26.w = (uint)r33.w >> 16;
                  ...
                  r27.w = samp0[]..swiz;
                  // Known bad code for instruction (needs manual fix):
                                    ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r41.xyzw, r26.w, l(100), t12.xyzw
                  r41.x = samp0[]..swiz;
                  r41.y = samp0[]..swiz;
                  r41.z = samp0[]..swiz;
                  r41.w = samp0[]..swiz;
                  // Known bad code for instruction (needs manual fix):
                                    ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r42.xyzw, r26.w, l(116), t12.xyzw
                  r42.x = samp0[]..swiz;
                  r42.y = samp0[]..swiz;
                  r42.z = samp0[]..swiz;
                  r42.w = samp0[]..swiz;
                    r39.w = abs(r29.w) * -0.200000003 + 0.400000006;
                    r20.xyz = r3.xyz * r39.www + v7.xyz;
                    r39.w = dot(r41.xyzw, r20.xyzw);
                    r41.x = dot(r42.xyzw, r20.xyzw);
                    r41.y = cmp(r41.x < r39.w);
                    if (r41.y == 0) {
                    // Known bad code for instruction (needs manual fix):
                                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r42.xyzw, r26.w, l(68), t12.xyzw
                    r42.x = samp0[]..swiz;
                    r42.y = samp0[]..swiz;
                    r42.z = samp0[]..swiz;
                    r42.w = samp0[]..swiz;
                    // Known bad code for instruction (needs manual fix):
                                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r43.xyzw, r26.w, l(84), t12.xyzw
                    r43.x = samp0[]..swiz;
                    r43.y = samp0[]..swiz;
                    r43.z = samp0[]..swiz;
                    r43.w = samp0[]..swiz;
                    // Known bad code for instruction (needs manual fix):
                                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r44.xyzw, r26.w, l(132), t12.xyzw
                    r44.x = samp0[]..swiz;
                    r44.y = samp0[]..swiz;
                    r44.z = samp0[]..swiz;
                    r44.w = samp0[]..swiz;
                    // Known bad code for instruction (needs manual fix):
                                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r45.xyzw, r26.w, l(148), t12.xyzw
                    r45.x = samp0[]..swiz;
                    r45.y = samp0[]..swiz;
                    r45.z = samp0[]..swiz;
                    r45.w = samp0[]..swiz;
                    // Known bad code for instruction (needs manual fix):
                                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r41.zw, r26.w, l(164), t12.xxxy
                    r41.z = samp0[]..swiz;
                    r41.w = samp0[]..swiz;
                      r42.x = dot(r42.xyzw, r20.xyzw);
                      r42.y = dot(r43.xyzw, r20.xyzw);
                      r20.xy = r42.xy / r41.xx;
                      r20.xy = r20.xy * float2(0.5,-0.5) + float2(0.5,0.5);
                      r20.xy = r20.xy + r45.zw;
                      r20.xy = r20.xy * r45.xy;
                      r42.xy = r27.ww / r44.xz;
                      ...
                      r20.x = r41.w * r41.x;
                      r20.y = r41.z * r41.x + r39.w;
                      r20.x = r20.y / r20.x;
                    } else {
                      r20.z = -1;
                    }
                    r20.y = (int)r41.y | (int)r20.z;
                    if (r20.y == 0) {
                    // Known bad code for instruction (needs manual fix):
                    ...
                    r20.y = samp0[]..swiz;
                      ...
                      if (r15.w != 0) {
                        ...
                        r26.w = 0;
                        while (true) {
                          r39.w = cmp((int)r26.w >= 8);
                          if (r39.w != 0) break;
                          r43.x = dot(icb[r26.w+0].yx, r16.xw);
                          r43.y = dot(icb[r26.w+0].xy, r8.xy);
                          r41.xy = r43.xy * r27.ww + r42.xy;
                          r39.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r41.xyz, r20.x).x;
                          r20.z = r39.w * 0.125 + r20.z;
                          r26.w = (int)r26.w + 1;
                        }
                      } else {
                        r42.z = (uint)r20.y;
                    ...
                    if (4 == 0) r20.x = 0; else if (4+20 < 32) {                     r20.x = (uint)r33.w << (32-(4 + 20)); r20.x = (uint)r20.x >> (32-4);                    } else r20.x = (uint)r33.w >> 20;
                    ...
                    r20.y = samp0[]..swiz;
                    // Known bad code for instruction (needs manual fix):
                                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r41.xyzw, r20.x, l(100), t12.xyzw
                    r41.x = samp0[]..swiz;
                    r41.y = samp0[]..swiz;
                    r41.z = samp0[]..swiz;
                    r41.w = samp0[]..swiz;
                    // Known bad code for instruction (needs manual fix):
                                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r42.xyzw, r20.x, l(116), t12.xyzw
                    r42.x = samp0[]..swiz;
                    r42.y = samp0[]..swiz;
                    r42.z = samp0[]..swiz;
                    r42.w = samp0[]..swiz;
                      ...
                      r26.w = dot(r41.xyzw, r21.xyzw);
                      r27.w = dot(r42.xyzw, r21.xyzw);
                      r39.w = cmp(r27.w < r26.w);
                      if (r39.w == 0) {
                      // Known bad code for instruction (needs manual fix):
                                            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r41.xyzw, r20.x, l(68), t12.xyzw
                      r41.x = samp0[]..swiz;
                      r41.y = samp0[]..swiz;
                      r41.z = samp0[]..swiz;
                      r41.w = samp0[]..swiz;
                      // Known bad code for instruction (needs manual fix):
                                            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r42.xyzw, r20.x, l(84), t12.xyzw
                      r42.x = samp0[]..swiz;
                      r42.y = samp0[]..swiz;
                      r42.z = samp0[]..swiz;
                      r42.w = samp0[]..swiz;
                      // Known bad code for instruction (needs manual fix):
                                            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r43.xyzw, r20.x, l(132), t12.xyzw
                      r43.x = samp0[]..swiz;
                      r43.y = samp0[]..swiz;
                      r43.z = samp0[]..swiz;
                      r43.w = samp0[]..swiz;
                      // Known bad code for instruction (needs manual fix):
                                            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r44.xyzw, r20.x, l(148), t12.xyzw
                      r44.x = samp0[]..swiz;
                      r44.y = samp0[]..swiz;
                      r44.z = samp0[]..swiz;
                      r44.w = samp0[]..swiz;
                      // Known bad code for instruction (needs manual fix):
                                            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r45.xy, r20.x, l(164), t12.xyxx
                      r45.x = samp0[]..swiz;
                      r45.y = samp0[]..swiz;
                        r41.x = dot(r41.xyzw, r21.xyzw);
                        r41.y = dot(r42.xyzw, r21.xyzw);
                        r21.xy = r41.xy / r27.ww;
                        r21.xy = r21.xy * float2(0.5,-0.5) + float2(0.5,0.5);
                        r21.xy = r21.xy + r44.zw;
                        r21.xy = r21.xy * r44.xy;
                        r41.xy = r20.yy / r43.xz;
                        ...
                        r21.x = r45.y * r27.w;
                        r21.y = r45.x * r27.w + r26.w;
                        r21.x = r21.y / r21.x;
                      } else {
                        r21.z = -1;
                      }
                      r21.y = (int)r39.w | (int)r21.z;
                      if (r21.y == 0) {
                      // Known bad code for instruction (needs manual fix):
                      ...
                      r20.x = samp0[]..swiz;
                        ...
                        if (r15.w != 0) {
                          ...
                          while (true) {
                            ...
                            if (r26.w != 0) break;
                            r43.x = dot(icb[r21.z+0].xy, r9.xy);
                            r43.y = dot(icb[r21.z+0].yx, r9.xz);
                            r42.xy = r43.xy * r20.yy + r41.xy;
                            r26.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r42.xyz, r21.x).x;
                            r21.y = r26.w * 0.125 + r21.y;
                            r21.z = (int)r21.z + 1;
                          }
                        } else {
                          r41.z = (uint)r20.x;
                          r21.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r41.xyz, r21.x).x;
                        }
                        r20.x = r21.y * r21.y;
                        r20.x = r20.x * r21.y;
                      } else {
                  ...
                  r20.x = r20.x + -r30.w;
                  r20.x = r6.w * r20.x + r30.w;
                  r20.x = r20.x * r28.w;
                  r33.x = r32.x;
                  r20.y = cmp(0 < r29.w);
                  r41.xyz = r20.xxx * r33.xyz + r11.yzw;
                  r20.x = saturate(dot(r3.xyz, r40.xyz));
                  r39.xyz = r39.xyz * r22.www + r6.xyz;
                  r21.x = dot(r39.xyz, r39.xyz);
                  r21.x = rsqrt(r21.x);
                  r39.xyz = r39.xyz * r21.xxx;
                  r21.x = dot(r39.xyz, r6.xyz);
                  r21.z = dot(r3.xyz, r39.xyz);
                  r22.w = abs(r21.z) * r5.w + -abs(r21.z);
                  r21.z = abs(r21.z) * r22.w + 1;
                  r22.w = r20.x * r7.z + r7.w;
                  r21.z = r21.z * r21.z;
                  r21.z = r21.z * r22.w;
                  r21.z = rcp(r21.z);
                  r20.x = r20.x * r31.w;
                  r20.x = r21.z * r20.x;
                  r20.x = r20.x * r28.w;
                  r39.xyz = r20.xxx * r33.xyz + r31.xyz;
                  r21.x = saturate(1 + -r21.x);
                  r21.z = r21.x * r21.x;
                  r21.z = r21.z * r21.z;
                  r21.x = r21.x * r21.z;
                  r20.x = r21.x * r20.x;
                  r40.xyz = r20.xxx * r33.xyz + r18.xyz;
                  r11.yzw = r20.yyy ? r41.xyz : r11.yzw;
                  r18.xyz = r20.yyy ? r40.xyz : r18.xyz;
                  r31.xyz = r20.yyy ? r39.xyz : r31.xyz;
                }
              }
            }
            break;
            case 2 :            r39.xy = r35.zw;
            r39.z = r36.w;
            r39.xyz = -v7.xyz + r39.xyz;
            r20.x = dot(r39.xyz, r39.xyz);
            r20.x = rsqrt(r20.x);
            r40.xyz = r39.xyz * r20.xxx;
            r20.y = dot(r3.xyz, r40.xyz);
            ...
            r42.w = samp0[]..swiz;
              ...
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r44.xyzw, r17.w, l(172), t12.yzwx
              r44.x = samp0[]..swiz;
              r44.y = samp0[]..swiz;
              r44.z = samp0[]..swiz;
              r44.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r45.xyzw, r17.w, l(188), t12.wxyz
              r45.x = samp0[]..swiz;
              r45.y = samp0[]..swiz;
              r45.z = samp0[]..swiz;
              r45.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r46.xyzw, r17.w, l(204), t12.xyzw
              r46.x = samp0[]..swiz;
              r46.y = samp0[]..swiz;
              r46.z = samp0[]..swiz;
              r46.w = samp0[]..swiz;
              ...
              r26.w = samp0[]..swiz;
                r47.xyz = -v7.xyz + r32.yzw;
                r27.w = r35.x * r35.x;
                r28.w = dot(r47.xyz, r47.xyz);
                r27.w = r27.w / r28.w;
                r27.w = min(1, r27.w);
                r34.xy = saturate(r21.zz * r34.xz + r34.yw);
                ...
                r47.xyz = r37.yzw;
                r47.w = r38.w;
                r34.y = dot(r47.xyzw, r19.xyzw);
                r22.xy = r34.xy / r21.zz;
                r21.z = cmp(r44.w < 0.00048828125);
                if (r21.z != 0) {
                  r45.y = r46.x;
                  r34.xy = saturate(abs(r22.xy) * r45.zw + r45.xy);
                  r34.zw = r34.xy * r34.xy;
                  r34.xy = r34.xy * float2(-2,-2) + float2(3,3);
                  r34.xy = r34.zw * r34.xy;
                  r21.z = r34.x * r34.y;
                  ...
                  r44.w = r45.y;
                  r34.xyzw = saturate(r44.xyzw * abs(r22.yyxx));
                  r34.xyzw = log2(r34.xyzw);
                  r34.xyzw = r45.xxxx * r34.xyzw;
                  r34.xyzw = exp2(r34.xyzw);
                  r34.xy = r34.xy + r34.zw;
                  r34.xy = log2(r34.xy);
                  r34.xy = r46.xx * r34.xy;
                  r34.xy = exp2(r34.xy);
                  r28.w = r45.z * r34.x;
                  r29.w = r45.w * r34.y + -1;
                  r28.w = r45.w * r34.y + -r28.w;
                ...
                if (r21.z != 0) {
                // Known bad code for instruction (needs manual fix):
                                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r34.xyz, r17.w, l(220), t12.xyzx
                r34.x = samp0[]..swiz;
                r34.y = samp0[]..swiz;
                r34.z = samp0[]..swiz;
                  r26.w = dot(r46.yzw, r22.xyz);
                  r22.x = dot(r34.xyz, r22.xyz);
                  r34.x = frac(r26.w);
                  r34.y = frac(r22.x);
                  r21.z = (int)r21.z + -1;
                  r34.z = (uint)r21.z;
                  r40.xyz = gCookieArray.SampleLevel(samplerLinear_s, r34.xyz, 0).xyz;
                } else {
                  r40.xyz = float3(1,1,1);
                }
              }
              r32.yz = r33.yz;
              r32.xyz = r32.xyz * r40.xyz;
              r21.z = cmp(0 < r22.w);
              if (r21.z != 0) {
                if (3 == 0) r21.z = 0; else if (3+27 < 32) {                 r21.z = (uint)r33.w << (32-(3 + 27)); r21.z = (uint)r21.z >> (32-3);                } else r21.z = (uint)r33.w >> 27;
                ...
                if (r21.z != 0) {
                  ...
                  r42.y = samp0[]..swiz;
                    r36.w = r37.x;
                    r34.x = dot(r36.xyzw, r23.xyzw);
                    r38.xyz = r37.yzw;
                    r34.y = dot(r38.xyzw, r23.xyzw);
                    ...
                    if (r15.w != 0) {
                      ...
                      while (true) {
                        ...
                        if (r26.w != 0) break;
                        r36.x = dot(icb[r22.y+0].xy, r26.xy);
                        r36.y = dot(icb[r22.y+0].yx, r26.xz);
                        r34.xy = r36.xy * r35.yy + r23.xy;
                        r26.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r34.xyz, r17.w).x;
                ...
                if (r21.z != 0) {
                  r21.z = r33.x * r5.w;
                  r21.z = r21.z * r21.x;
                  if (4 == 0) r22.y = 0; else if (4+16 < 32) {                   r22.y = (uint)r33.w << (32-(4 + 16)); r22.y = (uint)r22.y >> (32-4);                  } else r22.y = (uint)r33.w >> 16;
                  ...
                  r41.w = samp0[]..swiz;
                    ...
                    r33.xy = r22.ww / r38.xz;
                    r34.xy = float2(1,1) + -r33.xy;
                    r34.xy = cmp(r23.xy >= r34.xy);
                    r33.xy = cmp(r33.xy >= r23.xy);
                    r33.xy = (int2)r33.xy | (int2)r34.xy;
                    ...
                    r24.y = samp0[]..swiz;
                    // Known bad code for instruction (needs manual fix):
                                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r33.xy, r22.y, l(164), t12.xyxx
                    r33.x = samp0[]..swiz;
                    r33.y = samp0[]..swiz;
                      ...
                      if (r15.w != 0) {
                        ...
                        r34.z = (uint)r23.x;
                        r23.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r34.xyz, r22.y).x;
                      }
                      r22.y = r23.y * r23.y;
                      r22.y = r22.y * r23.y;
                    } else {
                    ...
                    if (4 == 0) r22.y = 0; else if (4+20 < 32) {                     r22.y = (uint)r33.w << (32-(4 + 20)); r22.y = (uint)r22.y >> (32-4);                    } else r22.y = (uint)r33.w >> 20;
                    r22.w = cmp(0 < (uint)r22.y);
                    r22.w = r22.w ? r5.x : 0;
                    if (r22.w != 0) {
                      r22.y = (int)r22.y + numLights;
                    ...
                    r22.w = samp0[]..swiz;
                    // Known bad code for instruction (needs manual fix):
                                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r33.xyzw, r22.y, l(68), t12.xyzw
                    r33.x = samp0[]..swiz;
                    r33.y = samp0[]..swiz;
                    r33.z = samp0[]..swiz;
                    r33.w = samp0[]..swiz;
                    // Known bad code for instruction (needs manual fix):
                                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r34.xyzw, r22.y, l(84), t12.xyzw
                    r34.x = samp0[]..swiz;
                    r34.y = samp0[]..swiz;
                    r34.z = samp0[]..swiz;
                    r34.w = samp0[]..swiz;
                    // Known bad code for instruction (needs manual fix):
                                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r35.xyzw, r22.y, l(100), t12.xyzw
                    r35.x = samp0[]..swiz;
                    r35.y = samp0[]..swiz;
                    r35.z = samp0[]..swiz;
                    r35.w = samp0[]..swiz;
                    // Known bad code for instruction (needs manual fix):
                                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r36.xyzw, r22.y, l(116), t12.xyzw
                    r36.x = samp0[]..swiz;
                    r36.y = samp0[]..swiz;
                    r36.z = samp0[]..swiz;
                    r36.w = samp0[]..swiz;
                    // Known bad code for instruction (needs manual fix):
                                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r37.xyzw, r22.y, l(132), t12.xyzw
                    r37.x = samp0[]..swiz;
                    r37.y = samp0[]..swiz;
                    r37.z = samp0[]..swiz;
                    r37.w = samp0[]..swiz;
                    // Known bad code for instruction (needs manual fix):
                                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r38.xyzw, r22.y, l(148), t12.xyzw
                    r38.x = samp0[]..swiz;
                    r38.y = samp0[]..swiz;
                    r38.z = samp0[]..swiz;
                    r38.w = samp0[]..swiz;
                      ...
                      r25.y = samp0[]..swiz;
                        ...
                        if (r15.w != 0) {
                          ...
                          r33.z = (uint)r23.x;
                          r23.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r33.xyz, r22.y).x;
                        }
                        r22.y = r23.z * r23.z;
                        r22.y = r22.y * r23.z;
                      } else {
                  ...
                  r22.y = r22.y + -r21.x;
                  r22.y = r6.w * r22.y + r21.x;
                  r22.y = r22.y * r17.w;
                  r20.y = cmp(0 < r20.y);
                  r24.xyz = r22.yyy * r32.xyz + r11.yzw;
                  r25.xyz = r39.xyz * r20.xxx + r6.xyz;
                  r20.x = dot(r25.xyz, r25.xyz);
                  r20.x = rsqrt(r20.x);
                  r25.xyz = r25.xyz * r20.xxx;
                  r20.x = dot(r25.xyz, r6.xyz);
                  r22.y = dot(r3.xyz, r25.xyz);
                  r22.w = abs(r22.y) * r5.w + -abs(r22.y);
                  r22.y = abs(r22.y) * r22.w + 1;
                  r21.x = r21.x * r7.z + r7.w;
                  r22.y = r22.y * r22.y;
                  r21.x = r22.y * r21.x;
                  r21.x = rcp(r21.x);
                  r21.x = r21.x * r21.z;
                  r17.w = r21.x * r17.w;
                  r17.w = 0.25 * r17.w;
                  r25.xyz = r17.www * r32.xyz + r31.xyz;
                  r20.x = saturate(1 + -r20.x);
                  r21.x = r20.x * r20.x;
                  r21.x = r21.x * r21.x;
                  r20.x = r21.x * r20.x;
                  r17.w = r20.x * r17.w;
                  r32.xyz = r17.www * r32.xyz + r18.xyz;
                  r11.yzw = r20.yyy ? r24.xyz : r11.yzw;
                  r18.xyz = r20.yyy ? r32.xyz : r18.xyz;
                  r31.xyz = r20.yyy ? r25.xyz : r31.xyz;
                }
              }
            }
            break;
  ...
  r5.x = 5 * r2.y;
  r5.y = r2.y * 5 + -2.5;
  r5.y = 0.400000006 * r5.y;
  r5.y = max(0, r5.y);
  r5.zw = -r2.yy * float2(10,5) + float2(6.85740995,7.08500004);
  r5.z = exp2(r5.z);
  r5.z = r7.x * r5.z;
  r6.x = r5.x * r2.y;
  ...
  r5.w = exp2(r5.w);
  r5.w = r7.x * r5.w;
  r5.yzw = float3(100,9.1368103,9.70808983) * r5.yzw;
  r5.z = max(r5.z, r5.w);
  r5.z = max(1.26815999, r5.z);
  r5.w = numRefProbes + -numOverrideProbes;
  r6.x = (int)r5.w & -32;
  r6.y = (int)r5.w + (int)-r6.x;
  r6.z = numRefProbes & -32;
  r6.w = (int)-r6.z + numRefProbes;
  r8.xy = float2(0,0);
  r9.w = 0;
  r11.yz = float2(0,1);
  r13.xy = float2(0,0);
  ...
  while (true) {
    ...
    r7.w = visibleProbes.Load(r9.xyzw).x;
    r8.z = cmp((int)r6.x == (int)r7.z);
    bitmask.w = ((~(-1 << r6.y)) << 0) & 0xffffffff;  r8.w = (((uint)0 << 0) & bitmask.w) | ((uint)r7.w & ~bitmask.w);
    r7.w = r8.z ? r8.w : r7.w;
    r8.z = cmp((int)r6.z == (int)r7.z);
    if (r6.w == 0) r8.w = 0; else if (r6.w+0 < 32) {     r8.w = (uint)r7.w << (32-(r6.w + 0)); r8.w = (uint)r8.w >> (32-r6.w);    } else r8.w = (uint)r7.w >> 0;
    r7.w = r8.z ? r8.w : r7.w;
    r8.z = (int)r7.z + numLights;
    r20.xyzw = r18.xyzw;
    r21.xyz = r19.yzw;
    r8.w = r7.w;
    while (true) {
      ...
      r9.y = 1 << (int)r9.x;
      r9.z = (int)r8.w & (int)r9.y;
      if (r9.z != 0) {
        r8.w = (int)r8.w ^ (int)r9.y;
        r9.y = (int)r8.z + (int)r9.x;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=80)(mixed,mixed,mixed,mixed) r22.xyzw, r9.y, l(0), t11.xyzw
      r22.x = samp0[]..swiz;
      r22.y = samp0[]..swiz;
      r22.z = samp0[]..swiz;
      r22.w = samp0[]..swiz;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=80)(mixed,mixed,mixed,mixed) r23.xy, r9.y, l(16), t11.xyxx
      r23.x = samp0[]..swiz;
      r23.y = samp0[]..swiz;
        ...
        r9.y = r22.z ? r9.y : 0;
        if (r9.y != 0) {
          r9.x = (int)r7.z + (int)r9.x;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r22.xyzw, r9.x, l(0), t15.wxyz
        r22.x = samp0[]..swiz;
        r22.y = samp0[]..swiz;
        r22.z = samp0[]..swiz;
        r22.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r9.yz, r9.x, l(96), t15.xxyx
        r9.y = samp0[]..swiz;
        r9.z = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r23.xyzw, r9.x, l(116), t15.zwxy
        r23.x = samp0[]..swiz;
        r23.y = samp0[]..swiz;
        r23.z = samp0[]..swiz;
        r23.w = samp0[]..swiz;
          ...
          if (6 == 0) r11.w = 0; else if (6+25 < 32) {           r11.w = (uint)r23.w << (32-(6 + 25)); r11.w = (uint)r11.w >> (32-6);          } else r11.w = (uint)r23.w >> 25;
        // Known bad code for instruction (needs manual fix):
        ...
        r28.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r31.xyzw, r10.x, l(64), t16.xyzw
        r31.x = samp0[]..swiz;
        r31.y = samp0[]..swiz;
        r31.z = samp0[]..swiz;
        r31.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r32.xyzw, r10.x, l(80), t16.xyzw
        r32.x = samp0[]..swiz;
        r32.y = samp0[]..swiz;
        r32.z = samp0[]..swiz;
        r32.w = samp0[]..swiz;
          ...
          r14.z = dot(r26.xyz, r24.xyz);
          r14.z = saturate(r14.z + r26.w);
          r13.w = r14.z * r13.w;
          r14.z = dot(r27.xyz, r24.xyz);
          r14.z = saturate(r14.z + r27.w);
          r13.w = r14.z * r13.w;
          r14.z = dot(r28.xyz, r24.xyz);
          r14.z = saturate(r14.z + r28.w);
          r13.w = r14.z * r13.w;
          r14.z = dot(r31.xyz, r24.xyz);
          r14.z = saturate(r14.z + r31.w);
          r13.w = r14.z * r13.w;
          r14.z = dot(r32.xyz, r24.xyz);
          r14.z = saturate(r14.z + r32.w);
          r11.x = r14.z * r13.w;
          r13.w = (int)r9.y & 1;
          r14.zw = r13.ww ? r11.xy : r11.zx;
          r11.x = r9.y;
          r25.xy = r14.zw;
          r13.w = 1;
          while (true) {
            r15.w = cmp((int)r13.w >= (int)r11.w);
            if (r15.w != 0) break;
            r15.w = (int)r10.x + (int)r13.w;
          // Known bad code for instruction (needs manual fix):
          ...
          r33.w = samp0[]..swiz;
            ...
            r15.w = r16.w * r15.w;
            r16.w = dot(r32.xyz, r24.xyz);
            r16.w = saturate(r16.w + r32.w);
            r15.w = r16.w * r15.w;
            r16.w = dot(r33.xyz, r24.xyz);
            r16.w = saturate(r16.w + r33.w);
            r25.x = r16.w * r15.w;
            r17.w = (uint)r11.x >> 2;
            if (1 == 0) r22.w = 0; else if (1+2 < 32) {             r22.w = (uint)r11.x << (32-(1 + 2)); r22.w = (uint)r22.w >> (32-1);            } else r22.w = (uint)r11.x >> 2;
            r24.w = (int)r17.w & 2;
            r25.z = max(r25.y, r25.x);
            r15.w = -r15.w * r16.w + 1;
            r15.w = r25.y * r15.w;
            r14.y = r24.w ? r15.w : r25.z;
            r25.xy = r22.ww ? r25.xy : r14.xy;
            r13.w = (int)r13.w + 1;
            r11.x = r17.w;
          }
          ...
          if (r10.x != 0) {
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r26.xyzw, r9.x, l(16), t15.xyzw
          r26.x = samp0[]..swiz;
          r26.y = samp0[]..swiz;
          r26.z = samp0[]..swiz;
          r26.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r27.xyzw, r9.x, l(32), t15.yxwz
          r27.x = samp0[]..swiz;
          r27.y = samp0[]..swiz;
          r27.z = samp0[]..swiz;
          r27.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r28.xyzw, r9.x, l(48), t15.xyzw
          r28.x = samp0[]..swiz;
          r28.y = samp0[]..swiz;
          r28.z = samp0[]..swiz;
          r28.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r31.xyzw, r9.x, l(64), t15.zwxy
          r31.x = samp0[]..swiz;
          r31.y = samp0[]..swiz;
          r31.z = samp0[]..swiz;
          r31.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r32.xyzw, r9.x, l(80), t15.xyzw
          r32.x = samp0[]..swiz;
          r32.y = samp0[]..swiz;
          r32.z = samp0[]..swiz;
          r32.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r33.xyzw, r9.x, l(132), t15.zwxy
          r33.x = samp0[]..swiz;
          r33.y = samp0[]..swiz;
          r33.z = samp0[]..swiz;
          r33.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r34.xyzw, r9.x, l(148), t15.zwxy
          r34.x = samp0[]..swiz;
          r34.y = samp0[]..swiz;
          r34.z = samp0[]..swiz;
          r34.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r35.xyzw, r9.x, l(164), t15.zwxy
          r35.x = samp0[]..swiz;
          r35.y = samp0[]..swiz;
          r35.z = samp0[]..swiz;
          r35.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r36.xyzw, r9.x, l(180), t15.zwxy
          r36.x = samp0[]..swiz;
          r36.y = samp0[]..swiz;
          r36.z = samp0[]..swiz;
          r36.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r37.xyzw, r9.x, l(196), t15.xyzw
          r37.x = samp0[]..swiz;
          r37.y = samp0[]..swiz;
          r37.z = samp0[]..swiz;
          r37.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r38.xy, r9.x, l(212), t15.xyxx
          r38.x = samp0[]..swiz;
          r38.y = samp0[]..swiz;
            r21.z = r25.y * r9.z + r21.z;
            r9.x = r9.y * r23.z;
            r23.z = r33.z;
            r9.y = dot(r12.xyz, r23.xyz);
            r9.z = dot(r24.xyz, r23.xyz);
            r9.z = r9.z + -r33.w;
            r10.x = cmp(r9.z >= 0);
            r9.z = max(abs(r9.z), r5.y);
            r9.z = r10.x ? r9.z : -r9.z;
            r9.y = max(1.00000001e-07, -r9.y);
            r9.y = r9.z / r9.y;
            r9.y = min(131072, abs(r9.y));
            r33.z = r34.z;
            r9.z = dot(r12.xyz, r33.xyz);
            r10.x = dot(r24.xyz, r33.xyz);
            r10.x = r10.x + -r34.w;
            r11.x = cmp(r10.x >= 0);
            r10.x = max(abs(r10.x), r5.y);
            r10.x = r11.x ? r10.x : -r10.x;
            r9.z = max(1.00000001e-07, -r9.z);
            r9.z = r10.x / r9.z;
            r9.y = min(r9.y, abs(r9.z));
            r34.z = r35.z;
            r9.z = dot(r12.xyz, r34.xyz);
            ...
            r9.y = min(r9.y, abs(r9.z));
            r35.z = r36.z;
            r9.z = dot(r12.xyz, r35.xyz);
            r10.x = dot(r24.xyz, r35.xyz);
            r10.x = r10.x + -r36.w;
            r11.x = cmp(r10.x >= 0);
            r10.x = max(abs(r10.x), r5.y);
            r10.x = r11.x ? r10.x : -r10.x;
            ...
            r9.y = min(r9.y, abs(r9.z));
            r36.z = r37.x;
            r9.z = dot(r12.xyz, r36.xyz);
            r10.x = dot(r24.xyz, r36.xyz);
            r10.x = r10.x + -r37.y;
            r11.x = cmp(r10.x >= 0);
            r10.x = max(abs(r10.x), r5.y);
            r10.x = r11.x ? r10.x : -r10.x;
            ...
            r9.y = min(r9.y, abs(r9.z));
            r38.zw = r37.zw;
            r9.z = dot(r12.zxy, r38.xzw);
            r10.x = dot(r24.zxy, r38.xzw);
            r10.x = r10.x + -r38.y;
            r11.x = cmp(r10.x >= 0);
            r10.x = max(abs(r10.x), r5.y);
            r10.x = r11.x ? r10.x : -r10.x;
            ...
            r14.yzw = r12.xyz * r9.yyy + r14.yzw;
            r9.z = dot(r14.yzw, r14.yzw);
            r9.z = sqrt(r9.z);
            r9.y = r9.y / r9.z;
            r9.y = r9.y + r9.y;
            r9.y = sqrt(r9.y);
            r9.y = r2.y * 5 + r9.y;
            r9.y = -0.844799995 + r9.y;
            r22.y = r26.z;
            r22.z = r27.x;
            r33.x = dot(r14.yzw, r22.xyz);
            r23.xy = r26.xw;
            r23.z = r27.w;
            r33.y = dot(r14.yzw, r23.xyz);
            r27.x = r26.y;
            r33.z = dot(r14.yzw, r27.xyz);
            if (9 == 0) r9.z = 0; else if (9+16 < 32) {             r9.z = (uint)r23.w << (32-(9 + 16)); r9.z = (uint)r9.z >> (32-9);            } else r9.z = (uint)r23.w >> 16;
            r33.w = (uint)r9.z;
            r14.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r33.xyzw, r9.y).xyz;
            ...
            r33.y = dot(r3.xyz, r23.xyz);
            r33.z = dot(r3.xyz, r27.xyz);
            ...
            r25.xzw = r33.xyz * r33.xyz;
            r25.xzw = r25.xzw * r9.xxx;
            r16.z = r22.y ? 0 : 0.5;
            ...
            r9.y = dot(r24.xyz, float3(0.212599993,0.715200007,0.0722000003));
            r20.xyz = r22.xyz * r23.xyz + r20.xyz;
            r9.z = r9.y * r5.z;
            r14.yzw = r14.yzw * r9.xxx;
            r9.x = dot(r14.yzw, float3(0.212599993,0.715200007,0.0722000003));
            r9.x = r5.z * r9.y + r9.x;
            r9.x = r9.z / r9.x;
            r22.x = r20.w;
            r22.yz = r21.xy;
            r21.xyw = r14.zwy * r9.xxx + r22.yzx;
            r20.w = r21.w;
          }
        }
      }
  ...
  if (r6.z != 0) {
    ...
    r6.w = 0;
    while (true) {
      r7.z = cmp((uint)r6.w >= (uint)r5.w);
      if (r7.z != 0) break;
      r8.z = (uint)r6.w >> 5;
      r9.xyz = (int3)r8.xyz + (int3)r15.xyz;
      r7.z = visibleProbes.Load(r9.xyzw).x;
      r7.w = cmp((int)r6.x == (int)r6.w);
      if (r6.y == 0) r8.z = 0; else if (r6.y+0 < 32) {       r8.z = (uint)r7.z << (32-(r6.y + 0)); r8.z = (uint)r8.z >> (32-r6.y);      } else r8.z = (uint)r7.z >> 0;
      r7.z = r7.w ? r8.z : r7.z;
      ...
      while (true) {
        ...
        r11.w = 1 << (int)r10.x;
        r13.w = (int)r8.w & (int)r11.w;
        if (r13.w != 0) {
          r8.w = (int)r8.w ^ (int)r11.w;
          r11.w = (int)r7.w + (int)r10.x;
        // Known bad code for instruction (needs manual fix):
        ...
        r24.y = samp0[]..swiz;
          ...
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r23.xyzw, r10.x, l(0), t15.wxyz
          r23.x = samp0[]..swiz;
          r23.y = samp0[]..swiz;
          r23.z = samp0[]..swiz;
          r23.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r14.zw, r10.x, l(96), t15.xxxy
          r14.z = samp0[]..swiz;
          r14.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r24.xyzw, r10.x, l(116), t15.zwxy
          r24.x = samp0[]..swiz;
          r24.y = samp0[]..swiz;
          r24.z = samp0[]..swiz;
          r24.w = samp0[]..swiz;
            r25.xyz = v7.xyz + -r23.yzw;
            r11.w = (int)r24.w & 0x0000ffff;
            if (6 == 0) r13.w = 0; else if (6+25 < 32) {             r13.w = (uint)r24.w << (32-(6 + 25)); r13.w = (uint)r13.w >> (32-6);            } else r13.w = (uint)r24.w >> 25;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r26.xyzw, r11.w, l(0), t16.xyzw
          r26.x = samp0[]..swiz;
          r26.y = samp0[]..swiz;
          r26.z = samp0[]..swiz;
          r26.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r27.xyzw, r11.w, l(16), t16.xyzw
          r27.x = samp0[]..swiz;
          r27.y = samp0[]..swiz;
          r27.z = samp0[]..swiz;
          r27.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r28.xyzw, r11.w, l(32), t16.xyzw
          r28.x = samp0[]..swiz;
          r28.y = samp0[]..swiz;
          r28.z = samp0[]..swiz;
          r28.w = samp0[]..swiz;
          ...
          r33.w = samp0[]..swiz;
            ...
            r35.w = samp0[]..swiz;
              ...
              r16.w = r17.w * r16.w;
              r17.w = dot(r34.xyz, r25.xyz);
              r17.w = saturate(r17.w + r34.w);
              r16.w = r17.w * r16.w;
              r17.w = dot(r35.xyz, r25.xyz);
              ...
              r16.w = -r16.w * r17.w + 1;
              r16.w = r27.y * r16.w;
              r14.y = r25.w ? r16.w : r26.z;
              r27.xy = r23.ww ? r27.xy : r14.xy;
              r15.w = (int)r15.w + 1;
              r11.x = r21.w;
            }
            r11.x = saturate(r27.y + -r8.z);
            r11.w = r11.x * r14.w;
            r13.w = cmp(0 < r11.w);
            if (r13.w != 0) {
            // Known bad code for instruction (needs manual fix):
            ...
            r26.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r28.xyzw, r10.x, l(32), t15.yxwz
            r28.x = samp0[]..swiz;
            r28.y = samp0[]..swiz;
            r28.z = samp0[]..swiz;
            r28.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r31.xyzw, r10.x, l(48), t15.xyzw
            r31.x = samp0[]..swiz;
            r31.y = samp0[]..swiz;
            r31.z = samp0[]..swiz;
            r31.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r32.xyzw, r10.x, l(64), t15.zwxy
            r32.x = samp0[]..swiz;
            r32.y = samp0[]..swiz;
            r32.z = samp0[]..swiz;
            r32.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r33.xyzw, r10.x, l(80), t15.xyzw
            r33.x = samp0[]..swiz;
            r33.y = samp0[]..swiz;
            r33.z = samp0[]..swiz;
            r33.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r34.xyzw, r10.x, l(132), t15.zwxy
            r34.x = samp0[]..swiz;
            r34.y = samp0[]..swiz;
            r34.z = samp0[]..swiz;
            r34.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r35.xyzw, r10.x, l(148), t15.zwxy
            r35.x = samp0[]..swiz;
            r35.y = samp0[]..swiz;
            r35.z = samp0[]..swiz;
            r35.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r36.xyzw, r10.x, l(164), t15.zwxy
            r36.x = samp0[]..swiz;
            r36.y = samp0[]..swiz;
            r36.z = samp0[]..swiz;
            r36.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r37.xyzw, r10.x, l(180), t15.zwxy
            r37.x = samp0[]..swiz;
            r37.y = samp0[]..swiz;
            r37.z = samp0[]..swiz;
            r37.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r38.xyzw, r10.x, l(196), t15.xyzw
            r38.x = samp0[]..swiz;
            r38.y = samp0[]..swiz;
            r38.z = samp0[]..swiz;
            r38.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r39.xy, r10.x, l(212), t15.xyxx
            r39.x = samp0[]..swiz;
            r39.y = samp0[]..swiz;
              r22.w = r11.x * r14.w + r22.w;
              r10.x = r11.w * r24.z;
              r24.z = r34.z;
              r11.x = dot(r12.xyz, r24.xyz);
              r11.w = dot(r25.xyz, r24.xyz);
              r11.w = r11.w + -r34.w;
              r13.w = cmp(r11.w >= 0);
              r11.w = max(abs(r11.w), r5.y);
              ...
              r11.x = min(r11.x, abs(r11.w));
              r39.zw = r38.zw;
              r11.w = dot(r12.zxy, r39.xzw);
              r13.w = dot(r25.zxy, r39.xzw);
              r13.w = r13.w + -r39.y;
              r14.y = cmp(r13.w >= 0);
              r13.w = max(abs(r13.w), r5.y);
              r13.w = r14.y ? r13.w : -r13.w;
              ...
              r14.yzw = r12.xyz * r11.xxx + r14.yzw;
              ...
              r23.y = r26.z;
              r23.z = r28.x;
              r34.x = dot(r14.yzw, r23.xyz);
              r24.xy = r26.xw;
              r24.z = r28.w;
              r34.y = dot(r14.yzw, r24.xyz);
              r28.x = r26.y;
              r34.z = dot(r14.yzw, r28.xyz);
              if (9 == 0) r11.w = 0; else if (9+16 < 32) {               r11.w = (uint)r24.w << (32-(9 + 16)); r11.w = (uint)r11.w >> (32-9);              } else r11.w = (uint)r24.w >> 16;
              r34.w = (uint)r11.w;
              r14.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r34.xyzw, r11.x).xyz;
              r26.x = dot(r25.xyz, r23.xyz);
              r26.y = dot(r25.xyz, r24.xyz);
              r26.z = dot(r25.xyz, r28.xyz);
              r25.xyz = saturate(r26.xyz * r31.xyz + float3(0.5,0.5,0.5));
              r32.z = r33.x;
  ...
  r5.yzw = r18.xyz * r2.yyy;
  r6.xyz = r19.xyz * r2.yyy;
  r6.w = cmp(r19.w < 0.99000001);
  if (r6.w != 0) {
    r6.w = 1 + -r19.w;
    r7.z = sunConstants.globalProbeExposure * r6.w;
    r8.xyz = -globalProbeConstants.data[0].xyz + v7.xyz;
    ...
    r8.xyz = r8.xyz * r13.zzz + r11.xyz;
    r3.w = 0;
    r9.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r3.xyzw, 6).xyz;
    r8.xyz = r9.xyz * r8.xyz;
    r3.z = dot(r8.xyz, float3(0.212599993,0.715200007,0.0722000003));
    r5.yzw = r18.xyz * r2.yyy + r8.xyz;
    r12.w = 0;
    r8.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r12.xyzw, r5.x).xyz;
    r2.y = sunConstants.globalProbeExposure * r6.w + -r3.z;
    r2.y = r7.y * r2.y + r3.z;
    r6.xyz = r8.xyz * r2.yyy + r6.xyz;
  }
  r5.xyz = r5.yzw * r2.xxx + r10.yzw;
  r3.zw = r7.xy * float2(0.984375,0.984375) + float2(0.0078125,0.0078125);
  r3.zw = gEnvBRDFGeneric.SampleLevel(samplerLinear_s, r3.zw, 0).xy;
  r6.xyz = r6.xyz * r2.xxx;
  r7.xyz = r6.xyz * r3.zzz + r29.xyz;
  r6.xyz = r6.xyz * r3.www + r30.xyz;
  r7.xyz = float3(0.959999979,0.959999979,0.959999979) * r7.xyz;
  r6.xyz = r6.xyz * float3(0.0399999991,0.0399999991,0.0399999991) + r7.xyz;
  r0.xyz = r5.xyz * r0.xyz + r6.xyz;
  r5.xy = (int2)v0.xy;
  r5.zw = float2(0,0);
  r2.x = floatZSampler.Load(r5.xyz).x;
  r2.y = cmp(r2.x >= 0.984375);
  r3.z = 1.01587307 * r2.x;
  r2.x = r2.x * 64 + -63;
  r2.x = r2.y ? r2.x : r3.z;
  r2.x = max(9.99999994e-09, r2.x);
  r2.x = rcp(r2.x);
  r2.y = cmp(zFeather == 0.000000);
  r3.z = 1 / zFeather;
  r2.y = r2.y ? 60000 : r3.z;
  r2.x = r2.x + -r2.w;
  r2.x = saturate(r2.x * r2.y);
  r2.y = cmp(r2.x < 1);
  if (r2.y != 0) {
    r2.y = edgeColorMap.Sample(colorSampler_s, v2.xy).w;
    r5.xyzw = edgeEmissiveMap.Sample(colorSampler_s, v2.xy).xyzw;
    r5.xyz = r5.xyz * r5.www;
    r0.w = r0.w * w1.x + -r2.y;
    r0.w = r2.x * r0.w + r2.y;
    r6.xyzw = -r5.xyzw + r4.xyzw;
    r4.xyzw = r2.xxxx * r6.xyzw + r5.xyzw;
  ...
  r3.xyz = resolvedPostSun.Sample(colorSampler_s, r2.yw).xyz;
  r4.xyz = relHDRExposure.xxx * r3.xyz;
  r0.w = saturate(r0.w * r2.z + r1.w);
