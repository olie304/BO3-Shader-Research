...
//   float emissiveFalloffScale;        // Offset:  244 Size:     4 [unused]
//   float emissiveFalloffPow;          // Offset:  248 Size:     4 [unused]
//   float emissiveFalloffDir;          // Offset:  252 Size:     4 [unused]
//   float shieldOpacity;               // Offset:  256 Size:     4 [unused]
//   float zFeather;                    // Offset:  260 Size:     4 [unused]
//   float distortionAmount;            // Offset:  264 Size:     4 [unused]
//
// }
//
