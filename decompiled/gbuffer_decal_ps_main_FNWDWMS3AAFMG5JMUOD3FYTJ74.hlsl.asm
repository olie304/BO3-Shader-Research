...
mul r1.w, r0.y, r1.w
sample_indexable(texture2d)(float,float,float,float) r2.x, r0.zwzz, t9.xyzw, s2
add r2.yzw, cb0[10].xxyz, l(0.000000, -0.040000, -0.040000, -0.040000)
mad r2.yzw, r2.xxxx, r2.yyzw, l(0.000000, 0.040000, 0.040000, 0.040000)
add_sat r2.x, -r2.x, l(1.000000)
mul r1.xyz, r1.xyzx, r2.xxxx
sample_indexable(texture2d)(float,float,float,float) r3.z, r0.zwzz, t12.yzxw, s4
sample_indexable(texture2d)(float,float,float,float) r2.x, r0.zwzz, t11.xyzw, s2
add r4.x, -cb0[11].x, cb0[11].y
mad r2.x, r2.x, r4.x, cb0[11].x
...
mul r4.yzw, r0.wwww, r7.xxyz
mad r4.yzw, r6.xxyz, r0.zzzz, r4.yyzw
...
mul r1.zw, r5.xxxz, l(0.000000, 0.000000, -1.22474492, 1.22474492)
mul r6.xyz, r5.xyzx, l(0.70710677, -1.41421354, 0.70710677, 0.000000)
dp3 r6.x, r4.xyzx, r6.xyzx
dp2 r6.y, r4.xzxx, r1.zwzz
dp3 r0.z, r4.xyzx, r5.xyzx
add r0.z, |r0.z|, l(1.000000)
rsq r0.z, r0.z
mul r1.zw, r0.zzzz, r6.xxxy
mad r4.xy, r1.zwzz, l(0.58823532, 0.58823532, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
ge r0.y, r0.y, l(0.500000)
movc r0.y, r0.y, l(0.500000), l(0.00146628)
mad r4.z, r2.x, l(0.49755621), r0.y
and r0.yzw, r0.wwww, r4.xxyz
mul o1.xyz, r0.xxxx, r0.yzwy
add r4.y, -r2.w, r2.y
mad r0.y, r4.y, l(0.500000), r2.w
add r4.z, -r0.y, r2.z
