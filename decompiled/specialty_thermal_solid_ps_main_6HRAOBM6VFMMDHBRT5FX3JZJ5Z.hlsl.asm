...
sample_indexable(texture2d)(float,float,float,float) r1.xy, v1.yzyy, t21.xyzw, s1
...
sample_indexable(texture2d)(float,float,float,float) r0.y, v1.yzyy, t22.yxzw, s3
mul o0.x, r0.y, r0.x
