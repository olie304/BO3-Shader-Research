...
if_nz r1.w
  ...
  dp3_sat r1.w, r1.xyzx, r10.xyzx
  dp3_sat r4.x, r10.xyzx, r6.xyzx
  mul r4.y, r1.w, r1.w
...
ge r1.z, r0.z, l(0.984375)
mul r1.w, r0.z, l(1.01587307)
mad r0.z, r0.z, l(64.000000), l(-63.000000)
movc r0.z, r1.z, r0.z, r1.w
...
mad r1.xyz, r5.xxxx, r1.xyzx, r10.xyzx
mad r3.xyz, r3.xzwx, r7.xyzx, -r1.xyzx
mad r1.xyz, r8.wwww, r3.xyzx, r1.xyzx
...
mad r1.xyz, cb0[22].yzwy, r7.xyzx, -r0.xzwx
mad r1.xyz, r5.wwww, r1.xyzx, r0.xzwx
movc r0.xzw, cb0[28].yyyy, r1.xxyz, r0.xxzw
if_nz cb2[52].y
  if_nz cb2[53].y
    and r1.xy, r0.yyyy, r4.yxyy
    switch cb2[53].y
      case l(1)
      mov r1.x, l(1)
      break 
