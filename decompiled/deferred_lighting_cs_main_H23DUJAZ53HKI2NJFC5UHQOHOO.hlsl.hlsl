...
r0.y = samplerLinear[]..swiz;
  ...
  while (true) {
    ...
    if (r6.w != 0) {
      ...
      if (r1.z != 0) {
        ...
        r13.yzw = refProbeConstantsCB[r5.w].data[0].xyz + eyeOffset.xyz;
        GBufferDiffuseColor[viewID].r6.w = u2.xyzw;
      }
      r21.w = (int)r20.w + 1;
      r13.yzw = -refProbeConstantsCB[r5.w].data[0].xyz + r10.xyz;
      ...
      while (true) {
        ...
        r15.w = r22.x * r15.w;
        r17.w = dot(refProbeAttenuationConstantsCB[r10.w].data[1].xyz, r13.yzw);
        r17.w = saturate(refProbeAttenuationConstantsCB[r10.w].data[1].w + r17.w);
        r15.w = r17.w * r15.w;
        r17.w = dot(refProbeAttenuationConstantsCB[r10.w].data[2].xyz, r13.yzw);
        r17.w = saturate(refProbeAttenuationConstantsCB[r10.w].data[2].w + r17.w);
        r15.w = r17.w * r15.w;
        r17.w = dot(refProbeAttenuationConstantsCB[r10.w].data[3].xyz, r13.yzw);
        r17.w = saturate(refProbeAttenuationConstantsCB[r10.w].data[3].w + r17.w);
        r15.w = r17.w * r15.w;
        r17.w = dot(refProbeAttenuationConstantsCB[r10.w].data[4].xyz, r13.yzw);
        r17.w = saturate(refProbeAttenuationConstantsCB[r10.w].data[4].w + r17.w);
        r15.w = r17.w * r15.w;
        r17.w = dot(refProbeAttenuationConstantsCB[r10.w].data[5].xyz, r13.yzw);
        r10.w = saturate(refProbeAttenuationConstantsCB[r10.w].data[5].w + r17.w);
        r22.x = r15.w * r10.w;
        r17.w = (uint)r8.w >> 2;
        if (1 == 0) r18.w = 0; else if (1+2 < 32) {         r18.w = (uint)r8.w << (32-(1 + 2)); r18.w = (uint)r18.w >> (32-1);        } else r18.w = (uint)r8.w >> 2;
        r22.z = (int)r17.w & 2;
        r22.w = max(r22.y, r22.x);
        r10.w = -r15.w * r10.w + 1;
        r10.w = r22.y * r10.w;
        r16.y = r22.z ? r10.w : r22.w;
        r22.xy = r18.ww ? r22.xy : r16.xy;
        r9.w = (int)r9.w + 1;
        r8.w = r17.w;
      }
      r22.y = saturate(r22.y);
      r6.w = refProbeConstantsCB[r5.w].data[6].y * r22.y;
      r7.w = cmp(0 < r6.w);
      if (r7.w != 0) {
        r7.w = (int)r21.w & 7;
        r8.w = (int)r7.w + -1;
        ...
        r8.w = r1.z ? r8.w : 0;
        if (r8.w != 0) {
          r14.xw = mad((int2)r7.ww, int2(20,20), int2(860,876));
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r7.w, cb2[52].x, r14.x, u2.xxxx
        ...
        r20.w = (int)r20.w + 257;
        r20.z = r22.y * refProbeConstantsCB[r5.w].data[6].y + r20.z;
        r6.w = refProbeConstantsCB[r5.w].data[7].y * r6.w;
        r23.x = refProbeConstantsCB[r5.w].data[7].w;
        r23.yz = refProbeConstantsCB[r5.w].data[8].xy;
        r7.w = dot(r12.xyz, r23.xyz);
        r8.w = dot(r13.yzw, r23.xyz);
        r8.w = -refProbeConstantsCB[r5.w].data[8].z + r8.w;
        r9.w = cmp(r8.w >= 0);
        ...
        r23.x = refProbeConstantsCB[r5.w].data[8].w;
        r23.yz = refProbeConstantsCB[r5.w].data[9].xy;
        r8.w = dot(r12.xyz, r23.xyz);
        r9.w = dot(r13.yzw, r23.xyz);
        r9.w = -refProbeConstantsCB[r5.w].data[9].z + r9.w;
        r10.w = cmp(r9.w >= 0);
        ...
        r23.x = refProbeConstantsCB[r5.w].data[9].w;
        r23.yz = refProbeConstantsCB[r5.w].data[10].xy;
        r8.w = dot(r12.xyz, r23.xyz);
        r9.w = dot(r13.yzw, r23.xyz);
        r9.w = -refProbeConstantsCB[r5.w].data[10].z + r9.w;
        r10.w = cmp(r9.w >= 0);
        r9.w = max(abs(r9.w), r2.w);
        r9.w = r10.w ? r9.w : -r9.w;
        r8.w = max(1.00000001e-07, -r8.w);
        r8.w = r9.w / r8.w;
        r7.w = min(abs(r8.w), r7.w);
        r23.x = refProbeConstantsCB[r5.w].data[10].w;
        r23.yz = refProbeConstantsCB[r5.w].data[11].xy;
        r8.w = dot(r12.xyz, r23.xyz);
        r9.w = dot(r13.yzw, r23.xyz);
        r9.w = -refProbeConstantsCB[r5.w].data[11].z + r9.w;
        r10.w = cmp(r9.w >= 0);
        r9.w = max(abs(r9.w), r2.w);
        r9.w = r10.w ? r9.w : -r9.w;
        r8.w = max(1.00000001e-07, -r8.w);
        r8.w = r9.w / r8.w;
        r7.w = min(abs(r8.w), r7.w);
        r23.x = refProbeConstantsCB[r5.w].data[11].w;
        r23.yz = refProbeConstantsCB[r5.w].data[12].xy;
        r8.w = dot(r12.xyz, r23.xyz);
        r9.w = dot(r13.yzw, r23.xyz);
        r9.w = -refProbeConstantsCB[r5.w].data[12].z + r9.w;
        r10.w = cmp(r9.w >= 0);
        r9.w = max(abs(r9.w), r2.w);
        r9.w = r10.w ? r9.w : -r9.w;
        r8.w = max(1.00000001e-07, -r8.w);
        r8.w = r9.w / r8.w;
        r7.w = min(abs(r8.w), r7.w);
        r23.x = refProbeConstantsCB[r5.w].data[12].w;
        r23.yz = refProbeConstantsCB[r5.w].data[13].xy;
        r8.w = dot(r12.xyz, r23.xyz);
        r9.w = dot(r13.yzw, r23.xyz);
        r9.w = -refProbeConstantsCB[r5.w].data[13].z + r9.w;
        r10.w = cmp(r9.w >= 0);
        r9.w = max(abs(r9.w), r2.w);
        r9.w = r10.w ? r9.w : -r9.w;
        r8.w = max(1.00000001e-07, -r8.w);
        r8.w = r9.w / r8.w;
        r7.w = min(abs(r8.w), r7.w);
        r23.x = refProbeConstantsCB[r5.w].data[3].w + r13.y;
        r23.yz = refProbeConstantsCB[r5.w].data[4].xy + r13.zw;
        r22.xzw = r12.xyz * r7.www + r23.xyz;
        r8.w = dot(r22.xzw, r22.xzw);
        r8.w = sqrt(r8.w);
        r7.w = r7.w / r8.w;
        r7.w = r7.w + r7.w;
        r7.w = sqrt(r7.w);
        ...
        r23.x = refProbeConstantsCB[r5.w].data[0].w;
        r23.y = refProbeConstantsCB[r5.w].data[1].z;
        r23.z = refProbeConstantsCB[r5.w].data[2].y;
        r24.x = dot(r22.xzw, r23.xyz);
        r25.xy = refProbeConstantsCB[r5.w].data[1].xw;
        r25.z = refProbeConstantsCB[r5.w].data[2].z;
        r24.y = dot(r22.xzw, r25.xyz);
        r26.x = refProbeConstantsCB[r5.w].data[1].y;
        r26.yz = refProbeConstantsCB[r5.w].data[2].xw;
        r24.z = dot(r22.xzw, r26.xyz);
        if (9 == 0) r8.w = 0; else if (9+16 < 32) {         r8.w = (uint)refProbeConstantsCB[r5.w].data[7].z << (32-(9 + 16)); r8.w = (uint)r8.w >> (32-9);        } else r8.w = (uint)refProbeConstantsCB[r5.w].data[7].z >> 16;
        r24.w = (uint)r8.w;
        r22.xzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r24.xyzw, r7.w).xyz;
        r27.xyz = (int3)r22.xzw & int3(-2147483648,-2147483648,-2147483648);
        r27.xyz = cmp((int3)r27.xyz == int3(2139095040,2139095040,2139095040));
        r7.w = (int)r27.y | (int)r27.x;
        r7.w = (int)r27.z | (int)r7.w;
        r22.xzw = r7.www ? float3(1,1,0) : r22.xzw;
        r27.x = dot(r13.yzw, r23.xyz);
        r27.y = dot(r13.yzw, r25.xyz);
        r27.z = dot(r13.yzw, r26.xyz);
        r13.yzw = saturate(r27.xyz * refProbeConstantsCB[r5.w].data[3].xyz + float3(0.5,0.5,0.5));
        r27.xy = refProbeConstantsCB[r5.w].data[4].zw * r13.yz;
        r27.z = refProbeConstantsCB[r5.w].data[5].x * r13.w;
        r13.yzw = refProbeConstantsCB[r5.w].data[5].yzw + r27.xyz;
  ...
  while (true) {
    ...
    if (r6.w != 0) {
      ...
      while (true) {
        ...
        r10.w = -r15.w * r10.w + 1;
        r10.w = r24.y * r10.w;
        r16.w = r21.w ? r10.w : r22.w;
        r24.xy = r18.ww ? r24.xy : r16.zw;
        r9.w = (int)r9.w + 1;
        r8.w = r17.w;
      }
      r6.w = saturate(r24.y + -r20.z);
      r7.w = refProbeConstantsCB[r5.w].data[6].y * r6.w;
      r8.w = cmp(0 < r7.w);
      if (r8.w != 0) {
        r8.w = (int)r23.y & 31;
        r9.w = (int)r8.w + -1;
        ...
        r16.y = (int)r16.y + 257;
        r16.x = r6.w * refProbeConstantsCB[r5.w].data[6].y + r16.x;
        r6.w = refProbeConstantsCB[r5.w].data[7].y * r7.w;
        r25.x = refProbeConstantsCB[r5.w].data[7].w;
        r25.yz = refProbeConstantsCB[r5.w].data[8].xy;
        r7.w = dot(r12.xyz, r25.xyz);
        r8.w = dot(r13.yzw, r25.xyz);
        r8.w = -refProbeConstantsCB[r5.w].data[8].z + r8.w;
        r9.w = cmp(r8.w >= 0);
        r8.w = max(abs(r8.w), r2.w);
        r8.w = r9.w ? r8.w : -r8.w;
        ...
        r7.w = r8.w / r7.w;
        r7.w = min(131072, abs(r7.w));
        r25.x = refProbeConstantsCB[r5.w].data[8].w;
        r25.yz = refProbeConstantsCB[r5.w].data[9].xy;
        ...
        r8.w = r9.w / r8.w;
        r7.w = min(abs(r8.w), r7.w);
        r25.x = refProbeConstantsCB[r5.w].data[9].w;
        r25.yz = refProbeConstantsCB[r5.w].data[10].xy;
        r8.w = dot(r12.xyz, r25.xyz);
        r9.w = dot(r13.yzw, r25.xyz);
        r9.w = -refProbeConstantsCB[r5.w].data[10].z + r9.w;
        r10.w = cmp(r9.w >= 0);
        ...
        r8.w = r9.w / r8.w;
        r7.w = min(abs(r8.w), r7.w);
        r25.x = refProbeConstantsCB[r5.w].data[10].w;
        r25.yz = refProbeConstantsCB[r5.w].data[11].xy;
        r8.w = dot(r12.xyz, r25.xyz);
        r9.w = dot(r13.yzw, r25.xyz);
        r9.w = -refProbeConstantsCB[r5.w].data[11].z + r9.w;
        r10.w = cmp(r9.w >= 0);
        ...
        r8.w = r9.w / r8.w;
        r7.w = min(abs(r8.w), r7.w);
        r25.x = refProbeConstantsCB[r5.w].data[11].w;
        r25.yz = refProbeConstantsCB[r5.w].data[12].xy;
        r8.w = dot(r12.xyz, r25.xyz);
        r9.w = dot(r13.yzw, r25.xyz);
        r9.w = -refProbeConstantsCB[r5.w].data[12].z + r9.w;
        r10.w = cmp(r9.w >= 0);
        ...
        r8.w = r9.w / r8.w;
        r7.w = min(abs(r8.w), r7.w);
        r25.x = refProbeConstantsCB[r5.w].data[12].w;
        r25.yz = refProbeConstantsCB[r5.w].data[13].xy;
        r8.w = dot(r12.xyz, r25.xyz);
        r9.w = dot(r13.yzw, r25.xyz);
        r9.w = -refProbeConstantsCB[r5.w].data[13].z + r9.w;
        r10.w = cmp(r9.w >= 0);
        ...
        r8.w = r9.w / r8.w;
        r7.w = min(abs(r8.w), r7.w);
        r25.x = refProbeConstantsCB[r5.w].data[3].w + r13.y;
        r25.yz = refProbeConstantsCB[r5.w].data[4].xy + r13.zw;
        r24.xzw = r12.xyz * r7.www + r25.xyz;
        r8.w = dot(r24.xzw, r24.xzw);
        r8.w = sqrt(r8.w);
        r7.w = r7.w / r8.w;
        r7.w = r7.w + r7.w;
        r7.w = sqrt(r7.w);
        r7.w = r1.w * 5 + r7.w;
        r7.w = -0.844799995 + r7.w;
        r25.x = refProbeConstantsCB[r5.w].data[0].w;
        r25.y = refProbeConstantsCB[r5.w].data[1].z;
        r25.z = refProbeConstantsCB[r5.w].data[2].y;
        r26.x = dot(r24.xzw, r25.xyz);
        r27.xy = refProbeConstantsCB[r5.w].data[1].xw;
        r27.z = refProbeConstantsCB[r5.w].data[2].z;
        r26.y = dot(r24.xzw, r27.xyz);
        r28.x = refProbeConstantsCB[r5.w].data[1].y;
        r28.yz = refProbeConstantsCB[r5.w].data[2].xw;
        r26.z = dot(r24.xzw, r28.xyz);
        if (9 == 0) r8.w = 0; else if (9+16 < 32) {         r8.w = (uint)refProbeConstantsCB[r5.w].data[7].z << (32-(9 + 16)); r8.w = (uint)r8.w >> (32-9);        } else r8.w = (uint)refProbeConstantsCB[r5.w].data[7].z >> 16;
        r26.w = (uint)r8.w;
        r24.xzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r26.xyzw, r7.w).xyz;
        r29.xyz = (int3)r24.xzw & int3(-2147483648,-2147483648,-2147483648);
        r29.xyz = cmp((int3)r29.xyz == int3(2139095040,2139095040,2139095040));
        r7.w = (int)r29.y | (int)r29.x;
        r7.w = (int)r29.z | (int)r7.w;
        r24.xzw = r7.www ? float3(1,1,0) : r24.xzw;
        r29.x = dot(r13.yzw, r25.xyz);
        r29.y = dot(r13.yzw, r27.xyz);
        r29.z = dot(r13.yzw, r28.xyz);
        r13.yzw = saturate(r29.xyz * refProbeConstantsCB[r5.w].data[3].xyz + float3(0.5,0.5,0.5));
        r29.xy = refProbeConstantsCB[r5.w].data[4].zw * r13.yz;
        r29.z = refProbeConstantsCB[r5.w].data[5].x * r13.w;
        r13.yzw = refProbeConstantsCB[r5.w].data[5].yzw + r29.xyz;
        ...
        r5.w = (int)r26.y | (int)r26.x;
        r5.w = (int)r26.z | (int)r5.w;
        r25.xyz = r5.www ? float3(1,1,0) : r25.xyz;
        r26.xyz = r25.xyz * r13.yzw;
        r5.w = dot(r26.xyz, float3(0.212599993,0.715200007,0.0722000003));
        r21.xyz = r13.yzw * r25.xyz + r21.xyz;
        r7.w = r5.w * r3.x;
        r13.yzw = r24.xzw * r6.www;
        r6.w = dot(r13.yzw, float3(0.212599993,0.715200007,0.0722000003));
        r5.w = r3.x * r5.w + r6.w;
        r5.w = r7.w / r5.w;
        r22.xyz = r13.yzw * r5.www + r22.xyz;
      } else {
        r23.x = r16.x;
        r16.xy = r23.xy;
      }
  ...
  r3.xyz = r21.xyz * r1.www;
  r13.xyz = r22.xyz * r1.www;
  r2.w = cmp(r16.x < 0.99000001);
  if (r2.w != 0) {
    r0.y = (int)r0.y + 256;
    r2.w = 1 + -r16.x;
    r4.z = sunConstants.globalProbeExposure * r2.w;
    r14.xyz = -globalProbeConstants.data[0].xyz + r10.xyz;
    ...
    r1.w = r2.y * r1.w + r4.z;
    r13.xyz = r11.xyz * r1.www + r13.xyz;
  }
  r1.w = r2.x + r3.w;
  r1.w = log2(abs(r1.w));
  r0.w = r1.w * r0.w;
