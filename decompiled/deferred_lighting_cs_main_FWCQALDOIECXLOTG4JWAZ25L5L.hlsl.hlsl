...
r0.y = samp0[]..swiz;
  ...
  r15.w = samp0[]..swiz;
    ...
    while (true) {
      ...
      r18.x = cmp(0 < r16.w);
      if (r18.x != 0) {
        r26.z = r28.y * refProbeConstantsCB[r16.z].data[6].y + r26.z;
        ...
        r25.xyz = r27.xyz * r28.xzw + r25.xyz;
        r18.x = r16.z * r9.w;
        r20.yzw = r20.yzw * r16.www;
        r16.w = dot(r20.yzw, float3(0.212599993,0.715200007,0.0722000003));
        r16.z = r9.w * r16.z + r16.w;
        r16.z = r18.x / r16.z;
        r27.x = r25.w;
        r27.yz = r26.xy;
        r26.xyw = r20.zwy * r16.zzz + r27.yzx;
        r25.w = r26.w;
      }
    }
    r23.xyzw = r25.xyzw;
  ...
  if (r14.w != 0) {
    ...
    while (true) {
      ...
      if (r16.z != 0) break;
      r16.z = (uint)r16.y >> 5;
      r16.z = (int)r0.y + (int)r16.z;
    // Known bad code for instruction (needs manual fix):
        ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r16.z, r16.z, l(0), t26.xxxx
    r16.z = samp0[]..swiz;
      r16.w = cmp((int)r0.z == (int)r16.y);
      if (r13.w == 0) r18.w = 0; else if (r13.w+0 < 32) {       r18.w = (uint)r16.z << (32-(r13.w + 0)); r18.w = (uint)r18.w >> (32-r13.w);      } else r18.w = (uint)r16.z >> 0;
      r16.z = r16.w ? r18.w : r16.z;
      r26.xyzw = r25.xyzw;
      r27.xyz = r15.yzw;
      r16.w = r14.w;
      r18.w = r16.z;
      while (true) {
        ...
        r20.z = 1 << (int)r19.w;
        r20.z = ~(int)r20.z;
        r18.w = (int)r18.w & (int)r20.z;
        r19.w = (int)r16.y + (int)r19.w;
        r19.w = (int)r19.w * 14;
        r28.xyz = -refProbeConstantsCB[r19.w].data[0].xyz + r11.xyz;
        r20.z = 0x0000ffff & (int)refProbeConstantsCB[r19.w].data[7].z;
        if (6 == 0) r20.w = 0; else if (6+25 < 32) {         r20.w = (uint)refProbeConstantsCB[r19.w].data[7].z << (32-(6 + 25)); r20.w = (uint)r20.w >> (32-6);        } else r20.w = (uint)refProbeConstantsCB[r19.w].data[7].z >> 25;
        r21.w = (int)r20.z * 6;
        r22.w = dot(refProbeAttenuationConstantsCB[r21.w].data[0].xyz, r28.xyz);
        r22.w = saturate(refProbeAttenuationConstantsCB[r21.w].data[0].w + r22.w);
        r27.w = dot(refProbeAttenuationConstantsCB[r21.w].data[1].xyz, r28.xyz);
        r27.w = saturate(refProbeAttenuationConstantsCB[r21.w].data[1].w + r27.w);
        r22.w = r27.w * r22.w;
        r27.w = dot(refProbeAttenuationConstantsCB[r21.w].data[2].xyz, r28.xyz);
        r27.w = saturate(refProbeAttenuationConstantsCB[r21.w].data[2].w + r27.w);
        r22.w = r27.w * r22.w;
        r27.w = dot(refProbeAttenuationConstantsCB[r21.w].data[3].xyz, r28.xyz);
        r27.w = saturate(refProbeAttenuationConstantsCB[r21.w].data[3].w + r27.w);
        r22.w = r27.w * r22.w;
        r27.w = dot(refProbeAttenuationConstantsCB[r21.w].data[4].xyz, r28.xyz);
        r27.w = saturate(refProbeAttenuationConstantsCB[r21.w].data[4].w + r27.w);
        r22.w = r27.w * r22.w;
        r27.w = dot(refProbeAttenuationConstantsCB[r21.w].data[5].xyz, r28.xyz);
        r21.w = saturate(refProbeAttenuationConstantsCB[r21.w].data[5].w + r27.w);
        r18.x = r22.w * r21.w;
        r21.w = 1 & (int)refProbeConstantsCB[r19.w].data[6].x;
        r29.xy = r21.ww ? r18.xy : r18.zx;
        r18.x = refProbeConstantsCB[r19.w].data[6].x;
        r30.xy = r29.xy;
        r21.w = 1;
        while (true) {
          r22.w = cmp((int)r21.w >= (int)r20.w);
          if (r22.w != 0) break;
          r22.w = (int)r20.z + (int)r21.w;
          r22.w = (int)r22.w * 6;
          r27.w = dot(refProbeAttenuationConstantsCB[r22.w].data[0].xyz, r28.xyz);
          ...
          r22.w = -r27.w * r22.w + 1;
          r22.w = r30.y * r22.w;
          r20.y = r29.w ? r22.w : r30.z;
          r30.xy = r29.zz ? r30.xy : r20.xy;
          r21.w = (int)r21.w + 1;
          r18.x = r28.w;
        }
        r18.x = saturate(r30.y + -r16.w);
        r20.y = refProbeConstantsCB[r19.w].data[6].y * r18.x;
        r20.z = cmp(0 < r20.y);
        if (r20.z != 0) {
          r26.w = r18.x * refProbeConstantsCB[r19.w].data[6].y + r26.w;
          r18.x = refProbeConstantsCB[r19.w].data[7].y * r20.y;
          r29.x = refProbeConstantsCB[r19.w].data[7].w;
          r29.yz = refProbeConstantsCB[r19.w].data[8].xy;
          r20.y = dot(r17.xyz, r29.xyz);
          r20.z = dot(r28.xyz, r29.xyz);
          r20.z = -refProbeConstantsCB[r19.w].data[8].z + r20.z;
          r20.w = cmp(r20.z >= 0);
          r20.z = max(abs(r20.z), r8.w);
          r20.z = r20.w ? r20.z : -r20.z;
          ...
          r20.z = dot(r17.xyz, r29.xyz);
          r20.w = dot(r28.xyz, r29.xyz);
          r20.w = -refProbeConstantsCB[r19.w].data[9].z + r20.w;
          r21.w = cmp(r20.w >= 0);
          r20.w = max(abs(r20.w), r8.w);
          r20.w = r21.w ? r20.w : -r20.w;
          r20.z = max(1.00000001e-07, -r20.z);
          r20.z = r20.w / r20.z;
          r20.y = min(r20.y, abs(r20.z));
          r29.x = refProbeConstantsCB[r19.w].data[9].w;
          r29.yz = refProbeConstantsCB[r19.w].data[10].xy;
          r20.z = dot(r17.xyz, r29.xyz);
          r20.w = dot(r28.xyz, r29.xyz);
          r20.w = -refProbeConstantsCB[r19.w].data[10].z + r20.w;
          r21.w = cmp(r20.w >= 0);
          r20.w = max(abs(r20.w), r8.w);
          r20.w = r21.w ? r20.w : -r20.w;
          r20.z = max(1.00000001e-07, -r20.z);
          ...
          r20.z = dot(r17.xyz, r29.xyz);
          r20.w = dot(r28.xyz, r29.xyz);
          r20.w = -refProbeConstantsCB[r19.w].data[11].z + r20.w;
          r21.w = cmp(r20.w >= 0);
          r20.w = max(abs(r20.w), r8.w);
          r20.w = r21.w ? r20.w : -r20.w;
          r20.z = max(1.00000001e-07, -r20.z);
          ...
          r20.z = dot(r17.xyz, r29.xyz);
          r20.w = dot(r28.xyz, r29.xyz);
          r20.w = -refProbeConstantsCB[r19.w].data[12].z + r20.w;
          r21.w = cmp(r20.w >= 0);
          r20.w = max(abs(r20.w), r8.w);
          r20.w = r21.w ? r20.w : -r20.w;
          r20.z = max(1.00000001e-07, -r20.z);
          ...
          r20.z = dot(r17.xyz, r29.xyz);
          r20.w = dot(r28.xyz, r29.xyz);
          r20.w = -refProbeConstantsCB[r19.w].data[13].z + r20.w;
          r21.w = cmp(r20.w >= 0);
          r20.w = max(abs(r20.w), r8.w);
          r20.w = r21.w ? r20.w : -r20.w;
          r20.z = max(1.00000001e-07, -r20.z);
          ...
          r29.xyz = r17.xyz * r20.yyy + r29.xyz;
          r20.z = dot(r29.xyz, r29.xyz);
          r20.z = sqrt(r20.z);
          r20.y = r20.y / r20.z;
          r20.y = r20.y + r20.y;
          r20.y = sqrt(r20.y);
          ...
          if (9 == 0) r20.z = 0; else if (9+16 < 32) {           r20.z = (uint)refProbeConstantsCB[r19.w].data[7].z << (32-(9 + 16)); r20.z = (uint)r20.z >> (32-9);          } else r20.z = (uint)refProbeConstantsCB[r19.w].data[7].z >> 16;
          r32.w = (uint)r20.z;
          r20.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r32.xyzw, r20.y).xyz;
          r29.x = dot(r28.xyz, r31.xyz);
          r29.y = dot(r28.xyz, r33.xyz);
          r29.z = dot(r28.xyz, r34.xyz);
          r28.xyz = saturate(r29.xyz * refProbeConstantsCB[r19.w].data[3].xyz + float3(0.5,0.5,0.5));
          r29.xy = refProbeConstantsCB[r19.w].data[4].zw * r28.xy;
          r29.z = refProbeConstantsCB[r19.w].data[5].x * r28.z;
          r28.xyz = refProbeConstantsCB[r19.w].data[5].yzw + r29.xyz;
          r32.x = dot(r12.xyz, r31.xyz);
          r32.y = dot(r12.xyz, r33.xyz);
          r32.z = dot(r12.xyz, r34.xyz);
          r29.xyz = cmp(float3(0,0,0) < r32.xyz);
          r19.z = r29.x ? 0 : 0.5;
          r30.xzw = r28.xyz + r19.xyz;
          r30.xzw = gProbeXArray.SampleLevel(samplerLinearClamp_s, r30.xzw, 0).xyz;
          r31.xyz = r32.xyz * r32.xyz;
          r31.xyz = r31.xyz * r18.xxx;
          r21.z = r29.y ? 0 : 0.5;
          r29.xyw = r28.xyz + r21.xyz;
          ...
          r19.z = dot(r30.xzw, float3(0.212599993,0.715200007,0.0722000003));
          ...
          r18.x = r19.w / r18.x;
          r26.xyz = r20.yzw * r18.xxx + r26.xyz;
        }
      }
      r25.xyzw = r26.xyzw;
      r15.yzw = r27.xyz;
  ...
  if (r2.y != 0) {
    ...
    if (r2.y != 0) {
      ...
      if (r4.w != 0) {
        ...
        r23.x = lightConstantsCB[r2.z].data[9].w + r13.z;
        r23.y = lightConstantsCB[r2.z].data[10].x + r13.w;
        r13.zw = lightConstantsCB[r2.z].data[9].yz * r23.xy;
        ...
        if (r4.w == 0) {
          ...
          r22.x = r13.z * lightConstantsCB[r2.z].data[8].y + lightConstantsCB[r2.z].data[8].z;
          r22.y = r13.w * lightConstantsCB[r2.z].data[8].w + lightConstantsCB[r2.z].data[9].x;
        ...
        if (r12.w != 0) {
          ...
          if (r12.w != 0) {
            ...
            while (true) {
              ...
              r38.x = r38.y * r16.x;
              r38.w = r38.y * r15.x;
              r37.xyz = r36.xyz * r13.zzz + r38.xzw;
              r17.w = gOmniShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r37.xyzw, r12.w).x;
          ...
          if (r12.w != 0) {
            ...
            r12.w = 0.25 * r12.w;
            r13.z = dot(r34.xyz, r17.xyz);
            r14.w = dot(r17.xyz, r35.xyz);
            r17.w = -r13.z * r13.z + lightConstantsCB[r2.w].data[6].y;
            r5.z = r13.z * r14.w + -r5.z;
            r5.z = saturate(r5.z / r17.w);
            r13.z = r17.w / lightConstantsCB[r2.w].data[6].y;
            r13.z = 10 * r13.z;
            r13.z = min(1, r13.z);
            r5.z = r5.z + -r6.w;
            r5.z = r13.z * r5.z + r6.w;
            ...
            if (r6.w != 0) {
              ...
              if (r14.w == 0) {
                ...
                if (r17.w == 0) {
                  ...
                  r18.w = lightConstantsCB[r5.z].data[10].z * r13.z;
                  r6.w = lightConstantsCB[r5.z].data[10].y * r13.z + r6.w;
                  r6.w = r6.w / r18.w;
                }
              } else {
                r17.w = -1;
              }
              r13.z = (int)r14.w | (int)r17.w;
              if (r13.z == 0) {
                r6.w = max(6.10351563e-05, r6.w);
                r13.z = 0x0000ffff & (int)lightConstantsCB[r5.z].data[1].w;
                if (enableDitheredShadow != 0) {
                  r23.z = (uint)r13.z;
                  r14.w = 0;
                  r17.w = 0;
                  while (true) {
                    ...
                    if (r18.w != 0) break;
                    r36.x = dot(icb[r17.w+0].yx, r22.xw);
                    r36.y = dot(icb[r17.w+0].xy, r13.xy);
              ...
              if (r6.w != 0) {
                ...
                r35.xyz = lightConstantsCB[r5.z].data[7].yzw;
                r35.w = lightConstantsCB[r5.z].data[8].x;
                r13.z = dot(r35.xyzw, r25.xyzw);
                r17.w = cmp(r13.z < r6.w);
                if (r17.w == 0) {
                  r35.xyz = lightConstantsCB[r5.z].data[4].yzw;
                  r35.w = lightConstantsCB[r5.z].data[5].x;
                  ...
                  if (r18.w == 0) {
                    ...
                    r19.w = lightConstantsCB[r5.z].data[10].z * r13.z;
                    r6.w = lightConstantsCB[r5.z].data[10].y * r13.z + r6.w;
                    r6.w = r6.w / r19.w;
                  }
                } else {
                ...
                if (r13.z == 0) {
                  ...
                  if (enableDitheredShadow != 0) {
                    ...
                    while (true) {
                      ...
                      if (r19.w != 0) break;
                      r35.x = dot(icb[r18.w+0].xy, r14.xy);
                      r35.y = dot(icb[r18.w+0].yx, r14.xz);
                    ...
                    r25.z = (uint)r13.z;
                    r17.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r25.xyz, r6.w).x;
                  }
                  r5.z = r17.w * r17.w;
                  r5.z = r5.z * r17.w;
                } else {
            ...
            r16.yzw = r16.yzw * r4.www + r10.yzw;
            r4.w = dot(r16.yzw, r16.yzw);
            r4.w = rsqrt(r4.w);
            r16.yzw = r16.yzw * r4.www;
            r4.w = dot(r16.yzw, r10.yzw);
            r9.w = dot(r12.xyz, r16.yzw);
            r13.z = abs(r9.w) * r1.z + -abs(r9.w);
            r9.w = abs(r9.w) * r13.z + 1;
            r13.z = r8.w * r0.y + r0.z;
            r9.w = r9.w * r9.w;
            r9.w = r9.w * r13.z;
            r9.w = rcp(r9.w);
            r8.w = r8.w * r12.w;
            r8.w = r9.w * r8.w;
            r7.w = r8.w * r7.w;
            r16.yzw = r7.www * r23.xyz + r15.yzw;
            ...
            r15.yzw = r6.www ? r16.yzw : r15.yzw;
          }
        }
      }
      break;
      ...
      if (r8.w != 0) {
        ...
        if (r9.w != 0) {
          ...
          if (r8.w != 0) {
            ...
            r25.xy = exp2(r25.xy);
            r13.z = lightConstantsCB[r2.w].data[12].x * r25.x;
            r18.w = lightConstantsCB[r2.w].data[12].y * r25.y + -1;
            r13.z = lightConstantsCB[r2.w].data[12].y * r25.y + -r13.z;
            r13.z = saturate(r18.w / r13.z);
            r18.w = r13.z * r13.z;
            r13.z = r13.z * -2 + 3;
            r8.w = r18.w * r13.z;
          }
        ...
        if (r8.w != 0) {
          ...
          if (r9.w != 0) {
            ...
            r23.xyz = r23.xyz * r4.www + r10.yzw;
            r4.w = dot(r23.xyz, r23.xyz);
            r4.w = rsqrt(r4.w);
            r23.xyz = r23.xyz * r4.www;
            r4.w = dot(r23.xyz, r10.yzw);
            ...
            r6.w = r8.w * r6.w;
            r6.w = 0.25 * r6.w;
            r23.xyz = r6.www * r16.yzw + r15.yzw;
            r4.w = saturate(1 + -r4.w);
            r7.w = r4.w * r4.w;
            r7.w = r7.w * r7.w;
            r4.w = r7.w * r4.w;
            ...
            r15.yzw = r5.zzz ? r23.xyz : r15.yzw;
          }
        }
      }
      break;
  ...
  r5.xyz = r15.yzw * float3(0.0399999991,0.0399999991,0.0399999991) + r5.xyz;
  r0.xyz = r5.xyz + r0.xyz;
  r5.xyz = float3(1,1,1) + -r2.xyz;
  r5.xyz = r33.xyz * r5.xyz;
  r2.xyz = r15.yzw * r2.xyz + r5.xyz;
