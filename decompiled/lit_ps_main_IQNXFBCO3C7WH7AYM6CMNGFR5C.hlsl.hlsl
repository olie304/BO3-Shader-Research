...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  if (r0.y != 0) {
    ...
    r0.z = colorMap.CalculateLevelOfDetailUnclamped(colorSampler_s, v2.xy);
    r2.x = colorMap.CalculateLevelOfDetail(colorSampler_s, v2.xy);
    r0.z = cmp(r0.z < r2.x);
    r2.x = cmp(0 < r2.x);
    r2.yzw = (int3)r0.yyy & int3(1,2,4);
    r3.xyz = r2.yyy ? float3(1,0,1) : r1.xyz;
    r4.xyz = r2.zzz ? float3(0,1,1) : r1.xyz;
    r2.xyz = r2.xxx ? r3.xyz : r4.xyz;
    r3.xyz = r2.www ? float3(0,1,0) : r1.xyz;
    r1.xyz = r0.zzz ? r2.xyz : r3.xyz;
  }
  r0.y = -r0.w * w1.x + debugAlphaOverride.x;
  r2.w = debugAlphaOverride.w * r0.y + r1.w;
  ...
  r0.xzw = r0.xxx * r4.xyz + float3(0.0399999991,0.0399999991,0.0399999991);
  r1.w = aoMap.Sample(aoSampler_s, v2.xy).x;
  r3.w = glossRange.y + -glossRange.x;
  r0.y = r0.y * r3.w + glossRange.x;
  ...
  r4.yzw = r6.xyz * r3.xxx + r4.yzw;
  r4.xyz = r5.xyz * r4.xxx + r4.yzw;
  r3.x = dot(r4.xyz, r4.xyz);
  r3.x = rsqrt(r3.x);
  r4.xyz = r4.xyz * r3.xxx;
  r3.x = debugGlossOverride.x * r3.w + glossRange.x;
  ...
  r3.yzw = debugSpecularOverride.xyz + -r0.xzw;
  r0.xzw = debugSpecularOverride.www * r3.yzw + r0.xzw;
  r3.x = r3.x + -r0.y;
  r3.y = debugGlossOverride.w * r3.x + r0.y;
  r0.y = debugOcclusionOverride.x + -r1.w;
  r0.y = debugOcclusionOverride.w * r0.y + r1.w;
  ...
  r3.x = saturate(dot(r4.xyz, r5.yzw));
  r6.y = dot(-r5.yzw, r4.xyz);
  r6.y = r6.y + r6.y;
  r11.xyz = r4.xyz * -r6.yyy + -r5.yzw;
  r6.y = 17 * r3.y;
  r6.y = exp2(r6.y);
  r6.y = 2 + r6.y;
  r6.y = 2 / r6.y;
  ...
  if (r1.w == 0) {
    ...
    while (true) {
      ...
      bitmask.w = ((~(-1 << r3.w)) << 0) & 0xffffffff;  r10.w = (((uint)0 << 0) & bitmask.w) | ((uint)r10.y & ~bitmask.w);
    ...
    if (r9.y != 0) {
      ...
      r10.z = 0;
      while (true) {
        r10.w = cmp((uint)r10.z >= (uint)r1.w);
        if (r10.w != 0) break;
        r13.z = (uint)r10.z >> 5;
        r14.xyz = (int3)r12.xyz + (int3)r13.xyz;
        r10.w = visibleProbes.Load(r14.xyzw).x;
        r12.w = cmp((int)r3.z == (int)r10.z);
        if (r3.w == 0) r13.z = 0; else if (r3.w+0 < 32) {         r13.z = (uint)r10.w << (32-(r3.w + 0)); r13.z = (uint)r13.z >> (32-r3.w);        } else r13.z = (uint)r10.w >> 0;
    ...
    r20.xyz = r22.xyz * r1.www;
    r21.xyz = r23.xyz * r1.www;
    ...
    if (r3.z != 0) {
      ...
      r20.xyz = r22.xyz * r1.www + r9.yzw;
      r11.w = 0;
      r9.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r11.xyzw, r7.z).xyz;
      r1.w = sunConstants.globalProbeExposure * r3.z + -r3.w;
      r1.w = r3.y * r1.w + r3.w;
  ...
  r3.xyz = float3(1,1,1) + -r0.xzw;
  r3.xyz = r28.xyz * r3.xyz;
  r0.xyz = r29.xyz * r0.xzw + r3.xyz;
