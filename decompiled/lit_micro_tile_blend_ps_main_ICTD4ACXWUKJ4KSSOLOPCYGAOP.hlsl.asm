...
eq r1.w, r2.w, l(0.000000)
if_nz r1.w
  mov o0.xyzw, l(0,0,0,0)
  ret 
endif 
sample_indexable(texture2d)(float,float,float,float) r3.xyz, v2.xyxx, t21.xyzw, s3
...
mul_sat r3.z, cb0[10].z, l(0.05882353)
mul_sat r3.w, cb0[14].y, l(0.05882353)
add r3.w, -r3.z, r3.w
mad r3.z, r0.x, r3.w, r3.z
...
sincos r4.x, r9.x, r4.x
dp3_sat r6.x, r0.xyzx, r3.xyzx
dp3 r4.y, -r3.xyzx, r0.xyzx
add r4.y, r4.y, r4.y
mad r10.xyz, r0.xyzx, -r4.yyyy, -r3.xyzx
mul r4.y, r6.y, l(17.000000)
exp r4.y, r4.y
...
max r1.x, r20.w, l(1.000000)
rcp r1.x, r1.x
mov_sat r20.w, r20.w
mul r12.xyz, r1.xxxx, r19.xyzx
mul r9.yzw, r1.xxxx, r20.xxyz
...
if_nz r1.y
  ...
  mad r12.xyz, r19.xyzx, r1.xxxx, r13.xyzx
  mov r10.w, l(0)
...
if_nz r6.z
  ...
  if_nz r6.z
    ...
    if_nz r7.w
      ...
      mad r18.xyz, r0.xyzx, r8.wwww, v7.xyzx
    ...
    mad r15.xyz, r6.yyyy, r9.yzwy, r1.xyzx
    add_sat r1.w, -r1.w, l(1.000000)
    mul r6.z, r1.w, r1.w
    mul r6.z, r6.z, r6.z
    mul r1.w, r1.w, r6.z
    mul r1.w, r1.w, r6.y
    mad r16.xyz, r1.wwww, r9.zwyz, r13.xyzx
    mov r14.w, r16.z
    mov r12.w, r13.z
          ...
          if_nz r25.w
            ...
            if_nz r25.w
              ...
              if_nz r25.w
                ...
                mad r40.xyz, r0.xyzx, r25.wwww, v7.xyzx
              ...
              if_nz r25.w
                ...
                if_nz r13.w
                  ...
                  mad r17.xyz, r0.xyzx, r26.wwww, v7.xyzx
                  ...
                  if_nz r13.w
                    ...
                    mad r18.xyz, r0.xyzx, r17.xxxx, v7.xyzx
          ...
          if_nz r17.x
            ...
            if_nz r17.x
              ...
              if_nz r17.x
                ...
                mad r20.xyz, r0.xyzx, r17.xxxx, v7.xyzx
              ...
              if_nz r17.x
                ...
                if_nz r19.w
                  ...
                  mad r21.xyz, r0.xyzx, r20.xxxx, v7.xyzx
                  ...
                  if_nz r19.w
                    ...
                    mad r20.x, |r12.w|, l(-0.200000), l(0.400000)
                    mad r22.xyz, r0.xyzx, r20.xxxx, v7.xyzx
...
mad r0.xyz, r9.yzwy, r5.xyzx, r0.xyzx
...
ret 
// Approximately 1961 instruction slots used
