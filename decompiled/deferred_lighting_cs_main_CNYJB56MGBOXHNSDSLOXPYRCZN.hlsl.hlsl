...
r0.y = samp0[]..swiz;
  ...
  r18.xyzw = gSSAOTexture.Gather(samplerLinearClamp_s, r9.zw).xyzw;
  r19.xyzw = gSSAODepthTexture.Gather(samplerLinearClamp_s, r9.zw).xyzw;
  r9.xy = float2(0.5,0.5) * r9.xy;
  r9.xy = frac(r9.xy);
  r9.zw = float2(1,1) + -r9.yx;
  r20.xyzw = r9.xwyx * r9.zzwy;
  r2.w = dot(r18.xyzw, r20.xyzw);
  ...
  r3.w = r9.x ? r18.y : r18.x;
  r3.w = r9.y ? r18.z : r3.w;
  r3.w = r9.z ? r18.w : r3.w;
  ...
  if (r4.z != 0) {
    ...
    if (r4.z != 0) {
      ...
      r21.xyz = -r10.xyz * r2.zzz + sunConstants.wldDir.xyz;
      r2.z = dot(r21.xyz, r21.xyz);
      r2.z = rsqrt(r2.z);
      r21.xyz = r21.xyz * r2.zzz;
      r2.z = dot(r21.xyz, r12.xyz);
      ...
      r2.z = r4.z * r2.z;
      r2.z = r2.w * r2.z;
      r22.xyz = r2.zzz * r15.yzw + r16.yzw;
