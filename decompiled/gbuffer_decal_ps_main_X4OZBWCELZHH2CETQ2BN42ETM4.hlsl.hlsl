  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r3.z = aoMap.Sample(aoSampler_s, r0.yz).x;
  ...
  r6.xyz = detailMap.Sample(normalSampler_s, r0.yz).xyz;
  r0.yz = r6.xy * float2(1.9921875,1.9921875) + float2(-1,-1);
  r2.w = r6.z * r6.z;
  r2.w = 0.333333343 * r2.w;
  r2.w = min(1, r2.w);
  r5.xy = r0.yz * detailScaleHeight + r4.xy;
  r0.y = dot(r5.xyz, r5.xyz);
  r0.y = rsqrt(r0.y);
  r4.xyz = r5.xyz * r0.yyy;
  r0.y = r2.w * detailScaleHeight + r1.w;
  ...
  r3.xy = r0.yz * float2(1,0.5) + float2(0,0.5);
  r3.w = 1;
  o2.xyzw = r3.xyzw * r0.xxxx;
  o0.w = r0.x;
  o1.w = r0.x;
  return;
}