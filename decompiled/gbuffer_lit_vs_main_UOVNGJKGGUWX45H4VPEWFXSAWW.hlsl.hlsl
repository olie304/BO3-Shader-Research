...
r4.w = shaderConstantSetBuffer[]..swiz;
  ...
  r6.xyzw = viewProjectionMatrix._m10_m11_m12_m13 * r0.wwww;
  r1.w = r2.x;
  r4.w = r2.z;
  r0.w = dot(r5.xyzw, r1.xyzw);
  r2.xyzw = r0.wwww * viewProjectionMatrix._m00_m01_m02_m03 + r6.xyzw;
  ...
  o1.xyz = exp2(r2.xyz);
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) o1.w, r0.y, l(0), t0.xxxx
r1.w = shaderConstantSetBuffer[]..swiz;
  o2.xy = v2.xy;
  ...
  r0.y = rsqrt(r0.y);
  o4.xyz = r7.xyz * r0.yyy;
  r7.xyz = r6.yzx * r2.zxy;
  r2.xyz = r2.yzx * r6.zxy + -r7.xyz;
  r0.y = v4.w * 2 + -1;
