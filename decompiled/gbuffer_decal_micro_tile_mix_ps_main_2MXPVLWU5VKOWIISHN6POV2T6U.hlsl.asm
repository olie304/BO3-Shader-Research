...
sample_indexable(texture2d)(float,float,float,float) r0.z, r0.zwzz, t19.yzxw, s5
...
sample_indexable(texture2d)(float,float,float,float) r1.w, r4.xyxx, t11.yzwx, s2
...
sample_indexable(texture2d)(float,float,float,float) r6.xyzw, r1.xyxx, t18.xyzw, s1
sample_indexable(texture2d)(float,float,float,float) r1.z, r1.xyxx, t15.yzxw, s1
...
sample_indexable(texture2d)(float,float,float,float) r7.xyz, r1.xyxx, t16.xyzw, s3
add r6.xyzw, -r5.xyzw, r6.xyzw
mad r5.xyzw, r0.zzzz, r6.xyzw, r5.xyzw
mul r5.xyz, r5.xyzx, v8.xyzx
add r1.x, -cb0[11].x, cb0[11].y
mad r1.y, r1.w, r1.x, cb0[11].x
add r1.w, -cb0[14].x, cb0[14].y
mad r1.z, r1.z, r1.w, cb0[14].x
mul_sat r1.yz, r1.yyzy, l(0.000000, 0.05882353, 0.05882353, 0.000000)
add r1.z, -r1.y, r1.z
mad r1.y, r0.z, r1.z, r1.y
sample_indexable(texture2d)(float,float,float,float) r1.z, r0.xyxx, t12.yzxw, s4
mad r2.zw, r7.xxxy, l(0.000000, 0.000000, 1.99218750, 1.99218750), l(0.000000, 0.000000, -1.000000, -1.000000)
mul r1.w, r7.z, r7.z
...
mad r4.w, r3.w, cb0[12].x, r0.w
mad r3.xy, r2.zwzz, cb0[12].yyyy, r2.xyxx
dp3 r2.x, r3.xyzx, r3.xyzx
rsq r2.x, r2.x
mul r2.xyz, r2.xxxx, r3.xyzx
mad r2.w, r1.w, cb0[12].y, r0.w
add r2.xyzw, -r4.xyzw, r2.xyzw
mad r2.xyzw, r0.zzzz, r2.xyzw, r4.xyzw
