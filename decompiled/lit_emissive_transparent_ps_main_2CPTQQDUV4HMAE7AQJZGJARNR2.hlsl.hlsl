...
r1.w = samp0[]..swiz;
  ...
  while (true) {
    ...
    r11.z = cmp((int)r3.x == (int)r8.w);
    if (r5.w == 0) r11.w = 0; else if (r5.w+0 < 32) {     r11.w = (uint)r10.w << (32-(r5.w + 0)); r11.w = (uint)r11.w >> (32-r5.w);    } else r11.w = (uint)r10.w >> 0;
          ...
          r23.w = samp0[]..swiz;
            ...
            r20.w = samp0[]..swiz;
              ...
              if (r19.y != 0) {
                ...
                r17.w = 1 + -r16.w;
                r20.xyz = r17.www * r16.xyz;
                r16.xyz = r19.xyz * r16.www + r20.xyz;
              }
              r17.w = 1 + -r16.w;
              r19.xyz = r17.www * r12.xyz;
              r12.xyz = r18.xyz * r16.www + r19.xyz;
              r18.xyz = r17.xyz * r17.www;
              r17.xyz = r27.xyz * r16.www + r18.xyz;
              r11.w = r11.w * r17.w + r16.w;
              r17.w = r17.w * r13.w;
              r13.w = r15.w * r16.w + r17.w;
            }
          }
        }
      }
  ...
  r6.w = saturate(r6.w);
  r3.x = 1 + -r6.w;
  r0.xyz = r0.xyz * r3.xxx + r13.xyz;
  r1.w = r1.w * r3.x + r6.w;
  r2.yzw = r2.yzw * r3.xxx + r14.xyz;
  r3.y = dot(r2.yzw, r2.yzw);
  r3.y = rsqrt(r3.y);
  r8.xyz = r3.yyy * r2.yzw;
  r2.y = r2.x * r3.x + r7.w;
  r1.xyz = r1.xyz * r3.xxx + r15.xyz;
  r2.z = dot(-v7.xyz, -v7.xyz);
  r2.z = rsqrt(r2.z);
  r7.xyz = -v7.xyz * r2.zzz;
  r2.w = dot(r7.xyz, r4.xyz);
  r4.x = dot(r7.xyz, r5.xyz);
  r4.y = dot(r7.xyz, r6.xyz);
  r3.y = cmp(0 < r2.w);
  r4.xy = -r4.xy / r2.ww;
  r4.xy = r3.yy ? r4.xy : 0;
  r3.y = 9.99999975e-06 + relativeHDR;
  r4.xy = r4.xy * r3.yy + v2.xy;
  ...
  r5.w = 100 * r5.w;
  r11.yz = -r3.ww * float2(10,5) + float2(6.85740995,7.08500004);
  r6.w = exp2(r11.y);
  r6.w = r6.w * r2.x;
  r6.w = 9.1368103 * r6.w;
  r7.w = r5.z * r3.w;
  r7.w = -r7.w * 2.0159049 + r11.z;
  r7.w = exp2(r7.w);
  r7.w = r7.w * r2.x;
    ...
    while (true) {
      ...
      r25.y = samp0[]..swiz;
        ...
        r32.w = samp0[]..swiz;
          ...
          if (r15.w != 0) {
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r27.xyzw, r14.z, l(16), t15.xyzw
          r27.x = samp0[]..swiz;
          r27.y = samp0[]..swiz;
          r27.z = samp0[]..swiz;
          r27.w = samp0[]..swiz;
          ...
          r38.y = samp0[]..swiz;
            ...
            r17.yzw = r12.xyz * r15.xxx + r17.yzw;
            ...
            r15.w = r15.x * r6.w;
            r17.yzw = r17.yzw * r14.zzz;
            r14.z = dot(r17.yzw, float3(0.212599993,0.715200007,0.0722000003));
            r14.z = r6.w * r15.x + r14.z;
            r14.z = r15.w / r14.z;
            r24.x = r22.w;
            r24.yz = r23.xy;
            r23.xyw = r17.zwy * r14.zzz + r24.yzx;
            r22.w = r23.w;
          }
        }
      }
  ...
  if (r11.z != 0) {
    ...
    r11.w = 0;
    while (true) {
      r13.w = cmp((uint)r11.w >= (uint)r7.w);
      if (r13.w != 0) break;
      r13.z = (uint)r11.w >> 5;
      r14.xyz = (int3)r10.xyz + (int3)r13.xyz;
      r13.z = visibleProbes.Load(r14.xyzw).x;
      ...
      while (true) {
        ...
        r26.y = samp0[]..swiz;
          ...
          r17.w = r25.z ? r17.w : 0;
          if (r17.w != 0) {
            r17.z = (int)r11.w + (int)r17.z;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r25.xyzw, r17.z, l(0), t15.wxyz
          r25.x = samp0[]..swiz;
          r25.y = samp0[]..swiz;
          r25.z = samp0[]..swiz;
          r25.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r26.xy, r17.z, l(96), t15.xyxx
          r26.x = samp0[]..swiz;
          r26.y = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r27.xyzw, r17.z, l(116), t15.zwxy
          r27.x = samp0[]..swiz;
          r27.y = samp0[]..swiz;
          r27.z = samp0[]..swiz;
          r27.w = samp0[]..swiz;
          ...
          r34.w = samp0[]..swiz;
            ...
            r19.w = saturate(r19.w + r29.w);
            r23.w = dot(r30.xyz, r28.xyz);
            r23.w = saturate(r23.w + r30.w);
            r19.w = r23.w * r19.w;
            r23.w = dot(r31.xyz, r28.xyz);
            r23.w = saturate(r23.w + r31.w);
            r19.w = r23.w * r19.w;
            r23.w = dot(r32.xyz, r28.xyz);
            r23.w = saturate(r23.w + r32.w);
            r19.w = r23.w * r19.w;
            r23.w = dot(r33.xyz, r28.xyz);
            r23.w = saturate(r23.w + r33.w);
            r19.w = r23.w * r19.w;
            r23.w = dot(r34.xyz, r28.xyz);
            r23.w = saturate(r23.w + r34.w);
            r15.x = r23.w * r19.w;
            r19.w = (int)r26.x & 1;
            r26.zw = r19.ww ? r15.xy : r15.zx;
            r15.x = r26.x;
            r29.xy = r26.zw;
            r19.w = 1;
            while (true) {
            ...
            r35.w = samp0[]..swiz;
              ...
              r23.w = -r23.w * r25.w + 1;
              r23.w = r29.y * r23.w;
              r17.y = r29.w ? r23.w : r30.x;
              r29.xy = r29.zz ? r29.xy : r17.xy;
              r19.w = (int)r19.w + 1;
              r15.x = r28.w;
            }
            r15.x = saturate(r29.y + -r15.w);
            r17.y = r15.x * r26.y;
            r17.w = cmp(0 < r17.y);
            if (r17.w != 0) {
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r30.xyzw, r17.z, l(16), t15.xyzw
            r30.x = samp0[]..swiz;
            r30.y = samp0[]..swiz;
            r30.z = samp0[]..swiz;
            r30.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r31.xyzw, r17.z, l(32), t15.yxwz
            r31.x = samp0[]..swiz;
            r31.y = samp0[]..swiz;
            r31.z = samp0[]..swiz;
            r31.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r32.xyzw, r17.z, l(48), t15.xyzw
            r32.x = samp0[]..swiz;
            r32.y = samp0[]..swiz;
            r32.z = samp0[]..swiz;
            r32.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r33.xyzw, r17.z, l(64), t15.zwxy
            r33.x = samp0[]..swiz;
            r33.y = samp0[]..swiz;
            r33.z = samp0[]..swiz;
            r33.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r34.xyzw, r17.z, l(80), t15.xyzw
            r34.x = samp0[]..swiz;
            r34.y = samp0[]..swiz;
            r34.z = samp0[]..swiz;
            r34.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r35.xyzw, r17.z, l(132), t15.zwxy
            r35.x = samp0[]..swiz;
            r35.y = samp0[]..swiz;
            r35.z = samp0[]..swiz;
            r35.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r36.xyzw, r17.z, l(148), t15.zwxy
            r36.x = samp0[]..swiz;
            r36.y = samp0[]..swiz;
            r36.z = samp0[]..swiz;
            r36.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r37.xyzw, r17.z, l(164), t15.zwxy
            r37.x = samp0[]..swiz;
            r37.y = samp0[]..swiz;
            r37.z = samp0[]..swiz;
            r37.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r38.xyzw, r17.z, l(180), t15.zwxy
            r38.x = samp0[]..swiz;
            r38.y = samp0[]..swiz;
            r38.z = samp0[]..swiz;
            r38.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r39.xyzw, r17.z, l(196), t15.xyzw
            r39.x = samp0[]..swiz;
            r39.y = samp0[]..swiz;
            r39.z = samp0[]..swiz;
            r39.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r40.xy, r17.z, l(212), t15.xyxx
            r40.x = samp0[]..swiz;
            r40.y = samp0[]..swiz;
              r24.w = r15.x * r26.y + r24.w;
              r15.x = r17.y * r27.z;
              r27.z = r35.z;
              r17.y = dot(r12.xyz, r27.xyz);
              r17.z = dot(r28.xyz, r27.xyz);
              r17.z = r17.z + -r35.w;
              r17.w = cmp(r17.z >= 0);
              ...
              r17.y = min(r17.y, abs(r17.z));
              r40.zw = r39.zw;
              r17.z = dot(r12.zxy, r40.xzw);
              r17.w = dot(r28.zxy, r40.xzw);
              r17.w = r17.w + -r40.y;
              r18.w = cmp(r17.w >= 0);
              r17.w = max(abs(r17.w), r5.w);
              r17.w = r18.w ? r17.w : -r17.w;
              ...
              r26.xyz = r12.xyz * r17.yyy + r26.xyz;
              r17.z = dot(r26.xyz, r26.xyz);
              r17.z = sqrt(r17.z);
              r17.y = r17.y / r17.z;
              r17.y = r17.y + r17.y;
              r17.y = sqrt(r17.y);
              ...
              if (9 == 0) r17.z = 0; else if (9+16 < 32) {               r17.z = (uint)r27.w << (32-(9 + 16)); r17.z = (uint)r17.z >> (32-9);              } else r17.z = (uint)r27.w >> 16;
              r35.w = (uint)r17.z;
              r17.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r35.xyzw, r17.y).xyz;
              ...
              r15.x = r18.z / r15.x;
              r24.xyz = r17.yzw * r15.xxx + r24.xyz;
            }
          }
        }
      }
  ...
  if (r5.w != 0) {
    ...
    r6.w = dot(r14.xyz, float3(0.212599993,0.715200007,0.0722000003));
    r11.yzw = r20.xyz * r3.www + r14.xyz;
    r12.w = 0;
    r14.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r12.xyzw, r5.z).xyz;
    r3.w = sunConstants.globalProbeExposure * r5.w + -r6.w;
    r3.w = r2.y * r3.w + r6.w;
  ...
  r5.zw = r2.xy * float2(0.984375,0.984375) + float2(0.0078125,0.0078125);
  r5.zw = gEnvBRDFGeneric.SampleLevel(samplerLinear_s, r5.zw, 0).xy;
  r11.yzw = r13.xyz * r3.www;
  r13.xyz = r11.zwy * r5.zzz;
  ...
  r0.w = r3.w * r0.w;
  r2.y = r3.w * r2.y;
  r3.w = dot(r8.xyz, sunConstants.wldDir.xyz);
  r5.z = saturate(r3.w);
  r5.w = cmp(0 >= r5.z);
  if (r5.w != 0) {
    r6.w = 0;
    ...
    if (r10.w == 0) {
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          if (r17.x != 0) break;
          r17.x = cmp((uint)r8.w < (uint)r16.w);
  ...
  if (r5.w != 0) {
    ...
    if (r5.w != 0) {
      ...
      r7.w = r7.w * r6.w;
      r3.w = cmp(0 < r3.w);
      r15.xyz = r7.www * r9.xyz + r14.xyz;
      r16.xyz = -v7.xyz * r2.zzz + sunConstants.wldDir.xyz;
      ...
      r5.z = r6.w * r5.z;
      r5.z = 0.25 * r5.z;
      r16.xyz = r5.zzz * r9.xyz + r11.yzw;
      r2.z = saturate(1 + -r2.z);
      r5.w = r2.z * r2.z;
      r5.w = r5.w * r5.w;
      r2.z = r5.w * r2.z;
      r2.z = r5.z * r2.z;
      r9.xyz = r2.zzz * r9.yzx + r13.xyz;
      r15.w = r9.z;
      r14.w = r13.z;
      r14.xyzw = r3.wwww ? r15.xyzw : r14.xyzw;
      r9.zw = r16.xy;
      r13.zw = r11.yz;
      r9.xyzw = r3.wwww ? r9.xyzw : r13.xyzw;
      r11.w = r3.w ? r16.z : r11.w;
      r13.z = r14.w;
      r13.xy = r9.xy;
      r11.yz = r9.zw;
    }
            ...
            if (r20.w != 0) {
              ...
              if (r20.w != 0) {
                ...
                if (r20.w != 0) {
                    ...
                    r12.w = samp0[]..swiz;
                      ...
                      if (r6.w != 0) {
                        ...
                        while (true) {
                          ...
                          if (r24.w != 0) break;
                          r43.x = dot(icb[r18.z+0].yx, r9.xw);
                      ...
                      r12.w = samp0[]..swiz;
                        ...
                        if (r6.w != 0) {
                          ...
                          while (true) {
                            ...
                            if (r26.w != 0) break;
                            r42.x = dot(icb[r24.w+0].xy, r6.xy);
                            r42.y = dot(icb[r24.w+0].yx, r6.xz);
                  ...
                  r15.z = dot(r8.xyz, r39.xyz);
                  r15.w = abs(r15.z) * r3.y + -abs(r15.z);
                  r15.z = abs(r15.z) * r15.w + 1;
                  r15.w = r12.w * r0.w + r2.y;
                  r15.z = r15.z * r15.z;
                  r15.z = r15.z * r15.w;
                  r15.z = rcp(r15.z);
                  r12.w = r12.w * r20.w;
            ...
            r40.w = samp0[]..swiz;
              ...
              if (r14.w != 0) {
                  ...
                  r40.y = samp0[]..swiz;
                    ...
                    if (r6.w != 0) {
                      ...
                      while (true) {
                        ...
                        r24.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r32.xyz, r8.w).x;
                ...
                if (r14.w != 0) {
                  ...
                  r15.z = dot(r8.xyz, r19.xyz);
                  r18.x = abs(r15.z) * r3.y + -abs(r15.z);
                  r15.z = abs(r15.z) * r18.x + 1;
                  r13.w = r13.w * r0.w + r2.y;
                  r15.z = r15.z * r15.z;
                  r13.w = r15.z * r13.w;
                  r13.w = rcp(r13.w);
                  r13.w = r13.w * r14.w;
