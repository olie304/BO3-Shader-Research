...
r0.y = samp0[]..swiz;
  ...
  if (probeDebug != 0) {
    ...
    while (true) {
      r28.w = cmp((uint)r27.w >= numRefProbes);
      if (r28.w != 0) break;
      r28.w = (uint)r27.w >> 5;
      r28.w = (int)r12.w + (int)r28.w;
    // Known bad code for instruction (needs manual fix):
  ...
  if (r13.w != 0) {
    ...
    r12.w = (int)r27.z & 0x0000ffff;
    if (6 == 0) r16.w = 0; else if (6+25 < 32) {     r16.w = (uint)r27.z << (32-(6 + 25)); r16.w = (uint)r16.w >> (32-6);    } else r16.w = (uint)r27.z >> 25;
    r17.w = (int)r12.w * 6;
    ...
    r20.z = dot(refProbeAttenuationConstantsCB[r17.w].data[1].xyz, r14.yzw);
    r20.z = saturate(refProbeAttenuationConstantsCB[r17.w].data[1].w + r20.z);
    r18.w = r20.z * r18.w;
    r20.z = dot(refProbeAttenuationConstantsCB[r17.w].data[2].xyz, r14.yzw);
    r20.z = saturate(refProbeAttenuationConstantsCB[r17.w].data[2].w + r20.z);
    r18.w = r20.z * r18.w;
    r20.z = dot(refProbeAttenuationConstantsCB[r17.w].data[3].xyz, r14.yzw);
    r20.z = saturate(refProbeAttenuationConstantsCB[r17.w].data[3].w + r20.z);
    r18.w = r20.z * r18.w;
    r20.z = dot(refProbeAttenuationConstantsCB[r17.w].data[4].xyz, r14.yzw);
    r20.z = saturate(refProbeAttenuationConstantsCB[r17.w].data[4].w + r20.z);
    r18.w = r20.z * r18.w;
    r20.z = dot(refProbeAttenuationConstantsCB[r17.w].data[5].xyz, r14.yzw);
    r17.w = saturate(refProbeAttenuationConstantsCB[r17.w].data[5].w + r20.z);
    r31.x = r18.w * r17.w;
    r17.w = (int)r19.w & 1;
    r31.yz = float2(0,1);
    r20.zw = r17.ww ? r31.xy : r31.zx;
    r31.x = 1;
    r17.w = r19.w;
    r32.xy = r20.zw;
    r18.w = 1;
    while (true) {
      r21.w = cmp((int)r18.w >= (int)r16.w);
      if (r21.w != 0) break;
      r21.w = (int)r12.w + (int)r18.w;
      r21.w = (int)r21.w * 6;
      r27.y = dot(refProbeAttenuationConstantsCB[r21.w].data[0].xyz, r14.yzw);
      r27.y = saturate(refProbeAttenuationConstantsCB[r21.w].data[0].w + r27.y);
      r27.y = r32.x * r27.y;
      r27.w = dot(refProbeAttenuationConstantsCB[r21.w].data[1].xyz, r14.yzw);
      r27.w = saturate(refProbeAttenuationConstantsCB[r21.w].data[1].w + r27.w);
      r27.y = r27.y * r27.w;
      r27.w = dot(refProbeAttenuationConstantsCB[r21.w].data[2].xyz, r14.yzw);
      r27.w = saturate(refProbeAttenuationConstantsCB[r21.w].data[2].w + r27.w);
      r27.y = r27.y * r27.w;
      r27.w = dot(refProbeAttenuationConstantsCB[r21.w].data[3].xyz, r14.yzw);
      r27.w = saturate(refProbeAttenuationConstantsCB[r21.w].data[3].w + r27.w);
      r27.y = r27.y * r27.w;
      r27.w = dot(refProbeAttenuationConstantsCB[r21.w].data[4].xyz, r14.yzw);
      r27.w = saturate(refProbeAttenuationConstantsCB[r21.w].data[4].w + r27.w);
      r27.y = r27.y * r27.w;
      r27.w = dot(refProbeAttenuationConstantsCB[r21.w].data[5].xyz, r14.yzw);
    ...
    if (r12.w != 0) {
      ...
      r12.w = r31.w * r20.y;
      r16.w = dot(r15.xyz, r21.xyz);
      r17.w = dot(r14.yzw, r21.xyz);
      r17.w = r17.w + -r22.w;
      r18.w = cmp(r17.w >= 0);
      ...
      r17.w = dot(r15.xyz, r22.xyz);
      r18.w = dot(r14.yzw, r22.xyz);
      r18.w = r18.w + -r23.w;
      r19.w = cmp(r18.w >= 0);
      ...
      r19.xyz = r15.xyz * r16.www + r19.xyz;
      ...
      if (9 == 0) r17.w = 0; else if (9+16 < 32) {       r17.w = (uint)r27.z << (32-(9 + 16)); r17.w = (uint)r17.w >> (32-9);      } else r17.w = (uint)r27.z >> 16;
      r20.w = (uint)r17.w;
      r19.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r20.xyzw, r16.w).xyz;
      r21.xyz = (int3)r19.xyz & int3(-2147483648,-2147483648,-2147483648);
      r21.xyz = cmp((int3)r21.xyz == int3(2139095040,2139095040,2139095040));
      r16.w = (int)r21.y | (int)r21.x;
      r16.w = (int)r21.z | (int)r16.w;
      r19.xyz = r16.www ? float3(1,1,0) : r19.xyz;
  ...
  if (r13.w == 0) {
    ...
    r16.x = numRefProbes & -32;
    r16.y = (int)-r16.x + numRefProbes;
    r17.x = 16;
    r18.yz = float2(0,1);
    r19.xy = float2(0,0);
    r20.xz = float2(1,1);
    ...
    while (true) {
      ...
      if (r16.w != 0) break;
      r16.w = (uint)r16.z >> 5;
      r16.w = (int)r14.y + (int)r16.w;
    // Known bad code for instruction (needs manual fix):
        ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r16.w, r16.w, l(0), t26.xxxx
    r16.w = samp0[]..swiz;
      r18.w = cmp((int)r14.z == (int)r16.z);
      bitmask.w = ((~(-1 << r14.w)) << 0) & 0xffffffff;  r19.w = (((uint)0 << 0) & bitmask.w) | ((uint)r16.w & ~bitmask.w);
    ...
    r17.w = 0;
    while (true) {
      r18.w = cmp((uint)r17.w >= (uint)r13.w);
      if (r18.w != 0) break;
      r18.w = (uint)r17.w >> 5;
    ...
    r18.w = samp0[]..swiz;
      r19.w = cmp((int)r14.z == (int)r17.w);
      if (r14.w == 0) r20.x = 0; else if (r14.w+0 < 32) {       r20.x = (uint)r18.w << (32-(r14.w + 0)); r20.x = (uint)r20.x >> (32-r14.w);      } else r20.x = (uint)r18.w >> 0;
      ...
      while (true) {
        ...
        if (r21.w != 0) {
          ...
          r16.yzw = refProbeConstantsCB[r20.x].data[0].xyz + eyeOffset.xyz;
          GBufferDiffuseColor[viewID].r20.y = u2.xyzw;
        }
        r30.y = (int)r29.z + 1;
        r16.yzw = -refProbeConstantsCB[r20.x].data[0].xyz + r10.xyz;
        ...
        r22.w = (int)r20.y * 6;
        r25.w = dot(refProbeAttenuationConstantsCB[r22.w].data[0].xyz, r16.yzw);
        r25.w = saturate(refProbeAttenuationConstantsCB[r22.w].data[0].w + r25.w);
        r26.w = dot(refProbeAttenuationConstantsCB[r22.w].data[1].xyz, r16.yzw);
        r26.w = saturate(refProbeAttenuationConstantsCB[r22.w].data[1].w + r26.w);
        r25.w = r26.w * r25.w;
        r26.w = dot(refProbeAttenuationConstantsCB[r22.w].data[2].xyz, r16.yzw);
        r26.w = saturate(refProbeAttenuationConstantsCB[r22.w].data[2].w + r26.w);
        r25.w = r26.w * r25.w;
        r26.w = dot(refProbeAttenuationConstantsCB[r22.w].data[3].xyz, r16.yzw);
        r26.w = saturate(refProbeAttenuationConstantsCB[r22.w].data[3].w + r26.w);
        r25.w = r26.w * r25.w;
        r26.w = dot(refProbeAttenuationConstantsCB[r22.w].data[4].xyz, r16.yzw);
        r26.w = saturate(refProbeAttenuationConstantsCB[r22.w].data[4].w + r26.w);
        r25.w = r26.w * r25.w;
        r26.w = dot(refProbeAttenuationConstantsCB[r22.w].data[5].xyz, r16.yzw);
        ...
        r17.x = refProbeConstantsCB[r20.x].data[6].x;
        r32.xy = r30.zw;
        r22.w = 1;
        while (true) {
        ...
        r20.y = refProbeConstantsCB[r20.x].data[6].y * r17.x;
        r20.w = cmp(0 < r20.y);
        if (r20.w != 0) {
          r20.w = (int)r30.y & 255;
          r21.w = (int)r20.w + -1;
          ...
          r29.z = (int)r29.z + 257;
          r29.x = r17.x * refProbeConstantsCB[r20.x].data[6].y + r29.x;
          r17.x = refProbeConstantsCB[r20.x].data[7].y * r20.y;
          r33.x = refProbeConstantsCB[r20.x].data[7].w;
          r33.yz = refProbeConstantsCB[r20.x].data[8].xy;
          r20.y = dot(r15.xyz, r33.xyz);
          r20.w = dot(r16.yzw, r33.xyz);
          ...
          r20.w = r21.w / r20.w;
          r20.y = min(r20.y, abs(r20.w));
          r33.x = refProbeConstantsCB[r20.x].data[3].w + r16.y;
          r33.yz = refProbeConstantsCB[r20.x].data[4].xy + r16.zw;
          r32.xzw = r15.xyz * r20.yyy + r33.xyz;
          ...
          r16.yzw = saturate(r37.xyz * refProbeConstantsCB[r20.x].data[3].xyz + float3(0.5,0.5,0.5));
          r37.xy = refProbeConstantsCB[r20.x].data[4].zw * r16.yz;
          r37.z = refProbeConstantsCB[r20.x].data[5].x * r16.w;
          r16.yzw = refProbeConstantsCB[r20.x].data[5].yzw + r37.xyz;
          ...
          r20.xyw = r18.zzz ? float3(1,1,0) : r20.xyw;
          r33.xyz = r20.xyw * r16.yzw;
          r18.z = dot(r33.xyz, float3(0.212599993,0.715200007,0.0722000003));
          r27.xyz = r16.yzw * r20.xyw + r27.xyz;
          r16.y = r18.z * r9.w;
          r20.xyw = r32.xzw * r17.xxx;
          r16.z = dot(r20.xyw, float3(0.212599993,0.715200007,0.0722000003));
          r16.z = r9.w * r18.z + r16.z;
          r16.y = r16.y / r16.z;
          r28.xyz = r20.xyw * r16.yyy + r28.xyz;
        } else {
          r30.x = r29.x;
          r29.xz = r30.xy;
        }
    ...
    r12.w = r4.w ? r8.w : r26.y;
    r4.w = max(1, r26.x);
    r4.w = rcp(r4.w);
    r26.x = saturate(r26.x);
    r14.yzw = r22.xyz * r4.www;
    ...
    if (r8.w != 0) {
      ...
      r9.w = dot(r16.xyz, float3(0.212599993,0.715200007,0.0722000003));
      r14.yzw = r22.xyz * r4.www + r16.xyz;
      r15.w = 0;
      ...
      r4.w = r2.y * r4.w + r9.w;
      r31.xyz = r16.xyz * r4.www + r31.xyz;
    }
  } else {
    r14.yzw = float3(0,0,0);
  }
  ...
  r17.xyz = r31.xyz * r4.www;
  r18.xyz = r17.yzx * r14.yyy;
  ...
  if (r4.w != 0) {
    ...
    if (r4.w != 0) {
      ...
      r7.w = r7.w * r6.w;
      r2.w = cmp(0 < r2.w);
      r19.xyz = r7.www * r17.xyz + r16.xyz;
      ...
      r4.z = r6.w * r4.z;
      r4.z = 0.25 * r4.z;
      r20.xyz = r4.zzz * r17.xyz + r14.yzw;
      r0.z = saturate(1 + -r0.z);
      r4.w = r0.z * r0.z;
      r4.w = r4.w * r4.w;
      r0.z = r4.w * r0.z;
      r0.z = r4.z * r0.z;
      r17.xyz = r0.zzz * r17.yzx + r18.xyz;
      r19.w = r17.z;
      r16.w = r18.z;
      r16.xyzw = r2.wwww ? r19.xyzw : r16.xyzw;
      r17.zw = r20.xy;
      r18.zw = r14.yz;
      r17.xyzw = r2.wwww ? r17.xyzw : r18.xyzw;
  ...
  r8.w = samp0[]..swiz;
    ...
    while (true) {
      ...
      r18.w = cmp((int)r16.w == 2);
      if (r18.w != 0) {
        if (3 == 0) r18.w = 0; else if (3+27 < 32) {         r18.w = (uint)lightConstantsCB[r15.w].data[1].w << (32-(3 + 27)); r18.w = (uint)r18.w >> (32-3);        } else r18.w = (uint)lightConstantsCB[r15.w].data[1].w >> 27;
        r21.w = (int)r11.w & 255;
        r26.w = cmp((uint)r21.w < 32);
        r26.w = r2.z ? r26.w : 0;
        if (r26.w != 0) {
          r21.w = mad((int)r21.w, 24, 112);
          r19.yzw = lightConstantsCB[r15.w].data[0].xyz + eyeOffset.xyz;
          GBufferDiffuseColor[viewID].r21.w = u2.xyzw;
        }
        r19.y = (int)r11.w + 1;
        r36.xy = lightConstantsCB[r15.w].data[3].zw + -r10.xy;
        r36.z = lightConstantsCB[r15.w].data[4].x + -r10.z;
        r19.z = dot(r36.xyz, r36.xyz);
        r19.z = rsqrt(r19.z);
        r37.xyz = r36.xyz * r19.zzz;
        r19.w = lightConstantsCB[r15.w].data[1].z * r0.w;
        r19.w = 0.25 * r19.w;
        r21.w = dot(r11.xyz, r37.xyz);
        r26.w = saturate(r21.w);
        r28.w = cmp(0 < r26.w);
        if (r28.w != 0) {
          r37.xyz = lightConstantsCB[r15.w].data[7].yzw;
          r37.w = lightConstantsCB[r15.w].data[8].x;
          r28.w = dot(r37.xyzw, r10.xyzw);
          r29.w = cmp(r28.w < 1);
          if (r29.w != 0) {
            r38.xyz = float3(1,1,1);
            r29.w = 0;
          } else {
            r39.xyz = lightConstantsCB[r15.w].data[0].xyz + -r10.xyz;
            r30.w = lightConstantsCB[r15.w].data[3].x * lightConstantsCB[r15.w].data[3].x;
            r31.w = dot(r39.xyz, r39.xyz);
            r30.w = r30.w / r31.w;
            r30.w = min(1, r30.w);
            r39.xy = saturate(r28.ww * lightConstantsCB[r15.w].data[2].xz + lightConstantsCB[r15.w].data[2].yw);
            r39.zw = r39.xy * r39.xy;
            r39.xy = r39.xy * float2(-2,-2) + float2(3,3);
            r39.xy = r39.zw * r39.xy;
            r30.w = r39.x * r30.w;
            r30.w = r30.w * r39.y;
            r39.xyz = lightConstantsCB[r15.w].data[4].yzw;
            r39.w = lightConstantsCB[r15.w].data[5].x;
            r39.x = dot(r39.xyzw, r10.xyzw);
            r40.xyz = lightConstantsCB[r15.w].data[5].yzw;
            r40.w = lightConstantsCB[r15.w].data[6].x;
            r39.y = dot(r40.xyzw, r10.xyzw);
            r21.xy = r39.xy / r28.ww;
            r28.w = cmp(lightConstantsCB[r15.w].data[10].w < 0.00048828125);
            if (r28.w != 0) {
              r39.xy = saturate(abs(r21.xy) * lightConstantsCB[r15.w].data[12].xy + lightConstantsCB[r15.w].data[12].zw);
              r39.zw = r39.xy * r39.xy;
              r39.xy = r39.xy * float2(-2,-2) + float2(3,3);
              r39.xy = r39.zw * r39.xy;
              r28.w = r39.x * r39.y;
            } else {
              r39.xyzw = saturate(lightConstantsCB[r15.w].data[11].xyzw * abs(r21.yyxx));
              r39.xyzw = log2(r39.xyzw);
              r39.xyzw = lightConstantsCB[r15.w].data[12].zzzz * r39.xyzw;
              r39.xyzw = exp2(r39.xyzw);
              r39.xy = r39.xy + r39.zw;
              r39.xy = log2(r39.xy);
              r39.xy = lightConstantsCB[r15.w].data[12].ww * r39.xy;
              r39.xy = exp2(r39.xy);
              r31.w = lightConstantsCB[r15.w].data[12].x * r39.x;
              r32.w = lightConstantsCB[r15.w].data[12].y * r39.y + -1;
              r31.w = lightConstantsCB[r15.w].data[12].y * r39.y + -r31.w;
            ...
            if (r28.w != 0) {
              r30.w = dot(lightConstantsCB[r15.w].data[13].xyz, r21.xyz);
              r39.x = lightConstantsCB[r15.w].data[13].w;
              r39.yz = lightConstantsCB[r15.w].data[14].xy;
          ...
          r39.x = lightConstantsCB[r15.w].data[0].w;
          r39.yz = lightConstantsCB[r15.w].data[1].xy;
          ...
          if (r21.x != 0) {
            ...
            if (r18.w != 0) {
              r18.w = abs(r21.w) * -0.200000003 + 0.400000006;
              r22.xyz = r11.xyz * r18.www + r10.xyz;
              r39.xyz = lightConstantsCB[r15.w].data[6].yzw;
              r39.w = lightConstantsCB[r15.w].data[7].x;
              r18.w = dot(r39.xyzw, r22.xyzw);
              r21.y = dot(r37.xyzw, r22.xyzw);
              r28.w = cmp(r21.y >= r18.w);
              if (r28.w != 0) {
                r37.xyz = lightConstantsCB[r15.w].data[4].yzw;
                r37.w = lightConstantsCB[r15.w].data[5].x;
                r37.x = dot(r37.xyzw, r22.xyzw);
                r39.xyz = lightConstantsCB[r15.w].data[5].yzw;
                r39.w = lightConstantsCB[r15.w].data[6].x;
                r37.y = dot(r39.xyzw, r22.xyzw);
                r22.xy = r37.xy / r21.yy;
                r22.xy = saturate(r22.xy * float2(0.5,-0.5) + float2(0.5,0.5));
                r37.x = r22.x * lightConstantsCB[r15.w].data[8].y + lightConstantsCB[r15.w].data[8].z;
                r37.y = r22.y * lightConstantsCB[r15.w].data[8].w + lightConstantsCB[r15.w].data[9].x;
                r18.w = r18.w / r21.y;
                r18.w = max(6.10351563e-05, r18.w);
                r21.y = 0x0000ffff & (int)lightConstantsCB[r15.w].data[1].w;
                if (r9.w != 0) {
                  r22.z = (uint)r21.y;
                  r28.w = 0;
                  r30.w = 0;
                  while (true) {
                    ...
                    if (r31.w != 0) break;
                    r39.x = dot(icb[r30.w+0].yx, r17.xy);
                    r39.y = dot(icb[r30.w+0].yx, r17.yz);
                    r22.xy = r39.xy * lightConstantsCB[r15.w].data[3].yy + r37.xy;
                    r22.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r22.xyz, r18.w).x;
                    r28.w = r22.x * 0.125 + r28.w;
                    r30.w = (int)r30.w + 1;
                  }
                } else {
                  r37.z = (uint)r21.y;
                  r28.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r37.xyz, r18.w).x;
                }
                r18.w = r28.w * r28.w;
                r18.w = r18.w * r28.w;
              } else {
            ...
            r21.y = cmp(0 < r18.w);
            if (r21.y != 0) {
              if (4 == 0) r21.y = 0; else if (4+16 < 32) {               r21.y = (uint)lightConstantsCB[r15.w].data[1].w << (32-(4 + 16)); r21.y = (uint)r21.y >> (32-4);              } else r21.y = (uint)lightConstantsCB[r15.w].data[1].w >> 16;
              r22.x = cmp(0 < (uint)r21.y);
              r22.x = r22.x ? r1.z : 0;
              if (r22.x != 0) {
                r21.y = (int)r21.y + numLights;
                r21.y = mad((int)r21.y, 15, -15);
                r22.x = abs(r21.w) * -0.200000003 + 0.400000006;
                ...
                if (r22.y == 0) {
                  ...
                  if (r9.w != 0) {
                    ...
                    while (true) {
                      ...
                      if (r30.w != 0) break;
                      r39.x = dot(icb[r29.w+0].yx, r17.xw);
                ...
                if (4 == 0) r21.y = 0; else if (4+20 < 32) {                 r21.y = (uint)lightConstantsCB[r15.w].data[1].w << (32-(4 + 20)); r21.y = (uint)r21.y >> (32-4);                } else r21.y = (uint)lightConstantsCB[r15.w].data[1].w >> 20;
                r22.x = cmp(0 < (uint)r21.y);
                r22.x = r22.x ? r4.z : 0;
                if (r22.x != 0) {
                  r21.y = (int)r21.y + numLights;
              ...
              r21.y = r21.y + -r26.w;
              r21.y = r1.w * r21.y + r26.w;
              r21.y = r21.y * r18.w;
              r21.w = cmp(0 < r21.w);
              r23.xyz = r21.yyy * r38.xyz + r33.xyz;
              r36.xyz = r36.xyz * r19.zzz + r12.xyz;
              r19.z = dot(r36.xyz, r36.xyz);
              r19.z = rsqrt(r19.z);
              r36.xyz = r36.xyz * r19.zzz;
              r19.z = dot(r36.xyz, r12.xyz);
              r21.y = dot(r11.xyz, r36.xyz);
              r22.x = abs(r21.y) * r0.w + -abs(r21.y);
              r21.y = abs(r21.y) * r22.x + 1;
              r22.x = r26.w * r2.y + r3.z;
              r21.y = r21.y * r21.y;
              r21.y = r21.y * r22.x;
              r21.y = rcp(r21.y);
              r19.w = r26.w * r19.w;
              r19.w = r21.y * r19.w;
              r19.w = r19.w * r18.w;
              r36.xyz = r19.www * r38.xyz + r35.xyz;
              r19.z = saturate(1 + -r19.z);
              r21.y = r19.z * r19.z;
              r21.y = r21.y * r21.y;
              r19.z = r21.y * r19.z;
              r19.z = r19.w * r19.z;
              r37.xyz = r19.zzz * r38.xyz + r34.xyz;
              r33.xyz = r21.www ? r23.xyz : r33.xyz;
              r34.xyz = r21.www ? r37.xyz : r34.xyz;
              r35.xyz = r21.www ? r36.xyz : r35.xyz;
              r19.z = (int)r21.x & 255;
              r19.w = (int)r19.z + -1;
        ...
        if (r16.w != 0) {
          ...
          r18.w = (int)r11.w + 1;
          r19.y = lightConstantsCB[r15.w].data[1].z * r0.w;
          r19.y = 0.25 * r19.y;
          r19.z = cmp(0 < lightConstantsCB[r15.w].data[6].y);
          r23.xy = lightConstantsCB[r15.w].data[5].zw;
          r23.z = lightConstantsCB[r15.w].data[6].x;
          r20.yzw = -r23.xyz * float3(0.5,0.5,0.5) + lightConstantsCB[r15.w].data[0].xyz;
          r21.xyw = r20.yzw + -r10.xyz;
          r19.w = dot(r23.xyz, r15.xyz);
          r22.x = dot(r23.xyz, r21.xyw);
          r21.x = dot(r15.xyz, r21.xyw);
          r21.y = -r19.w * r19.w + lightConstantsCB[r15.w].data[6].y;
          r19.w = r19.w * r21.x + -r22.x;
          r21.x = saturate(-r22.x / lightConstantsCB[r15.w].data[6].y);
          r19.w = saturate(r19.w / r21.y);
          r21.y = r21.y / lightConstantsCB[r15.w].data[6].y;
          r21.y = 10 * r21.y;
          r21.y = min(1, r21.y);
          r19.w = r19.w + -r21.x;
          r19.w = r21.y * r19.w + r21.x;
          r36.xyz = r19.www * r23.xyz + r20.yzw;
          r20.yzw = r21.xxx * r23.xyz + r20.yzw;
          r20.yzw = r19.zzz ? r20.yzw : lightConstantsCB[r15.w].data[0].xyz;
          r21.xyw = r19.zzz ? r36.xyz : lightConstantsCB[r15.w].data[0].xyz;
          r21.xyw = r21.xyw + -r10.xyz;
          r20.yzw = r20.yzw + -r10.xyz;
          r19.z = dot(r21.xyw, r21.xyw);
          r19.z = rsqrt(r19.z);
          r23.xyz = r21.xyw * r19.zzz;
          ...
          if (r20.w != 0) {
            r20.w = sqrt(r19.w);
            r22.x = lightConstantsCB[r15.w].data[3].x * lightConstantsCB[r15.w].data[3].x;
            r19.w = r22.x / r19.w;
            r19.w = min(1, r19.w);
            r22.xy = saturate(r20.ww * lightConstantsCB[r15.w].data[2].xz + lightConstantsCB[r15.w].data[2].yw);
            ...
            if (r20.w != 0) {
              ...
              if (r16.w != 0) {
                ...
                r36.xyz = -lightConstantsCB[r15.w].data[4].yzw + r36.xyz;
                ...
                while (true) {
                  r24.z = cmp((int)r24.y >= 8);
                  if (r24.z != 0) break;
                  r38.y = dot(icb[r24.y+0].xy, r13.xy);
                  r38.z = dot(icb[r24.y+0].yx, r13.xz);
                  r38.yz = lightConstantsCB[r15.w].data[3].yy * r38.yz;
                  r38.x = r38.y * r14.x;
                  r38.w = r38.y * r5.x;
                  r37.xyz = r36.xyz * r22.xxx + r38.xzw;
                  r24.z = gOmniShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r37.xyzw, r16.w).x;
                  r22.y = r24.z * 0.125 + r22.y;
                  r24.y = (int)r24.y + 1;
                }
              } else {
                r22.y = 1;
              ...
              r19.w = cmp(0 < r16.w);
              if (r19.w != 0) {
                if (4 == 0) r19.w = 0; else if (4+16 < 32) {                 r19.w = (uint)lightConstantsCB[r15.w].data[1].w << (32-(4 + 16)); r19.w = (uint)r19.w >> (32-4);                } else r19.w = (uint)lightConstantsCB[r15.w].data[1].w >> 16;
                r22.x = cmp(0 < (uint)r19.w);
                r22.x = r22.x ? r1.z : 0;
                if (r22.x != 0) {
                  r19.w = (int)r19.w + numLights;
                  r19.w = mad((int)r19.w, 15, -15);
                  r22.x = abs(r20.y) * -0.200000003 + 0.400000006;
                  r25.xyz = r11.xyz * r22.xxx + r10.xyz;
                  r36.xyz = lightConstantsCB[r19.w].data[6].yzw;
                  r36.w = lightConstantsCB[r19.w].data[7].x;
                  r22.x = dot(r36.xyzw, r25.xyzw);
                  r36.xyz = lightConstantsCB[r19.w].data[7].yzw;
                  r36.w = lightConstantsCB[r19.w].data[8].x;
                  r24.y = dot(r36.xyzw, r25.xyzw);
                  r24.z = cmp(r24.y < r22.x);
                  if (r24.z == 0) {
                    r36.xyz = lightConstantsCB[r19.w].data[4].yzw;
                    r36.w = lightConstantsCB[r19.w].data[5].x;
                    r36.x = dot(r36.xyzw, r25.xyzw);
                    r37.xyz = lightConstantsCB[r19.w].data[5].yzw;
                    r37.w = lightConstantsCB[r19.w].data[6].x;
                    r36.y = dot(r37.xyzw, r25.xyzw);
                    r25.xy = r36.xy / r24.yy;
                    r25.xy = r25.xy * float2(0.5,-0.5) + float2(0.5,0.5);
                    r36.x = lightConstantsCB[r19.w].data[9].w + r25.x;
                    r36.y = lightConstantsCB[r19.w].data[10].x + r25.y;
                    r25.xy = lightConstantsCB[r19.w].data[9].yz * r36.xy;
                    r36.xy = lightConstantsCB[r19.w].data[3].yy / lightConstantsCB[r19.w].data[8].yw;
                    ...
                    if (r25.z == 0) {
                      ...
                      r36.x = r25.x * lightConstantsCB[r19.w].data[8].y + lightConstantsCB[r19.w].data[8].z;
                      r36.y = r25.y * lightConstantsCB[r19.w].data[8].w + lightConstantsCB[r19.w].data[9].x;
                      r25.x = lightConstantsCB[r19.w].data[10].z * r24.y;
                      r22.x = lightConstantsCB[r19.w].data[10].y * r24.y + r22.x;
                      r22.x = r22.x / r25.x;
                    }
                  } else {
                    r25.z = -1;
                  ...
                  if (r24.y == 0) {
                    r22.x = max(6.10351563e-05, r22.x);
                    r24.y = 0x0000ffff & (int)lightConstantsCB[r19.w].data[1].w;
                    if (r9.w != 0) {
                      r25.z = (uint)r24.y;
                      r24.z = 0;
                      r26.w = 0;
                      while (true) {
                        ...
                        if (r29.w != 0) break;
                        r37.x = dot(icb[r26.w+0].xy, r28.xy);
                        r37.y = dot(icb[r26.w+0].yx, r28.xz);
                        r25.xy = r37.xy * lightConstantsCB[r19.w].data[3].yy + r36.xy;
                      ...
                      r36.z = (uint)r24.y;
                      r24.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r36.xyz, r22.x).x;
                    }
                    r19.w = r24.z * r24.z;
                    r19.w = r19.w * r24.z;
                  } else {
                  ...
                  if (4 == 0) r19.w = 0; else if (4+20 < 32) {                   r19.w = (uint)lightConstantsCB[r15.w].data[1].w << (32-(4 + 20)); r19.w = (uint)r19.w >> (32-4);                  } else r19.w = (uint)lightConstantsCB[r15.w].data[1].w >> 20;
                  r22.x = cmp(0 < (uint)r19.w);
                  r22.x = r22.x ? r4.z : 0;
                  if (r22.x != 0) {
                    r19.w = (int)r19.w + numLights;
                    r19.w = mad((int)r19.w, 15, -15);
                    r22.x = abs(r20.y) * -0.200000003 + 0.400000006;
                    r27.xyz = r11.xyz * r22.xxx + r10.xyz;
                    r36.xyz = lightConstantsCB[r19.w].data[6].yzw;
                    r36.w = lightConstantsCB[r19.w].data[7].x;
                    r22.x = dot(r36.xyzw, r27.xyzw);
                    r36.xyz = lightConstantsCB[r19.w].data[7].yzw;
                    r36.w = lightConstantsCB[r19.w].data[8].x;
                    r24.y = dot(r36.xyzw, r27.xyzw);
                    r25.x = cmp(r24.y < r22.x);
                    if (r25.x == 0) {
                      r36.xyz = lightConstantsCB[r19.w].data[4].yzw;
                      r36.w = lightConstantsCB[r19.w].data[5].x;
                      ...
                      r25.yz = r36.xy / r24.yy;
                      r25.yz = r25.yz * float2(0.5,-0.5) + float2(0.5,0.5);
                      r27.x = lightConstantsCB[r19.w].data[9].w + r25.y;
                      r27.y = lightConstantsCB[r19.w].data[10].x + r25.z;
                      r25.yz = lightConstantsCB[r19.w].data[9].yz * r27.xy;
                      ...
                      if (r26.w == 0) {
                        ...
                        r27.x = r25.y * lightConstantsCB[r19.w].data[8].y + lightConstantsCB[r19.w].data[8].z;
                        r27.y = r25.z * lightConstantsCB[r19.w].data[8].w + lightConstantsCB[r19.w].data[9].x;
                        r25.y = lightConstantsCB[r19.w].data[10].z * r24.y;
                        r22.x = lightConstantsCB[r19.w].data[10].y * r24.y + r22.x;
                        r22.x = r22.x / r25.y;
                      }
                    } else {
                    ...
                    if (r24.y == 0) {
                      ...
                      if (r9.w != 0) {
                        ...
                        while (true) {
                          r30.w = cmp((int)r29.w >= 8);
                          if (r30.w != 0) break;
                          r36.x = dot(icb[r29.w+0].xy, r29.xy);
                          r36.y = dot(icb[r29.w+0].yx, r29.xz);
                          r25.xy = r36.xy * lightConstantsCB[r19.w].data[3].yy + r27.xy;
                          r25.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r25.xyz, r22.x).x;
                        ...
                        r27.z = (uint)r24.y;
                        r26.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r27.xyz, r22.x).x;
                      }
                      r19.w = r26.w * r26.w;
                      r19.w = r19.w * r26.w;
                    } else {
                ...
                r19.w = r19.w + -r20.z;
                r19.w = r1.w * r19.w + r20.z;
                r19.w = r19.w * r16.w;
                r25.x = lightConstantsCB[r15.w].data[0].w;
                r25.yz = lightConstantsCB[r15.w].data[1].xy;
                r15.w = cmp(0 < r20.y);
                r27.xyz = r19.www * r25.xyz + r33.xyz;
                r19.w = saturate(dot(r11.xyz, r23.xyz));
                r21.xyw = r21.xyw * r19.zzz + r12.xyz;
                r19.z = dot(r21.xyw, r21.xyw);
                r19.z = rsqrt(r19.z);
                r21.xyw = r21.xyw * r19.zzz;
                r19.z = dot(r21.xyw, r12.xyz);
                r20.y = dot(r11.xyz, r21.xyw);
                r20.z = abs(r20.y) * r0.w + -abs(r20.y);
                r20.y = abs(r20.y) * r20.z + 1;
                r20.z = r19.w * r2.y + r3.z;
                r20.y = r20.y * r20.y;
                r20.y = r20.y * r20.z;
                r20.y = rcp(r20.y);
                r19.y = r19.w * r19.y;
                r19.y = r20.y * r19.y;
                r19.y = r19.y * r16.w;
                r21.xyw = r19.yyy * r25.xyz + r35.xyz;
                r19.z = saturate(1 + -r19.z);
                r19.w = r19.z * r19.z;
                r19.w = r19.w * r19.w;
                r19.z = r19.z * r19.w;
                r19.y = r19.y * r19.z;
                r19.yzw = r19.yyy * r25.xyz + r34.xyz;
                r33.xyz = r15.www ? r27.xyz : r33.xyz;
                r34.xyz = r15.www ? r19.yzw : r34.xyz;
                r35.xyz = r15.www ? r21.xyw : r35.xyz;
                r15.w = (int)r20.w & 255;
                r19.y = (int)r15.w + -1;
                r19.y = cmp((uint)r19.y < 32);
                r19.y = r2.z ? r19.y : 0;
                if (r19.y != 0) {
                  r19.yz = mad((int2)r15.ww, int2(24,24), int2(88,108));
                // Known bad code for instruction (needs manual fix):
  ...
  if (enableCountDebug != 0) {
    if (debugDrawOverlayType != 0) {
      switch (cb2[53].y) {
        ...
        break;
        case 4 :        r0.z = (int)r12.w & 255;
        break;
        case 5 :        if (8 == 0) r0.z = 0; else if (8+8 < 32) {         r0.z = (uint)r12.w << (32-(8 + 8)); r0.z = (uint)r0.z >> (32-8);        } else r0.z = (uint)r12.w >> 8;
        break;
        default :
        r0.z = 0;
        break;
