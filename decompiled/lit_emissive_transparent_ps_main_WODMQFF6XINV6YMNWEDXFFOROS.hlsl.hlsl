...
r5.w = samp0[]..swiz;
  ...
  r3.w = 1 + -r14.x;
  r0.xyz = r0.xyz * r3.www + r9.xzw;
  r0.w = r0.w * r3.w + r14.x;
  r2.yzw = r2.yzw * r3.www + r15.xyz;
  r4.w = dot(r2.yzw, r2.yzw);
  r4.w = rsqrt(r4.w);
  r7.xyz = r4.www * r2.yzw;
  r8.y = r1.w * r3.w + r14.y;
  r1.xyz = r1.xyz * r3.www + r16.xyz;
  r1.w = dot(-v6.xyz, -v6.xyz);
  r1.w = rsqrt(r1.w);
  r2.yzw = -v6.xyz * r1.www;
  r4.x = dot(r2.yzw, r4.xyz);
  r5.x = dot(r2.yzw, r5.xyz);
  r5.y = dot(r2.yzw, r6.xyz);
  r4.y = cmp(0 < r4.x);
  r4.zw = -r5.xy / r4.xx;
  r4.yz = r4.yy ? r4.zw : 0;
  r4.w = 9.99999975e-06 + relativeHDR;
  r4.yz = r4.yz * r4.ww + w1.xy;
  r5.xyzw = emissiveMap.Sample(colorSampler_s, r4.yz).xyzw;
  r4.yzw = emissiveTint1.xyz * r5.xyz;
  r4.x = saturate(r4.x);
  r5.x = log2(r4.x);
  ...
  r6.w = 100 * r6.w;
  r8.zw = -r5.ww * float2(10,5) + float2(6.85740995,7.08500004);
  r8.z = exp2(r8.z);
  r8.z = r8.x * r8.z;
  r9.w = r6.z * r5.w;
  ...
  r39.w = samp0[]..swiz;
    ...
    r29.x = dot(r7.xyz, r21.xyz);
    r29.y = dot(r7.xyz, r30.xyz);
    r29.z = dot(r7.xyz, r23.xyz);
  ...
  if (r8.w == 0) {
        ...
        r14.y = samp0[]..swiz;
          ...
          r34.w = samp0[]..swiz;
            ...
            r40.y = samp0[]..swiz;
              ...
              r35.x = dot(r7.xyz, r26.xyz);
              r35.y = dot(r7.xyz, r27.xyz);
    ...
    if (r3.y != 0) {
      ...
      r13.xyz = cmp(float3(0,0,0) < r7.xyz);
      ...
      r7.w = 0;
      r13.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r7.xyzw, 6).xyz;
      r10.yzw = r13.xyz * r10.yzw;
      r3.z = dot(r10.yzw, float3(0.212599993,0.715200007,0.0722000003));
      r19.xyz = r22.xyz * r3.xxx + r10.yzw;
      r11.w = 0;
      r10.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r11.xyzw, r6.z).xyz;
      r3.x = sunConstants.globalProbeExposure * r3.y + -r3.z;
      r3.x = r8.y * r3.x + r3.z;
      r20.xyz = r10.yzw * r3.xxx + r20.xyz;
    }
  } else {
    r20.x = r19.w;
  }
  ...
  r3.yz = r8.xy * float2(0.984375,0.984375) + float2(0.0078125,0.0078125);
  r3.yz = gEnvBRDFGeneric.SampleLevel(samplerLinear_s, r3.yz, 0).xy;
  r8.yzw = r20.xyz * r3.xxx;
  r14.xyz = r8.zwy * r3.yyy;
  r3.xyz = r8.yzw * r3.zzz;
  r2.x = sqrt(r5.z);
  r2.x = r2.x * 0.5 + 0.5;
  r2.x = r2.x * r2.x;
  r5.w = 0.5 * r2.x;
  ...
  r2.x = r6.z * r2.x;
  r5.w = r6.z * r5.w;
  r6.z = dot(r7.xyz, sunConstants.wldDir.xyz);
  r6.w = saturate(r6.z);
  r7.w = cmp(0 >= r6.w);
  if (r7.w != 0) {
    r8.y = 0;
  ...
  if (r7.w != 0) {
    r7.w = cmp(0 < r8.y);
    if (r7.w != 0) {
      r7.w = sunConstants.specScale * r5.y;
      r7.w = r7.w * r6.w;
      ...
      r1.w = dot(r16.xyz, r2.yzw);
      r8.z = dot(r7.xyz, r16.xyz);
      r8.w = abs(r8.z) * r5.y + -abs(r8.z);
      ...
      r6.w = r8.y * r6.w;
      r6.w = 0.25 * r6.w;
      r8.yzw = r6.www * r10.yzw + r3.xyz;
      r1.w = saturate(1 + -r1.w);
      r7.w = r1.w * r1.w;
      r7.w = r7.w * r7.w;
      r1.w = r7.w * r1.w;
      r1.w = r6.w * r1.w;
      r16.xyz = r1.www * r10.zwy + r14.xyz;
      r15.w = r16.z;
      r13.w = r14.z;
      r13.xyzw = r6.zzzz ? r15.xyzw : r13.xyzw;
      r16.zw = r8.yz;
      r14.zw = r3.xy;
      r15.xyzw = r6.zzzz ? r16.xyzw : r14.xyzw;
      r3.z = r6.z ? r8.w : r3.z;
      r14.z = r13.w;
      r14.xy = r15.xy;
      r3.xy = r15.zw;
  ...
  while (true) {
    ...
    if (r8.w != 0) break;
    r8.z = (uint)r7.w >> 5;
    r16.xyz = (int3)r8.xyz + (int3)r12.xyz;
            ...
            if (r26.w != 0) {
              ...
              if (r26.w != 0) {
                ...
                if (r26.w != 0) {
                  ...
                  r13.w = saturate(dot(r7.xyz, r39.xyz));
                  r38.xyz = r38.xyz * r12.www + r2.yzw;
                  r12.w = dot(r38.xyz, r38.xyz);
                  r12.w = rsqrt(r12.w);
                  r38.xyz = r38.xyz * r12.www;
                  r12.w = dot(r38.xyz, r2.yzw);
                  r18.x = dot(r7.xyz, r38.xyz);
                  r24.w = abs(r18.x) * r5.y + -abs(r18.x);
                  r18.x = abs(r18.x) * r24.w + 1;
                  r24.w = r13.w * r2.x + r5.w;
                  r18.x = r18.x * r18.x;
                  r18.x = r18.x * r24.w;
                  r18.x = rcp(r18.x);
                  r13.w = r13.w * r26.w;
            ...
            r39.w = samp0[]..swiz;
              ...
              if (r18.x != 0) {
                ...
                if (r18.x != 0) {
                  ...
                  r20.y = r20.y + -r14.w;
                  r20.y = r5.z * r20.y + r14.w;
                  r20.y = r20.y * r11.w;
                  r13.w = cmp(0 < r13.w);
                  r22.xyz = r20.yyy * r31.xyz + r16.xyz;
                  r19.xyz = r19.xyz * r12.www + r2.yzw;
                  r12.w = dot(r19.xyz, r19.xyz);
                  r12.w = rsqrt(r12.w);
                  r19.xyz = r19.xyz * r12.www;
                  r12.w = dot(r19.xyz, r2.yzw);
                  r19.x = dot(r7.xyz, r19.xyz);
                  r19.y = abs(r19.x) * r5.y + -abs(r19.x);
                  r19.x = abs(r19.x) * r19.y + 1;
                  r14.w = r14.w * r2.x + r5.w;
                  r19.x = r19.x * r19.x;
                  r14.w = r19.x * r14.w;
                  r14.w = rcp(r14.w);
                  r14.w = r14.w * r18.x;
