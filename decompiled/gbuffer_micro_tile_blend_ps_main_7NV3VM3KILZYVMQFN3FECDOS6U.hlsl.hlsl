// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:30:44 2021
  ...
  out float2 o3 : SV_TARGET3)
{
  ...
  r4.z = 1 + -weatherThreshold2;
  r4.z = max(9.99999975e-05, r4.z);
  r4.y = saturate(r4.y / r4.z);
  r2.y = r4.y * r2.y;
  r4.yzw = r6.xyz * weather.weatherTint.xyz + -r3.xyz;
  r3.xyz = r2.zzz * r4.yzw + r3.xyz;
  r4.yzw = r13.xyz * weather.weatherTint2.xyz + -r3.xyz;
  r3.xyz = r2.yyy * r4.yzw + r3.xyz;
  ...
  r3.w = min(1, r3.w);
  r7.w = r1.w * detailScaleHeight1 + r0.z;
  r1.xy = r4.zw * detailScaleHeight2 + r0.xy;
  r1.w = dot(r1.xyz, r1.xyz);
  r1.w = rsqrt(r1.w);
  r5.xyz = r1.xyz * r1.www;
  r5.w = r3.w * detailScaleHeight2 + r0.z;
  r1.w = r4.x * 1.9921875 + -1;
  r3.w = r4.x * r4.x;
  r3.w = 0.333333343 * r3.w;
  r3.w = min(1, r3.w);
  r1.xy = r1.ww * useUVOffsets1 + r0.xy;
  r0.x = dot(r1.xyz, r1.xyz);
  r0.x = rsqrt(r0.x);
  r1.xyz = r1.xyz * r0.xxx;
  r1.w = r3.w * useUVOffsets1 + r0.z;
  r5.xyzw = r5.xyzw + -r7.xyzw;
  r5.xyzw = r2.zzzz * r5.xyzw + r7.xyzw;
  r1.xyzw = -r5.xyzw + r1.xyzw;
  r1.xyzw = r2.yyyy * r1.xyzw + r5.xyzw;
  r0.x = -17 * r0.w;
  r0.x = exp2(r0.x);
  r0.x = r1.w + r0.x;
  r0.x = log2(r0.x);
  r0.x = saturate(-0.0588235296 * r0.x);
  r0.yzw = r11.xyz * r1.yyy;
  r0.yzw = r10.xyz * r1.xxx + r0.yzw;
  r0.yzw = r9.xyz * r1.zzz + r0.yzw;
