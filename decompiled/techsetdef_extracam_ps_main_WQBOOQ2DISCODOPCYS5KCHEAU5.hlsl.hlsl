  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  if (r0.x != 0) {
    r0.xyz = extracamTexture4.Sample(extracamSampler_s, v2.xy).xyz;
  } else {
    r0.w = cmp(extracamSelect == 3);
    if (r0.w != 0) {
      r0.xyz = extracamTexture3.Sample(extracamSampler_s, v2.xy).xyz;
    } else {
      r0.w = cmp(extracamSelect == 2);
      if (r0.w != 0) {
        r0.xyz = extracamTexture2.Sample(extracamSampler_s, v2.xy).xyz;
      } else {
        r0.xyz = extracamTexture1.Sample(extracamSampler_s, v2.xy).xyz;
      }
    }
  }
