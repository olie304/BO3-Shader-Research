// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:35:52 2021
...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  r1.z = r2.w * detailScaleHeight + r1.z;
  r4.xyzw = gameTime.wwww * flagScrollParms.xyzw;
  r4.xyzw = v2.xyxy * flagRippleScale + r4.xyzw;
  r2.yzw = flagRippleDetailMap.Sample(normalSampler_s, r4.xy).xyz;
  r2.yz = r2.yz * float2(1.9921875,1.9921875) + float2(-1,-1);
  r2.w = r2.w * r2.w;
  r2.w = 0.333333343 * r2.w;
  r2.w = min(1, r2.w);
  ...
  r3.w = min(1, r3.w);
  r3.xy = r2.yz * flagRippleHeight + r3.xy;
  r2.y = dot(r3.xyz, r3.xyz);
  r2.y = rsqrt(r2.y);
  r3.xyz = r3.xyz * r2.yyy;
  r1.z = r2.w * flagRippleHeight + r1.z;
  r3.xy = r4.xy * flagRippleHeight + r3.xy;
  r2.y = dot(r3.xyz, r3.xyz);
  r2.y = rsqrt(r2.y);
  r2.yzw = r3.xyz * r2.yyy;
  r1.z = r3.w * flagRippleHeight + r1.z;
  r3.x = v7.x ? 1 : -1;
  ...
  r4.xyz = r4.xyz * r2.yyy + r5.xyz;
  r2.yzw = r3.yzw * r2.www + r4.xyz;
  ...
  r1.z = rsqrt(r1.z);
  r3.xyz = r3.xyz * r1.zzz + -r2.yzw;
  r2.xyz = debugNormalOverride.www * r3.xyz + r2.yzw;
  ...
  r26.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r8.yz, r1.w, l(96), t15.xxyx
  r8.y = samp0[]..swiz;
  r8.z = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
  ...
  if (r1.z == 0) {
    ...
    if (r8.y != 0) {
      ...
      r9.z = 0;
      while (true) {
        r9.w = cmp((uint)r9.z >= (uint)r1.z);
        if (r9.w != 0) break;
        r12.z = (uint)r9.z >> 5;
        r13.xyz = (int3)r11.xyz + (int3)r12.xyz;
        r9.w = visibleProbes.Load(r13.xyzw).x;
        r11.w = cmp((int)r1.w == (int)r9.z);
  ...
  r8.yzw = r20.xyz * r1.zzz;
  r9.yzw = r8.yzw * r1.yyy;
  r13.xyz = r8.yzw * r1.www;
  r0.w = sqrt(r5.z);
  r0.w = r0.w * 0.5 + 0.5;
  r0.w = r0.w * r0.w;
  r1.y = 0.5 * r0.w;
  ...
  if (r1.w == 0) {
    ...
    r1.w = -sunConstants.splitDepthOffset + r8.w;
    ...
    if (r6.z == 0) {
      if (enableDitheredShadow == 0) {
        ...
        r14.z = r6.z + r3.w;
        r6.z = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r14.xyz, r1.w).x;
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          r16.z = (uint)r8.w;
          r8.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r1.w).x;
  ...
  if (r1.w != 0) {
    r1.w = cmp(0 < r2.w);
    if (r1.w != 0) {
      r1.w = sunConstants.specScale * r5.y;
      r1.w = 0.25 * r1.w;
