...
mul r13.xyz, r4.yyyy, r10.yzwy
mul r14.xyz, r4.wwww, r10.yzwy
sqrt r1.y, r4.z
...
if_nz r4.w
  ...
  if_nz r4.w
    mul r4.w, r3.y, cb2[18].w
    mul r4.w, r4.w, l(0.250000)
    if_nz cb2[23].x
      mov r6.w, l(1.000000)
      dp4 r7.w, cb2[24].xyzw, r6.xyzw
    ...
    if_nz r7.w
      ...
      mad r8.z, |r4.y|, l(-0.200000), l(0.400000)
      lt r9.w, r4.y, l(0.000000)
      movc r8.z, r9.w, -r8.z, r8.z
      mad r19.xyz, r2.xyzx, r8.zzzz, v7.xyzx
    ...
    add r6.w, -|r4.y|, r6.w
    mad r6.w, r4.z, r6.w, |r4.y|
    mul r6.w, r5.w, r6.w
    lt r7.w, l(0.000000), r4.y
    mad r15.xyz, r6.wwww, r6.yzxy, r12.xyzx
    mov_sat r4.y, r4.y
    mad r10.yzw, -v7.xxyz, r3.zzzz, cb2[17].xxyz
    dp3 r3.z, r10.yzwy, r10.yzwy
    rsq r3.z, r3.z
    mul r10.yzw, r3.zzzz, r10.yyzw
    dp3 r3.z, r10.yzwy, r5.xyzx
    dp3 r6.w, r2.xyzx, r10.yzwy
    mad r8.z, |r6.w|, r3.y, -|r6.w|
    mad r6.w, |r6.w|, r8.z, l(1.000000)
    mad r8.z, r4.y, r1.y, r2.w
    mul r6.w, r6.w, r6.w
    mul r6.w, r8.z, r6.w
    rcp r6.w, r6.w
    mul r4.y, r4.w, r4.y
    mul r4.y, r4.y, r6.w
    mul r4.y, r5.w, r4.y
    mad r16.yzw, r4.yyyy, r6.xxyz, r14.xxyz
    add_sat r3.z, -r3.z, l(1.000000)
    log r3.z, r3.z
    mul r3.z, r3.z, l(3.400000)
    exp r3.z, r3.z
    mul r3.z, r3.z, r4.y
    mad r6.xyz, r3.zzzz, r6.xyzx, r13.xyzx
    mov r15.w, r12.z
    mov r12.w, r15.z
          ...
          if_nz r15.w
            ...
            if_nz r15.w
              ...
              if_nz r15.w
                ...
                mad r44.xyz, r2.xyzx, r15.wwww, v7.xyzx
                ...
                loop 
                  ige r26.w, r25.w, l(8)
                  breakc_nz r26.w
                  dp2 r46.y, icb[r25.w + 0].yxyy, r6.xyxx
                  dp2 r46.z, icb[r25.w + 0].yxyy, r6.yzyy
              ...
              if_nz r15.w
                ...
                if_nz r13.w
                  ...
                  mad r19.xyz, r2.xyzx, r17.wwww, v7.xyzx
                  ...
                  if_z r19.x
                    ...
                    if_nz r7.w
                      ...
                      loop 
                        ige r27.w, r26.w, l(8)
                        breakc_nz r27.w
                        dp2 r44.x, icb[r26.w + 0].yxyy, r6.xwxx
                        dp2 r44.y, icb[r26.w + 0].xyxx, r8.xyxx
                        mad r19.xy, r44.xyxx, r13.wwww, r43.xyxx
                  ...
                  if_nz r13.w
                    ...
                    mad r20.xyz, r2.xyzx, r17.wwww, v7.xyzx
                    ...
                    if_z r19.x
                      ...
                      if_nz r7.w
                        ...
                        loop 
                          ...
                          mad r19.xy, r43.xyxx, r13.wwww, r20.xyxx
                          sample_c_lz_indexable(texture2darray)(float,float,float,float) r19.x, r19.xyzx, t9.xxxx, s13, r17.w
                ...
                movc r31.xyz, r13.wwww, r31.xyzx, r42.xyzx
          ...
          if_nz r13.w
            ...
            if_nz r14.w
              ...
              if_nz r13.w
                ...
                mul r13.w, r17.w, r27.w
              endif 
              mul r14.w, r13.w, r15.w
              and r13.w, r15.z, l(255)
              if_nz r13.w
            ...
            if_nz r13.w
              ...
              if_nz r13.w
                ...
                mad r22.xyz, r2.xyzx, r13.wwww, v7.xyzx
                mov r41.xyz, r40.xyzx
                dp4 r13.w, r41.xyzw, r22.xyzw
                dp4 r15.z, r43.xyzw, r22.xyzw
                ge r15.w, r15.z, r13.w
                if_nz r15.w
              ...
              if_nz r13.w
                ...
                if_nz r15.w
                  ...
                  mad r23.xyz, r2.xyzx, r17.wwww, v7.xyzx
                  ...
                  if_nz r15.w
                    ...
                    mad r24.xyz, r2.xyzx, r17.wwww, v7.xyzx
                ...
                mad r14.w, -|r12.w|, r4.x, l(1.000000)
...
mul r3.xyz, r0.xyzx, cb0[12].xyzx
mul r3.xyz, r3.xyzx, r28.xyzx
mad r0.xyz, r10.yzwy, r0.xyzx, r3.xyzx
add r3.xyz, -r1.xzwx, l(1.000000, 1.000000, 1.000000, 0.000000)
mul r3.xyz, r3.xyzx, r29.xyzx
mad r1.xyz, r30.xyzx, r1.xzwx, r3.xyzx
...
if_z r1.x
  ...
  if_nz r1.w
    ...
    bfi r3.y, l(1), l(0), cb0[12].w, r1.w
...
ret 
// Approximately 2623 instruction slots used
