  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.xy = (int2)v0.xy;
  r0.zw = float2(0,0);
  r1.x = GBufferNormalAndGloss.Load(r0.xyw).z;
  r1.y = GBufferSpecularColorAndOcclusion.Load(r0.xyw).z;
  r1.z = cmp(r1.x >= 0.5);
  r1.x = cmp(0 < r1.x);
  r1.x = r1.x ? 0.000000 : 0;
  r1.x = r1.z ? 2 : r1.x;
  r1.x = r1.x ? r1.y : 1;
  r1.y = cmp(0 < postFxControl0.x);
  if (r1.y != 0) {
    ...
    r0.x = rcp(r0.x);
    r2.xyzw = gSSAOTexture.Gather(LinearSampler_s, v1.xy).xyzw;
    r3.xyzw = gSSAODepthTexture.Gather(LinearSampler_s, v1.xy).xyzw;
    r0.yz = float2(0.5,0.5) * v0.xy;
    r0.yz = frac(r0.yz);
    r1.yz = float2(1,1) + -r0.zy;
    r4.y = r1.z * r1.y;
    r4.xz = r1.yz * r0.yz;
    r4.w = r0.y * r0.z;
    r0.y = dot(r2.xyzw, r4.xyzw);
    r3.xyzw = r3.xyzw + -r0.xxxx;
    r0.z = min(abs(r3.z), abs(r3.w));
    r0.z = min(abs(r3.y), r0.z);
    r0.z = min(abs(r3.x), r0.z);
    r0.w = max(abs(r3.z), abs(r3.w));
    r0.w = max(abs(r3.y), r0.w);
    r0.w = max(abs(r3.x), r0.w);
    r1.yzw = cmp(r0.zzz == abs(r3.yzw));
    r0.z = r1.y ? r2.y : r2.x;
    r0.z = r1.z ? r2.z : r0.z;
    r0.z = r1.w ? r2.w : r0.z;
    ...
    r0.y = gSSAOTexture.SampleLevel(LinearSampler_s, v1.xy, 0).x;
    r0.x = r1.x * r0.y;
  }
  o0.xyzw = r0.xxxx;
  return;
