// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:31:55 2021
...
// unknown dcl_: dcl_resource_structured t8, 64
  ...
  r3.w = 34.4561768 * wind3Parms.x;
  r4.w = wind3Parms.y * r1.x;
  r2.x = r2.x + r2.y;
  r1.x = r3.w * r1.x + r2.x;
  r1.x = v1.y * r1.x;
  r1.x = 0.0250000004 * r1.x;
  r2.x = r2.z + r2.w;
  r2.x = r4.w * 34.4561768 + r2.x;
  r2.x = v1.y * r2.x;
...
r4.w = gpuSkinBase[]..swiz;
  r4.xyzw = r2.zzzz ? r4.xyzw : float4(0,0,0,0);
  r1.x = cmp(0 != r4.w);
  if (r1.x != 0) {
    r1.x = (uint)r4.w;
    if (r1.x != 0) {
      r2.z = (int)r1.x + (int)v6.x;
    // Known bad code for instruction (needs manual fix):
    ...
    r8.w = gpuSkinBase[]..swiz;
      ...
      r2.z = r2.z + r8.w;
      r6.z = v5.x * r2.z;
      r2.z = dot(r8.xyz, r0.yzw);
      r7.z = v5.x * r2.z;
      r2.z = dot(r8.xyz, r3.xyz);
      r5.yz = v5.xx * r2.wz;
      r2.z = cmp(v5.y != 0.000000);
      if (r2.z != 0) {
        r2.z = (int)r1.x + (int)v6.y;
      // Known bad code for instruction (needs manual fix):
      ...
      r8.w = gpuSkinBase[]..swiz;
        ...
        r8.w = gpuSkinBase[]..swiz;
          ...
          r8.z = gpuSkinBase[]..swiz;
          r8.w = gpuSkinBase[]..swiz;
            r1.x = dot(r8.xyz, r1.yzw);
            r1.x = r1.x + r8.w;
            r6.z = r1.x * v5.w + r6.z;
            r1.x = dot(r8.xyz, r0.yzw);
            r7.z = r1.x * v5.w + r7.z;
      ...
      r1.x = rsqrt(r1.x);
      r0.yzw = r7.xyz * r1.xxx;
      r1.x = dot(r5.xyz, r5.xyz);
      r1.x = rsqrt(r1.x);
      r3.xyz = r5.xyz * r1.xxx;
    } else {
      r6.xyz = r1.yzw;
    }
  } else {
    ...
    r3.w = r7.y * r9.y + r2.w;
    r12.x = 1 + -r3.w;
    r13.x = r7.z * r9.x + -r1.x;
    r12.y = r7.y * r9.x + -r2.z;
    r14.xy = r7.yx * r9.xx + r2.zw;
    ...
    r8.x = dot(r3.xyz, r12.xyz);
    r8.y = dot(r3.xzy, r14.xzw);
    r8.z = dot(r3.xyz, r13.xyz);
    ...
    if (r1.x != 0) {
      ...
      r10.xyz = -r12.xyz + r1.yzw;
      r1.x = dot(r8.xyzw, r8.xyzw);
      r1.x = rsqrt(r1.x);
      ...
      r1.x = r11.y * r8.w;
      r2.zw = r11.zz * r8.wz;
      r3.w = r8.y * r11.y + r2.w;
      r14.x = 1 + -r3.w;
      r15.x = r8.z * r11.x + -r1.x;
      r14.y = r8.y * r11.x + -r2.z;
      r16.xy = r8.yx * r11.xx + r2.zw;
      ...
      r10.x = dot(r3.xyz, r14.xyz);
      r10.y = dot(r3.xzy, r16.xzw);
      r10.z = dot(r3.xyz, r15.xyz);
      ...
      if (r1.x != 0) {
        ...
        if (r1.x != 0) {
          ...
          r3.w = r8.y * r11.y + r2.w;
          r13.x = 1 + -r3.w;
          r14.x = r8.z * r11.x + -r1.x;
          r13.y = r8.y * r11.x + -r2.z;
          r15.xy = r8.yx * r11.xx + r2.zw;
          ...
          r10.x = dot(r3.xyz, r13.xyz);
          r10.y = dot(r3.xzy, r15.xzw);
...
r8.w = gpuSkinBase[]..swiz;
  ...
  r6.w = 1;
  r5.w = r9.x;
  r10.x = dot(r6.xyzw, r5.xyzw);
  r7.w = r9.y;
  r10.y = dot(r6.xyzw, r7.xyzw);
  r9.xyz = r8.xyz;
  r10.z = dot(r6.xyzw, r9.xyzw);
  ...
  r6.z = dot(r3.xyz, r9.xyz);
  r1.x = dot(r6.xyz, r6.xyz);
  r1.x = rsqrt(r1.x);
  r2.yzw = r6.xyz * r1.xxx;
  ...
  r4.xyzw = viewProjectionMatrix._m10_m11_m12_m13 * r10.yyyy;
  r4.xyzw = r10.xxxx * viewProjectionMatrix._m00_m01_m02_m03 + r4.xyzw;
  r4.xyzw = r10.zzzz * viewProjectionMatrix._m20_m21_m22_m23 + r4.xyzw;
  o0.xyzw = viewProjectionMatrix._m30_m31_m32_m33 + r4.xyzw;
  r1.x = (int)r2.x & 0x0fffffff;
  if (r1.x != 0) {
  // Known bad code for instruction (needs manual fix):
  ...
  r5.z = gpuSkinBase[]..swiz;
  r5.w = gpuSkinBase[]..swiz;
    r5.xyzw = r4.xxxx ? r5.xyzw : float4(0,0,0,0);
  // Known bad code for instruction (needs manual fix):
  ...
  r6.w = gpuSkinBase[]..swiz;
    r4.xyzw = r4.yyyy ? r6.xyzw : r5.xyzw;
    r1.x = cmp(0 != r4.w);
    if (r1.x != 0) {
      r1.x = (uint)r4.w;
      if (r1.x != 0) {
      ...
      r6.x = v6.x;
      r6.z = 0;
      r7.xyzw = gpuSkinQuat.Load(r6.xyz).xyzw;
      r8.xyzw = gpuSkinQuat.Load(r6.xwz).xyzw;
      r4.xyw = gpuSkinPos.Load(r6.xyz).xyz;
      r9.xyz = gpuSkinPos.Load(r6.xwz).xyz;
      r11.xyz = gpuSkinBase.Load(r6.xzz).xyz;
      r8.xyzw = r8.xyzw + -r7.xyzw;
      r7.xyzw = r4.zzzz * r8.xyzw + r7.xyzw;
      r8.xyz = r9.xyz + -r4.xyw;
      r4.xyw = r4.zzz * r8.xyz + r4.xyw;
      r8.xyz = -r11.xyz + r1.yzw;
      r1.x = dot(r7.xyzw, r7.xyzw);
      r1.x = rsqrt(r1.x);
      r7.xyzw = r7.xyzw * r1.xxxx;
      r9.xyz = r7.xyz + r7.xyz;
      r12.xyz = r9.xxx * r7.xzw;
      r1.x = r9.y * r7.w;
      r9.zw = r9.zz * r7.wz;
      r2.x = r7.y * r9.y + r9.w;
      r13.x = 1 + -r2.x;
      r14.x = r7.z * r9.x + -r1.x;
      r13.y = r7.y * r9.x + -r9.z;
      r15.xy = r7.yx * r9.xx + r9.zw;
      r15.z = r7.z * r9.y + -r12.z;
      r7.xyz = r7.zwy * r9.yyy + r12.zyx;
      r13.z = r7.y;
      r9.x = dot(r8.xyz, r13.xyz);
      r15.w = 1 + -r15.y;
      r9.y = dot(r8.xzy, r15.xzw);
      r14.yz = r7.xz * float2(1,-1) + float2(0,1);
      r9.z = dot(r8.xyz, r14.xyz);
      r7.xyz = r9.xyz + r11.xyz;
      r4.xyw = r7.xyz + r4.xyw;
      r5.xyz = v5.xxx * r4.xyw;
      r1.x = cmp(v5.y != 0.000000);
      if (r1.x != 0) {
        r6.x = v6.y;
        r7.xyzw = gpuSkinQuat.Load(r6.xyz).xyzw;
        ...
        if (r1.x != 0) {
          ...
          if (r1.x != 0) {
            ...
            r12.x = 1 + -r2.x;
            r13.x = r7.z * r9.x + -r1.x;
            r12.y = r7.y * r9.x + -r9.z;
            r14.xy = r7.yx * r9.xx + r9.zw;
            r14.z = r7.z * r9.y + -r11.z;
            r7.xyz = r7.zwy * r9.yyy + r11.zyx;
            r12.z = r7.y;
            r9.x = dot(r8.xyz, r12.xyz);
  ...
  r4.z = gpuSkinBase[]..swiz;
  r4.w = gpuSkinBase[]..swiz;
    r4.xyzw = r1.xxxx ? r4.xyzw : float4(0,0,0,0);
    r1.x = cmp(0 != r4.w);
    if (r1.x != 0) {
      r1.x = (uint)r4.w;
      if (r1.x != 0) {
      ...
      if (r1.x != 0) {
        ...
        if (r1.x != 0) {
          ...
          if (r1.x != 0) {
            ...
            r9.xyz = r8.xxx * r7.xzw;
            r1.w = r8.y * r7.w;
            r8.zw = r8.zz * r7.wz;
            r2.x = r7.y * r8.y + r8.w;
            r11.x = 1 + -r2.x;
            r12.x = r7.z * r8.x + -r1.w;
            r11.y = r7.y * r8.x + -r8.z;
            r13.xy = r7.yx * r8.xx + r8.zw;
            r13.z = r7.z * r8.y + -r9.z;
            r7.xyz = r7.zwy * r8.yyy + r9.zyx;
            r11.z = r7.y;
            ...
            r1.xyz = r8.xyz + r6.xyz;
            r1.xyz = r1.xyz + r4.xyz;
            r5.xyz = r1.xyz * v5.www + r5.xyz;
          }
        }
      }
    }
...
r6.w = gpuSkinBase[]..swiz;
  ...
  r5.w = 1;
  r1.w = r7.x;
  r0.x = dot(r5.xyzw, r1.xyzw);
  r4.w = r7.y;
  r1.x = dot(r5.xyzw, r4.xyzw);
  r7.xyz = r6.xyz;
  r1.y = dot(r5.xyzw, r7.xyzw);
  r4.xyzw = motionVectorConstants.prevFrameOffToClpMatrixFull._m10_m11_m12_m13 * r1.xxxx;
  r4.xyzw = r0.xxxx * motionVectorConstants.prevFrameOffToClpMatrixFull._m00_m01_m02_m03 + r4.xyzw;
  r1.xyzw = r1.yyyy * motionVectorConstants.prevFrameOffToClpMatrixFull._m20_m21_m22_m23 + r4.xyzw;
  o6.xyzw = motionVectorConstants.prevFrameOffToClpMatrixFull._m30_m31_m32_m33 + r1.xyzw;
  r0.x = dot(-r10.xyz, -r10.xyz);
  r0.x = rsqrt(r0.x);
  r1.xyz = -r10.xyz * r0.xxx;
  r4.x = dot(r1.xyz, r2.yzw);
  r4.y = dot(r1.xyz, r3.xyz);
  r0.x = dot(r1.xyz, r0.yzw);
  r1.x = cmp(0 < r0.x);
  r1.yz = -r4.xy / r0.xx;
  r1.xy = r1.xx ? r1.yz : 0;
  r1.zw = float2(-0.5,-0.5) + v2.xy;
  r0.x = 9.99999975e-06 + layerDepth;
  r1.xy = r1.xy * r0.xx;
  r1.xy = scaleUVs.xy * r1.xy;
  r1.xy = r1.zw * scaleUVs.xy + r1.xy;
  r1.xy = offsetUVs.xy * scaleUVs.xy + r1.xy;
  r0.x = rotateUVs.y * gameTime.w + 1;
  r0.x = rotateUVs.x * r0.x;
  r0.x = 0.0174532924 * r0.x;
  ...
  r1.xy = r1.xy * scaleUVs.xy + r5.xy;
  r0.x = gameTime.w * zoomRate;
  r0.x = cos(r0.x);
  r0.x = r0.x * 0.5 + 0.5;
  r0.x = 1 + -r0.x;
  r1.z = zoomUVs.y + -zoomUVs.x;
  r0.x = r0.x * r1.z + zoomUVs.x;
  r1.xy = r1.xy / r0.xx;
  r1.xy = float2(0.5,0.5) + r1.xy;
  r1.zw = saturate(r1.xy);
  o2.xy = clampU ? r1.zw : r1.xy;
  o1.xyzw = v1.xyzw;
  o3.xyz = r0.yzw;
  o4.xyz = r2.yzw;
  o5.xyz = r3.xyz;
