...
r0.x = samp0[]..swiz;
  ...
  if (1 == 0) r5.z = 0; else if (1+19 < 32) {   r5.z = (uint)r0.x << (32-(1 + 19)); r5.z = (uint)r5.z >> (32-1);  } else r5.z = (uint)r0.x >> 19;
  if (1 == 0) r5.w = 0; else if (1+20 < 32) {   r5.w = (uint)r0.x << (32-(1 + 20)); r5.w = (uint)r5.w >> (32-1);  } else r5.w = (uint)r0.x >> 20;
  r0.x = dot(-r2.xy, -r2.xy);
  r0.x = rsqrt(r0.x);
  r6.xz = -r2.yx * r0.xx;
  r6.y = 0;
  r3.x = r7.w;
  r8.xyz = r3.yzx * r6.xyz;
  r6.xyz = r3.xyz * r6.yzx + -r8.xyz;
  ...
  r7.yz = r4.xy * r7.xy;
  r6.xyz = r6.xyz * r7.yyy + r2.xyz;
  r6.xyz = r3.zxy * r7.zzz + r6.xyz;
  r3.w = r7.x;
  ...
  if (r0.z != 0) {
    ...
    // No code for instruction (needs manual fix):
      ...
      r4.xz = r5.zz * r4.xz;
      r4.xz = (uint2)r4.xz;
      r4.xz = (int2)r4.xz + (int2)r6.yy;
      r0.xy = r9.zz ? r4.xz : r0.xy;
      r0.y = r7.z ? r0.y : r0.x;
  ...
  if (r1.x != 0) {
    ...
    while (true) {
      ...
      while (true) {
        ...
        r6.y = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r13.xyzw, r4.w, l(68), t12.xyzw
        r13.x = samp0[]..swiz;
        r13.y = samp0[]..swiz;
        r13.z = samp0[]..swiz;
        r13.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r14.xyzw, r4.w, l(84), t12.xyzw
        r14.x = samp0[]..swiz;
        r14.y = samp0[]..swiz;
        r14.z = samp0[]..swiz;
        r14.w = samp0[]..swiz;
          ...
          switch (r5.w) {
            case 2 :          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r16.xyzw, r4.w, l(116), t12.xyzw
          r16.x = samp0[]..swiz;
          r16.y = samp0[]..swiz;
          r16.z = samp0[]..swiz;
          r16.w = samp0[]..swiz;
            r5.w = dot(r16.xyzw, r2.xyzw);
            r6.z = cmp(r5.w < 1);
            if (r6.z != 0) {
              r15.xyz = r9.xyz;
              break;
          ...
          r18.w = samp0[]..swiz;
            ...
            r7.w = r8.w * r7.w;
            r6.z = r7.w * r6.z;
            r19.x = dot(r13.xyzw, r2.xyzw);
            r19.y = dot(r14.xyzw, r2.xyzw);
            r7.xy = r19.xy / r5.ww;
            r7.w = cmp(r16.w < 0.00048828125);
            if (r7.w != 0) {
              r17.y = r18.x;
              r14.yz = saturate(abs(r7.xy) * r17.zw + r17.xy);
              ...
              r16.w = r17.y;
              r16.xyzw = saturate(r16.xyzw * abs(r7.yyxx));
              r16.xyzw = log2(r16.xyzw);
              r16.xyzw = r17.xxxx * r16.xyzw;
              r16.xyzw = exp2(r16.xyzw);
              r14.yz = r16.xy + r16.zw;
              r14.yz = log2(r14.yz);
              r14.yz = r18.xx * r14.yz;
              r14.yz = exp2(r14.yz);
              r8.w = r17.z * r14.y;
              r14.y = r17.w * r14.z + -1;
              r8.w = r17.w * r14.z + -r8.w;
              r8.w = saturate(r14.y / r8.w);
              r14.y = r8.w * r8.w;
              r8.w = r8.w * -2 + 3;
              r8.w = r14.y * r8.w;
              r7.w = r8.w * r6.z;
          ...
          r6.z = samp0[]..swiz;
            ...
            if (r6.z != 0) {
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r14.yzw, r4.w, l(220), t12.xxyz
            r14.y = samp0[]..swiz;
            r14.z = samp0[]..swiz;
            r14.w = samp0[]..swiz;
              r8.w = dot(r18.yzw, r7.xyz);
              r14.y = dot(r14.yzw, r7.xyz);
              r16.x = frac(r8.w);
              r16.y = frac(r14.y);
              r6.z = (int)r6.z + -1;
              r16.z = (uint)r6.z;
              ...
              r11.w = r10.w;
              r11.xyz = r14.yzw * r11.wyz;
            } else {
              r11.x = r10.w;
            }
            if (3 == 0) r6.z = 0; else if (3+27 < 32) {             r6.z = (uint)r12.x << (32-(3 + 27)); r6.z = (uint)r6.z >> (32-3);            } else r6.z = (uint)r12.x >> 27;
            r6.z = cmp((int)r6.z != 1);
            if (r6.z != 0) {
            // Known bad code for instruction (needs manual fix):
            ...
            r17.z = samp0[]..swiz;
            r17.w = samp0[]..swiz;
              r7.xy = saturate(r7.xy * float2(0.5,-0.5) + float2(0.5,0.5));
              r4.w = dot(r16.xyzw, r2.xyzw);
              r4.w = r4.w / r5.w;
              r16.xy = r7.xy * r17.xz + r17.yw;
              r5.w = (int)r12.x & 0x0000ffff;
              r16.z = (uint)r5.w;
              r4.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r4.w).x;
            } else {
              r4.w = 1;
            }
            r4.w = r7.w * r4.w;
            ...
            if (3 == 0) r5.w = 0; else if (3+27 < 32) {             r5.w = (uint)r12.x << (32-(3 + 27)); r5.w = (uint)r5.w >> (32-3);            } else r5.w = (uint)r12.x >> 27;
            r5.w = cmp((int)r5.w != 1);
            if (r5.w != 0) {
              r16.xyz = -r13.xyz + r2.xyz;
              r5.w = max(abs(r16.y), abs(r16.z));
              r5.w = max(abs(r16.x), r5.w);
              r5.w = r13.w / r5.w;
              r5.w = r5.w + r14.x;
              r6.x = (int)r12.x & 0x0000ffff;
              r16.w = (uint)r6.x;
              r5.w = gOmniShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyzw, r5.w).x;
            } else {
              r5.w = 1;
            }
            r4.w = r5.w * r4.w;
