// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:29:10 2021
...
r0.x = colorSampler[]..swiz;
  ...
  r3.y = transGlossMap.Sample(transitionSampler_s, r0.yz).x;
  if (r3.x != 0) {
    r3.xzw = float3(-1,-1,-1) + transColorTint.xyz;
    r3.xzw = r4.www * r3.xzw + float3(1,1,1);
    r3.xzw = r4.xyz * r3.xzw;
    r4.x = w1.x * r4.w;
    r4.y = transGlossRange.y + -transGlossRange.x;
    r3.y = r3.y * r4.y + transGlossRange.x;
    r3.y = saturate(0.0588235296 * r3.y);
    r0.x = r4.x * r0.x;
    r3.xzw = r3.xzw * v1.xyz + -r1.xyz;
    r1.xyz = r0.xxx * r3.xzw + r1.xyz;
    r3.x = r3.y * 2 + -1;
    r3.x = r0.x * r3.x + 1;
  ...
  r3.z = min(1, r3.z);
  r4.x = cmp(0 < r0.x);
  r4.yzw = transNormalMap.Sample(transitionSampler_s, r0.yz).xyz;
  if (r4.x != 0) {
    r4.xyz = float3(-0.5,-0.5,-0) + r4.yzw;
  ...
  r3.xyw = r5.xyz * r3.www + r6.xyz;
  r0.z = dot(r3.xyw, r3.xyw);
  r0.z = rsqrt(r0.z);
  r3.xyw = r3.xyw * r0.zzz;
  r0.z = debugGlossOverride.x * r2.w + glossRange.x;
  ...
  o2.z = debugOcclusionOverride.w * r0.z + r0.w;
  r2.xyz = v8.xxx ? v4.xyz : -v4.xyz;
  r0.z = dot(r2.xyz, r2.xyz);
  r0.z = rsqrt(r0.z);
  r2.xyz = r2.xyz * r0.zzz + -r3.xyw;
  r2.yzw = debugNormalOverride.www * r2.xyz + r3.xyw;
  r0.zw = v7.xy / v7.ww;
  r3.xy = float2(0.5,0.5) * renderTargetSize.xy;
  r6.x = r3.x * r0.z;
  r6.y = -r3.y * r0.w;
  r0.zw = renderTargetSize.xy * float2(0.5,0.5) + r6.xy;
  r0.zw = v0.xy + -r0.zw;
  r1.w = r5.x + r5.y;
  r1.w = r4.z * r0.x + r1.w;
  r1.w = 0.5 * r1.w;
  r3.xyz = r4.xyz * r0.xxx + -r1.www;
  r0.x = max(r3.y, r3.z);
  r0.x = max(r3.x, r0.x);
  r0.x = max(r1.w, r0.x);
  r1.w = cmp(r0.x == r3.x);
