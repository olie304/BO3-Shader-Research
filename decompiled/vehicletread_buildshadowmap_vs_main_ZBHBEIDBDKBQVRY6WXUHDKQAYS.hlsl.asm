...
if_nz r0.y
  ...
  if_nz r0.y
    ...
    if_nz r0.z
      ...
      dp3 r0.w, r3.xyzx, v0.xyzx
      add r0.w, r3.w, r0.w
      mad r2.x, r0.w, v2.y, r2.x
      ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r3.xyzw, r0.z, l(16), t5.xyzw
      dp3 r0.w, r3.xyzx, v0.xyzx
      add r0.w, r3.w, r0.w
      mad r2.y, r0.w, v2.y, r2.y
      ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r3.xyzw, r0.z, l(32), t5.xyzw
      dp3 r0.z, r3.xyzx, v0.xyzx
      add r0.z, r3.w, r0.z
      mad r2.z, r0.z, v2.y, r2.z
      ...
      if_nz r0.z
        ...
        dp3 r0.w, r3.xyzx, v0.xyzx
        add r0.w, r3.w, r0.w
        mad r2.x, r0.w, v2.z, r2.x
        ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r3.xyzw, r0.z, l(16), t5.xyzw
        dp3 r0.w, r3.xyzx, v0.xyzx
        add r0.w, r3.w, r0.w
        mad r2.y, r0.w, v2.z, r2.y
        ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r3.xyzw, r0.z, l(32), t5.xyzw
        dp3 r0.z, r3.xyzx, v0.xyzx
        add r0.z, r3.w, r0.z
        mad r2.z, r0.z, v2.z, r2.z
  ...
  if_nz r0.y
    ...
    add r1.xyw, r6.xyxz, r5.xyxz
    add r0.yzw, r0.yyzw, r1.xxyw
    mad r2.xyz, r0.yzwy, v2.yyyy, r2.xyzx
    ...
    if_nz r0.y
      ...
      add r1.xyw, r6.xyxz, r5.xyxz
      add r0.yzw, r0.yyzw, r1.xxyw
      mad r2.xyz, r0.yzwy, v2.zzzz, r2.xyzx
      ...
      if_nz r0.y
        ...
        mad r2.xyz, r0.yzwy, v2.wwww, r2.xyzx
      endif 
    endif 
  endif 
endif 
...
ne r1.x, cb0[10].w, l(0.000000)
movc r0.z, r1.x, r0.w, r0.z
mad r0.zw, r0.zzzz, cb0[10].xxxy, v1.xxxy
sample_l_indexable(texture2d)(float,float,float,float) r0.z, r0.zwzz, t6.yzxw, s1, l(0.000000)
