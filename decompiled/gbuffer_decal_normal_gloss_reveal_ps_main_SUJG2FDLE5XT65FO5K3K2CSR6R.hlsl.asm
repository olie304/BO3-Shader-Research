...
mul r1.xyzw, r0.yzyz, cb0[13].xyxy
movc r2.xy, cb0[12].wwww, r1.zwzz, r0.yzyy
mul r2.xy, r2.xyxx, cb0[10].zwzz
...
mad r0.w, r0.w, r2.w, cb0[11].y
mul_sat r0.w, r0.w, l(0.05882353)
mad r1.xyzw, cb0[14].xyzw, cb1[69].wwww, r1.xyzw
sample_indexable(texture2d)(float,float,float,float) r3.xyz, r1.xyxx, t10.xyzw, s4
...
sample_indexable(texture2d)(float,float,float,float) r3.yzw, r1.zwzz, t10.wxyz, s4
add r3.yzw, r3.yyzw, l(0.000000, -0.500000, -0.500000, -0.000000)
mad r3.yzw, cb0[15].yyyy, r3.yyzw, l(0.000000, 0.500000, 0.500000, 0.000000)
mad r1.xy, r3.yzyy, l(1.99218750, 1.99218750, 0.000000, 0.000000), r1.xyxx
mul r1.z, r3.w, r3.w
...
mad r1.xyw, r3.yzyw, r1.wwww, r4.xyxz
dp3 r3.y, r1.xywx, r1.xywx
rsq r3.y, r3.y
mul r1.xyw, r1.xyxw, r3.yyyy
mad r2.w, cb1[62].x, r2.w, cb0[11].y
...
if_nz r2.w
  ...
  and r3.yzw, r2.wwww, l(0, 1, 2, 4)
  movc r4.xyz, r3.yyyy, l(1.000000,0,1.000000,0), r2.xyzx
  movc r5.xyz, r3.zzzz, l(0,1.000000,1.000000,0), r2.xyzx
  movc r4.xyz, r0.yyyy, r4.xyzx, r5.xyzx
  movc r3.yzw, r3.wwww, l(0,0,1.000000,0), r2.xxyz
  movc r2.xyz, r0.zzzz, r4.xyzx, r3.yzwy
endif 
add r3.yzw, -r2.xxyz, cb1[58].xxyz
mad o0.xyz, cb1[58].wwww, r3.yzwy, r2.xyzx
add r0.y, -r0.x, cb1[59].x
mad r0.x, cb1[59].w, r0.y, r0.x
add r0.y, -r0.w, r1.z
mad r0.y, cb1[62].w, r0.y, r0.w
mad r2.xyz, v5.xyzx, r3.xxxx, -r1.xywx
mad r1.xyz, cb1[60].wwww, r2.xyzx, r1.xywx
ftou r2.xy, v0.xyxx
mov r2.zw, l(0,0,0,0)
