...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:32:02 2021
//
//
// Buffer Definitions: 
//
...
mul r1.x, r0.w, v1.w
sample_indexable(texture2d)(float,float,float,float) r1.y, v2.xyxx, t21.yxzw, s3
...
movc r4.xyz, v7.xxxx, r4.yzwy, -r4.yzwy
...
if_nz r8.w
  ...
  if_nz r8.w
    ...
    mad r11.yzw, -v6.xxyz, r4.yyyy, cb2[17].xxyz
          ...
          if_nz r24.w
            ...
            if_nz r24.w
              ...
              if_nz r24.w
                ...
                mad r35.xyz, r3.xyzx, r24.wwww, v6.xyzx
          ...
          if_nz r18.w
            ...
            if_nz r18.w
              ...
              if_nz r18.w
                ...
                mad r22.xyz, r3.xyzx, r18.wwww, v6.xyzx
...
ret 
// Approximately 1826 instruction slots used
