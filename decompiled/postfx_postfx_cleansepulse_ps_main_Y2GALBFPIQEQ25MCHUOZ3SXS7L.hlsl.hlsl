...
Texture2D<float4> pixelTexture : register(t6);
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.x = r0.x ? 0 : r0.w;
  r0.yz = float2(45,600) * v1.xy;
  r0.y = floor(r0.y);
  r0.y = 1234.12341 * r0.y;
  r0.y = cos(r0.y);
  r0.y = 123.456001 * r0.y;
  r0.y = frac(r0.y);
  r0.w = 720 * gameTime.w;
  r0.y = r0.w * r0.y + r0.z;
  r0.y = 0.0666666701 * r0.y;
  r0.y = floor(r0.y);
  r0.y = 0.0416666679 * r0.y;
  r0.z = cmp(r0.y >= -r0.y);
  r0.y = frac(abs(r0.y));
  r0.y = r0.z ? r0.y : -r0.y;
  r0.y = r0.y * 24 + 4;
  r0.y = max(0, r0.y);
  r1.xyzw = pixelTexture.Sample(samp0_s, v1.xy).xyzw;
  ...
  r2.w = dot(r2.xyz, float3(0.349999994,0.5,0.150000006));
  r0.z = dot(r2.yww, r2.yww);
  r3.x = sqrt(r0.z);
  r3.y = r3.x * r0.y;
  r3.z = 0;
  r0.yzw = float3(0.5,0.5,0.5) * r3.zxz;
  r0.yzw = r3.xyy * float3(0,0.0625,0.0187500007) + r0.yzw;
  r2.xyz = r2.wyw + r0.yzw;
