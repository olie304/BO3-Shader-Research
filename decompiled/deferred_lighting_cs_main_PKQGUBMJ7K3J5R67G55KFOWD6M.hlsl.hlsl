...
r0.y = samp0[]..swiz;
  ...
  r0.y = (uint)r0.y >> 24;
  r14.y = cmp((uint)r0.y >= (uint)r13.w);
  r14.z = cmp((uint)r0.y < numRefProbes);
  r14.y = r14.z ? r14.y : 0;
  if (r14.y != 0) {
    r14.y = (int)r0.y * 14;
    r15.yzw = -refProbeConstantsCB[r14.y].data[0].xyz + r11.xyz;
    ...
    r18.x = 1;
    r17.z = refProbeConstantsCB[r14.y].data[6].x;
    r19.xy = r17.xy;
    r17.w = 1;
    while (true) {
    ...
    r14.z = refProbeConstantsCB[r14.y].data[6].y * r19.y;
    r14.w = cmp(0 < r14.z);
    if (r14.w != 0) {
      r14.w = refProbeConstantsCB[r14.y].data[7].y * r14.z;
      r17.x = refProbeConstantsCB[r14.y].data[7].w;
      r17.yz = refProbeConstantsCB[r14.y].data[8].xy;
      ...
      r18.x = refProbeConstantsCB[r14.y].data[8].w;
      r18.yz = refProbeConstantsCB[r14.y].data[9].xy;
      r17.y = dot(r16.xyz, r18.xyz);
      r17.z = dot(r15.yzw, r18.xyz);
      r17.z = -refProbeConstantsCB[r14.y].data[9].z + r17.z;
      r17.w = cmp(r17.z >= 0);
      ...
      r18.x = refProbeConstantsCB[r14.y].data[9].w;
      r18.yz = refProbeConstantsCB[r14.y].data[10].xy;
      r17.y = dot(r16.xyz, r18.xyz);
      r17.z = dot(r15.yzw, r18.xyz);
      r17.z = -refProbeConstantsCB[r14.y].data[10].z + r17.z;
      r17.w = cmp(r17.z >= 0);
      r17.z = max(abs(r17.z), r8.w);
      r17.z = r17.w ? r17.z : -r17.z;
      r17.y = max(1.00000001e-07, -r17.y);
      r17.y = r17.z / r17.y;
      r17.x = min(r17.x, abs(r17.y));
      r18.x = refProbeConstantsCB[r14.y].data[10].w;
      r18.yz = refProbeConstantsCB[r14.y].data[11].xy;
      r17.y = dot(r16.xyz, r18.xyz);
      r17.z = dot(r15.yzw, r18.xyz);
      r17.z = -refProbeConstantsCB[r14.y].data[11].z + r17.z;
      r17.w = cmp(r17.z >= 0);
      r17.z = max(abs(r17.z), r8.w);
      r17.z = r17.w ? r17.z : -r17.z;
      r17.y = max(1.00000001e-07, -r17.y);
      r17.y = r17.z / r17.y;
      r17.x = min(r17.x, abs(r17.y));
      r18.x = refProbeConstantsCB[r14.y].data[11].w;
      r18.yz = refProbeConstantsCB[r14.y].data[12].xy;
      r17.y = dot(r16.xyz, r18.xyz);
      r17.z = dot(r15.yzw, r18.xyz);
      r17.z = -refProbeConstantsCB[r14.y].data[12].z + r17.z;
      r17.w = cmp(r17.z >= 0);
      r17.z = max(abs(r17.z), r8.w);
      r17.z = r17.w ? r17.z : -r17.z;
      r17.y = max(1.00000001e-07, -r17.y);
      r17.y = r17.z / r17.y;
      r17.x = min(r17.x, abs(r17.y));
      r18.x = refProbeConstantsCB[r14.y].data[12].w;
      r18.yz = refProbeConstantsCB[r14.y].data[13].xy;
      r17.y = dot(r16.xyz, r18.xyz);
      r17.z = dot(r15.yzw, r18.xyz);
      r17.z = -refProbeConstantsCB[r14.y].data[13].z + r17.z;
      r17.w = cmp(r17.z >= 0);
      r17.z = max(abs(r17.z), r8.w);
      r17.z = r17.w ? r17.z : -r17.z;
      r17.y = max(1.00000001e-07, -r17.y);
      r17.y = r17.z / r17.y;
      r17.x = min(r17.x, abs(r17.y));
      r18.x = refProbeConstantsCB[r14.y].data[3].w + r15.y;
      r18.yz = refProbeConstantsCB[r14.y].data[4].xy + r15.zw;
      ...
      r18.x = refProbeConstantsCB[r14.y].data[0].w;
      r18.y = refProbeConstantsCB[r14.y].data[1].z;
      r18.z = refProbeConstantsCB[r14.y].data[2].y;
      r19.x = dot(r17.yzw, r18.xyz);
      r20.xy = refProbeConstantsCB[r14.y].data[1].xw;
      r20.z = refProbeConstantsCB[r14.y].data[2].z;
      r19.y = dot(r17.yzw, r20.xyz);
      r21.x = refProbeConstantsCB[r14.y].data[1].y;
      r21.yz = refProbeConstantsCB[r14.y].data[2].xw;
      r19.z = dot(r17.yzw, r21.xyz);
      if (9 == 0) r17.y = 0; else if (9+16 < 32) {       r17.y = (uint)refProbeConstantsCB[r14.y].data[7].z << (32-(9 + 16)); r17.y = (uint)r17.y >> (32-9);      } else r17.y = (uint)refProbeConstantsCB[r14.y].data[7].z >> 16;
      r19.w = (uint)r17.y;
      ...
      r15.yzw = saturate(r22.xyz * refProbeConstantsCB[r14.y].data[3].xyz + float3(0.5,0.5,0.5));
      r22.xy = refProbeConstantsCB[r14.y].data[4].zw * r15.yz;
      r22.z = refProbeConstantsCB[r14.y].data[5].x * r15.w;
      r15.yzw = refProbeConstantsCB[r14.y].data[5].yzw + r22.xyz;
      ...
      r14.y = r9.w * r14.y + r14.w;
      r14.y = r17.w / r14.y;
      r17.xyz = r17.xyz * r14.yyy;
    } else {
  ...
  r14.y = cmp(r14.z < 1);
  if (r14.y != 0) {
    r13.w = cmp((uint)r0.y < (uint)r13.w);
    if (r13.w != 0) {
      r0.y = (int)r0.y * 14;
      r18.xyz = -refProbeConstantsCB[r0.y].data[0].xyz + r11.xyz;
      r13.w = 0x0000ffff & (int)refProbeConstantsCB[r0.y].data[7].z;
      if (6 == 0) r14.y = 0; else if (6+25 < 32) {       r14.y = (uint)refProbeConstantsCB[r0.y].data[7].z << (32-(6 + 25)); r14.y = (uint)r14.y >> (32-6);      } else r14.y = (uint)refProbeConstantsCB[r0.y].data[7].z >> 25;
      r14.w = (int)r13.w * 6;
      ...
      r13.w = saturate(r21.y + -r14.z);
      r14.y = refProbeConstantsCB[r0.y].data[6].y * r13.w;
      r14.w = cmp(0 < r14.y);
      if (r14.w != 0) {
        r14.z = r13.w * refProbeConstantsCB[r0.y].data[6].y + r14.z;
        r13.w = refProbeConstantsCB[r0.y].data[7].y * r14.y;
        ...
        r18.w = cmp(r17.w >= 0);
        r8.w = max(abs(r17.w), r8.w);
        r8.w = r18.w ? r8.w : -r8.w;
        r14.w = max(1.00000001e-07, -r14.w);
        r8.w = r8.w / r14.w;
        r8.w = min(r14.y, abs(r8.w));
  ...
  r4.w = cmp(r14.z < 0.99000001);
  if (r4.w != 0) {
    r4.w = 1 + -r14.z;
    r8.w = sunConstants.globalProbeExposure * r4.w;
    r14.yzw = -globalProbeConstants.data[0].xyz + r11.xyz;
    r19.x = globalProbeConstants.data[0].w * r14.y;
    r19.yz = globalProbeConstants.data[1].xy * r14.zw;
    r14.yzw = saturate(float3(0.5,0.5,0.5) + r19.xyz);
    r19.xy = globalProbeConstants.data[1].zw * r14.yz;
    r19.z = globalProbeConstants.data[2].x * r14.w;
    r14.yzw = globalProbeConstants.data[2].yzw + r19.xyz;
    r19.xyz = cmp(float3(0,0,0) < r12.xyz);
    r19.xyz = r19.xyz ? float3(0,0,0) : float3(0.5,0.5,0.5);
    r19.w = 0;
    r20.xyz = r19.wwx + r14.yzw;
    r20.xyz = gProbeXArray.SampleLevel(samplerLinearClamp_s, r20.xyz, 0).xyz;
    r21.xyz = r12.xyz * r12.xyz;
    r21.xyz = r21.xyz * r8.www;
    r22.xyz = r19.wwy + r14.yzw;
    ...
    r18.xyz = r15.yzw * r0.yyy + r14.yzw;
    r16.w = 0;
  ...
  if (r5.z != 0) {
    ...
    if (r5.z != 0) {
      ...
      r7.w = r7.w * r6.w;
      r3.z = cmp(0 < r3.z);
      r19.xyz = r7.www * r14.yzw + r18.xyz;
      ...
      r20.zw = r15.yz;
      r17.zw = r2.yz;
      r19.xyzw = r3.zzzz ? r20.xyzw : r17.xyzw;
