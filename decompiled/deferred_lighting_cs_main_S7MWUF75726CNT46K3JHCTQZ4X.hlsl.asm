...
loop 
  ...
  if_nz r15.w
    ...
    ubfe r18.y, l(6), l(25), cb10[r14.w + 7].z
    ...
    if_nz r18.y
      ...
      dp3 r18.y, r17.xyzx, r28.xyzx
      dp3 r18.z, r16.yzwy, r28.xyzx
      add r18.z, r18.z, -cb10[r14.w + 8].z
      ...
      dp3 r18.z, r17.xyzx, r28.xyzx
      dp3 r18.w, r16.yzwy, r28.xyzx
      ...
      div r18.z, r18.w, r18.z
      min r18.y, |r18.z|, r18.y
      add r28.x, r16.y, cb10[r14.w + 3].w
      add r28.yz, r16.zzwz, cb10[r14.w + 4].xxyx
      mad r27.xzw, r17.xxyz, r18.yyyy, r28.xxyz
      dp3 r18.z, r27.xzwx, r27.xzwx
      sqrt r18.z, r18.z
      ...
      ubfe r18.z, l(9), l(16), cb10[r14.w + 7].z
      utof r29.w, r18.z
      ...
      or r19.x, r27.z, r27.x
      or r19.x, r27.w, r19.x
      ...
      mad_sat r16.yzw, r32.xxyz, cb10[r14.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
      mul r32.xy, r16.yzyy, cb10[r14.w + 4].zwzz
      mul r32.z, r16.w, cb10[r14.w + 5].x
      add r16.yzw, r32.xxyz, cb10[r14.w + 5].yyzw
      ...
      mad r14.w, r10.w, r14.w, r15.w
      div r14.w, r16.y, r14.w
      mov r28.x, r24.w
      mov r28.yz, r25.xxyx
      mad r16.yzw, r18.yyzw, r14.wwww, r28.xxyz
      mov r24.w, r16.y
      mov r25.xy, r16.zwzz
    else 
...
loop 
  ...
  if_nz r15.w
    ...
    movc r27.zw, r20.wwww, r19.xxxy, r19.zzzx
    mov r19.x, cb10[r14.w + 6].x
    mov r28.xy, r27.zwzz
    mov r20.w, l(1)
    loop 
      ...
      movc r21.w, r28.w, r22.w, r29.x
      movc r28.xy, r28.zzzz, r28.xyxx, r21.zwzz
      iadd r20.w, r20.w, l(1)
      mov r19.x, r26.w
    endloop 
    add_sat r15.w, -r25.z, r28.y
    ...
    if_nz r19.w
      ...
      if_nz r20.w
        ...
        store_structured u2.x, cb2[52].x, r27.w, r19.x
      endif 
      iadd r21.y, r21.y, l(257)
      mad r21.x, r15.w, cb10[r14.w + 6].y, r21.x
      mul r15.w, r19.x, cb10[r14.w + 7].y
      mov r29.x, cb10[r14.w + 7].w
      mov r29.yz, cb10[r14.w + 8].xxyx
      dp3 r19.x, r17.xyzx, r29.xyzx
      dp3 r19.w, r18.yzwy, r29.xyzx
      ...
      div r19.w, r20.w, r19.w
      min r19.x, |r19.w|, r19.x
      add r29.x, r18.y, cb10[r14.w + 3].w
      add r29.yz, r18.zzwz, cb10[r14.w + 4].xxyx
      mad r28.xzw, r17.xxyz, r19.xxxx, r29.xxyz
      ...
      utof r30.w, r19.w
      sample_l_indexable(texturecubearray)(float,float,float,float) r28.xzw, r30.xyzw, t8.xwyz, s2, r19.x
      and r33.xyz, r28.xzwx, l(0x7fffffff, 0x7fffffff, 0x7fffffff, 0)
      ieq r33.xyz, r33.xyzx, l(0x7f800000, 0x7f800000, 0x7f800000, 0)
      or r19.x, r33.y, r33.x
      or r19.x, r33.z, r19.x
      movc r28.xzw, r19.xxxx, l(1.000000,0,1.000000,0), r28.xxzw
...
bfi r6.w, l(8), l(0), r21.y, r25.w
movc r0.x, r0.x, r6.w, r21.y
max r6.w, r21.x, l(1.000000)
rcp r6.w, r6.w
mov_sat r21.x, r21.x
mul r18.xyz, r6.wwww, r16.yzwy
mul r19.xyz, r6.wwww, r26.xyzx
lt r9.w, r21.x, l(0.990000)
if_nz r9.w
  iadd r0.x, r0.x, l(256)
  add r9.w, -r21.x, l(1.000000)
  ...
  mad r18.xyz, r16.yzwy, r6.wwww, r20.xyzx
  mov r17.w, l(0)
  ...
  mad r19.xyz, r16.yzwy, r6.wwww, r19.xyzx
endif 
add r6.w, r5.z, r2.x
log r6.w, |r6.w|
mul r6.w, r2.z, r6.w
...
mul r16.yzw, r6.wwww, r19.xxyz
mul r19.xyz, r13.zzzz, r16.yzwy
...
if_nz r8.w
  ...
  if_nz r8.w
    ...
    mad r18.xyz, r18.xyzx, r5.zzzz, r23.xyzx
    ...
    mul r1.z, r1.z, r5.z
    mul r1.z, r1.z, r3.z
    mad r24.xyz, r1.zzzz, r16.yzwy, r19.xyzx
    mad r16.yzw, r3.wwww, r16.yyzw, r21.zzxy
    and r25.xyz, r4.zzzz, r16.zwyz
    mov r18.w, r21.z
    mov r20.w, r25.z
    movc r20.xyzw, r3.yyyy, r18.xyzw, r20.xyzw
    mov r21.zw, r24.xxxy
    mov r25.zw, r19.xxxy
    movc r18.xyzw, r3.yyyy, r21.xyzw, r25.xyzw
    mov r23.x, r24.z
    mov r22.w, r19.z
      ...
      if_nz r14.w
        ...
        if_nz r14.w
          ...
          loop 
            ige r20.w, r19.w, l(8)
            breakc_nz r20.w
            dp2 r41.y, icb[r19.w + 0].yxyy, r18.xyxx
            dp2 r41.z, icb[r19.w + 0].yxyy, r18.yzyy
        ...
        if_nz r14.w
          ...
          dp3 r19.w, r17.xyzx, r38.xyzx
          mad r20.w, -r15.w, r15.w, cb9[r5.z + 6].y
          mad r9.w, r15.w, r19.w, -r9.w
            ...
            if_z r15.w
              ...
              if_nz cb2[58].y
                ...
                loop 
                  ige r21.w, r20.w, l(8)
                  breakc_nz r21.w
                  dp2 r39.x, icb[r20.w + 0].yxyy, r18.xwxx
                ...
                utof r38.z, r15.w
                sample_c_lz_indexable(texture2darray)(float,float,float,float) r19.w, r38.xyzx, t9.xxxx, s13, r10.w
              endif 
...
ftou r2.z, r4.x
ieq r0.y, r0.y, r2.z
movc r4.xy, r0.yyyy, r4.ywyy, l(-1.000000,0,0,0)
mov r7.x, r1.z
mov r7.y, r2.x
mov r7.z, r3.x
mov r7.w, r4.x
...
ieq r0.y, r1.w, r1.z
movc r2.xyz, r0.yyyy, r5.xyzx, r5.xzyx
...
ret 
// Approximately 2157 instruction slots used
