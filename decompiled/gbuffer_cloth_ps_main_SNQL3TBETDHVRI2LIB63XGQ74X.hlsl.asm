...
sample_indexable(texture2d)(float,float,float,float) r2.w, v1.yzyy, t11.yzwx, s4
sample_indexable(texture2d)(float,float,float,float) r3.w, v1.yzyy, t10.yzwx, s2
...
sample_indexable(texture2d)(float,float,float,float) r4.y, r0.yzyy, t16.yxzw, s5
if_nz r4.x
  mul r4.x, r5.w, v1.x
  add r4.z, -cb0[14].x, cb0[14].y
  mad r4.y, r4.y, r4.z, cb0[14].x
  mul_sat r4.y, r4.y, l(0.05882353)
  mul r4.x, r0.x, r4.x
  mad r1.xyz, -r1.xyzx, r0.wwww, r5.xyzx
  mad r3.xyz, r4.xxxx, r1.xyzx, r3.xyzx
  mad r0.w, r4.y, l(2.000000), l(-1.000000)
  mad r0.w, r4.x, r0.w, l(1.000000)
  mul_sat r3.w, r0.w, r3.w
  add r1.xyz, -r2.xyzx, l(0.040000, 0.040000, 0.040000, 0.000000)
  mad r2.xyz, r4.xxxx, r1.xyzx, r2.xyzx
else 
  mov r4.x, l(0)
endif 
...
mul r4.yz, v1.yyzy, cb0[4].xxyx
sample_indexable(texture2d)(float,float,float,float) r4.yzw, r4.yzyy, t12.wxyz, s3
...
mad r5.xy, r4.yzyy, cb0[12].zzzz, r1.xyxx
dp3 r1.x, r5.xyzx, r5.xyzx
rsq r1.x, r1.x
mul r4.yzw, r1.xxxx, r5.xxyz
mad r0.w, r1.z, cb0[12].z, r0.w
lt r1.x, l(0.000000), r4.x
sample_indexable(texture2d)(float,float,float,float) r5.xyz, r0.yzyy, t15.xyzw, s5
if_nz r1.x
  add r1.xyz, r5.xyzx, l(-0.500000, -0.500000, -0.000000, 0.000000)
  mad r1.xyz, cb0[13].wwww, r1.xyzx, l(0.500000, 0.500000, 0.000000, 0.000000)
  mad r0.yz, r1.xxyx, l(0.000000, 1.99218750, 1.99218750, 0.000000), l(0.000000, -1.000000, -1.000000, 0.000000)
  mul r1.x, r1.z, r1.z
  mul r1.x, r1.x, l(0.33333334)
  min r1.x, r1.x, l(1.000000)
  mad r4.yz, r0.yyzy, r4.xxxx, r4.yyzy
...
mad r3.xyz, r3.xyzx, r6.xyzx, -r2.xyzx
mad r3.xyz, r3.wwww, r3.xyzx, r2.xyzx
add r0.x, r0.x, r0.w
min r0.x, r0.x, l(1.000000)
mul r6.xyz, r0.xxxx, r7.xyzx
movc o0.xyz, r1.wwww, r6.xyzx, r7.xyzx
...
add r1.w, r5.y, r5.x
mad r1.w, r1.z, r0.y, r1.w
mul r1.w, r1.w, l(0.500000)
mad r1.xyz, r1.xyzx, r0.yyyy, -r1.wwww
max r0.y, r1.z, r1.y
max r0.y, r0.y, r1.x
max r0.y, r0.y, r1.w
eq r1.x, r0.y, r1.x
