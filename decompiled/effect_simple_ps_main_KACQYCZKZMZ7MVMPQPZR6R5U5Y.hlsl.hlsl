...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r1.w = dot(v6.xyz, v4.xyz);
  r4.xyz = -v6.xyz * r1.www + v4.xyz;
  r1.w = dot(r4.xyz, r4.xyz);
  r1.w = rsqrt(r1.w);
  r4.xyz = r4.xyz * r1.www;
  r3.yzw = r3.yyy ? r4.xyz : v6.xyz;
  ...
  r0.w = r4.z ? r0.w : 0;
  r0.w = r4.w ? r0.w : 0;
  r3.x = max(9.99999975e-05, r2.w);
  r4.xyz = saturate(r0.xyz / r3.xxx);
  r4.xyz = saturate(-levelsControls.xxx + r4.xyz);
  r3.zw = levelsControls.yw + -levelsControls.xz;
  r3.z = max(9.99999975e-05, r3.z);
  r4.xyz = r4.xyz / r3.zzz;
  r4.xyz = min(float3(1,1,1), r4.xyz);
  r4.xyz = r4.xyz * r3.www + levelsControls.zzz;
  ...
  r3.z = useOldHDRScale * v4.z;
  r3.w = cmp(r0.w < r3.z);
  r0.w = r0.z * r0.w;
  r0.w = r0.w / r3.z;
  r4.xyz = r2.xyz / r3.xxx;
  r3.x = v1.w + r2.w;
  r5.w = saturate(r3.x * v5.y + -v5.y);
