...
mad r0.xyz, -cb0[40].xyzx, cb1[69].wwww, r0.xyzx
sincos r0.w, null, r0.x
sincos null, r0.xyz, r0.xyzx
mul r1.xyz, v1.xxxx, cb0[38].xyzx
mul r2.xy, r1.xxxx, -cb0[35].zwzz
mul r2.xy, r0.wwww, r2.xyxx
mad r2.xy, cb0[39].xxxx, r2.xyxx, v0.xyxx
mul r2.zw, r1.yyyy, -cb0[36].zzzw
mul r2.zw, r0.wwww, r2.zzzw
mad r2.xy, cb0[39].yyyy, r2.zwzz, r2.xyxx
mul r2.zw, r1.zzzz, -cb0[37].zzzw
dp3 r0.x, r1.xyzx, r0.xyzx
mul r0.yz, r0.wwww, r2.zzwz
mad r1.xy, cb0[39].zzzz, r0.yzyy, r2.xyxx
mov r2.xyz, v0.xyzx
mov r2.w, l(0)
mul r0.y, -r0.x, cb0[34].y
add r1.z, r0.x, v0.z
min r1.w, r0.y, l(0.000000)
movc r0.xyzw, cb0[41].yyyy, r1.xyzw, r2.xyzw
mov o6.z, r0.w
mov r0.w, l(1.000000)
