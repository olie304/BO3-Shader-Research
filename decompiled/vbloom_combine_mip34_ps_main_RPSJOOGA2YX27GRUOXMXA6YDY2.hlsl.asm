...
dcl_constantbuffer CB8[30], immediateIndexed
...
mul r1.xyz, r0.wwww, cb8[28].xyzx
mad r1.xyz, r0.wwww, cb8[27].xyzx, r1.xyzx
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, v0.xyxx, t1.xyzw, s0
mad r1.xyz, r2.wwww, cb8[29].xyzx, r1.xyzx
mul r3.xyz, r0.xyzx, cb8[25].xyzx
mad r0.xyz, r0.xyzx, cb8[24].xyzx, r3.xyzx
add r0.xyz, r0.xyzx, r1.xyzx
mad r0.xyz, r2.xyzx, cb8[26].xyzx, r0.xyzx
min o0.xyz, r0.xyzx, l(65504.000000, 65504.000000, 65504.000000, 0.000000)
ret 
