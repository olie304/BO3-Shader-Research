...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  r0.yz = commonScale.xy * r0.yz;
  r2.xyzw = colorMap.Sample(colorSampler_s, r0.yz).xyzw;
  r0.w = w1.x * r2.w;
  r1.z = cmp(r0.w < 0.5);
  if (r1.z != 0) discard;
  r1.z = tintMask.Sample(colorSampler_s, r0.yz).x;
  ...
  r6.xy = (uint2)r8.xy;
  r2.w = dot(r6.yx, float2(0.0671105608,0.00583714992));
  r2.w = frac(r2.w);
  r2.w = 52.9829178 * r2.w;
  r2.w = frac(r2.w);
  r2.w = r2.w * 6.28318548 + gameTick.w;
  sincos(r2.w, r7.x, r8.x);
  r2.w = dot(r6.xy, float2(0.0671105608,0.00583714992));
  r2.w = frac(r2.w);
  r2.w = 52.9829178 * r2.w;
  r2.w = frac(r2.w);
  r2.w = r2.w * 6.28318548 + gameTick.w;
  ...
  r41.z = samp0[]..swiz;
  r41.w = samp0[]..swiz;
    r14.w = dot(r36.xyz, r10.yzw);
    r14.w = saturate(r14.w + r36.w);
    r15.x = dot(r37.xyz, r10.yzw);
    r15.x = saturate(r15.x + r37.w);
    r14.w = r15.x * r14.w;
    r15.x = dot(r38.xyz, r10.yzw);
    r15.x = saturate(r15.x + r38.w);
    r14.w = r15.x * r14.w;
    r15.x = dot(r39.xyz, r10.yzw);
    r15.x = saturate(r15.x + r39.w);
    r14.w = r15.x * r14.w;
    r15.x = dot(r40.xyz, r10.yzw);
    r15.x = saturate(r15.x + r40.w);
    r14.w = r15.x * r14.w;
    r15.x = dot(r41.xyz, r10.yzw);
    ...
    r30.x = dot(r10.yzw, r23.xyz);
    r30.y = dot(r10.yzw, r32.xyz);
    r30.z = dot(r10.yzw, r25.xyz);
      ...
      if (r17.z != 0) {
        ...
        if (r12.w != 0) {
          ...
          r37.w = samp0[]..swiz;
            ...
            r17.w = r31.x * r17.w;
            r18.z = dot(r33.xyz, r10.yzw);
            r18.z = saturate(r18.z + r33.w);
            r17.w = r18.z * r17.w;
            r18.z = dot(r34.xyz, r10.yzw);
            r18.z = saturate(r18.z + r34.w);
            r17.w = r18.z * r17.w;
            r18.z = dot(r35.xyz, r10.yzw);
            r18.z = saturate(r18.z + r35.w);
            r17.w = r18.z * r17.w;
            r18.z = dot(r36.xyz, r10.yzw);
            r18.z = saturate(r18.z + r36.w);
            r17.w = r18.z * r17.w;
            r18.z = dot(r37.xyz, r10.yzw);
  ...
  if (r7.z == 0) {
    ...
    while (true) {
      ...
      bitmask.w = ((~(-1 << r8.w)) << 0) & 0xffffffff;  r12.w = (((uint)0 << 0) & bitmask.w) | ((uint)r10.z & ~bitmask.w);
    ...
    if (r9.z != 0) {
      ...
      r9.w = 0;
      while (true) {
        r12.w = cmp((uint)r9.w >= (uint)r7.z);
        if (r12.w != 0) break;
        r14.z = (uint)r9.w >> 5;
        r15.xyz = (int3)r12.xyz + (int3)r14.xyz;
        r12.w = visibleProbes.Load(r15.xyzw).x;
        r14.z = cmp((int)r7.w == (int)r9.w);
        if (r8.w == 0) r14.w = 0; else if (r8.w+0 < 32) {         r14.w = (uint)r12.w << (32-(r8.w + 0)); r14.w = (uint)r14.w >> (32-r8.w);        } else r14.w = (uint)r12.w >> 0;
    ...
    if (r6.z != 0) {
      ...
      r21.xyz = r23.xyz * r5.www + r10.yzw;
      r13.w = 0;
      r10.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r13.xyzw, r6.y).xyz;
      r5.w = sunConstants.globalProbeExposure * r6.z + -r4.w;
      r4.w = r9.y * r5.w + r4.w;
  ...
  if (r7.w == 0) {
    ...
    if (r10.y != 0) {
      ...
      while (true) {
        ...
        if (r10.w != 0) break;
        r10.w = (uint)r10.y;
        r16.xy = -sunConstants.splitPinTransform[r10.w].xy + r9.yz;
        r12.w = max(abs(r16.x), abs(r16.y));
        r10.z = sunConstants.splitPinTransform[r10.w].z * r12.w;
        r10.w = cmp(r10.z < 1);
        if (r10.w != 0) {
          break;
        }
    ...
    if (r10.w == 0) {
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          r16.w = r13.w ? sunConstants.splitPinTransform[r10.y].w : sunConstants.splitPinTransform[r9.w].w;
          r13.w = r13.w ? r10.y : r9.w;
  ...
  if (r7.w != 0) {
    ...
    if (r7.w != 0) {
      ...
      if (sunConstants.sunCookieIndex != 0) {
        r11.w = 1;
        r9.y = dot(sunConstants.sunCookieTransform[0].xyzw, r11.xyzw);
        r9.z = dot(sunConstants.sunCookieTransform[1].xyzw, r11.xyzw);
        r11.xy = frac(r9.yz);
      ...
      r10.z = samp0[]..swiz;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r11.xyzw, r10.y, l(68), t12.xyzw
      r11.x = samp0[]..swiz;
      r11.y = samp0[]..swiz;
      r11.z = samp0[]..swiz;
      r11.w = samp0[]..swiz;
      ...
      r18.w = samp0[]..swiz;
        ...
        r16.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r11.zw, r10.y, l(164), t12.xxxy
        r11.z = samp0[]..swiz;
        r11.w = samp0[]..swiz;
          ...
          if (enableDitheredShadow != 0) {
            ...
            while (true) {
              ...
              if (r13.w != 0) break;
              r18.x = dot(icb[r12.w+0].yx, r11.xy);
              r18.y = dot(icb[r12.w+0].yx, r11.yz);
              r17.xy = r18.xy * r10.zz + r16.xy;
              r13.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r17.xyz, r10.y).x;
      ...
      r10.y = r10.y + -r7.z;
      r10.y = r3.w * r10.y + r7.z;
      r10.y = r10.y * r8.w;
      r5.w = cmp(0 < r5.w);
      r11.xyz = r10.yyy * r9.yzw + r14.xyz;
      r10.yzw = -v7.xyz * r0.zzz + sunConstants.wldDir.xyz;
      r0.z = dot(r10.yzw, r10.yzw);
      r0.z = rsqrt(r0.z);
      r10.yzw = r10.yzw * r0.zzz;
      r0.z = dot(r10.yzw, r5.xyz);
      r10.y = dot(r4.xyz, r10.yzw);
      r10.z = abs(r10.y) * r2.w + -abs(r10.y);
      ...
      r11.w = r16.z;
      r14.w = r15.z;
      r14.xyzw = r5.wwww ? r11.xyzw : r14.xyzw;
      r16.zw = r10.yz;
      r15.zw = r6.yz;
      r11.xyzw = r5.wwww ? r16.xyzw : r15.xyzw;
      r6.w = r5.w ? r10.w : r6.w;
      r15.z = r14.w;
      r15.xy = r11.xy;
      r6.yz = r11.zw;
    }
              ...
              if (r26.w != 0) {
                ...
                if (r26.w != 0) {
                  ...
                  while (true) {
                    ...
                    if (r30.w != 0) break;
                    r43.y = dot(icb[r29.w+0].yx, r11.xy);
                    r43.z = dot(icb[r29.w+0].yx, r11.yz);
  ...
  r1.xyz = relativeHDR ? r3.xyz : r1.xyz;
