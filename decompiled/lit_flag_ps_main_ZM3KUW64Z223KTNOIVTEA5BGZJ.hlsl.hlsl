...
Texture2D<float4> detailMap : register(t30);
Texture2DArray<float> gTransShadowmapArray : register(t31);
Texture2D<float4> flagRippleDetailMap : register(t37);
...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  r4.xyzw = gameTime.wwww * flagScrollParms.xyzw;
  r4.xyzw = v2.xyxy * flagRippleScale + r4.xyzw;
  r5.xyz = flagRippleDetailMap.Sample(normalSampler_s, r4.xy).xyz;
  r2.zw = r5.xy * float2(1.9921875,1.9921875) + float2(-1,-1);
  r3.w = r5.z * r5.z;
  r3.w = 0.333333343 * r3.w;
  r3.w = min(1, r3.w);
  r4.xyz = flagRippleDetailMap.Sample(normalSampler_s, r4.zw).xyz;
  r4.xy = r4.xy * float2(1.9921875,1.9921875) + float2(-1,-1);
  r4.z = r4.z * r4.z;
  r4.z = 0.333333343 * r4.z;
  r4.z = min(1, r4.z);
  r3.xy = r2.zw * flagRippleHeight + r3.xy;
  r2.z = dot(r3.xyz, r3.xyz);
  r2.z = rsqrt(r2.z);
  r3.xyz = r3.xyz * r2.zzz;
  r2.y = r3.w * flagRippleHeight + r2.y;
  r3.xy = r4.xy * flagRippleHeight + r3.xy;
  r2.z = dot(r3.xyz, r3.xyz);
  r2.z = rsqrt(r2.z);
  r3.xyz = r3.xyz * r2.zzz;
  r2.y = r4.z * flagRippleHeight + r2.y;
  r2.z = v7.x ? 1 : -1;
  ...
  if (r2.y != 0) {
    ...
    r0.xyz = r2.zzz ? r4.xyw : r5.xyz;
  }
  r2.yzw = debugColorOverride.xyz + -r0.xyz;
  r0.xyz = debugColorOverride.www * r2.yzw + r0.xyz;
  r0.w = -r0.w * r1.w + debugAlphaOverride.x;
  o0.w = debugAlphaOverride.w * r0.w + r2.x;
  r0.w = r1.z + -r1.y;
  r2.y = debugGlossOverride.w * r0.w + r1.y;
  ...
  r2.x = saturate(dot(r1.xyz, r4.yzw));
  r5.y = dot(-r4.yzw, r1.xyz);
  r5.y = r5.y + r5.y;
  r10.xyz = r1.xyz * -r5.yyy + -r4.yzw;
  r5.y = 17 * r2.y;
  r5.y = exp2(r5.y);
  r5.y = 2 + r5.y;
  r5.y = 2 / r5.y;
  ...
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r21.xyzw, r2.w, l(0), t15.wxyz
  r21.x = samp0[]..swiz;
  r21.y = samp0[]..swiz;
  r21.z = samp0[]..swiz;
  r21.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r22.xyzw, r2.w, l(16), t15.xyzw
  r22.x = samp0[]..swiz;
  r22.y = samp0[]..swiz;
  r22.z = samp0[]..swiz;
  r22.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r23.xyzw, r2.w, l(32), t15.yxwz
  r23.x = samp0[]..swiz;
  r23.y = samp0[]..swiz;
  r23.z = samp0[]..swiz;
  r23.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r24.xyzw, r2.w, l(48), t15.xyzw
  r24.x = samp0[]..swiz;
  r24.y = samp0[]..swiz;
  r24.z = samp0[]..swiz;
  r24.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r25.xyzw, r2.w, l(64), t15.zwxy
  r25.x = samp0[]..swiz;
  r25.y = samp0[]..swiz;
  r25.z = samp0[]..swiz;
  r25.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r26.xyzw, r2.w, l(80), t15.xyzw
  r26.x = samp0[]..swiz;
  r26.y = samp0[]..swiz;
  r26.z = samp0[]..swiz;
  r26.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r8.yz, r2.w, l(96), t15.xxyx
  r8.y = samp0[]..swiz;
  r8.z = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r27.xyzw, r2.w, l(116), t15.xyzw
  r27.x = samp0[]..swiz;
  r27.y = samp0[]..swiz;
  r27.z = samp0[]..swiz;
  r27.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r28.xyzw, r2.w, l(132), t15.zwxy
  r28.x = samp0[]..swiz;
  r28.y = samp0[]..swiz;
  r28.z = samp0[]..swiz;
  r28.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r29.xyzw, r2.w, l(148), t15.zwxy
  r29.x = samp0[]..swiz;
  r29.y = samp0[]..swiz;
  r29.z = samp0[]..swiz;
  r29.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r30.xyzw, r2.w, l(164), t15.zwxy
  r30.x = samp0[]..swiz;
  r30.y = samp0[]..swiz;
  r30.z = samp0[]..swiz;
  r30.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r31.xyzw, r2.w, l(180), t15.zwxy
  r31.x = samp0[]..swiz;
  r31.y = samp0[]..swiz;
  r31.z = samp0[]..swiz;
  r31.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r32.xyzw, r2.w, l(196), t15.xyzw
  r32.x = samp0[]..swiz;
  r32.y = samp0[]..swiz;
  r32.z = samp0[]..swiz;
  r32.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r33.xy, r2.w, l(212), t15.xyxx
  r33.x = samp0[]..swiz;
  r33.y = samp0[]..swiz;
  ...
  if (r2.z == 0) {
    ...
    if (r2.w != 0) {
      ...
      r19.xyz = r21.xyz * r2.zzz + r8.yzw;
      r10.w = 0;
      r8.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r10.xyzw, r6.z).xyz;
      r2.z = sunConstants.globalProbeExposure * r2.w + -r1.w;
      r1.w = r2.y * r2.z + r1.w;
      r20.xyz = r8.yzw * r1.www + r20.xyz;
    }
  } else {
    r20.x = r19.w;
  }
  ...
  r8.yzw = r20.xyz * r1.www;
  r9.yzw = r8.yzw * r2.yyy;
  r13.xyz = r8.yzw * r2.zzz;
  r0.w = sqrt(r5.z);
  r0.w = r0.w * 0.5 + 0.5;
  r0.w = r0.w * r0.w;
  r1.w = 0.5 * r0.w;
  ...
  r0.w = r2.y * r0.w;
  r1.w = r2.y * r1.w;
  r2.y = dot(r1.xyz, sunConstants.wldDir.xyz);
  r2.z = cmp(0 >= abs(r2.y));
  if (r2.z != 0) {
    r2.w = 0;
  }
  if (r2.z == 0) {
    ...
    r2.z = -sunConstants.splitDepthOffset + r8.w;
    ...
    if (r6.z == 0) {
      if (enableDitheredShadow == 0) {
        ...
        r14.z = r6.z + r3.w;
        r6.z = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r14.xyz, r2.z).x;
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          r16.z = (uint)r8.w;
          r8.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r2.z).x;
  ...
  if (r2.z != 0) {
    r2.z = cmp(0 < r2.w);
    if (r2.z != 0) {
      r2.z = sunConstants.specScale * r5.y;
      r2.z = 0.25 * r2.z;
      ...
      r17.z = samp0[]..swiz;
      r17.w = samp0[]..swiz;
        r6.z = abs(r2.y) * -0.200000003 + 0.400000006;
        r6.w = cmp(r2.y < 0);
        r6.z = r6.w ? -r6.z : r6.z;
      ...
      r3.w = -r2.x * 0.5 + 1;
      r3.w = -abs(r2.y) * r3.w + 1;
      r3.w = r3.w * r3.w;
      r3.w = -r3.w * 0.620000005 + 0.620000005;
      r3.w = r3.w + -abs(r2.y);
      r3.w = r5.z * r3.w + abs(r2.y);
      r3.w = r3.w * r2.w;
      r5.w = cmp(0 < r2.y);
      ...
      r2.y = r4.x * r2.y;
      r2.y = r2.y * r2.w;
      r15.yzw = r2.yyy * r8.yzw + r13.xyz;
      r2.z = saturate(1 + -r3.w);
      r2.w = r2.z * r2.z;
      r2.w = r2.w * r2.w;
      r2.z = r2.z * r2.w;
      r2.y = r2.y * r2.z;
      r2.yzw = r2.yyy * r8.yzw + r9.yzw;
      r14.w = r12.z;
      r12.w = r14.z;
  ...
  while (true) {
    ...
    r3.w = visibleLights.Load(r17.xyzw).x;
    r17.xyz = r8.yzw;
    r31.xyz = r28.xyz;
    r32.xyz = r29.xyz;
    r33.xyz = r30.xyz;
            ...
            if (r13.w != 0) {
              ...
              if (r13.w != 0) {
                ...
                if (r13.w != 0) {
                  ...
                  r7.w = -abs(r12.w) * r2.x + 1;
                  r7.w = r7.w * r7.w;
                  r7.w = -r7.w * 0.620000005 + 0.620000005;
                  r7.w = r7.w + -abs(r12.w);
                  r7.w = r5.z * r7.w + abs(r12.w);
                  r7.w = r7.w * r11.w;
                  r35.x = r34.x;
                  r10.w = cmp(0 < r12.w);
                  r19.xyz = r7.www * r35.xyz + r17.xyz;
                  r12.w = saturate(dot(r1.xyz, r42.xyz));
                  r20.xyz = r41.xyz * r6.www + r4.yzw;
                  r6.w = dot(r20.xyz, r20.xyz);
                  r6.w = rsqrt(r6.w);
                  r20.xyz = r20.xyz * r6.www;
                  r6.w = dot(r20.xyz, r4.yzw);
                  r15.z = dot(r1.xyz, r20.xyz);
                  r20.x = abs(r15.z) * r5.y + -abs(r15.z);
            ...
            r42.w = samp0[]..swiz;
              ...
              if (r10.w != 0) {
                ...
                if (r10.w != 0) {
                  ...
                  r11.w = -abs(r7.w) * r2.x + 1;
                  r11.w = r11.w * r11.w;
                  r11.w = -r11.w * 0.620000005 + 0.620000005;
                  r11.w = r11.w + -abs(r7.w);
                  r11.w = r5.z * r11.w + abs(r7.w);
                  r11.w = r11.w * r6.z;
                  r13.w = cmp(0 < r7.w);
                  r22.xyz = r11.www * r20.xyz + r17.xyz;
                  r7.w = saturate(r7.w);
                  r19.xyz = r19.xyz * r6.www + r4.yzw;
                  r6.w = dot(r19.xyz, r19.xyz);
                  r6.w = rsqrt(r6.w);
                  r19.xyz = r19.xyz * r6.www;
                  r6.w = dot(r19.xyz, r4.yzw);
                  r15.z = dot(r1.xyz, r19.xyz);
                  r19.x = abs(r15.z) * r5.y + -abs(r15.z);
                  r15.z = abs(r15.z) * r19.x + 1;
                  r19.x = r7.w * r0.w + r1.w;
                  r15.z = r15.z * r15.z;
                  r15.z = r15.z * r19.x;
                  r15.z = rcp(r15.z);
                  r7.w = r7.w * r10.w;
