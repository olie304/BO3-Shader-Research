...
rsq r2.z, r2.z
mul r3.xyz, r1.xywx, r2.zzzz
mad r1.y, r0.x, r1.z, r10.y
mad r4.xyz, r1.zzzz, l(0.080000, 0.080000, 0.080000, 0.000000), r12.xyzx
...
dp3_sat r1.x, r3.xyzx, r6.xyzx
dp3 r1.w, -r6.xyzx, r3.xyzx
add r1.w, r1.w, r1.w
mad r11.xyz, r3.xyzx, -r1.wwww, -r6.xyzx
...
mad r4.w, r7.z, l(5.000000), l(-2.500000)
...
loop 
  ...
  dp3 r29.x, r3.xyzx, r21.xyzx
  dp3 r29.y, r3.xyzx, r30.xyzx
  dp3 r29.z, r3.xyzx, r23.xyzx
...
if_nz r4.w
  ...
  if_nz r4.w
    ...
    if_nz r7.z
      ...
      mad r19.xyz, r3.xyzx, r8.wwww, v6.xyzx
...
mad r0.xyw, r29.xyxz, r4.xyxz, r0.xyxw
mad r0.xyw, r9.yzyw, r5.xzxw, r0.xyxw
log r1.x, r7.w
...
mov o0.w, r0.z
ret 
// Approximately 2879 instruction slots used
