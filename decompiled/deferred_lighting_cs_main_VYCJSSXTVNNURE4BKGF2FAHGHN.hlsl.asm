...
if_nz r3.w
  ...
  if_nz r3.w
    ...
    loop 
      ...
      mad r14.yzw, r18.xxyz, r10.wwww, r16.xxyz
      sample_l_indexable(texture2d)(float,float,float,float) r10.w, r14.yzyy, t28.yzwx, s1, l(0.000000)
      mul r12.w, r14.w, |r10.w|
      ...
      if_nz r12.w
        if_nz r20.z
          ...
          movc r13.yz, r12.wwww, r14.yyzy, r9.xxyx
          mov r20.z, r14.w
          mov r22.x, r7.w
          movc r17.xyw, r12.wwww, r20.zxzy, r22.xyxz
          mov r6.w, r20.x
          mov r20.z, l(-1)
          mov r9.xy, r13.yzyy
          mov r7.w, r17.x
      ...
      loop 
        ...
        mad r23.xyz, r19.xyzx, r19.wwww, r14.yzwy
        sample_l_indexable(texture2d)(float,float,float,float) r19.w, r23.xyxx, t28.yzwx, s1, l(0.000000)
        mul r22.w, r23.z, |r19.w|
        lt r22.w, r22.w, l(1.000000)
        if_nz r22.w
          lt r22.w, r9.z, |r19.w|
          add r23.w, -r16.w, r23.z
          add r24.x, -r17.w, |r19.w|
          mul r24.y, r16.w, r23.z
          mul r24.x, r24.y, |r24.x|
          lt r23.w, r24.x, |r23.w|
          and r24.x, r22.w, r23.w
          lt r24.y, r13.z, r23.z
          and r24.z, r22.w, r24.y
          movc r21.xy, r24.zzzz, r20.xyxx, r22.yxyy
          or r23.w, r23.w, r24.y
          and r22.w, r22.w, r23.w
          movc r23.xy, r22.wwww, r23.xyxx, r17.xyxx
          movc r23.w, r24.x, l(1.000000), r9.w
          movc r22.w, r22.w, r23.z, r13.z
          movc r24.xyzw, r24.xxxx, r20.xyzw, r21.xyzw
          mov r9.w, r23.w
          mov r17.xy, r23.xyxx
          mov r13.z, r22.w
          mov r22.xy, r24.yxyy
...
if_z r7.w
  ...
  if_nz r9.w
    ...
    loop 
      ...
      breakc_nz r12.w
      ftou r12.w, r9.w
      add r14.yz, r13.yyzy, -cb2[r12.w + 20].xxyx
      max r14.y, |r14.z|, |r14.y|
      mul r10.w, r14.y, cb2[r12.w + 20].z
  ...
  if_z r12.w
    if_z cb2[58].y
      ...
      itof r12.w, cb2[26].y
      add r16.z, r9.w, r12.w
      sample_c_lz_indexable(texture2darray)(float,float,float,float) r12.w, r16.xyzx, t13.xxxx, s13, r7.w
    ...
    if_nz cb2[58].y
      ...
      loop 
        uge r16.w, r14.w, l(8)
        breakc_nz r16.w
        ult r16.w, r10.w, r14.w
        movc r17.xy, r16.wwww, r13.yzyy, r14.yzyy
        movc r17.z, r16.w, cb2[r9.w + 20].w, cb2[r12.w + 20].w
        movc r16.w, r16.w, r9.w, r12.w
        ...
        utof r17.z, r16.w
        sample_c_lz_indexable(texture2darray)(float,float,float,float) r16.w, r17.xyzx, t13.xxxx, s13, r7.w
...
mad r13.yz, -r7.wwww, l(0.000000, 10.000000, 5.000000, 0.000000), l(0.000000, 6.857410, 7.085000, 0.000000)
exp r12.w, r13.y
...
loop 
  ...
  if_nz r14.z
    ...
    dp3 r18.z, cb11[r16.w + 1].xyzx, r23.xyzx
    add_sat r18.z, r18.z, cb11[r16.w + 1].w
    mul r17.w, r17.w, r18.z
    dp3 r18.z, cb11[r16.w + 2].xyzx, r23.xyzx
    add_sat r18.z, r18.z, cb11[r16.w + 2].w
    mul r17.w, r17.w, r18.z
    dp3 r18.z, cb11[r16.w + 3].xyzx, r23.xyzx
    add_sat r18.z, r18.z, cb11[r16.w + 3].w
    mul r17.w, r17.w, r18.z
    dp3 r18.z, cb11[r16.w + 4].xyzx, r23.xyzx
    add_sat r18.z, r18.z, cb11[r16.w + 4].w
    mul r17.w, r17.w, r18.z
    dp3 r18.z, cb11[r16.w + 5].xyzx, r23.xyzx
    ...
    loop 
      ...
      dp3 r20.w, cb11[r18.w + 1].xyzx, r23.xyzx
      add_sat r20.w, r20.w, cb11[r18.w + 1].w
      mul r19.w, r19.w, r20.w
      dp3 r20.w, cb11[r18.w + 2].xyzx, r23.xyzx
      add_sat r20.w, r20.w, cb11[r18.w + 2].w
      mul r19.w, r19.w, r20.w
      dp3 r20.w, cb11[r18.w + 3].xyzx, r23.xyzx
      add_sat r20.w, r20.w, cb11[r18.w + 3].w
      mul r19.w, r19.w, r20.w
      dp3 r20.w, cb11[r18.w + 4].xyzx, r23.xyzx
      add_sat r20.w, r20.w, cb11[r18.w + 4].w
      mul r19.w, r19.w, r20.w
      dp3 r20.w, cb11[r18.w + 5].xyzx, r23.xyzx
      ...
      movc r18.y, r24.z, r18.w, r24.w
      movc r24.xy, r23.wwww, r24.xyxx, r18.xyxx
      iadd r18.z, r18.z, l(1)
      mov r17.w, r20.w
    endloop 
    mov_sat r24.y, r24.y
    mul r14.z, r24.y, cb10[r14.y + 6].y
    lt r14.w, l(0.000000), r14.z
    if_nz r14.w
      mad r22.w, r24.y, cb10[r14.y + 6].y, r22.w
      mul r14.z, r14.z, cb10[r14.y + 7].y
      mov r25.x, cb10[r14.y + 7].w
      mov r25.yz, cb10[r14.y + 8].xxyx
      dp3 r14.w, r15.xyzx, r25.xyzx
      dp3 r16.x, r23.xyzx, r25.xyzx
      ...
      mov r25.x, cb10[r14.y + 8].w
      mov r25.yz, cb10[r14.y + 9].xxyx
      ...
      mov r25.x, cb10[r14.y + 9].w
      mov r25.yz, cb10[r14.y + 10].xxyx
      dp3 r16.x, r15.xyzx, r25.xyzx
      dp3 r16.w, r23.xyzx, r25.xyzx
      ...
      div r16.x, r16.w, r16.x
      min r14.w, r14.w, |r16.x|
      mov r25.x, cb10[r14.y + 10].w
      mov r25.yz, cb10[r14.y + 11].xxyx
      dp3 r16.x, r15.xyzx, r25.xyzx
      dp3 r16.w, r23.xyzx, r25.xyzx
      ...
      div r16.x, r16.w, r16.x
      min r14.w, r14.w, |r16.x|
      mov r25.x, cb10[r14.y + 11].w
      mov r25.yz, cb10[r14.y + 12].xxyx
      dp3 r16.x, r15.xyzx, r25.xyzx
      dp3 r16.w, r23.xyzx, r25.xyzx
      ...
      div r16.x, r16.w, r16.x
      min r14.w, r14.w, |r16.x|
      mov r25.x, cb10[r14.y + 12].w
      mov r25.yz, cb10[r14.y + 13].xxyx
      dp3 r16.x, r15.xyzx, r25.xyzx
      dp3 r16.w, r23.xyzx, r25.xyzx
      ...
      div r16.x, r16.w, r16.x
      min r14.w, r14.w, |r16.x|
      add r25.x, r23.x, cb10[r14.y + 3].w
      add r25.yz, r23.yyzy, cb10[r14.y + 4].xxyx
      mad r18.yzw, r15.xxyz, r14.wwww, r25.xxyz
      ...
      mov r25.x, cb10[r14.y + 0].w
      mov r25.y, cb10[r14.y + 1].z
      mov r25.z, cb10[r14.y + 2].y
      dp3 r26.x, r18.yzwy, r25.xyzx
      mov r27.xy, cb10[r14.y + 1].xwxx
      mov r27.z, cb10[r14.y + 2].z
      dp3 r26.y, r18.yzwy, r27.xyzx
      mov r28.x, cb10[r14.y + 1].y
      mov r28.yz, cb10[r14.y + 2].xxwx
      dp3 r26.z, r18.yzwy, r28.xyzx
      ubfe r16.x, l(9), l(16), cb10[r14.y + 7].z
      utof r26.w, r16.x
      sample_l_indexable(texturecubearray)(float,float,float,float) r18.yzw, r26.xyzw, t8.wxyz, s2, r14.w
      dp3 r29.x, r23.xyzx, r25.xyzx
      dp3 r29.y, r23.xyzx, r27.xyzx
      dp3 r29.z, r23.xyzx, r28.xyzx
      mad_sat r23.xyz, r29.xyzx, cb10[r14.y + 3].xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
      mul r29.xy, r23.xyxx, cb10[r14.y + 4].zwzz
      mul r29.z, r23.z, cb10[r14.y + 5].x
      add r23.xyz, r29.xyzx, cb10[r14.y + 5].yzwy
...
if_nz r13.w
  ...
  loop 
    ieq r16.w, r13.w, l(2)
    breakc_nz r16.w
    movc r16.w, r13.w, r0.y, r13.z
    ult r17.w, r16.w, r13.y
    if_nz r17.w
      ...
      movc r25.xy, r18.wwww, r16.xyxx, r16.zxzz
      ...
      loop 
        ...
        movc r18.y, r25.w, r19.w, r26.z
        movc r26.xy, r25.zzzz, r26.xyxx, r18.xyxx
        iadd r18.w, r18.w, l(1)
        mov r16.x, r24.w
      endloop 
      ...
      if_nz r18.y
        ...
        dp3 r18.y, r15.xyzx, r25.xyzx
        dp3 r18.z, r24.xyzx, r25.xyzx
        ...
        mad r18.yzw, r15.xxyz, r17.wwww, r25.xxyz
        ...
        mov r25.x, cb10[r16.w + 0].w
        mov r25.y, cb10[r16.w + 1].z
        mov r25.z, cb10[r16.w + 2].y
        dp3 r27.x, r18.yzwy, r25.xyzx
        ...
        utof r27.w, r18.y
        sample_l_indexable(texturecubearray)(float,float,float,float) r18.yzw, r27.xyzw, t8.wxyz, s2, r17.w
        dp3 r30.x, r24.xyzx, r25.xyzx
        dp3 r30.y, r24.xyzx, r28.xyzx
        dp3 r30.z, r24.xyzx, r29.xyzx
        mad_sat r24.xyz, r30.xyzx, cb10[r16.w + 3].xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
        mul r30.xy, r24.xyxx, cb10[r16.w + 4].zwzz
        mul r30.z, r24.z, cb10[r16.w + 5].x
        add r24.xyz, r30.xyzx, cb10[r16.w + 5].yzwy
        ...
        dp3 r16.w, r26.xzwx, l(0.212600, 0.715200, 0.072200, 0.000000)
        mad r14.yzw, r24.xxyz, r25.xxyz, r14.yyzw
        mul r17.z, r12.w, r16.w
        mul r18.yzw, r16.xxxx, r18.yyzw
        dp3 r16.x, r18.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
        mad r16.x, r12.w, r16.w, r16.x
        div r16.x, r17.z, r16.x
        mad r23.xyz, r18.yzwy, r16.xxxx, r23.xyzx
      endif 
    endif 
    iadd r13.w, r13.w, l(1)
  endloop 
...
if_nz r7.w
  ...
  mov r15.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r15.xyz, r15.xyzw, t8.xyzw, s2, r9.w
  mad r0.y, cb2[19].x, r7.w, -r10.w
  mad r0.y, r2.y, r0.y, r10.w
  mad r14.yzw, r15.xxyz, r0.yyyy, r14.yyzw
endif 
add r0.y, -r0.w, l(1.000000)
mad r9.xyz, r14.yzwy, r0.yyyy, r9.xyzx
...
if_nz r0.y
  ...
  if_nz r0.y
    ...
    mad r3.w, r2.x, r0.y, r0.w
    mul r0.yw, r0.yyyw, r3.wwww
    mul r3.w, r1.z, cb2[18].w
    mul r3.w, r6.w, r3.w
    if_nz cb2[23].x
      add r9.xyz, r10.xyzx, cb1[24].xyzx
      mov r9.w, l(1.000000)
      dp4 r4.z, cb2[24].xyzw, r9.xyzw
    ...
    if_nz r7.w
      ...
      if_nz r0.x
        ...
        mov r15.w, l(1.000000)
        dp4 r16.x, r16.xyzw, r15.xyzw
        mov r17.xyz, cb9[r0.x + 5].yzwy
        mov r17.w, cb9[r0.x + 6].x
        dp4 r16.y, r17.xyzw, r15.xyzw
        mad r16.xy, r16.xyxx, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
        ...
        if_z r4.z
          ...
          mov_sat r16.xy, r16.xyxx
          mad r15.x, r16.x, cb9[r0.x + 8].y, cb9[r0.x + 8].z
          mad r15.y, r16.y, cb9[r0.x + 8].w, cb9[r0.x + 9].x
          ...
          if_nz cb2[58].y
            ...
            loop 
              ...
              mad r17.xy, r18.xyxx, cb9[r0.x + 3].yyyy, r15.xyxx
    ...
    mad r15.xyz, r0.xxxx, r9.xyzx, r13.yzwy
    ...
    mad r11.xyz, r0.yyyy, r9.xyzx, r2.yzwy
    add_sat r0.x, -r0.x, l(1.000000)
    mul r0.z, r0.x, r0.x
    mul r0.z, r0.z, r0.z
    mul r0.x, r0.z, r0.x
    mul r0.x, r0.x, r0.y
    mad r0.xyz, r0.xxxx, r9.xyzx, r14.yzwy
    movc r13.yzw, r1.wwww, r15.xxyz, r13.yyzw
    movc r14.yzw, r1.wwww, r0.xxyz, r14.yyzw
    movc r2.yzw, r1.wwww, r11.xxyz, r2.yyzw
  endif 
endif 
...
mad r0.xyz, r13.yzwy, r3.xyzx, r0.xyzx
