...
sample_indexable(texture2d)(float,float,float,float) r1.xyz, v2.xyxx, t24.xyzw, s5
...
frc r3.w, r3.w
mad r3.w, r3.w, l(6.28318548), cb1[70].w
sincos r4.x, r8.x, r3.w
dp3_sat r5.x, r1.xyzx, r3.xyzx
dp3 r3.w, -r3.xyzx, r1.xyzx
add r3.w, r3.w, r3.w
mad r9.xyz, r1.xyzx, -r3.wwww, -r3.xyzx
...
loop 
  ...
  ieq r8.z, r0.w, r7.w
  bfi r8.w, r2.x, l(0), l(0), r8.y
  movc r8.y, r8.z, r8.w, r8.y
  ieq r8.z, r2.y, r7.w
  ubfe r8.w, r6.w, l(0), r8.y
  movc r8.y, r8.z, r8.w, r8.y
    ...
    if_nz r11.w
      ...
      if_nz r11.z
        ...
        if_nz r13.x
          ...
          sqrt r11.z, r11.z
          mad r11.z, r4.z, l(5.000000), r11.z
...
max r0.w, r19.w, l(1.000000)
rcp r0.w, r0.w
mov_sat r19.w, r19.w
mul r11.xyz, r0.wwww, r18.xyzx
mul r8.yzw, r0.wwww, r19.xxyz
lt r2.x, r19.w, l(0.990000)
if_nz r2.x
  add r2.x, -r19.w, l(1.000000)
  ...
  mad r11.xyz, r18.xyzx, r0.wwww, r12.xyzx
  mov r9.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r12.xyz, r9.xyzw, t8.xyzw, s2, r4.w
  mad r0.w, cb2[19].x, r2.x, -r1.w
...
mul r12.xyz, r2.xxxx, r8.zwyz
mul r5.yzw, r2.yyyy, r8.yyzw
sqrt r0.w, r4.y
mad r0.w, r0.w, l(0.500000), l(0.500000)
mul r0.w, r0.w, r0.w
mul r1.w, r0.w, l(0.500000)
mad r0.w, -r0.w, l(0.500000), l(1.000000)
mad r2.x, r5.x, r0.w, r1.w
mul r0.w, r0.w, r2.x
mul r1.w, r1.w, r2.x
dp3 r2.x, r1.xyzx, cb2[17].xyzx
mov_sat r2.y, r2.x
ge r4.z, l(0.000000), r2.y
if_nz r4.z
  mov r4.w, l(0)
endif 
if_z r4.z
  ...
  if_z r7.w
    if_z cb2[58].y
      ...
      itof r7.w, cb2[26].y
      add r13.z, r6.z, r7.w
      sample_c_lz_indexable(texture2darray)(float,float,float,float) r7.w, r13.xyzx, t13.xxxx, s13, r4.z
    ...
    if_nz cb2[58].y
      ...
      loop 
        ...
        utof r15.z, r10.w
        sample_c_lz_indexable(texture2darray)(float,float,float,float) r10.w, r15.xyzx, t13.xxxx, s13, r4.z
...
if_nz r4.z
  lt r4.z, l(0.000000), r4.w
  if_nz r4.z
    mul r4.z, r3.w, cb2[18].w
    mul r4.z, r2.y, r4.z
    if_nz cb2[23].x
    ...
    if_nz r6.w
      ...
      mad r7.w, |r2.x|, l(-0.200000), l(0.400000)
      mad r17.xyz, r1.xyzx, r7.wwww, v7.xyzx
    ...
    mad r14.xyz, r2.yyyy, r8.yzwy, r5.yzwy
    add_sat r2.z, -r2.z, l(1.000000)
    mul r4.z, r2.z, r2.z
    mul r4.z, r4.z, r4.z
    mul r2.z, r2.z, r4.z
    mul r2.y, r2.z, r2.y
    mad r15.xyz, r2.yyyy, r8.zwyz, r12.xyzx
    mov r13.w, r15.z
    mov r11.w, r12.z
    movc r11.xyzw, r2.xxxx, r13.xyzw, r11.xyzw
    mov r15.zw, r14.xxxy
    mov r12.zw, r5.yyyz
    movc r13.xyzw, r2.xxxx, r15.xyzw, r12.xyzw
    movc r5.w, r2.x, r14.z, r5.w
    mov r12.z, r11.w
    mov r12.xy, r13.xyxx
    mov r5.yz, r13.zzwz
  endif 
...
mov r4.z, l(0)
loop 
  uge r4.w, r4.z, cb2[0].x
  breakc_nz r4.w
  ushr r14.z, r4.z, l(5)
  iadd r15.xyz, r10.xyzx, r14.xyzx
  ld_indexable(texture2darray)(uint,uint,uint,uint) r4.w, r15.xyzw, t6.yzwx
  mov r15.xyz, r8.yzwy
  ...
  loop 
    ...
    if_nz r9.w
      ...
      if_nz r7.w
        ...
        ubfe r7.w, l(3), l(24), r31.w
        switch r7.w
          case l(4)
          lt r7.w, l(0.000000), r36.x
          mov r37.xy, r35.zwzz
          mov r37.z, r36.w
          mad r38.xyz, -r37.xyzx, l(0.500000, 0.500000, 0.500000, 0.000000), r30.yzwy
          add r39.xyz, r38.xyzx, -v7.xyzx
          dp3 r9.w, r37.xyzx, r39.xyzx
          div_sat r10.w, -r9.w, r36.x
          mad r40.xyz, r10.wwww, r37.xyzx, r38.xyzx
          movc r40.xyz, r7.wwww, r40.xyzx, r30.yzwy
          add r40.xyz, r40.xyzx, -v7.xyzx
          dp3 r11.w, r40.xyzx, r40.xyzx
          rsq r12.w, r11.w
          mul r40.xyz, r12.wwww, r40.xyzx
          dp3 r12.w, r1.xyzx, r40.xyzx
          mov_sat r14.z, r12.w
          lt r14.w, l(0.000000), r14.z
          if_nz r14.w
            sqrt r14.w, r11.w
            mul r19.w, r33.x, r33.x
            div r11.w, r19.w, r11.w
            min r11.w, r11.w, l(1.000000)
            mad_sat r40.xy, r14.wwww, r32.xzxx, r32.ywyy
            ...
            mul r11.w, r11.w, r40.x
            mul r11.w, r40.y, r11.w
            ...
            if_nz r14.w
              ...
              if_nz r14.w
                ...
                mad r40.xyz, r1.xyzx, r14.wwww, v7.xyzx
                add r40.xyz, -r34.xyzx, r40.xyzx
                max r14.w, |r40.z|, |r40.y|
                max r14.w, r14.w, |r40.x|
                div r14.w, r35.x, r14.w
                ...
                loop 
                  ige r25.w, r24.w, l(8)
                  breakc_nz r25.w
                  dp2 r42.y, icb[r24.w + 0].yxyy, r13.xyxx
                  dp2 r42.z, icb[r24.w + 0].yxyy, r13.yzyy
                  mul r42.yz, r33.yyyy, r42.yyzy
                  mul r42.x, r8.x, r42.y
                  mul r42.w, r4.x, r42.y
                  mad r41.xyz, r40.xyzx, r19.wwww, r42.xzwx
                  sample_c_lz_indexable(texturecubearray)(float,float,float,float) r25.w, r41.xyzw, t10.xxxx, s13, r14.w
              ...
              mul r11.w, r11.w, r23.w
              lt r14.w, l(0.000000), r11.w
              if_nz r14.w
                mul r14.w, r3.w, r31.x
                mul r14.w, r14.w, l(0.250000)
                dp3 r19.w, r37.xyzx, r9.xyzx
                dp3 r24.w, r9.xyzx, r39.xyzx
                mad r25.w, -r19.w, r19.w, r36.x
                mad r9.w, r19.w, r24.w, -r9.w
                div_sat r9.w, r9.w, r25.w
                div r19.w, r25.w, r36.x
                mul r19.w, r19.w, l(10.000000)
                min r19.w, r19.w, l(1.000000)
                add r9.w, -r10.w, r9.w
                mad r9.w, r19.w, r9.w, r10.w
                mad r37.xyz, r9.wwww, r37.xyzx, r38.xyzx
                movc r37.xyz, r7.wwww, r37.xyzx, r30.yzwy
                add r37.xyz, r37.xyzx, -v7.xyzx
                dp3 r7.w, r37.xyzx, r37.xyzx
                rsq r7.w, r7.w
                mul r38.xyz, r7.wwww, r37.xyzx
                ubfe r9.w, l(4), l(16), r31.w
                ult r10.w, l(0), r9.w
                ...
                if_nz r10.w
                  ...
                  mad r17.xyz, r1.xyzx, r19.wwww, v7.xyzx
                  dp4 r19.w, r39.xyzw, r17.xyzw
                  dp4 r24.w, r40.xyzw, r17.xyzw
                  lt r25.w, r24.w, r19.w
                  if_z r25.w
                    ...
                    mul r17.x, r24.w, r43.y
                    mad r17.y, r43.x, r24.w, r19.w
                    div r17.x, r17.y, r17.x
                  else 
                    mov r17.z, l(-1)
                  endif 
                  or r17.y, r25.w, r17.z
                  if_z r17.y
                    ...
                    if_nz r5.x
                      ...
                      loop 
                        ...
                        mad r40.xy, r41.xyxx, r10.wwww, r39.xyxx
                        sample_c_lz_indexable(texture2darray)(float,float,float,float) r19.w, r40.xyzx, t9.xxxx, s13, r17.x
                  ...
                  ubfe r9.w, l(4), l(20), r31.w
                  ult r10.w, l(0), r9.w
                  and r10.w, r2.x, r10.w
                  if_nz r10.w
                    iadd r9.w, r9.w, cb2[0].x
                    iadd r9.w, r9.w, l(-1)
                    ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r10.w, r9.w, l(52), t12.xxxx
                    ...
                    if_z r17.z
                      ...
                      if_nz r5.x
                        ...
                        loop 
                          ige r24.w, r19.w, l(8)
                          breakc_nz r24.w
                          dp2 r40.x, icb[r19.w + 0].xyxx, r7.xyxx
                          dp2 r40.y, icb[r19.w + 0].yxyy, r7.xzxx
                          mad r18.xy, r40.xyxx, r10.wwww, r39.xyxx
                ...
                mad r9.w, -r14.z, r2.y, l(1.000000)
                mul r9.w, r9.w, r9.w
                mad r9.w, -r9.w, l(0.620000), l(0.620000)
                add r9.w, -r14.z, r9.w
                mad r9.w, r4.y, r9.w, r14.z
                mul r9.w, r11.w, r9.w
                mov r31.x, r30.x
                lt r10.w, l(0.000000), r12.w
                mad r18.xyz, r9.wwww, r31.xyzx, r15.xyzx
                dp3_sat r9.w, r1.xyzx, r38.xyzx
                mad r37.xyz, r37.xyzx, r7.wwww, r3.xyzx
                dp3 r7.w, r37.xyzx, r37.xyzx
                rsq r7.w, r7.w
                mul r37.xyz, r7.wwww, r37.xyzx
                dp3 r7.w, r37.xyzx, r3.xyzx
                dp3 r12.w, r1.xyzx, r37.xyzx
                mad r14.z, |r12.w|, r3.w, -|r12.w|
                mad r12.w, |r12.w|, r14.z, l(1.000000)
                mad r14.z, r9.w, r0.w, r1.w
                ...
                mul r9.w, r9.w, r12.w
                mul r9.w, r11.w, r9.w
                mad r37.xyz, r9.wwww, r31.xyzx, r29.xyzx
                add_sat r7.w, -r7.w, l(1.000000)
                mul r11.w, r7.w, r7.w
                mul r11.w, r11.w, r11.w
                mul r7.w, r7.w, r11.w
                mul r7.w, r7.w, r9.w
                mad r38.xyz, r7.wwww, r31.xyzx, r28.xyzx
                movc r15.xyz, r10.wwww, r18.xyzx, r15.xyzx
                movc r28.xyz, r10.wwww, r38.xyzx, r28.xyzx
                movc r29.xyz, r10.wwww, r37.xyzx, r29.xyzx
              endif 
            endif 
          endif 
          break 
          ...
          rsq r7.w, r7.w
          mul r37.xyz, r7.wwww, r18.xyzx
          dp3 r9.w, r1.xyzx, r37.xyzx
          mov_sat r10.w, r9.w
          ...
          if_nz r11.w
            ...
            if_nz r12.w
              ...
              mul r14.w, r33.x, r33.x
              dp3 r17.x, r44.xyzx, r44.xyzx
              div r14.w, r14.w, r17.x
              min r14.w, r14.w, l(1.000000)
              mad_sat r32.xy, r11.wwww, r32.xzxx, r32.ywyy
              ...
              if_nz r11.w
                ...
                exp r32.xy, r32.xyxx
                mul r17.x, r32.x, r42.z
                mad r19.w, r42.w, r32.y, l(-1.000000)
                mad r17.x, r42.w, r32.y, -r17.x
                div_sat r17.x, r19.w, r17.x
                mul r19.w, r17.x, r17.x
                mad r17.x, r17.x, l(-2.000000), l(3.000000)
                mul r11.w, r17.x, r19.w
              endif 
              mul r12.w, r11.w, r14.w
              and r11.w, r14.z, l(255)
              if_nz r11.w
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r32.xyz, r6.w, l(220), t12.xyzx
                dp3 r14.z, r43.yzwy, r19.xyzx
            ...
            if_nz r11.w
              ubfe r11.w, l(3), l(27), r31.w
              ine r11.w, r11.w, l(1)
              if_nz r11.w
                mad r11.w, |r9.w|, l(-0.200000), l(0.400000)
                mad r20.xyz, r1.xyzx, r11.wwww, v7.xyzx
                mov r37.xyz, r36.xyzx
                dp4 r11.w, r37.xyzw, r20.xyzw
                dp4 r14.z, r39.xyzw, r20.xyzw
                ge r14.w, r14.z, r11.w
                if_nz r14.w
                  ...
                  div r6.w, r11.w, r14.z
                  max r6.w, r6.w, l(0.00006104)
                  and r11.w, r31.w, l(0x0000ffff)
                  if_nz r5.x
                    utof r30.z, r11.w
                    ...
                    loop 
                      ige r17.x, r14.w, l(8)
                      breakc_nz r17.x
                      dp2 r32.x, icb[r14.w + 0].xyxx, r23.xyxx
                      dp2 r32.y, icb[r14.w + 0].yxyy, r23.xzxx
                      mad r30.xy, r32.xyxx, r33.yyyy, r20.xyxx
                      sample_c_lz_indexable(texture2darray)(float,float,float,float) r17.x, r30.xyzx, t9.xxxx, s13, r6.w
                      mad r14.z, r17.x, l(0.125000), r14.z
                      iadd r14.w, r14.w, l(1)
                    endloop 
                  else 
                    utof r20.z, r11.w
                    sample_c_lz_indexable(texture2darray)(float,float,float,float) r14.z, r20.xyzx, t9.xxxx, s13, r6.w
                  endif 
                  mul r6.w, r14.z, r14.z
                  mul r6.w, r14.z, r6.w
                else 
                  mov r6.w, l(1.000000)
                endif 
              ...
              if_nz r11.w
                ...
                if_nz r14.w
                  ...
                  mad r17.x, |r9.w|, l(-0.200000), l(0.400000)
                  mad r21.xyz, r1.xyzx, r17.xxxx, v7.xyzx
                  dp4 r20.x, r30.xyzw, r21.xyzw
                  dp4 r20.y, r32.xyzw, r21.xyzw
                  dp4 r17.x, r33.xyzw, r21.xyzw
                  dp4 r20.z, r34.xyzw, r21.xyzw
                  lt r21.x, r20.z, r17.x
                  ...
                  div r21.yz, r14.wwww, r35.xxzx
                  add r30.xy, -r21.yzyy, l(1.000000, 1.000000, 0.000000, 0.000000)
                  ge r30.xy, r20.xyxx, r30.xyxx
                  ge r21.yz, r21.yyzy, r20.xxyx
                  or r21.yz, r21.yyzy, r30.xxyx
                  ...
                  if_z r21.x
                    ...
                    mad r30.xy, r20.xyxx, r35.xzxx, r35.ywyy
                    mul r12.w, r20.z, r21.z
                    mad r17.x, r21.y, r20.z, r17.x
                    div r12.w, r17.x, r12.w
                    max r12.w, r12.w, l(0.00006104)
                    and r17.x, r21.x, l(0x0000ffff)
                    if_nz r5.x
                      utof r20.z, r17.x
                      ...
                      loop 
                        ige r21.z, r21.y, l(8)
                        breakc_nz r21.z
                        dp2 r31.x, icb[r21.y + 0].xyxx, r24.xyxx
                        dp2 r31.y, icb[r21.y + 0].yxyy, r24.xzxx
                        mad r20.xy, r31.xyxx, r14.wwww, r30.xyxx
                      ...
                      utof r30.z, r17.x
                      sample_c_lz_indexable(texture2darray)(float,float,float,float) r21.x, r30.xyzx, t9.xxxx, s13, r12.w
                    endif 
                  ...
                  if_nz r14.w
                    ...
                    if_z r21.y
                      ...
                      mul r12.w, r20.z, r22.y
                      mad r17.x, r22.x, r20.z, r17.x
                      div r12.w, r17.x, r12.w
                      max r12.w, r12.w, l(0.00006104)
                      and r17.x, r21.y, l(0x0000ffff)
                      if_nz r5.x
                        utof r20.z, r17.x
                        ...
                        loop 
                          ige r22.x, r21.z, l(8)
                          breakc_nz r22.x
                          dp2 r22.x, icb[r21.z + 0].xyxx, r25.xyxx
                          dp2 r22.y, icb[r21.z + 0].yxyy, r25.xzxx
                          mad r20.xy, r22.xyxx, r14.wwww, r30.xyxx
                          sample_c_lz_indexable(texture2darray)(float,float,float,float) r20.x, r20.xyzx, t9.xxxx, s13, r12.w
                        ...
                        utof r30.z, r17.x
                        sample_c_lz_indexable(texture2darray)(float,float,float,float) r21.y, r30.xyzx, t9.xxxx, s13, r12.w
                      endif 
                ...
                mad r12.w, -r10.w, r2.y, l(1.000000)
                mul r12.w, r12.w, r12.w
                mad r12.w, -r12.w, l(0.620000), l(0.620000)
                add r12.w, -r10.w, r12.w
                mad r12.w, r4.y, r12.w, r10.w
                mul r12.w, r6.w, r12.w
                lt r9.w, l(0.000000), r9.w
                mad r20.xyz, r12.wwww, r19.xywx, r15.xyzx
                mad r18.xyz, r18.xyzx, r7.wwww, r3.xyzx
                dp3 r7.w, r18.xyzx, r18.xyzx
                rsq r7.w, r7.w
                mul r18.xyz, r7.wwww, r18.xyzx
                dp3 r7.w, r18.xyzx, r3.xyzx
                dp3 r12.w, r1.xyzx, r18.xyzx
                mad r14.w, |r12.w|, r3.w, -|r12.w|
                ...
                mad r18.xyz, r6.wwww, r19.xywx, r29.xyzx
                add_sat r7.w, -r7.w, l(1.000000)
                mul r10.w, r7.w, r7.w
                mul r10.w, r10.w, r10.w
                mul r7.w, r7.w, r10.w
                mul r6.w, r6.w, r7.w
                mad r19.xyw, r6.wwww, r19.xyxw, r28.xyxz
                movc r15.xyz, r9.wwww, r20.xyzx, r15.xyzx
                movc r28.xyz, r9.wwww, r19.xywx, r28.xyzx
                movc r29.xyz, r9.wwww, r18.xyzx, r29.xyzx
              endif 
            endif 
          endif 
          break 
...
ret 
// Approximately 1872 instruction slots used
