...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  while (true) {
    ...
    while (true) {
      ...
      r5.y = samp0[]..swiz;
        ...
        r19.z = samp0[]..swiz;
        r19.w = samp0[]..swiz;
          r20.xyz = v6.xyz + -r18.yzw;
          r5.z = (int)r19.w & 0x0000ffff;
          if (6 == 0) r6.w = 0; else if (6+25 < 32) {           r6.w = (uint)r19.w << (32-(6 + 25)); r6.w = (uint)r6.w >> (32-6);          } else r6.w = (uint)r19.w >> 25;
        // Known bad code for instruction (needs manual fix):
        ...
        r28.z = samp0[]..swiz;
        r28.w = samp0[]..swiz;
          r7.x = dot(r21.xyz, r20.xyz);
          r7.x = saturate(r7.x + r21.w);
          r9.w = dot(r22.xyz, r20.xyz);
          r9.w = saturate(r9.w + r22.w);
          r7.x = r9.w * r7.x;
          r9.w = dot(r23.xyz, r20.xyz);
          r9.w = saturate(r9.w + r23.w);
          r7.x = r9.w * r7.x;
          r9.w = dot(r24.xyz, r20.xyz);
          r9.w = saturate(r9.w + r24.w);
          r7.x = r9.w * r7.x;
          r9.w = dot(r27.xyz, r20.xyz);
          r9.w = saturate(r9.w + r27.w);
          r7.x = r9.w * r7.x;
          r9.w = dot(r28.xyz, r20.xyz);
          r9.w = saturate(r9.w + r28.w);
          r6.x = r9.w * r7.x;
          r7.x = r5.x ? 0.000000 : 0;
          r21.xy = r7.xx ? r6.xy : r6.zx;
          r6.x = r5.x;
          r22.xy = r21.xy;
          r7.x = 1;
          while (true) {
          ...
          r30.w = samp0[]..swiz;
            ...
            r9.w = saturate(r9.w + r23.w);
            r9.w = r22.x * r9.w;
            r11.w = dot(r24.xyz, r20.xyz);
            r11.w = saturate(r11.w + r24.w);
            r9.w = r11.w * r9.w;
            r11.w = dot(r27.xyz, r20.xyz);
            r11.w = saturate(r11.w + r27.w);
            r9.w = r11.w * r9.w;
            r11.w = dot(r28.xyz, r20.xyz);
            r11.w = saturate(r11.w + r28.w);
            r9.w = r11.w * r9.w;
            r11.w = dot(r29.xyz, r20.xyz);
            r11.w = saturate(r11.w + r29.w);
            r9.w = r11.w * r9.w;
            r11.w = dot(r30.xyz, r20.xyz);
            r11.w = saturate(r11.w + r30.w);
            r22.x = r11.w * r9.w;
            r12.w = (uint)r6.x >> 2;
            if (1 == 0) r13.w = 0; else if (1+2 < 32) {             r13.w = (uint)r6.x << (32-(1 + 2)); r13.w = (uint)r13.w >> (32-1);            } else r13.w = (uint)r6.x >> 2;
            r18.w = (int)r12.w & 2;
            r20.w = max(r22.y, r22.x);
            r9.w = -r9.w * r11.w + 1;
            r9.w = r22.y * r9.w;
            r10.y = r18.w ? r9.w : r20.w;
            r22.xy = r13.ww ? r22.xy : r10.xy;
            r7.x = (int)r7.x + 1;
            r6.x = r12.w;
          }
          ...
          r34.x = samp0[]..swiz;
          r34.y = samp0[]..swiz;
            r17.z = r22.y * r5.y + r17.z;
            r4.w = r5.x * r19.z;
            r19.z = r29.z;
            r5.x = dot(r8.xyz, r19.xyz);
            r5.y = dot(r20.xyz, r19.xyz);
            r5.y = r5.y + -r29.w;
            r5.z = cmp(r5.y >= 0);
            ...
            r29.z = r30.z;
            r5.y = dot(r8.xyz, r29.xyz);
            r5.z = dot(r20.xyz, r29.xyz);
            r5.z = r5.z + -r30.w;
            r6.x = cmp(r5.z >= 0);
            ...
            r30.z = r31.z;
            r5.y = dot(r8.xyz, r30.xyz);
            r5.z = dot(r20.xyz, r30.xyz);
            r5.z = r5.z + -r31.w;
            r6.x = cmp(r5.z >= 0);
            r5.z = r6.x ? abs(r5.z) : -abs(r5.z);
            r5.y = max(1.00000001e-07, -r5.y);
            ...
            r5.x = min(r5.x, abs(r5.y));
            r34.zw = r33.zw;
            r5.y = dot(r8.zxy, r34.xzw);
            r5.z = dot(r20.zxy, r34.xzw);
            r5.z = r5.z + -r34.y;
            r6.x = cmp(r5.z >= 0);
            r5.z = r6.x ? abs(r5.z) : -abs(r5.z);
            r5.y = max(1.00000001e-07, -r5.y);
            ...
            r19.xyz = r8.xyz * r5.xxx + r19.xyz;
            r5.y = dot(r19.xyz, r19.xyz);
            r5.y = sqrt(r5.y);
            r5.x = r5.x / r5.y;
            r5.x = r5.x + r5.x;
            r5.x = sqrt(r5.x);
            ...
            r18.y = r21.z;
            r18.z = r23.x;
            r29.x = dot(r19.xyz, r18.xyz);
            r30.xy = r21.xw;
            r30.z = r23.w;
            r29.y = dot(r19.xyz, r30.xyz);
            r23.x = r21.y;
            r29.z = dot(r19.xyz, r23.xyz);
            if (9 == 0) r5.y = 0; else if (9+16 < 32) {             r5.y = (uint)r19.w << (32-(9 + 16)); r5.y = (uint)r5.y >> (32-9);            } else r5.y = (uint)r19.w >> 16;
            r29.w = (uint)r5.y;
            r5.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r29.xyzw, r5.x).xyz;
            r19.x = dot(r20.xyz, r18.xyz);
            r19.y = dot(r20.xyz, r30.xyz);
            r19.z = dot(r20.xyz, r23.xyz);
            r19.xyz = saturate(r19.xyz * r24.xyz + float3(0.5,0.5,0.5));
            r27.z = r28.x;
            r19.xyz = r19.xyz * r27.xyz + r28.yzw;
            r29.x = dot(r1.xyz, r18.xyz);
            r29.y = dot(r1.xyz, r30.xyz);
            r29.z = dot(r1.xyz, r23.xyz);
            r18.xyz = cmp(float3(0,0,0) < r29.xyz);
            r9.z = r18.x ? 0 : 0.5;
            r20.xyz = r19.xyz + r9.xyz;
            r20.xyz = gProbeXArray.SampleLevel(samplerLinearClamp_s, r20.xyz, 0).xyz;
            r21.xyz = r29.xyz * r29.xyz;
            r21.xyz = r21.xyz * r4.www;
            r12.z = r18.y ? 0 : 0.5;
            r18.xyw = r19.xyz + r12.xyz;
            ...
            r18.xyz = r19.xyz * r21.zzz + r18.xyw;
            r19.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r29.xyzw, 6).xyz;
            r20.xyz = r19.xyz * r18.xyz;
            r6.x = dot(r20.xyz, float3(0.212599993,0.715200007,0.0722000003));
            r16.xyz = r18.xyz * r19.xyz + r16.xyz;
            r6.w = r6.x * r0.z;
      ...
      while (true) {
        ...
        r21.y = samp0[]..swiz;
          ...
          r21.w = samp0[]..swiz;
            ...
            r6.w = (int)r21.w & 0x0000ffff;
            if (6 == 0) r7.x = 0; else if (6+25 < 32) {             r7.x = (uint)r21.w << (32-(6 + 25)); r7.x = (uint)r7.x >> (32-6);            } else r7.x = (uint)r21.w >> 25;
          // Known bad code for instruction (needs manual fix):
          ...
          r30.z = samp0[]..swiz;
          r30.w = samp0[]..swiz;
            r10.x = dot(r23.xyz, r22.xyz);
            r10.x = saturate(r10.x + r23.w);
            r10.y = dot(r24.xyz, r22.xyz);
            r10.y = saturate(r10.y + r24.w);
            r10.x = r10.x * r10.y;
            r10.y = dot(r27.xyz, r22.xyz);
            r10.y = saturate(r10.y + r27.w);
            r10.x = r10.x * r10.y;
            r10.y = dot(r28.xyz, r22.xyz);
            r10.y = saturate(r10.y + r28.w);
            r10.x = r10.x * r10.y;
            r10.y = dot(r29.xyz, r22.xyz);
            r10.y = saturate(r10.y + r29.w);
            r10.x = r10.x * r10.y;
            r10.y = dot(r30.xyz, r22.xyz);
            ...
            r31.w = samp0[]..swiz;
              ...
              r12.w = r23.x * r12.w;
              r13.w = dot(r27.xyz, r22.xyz);
              r13.w = saturate(r13.w + r27.w);
              r12.w = r13.w * r12.w;
              r13.w = dot(r28.xyz, r22.xyz);
              r13.w = saturate(r13.w + r28.w);
              r12.w = r13.w * r12.w;
              r13.w = dot(r29.xyz, r22.xyz);
              r13.w = saturate(r13.w + r29.w);
              r12.w = r13.w * r12.w;
              r13.w = dot(r30.xyz, r22.xyz);
              r13.w = saturate(r13.w + r30.w);
              r12.w = r13.w * r12.w;
              r13.w = dot(r31.xyz, r22.xyz);
              ...
              r20.w = (int)r17.w & 2;
              r22.w = max(r23.y, r23.x);
              r12.w = -r12.w * r13.w + 1;
              r12.w = r23.y * r12.w;
              r9.y = r20.w ? r12.w : r22.w;
              r23.xy = r19.ww ? r23.xy : r9.xy;
              r11.w = (int)r11.w + 1;
              r5.x = r17.w;
            }
            r5.x = saturate(r23.y + -r4.y);
            r6.w = r5.x * r9.w;
            r7.x = cmp(0 < r6.w);
            if (r7.x != 0) {
            // Known bad code for instruction (needs manual fix):
            ...
            r36.x = samp0[]..swiz;
            r36.y = samp0[]..swiz;
              r18.w = r5.x * r9.w + r18.w;
              r5.x = r6.w * r21.z;
              r21.z = r31.z;
              r5.w = dot(r8.xyz, r21.xyz);
              r6.w = dot(r22.xyz, r21.xyz);
              r6.w = r6.w + -r31.w;
              r7.x = cmp(r6.w >= 0);
              ...
              r31.z = r32.z;
              r6.w = dot(r8.xyz, r31.xyz);
              r7.x = dot(r22.xyz, r31.xyz);
              r7.x = r7.x + -r32.w;
              r9.y = cmp(r7.x >= 0);
              ...
              r32.z = r33.z;
              r6.w = dot(r8.xyz, r32.xyz);
              r7.x = dot(r22.xyz, r32.xyz);
              r7.x = r7.x + -r33.w;
              r9.y = cmp(r7.x >= 0);
              r7.x = r9.y ? abs(r7.x) : -abs(r7.x);
              r6.w = max(1.00000001e-07, -r6.w);
              ...
              r5.w = min(abs(r6.w), r5.w);
              r36.zw = r35.zw;
              r6.w = dot(r8.zxy, r36.xzw);
              r7.x = dot(r22.zxy, r36.xzw);
              r7.x = r7.x + -r36.y;
              r9.y = cmp(r7.x >= 0);
              r7.x = r9.y ? abs(r7.x) : -abs(r7.x);
              r6.w = max(1.00000001e-07, -r6.w);
              ...
              r20.y = r24.z;
              r20.z = r27.x;
              r31.x = dot(r9.yzw, r20.xyz);
              r21.xy = r24.xw;
              r21.z = r27.w;
              r31.y = dot(r9.yzw, r21.xyz);
              r27.x = r24.y;
              r31.z = dot(r9.yzw, r27.xyz);
              if (9 == 0) r6.w = 0; else if (9+16 < 32) {               r6.w = (uint)r21.w << (32-(9 + 16)); r6.w = (uint)r6.w >> (32-9);              } else r6.w = (uint)r21.w >> 16;
              r31.w = (uint)r6.w;
              r9.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r31.xyzw, r5.w).xyz;
              r24.x = dot(r22.xyz, r20.xyz);
              r24.y = dot(r22.xyz, r21.xyz);
              r24.z = dot(r22.xyz, r27.xyz);
              r22.xyz = saturate(r24.xyz * r28.xyz + float3(0.5,0.5,0.5));
              r29.z = r30.x;
              ...
              r5.w = dot(r22.xyz, float3(0.212599993,0.715200007,0.0722000003));
              r19.xyz = r20.xyz * r21.xyz + r19.xyz;
              r6.z = r5.w * r0.z;
              r9.yzw = r9.yzw * r5.xxx;
              r5.x = dot(r9.yzw, float3(0.212599993,0.715200007,0.0722000003));
              r5.x = r0.z * r5.w + r5.x;
              r5.x = r6.z / r5.x;
              r18.xyz = r9.yzw * r5.xxx + r18.xyz;
            }
          }
        }
      }
  ...
  r2.xyz = r14.xyz * r0.zzz;
  r3.xyz = r15.xyz * r0.zzz;
  r0.w = cmp(r15.w < 0.99000001);
  if (r0.w != 0) {
    r0.w = 1 + -r15.w;
