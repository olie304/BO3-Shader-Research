...
r0.x = colorSampler[]..swiz;
  ...
  if (r3.x != 0) {
    r3.x = w1.x * r4.w;
    r3.z = transGlossRange.y + -transGlossRange.x;
    r3.y = r3.y * r3.z + transGlossRange.x;
    r3.y = saturate(0.0588235296 * r3.y);
    r3.x = r3.x * r0.x;
    r4.xyz = r4.xyz * v1.xyz + -r1.xyz;
    r1.xyz = r3.xxx * r4.xyz + r1.xyz;
    r3.y = r3.y * 2 + -1;
    r3.y = r3.x * r3.y + 1;
    r2.w = saturate(r3.y * r2.w);
    r3.yzw = float3(0.0399999991,0.0399999991,0.0399999991) + -r2.xyz;
  ...
  r4.w = min(1, r4.w);
  r4.xy = r5.xy * detailScaleHeight + r3.yz;
  r3.y = dot(r4.xyz, r4.xyz);
  r3.y = rsqrt(r3.y);
  r4.xyz = r4.xyz * r3.yyy;
  r3.y = r4.w * detailScaleHeight + r3.w;
  r3.z = cmp(0 < r3.x);
  ...
  r0.z = rsqrt(r0.z);
  r3.xzw = v4.xyz * r0.zzz;
  r5.xyz = r3.xzw * r0.yyy;
  ...
  r2.w = rsqrt(r2.w);
  r4.yzw = r4.xyz * r2.www;
  r5.zw = tintScale.xy * v2.xy;
  ...
  r2.w = waterRefractionAmount * r1.w;
  r2.w = cmp(0 < r2.w);
  r3.y = 17 * r0.z;
  r3.y = exp2(r3.y);
  r3.y = 2 + r3.y;
