...
r1.w = samp0[]..swiz;
  ...
  if (r3.y != 0) {
    ...
    r3.z = cmp(r3.z < r3.w);
    r3.w = cmp(0 < r3.w);
    r8.xyz = (int3)r3.yyy & int3(1,2,4);
    r9.xyz = r8.xxx ? float3(1,0,1) : r1.xyz;
    r8.xyw = r8.yyy ? float3(0,1,1) : r1.xyz;
    r8.xyw = r3.www ? r9.xyz : r8.xyw;
    r9.xyz = r8.zzz ? float3(0,1,0) : r1.xyz;
    r1.xyz = r3.zzz ? r8.xyw : r9.xyz;
  }
  r3.yzw = debugColorOverride.xyz + -r1.xyz;
  r1.xyz = debugColorOverride.www * r3.yzw + r1.xyz;
  r3.y = debugAlphaOverride.x + -r2.w;
  r2.w = debugAlphaOverride.w * r3.y + r2.w;
  r3.yzw = debugSpecularOverride.xyz + -r2.xyz;
  r2.xyz = debugSpecularOverride.www * r3.yzw + r2.xyz;
  r3.x = r3.x + -r1.w;
  r1.w = debugGlossOverride.w * r3.x + r1.w;
  r3.x = debugOcclusionOverride.x + -r0.x;
  r0.x = debugOcclusionOverride.w * r3.x + r0.x;
  r3.xyz = v7.xxx ? v3.xyz : -v3.xyz;
  r3.w = dot(r3.xyz, r3.xyz);
  r3.w = rsqrt(r3.w);
  r3.xyz = r3.xyz * r3.www + -r4.xzw;
  r3.xyz = debugNormalOverride.www * r3.xyz + r4.xzw;
            ...
            r29.w = samp0[]..swiz;
              ...
              r26.w = samp0[]..swiz;
                ...
                if (r25.y != 0) {
                  ...
                  r27.xyz = r28.xyz * r4.yyy;
                  r25.xyz = r25.xyz * r4.yyy;
                  r26.xyz = r26.xyz * r4.yyy;
                  r19.w = -17 * r15.w;
                  r19.w = exp2(r19.w);
                  r18.w = r19.w + r18.w;
                  r18.w = log2(r18.w);
  ...
  r4.yw = r4.yw * r3.zz + w1.xy;
  r5.xyzw = emissiveMap.Sample(colorSampler_s, r4.yw).xyzw;
  ...
  r4.yw = (uint2)r4.zx;
  r0.z = dot(r4.wy, float2(0.0671105608,0.00583714992));
  r0.z = frac(r0.z);
  r0.z = 52.9829178 * r0.z;
  r0.z = frac(r0.z);
  r0.z = r0.z * 6.28318548 + gameTick.w;
  sincos(r0.z, r6.x, r7.x);
  r0.z = dot(r4.yw, float2(0.0671105608,0.00583714992));
  r0.z = frac(r0.z);
  r0.z = 52.9829178 * r0.z;
  r0.z = frac(r0.z);
  r0.z = r0.z * 6.28318548 + gameTick.w;
  ...
  r4.x = 0;
  while (true) {
    r4.z = cmp((uint)r4.x >= numRefProbes);
    if (r4.z != 0) break;
    r14.z = (uint)r4.x >> 5;
    r15.xyz = (int3)r13.xyz + (int3)r14.xyz;
    r4.z = visibleProbes.Load(r15.xyzw).x;
  // Known bad code for instruction (needs manual fix):
  ...
  r35.y = samp0[]..swiz;
    ...
    r6.w = dot(r11.yzw, r11.yzw);
    r6.w = sqrt(r6.w);
    r6.w = cmp(probeDebugRadius >= r6.w);
    r7.w = (int)r29.y & 0x0000ffff;
  // Known bad code for instruction (needs manual fix):
  ...
  r41.z = samp0[]..swiz;
  r41.w = samp0[]..swiz;
    r9.w = dot(r36.xyz, r11.yzw);
    r9.w = saturate(r9.w + r36.w);
    r10.w = dot(r37.xyz, r11.yzw);
    r10.w = saturate(r10.w + r37.w);
    r9.w = r10.w * r9.w;
    r10.w = dot(r38.xyz, r11.yzw);
    r10.w = saturate(r10.w + r38.w);
    r9.w = r10.w * r9.w;
    r10.w = dot(r39.xyz, r11.yzw);
    r10.w = saturate(r10.w + r39.w);
    r9.w = r10.w * r9.w;
    r10.w = dot(r40.xyz, r11.yzw);
    r10.w = saturate(r10.w + r40.w);
    r9.w = r10.w * r9.w;
    r10.w = dot(r41.xyz, r11.yzw);
    r10.w = saturate(r10.w + r41.w);
    r16.x = r10.w * r9.w;
    r9.w = (int)r9.y & 1;
    r14.zw = r9.ww ? r16.xy : r16.zx;
    r15.xy = r29.zw;
    r15.z = r30.z;
    r9.w = dot(r12.xyz, r15.xyz);
    r10.w = dot(r11.yzw, r15.xyz);
    r10.w = r10.w + -r30.w;
    r13.w = cmp(r10.w >= 0);
    ...
    r30.z = r31.z;
    r10.w = dot(r12.xyz, r30.xyz);
    r13.w = dot(r11.yzw, r30.xyz);
    r13.w = r13.w + -r31.w;
    r15.x = cmp(r13.w >= 0);
    ...
    r9.w = min(abs(r10.w), r9.w);
    r35.zw = r34.zw;
    r10.w = dot(r12.zxy, r35.xzw);
    r13.w = dot(r11.wyz, r35.xzw);
    r13.w = r13.w + -r35.y;
    r15.x = cmp(r13.w >= 0);
    r13.w = max(abs(r13.w), r4.w);
    r13.w = r15.x ? r13.w : -r13.w;
    ...
    r15.xyz = r12.xyz * r9.www + r15.xyz;
    ...
    r9.w = (int)r29.z | (int)r29.y;
    r9.w = (int)r29.w | (int)r9.w;
    r28.xyz = r9.www ? float3(1,1,0) : r28.xyz;
    r30.xyzw = r21.xyzw;
    r29.yzw = r22.yzw;
    r9.w = r3.w;
    r10.w = r4.z;
    while (true) {
      ...
      if (r15.y != 0) {
        ...
        if (r6.w != 0) {
          ...
          r15.y = 1;
          while (true) {
            r15.z = cmp((int)r15.y >= (int)r15.x);
            if (r15.z != 0) break;
            r15.z = (int)r7.w + (int)r15.y;
          // Known bad code for instruction (needs manual fix):
          ...
          r37.z = samp0[]..swiz;
          r37.w = samp0[]..swiz;
            r15.z = dot(r32.xyz, r11.yzw);
            r15.z = saturate(r15.z + r32.w);
            r15.z = r31.x * r15.z;
            r16.x = dot(r33.xyz, r11.yzw);
            r16.x = saturate(r16.x + r33.w);
            r15.z = r16.x * r15.z;
            r16.x = dot(r34.xyz, r11.yzw);
            r16.x = saturate(r16.x + r34.w);
            r15.z = r16.x * r15.z;
            r16.x = dot(r35.xyz, r11.yzw);
            r16.x = saturate(r16.x + r35.w);
            r15.z = r16.x * r15.z;
            r16.x = dot(r36.xyz, r11.yzw);
            r16.x = saturate(r16.x + r36.w);
            r15.z = r16.x * r15.z;
            r16.x = dot(r37.xyz, r11.yzw);
            r16.x = saturate(r16.x + r37.w);
            r31.x = r16.x * r15.z;
            r16.w = (uint)r13.w >> 2;
            if (1 == 0) r17.z = 0; else if (1+2 < 32) {             r17.z = (uint)r13.w << (32-(1 + 2)); r17.z = (uint)r17.z >> (32-1);            } else r17.z = (uint)r13.w >> 2;
            r17.w = (int)r16.w & 2;
            r18.z = max(r31.y, r31.x);
            r15.z = -r15.z * r16.x + 1;
            r15.z = r31.y * r15.z;
            r20.y = r17.w ? r15.z : r18.z;
            r31.xy = r17.zz ? r31.xy : r20.xy;
            r15.y = (int)r15.y + 1;
            r13.w = r16.w;
          }
          ...
          if (r15.y != 0) {
            ...
            r13.w = r13.w * r29.x;
            r20.yzw = r27.xyz * r13.www;
            r31.xzw = r23.xyw * r20.zzz;
            r31.xzw = r25.xyz * r20.yyy + r31.xzw;
            r20.yzw = r26.xyz * r20.www + r31.xzw;
            r31.xzw = r20.yzw * r28.xyz;
            r15.y = dot(r31.xzw, float3(0.212599993,0.715200007,0.0722000003));
            r33.xyz = r20.yzw * r28.xyz + r30.xyz;
            r15.z = r15.y * r6.z;
            r20.yzw = r24.xyz * r13.www;
            r13.w = dot(r20.yzw, float3(0.212599993,0.715200007,0.0722000003));
            r13.w = r6.z * r15.y + r13.w;
            r13.w = r15.z / r13.w;
            r34.x = r30.w;
            r34.yz = r29.yz;
            r32.xyw = r20.zwy * r13.www + r34.yzx;
            r33.w = r32.w;
          } else {
            r33.xyzw = r30.xyzw;
            r32.xyz = r29.yzw;
  ...
  if (r3.w == 0) {
    ...
    while (true) {
      ...
      bitmask.w = ((~(-1 << r4.z)) << 0) & 0xffffffff;  r10.w = (((uint)0 << 0) & bitmask.w) | ((uint)r9.z & ~bitmask.w);
    ...
    if (r6.w != 0) {
      ...
      while (true) {
        ...
        if (r4.z == 0) r11.z = 0; else if (r4.z+0 < 32) {         r11.z = (uint)r10.w << (32-(r4.z + 0)); r11.z = (uint)r11.z >> (32-r4.z);        } else r11.z = (uint)r10.w >> 0;
    ...
    if (r3.w != 0) {
      ...
      r4.xzw = r9.yzw * r4.www + r11.yzw;
      r8.w = 0;
      r9.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r8.xyzw, 6).xyz;
      r4.xzw = r9.yzw * r4.xzw;
      r6.z = dot(r4.xzw, float3(0.212599993,0.715200007,0.0722000003));
      r21.xyz = r23.xyz * r3.zzz + r4.xzw;
      r12.w = 0;
      r4.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r12.xyzw, r4.y).xyz;
      r3.z = sunConstants.globalProbeExposure * r3.w + -r6.z;
      r3.z = r3.y * r3.z + r6.z;
      r22.xyz = r4.xyz * r3.zzz + r22.xyz;
    }
  } else {
    r22.x = r21.w;
  }
  ...
  if (r8.w != 0) {
    ...
    if (r8.w != 0) {
      ...
      r0.w = r8.w * r0.w;
      r0.w = r7.w * r0.w;
      r16.xyz = r0.www * r11.zwy + r14.xyz;
      r15.w = r16.z;
      r4.w = r14.z;
