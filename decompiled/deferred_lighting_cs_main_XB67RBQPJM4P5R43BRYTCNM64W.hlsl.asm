...
if_nz r7.w
  ...
  if_nz r1.z
    add r12.yzw, cb1[24].xxyz, cb10[r7.w + 0].xxyz
    mov r12.x, l(16)
    store_structured u2.xyzw, cb2[52].x, l(880), r12.xyzw
  endif 
  add r12.xyz, r4.xywx, -cb10[r7.w + 0].xyzx
  and r8.w, l(0x0000ffff), cb10[r7.w + 7].z
  ubfe r9.w, l(6), l(25), cb10[r7.w + 7].z
  imul null, r12.w, r8.w, l(6)
  dp3 r13.x, cb11[r12.w + 0].xyzx, r12.xyzx
  add_sat r13.x, r13.x, cb11[r12.w + 0].w
  dp3 r13.y, cb11[r12.w + 1].xyzx, r12.xyzx
  add_sat r13.y, r13.y, cb11[r12.w + 1].w
  mul r13.x, r13.y, r13.x
  dp3 r13.y, cb11[r12.w + 2].xyzx, r12.xyzx
  add_sat r13.y, r13.y, cb11[r12.w + 2].w
  mul r13.x, r13.y, r13.x
  dp3 r13.y, cb11[r12.w + 3].xyzx, r12.xyzx
  add_sat r13.y, r13.y, cb11[r12.w + 3].w
  mul r13.x, r13.y, r13.x
  dp3 r13.y, cb11[r12.w + 4].xyzx, r12.xyzx
  add_sat r13.y, r13.y, cb11[r12.w + 4].w
  mul r13.x, r13.y, r13.x
  dp3 r13.y, cb11[r12.w + 5].xyzx, r12.xyzx
  add_sat r12.w, r13.y, cb11[r12.w + 5].w
  mul r13.x, r12.w, r13.x
  and r12.w, l(1), cb10[r7.w + 6].x
  mov r13.yz, l(0,0,1.000000,0)
  movc r13.xy, r12.wwww, r13.xyxx, r13.zxzz
  mov r14.x, l(1.000000)
  mov r12.w, cb10[r7.w + 6].x
  mov r15.xy, r13.xyxx
  mov r13.z, l(1)
  loop 
    ige r13.w, r13.z, r9.w
    breakc_nz r13.w
    iadd r13.w, r8.w, r13.z
    imul null, r13.w, r13.w, l(6)
    dp3 r14.z, cb11[r13.w + 0].xyzx, r12.xyzx
    add_sat r14.z, r14.z, cb11[r13.w + 0].w
    mul r14.z, r14.z, r15.x
    dp3 r14.w, cb11[r13.w + 1].xyzx, r12.xyzx
    add_sat r14.w, r14.w, cb11[r13.w + 1].w
    mul r14.z, r14.w, r14.z
    dp3 r14.w, cb11[r13.w + 2].xyzx, r12.xyzx
    add_sat r14.w, r14.w, cb11[r13.w + 2].w
    mul r14.z, r14.w, r14.z
    dp3 r14.w, cb11[r13.w + 3].xyzx, r12.xyzx
    add_sat r14.w, r14.w, cb11[r13.w + 3].w
    mul r14.z, r14.w, r14.z
    dp3 r14.w, cb11[r13.w + 4].xyzx, r12.xyzx
    add_sat r14.w, r14.w, cb11[r13.w + 4].w
    mul r14.z, r14.w, r14.z
    dp3 r14.w, cb11[r13.w + 5].xyzx, r12.xyzx
    add_sat r13.w, r14.w, cb11[r13.w + 5].w
    mul r15.x, r13.w, r14.z
    ushr r14.w, r12.w, l(2)
    ubfe r15.z, l(1), l(2), r12.w
    and r15.w, r14.w, l(2)
    max r16.x, r15.x, r15.y
    mad r13.w, -r14.z, r13.w, l(1.000000)
    mul r13.w, r13.w, r15.y
    movc r14.y, r15.w, r13.w, r16.x
    movc r15.xy, r15.zzzz, r15.xyxx, r14.xyxx
    iadd r13.z, r13.z, l(1)
    mov r12.w, r14.w
  endloop 
  mov_sat r15.y, r15.y
  mul r8.w, r15.y, cb10[r7.w + 6].y
  ...
  if_nz r9.w
    ...
    mov r13.x, cb10[r7.w + 7].w
    mov r13.yz, cb10[r7.w + 8].xxyx
    dp3 r12.w, r11.xyzx, r13.xyzx
    dp3 r13.x, r12.xyzx, r13.xyzx
    add r13.x, r13.x, -cb10[r7.w + 8].z
    ...
    mov r13.x, cb10[r7.w + 8].w
    mov r13.yz, cb10[r7.w + 9].xxyx
    dp3 r13.w, r11.xyzx, r13.xyzx
    dp3 r13.x, r12.xyzx, r13.xyzx
    add r13.x, r13.x, -cb10[r7.w + 9].z
    ge r13.y, r13.x, l(0.000000)
    max r13.x, r2.w, |r13.x|
    movc r13.x, r13.y, r13.x, -r13.x
    max r13.y, -r13.w, l(0.00000010)
    div r13.x, r13.x, r13.y
    min r12.w, r12.w, |r13.x|
    mov r13.x, cb10[r7.w + 9].w
    mov r13.yz, cb10[r7.w + 10].xxyx
    dp3 r13.w, r11.xyzx, r13.xyzx
    dp3 r13.x, r12.xyzx, r13.xyzx
    add r13.x, r13.x, -cb10[r7.w + 10].z
    ge r13.y, r13.x, l(0.000000)
    max r13.x, r2.w, |r13.x|
    movc r13.x, r13.y, r13.x, -r13.x
    max r13.y, -r13.w, l(0.00000010)
    div r13.x, r13.x, r13.y
    min r12.w, r12.w, |r13.x|
    mov r13.x, cb10[r7.w + 10].w
    mov r13.yz, cb10[r7.w + 11].xxyx
    dp3 r13.w, r11.xyzx, r13.xyzx
    dp3 r13.x, r12.xyzx, r13.xyzx
    add r13.x, r13.x, -cb10[r7.w + 11].z
    ge r13.y, r13.x, l(0.000000)
    max r13.x, r2.w, |r13.x|
    movc r13.x, r13.y, r13.x, -r13.x
    max r13.y, -r13.w, l(0.00000010)
    div r13.x, r13.x, r13.y
    min r12.w, r12.w, |r13.x|
    mov r13.x, cb10[r7.w + 11].w
    mov r13.yz, cb10[r7.w + 12].xxyx
    dp3 r13.w, r11.xyzx, r13.xyzx
    dp3 r13.x, r12.xyzx, r13.xyzx
    add r13.x, r13.x, -cb10[r7.w + 12].z
    ge r13.y, r13.x, l(0.000000)
    max r13.x, r2.w, |r13.x|
    movc r13.x, r13.y, r13.x, -r13.x
    max r13.y, -r13.w, l(0.00000010)
    div r13.x, r13.x, r13.y
    min r12.w, r12.w, |r13.x|
    mov r13.x, cb10[r7.w + 12].w
    mov r13.yz, cb10[r7.w + 13].xxyx
    dp3 r13.w, r11.xyzx, r13.xyzx
    dp3 r13.x, r12.xyzx, r13.xyzx
    add r13.x, r13.x, -cb10[r7.w + 13].z
    ge r13.y, r13.x, l(0.000000)
    max r13.x, r2.w, |r13.x|
    movc r13.x, r13.y, r13.x, -r13.x
    max r13.y, -r13.w, l(0.00000010)
    div r13.x, r13.x, r13.y
    min r12.w, r12.w, |r13.x|
    add r13.x, r12.x, cb10[r7.w + 3].w
    add r13.yz, r12.yyzy, cb10[r7.w + 4].xxyx
    mad r13.xyz, r11.xyzx, r12.wwww, r13.xyzx
    ...
    mov r14.x, cb10[r7.w + 0].w
    mov r14.y, cb10[r7.w + 1].z
    mov r14.z, cb10[r7.w + 2].y
    dp3 r15.x, r13.xyzx, r14.xyzx
    mov r16.xy, cb10[r7.w + 1].xwxx
    mov r16.z, cb10[r7.w + 2].z
    dp3 r15.y, r13.xyzx, r16.xyzx
    mov r17.x, cb10[r7.w + 1].y
    mov r17.yz, cb10[r7.w + 2].xxwx
    dp3 r15.z, r13.xyzx, r17.xyzx
    ubfe r13.x, l(9), l(16), cb10[r7.w + 7].z
    utof r15.w, r13.x
    sample_l_indexable(texturecubearray)(float,float,float,float) r13.xyz, r15.xyzw, t8.xyzw, s2, r12.w
    ...
    movc r13.xyz, r12.wwww, l(1.000000,1.000000,0,0), r13.xyzx
    dp3 r18.x, r12.xyzx, r14.xyzx
    dp3 r18.y, r12.xyzx, r16.xyzx
    dp3 r18.z, r12.xyzx, r17.xyzx
    mad_sat r12.xyz, r18.xyzx, cb10[r7.w + 3].xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
    mul r18.xy, r12.xyxx, cb10[r7.w + 4].zwzz
    mul r18.z, r12.z, cb10[r7.w + 5].x
    add r12.xyz, r18.xyzx, cb10[r7.w + 5].yzwy
...
if_nz r6.w
  ...
  if_nz r1.z
    ...
    mov r14.x, l(16)
    store_structured u2.xyzw, cb2[52].x, r6.w, r14.xyzw
  endif 
  iadd r6.w, r7.w, l(1)
  ...
  dp3 r14.w, cb11[r13.w + 0].xyzx, r14.xyzx
  add_sat r14.w, r14.w, cb11[r13.w + 0].w
  dp3 r15.x, cb11[r13.w + 1].xyzx, r14.xyzx
  add_sat r15.x, r15.x, cb11[r13.w + 1].w
  mul r14.w, r14.w, r15.x
  dp3 r15.x, cb11[r13.w + 2].xyzx, r14.xyzx
  add_sat r15.x, r15.x, cb11[r13.w + 2].w
  mul r14.w, r14.w, r15.x
  dp3 r15.x, cb11[r13.w + 3].xyzx, r14.xyzx
  add_sat r15.x, r15.x, cb11[r13.w + 3].w
  mul r14.w, r14.w, r15.x
  dp3 r15.x, cb11[r13.w + 4].xyzx, r14.xyzx
  add_sat r15.x, r15.x, cb11[r13.w + 4].w
  mul r14.w, r14.w, r15.x
  dp3 r15.x, cb11[r13.w + 5].xyzx, r14.xyzx
  add_sat r13.w, r15.x, cb11[r13.w + 5].w
  mul r15.x, r13.w, r14.w
  and r13.w, l(1), cb10[r0.y + 6].x
  mov r15.yz, l(0,0,1.000000,0)
  movc r15.xy, r13.wwww, r15.xyxx, r15.zxzz
  mov r16.x, l(1.000000)
  mov r13.w, cb10[r0.y + 6].x
  mov r17.xy, r15.xyxx
  mov r14.w, l(1)
  loop 
    ige r15.z, r14.w, r12.w
    breakc_nz r15.z
    iadd r15.z, r9.w, r14.w
    imul null, r15.z, r15.z, l(6)
    dp3 r15.w, cb11[r15.z + 0].xyzx, r14.xyzx
    add_sat r15.w, r15.w, cb11[r15.z + 0].w
    mul r15.w, r15.w, r17.x
    dp3 r16.z, cb11[r15.z + 1].xyzx, r14.xyzx
    add_sat r16.z, r16.z, cb11[r15.z + 1].w
    mul r15.w, r15.w, r16.z
    dp3 r16.z, cb11[r15.z + 2].xyzx, r14.xyzx
    add_sat r16.z, r16.z, cb11[r15.z + 2].w
    mul r15.w, r15.w, r16.z
    dp3 r16.z, cb11[r15.z + 3].xyzx, r14.xyzx
    add_sat r16.z, r16.z, cb11[r15.z + 3].w
    mul r15.w, r15.w, r16.z
    dp3 r16.z, cb11[r15.z + 4].xyzx, r14.xyzx
    add_sat r16.z, r16.z, cb11[r15.z + 4].w
    mul r15.w, r15.w, r16.z
    dp3 r16.z, cb11[r15.z + 5].xyzx, r14.xyzx
    add_sat r15.z, r16.z, cb11[r15.z + 5].w
    mul r17.x, r15.z, r15.w
    ushr r16.z, r13.w, l(2)
    ubfe r16.w, l(1), l(2), r13.w
    and r17.z, r16.z, l(2)
    max r17.w, r17.x, r17.y
    mad r15.z, -r15.w, r15.z, l(1.000000)
    mul r15.z, r15.z, r17.y
    movc r16.y, r17.z, r15.z, r17.w
    movc r17.xy, r16.wwww, r17.xyxx, r16.xyxx
    iadd r14.w, r14.w, l(1)
    mov r13.w, r16.z
  endloop 
  add_sat r9.w, -r8.w, r17.y
  mul r12.w, r9.w, cb10[r0.y + 6].y
  ...
  if_nz r13.w
    ...
    if_nz r14.w
      imad r15.xy, r13.wwww, l(20, 20, 0, 0), l(860, 876, 0, 0)
      ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r13.w, cb2[52].x, r15.x, u2.xxxx
      or r13.w, r13.w, l(32)
      store_structured u2.x, cb2[52].x, r15.x, r13.w
      store_structured u2.x, cb2[52].x, r15.y, r12.w
    endif 
    iadd r6.w, r7.w, l(257)
    mad r9.w, r9.w, cb10[r0.y + 6].y, r8.w
    mul r12.w, r12.w, cb10[r0.y + 7].y
    ...
    dp3 r14.w, r11.xyzx, r15.xyzx
    dp3 r15.x, r14.xyzx, r15.xyzx
    add r15.x, r15.x, -cb10[r0.y + 9].z
    ...
    dp3 r14.w, r11.xyzx, r15.xyzx
    dp3 r15.x, r14.xyzx, r15.xyzx
    add r15.x, r15.x, -cb10[r0.y + 10].z
    ge r15.y, r15.x, l(0.000000)
    max r15.x, r2.w, |r15.x|
    movc r15.x, r15.y, r15.x, -r15.x
    max r14.w, -r14.w, l(0.00000010)
    ...
    dp3 r14.w, r11.xyzx, r15.xyzx
    dp3 r15.x, r14.xyzx, r15.xyzx
    add r15.x, r15.x, -cb10[r0.y + 11].z
    ge r15.y, r15.x, l(0.000000)
    max r15.x, r2.w, |r15.x|
    movc r15.x, r15.y, r15.x, -r15.x
    max r14.w, -r14.w, l(0.00000010)
    ...
    dp3 r14.w, r11.xyzx, r15.xyzx
    dp3 r15.x, r14.xyzx, r15.xyzx
    add r15.x, r15.x, -cb10[r0.y + 12].z
    ge r15.y, r15.x, l(0.000000)
    max r15.x, r2.w, |r15.x|
    movc r15.x, r15.y, r15.x, -r15.x
    max r14.w, -r14.w, l(0.00000010)
    ...
    dp3 r14.w, r11.xyzx, r15.xyzx
    dp3 r15.x, r14.xyzx, r15.xyzx
    add r15.x, r15.x, -cb10[r0.y + 13].z
    ge r15.y, r15.x, l(0.000000)
    max r2.w, r2.w, |r15.x|
    movc r2.w, r15.y, r2.w, -r2.w
    max r14.w, -r14.w, l(0.00000010)
    div r2.w, r2.w, r14.w
    min r2.w, |r2.w|, r13.w
...
bfi r1.w, l(8), l(0), r6.w, r7.w
movc r0.y, r0.y, r1.w, r6.w
max r1.w, r9.w, l(1.000000)
rcp r1.w, r1.w
mov_sat r9.w, r9.w
