    ...
    if_nz r1.x
      ...
      if_nz r1.x
        ...
        if_nz r1.x
          ...
          dp3 r1.y, r4.xyzx, r0.xyzx
          mad r2.x, r1.y, v3.w, r2.x
          ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r4.xyzw, r1.x, l(16), t5.xyzw
          dp3 r1.y, r4.xyzx, v0.xyzx
          add r1.y, r4.w, r1.y
          mad r3.y, r1.y, v3.w, r3.y
          dp3 r1.y, r4.xyzx, r0.xyzx
          mad r2.y, r1.y, v3.w, r2.y
          ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r1.xyzw, r1.x, l(32), t5.xyzw
          dp3 r2.w, r1.xyzx, v0.xyzx
          add r1.w, r1.w, r2.w
          mad r3.z, r1.w, v3.w, r3.z
          dp3 r1.x, r1.xyzx, r0.xyzx
          mad r2.z, r1.x, v3.w, r2.z
        endif 
      endif 
    endif 
  else 
...
movc r1.yzw, r0.wwww, r3.xxyz, l(0,1.000000,0,0)
...
dp3 r3.y, r1.yzwy, r4.xyzx
dp3 r3.z, r1.yzwy, r5.xyzx
dp3 r0.z, r3.xyzx, r3.xyzx
rsq r0.z, r0.z
mul r1.yzw, r0.zzzz, r3.xxyz
add r3.xy, v1.xyxx, l(-0.500000, -0.500000, 0.000000, 0.000000)
dp2 r0.z, r3.xyxx, r3.xyxx
sqrt r0.z, r0.z
add r2.w, r0.z, l(-0.225000)
lt r3.x, r2.w, l(0.000000)
mul r0.z, r0.z, l(0.88888896)
mad r2.w, r2.w, l(1.09090912), l(0.200000)
movc r0.z, r3.x, r0.z, r2.w
mul r0.z, r0.z, r0.z
mad_sat r0.z, -r0.z, l(18.400000), l(1.000000)
mul r0.z, r0.z, l(0.101000)
mad r1.yzw, -r1.yyzw, r0.zzzz, r2.xxyz
  ...
  if_nz r0.w
    ...
    if_nz r1.x
      ...
      if_nz r0.x
        ...
        dp3 r1.x, r1.xyzx, v0.xyzx
        add r1.x, r1.w, r1.x
        mad r2.x, r1.x, v3.y, r2.x
        ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r1.xyzw, r0.x, l(16), t5.xyzw
        dp3 r1.x, r1.xyzx, v0.xyzx
        add r1.x, r1.w, r1.x
        mad r2.y, r1.x, v3.y, r2.y
        ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r1.xyzw, r0.x, l(32), t5.xyzw
        dp3 r0.x, r1.xyzx, v0.xyzx
        add r0.x, r1.w, r0.x
        mad r2.z, r0.x, v3.y, r2.z
        ...
        if_nz r0.x
          ...
          dp3 r1.x, r1.xyzx, v0.xyzx
          add r1.x, r1.w, r1.x
          mad r2.x, r1.x, v3.z, r2.x
          ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r1.xyzw, r0.x, l(16), t5.xyzw
          dp3 r1.x, r1.xyzx, v0.xyzx
          add r1.x, r1.w, r1.x
          mad r2.y, r1.x, v3.z, r2.y
          ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r1.xyzw, r0.x, l(32), t5.xyzw
          dp3 r0.x, r1.xyzx, v0.xyzx
          add r0.x, r1.w, r0.x
          mad r2.z, r0.x, v3.z, r2.z
