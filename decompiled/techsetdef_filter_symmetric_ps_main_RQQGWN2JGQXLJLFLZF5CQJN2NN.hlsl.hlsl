// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:43:12 2021
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.xyzw = colorMapSampler.Sample(samp0_s, v2.xy).xyzw;
  r1.xyzw = colorMapSampler.Sample(samp0_s, v2.zw).xyzw;
  r0.xyzw = r1.xyzw + r0.xyzw;
  r0.xyzw = filterTap[1].wwww * r0.xyzw;
  r1.xyzw = colorMapSampler.Sample(samp0_s, v1.xy).xyzw;
  r2.xyzw = colorMapSampler.Sample(samp0_s, v1.zw).xyzw;
  r1.xyzw = r2.xyzw + r1.xyzw;
  r0.xyzw = filterTap[0].wwww * r1.xyzw + r0.xyzw;
  r1.xyzw = colorMapSampler.Sample(samp0_s, v3.xy).xyzw;
  r2.xyzw = colorMapSampler.Sample(samp0_s, v3.zw).xyzw;
  r1.xyzw = r2.xyzw + r1.xyzw;
  r0.xyzw = filterTap[2].wwww * r1.xyzw + r0.xyzw;
  r1.xyzw = colorMapSampler.Sample(samp0_s, v4.xy).xyzw;
  r2.xyzw = colorMapSampler.Sample(samp0_s, v4.zw).xyzw;
  r1.xyzw = r2.xyzw + r1.xyzw;
  r0.xyzw = filterTap[3].wwww * r1.xyzw + r0.xyzw;
  r1.xyzw = colorMapSampler.Sample(samp0_s, v5.xy).xyzw;
  r2.xyzw = colorMapSampler.Sample(samp0_s, v5.zw).xyzw;
  r1.xyzw = r2.xyzw + r1.xyzw;
  r0.xyzw = filterTap[4].wwww * r1.xyzw + r0.xyzw;
  r1.xyzw = colorMapSampler.Sample(samp0_s, v6.xy).xyzw;
  r2.xyzw = colorMapSampler.Sample(samp0_s, v6.zw).xyzw;
  r1.xyzw = r2.xyzw + r1.xyzw;
  r0.xyzw = filterTap[5].wwww * r1.xyzw + r0.xyzw;
  r1.xyzw = colorMapSampler.Sample(samp0_s, v7.xy).xyzw;
  r2.xyzw = colorMapSampler.Sample(samp0_s, v7.zw).xyzw;
  r1.xyzw = r2.xyzw + r1.xyzw;
  r0.xyzw = filterTap[6].wwww * r1.xyzw + r0.xyzw;
  r1.xyzw = colorMapSampler.Sample(samp0_s, v8.xy).xyzw;
  r2.xyzw = colorMapSampler.Sample(samp0_s, v8.zw).xyzw;
  r1.xyzw = r2.xyzw + r1.xyzw;
  o0.xyzw = filterTap[7].wwww * r1.xyzw + r0.xyzw;
  return;
}