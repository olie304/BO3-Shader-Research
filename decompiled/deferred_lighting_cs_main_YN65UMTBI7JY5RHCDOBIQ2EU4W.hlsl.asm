...
loop 
  ...
  if_nz r10.w
    ...
    mul r19.x, r13.z, r13.w
    and r13.z, l(1), cb10[r9.w + 6].x
    movc r13.zw, r13.zzzz, r19.xxxy, r19.zzzx
    mov r14.w, cb10[r9.w + 6].x
    mov r27.xy, r13.zwzz
    mov r16.y, l(1)
    loop 
      ige r16.z, r16.y, r12.w
      breakc_nz r16.z
      iadd r16.z, r10.w, r16.y
      imul null, r16.z, r16.z, l(6)
      dp3 r16.w, cb11[r16.z + 0].xyzx, r15.yzwy
      add_sat r16.w, r16.w, cb11[r16.z + 0].w
      mul r16.w, r16.w, r27.x
      dp3 r18.y, cb11[r16.z + 1].xyzx, r15.yzwy
      add_sat r18.y, r18.y, cb11[r16.z + 1].w
      mul r16.w, r16.w, r18.y
      dp3 r18.y, cb11[r16.z + 2].xyzx, r15.yzwy
      add_sat r18.y, r18.y, cb11[r16.z + 2].w
      mul r16.w, r16.w, r18.y
      dp3 r18.y, cb11[r16.z + 3].xyzx, r15.yzwy
      add_sat r18.y, r18.y, cb11[r16.z + 3].w
      mul r16.w, r16.w, r18.y
      dp3 r18.y, cb11[r16.z + 4].xyzx, r15.yzwy
      add_sat r18.y, r18.y, cb11[r16.z + 4].w
      mul r16.w, r16.w, r18.y
      dp3 r18.y, cb11[r16.z + 5].xyzx, r15.yzwy
      add_sat r16.z, r18.y, cb11[r16.z + 5].w
      mul r27.x, r16.z, r16.w
      ushr r18.y, r14.w, l(2)
      ubfe r18.z, l(1), l(2), r14.w
      and r18.w, r18.y, l(2)
      max r19.x, r27.x, r27.y
      mad r16.z, -r16.w, r16.z, l(1.000000)
      mul r16.z, r16.z, r27.y
      movc r21.y, r18.w, r16.z, r19.x
      movc r27.xy, r18.zzzz, r27.xyxx, r21.xyxx
      iadd r16.y, r16.y, l(1)
      mov r14.w, r18.y
    endloop 
    mov_sat r27.y, r27.y
    mul r10.w, r27.y, cb10[r9.w + 6].y
    ...
    if_nz r12.w
      ...
      mad r25.z, r27.y, cb10[r9.w + 6].y, r25.z
      mul r10.w, r10.w, cb10[r9.w + 7].y
      mov r28.x, cb10[r9.w + 7].w
      mov r28.yz, cb10[r9.w + 8].xxyx
      dp3 r12.w, r17.xyzx, r28.xyzx
      dp3 r13.z, r15.yzwy, r28.xyzx
      add r13.z, r13.z, -cb10[r9.w + 8].z
      ...
      mov r28.x, cb10[r9.w + 8].w
      mov r28.yz, cb10[r9.w + 9].xxyx
      dp3 r13.z, r17.xyzx, r28.xyzx
      dp3 r13.w, r15.yzwy, r28.xyzx
      add r13.w, r13.w, -cb10[r9.w + 9].z
      ...
      mov r28.x, cb10[r9.w + 9].w
      mov r28.yz, cb10[r9.w + 10].xxyx
      dp3 r13.z, r17.xyzx, r28.xyzx
      dp3 r13.w, r15.yzwy, r28.xyzx
      add r13.w, r13.w, -cb10[r9.w + 10].z
      ge r14.w, r13.w, l(0.000000)
      max r13.w, r3.z, |r13.w|
      movc r13.w, r14.w, r13.w, -r13.w
      max r13.z, -r13.z, l(0.00000010)
      div r13.z, r13.w, r13.z
      min r12.w, r12.w, |r13.z|
      mov r28.x, cb10[r9.w + 10].w
      mov r28.yz, cb10[r9.w + 11].xxyx
      dp3 r13.z, r17.xyzx, r28.xyzx
      dp3 r13.w, r15.yzwy, r28.xyzx
      add r13.w, r13.w, -cb10[r9.w + 11].z
      ge r14.w, r13.w, l(0.000000)
      max r13.w, r3.z, |r13.w|
      movc r13.w, r14.w, r13.w, -r13.w
      max r13.z, -r13.z, l(0.00000010)
      div r13.z, r13.w, r13.z
      min r12.w, r12.w, |r13.z|
      mov r28.x, cb10[r9.w + 11].w
      mov r28.yz, cb10[r9.w + 12].xxyx
      dp3 r13.z, r17.xyzx, r28.xyzx
      dp3 r13.w, r15.yzwy, r28.xyzx
      add r13.w, r13.w, -cb10[r9.w + 12].z
      ge r14.w, r13.w, l(0.000000)
      max r13.w, r3.z, |r13.w|
      movc r13.w, r14.w, r13.w, -r13.w
      max r13.z, -r13.z, l(0.00000010)
      div r13.z, r13.w, r13.z
      min r12.w, r12.w, |r13.z|
      mov r28.x, cb10[r9.w + 12].w
      mov r28.yz, cb10[r9.w + 13].xxyx
      dp3 r13.z, r17.xyzx, r28.xyzx
      dp3 r13.w, r15.yzwy, r28.xyzx
      add r13.w, r13.w, -cb10[r9.w + 13].z
      ge r14.w, r13.w, l(0.000000)
      max r13.w, r3.z, |r13.w|
      movc r13.w, r14.w, r13.w, -r13.w
      max r13.z, -r13.z, l(0.00000010)
      div r13.z, r13.w, r13.z
      min r12.w, r12.w, |r13.z|
      add r28.x, r15.y, cb10[r9.w + 3].w
      add r28.yz, r15.zzwz, cb10[r9.w + 4].xxyx
      mad r16.yzw, r17.xxyz, r12.wwww, r28.xxyz
      ...
      mov r28.x, cb10[r9.w + 0].w
      mov r28.y, cb10[r9.w + 1].z
      mov r28.z, cb10[r9.w + 2].y
      dp3 r29.x, r16.yzwy, r28.xyzx
      mov r30.xy, cb10[r9.w + 1].xwxx
      mov r30.z, cb10[r9.w + 2].z
      dp3 r29.y, r16.yzwy, r30.xyzx
      mov r31.x, cb10[r9.w + 1].y
      mov r31.yz, cb10[r9.w + 2].xxwx
      dp3 r29.z, r16.yzwy, r31.xyzx
      ubfe r13.z, l(9), l(16), cb10[r9.w + 7].z
      utof r29.w, r13.z
      sample_l_indexable(texturecubearray)(float,float,float,float) r16.yzw, r29.xyzw, t8.wxyz, s2, r12.w
      and r18.yzw, r16.yyzw, l(0, 0x7fffffff, 0x7fffffff, 0x7fffffff)
      ieq r18.yzw, r18.yyzw, l(0, 0x7f800000, 0x7f800000, 0x7f800000)
      or r12.w, r18.z, r18.y
      or r12.w, r18.w, r12.w
      ...
      mad_sat r15.yzw, r32.xxyz, cb10[r9.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
      mul r32.xy, r15.yzyy, cb10[r9.w + 4].zwzz
      mul r32.z, r15.w, cb10[r9.w + 5].x
      add r15.yzw, r32.xxyz, cb10[r9.w + 5].yyzw
      ...
      or r9.w, r27.z, r27.x
      or r9.w, r27.w, r9.w
      movc r18.yzw, r9.wwww, l(0,1.000000,1.000000,0), r18.yyzw
      mul r27.xzw, r15.yyzw, r18.yyzw
      dp3 r9.w, r27.xzwx, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r24.xyz, r15.yzwy, r18.yzwy, r24.xyzx
      mul r12.w, r3.w, r9.w
      mul r15.yzw, r10.wwww, r16.yyzw
      dp3 r10.w, r15.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r9.w, r3.w, r9.w, r10.w
      div r9.w, r12.w, r9.w
      mov r28.x, r24.w
      mov r28.yz, r25.xxyx
      mad r15.yzw, r15.yyzw, r9.wwww, r28.xxyz
      mov r24.w, r15.y
      mov r25.xy, r15.zwzz
    else 
...
loop 
  ...
  if_nz r10.w
    imul null, r9.w, r9.w, l(14)
    if_nz r2.z
      and r10.w, r13.w, l(15)
      imad r10.w, r10.w, l(20), l(880)
      add r18.yzw, cb1[24].xxyz, cb10[r9.w + 0].xxyz
      store_structured u2.xyzw, cb2[52].x, r10.w, r18.xyzw
    endif 
    iadd r21.y, r13.w, l(1)
    add r16.yzw, r5.xxyz, -cb10[r9.w + 0].xxyz
    and r10.w, l(0x0000ffff), cb10[r9.w + 7].z
    ubfe r12.w, l(6), l(25), cb10[r9.w + 7].z
    imul null, r14.w, r10.w, l(6)
    dp3 r18.y, cb11[r14.w + 0].xyzx, r16.yzwy
    add_sat r18.y, r18.y, cb11[r14.w + 0].w
    dp3 r18.z, cb11[r14.w + 1].xyzx, r16.yzwy
    add_sat r18.z, r18.z, cb11[r14.w + 1].w
    mul r18.y, r18.z, r18.y
    dp3 r18.z, cb11[r14.w + 2].xyzx, r16.yzwy
    add_sat r18.z, r18.z, cb11[r14.w + 2].w
    mul r18.y, r18.z, r18.y
    dp3 r18.z, cb11[r14.w + 3].xyzx, r16.yzwy
    add_sat r18.z, r18.z, cb11[r14.w + 3].w
    mul r18.y, r18.z, r18.y
    dp3 r18.z, cb11[r14.w + 4].xyzx, r16.yzwy
    add_sat r18.z, r18.z, cb11[r14.w + 4].w
    mul r18.y, r18.z, r18.y
    dp3 r18.z, cb11[r14.w + 5].xyzx, r16.yzwy
    add_sat r14.w, r18.z, cb11[r14.w + 5].w
    mul r19.x, r14.w, r18.y
    and r14.w, l(1), cb10[r9.w + 6].x
    movc r18.yz, r14.wwww, r19.xxyx, r19.zzxz
    mov r14.w, cb10[r9.w + 6].x
    mov r27.xy, r18.yzyy
    mov r18.w, l(1)
    loop 
      ige r19.x, r18.w, r12.w
      breakc_nz r19.x
      ...
      movc r21.w, r23.w, r19.x, r26.w
      movc r27.xy, r22.wwww, r27.xyxx, r21.zwzz
      iadd r18.w, r18.w, l(1)
      mov r14.w, r20.w
    endloop 
    add_sat r10.w, -r25.z, r27.y
    mul r12.w, r10.w, cb10[r9.w + 6].y
    lt r14.w, l(0.000000), r12.w
    if_nz r14.w
      and r14.w, r21.y, l(31)
      iadd r18.y, r14.w, l(-1)
      ult r18.y, r18.y, l(32)
      and r18.y, r2.z, r18.y
      if_nz r18.y
        imad r18.yz, r14.wwww, l(0, 20, 20, 0), l(0, 860, 876, 0)
        ...
        store_structured u2.x, cb2[52].x, r18.z, r12.w
      endif 
      iadd r13.w, r13.w, l(257)
      mad r13.z, r10.w, cb10[r9.w + 6].y, r13.z
      ...
      dp3 r18.y, r16.yzwy, r28.xyzx
      add r18.y, r18.y, -cb10[r9.w + 9].z
      ...
      dp3 r14.w, r17.xyzx, r28.xyzx
      dp3 r18.y, r16.yzwy, r28.xyzx
      add r18.y, r18.y, -cb10[r9.w + 10].z
      ge r18.z, r18.y, l(0.000000)
      max r18.y, r3.z, |r18.y|
      movc r18.y, r18.z, r18.y, -r18.y
      max r14.w, -r14.w, l(0.00000010)
      ...
      dp3 r14.w, r17.xyzx, r28.xyzx
      dp3 r18.y, r16.yzwy, r28.xyzx
      add r18.y, r18.y, -cb10[r9.w + 11].z
      ge r18.z, r18.y, l(0.000000)
      max r18.y, r3.z, |r18.y|
      movc r18.y, r18.z, r18.y, -r18.y
      max r14.w, -r14.w, l(0.00000010)
      ...
      dp3 r14.w, r17.xyzx, r28.xyzx
      dp3 r18.y, r16.yzwy, r28.xyzx
      add r18.y, r18.y, -cb10[r9.w + 12].z
      ge r18.z, r18.y, l(0.000000)
      max r18.y, r3.z, |r18.y|
      movc r18.y, r18.z, r18.y, -r18.y
      max r14.w, -r14.w, l(0.00000010)
      ...
      dp3 r14.w, r17.xyzx, r28.xyzx
      dp3 r18.y, r16.yzwy, r28.xyzx
      add r18.y, r18.y, -cb10[r9.w + 13].z
      ge r18.z, r18.y, l(0.000000)
      max r18.y, r3.z, |r18.y|
      movc r18.y, r18.z, r18.y, -r18.y
      max r14.w, -r14.w, l(0.00000010)
      div r14.w, r18.y, r14.w
      min r12.w, r12.w, |r14.w|
      add r28.x, r16.y, cb10[r9.w + 3].w
      add r28.yz, r16.zzwz, cb10[r9.w + 4].xxyx
      mad r18.yzw, r17.xxyz, r12.wwww, r28.xxyz
      ...
      utof r29.w, r14.w
      sample_l_indexable(texturecubearray)(float,float,float,float) r18.yzw, r29.xyzw, t8.wxyz, s2, r12.w
      and r27.xzw, r18.yyzw, l(0x7fffffff, 0, 0x7fffffff, 0x7fffffff)
      ieq r27.xzw, r27.xxzw, l(0x7f800000, 0, 0x7f800000, 0x7f800000)
      or r12.w, r27.z, r27.x
      ...
      mad_sat r16.yzw, r32.xxyz, cb10[r9.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
      mul r32.xy, r16.yzyy, cb10[r9.w + 4].zwzz
      mul r32.z, r16.w, cb10[r9.w + 5].x
      add r16.yzw, r32.xxyz, cb10[r9.w + 5].yyzw
      dp3 r29.x, r11.xyzx, r28.xyzx
      dp3 r29.y, r11.xyzx, r30.xyzx
      dp3 r29.z, r11.xyzx, r31.xyzx
      ...
      mul r12.w, r3.w, r9.w
      mul r16.yzw, r10.wwww, r18.yyzw
      dp3 r10.w, r16.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r9.w, r3.w, r9.w, r10.w
      div r9.w, r12.w, r9.w
      mad r26.xyz, r16.yzwy, r9.wwww, r26.xyzx
    else 
      mov r21.x, r13.z
      mov r13.zw, r21.xxxy
    endif 
...
bfi r2.w, l(8), l(0), r13.w, r25.w
movc r0.y, r0.y, r2.w, r13.w
max r2.w, r13.z, l(1.000000)
rcp r2.w, r2.w
mov_sat r13.z, r13.z
mul r16.yzw, r2.wwww, r15.yyzw
mul r18.xyz, r2.wwww, r26.xyzx
lt r3.z, r13.z, l(0.990000)
if_nz r3.z
  iadd r0.y, r0.y, l(256)
  add r3.z, -r13.z, l(1.000000)
  ...
  mad r16.yzw, r15.yyzw, r2.wwww, r19.xxyz
  mov r17.w, l(0)
  ...
  mad r18.xyz, r15.yzwy, r2.wwww, r18.xyzx
endif 
add r2.w, r4.z, r2.x
log r2.w, |r2.w|
mul r2.w, r1.w, r2.w
...
ret 
// Approximately 1716 instruction slots used
