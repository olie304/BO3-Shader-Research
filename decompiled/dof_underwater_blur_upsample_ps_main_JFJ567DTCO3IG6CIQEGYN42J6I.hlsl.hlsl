  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.x = codeTexture1.Sample(bilinearClamp_s, v0.xy).x;
  r0.y = 1.01587307 * r0.x;
  r0.x = cmp(r0.x >= 0.984375);
  r0.y = max(9.99999994e-09, r0.y);
  r0.y = rcp(r0.y);
  r0.y = postFxControl3.x * r0.y;
  r0.y = exp2(r0.y);
  r0.y = min(1, r0.y);
  r0.y = 1 + -r0.y;
  r0.y = 127.5 * r0.y;
  ...
  r1.xyz = float3(-0.598205984,-0.598205984,-0.598205984) + r1.xyz;
  r1.xyz = float3(13.7545986,13.7545986,13.7545986) * r1.xyz;
  r1.xyz = exp2(r1.xyz);
  r1.xyz = float3(-0.00872999988,-0.00872999988,-0.00872999988) + r1.xyz;
  r0.w = cmp(0 < r0.w);
