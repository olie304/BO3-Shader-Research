...
//   float2 colorScroll;                // Offset:  176 Size:     8
//   bool useAlphaBlend;                // Offset:  184 Size:     4
//   float refractionAmount;            // Offset:  188 Size:     4
//   float2 normalScroll;               // Offset:  192 Size:     8
//   float2 normalTile;                 // Offset:  200 Size:     8
//   float blurAmount;                  // Offset:  208 Size:     4
//   float2 blurScroll;                 // Offset:  212 Size:     8
//   float2 blurTile;                   // Offset:  224 Size:     8
//
// }
//
...
// blurMask                          texture  float4          2d            t10      1 
...
dcl_output o0.xyzw
dcl_temps 7
mad r0.xy, cb1[69].wwww, cb0[11].xyxx, v1.xyxx
sample_indexable(texture2d)(float,float,float,float) r0.xyzw, r0.xyxx, t7.xyzw, s2
mov_sat r1.x, cb3[0].z
mul r0.w, r0.w, r1.x
log r1.xyz, cb3[1].xyzx
mul r1.xyz, r1.xyzx, l(2.200000, 2.200000, 2.200000, 0.000000)
exp r1.xyz, r1.xyzx
add r1.xyz, r1.xyzx, l(-1.000000, -1.000000, -1.000000, 0.000000)
mad r1.xyz, cb3[1].wwww, r1.xyzx, l(1.000000, 1.000000, 1.000000, 0.000000)
mul r2.xyz, r0.xyzx, r1.xyzx
sample_indexable(texture2d)(float,float,float,float) r1.w, v1.xyxx, t6.yzwx, s1
add r1.w, -r1.w, l(1.000000)
min r2.w, |cb3[0].x|, l(1.000000)
mul r2.w, r2.w, cb0[10].z
mul r2.w, r2.w, cb1[44].z
mad r3.xy, v1.xyxx, l(2.000000, 2.000000, 0.000000, 0.000000), l(-1.000000, -1.000000, 0.000000, 0.000000)
lt r3.zw, l(0.000000, 0.000000, 0.000000, 0.000000), cb3[0].xxxw
mad r4.x, r1.w, r2.w, l(1.000000)
...
if_nz r3.w
  ...
  mad r3.zw, v1.xxxy, cb0[12].zzzw, r3.zzzw
  frc r3.zw, r3.zzzw
  mul r4.xy, cb0[11].wwww, cb1[44].zwzz
...
mul r1.w, cb0[13].x, cb3[2].x
lt r2.w, l(0.000000), r1.w
if_nz r2.w
  mul r3.zw, cb0[13].yyyz, cb1[69].wwww
  mad r3.zw, v1.xxxy, cb0[14].xxxy, r3.zzzw
  frc r3.zw, r3.zzzw
  sample_indexable(texture2d)(float,float,float,float) r2.w, r3.zwzz, t10.yzwx, s1
  mul r1.w, r1.w, r2.w
  mul r3.zw, r1.wwww, cb1[44].zzzw
  max r1.w, r3.w, r3.z
  mad_sat r4.xyzw, r1.wwww, l(-0.60068172, 0.41903731, -0.20014110, -0.25657189), r3.xyxy
  ...
  mad_sat r5.xyzw, r1.wwww, l(0.06684364, 0.49094659, -0.697239, -0.45906171), r3.xyxy
  sample_indexable(texture2d)(float,float,float,float) r6.xyzw, r5.xyxx, t0.xyzw, s1
  add r4.xyzw, r4.xyzw, r6.xyzw
  sample_indexable(texture2d)(float,float,float,float) r5.xyzw, r5.zwzz, t0.xyzw, s1
  add r4.xyzw, r4.xyzw, r5.xyzw
  mad_sat r5.xyzw, r1.wwww, l(0.22192720, -0.52654648, 0.63864481, 0.11727790), r3.xyxy
  sample_indexable(texture2d)(float,float,float,float) r6.xyzw, r5.xyxx, t0.xyzw, s1
  add r4.xyzw, r4.xyzw, r6.xyzw
  sample_indexable(texture2d)(float,float,float,float) r5.xyzw, r5.zwzz, t0.xyzw, s1
  add r4.xyzw, r4.xyzw, r5.xyzw
  mul r4.xyzw, r4.xyzw, l(0.16666667, 0.16666667, 0.16666667, 0.16666667)
  mov o0.w, r4.w
else 
...
mad r1.xyz, -r4.xyzx, l(0.00003052, 0.00003052, 0.00003052, 0.000000), l(1.000000, 1.000000, 1.000000, 0.000000)
...
movc r0.xyz, cb0[11].zzzz, r0.xyzx, r1.xyzx
