...
r0.x = samp0[]..swiz;
  ...
  if (1 == 0) r6.y = 0; else if (1+20 < 32) {   r6.y = (uint)r0.x << (32-(1 + 20)); r6.y = (uint)r6.y >> (32-1);  } else r6.y = (uint)r0.x >> 20;
  ...
  r6.zw = r4.xy * r7.xy;
  r7.yzw = r8.xyz * r6.zzz + r2.xyz;
  r7.yzw = r3.zxy * r6.www + r7.yzw;
  r3.w = r7.x;
  ...
  if (r0.w != 0) {
    ...
    r6.w = samp0[]..swiz;
      r7.x = r6.w ? 2.000000 : 0;
      r7.y = (uint)r6.w << 2;
      if (r7.x == 0) {
        r7.x = r6.w ? 0.000000 : 0;
