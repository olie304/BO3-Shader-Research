...
r1.w = modelInstanceBuffer[]..swiz;
  if (r1.w != 0) {
    ...
    r6.w = modelInstanceBuffer[]..swiz;
      ...
      r3.z = v5.x * r2.y;
    // Known bad code for instruction (needs manual fix):
        ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r2.x, r2.x, l(48), t5.xxxx
...
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r5.xy, v7.x, l(8), t4.xyxx
r5.x = modelInstanceBuffer[]..swiz;
r5.y = modelInstanceBuffer[]..swiz;
  if (r5.y != 0) {
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r6.xyzw, r5.y, l(0), t5.xyzw
  r6.x = modelInstanceBuffer[]..swiz;
  r6.y = modelInstanceBuffer[]..swiz;
  r6.z = modelInstanceBuffer[]..swiz;
  r6.w = modelInstanceBuffer[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r7.xyzw, r5.y, l(16), t5.xyzw
  r7.x = modelInstanceBuffer[]..swiz;
  r7.y = modelInstanceBuffer[]..swiz;
  r7.z = modelInstanceBuffer[]..swiz;
  r7.w = modelInstanceBuffer[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r8.xyzw, r5.y, l(32), t5.xywz
  ...
  r4.w = 1;
  r6.w = r8.x;
  r0.w = dot(r4.xyzw, r6.xyzw);
  r7.w = r8.y;
  r2.w = dot(r4.xyzw, r7.xyzw);
  r9.w = r8.z;
  r3.w = dot(r4.xyzw, r9.xyzw);
  r4.x = dot(r0.xyz, r6.xyz);
  r4.y = dot(r0.xyz, r7.xyz);
  r4.z = dot(r0.xyz, r9.xyz);
  r0.x = dot(r4.xyz, r4.xyz);
  r0.x = rsqrt(r0.x);
  o2.xyz = r4.xyz * r0.xxx;
  ...
  r0.xyzw = r0.wwww * viewProjectionMatrix._m00_m01_m02_m03 + r4.xyzw;
  r0.xyzw = r3.wwww * viewProjectionMatrix._m20_m21_m22_m23 + r0.xyzw;
  o0.xyzw = viewProjectionMatrix._m30_m31_m32_m33 + r0.xyzw;
  r0.x = (int)r5.x & 0x0fffffff;
  if (r0.x != 0) {
    if (r0.x != 0) {
