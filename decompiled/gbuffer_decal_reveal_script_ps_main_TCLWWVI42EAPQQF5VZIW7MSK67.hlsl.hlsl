...
r0.x = colorSampler[]..swiz;
  ...
  r2.xyz = transitionNormal.Sample(normalSampler_s, v2.xy).xyz;
  ...
  r1.w = transitionGloss.Sample(specColorSampler_s, v2.xy).x;
  r1.w = r1.w * r2.y + glossRange.x;
  r1.w = saturate(0.0588235296 * r1.w);
  r1.w = -17 * r1.w;
  r1.w = exp2(r1.w);
