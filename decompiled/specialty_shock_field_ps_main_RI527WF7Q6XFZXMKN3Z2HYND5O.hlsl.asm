...
mul r1.w, r0.w, v1.x
sample_indexable(texture2d)(float,float,float,float) r2.x, v1.yzyy, t29.xyzw, s6
sample_indexable(texture2d)(float,float,float,float) r2.y, v1.yzyy, t26.yxzw, s3
add r2.z, -cb0[11].x, cb0[11].y
mad r2.y, r2.y, r2.z, cb0[11].x
mul_sat r2.y, r2.y, l(0.05882353)
sample_indexable(texture2d)(float,float,float,float) r3.xyz, v1.yzyy, t25.xyzw, s5
...
sample_indexable(texture2d)(float,float,float,float) r4.xyzw, v1.yzyy, t37.xyzw, s1
...
rsq r2.y, r2.y
mul r6.xyz, r2.yyyy, -v6.xyzx
dp3_sat r2.z, v3.xyzx, r6.xyzx
...
if_nz r9.w
  ...
  if_nz r9.w
    ...
    if_nz r10.w
      ...
      mad r17.xyz, r3.xyzx, r17.xxxx, v6.xyzx
    ...
    mad r14.xyz, -v6.xyzx, r2.yyyy, cb2[17].xyzx
          ...
          if_nz r31.w
            ...
            if_nz r31.w
              ...
              if_nz r31.w
                ...
                mad r42.xyz, r3.xyzx, r31.wwww, v6.xyzx
              ...
              if_nz r31.w
                ...
                if_nz r27.w
                  ...
                  mad r20.xyz, r3.xyzx, r39.wwww, v6.xyzx
...
if_nz r2.y
  sample_indexable(texture2d)(float,float,float,float) r2.y, v1.yzyy, t46.xwyz, s1
  sample_indexable(texture2d)(float,float,float,float) r5.xyzw, v1.yzyy, t47.xyzw, s1
...
mul r0.w, r4.w, r0.w
sample_indexable(texture2d)(float,float,float,float) r2.x, v7.xyxx, t38.xyzw, s1
...
mov o0.xyzw, r1.xyzw
ret 
// Approximately 1931 instruction slots used
