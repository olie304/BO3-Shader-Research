...
if_nz r0.y
  ftoi r0.y, cb1[64].w
  lod r0.z, v2.xyxx, t0.y, s1
  lod r2.x, v2.xyxx, t0.x, s1
  lt r0.z, r0.z, r2.x
  lt r2.x, l(0.000000), r2.x
  and r2.yzw, r0.yyyy, l(0, 1, 2, 4)
  movc r3.xyz, r2.yyyy, l(1.000000,0,1.000000,0), r1.xyzx
  movc r4.xyz, r2.zzzz, l(0,1.000000,1.000000,0), r1.xyzx
  movc r2.xyz, r2.xxxx, r3.xyzx, r4.xyzx
  movc r3.xyz, r2.wwww, l(0,1.000000,0,0), r1.xyzx
  movc r1.xyz, r0.zzzz, r2.xyzx, r3.xyzx
endif 
mad r0.y, -r0.w, v1.w, cb1[59].x
mad r2.w, cb1[59].w, r0.y, r1.w
...
mad r3.x, cb1[62].x, r3.w, cb0[11].x
...
add r3.yzw, -r0.xxzw, cb1[61].xxyz
mad r0.xzw, cb1[61].wwww, r3.yyzw, r0.xxzw
add r3.x, -r0.y, r3.x
mad r3.y, cb1[62].w, r3.x, r0.y
add r0.y, -r1.w, cb1[63].x
mad r0.y, cb1[63].w, r0.y, r1.w
...
mad r0.xyz, r29.xyzx, r0.xzwx, r3.xyzx
