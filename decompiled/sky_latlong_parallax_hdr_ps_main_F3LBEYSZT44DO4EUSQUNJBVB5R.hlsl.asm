...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:40:44 2021
//
//
// Buffer Definitions: 
//
...
//   float2 cloudHeights;               // Offset:  160 Size:     8 [unused]
//   float3 skyBoxCenter;               // Offset:  176 Size:    12 [unused]
//   float skyScale;                    // Offset:  188 Size:     4
//   float skyFogFraction;              // Offset:  192 Size:     4 [unused]
//
// }
//
...
//   float4 skyMxR;                     // Offset:  816 Size:    16
//   float4 skyMxG;                     // Offset:  832 Size:    16
//   float4 skyMxB;                     // Offset:  848 Size:    16
//   float4 sunMxR;                     // Offset:  864 Size:    16
//   float4 sunMxG;                     // Offset:  880 Size:    16
//   float4 sunMxB;                     // Offset:  896 Size:    16
...
// cloudLayer0                       texture  float4          2d             t6      1 
// cloudMask0                        texture  float4          2d             t7      1 
// cloudLayer1                       texture  float4          2d             t9      1 
// cloudMask1                        texture  float4          2d            t10      1 
...
sqrt r0.x, r0.x
mad r0.y, |r0.z|, l(-0.01872930), l(0.074261)
mad r0.y, r0.y, |r0.z|, l(-0.21211439)
mad r0.y, r0.y, |r0.z|, l(1.57072878)
mul r0.z, r0.x, r0.y
mad r0.z, r0.z, l(-2.000000), l(3.14159274)
and r0.z, r1.y, r0.z
mad r2.yz, r0.yyyy, r0.xxxx, r0.zzzz
...
sample_indexable(texture2d)(float,float,float,float) r0.xyz, r0.xzxx, t0.xyzw, s1
add r0.xyz, -r1.xyzx, r0.xyzx
mad r0.xyz, cb1[57].wwww, r0.xyzx, r1.xyzx
add r1.xyz, v1.yxzy, v4.yxzy
...
mul r0.w, r0.w, r1.w
mul r1.w, r0.w, r0.w
mad r2.x, r1.w, l(0.02083510), l(-0.085133)
mad r2.x, r1.w, r2.x, l(0.180141)
mad r2.x, r1.w, r2.x, l(-0.33029950)
...
ge r1.x, r1.x, -r1.x
and r1.x, r1.x, r1.y
movc r1.x, r1.x, -r0.w, r0.w
add r0.w, -|r1.z|, l(1.000000)
sqrt r0.w, r0.w
mad r1.w, |r1.z|, l(-0.01872930), l(0.074261)
mad r1.w, r1.w, |r1.z|, l(-0.21211439)
mad r1.z, r1.w, |r1.z|, l(1.57072878)
mul r1.w, r0.w, r1.z
mad r1.w, r1.w, l(-2.000000), l(3.14159274)
and r1.w, r2.y, r1.w
mad r1.y, r1.z, r0.w, r1.w
mad r1.xy, r1.xyxx, l(-0.15915494, 0.31830987, 0.000000, 0.000000), l(0.500000, 0.000000, 0.000000, 0.000000)
...
ge r2.x, r2.x, -r2.x
and r1.w, r1.w, r2.x
movc r3.x, r1.w, -r0.w, r0.w
add r0.w, -|r1.z|, l(1.000000)
sqrt r0.w, r0.w
mad r1.w, |r1.z|, l(-0.01872930), l(0.074261)
mad r1.w, r1.w, |r1.z|, l(-0.21211439)
mad r1.w, r1.w, |r1.z|, l(1.57072878)
mul r2.x, r0.w, r1.w
mad r2.x, r2.x, l(-2.000000), l(3.14159274)
and r2.x, r2.y, r2.x
mad r3.y, r1.w, r0.w, r2.x
mad r2.xy, r3.xyxx, l(-0.15915494, 0.31830987, 0.000000, 0.000000), l(0.500000, 0.000000, 0.000000, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r3.xyz, r2.xyxx, t9.xyzw, s1
sample_indexable(texture2d)(float,float,float,float) r0.w, r2.xyxx, t10.yzwx, s1
add r2.xyz, -r0.xyzx, r3.xyzx
mad r0.xyz, r0.wwww, r2.xyzx, r0.xyzx
dp3 r2.x, r0.xyzx, cb1[51].xyzx
dp3 r2.y, r0.xyzx, cb1[52].xyzx
dp3 r2.z, r0.xyzx, cb1[53].xyzx
dp3 r3.x, r0.xyzx, cb1[54].xyzx
dp3 r3.y, r0.xyzx, cb1[55].xyzx
dp3 r3.z, r0.xyzx, cb1[56].xyzx
mov r0.x, cb1[51].w
mov r0.y, cb1[52].w
mov r0.z, cb1[53].w
dp3_sat r0.x, r1.xyzx, r0.xyzx
mad_sat r0.x, r0.x, cb1[54].w, cb1[55].w
...
mul r2.xyz, r2.xyzx, cb2[12].wwww
...
if_nz r0.w
  ...
  if_nz r1.w
    ...
    mul r4.xy, r4.xyxx, cb2[9].xyxx
    lt r1.w, l(0.010000), |r2.z|
    mul r4.zw, r2.zzzz, cb2[14].xxxy
    ...
    mul r1.w, r1.w, cb2[9].x
    lt r2.w, l(0.010000), |r2.z|
    mul r3.w, r2.z, cb2[14].x
  ...
  mul r0.w, r0.w, r2.w
  mad r0.xyz, -r0.xyzx, cb0[11].wwww, r2.xyzx
  mad r3.xyz, r0.wwww, r0.xyzx, r1.xyzx
endif 
mul r0.xyz, r3.xyzx, cb1[85].yyyy
