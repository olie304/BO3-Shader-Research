  ...
  out float2 o3 : SV_TARGET3)
{
  ...
  r4.xyz = specColorMap.Sample(specColorSampler_s, r2.xw).xyz;
  r3.w = glossMap.Sample(specColorSampler_s, r2.xw).x;
  ...
  r6.w = r4.w * detailScaleHeight1 + r0.w;
  r1.xy = r5.xy * detailScaleHeight2 + r0.yz;
