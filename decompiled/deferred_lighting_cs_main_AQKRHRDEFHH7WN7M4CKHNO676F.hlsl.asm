...
loop 
  ...
  if_nz r10.w
    ...
    if_nz r2.z
      ...
      add r17.yzw, cb1[24].xxyz, cb10[r9.w + 0].xxyz
    ...
    imul null, r15.y, r10.w, l(6)
    dp3 r15.z, cb11[r15.y + 0].xyzx, r14.yzwy
    add_sat r15.z, r15.z, cb11[r15.y + 0].w
    dp3 r15.w, cb11[r15.y + 1].xyzx, r14.yzwy
    add_sat r15.w, r15.w, cb11[r15.y + 1].w
    mul r15.z, r15.w, r15.z
    dp3 r15.w, cb11[r15.y + 2].xyzx, r14.yzwy
    add_sat r15.w, r15.w, cb11[r15.y + 2].w
    mul r15.z, r15.w, r15.z
    dp3 r15.w, cb11[r15.y + 3].xyzx, r14.yzwy
    add_sat r15.w, r15.w, cb11[r15.y + 3].w
    mul r15.z, r15.w, r15.z
    dp3 r15.w, cb11[r15.y + 4].xyzx, r14.yzwy
    add_sat r15.w, r15.w, cb11[r15.y + 4].w
    mul r15.z, r15.w, r15.z
    dp3 r15.w, cb11[r15.y + 5].xyzx, r14.yzwy
    ...
    if_nz r13.w
      ...
      div r15.y, r15.z, r15.y
      min r13.w, r13.w, |r15.y|
      add r27.x, r14.y, cb10[r9.w + 3].w
      add r27.yz, r14.zzwz, cb10[r9.w + 4].xxyx
      mad r15.yzw, r16.xxyz, r13.wwww, r27.xxyz
      dp3 r17.y, r15.yzwy, r15.yzwy
      sqrt r17.y, r17.y
      div r13.w, r13.w, r17.y
      ...
      dp3 r28.x, r15.yzwy, r27.xyzx
      mov r29.xy, cb10[r9.w + 1].xwxx
      mov r29.z, cb10[r9.w + 2].z
      dp3 r28.y, r15.yzwy, r29.xyzx
      mov r30.x, cb10[r9.w + 1].y
      mov r30.yz, cb10[r9.w + 2].xxwx
      dp3 r28.z, r15.yzwy, r30.xyzx
      ubfe r15.y, l(9), l(16), cb10[r9.w + 7].z
      utof r28.w, r15.y
      sample_l_indexable(texturecubearray)(float,float,float,float) r15.yzw, r28.xyzw, t8.wxyz, s2, r13.w
      and r17.yzw, r15.yyzw, l(0, 0x7fffffff, 0x7fffffff, 0x7fffffff)
      ...
      mad_sat r14.yzw, r31.xxyz, cb10[r9.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
      mul r31.xy, r14.yzyy, cb10[r9.w + 4].zwzz
      mul r31.z, r14.w, cb10[r9.w + 5].x
      add r14.yzw, r31.xxyz, cb10[r9.w + 5].yyzw
      ...
      movc r21.z, r17.z, l(0), l(0.500000)
      add r29.xyz, r14.yzwy, r21.xyzx
      ...
      mul r26.xzw, r14.yyzw, r17.yyzw
      dp3 r9.w, r26.xzwx, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r23.xyz, r14.yzwy, r17.yzwy, r23.xyzx
      mul r13.w, r4.w, r9.w
      mul r14.yzw, r10.wwww, r15.yyzw
      dp3 r10.w, r14.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r9.w, r4.w, r9.w, r10.w
      div r9.w, r13.w, r9.w
      mov r27.x, r23.w
      mov r27.yz, r24.xxyx
      mad r14.yzw, r14.yyzw, r9.wwww, r27.xxyz
      mov r23.w, r14.y
      mov r24.xy, r14.zwzz
    else 
...
loop 
  ...
  if_nz r10.w
    imul null, r9.w, r9.w, l(14)
    if_nz r2.z
      and r10.w, r15.z, l(15)
      imad r10.w, r10.w, l(20), l(880)
      add r17.yzw, cb1[24].xxyz, cb10[r9.w + 0].xxyz
      store_structured u2.xyzw, cb2[52].x, r10.w, r17.xyzw
    endif 
    iadd r20.y, r15.z, l(1)
    add r17.yzw, r11.xxyz, -cb10[r9.w + 0].xxyz
    and r10.w, l(0x0000ffff), cb10[r9.w + 7].z
    ubfe r13.w, l(6), l(25), cb10[r9.w + 7].z
    imul null, r15.w, r10.w, l(6)
    dp3 r18.w, cb11[r15.w + 0].xyzx, r17.yzwy
    add_sat r18.w, r18.w, cb11[r15.w + 0].w
    dp3 r19.w, cb11[r15.w + 1].xyzx, r17.yzwy
    add_sat r19.w, r19.w, cb11[r15.w + 1].w
    mul r18.w, r18.w, r19.w
    dp3 r19.w, cb11[r15.w + 2].xyzx, r17.yzwy
    add_sat r19.w, r19.w, cb11[r15.w + 2].w
    mul r18.w, r18.w, r19.w
    dp3 r19.w, cb11[r15.w + 3].xyzx, r17.yzwy
    add_sat r19.w, r19.w, cb11[r15.w + 3].w
    mul r18.w, r18.w, r19.w
    dp3 r19.w, cb11[r15.w + 4].xyzx, r17.yzwy
    add_sat r19.w, r19.w, cb11[r15.w + 4].w
    mul r18.w, r18.w, r19.w
    dp3 r19.w, cb11[r15.w + 5].xyzx, r17.yzwy
    add_sat r15.w, r19.w, cb11[r15.w + 5].w
    mul r18.x, r15.w, r18.w
    and r15.w, l(1), cb10[r9.w + 6].x
    movc r18.xw, r15.wwww, r18.xxxy, r18.zzzx
    mov r15.w, cb10[r9.w + 6].x
    mov r26.xy, r18.xwxx
    mov r19.w, l(1)
    loop 
      ...
      ushr r25.w, r15.w, l(2)
      ubfe r26.z, l(1), l(2), r15.w
      and r26.w, r25.w, l(2)
      max r27.x, r26.x, r26.y
      mad r21.w, -r22.w, r21.w, l(1.000000)
      mul r21.w, r21.w, r26.y
      movc r20.w, r26.w, r21.w, r27.x
      movc r26.xy, r26.zzzz, r26.xyxx, r20.zwzz
      iadd r19.w, r19.w, l(1)
      mov r15.w, r25.w
    endloop 
    add_sat r10.w, -r24.z, r26.y
    mul r13.w, r10.w, cb10[r9.w + 6].y
    lt r15.w, l(0.000000), r13.w
    if_nz r15.w
      and r15.w, r20.y, l(31)
      ...
      mad r15.y, r10.w, cb10[r9.w + 6].y, r15.y
      mul r10.w, r13.w, cb10[r9.w + 7].y
      mov r27.x, cb10[r9.w + 7].w
      mov r27.yz, cb10[r9.w + 8].xxyx
      dp3 r13.w, r16.xyzx, r27.xyzx
      dp3 r15.w, r17.yzwy, r27.xyzx
      add r15.w, r15.w, -cb10[r9.w + 8].z
      ge r18.x, r15.w, l(0.000000)
      max r15.w, r4.z, |r15.w|
      movc r15.w, r18.x, r15.w, -r15.w
      max r13.w, -r13.w, l(0.00000010)
      ...
      dp3 r15.w, r16.xyzx, r27.xyzx
      dp3 r18.x, r17.yzwy, r27.xyzx
      add r18.x, r18.x, -cb10[r9.w + 10].z
      ge r18.w, r18.x, l(0.000000)
      max r18.x, r4.z, |r18.x|
      movc r18.x, r18.w, r18.x, -r18.x
      max r15.w, -r15.w, l(0.00000010)
      ...
      dp3 r15.w, r16.xyzx, r27.xyzx
      dp3 r18.x, r17.yzwy, r27.xyzx
      add r18.x, r18.x, -cb10[r9.w + 11].z
      ge r18.w, r18.x, l(0.000000)
      max r18.x, r4.z, |r18.x|
      movc r18.x, r18.w, r18.x, -r18.x
      max r15.w, -r15.w, l(0.00000010)
      ...
      dp3 r15.w, r16.xyzx, r27.xyzx
      dp3 r18.x, r17.yzwy, r27.xyzx
      add r18.x, r18.x, -cb10[r9.w + 12].z
      ge r18.w, r18.x, l(0.000000)
      max r18.x, r4.z, |r18.x|
      movc r18.x, r18.w, r18.x, -r18.x
      max r15.w, -r15.w, l(0.00000010)
      ...
      dp3 r15.w, r16.xyzx, r27.xyzx
      dp3 r18.x, r17.yzwy, r27.xyzx
      add r18.x, r18.x, -cb10[r9.w + 13].z
      ge r18.w, r18.x, l(0.000000)
      max r18.x, r4.z, |r18.x|
      movc r18.x, r18.w, r18.x, -r18.x
      max r15.w, -r15.w, l(0.00000010)
      div r15.w, r18.x, r15.w
      min r13.w, r13.w, |r15.w|
      add r27.x, r17.y, cb10[r9.w + 3].w
      add r27.yz, r17.zzwz, cb10[r9.w + 4].xxyx
      mad r26.xzw, r16.xxyz, r13.wwww, r27.xxyz
      dp3 r15.w, r26.xzwx, r26.xzwx
      sqrt r15.w, r15.w
      ...
      utof r28.w, r15.w
      sample_l_indexable(texturecubearray)(float,float,float,float) r26.xzw, r28.xyzw, t8.xwyz, s2, r13.w
      and r31.xyz, r26.xzwx, l(0x7fffffff, 0x7fffffff, 0x7fffffff, 0)
      ieq r31.xyz, r31.xyzx, l(0x7f800000, 0x7f800000, 0x7f800000, 0)
      or r13.w, r31.y, r31.x
      or r13.w, r31.z, r13.w
      movc r26.xzw, r13.wwww, l(1.000000,0,1.000000,0), r26.xxzw
      dp3 r31.x, r17.yzwy, r27.xyzx
      dp3 r31.y, r17.yzwy, r29.xyzx
      dp3 r31.z, r17.yzwy, r30.xyzx
      mad_sat r17.yzw, r31.xxyz, cb10[r9.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
      mul r31.xy, r17.yzyy, cb10[r9.w + 4].zwzz
      mul r31.z, r17.w, cb10[r9.w + 5].x
      add r17.yzw, r31.xxyz, cb10[r9.w + 5].yyzw
      dp3 r28.x, r12.xyzx, r27.xyzx
      dp3 r28.y, r12.xyzx, r29.xyzx
      dp3 r28.z, r12.xyzx, r30.xyzx
      ...
      mad r14.yzw, r17.yyzw, r27.xxyz, r14.yyzw
      mul r13.w, r4.w, r9.w
      mul r17.yzw, r10.wwww, r26.xxzw
      dp3 r10.w, r17.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r9.w, r4.w, r9.w, r10.w
      div r9.w, r13.w, r9.w
      mad r25.xyz, r17.yzwy, r9.wwww, r25.xyzx
    else 
      mov r20.x, r15.y
      mov r15.yz, r20.xxyx
    endif 
...
bfi r2.w, l(8), l(0), r15.z, r24.w
movc r0.y, r0.y, r2.w, r15.z
max r2.w, r15.y, l(1.000000)
rcp r2.w, r2.w
mov_sat r15.y, r15.y
mul r17.xyz, r2.wwww, r14.yzwy
mul r18.xyz, r2.wwww, r25.xyzx
...
if_nz r4.z
  ...
  mad r18.xyz, r14.yzwy, r2.wwww, r18.xyzx
endif 
add r2.w, r5.x, r2.x
log r2.w, |r2.w|
mul r2.w, r1.w, r2.w
...
ret 
// Approximately 1657 instruction slots used
