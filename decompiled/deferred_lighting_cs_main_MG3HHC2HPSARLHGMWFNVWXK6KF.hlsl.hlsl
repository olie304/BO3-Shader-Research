...
r0.y = samplerLinear[]..swiz;
  ...
  r0.y = cmp((uint)r14.y >= (uint)r8.w);
  r9.w = cmp((uint)r14.y < numRefProbes);
  r0.y = r0.y ? r9.w : 0;
  if (r0.y != 0) {
    r0.y = (int)r14.y * 14;
    if (r2.w != 0) {
    ...
    r17.yz = float2(0,1);
    r17.xy = r12.ww ? r17.xy : r17.zx;
    r18.x = 1;
    r12.w = refProbeConstantsCB[r0.y].data[6].x;
    r19.xy = r17.xy;
    r13.w = 1;
    while (true) {
      r14.w = cmp((int)r13.w >= (int)r10.w);
      if (r14.w != 0) break;
      r14.w = (int)r9.w + (int)r13.w;
      r14.w = (int)r14.w * 6;
      r17.z = dot(refProbeAttenuationConstantsCB[r14.w].data[0].xyz, r15.yzw);
      r17.z = saturate(refProbeAttenuationConstantsCB[r14.w].data[0].w + r17.z);
      r17.z = r19.x * r17.z;
      r17.w = dot(refProbeAttenuationConstantsCB[r14.w].data[1].xyz, r15.yzw);
      r17.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[1].w + r17.w);
      r17.z = r17.z * r17.w;
      r17.w = dot(refProbeAttenuationConstantsCB[r14.w].data[2].xyz, r15.yzw);
      r17.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[2].w + r17.w);
      r17.z = r17.z * r17.w;
      r17.w = dot(refProbeAttenuationConstantsCB[r14.w].data[3].xyz, r15.yzw);
      r17.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[3].w + r17.w);
      r17.z = r17.z * r17.w;
      r17.w = dot(refProbeAttenuationConstantsCB[r14.w].data[4].xyz, r15.yzw);
      r17.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[4].w + r17.w);
      r17.z = r17.z * r17.w;
      r17.w = dot(refProbeAttenuationConstantsCB[r14.w].data[5].xyz, r15.yzw);
      r14.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[5].w + r17.w);
      r19.x = r17.z * r14.w;
      r17.w = (uint)r12.w >> 2;
      if (1 == 0) r18.z = 0; else if (1+2 < 32) {       r18.z = (uint)r12.w << (32-(1 + 2)); r18.z = (uint)r18.z >> (32-1);      } else r18.z = (uint)r12.w >> 2;
      r18.w = (int)r17.w & 2;
      r19.z = max(r19.y, r19.x);
      r14.w = -r17.z * r14.w + 1;
      r14.w = r19.y * r14.w;
      r18.y = r18.w ? r14.w : r19.z;
      r19.xy = r18.zz ? r19.xy : r18.xy;
      r13.w = (int)r13.w + 1;
      r12.w = r17.w;
    }
    r19.y = saturate(r19.y);
    r9.w = refProbeConstantsCB[r0.y].data[6].y * r19.y;
    r10.w = cmp(0 < r9.w);
    if (r10.w != 0) {
      if (r2.w != 0) {
      // Known bad code for instruction (needs manual fix):
      ...
      r10.w = refProbeConstantsCB[r0.y].data[7].y * r9.w;
      ...
      r17.xyz = r16.xyz * r12.www + r17.xyz;
      ...
      r19.w = (uint)r13.w;
      r17.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r19.xyzw, r12.w).xyz;
      r22.xyz = (int3)r17.xyz & int3(-2147483648,-2147483648,-2147483648);
      r22.xyz = cmp((int3)r22.xyz == int3(2139095040,2139095040,2139095040));
      r12.w = (int)r22.y | (int)r22.x;
      r12.w = (int)r22.z | (int)r12.w;
  ...
  if (r8.w != 0) {
    ...
    r10.w = (int)r0.y + 1;
    r18.xyz = -refProbeConstantsCB[r8.w].data[0].xyz + r5.xyz;
    ...
    r14.y = (int)r12.w * 6;
    r14.w = dot(refProbeAttenuationConstantsCB[r14.y].data[0].xyz, r18.xyz);
    r14.w = saturate(refProbeAttenuationConstantsCB[r14.y].data[0].w + r14.w);
    r17.w = dot(refProbeAttenuationConstantsCB[r14.y].data[1].xyz, r18.xyz);
    r17.w = saturate(refProbeAttenuationConstantsCB[r14.y].data[1].w + r17.w);
    r14.w = r17.w * r14.w;
    r17.w = dot(refProbeAttenuationConstantsCB[r14.y].data[2].xyz, r18.xyz);
    r17.w = saturate(refProbeAttenuationConstantsCB[r14.y].data[2].w + r17.w);
    r14.w = r17.w * r14.w;
    r17.w = dot(refProbeAttenuationConstantsCB[r14.y].data[3].xyz, r18.xyz);
    r17.w = saturate(refProbeAttenuationConstantsCB[r14.y].data[3].w + r17.w);
    r14.w = r17.w * r14.w;
    r17.w = dot(refProbeAttenuationConstantsCB[r14.y].data[4].xyz, r18.xyz);
    r17.w = saturate(refProbeAttenuationConstantsCB[r14.y].data[4].w + r17.w);
    r14.w = r17.w * r14.w;
    r17.w = dot(refProbeAttenuationConstantsCB[r14.y].data[5].xyz, r18.xyz);
    r14.y = saturate(refProbeAttenuationConstantsCB[r14.y].data[5].w + r17.w);
    r19.x = r14.w * r14.y;
    r14.y = 1 & (int)refProbeConstantsCB[r8.w].data[6].x;
    r19.yz = float2(0,1);
    r14.yw = r14.yy ? r19.xy : r19.zx;
    r19.x = 1;
    r17.w = refProbeConstantsCB[r8.w].data[6].x;
    r20.xy = r14.yw;
    r18.w = 1;
    while (true) {
      r19.z = cmp((int)r18.w >= (int)r13.w);
      if (r19.z != 0) break;
      r19.z = (int)r12.w + (int)r18.w;
      r19.z = (int)r19.z * 6;
    ...
    r12.w = saturate(r20.y + -r9.w);
    r13.w = refProbeConstantsCB[r8.w].data[6].y * r12.w;
    r14.y = cmp(0 < r13.w);
    if (r14.y != 0) {
      r14.y = (int)r10.w & 3;
      r14.w = (int)r14.y + -1;
      ...
      r14.w = r14.w ? r2.w : 0;
      if (r14.w != 0) {
        r14.yw = mad((int2)r14.yy, int2(20,20), int2(860,876));
      // Known bad code for instruction (needs manual fix):
      ...
      r10.w = (int)r0.y + 257;
      r12.w = r12.w * refProbeConstantsCB[r8.w].data[6].y + r9.w;
      r13.w = refProbeConstantsCB[r8.w].data[7].y * r13.w;
      r19.x = refProbeConstantsCB[r8.w].data[7].w;
      r19.yz = refProbeConstantsCB[r8.w].data[8].xy;
      r14.y = dot(r16.xyz, r19.xyz);
      r14.w = dot(r18.xyz, r19.xyz);
      r14.w = -refProbeConstantsCB[r8.w].data[8].z + r14.w;
      r17.w = cmp(r14.w >= 0);
      r14.w = max(abs(r14.w), r6.w);
      ...
      r19.x = refProbeConstantsCB[r8.w].data[8].w;
      r19.yz = refProbeConstantsCB[r8.w].data[9].xy;
      r14.w = dot(r16.xyz, r19.xyz);
      r17.w = dot(r18.xyz, r19.xyz);
      r17.w = -refProbeConstantsCB[r8.w].data[9].z + r17.w;
      r18.w = cmp(r17.w >= 0);
      ...
      r19.x = refProbeConstantsCB[r8.w].data[9].w;
      r19.yz = refProbeConstantsCB[r8.w].data[10].xy;
      r14.w = dot(r16.xyz, r19.xyz);
      r17.w = dot(r18.xyz, r19.xyz);
      r17.w = -refProbeConstantsCB[r8.w].data[10].z + r17.w;
      r18.w = cmp(r17.w >= 0);
      r17.w = max(abs(r17.w), r6.w);
      r17.w = r18.w ? r17.w : -r17.w;
      r14.w = max(1.00000001e-07, -r14.w);
      r14.w = r17.w / r14.w;
      r14.y = min(r14.y, abs(r14.w));
      r19.x = refProbeConstantsCB[r8.w].data[10].w;
      r19.yz = refProbeConstantsCB[r8.w].data[11].xy;
      r14.w = dot(r16.xyz, r19.xyz);
      r17.w = dot(r18.xyz, r19.xyz);
      r17.w = -refProbeConstantsCB[r8.w].data[11].z + r17.w;
      r18.w = cmp(r17.w >= 0);
      r17.w = max(abs(r17.w), r6.w);
      r17.w = r18.w ? r17.w : -r17.w;
      r14.w = max(1.00000001e-07, -r14.w);
      r14.w = r17.w / r14.w;
      r14.y = min(r14.y, abs(r14.w));
      r19.x = refProbeConstantsCB[r8.w].data[11].w;
      r19.yz = refProbeConstantsCB[r8.w].data[12].xy;
      r14.w = dot(r16.xyz, r19.xyz);
      r17.w = dot(r18.xyz, r19.xyz);
      r17.w = -refProbeConstantsCB[r8.w].data[12].z + r17.w;
      r18.w = cmp(r17.w >= 0);
      r17.w = max(abs(r17.w), r6.w);
      r17.w = r18.w ? r17.w : -r17.w;
      r14.w = max(1.00000001e-07, -r14.w);
      r14.w = r17.w / r14.w;
      r14.y = min(r14.y, abs(r14.w));
      r19.x = refProbeConstantsCB[r8.w].data[12].w;
      r19.yz = refProbeConstantsCB[r8.w].data[13].xy;
      r14.w = dot(r16.xyz, r19.xyz);
      r17.w = dot(r18.xyz, r19.xyz);
      r17.w = -refProbeConstantsCB[r8.w].data[13].z + r17.w;
      r18.w = cmp(r17.w >= 0);
      r6.w = max(abs(r17.w), r6.w);
      r6.w = r18.w ? r6.w : -r6.w;
      r14.w = max(1.00000001e-07, -r14.w);
      r6.w = r6.w / r14.w;
      r6.w = min(r14.y, abs(r6.w));
      r19.x = refProbeConstantsCB[r8.w].data[3].w + r18.x;
      r19.yz = refProbeConstantsCB[r8.w].data[4].xy + r18.yz;
      r19.xyz = r16.xyz * r6.www + r19.xyz;
      r14.y = dot(r19.xyz, r19.xyz);
      r14.y = sqrt(r14.y);
      r6.w = r6.w / r14.y;
      r6.w = r6.w + r6.w;
      r6.w = sqrt(r6.w);
      ...
      r20.x = refProbeConstantsCB[r8.w].data[0].w;
      r20.y = refProbeConstantsCB[r8.w].data[1].z;
      r20.z = refProbeConstantsCB[r8.w].data[2].y;
      r21.x = dot(r19.xyz, r20.xyz);
      r22.xy = refProbeConstantsCB[r8.w].data[1].xw;
      r22.z = refProbeConstantsCB[r8.w].data[2].z;
      r21.y = dot(r19.xyz, r22.xyz);
      r23.x = refProbeConstantsCB[r8.w].data[1].y;
      r23.yz = refProbeConstantsCB[r8.w].data[2].xw;
      r21.z = dot(r19.xyz, r23.xyz);
      if (9 == 0) r6.w = 0; else if (9+16 < 32) {       r6.w = (uint)refProbeConstantsCB[r8.w].data[7].z << (32-(9 + 16)); r6.w = (uint)r6.w >> (32-9);      } else r6.w = (uint)refProbeConstantsCB[r8.w].data[7].z >> 16;
      r21.w = (uint)r6.w;
      ...
      r18.xyz = saturate(r24.xyz * refProbeConstantsCB[r8.w].data[3].xyz + float3(0.5,0.5,0.5));
      r24.xy = refProbeConstantsCB[r8.w].data[4].zw * r18.xy;
      r24.z = refProbeConstantsCB[r8.w].data[5].x * r18.z;
      r18.xyz = refProbeConstantsCB[r8.w].data[5].yzw + r24.xyz;
  ...
  r3.z = cmp(r9.w >= 1);
  bitmask.y = ((~(-1 << 8)) << 0) & 0xffffffff;  r0.y = (((uint)r10.w << 0) & bitmask.y) | ((uint)r0.y & ~bitmask.y);
  r0.y = r3.z ? r0.y : r10.w;
  r3.z = max(1, r12.w);
  r3.z = rcp(r3.z);
  ...
  if (enableCountDebug != 0) {
    if (debugDrawOverlayType != 0) {
      switch (cb2[53].y) {
        case 1 :        r0.x = (int)r4.z & 3;
        break;
        case 2 :        if (2 == 0) r0.x = 0; else if (2+8 < 32) {         r0.x = (uint)r4.z << (32-(2 + 8)); r0.x = (uint)r0.x >> (32-2);        } else r0.x = (uint)r4.z >> 8;
        break;
