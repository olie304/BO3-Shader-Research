  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.z = r0.x + -r0.y;
  r0.x = cmp(r0.y < r0.x);
  r0.y = cmp(featherParms.x == 0.000000);
  r0.w = 1 / featherParms.x;
  ...
  r2.x = v1.w + r1.w;
  r2.y = saturate(r2.x * alphaDissolve + -alphaDissolve);
  r2.xzw = r2.yyy * r0.yzw;
  r0.y = cmp(alphaDissolve != 1.000000);
  r1.xyzw = r0.yyyy ? r2.xzwy : r1.xyzw;
  r1.xyzw = r1.xyzw * r0.xxxx;
  r2.x = 1;
  r0.yz = r0.yy ? r2.xy : v1.ww;
  r1.xyzw = r1.xyzw * r0.yyyy;
  r0.x = r0.z * r0.x;
  r0.y = emissiveMap.Sample(colorSampler_s, v2.xy).x;
  r0.x = r0.y * r0.x;
