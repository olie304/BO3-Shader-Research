// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:37:27 2021
...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r1.xyz = detailMap1.Sample(normalSampler_s, r1.xy).xyz;
  ...
  r3.xy = detailScale2.xy * r3.xy;
  r0.yz = useUVOffsets1 ? r0.yz : r3.xy;
  ...
  if (r1.w != 0) {
    ...
    r4.xyz = r4.zzz ? float3(0,1,0) : r2.xyz;
    r2.xyz = r3.xxx ? r3.yzw : r4.xyz;
  }
  r1.w = debugAlphaOverride.x + -r2.w;
  r3.w = debugAlphaOverride.w * r1.w + r2.w;
  ...
  r4.w = saturate(0.0588235296 * glossRange2.y);
  r4.w = r4.w + -r4.z;
  r4.z = r0.x * r4.w + r4.z;
  ...
  r0.w = min(1, r0.w);
  r5.xy = r1.xy * detailScaleHeight1 + r4.xy;
  r1.x = dot(r5.xyz, r5.xyz);
  r1.x = rsqrt(r1.x);
  r6.xyz = r5.xyz * r1.xxx;
  r6.w = r1.z * detailScaleHeight1 + r1.w;
  r5.xy = r0.yz * detailScaleHeight2 + r4.xy;
  r0.y = dot(r5.xyz, r5.xyz);
  r0.y = rsqrt(r0.y);
  r5.xyz = r5.xyz * r0.yyy;
  r5.w = r0.w * detailScaleHeight2 + r1.w;
  r1.xyzw = r5.xyzw + -r6.xyzw;
  r0.xyzw = r0.xxxx * r1.xyzw + r6.xyzw;
  r1.x = v8.x ? 1 : -1;
  r1.y = dot(v4.xyz, v4.xyz);
  r1.y = rsqrt(r1.y);
  r4.xyw = v4.xyz * r1.yyy;
  ...
  r0.xyz = r4.xyw * r0.zzz + r1.xzw;
  r1.x = dot(r0.xyz, r0.xyz);
  r1.x = rsqrt(r1.x);
  r0.xyz = r1.xxx * r0.xyz;
  r1.x = debugGlossOverride.x * r2.w + glossRange.x;
  ...
  r1.xyz = v4.xyz * r1.yyy + -r0.xyz;
  r1.xyz = debugNormalOverride.www * r1.xyz + r0.xyz;
  r0.xy = (uint2)v0.xy;
  ...
  while (true) {
    ...
    if (r9.w != 0) break;
    r0.z = (uint)r9.z >> 5;
    r13.xyz = (int3)r0.xyz + (int3)r12.xyz;
    r0.z = visibleProbes.Load(r13.xyzw).x;
  ...
  if (r9.y == 0) {
    ...
    while (true) {
      ...
      r10.z = cmp((int)r0.y == (int)r9.w);
      bitmask.w = ((~(-1 << r0.z)) << 0) & 0xffffffff;  r10.w = (((uint)0 << 0) & bitmask.w) | ((uint)r10.y & ~bitmask.w);
    ...
    if (r9.y != 0) {
      ...
      r10.z = 0;
      while (true) {
        r10.w = cmp((uint)r10.z >= (uint)r0.x);
        if (r10.w != 0) break;
        r13.z = (uint)r10.z >> 5;
        r14.xyz = (int3)r12.xyz + (int3)r13.xyz;
        r10.w = visibleProbes.Load(r14.xyzw).x;
        r12.w = cmp((int)r0.y == (int)r10.z);
        if (r0.z == 0) r13.z = 0; else if (r0.z+0 < 32) {         r13.z = (uint)r10.w << (32-(r0.z + 0)); r13.z = (uint)r13.z >> (32-r0.z);        } else r13.z = (uint)r10.w >> 0;
    ...
    r19.xyz = r22.xyz * r0.xxx;
    r20.xyz = r23.xyz * r0.xxx;
  ...
  r0.yz = r5.xy * float2(0.984375,0.984375) + float2(0.0078125,0.0078125);
  r0.yz = gEnvBRDFGeneric.SampleLevel(samplerLinear_s, r0.yz, 0).xy;
  r9.yzw = r20.xyz * r0.xxx;
  r14.xyz = r9.zwy * r0.yyy;
  r0.xyz = r9.yzw * r0.zzz;
  r0.w = sqrt(r5.w);
  r0.w = r0.w * 0.5 + 0.5;
  r0.w = r0.w * r0.w;
  r1.w = 0.5 * r0.w;
  ...
  r0.w = r5.y * r0.w;
  r1.w = r5.y * r1.w;
  r5.y = dot(r1.xyz, sunConstants.wldDir.xyz);
  r6.w = saturate(r5.y);
  r7.z = cmp(0 >= r6.w);
  if (r7.z != 0) {
    r7.w = 0;
  ...
  if (r7.z != 0) {
    r7.z = cmp(0 < r7.w);
    if (r7.z != 0) {
      r7.z = sunConstants.specScale * r5.z;
      r7.z = r7.z * r6.w;
      ...
      r18.z = samp0[]..swiz;
      r18.w = samp0[]..swiz;
        r10.z = abs(r5.y) * -0.200000003 + 0.400000006;
        r19.xyz = r1.xyz * r10.zzz + v7.xyz;
        r19.w = 1;
      ...
      r10.yzw = -v7.xyz * r2.www + sunConstants.wldDir.xyz;
      r2.w = dot(r10.yzw, r10.yzw);
      r2.w = rsqrt(r2.w);
      r10.yzw = r10.yzw * r2.www;
      r2.w = dot(r10.yzw, r6.xyz);
      r8.w = dot(r1.xyz, r10.yzw);
      r10.y = abs(r8.w) * r5.z + -abs(r8.w);
      ...
      r6.w = r7.w * r6.w;
      r6.w = 0.25 * r6.w;
      r10.yzw = r6.www * r9.yzw + r0.xyz;
      r2.w = saturate(1 + -r2.w);
      r7.z = r2.w * r2.w;
      r7.z = r7.z * r7.z;
      r2.w = r7.z * r2.w;
      r2.w = r6.w * r2.w;
      r16.xyz = r2.www * r9.zwy + r14.xyz;
      r15.w = r16.z;
      r13.w = r14.z;
      r13.xyzw = r5.yyyy ? r15.xyzw : r13.xyzw;
      r16.zw = r10.yz;
      r14.zw = r0.xy;
      r15.xyzw = r5.yyyy ? r16.xyzw : r14.xyzw;
      r0.z = r5.y ? r10.w : r0.z;
      r14.z = r13.w;
      r14.xy = r15.xy;
      r0.xy = r15.zw;
    }
            ...
            if (r25.w != 0) {
              ...
              if (r25.w != 0) {
                ...
                if (r25.w != 0) {
                  ...
                  r13.w = r13.w + -r21.w;
                  r13.w = r5.w * r13.w + r21.w;
                  r13.w = r13.w * r16.z;
                  r32.x = r31.x;
                  r14.w = cmp(0 < r16.w);
                  r20.xyz = r13.www * r32.xyz + r10.yzw;
                  r13.w = saturate(dot(r1.xyz, r39.xyz));
                  r38.xyz = r38.xyz * r12.www + r6.xyz;
                  r12.w = dot(r38.xyz, r38.xyz);
                  r12.w = rsqrt(r12.w);
                  r38.xyz = r38.xyz * r12.www;
                  r12.w = dot(r38.xyz, r6.xyz);
                  r16.w = dot(r1.xyz, r38.xyz);
                  r19.x = abs(r16.w) * r5.z + -abs(r16.w);
                  r16.w = abs(r16.w) * r19.x + 1;
                  r19.x = r13.w * r0.w + r1.w;
                  r16.w = r16.w * r16.w;
                  r16.w = r16.w * r19.x;
                  r16.w = rcp(r16.w);
                  r13.w = r13.w * r25.w;
            ...
            r39.w = samp0[]..swiz;
              ...
              if (r16.z != 0) {
                ...
                if (r16.z != 0) {
                  ...
                  r16.w = r16.w + -r14.w;
                  r16.w = r5.w * r16.w + r14.w;
                  r16.w = r16.w * r11.w;
                  r13.w = cmp(0 < r13.w);
                  r23.xyz = r16.www * r21.xyw + r10.yzw;
                  r20.xyz = r20.xyz * r12.www + r6.xyz;
                  r12.w = dot(r20.xyz, r20.xyz);
                  r12.w = rsqrt(r12.w);
                  r20.xyz = r20.xyz * r12.www;
                  r12.w = dot(r20.xyz, r6.xyz);
                  r16.w = dot(r1.xyz, r20.xyz);
                  r20.x = abs(r16.w) * r5.z + -abs(r16.w);
                  r16.w = abs(r16.w) * r20.x + 1;
                  r14.w = r14.w * r0.w + r1.w;
                  r16.w = r16.w * r16.w;
                  r14.w = r16.w * r14.w;
                  r14.w = rcp(r14.w);
                  r14.w = r14.w * r16.z;
