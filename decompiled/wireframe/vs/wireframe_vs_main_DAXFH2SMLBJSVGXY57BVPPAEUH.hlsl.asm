...
mov r4.xyz, v0.xyzx
mov r4.w, l(1.000000)
dp4 r3.y, r4.xyzw, r3.xyzw
mul r5.xyzw, r3.yyyy, cb1[9].xyzw
mov r1.w, r2.x
mov r0.w, r2.z
dp4 r3.z, r4.xyzw, r0.xyzw
dp4 r3.x, r4.xyzw, r1.xyzw
mad r0.xyzw, r3.xxxx, cb1[8].xyzw, r5.xyzw
add r1.xyz, r3.xyzx, cb1[24].xyzx
mad r0.xyzw, r3.zzzz, cb1[10].xyzw, r0.xyzw
add o0.xyzw, r0.xyzw, cb1[11].xyzw
mul r0.xyzw, r1.yyyy, cb3[2].xyzw
mad r0.xyzw, r1.xxxx, cb3[1].xyzw, r0.xyzw
mad r0.xyzw, r1.zzzz, cb3[3].xyzw, r0.xyzw
add r0.xyzw, r0.xyzw, cb3[4].xyzw
lt r1.x, l(0.000000), cb3[0].x
