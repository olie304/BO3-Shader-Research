...
mul r0.xyzw, r1.yyyy, cb1[9].xyzw
mad r0.xyzw, r1.xxxx, cb1[8].xyzw, r0.xyzw
mad r0.xyzw, r1.zzzz, cb1[10].xyzw, r0.xyzw
add o0.xyzw, r0.xyzw, cb1[11].xyzw
lt r0.x, l(0.000000), cb3[0].x
add r0.yzw, r1.xxyz, cb1[24].xxyz
mul r1.xyzw, r0.zzzz, cb3[2].xyzw
mad r1.xyzw, r0.yyyy, cb3[1].xyzw, r1.xyzw
mad r1.xyzw, r0.wwww, cb3[3].xyzw, r1.xyzw
add r1.xyzw, r1.xyzw, cb3[4].xyzw
movc o1.xyzw, r0.xxxx, r1.xyzw, l(0,0,0,1.000000)
ret 
