...
r0.w = gpuSkinBase[]..swiz;
  ...
  r0.xyzw = viewProjectionMatrix._m10_m11_m12_m13 * r1.yyyy;
  r0.xyzw = r1.xxxx * viewProjectionMatrix._m00_m01_m02_m03 + r0.xyzw;
  r0.xyzw = r1.zzzz * viewProjectionMatrix._m20_m21_m22_m23 + r0.xyzw;
  o0.xyzw = viewProjectionMatrix._m30_m31_m32_m33 + r0.xyzw;
  r0.x = cmp(0 < scriptVector0.x);
  r0.yzw = eyeOffset.xyz + r1.xyz;
  r1.xyzw = scriptVector2.xyzw * r0.zzzz;
  r1.xyzw = r0.yyyy * scriptVector1.xyzw + r1.xyzw;
  r1.xyzw = r0.wwww * scriptVector3.xyzw + r1.xyzw;
  r1.xyzw = scriptVector4.xyzw + r1.xyzw;
  o1.xyzw = r0.xxxx ? r1.xyzw : float4(0,0,0,1);
  return;
}