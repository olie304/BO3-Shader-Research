...
ftoi r0.xy, r0.xyxx
ftoi r0.zw, cb8[16].xxxx
ld_aoffimmi_indexable(-1,0,0)(texture2d)(float,float,float,float) r1.xyzw, r0.xyww, t0.xyzw
mul r2.xyzw, r1.wwww, r1.xyzw
ld_indexable(texture2d)(float,float,float,float) r3.xyzw, r0.xyww, t0.xyzw
mad r2.xyzw, r3.xyzw, r3.wwww, r2.xyzw
add r1.x, r1.w, r3.w
ld_aoffimmi_indexable(0,-1,0)(texture2d)(float,float,float,float) r3.xyzw, r0.xyww, t0.xyzw
ld_aoffimmi_indexable(-1,-1,0)(texture2d)(float,float,float,float) r0.xyzw, r0.xyzw, t0.xyzw
mad r2.xyzw, r3.xyzw, r3.wwww, r2.xyzw
add r1.x, r1.x, r3.w
add r1.x, r0.w, r1.x
mad r0.xyzw, r0.xyzw, r0.wwww, r2.xyzw
