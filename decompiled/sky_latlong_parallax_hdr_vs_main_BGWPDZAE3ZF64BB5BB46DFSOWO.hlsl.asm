...
dp2 r1.y, r0.xyxx, cb1[57].xyxx
mul r0.zw, cb1[57].yyyx, l(0.000000, 0.000000, 1.000000, -1.000000)
dp2 r1.x, r0.xyxx, r0.zwzz
add r2.xyz, -cb0[10].xyzx, cb1[24].xyzx
div r2.xyz, r2.xyzx, |cb1[57].zzzz|
dp2 r3.y, r2.xyxx, cb1[57].xyxx
mov r3.z, r2.z
dp2 r3.x, r2.xyxx, r0.zwzz
add o1.xyz, r1.xyzx, r3.xyzx
ret 
