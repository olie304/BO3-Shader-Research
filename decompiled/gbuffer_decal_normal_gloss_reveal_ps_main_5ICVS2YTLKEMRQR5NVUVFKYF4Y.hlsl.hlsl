// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:27:48 2021
...
Texture2D<float4> flowMap : register(t14);
Texture2D<float4> noiseMap : register(t15);
  ...
  out float4 o1 : SV_TARGET1)
{
  ...
  r1.xy = r0.yz * v10.zw + v10.xy;
  r1.xy = max(v11.xy, r1.xy);
  r1.xy = min(v11.zw, r1.xy);
  r0.w = volDecalRevealTexture.Sample(colorSampler_s, r1.xy).x;
  r0.x = r0.w * r0.x;
  r0.yz = r0.yz * v12.zw + v12.xy;
  r1.xy = normalMapScale.xy * r0.yz;
  r1.zw = scaleReveal ? r1.xy : r0.yz;
  r1.zw = revealScale.xy * r1.zw;
  ...
  r0.x = r1.w * r0.x;
  r2.y = exp2(r0.x);
  r1.zw = saturate(alphaRevealSoftEdge * r2.xy + r1.zz);
  r0.x = -r1.z + r0.w;
  r0.w = r1.w + -r1.z;
  r0.x = saturate(r0.x / r0.w);
  r2.xyz = float3(-1,-1,-1) + useOrientedNormalMap;
  r2.xyz = r0.xxx * r2.xyz + float3(1,1,1);
  r0.w = glossMap.Sample(specColorSampler_s, r0.yz).x;
  ...
  if (useOrientedNormalMap == 0) {
    ...
    r6.xy = r6.xy * r3.ww + r1.xy;
    r6.xy = normalMap.SampleLevel(normalSampler_s, r6.xy, r2.w).xy;
    r9.xy = r7.zw * float2(-1,1) + float2(1,-1);
    r9.xy = r9.xy * r3.ww + r1.xy;
    r9.xy = normalMap.SampleLevel(normalSampler_s, r9.xy, r2.w).xy;
    r9.xy = r9.xy + -r6.xy;
    ...
    r1.xy = r9.zw * r3.ww + r1.xy;
    r1.xy = normalMap.SampleLevel(normalSampler_s, r1.xy, r2.w).xy;
    r1.xy = r1.xy + -r9.xy;
    r1.xy = r6.zz * r1.xy + r9.xy;
    r1.xy = r1.xy + -r6.xy;
    r1.xy = r6.ww * r1.xy + r6.xy;
    r1.xy = r1.xy * r8.zz + r8.ww;
  } else {
    r6.xy = r7.xy * float2(-1,1) + float2(1,-1);
    ...
    r9.xy = r6.xy / r3.ww;
    r9.z = -r9.x;
    r6.x = dot(r0.yz, r9.yz);
    r6.y = dot(r0.yz, -r9.xy);
    r10.xy = normalMapScale.xy * r6.xy;
    r3.w = gameTime.w * r3.w;
    r10.z = -r3.w * flowParams.y + r10.y;
    r6.xy = normalMap.SampleLevel(normalSampler_s, r10.xz, r2.w).xy;
    ...
    r7.xy = r7.xy / r3.ww;
    r7.z = -r7.x;
    r8.x = dot(r0.yz, r7.yz);
    r8.y = dot(r0.yz, -r7.xy);
    r9.xy = normalMapScale.xy * r8.xy;
    r3.w = gameTime.w * r3.w;
    r9.z = -r3.w * flowParams.y + r9.y;
    r8.xy = normalMap.SampleLevel(normalSampler_s, r9.xz, r2.w).xy;
    ...
    r7.xy = r5.xy / r3.ww;
    r7.z = -r7.x;
    r5.x = dot(r0.yz, r7.yz);
    r5.y = dot(r0.yz, -r7.xy);
    r10.xy = normalMapScale.xy * r5.xy;
    r3.w = gameTime.w * r3.w;
    r10.z = -r3.w * flowParams.y + r10.y;
    r5.xy = normalMap.SampleLevel(normalSampler_s, r10.xz, r2.w).xy;
  ...
  if (r1.y != 0) {
    ...
    r1.z = colorMap.CalculateLevelOfDetailUnclamped(colorSampler_s, r0.yz);
    ...
    r4.xyw = r0.yyy ? r5.xyz : r4.xyw;
    r5.xyz = r4.zzz ? float3(0,1,0) : r2.xyz;
    r2.xyz = r0.zzz ? r4.xyw : r5.xyz;
  }
