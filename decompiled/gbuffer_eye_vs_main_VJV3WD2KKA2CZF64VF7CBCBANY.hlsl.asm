...
// TEXCOORD                13   xy          9     NONE   float   xy  
//
vs_5_0
...
if_nz r0.w
  ...
  mov o7.xyz, l(0,1.000000,0,0)
  mov o8.xyz, l(0,0,1.000000,0)
endif 
...
mul o1.w, r0.z, r0.w
mad o9.xy, r0.xyxx, l(1.000000, -1.000000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
mov o1.x, v1.w
mov o1.yz, v2.xxyx
mov r4.w, v7.x
mov o2.xyzw, r4.wxyz
