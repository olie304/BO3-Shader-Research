  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.xy = (int2)r0.xy;
  r0.zw = float2(0,0);
  r0.x = floatAlphaZSampler.Load(r0.xyz).x;
  ...
  r1.xy = r1.xy + r1.xy;
  r1.xy = r1.xy / postFxControl7.xx;
  r1.zw = floor(r1.xy);
  r2.xy = frac(r1.xy);
  r0.yz = r1.zw * r0.yz;
  r1.xyzw = downsampledAlphaDepth.Gather(depthSamplerState_s, r0.yz).xyzw;
  r1.xyzw = max(float4(9.99999994e-09,9.99999994e-09,9.99999994e-09,9.99999994e-09), r1.wzxy);
  r1.xyzw = rcp(r1.xyzw);
  ...
  r0.x = r2.z * r1.z + r0.x;
  r0.x = r2.w * r1.w + r0.x;
  r1.xyzw = volumeLightTexture.Gather(volumeLightSamplerState_s, r0.yz).xyzw;
  r1.x = dot(r3.zwyx, r1.xyzw);
  r2.xyzw = volumeLightTexture.Gather(volumeLightSamplerState_s, r0.yz).xyzw;
  r4.xyzw = volumeLightTexture.Gather(volumeLightSamplerState_s, r0.yz).xyzw;
  r1.z = dot(r3.zwyx, r4.xyzw);
  r1.y = dot(r3.zwyx, r2.xyzw);
