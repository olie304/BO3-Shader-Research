...
// depthSamplerState                 sampler      NA          NA             s2      1 
// volumeLightTexture                texture  float4          2d             t0      1 
// downsampledAlphaDepth             texture   float          2d             t2      1 
// floatAlphaZSampler                texture   float          2d             t3      1 
...
utof r0.xy, r0.xyxx
rcp r0.xy, r0.xyxx
add r0.zw, v0.xxxy, l(0.000000, 0.000000, 1.000000, 1.000000)
div r0.zw, r0.zzzw, cb8[7].xxxx
...
max r1.xyzw, r1.wzxy, l(0.00000001, 0.00000001, 0.00000001, 0.00000001)
rcp r1.xyzw, r1.xyzw
ftoi r3.xy, v0.xyxx
mov r3.zw, l(0,0,0,0)
ld_indexable(texture2d)(float,float,float,float) r0.z, r3.xyww, t3.yzxw
ld_indexable(texture2d)(float,float,float,float) r3.xyz, r3.xyzw, t5.xyzw
max r0.z, r0.z, l(0.00000001)
rcp r0.z, r0.z
add r1.xyzw, -r0.zzzz, r1.xyzw
mul r0.z, r0.z, cb8[10].y
div r0.z, l(1.000000, 1.000000, 1.000000, 1.000000), r0.z
mad r1.xyzw, r0.zzzz, |r1.xyzw|, l(0.000100, 0.000100, 0.000100, 0.000100)
...
dp4 r1.x, r4.zwyx, r1.xyzw
gather4_indexable(texture2d)(float,float,float,float) r2.xyzw, r0.xyxx, t0.xyzw, s1.y
gather4_indexable(texture2d)(float,float,float,float) r5.xyzw, r0.xyxx, t0.xyzw, s1.z
dp4 r1.z, r4.zwyx, r5.xyzw
dp4 r1.y, r4.zwyx, r2.xyzw
div r0.xyz, r1.xyzx, r0.zzzz
