...
Texture2D<float3> volumeLightTexture : register(t0);
Texture2D<float4> blendTexture : register(t2);
Texture3D<float4> volumetricAccumulatedLightScatter : register(t3);
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.xy = (uint2)r0.xy;
  r0.xy = rcp(r0.xy);
  r0.zw = v0.xy / postFxControl7.xx;
  r0.xy = r0.zw * r0.xy;
  r1.xy = (int2)v0.xy;
  r1.zw = float2(0,0);
  r0.w = floatZSampler.Load(r1.xyw).x;
  r1.xyz = blendTexture.Load(r1.xyz).xyz;
  ...
  r0.w = rcp(r0.w);
  r0.w = 0.000714285707 * r0.w;
  r0.w = rsqrt(r0.w);
  r0.z = 1 / r0.w;
  r0.xyz = volumetricAccumulatedLightScatter.SampleLevel(volumeLightSamplerState_s, r0.xyz, 0).xyz;
