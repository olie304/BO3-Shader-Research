...
// volumeLightTexture                texture  float3          2d             t0      1 
// blendTexture                      texture  float4          2d             t2      1 
// volumetricAccumulatedLightScatter    texture  float4          3d             t3      1 
...
utof r0.xy, r0.xyxx
rcp r0.xy, r0.xyxx
div r0.zw, v0.xxxy, cb8[7].xxxx
mul r0.xy, r0.xyxx, r0.zwzz
ftoi r1.xy, v0.xyxx
mov r1.zw, l(0,0,0,0)
ld_indexable(texture2d)(float,float,float,float) r0.w, r1.xyww, t6.yzwx
...
rcp r0.w, r0.w
mul r0.w, r0.w, l(0.00071429)
rsq r0.w, r0.w
div r0.z, l(1.000000, 1.000000, 1.000000, 1.000000), r0.w
sample_l_indexable(texture3d)(float,float,float,float) r0.xyz, r0.xyzx, t3.xyzw, s1, l(0.000000)
