...
if_nz r1.w
  ...
  div r10.zw, -r12.xxxy, r1.wwww
  and r10.zw, r2.yyyy, r10.zzzw
  add r11.xy, v2.xyxx, l(-0.500000, -0.500000, 0.000000, 0.000000)
  add r1.w, cb0[15].y, l(0.000010)
  mul r10.zw, r1.wwww, r10.zzzw
  mul r10.zw, r10.zzzw, cb0[13].zzzw
  mad r10.zw, r11.xxxy, cb0[13].zzzw, r10.zzzw
  mad r10.zw, cb0[14].xxxy, cb0[13].zzzw, r10.zzzw
  ...
  mov r12.y, r12.x
  mov r12.z, r11.x
  dp2 r13.x, r12.yzyy, r10.zwzz
  mov r12.x, -r11.x
  dp2 r13.y, r12.xyxx, r10.zwzz
  mul r10.zw, cb0[13].xxxy, cb1[69].wwww
  mad r10.zw, r10.zzzw, cb0[13].zzzw, r13.xxxy
  mul r1.w, cb0[15].x, cb1[69].w
  sincos null, r1.w, r1.w
  mad r1.w, r1.w, l(0.500000), l(0.500000)
  add r1.w, -r1.w, l(1.000000)
  add r2.y, -cb0[14].z, cb0[14].w
  mad r1.w, r1.w, r2.y, cb0[14].z
  div r10.zw, r10.zzzw, r1.wwww
  add r10.zw, r10.zzzw, l(0.000000, 0.000000, 0.500000, 0.500000)
  mov_sat r11.xy, r10.zwzz
  movc r10.xy, cb0[15].zwzz, r11.xyxx, r10.zwzz
endif 
sample_indexable(texture2d)(float,float,float,float) r10.xyzw, r10.xyxx, t25.xyzw, s1
mul r10.xyz, r10.xyzx, cb0[18].xyzx
mul r1.w, r1.z, r10.w
mul r10.xyz, r1.wwww, r10.xyzx
add r1.w, v3.y, v3.x
add r1.w, r1.w, v3.z
add r2.y, r1.w, cb0[16].y
frc r2.y, r2.y
mad r11.y, cb1[69].w, cb0[16].z, r2.y
mov r11.x, cb0[16].x
sample_l_indexable(texture2d)(float,float,float,float) r2.y, r11.xyxx, t24.yxzw, s5, l(0.000000)
log r2.y, |r2.y|
mul r2.y, r2.y, cb0[17].z
exp r2.y, r2.y
add r3.w, -cb0[17].x, cb0[17].y
mad r2.y, r2.y, r3.w, cb0[17].x
mul r10.xyz, r2.yyyy, r10.xyzx
lt r2.y, l(0.500000), cb0[24].z
if_nz r2.y
  mul r2.y, cb0[20].w, cb0[21].x
  mul r3.w, r2.y, cb0[21].y
  ...
  mul r2.y, r2.y, r3.w
  round_ne r2.y, r2.y
  div r3.w, r2.y, cb0[21].x
  mul r4.w, r2.y, cb0[21].x
  ge r4.w, r4.w, -r4.w
  ...
  mad r2.y, cb0[21].w, cb1[69].w, l(1.000000)
  mul r2.y, r2.y, cb0[21].z
