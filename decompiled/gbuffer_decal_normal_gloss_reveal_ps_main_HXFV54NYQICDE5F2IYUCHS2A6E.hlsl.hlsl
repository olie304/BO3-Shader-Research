  ...
  out float4 o1 : SV_TARGET1)
{
  ...
  if (scaleNormalsWithFlow != 0) {
    r8.zw = flowMap.Sample(flowSampler_s, w1.xy).xy;
    r9.xy = r8.zw + r8.zw;
  ...
  if (useOrientedNormalMap == 0) {
    ...
    r9.xy = r6.xy / r4.ww;
    r9.z = -r9.x;
    r6.x = dot(w1.xy, r9.yz);
    r6.y = dot(w1.xy, -r9.xy);
    ...
    r7.xy = r7.xy / r4.ww;
    r7.z = -r7.x;
    r8.x = dot(w1.xy, r7.yz);
    r8.y = dot(w1.xy, -r7.xy);
