// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:36:45 2021
...
StructuredBuffer<glassShardTransformBuffer> glassShardTransformBuffer : register(t6);
...
// Needs manual fix for instruction: 
// unknown dcl_: dcl_resource_structured t6, 48
  float4 r0,r1,r2,r3,r4,r5,r6,r7,r8,r9;
  uint4 bitmask, uiDest;
  float4 fDest;

// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=48)(mixed,mixed,mixed,mixed) r0.xyzw, v5.x, l(0), t6.xyzw
...
r0.w = modelInstanceBuffer[]..swiz;
  ...
  r1.x = v0.z * r0.z + r0.w;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=48)(mixed,mixed,mixed,mixed) r2.xyzw, v5.x, l(16), t6.xyzw
...
r2.w = modelInstanceBuffer[]..swiz;
  ...
  r1.y = v0.z * r2.z + r0.w;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=48)(mixed,mixed,mixed,mixed) r3.xyzw, v5.x, l(32), t6.xyzw
...
r7.w = modelInstanceBuffer[]..swiz;
  ...
  r6.w = r5.y;
  r8.y = dot(r1.xyzw, r6.xyzw);
  r9.xyzw = viewProjectionMatrix._m10_m11_m12_m13 * r8.yyyy;
  r4.w = r5.x;
  r7.w = r5.z;
  r8.x = dot(r1.xyzw, r4.xyzw);
  r5.xyzw = r8.xxxx * viewProjectionMatrix._m00_m01_m02_m03 + r9.xyzw;
  r8.z = dot(r1.xyzw, r7.xyzw);
  r1.xyzw = r8.zzzz * viewProjectionMatrix._m20_m21_m22_m23 + r5.xyzw;
  o6.xyz = r8.xyz;
  ...
  r5.x = dot(r1.xyz, r0.xyz);
  r5.y = dot(r1.xyz, r2.xyz);
  r5.z = dot(r1.xyz, r3.xyz);
  r1.xyz = r5.xyz * float3(511,511,511) + float3(512,512,512);
  r1.xyz = r1.xyz * float3(0.00195694715,0.00195694715,0.00195694715) + float3(-1.00195694,-1.00195694,-1.00195694);
  r5.x = dot(r1.xyz, r4.xyz);
  r5.y = dot(r1.xyz, r6.xyz);
  r5.z = dot(r1.xyz, r7.xyz);
