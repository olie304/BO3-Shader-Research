  ...
  if_nz r2.x
    ...
    if_nz r2.w
      ...
      if_nz r2.w
        ...
        dp3 r3.w, r6.xyzx, v0.xyzx
        add r3.w, r6.w, r3.w
        mad r4.z, r3.w, v5.z, r4.z
        dp3 r3.w, r6.xyzx, r0.xyzx
        mad r5.z, r3.w, v5.z, r5.z
        dp3 r3.w, r6.xyzx, r1.xyzx
        mad r3.z, r3.w, v5.z, r3.z
        ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r2.w, r2.w, l(48), t5.xxxx
        mad r2.z, r2.w, v5.z, r2.z
        ...
        if_nz r2.w
          ...
          dp3 r3.w, r6.xyzx, r0.xyzx
          mad r5.x, r3.w, v5.w, r5.x
          dp3 r3.w, r6.xyzx, r1.xyzx
          mad r3.x, r3.w, v5.w, r3.x
          ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r6.xyzw, r2.w, l(16), t5.xyzw
          dp3 r3.w, r6.xyzx, v0.xyzx
          add r3.w, r6.w, r3.w
          mad r4.y, r3.w, v5.w, r4.y
          dp3 r3.w, r6.xyzx, r0.xyzx
          mad r5.y, r3.w, v5.w, r5.y
          dp3 r3.w, r6.xyzx, r1.xyzx
          mad r3.y, r3.w, v5.w, r3.y
          ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r6.xyzw, r2.w, l(32), t5.xyzw
          dp3 r3.w, r6.xyzx, v0.xyzx
          add r3.w, r6.w, r3.w
          mad r4.z, r3.w, v5.w, r4.z
          dp3 r3.w, r6.xyzx, r0.xyzx
          mad r5.z, r3.w, v5.w, r5.z
          dp3 r3.w, r6.xyzx, r1.xyzx
          mad r3.z, r3.w, v5.w, r3.z
          ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r2.w, r2.w, l(48), t5.xxxx
          mad r2.z, r2.w, v5.w, r2.z
        endif 
      endif 
    endif 
  else 
...
mov r9.w, r8.z
dp4 r3.w, r4.xyzw, r9.xyzw
dp3 r4.x, r0.xyzx, r6.xyzx
dp3 r4.y, r0.xyzx, r7.xyzx
dp3 r4.z, r0.xyzx, r9.xyzx
...
mad r0.xyzw, r0.wwww, cb1[8].xyzw, r4.xyzw
mad r0.xyzw, r3.wwww, cb1[10].xyzw, r0.xyzw
add o0.xyzw, r0.xyzw, cb1[11].xyzw
and r0.x, r5.x, l(0x0fffffff)
if_nz r0.x
  if_nz r0.x
