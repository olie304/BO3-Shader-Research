...
dp3 r0.y, r1.xyzx, cb8[0].xyzx
mad r1.xyz, -r0.yyyy, cb8[1].xyzx, r1.xyzx
mad_sat r0.z, r0.y, cb8[0].w, cb8[1].w
mul r2.xyz, r0.yyyy, cb8[1].xyzx
...
mul o0.xyz, r0.yzwy, cb8[2].yyyy
add r0.y, -r0.x, l(1.000000)
mad r0.y, -r0.y, l(40.000000), l(1.000000)
ge r0.z, r0.x, l(0.984375)
movc r0.x, r0.z, r0.y, r0.x
max r0.x, r0.x, l(0.00000001)
div r0.x, cb8[2].z, r0.x
