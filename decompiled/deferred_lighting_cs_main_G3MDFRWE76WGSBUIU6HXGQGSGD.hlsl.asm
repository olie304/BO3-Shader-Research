...
mov r15.w, l(0)
sample_l_indexable(texturecubearray)(float,float,float,float) r14.yzw, r15.xyzw, t8.wxyz, s2, r3.z
add r3.z, -r6.w, cb2[19].x
mad r3.z, r2.y, r3.z, r6.w
      ...
      if_z r7.w
        ...
        if_nz cb2[58].y
          ...
          loop 
            ...
            sample_c_lz_indexable(texture2darray)(float,float,float,float) r11.w, r20.xyzx, t9.xxxx, s13, r7.w
  ...
  if_nz r9.w
    ...
    if_nz r9.w
      ...
      if_nz r9.w
        ...
        mad r20.yzw, r11.xxyz, r9.wwww, r5.xxyz
      ...
      if_nz r9.w
        ...
        dp3 r11.w, r18.xyzx, r15.xyzx
        dp3 r12.w, r15.xyzx, r19.xyzx
        mad r15.x, -r11.w, r11.w, cb9[r0.x + 6].y
        mad r3.w, r11.w, r12.w, -r3.w
        div_sat r3.w, r3.w, r15.x
        div r11.w, r15.x, cb9[r0.x + 6].y
        mul r11.w, r11.w, l(10.000000)
        min r11.w, r11.w, l(1.000000)
        add r3.w, -r4.z, r3.w
        mad r3.w, r11.w, r3.w, r4.z
        ...
        if_nz r4.z
          ...
          if_z r12.w
            ...
            if_z r15.w
              ...
              mul r16.w, r11.w, cb9[r3.w + 10].z
              mad r4.z, cb9[r3.w + 10].y, r11.w, r4.z
              div r4.z, r4.z, r16.w
            endif 
          else 
            mov r15.w, l(-1)
          ...
          if_z r11.w
            ...
            and r11.w, l(0x0000ffff), cb9[r3.w + 1].w
            if_nz cb2[58].y
              mov r18.x, -r13.x
              utof r20.z, r11.w
              mov r18.y, r14.x
              ...
              loop 
                ...
                sample_c_lz_indexable(texture2darray)(float,float,float,float) r16.w, r20.xyzx, t9.xxxx, s13, r4.z
                mad r12.w, r16.w, l(0.125000), r12.w
                iadd r15.w, r15.w, l(1)
              endloop 
            else 
          ...
          if_z r10.w
            ...
            if_nz cb2[58].y
              ...
              loop 
                ...
                sample_c_lz_indexable(texture2darray)(float,float,float,float) r15.w, r20.xyzx, t9.xxxx, s13, r9.w
          ...
          if_nz r3.x
            ...
            if_z r8.w
              ...
              if_nz cb2[58].y
                ...
                utof r19.z, r8.w
                sample_c_lz_indexable(texture2darray)(float,float,float,float) r9.w, r19.xyzx, t9.xxxx, s13, r3.x
              endif 
              mul r0.x, r9.w, r9.w
              mul r0.x, r9.w, r0.x
            else 
