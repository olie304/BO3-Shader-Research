...
add r0.z, -r0.y, r0.x
lt r0.x, r0.y, r0.x
eq r0.y, cb0[12].x, l(0.000000)
div r0.w, l(1.000000, 1.000000, 1.000000, 1.000000), cb0[12].x
...
max r0.y, r1.w, l(0.000100)
div r0.yzw, r1.xxyz, r0.yyyy
add r2.x, r1.w, v1.w
mad_sat r2.y, r2.x, cb0[12].z, -cb0[12].z
mul r2.xzw, r0.yyzw, r2.yyyy
ne r0.y, cb0[12].z, l(1.000000)
movc r1.xyzw, r0.yyyy, r2.xzwy, r1.xyzw
mul r1.xyzw, r0.xxxx, r1.xyzw
mov r2.x, l(1.000000)
movc r0.yz, r0.yyyy, r2.xxyx, v1.wwww
mul r1.xyzw, r0.yyyy, r1.xyzw
mul r0.x, r0.x, r0.z
sample_indexable(texture2d)(float,float,float,float) r0.y, v2.xyxx, t22.yxzw, s1
mul r0.x, r0.x, r0.y
...
mul r0.y, r0.y, v3.w
movc r0.y, cb0[12].w, cb0[11].z, r0.y
mul r0.x, r0.x, r0.y
mad r0.xyz, v3.xyzx, r0.xxxx, v1.xyzx
