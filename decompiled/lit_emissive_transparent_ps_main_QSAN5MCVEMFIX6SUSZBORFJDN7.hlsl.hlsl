...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  if (r1.z != 0) {
    ...
    r2.xyw = r2.xxx ? r6.xyz : r5.xyw;
    r5.xyz = r5.zzz ? float3(0,1,0) : r0.xyz;
    r0.xyz = r1.www ? r2.xyw : r5.xyz;
  }
  ...
  r2.xyw = float3(-0.0399999991,-0.0399999991,-0.0399999991) + debugSpecularOverride.xyz;
  r2.xyw = debugSpecularOverride.www * r2.xyw + float3(0.0399999991,0.0399999991,0.0399999991);
  r1.x = r1.x + -r1.y;
  ...
  r0.w = r0.w * r1.z + r4.w;
  r4.xyz = r4.xyz * r1.zzz + r13.xyz;
  r1.w = dot(r4.xyz, r4.xyz);
  r1.w = rsqrt(r1.w);
  r4.xyz = r4.xyz * r1.www;
  r6.y = r1.x * r1.z + r5.z;
  r2.xyz = r2.xyw * r1.zzz + r14.xyz;
  r1.x = cmp(0.5 < relativeHDR);
  if (r1.x != 0) {
    ...
    r11.y = r11.x;
    r11.z = r10.x;
    r12.x = dot(r11.yz, r1.xw);
    r11.x = -r10.x;
    r12.y = dot(r11.xy, r1.xw);
    r1.xw = gameTime.ww * scrollUVs.xy;
    r1.xw = r1.xw * scaleUVs.xy + r12.xy;
  ...
  if (r6.w == 0) {
    ...
    if (r5.w != 0) {
      ...
      r5.y = sunConstants.globalProbeExposure * r5.w + -r4.w;
      r4.w = r6.y * r5.y + r4.w;
