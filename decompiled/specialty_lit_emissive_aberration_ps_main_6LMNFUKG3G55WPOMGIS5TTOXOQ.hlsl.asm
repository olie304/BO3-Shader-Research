...
dp3 r6.x, r5.xyzx, v5.xyzx
dp3 r6.y, r5.xyzx, v6.xyzx
dp3 r2.z, r5.xyzx, v4.xyzx
lt r2.w, l(0.000000), r2.z
div r6.xy, -r6.xyxx, r2.zzzz
and r2.zw, r2.wwww, r6.xxxy
add r6.xy, v2.xyxx, l(-0.500000, -0.500000, 0.000000, 0.000000)
...
sample_indexable(texture2d)(float,float,float,float) r2.w, v2.xyxx, t37.xyzw, s1
add r6.xyzw, r6.xyzz, v2.xyxy
...
if_nz r9.z
  ...
  if_nz r9.z
    ...
    if_nz r12.w
      ...
      mad r19.xyz, r3.xyzx, r13.wwww, v7.xyzx
          ...
          if_nz r25.w
            ...
            if_nz r25.w
              ...
              if_nz r25.w
                ...
                mad r42.xyz, r3.xyzx, r25.wwww, v7.xyzx
