...
mul r2.zw, v2.xxxy, cb0[11].zzzw
sample_indexable(texture2d)(float,float,float,float) r2.z, r2.zwzz, t18.yzxw, s5
mov_sat r2.w, cb0[21].w
mad_sat r4.xy, v1.xyxx, l(0.998000, 0.998000, 0.000000, 0.000000), l(0.001000, 0.001000, 0.000000, 0.000000)
log r4.zw, r4.xxxy
...
mul r2.w, r2.w, r5.z
exp r5.y, r2.w
mad_sat r4.xz, cb0[21].zzzz, r5.xxyx, r4.xxxx
add r2.z, r2.z, -r4.x
add r2.w, -r4.x, r4.z
...
add r5.xyz, cb0[17].xyzx, l(-1.000000, -1.000000, -1.000000, 0.000000)
mad r5.xyz, r3.wwww, r5.xyzx, l(1.000000, 1.000000, 1.000000, 0.000000)
mad r3.xyz, r3.xyzx, r5.xyzx, -r0.xyzx
...
exp r0.w, r2.w
mov r5.x, -r0.w
mad_sat r4.xy, cb0[22].xxxx, r5.xyxx, r4.yyyy
add r0.w, -r4.x, r4.y
mul r4.yz, v2.xxyx, cb0[21].xxyx
sample_indexable(texture2d)(float,float,float,float) r2.w, r4.yzyy, t21.yzwx, s5
add r2.w, -r4.x, r2.w
