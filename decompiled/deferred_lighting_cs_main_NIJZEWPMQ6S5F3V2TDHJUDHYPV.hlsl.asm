...
if_nz r9.w
  ...
  endloop 
  mov_sat r19.y, r19.y
  mul r13.w, r19.y, cb10[r9.w + 6].y
  lt r14.w, l(0.000000), r13.w
  if_nz r14.w
    mul r14.w, r13.w, cb10[r9.w + 7].y
    mov r18.x, cb10[r9.w + 7].w
    mov r18.yz, cb10[r9.w + 8].xxyx
    dp3 r16.y, r17.xyzx, r18.xyzx
    dp3 r16.z, r15.yzwy, r18.xyzx
    add r16.z, r16.z, -cb10[r9.w + 8].z
    ...
    mov r18.x, cb10[r9.w + 8].w
    mov r18.yz, cb10[r9.w + 9].xxyx
    ...
    mov r18.x, cb10[r9.w + 9].w
    mov r18.yz, cb10[r9.w + 10].xxyx
    dp3 r16.z, r17.xyzx, r18.xyzx
    dp3 r16.w, r15.yzwy, r18.xyzx
    ...
    div r16.z, r16.w, r16.z
    min r16.y, |r16.z|, r16.y
    mov r18.x, cb10[r9.w + 10].w
    mov r18.yz, cb10[r9.w + 11].xxyx
    dp3 r16.z, r17.xyzx, r18.xyzx
    dp3 r16.w, r15.yzwy, r18.xyzx
    ...
    div r16.z, r16.w, r16.z
    min r16.y, |r16.z|, r16.y
    mov r18.x, cb10[r9.w + 11].w
    mov r18.yz, cb10[r9.w + 12].xxyx
    dp3 r16.z, r17.xyzx, r18.xyzx
    dp3 r16.w, r15.yzwy, r18.xyzx
    ...
    div r16.z, r16.w, r16.z
    min r16.y, |r16.z|, r16.y
    mov r18.x, cb10[r9.w + 12].w
    mov r18.yz, cb10[r9.w + 13].xxyx
    dp3 r16.z, r17.xyzx, r18.xyzx
    dp3 r16.w, r15.yzwy, r18.xyzx
    ...
    div r16.z, r16.w, r16.z
    min r16.y, |r16.z|, r16.y
    add r18.x, r15.y, cb10[r9.w + 3].w
    add r18.yz, r15.zzwz, cb10[r9.w + 4].xxyx
    ...
    mov r19.x, cb10[r9.w + 0].w
    mov r19.y, cb10[r9.w + 1].z
    mov r19.z, cb10[r9.w + 2].y
    dp3 r20.x, r18.xyzx, r19.xyzx
    mov r21.xy, cb10[r9.w + 1].xwxx
    mov r21.z, cb10[r9.w + 2].z
    dp3 r20.y, r18.xyzx, r21.xyzx
    mov r22.x, cb10[r9.w + 1].y
    mov r22.yz, cb10[r9.w + 2].xxwx
    dp3 r20.z, r18.xyzx, r22.xyzx
    ubfe r16.z, l(9), l(16), cb10[r9.w + 7].z
    utof r20.w, r16.z
    ...
    mad_sat r15.yzw, r18.xxyz, cb10[r9.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
    mul r18.xy, r15.yzyy, cb10[r9.w + 4].zwzz
    mul r18.z, r15.w, cb10[r9.w + 5].x
    add r15.yzw, r18.xxyz, cb10[r9.w + 5].yyzw
...
if_nz r9.w
  ...
  if_nz r8.w
    ...
    mov r18.w, l(1)
    loop 
      ige r19.z, r18.w, r9.w
      breakc_nz r19.z
      iadd r19.z, r8.w, r18.w
      ...
      mov r14.w, r20.z
    endloop 
    add_sat r8.w, -r13.w, r21.y
    mul r9.w, r8.w, cb10[r0.y + 6].y
    lt r14.w, l(0.000000), r9.w
    if_nz r14.w
      mad r13.w, r8.w, cb10[r0.y + 6].y, r13.w
      mul r8.w, r9.w, cb10[r0.y + 7].y
      mov r19.x, cb10[r0.y + 7].w
      mov r19.yz, cb10[r0.y + 8].xxyx
      dp3 r9.w, r17.xyzx, r19.xyzx
      ...
      ge r19.x, r18.w, l(0.000000)
      max r4.w, r4.w, |r18.w|
      movc r4.w, r19.x, r4.w, -r4.w
      max r14.w, -r14.w, l(0.00000010)
      div r4.w, r4.w, r14.w
      min r4.w, |r4.w|, r9.w
      add r19.x, r18.x, cb10[r0.y + 3].w
      add r19.yz, r18.yyzy, cb10[r0.y + 4].xxyx
      mad r19.xyz, r17.xyzx, r4.wwww, r19.xyzx
      dp3 r9.w, r19.xyzx, r19.xyzx
      sqrt r9.w, r9.w
      div r4.w, r4.w, r9.w
      add r4.w, r4.w, r4.w
      sqrt r4.w, r4.w
      mad r3.z, r3.z, l(5.000000), r4.w
...
lt r3.z, r13.w, l(0.990000)
if_nz r3.z
  add r3.z, -r13.w, l(1.000000)
  ...
  mov r17.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r15.yzw, r17.xyzw, t8.wxyz, s2, r3.w
