...
// tImg0                             texture  float4          2d             t0      1 
// tImg1                             texture  float4          2d             t1      1 
// tImg2                             texture  float4          2d             t2      1 
// tImg3                             texture  float4          2d             t3      1 
...
dcl_output o0.xyz
dcl_temps 2
sample_indexable(texture2d)(float,float,float,float) r0.xyz, v0.xyxx, t1.xyzw, s0
mul r0.xyz, r0.xyzx, cb8[0].yyyy
sample_indexable(texture2d)(float,float,float,float) r1.xyz, v0.xyxx, t0.xyzw, s0
mad r0.xyz, r1.xyzx, cb8[0].xxxx, r0.xyzx
sample_indexable(texture2d)(float,float,float,float) r0.w, v0.xyxx, t2.yzwx, s0
mad r0.xyz, r0.wwww, cb8[0].zzzz, r0.xyzx
sample_indexable(texture2d)(float,float,float,float) r0.w, v0.xyxx, t3.yzwx, s0
mad o0.xyz, r0.wwww, cb8[0].wwww, r0.xyzx
ret 
