...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  if (r1.w != 0) {
    ...
    sincos(r1.w, r3.x, r7.x);
    r7.y = r7.x;
    r7.z = r3.x;
    r10.x = dot(r7.yz, r5.zw);
    r7.x = -r3.x;
    r10.y = dot(r7.xy, r5.zw);
  ...
  r1.w = rsqrt(r1.w);
  r7.xyz = -v7.xyz * r1.www;
  r3.x = saturate(dot(r7.xyz, r3.yzw));
  ...
  r0.w = frac(r0.w);
  r6.y = gameTime.w * flickerSpeed + r0.w;
  r6.x = flickerSeed.x;
  r0.w = flickerLookupMap.SampleLevel(lookupSampler_s, r6.xy, 0).x;
  r0.w = log2(abs(r0.w));
  r0.w = flickerPower * r0.w;
  r0.w = exp2(r0.w);
  r3.w = flickerRange.y + -flickerRange.x;
  r0.w = r0.w * r3.w + flickerRange.x;
