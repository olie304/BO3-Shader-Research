...
//   float scriptSelector;              // Offset:  324 Size:     4 [unused]
...
eq r1.yzw, v7.yyyy, l(0.000000, 3.000000, 2.000000, 1.000000)
...
if_nz r0.w
  ...
  if_nz r1.x
    ...
    mad r0.w, r0.w, cb2[15].x, cb2[14].z
    mul r0.w, r0.w, cb2[16].x
    lt r1.w, l(0.010000), |v6.z|
    mul r2.x, v6.z, cb2[15].z
    mul r2.y, r2.x, l(-1.442695)
    exp r2.y, r2.y
    add r2.y, -r2.y, l(1.000000)
    div r2.x, r2.y, r2.x
    mul r2.x, r0.w, r2.x
    movc r0.w, r1.w, r2.x, r0.w
    mul r2.xyz, r0.wwww, cb2[12].xyzx
    exp r1.xyz, r2.xyzx
  endif 
