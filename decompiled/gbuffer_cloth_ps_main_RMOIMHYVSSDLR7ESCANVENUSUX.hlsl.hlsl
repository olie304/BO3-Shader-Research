  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  if (r2.w != 0) {
    r2.w = detailScaleHeight3 * r4.x;
    r8.xyz = r5.xyz;
  } else {
    r3.w = cmp(0 < r4.y);
    if (r3.w != 0) {
      r2.w = detailScaleHeight2 * r4.y;
      r8.xyz = r6.xyz;
    } else {
      r3.w = cmp(0 < r4.z);
      if (r3.w != 0) {
        r2.w = detailScaleHeight1 * r4.z;
        r8.xyz = r7.xyz;
      } else {
        r3.w = cmp(0 < r4.w);
        if (r3.w != 0) {
          r2.w = detailScaleHeight * r4.w;
        } else {
          r8.xyz = float3(0,0,0);
          r2.w = 0;
        }
  ...
  r2.xzw = debugColorOverride.xyz + -r0.xyz;
  r0.xyz = debugColorOverride.www * r2.xzw + r0.xyz;
  ...
  r3.yzw = debugNormalOverride.www * r1.yzw + r3.xyz;
  r1.yz = tintScale.xy * v2.xy;
  ...
  r4.w = waterRefractionAmount * r0.w;
  r4.w = cmp(0 < r4.w);
  r5.z = 17 * r1.x;
  r5.z = exp2(r5.z);
  r5.z = 2 + r5.z;
  ...
  r0.w = r0.w + r5.z;
  r0.w = min(1, r0.w);
  r0.xyz = r0.xyz * r1.yzw + -r2.xzw;
  r0.xyz = r5.zzz * r0.xyz + r2.xzw;
  r1.yzw = r6.xyz * r0.www;
  o0.xyz = r4.www ? r1.yzw : r6.xyz;
  r0.xyz = r4.www ? r0.xyz : r2.xzw;
  r0.w = r5.x + r5.y;
  r0.w = r4.z * r2.y + r0.w;
  r0.w = 0.5 * r0.w;
  r1.yzw = r4.xyz * r2.yyy + -r0.www;
  r2.x = max(r1.z, r1.w);
  r2.x = max(r2.x, r1.y);
  r0.w = max(r2.x, r0.w);
  r1.y = cmp(r0.w == r1.y);
