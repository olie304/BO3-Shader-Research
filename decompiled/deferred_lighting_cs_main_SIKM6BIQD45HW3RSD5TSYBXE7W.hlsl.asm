...
sqrt r2.z, r2.z
mul r12.xy, r1.zwzz, cb1[44].zwzz
gather4_indexable(texture2d)(float,float,float,float) r13.xyzw, r12.xyxx, t27.xyzw, s4.x
gather4_indexable(texture2d)(float,float,float,float) r12.xyzw, r12.xyxx, t28.xyzw, s4.x
mul r1.zw, r1.zzzw, l(0.000000, 0.000000, 0.500000, 0.500000)
frc r1.zw, r1.zzzw
add r14.xy, -r1.wzww, l(1.000000, 1.000000, 0.000000, 0.000000)
mul r15.y, r14.x, r14.y
mul r15.xz, r1.zzwz, r14.xxyx
mul r15.w, r1.w, r1.z
dp4 r1.z, r13.xyzw, r15.xyzw
add r12.xyzw, -r0.zzzz, r12.xyzw
min r1.w, |r12.w|, |r12.z|
min r1.w, r1.w, |r12.y|
min r1.w, r1.w, |r12.x|
max r2.w, |r12.w|, |r12.z|
max r2.w, r2.w, |r12.y|
max r2.w, r2.w, |r12.x|
eq r12.xyz, r1.wwww, |r12.yzwy|
movc r1.w, r12.x, r13.y, r13.x
movc r1.w, r12.y, r13.z, r1.w
movc r1.w, r12.z, r13.w, r1.w
...
mad r3.x, r1.w, l(5.000000), l(-2.500000)
mul r3.x, r3.x, l(0.400000)
...
loop 
  ...
  ieq r14.z, r0.y, r12.w
  bfi r14.w, r7.w, l(0), l(0), r13.w
  movc r13.w, r14.z, r14.w, r13.w
  ieq r14.z, r8.w, r12.w
  ubfe r14.w, r9.w, l(0), r13.w
  movc r13.w, r14.z, r14.w, r13.w
  ...
  loop 
    ...
    add r21.xyz, r9.xyzx, -cb10[r14.w + 0].xyzx
    and r15.w, l(0x0000ffff), cb10[r14.w + 7].z
    ubfe r16.w, l(6), l(25), cb10[r14.w + 7].z
    imul null, r21.w, r15.w, l(6)
    dp3 r22.x, cb11[r21.w + 0].xyzx, r21.xyzx
    add_sat r22.x, r22.x, cb11[r21.w + 0].w
    dp3 r22.y, cb11[r21.w + 1].xyzx, r21.xyzx
    add_sat r22.y, r22.y, cb11[r21.w + 1].w
    mul r22.x, r22.y, r22.x
    dp3 r22.y, cb11[r21.w + 2].xyzx, r21.xyzx
    add_sat r22.y, r22.y, cb11[r21.w + 2].w
    mul r22.x, r22.y, r22.x
    dp3 r22.y, cb11[r21.w + 3].xyzx, r21.xyzx
    add_sat r22.y, r22.y, cb11[r21.w + 3].w
    mul r22.x, r22.y, r22.x
    dp3 r22.y, cb11[r21.w + 4].xyzx, r21.xyzx
    add_sat r22.y, r22.y, cb11[r21.w + 4].w
    mul r22.x, r22.y, r22.x
    dp3 r22.y, cb11[r21.w + 5].xyzx, r21.xyzx
    add_sat r21.w, r22.y, cb11[r21.w + 5].w
    mul r12.x, r21.w, r22.x
    and r21.w, l(1), cb10[r14.w + 6].x
    movc r22.xy, r21.wwww, r12.xyxx, r12.zxzz
    mov r12.x, cb10[r14.w + 6].x
    mov r23.xy, r22.xyxx
    mov r21.w, l(1)
    loop 
      ige r22.z, r21.w, r16.w
      breakc_nz r22.z
      iadd r22.z, r15.w, r21.w
      imul null, r22.z, r22.z, l(6)
      dp3 r22.w, cb11[r22.z + 0].xyzx, r21.xyzx
      add_sat r22.w, r22.w, cb11[r22.z + 0].w
      mul r22.w, r22.w, r23.x
      dp3 r23.z, cb11[r22.z + 1].xyzx, r21.xyzx
      add_sat r23.z, r23.z, cb11[r22.z + 1].w
      mul r22.w, r22.w, r23.z
      dp3 r23.z, cb11[r22.z + 2].xyzx, r21.xyzx
      add_sat r23.z, r23.z, cb11[r22.z + 2].w
      mul r22.w, r22.w, r23.z
      dp3 r23.z, cb11[r22.z + 3].xyzx, r21.xyzx
      add_sat r23.z, r23.z, cb11[r22.z + 3].w
      mul r22.w, r22.w, r23.z
      dp3 r23.z, cb11[r22.z + 4].xyzx, r21.xyzx
      add_sat r23.z, r23.z, cb11[r22.z + 4].w
      mul r22.w, r22.w, r23.z
      dp3 r23.z, cb11[r22.z + 5].xyzx, r21.xyzx
    ...
    if_nz r14.y
      ...
      dp3 r15.w, r11.xyzx, r22.xyzx
      dp3 r16.w, r21.xyzx, r22.xyzx
      add r16.w, r16.w, -cb10[r14.w + 11].z
      ge r21.w, r16.w, l(0.000000)
      max r16.w, r3.x, |r16.w|
      movc r16.w, r21.w, r16.w, -r16.w
      max r15.w, -r15.w, l(0.00000010)
      ...
      dp3 r15.w, r11.xyzx, r22.xyzx
      dp3 r16.w, r21.xyzx, r22.xyzx
      add r16.w, r16.w, -cb10[r14.w + 12].z
      ge r21.w, r16.w, l(0.000000)
      max r16.w, r3.x, |r16.w|
      movc r16.w, r21.w, r16.w, -r16.w
      max r15.w, -r15.w, l(0.00000010)
      ...
      dp3 r15.w, r11.xyzx, r22.xyzx
      dp3 r16.w, r21.xyzx, r22.xyzx
      add r16.w, r16.w, -cb10[r14.w + 13].z
      ge r21.w, r16.w, l(0.000000)
      max r16.w, r3.x, |r16.w|
      movc r16.w, r21.w, r16.w, -r16.w
      max r15.w, -r15.w, l(0.00000010)
      div r15.w, r16.w, r15.w
      min r14.y, r14.y, |r15.w|
      add r22.x, r21.x, cb10[r14.w + 3].w
      add r22.yz, r21.yyzy, cb10[r14.w + 4].xxyx
      mad r22.xyz, r11.xyzx, r14.yyyy, r22.xyzx
      dp3 r15.w, r22.xyzx, r22.xyzx
      sqrt r15.w, r15.w
      div r14.y, r14.y, r15.w
      ...
      ubfe r15.w, l(9), l(16), cb10[r14.w + 7].z
      utof r25.w, r15.w
      ...
      mad_sat r21.xyz, r28.xyzx, cb10[r14.w + 3].xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
      mul r28.xy, r21.xyxx, cb10[r14.w + 4].zwzz
      mul r28.z, r21.z, cb10[r14.w + 5].x
      add r21.xyz, r28.xyzx, cb10[r14.w + 5].yzwy
      ...
      movc r16.z, r23.w, l(0), l(0.500000)
...
if_nz r8.w
  ...
  loop 
    ...
    loop 
      ...
      mul r12.x, r20.w, r22.w
      and r20.w, l(1), cb10[r14.w + 6].x
      movc r24.xy, r20.wwww, r12.xyxx, r12.zxzz
      mov r12.x, cb10[r14.w + 6].x
      mov r25.xy, r24.xyxx
      mov r20.w, l(1)
      loop 
        ige r22.w, r20.w, r16.w
        breakc_nz r22.w
        iadd r22.w, r15.w, r20.w
        imul null, r22.w, r22.w, l(6)
        dp3 r23.w, cb11[r22.w + 0].xyzx, r23.xyzx
        add_sat r23.w, r23.w, cb11[r22.w + 0].w
        mul r23.w, r23.w, r25.x
        dp3 r24.z, cb11[r22.w + 1].xyzx, r23.xyzx
        add_sat r24.z, r24.z, cb11[r22.w + 1].w
        mul r23.w, r23.w, r24.z
        dp3 r24.z, cb11[r22.w + 2].xyzx, r23.xyzx
        add_sat r24.z, r24.z, cb11[r22.w + 2].w
        mul r23.w, r23.w, r24.z
        dp3 r24.z, cb11[r22.w + 3].xyzx, r23.xyzx
        add_sat r24.z, r24.z, cb11[r22.w + 3].w
        mul r23.w, r23.w, r24.z
        dp3 r24.z, cb11[r22.w + 4].xyzx, r23.xyzx
        add_sat r24.z, r24.z, cb11[r22.w + 4].w
        mul r23.w, r23.w, r24.z
        dp3 r24.z, cb11[r22.w + 5].xyzx, r23.xyzx
        add_sat r22.w, r24.z, cb11[r22.w + 5].w
        ...
        mul r22.w, r22.w, r25.y
        movc r14.y, r25.z, r22.w, r25.w
        movc r25.xy, r24.wwww, r25.xyxx, r14.xyxx
        iadd r20.w, r20.w, l(1)
        mov r12.x, r24.z
      endloop 
      add_sat r12.x, -r13.w, r25.y
      mul r14.y, r12.x, cb10[r14.w + 6].y
      lt r15.w, l(0.000000), r14.y
      if_nz r15.w
        mad r21.w, r12.x, cb10[r14.w + 6].y, r21.w
        mul r12.x, r14.y, cb10[r14.w + 7].y
        ...
        mad_sat r23.xyz, r30.xyzx, cb10[r14.w + 3].xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
        mul r30.xy, r23.xyxx, cb10[r14.w + 4].zwzz
        mul r30.z, r23.z, cb10[r14.w + 5].x
        add r23.xyz, r30.xyzx, cb10[r14.w + 5].yzwy
        ...
        movc r16.z, r25.w, l(0), l(0.500000)
...
mad r0.yz, r2.xxyx, l(0.000000, 0.984375, 0.984375, 0.000000), l(0.000000, 0.00781250, 0.00781250, 0.000000)
...
add r1.z, r6.w, r1.z
mul r3.x, r4.w, r6.y
mad r3.x, r6.x, r4.y, r3.x
mad r3.x, r6.z, r5.y, r3.x
...
ret 
// Approximately 793 instruction slots used
