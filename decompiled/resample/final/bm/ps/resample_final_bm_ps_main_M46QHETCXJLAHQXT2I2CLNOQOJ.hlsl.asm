...
// pointWrap                         sampler      NA          NA             s2      1 
// codeTexture0                      texture  float4          2d             t0      1 
// tNoise                            texture  float4          2d             t1      1 
// tDither                           texture  float4          2d             t2      1 
...
dcl_output o0.xyzw
dcl_temps 3
mad r0.xy, v1.xyxx, cb8[0].xyxx, cb8[0].zwzz
sample_indexable(texture2d)(float,float,float,float) r0.x, r0.xyxx, t1.xyzw, s2
mul r0.x, r0.x, cb8[1].x
mul r0.yz, v0.xxyx, l(0.000000, 0.025000, 0.025000, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r0.yzw, r0.yzyy, t2.wxyz, s2
mul r0.xyz, r0.yzwy, r0.xxxx
sample_indexable(texture2d)(float,float,float,float) r1.xyz, v1.xyxx, t0.xyzw, s0
mad r1.xyz, r1.xyzx, l(0.00003052, 0.00003052, 0.00003052, 0.000000), r0.xyzx
mad r1.xz, r0.zzxz, r1.yyyy, r1.xxzx
log r0.xyz, r1.xyzx
mul r0.xyz, r0.xyzx, cb8[2].yyyy
exp r0.xyz, r0.xyzx
mad r0.xyz, r0.xyzx, cb8[2].zzzz, cb8[2].wwww
ge r2.xyz, cb8[1].wwww, r1.xyzx
mul r1.xyz, r1.xyzx, cb8[2].xxxx
movc r0.xyz, r2.xyzx, r1.xyzx, r0.xyzx
add o0.xyz, r0.xyzx, cb8[1].yyyy
mov o0.w, l(1.000000)
ret 
