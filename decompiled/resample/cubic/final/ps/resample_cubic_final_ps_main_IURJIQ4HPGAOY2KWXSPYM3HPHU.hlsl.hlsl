  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.xyz = codeTexture0.Sample(samp0_s, v1.wy).xyz;
  r1.xyz = codeTexture0.Sample(samp0_s, v1.zy).xyz;
  r2.xyz = codeTexture0.Sample(samp0_s, v1.xy).xyz;
  r3.z = frac(v2.z);
  r3.y = r3.z * r3.z;
  r3.x = r3.y * r3.z;
  r0.w = dot(r3.xy, postFxControl0.xy);
  r0.w = 1 + r0.w;
  r2.xyz = r2.xyz * r0.www;
  r0.w = dot(r3.xzy, postFxControl0.zzw);
  r1.w = dot(r3.zxy, postFxControl1.xzw);
  r2.w = dot(r3.xy, postFxControl1.xy);
  r1.xyz = r1.xyz * r0.www + r2.xyz;
  r0.xyz = r0.xyz * r1.www + r1.xyz;
  r1.xyz = codeTexture0.Sample(samp0_s, v2.xy).xyz;
  o0.xyz = r1.xyz * r2.www + r0.xyz;
  o0.w = 1;
  return;
}