...
dcl_output o0.xyzw
dcl_temps 4
sample_indexable(texture2d)(float,float,float,float) r0.xyz, v1.wyww, t0.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r1.xyz, v1.zyzz, t0.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r2.xyz, v1.xyxx, t0.xyzw, s0
frc r3.z, v2.z
mul r3.y, r3.z, r3.z
mul r3.x, r3.z, r3.y
dp2 r0.w, r3.xyxx, cb8[0].xyxx
add r0.w, r0.w, l(1.000000)
mul r2.xyz, r0.wwww, r2.xyzx
dp3 r0.w, r3.xzyx, cb8[0].zzwz
dp3 r1.w, r3.zxyz, cb8[1].xzwx
dp2 r2.w, r3.xyxx, cb8[1].xyxx
