  ...
  out float2 o3 : SV_TARGET3)
{
  ...
  r1.xyzw = tintMask.Sample(tintMaskSampler_s, w1.xy).xyzw;
  r2.xyz = float3(-1,-1,-1) + colorTint3.xyz;
  r2.xyz = r1.www * r2.xyz + float3(1,1,1);
  r3.xyz = colorTint2.xyz + -r2.xyz;
  r2.xyz = r1.zzz * r3.xyz + r2.xyz;
  r3.xyz = colorTint1.xyz + -r2.xyz;
  r1.yzw = r1.yyy * r3.xyz + r2.xyz;
  r2.xyz = colorTint.xyz + -r1.yzw;
  ...
  o0.xyz = debugColorOverride.www * r1.yzw + r0.xyz;
  ...
  r5.x = r4.z * r2.x;
  r5.y = -r4.w * r2.z;
  r2.xz = renderTargetSize.xy * float2(0.5,0.5) + r5.xy;
  r2.xz = v0.xy + -r2.xz;
  r2.w = r4.x + r4.y;
  r2.w = r3.z * r2.y + r2.w;
  r2.w = 0.5 * r2.w;
