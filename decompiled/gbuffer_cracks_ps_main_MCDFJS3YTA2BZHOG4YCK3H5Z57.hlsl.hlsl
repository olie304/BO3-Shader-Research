// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:27:16 2021
...
// unknown dcl_: dcl_resource_structured t4, 24
  ...
  r3.xyw = r6.xyz * r3.xxx + r8.xyz;
  r3.xyz = r5.xyz * r3.zzz + r3.xyw;
  r2.w = dot(r3.xyz, r3.xyz);
  r2.w = rsqrt(r2.w);
  r3.xyz = r3.xyz * r2.www;
  r8.xy = colorDetailScale.xy * v2.xy;
  r9.xyzw = crackMap.Sample(crackSampler_s, r8.xy).xyzw;
...
r2.w = colorSampler[]..swiz;
  ...
  r2.w = saturate(r2.w);
  r3.w = r3.w * -v1.x + 1;
  r5.w = saturate(r9.w * 0.998000026 + 0.00100000005);
  r6.w = saturate(r3.w);
  r3.w = saturate(alphaRevealParms.x + r3.w);
  r7.w = alphaRevealParms.y + alphaRevealParms.y;
  r5.w = log2(r5.w);
  r5.w = r7.w * r5.w;
  r5.w = exp2(r5.w);
  r3.w = r3.w + -r6.w;
  ...
  r4.w = r4.w * -v1.y + 1;
  r7.w = saturate(r4.w);
  r4.w = saturate(alphaRevealParms.x + r4.w);
  r4.w = r4.w + -r7.w;
  r7.w = -r7.w + r5.w;
  r4.w = 1 / r4.w;
  ...
  r2.w = r4.w * r2.w + r3.w;
  r2.w = min(1, r2.w);
  r9.xyz = r9.xyz * colorTint1.xyz + -r0.xyz;
  r0.xyz = r2.www * r9.xyz + r0.xyz;
  r8.xyz = crackNormalMap.Sample(crackSampler_s, r8.xy).xyz;
  ...
  r4.w = r4.w + -r2.y;
  r2.y = r2.w * r4.w + r2.y;
  r6.xyz = r6.xyz * r3.www + -r3.xyz;
  r3.xyz = r2.www * r6.xyz + r3.xyz;
