...
//   float4 specColorTint1;             // Offset:  272 Size:    16 [unused]
//
// }
//
...
sample_indexable(texture2d)(float,float,float,float) r4.xyz, r2.xwxx, t6.xyzw, s2
...
movc r2.yz, cb0[16].yyyy, r2.yyzy, r5.xxyx
sample_indexable(texture2d)(float,float,float,float) r5.xyzw, r2.yzyy, t15.xyzw, s1
add r6.xyz, cb0[14].xyzx, l(-1.000000, -1.000000, -1.000000, 0.000000)
mad r6.xyz, r5.wwww, r6.xyzx, l(1.000000, 1.000000, 1.000000, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r7.xyz, r2.yzyy, t17.xyzw, s2
sample_indexable(texture2d)(float,float,float,float) r1.w, r2.yzyy, t14.yzwx, s2
sample_indexable(texture2d)(float,float,float,float) r8.xyz, r2.yzyy, t12.xyzw, s3
mad r5.xyz, r5.xyzx, r6.xyzx, -r3.xyzx
mad r3.xyz, r0.xxxx, r5.xyzx, r3.xyzx
add r5.xyz, -r4.xyzx, r7.xyzx
mad r4.xyz, r0.xxxx, r5.xyzx, r4.xyzx
add r2.y, -cb0[11].x, cb0[11].y
mad r2.z, r3.w, r2.y, cb0[11].x
mul_sat r2.z, r2.z, l(0.05882353)
add r3.w, -cb0[15].x, cb0[15].y
mad r1.w, r1.w, r3.w, cb0[15].x
...
mad r5.xy, r8.xyxx, l(1.99218750, 1.99218750, 0.000000, 0.000000), l(-1.000000, -1.000000, 0.000000, 0.000000)
mul r3.w, r8.z, r8.z
...
mad r6.w, r4.w, cb0[12].x, r0.w
mad r1.xy, r5.xyxx, cb0[12].yyyy, r0.yzyy
...
mad r7.xyz, r7.xyzx, r0.xxxx, r8.xyzx
mad r0.xyz, r6.xyzx, r0.zzzz, r7.xyzx
dp3 r1.z, r0.xyzx, r0.xyzx
rsq r1.z, r1.z
mul r0.xyz, r0.xyzx, r1.zzzz
mad r1.z, cb1[62].x, r2.y, cb0[11].x
