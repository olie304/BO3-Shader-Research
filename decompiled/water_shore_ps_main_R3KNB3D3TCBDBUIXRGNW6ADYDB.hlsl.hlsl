...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  r4.z = saturate(dot(r1.xyz, r6.xyz));
  ...
  if (r2.w == 0) {
    ...
    if (r4.x != 0) {
      ...
      r10.x = globalProbeConstants.data[0].w * r7.y;
      r10.yz = globalProbeConstants.data[1].xy * r7.zw;
      r7.yzw = saturate(float3(0.5,0.5,0.5) + r10.xyz);
      r10.xy = globalProbeConstants.data[1].zw * r7.yz;
      r10.z = globalProbeConstants.data[2].x * r7.w;
      r7.yzw = globalProbeConstants.data[2].yzw + r10.xyz;
      r4.zw = cmp(float2(0,0) < r1.xy);
      r10.xy = r4.zw ? float2(0,0) : float2(0.5,0.5);
      r10.z = 0;
      r8.yzw = r10.zzx + r7.yzw;
      r8.yzw = gProbeXArray.SampleLevel(samplerLinearClamp_s, r8.yzw, 0).xyz;
      r11.xyz = r1.xyz * r1.xyz;
      r4.yzw = r11.xyz * r4.yyy;
      r10.xyz = r10.zzy + r7.yzw;
      r10.xyz = gProbeYArray.SampleLevel(samplerLinearClamp_s, r10.xyz, 0).xyz;
      r10.xyz = r10.xyz * r4.zzz;
      r8.yzw = r8.yzw * r4.yyy + r10.xyz;
      r0.y = cmp(0 < r0.y);
      r10.z = r0.y ? 0 : 0.5;
      r10.xy = float2(0,0);
      r7.yzw = r10.xyz + r7.yzw;
      r7.yzw = gProbeZArray.SampleLevel(samplerLinearClamp_s, r7.yzw, 0).xyz;
      r4.yzw = r7.yzw * r4.www + r8.yzw;
      r1.w = 0;
      r7.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r1.xyzw, 6).xyz;
      r4.yzw = r7.yzw * r4.yzw;
      r0.y = dot(r4.yzw, float3(0.212599993,0.715200007,0.0722000003));
      r17.xyz = r20.xyz * r2.www + r4.yzw;
      r9.w = 0;
      r4.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r9.xyzw, r5.w).xyz;
      r1.w = sunConstants.globalProbeExposure * r4.x + -r0.y;
      r0.y = r2.z * r1.w + r0.y;
      r18.xyz = r4.yzw * r0.yyy + r18.xyz;
    }
  } else {
    r18.x = r17.w;
  }
  r4.xyz = probeReflectionLevel * r18.xyz;
  ...
  if (r2.z == 0) {
    ...
    r2.z = -sunConstants.splitDepthOffset + r7.w;
    ...
    if (r4.w != 0) {
      ...
      while (true) {
        ...
        if (r6.w != 0) break;
        r6.w = (uint)r4.w;
        r8.yz = -sunConstants.splitPinTransform[r6.w].xy + r7.yz;
        r8.y = max(abs(r8.y), abs(r8.z));
        r5.w = sunConstants.splitPinTransform[r6.w].z * r8.y;
        r6.w = cmp(r5.w < 1);
        if (r6.w != 0) {
          break;
        }
    ...
    if (r6.w == 0) {
      if (enableDitheredShadow == 0) {
        ...
        r9.z = r6.w + r4.w;
        r6.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r9.xyz, r2.z).x;
        r7.w = gTransShadowmapArray.SampleLevel(samp0_s, r9.xyz, 0).x;
        r6.w = r7.w + r6.w;
      ...
      if (enableDitheredShadow != 0) {
        ...
        r7.yz = -sunConstants.splitPinTransform[r4.w].xy + r7.yz;
        r7.yz = sunConstants.splitPinTransform[r4.w].zz * r7.yz;
        ...
        while (true) {
          ...
          r10.xy = r9.ww ? r7.yz : r8.yz;
          r10.z = r9.w ? sunConstants.splitPinTransform[r4.w].w : sunConstants.splitPinTransform[r6.w].w;
          r9.w = r9.w ? r4.w : r6.w;
          r11.x = dot(icb[r8.w+0].yx, r9.xy);
          r11.y = dot(icb[r8.w+0].yx, r9.yz);
          r10.xy = r11.xy * r10.zz + r10.xy;
          r9.w = (int)r9.w + (int16)sunConstants.splitArrayOffset;
          r10.z = (uint)r9.w;
          r9.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r10.xyz, r2.z).x;
  ...
  r12.w = samp0[]..swiz;
    ...
    r13.xyz = r1.xyz * r0.yyy + v5.xyz;
    r13.w = 1;
    r9.x = dot(r9.xyzw, r13.xyzw);
    r9.y = dot(r10.xyzw, r13.xyzw);
    r7.yz = r9.xy * float2(0.5,-0.5) + float2(0.5,0.5);
    r7.yz = r7.yz + r12.zw;
    r7.yz = r7.yz * r12.xy;
    r8.yz = r4.ww / r11.xz;
    r9.xy = float2(1,1) + -r8.yz;
    r9.xy = cmp(r7.yz >= r9.xy);
    r8.yz = cmp(r8.yz >= r7.yz);
    r8.yz = (int2)r8.yz | (int2)r9.xy;
    r0.y = (int)r8.z | (int)r8.y;
    if (r0.y == 0) {
    // Known bad code for instruction (needs manual fix):
    ...
    r8.y = samp0[]..swiz;
    r8.z = samp0[]..swiz;
      r2.z = dot(r9.xyzw, r13.xyzw);
      r7.yz = saturate(r7.yz);
      r9.xy = r7.yz * r11.xz + r11.yw;
      r2.z = r2.z + r8.y;
      r2.z = r2.z / r8.z;
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          r7.x = cmp((int)r6.w >= 8);
          if (r7.x != 0) break;
          r7.x = dot(icb[r6.w+0].yx, r10.xy);
          r7.y = dot(icb[r6.w+0].yx, r10.yz);
          r11.xy = r7.xy * r4.ww + r9.xy;
          r7.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r11.xyz, r2.z).x;
          r5.w = r7.x * 0.125 + r5.w;
          r6.w = (int)r6.w + 1;
        }
      } else {
        r9.z = (uint)r0.y;
        r5.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r9.xyz, r2.z).x;
      }
      r0.y = r5.w * r5.w;
      r0.y = r0.y * r5.w;
    } else {
  ...
  r7.xyz = sunConstants.color.xyz * r2.www;
  r8.xyz = -v5.xyz * r3.www + sunConstants.wldDir.xyz;
  r0.y = dot(r8.xyz, r8.xyz);
  r0.y = rsqrt(r0.y);
  r8.xyz = r8.xyz * r0.yyy;
  r0.y = saturate(dot(r1.xyz, r8.xyz));
  r1.x = saturate(dot(r8.xyz, sunConstants.wldDir.xyz));
  r1.y = saturate(dot(r8.xyz, r6.xyz));
  r1.x = 1 + -r1.x;
  r1.z = r1.x * r1.x;
  r1.z = r1.z * r1.z;
  r1.x = r1.x * r1.z;
  r1.x = controlVar0.w * r1.x + controlVar0.z;
  r0.y = log2(r0.y);
  r2.zw = controlVar0.xy * r0.yy;
  r2.zw = exp2(r2.zw);
  r0.y = dot(r2.zw, controlVar1.xy);
  r1.x = r1.x * r1.w;
  r1.y = 12.566371 * r1.y;
  r1.x = r1.x / r1.y;
  r0.y = r1.x * r0.y;
  r1.x = r1.w + r1.w;
  r1.x = r1.w / r1.x;
  r4.xyz = r7.xyz * r0.yyy + r4.xyz;
  r1.xyz = r7.xyz * r1.xxx + r17.xyz;
  r6.xyz = r7.xyz * r1.www + r17.xyz;
  r1.xyz = r1.xyz * r3.xyz;
  r0.xyz = r6.xyz * r0.xzw + -r1.xyz;
