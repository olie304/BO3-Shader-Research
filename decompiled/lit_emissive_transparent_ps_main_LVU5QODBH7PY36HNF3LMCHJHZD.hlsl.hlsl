...
r0.y = samp0[]..swiz;
  ...
  r0.z = tintMask.Sample(colorSampler_s, v2.xy).x;
  ...
  r1.w = r2.y + -r2.x;
  r1.w = debugGlossOverride.w * r1.w + r2.x;
  r2.x = debugOcclusionOverride.x + -r0.w;
  r0.w = debugOcclusionOverride.w * r2.x + r0.w;
  ...
  r0.z = r0.z * r2.w + r6.w;
  r2.xyz = r2.xyz * r2.www + r15.xyz;
  r3.z = dot(r2.xyz, r2.xyz);
  r3.z = rsqrt(r3.z);
  r8.xyz = r3.zzz * r2.xyz;
  r2.y = r1.w * r2.w + r7.z;
  r3.xyz = r3.xyw * r2.www + r16.xyz;
  r0.x = saturate(r0.x);
  r0.x = hdrScale * r0.x;
  ...
  r5.z = 100 * r5.z;
  r7.yz = -r2.ww * float2(10,5) + float2(6.85740995,7.08500004);
  r5.w = exp2(r7.y);
  r5.w = r5.w * r2.x;
  r5.w = 9.1368103 * r5.w;
  r6.w = r3.w * r2.w;
  ...
  r28.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r9.yz, r7.y, l(96), t15.xxyx
  r9.y = samp0[]..swiz;
  r9.z = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
  ...
  if (r6.w == 0) {
    ...
    while (true) {
      ...
      bitmask.w = ((~(-1 << r7.z)) << 0) & 0xffffffff;  r12.w = (((uint)0 << 0) & bitmask.w) | ((uint)r9.w & ~bitmask.w);
    ...
    if (r7.w != 0) {
      ...
      while (true) {
        ...
        r14.z = cmp((int)r7.y == (int)r11.w);
        if (r7.z == 0) r14.w = 0; else if (r7.z+0 < 32) {         r14.w = (uint)r12.w << (32-(r7.z + 0)); r14.w = (uint)r14.w >> (32-r7.z);        } else r14.w = (uint)r12.w >> 0;
    ...
    if (r5.z != 0) {
      ...
      r21.xyz = r23.xyz * r2.www + r7.yzw;
      r13.w = 0;
      r7.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r13.xyzw, r3.w).xyz;
      r2.w = sunConstants.globalProbeExposure * r5.z + -r5.w;
      r2.w = r2.y * r2.w + r5.w;
      r22.xyz = r7.yzw * r2.www + r22.xyz;
    }
  } else {
    r22.x = r21.w;
  }
  ...
  r0.w = r2.w * r0.w;
  r2.y = r2.y * r2.w;
  r2.w = dot(r8.xyz, sunConstants.wldDir.xyz);
  r3.w = saturate(r2.w);
  r5.z = cmp(0 >= r3.w);
  if (r5.z != 0) {
    r5.w = 0;
  ...
  if (r5.z == 0) {
    ...
    if (r11.w == 0) {
      if (enableDitheredShadow == 0) {
        ...
        r16.z = r9.w + r6.w;
        r9.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r5.z).x;
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          r16.w = r13.w ? sunConstants.splitPinTransform[r6.w].w : sunConstants.splitPinTransform[r9.w].w;
          r13.w = r13.w ? r6.w : r9.w;
  ...
  if (r5.z != 0) {
    ...
    if (r5.z != 0) {
      ...
      if (sunConstants.sunCookieIndex != 0) {
        r10.w = 1;
        r6.w = dot(sunConstants.sunCookieTransform[0].xyzw, r10.xyzw);
      ...
      r18.w = samp0[]..swiz;
        ...
        if (r10.z == 0) {
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r10.z, r6.w, l(28), t12.xxxx
        r10.z = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
        ...
        r18.y = samp0[]..swiz;
          ...
          if (enableDitheredShadow != 0) {
            ...
            r16.z = (uint)r10.x;
            r10.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r6.w).x;
          }
          r6.w = r10.y * r10.y;
          r6.w = r6.w * r10.y;
        } else {
      ...
      r3.w = r5.w * r3.w;
      r3.w = 0.25 * r3.w;
      r16.xyz = r3.www * r9.yzw + r7.yzw;
      r0.y = saturate(1 + -r0.y);
      r5.z = r0.y * r0.y;
      r5.z = r5.z * r5.z;
      r0.y = r5.z * r0.y;
      r0.y = r3.w * r0.y;
      r17.xyz = r0.yyy * r9.zwy + r15.xyz;
      r10.w = r17.z;
      r14.w = r15.z;
      r14.xyzw = r2.wwww ? r10.xyzw : r14.xyzw;
      r17.zw = r16.xy;
      r15.zw = r7.yz;
      r10.xyzw = r2.wwww ? r17.xyzw : r15.xyzw;
            ...
            r40.w = samp0[]..swiz;
              ...
              if (r14.w != 0) {
                ...
                if (r14.w != 0) {
                  ...
                  r20.xyz = r20.xyz * r11.www + r12.xyz;
                  r11.w = dot(r20.xyz, r20.xyz);
                  r11.w = rsqrt(r11.w);
                  r20.xyz = r20.xyz * r11.www;
                  r11.w = dot(r20.xyz, r12.xyz);
                  r15.w = dot(r8.xyz, r20.xyz);
