...
// filmicHistoryTex1                 texture  float4          2d            t14      1 
// depthTex                          texture  float4          2d            t15      1 
...
sample_l_indexable(texture2d)(float,float,float,float) r0.x, r0.xyxx, t15.xyzw, s0, l(0.000000)
mad r1.xyzw, cb1[44].zwzw, l(-2.000000, -2.000000, -2.000000, 2.000000), v1.xyxy
sample_l_indexable(texture2d)(float,float,float,float) r0.y, r1.xyxx, t15.yxzw, s0, l(0.000000)
max r0.x, r0.y, r0.x
sample_l_indexable(texture2d)(float,float,float,float) r0.z, r1.zwzz, t15.yzxw, s0, l(0.000000)
max r0.x, r0.z, r0.x
mad r1.xyzw, cb1[44].zwzw, l(2.000000, -2.000000, -1.000000, 0.000000), v1.xyxy
sample_l_indexable(texture2d)(float,float,float,float) r0.w, r1.xyxx, t15.yzwx, s0, l(0.000000)
max r0.x, r0.w, r0.x
sample_l_indexable(texture2d)(float,float,float,float) r1.x, v1.xyxx, t15.xyzw, s0, l(0.000000)
max r0.x, r0.x, r1.x
eq r0.yzw, r0.xxxx, r0.yyzw
movc r0.y, r0.y, l(-2.000000), l(2.000000)
movc r0.yz, r0.zzzz, l(0,-2.000000,2.000000,0), r0.yyyy
movc r0.yz, r0.wwww, l(0,2.000000,-2.000000,0), r0.yyzy
eq r0.x, r0.x, r1.x
mul r0.yz, r0.yyzy, cb1[44].zzwz
movc r0.xy, r0.xxxx, l(0,0,0,0), r0.yzyy
...
sample_l_indexable(texture2d)(float,float,float,float) r2.xy, r1.xyxx, t12.xyzw, s0, l(0.000000)
add r2.zw, |r2.xxxy|, l(0.000000, 0.000000, -0.500000, -0.500000)
add_sat r2.zw, r2.zzzw, r2.zzzw
...
mad r2.zw, r2.zzzw, l(0.000000, 0.000000, 30.000000, 30.000000), r3.xxxy
ge r2.xy, r2.xyxx, l(0.000000, 0.000000, 0.000000, 0.000000)
movc r2.xy, r2.xyxx, r2.zwzz, -r2.zwzz
add r2.zw, v1.xxxy, cb8[0].xxxy
sample_l_indexable(texture2d)(float,float,float,float) r3.xyz, r2.zwzz, t0.xyzw, s0, l(0.000000)
add r2.zw, r1.xxxy, cb8[0].zzzw
sample_l_indexable(texture2d)(float,float,float,float) r4.xyz, r2.zwzz, t6.xyzw, s0, l(0.000000)
...
mul r6.xyz, r4.xyzx, l(0.00003052, 0.00003052, 0.00003052, 0.000000)
ishr r6.xyz, r6.xyzx, l(1, 1, 1, 0)
iadd r6.xyz, r6.xyzx, l(0x1fbd1df5, 0x1fbd1df5, 0x1fbd1df5, 0)
dp3 r5.y, r6.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
mad r2.zw, cb1[44].zzzw, r2.xxxy, -r0.zzzw
mad r2.zw, r2.zzzw, l(0.000000, 0.000000, 2.000000, 2.000000), r0.zzzw
gather4_aoffimmi_indexable(0,0,0)(texture2d)(float,float,float,float) r6.xyzw, r1.xyxx, t7.xyzw, s0.x
mad r5.zw, -cb1[44].zzzw, r2.xxxy, r1.xxxy
add r2.zw, -r2.zzzw, r5.zzzw
gather4_aoffimmi_indexable(0,0,0)(texture2d)(float,float,float,float) r7.xyzw, r2.zwzz, t10.xyzw, s0.x
add r6.xyzw, r6.xyzw, -r7.xyzw
dp4 r2.z, |r6.xyzw|, l(10.000000, 10.000000, 10.000000, 10.000000)
add r2.z, -r2.z, l(1.000000)
max r2.z, r2.z, l(0.000000)
sample_l_indexable(texture2d)(float,float,float,float) r2.w, r5.zwzz, t9.yzwx, s0, l(0.000000)
add r2.w, -r2.w, r5.x
mad r2.w, -|r2.w|, l(40.000000), l(1.000000)
max r2.w, r2.w, l(0.000000)
min r2.z, r2.w, r2.z
sample_l_indexable(texture2d)(float,float,float,float) r6.xyz, r1.zwzz, t0.xyzw, s0, l(0.000000)
mad r7.xyzw, cb1[44].zwzw, l(1.000000, 0.000000, 0.000000, 1.000000), v1.xyxy
sample_l_indexable(texture2d)(float,float,float,float) r8.xyz, r7.xyxx, t0.xyzw, s0, l(0.000000)
sample_l_indexable(texture2d)(float,float,float,float) r7.xyz, r7.zwzz, t0.xyzw, s0, l(0.000000)
mad r1.zw, cb1[44].zzzw, l(0.000000, 0.000000, 0.000000, -1.000000), v1.xxxy
sample_l_indexable(texture2d)(float,float,float,float) r9.xyz, r1.zwzz, t0.xyzw, s0, l(0.000000)
min r10.xyz, r7.xyzx, r9.xyzx
min r10.xyz, r8.xyzx, r10.xyzx
min r10.xyz, r6.xyzx, r10.xyzx
min r10.xyz, r3.xyzx, r10.xyzx
max r7.xyz, r7.xyzx, r9.xyzx
max r7.xyz, r7.xyzx, r8.xyzx
max r6.xyz, r6.xyzx, r7.xyzx
max r6.xyz, r3.xyzx, r6.xyzx
max r7.xyz, r4.xyzx, r10.xyzx
max r8.xyz, r4.xyzx, r6.xyzx
...
mul r0.xy, r0.zwzz, cb1[44].xyxx
sample_l_indexable(texture2d)(float,float,float,float) r3.xyz, r1.xyxx, t14.xyzw, s0, l(0.000000)
...
add r0.zw, -r5.xxxy, r0.zzzz
max r0.z, |r0.w|, |r0.z|
mad_sat r0.z, r0.z, l(6.66666651), l(-0.33333334)
dp2 r0.x, r0.xyxx, r0.xyxx
ishr r0.x, r0.x, l(1)
iadd r0.x, r0.x, l(0x1fbd1df5)
add_sat r0.x, -r0.x, l(40.000000)
min r0.x, r0.x, r0.z
...
if_nz r0.x
  ...
  add r4.zw, r4.xxxy, r4.xxxy
  mad r5.yz, r4.xxyx, l(0.000000, 2.000000, 2.000000, 0.000000), -r1.xxyx
  mad r5.yz, -r4.xxyx, r1.xxyx, r5.yyzy
  mad r4.zw, r4.xxxy, r1.xxxy, -r4.zzzw
  add r4.zw, r4.zzzw, l(0.000000, 0.000000, 1.000000, 1.000000)
  mad r6.xy, r1.xyxx, r1.xyxx, r1.xyxx
  mad r6.xy, -r4.xyxx, r1.xyxx, r6.xyxx
  mad r1.xy, r4.xyxx, r1.xyxx, -r4.xyxx
  add r1.zw, r1.zzzw, l(0.000000, 0.000000, 2.500000, 2.500000)
  add r4.xy, r4.zwzz, r6.xyxx
  div r4.zw, r6.xxxy, r4.xxxy
  add r3.xy, r3.xyxx, r4.zwzz
  mul r7.xy, r1.zwzz, cb1[44].zwzz
  mul r6.xyzw, r3.zyxw, cb1[44].zwzw
  sample_l_indexable(texture2d)(float,float,float,float) r3.xyz, r6.xwxx, t14.xyzw, s0, l(0.000000)
  mul r3.xyz, r5.yyyy, r3.xyzx
  sample_l_indexable(texture2d)(float,float,float,float) r8.xyz, r6.zwzz, t14.xyzw, s0, l(0.000000)
  mul r8.xyz, r4.xxxx, r8.xyzx
  mul r8.xyz, r5.zzzz, r8.xyzx
  mad r3.xyz, r3.xyzx, r5.zzzz, r8.xyzx
  mov r7.zw, r6.wwwy
  sample_l_indexable(texture2d)(float,float,float,float) r8.xyz, r7.xzxx, t14.xyzw, s0, l(0.000000)
  mul r8.xyz, r1.xxxx, r8.xyzx
  mad r3.xyz, r8.xyzx, r5.zzzz, r3.xyzx
  sample_l_indexable(texture2d)(float,float,float,float) r8.xyz, r6.xyxx, t14.xyzw, s0, l(0.000000)
  mul r8.xyz, r5.yyyy, r8.xyzx
  mad r3.xyz, r8.xyzx, r4.yyyy, r3.xyzx
  sample_l_indexable(texture2d)(float,float,float,float) r8.xyz, r6.zyzz, t14.xyzw, s0, l(0.000000)
  mul r8.xyz, r4.xxxx, r8.xyzx
  mad r3.xyz, r8.xyzx, r4.yyyy, r3.xyzx
  sample_l_indexable(texture2d)(float,float,float,float) r8.xyz, r7.xwxx, t14.xyzw, s0, l(0.000000)
  mul r8.xyz, r1.xxxx, r8.xyzx
  mad r3.xyz, r8.xyzx, r4.yyyy, r3.xyzx
  mov r6.y, r7.y
  sample_l_indexable(texture2d)(float,float,float,float) r4.yzw, r6.xyxx, t14.wxyz, s0, l(0.000000)
  mul r4.yzw, r5.yyyy, r4.yyzw
  mad r3.xyz, r4.yzwy, r1.yyyy, r3.xyzx
  sample_l_indexable(texture2d)(float,float,float,float) r4.yzw, r6.zyzz, t14.wxyz, s0, l(0.000000)
  mul r4.xyz, r4.xxxx, r4.yzwy
  mad r3.xyz, r4.xyzx, r1.yyyy, r3.xyzx
  sample_l_indexable(texture2d)(float,float,float,float) r4.xyz, r7.xyxx, t14.xyzw, s0, l(0.000000)
  ...
  ftou r0.z, r0.z
  ishl r0.yz, r0.yyzy, l(0, 12, 24, 0)
  or r0.y, r0.y, r0.z
  or r1.y, r0.x, r0.y
