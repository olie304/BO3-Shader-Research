...
// specularMapDetail2                texture  float4          2d            t22      1 
...
frc r1.xyz, r1.xyzx
mul r0.zw, r0.xxxy, cb0[12].zzzw
sample_indexable(texture2d)(float,float,float,float) r0.z, r0.zwzz, t20.yzxw, s5
...
sample_indexable(texture2d)(float,float,float,float) r1.w, r4.xyxx, t10.yzwx, s2
add r6.xyz, cb0[11].xyzx, l(-0.040000, -0.040000, -0.040000, 0.000000)
mad r6.xyz, r1.wwww, r6.xyzx, l(0.040000, 0.040000, 0.040000, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r3.w, r4.xyxx, t12.yzwx, s2
sample_indexable(texture2d)(float,float,float,float) r4.xyz, r4.xyxx, t15.xyzw, s3
...
sample_indexable(texture2d)(float,float,float,float) r7.xyzw, r1.xyxx, t19.xyzw, s1
sample_indexable(texture2d)(float,float,float,float) r1.z, r1.xyxx, t16.yzxw, s1
...
sample_indexable(texture2d)(float,float,float,float) r1.z, r1.xyxx, t22.yzxw, s2
add r8.xyz, cb0[17].xyzx, l(-0.040000, -0.040000, -0.040000, 0.000000)
mad r8.xyz, r1.zzzz, r8.xyzx, l(0.040000, 0.040000, 0.040000, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r2.z, r1.xyxx, t18.yzxw, s2
sample_indexable(texture2d)(float,float,float,float) r9.xyz, r1.xyxx, t17.xyzw, s3
add r7.xyzw, -r5.xyzw, r7.xyzw
mad r5.xyzw, r0.zzzz, r7.xyzw, r5.xyzw
mul r5.xyz, r5.xyzx, v8.xyzx
add r1.x, -r1.w, r1.z
mad r1.x, r0.z, r1.x, r1.w
add r1.yzw, -r6.xxyz, r8.xxyz
mad r1.yzw, r0.zzzz, r1.yyzw, r6.xxyz
add r1.x, -r1.x, l(1.000000)
mul r5.xyz, r1.xxxx, r5.xyzx
add r1.x, -cb0[12].x, cb0[12].y
mad r2.w, r3.w, r1.x, cb0[12].x
add r3.w, -cb0[15].x, cb0[15].y
mad r2.z, r2.z, r3.w, cb0[15].x
mul_sat r2.zw, r2.zzzw, l(0.000000, 0.000000, 0.05882353, 0.05882353)
add r2.z, -r2.w, r2.z
mad r2.z, r0.z, r2.z, r2.w
sample_indexable(texture2d)(float,float,float,float) r2.w, r0.xyxx, t14.yzwx, s4
mad r6.xy, r9.xyxx, l(1.99218750, 1.99218750, 0.000000, 0.000000), l(-1.000000, -1.000000, 0.000000, 0.000000)
mul r3.w, r9.z, r9.z
...
mad r7.w, r4.z, cb0[13].x, r0.w
mad r3.xy, r6.xyxx, cb0[13].yyyy, r2.xyxx
dp3 r2.x, r3.xyzx, r3.xyzx
rsq r2.x, r2.x
mul r4.xyz, r2.xxxx, r3.xyzx
mad r4.w, r3.w, cb0[13].y, r0.w
add r3.xyzw, -r7.xyzw, r4.xyzw
mad r3.xyzw, r0.zzzz, r3.xyzw, r7.xyzw
...
rsq r0.w, r0.w
mul r7.xyz, r0.wwww, v7.xyzx
mul r0.w, r2.z, l(-17.000000)
exp r0.w, r0.w
add r0.w, r0.w, r3.w
log r0.w, r0.w
mul_sat r0.w, r0.w, l(-0.05882353)
mul r2.xyz, r3.yyyy, r7.xyzx
...
if_nz r3.x
  ...
  movc r3.xyw, r0.xxxx, r4.xyxz, r3.xyxw
  movc r4.xyz, r3.zzzz, l(0,1.000000,0,0), r5.xyzx
  movc r5.xyz, r0.yyyy, r3.xywx, r4.xyzx
endif 
...
mad r4.z, cb1[63].w, r0.w, r2.w
mad r5.xyz, v5.xyzx, r0.zzzz, -r2.xyzx
...
and r0.yzw, r1.xxxx, r2.xxyz
mul o1.xyz, r0.xxxx, r0.yzwy
add r2.y, -r1.w, r1.y
mad r0.y, r2.y, l(0.500000), r1.w
add r2.z, -r0.y, r1.z
