// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:31:32 2021
...
cbuffer _Globals : register(b0)
{
  ...
  float4 tensionParms : packoffset(c11);
}
...
Texture2D<float4> stretchNormal : register(t12);
Texture2D<float4> compressNormal : register(t14);
  ...
  out float2 o3 : SV_TARGET3)
{
  ...
  r1.zw = saturate(tensionParms.ww * v7.xy);
  r1.zw = log2(r1.zw);
  r1.zw = tensionParms.zz * r1.zw;
  r1.zw = exp2(r1.zw);
  r2.x = cmp(r1.w < r1.z);
  r2.yzw = compressNormal.Sample(normalSampler_s, v2.xy).xyz;
  r3.xyz = stretchNormal.Sample(normalSampler_s, v2.xy).xyz;
  ...
  r5.xyz = debugColorOverride.www * r5.xyz + r0.xyz;
  r0.x = r1.y * 1 + -r1.x;
  r0.x = debugGlossOverride.w * r0.x + r1.x;
  r0.y = debugOcclusionOverride.x + -r0.w;
  o2.z = debugOcclusionOverride.w * r0.y + r0.w;
  r0.yzw = v8.xxx ? v3.xyz : -v3.xyz;
  r1.x = dot(r0.yzw, r0.yzw);
  r1.x = rsqrt(r1.x);
  r0.yzw = r0.yzw * r1.xxx + -r2.xyz;
  r2.yzw = debugNormalOverride.www * r0.yzw + r2.xyz;
  r0.y = thicknessMap.Sample(colorSampler_s, v2.xy).x;
  r0.y = saturate(r0.y);
  r0.y = 1 + -r0.y;
  r5.w = 0.5;
  r0.yzw = r5.xww * r0.yyy;
  r1.x = 1;
  r0.w = r5.z * r0.w;
  r1.yz = v6.xy / v6.ww;
