// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:27:02 2021
  ...
  out float2 o3 : SV_TARGET3)
{
  ...
  r2.y = dot(r3.xyz, r3.xyz);
  r2.y = rsqrt(r2.y);
  r3.yzw = r3.xyz * r2.yyy;
  r2.yw = tintScale.xy * v2.xy;
  r2.yw = tintBlendMask.Sample(tintBlendSampler_s, r2.yw).xy;
  ...
  r7.xyz = r6.xyz * r0.yzw;
  r0.x = velveteenMask.Sample(velveteenSampler_s, v2.xy).x;
  r2.y = waterRefractionAmount * r0.x;
  r2.y = cmp(0 < r2.y);
  r2.w = 17 * r2.x;
  r2.w = exp2(r2.w);
  r2.w = 2 + r2.w;
  ...
  r2.w = r4.w * r2.w;
  r2.w = exp2(r2.w);
  r0.x = saturate(-r0.x * waterRefractionAmount + 1);
  r0.x = r0.x + r2.w;
  r0.x = min(1, r0.x);
  r0.yzw = r0.yzw * r6.xyz + -r1.yzw;
  r0.yzw = r2.www * r0.yzw + r1.yzw;
  r6.xyz = r7.xyz * r0.xxx;
  o0.xyz = r2.yyy ? r6.xyz : r7.xyz;
  r0.xyz = r2.yyy ? r0.yzw : r1.yzw;
  r1.yz = v6.xy / v6.ww;
  r2.yw = float2(0.5,0.5) * renderTargetSize.xy;
  r6.x = r2.y * r1.y;
  r6.y = -r2.w * r1.z;
  ...
  r4.y = r3.w + -r3.y;
  r4.x = -r3.z * 3 + r4.z;
  r2.yzw = float3(0.408248305,0.707106769,0.577350259) * r4.xyz;
  r0.w = 1 + abs(r2.w);
  r0.w = rsqrt(r0.w);
  r2.yz = r2.yz * r0.ww;
  o1.xy = r2.yz * float2(0.588235319,0.588235319) + float2(0.5,0.5);
  o1.z = r2.x * 0.49755621 + 0.00146627566;
  r0.w = (uint)r3.x;
