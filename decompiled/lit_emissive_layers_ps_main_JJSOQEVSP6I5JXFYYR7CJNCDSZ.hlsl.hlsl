...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  r0.x = -r1.w * w1.x + debugAlphaOverride.x;
  ...
  if (r1.w != 0) {
    ...
    r12.x = dot(r9.xyz, r5.xyz);
    r12.y = dot(r9.xyz, r6.xyz);
    r1.w = dot(r9.xyz, r4.xyz);
    r3.w = cmp(0 < r1.w);
    r7.zw = -r12.xy / r1.ww;
    r7.zw = r3.ww ? r7.zw : 0;
    r8.zw = float2(-0.5,-0.5) + v2.xy;
  ...
  r3.w = frac(r3.w);
  r9.y = gameTime.w * flickerSpeed + r3.w;
  r9.x = flickerSeed.x;
  r3.w = flickerLookupMap.SampleLevel(lookupSampler_s, r9.xy, 0).x;
  r3.w = log2(abs(r3.w));
  ...
  if (r3.w != 0) {
    ...
    r6.y = r6.x;
    r6.z = r5.x;
    r12.x = dot(r6.yz, r4.xy);
    r6.x = -r5.x;
    r12.y = dot(r6.xy, r4.xy);
    r4.xy = gameTime.ww * scrollUVs3.xy;
    r4.xy = r4.xy * scaleUVs3.xy + r12.xy;
    r3.w = gameTime.w * zoomRate3;
    r3.w = cos(r3.w);
    r3.w = r3.w * 0.5 + 0.5;
    r3.w = 1 + -r3.w;
    r4.z = zoomUVs3.y + -zoomUVs3.x;
    r3.w = r3.w * r4.z + zoomUVs3.x;
    r4.xy = r4.xy / r3.ww;
  ...
  r1.w = clampV3 + r1.w;
  r1.w = frac(r1.w);
  r5.y = gameTime.w * clampV3 + r1.w;
  r5.x = clampV3;
  r1.w = flickerLookupMap.SampleLevel(lookupSampler_s, r5.xy, 0).x;
  r1.w = log2(abs(r1.w));
  r1.w = flickerPower3 * r1.w;
  r1.w = exp2(r1.w);
  r3.w = flickerRange3.y + -flickerRange3.x;
  r1.w = r1.w * r3.w + flickerRange3.x;
  ...
  r40.w = samp0[]..swiz;
    ...
    r29.xyz = r12.xyz * r15.xxx + r29.xyz;
  ...
  if (r7.z == 0) {
    ...
    while (true) {
      ...
      r13.z = cmp((int)r9.y == (int)r9.w);
      if (r9.z == 0) r13.w = 0; else if (r9.z+0 < 32) {       r13.w = (uint)r11.w << (32-(r9.z + 0)); r13.w = (uint)r13.w >> (32-r9.z);      } else r13.w = (uint)r11.w >> 0;
      r11.w = r13.z ? r13.w : r11.w;
    ...
    if (r6.z != 0) {
      ...
      r20.xyz = r22.xyz * r5.www + r9.yzw;
      r12.w = 0;
      r9.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r12.xyzw, r6.y).xyz;
      r5.w = sunConstants.globalProbeExposure * r6.z + -r2.w;
      r2.w = r0.y * r5.w + r2.w;
      r21.xyz = r9.yzw * r2.www + r21.xyz;
    }
  } else {
    r21.x = r20.w;
  }
  ...
  r6.yzw = r21.xyz * r2.www;
  r14.xyz = r6.zwy * r0.yyy;
  ...
  if (r7.z == 0) {
    ...
    if (r8.w != 0) {
      ...
      while (true) {
        ...
        if (r12.w != 0) break;
        r12.w = (uint)r8.w;
        r15.xy = -sunConstants.splitPinTransform[r12.w].xy + r9.yz;
        r15.x = max(abs(r15.x), abs(r15.y));
        r11.w = sunConstants.splitPinTransform[r12.w].z * r15.x;
        r12.w = cmp(r11.w < 1);
        if (r12.w != 0) {
          break;
        }
    ...
    r16.x = samp0[]..swiz;
      ...
      r18.w = samp0[]..swiz;
        ...
        r15.y = samp0[]..swiz;
          ...
          r15.y = r9.y * r15.z + r15.y;
          r15.x = r9.z * r15.x + r15.y;
    ...
    if (r12.w == 0) {
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          if (r16.z != 0) break;
          r16.z = cmp((uint)r11.w < (uint)r15.w);
          r17.xy = r16.zz ? r9.yz : r16.xy;
          r16.w = r16.z ? sunConstants.splitPinTransform[r8.w].w : sunConstants.splitPinTransform[r9.w].w;
          r16.z = r16.z ? r8.w : r9.w;
  ...
  if (r7.z != 0) {
    ...
    if (r7.z != 0) {
      ...
      r18.z = samp0[]..swiz;
      r18.w = samp0[]..swiz;
        r10.y = abs(r2.w) * -0.200000003 + 0.400000006;
        r19.xyz = r2.xyz * r10.yyy + v7.xyz;
        r19.w = 1;
        ...
        r16.y = samp0[]..swiz;
          ...
          if (enableDitheredShadow != 0) {
            ...
            r15.z = (uint)r10.y;
            r10.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r15.xyz, r8.w).x;
          }
          r8.w = r10.z * r10.z;
          r8.w = r8.w * r10.z;
        } else {
      ...
      r8.w = r8.w * r7.w;
      r2.w = cmp(0 < r2.w);
      r10.xyz = r8.www * r9.yzw + r13.xyz;
      r15.xyz = -v7.xyz * r0.www + sunConstants.wldDir.xyz;
      r0.w = dot(r15.xyz, r15.xyz);
      r0.w = rsqrt(r0.w);
      r15.xyz = r15.xyz * r0.www;
      r0.w = dot(r15.xyz, r5.xyz);
      r8.w = dot(r2.xyz, r15.xyz);
      r11.w = abs(r8.w) * r3.w + -abs(r8.w);
      ...
      r5.w = r7.w * r5.w;
      r5.w = 0.25 * r5.w;
      r15.xyz = r5.www * r9.yzw + r6.yzw;
      r0.w = saturate(1 + -r0.w);
      r7.z = r0.w * r0.w;
      r7.z = r7.z * r7.z;
      r0.w = r7.z * r0.w;
      r0.w = r5.w * r0.w;
      r16.xyz = r0.www * r9.zwy + r14.xyz;
      r10.w = r16.z;
      r13.w = r14.z;
      r13.xyzw = r2.wwww ? r10.xyzw : r13.xyzw;
      r16.zw = r15.xy;
      r14.zw = r6.yz;
      r10.xyzw = r2.wwww ? r16.xyzw : r14.xyzw;
              ...
              if (r24.w != 0) {
                ...
                if (r24.w != 0) {
                  ...
                  while (true) {
                    ...
                    if (r28.w != 0) break;
                    r43.y = dot(icb[r27.w+0].yx, r10.xy);
                    r43.z = dot(icb[r27.w+0].yx, r10.yz);
                      ...
                      r13.w = samp0[]..swiz;
                        ...
                        if (r7.w != 0) {
                          ...
                          while (true) {
                            ...
                            if (r27.w != 0) break;
                            r41.x = dot(icb[r25.w+0].xy, r8.xy);
                            r41.y = dot(icb[r25.w+0].yx, r8.xz);
            ...
            r39.w = samp0[]..swiz;
              ...
              if (r15.z != 0) {
                  ...
                  r39.y = samp0[]..swiz;
                    ...
                    if (r7.w != 0) {
                      ...
                      while (true) {
                        ...
                        r25.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r31.xyz, r11.w).x;
                        r18.x = r25.w * 0.125 + r18.x;
                        r24.w = (int)r24.w + 1;
                      }
                    } else {
                      r21.z = (uint)r15.z;
                      r18.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r21.xyz, r11.w).x;
                    }
                    r11.w = r18.x * r18.x;
                    r11.w = r11.w * r18.x;
                  } else {
                ...
                if (r15.z != 0) {
                  ...
                  r11.w = r14.w * r11.w;
                  r11.w = 0.25 * r11.w;
                  r19.xyz = r11.www * r20.xyw + r30.xyz;
                  r12.w = saturate(1 + -r12.w);
                  r14.w = r12.w * r12.w;
                  r14.w = r14.w * r14.w;
                  r12.w = r14.w * r12.w;
                  r11.w = r12.w * r11.w;
                  r20.xyw = r11.www * r20.xyw + r29.xyz;
