...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  r7.zw = (uint2)r0.wy;
  r1.w = dot(r7.wz, float2(0.0671105608,0.00583714992));
  r1.w = frac(r1.w);
  r1.w = 52.9829178 * r1.w;
  r1.w = frac(r1.w);
  r1.w = r1.w * 6.28318548 + gameTick.w;
  sincos(r1.w, r8.x, r9.x);
  r1.w = dot(r7.zw, float2(0.0671105608,0.00583714992));
  r1.w = frac(r1.w);
  r1.w = 52.9829178 * r1.w;
  r1.w = frac(r1.w);
  r1.w = r1.w * 6.28318548 + gameTick.w;
  ...
  r0.z = min(15, r0.z);
  r0.z = (uint)r0.z;
  r13.xy = (uint2)r0.yw >> int2(6,6);
  r13.z = (uint)r0.z << 4;
  r0.y = (int)r7.w & -32;
  r0.z = (int)-r0.y + (int)r7.w;
  r0.w = numRefProbes & -32;
  r8.z = (int)-r0.w + numRefProbes;
  r14.xy = float2(0,0);
  r15.w = 0;
  r16.yz = float2(0,1);
  r17.xy = float2(0,0);
  ...
  while (true) {
    ...
    r10.y = cmp((int)r0.y == (int)r8.w);
    bitmask.z = ((~(-1 << r0.z)) << 0) & 0xffffffff;  r10.z = (((uint)0 << 0) & bitmask.z) | ((uint)r9.w & ~bitmask.z);
    r9.w = r10.y ? r10.z : r9.w;
    r10.y = cmp((int)r0.w == (int)r8.w);
  ...
  if (r0.w != 0) {
    ...
    while (true) {
      ...
      if (r0.z == 0) r11.y = 0; else if (r0.z+0 < 32) {       r11.y = (uint)r8.w << (32-(r0.z + 0)); r11.y = (uint)r11.y >> (32-r0.z);      } else r11.y = (uint)r8.w >> 0;
  ...
  if (r0.z != 0) {
    ...
    r14.xyz = r21.xyz * r0.yyy + r11.yzw;
    r12.w = 0;
    ...
    r0.y = r7.y * r0.y + r0.w;
    r10.yzw = r11.yzw * r0.yyy + r10.yzw;
  }
  r0.yz = r7.xy * float2(0.984375,0.984375) + float2(0.0078125,0.0078125);
  r0.yz = gEnvBRDFGeneric.SampleLevel(samplerLinear_s, r0.yz, 0).xy;
  r15.xyz = r10.zwy * r0.yyy;
  ...
  if (noReceiveShadow == 0) {
    ...
    if (r5.w == 0) {
      r7.yzw = sunConstants.sstLightingConstants.offToPinTransform._m10_m11_m12 * v7.yyy;
      r7.yzw = v7.xxx * sunConstants.sstLightingConstants.offToPinTransform._m00_m01_m02 + r7.yzw;
      r7.yzw = v7.zzz * sunConstants.sstLightingConstants.offToPinTransform._m20_m21_m22 + r7.yzw;
      r7.yzw = sunConstants.sstLightingConstants.offToPinTransform._m30_m31_m32 + r7.yzw;
      r5.w = -sunConstants.splitDepthOffset + r7.w;
      ...
      if (r8.z != 0) {
        ...
        while (true) {
          ...
          r8.w = sunConstants.splitPinTransform[r9.w].z * r10.y;
          r9.w = cmp(r8.w < 1);
          if (r9.w != 0) {
            break;
          }
      ...
      if (r9.w != 0) {
        ...
        r16.xz = rcp(r10.yy);
        r16.y = -r16.z;
        r10.yzw = r7.yzy * r16.xyz + r10.zwz;
        r11.yzw = sunConstants.sstLightingConstants.constants.dimensionInTiles.xyx + float3(-0.0078125,-0.0078125,-0.0078125);
        r10.yzw = max(float3(0,0,0), r10.yzw);
        r10.yzw = min(r10.yzw, r11.yzw);
        r11.yz = sunConstants.sstLightingConstants.coordScale * r10.wz;
        r11.yz = floor(r11.yz);
        r11.z = sunConstants.sstLightingConstants.constants.dimensionInTiles.x * r11.z;
        r11.y = r11.z * sunConstants.sstLightingConstants.coordScale + r11.y;
        r11.y = (uint)r11.y;
        r11.y = (int)r11.y + (int10)sunConstants.sstLightingConstants.rootOffset;
      // Known bad code for instruction (needs manual fix):
      ...
      r11.z = samp0[]..swiz;
        ...
        r12.w = (uint)r11.z << 2;
        if (r11.w == 0) {
          r11.w = (int)r11.z & 0x01ffffff;
          r16.x = (int)r11.w + (int)r11.y;
          r11.y = (uint)r11.z >> 25;
          r11.y = (uint)r11.y;
        ...
        r13.w = samp0[]..swiz;
          r11.z = r11.z ? r16.z : r13.w;
          r13.w = (uint)r11.z >> 13;
          r11.y = r11.y ? r13.w : r11.z;
          r11.y = (int)r11.y & 8191;
          r17.x = (int)r11.y + (int)r16.x;
        // Known bad code for instruction (needs manual fix):
        ...
        r17.z = samp0[]..swiz;
          ...
          r11.yz = (uint2)r10.wz >> (uint2)r18.yy;
          r11.yz = (int2)r11.yz & int2(1,1);
        ...
        r16.w = samp0[]..swiz;
          r11.z = r11.z ? r17.z : r16.w;
          r16.w = (uint)r11.z >> 13;
          r11.y = r11.y ? r16.w : r11.z;
          r11.y = (int)r11.y & 8191;
          r18.x = (int)r11.y + (int)r17.x;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r18.w, r18.x, l(0), t23.xxxx
        r18.w = samp0[]..swiz;
          r17.xyz = r13.www ? r17.xyz : r18.xzw;
          r11.yzw = r11.www ? r16.xyz : r17.xyz;
          r13.w = (int)r11.w & 0xc0000000;
          if (r13.w == 0) {
            r13.w = (int)-r11.z + 6;
            r16.xy = (uint2)r10.wz >> (uint2)r13.ww;
            ...
            r16.x = (int)r16.x * 10;
            r13.w = (uint)r13.w >> (uint)r16.x;
            r13.w = (int)r13.w & 1023;
            r16.x = (int)r11.y + (int)r13.w;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r16.w, r16.x, l(0), t23.xxxx
          r16.w = samp0[]..swiz;
            r16.yz = (int2)r11.zz + int2(1,2);
            r11.z = (int)-r16.y + 6;
            r17.xy = (uint2)r10.wz >> (uint2)r11.zz;
            r11.z = (int)r16.w & 0xc0000000;
          ...
          r17.z = samp0[]..swiz;
            r17.y = r16.z;
            r17.xyz = r11.zzz ? r16.xyw : r17.xyz;
            r13.w = (int)-r17.y + 6;
            r16.yz = (uint2)r10.wz >> (uint2)r13.ww;
            r13.w = (int)r17.z & 0xc0000000;
          ...
          r18.y = samp0[]..swiz;
            r16.yz = r13.ww ? r17.xz : r18.xy;
            r11.yw = r11.zz ? r16.xw : r16.yz;
          }
          r11.z = (int)r11.w & 0xc0000000;
          if (r11.z == 0) {
            if (14 == 0) r13.w = 0; else if (14+15 < 32) {             r13.w = (uint)r11.w << (32-(14 + 15)); r13.w = (uint)r13.w >> (32-14);            } else r13.w = (uint)r11.w >> 15;
            r13.w = (uint)r13.w;
            r13.w = sunConstants.sstLightingConstants.constants.spanInInches * r13.w;
            r13.w = 6.10388815e-05 * r13.w;
            r16.xy = (int2)r11.ww & int2(32767,536870912);
            r16.x = (uint)r16.x;
            r16.x = sunConstants.sstLightingConstants.constants.spanInInches * r16.x;
            r16.x = 3.05185094e-05 * r16.x;
            r16.z = (int)r10.z & 3;
            r16.z = (int)r11.y + (int)r16.z;
            r16.z = (int)r16.z + 1;
          // Known bad code for instruction (needs manual fix):
          ...
          r16.z = samp0[]..swiz;
            ...
            r10.y = (uint)r16.z >> (uint)r17.x;
            r10.y = (int)r10.y & 255;
            r10.y = (uint)r10.y;
            r10.y = r10.y * r16.x;
            r10.y = r10.y * 0.00392156886 + r13.w;
            r10.z = (int)r17.y + 1;
          ...
          r10.z = samp0[]..swiz;
            ...
            r10.z = (uint)r10.z;
            r10.z = r10.z * r16.x;
            r10.z = r10.z * 1.52590219e-05 + r13.w;
            r12.w = r16.y ? r10.y : r10.z;
          } else {
            r10.y = (int)r11.w & 0x80000000;
            r10.z = (int)r11.y + 1;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r10.z, r10.z, l(0), t23.xxxx
          r10.z = samp0[]..swiz;
      ...
      if (r9.w == 0) {
        if (enableDitheredShadow == 0) {
          ...
          r16.z = r8.z + r7.w;
          r7.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r5.w).x;
        ...
        if (enableDitheredShadow != 0) {
          ...
          r7.yz = -sunConstants.splitPinTransform[r8.z].xy + r7.yz;
          r7.yz = sunConstants.splitPinTransform[r8.z].zz * r7.yz;
          ...
          r10.w = 0;
          while (true) {
            r11.y = cmp((uint)r10.w >= 8);
            if (r11.y != 0) break;
            r11.y = cmp((uint)r8.w < (uint)r10.w);
            r11.zw = r11.yy ? r7.yz : r10.yz;
            r12.w = r11.y ? sunConstants.splitPinTransform[r8.z].w : sunConstants.splitPinTransform[r7.w].w;
            r11.y = r11.y ? r8.z : r7.w;
            r17.x = dot(icb[r10.w+0].yx, r16.xy);
            r17.y = dot(icb[r10.w+0].yx, r16.yz);
            r17.xy = r17.xy * r12.ww + r11.zw;
            r11.y = (int)r11.y + (int16)sunConstants.splitArrayOffset;
            r17.z = (uint)r11.y;
            r11.y = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r17.xyz, r5.w).x;
            r11.z = gTransShadowmapArray.SampleLevel(samp0_s, r17.xyz, 0).x;
            r11.y = r11.y + r11.z;
            r11.y = saturate(-1 + r11.y);
            r9.w = r11.y * 0.125 + r9.w;
            r10.w = (int)r10.w + 1;
          }
          r5.w = r9.w * r9.w;
          r6.w = r5.w * r9.w;
    ...
    if (r7.y != 0) {
      ...
      if (noReceiveShadow == 0) {
        ...
        r19.w = samp0[]..swiz;
          ...
          r16.xy = cmp(r8.zw >= r16.xy);
          r11.yz = cmp(r11.yz >= r8.zw);
          r11.yz = (int2)r11.yz | (int2)r16.xy;
          r9.w = (int)r11.z | (int)r11.y;
          if (r9.w == 0) {
          // Known bad code for instruction (needs manual fix):
          ...
          r11.z = samp0[]..swiz;
            ...
            if (enableDitheredShadow != 0) {
              ...
              r9.w = 0;
              while (true) {
                r11.y = cmp((int)r9.w >= 8);
                if (r11.y != 0) break;
                r19.x = dot(icb[r9.w+0].yx, r17.xy);
                r19.y = dot(icb[r9.w+0].yx, r17.yz);
                r18.xy = r19.xy * r7.ww + r16.xy;
                r11.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r18.xyz, r7.z).x;
                r8.w = r11.y * 0.125 + r8.w;
                r9.w = (int)r9.w + 1;
              }
            } else {
              r16.z = (uint)r8.z;
              r8.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r7.z).x;
            }
            r7.z = r8.w * r8.w;
            r7.z = r7.z * r8.w;
          } else {
      ...
      r7.z = r7.z + -abs(r5.w);
      r7.z = r2.w * r7.z + abs(r5.w);
      r7.z = r7.z * r6.w;
      r7.w = cmp(0 < r5.w);
      r16.xyz = r7.zzz * r10.yzw + r14.xyz;
      r5.w = saturate(r5.w);
      r11.yzw = -v7.xyz * r1.yyy + sunConstants.wldDir.xyz;
      r1.y = dot(r11.yzw, r11.yzw);
      r1.y = rsqrt(r1.y);
      r11.yzw = r11.yzw * r1.yyy;
      r1.y = dot(r11.yzw, r4.xyz);
      r7.z = dot(r3.xyz, r11.yzw);
      r8.z = abs(r7.z) * r1.w + -abs(r7.z);
      r7.z = abs(r7.z) * r8.z + 1;
      r8.z = r5.w * r3.w + r4.w;
      r7.z = r7.z * r7.z;
      r7.z = r7.z * r8.z;
      r7.z = rcp(r7.z);
      ...
      r16.w = r17.z;
      r14.w = r15.z;
      r14.xyzw = r7.wwww ? r16.xyzw : r14.xyzw;
      r17.zw = r11.yz;
      r15.zw = r0.yz;
      r16.xyzw = r7.wwww ? r17.xyzw : r15.xyzw;
      r0.w = r7.w ? r11.w : r0.w;
      r15.z = r14.w;
      r15.xy = r16.xy;
      r0.yz = r16.zw;
    }
  ...
  while (true) {
    ...
    if (r8.z != 0) break;
    r7.z = (uint)r7.w >> 5;
    r17.xyz = (int3)r7.xyz + (int3)r13.xyz;
              ...
              if (r25.w != 0) {
                ...
                if (r25.w != 0) {
                  ...
                  while (true) {
                    ...
                    if (r29.w != 0) break;
                    r43.y = dot(icb[r28.w+0].yx, r16.xy);
                    r43.z = dot(icb[r28.w+0].yx, r16.yz);
                ...
                if (r25.w != 0) {
                  r25.w = r32.x * r1.w;
                  r25.w = 0.25 * r25.w;
                  r26.w = dot(r38.xyz, r12.xyz);
                  r28.w = dot(r12.xyz, r40.xyz);
                      ...
                      r13.w = samp0[]..swiz;
                        ...
                        if (r8.z != 0) {
                          ...
                          while (true) {
                            ...
                            if (r28.w != 0) break;
                            r41.x = dot(icb[r26.w+0].xy, r9.xy);
                            r41.y = dot(icb[r26.w+0].yx, r9.xz);
                  ...
                  r19.x = dot(r3.xyz, r38.xyz);
                  r21.w = abs(r19.x) * r1.w + -abs(r19.x);
                  r19.x = abs(r19.x) * r21.w + 1;
                  r21.w = r13.w * r3.w + r4.w;
                  r19.x = r19.x * r19.x;
                  r19.x = r19.x * r21.w;
                  r19.x = rcp(r19.x);
                  r13.w = r13.w * r25.w;
            ...
            r39.w = samp0[]..swiz;
              ...
              if (r14.w != 0) {
                  ...
                  r39.y = samp0[]..swiz;
                    ...
                    if (r8.z != 0) {
                      ...
                      while (true) {
                        ...
                        r26.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r31.xyz, r9.w).x;
                        r19.x = r26.w * 0.125 + r19.x;
                        r25.w = (int)r25.w + 1;
                      }
                    } else {
                      r22.z = (uint)r14.w;
                      r19.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r22.xyz, r9.w).x;
                    }
                    r9.w = r19.x * r19.x;
                    r9.w = r9.w * r19.x;
                  } else {
                ...
                if (r14.w != 0) {
                  ...
                  r37.w = samp0[]..swiz;
                    ...
                    r31.y = samp0[]..swiz;
                      ...
                      if (r8.z != 0) {
                        ...
                        r32.z = (uint)r22.y;
                        r22.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r32.xyz, r15.w).x;
                      }
                      r15.w = r22.z * r22.z;
                      r15.w = r15.w * r22.z;
                    } else {
                    ...
                    r36.w = samp0[]..swiz;
                      ...
                      r24.z = samp0[]..swiz;
                        ...
                        if (r8.z != 0) {
                          ...
                          r31.z = (uint)r22.y;
                          r24.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r31.xyz, r15.w).x;
                        }
                        r15.w = r24.x * r24.x;
                        r15.w = r15.w * r24.x;
                      } else {
                  ...
                  r15.w = -abs(r13.w) * r5.w + 1;
                  r15.w = r15.w * r15.w;
                  r15.w = -r15.w * 0.620000005 + 0.620000005;
                  r15.w = r15.w + -abs(r13.w);
                  r15.w = r2.w * r15.w + abs(r13.w);
                  r15.w = r15.w * r9.w;
                  r22.x = cmp(0 < r13.w);
                  r23.xyz = r15.www * r21.xyw + r11.yzw;
                  r13.w = saturate(r13.w);
                  r20.xyz = r20.xyz * r12.www + r4.xyz;
                  r12.w = dot(r20.xyz, r20.xyz);
                  r12.w = rsqrt(r12.w);
                  r20.xyz = r20.xyz * r12.www;
                  r12.w = dot(r20.xyz, r4.xyz);
                  r15.w = dot(r3.xyz, r20.xyz);
                  r20.x = abs(r15.w) * r1.w + -abs(r15.w);
  ...
  r0.yzw = float3(0.959999979,0.959999979,0.959999979) * r28.xyz;
  r0.yzw = r29.xyz * float3(0.0399999991,0.0399999991,0.0399999991) + r0.yzw;
  r0.yzw = r10.yzw * r2.xyz + r0.yzw;
  r1.y = 1 + -coolingFactor;
  r1.y = r1.y * r0.x;
  r1.xzw = r5.xyz * r1.xxx + -r6.xyz;
  r1.xyz = r1.yyy * r1.xzw + r6.xyz;
