...
if_nz r7.z
  ...
  if_nz r7.z
    ...
    mad r16.xyz, r7.yyyy, r10.yzwy, r2.xyzx
    add_sat r0.z, -r0.z, l(1.000000)
    mul r7.z, r0.z, r0.z
    mul r7.z, r7.z, r7.z
    mul r0.z, r0.z, r7.z
    mul r0.z, r0.z, r7.y
    mad r17.xyz, r0.zzzz, r10.zwyz, r14.xyzx
    mov r15.w, r17.z
    mov r13.w, r14.z
          ...
          if_nz r26.w
            ...
            if_nz r26.w
              ...
              if_nz r26.w
                ...
                mad r14.w, -r25.w, r0.x, l(1.000000)
          ...
          if_nz r16.w
            ...
            if_nz r16.w
              ...
              if_nz r16.w
                ...
                mad r19.x, -r16.z, r0.x, l(1.000000)
                mul r19.x, r19.x, r19.x
...
ret 
// Approximately 2798 instruction slots used
