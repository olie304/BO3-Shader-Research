...
r0.y = samp0[]..swiz;
  ...
  r16.w = 0;
  r15.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r16.xyzw, r4.w).xyz;
    ...
    switch (r8.w) {
      ...
      if (r18.w != 0) {
        ...
        if (r18.w != 0) {
          ...
          r18.w = cmp(0 < r13.w);
          if (r18.w != 0) {
            r18.w = lightConstantsCB[r7.w].data[1].z * r1.w;
            r18.w = 0.25 * r18.w;
            ...
            r16.w = dot(r12.xyz, r20.yzw);
            r17.w = abs(r16.w) * r1.w + -abs(r16.w);
            r16.w = abs(r16.w) * r17.w + 1;
            r17.w = r10.w * r2.y + r4.w;
            r16.w = r16.w * r16.w;
            r16.w = r16.w * r17.w;
            r16.w = rcp(r16.w);
            r10.w = r10.w * r18.w;
            ...
            r15.yzw = r12.www ? r34.xyz : r15.yzw;
      ...
      if (r13.w != 0) {
        ...
        if (r16.w != 0) {
          ...
          r17.w = r17.w / r18.w;
          r17.w = min(1, r17.w);
          r21.yz = saturate(r13.ww * lightConstantsCB[r7.w].data[2].xz + lightConstantsCB[r7.w].data[2].yw);
        ...
        if (r13.w != 0) {
          ...
          r16.w = cmp(0 < r13.w);
          if (r16.w != 0) {
            r16.w = lightConstantsCB[r7.w].data[1].z * r1.w;
            r16.w = r16.w * r12.w;
            ...
            r7.w = r7.w * r13.w;
            r10.w = cmp(0 < r10.w);
            r24.xyw = r7.www * r20.yzw + r15.yzw;
            ...
            r18.w = abs(r9.w) * r1.w + -abs(r9.w);
            r9.w = abs(r9.w) * r18.w + 1;
            r12.w = r12.w * r2.y + r4.w;
            r9.w = r9.w * r9.w;
            r9.w = r9.w * r12.w;
            r9.w = rcp(r9.w);
            r9.w = r9.w * r16.w;
            ...
            r15.yzw = r10.www ? r24.xyw : r15.yzw;
