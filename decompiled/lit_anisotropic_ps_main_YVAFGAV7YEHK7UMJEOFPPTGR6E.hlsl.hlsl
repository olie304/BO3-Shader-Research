...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  if (r6.w != 0) {
    ...
    if (r6.w != 0) {
      ...
      r1.w = cmp(0 < r1.w);
      r14.xyz = -v6.xyz * r3.xxx + sunConstants.wldDir.xyz;
