// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:32:46 2021
...
r1.w = samp0[]..swiz;
  r6.zw = (int2)r1.ww & int2(268435456,536870912);
  if (r6.z != 0) {
    ...
    while (true) {
      ...
      r5.w = visibleDecals.Load(r12.xyzw).x;
      r6.z = cmp((int)r1.w == (int)r4.w);
      if (r3.w == 0) r7.w = 0; else if (r3.w+0 < 32) {       r7.w = (uint)r5.w << (32-(r3.w + 0)); r7.w = (uint)r7.w >> (32-r3.w);      } else r7.w = (uint)r5.w >> 0;
      r5.w = r6.z ? r7.w : r5.w;
      r6.z = (int)r0.y + (int)r4.w;
      r17.xyzw = r13.xzwy;
      r12.xyz = r14.xyz;
      r18.yz = r15.yz;
      r19.xy = r16.xy;
  ...
  if (r6.w != 0) {
    ...
    while (true) {
      ...
      r8.w = cmp((int)r3.w == (int)r6.w);
      bitmask.w = ((~(-1 << r4.w)) << 0) & 0xffffffff;  r10.w = (((uint)0 << 0) & bitmask.w) | ((uint)r7.w & ~bitmask.w);
            ...
            r28.w = samp0[]..swiz;
              ...
              r25.w = samp0[]..swiz;
                ...
                if (r24.y != 0) {
                  ...
                  r26.xyz = r27.xyz * r2.yyy;
                  r24.xyz = r24.xyz * r2.yyy;
                  r25.xyz = r25.xyz * r2.yyy;
                  r16.w = -17 * r13.z;
                  r16.w = exp2(r16.w);
                  r15.w = r16.w + r15.w;
                  r15.w = log2(r15.w);
  ...
  r2.xyz = r2.xzw * r0.yyy + r15.xyz;
  r0.z = dot(r2.xyz, r2.xyz);
  r0.z = rsqrt(r0.z);
  r2.xyz = r2.xyz * r0.zzz;
  r7.y = r0.w * r0.y + r13.y;
  ...
  if (r0.z != 0) {
    ...
    r11.y = r11.x;
    r11.z = r10.x;
    r12.x = dot(r11.yz, r0.zw);
    r11.x = -r10.x;
    r12.y = dot(r11.xy, r0.zw);
    r0.zw = gameTime.ww * scrollUVs.xy;
    r0.zw = r0.zw * scaleUVs.xy + r12.xy;
    ...
    r6.zw = saturate(r0.zw);
    r9.xy = clampU ? r6.zw : r0.zw;
  }
  ...
  r0.z = v2.x + v2.y;
  r0.z = v2.z + r0.z;
  r0.w = flickerSeed.y + r0.z;
  r0.w = frac(r0.w);
  r10.y = gameTime.w * flickerSpeed + r0.w;
  r10.x = flickerSeed.x;
  r0.w = flickerLookupMap.SampleLevel(lookupSampler_s, r10.xy, 0).x;
  r0.w = log2(abs(r0.w));
  ...
  r0.w = cmp(0.5 < uvMotionToggle2);
  if (r0.w != 0) {
    r0.w = columnCount2 * rowCount2;
    r1.w = imageTime2 * r0.w;
    ...
    r0.w = r1.w * r0.w;
    r0.w = round(r0.w);
    r1.w = r0.w / columnCount2;
    r3.w = columnCount2 * r0.w;
    r3.w = cmp(r3.w >= -r3.w);
    ...
    r0.w = trunc(r0.w);
    r0.w = w1.x + r0.w;
    r10.x = r0.w / columnCount2;
    r0.w = trunc(r1.w);
    r0.w = w1.y + r0.w;
    r10.y = r0.w / rowCount2;
  } else {
    r0.w = dot(-v6.xyz, -v6.xyz);
    r0.w = rsqrt(r0.w);
    r11.xyz = -v6.xyz * r0.www;
    ...
    r0.w = gameTime.w * zoomRate2;
    r0.w = cos(r0.w);
    r0.w = r0.w * 0.5 + 0.5;
    r0.w = 1 + -r0.w;
    r1.w = zoomUVs2.y + -zoomUVs2.x;
    r0.w = r0.w * r1.w + zoomUVs2.x;
    r6.zw = r6.zw / r0.ww;
  ...
  r0.w = clampV2 + r0.z;
  r0.w = frac(r0.w);
  r11.y = gameTime.w * clampV2 + r0.w;
  r11.x = clampV2;
  r0.w = flickerLookupMap.SampleLevel(lookupSampler_s, r11.xy, 0).x;
  r0.w = log2(abs(r0.w));
  r0.w = flickerPower2 * r0.w;
  r0.w = exp2(r0.w);
  r1.w = flickerRange2.y + -flickerRange2.x;
  r0.w = r0.w * r1.w + flickerRange2.x;
  r10.xyz = r10.xyz * r0.www;
  r0.w = 1 + -r10.w;
  r9.xyz = r9.xyz * r0.www + r10.xyz;
  r0.w = cmp(0.5 < uvMotionToggle3);
  if (r0.w != 0) {
    r0.w = columnCount3 * rowCount3;
    r1.w = imageTime3 * r0.w;
    r3.w = gameTime.w * r1.w;
    r3.w = cmp(r3.w >= -r3.w);
    r3.w = r3.w ? r1.w : -r1.w;
    r4.w = 1 / r3.w;
    ...
    r0.w = r1.w * r0.w;
    r0.w = round(r0.w);
    r1.w = r0.w / columnCount3;
    r3.w = columnCount3 * r0.w;
    r3.w = cmp(r3.w >= -r3.w);
    ...
    r0.w = trunc(r0.w);
    r0.w = w1.x + r0.w;
    r10.x = r0.w / columnCount3;
    r0.w = trunc(r1.w);
    r0.w = w1.y + r0.w;
    r10.y = r0.w / rowCount3;
  } else {
    r0.w = dot(-v6.xyz, -v6.xyz);
    r0.w = rsqrt(r0.w);
    r11.xyz = -v6.xyz * r0.www;
    ...
    r0.w = gameTime.w * zoomRate3;
    r0.w = cos(r0.w);
    r0.w = r0.w * 0.5 + 0.5;
    r0.w = 1 + -r0.w;
    r1.w = zoomUVs3.y + -zoomUVs3.x;
    r0.w = r0.w * r1.w + zoomUVs3.x;
    r3.xy = r3.xy / r0.ww;
  ...
  r0.z = exp2(r0.z);
  r0.w = flickerRange3.y + -flickerRange3.x;
  r0.z = r0.z * r0.w + flickerRange3.x;
  ...
  r7.x = saturate(dot(r2.xyz, r3.xyz));
  r4.y = dot(-r3.xyz, r2.xyz);
  r4.y = r4.y + r4.y;
  r11.xyz = r2.xyz * -r4.yyy + -r3.xyz;
  r4.y = 17 * r7.y;
  r4.y = exp2(r4.y);
  r4.y = 2 + r4.y;
  r4.y = 2 / r4.y;
  ...
  r12.z = (uint)r0.x << 4;
  r0.x = (int)r6.w & -32;
  r6.x = (int)-r0.x + (int)r6.w;
  r6.y = numRefProbes & -32;
  r7.z = (int)-r6.y + numRefProbes;
  r13.xy = float2(0,0);
  r14.w = 0;
  r15.yz = float2(0,1);
  r16.xy = float2(0,0);
  ...
  while (true) {
    ...
    bitmask.y = ((~(-1 << r6.x)) << 0) & 0xffffffff;  r10.y = (((uint)0 << 0) & bitmask.y) | ((uint)r8.w & ~bitmask.y);
    r8.w = r9.w ? r10.y : r8.w;
    r9.w = cmp((int)r6.y == (int)r7.w);
  ...
  if (r6.y != 0) {
    ...
    while (true) {
      ...
      if (r6.x == 0) r9.w = 0; else if (r6.x+0 < 32) {       r9.w = (uint)r7.w << (32-(r6.x + 0)); r9.w = (uint)r9.w >> (32-r6.x);      } else r9.w = (uint)r7.w >> 0;
      r7.w = r8.w ? r9.w : r7.w;
  ...
  if (r4.w != 0) {
    ...
    r6.xyz = r20.xyz * r0.xxx + r13.xyz;
    r11.w = 0;
    r13.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r11.xyzw, r5.z).xyz;
    r0.x = sunConstants.globalProbeExposure * r4.w + -r2.w;
    r0.x = r7.y * r0.x + r2.w;
    r10.yzw = r13.xyz * r0.xxx + r10.yzw;
  }
  r5.zw = r7.xy * float2(0.984375,0.984375) + float2(0.0078125,0.0078125);
  r5.zw = gEnvBRDFGeneric.SampleLevel(samplerLinear_s, r5.zw, 0).xy;
  r13.xyz = r10.zwy * r5.zzz;
  r7.yzw = r10.yzw * r5.www;
  r0.x = sqrt(r4.z);
  r0.x = r0.x * 0.5 + 0.5;
  r0.x = r0.x * r0.x;
  r2.w = 0.5 * r0.x;
  ...
  if (r5.w == 0) {
    ...
    if (r12.w == 0) {
      if (enableDitheredShadow == 0) {
        ...
        r14.z = r10.w + r9.w;
        r10.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r14.xyz, r5.w).x;
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          r16.z = (uint)r15.z;
          r15.z = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r5.w).x;
  ...
  if (r5.w != 0) {
    ...
    if (r5.w != 0) {
      ...
      r1.w = dot(r15.xyz, r3.xyz);
      r9.w = dot(r2.xyz, r15.xyz);
      r11.w = abs(r9.w) * r4.y + -abs(r9.w);
      ...
      r5.z = r8.w * r5.z;
      r5.z = 0.25 * r5.z;
      r15.xyz = r5.zzz * r10.yzw + r7.yzw;
      r1.w = saturate(1 + -r1.w);
      r5.w = r1.w * r1.w;
      r5.w = r5.w * r5.w;
      r1.w = r5.w * r1.w;
      r1.w = r5.z * r1.w;
      r16.xyz = r1.www * r10.zwy + r13.xyz;
      r14.w = r16.z;
      r6.w = r13.z;
      r6.xyzw = r4.wwww ? r14.xyzw : r6.xyzw;
      r16.zw = r15.xy;
      r13.zw = r7.yz;
      r14.xyzw = r4.wwww ? r16.xyzw : r13.xyzw;
      r7.w = r4.w ? r15.z : r7.w;
      r13.z = r6.w;
      r13.xy = r14.xy;
      r7.yz = r14.zw;
    }
            ...
            if (r24.w != 0) {
              ...
              if (r24.w != 0) {
                ...
                if (r24.w != 0) {
                  ...
                  r18.x = abs(r15.w) * r4.y + -abs(r15.w);
                  r15.w = abs(r15.w) * r18.x + 1;
                  r18.x = r12.w * r0.x + r2.w;
                  r15.w = r15.w * r15.w;
                  r15.w = r15.w * r18.x;
                  r15.w = rcp(r15.w);
                  r12.w = r12.w * r24.w;
            ...
            r39.w = samp0[]..swiz;
              ...
              if (r15.z != 0) {
                ...
                if (r15.z != 0) {
                  ...
                  r15.w = r15.w + -r13.w;
                  r15.w = r4.z * r15.w + r13.w;
                  r15.w = r15.w * r9.w;
                  r12.w = cmp(0 < r12.w);
                  r22.xyz = r15.www * r20.xyw + r16.xyz;
                  r19.xyz = r19.xyz * r11.www + r3.xyz;
                  r11.w = dot(r19.xyz, r19.xyz);
                  r11.w = rsqrt(r11.w);
                  r19.xyz = r19.xyz * r11.www;
                  r11.w = dot(r19.xyz, r3.xyz);
                  r15.w = dot(r2.xyz, r19.xyz);
                  r19.x = abs(r15.w) * r4.y + -abs(r15.w);
                  r15.w = abs(r15.w) * r19.x + 1;
                  r13.w = r13.w * r0.x + r2.w;
                  r15.w = r15.w * r15.w;
                  r13.w = r15.w * r13.w;
                  r13.w = rcp(r13.w);
                  r13.w = r13.w * r15.z;
  ...
  r2.xyz = float3(1,1,1) + -r8.xyz;
  r2.xyz = r27.xyz * r2.xyz;
  r2.xyz = r28.xyz * r8.xyz + r2.xyz;
  r1.xyz = r10.yzw * r1.xyz + r2.xyz;
  r0.x = dot(r1.xyz, float3(0.298999995,0.587000012,0.114));
  r0.x = max(9.99999975e-05, r0.x);
  r0.x = max(relHDRExposure.x, r0.x);
  r2.xyz = r0.yzw * r0.xxx;
  r0.xyz = relativeHDR ? r2.xyz : r0.yzw;
