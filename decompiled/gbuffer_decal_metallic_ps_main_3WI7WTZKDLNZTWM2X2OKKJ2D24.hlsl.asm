...
mul r0.w, r1.z, v8.z
mul r2.z, r0.x, r1.w
sample_indexable(texture2d)(float,float,float,float) r0.x, r0.yzyy, t9.xyzw, s2
add r0.y, -cb0[11].x, cb0[11].y
mad r0.x, r0.x, r0.y, cb0[11].x
mul_sat r0.x, r0.x, l(0.05882353)
ftou r3.xy, v0.xyxx
mov r3.zw, l(0,0,0,0)
ld_indexable(texture2d)(float,float,float,float) r0.y, r3.xyzw, t6.xzyw
lt r0.z, l(0.000000), r0.y
ge r0.y, r0.y, l(0.500000)
movc r0.y, r0.y, l(0.500000), l(0.00146628)
mad r0.y, r0.x, l(0.49755621), r0.y
mov r0.x, l(0.500000)
and r0.xy, r0.xyxx, r0.zzzz
mul r2.xy, r2.zzzz, r0.xyxx
mad r0.y, r1.x, v8.x, -r0.w
mad r0.w, r0.y, l(0.500000), r0.w
mad r0.z, r1.y, v8.y, -r0.w
