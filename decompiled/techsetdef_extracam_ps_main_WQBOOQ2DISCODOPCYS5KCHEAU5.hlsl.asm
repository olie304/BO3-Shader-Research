...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:43:10 2021
//
//
// Buffer Definitions: 
//
...
if_nz r0.x
  sample_indexable(texture2d)(float,float,float,float) r0.xyz, v2.xyxx, t24.xyzw, s1
else 
  ieq r0.w, cb0[11].z, l(3)
  if_nz r0.w
    sample_indexable(texture2d)(float,float,float,float) r0.xyz, v2.xyxx, t22.xyzw, s1
  else 
    ieq r0.w, cb0[11].z, l(2)
    if_nz r0.w
      sample_indexable(texture2d)(float,float,float,float) r0.xyz, v2.xyxx, t21.xyzw, s1
    else 
