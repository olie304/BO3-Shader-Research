// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:24:39 2021
...
cbuffer _Globals : register(b0)
{
  ...
  float2 featherParms : packoffset(c12);
  float1 alphaDissolve : packoffset(c12.z);
  bool useOldHDRScale : packoffset(c12.w);
}
...
r0.x = samp0[]..swiz;
  ...
  r5.z = r11.z * 2 + r8.y;
  r12.x = 1 + -r5.z;
  r12.yz = r9.yx * float2(2,2) + r8.xy;
  r12.w = r9.z * 2 + -r4.y;
  r8.yzw = r12.xyw * r2.www;
  r9.x = r9.y * 2 + -r8.x;
  r9.y = 1 + -r12.z;
  ...
  r7.yz = r4.xy * r7.xy;
  r8.xyz = r8.xyz * r7.yyy + r2.xyz;
  r7.yzw = r3.zxy * r7.zzz + r8.xyz;
  r3.w = r7.x;
  ...
  r0.xyz = exp2(r0.xyz);
  o3.w = f16tof32(r5.w);
  r0.w = cmp(1 >= featherParms.x);
  r1.x = saturate(featherParms.x * r3.w);
  r1.x = r1.w * r1.x;
  r0.w = r0.w ? r1.x : r1.w;
  if (r6.y != 0) {
    ...
    r4.xy = outdoorSSTConstants.offToPinTransform._m30_m31 + r1.xy;
    r1.xyw = float3(128,0.5,0.5) * outdoorSSTConstants.constants.inchesPerTexel;
    r5.xz = rcp(r1.xx);
    r5.y = -r5.z;
    r1.xyw = r4.xyx * r5.xyz + r1.ywy;
    r5.xyz = float3(-0.0078125,-0.0078125,-0.0078125) + outdoorSSTConstants.constants.dimensionInTiles.xyx;
    r1.xyw = max(float3(0,0,0), r1.xyw);
    r1.xyw = min(r1.xyw, r5.xyz);
    r5.xy = floor(r1.wy);
    r4.w = r5.y * outdoorSSTConstants.constants.dimensionInTiles.x + r5.x;
    r4.w = (uint)r4.w;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r5.x, r4.w, l(0), t24.xxxx
  r5.x = samp0[]..swiz;
    r5.y = (int)r5.x & 0x40000000;
    r4.z = (uint)r5.x << 2;
    if (r5.y == 0) {
      r5.y = (int)r5.x & 0x01ffffff;
      r7.x = (int)r4.w + (int)r5.y;
      r4.w = (uint)r5.x >> 25;
      r4.w = (uint)r4.w;
    ...
    r5.z = samp0[]..swiz;
      ...
      r6.xy = (uint2)r1.wy >> (uint2)r8.yy;
      r6.xy = (int2)r6.xy & int2(1,1);
      r5.w = (int)r5.z & 0xc0000000;
      r6.w = (int)r5.x + 1;
    // Known bad code for instruction (needs manual fix):
    ...
    r6.w = samp0[]..swiz;
      ...
      r6.x = r6.x ? r6.w : r6.y;
      r6.x = (int)r6.x & 8191;
      r8.x = (int)r5.x + (int)r6.x;
    // Known bad code for instruction (needs manual fix):
        ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r8.w, r8.x, l(0), t24.xxxx
    r8.w = samp0[]..swiz;
      r5.xyz = r5.www ? r5.xyz : r8.xzw;
      r5.xyz = r4.www ? r7.xyz : r5.xyz;
      r4.w = (int)r5.z & 0xc0000000;
      if (r4.w == 0) {
        r4.w = (int)-r5.y + 6;
        r6.xy = (uint2)r1.wy >> (uint2)r4.ww;
        r4.w = (int)r5.z | 0x40000000;
        bitmask.w = ((~(-1 << 1)) << 1) & 0xffffffff;  r5.w = (((uint)r6.y << 1) & bitmask.w) | ((uint)0 & ~bitmask.w);
        bitmask.w = ((~(-1 << 1)) << 0) & 0xffffffff;  r5.w = (((uint)r6.x << 0) & bitmask.w) | ((uint)r5.w & ~bitmask.w);
        r5.w = (int)r5.w * 10;
        r4.w = (uint)r4.w >> (uint)r5.w;
        r4.w = (int)r4.w & 1023;
        r7.x = (int)r4.w + (int)r5.x;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r7.w, r7.x, l(0), t24.xxxx
      r7.w = samp0[]..swiz;
        r7.yz = (int2)r5.yy + int2(1,2);
        r4.w = (int)-r7.y + 6;
        r5.yw = (uint2)r1.wy >> (uint2)r4.ww;
        r4.w = (int)r7.w & 0xc0000000;
        r6.x = (int)r7.w | 0x40000000;
        bitmask.w = ((~(-1 << 1)) << 1) & 0xffffffff;  r5.w = (((uint)r5.w << 1) & bitmask.w) | ((uint)0 & ~bitmask.w);
        bitmask.y = ((~(-1 << 1)) << 0) & 0xffffffff;  r5.y = (((uint)r5.y << 0) & bitmask.y) | ((uint)r5.w & ~bitmask.y);
        r5.y = (int)r5.y * 10;
        r5.y = (uint)r6.x >> (uint)r5.y;
        r5.y = (int)r5.y & 1023;
        r8.x = (int)r5.y + (int)r7.x;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r8.z, r8.x, l(0), t24.xxxx
      r8.z = samp0[]..swiz;
        r8.y = r7.z;
        r6.xyw = r4.www ? r7.xyw : r8.xyz;
        r5.y = (int)-r6.y + 6;
        r5.yw = (uint2)r1.wy >> (uint2)r5.yy;
        r6.y = (int)r6.w & 0xc0000000;
        r7.y = (int)r6.w | 0x40000000;
        bitmask.w = ((~(-1 << 1)) << 1) & 0xffffffff;  r5.w = (((uint)r5.w << 1) & bitmask.w) | ((uint)0 & ~bitmask.w);
        bitmask.y = ((~(-1 << 1)) << 0) & 0xffffffff;  r5.y = (((uint)r5.y << 0) & bitmask.y) | ((uint)r5.w & ~bitmask.y);
        r5.y = (int)r5.y * 10;
        r5.y = (uint)r7.y >> (uint)r5.y;
        r5.y = (int)r5.y & 1023;
        r8.x = (int)r5.y + (int)r6.x;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r8.y, r8.x, l(0), t24.xxxx
      r8.y = samp0[]..swiz;
        r5.yw = r6.yy ? r6.xw : r8.xy;
        r5.xz = r4.ww ? r7.xw : r5.yw;
      }
      r4.w = (int)r5.z & 0xc0000000;
      if (r4.w == 0) {
        if (14 == 0) r5.y = 0; else if (14+15 < 32) {         r5.y = (uint)r5.z << (32-(14 + 15)); r5.y = (uint)r5.y >> (32-14);        } else r5.y = (uint)r5.z >> 15;
        r5.y = (uint)r5.y;
        r5.y = outdoorSSTConstants.constants.spanInInches * r5.y;
        r6.xy = (int2)r5.zz & int2(32767,536870912);
        r5.w = (uint)r6.x;
        r5.w = outdoorSSTConstants.constants.spanInInches * r5.w;
        r5.yw = float2(6.10388815e-05,3.05185094e-05) * r5.yw;
        r6.x = (int)r1.y & 3;
      ...
      r6.x = samp0[]..swiz;
        ...
        r1.x = (uint)r6.x >> (uint)r7.x;
        r1.x = (int)r1.x & 255;
        r1.x = (uint)r1.x;
        r1.x = r1.x * r5.w;
        r1.x = r1.x * 0.00392156886 + r5.y;
        r1.y = (int)r7.y + 1;
      ...
      r1.y = samp0[]..swiz;
        ...
        r1.y = (uint)r1.y;
        r1.y = r1.y * r5.w;
        r1.y = r1.y * 1.52590219e-05 + r5.y;
        r4.z = r6.y ? r1.x : r1.y;
      } else {
        r1.x = (int)r5.z & 0x80000000;
        r1.y = (int)r5.x + 1;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r1.y, r1.y, l(0), t24.xxxx
      r1.y = samp0[]..swiz;
    ...
    r1.x = dot(r4.xyz, pinToWorldZ.xyz);
    r1.x = pinToWorldZ.w + r1.x;
  ...
  r5.y = samp0[]..swiz;
    ...
    r8.w = samp0[]..swiz;
      r9.xy = r6.xw;
      r9.z = r7.z;
      r9.x = dot(r1.yzw, r9.xyz);
      r10.x = r6.y;
      r10.yz = r7.xw;
      r9.y = dot(r1.yzw, r10.xyz);
      r7.x = r6.z;
      r7.z = r8.x;
      r9.z = dot(r1.yzw, r7.xyz);
      r5.yzw = r9.xyz + r8.yzw;
    // Known bad code for instruction (needs manual fix):
        ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r6.xyz, r4.w, l(52), t0.xyzx
    r6.x = samp0[]..swiz;
    r6.y = samp0[]..swiz;
    r6.z = samp0[]..swiz;
      r5.yzw = cmp(abs(r5.yzw) < r6.xyz);
      r5.y = r5.z ? r5.y : 0;
      r5.y = r5.w ? r5.y : 0;
      if (r5.y != 0) {
        r4.z = -1;
  ...
  if (r0.w != 0) {
    ...
    r4.xyz = r2.xxx * viewProjectionMatrix._m00_m01_m03 + r4.xyz;
    r4.xyz = r2.zzz * viewProjectionMatrix._m20_m21_m23 + r4.xyz;
    ...
    r4.xy = (uint2)r4.xy;
    r5.xyz = sunConstants.sstLightingConstants.offToPinTransform._m10_m11_m12 * r2.yyy;
    r5.xyz = r2.xxx * sunConstants.sstLightingConstants.offToPinTransform._m00_m01_m02 + r5.xyz;
    r5.xyz = r2.zzz * sunConstants.sstLightingConstants.offToPinTransform._m20_m21_m22 + r5.xyz;
