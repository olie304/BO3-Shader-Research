...
//   float2 colorScroll;                // Offset:  168 Size:     8
//
// }
//
...
mad r1.zw, cb0[10].zzzw, cb1[69].wwww, v1.xxxy
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r1.zwzz, t6.xyzw, s1
if_nz r1.y
  mul r1.x, r1.x, r2.w
  mad r1.yzw, -r0.xxyz, l(0.000000, 0.00003052, 0.00003052, 0.00003052), l(0.000000, 1.000000, 1.000000, 1.000000)
  mad r2.xyz, -r2.xyzx, r1.xxxx, l(1.000000, 1.000000, 1.000000, 0.000000)
  mad r1.xyz, -r1.yzwy, r2.xyzx, l(1.000000, 1.000000, 1.000000, 0.000000)
  mul r0.xyz, r1.xyzx, l(32768.000000, 32768.000000, 32768.000000, 0.000000)
endif 
mov o0.xyzw, r0.xyzw
ret 
