// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:42:40 2021
...
r0.w = modelInstanceBuffer[]..swiz;
  ...
  r1.x = max(0.100000001, zFeatherDistance);
  r1.x = 1 / r1.x;
  r1.y = cmp(1 >= r1.x);
  r1.x = saturate(r1.x * r0.w);
  r1.x = v1.w * r1.x;
  o1.x = r1.y ? r1.x : v1.w;
  r1.xy = cmp(falloffBegin == float2(0,0));
  r1.x = r1.y ? r1.x : 0;
  r1.yz = float2(0.0174532924,0.0174532924) * falloffBegin;
  r1.yz = cos(r1.yz);
  r1.zw = r1.yz * r1.yz;
  r1.y = r1.y * r1.y + -r1.w;
  r2.x = 1 / r1.y;
  r2.y = -r1.z * r2.x + 1;
  o6.xy = r1.xx ? float2(0,1) : r2.xy;
  o0.xyzw = r0.xyzw;
  p1.xy = v2.xy;
  o5.xyz = r8.xyz;
  return;
