...
dcl_temps 6
mov r0.x, l(0)
sample_indexable(texture2d)(float,float,float,float) r0.z, v0.xyxx, t0.yzxw, s0
mul r1.xyzw, r0.zzzz, v1.xzyw
mov r0.yw, r1.xxxz
...
mov r1.x, l(0)
add r4.xyzw, -r1.xyxw, v0.xyxy
add r1.xyzw, r1.xwxy, v0.xyxy
...
sample_indexable(texture2d)(float,float,float,float) r4.xyzw, r1.xyxx, t1.xyzw, s0
