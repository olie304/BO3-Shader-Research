...
// unknown dcl_: dcl_thread_group 8, 8, 1
  ...
  r0.w = (int)r0.x + -1;
  r2.x = (int)r0.w + (int)-vThreadID.y;
  r0.w = 0.75 * hdrControl0.w;
  r3.x = (int)vThreadID.z + 1;
  if (1 == 0) r3.y = 0; else if (1+2 < 32) {   r3.y = (uint)r3.x << (32-(1 + 2)); r3.y = (uint)r3.y >> (32-1);  } else r3.y = (uint)r3.x >> 2;
  if (1 == 0) r3.z = 0; else if (1+1 < 32) {   r3.z = (uint)r3.x << (32-(1 + 1)); r3.z = (uint)r3.z >> (32-1);  } else r3.z = (uint)r3.x >> 1;
  r3.x = (int)r3.x & 1;
  r3.yzw = (uint3)r3.yzx;
  r2.yzw = r3.yzw * r0.www;
  r1.w = vThreadID.y;
  r3.xyzw = r0.zzzz ? r2.xyzw : r1.wxyz;
  r4.xzw = vThreadID.xzz;
  r4.y = r3.x;
...
store_uav_typed u0.xyzw, r4.xyzw, r3.yzwy
  ...
  r3.z = gSRVReflectionArray[]..swiz;
    ...
    r3.xy = (int2)r1.xx + int2(8,9);
  // Known bad code for instruction (needs manual fix):
    ld_structured r3.xzw, r3.x, l(0), g0.xxyz
  r3.x = gSRVReflectionArray[]..swiz;
  r3.z = gSRVReflectionArray[]..swiz;
  r3.w = gSRVReflectionArray[]..swiz;
    r1.xyz = r3.xzw + r1.yzw;
  // Known bad code for instruction (needs manual fix):
  ...
  r3.z = gSRVReflectionArray[]..swiz;
    ...
    r1.yzw = float3(0.25,0.25,0.25) * r1.xyz;
    gSRVReflectionArray[r0.y].0 = g0.xyz;
    r3.xy = mad((int2)vThreadGroupID.xy, (int2)r0.ww, (int2)vThreadIDInGroup.xy);
    r4.x = (int)r0.x + -1;
    r2.x = (int)-r3.y + (int)r4.x;
    r1.x = r3.y;
  ...
  r3.z = gSRVReflectionArray[]..swiz;
    ...
    r1.yzw = float3(0.25,0.25,0.25) * r1.xyz;
    r0.x = (int)r0.x + -1;
    r2.x = (int)r0.x + (int)-vThreadGroupID.y;
    r1.x = vThreadGroupID.y;
