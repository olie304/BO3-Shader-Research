...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  if (r1.y != 0) {
    ...
    r13.y = r13.x;
    r13.z = r12.x;
    r14.x = dot(r13.yz, r1.yw);
    r13.x = -r12.x;
    r14.y = dot(r13.xy, r1.yw);
    r1.yw = gameTime.ww * scrollUVs.xy;
    r1.yw = r1.yw * scaleUVs.xy + r14.xy;
    ...
    r6.zw = saturate(r1.yw);
    r11.xy = clampU ? r6.zw : r1.yw;
  }
  ...
  r1.y = v3.x + v3.y;
  r1.y = v3.z + r1.y;
  r1.w = flickerSeed.y + r1.y;
  r1.w = frac(r1.w);
  r12.y = gameTime.w * flickerSpeed + r1.w;
  r12.x = flickerSeed.x;
  ...
  if (r1.w != 0) {
    ...
    r1.w = trunc(r1.w);
    r1.w = v2.x + r1.w;
    r12.x = r1.w / columnCount2;
    r1.w = trunc(r3.w);
    r1.w = v2.y + r1.w;
    r12.y = r1.w / rowCount2;
  } else {
    r1.w = dot(-v7.xyz, -v7.xyz);
    r1.w = rsqrt(r1.w);
    r13.xyz = -v7.xyz * r1.www;
    r14.x = dot(r13.xyz, r4.xyz);
    r14.y = dot(r13.xyz, r5.xyz);
    r1.w = dot(r13.xyz, r3.xyz);
    r3.w = cmp(0 < r1.w);
    r6.zw = -r14.xy / r1.ww;
    r6.zw = r3.ww ? r6.zw : 0;
  ...
  if (r1.w != 0) {
    ...
    r1.w = trunc(r1.w);
    r1.w = v2.x + r1.w;
    r12.x = r1.w / columnCount3;
    r1.w = trunc(r3.w);
    r1.w = v2.y + r1.w;
    r12.y = r1.w / rowCount3;
  } else {
    r1.w = dot(-v7.xyz, -v7.xyz);
    r1.w = rsqrt(r1.w);
    r13.xyz = -v7.xyz * r1.www;
