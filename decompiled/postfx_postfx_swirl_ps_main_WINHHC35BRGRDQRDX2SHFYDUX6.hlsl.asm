...
//   float pulseAmp;                    // Offset:  212 Size:     4
//   float pulseRate;                   // Offset:  216 Size:     4
//
// }
//
...
mad r2.y, r2.x, r1.x, l(1.000000)
mad r1.x, -r2.x, r1.x, l(1.000000)
mul r2.xz, r1.xxxx, r1.zzwz
mul r1.xz, r1.zzwz, r2.yyyy
...
lt r1.w, l(0.000000), cb3[0].x
movc r1.xz, r1.wwww, r1.xxzx, r2.xxyx
add r2.xy, r1.xzxx, l(-0.500000, -0.500000, 0.000000, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r3.xyzw, r1.xzxx, t0.xyzw, s1
mul r1.xz, r2.xxyx, l(1.000000, 0.000000, 0.562500, 0.000000)
...
mov r5.y, r4.x
mov r5.x, -r2.x
dp2 r2.y, r5.xyxx, r1.xzxx
dp2 r2.x, r5.yzyy, r1.xzxx
mul r1.xz, cb0[12].xxyx, cb1[69].wwww
mad r1.xz, r1.xxzx, l(1.000000, 0.000000, 0.562500, 0.000000), r2.xxyx
add r1.xz, r1.xxzx, l(0.500000, 0.000000, 0.500000, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r1.xzxx, t10.xyzw, s2
mov_sat r1.x, cb3[0].y
mul r1.z, r1.x, r2.w
mul r0.w, r0.w, r1.x
mad r4.xyz, -r3.xyzx, l(0.00003052, 0.00003052, 0.00003052, 0.000000), r2.xyzx
...
mad r1.xzw, r1.zzzz, r4.xxyz, r5.xxyz
add r4.xyz, r0.xyzx, -r1.xzwx
sample_indexable(texture2d)(float,float,float,float) r2.w, v1.xyxx, t9.yzwx, s1
mul_sat r2.w, r2.w, cb3[0].z
mul r0.w, r0.w, r2.w
mul r0.w, r1.y, r0.w
mad r1.xyz, r0.wwww, r4.xyzx, r1.xzwx
mad r0.xyz, -r0.xyzx, r0.wwww, l(1.000000, 1.000000, 1.000000, 0.000000)
mad r3.xyz, -r3.xyzx, l(0.00003052, 0.00003052, 0.00003052, 0.000000), l(1.000000, 1.000000, 1.000000, 0.000000)
mov o0.w, r3.w
...
movc r0.xyz, cb0[12].wwww, r1.xyzx, r0.xyzx
