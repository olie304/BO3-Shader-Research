...
sample_indexable(texture2d)(float,float,float,float) r3.xyz, r0.yzyy, t22.xyzw, s5
...
sample_indexable(texture2d)(float,float,float,float) r4.xyzw, r11.xyxx, t38.xyzw, s1
...
mov r1.x, cb0[32].y
sample_l_indexable(texture2d)(float,float,float,float) r1.x, r1.xyxx, t26.xyzw, s7, l(0.000000)
log r1.x, |r1.x|
...
ret 
// Approximately 2849 instruction slots used
