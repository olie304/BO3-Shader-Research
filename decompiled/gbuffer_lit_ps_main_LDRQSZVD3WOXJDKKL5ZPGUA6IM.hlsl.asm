...
sample_indexable(texture2d)(float,float,float,float) r4.xyz, r0.xyxx, t7.xyzw, s2
mad r0.xy, r4.xyxx, l(1.99218750, 1.99218750, 0.000000, 0.000000), l(-1.000000, -1.000000, 0.000000, 0.000000)
mul r2.z, r4.z, r4.z
mul r2.z, r2.z, l(0.33333334)
min r2.z, r2.z, l(1.000000)
mad r3.xy, r0.xyxx, cb0[11].zzzz, r2.xyxx
dp3 r0.x, r3.xyzx, r3.xyzx
rsq r0.x, r0.x
mul r2.xyw, r0.xxxx, r3.xyxz
mad r0.x, r2.z, cb0[11].z, r1.w
...
if_nz r0.z
  ...
  movc r1.xyz, r1.wwww, r5.xywx, r6.xyzx
endif 
...
rsq r0.z, r0.z
mad r5.xyz, r5.xyzx, r0.zzzz, -r2.xyzx
...
add r1.w, r4.y, r4.x
mad r1.w, r3.z, r0.y, r1.w
mul r1.w, r1.w, l(0.500000)
mad r3.xyz, r3.xyzx, r0.yyyy, -r1.wwww
max r0.y, r3.z, r3.y
max r0.y, r0.y, r3.x
max r0.y, r0.y, r1.w
eq r1.w, r0.y, r3.x
