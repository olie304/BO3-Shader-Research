...
mul r2.xyz, r2.xyzx, l(0.11718750, 0.11718750, 0.11718750, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r3.xyz, r1.xyxx, t0.xyzw, s0
mad r2.xyz, r3.xyzx, l(0.03515625, 0.03515625, 0.03515625, 0.000000), r2.xyzx
sample_indexable(texture2d)(float,float,float,float) r3.xyz, r1.zyzz, t0.xyzw, s0
mad r2.xyz, r3.xyzx, l(0.03515625, 0.03515625, 0.03515625, 0.000000), r2.xyzx
mad r0.xyz, r0.xyzx, l(0.11718750, 0.11718750, 0.11718750, 0.000000), r2.xyzx
sample_indexable(texture2d)(float,float,float,float) r2.xyz, v0.xyxx, t0.xyzw, s0
mad r0.xyz, r2.xyzx, l(0.390625, 0.390625, 0.390625, 0.000000), r0.xyzx
mov r2.xw, r1.zzzw
mov r2.yz, v0.yyxy
...
mad r0.xyz, r3.xyzx, l(0.11718750, 0.11718750, 0.11718750, 0.000000), r0.xyzx
...
mad r0.xyz, r3.xyzx, l(0.03515625, 0.03515625, 0.03515625, 0.000000), r0.xyzx
mad r0.xyz, r2.xyzx, l(0.11718750, 0.11718750, 0.11718750, 0.000000), r0.xyzx
mad r0.xyz, r1.xyzx, l(0.03515625, 0.03515625, 0.03515625, 0.000000), r0.xyzx
mul r1.xyz, r0.xyzx, cb8[17].xxxx
mad r2.xyz, r1.xyzx, cb8[17].zzzz, l(0.540000, 0.540000, 0.540000, 0.000000)
mul r1.xyz, r1.xyzx, r2.xyzx
mad r2.xyz, r0.xyzx, cb8[17].xxxx, l(0.540000, 0.540000, 0.540000, 0.000000)
dp3 r0.x, r0.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
div_sat r1.xyz, r1.xyzx, r2.xyzx
mul r0.y, r0.x, cb8[17].y
mad r0.x, r0.x, cb8[17].y, l(0.540000)
mad r0.z, r0.y, cb8[17].w, l(0.540000)
mul r0.y, r0.z, r0.y
div_sat r1.w, r0.y, r0.x
sqrt r0.xyzw, r1.xyzw
mad_sat r0.xyzw, r0.xyzw, cb8[19].xyzw, cb8[20].xyzw
log r0.xyzw, r0.xyzw
mul r0.xyzw, r0.xyzw, cb8[21].xyzw
exp r0.xyzw, r0.xyzw
mad_sat r0.xyzw, r0.xyzw, cb8[22].xyzw, cb8[23].xyzw
mad r0.xyzw, r0.xyzw, r0.xyzw, -r1.xyzw
mad r0.xyzw, cb8[18].xxxy, r0.xyzw, r1.xyzw
mul r1.xyzw, r0.xyzw, r0.xyzw
mad r2.xyzw, r0.xyzw, l(-2.000000, -2.000000, -2.000000, -2.000000), l(3.000000, 3.000000, 3.000000, 3.000000)
mad r1.xyzw, r1.xyzw, r2.xyzw, -r0.xyzw
mad o0.xyzw, cb8[18].zzzw, r1.xyzw, r0.xyzw
ret 
