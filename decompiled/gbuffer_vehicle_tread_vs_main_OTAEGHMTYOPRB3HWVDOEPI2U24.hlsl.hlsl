...
r4.y = colorSampler[]..swiz;
  ...
  r3.zw = r4.xy + -r3.xy;
  r0.w = treadHeightMap.SampleLevel(colorSampler_s, r3.zw, 0).x;
  ...
  r3.z = treadHeightMap.SampleLevel(colorSampler_s, r5.xy, 0).x;
  r3.w = treadHeightMap.SampleLevel(colorSampler_s, r5.zw, 0).x;
  r5.xyzw = r3.xyxy * float4(1,-1,1,0) + r4.xyxy;
  r4.z = treadHeightMap.SampleLevel(colorSampler_s, r5.xy, 0).x;
  r4.w = treadHeightMap.SampleLevel(colorSampler_s, r5.zw, 0).x;
  r3.xy = r4.xy + r3.xy;
  r3.x = treadHeightMap.SampleLevel(colorSampler_s, r3.xy, 0).x;
  r3.y = abs(r4.w) * 2 + abs(r4.z);
  r3.y = r3.y + abs(r3.x);
  r3.y = r3.y + -abs(r0.w);
  r1.w = -abs(r1.w) * 2 + r3.y;
  r1.w = r1.w + -abs(r2.x);
  r2.x = abs(r3.w) * 2 + abs(r2.x);
  r2.x = r2.x + abs(r3.x);
  r0.w = r2.x + -abs(r0.w);
  r0.w = -abs(r3.z) * 2 + r0.w;
  r0.w = r0.w + -abs(r4.z);
  r3.x = -r1.w;
  r3.y = -r0.w;
...
r6.y = colorSampler[]..swiz;
r6.z = colorSampler[]..swiz;
  r7.x = dot(r0.xyz, r3.xyz);
  r7.y = dot(r0.xyz, r5.xyz);
