...
Texture2D<float4> lensFilter : register(t2);
  ...
  out float o1 : SV_TARGET1)
{
  ...
  r0.xy = v1.xy * postFxControl5.xy + postFxControl5.zw;
  r0.x = dot(r0.xy, r0.xy);
  r0.x = sqrt(r0.x);
  r0.x = saturate(r0.x * postFxControl8.z + postFxControl8.w);
  r0.x = 1.57079637 * r0.x;
  r0.x = sin(r0.x);
  r1.xy = (int2)v0.xy;
  r1.zw = float2(0,0);
  r0.yzw = codeTexture0.Load(r1.xyw).xyz;
  r1.x = codeTexture1.Load(r1.xyz).x;
  r1.yzw = lensFilter.Sample(bilinearClamp_s, v1.xy).xyz;
  r2.xyz = r1.yzw * r0.yzw;
  r2.w = dot(r2.xyz, postFxControl0.xyz);
  r0.yzw = -r0.yzw * r1.yzw + r2.www;
  o0.xyz = r0.xxx * r0.yzw + r2.xyz;
  r0.x = r1.x * 64 + -63;
  r0.x = max(9.99999994e-09, r0.x);
  r0.y = max(9.99999994e-09, r1.x);
  r0.z = cmp(r1.x >= 0.984375);
  r0.xy = postFxControl2.zw / r0.xy;
  r0.x = r0.z ? r0.x : r0.y;
  r0.y = 25.3999996 * r0.x;
  r0.x = saturate(r0.x * postFxControl9.x + postFxControl9.y);
  r0.x = exp2(r0.x);
  r0.x = 1 / r0.x;
  r0.x = 1 + -r0.x;
  r0.x = postFxControl9.z * r0.x;
  r0.x = postFxControl9.w * r0.x;
  r0.y = postFxControl3.y / r0.y;
  r0.y = -1 + r0.y;
  r0.y = postFxControl3.z * r0.y;
  r0.y = postFxControl3.w * r0.y;
  o1.x = r0.y * 0.5 + r0.x;
  return;
}