...
if_nz r0.x
  ftoi r0.x, cb1[64].w
  lod r0.y, v2.xyxx, t0.y, s1
  lod r0.z, v2.xyxx, t0.x, s1
  lt r0.y, r0.y, r0.z
...
sample_indexable(texture2d)(float,float,float,float) r2.w, v2.xyxx, t24.yzwx, s6
add r3.x, -cb0[10].y, cb0[10].z
mad r1.w, r1.w, r3.x, cb0[10].y
...
mad r2.x, cb1[62].x, r3.x, cb0[10].y
...
add r1.w, -r2.w, cb1[63].x
mad r1.w, cb1[63].w, r1.w, r2.w
