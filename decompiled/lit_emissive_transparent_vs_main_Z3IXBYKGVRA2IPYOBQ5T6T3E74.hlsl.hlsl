// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:35:46 2021
...
r0.z = modelInstanceBuffer[]..swiz;
  r1.xyz = float3(0.100000001,0.100000001,0.100000001) * r0.xyz;
  o3.xyz = frac(r1.xyz);
  if (forceIsolateHack != 0) {
    ...
    r2.w = r0.z * 0.899999976 + r2.x;
    r2.w = 0.699999988 * r2.w;
    r2.w = sin(r2.w);
    r3.x = r0.w * 0.699999988 + r2.x;
    r3.x = 0.699999988 * r3.x;
    r3.x = cos(r3.x);
    r3.y = 0.00999999978 * v0.z;
    r3.zw = weather.windSpeed * weather.windDirSin;
    r3.z = r3.z * r2.w;
    r4.x = r3.z * r1.y;
    r3.z = r3.w * r3.x;
    r4.y = r3.z * r1.y;
