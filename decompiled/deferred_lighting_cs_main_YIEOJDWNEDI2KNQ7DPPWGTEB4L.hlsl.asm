...
add r0.w, r0.w, r0.w
mad r16.xyz, r12.xyzx, -r0.wwww, -r13.xyzx
...
mul r19.y, r3.y, r3.z
mul r19.xz, r2.zzwz, r3.yyzy
mul r19.w, r2.w, r2.z
dp4 r1.w, r17.xyzw, r19.xyzw
add r18.xyzw, -r10.yyyy, r18.xyzw
...
max r2.w, r2.w, |r18.y|
max r2.w, r2.w, |r18.x|
eq r3.yzw, r2.zzzz, |r18.yyzw|
movc r2.z, r3.y, r17.y, r17.x
movc r2.z, r3.z, r17.z, r2.z
movc r2.z, r3.w, r17.w, r2.z
...
loop 
  ...
  loop 
    ...
    ubfe r15.y, l(6), l(25), cb10[r10.w + 7].z
    ...
    if_nz r15.y
      ...
      dp3 r15.z, r16.xyzx, r27.xyzx
      dp3 r15.w, r14.yzwy, r27.xyzx
      ...
      div r15.z, r15.w, r15.z
      min r15.y, |r15.z|, r15.y
      add r27.x, r14.y, cb10[r10.w + 3].w
      add r27.yz, r14.zzwz, cb10[r10.w + 4].xxyx
      mad r19.yzw, r16.xxyz, r15.yyyy, r27.xxyz
      ...
      utof r28.w, r15.z
      sample_l_indexable(texturecubearray)(float,float,float,float) r15.yzw, r28.xyzw, t8.wxyz, s2, r15.y
      dp3 r31.x, r14.yzwy, r27.xyzx
      dp3 r31.y, r14.yzwy, r29.xyzx
      dp3 r31.z, r14.yzwy, r30.xyzx
      mad_sat r14.yzw, r31.xxyz, cb10[r10.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
      mul r31.xy, r14.yzyy, cb10[r10.w + 4].zwzz
      mul r31.z, r14.w, cb10[r10.w + 5].x
      add r14.yzw, r31.xxyz, cb10[r10.w + 5].yyzw
      dp3 r28.x, r12.xyzx, r27.xyzx
      dp3 r28.y, r12.xyzx, r29.xyzx
      dp3 r28.z, r12.xyzx, r30.xyzx
      lt r19.yzw, l(0.000000, 0.000000, 0.000000, 0.000000), r28.xxyz
      movc r18.z, r19.y, l(0), l(0.500000)
      add r26.xzw, r14.yyzw, r18.xxyz
      ...
      mad r14.yzw, r14.yyzw, r27.zzzz, r26.xxzw
      sample_l_indexable(texturecubearray)(float,float,float,float) r19.yzw, r28.xyzw, t8.wxyz, s2, l(6.000000)
      mul r26.xzw, r14.yyzw, r19.yyzw
      dp3 r10.w, r26.xzwx, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r24.xyz, r14.yzwy, r19.yzwy, r24.xyzx
      mul r14.y, r3.w, r10.w
      ...
      mov r27.x, r24.w
      mov r27.yz, r25.xxyx
      mad r25.xyw, r15.zwzy, r10.wwww, r27.yzyx
      mov r24.w, r25.w
    endif 
  endloop 
...
if_nz r7.w
  ...
  loop 
    ...
    ieq r13.w, r0.z, r8.w
    ubfe r14.y, r6.w, l(0), r9.w
    movc r9.w, r13.w, r14.y, r9.w
    mov r25.xyzw, r24.xyzw
    mov r14.yzw, r10.yyzw
    mov r13.w, r7.w
    mov r15.y, r9.w
    loop 
      breakc_z r15.y
      ...
      add r26.xyz, r11.xyzx, -cb10[r15.z + 0].xyzx
      ...
      loop 
        ...
        movc r19.y, r27.w, r20.w, r28.x
        movc r27.xy, r27.zzzz, r27.xyxx, r19.xyxx
        iadd r18.w, r18.w, l(1)
        mov r17.x, r26.w
      endloop 
      add_sat r15.w, -r13.w, r27.y
      mul r17.x, r15.w, cb10[r15.z + 6].y
      lt r17.w, l(0.000000), r17.x
      if_nz r17.w
        mad r25.w, r15.w, cb10[r15.z + 6].y, r25.w
        mul r15.w, r17.x, cb10[r15.z + 7].y
        mov r28.x, cb10[r15.z + 7].w
        mov r28.yz, cb10[r15.z + 8].xxyx
        dp3 r17.x, r16.xyzx, r28.xyzx
        dp3 r17.w, r26.xyzx, r28.xyzx
        add r17.w, r17.w, -cb10[r15.z + 8].z
        ...
        div r17.w, r18.w, r17.w
        min r17.x, |r17.w|, r17.x
        add r28.x, r26.x, cb10[r15.z + 3].w
        add r28.yz, r26.yyzy, cb10[r15.z + 4].xxyx
        ...
        mov r28.x, cb10[r15.z + 0].w
        mov r28.y, cb10[r15.z + 1].z
        mov r28.z, cb10[r15.z + 2].y
        dp3 r29.x, r19.yzwy, r28.xyzx
        mov r30.xy, cb10[r15.z + 1].xwxx
        mov r30.z, cb10[r15.z + 2].z
        dp3 r29.y, r19.yzwy, r30.xyzx
        mov r31.x, cb10[r15.z + 1].y
        mov r31.yz, cb10[r15.z + 2].xxwx
        dp3 r29.z, r19.yzwy, r31.xyzx
        ubfe r17.w, l(9), l(16), cb10[r15.z + 7].z
        utof r29.w, r17.w
        ...
        mad_sat r26.xyz, r32.xyzx, cb10[r15.z + 3].xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
        mul r32.xy, r26.xyxx, cb10[r15.z + 4].zwzz
        mul r32.z, r26.z, cb10[r15.z + 5].x
        add r26.xyz, r32.xyzx, cb10[r15.z + 5].yzwy
        ...
        mad r14.yzw, r26.xxyz, r27.xxzw, r14.yyzw
        mul r17.x, r3.w, r15.z
        ...
        mad r25.xyz, r19.yzwy, r15.zzzz, r25.xyzx
      endif 
    endloop 
...
if_nz r0.z
  ...
  dp3 r2.w, r15.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
  mad r10.yzw, r22.xxyz, r0.yyyy, r15.yyzw
  mov r16.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r3.yzw, r16.xyzw, t8.wxyz, s2, r3.y
    ...
    if_nz r7.w
      ...
      if_nz r7.w
        ...
        loop 
          ...
          sample_c_lz_indexable(texturecubearray)(float,float,float,float) r13.w, r24.xyzw, t10.xxxx, s13, r7.w
      ...
      if_nz r7.w
        ...
        mad r16.xyz, r2.yyyy, r18.xyzx, r19.xyzx
        movc r16.xyz, r1.wwww, r16.xyzx, cb9[r0.x + 0].xyzx
        add r16.xyz, -r11.xyzx, r16.xyzx
        dp3 r1.w, r16.xyzx, r16.xyzx
        rsq r1.w, r1.w
        mul r18.xyz, r1.wwww, r16.xyzx
          ...
          if_z r8.w
            ...
            if_nz cb2[58].y
              ...
              loop 
                ...
                sample_c_lz_indexable(texture2darray)(float,float,float,float) r13.w, r21.xyzx, t9.xxxx, s13, r2.w
                mad r9.w, r13.w, l(0.125000), r9.w
                iadd r12.w, r12.w, l(1)
              endloop 
            else 
        ...
        mad r20.xyz, r10.yzwy, r2.zzzz, r20.xyzx
        dp3_sat r5.z, r12.xyzx, r18.xyzx
        mad r16.xyz, r16.xyzx, r1.wwww, r13.xyzx
        dp3 r1.w, r16.xyzx, r16.xyzx
        rsq r1.w, r1.w
        ...
        mul r5.z, r5.z, r6.w
        mul r4.w, r4.w, r5.z
        mad r16.xyz, r4.wwww, r19.xyzx, r14.yzwy
        ...
        mad r19.xyz, r2.yyyy, r19.xyzx, r15.yzwy
        and r19.xyz, r3.xxxx, r19.xyzx
        movc r3.yzw, r2.wwww, r20.xxyz, r3.yyzw
        movc r15.yzw, r2.wwww, r15.yyzw, r19.xxyz
        movc r17.xyz, r2.wwww, r18.xyzx, r17.xyzx
        movc r14.yzw, r2.wwww, r16.xxyz, r14.yyzw
      endif 
    endif 
  endif 
  break 
  ...
  if_nz r5.z
    ...
    if_nz r5.z
      ...
      if_nz r6.w
        ...
        mad r2.xyz, r10.yzwy, r2.zzzz, r18.xyzx
        mad r10.xyz, r16.xyzx, r1.wwww, r13.xyzx
        ...
        mad r12.xyz, r0.xxxx, r19.xyzx, r15.yzwy
        and r12.xyz, r3.xxxx, r12.xyzx
        movc r3.yzw, r1.zzzz, r2.xxyz, r3.yyzw
        movc r15.yzw, r1.zzzz, r15.yyzw, r12.xxyz
...
mad r0.xyz, r15.yzwy, r2.xyzx, r0.xyzx
...
ret 
// Approximately 1467 instruction slots used
