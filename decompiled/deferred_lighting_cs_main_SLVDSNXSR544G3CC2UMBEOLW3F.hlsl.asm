...
gather4_indexable(texture2d)(float,float,float,float) r15.xyzw, r1.zwzz, t27.xyzw, s4.x
gather4_indexable(texture2d)(float,float,float,float) r16.xyzw, r1.zwzz, t28.xyzw, s4.x
mul r1.zw, r9.xxxy, l(0.000000, 0.000000, 0.500000, 0.500000)
frc r1.zw, r1.zzzw
add r2.zw, -r1.wwwz, l(0.000000, 0.000000, 1.000000, 1.000000)
mul r17.y, r2.z, r2.w
mul r17.xz, r1.zzwz, r2.zzwz
mul r17.w, r1.w, r1.z
dp4 r1.z, r15.xyzw, r17.xyzw
add r16.xyzw, -r9.wwww, r16.xyzw
min r1.w, |r16.w|, |r16.z|
min r1.w, r1.w, |r16.y|
min r1.w, r1.w, |r16.x|
max r2.z, |r16.w|, |r16.z|
max r2.z, r2.z, |r16.y|
max r2.z, r2.z, |r16.x|
eq r13.yzw, r1.wwww, |r16.yyzw|
movc r1.w, r13.y, r15.y, r15.x
movc r1.w, r13.z, r15.z, r1.w
movc r1.w, r13.w, r15.w, r1.w
...
loop 
  ieq r8.w, r0.y, l(2)
  breakc_nz r8.w
  movc r8.w, r0.y, r0.x, r9.x
  uge r9.w, r8.w, r7.w
  ult r12.w, r8.w, cb2[0].y
  and r9.w, r9.w, r12.w
  if_nz r9.w
    imul null, r8.w, r8.w, l(14)
    add r13.yzw, r10.xxyz, -cb10[r8.w + 0].xxyz
    ...
    loop 
      ...
      dp3 r19.w, cb11[r17.w + 1].xyzx, r13.yzwy
      add_sat r19.w, r19.w, cb11[r17.w + 1].w
      mul r18.w, r18.w, r19.w
      dp3 r19.w, cb11[r17.w + 2].xyzx, r13.yzwy
      add_sat r19.w, r19.w, cb11[r17.w + 2].w
      mul r18.w, r18.w, r19.w
      dp3 r19.w, cb11[r17.w + 3].xyzx, r13.yzwy
      add_sat r19.w, r19.w, cb11[r17.w + 3].w
      mul r18.w, r18.w, r19.w
      dp3 r19.w, cb11[r17.w + 4].xyzx, r13.yzwy
      add_sat r19.w, r19.w, cb11[r17.w + 4].w
      mul r18.w, r18.w, r19.w
      dp3 r19.w, cb11[r17.w + 5].xyzx, r13.yzwy
      add_sat r17.w, r19.w, cb11[r17.w + 5].w
      mul r22.x, r17.w, r18.w
      ushr r19.w, r16.w, l(2)
      ubfe r22.z, l(1), l(2), r16.w
      and r22.w, r19.w, l(2)
      max r23.x, r22.x, r22.y
      mad r17.w, -r18.w, r17.w, l(1.000000)
      mul r17.w, r17.w, r22.y
      movc r17.y, r22.w, r17.w, r23.x
      movc r22.xy, r22.zzzz, r22.xyxx, r17.xyxx
    ...
    if_nz r12.w
      mad r21.w, r22.y, cb10[r8.w + 6].y, r21.w
      mul r9.w, r9.w, cb10[r8.w + 7].y
      mov r23.x, cb10[r8.w + 7].w
      mov r23.yz, cb10[r8.w + 8].xxyx
      dp3 r12.w, r14.xyzx, r23.xyzx
      dp3 r15.x, r13.yzwy, r23.xyzx
      ...
      div r15.x, r15.w, r15.x
      min r12.w, r12.w, |r15.x|
      add r23.x, r13.y, cb10[r8.w + 3].w
      add r23.yz, r13.zzwz, cb10[r8.w + 4].xxyx
      mad r17.yzw, r14.xxyz, r12.wwww, r23.xxyz
      ...
      utof r24.w, r15.x
      sample_l_indexable(texturecubearray)(float,float,float,float) r17.yzw, r24.xyzw, t8.wxyz, s2, r12.w
      dp3 r27.x, r13.yzwy, r23.xyzx
      dp3 r27.y, r13.yzwy, r25.xyzx
      dp3 r27.z, r13.yzwy, r26.xyzx
      mad_sat r13.yzw, r27.xxyz, cb10[r8.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
      mul r27.xy, r13.yzyy, cb10[r8.w + 4].zwzz
      mul r27.z, r13.w, cb10[r8.w + 5].x
      add r13.yzw, r27.xxyz, cb10[r8.w + 5].yyzw
      ...
      mul r12.w, r6.w, r8.w
      mul r13.yzw, r9.wwww, r17.yyzw
      dp3 r9.w, r13.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r8.w, r6.w, r8.w, r9.w
      div r8.w, r12.w, r8.w
      mov r23.x, r20.w
      mov r23.yz, r21.yyzy
      mad r21.xyz, r13.yzwy, r8.wwww, r23.xyzx
      mov r20.w, r21.x
    endif 
  endif 
  iadd r0.y, r0.y, l(1)
...
if_nz r0.y
  ...
  loop 
    ...
    if_nz r9.w
      imul null, r8.w, r8.w, l(14)
      add r23.xyz, r10.xyzx, -cb10[r8.w + 0].xyzx
      and r9.w, l(0x0000ffff), cb10[r8.w + 7].z
      ubfe r12.w, l(6), l(25), cb10[r8.w + 7].z
      imul null, r15.w, r9.w, l(6)
      dp3 r16.w, cb11[r15.w + 0].xyzx, r23.xyzx
      add_sat r16.w, r16.w, cb11[r15.w + 0].w
      dp3 r17.z, cb11[r15.w + 1].xyzx, r23.xyzx
      add_sat r17.z, r17.z, cb11[r15.w + 1].w
      mul r16.w, r16.w, r17.z
      dp3 r17.z, cb11[r15.w + 2].xyzx, r23.xyzx
      add_sat r17.z, r17.z, cb11[r15.w + 2].w
      mul r16.w, r16.w, r17.z
      dp3 r17.z, cb11[r15.w + 3].xyzx, r23.xyzx
      add_sat r17.z, r17.z, cb11[r15.w + 3].w
      mul r16.w, r16.w, r17.z
      dp3 r17.z, cb11[r15.w + 4].xyzx, r23.xyzx
      add_sat r17.z, r17.z, cb11[r15.w + 4].w
      mul r16.w, r16.w, r17.z
      dp3 r17.z, cb11[r15.w + 5].xyzx, r23.xyzx
      add_sat r15.w, r17.z, cb11[r15.w + 5].w
      mul r15.x, r15.w, r16.w
      and r15.w, l(1), cb10[r8.w + 6].x
      movc r15.xw, r15.wwww, r15.xxxy, r15.zzzx
      ...
      loop 
        ...
        add_sat r18.w, r18.w, cb11[r17.w + 0].w
        mul r18.w, r18.w, r24.x
        dp3 r19.w, cb11[r17.w + 1].xyzx, r23.xyzx
        add_sat r19.w, r19.w, cb11[r17.w + 1].w
        mul r18.w, r18.w, r19.w
        dp3 r19.w, cb11[r17.w + 2].xyzx, r23.xyzx
        add_sat r19.w, r19.w, cb11[r17.w + 2].w
        mul r18.w, r18.w, r19.w
        dp3 r19.w, cb11[r17.w + 3].xyzx, r23.xyzx
        add_sat r19.w, r19.w, cb11[r17.w + 3].w
        mul r18.w, r18.w, r19.w
        dp3 r19.w, cb11[r17.w + 4].xyzx, r23.xyzx
        add_sat r19.w, r19.w, cb11[r17.w + 4].w
        mul r18.w, r18.w, r19.w
        dp3 r19.w, cb11[r17.w + 5].xyzx, r23.xyzx
        add_sat r17.w, r19.w, cb11[r17.w + 5].w
        mul r24.x, r17.w, r18.w
        ushr r19.w, r16.w, l(2)
        ubfe r23.w, l(1), l(2), r16.w
        and r24.z, r19.w, l(2)
        max r24.w, r24.x, r24.y
        mad r17.w, -r18.w, r17.w, l(1.000000)
        mul r17.w, r17.w, r24.y
        movc r17.y, r24.z, r17.w, r24.w
        movc r24.xy, r23.wwww, r24.xyxx, r17.xyxx
        iadd r17.z, r17.z, l(1)
        mov r16.w, r19.w
      endloop 
      add_sat r9.w, -r21.w, r24.y
      mul r12.w, r9.w, cb10[r8.w + 6].y
      lt r15.x, l(0.000000), r12.w
      if_nz r15.x
        mad r22.w, r9.w, cb10[r8.w + 6].y, r22.w
        mul r9.w, r12.w, cb10[r8.w + 7].y
        mov r25.x, cb10[r8.w + 7].w
        mov r25.yz, cb10[r8.w + 8].xxyx
        dp3 r12.w, r14.xyzx, r25.xyzx
        dp3 r15.x, r23.xyzx, r25.xyzx
        add r15.x, r15.x, -cb10[r8.w + 8].z
        ge r15.w, r15.x, l(0.000000)
        max r15.x, r5.w, |r15.x|
        movc r15.x, r15.w, r15.x, -r15.x
        ...
        div r12.w, r15.x, r12.w
        min r12.w, |r12.w|, l(131072.000000)
        mov r25.x, cb10[r8.w + 8].w
        mov r25.yz, cb10[r8.w + 9].xxyx
        ...
        div r15.x, r15.w, r15.x
        min r12.w, r12.w, |r15.x|
        mov r25.x, cb10[r8.w + 9].w
        mov r25.yz, cb10[r8.w + 10].xxyx
        dp3 r15.x, r14.xyzx, r25.xyzx
        dp3 r15.w, r23.xyzx, r25.xyzx
        add r15.w, r15.w, -cb10[r8.w + 10].z
        ge r16.w, r15.w, l(0.000000)
        ...
        div r15.x, r15.w, r15.x
        min r12.w, r12.w, |r15.x|
        mov r25.x, cb10[r8.w + 10].w
        mov r25.yz, cb10[r8.w + 11].xxyx
        dp3 r15.x, r14.xyzx, r25.xyzx
        dp3 r15.w, r23.xyzx, r25.xyzx
        add r15.w, r15.w, -cb10[r8.w + 11].z
        ge r16.w, r15.w, l(0.000000)
        ...
        div r15.x, r15.w, r15.x
        min r12.w, r12.w, |r15.x|
        mov r25.x, cb10[r8.w + 11].w
        mov r25.yz, cb10[r8.w + 12].xxyx
        dp3 r15.x, r14.xyzx, r25.xyzx
        dp3 r15.w, r23.xyzx, r25.xyzx
        add r15.w, r15.w, -cb10[r8.w + 12].z
        ge r16.w, r15.w, l(0.000000)
        ...
        div r15.x, r15.w, r15.x
        min r12.w, r12.w, |r15.x|
        mov r25.x, cb10[r8.w + 12].w
        mov r25.yz, cb10[r8.w + 13].xxyx
        dp3 r15.x, r14.xyzx, r25.xyzx
        dp3 r15.w, r23.xyzx, r25.xyzx
        add r15.w, r15.w, -cb10[r8.w + 13].z
        ge r16.w, r15.w, l(0.000000)
        ...
        div r15.x, r15.w, r15.x
        min r12.w, r12.w, |r15.x|
        add r25.x, r23.x, cb10[r8.w + 3].w
        add r25.yz, r23.yyzy, cb10[r8.w + 4].xxyx
        mad r17.yzw, r14.xxyz, r12.wwww, r25.xxyz
        dp3 r15.x, r17.yzwy, r17.yzwy
        sqrt r15.x, r15.x
        div r12.w, r12.w, r15.x
        add r12.w, r12.w, r12.w
        ...
        mad r12.w, r2.z, l(5.000000), r12.w
        add r12.w, r12.w, l(-0.844800)
        mov r25.x, cb10[r8.w + 0].w
        mov r25.y, cb10[r8.w + 1].z
        mov r25.z, cb10[r8.w + 2].y
        dp3 r26.x, r17.yzwy, r25.xyzx
        mov r27.xy, cb10[r8.w + 1].xwxx
        mov r27.z, cb10[r8.w + 2].z
        dp3 r26.y, r17.yzwy, r27.xyzx
        mov r28.x, cb10[r8.w + 1].y
        mov r28.yz, cb10[r8.w + 2].xxwx
        dp3 r26.z, r17.yzwy, r28.xyzx
        ubfe r15.x, l(9), l(16), cb10[r8.w + 7].z
        utof r26.w, r15.x
        sample_l_indexable(texturecubearray)(float,float,float,float) r17.yzw, r26.xyzw, t8.wxyz, s2, r12.w
        dp3 r29.x, r23.xyzx, r25.xyzx
        dp3 r29.y, r23.xyzx, r27.xyzx
        dp3 r29.z, r23.xyzx, r28.xyzx
        mad_sat r23.xyz, r29.xyzx, cb10[r8.w + 3].xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
        mul r29.xy, r23.xyxx, cb10[r8.w + 4].zwzz
        mul r29.z, r23.z, cb10[r8.w + 5].x
        add r23.xyz, r29.xyzx, cb10[r8.w + 5].yzwy
        ...
        mul r12.w, r6.w, r8.w
        mul r17.yzw, r9.wwww, r17.yyzw
        dp3 r9.w, r17.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
        mad r8.w, r6.w, r8.w, r9.w
        div r8.w, r12.w, r8.w
        mad r22.xyz, r17.yzwy, r8.wwww, r22.xyzx
      endif 
    endif 
    iadd r0.y, r0.y, l(1)
  endloop 
...
if_nz r0.y
  ...
  dp3 r2.z, r16.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
  mad r13.yzw, r20.xxyz, r0.xxxx, r16.xxyz
  mov r14.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r16.xyz, r14.xyzw, t8.xyzw, s2, r2.w
  mad r0.x, cb2[19].x, r0.y, -r2.z
...
mul r2.yzw, r0.xxxx, r15.xxyz
mul r15.xyz, r1.zzzz, r2.yzwy
...
switch r1.w
  ...
  mad r9.xyw, -r16.xyxz, l(0.500000, 0.500000, 0.000000, 0.500000), cb9[r1.z + 0].xyxz
  add r17.xyz, -r10.xyzx, r9.xywx
  dp3 r4.z, r16.xyzx, r17.xyzx
  div_sat r5.w, -r4.z, cb9[r1.z + 6].y
  mad r18.xyz, r5.wwww, r16.xyzx, r9.xywx
  ...
  if_nz r11.w
    ...
    if_nz r11.w
      ...
      if_nz r11.w
        ...
        mad r9.xyw, r4.zzzz, r16.xyxz, r9.xyxw
        movc r9.xyw, r1.wwww, r9.xyxw, cb9[r1.z + 0].xyxz
        add r9.xyw, -r10.xyxz, r9.xyxw
        dp3 r1.w, r9.xywx, r9.xywx
        rsq r1.w, r1.w
        mul r14.xyz, r1.wwww, r9.xywx
        ...
        mul r4.z, r4.z, r7.w
        mul r4.z, r6.w, r4.z
        mad r9.xyw, r4.zzzz, r16.xyxz, r2.yzyw
  ...
  if_nz r6.w
    ...
    if_nz r6.w
      ...
      if_nz r7.w
        ...
        mad r16.xyz, r0.wwww, r9.xywx, r13.yzwy
        ...
        mul r0.y, r0.z, r0.y
        mul r0.x, r0.y, r0.x
        mad r0.xyz, r0.xxxx, r9.xywx, r15.xyzx
