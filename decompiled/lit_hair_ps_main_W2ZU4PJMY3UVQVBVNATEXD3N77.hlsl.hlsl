...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  if (r7.w != 0) {
    ...
    if (r7.w != 0) {
      ...
      r13.w = cmp(0 < r5.w);
      r5.w = saturate(r5.w);
      r15.xyz = -v7.xyz * r3.www + sunConstants.wldDir.xyz;
  ...
  if (useAlphaControls != 0) {
    ...
    r3.x = 1 / r1.y;
    r3.y = -r2.y * r3.x + 1;
    r1.xy = r1.xx ? float2(0,1) : r3.xy;
    r2.x = abs(r2.w) * abs(r2.w);
    r1.x = saturate(r2.x * r1.x + r1.y);
    r1.x = r1.x * r0.w;
    r2.xy = (int2)v0.xy;
    r2.zw = float2(0,0);
    r1.y = floatZSampler.Load(r2.xyz).x;
    r2.x = cmp(r1.y >= 0.984375);
    r2.y = 1.01587307 * r1.y;
    r1.y = r1.y * 64 + -63;
    r1.y = r2.x ? r1.y : r2.y;
    r1.y = max(9.99999994e-09, r1.y);
    r1.y = rcp(r1.y);
    r2.x = 1 / zFeatherDistance;
    r1.z = r1.z ? 60000 : r2.x;
    r1.y = r1.y + -r1.w;
