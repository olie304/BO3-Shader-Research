...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  if (r9.w == 0) {
    r14.xyz = sunConstants.sstLightingConstants.offToPinTransform._m10_m11_m12 * v5.yyy;
    r14.xyz = v5.xxx * sunConstants.sstLightingConstants.offToPinTransform._m00_m01_m02 + r14.xyz;
    r14.xyz = v5.zzz * sunConstants.sstLightingConstants.offToPinTransform._m20_m21_m22 + r14.xyz;
  ...
  if (r9.w != 0) {
    ...
    if (r9.w != 0) {
      ...
      r12.w = cmp(0 < r6.w);
      r6.w = saturate(r6.w);
      r15.xyz = -v5.xyz * r4.www + sunConstants.wldDir.xyz;
