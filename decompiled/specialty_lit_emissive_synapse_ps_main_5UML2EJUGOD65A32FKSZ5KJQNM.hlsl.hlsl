// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:42:21 2021
...
r6.y = samp0[]..swiz;
  ...
  r8.y = numRefProbes + -numOverrideProbes;
  r3.w = 0.0078125 * r3.w;
  r3.w = min(15, r3.w);
  r3.w = (uint)r3.w;
  ...
  r10.z = (uint)r3.w << 4;
  r0.z = (int)r8.y & -32;
  r0.w = (int)-r0.z + (int)r8.y;
  r3.w = numRefProbes & -32;
  r8.z = (int)-r3.w + numRefProbes;
  r11.xy = float2(0,0);
  r12.w = 0;
  r13.yz = float2(0,1);
  r14.xy = float2(0,0);
  ...
  while (true) {
    ...
    r11.z = cmp((int)r0.z == (int)r8.w);
    bitmask.w = ((~(-1 << r0.w)) << 0) & 0xffffffff;  r11.w = (((uint)0 << 0) & bitmask.w) | ((uint)r10.w & ~bitmask.w);
    r10.w = r11.z ? r11.w : r10.w;
    r11.z = cmp((int)r3.w == (int)r8.w);
    ...
    while (true) {
      ...
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=80)(mixed,mixed,mixed,mixed) r22.xyzw, r12.y, l(0), t11.xyzw
      r22.x = samp0[]..swiz;
      r22.y = samp0[]..swiz;
      r22.z = samp0[]..swiz;
      r22.w = samp0[]..swiz;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=80)(mixed,mixed,mixed,mixed) r23.xy, r12.y, l(16), t11.xyxx
      r23.x = samp0[]..swiz;
      r23.y = samp0[]..swiz;
        ...
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r22.xyzw, r12.x, l(0), t15.wxyz
        r22.x = samp0[]..swiz;
        r22.y = samp0[]..swiz;
        r22.z = samp0[]..swiz;
        r22.w = samp0[]..swiz;
        ...
        r12.z = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r23.xyzw, r12.x, l(116), t15.zwxy
        r23.x = samp0[]..swiz;
        r23.y = samp0[]..swiz;
        r23.z = samp0[]..swiz;
        r23.w = samp0[]..swiz;
        ...
        r30.w = samp0[]..swiz;
          ...
          r15.z = r15.z * r15.w;
          r15.w = dot(r28.xyz, r24.xyz);
          r15.w = saturate(r15.w + r28.w);
          r15.z = r15.z * r15.w;
          r15.w = dot(r29.xyz, r24.xyz);
          ...
          if (r13.x != 0) {
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r26.xyzw, r12.x, l(16), t15.xyzw
          r26.x = samp0[]..swiz;
          r26.y = samp0[]..swiz;
          r26.z = samp0[]..swiz;
          r26.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r27.xyzw, r12.x, l(32), t15.yxwz
          r27.x = samp0[]..swiz;
          r27.y = samp0[]..swiz;
          r27.z = samp0[]..swiz;
          r27.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r28.xyzw, r12.x, l(48), t15.xyzw
          r28.x = samp0[]..swiz;
          r28.y = samp0[]..swiz;
          r28.z = samp0[]..swiz;
          r28.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r29.xyzw, r12.x, l(64), t15.zwxy
          r29.x = samp0[]..swiz;
          r29.y = samp0[]..swiz;
          r29.z = samp0[]..swiz;
          r29.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r30.xyzw, r12.x, l(80), t15.xyzw
          r30.x = samp0[]..swiz;
          r30.y = samp0[]..swiz;
          r30.z = samp0[]..swiz;
          r30.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r31.xyzw, r12.x, l(132), t15.zwxy
          r31.x = samp0[]..swiz;
          r31.y = samp0[]..swiz;
          r31.z = samp0[]..swiz;
          r31.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r32.xyzw, r12.x, l(148), t15.zwxy
          r32.x = samp0[]..swiz;
          r32.y = samp0[]..swiz;
          r32.z = samp0[]..swiz;
          r32.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r33.xyzw, r12.x, l(164), t15.zwxy
          r33.x = samp0[]..swiz;
          r33.y = samp0[]..swiz;
          r33.z = samp0[]..swiz;
          r33.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r34.xyzw, r12.x, l(180), t15.zwxy
          r34.x = samp0[]..swiz;
          r34.y = samp0[]..swiz;
          r34.z = samp0[]..swiz;
          r34.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r35.xyzw, r12.x, l(196), t15.xyzw
          r35.x = samp0[]..swiz;
          r35.y = samp0[]..swiz;
          r35.z = samp0[]..swiz;
          r35.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r36.xy, r12.x, l(212), t15.xyxx
          r36.x = samp0[]..swiz;
          r36.y = samp0[]..swiz;
            r21.z = r25.y * r12.z + r21.z;
            r12.x = r12.y * r23.z;
            r23.z = r31.z;
            r12.y = dot(r9.xyz, r23.xyz);
            ...
            r31.z = r32.z;
            r12.z = dot(r9.xyz, r31.xyz);
            r13.x = dot(r24.xyz, r31.xyz);
            r13.x = r13.x + -r32.w;
            r13.w = cmp(r13.x >= 0);
            ...
            r32.z = r33.z;
            r12.z = dot(r9.xyz, r32.xyz);
            r13.x = dot(r24.xyz, r32.xyz);
            r13.x = r13.x + -r33.w;
            r13.w = cmp(r13.x >= 0);
            r13.x = max(abs(r13.x), r6.w);
            r13.x = r13.w ? r13.x : -r13.x;
            ...
            r12.y = min(r12.y, abs(r12.z));
            r36.zw = r35.zw;
            r12.z = dot(r9.zxy, r36.xzw);
            r13.x = dot(r24.zxy, r36.xzw);
            r13.x = r13.x + -r36.y;
            r13.w = cmp(r13.x >= 0);
            r13.x = max(abs(r13.x), r6.w);
            r13.x = r13.w ? r13.x : -r13.x;
            ...
            r31.w = (uint)r12.z;
            r15.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r31.xyzw, r12.y).xyz;
            ...
            r12.y = dot(r24.xyz, float3(0.212599993,0.715200007,0.0722000003));
            ...
            r22.x = r20.w;
            r22.yz = r21.xy;
            r21.xyw = r15.zwy * r12.xxx + r22.yzx;
            r20.w = r21.w;
          }
        }
      }
  ...
  if (r3.w != 0) {
    ...
    r8.z = 0;
    while (true) {
      r8.w = cmp((uint)r8.z >= (uint)r8.y);
      if (r8.w != 0) break;
      r11.z = (uint)r8.z >> 5;
      r12.xyz = (int3)r10.xyz + (int3)r11.xyz;
      r8.w = visibleProbes.Load(r12.xyzw).x;
      r10.w = cmp((int)r0.z == (int)r8.z);
      if (r0.w == 0) r11.z = 0; else if (r0.w+0 < 32) {       r11.z = (uint)r8.w << (32-(r0.w + 0)); r11.z = (uint)r11.z >> (32-r0.w);      } else r11.z = (uint)r8.w >> 0;
      ...
      while (true) {
        ...
        r24.y = samp0[]..swiz;
          ...
          r24.w = samp0[]..swiz;
            ...
            if (6 == 0) r16.w = 0; else if (6+25 < 32) {             r16.w = (uint)r24.w << (32-(6 + 25)); r16.w = (uint)r16.w >> (32-6);            } else r16.w = (uint)r24.w >> 25;
          // Known bad code for instruction (needs manual fix):
          ...
          r31.w = samp0[]..swiz;
            ...
            r17.w = saturate(r17.w + r26.w);
            r21.w = dot(r27.xyz, r25.xyz);
            r21.w = saturate(r21.w + r27.w);
            r17.w = r21.w * r17.w;
            r21.w = dot(r28.xyz, r25.xyz);
            r21.w = saturate(r21.w + r28.w);
            r17.w = r21.w * r17.w;
            r21.w = dot(r29.xyz, r25.xyz);
            r21.w = saturate(r21.w + r29.w);
            r17.w = r21.w * r17.w;
            r21.w = dot(r30.xyz, r25.xyz);
            r21.w = saturate(r21.w + r30.w);
            r17.w = r21.w * r17.w;
            r21.w = dot(r31.xyz, r25.xyz);
            r21.w = saturate(r21.w + r31.w);
            r13.x = r21.w * r17.w;
            r17.w = (int)r15.z & 1;
            r26.xy = r17.ww ? r13.xy : r13.zx;
            r13.x = r15.z;
            r27.xy = r26.xy;
            r17.w = 1;
            while (true) {
              r21.w = cmp((int)r17.w >= (int)r16.w);
              if (r21.w != 0) break;
            ...
            r33.w = samp0[]..swiz;
              ...
              r21.w = -r21.w * r23.w + 1;
              r21.w = r27.y * r21.w;
              r15.y = r26.w ? r21.w : r27.z;
              r27.xy = r26.zz ? r27.xy : r15.xy;
              r17.w = (int)r17.w + 1;
              r13.x = r25.w;
            }
            r13.x = saturate(r27.y + -r11.z);
            r14.w = r13.x * r15.w;
            r15.y = cmp(0 < r14.w);
            if (r15.y != 0) {
            // Known bad code for instruction (needs manual fix):
            ...
            r37.y = samp0[]..swiz;
              ...
              r13.w = min(abs(r14.w), r13.w);
              r37.zw = r36.zw;
              r14.w = dot(r9.zxy, r37.xzw);
              r15.y = dot(r25.zxy, r37.xzw);
              r15.y = r15.y + -r37.y;
              r15.z = cmp(r15.y >= 0);
              r15.y = max(abs(r15.y), r6.w);
              r15.y = r15.z ? r15.y : -r15.y;
              ...
              r32.w = (uint)r14.w;
              r15.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r32.xyzw, r13.w).xyz;
  ...
  r11.xyz = r18.xyz * r0.zzz;
  r8.yzw = r19.xyz * r0.zzz;
  r0.w = cmp(r19.w < 0.99000001);
  if (r0.w != 0) {
    r0.w = 1 + -r19.w;
    ...
    r11.xyz = r18.xyz * r0.zzz + r12.xyz;
    r9.w = 0;
    r12.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r9.xyzw, r6.z).xyz;
    r0.z = sunConstants.globalProbeExposure * r0.w + -r2.w;
    r0.z = r0.y * r0.z + r2.w;
    r8.yzw = r12.xyz * r0.zzz + r8.yzw;
  }
  ...
  r12.xyz = r8.zwy * r0.yyy;
  r0.yzw = r8.yzw * r0.zzz;
  r2.w = sqrt(r5.z);
  r2.w = r2.w * 0.5 + 0.5;
  r2.w = r2.w * r2.w;
  r3.w = 0.5 * r2.w;
  ...
  if (r6.w == 0) {
    ...
    if (r9.w != 0) {
      ...
      while (true) {
        ...
        if (r13.x != 0) break;
        r13.x = (uint)r9.w;
        r13.yz = -sunConstants.splitPinTransform[r13.x].xy + r8.yz;
    ...
    if (r13.x != 0) {
      ...
      r14.xz = rcp(r13.yy);
      r14.y = -r14.z;
      r13.yzw = r8.yzy * r14.xyz + r13.zwz;
    ...
    r14.y = samp0[]..swiz;
      ...
      r17.w = samp0[]..swiz;
        ...
        r13.z = samp0[]..swiz;
          ...
          r13.z = r8.y * r13.w + r13.z;
          r13.y = r8.z * r13.y + r13.z;
    ...
    if (r13.x == 0) {
      if (enableDitheredShadow == 0) {
        ...
        r13.z = r9.w + r8.w;
        r8.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r13.xyz, r6.w).x;
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          r15.xy = r14.ww ? r8.yz : r14.xy;
          r15.z = r14.w ? sunConstants.splitPinTransform[r9.w].w : sunConstants.splitPinTransform[r8.w].w;
          r14.w = r14.w ? r9.w : r8.w;
          ...
          r15.z = (uint)r14.w;
          r14.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r15.xyz, r6.w).x;
  ...
  if (r6.w != 0) {
    ...
    if (r6.w != 0) {
      ...
      if (sunConstants.sunCookieIndex != 0) {
        ...
        r13.w = 1;
        r8.y = dot(sunConstants.sunCookieTransform[0].xyzw, r13.xyzw);
        r8.z = dot(sunConstants.sunCookieTransform[1].xyzw, r13.xyzw);
        r13.xy = frac(r8.yz);
      ...
      r10.w = samp0[]..swiz;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r13.xyzw, r9.w, l(68), t12.xyzw
      r13.x = samp0[]..swiz;
      r13.y = samp0[]..swiz;
      r13.z = samp0[]..swiz;
      r13.w = samp0[]..swiz;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r14.xyzw, r9.w, l(84), t12.xyzw
      r14.x = samp0[]..swiz;
      r14.y = samp0[]..swiz;
      r14.z = samp0[]..swiz;
      r14.w = samp0[]..swiz;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r15.xyzw, r9.w, l(132), t12.xyzw
      r15.x = samp0[]..swiz;
      r15.y = samp0[]..swiz;
      r15.z = samp0[]..swiz;
      r15.w = samp0[]..swiz;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r16.xyzw, r9.w, l(148), t12.xyzw
      r16.x = samp0[]..swiz;
      r16.y = samp0[]..swiz;
      r16.z = samp0[]..swiz;
      r16.w = samp0[]..swiz;
        r17.x = abs(r5.w) * -0.200000003 + 0.400000006;
        r17.xyz = r2.xyz * r17.xxx + v7.xyz;
        r17.w = 1;
        ...
        if (r13.z == 0) {
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r13.z, r9.w, l(28), t12.xxxx
        r13.z = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r14.xyzw, r9.w, l(100), t12.xyzw
        r14.x = samp0[]..swiz;
        r14.y = samp0[]..swiz;
        r14.z = samp0[]..swiz;
        r14.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r16.xy, r9.w, l(164), t12.xyxx
        r16.x = samp0[]..swiz;
        r16.y = samp0[]..swiz;
          r9.w = dot(r14.xyzw, r17.xyzw);
          ...
          if (enableDitheredShadow != 0) {
            ...
            r14.z = (uint)r13.x;
            r13.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r14.xyz, r9.w).x;
          }
          r9.w = r13.y * r13.y;
          r9.w = r9.w * r13.y;
        } else {
      ...
      r15.zw = r14.xy;
      r12.zw = r0.yz;
      r13.xyzw = r5.wwww ? r15.xyzw : r12.xyzw;
      r0.w = r5.w ? r14.z : r0.w;
      r12.z = r11.w;
      r12.xy = r13.xy;
      r0.yz = r13.zw;
    }
      ...
      r31.y = samp0[]..swiz;
        ...
        r36.w = samp0[]..swiz;
          ...
          switch (r11.w) {
            ...
            r14.z = saturate(-r12.w / r36.x);
            r40.xyz = r14.zzz * r37.xyz + r38.xyz;
            r40.xyz = r11.www ? r40.xyz : r30.yzw;
            r40.xyz = -v7.xyz + r40.xyz;
            r14.w = dot(r40.xyz, r40.xyz);
            r19.w = rsqrt(r14.w);
              ...
              if (r24.w != 0) {
                ...
                if (r24.w != 0) {
                  ...
                  while (true) {
                    ...
                    if (r28.w != 0) break;
                    r42.y = dot(icb[r27.w+0].yx, r13.xy);
                    r42.z = dot(icb[r27.w+0].yx, r13.yz);
                ...
                if (r24.w != 0) {
                  ...
                  r14.z = cmp(0 < (uint)r12.w);
                  r14.z = r4.w ? r14.z : 0;
                  if (r14.z != 0) {
                    r12.w = (int)r12.w + numLights;
                    r12.w = (int)r12.w + -1;
                  // Known bad code for instruction (needs manual fix):
                                    ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r14.z, r12.w, l(52), t12.xxxx
                  r14.z = samp0[]..swiz;
                  // Known bad code for instruction (needs manual fix):
                  ...
                  r19.w = abs(r17.x) * r5.y + -abs(r17.x);
                  r17.x = abs(r17.x) * r19.w + 1;
                  r19.w = r12.w * r2.w + r3.w;
                  r17.x = r17.x * r17.x;
                  r17.x = r17.x * r19.w;
                  r17.x = rcp(r17.x);
                  r12.w = r12.w * r24.w;
                  ...
                  r15.xyz = r14.zzz ? r18.xyz : r15.xyz;
                  r28.xyz = r14.zzz ? r38.xyz : r28.xyz;
                  r29.xyz = r14.zzz ? r37.xyz : r29.xyz;
                }
              }
            }
            break;
            ...
            r38.w = samp0[]..swiz;
              ...
              r19.w = samp0[]..swiz;
                ...
                r23.w = r23.w / r24.w;
                r23.w = min(1, r23.w);
                r32.xy = saturate(r14.ww * r32.xz + r32.yw);
                ...
                r19.xy = r32.xy / r14.ww;
                r14.w = cmp(r41.w < 0.00048828125);
                if (r14.w != 0) {
                  r42.y = r43.x;
              ...
              if (r14.w != 0) {
                ...
                if (r14.w != 0) {
                  ...
                  r20.xyz = r2.xyz * r14.www + v7.xyz;
                  r37.xyz = r36.xyz;
                  r14.w = dot(r37.xyzw, r20.xyzw);
                ...
                if (r14.w != 0) {
                  ...
                  r17.x = dot(r2.xyz, r18.xyz);
                  r18.x = abs(r17.x) * r5.y + -abs(r17.x);
                  r17.x = abs(r17.x) * r18.x + 1;
                  r14.z = r14.z * r2.w + r3.w;
                  r17.x = r17.x * r17.x;
                  r14.z = r17.x * r14.z;
                  r14.z = rcp(r14.z);
                  r14.z = r14.z * r14.w;
                  r10.w = r14.z * r10.w;
                  r10.w = 0.25 * r10.w;
                  r18.xyz = r10.www * r19.xyw + r29.xyz;
                  r11.w = saturate(1 + -r11.w);
                  r14.z = r11.w * r11.w;
                  r14.z = r14.z * r14.z;
                  r11.w = r14.z * r11.w;
                  ...
                  r28.xyz = r12.www ? r19.xyw : r28.xyz;
