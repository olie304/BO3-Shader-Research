...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r37.w = samp0[]..swiz;
    ...
    r27.x = dot(v2.xyz, r19.xyz);
    r27.y = dot(v2.xyz, r28.xyz);
    r27.z = dot(v2.xyz, r21.xyz);
  ...
  if (r2.w == 0) {
        ...
        r12.y = samp0[]..swiz;
          ...
          r31.w = samp0[]..swiz;
            ...
            r37.y = samp0[]..swiz;
              ...
              r32.x = dot(v2.xyz, r24.xyz);
              r32.y = dot(v2.xyz, r25.xyz);
          ...
          r25.y = samp0[]..swiz;
            ...
            r32.w = samp0[]..swiz;
              ...
              r38.y = samp0[]..swiz;
                ...
                r33.x = dot(v2.xyz, r24.xyz);
                r33.y = dot(v2.xyz, r25.xyz);
                r33.z = dot(v2.xyz, r29.xyz);
    ...
    if (r4.x != 0) {
      ...
      r8.yzw = cmp(float3(0,0,0) < v2.xyz);
  ...
  if (noReceiveShadow == 0) {
    r5.z = dot(v2.xyz, sunConstants.wldDir.xyz);
    r5.z = cmp(0 >= abs(r5.z));
    if (r5.z != 0) {
      r5.w = 0;
    }
