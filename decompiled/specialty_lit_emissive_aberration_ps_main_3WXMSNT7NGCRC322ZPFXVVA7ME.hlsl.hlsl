// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:41:22 2021
...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  if (r2.y != 0) {
    ...
    r0.xyz = r2.zzz ? r5.xyw : r6.xyz;
  }
  r2.yzw = debugColorOverride.xyz + -r0.xyz;
  r0.xyz = debugColorOverride.www * r2.yzw + r0.xyz;
  r2.yzw = debugSpecularOverride.xyz + -r1.xyz;
  r1.xyz = debugSpecularOverride.www * r2.yzw + r1.xyz;
  r2.x = r2.x + -r1.w;
  r2.y = debugGlossOverride.w * r2.x + r1.w;
  r1.w = debugOcclusionOverride.x + -r0.w;
  r0.w = debugOcclusionOverride.w * r1.w + r0.w;
  ...
  r6.x = dot(r5.xyz, v5.xyz);
  r6.y = dot(r5.xyz, v6.xyz);
  r2.z = dot(r5.xyz, v4.xyz);
  r2.w = cmp(0 < r2.z);
  r6.xy = -r6.xy / r2.zz;
  r2.zw = r2.ww ? r6.xy : 0;
  r6.xy = float2(-0.5,-0.5) + v2.xy;
  r4.w = 9.99999975e-06 + layerDepth;
  r2.zw = r4.ww * r2.zw;
  r2.zw = scaleUVs.xy * r2.zw;
  r2.zw = r6.xy * scaleUVs.xy + r2.zw;
  ...
  r7.y = r7.x;
  r7.z = r6.x;
  r8.x = dot(r7.yz, r2.zw);
  r7.x = -r6.x;
  r8.y = dot(r7.xy, r2.zw);
  r2.zw = gameTime.ww * scrollUVs.xy;
  r2.zw = r2.zw * scaleUVs.xy + r8.xy;
  ...
  r6.xy = saturate(r2.zw);
  r2.zw = clampU ? r6.xy : r2.zw;
  r4.x = saturate(dot(r5.xyz, r4.xyz));
  r4.y = emissiveMap1.Sample(colorSampler_s, r2.zw).w;
  r6.x = 0;
  r6.yz = gameTime.ww * aberrationFactors.xy;
  r7.xyzw = -r6.xyzz + r2.zwzw;
  r8.x = emissiveMap1.Sample(colorSampler_s, r7.xy).x;
  r8.y = emissiveMap1.Sample(colorSampler_s, r7.zw).y;
  r7.xz = float2(0,1);
  r7.y = gameTime.w * aberrationFactors.z;
  r2.zw = -r7.xy + r2.zw;
  r8.z = emissiveMap1.Sample(colorSampler_s, r2.zw).z;
  r2.z = log2(r4.x);
  ...
  r2.z = frac(r2.z);
  r8.y = gameTime.w * flickerSpeed + r2.z;
  r8.x = flickerSeed.x;
  r2.z = flickerLookupMap.SampleLevel(lookupSampler_s, r8.xy, 0).x;
  r2.z = log2(abs(r2.z));
  r2.z = flickerPower * r2.z;
  r2.z = exp2(r2.z);
  r2.w = flickerRange.y + -flickerRange.x;
  r2.z = r2.z * r2.w + flickerRange.x;
  r2.w = outlineMap.Sample(colorSampler_s, v2.xy).w;
  r6.xyzw = v2.xyxy + r6.xyzz;
  r8.x = outlineMap.Sample(colorSampler_s, r6.xy).x;
  r8.y = outlineMap.Sample(colorSampler_s, r6.zw).y;
  r6.xy = v2.xy + r7.xy;
  r8.z = outlineMap.Sample(colorSampler_s, r6.xy).z;
  r6.xyz = emissiveTint1.xyz * r8.xyz;
  r2.w = outlineHDR * r2.w;
  ...
  r5.w = dot(-r5.xyz, r3.xyz);
  r5.w = r5.w + r5.w;
  r12.xyz = r3.xyz * -r5.www + -r5.xyz;
  r5.w = 17 * r2.y;
  r5.w = exp2(r5.w);
  r5.w = 2 + r5.w;
  r5.w = 2 / r5.w;
  ...
  r8.w = 100 * r8.w;
  r9.zw = -r8.yy * float2(10,5) + float2(6.85740995,7.08500004);
  r9.z = exp2(r9.z);
  r9.z = r9.z * r2.x;
  r10.w = r8.z * r8.y;
  ...
  r9.w = exp2(r9.w);
  r9.w = r9.w * r2.x;
  r9.zw = float2(9.1368103,9.70808983) * r9.zw;
  r9.z = max(r9.z, r9.w);
  ...
  r7.x = 0;
  while (true) {
    r7.y = cmp((uint)r7.x >= numRefProbes);
    if (r7.y != 0) break;
    r14.z = (uint)r7.x >> 5;
    r15.xyz = (int3)r13.xyz + (int3)r14.xyz;
    r7.y = visibleProbes.Load(r15.xyzw).x;
  ...
  r40.z = samp0[]..swiz;
  r40.w = samp0[]..swiz;
    r11.w = dot(r35.xyz, r15.xyz);
    r11.w = saturate(r11.w + r35.w);
    r13.w = dot(r36.xyz, r15.xyz);
    ...
    r11.w = min(abs(r13.w), r11.w);
    r34.zw = r33.zw;
    r13.w = dot(r12.zxy, r34.xzw);
    r16.x = dot(r15.zxy, r34.xzw);
    r16.x = r16.x + -r34.y;
    r16.w = cmp(r16.x >= 0);
    r16.x = max(abs(r16.x), r8.w);
    r16.x = r16.w ? r16.x : -r16.x;
      ...
      if (r17.z != 0) {
        ...
        if (r9.w != 0) {
          ...
          r36.w = samp0[]..swiz;
            ...
            r17.w = -r17.w * r18.z + 1;
            r17.w = r30.y * r17.w;
            r7.w = r19.w ? r17.w : r22.z;
            r30.xy = r19.zz ? r30.xy : r7.zw;
            r17.z = (int)r17.z + 1;
            r16.w = r18.w;
          }
          ...
          if (r16.w != 0) {
            ...
            r17.z = r16.w * r9.z;
            r30.xzw = r23.xyz * r7.www;
            r7.w = dot(r30.xzw, float3(0.212599993,0.715200007,0.0722000003));
            r7.w = r9.z * r16.w + r7.w;
            r7.w = r17.z / r7.w;
            r33.x = r29.w;
            r33.yz = r28.yz;
            r31.xyw = r30.zwx * r7.www + r33.yzx;
            r32.w = r31.w;
          } else {
            r32.xyzw = r29.xyzw;
            r31.xyz = r28.yzw;
  ...
  if (r2.w == 0) {
    ...
    while (true) {
      ...
      r11.y = cmp((int)r7.x == (int)r9.w);
      bitmask.z = ((~(-1 << r7.y)) << 0) & 0xffffffff;  r11.z = (((uint)0 << 0) & bitmask.z) | ((uint)r10.w & ~bitmask.z);
      r10.w = r11.y ? r11.z : r10.w;
      r11.y = cmp((int)r7.z == (int)r9.w);
      if (r7.w == 0) r11.z = 0; else if (r7.w+0 < 32) {       r11.z = (uint)r10.w << (32-(r7.w + 0)); r11.z = (uint)r11.z >> (32-r7.w);      } else r11.z = (uint)r10.w >> 0;
      r10.w = r11.y ? r11.z : r10.w;
    ...
    if (r7.z != 0) {
      ...
      r7.w = 0;
      while (true) {
        r9.w = cmp((uint)r7.w >= (uint)r2.w);
        if (r9.w != 0) break;
        r14.z = (uint)r7.w >> 5;
        r15.xyz = (int3)r13.xyz + (int3)r14.xyz;
        r9.w = visibleProbes.Load(r15.xyzw).x;
        r10.w = cmp((int)r7.x == (int)r7.w);
        if (r7.y == 0) r13.w = 0; else if (r7.y+0 < 32) {         r13.w = (uint)r9.w << (32-(r7.y + 0)); r13.w = (uint)r13.w >> (32-r7.y);        } else r13.w = (uint)r9.w >> 0;
        r9.w = r10.w ? r13.w : r9.w;
    ...
    r21.xyz = r24.xyz * r2.www;
    r7.x = cmp(r24.w < 0.99000001);
    if (r7.x != 0) {
      r7.x = 1 + -r24.w;
      ...
      r7.yzw = r16.xyz * r7.yyy;
      r16.xyz = r14.wwy + r11.yzw;
      r16.xyz = gProbeYArray.SampleLevel(samplerLinearClamp_s, r16.xyz, 0).xyz;
      r16.xyz = r16.xyz * r7.zzz;
      r15.xyz = r15.xyz * r7.yyy + r16.xyz;
      r11.yzw = r14.wwz + r11.yzw;
      r11.yzw = gProbeZArray.SampleLevel(samplerLinearClamp_s, r11.yzw, 0).xyz;
      r7.yzw = r11.yzw * r7.www + r15.xyz;
      r3.w = 0;
      r11.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r3.xyzw, 6).xyz;
      r7.yzw = r11.yzw * r7.yzw;
      r3.w = dot(r7.yzw, float3(0.212599993,0.715200007,0.0722000003));
      r20.xyz = r23.xyz * r2.www + r7.yzw;
      r12.w = 0;
      r7.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r12.xyzw, r8.z).xyz;
      r2.w = sunConstants.globalProbeExposure * r7.x + -r3.w;
      r2.w = r2.y * r2.w + r3.w;
      r21.xyz = r7.yzw * r2.www + r21.xyz;
    }
  } else {
    r21.x = r20.w;
  }
  ...
  r7.xyz = r20.xyz * r0.www;
  r8.yz = r2.xy * float2(0.984375,0.984375) + float2(0.0078125,0.0078125);
  r8.yz = gEnvBRDFGeneric.SampleLevel(samplerLinear_s, r8.yz, 0).xy;
  r11.yzw = r21.xyz * r2.www;
  r14.xyz = r11.zwy * r8.yyy;
  r8.yzw = r11.yzw * r8.zzz;
  r0.w = sqrt(r6.w);
  r0.w = r0.w * 0.5 + 0.5;
  r0.w = r0.w * r0.w;
  r2.y = 0.5 * r0.w;
  ...
  r0.w = r2.w * r0.w;
  r2.y = r2.y * r2.w;
  r2.w = dot(r3.xyz, sunConstants.wldDir.xyz);
  r3.w = saturate(r2.w);
  r9.z = cmp(0 >= r3.w);
  if (r9.z != 0) {
    r9.w = 0;
  ...
  if (r9.z == 0) {
    ...
    r9.z = -sunConstants.splitDepthOffset + r11.w;
    r9.z = -r9.z * 6.10351563e-05 + 1;
    r10.w = saturate(r9.z);
    r10.w = cmp(r9.z == r10.w);
    if (r10.w != 0) {
      r10.w = 0;
      r12.w = 0;
      while (true) {
        ...
        if (r13.w != 0) break;
        r13.w = (uint)r10.w;
        r15.xy = -sunConstants.splitPinTransform[r13.w].xy + r11.yz;
        r15.x = max(abs(r15.x), abs(r15.y));
        r12.w = sunConstants.splitPinTransform[r13.w].z * r15.x;
        r13.w = cmp(r12.w < 1);
        if (r13.w != 0) {
          break;
        }
    ...
    if (r13.w == 0) {
      if (enableDitheredShadow == 0) {
        ...
        r15.z = r11.w + r10.w;
        r11.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r15.xyz, r9.z).x;
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          if (r16.z != 0) break;
          r16.z = cmp((uint)r12.w < (uint)r15.w);
          r17.xy = r16.zz ? r11.yz : r16.xy;
          r16.w = r16.z ? sunConstants.splitPinTransform[r10.w].w : sunConstants.splitPinTransform[r11.w].w;
          r16.z = r16.z ? r10.w : r11.w;
          ...
          r17.z = (uint)r16.z;
          r16.z = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r17.xyz, r9.z).x;
  ...
  if (r9.z != 0) {
    ...
    if (r9.z != 0) {
        ...
        r15.w = samp0[]..swiz;
          ...
          if (enableDitheredShadow != 0) {
            ...
            while (true) {
              ...
              if (r17.w != 0) break;
              r18.x = dot(icb[r16.w+0].yx, r15.xy);
              r18.y = dot(icb[r16.w+0].yx, r15.yz);
              r17.xy = r18.xy * r12.ww + r16.xy;
              r17.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r17.xyz, r10.w).x;
              r15.w = r17.x * 0.125 + r15.w;
              r16.w = (int)r16.w + 1;
            }
          } else {
            r16.z = (uint)r13.w;
            r15.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r10.w).x;
          }
          r10.w = r15.w * r15.w;
          r10.w = r10.w * r15.w;
        } else {
      ...
      r10.w = r10.w + -r3.w;
      r10.w = r6.w * r10.w + r3.w;
      r10.w = r10.w * r9.w;
      r2.w = cmp(0 < r2.w);
      r15.xyz = r10.www * r11.yzw + r7.xyz;
      r16.xyz = -v7.xyz * r1.www + sunConstants.wldDir.xyz;
      r1.w = dot(r16.xyz, r16.xyz);
      r1.w = rsqrt(r1.w);
      r16.xyz = r16.xyz * r1.www;
      r1.w = dot(r16.xyz, r5.xyz);
      r10.w = dot(r3.xyz, r16.xyz);
      r12.w = abs(r10.w) * r5.w + -abs(r10.w);
      r10.w = abs(r10.w) * r12.w + 1;
      r3.w = r3.w * r0.w + r2.y;
      r10.w = r10.w * r10.w;
      r3.w = r10.w * r3.w;
      r3.w = rcp(r3.w);
      ...
      r3.w = r9.w * r3.w;
      r3.w = 0.25 * r3.w;
      r16.xyz = r3.www * r11.yzw + r8.yzw;
      r1.w = saturate(1 + -r1.w);
      r9.z = r1.w * r1.w;
      r9.z = r9.z * r9.z;
      r1.w = r9.z * r1.w;
      r1.w = r3.w * r1.w;
      r17.xyz = r1.www * r11.zwy + r14.xyz;
      r15.w = r17.z;
      r7.w = r14.z;
      r7.xyzw = r2.wwww ? r15.xyzw : r7.xyzw;
      r17.zw = r16.xy;
      r14.zw = r8.yz;
      r15.xyzw = r2.wwww ? r17.xyzw : r14.xyzw;
      r8.w = r2.w ? r16.z : r8.w;
      r14.z = r7.w;
      r14.xy = r15.xy;
      r8.yz = r15.zw;
    }
              ...
              if (r25.w != 0) {
                ...
                if (r25.w != 0) {
                  ...
                  while (true) {
                    ...
                    if (r29.w != 0) break;
                    r44.y = dot(icb[r28.w+0].yx, r15.xy);
                    r44.z = dot(icb[r28.w+0].yx, r15.yz);
            ...
            r40.w = samp0[]..swiz;
              ...
              if (r16.z != 0) {
                ...
                if (r16.z != 0) {
                  ...
                  r16.w = r16.w + -r14.w;
                  r16.w = r6.w * r16.w + r14.w;
                  r16.w = r16.w * r10.w;
                  r13.w = cmp(0 < r13.w);
                  r23.xyz = r16.www * r21.xyw + r17.xyz;
                  r20.xyz = r20.xyz * r12.www + r5.xyz;
                  r12.w = dot(r20.xyz, r20.xyz);
                  r12.w = rsqrt(r12.w);
                  r20.xyz = r20.xyz * r12.www;
                  r12.w = dot(r20.xyz, r5.xyz);
                  r16.w = dot(r3.xyz, r20.xyz);
                  r20.x = abs(r16.w) * r5.w + -abs(r16.w);
                  r16.w = abs(r16.w) * r20.x + 1;
                  r14.w = r14.w * r0.w + r2.y;
                  r16.w = r16.w * r16.w;
                  r14.w = r16.w * r14.w;
                  r14.w = rcp(r14.w);
                  r14.w = r14.w * r16.z;
  ...
  r2.xyw = float3(1,1,1) + -r1.xyz;
  r2.xyw = r28.xyz * r2.xyw;
  r1.xyz = r29.xyz * r1.xyz + r2.xyw;
