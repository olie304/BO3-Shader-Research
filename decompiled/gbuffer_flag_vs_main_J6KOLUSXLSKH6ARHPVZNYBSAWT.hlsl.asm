...
if_nz r2.x
  ...
  rsq r3.x, r3.x
  mul r0.yzw, r3.xxxx, r6.xxyz
  dp3 r3.x, r4.xyzx, r4.xyzx
  rsq r3.x, r3.x
  mul r2.yzw, r3.xxxx, r4.xxyz
else 
  mov r5.xyz, r1.xyzx
endif 
...
mov r7.w, r8.y
dp4 r3.w, r5.xyzw, r7.xyzw
mov r9.w, r8.z
dp4 r4.z, r5.xyzw, r9.xyzw
