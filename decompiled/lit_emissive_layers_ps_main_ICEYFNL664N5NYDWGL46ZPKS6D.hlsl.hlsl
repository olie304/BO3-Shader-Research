...
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) r1.x, r7.z, l(0), t0.xxxx
r1.x = samp0[]..swiz;
  ...
  if (r2.w != 0) {
    ...
    r3.xy = scrollUVs.xy * r1.xx;
    r3.xy = r3.xy * scaleUVs.xy + r10.xy;
    ...
    r9.xy = clampU ? r3.zw : r3.xy;
  }
  r3.xyzw = emissiveMap1.Sample(colorSampler_s, r9.xy).xyzw;
  ...
  r1.x = frac(r1.x);
  r4.y = gameTime.w * flickerSpeed + r1.x;
  r4.x = flickerSeed.x;
