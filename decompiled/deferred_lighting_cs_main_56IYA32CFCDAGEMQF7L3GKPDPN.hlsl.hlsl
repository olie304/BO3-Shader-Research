...
// unknown dcl_: dcl_thread_group 8, 8, 1
  r0.x = mad(permuteStride, 61, (int)vThreadGroupID.x);
...
r0.y = samplerLinear[]..swiz;
  ...
  r14.xz = r2.zw * r1.zw;
  r14.w = r1.z * r1.w;
  r0.w = dot(r12.xyzw, r14.xyzw);
  r13.xyzw = r13.xyzw + -r0.xxxx;
  r1.z = min(abs(r13.z), abs(r13.w));
  r1.z = min(abs(r13.y), r1.z);
  r1.z = min(abs(r13.x), r1.z);
  r1.w = max(abs(r13.z), abs(r13.w));
  r1.w = max(abs(r13.y), r1.w);
  r1.w = max(abs(r13.x), r1.w);
  r13.xyz = cmp(r1.zzz == abs(r13.yzw));
  r1.z = r13.x ? r12.y : r12.x;
  r1.z = r13.y ? r12.z : r1.z;
  r1.z = r13.z ? r12.w : r1.z;
  ...
  while (true) {
    ...
    if (r8.w != 0) {
      r7.w = (int)r7.w * 14;
      r19.xyz = -refProbeConstantsCB[r7.w].data[0].xyz + r9.xyz;
      ...
      r12.w = (int)r8.w * 6;
      r13.w = dot(refProbeAttenuationConstantsCB[r12.w].data[0].xyz, r19.xyz);
      r13.w = saturate(refProbeAttenuationConstantsCB[r12.w].data[0].w + r13.w);
      r14.z = dot(refProbeAttenuationConstantsCB[r12.w].data[1].xyz, r19.xyz);
      r14.z = saturate(refProbeAttenuationConstantsCB[r12.w].data[1].w + r14.z);
      r13.w = r14.z * r13.w;
      r14.z = dot(refProbeAttenuationConstantsCB[r12.w].data[2].xyz, r19.xyz);
      r14.z = saturate(refProbeAttenuationConstantsCB[r12.w].data[2].w + r14.z);
      r13.w = r14.z * r13.w;
      r14.z = dot(refProbeAttenuationConstantsCB[r12.w].data[3].xyz, r19.xyz);
      r14.z = saturate(refProbeAttenuationConstantsCB[r12.w].data[3].w + r14.z);
      r13.w = r14.z * r13.w;
      r14.z = dot(refProbeAttenuationConstantsCB[r12.w].data[4].xyz, r19.xyz);
      r14.z = saturate(refProbeAttenuationConstantsCB[r12.w].data[4].w + r14.z);
      r13.w = r14.z * r13.w;
      r14.z = dot(refProbeAttenuationConstantsCB[r12.w].data[5].xyz, r19.xyz);
      ...
      while (true) {
        ...
        r14.w = (int)r14.w * 6;
        r15.w = dot(refProbeAttenuationConstantsCB[r14.w].data[0].xyz, r19.xyz);
        r15.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[0].w + r15.w);
        r15.w = r20.x * r15.w;
        r16.w = dot(refProbeAttenuationConstantsCB[r14.w].data[1].xyz, r19.xyz);
        r16.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[1].w + r16.w);
        r15.w = r16.w * r15.w;
        r16.w = dot(refProbeAttenuationConstantsCB[r14.w].data[2].xyz, r19.xyz);
        r16.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[2].w + r16.w);
        r15.w = r16.w * r15.w;
        r16.w = dot(refProbeAttenuationConstantsCB[r14.w].data[3].xyz, r19.xyz);
        r16.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[3].w + r16.w);
        r15.w = r16.w * r15.w;
        r16.w = dot(refProbeAttenuationConstantsCB[r14.w].data[4].xyz, r19.xyz);
        r16.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[4].w + r16.w);
        r15.w = r16.w * r15.w;
        r16.w = dot(refProbeAttenuationConstantsCB[r14.w].data[5].xyz, r19.xyz);
        ...
        r14.w = -r15.w * r14.w + 1;
        r14.w = r20.y * r14.w;
        r14.y = r20.z ? r14.w : r20.w;
        r20.xy = r19.ww ? r20.xy : r14.xy;
        r14.z = (int)r14.z + 1;
        r13.w = r16.w;
      }
      r20.y = saturate(r20.y);
      r8.w = refProbeConstantsCB[r7.w].data[6].y * r20.y;
      r9.w = cmp(0 < r8.w);
      if (r9.w != 0) {
        r18.w = r20.y * refProbeConstantsCB[r7.w].data[6].y + r18.w;
        r8.w = refProbeConstantsCB[r7.w].data[7].y * r8.w;
        r21.x = refProbeConstantsCB[r7.w].data[7].w;
        r21.yz = refProbeConstantsCB[r7.w].data[8].xy;
        r9.w = dot(r11.xyz, r21.xyz);
        r12.x = dot(r19.xyz, r21.xyz);
        r12.x = -refProbeConstantsCB[r7.w].data[8].z + r12.x;
        r12.w = cmp(r12.x >= 0);
        ...
        r21.x = refProbeConstantsCB[r7.w].data[8].w;
        r21.yz = refProbeConstantsCB[r7.w].data[9].xy;
        r12.x = dot(r11.xyz, r21.xyz);
        r12.w = dot(r19.xyz, r21.xyz);
        r12.w = -refProbeConstantsCB[r7.w].data[9].z + r12.w;
        r13.w = cmp(r12.w >= 0);
        ...
        r21.x = refProbeConstantsCB[r7.w].data[9].w;
        r21.yz = refProbeConstantsCB[r7.w].data[10].xy;
        r12.x = dot(r11.xyz, r21.xyz);
        r12.w = dot(r19.xyz, r21.xyz);
        r12.w = -refProbeConstantsCB[r7.w].data[10].z + r12.w;
        r13.w = cmp(r12.w >= 0);
        r12.w = max(abs(r12.w), r2.z);
        r12.w = r13.w ? r12.w : -r12.w;
        r12.x = max(1.00000001e-07, -r12.x);
        r12.x = r12.w / r12.x;
        r9.w = min(abs(r12.x), r9.w);
        r21.x = refProbeConstantsCB[r7.w].data[10].w;
        r21.yz = refProbeConstantsCB[r7.w].data[11].xy;
        r12.x = dot(r11.xyz, r21.xyz);
        r12.w = dot(r19.xyz, r21.xyz);
        r12.w = -refProbeConstantsCB[r7.w].data[11].z + r12.w;
        r13.w = cmp(r12.w >= 0);
        r12.w = max(abs(r12.w), r2.z);
        r12.w = r13.w ? r12.w : -r12.w;
        r12.x = max(1.00000001e-07, -r12.x);
        r12.x = r12.w / r12.x;
        r9.w = min(abs(r12.x), r9.w);
        r21.x = refProbeConstantsCB[r7.w].data[11].w;
        r21.yz = refProbeConstantsCB[r7.w].data[12].xy;
        r12.x = dot(r11.xyz, r21.xyz);
        r12.w = dot(r19.xyz, r21.xyz);
        r12.w = -refProbeConstantsCB[r7.w].data[12].z + r12.w;
        r13.w = cmp(r12.w >= 0);
        r12.w = max(abs(r12.w), r2.z);
        r12.w = r13.w ? r12.w : -r12.w;
        r12.x = max(1.00000001e-07, -r12.x);
        r12.x = r12.w / r12.x;
        r9.w = min(abs(r12.x), r9.w);
        r21.x = refProbeConstantsCB[r7.w].data[12].w;
        r21.yz = refProbeConstantsCB[r7.w].data[13].xy;
        r12.x = dot(r11.xyz, r21.xyz);
        r12.w = dot(r19.xyz, r21.xyz);
        r12.w = -refProbeConstantsCB[r7.w].data[13].z + r12.w;
        r13.w = cmp(r12.w >= 0);
        r12.w = max(abs(r12.w), r2.z);
        r12.w = r13.w ? r12.w : -r12.w;
        r12.x = max(1.00000001e-07, -r12.x);
        r12.x = r12.w / r12.x;
        r9.w = min(abs(r12.x), r9.w);
        r21.x = refProbeConstantsCB[r7.w].data[3].w + r19.x;
        r21.yz = refProbeConstantsCB[r7.w].data[4].xy + r19.yz;
        r14.yzw = r11.xyz * r9.www + r21.xyz;
        ...
        r21.x = refProbeConstantsCB[r7.w].data[0].w;
        r21.y = refProbeConstantsCB[r7.w].data[1].z;
        r21.z = refProbeConstantsCB[r7.w].data[2].y;
        r22.x = dot(r14.yzw, r21.xyz);
        r23.xy = refProbeConstantsCB[r7.w].data[1].xw;
        r23.z = refProbeConstantsCB[r7.w].data[2].z;
        r22.y = dot(r14.yzw, r23.xyz);
        r24.x = refProbeConstantsCB[r7.w].data[1].y;
        r24.yz = refProbeConstantsCB[r7.w].data[2].xw;
        r22.z = dot(r14.yzw, r24.xyz);
        if (9 == 0) r12.x = 0; else if (9+16 < 32) {         r12.x = (uint)refProbeConstantsCB[r7.w].data[7].z << (32-(9 + 16)); r12.x = (uint)r12.x >> (32-9);        } else r12.x = (uint)refProbeConstantsCB[r7.w].data[7].z >> 16;
        r22.w = (uint)r12.x;
        r14.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r22.xyzw, r9.w).xyz;
        r25.x = dot(r19.xyz, r21.xyz);
        r25.y = dot(r19.xyz, r23.xyz);
        r25.z = dot(r19.xyz, r24.xyz);
        r19.xyz = saturate(r25.xyz * refProbeConstantsCB[r7.w].data[3].xyz + float3(0.5,0.5,0.5));
        r25.xy = refProbeConstantsCB[r7.w].data[4].zw * r19.xy;
        r25.z = refProbeConstantsCB[r7.w].data[5].x * r19.z;
        r19.xyz = refProbeConstantsCB[r7.w].data[5].yzw + r25.xyz;
        ...
        r7.w = dot(r21.xyz, float3(0.212599993,0.715200007,0.0722000003));
        ...
        r19.x = r17.w;
        r19.yz = r18.yz;
        r18.xyz = r14.yzw * r7.www + r19.xyz;
        r17.w = r18.x;
      }
    }
    r6.w = (int)r6.w + 1;
  ...
  if (r6.w != 0) {
    ...
    while (true) {
      ...
      if (r8.w != 0) {
        r7.w = (int)r7.w * 14;
        r21.xyz = -refProbeConstantsCB[r7.w].data[0].xyz + r9.xyz;
        r8.w = 0x0000ffff & (int)refProbeConstantsCB[r7.w].data[7].z;
        if (6 == 0) r9.w = 0; else if (6+25 < 32) {         r9.w = (uint)refProbeConstantsCB[r7.w].data[7].z << (32-(6 + 25)); r9.w = (uint)r9.w >> (32-6);        } else r9.w = (uint)refProbeConstantsCB[r7.w].data[7].z >> 25;
        r12.w = (int)r8.w * 6;
        r13.w = dot(refProbeAttenuationConstantsCB[r12.w].data[0].xyz, r21.xyz);
        r13.w = saturate(refProbeAttenuationConstantsCB[r12.w].data[0].w + r13.w);
        r14.z = dot(refProbeAttenuationConstantsCB[r12.w].data[1].xyz, r21.xyz);
        r14.z = saturate(refProbeAttenuationConstantsCB[r12.w].data[1].w + r14.z);
        r13.w = r14.z * r13.w;
        r14.z = dot(refProbeAttenuationConstantsCB[r12.w].data[2].xyz, r21.xyz);
        r14.z = saturate(refProbeAttenuationConstantsCB[r12.w].data[2].w + r14.z);
        r13.w = r14.z * r13.w;
        r14.z = dot(refProbeAttenuationConstantsCB[r12.w].data[3].xyz, r21.xyz);
        r14.z = saturate(refProbeAttenuationConstantsCB[r12.w].data[3].w + r14.z);
        r13.w = r14.z * r13.w;
        r14.z = dot(refProbeAttenuationConstantsCB[r12.w].data[4].xyz, r21.xyz);
        r14.z = saturate(refProbeAttenuationConstantsCB[r12.w].data[4].w + r14.z);
        r13.w = r14.z * r13.w;
        r14.z = dot(refProbeAttenuationConstantsCB[r12.w].data[5].xyz, r21.xyz);
        r12.w = saturate(refProbeAttenuationConstantsCB[r12.w].data[5].w + r14.z);
        r12.x = r13.w * r12.w;
        r12.w = 1 & (int)refProbeConstantsCB[r7.w].data[6].x;
        r12.xw = r12.ww ? r12.xy : r12.zx;
        ...
        while (true) {
          ...
          r14.w = (int)r8.w + (int)r14.z;
          r14.w = (int)r14.w * 6;
          r15.w = dot(refProbeAttenuationConstantsCB[r14.w].data[0].xyz, r21.xyz);
          r15.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[0].w + r15.w);
          r15.w = r22.x * r15.w;
          r16.w = dot(refProbeAttenuationConstantsCB[r14.w].data[1].xyz, r21.xyz);
          r16.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[1].w + r16.w);
          r15.w = r16.w * r15.w;
          r16.w = dot(refProbeAttenuationConstantsCB[r14.w].data[2].xyz, r21.xyz);
          r16.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[2].w + r16.w);
          r15.w = r16.w * r15.w;
          r16.w = dot(refProbeAttenuationConstantsCB[r14.w].data[3].xyz, r21.xyz);
          r16.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[3].w + r16.w);
          r15.w = r16.w * r15.w;
          r16.w = dot(refProbeAttenuationConstantsCB[r14.w].data[4].xyz, r21.xyz);
          r16.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[4].w + r16.w);
          r15.w = r16.w * r15.w;
          r16.w = dot(refProbeAttenuationConstantsCB[r14.w].data[5].xyz, r21.xyz);
          r14.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[5].w + r16.w);
          r22.x = r15.w * r14.w;
          r16.w = (uint)r13.w >> 2;
          if (1 == 0) r20.w = 0; else if (1+2 < 32) {           r20.w = (uint)r13.w << (32-(1 + 2)); r20.w = (uint)r20.w >> (32-1);          } else r20.w = (uint)r13.w >> 2;
          r21.w = (int)r16.w & 2;
          r22.z = max(r22.y, r22.x);
          r14.w = -r15.w * r14.w + 1;
          r14.w = r22.y * r14.w;
          r14.y = r21.w ? r14.w : r22.z;
          r22.xy = r20.ww ? r22.xy : r14.xy;
          r14.z = (int)r14.z + 1;
          r13.w = r16.w;
        }
        r8.w = saturate(r22.y + -r18.w);
        r9.w = refProbeConstantsCB[r7.w].data[6].y * r8.w;
        r12.x = cmp(0 < r9.w);
        if (r12.x != 0) {
          r19.w = r8.w * refProbeConstantsCB[r7.w].data[6].y + r19.w;
          r8.w = refProbeConstantsCB[r7.w].data[7].y * r9.w;
          r23.x = refProbeConstantsCB[r7.w].data[7].w;
          r23.yz = refProbeConstantsCB[r7.w].data[8].xy;
          r9.w = dot(r11.xyz, r23.xyz);
          r12.x = dot(r21.xyz, r23.xyz);
          r12.x = -refProbeConstantsCB[r7.w].data[8].z + r12.x;
          r12.w = cmp(r12.x >= 0);
          r12.x = max(abs(r12.x), r2.z);
          r12.x = r12.w ? r12.x : -r12.x;
          ...
          r9.w = r12.x / r9.w;
          r9.w = min(131072, abs(r9.w));
          r23.x = refProbeConstantsCB[r7.w].data[8].w;
          r23.yz = refProbeConstantsCB[r7.w].data[9].xy;
          ...
          r12.x = r12.w / r12.x;
          r9.w = min(abs(r12.x), r9.w);
          r23.x = refProbeConstantsCB[r7.w].data[9].w;
          r23.yz = refProbeConstantsCB[r7.w].data[10].xy;
          r12.x = dot(r11.xyz, r23.xyz);
          r12.w = dot(r21.xyz, r23.xyz);
          r12.w = -refProbeConstantsCB[r7.w].data[10].z + r12.w;
          r13.w = cmp(r12.w >= 0);
          ...
          r12.x = r12.w / r12.x;
          r9.w = min(abs(r12.x), r9.w);
          r23.x = refProbeConstantsCB[r7.w].data[10].w;
          r23.yz = refProbeConstantsCB[r7.w].data[11].xy;
          r12.x = dot(r11.xyz, r23.xyz);
          r12.w = dot(r21.xyz, r23.xyz);
          r12.w = -refProbeConstantsCB[r7.w].data[11].z + r12.w;
          r13.w = cmp(r12.w >= 0);
          ...
          r12.x = r12.w / r12.x;
          r9.w = min(abs(r12.x), r9.w);
          r23.x = refProbeConstantsCB[r7.w].data[11].w;
          r23.yz = refProbeConstantsCB[r7.w].data[12].xy;
          r12.x = dot(r11.xyz, r23.xyz);
          r12.w = dot(r21.xyz, r23.xyz);
          r12.w = -refProbeConstantsCB[r7.w].data[12].z + r12.w;
          r13.w = cmp(r12.w >= 0);
          ...
          r12.x = r12.w / r12.x;
          r9.w = min(abs(r12.x), r9.w);
          r23.x = refProbeConstantsCB[r7.w].data[12].w;
          r23.yz = refProbeConstantsCB[r7.w].data[13].xy;
          r12.x = dot(r11.xyz, r23.xyz);
          r12.w = dot(r21.xyz, r23.xyz);
          r12.w = -refProbeConstantsCB[r7.w].data[13].z + r12.w;
          r13.w = cmp(r12.w >= 0);
          ...
          r12.x = r12.w / r12.x;
          r9.w = min(abs(r12.x), r9.w);
          r23.x = refProbeConstantsCB[r7.w].data[3].w + r21.x;
          r23.yz = refProbeConstantsCB[r7.w].data[4].xy + r21.yz;
          r14.yzw = r11.xyz * r9.www + r23.xyz;
          r12.x = dot(r14.yzw, r14.yzw);
          r12.x = sqrt(r12.x);
          r9.w = r9.w / r12.x;
          r9.w = r9.w + r9.w;
          ...
          r9.w = r1.z * 5 + r9.w;
          r9.w = -0.844799995 + r9.w;
          r23.x = refProbeConstantsCB[r7.w].data[0].w;
          r23.y = refProbeConstantsCB[r7.w].data[1].z;
          r23.z = refProbeConstantsCB[r7.w].data[2].y;
          r24.x = dot(r14.yzw, r23.xyz);
          r25.xy = refProbeConstantsCB[r7.w].data[1].xw;
          r25.z = refProbeConstantsCB[r7.w].data[2].z;
          r24.y = dot(r14.yzw, r25.xyz);
          r26.x = refProbeConstantsCB[r7.w].data[1].y;
          r26.yz = refProbeConstantsCB[r7.w].data[2].xw;
          r24.z = dot(r14.yzw, r26.xyz);
          if (9 == 0) r12.x = 0; else if (9+16 < 32) {           r12.x = (uint)refProbeConstantsCB[r7.w].data[7].z << (32-(9 + 16)); r12.x = (uint)r12.x >> (32-9);          } else r12.x = (uint)refProbeConstantsCB[r7.w].data[7].z >> 16;
          r24.w = (uint)r12.x;
          r14.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r24.xyzw, r9.w).xyz;
          r27.x = dot(r21.xyz, r23.xyz);
          r27.y = dot(r21.xyz, r25.xyz);
          r27.z = dot(r21.xyz, r26.xyz);
          r21.xyz = saturate(r27.xyz * refProbeConstantsCB[r7.w].data[3].xyz + float3(0.5,0.5,0.5));
          r27.xy = refProbeConstantsCB[r7.w].data[4].zw * r21.xy;
          r27.z = refProbeConstantsCB[r7.w].data[5].x * r21.z;
          r21.xyz = refProbeConstantsCB[r7.w].data[5].yzw + r27.xyz;
          ...
          r7.w = dot(r23.xyz, float3(0.212599993,0.715200007,0.0722000003));
          ...
          r7.w = r2.w * r7.w + r8.w;
          r7.w = r9.w / r7.w;
          r19.xyz = r14.yzw * r7.www + r19.xyz;
        }
      }
      r6.w = (int)r6.w + 1;
    }
