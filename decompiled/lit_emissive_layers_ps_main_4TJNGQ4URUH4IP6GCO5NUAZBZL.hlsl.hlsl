// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:32:41 2021
...
Texture2D<float4> emissiveMap1 : register(t29);
Texture2D<float4> emissiveMap2 : register(t30);
...
Texture2D<float4> emissiveMap3 : register(t37);
...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  r6.xyz = r4.xyz * r0.xxx + r6.xyz;
  r2.xyw = r3.xyz * r2.xxx + r6.xyz;
...
r3.w = samp0[]..swiz;
  r6.zw = (int2)r3.ww & int2(268435456,536870912);
  if (r6.z != 0) {
            ...
            r28.w = samp0[]..swiz;
              ...
              r25.w = samp0[]..swiz;
                ...
                if (r24.y != 0) {
                  ...
                  r26.xyz = r27.xyz * r2.zzz;
                  r24.xyz = r24.xyz * r2.zzz;
                  r25.xyz = r25.xyz * r2.zzz;
                  r17.w = -17 * r13.w;
                  r17.w = exp2(r17.w);
                  r16.w = r17.w + r16.w;
                  r16.w = log2(r16.w);
  ...
  r0.y = 1 + -r13.x;
  r1.xyz = r1.xyz * r0.yyy + r14.xyz;
  o0.w = r0.z * r0.y + r13.x;
  r2.xyz = r2.xyw * r0.yyy + r15.xyz;
  r0.z = dot(r2.xyz, r2.xyz);
  r0.z = rsqrt(r0.z);
  r2.xyz = r2.xyz * r0.zzz;
  r7.y = r1.w * r0.y + r13.y;
  r8.xyz = r0.yyy * float3(0.0399999991,0.0399999991,0.0399999991) + r16.xyz;
  ...
  if (r0.z != 0) {
    ...
    r11.y = r11.x;
    r11.z = r10.x;
    r12.x = dot(r11.yz, r6.zw);
    r11.x = -r10.x;
    r12.y = dot(r11.xy, r6.zw);
    r6.zw = gameTime.ww * scrollUVs.xy;
    r6.zw = r6.zw * scaleUVs.xy + r12.xy;
  ...
  r1.w = frac(r1.w);
  r10.y = gameTime.w * flickerSpeed + r1.w;
  r10.x = flickerSeed.x;
  r1.w = flickerLookupMap.SampleLevel(lookupSampler_s, r10.xy, 0).x;
  r1.w = log2(abs(r1.w));
  ...
  if (r1.w != 0) {
    ...
    r1.w = trunc(r1.w);
    r1.w = w1.x + r1.w;
    r10.x = r1.w / columnCount2;
    r1.w = trunc(r3.w);
    r1.w = w1.y + r1.w;
    r10.y = r1.w / rowCount2;
  } else {
    ...
    r6.zw = r6.zw * scaleUVs2.xy + r13.xy;
    r1.w = gameTime.w * zoomRate2;
    r1.w = cos(r1.w);
    r1.w = r1.w * 0.5 + 0.5;
    r1.w = 1 + -r1.w;
    r3.w = zoomUVs2.y + -zoomUVs2.x;
    r1.w = r1.w * r3.w + zoomUVs2.x;
    r6.zw = r6.zw / r1.ww;
    r6.zw = float2(0.5,0.5) + r6.zw;
    r7.zw = saturate(r6.zw);
    r10.x = clampU2 ? r7.z : r6.z;
    r10.y = clampV2 ? r7.w : r6.w;
  }
  ...
  r1.w = r1.w * r3.w + flickerRange2.x;
  r10.xyz = r10.xyz * r1.www;
  r1.w = 1 + -r10.w;
  r9.xyz = r9.xyz * r1.www + r10.xyz;
  r1.w = cmp(0.5 < uvMotionToggle3);
  if (r1.w != 0) {
    r1.w = columnCount3 * rowCount3;
    r3.w = imageTime3 * r1.w;
    r4.w = gameTime.w * r3.w;
    r4.w = cmp(r4.w >= -r4.w);
    r4.w = r4.w ? r3.w : -r3.w;
    r5.w = 1 / r4.w;
    ...
    r1.w = r3.w * r1.w;
    r1.w = round(r1.w);
    r3.w = r1.w / columnCount3;
    r4.w = columnCount3 * r1.w;
    r4.w = cmp(r4.w >= -r4.w);
    ...
    r1.w = trunc(r1.w);
    r1.w = w1.x + r1.w;
    r10.x = r1.w / columnCount3;
    r1.w = trunc(r3.w);
    r1.w = w1.y + r1.w;
    r10.y = r1.w / rowCount3;
  } else {
    r1.w = dot(-v6.xyz, -v6.xyz);
    r1.w = rsqrt(r1.w);
    r11.xyz = -v6.xyz * r1.www;
  ...
  r0.z = clampV3 + r0.z;
  r0.z = frac(r0.z);
  r4.y = gameTime.w * clampV3 + r0.z;
  r4.x = clampV3;
  r0.z = flickerLookupMap.SampleLevel(lookupSampler_s, r4.xy, 0).x;
  r0.z = log2(abs(r0.z));
  r0.z = flickerPower3 * r0.z;
  r0.z = exp2(r0.z);
  r1.w = flickerRange3.y + -flickerRange3.x;
  r0.z = r0.z * r1.w + flickerRange3.x;
  r3.xyz = r3.xyz * r0.zzz;
  r0.z = 1 + -r3.w;
  r3.xyz = r9.xyz * r0.zzz + r3.xyz;
  ...
  r13.z = (uint)r0.x << 4;
  r0.x = (int)r6.z & -32;
  r6.x = (int)-r0.x + (int)r6.z;
  r6.y = numRefProbes & -32;
  r6.w = (int)-r6.y + numRefProbes;
  r14.xy = float2(0,0);
  r15.w = 0;
  r16.yz = float2(0,1);
  r17.xy = float2(0,0);
  ...
  while (true) {
    ...
    bitmask.z = ((~(-1 << r6.x)) << 0) & 0xffffffff;  r9.z = (((uint)0 << 0) & bitmask.z) | ((uint)r7.w & ~bitmask.z);
    r7.w = r8.w ? r9.z : r7.w;
    r8.w = cmp((int)r6.y == (int)r7.z);
    if (r6.w == 0) r9.z = 0; else if (r6.w+0 < 32) {     r9.z = (uint)r7.w << (32-(r6.w + 0)); r9.z = (uint)r9.z >> (32-r6.w);    } else r9.z = (uint)r7.w >> 0;
    r7.w = r8.w ? r9.z : r7.w;
      ...
      r15.y = samp0[]..swiz;
        ...
        r32.w = samp0[]..swiz;
          ...
          r38.y = samp0[]..swiz;
            ...
            r9.w = dot(r11.yzw, float3(0.212599993,0.715200007,0.0722000003));
            r9.w = r5.w * r10.w + r9.w;
            r9.w = r13.w / r9.w;
            r15.x = r23.w;
            r15.yz = r24.xy;
            r24.xyw = r11.zwy * r9.www + r15.yzx;
            r23.w = r24.w;
          }
        }
      }
  ...
  if (r6.y != 0) {
    ...
    r6.w = 0;
    while (true) {
      r7.z = cmp((uint)r6.w >= (uint)r6.z);
      if (r7.z != 0) break;
      r14.z = (uint)r6.w >> 5;
      r15.xyz = (int3)r13.xyz + (int3)r14.xyz;
      r7.z = visibleProbes.Load(r15.xyzw).x;
      r7.w = cmp((int)r0.x == (int)r6.w);
      if (r6.x == 0) r8.w = 0; else if (r6.x+0 < 32) {       r8.w = (uint)r7.z << (32-(r6.x + 0)); r8.w = (uint)r8.w >> (32-r6.x);      } else r8.w = (uint)r7.z >> 0;
      r7.z = r7.w ? r8.w : r7.z;
      ...
      while (true) {
        ...
        r25.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=80)(mixed,mixed,mixed,mixed) r26.xy, r10.w, l(16), t11.xyxx
        r26.x = samp0[]..swiz;
        r26.y = samp0[]..swiz;
          ...
          r25.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r14.zw, r9.w, l(96), t15.xxxy
          r14.z = samp0[]..swiz;
          r14.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r26.xyzw, r9.w, l(116), t15.zwxy
          ...
          r33.w = samp0[]..swiz;
            ...
            r10.w = saturate(r28.y + -r8.w);
            r13.w = r10.w * r14.w;
            r14.z = cmp(0 < r13.w);
            if (r14.z != 0) {
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r29.xyzw, r9.w, l(16), t15.xyzw
            r29.x = samp0[]..swiz;
            r29.y = samp0[]..swiz;
            r29.z = samp0[]..swiz;
            r29.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r30.xyzw, r9.w, l(32), t15.yxwz
            r30.x = samp0[]..swiz;
            r30.y = samp0[]..swiz;
            r30.z = samp0[]..swiz;
            r30.w = samp0[]..swiz;
            ...
            r39.y = samp0[]..swiz;
              ...
              r18.yzw = r12.xyz * r10.www + r18.yzw;
              ...
              r34.w = (uint)r13.w;
              r18.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r34.xyzw, r10.w).xyz;
              ...
              r13.w = r10.w * r5.w;
              r18.yzw = r18.yzw * r9.www;
              r9.w = dot(r18.yzw, float3(0.212599993,0.715200007,0.0722000003));
              r9.w = r5.w * r10.w + r9.w;
              r9.w = r13.w / r9.w;
              r24.xyz = r18.yzw * r9.www + r24.xyz;
            }
          }
        }
      }
  ...
  r6.xyz = r21.xyz * r0.xxx;
  r11.yzw = r22.xyz * r0.xxx;
  ...
  if (r4.w != 0) {
    ...
    r6.xyz = r21.xyz * r0.xxx + r14.xyz;
    r12.w = 0;
    r5.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r12.xyzw, r5.y).xyz;
    r0.x = sunConstants.globalProbeExposure * r4.w + -r2.w;
    r0.x = r7.y * r0.x + r2.w;
    r11.yzw = r5.yzw * r0.xxx + r11.yzw;
  }
  r0.x = r7.x + r0.w;
  r0.x = log2(abs(r0.x));
  r0.x = r3.w * r0.x;
  ...
  r7.yzw = r11.yzw * r0.xxx;
  r14.xyz = r7.zwy * r5.yyy;
  r5.yzw = r7.yzw * r5.zzz;
  r0.x = sqrt(r3.w);
  r0.x = r0.x * 0.5 + 0.5;
  r0.x = r0.x * r0.x;
  r0.w = 0.5 * r0.x;
  ...
  if (r7.y == 0) {
    ...
    r7.y = -sunConstants.splitDepthOffset + r11.w;
    r7.y = -r7.y * 6.10351563e-05 + 1;
    r7.w = saturate(r7.y);
    r7.w = cmp(r7.y == r7.w);
    if (r7.w != 0) {
      r7.w = 0;
      ...
      while (true) {
        ...
        if (r9.z != 0) break;
        r9.z = (uint)r7.w;
        r15.xy = -sunConstants.splitPinTransform[r9.z].xy + r11.yz;
    ...
    r10.w = samp0[]..swiz;
      ...
      r18.w = samp0[]..swiz;
        ...
        r12.w = samp0[]..swiz;
          ...
          r12.w = r11.y * r15.x + r12.w;
          r10.w = r11.z * r10.w + r12.w;
    ...
    if (r9.z == 0) {
      if (enableDitheredShadow == 0) {
        r9.z = (uint)r7.w;
        r15.xy = -sunConstants.splitPinTransform[r9.z].xy + r11.yz;
        r9.zw = sunConstants.splitPinTransform[r9.z].zz * r15.xy;
        r15.xy = r9.zw * float2(0.5,-0.5) + float2(0.5,0.5);
        r9.z = (int16)sunConstants.splitArrayOffset;
        r15.z = r9.z + r7.w;
        r9.z = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r15.xyz, r7.y).x;
      ...
      if (enableDitheredShadow != 0) {
        ...
        r8.w = 28 * r8.w;
        r8.w = (uint)r8.w;
        r16.xy = -sunConstants.splitPinTransform[r9.z].xy + r11.yz;
        r16.xy = sunConstants.splitPinTransform[r9.z].zz * r16.xy;
        ...
        while (true) {
          ...
          r16.zw = r11.ww ? r11.yz : r16.xy;
          r12.w = r11.w ? sunConstants.splitPinTransform[r7.w].w : sunConstants.splitPinTransform[r9.z].w;
          r11.w = r11.w ? r7.w : r9.z;
          ...
          r17.z = (uint)r11.w;
          r11.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r17.xyz, r7.y).x;
  ...
  if (r7.y != 0) {
    r7.y = cmp(0 < r7.z);
    if (r7.y != 0) {
      r7.y = sunConstants.specScale * r1.w;
      r7.y = r7.y * r4.w;
      ...
      r18.z = samp0[]..swiz;
      r18.w = samp0[]..swiz;
        r9.z = abs(r2.w) * -0.200000003 + 0.400000006;
        r19.xyz = r2.xyz * r9.zzz + v6.xyz;
        r19.w = 1;
        ...
        r16.y = samp0[]..swiz;
          ...
          if (enableDitheredShadow != 0) {
            ...
            while (true) {
              ...
              r12.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r17.xyz, r7.w).x;
              r9.w = r12.w * 0.125 + r9.w;
              r10.w = (int)r10.w + 1;
            }
          } else {
            r15.z = (uint)r9.z;
            r9.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r15.xyz, r7.w).x;
          }
          r7.w = r9.w * r9.w;
          r7.w = r7.w * r9.w;
        } else {
      ...
      r7.w = r7.w * r7.z;
      r2.w = cmp(0 < r2.w);
      r15.xyz = r7.www * r11.yzw + r6.xyz;
      r16.xyz = -v6.xyz * r0.yyy + sunConstants.wldDir.xyz;
      r0.y = dot(r16.xyz, r16.xyz);
      r0.y = rsqrt(r0.y);
      r16.xyz = r16.xyz * r0.yyy;
      r0.y = dot(r16.xyz, r4.xyz);
      r7.w = dot(r2.xyz, r16.xyz);
      ...
      r4.w = r7.z * r4.w;
      r4.w = 0.25 * r4.w;
      r7.yzw = r4.www * r11.yzw + r5.yzw;
      r0.y = saturate(1 + -r0.y);
      r8.w = r0.y * r0.y;
      r8.w = r8.w * r8.w;
      r0.y = r8.w * r0.y;
      r0.y = r4.w * r0.y;
      r16.xyz = r0.yyy * r11.zwy + r14.xyz;
      r15.w = r16.z;
      r6.w = r14.z;
      r6.xyzw = r2.wwww ? r15.xyzw : r6.xyzw;
      r16.zw = r7.yz;
      r14.zw = r5.yz;
  ...
  while (true) {
    ...
    if (r7.w != 0) break;
    r7.z = (uint)r6.w >> 5;
    r16.xyz = (int3)r7.xyz + (int3)r13.xyz;
        ...
        r37.w = samp0[]..swiz;
          ...
          switch (r9.w) {
            ...
            if (r24.w != 0) {
              ...
              if (r24.w != 0) {
                ...
                if (r24.w != 0) {
                  ...
                  r10.w = r25.w * r27.w + -r10.w;
                  r10.w = saturate(r10.w / r28.w);
                  r25.w = r28.w / r37.x;
                  r25.w = 10 * r25.w;
                  r25.w = min(1, r25.w);
                  r10.w = r10.w + -r12.w;
                  r10.w = r25.w * r10.w + r12.w;
            ...
            r39.w = samp0[]..swiz;
              ...
              r44.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r18.x, r9.z, l(236), t12.xxxx
              r18.x = samp0[]..swiz;
              ...
              if (r13.w != 0) {
                  ...
                  r39.y = samp0[]..swiz;
                    ...
                    if (r7.w != 0) {
                      ...
                      while (true) {
                        ...
                        r25.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r31.xyz, r9.z).x;
                        r18.x = r25.w * 0.125 + r18.x;
                        r24.w = (int)r24.w + 1;
                      }
                    } else {
                      r21.z = (uint)r13.w;
                      r18.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r21.xyz, r9.z).x;
                    }
                    r9.z = r18.x * r18.x;
                    r9.z = r9.z * r18.x;
                  } else {
                ...
                if (r13.w != 0) {
                  ...
                  r14.w = r14.w + -r12.w;
                  r14.w = r3.w * r14.w + r12.w;
                  r14.w = r14.w * r9.z;
                  r10.w = cmp(0 < r10.w);
                  r22.xyz = r14.www * r20.xyw + r16.xyz;
                  r19.xyz = r19.xyz * r9.www + r4.xyz;
                  r9.w = dot(r19.xyz, r19.xyz);
                  r9.w = rsqrt(r9.w);
                  r19.xyz = r19.xyz * r9.www;
                  r9.w = dot(r19.xyz, r4.xyz);
                  r14.w = dot(r2.xyz, r19.xyz);
                  r19.x = abs(r14.w) * r1.w + -abs(r14.w);
                  r14.w = abs(r14.w) * r19.x + 1;
                  r12.w = r12.w * r0.x + r0.w;
                  r14.w = r14.w * r14.w;
                  r12.w = r14.w * r12.w;
                  r12.w = rcp(r12.w);
                  r12.w = r12.w * r13.w;
                  r9.z = r12.w * r9.z;
                  r9.z = 0.25 * r9.z;
                  r19.xyz = r9.zzz * r20.xyw + r30.xyz;
                  r9.w = saturate(1 + -r9.w);
                  r12.w = r9.w * r9.w;
                  r12.w = r12.w * r12.w;
                  r9.w = r12.w * r9.w;
                  r9.z = r9.z * r9.w;
                  r20.xyw = r9.zzz * r20.xyw + r29.xyz;
