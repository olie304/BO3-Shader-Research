...
sample_indexable(texture2d)(float,float,float,float) r1.yzw, v2.xyxx, t9.wxyz, s4
...
sample_indexable(texture2d)(float,float,float,float) r3.xyz, r3.xyxx, t12.xyzw, s4
...
sample_indexable(texture2d)(float,float,float,float) r4.xyz, r3.xyxx, t14.xyzw, s4
mad r1.zw, r4.xxxy, l(0.000000, 0.000000, 1.99218750, 1.99218750), l(0.000000, 0.000000, -1.000000, -1.000000)
mul r2.w, r4.z, r4.z
mul r2.w, r2.w, l(0.33333334)
min r2.w, r2.w, l(1.000000)
sample_indexable(texture2d)(float,float,float,float) r3.xyz, r3.zwzz, t14.xyzw, s4
mad r3.xy, r3.xyxx, l(1.99218750, 1.99218750, 0.000000, 0.000000), l(-1.000000, -1.000000, 0.000000, 0.000000)
mul r3.z, r3.z, r3.z
...
mov r5.x, l(1)
mov r2.x, l(0)
movc r2.xyzw, r1.wwww, r5.xyzw, r2.xyzw
...
ftou r1.xz, v0.xxyx
mad r2.y, r0.x, cb0[0].z, -r1.y
mad r1.y, r2.y, l(0.500000), r1.y
mad r2.z, r0.y, cb0[0].z, -r1.y
