...
mad r0.xyz, v3.xyzx, r0.zzzz, r0.xywx
dp3 r0.w, r0.xyzx, r0.xyzx
rsq r0.w, r0.w
mul r0.xyz, r0.wwww, r0.xyzx
mul r1.xy, r0.xyxx, cb0[15].wwww
mad r1.zw, r0.xxxy, cb0[15].zzzz, v2.xxxy
sample_indexable(texture2d)(float,float,float,float) r2.xyz, r1.zwzz, t22.xyzw, s5
...
mul r2.w, r2.w, r2.w
mul r2.x, r2.w, r2.x
mad r2.x, cb0[14].w, r2.x, cb0[14].z
add r3.xyz, r3.xyzx, -r4.xyzx
mad r3.xyz, r2.xxxx, r3.xyzx, r4.xyzx
if_nz cb0[42].x
  sample_indexable(texture2d)(float,float,float,float) r2.x, v7.xyxx, t25.xyzw, s5
  sample_indexable(texture2d)(float,float,float,float) r2.w, v7.zwzz, t25.yzwx, s5
  sample_indexable(texture2d)(float,float,float,float) r3.w, v8.xyxx, t25.yzwx, s5
  sample_indexable(texture2d)(float,float,float,float) r4.x, v8.zwzz, t25.xyzw, s5
  add r2.x, r2.w, r2.x
  add r2.x, r3.w, r2.x
  add r2.x, r4.x, r2.x
  mul r2.x, r2.x, cb0[35].x
  ...
  add r4.xyz, -r1.xyzx, cb0[24].xyzx
...
mul r2.xzw, r18.xxyz, cb0[17].yyyy
...
mul r4.x, r4.x, r4.x
mul r0.y, r0.y, r4.x
mad r0.y, cb0[14].w, r0.y, cb0[14].z
log r0.x, r0.x
mul r4.xy, r0.xxxx, cb0[14].xyxx
exp r4.xy, r4.xyxx
dp2 r0.x, r4.xyxx, cb0[15].xyxx
mul r0.y, r3.w, r0.y
...
sqrt r0.w, r0.w
mad r0.w, r0.w, cb0[17].z, cb0[17].w
exp r0.w, r0.w
min r0.w, r0.w, l(1.000000)
mul r1.xyz, cb0[29].xyzx, cb2[18].xyzx
