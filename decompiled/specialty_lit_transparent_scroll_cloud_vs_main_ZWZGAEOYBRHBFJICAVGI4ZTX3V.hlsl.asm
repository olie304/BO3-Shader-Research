...
//   float2 colorMapScale;              // Offset:  240 Size:     8 [unused]
//   float4 colorTint;                  // Offset:  256 Size:    16 [unused]
//   float zFeatherDistance;            // Offset:  272 Size:     4
//   float falloffBegin;                // Offset:  276 Size:     4
//   float falloffEnd;                  // Offset:  280 Size:     4
//   float uvMotionToggle1;             // Offset:  284 Size:     4 [unused]
//   float2 maskRotateUVs;              // Offset:  288 Size:     8 [unused]
//   float2 maskScrollUVs;              // Offset:  296 Size:     8 [unused]
//   float2 maskScaleUVs;               // Offset:  304 Size:     8 [unused]
//   float2 maskOffsetUVs;              // Offset:  312 Size:     8 [unused]
//   float2 maskZoomUVs;                // Offset:  320 Size:     8 [unused]
//   float maskZoomRate;                // Offset:  328 Size:     4 [unused]
//   bool noReceiveShadow;              // Offset:  332 Size:     4 [unused]
//   float4 flowParams;                 // Offset:  336 Size:    16 [unused]
//   float4 noiseParams;                // Offset:  352 Size:    16 [unused]
//
// }
//
...
max r1.x, cb0[17].x, l(0.100000)
div r1.x, l(1.000000, 1.000000, 1.000000, 1.000000), r1.x
ge r1.y, l(1.000000), r1.x
mul_sat r1.x, r0.w, r1.x
mul r1.x, r1.x, v1.w
movc o1.x, r1.y, r1.x, v1.w
eq r1.xy, cb0[17].yzyy, l(0.000000, 0.000000, 0.000000, 0.000000)
and r1.x, r1.y, r1.x
mul r1.yz, cb0[17].yyzy, l(0.000000, 0.01745329, 0.01745329, 0.000000)
sincos null, r1.yz, r1.yyzy
mul r1.zw, r1.yyyz, r1.yyyz
mad r1.y, r1.y, r1.y, -r1.w
div r2.x, l(1.000000, 1.000000, 1.000000, 1.000000), r1.y
mad r2.y, -r1.z, r2.x, l(1.000000)
movc o6.xy, r1.xxxx, l(0,1.000000,0,0), r2.xyxx
mov o0.xyzw, r0.xyzw
mov o1.yz, v2.xxyx
mov o5.xyz, r8.xyzx
ret 
