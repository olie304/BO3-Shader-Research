...
uge r13.y, r0.x, r12.w
ult r13.z, r0.x, cb2[0].y
and r13.y, r13.z, r13.y
if_nz r13.y
  imul null, r13.y, r0.x, l(14)
  add r15.xyz, r10.xyzx, -cb10[r13.y + 0].xyzx
...
lt r13.y, r13.z, l(1.000000)
if_nz r13.y
  ult r12.w, r0.x, r12.w
  if_nz r12.w
    imul null, r0.x, r0.x, l(14)
    add r17.xyz, r10.xyzx, -cb10[r0.x + 0].xyzx
    and r12.w, l(0x0000ffff), cb10[r0.x + 7].z
    ubfe r13.y, l(6), l(25), cb10[r0.x + 7].z
    imul null, r13.w, r12.w, l(6)
    dp3 r15.w, cb11[r13.w + 0].xyzx, r17.xyzx
    add_sat r15.w, r15.w, cb11[r13.w + 0].w
    dp3 r16.w, cb11[r13.w + 1].xyzx, r17.xyzx
    add_sat r16.w, r16.w, cb11[r13.w + 1].w
    mul r15.w, r15.w, r16.w
    dp3 r16.w, cb11[r13.w + 2].xyzx, r17.xyzx
    add_sat r16.w, r16.w, cb11[r13.w + 2].w
    mul r15.w, r15.w, r16.w
    dp3 r16.w, cb11[r13.w + 3].xyzx, r17.xyzx
    add_sat r16.w, r16.w, cb11[r13.w + 3].w
    mul r15.w, r15.w, r16.w
    dp3 r16.w, cb11[r13.w + 4].xyzx, r17.xyzx
    add_sat r16.w, r16.w, cb11[r13.w + 4].w
    mul r15.w, r15.w, r16.w
    dp3 r16.w, cb11[r13.w + 5].xyzx, r17.xyzx
    add_sat r13.w, r16.w, cb11[r13.w + 5].w
    mul r18.x, r13.w, r15.w
    and r13.w, l(1), cb10[r0.x + 6].x
    mov r18.yz, l(0,0,1.000000,0)
    movc r18.xy, r13.wwww, r18.xyxx, r18.zxzz
    mov r19.x, l(1.000000)
    mov r13.w, cb10[r0.x + 6].x
    mov r20.xy, r18.xyxx
    mov r15.w, l(1)
    loop 
      ige r16.w, r15.w, r13.y
      breakc_nz r16.w
      ...
      dp3 r18.z, cb11[r16.w + 1].xyzx, r17.xyzx
      add_sat r18.z, r18.z, cb11[r16.w + 1].w
      mul r17.w, r17.w, r18.z
      dp3 r18.z, cb11[r16.w + 2].xyzx, r17.xyzx
      add_sat r18.z, r18.z, cb11[r16.w + 2].w
      mul r17.w, r17.w, r18.z
      dp3 r18.z, cb11[r16.w + 3].xyzx, r17.xyzx
      add_sat r18.z, r18.z, cb11[r16.w + 3].w
      mul r17.w, r17.w, r18.z
      dp3 r18.z, cb11[r16.w + 4].xyzx, r17.xyzx
      add_sat r18.z, r18.z, cb11[r16.w + 4].w
      mul r17.w, r17.w, r18.z
      dp3 r18.z, cb11[r16.w + 5].xyzx, r17.xyzx
      add_sat r16.w, r18.z, cb11[r16.w + 5].w
      mul r20.x, r16.w, r17.w
      ushr r18.z, r13.w, l(2)
      ubfe r18.w, l(1), l(2), r13.w
      and r19.z, r18.z, l(2)
      max r19.w, r20.x, r20.y
      mad r16.w, -r17.w, r16.w, l(1.000000)
      mul r16.w, r16.w, r20.y
      movc r19.y, r19.z, r16.w, r19.w
      movc r20.xy, r18.wwww, r20.xyxx, r19.xyxx
      iadd r15.w, r15.w, l(1)
      mov r13.w, r18.z
    endloop 
    add_sat r12.w, -r13.z, r20.y
    mul r13.y, r12.w, cb10[r0.x + 6].y
    lt r13.w, l(0.000000), r13.y
    if_nz r13.w
      mad r13.z, r12.w, cb10[r0.x + 6].y, r13.z
      mul r12.w, r13.y, cb10[r0.x + 7].y
      mov r18.x, cb10[r0.x + 7].w
      mov r18.yz, cb10[r0.x + 8].xxyx
      dp3 r13.y, r14.xyzx, r18.xyzx
      dp3 r13.w, r17.xyzx, r18.xyzx
      add r13.w, r13.w, -cb10[r0.x + 8].z
      ge r15.w, r13.w, l(0.000000)
      ...
      dp3 r13.w, r14.xyzx, r18.xyzx
      dp3 r15.w, r17.xyzx, r18.xyzx
      add r15.w, r15.w, -cb10[r0.x + 9].z
      ...
      dp3 r13.w, r14.xyzx, r18.xyzx
      dp3 r15.w, r17.xyzx, r18.xyzx
      add r15.w, r15.w, -cb10[r0.x + 10].z
      ge r16.w, r15.w, l(0.000000)
      max r15.w, r7.w, |r15.w|
      movc r15.w, r16.w, r15.w, -r15.w
      max r13.w, -r13.w, l(0.00000010)
      ...
      dp3 r13.w, r14.xyzx, r18.xyzx
      dp3 r15.w, r17.xyzx, r18.xyzx
      add r15.w, r15.w, -cb10[r0.x + 11].z
      ge r16.w, r15.w, l(0.000000)
      max r15.w, r7.w, |r15.w|
      movc r15.w, r16.w, r15.w, -r15.w
      max r13.w, -r13.w, l(0.00000010)
      ...
      dp3 r13.w, r14.xyzx, r18.xyzx
      dp3 r15.w, r17.xyzx, r18.xyzx
      add r15.w, r15.w, -cb10[r0.x + 12].z
      ge r16.w, r15.w, l(0.000000)
      max r15.w, r7.w, |r15.w|
      movc r15.w, r16.w, r15.w, -r15.w
      max r13.w, -r13.w, l(0.00000010)
      ...
      dp3 r13.w, r14.xyzx, r18.xyzx
      dp3 r15.w, r17.xyzx, r18.xyzx
      add r15.w, r15.w, -cb10[r0.x + 13].z
      ge r16.w, r15.w, l(0.000000)
      max r7.w, r7.w, |r15.w|
      movc r7.w, r16.w, r7.w, -r7.w
      max r13.w, -r13.w, l(0.00000010)
      div r7.w, r7.w, r13.w
      min r7.w, |r7.w|, r13.y
...
max r0.x, r13.z, l(1.000000)
rcp r0.x, r0.x
mov_sat r13.z, r13.z
mul r17.xyz, r0.xxxx, r15.xyzx
mul r16.xyz, r0.xxxx, r16.xyzx
lt r2.w, r13.z, l(0.990000)
if_nz r2.w
  add r2.w, -r13.z, l(1.000000)
  ...
  mad r17.xyz, r15.xyzx, r0.xxxx, r13.yzwy
  mov r14.w, l(0)
...
ubfe r1.w, l(3), l(24), cb9[r0.y + 1].w
switch r1.w
  case l(4)
  lt r1.w, l(0.000000), cb9[r0.y + 6].y
  mov r15.xy, cb9[r0.y + 5].zwzz
  mov r15.z, cb9[r0.y + 6].x
  mad r16.xyz, -r15.xyzx, l(0.500000, 0.500000, 0.500000, 0.000000), cb9[r0.y + 0].xyzx
  add r17.xyz, -r10.xyzx, r16.xyzx
  dp3 r4.z, r15.xyzx, r17.xyzx
  div_sat r5.w, -r4.z, cb9[r0.y + 6].y
  mad r18.xyz, r5.wwww, r15.xyzx, r16.xyzx
  movc r18.xyz, r1.wwww, r18.xyzx, cb9[r0.y + 0].xyzx
  ...
  if_nz r11.w
    ...
    if_nz r11.w
      ...
      if_nz r11.w
        ...
        mul r4.z, r4.z, r7.w
        mul r4.z, r6.w, r4.z
        mad r14.xyz, r4.zzzz, r16.xyzx, r2.yzwy
        add_sat r1.w, -r1.w, l(1.000000)
        mul r6.w, r1.w, r1.w
        mul r6.w, r6.w, r6.w
        mul r1.w, r1.w, r6.w
        mul r1.w, r1.w, r4.z
        mad r15.xyz, r1.wwww, r16.xyzx, r9.xywx
        movc r13.yzw, r5.wwww, r17.xxyz, r13.yyzw
        movc r9.xyw, r5.wwww, r15.xyxz, r9.xyxw
        movc r2.yzw, r5.wwww, r14.xxyz, r2.yyzw
      endif 
    endif 
  endif 
  break 
  ...
  if_nz r6.w
    ...
    if_nz r7.w
      ...
      add r17.xyz, -r10.xyzx, cb9[r0.y + 0].xyzx
      mul r8.w, cb9[r0.y + 3].x, cb9[r0.y + 3].x
      dp3 r11.w, r17.xyzx, r17.xyzx
      div r8.w, r8.w, r11.w
      min r8.w, r8.w, l(1.000000)
      mad_sat r17.xy, r6.wwww, cb9[r0.y + 2].xzxx, cb9[r0.y + 2].ywyy
      ...
      mov r18.xyz, cb9[r0.y + 5].yzwy
      mov r18.w, cb9[r0.y + 6].x
      dp4 r17.y, r18.xyzw, r10.xyzw
      div r17.xy, r17.xyxx, r6.wwww
      lt r6.w, cb9[r0.y + 10].w, l(0.00048828)
      if_nz r6.w
        mad_sat r18.xy, |r17.xyxx|, cb9[r0.y + 12].xyxx, cb9[r0.y + 12].zwzz
        mul r18.zw, r18.xxxy, r18.xxxy
        mad r18.xy, r18.xyxx, l(-2.000000, -2.000000, 0.000000, 0.000000), l(3.000000, 3.000000, 0.000000, 0.000000)
        mul r18.xy, r18.xyxx, r18.zwzz
        mul r6.w, r18.y, r18.x
      else 
        mul_sat r18.xyzw, |r17.yyxx|, cb9[r0.y + 11].xyzw
        log r18.xyzw, r18.xyzw
        mul r18.xyzw, r18.xyzw, cb9[r0.y + 12].zzzz
        exp r18.xyzw, r18.xyzw
        add r18.xy, r18.zwzz, r18.xyxx
        log r18.xy, r18.xyxx
        mul r18.xy, r18.xyxx, cb9[r0.y + 12].wwww
        exp r18.xy, r18.xyxx
        mul r10.w, r18.x, cb9[r0.y + 12].x
        mad r11.w, cb9[r0.y + 12].y, r18.y, l(-1.000000)
        mad r10.w, cb9[r0.y + 12].y, r18.y, -r10.w
      ...
      if_nz r6.w
        ...
        dp3 r8.w, cb9[r0.y + 13].xyzx, r17.xyzx
        mov r18.x, cb9[r0.y + 13].w
        mov r18.yz, cb9[r0.y + 14].xxyx
        dp3 r10.w, r18.xyzx, r17.xyzx
        frc r17.x, r8.w
        frc r17.y, r10.w
        iadd r6.w, r6.w, l(-1)
        utof r17.z, r6.w
        sample_l_indexable(texture2darray)(float,float,float,float) r16.xyz, r17.xyzx, t20.xyzw, s2, l(0.000000)
      else 
        mov r16.xyz, l(1.000000,1.000000,1.000000,0)
      endif 
    endif 
    ...
    if_nz r6.w
        ...
        if_nz r10.w
          ...
          if_nz cb2[58].y
            ...
            loop 
              ige r12.w, r11.w, l(8)
              breakc_nz r12.w
              dp2 r19.x, icb[r11.w + 0].yxyy, r15.xyxx
              dp2 r19.y, icb[r11.w + 0].yxyy, r15.yzyy
              mad r18.xy, r19.xyxx, cb9[r0.y + 3].yyyy, r17.xyxx
      ...
      if_nz r7.w
        ...
        if_nz r10.w
          ...
          dp4 r10.w, r17.xyzw, r15.xyzw
          mov r17.xyz, cb9[r8.w + 7].yzwy
          mov r17.w, cb9[r8.w + 8].x
          dp4 r11.w, r17.xyzw, r15.xyzw
          ...
          if_z r12.w
            ...
            div r15.xy, r17.xyxx, r11.wwww
            mad r15.xy, r15.xyxx, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
            add r17.x, r15.x, cb9[r8.w + 9].w
            add r17.y, r15.y, cb9[r8.w + 10].x
            mul r15.xy, r17.xyxx, cb9[r8.w + 9].yzyy
            div r15.zw, cb9[r8.w + 3].yyyy, cb9[r8.w + 8].yyyw
            add r17.xy, -r15.zwzz, l(1.000000, 1.000000, 0.000000, 0.000000)
            ge r17.xy, r15.xyxx, r17.xyxx
            ge r15.zw, r15.zzzw, r15.xxxy
            or r15.zw, r15.zzzw, r17.xxxy
            or r14.w, r15.w, r15.z
            if_z r14.w
              mov_sat r15.xy, r15.xyxx
              mad r17.x, r15.x, cb9[r8.w + 8].y, cb9[r8.w + 8].z
              mad r17.y, r15.y, cb9[r8.w + 8].w, cb9[r8.w + 9].x
              mul r15.x, r11.w, cb9[r8.w + 10].z
          ...
          if_z r11.w
            ...
            if_nz cb2[58].y
              ...
              loop 
                ige r15.w, r14.w, l(8)
                breakc_nz r15.w
                dp2 r19.x, icb[r14.w + 0].yxyy, r15.xyxx
                dp2 r19.y, icb[r14.w + 0].yxyy, r15.yzyy
          ...
          if_nz r8.w
            ...
            mov r17.xyz, cb9[r0.y + 6].yzwy
            mov r17.w, cb9[r0.y + 7].x
            mov r15.w, l(1.000000)
            dp4 r8.w, r17.xyzw, r15.xyzw
            mov r17.xyz, cb9[r0.y + 7].yzwy
            mov r17.w, cb9[r0.y + 8].x
            dp4 r9.z, r17.xyzw, r15.xyzw
            lt r10.w, r9.z, r8.w
            if_z r10.w
              mov r17.xyz, cb9[r0.y + 4].yzwy
              mov r17.w, cb9[r0.y + 5].x
              ...
              mov r18.w, cb9[r0.y + 6].x
              dp4 r17.y, r18.xyzw, r15.xyzw
              div r15.xy, r17.xyxx, r9.zzzz
              mad r15.xy, r15.xyxx, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
              add r17.x, r15.x, cb9[r0.y + 9].w
              add r17.y, r15.y, cb9[r0.y + 10].x
              mul r15.xy, r17.xyxx, cb9[r0.y + 9].yzyy
            ...
            if_z r9.z
              ...
              if_nz cb2[58].y
                ...
                loop 
                  ige r11.w, r10.w, l(8)
                  breakc_nz r11.w
                  dp2 r19.x, icb[r10.w + 0].yxyy, r15.xyxx
                  dp2 r19.y, icb[r10.w + 0].yxyy, r15.yzyy
                  mad r18.xy, r19.xyxx, cb9[r0.y + 3].yyyy, r17.xyxx
        ...
        add r0.y, -r5.w, r0.y
        mad r0.y, r0.w, r0.y, r5.w
        mul r0.y, r6.w, r0.y
        lt r0.w, l(0.000000), r4.z
        mad r15.xyz, r0.yyyy, r16.xyzx, r13.yzwy
        mad r14.xyz, r14.xyzx, r1.wwww, r12.xyzx
        ...
        mad r11.xyz, r0.xxxx, r16.xyzx, r2.yzwy
        add_sat r0.y, -r0.y, l(1.000000)
        mul r0.z, r0.y, r0.y
        mul r0.z, r0.z, r0.z
        mul r0.y, r0.z, r0.y
        mul r0.x, r0.y, r0.x
        mad r0.xyz, r0.xxxx, r16.xyzx, r9.xywx
        movc r13.yzw, r0.wwww, r15.xxyz, r13.yyzw
        movc r9.xyw, r0.wwww, r0.xyxz, r9.xyxw
        movc r2.yzw, r0.wwww, r11.xxyz, r2.yyzw
      endif 
    endif 
  endif 
  break 
...
mad r0.xyz, r13.yzwy, r3.yzwy, r0.xyzx
...
ret 
// Approximately 1796 instruction slots used
