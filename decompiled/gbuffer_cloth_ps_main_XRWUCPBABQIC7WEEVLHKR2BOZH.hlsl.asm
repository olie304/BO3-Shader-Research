...
mul r0.w, r1.w, v1.x
sample_indexable(texture2d)(float,float,float,float) r2.x, v1.yzyy, t10.xyzw, s4
sample_indexable(texture2d)(float,float,float,float) r2.y, v1.yzyy, t9.yxzw, s2
add r2.z, -cb0[11].y, cb0[11].z
mad r2.y, r2.y, r2.z, cb0[11].y
...
mad r2.y, cb1[62].x, r2.z, cb0[11].y
mul_sat r2.y, r2.y, l(0.05882353)
...
mad r1.xyz, r1.xyzx, r4.xyzx, -r6.xyzx
mad r1.xyz, r3.xxxx, r1.xyzx, r6.xyzx
add r0.x, r0.x, r0.w
...
mul r4.xy, cb1[44].xyxx, l(0.500000, 0.500000, 0.000000, 0.000000)
mul r6.x, r0.x, r4.x
mul r6.y, r0.w, -r4.y
...
mad r3.xyz, r3.yzwy, r0.yyyy, -r1.wwww
max r0.y, r3.z, r3.y
max r0.y, r0.y, r3.x
max r0.y, r0.y, r1.w
eq r1.w, r0.y, r3.x
