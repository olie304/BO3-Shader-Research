  ...
  out float2 o3 : SV_TARGET3)
{
  ...
  r0.xy = mixMap.Sample(mixSampler_s, r0.xy).xy;
  r1.xyzw = cmp(levelsControls.xyzw != float4(0,1,0,1));
  r0.z = (int)r1.y | (int)r1.x;
  r0.z = (int)r1.z | (int)r0.z;
  r0.z = (int)r1.w | (int)r0.z;
  r0.w = saturate(-levelsControls.x + r0.x);
  r1.xy = levelsControls.yw + -levelsControls.xz;
  r1.x = max(9.99999975e-05, r1.x);
  r0.w = r0.w / r1.x;
  r0.w = min(1, r0.w);
  r0.w = r0.w * r1.y + levelsControls.z;
  r0.x = r0.z ? r0.w : r0.x;
  r1.xyzw = cmp(levelsControls1.xyzw != float4(0,1,0,1));
  r0.z = (int)r1.y | (int)r1.x;
  r0.z = (int)r1.z | (int)r0.z;
  r0.z = (int)r1.w | (int)r0.z;
  r0.w = saturate(-levelsControls1.x + r0.y);
  r1.xy = levelsControls1.yw + -levelsControls1.xz;
  r1.x = max(9.99999975e-05, r1.x);
  r0.w = r0.w / r1.x;
  r0.w = min(1, r0.w);
  r0.w = r0.w * r1.y + levelsControls1.z;
  r0.y = r0.z ? r0.w : r0.y;
  ...
  r4.xyzw = detailScale1.xyxy * r3.zwxy;
  r4.xy = useUVOffsets1 ? r4.xy : r4.zw;
  r3.xyzw = colorMapTile1.xyxy * r3.xyzw;
  r3.xy = useUVOffsets1 ? r3.zw : r3.xy;
  r3.xyzw = colorMap.Sample(colorSampler_s, r3.xy).xyzw;
  r5.xyz = float3(-1,-1,-1) + colorTint.xyz;
  r5.xyz = r3.www * r5.xyz + float3(1,1,1);
  r3.xyz = r5.xyz * r3.xyz;
  r2.w = specColorMap.Sample(specColorSampler_s, r4.xy).x;
  ...
  r7.xyzw = detailScale2.xyxy * r6.zwxy;
  r7.xy = useUVOffsets1 ? r7.xy : r7.zw;
  r6.xyzw = colorMapTile2.xyxy * r6.xyzw;
  r6.xy = useUVOffsets1 ? r6.zw : r6.xy;
  r6.xyzw = colorMapDetail2.Sample(colorSampler_s, r6.xy).xyzw;
  r8.xyz = float3(-1,-1,-1) + colorTint1.xyz;
  r8.xyz = r6.www * r8.xyz + float3(1,1,1);
  r4.w = specularMapDetail2.Sample(specColorSampler_s, r7.xy).x;
  ...
  r10.xyz = detailMap2.Sample(normalSampler_s, r7.xy).xyz;
  ...
  r1.yz = v2.yx + r11.xy;
  r1.yz = r1.yz + r1.ww;
  r7.zw = detailScale3.xy * r1.yz;
  r11.xy = float2(0.5,0.5) + r11.xy;
  r11.zw = detailScale3.xy * r11.xy;
  r7.zw = useUVOffsets3 ? r7.zw : r11.zw;
  r1.yz = colorMapTile3.xy * r1.yz;
  r11.xy = colorMapTile3.xy * r11.xy;
  r1.yz = useUVOffsets3 ? r1.yz : r11.xy;
  r11.xyzw = colorMapDetail3.Sample(colorSampler_s, r1.yz).xyzw;
  r1.yzw = float3(-1,-1,-1) + colorTint2.xyz;
  r1.yzw = r11.www * r1.yzw + float3(1,1,1);
  r12.xyz = detailMap3.Sample(normalSampler_s, r7.zw).xyz;
  r5.w = specularMapDetail3.Sample(specColorSampler_s, r7.zw).x;
  r13.xyz = float3(-0.0399999991,-0.0399999991,-0.0399999991) + specColorTint2.xyz;
  r13.xyz = r5.www * r13.xyz + float3(0.0399999991,0.0399999991,0.0399999991);
  r6.w = glossMapDetail2.Sample(specColorSampler_s, r7.xy).x;
  r6.xyz = r6.xyz * r8.xyz + -r3.xyz;
  r3.xyz = r0.xxx * r6.xyz + r3.xyz;
  r1.yzw = r11.xyz * r1.yzw + -r3.xyz;
  ...
  r3.w = r3.w * r2.w + glossRange.x;
  r3.w = saturate(0.0588235296 * r3.w);
  r4.w = glossRange2.y + -glossRange2.x;
  r4.w = r6.w * r4.w + glossRange2.x;
  r4.w = saturate(0.0588235296 * r4.w);
  r5.x = saturate(0.0588235296 * glossRange3.y);
  r4.w = r4.w + -r3.w;
  r3.w = r0.x * r4.w + r3.w;
  r4.w = r5.x + -r3.w;
  r3.w = r0.y * r4.w + r3.w;
  r4.w = aoMap.Sample(aoSampler_s, w1.xy).x;
  r5.xy = r10.xy * float2(1.9921875,1.9921875) + float2(-1,-1);
  r5.z = r10.z * r10.z;
  r5.z = 0.333333343 * r5.z;
  r5.z = min(1, r5.z);
  r2.xy = r4.xy * detailScaleHeight1 + r0.zw;
  r4.x = dot(r2.xyz, r2.xyz);
  r4.x = rsqrt(r4.x);
  r6.xyz = r4.xxx * r2.xyz;
  r6.w = r4.z * detailScaleHeight1 + r1.x;
  r2.xy = r5.xy * detailScaleHeight2 + r0.zw;
  r4.x = dot(r2.xyz, r2.xyz);
  r4.x = rsqrt(r4.x);
  r7.xyz = r4.xxx * r2.xyz;
  r7.w = r5.z * detailScaleHeight2 + r1.x;
  r4.xy = r12.xy * float2(1.9921875,1.9921875) + float2(-1,-1);
  r4.z = r12.z * r12.z;
  r4.z = 0.333333343 * r4.z;
  r4.z = min(1, r4.z);
  r2.xy = r4.xy * useUVOffsets1 + r0.zw;
  r0.z = dot(r2.xyz, r2.xyz);
  r0.z = rsqrt(r0.z);
  r5.xyz = r2.xyz * r0.zzz;
  r5.w = r4.z * useUVOffsets1 + r1.x;
  r7.xyzw = r7.xyzw + -r6.xyzw;
  r6.xyzw = r0.xxxx * r7.xyzw + r6.xyzw;
  r5.xyzw = -r6.xyzw + r5.xyzw;
  r0.xyzw = r0.yyyy * r5.xyzw + r6.xyzw;
  r1.x = v7.x ? 1 : -1;
  ...
  r2.y = debugGlossOverride.x * r2.w + glossRange.x;
  ...
  if (r2.z != 0) {
    ...
    r7.xyz = r6.xxx ? float3(1,0,1) : r1.yzw;
    r6.xyw = r6.yyy ? float3(0,1,1) : r1.yzw;
    r6.xyw = r3.www ? r7.xyz : r6.xyw;
    r7.xyz = r6.zzz ? float3(0,1,0) : r1.yzw;
    r1.yzw = r2.www ? r6.xyw : r7.xyz;
  }
  r6.xyz = debugColorOverride.xyz + -r1.yzw;
  o0.xyz = debugColorOverride.www * r6.xyz + r1.yzw;
  r1.yzw = debugSpecularOverride.xyz + -r3.xyz;
  r1.yzw = debugSpecularOverride.www * r1.yzw + r3.xyz;
  r2.y = r2.y * 1 + -r0.w;
  r0.w = debugGlossOverride.w * r2.y + r0.w;
  r2.y = debugOcclusionOverride.x + -r4.w;
  o2.z = debugOcclusionOverride.w * r2.y + r4.w;
  r2.xyz = v3.xyz * r2.xxx + -r0.xyz;
  r2.yzw = debugNormalOverride.www * r2.xyz + r0.xyz;
  r0.xy = v6.xy / v6.ww;
