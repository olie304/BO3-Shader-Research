...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  r1.x = w1.x * r0.w;
  r1.yzw = specColorMap.Sample(specColorSampler_s, v2.xy).xyz;
  ...
  r0.w = rsqrt(r0.w);
  r2.yzw = -v7.xyz * r0.www;
  r9.x = dot(r2.yzw, v5.xyz);
  r9.y = dot(r2.yzw, v6.xyz);
  r1.w = dot(r2.yzw, v4.xyz);
  r3.x = cmp(0 < r1.w);
  r6.zw = -r9.xy / r1.ww;
  r3.xw = r3.xx ? r6.zw : 0;
  ...
  r3.xw = r3.xw * r1.ww;
  r3.xw = scaleUVs.xy * r3.xw;
  r3.xw = r6.zw * scaleUVs.xy + r3.xw;
  r3.xw = offsetUVs.xy * scaleUVs.xy + r3.xw;
  ...
  r10.y = r10.x;
  r10.z = r9.x;
  r11.x = dot(r10.yz, r3.xw);
  r10.x = -r9.x;
  r11.y = dot(r10.xy, r3.xw);
  r3.xw = gameTime.ww * scrollUVs.xy;
  r3.xw = r3.xw * scaleUVs.xy + r11.xy;
  ...
  r6.zw = saturate(r3.xw);
  r3.xw = clampU ? r6.zw : r3.xw;
  r1.w = saturate(dot(r2.yzw, r4.xyz));
  r4.xyzw = emissiveMap.Sample(colorSampler_s, r3.xw).xyzw;
  r4.xyz = emissiveTint1.xyz * r4.xyz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r3.x, v3.x, l(4), t4.xxxx
r3.x = samp0[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) r3.x, r3.x, l(16), t0.xxxx
r3.x = samp0[]..swiz;
  r3.w = revealMap.Sample(revealSampler_s, v2.xy).x;
  r3.x = saturate(0.998000026 * r3.x);
  r6.z = saturate(-alphaRevealParms.x * 0.5 + r3.x);
  r6.w = -r6.z + r3.x;
  r6.z = -r6.z + r3.w;
  r6.w = 1 / r6.w;
  ...
  r6.z = r6.z * r6.z;
  r6.z = r6.w * r6.z;
  r6.w = saturate(alphaRevealParms.x * 0.5 + r3.x);
  r6.w = r6.w + -r3.x;
  r3.x = r3.w + -r3.x;
  r3.w = 1 / r6.w;
  ...
  r3.x = r6.z * r3.x;
  r3.x = log2(r3.x);
  r3.x = alphaRevealParms.y * r3.x;
  r3.x = exp2(r3.x);
  r3.w = 0.200000003 + r3.x;
  r3.w = min(1, r3.w);
  r3.w = r4.w * r3.w;
  r9.xyz = emissiveTint1.xyz * r3.www;
  r4.xyz = saturate(r4.xyz * r3.xxx + r9.xyz);
  r3.x = log2(r1.w);
  ...
  r1.w = exp2(r1.w);
  r1.w = invertFalloff ? r1.w : r3.x;
  r3.x = cmp(emissiveFalloffPower == 0.000000);
  r1.w = r3.x ? 1 : r1.w;
  r1.w = hdrScale * r1.w;
  ...
  r3.y = dot(-r2.yzw, r5.xyz);
  r3.y = r3.y + r3.y;
  r12.xyz = r5.xyz * -r3.yyy + -r2.yzw;
  r3.y = 17 * r6.y;
  r3.y = exp2(r3.y);
  r3.y = 2 + r3.y;
  r3.y = 2 / r3.y;
  ...
  r3.w = r6.z * r3.w;
  r4.w = r6.z * r4.w;
  r6.z = dot(r5.xyz, sunConstants.wldDir.xyz);
  r6.w = saturate(r6.z);
  r8.w = cmp(0 >= r6.w);
  if (r8.w != 0) {
    r9.z = 0;
  ...
  if (r8.w != 0) {
    r8.w = cmp(0 < r9.z);
    if (r8.w != 0) {
      r8.w = sunConstants.specScale * r3.y;
      r8.w = r8.w * r6.w;
      ...
      r0.w = dot(r11.yzw, r2.yzw);
      r7.w = dot(r5.xyz, r11.yzw);
      r9.w = abs(r7.w) * r3.y + -abs(r7.w);
            ...
            r40.w = samp0[]..swiz;
              ...
              if (r19.z != 0) {
                ...
                if (r19.z != 0) {
                  ...
                  r20.y = r20.y + -r19.x;
                  r20.y = r3.z * r20.y + r19.x;
                  r20.y = r20.y * r15.w;
                  r18.y = cmp(0 < r18.y);
                  r22.xyz = r20.yyy * r31.xyz + r16.xyz;
                  r23.xyz = r38.xyz * r18.xxx + r2.yzw;
                  r18.x = dot(r23.xyz, r23.xyz);
                  r18.x = rsqrt(r18.x);
                  r23.xyz = r23.xyz * r18.xxx;
                  r18.x = dot(r23.xyz, r2.yzw);
                  r20.y = dot(r5.xyz, r23.xyz);
                  r20.w = abs(r20.y) * r3.y + -abs(r20.y);
                  r20.y = abs(r20.y) * r20.w + 1;
                  r19.x = r19.x * r3.w + r4.w;
                  r20.y = r20.y * r20.y;
                  r19.x = r20.y * r19.x;
                  r19.x = rcp(r19.x);
                  r19.x = r19.x * r19.z;
  ...
  while (true) {
    ...
    if (r4.w != 0) break;
    r3.z = (uint)r3.w >> 5;
    r7.xyz = (int3)r3.xyz + (int3)r8.xyz;
  ...
  r26.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r29.xyzw, r3.w, l(164), t15.zwxy
  r29.x = samp0[]..swiz;
  r29.y = samp0[]..swiz;
  r29.z = samp0[]..swiz;
  r29.w = samp0[]..swiz;
  ...
  r38.w = samp0[]..swiz;
    ...
    r9.x = r10.w * r9.w;
    r9.w = r6.z ? 0.000000 : 0;
    r9.xw = r9.ww ? r9.xy : r9.zx;
    r33.xy = r24.zw;
    r33.z = r25.z;
    r10.w = dot(r12.xyz, r33.xyz);
    r11.x = dot(r7.xyz, r33.xyz);
    r11.x = r11.x + -r25.w;
    r13.w = cmp(r11.x >= 0);
    r11.x = max(abs(r11.x), r2.y);
    r11.x = r13.w ? r11.x : -r11.x;
    r10.w = max(1.00000001e-07, -r10.w);
    r10.w = r11.x / r10.w;
    r10.w = min(131072, abs(r10.w));
    r25.z = r26.z;
    r11.x = dot(r12.xyz, r25.xyz);
    r13.w = dot(r7.xyz, r25.xyz);
    r13.w = r13.w + -r26.w;
    r14.w = cmp(r13.w >= 0);
    r13.w = max(abs(r13.w), r2.y);
    ...
    r10.w = min(abs(r11.x), r10.w);
    r29.z = r30.z;
    r11.x = dot(r12.xyz, r29.xyz);
    r13.w = dot(r7.xyz, r29.xyz);
    r13.w = r13.w + -r30.w;
    r14.w = cmp(r13.w >= 0);
    r13.w = max(abs(r13.w), r2.y);
    r13.w = r14.w ? r13.w : -r13.w;
    ...
    r10.w = min(abs(r11.x), r10.w);
    r30.z = r31.x;
    r11.x = dot(r12.xyz, r30.xyz);
    r13.w = dot(r7.xyz, r30.xyz);
    r13.w = r13.w + -r31.y;
    r14.w = cmp(r13.w >= 0);
    r13.w = max(abs(r13.w), r2.y);
    r13.w = r14.w ? r13.w : -r13.w;
    ...
    r10.w = min(abs(r11.x), r10.w);
    r32.zw = r31.zw;
    r11.x = dot(r12.zxy, r32.xzw);
    r13.w = dot(r7.zxy, r32.xzw);
    r13.w = r13.w + -r32.y;
    r14.w = cmp(r13.w >= 0);
    r13.w = max(abs(r13.w), r2.y);
    r13.w = r14.w ? r13.w : -r13.w;
    ...
    r25.xyz = r12.xyz * r10.www + r25.xyz;
    ...
    r29.xy = r19.xw;
    r29.z = r20.w;
    r26.y = dot(r25.xyz, r29.xyz);
    r20.x = r19.y;
    r26.z = dot(r25.xyz, r20.xyz);
    if (6 == 0) r15.z = 0; else if (6+25 < 32) {     r15.z = (uint)r24.y << (32-(6 + 25)); r15.z = (uint)r15.z >> (32-6);    } else r15.z = (uint)r24.y >> 25;
    if (9 == 0) r15.w = 0; else if (9+16 < 32) {     r15.w = (uint)r24.y << (32-(9 + 16)); r15.w = (uint)r15.w >> (32-9);    } else r15.w = (uint)r24.y >> 16;
    r26.w = (uint)r15.w;
    r19.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r26.xyzw, r10.w).xyz;
    r24.yzw = (int3)r19.xyz & int3(-2147483648,-2147483648,-2147483648);
    r24.yzw = cmp((int3)r24.yzw == int3(2139095040,2139095040,2139095040));
    r10.w = (int)r24.z | (int)r24.y;
    r10.w = (int)r24.w | (int)r10.w;
    r19.xyz = r10.www ? float3(1,1,0) : r19.xyz;
    r25.x = dot(r7.xyz, r18.xyz);
    r25.y = dot(r7.xyz, r29.xyz);
    ...
    r24.yzw = cmp((int3)r24.yzw == int3(2139095040,2139095040,2139095040));
    r10.z = (int)r24.z | (int)r24.y;
    r10.z = (int)r24.w | (int)r10.z;
    ...
    while (true) {
      ...
      r11.x = 1 << (int)r11.x;
      r13.z = (int)r10.w & (int)r11.x;
      if (r13.z != 0) {
        r11.x = ~(int)r11.x;
        r10.w = (int)r10.w & (int)r11.x;
        if (r4.w != 0) {
          r11.x = r6.z;
          r26.xy = r9.xw;
          r13.z = 1;
          while (true) {
            r13.w = cmp((int)r13.z >= (int)r15.z);
            if (r13.w != 0) break;
          ...
          r34.z = samp0[]..swiz;
          r34.w = samp0[]..swiz;
            r13.w = dot(r29.xyz, r7.xyz);
            r13.w = saturate(r13.w + r29.w);
            r13.w = r26.x * r13.w;
            r14.z = dot(r30.xyz, r7.xyz);
            r14.z = saturate(r14.z + r30.w);
            r13.w = r14.z * r13.w;
            r14.z = dot(r31.xyz, r7.xyz);
            r14.z = saturate(r14.z + r31.w);
            r13.w = r14.z * r13.w;
            r14.z = dot(r32.xyz, r7.xyz);
            r14.z = saturate(r14.z + r32.w);
            r13.w = r14.z * r13.w;
            r14.z = dot(r33.xyz, r7.xyz);
            r14.z = saturate(r14.z + r33.w);
            r13.w = r14.z * r13.w;
            r14.z = dot(r34.xyz, r7.xyz);
            r14.z = saturate(r14.z + r34.w);
            r26.x = r14.z * r13.w;
            r14.w = (uint)r11.x >> 2;
            if (1 == 0) r15.w = 0; else if (1+2 < 32) {             r15.w = (uint)r11.x << (32-(1 + 2)); r15.w = (uint)r15.w >> (32-1);            } else r15.w = (uint)r11.x >> 2;
            r18.z = (int)r14.w & 2;
            r19.w = max(r26.y, r26.x);
            r13.w = -r13.w * r14.z + 1;
            r13.w = r26.y * r13.w;
            r15.y = r18.z ? r13.w : r19.w;
            r26.xy = r15.ww ? r26.xy : r15.xy;
            r13.z = (int)r13.z + 1;
            r11.x = r14.w;
          }
          ...
          r13.z = cmp(0 < r11.x);
          if (r13.z != 0) {
            r29.z = r26.y * r6.w + r24.w;
            r11.x = r11.x * r24.x;
            r26.xzw = r22.xyz * r11.xxx;
            r30.xyz = r26.zzz * r18.xyw;
            r30.xyz = r20.xyz * r26.xxx + r30.xyz;
            r26.xzw = r21.xyz * r26.www + r30.xyz;
            r30.xyz = r26.xzw * r23.xyz;
            r13.z = dot(r30.xyz, float3(0.212599993,0.715200007,0.0722000003));
            r30.xyz = r26.xzw * r23.xyz + r25.xyz;
            r13.w = r13.z * r2.z;
            r26.xzw = r19.xyz * r11.xxx;
            r11.x = dot(r26.xzw, float3(0.212599993,0.715200007,0.0722000003));
            r11.x = r2.z * r13.z + r11.x;
            r11.x = r13.w / r11.x;
            r31.x = r25.w;
            r31.yz = r24.yz;
            r29.xyw = r26.zwx * r11.xxx + r31.yzx;
            r30.w = r29.w;
          } else {
            r30.xyzw = r25.xyzw;
            r29.xyz = r24.yzw;
  ...
  if (r2.w == 0) {
    ...
    while (true) {
      ...
      while (true) {
        ...
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=80)(mixed,mixed,mixed,mixed) r23.xyzw, r8.w, l(0), t11.xyzw
        r23.x = samp0[]..swiz;
        r23.y = samp0[]..swiz;
        r23.z = samp0[]..swiz;
        r23.w = samp0[]..swiz;
        ...
        r9.y = samp0[]..swiz;
          ...
          r24.w = samp0[]..swiz;
            ...
            r8.w = (int)r24.w & 0x0000ffff;
            if (6 == 0) r9.z = 0; else if (6+25 < 32) {             r9.z = (uint)r24.w << (32-(6 + 25)); r9.z = (uint)r9.z >> (32-6);            } else r9.z = (uint)r24.w >> 25;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r26.xyzw, r8.w, l(0), t16.xyzw
          r26.x = samp0[]..swiz;
          r26.y = samp0[]..swiz;
          r26.z = samp0[]..swiz;
          r26.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r29.xyzw, r8.w, l(16), t16.xyzw
          r29.x = samp0[]..swiz;
          r29.y = samp0[]..swiz;
          r29.z = samp0[]..swiz;
          r29.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r30.xyzw, r8.w, l(32), t16.xyzw
          r30.x = samp0[]..swiz;
          r30.y = samp0[]..swiz;
          r30.z = samp0[]..swiz;
          r30.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r31.xyzw, r8.w, l(48), t16.xyzw
          r31.x = samp0[]..swiz;
          r31.y = samp0[]..swiz;
          r31.z = samp0[]..swiz;
          r31.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r32.xyzw, r8.w, l(64), t16.xyzw
          r32.x = samp0[]..swiz;
          r32.y = samp0[]..swiz;
          r32.z = samp0[]..swiz;
          r32.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r33.xyzw, r8.w, l(80), t16.xyzw
          r33.x = samp0[]..swiz;
          r33.y = samp0[]..swiz;
          r33.z = samp0[]..swiz;
          r33.w = samp0[]..swiz;
            ...
            r11.x = dot(r29.xyz, r25.xyz);
            r11.x = saturate(r11.x + r29.w);
            r10.w = r11.x * r10.w;
            r11.x = dot(r30.xyz, r25.xyz);
            r11.x = saturate(r11.x + r30.w);
            r10.w = r11.x * r10.w;
            r11.x = dot(r31.xyz, r25.xyz);
            r11.x = saturate(r11.x + r31.w);
            r10.w = r11.x * r10.w;
            r11.x = dot(r32.xyz, r25.xyz);
            r11.x = saturate(r11.x + r32.w);
            r10.w = r11.x * r10.w;
            r11.x = dot(r33.xyz, r25.xyz);
            r11.x = saturate(r11.x + r33.w);
            r10.x = r11.x * r10.w;
            ...
            r34.w = samp0[]..swiz;
              ...
              r26.x = r14.z * r14.w;
              r15.w = (uint)r11.x >> 2;
              if (1 == 0) r18.w = 0; else if (1+2 < 32) {               r18.w = (uint)r11.x << (32-(1 + 2)); r18.w = (uint)r18.w >> (32-1);              } else r18.w = (uint)r11.x >> 2;
              r23.w = (int)r15.w & 2;
              r25.w = max(r26.y, r26.x);
              r14.z = -r14.z * r14.w + 1;
              r14.z = r26.y * r14.z;
              r14.y = r23.w ? r14.z : r25.w;
              r26.xy = r18.ww ? r26.xy : r14.xy;
              r13.w = (int)r13.w + 1;
              r11.x = r15.w;
            }
            r26.y = saturate(r26.y);
            ...
            if (r9.x != 0) {
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r29.xyzw, r7.w, l(16), t15.xyzw
            r29.x = samp0[]..swiz;
            r29.y = samp0[]..swiz;
            r29.z = samp0[]..swiz;
            r29.w = samp0[]..swiz;
            ...
            r39.x = samp0[]..swiz;
            r39.y = samp0[]..swiz;
              r22.z = r26.y * r9.y + r22.z;
              r7.w = r8.w * r24.z;
              r24.z = r34.z;
              r8.w = dot(r12.xyz, r24.xyz);
              r9.x = dot(r25.xyz, r24.xyz);
              r9.x = r9.x + -r34.w;
              r9.y = cmp(r9.x >= 0);
              ...
              r9.y = dot(r25.xyz, r34.xyz);
              r9.y = r9.y + -r35.w;
              r9.z = cmp(r9.y >= 0);
              r9.y = max(abs(r9.y), r2.y);
              r9.y = r9.z ? r9.y : -r9.y;
              ...
              r8.w = min(abs(r9.x), r8.w);
              r36.z = r37.z;
              r9.x = dot(r12.xyz, r36.xyz);
              r9.y = dot(r25.xyz, r36.xyz);
              r9.y = r9.y + -r37.w;
              r9.z = cmp(r9.y >= 0);
              r9.y = max(abs(r9.y), r2.y);
              r9.y = r9.z ? r9.y : -r9.y;
              ...
              r8.w = min(abs(r9.x), r8.w);
              r37.z = r38.x;
              r9.x = dot(r12.xyz, r37.xyz);
              r9.y = dot(r25.xyz, r37.xyz);
              r9.y = r9.y + -r38.y;
              r9.z = cmp(r9.y >= 0);
              r9.y = max(abs(r9.y), r2.y);
              r9.y = r9.z ? r9.y : -r9.y;
              ...
              r8.w = min(abs(r9.x), r8.w);
              r39.zw = r38.zw;
              r9.x = dot(r12.zxy, r39.xzw);
              r9.y = dot(r25.zxy, r39.xzw);
              r9.y = r9.y + -r39.y;
              r9.z = cmp(r9.y >= 0);
              r9.y = max(abs(r9.y), r2.y);
              r9.y = r9.z ? r9.y : -r9.y;
              ...
              r23.y = r29.z;
              r23.z = r30.x;
              r34.x = dot(r9.xyz, r23.xyz);
              r24.xy = r29.xw;
              r24.z = r30.w;
              r34.y = dot(r9.xyz, r24.xyz);
              r30.x = r29.y;
              r34.z = dot(r9.xyz, r30.xyz);
              if (9 == 0) r9.x = 0; else if (9+16 < 32) {               r9.x = (uint)r24.w << (32-(9 + 16)); r9.x = (uint)r9.x >> (32-9);              } else r9.x = (uint)r24.w >> 16;
              r34.w = (uint)r9.x;
              r9.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r34.xyzw, r8.w).xyz;
              r14.yzw = (int3)r9.xyz & int3(-2147483648,-2147483648,-2147483648);
              r14.yzw = cmp((int3)r14.yzw == int3(2139095040,2139095040,2139095040));
              r8.w = (int)r14.z | (int)r14.y;
              r8.w = (int)r14.w | (int)r8.w;
              r9.xyz = r8.www ? float3(1,1,0) : r9.xyz;
              r29.x = dot(r25.xyz, r23.xyz);
              r29.y = dot(r25.xyz, r24.xyz);
              r29.z = dot(r25.xyz, r30.xyz);
              r14.yzw = saturate(r29.xyz * r31.xyz + float3(0.5,0.5,0.5));
              r32.z = r33.x;
              r14.yzw = r14.yzw * r32.xyz + r33.yzw;
              r34.x = dot(r5.xyz, r23.xyz);
              r34.y = dot(r5.xyz, r24.xyz);
              r34.z = dot(r5.xyz, r30.xyz);
              r23.xyz = cmp(float3(0,0,0) < r34.xyz);
              r13.z = r23.x ? 0 : 0.5;
              r24.xyz = r14.yzw + r13.xyz;
              ...
              r14.yzw = r14.yzw * r25.zzz + r23.xyw;
              ...
              r8.w = (int)r24.y | (int)r24.x;
              r8.w = (int)r24.z | (int)r8.w;
              r23.xyz = r8.www ? float3(1,1,0) : r23.xyz;
              r24.xyz = r23.xyz * r14.yzw;
              r8.w = dot(r24.xyz, float3(0.212599993,0.715200007,0.0722000003));
              r21.xyz = r14.yzw * r23.xyz + r21.xyz;
              r10.x = r8.w * r2.z;
    ...
    if (r3.z != 0) {
      ...
      while (true) {
        ...
        r7.z = (uint)r3.w >> 5;
        r9.xyz = (int3)r7.xyz + (int3)r8.xyz;
        r4.w = visibleProbes.Load(r9.xyzw).x;
        ...
        while (true) {
          ...
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=80)(mixed,mixed,mixed,mixed) r24.xyzw, r8.w, l(0), t11.xyzw
          r24.x = samp0[]..swiz;
          r24.y = samp0[]..swiz;
          r24.z = samp0[]..swiz;
          r24.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=80)(mixed,mixed,mixed,mixed) r25.xy, r8.w, l(16), t11.xyxx
          r25.x = samp0[]..swiz;
          r25.y = samp0[]..swiz;
            ...
            r24.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r14.zw, r7.w, l(96), t15.xxxy
            r14.z = samp0[]..swiz;
            r14.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
            ...
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r29.xyzw, r8.w, l(0), t16.xyzw
            r29.x = samp0[]..swiz;
            r29.y = samp0[]..swiz;
            r29.z = samp0[]..swiz;
            r29.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r30.xyzw, r8.w, l(16), t16.xyzw
            r30.x = samp0[]..swiz;
            r30.y = samp0[]..swiz;
            r30.z = samp0[]..swiz;
            r30.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r31.xyzw, r8.w, l(32), t16.xyzw
            r31.x = samp0[]..swiz;
            r31.y = samp0[]..swiz;
            r31.z = samp0[]..swiz;
            r31.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r32.xyzw, r8.w, l(48), t16.xyzw
            r32.x = samp0[]..swiz;
            r32.y = samp0[]..swiz;
            r32.z = samp0[]..swiz;
            r32.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r33.xyzw, r8.w, l(64), t16.xyzw
            r33.x = samp0[]..swiz;
            r33.y = samp0[]..swiz;
            r33.z = samp0[]..swiz;
            r33.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r34.xyzw, r8.w, l(80), t16.xyzw
            r34.x = samp0[]..swiz;
            r34.y = samp0[]..swiz;
            r34.z = samp0[]..swiz;
            r34.w = samp0[]..swiz;
              r11.x = dot(r29.xyz, r26.xyz);
              r11.x = saturate(r11.x + r29.w);
              r13.w = dot(r30.xyz, r26.xyz);
              r13.w = saturate(r13.w + r30.w);
              r11.x = r13.w * r11.x;
              r13.w = dot(r31.xyz, r26.xyz);
              r13.w = saturate(r13.w + r31.w);
              r11.x = r13.w * r11.x;
              r13.w = dot(r32.xyz, r26.xyz);
              r13.w = saturate(r13.w + r32.w);
              r11.x = r13.w * r11.x;
              r13.w = dot(r33.xyz, r26.xyz);
              r13.w = saturate(r13.w + r33.w);
              r11.x = r13.w * r11.x;
              r13.w = dot(r34.xyz, r26.xyz);
              r13.w = saturate(r13.w + r34.w);
              r10.x = r13.w * r11.x;
              r11.x = (int)r14.z & 1;
              r29.xy = r11.xx ? r10.xy : r10.zx;
              r10.x = r14.z;
              r30.xy = r29.xy;
              r11.x = 1;
              while (true) {
                r13.w = cmp((int)r11.x >= (int)r10.w);
                if (r13.w != 0) break;
                r13.w = (int)r8.w + (int)r11.x;
              // Known bad code for instruction (needs manual fix):
              ...
              r36.w = samp0[]..swiz;
                ...
                r13.w = -r13.w * r15.w + 1;
                r13.w = r30.y * r13.w;
                r14.y = r22.w ? r13.w : r24.w;
                r30.xy = r18.ww ? r30.xy : r14.xy;
                r11.x = (int)r11.x + 1;
                r10.x = r17.w;
              }
              r8.w = saturate(r30.y + -r6.w);
              r10.x = r8.w * r14.w;
              r10.w = cmp(0 < r10.x);
              if (r10.w != 0) {
              // Known bad code for instruction (needs manual fix):
              ...
              r40.y = samp0[]..swiz;
                ...
                r14.yzw = r12.xyz * r8.www + r14.yzw;
                r10.x = dot(r14.yzw, r14.yzw);
                r10.x = sqrt(r10.x);
                r8.w = r8.w / r10.x;
                r8.w = r8.w + r8.w;
                r8.w = sqrt(r8.w);
                ...
                r35.w = (uint)r10.x;
                r14.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r35.xyzw, r8.w).xyz;
                ...
                r29.x = dot(r26.xyz, r24.xyz);
                r29.y = dot(r26.xyz, r25.xyz);
                r29.z = dot(r26.xyz, r31.xyz);
                r26.xyz = saturate(r29.xyz * r32.xyz + float3(0.5,0.5,0.5));
                r33.z = r34.x;
    ...
    if (r2.y != 0) {
      ...
      r3.xyz = -globalProbeConstants.data[0].xyz + v7.xyz;
      ...
      r12.w = 0;
      r3.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r12.xyzw, r1.w).xyz;
  ...
  r3.xzw = r5.xyz * r3.xxx + r27.xyz;
  r5.xyz = r5.xyz * r3.yyy + r28.xyz;
