...
r4.z = samp0[]..swiz;
  ...
  while (true) {
    ...
    if (r6.z != 0) break;
    r4.z = (uint)r4.w >> 5;
    r5.xyz = (int3)r4.xyz + (int3)r12.xyz;
  ...
  r31.x = samp0[]..swiz;
  r31.y = samp0[]..swiz;
    r32.xyz = v7.xyz + -r17.yzw;
    r5.z = dot(r32.xyz, r32.xyz);
    r5.z = sqrt(r5.z);
    r5.z = cmp(probeDebugRadius >= r5.z);
    r6.z = (int)r23.y & 0x0000ffff;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r33.xyzw, r6.z, l(0), t16.xyzw
  r33.x = samp0[]..swiz;
  r33.y = samp0[]..swiz;
  r33.z = samp0[]..swiz;
  r33.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r34.xyzw, r6.z, l(16), t16.xyzw
  r34.x = samp0[]..swiz;
  r34.y = samp0[]..swiz;
  r34.z = samp0[]..swiz;
  r34.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r35.xyzw, r6.z, l(32), t16.xyzw
  r35.x = samp0[]..swiz;
  r35.y = samp0[]..swiz;
  r35.z = samp0[]..swiz;
  r35.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r36.xyzw, r6.z, l(48), t16.xyzw
  r36.x = samp0[]..swiz;
  r36.y = samp0[]..swiz;
  r36.z = samp0[]..swiz;
  r36.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r37.xyzw, r6.z, l(64), t16.xyzw
  r37.x = samp0[]..swiz;
  r37.y = samp0[]..swiz;
  r37.z = samp0[]..swiz;
  r37.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r38.xyzw, r6.z, l(80), t16.xyzw
  r38.x = samp0[]..swiz;
  r38.y = samp0[]..swiz;
  r38.z = samp0[]..swiz;
  r38.w = samp0[]..swiz;
    r6.w = dot(r33.xyz, r32.xyz);
    r6.w = saturate(r6.w + r33.w);
    ...
    r7.x = r7.w * r6.w;
    r6.w = (int)r5.x & 1;
    r7.xw = r6.ww ? r7.xy : r7.zx;
    r33.xy = r23.zw;
    r33.z = r24.z;
    r6.w = dot(r10.xyz, r33.xyz);
    r8.w = dot(r32.xyz, r33.xyz);
    r8.w = r8.w + -r24.w;
    r9.x = cmp(r8.w >= 0);
    r8.w = max(abs(r8.w), r3.y);
    r8.w = r9.x ? r8.w : -r8.w;
    ...
    r8.w = r9.x / r8.w;
    r6.w = min(abs(r8.w), r6.w);
    r25.z = r26.z;
    r8.w = dot(r10.xyz, r25.xyz);
    r9.x = dot(r32.xyz, r25.xyz);
    r9.x = r9.x + -r26.w;
    r11.w = cmp(r9.x >= 0);
    r9.x = max(abs(r9.x), r3.y);
    r9.x = r11.w ? r9.x : -r9.x;
    ...
    r6.w = min(abs(r8.w), r6.w);
    r26.z = r29.z;
    r8.w = dot(r10.xyz, r26.xyz);
    r9.x = dot(r32.xyz, r26.xyz);
    r9.x = r9.x + -r29.w;
    r11.w = cmp(r9.x >= 0);
    r9.x = max(abs(r9.x), r3.y);
    r9.x = r11.w ? r9.x : -r9.x;
    ...
    r6.w = min(abs(r8.w), r6.w);
    r29.z = r30.x;
    r8.w = dot(r10.xyz, r29.xyz);
    r9.x = dot(r32.xyz, r29.xyz);
    r9.x = r9.x + -r30.y;
    r11.w = cmp(r9.x >= 0);
    r9.x = max(abs(r9.x), r3.y);
    r9.x = r11.w ? r9.x : -r9.x;
    ...
    r6.w = min(abs(r8.w), r6.w);
    r31.zw = r30.zw;
    r8.w = dot(r10.zxy, r31.xzw);
    r9.x = dot(r32.zxy, r31.xzw);
    r9.x = r9.x + -r31.y;
    r11.w = cmp(r9.x >= 0);
    r9.x = max(abs(r9.x), r3.y);
    r9.x = r11.w ? r9.x : -r9.x;
    ...
    r24.x = r20.w;
    r24.yz = r21.zw;
    r24.xyz = r24.xyz + r32.xyz;
    r24.xyz = r10.xyz * r6.www + r24.xyz;
    ...
    if (6 == 0) r14.z = 0; else if (6+25 < 32) {     r14.z = (uint)r23.y << (32-(6 + 25)); r14.z = (uint)r14.z >> (32-6);    } else r14.z = (uint)r23.y >> 25;
    if (9 == 0) r14.w = 0; else if (9+16 < 32) {     r14.w = (uint)r23.y << (32-(9 + 16)); r14.w = (uint)r14.w >> (32-9);    } else r14.w = (uint)r23.y >> 16;
    r25.w = (uint)r14.w;
    r18.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r25.xyzw, r6.w).xyz;
    r23.yzw = (int3)r18.xyz & int3(-2147483648,-2147483648,-2147483648);
    r23.yzw = cmp((int3)r23.yzw == int3(2139095040,2139095040,2139095040));
    r6.w = (int)r23.z | (int)r23.y;
    r6.w = (int)r23.w | (int)r6.w;
    r18.xyz = r6.www ? float3(1,1,0) : r18.xyz;
    r24.x = dot(r32.xyz, r17.xyz);
    r24.y = dot(r32.xyz, r26.xyz);
    r24.z = dot(r32.xyz, r19.xyz);
    ...
    r6.w = (int)r23.z | (int)r23.y;
    r6.w = (int)r23.w | (int)r6.w;
    r22.xyz = r6.www ? float3(1,1,0) : r22.xyz;
    r24.xyzw = r15.xyzw;
    r23.yzw = r16.yzw;
    r6.w = r3.w;
    r8.z = r4.z;
    while (true) {
      ...
      if (r9.x != 0) {
        ...
        if (r5.z != 0) {
          ...
          r9.x = 1;
          while (true) {
            r11.z = cmp((int)r9.x >= (int)r14.z);
            if (r11.z != 0) break;
            r11.z = (int)r6.z + (int)r9.x;
          // Known bad code for instruction (needs manual fix):
          ...
          r34.z = samp0[]..swiz;
          r34.w = samp0[]..swiz;
            r11.z = dot(r26.xyz, r32.xyz);
            r11.z = saturate(r11.z + r26.w);
            r11.z = r25.x * r11.z;
            r11.w = dot(r29.xyz, r32.xyz);
            r11.w = saturate(r11.w + r29.w);
            r11.z = r11.z * r11.w;
            r11.w = dot(r30.xyz, r32.xyz);
            r11.w = saturate(r11.w + r30.w);
            r11.z = r11.z * r11.w;
            r11.w = dot(r31.xyz, r32.xyz);
            r11.w = saturate(r11.w + r31.w);
            r11.z = r11.z * r11.w;
            r11.w = dot(r33.xyz, r32.xyz);
            r11.w = saturate(r11.w + r33.w);
            r11.z = r11.z * r11.w;
            r11.w = dot(r34.xyz, r32.xyz);
            r11.w = saturate(r11.w + r34.w);
            r25.x = r11.z * r11.w;
            r12.w = (uint)r8.w >> 2;
            if (1 == 0) r13.z = 0; else if (1+2 < 32) {             r13.z = (uint)r8.w << (32-(1 + 2)); r13.z = (uint)r13.z >> (32-1);            } else r13.z = (uint)r8.w >> 2;
            r13.w = (int)r12.w & 2;
            r14.w = max(r25.y, r25.x);
            r11.z = -r11.z * r11.w + 1;
            r11.z = r25.y * r11.z;
            r14.y = r13.w ? r11.z : r14.w;
            r25.xy = r13.zz ? r25.xy : r14.xy;
            r9.x = (int)r9.x + 1;
            r8.w = r12.w;
          }
      ...
      while (true) {
        ...
        r23.y = samp0[]..swiz;
          ...
          r23.w = samp0[]..swiz;
            ...
            r8.w = (int)r23.w & 0x0000ffff;
            if (6 == 0) r9.x = 0; else if (6+25 < 32) {             r9.x = (uint)r23.w << (32-(6 + 25)); r9.x = (uint)r9.x >> (32-6);            } else r9.x = (uint)r23.w >> 25;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r25.xyzw, r8.w, l(0), t16.xyzw
          r25.x = samp0[]..swiz;
          r25.y = samp0[]..swiz;
          r25.z = samp0[]..swiz;
          r25.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r26.xyzw, r8.w, l(16), t16.xyzw
          r26.x = samp0[]..swiz;
          r26.y = samp0[]..swiz;
          r26.z = samp0[]..swiz;
          r26.w = samp0[]..swiz;
          ...
          r32.w = samp0[]..swiz;
            ...
            r12.w = dot(r26.xyz, r24.xyz);
            r12.w = saturate(r12.w + r26.w);
            r11.w = r12.w * r11.w;
            r12.w = dot(r29.xyz, r24.xyz);
            r12.w = saturate(r12.w + r29.w);
            r11.w = r12.w * r11.w;
            r12.w = dot(r30.xyz, r24.xyz);
            r12.w = saturate(r12.w + r30.w);
            r11.w = r12.w * r11.w;
            r12.w = dot(r31.xyz, r24.xyz);
            r12.w = saturate(r12.w + r31.w);
            r11.w = r12.w * r11.w;
            r12.w = dot(r32.xyz, r24.xyz);
            ...
            r33.w = samp0[]..swiz;
              ...
              r12.w = -r12.w * r14.w + 1;
              r12.w = r25.y * r12.w;
              r13.y = r24.w ? r12.w : r25.z;
              r25.xy = r22.ww ? r25.xy : r13.xy;
              r11.w = (int)r11.w + 1;
              r8.x = r17.w;
            }
            r25.y = saturate(r25.y);
            ...
            r38.y = samp0[]..swiz;
              ...
              r33.w = (uint)r7.z;
              r13.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r33.xyzw, r7.y).xyz;
              ...
              r13.yzw = r7.yyy ? float3(1,1,0) : r13.yzw;
              ...
              r22.x = r20.w;
              r22.yz = r21.xy;
              r21.xyw = r13.zwy * r7.xxx + r22.yzx;
              r20.w = r21.w;
            }
          }
        }
    ...
    if (r4.z != 0) {
      ...
      while (true) {
        ...
        while (true) {
          ...
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=80)(mixed,mixed,mixed,mixed) r23.xyzw, r9.x, l(0), t11.xyzw
          r23.x = samp0[]..swiz;
          r23.y = samp0[]..swiz;
          r23.z = samp0[]..swiz;
          r23.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=80)(mixed,mixed,mixed,mixed) r24.xy, r9.x, l(16), t11.xyxx
          r24.x = samp0[]..swiz;
          r24.y = samp0[]..swiz;
            ...
            r13.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r24.xyzw, r8.w, l(116), t15.zwxy
            r24.x = samp0[]..swiz;
            r24.y = samp0[]..swiz;
            r24.z = samp0[]..swiz;
            r24.w = samp0[]..swiz;
              r25.xyz = v7.xyz + -r23.yzw;
              r9.x = (int)r24.w & 0x0000ffff;
              if (6 == 0) r11.w = 0; else if (6+25 < 32) {               r11.w = (uint)r24.w << (32-(6 + 25)); r11.w = (uint)r11.w >> (32-6);              } else r11.w = (uint)r24.w >> 25;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r26.xyzw, r9.x, l(0), t16.xyzw
            r26.x = samp0[]..swiz;
            r26.y = samp0[]..swiz;
            r26.z = samp0[]..swiz;
            r26.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r29.xyzw, r9.x, l(16), t16.xyzw
            r29.x = samp0[]..swiz;
            r29.y = samp0[]..swiz;
            r29.z = samp0[]..swiz;
            r29.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r30.xyzw, r9.x, l(32), t16.xyzw
            r30.x = samp0[]..swiz;
            r30.y = samp0[]..swiz;
            r30.z = samp0[]..swiz;
            r30.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r31.xyzw, r9.x, l(48), t16.xyzw
            r31.x = samp0[]..swiz;
            r31.y = samp0[]..swiz;
            r31.z = samp0[]..swiz;
            r31.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r32.xyzw, r9.x, l(64), t16.xyzw
            r32.x = samp0[]..swiz;
            r32.y = samp0[]..swiz;
            r32.z = samp0[]..swiz;
            r32.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r33.xyzw, r9.x, l(80), t16.xyzw
            r33.x = samp0[]..swiz;
            r33.y = samp0[]..swiz;
            r33.z = samp0[]..swiz;
            r33.w = samp0[]..swiz;
              ...
              r35.w = samp0[]..swiz;
                ...
                r14.w = -r14.w * r16.w + 1;
                r14.w = r29.y * r14.w;
                r13.y = r23.w ? r14.w : r25.w;
                r29.xy = r21.ww ? r29.xy : r13.xy;
                r12.w = (int)r12.w + 1;
                r8.x = r17.w;
              }
              r8.x = saturate(r29.y + -r6.z);
              r9.x = r8.x * r13.w;
              r11.w = cmp(0 < r9.x);
              if (r11.w != 0) {
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r26.xyzw, r8.w, l(16), t15.xyzw
              r26.x = samp0[]..swiz;
              r26.y = samp0[]..swiz;
              r26.z = samp0[]..swiz;
              r26.w = samp0[]..swiz;
              ...
              r39.y = samp0[]..swiz;
                ...
                r34.w = (uint)r9.x;
                r13.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r34.xyzw, r8.w).xyz;
                r26.xyz = (int3)r13.yzw & int3(-2147483648,-2147483648,-2147483648);
                r26.xyz = cmp((int3)r26.xyz == int3(2139095040,2139095040,2139095040));
                r8.w = (int)r26.y | (int)r26.x;
                r8.w = (int)r26.z | (int)r8.w;
                r13.yzw = r8.www ? float3(1,1,0) : r13.yzw;
                ...
                r8.w = (int)r25.y | (int)r25.x;
                r8.w = (int)r25.z | (int)r8.w;
                ...
                r8.x = r3.z * r8.w + r8.x;
                r8.x = r9.x / r8.x;
                r22.xyz = r13.yzw * r8.xxx + r22.xyz;
              }
            }
          }
        }
