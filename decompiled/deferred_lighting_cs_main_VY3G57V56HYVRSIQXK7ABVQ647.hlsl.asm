...
loop 
  ieq r14.w, r14.z, l(2)
  breakc_nz r14.w
  movc r14.w, r14.z, r0.y, r14.y
  uge r15.y, r14.w, r13.w
  ult r15.z, r14.w, cb2[0].y
  and r15.y, r15.z, r15.y
  if_nz r15.y
    imul null, r14.w, r14.w, l(14)
    add r15.yzw, r11.xxyz, -cb10[r14.w + 0].xxyz
    and r17.w, l(0x0000ffff), cb10[r14.w + 7].z
    ubfe r18.w, l(6), l(25), cb10[r14.w + 7].z
    imul null, r19.z, r17.w, l(6)
    dp3 r19.w, cb11[r19.z + 0].xyzx, r15.yzwy
    add_sat r19.w, r19.w, cb11[r19.z + 0].w
    dp3 r20.w, cb11[r19.z + 1].xyzx, r15.yzwy
    add_sat r20.w, r20.w, cb11[r19.z + 1].w
    mul r19.w, r19.w, r20.w
    dp3 r20.w, cb11[r19.z + 2].xyzx, r15.yzwy
    add_sat r20.w, r20.w, cb11[r19.z + 2].w
    mul r19.w, r19.w, r20.w
    dp3 r20.w, cb11[r19.z + 3].xyzx, r15.yzwy
    add_sat r20.w, r20.w, cb11[r19.z + 3].w
    mul r19.w, r19.w, r20.w
    dp3 r20.w, cb11[r19.z + 4].xyzx, r15.yzwy
    add_sat r20.w, r20.w, cb11[r19.z + 4].w
    mul r19.w, r19.w, r20.w
    dp3 r20.w, cb11[r19.z + 5].xyzx, r15.yzwy
    add_sat r19.z, r20.w, cb11[r19.z + 5].w
    mul r17.x, r19.z, r19.w
    and r19.z, l(1), cb10[r14.w + 6].x
    ...
    loop 
      ...
      dp3 r24.z, cb11[r21.w + 0].xyzx, r15.yzwy
      add_sat r24.z, r24.z, cb11[r21.w + 0].w
      mul r24.z, r24.z, r24.x
      dp3 r24.w, cb11[r21.w + 1].xyzx, r15.yzwy
      add_sat r24.w, r24.w, cb11[r21.w + 1].w
      mul r24.z, r24.w, r24.z
      dp3 r24.w, cb11[r21.w + 2].xyzx, r15.yzwy
      add_sat r24.w, r24.w, cb11[r21.w + 2].w
      mul r24.z, r24.w, r24.z
      dp3 r24.w, cb11[r21.w + 3].xyzx, r15.yzwy
      add_sat r24.w, r24.w, cb11[r21.w + 3].w
      mul r24.z, r24.w, r24.z
      dp3 r24.w, cb11[r21.w + 4].xyzx, r15.yzwy
      add_sat r24.w, r24.w, cb11[r21.w + 4].w
      mul r24.z, r24.w, r24.z
      dp3 r24.w, cb11[r21.w + 5].xyzx, r15.yzwy
      add_sat r21.w, r24.w, cb11[r21.w + 5].w
      mul r24.x, r21.w, r24.z
      ushr r24.w, r17.x, l(2)
      ubfe r25.x, l(1), l(2), r17.x
      and r25.y, r24.w, l(2)
      max r25.z, r24.x, r24.y
      mad r21.w, -r24.z, r21.w, l(1.000000)
      mul r21.w, r21.w, r24.y
      movc r19.y, r25.y, r21.w, r25.z
      movc r24.xy, r25.xxxx, r24.xyxx, r19.xyxx
      iadd r20.w, r20.w, l(1)
      mov r17.x, r24.w
    endloop 
    mov_sat r24.y, r24.y
    mul r17.x, r24.y, cb10[r14.w + 6].y
    lt r17.w, l(0.000000), r17.x
    if_nz r17.w
      mad r23.w, r24.y, cb10[r14.w + 6].y, r23.w
      mul r17.x, r17.x, cb10[r14.w + 7].y
      mov r25.x, cb10[r14.w + 7].w
      mov r25.yz, cb10[r14.w + 8].xxyx
      dp3 r17.w, r16.xyzx, r25.xyzx
      dp3 r18.w, r15.yzwy, r25.xyzx
      add r18.w, r18.w, -cb10[r14.w + 8].z
      ...
      mov r25.x, cb10[r14.w + 8].w
      mov r25.yz, cb10[r14.w + 9].xxyx
      dp3 r18.w, r16.xyzx, r25.xyzx
      dp3 r19.y, r15.yzwy, r25.xyzx
      add r19.y, r19.y, -cb10[r14.w + 9].z
      ...
      mov r25.x, cb10[r14.w + 9].w
      mov r25.yz, cb10[r14.w + 10].xxyx
      dp3 r18.w, r16.xyzx, r25.xyzx
      dp3 r19.y, r15.yzwy, r25.xyzx
      add r19.y, r19.y, -cb10[r14.w + 10].z
      ge r19.z, r19.y, l(0.000000)
      max r19.y, r8.w, |r19.y|
      movc r19.y, r19.z, r19.y, -r19.y
      max r18.w, -r18.w, l(0.00000010)
      div r18.w, r19.y, r18.w
      min r17.w, r17.w, |r18.w|
      mov r25.x, cb10[r14.w + 10].w
      mov r25.yz, cb10[r14.w + 11].xxyx
      dp3 r18.w, r16.xyzx, r25.xyzx
      dp3 r19.y, r15.yzwy, r25.xyzx
      add r19.y, r19.y, -cb10[r14.w + 11].z
      ge r19.z, r19.y, l(0.000000)
      max r19.y, r8.w, |r19.y|
      movc r19.y, r19.z, r19.y, -r19.y
      max r18.w, -r18.w, l(0.00000010)
      div r18.w, r19.y, r18.w
      min r17.w, r17.w, |r18.w|
      mov r25.x, cb10[r14.w + 11].w
      mov r25.yz, cb10[r14.w + 12].xxyx
      dp3 r18.w, r16.xyzx, r25.xyzx
      dp3 r19.y, r15.yzwy, r25.xyzx
      add r19.y, r19.y, -cb10[r14.w + 12].z
      ge r19.z, r19.y, l(0.000000)
      max r19.y, r8.w, |r19.y|
      movc r19.y, r19.z, r19.y, -r19.y
      max r18.w, -r18.w, l(0.00000010)
      div r18.w, r19.y, r18.w
      min r17.w, r17.w, |r18.w|
      mov r25.x, cb10[r14.w + 12].w
      mov r25.yz, cb10[r14.w + 13].xxyx
      dp3 r18.w, r16.xyzx, r25.xyzx
      dp3 r19.y, r15.yzwy, r25.xyzx
      add r19.y, r19.y, -cb10[r14.w + 13].z
      ge r19.z, r19.y, l(0.000000)
      max r19.y, r8.w, |r19.y|
      movc r19.y, r19.z, r19.y, -r19.y
      max r18.w, -r18.w, l(0.00000010)
      div r18.w, r19.y, r18.w
      min r17.w, r17.w, |r18.w|
      add r25.x, r15.y, cb10[r14.w + 3].w
      add r25.yz, r15.zzwz, cb10[r14.w + 4].xxyx
      mad r19.yzw, r16.xxyz, r17.wwww, r25.xxyz
      ...
      mov r25.x, cb10[r14.w + 0].w
      mov r25.y, cb10[r14.w + 1].z
      mov r25.z, cb10[r14.w + 2].y
      ...
      ubfe r18.w, l(9), l(16), cb10[r14.w + 7].z
      utof r26.w, r18.w
      sample_l_indexable(texturecubearray)(float,float,float,float) r19.yzw, r26.xyzw, t8.wxyz, s2, r17.w
      dp3 r29.x, r15.yzwy, r25.xyzx
      dp3 r29.y, r15.yzwy, r27.xyzx
      dp3 r29.z, r15.yzwy, r28.xyzx
      mad_sat r15.yzw, r29.xxyz, cb10[r14.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
      mul r29.xy, r15.yzyy, cb10[r14.w + 4].zwzz
      mul r29.z, r15.w, cb10[r14.w + 5].x
      add r15.yzw, r29.xxyz, cb10[r14.w + 5].yyzw
      ...
      movc r21.z, r24.w, l(0), l(0.500000)
...
if_nz r14.z
  ...
  loop 
    ...
    if_nz r17.w
      ...
      ubfe r18.w, l(6), l(25), cb10[r14.w + 7].z
      imul null, r19.z, r17.w, l(6)
      dp3 r19.w, cb11[r19.z + 0].xyzx, r25.xyzx
      add_sat r19.w, r19.w, cb11[r19.z + 0].w
      dp3 r20.w, cb11[r19.z + 1].xyzx, r25.xyzx
      add_sat r20.w, r20.w, cb11[r19.z + 1].w
      mul r19.w, r19.w, r20.w
      dp3 r20.w, cb11[r19.z + 2].xyzx, r25.xyzx
      add_sat r20.w, r20.w, cb11[r19.z + 2].w
      mul r19.w, r19.w, r20.w
      dp3 r20.w, cb11[r19.z + 3].xyzx, r25.xyzx
      add_sat r20.w, r20.w, cb11[r19.z + 3].w
      mul r19.w, r19.w, r20.w
      dp3 r20.w, cb11[r19.z + 4].xyzx, r25.xyzx
      add_sat r20.w, r20.w, cb11[r19.z + 4].w
      mul r19.w, r19.w, r20.w
      dp3 r20.w, cb11[r19.z + 5].xyzx, r25.xyzx
      add_sat r19.z, r20.w, cb11[r19.z + 5].w
      mul r17.x, r19.z, r19.w
      and r19.z, l(1), cb10[r14.w + 6].x
      movc r19.zw, r19.zzzz, r17.xxxy, r17.zzzx
      ...
      loop 
        ...
        iadd r21.w, r17.w, r20.w
        imul null, r21.w, r21.w, l(6)
        dp3 r25.w, cb11[r21.w + 0].xyzx, r25.xyzx
        add_sat r25.w, r25.w, cb11[r21.w + 0].w
        mul r25.w, r25.w, r26.x
        dp3 r26.z, cb11[r21.w + 1].xyzx, r25.xyzx
        add_sat r26.z, r26.z, cb11[r21.w + 1].w
        mul r25.w, r25.w, r26.z
        dp3 r26.z, cb11[r21.w + 2].xyzx, r25.xyzx
        add_sat r26.z, r26.z, cb11[r21.w + 2].w
        mul r25.w, r25.w, r26.z
        dp3 r26.z, cb11[r21.w + 3].xyzx, r25.xyzx
        add_sat r26.z, r26.z, cb11[r21.w + 3].w
        mul r25.w, r25.w, r26.z
        dp3 r26.z, cb11[r21.w + 4].xyzx, r25.xyzx
        add_sat r26.z, r26.z, cb11[r21.w + 4].w
        mul r25.w, r25.w, r26.z
        dp3 r26.z, cb11[r21.w + 5].xyzx, r25.xyzx
        add_sat r21.w, r26.z, cb11[r21.w + 5].w
        mul r26.x, r21.w, r25.w
        ...
        movc r19.y, r27.x, r21.w, r27.y
        movc r26.xy, r26.wwww, r26.xyxx, r19.xyxx
        iadd r20.w, r20.w, l(1)
        mov r17.x, r26.z
      endloop 
      add_sat r17.x, -r23.w, r26.y
      mul r17.w, r17.x, cb10[r14.w + 6].y
      lt r18.w, l(0.000000), r17.w
      if_nz r18.w
        mad r24.w, r17.x, cb10[r14.w + 6].y, r24.w
        mul r17.x, r17.w, cb10[r14.w + 7].y
        ...
        mad r19.yzw, r16.xxyz, r17.wwww, r27.xxyz
        dp3 r18.w, r19.yzwy, r19.yzwy
        sqrt r18.w, r18.w
        div r17.w, r17.w, r18.w
        add r17.w, r17.w, r17.w
        ...
        dp3 r28.x, r19.yzwy, r27.xyzx
        mov r29.xy, cb10[r14.w + 1].xwxx
        mov r29.z, cb10[r14.w + 2].z
        dp3 r28.y, r19.yzwy, r29.xyzx
        mov r30.x, cb10[r14.w + 1].y
        mov r30.yz, cb10[r14.w + 2].xxwx
        dp3 r28.z, r19.yzwy, r30.xyzx
        ubfe r18.w, l(9), l(16), cb10[r14.w + 7].z
        utof r28.w, r18.w
        sample_l_indexable(texturecubearray)(float,float,float,float) r19.yzw, r28.xyzw, t8.wxyz, s2, r17.w
        ...
        mad r15.yzw, r25.xxyz, r26.xxzw, r15.yyzw
        mul r17.w, r9.w, r14.w
        mul r19.yzw, r17.xxxx, r19.yyzw
        dp3 r17.x, r19.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
        mad r14.w, r9.w, r14.w, r17.x
...
mul r14.yzw, r0.yyyy, r15.yyzw
mul r18.xyz, r2.yyyy, r14.zwyz
...
if_nz r5.z
  ...
  if_nz r5.z
    ...
    mad r19.xyz, r7.wwww, r14.yzwy, r17.xyzx
    ...
    mul r0.w, r0.w, r5.z
    mul r0.w, r0.w, r3.w
    mad r20.xyz, r0.wwww, r14.zwyz, r18.xyzx
    mov r19.w, r20.z
    mov r17.w, r18.z
    movc r17.xyzw, r3.zzzz, r19.xyzw, r17.xyzw
    mov r20.zw, r15.yyyz
    mov r18.zw, r2.yyyz
    movc r19.xyzw, r3.zzzz, r20.xyzw, r18.xyzw
