...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:26:04 2021
//
//
// Buffer Definitions: 
//
...
//   float4 emblemSCALEandOFFSET;       // Offset:  208 Size:    16
//
// }
//
...
// thicknessMap                      texture  float4          2d             t7      1 
// codeEmblemTexture3                texture  float4          2d             t9      1 
...
sample_indexable(texture2d)(float,float,float,float) r2.x, v1.yzyy, t7.xyzw, s1
mad r5.yz, v1.yyzy, cb0[13].xxyx, cb0[13].zzwz
add r2.z, -r5.y, l(1.000000)
movc r5.x, v6.x, r5.y, r2.z
add r2.zw, r5.xxxz, l(0.000000, 0.000000, -0.500000, -0.500000)
max r2.z, |r2.w|, |r2.z|
lt r2.z, l(0.500000), r2.z
movc r2.z, r2.z, l(0), l(1.000000)
sample_indexable(texture2d)(float,float,float,float) r5.xyzw, r5.xzxx, t9.xyzw, s1
mul r5.xyz, r2.zzzz, r5.xyzx
mad r2.z, -r5.w, r2.z, l(1.000000)
mad r0.xyz, r0.xyzx, r2.zzzz, r5.xyzx
...
max r2.y, r2.y, r2.w
eq r2.w, r2.y, r3.x
mul r6.yzw, r1.yyzw, l(0.000000, 1.000000, -1.000000, -1.000000)
add r3.x, r2.y, l(2.000000)
mov r6.x, l(1)
mov r1.x, l(0)
movc r1.xyzw, r2.wwww, r6.xyzw, r1.xyzw
...
ftou r1.xy, v0.xyxx
mad r3.y, r5.x, r2.x, -r2.z
mad r0.w, r3.y, l(0.500000), r2.z
mad r3.z, r5.y, r2.x, -r0.w
