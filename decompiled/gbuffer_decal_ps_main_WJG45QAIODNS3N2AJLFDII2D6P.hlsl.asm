...
sample_indexable(texture2d)(float,float,float,float) r3.z, r0.yzyy, t14.yzxw, s4
sample_indexable(texture2d)(float,float,float,float) r0.w, r0.yzyy, t12.yzwx, s2
...
sample_indexable(texture2d)(float,float,float,float) r6.xyz, r0.yzyy, t15.xyzw, s3
...
mad r5.xy, r0.yzyy, cb0[12].zzzz, r4.xyxx
dp3 r0.y, r5.xyzx, r5.xyzx
rsq r0.y, r0.y
mul r4.xyz, r0.yyyy, r5.xyzx
mad r0.y, r2.w, cb0[12].z, r1.w
