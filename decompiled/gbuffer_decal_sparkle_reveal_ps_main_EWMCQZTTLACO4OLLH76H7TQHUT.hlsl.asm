...
dcl_output o2.xyzw
dcl_temps 5
mul r0.xyzw, v2.xyxy, cb0[13].yzyz
mad r1.xyzw, cb0[14].xyzw, cb1[69].wwww, r0.xyzw
movc r0.xy, cb0[13].xxxx, r0.zwzz, v2.xyxx
...
sample_indexable(texture2d)(float,float,float,float) r3.x, v2.xyxx, t9.xyzw, s2
...
mad_sat r2.x, v1.w, l(0.998000), l(0.001000)
log r2.y, r2.x
