...
mul r1.x, r1.y, r1.x
sample_indexable(texture2d)(float,float,float,float) r1.yzw, v1.yzyy, t14.wxyz, s3
sample_indexable(texture2d)(float,float,float,float) r2.xyz, v1.yzyy, t12.xyzw, s3
