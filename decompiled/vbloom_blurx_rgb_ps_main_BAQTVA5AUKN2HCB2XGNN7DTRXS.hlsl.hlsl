  ...
  out float3 o0 : SV_TARGET0)
{
  ...
  r0.xyz = r2.xyz * float3(0.4921875,0.4921875,0.4921875) + r0.xyz;
  r1.yw = v0.yy;
  r2.xyz = codeTexture0.Sample(biLinearClamp_s, r1.xy).xyz;
  r1.xyz = codeTexture0.Sample(biLinearClamp_s, r1.zw).xyz;
  r0.xyz = r2.xyz * float3(0.234375,0.234375,0.234375) + r0.xyz;
  o0.xyz = r1.xyz * float3(0.01953125,0.01953125,0.01953125) + r0.xyz;
  return;
}