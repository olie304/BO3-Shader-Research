...
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r0.xyzw, v4.x, l(0), t4.xyzw
...
r4.w = shaderConstantSetBuffer[]..swiz;
  ...
  r3.xyzw = viewProjectionMatrix._m10_m11_m12_m13 * r0.wwww;
  r1.w = r2.x;
  r4.w = r2.z;
  r0.w = dot(r5.xyzw, r4.xyzw);
  r1.x = dot(r5.xyzw, r1.xyzw);
  r1.xyzw = r1.xxxx * viewProjectionMatrix._m00_m01_m02_m03 + r3.xyzw;
...
r0.y = shaderConstantSetBuffer[]..swiz;
  o1.x = v1.w * 9.99999975e-05 + r0.y;
  p1.xy = v2.xy;
  r1.xyz = v3.xyz * float3(2.00195694,2.00195694,2.00195694) + float3(-1.00195694,-1.00195694,-1.00195694);
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r0.y, v4.x, l(12), t4.xxxx
r0.y = shaderConstantSetBuffer[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r2.xyz, r0.y, l(0), t5.xyzx
r2.x = shaderConstantSetBuffer[]..swiz;
r2.y = shaderConstantSetBuffer[]..swiz;
r2.z = shaderConstantSetBuffer[]..swiz;
  o2.x = dot(r1.xyz, r2.xyz);
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r2.xyz, r0.y, l(16), t5.xyzx
r2.x = shaderConstantSetBuffer[]..swiz;
r2.y = shaderConstantSetBuffer[]..swiz;
r2.z = shaderConstantSetBuffer[]..swiz;
  o2.y = dot(r1.xyz, r2.xyz);
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r2.xyz, r0.y, l(32), t5.xyzx
r2.x = shaderConstantSetBuffer[]..swiz;
r2.y = shaderConstantSetBuffer[]..swiz;
r2.z = shaderConstantSetBuffer[]..swiz;
