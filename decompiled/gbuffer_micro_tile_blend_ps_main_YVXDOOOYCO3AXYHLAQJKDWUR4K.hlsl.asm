...
sample_indexable(texture2d)(float,float,float,float) r4.xyz, r4.xyxx, t34.xyzw, s3
...
rsq r4.w, r4.w
mul r9.xyz, r4.wwww, v4.xyzx
mul r9.xyz, r2.xxxx, r9.xyzx
dp3 r4.w, v5.xyzx, v5.xyzx
rsq r4.w, r4.w
mul r10.xyz, r4.wwww, v5.xyzx
...
dp3_sat r4.w, r11.xyzx, cb2[39].yzwy
log r4.w, r4.w
mul r4.w, r4.w, cb0[16].y
exp r4.w, r4.w
add r4.w, r4.w, -cb0[16].x
add r5.w, -cb0[16].x, l(1.000000)
max r5.w, r5.w, l(0.000100)
div_sat r4.w, r4.w, r5.w
mul r2.yz, r2.yyzy, cb0[15].zzwz
mul r11.xy, v1.yzyy, cb0[15].zwzz
...
mad r6.w, r3.w, cb0[11].z, r0.z
mad r1.xy, r4.xyxx, cb0[11].wwww, r0.xyxx
dp3 r0.x, r1.xyzx, r1.xyzx
rsq r0.x, r0.x
mul r5.xyz, r0.xxxx, r1.xyzx
mad r5.w, r4.z, cb0[11].w, r0.z
add r4.xyzw, -r6.xyzw, r5.xyzw
...
mul r0.yzw, r4.yyyy, r10.xxyz
mad r0.yzw, r9.xxyz, r4.xxxx, r0.yyzw
mad r0.yzw, r8.xxyz, r4.zzzz, r0.yyzw
