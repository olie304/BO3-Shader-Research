...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:31:12 2021
//
//
// Buffer Definitions: 
//
...
mad r0.y, r0.z, l(0.900000), r3.x
mul r0.y, r0.y, l(0.700000)
sincos r0.y, null, r0.y
mad r0.z, r1.w, l(0.700000), r3.x
...
mul r1.z, r1.w, r1.z
mul r6.z, r1.y, r1.z
mul r1.zw, cb2[38].zzzw, cb2[38].yyyy
mul r0.yz, r0.yyzy, r1.zzwz
mul r6.xy, r1.yyyy, r0.yzyy
