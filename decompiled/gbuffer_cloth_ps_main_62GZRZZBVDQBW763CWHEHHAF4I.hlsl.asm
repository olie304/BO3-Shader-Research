...
movc r6.xyz, v7.xxxx, v2.xyzx, -v2.xyzx
...
mul r1.y, r0.w, cb0[11].w
lt r1.y, l(0.000000), r1.y
mul r1.z, r1.x, l(17.000000)
exp r1.z, r1.z
...
movc o0.xyz, r1.yyyy, r7.xyzx, r0.xyzx
movc r0.xyz, r1.yyyy, r6.xyzx, r5.xyzx
