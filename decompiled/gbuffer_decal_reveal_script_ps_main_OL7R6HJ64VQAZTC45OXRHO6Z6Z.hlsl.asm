...
dcl_output o2.xyzw
dcl_temps 10
sample_indexable(texture2d)(float,float,float,float) r0.xyz, v2.xyxx, t7.xyzw, s1
...
if_nz r2.y
  ftoi r3.w, cb1[64].w
  lod r4.w, v2.xyxx, t7.y, s1
  lod r5.w, v2.xyxx, t7.x, s1
  lt r4.w, r4.w, r5.w
...
sample_indexable(texture2d)(float,float,float,float) r8.xyz, v2.xyxx, t14.xyzw, s1
mul r8.xyz, r8.xyzx, v1.xyzx
sample_indexable(texture2d)(float,float,float,float) r3.w, v2.xyxx, t16.yzwx, s2
mad r1.y, r3.w, r1.y, cb0[10].y
mul_sat r1.y, r1.y, l(0.05882353)
sample_indexable(texture2d)(float,float,float,float) r9.xyz, v2.xyxx, t15.xyzw, s3
...
if_nz r2.y
  ftoi r2.y, cb1[64].w
  lod r3.w, v2.xyxx, t7.y, s1
  lod r4.x, v2.xyxx, t7.x, s1
  lt r3.w, r3.w, r4.x
...
sample_indexable(texture2d)(float,float,float,float) r2.y, v2.xyxx, t12.yxzw, s5
