...
//   float3 skyBoxCenter;               // Offset:  160 Size:    12 [unused]
//   float skyScale;                    // Offset:  172 Size:     4
//   float skyFogFraction;              // Offset:  176 Size:     4 [unused]
//
// }
//
...
mul r1.xyz, r0.xyzx, cb0[10].wwww
...
if_nz r0.w
  ...
  mul r0.w, r0.w, r2.w
  mad r0.xyz, -r0.xyzx, cb0[10].wwww, r2.xyzx
