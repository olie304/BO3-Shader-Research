// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:40:45 2021
...
cbuffer _Globals : register(b0)
{
  ...
  float2 cloudHeights : packoffset(c10);
  float3 skyBoxCenter : packoffset(c11);
  float skyScale : packoffset(c11.w);
  float skyFogFraction : packoffset(c12);
}
...
Texture2D<float4> cloudLayer0 : register(t6);
Texture2D<float4> cloudMask0 : register(t7);
Texture2D<float4> cloudLayer1 : register(t9);
Texture2D<float4> cloudMask1 : register(t10);
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.x = 1 + -abs(r0.z);
  r0.x = sqrt(r0.x);
  r0.y = abs(r0.z) * -0.0187292993 + 0.0742610022;
  r0.y = r0.y * abs(r0.z) + -0.212114394;
  r0.y = r0.y * abs(r0.z) + 1.57072878;
  r0.z = r0.y * r0.x;
  r0.z = r0.z * -2 + 3.14159274;
  r0.z = r1.y ? r0.z : 0;
  r2.yz = r0.yy * r0.xx + r0.zz;
  r0.xyz = r2.xyz * float3(-0.159154937,0.318309873,-0.318309873) + float3(0.5,0,1);
  r1.xyz = colorMap.Sample(colorSampler_s, r0.xy).xyz;
  r0.xyz = colorMap.Sample(colorSampler_s, r0.xz).xyz;
  r0.xyz = r0.xyz + -r1.xyz;
  r0.xyz = skyRotationTransition.www * r0.xyz + r1.xyz;
  r1.xyz = v4.yxz + v1.yxz;
  r0.w = dot(r1.xyz, r1.xyz);
  r0.w = rsqrt(r0.w);
  r1.xyz = r1.xyz * r0.www;
  r0.w = min(abs(r1.x), abs(r1.y));
  r1.w = max(abs(r1.x), abs(r1.y));
  r1.w = 1 / r1.w;
  r0.w = r1.w * r0.w;
  r1.w = r0.w * r0.w;
  ...
  r1.z = r1.w * abs(r1.z) + 1.57072878;
  r1.w = r1.z * r0.w;
  r1.w = r1.w * -2 + 3.14159274;
  r1.w = r2.y ? r1.w : 0;
  r1.y = r1.z * r0.w + r1.w;
  r1.xy = r1.xy * float2(-0.159154937,0.318309873) + float2(0.5,0);
  r2.xyz = cloudLayer0.Sample(colorSampler_s, r1.xy).xyz;
  r0.w = cloudMask0.Sample(colorSampler_s, r1.xy).x;
  ...
  r2.x = r1.w * r0.w;
  r2.x = r2.x * -2 + 3.14159274;
  r2.x = r2.y ? r2.x : 0;
  r3.y = r1.w * r0.w + r2.x;
  r2.xy = r3.xy * float2(-0.159154937,0.318309873) + float2(0.5,0);
  r3.xyz = cloudLayer1.Sample(colorSampler_s, r2.xy).xyz;
  r0.w = cloudMask1.Sample(colorSampler_s, r2.xy).x;
  r2.xyz = r3.xyz + -r0.xyz;
  r0.xyz = r0.www * r2.xyz + r0.xyz;
  r2.x = dot(r0.xyz, skyMxR.xyz);
  r2.y = dot(r0.xyz, skyMxG.xyz);
  r2.z = dot(r0.xyz, skyMxB.xyz);
  r3.x = dot(r0.xyz, sunMxR.xyz);
  r3.y = dot(r0.xyz, sunMxG.xyz);
  r3.z = dot(r0.xyz, sunMxB.xyz);
  r0.x = skyMxR.w;
  r0.y = skyMxG.w;
  r0.z = skyMxB.w;
