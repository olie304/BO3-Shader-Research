...
add r0.xyz, -cb0[11].xyzx, cb1[24].xyzx
div r3.xyz, r0.xyzx, |cb1[57].zzzz|
dp2 o3.x, r3.xyxx, r2.xyxx
dp2 o3.y, r3.xyxx, cb1[57].xyxx
add r2.zw, -cb0[10].xxxy, cb1[57].zzzz
div r3.xyw, r0.xyxz, |r2.zzzz|
dp2 o4.x, r3.xyxx, r2.xyxx
dp2 o4.y, r3.xyxx, cb1[57].xyxx
div r0.xyz, r0.xyzx, |r2.wwww|
dp2 o5.x, r0.xyxx, r2.xyxx
dp2 o5.y, r0.xyxx, cb1[57].xyxx
mov o0.z, l(0)
mov o2.xyz, r1.xyzx
mov o3.z, r3.z
mov o4.z, r3.w
