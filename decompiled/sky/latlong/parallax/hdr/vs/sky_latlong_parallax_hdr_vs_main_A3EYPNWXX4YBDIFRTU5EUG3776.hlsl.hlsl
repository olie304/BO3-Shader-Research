...
r0.x = modelInstanceBuffer[]..swiz;
  ...
  o1.z = r0.x ? -r0.z : r0.z;
  r0.xyz = eyeOffset.xyz + -skyBoxCenter.xyz;
  r3.xyz = r0.xyz / abs(skyRotationTransition.zzz);
  o3.x = dot(r3.xy, r2.xy);
  o3.y = dot(r3.xy, skyRotationTransition.xy);
  r2.zw = skyRotationTransition.zz + -cloudHeights.xy;
  r3.xyw = r0.xyz / abs(r2.zzz);
  o4.x = dot(r3.xy, r2.xy);
  o4.y = dot(r3.xy, skyRotationTransition.xy);
  r0.xyz = r0.xyz / abs(r2.www);
  o5.x = dot(r0.xy, r2.xy);
  o5.y = dot(r0.xy, skyRotationTransition.xy);
  o0.z = 0;
  o2.xyz = r1.xyz;
  o3.z = r3.z;
  o4.z = r3.w;
