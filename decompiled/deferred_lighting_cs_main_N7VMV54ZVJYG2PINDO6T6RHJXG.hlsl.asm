...
mov r15.w, l(0)
sample_l_indexable(texturecubearray)(float,float,float,float) r17.xyz, r15.xyzw, t8.xyzw, s2, r4.w
...
loop 
  ...
  loop 
    ...
    if_nz r16.w
      ...
      rsq r18.w, r18.w
      mul r20.yzw, r18.wwww, r39.xxyz
      mul r22.w, r0.z, cb9[r13.w + 1].z
      mul r22.w, r22.w, l(0.250000)
      dp3 r20.y, r11.xyzx, r20.yzwy
      mov_sat r20.z, r20.y
      movc r20.w, r0.w, |r20.y|, r20.z
      lt r27.w, l(0.000000), r20.w
      if_nz r27.w
        mov r40.xyz, cb9[r13.w + 7].yzwy
        mov r40.w, cb9[r13.w + 8].x
        dp4 r27.w, r40.xyzw, r10.xyzw
        ...
        if_nz r29.w
          ...
          dp3 r31.w, r42.xyzx, r42.xyzx
          div r30.w, r30.w, r31.w
          min r30.w, r30.w, l(1.000000)
          mad_sat r42.xy, r27.wwww, cb9[r13.w + 2].xzxx, cb9[r13.w + 2].ywyy
          ...
          if_nz r27.w
            ...
            exp r42.xy, r42.xyxx
            mul r31.w, r42.x, cb9[r13.w + 12].x
            mad r32.w, cb9[r13.w + 12].y, r42.y, l(-1.000000)
            mad r31.w, cb9[r13.w + 12].y, r42.y, -r31.w
        ...
        if_nz r22.x
          ...
          if_nz r16.w
            ...
            lt r22.y, r20.y, l(0.000000)
            and r22.y, r0.w, r22.y
            movc r16.w, r22.y, -r16.w, r16.w
            ...
            if_nz r27.w
              ...
              if_nz r9.w
                ...
                loop 
                  ige r31.w, r30.w, l(8)
                  breakc_nz r31.w
                  dp2 r42.x, icb[r30.w + 0].yxyy, r19.xyxx
                  dp2 r42.y, icb[r30.w + 0].yxyy, r19.yzyy
                ...
                utof r40.z, r22.y
                sample_c_lz_indexable(texture2darray)(float,float,float,float) r27.w, r40.xyzx, t9.xxxx, s13, r16.w
              endif 
              mul r16.w, r27.w, r27.w
              mul r16.w, r27.w, r16.w
            else 
          ...
          mul r16.w, r16.w, r29.w
          lt r22.y, l(0.000000), r16.w
          if_nz r22.y
              ...
              if_z r23.y
                ...
                if_nz r9.w
                  ...
                  loop 
                    ige r30.w, r29.w, l(8)
                    breakc_nz r30.w
                    dp2 r42.x, icb[r29.w + 0].yxyy, r19.xwxx
                    dp2 r42.y, icb[r29.w + 0].xyxx, r4.xyxx
            ...
            mad r22.y, -r20.w, r2.x, l(1.000000)
            mul r22.y, r22.y, r22.y
            mad r22.y, -r22.y, l(0.620000), l(0.620000)
            add r22.y, -r20.w, r22.y
            mad r20.w, r2.z, r22.y, r20.w
            mul r20.w, r16.w, r20.w
            lt r20.y, l(0.000000), r20.y
            mad r24.xyz, r20.wwww, r41.xyzx, r35.xyzx
            mad r39.xyz, r39.xyzx, r18.wwww, r12.xyzx
            dp3 r18.w, r39.xyzx, r39.xyzx
            rsq r18.w, r18.w
            mul r39.xyz, r18.wwww, r39.xyzx
            dp3 r18.w, r39.xyzx, r12.xyzx
            dp3 r22.y, r11.xyzx, r39.xyzx
            mad r23.x, |r22.y|, r0.z, -|r22.y|
            mad r22.y, |r22.y|, r23.x, l(1.000000)
            mad r23.x, r20.z, r1.w, r2.y
            mul r22.y, r22.y, r22.y
            ...
            mul r22.y, r18.w, r18.w
            mul r22.y, r22.y, r22.y
            mul r18.w, r18.w, r22.y
            mul r18.w, r18.w, r20.z
            mad r40.xyz, r18.wwww, r41.xyzx, r37.xyzx
            mad r41.xyz, r20.wwww, r41.xyzx, r36.xyzx
            movc r41.xyz, r0.wwww, r41.xyzx, r36.xyzx
            movc r35.xyz, r20.yyyy, r24.xyzx, r35.xyzx
            movc r36.xyz, r20.yyyy, r36.xyzx, r41.xyzx
            movc r37.xyz, r20.yyyy, r40.xyzx, r37.xyzx
            movc r38.xyz, r20.yyyy, r39.xyzx, r38.xyzx
      ...
      if_nz r15.w
        ...
        mul r17.w, r0.z, cb9[r13.w + 1].z
        mul r17.w, r17.w, l(0.250000)
        lt r18.w, l(0.000000), cb9[r13.w + 6].y
        mov r24.xy, cb9[r13.w + 5].zwzz
        mov r24.z, cb9[r13.w + 6].x
        mad r20.yzw, -r24.xxyz, l(0.000000, 0.500000, 0.500000, 0.500000), cb9[r13.w + 0].xxyz
        add r21.yzw, -r10.xxyz, r20.yyzw
        dp3 r22.x, r24.xyzx, r15.xyzx
        dp3 r22.y, r24.xyzx, r21.yzwy
        dp3 r21.y, r15.xyzx, r21.yzwy
        mad r21.z, -r22.x, r22.x, cb9[r13.w + 6].y
        mad r21.y, r22.x, r21.y, -r22.y
        div_sat r21.w, -r22.y, cb9[r13.w + 6].y
        div_sat r21.y, r21.y, r21.z
        div r21.z, r21.z, cb9[r13.w + 6].y
        mul r21.z, r21.z, l(10.000000)
        min r21.z, r21.z, l(1.000000)
        add r21.y, -r21.w, r21.y
        mad r21.y, r21.z, r21.y, r21.w
        mad r22.xyw, r21.yyyy, r24.xyxz, r20.yzyw
        mad r20.yzw, r21.wwww, r24.xxyz, r20.yyzw
        movc r20.yzw, r18.wwww, r20.yyzw, cb9[r13.w + 0].xxyz
        movc r21.yzw, r18.wwww, r22.xxyw, cb9[r13.w + 0].xxyz
        add r21.yzw, -r10.xxyz, r21.yyzw
        add r20.yzw, -r10.xxyz, r20.yyzw
        dp3 r18.w, r21.yzwy, r21.yzwy
        rsq r18.w, r18.w
        mul r22.xyw, r18.wwww, r21.yzyw
        dp3 r23.x, r20.yzwy, r20.yzwy
        rsq r23.y, r23.x
        mul r20.yzw, r20.yyzw, r23.yyyy
        dp3 r20.y, r11.xyzx, r20.yzwy
        mov_sat r20.z, r20.y
        movc r20.z, r0.w, |r20.y|, r20.z
        lt r20.w, l(0.000000), r20.z
        if_nz r20.w
          sqrt r20.w, r23.x
          mul r23.y, cb9[r13.w + 3].x, cb9[r13.w + 3].x
          div r23.x, r23.y, r23.x
          min r23.x, r23.x, l(1.000000)
          mad_sat r24.xy, r20.wwww, cb9[r13.w + 2].xzxx, cb9[r13.w + 2].ywyy
          mul r25.yz, r24.xxyx, r24.xxyx
          mad r24.xy, r24.xyxx, l(-2.000000, -2.000000, 0.000000, 0.000000), l(3.000000, 3.000000, 0.000000, 0.000000)
          mul r24.xy, r24.xyxx, r25.yzyy
          mul r20.w, r23.x, r24.x
          mul r20.w, r24.y, r20.w
          lt r23.x, l(0.000000), r20.w
          if_nz r23.x
            and r23.x, r16.w, l(255)
            ...
            if_nz r23.y
              ...
              or r24.x, r24.x, l(4)
              store_structured u2.x, cb2[52].x, r23.x, r24.x
              store_structured u2.x, cb2[52].x, r23.y, r20.w
            endif 
            iadd r23.x, r11.w, l(257)
            ine r15.w, r15.w, l(1)
            if_nz r15.w
              ...
              add r24.xyz, r24.xyzx, -cb9[r13.w + 4].yzwy
              max r15.w, |r24.z|, |r24.y|
              max r15.w, r15.w, |r24.x|
              div r15.w, cb9[r13.w + 5].x, r15.w
              add r15.w, r15.w, cb9[r13.w + 5].y
              dp3 r23.y, r24.xyzx, r24.xyzx
              rsq r23.y, r23.y
              max r15.w, r15.w, l(0.00006104)
              and r25.y, l(0x0000ffff), cb9[r13.w + 1].w
              utof r39.w, r25.y
              ...
              loop 
                ...
                mad r39.xyz, r24.xyzx, r23.yyyy, r40.xzwx
                sample_c_lz_indexable(texturecubearray)(float,float,float,float) r29.w, r39.xyzw, t10.xxxx, s13, r15.w
            ...
            if_nz r20.w
              ...
              if_nz r23.y
                ...
                mad r23.y, |r20.y|, l(-0.200000), l(0.400000)
                lt r24.x, r20.y, l(0.000000)
                and r24.x, r0.w, r24.x
                movc r23.y, r24.x, -r23.y, r23.y
                ...
                dp4 r24.x, r39.xyzw, r26.xyzw
                lt r24.y, r24.x, r23.y
                if_z r24.y
                  ...
                  div r26.xy, r39.xyxx, r24.xxxx
                  mad r26.xy, r26.xyxx, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
                  add r39.x, r26.x, cb9[r20.w + 9].w
                  add r39.y, r26.y, cb9[r20.w + 10].x
                  mul r26.xy, r39.xyxx, cb9[r20.w + 9].yzyy
                  div r39.xy, cb9[r20.w + 3].yyyy, cb9[r20.w + 8].ywyy
                  ...
                  if_z r24.z
                    ...
                    mad r39.x, r26.x, cb9[r20.w + 8].y, cb9[r20.w + 8].z
                    mad r39.y, r26.y, cb9[r20.w + 8].w, cb9[r20.w + 9].x
                    mul r25.z, r24.x, cb9[r20.w + 10].z
                    mad r23.y, cb9[r20.w + 10].y, r24.x, r23.y
                    div r23.y, r23.y, r25.z
                  endif 
                else 
                  mov r24.z, l(-1)
                endif 
                ...
                if_z r24.x
                  ...
                  if_nz r9.w
                    ...
                    loop 
                      ige r25.z, r24.z, l(8)
                      breakc_nz r25.z
                      dp2 r40.x, icb[r24.z + 0].xyxx, r29.xyxx
                      dp2 r40.y, icb[r24.z + 0].yxyy, r29.xzxx
                      mad r26.xy, r40.xyxx, cb9[r20.w + 3].yyyy, r39.xyxx
                      sample_c_lz_indexable(texture2darray)(float,float,float,float) r25.z, r26.xyzx, t9.xxxx, s13, r23.y
                      mad r24.y, r25.z, l(0.125000), r24.y
                      iadd r24.z, r24.z, l(1)
                    endloop 
                  else 
                    utof r39.z, r24.x
                    sample_c_lz_indexable(texture2darray)(float,float,float,float) r24.y, r39.xyzx, t9.xxxx, s13, r23.y
                  endif 
                ...
                if_nz r23.y
                  ...
                  mov r39.xyz, cb9[r20.w + 7].yzwy
                  mov r39.w, cb9[r20.w + 8].x
                  dp4 r24.x, r39.xyzw, r28.xyzw
                  lt r24.z, r24.x, r23.y
                  if_z r24.z
                    mov r39.xyz, cb9[r20.w + 4].yzwy
                    mov r39.w, cb9[r20.w + 5].x
                  ...
                  if_z r24.x
                    ...
                    if_nz r9.w
                      ...
                      loop 
                        ige r29.w, r25.z, l(8)
                        breakc_nz r29.w
                        dp2 r39.x, icb[r25.z + 0].xyxx, r30.xyxx
                        dp2 r39.y, icb[r25.z + 0].yxyy, r30.xzxx
                        mad r26.xy, r39.xyxx, cb9[r20.w + 3].yyyy, r28.xyxx
                      ...
                      utof r28.z, r24.x
                      sample_c_lz_indexable(texture2darray)(float,float,float,float) r24.z, r28.xyzx, t9.xxxx, s13, r23.y
                    endif 
              ...
              mad r28.xyz, r20.zzzz, r26.xyzx, r35.xyzx
              dp3_sat r20.y, r11.xyzx, r22.xywx
              ...
              mad r21.y, |r20.w|, r0.z, -|r20.w|
              mad r20.w, |r20.w|, r21.y, l(1.000000)
              mad r21.y, r20.y, r1.w, r2.y
              mul r20.w, r20.w, r20.w
              mul r20.w, r21.y, r20.w
              rcp r20.w, r20.w
              mul r17.w, r17.w, r20.y
              mul r17.w, r17.w, r20.w
              mul r17.w, r15.w, r17.w
              mad r21.yzw, r17.wwww, r26.xxyz, r38.xxyz
              add_sat r18.w, -r18.w, l(1.000000)
              mul r20.y, r18.w, r18.w
              mul r20.y, r20.y, r20.y
              mul r18.w, r18.w, r20.y
              mul r17.w, r17.w, r18.w
              mad r22.xyw, r17.wwww, r26.xyxz, r37.xyxz
              mad r20.yzw, r20.zzzz, r26.xxyz, r36.xxyz
              movc r20.yzw, r0.wwww, r20.yyzw, r36.xxyz
              movc r35.xyz, r13.wwww, r28.xyzx, r35.xyzx
              movc r36.xyz, r13.wwww, r36.xyzx, r20.yzwy
              movc r37.xyz, r13.wwww, r22.xywx, r37.xyzx
              movc r38.xyz, r13.wwww, r21.yzwy, r38.xyzx
              and r13.w, r23.x, l(255)
...
ret 
// Approximately 1616 instruction slots used
