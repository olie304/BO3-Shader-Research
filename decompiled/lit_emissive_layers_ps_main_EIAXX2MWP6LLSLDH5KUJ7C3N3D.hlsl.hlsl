...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r4.z = min(1, r4.z);
  r5.x = v8.x ? 1 : -1;
  r5.y = dot(v4.xyz, v4.xyz);
  r5.y = rsqrt(r5.y);
  r5.yzw = v4.xyz * r5.yyy;
          ...
          r25.w = samp0[]..swiz;
            ...
            r22.w = samp0[]..swiz;
              ...
              if (r21.y != 0) {
                ...
                r23.xyz = r24.xyz * r5.xxx;
                r21.xyz = r21.xyz * r5.xxx;
                r22.xyz = r22.xyz * r5.xxx;
                r18.w = -17 * r12.w;
                r18.w = exp2(r18.w);
                r17.w = r18.w + r17.w;
                r17.w = log2(r17.w);
  ...
  r0.y = r0.y * r1.z + r3.w;
  r4.xyz = r4.xyz * r1.zzz + r16.xyz;
  r1.w = dot(r4.xyz, r4.xyz);
  r1.w = rsqrt(r1.w);
  r9.xyz = r4.xyz * r1.www;
  r4.y = r0.z * r1.z + r4.w;
  r3.xyz = r3.xyz * r1.zzz + r17.xyz;
  ...
  if (r0.z != 0) {
    ...
    r8.zw = saturate(r4.zw);
    r10.xy = clampU ? r8.zw : r4.zw;
  }
  ...
  if (r1.w != 0) {
    ...
    r15.x = dot(r14.xyz, r6.xyz);
    r15.y = dot(r14.xyz, r7.xyz);
    ...
    r4.zw = r4.zw * r1.ww;
    r4.zw = scaleUVs2.xy * r4.zw;
    r4.zw = r8.zw * scaleUVs2.xy + r4.zw;
    r4.zw = offsetUVs2.xy * scaleUVs2.xy + r4.zw;
    ...
    r14.y = r14.x;
    r14.z = r5.x;
    r15.x = dot(r14.yz, r4.zw);
    r14.x = -r5.x;
    r15.y = dot(r14.xy, r4.zw);
    r4.zw = gameTime.ww * scrollUVs2.xy;
    r4.zw = r4.zw * scaleUVs2.xy + r15.xy;
    ...
    r4.zw = float2(0.5,0.5) + r4.zw;
    r8.zw = saturate(r4.zw);
    r13.x = clampU2 ? r8.z : r4.z;
    r13.y = clampV2 ? r8.w : r4.w;
  }
  r13.xyzw = emissiveMap2.Sample(colorSampler_s, r13.xy).xyzw;
  r13.xyz = emissiveTint2.xyz * r13.xyz;
  r1.w = hdrScale * r13.w;
  r13.xyz = r13.xyz * r1.www;
  r1.w = clampV2 + r0.z;
  r1.w = frac(r1.w);
  r14.y = gameTime.w * clampV2 + r1.w;
  r14.x = clampV2;
  r1.w = flickerLookupMap.SampleLevel(lookupSampler_s, r14.xy, 0).x;
  r1.w = log2(abs(r1.w));
  r1.w = flickerPower2 * r1.w;
  r1.w = exp2(r1.w);
  r2.w = flickerRange2.y + -flickerRange2.x;
  r1.w = r1.w * r2.w + flickerRange2.x;
  r13.xyz = r13.xyz * r1.www;
  r1.w = 1 + -r13.w;
  r10.xyz = r10.xyz * r1.www + r13.xyz;
  r1.w = cmp(0.5 < uvMotionToggle3);
  if (r1.w != 0) {
    r1.w = columnCount3 * rowCount3;
    r2.w = imageTime3 * r1.w;
    r3.w = gameTime.w * r2.w;
    r3.w = cmp(r3.w >= -r3.w);
    r3.w = r3.w ? r2.w : -r2.w;
    r4.z = 1 / r3.w;
    ...
    r1.w = trunc(r1.w);
    r1.w = r1.x + r1.w;
    r13.x = r1.w / columnCount3;
    r1.w = trunc(r2.w);
    r1.w = r1.y + r1.w;
    r13.y = r1.w / rowCount3;
  } else {
    r1.w = dot(-v7.xyz, -v7.xyz);
    r1.w = rsqrt(r1.w);
    r14.xyz = -v7.xyz * r1.www;
    ...
    r4.zw = r4.zw * r1.ww;
    r4.zw = scaleUVs3.xy * r4.zw;
    r1.xy = r1.xy * scaleUVs3.xy + r4.zw;
    ...
    r1.w = r1.w * 0.5 + 0.5;
    r1.w = 1 + -r1.w;
    r2.w = zoomUVs3.y + -zoomUVs3.x;
    r1.w = r1.w * r2.w + zoomUVs3.x;
    r1.xy = r1.xy / r1.ww;
    r1.xy = float2(0.5,0.5) + r1.xy;
    r4.zw = saturate(r1.xy);
    r13.x = clampU3 ? r4.z : r1.x;
    r13.y = clampV3 ? r4.w : r1.y;
  }
  r5.xyzw = emissiveMap3.Sample(colorSampler_s, r13.xy).xyzw;
  r1.xyw = emissiveTint3.xyz * r5.xyz;
  r2.w = hdrScale * r5.w;
  r1.xyw = r2.www * r1.xyw;
  r0.z = clampV3 + r0.z;
  r0.z = frac(r0.z);
  r5.y = gameTime.w * clampV3 + r0.z;
  r5.x = clampV3;
  ...
  r0.z = r0.z * r2.w + flickerRange3.x;
  ...
  r6.z = 100 * r6.z;
  r8.yz = -r4.ww * float2(10,5) + float2(6.85740995,7.08500004);
  r6.w = exp2(r8.y);
  r6.w = r6.w * r4.x;
  r6.w = 9.1368103 * r6.w;
  r7.w = r5.w * r4.w;
  ...
  r41.w = samp0[]..swiz;
    ...
    r31.x = dot(r9.xyz, r23.xyz);
    r31.y = dot(r9.xyz, r32.xyz);
    r31.z = dot(r9.xyz, r25.xyz);
  ...
  if (r7.w == 0) {
    ...
    r8.y = (int)r7.w & -32;
    r8.z = (int)r7.w + (int)-r8.y;
    r8.w = numRefProbes & -32;
    r10.y = (int)-r8.w + numRefProbes;
    r14.xy = float2(0,0);
    r15.w = 0;
    r16.yz = float2(0,1);
    r17.xy = float2(0,0);
    ...
    while (true) {
      ...
      r12.w = cmp((int)r8.y == (int)r10.z);
      bitmask.z = ((~(-1 << r8.z)) << 0) & 0xffffffff;  r14.z = (((uint)0 << 0) & bitmask.z) | ((uint)r10.w & ~bitmask.z);
        ...
        r15.y = samp0[]..swiz;
          ...
          r35.w = samp0[]..swiz;
            ...
            r41.y = samp0[]..swiz;
              ...
              r36.x = dot(r9.xyz, r27.xyz);
              r36.y = dot(r9.xyz, r28.xyz);
              r36.z = dot(r9.xyz, r32.xyz);
    ...
    if (r8.w != 0) {
      ...
      while (true) {
        ...
        r14.w = cmp((int)r8.y == (int)r12.w);
        if (r8.z == 0) r15.x = 0; else if (r8.z+0 < 32) {         r15.x = (uint)r14.z << (32-(r8.z + 0)); r15.x = (uint)r15.x >> (32-r8.z);        } else r15.x = (uint)r14.z >> 0;
          ...
          r28.y = samp0[]..swiz;
            ...
            r36.w = samp0[]..swiz;
              ...
              r42.y = samp0[]..swiz;
                ...
                r37.x = dot(r9.xyz, r27.xyz);
                r37.y = dot(r9.xyz, r29.xyz);
                r37.z = dot(r9.xyz, r33.xyz);
    ...
    r22.xyz = r24.xyz * r4.www;
    r6.z = cmp(r24.w < 0.99000001);
    if (r6.z != 0) {
      r6.z = 1 + -r24.w;
      r6.w = sunConstants.globalProbeExposure * r6.z;
      r8.yzw = -globalProbeConstants.data[0].xyz + v7.xyz;
      r14.x = globalProbeConstants.data[0].w * r8.y;
      r14.yz = globalProbeConstants.data[1].xy * r8.zw;
      r8.yzw = saturate(float3(0.5,0.5,0.5) + r14.xyz);
      r14.xy = globalProbeConstants.data[1].zw * r8.yz;
      r14.z = globalProbeConstants.data[2].x * r8.w;
      r8.yzw = globalProbeConstants.data[2].yzw + r14.xyz;
      r10.yzw = cmp(float3(0,0,0) < r9.xyz);
      r14.xyz = r10.yzw ? float3(0,0,0) : float3(0.5,0.5,0.5);
      r14.w = 0;
      r10.yzw = r14.wwx + r8.yzw;
      r10.yzw = gProbeXArray.SampleLevel(samplerLinearClamp_s, r10.yzw, 0).xyz;
      r15.xyz = r9.xyz * r9.xyz;
      r15.xyz = r15.xyz * r6.www;
      r16.xyz = r14.wwy + r8.yzw;
      ...
      r8.yzw = r14.wwz + r8.yzw;
      r8.yzw = gProbeZArray.SampleLevel(samplerLinearClamp_s, r8.yzw, 0).xyz;
      r8.yzw = r8.yzw * r15.zzz + r10.yzw;
      r9.w = 0;
      r10.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r9.xyzw, 6).xyz;
      r8.yzw = r10.yzw * r8.yzw;
      r6.w = dot(r8.yzw, float3(0.212599993,0.715200007,0.0722000003));
      r21.xyz = r23.xyz * r4.www + r8.yzw;
      r13.w = 0;
      r8.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r13.xyzw, r5.w).xyz;
      r4.w = sunConstants.globalProbeExposure * r6.z + -r6.w;
      r4.w = r4.y * r4.w + r6.w;
      r22.xyz = r8.yzw * r4.www + r22.xyz;
    }
  } else {
    r22.x = r21.w;
  }
  ...
  r6.zw = r4.xy * float2(0.984375,0.984375) + float2(0.0078125,0.0078125);
  r6.zw = gEnvBRDFGeneric.SampleLevel(samplerLinear_s, r6.zw, 0).xy;
  r8.yzw = r22.xyz * r4.www;
  r15.xyz = r8.zwy * r6.zzz;
  ...
  r0.w = r4.w * r0.w;
  r4.y = r4.y * r4.w;
  r4.w = dot(r9.xyz, sunConstants.wldDir.xyz);
  r5.w = saturate(r4.w);
  r6.z = cmp(0 >= r5.w);
  if (r6.z != 0) {
    r6.w = 0;
    ...
    if (r12.w == 0) {
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          r18.x = r16.w ? sunConstants.splitPinTransform[r7.w].w : sunConstants.splitPinTransform[r10.w].w;
  ...
  if (r6.z != 0) {
    ...
    if (r6.z != 0) {
      ...
      if (sunConstants.sunCookieIndex != 0) {
        r11.w = 1;
        r7.w = dot(sunConstants.sunCookieTransform[0].xyzw, r11.xyzw);
      ...
      r11.w = r17.z;
      r14.w = r15.z;
      r14.xyzw = r4.wwww ? r11.xyzw : r14.xyzw;
      r17.zw = r16.xy;
      r15.zw = r8.yz;
      r11.xyzw = r4.wwww ? r17.xyzw : r15.xyzw;
      r8.w = r4.w ? r16.z : r8.w;
      r15.z = r14.w;
      r15.xy = r11.xy;
      r8.yz = r11.zw;
    }
              ...
              if (r21.w != 0) {
                ...
                if (r21.w != 0) {
                  ...
                  while (true) {
                    ...
                    if (r28.w != 0) break;
                    r44.y = dot(icb[r27.w+0].yx, r11.xy);
                    r44.z = dot(icb[r27.w+0].yx, r11.yz);
                    ...
                    r13.w = samp0[]..swiz;
                      ...
                      if (r6.w != 0) {
                        ...
                        while (true) {
                          ...
                          if (r25.w != 0) break;
                          r43.x = dot(icb[r19.z+0].yx, r11.xw);
  ...
  if (r1.x != 0) {
    ...
    if (r2.w != 0) {
      r3.xy = r1.xx * fogConstants.atmospherefogdistancedensityscale.xy + fogConstants.atmospherefogdistanceoffset.xy;
