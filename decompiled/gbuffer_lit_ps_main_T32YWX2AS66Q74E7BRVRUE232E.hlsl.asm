...
mad r1.yzw, cb0[13].wwww, r1.yyzw, l(0.000000, 0.500000, 0.500000, 0.000000)
...
mad r0.w, cb1[62].x, r0.w, cb0[14].x
...
add r2.x, r4.y, r4.x
mad r2.x, r3.z, r2.y, r2.x
mul r2.x, r2.x, l(0.500000)
mad r2.yzw, r3.xxyz, r2.yyyy, -r2.xxxx
max r3.x, r2.w, r2.z
max r3.x, r2.y, r3.x
max r2.x, r2.x, r3.x
eq r2.y, r2.x, r2.y
