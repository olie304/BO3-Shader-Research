...
loop 
  ...
  add r14.xyz, -r21.yzwy, v7.xyzx
  dp3 r13.z, r14.xyzx, r14.xyzx
  sqrt r13.z, r13.z
  ge r13.z, cb2[54].y, r13.z
  and r13.w, r27.y, l(0x0000ffff)
  ...
  dp3 r15.w, r34.xyzx, r14.xyzx
  add_sat r15.w, r34.w, r15.w
  dp3 r16.w, r35.xyzx, r14.xyzx
  ...
  min r16.w, r16.w, |r17.w|
  mov r33.zw, r32.zzzw
  dp3 r17.w, r12.zxyz, r33.xzwx
  dp3 r18.w, r14.zxyz, r33.xzwx
  ...
  mad r28.xyz, r12.xyzx, r16.wwww, r28.xyzx
  ...
  utof r29.w, r22.y
  sample_l_indexable(texturecubearray)(float,float,float,float) r22.yzw, r29.xyzw, t8.wxyz, s2, r16.w
  and r27.yzw, r22.yyzw, l(0, 0x7fffffff, 0x7fffffff, 0x7fffffff)
  ieq r27.yzw, r27.yyzw, l(0, 0x7f800000, 0x7f800000, 0x7f800000)
  or r16.w, r27.z, r27.y
  or r16.w, r27.w, r16.w
  movc r22.yzw, r16.wwww, l(0,1.000000,1.000000,0), r22.yyzw
  ...
  ieq r27.yzw, r27.yyzw, l(0, 0x7f800000, 0x7f800000, 0x7f800000)
  or r16.z, r27.z, r27.y
  or r16.z, r27.w, r16.z
  movc r26.xyz, r16.zzzz, l(1.000000,1.000000,0,0), r26.xyzx
  mov r28.xyzw, r19.yzwx
    ...
    if_nz r17.w
      ...
      if_nz r13.z
        ...
        loop 
          ...
          ushr r21.z, r17.z, l(2)
          ubfe r23.w, l(1), l(2), r17.z
          and r24.w, r21.z, l(2)
          max r25.w, r30.x, r30.y
          mad r18.z, -r18.z, r18.w, l(1.000000)
          mul r18.z, r18.z, r30.y
          movc r5.y, r24.w, r18.z, r25.w
          movc r30.xy, r23.wwww, r30.xyxx, r5.xyxx
          iadd r17.w, r17.w, l(1)
          mov r17.z, r21.z
        endloop 
        mov_sat r30.y, r30.y
        mul r5.y, r11.w, r30.y
        lt r17.z, l(0.000000), r5.y
        if_nz r17.z
          iadd r31.w, r29.w, l(257)
          mad r32.w, r30.y, r11.w, r28.w
          mul r5.y, r27.x, r5.y
          mul r27.yzw, r5.yyyy, r25.xxyz
          mul r30.xzw, r21.xxyw, r27.zzzz
          mad r30.xzw, r23.xxyz, r27.yyyy, r30.xxzw
          mad r27.yzw, r24.xxyz, r27.wwww, r30.xxzw
          mul r30.xzw, r26.xxyz, r27.yyzw
          dp3 r17.z, r30.xzwx, l(0.212600, 0.715200, 0.072200, 0.000000)
          mad r32.xyz, r27.yzwy, r26.xyzx, r28.xyzx
          mul r17.w, r10.y, r17.z
          mul r27.yzw, r5.yyyy, r22.yyzw
          dp3 r5.y, r27.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
          mad r5.y, r10.y, r17.z, r5.y
          div r5.y, r17.w, r5.y
          mad r31.xyz, r27.yzwy, r5.yyyy, r29.xyzx
        else 
...
endloop 
if_z r10.z
  max r0.z, r19.x, l(1.000000)
  rcp r0.z, r0.z
  mov_sat r19.x, r19.x
  mul r4.xyz, r0.zzzz, r19.yzwy
  mul r20.xyz, r0.zzzz, r20.xyzx
  lt r5.x, r19.x, l(0.990000)
  if_nz r5.x
    iadd r20.w, r20.w, l(256)
    add r5.x, -r19.x, l(1.000000)
    ...
    lt r11.yzw, l(0.000000, 0.000000, 0.000000, 0.000000), r1.xxyz
    movc r13.xyz, r11.yzwy, l(0,0,0,0), l(0.500000,0.500000,0.500000,0)
    mov r13.w, l(0)
    add r11.yzw, r10.yyzw, r13.wwwx
    ...
    mad r11.yzw, r11.yyzw, r14.xxxx, r15.xxyz
    ...
    mad r10.yzw, r10.yyzw, r14.zzzz, r11.yyzw
    mov r1.w, l(0)
    sample_l_indexable(texturecubearray)(float,float,float,float) r11.yzw, r1.xyzw, t8.wxyz, s2, l(6.000000)
    mul r10.yzw, r10.yyzw, r11.yyzw
    dp3 r1.w, r10.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
    mad r19.yzw, r19.yyzw, r0.zzzz, r10.yyzw
    mov r12.w, l(0)
...
if_nz r4.x
  ...
  add r0.y, r0.y, r1.w
  div r0.y, r1.w, r0.y
  mad r4.xyz, r3.xyzx, r0.yyyy, r19.yzwy
...
movc r4.xyz, r0.zzzz, r4.xyzx, r19.yzwy
...
add r5.xy, cb1[44].xyxx, l(-1.000000, -1.000000, 0.000000, 0.000000)
max r1.xy, r1.xyxx, l(0.000000, 0.000000, 0.000000, 0.000000)
min r1.xy, r5.xyxx, r1.xyxx
ftoi r10.xy, r1.xyxx
mov r10.zw, l(0,0,0,0)
ld_indexable(texture2d)(float,float,float,float) r0.y, r10.xyzw, t29.yxzw
ge r3.w, r0.y, l(0.984375)
mul r5.x, r0.y, l(1.01587307)
mad r0.y, r0.y, l(64.000000), l(-63.000000)
movc r0.y, r3.w, r0.y, r5.x
max r0.y, r0.y, l(0.00000001)
rcp r0.y, r0.y
lt r0.x, r0.x, r0.y
mul r1.xy, r1.xyxx, cb1[44].zwzz
sample_indexable(texture2d)(float,float,float,float) r5.xyw, r1.xyxx, t30.xywz, s9
if_z r0.x
  ftoi r10.xy, v0.xyxx
  mov r10.zw, l(0,0,0,0)
  ld_indexable(texture2d)(float,float,float,float) r5.xyw, r10.xyzw, t30.xywz
endif 
mul r10.xyz, r5.xywx, cb1[85].xxxx
...
mad r5.xyw, -r5.xyxw, cb1[85].xxxx, r9.xyxz
mad r5.xyw, r6.xxxx, r5.xyxw, r10.xyxz
mad r6.xyz, r8.xyzx, r4.xyzx, -r5.xywx
mad r5.xyw, r7.xxxx, r6.xyxz, r5.xyxw
...
add r0.xyw, -r5.xyxw, r0.xyxw
mad r0.xyw, r1.xxxx, r0.xyxw, r5.xyxw
mad r3.xyz, cb0[22].yzwy, r4.xyzx, -r0.xywx
mad r3.xyz, r6.wwww, r3.xyzx, r0.xywx
movc r0.xyw, cb0[28].yyyy, r3.xyxz, r0.xyxw
if_nz cb2[52].y
  if_nz cb2[53].y
    and r1.xy, r0.zzzz, r1.wzww
    switch cb2[53].y
      case l(1)
      mov r1.x, l(1)
      break 
...
mov o0.w, l(1.000000)
ret 
// Approximately 1385 instruction slots used
