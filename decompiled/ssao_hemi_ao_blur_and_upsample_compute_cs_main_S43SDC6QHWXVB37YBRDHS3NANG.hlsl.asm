...
gather4_indexable(texture2d)(float,float,float,float) r2.xyzw, r0.yzyy, t0.xyzw, s2.x
...
if_nz r0.y
  ...
  add r2.w, -r2.w, r3.x
  add r3.x, -r3.x, r3.y
  mad r3.y, r2.x, r2.x, cb5[8].y
  mad r3.z, r2.y, r2.y, cb5[8].y
  mad r3.w, r2.z, r2.z, cb5[8].y
  mad r4.x, r2.w, r2.w, cb5[8].y
  ...
  mul r3.y, r3.y, cb5[8].z
  lt r2.x, r3.y, r2.x
  mad r2.y, r2.y, r2.z, cb5[8].y
  mul r2.y, r2.y, r2.y
  mul r3.y, r3.w, r3.z
  mul r3.y, r3.y, cb5[8].z
  lt r2.y, r3.y, r2.y
  mad r2.z, r2.z, r2.w, cb5[8].y
  mul r2.z, r2.z, r2.z
  mul r3.y, r3.w, r4.x
  mul r3.y, r3.y, cb5[8].z
  mad r2.w, r2.w, r3.x, cb5[8].y
  mul r2.w, r2.w, r2.w
  mul r3.x, r4.y, r4.x
  mul r3.x, r3.x, cb5[8].z
...
gather4_indexable(texture2d)(float,float,float,float) r3.xyzw, r0.zwzz, t4.xyzw, s2.x
ge r4.xyzw, r3.xyzw, l(0.984375, 0.984375, 0.984375, 0.984375)
mul r0.zw, r3.xxxy, l(0.000000, 0.000000, 1.01587307, 1.01587307)
mad r3.xy, r3.xyxx, l(64.000000, 64.000000, 0.000000, 0.000000), l(-63.000000, -63.000000, 0.000000, 0.000000)
movc r0.zw, r4.xxxy, r3.xxxy, r0.zzzw
max r0.zw, r0.zzzw, l(0.000000, 0.000000, 0.00000001, 0.00000001)
rcp r0.zw, r0.zzzw
min r0.zw, r0.zzzw, l(0.000000, 0.000000, 65504.000000, 65504.000000)
mul r3.xy, r3.zwzz, l(1.01587307, 1.01587307, 0.000000, 0.000000)
mad r3.zw, r3.zzzw, l(0.000000, 0.000000, 64.000000, 64.000000), l(0.000000, 0.000000, -63.000000, -63.000000)
movc r3.xy, r4.zwzz, r3.zwzz, r3.xyxx
max r3.xy, r3.xyxx, l(0.00000001, 0.00000001, 0.000000, 0.000000)
rcp r3.xy, r3.xyxx
min r3.xy, r3.xyxx, l(65504.000000, 65504.000000, 0.000000, 0.000000)
gather4_indexable(texture2d)(float,float,float,float) r4.xyzw, r0.xyxx, t0.xyzw, s2.x
add r5.xyzw, r0.zzzz, -r4.xyzw
add r5.xyzw, |r5.xyzw|, cb5[8].wwww
div r5.xyzw, l(9.000000, 3.000000, 1.000000, 3.000000), r5.xyzw
dp4 r0.x, r5.xyzw, l(1.000000, 1.000000, 1.000000, 1.000000)
dp4 r0.y, r1.yzwx, r5.xyzw
add r0.xy, r0.xyxx, cb5[8].xxxx
div r0.x, r0.y, r0.x
add r5.xyzw, r0.wwww, -r4.yzwx
add r5.xyzw, |r5.xyzw|, cb5[8].wwww
div r5.xyzw, l(9.000000, 3.000000, 1.000000, 3.000000), r5.xyzw
dp4 r0.y, r5.xyzw, l(1.000000, 1.000000, 1.000000, 1.000000)
dp4 r0.z, r1.zwxy, r5.xyzw
add r0.yz, r0.yyzy, cb5[8].xxxx
div r0.y, r0.z, r0.y
add r5.xyzw, r3.xxxx, -r4.zwxy
add r5.xyzw, |r5.xyzw|, cb5[8].wwww
div r5.xyzw, l(9.000000, 3.000000, 1.000000, 3.000000), r5.xyzw
dp4 r0.z, r5.xyzw, l(1.000000, 1.000000, 1.000000, 1.000000)
dp4 r0.w, r1.wxyz, r5.xyzw
add r0.zw, r0.zzzw, cb5[8].xxxx
div r0.z, r0.w, r0.z
add r3.xyzw, r3.yyyy, -r4.wxyz
add r3.xyzw, |r3.xyzw|, cb5[8].wwww
div r3.xyzw, l(9.000000, 3.000000, 1.000000, 3.000000), r3.xyzw
dp4 r0.w, r3.xyzw, l(1.000000, 1.000000, 1.000000, 1.000000)
add r0.w, r0.w, cb5[8].x
dp4 r1.x, r1.xyzw, r3.xyzw
add r1.x, r1.x, cb5[8].x
div r0.w, r1.x, r0.w
