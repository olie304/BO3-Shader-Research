...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:38:25 2021
//
//
// Buffer Definitions: 
//
...
mul r1.y, r0.w, r1.x
sample_indexable(texture2d)(float,float,float,float) r1.z, v1.yzyy, t26.yzxw, s7
sample_indexable(texture2d)(float,float,float,float) r1.w, v1.yzyy, t25.yzwx, s5
add r2.x, -cb0[12].x, cb0[12].y
mad r1.w, r1.w, r2.x, cb0[12].x
mul_sat r1.w, r1.w, l(0.05882353)
sample_indexable(texture2d)(float,float,float,float) r2.yzw, v1.yzyy, t24.wxyz, s6
