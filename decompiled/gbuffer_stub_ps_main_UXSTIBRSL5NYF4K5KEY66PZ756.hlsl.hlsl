// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:31:35 2021
  ...
  out float2 o3 : SV_TARGET3)
{
  ...
  r0.x = colorMap.Sample(colorSampler_s, w1.xy).x;
  r0.y = cmp(r0.x < 0.5);
  if (r0.y != 0) discard;
  ...
  r3.x = r2.x * r0.z;
  r3.y = -r2.y * r0.w;
  r0.zw = renderTargetSize.xy * float2(0.5,0.5) + r3.xy;
  r0.zw = v0.xy + -r0.zw;
  r2.x = r1.y + r1.z;
  r2.x = v2.z * r0.y + r2.x;
  r2.x = 0.5 * r2.x;
  r2.yzw = v2.xyz * r0.yyy + -r2.xxx;
  r0.y = max(r2.z, r2.w);
  r0.y = max(r2.y, r0.y);
  r0.y = max(r2.x, r0.y);
  r2.x = cmp(r0.y == r2.y);
