...
Texture2D<float4> specOcclusionMap : register(t29);
...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  r4.xyz = detailMap.Sample(normalSampler_s, r2.yz).xyz;
  r4.xy = r4.xy * float2(1.9921875,1.9921875) + float2(-1,-1);
  r2.w = r4.z * r4.z;
  r2.w = 0.333333343 * r2.w;
  r2.xw = min(float2(1,1), r2.xw);
  r3.xy = r4.xy * detailScaleHeight + r1.zw;
  ...
  r1.y = rsqrt(r1.y);
  r4.xyz = r4.xyz * r1.yyy + -r3.xyz;
  r3.xyz = debugNormalOverride.www * r4.xyz + r3.xyz;
  r1.y = specOcclusionMap.Sample(colorSampler_s, r2.yz).x;
  r1.y = -1 + r1.y;
  r1.y = detailScaleHeight * r1.y + 1;
  r1.z = thicknessMap.Sample(colorSampler_s, w1.xy).x;
  r1.z = 1 + -r1.z;
  r2.xyz = float3(1,0.5,0.5) * r1.zzz;
  ...
  if (enableGTAO != 0) {
    ...
    r6.xy = r4.xy * r3.ww;
    r6.zw = -r6.yy;
    r3.w = dot(r5.yx, r6.xz);
    r5.xy = -r6.wx * r3.ww + r5.xy;
    r3.w = dot(r5.xyz, r5.xyz);
    r3.w = rsqrt(r3.w);
    r5.xyz = r5.zxy * r3.www;
    r3.w = dot(r6.xy, r5.yz);
    r3.w = cmp(r3.w >= 0);
    r3.w = r3.w ? -1 : 1;
    r5.x = saturate(-r5.x);
    r4.x = 1 + -r5.x;
    r4.x = sqrt(r4.x);
    r4.y = r5.x * -0.0187292993 + 0.0742610022;
    r4.y = r4.y * r5.x + -0.212114394;
    r4.y = r4.y * r5.x + 1.57072878;
    r4.x = r4.y * r4.x;
    r4.y = r4.x * r3.w;
    r5.x = 1 + -abs(r1.z);
    r5.x = sqrt(r5.x);
    r5.y = abs(r1.z) * -0.0187292993 + 0.0742610022;
    r5.y = r5.y * abs(r1.z) + -0.212114394;
    r5.y = r5.y * abs(r1.z) + 1.57072878;
    r5.z = r5.y * r5.x;
    ...
    r5.x = 1 + -abs(r2.w);
    r5.x = sqrt(r5.x);
    r5.y = abs(r2.w) * -0.0187292993 + 0.0742610022;
    r5.y = r5.y * abs(r2.w) + -0.212114394;
    r5.y = r5.y * abs(r2.w) + 1.57072878;
    r5.z = r5.y * r5.x;
    r5.z = r5.z * -2 + 3.14159274;
    r2.w = cmp(r2.w < -r2.w);
    r2.w = r2.w ? r5.z : 0;
    ...
    r3.w = gSSAOTexture.SampleLevel(LinearSampler_s, r4.zw, 0).x;
    r1.z = min(r3.w, r2.w);
  }
...
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r4.z, v2.x, l(8), t4.xxxx
r4.z = samp0[]..swiz;
  r4.zw = (int2)r4.zz & int2(268435456,536870912);
  if (r4.z != 0) {
  ...
  if (r4.w != 0) {
    r7.xyz = eyeOffset.xyz + v6.xyz;
    r4.z = numDynamicDecals + numStaticDecals;
    r2.w = 0.0078125 * r2.w;
    r2.w = min(15, r2.w);
    r2.w = (uint)r2.w;
    r8.xy = (uint2)r4.xy >> int2(6,6);
          ...
          r20.z = samp0[]..swiz;
            ...
            r23.w = samp0[]..swiz;
              ...
              r20.w = samp0[]..swiz;
                ...
                r15.w = 1 + -r14.w;
                r19.xyz = r15.www * r10.xyz;
                r10.xyz = r18.xyz * r14.www + r19.xyz;
                r16.z = r15.w * r12.w;
  ...
  r1.w = 1 + -r12.x;
  o2.xyz = r0.xyz * r1.www + r11.xyz;
  r0.x = r0.w * r1.w + r12.x;
  r0.yzw = r3.xyz * r1.www + r13.xyz;
  r2.w = dot(r0.yzw, r0.yzw);
  r2.w = rsqrt(r2.w);
  r3.xyz = r2.www * r0.yzw;
  r5.y = r1.x * r1.w + r12.y;
  r0.y = log2(abs(r1.z));
  ...
  r5.x = saturate(dot(r3.xyz, r6.xyz));
  r2.w = dot(-r6.xyz, r3.xyz);
  r2.w = r2.w + r2.w;
  r11.xyz = r3.xyz * -r2.www + -r6.xyz;
  r2.w = 17 * r5.y;
  r2.w = exp2(r2.w);
  r2.w = 2 + r2.w;
  r2.w = 2 / r2.w;
  ...
  if (r6.w != 0) {
    ...
    if (r6.w != 0) {
      ...
      r7.z = r7.z + -abs(r5.w);
      r7.z = r4.z * r7.z + abs(r5.w);
      r7.w = cmp(0 < r5.w);
      r5.w = saturate(r5.w);
      r14.xyz = -v6.xyz * r1.zzz + sunConstants.wldDir.xyz;
      r1.z = dot(r14.xyz, r14.xyz);
      r1.z = rsqrt(r1.z);
      r14.xyz = r14.xyz * r1.zzz;
      r1.z = dot(r14.xyz, r6.xyz);
      r8.w = dot(r3.xyz, r14.xyz);
      r12.w = abs(r8.w) * r2.w + -abs(r8.w);
      r8.w = abs(r8.w) * r12.w + 1;
      r12.w = r5.w * r4.w + r5.z;
      r8.w = r8.w * r8.w;
      r8.w = r8.w * r12.w;
      r8.w = rcp(r8.w);
      r5.w = r5.w * r6.w;
      ...
      r13.zw = r7.ww ? r1.zz : 0;
      r15.xyz = r7.www ? r5.www : 0;
      r1.z = dot(r10.yzw, float3(0.212599993,0.715200007,0.0722000003));
      r1.z = r13.y * r1.z;
      r13.x = 1;
  ...
  r1.xzw = r36.zxy * r4.yzx;
  r1.xzw = r36.yzx * r4.zxy + -r1.xzw;
  ...
  r8.xyz = r8.xxx * r1.xzw;
  r8.xyz = r9.xxx * r4.xyz + r8.xyz;
  ...
  sincos(r4.w, r9.x, r12.x);
  r1.xzw = r9.xxx * r1.xzw;
  r1.xzw = r12.xxx * r4.xyz + r1.xzw;
  r1.xzw = r1.xzw * float3(0.119999997,0.119999997,0.119999997) + r6.xyw;
  r4.xyz = viewProjectionMatrix._m10_m11_m13 * r1.zzz;
  r4.xyz = r1.xxx * viewProjectionMatrix._m00_m01_m03 + r4.xyz;
  r1.xzw = r1.www * viewProjectionMatrix._m20_m21_m23 + r4.xyz;
  r1.xzw = r1.xzw + r9.yzw;
  r1.xz = float2(0.5,-0.5) * r1.xz;
  r4.z = rcp(r1.w);
  r4.xy = r1.xz * r4.zz + r10.xy;
  r10.w = 0.5;
  r1.xzw = r4.xyz + r10.wwz;
  r4.x = dot(renderTargetSize.zw, renderTargetSize.zw);
  r4.y = dot(r8.xy, r8.xy);
  r4.xy = sqrt(r4.xy);
  r4.y = rcp(r4.y);
  r4.x = r4.x * r4.y;
  r4.yz = r2.ww * float2(0.5,0.5) + float2(0.333333343,1);
  r4.yz = float2(0.117647059,0.117647059) * r4.yz;
  r4.yz = r4.yz * r4.yz;
  x1[0].x = r4.y;
  r6.xyw = r8.xyz * r4.yyy + r7.xyz;
  r5.zw = cmp(r4.xx < r4.yz);
  r6.xy = renderTargetSize.xy * r6.xy;
  r9.xy = (int2)r6.xy;
  r9.zw = float2(0,0);
  r4.w = floatZSampler.Load(r9.xyz).x;
  ...
  if (r6.y != 0) {
    r6.yw = r2.ww * float2(0.5,0.5) + float2(1.33333337,2);
    r6.yw = float2(0.117647059,0.117647059) * r6.yw;
    r6.yw = r6.yw * r6.yw + -r4.yz;
    r4.y = r5.z * r6.y + r4.y;
    x1[0].x = r4.y;
    r9.xyz = r8.xyz * r4.yyy + r7.xyz;
    r4.y = cmp(r4.x < r4.y);
    ...
    r4.z = r5.w * r6.w + r4.z;
    x1[1].x = r4.z;
    r9.xyz = r1.xzw * r4.zzz + r7.xyz;
    r4.z = cmp(r4.x < r4.z);
    r6.yw = renderTargetSize.xy * r9.xy;
    r10.xy = (int2)r6.yw;
    r10.zw = float2(0,0);
  ...
  if (r4.y == 0) {
    r4.yz = r2.ww * float2(0.5,0.5) + float2(2.33333325,3);
    r4.yz = float2(0.117647059,0.117647059) * r4.yz;
    r4.w = x1[0].x;
    r5.z = x0[0].x;
    r4.y = r4.y * r4.y + -r4.w;
  ...
  if (r4.y == 0) {
    r4.yz = r2.ww * float2(0.5,0.5) + float2(3.33333325,4);
    r4.yz = float2(0.117647059,0.117647059) * r4.yz;
    r4.w = x1[0].x;
    r5.z = x0[0].x;
    r4.y = r4.y * r4.y + -r4.w;
  ...
  if (r4.y == 0) {
    r4.yz = r2.ww * float2(0.5,0.5) + float2(4.33333349,5);
    r4.yz = float2(0.117647059,0.117647059) * r4.yz;
    r4.w = x1[0].x;
    r5.z = x0[0].x;
    r4.y = r4.y * r4.y + -r4.w;
  ...
  if (r4.y == 0) {
    r4.yz = r2.ww * float2(0.5,0.5) + float2(5.33333349,6);
    r4.yz = float2(0.117647059,0.117647059) * r4.yz;
    r4.w = x1[0].x;
    r5.z = x0[0].x;
    r4.y = r4.y * r4.y + -r4.w;
  ...
  if (r4.y == 0) {
    r4.yz = r2.ww * float2(0.5,0.5) + float2(6.33333349,7);
    r4.yz = float2(0.117647059,0.117647059) * r4.yz;
    r4.w = x1[0].x;
    r5.z = x0[0].x;
    r4.y = r4.y * r4.y + -r4.w;
  ...
  if (r4.y == 0) {
    r4.yz = r2.ww * float2(0.5,0.5) + float2(7.33333349,8);
    r4.yz = float2(0.117647059,0.117647059) * r4.yz;
    r2.w = x1[0].x;
    r4.w = x0[0].x;
    r4.y = r4.y * r4.y + -r2.w;
    r2.w = r4.w * r4.y + r2.w;
    r6.xyw = r8.xyz * r2.www + r7.xyz;
    r2.w = cmp(r4.x < r2.w);
    r5.zw = renderTargetSize.xy * r6.xy;
    r8.xy = (int2)r5.zw;
    r8.zw = float2(0,0);
    r4.y = floatZSampler.Load(r8.xyz).x;
    r5.z = cmp(r4.y >= 0.984375);
  ...
  r1.x = min(r16.w, r1.x);
  r1.x = r16.z * r1.x;
  r1.xzw = r1.xxx * r35.xyz;
  r4.xyz = r1.xzw * r37.xyz + r31.xyz;
  r6.xyz = r1.xzw * r38.xyz + r32.xyz;
  r7.xyz = r1.xzw * r39.xyz + r34.xyz;
  r1.xzw = r1.xzw * r40.xyz + r33.xyz;
  r2.w = 1 + -r5.y;
  r4.w = 5 * r2.w;
  r5.z = r2.w * 5 + -2.5;
  r5.z = saturate(0.400000006 * r5.z);
  r5.z = 100 * r5.z;
  r8.xy = -r2.ww * float2(10,5) + float2(6.85740995,7.08500004);
  r5.w = exp2(r8.x);
  r5.w = r5.x * r5.w;
  r5.w = 9.1368103 * r5.w;
  r6.w = r4.w * r2.w;
  r6.w = -r6.w * 2.0159049 + r8.y;
  r6.w = exp2(r6.w);
  r6.w = r6.w * r5.x;
  ...
  r28.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r29.xyzw, r7.w, l(180), t15.zwxy
  r29.x = samp0[]..swiz;
  r29.y = samp0[]..swiz;
  r29.z = samp0[]..swiz;
  r29.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r30.xyzw, r7.w, l(196), t15.xyzw
  r30.x = samp0[]..swiz;
  r30.y = samp0[]..swiz;
  r30.z = samp0[]..swiz;
  r30.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r31.xy, r7.w, l(212), t15.xyxx
  r31.x = samp0[]..swiz;
  r31.y = samp0[]..swiz;
    r32.xyz = v6.xyz + -r19.yzw;
    r8.w = dot(r32.xyz, r32.xyz);
    r8.w = sqrt(r8.w);
    r8.w = cmp(probeDebugRadius >= r8.w);
    r9.z = (int)r25.y & 0x0000ffff;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r33.xyzw, r9.z, l(0), t16.xyzw
  r33.x = samp0[]..swiz;
  r33.y = samp0[]..swiz;
  r33.z = samp0[]..swiz;
  r33.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r34.xyzw, r9.z, l(16), t16.xyzw
  r34.x = samp0[]..swiz;
  r34.y = samp0[]..swiz;
  r34.z = samp0[]..swiz;
  r34.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r35.xyzw, r9.z, l(32), t16.xyzw
  r35.x = samp0[]..swiz;
  r35.y = samp0[]..swiz;
  r35.z = samp0[]..swiz;
  r35.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r36.xyzw, r9.z, l(48), t16.xyzw
  r36.x = samp0[]..swiz;
  r36.y = samp0[]..swiz;
  r36.z = samp0[]..swiz;
  r36.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r37.xyzw, r9.z, l(64), t16.xyzw
  r37.x = samp0[]..swiz;
  r37.y = samp0[]..swiz;
  r37.z = samp0[]..swiz;
  r37.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=96)(mixed,mixed,mixed,mixed) r38.xyzw, r9.z, l(80), t16.xyzw
  r38.x = samp0[]..swiz;
  r38.y = samp0[]..swiz;
  r38.z = samp0[]..swiz;
  r38.w = samp0[]..swiz;
    ...
    r12.w = dot(r34.xyz, r32.xyz);
    r12.w = saturate(r12.w + r34.w);
    r10.w = r12.w * r10.w;
    r12.w = dot(r35.xyz, r32.xyz);
    r12.w = saturate(r12.w + r35.w);
    r10.w = r12.w * r10.w;
    r12.w = dot(r36.xyz, r32.xyz);
    r12.w = saturate(r12.w + r36.w);
    r10.w = r12.w * r10.w;
    r12.w = dot(r37.xyz, r32.xyz);
    r12.w = saturate(r12.w + r37.w);
    r10.w = r12.w * r10.w;
    r12.w = dot(r38.xyz, r32.xyz);
    ...
    r26.xyz = r11.xyz * r12.www + r26.xyz;
    ...
    if (6 == 0) r15.z = 0; else if (6+25 < 32) {     r15.z = (uint)r25.y << (32-(6 + 25)); r15.z = (uint)r15.z >> (32-6);    } else r15.z = (uint)r25.y >> 25;
    if (9 == 0) r15.w = 0; else if (9+16 < 32) {     r15.w = (uint)r25.y << (32-(9 + 16)); r15.w = (uint)r15.w >> (32-9);    } else r15.w = (uint)r25.y >> 16;
    r27.w = (uint)r15.w;
    r20.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r27.xyzw, r12.w).xyz;
    r25.yzw = (int3)r20.xyz & int3(-2147483648,-2147483648,-2147483648);
    r25.yzw = cmp((int3)r25.yzw == int3(2139095040,2139095040,2139095040));
    r12.w = (int)r25.z | (int)r25.y;
    r12.w = (int)r25.w | (int)r12.w;
    r20.xyz = r12.www ? float3(1,1,0) : r20.xyz;
    r26.x = dot(r32.xyz, r19.xyz);
    r26.y = dot(r32.xyz, r28.xyz);
    r26.z = dot(r32.xyz, r21.xyz);
    ...
    r25.yzw = cmp((int3)r25.yzw == int3(2139095040,2139095040,2139095040));
    r12.z = (int)r25.z | (int)r25.y;
    r12.z = (int)r25.w | (int)r12.z;
    r24.xyz = r12.zzz ? float3(1,1,0) : r24.xyz;
    r26.xyzw = r16.xyzw;
    r25.yzw = r18.yzw;
    r12.z = r6.w;
    r12.w = r8.z;
    while (true) {
      ...
      if (r13.w != 0) {
        ...
        if (r8.w != 0) {
          ...
          r34.z = samp0[]..swiz;
          r34.w = samp0[]..swiz;
            r14.z = dot(r28.xyz, r32.xyz);
            r14.z = saturate(r14.z + r28.w);
            r14.z = r27.x * r14.z;
            r14.w = dot(r29.xyz, r32.xyz);
            r14.w = saturate(r14.w + r29.w);
            r14.z = r14.z * r14.w;
            r14.w = dot(r30.xyz, r32.xyz);
            r14.w = saturate(r14.w + r30.w);
            r14.z = r14.z * r14.w;
            r14.w = dot(r31.xyz, r32.xyz);
            r14.w = saturate(r14.w + r31.w);
            r14.z = r14.z * r14.w;
            r14.w = dot(r33.xyz, r32.xyz);
            r14.w = saturate(r14.w + r33.w);
            r14.z = r14.z * r14.w;
            r14.w = dot(r34.xyz, r32.xyz);
            r14.w = saturate(r14.w + r34.w);
            r27.x = r14.z * r14.w;
            r15.w = (uint)r13.z >> 2;
            if (1 == 0) r17.w = 0; else if (1+2 < 32) {             r17.w = (uint)r13.z << (32-(1 + 2)); r17.w = (uint)r17.w >> (32-1);            } else r17.w = (uint)r13.z >> 2;
            r19.z = (int)r15.w & 2;
            r20.w = max(r27.y, r27.x);
            r14.z = -r14.z * r14.w + 1;
            r14.z = r27.y * r14.z;
            r15.y = r19.z ? r14.z : r20.w;
            r27.xy = r17.ww ? r27.xy : r15.xy;
            r13.w = (int)r13.w + 1;
            r13.z = r15.w;
          }
  ...
  if (r6.w == 0) {
    ...
    if (r8.y != 0) {
      ...
      while (true) {
        ...
        while (true) {
          if (r10.z == 0) break;
          r13.w = firstbitlow((uint)r10.z);
          r14.z = 1 << (int)r13.w;
          r14.w = (int)r10.z & (int)r14.z;
          if (r14.w != 0) {
            r10.z = (int)r10.z ^ (int)r14.z;
            r14.z = (int)r10.x + (int)r13.w;
          // Known bad code for instruction (needs manual fix):
          ...
          r26.y = samp0[]..swiz;
            ...
            r33.w = samp0[]..swiz;
              ...
              r39.y = samp0[]..swiz;
                ...
                r12.x = r13.w / r12.x;
                r23.xyz = r14.yzw * r12.xxx + r23.xyz;
              }
            }
          }
        }
    ...
    if (r5.z != 0) {
      ...
      r16.xyz = r20.xyz * r2.www + r3.xyz;
      r11.w = 0;
      r3.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r11.xyzw, r4.w).xyz;
      r2.w = sunConstants.globalProbeExposure * r5.z + -r3.w;
      r2.w = r5.y * r2.w + r3.w;
      r18.xyz = r3.xyz * r2.www + r18.xyz;
    }
  } else {
    r18.x = r16.w;
  }
  r3.xyz = r16.xyz * r0.yzw + r4.xyz;
  ...
  r5.xyz = r18.xyz * r1.yyy;
  r1.xyz = r5.xyz * r4.xxx + r1.xzw;
  r4.xyz = r5.xyz * r4.yyy + r7.xyz;
