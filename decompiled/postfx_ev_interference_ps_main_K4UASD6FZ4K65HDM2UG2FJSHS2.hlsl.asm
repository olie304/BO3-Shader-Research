...
//   float lookupMaxX;                  // Offset:  168 Size:     4
//   float lookupMinX;                  // Offset:  172 Size:     4
//   float2 warpScroll;                 // Offset:  176 Size:     8
//
// }
//
...
// warpTexture                       texture  float4          2d             t6      1 
// lookupTexture                     texture  float4          2d             t7      1 
// blockNoiseTexture                 texture  float4          2d             t9      1 
...
dcl_output o0.xyzw
dcl_temps 2
mad r0.x, cb1[69].w, cb0[10].y, l(0.500000)
add r0.y, -cb0[10].w, cb0[10].z
div r0.x, r0.x, r0.y
ge r0.z, r0.x, -r0.x
frc r0.x, |r0.x|
...
mad r0.yz, cb1[69].wwww, cb0[11].xxyx, v1.xxyx
sample_indexable(texture2d)(float,float,float,float) r0.y, r0.yzyy, t6.yxzw, s1
mad r0.y, r0.y, l(2.000000), l(-1.000000)
mul r0.z, cb1[69].w, l(0.700000)
mad r0.zw, r0.zzzz, cb0[11].xxxy, v1.xxxy
...
mad r0.yz, r1.xxyx, r0.yyyy, r0.zzwz
mul r0.xy, r0.yzyy, r0.xxxx
mad r0.zw, r0.xxxy, l(0.000000, 0.000000, -0.130000, -0.130000), v1.xxxy
mad r1.xyzw, r0.xyxy, l(0.170000, 0.170000, 0.310000, 0.310000), v1.xyxy
sample_indexable(texture2d)(float,float,float,float) r0.z, r0.zwzz, t0.xyzw, s1
sample_indexable(texture2d)(float,float,float,float) r0.x, r1.xyxx, t0.xyzw, s1
sample_indexable(texture2d)(float,float,float,float) r0.y, r1.zwzz, t0.xyzw, s1
mul r0.xyz, r0.xyzx, l(0.00003052, 0.00003052, 0.00003052, 0.000000)
mad r1.xy, cb1[69].wwww, -cb0[11].xyxx, v1.xyxx
mul r0.w, cb1[69].x, cb1[69].y
mad r1.xy, r0.wwww, l(713.000000, 573.000000, 0.000000, 0.000000), r1.xyxx
...
mad r0.xyz, r0.xyzx, l(32768.000000, 32768.000000, 32768.000000, 0.000000), -r1.xyzx
mad o0.xyz, cb3[0].xxxx, r0.xyzx, r1.xyzx
mov o0.w, r1.w
ret 
