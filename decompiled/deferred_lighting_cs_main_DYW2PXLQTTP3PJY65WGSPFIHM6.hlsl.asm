...
loop 
  ieq r9.w, r8.w, l(2)
  breakc_nz r9.w
  movc r9.w, r8.w, r0.x, r9.x
  uge r12.w, r9.w, r7.w
  ult r13.z, r9.w, cb2[0].y
  and r12.w, r12.w, r13.z
  if_nz r12.w
    imul null, r9.w, r9.w, l(14)
    add r15.yzw, r10.xxyz, -cb10[r9.w + 0].xxyz
    and r12.w, l(0x0000ffff), cb10[r9.w + 7].z
    ubfe r13.z, l(6), l(25), cb10[r9.w + 7].z
    ...
    mul r17.x, r13.w, r14.w
    and r13.w, l(1), cb10[r9.w + 6].x
    movc r17.xw, r13.wwww, r17.xxxy, r17.zzzx
    mov r13.w, cb10[r9.w + 6].x
    mov r24.xy, r17.xwxx
    mov r14.w, l(1)
    loop 
      ige r18.w, r14.w, r13.z
      breakc_nz r18.w
      iadd r18.w, r12.w, r14.w
    ...
    if_nz r13.z
      ...
      mad r19.yzw, r16.xxyz, r13.zzzz, r25.xxyz
      dp3 r13.w, r19.yzwy, r19.yzwy
      sqrt r13.w, r13.w
      ...
      utof r26.w, r13.w
      sample_l_indexable(texturecubearray)(float,float,float,float) r19.yzw, r26.xyzw, t8.wxyz, s2, r13.z
...
if_nz r8.w
  ...
  loop 
    ...
    if_nz r12.w
      imul null, r9.w, r9.w, l(14)
      add r25.xyz, r10.xyzx, -cb10[r9.w + 0].xyzx
      and r12.w, l(0x0000ffff), cb10[r9.w + 7].z
      ubfe r13.z, l(6), l(25), cb10[r9.w + 7].z
      imul null, r13.w, r12.w, l(6)
      dp3 r14.w, cb11[r13.w + 0].xyzx, r25.xyzx
      add_sat r14.w, r14.w, cb11[r13.w + 0].w
      dp3 r17.w, cb11[r13.w + 1].xyzx, r25.xyzx
      add_sat r17.w, r17.w, cb11[r13.w + 1].w
      mul r14.w, r14.w, r17.w
      dp3 r17.w, cb11[r13.w + 2].xyzx, r25.xyzx
      add_sat r17.w, r17.w, cb11[r13.w + 2].w
      mul r14.w, r14.w, r17.w
      dp3 r17.w, cb11[r13.w + 3].xyzx, r25.xyzx
      add_sat r17.w, r17.w, cb11[r13.w + 3].w
      mul r14.w, r14.w, r17.w
      dp3 r17.w, cb11[r13.w + 4].xyzx, r25.xyzx
      add_sat r17.w, r17.w, cb11[r13.w + 4].w
      mul r14.w, r14.w, r17.w
      dp3 r17.w, cb11[r13.w + 5].xyzx, r25.xyzx
      add_sat r13.w, r17.w, cb11[r13.w + 5].w
      mul r17.x, r13.w, r14.w
      and r13.w, l(1), cb10[r9.w + 6].x
      movc r17.xw, r13.wwww, r17.xxxy, r17.zzzx
      ...
      loop 
        ...
        iadd r18.w, r12.w, r14.w
        imul null, r18.w, r18.w, l(6)
        dp3 r19.z, cb11[r18.w + 0].xyzx, r25.xyzx
        add_sat r19.z, r19.z, cb11[r18.w + 0].w
        mul r19.z, r19.z, r26.x
        dp3 r19.w, cb11[r18.w + 1].xyzx, r25.xyzx
        add_sat r19.w, r19.w, cb11[r18.w + 1].w
        mul r19.z, r19.w, r19.z
        dp3 r19.w, cb11[r18.w + 2].xyzx, r25.xyzx
        add_sat r19.w, r19.w, cb11[r18.w + 2].w
        mul r19.z, r19.w, r19.z
        dp3 r19.w, cb11[r18.w + 3].xyzx, r25.xyzx
        add_sat r19.w, r19.w, cb11[r18.w + 3].w
        mul r19.z, r19.w, r19.z
        dp3 r19.w, cb11[r18.w + 4].xyzx, r25.xyzx
        add_sat r19.w, r19.w, cb11[r18.w + 4].w
        mul r19.z, r19.w, r19.z
        dp3 r19.w, cb11[r18.w + 5].xyzx, r25.xyzx
        add_sat r18.w, r19.w, cb11[r18.w + 5].w
        ...
        movc r19.y, r21.w, r18.w, r25.w
        movc r26.xy, r20.wwww, r26.xyxx, r19.xyxx
        iadd r14.w, r14.w, l(1)
        mov r13.w, r19.w
      endloop 
      add_sat r12.w, -r23.w, r26.y
      mul r13.z, r12.w, cb10[r9.w + 6].y
      lt r13.w, l(0.000000), r13.z
      if_nz r13.w
        mad r24.w, r12.w, cb10[r9.w + 6].y, r24.w
        mul r12.w, r13.z, cb10[r9.w + 7].y
        mov r27.x, cb10[r9.w + 7].w
        mov r27.yz, cb10[r9.w + 8].xxyx
        dp3 r13.z, r16.xyzx, r27.xyzx
        dp3 r13.w, r25.xyzx, r27.xyzx
        add r13.w, r13.w, -cb10[r9.w + 8].z
        ge r14.w, r13.w, l(0.000000)
        max r13.w, r5.w, |r13.w|
        movc r13.w, r14.w, r13.w, -r13.w
        ...
        div r13.w, r14.w, r13.w
        min r13.z, |r13.w|, r13.z
        add r27.x, r25.x, cb10[r9.w + 3].w
        add r27.yz, r25.yyzy, cb10[r9.w + 4].xxyx
        mad r19.yzw, r16.xxyz, r13.zzzz, r27.xxyz
        dp3 r13.w, r19.yzwy, r19.yzwy
        sqrt r13.w, r13.w
        div r13.z, r13.z, r13.w
        add r13.z, r13.z, r13.z
        ...
        ubfe r13.w, l(9), l(16), cb10[r9.w + 7].z
        utof r28.w, r13.w
        sample_l_indexable(texturecubearray)(float,float,float,float) r19.yzw, r28.xyzw, t8.wxyz, s2, r13.z
        dp3 r31.x, r25.xyzx, r27.xyzx
        dp3 r31.y, r25.xyzx, r29.xyzx
        dp3 r31.z, r25.xyzx, r30.xyzx
        mad_sat r25.xyz, r31.xyzx, cb10[r9.w + 3].xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
        mul r31.xy, r25.xyxx, cb10[r9.w + 4].zwzz
        mul r31.z, r25.z, cb10[r9.w + 5].x
        add r25.xyz, r31.xyzx, cb10[r9.w + 5].yzwy
        ...
        mul r13.z, r6.w, r9.w
        mul r19.yzw, r12.wwww, r19.yyzw
        dp3 r12.w, r19.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
        mad r9.w, r6.w, r9.w, r12.w
        div r9.w, r13.z, r9.w
...
if_nz r2.z
  ...
  mov r16.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r18.xyz, r16.xyzw, t8.xyzw, s2, r2.w
