...
mad r0.y, r0.y, r0.w, r5.z
mad r3.xyz, r3.xywx, r0.wwww, r14.xyzx
...
if_nz r1.w
  ...
  rsq r1.w, r1.w
  mul r7.xyz, r1.wwww, -v7.xyzx
  dp3 r10.x, r7.xyzx, v5.xyzx
  dp3 r10.y, r7.xyzx, v6.xyzx
  dp3 r1.w, r7.xyzx, v4.xyzx
  ...
  sincos r7.x, r10.x, r1.w
  mov r10.y, r10.x
  mov r10.z, r7.x
  dp2 r11.x, r10.yzyy, r5.zwzz
  mov r10.x, -r7.x
  dp2 r11.y, r10.xyxx, r5.zwzz
  mul r5.zw, cb0[13].xxxy, cb1[69].wwww
  mad r5.zw, r5.zzzw, cb0[13].zzzw, r11.xxxy
...
log r3.w, r3.w
mul r3.w, r3.w, cb0[18].y
exp r3.w, r3.w
movc r3.w, cb0[20].x, r3.w, r5.z
eq r5.z, cb0[18].y, l(0.000000)
movc r3.w, r5.z, l(1.000000), r3.w
...
frc r0.w, r0.w
mad r6.y, cb1[69].w, cb0[16].z, r0.w
mov r6.x, cb0[16].x
sample_l_indexable(texture2d)(float,float,float,float) r0.w, r6.xyxx, t26.yzwx, s7, l(0.000000)
log r0.w, |r0.w|
mul r0.w, r0.w, cb0[17].z
exp r0.w, r0.w
add r3.w, -cb0[17].x, cb0[17].y
mad r0.w, r0.w, r3.w, cb0[17].x
mul r4.xyz, r0.wwww, r4.xyzx
