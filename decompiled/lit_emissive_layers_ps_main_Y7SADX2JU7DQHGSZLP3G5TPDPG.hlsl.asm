...
add r2.w, r2.w, r2.w
mad r13.xyz, r3.xyzx, -r2.wwww, -r4.xyzx
...
if_nz r5.w
  ...
  mad r5.y, cb2[19].x, r5.w, -r3.w
  mad r3.w, r8.y, r5.y, r3.w
...
mad r6.z, r8.x, r1.z, r3.w
mul r1.z, r1.z, r6.z
mul r3.w, r3.w, r6.z
dp3 r6.z, r3.xyzx, cb2[17].xyzx
mov_sat r6.w, r6.z
...
if_nz r7.w
  ...
  if_nz r7.w
    ...
    if_nz r8.w
      ...
      mad r20.xyz, r3.xyzx, r9.wwww, v7.xyzx
    ...
    mad r16.xyz, r8.zzzz, r10.xyzx, r15.xyzx
    mad r12.yzw, -v7.xxyz, r0.yyyy, cb2[17].xxyz
    dp3 r0.y, r12.yzwy, r12.yzwy
    rsq r0.y, r0.y
    mul r12.yzw, r0.yyyy, r12.yyzw
    dp3 r0.y, r12.yzwy, r4.xyzx
    dp3 r8.z, r3.xyzx, r12.yzwy
    mad r8.w, |r8.z|, r2.w, -|r8.z|
    mad r8.z, |r8.z|, r8.w, l(1.000000)
    mad r6.w, r6.w, r1.z, r3.w
    mul r8.z, r8.z, r8.z
    mul r6.w, r6.w, r8.z
    rcp r6.w, r6.w
    mul r6.w, r7.w, r6.w
    ...
    mad r8.yzw, r6.wwww, r10.xxyz, r5.yyzw
    ...
    mov r10.zw, r8.yyyz
    mov r14.zw, r5.yyyz
    movc r10.xyzw, r6.zzzz, r10.xyzw, r14.xyzw
    movc r5.w, r6.z, r8.w, r5.w
    mov r14.z, r15.w
    mov r14.xy, r10.xyxx
    mov r5.yz, r10.zzwz
  endif 
          ...
          if_nz r26.w
            ...
            if_nz r26.w
              ...
              if_nz r26.w
                ...
                mad r41.xyz, r3.xyzx, r26.wwww, v7.xyzx
              ...
              if_nz r26.w
                ...
                if_nz r15.w
                  ...
                  mad r18.xyz, r3.xyzx, r27.wwww, v7.xyzx
          ...
          if_nz r18.x
            ...
            if_nz r18.x
              ...
              if_nz r18.x
                ...
                mad r21.xyz, r3.xyzx, r18.xxxx, v7.xyzx
...
mad r3.xyz, r28.xyzx, r9.xyzx, r3.xyzx
...
ret 
// Approximately 2401 instruction slots used
