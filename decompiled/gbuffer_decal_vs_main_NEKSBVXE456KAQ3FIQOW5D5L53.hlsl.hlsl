// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:28:38 2021
...
r0.w = volDecalInstanceBuffer[]..swiz;
  o10.xyzw = r0.xyzw;
  r0.zw = r0.xy + r0.zw;
  r0.xy = voldecalRevealTextureInfo.zw + r0.xy;
  r0.zw = -voldecalRevealTextureInfo.zw + r0.zw;
  r0.xyzw = max(voldecalRevealTextureInfo.zwzw, r0.xyzw);
  r1.xy = float2(1,1) + -voldecalRevealTextureInfo.zw;
  r0.xyzw = min(r1.xyxy, r0.xyzw);
  o11.xy = min(r0.xy, r0.zw);
  o11.zw = max(r0.xy, r0.zw);
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=200)(mixed,mixed,mixed,mixed) o12.xyzw, v1.x, l(176), t21.xyzw
r12.x = volDecalInstanceBuffer[]..swiz;
r12.y = volDecalInstanceBuffer[]..swiz;
r12.z = volDecalInstanceBuffer[]..swiz;
r12.w = volDecalInstanceBuffer[]..swiz;
  return;
}