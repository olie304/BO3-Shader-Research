...
add r1.w, -r0.x, cb1[63].x
mad r0.x, cb1[63].w, r1.w, r0.x
movc r2.yzw, v7.xxxx, r4.xxyz, -r4.xxyz
dp3 r1.w, r2.yzwy, r2.yzwy
rsq r1.w, r1.w
mad r2.yzw, r2.yyzw, r1.wwww, -r6.xxyz
...
utof r7.zw, r2.zzzy
dp2 r3.x, r7.wzww, l(0.06711056, 0.00583715, 0.000000, 0.000000)
frc r3.x, r3.x
mul r3.x, r3.x, l(52.982918)
frc r3.x, r3.x
mad r3.x, r3.x, l(6.28318548), cb1[70].w
sincos r9.x, r10.x, r3.x
dp2 r3.x, r7.zwzz, l(0.06711056, 0.00583715, 0.000000, 0.000000)
frc r3.x, r3.x
mul r3.x, r3.x, l(52.982918)
frc r3.x, r3.x
mad r3.x, r3.x, l(6.28318548), cb1[70].w
...
add r4.w, r4.w, r4.w
mad r12.xyz, r6.xyzx, -r4.wwww, -r8.xyzx
mul r4.w, r7.y, l(17.000000)
exp r13.x, r4.w
...
mad r8.w, r7.x, r7.z, r7.w
mul r7.zw, r7.zzzw, r8.wwww
min r8.w, |cb0[10].w|, l(1.000000)
add r2.x, -r0.y, r2.x
mad r0.y, r8.w, r2.x, r0.y
...
if_z r2.x
  ...
  if_nz r8.w
    ...
    loop 
      ...
      mul r10.w, r13.w, cb2[r13.z + 20].z
      lt r13.z, r10.w, l(1.000000)
      if_nz r13.z
        break 
      endif 
  ...
  if_z r13.z
    if_z cb2[58].y
      ...
      itof r13.z, cb2[26].y
      add r16.z, r8.w, r13.z
      sample_c_lz_indexable(texture2darray)(float,float,float,float) r13.z, r16.xyzx, t13.xxxx, s13, r2.x
    ...
    if_nz cb2[58].y
      ...
      loop 
        ...
        movc r17.w, r17.x, cb2[r8.w + 20].w, cb2[r13.z + 20].w
        movc r17.x, r17.x, r8.w, r13.z
        ...
        utof r18.z, r17.x
        sample_c_lz_indexable(texture2darray)(float,float,float,float) r17.x, r18.xyzx, t13.xxxx, s13, r2.x
      ...
      endloop 
      mul r2.x, r13.w, r13.w
      mul r13.y, r13.w, r2.x
    endif 
  endif 
endif 
...
if_nz r2.x
  ...
  mad r10.w, |r0.y|, l(-0.200000), l(0.400000)
  lt r13.z, r0.y, l(0.000000)
  movc r10.w, r13.z, -r10.w, r10.w
  mad r19.xyz, r6.xyzx, r10.wwww, v6.xyzx
  ...
  if_z r10.w
    ...
    if_nz cb2[58].y
      ...
      loop 
        ...
        sample_c_lz_indexable(texture2darray)(float,float,float,float) r15.w, r17.xyzx, t9.xxxx, s13, r2.x
        mad r13.z, r15.w, l(0.125000), r13.z
        iadd r13.w, r13.w, l(1)
      endloop 
    else 
      utof r15.z, r10.w
      sample_c_lz_indexable(texture2darray)(float,float,float,float) r13.z, r15.xyzx, t9.xxxx, s13, r2.x
    endif 
    mul r2.x, r13.z, r13.z
    mul r2.x, r13.z, r2.x
  else 
    mov r2.x, l(1.000000)
  endif 
...
if_nz r2.x
  ...
  if_nz r2.x
    mul r2.x, r4.w, cb2[18].w
    mul r2.x, r2.x, l(0.250000)
    if_nz cb2[23].x
      mov r14.w, l(1.000000)
      dp4 r8.w, cb2[24].xyzw, r14.xyzw
      dp4 r10.w, cb2[25].xyzw, r14.xyzw
      frc r15.x, r8.w
      frc r15.y, r10.w
    ...
    mad r8.w, -|r0.y|, r8.w, l(1.000000)
    mul r8.w, r8.w, r8.w
    mad r8.w, -r8.w, l(0.620000), l(0.620000)
    add r8.w, -|r0.y|, r8.w
    mad r8.w, r5.w, r8.w, |r0.y|
    lt r10.w, l(0.000000), r0.y
    mov_sat r0.y, r0.y
    mad r16.xyz, -v6.xyzx, r2.wwww, cb2[17].xyzx
    dp3 r2.w, r16.xyzx, r16.xyzx
    rsq r2.w, r2.w
    mul r16.xyz, r2.wwww, r16.xyzx
    dp3 r2.w, r6.xyzx, r16.xyzx
    dp3 r13.z, r16.xyzx, r8.xyzx
    mul r13.w, r9.w, r9.z
    sqrt r13.w, r13.w
    dp3 r14.w, r16.xyzx, r5.xyzx
    dp3 r15.w, r16.xyzx, r3.yzwy
    mul r14.w, r14.w, r14.w
    div r14.w, r14.w, r9.z
    mul r15.w, r15.w, r15.w
    div r15.w, r15.w, r9.w
    add r14.w, r14.w, r15.w
    mad r2.w, |r2.w|, |r2.w|, r14.w
    mad r14.w, r0.y, r7.z, r7.w
    mul r2.w, r2.w, r2.w
    mul r2.w, r13.w, r2.w
    mul r2.w, r14.w, r2.w
    rcp r2.w, r2.w
    mul r0.y, r2.x, r0.y
    mul r0.y, r0.y, r2.w
    add_sat r2.x, -r13.z, l(1.000000)
    mul r2.w, r2.x, r2.x
    mul r2.w, r2.w, r2.w
    mul r2.x, r2.w, r2.x
    mul r2.x, r0.y, r2.x
    and r2.w, r8.w, r10.w
    movc r16.xyz, r10.wwww, l(0,0,0,0), r8.wwww
    and r13.zw, r2.xxxx, r10.wwww
    and r17.xyz, r0.yyyy, r10.wwww
...
mul r10.w, r1.w, l(0.00781250)
min r10.w, r10.w, l(15.000000)
ftou r10.w, r10.w
ushr r19.xy, r2.yzyy, l(6, 6, 0, 0)
ishl r19.z, r10.w, l(4)
mov r20.x, -r9.x
mad r2.y, -r7.x, l(0.500000), l(1.000000)
mul r2.z, r9.w, r9.z
sqrt r2.z, r2.z
...
mov r10.w, l(0)
loop 
  uge r14.w, r10.w, cb2[0].x
  breakc_nz r14.w
  ushr r21.z, r10.w, l(5)
        ...
        if_nz r32.w
          ...
          if_nz r30.w
            ...
            if_nz r30.w
              ...
              mad r61.xyz, r6.xyzx, r30.wwww, v6.xyzx
            ...
            if_nz r60.w
              ...
              mad r24.xyz, r6.xyzx, r33.wwww, v6.xyzx
            ...
            if_nz r24.y
              ...
              mad r28.w, -|r31.w|, r2.y, l(1.000000)
              mul r28.w, r28.w, r28.w
              mad r28.w, -r28.w, l(0.620000), l(0.620000)
              add r28.w, -|r31.w|, r28.w
              mad r28.w, r5.w, r28.w, |r31.w|
              lt r29.w, l(0.000000), r31.w
              dp3_sat r30.w, r6.xyzx, r57.xyzx
              mad r56.xyz, r56.xyzx, r25.wwww, r8.xyzx
              dp3 r25.w, r56.xyzx, r56.xyzx
              rsq r25.w, r25.w
              mul r56.xyz, r25.wwww, r56.xyzx
              dp3 r25.w, r6.xyzx, r56.xyzx
              dp3 r31.w, r56.xyzx, r8.xyzx
              dp3 r32.w, r56.xyzx, r5.xyzx
              dp3 r33.w, r56.xyzx, r3.yzwy
              mul r32.w, r32.w, r32.w
              div r32.w, r32.w, r9.z
              mul r33.w, r33.w, r33.w
              div r33.w, r33.w, r9.w
              add r32.w, r32.w, r33.w
              mad r25.w, |r25.w|, |r25.w|, r32.w
              mad r32.w, r30.w, r7.z, r7.w
              mul r25.w, r25.w, r25.w
              mul r25.w, r2.z, r25.w
        ...
        if_nz r25.w
          ...
          if_nz r28.w
            ...
            if_nz r28.w
              ...
              mad r26.xyz, r6.xyzx, r28.wwww, v6.xyzx
            ...
            if_nz r49.y
              ...
              mad r27.xyz, r6.xyzx, r26.yyyy, v6.xyzx
            ...
            if_nz r26.x
              mul r26.x, r4.w, r50.x
              mul r26.x, r26.x, l(0.250000)
              mad r26.y, -|r24.y|, r2.y, l(1.000000)
              mul r26.y, r26.y, r26.y
              mad r26.y, -r26.y, l(0.620000), l(0.620000)
              add r26.y, -|r24.y|, r26.y
              mad r26.y, r5.w, r26.y, |r24.y|
              lt r27.x, l(0.000000), r24.y
              mov_sat r24.y, r24.y
              mad r49.xyz, r56.xyzx, r24.xxxx, r8.xyzx
              dp3 r24.x, r49.xyzx, r49.xyzx
              rsq r24.x, r24.x
              mul r49.xyz, r24.xxxx, r49.xyzx
              dp3 r24.x, r6.xyzx, r49.xyzx
              dp3 r27.y, r49.xyzx, r8.xyzx
              dp3 r27.z, r49.xyzx, r5.xyzx
              dp3 r28.w, r49.xyzx, r3.yzwy
              mul r27.z, r27.z, r27.z
              div r27.z, r27.z, r9.z
              mul r28.w, r28.w, r28.w
              div r28.w, r28.w, r9.w
              add r27.z, r27.z, r28.w
              mad r24.x, |r24.x|, |r24.x|, r27.z
              mad r27.z, r24.y, r7.z, r7.w
              mul r24.x, r24.x, r24.x
              mul r24.x, r2.z, r24.x
...
frc r0.y, r0.y
mul r2.w, r0.y, l(3.141600)
mad r2.w, cb1[70].w, l(0.500000), r2.w
...
add r2.w, r2.w, l(3.141600)
sincos r11.x, r14.x, r2.w
...
dp2 r2.w, cb1[44].zwzz, cb1[44].zwzz
sqrt r2.w, r2.w
dp2 r3.x, r10.xyxx, r10.xyxx
sqrt r3.x, r3.x
rcp r3.x, r3.x
mul r2.w, r2.w, r3.x
...
movc r3.z, r3.z, r5.x, l(1.000000)
mov x0[0].x, r3.z
mov x1[1].x, r3.y
...
ftoi r11.xy, r5.xyxx
mov r11.zw, l(0,0,0,0)
ld_indexable(texture2d)(float,float,float,float) r5.x, r11.xyzw, t0.xyzw
ge r5.y, r5.x, l(0.984375)
mul r7.z, r5.x, l(1.01587307)
mad r5.x, r5.x, l(64.000000), l(-63.000000)
movc r5.x, r5.y, r5.x, r7.z
...
movc r3.w, r3.w, r5.y, l(1.000000)
mov x0[1].x, r3.w
add r5.y, r3.w, r3.z
ne r5.y, r5.y, l(0.000000)
if_nz r5.y
  mad r5.yw, r0.yyyy, l(0.000000, 0.500000, 0.000000, 0.500000), l(0.000000, 1.33333337, 0.000000, 2.000000)
  mul r5.yw, r5.yyyw, l(0.000000, 0.11764706, 0.000000, 0.11764706)
  mad r5.yw, r5.yyyw, r5.yyyw, -r3.xxxy
  mad r3.x, r3.z, r5.y, r3.x
  mov x1[0].x, r3.x
  mad r11.xyz, r10.xyzx, r3.xxxx, r9.xyzx
  lt r3.x, r2.w, r3.x
  mul r7.zw, r11.xxxy, cb1[44].xxxy
  ftoi r13.xy, r7.zwzz
  mov r13.zw, l(0,0,0,0)
  ld_indexable(texture2d)(float,float,float,float) r5.y, r13.xyzw, t0.yxzw
  ge r7.z, r5.y, l(0.984375)
  mul r7.w, r5.y, l(1.01587307)
  mad r5.y, r5.y, l(64.000000), l(-63.000000)
  movc r5.y, r7.z, r5.y, r7.w
  max r5.y, r5.y, l(0.00000001)
  rcp r5.y, r5.y
  movc r4.w, r3.x, r5.y, r4.w
  mov x2[0].x, r4.w
  add r4.w, r5.y, l(0.042000)
  mul r4.w, r4.w, r11.z
  ...
  mov x1[1].x, r3.y
  mad r11.xyz, r2.xyzx, r3.yyyy, r9.xyzx
  lt r3.y, r2.w, r3.y
  mul r5.yw, r11.xxxy, cb1[44].xxxy
  ftoi r13.xy, r5.ywyy
  mov r13.zw, l(0,0,0,0)
  ld_indexable(texture2d)(float,float,float,float) r3.z, r13.xyzw, t0.yzxw
  ge r4.w, r3.z, l(0.984375)
  mul r5.y, r3.z, l(1.01587307)
  mad r3.z, r3.z, l(64.000000), l(-63.000000)
  movc r3.z, r4.w, r3.z, r5.y
  max r3.z, r3.z, l(0.00000001)
  rcp r3.z, r3.z
  movc r4.w, r3.y, r3.z, r5.x
  mov x2[1].x, r4.w
  add r3.z, r3.z, l(0.042000)
  mul r3.z, r3.z, r11.z
...
if_z r3.x
  ...
  mov r3.z, x1[0].x
  mov r3.w, x0[0].x
  mad r3.x, r3.x, r3.x, -r3.z
  mad r3.x, r3.w, r3.x, r3.z
  mov x1[0].x, r3.x
  mad r5.xyw, r10.xyxz, r3.xxxx, r9.xyxz
  lt r3.x, r2.w, r3.x
  mul r5.xy, r5.xyxx, cb1[44].xyxx
...
if_z r3.x
  ...
  mov r0.y, x1[0].x
  mov r3.z, x0[0].x
  mad r3.x, r3.x, r3.x, -r0.y
  mad r0.y, r3.z, r3.x, r0.y
  mad r5.xyw, r10.xyxz, r0.yyyy, r9.xyxz
  lt r0.y, r2.w, r0.y
  mul r3.xw, r5.xxxy, cb1[44].xxxy
  ftoi r10.xy, r3.xwxx
  mov r10.zw, l(0,0,0,0)
  ld_indexable(texture2d)(float,float,float,float) r3.x, r10.xyzw, t0.xyzw
  ge r3.w, r3.x, l(0.984375)
  mul r4.w, r3.x, l(1.01587307)
  mad r3.x, r3.x, l(64.000000), l(-63.000000)
  movc r3.x, r3.w, r3.x, r4.w
  max r3.x, r3.x, l(0.00000001)
  rcp r3.x, r3.x
  mov r3.w, x2[0].x
  movc r3.w, r0.y, r3.x, r3.w
  mov x2[0].x, r3.w
  ...
  mul r3.x, r3.x, r3.z
  movc r0.y, r0.y, r3.x, r3.z
  mov x0[0].x, r0.y
  mov r0.y, x1[1].x
  mov r3.x, x0[1].x
  mad r3.y, r3.y, r3.y, -r0.y
  mad r0.y, r3.x, r3.y, r0.y
  mad r2.xyz, r2.xyzx, r0.yyyy, r9.xyzx
  lt r0.y, r2.w, r0.y
  mul r2.xy, r2.xyxx, cb1[44].xyxx
  ftoi r9.xy, r2.xyxx
  mov r9.zw, l(0,0,0,0)
  ld_indexable(texture2d)(float,float,float,float) r2.x, r9.xyzw, t0.xyzw
...
movc r0.y, r0.y, l(0.500000), r2.x
mov r2.x, x2[1].x
add r2.x, -r5.z, r2.x
...
mad r2.w, r0.y, l(5.000000), l(-2.500000)
...
loop 
  ...
  ld_indexable(texture2darray)(uint,uint,uint,uint) r7.z, r11.xyzw, t7.yzxw
...
if_z r4.w
      ...
      if_nz r13.w
        ...
        if_nz r11.z
          ...
          if_nz r13.x
            ...
            sqrt r11.z, r11.z
            mad r11.z, r0.y, l(5.000000), r11.z
        ...
        if_nz r15.w
          ...
          if_nz r15.z
            ...
            if_nz r15.z
              ...
              sqrt r14.w, r14.w
              mad r14.w, r0.y, l(5.000000), r14.w
  ...
  if_nz r2.w
    ...
    mad r0.y, r7.y, r0.y, r3.w
    mad r20.xyz, r6.xyzx, r0.yyyy, r20.xyzx
  endif 
else 
  mov r20.x, r18.w
endif 
mad r3.xyz, r18.xyzx, r0.xxxx, r3.xyzx
mad r5.xyz, r18.xyzx, r0.xxxx, r5.xyzx
...
ret 
// Approximately 2690 instruction slots used
