...
void main( 
  ...
  out uint2 o11 : TEXCOORD13,
  out float p11 : TEXCOORD0)
{
...
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=200)(mixed,mixed,mixed,mixed) r0.xyzw, v1.x, l(128), t21.xywz
r0.x = volDecalInstanceBuffer[]..swiz;
r0.y = volDecalInstanceBuffer[]..swiz;
r0.z = volDecalInstanceBuffer[]..swiz;
r0.w = volDecalInstanceBuffer[]..swiz;
...
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=200)(mixed,mixed,mixed,mixed) r0.xy, v1.x, l(192), t21.xyxx
r0.x = volDecalInstanceBuffer[]..swiz;
r0.y = volDecalInstanceBuffer[]..swiz;
  o11.xyz = r0.zyx;
  return;
