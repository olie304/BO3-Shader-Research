...
dcl_output o2.xyzw
dcl_temps 9
mul r0.xy, v1.yzyy, cb0[13].zwzz
sample_indexable(texture2d)(float,float,float,float) r0.x, r0.xyxx, t20.xyzw, s6
sample_indexable(texture2d)(float,float,float,float) r0.yzw, v1.yzyy, t11.wxyz, s4
...
sample_indexable(texture2d)(float,float,float,float) r3.w, v1.yzyy, t14.yzwx, s5
