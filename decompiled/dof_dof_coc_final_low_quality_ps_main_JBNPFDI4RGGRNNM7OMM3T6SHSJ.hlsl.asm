...
sample_indexable(texture2d)(float,float,float,float) r0.w, v0.xyxx, t6.yzwx, s1
lt r1.x, l(0.000000), r0.w
if_nz r1.x
  sample_indexable(texture2d)(float,float,float,float) r1.xyz, v0.xyxx, t7.xyzw, s1
  mul r1.w, r0.w, cb8[16].x
  mov_sat r1.w, r1.w
  mad_sat r0.w, r0.w, cb8[16].y, cb8[16].z
  add r2.x, -r1.w, l(1.000000)
  mul r1.w, r1.w, l(0.250000)
  add r2.yz, v0.xxyx, v1.xxyx
  sample_l_indexable(texture2d)(float,float,float,float) r3.xyz, r2.yzyy, t0.xyzw, s1, l(0.000000)
  sample_l_aoffimmi_indexable(1,0,0)(texture2d)(float,float,float,float) r4.xyz, r2.yzyy, t0.xyzw, s1, l(0.000000)
  add r3.xyz, r3.xyzx, r4.xyzx
  sample_l_aoffimmi_indexable(1,1,0)(texture2d)(float,float,float,float) r4.xyz, r2.yzyy, t0.xyzw, s1, l(0.000000)
  add r3.xyz, r3.xyzx, r4.xyzx
  sample_l_aoffimmi_indexable(0,1,0)(texture2d)(float,float,float,float) r2.yzw, r2.yzyy, t0.wxyz, s1, l(0.000000)
  add r2.yzw, r2.yyzw, r3.xxyz
  mul r2.yzw, r1.wwww, r2.yyzw
  mad r2.xyz, r0.xyzx, r2.xxxx, r2.yzwy
