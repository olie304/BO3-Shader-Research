...
// ------------------------------ ---------- ------- ----------- -------------- ------
// lensFlarePixelCount                   UAV  struct         r/w             u6      1 
// lensFlareTotalAlpha                   UAV  struct         r/w             u7      1 
...
dcl_temps 1
dcl_thread_group 768, 1, 1
imad r0.x, cb8[16].x, l(768), vThreadIDInGroup.x
store_structured u7.x, r0.x, l(0), l(0)
store_structured u6.x, r0.x, l(0), l(0)
ret 
