...
add r5.yzw, v5.xxyz, -cb2[35].xxyz
...
if_nz r6.z
  ...
  if_nz r6.z
    ...
    mul r8.z, r4.w, r8.z
    if_nz cb2[23].x
      add r9.xyz, v5.xyzx, cb1[24].xyzx
      mov r9.w, l(1.000000)
    ...
    if_nz r9.w
      ...
      mad r14.xyz, r2.xyzx, r14.xxxx, v5.xyzx
      ...
      if_nz r6.z
        ...
        mad r14.xyz, r2.xyzx, r9.wwww, v5.xyzx
        mov r14.w, l(1.000000)
        dp4 r10.x, r10.xyzw, r14.xyzw
        dp4 r10.y, r11.xyzw, r14.xyzw
        mad r10.xy, r10.xyxx, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
    ...
    mad r11.xyz, -v5.xyzx, r0.wwww, cb2[17].xyzx
