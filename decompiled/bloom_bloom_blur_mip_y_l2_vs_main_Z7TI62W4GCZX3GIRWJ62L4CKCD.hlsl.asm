...
//   float4 postFxBloom21;              // Offset: 1616 Size:    16
...
dcl_constantbuffer CB8[102], immediateIndexed
...
utof r0.x, r0.x
mul r0.y, cb8[101].w, cb8[101].y
mul r0.x, r0.x, r0.y
mul o1.xyzw, r0.xxxx, l(1.593200, 0.967400, 0.589500, 0.282200)
