...
//   float4 postFxBloom23;              // Offset: 1648 Size:    16
...
dcl_constantbuffer CB8[104], immediateIndexed
...
utof r0.x, r0.x
mul r0.y, cb8[103].w, cb8[103].y
mul r0.x, r0.x, r0.y
mul o1.xyzw, r0.xxxx, l(1.768800, 1.198400, 0.869400, 0.615100)
mul o2.xy, r0.xxxx, l(0.395700, 0.194000, 0.000000, 0.000000)
