...
sample_indexable(texture2d)(float,float,float,float) r4.xyz, r3.xyxx, t26.xyzw, s5
...
mad r2.xy, r3.zwzz, cb0[11].zzzz, r1.yzyy
...
rsq r1.y, r1.y
mul r2.xyz, r1.yyyy, r2.xyzx
sample_indexable(texture2d)(float,float,float,float) r1.y, r3.xyxx, t29.yxzw, s1
add r1.y, r1.y, l(-1.000000)
mad r1.y, cb0[11].z, r1.y, l(1.000000)
sample_indexable(texture2d)(float,float,float,float) r1.w, v1.yzyy, t3.yzwx, s1
add r1.w, -r1.w, l(1.000000)
mul r3.xyz, r1.wwww, l(1.000000, 0.500000, 0.500000, 0.000000)
...
if_nz cb0[11].w
  ...
  sqrt r5.x, r5.x
  mad r5.y, |r1.w|, l(-0.01872930), l(0.074261)
  mad r5.y, r5.y, |r1.w|, l(-0.21211439)
...
if_nz r6.y
  mad r6.yw, r3.wwww, l(0.000000, 0.500000, 0.000000, 0.500000), l(0.000000, 1.33333337, 0.000000, 2.000000)
...
if_z r4.y
  ...
  mad r6.xyw, r8.xyxz, r3.wwww, r7.xyxz
  lt r3.w, r4.x, r3.w
  ...
  mad r1.xzw, r1.xxzw, r3.wwww, r7.xxyz
  lt r3.w, r4.x, r3.w
...
mad r8.xy, -r3.wwww, l(10.000000, 5.000000, 0.000000, 0.000000), l(6.857410, 7.085000, 0.000000, 0.000000)
exp r5.w, r8.x
mul r5.w, r5.w, r5.x
...
max r3.w, r19.w, l(1.000000)
rcp r3.w, r3.w
mov_sat r19.w, r19.w
mul r8.xyz, r3.wwww, r18.xyzx
mul r9.xyz, r3.wwww, r19.xyzx
lt r5.z, r19.w, l(0.990000)
if_nz r5.z
  add r5.z, -r19.w, l(1.000000)
  ...
  mad r8.xyz, r18.xyzx, r3.wwww, r2.xyzx
  mov r11.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r2.xyz, r11.xyzw, t8.xyzw, s2, r4.w
  mad r3.w, cb2[19].x, r5.z, -r2.w
...
mov o2.w, r0.x
ret 
// Approximately 3567 instruction slots used
