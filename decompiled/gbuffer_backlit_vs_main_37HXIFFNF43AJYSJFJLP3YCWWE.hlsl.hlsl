// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:26:27 2021
...
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r0.z, v7.x, l(12), t4.xxxx
...
r0.z = gpuSkinBase[]..swiz;
  r1.xyz = eyeOffset.xyz + r8.xyz;
  r1.w = weather.windSpeed * gameTime.w;
  r2.x = 0.899999976 * r1.w;
  r2.y = gameTime.w * weather.windSpeed + 0.5;
  r2.z = 0.699999988 * r2.y;
  r1.w = r1.w * 0.899999976 + r1.x;
  r1.w = 0.699999988 * r1.w;
  r1.w = sin(r1.w);
  r2.y = r2.y * 0.699999988 + r1.x;
  r2.y = 0.699999988 * r2.y;
  r2.y = cos(r2.y);
