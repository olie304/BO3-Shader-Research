...
eq r10.xyz, v2.wwww, l(3.000000, 2.000000, 1.000000, 0.000000)
...
exp r2.y, r2.y
movc r2.y, cb0[13].y, r2.y, r4.x
eq r4.x, cb0[12].x, l(0.000000)
movc r2.y, r4.x, l(1.000000), r2.y
mul r1.z, r1.z, r3.w
mul r1.z, r2.y, r1.z
mul r1.z, r2.x, r1.z
...
dp3_sat r1.x, r7.xyzx, r11.xyzx
dp3 r2.y, -r11.xyzx, r7.xyzx
add r2.y, r2.y, r2.y
mad r12.xyz, r7.xyzx, -r2.yyyy, -r11.xyzx
    ...
    loop 
      ...
      if_nz r17.w
        ...
        if_nz r17.z
          ...
          and r23.w, r17.z, l(1)
          movc r28.xy, r23.wwww, r15.xyxx, r15.zxzz
          mov r15.x, r17.z
          mov r29.xy, r28.xyxx
          mov r23.w, l(1)
          loop 
...
if_nz r4.w
  ...
  mad r10.yzw, r14.xxyz, r2.wwww, r10.yyzw
endif 
...
if_nz r5.w
  ...
  if_nz r5.w
    ...
    mad r16.xyz, r4.wwww, r8.xyzx, r10.yzwy
    add_sat r1.w, -r1.w, l(1.000000)
    mul r5.w, r1.w, r1.w
    mul r5.w, r5.w, r5.w
    mul r1.w, r1.w, r5.w
    mul r1.w, r1.w, r4.w
    mad r8.xyz, r1.wwww, r8.yzxy, r14.xyzx
    mov r15.w, r8.z
    mov r13.w, r14.z
          ...
          if_nz r14.w
            ...
            if_nz r14.w
              ...
              if_nz r14.w
                ...
                mad r19.xyz, r19.xyzx, r11.wwww, r11.xyzx
                dp3 r11.w, r19.xyzx, r19.xyzx
                rsq r11.w, r11.w
                mul r19.xyz, r11.wwww, r19.xyzx
                dp3 r11.w, r19.xyzx, r11.xyzx
