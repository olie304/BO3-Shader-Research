  ...
  out float3 o0 : SV_TARGET0)
{
  ...
  r1.xyz = postFxConst12.xyz * r0.www;
  r1.xyz = r0.www * postFxConst11.xyz + r1.xyz;
  r2.xyzw = codeTexture1.Sample(biLinearClamp_s, v0.xy).xyzw;
  r1.xyz = r2.www * postFxConst13.xyz + r1.xyz;
  r3.xyz = postFxConst09.xyz * r0.xyz;
  r0.xyz = r0.xyz * postFxConst08.xyz + r3.xyz;
  r0.xyz = r1.xyz + r0.xyz;
  r0.xyz = r2.xyz * postFxConst10.xyz + r0.xyz;
  o0.xyz = min(float3(65504,65504,65504), r0.xyz);
  return;
}