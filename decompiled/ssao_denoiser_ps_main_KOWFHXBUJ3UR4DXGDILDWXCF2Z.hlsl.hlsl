  ...
  out float o0 : SV_TARGET0)
{
  ...
  if (r2.x != 0) {
    ...
    r2.xz = -r0.xy * r1.zy + v1.yx;
    r3.xy = velocityTex1.SampleLevel(linearSampler_s, r2.zx, 0).xy;
    r3.zw = float2(-0.5,-0.5) + abs(r3.xy);
    r3.zw = saturate(r3.zw + r3.zw);
    r4.xy = abs(r3.xy) + abs(r3.xy);
    r4.xy = min(float2(1,1), r4.xy);
    r4.xy = float2(10,10) * r4.xy;
    r3.zw = r3.zw * float2(30,30) + r4.xy;
    r3.xy = cmp(r3.xy >= float2(0,0));
    r3.xy = r3.xy ? r3.zw : -r3.zw;
    r0.xy = -r0.xy * r3.yx + r2.xz;
    r4.xyzw = aoHistoryTex2.Gather(linearSampler_s, r0.yx).xyzw;
    r0.xy = r0.xy * renderTargetSize.yx + float2(-0.498046875,-0.498046875);
    r5.xy = (int2)r0.yx;
    r6.xy = (int2)r5.yx + int2(1,1);
    r5.z = r6.x;
    r5.w = 0;
    r2.x = depthTex2.Load(r5.xzw).x;
    r6.z = 0;
    r2.z = depthTex2.Load(r6.yxz).x;
    r6.w = r5.y;
    r2.w = depthTex2.Load(r6.ywz).x;
    r3.z = depthTex2.Load(r5.xyw).x;
    r3.w = dot(r1.yz, r1.yz);
    r5.x = dot(r3.xy, r3.xy);
    r3.w = max(r5.x, r3.w);
    r3.w = (uint)r3.w >> 1;
    r3.w = (int)r3.w + 0x1fbd1df5;
    r5.x = saturate(r3.w);
    r5.y = postFxControl1.x + -postFxControl1.y;
    r5.x = r5.x * r5.y + postFxControl1.y;
    r3.w = saturate(40 + -r3.w);
    r3.w = r5.x * r3.w;
    r0.xy = frac(r0.xy);
    r5.xy = float2(1,1) + -r0.yx;
    r5.z = r0.y * r0.x;
    r0.xy = r5.xy * r0.xy;
    r5.x = r5.x * r5.y;
    r2.xz = -r2.xz + r1.ww;
    r2.x = saturate(-r2.y * r2.x + 1);
    r4.xyzw = r4.xyzw + -r1.xxxx;
    r2.x = r2.x * r4.x + r1.x;
    r2.z = saturate(-r2.y * r2.z + 1);
    r2.z = r2.z * r4.y + r1.x;
    r2.z = r5.z * r2.z;
    r0.x = r0.x * r2.x + r2.z;
    r2.x = -r2.w + r1.w;
    ...
    r2.xyzw = renderTargetSize.zwzw * float4(-0.5,0.5,0.5,-0.5) + v1.xyxy;
    r0.w = aoTex.SampleLevel(linearSampler_s, r2.xy, 0).x;
    r1.w = aoTex.SampleLevel(linearSampler_s, r2.zw, 0).x;
    r2.x = min(r1.w, r0.w);
    r2.x = min(r2.x, r0.z);
    r2.x = min(r2.x, r0.y);
    r2.x = min(r2.x, r1.x);
