...
loop 
  ...
  if_nz r18.w
    ...
    add r16.yzw, r5.yyzw, -cb10[r17.w + 0].xxyz
...
bfi r8.w, l(8), l(0), r19.y, r23.w
movc r0.y, r0.y, r8.w, r19.y
max r8.w, r19.x, l(1.000000)
rcp r8.w, r8.w
mov_sat r19.x, r19.x
mul r15.xyz, r8.wwww, r24.xyzx
mul r16.xyz, r8.wwww, r25.xyzx
lt r12.w, r19.x, l(0.990000)
if_nz r12.w
  iadd r0.y, r0.y, l(256)
  add r12.w, -r19.x, l(1.000000)
  ...
  mad r15.xyz, r24.xyzx, r8.wwww, r17.xyzx
  mov r14.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r14.xyz, r14.xyzw, t8.xyzw, s2, r10.w
  mad r8.w, cb2[19].x, r12.w, -r11.w
  mad r8.w, r2.y, r8.w, r11.w
  mad r16.xyz, r14.xyzx, r8.wwww, r16.xyzx
endif 
...
mul r1.w, r4.y, r1.w
mul r14.xyz, r5.xxxx, r15.xyzx
and r16.xyz, r3.zzzz, r14.xyzx
  ...
  if_nz r1.w
    ...
    if_nz r10.w
      ...
      if_nz r1.z
        ...
        mad r19.xyz, r11.xyzx, r8.wwww, r5.yzwy
    ...
    mad r15.xyz, r15.xyzx, r5.xxxx, r19.xyzx
    mad r19.xyz, -r5.yzwy, r0.wwww, cb2[17].xyzx
    ...
    mad r2.yzw, r1.wwww, r18.xxyz, r13.yyzw
    add_sat r0.w, -r0.w, l(1.000000)
    mul r4.x, r0.w, r0.w
    mul r4.x, r4.x, r4.x
    mul r0.w, r0.w, r4.x
    mul r0.w, r0.w, r1.w
    mad r4.xyz, r0.wwww, r18.xyzx, r17.xzwx
...
add r1.z, r8.w, r1.z
mul r3.x, r4.y, r8.y
mad r3.x, r8.x, r3.y, r3.x
mad r3.x, r8.z, r7.y, r3.x
mad r1.w, r8.w, r1.w, r3.x
div r2.w, r1.w, r1.z
...
mad r3.xyw, r13.yzyw, r4.xyxz, r3.xyxw
mad r3.xyw, r14.xyxz, r6.xyxz, r3.xyxw
...
if_nz r1.z
  ...
  mad r6.xyzw, r1.wwww, r6.xyzw, cb2[4].xyzw
  mul r1.z, r1.z, r6.w
