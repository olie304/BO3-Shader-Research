...
round_ni r0.x, r0.x
resinfo_indexable(texture2d)(float,float,float,float) r0.yz, l(0), t0.zxyw
div r1.xy, cb3[0].xxxx, r0.yzyy
div r1.zw, v2.xxxy, r1.xxxy
round_ni r1.zw, r1.zzzw
add r0.xw, r0.xxxx, r1.zzzw
resinfo_indexable(texture2d)(float,float,float,float) r2.xy, l(0), t6.xyzw
div r0.xw, r0.xxxw, r2.xxxy
sample_indexable(texture2d)(float,float,float,float) r0.x, r0.xwxx, t6.yxzw, s1
mul r0.x, r0.x, r0.x
add r0.w, cb3[0].x, l(-1.000000)
mad r0.x, r0.x, r0.w, l(1.000000)
div r0.xy, r0.xxxx, r0.yzyy
mad r0.zw, -r1.zzzw, r1.xxxy, v2.xxxy
div r0.zw, r0.zzzw, r0.xxxy
round_ni r0.zw, r0.zzzw
mul r2.zw, r1.xxxy, r1.zzzw
mul r1.xy, r1.xyxx, cb3[2].xxxx
mad r0.xy, r0.xyxx, r0.zwzz, r2.zwzz
...
mad_sat r0.xy, r1.xyxx, r0.zwzz, r0.xyxx
