...
if_nz r8.w
  ...
  if_nz r8.w
      ...
      if_z r10.w
        ...
        if_nz cb2[58].y
          ...
          loop 
            ...
            sample_c_lz_indexable(texture2darray)(float,float,float,float) r19.w, r22.xyzx, t9.xxxx, s13, r10.w
            mad r14.w, r19.w, l(0.125000), r14.w
    ...
    mad r21.yzw, r4.zzzz, r19.xxyz, r15.xxyz
    add_sat r0.w, -r0.w, l(1.000000)
    mul r5.x, r0.w, r0.w
    mul r5.x, r5.x, r5.x
    mul r0.w, r0.w, r5.x
    mul r0.w, r0.w, r4.z
    mad r13.yzw, r0.wwww, r19.xxyz, r18.xxzw
    mad r19.xyz, r4.wwww, r19.xyzx, r17.zxyz
    and r19.xyz, r3.zzzz, r19.yzxy
    mov r20.w, r17.z
    mov r16.w, r19.z
    movc r16.xyzw, r4.yyyy, r20.xyzw, r16.xyzw
    mov r17.zw, r13.yyyz
    mov r19.zw, r18.xxxz
    movc r19.xyzw, r4.yyyy, r17.xyzw, r19.xyzw
    mov r21.x, r13.w
    mov r15.w, r18.w
    movc r15.xyzw, r4.yyyy, r21.yzwx, r15.xyzw
    if_nz r2.w
...
switch r4.y
  case l(4)
  if_nz r2.w
    add r19.yzw, cb1[24].xxyz, cb9[r0.x + 0].xxyz
    mov r19.x, l(2)
    store_structured u2.xyzw, cb2[52].x, l(136), r19.xyzw
  endif 
  iadd r4.y, r0.w, l(1)
  lt r4.z, l(0.000000), cb9[r0.x + 6].y
  mov r19.xy, cb9[r0.x + 5].zwzz
  mov r19.z, cb9[r0.x + 6].x
  mad r13.yzw, -r19.xxyz, l(0.000000, 0.500000, 0.500000, 0.500000), cb9[r0.x + 0].xxyz
  add r20.xyz, -r11.xyzx, r13.yzwy
  dp3 r4.w, r19.xyzx, r20.xyzx
  div_sat r5.x, -r4.w, cb9[r0.x + 6].y
  mad r21.xyz, r5.xxxx, r19.xyzx, r13.yzwy
  ...
  if_nz r10.w
    ...
    if_nz r10.w
      ...
      if_nz r10.w
        ...
        mad r13.yzw, r4.wwww, r19.xxyz, r13.yyzw
        ...
        if_nz r5.x
          ...
          lt r14.w, r8.w, l(0.000000)
          and r14.w, r3.z, r14.w
          movc r5.x, r14.w, -r5.x, r5.x
          mad r19.xyz, r12.xyzx, r5.xxxx, r11.xyzx
          mov r20.xyz, cb9[r4.w + 6].yzwy
          mov r20.w, cb9[r4.w + 7].x
          mov r19.w, l(1.000000)
          dp4 r5.x, r20.xyzw, r19.xyzw
          ...
          if_z r15.w
            ...
            div r19.xy, r20.xyxx, r14.wwww
            mad r19.xy, r19.xyxx, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
            add r20.x, r19.x, cb9[r4.w + 9].w
            add r20.y, r19.y, cb9[r4.w + 10].x
            mul r19.xy, r20.xyxx, cb9[r4.w + 9].yzyy
            div r19.zw, cb9[r4.w + 3].yyyy, cb9[r4.w + 8].yyyw
            ...
            if_z r16.w
              ...
              mad r20.x, r19.x, cb9[r4.w + 8].y, cb9[r4.w + 8].z
              mad r20.y, r19.y, cb9[r4.w + 8].w, cb9[r4.w + 9].x
          ...
          if_z r14.w
            ...
            if_nz cb2[58].y
              ...
              loop 
                ige r17.w, r16.w, l(8)
                breakc_nz r17.w
                dp2 r22.x, icb[r16.w + 0].yxyy, r19.xyxx
                dp2 r22.y, icb[r16.w + 0].yxyy, r19.yzyy
                mad r21.xy, r22.xyxx, cb9[r4.w + 3].yyyy, r20.xyxx
                sample_c_lz_indexable(texture2darray)(float,float,float,float) r17.w, r21.xyzx, t9.xxxx, s13, r5.x
                mad r15.w, r17.w, l(0.125000), r15.w
                iadd r16.w, r16.w, l(1)
              endloop 
            else 
        ...
        mad r20.xyz, r4.wwww, r19.xyzx, r16.xyzx
        ...
        mul r8.w, r8.w, r9.w
        mul r8.w, r7.w, r8.w
        mad r13.yzw, r8.wwww, r19.xxyz, r15.xxyz
        ...
        mad r19.xyz, r4.wwww, r19.xyzx, r17.zxyz
        movc r19.xyz, r3.zzzz, r19.xyzx, r17.zxyz
        movc r16.xyz, r5.xxxx, r20.xyzx, r16.xyzx
        movc r17.xyz, r5.xxxx, r17.xyzx, r19.yzxy
        movc r18.xzw, r5.xxxx, r14.xxyz, r18.xxzw
        movc r15.xyz, r5.xxxx, r13.yzwy, r15.xyzx
        if_nz r2.w
    ...
    if_nz r8.w
      ...
      if_nz r8.w
        ...
        if_nz r12.w
          ...
          mad r20.x, r19.x, cb9[r0.x + 8].y, cb9[r0.x + 8].z
          mad r20.y, r19.y, cb9[r0.x + 8].w, cb9[r0.x + 9].x
          div r8.w, r8.w, r11.w
      ...
      if_nz r9.w
        ...
        if_nz r12.w
          ...
          lt r14.w, r4.w, l(0.000000)
          and r14.w, r3.z, r14.w
          movc r12.w, r14.w, -r12.w, r12.w
          mad r19.xyz, r12.xyzx, r12.wwww, r11.xyzx
          ...
          if_z r15.w
            ...
            div r19.xy, r20.xyxx, r14.wwww
            mad r19.xy, r19.xyxx, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
            add r20.x, r19.x, cb9[r11.w + 9].w
            add r20.y, r19.y, cb9[r11.w + 10].x
            mul r19.xy, r20.xyxx, cb9[r11.w + 9].yzyy
            ...
            if_z r16.w
              mov_sat r19.xy, r19.xyxx
              mad r20.x, r19.x, cb9[r11.w + 8].y, cb9[r11.w + 8].z
              mad r20.y, r19.y, cb9[r11.w + 8].w, cb9[r11.w + 9].x
          ...
          if_nz r1.z
            ...
            mad r19.xyz, r12.xyzx, r1.zzzz, r11.xyzx
        ...
        mad r19.xyz, r0.xxxx, r13.yzwy, r16.xyzx
        ...
        mad r4.xzw, r1.wwww, r13.yyzw, r15.xxyz
        add_sat r2.x, -r2.x, l(1.000000)
        mul r2.y, r2.x, r2.x
        mul r2.y, r2.y, r2.y
        mul r2.x, r2.y, r2.x
        mul r1.w, r1.w, r2.x
        mad r2.xyz, r1.wwww, r13.yzwy, r18.xzwx
        mad r5.xyz, r0.xxxx, r13.yzwy, r17.zxyz
        movc r5.xyz, r3.zzzz, r5.xyzx, r17.zxyz
        movc r16.xyz, r1.zzzz, r19.xyzx, r16.xyzx
        movc r17.xyz, r1.zzzz, r17.xyzx, r5.yzxy
        movc r18.xzw, r1.zzzz, r2.xxyz, r18.xxzw
        movc r15.xyz, r1.zzzz, r4.xzwx, r15.xyzx
        if_nz r2.w
...
ret 
// Approximately 1581 instruction slots used
