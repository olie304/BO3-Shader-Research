...
r0.w = modelInstanceBuffer[]..swiz;
  ...
  o2.xy = -filterTap[0].xy + v1.xy;
  o3.xy = filterTap[1].xy + v1.xy;
  o4.xy = -filterTap[1].xy + v1.xy;
  o5.xy = filterTap[2].xy + v1.xy;
  o6.xy = -filterTap[2].xy + v1.xy;
  o7.xy = filterTap[3].xy + v1.xy;
  o8.xy = -filterTap[3].xy + v1.xy;
  return;
}