  ...
  out float2 o3 : SV_TARGET3)
{
  ...
  r1.w = specColorMap.Sample(specColorSampler_s, r2.xw).x;
  r4.xyz = float3(-0.0399999991,-0.0399999991,-0.0399999991) + specColorTint.xyz;
  r4.xyz = r1.www * r4.xyz + float3(0.0399999991,0.0399999991,0.0399999991);
  ...
  r2.yz = v3.yx + r2.yz;
  r2.yz = r2.yz + r0.ww;
  r5.xy = detailScale1.xy * r2.yz;
  r5.zw = detailScale1.xy * v2.xy;
  r5.xy = useUVOffsets1 ? r5.xy : r5.zw;
  ...
  r12.xy = useUVOffsets1 * v2.xy;
  r2.yz = useUVOffsets1 ? r2.yz : r12.xy;
  ...
  r3.w = min(1, r3.w);
  r7.w = r4.w * detailScaleHeight1 + r0.z;
  r1.xy = r5.xy * detailScaleHeight2 + r0.xy;
  r0.x = dot(r1.xyz, r1.xyz);
  r0.x = rsqrt(r0.x);
  r5.xyz = r1.xyz * r0.xxx;
  r5.w = r3.w * detailScaleHeight2 + r0.z;
  r5.xyzw = r5.xyzw + -r7.xyzw;
  r5.xyzw = r2.yyyy * r5.xyzw + r7.xyzw;
  r0.x = -17 * r0.w;
  r0.x = exp2(r0.x);
  r0.x = r5.w + r0.x;
  r0.x = log2(r0.x);
  ...
  if (r1.y != 0) {
    ...
    r3.xyz = r1.zzz ? r5.xyw : r6.xyz;
  }
  r1.yzw = debugColorOverride.xyz + -r3.xyz;
  o0.xyz = debugColorOverride.www * r1.yzw + r3.xyz;
  r1.yzw = debugSpecularOverride.xyz + -r4.xyz;
  r1.yzw = debugSpecularOverride.www * r1.yzw + r4.xyz;
  r1.x = r1.x * 1 + -r0.x;
  r0.x = debugGlossOverride.w * r1.x + r0.x;
  r1.x = debugOcclusionOverride.x + -r2.z;
  o2.z = debugOcclusionOverride.w * r1.x + r2.z;
  r2.yzw = v4.xyz * r2.www + -r0.yzw;
  r3.yzw = debugNormalOverride.www * r2.yzw + r0.yzw;
  r0.yz = v7.xy / v7.ww;
  r2.yz = float2(0.5,0.5) * renderTargetSize.xy;
  r4.x = r2.y * r0.y;
  r4.y = -r2.z * r0.z;
  r0.yz = renderTargetSize.xy * float2(0.5,0.5) + r4.xy;
  r0.yz = v0.xy + -r0.yz;
  r0.w = r9.x + r9.y;
  r0.w = r8.z * r2.x + r0.w;
  r0.w = 0.5 * r0.w;
  r2.xyz = r8.xyz * r2.xxx + -r0.www;
  r1.x = max(r2.y, r2.z);
  r1.x = max(r2.x, r1.x);
  r0.w = max(r1.x, r0.w);
  r1.x = cmp(r0.w == r2.x);
