...
// unknown dcl_: dcl_resource_structured t5, 64
  ...
  codeTexture1.GetDimensions(0, uiDest.x, uiDest.y, uiDest.z);
  r0.xy = uiDest.xy;
  r0.xy = (uint2)r0.xy;
...
r0.w = codeTexture1[]..swiz;
  ...
  o1.xyzw = viewProjectionMatrix._m30_m31_m32_m33 + r0.xyzw;
  return;
}