...
sample_indexable(texture2d)(float,float,float,float) r4.xyz, r2.ywyy, t30.xyzw, s1
if_nz r2.x
  mov o0.xyzw, l(0,0,0,0)
  ret 
endif 
sample_indexable(texture2d)(float,float,float,float) r2.x, v2.xyxx, t24.xyzw, s1
...
sample_indexable(texture2d)(float,float,float,float) r6.xyzw, v2.xyxx, t37.xyzw, s1
...
ge r7.xyz, l(0.040450, 0.040450, 0.040450, 0.000000), r2.yzwy
mul r8.xyz, r2.yzwy, l(0.07739938, 0.07739938, 0.07739938, 0.000000)
...
exp r2.yzw, r2.yyzw
movc r2.yzw, r7.xxyz, r8.xxyz, r2.yyzw
mul r7.xyz, r2.yzwy, r6.xyzx
mul r0.xyz, r0.xyzx, r2.yzwy
dp3 r2.y, -v7.xyzx, -v7.xyzx
rsq r2.y, r2.y
mul r8.xyz, r2.yyyy, -v7.xyzx
dp3_sat r2.z, v4.xyzx, r8.xyzx
...
dp3_sat r5.x, r3.xyzx, r8.xyzx
dp3 r7.y, -r8.xyzx, r3.xyzx
add r7.y, r7.y, r7.y
mad r12.xyz, r3.xyzx, -r7.yyyy, -r8.xyzx
...
if_nz r10.w
  ...
  if_nz r10.w
    ...
    if_nz r11.w
      ...
      mad r18.xyz, r3.xyzx, r13.wwww, v7.xyzx
    ...
    mad r11.z, r7.z, r11.z, r9.w
    mul r11.z, r11.y, r11.z
    mul r14.xyz, r13.xyzx, r11.zzzz
    lt r9.z, l(0.000000), r9.z
    mad r15.xyz, -v7.xyzx, r2.yyyy, cb2[17].xyzx
    dp3 r2.y, r15.xyzx, r15.xyzx
    rsq r2.y, r2.y
    mul r15.xyz, r2.yyyy, r15.xyzx
    dp3 r2.y, r15.xyzx, r8.xyzx
    dp3 r11.z, r3.xyzx, r15.xyzx
    mad r11.w, |r11.z|, r7.y, -|r11.z|
    mad r11.z, |r11.z|, r11.w, l(1.000000)
    mad r9.w, r9.w, r7.w, r8.w
    mul r11.z, r11.z, r11.z
    mul r9.w, r9.w, r11.z
    rcp r9.w, r9.w
    mul r9.w, r10.w, r9.w
...
mul r9.z, r2.w, l(0.00781250)
min r9.z, r9.z, l(15.000000)
ftou r9.z, r9.z
ushr r15.xy, r5.zwzz, l(6, 6, 0, 0)
ishl r15.z, r9.z, l(4)
mov r16.x, -r9.x
not r5.z, r4.w
          ...
          if_nz r31.w
            ...
            if_nz r31.w
              ...
              if_nz r31.w
                ...
                mad r43.xyz, r3.xyzx, r31.wwww, v7.xyzx
              ...
              if_nz r31.w
                ...
                if_nz r27.w
                  ...
                  mad r20.xyz, r3.xyzx, r32.wwww, v7.xyzx
...
mul r4.w, r2.y, l(5.000000)
mad r5.z, r2.y, l(5.000000), l(-2.500000)
mul r5.z, r5.z, l(0.400000)
max r5.z, r5.z, l(0.000000)
mad r7.xy, -r2.yyyy, l(10.000000, 5.000000, 0.000000, 0.000000), l(6.857410, 7.085000, 0.000000, 0.000000)
exp r5.w, r7.x
mul r5.w, r5.w, r5.x
    ...
    if_nz r10.y
      ...
      if_nz r10.x
        ...
        if_nz r10.z
          ...
          sqrt r10.x, r10.x
          mad r10.x, r2.y, l(5.000000), r10.x
      ...
      if_nz r13.w
        ...
        if_nz r11.x
          ...
          if_nz r13.w
            ...
            sqrt r10.w, r10.w
            mad r10.w, r2.y, l(5.000000), r10.w
...
max r2.y, r20.w, l(1.000000)
rcp r2.y, r2.y
mov_sat r20.w, r20.w
mul r7.xyz, r2.yyyy, r19.xyzx
mul r8.xyz, r2.yyyy, r20.xyzx
lt r5.z, r20.w, l(0.990000)
if_nz r5.z
  add r5.z, -r20.w, l(1.000000)
  ...
  mad r7.xyz, r19.xyzx, r2.yyyy, r3.xyzx
  mov r12.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r3.xyz, r12.xyzw, t8.xyzw, s2, r4.w
  mad r2.y, cb2[19].x, r5.z, -r3.w
  mad r2.y, r5.y, r2.y, r3.w
  mad r8.xyz, r3.xyzx, r2.yyyy, r8.xyzx
endif 
...
mad r5.xzw, r7.xxyz, r5.xxxx, r29.xxyz
mad r7.xyz, r7.xyzx, r5.yyyy, r30.xyzx
mul r5.xyz, r5.xzwx, l(0.960000, 0.960000, 0.960000, 0.000000)
mad r5.xyz, r7.xyzx, l(0.040000, 0.040000, 0.040000, 0.000000), r5.xyzx
...
div r3.x, l(1.000000, 1.000000, 1.000000, 1.000000), cb0[16].y
movc r2.y, r2.y, l(60000.000000), r3.x
add r2.x, -r2.w, r2.x
mul_sat r2.x, r2.y, r2.x
lt r2.y, r2.x, l(1.000000)
if_nz r2.y
  sample_indexable(texture2d)(float,float,float,float) r2.y, v2.xyxx, t46.xwyz, s1
  sample_indexable(texture2d)(float,float,float,float) r3.xyzw, v2.xyxx, t47.xyzw, s1
  mul r3.xyz, r3.wwww, r3.xyzx
  mad r0.w, r0.w, v1.w, -r2.y
  mad r0.w, r2.x, r0.w, r2.y
  add r5.xyzw, -r3.xyzw, r6.xyzw
  mad r6.xyzw, r2.xxxx, r5.xyzw, r3.xyzw
...
mul r3.xyz, r4.xyzx, cb1[85].xxxx
...
ret 
// Approximately 1983 instruction slots used
