...
mul_sat r0.z, cb0[11].y, l(0.05882353)
sample_indexable(texture2d)(float,float,float,float) r0.xyw, r0.xyxx, t10.xywz, s2
...
mad r0.xyw, r3.xyxz, r0.xxxx, r4.xyxz
mad r0.xyw, r2.yzyw, r2.xxxx, r0.xyxw
