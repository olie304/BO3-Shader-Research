...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r3.xyz = backlightScatterColor.xyz * r1.xyz;
  r1.w = 1 + -r1.w;
  ...
  if (r4.x != 0) {
    ...
    r13.xyz = r20.yzx * r1.www + r10.zwy;
    r11.w = 0;
  ...
  r1.w = r4.x * r1.w;
  r2.w = r4.x * r2.w;
  r4.x = dot(r2.xyz, sunConstants.wldDir.xyz);
  r4.y = cmp(0 >= abs(r4.x));
  if (r4.y != 0) {
    r7.z = 0;
  }
  ...
  r1.xyz = r9.yzw * r1.xyz + r2.xyz;
  r2.xyz = float3(0.959999979,0.959999979,0.959999979) * r30.xyz;
  r2.xyz = r10.yzw * float3(0.0399999991,0.0399999991,0.0399999991) + r2.xyz;
