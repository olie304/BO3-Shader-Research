...
sample_indexable(texture2d)(float,float,float,float) r2.xyz, r2.xyxx, t29.xyzw, s5
...
sample_indexable(texture2d)(float,float,float,float) r2.w, v1.yzyy, t22.yzwx, s3
sample_indexable(texture2d)(float,float,float,float) r3.x, v1.yzyy, t25.xyzw, s3
sample_indexable(texture2d)(float,float,float,float) r3.yzw, v1.yzyy, t24.wxyz, s5
...
mad r4.xyz, r2.wwww, r4.xyzx, l(0.040000, 0.040000, 0.040000, 0.000000)
add_sat r0.w, -r2.w, l(1.000000)
mul r0.xyz, r0.wwww, r0.xyzx
sample_indexable(texture2d)(float,float,float,float) r0.w, v1.yzyy, t26.yzwx, s6
add r2.w, -cb0[12].x, cb0[12].y
mad r2.w, r3.x, r2.w, cb0[12].x
...
mad r5.xy, r2.xyxx, cb0[12].zzzz, r3.xyxx
dp3 r2.x, r5.xyzx, r5.xyzx
rsq r2.x, r2.x
mul r3.xyw, r2.xxxx, r5.xyxz
mad r2.x, r2.z, cb0[12].z, r3.z
movc r2.y, v6.x, l(1.000000), l(-1.000000)
dp3 r2.z, v2.xyzx, v2.xyzx
rsq r2.z, r2.z
mul r5.xyz, r2.zzzz, v2.xyzx
...
rcp r2.z, r2.z
mov_sat r21.w, r21.w
mul r9.yzw, r2.zzzz, r20.xxyz
mul r10.yzw, r2.zzzz, r21.xxyz
...
if_nz r2.w
  ...
  mad r9.yzw, r20.xxyz, r2.zzzz, r13.xxyz
  mov r11.w, l(0)
  ...
  mad r10.yzw, r13.xxyz, r2.zzzz, r10.yyzw
endif 
add r2.z, r0.w, r2.x
log r2.z, |r2.z|
mul r2.z, r2.z, r6.z
