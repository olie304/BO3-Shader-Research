...
mad r2.xyz, r2.xyzx, r0.xxxx, -r1.xxxx
max r0.x, r2.z, r2.y
max r0.x, r0.x, r2.x
max r0.x, r0.x, r1.x
eq r1.x, r0.x, r2.x
...
mul r1.xzw, r3.xxyz, l(0.40824831, 0.000000, 0.70710677, 0.57735026)
add r0.x, |r1.w|, l(1.000000)
rsq r0.x, r0.x
mul r1.xz, r0.xxxx, r1.xxzx
mad o1.xy, r1.xzxx, l(0.58823532, 0.58823532, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
