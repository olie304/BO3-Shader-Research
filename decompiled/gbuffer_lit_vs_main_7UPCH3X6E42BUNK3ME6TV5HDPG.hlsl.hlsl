...
r1.w = shaderConstantSetBuffer[]..swiz;
  ...
  r6.w = 1;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r4.x, v5.x, l(4), t4.xxxx
r4.x = shaderConstantSetBuffer[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) r4.x, r4.x, l(96), t0.xxxx
r4.x = shaderConstantSetBuffer[]..swiz;
  r7.xyz = v3.xyz * float3(2.00195694,2.00195694,2.00195694) + float3(-1.00195694,-1.00195694,-1.00195694);
  r6.xyz = r7.xyz * r4.xxx + v0.xyz;
  r8.x = dot(r6.xyzw, r3.xyzw);
  r5.w = r4.y;
  r1.w = r4.z;
  r8.y = dot(r6.xyzw, r5.xyzw);
  r8.z = dot(r6.xyzw, r1.xyzw);
  r4.xyz = eyeOffset.xyz + r8.xyz;
  ...
  r2.xyz = r7.zxy * r0.yzx;
  r0.xyz = r7.yzx * r0.zxy + -r2.xyz;
  r0.w = v4.w * 2 + -1;
