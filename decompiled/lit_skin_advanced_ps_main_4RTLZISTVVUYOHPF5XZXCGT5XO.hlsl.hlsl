...
r0.x = samp0[]..swiz;
  ...
  r2.z = transGlossMap.Sample(transitionSampler_s, r0.zw).x;
  if (r2.y != 0) {
    r4.xyz = float3(-1,-1,-1) + transColorTint.xyz;
    r4.xyz = r3.www * r4.xyz + float3(1,1,1);
    r2.y = transGlossRange.y + -transGlossRange.x;
    r2.y = r2.z * r2.y + transGlossRange.x;
  ...
  r2.yw = r3.xy * float2(1.9921875,1.9921875) + float2(-1,-1);
  r3.x = dot(r2.yw, r2.yw);
  r3.x = 1 + -r3.x;
  r3.x = max(0, r3.x);
  r4.z = sqrt(r3.x);
  r3.x = r3.z * r3.z;
  ...
  if (r2.z != 0) {
    ...
    r0.y = r2.y * r0.y + r1.w;
    r10.xyz = r1.xyz * r0.yyy + r10.xyz;
  }
  r1.xyz = r9.xyz * r5.xyz + r6.xyz;
