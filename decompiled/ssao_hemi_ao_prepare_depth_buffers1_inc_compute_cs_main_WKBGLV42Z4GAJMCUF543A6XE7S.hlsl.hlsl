...
r0.z = GBufferDepth[]..swiz;
  r1.xy = (int2)r0.xx + int2(16,17);
// Known bad code for instruction (needs manual fix):
ld_structured r0.w, r1.x, l(0), g0.xxxx
r0.w = GBufferDepth[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured r1.x, r1.y, l(0), g0.xxxx
r1.x = GBufferDepth[]..swiz;
  r0.y = max(r0.y, r0.z);
  r0.z = max(r1.x, r0.w);
  r0.y = max(r0.y, r0.z);
  [r0.x].0 = g0.x;
...
store_uav_typed u1.xyzw, r1.xyzw, r0.yyyy
  r0.z = (int)vThreadIDInGroupFlattened.x & 9;
  if (r0.z == 0) {
    r0.xzw = (int3)r0.xxx + int3(2,32,34);
  // Known bad code for instruction (needs manual fix):
