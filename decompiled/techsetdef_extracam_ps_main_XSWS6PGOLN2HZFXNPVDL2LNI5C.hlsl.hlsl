  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  if (r0.x != 0) {
    r0.xyzw = extracamTexture4.Sample(extracamSampler_s, v2.xy).xyzw;
  } else {
    r1.x = cmp(extracamSelect == 3);
    if (r1.x != 0) {
      r0.xyzw = extracamTexture3.Sample(extracamSampler_s, v2.xy).xyzw;
    } else {
      r1.x = cmp(extracamSelect == 2);
      if (r1.x != 0) {
        r0.xyzw = extracamTexture2.Sample(extracamSampler_s, v2.xy).xyzw;
      } else {
        r0.xyzw = extracamTexture1.Sample(extracamSampler_s, v2.xy).xyzw;
      }
    }
  }
