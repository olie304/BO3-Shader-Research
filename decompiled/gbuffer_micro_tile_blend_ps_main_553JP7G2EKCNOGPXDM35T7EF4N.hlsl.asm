...
mad r0.y, r0.w, r0.y, cb0[14].x
mul_sat r0.y, r0.y, l(0.05882353)
sample_indexable(texture2d)(float,float,float,float) r0.z, r1.zwzz, t7.yzxw, s2
sample_indexable(texture2d)(float,float,float,float) r1.xyz, r1.zwzz, t10.xyzw, s3
...
mad r3.w, r0.z, cb0[11].w, r0.w
mul r0.z, r1.z, r1.z
mad r1.xy, r1.xyxx, l(1.99218750, 1.99218750, 0.000000, 0.000000), l(-1.000000, -1.000000, 0.000000, 0.000000)
mad r1.xy, r1.xyxx, cb0[11].zzzz, r2.zwzz
mul r0.z, r0.z, l(0.33333334)
min r0.z, r0.z, l(1.000000)
mad r4.w, r0.z, cb0[11].z, r0.w
mad r5.xy, r2.xyxx, cb0[11].wwww, r2.zwzz
