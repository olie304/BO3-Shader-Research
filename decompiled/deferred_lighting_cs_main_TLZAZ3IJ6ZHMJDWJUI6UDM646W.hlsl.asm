...
mul r18.y, r3.y, r3.z
mul r18.xz, r2.zzwz, r3.yyzy
mul r18.w, r2.w, r2.z
dp4 r2.z, r16.xyzw, r18.xyzw
add r17.xyzw, -r10.yyyy, r17.xyzw
min r2.w, |r17.w|, |r17.z|
min r2.w, r2.w, |r17.y|
min r2.w, r2.w, |r17.x|
max r3.y, |r17.w|, |r17.z|
max r3.y, r3.y, |r17.y|
max r3.y, r3.y, |r17.x|
eq r14.yzw, r2.wwww, |r17.yyzw|
movc r2.w, r14.y, r16.y, r16.x
movc r2.w, r14.z, r16.z, r2.w
movc r2.w, r14.w, r16.w, r2.w
...
if_z r3.w
  ...
  if_nz r6.w
    ...
    loop 
      ...
      breakc_nz r8.w
      ftou r8.w, r6.w
      add r14.yz, r10.yyzy, -cb2[r8.w + 20].xxyx
  ...
  if_nz r8.w
    ...
    rcp r16.xz, r14.yyyy
    mov r16.y, -r16.z
    mad r14.yzw, r10.yyzy, r16.xxyz, r14.zzwz
    ...
    if_z r16.x
      ...
      if_z r9.w
        ...
        mad r13.w, r10.z, r13.w, r14.y
        movc r16.y, r9.w, r13.w, r16.y
      endif 
    endif 
  ...
  if_z r8.w
    ...
    if_nz cb2[58].y
      ...
      loop 
        ...
        movc r17.xy, r13.wwww, r10.yzyy, r14.yzyy
...
mad r10.yz, -r3.wwww, l(0.000000, 10.000000, 5.000000, 0.000000), l(0.000000, 6.857410, 7.085000, 0.000000)
exp r8.w, r10.y
mul r8.w, r2.x, r8.w
...
ftou r10.y, cb1[44].x
iadd r10.y, r10.y, l(7)
ushr r10.y, r10.y, l(3)
imad r0.y, r0.z, r10.y, r0.y
...
mov r13.w, r0.z
loop 
  uge r14.y, r13.w, cb2[0].y
  breakc_nz r14.y
  ushr r14.y, r13.w, l(5)
  iadd r14.y, r0.y, r14.y
  ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r14.y, r14.y, l(0), t26.xxxx
  ieq r14.z, r0.z, r13.w
  bfi r14.w, r10.y, l(0), l(0), r14.y
  movc r14.y, r14.z, r14.w, r14.y
  ieq r14.z, r10.z, r13.w
  ubfe r14.w, r10.w, l(0), r14.y
  movc r14.y, r14.z, r14.w, r14.y
  ...
  loop 
    ...
    not r16.w, r16.w
    and r14.z, r14.z, r16.w
    iadd r14.w, r13.w, r14.w
    imul null, r14.w, r14.w, l(14)
    add r25.xyz, r11.xyzx, -cb10[r14.w + 0].xyzx
    ...
    and r18.z, l(1), cb10[r14.w + 6].x
    movc r18.zw, r18.zzzz, r16.xxxy, r16.zzzx
    mov r16.x, cb10[r14.w + 6].x
    mov r26.xy, r18.zwzz
    mov r19.w, l(1)
    loop 
      ...
      dp3 r25.w, cb11[r20.w + 0].xyzx, r25.xyzx
      add_sat r25.w, r25.w, cb11[r20.w + 0].w
      mul r25.w, r25.w, r26.x
      dp3 r26.z, cb11[r20.w + 1].xyzx, r25.xyzx
      add_sat r26.z, r26.z, cb11[r20.w + 1].w
      mul r25.w, r25.w, r26.z
      dp3 r26.z, cb11[r20.w + 2].xyzx, r25.xyzx
      add_sat r26.z, r26.z, cb11[r20.w + 2].w
      mul r25.w, r25.w, r26.z
      dp3 r26.z, cb11[r20.w + 3].xyzx, r25.xyzx
      add_sat r26.z, r26.z, cb11[r20.w + 3].w
      mul r25.w, r25.w, r26.z
      dp3 r26.z, cb11[r20.w + 4].xyzx, r25.xyzx
      add_sat r26.z, r26.z, cb11[r20.w + 4].w
      mul r25.w, r25.w, r26.z
      dp3 r26.z, cb11[r20.w + 5].xyzx, r25.xyzx
      add_sat r20.w, r26.z, cb11[r20.w + 5].w
      mul r26.x, r20.w, r25.w
      ushr r26.z, r16.x, l(2)
      ubfe r26.w, l(1), l(2), r16.x
      and r27.x, r26.z, l(2)
      max r27.y, r26.x, r26.y
      mad r20.w, -r25.w, r20.w, l(1.000000)
      mul r20.w, r20.w, r26.y
      movc r18.y, r27.x, r20.w, r27.y
      movc r26.xy, r26.wwww, r26.xyxx, r18.xyxx
      iadd r19.w, r19.w, l(1)
      mov r16.x, r26.z
    endloop 
    mov_sat r26.y, r26.y
    mul r16.x, r26.y, cb10[r14.w + 6].y
    lt r16.w, l(0.000000), r16.x
    if_nz r16.w
      mad r24.z, r26.y, cb10[r14.w + 6].y, r24.z
      mul r16.x, r16.x, cb10[r14.w + 7].y
      mov r27.x, cb10[r14.w + 7].w
      mov r27.yz, cb10[r14.w + 8].xxyx
      dp3 r16.w, r15.xyzx, r27.xyzx
      ...
      div r17.w, r18.y, r17.w
      min r16.w, r16.w, |r17.w|
      add r27.x, r25.x, cb10[r14.w + 3].w
      add r27.yz, r25.yyzy, cb10[r14.w + 4].xxyx
      mad r18.yzw, r15.xxyz, r16.wwww, r27.xxyz
      ...
      mov r27.x, cb10[r14.w + 0].w
      mov r27.y, cb10[r14.w + 1].z
      mov r27.z, cb10[r14.w + 2].y
      ...
      mad_sat r25.xyz, r31.xyzx, cb10[r14.w + 3].xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
      mul r31.xy, r25.xyxx, cb10[r14.w + 4].zwzz
      mul r31.z, r25.z, cb10[r14.w + 5].x
      add r25.xyz, r31.xyzx, cb10[r14.w + 5].yzwy
...
if_nz r10.z
  ...
  loop 
    ...
    ieq r16.w, r0.z, r10.w
    ubfe r17.w, r10.y, l(0), r13.w
    movc r13.w, r16.w, r17.w, r13.w
    mov r24.xyzw, r23.xyzw
    mov r25.xyz, r14.yzwy
    mov r16.w, r10.z
    mov r17.w, r13.w
    loop 
      breakc_z r17.w
      ...
      iadd r18.z, r10.w, r18.z
      imul null, r18.z, r18.z, l(14)
      add r26.xyz, r11.xyzx, -cb10[r18.z + 0].xyzx
      and r18.w, l(0x0000ffff), cb10[r18.z + 7].z
      ubfe r19.w, l(6), l(25), cb10[r18.z + 7].z
      imul null, r20.w, r18.w, l(6)
      dp3 r25.w, cb11[r20.w + 0].xyzx, r26.xyzx
      add_sat r25.w, r25.w, cb11[r20.w + 0].w
      ...
      and r20.w, l(1), cb10[r18.z + 6].x
      movc r27.xy, r20.wwww, r16.xyxx, r16.zxzz
      mov r16.x, cb10[r18.z + 6].x
      mov r28.xy, r27.xyxx
      mov r20.w, l(1)
      loop 
        ...
        movc r18.y, r28.z, r25.w, r28.w
        movc r28.xy, r27.wwww, r28.xyxx, r18.xyxx
        iadd r20.w, r20.w, l(1)
        mov r16.x, r27.z
      endloop 
      add_sat r16.x, -r16.w, r28.y
      mul r18.y, r16.x, cb10[r18.z + 6].y
      lt r18.w, l(0.000000), r18.y
      if_nz r18.w
        mad r24.w, r16.x, cb10[r18.z + 6].y, r24.w
        mul r16.x, r18.y, cb10[r18.z + 7].y
        mov r27.x, cb10[r18.z + 7].w
        mov r27.yz, cb10[r18.z + 8].xxyx
        dp3 r18.y, r15.xyzx, r27.xyzx
        dp3 r18.w, r26.xyzx, r27.xyzx
        add r18.w, r18.w, -cb10[r18.z + 8].z
        ...
        mov r27.x, cb10[r18.z + 8].w
        mov r27.yz, cb10[r18.z + 9].xxyx
        dp3 r18.w, r15.xyzx, r27.xyzx
        dp3 r19.w, r26.xyzx, r27.xyzx
        add r19.w, r19.w, -cb10[r18.z + 9].z
        ...
        mov r27.x, cb10[r18.z + 9].w
        mov r27.yz, cb10[r18.z + 10].xxyx
        dp3 r18.w, r15.xyzx, r27.xyzx
        dp3 r19.w, r26.xyzx, r27.xyzx
        add r19.w, r19.w, -cb10[r18.z + 10].z
        ge r20.w, r19.w, l(0.000000)
        max r19.w, r7.w, |r19.w|
        movc r19.w, r20.w, r19.w, -r19.w
        max r18.w, -r18.w, l(0.00000010)
        div r18.w, r19.w, r18.w
        min r18.y, |r18.w|, r18.y
        mov r27.x, cb10[r18.z + 10].w
        mov r27.yz, cb10[r18.z + 11].xxyx
        dp3 r18.w, r15.xyzx, r27.xyzx
        dp3 r19.w, r26.xyzx, r27.xyzx
        add r19.w, r19.w, -cb10[r18.z + 11].z
        ge r20.w, r19.w, l(0.000000)
        max r19.w, r7.w, |r19.w|
        movc r19.w, r20.w, r19.w, -r19.w
        max r18.w, -r18.w, l(0.00000010)
        div r18.w, r19.w, r18.w
        min r18.y, |r18.w|, r18.y
        mov r27.x, cb10[r18.z + 11].w
        mov r27.yz, cb10[r18.z + 12].xxyx
        dp3 r18.w, r15.xyzx, r27.xyzx
        dp3 r19.w, r26.xyzx, r27.xyzx
        add r19.w, r19.w, -cb10[r18.z + 12].z
        ge r20.w, r19.w, l(0.000000)
        max r19.w, r7.w, |r19.w|
        movc r19.w, r20.w, r19.w, -r19.w
        max r18.w, -r18.w, l(0.00000010)
        div r18.w, r19.w, r18.w
        min r18.y, |r18.w|, r18.y
        mov r27.x, cb10[r18.z + 12].w
        mov r27.yz, cb10[r18.z + 13].xxyx
        dp3 r18.w, r15.xyzx, r27.xyzx
        dp3 r19.w, r26.xyzx, r27.xyzx
        add r19.w, r19.w, -cb10[r18.z + 13].z
        ge r20.w, r19.w, l(0.000000)
        max r19.w, r7.w, |r19.w|
        movc r19.w, r20.w, r19.w, -r19.w
        max r18.w, -r18.w, l(0.00000010)
        div r18.w, r19.w, r18.w
        min r18.y, |r18.w|, r18.y
        add r27.x, r26.x, cb10[r18.z + 3].w
        add r27.yz, r26.yyzy, cb10[r18.z + 4].xxyx
        mad r27.xyz, r15.xyzx, r18.yyyy, r27.xyzx
        dp3 r18.w, r27.xyzx, r27.xyzx
        sqrt r18.w, r18.w
        div r18.y, r18.y, r18.w
        add r18.y, r18.y, r18.y
        sqrt r18.y, r18.y
        mad r18.y, r3.w, l(5.000000), r18.y
        add r18.y, r18.y, l(-0.844800)
        mov r29.x, cb10[r18.z + 0].w
        mov r29.y, cb10[r18.z + 1].z
        mov r29.z, cb10[r18.z + 2].y
        dp3 r30.x, r27.xyzx, r29.xyzx
        mov r31.xy, cb10[r18.z + 1].xwxx
        mov r31.z, cb10[r18.z + 2].z
        dp3 r30.y, r27.xyzx, r31.xyzx
        mov r32.x, cb10[r18.z + 1].y
        mov r32.yz, cb10[r18.z + 2].xxwx
        dp3 r30.z, r27.xyzx, r32.xyzx
        ubfe r18.w, l(9), l(16), cb10[r18.z + 7].z
        utof r30.w, r18.w
        sample_l_indexable(texturecubearray)(float,float,float,float) r27.xyz, r30.xyzw, t8.xyzw, s2, r18.y
        dp3 r33.x, r26.xyzx, r29.xyzx
        dp3 r33.y, r26.xyzx, r31.xyzx
        dp3 r33.z, r26.xyzx, r32.xyzx
        mad_sat r26.xyz, r33.xyzx, cb10[r18.z + 3].xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
        mul r33.xy, r26.xyxx, cb10[r18.z + 4].zwzz
        mul r33.z, r26.z, cb10[r18.z + 5].x
        add r18.yzw, r33.xxyz, cb10[r18.z + 5].yyzw
...
if_nz r0.z
  ...
  mad r10.yzw, r21.xxyz, r0.yyyy, r16.xxyz
  mov r15.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r16.xyz, r15.xyzw, t8.xyzw, s2, r6.w
  mad r0.y, cb2[19].x, r0.z, -r3.w
...
if_nz r3.w
  ...
  if_nz r3.w
    ...
    if_nz r6.w
      ...
      add r19.x, r14.y, cb9[r5.z + 9].w
      add r19.y, r14.z, cb9[r5.z + 10].x
      mul r14.yz, r19.xxyx, cb9[r5.z + 9].yyzy
      div r19.xy, cb9[r5.z + 3].yyyy, cb9[r5.z + 8].ywyy
    ...
    mad r14.yzw, r3.zzzz, r10.yyzw, r2.yyzw
    ...
    mov r18.w, r19.z
    mov r16.w, r17.z
    movc r16.xyzw, r3.yyyy, r18.xyzw, r16.xyzw
    mov r19.zw, r14.yyyz
    mov r17.zw, r2.yyyz
    movc r18.xyzw, r3.yyyy, r19.xyzw, r17.xyzw
    movc r2.w, r3.y, r14.w, r2.w
    mov r17.z, r16.w
    mov r17.xy, r18.xyxx
    mov r2.yz, r18.zzwz
  endif 
