...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r4.xyz = v7.xxx ? v2.xyz : -v2.xyz;
  r2.z = dot(r4.xyz, r4.xyz);
  r2.z = rsqrt(r2.z);
  r4.xyz = r4.xyz * r2.zzz + -r3.yzw;
  r3.xyz = debugNormalOverride.www * r4.xyz + r3.yzw;
  r2.z = thicknessMap.Sample(colorSampler_s, w1.xy).x;
  ...
  if (r2.w != 0) {
    ...
    if (r2.w != 0) {
      ...
      r2.z = saturate(r2.z);
      r16.xyz = -v5.xyz * r5.xxx + sunConstants.wldDir.xyz;
