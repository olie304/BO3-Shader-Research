...
loop 
  ...
  ieq r12.w, r2.x, r11.w
  bfi r13.x, r2.y, l(0), l(0), r12.z
  movc r12.z, r12.w, r13.x, r12.z
  ieq r12.w, r2.z, r11.w
    ...
    if_nz r14.w
      ...
      if_nz r13.z
        ...
        if_nz r14.x
          ...
          utof r32.w, r14.x
          sample_l_indexable(texturecubearray)(float,float,float,float) r16.yzw, r32.xyzw, t8.wxyz, s2, r13.z
          ...
          mov r23.x, r21.w
          mov r23.yz, r22.xxyx
          mad r22.xyw, r16.zwzy, r13.yyyy, r23.yzyx
          mov r21.w, r22.w
        endif 
      endif 
    endif 
  ...
  loop 
    ...
    loop 
      ...
      if_nz r16.w
        ...
        and r16.z, r24.y, r24.x
        and r16.z, r24.z, r16.z
        if_nz r16.z
          ...
          and r22.w, r16.z, l(1)
          movc r27.xy, r22.wwww, r14.xyxx, r14.zxzz
          mov r14.x, r16.z
          mov r28.xy, r27.xyxx
          mov r22.w, l(1)
          loop 
            ...
            movc r16.y, r28.z, r24.w, r28.w
            movc r28.xy, r27.wwww, r28.xyxx, r16.xyxx
          ...
          if_nz r16.z
            ...
            mad r23.w, r14.x, r16.w, r23.w
            mul r14.x, r25.z, r16.y
            mov r25.z, r33.z
            dp3 r15.w, r10.xyzx, r25.xyzx
            dp3 r16.y, r26.xyzx, r25.xyzx
            ...
            min r15.w, r15.w, |r16.y|
            mov r38.zw, r37.zzzw
            dp3 r16.y, r10.zxyz, r38.xzwx
            dp3 r16.z, r26.zxyz, r38.xzwx
            ...
            mov r24.y, r27.z
            mov r24.z, r29.x
            dp3 r33.x, r16.yzwy, r24.xyzx
            mov r25.xy, r27.xwxx
            mov r25.z, r29.w
            dp3 r33.y, r16.yzwy, r25.xyzx
            mov r29.x, r27.y
            dp3 r33.z, r16.yzwy, r29.xyzx
            ubfe r16.y, l(9), l(16), r25.w
            utof r33.w, r16.y
            sample_l_indexable(texturecubearray)(float,float,float,float) r16.yzw, r33.xyzw, t8.wxyz, s2, r15.w
...
if_nz r2.y
  ...
  mad r12.xyz, r19.xyzx, r2.xxxx, r14.xyzx
  mov r10.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r14.xyz, r10.xyzw, t8.xyzw, s2, r6.w
...
mul r14.xyz, r2.xxxx, r13.yzxy
mul r2.xyz, r2.yyyy, r13.xyzx
sqrt r0.y, r6.y
...
if_z r7.w
  ...
  if_nz r8.w
    ...
    loop 
      ...
      breakc_nz r10.w
      ftou r10.w, r8.w
      add r15.xy, r13.xyxx, -cb2[r10.w + 20].xyxx
  ...
  if_nz r10.w
    ...
    if_z r15.w
      ...
      if_z r11.w
        ...
        mad r15.x, r13.x, r15.y, r15.x
        mad r13.w, r13.y, r13.w, r15.x
        movc r16.x, r11.w, r13.w, r16.x
      endif 
    endif 
  ...
  if_z r10.w
    ...
    if_nz cb2[58].y
      ...
      loop 
        ...
        movc r16.yz, r16.xxxx, r13.xxyx, r13.zzwz
...
if_nz r7.w
  ...
  if_nz r7.w
    ...
    if_nz r9.w
      ...
      if_z r10.w
        ...
        if_nz cb2[58].y
          ...
          utof r16.z, r10.w
          sample_c_lz_indexable(texture2darray)(float,float,float,float) r11.w, r16.xyzx, t9.xxxx, s13, r8.w
        endif 
    ...
    mad r16.xyz, r6.wwww, r13.xyzx, r2.xyzx
    add_sat r0.w, -r0.w, l(1.000000)
    mul r7.w, r0.w, r0.w
    mul r7.w, r7.w, r7.w
    mul r0.w, r0.w, r7.w
    mul r0.w, r0.w, r6.w
    mad r13.xyz, r0.wwww, r13.yzxy, r14.xyzx
    mov r15.w, r13.z
    mov r12.w, r14.z
    movc r12.xyzw, r6.zzzz, r15.xyzw, r12.xyzw
    mov r13.zw, r16.xxxy
    mov r14.zw, r2.xxxy
    movc r13.xyzw, r6.zzzz, r13.xyzw, r14.xyzw
    movc r2.z, r6.z, r16.z, r2.z
    mov r14.z, r12.w
    mov r14.xy, r13.xyxx
    mov r2.xy, r13.zwzz
  endif 
            ...
            if_nz r20.w
              ...
              if_nz r20.w
                ...
                if_nz r12.w
                  ...
                  mad r18.xyz, r4.xyzx, r24.wwww, v6.xyzx
                  ...
                  if_z r18.y
                    ...
                    if_nz r8.z
                      ...
                      loop 
                        ige r24.w, r18.z, l(8)
                        breakc_nz r24.w
                        dp2 r43.x, icb[r18.z + 0].yxyy, r13.xwxx
                ...
                mad r15.w, |r15.z|, r3.w, -|r15.z|
                mad r15.z, |r15.z|, r15.w, l(1.000000)
                mad r15.w, r11.w, r0.y, r4.w
          ...
          if_nz r14.w
            ...
            if_nz r14.w
              ...
              if_nz r14.w
                ...
                mad r21.xyz, r4.xyzx, r14.wwww, v6.xyzx
...
ret 
// Approximately 2810 instruction slots used
