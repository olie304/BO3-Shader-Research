...
ult r12.w, r15.y, r12.w
if_nz r12.w
  imul null, r12.w, r15.y, l(14)
  if_nz r3.z
    and r15.y, r0.y, l(1)
    imad r15.y, r15.y, l(20), l(880)
    add r19.yzw, cb1[24].xxyz, cb10[r12.w + 0].xxyz
    mov r19.x, l(16)
    store_structured u2.xyzw, cb2[52].x, r15.y, r19.xyzw
  endif 
  iadd r15.y, r0.y, l(1)
  add r19.xyz, r5.xyzx, -cb10[r12.w + 0].xyzx
  ...
  loop 
    ...
    mov r18.w, r21.z
  endloop 
  add_sat r15.w, -r13.w, r22.y
  mul r17.w, r15.w, cb10[r12.w + 6].y
  ...
  if_nz r18.w
    ...
    mad r15.w, r15.w, cb10[r12.w + 6].y, r13.w
    mul r17.w, r17.w, cb10[r12.w + 7].y
    mov r20.x, cb10[r12.w + 7].w
    mov r20.yz, cb10[r12.w + 8].xxyx
    dp3 r18.w, r16.xyzx, r20.xyzx
    dp3 r19.w, r19.xyzx, r20.xyzx
    add r19.w, r19.w, -cb10[r12.w + 8].z
    ...
    mov r20.x, cb10[r12.w + 8].w
    mov r20.yz, cb10[r12.w + 9].xxyx
    dp3 r19.w, r16.xyzx, r20.xyzx
    dp3 r20.x, r19.xyzx, r20.xyzx
    add r20.x, r20.x, -cb10[r12.w + 9].z
    ...
    mov r20.x, cb10[r12.w + 9].w
    mov r20.yz, cb10[r12.w + 10].xxyx
    dp3 r19.w, r16.xyzx, r20.xyzx
    dp3 r20.x, r19.xyzx, r20.xyzx
    add r20.x, r20.x, -cb10[r12.w + 10].z
    ge r20.y, r20.x, l(0.000000)
    max r20.x, r9.w, |r20.x|
    movc r20.x, r20.y, r20.x, -r20.x
    max r19.w, -r19.w, l(0.00000010)
    div r19.w, r20.x, r19.w
    min r18.w, r18.w, |r19.w|
    mov r20.x, cb10[r12.w + 10].w
    mov r20.yz, cb10[r12.w + 11].xxyx
    dp3 r19.w, r16.xyzx, r20.xyzx
    dp3 r20.x, r19.xyzx, r20.xyzx
    add r20.x, r20.x, -cb10[r12.w + 11].z
    ge r20.y, r20.x, l(0.000000)
    max r20.x, r9.w, |r20.x|
    movc r20.x, r20.y, r20.x, -r20.x
    max r19.w, -r19.w, l(0.00000010)
    div r19.w, r20.x, r19.w
    min r18.w, r18.w, |r19.w|
    mov r20.x, cb10[r12.w + 11].w
    mov r20.yz, cb10[r12.w + 12].xxyx
    dp3 r19.w, r16.xyzx, r20.xyzx
    dp3 r20.x, r19.xyzx, r20.xyzx
    add r20.x, r20.x, -cb10[r12.w + 12].z
    ge r20.y, r20.x, l(0.000000)
    max r20.x, r9.w, |r20.x|
    movc r20.x, r20.y, r20.x, -r20.x
    max r19.w, -r19.w, l(0.00000010)
    div r19.w, r20.x, r19.w
    min r18.w, r18.w, |r19.w|
    mov r20.x, cb10[r12.w + 12].w
    mov r20.yz, cb10[r12.w + 13].xxyx
    dp3 r19.w, r16.xyzx, r20.xyzx
    dp3 r20.x, r19.xyzx, r20.xyzx
    add r20.x, r20.x, -cb10[r12.w + 13].z
    ge r20.y, r20.x, l(0.000000)
    max r9.w, r9.w, |r20.x|
    ...
    div r9.w, r9.w, r19.w
    min r9.w, |r9.w|, r18.w
    add r20.x, r19.x, cb10[r12.w + 3].w
    add r20.yz, r19.yyzy, cb10[r12.w + 4].xxyx
    mad r20.xyz, r16.xyzx, r9.wwww, r20.xyzx
    dp3 r18.w, r20.xyzx, r20.xyzx
    sqrt r18.w, r18.w
    div r9.w, r9.w, r18.w
    add r9.w, r9.w, r9.w
    sqrt r9.w, r9.w
    mad r7.w, r7.w, l(5.000000), r9.w
    add r7.w, r7.w, l(-0.844800)
    mov r21.x, cb10[r12.w + 0].w
    mov r21.y, cb10[r12.w + 1].z
    mov r21.z, cb10[r12.w + 2].y
    dp3 r22.x, r20.xyzx, r21.xyzx
    mov r23.xy, cb10[r12.w + 1].xwxx
    mov r23.z, cb10[r12.w + 2].z
    dp3 r22.y, r20.xyzx, r23.xyzx
    mov r24.x, cb10[r12.w + 1].y
    mov r24.yz, cb10[r12.w + 2].xxwx
    dp3 r22.z, r20.xyzx, r24.xyzx
    ubfe r9.w, l(9), l(16), cb10[r12.w + 7].z
    utof r22.w, r9.w
    ...
    mad_sat r19.xyz, r25.xyzx, cb10[r12.w + 3].xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
    mul r25.xy, r19.xyxx, cb10[r12.w + 4].zwzz
    mul r25.z, r19.z, cb10[r12.w + 5].x
    add r19.xyz, r25.xyzx, cb10[r12.w + 5].yzwy
    ...
    or r7.w, r22.y, r22.x
    or r7.w, r22.z, r7.w
    movc r21.xyz, r7.wwww, l(1.000000,1.000000,0,0), r21.xyzx
    mul r22.xyz, r19.xyzx, r21.xyzx
    dp3 r7.w, r22.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
...
ge r7.w, r13.w, l(1.000000)
bfi r0.y, l(8), l(0), r15.y, r0.y
movc r0.y, r7.w, r0.y, r15.y
max r7.w, r15.w, l(1.000000)
rcp r7.w, r7.w
mov_sat r15.w, r15.w
mul r19.xyz, r7.wwww, r17.xyzx
mul r18.xyz, r7.wwww, r18.xyzx
lt r9.w, r15.w, l(0.990000)
if_nz r9.w
  iadd r0.y, r0.y, l(256)
  add r9.w, -r15.w, l(1.000000)
  ...
  mad r19.xyz, r17.xyzx, r7.wwww, r20.xyzx
  mov r16.w, l(0)
...
ret 
// Approximately 2091 instruction slots used
