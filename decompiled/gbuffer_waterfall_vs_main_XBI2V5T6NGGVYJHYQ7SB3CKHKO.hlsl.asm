...
dp3 r4.y, r3.xyzx, r6.xyzx
dp3 r4.z, r3.xyzx, r8.xyzx
dp3 r1.w, r4.xyzx, r4.xyzx
rsq r1.w, r1.w
mul r2.yzw, r1.wwww, r4.xxyz
mul r3.xyzw, r9.yyyy, cb1[9].xyzw
mad r3.xyzw, r9.xxxx, cb1[8].xyzw, r3.xyzw
mad r3.xyzw, r9.zzzz, cb1[10].xyzw, r3.xyzw
add o0.xyzw, r3.xyzw, cb1[11].xyzw
and r1.w, r2.x, l(0x0fffffff)
if_nz r1.w
  ...
  if_nz r1.w
    ...
    ld_indexable(texture2d)(float,float,float,float) r3.xyw, r5.xyzz, t3.xywz
    ld_indexable(texture2d)(float,float,float,float) r8.xyz, r5.xwzz, t3.xyzw
    ...
    mul r6.xyzw, r1.wwww, r6.xyzw
    add r8.xyz, r6.xyzx, r6.xyzx
    mul r11.xyz, r6.xzwx, r8.xxxx
    mul r1.w, r6.w, r8.y
    mul r8.zw, r6.wwwz, r8.zzzz
    mad r2.x, r6.y, r8.y, r8.w
    add r12.x, -r2.x, l(1.000000)
    mad r13.x, r6.z, r8.x, -r1.w
    mad r12.y, r6.y, r8.x, -r8.z
    mad r14.xy, r6.yxyy, r8.xxxx, r8.zwzz
    mad r14.z, r6.z, r8.y, -r11.z
    mad r6.xyz, r6.zwyz, r8.yyyy, r11.zyxz
    mov r12.z, r6.y
    dp3 r8.x, r7.xyzx, r12.xyzx
    add r14.w, -r14.y, l(1.000000)
    dp3 r8.y, r7.xzyx, r14.xzwx
    mad r13.yz, r6.xxzx, l(0.000000, 1.000000, -1.000000, 0.000000), l(0.000000, 0.000000, 1.000000, 0.000000)
    dp3 r8.z, r7.xyzx, r13.xyzx
    add r6.xyz, r10.xyzx, r8.xyzx
    add r3.xyw, r3.xyxw, r6.xyxz
    mul r4.xyz, r3.xywx, v5.xxxx
    ne r1.w, v5.y, l(0.000000)
    if_nz r1.w
      mov r5.x, v6.y
      ld_indexable(texture2d)(float,float,float,float) r6.xyzw, r5.xyzz, t2.xyzw
      ...
      add r6.xyz, r10.xyzx, r8.xyzx
      add r3.xyw, r3.xyxw, r6.xyxz
      mad r4.xyz, r3.xywx, v5.yyyy, r4.xyzx
      ne r1.w, v5.z, l(0.000000)
      if_nz r1.w
        mov r5.x, v6.z
        ld_indexable(texture2d)(float,float,float,float) r6.xyzw, r5.xyzz, t2.xyzw
        ...
        add r6.xyz, r10.xyzx, r8.xyzx
        add r3.xyw, r3.xyxw, r6.xyxz
        mad r4.xyz, r3.xywx, v5.zzzz, r4.xyzx
        ne r1.w, v5.w, l(0.000000)
        if_nz r1.w
          mov r5.x, v6.w
          ld_indexable(texture2d)(float,float,float,float) r6.xyzw, r5.xyzz, t2.xyzw
          ...
          mad r4.xyz, r3.xyzx, v5.wwww, r4.xyzx
        endif 
      endif 
    endif 
  endif 
  ...
  movc r3.xyzw, r1.wwww, r3.xyzw, l(0,0,0,0)
  ne r1.w, l(0.000000, 0.000000, 0.000000, 0.000000), r3.w
  if_nz r1.w
    ftou r1.w, r3.w
    if_nz r1.w
...
and r1.w, r3.x, l(0x0fffffff)
ine r2.x, r3.y, l(0)
ieq r0.w, r0.w, l(0)
and r0.w, r0.w, r2.x
ine r2.x, r1.w, l(0)
and r0.w, r0.w, r2.x
movc r0.w, r0.w, r1.w, r3.y
iadd r0.w, r1.w, r0.w
...
mul r3.xyzw, r1.wwww, cb7[1].xyzw
mad r3.xyzw, r0.wwww, cb7[0].xyzw, r3.xyzw
mad r3.xyzw, r2.xxxx, cb7[2].xyzw, r3.xyzw
add o5.xyzw, r3.xyzw, cb7[3].xyzw
dp3 r0.w, -r9.xyzx, -r9.xyzx
rsq r0.w, r0.w
mul r3.xyz, r0.wwww, -r9.xyzx
dp3 r4.x, r3.xyzx, r1.xyzx
dp3 r4.y, r3.xyzx, r2.yzwy
...
mov r4.y, r4.x
mov r4.z, r2.x
dp2 r5.y, r4.yzyy, r3.xyxx
mov r4.x, -r2.x
dp2 r5.z, r4.xyxx, r3.xyxx
mul r3.xy, cb0[12].xyxx, cb1[69].wwww
mad r3.xy, r3.xyxx, cb0[12].zwzz, r5.yzyy
...
mov o4.xyz, r2.yzwy
ret 
// Approximately 869 instruction slots used
