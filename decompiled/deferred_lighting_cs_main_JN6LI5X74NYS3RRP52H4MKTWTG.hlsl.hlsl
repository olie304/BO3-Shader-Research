...
r0.y = samp0[]..swiz;
  ...
  r0.y = (uint)r0.y >> 24;
  r9.w = cmp((uint)r0.y >= (uint)r8.w);
  r10.w = cmp((uint)r0.y < numRefProbes);
  r9.w = r9.w ? r10.w : 0;
  if (r9.w != 0) {
    r9.w = (int)r0.y * 14;
    if (r2.z != 0) {
      r16.yzw = refProbeConstantsCB[r9.w].data[0].xyz + eyeOffset.xyz;
      r16.x = 16;
    ...
    r14.y = (int)r10.w * 6;
    r14.z = dot(refProbeAttenuationConstantsCB[r14.y].data[0].xyz, r13.yzw);
    r14.z = saturate(refProbeAttenuationConstantsCB[r14.y].data[0].w + r14.z);
    r14.w = dot(refProbeAttenuationConstantsCB[r14.y].data[1].xyz, r13.yzw);
    r14.w = saturate(refProbeAttenuationConstantsCB[r14.y].data[1].w + r14.w);
    r14.z = r14.z * r14.w;
    r14.w = dot(refProbeAttenuationConstantsCB[r14.y].data[2].xyz, r13.yzw);
    r14.w = saturate(refProbeAttenuationConstantsCB[r14.y].data[2].w + r14.w);
    r14.z = r14.z * r14.w;
    r14.w = dot(refProbeAttenuationConstantsCB[r14.y].data[3].xyz, r13.yzw);
    r14.w = saturate(refProbeAttenuationConstantsCB[r14.y].data[3].w + r14.w);
    r14.z = r14.z * r14.w;
    r14.w = dot(refProbeAttenuationConstantsCB[r14.y].data[4].xyz, r13.yzw);
    r14.w = saturate(refProbeAttenuationConstantsCB[r14.y].data[4].w + r14.w);
    r14.z = r14.z * r14.w;
    r14.w = dot(refProbeAttenuationConstantsCB[r14.y].data[5].xyz, r13.yzw);
    r14.y = saturate(refProbeAttenuationConstantsCB[r14.y].data[5].w + r14.w);
    r16.x = r14.z * r14.y;
    r14.y = 1 & (int)refProbeConstantsCB[r9.w].data[6].x;
    r16.yz = float2(0,1);
    r14.yz = r14.yy ? r16.xy : r16.zx;
    r16.x = 1;
    r14.w = refProbeConstantsCB[r9.w].data[6].x;
    r17.xy = r14.yz;
    r16.z = 1;
    while (true) {
      r16.w = cmp((int)r16.z >= (int)r12.w);
      if (r16.w != 0) break;
      ...
      r17.x = r17.z * r16.w;
      r17.w = (uint)r14.w >> 2;
      if (1 == 0) r18.x = 0; else if (1+2 < 32) {       r18.x = (uint)r14.w << (32-(1 + 2)); r18.x = (uint)r18.x >> (32-1);      } else r18.x = (uint)r14.w >> 2;
      r18.y = (int)r17.w & 2;
      r18.z = max(r17.y, r17.x);
      r16.w = -r17.z * r16.w + 1;
      r16.w = r17.y * r16.w;
      r16.y = r18.y ? r16.w : r18.z;
      r17.xy = r18.xx ? r17.xy : r16.xy;
      r16.z = (int)r16.z + 1;
      r14.w = r17.w;
    }
    ...
    if (r12.w != 0) {
      ...
      r16.x = refProbeConstantsCB[r9.w].data[7].w;
      r16.yz = refProbeConstantsCB[r9.w].data[8].xy;
      r14.y = dot(r15.xyz, r16.xyz);
      r14.z = dot(r13.yzw, r16.xyz);
      r14.z = -refProbeConstantsCB[r9.w].data[8].z + r14.z;
      r14.w = cmp(r14.z >= 0);
      ...
      r16.xyz = r15.xyz * r14.yyy + r16.xyz;
      ...
      r17.x = refProbeConstantsCB[r9.w].data[0].w;
      r17.y = refProbeConstantsCB[r9.w].data[1].z;
      r17.z = refProbeConstantsCB[r9.w].data[2].y;
      r18.x = dot(r16.xyz, r17.xyz);
      r19.xy = refProbeConstantsCB[r9.w].data[1].xw;
      r19.z = refProbeConstantsCB[r9.w].data[2].z;
      r18.y = dot(r16.xyz, r19.xyz);
      r20.x = refProbeConstantsCB[r9.w].data[1].y;
      r20.yz = refProbeConstantsCB[r9.w].data[2].xw;
      r18.z = dot(r16.xyz, r20.xyz);
      if (9 == 0) r14.z = 0; else if (9+16 < 32) {       r14.z = (uint)refProbeConstantsCB[r9.w].data[7].z << (32-(9 + 16)); r14.z = (uint)r14.z >> (32-9);      } else r14.z = (uint)refProbeConstantsCB[r9.w].data[7].z >> 16;
      r18.w = (uint)r14.z;
      r14.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r18.xyzw, r14.y).xyz;
      r16.xyz = (int3)r14.yzw & int3(-2147483648,-2147483648,-2147483648);
      r16.xyz = cmp((int3)r16.xyz == int3(2139095040,2139095040,2139095040));
      r16.x = (int)r16.y | (int)r16.x;
      r16.x = (int)r16.z | (int)r16.x;
      r14.yzw = r16.xxx ? float3(1,1,0) : r14.yzw;
      r16.x = dot(r13.yzw, r17.xyz);
      r16.y = dot(r13.yzw, r19.xyz);
      r16.z = dot(r13.yzw, r20.xyz);
      r13.yzw = saturate(r16.xyz * refProbeConstantsCB[r9.w].data[3].xyz + float3(0.5,0.5,0.5));
      r16.xy = refProbeConstantsCB[r9.w].data[4].zw * r13.yz;
      r16.z = refProbeConstantsCB[r9.w].data[5].x * r13.w;
      r13.yzw = refProbeConstantsCB[r9.w].data[5].yzw + r16.xyz;
      r18.x = dot(r11.xyz, r17.xyz);
      r18.y = dot(r11.xyz, r19.xyz);
      r18.z = dot(r11.xyz, r20.xyz);
      r16.xyz = cmp(float3(0,0,0) < r18.xyz);
      r17.z = r16.x ? 0 : 0.5;
      r17.xy = float2(0,0);
      ...
      r16.xyw = r17.xyz * r19.xxx + r16.xyw;
      r17.z = r16.z ? 0 : 0.5;
      r17.xy = float2(0,0);
      ...
      r16.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r18.xyzw, 6).xyz;
  ...
  r8.w = cmp((uint)r0.y < (uint)r8.w);
  if (r8.w != 0) {
    r0.y = (int)r0.y * 14;
    if (r2.z != 0) {
      r8.w = (int)r9.w & 1;
      r8.w = mad((int)r8.w, 20, 880);
      r16.yzw = refProbeConstantsCB[r0.y].data[0].xyz + eyeOffset.xyz;
      r16.x = 16;
      GBufferDiffuseColor[viewID].r8.w = u2.xyzw;
    }
    r8.w = (int)r9.w + 1;
    r16.xyz = -refProbeConstantsCB[r0.y].data[0].xyz + r5.xyz;
    r12.w = 0x0000ffff & (int)refProbeConstantsCB[r0.y].data[7].z;
    if (6 == 0) r16.w = 0; else if (6+25 < 32) {     r16.w = (uint)refProbeConstantsCB[r0.y].data[7].z << (32-(6 + 25)); r16.w = (uint)r16.w >> (32-6);    } else r16.w = (uint)refProbeConstantsCB[r0.y].data[7].z >> 25;
    r17.x = (int)r12.w * 6;
    r17.y = dot(refProbeAttenuationConstantsCB[r17.x].data[0].xyz, r16.xyz);
    r17.y = saturate(refProbeAttenuationConstantsCB[r17.x].data[0].w + r17.y);
    r17.z = dot(refProbeAttenuationConstantsCB[r17.x].data[1].xyz, r16.xyz);
    r17.z = saturate(refProbeAttenuationConstantsCB[r17.x].data[1].w + r17.z);
    r17.y = r17.y * r17.z;
    r17.z = dot(refProbeAttenuationConstantsCB[r17.x].data[2].xyz, r16.xyz);
    r17.z = saturate(refProbeAttenuationConstantsCB[r17.x].data[2].w + r17.z);
    r17.y = r17.y * r17.z;
    r17.z = dot(refProbeAttenuationConstantsCB[r17.x].data[3].xyz, r16.xyz);
    r17.z = saturate(refProbeAttenuationConstantsCB[r17.x].data[3].w + r17.z);
    r17.y = r17.y * r17.z;
    r17.z = dot(refProbeAttenuationConstantsCB[r17.x].data[4].xyz, r16.xyz);
    r17.z = saturate(refProbeAttenuationConstantsCB[r17.x].data[4].w + r17.z);
    r17.y = r17.y * r17.z;
    r17.z = dot(refProbeAttenuationConstantsCB[r17.x].data[5].xyz, r16.xyz);
    ...
    r17.w = 1;
    while (true) {
      r18.z = cmp((int)r17.w >= (int)r16.w);
      if (r18.z != 0) break;
      r18.z = (int)r12.w + (int)r17.w;
      r18.z = (int)r18.z * 6;
      r18.w = dot(refProbeAttenuationConstantsCB[r18.z].data[0].xyz, r16.xyz);
      r18.w = saturate(refProbeAttenuationConstantsCB[r18.z].data[0].w + r18.w);
      r18.w = r19.x * r18.w;
      r19.z = dot(refProbeAttenuationConstantsCB[r18.z].data[1].xyz, r16.xyz);
      r19.z = saturate(refProbeAttenuationConstantsCB[r18.z].data[1].w + r19.z);
      r18.w = r19.z * r18.w;
      r19.z = dot(refProbeAttenuationConstantsCB[r18.z].data[2].xyz, r16.xyz);
      r19.z = saturate(refProbeAttenuationConstantsCB[r18.z].data[2].w + r19.z);
      r18.w = r19.z * r18.w;
      r19.z = dot(refProbeAttenuationConstantsCB[r18.z].data[3].xyz, r16.xyz);
      r19.z = saturate(refProbeAttenuationConstantsCB[r18.z].data[3].w + r19.z);
      r18.w = r19.z * r18.w;
      r19.z = dot(refProbeAttenuationConstantsCB[r18.z].data[4].xyz, r16.xyz);
      r19.z = saturate(refProbeAttenuationConstantsCB[r18.z].data[4].w + r19.z);
      r18.w = r19.z * r18.w;
      r19.z = dot(refProbeAttenuationConstantsCB[r18.z].data[5].xyz, r16.xyz);
    ...
    r16.w = refProbeConstantsCB[r0.y].data[6].y * r12.w;
    r17.x = cmp(0 < r16.w);
    if (r17.x != 0) {
      r17.x = (int)r8.w & 3;
      r17.y = (int)r17.x + -1;
      r17.y = cmp((uint)r17.y < 32);
      r17.y = r2.z ? r17.y : 0;
      if (r17.y != 0) {
        r17.xy = mad((int2)r17.xx, int2(20,20), int2(860,876));
      // Known bad code for instruction (needs manual fix):
      ...
      r8.w = (int)r9.w + 257;
      r12.w = r12.w * refProbeConstantsCB[r0.y].data[6].y + r10.w;
      r16.w = refProbeConstantsCB[r0.y].data[7].y * r16.w;
      ...
      r17.w = cmp(r17.z >= 0);
      r6.w = max(abs(r17.z), r6.w);
      r6.w = r17.w ? r6.w : -r6.w;
      r17.y = max(1.00000001e-07, -r17.y);
      r6.w = r6.w / r17.y;
      r6.w = min(r17.x, abs(r6.w));
      r17.x = refProbeConstantsCB[r0.y].data[3].w + r16.x;
      r17.yz = refProbeConstantsCB[r0.y].data[4].xy + r16.yz;
      r17.xyz = r15.xyz * r6.www + r17.xyz;
      ...
      r19.w = (uint)r6.w;
      r17.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r19.xyzw, r3.z).xyz;
      r22.xyz = (int3)r17.xyz & int3(-2147483648,-2147483648,-2147483648);
      r22.xyz = cmp((int3)r22.xyz == int3(2139095040,2139095040,2139095040));
      r3.z = (int)r22.y | (int)r22.x;
      r3.z = (int)r22.z | (int)r3.z;
      r17.xyz = r3.zzz ? float3(1,1,0) : r17.xyz;
  ...
  r0.y = cmp(r10.w >= 1);
  bitmask.z = ((~(-1 << 8)) << 0) & 0xffffffff;  r3.z = (((uint)r8.w << 0) & bitmask.z) | ((uint)r9.w & ~bitmask.z);
  r0.y = r0.y ? r3.z : r8.w;
  r3.z = max(1, r12.w);
  r3.z = rcp(r3.z);
  ...
  if (r6.w != 0) {
    ...
    r16.xyz = r13.yzw * r3.zzz + r17.xyz;
    r15.w = 0;
    ...
    r3.z = r2.y * r3.z + r7.w;
    r14.yzw = r13.yzw * r3.zzz + r14.yzw;
  }
  r3.z = r2.x + r4.z;
  r3.z = log2(abs(r3.z));
  r3.z = r3.z * r1.w;
  ...
  r14.yzw = r14.yzw * r3.zzz;
  r15.xzw = r14.yzw * r15.xxx;
  r14.yzw = r14.yzw * r15.yyy;
  if (r2.z != 0) {
    r16.x = 3;
  ...
  if (r2.y != 0) {
    ...
    if (r2.y != 0) {
      ...
      r1.w = r1.w * r3.w;
      r2.x = cmp(0 < r2.w);
      r17.xyz = r1.www * r16.xyz + r13.yzw;
      ...
      r1.z = r3.w * r1.z;
      r1.z = 0.25 * r1.z;
      r3.xyz = r1.zzz * r16.xyz + r14.yzw;
      r0.w = saturate(1 + -r0.w);
      r1.w = r0.w * r0.w;
      r1.w = r1.w * r1.w;
      r0.w = r1.w * r0.w;
      r0.w = r1.z * r0.w;
      r11.xyz = r0.www * r16.xyz + r15.xzw;
      r13.yzw = r2.xxx ? r17.xyz : r13.yzw;
      r15.xzw = r2.xxx ? r11.xyz : r15.xzw;
