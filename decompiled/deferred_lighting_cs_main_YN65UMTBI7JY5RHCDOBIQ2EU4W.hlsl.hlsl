...
r0.y = samplerLinear[]..swiz;
  ...
  while (true) {
    ...
    if (r10.w != 0) {
      ...
      r19.x = r13.w * r13.z;
      r13.z = 1 & (int)refProbeConstantsCB[r9.w].data[6].x;
      r13.zw = r13.zz ? r19.xy : r19.zx;
      r14.w = refProbeConstantsCB[r9.w].data[6].x;
      r27.xy = r13.zw;
      r16.y = 1;
      while (true) {
        r16.z = cmp((int)r16.y >= (int)r12.w);
        if (r16.z != 0) break;
        r16.z = (int)r10.w + (int)r16.y;
        r16.z = (int)r16.z * 6;
        ...
        r16.w = r27.x * r16.w;
        r18.y = dot(refProbeAttenuationConstantsCB[r16.z].data[1].xyz, r15.yzw);
        r18.y = saturate(refProbeAttenuationConstantsCB[r16.z].data[1].w + r18.y);
        r16.w = r18.y * r16.w;
        r18.y = dot(refProbeAttenuationConstantsCB[r16.z].data[2].xyz, r15.yzw);
        r18.y = saturate(refProbeAttenuationConstantsCB[r16.z].data[2].w + r18.y);
        r16.w = r18.y * r16.w;
        r18.y = dot(refProbeAttenuationConstantsCB[r16.z].data[3].xyz, r15.yzw);
        r18.y = saturate(refProbeAttenuationConstantsCB[r16.z].data[3].w + r18.y);
        r16.w = r18.y * r16.w;
        r18.y = dot(refProbeAttenuationConstantsCB[r16.z].data[4].xyz, r15.yzw);
        r18.y = saturate(refProbeAttenuationConstantsCB[r16.z].data[4].w + r18.y);
        r16.w = r18.y * r16.w;
        r18.y = dot(refProbeAttenuationConstantsCB[r16.z].data[5].xyz, r15.yzw);
        r16.z = saturate(refProbeAttenuationConstantsCB[r16.z].data[5].w + r18.y);
        r27.x = r16.w * r16.z;
        r18.y = (uint)r14.w >> 2;
        if (1 == 0) r18.z = 0; else if (1+2 < 32) {         r18.z = (uint)r14.w << (32-(1 + 2)); r18.z = (uint)r18.z >> (32-1);        } else r18.z = (uint)r14.w >> 2;
        r18.w = (int)r18.y & 2;
        r19.x = max(r27.y, r27.x);
        r16.z = -r16.w * r16.z + 1;
        r16.z = r27.y * r16.z;
        r21.y = r18.w ? r16.z : r19.x;
        r27.xy = r18.zz ? r27.xy : r21.xy;
        r16.y = (int)r16.y + 1;
        r14.w = r18.y;
      }
      r27.y = saturate(r27.y);
      r10.w = refProbeConstantsCB[r9.w].data[6].y * r27.y;
      r12.w = cmp(0 < r10.w);
      if (r12.w != 0) {
        r12.w = (int)r26.w & 7;
        r13.z = (int)r12.w + -1;
        ...
        r25.w = (int)r25.w + 257;
        r25.z = r27.y * refProbeConstantsCB[r9.w].data[6].y + r25.z;
        r10.w = refProbeConstantsCB[r9.w].data[7].y * r10.w;
        r28.x = refProbeConstantsCB[r9.w].data[7].w;
        r28.yz = refProbeConstantsCB[r9.w].data[8].xy;
        r12.w = dot(r17.xyz, r28.xyz);
        r13.z = dot(r15.yzw, r28.xyz);
        r13.z = -refProbeConstantsCB[r9.w].data[8].z + r13.z;
        r13.w = cmp(r13.z >= 0);
        ...
        r28.x = refProbeConstantsCB[r9.w].data[8].w;
        r28.yz = refProbeConstantsCB[r9.w].data[9].xy;
        r13.z = dot(r17.xyz, r28.xyz);
        r13.w = dot(r15.yzw, r28.xyz);
        r13.w = -refProbeConstantsCB[r9.w].data[9].z + r13.w;
        r14.w = cmp(r13.w >= 0);
        ...
        r28.x = refProbeConstantsCB[r9.w].data[9].w;
        r28.yz = refProbeConstantsCB[r9.w].data[10].xy;
        r13.z = dot(r17.xyz, r28.xyz);
        r13.w = dot(r15.yzw, r28.xyz);
        r13.w = -refProbeConstantsCB[r9.w].data[10].z + r13.w;
        r14.w = cmp(r13.w >= 0);
        r13.w = max(abs(r13.w), r3.z);
        r13.w = r14.w ? r13.w : -r13.w;
        r13.z = max(1.00000001e-07, -r13.z);
        r13.z = r13.w / r13.z;
        r12.w = min(abs(r13.z), r12.w);
        r28.x = refProbeConstantsCB[r9.w].data[10].w;
        r28.yz = refProbeConstantsCB[r9.w].data[11].xy;
        r13.z = dot(r17.xyz, r28.xyz);
        r13.w = dot(r15.yzw, r28.xyz);
        r13.w = -refProbeConstantsCB[r9.w].data[11].z + r13.w;
        r14.w = cmp(r13.w >= 0);
        r13.w = max(abs(r13.w), r3.z);
        r13.w = r14.w ? r13.w : -r13.w;
        r13.z = max(1.00000001e-07, -r13.z);
        r13.z = r13.w / r13.z;
        r12.w = min(abs(r13.z), r12.w);
        r28.x = refProbeConstantsCB[r9.w].data[11].w;
        r28.yz = refProbeConstantsCB[r9.w].data[12].xy;
        r13.z = dot(r17.xyz, r28.xyz);
        r13.w = dot(r15.yzw, r28.xyz);
        r13.w = -refProbeConstantsCB[r9.w].data[12].z + r13.w;
        r14.w = cmp(r13.w >= 0);
        r13.w = max(abs(r13.w), r3.z);
        r13.w = r14.w ? r13.w : -r13.w;
        r13.z = max(1.00000001e-07, -r13.z);
        r13.z = r13.w / r13.z;
        r12.w = min(abs(r13.z), r12.w);
        r28.x = refProbeConstantsCB[r9.w].data[12].w;
        r28.yz = refProbeConstantsCB[r9.w].data[13].xy;
        r13.z = dot(r17.xyz, r28.xyz);
        r13.w = dot(r15.yzw, r28.xyz);
        r13.w = -refProbeConstantsCB[r9.w].data[13].z + r13.w;
        r14.w = cmp(r13.w >= 0);
        r13.w = max(abs(r13.w), r3.z);
        r13.w = r14.w ? r13.w : -r13.w;
        r13.z = max(1.00000001e-07, -r13.z);
        r13.z = r13.w / r13.z;
        r12.w = min(abs(r13.z), r12.w);
        r28.x = refProbeConstantsCB[r9.w].data[3].w + r15.y;
        r28.yz = refProbeConstantsCB[r9.w].data[4].xy + r15.zw;
        r16.yzw = r17.xyz * r12.www + r28.xyz;
        ...
        r28.x = refProbeConstantsCB[r9.w].data[0].w;
        r28.y = refProbeConstantsCB[r9.w].data[1].z;
        r28.z = refProbeConstantsCB[r9.w].data[2].y;
        r29.x = dot(r16.yzw, r28.xyz);
        r30.xy = refProbeConstantsCB[r9.w].data[1].xw;
        r30.z = refProbeConstantsCB[r9.w].data[2].z;
        r29.y = dot(r16.yzw, r30.xyz);
        r31.x = refProbeConstantsCB[r9.w].data[1].y;
        r31.yz = refProbeConstantsCB[r9.w].data[2].xw;
        r29.z = dot(r16.yzw, r31.xyz);
        if (9 == 0) r13.z = 0; else if (9+16 < 32) {         r13.z = (uint)refProbeConstantsCB[r9.w].data[7].z << (32-(9 + 16)); r13.z = (uint)r13.z >> (32-9);        } else r13.z = (uint)refProbeConstantsCB[r9.w].data[7].z >> 16;
        r29.w = (uint)r13.z;
        r16.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r29.xyzw, r12.w).xyz;
        r18.yzw = (int3)r16.yzw & int3(-2147483648,-2147483648,-2147483648);
        r18.yzw = cmp((int3)r18.yzw == int3(2139095040,2139095040,2139095040));
        r12.w = (int)r18.z | (int)r18.y;
        r12.w = (int)r18.w | (int)r12.w;
        r16.yzw = r12.www ? float3(1,1,0) : r16.yzw;
        r32.x = dot(r15.yzw, r28.xyz);
        r32.y = dot(r15.yzw, r30.xyz);
        r32.z = dot(r15.yzw, r31.xyz);
        r15.yzw = saturate(r32.xyz * refProbeConstantsCB[r9.w].data[3].xyz + float3(0.5,0.5,0.5));
        r32.xy = refProbeConstantsCB[r9.w].data[4].zw * r15.yz;
        r32.z = refProbeConstantsCB[r9.w].data[5].x * r15.w;
        r15.yzw = refProbeConstantsCB[r9.w].data[5].yzw + r32.xyz;
        ...
        r18.yzw = r9.www ? float3(1,1,0) : r18.yzw;
        r27.xzw = r18.yzw * r15.yzw;
        r9.w = dot(r27.xzw, float3(0.212599993,0.715200007,0.0722000003));
        r24.xyz = r15.yzw * r18.yzw + r24.xyz;
        r12.w = r9.w * r3.w;
        r15.yzw = r16.yzw * r10.www;
        r10.w = dot(r15.yzw, float3(0.212599993,0.715200007,0.0722000003));
        r9.w = r3.w * r9.w + r10.w;
        r9.w = r12.w / r9.w;
        r28.x = r24.w;
        r28.yz = r25.xy;
        r15.yzw = r15.yzw * r9.www + r28.xyz;
        r24.w = r15.y;
        r25.xy = r15.zw;
      } else {
        r26.xyz = r25.xyz;
  ...
  while (true) {
    ...
    if (r10.w != 0) {
      ...
      r21.y = (int)r13.w + 1;
      r16.yzw = -refProbeConstantsCB[r9.w].data[0].xyz + r5.xyz;
      r10.w = 0x0000ffff & (int)refProbeConstantsCB[r9.w].data[7].z;
      if (6 == 0) r12.w = 0; else if (6+25 < 32) {       r12.w = (uint)refProbeConstantsCB[r9.w].data[7].z << (32-(6 + 25)); r12.w = (uint)r12.w >> (32-6);      } else r12.w = (uint)refProbeConstantsCB[r9.w].data[7].z >> 25;
      r14.w = (int)r10.w * 6;
      r18.y = dot(refProbeAttenuationConstantsCB[r14.w].data[0].xyz, r16.yzw);
      r18.y = saturate(refProbeAttenuationConstantsCB[r14.w].data[0].w + r18.y);
      r18.z = dot(refProbeAttenuationConstantsCB[r14.w].data[1].xyz, r16.yzw);
      r18.z = saturate(refProbeAttenuationConstantsCB[r14.w].data[1].w + r18.z);
      r18.y = r18.y * r18.z;
      r18.z = dot(refProbeAttenuationConstantsCB[r14.w].data[2].xyz, r16.yzw);
      r18.z = saturate(refProbeAttenuationConstantsCB[r14.w].data[2].w + r18.z);
      r18.y = r18.y * r18.z;
      r18.z = dot(refProbeAttenuationConstantsCB[r14.w].data[3].xyz, r16.yzw);
      r18.z = saturate(refProbeAttenuationConstantsCB[r14.w].data[3].w + r18.z);
      r18.y = r18.y * r18.z;
      r18.z = dot(refProbeAttenuationConstantsCB[r14.w].data[4].xyz, r16.yzw);
      r18.z = saturate(refProbeAttenuationConstantsCB[r14.w].data[4].w + r18.z);
      r18.y = r18.y * r18.z;
      r18.z = dot(refProbeAttenuationConstantsCB[r14.w].data[5].xyz, r16.yzw);
      r14.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[5].w + r18.z);
      r19.x = r18.y * r14.w;
      r14.w = 1 & (int)refProbeConstantsCB[r9.w].data[6].x;
      r18.yz = r14.ww ? r19.xy : r19.zx;
      r14.w = refProbeConstantsCB[r9.w].data[6].x;
      r27.xy = r18.yz;
      r18.w = 1;
      while (true) {
        r19.x = cmp((int)r18.w >= (int)r12.w);
        if (r19.x != 0) break;
        r19.x = (int)r10.w + (int)r18.w;
        r19.x = (int)r19.x * 6;
        ...
        r19.x = -r19.w * r19.x + 1;
        r19.x = r27.y * r19.x;
        r21.w = r23.w ? r19.x : r26.w;
        r27.xy = r22.ww ? r27.xy : r21.zw;
        r18.w = (int)r18.w + 1;
        r14.w = r20.w;
      }
      r10.w = saturate(r27.y + -r25.z);
      ...
      if (r14.w != 0) {
        ...
        r18.y = r2.z ? r18.y : 0;
        if (r18.y != 0) {
          r18.yz = mad((int2)r14.ww, int2(20,20), int2(860,876));
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r14.w, cb2[52].x, r18.y, u2.xxxx
        ...
        r13.w = (int)r13.w + 257;
        r13.z = r10.w * refProbeConstantsCB[r9.w].data[6].y + r13.z;
        ...
        r18.y = dot(r16.yzw, r28.xyz);
        r18.y = -refProbeConstantsCB[r9.w].data[9].z + r18.y;
        r18.z = cmp(r18.y >= 0);
        ...
        r14.w = dot(r17.xyz, r28.xyz);
        r18.y = dot(r16.yzw, r28.xyz);
        r18.y = -refProbeConstantsCB[r9.w].data[10].z + r18.y;
        r18.z = cmp(r18.y >= 0);
        r18.y = max(abs(r18.y), r3.z);
        r18.y = r18.z ? r18.y : -r18.y;
        r14.w = max(1.00000001e-07, -r14.w);
        ...
        r14.w = dot(r17.xyz, r28.xyz);
        r18.y = dot(r16.yzw, r28.xyz);
        r18.y = -refProbeConstantsCB[r9.w].data[11].z + r18.y;
        r18.z = cmp(r18.y >= 0);
        r18.y = max(abs(r18.y), r3.z);
        r18.y = r18.z ? r18.y : -r18.y;
        r14.w = max(1.00000001e-07, -r14.w);
        ...
        r14.w = dot(r17.xyz, r28.xyz);
        r18.y = dot(r16.yzw, r28.xyz);
        r18.y = -refProbeConstantsCB[r9.w].data[12].z + r18.y;
        r18.z = cmp(r18.y >= 0);
        r18.y = max(abs(r18.y), r3.z);
        r18.y = r18.z ? r18.y : -r18.y;
        r14.w = max(1.00000001e-07, -r14.w);
        ...
        r14.w = dot(r17.xyz, r28.xyz);
        r18.y = dot(r16.yzw, r28.xyz);
        r18.y = -refProbeConstantsCB[r9.w].data[13].z + r18.y;
        r18.z = cmp(r18.y >= 0);
        r18.y = max(abs(r18.y), r3.z);
        r18.y = r18.z ? r18.y : -r18.y;
        r14.w = max(1.00000001e-07, -r14.w);
        r14.w = r18.y / r14.w;
        r12.w = min(abs(r14.w), r12.w);
        r28.x = refProbeConstantsCB[r9.w].data[3].w + r16.y;
        r28.yz = refProbeConstantsCB[r9.w].data[4].xy + r16.zw;
        r18.yzw = r17.xyz * r12.www + r28.xyz;
        ...
        r29.w = (uint)r14.w;
        r18.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r29.xyzw, r12.w).xyz;
        r27.xzw = (int3)r18.yzw & int3(-2147483648,-2147483648,-2147483648);
        r27.xzw = cmp((int3)r27.xzw == int3(2139095040,2139095040,2139095040));
        r12.w = (int)r27.z | (int)r27.x;
        ...
        r16.yzw = saturate(r32.xyz * refProbeConstantsCB[r9.w].data[3].xyz + float3(0.5,0.5,0.5));
        r32.xy = refProbeConstantsCB[r9.w].data[4].zw * r16.yz;
        r32.z = refProbeConstantsCB[r9.w].data[5].x * r16.w;
        r16.yzw = refProbeConstantsCB[r9.w].data[5].yzw + r32.xyz;
        r29.x = dot(r11.xyz, r28.xyz);
        r29.y = dot(r11.xyz, r30.xyz);
        r29.z = dot(r11.xyz, r31.xyz);
  ...
  r0.y = cmp(r25.z >= 1);
  bitmask.w = ((~(-1 << 8)) << 0) & 0xffffffff;  r2.w = (((uint)r13.w << 0) & bitmask.w) | ((uint)r25.w & ~bitmask.w);
  r0.y = r0.y ? r2.w : r13.w;
  r2.w = max(1, r13.z);
  r2.w = rcp(r2.w);
  r13.z = saturate(r13.z);
  r16.yzw = r15.yzw * r2.www;
  r18.xyz = r26.xyz * r2.www;
  r3.z = cmp(r13.z < 0.99000001);
  if (r3.z != 0) {
    r0.y = (int)r0.y + 256;
    r3.z = 1 + -r13.z;
    ...
    r16.yzw = r15.yzw * r2.www + r19.xyz;
    r17.w = 0;
    ...
    r2.w = r2.y * r2.w + r3.w;
    r18.xyz = r15.yzw * r2.www + r18.xyz;
  }
  r2.w = r2.x + r4.z;
  r2.w = log2(abs(r2.w));
  r2.w = r2.w * r1.w;
