  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r0.w = max(0, r0.w);
  r2.z = sqrt(r0.w);
  r3.xyz = detailMap.Sample(normalSampler_s, r1.xy).xyz;
  ...
  r2.xy = r1.xy * detailScaleHeight + r0.xy;
  ...
  r0.xyw = r3.xyz * r0.www + r1.xyz;
  r1.x = r3.x + r3.y;
  r1.x = r2.z * r1.w + r1.x;
  r1.x = 0.5 * r1.x;
  r1.y = dot(r0.xyw, r0.xyw);
  r1.y = rsqrt(r1.y);
  r3.yzw = r1.yyy * r0.xyw;
  r4.yzw = float3(1,-1,-1) * r3.yzw;
  r4.x = 1;
  r3.x = 0;
  r0.xyw = r2.xyz * r1.www + -r1.xxx;
  r1.y = max(r0.y, r0.w);
  r1.y = max(r1.y, r0.x);
  r1.x = max(r1.x, r1.y);
  r0.x = cmp(r0.x == r1.x);
