...
if_nz r2.x
  ...
  mad r0.xy, -r0.xyxx, r1.zyzz, v1.yxyy
  sample_l_indexable(texture2d)(float,float,float,float) r2.xz, r0.yxyy, t4.xzyw, s0, l(0.000000)
  add r3.xy, |r2.xzxx|, l(-0.500000, -0.500000, 0.000000, 0.000000)
  add_sat r3.xy, r3.xyxx, r3.xyxx
  add r3.zw, |r2.xxxz|, |r2.xxxz|
  ...
  movc r2.xz, r2.xxzx, r3.xxyx, -r3.xxyx
  gather4_indexable(texture2d)(float,float,float,float) r3.xyzw, r0.yxyy, t6.xyzw, s0.x
  mad r0.xy, r0.xyxx, cb1[44].yxyy, l(-0.49804688, -0.49804688, 0.000000, 0.000000)
  ftoi r4.xy, r0.yxyy
  iadd r5.xy, r4.yxyy, l(1, 1, 0, 0)
  mov r4.z, r5.x
  mov r4.w, l(0)
  ld_indexable(texture2d)(float,float,float,float) r2.w, r4.xzww, t1.yzwx
  mov r5.z, l(0)
  ...
  mul r4.y, r4.y, r4.w
  frc r0.xy, r0.xyxx
  add r5.yz, -r0.yyxy, l(0.000000, 1.000000, 1.000000, 0.000000)
  mul r4.w, r0.x, r0.y
  mul r0.xy, r0.xyxx, r5.yzyy
  mul r5.y, r5.z, r5.y
  add r2.w, r1.w, -r2.w
  mad_sat r2.w, -r2.y, r2.w, l(1.000000)
  add r3.xyzw, -r1.xxxx, r3.xyzw
  mad r2.w, r2.w, r3.x, r1.x
  add r3.x, r1.w, -r4.z
  mad_sat r3.x, -r2.y, r3.x, l(1.000000)
  mad r3.x, r3.x, r3.y, r1.x
  mul r3.x, r3.x, r4.w
  mad r0.x, r0.x, r2.w, r3.x
  add r2.w, r1.w, -r5.x
  mad_sat r2.w, -r2.y, r2.w, l(1.000000)
  mad r2.w, r2.w, r3.z, r1.x
  mad r0.x, r0.y, r2.w, r0.x
  add r0.y, r1.w, -r4.x
  mad_sat r0.y, -r2.y, r0.y, l(1.000000)
  mad r0.y, r0.y, r3.w, r1.x
  mad r0.x, r5.y, r0.y, r0.x
  ...
  sample_l_indexable(texture2d)(float,float,float,float) r0.w, r3.xyxx, t5.yzwx, s0, l(0.000000)
