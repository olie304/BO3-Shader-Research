...
add r2.w, cb0[14].z, l(0.000010)
mad r4.xy, r4.xyxx, r2.wwww, v2.xyxx
...
exp r1.w, r1.w
movc r1.w, cb0[14].y, r1.w, r2.w
eq r2.w, cb0[13].x, l(0.000000)
movc r1.w, r2.w, l(1.000000), r1.w
mul r2.w, r4.w, cb0[12].w
mul r1.w, r1.w, r2.w
mul r1.z, r1.z, r1.w
...
add r1.w, r1.w, r1.w
mad r13.xyz, r3.xyzx, -r1.wwww, -r9.xyzx
...
if_z r6.w
  ...
  if_nz r5.w
    ...
    mad r22.xyz, r12.yzwy, r3.wwww, r22.xyzx
  endif 
else 
  mov r22.x, r21.w
endif 
...
if_nz r7.w
  ...
  if_nz r7.w
    ...
    mov r16.w, r10.z
    mov r14.w, r15.z
    movc r14.xyzw, r6.zzzz, r16.xyzw, r14.xyzw
    mov r10.zw, r8.yyyz
    mov r15.zw, r5.yyyz
    movc r10.xyzw, r6.zzzz, r10.xyzw, r15.xyzw
...
ret 
// Approximately 2582 instruction slots used
