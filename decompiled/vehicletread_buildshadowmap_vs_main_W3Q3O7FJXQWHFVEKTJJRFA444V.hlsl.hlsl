...
r1.w = colorSampler[]..swiz;
  ...
  if (r0.y != 0) {
    ...
    r3.w = colorSampler[]..swiz;
      ...
      r0.z = r0.z + r3.w;
      r2.yz = v2.xx * r0.wz;
      r0.z = cmp(v2.y != 0.000000);
      if (r0.z != 0) {
        r0.z = (int)r0.y + (int)v3.y;
      // Known bad code for instruction (needs manual fix):
      ...
      r3.w = colorSampler[]..swiz;
        ...
        r0.z = r0.z + r3.w;
        r2.z = r0.z * v2.y + r2.z;
        r0.z = cmp(v2.z != 0.000000);
        if (r0.z != 0) {
          r0.z = (int)r0.y + (int)v3.z;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r3.xyzw, r0.z, l(0), t5.xyzw
        r3.x = colorSampler[]..swiz;
        r3.y = colorSampler[]..swiz;
        ...
        r3.w = colorSampler[]..swiz;
          ...
          r0.z = r0.z + r3.w;
          r2.z = r0.z * v2.z + r2.z;
          r0.z = cmp(v2.w != 0.000000);
          if (r0.z != 0) {
            r0.y = (int)r0.y + (int)v3.w;
          // Known bad code for instruction (needs manual fix):
...
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) r0.zw, r0.z, l(16), t0.xxxy
r0.z = colorSampler[]..swiz;
r0.w = colorSampler[]..swiz;
  r1.x = cmp(reverseTread != 0.000000);
  r0.z = r1.x ? r0.w : r0.z;
  r0.zw = r0.zz * scrollUVs.xy + v1.xy;
  r0.z = treadHeightMap.SampleLevel(colorSampler_s, r0.zw, 0).x;
...
r3.z = colorSampler[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r4.xyz, r0.x, l(16), t5.xyzx
r4.x = colorSampler[]..swiz;
r4.y = colorSampler[]..swiz;
r4.z = colorSampler[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r0.xyw, r0.x, l(32), t5.xyxz
r0.x = colorSampler[]..swiz;
r0.y = colorSampler[]..swiz;
r0.w = colorSampler[]..swiz;
  r3.x = dot(r1.xyz, r3.xyz);
  r3.y = dot(r1.xyz, r4.xyz);
  r3.z = dot(r1.xyz, r0.xyw);
// Known bad code for instruction (needs manual fix):
