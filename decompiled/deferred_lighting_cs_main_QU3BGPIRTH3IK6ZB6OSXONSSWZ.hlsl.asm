...
uge r0.y, r17.x, r15.z
ult r15.w, r17.x, cb2[0].y
and r0.y, r0.y, r15.w
if_nz r0.y
  imul null, r0.y, r17.x, l(14)
  if_nz r3.w
  ...
  ubfe r17.z, l(6), l(25), cb10[r0.y + 7].z
  ...
  endloop 
  mov_sat r21.y, r21.y
  mul r15.w, r21.y, cb10[r0.y + 6].y
  lt r17.z, l(0.000000), r15.w
  if_nz r17.z
    if_nz r3.w
      ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r17.z, cb2[52].x, l(880), u2.xxxx
      or r17.z, r17.z, l(32)
      store_structured u2.x, cb2[52].x, l(880), r17.z
      store_structured u2.x, cb2[52].x, l(896), r15.w
    endif 
    mul r17.z, r15.w, cb10[r0.y + 7].y
    ...
    mad r19.xyz, r16.xyzx, r17.wwww, r19.xyzx
    ...
    ubfe r18.w, l(9), l(16), cb10[r0.y + 7].z
    utof r21.w, r18.w
    ...
    or r17.w, r24.y, r24.x
    or r17.w, r24.z, r17.w
    movc r19.xyz, r17.wwww, l(1.000000,1.000000,0,0), r19.xyzx
...
ult r15.z, r17.x, r15.z
if_nz r15.z
  imul null, r15.z, r17.x, l(14)
  if_nz r3.w
    and r17.x, r0.y, l(1)
    imad r17.x, r17.x, l(20), l(880)
    add r20.yzw, cb1[24].xxyz, cb10[r15.z + 0].xxyz
    mov r20.x, l(16)
    store_structured u2.xyzw, cb2[52].x, r17.x, r20.xyzw
  endif 
  iadd r17.x, r0.y, l(1)
  add r20.xyz, r5.xyzx, -cb10[r15.z + 0].xyzx
  and r17.z, l(0x0000ffff), cb10[r15.z + 7].z
  ubfe r17.w, l(6), l(25), cb10[r15.z + 7].z
  imul null, r18.w, r17.z, l(6)
  dp3 r19.w, cb11[r18.w + 0].xyzx, r20.xyzx
  add_sat r19.w, r19.w, cb11[r18.w + 0].w
  dp3 r20.w, cb11[r18.w + 1].xyzx, r20.xyzx
  add_sat r20.w, r20.w, cb11[r18.w + 1].w
  mul r19.w, r19.w, r20.w
  dp3 r20.w, cb11[r18.w + 2].xyzx, r20.xyzx
  add_sat r20.w, r20.w, cb11[r18.w + 2].w
  mul r19.w, r19.w, r20.w
  dp3 r20.w, cb11[r18.w + 3].xyzx, r20.xyzx
  add_sat r20.w, r20.w, cb11[r18.w + 3].w
  mul r19.w, r19.w, r20.w
  dp3 r20.w, cb11[r18.w + 4].xyzx, r20.xyzx
  add_sat r20.w, r20.w, cb11[r18.w + 4].w
  mul r19.w, r19.w, r20.w
  dp3 r20.w, cb11[r18.w + 5].xyzx, r20.xyzx
  add_sat r18.w, r20.w, cb11[r18.w + 5].w
  mul r21.x, r18.w, r19.w
  and r18.w, l(1), cb10[r15.z + 6].x
  mov r21.yz, l(0,0,1.000000,0)
  movc r21.xy, r18.wwww, r21.xyxx, r21.zxzz
  ...
  loop 
    ...
    breakc_nz r20.w
    iadd r20.w, r17.z, r19.w
    imul null, r20.w, r20.w, l(6)
    dp3 r21.z, cb11[r20.w + 0].xyzx, r20.xyzx
    add_sat r21.z, r21.z, cb11[r20.w + 0].w
    mul r21.z, r21.z, r23.x
    dp3 r21.w, cb11[r20.w + 1].xyzx, r20.xyzx
    add_sat r21.w, r21.w, cb11[r20.w + 1].w
    mul r21.z, r21.w, r21.z
    dp3 r21.w, cb11[r20.w + 2].xyzx, r20.xyzx
    add_sat r21.w, r21.w, cb11[r20.w + 2].w
    mul r21.z, r21.w, r21.z
    dp3 r21.w, cb11[r20.w + 3].xyzx, r20.xyzx
    add_sat r21.w, r21.w, cb11[r20.w + 3].w
    mul r21.z, r21.w, r21.z
    dp3 r21.w, cb11[r20.w + 4].xyzx, r20.xyzx
    add_sat r21.w, r21.w, cb11[r20.w + 4].w
    mul r21.z, r21.w, r21.z
    dp3 r21.w, cb11[r20.w + 5].xyzx, r20.xyzx
    add_sat r20.w, r21.w, cb11[r20.w + 5].w
    mul r23.x, r20.w, r21.z
    ushr r21.w, r18.w, l(2)
    ubfe r22.z, l(1), l(2), r18.w
    and r22.w, r21.w, l(2)
    max r23.z, r23.x, r23.y
    mad r20.w, -r21.z, r20.w, l(1.000000)
    mul r20.w, r20.w, r23.y
    movc r22.y, r22.w, r20.w, r23.z
    movc r23.xy, r22.zzzz, r23.xyxx, r22.xyxx
    iadd r19.w, r19.w, l(1)
    mov r18.w, r21.w
  endloop 
  add_sat r17.z, -r15.w, r23.y
  mul r17.w, r17.z, cb10[r15.z + 6].y
  ...
  if_nz r18.w
    ...
    if_nz r19.w
      imad r21.xy, r18.wwww, l(20, 20, 0, 0), l(860, 876, 0, 0)
      ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r18.w, cb2[52].x, r21.x, u2.xxxx
      or r18.w, r18.w, l(32)
      store_structured u2.x, cb2[52].x, r21.x, r18.w
      store_structured u2.x, cb2[52].x, r21.y, r17.w
    endif 
    iadd r17.x, r0.y, l(257)
    mad r17.z, r17.z, cb10[r15.z + 6].y, r15.w
    mul r17.w, r17.w, cb10[r15.z + 7].y
    mov r21.x, cb10[r15.z + 7].w
    mov r21.yz, cb10[r15.z + 8].xxyx
    dp3 r18.w, r16.xyzx, r21.xyzx
    dp3 r19.w, r20.xyzx, r21.xyzx
    add r19.w, r19.w, -cb10[r15.z + 8].z
    ...
    mov r21.x, cb10[r15.z + 8].w
    mov r21.yz, cb10[r15.z + 9].xxyx
    dp3 r19.w, r16.xyzx, r21.xyzx
    dp3 r20.w, r20.xyzx, r21.xyzx
    add r20.w, r20.w, -cb10[r15.z + 9].z
    ...
    mov r21.x, cb10[r15.z + 9].w
    mov r21.yz, cb10[r15.z + 10].xxyx
    dp3 r19.w, r16.xyzx, r21.xyzx
    dp3 r20.w, r20.xyzx, r21.xyzx
    add r20.w, r20.w, -cb10[r15.z + 10].z
    ge r21.x, r20.w, l(0.000000)
    max r20.w, r13.w, |r20.w|
    movc r20.w, r21.x, r20.w, -r20.w
    max r19.w, -r19.w, l(0.00000010)
    div r19.w, r20.w, r19.w
    min r18.w, r18.w, |r19.w|
    mov r21.x, cb10[r15.z + 10].w
    mov r21.yz, cb10[r15.z + 11].xxyx
    dp3 r19.w, r16.xyzx, r21.xyzx
    dp3 r20.w, r20.xyzx, r21.xyzx
    add r20.w, r20.w, -cb10[r15.z + 11].z
    ge r21.x, r20.w, l(0.000000)
    max r20.w, r13.w, |r20.w|
    movc r20.w, r21.x, r20.w, -r20.w
    max r19.w, -r19.w, l(0.00000010)
    div r19.w, r20.w, r19.w
    min r18.w, r18.w, |r19.w|
    mov r21.x, cb10[r15.z + 11].w
    mov r21.yz, cb10[r15.z + 12].xxyx
    dp3 r19.w, r16.xyzx, r21.xyzx
    dp3 r20.w, r20.xyzx, r21.xyzx
    add r20.w, r20.w, -cb10[r15.z + 12].z
    ge r21.x, r20.w, l(0.000000)
    max r20.w, r13.w, |r20.w|
    movc r20.w, r21.x, r20.w, -r20.w
    max r19.w, -r19.w, l(0.00000010)
    div r19.w, r20.w, r19.w
    min r18.w, r18.w, |r19.w|
    mov r21.x, cb10[r15.z + 12].w
    mov r21.yz, cb10[r15.z + 13].xxyx
    dp3 r19.w, r16.xyzx, r21.xyzx
    dp3 r20.w, r20.xyzx, r21.xyzx
    add r20.w, r20.w, -cb10[r15.z + 13].z
    ge r21.x, r20.w, l(0.000000)
    max r13.w, r13.w, |r20.w|
    movc r13.w, r21.x, r13.w, -r13.w
    max r19.w, -r19.w, l(0.00000010)
    div r13.w, r13.w, r19.w
    min r13.w, |r13.w|, r18.w
    add r21.x, r20.x, cb10[r15.z + 3].w
    add r21.yz, r20.yyzy, cb10[r15.z + 4].xxyx
    mad r21.xyz, r16.xyzx, r13.wwww, r21.xyzx
    ...
    mov r22.x, cb10[r15.z + 0].w
    mov r22.y, cb10[r15.z + 1].z
    mov r22.z, cb10[r15.z + 2].y
    dp3 r23.x, r21.xyzx, r22.xyzx
    mov r24.xy, cb10[r15.z + 1].xwxx
    mov r24.z, cb10[r15.z + 2].z
    dp3 r23.y, r21.xyzx, r24.xyzx
    mov r25.x, cb10[r15.z + 1].y
    mov r25.yz, cb10[r15.z + 2].xxwx
    dp3 r23.z, r21.xyzx, r25.xyzx
    ubfe r13.w, l(9), l(16), cb10[r15.z + 7].z
    utof r23.w, r13.w
    sample_l_indexable(texturecubearray)(float,float,float,float) r21.xyz, r23.xyzw, t8.xyzw, s2, r9.w
    ...
    mad_sat r20.xyz, r26.xyzx, cb10[r15.z + 3].xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
    mul r26.xy, r20.xyxx, cb10[r15.z + 4].zwzz
    mul r26.z, r20.z, cb10[r15.z + 5].x
    add r20.xyz, r26.xyzx, cb10[r15.z + 5].yzwy
    ...
    mul r13.w, r9.w, r15.y
    mul r20.xyz, r17.wwww, r21.xyzx
    dp3 r15.z, r20.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
    mad r9.w, r15.y, r9.w, r15.z
    div r9.w, r13.w, r9.w
    mad r19.xyz, r20.xyzx, r9.wwww, r19.xyzx
  else 
    mov r17.z, r15.w
  endif 
else 
...
ge r9.w, r15.w, l(1.000000)
bfi r0.y, l(8), l(0), r17.x, r0.y
movc r0.y, r9.w, r0.y, r17.x
max r9.w, r17.z, l(1.000000)
rcp r9.w, r9.w
mov_sat r17.z, r17.z
mul r15.yzw, r9.wwww, r18.xxyz
...
if_nz r13.w
  ...
  mad r19.xyz, r17.xzwx, r9.wwww, r19.xyzx
endif 
...
ret 
// Approximately 2508 instruction slots used
