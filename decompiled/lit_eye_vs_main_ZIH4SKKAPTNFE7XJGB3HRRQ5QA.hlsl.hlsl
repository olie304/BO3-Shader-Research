...
r0.z = gpuSkinBase[]..swiz;
  ...
  r3.y = r2.x;
  r3.z = r0.x;
  r3.xyz = r0.www ? r3.xyz : float3(1,0,0);
  r4.x = r1.y;
  r4.y = r2.y;
  r4.z = r0.y;
  r1.xyw = r0.www ? r4.xyz : float3(0,1,0);
  r0.x = r1.z;
  r0.y = r2.z;
  r0.xyz = r0.www ? r0.xyz : float3(0,0,1);
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r1.z, v7.x, l(12), t4.xxxx
r1.z = gpuSkinBase[]..swiz;
...
r5.z = gpuSkinBase[]..swiz;
  p2.x = dot(r3.xyz, r2.xyz);
  p2.y = dot(r3.xyz, r4.xyz);
  p2.z = dot(r3.xyz, r5.xyz);
  o7.x = dot(r1.xyw, r2.xyz);
  o7.y = dot(r1.xyw, r4.xyz);
  o7.z = dot(r1.xyw, r5.xyz);
  o8.x = dot(r0.xyz, r2.xyz);
