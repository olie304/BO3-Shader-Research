...
mov r4.xyz, v0.xyzx
mov r4.w, l(1.000000)
dp4 r5.y, r4.xyzw, r2.xyzw
mul r6.xyzw, r5.yyyy, cb1[9].xyzw
mov r3.w, r1.x
mov r0.w, r1.z
dp4 r5.x, r4.xyzw, r3.xyzw
mad r1.xyzw, r5.xxxx, cb1[8].xyzw, r6.xyzw
dp4 r5.z, r4.xyzw, r0.xyzw
mad r1.xyzw, r5.zzzz, cb1[10].xyzw, r1.xyzw
mov o5.xyz, r5.xyzx
...
dp3 r4.z, r1.xyzx, r0.xyzx
dp3 r0.w, r4.xyzx, r4.xyzx
rsq r0.w, r0.w
mul o2.xyz, r0.wwww, r4.xyzx
mad r4.xyz, v4.xyzx, l(2.001957, 2.001957, 2.001957, 0.000000), l(-1.00195694, -1.00195694, -1.00195694, 0.000000)
...
mad r1.xyz, r1.yzxy, r4.zxyz, -r5.xyzx
