...
// unknown dcl_: dcl_resource_structured t23, 4
      ...
      r14.y = samp0[]..swiz;
        ...
        r31.w = samp0[]..swiz;
          ...
          r37.y = samp0[]..swiz;
            ...
            r32.x = dot(r5.xyz, r24.xyz);
            r32.y = dot(r5.xyz, r25.xyz);
            r32.z = dot(r5.xyz, r28.xyz);
  ...
  if (r7.w != 0) {
    ...
    if (r7.w != 0) {
      ...
      r0.x = r7.z * r0.x;
      r0.x = r6.w * r0.x;
      r17.xyz = r0.xxx * r9.zwy + r14.xyz;
      r15.w = r17.z;
      r13.w = r14.z;
      r13.xyzw = r10.yyyy ? r15.xyzw : r13.xyzw;
      r17.zw = r16.xy;
      r14.zw = r2.xy;
      r15.xyzw = r10.yyyy ? r17.xyzw : r14.xyzw;
            ...
            r39.w = samp0[]..swiz;
              ...
              if (r14.w != 0) {
                ...
                if (r14.w != 0) {
                  ...
                  r18.x = -abs(r13.w) * r6.w + 1;
                  r18.x = r18.x * r18.x;
                  r18.x = -r18.x * 0.620000005 + 0.620000005;
                  r18.x = r18.x + -abs(r13.w);
                  r18.x = r3.w * r18.x + abs(r13.w);
                  r18.x = r18.x * r11.w;
                  r21.x = cmp(0 < r13.w);
                  r22.xyz = r18.xxx * r20.xyw + r16.xyz;
                  r13.w = saturate(r13.w);
                  r19.xyz = r19.xyz * r12.www + r0.yzw;
                  r12.w = dot(r19.xyz, r19.xyz);
                  r12.w = rsqrt(r12.w);
                  r19.xyz = r19.xyz * r12.www;
                  r12.w = dot(r19.xyz, r0.yzw);
                  r18.x = dot(r5.xyz, r19.xyz);
                  r19.x = abs(r18.x) * r3.y + -abs(r18.x);
                  r18.x = abs(r18.x) * r19.x + 1;
                  r19.x = r13.w * r4.w + r5.w;
                  r18.x = r18.x * r18.x;
                  r18.x = r18.x * r19.x;
                  r18.x = rcp(r18.x);
                  r13.w = r13.w * r14.w;
