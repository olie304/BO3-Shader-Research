...
movc r3.xy, cb0[20].xxxx, r3.zwzz, r3.xyxx
...
movc r6.xy, cb0[20].yyyy, r6.zwzz, r6.xyxx
sample_indexable(texture2d)(float,float,float,float) r7.xyzw, r6.xyxx, t15.xyzw, s1
add r8.xyz, cb0[18].xyzx, l(-1.000000, -1.000000, -1.000000, 0.000000)
...
add r9.xyz, cb0[23].xyzx, l(-0.040000, -0.040000, -0.040000, 0.000000)
...
movc r1.yz, cb0[22].wwww, r1.yyzy, r6.zzwz
sample_indexable(texture2d)(float,float,float,float) r11.xyzw, r1.yzyy, t17.xyzw, s1
add r12.xyz, cb0[21].xyzx, l(-1.000000, -1.000000, -1.000000, 0.000000)
...
add r14.xyz, cb0[24].xyzx, l(-0.040000, -0.040000, -0.040000, 0.000000)
...
add r2.w, -cb0[19].x, cb0[19].y
mad r1.z, r1.z, r2.w, cb0[19].x
mul_sat r1.zw, r1.zzzw, l(0.000000, 0.000000, 0.05882353, 0.05882353)
mul_sat r2.w, cb0[22].y, l(0.05882353)
add r1.z, -r1.w, r1.z
mad r1.z, r0.x, r1.z, r1.w
add r1.w, -r1.z, r2.w
mad r1.z, r0.y, r1.w, r1.z
sample_indexable(texture2d)(float,float,float,float) r1.w, v1.yzyy, t10.yzwx, s4
...
mad r1.yzw, v3.xxyz, r2.xxxx, -r0.xxyz
mad r5.yzw, cb1[60].wwww, r1.yyzw, r0.xxyz
add r0.x, r3.y, r3.x
mad r0.x, r2.w, r1.x, r0.x
mul r0.x, r0.x, l(0.500000)
mad r1.xyz, r2.yzwy, r1.xxxx, -r0.xxxx
max r0.y, r1.z, r1.y
max r0.y, r0.y, r1.x
max r0.x, r0.y, r0.x
eq r0.y, r0.x, r1.x
