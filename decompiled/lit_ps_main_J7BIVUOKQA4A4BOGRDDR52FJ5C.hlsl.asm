...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:37:59 2021
//
//
// Buffer Definitions: 
//
...
dcl_output o0.xyzw
dcl_temps 45
sample_indexable(texture2d)(float,float,float,float) r0.xyz, v1.yzyy, t21.xyzw, s3
...
sample_indexable(texture2d)(float,float,float,float) r1.x, v1.yzyy, t24.xyzw, s5
...
sample_indexable(texture2d)(float,float,float,float) r1.x, v1.yzyy, t29.xyzw, s7
sample_indexable(texture2d)(float,float,float,float) r2.x, v1.yzyy, t26.xyzw, s5
add r2.y, -cb0[13].x, cb0[13].y
mad r2.x, r2.x, r2.y, cb0[13].x
...
mad r3.xzw, r4.xxyz, r3.xxxx, r5.xxyz
dp3 r2.z, r3.xzwx, r3.xzwx
rsq r2.z, r2.z
mul r3.xzw, r2.zzzz, r3.xxzw
mad r2.y, cb1[62].x, r2.y, cb0[13].x
...
if_nz r2.z
  ftoi r2.z, cb1[64].w
  lod r2.w, v1.yzyy, t21.y, s3
  lod r3.y, v1.yzyy, t21.x, s3
  lt r2.w, r2.w, r3.y
  ...
  movc r4.xyw, r3.yyyy, r5.xyxz, r4.xyxw
  movc r5.xyz, r4.zzzz, l(0,1.000000,0,0), r0.xyzx
  movc r0.xyz, r2.wwww, r4.xywx, r5.xyzx
endif 
add r4.xyz, -r0.xyzx, cb1[58].xyzx
mad r0.xyz, cb1[58].wwww, r4.xyzx, r0.xyzx
add r2.z, -r0.w, cb1[59].x
mad o0.w, cb1[59].w, r2.z, r0.w
add r4.xyz, -r1.yzwy, cb1[61].xyzx
mad r1.yzw, cb1[61].wwww, r4.xxyz, r1.yyzw
add r0.w, -r2.x, r2.y
mad r2.y, cb1[62].w, r0.w, r2.x
add r0.w, -r1.x, cb1[63].x
mad r0.w, cb1[63].w, r0.w, r1.x
movc r4.xyz, v6.xxxx, v2.xyzx, -v2.xyzx
dp3 r1.x, r4.xyzx, r4.xyzx
rsq r1.x, r1.x
mad r4.xyz, r4.xyzx, r1.xxxx, -r3.xzwx
mad r3.xyz, cb1[60].wwww, r4.xyzx, r3.xzwx
ftou r2.zw, v0.xxxy
ge r1.x, v0.z, l(0.984375)
mul r4.x, v0.z, l(1.01587307)
mad r4.y, v0.z, l(64.000000), l(-63.000000)
movc r1.x, r1.x, r4.y, r4.x
max r1.x, r1.x, l(0.00000001)
rcp r1.x, r1.x
dp3 r4.x, -v5.xyzx, -v5.xyzx
rsq r4.x, r4.x
mul r4.yzw, r4.xxxx, -v5.xxyz
ine r5.x, cb1[92].x, l(0)
utof r5.yz, r2.wwzw
dp2 r5.w, r5.zyzz, l(0.06711056, 0.00583715, 0.000000, 0.000000)
frc r5.w, r5.w
mul r5.w, r5.w, l(52.982918)
frc r5.w, r5.w
mad r5.w, r5.w, l(6.28318548), cb1[70].w
sincos r6.x, r7.x, r5.w
dp2 r5.y, r5.yzyy, l(0.06711056, 0.00583715, 0.000000, 0.000000)
frc r5.y, r5.y
mul r5.y, r5.y, l(52.982918)
frc r5.y, r5.y
mad r5.y, r5.y, l(6.28318548), cb1[70].w
sincos r8.x, r9.x, r5.y
dp3_sat r2.x, r3.xyzx, r4.yzwy
dp3 r5.y, -r4.yzwy, r3.xyzx
add r5.y, r5.y, r5.y
mad r10.xyz, r3.xyzx, -r5.yyyy, -r4.yzwy
mul r5.y, r2.y, l(17.000000)
exp r5.y, r5.y
...
loop 
  ...
  ld_indexable(texture2darray)(uint,uint,uint,uint) r2.w, r13.xyzw, t7.yzwx
...
if_z r1.x
  ...
  max r1.x, r22.w, l(1.000000)
  rcp r1.x, r1.x
  mov_sat r22.w, r22.w
  mul r19.xyz, r1.xxxx, r21.xyzx
  mul r20.xyz, r1.xxxx, r22.xyzx
...
mul r8.yzw, r1.xxxx, r20.xxyz
mul r13.xyz, r2.yyyy, r8.zwyz
mul r2.yzw, r2.zzzz, r8.yyzw
sqrt r0.w, r5.z
mad r0.w, r0.w, l(0.500000), l(0.500000)
mul r0.w, r0.w, r0.w
mul r1.x, r0.w, l(0.500000)
mad r0.w, -r0.w, l(0.500000), l(1.000000)
mad r3.w, r2.x, r0.w, r1.x
mul r0.w, r0.w, r3.w
mul r1.x, r1.x, r3.w
...
if_nz r6.z
  ...
  if_nz r6.z
    ...
    if_nz r9.y
      ...
      mad r18.xyz, r3.xyzx, r9.zzzz, v5.xyzx
    ...
    mad r9.yzw, -v5.xxyz, r4.xxxx, cb2[17].xxyz
    dp3 r4.x, r9.yzwy, r9.yzwy
    rsq r4.x, r4.x
    mul r9.yzw, r4.xxxx, r9.yyzw
    dp3 r4.x, r9.yzwy, r4.yzwy
    dp3 r7.w, r3.xyzx, r9.yzwy
    mad r9.y, |r7.w|, r5.y, -|r7.w|
    mad r7.w, |r7.w|, r9.y, l(1.000000)
    mad r5.w, r5.w, r0.w, r1.x
    mul r7.w, r7.w, r7.w
    mul r5.w, r5.w, r7.w
    rcp r5.w, r5.w
    mul r5.w, r6.z, r5.w
    ...
    mad r9.yzw, r5.wwww, r8.yyzw, r2.yyzw
    add_sat r4.x, -r4.x, l(1.000000)
    mul r6.z, r4.x, r4.x
    mul r6.z, r6.z, r6.z
    mul r4.x, r4.x, r6.z
    mul r4.x, r4.x, r5.w
    mad r15.xyz, r4.xxxx, r8.zwyz, r13.xyzx
    mov r14.w, r15.z
    mov r12.w, r13.z
          ...
          if_nz r24.w
            ...
            if_nz r24.w
              ...
              if_nz r24.w
                ...
                mad r40.xyz, r3.xyzx, r24.wwww, v5.xyzx
              ...
              if_nz r24.w
                ...
                if_nz r13.w
                  ...
                  mad r18.xyz, r3.xyzx, r25.wwww, v5.xyzx
                  ...
                  if_nz r13.w
                    ...
                    mad r19.xyz, r3.xyzx, r18.xxxx, v5.xyzx
                ...
                mad r12.w, -r20.w, r2.x, l(1.000000)
                ...
                dp3_sat r12.w, r3.xyzx, r38.xyzx
                mad r37.xyz, r37.xyzx, r11.wwww, r4.yzwy
                dp3 r11.w, r37.xyzx, r37.xyzx
                rsq r11.w, r11.w
                mul r37.xyz, r11.wwww, r37.xyzx
                dp3 r11.w, r37.xyzx, r4.yzwy
                dp3 r15.w, r3.xyzx, r37.xyzx
                mad r18.x, |r15.w|, r5.y, -|r15.w|
                mad r15.w, |r15.w|, r18.x, l(1.000000)
                mad r18.x, r12.w, r0.w, r1.x
          ...
          if_nz r15.z
            ...
            if_nz r15.z
              ...
              if_nz r15.z
                ...
                mad r21.xyz, r3.xyzx, r15.zzzz, v5.xyzx
              ...
              if_nz r15.z
                ...
                if_nz r21.x
                  ...
                  mad r22.xyz, r3.xyzx, r21.yyyy, v5.xyzx
                  ...
                  if_nz r21.x
                    ...
                    mad r21.y, |r12.w|, l(-0.200000), l(0.400000)
                    mad r23.xyz, r3.xyzx, r21.yyyy, v5.xyzx
                ...
                mad r15.w, -r13.w, r2.x, l(1.000000)
                mul r15.w, r15.w, r15.w
                ...
                mad r19.xyz, r19.xyzx, r11.wwww, r4.yzwy
                dp3 r11.w, r19.xyzx, r19.xyzx
                rsq r11.w, r11.w
                mul r19.xyz, r11.wwww, r19.xyzx
                dp3 r11.w, r19.xyzx, r4.yzwy
                dp3 r15.w, r3.xyzx, r19.xyzx
                mad r19.x, |r15.w|, r5.y, -|r15.w|
                mad r15.w, |r15.w|, r19.x, l(1.000000)
                mad r13.w, r13.w, r0.w, r1.x
                mul r15.w, r15.w, r15.w
...
mad r1.xyz, r28.xyzx, r1.yzwy, r2.xyzx
...
ret 
// Approximately 2230 instruction slots used
