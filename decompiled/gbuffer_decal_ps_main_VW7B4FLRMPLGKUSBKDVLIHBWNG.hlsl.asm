...
mad r0.x, cb1[62].x, r0.w, cb0[12].x
...
if_nz r0.y
  ...
  movc r1.xyz, r0.wwww, r3.xywx, r4.xyzx
endif 
...
and r0.xzw, r1.zzzz, r2.xxyz
mul o1.xyz, r0.yyyy, r0.xzwx
add r2.y, -r3.z, r3.x
mad r0.x, r2.y, l(0.500000), r3.z
add r2.z, -r0.x, r3.y
