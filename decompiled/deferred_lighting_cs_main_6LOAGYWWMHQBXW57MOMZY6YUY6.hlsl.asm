...
if_nz r7.w
  ...
  add r10.yzw, r11.xxyz, -cb10[r7.w + 0].xxyz
  and r8.w, l(0x0000ffff), cb10[r7.w + 7].z
  ubfe r9.w, l(6), l(25), cb10[r7.w + 7].z
  imul null, r13.w, r8.w, l(6)
  dp3 r14.w, cb11[r13.w + 0].xyzx, r10.yzwy
  add_sat r14.w, r14.w, cb11[r13.w + 0].w
  dp3 r15.y, cb11[r13.w + 1].xyzx, r10.yzwy
  add_sat r15.y, r15.y, cb11[r13.w + 1].w
  mul r14.w, r14.w, r15.y
  dp3 r15.y, cb11[r13.w + 2].xyzx, r10.yzwy
  add_sat r15.y, r15.y, cb11[r13.w + 2].w
  mul r14.w, r14.w, r15.y
  dp3 r15.y, cb11[r13.w + 3].xyzx, r10.yzwy
  add_sat r15.y, r15.y, cb11[r13.w + 3].w
  mul r14.w, r14.w, r15.y
  dp3 r15.y, cb11[r13.w + 4].xyzx, r10.yzwy
  add_sat r15.y, r15.y, cb11[r13.w + 4].w
  mul r14.w, r14.w, r15.y
  dp3 r15.y, cb11[r13.w + 5].xyzx, r10.yzwy
  add_sat r13.w, r15.y, cb11[r13.w + 5].w
  mul r18.x, r13.w, r14.w
  and r13.w, l(1), cb10[r7.w + 6].x
  mov r18.yz, l(0,0,1.000000,0)
  movc r15.yz, r13.wwww, r18.xxyx, r18.zzxz
  mov r18.x, l(1.000000)
  mov r13.w, cb10[r7.w + 6].x
  mov r19.xy, r15.yzyy
  mov r14.w, l(1)
  loop 
    ige r15.w, r14.w, r9.w
    breakc_nz r15.w
    iadd r15.w, r8.w, r14.w
    ...
    mul r19.x, r15.w, r16.y
    ushr r16.z, r13.w, l(2)
  ...
  if_nz r9.w
    ...
    dp3 r14.w, r10.yzwy, r18.xyzx
    add r14.w, r14.w, -cb10[r7.w + 8].z
    ...
    div r14.w, r15.y, r14.w
    min r13.w, r13.w, |r14.w|
    add r18.x, r10.y, cb10[r7.w + 3].w
    add r18.yz, r10.zzwz, cb10[r7.w + 4].xxyx
    mad r15.yzw, r17.xxyz, r13.wwww, r18.xxyz
    ...
    dp3 r19.x, r15.yzwy, r18.xyzx
    mov r20.xy, cb10[r7.w + 1].xwxx
    mov r20.z, cb10[r7.w + 2].z
    dp3 r19.y, r15.yzwy, r20.xyzx
    mov r21.x, cb10[r7.w + 1].y
    mov r21.yz, cb10[r7.w + 2].xxwx
    dp3 r19.z, r15.yzwy, r21.xyzx
    ubfe r14.w, l(9), l(16), cb10[r7.w + 7].z
    utof r19.w, r14.w
    sample_l_indexable(texturecubearray)(float,float,float,float) r15.yzw, r19.xyzw, t8.wxyz, s2, r13.w
    dp3 r22.x, r10.yzwy, r18.xyzx
    dp3 r22.y, r10.yzwy, r20.xyzx
    dp3 r22.z, r10.yzwy, r21.xyzx
    mad_sat r10.yzw, r22.xxyz, cb10[r7.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
    mul r22.xy, r10.yzyy, cb10[r7.w + 4].zwzz
    mul r22.z, r10.w, cb10[r7.w + 5].x
    add r10.yzw, r22.xxyz, cb10[r7.w + 5].yyzw
    dp3 r19.x, r12.xyzx, r18.xyzx
    dp3 r19.y, r12.xyzx, r20.xyzx
    dp3 r19.z, r12.xyzx, r21.xyzx
    lt r16.yzw, l(0.000000, 0.000000, 0.000000, 0.000000), r19.xxyz
    movc r18.z, r16.y, l(0), l(0.500000)
    mov r18.xy, l(0,0,0,0)
    add r18.xyz, r10.yzwy, r18.xyzx
    ...
    mad r18.xyz, r18.xyzx, r20.xxxx, r21.xyzx
    movc r21.z, r16.w, l(0), l(0.500000)
    mov r21.xy, l(0,0,0,0)
    ...
    mad r10.yzw, r10.yyzw, r20.zzzz, r18.xxyz
    sample_l_indexable(texturecubearray)(float,float,float,float) r16.yzw, r19.xyzw, t8.wxyz, s2, l(6.000000)
    mul r10.yzw, r10.yyzw, r16.yyzw
    dp3 r7.w, r10.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
    mul r13.w, r4.w, r7.w
...
if_nz r7.w
  ...
  if_nz r6.w
    ...
    dp3 r13.w, cb11[r9.w + 0].xyzx, r16.yzwy
    add_sat r13.w, r13.w, cb11[r9.w + 0].w
    dp3 r14.w, cb11[r9.w + 1].xyzx, r16.yzwy
    add_sat r14.w, r14.w, cb11[r9.w + 1].w
    mul r13.w, r13.w, r14.w
    dp3 r14.w, cb11[r9.w + 2].xyzx, r16.yzwy
    add_sat r14.w, r14.w, cb11[r9.w + 2].w
    mul r13.w, r13.w, r14.w
    dp3 r14.w, cb11[r9.w + 3].xyzx, r16.yzwy
    add_sat r14.w, r14.w, cb11[r9.w + 3].w
    mul r13.w, r13.w, r14.w
    dp3 r14.w, cb11[r9.w + 4].xyzx, r16.yzwy
    add_sat r14.w, r14.w, cb11[r9.w + 4].w
    mul r13.w, r13.w, r14.w
    dp3 r14.w, cb11[r9.w + 5].xyzx, r16.yzwy
    add_sat r9.w, r14.w, cb11[r9.w + 5].w
    mul r18.x, r9.w, r13.w
    and r9.w, l(1), cb10[r0.y + 6].x
    mov r18.yz, l(0,0,1.000000,0)
    movc r18.xy, r9.wwww, r18.xyxx, r18.zxzz
    mov r19.x, l(1.000000)
    mov r9.w, cb10[r0.y + 6].x
    mov r20.xy, r18.xyxx
    mov r13.w, l(1)
    loop 
      ige r14.w, r13.w, r7.w
      breakc_nz r14.w
      iadd r14.w, r6.w, r13.w
      imul null, r14.w, r14.w, l(6)
      dp3 r18.z, cb11[r14.w + 0].xyzx, r16.yzwy
      add_sat r18.z, r18.z, cb11[r14.w + 0].w
      mul r18.z, r18.z, r20.x
      dp3 r18.w, cb11[r14.w + 1].xyzx, r16.yzwy
      add_sat r18.w, r18.w, cb11[r14.w + 1].w
      mul r18.z, r18.w, r18.z
      dp3 r18.w, cb11[r14.w + 2].xyzx, r16.yzwy
      add_sat r18.w, r18.w, cb11[r14.w + 2].w
      mul r18.z, r18.w, r18.z
      dp3 r18.w, cb11[r14.w + 3].xyzx, r16.yzwy
      add_sat r18.w, r18.w, cb11[r14.w + 3].w
      mul r18.z, r18.w, r18.z
      dp3 r18.w, cb11[r14.w + 4].xyzx, r16.yzwy
      add_sat r18.w, r18.w, cb11[r14.w + 4].w
      mul r18.z, r18.w, r18.z
      dp3 r18.w, cb11[r14.w + 5].xyzx, r16.yzwy
      add_sat r14.w, r18.w, cb11[r14.w + 5].w
      mul r20.x, r14.w, r18.z
      ushr r18.w, r9.w, l(2)
      ubfe r19.z, l(1), l(2), r9.w
      and r19.w, r18.w, l(2)
      max r20.z, r20.x, r20.y
      mad r14.w, -r18.z, r14.w, l(1.000000)
...
if_nz r2.w
  ...
  dp3 r3.w, r18.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
  mad r16.yzw, r10.yyzw, r0.yyyy, r18.xxyz
  mov r17.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r10.yzw, r17.xyzw, t8.wxyz, s2, r3.z
  mad r0.y, cb2[19].x, r2.w, -r3.w
  mad r0.y, r2.y, r0.y, r3.w
  mad r15.yzw, r10.yyzw, r0.yyyy, r15.yyzw
endif 
