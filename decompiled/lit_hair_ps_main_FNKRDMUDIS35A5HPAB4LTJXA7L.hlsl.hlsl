...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  r7.zw = (uint2)r2.zy;
  r3.x = dot(r7.wz, float2(0.0671105608,0.00583714992));
  r3.x = frac(r3.x);
  r3.x = 52.9829178 * r3.x;
  r3.x = frac(r3.x);
  r3.x = r3.x * 6.28318548 + gameTick.w;
  sincos(r3.x, r9.x, r10.x);
  r3.x = dot(r7.zw, float2(0.0671105608,0.00583714992));
  r3.x = frac(r3.x);
  r3.x = 52.9829178 * r3.x;
  r3.x = frac(r3.x);
  r3.x = r3.x * 6.28318548 + gameTick.w;
  ...
  r4.w = dot(-r8.xyz, r6.xyz);
  r4.w = r4.w + r4.w;
  r12.xyz = r6.xyz * -r4.www + -r8.xyz;
  r4.w = 17 * r7.y;
  r13.x = exp2(r4.w);
  r4.w = 2 + r13.x;
  r4.w = 2 / r4.w;
  ...
  if (r2.x == 0) {
    ...
    if (r8.w != 0) {
      ...
      while (true) {
        ...
        r10.w = sunConstants.splitPinTransform[r13.z].z * r13.w;
        r13.z = cmp(r10.w < 1);
        if (r13.z != 0) {
          break;
        }
    ...
    if (r13.z == 0) {
      if (enableDitheredShadow == 0) {
        ...
        r16.z = r13.z + r8.w;
        r13.z = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r2.x).x;
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          r17.w = r17.x ? sunConstants.splitPinTransform[r8.w].w : sunConstants.splitPinTransform[r13.z].w;
          r17.x = r17.x ? r8.w : r13.z;
          ...
          r18.z = (uint)r17.x;
          r17.x = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r18.xyz, r2.x).x;
  ...
  if (r2.x != 0) {
    ...
    r2.x = (int)r2.x + -1;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r8.w, r2.x, l(52), t12.xxxx
  r8.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
  ...
  r18.z = samp0[]..swiz;
  r18.w = samp0[]..swiz;
    r10.w = abs(r0.y) * -0.200000003 + 0.400000006;
    r13.z = cmp(r0.y < 0);
    ...
    if (r10.w == 0) {
    // Known bad code for instruction (needs manual fix):
        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r10.w, r2.x, l(28), t12.xxxx
    r10.w = samp0[]..swiz;
    // Known bad code for instruction (needs manual fix):
    ...
    r16.y = samp0[]..swiz;
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          r15.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r17.xyz, r2.x).x;
          r13.z = r15.w * 0.125 + r13.z;
          r13.w = (int)r13.w + 1;
        }
      } else {
        r15.z = (uint)r10.w;
        r13.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r15.xyz, r2.x).x;
      }
      r2.x = r13.z * r13.z;
      r2.x = r2.x * r13.z;
    } else {
  ...
  if (r2.x != 0) {
    r2.x = cmp(0 < r13.y);
    if (r2.x != 0) {
      r2.x = sunConstants.specScale * r4.w;
      r2.x = 0.25 * r2.x;
      if (sunConstants.sunCookieIndex != 0) {
        r14.w = 1;
        r8.w = dot(sunConstants.sunCookieTransform[0].xyzw, r14.xyzw);
        r10.w = dot(sunConstants.sunCookieTransform[1].xyzw, r14.xyzw);
        r15.x = frac(r8.w);
        r15.y = frac(r10.w);
      ...
      r8.w = -r7.x * 0.5 + 1;
      r8.w = -abs(r0.y) * r8.w + 1;
      r8.w = r8.w * r8.w;
      r8.w = -r8.w * 0.620000005 + 0.620000005;
      r8.w = r8.w + -abs(r0.y);
      r8.w = r5.w * r8.w + abs(r0.y);
      r10.w = cmp(0 < r0.y);
      r0.y = saturate(r0.y);
      r16.xyz = -v6.xyz * r2.www + sunConstants.wldDir.xyz;
      r2.w = dot(r16.xyz, r16.xyz);
      r2.w = rsqrt(r2.w);
      r16.xyz = r16.xyz * r2.www;
      r2.w = dot(r6.xyz, r16.xyz);
      r13.z = dot(r16.xyz, r8.xyz);
      r13.w = r9.z * r9.w;
      r13.w = sqrt(r13.w);
      r14.w = dot(r16.xyz, r5.xyz);
      r15.w = dot(r16.xyz, r3.yzw);
      r14.w = r14.w * r14.w;
      r14.w = r14.w / r9.z;
      r15.w = r15.w * r15.w;
      r15.w = r15.w / r9.w;
      r14.w = r15.w + r14.w;
      r2.w = abs(r2.w) * abs(r2.w) + r14.w;
      r14.w = r0.y * r7.z + r7.w;
      r2.w = r2.w * r2.w;
      r2.w = r2.w * r13.w;
      r2.w = r2.w * r14.w;
      r2.w = rcp(r2.w);
      r0.y = r0.y * r2.x;
      r0.y = r2.w * r0.y;
      r2.x = saturate(1 + -r13.z);
      r2.w = r2.x * r2.x;
      r2.w = r2.w * r2.w;
      r2.x = r2.x * r2.w;
      r2.x = r2.x * r0.y;
      r2.w = r10.w ? r8.w : 0;
      r16.xyz = r10.www ? float3(0,0,0) : r8.www;
      r13.zw = r10.ww ? r2.xx : 0;
      r17.xyz = r10.www ? r0.yyy : 0;
      r0.y = dot(r15.xyz, float3(0.212599993,0.715200007,0.0722000003));
      r0.y = r13.y * r0.y;
      r13.x = 1;
      r2.x = sunConstants.wldDir.x;
  ...
  r10.w = 0;
  while (true) {
    r14.w = cmp((uint)r10.w >= numLights);
    if (r14.w != 0) break;
    r21.z = (uint)r10.w >> 5;
          ...
          if (r32.w != 0) {
            ...
            if (r30.w != 0) {
              ...
              if (r24.y != 0) {
                ...
                r28.w = -abs(r31.w) * r2.y + 1;
                r28.w = r28.w * r28.w;
                r28.w = -r28.w * 0.620000005 + 0.620000005;
                r28.w = r28.w + -abs(r31.w);
                r28.w = r5.w * r28.w + abs(r31.w);
                r29.w = cmp(0 < r31.w);
                r30.w = saturate(dot(r6.xyz, r57.xyz));
                r56.xyz = r56.xyz * r25.www + r8.xyz;
                r25.w = dot(r56.xyz, r56.xyz);
                r25.w = rsqrt(r25.w);
                r56.xyz = r56.xyz * r25.www;
                r25.w = dot(r6.xyz, r56.xyz);
                r31.w = dot(r56.xyz, r8.xyz);
                r32.w = dot(r56.xyz, r5.xyz);
                r33.w = dot(r56.xyz, r3.yzw);
                r32.w = r32.w * r32.w;
                r32.w = r32.w / r9.z;
                r33.w = r33.w * r33.w;
                r33.w = r33.w / r9.w;
          ...
          r59.w = samp0[]..swiz;
            ...
            if (r28.w != 0) {
              ...
              if (r26.x != 0) {
                r26.x = r50.x * r4.w;
                r26.x = 0.25 * r26.x;
                r26.y = -abs(r24.y) * r2.y + 1;
                r26.y = r26.y * r26.y;
                r26.y = -r26.y * 0.620000005 + 0.620000005;
                r26.y = r26.y + -abs(r24.y);
                r26.y = r5.w * r26.y + abs(r24.y);
                r27.x = cmp(0 < r24.y);
                r24.y = saturate(r24.y);
                r49.xyz = r56.xyz * r24.xxx + r8.xyz;
                r24.x = dot(r49.xyz, r49.xyz);
                r24.x = rsqrt(r24.x);
                r49.xyz = r49.xyz * r24.xxx;
                r24.x = dot(r6.xyz, r49.xyz);
                r27.y = dot(r49.xyz, r8.xyz);
                r27.z = dot(r49.xyz, r5.xyz);
                r28.w = dot(r49.xyz, r3.yzw);
                r27.z = r27.z * r27.z;
                r27.z = r27.z / r9.z;
                r28.w = r28.w * r28.w;
                r28.w = r28.w / r9.w;
  ...
  r0.y = frac(r0.y);
  r2.w = 3.14159989 * r0.y;
  r2.w = gameTick.w * 0.5 + r2.w;
  ...
  r2.w = 3.14159989 + r2.w;
  sincos(r2.w, r11.x, r14.x);
  ...
  r2.w = dot(renderTargetSize.zw, renderTargetSize.zw);
  r2.w = sqrt(r2.w);
  r3.x = dot(r10.xy, r10.xy);
  r3.x = sqrt(r3.x);
  r3.x = rcp(r3.x);
  r2.w = r3.x * r2.w;
  ...
  r11.xy = (int2)r5.xy;
  r11.zw = float2(0,0);
  r5.x = floatZSampler.Load(r11.xyz).x;
  r5.y = cmp(r5.x >= 0.984375);
  r7.z = 1.01587307 * r5.x;
  r5.x = r5.x * 64 + -63;
  r5.x = r5.y ? r5.x : r7.z;
  ...
  if (r5.y != 0) {
    r5.yw = r0.yy * float2(0.5,0.5) + float2(1.33333337,2);
    r5.yw = float2(0.117647059,0.117647059) * r5.yw;
    r5.yw = r5.yw * r5.yw + -r3.xy;
    r3.x = r3.z * r5.y + r3.x;
    x1[0].x = r3.x;
    r11.xyz = r10.xyz * r3.xxx + r9.xyz;
    r3.x = cmp(r2.w < r3.x);
    r7.zw = renderTargetSize.xy * r11.xy;
    r13.xy = (int2)r7.zw;
    r13.zw = float2(0,0);
    r5.y = floatZSampler.Load(r13.xyz).x;
    r7.z = cmp(r5.y >= 0.984375);
    r7.w = 1.01587307 * r5.y;
    r5.y = r5.y * 64 + -63;
    r5.y = r7.z ? r5.y : r7.w;
    ...
    r3.y = r3.w * r5.w + r3.y;
    x1[1].x = r3.y;
    r11.xyz = r2.xyz * r3.yyy + r9.xyz;
    r3.y = cmp(r2.w < r3.y);
    r5.yw = renderTargetSize.xy * r11.xy;
    r13.xy = (int2)r5.yw;
    r13.zw = float2(0,0);
    r3.z = floatZSampler.Load(r13.xyz).x;
    r4.w = cmp(r3.z >= 0.984375);
    r5.y = 1.01587307 * r3.z;
    r3.z = r3.z * 64 + -63;
    r3.z = r4.w ? r3.z : r5.y;
  ...
  if (r3.x == 0) {
    ...
    r3.x = r3.x * r3.x + -r0.y;
    r0.y = r3.z * r3.x + r0.y;
    r5.xyw = r10.xyz * r0.yyy + r9.xyz;
    r0.y = cmp(r2.w < r0.y);
    r3.xw = renderTargetSize.xy * r5.xy;
    r10.xy = (int2)r3.xw;
    r10.zw = float2(0,0);
    r3.x = floatZSampler.Load(r10.xyz).x;
  ...
  while (true) {
    ...
    r7.z = visibleProbes.Load(r11.xyzw).x;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r21.xyzw, r5.w, l(0), t15.wxyz
  r21.x = samp0[]..swiz;
  r21.y = samp0[]..swiz;
  r21.z = samp0[]..swiz;
  r21.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r22.xyzw, r5.w, l(16), t15.xyzw
  r22.x = samp0[]..swiz;
  r22.y = samp0[]..swiz;
  r22.z = samp0[]..swiz;
  r22.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r23.xyzw, r5.w, l(32), t15.yxwz
  r23.x = samp0[]..swiz;
  r23.y = samp0[]..swiz;
  r23.z = samp0[]..swiz;
  r23.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r24.xyzw, r5.w, l(48), t15.xyzw
  r24.x = samp0[]..swiz;
  r24.y = samp0[]..swiz;
  r24.z = samp0[]..swiz;
  r24.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r25.xyzw, r5.w, l(64), t15.zwxy
  r25.x = samp0[]..swiz;
  r25.y = samp0[]..swiz;
  r25.z = samp0[]..swiz;
  r25.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r26.xyzw, r5.w, l(80), t15.xyzw
  r26.x = samp0[]..swiz;
  r26.y = samp0[]..swiz;
  r26.z = samp0[]..swiz;
  r26.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r10.zw, r5.w, l(96), t15.xxxy
  r10.z = samp0[]..swiz;
  r10.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r27.xyzw, r5.w, l(116), t15.xyzw
  r27.x = samp0[]..swiz;
  r27.y = samp0[]..swiz;
  r27.z = samp0[]..swiz;
  r27.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r28.xyzw, r5.w, l(132), t15.zwxy
  r28.x = samp0[]..swiz;
  r28.y = samp0[]..swiz;
  r28.z = samp0[]..swiz;
  r28.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r29.xyzw, r5.w, l(148), t15.zwxy
  r29.x = samp0[]..swiz;
  r29.y = samp0[]..swiz;
  r29.z = samp0[]..swiz;
  r29.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r30.xyzw, r5.w, l(164), t15.zwxy
  r30.x = samp0[]..swiz;
  r30.y = samp0[]..swiz;
  r30.z = samp0[]..swiz;
  r30.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r31.xyzw, r5.w, l(180), t15.zwxy
  r31.x = samp0[]..swiz;
  r31.y = samp0[]..swiz;
  r31.z = samp0[]..swiz;
  r31.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r32.xyzw, r5.w, l(196), t15.xyzw
  r32.x = samp0[]..swiz;
  r32.y = samp0[]..swiz;
  r32.z = samp0[]..swiz;
  r32.w = samp0[]..swiz;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r33.xy, r5.w, l(212), t15.xyxx
  r33.x = samp0[]..swiz;
  r33.y = samp0[]..swiz;
  ...
  r3.xyz = r18.xyz * r0.xxx + r3.xyz;
  r5.xyz = r18.xyz * r0.xxx + r5.xyz;
  ...
  r2.xyz = r6.xyz * r0.yyy + r2.xyz;
  r0.xyz = r6.xyz * r0.zzz + r9.xyz;
  r2.w = dot(r4.xyz, r8.xyz);
  r3.w = 1 + -abs(r2.w);
  r3.w = r3.w * r3.w;
  r3.w = r3.w * 0.600000024 + 0.400000006;
  r3.w = min(1, r3.w);
  r4.xyz = saturate(r1.xyz * float3(0.0199999996,0.0199999996,0.0199999996) + float3(0.0399999991,0.0399999991,0.0399999991));
  r6.xyz = specColorTint.xyz * r4.xyz;
