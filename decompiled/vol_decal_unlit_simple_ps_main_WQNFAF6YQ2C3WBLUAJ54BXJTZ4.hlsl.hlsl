// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:43:59 2021
...
Texture2D<float> volDecalRevealTexture : register(t9);
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r1.xyz = float3(1,1,1) + -abs(r0.xyz);
  r1.xyz = cmp(r1.xyz < float3(0,0,0));
  r0.w = (int)r1.y | (int)r1.x;
  r0.w = (int)r1.z | (int)r0.w;
  if (r0.w != 0) discard;
  if (r0.w != 0) discard;
  r1.xyz = -v9.xyz + abs(r0.xyz);
  r0.xy = r0.yz * float2(0.5,-0.5) + float2(0.5,0.5);
  ...
  r0.w = r1.x * r0.w;
  r2.y = exp2(r0.w);
  r0.zw = saturate(alphaRevealSoftEdge * r2.xy + r0.zz);
  r1.x = revealMap.Sample(revealSampler_s, r0.xy).x;
  r1.yzw = colorMap.Sample(colorSampler_s, r0.xy).xyz;
  r1.yzw = log2(abs(r1.yzw));
  r1.yzw = float3(0.454545468,0.454545468,0.454545468) * r1.yzw;
  r1.yzw = exp2(r1.yzw);
  o0.xyz = v8.xyz * r1.yzw;
  r0.x = r1.x + -r0.z;
  r0.y = r0.w + -r0.z;
