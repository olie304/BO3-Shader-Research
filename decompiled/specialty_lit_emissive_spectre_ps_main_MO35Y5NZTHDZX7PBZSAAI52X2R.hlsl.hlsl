...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r5.w = -r6.w * w1.x + debugAlphaOverride.x;
...
r1.w = samp0[]..swiz;
  ...
  if (r5.y != 0) {
    ...
    if (r5.y != 0) {
      ...
      r4.z = saturate(r4.z);
      r18.xyz = -v7.xyz * r0.yyy + sunConstants.wldDir.xyz;
        ...
        r40.w = samp0[]..swiz;
          ...
          switch (r10.w) {
            ...
            if (r15.w != 0) {
              ...
              r13.w = r16.w / r13.w;
              r13.w = min(1, r13.w);
              r17.zw = saturate(r15.ww * r36.xz + r36.yw);
              r44.xy = r17.zw * r17.zw;
              r17.zw = r17.zw * float2(-2,-2) + float2(3,3);
              r17.zw = r44.xy * r17.zw;
              r13.w = r17.z * r13.w;
              r13.w = r13.w * r17.w;
              r15.w = cmp(0 < r13.w);
              if (r15.w != 0) {
                ...
                if (r15.w != 0) {
                  ...
                  r17.z = (int)r35.w & 0x0000ffff;
                  r45.w = (uint)r17.z;
                  r17.zw = float2(0,0);
                  while (true) {
                    r22.w = cmp((int)r17.w >= 8);
                    if (r22.w != 0) break;
                    r46.y = dot(icb[r17.w+0].yx, r9.xy);
                    r46.z = dot(icb[r17.w+0].yx, r9.yz);
                    r46.yz = r46.yz * r37.yy;
                    r46.x = r46.y * r5.x;
                    r46.w = r46.y * r3.x;
                    r45.xyz = r44.xyz * r16.www + r46.xzw;
                    r22.w = gOmniShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r45.xyzw, r15.w).x;
                    r17.z = r22.w * 0.125 + r17.z;
                    r17.w = (int)r17.w + 1;
                  }
                } else {
                  r17.z = 1;
                ...
                if (r15.w != 0) {
                  r15.w = r35.x * r3.y;
                  r15.w = 0.25 * r15.w;
                  r16.w = dot(r41.xyz, r13.xyz);
                  r17.w = dot(r13.xyz, r43.xyz);
                  r22.w = -r16.w * r16.w + r40.x;
                  r11.w = r16.w * r17.w + -r11.w;
                  r11.w = saturate(r11.w / r22.w);
                  r16.w = r22.w / r40.x;
                  r16.w = 10 * r16.w;
                  r16.w = min(1, r16.w);
                  r11.w = r11.w + -r12.w;
                  r11.w = r16.w * r11.w + r12.w;
                  ...
                  r44.w = samp0[]..swiz;
                    ...
                    r20.xyz = r7.xyz * r16.www + v7.xyz;
                    r16.w = dot(r43.xyzw, r20.xyzw);
                    r17.w = dot(r44.xyzw, r20.xyzw);
                    r22.w = cmp(r17.w < r16.w);
                    if (r22.w == 0) {
                    // Known bad code for instruction (needs manual fix):
                    ...
                    r11.w = samp0[]..swiz;
                      ...
                      if (r6.w != 0) {
                        ...
                        while (true) {
                          ...
                          if (r26.w != 0) break;
                          r44.x = dot(icb[r22.w+0].yx, r9.xw);
                          r44.y = dot(icb[r22.w+0].xy, r4.xy);
                          r20.xy = r44.xy * r12.ww + r43.xy;
                          r20.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r20.xyz, r16.w).x;
                          r17.w = r20.x * 0.125 + r17.w;
                          r22.w = (int)r22.w + 1;
                        }
                      } else {
                        r43.z = (uint)r11.w;
                        r17.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r43.xyz, r16.w).x;
                      }
                      r11.w = r17.w * r17.w;
                      r11.w = r11.w * r17.w;
                    } else {
                    ...
                    r44.w = samp0[]..swiz;
                      r16.w = abs(r14.w) * -0.200000003 + 0.400000006;
                      r20.x = cmp(r14.w < 0);
                      r16.w = r20.x ? -r16.w : r16.w;
                      r21.xyz = r7.xyz * r16.www + v7.xyz;
                      r16.w = dot(r43.xyzw, r21.xyzw);
                      ...
                      r11.w = samp0[]..swiz;
                        ...
                        if (r6.w != 0) {
                          ...
                          r21.z = (uint)r11.w;
                          r22.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r21.xyz, r16.w).x;
                        }
                        r11.w = r22.w * r22.w;
                        r11.w = r11.w * r22.w;
                      } else {
                  ...
                  r11.w = -abs(r14.w) * r4.z + 1;
                  r11.w = r11.w * r11.w;
                  r11.w = -r11.w * 0.620000005 + 0.620000005;
                  r11.w = r11.w + -abs(r14.w);
                  r11.w = r3.z * r11.w + abs(r14.w);
                  r11.w = r11.w * r13.w;
                  r35.x = r34.x;
                  r12.w = cmp(0 < r14.w);
                  r20.xyz = r11.www * r35.xyz + r18.xyz;
                  r11.w = saturate(dot(r7.xyz, r42.xyz));
                  r21.xyz = r41.xyz * r10.www + r2.xyz;
                  r10.w = dot(r21.xyz, r21.xyz);
                  r10.w = rsqrt(r10.w);
                  r21.xyz = r21.xyz * r10.www;
                  r10.w = dot(r21.xyz, r2.xyz);
                  r14.w = dot(r7.xyz, r21.xyz);
                  r16.w = abs(r14.w) * r3.y + -abs(r14.w);
                  r14.w = abs(r14.w) * r16.w + 1;
                  r16.w = r11.w * r2.w + r3.w;
                  r14.w = r14.w * r14.w;
                  r14.w = r14.w * r16.w;
                  r14.w = rcp(r14.w);
                  r11.w = r11.w * r15.w;
                  r11.w = r14.w * r11.w;
                  r11.w = r11.w * r13.w;
                  r21.xyz = r11.www * r35.xyz + r33.xyz;
                  ...
                  r32.xyz = r12.www ? r41.xyz : r32.xyz;
                  r33.xyz = r12.www ? r21.xyz : r33.xyz;
                }
              }
            }
            break;
            ...
            r10.w = rsqrt(r10.w);
            r21.xyz = r20.xyz * r10.www;
            r11.w = dot(r7.xyz, r21.xyz);
            ...
            r42.w = samp0[]..swiz;
              ...
              r14.w = samp0[]..swiz;
                ...
                r22.xy = r36.xy / r12.ww;
                r12.w = cmp(r44.w < 0.00048828125);
                if (r12.w != 0) {
                  r45.y = r46.x;
                ...
                r36.y = samp0[]..swiz;
                r36.z = samp0[]..swiz;
                  r14.w = dot(r46.yzw, r22.xyz);
                  r15.w = dot(r36.xyz, r22.xyz);
                  r36.x = frac(r14.w);
                  r36.y = frac(r15.w);
                  r12.w = (int)r12.w + -1;
                  r36.z = (uint)r12.w;
              ...
              if (r12.w != 0) {
                ...
                if (r12.w != 0) {
                  ...
                  r14.w = cmp(r11.w < 0);
                  r12.w = r14.w ? -r12.w : r12.w;
                  r23.xyz = r7.xyz * r12.www + v7.xyz;
                  r41.xyz = r40.xyz;
                  r12.w = dot(r41.xyzw, r23.xyzw);
                  r14.w = dot(r43.xyzw, r23.xyzw);
                  ...
                  r42.y = samp0[]..swiz;
                    ...
                    if (r6.w != 0) {
                      ...
                      while (true) {
                        ...
                        r16.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r34.xyz, r8.w).x;
                        r14.w = r16.w * 0.125 + r14.w;
                        r15.w = (int)r15.w + 1;
                      }
                    } else {
                      r23.z = (uint)r12.w;
                      r14.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r23.xyz, r8.w).x;
                    }
                    r8.w = r14.w * r14.w;
                    r8.w = r8.w * r14.w;
                  } else {
                ...
                if (r12.w != 0) {
                  ...
                  r40.w = samp0[]..swiz;
                    ...
                    r24.y = samp0[]..swiz;
                      ...
                      r13.w = r24.y * r23.x;
                      r16.w = r24.x * r23.x + r16.w;
                      r13.w = r16.w / r13.w;
                      r13.w = max(6.10351563e-05, r13.w);
                      r16.w = r23.y ? 0.000000 : 0;
                      if (r6.w != 0) {
                        r23.z = (uint)r16.w;
                        r22.xy = float2(0,0);
                        while (true) {
                        ...
                        r34.z = (uint)r16.w;
                        r22.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r34.xyz, r13.w).x;
                      }
                      r13.w = r22.x * r22.x;
                      r13.w = r13.w * r22.x;
                    } else {
                    ...
                    r39.w = samp0[]..swiz;
                      ...
                      r24.y = samp0[]..swiz;
                        ...
                        r13.w = r24.y * r22.y;
                        r16.w = r24.x * r22.y + r16.w;
                        r13.w = r16.w / r13.w;
                        r13.w = max(6.10351563e-05, r13.w);
                        r16.w = r23.z ? 0.000000 : 0;
                        if (r6.w != 0) {
                          r23.z = (uint)r16.w;
                          r22.y = 0;
                          r24.x = 0;
                  ...
                  r13.w = dot(r7.xyz, r20.xyz);
                  r16.w = abs(r13.w) * r3.y + -abs(r13.w);
                  ...
                  r33.xyz = r15.www ? r20.xyz : r33.xyz;
                }
              }
            }
            break;
