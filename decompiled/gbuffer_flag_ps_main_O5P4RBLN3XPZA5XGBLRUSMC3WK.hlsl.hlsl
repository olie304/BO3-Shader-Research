  ...
  out float2 o3 : SV_TARGET3)
{
  ...
  r1.yzw = r3.xyz * r1.www + r4.xyz;
  r3.z = dot(r1.yzw, r1.yzw);
  r3.z = rsqrt(r3.z);
  ...
  r1.x = rsqrt(r1.x);
  r4.xyz = r4.xyz * r1.xxx + -r1.yzw;
  r1.yzw = debugNormalOverride.www * r4.xyz + r1.yzw;
  r3.z = flagParams.z * r0.z;
  r4.xy = v6.xy / v6.ww;
  r4.zw = float2(0.5,0.5) * renderTargetSize.xy;
  r5.x = r4.x * r4.z;
  r5.y = r4.y * -r4.w;
  r4.xy = renderTargetSize.xy * float2(0.5,0.5) + r5.xy;
  r4.xy = v0.xy + -r4.xy;
  r3.x = r3.x + r3.y;
  r3.x = r2.w * r2.x + r3.x;
  r3.x = 0.5 * r3.x;
  ...
  r1.xy = float2(-10,-10) + abs(r4.xy);
  r1.xy = saturate(float2(0.0333333351,0.0333333351) * r1.xy);
  r1.zw = float2(0.100000001,0.100000001) * abs(r4.xy);
  r1.zw = min(float2(1,1), r1.zw);
  r1.zw = r1.zw + -r1.xy;
  r1.xy = r1.zw * float2(0.5,0.5) + r1.xy;
  r1.zw = cmp(r4.xy >= float2(0,0));
