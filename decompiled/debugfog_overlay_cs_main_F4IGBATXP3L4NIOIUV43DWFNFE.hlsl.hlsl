...
Texture2D<float4> frameBuffer : register(t6);
StructuredBuffer<debugPoints> debugPoints : register(t10);
...
// unknown dcl_: dcl_resource_structured t10, 16
// Needs manual fix for instruction: 
...
// unknown dcl_: dcl_thread_group 8, 8, 1
  ...
  frameBuffer.GetDimensions(0, uiDest.x, uiDest.y, uiDest.z);
  r1.xy = uiDest.xy;
  r1.zw = cmp((uint2)r0.xy >= (uint2)r1.xy);
  r1.z = (int)r1.w | (int)r1.z;
  if (r1.z != 0) {
    return;
  }
  r0.zw = float2(0,0);
  r1.z = floatZSampler.Load(r0.xyw).x;
  ...
  r1.z = r1.w ? 1.00000001e-07 : r1.z;
  r1.z = zNear.x / r1.z;
  r2.xy = (uint2)r0.xy;
  r2.xy = -subpixelOffset.xy + r2.xy;
  r1.xy = r2.xy * r1.xy;
  r1.xy = r1.xy * float2(2,-2) + float2(-1,1);
  r2.x = inverseProjectionMatrix._m00 * r1.x;
  r2.y = inverseProjectionMatrix._m11 * r1.y;
  r2.zw = float2(1.01587307,1);
  r1.xyw = float3(1.01587307,1.01587307,1) * zNear.xxx;
  r1.xyw = r2.xyz * r1.xyw;
  r3.xyz = inverseViewMatrix._m10_m11_m12 * r1.yyy;
  r3.xyz = r1.xxx * inverseViewMatrix._m00_m01_m02 + r3.xyz;
  r1.xyw = r1.www * inverseViewMatrix._m20_m21_m22 + r3.xyz;
  r1.xyw = inverseViewMatrix._m30_m31_m32 + r1.xyw;
  r1.xyw = eyeOffset.xyz + r1.xyw;
  r2.xyz = r2.xyw * r1.zzz;
  ...
  r2.xyz = inverseViewMatrix._m30_m31_m32 + r2.xyz;
  r2.xyz = eyeOffset.xyz + r2.xyz;
  r2.xyz = r2.xyz + -r1.xyw;
  r1.z = dot(r2.xyz, r2.xyz);
  r1.z = 1 / r1.z;
  r3.xyz = r1.zzz * r2.xyz;
  r1.z = 1 / postFxConst00.y;
  r2.w = postFxConst00.y * postFxConst00.y;
  r3.w = r2.w;
  r4.x = 0;
  while (true) {
    r4.y = cmp((uint)r4.x >= (uint)postFxConst00.x);
    if (r4.y != 0) break;
  // Known bad code for instruction (needs manual fix):
    ld_structured_indexable(structured_buffer, stride=16)(mixed,mixed,mixed,mixed) r4.yzw, r4.x, l(0), t10.xxyz
  r4.y = floatZSampler[]..swiz;
  r4.z = floatZSampler[]..swiz;
  r4.w = floatZSampler[]..swiz;
    r5.xyz = r4.yzw + -r1.xyw;
    r5.x = saturate(dot(r3.xyz, r5.xyz));
    r5.xyz = r2.xyz * r5.xxx + r1.xyw;
  ...
  if (r2.x != 0) {
    r2.xyzw = frameBuffer.Load(r0.xyz).xyzw;
    r0.z = 0.75 * r1.w;
    r1.xyz = float3(0.75,0,0) * hdrControl0.www;
