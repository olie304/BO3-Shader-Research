...
cbuffer _Globals : register(b0)
{
  ...
  float alphaLayer1 : packoffset(c19.z);
  ...
  float alphaLayer2 : packoffset(c26.w);
  ...
  float alphaLayer3 : packoffset(c33.w);
}
...
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r4.w, v2.w, l(8), t4.xxxx
r4.w = samp0[]..swiz;
  r8.xy = (int2)r4.ww & int2(268435456,536870912);
  if (r8.x != 0) {
    r9.xyz = eyeOffset.xyz + v6.xyz;
    r4.w = 0.0078125 * r2.x;
    r4.w = min(15, r4.w);
    r4.w = (uint)r4.w;
    r10.xy = (uint2)r2.zw >> int2(6,6);
    r10.z = (uint)r4.w << 4;
    ...
    while (true) {
      ...
      if (r5.w == 0) r11.z = 0; else if (r5.w+0 < 32) {       r11.z = (uint)r7.w << (32-(r5.w + 0)); r11.z = (uint)r11.z >> (32-r5.w);      } else r11.z = (uint)r7.w >> 0;
          ...
          r21.z = samp0[]..swiz;
            ...
            r24.w = samp0[]..swiz;
              ...
              r21.w = samp0[]..swiz;
                ...
                if (r22.z != 0) {
                  if (4 == 0) r14.w = 0; else if (4+24 < 32) {                   r14.w = (uint)r20.w << (32-(4 + 24)); r14.w = (uint)r14.w >> (32-4);                  } else r14.w = (uint)r20.w >> 24;
                  r14.w = 1 << (int)r14.w;
                  r15.w = (uint)r20.w >> 28;
                  r15.w = 1 << (int)r15.w;
                ...
                r15.w = cmp(r20.x != 1.000000);
                r17.w = r14.w + r19.w;
                r17.w = saturate(r17.w * r20.x + -r20.x);
                r14.w = r15.w ? r17.w : r14.w;
                if (r22.w != 0) {
                  if (4 == 0) r15.w = 0; else if (4+24 < 32) {                   r15.w = (uint)r21.y << (32-(4 + 24)); r15.w = (uint)r15.w >> (32-4);                  } else r15.w = (uint)r21.y >> 24;
                  r15.w = 1 << (int)r15.w;
                  r17.w = (uint)r21.y >> 28;
                  r17.w = 1 << (int)r17.w;
                ...
                if (r20.x != 0) {
                  ...
                  r11.w = samp0[]..swiz;
                    ...
                    r29.xyz = r32.xyz * r29.xyz;
                    r11.w = materialTexMask.SampleGrad(samplerLinearClamp_s, r30.xyz, r31.x, r29.x).x;
                  } else {
                    r15.w = cmp((int)r20.x == 6);
                    r11.w = r15.w ? 0 : 1;
                  }
                } else {
                  r11.w = 1;
                ...
                if (r20.y != 0) {
                  ...
                  r20.xyz = r23.xyz * r15.www + r20.xyz;
                  r15.w = dot(r20.xyz, r20.xyz);
                  r15.w = rsqrt(r15.w);
                  r20.xyz = r20.xyz * r15.www;
                  r15.w = 1 + -r14.w;
                  r17.x = r16.x;
                  r21.xyz = r17.xyz * r15.www;
                  r17.xyz = r20.xyz * r14.www + r21.xyz;
                  r16.x = r17.x;
                }
                r15.w = 1 + -r14.w;
                r20.xyz = r15.www * r12.xyz;
                r12.xyz = r19.xyz * r14.www + r20.xyz;
                r18.z = r16.y;
                r19.xyz = r18.xyz * r15.www;
                r18.xyz = r28.xyz * r14.www + r19.xyz;
                r17.x = r16.w * r15.w;
                r16.z = r16.z * r15.w + r14.w;
                r16.w = r11.w * r14.w + r17.x;
                r16.y = r18.z;
              }
            }
          }
  ...
  if (r8.y != 0) {
    ...
    while (true) {
      ...
      r11.z = (uint)r10.w >> 5;
      r12.xyz = (int3)r10.xyz + (int3)r11.xyz;
      r11.z = visibleDecals.Load(r12.xyzw).x;
      r11.w = cmp((int)r5.w == (int)r10.w);
      bitmask.x = ((~(-1 << r6.w)) << 0) & 0xffffffff;  r12.x = (((uint)0 << 0) & bitmask.x) | ((uint)r11.z & ~bitmask.x);
      r11.z = r11.w ? r12.x : r11.z;
      r11.w = cmp((int)r7.w == (int)r10.w);
      if (r8.y == 0) r12.x = 0; else if (r8.y+0 < 32) {       r12.x = (uint)r11.z << (32-(r8.y + 0)); r12.x = (uint)r12.x >> (32-r8.y);      } else r12.x = (uint)r11.z >> 0;
      r11.z = r11.w ? r12.x : r11.z;
      r11.w = (int)r3.w + (int)r10.w;
      r12.xyz = r16.xyz;
      r20.xyz = r17.xyz;
      r21.xyz = r18.xyz;
      r13.zw = r19.xy;
      ...
      while (true) {
        ...
        r23.y = samp0[]..swiz;
          ...
          r24.z = samp0[]..swiz;
            ...
            r16.w = rsqrt(r16.w);
            r26.xyz = r25.xyz * r16.www;
            r16.w = dot(r26.xyz, r3.xyz);
            r16.w = cmp(r16.w >= 0.5);
            if (r16.w != 0) {
            // Known bad code for instruction (needs manual fix):
            ...
            r27.w = samp0[]..swiz;
              r25.w = r27.x;
              r25.x = dot(r9.xyzw, r25.xyzw);
              r28.x = r22.y;
              r28.y = r23.y;
              r28.z = r24.y;
              r28.w = r27.y;
              r25.y = dot(r9.xyzw, r28.xyzw);
              r27.x = r22.z;
              r27.y = r23.z;
              r27.z = r24.z;
              r25.z = dot(r9.xyzw, r27.xyzw);
              ...
              r24.w = samp0[]..swiz;
                ...
                if (r30.x != 0) {
                  if (4 == 0) r16.w = 0; else if (4+24 < 32) {                   r16.w = (uint)r23.w << (32-(4 + 24)); r16.w = (uint)r16.w >> (32-4);                  } else r16.w = (uint)r23.w >> 24;
                  r16.w = 1 << (int)r16.w;
                  r17.w = (uint)r23.w >> 28;
                  r17.w = 1 << (int)r17.w;
                  r18.w = cmp((int)r30.x == 4);
                  if (r18.w != 0) {
                    r18.w = (int)r23.w & 4095;
                    if (12 == 0) r20.w = 0; else if (12+12 < 32) {                     r20.w = (uint)r23.w << (32-(12 + 12)); r20.w = (uint)r20.w >> (32-12);                    } else r20.w = (uint)r23.w >> 12;
                    r21.w = (int)r24.w & 1023;
                    r31.xz = (uint2)r16.ww;
                    r31.y = (uint)r17.w;
                ...
                r17.w = cmp(r23.x != 1.000000);
                r18.w = r16.w + r22.w;
                r18.w = saturate(r18.w * r23.x + -r23.x);
                r16.w = r17.w ? r18.w : r16.w;
                if (r30.y != 0) {
                  if (4 == 0) r17.w = 0; else if (4+24 < 32) {                   r17.w = (uint)r24.y << (32-(4 + 24)); r17.w = (uint)r17.w >> (32-4);                  } else r17.w = (uint)r24.y >> 24;
                  r17.w = 1 << (int)r17.w;
                  r18.w = (uint)r24.y >> 28;
                  r18.w = 1 << (int)r18.w;
                  r20.w = cmp((int)r30.y == 2);
                  if (r20.w != 0) {
                    ...
                    r20.w = materialTexMask.SampleGrad(samplerLinearClamp_s, r32.xyz, r30.x, r31.x).x;
                  } else {
                    r21.w = cmp((int)r30.y == 4);
                    if (r21.w != 0) {
                      r21.w = (int)r24.y & 4095;
                      if (12 == 0) r23.x = 0; else if (12+12 < 32) {                       r23.x = (uint)r24.y << (32-(12 + 12)); r23.x = (uint)r23.x >> (32-12);                      } else r23.x = (uint)r24.y >> 12;
                      if (10 == 0) r23.w = 0; else if (10+20 < 32) {                       r23.w = (uint)r24.w << (32-(10 + 20)); r23.w = (uint)r23.w >> (32-10);                      } else r23.w = (uint)r24.w >> 20;
                      r30.xz = (uint2)r17.ww;
                      r30.y = (uint)r18.w;
                      ...
                      r20.w = materialTexBC7.SampleGrad(samplerLinearClamp_s, r31.xyz, r32.x, r30.x).x;
                    } else {
                      r21.w = (int)r24.y & 4095;
                      if (12 == 0) r23.x = 0; else if (12+12 < 32) {                       r23.x = (uint)r24.y << (32-(12 + 12)); r23.x = (uint)r23.x >> (32-12);                      } else r23.x = (uint)r24.y >> 12;
                      if (10 == 0) r23.w = 0; else if (10+20 < 32) {                       r23.w = (uint)r24.w << (32-(10 + 20)); r23.w = (uint)r23.w >> (32-10);                      } else r23.w = (uint)r24.w >> 20;
                      ...
                      r30.xyz = r33.xyz * r30.xyz;
                      r20.w = materialTexBC3.SampleGrad(samplerLinearClamp_s, r31.xyz, r32.x, r30.x).x;
                    }
                  }
                  r30.xyz = r20.www * float3(0.959999979,0.959999979,0.959999979) + float3(0.0399999991,0.0399999991,0.0399999991);
                ...
                if (r23.x != 0) {
                  ...
                  r15.w = samp0[]..swiz;
                    ...
                    r31.xyz = r34.xyz * r31.xyz;
                    r15.w = materialTexMask.SampleGrad(samplerLinearClamp_s, r32.xyz, r33.x, r31.x).x;
                  } else {
                    r17.w = cmp((int)r23.x == 6);
                    r15.w = r17.w ? 0 : 1;
                  }
                } else {
                  r15.w = 1;
                ...
                if (r23.y != 0) {
                  ...
                  r20.w = rsqrt(r20.w);
                  r23.xyz = r28.xyz * r20.www;
                  r20.w = dot(-r27.xyz, -r27.xyz);
                  r20.w = rsqrt(r20.w);
                  r24.xyz = -r27.xyz * r20.www;
                  r25.xyz = r26.xyz * r2.yyy;
                  r23.xyz = r23.xyz * r2.yyy;
                  ...
                  r23.xyz = r25.xyz * r17.www + r23.xyz;
                  r17.w = dot(r23.xyz, r23.xyz);
                  r17.w = rsqrt(r17.w);
                  r23.xyz = r23.xyz * r17.www;
                  r17.w = 1 + -r16.w;
                  r24.xyz = r20.xyz * r17.www;
                  r20.xyz = r23.xyz * r16.www + r24.xyz;
                }
                r17.w = 1 + -r16.w;
                r23.xyz = r17.www * r12.xyz;
                r12.xyz = r22.xyz * r16.www + r23.xyz;
                r22.xyz = r21.xyz * r17.www;
                r21.xyz = r30.xyz * r16.www + r22.xyz;
                r18.w = r17.w * r13.w;
  ...
  r2.y = 1 + -r13.x;
  r0.xyz = r0.xyz * r2.yyy + r8.xzw;
  r0.w = r0.w * r2.y + r13.x;
  r1.yzw = r1.yzw * r2.yyy + r14.xyz;
  r3.w = dot(r1.yzw, r1.yzw);
  r3.w = rsqrt(r3.w);
  r6.xyz = r3.www * r1.yzw;
  r1.y = r1.x * r2.y + r13.y;
  r7.xyz = r2.yyy * float3(0.0399999991,0.0399999991,0.0399999991) + r15.xyz;
  ...
  if (r1.z != 0) {
    ...
    r1.z = rsqrt(r1.z);
    r9.xyz = -v6.xyz * r1.zzz;
    r10.x = dot(r9.xyz, r4.xyz);
    r10.y = dot(r9.xyz, r5.xyz);
    r1.z = dot(r9.xyz, r3.xyz);
    r1.w = cmp(0 < r1.z);
    r8.zw = -r10.xy / r1.zz;
    r1.zw = r1.ww ? r8.zw : 0;
    ...
    r10.y = r10.x;
    r10.z = r9.x;
    r11.x = dot(r10.yz, r1.zw);
    r10.x = -r9.x;
    r11.y = dot(r10.xy, r1.zw);
    r1.zw = gameTime.ww * scrollUVs.xy;
    r1.zw = r1.zw * scaleUVs.xy + r11.xy;
    ...
    r8.zw = saturate(r1.zw);
    r8.xy = clampU ? r8.zw : r1.zw;
  }
  r8.xyzw = emissiveMap1.Sample(colorSampler_s, r8.xy).xyzw;
  r8.xyzw = emissiveTint1.xyzw * r8.xyzw;
  r8.xyz = r8.xyz * r8.www;
  r8.xyz = alphaLayer1 * r8.xyz;
  r1.z = v2.x + v2.y;
  r1.z = v2.z + r1.z;
  r1.w = flickerSeed.y + r1.z;
  r1.w = frac(r1.w);
  r9.y = gameTime.w * flickerSpeed + r1.w;
  r9.x = flickerSeed.x;
  r1.w = flickerLookupMap.SampleLevel(lookupSampler_s, r9.xy, 0).x;
  r1.w = log2(abs(r1.w));
  ...
  if (r1.w != 0) {
    ...
    r1.w = dot(r10.xyz, r3.xyz);
    r3.w = cmp(0 < r1.w);
    r9.zw = -r11.xy / r1.ww;
    r9.zw = r3.ww ? r9.zw : 0;
    r10.xy = float2(-0.5,-0.5) + w1.xy;
    r1.w = 9.99999975e-06 + layer2Depth;
    r9.zw = r9.zw * r1.ww;
    r9.zw = scaleUVs2.xy * r9.zw;
    r9.zw = r10.xy * scaleUVs2.xy + r9.zw;
    r9.zw = offsetUVs2.xy * scaleUVs2.xy + r9.zw;
    ...
    r11.y = r11.x;
    r11.z = r10.x;
    r12.x = dot(r11.yz, r9.zw);
    r11.x = -r10.x;
    r12.y = dot(r11.xy, r9.zw);
    r9.zw = gameTime.ww * scrollUVs2.xy;
    r9.zw = r9.zw * scaleUVs2.xy + r12.xy;
    ...
    r10.xy = saturate(r9.zw);
    r9.x = clampU2 ? r10.x : r9.z;
    r9.y = clampV2 ? r10.y : r9.w;
  }
  r9.xyzw = emissiveMap2.Sample(colorSampler_s, r9.xy).xyzw;
  r9.xyz = emissiveTint2.xyz * r9.xyz;
  r1.w = hdrScale * r9.w;
  r9.xyz = r9.xyz * r1.www;
  r9.xyz = alphaLayer2 * r9.xyz;
  r1.w = clampV2 + r1.z;
  r1.w = frac(r1.w);
  r10.y = gameTime.w * clampV2 + r1.w;
  r10.x = clampV2;
  ...
  r9.xyz = r9.xyz * r1.www;
  r1.w = -r9.w * alphaLayer2 + 1;
  r8.xyz = r8.xyz * r1.www + r9.xyz;
  ...
  if (r1.w != 0) {
    ...
    r5.y = r5.x;
    r5.z = r4.x;
    r10.x = dot(r5.yz, r3.xy);
    r5.x = -r4.x;
    r10.y = dot(r5.xy, r3.xy);
    r3.xy = gameTime.ww * scrollUVs3.xy;
    r3.xy = r3.xy * scaleUVs3.xy + r10.xy;
    ...
    r9.x = clampU3 ? r3.z : r3.x;
    r9.y = clampV3 ? r3.w : r3.y;
  }
  r3.xyzw = emissiveMap3.Sample(colorSampler_s, r9.xy).xyzw;
  r3.xyz = emissiveTint3.xyz * r3.xyz;
  r1.w = hdrScale * r3.w;
  r3.xyz = r3.xyz * r1.www;
  r3.xyz = alphaLayer3 * r3.xyz;
  r1.z = clampV3 + r1.z;
  r1.z = frac(r1.z);
  ...
  r5.xy = (uint2)r2.wz;
  r2.y = dot(r5.yx, float2(0.0671105608,0.00583714992));
  r2.y = frac(r2.y);
  r2.xy = float2(0.0078125,52.9829178) * r2.xy;
  r2.y = frac(r2.y);
  r2.y = r2.y * 6.28318548 + gameTick.w;
  sincos(r2.y, r8.x, r9.x);
  r2.y = dot(r5.xy, float2(0.0671105608,0.00583714992));
  r2.y = frac(r2.y);
  r2.y = 52.9829178 * r2.y;
  r2.y = frac(r2.y);
  r2.y = r2.y * 6.28318548 + gameTick.w;
  sincos(r2.y, r5.x, r10.x);
  r1.x = saturate(dot(r6.xyz, r4.xyz));
  r2.y = dot(-r4.xyz, r6.xyz);
  r2.y = r2.y + r2.y;
  r11.xyz = r6.xyz * -r2.yyy + -r4.xyz;
  r2.y = 17 * r1.y;
  r2.y = exp2(r2.y);
  r2.y = 2 + r2.y;
  r2.y = 2 / r2.y;
  ...
  r5.w = 100 * r5.w;
  r8.zw = -r5.yy * float2(10,5) + float2(6.85740995,7.08500004);
  r7.w = exp2(r8.z);
  r7.w = r7.w * r1.x;
  r7.w = 9.1368103 * r7.w;
  r8.z = r5.z * r5.y;
      ...
      r14.y = samp0[]..swiz;
        ...
        r31.w = samp0[]..swiz;
          ...
          r37.y = samp0[]..swiz;
            ...
            r32.y = dot(r6.xyz, r25.xyz);
            r32.z = dot(r6.xyz, r28.xyz);
  ...
  if (r2.z != 0) {
    ...
    r11.w = 0;
    r5.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r11.xyzw, r5.z).xyz;
    r2.x = sunConstants.globalProbeExposure * r2.z + -r2.w;
    r2.x = r1.y * r2.x + r2.w;
    r10.yzw = r5.yzw * r2.xxx + r10.yzw;
  }
  ...
  if (r6.w != 0) {
    ...
    if (r6.w != 0) {
      ...
      r15.w = r17.z;
      r13.w = r14.z;
      r13.xyzw = r5.zzzz ? r15.xyzw : r13.xyzw;
      r17.zw = r16.xy;
      r14.zw = r2.xz;
      r15.xyzw = r5.zzzz ? r17.xyzw : r14.xyzw;
      r2.w = r5.z ? r16.z : r2.w;
      r14.z = r13.w;
      r14.xy = r15.xy;
      r2.xz = r15.zw;
    }
            ...
            if (r16.w != 0) {
              ...
              if (r16.w != 0) {
                ...
                if (r16.w != 0) {
                  ...
                  r11.w = r11.w + -r16.z;
                  r11.w = r4.w * r11.w + r16.z;
                  r11.w = r11.w * r13.w;
                  r33.x = r32.x;
                  r12.w = cmp(0 < r14.w);
                  r20.xyz = r11.www * r33.xyz + r17.xyz;
                  r11.w = saturate(dot(r6.xyz, r40.xyz));
                  r39.xyz = r39.xyz * r9.www + r4.xyz;
                  r9.w = dot(r39.xyz, r39.xyz);
                  r9.w = rsqrt(r9.w);
                  r39.xyz = r39.xyz * r9.www;
                  r9.w = dot(r39.xyz, r4.xyz);
                  r14.w = dot(r6.xyz, r39.xyz);
                  r16.z = abs(r14.w) * r2.y + -abs(r14.w);
                  r14.w = abs(r14.w) * r16.z + 1;
                  r16.z = r11.w * r1.y + r5.y;
                  r14.w = r14.w * r14.w;
                  r14.w = r14.w * r16.z;
                  r14.w = rcp(r14.w);
                  r11.w = r11.w * r16.w;
            ...
            r40.w = samp0[]..swiz;
              ...
              if (r13.w != 0) {
                ...
                if (r13.w != 0) {
                  ...
                  r14.w = dot(r6.xyz, r20.xyz);
                  r16.w = abs(r14.w) * r2.y + -abs(r14.w);
                  r14.w = abs(r14.w) * r16.w + 1;
                  r12.w = r12.w * r1.y + r5.y;
                  r14.w = r14.w * r14.w;
                  r12.w = r14.w * r12.w;
                  r12.w = rcp(r12.w);
                  r12.w = r12.w * r13.w;
