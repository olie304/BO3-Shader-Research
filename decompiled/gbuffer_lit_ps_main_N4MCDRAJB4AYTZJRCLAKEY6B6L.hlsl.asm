...
sample_indexable(texture2d)(float,float,float,float) r1.xyz, v1.yzyy, t9.xyzw, s2
...
sample_indexable(texture2d)(float,float,float,float) r4.xyzw, v1.yzyy, t18.xyzw, s5
