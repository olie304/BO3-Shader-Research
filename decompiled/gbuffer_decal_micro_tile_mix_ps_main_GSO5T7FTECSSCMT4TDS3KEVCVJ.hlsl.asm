...
dcl_output o2.xyzw
dcl_temps 9
mul r0.xy, v2.xyxx, cb0[12].zwzz
sample_indexable(texture2d)(float,float,float,float) r0.x, r0.xyxx, t19.xyzw, s5
sample_indexable(texture2d)(float,float,float,float) r0.yzw, v2.xyxx, t10.wxyz, s3
...
sample_indexable(texture2d)(float,float,float,float) r2.z, v2.xyxx, t12.yzxw, s4
...
if_nz r1.z
  ftoi r1.z, cb1[64].w
  lod r1.w, v2.xyxx, t6.y, s1
  lod r2.x, v2.xyxx, t6.x, s1
  lt r1.w, r1.w, r2.x
