...
sample_indexable(texture2d)(float,float,float,float) r0.w, r0.xyxx, t9.yzwx, s2
...
sample_indexable(texture2d)(float,float,float,float) r5.xyz, r0.xyxx, t11.xyzw, s3
...
mad r4.xy, r0.xyxx, cb0[12].zzzz, r3.xyxx
dp3 r0.x, r4.xyzx, r4.xyzx
rsq r0.x, r0.x
mul r3.xyw, r0.xxxx, r4.xyxz
mad r0.x, r3.z, cb0[12].z, r2.w
...
add r0.x, r0.x, r1.w
log r0.x, r0.x
mul_sat r0.xw, r0.xxxw, l(-0.05882353, 0.000000, 0.000000, -0.05882353)
...
mad r3.xyz, r4.xyzx, r0.yyyy, -r1.wwww
max r0.y, r3.z, r3.y
max r0.y, r0.y, r3.x
max r0.y, r0.y, r1.w
eq r1.w, r0.y, r3.x
