// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:38:47 2021
...
cbuffer _Globals : register(b0)
{
  ...
  bool invertFalloff : packoffset(c17);
  float2 emissiveScaleUVs : packoffset(c17.y);
  float2 emissiveScrollUVs : packoffset(c18);
  float edgeHighlightPower : packoffset(c18.z);
  float scriptReplacement : packoffset(c18.w);
  float2 scriptReplacementEmissive : packoffset(c19);
  float3 tint1 : packoffset(c20);
  float3 tint2 : packoffset(c21);
  float3 tint3 : packoffset(c22);
}
...
Texture2D<float4> transColorMap : register(t26);
Texture2D<float4> transNormalMap : register(t29);
Texture2D<float4> transGlossMap : register(t30);
...
Texture2D<float4> transRevealMap : register(t37);
...
r0.y = samp0[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) r0.z, r0.x, l(0), t0.xxxx
r0.z = samp0[]..swiz;
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=384)(mixed,mixed,mixed,mixed) r0.xw, r0.x, l(36), t0.xxxy
r0.x = samp0[]..swiz;
r0.w = samp0[]..swiz;
  r1.x = transRevealMap.Sample(transitionSampler_s, w1.xy).x;
  r0.z = saturate(r0.z * 0.998000026 + 0.00100000005);
  r1.y = 1 + -r0.z;
  r1.z = saturate(transRevealRamp);
  r0.z = log2(r0.z);
  r0.z = r1.z * r0.z;
  r0.z = exp2(r0.z);
  r2.x = -r0.z;
  ...
  r0.z = r1.z * r0.z;
  r2.y = exp2(r0.z);
  r1.yz = saturate(transRevealSoftEdge * r2.xy + r1.yy);
  r0.z = r1.x + -r1.y;
  r1.x = r1.z + -r1.y;
  r0.z = saturate(r0.z / r1.x);
  r1.xy = transScale.xy * w1.xy;
  r2.xyzw = colorMap.Sample(colorSampler_s, w1.xy).xyzw;
  ...
  r3.y = cmp(0 < r0.z);
  r4.xyzw = transColorMap.Sample(transitionSampler_s, r1.xy).xyzw;
  r3.z = transGlossMap.Sample(transitionSampler_s, r1.xy).x;
  if (r3.y != 0) {
    r5.xyz = float3(-1,-1,-1) + transColorTint.xyz;
    r5.xyz = r4.www * r5.xyz + float3(1,1,1);
    r3.y = transGlossRange.y + -transGlossRange.x;
    r3.y = r3.z * r3.y + transGlossRange.x;
  ...
  r3.y = min(1, r3.y);
  r3.w = cmp(0 < r3.z);
  r5.xyz = transNormalMap.Sample(transitionSampler_s, r1.xy).xyz;
  if (r3.w != 0) {
    r5.xyz = float3(-0.5,-0.5,-0) + r5.xyz;
    r5.xyz = transNormalHeight * r5.xyz + float3(0.5,0.5,0);
    r1.xy = r5.xy * float2(1.9921875,1.9921875) + float2(-1,-1);
    r3.w = r5.z * r5.z;
    r3.w = 0.333333343 * r3.w;
    r3.w = min(1, r3.w);
    r4.xy = r1.xy * r3.zz + r4.xy;
    r1.x = dot(r4.xyw, r4.xyw);
    r1.x = rsqrt(r1.x);
    r4.xyw = r4.xyw * r1.xxx;
    r3.y = r3.w * r3.z + r3.y;
  }
  r1.x = v7.x ? 1 : -1;
  ...
  r1.w = debugGlossOverride.x * r3.x + glossRange.x;
  ...
  if (r3.x != 0) {
    ...
    r3.y = colorMap.CalculateLevelOfDetailUnclamped(colorSampler_s, w1.xy);
    r3.z = colorMap.CalculateLevelOfDetail(colorSampler_s, w1.xy);
    r3.y = cmp(r3.y < r3.z);
    r3.z = cmp(0 < r3.z);
    r6.xyz = (int3)r3.xxx & int3(1,2,4);
    r7.xyz = r6.xxx ? float3(1,0,1) : r2.xyz;
    r6.xyw = r6.yyy ? float3(0,1,1) : r2.xyz;
    r3.xzw = r3.zzz ? r7.xyz : r6.xyw;
    r6.xyz = r6.zzz ? float3(0,1,0) : r2.xyz;
    r2.xyz = r3.yyy ? r3.xzw : r6.xyz;
  }
  r3.xyz = debugColorOverride.xyz + -r2.xyz;
  r2.xyz = debugColorOverride.www * r3.xyz + r2.xyz;
  r3.x = debugAlphaOverride.x + -r2.w;
  r2.w = debugAlphaOverride.w * r3.x + r2.w;
  ...
  if (r6.z != 0) {
    ...
    while (true) {
      ...
      r7.w = cmp((int)r0.y == (int)r5.w);
      if (r4.w == 0) r8.w = 0; else if (r4.w+0 < 32) {       r8.w = (uint)r6.z << (32-(r4.w + 0)); r8.w = (uint)r8.w >> (32-r4.w);      } else r8.w = (uint)r6.z >> 0;
      r6.z = r7.w ? r8.w : r6.z;
      r7.w = (int)r3.w + (int)r5.w;
      r17.xyzw = r13.xzwy;
      r12.xyz = r14.xyz;
      r18.yz = r15.yz;
      r19.xy = r16.xy;
      ...
      while (true) {
        ...
        r21.y = samp0[]..swiz;
          ...
          r22.z = samp0[]..swiz;
            ...
            r23.y = r21.x;
            r23.z = r22.x;
            r11.z = dot(r23.xyz, r23.xyz);
            r11.z = rsqrt(r11.z);
            r24.xyz = r23.xyz * r11.zzz;
            r11.z = dot(r24.xyz, v3.xyz);
            r11.z = cmp(r11.z >= 0.5);
            if (r11.z != 0) {
            // Known bad code for instruction (needs manual fix):
            ...
            r25.w = samp0[]..swiz;
              ...
              r22.w = samp0[]..swiz;
                ...
                if (r28.x != 0) {
                  if (4 == 0) r14.w = 0; else if (4+24 < 32) {                   r14.w = (uint)r21.w << (32-(4 + 24)); r14.w = (uint)r14.w >> (32-4);                  } else r14.w = (uint)r21.w >> 24;
                  r14.w = 1 << (int)r14.w;
                  r15.w = (uint)r21.w >> 28;
                  r15.w = 1 << (int)r15.w;
                  r16.w = cmp((int)r28.x == 4);
                  if (r16.w != 0) {
                ...
                if (r21.y != 0) {
                  ...
                  r18.xyz = r21.xyz * r14.www + r22.xyz;
                  r17.x = r18.x;
                }
                r11.z = 1 + -r14.w;
                r21.xyz = r12.xyz * r11.zzz;
                r12.xyz = r20.xyz * r14.www + r21.xyz;
                r19.z = r17.y;
                r20.xyz = r19.xyz * r11.zzz;
                r19.xyz = r28.xyz * r14.www + r20.xyz;
                r11.w = r17.w * r11.z;
                r17.z = r17.z * r11.z + r14.w;
                r17.w = r10.w * r14.w + r11.w;
                r17.y = r19.z;
              }
            }
          }
  ...
  if (r6.w != 0) {
    ...
    while (true) {
      ...
      r10.w = cmp((int)r4.w == (int)r7.w);
      bitmask.z = ((~(-1 << r5.w)) << 0) & 0xffffffff;  r11.z = (((uint)0 << 0) & bitmask.z) | ((uint)r8.w & ~bitmask.z);
      r8.w = r10.w ? r11.z : r8.w;
      r10.w = cmp((int)r6.z == (int)r7.w);
      if (r6.w == 0) r11.z = 0; else if (r6.w+0 < 32) {       r11.z = (uint)r8.w << (32-(r6.w + 0)); r11.z = (uint)r11.z >> (32-r6.w);      } else r11.z = (uint)r8.w >> 0;
      r8.w = r10.w ? r11.z : r8.w;
      r10.w = (int)r3.w + (int)r7.w;
      r12.xyz = r17.xyz;
      r21.xyz = r18.xyz;
      r22.xyz = r19.xyz;
      r11.zw = r20.xy;
              ...
              r25.w = samp0[]..swiz;
                ...
                if (r31.y != 0) {
                  ...
                  if (r17.w != 0) {
                    ...
                    r17.w = materialTexMask.SampleGrad(samplerLinearClamp_s, r33.xyz, r31.x, r32.x).x;
                  } else {
                    r18.w = cmp((int)r31.y == 4);
                    if (r18.w != 0) {
                ...
                if (r24.x != 0) {
                  ...
                  r13.w = samp0[]..swiz;
                    ...
                    r32.xyz = r35.xyz * r32.xyz;
                    r13.w = materialTexMask.SampleGrad(samplerLinearClamp_s, r33.xyz, r34.x, r32.x).x;
                  } else {
                    r15.w = cmp((int)r24.x == 6);
                    r13.w = r15.w ? 0 : 1;
                  }
                } else {
                  r13.w = 1;
                ...
                if (r24.y != 0) {
                  ...
                  r26.xyz = r27.xyz * r1.xxx;
                  r24.xyz = r24.xyz * r1.xxx;
                  r25.xyz = r25.xyz * r1.xxx;
                  r17.w = -17 * r13.w;
                  r17.w = exp2(r17.w);
                  r16.w = r17.w + r16.w;
                  r16.w = log2(r16.w);
                  ...
                  r15.w = 1 + -r14.w;
                  r25.xyz = r21.xyz * r15.www;
                  r21.xyz = r24.xyz * r14.www + r25.xyz;
                }
                r15.w = 1 + -r14.w;
                r24.xyz = r15.www * r12.xyz;
  ...
  o0.w = r2.w * r0.y + r13.x;
  r4.xyz = r4.xyz * r0.yyy + r15.xyz;
  r1.x = dot(r4.xyz, r4.xyz);
  r1.x = rsqrt(r1.x);
  r4.xyz = r4.xyz * r1.xxx;
  r1.y = r1.y * r0.y + r13.y;
  r3.xyz = r3.xyz * r0.yyy + r16.xyz;
  r6.zw = float2(-0.00999999978,-0.800000012) + r0.zz;
  r6.zw = float2(1.26582277,5.00000048) * r6.zw;
  r6.z = saturate(r6.z);
  r2.w = r6.z * -2 + 3;
  r3.w = r6.z * r6.z;
  r2.w = r3.w * r2.w;
  r2.w = log2(r2.w);
  r2.w = edgeHighlightPower * r2.w;
  r2.w = exp2(r2.w);
  r3.w = max(0, r6.w);
  r5.w = r3.w * -2 + 3;
  r3.w = r3.w * r3.w;
  r3.w = -r5.w * r3.w + 1;
  r3.w = log2(r3.w);
  r3.w = edgeHighlightPower * r3.w;
  r3.w = exp2(r3.w);
  r2.w = r3.w * r2.w;
  r0.z = saturate(r2.w * 0.99000001 + -r0.z);
  r0.z = hdrScale * r0.z;
  r0.x = saturate(r0.x);
  r0.x = r0.z * r0.x;
  r7.xyz = cmp(r0.www == float3(3,2,1));
  r8.xyz = r7.zzz ? tint1.xyz : emissiveTint1.xyz;
  r7.yzw = r7.yyy ? tint2.xyz : r8.xyz;
  r7.xyz = r7.xxx ? tint3.xyz : r7.yzw;
  r0.zw = gameTime.ww * emissiveScrollUVs.xy;
  r0.zw = w1.xy * invertFalloff + r0.zw;
  r2.w = dot(-v6.xyz, -v6.xyz);
  r2.w = rsqrt(r2.w);
  r8.xyz = -v6.xyz * r2.www;
  r3.w = saturate(dot(r8.xyz, r5.xyz));
  r5.xyzw = emissiveMap.Sample(colorSampler_s, r0.zw).xyzw;
  ...
  r0.w = exp2(r0.w);
  r0.z = invertFalloff ? r0.w : r0.z;
  r0.w = cmp(emissiveFalloffPower == 0.000000);
  r0.z = r0.w ? 1 : r0.z;
  r0.x = r5.w * r0.x;
  r0.x = r0.x * r0.z;
  r0.x = r0.x * r0.y;
  ...
  if (r1.w == 0) {
    ...
    if (r5.z != 0) {
      ...
      r19.xyz = r22.xyz * r1.www + r6.xyz;
      r11.w = 0;
      r6.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r11.xyzw, r5.w).xyz;
      r1.w = sunConstants.globalProbeExposure * r5.z + -r4.w;
      r1.w = r1.y * r1.w + r4.w;
      r20.xyz = r6.xyz * r1.www + r20.xyz;
    }
  } else {
    r20.x = r19.w;
  }
  ...
  r10.yzw = r20.xyz * r1.www;
  r13.xyz = r10.zwy * r1.yyy;
  r1.yzw = r10.yzw * r1.zzz;
  r4.w = sqrt(r5.y);
  r4.w = r4.w * 0.5 + 0.5;
  r4.w = r4.w * r4.w;
  r5.z = 0.5 * r4.w;
  ...
  if (r7.w != 0) {
    ...
    if (r7.w != 0) {
      ...
      r7.z = r8.w * r7.z;
      r7.z = 0.25 * r7.z;
      r15.xyz = r7.zzz * r10.yzw + r1.yzw;
      r2.w = saturate(1 + -r2.w);
      r7.w = r2.w * r2.w;
      r7.w = r7.w * r7.w;
      r2.w = r7.w * r2.w;
      r2.w = r7.z * r2.w;
      r16.xyz = r2.www * r10.zwy + r13.xyz;
      r14.w = r16.z;
      r6.w = r13.z;
