...
and r0.y, r1.z, r0.y
and r0.y, r1.w, r0.y
add r1.xy, -cb0[13].xzxx, cb0[13].ywyy
max r0.w, r1.x, l(0.000100)
div r1.xz, v4.xxyx, v4.zzzz
deriv_rtx_coarse r2.xy, r1.xzxx
deriv_rty_coarse r2.zw, r1.xxxz
sample_d_indexable(texture2d)(float,float,float,float) r3.xyzw, r1.xzxx, t21.xyzw, s1, r2.xyxx, r2.zwzz
sample_d_indexable(texture2d)(float,float,float,float) r1.x, r1.xzxx, t22.xyzw, s1, r2.xyxx, r2.zwzz
dp3 r1.z, r3.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
add r2.xyz, -r3.xyzx, r1.zzzz
mad r2.xyz, cb0[12].zzzz, r2.xyzx, r3.xyzx
max r1.z, r3.w, l(0.000100)
div_sat r4.xyz, r2.xyzx, r1.zzzz
add_sat r4.xyz, r4.xyzx, -cb0[13].xxxx
div r4.xyz, r4.xyzx, r0.wwww
min r4.xyz, r4.xyzx, l(1.000000, 1.000000, 1.000000, 0.000000)
mad r4.xyz, r4.xyzx, r1.yyyy, cb0[13].zzzz
...
exp r5.xyz, r5.xyzx
ge r6.xyz, l(0.040450, 0.040450, 0.040450, 0.000000), r4.xyzx
mul r4.xyz, r4.xyzx, l(0.07739938, 0.07739938, 0.07739938, 0.000000)
movc r4.xyz, r6.xyzx, r4.xyzx, r5.xyzx
mul r4.xyz, r3.wwww, r4.xyzx
movc r3.xyz, r0.yyyy, r2.xyzx, r4.xyzx
div r1.yzw, r3.xxyz, r1.zzzz
add r0.y, r3.w, v1.w
mad_sat r2.y, r0.y, v6.y, -v6.y
mul r2.xzw, r1.yyzw, r2.yyyy
ne r0.y, v6.y, l(1.000000)
movc r3.xyzw, r0.yyyy, r2.xzwy, r3.xyzw
mul r3.xyzw, r0.xxxx, r3.xyzw
mov r2.x, l(1.000000)
movc r0.yw, r0.yyyy, r2.xxxy, v1.wwww
mul r2.xyzw, r0.yyyy, r3.xyzw
mul r0.x, r0.x, r0.w
dp3 r0.y, v5.xyzx, v5.xyzx
rsq r0.y, r0.y
mul r1.yzw, r0.yyyy, v5.xxyz
dp3 r0.y, v7.xyzx, v5.xyzx
mad r3.xyz, -v7.xyzx, r0.yyyy, v5.xyzx
dp3 r0.y, r3.xyzx, r3.xyzx
rsq r0.y, r0.y
mul r3.xyz, r0.yyyy, r3.xyzx
ieq r0.yw, v6.wwww, l(0, 1, 0, 2)
movc r3.xyz, r0.wwww, r3.xyzx, v7.xyzx
movc r1.yzw, r0.yyyy, r1.yyzw, r3.xxyz
dp3 r0.y, -v5.xyzx, -v5.xyzx
rsq r0.y, r0.y
mul r3.xyz, r0.yyyy, -v5.xyzx
dp3 r0.y, r3.xyzx, r1.yzwy
mul r0.y, r0.y, r0.y
mad_sat r0.y, r0.y, v8.x, v8.y
mul r2.xyzw, r0.yyyy, r2.xyzw
mul r0.y, r0.y, r0.x
mov r0.x, r2.w
and r1.yzw, r0.zzzz, r2.xxyz
and r0.xw, r0.yyyx, r0.zzzz
mul r1.x, r0.x, r1.x
...
mul r2.x, r2.x, v5.w
movc r2.x, cb0[14].x, cb0[12].x, r2.x
mul r1.x, r1.x, r2.x
mad r2.xyz, v2.xyzx, r1.xxxx, v1.xyzx
mul r3.xyz, r0.wwww, v3.xyzx
mad r1.xyz, r1.yzwy, r2.xyzx, -r3.xyzx
mad r1.xyz, v3.wwww, r1.xyzx, r3.xyzx
mul r2.xyz, r0.wwww, v11.xyzx
mad r1.xyz, r1.xyzx, v10.xyzx, r2.xyzx
