...
mul o0.w, r0.w, r1.x
sample_indexable(texture2d)(float,float,float,float) r0.w, v1.yzyy, t24.yzwx, s5
...
sample_indexable(texture2d)(float,float,float,float) r2.xyz, v1.yzyy, t25.xyzw, s6
