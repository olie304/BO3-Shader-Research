...
mul r0.z, r1.x, r2.w
sample_indexable(texture2d)(float,float,float,float) r2.x, r0.xyxx, t11.xyzw, s4
sample_indexable(texture2d)(float,float,float,float) r2.y, r0.xyxx, t10.yxzw, s2
add r2.z, -cb0[10].y, cb0[10].z
mad r2.y, r2.y, r2.z, cb0[10].y
mul_sat r2.y, r2.y, l(0.05882353)
sample_indexable(texture2d)(float,float,float,float) r3.xyz, r0.xyxx, t9.xyzw, s3
...
if_nz r3.z
  ftoi r3.z, cb1[64].w
  lod r4.y, r0.xyxx, t7.y, s1
  lod r0.x, r0.xyxx, t7.x, s1
  lt r0.y, r4.y, r0.x
  lt r0.x, l(0.000000), r0.x
  and r4.yzw, r3.zzzz, l(0, 1, 2, 4)
  movc r5.xyz, r4.yyyy, l(1.000000,0,1.000000,0), r1.yzwy
  movc r6.xyz, r4.zzzz, l(0,1.000000,1.000000,0), r1.yzwy
  movc r5.xyz, r0.xxxx, r5.xyzx, r6.xyzx
  movc r4.yzw, r4.wwww, l(0,0,1.000000,0), r1.yyzw
  movc r1.yzw, r0.yyyy, r5.xxyz, r4.yyzw
endif 
add r4.yzw, -r1.yyzw, cb1[58].xxyz
mad r1.yzw, cb1[58].wwww, r4.yyzw, r1.yyzw
mad r0.x, -r2.w, r1.x, cb1[59].x
...
add r0.y, -r2.y, r2.z
mad r0.y, cb1[62].w, r0.y, r2.y
add r0.z, -r2.x, cb1[63].x
mad r2.z, cb1[63].w, r0.z, r2.x
mad r5.xyz, v5.xyzx, r4.xxxx, -r3.xywx
mad r3.xyz, cb1[60].wwww, r5.xyzx, r3.xywx
ne r0.z, v6.w, l(1.000000)
max r1.x, r1.x, l(0.001000)
div r1.x, r0.x, r1.x
mad r0.w, v8.w, r0.w, r1.x
mad_sat r0.w, r0.w, v6.w, -v6.w
