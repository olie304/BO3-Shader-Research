...
gather4_indexable(texture2d)(float,float,float,float) r17.xyzw, r1.zwzz, t27.xyzw, s4.x
gather4_indexable(texture2d)(float,float,float,float) r18.xyzw, r1.zwzz, t28.xyzw, s4.x
mul r1.zw, r9.xxxy, l(0.000000, 0.000000, 0.500000, 0.500000)
frc r1.zw, r1.zzzw
add r2.zw, -r1.wwwz, l(0.000000, 0.000000, 1.000000, 1.000000)
mul r19.y, r2.z, r2.w
mul r19.xz, r1.zzwz, r2.zzwz
mul r19.w, r1.w, r1.z
dp4 r1.z, r17.xyzw, r19.xyzw
add r18.xyzw, -r9.wwww, r18.xyzw
min r1.w, |r18.w|, |r18.z|
min r1.w, r1.w, |r18.y|
min r1.w, r1.w, |r18.x|
max r2.z, |r18.w|, |r18.z|
max r2.z, r2.z, |r18.y|
max r2.z, r2.z, |r18.x|
eq r15.yzw, r1.wwww, |r18.yyzw|
movc r1.w, r15.y, r17.y, r17.x
movc r1.w, r15.z, r17.z, r1.w
movc r1.w, r15.w, r17.w, r1.w
mul r2.w, r9.w, l(0.010000)
lt r2.z, r2.w, r2.z
...
loop 
  ...
  ieq r13.w, r8.w, r12.w
  bfi r14.w, r9.x, l(0), l(0), r13.z
  movc r13.z, r13.w, r14.w, r13.z
  ieq r13.w, r9.y, r12.w
  ubfe r14.w, r9.w, l(0), r13.z
  movc r13.z, r13.w, r14.w, r13.z
  ...
  loop 
    ...
    add r15.yzw, r10.xxyz, -cb10[r14.w + 0].xxyz
    ...
    loop 
      ...
      dp3 r26.z, cb11[r21.w + 0].xyzx, r15.yzwy
      add_sat r26.z, r26.z, cb11[r21.w + 0].w
      mul r26.z, r26.z, r26.x
      dp3 r26.w, cb11[r21.w + 1].xyzx, r15.yzwy
      add_sat r26.w, r26.w, cb11[r21.w + 1].w
      mul r26.z, r26.w, r26.z
      dp3 r26.w, cb11[r21.w + 2].xyzx, r15.yzwy
      add_sat r26.w, r26.w, cb11[r21.w + 2].w
      mul r26.z, r26.w, r26.z
      dp3 r26.w, cb11[r21.w + 3].xyzx, r15.yzwy
      add_sat r26.w, r26.w, cb11[r21.w + 3].w
      mul r26.z, r26.w, r26.z
      dp3 r26.w, cb11[r21.w + 4].xyzx, r15.yzwy
      add_sat r26.w, r26.w, cb11[r21.w + 4].w
      mul r26.z, r26.w, r26.z
      dp3 r26.w, cb11[r21.w + 5].xyzx, r15.yzwy
      add_sat r21.w, r26.w, cb11[r21.w + 5].w
      mul r26.x, r21.w, r26.z
      ushr r26.w, r17.x, l(2)
      ubfe r27.x, l(1), l(2), r17.x
      and r27.y, r26.w, l(2)
      max r27.z, r26.x, r26.y
      mad r21.w, -r26.z, r21.w, l(1.000000)
      mul r21.w, r21.w, r26.y
      movc r19.y, r27.y, r21.w, r27.z
      movc r26.xy, r27.xxxx, r26.xyxx, r19.xyxx
      iadd r20.w, r20.w, l(1)
      mov r17.x, r26.w
    endloop 
    mov_sat r26.y, r26.y
    mul r17.x, r26.y, cb10[r14.w + 6].y
    lt r17.w, l(0.000000), r17.x
    if_nz r17.w
      mad r25.z, r26.y, cb10[r14.w + 6].y, r25.z
      ...
      div r18.w, r19.y, r18.w
      min r17.w, r17.w, |r18.w|
      add r27.x, r15.y, cb10[r14.w + 3].w
      add r27.yz, r15.zzwz, cb10[r14.w + 4].xxyx
      ...
      sqrt r17.w, r17.w
      mad r17.w, r2.z, l(5.000000), r17.w
      ...
      mad_sat r15.yzw, r31.xxyz, cb10[r14.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
      mul r31.xy, r15.yzyy, cb10[r14.w + 4].zwzz
      mul r31.z, r15.w, cb10[r14.w + 5].x
      add r15.yzw, r31.xxyz, cb10[r14.w + 5].yyzw
...
if_nz r9.y
  ...
  loop 
    ...
    loop 
      breakc_z r13.w
      firstbit_lo r14.w, r13.w
      ishl r17.w, l(1), r14.w
      not r17.w, r17.w
      and r13.w, r13.w, r17.w
      iadd r14.w, r9.w, r14.w
      imul null, r14.w, r14.w, l(14)
      add r27.xyz, r10.xyzx, -cb10[r14.w + 0].xyzx
      and r17.w, l(0x0000ffff), cb10[r14.w + 7].z
      ubfe r18.w, l(6), l(25), cb10[r14.w + 7].z
      imul null, r19.z, r17.w, l(6)
      dp3 r19.w, cb11[r19.z + 0].xyzx, r27.xyzx
      add_sat r19.w, r19.w, cb11[r19.z + 0].w
      dp3 r20.w, cb11[r19.z + 1].xyzx, r27.xyzx
      add_sat r20.w, r20.w, cb11[r19.z + 1].w
      mul r19.w, r19.w, r20.w
      dp3 r20.w, cb11[r19.z + 2].xyzx, r27.xyzx
      add_sat r20.w, r20.w, cb11[r19.z + 2].w
      mul r19.w, r19.w, r20.w
      dp3 r20.w, cb11[r19.z + 3].xyzx, r27.xyzx
      add_sat r20.w, r20.w, cb11[r19.z + 3].w
      mul r19.w, r19.w, r20.w
      dp3 r20.w, cb11[r19.z + 4].xyzx, r27.xyzx
      add_sat r20.w, r20.w, cb11[r19.z + 4].w
      mul r19.w, r19.w, r20.w
      dp3 r20.w, cb11[r19.z + 5].xyzx, r27.xyzx
      add_sat r19.z, r20.w, cb11[r19.z + 5].w
      mul r17.x, r19.z, r19.w
      and r19.z, l(1), cb10[r14.w + 6].x
      movc r19.zw, r19.zzzz, r17.xxxy, r17.zzzx
      ...
      loop 
        ...
        iadd r21.w, r17.w, r20.w
        imul null, r21.w, r21.w, l(6)
        dp3 r26.w, cb11[r21.w + 0].xyzx, r27.xyzx
      ...
      if_nz r18.w
        ...
        mad r19.yzw, r16.xxyz, r17.wwww, r29.xxyz
        dp3 r18.w, r19.yzwy, r19.yzwy
        sqrt r18.w, r18.w
        div r17.w, r17.w, r18.w
        add r17.w, r17.w, r17.w
        ...
        ubfe r18.w, l(9), l(16), cb10[r14.w + 7].z
        utof r30.w, r18.w
        sample_l_indexable(texturecubearray)(float,float,float,float) r19.yzw, r30.xyzw, t8.wxyz, s2, r17.w
        ...
        mul r17.w, r6.w, r14.w
        mul r19.yzw, r17.xxxx, r19.yyzw
        dp3 r17.x, r19.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
        mad r14.w, r6.w, r14.w, r17.x
        div r14.w, r17.w, r14.w
        mad r25.xyz, r19.yzwy, r14.wwww, r25.xyzx
      endif 
    endloop 
...
mul r2.yzw, r0.xxxx, r15.yyzw
mul r15.yzw, r1.zzzz, r2.yyzw
...
ret 
// Approximately 1453 instruction slots used
