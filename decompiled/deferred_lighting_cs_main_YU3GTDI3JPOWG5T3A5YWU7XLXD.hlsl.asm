...
mov r13.w, l(0)
sample_l_indexable(texturecubearray)(float,float,float,float) r13.xyz, r13.xyzw, t8.xyzw, s2, r4.z
add r4.z, -r6.w, cb2[19].x
mad r4.z, r2.y, r4.z, r6.w
mul r13.xyz, r4.zzzz, r13.xyzx
add r4.z, r3.z, r2.x
log r4.z, |r4.z|
mul r4.z, r1.w, r4.z
exp r4.z, r4.z
...
if_nz r2.y
  ...
  if_nz r2.y
    ...
    mad r2.xyw, r0.wwww, r16.xyxz, r13.xyxz
    add_sat r0.z, -r0.z, l(1.000000)
    mul r1.z, r0.z, r0.z
    mul r1.z, r1.z, r1.z
    mul r0.z, r0.z, r1.z
    mul r0.z, r0.z, r0.w
    mad r4.xyz, r0.zzzz, r16.xyzx, r15.xzwx
    movc r14.xyz, r1.wwww, r17.xyzx, r14.xyzx
    movc r15.xzw, r1.wwww, r4.xxyz, r15.xxzw
    movc r13.xyz, r1.wwww, r2.xywx, r13.xyzx
    if_nz r2.z
...
mad r2.xyw, r13.xyxz, r3.xyxz, r2.xyxw
mad r2.xyw, r14.xyxz, r5.yzyw, r2.xyxw
