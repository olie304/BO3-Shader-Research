...
r5.w = modelInstanceBuffer[]..swiz;
  ...
  o1.xyz = exp2(r0.xyz);
  p1.x = v1.w;
  r0.xyz = float3(-0.5,-0.5,-0.5) + v1.xzy;
  r0.xyz = float3(4,4,4) * r0.xyz;
  r0.w = 4 * v1.w;
  r0.w = max(9.99999975e-05, r0.w);
  r0.xyz = r0.xyz / r0.www;
  r0.z = -0.400000006 + r0.z;
  o10.xy = r0.xy * float2(1,-1) + float2(0.5,0.5);
  r0.x = max(0, r0.z);
// Known bad code for instruction (needs manual fix):
...
r6.z = modelInstanceBuffer[]..swiz;
  ...
  r7.y = dot(r1.xyz, r4.xyz);
  r7.z = dot(r1.xyz, r5.xyz);
  r0.x = dot(r7.xyz, r7.xyz);
  r0.x = rsqrt(r0.x);
  o4.xyz = r7.xyz * r0.xxx;
  r7.xyz = v4.xyz * float3(2.00195694,2.00195694,2.00195694) + float3(-1.00195694,-1.00195694,-1.00195694);
  r8.x = dot(r7.xyz, r2.xyz);
  r8.y = dot(r7.xyz, r4.xyz);
  r8.z = dot(r7.xyz, r5.xyz);
  r0.x = dot(r8.xyz, r8.xyz);
  r0.x = rsqrt(r0.x);
  o5.xyz = r8.xyz * r0.xxx;
  r8.xyz = r7.yzx * r1.zxy;
  r1.xyz = r1.yzx * r7.zxy + -r8.xyz;
  r0.x = v4.w * 2 + -1;
