...
// ySampler                          sampler      NA          NA             s5      1 
// cbcrSampler                       sampler      NA          NA             s6      1 
...
// yTexture                          texture  float4          2d            t22      1 
// gSunShadowTree                    texture  struct         r/o            t23      1 
// cbcrTexture                       texture  float4          2d            t24      1 
...
sample_indexable(texture2d)(float,float,float,float) r3.z, r3.xyxx, t22.yzxw, s5
add r4.x, r3.z, l(-0.062500)
sample_indexable(texture2d)(float,float,float,float) r3.xy, r3.xyxx, t24.xyzw, s6
add r4.yz, r3.xxyx, l(0.000000, -0.500000, -0.500000, 0.000000)
dp2 r3.x, l(1.164400, 1.792700, 0.000000, 0.000000), r4.xzxx
dp3 r3.y, l(1.164400, -0.213300, -0.532900, 0.000000), r4.xyzx
dp2 r3.z, l(1.164400, 2.112400, 0.000000, 0.000000), r4.xyxx
ge r4.xyz, l(0.040450, 0.040450, 0.040450, 0.000000), r3.xyzx
mul r5.xyz, r3.xyzx, l(0.07739938, 0.07739938, 0.07739938, 0.000000)
...
ret 
// Approximately 2947 instruction slots used
