...
mad r0.xyz, r0.xyzx, r3.yyyy, r7.xzwx
mad r0.w, r0.w, r3.y, r12.x
mad r2.yzw, r2.yyzw, r3.yyyy, r13.xxyz
dp3 r4.w, r2.yzwy, r2.yzwy
rsq r4.w, r4.w
mul r5.xyz, r2.yzwy, r4.wwww
mad r2.y, r2.x, r3.y, r12.y
mad r1.xyz, r1.xyzx, r3.yyyy, r14.xyzx
lt r2.z, l(0.500000), cb0[21].y
if_nz r2.z
  mul r2.z, cb0[12].w, cb0[12].z
  mul r2.w, r2.z, cb0[13].x
  mul r4.w, r2.w, cb1[69].w
  ge r4.w, r4.w, -r4.w
  movc r4.w, r4.w, r2.w, -r2.w
  div r6.x, l(1.000000, 1.000000, 1.000000, 1.000000), r4.w
  ...
  mul r2.z, r2.z, r2.w
  round_ne r2.z, r2.z
  div r2.w, r2.z, cb0[12].w
  mul r4.w, r2.z, cb0[12].w
  ge r4.w, r4.w, -r4.w
  movc r4.w, r4.w, cb0[12].w, -cb0[12].w
  div r6.x, l(1.000000, 1.000000, 1.000000, 1.000000), r4.w
  mul r2.z, r2.z, r6.x
  frc r2.z, r2.z
  mul r2.z, r2.z, r4.w
  round_z r2.z, r2.z
  add r2.z, r2.z, v1.y
  div r6.x, r2.z, cb0[12].w
  round_z r2.z, r2.w
  add r2.z, r2.z, v1.z
  div r6.y, r2.z, cb0[12].z
else 
  dp3 r2.z, -v6.xyzx, -v6.xyzx
  rsq r2.z, r2.z
  mul r7.xyz, r2.zzzz, -v6.xyzx
  dp3 r8.x, r7.xyzx, v4.xyzx
  dp3 r8.y, r7.xyzx, v5.xyzx
  dp3 r2.z, r7.xyzx, v3.xyzx
  lt r2.w, l(0.000000), r2.z
  div r6.zw, -r8.xxxy, r2.zzzz
  and r2.zw, r2.wwww, r6.zzzw
  add r6.zw, v1.yyyz, l(0.000000, 0.000000, -0.500000, -0.500000)
  add r4.w, cb0[16].y, l(0.000010)
  mul r2.zw, r2.zzzw, r4.wwww
  mul r2.zw, r2.zzzw, cb0[14].zzzw
  mad r2.zw, r6.zzzw, cb0[14].zzzw, r2.zzzw
  mad r2.zw, cb0[15].xxxy, cb0[14].zzzw, r2.zzzw
  mad r4.w, cb0[13].z, cb1[69].w, l(1.000000)
  mul r4.w, r4.w, cb0[13].y
  mul r4.w, r4.w, l(0.01745329)
  sincos r7.x, r8.x, r4.w
  mov r8.y, r8.x
  mov r8.z, r7.x
  dp2 r9.x, r8.yzyy, r2.zwzz
  mov r8.x, -r7.x
  dp2 r9.y, r8.xyxx, r2.zwzz
  mul r2.zw, cb0[14].xxxy, cb1[69].wwww
  mad r2.zw, r2.zzzw, cb0[14].zzzw, r9.xxxy
  mul r4.w, cb0[16].x, cb1[69].w
  sincos null, r4.w, r4.w
  mad r4.w, r4.w, l(0.500000), l(0.500000)
  add r4.w, -r4.w, l(1.000000)
  add r6.z, -cb0[15].z, cb0[15].w
  mad r4.w, r4.w, r6.z, cb0[15].z
  div r2.zw, r2.zzzw, r4.wwww
  add r2.zw, r2.zzzw, l(0.000000, 0.000000, 0.500000, 0.500000)
  mov_sat r6.zw, r2.zzzw
  movc r6.xy, cb0[16].zwzz, r6.zwzz, r2.zwzz
endif 
dp3 r2.z, -v6.xyzx, -v6.xyzx
rsq r2.z, r2.z
mul r7.xyz, r2.zzzz, -v6.xyzx
dp3_sat r2.w, r7.xyzx, r4.xyzx
sample_indexable(texture2d)(float,float,float,float) r4.xyzw, r6.xyxx, t29.xyzw, s1
mul r4.xyz, r4.xyzx, cb0[20].xyzx
log r6.x, r2.w
mul r6.x, r6.x, cb0[19].y
exp r6.x, r6.x
add r2.w, -r2.w, l(1.000000)
log r2.w, r2.w
mul r2.w, r2.w, cb0[19].y
exp r2.w, r2.w
movc r2.w, cb0[21].x, r2.w, r6.x
eq r6.x, cb0[19].y, l(0.000000)
movc r2.w, r6.x, l(1.000000), r2.w
...
add r2.w, v2.y, v2.x
add r2.w, r2.w, v2.z
add r2.w, r2.w, cb0[17].y
frc r2.w, r2.w
mad r6.y, cb1[69].w, cb0[17].z, r2.w
mov r6.x, cb0[17].x
sample_l_indexable(texture2d)(float,float,float,float) r2.w, r6.xyxx, t26.yzwx, s7, l(0.000000)
log r2.w, |r2.w|
mul r2.w, r2.w, cb0[18].z
exp r2.w, r2.w
add r3.y, -cb0[18].x, cb0[18].y
mad r2.w, r2.w, r3.y, cb0[18].x
mul r4.xyz, r2.wwww, r4.xyzx
ine r2.w, cb1[92].x, l(0)
utof r6.xy, r3.wzww
dp2 r3.y, r6.yxyy, l(0.06711056, 0.00583715, 0.000000, 0.000000)
frc r3.y, r3.y
mul r3.xy, r3.xyxx, l(0.00781250, 52.982918, 0.000000, 0.000000)
frc r3.y, r3.y
mad r3.y, r3.y, l(6.28318548), cb1[70].w
sincos r8.x, r9.x, r3.y
dp2 r3.y, r6.xyxx, l(0.06711056, 0.00583715, 0.000000, 0.000000)
frc r3.y, r3.y
mul r3.y, r3.y, l(52.982918)
frc r3.y, r3.y
mad r3.y, r3.y, l(6.28318548), cb1[70].w
sincos r6.x, r10.x, r3.y
dp3_sat r2.x, r5.xyzx, r7.xyzx
dp3 r3.y, -r7.xyzx, r5.xyzx
add r3.y, r3.y, r3.y
mad r11.xyz, r5.xyzx, -r3.yyyy, -r7.xyzx
mul r3.y, r2.y, l(17.000000)
exp r3.y, r3.y
add r3.y, r3.y, l(2.000000)
div r3.y, l(2.000000), r3.y
sqrt r6.y, r3.y
add r6.z, -r2.y, l(1.000000)
    ...
    if_nz r14.x
      ...
      if_nz r13.w
        ...
        if_nz r14.x
          ...
          sqrt r13.w, r13.w
          mad r13.w, r6.z, l(5.000000), r13.w
          ...
          dp3 r33.x, r5.xyzx, r24.xyzx
          dp3 r33.y, r5.xyzx, r25.xyzx
      ...
      if_nz r17.w
        ...
        if_nz r17.z
          ...
          if_nz r17.z
            ...
            sqrt r16.w, r16.w
            mad r16.w, r6.z, l(5.000000), r16.w
...
if_nz r6.w
  ...
  if_nz r6.w
    ...
    if_nz r8.w
      ...
      mad r19.xyz, r5.xyzx, r9.wwww, v6.xyzx
    ...
    mad r16.xyz, r6.zzzz, r10.yzwy, r3.xzwx
    ...
    mov r15.w, r17.z
    mov r14.w, r13.z
    movc r14.xyzw, r5.wwww, r15.xyzw, r14.xyzw
    mov r17.zw, r16.xxxy
    mov r13.zw, r3.xxxz
    movc r15.xyzw, r5.wwww, r17.xyzw, r13.xyzw
    movc r3.w, r5.w, r16.z, r3.w
    mov r13.z, r14.w
    mov r13.xy, r15.xyxx
    mov r3.xz, r15.zzwz
  endif 
          ...
          if_nz r16.w
            ...
            if_nz r16.w
              ...
              if_nz r16.w
                ...
                mad r42.xyz, r5.xyzx, r16.wwww, v6.xyzx
              ...
              if_nz r16.w
                ...
                if_nz r12.w
                  ...
                  mad r19.xyz, r5.xyzx, r21.wwww, v6.xyzx
          ...
          if_nz r13.w
            ...
            if_nz r13.w
              ...
              if_nz r13.w
                ...
                mad r22.xyz, r5.xyzx, r13.wwww, v6.xyzx
              ...
              if_nz r13.w
                ...
                if_nz r16.w
                  ...
                  mad r23.xyz, r5.xyzx, r19.xxxx, v6.xyzx
                  ...
                  if_nz r16.w
                    ...
                    mad r19.x, |r11.w|, l(-0.200000), l(0.400000)
                    mad r24.xyz, r5.xyzx, r19.xxxx, v6.xyzx
                ...
                mad r20.xyz, r20.xyzx, r9.wwww, r7.xyzx
                dp3 r9.w, r20.xyzx, r20.xyzx
                rsq r9.w, r9.w
                mul r20.xyz, r9.wwww, r20.xyzx
                dp3 r9.w, r20.xyzx, r7.xyzx
                dp3 r14.w, r5.xyzx, r20.xyzx
...
ret 
// Approximately 2667 instruction slots used
