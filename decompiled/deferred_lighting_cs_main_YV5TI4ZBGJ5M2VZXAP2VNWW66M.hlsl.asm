...
if_nz r12.w
  imul null, r12.w, r0.x, l(14)
  add r13.yzw, r10.xxyz, -cb10[r12.w + 0].xxyz
  and r15.x, l(0x0000ffff), cb10[r12.w + 7].z
  ubfe r15.y, l(6), l(25), cb10[r12.w + 7].z
  imul null, r15.z, r15.x, l(6)
  dp3 r15.w, cb11[r15.z + 0].xyzx, r13.yzwy
  add_sat r15.w, r15.w, cb11[r15.z + 0].w
  dp3 r16.x, cb11[r15.z + 1].xyzx, r13.yzwy
  add_sat r16.x, r16.x, cb11[r15.z + 1].w
  mul r15.w, r15.w, r16.x
  dp3 r16.x, cb11[r15.z + 2].xyzx, r13.yzwy
  add_sat r16.x, r16.x, cb11[r15.z + 2].w
  mul r15.w, r15.w, r16.x
  dp3 r16.x, cb11[r15.z + 3].xyzx, r13.yzwy
  add_sat r16.x, r16.x, cb11[r15.z + 3].w
  mul r15.w, r15.w, r16.x
  dp3 r16.x, cb11[r15.z + 4].xyzx, r13.yzwy
  add_sat r16.x, r16.x, cb11[r15.z + 4].w
  mul r15.w, r15.w, r16.x
  dp3 r16.x, cb11[r15.z + 5].xyzx, r13.yzwy
  add_sat r15.z, r16.x, cb11[r15.z + 5].w
  mul r16.x, r15.z, r15.w
  and r15.z, l(1), cb10[r12.w + 6].x
  mov r16.yz, l(0,0,1.000000,0)
  movc r15.zw, r15.zzzz, r16.xxxy, r16.zzzx
  mov r16.x, l(1.000000)
  mov r16.z, cb10[r12.w + 6].x
  mov r17.xy, r15.zwzz
  mov r16.w, l(1)
  loop 
    ige r17.z, r16.w, r15.y
    breakc_nz r17.z
    iadd r17.z, r15.x, r16.w
    imul null, r17.z, r17.z, l(6)
    dp3 r17.w, cb11[r17.z + 0].xyzx, r13.yzwy
    add_sat r17.w, r17.w, cb11[r17.z + 0].w
    mul r17.w, r17.w, r17.x
    dp3 r18.x, cb11[r17.z + 1].xyzx, r13.yzwy
    add_sat r18.x, r18.x, cb11[r17.z + 1].w
    mul r17.w, r17.w, r18.x
    dp3 r18.x, cb11[r17.z + 2].xyzx, r13.yzwy
    add_sat r18.x, r18.x, cb11[r17.z + 2].w
    mul r17.w, r17.w, r18.x
    dp3 r18.x, cb11[r17.z + 3].xyzx, r13.yzwy
    add_sat r18.x, r18.x, cb11[r17.z + 3].w
    mul r17.w, r17.w, r18.x
    dp3 r18.x, cb11[r17.z + 4].xyzx, r13.yzwy
    add_sat r18.x, r18.x, cb11[r17.z + 4].w
    mul r17.w, r17.w, r18.x
    dp3 r18.x, cb11[r17.z + 5].xyzx, r13.yzwy
    add_sat r17.z, r18.x, cb11[r17.z + 5].w
    mul r17.x, r17.z, r17.w
    ushr r18.x, r16.z, l(2)
    ubfe r18.y, l(1), l(2), r16.z
    and r18.z, r18.x, l(2)
    max r18.w, r17.x, r17.y
    mad r17.z, -r17.w, r17.z, l(1.000000)
    mul r17.z, r17.z, r17.y
    movc r16.y, r18.z, r17.z, r18.w
    movc r17.xy, r18.yyyy, r17.xyxx, r16.xyxx
    iadd r16.w, r16.w, l(1)
    mov r16.z, r18.x
  endloop 
  mov_sat r17.y, r17.y
  mul r15.x, r17.y, cb10[r12.w + 6].y
  lt r15.y, l(0.000000), r15.x
  if_nz r15.y
    mul r15.y, r15.x, cb10[r12.w + 7].y
    mov r16.x, cb10[r12.w + 7].w
    mov r16.yz, cb10[r12.w + 8].xxyx
    ...
    mov r16.x, cb10[r12.w + 8].w
    mov r16.yz, cb10[r12.w + 9].xxyx
    dp3 r15.w, r14.xyzx, r16.xyzx
    dp3 r16.x, r13.yzwy, r16.xyzx
    add r16.x, r16.x, -cb10[r12.w + 9].z
    ge r16.y, r16.x, l(0.000000)
    max r16.x, r9.x, |r16.x|
    movc r16.x, r16.y, r16.x, -r16.x
    max r15.w, -r15.w, l(0.00000010)
    div r15.w, r16.x, r15.w
    min r15.z, |r15.w|, r15.z
    mov r16.x, cb10[r12.w + 9].w
    mov r16.yz, cb10[r12.w + 10].xxyx
    dp3 r15.w, r14.xyzx, r16.xyzx
    dp3 r16.x, r13.yzwy, r16.xyzx
    add r16.x, r16.x, -cb10[r12.w + 10].z
    ge r16.y, r16.x, l(0.000000)
    max r16.x, r9.x, |r16.x|
    movc r16.x, r16.y, r16.x, -r16.x
    max r15.w, -r15.w, l(0.00000010)
    div r15.w, r16.x, r15.w
    min r15.z, |r15.w|, r15.z
    mov r16.x, cb10[r12.w + 10].w
    mov r16.yz, cb10[r12.w + 11].xxyx
    dp3 r15.w, r14.xyzx, r16.xyzx
    dp3 r16.x, r13.yzwy, r16.xyzx
    add r16.x, r16.x, -cb10[r12.w + 11].z
    ge r16.y, r16.x, l(0.000000)
    max r16.x, r9.x, |r16.x|
    movc r16.x, r16.y, r16.x, -r16.x
    max r15.w, -r15.w, l(0.00000010)
    div r15.w, r16.x, r15.w
    min r15.z, |r15.w|, r15.z
    mov r16.x, cb10[r12.w + 11].w
    mov r16.yz, cb10[r12.w + 12].xxyx
    dp3 r15.w, r14.xyzx, r16.xyzx
    dp3 r16.x, r13.yzwy, r16.xyzx
    add r16.x, r16.x, -cb10[r12.w + 12].z
    ge r16.y, r16.x, l(0.000000)
    max r16.x, r9.x, |r16.x|
    movc r16.x, r16.y, r16.x, -r16.x
    max r15.w, -r15.w, l(0.00000010)
    div r15.w, r16.x, r15.w
    min r15.z, |r15.w|, r15.z
    mov r16.x, cb10[r12.w + 12].w
    mov r16.yz, cb10[r12.w + 13].xxyx
    dp3 r15.w, r14.xyzx, r16.xyzx
    dp3 r16.x, r13.yzwy, r16.xyzx
    add r16.x, r16.x, -cb10[r12.w + 13].z
    ge r16.y, r16.x, l(0.000000)
    max r16.x, r9.x, |r16.x|
    movc r16.x, r16.y, r16.x, -r16.x
    max r15.w, -r15.w, l(0.00000010)
    div r15.w, r16.x, r15.w
    min r15.z, |r15.w|, r15.z
    add r16.x, r13.y, cb10[r12.w + 3].w
    add r16.yz, r13.zzwz, cb10[r12.w + 4].xxyx
    ...
    sqrt r15.z, r15.z
    mad r15.z, r6.w, l(5.000000), r15.z
    add r15.z, r15.z, l(-0.844800)
    mov r17.x, cb10[r12.w + 0].w
    mov r17.y, cb10[r12.w + 1].z
    mov r17.z, cb10[r12.w + 2].y
    dp3 r18.x, r16.xyzx, r17.xyzx
    mov r19.xy, cb10[r12.w + 1].xwxx
    mov r19.z, cb10[r12.w + 2].z
    dp3 r18.y, r16.xyzx, r19.xyzx
    mov r20.x, cb10[r12.w + 1].y
    mov r20.yz, cb10[r12.w + 2].xxwx
    dp3 r18.z, r16.xyzx, r20.xyzx
    ubfe r15.w, l(9), l(16), cb10[r12.w + 7].z
    utof r18.w, r15.w
    sample_l_indexable(texturecubearray)(float,float,float,float) r16.xyz, r18.xyzw, t8.xyzw, s2, r15.z
    dp3 r21.x, r13.yzwy, r17.xyzx
    dp3 r21.y, r13.yzwy, r19.xyzx
    dp3 r21.z, r13.yzwy, r20.xyzx
    mad_sat r13.yzw, r21.xxyz, cb10[r12.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
    mul r21.xy, r13.yzyy, cb10[r12.w + 4].zwzz
    mul r21.z, r13.w, cb10[r12.w + 5].x
    add r13.yzw, r21.xxyz, cb10[r12.w + 5].yyzw
...
lt r12.w, r15.x, l(1.000000)
if_nz r12.w
  ult r9.w, r0.x, r9.w
  if_nz r9.w
    imul null, r0.x, r0.x, l(14)
    add r16.xyz, r10.xyzx, -cb10[r0.x + 0].xyzx
    ...
    loop 
      ...
      mov r16.w, r18.w
    endloop 
    add_sat r9.w, -r15.x, r19.y
    mul r12.w, r9.w, cb10[r0.x + 6].y
    lt r16.w, l(0.000000), r12.w
    if_nz r16.w
      mad r15.x, r9.w, cb10[r0.x + 6].y, r15.x
      mul r9.w, r12.w, cb10[r0.x + 7].y
      mov r17.x, cb10[r0.x + 7].w
      mov r17.yz, cb10[r0.x + 8].xxyx
      dp3 r12.w, r14.xyzx, r17.xyzx
      ...
      ubfe r9.x, l(9), l(16), cb10[r0.x + 7].z
      utof r19.w, r9.x
      sample_l_indexable(texturecubearray)(float,float,float,float) r17.xyz, r19.xyzw, t8.xyzw, s2, r6.w
      ...
      dp3 r9.x, r16.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r0.x, r9.y, r0.x, r9.x
      div r0.x, r6.w, r0.x
      mad r15.yzw, r16.xxyz, r0.xxxx, r15.yyzw
    endif 
  endif 
endif 
max r0.x, r15.x, l(1.000000)
rcp r0.x, r0.x
mov_sat r15.x, r15.x
mul r9.xyw, r0.xxxx, r13.yzyw
mul r15.yzw, r0.xxxx, r15.yyzw
lt r6.w, r15.x, l(0.990000)
if_nz r6.w
  add r6.w, -r15.x, l(1.000000)
  ...
  mad r9.xyw, r13.yzyw, r0.xxxx, r16.xyxz
  mov r14.w, l(0)
  ...
  mad r15.yzw, r13.yyzw, r0.xxxx, r15.yyzw
endif 
...
if_nz r2.y
  ...
  if_nz r2.y
    ...
    if_nz r4.z
      ...
      mad r17.xyz, r11.xyzx, r4.zzzz, r10.xyzx
      mov r18.xyz, cb9[r2.z + 4].yzwy
      mov r18.w, cb9[r2.z + 5].x
      mov r17.w, l(1.000000)
      dp4 r18.x, r18.xyzw, r17.xyzw
      mov r19.xyz, cb9[r2.z + 5].yzwy
      mov r19.w, cb9[r2.z + 6].x
      ...
      add r19.x, r18.x, cb9[r2.z + 9].w
      add r19.y, r18.y, cb9[r2.z + 10].x
      mul r18.xy, r19.xyxx, cb9[r2.z + 9].yzyy
      div r18.zw, cb9[r2.z + 3].yyyy, cb9[r2.z + 8].yyyw
      ...
      or r4.z, r18.w, r18.z
      if_z r4.z
        mov r19.xyz, cb9[r2.z + 6].yzwy
        mov r19.w, cb9[r2.z + 7].x
        dp4 r4.z, r19.xyzw, r17.xyzw
        mov_sat r18.xy, r18.xyxx
        mad r17.x, r18.x, cb9[r2.z + 8].y, cb9[r2.z + 8].z
        mad r17.y, r18.y, cb9[r2.z + 8].w, cb9[r2.z + 9].x
        ...
        if_nz cb2[58].y
          ...
          loop 
            ...
            mad r19.xy, r20.xyxx, cb9[r2.z + 3].yyyy, r17.xyxx
            sample_c_lz_indexable(texture2darray)(float,float,float,float) r12.w, r19.xyzx, t9.xxxx, s13, r4.z
    ...
    mad r18.xyz, r2.yyyy, r13.yzwy, r9.xywx
    add_sat r0.z, -r0.z, l(1.000000)
    mul r2.z, r0.z, r0.z
    mul r2.z, r2.z, r2.z
    mul r0.z, r0.z, r2.z
    mul r0.z, r0.z, r2.y
    mad r19.xyz, r0.zzzz, r13.zwyz, r15.xyzx
    mov r17.w, r19.z
    mov r16.w, r15.z
    movc r16.xyzw, r2.wwww, r17.xyzw, r16.xyzw
    mov r19.zw, r18.xxxy
    mov r15.zw, r9.xxxy
    movc r17.xyzw, r2.wwww, r19.xyzw, r15.xyzw
    movc r9.w, r2.w, r18.z, r9.w
    mov r15.z, r16.w
    mov r15.xy, r17.xyxx
    mov r9.xy, r17.zwzz
  endif 
...
switch r0.z
  ...
  mad r2.yzw, -r17.xxyz, l(0.000000, 0.500000, 0.500000, 0.500000), cb9[r0.y + 0].xxyz
  ...
  if_nz r11.w
    ...
    if_nz r11.w
      ...
      if_nz r11.w
        ...
        movc r2.yzw, r0.zzzz, r2.yyzw, cb9[r0.y + 0].xxyz
        add r2.yzw, -r10.xxyz, r2.yyzw
        dp3 r0.z, r2.yzwy, r2.yzwy
        rsq r0.z, r0.z
        mul r13.yzw, r0.zzzz, r2.yyzw
        ...
        mul r0.z, r0.z, r2.z
        mul r0.z, r0.z, r2.y
        mad r2.yzw, r0.zzzz, r14.xxyz, r15.zzxy
  ...
  if_nz r2.w
    ...
    if_nz r4.z
      ...
      add r18.xyz, -r10.xyzx, cb9[r0.y + 0].xyzx
      mul r5.w, cb9[r0.y + 3].x, cb9[r0.y + 3].x
      dp3 r6.w, r18.xyzx, r18.xyzx
      div r5.w, r5.w, r6.w
      min r5.w, r5.w, l(1.000000)
      mad_sat r18.xy, r2.wwww, cb9[r0.y + 2].xzxx, cb9[r0.y + 2].ywyy
      mul r18.zw, r18.xxxy, r18.xxxy
      mad r18.xy, r18.xyxx, l(-2.000000, -2.000000, 0.000000, 0.000000), l(3.000000, 3.000000, 0.000000, 0.000000)
      mul r18.xy, r18.xyxx, r18.zwzz
      mul r5.w, r5.w, r18.x
      ...
      lt r2.w, cb9[r0.y + 10].w, l(0.00048828)
      if_nz r2.w
        ...
        exp r19.xy, r19.xyxx
        mul r6.w, r19.x, cb9[r0.y + 12].x
        mad r7.w, cb9[r0.y + 12].y, r19.y, l(-1.000000)
        mad r6.w, cb9[r0.y + 12].y, r19.y, -r6.w
      ...
      mul r4.z, r2.w, r5.w
      and r2.w, l(255), cb9[r0.y + 14].w
      if_nz r2.w
        mov r18.z, l(1.000000)
        dp3 r5.w, cb9[r0.y + 13].xyzx, r18.xyzx
    ...
    if_nz r2.w
      ubfe r2.w, l(3), l(27), cb9[r0.y + 1].w
      ine r2.w, r2.w, l(1)
      if_nz r2.w
        ...
        if_nz r6.w
          ...
          mad r18.x, r17.x, cb9[r0.y + 8].y, cb9[r0.y + 8].z
          mad r18.y, r17.y, cb9[r0.y + 8].w, cb9[r0.y + 9].x
          div r2.w, r2.w, r5.w
          max r2.w, r2.w, l(0.00006104)
          and r5.w, l(0x0000ffff), cb9[r0.y + 1].w
          if_nz cb2[58].y
            mov r17.x, -r3.x
            utof r19.z, r5.w
            mov r17.y, r13.x
      ...
      if_nz r4.z
        mul r4.z, r0.w, cb9[r0.y + 1].z
        mul r4.z, r2.z, r4.z
        ubfe r5.w, l(4), l(16), cb9[r0.y + 1].w
        ult r6.w, l(0), r5.w
        and r6.w, r9.z, r6.w
        if_nz r6.w
          ...
          if_nz r5.w
            ...
            if_z r7.w
              ...
              mad r17.xy, r17.xyxx, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
              add r18.x, r17.x, cb9[r0.y + 9].w
              add r18.y, r17.y, cb9[r0.y + 10].x
              mul r17.xy, r18.xyxx, cb9[r0.y + 9].yzyy
              ...
              if_z r8.w
                ...
                mad r18.x, r17.x, cb9[r0.y + 8].y, cb9[r0.y + 8].z
                mad r18.y, r17.y, cb9[r0.y + 8].w, cb9[r0.y + 9].x
                mul r9.z, r6.w, cb9[r0.y + 10].z
                mad r5.w, cb9[r0.y + 10].y, r6.w, r5.w
                div r5.w, r5.w, r9.z
              endif 
            else 
              mov r8.w, l(-1)
            ...
            if_z r6.w
              max r5.w, r5.w, l(0.00006104)
              and r6.w, l(0x0000ffff), cb9[r0.y + 1].w
              if_nz cb2[58].y
                mov r17.x, -r3.x
                utof r19.z, r6.w
                mov r17.y, r13.x
        ...
        add r0.y, -r2.z, r0.y
        mad r0.y, r1.z, r0.y, r2.z
        mul r0.y, r2.w, r0.y
        lt r1.z, l(0.000000), r2.y
        mad r17.xyz, r0.yyyy, r13.yzwy, r16.xyzx
