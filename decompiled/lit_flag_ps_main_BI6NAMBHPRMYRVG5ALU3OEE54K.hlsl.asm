...
sample_indexable(texture2d)(float,float,float,float) r3.xyz, r3.xyxx, t30.xyzw, s6
...
mad r2.xy, r3.xyxx, cb0[13].zzzz, r1.yzyy
dp3 r1.y, r2.xyzx, r2.xyzx
rsq r1.y, r1.y
mul r2.xyz, r1.yyyy, r2.xyzx
mad r1.y, r2.w, cb0[13].z, r1.w
mul r3.xyzw, cb0[14].xyzw, cb1[69].wwww
mad r3.xyzw, v2.xyxy, cb0[15].xxxx, r3.xyzw
sample_indexable(texture2d)(float,float,float,float) r4.xyz, r3.xyxx, t37.xyzw, s6
mad r1.zw, r4.xxxy, l(0.000000, 0.000000, 1.99218750, 1.99218750), l(0.000000, 0.000000, -1.000000, -1.000000)
mul r2.w, r4.z, r4.z
mul r2.w, r2.w, l(0.33333334)
min r2.w, r2.w, l(1.000000)
sample_indexable(texture2d)(float,float,float,float) r3.xyz, r3.zwzz, t37.xyzw, s6
mad r3.xy, r3.xyxx, l(1.99218750, 1.99218750, 0.000000, 0.000000), l(-1.000000, -1.000000, 0.000000, 0.000000)
mul r3.z, r3.z, r3.z
mul r3.z, r3.z, l(0.33333334)
min r3.z, r3.z, l(1.000000)
mad r2.xy, r1.zwzz, cb0[15].yyyy, r2.xyxx
dp3 r1.z, r2.xyzx, r2.xyzx
rsq r1.z, r1.z
mul r2.xyz, r1.zzzz, r2.xyzx
mad r1.y, r2.w, cb0[15].y, r1.y
mad r2.xy, r3.xyxx, cb0[15].yyyy, r2.xyxx
dp3 r1.z, r2.xyzx, r2.xyzx
rsq r1.z, r1.z
mul r2.xyz, r1.zzzz, r2.xyzx
mad r1.y, r3.z, cb0[15].y, r1.y
...
if_nz r3.w
  ...
  loop 
    ...
    ieq r11.w, r1.z, r8.z
    ubfe r12.z, r1.w, l(0), r8.w
    movc r8.w, r11.w, r12.z, r8.w
    iadd r11.w, r8.z, cb2[0].x
...
max r1.z, r20.w, l(1.000000)
rcp r1.z, r1.z
mov_sat r20.w, r20.w
mul r8.yzw, r1.zzzz, r19.xxyz
...
if_nz r1.w
  ...
  mad r8.yzw, r19.xxyz, r1.zzzz, r12.xxyz
  mov r10.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r12.xyz, r10.xyzw, t8.xyzw, s2, r6.z
  mad r1.z, cb2[19].x, r1.w, -r2.w
  mad r1.z, r1.y, r1.z, r2.w
  mad r9.yzw, r12.xxyz, r1.zzzz, r9.yyzw
endif 
add r1.z, r0.w, r1.x
log r1.z, |r1.z|
mul r1.z, r1.z, r5.z
