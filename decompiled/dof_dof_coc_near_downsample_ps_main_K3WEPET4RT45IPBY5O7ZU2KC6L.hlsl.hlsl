  ...
  out float o0 : SV_TARGET0)
{
  ...
  r1.xyzw = r0.xyzw * float4(64,64,64,64) + float4(-63,-63,-63,-63);
  r1.xyzw = max(float4(9.99999994e-09,9.99999994e-09,9.99999994e-09,9.99999994e-09), r1.xyzw);
  r1.xyzw = postFxControl2.xxxx / r1.xyzw;
  r2.xyzw = max(float4(9.99999994e-09,9.99999994e-09,9.99999994e-09,9.99999994e-09), r0.xyzw);
  r0.xyzw = cmp(r0.xyzw >= float4(0.984375,0.984375,0.984375,0.984375));
  r2.xyzw = postFxControl2.yyyy / r2.xyzw;
  r0.xyzw = r0.xyzw ? r1.xyzw : r2.xyzw;
  r0.xyzw = rcp(r0.xyzw);
  r0.xyzw = r0.xyzw * postFxControl0.xxxx + postFxControl0.yyyy;
  r0.xyzw = saturate(r0.xyzw * postFxControl0.zzzz + postFxControl0.wwww);
