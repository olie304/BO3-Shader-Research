...
dcl_output o0.xyzw
dcl_temps 46
sample_indexable(texture2d)(float,float,float,float) r0.x, v1.yzyy, t21.xyzw, s1
add r0.y, -cb0[10].y, cb0[10].z
mad r0.x, r0.x, r0.y, cb0[10].y
mul_sat r0.x, r0.x, l(0.05882353)
sample_indexable(texture2d)(float,float,float,float) r1.xyz, v1.yzyy, t0.xyzw, s3
        ...
        if_nz r12.w
          ...
          if_nz r12.w
            ...
            if_nz r12.w
              ...
              mul r17.xyz, r9.xyzx, r14.xxxx
              mad r9.xyz, r16.xyzx, r12.wwww, r17.xyzx
              mov r15.z, r13.y
              mul r16.xyz, r14.xxxx, r15.xyzx
              mad r15.xyz, r25.xyzx, r12.wwww, r16.xyzx
              mul r14.w, r13.w, r14.x
              mad r13.z, r13.z, r14.x, r12.w
              mad r13.w, r11.w, r12.w, r14.w
              mov r13.y, r15.z
            endif 
          endif 
        endif 
      ...
      if_nz r12.w
        ...
        if_nz r11.w
          ...
          if_nz r11.w
            ...
            mov r23.w, r25.x
            dp4 r23.x, r6.xyzw, r23.xyzw
            mov r26.x, r20.y
            mov r26.y, r21.y
            mov r26.z, r22.y
            mov r26.w, r25.y
            dp4 r23.y, r6.xyzw, r26.xyzw
            mov r25.x, r20.z
            mov r25.y, r21.z
            mov r25.z, r22.z
            dp4 r23.z, r6.xyzw, r25.xyzw
            ...
            if_nz r11.w
              ...
              if_nz r28.x
                ...
                ushr r12.w, r21.w, l(28)
                ishl r12.w, l(1), r12.w
                ieq r13.w, r28.x, l(4)
                if_nz r13.w
                  and r13.w, r21.w, l(4095)
                  ubfe r14.w, l(12), l(12), r21.w
                  and r15.w, r22.w, l(1023)
              ...
              ne r12.w, r21.x, l(1.000000)
              add r13.w, r20.w, r11.w
              mad_sat r13.w, r13.w, r21.x, -r21.x
              movc r11.w, r12.w, r13.w, r11.w
              if_nz r28.y
                ubfe r12.w, l(4), l(24), r22.y
                ishl r12.w, l(1), r12.w
                ushr r13.w, r22.y, l(28)
                ...
                if_nz r14.w
                  ...
                  sample_d_indexable(texture2darray)(float,float,float,float) r14.w, r30.xyzx, t45.yzwx, s4, r28.xzwx, r29.xyzx
                else 
                  ieq r15.w, r28.y, l(4)
                  if_nz r15.w
                    ...
                    sample_d_indexable(texture2darray)(float,float,float,float) r14.w, r29.xyzx, t42.yzwx, s4, r30.xyzx, r28.xyzx
                  else 
                    and r15.w, r22.y, l(4095)
                    ubfe r21.xw, l(12, 0, 0, 10), l(12, 0, 0, 20), r22.yyyw
                    utof r28.xz, r12.wwww
                    ...
                    mul r28.xyz, r28.xyzx, r31.xyzx
                    sample_d_indexable(texture2darray)(float,float,float,float) r14.w, r29.xyzx, t43.yzwx, s4, r30.xyzx, r28.xyzx
                  endif 
                endif 
                mad r28.xyz, r14.wwww, l(0.960000, 0.960000, 0.960000, 0.000000), l(0.040000, 0.040000, 0.040000, 0.000000)
              ...
              if_nz r21.x
                ...
                if_nz r12.w
                  ...
                  ishl r12.w, l(1), r21.z
                  ushr r13.w, r22.z, l(28)
                  ishl r13.w, l(1), r13.w
                  and r14.w, r22.z, l(4095)
              ...
              if_nz r21.y
                ...
                if_nz r12.w
                  ...
                  ishl r12.w, l(1), r21.x
                  ushr r13.w, r22.x, l(28)
                  ishl r13.w, l(1), r13.w
                  and r14.w, r22.x, l(4095)
                  utof r22.xz, r12.wwww
                  utof r22.y, r13.w
                ...
                rsq r14.w, r14.w
                mul r21.xyz, r14.wwww, r26.xyzx
                dp3 r14.w, -r25.xyzx, -r25.xyzx
                rsq r14.w, r14.w
                mul r22.xyz, r14.wwww, -r25.xyzx
                ...
                mad r21.xyz, r23.xyzx, r12.wwww, r21.xyzx
              ...
              add r12.w, -r11.w, l(1.000000)
              mul r21.xyz, r12.wwww, r17.xyzx
              mad r17.xyz, r20.xyzx, r11.wwww, r21.xyzx
              mul r20.xyz, r12.wwww, r19.xyzx
              mad r19.xyz, r28.xyzx, r11.wwww, r20.xyzx
...
mad r3.xyz, cb0[11].yzwy, r1.zzzz, r5.xzwx
mad r0.z, r0.z, r1.z, r10.x
mad r1.xyw, r1.xyxw, r1.zzzz, r11.xyxz
dp3 r2.z, r1.xywx, r1.xywx
rsq r2.z, r2.z
mul r4.xyz, r1.xywx, r2.zzzz
mad r1.y, r0.x, r1.z, r10.y
mad r5.xyz, r1.zzzz, l(0.080000, 0.080000, 0.080000, 0.000000), r12.xyzx
dp3 r0.x, -v6.xyzx, -v6.xyzx
rsq r0.x, r0.x
mul r6.xyz, r0.xxxx, -v6.xyzx
...
dp3_sat r1.x, r4.xyzx, r6.xyzx
dp3 r1.w, -r6.xyzx, r4.xyzx
add r1.w, r1.w, r1.w
mad r11.xyz, r4.xyzx, -r1.wwww, -r6.xyzx
mul r1.w, r1.y, l(17.000000)
exp r1.w, r1.w
add r1.w, r1.w, l(2.000000)
div r1.w, l(2.000000), r1.w
sqrt r2.z, r1.w
add r7.zw, -r1.yyyx, l(0.000000, 0.000000, 1.000000, 1.000000)
    ...
    if_nz r15.w
      ...
      if_nz r9.w
        ...
        loop 
          ...
          movc r2.y, r18.z, r16.z, r18.w
          movc r29.xy, r17.wwww, r29.xyxx, r2.xyxx
          iadd r15.w, r15.w, l(1)
          mov r15.x, r17.z
        endloop 
        mov_sat r29.y, r29.y
        mul r2.y, r9.z, r29.y
        lt r15.x, l(0.000000), r2.y
        if_nz r15.x
...
if_z r0.w
      ...
      if_nz r12.w
        ...
        if_nz r10.w
          ...
          if_nz r12.w
            ...
            sqrt r10.w, r10.w
            mad r10.w, r7.z, l(5.000000), r10.w
  ...
  if_nz r2.x
    ...
    mov r11.w, l(0)
    sample_l_indexable(texturecubearray)(float,float,float,float) r9.yzw, r11.xyzw, t8.wxyz, s2, r2.w
    mad r0.w, cb2[19].x, r2.x, -r2.y
    mad r0.w, r1.y, r0.w, r2.y
...
mul r13.xyz, r0.yyyy, r19.xyzx
mad r2.xy, r1.xyxx, l(0.984375, 0.984375, 0.000000, 0.000000), l(0.00781250, 0.00781250, 0.000000, 0.000000)
...
if_z r4.w
  ...
  if_nz r6.w
    ...
    loop 
      ...
      mul r7.z, r10.y, cb2[r8.w + 20].z
      lt r8.w, r7.z, l(1.000000)
      if_nz r8.w
        break 
      endif 
  ...
  if_nz r8.w
    ...
    rcp r15.xz, r10.yyyy
    mov r15.y, -r15.z
    mad r10.yzw, r9.yyzy, r15.xxyz, r10.zzwz
  ...
  if_z r8.w
    if_z cb2[58].y
      ...
      itof r8.w, cb2[26].y
      add r15.z, r6.w, r8.w
      sample_c_lz_indexable(texture2darray)(float,float,float,float) r8.w, r15.xyzx, t13.xxxx, s13, r4.w
    ...
    if_nz cb2[58].y
      ...
      add r9.yz, r9.yyzy, -cb2[r6.w + 20].xxyx
      mul r9.yz, r9.yyzy, cb2[r6.w + 20].zzzz
      ...
      loop 
        ...
        movc r16.xy, r11.wwww, r9.yzyy, r10.yzyy
        ...
        utof r16.z, r11.w
        sample_c_lz_indexable(texture2darray)(float,float,float,float) r11.w, r16.xyzx, t13.xxxx, s13, r4.w
...
if_nz r4.w
  ...
  if_nz r4.w
    ...
    if_nz r7.z
      ...
      mad r8.w, |r1.y|, l(-0.200000), l(0.400000)
      mad r19.xyz, r4.xyzx, r8.wwww, v6.xyzx
      ...
      if_z r8.w
        ...
        if_nz cb2[58].y
          ...
          loop 
            ...
            mad r17.xy, r18.xyxx, r7.zzzz, r15.xyxx
          ...
          utof r15.z, r8.w
          sample_c_lz_indexable(texture2darray)(float,float,float,float) r10.y, r15.xyzx, t9.xxxx, s13, r6.w
        endif 
    ...
    add r6.w, -r3.w, r6.w
    mad r6.w, r2.z, r6.w, r3.w
    mul r6.w, r5.w, r6.w
    lt r1.y, l(0.000000), r1.y
    mad r15.xyz, r6.wwww, r9.yzwy, r13.xyzx
    mad r10.yzw, -v6.xxyz, r0.xxxx, cb2[17].xxyz
    dp3 r0.x, r10.yzwy, r10.yzwy
    rsq r0.x, r0.x
    mul r10.yzw, r0.xxxx, r10.yyzw
    dp3 r0.x, r10.yzwy, r6.xyzx
    dp3 r6.w, r4.xyzx, r10.yzwy
    mad r7.z, |r6.w|, r1.w, -|r6.w|
    mad r6.w, |r6.w|, r7.z, l(1.000000)
    mad r3.w, r3.w, r0.y, r0.w
    mul r6.w, r6.w, r6.w
    mul r3.w, r3.w, r6.w
    rcp r3.w, r3.w
    mul r3.w, r4.w, r3.w
    ...
    mad r10.yzw, r3.wwww, r9.yyzw, r2.xxyw
    add_sat r0.x, -r0.x, l(1.000000)
    log r0.x, r0.x
    mul r0.x, r0.x, l(3.400000)
    exp r0.x, r0.x
    mul r0.x, r0.x, r3.w
    mad r16.xyz, r0.xxxx, r9.zwyz, r14.xyzx
    mov r15.w, r16.z
    mov r13.w, r14.z
    movc r13.xyzw, r1.yyyy, r15.xyzw, r13.xyzw
    mov r16.zw, r10.yyyz
    mov r14.zw, r2.xxxy
    movc r15.xyzw, r1.yyyy, r16.xyzw, r14.xyzw
    movc r2.w, r1.y, r10.w, r2.w
    mov r14.z, r13.w
    mov r14.xy, r15.xyxx
    mov r2.xy, r15.zwzz
  endif 
...
loop 
          ...
          if_nz r16.w
            ...
            if_nz r16.w
              ...
              if_nz r16.w
                ...
                mad r41.xyz, r4.xyzx, r16.wwww, v6.xyzx
              ...
              if_nz r16.w
                ...
                if_nz r12.w
                  ...
                  mad r19.xyz, r4.xyzx, r21.wwww, v6.xyzx
            ...
            if_nz r13.w
                ...
                if_nz r16.w
                  ...
                  if_nz r5.w
                    ...
                    loop 
                      ...
                      sample_c_lz_indexable(texture2darray)(float,float,float,float) r19.x, r31.xyzx, t9.xxxx, s13, r7.z
                      mad r16.z, r19.x, l(0.125000), r16.z
                      iadd r16.w, r16.w, l(1)
                    endloop 
                  else 
                    utof r22.z, r13.w
                    sample_c_lz_indexable(texture2darray)(float,float,float,float) r16.z, r22.xyzx, t9.xxxx, s13, r7.z
                  endif 
                  mul r7.z, r16.z, r16.z
                  mul r7.z, r16.z, r7.z
                else 
                  mov r7.z, l(1.000000)
                endif 
              ...
              if_nz r13.w
                ...
                if_nz r16.w
                  ...
                  mad r23.xyz, r4.xyzx, r19.xxxx, v6.xyzx
                  ...
                  if_nz r16.w
                    ...
                    mad r19.x, |r11.w|, l(-0.200000), l(0.400000)
                    mad r24.xyz, r4.xyzx, r19.xxxx, v6.xyzx
                ...
                mad r20.xyz, r7.zzzz, r21.xywx, r30.xyzx
                add_sat r8.w, -r8.w, l(1.000000)
                log r8.w, r8.w
                mul r8.w, r8.w, l(3.400000)
                exp r8.w, r8.w
                mul r7.z, r7.z, r8.w
                mad r21.xyw, r7.zzzz, r21.xyxw, r17.xyxz
  ...
  iadd r3.w, r3.w, l(32)
endloop 
add r0.xyw, -r5.xyxz, l(1.000000, 1.000000, 0.000000, 1.000000)
mul r0.xyw, r0.xyxw, r28.xyxz
mad r0.xyw, r29.xyxz, r5.xyxz, r0.xyxw
mad r0.xyw, r9.yzyw, r3.xyxz, r0.xyxw
log r1.x, r7.w
...
if_nz r1.x
  ...
  mul r1.w, r1.w, r2.w
  mad r2.xyz, r2.xyzx, r0.zzzz, -r0.xywx
...
mov o0.w, r0.z
ret 
// Approximately 2880 instruction slots used
