...
if_nz r10.z
  ...
  mul r18.x, r14.w, r16.y
  and r14.w, l(1), cb10[r10.z + 6].x
  mov r18.yz, l(0,0,1.000000,0)
  movc r16.yz, r14.wwww, r18.xxyx, r18.zzxz
  mov r18.x, l(1.000000)
  mov r14.w, cb10[r10.z + 6].x
  mov r19.xy, r16.yzyy
  mov r16.w, l(1)
  loop 
    ige r18.z, r16.w, r13.w
    breakc_nz r18.z
    iadd r18.z, r10.w, r16.w
  ...
  if_nz r13.w
    ...
    min r14.w, r14.w, |r16.y|
    mov r18.x, cb10[r10.z + 9].w
    mov r18.yz, cb10[r10.z + 10].xxyx
    dp3 r16.y, r17.xyzx, r18.xyzx
    dp3 r16.z, r15.yzwy, r18.xyzx
    add r16.z, r16.z, -cb10[r10.z + 10].z
    ge r16.w, r16.z, l(0.000000)
    max r16.z, r8.w, |r16.z|
    movc r16.z, r16.w, r16.z, -r16.z
    max r16.y, -r16.y, l(0.00000010)
    div r16.y, r16.z, r16.y
    min r14.w, r14.w, |r16.y|
    mov r18.x, cb10[r10.z + 10].w
    mov r18.yz, cb10[r10.z + 11].xxyx
    dp3 r16.y, r17.xyzx, r18.xyzx
    dp3 r16.z, r15.yzwy, r18.xyzx
    add r16.z, r16.z, -cb10[r10.z + 11].z
    ge r16.w, r16.z, l(0.000000)
    max r16.z, r8.w, |r16.z|
    movc r16.z, r16.w, r16.z, -r16.z
    max r16.y, -r16.y, l(0.00000010)
    div r16.y, r16.z, r16.y
    min r14.w, r14.w, |r16.y|
    mov r18.x, cb10[r10.z + 11].w
    mov r18.yz, cb10[r10.z + 12].xxyx
    dp3 r16.y, r17.xyzx, r18.xyzx
    dp3 r16.z, r15.yzwy, r18.xyzx
    add r16.z, r16.z, -cb10[r10.z + 12].z
    ge r16.w, r16.z, l(0.000000)
    max r16.z, r8.w, |r16.z|
    movc r16.z, r16.w, r16.z, -r16.z
    max r16.y, -r16.y, l(0.00000010)
    div r16.y, r16.z, r16.y
    min r14.w, r14.w, |r16.y|
    mov r18.x, cb10[r10.z + 12].w
    mov r18.yz, cb10[r10.z + 13].xxyx
    dp3 r16.y, r17.xyzx, r18.xyzx
    dp3 r16.z, r15.yzwy, r18.xyzx
    add r16.z, r16.z, -cb10[r10.z + 13].z
    ge r16.w, r16.z, l(0.000000)
    max r16.z, r8.w, |r16.z|
    movc r16.z, r16.w, r16.z, -r16.z
    max r16.y, -r16.y, l(0.00000010)
    div r16.y, r16.z, r16.y
    min r14.w, r14.w, |r16.y|
    add r18.x, r15.y, cb10[r10.z + 3].w
    add r18.yz, r15.zzwz, cb10[r10.z + 4].xxyx
    mad r16.yzw, r17.xxyz, r14.wwww, r18.xxyz
    dp3 r18.x, r16.yzwy, r16.yzwy
    sqrt r18.x, r18.x
    ...
    mov r18.x, cb10[r10.z + 0].w
    mov r18.y, cb10[r10.z + 1].z
    mov r18.z, cb10[r10.z + 2].y
    dp3 r19.x, r16.yzwy, r18.xyzx
    mov r20.xy, cb10[r10.z + 1].xwxx
    mov r20.z, cb10[r10.z + 2].z
    dp3 r19.y, r16.yzwy, r20.xyzx
    mov r21.x, cb10[r10.z + 1].y
    mov r21.yz, cb10[r10.z + 2].xxwx
    dp3 r19.z, r16.yzwy, r21.xyzx
    ubfe r16.y, l(9), l(16), cb10[r10.z + 7].z
    utof r19.w, r16.y
    sample_l_indexable(texturecubearray)(float,float,float,float) r16.yzw, r19.xyzw, t8.wxyz, s2, r14.w
    dp3 r22.x, r15.yzwy, r18.xyzx
    dp3 r22.y, r15.yzwy, r20.xyzx
    dp3 r22.z, r15.yzwy, r21.xyzx
    mad_sat r15.yzw, r22.xxyz, cb10[r10.z + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
    mul r22.xy, r15.yzyy, cb10[r10.z + 4].zwzz
    mul r22.z, r15.w, cb10[r10.z + 5].x
    add r15.yzw, r22.xxyz, cb10[r10.z + 5].yyzw
    ...
    dp3 r10.z, r15.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
    mul r14.w, r9.w, r10.z
    mul r16.yzw, r13.wwww, r16.yyzw
    dp3 r13.w, r16.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
    mad r10.z, r9.w, r10.z, r13.w
    div r10.z, r14.w, r10.z
    mul r16.yzw, r10.zzzz, r16.yyzw
  else 
...
if_nz r10.z
  ...
  if_nz r10.y
    ...
    loop 
      ...
      ushr r19.w, r13.w, l(2)
      ubfe r20.z, l(1), l(2), r13.w
      and r20.w, r19.w, l(2)
...
if_nz r4.w
  ...
  mul r19.x, r10.y, cb2[35].w
  mul r19.yz, r10.zzwz, cb2[36].xxyx
  add_sat r10.yzw, r19.xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
  mul r19.xy, r10.yzyy, cb2[36].zwzz
  mul r19.z, r10.w, cb2[37].x
  add r10.yzw, r19.xxyz, cb2[37].yyzw
  lt r19.xyz, l(0.000000, 0.000000, 0.000000, 0.000000), r12.xyzx
  movc r19.xyz, r19.xyzx, l(0,0,0,0), l(0.500000,0.500000,0.500000,0)
  mov r19.w, l(0)
  add r20.xyz, r10.yzwy, r19.wwxw
  sample_l_indexable(texture3d)(float,float,float,float) r20.xyz, r20.xyzx, t17.xyzw, s4, l(0.000000)
  mul r21.xyz, r12.xyzx, r12.xyzx
  mul r21.xyz, r8.wwww, r21.xyzx
  add r22.xyz, r10.yzwy, r19.wwyw
  ...
  mad r18.xyz, r15.yzwy, r0.yyyy, r10.yzwy
  mov r17.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r10.yzw, r17.xyzw, t8.wxyz, s2, r7.w
  mad r0.y, cb2[19].x, r4.w, -r8.w
  mad r0.y, r2.y, r0.y, r8.w
  mad r16.yzw, r10.yyzw, r0.yyyy, r16.yyzw
endif 
...
ret 
// Approximately 1829 instruction slots used
