// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:39:30 2021
...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  if (useAlphaControls != 0) {
    ...
    r3.x = dot(r3.xyz, v2.xyz);
    r3.x = r3.x * r3.x;
    r3.x = saturate(r3.x * v6.x + v6.y);
    r3.x = r3.x * r0.w;
    r4.xy = (int2)v0.xy;
    r4.zw = float2(0,0);
    r3.y = floatZSampler.Load(r4.xyz).x;
    r3.z = cmp(r3.y >= 0.984375);
    r3.w = 1.01587307 * r3.y;
    r3.y = r3.y * 64 + -63;
    r3.y = r3.z ? r3.y : r3.w;
    ...
    r3.yz = rcp(r3.yz);
    r3.w = cmp(zFeatherDistance == 0.000000);
    r4.x = 1 / zFeatherDistance;
    r3.w = r3.w ? 60000 : r4.x;
    r3.y = r3.y + -r3.z;
  ...
  r9.yzw = r19.xyz * r0.www;
  r12.xyz = r20.xyz * r0.www;
  ...
  if (r3.x != 0) {
    ...
    r0.w = r6.y * r0.w + r2.w;
    r12.xyz = r13.xyz * r0.www + r12.xyz;
  }
  r0.w = r6.x + r1.x;
  r0.w = log2(abs(r0.w));
  r0.w = r5.y * r0.w;
  ...
  r6.yzw = r12.xyz * r0.www;
  r9.yzw = r6.yzw * r3.xxx;
  r12.xyz = r6.yzw * r3.yyy;
  r0.w = sqrt(r5.y);
  r0.w = r0.w * 0.5 + 0.5;
  r0.w = r0.w * r0.w;
  r1.x = 0.5 * r0.w;
  ...
  if (r3.x == 0) {
    r6.yzw = sunConstants.sstLightingConstants.offToPinTransform._m10_m11_m12 * v5.yyy;
    r6.yzw = v5.xxx * sunConstants.sstLightingConstants.offToPinTransform._m00_m01_m02 + r6.yzw;
    r6.yzw = v5.zzz * sunConstants.sstLightingConstants.offToPinTransform._m20_m21_m22 + r6.yzw;
    r6.yzw = sunConstants.sstLightingConstants.offToPinTransform._m30_m31_m32 + r6.yzw;
    r3.x = -sunConstants.splitDepthOffset + r6.w;
    ...
    if (r5.z != 0) {
      ...
      while (true) {
        ...
        if (r7.z != 0) break;
        r7.z = (uint)r5.z;
        r14.xy = -sunConstants.splitPinTransform[r7.z].xy + r6.yz;
        r7.w = max(abs(r14.x), abs(r14.y));
        r5.w = sunConstants.splitPinTransform[r7.z].z * r7.w;
        r7.z = cmp(r5.w < 1);
        if (r7.z != 0) {
          break;
        }
    ...
    if (r7.z != 0) {
      ...
      r15.xz = rcp(r14.xx);
      r15.y = -r15.z;
      r14.xyz = r6.yzy * r15.xyz + r14.yzy;
    ...
    r8.w = samp0[]..swiz;
      ...
      r8.w = samp0[]..swiz;
        r8.w = r16.y ? r15.z : r8.w;
        r10.w = (uint)r8.w >> 13;
        r8.w = r16.x ? r10.w : r8.w;
        r8.w = (int)r8.w & 8191;
      ...
      r17.w = samp0[]..swiz;
        r16.xyz = r8.www ? r16.xyz : r17.xzw;
        ...
        if (r7.w == 0) {
          ...
          bitmask.w = ((~(-1 << 1)) << 1) & 0xffffffff;  r8.w = (((uint)r16.y << 1) & bitmask.w) | ((uint)0 & ~bitmask.w);
          bitmask.w = ((~(-1 << 1)) << 0) & 0xffffffff;  r8.w = (((uint)r16.x << 0) & bitmask.w) | ((uint)r8.w & ~bitmask.w);
          r8.w = (int)r8.w * 10;
        ...
        r18.y = samp0[]..swiz;
          r15.yw = r8.ww ? r17.xz : r18.xy;
          r15.xz = r7.ww ? r16.xw : r15.yw;
        }
        r7.w = (int)r15.z & 0xc0000000;
        if (r7.w == 0) {
          if (14 == 0) r8.w = 0; else if (14+15 < 32) {           r8.w = (uint)r15.z << (32-(14 + 15)); r8.w = (uint)r8.w >> (32-14);          } else r8.w = (uint)r15.z >> 15;
          r8.w = (uint)r8.w;
        ...
        r14.w = samp0[]..swiz;
          ...
          r14.x = (uint)r14.x;
          r14.x = r14.x * r10.w;
          r14.x = r14.x * 0.00392156886 + r8.w;
          r14.y = (int)r16.y + 1;
        ...
        r14.y = samp0[]..swiz;
          ...
          r11.w = r15.w ? r14.x : r8.w;
        } else {
          r8.w = (int)r15.z & 0x80000000;
          r10.w = (int)r15.x + 1;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r10.w, r10.w, l(0), t23.xxxx
        r10.w = samp0[]..swiz;
          ...
          r8.w = f16tof32(r8.w);
          r10.w = r6.y * r14.x + r10.w;
          r8.w = r6.z * r8.w + r10.w;
    ...
    if (r7.z == 0) {
      if (enableDitheredShadow == 0) {
        ...
        r14.xy = r7.zw * float2(0.5,-0.5) + float2(0.5,0.5);
        r6.w = (int16)sunConstants.splitArrayOffset;
        r14.z = r6.w + r5.z;
        r6.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r14.xyz, r3.x).x;
        r7.z = gTransShadowmapArray.SampleLevel(samp0_s, r14.xyz, 0).x;
        r6.w = r7.z + r6.w;
      ...
      if (enableDitheredShadow != 0) {
        ...
        r6.yz = -sunConstants.splitPinTransform[r5.z].xy + r6.yz;
        r6.yz = sunConstants.splitPinTransform[r5.z].zz * r6.yz;
        ...
        while (true) {
          ...
          if (r11.w != 0) break;
          r11.w = cmp((uint)r5.w < (uint)r10.w);
          r15.xy = r11.ww ? r6.yz : r7.zw;
          r14.w = r11.w ? sunConstants.splitPinTransform[r5.z].w : sunConstants.splitPinTransform[r6.w].w;
          r11.w = r11.w ? r5.z : r6.w;
          ...
          r15.z = (uint)r11.w;
          r11.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r15.xyz, r3.x).x;
  ...
  if (r3.x != 0) {
    r3.x = cmp(0 < r3.y);
    if (r3.x != 0) {
      r3.x = sunConstants.specScale * r4.w;
      r3.x = 0.25 * r3.x;
      if (sunConstants.sunCookieIndex != 0) {
        r14.xyz = eyeOffset.xyz + v5.xyz;
        r14.w = 1;
        r5.z = dot(sunConstants.sunCookieTransform[0].xyzw, r14.xyzw);
        r5.w = dot(sunConstants.sunCookieTransform[1].xyzw, r14.xyzw);
        r14.xy = frac(r5.zw);
        r5.z = -1 + (int14)sunConstants.sunCookieIndex;
        r14.z = (uint)r5.z;
        r6.yzw = gCookieArray.SampleLevel(samplerLinear_s, r14.xyz, 0).xyz;
      ...
      r17.w = samp0[]..swiz;
        ...
        r7.w = cmp(r2.w < 0);
        r7.z = r7.w ? -r7.z : r7.z;
        r18.xyz = r2.xyz * r7.zzz + v5.xyz;
        r18.w = 1;
        r14.x = dot(r14.xyzw, r18.xyzw);
        r14.y = dot(r15.xyzw, r18.xyzw);
        r7.zw = r14.xy * float2(0.5,-0.5) + float2(0.5,0.5);
        r7.zw = r7.zw + r17.zw;
        r7.zw = r7.zw * r17.xy;
        r14.xy = r5.ww / r16.xz;
        r14.zw = float2(1,1) + -r14.xy;
        r14.zw = cmp(r7.zw >= r14.zw);
        r14.xy = cmp(r14.xy >= r7.zw);
        ...
        r15.x = samp0[]..swiz;
        r15.y = samp0[]..swiz;
          r5.z = dot(r14.xyzw, r18.xyzw);
          r7.zw = saturate(r7.zw);
          r14.xy = r7.zw * r16.xz + r16.yw;
          r5.z = r5.z + r15.x;
          r5.z = r5.z / r15.y;
          ...
          if (enableDitheredShadow != 0) {
            ...
            while (true) {
              ...
              r10.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r5.z).x;
              r7.w = r10.w * 0.125 + r7.w;
              r8.w = (int)r8.w + 1;
            }
          } else {
            r14.z = (uint)r7.z;
            r7.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r14.xyz, r5.z).x;
          }
          r5.z = r7.w * r7.w;
          r5.z = r5.z * r7.w;
        } else {
      ...
      r5.z = -r6.x * 0.5 + 1;
      r5.z = -abs(r2.w) * r5.z + 1;
      r5.z = r5.z * r5.z;
      r5.z = -r5.z * 0.620000005 + 0.620000005;
      r5.z = r5.z + -abs(r2.w);
      r5.z = r5.y * r5.z + abs(r2.w);
      r5.z = r5.z * r3.y;
      r5.w = cmp(0 < r2.w);
      r14.xyz = r5.zzz * r6.zwy + r13.xyz;
      r2.w = saturate(r2.w);
      ...
      r5.z = dot(r2.xyz, r15.xyz);
      r7.z = abs(r5.z) * r4.w + -abs(r5.z);
      r5.z = abs(r5.z) * r7.z + 1;
      r7.z = r2.w * r0.w + r1.x;
      r5.z = r5.z * r5.z;
      r5.z = r5.z * r7.z;
      r5.z = rcp(r5.z);
      ...
      r2.w = r5.z * r2.w;
      r2.w = r2.w * r3.y;
      r15.yzw = r2.www * r6.yzw + r12.xyz;
      r3.x = saturate(1 + -r3.z);
      r3.y = r3.x * r3.x;
      r3.y = r3.y * r3.y;
      r3.x = r3.x * r3.y;
      r2.w = r3.x * r2.w;
      r3.xyz = r2.www * r6.yzw + r9.yzw;
      r14.w = r13.z;
      r13.w = r14.z;
      r16.xyzw = r5.wwww ? r14.zxyw : r13.zxyw;
      r13.zw = r3.xy;
      r14.zw = r9.yz;
      r14.xyzw = r5.wwww ? r13.xyzw : r14.xyzw;
      r15.x = r3.z;
      r12.w = r9.w;
      r12.xyzw = r5.wwww ? r15.yzwx : r12.xyzw;
      r13.z = r16.w;
      r13.xy = r14.xy;
      r9.yz = r14.zw;
      r9.w = r12.w;
  ...
  while (true) {
    ...
    r5.z = visibleLights.Load(r15.xyzw).x;
    r15.xyz = r27.xyz;
    r31.xyz = r28.xyz;
    r32.xyz = r29.xyz;
    r33.xyz = r30.xyz;
    ...
    while (true) {
      ...
      r35.y = samp0[]..swiz;
        ...
        r40.z = samp0[]..swiz;
        r40.w = samp0[]..swiz;
          if (3 == 0) r7.z = 0; else if (3+24 < 32) {           r7.z = (uint)r35.w << (32-(3 + 24)); r7.z = (uint)r7.z >> (32-3);          } else r7.z = (uint)r35.w >> 24;
          switch (r7.z) {
            case 4 :            r7.z = cmp(0 < r40.x);
            r41.xy = r39.zw;
            r41.z = r40.w;
            r42.xyz = -r41.xyz * float3(0.5,0.5,0.5) + r34.yzw;
            r43.xyz = -v5.xyz + r42.xyz;
            r7.w = dot(r41.xyz, r43.xyz);
            r8.w = saturate(-r7.w / r40.x);
            r44.xyz = r8.www * r41.xyz + r42.xyz;
            r44.xyz = r7.zzz ? r44.xyz : r34.yzw;
            r44.xyz = -v5.xyz + r44.xyz;
            r10.w = dot(r44.xyz, r44.xyz);
            r11.w = rsqrt(r10.w);
            r44.xyz = r44.xyz * r11.www;
            r11.w = dot(r2.xyz, r44.xyz);
            ...
            if (r12.w != 0) {
              ...
              r10.w = r13.w / r10.w;
              r10.w = min(1, r10.w);
              r44.xy = saturate(r12.ww * r36.xz + r36.yw);
              ...
              if (r12.w != 0) {
                ...
                if (r12.w != 0) {
                  ...
                  r44.xyz = r2.xyz * r12.www + v5.xyz;
                  r44.xyz = r44.xyz + -r38.xyz;
                  r12.w = max(abs(r44.y), abs(r44.z));
                  r12.w = max(abs(r44.x), r12.w);
                  r12.w = r39.x / r12.w;
                  r12.w = r12.w + r39.y;
                  r13.w = dot(r44.xyz, r44.xyz);
                  r13.w = rsqrt(r13.w);
                  r12.w = max(6.10351563e-05, r12.w);
                  r16.w = (int)r35.w & 0x0000ffff;
                  r45.w = (uint)r16.w;
                  r16.w = 0;
                  r20.w = 0;
                  while (true) {
                    r24.w = cmp((int)r20.w >= 8);
                    if (r24.w != 0) break;
                    r46.y = dot(icb[r20.w+0].yx, r14.xy);
                    r46.z = dot(icb[r20.w+0].yx, r14.yz);
                    r46.yz = r46.yz * r37.yy;
                    r46.x = r46.y * r9.x;
                    r46.w = r46.y * r5.x;
                    r45.xyz = r44.xyz * r13.www + r46.xzw;
                    r24.w = gOmniShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r45.xyzw, r12.w).x;
                    r16.w = r24.w * 0.125 + r16.w;
                    r20.w = (int)r20.w + 1;
                  }
                } else {
                  r16.w = 1;
                ...
                if (r12.w != 0) {
                  r12.w = r35.x * r4.w;
                  r12.w = 0.25 * r12.w;
                  r13.w = dot(r41.xyz, r10.xyz);
                  r20.w = dot(r10.xyz, r43.xyz);
                  r24.w = -r13.w * r13.w + r40.x;
                  r7.w = r13.w * r20.w + -r7.w;
                  r7.w = saturate(r7.w / r24.w);
                  r13.w = r24.w / r40.x;
                  r13.w = 10 * r13.w;
                  r13.w = min(1, r13.w);
                  r7.w = r7.w + -r8.w;
                  ...
                  r41.xyz = r7.zzz ? r41.xyz : r34.yzw;
                  r41.xyz = -v5.xyz + r41.xyz;
                  r7.z = dot(r41.xyz, r41.xyz);
                  r7.z = rsqrt(r7.z);
                  r42.xyz = r41.xyz * r7.zzz;
                  ...
                  r44.w = samp0[]..swiz;
                    ...
                    r18.xyz = r2.xyz * r13.www + v5.xyz;
                    r13.w = dot(r43.xyzw, r18.xyzw);
                    r20.w = dot(r44.xyzw, r18.xyzw);
                    r24.w = cmp(r20.w < r13.w);
                    if (r24.w == 0) {
                    // Known bad code for instruction (needs manual fix):
                    ...
                    r47.x = samp0[]..swiz;
                    r47.y = samp0[]..swiz;
                      r43.x = dot(r43.xyzw, r18.xyzw);
                      r43.y = dot(r44.xyzw, r18.xyzw);
                      r18.xy = r43.xy / r20.ww;
                      r18.xy = r18.xy * float2(0.5,-0.5) + float2(0.5,0.5);
                      r18.xy = r18.xy + r46.zw;
                      r18.xy = r18.xy * r46.xy;
                      r43.xy = r8.ww / r45.xz;
                      r43.zw = float2(1,1) + -r43.xy;
                      r43.zw = cmp(r18.xy >= r43.zw);
                      r43.xy = cmp(r43.xy >= r18.xy);
                      r43.xy = (int2)r43.xy | (int2)r43.zw;
                      r18.z = (int)r43.y | (int)r43.x;
                      r18.xy = saturate(r18.xy);
                      r43.xy = r18.xy * r45.xz + r45.yw;
                      r18.x = r47.y * r20.w;
                      r13.w = r47.x * r20.w + r13.w;
                      r13.w = r13.w / r18.x;
                    } else {
                      r18.z = -1;
                    }
                    r18.x = (int)r24.w | (int)r18.z;
                    if (r18.x == 0) {
                    // Known bad code for instruction (needs manual fix):
                    ...
                    r7.w = samp0[]..swiz;
                      ...
                      if (r5.w != 0) {
                        ...
                        while (true) {
                          ...
                          if (r25.w != 0) break;
                          r44.x = dot(icb[r24.w+0].yx, r14.xw);
                          r44.y = dot(icb[r24.w+0].xy, r7.xy);
                          r18.xy = r44.xy * r8.ww + r43.xy;
                          r18.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r18.xyz, r13.w).x;
                          r20.w = r18.x * 0.125 + r20.w;
                          r24.w = (int)r24.w + 1;
                        }
                      } else {
                        r43.z = (uint)r7.w;
                        r20.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r43.xyz, r13.w).x;
                      }
                      r7.w = r20.w * r20.w;
                      r7.w = r7.w * r20.w;
                    } else {
                    ...
                    r44.w = samp0[]..swiz;
                      r13.w = abs(r11.w) * -0.200000003 + 0.400000006;
                      r18.x = cmp(r11.w < 0);
                      r13.w = r18.x ? -r13.w : r13.w;
                      r19.xyz = r2.xyz * r13.www + v5.xyz;
                      r13.w = dot(r43.xyzw, r19.xyzw);
                      r18.x = dot(r44.xyzw, r19.xyzw);
                      r18.y = cmp(r18.x < r13.w);
                      if (r18.y == 0) {
                      // Known bad code for instruction (needs manual fix):
                                            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r43.xyzw, r7.w, l(68), t12.xyzw
                      r43.x = samp0[]..swiz;
                      ...
                      r47.y = samp0[]..swiz;
                        ...
                        r19.xy = r19.xy * r45.xz + r45.yw;
                        r24.w = r47.y * r18.x;
                        r13.w = r47.x * r18.x + r13.w;
                        r13.w = r13.w / r24.w;
                      } else {
                        r18.z = -1;
                      }
                      ...
                      r7.w = samp0[]..swiz;
                        ...
                        if (r5.w != 0) {
                          ...
                          while (true) {
                            ...
                            if (r26.w != 0) break;
                            r43.x = dot(icb[r25.w+0].xy, r8.xy);
                            r43.y = dot(icb[r25.w+0].yx, r8.xz);
                            r18.xy = r43.xy * r8.ww + r19.xy;
                            r18.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r18.xyz, r13.w).x;
                          ...
                          r19.z = (uint)r7.w;
                          r24.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r19.xyz, r13.w).x;
                        }
                        r7.w = r24.w * r24.w;
                        r7.w = r7.w * r24.w;
                      } else {
                  ...
                  r7.w = -abs(r11.w) * r3.x + 1;
                  r7.w = r7.w * r7.w;
                  r7.w = -r7.w * 0.620000005 + 0.620000005;
                  r7.w = r7.w + -abs(r11.w);
                  r7.w = r5.y * r7.w + abs(r11.w);
                  r7.w = r7.w * r10.w;
                  r35.x = r34.x;
                  r8.w = cmp(0 < r11.w);
                  r18.xyz = r7.www * r35.xyz + r15.xyz;
                  r11.w = saturate(dot(r2.xyz, r42.xyz));
                  r19.xyz = r41.xyz * r7.zzz + r4.xyz;
                  r7.z = dot(r19.xyz, r19.xyz);
                  r7.z = rsqrt(r7.z);
                  r19.xyz = r19.xyz * r7.zzz;
                  r7.z = dot(r19.xyz, r4.xyz);
                  r13.w = dot(r2.xyz, r19.xyz);
                  r19.x = abs(r13.w) * r4.w + -abs(r13.w);
                  r13.w = abs(r13.w) * r19.x + 1;
                  r19.x = r11.w * r0.w + r1.x;
                  r13.w = r13.w * r13.w;
                  r13.w = r13.w * r19.x;
                  r13.w = rcp(r13.w);
                  r11.w = r11.w * r12.w;
                  r11.w = r13.w * r11.w;
                  r10.w = r11.w * r10.w;
                  r19.xyz = r10.www * r35.xyz + r33.xyz;
                  r7.z = saturate(1 + -r7.z);
                  r11.w = r7.z * r7.z;
                  r11.w = r11.w * r11.w;
                  r7.z = r11.w * r7.z;
                  r7.z = r10.w * r7.z;
                  r41.xyz = r7.zzz * r35.xyz + r32.xyz;
                  r42.xyz = r7.www * r35.xyz + r31.xyz;
                  r15.xyz = r8.www ? r18.xyz : r15.xyz;
                  r31.xyz = r8.www ? r31.xyz : r42.xyz;
                  r32.xyz = r8.www ? r41.xyz : r32.xyz;
                  r33.xyz = r8.www ? r19.xyz : r33.xyz;
                }
              }
            }
            break;
            case 2 :            r18.xy = r37.zw;
            r18.z = r38.w;
            r18.xyz = -v5.xyz + r18.xyz;
            r7.z = dot(r18.xyz, r18.xyz);
            r7.z = rsqrt(r7.z);
            r19.xyz = r18.xyz * r7.zzz;
            r7.w = dot(r2.xyz, r19.xyz);
            r8.w = cmp(0 < abs(r7.w));
            if (r8.w != 0) {
            // Known bad code for instruction (needs manual fix):
            ...
            r42.w = samp0[]..swiz;
              ...
              r11.w = samp0[]..swiz;
                ...
                r12.w = r37.x * r37.x;
                r13.w = dot(r47.xyz, r47.xyz);
                r12.w = r12.w / r13.w;
                r12.w = min(1, r12.w);
                r36.xy = saturate(r8.ww * r36.xz + r36.yw);
                ...
                r12.w = r12.w * r36.y;
                r38.w = r39.x;
                r36.x = dot(r38.xyzw, r17.xyzw);
                r47.xyz = r39.yzw;
                r47.w = r40.w;
                r36.y = dot(r47.xyzw, r17.xyzw);
                r20.xy = r36.xy / r8.ww;
                r8.w = cmp(r44.w < 0.00048828125);
                if (r8.w != 0) {
                  r45.y = r46.x;
                  r36.xy = saturate(abs(r20.xy) * r45.zw + r45.xy);
                  r36.zw = r36.xy * r36.xy;
                  r36.xy = r36.xy * float2(-2,-2) + float2(3,3);
                  r36.xy = r36.zw * r36.xy;
                  r8.w = r36.x * r36.y;
                  ...
                  r44.w = r45.y;
                  r36.xyzw = saturate(r44.xyzw * abs(r20.yyxx));
                  ...
                  r13.w = r45.z * r36.x;
                  r25.w = r45.w * r36.y + -1;
                  r13.w = r45.w * r36.y + -r13.w;
                  r13.w = saturate(r25.w / r13.w);
                  r25.w = r13.w * r13.w;
                  r13.w = r13.w * -2 + 3;
                  r8.w = r25.w * r13.w;
                }
                ...
                r36.y = samp0[]..swiz;
                r36.z = samp0[]..swiz;
                  r11.w = dot(r46.yzw, r20.xyz);
                  r12.w = dot(r36.xyz, r20.xyz);
                  r36.x = frac(r11.w);
                  r36.y = frac(r12.w);
                  r8.w = (int)r8.w + -1;
                  r36.z = (uint)r8.w;
                  r19.xyz = gCookieArray.SampleLevel(samplerLinear_s, r36.xyz, 0).xyz;
                } else {
                  r19.xyz = float3(1,1,1);
                }
              }
              r34.yz = r35.yz;
              r19.xyz = r34.xyz * r19.xyz;
              r8.w = cmp(0 < r10.w);
              if (r8.w != 0) {
                if (3 == 0) r8.w = 0; else if (3+27 < 32) {                 r8.w = (uint)r35.w << (32-(3 + 27)); r8.w = (uint)r8.w >> (32-3);                } else r8.w = (uint)r35.w >> 27;
                r8.w = cmp((int)r8.w != 1);
                if (r8.w != 0) {
                  r8.w = abs(r7.w) * -0.200000003 + 0.400000006;
                  r11.w = cmp(r7.w < 0);
                  r8.w = r11.w ? -r8.w : r8.w;
                  r21.xyz = r2.xyz * r8.www + v5.xyz;
                  r41.xyz = r40.xyz;
                  r8.w = dot(r41.xyzw, r21.xyzw);
                  r11.w = dot(r43.xyzw, r21.xyzw);
                  ...
                  r42.y = samp0[]..swiz;
                    ...
                    if (r5.w != 0) {
                      ...
                      while (true) {
                        ...
                        if (r13.w != 0) break;
                        r20.x = dot(icb[r12.w+0].xy, r24.xy);
                        r20.y = dot(icb[r12.w+0].yx, r24.xz);
                        r34.xy = r20.xy * r37.yy + r21.xy;
                        r13.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r34.xyz, r6.w).x;
                ...
                if (r8.w != 0) {
                  r8.w = r35.x * r4.w;
                  r8.w = 0.25 * r8.w;
                  if (4 == 0) r10.w = 0; else if (4+16 < 32) {                   r10.w = (uint)r35.w << (32-(4 + 16)); r10.w = (uint)r10.w >> (32-4);                  } else r10.w = (uint)r35.w >> 16;
                  ...
                  r40.w = samp0[]..swiz;
                    ...
                    r22.xyz = r2.xyz * r13.www + v5.xyz;
                    r20.x = dot(r34.xyzw, r22.xyzw);
                    r20.y = dot(r36.xyzw, r22.xyzw);
                    r13.w = dot(r37.xyzw, r22.xyzw);
                    r21.x = dot(r38.xyzw, r22.xyzw);
                    r21.y = cmp(r21.x < r13.w);
                    r20.xy = r20.xy / r21.xx;
                    r20.xy = r20.xy * float2(0.5,-0.5) + float2(0.5,0.5);
                    r20.xy = r20.xy + r40.zw;
                    r20.xy = r20.xy * r40.xy;
                    r22.xy = r12.ww / r39.xz;
                    r34.xy = float2(1,1) + -r22.xy;
                    r34.xy = cmp(r20.xy >= r34.xy);
                    ...
                    r22.y = samp0[]..swiz;
                      ...
                      r34.xy = r20.xy * r39.xz + r39.yw;
                      r10.w = r22.y * r21.x;
                      r13.w = r22.x * r21.x + r13.w;
                      r10.w = r13.w / r10.w;
                      r10.w = max(6.10351563e-05, r10.w);
                      r13.w = r21.y ? 0.000000 : 0;
                      if (r5.w != 0) {
                        r21.z = (uint)r13.w;
                        r20.xy = float2(0,0);
                        while (true) {
                          ...
                          r21.xy = r22.xy * r12.ww + r34.xy;
                          r21.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r21.xyz, r10.w).x;
                          r20.x = r21.x * 0.125 + r20.x;
                          r20.y = (int)r20.y + 1;
                        }
                      } else {
                        r34.z = (uint)r13.w;
                        r20.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r34.xyz, r10.w).x;
                      }
                      r10.w = r20.x * r20.x;
                      r10.w = r10.w * r20.x;
                    } else {
                    ...
                    if (4 == 0) r10.w = 0; else if (4+20 < 32) {                     r10.w = (uint)r35.w << (32-(4 + 20)); r10.w = (uint)r10.w >> (32-4);                    } else r10.w = (uint)r35.w >> 20;
                    r12.w = cmp(0 < (uint)r10.w);
                    r12.w = r12.w ? r2.w : 0;
                    if (r12.w != 0) {
                      r10.w = (int)r10.w + numLights;
                    ...
                    r39.w = samp0[]..swiz;
                      ...
                      r22.y = samp0[]..swiz;
                        ...
                        r23.xy = r21.xy * r38.xz + r38.yw;
                        r10.w = r22.y * r20.y;
                        r13.w = r22.x * r20.y + r13.w;
                        r10.w = r13.w / r10.w;
                        r10.w = max(6.10351563e-05, r10.w);
                        r13.w = r21.z ? 0.000000 : 0;
                        if (r5.w != 0) {
                          r21.z = (uint)r13.w;
                          r20.y = 0;
                          r22.x = 0;
                          while (true) {
                            ...
                            if (r22.y != 0) break;
                            r34.x = dot(icb[r22.x+0].xy, r26.xy);
                            r34.y = dot(icb[r22.x+0].yx, r26.xz);
                            r21.xy = r34.xy * r12.ww + r23.xy;
                            r21.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r21.xyz, r10.w).x;
                          ...
                          r23.z = (uint)r13.w;
                          r20.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r23.xyz, r10.w).x;
                        }
                        r10.w = r20.y * r20.y;
                        r10.w = r10.w * r20.y;
                      } else {
                  ...
                  r10.w = -abs(r7.w) * r3.x + 1;
                  r10.w = r10.w * r10.w;
                  r10.w = -r10.w * 0.620000005 + 0.620000005;
                  r10.w = r10.w + -abs(r7.w);
                  r10.w = r5.y * r10.w + abs(r7.w);
                  r10.w = r10.w * r6.w;
                  r12.w = cmp(0 < r7.w);
                  r21.xyz = r10.www * r19.xyz + r15.xyz;
                  r7.w = saturate(r7.w);
                  r18.xyz = r18.xyz * r7.zzz + r4.xyz;
                  r7.z = dot(r18.xyz, r18.xyz);
                  r7.z = rsqrt(r7.z);
                  r18.xyz = r18.xyz * r7.zzz;
                  r7.z = dot(r18.xyz, r4.xyz);
                  r13.w = dot(r2.xyz, r18.xyz);
                  r18.x = abs(r13.w) * r4.w + -abs(r13.w);
                  r13.w = abs(r13.w) * r18.x + 1;
                  r18.x = r7.w * r0.w + r1.x;
                  r13.w = r13.w * r13.w;
                  r13.w = r13.w * r18.x;
                  r13.w = rcp(r13.w);
                  r7.w = r7.w * r8.w;
                  r7.w = r13.w * r7.w;
                  r6.w = r7.w * r6.w;
                  r18.xyz = r6.www * r19.xyz + r33.xyz;
                  r7.z = saturate(1 + -r7.z);
                  r7.w = r7.z * r7.z;
                  r7.w = r7.w * r7.w;
                  r7.z = r7.z * r7.w;
                  r6.w = r7.z * r6.w;
                  r22.xyz = r6.www * r19.xyz + r32.xyz;
                  r19.xyz = r10.www * r19.xyz + r31.xyz;
                  r15.xyz = r12.www ? r21.xyz : r15.xyz;
                  r31.xyz = r12.www ? r31.xyz : r19.xyz;
                  r32.xyz = r12.www ? r22.xyz : r32.xyz;
                  r33.xyz = r12.www ? r18.xyz : r33.xyz;
                }
              }
            }
            break;
