...
if_nz r3.x
  ...
  mad r6.xyz, r4.xyzx, r3.yyyy, -r3.xxxx
  max r3.z, r6.z, r6.y
  max r3.z, r3.z, r6.x
  max r3.x, r3.z, r3.x
  eq r3.z, r3.x, r6.x
  mul r7.yzw, r2.yyzw, l(0.000000, 1.000000, -1.000000, -1.000000)
  add r3.w, r3.x, l(2.000000)
  mov r7.x, l(1)
  mov r2.x, l(0)
  movc r7.xyzw, r3.zzzz, r7.xyzw, r2.xyzw
  movc r3.x, r3.z, r3.w, r3.x
  eq r3.z, r3.x, r6.y
  mul r8.yzw, r7.yyzw, l(0.000000, -1.000000, 1.000000, -1.000000)
  add r3.w, r3.x, l(2.000000)
  mov r8.x, l(2)
  movc r7.xyzw, r3.zzzz, r8.xyzw, r7.xyzw
  movc r3.x, r3.z, r3.w, r3.x
  eq r3.x, r3.x, r6.z
  mul r6.yzw, r7.yyzw, l(0.000000, -1.000000, -1.000000, 1.000000)
  mov r6.x, l(3)
  movc r6.xyzw, r3.xxxx, r6.xyzw, r7.xyzw
  add r3.x, r6.z, r6.y
  add r7.z, r6.w, r3.x
  add r7.y, -r6.y, r6.w
  mad r7.x, -r6.z, l(3.000000), r7.z
  mul r3.xzw, r7.xxyz, l(0.40824831, 0.000000, 0.70710677, 0.57735026)
  add r3.w, |r3.w|, l(1.000000)
  rsq r3.w, r3.w
  mul r3.xz, r3.wwww, r3.xxzx
  mad o1.xy, r3.xzxx, l(0.58823532, 0.58823532, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
  mad o1.z, r1.w, l(0.49755621), l(0.00146628)
  utof r3.x, r6.x
  mul o1.w, r3.x, l(0.33333334)
  ftou r3.xz, v0.xxyx
  add r6.y, -r1.z, r1.x
  mad r1.x, r6.y, l(0.500000), r1.z
  add r6.z, -r1.x, r1.y
  mad r6.x, r6.z, l(0.500000), r1.x
  and r1.xy, r3.xzxx, l(1, 1, 0, 0)
  ieq r1.x, r1.y, r1.x
