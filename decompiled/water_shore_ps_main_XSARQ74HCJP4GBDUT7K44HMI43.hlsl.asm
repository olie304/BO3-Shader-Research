...
if_z r3.w
  ...
  if_nz r8.x
    mov r8.xy, l(0,0,0,0)
    loop 
      ge r8.z, r8.x, l(3.000000)
      breakc_nz r8.z
      ftou r8.z, r8.x
      add r9.xy, r6.yzyy, -cb2[r8.z + 20].xyxx
      max r8.w, |r9.y|, |r9.x|
  ...
  if_nz r8.z
    ...
    rcp r10.xz, r9.xxxx
    mov r10.y, -r10.z
    mad r9.xyz, r6.yzyy, r10.xyzx, r9.yzyy
    ...
    mul r8.w, r10.y, cb2[27].x
    mad r8.w, r8.w, cb2[32].x, r10.x
    ftou r8.w, r8.w
    iadd r8.w, r8.w, cb2[32].y
    ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r9.w, r8.w, l(0), t23.xxxx
    and r10.x, r9.w, l(0x40000000)
    ishl r10.y, r9.w, l(2)
    if_z r10.x
      and r10.x, r9.w, l(0x01ffffff)
      iadd r11.x, r8.w, r10.x
      ushr r8.w, r9.w, l(25)
      utof r8.w, r8.w
      ...
      if_z r8.w
        ...
        iadd r8.w, -r11.y, l(6)
        ushr r12.xy, r9.zyzz, r8.wwww
        and r8.w, r11.w, l(0xc0000000)
        or r9.w, r11.w, l(0x40000000)
        bfi r10.z, l(1), l(1), r12.y, l(0)
        bfi r10.z, l(1), l(0), r12.x, r10.z
        imul null, r10.z, r10.z, l(10)
        ushr r9.w, r9.w, r10.z
        and r9.w, r9.w, l(1023)
        iadd r12.x, r9.w, r11.x
        ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r12.z, r12.x, l(0), t23.xxxx
        mov r12.y, r11.z
        movc r12.xyz, r8.wwww, r11.xywx, r12.xyzx
        iadd r9.w, -r12.y, l(6)
        ushr r11.yz, r9.zzyz, r9.wwww
        and r9.w, r12.z, l(0xc0000000)
        or r10.z, r12.z, l(0x40000000)
        bfi r11.z, l(1), l(1), r11.z, l(0)
        bfi r11.y, l(1), l(0), r11.y, r11.z
        imul null, r11.y, r11.y, l(10)
        ushr r10.z, r10.z, r11.y
        and r10.z, r10.z, l(1023)
        iadd r13.x, r10.z, r12.x
        ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r13.y, r13.x, l(0), t23.xxxx
        movc r11.yz, r9.wwww, r12.xxzx, r13.xxyx
        movc r10.xw, r8.wwww, r11.xxxw, r11.yyyz
      endif 
      and r8.w, r10.w, l(0xc0000000)
      if_z r8.w
        ubfe r9.w, l(14), l(15), r10.w
        utof r9.w, r9.w
        ...
        ushr r9.x, r11.x, r12.x
        and r9.x, r9.x, l(255)
        utof r9.x, r9.x
        mul r9.x, r10.z, r9.x
        mad r9.x, r9.x, l(0.00392157), r9.w
        iadd r9.y, r12.y, l(1)
        ...
        utof r9.y, r9.y
        mul r9.y, r10.z, r9.y
        mad r9.y, r9.y, l(0.00001526), r9.w
        movc r10.y, r11.y, r9.x, r9.y
      else 
        ...
        mad r9.y, r6.y, r9.z, r9.y
        mad r9.x, r6.z, r9.x, r9.y
        movc r10.y, r8.w, r9.x, r10.y
      endif 
    endif 
  ...
  if_z r8.z
    if_z cb2[58].y
      ftou r6.w, r8.x
      add r8.zw, r6.yyyz, -cb2[r6.w + 20].xxxy
      mul r8.zw, r8.zzzw, cb2[r6.w + 20].zzzz
      mad r9.xy, r8.zwzz, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
      itof r6.w, cb2[26].y
      add r9.z, r6.w, r8.x
      sample_c_lz_indexable(texture2darray)(float,float,float,float) r6.w, r9.xyzx, t13.xxxx, s13, r3.w
      sample_l_indexable(texture2darray)(float,float,float,float) r8.z, r9.xyzx, t31.yzxw, s0, l(0.000000)
      add r6.w, r6.w, r8.z
    ...
    if_nz cb2[58].y
      ...
      add r6.yz, r6.yyzy, -cb2[r8.x + 20].xxyx
      mul r6.yz, r6.yyzy, cb2[r8.x + 20].zzzz
      ...
      loop 
        uge r10.y, r10.x, l(8)
        breakc_nz r10.y
        ult r10.y, r8.y, r10.x
        movc r10.zw, r10.yyyy, r6.yyyz, r8.zzzw
        movc r11.x, r10.y, cb2[r8.x + 20].w, cb2[r6.w + 20].w
        movc r10.y, r10.y, r8.x, r6.w
        dp2 r12.x, icb[r10.x + 0].yxyy, r9.xyxx
        dp2 r12.y, icb[r10.x + 0].yxyy, r9.yzyy
        mad r11.xy, r12.xyxx, r11.xxxx, r10.zwzz
        iadd r10.y, r10.y, cb2[26].y
        utof r11.z, r10.y
        sample_c_lz_indexable(texture2darray)(float,float,float,float) r10.y, r11.xyzx, t13.xxxx, s13, r3.w
        sample_l_indexable(texture2darray)(float,float,float,float) r10.z, r11.xyzx, t31.yzxw, s0, l(0.000000)
        add r10.y, r10.z, r10.y
        add_sat r10.y, r10.y, l(-1.000000)
        mad r9.w, r10.y, l(0.125000), r9.w
...
if_nz r3.w
  ...
  div r8.xy, r6.yyyy, r10.xzxx
  add r8.zw, -r8.xxxy, l(0.000000, 0.000000, 1.000000, 1.000000)
  ge r8.zw, r6.zzzw, r8.zzzw
  ge r8.xy, r8.xyxx, r6.zwzz
  or r8.xy, r8.xyxx, r8.zwzz
  or r8.x, r8.y, r8.x
  if_z r8.x
    ...
    dp4 r3.w, r9.xyzw, r12.xyzw
    mov_sat r6.zw, r6.zzzw
    mad r9.xy, r6.zwzz, r10.xzxx, r10.ywyy
    add r3.w, r8.y, r3.w
    div r3.w, r3.w, r8.z
    max r3.w, r3.w, l(0.00006104)
    and r6.z, r8.x, l(0x0000ffff)
    if_nz cb2[58].y
      mov r8.x, -r6.x
      utof r10.z, r6.z
      mov r8.y, r7.x
      ...
      loop 
        ...
        mad r10.xy, r11.xyxx, r6.yyyy, r9.xyxx
      ...
      utof r9.z, r6.z
      sample_c_lz_indexable(texture2darray)(float,float,float,float) r6.x, r9.xyzx, t9.xxxx, s13, r3.w
    endif 
    mul r3.w, r6.x, r6.x
    mul r3.w, r6.x, r3.w
  else 
...
mad r8.xyz, -v6.xyzx, r4.xxxx, cb2[17].xyzx
...
mad r0.xyz, r6.xyzx, r0.yyyy, r7.yzwy
mad r4.xyz, r6.xyzx, |r0.wwww|, r7.yzwy
