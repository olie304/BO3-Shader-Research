...
sample_indexable(texture2d)(float,float,float,float) r1.x, v2.xyxx, t9.xyzw, s1
...
mov r6.x, l(1)
mov r2.x, l(0)
movc r2.xyzw, r1.wwww, r6.xyzw, r2.xyzw
...
mad r0.w, r2.y, l(0.500000), r1.y
mad r2.z, r5.y, r1.x, -r0.w
