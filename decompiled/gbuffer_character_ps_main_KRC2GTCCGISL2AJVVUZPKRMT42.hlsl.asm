...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:26:49 2021
//
//
// Buffer Definitions: 
//
...
mad r1.xyz, r2.xyzx, r2.wwww, -r0.wwww
max r2.x, r1.z, r1.y
max r2.x, r1.x, r2.x
max r0.w, r0.w, r2.x
eq r1.x, r0.w, r1.x
mul r2.yzw, r9.yyzw, l(0.000000, 1.000000, -1.000000, -1.000000)
add r3.x, r0.w, l(2.000000)
mov r2.x, l(1)
mov r9.x, l(0)
movc r2.xyzw, r1.xxxx, r2.xyzw, r9.xyzw
