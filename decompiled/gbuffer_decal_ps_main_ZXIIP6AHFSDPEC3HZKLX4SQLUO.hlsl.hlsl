  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r1.w = glossMap.Sample(specColorSampler_s, r1.xy).x;
  r3.x = glossRange.y + -glossRange.x;
  r1.w = r1.w * r3.x + glossRange.x;
  r1.w = saturate(0.0588235296 * r1.w);
  r3.yzw = normalMap.Sample(normalSampler_s, r1.xy).xyz;
  r3.yzw = float3(-0.5,-0.5,-0) + r3.yzw;
  r3.yzw = baseNormalHeight * r3.yzw + float3(0.5,0.5,0);
  r1.xy = r3.yz * float2(1.9921875,1.9921875) + float2(-1,-1);
  r3.y = dot(r1.xy, r1.xy);
  r3.y = 1 + -r3.y;
  r3.y = max(0, r3.y);
  r3.y = sqrt(r3.y);
  r3.z = r3.w * r3.w;
  ...
  r5.xyz = r5.xyz * r1.xxx + r6.xyz;
  r4.xyz = r4.xyz * r3.yyy + r5.xyz;
  r1.x = dot(r4.xyz, r4.xyz);
  r1.x = rsqrt(r1.x);
  r4.xyz = r4.xyz * r1.xxx;
  r1.x = debugGlossOverride.x * r3.x + glossRange.x;
  ...
  if (r1.y != 0) {
    ...
    r3.x = colorMap.CalculateLevelOfDetailUnclamped(colorSampler_s, r0.yz);
    r0.y = colorMap.CalculateLevelOfDetail(colorSampler_s, r0.yz);
    r0.z = cmp(r3.x < r0.y);
    r0.y = cmp(0 < r0.y);
    r3.xyz = (int3)r1.yyy & int3(1,2,4);
    r5.xyz = r3.xxx ? float3(1,0,1) : r2.xyz;
    r6.xyz = r3.yyy ? float3(0,1,1) : r2.xyz;
    r5.xyz = r0.yyy ? r5.xyz : r6.xyz;
    r3.xyz = r3.zzz ? float3(0,1,0) : r2.xyz;
    r2.xyz = r0.zzz ? r5.xyz : r3.xyz;
  }
  r3.xyz = debugColorOverride.xyz + -r2.xyz;
  r2.xyz = debugColorOverride.www * r3.xyz + r2.xyz;
  r0.x = -r2.w * r0.x + debugAlphaOverride.x;
  r0.x = debugAlphaOverride.w * r0.x + r0.w;
  r0.yzw = float3(-0.0399999991,-0.0399999991,-0.0399999991) + debugSpecularOverride.xyz;
  r0.yzw = debugSpecularOverride.www * r0.yzw + float3(0.0399999991,0.0399999991,0.0399999991);
  r1.x = r1.x + -r1.w;
  r1.x = debugGlossOverride.w * r1.x + r1.w;
  r1.y = debugOcclusionOverride.x + -r1.z;
  r5.z = debugOcclusionOverride.w * r1.y + r1.z;
  r1.yzw = v5.xyz * r3.www + -r4.xyz;
  r1.yzw = debugNormalOverride.www * r1.yzw + r4.xyz;
  ...
  r2.w = r2.w * 3 + 0.5;
  r2.w = (uint)r2.w;
  r4.xyzw = (int4)r2.wwww & int4(2,1,2,1);
  ...
  r4.z = r2.w ? -0.577350259 : 0.577350259;
  r3.yz = float2(-1.22474492,1.22474492) * r4.xz;
  r6.xyz = float3(0.707106769,-1.41421354,0.707106769) * r4.xyz;
  r6.x = dot(r1.yzw, r6.xyz);
  r6.y = dot(r1.yw, r3.yz);
  r1.y = dot(r1.yzw, r4.xyz);
  r1.y = 1 + abs(r1.y);
  r1.y = rsqrt(r1.y);
  r1.yz = r6.xy * r1.yy;
  r4.xy = r1.yz * float2(0.588235319,0.588235319) + float2(0.5,0.5);
  r1.y = cmp(r2.z >= 0.5);
  r1.y = r1.y ? 0.5 : 0.00146627566;
  r4.z = r1.x * 0.49755621 + r1.y;
  r1.xyz = r3.xxx ? r4.xyz : 0;
