...
mul r0.x, r0.w, r0.x
sample_indexable(texture2d)(float,float,float,float) r0.yz, r0.yzyy, t7.zxyw, s1
add r0.yz, r0.yyzy, l(0.000000, -0.500000, -0.500000, 0.000000)
mad r0.yz, cb0[10].wwww, r0.yyzy, l(0.000000, 0.500000, 0.500000, 0.000000)
...
mad r0.yzw, r1.xxyz, r0.wwww, r2.xxyz
...
movc r2.z, r0.y, l(0.500000), l(0.00146628)
