...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r3.w = debugAlphaOverride.w * r1.z + r0.w;
  ...
  r5.xyz = v8.xxx ? v4.xyz : -v4.xyz;
  r1.z = dot(r5.xyz, r5.xyz);
  r1.z = rsqrt(r1.z);
  r5.xyz = r5.xyz * r1.zzz + -r2.xzw;
  r2.xyz = debugNormalOverride.www * r5.xyz + r2.xzw;
  r1.z = thicknessMap.Sample(colorSampler_s, v2.xy).x;
  r1.z = 1 + -r1.z;
  r5.xyz = backlightScatterColor.xyz * r1.zzz;
  ...
  r1.zw = float2(0,0);
  while (true) {
    r4.w = cmp((uint)r1.w >= numRefProbes);
    if (r4.w != 0) break;
    r13.z = (uint)r1.w >> 5;
  ...
  r40.w = samp0[]..swiz;
    ...
    r30.x = dot(r2.xyz, r22.xyz);
    r30.y = dot(r2.xyz, r31.xyz);
    r30.z = dot(r2.xyz, r24.xyz);
  ...
  if (r1.z == 0) {
    ...
    while (true) {
      ...
      r13.z = cmp((int)r1.w == (int)r10.w);
      bitmask.w = ((~(-1 << r4.w)) << 0) & 0xffffffff;  r13.w = (((uint)0 << 0) & bitmask.w) | ((uint)r12.w & ~bitmask.w);
    ...
    if (r10.y != 0) {
      ...
      r13.w = 0;
      while (true) {
        r15.w = cmp((uint)r13.w >= (uint)r1.z);
        if (r15.w != 0) break;
        r13.z = (uint)r13.w >> 5;
        r14.xyz = (int3)r12.xyz + (int3)r13.xyz;
        r13.z = visibleProbes.Load(r14.xyzw).x;
        r14.x = cmp((int)r1.w == (int)r13.w);
        if (r4.w == 0) r14.y = 0; else if (r4.w+0 < 32) {         r14.y = (uint)r13.z << (32-(r4.w + 0)); r14.y = (uint)r14.y >> (32-r4.w);        } else r14.y = (uint)r13.z >> 0;
    ...
    if (r1.w != 0) {
      ...
      r20.xyz = r22.xyz * r1.zzz + r10.yzw;
      r11.w = 0;
  ...
  r14.xyz = r10.yzw * r1.yyy;
  r15.xyz = r10.yzw * r1.www;
  r0.w = sqrt(r7.z);
  r0.w = r0.w * 0.5 + 0.5;
  r0.w = r0.w * r0.w;
  r1.y = 0.5 * r0.w;
  ...
  if (r1.w == 0) {
    ...
    r1.w = -sunConstants.splitDepthOffset + r10.w;
    ...
    if (r8.z == 0) {
      if (enableDitheredShadow == 0) {
        ...
        r16.z = r8.z + r4.w;
        r8.z = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r1.w).x;
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          r11.w = r10.w ? sunConstants.splitPinTransform[r4.w].w : sunConstants.splitPinTransform[r8.z].w;
          r10.w = r10.w ? r4.w : r8.z;
          ...
          r18.z = (uint)r10.w;
          r10.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r18.xyz, r1.w).x;
  ...
  if (r1.w != 0) {
    r1.w = cmp(0 < r2.w);
    if (r1.w != 0) {
      r1.w = sunConstants.specScale * r7.y;
      r1.w = 0.25 * r1.w;
      if (sunConstants.sunCookieIndex != 0) {
        r16.xyz = eyeOffset.xyz + v7.xyz;
        r16.w = 1;
        r4.w = dot(sunConstants.sunCookieTransform[0].xyzw, r16.xyzw);
      ...
      r19.z = samp0[]..swiz;
      r19.w = samp0[]..swiz;
        r8.z = abs(r1.z) * -0.200000003 + 0.400000006;
        r8.w = cmp(r1.z < 0);
        r8.z = r8.w ? -r8.z : r8.z;
        r20.xyz = r2.xyz * r8.zzz + v7.xyz;
        r20.w = 1;
        ...
        r17.y = samp0[]..swiz;
          ...
          if (enableDitheredShadow != 0) {
            ...
            while (true) {
              ...
              r11.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r18.xyz, r4.w).x;
              r8.w = r11.w * 0.125 + r8.w;
              r9.w = (int)r9.w + 1;
            }
          } else {
            r16.z = (uint)r8.z;
            r8.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r4.w).x;
          }
          r4.w = r8.w * r8.w;
          r4.w = r4.w * r8.w;
        } else {
      ...
      r1.z = r5.w * r1.z;
      r1.z = r1.z * r2.w;
      r17.yzw = r1.zzz * r10.yzw + r15.xyz;
      r1.w = saturate(1 + -r4.w);
      r2.w = r1.w * r1.w;
      r2.w = r2.w * r2.w;
      r1.w = r2.w * r1.w;
      r1.z = r1.z * r1.w;
      r10.yzw = r1.zzz * r10.yzw + r14.xyz;
      r16.w = r13.z;
      r13.w = r16.z;
  ...
  r2.w = 0;
  while (true) {
    r4.w = cmp((uint)r2.w >= numLights);
    if (r4.w != 0) break;
    r17.z = (uint)r2.w >> 5;
    r19.xyz = (int3)r12.xyz + (int3)r17.xyz;
    r4.w = visibleLights.Load(r19.xyzw).x;
    r19.xyz = r10.yzw;
    r33.xyz = r30.xyz;
    r34.xyz = r31.xyz;
    r35.xyz = r32.xyz;
    ...
    while (true) {
      if (r7.w == 0) break;
      r8.z = firstbitlow((uint)r7.w);
      r8.w = 1 << (int)r8.z;
      r9.w = (int)r7.w & (int)r8.w;
      if (r9.w != 0) {
        r7.w = (int)r7.w ^ (int)r8.w;
        r8.z = (int)r2.w + (int)r8.z;
      // Known bad code for instruction (needs manual fix):
      ...
      r37.y = samp0[]..swiz;
        ...
        r37.z = r36.w;
        r36.xyz = cmp(abs(r36.xyz) < r37.zxy);
        r8.w = r36.y ? r36.x : 0;
        r8.w = r36.z ? r8.w : 0;
        if (r8.w != 0) {
        // Known bad code for instruction (needs manual fix):
        ...
        r42.z = samp0[]..swiz;
        r42.w = samp0[]..swiz;
          if (3 == 0) r8.w = 0; else if (3+24 < 32) {           r8.w = (uint)r37.w << (32-(3 + 24)); r8.w = (uint)r8.w >> (32-3);          } else r8.w = (uint)r37.w >> 24;
          switch (r8.w) {
            case 4 :            r8.w = cmp(0 < r42.x);
            r43.xy = r41.zw;
            r43.z = r42.w;
            r44.xyz = -r43.xyz * float3(0.5,0.5,0.5) + r36.yzw;
            r45.xyz = -v7.xyz + r44.xyz;
            r9.w = dot(r43.xyz, r45.xyz);
            r11.w = saturate(-r9.w / r42.x);
            r46.xyz = r11.www * r43.xyz + r44.xyz;
            r46.xyz = r8.www ? r46.xyz : r36.yzw;
            r46.xyz = -v7.xyz + r46.xyz;
            r12.w = dot(r46.xyz, r46.xyz);
            r13.w = rsqrt(r12.w);
            r46.xyz = r46.xyz * r13.www;
            r13.w = dot(r2.xyz, r46.xyz);
            ...
            if (r14.w != 0) {
              ...
              r12.w = r15.w / r12.w;
              r12.w = min(1, r12.w);
              r17.zw = saturate(r14.ww * r38.xz + r38.yw);
              r46.xy = r17.zw * r17.zw;
              r17.zw = r17.zw * float2(-2,-2) + float2(3,3);
              r17.zw = r46.xy * r17.zw;
              r12.w = r17.z * r12.w;
              r12.w = r12.w * r17.w;
              r14.w = cmp(0 < r12.w);
              if (r14.w != 0) {
                if (3 == 0) r14.w = 0; else if (3+27 < 32) {                 r14.w = (uint)r37.w << (32-(3 + 27)); r14.w = (uint)r14.w >> (32-3);                } else r14.w = (uint)r37.w >> 27;
                r14.w = cmp((int)r14.w != 1);
                if (r14.w != 0) {
                  r14.w = abs(r13.w) * -0.200000003 + 0.400000006;
                  r15.w = cmp(r13.w < 0);
                  r14.w = r15.w ? -r14.w : r14.w;
                  r46.xyz = r2.xyz * r14.www + v7.xyz;
                  r46.xyz = r46.xyz + -r40.xyz;
                  r14.w = max(abs(r46.y), abs(r46.z));
                  r14.w = max(abs(r46.x), r14.w);
                  r14.w = r41.x / r14.w;
                  r14.w = r14.w + r41.y;
                  r15.w = dot(r46.xyz, r46.xyz);
                  r15.w = rsqrt(r15.w);
                  r14.w = max(6.10351563e-05, r14.w);
                  r17.z = (int)r37.w & 0x0000ffff;
                  r47.w = (uint)r17.z;
                  r17.zw = float2(0,0);
                  while (true) {
                    r18.w = cmp((int)r17.w >= 8);
                    if (r18.w != 0) break;
                    r48.y = dot(icb[r17.w+0].yx, r16.xy);
                    r48.z = dot(icb[r17.w+0].yx, r16.yz);
                    r48.yz = r48.yz * r39.yy;
                    r48.x = r48.y * r10.x;
                    r48.w = r48.y * r7.x;
                    r47.xyz = r46.xyz * r15.www + r48.xzw;
                    r18.w = gOmniShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r47.xyzw, r14.w).x;
                    r17.z = r18.w * 0.125 + r17.z;
                    r17.w = (int)r17.w + 1;
                  }
                } else {
                  r17.z = 1;
                ...
                if (r14.w != 0) {
                  r14.w = r37.x * r7.y;
                  r14.w = 0.25 * r14.w;
                  r15.w = dot(r43.xyz, r11.xyz);
                  r17.w = dot(r11.xyz, r45.xyz);
                  r18.w = -r15.w * r15.w + r42.x;
                  r9.w = r15.w * r17.w + -r9.w;
                  r9.w = saturate(r9.w / r18.w);
                  r15.w = r18.w / r42.x;
                  r15.w = 10 * r15.w;
                  r15.w = min(1, r15.w);
                  r9.w = r9.w + -r11.w;
                  r9.w = r15.w * r9.w + r11.w;
                  r43.xyz = r9.www * r43.xyz + r44.xyz;
                  r43.xyz = r8.www ? r43.xyz : r36.yzw;
                  r43.xyz = -v7.xyz + r43.xyz;
                  r8.w = dot(r43.xyz, r43.xyz);
                  r8.w = rsqrt(r8.w);
                  r44.xyz = r43.xyz * r8.www;
                  if (4 == 0) r9.w = 0; else if (4+16 < 32) {                   r9.w = (uint)r37.w << (32-(4 + 16)); r9.w = (uint)r9.w >> (32-4);                  } else r9.w = (uint)r37.w >> 16;
                  ...
                  r46.w = samp0[]..swiz;
                    ...
                    r21.xyz = r2.xyz * r15.www + v7.xyz;
                    r15.w = dot(r45.xyzw, r21.xyzw);
                    r17.w = dot(r46.xyzw, r21.xyzw);
                    r18.w = cmp(r17.w < r15.w);
                    if (r18.w == 0) {
                    // Known bad code for instruction (needs manual fix):
                    ...
                    r49.x = samp0[]..swiz;
                    r49.y = samp0[]..swiz;
                      r45.x = dot(r45.xyzw, r21.xyzw);
                      r45.y = dot(r46.xyzw, r21.xyzw);
                      r21.xy = r45.xy / r17.ww;
                      r21.xy = r21.xy * float2(0.5,-0.5) + float2(0.5,0.5);
                      r21.xy = r21.xy + r48.zw;
                      r21.xy = r21.xy * r48.xy;
                      r45.xy = r11.ww / r47.xz;
                      r45.zw = float2(1,1) + -r45.xy;
                      r45.zw = cmp(r21.xy >= r45.zw);
                      r45.xy = cmp(r45.xy >= r21.xy);
                      r45.xy = (int2)r45.xy | (int2)r45.zw;
                      r21.z = (int)r45.y | (int)r45.x;
                      r21.xy = saturate(r21.xy);
                      r45.xy = r21.xy * r47.xz + r47.yw;
                      r21.x = r49.y * r17.w;
                      r15.w = r49.x * r17.w + r15.w;
                      r15.w = r15.w / r21.x;
                    } else {
                      r21.z = -1;
                    }
                    r17.w = (int)r18.w | (int)r21.z;
                    if (r17.w == 0) {
                    // Known bad code for instruction (needs manual fix):
                    ...
                    r9.w = samp0[]..swiz;
                      ...
                      if (r5.w != 0) {
                        ...
                        while (true) {
                          ...
                          if (r23.w != 0) break;
                          r46.x = dot(icb[r18.w+0].yx, r16.xw);
                          r46.y = dot(icb[r18.w+0].xy, r8.xy);
                          r21.xy = r46.xy * r11.ww + r45.xy;
                          r21.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r21.xyz, r15.w).x;
                          r17.w = r21.x * 0.125 + r17.w;
                          r18.w = (int)r18.w + 1;
                        }
                      } else {
                        r45.z = (uint)r9.w;
                        r17.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r45.xyz, r15.w).x;
                      }
                      r9.w = r17.w * r17.w;
                      r9.w = r9.w * r17.w;
                    } else {
                    ...
                    if (4 == 0) r9.w = 0; else if (4+20 < 32) {                     r9.w = (uint)r37.w << (32-(4 + 20)); r9.w = (uint)r9.w >> (32-4);                    } else r9.w = (uint)r37.w >> 20;
                    r11.w = cmp(0 < (uint)r9.w);
                    r11.w = r11.w ? r1.z : 0;
                    if (r11.w != 0) {
                      r9.w = (int)r9.w + numLights;
                    ...
                    r46.w = samp0[]..swiz;
                      ...
                      r22.xyz = r2.xyz * r15.www + v7.xyz;
                      r15.w = dot(r45.xyzw, r22.xyzw);
                      r18.w = dot(r46.xyzw, r22.xyzw);
                      r21.x = cmp(r18.w < r15.w);
                      if (r21.x == 0) {
                      // Known bad code for instruction (needs manual fix):
                                            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r45.xyzw, r9.w, l(68), t12.xyzw
                      r45.x = samp0[]..swiz;
                      ...
                      r21.y = samp0[]..swiz;
                      r21.z = samp0[]..swiz;
                        r45.x = dot(r45.xyzw, r22.xyzw);
                        r45.y = dot(r46.xyzw, r22.xyzw);
                        r22.xy = r45.xy / r18.ww;
                        r22.xy = r22.xy * float2(0.5,-0.5) + float2(0.5,0.5);
                        r22.xy = r22.xy + r48.zw;
                        r22.xy = r22.xy * r48.xy;
                        r45.xy = r11.ww / r47.xz;
                        r45.zw = float2(1,1) + -r45.xy;
                        r45.zw = cmp(r22.xy >= r45.zw);
                        r45.xy = cmp(r45.xy >= r22.xy);
                        r45.xy = (int2)r45.xy | (int2)r45.zw;
                        r22.z = (int)r45.y | (int)r45.x;
                        r22.xy = saturate(r22.xy);
                        r45.xy = r22.xy * r47.xz + r47.yw;
                        r21.z = r21.z * r18.w;
                        r15.w = r21.y * r18.w + r15.w;
                        r15.w = r15.w / r21.z;
                      } else {
                        r22.z = -1;
                      }
                      r18.w = (int)r21.x | (int)r22.z;
                      if (r18.w == 0) {
                      // Known bad code for instruction (needs manual fix):
                                            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r9.w, r9.w, l(28), t12.xxxx
                      r9.w = samp0[]..swiz;
                        ...
                        if (r5.w != 0) {
                          ...
                          while (true) {
                            ...
                            if (r22.y != 0) break;
                            r46.x = dot(icb[r22.x+0].xy, r9.xy);
                            r46.y = dot(icb[r22.x+0].yx, r9.xz);
                            r21.xy = r46.xy * r11.ww + r45.xy;
                            r21.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r21.xyz, r15.w).x;
                          ...
                          r45.z = (uint)r9.w;
                          r18.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r45.xyz, r15.w).x;
                        }
                        r9.w = r18.w * r18.w;
                        r9.w = r9.w * r18.w;
                      } else {
                  ...
                  r9.w = -abs(r13.w) * r1.x + 1;
                  r9.w = r9.w * r9.w;
                  r9.w = -r9.w * 0.620000005 + 0.620000005;
                  r9.w = r9.w + -abs(r13.w);
                  r9.w = r7.z * r9.w + abs(r13.w);
                  r9.w = r9.w * r12.w;
                  r37.x = r36.x;
                  r11.w = cmp(0 < r13.w);
                  r21.xyz = r9.www * r37.xyz + r19.xyz;
                  r13.w = saturate(dot(r2.xyz, r44.xyz));
                  r22.xyz = r43.xyz * r8.www + r6.xyz;
                  r8.w = dot(r22.xyz, r22.xyz);
                  r8.w = rsqrt(r8.w);
                  r22.xyz = r22.xyz * r8.www;
                  r8.w = dot(r22.xyz, r6.xyz);
                  r15.w = dot(r2.xyz, r22.xyz);
                  r22.x = abs(r15.w) * r7.y + -abs(r15.w);
                  r15.w = abs(r15.w) * r22.x + 1;
                  r22.x = r13.w * r0.w + r1.y;
                  r15.w = r15.w * r15.w;
                  r15.w = r15.w * r22.x;
                  r15.w = rcp(r15.w);
                  r13.w = r13.w * r14.w;
                  r13.w = r15.w * r13.w;
                  r12.w = r13.w * r12.w;
                  r22.xyz = r12.www * r37.xyz + r35.xyz;
                  r8.w = saturate(1 + -r8.w);
                  r13.w = r8.w * r8.w;
                  r13.w = r13.w * r13.w;
                  r8.w = r13.w * r8.w;
                  r8.w = r12.w * r8.w;
                  r43.xyz = r8.www * r37.xyz + r34.xyz;
                  r44.xyz = r9.www * r37.xyz + r33.xyz;
                  r19.xyz = r11.www ? r21.xyz : r19.xyz;
                  r33.xyz = r11.www ? r33.xyz : r44.xyz;
                  r34.xyz = r11.www ? r43.xyz : r34.xyz;
                  r35.xyz = r11.www ? r22.xyz : r35.xyz;
                }
              }
            }
            break;
            case 2 :            r21.xy = r39.zw;
            r21.z = r40.w;
            r21.xyz = -v7.xyz + r21.xyz;
            r8.w = dot(r21.xyz, r21.xyz);
            r8.w = rsqrt(r8.w);
            r22.xyz = r21.xyz * r8.www;
            r9.w = dot(r2.xyz, r22.xyz);
            r11.w = cmp(0 < abs(r9.w));
            if (r11.w != 0) {
            // Known bad code for instruction (needs manual fix):
            ...
            r44.w = samp0[]..swiz;
              ...
              r13.w = samp0[]..swiz;
                r49.xyz = -v7.xyz + r36.yzw;
                r14.w = r39.x * r39.x;
                r15.w = dot(r49.xyz, r49.xyz);
                r14.w = r14.w / r15.w;
                r14.w = min(1, r14.w);
                r38.xy = saturate(r11.ww * r38.xz + r38.yw);
                ...
                r14.w = r14.w * r38.y;
                r40.w = r41.x;
                r38.x = dot(r40.xyzw, r20.xyzw);
                r49.xyz = r41.yzw;
                r49.w = r42.w;
                r38.y = dot(r49.xyzw, r20.xyzw);
                r23.xy = r38.xy / r11.ww;
                r11.w = cmp(r46.w < 0.00048828125);
                if (r11.w != 0) {
                  r47.y = r48.x;
                  r38.xy = saturate(abs(r23.xy) * r47.zw + r47.xy);
                  r38.zw = r38.xy * r38.xy;
                  r38.xy = r38.xy * float2(-2,-2) + float2(3,3);
                  r38.xy = r38.zw * r38.xy;
                  r11.w = r38.x * r38.y;
                  ...
                  r46.w = r47.y;
                  r38.xyzw = saturate(r46.xyzw * abs(r23.yyxx));
                  r38.xyzw = log2(r38.xyzw);
                  r38.xyzw = r47.xxxx * r38.xyzw;
                  r38.xyzw = exp2(r38.xyzw);
                  r38.xy = r38.xy + r38.zw;
                  r38.xy = log2(r38.xy);
                  r38.xy = r48.xx * r38.xy;
                  r38.xy = exp2(r38.xy);
                  r15.w = r47.z * r38.x;
                  r23.w = r47.w * r38.y + -1;
                  r15.w = r47.w * r38.y + -r15.w;
                  r15.w = saturate(r23.w / r15.w);
                  r23.w = r15.w * r15.w;
                  r15.w = r15.w * -2 + 3;
                  r11.w = r23.w * r15.w;
                }
                ...
                r38.y = samp0[]..swiz;
                r38.z = samp0[]..swiz;
                  r13.w = dot(r48.yzw, r23.xyz);
                  r14.w = dot(r38.xyz, r23.xyz);
                  r38.x = frac(r13.w);
                  r38.y = frac(r14.w);
                  r11.w = (int)r11.w + -1;
                  r38.z = (uint)r11.w;
                  r22.xyz = gCookieArray.SampleLevel(samplerLinear_s, r38.xyz, 0).xyz;
                } else {
                  r22.xyz = float3(1,1,1);
                }
              }
              r36.yz = r37.yz;
              r22.xyz = r36.xyz * r22.xyz;
              r11.w = cmp(0 < r12.w);
              if (r11.w != 0) {
                if (3 == 0) r11.w = 0; else if (3+27 < 32) {                 r11.w = (uint)r37.w << (32-(3 + 27)); r11.w = (uint)r11.w >> (32-3);                } else r11.w = (uint)r37.w >> 27;
                r11.w = cmp((int)r11.w != 1);
                if (r11.w != 0) {
                  r11.w = abs(r9.w) * -0.200000003 + 0.400000006;
                  r13.w = cmp(r9.w < 0);
                  r11.w = r13.w ? -r11.w : r11.w;
                  r24.xyz = r2.xyz * r11.www + v7.xyz;
                  r43.xyz = r42.xyz;
                  r11.w = dot(r43.xyzw, r24.xyzw);
                  r13.w = dot(r45.xyzw, r24.xyzw);
                  ...
                  r44.y = samp0[]..swiz;
                    ...
                    if (r5.w != 0) {
                      ...
                      while (true) {
                        ...
                        if (r15.w != 0) break;
                        r23.x = dot(icb[r14.w+0].xy, r27.xy);
                        r23.y = dot(icb[r14.w+0].yx, r27.xz);
                        r36.xy = r23.xy * r39.yy + r24.xy;
                        r15.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r36.xyz, r8.z).x;
                        r13.w = r15.w * 0.125 + r13.w;
                        r14.w = (int)r14.w + 1;
                      }
                    } else {
                      r24.z = (uint)r11.w;
                      r13.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r24.xyz, r8.z).x;
                    }
                    r8.z = r13.w * r13.w;
                    r8.z = r8.z * r13.w;
                  } else {
                ...
                if (r11.w != 0) {
                  r11.w = r37.x * r7.y;
                  r11.w = 0.25 * r11.w;
                  if (4 == 0) r12.w = 0; else if (4+16 < 32) {                   r12.w = (uint)r37.w << (32-(4 + 16)); r12.w = (uint)r12.w >> (32-4);                  } else r12.w = (uint)r37.w >> 16;
                  ...
                  r42.w = samp0[]..swiz;
                    ...
                    r25.xyz = r2.xyz * r15.www + v7.xyz;
                    r23.x = dot(r36.xyzw, r25.xyzw);
                    r23.y = dot(r38.xyzw, r25.xyzw);
                    r15.w = dot(r39.xyzw, r25.xyzw);
                    r23.w = dot(r40.xyzw, r25.xyzw);
                    r24.x = cmp(r23.w < r15.w);
                    r23.xy = r23.xy / r23.ww;
                    r23.xy = r23.xy * float2(0.5,-0.5) + float2(0.5,0.5);
                    r23.xy = r23.xy + r42.zw;
                    r23.xy = r23.xy * r42.xy;
                    r24.yz = r14.ww / r41.xz;
                    ...
                    r24.z = samp0[]..swiz;
                      ...
                      r25.xy = r23.xy * r41.xz + r41.yw;
                      r12.w = r24.z * r23.w;
                      r15.w = r24.y * r23.w + r15.w;
                      r12.w = r15.w / r12.w;
                      r12.w = max(6.10351563e-05, r12.w);
                      r15.w = r24.x ? 0.000000 : 0;
                      if (r5.w != 0) {
                        r24.z = (uint)r15.w;
                        r23.xy = float2(0,0);
                        while (true) {
                          ...
                          if (r23.w != 0) break;
                          r36.x = dot(icb[r23.y+0].xy, r28.xy);
                          r36.y = dot(icb[r23.y+0].yx, r28.xz);
                          r24.xy = r36.xy * r14.ww + r25.xy;
                          r23.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r24.xyz, r12.w).x;
                          r23.x = r23.w * 0.125 + r23.x;
                          r23.y = (int)r23.y + 1;
                        }
                      } else {
                        r25.z = (uint)r15.w;
                        r23.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r25.xyz, r12.w).x;
                      }
                      r12.w = r23.x * r23.x;
                      r12.w = r12.w * r23.x;
                    } else {
                    ...
                    if (4 == 0) r12.w = 0; else if (4+20 < 32) {                     r12.w = (uint)r37.w << (32-(4 + 20)); r12.w = (uint)r12.w >> (32-4);                    } else r12.w = (uint)r37.w >> 20;
                    r14.w = cmp(0 < (uint)r12.w);
                    r14.w = r14.w ? r1.z : 0;
                    if (r14.w != 0) {
                      r12.w = (int)r12.w + numLights;
                    ...
                    r41.w = samp0[]..swiz;
                      ...
                      r25.y = samp0[]..swiz;
                        ...
                        r24.xy = r24.xy * r40.xz + r40.yw;
                        r12.w = r25.y * r23.y;
                        r15.w = r25.x * r23.y + r15.w;
                        r12.w = r15.w / r12.w;
                        r12.w = max(6.10351563e-05, r12.w);
                        r15.w = r23.w ? 0.000000 : 0;
                        if (r5.w != 0) {
                          r25.z = (uint)r15.w;
                          r23.yw = float2(0,0);
                          while (true) {
                            r26.x = cmp((int)r23.w >= 8);
                            if (r26.x != 0) break;
                            r26.x = dot(icb[r23.w+0].xy, r29.xy);
                            r26.y = dot(icb[r23.w+0].yx, r29.xz);
                            r25.xy = r26.xy * r14.ww + r24.xy;
                            r25.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r25.xyz, r12.w).x;
                            r23.y = r25.x * 0.125 + r23.y;
                            r23.w = (int)r23.w + 1;
                          }
                        } else {
                          r24.z = (uint)r15.w;
                          r23.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r24.xyz, r12.w).x;
                        }
                        r12.w = r23.y * r23.y;
                        r12.w = r12.w * r23.y;
                      } else {
                  ...
                  r12.w = -abs(r9.w) * r1.x + 1;
                  r12.w = r12.w * r12.w;
                  r12.w = -r12.w * 0.620000005 + 0.620000005;
                  r12.w = r12.w + -abs(r9.w);
                  r12.w = r7.z * r12.w + abs(r9.w);
                  r12.w = r12.w * r8.z;
                  r14.w = cmp(0 < r9.w);
                  r24.xyz = r12.www * r22.xyz + r19.xyz;
                  r9.w = saturate(r9.w);
                  r21.xyz = r21.xyz * r8.www + r6.xyz;
                  r8.w = dot(r21.xyz, r21.xyz);
                  r8.w = rsqrt(r8.w);
                  r21.xyz = r21.xyz * r8.www;
                  r8.w = dot(r21.xyz, r6.xyz);
                  r15.w = dot(r2.xyz, r21.xyz);
                  r21.x = abs(r15.w) * r7.y + -abs(r15.w);
                  r15.w = abs(r15.w) * r21.x + 1;
                  r21.x = r9.w * r0.w + r1.y;
                  r15.w = r15.w * r15.w;
                  r15.w = r15.w * r21.x;
                  r15.w = rcp(r15.w);
                  r9.w = r9.w * r11.w;
                  r9.w = r15.w * r9.w;
                  r8.z = r9.w * r8.z;
                  r21.xyz = r8.zzz * r22.xyz + r35.xyz;
                  r8.w = saturate(1 + -r8.w);
                  r9.w = r8.w * r8.w;
                  r9.w = r9.w * r9.w;
                  r8.w = r9.w * r8.w;
                  r8.z = r8.z * r8.w;
                  r25.xyz = r8.zzz * r22.xyz + r34.xyz;
                  r22.xyz = r12.www * r22.xyz + r33.xyz;
                  r19.xyz = r14.www ? r24.xyz : r19.xyz;
                  r33.xyz = r14.www ? r33.xyz : r22.xyz;
                  r34.xyz = r14.www ? r25.xyz : r34.xyz;
                  r35.xyz = r14.www ? r21.xyz : r35.xyz;
                }
              }
            }
            break;
  ...
  r1.xyz = r30.xyz * r5.xyz;
  r0.xyz = r10.yzw * r0.xyz + r1.xyz;
  r1.xyz = float3(1,1,1) + -r4.xyz;
  r1.xyz = r31.xyz * r1.xyz;
  r1.xyz = r32.xyz * r4.xyz + r1.xyz;
  r0.xyz = r1.xyz + r0.xyz;
