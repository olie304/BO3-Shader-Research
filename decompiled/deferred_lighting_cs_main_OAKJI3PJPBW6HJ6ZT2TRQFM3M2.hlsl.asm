...
if_nz r3.z
  ...
  if_nz r3.z
    ...
    max r3.z, r12.y, r12.x
    add r12.xyw, r14.xyxz, -r15.xyxz
    mad r12.xyw, r3.zzzz, r12.xyxw, r15.xyxz
    ...
    mad r13.xyw, r3.zzzz, r16.xyxz, r13.xyxw
    ...
    sample_l_indexable(texture2d)(float,float,float,float) r3.z, r17.xyxx, t28.yzxw, s1, r2.z
    min r2.w, |r2.w|, |r3.z|
    mul r2.w, r17.z, r2.w
    ...
    iadd r3.z, r2.w, l(0x80000000)
    movc r2.z, r2.z, r3.z, r2.w
    mov r17.w, l(-1)
    mov r18.z, l(-1)
  ...
  mad r3.z, r0.w, l(-2.000000), l(3.000000)
  mul r0.w, r0.w, r0.w
  mul r0.w, r0.w, r3.z
  mul r0.w, r0.w, r2.z
  mul r0.w, r13.y, r0.w
...
if_nz r8.w
  ...
  if_nz r1.w
    add r13.yzw, cb1[24].xxyz, cb10[r8.w + 0].xxyz
    mov r13.x, l(16)
    store_structured u2.xyzw, cb2[52].x, l(880), r13.xyzw
  endif 
  add r13.xyz, r4.xywx, -cb10[r8.w + 0].xyzx
  and r9.w, l(0x0000ffff), cb10[r8.w + 7].z
  ubfe r12.w, l(6), l(25), cb10[r8.w + 7].z
  imul null, r13.w, r9.w, l(6)
  dp3 r14.x, cb11[r13.w + 0].xyzx, r13.xyzx
  add_sat r14.x, r14.x, cb11[r13.w + 0].w
  dp3 r14.y, cb11[r13.w + 1].xyzx, r13.xyzx
  add_sat r14.y, r14.y, cb11[r13.w + 1].w
  mul r14.x, r14.y, r14.x
  dp3 r14.y, cb11[r13.w + 2].xyzx, r13.xyzx
  add_sat r14.y, r14.y, cb11[r13.w + 2].w
  mul r14.x, r14.y, r14.x
  dp3 r14.y, cb11[r13.w + 3].xyzx, r13.xyzx
  add_sat r14.y, r14.y, cb11[r13.w + 3].w
  mul r14.x, r14.y, r14.x
  dp3 r14.y, cb11[r13.w + 4].xyzx, r13.xyzx
  add_sat r14.y, r14.y, cb11[r13.w + 4].w
  mul r14.x, r14.y, r14.x
  dp3 r14.y, cb11[r13.w + 5].xyzx, r13.xyzx
  add_sat r13.w, r14.y, cb11[r13.w + 5].w
  mul r14.x, r13.w, r14.x
  and r13.w, l(1), cb10[r8.w + 6].x
  mov r14.yz, l(0,0,1.000000,0)
  movc r14.xy, r13.wwww, r14.xyxx, r14.zxzz
  mov r15.x, l(1.000000)
  mov r13.w, cb10[r8.w + 6].x
  mov r16.xy, r14.xyxx
  mov r14.z, l(1)
  loop 
    ige r14.w, r14.z, r12.w
    breakc_nz r14.w
    iadd r14.w, r9.w, r14.z
    imul null, r14.w, r14.w, l(6)
    dp3 r15.z, cb11[r14.w + 0].xyzx, r13.xyzx
    add_sat r15.z, r15.z, cb11[r14.w + 0].w
    mul r15.z, r15.z, r16.x
    dp3 r15.w, cb11[r14.w + 1].xyzx, r13.xyzx
    add_sat r15.w, r15.w, cb11[r14.w + 1].w
    mul r15.z, r15.w, r15.z
    dp3 r15.w, cb11[r14.w + 2].xyzx, r13.xyzx
    add_sat r15.w, r15.w, cb11[r14.w + 2].w
    mul r15.z, r15.w, r15.z
    dp3 r15.w, cb11[r14.w + 3].xyzx, r13.xyzx
    add_sat r15.w, r15.w, cb11[r14.w + 3].w
    mul r15.z, r15.w, r15.z
    dp3 r15.w, cb11[r14.w + 4].xyzx, r13.xyzx
    add_sat r15.w, r15.w, cb11[r14.w + 4].w
    mul r15.z, r15.w, r15.z
    dp3 r15.w, cb11[r14.w + 5].xyzx, r13.xyzx
    add_sat r14.w, r15.w, cb11[r14.w + 5].w
    mul r16.x, r14.w, r15.z
    ushr r15.w, r13.w, l(2)
    ubfe r16.z, l(1), l(2), r13.w
    and r16.w, r15.w, l(2)
    max r17.x, r16.x, r16.y
    mad r14.w, -r15.z, r14.w, l(1.000000)
    mul r14.w, r14.w, r16.y
    movc r15.y, r16.w, r14.w, r17.x
    movc r16.xy, r16.zzzz, r16.xyxx, r15.xyxx
    iadd r14.z, r14.z, l(1)
    mov r13.w, r15.w
  endloop 
  mov_sat r16.y, r16.y
  mul r9.w, r16.y, cb10[r8.w + 6].y
  ...
  if_nz r12.w
    ...
    mul r12.w, r9.w, cb10[r8.w + 7].y
    mov r14.x, cb10[r8.w + 7].w
    mov r14.yz, cb10[r8.w + 8].xxyx
    dp3 r13.w, r11.xyzx, r14.xyzx
    dp3 r14.x, r13.xyzx, r14.xyzx
    add r14.x, r14.x, -cb10[r8.w + 8].z
    ...
    mov r14.x, cb10[r8.w + 8].w
    mov r14.yz, cb10[r8.w + 9].xxyx
    dp3 r14.w, r11.xyzx, r14.xyzx
    dp3 r14.x, r13.xyzx, r14.xyzx
    add r14.x, r14.x, -cb10[r8.w + 9].z
    ge r14.y, r14.x, l(0.000000)
    max r14.x, r5.w, |r14.x|
    movc r14.x, r14.y, r14.x, -r14.x
    ...
    mov r14.x, cb10[r8.w + 9].w
    mov r14.yz, cb10[r8.w + 10].xxyx
    dp3 r14.w, r11.xyzx, r14.xyzx
    dp3 r14.x, r13.xyzx, r14.xyzx
    add r14.x, r14.x, -cb10[r8.w + 10].z
    ge r14.y, r14.x, l(0.000000)
    max r14.x, r5.w, |r14.x|
    movc r14.x, r14.y, r14.x, -r14.x
    max r14.y, -r14.w, l(0.00000010)
    div r14.x, r14.x, r14.y
    min r13.w, r13.w, |r14.x|
    mov r14.x, cb10[r8.w + 10].w
    mov r14.yz, cb10[r8.w + 11].xxyx
    dp3 r14.w, r11.xyzx, r14.xyzx
    dp3 r14.x, r13.xyzx, r14.xyzx
    add r14.x, r14.x, -cb10[r8.w + 11].z
    ge r14.y, r14.x, l(0.000000)
    max r14.x, r5.w, |r14.x|
    movc r14.x, r14.y, r14.x, -r14.x
    max r14.y, -r14.w, l(0.00000010)
    div r14.x, r14.x, r14.y
    min r13.w, r13.w, |r14.x|
    mov r14.x, cb10[r8.w + 11].w
    mov r14.yz, cb10[r8.w + 12].xxyx
    dp3 r14.w, r11.xyzx, r14.xyzx
    dp3 r14.x, r13.xyzx, r14.xyzx
    add r14.x, r14.x, -cb10[r8.w + 12].z
    ge r14.y, r14.x, l(0.000000)
    max r14.x, r5.w, |r14.x|
    movc r14.x, r14.y, r14.x, -r14.x
    max r14.y, -r14.w, l(0.00000010)
    div r14.x, r14.x, r14.y
    min r13.w, r13.w, |r14.x|
    mov r14.x, cb10[r8.w + 12].w
    mov r14.yz, cb10[r8.w + 13].xxyx
    dp3 r14.w, r11.xyzx, r14.xyzx
    dp3 r14.x, r13.xyzx, r14.xyzx
    add r14.x, r14.x, -cb10[r8.w + 13].z
    ge r14.y, r14.x, l(0.000000)
    max r14.x, r5.w, |r14.x|
    movc r14.x, r14.y, r14.x, -r14.x
    max r14.y, -r14.w, l(0.00000010)
    div r14.x, r14.x, r14.y
    min r13.w, r13.w, |r14.x|
    add r14.x, r13.x, cb10[r8.w + 3].w
    add r14.yz, r13.yyzy, cb10[r8.w + 4].xxyx
    ...
    mov r15.x, cb10[r8.w + 0].w
    mov r15.y, cb10[r8.w + 1].z
    mov r15.z, cb10[r8.w + 2].y
    dp3 r16.x, r14.xyzx, r15.xyzx
    mov r17.xy, cb10[r8.w + 1].xwxx
    mov r17.z, cb10[r8.w + 2].z
    dp3 r16.y, r14.xyzx, r17.xyzx
    mov r18.x, cb10[r8.w + 1].y
    mov r18.yz, cb10[r8.w + 2].xxwx
    dp3 r16.z, r14.xyzx, r18.xyzx
    ubfe r14.x, l(9), l(16), cb10[r8.w + 7].z
    utof r16.w, r14.x
    sample_l_indexable(texturecubearray)(float,float,float,float) r14.xyz, r16.xyzw, t8.xyzw, s2, r13.w
    ...
    mad_sat r13.xyz, r19.xyzx, cb10[r8.w + 3].xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
    mul r19.xy, r13.xyxx, cb10[r8.w + 4].zwzz
    mul r19.z, r13.z, cb10[r8.w + 5].x
    add r13.xyz, r19.xyzx, cb10[r8.w + 5].yzwy
...
if_nz r7.w
  ...
  if_nz r1.w
    ...
    mov r15.x, l(16)
    store_structured u2.xyzw, cb2[52].x, r7.w, r15.xyzw
  endif 
  iadd r7.w, r8.w, l(1)
  ...
  dp3 r15.w, cb11[r14.w + 0].xyzx, r15.xyzx
  add_sat r15.w, r15.w, cb11[r14.w + 0].w
  dp3 r16.x, cb11[r14.w + 1].xyzx, r15.xyzx
  add_sat r16.x, r16.x, cb11[r14.w + 1].w
  mul r15.w, r15.w, r16.x
  dp3 r16.x, cb11[r14.w + 2].xyzx, r15.xyzx
  add_sat r16.x, r16.x, cb11[r14.w + 2].w
  mul r15.w, r15.w, r16.x
  dp3 r16.x, cb11[r14.w + 3].xyzx, r15.xyzx
  add_sat r16.x, r16.x, cb11[r14.w + 3].w
  mul r15.w, r15.w, r16.x
  dp3 r16.x, cb11[r14.w + 4].xyzx, r15.xyzx
  add_sat r16.x, r16.x, cb11[r14.w + 4].w
  mul r15.w, r15.w, r16.x
  dp3 r16.x, cb11[r14.w + 5].xyzx, r15.xyzx
  add_sat r14.w, r16.x, cb11[r14.w + 5].w
  ...
  mov r15.w, l(1)
  loop 
    ige r16.z, r15.w, r13.w
    breakc_nz r16.z
    iadd r16.z, r12.w, r15.w
    imul null, r16.z, r16.z, l(6)
    dp3 r16.w, cb11[r16.z + 0].xyzx, r15.xyzx
    add_sat r16.w, r16.w, cb11[r16.z + 0].w
    mul r16.w, r16.w, r18.x
    dp3 r17.z, cb11[r16.z + 1].xyzx, r15.xyzx
    add_sat r17.z, r17.z, cb11[r16.z + 1].w
    mul r16.w, r16.w, r17.z
    dp3 r17.z, cb11[r16.z + 2].xyzx, r15.xyzx
    add_sat r17.z, r17.z, cb11[r16.z + 2].w
    mul r16.w, r16.w, r17.z
    dp3 r17.z, cb11[r16.z + 3].xyzx, r15.xyzx
    add_sat r17.z, r17.z, cb11[r16.z + 3].w
    mul r16.w, r16.w, r17.z
    dp3 r17.z, cb11[r16.z + 4].xyzx, r15.xyzx
    add_sat r17.z, r17.z, cb11[r16.z + 4].w
    mul r16.w, r16.w, r17.z
    dp3 r17.z, cb11[r16.z + 5].xyzx, r15.xyzx
    add_sat r16.z, r17.z, cb11[r16.z + 5].w
    mul r18.x, r16.z, r16.w
    ushr r17.z, r14.w, l(2)
    ubfe r17.w, l(1), l(2), r14.w
    and r18.z, r17.z, l(2)
    max r18.w, r18.x, r18.y
    mad r16.z, -r16.w, r16.z, l(1.000000)
    mul r16.z, r16.z, r18.y
    movc r17.y, r18.z, r16.z, r18.w
    movc r18.xy, r17.wwww, r18.xyxx, r17.xyxx
    iadd r15.w, r15.w, l(1)
    mov r14.w, r17.z
  endloop 
  add_sat r12.w, -r9.w, r18.y
  mul r13.w, r12.w, cb10[r0.y + 6].y
  lt r14.w, l(0.000000), r13.w
  if_nz r14.w
    and r14.w, r7.w, l(3)
    iadd r15.w, r14.w, l(-1)
    ult r15.w, r15.w, l(32)
    and r15.w, r1.w, r15.w
    if_nz r15.w
      imad r16.xy, r14.wwww, l(20, 20, 0, 0), l(860, 876, 0, 0)
      ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r14.w, cb2[52].x, r16.x, u2.xxxx
      or r14.w, r14.w, l(32)
      store_structured u2.x, cb2[52].x, r16.x, r14.w
      store_structured u2.x, cb2[52].x, r16.y, r13.w
    endif 
    iadd r7.w, r8.w, l(257)
    mad r12.w, r12.w, cb10[r0.y + 6].y, r9.w
    mul r13.w, r13.w, cb10[r0.y + 7].y
    mov r16.x, cb10[r0.y + 7].w
    mov r16.yz, cb10[r0.y + 8].xxyx
    dp3 r14.w, r11.xyzx, r16.xyzx
    dp3 r15.w, r15.xyzx, r16.xyzx
    add r15.w, r15.w, -cb10[r0.y + 8].z
    ...
    mad r16.xyz, r11.xyzx, r5.wwww, r16.xyzx
    dp3 r14.w, r16.xyzx, r16.xyzx
    sqrt r14.w, r14.w
    div r5.w, r5.w, r14.w
    add r5.w, r5.w, r5.w
    sqrt r5.w, r5.w
    mad r2.w, r2.w, l(5.000000), r5.w
...
ge r0.y, r9.w, l(1.000000)
bfi r2.w, l(8), l(0), r7.w, r8.w
movc r0.y, r0.y, r2.w, r7.w
max r2.w, r12.w, l(1.000000)
rcp r2.w, r2.w
mov_sat r12.w, r12.w
mul r15.xyz, r2.wwww, r13.xyzx
mul r14.xyz, r2.wwww, r14.xyzx
lt r5.w, r12.w, l(0.990000)
if_nz r5.w
  ...
  mov r11.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r10.xyz, r11.xyzw, t8.xyzw, s2, r3.z
