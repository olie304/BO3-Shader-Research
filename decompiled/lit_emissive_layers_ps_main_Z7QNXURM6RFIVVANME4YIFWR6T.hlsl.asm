...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:33:20 2021
//
//
// Buffer Definitions: 
//
...
movc r5.x, v7.x, l(1.000000), l(-1.000000)
          ...
          if_nz r10.w
            ...
            if_nz r10.w
              ...
              if_nz r23.y
                ...
                mul r25.xyz, r5.xxxx, r26.xyzx
                mul r23.xyz, r5.xxxx, r23.xyzx
                mul r24.xyz, r5.xxxx, r24.xyzx
          ...
          if_nz r15.z
            ...
            if_nz r15.z
              ...
              if_nz r22.w
                ...
                mul r28.xyz, r5.xxxx, r29.xyzx
                mul r26.xyz, r5.xxxx, r26.xyzx
                mul r27.xyz, r5.xxxx, r27.xyzx
...
mad r4.xyz, r4.xyzx, r1.wwww, r17.xyzx
...
if_nz r0.z
  ...
  mul r0.z, r0.z, r2.w
  round_ne r0.z, r0.z
  div r2.w, r0.z, cb0[12].w
  mul r3.w, r0.z, cb0[12].w
  ge r3.w, r3.w, -r3.w
...
if_nz r2.w
  ...
  mul r5.x, r3.w, cb1[69].w
  ge r5.x, r5.x, -r5.x
  movc r5.x, r5.x, r3.w, -r3.w
  div r6.w, l(1.000000, 1.000000, 1.000000, 1.000000), r5.x
  ...
  mul r5.x, r2.w, cb0[22].x
  ge r5.x, r5.x, -r5.x
  movc r5.x, r5.x, cb0[22].x, -cb0[22].x
  div r6.w, l(1.000000, 1.000000, 1.000000, 1.000000), r5.x
  mul r2.w, r2.w, r6.w
  frc r2.w, r2.w
  mul r2.w, r2.w, r5.x
...
if_nz r2.w
  ...
  mul r5.x, r2.w, cb0[29].x
  ge r5.x, r5.x, -r5.x
  movc r5.x, r5.x, cb0[29].x, -cb0[29].x
  div r6.w, l(1.000000, 1.000000, 1.000000, 1.000000), r5.x
  mul r2.w, r2.w, r6.w
  frc r2.w, r2.w
  mul r2.w, r2.w, r5.x
  ...
  mul r5.xy, r5.xyxx, cb0[30].zwzz
  mad r1.xy, r1.xyxx, cb0[30].zwzz, r5.xyxx
...
mov r5.w, l(1.000000)
movc r2.xyzw, cb0[20].yyyy, r2.xyzw, r5.xyzw
add r1.xyz, r1.xyzx, r2.xyzx
mul r0.z, r2.w, cb0[19].w
...
ret 
// Approximately 3189 instruction slots used
