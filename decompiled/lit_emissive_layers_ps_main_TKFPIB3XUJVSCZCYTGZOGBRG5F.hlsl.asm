...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:33:13 2021
//
//
// Buffer Definitions: 
//
...
if_nz r3.w
  ...
  dp3 r3.w, r12.xyzx, r3.xyzx
  lt r4.w, l(0.000000), r3.w
  div r6.zw, -r13.xxxy, r3.wwww
  and r6.zw, r4.wwww, r6.zzzw
  add r7.zw, v2.xxxy, l(0.000000, 0.000000, -0.500000, -0.500000)
  add r3.w, cb0[24].y, l(0.000010)
  ...
  mad r3.w, cb0[21].w, cb1[69].w, l(1.000000)
  mul r3.w, r3.w, cb0[21].z
  mul r3.w, r3.w, l(0.01745329)
  sincos r12.x, r13.x, r3.w
  mov r13.y, r13.x
  mov r13.z, r12.x
  dp2 r14.x, r13.yzyy, r6.zwzz
  mov r13.x, -r12.x
  dp2 r14.y, r13.xyxx, r6.zwzz
  mul r6.zw, cb0[22].xxxy, cb1[69].wwww
  mad r6.zw, r6.zzzw, cb0[22].zzzw, r14.xxxy
  mul r3.w, cb0[24].x, cb1[69].w
  sincos null, r3.w, r3.w
  mad r3.w, r3.w, l(0.500000), l(0.500000)
  add r3.w, -r3.w, l(1.000000)
  add r4.w, -cb0[23].z, cb0[23].w
  mad r3.w, r3.w, r4.w, cb0[23].z
  div r6.zw, r6.zzzw, r3.wwww
  add r6.zw, r6.zzzw, l(0.000000, 0.000000, 0.500000, 0.500000)
  mov_sat r7.zw, r6.zzzw
  movc r11.x, cb0[24].w, r7.z, r6.z
  movc r11.y, cb0[25].x, r7.w, r6.w
endif 
sample_indexable(texture2d)(float,float,float,float) r11.xyzw, r11.xyxx, t26.xyzw, s1
mul r11.xyz, r11.xyzx, cb0[20].xyzx
mul r3.w, r11.w, cb0[18].w
mul r11.xyz, r3.wwww, r11.xyzx
add r3.w, r1.w, cb0[25].z
frc r3.w, r3.w
mad r12.y, cb1[69].w, cb0[25].w, r3.w
mov r12.x, cb0[25].y
sample_l_indexable(texture2d)(float,float,float,float) r3.w, r12.xyxx, t24.yzwx, s5, l(0.000000)
log r3.w, |r3.w|
mul r3.w, r3.w, cb0[26].z
exp r3.w, r3.w
add r4.w, -cb0[26].x, cb0[26].y
mad r3.w, r3.w, r4.w, cb0[26].x
mul r11.xyz, r3.wwww, r11.xyzx
add r3.w, -r11.w, l(1.000000)
mad r8.xyz, r8.xyzx, r3.wwww, r11.xyzx
lt r3.w, l(0.500000), cb0[31].z
if_nz r3.w
  mul r3.w, cb0[27].w, cb0[28].x
  mul r4.w, r3.w, cb0[28].y
  mul r5.w, r4.w, cb1[69].w
  ge r5.w, r5.w, -r5.w
  movc r5.w, r5.w, r4.w, -r4.w
  div r6.z, l(1.000000, 1.000000, 1.000000, 1.000000), r5.w
  ...
  mul r3.w, r3.w, r4.w
  round_ne r3.w, r3.w
  div r4.w, r3.w, cb0[28].x
  mul r5.w, r3.w, cb0[28].x
  ge r5.w, r5.w, -r5.w
  ...
  round_z r3.w, r3.w
  add r3.w, r3.w, v2.x
  div r11.x, r3.w, cb0[28].x
  round_z r3.w, r4.w
  add r3.w, r3.w, v2.y
  div r11.y, r3.w, cb0[27].w
else 
  dp3 r3.w, -v7.xyzx, -v7.xyzx
  rsq r3.w, r3.w
  mul r12.xyz, r3.wwww, -v7.xyzx
...
ret 
// Approximately 2455 instruction slots used
