// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:43:35 2021
...
// Known bad code for instruction (needs manual fix):
ld_structured_indexable(structured_buffer, stride=24)(mixed,mixed,mixed,mixed) r0.y, v5.x, l(0), t4.xxxx
r0.y = gpuSkinBase[]..swiz;
...
r0.w = gpuSkinBase[]..swiz;
  ...
  r1.xyz = viewMatrix._m10_m11_m12 * r1.xxx;
  r0.yzw = r0.www * viewMatrix._m00_m01_m02 + r1.xyz;
