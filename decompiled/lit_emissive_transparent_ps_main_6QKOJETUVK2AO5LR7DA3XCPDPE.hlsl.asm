...
add r2.y, cb0[13].z, l(0.000010)
mad r3.xy, r3.xyxx, r2.yyyy, v2.xyxx
sample_indexable(texture2d)(float,float,float,float) r2.y, r3.xyxx, t22.yxzw, s5
add r4.x, r2.y, l(-0.062500)
...
exp r1.w, r1.w
movc r1.w, cb0[13].y, r1.w, r2.y
eq r2.y, cb0[12].x, l(0.000000)
...
dp3_sat r1.x, r7.xyzx, r10.xyzx
dp3 r2.y, -r10.xyzx, r7.xyzx
add r2.y, r2.y, r2.y
mad r12.xyz, r7.xyzx, -r2.yyyy, -r10.xyzx
...
if_nz r4.w
  ...
  mov r12.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r14.xyz, r12.xyzw, t8.xyzw, s2, r4.z
  mad r2.w, cb2[19].x, r4.w, -r5.w
  mad r2.w, r1.y, r2.w, r5.w
  mad r11.yzw, r14.xxyz, r2.wwww, r11.yyzw
endif 
mad r4.zw, r1.xxxy, l(0.000000, 0.000000, 0.984375, 0.984375), l(0.000000, 0.000000, 0.00781250, 0.00781250)
...
if_nz r5.w
  ...
  if_nz r5.w
    ...
    mad r16.xyz, r4.wwww, r8.xyzx, r11.yzwy
    ...
    mov r8.zw, r16.xxxy
    mov r14.zw, r11.yyyz
    movc r8.xyzw, r4.zzzz, r8.xyzw, r14.xyzw
    movc r11.w, r4.z, r16.z, r11.w
    mov r14.z, r13.w
    mov r14.xy, r8.xyxx
    mov r11.yz, r8.zzwz
  endif 
                  ...
                  if_z r18.y
                    ...
                    if_nz r6.w
                      ...
                      loop 
                        ...
                        dp2 r43.y, icb[r18.z + 0].xyxx, r4.xyxx
                    ...
                    if_z r18.z
                      ...
                      if_nz r6.w
                        ...
                        loop 
                          ige r26.w, r24.w, l(8)
                          breakc_nz r26.w
                          dp2 r42.x, icb[r24.w + 0].xyxx, r5.xyxx
                          dp2 r42.y, icb[r24.w + 0].yxyy, r5.xzxx
