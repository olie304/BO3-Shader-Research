...
add r4.yzw, v5.xxyz, -cb2[35].xxyz
...
if_nz r5.z
  ...
  if_nz r5.z
    ...
    mul r7.z, r3.w, r7.z
    if_nz cb2[23].x
      add r8.xyz, v5.xyzx, cb1[24].xyzx
      mov r8.w, l(1.000000)
    ...
    if_nz r8.w
      ...
      mad r13.xyz, r1.xyzx, r13.xxxx, v5.xyzx
      ...
      if_nz r5.z
        ...
        mad r13.xyz, r1.xyzx, r8.wwww, v5.xyzx
        mov r13.w, l(1.000000)
        dp4 r9.x, r9.xyzw, r13.xyzw
        dp4 r9.y, r10.xyzw, r13.xyzw
        mad r9.xy, r9.xyxx, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
    ...
    mad r10.xyz, -v5.xyzx, r0.wwww, cb2[17].xyzx
