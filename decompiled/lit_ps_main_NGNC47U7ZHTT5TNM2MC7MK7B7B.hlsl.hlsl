...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r1.y = r1.x * r0.w;
  r1.z = specColorMap.Sample(specColorSampler_s, v2.xy).x;
  r1.w = saturate(1 + -r1.z);
  ...
  if (r1.w != 0) {
    ...
    r2.yzw = r2.yyy ? r4.xyz : r3.xyw;
    r3.xyz = r3.zzz ? float3(0,1,0) : r0.xyz;
    r0.xyz = r2.xxx ? r2.yzw : r3.xyz;
  }
  r0.w = -r0.w * r1.x + debugAlphaOverride.x;
  r2.w = debugAlphaOverride.w * r0.w + r1.y;
  ...
  r1.xyw = normalMap.Sample(normalSampler_s, v2.xy).xyz;
  ...
  r1.x = r1.x + -r0.w;
  r1.y = debugGlossOverride.w * r1.x + r0.w;
  ...
  r1.x = saturate(dot(r4.xyz, r5.yzw));
  ...
  if (r1.z == 0) {
    ...
    if (r9.y != 0) {
      ...
      r10.z = 0;
      while (true) {
        r10.w = cmp((uint)r10.z >= (uint)r1.z);
        if (r10.w != 0) break;
        r13.z = (uint)r10.z >> 5;
        r14.xyz = (int3)r12.xyz + (int3)r13.xyz;
        r10.w = visibleProbes.Load(r14.xyzw).x;
        r12.w = cmp((int)r1.w == (int)r10.z);
    ...
    if (r1.w != 0) {
      ...
      r20.xyz = r22.xyz * r1.zzz + r9.yzw;
      r11.w = 0;
      r9.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r11.xyzw, r7.z).xyz;
      r1.z = sunConstants.globalProbeExposure * r1.w + -r3.w;
      r1.z = r1.y * r1.z + r3.w;
      r21.xyz = r9.yzw * r1.zzz + r21.xyz;
    }
  } else {
    r21.x = r20.w;
  }
  ...
  r14.xyz = r9.zwy * r1.yyy;
  r1.yzw = r9.yzw * r1.www;
  r0.w = sqrt(r6.z);
  r0.w = r0.w * 0.5 + 0.5;
  r0.w = r0.w * r0.w;
  r3.w = 0.5 * r0.w;
