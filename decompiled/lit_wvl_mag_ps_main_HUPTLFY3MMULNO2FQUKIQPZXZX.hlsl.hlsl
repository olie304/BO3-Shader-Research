// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:39:54 2021
...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r2.w = glossMap.Sample(specColorSampler_s, v2.xy).x;
  ...
  r2.z = min(1, r2.z);
  r4.xy = r2.xy * detailScaleHeight + r3.xy;
  r2.x = dot(r4.xyz, r4.xyz);
  r2.x = rsqrt(r2.x);
  r3.xyw = r4.xyz * r2.xxx;
  ...
  r4.w = frac(r4.w);
  r4.xw = float2(0.0078125,52.9829178) * r4.xw;
  r4.w = frac(r4.w);
  ...
  r2.x = saturate(dot(r3.xyz, r5.xyz));
  r4.w = dot(-r5.xyz, r3.xyz);
  r4.w = r4.w + r4.w;
  r10.xyz = r3.xyz * -r4.www + -r5.xyz;
  r4.w = 17 * r2.y;
  r4.w = exp2(r4.w);
  r4.w = 2 + r4.w;
  r4.w = 2 / r4.w;
  ...
  r6.y = 1 + -r2.y;
  r6.w = r6.y * 5 + -2.5;
  r6.zw = float2(5,0.400000006) * r6.yw;
  r6.w = max(0, r6.w);
  r6.w = 100 * r6.w;
  ...
  r11.z = (uint)r4.x << 4;
  r2.z = (int)r7.w & -32;
  r2.w = (int)-r2.z + (int)r7.w;
  r4.x = numRefProbes & -32;
  r8.w = (int)-r4.x + numRefProbes;
  r12.xy = float2(0,0);
  r13.w = 0;
  r14.yz = float2(0,1);
  r15.xy = float2(0,0);
  ...
  while (true) {
    ...
    r9.w = cmp((int)r2.z == (int)r9.y);
    bitmask.w = ((~(-1 << r2.w)) << 0) & 0xffffffff;  r11.w = (((uint)0 << 0) & bitmask.w) | ((uint)r9.z & ~bitmask.w);
  ...
  if (r4.x != 0) {
    ...
    while (true) {
      ...
      r12.z = cmp((int)r2.z == (int)r8.w);
      if (r2.w == 0) r12.w = 0; else if (r2.w+0 < 32) {       r12.w = (uint)r11.w << (32-(r2.w + 0)); r12.w = (uint)r12.w >> (32-r2.w);      } else r12.w = (uint)r11.w >> 0;
  ...
  r9.yzw = r19.xyz * r2.zzz;
  r12.xyz = r20.xyz * r2.zzz;
  r2.w = cmp(r20.w < 0.99000001);
  if (r2.w != 0) {
    r2.w = 1 + -r20.w;
    r4.x = sunConstants.globalProbeExposure * r2.w;
    ...
    r9.yzw = r19.xyz * r2.zzz + r13.xyz;
    r10.w = 0;
    r6.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r10.xyzw, r6.z).xyz;
    r2.z = sunConstants.globalProbeExposure * r2.w + -r3.w;
    r2.z = r2.y * r2.z + r3.w;
    r12.xyz = r6.yzw * r2.zzz + r12.xyz;
  }
  r2.z = r2.x + r0.w;
  r2.z = log2(abs(r2.z));
  r2.z = r5.w * r2.z;
  ...
  r6.yzw = r12.xyz * r2.zzz;
  r12.xyz = r6.zwy * r2.yyy;
  r2.yzw = r6.yzw * r2.www;
  r0.w = sqrt(r5.w);
  r0.w = r0.w * 0.5 + 0.5;
  r0.w = r0.w * r0.w;
  r3.w = 0.5 * r0.w;
  ...
  r0.w = r4.x * r0.w;
  r3.w = r4.x * r3.w;
  r4.x = dot(r3.xyz, sunConstants.wldDir.xyz);
  r6.y = saturate(r4.x);
  r6.z = cmp(0 >= r6.y);
  if (r6.z != 0) {
    r6.w = 0;
  ...
  if (r6.z != 0) {
    r6.z = cmp(0 < r6.w);
    if (r6.z != 0) {
      r6.z = sunConstants.specScale * r4.w;
      r6.z = r6.z * r6.y;
      ...
      r17.z = samp0[]..swiz;
      r17.w = samp0[]..swiz;
        r8.w = abs(r4.x) * -0.200000003 + 0.400000006;
        r18.xyz = r3.xyz * r8.www + v6.xyz;
        r18.w = 1;
      ...
      r15.xyz = -v6.xyz * r4.yyy + sunConstants.wldDir.xyz;
      r4.y = dot(r15.xyz, r15.xyz);
      r4.y = rsqrt(r4.y);
      r15.xyz = r15.xyz * r4.yyy;
      r4.y = dot(r15.xyz, r5.xyz);
      ...
      r6.y = r6.w * r6.y;
      r6.y = 0.25 * r6.y;
      r15.xyz = r6.yyy * r9.yzw + r2.yzw;
      r4.y = saturate(1 + -r4.y);
      r6.z = r4.y * r4.y;
      r6.z = r6.z * r6.z;
      r4.y = r6.z * r4.y;
      r4.y = r6.y * r4.y;
      r16.xyz = r4.yyy * r9.zwy + r12.xyz;
      r14.w = r16.z;
      r13.w = r12.z;
      r13.xyzw = r4.xxxx ? r14.xyzw : r13.xyzw;
      r16.zw = r15.xy;
      r12.zw = r2.yz;
      r14.xyzw = r4.xxxx ? r16.xyzw : r12.xyzw;
      r2.w = r4.x ? r15.z : r2.w;
      r12.z = r13.w;
      r12.xy = r14.xy;
      r2.yz = r14.zw;
    }
  ...
  while (true) {
    ...
    while (true) {
      ...
      if (r13.w != 0) {
        ...
        r11.w = (int)r7.z + (int)r11.w;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=80)(mixed,mixed,mixed,mixed) r30.xyzw, r11.w, l(0), t11.xyzw
      r30.x = samp0[]..swiz;
      r30.y = samp0[]..swiz;
      r30.z = samp0[]..swiz;
      r30.w = samp0[]..swiz;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=80)(mixed,mixed,mixed,mixed) r31.xy, r11.w, l(16), t11.xyxx
      r31.x = samp0[]..swiz;
      r31.y = samp0[]..swiz;
        ...
        if (r12.w != 0) {
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r30.xyzw, r11.w, l(0), t12.wxyz
        r30.x = samp0[]..swiz;
        r30.y = samp0[]..swiz;
        r30.z = samp0[]..swiz;
        r30.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r31.xyzw, r11.w, l(16), t12.zxyw
        r31.x = samp0[]..swiz;
        r31.y = samp0[]..swiz;
        r31.z = samp0[]..swiz;
        r31.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r32.xyzw, r11.w, l(32), t12.xyzw
        r32.x = samp0[]..swiz;
        r32.y = samp0[]..swiz;
        r32.z = samp0[]..swiz;
        r32.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r33.xyzw, r11.w, l(48), t12.xyzw
        r33.x = samp0[]..swiz;
        r33.y = samp0[]..swiz;
        r33.z = samp0[]..swiz;
        r33.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r34.xyzw, r11.w, l(64), t12.yzwx
        r34.x = samp0[]..swiz;
        r34.y = samp0[]..swiz;
        r34.z = samp0[]..swiz;
        r34.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r35.xyzw, r11.w, l(80), t12.xyzw
        r35.x = samp0[]..swiz;
        r35.y = samp0[]..swiz;
        r35.z = samp0[]..swiz;
        r35.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r36.xyzw, r11.w, l(96), t12.yzwx
        r36.x = samp0[]..swiz;
        r36.y = samp0[]..swiz;
        r36.z = samp0[]..swiz;
        r36.w = samp0[]..swiz;
          if (3 == 0) r12.w = 0; else if (3+24 < 32) {           r12.w = (uint)r31.w << (32-(3 + 24)); r12.w = (uint)r12.w >> (32-3);          } else r12.w = (uint)r31.w >> 24;
          switch (r12.w) {
            case 4 :            r12.w = cmp(0 < r36.x);
            r37.xy = r35.zw;
            r37.z = r36.w;
            r38.xyz = -r37.xyz * float3(0.5,0.5,0.5) + r30.yzw;
            r39.xyz = -v6.xyz + r38.xyz;
            r13.w = dot(r37.xyz, r39.xyz);
            r15.z = saturate(-r13.w / r36.x);
            r40.xyz = r15.zzz * r37.xyz + r38.xyz;
            r40.xyz = r12.www ? r40.xyz : r30.yzw;
            r40.xyz = -v6.xyz + r40.xyz;
            r15.w = dot(r40.xyz, r40.xyz);
            r20.w = rsqrt(r15.w);
            r40.xyz = r40.xyz * r20.www;
            r20.w = dot(r3.xyz, r40.xyz);
            r24.w = saturate(r20.w);
            r25.w = cmp(0 < r24.w);
            if (r25.w != 0) {
              r25.w = sqrt(r15.w);
              r26.w = r33.x * r33.x;
              ...
              if (r25.w != 0) {
                ...
                if (r25.w != 0) {
                  r25.w = abs(r20.w) * -0.200000003 + 0.400000006;
                  r40.xyz = r3.xyz * r25.www + v6.xyz;
                ...
                if (r25.w != 0) {
                  ...
                  r26.w = min(1, r26.w);
                  r13.w = r13.w + -r15.z;
                  r13.w = r26.w * r13.w + r15.z;
                  r37.xyz = r13.www * r37.xyz + r38.xyz;
                  r37.xyz = r12.www ? r37.xyz : r30.yzw;
                  r37.xyz = -v6.xyz + r37.xyz;
                  r12.w = dot(r37.xyz, r37.xyz);
                  r12.w = rsqrt(r12.w);
                  r38.xyz = r37.xyz * r12.www;
                  if (4 == 0) r13.w = 0; else if (4+16 < 32) {                   r13.w = (uint)r31.w << (32-(4 + 16)); r13.w = (uint)r13.w >> (32-4);                  } else r13.w = (uint)r31.w >> 16;
                  r15.z = cmp(0 < (uint)r13.w);
                  r15.z = r4.z ? r15.z : 0;
                  if (r15.z != 0) {
                  ...
                  r15.z = samp0[]..swiz;
                  // Known bad code for instruction (needs manual fix):
                                    ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r39.xyzw, r13.w, l(100), t12.xyzw
                  r39.x = samp0[]..swiz;
                  r39.y = samp0[]..swiz;
                  r39.z = samp0[]..swiz;
                  r39.w = samp0[]..swiz;
                  // Known bad code for instruction (needs manual fix):
                                    ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r40.xyzw, r13.w, l(116), t12.xyzw
                  r40.x = samp0[]..swiz;
                  r40.y = samp0[]..swiz;
                  r40.z = samp0[]..swiz;
                  r40.w = samp0[]..swiz;
                    r26.w = abs(r20.w) * -0.200000003 + 0.400000006;
                    r18.xyz = r3.xyz * r26.www + v6.xyz;
                    r26.w = dot(r39.xyzw, r18.xyzw);
                    r28.w = dot(r40.xyzw, r18.xyzw);
                    r29.w = cmp(r28.w < r26.w);
                    if (r29.w == 0) {
                    // Known bad code for instruction (needs manual fix):
                                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r39.xyzw, r13.w, l(68), t12.xyzw
                    r39.x = samp0[]..swiz;
                    r39.y = samp0[]..swiz;
                    r39.z = samp0[]..swiz;
                    r39.w = samp0[]..swiz;
                    // Known bad code for instruction (needs manual fix):
                                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r40.xyzw, r13.w, l(84), t12.xyzw
                    r40.x = samp0[]..swiz;
                    r40.y = samp0[]..swiz;
                    r40.z = samp0[]..swiz;
                    r40.w = samp0[]..swiz;
                    // Known bad code for instruction (needs manual fix):
                                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r41.xyzw, r13.w, l(132), t12.xyzw
                    r41.x = samp0[]..swiz;
                    r41.y = samp0[]..swiz;
                    r41.z = samp0[]..swiz;
                    r41.w = samp0[]..swiz;
                    // Known bad code for instruction (needs manual fix):
                                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r42.xyzw, r13.w, l(148), t12.xyzw
                    r42.x = samp0[]..swiz;
                    r42.y = samp0[]..swiz;
                    r42.z = samp0[]..swiz;
                    r42.w = samp0[]..swiz;
                    // Known bad code for instruction (needs manual fix):
                                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r43.xy, r13.w, l(164), t12.xyxx
                    r43.x = samp0[]..swiz;
                    r43.y = samp0[]..swiz;
                      r39.x = dot(r39.xyzw, r18.xyzw);
                      r39.y = dot(r40.xyzw, r18.xyzw);
                      r18.xy = r39.xy / r28.ww;
                      r18.xy = r18.xy * float2(0.5,-0.5) + float2(0.5,0.5);
                      r18.xy = r18.xy + r42.zw;
                      r18.xy = r18.xy * r42.xy;
                      r39.xy = r15.zz / r41.xz;
                    ...
                    r13.w = samp0[]..swiz;
                      ...
                      if (r8.w != 0) {
                        ...
                        while (true) {
                          ...
                          r40.xy = r41.xy * r15.zz + r39.xy;
                          r26.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r40.xyz, r18.x).x;
                    ...
                    if (4 == 0) r13.w = 0; else if (4+20 < 32) {                     r13.w = (uint)r31.w << (32-(4 + 20)); r13.w = (uint)r13.w >> (32-4);                    } else r13.w = (uint)r31.w >> 20;
                    r15.z = cmp(0 < (uint)r13.w);
                    r15.z = r4.x ? r15.z : 0;
                    if (r15.z != 0) {
                      r13.w = (int)r13.w + numLights;
                    ...
                    r40.z = samp0[]..swiz;
                    r40.w = samp0[]..swiz;
                      r18.x = abs(r20.w) * -0.200000003 + 0.400000006;
                      r19.xyz = r3.xyz * r18.xxx + v6.xyz;
                  ...
                  r13.w = r13.w + -r24.w;
                  r13.w = r5.w * r13.w + r24.w;
                  r13.w = r13.w * r15.w;
                  r31.x = r30.x;
                  r15.z = cmp(0 < r20.w);
                  r19.xyz = r13.www * r31.xyz + r9.yzw;
                  r13.w = saturate(dot(r3.xyz, r38.xyz));
                  r37.xyz = r37.xyz * r12.www + r5.xyz;
                  r12.w = dot(r37.xyz, r37.xyz);
                  r12.w = rsqrt(r12.w);
                  r37.xyz = r37.xyz * r12.www;
                  r12.w = dot(r37.xyz, r5.xyz);
                  r18.x = dot(r3.xyz, r37.xyz);
                  r20.w = abs(r18.x) * r4.w + -abs(r18.x);
                  r18.x = abs(r18.x) * r20.w + 1;
                  r20.w = r13.w * r0.w + r3.w;
                  r18.x = r18.x * r18.x;
                  r18.x = r18.x * r20.w;
                  r18.x = rcp(r18.x);
                  r13.w = r13.w * r25.w;
                  r13.w = r18.x * r13.w;
                  r13.w = r13.w * r15.w;
                  r37.xyz = r13.www * r31.xyz + r29.xyz;
                  r12.w = saturate(1 + -r12.w);
                  r15.w = r12.w * r12.w;
                  r15.w = r15.w * r15.w;
                  r12.w = r15.w * r12.w;
                  r12.w = r13.w * r12.w;
                  r38.xyz = r12.www * r31.xyz + r16.xyz;
                  r9.yzw = r15.zzz ? r19.xyz : r9.yzw;
                  r16.xyz = r15.zzz ? r38.xyz : r16.xyz;
                  r29.xyz = r15.zzz ? r37.xyz : r29.xyz;
                }
              }
            }
            break;
            ...
            r12.w = rsqrt(r12.w);
            r37.xyz = r19.xyz * r12.www;
            r13.w = dot(r3.xyz, r37.xyz);
            r15.z = saturate(r13.w);
            r15.w = cmp(0 < r15.z);
            if (r15.w != 0) {
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r37.xyzw, r11.w, l(112), t12.yzwx
            r37.x = samp0[]..swiz;
            r37.y = samp0[]..swiz;
            r37.z = samp0[]..swiz;
            r37.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r38.xyzw, r11.w, l(128), t12.zxyw
            r38.x = samp0[]..swiz;
            r38.y = samp0[]..swiz;
            r38.z = samp0[]..swiz;
            r38.w = samp0[]..swiz;
              ...
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r41.xyzw, r11.w, l(172), t12.yzwx
              r41.x = samp0[]..swiz;
              r41.y = samp0[]..swiz;
              r41.z = samp0[]..swiz;
              r41.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r42.xyzw, r11.w, l(188), t12.wxyz
              r42.x = samp0[]..swiz;
              r42.y = samp0[]..swiz;
              r42.z = samp0[]..swiz;
              r42.w = samp0[]..swiz;
              // Known bad code for instruction (needs manual fix):
                            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r43.xyzw, r11.w, l(204), t12.xyzw
              r43.x = samp0[]..swiz;
              r43.y = samp0[]..swiz;
              r43.z = samp0[]..swiz;
              r43.w = samp0[]..swiz;
              ...
              r20.w = samp0[]..swiz;
                ...
                r24.w = r24.w / r25.w;
                r24.w = min(1, r24.w);
                r32.xy = saturate(r15.ww * r32.xz + r32.yw);
                ...
                r20.xy = r32.xy / r15.ww;
                r15.w = cmp(r41.w < 0.00048828125);
                if (r15.w != 0) {
                  r42.y = r43.x;
                ...
                if (r15.w != 0) {
                // Known bad code for instruction (needs manual fix):
                                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r32.xyz, r11.w, l(220), t12.xyzx
                r32.x = samp0[]..swiz;
                r32.y = samp0[]..swiz;
                r32.z = samp0[]..swiz;
                  r20.w = dot(r43.yzw, r20.xyz);
              ...
              r15.w = cmp(0 < r18.x);
              if (r15.w != 0) {
                if (3 == 0) r15.w = 0; else if (3+27 < 32) {                 r15.w = (uint)r31.w << (32-(3 + 27)); r15.w = (uint)r15.w >> (32-3);                } else r15.w = (uint)r31.w >> 27;
                r15.w = cmp((int)r15.w != 1);
                if (r15.w != 0) {
                  r15.w = abs(r13.w) * -0.200000003 + 0.400000006;
                  r21.xyz = r3.xyz * r15.www + v6.xyz;
                  r37.xyz = r36.xyz;
                  r15.w = dot(r37.xyzw, r21.xyzw);
                  r24.w = dot(r39.xyzw, r21.xyzw);
                  r25.w = cmp(r24.w >= r15.w);
                  if (r25.w != 0) {
                  // Known bad code for instruction (needs manual fix):
                                    ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r38.y, r11.w, l(144), t12.xxxx
                  r38.y = samp0[]..swiz;
                    r34.w = r35.x;
                    r30.x = dot(r34.xyzw, r21.xyzw);
                    r36.xyz = r35.yzw;
                    r30.y = dot(r36.xyzw, r21.xyzw);
                    r21.xy = r30.xy / r24.ww;
                    r21.xy = saturate(r21.xy * float2(0.5,-0.5) + float2(0.5,0.5));
                    r21.xy = r21.xy * r38.zw + r38.xy;
                    r11.w = r15.w / r24.w;
                    r11.w = max(6.10351563e-05, r11.w);
                    r15.w = (int)r31.w & 0x0000ffff;
                    if (r8.w != 0) {
                      r30.z = (uint)r15.w;
                      r24.w = 0;
                      r25.w = 0;
                      while (true) {
                        ...
                        if (r26.w != 0) break;
                        r32.x = dot(icb[r25.w+0].xy, r24.xy);
                        r32.y = dot(icb[r25.w+0].yx, r24.xz);
                        r30.xy = r32.xy * r33.yy + r21.xy;
                        r26.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r30.xyz, r11.w).x;
                        r24.w = r26.w * 0.125 + r24.w;
                        r25.w = (int)r25.w + 1;
                      }
                    } else {
                      r21.z = (uint)r15.w;
                      r24.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r21.xyz, r11.w).x;
                    }
                    r11.w = r24.w * r24.w;
                    r11.w = r11.w * r24.w;
                  } else {
                ...
                if (r15.w != 0) {
                  r15.w = r31.x * r4.w;
                  r15.w = r15.w * r15.z;
                  if (4 == 0) r18.x = 0; else if (4+16 < 32) {                   r18.x = (uint)r31.w << (32-(4 + 16)); r18.x = (uint)r18.x >> (32-4);                  } else r18.x = (uint)r31.w >> 16;
                  ...
                  r21.x = samp0[]..swiz;
                  // Known bad code for instruction (needs manual fix):
                                    ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r30.xyzw, r18.x, l(68), t12.xyzw
                  r30.x = samp0[]..swiz;
                  r30.y = samp0[]..swiz;
                  r30.z = samp0[]..swiz;
                  r30.w = samp0[]..swiz;
                  ...
                  r36.w = samp0[]..swiz;
                    ...
                    r22.x = samp0[]..swiz;
                    // Known bad code for instruction (needs manual fix):
                                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r30.xy, r18.x, l(164), t12.xyxx
                    r30.x = samp0[]..swiz;
                    r30.y = samp0[]..swiz;
                      ...
                      if (r8.w != 0) {
                        ...
                        while (true) {
                          r26.w = cmp((int)r25.w >= 8);
                          if (r26.w != 0) break;
                          r30.x = dot(icb[r25.w+0].xy, r25.xy);
                          r30.y = dot(icb[r25.w+0].yx, r25.xz);
                        ...
                        r31.z = (uint)r21.y;
                        r21.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r31.xyz, r18.x).x;
                      }
                      r18.x = r21.z * r21.z;
                      r18.x = r18.x * r21.z;
                    } else {
                    ...
                    r30.w = samp0[]..swiz;
                    // Known bad code for instruction (needs manual fix):
                                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r31.xyzw, r18.x, l(84), t12.xyzw
                    r31.x = samp0[]..swiz;
                    r31.y = samp0[]..swiz;
                    r31.z = samp0[]..swiz;
                    r31.w = samp0[]..swiz;
                    // Known bad code for instruction (needs manual fix):
                                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r32.xyzw, r18.x, l(100), t12.xyzw
                    r32.x = samp0[]..swiz;
                    r32.y = samp0[]..swiz;
                    r32.z = samp0[]..swiz;
                    r32.w = samp0[]..swiz;
                    // Known bad code for instruction (needs manual fix):
                                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r33.xyzw, r18.x, l(116), t12.xyzw
                    r33.x = samp0[]..swiz;
                    r33.y = samp0[]..swiz;
                    r33.z = samp0[]..swiz;
                    r33.w = samp0[]..swiz;
                    // Known bad code for instruction (needs manual fix):
                                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r34.xyzw, r18.x, l(132), t12.xyzw
                    r34.x = samp0[]..swiz;
                    r34.y = samp0[]..swiz;
                    r34.z = samp0[]..swiz;
                    r34.w = samp0[]..swiz;
                    // Known bad code for instruction (needs manual fix):
                                        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r35.xyzw, r18.x, l(148), t12.xyzw
                    r35.x = samp0[]..swiz;
                    r35.y = samp0[]..swiz;
                    r35.z = samp0[]..swiz;
                    r35.w = samp0[]..swiz;
                      r21.y = abs(r13.w) * -0.200000003 + 0.400000006;
                      r23.xyz = r3.xyz * r21.yyy + v6.xyz;
                      ...
                      r23.z = samp0[]..swiz;
                        ...
                        if (r8.w != 0) {
                          ...
                          r30.z = (uint)r21.y;
                          r23.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r30.xyz, r18.x).x;
                        }
                        r18.x = r23.x * r23.x;
                        r18.x = r18.x * r23.x;
                      } else {
                  ...
                  r18.x = r18.x + -r15.z;
                  r18.x = r5.w * r18.x + r15.z;
                  r18.x = r18.x * r11.w;
                  r13.w = cmp(0 < r13.w);
                  r22.xyz = r18.xxx * r20.xyw + r9.yzw;
                  r19.xyz = r19.xyz * r12.www + r5.xyz;
                  r12.w = dot(r19.xyz, r19.xyz);
                  r12.w = rsqrt(r12.w);
                  r19.xyz = r19.xyz * r12.www;
                  r12.w = dot(r19.xyz, r5.xyz);
                  r18.x = dot(r3.xyz, r19.xyz);
                  r19.x = abs(r18.x) * r4.w + -abs(r18.x);
                  r18.x = abs(r18.x) * r19.x + 1;
                  r15.z = r15.z * r0.w + r3.w;
                  r18.x = r18.x * r18.x;
                  r15.z = r18.x * r15.z;
                  r15.z = rcp(r15.z);
                  r15.z = r15.z * r15.w;
                  r11.w = r15.z * r11.w;
                  r11.w = 0.25 * r11.w;
                  r19.xyz = r11.www * r20.xyw + r29.xyz;
                  r12.w = saturate(1 + -r12.w);
                  r15.z = r12.w * r12.w;
                  r15.z = r15.z * r15.z;
                  r12.w = r15.z * r12.w;
                  r11.w = r12.w * r11.w;
                  r20.xyw = r11.www * r20.xyw + r16.xyz;
                  r9.yzw = r13.www ? r22.xyz : r9.yzw;
                  r16.xyz = r13.www ? r20.xyw : r16.xyz;
                  r29.xyz = r13.www ? r19.xyz : r29.xyz;
                }
              }
            }
            break;
