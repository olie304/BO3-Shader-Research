...
//   float alphaRevealSoftEdge;         // Offset:  204 Size:     4
//   float alphaRevealRamp;             // Offset:  208 Size:     4
//   float scriptControl;               // Offset:  212 Size:     4 [unused]
//
// }
//
...
mul r0.y, r0.y, r2.x
exp r4.y, r0.y
mad_sat r2.xy, cb0[12].wwww, r4.xyxx, r1.wwww
add r0.y, r0.z, -r2.x
add r0.z, -r2.x, r2.y
...
mad r0.xzw, r0.xxzw, r7.xxyz, r2.xxyz
...
mov o0.w, r0.y
ret 
// Approximately 2672 instruction slots used
