...
//   float hdrScale;                    // Offset:  192 Size:     4 [unused]
//   uint zFeatherComputeSprites;       // Offset:  196 Size:     4 [unused]
//   float desaturationAmount;          // Offset:  200 Size:     4 [unused]
...
if_nz r3.w
  ...
  add r2.z, r2.z, r2.w
  sample_l_indexable(texture2darray)(float,float,float,float) r2.w, r4.xyzx, t31.yzwx, s0, l(0.000000)
  mad r2.z, r2.z, l(0.250000), r2.w
  add_sat r3.x, r2.z, l(-1.000000)
endif 
