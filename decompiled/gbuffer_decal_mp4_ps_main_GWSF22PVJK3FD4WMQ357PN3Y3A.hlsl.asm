...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:27:47 2021
//
//
// Buffer Definitions: 
//
...
// yTexture                          texture  float4          2d             t7      1 
// cbcrTexture                       texture  float4          2d             t9      1 
...
sample_indexable(texture2d)(float,float,float,float) r0.w, r0.yzyy, t7.yzwx, s1
add r1.x, r0.w, l(-0.062500)
sample_indexable(texture2d)(float,float,float,float) r0.yz, r0.yzyy, t9.zxyw, s2
add r1.yz, r0.yyzy, l(0.000000, -0.500000, -0.500000, 0.000000)
dp2 r2.x, l(1.164400, 1.792700, 0.000000, 0.000000), r1.xzxx
dp3 r2.y, l(1.164400, -0.213300, -0.532900, 0.000000), r1.xyzx
dp2 r2.z, l(1.164400, 2.112400, 0.000000, 0.000000), r1.xyxx
ge r0.yzw, l(0.000000, 0.040450, 0.040450, 0.040450), r2.xxyz
mul r1.xyz, r2.xyzx, l(0.07739938, 0.07739938, 0.07739938, 0.000000)
