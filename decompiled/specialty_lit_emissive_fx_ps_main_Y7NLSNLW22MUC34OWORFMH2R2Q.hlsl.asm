  ...
  if_nz r7.w
    ...
    if_z cb0[26].y
      ...
      if_nz r10.y
        ...
        mad r19.xyz, r6.xyzx, r10.zzzz, v6.xyzx
          ...
          if_nz r25.w
            ...
            if_nz r25.w
              ...
              if_nz r25.w
                ...
                mad r41.xyz, r6.xyzx, r25.wwww, v6.xyzx
                ...
                loop 
                  ige r29.w, r28.w, l(8)
                  breakc_nz r29.w
                  dp2 r43.y, icb[r28.w + 0].yxyy, r10.xyxx
                  dp2 r43.z, icb[r28.w + 0].yxyy, r10.yzyy
              ...
              if_nz r25.w
                ...
                if_nz r15.w
                  ...
                  mad r18.xyz, r6.xyzx, r26.wwww, v6.xyzx
          ...
          if_nz r15.w
            ...
            if_nz r15.w
              ...
              if_nz r15.w
                ...
                lt r24.w, r15.z, l(0.000000)
                movc r15.w, r24.w, -r15.w, r15.w
                mad r21.xyz, r6.xyzx, r15.wwww, v6.xyzx
                mov r38.xyz, r37.xyzx
                dp4 r15.w, r38.xyzw, r21.xyzw
                ...
                if_nz r25.w
                  ...
                  if_nz r11.w
                    ...
                    loop 
                      ...
                      sample_c_lz_indexable(texture2darray)(float,float,float,float) r26.w, r31.xyzx, t9.xxxx, s13, r13.w
                      mad r24.w, r26.w, l(0.125000), r24.w
                      iadd r25.w, r25.w, l(1)
                    endloop 
                  else 
                    utof r21.z, r15.w
                    sample_c_lz_indexable(texture2darray)(float,float,float,float) r24.w, r21.xyzx, t9.xxxx, s13, r13.w
                  endif 
              ...
              if_nz r15.w
                ...
                if_nz r21.x
                  ...
                  mad r21.y, |r15.z|, l(-0.200000), l(0.400000)
                  lt r21.z, r15.z, l(0.000000)
                  movc r21.y, r21.z, -r21.y, r21.y
                  mad r22.xyz, r6.xyzx, r21.yyyy, v6.xyzx
                  ...
                  if_nz r21.x
                    ...
                    mad r21.y, |r15.z|, l(-0.200000), l(0.400000)
                    lt r22.x, r15.z, l(0.000000)
                    movc r21.y, r22.x, -r21.y, r21.y
                    mad r23.xyz, r6.xyzx, r21.yyyy, v6.xyzx
                ...
                mad r19.xyz, r13.wwww, r20.xywx, r30.xyzx
                add_sat r14.w, -r14.w, l(1.000000)
                mul r15.z, r14.w, r14.w
                mul r15.z, r15.z, r15.z
                mul r14.w, r14.w, r15.z
                mul r13.w, r13.w, r14.w
                mad r20.xyw, r13.wwww, r20.xyxw, r29.xyxz
...
mov o0.w, r1.z
ret 
// Approximately 2131 instruction slots used
