...
r0.y = samp0[]..swiz;
  ...
  r6.w = 1 + -r2.y;
  r6.w = 5 * r6.w;
  r13.yzw = -globalProbeConstants.data[0].xyz + r11.xyz;
  ...
  r12.w = 0;
  r15.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r12.xyzw, 6).xyz;
  ...
  if (r8.w != 0) {
    ...
    if (r8.w != 0) {
        ...
        if (r10.w == 0) {
          ...
          if (enableDitheredShadow != 0) {
            ...
            while (true) {
              ...
              if (r19.w != 0) break;
              r23.x = dot(icb[r18.y+0].yx, r21.xy);
              r23.y = dot(icb[r18.y+0].yx, r21.yz);
              r22.xy = r23.xy * lightConstantsCB[r9.w].data[3].yy + r20.xy;
              r19.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r22.xyz, r10.w).x;
              r14.w = r19.w * 0.125 + r14.w;
              r18.y = (int)r18.y + 1;
            }
          } else {
            r20.z = (uint)r12.w;
            r14.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r20.xyz, r10.w).x;
          }
          r9.w = r14.w * r14.w;
          r9.w = r9.w * r14.w;
        } else {
      ...
      r4.w = r2.z * r9.w + r4.w;
      r4.w = r4.w * r7.w;
      r20.xyz = r4.www * r19.xyz;
      r4.y = cmp(0 < r4.y);
      r20.xyz = r13.yzw * r5.xxx + r20.xyz;
      r13.yzw = -r11.xyz * r0.www + sunConstants.wldDir.xyz;
      r0.w = dot(r13.yzw, r13.yzw);
      r0.w = rsqrt(r0.w);
      r13.yzw = r13.yzw * r0.www;
      r0.w = dot(r13.yzw, r5.yzw);
      r5.x = dot(r12.xyz, r13.yzw);
      ...
      r4.z = r7.w * r4.z;
      r4.z = 0.25 * r4.z;
      r21.yzw = r4.zzz * r19.xyz + r15.xyz;
      r0.w = saturate(1 + -r0.w);
      r5.x = r0.w * r0.w;
      r5.x = r5.x * r5.x;
      r0.w = r5.x * r0.w;
      r0.w = r4.z * r0.w;
      r13.yzw = r0.www * r19.xyz + r18.xzw;
      r19.xyz = r4.www * r19.xyz + r17.zxy;
      r19.xyz = r3.zzz ? r19.yzx : 0;
      r20.w = r17.z;
      r16.w = r19.z;
      r16.xyzw = r4.yyyy ? r20.xyzw : r16.xyzw;
      r17.zw = r13.yz;
      r19.zw = r18.xz;
      r19.xyzw = r4.yyyy ? r17.xyzw : r19.xyzw;
      r21.x = r13.w;
      r15.w = r18.w;
      r15.xyzw = r4.yyyy ? r21.yzwx : r15.xyzw;
      if (r2.w != 0) {
      // Known bad code for instruction (needs manual fix):
  ...
  switch (r4.y) {
    case 4 :    if (r2.w != 0) {
      r19.yzw = lightConstantsCB[r0.x].data[0].xyz + eyeOffset.xyz;
      r19.x = 2;
      GBufferDiffuseColor[viewID].136 = u2.xyzw;
    }
    r4.y = (int)r0.w + 1;
    r4.z = cmp(0 < lightConstantsCB[r0.x].data[6].y);
    r19.xy = lightConstantsCB[r0.x].data[5].zw;
    r19.z = lightConstantsCB[r0.x].data[6].x;
    r13.yzw = -r19.xyz * float3(0.5,0.5,0.5) + lightConstantsCB[r0.x].data[0].xyz;
    r20.xyz = r13.yzw + -r11.xyz;
    r4.w = dot(r19.xyz, r20.xyz);
    r5.x = saturate(-r4.w / lightConstantsCB[r0.x].data[6].y);
    r21.xyz = r5.xxx * r19.xyz + r13.yzw;
    r21.xyz = r4.zzz ? r21.xyz : lightConstantsCB[r0.x].data[0].xyz;
      ...
      if (r10.w != 0) {
        ...
        if (r10.w != 0) {
          ...
          while (true) {
            ...
            r25.x = r25.y * r22.x;
            r25.w = r25.y * r21.x;
            r24.xyz = r21.yzw * r14.www + r25.xzw;
        ...
        if (r10.w != 0) {
          ...
          r13.yzw = r4.www * r19.xyz + r13.yzw;
          r13.yzw = r4.zzz ? r13.yzw : lightConstantsCB[r0.x].data[0].xyz;
          ...
          if (r5.x != 0) {
            ...
            r14.w = cmp(r8.w < 0);
            r14.w = r3.z ? r14.w : 0;
            r5.x = r14.w ? -r5.x : r5.x;
            r19.xyz = r12.xyz * r5.xxx + r11.xyz;
            r20.xyz = lightConstantsCB[r4.w].data[6].yzw;
            r20.w = lightConstantsCB[r4.w].data[7].x;
            r19.w = 1;
            r5.x = dot(r20.xyzw, r19.xyzw);
            ...
            if (r15.w == 0) {
              ...
              r19.xy = r20.xy / r14.ww;
              r19.xy = r19.xy * float2(0.5,-0.5) + float2(0.5,0.5);
              r20.x = lightConstantsCB[r4.w].data[9].w + r19.x;
              r20.y = lightConstantsCB[r4.w].data[10].x + r19.y;
              r19.xy = lightConstantsCB[r4.w].data[9].yz * r20.xy;
              r19.zw = lightConstantsCB[r4.w].data[3].yy / lightConstantsCB[r4.w].data[8].yw;
              ...
              if (r16.w == 0) {
                ...
                r20.x = r19.x * lightConstantsCB[r4.w].data[8].y + lightConstantsCB[r4.w].data[8].z;
                r20.y = r19.y * lightConstantsCB[r4.w].data[8].w + lightConstantsCB[r4.w].data[9].x;
            ...
            if (r14.w == 0) {
              ...
              if (enableDitheredShadow != 0) {
                ...
                while (true) {
                  r17.w = cmp((int)r16.w >= 8);
                  if (r17.w != 0) break;
                  r22.x = dot(icb[r16.w+0].yx, r19.xy);
                  r22.y = dot(icb[r16.w+0].yx, r19.yz);
                  r21.xy = r22.xy * lightConstantsCB[r4.w].data[3].yy + r20.xy;
                  r17.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r21.xyz, r5.x).x;
                  r15.w = r17.w * 0.125 + r15.w;
                  r16.w = (int)r16.w + 1;
                }
              } else {
          ...
          r5.x = cmp(0 < r8.w);
          r20.xyz = r4.www * r19.xyz + r16.xyz;
          r8.w = saturate(dot(r12.xyz, r14.xyz));
          r13.yzw = r13.yzw * r4.zzz + r5.yzw;
          r4.z = dot(r13.yzw, r13.yzw);
          r4.z = rsqrt(r4.z);
          r13.yzw = r13.yzw * r4.zzz;
          r4.z = dot(r13.yzw, r5.yzw);
          ...
          r8.w = r9.w * r8.w;
          r8.w = r8.w * r7.w;
          r13.yzw = r8.www * r19.xyz + r15.xyz;
          ...
          r19.xyz = r4.www * r19.xyz + r17.zxy;
          r19.xyz = r3.zzz ? r19.xyz : r17.zxy;
          r16.xyz = r5.xxx ? r20.xyz : r16.xyz;
          r17.xyz = r5.xxx ? r17.xyz : r19.yzx;
          r18.xzw = r5.xxx ? r14.xyz : r18.xzw;
          r15.xyz = r5.xxx ? r13.yzw : r15.xyz;
          if (r2.w != 0) {
          // Known bad code for instruction (needs manual fix):
    ...
    if (r8.w != 0) {
      ...
      if (r9.w != 0) {
        ...
        r10.w = r10.w / r12.w;
        r10.w = min(1, r10.w);
        r20.xy = saturate(r8.ww * lightConstantsCB[r0.x].data[2].xz + lightConstantsCB[r0.x].data[2].yw);
        ...
        if (r8.w != 0) {
          ...
          r12.w = lightConstantsCB[r0.x].data[12].y * r21.y + -1;
        ...
        if (r8.w != 0) {
          r20.z = 1;
          r10.w = dot(lightConstantsCB[r0.x].data[13].xyz, r20.xyz);
          r21.x = lightConstantsCB[r0.x].data[13].w;
          r21.yz = lightConstantsCB[r0.x].data[14].xy;
          r11.w = dot(r21.xyz, r20.xyz);
          r20.x = frac(r10.w);
          r20.y = frac(r11.w);
          r8.w = (int)r8.w + -1;
          r20.z = (uint)r8.w;
      ...
      if (r8.w != 0) {
        ...
        if (r8.w != 0) {
          ...
          if (r12.w != 0) {
            ...
            r20.x = r19.x * lightConstantsCB[r0.x].data[8].y + lightConstantsCB[r0.x].data[8].z;
            r20.y = r19.y * lightConstantsCB[r0.x].data[8].w + lightConstantsCB[r0.x].data[9].x;
            r8.w = r8.w / r11.w;
        ...
        if (r9.w != 0) {
          ...
          if (r12.w != 0) {
            ...
            r19.xyz = r12.xyz * r12.www + r11.xyz;
            r20.xyz = lightConstantsCB[r11.w].data[6].yzw;
            r20.w = lightConstantsCB[r11.w].data[7].x;
            r19.w = 1;
            r12.w = dot(r20.xyzw, r19.xyzw);
            r20.xyz = lightConstantsCB[r11.w].data[7].yzw;
            r20.w = lightConstantsCB[r11.w].data[8].x;
            r14.w = dot(r20.xyzw, r19.xyzw);
            r15.w = cmp(r14.w < r12.w);
            if (r15.w == 0) {
              r20.xyz = lightConstantsCB[r11.w].data[4].yzw;
              r20.w = lightConstantsCB[r11.w].data[5].x;
              r20.x = dot(r20.xyzw, r19.xyzw);
              r21.xyz = lightConstantsCB[r11.w].data[5].yzw;
              r21.w = lightConstantsCB[r11.w].data[6].x;
              r20.y = dot(r21.xyzw, r19.xyzw);
              r19.xy = r20.xy / r14.ww;
              r19.xy = r19.xy * float2(0.5,-0.5) + float2(0.5,0.5);
              r20.x = lightConstantsCB[r11.w].data[9].w + r19.x;
              r20.y = lightConstantsCB[r11.w].data[10].x + r19.y;
              r19.xy = lightConstantsCB[r11.w].data[9].yz * r20.xy;
              ...
              if (r16.w == 0) {
                r19.xy = saturate(r19.xy);
                r20.x = r19.x * lightConstantsCB[r11.w].data[8].y + lightConstantsCB[r11.w].data[8].z;
                r20.y = r19.y * lightConstantsCB[r11.w].data[8].w + lightConstantsCB[r11.w].data[9].x;
            ...
            if (r14.w == 0) {
              ...
              if (enableDitheredShadow != 0) {
                ...
                while (true) {
                  ...
                  r22.x = dot(icb[r16.w+0].yx, r19.xy);
                  r22.y = dot(icb[r16.w+0].yx, r19.yz);
                  r21.xy = r22.xy * lightConstantsCB[r11.w].data[3].yy + r20.xy;
                  r17.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r21.xyz, r12.w).x;
                  r15.w = r17.w * 0.125 + r15.w;
                  r16.w = (int)r16.w + 1;
                }
              } else {
                r20.z = (uint)r14.w;
                r15.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r20.xyz, r12.w).x;
              }
              r11.w = r15.w * r15.w;
              r11.w = r11.w * r15.w;
            } else {
            ...
            if (r1.z != 0) {
              ...
              r19.xyz = r12.xyz * r1.zzz + r11.xyz;
              ...
              if (r12.w == 0) {
                ...
                if (r14.w == 0) {
                  ...
                  r20.x = r19.x * lightConstantsCB[r0.x].data[8].y + lightConstantsCB[r0.x].data[8].z;
                  r20.y = r19.y * lightConstantsCB[r0.x].data[8].w + lightConstantsCB[r0.x].data[9].x;
                  r15.w = lightConstantsCB[r0.x].data[10].z * r11.w;
              ...
              if (r11.w == 0) {
                ...
                if (enableDitheredShadow != 0) {
                  ...
                  while (true) {
                    ...
                    r21.xy = r22.xy * lightConstantsCB[r0.x].data[3].yy + r20.xy;
                    r13.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r21.xyz, r1.z).x;
          ...
          r0.x = r0.x * r8.w;
          r1.z = cmp(0 < r4.w);
          r19.xyz = r0.xxx * r13.yzw + r16.xyz;
          ...
          r1.w = r8.w * r1.w;
          r1.w = 0.25 * r1.w;
          r4.xzw = r1.www * r13.yzw + r15.xyz;
          r2.x = saturate(1 + -r2.x);
          r2.y = r2.x * r2.x;
          r2.y = r2.y * r2.y;
          r2.x = r2.x * r2.y;
          r1.w = r2.x * r1.w;
          r2.xyz = r1.www * r13.yzw + r18.xzw;
          r5.xyz = r0.xxx * r13.yzw + r17.zxy;
          r5.xyz = r3.zzz ? r5.xyz : r17.zxy;
          r16.xyz = r1.zzz ? r19.xyz : r16.xyz;
          r17.xyz = r1.zzz ? r17.xyz : r5.yzx;
          r18.xzw = r1.zzz ? r2.xyz : r18.xzw;
          r15.xyz = r1.zzz ? r4.xzw : r15.xyz;
          if (r2.w != 0) {
          // Known bad code for instruction (needs manual fix):
  ...
  r3.xyw = float3(0.959999979,0.959999979,0.959999979) * r18.xzw;
  r3.xyw = r15.xyz * float3(0.0399999991,0.0399999991,0.0399999991) + r3.xyw;
  r2.xyz = r3.xyw + r2.xyz;
  r3.xyw = float3(1,1,1) + -r4.xyz;
  r3.xyw = r18.xzw * r3.xyw;
  r3.xyw = r15.xyz * r4.xyz + r3.xyw;
