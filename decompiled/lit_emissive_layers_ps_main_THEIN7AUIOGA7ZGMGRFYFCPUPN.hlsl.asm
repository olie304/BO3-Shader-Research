...
if_nz cb0[18].w
  ...
  sample_indexable(texture2d)(float,float,float,float) r3.xyz, v1.yzyy, t37.xyzw, s1
...
mov r11.x, cb0[17].x
sample_l_indexable(texture2d)(float,float,float,float) r2.w, r11.xyxx, t30.yzwx, s7, l(0.000000)
log r2.w, |r2.w|
...
sample_indexable(texture2d)(float,float,float,float) r11.xyzw, r11.xyxx, t46.xyzw, s1
...
mov r12.x, cb0[26].y
sample_l_indexable(texture2d)(float,float,float,float) r2.w, r12.xyxx, t30.yzwx, s7, l(0.000000)
log r2.w, |r2.w|
...
sample_indexable(texture2d)(float,float,float,float) r4.xyzw, r11.xyxx, t47.xyzw, s1
...
mov r1.x, cb0[33].y
sample_l_indexable(texture2d)(float,float,float,float) r1.x, r1.xyxx, t30.xyzw, s7, l(0.000000)
log r1.x, |r1.x|
...
ret 
// Approximately 2855 instruction slots used
