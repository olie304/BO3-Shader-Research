...
sample_indexable(texture2d)(float,float,float,float) r2.w, r0.zwzz, t38.yzwx, s7
if_nz r2.z
  ...
  add r2.z, -cb0[14].x, cb0[14].y
  mad r2.z, r2.w, r2.z, cb0[14].x
...
mad r2.z, r4.w, cb0[12].z, r2.z
lt r3.w, l(0.000000), r2.w
sample_indexable(texture2d)(float,float,float,float) r4.xyz, r0.zwzz, t37.xyzw, s7
if_nz r3.w
  ...
  mad r0.zw, r4.xxxy, l(0.000000, 0.000000, 1.99218750, 1.99218750), l(0.000000, 0.000000, -1.000000, -1.000000)
  mul r3.w, r4.z, r4.z
  mul r3.w, r3.w, l(0.33333334)
  min r3.w, r3.w, l(1.000000)
  mad r3.xy, r0.zwzz, r2.wwww, r3.xyxx
...
mad r2.x, cb1[62].x, r2.y, cb0[12].x
mul_sat r2.x, r2.x, l(0.05882353)
...
if_nz r2.y
  ...
  movc r1.xyz, r2.zzzz, r4.xywx, r5.xyzx
endif 
add r2.yzw, -r1.xxyz, cb1[58].xxyz
mad r1.xyz, cb1[58].wwww, r2.yzwy, r1.xyzx
add r2.y, -r1.w, cb1[59].x
mad r1.w, cb1[59].w, r2.y, r1.w
add r2.x, -r0.w, r2.x
mad r0.w, cb1[62].w, r2.x, r0.w
...
if_z r3.w
  ...
  if_nz r2.z
    ...
    lt r10.xyz, l(0.000000, 0.000000, 0.000000, 0.000000), r1.xyzx
    ...
    mad r18.xyz, r20.xyzx, r0.yyyy, r1.xyzx
    mov r11.w, l(0)
    ...
    mad r19.xyz, r1.xyzx, r0.yyyy, r19.xyzx
  endif 
else 
  mov r19.x, r18.w
endif 
mad r1.xyz, r18.xyzx, r5.xyzx, r6.xyzx
mad r5.xyz, r18.xyzx, r5.xyzx, r7.xyzx
...
mad r2.xyz, r19.xyzx, r0.yyyy, r4.xyzx
mad r4.xyz, r19.xyzx, r0.wwww, r8.xyzx
...
mul o2.w, r0.x, r0.z
ret 
// Approximately 3946 instruction slots used
