...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  r4.xyz = debugSpecularOverride.xyz + -r1.xyz;
  r1.xyz = debugSpecularOverride.www * r4.xyz + r1.xyz;
  r0.w = r2.y + -r2.x;
  r2.y = debugGlossOverride.w * r0.w + r2.x;
  r0.w = debugOcclusionOverride.x + -r1.w;
  r0.w = debugOcclusionOverride.w * r0.w + r1.w;
  r4.xyz = v6.xxx ? v2.xyz : -v2.xyz;
  r1.w = dot(r4.xyz, r4.xyz);
  r1.w = rsqrt(r1.w);
  r4.xyz = r4.xyz * r1.www + -r3.xzw;
  ...
  if (r1.w == 0) {
    ...
    if (r2.z != 0) {
      ...
      r19.xyz = r21.xyz * r1.www + r8.yzw;
      r10.w = 0;
      r8.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r10.xyzw, r6.z).xyz;
      r1.w = sunConstants.globalProbeExposure * r2.z + -r2.w;
      r1.w = r2.y * r1.w + r2.w;
