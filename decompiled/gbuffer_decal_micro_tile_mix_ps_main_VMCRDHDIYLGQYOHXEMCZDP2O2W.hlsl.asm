...
mad r1.x, r3.w, r1.x, cb0[12].x
add r1.y, -cb0[15].x, cb0[15].y
mad r1.y, r1.z, r1.y, cb0[15].x
mul_sat r1.xy, r1.xyxx, l(0.05882353, 0.05882353, 0.000000, 0.000000)
add r1.y, -r1.x, r1.y
mad r1.x, r0.w, r1.y, r1.x
sample_indexable(texture2d)(float,float,float,float) r6.z, r0.yzyy, t14.yzxw, s5
mad r0.yz, r8.xxyx, l(0.000000, 1.99218750, 1.99218750, 0.000000), l(0.000000, -1.000000, -1.000000, 0.000000)
mul r1.y, r8.z, r8.z
mul r1.xy, r1.xyxx, l(-17.000000, 0.33333334, 0.000000, 0.000000)
min r1.y, r1.y, l(1.000000)
mad r3.xy, r4.xyxx, cb0[13].xxxx, r2.xyxx
dp3 r1.z, r3.xyzx, r3.xyzx
rsq r1.z, r1.z
mul r7.xyz, r1.zzzz, r3.xyzx
mad r7.w, r4.z, cb0[13].x, r1.w
mad r3.xy, r0.yzyy, cb0[13].yyyy, r2.xyxx
dp3 r0.y, r3.xyzx, r3.xyzx
rsq r0.y, r0.y
mul r2.xyz, r0.yyyy, r3.xyzx
mad r2.w, r1.y, cb0[13].y, r1.w
add r2.xyzw, -r7.xyzw, r2.xyzw
mad r2.xyzw, r0.wwww, r2.xyzw, r7.xyzw
...
mad r1.yzw, r1.yyzw, r2.xxxx, r3.xxyz
mad r0.yzw, r0.yyzw, r2.zzzz, r1.yyzw
dp3 r1.y, r0.yzwy, r0.yzwy
rsq r1.y, r1.y
mul r0.yzw, r0.yyzw, r1.yyyy
mul o0.xyz, r0.xxxx, r5.xyzx
ftou r2.xy, v0.xyxx
mov r2.zw, l(0,0,0,0)
ld_indexable(texture2d)(float,float,float,float) r1.yz, r2.xyzw, t6.xzwy
lt r1.w, l(0.000000), r1.y
mad r1.z, r1.z, l(3.000000), l(0.500000)
ftou r1.z, r1.z
and r2.xyzw, r1.zzzz, l(2, 1, 2, 1)
movc r2.xyzw, r2.zwxy, l(-0.57735026,-0.57735026,1,1), l(0.57735026,0.57735026,0,0)
xor r1.z, r2.w, r2.z
movc r2.z, r1.z, l(-0.57735026), l(0.57735026)
...
ge r0.y, r1.y, l(0.500000)
movc r0.y, r0.y, l(0.500000), l(0.00146628)
mad r2.z, r1.x, l(0.49755621), r0.y
and r0.yzw, r1.wwww, r2.xxyz
mul o1.xyz, r0.xxxx, r0.yzwy
mov r6.xyw, l(0.040000,0.500000,0,1.000000)
mul o2.xyzw, r0.xxxx, r6.xyzw
mov o0.w, r0.x
mov o1.w, r0.x
ret 
