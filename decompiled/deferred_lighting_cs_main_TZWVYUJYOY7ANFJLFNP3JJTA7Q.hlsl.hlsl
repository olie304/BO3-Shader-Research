...
r0.y = samp0[]..swiz;
  ...
  r13.w = cmp((uint)r0.x >= (uint)r13.z);
  r15.x = cmp((uint)r0.x < numRefProbes);
  r13.w = r13.w ? r15.x : 0;
  if (r13.w != 0) {
    r13.w = (int)r0.x * 14;
    if (r3.y != 0) {
      r15.yzw = refProbeConstantsCB[r13.w].data[0].xyz + eyeOffset.xyz;
      r15.x = 16;
      GBufferDiffuseColor[viewID].880 = u2.xyzw;
    }
    r15.xyz = -refProbeConstantsCB[r13.w].data[0].xyz + r5.xyz;
    r15.w = 0x0000ffff & (int)refProbeConstantsCB[r13.w].data[7].z;
    if (6 == 0) r16.x = 0; else if (6+25 < 32) {     r16.x = (uint)refProbeConstantsCB[r13.w].data[7].z << (32-(6 + 25)); r16.x = (uint)r16.x >> (32-6);    } else r16.x = (uint)refProbeConstantsCB[r13.w].data[7].z >> 25;
    r16.y = (int)r15.w * 6;
    r16.z = dot(refProbeAttenuationConstantsCB[r16.y].data[0].xyz, r15.xyz);
    r16.z = saturate(refProbeAttenuationConstantsCB[r16.y].data[0].w + r16.z);
    r16.w = dot(refProbeAttenuationConstantsCB[r16.y].data[1].xyz, r15.xyz);
    r16.w = saturate(refProbeAttenuationConstantsCB[r16.y].data[1].w + r16.w);
    r16.z = r16.z * r16.w;
    r16.w = dot(refProbeAttenuationConstantsCB[r16.y].data[2].xyz, r15.xyz);
    r16.w = saturate(refProbeAttenuationConstantsCB[r16.y].data[2].w + r16.w);
    r16.z = r16.z * r16.w;
    r16.w = dot(refProbeAttenuationConstantsCB[r16.y].data[3].xyz, r15.xyz);
    r16.w = saturate(refProbeAttenuationConstantsCB[r16.y].data[3].w + r16.w);
    r16.z = r16.z * r16.w;
    r16.w = dot(refProbeAttenuationConstantsCB[r16.y].data[4].xyz, r15.xyz);
    r16.w = saturate(refProbeAttenuationConstantsCB[r16.y].data[4].w + r16.w);
    r16.z = r16.z * r16.w;
    r16.w = dot(refProbeAttenuationConstantsCB[r16.y].data[5].xyz, r15.xyz);
    r16.y = saturate(refProbeAttenuationConstantsCB[r16.y].data[5].w + r16.w);
    r17.x = r16.z * r16.y;
    r16.y = 1 & (int)refProbeConstantsCB[r13.w].data[6].x;
    r17.yz = float2(0,1);
    r16.yz = r16.yy ? r17.xy : r17.zx;
    r17.x = 1;
    r16.w = refProbeConstantsCB[r13.w].data[6].x;
    r18.xy = r16.yz;
    r17.z = 1;
    while (true) {
      ...
      r17.w = (int)r17.w * 6;
      r18.z = dot(refProbeAttenuationConstantsCB[r17.w].data[0].xyz, r15.xyz);
      r18.z = saturate(refProbeAttenuationConstantsCB[r17.w].data[0].w + r18.z);
      r18.z = r18.x * r18.z;
      r18.w = dot(refProbeAttenuationConstantsCB[r17.w].data[1].xyz, r15.xyz);
      r18.w = saturate(refProbeAttenuationConstantsCB[r17.w].data[1].w + r18.w);
      r18.z = r18.z * r18.w;
      r18.w = dot(refProbeAttenuationConstantsCB[r17.w].data[2].xyz, r15.xyz);
      r18.w = saturate(refProbeAttenuationConstantsCB[r17.w].data[2].w + r18.w);
      r18.z = r18.z * r18.w;
      r18.w = dot(refProbeAttenuationConstantsCB[r17.w].data[3].xyz, r15.xyz);
      r18.w = saturate(refProbeAttenuationConstantsCB[r17.w].data[3].w + r18.w);
      r18.z = r18.z * r18.w;
      r18.w = dot(refProbeAttenuationConstantsCB[r17.w].data[4].xyz, r15.xyz);
      r18.w = saturate(refProbeAttenuationConstantsCB[r17.w].data[4].w + r18.w);
      r18.z = r18.z * r18.w;
      r18.w = dot(refProbeAttenuationConstantsCB[r17.w].data[5].xyz, r15.xyz);
      r17.w = saturate(refProbeAttenuationConstantsCB[r17.w].data[5].w + r18.w);
      r18.x = r18.z * r17.w;
      r18.w = (uint)r16.w >> 2;
      if (1 == 0) r19.x = 0; else if (1+2 < 32) {       r19.x = (uint)r16.w << (32-(1 + 2)); r19.x = (uint)r19.x >> (32-1);      } else r19.x = (uint)r16.w >> 2;
      r19.y = (int)r18.w & 2;
    ...
    r15.w = refProbeConstantsCB[r13.w].data[6].y * r18.y;
    r16.x = cmp(0 < r15.w);
    if (r16.x != 0) {
      if (r3.y != 0) {
      // Known bad code for instruction (needs manual fix):
      ...
      r16.x = refProbeConstantsCB[r13.w].data[7].y * r15.w;
      r17.x = refProbeConstantsCB[r13.w].data[7].w;
      r17.yz = refProbeConstantsCB[r13.w].data[8].xy;
      r16.y = dot(r14.xyz, r17.xyz);
      r16.z = dot(r15.xyz, r17.xyz);
      r16.z = -refProbeConstantsCB[r13.w].data[8].z + r16.z;
      r16.w = cmp(r16.z >= 0);
      r16.z = max(abs(r16.z), r12.w);
      r16.z = r16.w ? r16.z : -r16.z;
      r16.y = max(1.00000001e-07, -r16.y);
      r16.y = r16.z / r16.y;
      r16.y = min(131072, abs(r16.y));
      r17.x = refProbeConstantsCB[r13.w].data[8].w;
      r17.yz = refProbeConstantsCB[r13.w].data[9].xy;
      r16.z = dot(r14.xyz, r17.xyz);
      r16.w = dot(r15.xyz, r17.xyz);
      r16.w = -refProbeConstantsCB[r13.w].data[9].z + r16.w;
      r17.x = cmp(r16.w >= 0);
      ...
      r17.x = refProbeConstantsCB[r13.w].data[9].w;
      r17.yz = refProbeConstantsCB[r13.w].data[10].xy;
      r16.z = dot(r14.xyz, r17.xyz);
      r16.w = dot(r15.xyz, r17.xyz);
      r16.w = -refProbeConstantsCB[r13.w].data[10].z + r16.w;
      r17.x = cmp(r16.w >= 0);
      r16.w = max(abs(r16.w), r12.w);
      r16.w = r17.x ? r16.w : -r16.w;
      r16.z = max(1.00000001e-07, -r16.z);
      r16.z = r16.w / r16.z;
      r16.y = min(r16.y, abs(r16.z));
      r17.x = refProbeConstantsCB[r13.w].data[10].w;
      r17.yz = refProbeConstantsCB[r13.w].data[11].xy;
      r16.z = dot(r14.xyz, r17.xyz);
      r16.w = dot(r15.xyz, r17.xyz);
      r16.w = -refProbeConstantsCB[r13.w].data[11].z + r16.w;
      r17.x = cmp(r16.w >= 0);
      r16.w = max(abs(r16.w), r12.w);
      r16.w = r17.x ? r16.w : -r16.w;
      r16.z = max(1.00000001e-07, -r16.z);
      r16.z = r16.w / r16.z;
      r16.y = min(r16.y, abs(r16.z));
      r17.x = refProbeConstantsCB[r13.w].data[11].w;
      r17.yz = refProbeConstantsCB[r13.w].data[12].xy;
      r16.z = dot(r14.xyz, r17.xyz);
      r16.w = dot(r15.xyz, r17.xyz);
      r16.w = -refProbeConstantsCB[r13.w].data[12].z + r16.w;
      r17.x = cmp(r16.w >= 0);
      r16.w = max(abs(r16.w), r12.w);
      r16.w = r17.x ? r16.w : -r16.w;
      r16.z = max(1.00000001e-07, -r16.z);
      r16.z = r16.w / r16.z;
      r16.y = min(r16.y, abs(r16.z));
      r17.x = refProbeConstantsCB[r13.w].data[12].w;
      r17.yz = refProbeConstantsCB[r13.w].data[13].xy;
      r16.z = dot(r14.xyz, r17.xyz);
      r16.w = dot(r15.xyz, r17.xyz);
      r16.w = -refProbeConstantsCB[r13.w].data[13].z + r16.w;
      r17.x = cmp(r16.w >= 0);
      r16.w = max(abs(r16.w), r12.w);
      r16.w = r17.x ? r16.w : -r16.w;
      r16.z = max(1.00000001e-07, -r16.z);
      r16.z = r16.w / r16.z;
      r16.y = min(r16.y, abs(r16.z));
      r17.x = refProbeConstantsCB[r13.w].data[3].w + r15.x;
      r17.yz = refProbeConstantsCB[r13.w].data[4].xy + r15.yz;
      r17.xyz = r14.xyz * r16.yyy + r17.xyz;
      ...
      r18.x = refProbeConstantsCB[r13.w].data[0].w;
      r18.y = refProbeConstantsCB[r13.w].data[1].z;
      r18.z = refProbeConstantsCB[r13.w].data[2].y;
      r19.x = dot(r17.xyz, r18.xyz);
      r20.xy = refProbeConstantsCB[r13.w].data[1].xw;
      r20.z = refProbeConstantsCB[r13.w].data[2].z;
      r19.y = dot(r17.xyz, r20.xyz);
      r21.x = refProbeConstantsCB[r13.w].data[1].y;
      r21.yz = refProbeConstantsCB[r13.w].data[2].xw;
      r19.z = dot(r17.xyz, r21.xyz);
      if (9 == 0) r16.z = 0; else if (9+16 < 32) {       r16.z = (uint)refProbeConstantsCB[r13.w].data[7].z << (32-(9 + 16)); r16.z = (uint)r16.z >> (32-9);      } else r16.z = (uint)refProbeConstantsCB[r13.w].data[7].z >> 16;
      r19.w = (uint)r16.z;
      r16.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r19.xyzw, r16.y).xyz;
      r17.xyz = (int3)r16.yzw & int3(-2147483648,-2147483648,-2147483648);
      ...
      r17.x = dot(r15.xyz, r18.xyz);
      r17.y = dot(r15.xyz, r20.xyz);
      r17.z = dot(r15.xyz, r21.xyz);
      r15.xyz = saturate(r17.xyz * refProbeConstantsCB[r13.w].data[3].xyz + float3(0.5,0.5,0.5));
      r17.xy = refProbeConstantsCB[r13.w].data[4].zw * r15.xy;
      r17.z = refProbeConstantsCB[r13.w].data[5].x * r15.z;
      r15.xyz = refProbeConstantsCB[r13.w].data[5].yzw + r17.xyz;
      r19.x = dot(r11.xyz, r18.xyz);
      r19.y = dot(r11.xyz, r20.xyz);
      r19.z = dot(r11.xyz, r21.xyz);
      r17.xyz = cmp(float3(0,0,0) < r19.xyz);
      r18.z = r17.x ? 0 : 0.5;
      r18.xy = float2(0,0);
      ...
      r17.xyw = r18.xyz * r20.xxx + r17.xyw;
      r18.z = r17.z ? 0 : 0.5;
      r18.xy = float2(0,0);
      ...
      r17.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r19.xyzw, 6).xyz;
      ...
      r17.x = r13.y * r13.w;
      r16.xyz = r16.yzw * r16.xxx;
      r16.w = dot(r16.xyz, float3(0.212599993,0.715200007,0.0722000003));
      r13.w = r13.y * r13.w + r16.w;
      r13.w = r17.x / r13.w;
  ...
  r13.z = cmp((uint)r0.x < (uint)r13.z);
  if (r13.z != 0) {
    r0.x = (int)r0.x * 14;
    if (r3.y != 0) {
      r13.z = (int)r13.w & 1;
    ...
    r16.w = 0x0000ffff & (int)refProbeConstantsCB[r0.x].data[7].z;
    if (6 == 0) r17.w = 0; else if (6+25 < 32) {     r17.w = (uint)refProbeConstantsCB[r0.x].data[7].z << (32-(6 + 25)); r17.w = (uint)r17.w >> (32-6);    } else r17.w = (uint)refProbeConstantsCB[r0.x].data[7].z >> 25;
    r18.x = (int)r16.w * 6;
    r18.y = dot(refProbeAttenuationConstantsCB[r18.x].data[0].xyz, r17.xyz);
    r18.y = saturate(refProbeAttenuationConstantsCB[r18.x].data[0].w + r18.y);
    r18.z = dot(refProbeAttenuationConstantsCB[r18.x].data[1].xyz, r17.xyz);
    r18.z = saturate(refProbeAttenuationConstantsCB[r18.x].data[1].w + r18.z);
    r18.y = r18.y * r18.z;
    r18.z = dot(refProbeAttenuationConstantsCB[r18.x].data[2].xyz, r17.xyz);
    r18.z = saturate(refProbeAttenuationConstantsCB[r18.x].data[2].w + r18.z);
    r18.y = r18.y * r18.z;
    r18.z = dot(refProbeAttenuationConstantsCB[r18.x].data[3].xyz, r17.xyz);
    r18.z = saturate(refProbeAttenuationConstantsCB[r18.x].data[3].w + r18.z);
    r18.y = r18.y * r18.z;
    r18.z = dot(refProbeAttenuationConstantsCB[r18.x].data[4].xyz, r17.xyz);
    r18.z = saturate(refProbeAttenuationConstantsCB[r18.x].data[4].w + r18.z);
    r18.y = r18.y * r18.z;
    r18.z = dot(refProbeAttenuationConstantsCB[r18.x].data[5].xyz, r17.xyz);
    r18.x = saturate(refProbeAttenuationConstantsCB[r18.x].data[5].w + r18.z);
    r18.x = r18.y * r18.x;
    r18.w = 1 & (int)refProbeConstantsCB[r0.x].data[6].x;
    r18.yz = float2(0,1);
    r18.xy = r18.ww ? r18.xy : r18.zx;
    r19.x = 1;
    r18.z = refProbeConstantsCB[r0.x].data[6].x;
    r20.xy = r18.xy;
    r18.w = 1;
    while (true) {
      r19.z = cmp((int)r18.w >= (int)r17.w);
      if (r19.z != 0) break;
      r19.z = (int)r16.w + (int)r18.w;
      r19.z = (int)r19.z * 6;
      r19.w = dot(refProbeAttenuationConstantsCB[r19.z].data[0].xyz, r17.xyz);
      r19.w = saturate(refProbeAttenuationConstantsCB[r19.z].data[0].w + r19.w);
      r19.w = r20.x * r19.w;
      r20.z = dot(refProbeAttenuationConstantsCB[r19.z].data[1].xyz, r17.xyz);
      r20.z = saturate(refProbeAttenuationConstantsCB[r19.z].data[1].w + r20.z);
      r19.w = r20.z * r19.w;
      r20.z = dot(refProbeAttenuationConstantsCB[r19.z].data[2].xyz, r17.xyz);
      r20.z = saturate(refProbeAttenuationConstantsCB[r19.z].data[2].w + r20.z);
      r19.w = r20.z * r19.w;
      r20.z = dot(refProbeAttenuationConstantsCB[r19.z].data[3].xyz, r17.xyz);
      r20.z = saturate(refProbeAttenuationConstantsCB[r19.z].data[3].w + r20.z);
      r19.w = r20.z * r19.w;
      r20.z = dot(refProbeAttenuationConstantsCB[r19.z].data[4].xyz, r17.xyz);
      r20.z = saturate(refProbeAttenuationConstantsCB[r19.z].data[4].w + r20.z);
      r19.w = r20.z * r19.w;
      r20.z = dot(refProbeAttenuationConstantsCB[r19.z].data[5].xyz, r17.xyz);
      ...
      r21.x = (int)r20.z & 2;
      r21.y = max(r20.y, r20.x);
      r19.z = -r19.w * r19.z + 1;
      r19.z = r20.y * r19.z;
      r19.y = r21.x ? r19.z : r21.y;
      r20.xy = r20.ww ? r20.xy : r19.xy;
      r18.w = (int)r18.w + 1;
      r18.z = r20.z;
    }
    r16.w = saturate(r20.y + -r15.w);
    r17.w = refProbeConstantsCB[r0.x].data[6].y * r16.w;
    r18.x = cmp(0 < r17.w);
    if (r18.x != 0) {
      r18.x = (int)r13.z & 3;
      r18.y = (int)r18.x + -1;
      ...
      r18.y = r3.y ? r18.y : 0;
      if (r18.y != 0) {
        r18.xy = mad((int2)r18.xx, int2(20,20), int2(860,876));
      // Known bad code for instruction (needs manual fix):
      ...
      r13.z = (int)r13.w + 257;
      r16.w = r16.w * refProbeConstantsCB[r0.x].data[6].y + r15.w;
      r17.w = refProbeConstantsCB[r0.x].data[7].y * r17.w;
      r18.x = refProbeConstantsCB[r0.x].data[7].w;
      r18.yz = refProbeConstantsCB[r0.x].data[8].xy;
      r18.w = dot(r14.xyz, r18.xyz);
      r18.x = dot(r17.xyz, r18.xyz);
      r18.x = -refProbeConstantsCB[r0.x].data[8].z + r18.x;
      r18.y = cmp(r18.x >= 0);
      r18.x = max(abs(r18.x), r12.w);
      r18.x = r18.y ? r18.x : -r18.x;
      r18.y = max(1.00000001e-07, -r18.w);
      r18.x = r18.x / r18.y;
      r18.x = min(131072, abs(r18.x));
      r19.x = refProbeConstantsCB[r0.x].data[8].w;
      r19.yz = refProbeConstantsCB[r0.x].data[9].xy;
      r18.y = dot(r14.xyz, r19.xyz);
      r18.z = dot(r17.xyz, r19.xyz);
      r18.z = -refProbeConstantsCB[r0.x].data[9].z + r18.z;
      r18.w = cmp(r18.z >= 0);
      r18.z = max(abs(r18.z), r12.w);
      r18.z = r18.w ? r18.z : -r18.z;
      r18.y = max(1.00000001e-07, -r18.y);
      r18.y = r18.z / r18.y;
      r18.x = min(r18.x, abs(r18.y));
      r19.x = refProbeConstantsCB[r0.x].data[9].w;
      r19.yz = refProbeConstantsCB[r0.x].data[10].xy;
      r18.y = dot(r14.xyz, r19.xyz);
      r18.z = dot(r17.xyz, r19.xyz);
      r18.z = -refProbeConstantsCB[r0.x].data[10].z + r18.z;
      r18.w = cmp(r18.z >= 0);
      r18.z = max(abs(r18.z), r12.w);
      r18.z = r18.w ? r18.z : -r18.z;
      r18.y = max(1.00000001e-07, -r18.y);
      r18.y = r18.z / r18.y;
      r18.x = min(r18.x, abs(r18.y));
      r19.x = refProbeConstantsCB[r0.x].data[10].w;
      r19.yz = refProbeConstantsCB[r0.x].data[11].xy;
      r18.y = dot(r14.xyz, r19.xyz);
      r18.z = dot(r17.xyz, r19.xyz);
      r18.z = -refProbeConstantsCB[r0.x].data[11].z + r18.z;
      r18.w = cmp(r18.z >= 0);
      r18.z = max(abs(r18.z), r12.w);
      r18.z = r18.w ? r18.z : -r18.z;
      r18.y = max(1.00000001e-07, -r18.y);
      r18.y = r18.z / r18.y;
      r18.x = min(r18.x, abs(r18.y));
      r19.x = refProbeConstantsCB[r0.x].data[11].w;
      r19.yz = refProbeConstantsCB[r0.x].data[12].xy;
      r18.y = dot(r14.xyz, r19.xyz);
      r18.z = dot(r17.xyz, r19.xyz);
      r18.z = -refProbeConstantsCB[r0.x].data[12].z + r18.z;
      r18.w = cmp(r18.z >= 0);
      r18.z = max(abs(r18.z), r12.w);
      r18.z = r18.w ? r18.z : -r18.z;
      r18.y = max(1.00000001e-07, -r18.y);
      r18.y = r18.z / r18.y;
      r18.x = min(r18.x, abs(r18.y));
      r19.x = refProbeConstantsCB[r0.x].data[12].w;
      r19.yz = refProbeConstantsCB[r0.x].data[13].xy;
      r18.y = dot(r14.xyz, r19.xyz);
      r18.z = dot(r17.xyz, r19.xyz);
      r18.z = -refProbeConstantsCB[r0.x].data[13].z + r18.z;
      r18.w = cmp(r18.z >= 0);
      r12.w = max(abs(r18.z), r12.w);
      r12.w = r18.w ? r12.w : -r12.w;
      r18.y = max(1.00000001e-07, -r18.y);
      r12.w = r12.w / r18.y;
      r12.w = min(r18.x, abs(r12.w));
      r18.x = refProbeConstantsCB[r0.x].data[3].w + r17.x;
      r18.yz = refProbeConstantsCB[r0.x].data[4].xy + r17.yz;
      r18.xyz = r14.xyz * r12.www + r18.xyz;
      ...
      if (9 == 0) r12.w = 0; else if (9+16 < 32) {       r12.w = (uint)refProbeConstantsCB[r0.x].data[7].z << (32-(9 + 16)); r12.w = (uint)r12.w >> (32-9);      } else r12.w = (uint)refProbeConstantsCB[r0.x].data[7].z >> 16;
      r20.w = (uint)r12.w;
  ...
  r0.x = cmp(r15.w >= 1);
  bitmask.w = ((~(-1 << 8)) << 0) & 0xffffffff;  r8.w = (((uint)r13.z << 0) & bitmask.w) | ((uint)r13.w & ~bitmask.w);
  r0.x = r0.x ? r8.w : r13.z;
  r8.w = max(1, r16.w);
  r8.w = rcp(r8.w);
  r16.w = saturate(r16.w);
  r13.yzw = r15.xyz * r8.www;
  r16.xyz = r16.xyz * r8.www;
  r12.w = cmp(r16.w < 0.99000001);
  if (r12.w != 0) {
    r0.x = (int)r0.x + 256;
    r12.w = 1 + -r16.w;
    r15.w = sunConstants.globalProbeExposure * r12.w;
    ...
    r13.yzw = r15.xyz * r8.www + r17.xyz;
    r14.w = 0;
    r15.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r14.xyzw, r10.w).xyz;
    r8.w = sunConstants.globalProbeExposure * r12.w + -r11.w;
    r8.w = r2.y * r8.w + r11.w;
    r16.xyz = r15.xyz * r8.www + r16.xyz;
  }
  r8.w = r2.x + r4.z;
  r8.w = log2(abs(r8.w));
  r8.w = r8.w * r2.w;
  ...
  r16.xyz = r16.xyz * r8.www;
  r18.xzw = r16.xyz * r18.xxx;
  r16.xyz = r16.xyz * r18.yyy;
  r2.y = sqrt(r2.w);
  r2.y = r2.y * 0.5 + 0.5;
  r2.y = r2.y * r2.y;
  r8.w = 0.5 * r2.y;
  r2.y = -r2.y * 0.5 + 1;
  r10.w = r2.x * r2.y + r8.w;
  r2.y = r10.w * r2.y;
  r8.w = r10.w * r8.w;
  if (r3.y != 0) {
    r19.x = 3;
  ...
  if (r10.w != 0) {
    ...
    r10.w = cmp(0 < r9.w);
    if (r10.w != 0) {
      r10.w = sunConstants.specScale * r2.z;
      r10.w = r10.w * r6.w;
      if (sunConstants.sunCookieIndex != 0) {
        r19.xyz = eyeOffset.xyz + r5.xyz;
        r19.w = 1;
        r11.w = dot(sunConstants.sunCookieTransform[0].xyzw, r19.xyzw);
        r12.w = dot(sunConstants.sunCookieTransform[1].xyzw, r19.xyzw);
        r19.x = frac(r11.w);
        r19.y = frac(r12.w);
      ...
      if (r12.w != 0) {
        ...
        r12.w = abs(r3.z) * -0.200000003 + 0.400000006;
        r14.w = cmp(r3.z < 0);
        r14.w = r3.w ? r14.w : 0;
        ...
        r22.x = lightConstantsCB[r11.w].data[9].w + r21.x;
        r22.y = lightConstantsCB[r11.w].data[10].x + r21.y;
        r21.xy = lightConstantsCB[r11.w].data[9].yz * r22.xy;
        r21.zw = lightConstantsCB[r11.w].data[3].yy / lightConstantsCB[r11.w].data[8].yw;
        r22.xy = float2(1,1) + -r21.zw;
        r22.xy = cmp(r21.xy >= r22.xy);
        r21.zw = cmp(r21.zw >= r21.xy);
        r21.zw = (int2)r21.zw | (int2)r22.xy;
        r12.w = (int)r21.w | (int)r21.z;
        if (r12.w == 0) {
          r22.xyz = lightConstantsCB[r11.w].data[6].yzw;
          r22.w = lightConstantsCB[r11.w].data[7].x;
          r12.w = dot(r22.xyzw, r20.xyzw);
          r21.xy = saturate(r21.xy);
          r20.x = r21.x * lightConstantsCB[r11.w].data[8].y + lightConstantsCB[r11.w].data[8].z;
          r20.y = r21.y * lightConstantsCB[r11.w].data[8].w + lightConstantsCB[r11.w].data[9].x;
          ...
          if (enableDitheredShadow != 0) {
            ...
            while (true) {
              ...
              r22.xy = r23.xy * lightConstantsCB[r11.w].data[3].yy + r20.xy;
              r20.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r22.xyz, r12.w).x;
              r18.y = r20.w * 0.125 + r18.y;
              r19.w = (int)r19.w + 1;
            }
          } else {
            r20.z = (uint)r14.w;
            r18.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r20.xyz, r12.w).x;
          }
          r11.w = r18.y * r18.y;
          r11.w = r11.w * r18.y;
        } else {
      ...
      r11.w = r11.w + -r7.w;
      r7.w = r2.w * r11.w + r7.w;
      r7.w = r7.w * r9.w;
      r20.xyz = r7.www * r19.xyz;
      r3.z = cmp(0 < r3.z);
      ...
      r11.w = abs(r4.z) * r2.z + -abs(r4.z);
      r4.z = abs(r4.z) * r11.w + 1;
      r6.w = r6.w * r2.y + r8.w;
      r4.z = r4.z * r4.z;
      r4.z = r4.z * r6.w;
      r4.z = rcp(r4.z);
      ...
      r4.z = r9.w * r4.z;
      r4.z = 0.25 * r4.z;
      r21.yzw = r4.zzz * r19.xyz + r16.xyz;
      r1.w = saturate(1 + -r1.w);
      r6.w = r1.w * r1.w;
      r6.w = r6.w * r6.w;
      r1.w = r6.w * r1.w;
      r1.w = r4.z * r1.w;
      r13.yzw = r1.www * r19.xyz + r18.xzw;
      r19.xyz = r7.www * r19.xyz + r17.zxy;
      r19.xyz = r3.www ? r19.yzx : 0;
      r20.w = r17.z;
      r15.w = r19.z;
      r15.xyzw = r3.zzzz ? r20.xyzw : r15.xyzw;
      r17.zw = r13.yz;
      r19.zw = r18.xz;
      r19.xyzw = r3.zzzz ? r17.xyzw : r19.xyzw;
      r21.x = r13.w;
      r16.w = r18.w;
  ...
  switch (r3.z) {
    case 4 :    if (r3.y != 0) {
      r19.yzw = lightConstantsCB[r0.y].data[0].xyz + eyeOffset.xyz;
      r19.x = 2;
      GBufferDiffuseColor[viewID].136 = u2.xyzw;
    }
    r3.z = (int)r1.w + 1;
    r4.z = cmp(0 < lightConstantsCB[r0.y].data[6].y);
    r19.xy = lightConstantsCB[r0.y].data[5].zw;
    r19.z = lightConstantsCB[r0.y].data[6].x;
    r13.yzw = -r19.xyz * float3(0.5,0.5,0.5) + lightConstantsCB[r0.y].data[0].xyz;
    r20.xyz = r13.yzw + -r5.xyz;
    r6.w = dot(r19.xyz, r20.xyz);
    r7.w = saturate(-r6.w / lightConstantsCB[r0.y].data[6].y);
    r21.xyz = r7.www * r19.xyz + r13.yzw;
    r21.xyz = r4.zzz ? r21.xyz : lightConstantsCB[r0.y].data[0].xyz;
    ...
    if (r12.w != 0) {
      r12.w = sqrt(r9.w);
      r14.w = lightConstantsCB[r0.y].data[3].x * lightConstantsCB[r0.y].data[3].x;
      r9.w = r14.w / r9.w;
      r9.w = min(1, r9.w);
      r21.xy = saturate(r12.ww * lightConstantsCB[r0.y].data[2].xz + lightConstantsCB[r0.y].data[2].yw);
      ...
      if (r12.w != 0) {
        ...
        if (r12.w != 0) {
          ...
          r21.yzw = -lightConstantsCB[r0.y].data[4].yzw + r21.yzw;
          ...
          r17.w = 0;
          while (true) {
            r18.y = cmp((int)r17.w >= 8);
            if (r18.y != 0) break;
            r22.y = dot(icb[r17.w+0].yx, r23.xy);
            r22.z = dot(icb[r17.w+0].yx, r23.yz);
            r25.yz = lightConstantsCB[r0.y].data[3].yy * r22.yz;
            r25.x = r25.y * r22.x;
            r25.w = r25.y * r21.x;
            r24.xyz = r21.yzw * r15.www + r25.xzw;
            r18.y = gOmniShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r24.xyzw, r12.w).x;
            r16.w = r18.y * 0.125 + r16.w;
            r17.w = (int)r17.w + 1;
          }
        } else {
          r16.w = 1;
        ...
        r12.w = cmp(0 < r9.w);
        if (r12.w != 0) {
          r12.w = lightConstantsCB[r0.y].data[1].z * r2.z;
          r12.w = 0.25 * r12.w;
          r15.w = dot(r19.xyz, r14.xyz);
          r14.x = dot(r14.xyz, r20.xyz);
          r14.y = -r15.w * r15.w + lightConstantsCB[r0.y].data[6].y;
          r6.w = r15.w * r14.x + -r6.w;
          ...
          r13.yzw = r6.www * r19.xyz + r13.yzw;
          r13.yzw = r4.zzz ? r13.yzw : lightConstantsCB[r0.y].data[0].xyz;
          r13.yzw = r13.yzw + -r5.xyz;
          r4.z = dot(r13.yzw, r13.yzw);
          r4.z = rsqrt(r4.z);
          r14.xyz = r13.yzw * r4.zzz;
          ...
          if (r7.w != 0) {
            ...
            r7.w = abs(r10.w) * -0.200000003 + 0.400000006;
            r15.w = cmp(r10.w < 0);
            r15.w = r3.w ? r15.w : 0;
            r7.w = r15.w ? -r7.w : r7.w;
            r19.xyz = r11.xyz * r7.www + r5.xyz;
            r20.xyz = lightConstantsCB[r6.w].data[6].yzw;
            r20.w = lightConstantsCB[r6.w].data[7].x;
            r19.w = 1;
            r7.w = dot(r20.xyzw, r19.xyzw);
            r20.xyz = lightConstantsCB[r6.w].data[7].yzw;
            r20.w = lightConstantsCB[r6.w].data[8].x;
            ...
            if (r16.w == 0) {
              ...
              if (r17.w == 0) {
                ...
                r20.x = r19.x * lightConstantsCB[r6.w].data[8].y + lightConstantsCB[r6.w].data[8].z;
                r20.y = r19.y * lightConstantsCB[r6.w].data[8].w + lightConstantsCB[r6.w].data[9].x;
                r18.y = lightConstantsCB[r6.w].data[10].z * r15.w;
            ...
            if (r15.w == 0) {
              ...
              if (enableDitheredShadow != 0) {
                ...
                while (true) {
                  ...
                  r21.xy = r22.xy * lightConstantsCB[r6.w].data[3].yy + r20.xy;
                  r18.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r21.xyz, r7.w).x;
                  r16.w = r18.y * 0.125 + r16.w;
                  r17.w = (int)r17.w + 1;
                }
              } else {
                r20.z = (uint)r15.w;
                r16.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r20.xyz, r7.w).x;
              }
              r6.w = r16.w * r16.w;
              r6.w = r6.w * r16.w;
            } else {
          ...
          r10.w = r11.w * r10.w;
          r10.w = r10.w * r9.w;
          r13.yzw = r10.www * r19.xyz + r16.xyz;
          r4.z = saturate(1 + -r4.z);
          r11.w = r4.z * r4.z;
          r11.w = r11.w * r11.w;
          r4.z = r11.w * r4.z;
          r4.z = r10.w * r4.z;
          r14.xyz = r4.zzz * r19.xyz + r18.xzw;
          r19.xyz = r6.www * r19.xyz + r17.zxy;
          r19.xyz = r3.www ? r19.xyz : r17.zxy;
          r15.xyz = r7.www ? r20.xyz : r15.xyz;
          r17.xyz = r7.www ? r17.xyz : r19.yzx;
          r18.xzw = r7.www ? r14.xyz : r18.xzw;
          r16.xyz = r7.www ? r13.yzw : r16.xyz;
          if (r3.y != 0) {
          // Known bad code for instruction (needs manual fix):
    ...
    r4.z = rsqrt(r4.z);
    r13.yzw = r14.xyz * r4.zzz;
    r6.w = dot(r11.xyz, r13.yzw);
    r7.w = saturate(r6.w);
    r9.w = r3.w ? abs(r6.w) : r7.w;
    r10.w = cmp(0 < r9.w);
    if (r10.w != 0) {
      r19.xyz = lightConstantsCB[r0.y].data[7].yzw;
      r19.w = lightConstantsCB[r0.y].data[8].x;
      r5.w = 1;
      r10.w = dot(r19.xyzw, r5.xyzw);
      r11.w = cmp(r10.w < 1);
      if (r11.w != 0) {
        r13.yzw = float3(1,1,1);
        r11.w = 0;
      } else {
        r20.xyz = lightConstantsCB[r0.y].data[0].xyz + -r5.xyz;
        r12.w = lightConstantsCB[r0.y].data[3].x * lightConstantsCB[r0.y].data[3].x;
        r14.w = dot(r20.xyz, r20.xyz);
        r12.w = r12.w / r14.w;
        r12.w = min(1, r12.w);
        r20.xy = saturate(r10.ww * lightConstantsCB[r0.y].data[2].xz + lightConstantsCB[r0.y].data[2].yw);
        ...
        if (r5.w != 0) {
          r21.xy = saturate(abs(r20.xy) * lightConstantsCB[r0.y].data[12].xy + lightConstantsCB[r0.y].data[12].zw);
          r21.zw = r21.xy * r21.xy;
          r21.xy = r21.xy * float2(-2,-2) + float2(3,3);
          r21.xy = r21.zw * r21.xy;
          r5.w = r21.x * r21.y;
          ...
          r21.xy = log2(r21.xy);
          r21.xy = lightConstantsCB[r0.y].data[12].ww * r21.xy;
          r21.xy = exp2(r21.xy);
          r10.w = lightConstantsCB[r0.y].data[12].x * r21.x;
          r14.w = lightConstantsCB[r0.y].data[12].y * r21.y + -1;
          r10.w = lightConstantsCB[r0.y].data[12].y * r21.y + -r10.w;
        ...
        if (r5.w != 0) {
          r20.z = 1;
          r10.w = dot(lightConstantsCB[r0.y].data[13].xyz, r20.xyz);
      ...
      if (r5.w != 0) {
        ...
        if (r5.w != 0) {
          ...
          if (r14.w != 0) {
            ...
            r20.x = r19.x * lightConstantsCB[r0.y].data[8].y + lightConstantsCB[r0.y].data[8].z;
            r20.y = r19.y * lightConstantsCB[r0.y].data[8].w + lightConstantsCB[r0.y].data[9].x;
            r5.w = r5.w / r12.w;
            r5.w = max(6.10351563e-05, r5.w);
            r12.w = 0x0000ffff & (int)lightConstantsCB[r0.y].data[1].w;
            if (enableDitheredShadow != 0) {
              r19.x = -r3.x;
              r21.z = (uint)r12.w;
              r19.y = r13.x;
              ...
              while (true) {
                ...
                if (r16.w != 0) break;
                r22.x = dot(icb[r15.w+0].yx, r19.xy);
                r22.y = dot(icb[r15.w+0].yx, r19.yz);
                r21.xy = r22.xy * lightConstantsCB[r0.y].data[3].yy + r20.xy;
        ...
        if (r11.w != 0) {
          ...
          r11.w = r11.w * r7.w;
          if (4 == 0) r12.w = 0; else if (4+16 < 32) {           r12.w = (uint)lightConstantsCB[r0.y].data[1].w << (32-(4 + 16)); r12.w = (uint)r12.w >> (32-4);          } else r12.w = (uint)lightConstantsCB[r0.y].data[1].w >> 16;
          ...
          if (r14.w != 0) {
            ...
            r19.xyz = r11.xyz * r14.www + r5.xyz;
            ...
            if (r16.w == 0) {
              ...
              r19.xy = r20.xy / r15.ww;
              r19.xy = r19.xy * float2(0.5,-0.5) + float2(0.5,0.5);
              r20.x = lightConstantsCB[r12.w].data[9].w + r19.x;
              r20.y = lightConstantsCB[r12.w].data[10].x + r19.y;
              r19.xy = lightConstantsCB[r12.w].data[9].yz * r20.xy;
              r19.zw = lightConstantsCB[r12.w].data[3].yy / lightConstantsCB[r12.w].data[8].yw;
              r20.xy = float2(1,1) + -r19.zw;
              r20.xy = cmp(r19.xy >= r20.xy);
              r19.zw = cmp(r19.zw >= r19.xy);
              r19.zw = (int2)r19.zw | (int2)r20.xy;
              ...
              if (r17.w == 0) {
                r19.xy = saturate(r19.xy);
                r20.x = r19.x * lightConstantsCB[r12.w].data[8].y + lightConstantsCB[r12.w].data[8].z;
                r20.y = r19.y * lightConstantsCB[r12.w].data[8].w + lightConstantsCB[r12.w].data[9].x;
                r18.y = lightConstantsCB[r12.w].data[10].z * r15.w;
                r14.w = lightConstantsCB[r12.w].data[10].y * r15.w + r14.w;
                r14.w = r14.w / r18.y;
              }
            } else {
              r17.w = -1;
            ...
            if (r15.w == 0) {
              ...
              r15.w = 0x0000ffff & (int)lightConstantsCB[r12.w].data[1].w;
              if (enableDitheredShadow != 0) {
                r19.x = -r3.x;
                r21.z = (uint)r15.w;
                r19.y = r13.x;
                ...
                while (true) {
                  ...
                  r18.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r21.xyz, r14.w).x;
                  r16.w = r18.y * 0.125 + r16.w;
                  r17.w = (int)r17.w + 1;
                }
              } else {
                r20.z = (uint)r15.w;
                r16.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r20.xyz, r14.w).x;
              }
              r12.w = r16.w * r16.w;
              r12.w = r12.w * r16.w;
            } else {
            ...
            if (r1.z != 0) {
              ...
              if (r14.w == 0) {
                ...
                r21.w = lightConstantsCB[r0.y].data[6].x;
                r20.y = dot(r21.xyzw, r19.xyzw);
                r19.xy = r20.xy / r12.ww;
                r19.xy = r19.xy * float2(0.5,-0.5) + float2(0.5,0.5);
                r20.x = lightConstantsCB[r0.y].data[9].w + r19.x;
                r20.y = lightConstantsCB[r0.y].data[10].x + r19.y;
                r19.xy = lightConstantsCB[r0.y].data[9].yz * r20.xy;
                r19.zw = lightConstantsCB[r0.y].data[3].yy / lightConstantsCB[r0.y].data[8].yw;
                r20.xy = float2(1,1) + -r19.zw;
                r20.xy = cmp(r19.xy >= r20.xy);
                r19.zw = cmp(r19.zw >= r19.xy);
                r19.zw = (int2)r19.zw | (int2)r20.xy;
                r15.w = (int)r19.w | (int)r19.z;
                if (r15.w == 0) {
                  r19.xy = saturate(r19.xy);
                  r20.x = r19.x * lightConstantsCB[r0.y].data[8].y + lightConstantsCB[r0.y].data[8].z;
                  r20.y = r19.y * lightConstantsCB[r0.y].data[8].w + lightConstantsCB[r0.y].data[9].x;
                  r16.w = lightConstantsCB[r0.y].data[10].z * r12.w;
                  r1.z = lightConstantsCB[r0.y].data[10].y * r12.w + r1.z;
                  r1.z = r1.z / r16.w;
                }
              } else {
                r15.w = -1;
              ...
              if (r12.w == 0) {
                ...
                if (enableDitheredShadow != 0) {
                  ...
                  while (true) {
                    ...
                    if (r14.w != 0) break;
                    r22.x = dot(icb[r13.x+0].yx, r19.xy);
                    r22.y = dot(icb[r13.x+0].yx, r19.yz);
                    r21.xy = r22.xy * lightConstantsCB[r0.y].data[3].yy + r20.xy;
                    r14.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r21.xyz, r1.z).x;
                    r3.x = r14.w * 0.125 + r3.x;
                    r13.x = (int)r13.x + 1;
                  }
                } else {
                  r20.z = (uint)r12.w;
                  r3.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r20.xyz, r1.z).x;
                }
                r0.y = r3.x * r3.x;
                r0.y = r0.y * r3.x;
              } else {
          ...
          r0.y = r0.y * r5.w;
          r1.z = cmp(0 < r6.w);
          r19.xyz = r0.yyy * r13.yzw + r15.xyz;
          r14.xyz = r14.xyz * r4.zzz + r12.xyz;
          r2.x = dot(r14.xyz, r14.xyz);
          r2.x = rsqrt(r2.x);
          r14.xyz = r14.xyz * r2.xxx;
          r2.x = dot(r14.xyz, r12.xyz);
          r2.w = dot(r11.xyz, r14.xyz);
          r2.z = abs(r2.w) * r2.z + -abs(r2.w);
          r2.z = abs(r2.w) * r2.z + 1;
          r2.y = r7.w * r2.y + r8.w;
          r2.z = r2.z * r2.z;
          r2.y = r2.z * r2.y;
          r2.y = rcp(r2.y);
          ...
          r2.y = r5.w * r2.y;
          r2.y = 0.25 * r2.y;
          r11.xyz = r2.yyy * r13.yzw + r16.xyz;
          r2.x = saturate(1 + -r2.x);
          r2.z = r2.x * r2.x;
          r2.z = r2.z * r2.z;
          r2.x = r2.x * r2.z;
          r2.x = r2.y * r2.x;
          r2.xyz = r2.xxx * r13.yzw + r18.xzw;
          r12.xyz = r0.yyy * r13.yzw + r17.zxy;
          r12.xyz = r3.www ? r12.xyz : r17.zxy;
          r15.xyz = r1.zzz ? r19.xyz : r15.xyz;
          r17.xyz = r1.zzz ? r17.xyz : r12.yzx;
          r18.xzw = r1.zzz ? r2.xyz : r18.xzw;
