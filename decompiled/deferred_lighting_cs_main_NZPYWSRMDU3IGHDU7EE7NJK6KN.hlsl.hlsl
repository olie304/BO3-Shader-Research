...
// unknown dcl_: dcl_thread_group 8, 8, 1
  r0.x = mad(permuteStride, 41, (int)vThreadGroupID.x);
...
r0.y = samp0[]..swiz;
  ...
  r0.y = (uint)r0.y >> 24;
  r9.z = cmp((uint)r0.y >= (uint)r9.y);
  r9.w = cmp((uint)r0.y < numRefProbes);
  r9.z = r9.w ? r9.z : 0;
  if (r9.z != 0) {
    r9.z = (int)r0.y * 14;
    r13.yzw = -refProbeConstantsCB[r9.z].data[0].xyz + r10.xyz;
    r9.w = 0x0000ffff & (int)refProbeConstantsCB[r9.z].data[7].z;
    if (6 == 0) r10.w = 0; else if (6+25 < 32) {     r10.w = (uint)refProbeConstantsCB[r9.z].data[7].z << (32-(6 + 25)); r10.w = (uint)r10.w >> (32-6);    } else r10.w = (uint)refProbeConstantsCB[r9.z].data[7].z >> 25;
    r12.w = (int)r9.w * 6;
    r14.y = dot(refProbeAttenuationConstantsCB[r12.w].data[0].xyz, r13.yzw);
    r14.y = saturate(refProbeAttenuationConstantsCB[r12.w].data[0].w + r14.y);
    r14.z = dot(refProbeAttenuationConstantsCB[r12.w].data[1].xyz, r13.yzw);
    r14.z = saturate(refProbeAttenuationConstantsCB[r12.w].data[1].w + r14.z);
    r14.y = r14.y * r14.z;
    r14.z = dot(refProbeAttenuationConstantsCB[r12.w].data[2].xyz, r13.yzw);
    r14.z = saturate(refProbeAttenuationConstantsCB[r12.w].data[2].w + r14.z);
    r14.y = r14.y * r14.z;
    r14.z = dot(refProbeAttenuationConstantsCB[r12.w].data[3].xyz, r13.yzw);
    r14.z = saturate(refProbeAttenuationConstantsCB[r12.w].data[3].w + r14.z);
    r14.y = r14.y * r14.z;
    r14.z = dot(refProbeAttenuationConstantsCB[r12.w].data[4].xyz, r13.yzw);
    r14.z = saturate(refProbeAttenuationConstantsCB[r12.w].data[4].w + r14.z);
    r14.y = r14.y * r14.z;
    r14.z = dot(refProbeAttenuationConstantsCB[r12.w].data[5].xyz, r13.yzw);
    r12.w = saturate(refProbeAttenuationConstantsCB[r12.w].data[5].w + r14.z);
    r16.x = r14.y * r12.w;
    r12.w = 1 & (int)refProbeConstantsCB[r9.z].data[6].x;
    r16.yz = float2(0,1);
    r14.yz = r12.ww ? r16.xy : r16.zx;
    r16.x = 1;
    r12.w = refProbeConstantsCB[r9.z].data[6].x;
    r17.xy = r14.yz;
    r14.w = 1;
    while (true) {
      r16.z = cmp((int)r14.w >= (int)r10.w);
      if (r16.z != 0) break;
      r16.z = (int)r9.w + (int)r14.w;
      r16.z = (int)r16.z * 6;
    ...
    r9.w = refProbeConstantsCB[r9.z].data[6].y * r17.y;
    r10.w = cmp(0 < r9.w);
    if (r10.w != 0) {
      r10.w = refProbeConstantsCB[r9.z].data[7].y * r9.w;
      r16.x = refProbeConstantsCB[r9.z].data[7].w;
      r16.yz = refProbeConstantsCB[r9.z].data[8].xy;
      r12.w = dot(r15.xyz, r16.xyz);
      r14.y = dot(r13.yzw, r16.xyz);
      r14.y = -refProbeConstantsCB[r9.z].data[8].z + r14.y;
      r14.z = cmp(r14.y >= 0);
      r14.y = max(abs(r14.y), r8.w);
      r14.y = r14.z ? r14.y : -r14.y;
      r12.w = max(1.00000001e-07, -r12.w);
      r12.w = r14.y / r12.w;
      r12.w = min(131072, abs(r12.w));
      r16.x = refProbeConstantsCB[r9.z].data[8].w;
      r16.yz = refProbeConstantsCB[r9.z].data[9].xy;
      r14.y = dot(r15.xyz, r16.xyz);
      r14.z = dot(r13.yzw, r16.xyz);
      r14.z = -refProbeConstantsCB[r9.z].data[9].z + r14.z;
      r14.w = cmp(r14.z >= 0);
      r14.z = max(abs(r14.z), r8.w);
      r14.z = r14.w ? r14.z : -r14.z;
      r14.y = max(1.00000001e-07, -r14.y);
      r14.y = r14.z / r14.y;
      r12.w = min(abs(r14.y), r12.w);
      r16.x = refProbeConstantsCB[r9.z].data[9].w;
      r16.yz = refProbeConstantsCB[r9.z].data[10].xy;
      r14.y = dot(r15.xyz, r16.xyz);
      r14.z = dot(r13.yzw, r16.xyz);
      r14.z = -refProbeConstantsCB[r9.z].data[10].z + r14.z;
      r14.w = cmp(r14.z >= 0);
      r14.z = max(abs(r14.z), r8.w);
      r14.z = r14.w ? r14.z : -r14.z;
      r14.y = max(1.00000001e-07, -r14.y);
      r14.y = r14.z / r14.y;
      r12.w = min(abs(r14.y), r12.w);
      r16.x = refProbeConstantsCB[r9.z].data[10].w;
      r16.yz = refProbeConstantsCB[r9.z].data[11].xy;
      r14.y = dot(r15.xyz, r16.xyz);
      r14.z = dot(r13.yzw, r16.xyz);
      r14.z = -refProbeConstantsCB[r9.z].data[11].z + r14.z;
      r14.w = cmp(r14.z >= 0);
      r14.z = max(abs(r14.z), r8.w);
      r14.z = r14.w ? r14.z : -r14.z;
      r14.y = max(1.00000001e-07, -r14.y);
      r14.y = r14.z / r14.y;
      r12.w = min(abs(r14.y), r12.w);
      r16.x = refProbeConstantsCB[r9.z].data[11].w;
      r16.yz = refProbeConstantsCB[r9.z].data[12].xy;
      r14.y = dot(r15.xyz, r16.xyz);
      r14.z = dot(r13.yzw, r16.xyz);
      r14.z = -refProbeConstantsCB[r9.z].data[12].z + r14.z;
      r14.w = cmp(r14.z >= 0);
      r14.z = max(abs(r14.z), r8.w);
      r14.z = r14.w ? r14.z : -r14.z;
      r14.y = max(1.00000001e-07, -r14.y);
      r14.y = r14.z / r14.y;
      r12.w = min(abs(r14.y), r12.w);
      r16.x = refProbeConstantsCB[r9.z].data[12].w;
      r16.yz = refProbeConstantsCB[r9.z].data[13].xy;
      r14.y = dot(r15.xyz, r16.xyz);
      r14.z = dot(r13.yzw, r16.xyz);
      r14.z = -refProbeConstantsCB[r9.z].data[13].z + r14.z;
      r14.w = cmp(r14.z >= 0);
      r14.z = max(abs(r14.z), r8.w);
      r14.z = r14.w ? r14.z : -r14.z;
      r14.y = max(1.00000001e-07, -r14.y);
      r14.y = r14.z / r14.y;
      r12.w = min(abs(r14.y), r12.w);
      r16.x = refProbeConstantsCB[r9.z].data[3].w + r13.y;
      r16.yz = refProbeConstantsCB[r9.z].data[4].xy + r13.zw;
      r14.yzw = r15.xyz * r12.www + r16.xyz;
      ...
      r16.x = refProbeConstantsCB[r9.z].data[0].w;
      r16.y = refProbeConstantsCB[r9.z].data[1].z;
      r16.z = refProbeConstantsCB[r9.z].data[2].y;
      r17.x = dot(r14.yzw, r16.xyz);
      r18.xy = refProbeConstantsCB[r9.z].data[1].xw;
      r18.z = refProbeConstantsCB[r9.z].data[2].z;
      r17.y = dot(r14.yzw, r18.xyz);
      r19.x = refProbeConstantsCB[r9.z].data[1].y;
      r19.yz = refProbeConstantsCB[r9.z].data[2].xw;
      r17.z = dot(r14.yzw, r19.xyz);
      if (9 == 0) r14.y = 0; else if (9+16 < 32) {       r14.y = (uint)refProbeConstantsCB[r9.z].data[7].z << (32-(9 + 16)); r14.y = (uint)r14.y >> (32-9);      } else r14.y = (uint)refProbeConstantsCB[r9.z].data[7].z >> 16;
      r17.w = (uint)r14.y;
      r14.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r17.xyzw, r12.w).xyz;
      r20.x = dot(r13.yzw, r16.xyz);
      r20.y = dot(r13.yzw, r18.xyz);
      r20.z = dot(r13.yzw, r19.xyz);
      r13.yzw = saturate(r20.xyz * refProbeConstantsCB[r9.z].data[3].xyz + float3(0.5,0.5,0.5));
      r20.xy = refProbeConstantsCB[r9.z].data[4].zw * r13.yz;
      r20.z = refProbeConstantsCB[r9.z].data[5].x * r13.w;
      r13.yzw = refProbeConstantsCB[r9.z].data[5].yzw + r20.xyz;
      ...
      r9.z = dot(r13.yzw, float3(0.212599993,0.715200007,0.0722000003));
      r12.w = r9.x * r9.z;
      r14.yzw = r14.yzw * r10.www;
      r10.w = dot(r14.yzw, float3(0.212599993,0.715200007,0.0722000003));
      r9.z = r9.x * r9.z + r10.w;
      r9.z = r12.w / r9.z;
      r14.yzw = r14.yzw * r9.zzz;
    } else {
  ...
  r9.z = cmp(r9.w < 1);
  if (r9.z != 0) {
    r9.y = cmp((uint)r0.y < (uint)r9.y);
    if (r9.y != 0) {
      r0.y = (int)r0.y * 14;
      r16.xyz = -refProbeConstantsCB[r0.y].data[0].xyz + r10.xyz;
      r9.y = 0x0000ffff & (int)refProbeConstantsCB[r0.y].data[7].z;
      if (6 == 0) r9.z = 0; else if (6+25 < 32) {       r9.z = (uint)refProbeConstantsCB[r0.y].data[7].z << (32-(6 + 25)); r9.z = (uint)r9.z >> (32-6);      } else r9.z = (uint)refProbeConstantsCB[r0.y].data[7].z >> 25;
      r10.w = (int)r9.y * 6;
      r12.w = dot(refProbeAttenuationConstantsCB[r10.w].data[0].xyz, r16.xyz);
      r12.w = saturate(refProbeAttenuationConstantsCB[r10.w].data[0].w + r12.w);
      r16.w = dot(refProbeAttenuationConstantsCB[r10.w].data[1].xyz, r16.xyz);
      r16.w = saturate(refProbeAttenuationConstantsCB[r10.w].data[1].w + r16.w);
      r12.w = r16.w * r12.w;
      r16.w = dot(refProbeAttenuationConstantsCB[r10.w].data[2].xyz, r16.xyz);
      r16.w = saturate(refProbeAttenuationConstantsCB[r10.w].data[2].w + r16.w);
      r12.w = r16.w * r12.w;
      r16.w = dot(refProbeAttenuationConstantsCB[r10.w].data[3].xyz, r16.xyz);
      r16.w = saturate(refProbeAttenuationConstantsCB[r10.w].data[3].w + r16.w);
      r12.w = r16.w * r12.w;
      r16.w = dot(refProbeAttenuationConstantsCB[r10.w].data[4].xyz, r16.xyz);
      r16.w = saturate(refProbeAttenuationConstantsCB[r10.w].data[4].w + r16.w);
      r12.w = r16.w * r12.w;
      r16.w = dot(refProbeAttenuationConstantsCB[r10.w].data[5].xyz, r16.xyz);
      r10.w = saturate(refProbeAttenuationConstantsCB[r10.w].data[5].w + r16.w);
      r17.x = r12.w * r10.w;
      r10.w = 1 & (int)refProbeConstantsCB[r0.y].data[6].x;
      r17.yz = float2(0,1);
      r17.xy = r10.ww ? r17.xy : r17.zx;
      r18.x = 1;
      r10.w = refProbeConstantsCB[r0.y].data[6].x;
      r19.xy = r17.xy;
      r12.w = 1;
      while (true) {
        r16.w = cmp((int)r12.w >= (int)r9.z);
        if (r16.w != 0) break;
        r16.w = (int)r9.y + (int)r12.w;
        r16.w = (int)r16.w * 6;
        r17.z = dot(refProbeAttenuationConstantsCB[r16.w].data[0].xyz, r16.xyz);
        r17.z = saturate(refProbeAttenuationConstantsCB[r16.w].data[0].w + r17.z);
        r17.z = r19.x * r17.z;
        r17.w = dot(refProbeAttenuationConstantsCB[r16.w].data[1].xyz, r16.xyz);
        r17.w = saturate(refProbeAttenuationConstantsCB[r16.w].data[1].w + r17.w);
        r17.z = r17.z * r17.w;
        r17.w = dot(refProbeAttenuationConstantsCB[r16.w].data[2].xyz, r16.xyz);
        r17.w = saturate(refProbeAttenuationConstantsCB[r16.w].data[2].w + r17.w);
        r17.z = r17.z * r17.w;
        r17.w = dot(refProbeAttenuationConstantsCB[r16.w].data[3].xyz, r16.xyz);
        r17.w = saturate(refProbeAttenuationConstantsCB[r16.w].data[3].w + r17.w);
        r17.z = r17.z * r17.w;
        r17.w = dot(refProbeAttenuationConstantsCB[r16.w].data[4].xyz, r16.xyz);
        r17.w = saturate(refProbeAttenuationConstantsCB[r16.w].data[4].w + r17.w);
        r17.z = r17.z * r17.w;
        r17.w = dot(refProbeAttenuationConstantsCB[r16.w].data[5].xyz, r16.xyz);
        ...
        r16.w = -r17.z * r16.w + 1;
        r16.w = r19.y * r16.w;
        r18.y = r18.w ? r16.w : r19.z;
        r19.xy = r18.zz ? r19.xy : r18.xy;
        r12.w = (int)r12.w + 1;
        r10.w = r17.w;
      }
      r9.y = saturate(r19.y + -r9.w);
      r9.z = refProbeConstantsCB[r0.y].data[6].y * r9.y;
      r10.w = cmp(0 < r9.z);
      if (r10.w != 0) {
        r9.w = r9.y * refProbeConstantsCB[r0.y].data[6].y + r9.w;
        r9.y = refProbeConstantsCB[r0.y].data[7].y * r9.z;
        r17.x = refProbeConstantsCB[r0.y].data[7].w;
        r17.yz = refProbeConstantsCB[r0.y].data[8].xy;
        r9.z = dot(r15.xyz, r17.xyz);
        r10.w = dot(r16.xyz, r17.xyz);
        r10.w = -refProbeConstantsCB[r0.y].data[8].z + r10.w;
        r12.w = cmp(r10.w >= 0);
        r10.w = max(abs(r10.w), r8.w);
        r10.w = r12.w ? r10.w : -r10.w;
        r9.z = max(1.00000001e-07, -r9.z);
        r9.z = r10.w / r9.z;
        r9.z = min(131072, abs(r9.z));
        ...
        r12.w = -refProbeConstantsCB[r0.y].data[9].z + r12.w;
        r16.w = cmp(r12.w >= 0);
        r12.w = max(abs(r12.w), r8.w);
        r12.w = r16.w ? r12.w : -r12.w;
        r10.w = max(1.00000001e-07, -r10.w);
        r10.w = r12.w / r10.w;
        r9.z = min(abs(r10.w), r9.z);
        r17.x = refProbeConstantsCB[r0.y].data[9].w;
        r17.yz = refProbeConstantsCB[r0.y].data[10].xy;
        r10.w = dot(r15.xyz, r17.xyz);
        r12.w = dot(r16.xyz, r17.xyz);
        r12.w = -refProbeConstantsCB[r0.y].data[10].z + r12.w;
        r16.w = cmp(r12.w >= 0);
        r12.w = max(abs(r12.w), r8.w);
        r12.w = r16.w ? r12.w : -r12.w;
        r10.w = max(1.00000001e-07, -r10.w);
        ...
        r10.w = dot(r15.xyz, r17.xyz);
        r12.w = dot(r16.xyz, r17.xyz);
        r12.w = -refProbeConstantsCB[r0.y].data[11].z + r12.w;
        r16.w = cmp(r12.w >= 0);
        r12.w = max(abs(r12.w), r8.w);
        r12.w = r16.w ? r12.w : -r12.w;
        r10.w = max(1.00000001e-07, -r10.w);
        ...
        r10.w = dot(r15.xyz, r17.xyz);
        r12.w = dot(r16.xyz, r17.xyz);
        r12.w = -refProbeConstantsCB[r0.y].data[12].z + r12.w;
        r16.w = cmp(r12.w >= 0);
        r12.w = max(abs(r12.w), r8.w);
        r12.w = r16.w ? r12.w : -r12.w;
        r10.w = max(1.00000001e-07, -r10.w);
        ...
        r10.w = dot(r15.xyz, r17.xyz);
        r12.w = dot(r16.xyz, r17.xyz);
        r12.w = -refProbeConstantsCB[r0.y].data[13].z + r12.w;
        r16.w = cmp(r12.w >= 0);
        r8.w = max(abs(r12.w), r8.w);
        r8.w = r16.w ? r8.w : -r8.w;
        r10.w = max(1.00000001e-07, -r10.w);
        r8.w = r8.w / r10.w;
        r8.w = min(r9.z, abs(r8.w));
        r17.x = refProbeConstantsCB[r0.y].data[3].w + r16.x;
        r17.yz = refProbeConstantsCB[r0.y].data[4].xy + r16.yz;
        r17.xyz = r15.xyz * r8.www + r17.xyz;
        r9.z = dot(r17.xyz, r17.xyz);
        r9.z = sqrt(r9.z);
        r8.w = r8.w / r9.z;
        r8.w = r8.w + r8.w;
        r8.w = sqrt(r8.w);
        r5.w = r5.w * 5 + r8.w;
        r5.w = -0.844799995 + r5.w;
        ...
        r19.w = (uint)r8.w;
        r17.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r19.xyzw, r5.w).xyz;
        r22.x = dot(r16.xyz, r18.xyz);
        r22.y = dot(r16.xyz, r20.xyz);
        r22.z = dot(r16.xyz, r21.xyz);
        r16.xyz = saturate(r22.xyz * refProbeConstantsCB[r0.y].data[3].xyz + float3(0.5,0.5,0.5));
        r22.xy = refProbeConstantsCB[r0.y].data[4].zw * r16.xy;
        r22.z = refProbeConstantsCB[r0.y].data[5].x * r16.z;
        r16.xyz = refProbeConstantsCB[r0.y].data[5].yzw + r22.xyz;
        ...
        r0.y = dot(r19.xyz, float3(0.212599993,0.715200007,0.0722000003));
        r13.yzw = r16.xyz * r18.xyz + r13.yzw;
        r5.w = r9.x * r0.y;
        r16.xyz = r17.xyz * r9.yyy;
  ...
  r0.y = rcp(r0.y);
  r9.w = saturate(r9.w);
  r9.xyz = r13.yzw * r0.yyy;
  r14.yzw = r14.yzw * r0.yyy;
  r5.w = cmp(r9.w < 0.99000001);
  if (r5.w != 0) {
    r5.w = 1 + -r9.w;
    ...
    r0.y = r2.y * r0.y + r8.w;
    r14.yzw = r13.yzw * r0.yyy + r14.yzw;
  }
  r0.y = r4.z * r1.w + r2.x;
  r0.y = log2(abs(r0.y));
  r0.y = r1.z * r0.y;
  ...
  if (r0.y != 0) {
    ...
    if (r0.y != 0) {
      ...
      r9.xyz = r1.zzz ? r2.xzw : r9.xyz;
      r14.yzw = r1.zzz ? r0.xyz : r14.yzw;
      r13.yzw = r1.zzz ? r11.xyz : r13.yzw;
    }
  }
