...
r0.x = colorSampler[]..swiz;
  ...
  r2.z = transGlossMap.Sample(transitionSampler_s, r0.yz).x;
  if (r2.y != 0) {
    r2.y = v1.x * r3.w;
    r2.w = transGlossRange.y + -transGlossRange.x;
    r2.z = r2.z * r2.w + transGlossRange.x;
  ...
  r2.w = cmp(0 < r2.y);
  r3.xyz = transNormalMap.Sample(transitionSampler_s, r0.yz).xyz;
  if (r2.w != 0) {
    r3.xyz = float3(-0.5,-0.5,-0) + r3.xyz;
  ...
  r4.xzw = r4.xxx * r6.xyz + float3(1,1,1);
  r6.xyz = clothSecondaryTint.xyz + -r4.xzw;
  r4.xyz = r4.yyy * r6.xyz + r4.xzw;
  r1.w = saturate(r1.w * v1.x + -r0.x);
  r4.xyz = float3(-1,-1,-1) + r4.xyz;
  r4.xyz = r1.www * r4.xyz + float3(1,1,1);
  r6.xyz = r4.xyz * r1.xyz;
  r1.w = velveteenMask.Sample(velveteenSampler_s, w1.xy).x;
  r3.w = waterRefractionAmount * r1.w;
  r3.w = cmp(0 < r3.w);
  r4.w = 17 * r0.z;
  r4.w = exp2(r4.w);
  r4.w = 2 + r4.w;
  ...
  r5.z = saturate(dot(r2.yzw, r7.xyz));
  r5.z = 1 + -r5.z;
  r4.w = 1 / r4.w;
  r5.z = log2(r5.z);
  r4.w = r5.z * r4.w;
  ...
  r4.w = r4.w + -r0.x;
  r4.w = max(0, r4.w);
  r1.xyz = r1.xyz * r4.xyz + float3(-0.0399999991,-0.0399999991,-0.0399999991);
  r1.xyz = r4.www * r1.xyz + float3(0.0399999991,0.0399999991,0.0399999991);
  r0.x = r1.w + r0.x;
  r0.x = min(1, r0.x);
  r4.xyz = r6.xyz * r0.xxx;
  o0.xyz = r3.www ? r4.xyz : r6.xyz;
  r1.xyz = r3.www ? r1.xyz : float3(0.0399999991,0.0399999991,0.0399999991);
  r4.xy = v6.xy / v6.ww;
  r4.zw = float2(0.5,0.5) * renderTargetSize.xy;
  r6.x = r4.x * r4.z;
  r6.y = r4.y * -r4.w;
  r4.xy = renderTargetSize.xy * float2(0.5,0.5) + r6.xy;
  r4.xy = v0.xy + -r4.xy;
  r0.x = r5.x + r5.y;
  r0.x = r3.z * r0.y + r0.x;
  r0.x = 0.5 * r0.x;
  r3.xyz = r3.xyz * r0.yyy + -r0.xxx;
  r0.y = max(r3.y, r3.z);
  r0.y = max(r3.x, r0.y);
  r0.x = max(r0.x, r0.y);
  r0.y = cmp(r0.x == r3.x);
  ...
  r5.x = 1;
  r2.x = 0;
  r2.xyzw = r0.yyyy ? r5.xyzw : r2.xyzw;
  r0.x = r0.y ? r1.w : r0.x;
  r0.y = cmp(r0.x == r3.y);
  r5.yzw = float3(-1,1,-1) * r2.yzw;
  r1.w = 2 + r0.x;
  ...
  r0.xy = float2(-10,-10) + abs(r4.xy);
  r0.xy = saturate(float2(0.0333333351,0.0333333351) * r0.xy);
  r1.xy = float2(0.100000001,0.100000001) * abs(r4.xy);
