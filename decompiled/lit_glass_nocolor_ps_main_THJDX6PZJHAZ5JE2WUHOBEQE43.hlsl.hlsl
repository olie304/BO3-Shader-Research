...
r2.z = samp0[]..swiz;
  ...
  r39.w = samp0[]..swiz;
    ...
    r30.x = dot(r10.yzw, r21.xyz);
    r30.y = dot(r10.yzw, r29.xyz);
    r30.z = dot(r10.yzw, r23.xyz);
    r24.xyz = saturate(r30.xyz * r24.xyz + float3(0.5,0.5,0.5));
    r25.z = r26.x;
    r24.xyz = r24.xyz * r25.xyz + r26.yzw;
    r28.x = dot(r4.xyz, r21.xyz);
    r28.y = dot(r4.xyz, r29.xyz);
    r28.z = dot(r4.xyz, r23.xyz);
  ...
  if (r1.z == 0) {
    ...
    while (true) {
      ...
      r9.z = cmp((int)r2.x == (int)r8.w);
      bitmask.w = ((~(-1 << r2.y)) << 0) & 0xffffffff;  r9.w = (((uint)0 << 0) & bitmask.w) | ((uint)r9.y & ~bitmask.w);
      r9.y = r9.z ? r9.w : r9.y;
      ...
      while (true) {
        ...
        r14.y = samp0[]..swiz;
          ...
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r26.xyzw, r10.y, l(0), t15.wxyz
          r26.x = samp0[]..swiz;
          r26.y = samp0[]..swiz;
          r26.z = samp0[]..swiz;
          r26.w = samp0[]..swiz;
          ...
          r10.w = samp0[]..swiz;
          // Known bad code for instruction (needs manual fix):
                    ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r27.xyzw, r10.y, l(116), t15.zwxy
          r27.x = samp0[]..swiz;
          r27.y = samp0[]..swiz;
          r27.z = samp0[]..swiz;
          r27.w = samp0[]..swiz;
            ...
            if (6 == 0) r13.z = 0; else if (6+25 < 32) {             r13.z = (uint)r27.w << (32-(6 + 25)); r13.z = (uint)r13.z >> (32-6);            } else r13.z = (uint)r27.w >> 25;
          // Known bad code for instruction (needs manual fix):
          ...
          r33.w = samp0[]..swiz;
            ...
            r29.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r30.xyzw, r10.y, l(32), t15.yxwz
            r30.x = samp0[]..swiz;
            r30.y = samp0[]..swiz;
            r30.z = samp0[]..swiz;
            r30.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r31.xyzw, r10.y, l(48), t15.xyzw
            r31.x = samp0[]..swiz;
            r31.y = samp0[]..swiz;
            r31.z = samp0[]..swiz;
            r31.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r32.xyzw, r10.y, l(64), t15.zwxy
            r32.x = samp0[]..swiz;
            r32.y = samp0[]..swiz;
            r32.z = samp0[]..swiz;
            r32.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r33.xyzw, r10.y, l(80), t15.xyzw
            r33.x = samp0[]..swiz;
            r33.y = samp0[]..swiz;
            r33.z = samp0[]..swiz;
            r33.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r34.xyzw, r10.y, l(132), t15.zwxy
            r34.x = samp0[]..swiz;
            r34.y = samp0[]..swiz;
            r34.z = samp0[]..swiz;
            r34.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r35.xyzw, r10.y, l(148), t15.zwxy
            r35.x = samp0[]..swiz;
            r35.y = samp0[]..swiz;
            r35.z = samp0[]..swiz;
            r35.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r36.xyzw, r10.y, l(164), t15.zwxy
            r36.x = samp0[]..swiz;
            r36.y = samp0[]..swiz;
            r36.z = samp0[]..swiz;
            r36.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r37.xyzw, r10.y, l(180), t15.zwxy
            r37.x = samp0[]..swiz;
            r37.y = samp0[]..swiz;
            r37.z = samp0[]..swiz;
            r37.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r38.xyzw, r10.y, l(196), t15.xyzw
            r38.x = samp0[]..swiz;
            r38.y = samp0[]..swiz;
            r38.z = samp0[]..swiz;
            r38.w = samp0[]..swiz;
            // Known bad code for instruction (needs manual fix):
                        ld_structured_indexable(structured_buffer, stride=224)(mixed,mixed,mixed,mixed) r39.xy, r10.y, l(212), t15.xyxx
            r39.x = samp0[]..swiz;
            r39.y = samp0[]..swiz;
              r25.z = r28.y * r10.w + r25.z;
              r10.y = r10.z * r27.z;
              r27.z = r34.z;
              r10.z = dot(r11.xyz, r27.xyz);
              ...
              r34.w = (uint)r10.w;
              r17.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r34.xyzw, r10.z).xyz;
              ...
              r17.yzw = r10.zzz ? float3(1,1,0) : r17.yzw;
              ...
              r34.x = dot(r4.xyz, r26.xyz);
              r34.y = dot(r4.xyz, r27.xyz);
              ...
              r26.x = r24.w;
              r26.yz = r25.xy;
              r25.xyw = r14.yzx * r10.yyy + r26.yzx;
              r24.w = r25.w;
            }
          }
        }
    ...
    if (r7.z != 0) {
      ...
      r7.w = 0;
      while (true) {
        r8.w = cmp((uint)r7.w >= (uint)r1.z);
        if (r8.w != 0) break;
        r13.z = (uint)r7.w >> 5;
        r14.xyz = (int3)r12.xyz + (int3)r13.xyz;
        r8.w = visibleProbes.Load(r14.xyzw).x;
        r10.y = cmp((int)r2.x == (int)r7.w);
        if (r2.y == 0) r10.z = 0; else if (r2.y+0 < 32) {         r10.z = (uint)r8.w << (32-(r2.y + 0)); r10.z = (uint)r10.z >> (32-r2.y);        } else r10.z = (uint)r8.w >> 0;
    ...
    if (r2.x != 0) {
      ...
      r2.y = dot(r9.yzw, float3(0.212599993,0.715200007,0.0722000003));
  ...
  if (r5.w == 0) {
    ...
    if (r8.w != 0) {
      ...
      r14.xz = rcp(r10.yy);
      r14.y = -r14.z;
      r10.yzw = r9.yzy * r14.xyz + r10.zwz;
      ...
      r10.yzw = min(r10.yzw, r14.xyz);
      r14.xy = sunConstants.sstLightingConstants.coordScale * r10.wz;
      r14.xy = floor(r14.xy);
    ...
    r12.w = samp0[]..swiz;
      r14.x = (int)r12.w & 0x40000000;
      r14.y = (uint)r12.w << 2;
      if (r14.x == 0) {
        r14.x = (int)r12.w & 0x01ffffff;
      ...
      r12.w = samp0[]..swiz;
        r12.w = r14.z ? r15.z : r12.w;
        r14.z = (uint)r12.w >> 13;
        r12.w = r14.x ? r14.z : r12.w;
      ...
      r16.w = samp0[]..swiz;
        r14.xzw = r12.www ? r14.xzw : r16.xzw;
        r14.xzw = r11.www ? r15.xyz : r14.xzw;
        r11.w = (int)r14.w & 0xc0000000;
        if (r11.w == 0) {
          r11.w = (int)-r14.z + 6;
          r15.xy = (uint2)r10.wz >> (uint2)r11.ww;
          r11.w = (int)r14.w | 0x40000000;
          bitmask.w = ((~(-1 << 1)) << 1) & 0xffffffff;  r12.w = (((uint)r15.y << 1) & bitmask.w) | ((uint)0 & ~bitmask.w);
          bitmask.w = ((~(-1 << 1)) << 0) & 0xffffffff;  r12.w = (((uint)r15.x << 0) & bitmask.w) | ((uint)r12.w & ~bitmask.w);
          r12.w = (int)r12.w * 10;
        ...
        r16.z = samp0[]..swiz;
          ...
          r12.w = (int)-r16.y + 6;
          r15.yz = (uint2)r10.wz >> (uint2)r12.ww;
        ...
        r17.y = samp0[]..swiz;
          r15.yz = r12.ww ? r16.xz : r17.xy;
          r14.xw = r11.ww ? r15.xw : r15.yz;
        }
        r11.w = (int)r14.w & 0xc0000000;
        if (r11.w == 0) {
          if (14 == 0) r12.w = 0; else if (14+15 < 32) {           r12.w = (uint)r14.w << (32-(14 + 15)); r12.w = (uint)r12.w >> (32-14);          } else r12.w = (uint)r14.w >> 15;
          r12.w = (uint)r12.w;
        ...
        r15.x = samp0[]..swiz;
          bitmask.x = ((~(-1 << 2)) << 3) & 0xffffffff;  r16.x = (((uint)r10.y << 3) & bitmask.x) | ((uint)0 & ~bitmask.x);
          bitmask.y = ((~(-1 << 2)) << 1) & 0xffffffff;  r16.y = (((uint)r10.z << 1) & bitmask.y) | ((uint)0 & ~bitmask.y);
          bitmask.z = ((~(-1 << 1)) << 4) & 0xffffffff;  r16.z = (((uint)r10.w << 4) & bitmask.z) | ((uint)0 & ~bitmask.z);
          r10.y = (uint)r15.x >> (uint)r16.x;
          r10.y = (int)r10.y & 255;
          r10.y = (uint)r10.y;
          r10.y = r10.y * r14.z;
    ...
    if (r8.w == 0) {
      if (enableDitheredShadow == 0) {
        ...
        r14.xy = r10.yz * float2(0.5,-0.5) + float2(0.5,0.5);
  ...
  if (r5.w != 0) {
    ...
    if (r5.w != 0) {
      ...
      r17.w = samp0[]..swiz;
        ...
        r18.xyz = r4.xyz * r8.www + v6.xyz;
        r18.w = 1;
        r14.x = dot(r14.xyzw, r18.xyzw);
        r14.y = dot(r15.xyzw, r18.xyzw);
        r10.yz = r14.xy * float2(0.5,-0.5) + float2(0.5,0.5);
        r10.yz = r10.yz + r17.zw;
        r10.yz = r10.yz * r17.xy;
        r14.xy = r7.ww / r16.xz;
        r14.zw = float2(1,1) + -r14.xy;
        r14.zw = cmp(r10.yz >= r14.zw);
        r14.xy = cmp(r14.xy >= r10.yz);
        ...
        r15.y = samp0[]..swiz;
          ...
          if (enableDitheredShadow != 0) {
            ...
            while (true) {
              ...
              r10.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r7.z).x;
              r10.y = r10.w * 0.125 + r10.y;
              r10.z = (int)r10.z + 1;
            }
          } else {
            r14.z = (uint)r8.w;
            r10.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r14.xyz, r7.z).x;
          }
          r7.z = r10.y * r10.y;
          r7.z = r7.z * r10.y;
        } else {
            ...
            if (r19.w != 0) {
              ...
              if (r19.w != 0) {
                ...
                if (r19.w != 0) {
                  ...
                  r8.w = exp2(r8.w);
                  r8.w = r11.w * r8.w;
                  r39.xyz = r8.www * r32.xyz + r16.xyz;
