...
discard_nz r1.y
sample_indexable(texture2d)(float,float,float,float) r1.y, v1.yzyy, t6.yxzw, s2
...
sample_indexable(texture2d)(float,float,float,float) r1.y, v1.yzyy, t10.yxzw, s4
sample_indexable(texture2d)(float,float,float,float) r1.z, v1.yzyy, t9.yzxw, s2
...
mad r3.xyz, r5.xyzx, r3.zzzz, r6.xyzx
...
mad r6.yzw, cb1[60].wwww, r1.yyzw, r3.xxyz
mul r1.yz, v1.yyzy, cb0[12].xxyx
sample_indexable(texture2d)(float,float,float,float) r1.yz, r1.yzyy, t14.zxyw, s6
add r3.xyz, cb1[42].xyzx, l(-1.000000, -1.000000, -1.000000, 0.000000)
mad r3.xyz, r1.yyyy, r3.xyzx, l(1.000000, 1.000000, 1.000000, 0.000000)
add r7.xyz, -r3.xyzx, cb1[43].xyzx
mad r1.yzw, r1.zzzz, r7.xxyz, r3.xxyz
...
rsq r5.z, r5.z
mul r7.xyz, r5.zzzz, -v6.xyzx
dp3_sat r5.z, r6.yzwy, r7.xyzx
...
movc o0.xyz, r2.wwww, r1.yzwy, r3.xyzx
movc r0.xyz, r2.wwww, r0.xyzx, r2.xyzx
div r1.yz, v5.xxyx, v5.wwww
mul r2.xy, cb1[44].xyxx, l(0.500000, 0.500000, 0.000000, 0.000000)
mul r3.x, r1.y, r2.x
mul r3.y, r1.z, -r2.y
mad r1.yz, cb1[44].xxyx, l(0.000000, 0.500000, 0.500000, 0.000000), r3.xxyx
add r1.yz, -r1.yyzy, v0.xxyx
add r0.w, r5.y, r5.x
mad r0.w, r4.z, r3.w, r0.w
mul r0.w, r0.w, l(0.500000)
mad r2.xyz, r4.xyzx, r3.wwww, -r0.wwww
max r1.w, r2.z, r2.y
max r1.w, r1.w, r2.x
max r0.w, r0.w, r1.w
eq r1.w, r0.w, r2.x
mul r3.yzw, r6.yyzw, l(0.000000, 1.000000, -1.000000, -1.000000)
add r2.x, r0.w, l(2.000000)
mov r3.x, l(1)
mov r6.x, l(0)
movc r3.xyzw, r1.wwww, r3.xyzw, r6.xyzw
