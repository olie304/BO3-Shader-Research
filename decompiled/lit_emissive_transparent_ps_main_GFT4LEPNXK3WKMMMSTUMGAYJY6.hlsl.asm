...
add r4.xyw, -r2.xyxz, cb1[61].xyxz
mad r2.xyz, cb1[61].wwww, r4.xywx, r2.xyzx
add r1.w, -r3.x, r3.y
mad r1.w, cb1[62].w, r1.w, r3.x
add r3.x, -r2.w, cb1[63].x
mad r2.w, cb1[63].w, r3.x, r2.w
