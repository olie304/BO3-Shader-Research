...
dcl_output o1.x
dcl_temps 3
mad r0.xyzw, v0.xyxy, l(2.000000, 2.000000, 2.000000, 2.000000), l(-1.000000, -1.000000, -1.000000, -1.000000)
...
mul r1.z, r1.z, cb8[1].y
mad r1.z, r1.y, cb8[1].x, r1.z
mul r1.y, r1.y, r1.y
mad r1.y, r1.y, cb8[1].z, r1.z
add r1.y, r1.y, cb8[1].w
mul r2.xyzw, r1.yyyy, cb8[0].zzww
...
min r1.yz, r0.wwyw, r0.zzxz
min r1.y, r1.z, r1.y
lt r1.y, r1.y, l(0.000000)
max r1.zw, r0.wwwy, r0.zzzx
mul r0.xyzw, r0.xyzw, cb8[2].xyxy
max r1.z, r1.w, r1.z
lt r1.z, l(1.000000), r1.z
or r1.y, r1.z, r1.y
movc r1.xy, r1.xyxx, l(0.750000,0.250000,0,0), l(1.000000,1.000000,0,0)
mul r1.x, r1.x, r1.y
sample_indexable(texture2d)(float,float,float,float) r1.y, r0.zwzz, t5.wxyz, s1
sample_indexable(texture2d)(float,float,float,float) r1.zw, r0.xyxx, t5.wxyz, s1
mul r0.xyz, r1.xxxx, r1.yzwy
