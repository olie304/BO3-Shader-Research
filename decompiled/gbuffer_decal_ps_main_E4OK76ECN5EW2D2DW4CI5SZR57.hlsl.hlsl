// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:28:01 2021
  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  if (r1.y != 0) {
    ...
    r0.z = cmp(r1.z < r0.y);
    r0.y = cmp(0 < r0.y);
    r3.xyw = (int3)r1.yyy & int3(1,2,4);
    r5.xyz = r3.xxx ? float3(1,0,1) : r2.xyz;
    r6.xyz = r3.yyy ? float3(0,1,1) : r2.xyz;
    r5.xyz = r0.yyy ? r5.xyz : r6.xyz;
    r3.xyw = r3.www ? float3(0,1,0) : r2.xyz;
    r2.xyz = r0.zzz ? r5.xyz : r3.xyw;
  }
  r3.xyw = debugColorOverride.xyz + -r2.xyz;
  r2.xyz = debugColorOverride.www * r3.xyw + r2.xyz;
  ...
  r5.z = debugOcclusionOverride.w * r1.y + 1;
  r1.yzw = v5.xyz * r3.zzz + -r4.xyz;
