// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:44:10 2021
...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  if (r3.w == 0) {
    ...
    if (r8.x != 0) {
      ...
      while (true) {
        ...
        if (r8.z != 0) break;
        r8.z = (uint)r8.x;
        r9.xy = -sunConstants.splitPinTransform[r8.z].xy + r6.yz;
    ...
    if (r8.z != 0) {
      ...
      r10.xy = floor(r10.xy);
      r8.w = sunConstants.sstLightingConstants.constants.dimensionInTiles.x * r10.y;
      r8.w = r8.w * sunConstants.sstLightingConstants.coordScale + r10.x;
      r8.w = (uint)r8.w;
    ...
    r9.w = samp0[]..swiz;
      r10.x = (int)r9.w & 0x40000000;
      r10.y = (uint)r9.w << 2;
      if (r10.x == 0) {
        r10.x = (int)r9.w & 0x01ffffff;
        r11.x = (int)r8.w + (int)r10.x;
        r8.w = (uint)r9.w >> 25;
        r8.w = (uint)r8.w;
      ...
      r11.z = samp0[]..swiz;
        r10.xz = (uint2)r9.zy >> int2(6,6);
        r8.w = (int)r11.z & 0xc0000000;
        r9.w = (int)r11.x + 1;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r9.w, r9.w, l(0), t23.xxxx
      r9.w = samp0[]..swiz;
        r9.w = r10.z ? r11.z : r9.w;
        r10.z = (uint)r9.w >> 13;
        r9.w = r10.x ? r10.z : r9.w;
        r9.w = (int)r9.w & 8191;
        r12.x = (int)r9.w + (int)r11.x;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r12.z, r12.x, l(0), t23.xxxx
      r12.z = samp0[]..swiz;
        r11.y = 0;
        r12.y = 1;
        r10.xzw = r8.www ? r11.xyz : r12.xyz;
        r12.yz = r8.ww ? float2(8.40779079e-45,1.40129846e-45) : float2(7.00649232e-45,2.80259693e-45);
      ...
      r11.w = samp0[]..swiz;
        r11.w = r13.y ? r10.w : r11.w;
        r12.y = (uint)r11.w >> 13;
        r11.w = r13.x ? r12.y : r11.w;
        r11.w = (int)r11.w & 8191;
        r12.x = (int)r10.x + (int)r11.w;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r12.w, r12.x, l(0), t23.xxxx
      r12.w = samp0[]..swiz;
        r10.xzw = r9.www ? r10.xzw : r12.xzw;
        r10.xzw = r8.www ? r11.xyz : r10.xzw;
        r8.w = (int)r10.w & 0xc0000000;
        if (r8.w == 0) {
          r8.w = (int)-r10.z + 6;
          r11.xy = (uint2)r9.zy >> (uint2)r8.ww;
          r8.w = (int)r10.w | 0x40000000;
          bitmask.w = ((~(-1 << 1)) << 1) & 0xffffffff;  r9.w = (((uint)r11.y << 1) & bitmask.w) | ((uint)0 & ~bitmask.w);
          bitmask.w = ((~(-1 << 1)) << 0) & 0xffffffff;  r9.w = (((uint)r11.x << 0) & bitmask.w) | ((uint)r9.w & ~bitmask.w);
          r9.w = (int)r9.w * 10;
        ...
        r11.w = samp0[]..swiz;
          ...
          r8.w = (int)-r11.y + 6;
          r12.xy = (uint2)r9.zy >> (uint2)r8.ww;
          r8.w = (int)r11.w & 0xc0000000;
          r9.w = (int)r11.w | 0x40000000;
          bitmask.z = ((~(-1 << 1)) << 1) & 0xffffffff;  r10.z = (((uint)r12.y << 1) & bitmask.z) | ((uint)0 & ~bitmask.z);
          bitmask.z = ((~(-1 << 1)) << 0) & 0xffffffff;  r10.z = (((uint)r12.x << 0) & bitmask.z) | ((uint)r10.z & ~bitmask.z);
          r10.z = (int)r10.z * 10;
          r9.w = (uint)r9.w >> (uint)r10.z;
          r9.w = (int)r9.w & 1023;
          r12.x = (int)r9.w + (int)r11.x;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r12.z, r12.x, l(0), t23.xxxx
        r12.z = samp0[]..swiz;
          r12.y = r11.z;
          r12.xyz = r8.www ? r11.xyw : r12.xyz;
          r9.w = (int)-r12.y + 6;
          r11.yz = (uint2)r9.zy >> (uint2)r9.ww;
          r9.w = (int)r12.z & 0xc0000000;
          r10.z = (int)r12.z | 0x40000000;
          ...
          r11.y = (int)r11.y * 10;
          r10.z = (uint)r10.z >> (uint)r11.y;
          r10.z = (int)r10.z & 1023;
          r13.x = (int)r10.z + (int)r12.x;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=4)(mixed,mixed,mixed,mixed) r13.y, r13.x, l(0), t23.xxxx
        r13.y = samp0[]..swiz;
          r11.yz = r9.ww ? r12.xz : r13.xy;
          r10.xw = r8.ww ? r11.xw : r11.yz;
        }
        r8.w = (int)r10.w & 0xc0000000;
        if (r8.w == 0) {
          if (14 == 0) r9.w = 0; else if (14+15 < 32) {           r9.w = (uint)r10.w << (32-(14 + 15)); r9.w = (uint)r9.w >> (32-14);          } else r9.w = (uint)r10.w >> 15;
          r9.w = (uint)r9.w;
        ...
        r11.x = samp0[]..swiz;
          ...
          r9.x = (uint)r11.x >> (uint)r12.x;
          r9.x = (int)r9.x & 255;
          r9.x = (uint)r9.x;
          r9.x = r9.x * r10.z;
          r9.x = r9.x * 0.00392156886 + r9.w;
          r9.y = (int)r12.y + 1;
        ...
        r9.y = samp0[]..swiz;
          ...
          r9.y = (uint)r9.y;
          r9.y = r9.y * r10.z;
          r9.y = r9.y * 1.52590219e-05 + r9.w;
          r10.y = r11.y ? r9.x : r9.y;
        } else {
    ...
    if (r8.z == 0) {
      if (enableDitheredShadow == 0) {
        r6.w = (uint)r8.x;
        r8.zw = -sunConstants.splitPinTransform[r6.w].xy + r6.yz;
        r8.zw = sunConstants.splitPinTransform[r6.w].zz * r8.zw;
        r9.xy = r8.zw * float2(0.5,-0.5) + float2(0.5,0.5);
        r6.w = (int16)sunConstants.splitArrayOffset;
        r9.z = r8.x + r6.w;
        r6.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r9.xyz, r3.w).x;
        r8.z = gTransShadowmapArray.SampleLevel(samp0_s, r9.xyz, 0).x;
        r6.w = r8.z + r6.w;
      ...
      if (enableDitheredShadow != 0) {
        ...
        r6.yz = -sunConstants.splitPinTransform[r8.x].xy + r6.yz;
        r6.yz = sunConstants.splitPinTransform[r8.x].zz * r6.yz;
        ...
        r10.x = 0;
        while (true) {
          r10.y = cmp((uint)r10.x >= 8);
          if (r10.y != 0) break;
          r10.y = cmp((uint)r8.y < (uint)r10.x);
          r10.zw = r10.yy ? r6.yz : r8.zw;
          r11.x = r10.y ? sunConstants.splitPinTransform[r8.x].w : sunConstants.splitPinTransform[r6.w].w;
          r10.y = r10.y ? r8.x : r6.w;
          r12.x = dot(icb[r10.x+0].yx, r9.xy);
          r12.y = dot(icb[r10.x+0].yx, r9.yz);
          r11.xy = r12.xy * r11.xx + r10.zw;
          r10.y = (int)r10.y + (int16)sunConstants.splitArrayOffset;
          r11.z = (uint)r10.y;
          r10.y = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r11.xyz, r3.w).x;
          r10.z = gTransShadowmapArray.SampleLevel(samp0_s, r11.xyz, 0).x;
          r10.y = r10.y + r10.z;
          r10.y = saturate(-1 + r10.y);
          r9.w = r10.y * 0.125 + r9.w;
          r10.x = (int)r10.x + 1;
        }
        r3.w = r9.w * r9.w;
        r5.w = r3.w * r9.w;
  ...
  r11.w = samp0[]..swiz;
    ...
    r8.zw = cmp(r6.zw >= r8.zw);
    r8.xy = cmp(r8.xy >= r6.zw);
    r8.xy = (int2)r8.xy | (int2)r8.zw;
    r8.x = (int)r8.y | (int)r8.x;
    if (r8.x == 0) {
    // Known bad code for instruction (needs manual fix):
        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r8.x, r3.w, l(28), t12.xxxx
    r8.x = samp0[]..swiz;
    // Known bad code for instruction (needs manual fix):
        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r9.xyzw, r3.w, l(100), t12.xyzw
    r9.x = samp0[]..swiz;
    r9.y = samp0[]..swiz;
    r9.z = samp0[]..swiz;
    r9.w = samp0[]..swiz;
    // Known bad code for instruction (needs manual fix):
        ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r8.yz, r3.w, l(164), t12.xxyx
    r8.y = samp0[]..swiz;
    r8.z = samp0[]..swiz;
      r3.w = dot(r9.xyzw, r12.xyzw);
      r6.zw = saturate(r6.zw);
      r9.xy = r6.zw * r10.xz + r10.yw;
      r3.w = r3.w + r8.y;
      r3.w = r3.w / r8.z;
      r3.w = max(6.10351563e-05, r3.w);
      r6.z = r8.x ? 0.000000 : 0;
      if (enableDitheredShadow != 0) {
        r8.x = -r6.x;
        r10.z = (uint)r6.z;
        r8.y = r7.x;
        ...
        r9.z = (uint)r6.z;
        r6.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r9.xyz, r3.w).x;
      }
      r3.w = r6.x * r6.x;
      r3.w = r3.w * r6.x;
    } else {
  ...
  r8.xyz = -v5.xyz * r4.xxx + sunConstants.wldDir.xyz;
  ...
  r0.xyz = r6.xyz * r0.yyy + r7.yzw;
  r4.xyz = r6.xyz * abs(r0.www) + r7.yzw;
  ...
  if (r0.w != 0) {
    ...
    if (r1.x != 0) {
      ...
      r2.y = cmp(0.00999999978 < abs(v5.z));
      r2.z = fogConstants.atmospherefogheightdensityscale.x * v5.z;
