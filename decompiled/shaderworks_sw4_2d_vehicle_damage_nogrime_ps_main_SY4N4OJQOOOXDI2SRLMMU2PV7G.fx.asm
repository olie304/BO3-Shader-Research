...
// ------------------------------ ---------- ------- ----------- -------------- ------
// Vignette_Sampler                  sampler      NA          NA             s1      1 
// BlockNoise_Sampler                sampler      NA          NA             s2      1 
// Lookup2_Sampler                   sampler      NA          NA             s3      1 
// resolvedPostSun_C1_P0_sampler     sampler      NA          NA             s4      1 
// Vignette                          texture  float4          2d             t0      1 
// BlockNoise                        texture  float4          2d             t6      1 
// Lookup2                           texture  float4          2d             t7      1 
...
dcl_output o0.xyzw
dcl_temps 3
mul r0.xy, v1.xyxx, l(0.313100, 0.313100, 0.000000, 0.000000)
...
mov_sat r1.x, cb3[0].x
mad r1.y, r1.x, l(2.000000), l(-1.000000)
mul r1.x, r1.x, cb0[10].x
mul r1.x, r1.x, l(0.050000)
max r1.y, r1.y, l(0.000000)
mul r0.xyzw, r0.xyzw, r1.yyyy
add r1.y, cb1[69].w, l(0.500000)
ge r1.z, r1.y, -r1.y
frc r1.y, |r1.y|
movc r2.x, r1.z, r1.y, -r1.y
mov r2.yw, v1.yyyy
sample_indexable(texture2d)(float,float,float,float) r1.y, r2.xyxx, t7.yxzw, s3
max r1.y, r1.y, l(0.500000)
mad r1.y, r1.y, l(2.000000), l(-1.000000)
mad r2.z, r1.y, r1.x, v1.x
mul r1.x, r1.x, r1.y
mad r1.xy, r1.xxxx, l(0.500000, -0.250000, 0.000000, 0.000000), v1.xxxx
sample_indexable(texture2d)(float,float,float,float) r2.x, r2.zwzz, t9.xyzw, s4
mov r1.z, v1.y
sample_indexable(texture2d)(float,float,float,float) r2.y, r1.xzxx, t9.xyzw, s4
sample_indexable(texture2d)(float,float,float,float) r2.z, r1.yzyy, t9.xyzw, s4
mov r2.w, l(0)
mad r0.xyzw, r0.xyzw, l(0.33333334, 0.33333334, 0.33333334, 0.33333334), r2.xyzw
