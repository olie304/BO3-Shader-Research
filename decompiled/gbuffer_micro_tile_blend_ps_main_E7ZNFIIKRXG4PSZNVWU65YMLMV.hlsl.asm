...
sample_indexable(texture2d)(float,float,float,float) r6.xyz, r2.yzyy, t12.xyzw, s3
...
mad r5.w, r4.x, cb0[12].z, r0.w
mad r1.xy, r4.yzyy, cb0[12].wwww, r0.yzyy
dp3 r0.y, r1.xyzx, r1.xyzx
rsq r0.y, r0.y
mul r4.xyz, r0.yyyy, r1.xyzx
mad r4.w, r3.w, cb0[12].w, r0.w
...
mul r1.yzw, r2.xxyw, cb0[11].xxyz
mul r0.y, r0.x, r1.w
...
mad r4.xyz, r4.xyzx, r1.xxxx, -r0.zzzz
max r1.x, r4.z, r4.y
max r1.x, r1.x, r4.x
max r0.z, r0.z, r1.x
eq r1.x, r0.z, r4.x
...
ftou r0.zw, v0.xxxy
mad r3.y, r1.y, r0.x, -r0.y
mad r0.y, r3.y, l(0.500000), r0.y
mad r3.z, r1.z, r0.x, -r0.y
...
mul r0.zw, |r5.zzzw|, l(0.000000, 0.000000, 0.100000, 0.100000)
...
ge r0.zw, r5.zzzw, l(0.000000, 0.000000, 0.000000, 0.000000)
