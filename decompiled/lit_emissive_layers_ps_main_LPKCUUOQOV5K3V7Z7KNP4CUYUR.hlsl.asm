          ...
          if_nz r14.w
            ...
            if_nz r14.w
              ...
              if_nz r25.y
                ...
                mul r27.xyz, r3.yyyy, r28.xyzx
                mul r25.xyz, r3.yyyy, r25.xyzx
                mul r26.xyz, r3.yyyy, r26.xyzx
...
mad r2.xyz, r2.xyzx, r0.zzzz, r15.xyzx
mad r0.w, r0.w, r0.z, r14.x
mad r3.xyz, r3.xzwx, r0.zzzz, r16.xyzx
dp3 r2.w, r3.xyzx, r3.xyzx
rsq r2.w, r2.w
mul r3.xyz, r2.wwww, r3.xyzx
mad r8.y, r1.w, r0.z, r14.y
mad r9.xyz, r0.zzzz, l(0.040000, 0.040000, 0.040000, 0.000000), r17.xyzx
lt r1.w, l(0.500000), cb0[19].x
if_nz r1.w
  mul r1.w, cb0[11].w, cb0[11].z
  mul r2.w, r1.w, cb0[12].x
  ...
  round_z r1.w, r1.w
  add r1.w, r1.w, r1.x
  div r10.x, r1.w, cb0[11].w
  round_z r1.w, r2.w
  add r1.w, r1.w, r1.y
  div r10.y, r1.w, cb0[11].z
else 
...
if_nz r2.w
  ...
  dp3 r2.w, r12.xyzx, r4.xyzx
  lt r4.w, l(0.000000), r2.w
  div r7.zw, -r13.xxxy, r2.wwww
  ...
  mov r13.y, r13.x
  mov r13.z, r12.x
  dp2 r14.x, r13.yzyy, r7.zwzz
  mov r13.x, -r12.x
  dp2 r14.y, r13.xyxx, r7.zwzz
  mul r7.zw, cb0[22].xxxy, cb1[69].wwww
  mad r7.zw, r7.zzzw, cb0[22].zzzw, r14.xxxy
  mul r2.w, cb0[24].x, cb1[69].w
  sincos null, r2.w, r2.w
  mad r2.w, r2.w, l(0.500000), l(0.500000)
  add r2.w, -r2.w, l(1.000000)
  add r4.w, -cb0[23].z, cb0[23].w
  mad r2.w, r2.w, r4.w, cb0[23].z
  div r7.zw, r7.zzzw, r2.wwww
  add r7.zw, r7.zzzw, l(0.000000, 0.000000, 0.500000, 0.500000)
  mov_sat r8.zw, r7.zzzw
  movc r11.x, cb0[24].w, r8.z, r7.z
  movc r11.y, cb0[25].x, r8.w, r7.w
endif 
...
loop 
  ...
  ieq r10.w, r0.y, r8.w
  bfi r11.y, r7.x, l(0), l(0), r9.w
  movc r9.w, r10.w, r11.y, r9.w
  ieq r10.w, r7.y, r8.w
  ubfe r11.y, r8.z, l(0), r9.w
  movc r9.w, r10.w, r11.y, r9.w
...
if_nz r5.w
  ...
  mad r7.xyz, r21.xyzx, r0.yyyy, r14.xyzx
  mov r12.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r14.xyz, r12.xyzw, t8.xyzw, s2, r6.z
  mad r0.y, cb2[19].x, r5.w, -r3.w
  mad r0.y, r8.y, r0.y, r3.w
...
mad r6.zw, r8.xxxy, l(0.000000, 0.000000, 0.984375, 0.984375), l(0.000000, 0.000000, 0.00781250, 0.00781250)
sample_l_indexable(texture2d)(float,float,float,float) r6.zw, r6.zwzz, t5.zwxy, s2, l(0.000000)
mul r8.yzw, r0.yyyy, r11.yyzw
mul r14.xyz, r6.zzzz, r8.zwyz
  ...
  if_z r12.w
    ...
    if_nz cb2[58].y
      ...
      loop 
        ...
        movc r17.x, r15.w, cb2[r9.w + 20].w, cb2[r11.w + 20].w
        movc r15.w, r15.w, r9.w, r11.w
...
if_nz r6.z
  ...
  if_nz r6.z
    ...
    if_nz r10.w
      ...
      mad r19.xyz, r3.xyzx, r12.wwww, v6.xyzx
      ...
      if_z r12.w
        ...
        if_nz cb2[58].y
          ...
          loop 
            ...
            sample_c_lz_indexable(texture2darray)(float,float,float,float) r16.w, r17.xyzx, t9.xxxx, s13, r9.w
    ...
    mad r16.xyz, r5.wwww, r11.yzwy, r8.yzwy
    ...
    mov r15.w, r17.z
    mov r7.w, r14.z
    movc r7.xyzw, r3.wwww, r15.xyzw, r7.xyzw
    mov r17.zw, r16.xxxy
    mov r14.zw, r8.yyyz
    movc r15.xyzw, r3.wwww, r17.xyzw, r14.xyzw
    movc r8.w, r3.w, r16.z, r8.w
    mov r14.z, r7.w
    mov r14.xy, r15.xyxx
    mov r8.yz, r15.zzwz
  endif 
...
not r0.z, r2.w
mad r3.w, -r8.x, l(0.500000), l(1.000000)
mov r15.x, -r6.x
          ...
          if_nz r21.w
            ...
            if_nz r21.w
              ...
              if_nz r21.w
                ...
                mad r42.xyz, r3.xyzx, r21.wwww, v6.xyzx
...
ret 
// Approximately 2850 instruction slots used
