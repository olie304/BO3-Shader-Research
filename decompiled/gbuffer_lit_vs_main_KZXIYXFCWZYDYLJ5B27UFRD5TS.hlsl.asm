...
mad r5.xyz, v3.xyzx, l(2.001957, 2.001957, 2.001957, 0.000000), l(-1.00195694, -1.00195694, -1.00195694, 0.000000)
mul r6.xyz, r5.xyzx, cb0[16].wwww
mul r6.xyz, r0.yyyy, r6.xyzx
mad r6.xyz, r6.xyzx, v1.wwww, v0.xyzx
mov r6.w, l(1.000000)
dp4 r0.y, r6.xyzw, r3.xyzw
mul r7.xyzw, r0.yyyy, cb1[9].xyzw
mov r1.w, r2.x
mov r4.w, r2.z
dp4 r0.y, r6.xyzw, r1.xyzw
mad r2.xyzw, r0.yyyy, cb1[8].xyzw, r7.xyzw
dp4 r0.y, r6.xyzw, r4.xyzw
mad r2.xyzw, r0.yyyy, cb1[10].xyzw, r2.xyzw
...
rsq r0.y, r0.y
mul o4.xyz, r0.yyyy, r2.xyzx
mad r2.xyz, v4.xyzx, l(2.001957, 2.001957, 2.001957, 0.000000), l(-1.00195694, -1.00195694, -1.00195694, 0.000000)
dp3 r7.x, r2.xyzx, r1.xyzx
dp3 r7.y, r2.xyzx, r3.xyzx
dp3 r7.z, r2.xyzx, r4.xyzx
dp3 r0.y, r7.xyzx, r7.xyzx
rsq r0.y, r0.y
mul o5.xyz, r0.yyyy, r7.xyzx
mul r7.xyz, r2.yzxy, r5.zxyz
mad r2.xyz, r5.yzxy, r2.zxyz, -r7.xyzx
