...
ld_raw r11.xyzw, l(80), g3.xyzw
  ...
  r2.zw = frac(r2.zw);
  r10.xy = float2(1,1) + -r2.wz;
  r21.y = r10.y * r10.x;
  r21.xz = r10.xy * r2.zw;
  r21.w = r2.z * r2.w;
  r2.z = dot(r19.xyzw, r21.xyzw);
  r10.xyzw = r20.xyzw + -r3.zzzz;
  r2.w = min(abs(r10.z), abs(r10.w));
  r2.w = min(abs(r10.y), r2.w);
  r2.w = min(abs(r10.x), r2.w);
  r3.w = max(abs(r10.z), abs(r10.w));
  r3.w = max(abs(r10.y), r3.w);
  r3.w = max(abs(r10.x), r3.w);
  r10.xyz = cmp(r2.www == abs(r10.yzw));
  r2.w = r10.x ? r19.y : r19.x;
  r2.w = r10.y ? r19.z : r2.w;
  r2.w = r10.z ? r19.w : r2.w;
  r3.z = 0.00999999978 * r3.z;
  r3.z = cmp(r3.z < r3.w);
  r2.z = r3.z ? r2.w : r2.z;
  r2.w = r5.z * r2.z;
