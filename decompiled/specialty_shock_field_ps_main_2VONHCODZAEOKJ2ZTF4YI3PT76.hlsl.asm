...
sample_indexable(texture2d)(float,float,float,float) r1.xyz, r1.xyxx, t29.xyzw, s1
if_nz r0.w
  mov o0.xyzw, l(0,0,0,0)
  ret 
endif 
sample_indexable(texture2d)(float,float,float,float) r0.w, v2.xyxx, t25.yzwx, s3
sample_indexable(texture2d)(float,float,float,float) r4.x, v2.xyxx, t26.xyzw, s6
...
sample_indexable(texture2d)(float,float,float,float) r6.xyzw, v2.xyxx, t30.xyzw, s1
mul r7.xyz, r6.xyzx, cb0[10].xyzx
dp3 r1.w, -v7.xyzx, -v7.xyzx
rsq r1.w, r1.w
mul r8.xyz, r1.wwww, -v7.xyzx
dp3_sat r4.x, v4.xyzx, r8.xyzx
...
dp3 r7.z, -r8.xyzx, r2.xyzx
add r7.z, r7.z, r7.z
mad r13.xyz, r2.xyzx, -r7.zzzz, -r8.xyzx
...
if_nz r11.y
  ...
  if_nz r11.y
    ...
    if_nz r14.x
      ...
      mad r19.xyz, r2.xyzx, r14.yyyy, v7.xyzx
    ...
    dp3 r1.w, r15.xyzx, r8.xyzx
    dp3 r11.w, r2.xyzx, r15.xyzx
    mad r15.x, |r11.w|, r7.z, -|r11.w|
          ...
          if_nz r30.w
            ...
            if_nz r30.w
              ...
              if_nz r30.w
                ...
                mad r44.xyz, r2.xyzx, r30.wwww, v7.xyzx
              ...
              if_nz r30.w
                ...
                if_nz r23.w
                  ...
                  mad r21.xyz, r2.xyzx, r31.wwww, v7.xyzx
                  ...
                  if_nz r21.x
                    ...
                    mad r22.xyz, r2.xyzx, r21.zzzz, v7.xyzx
          ...
          if_nz r21.z
            ...
            if_nz r21.z
              ...
              if_nz r21.z
                ...
                mad r24.xyz, r2.xyzx, r21.zzzz, v7.xyzx
              ...
              if_nz r21.z
                ...
                if_nz r24.x
                  ...
                  mad r25.xyz, r2.xyzx, r24.yyyy, v7.xyzx
                  ...
                  if_nz r24.x
                    ...
                    mad r24.y, |r18.w|, l(-0.200000), l(0.400000)
                    mad r26.xyz, r2.xyzx, r24.yyyy, v7.xyzx
...
if_nz r1.w
  sample_indexable(texture2d)(float,float,float,float) r1.w, v2.xyxx, t38.xyzw, s1
  sample_indexable(texture2d)(float,float,float,float) r2.xyzw, v2.xyxx, t46.xyzw, s1
...
mul r0.w, r6.w, r0.w
sample_indexable(texture2d)(float,float,float,float) r1.w, v2.zwzz, t37.yzwx, s1
...
ret 
// Approximately 2309 instruction slots used
