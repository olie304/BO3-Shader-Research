  ...
  out float2 o3 : SV_TARGET3)
{
  ...
  r3.w = specColorMap.Sample(specColorSampler_s, r2.xw).x;
  r4.xyz = float3(-0.0399999991,-0.0399999991,-0.0399999991) + specColorTint.xyz;
  r4.xyz = r3.www * r4.xyz + float3(0.0399999991,0.0399999991,0.0399999991);
  r4.w = glossMap.Sample(specColorSampler_s, r2.xw).x;
  r5.xyz = detailMap1.Sample(normalSampler_s, r2.xw).xyz;
  r2.xw = r5.xy * float2(1.9921875,1.9921875) + float2(-1,-1);
  r5.x = r5.z * r5.z;
  ...
  r8.y = r7.x;
  r8.z = r6.x;
  r6.x = dot(r2.yz, r8.yz);
  r6.y = dot(r2.yz, r8.xy);
  r2.yz = v3.yx + r6.xy;
  r2.yz = r2.yz + r1.ww;
  r2.yz = detailScale2.xy * r2.yz;
  r5.yz = float2(0.5,0.5) + r6.xy;
  r5.yz = detailScale2.xy * r5.yz;
  r2.yz = useUVOffsets1 ? r2.yz : r5.yz;
  r6.xyzw = colorMapDetail2.Sample(colorSampler_s, r2.yz).xyzw;
  r5.yzw = float3(-1,-1,-1) + colorTint1.xyz;
  r5.yzw = r6.www * r5.yzw + float3(1,1,1);
  r1.w = specularMapDetail2.Sample(specColorSampler_s, r2.yz).x;
  r7.xyz = float3(-0.0399999991,-0.0399999991,-0.0399999991) + specColorTint1.xyz;
  r7.xyz = r1.www * r7.xyz + float3(0.0399999991,0.0399999991,0.0399999991);
  r6.w = glossMapDetail2.Sample(specColorSampler_s, r2.yz).x;
  r8.xyz = detailMap2.Sample(normalSampler_s, r2.yz).xyz;
  r5.yzw = r6.xyz * r5.yzw + -r3.xyz;
  r3.xyz = r0.xxx * r5.yzw + r3.xyz;
  r3.xyz = v1.xyz * r3.xyz;
  r1.w = r1.w + -r3.w;
  r1.w = r0.x * r1.w + r3.w;
  r5.yzw = r7.xyz + -r4.xyz;
  r4.xyz = r0.xxx * r5.yzw + r4.xyz;
  r1.w = 1 + -r1.w;
  r3.xyz = r3.xyz * r1.www;
  r1.w = glossRange.y + -glossRange.x;
  r2.y = r4.w * r1.w + glossRange.x;
  r2.z = glossRange2.y + -glossRange2.x;
  r2.z = r6.w * r2.z + glossRange2.x;
  r2.yz = saturate(float2(0.0588235296,0.0588235296) * r2.yz);
  r2.z = r2.z + -r2.y;
  r2.y = r0.x * r2.z + r2.y;
  r2.z = aoMap.Sample(aoSampler_s, v2.xy).x;
  r5.yz = r8.xy * float2(1.9921875,1.9921875) + float2(-1,-1);
  r3.w = r8.z * r8.z;
  ...
  r6.w = r5.x * detailScaleHeight1 + r0.w;
  r1.xy = r5.yz * detailScaleHeight2 + r0.yz;
  r0.y = dot(r1.xyz, r1.xyz);
  r0.y = rsqrt(r0.y);
  r5.xyz = r1.xyz * r0.yyy;
  r5.w = r3.w * detailScaleHeight2 + r0.w;
  r5.xyzw = r5.xyzw + -r6.xyzw;
  r0.xyzw = r0.xxxx * r5.xyzw + r6.xyzw;
  r1.x = v8.x ? 1 : -1;
  ...
  r2.xyw = r8.xyz * r0.yyy;
  r2.xyw = r7.xyz * r0.xxx + r2.xyw;
  r0.xyz = r6.xyz * r0.zzz + r2.xyw;
  ...
  if (r1.w != 0) {
    ...
    r8.xyz = r7.xxx ? float3(1,0,1) : r3.xyz;
    r7.xyw = r7.yyy ? float3(0,1,1) : r3.xyz;
    r7.xyw = r2.yyy ? r8.xyz : r7.xyw;
    r8.xyz = r7.zzz ? float3(0,1,0) : r3.xyz;
    r3.xyz = r2.xxx ? r7.xyw : r8.xyz;
  }
  r2.xyw = debugColorOverride.xyz + -r3.xyz;
  o0.xyz = debugColorOverride.www * r2.xyw + r3.xyz;
  r2.xyw = debugSpecularOverride.xyz + -r4.xyz;
  r2.xyw = debugSpecularOverride.www * r2.xyw + r4.xyz;
  r1.z = r1.z * 1 + -r0.w;
  r0.w = debugGlossOverride.w * r1.z + r0.w;
  r1.z = debugOcclusionOverride.x + -r2.z;
  o2.z = debugOcclusionOverride.w * r1.z + r2.z;
  r1.yzw = v4.xyz * r1.yyy + -r0.xyz;
  r3.yzw = debugNormalOverride.www * r1.yzw + r0.xyz;
  r0.xy = v7.xy / v7.ww;
  r1.yz = float2(0.5,0.5) * renderTargetSize.xy;
  r4.x = r1.y * r0.x;
  r4.y = -r1.z * r0.y;
  r0.xy = renderTargetSize.xy * float2(0.5,0.5) + r4.xy;
  r0.xy = v0.xy + -r0.xy;
  r0.z = r6.x + r6.y;
  r0.z = r5.z * r1.x + r0.z;
  r0.z = 0.5 * r0.z;
  r1.xyz = r5.xyz * r1.xxx + -r0.zzz;
  r1.w = max(r1.y, r1.z);
  r1.w = max(r1.x, r1.w);
  r0.z = max(r1.w, r0.z);
  r1.x = cmp(r0.z == r1.x);
