...
cbuffer _Globals : register(b0)
{
  ...
  float3 colorTint1 : packoffset(c10);
  float3 colorTint2 : packoffset(c11);
  float3 colorTint3 : packoffset(c12);
  float3 colorTint : packoffset(c13);
  float baseNormalHeight : packoffset(c13.w);
  float2 glossRange : packoffset(c14);
}
...
SamplerState tintMaskSampler_s : register(s2);
  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r2.xyzw = tintMask.Sample(tintMaskSampler_s, r0.yz).xyzw;
  r3.xyz = float3(-1,-1,-1) + colorTint3.xyz;
  r3.xyz = r2.www * r3.xyz + float3(1,1,1);
  r4.xyz = colorTint2.xyz + -r3.xyz;
  r3.xyz = r2.zzz * r4.xyz + r3.xyz;
  r4.xyz = colorTint1.xyz + -r3.xyz;
  r2.yzw = r2.yyy * r4.xyz + r3.xyz;
  r3.xyz = colorTint.xyz + -r2.yzw;
  ...
  if (r2.z != 0) {
    ...
    r6.xyz = r3.yyy ? float3(0,1,1) : r1.xyz;
    r5.xyz = r0.yyy ? r5.xyz : r6.xyz;
    r3.xyw = r3.www ? float3(0,1,0) : r1.xyz;
    r1.xyz = r0.zzz ? r5.xyz : r3.xyw;
  }
  ...
  r2.z = debugOcclusionOverride.w * r2.x + 1;
  r3.xyz = v5.xyz * r3.zzz + -r4.xyz;
