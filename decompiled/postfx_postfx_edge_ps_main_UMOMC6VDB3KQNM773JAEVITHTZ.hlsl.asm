...
dcl_output o0.xyzw
dcl_temps 4
mad r0.xyzw, cb8[0].wwww, l(0.00078125, -0.00138889, -0.00078125, 0.00138889), v1.xyxy
...
add r0.w, r0.y, r0.x
mad r1.xyzw, cb8[0].wwww, l(0.00078125, 0.000000, 0.00078125, 0.00138889), v1.xyxy
...
mad r2.xyzw, cb8[0].wwww, l(-0.00078125, 0.000000, 0.000000, 0.00138889), v1.xyxy
...
add r0.x, r1.z, r1.x
mad r2.xyzw, cb8[0].wwww, l(0.000000, -0.00138889, -0.00078125, -0.00138889), v1.xyxy
sample_indexable(texture2d)(float,float,float,float) r1.x, r2.xyxx, t0.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r1.z, r2.zwzz, t0.yzxw, s0
add r0.yz, r1.xxzx, r1.wwyw
sample_indexable(texture2d)(float,float,float,float) r1.x, v1.xyxx, t0.xyzw, s0
mad r0.xyzw, r1.xxxx, l(2.000000, 2.000000, 2.000000, 2.000000), -r0.xyzw
mul r0.xyzw, |r0.xyzw|, l(1000.000000, 1000.000000, 1000.000000, 1000.000000)
div r0.xyzw, r0.xyzw, r1.xxxx
max r0.x, r0.y, r0.x
max r0.x, r0.z, r0.x
max r0.x, r0.w, r0.x
lt r0.y, r0.x, l(0.300000)
mov_sat r0.x, r0.x
sample_indexable(texture2d)(float,float,float,float) r0.z, v1.xyxx, t10.yzxw, s0
lt r0.w, r0.z, r1.x
lt r1.x, l(0.900000), r1.x
lt r0.z, l(0.000000), r0.z
and r0.z, r0.w, r0.z
or r0.z, r1.x, r0.z
sample_indexable(texture2d)(float,float,float,float) r1.xyzw, v1.xyxx, t9.xyzw, s0
movc r1.xyzw, r0.zzzz, l(0,0,0,0), r1.xyzw
dp3 r0.z, l(0.350000, 0.500000, 0.150000, 0.000000), r1.xyzx
lt r0.z, l(0.000010), r0.z
or r0.y, r0.z, r0.y
movc r0.x, r0.y, l(0), r0.x
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, v1.xyxx, t7.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r3.xyzw, v1.xyxx, t6.xyzw, s0
add r2.xyzw, r2.xyzw, -r3.xyzw
mad r2.xyzw, cb8[0].xxxx, r2.xyzw, r3.xyzw
