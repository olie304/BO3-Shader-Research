...
r0.y = samp0[]..swiz;
  ...
  while (true) {
    ...
    if (r15.y != 0) break;
    r15.y = r14.w ? r0.y : r14.z;
    r15.z = cmp((uint)r15.y >= (uint)r14.y);
    ...
    if (r15.z != 0) {
      ...
      r25.w = (int)r24.w + 1;
      r17.yzw = -refProbeConstantsCB[r15.y].data[0].xyz + r11.xyz;
  ...
  while (true) {
    ...
    if (r18.w != 0) break;
    r18.w = r14.w ? r0.y : r14.z;
    r19.w = cmp((uint)r18.w < (uint)r14.y);
    if (r19.w != 0) {
      r18.w = (int)r18.w * 14;
      if (r2.w != 0) {
        r19.w = (int)r20.y & 15;
  ...
  r0.y = r0.y ? r7.w : r20.y;
  r7.w = max(1, r20.x);
  r7.w = rcp(r7.w);
  r20.x = saturate(r20.x);
  r14.yzw = r15.yzw * r7.www;
  r17.xyz = r25.xyz * r7.www;
