...
// ------------------------------ ---------- ------- ----------- -------------- ------
// bilinearWrap                      sampler      NA          NA             s0      1 
// gridTex2D                         texture  float4          2d             t0      1 
...
mul r1.x, r1.x, r1.y
sample_indexable(texture2d)(float,float,float,float) r1.y, r0.zwzz, t0.wxyz, s0
sample_indexable(texture2d)(float,float,float,float) r1.zw, r0.xyxx, t0.wxyz, s0
mul o0.xyz, r1.xxxx, r1.yzwy
ret 
