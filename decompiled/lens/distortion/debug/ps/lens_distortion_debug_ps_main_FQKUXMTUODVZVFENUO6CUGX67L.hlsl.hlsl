...
SamplerState bilinearWrap_s : register(s0);
Texture2D<float4> gridTex2D : register(t0);
  ...
  out float3 o0 : SV_TARGET0)
{
  ...
  r1.z = r1.y * r1.x;
  r1.x = cmp(0.5 < r1.x);
  r1.z = postFxControl1.y * r1.z;
  r1.z = r1.y * postFxControl1.x + r1.z;
  r1.y = r1.y * r1.y;
  r1.y = r1.y * postFxControl1.z + r1.z;
  r1.y = postFxControl1.w + r1.y;
  r2.xyzw = postFxControl0.zzww * r1.yyyy;
  r0.xyzw = r2.xyzw * r0.xyzw;
  r0.xyzw = r0.xyzw * float4(0.5,0.5,0.5,0.5) + float4(0.5,0.5,0.5,0.5);
  r1.yz = min(r0.zx, r0.wy);
  r1.y = min(r1.y, r1.z);
  r1.y = cmp(r1.y < 0);
  r1.zw = max(r0.zx, r0.wy);
  r0.xyzw = postFxControl2.xyxy * r0.xyzw;
  r1.z = max(r1.z, r1.w);
  r1.z = cmp(1 < r1.z);
  r1.y = (int)r1.z | (int)r1.y;
  r1.xy = r1.xy ? float2(0.75,0.25) : float2(1,1);
  r1.x = r1.y * r1.x;
  r1.y = gridTex2D.Sample(bilinearWrap_s, r0.zw).x;
  r1.zw = gridTex2D.Sample(bilinearWrap_s, r0.xy).yz;
  o0.xyz = r1.yzw * r1.xxx;
  return;
}