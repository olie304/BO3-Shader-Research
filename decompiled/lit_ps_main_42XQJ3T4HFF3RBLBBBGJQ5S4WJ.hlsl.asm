...
if_nz r5.z
  ...
  if_nz r5.z
    ...
    if_nz r6.w
      ...
      mad r17.xyz, r1.xyzx, r7.wwww, v6.xyzx
    ...
    mad r14.xyz, -v6.xyzx, r2.wwww, cb2[17].xyzx
...
loop 
  ...
  ld_indexable(texture2darray)(uint,uint,uint,uint) r7.w, r14.xyzw, t6.yzwx
  mov r14.xyz, r8.yzwy
    ...
    if_nz r13.z
      ...
      if_nz r12.w
        ...
        switch r12.w
          ...
          dp3 r13.z, r36.xyzx, r38.xyzx
          div_sat r13.w, -r13.z, r35.x
          mad r39.xyz, r13.wwww, r36.xyzx, r37.xyzx
          ...
          if_nz r24.w
            ...
            if_nz r24.w
              ...
              if_nz r24.w
                ...
                mad r39.xyz, r1.xyzx, r24.wwww, v6.xyzx
                ...
                loop 
                  ige r28.w, r27.w, l(8)
                  breakc_nz r28.w
                  dp2 r41.y, icb[r27.w + 0].yxyy, r5.xyxx
                  dp2 r41.z, icb[r27.w + 0].yxyy, r5.yzyy
              ...
              if_nz r24.w
                ...
                mad r36.xyz, r13.zzzz, r36.xyzx, r37.xyzx
                ...
                if_nz r13.w
                  ...
                  mad r16.xyz, r1.xyzx, r25.wwww, v6.xyzx
                  ...
                  if_z r16.y
                    ...
                    if_nz r9.w
                      ...
                      loop 
                        ige r25.w, r16.z, l(8)
                        breakc_nz r25.w
                        dp2 r40.x, icb[r16.z + 0].yxyy, r5.xwxx
                        dp2 r40.y, icb[r16.z + 0].xyxx, r6.xyxx
                        mad r39.xy, r40.xyxx, r13.wwww, r38.xyxx
                  ...
                  if_nz r13.w
                    ...
                    mad r17.xyz, r1.xyzx, r16.xxxx, v6.xyzx
                    ...
                    if_z r16.z
                      ...
                      if_nz r9.w
                        ...
                        loop 
                          ...
                          mad r17.xy, r39.xyxx, r13.wwww, r38.xyxx
                ...
                mul r13.z, r18.w, r13.z
                mad r36.xyz, r13.zzzz, r30.xyzx, r28.xyzx
                add_sat r12.w, -r12.w, l(1.000000)
                mul r16.x, r12.w, r12.w
                mul r16.x, r16.x, r16.x
                mul r12.w, r12.w, r16.x
                mul r12.w, r12.w, r13.z
                mad r37.xyz, r12.wwww, r30.xyzx, r27.xyzx
                movc r14.xyz, r13.wwww, r17.xyzx, r14.xyzx
                movc r27.xyz, r13.wwww, r37.xyzx, r27.xyzx
                movc r28.xyz, r13.wwww, r36.xyzx, r28.xyzx
              endif 
            endif 
          endif 
          break 
          ...
          rsq r12.w, r12.w
          mul r36.xyz, r12.wwww, r17.xyzx
          dp3 r13.z, r1.xyzx, r36.xyzx
          mov_sat r13.w, r13.z
          ...
          if_nz r16.x
            ...
            if_nz r16.x
              ...
              if_nz r16.x
                ...
                mad r19.xyz, r1.xyzx, r16.xxxx, v6.xyzx
                ...
                if_nz r18.y
                  ...
                  if_nz r9.w
                    ...
                    loop 
                      ...
                      sample_c_lz_indexable(texture2darray)(float,float,float,float) r22.w, r31.xyzx, t9.xxxx, s13, r11.w
                      mad r18.x, r22.w, l(0.125000), r18.x
                      iadd r18.y, r18.y, l(1)
                    endloop 
                  else 
                    utof r19.z, r16.x
                    sample_c_lz_indexable(texture2darray)(float,float,float,float) r18.x, r19.xyzx, t9.xxxx, s13, r11.w
                  endif 
              ...
              if_nz r16.x
                ...
                if_nz r18.w
                  ...
                  mad r19.x, |r13.z|, l(-0.200000), l(0.400000)
                  ...
                  if_nz r18.w
                    ...
                    mad r19.x, |r13.z|, l(-0.200000), l(0.400000)
                    mad r21.xyz, r1.xyzx, r19.xxxx, v6.xyzx
                ...
                mad r17.xyz, r11.wwww, r29.xyzx, r28.xyzx
                add_sat r12.w, -r12.w, l(1.000000)
                mul r13.w, r12.w, r12.w
                mul r13.w, r13.w, r13.w
                mul r12.w, r12.w, r13.w
                mul r11.w, r11.w, r12.w
                mad r21.xyz, r11.wwww, r29.xyzx, r27.xyzx
                movc r14.xyz, r13.zzzz, r20.xyzx, r14.xyzx
                movc r27.xyz, r13.zzzz, r21.xyzx, r27.xyzx
                movc r28.xyz, r13.zzzz, r17.xyzx, r28.xyzx
              endif 
            endif 
          endif 
          break 
...
ret 
// Approximately 1871 instruction slots used
