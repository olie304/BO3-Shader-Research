...
sample_indexable(texture2d)(float,float,float,float) r0.y, r0.yzyy, t9.yxzw, s1
add r2.xyz, cb0[10].xyzx, l(-1.000000, -1.000000, -1.000000, 0.000000)
mad r0.yzw, r0.yyyy, r2.xxyz, l(0.000000, 1.000000, 1.000000, 1.000000)
mul r0.xyzw, r0.xyzw, r1.wxyz
