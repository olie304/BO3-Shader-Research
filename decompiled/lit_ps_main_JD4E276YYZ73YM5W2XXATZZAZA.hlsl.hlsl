...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r0.w = r0.w + -r1.x;
  r4.y = debugGlossOverride.w * r0.w + r1.x;
  ...
  if (r1.x == 0) {
    ...
    if (r9.y != 0) {
      ...
      r10.z = 0;
      while (true) {
        r10.w = cmp((uint)r10.z >= (uint)r1.x);
        if (r10.w != 0) break;
        r13.z = (uint)r10.z >> 5;
        r14.xyz = (int3)r12.xyz + (int3)r13.xyz;
    ...
    if (r4.z != 0) {
      ...
      r20.xyz = r22.xyz * r1.xxx + r9.yzw;
      r11.w = 0;
      r9.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r11.xyzw, r7.z).xyz;
      r1.x = sunConstants.globalProbeExposure * r4.z + -r3.w;
      r1.x = r4.y * r1.x + r3.w;
      r21.xyz = r9.yzw * r1.xxx + r21.xyz;
    }
  } else {
    r21.x = r20.w;
  }
  ...
  r9.yzw = r21.xyz * r1.xxx;
  r14.xyz = r9.zwy * r4.yyy;
  r4.yzw = r9.yzw * r4.zzz;
  r0.w = sqrt(r6.z);
  r0.w = r0.w * 0.5 + 0.5;
  r0.w = r0.w * r0.w;
  r1.x = 0.5 * r0.w;
  ...
  if (r7.z != 0) {
    ...
    if (r7.z != 0) {
      ...
      r18.z = samp0[]..swiz;
      r18.w = samp0[]..swiz;
        r10.z = abs(r3.w) * -0.200000003 + 0.400000006;
        r19.xyz = r3.xyz * r10.zzz + v6.xyz;
        r19.w = 1;
      ...
      r10.yzw = -v6.xyz * r5.xxx + sunConstants.wldDir.xyz;
