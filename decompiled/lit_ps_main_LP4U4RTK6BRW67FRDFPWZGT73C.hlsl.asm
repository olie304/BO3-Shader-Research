...
if_nz r3.w
  ...
  if_nz r3.w
    ...
    mul r8.z, r2.w, r8.z
    if_nz cb2[23].x
      add r10.xyz, v5.xyzx, cb1[24].xyzx
    ...
    if_nz r9.w
      ...
      mad r15.xyz, r3.xyzx, r10.wwww, v5.xyzx
      ...
      if_nz r3.w
        ...
        mad r15.xyz, r3.xyzx, r9.wwww, v5.xyzx
        mov r15.w, l(1.000000)
        dp4 r11.x, r11.xyzw, r15.xyzw
        dp4 r11.y, r12.xyzw, r15.xyzw
        mad r11.xy, r11.xyxx, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
    ...
    mad r12.xyz, -v5.xyzx, r5.xxxx, cb2[17].xyzx
...
ret 
// Approximately 1036 instruction slots used
