...
r2.w = samp0[]..swiz;
  ...
  if (r2.w != 0) {
    ...
    r2.w = r2.w * r4.x + zoomUVs2.x;
    r1.xy = r1.xy / r2.ww;
    r1.xy = float2(0.5,0.5) + r1.xy;
    r4.xy = saturate(r1.xy);
    r11.x = clampU2 ? r4.x : r1.x;
    r11.y = clampV2 ? r4.y : r1.y;
  }
  r4.xyzw = emissiveMap2.Sample(colorSampler_s, r11.xy).xyzw;
  r4.xyz = emissiveTint2.xyz * r4.xyz;
  r1.x = hdrScale * r4.w;
  r4.xyz = r4.xyz * r1.xxx;
  r1.x = clampV2 + r1.w;
  r1.x = frac(r1.x);
  r1.y = gameTime.w * clampV2 + r1.x;
  r1.x = clampV2;
  r1.x = flickerLookupMap.SampleLevel(lookupSampler_s, r1.xy, 0).x;
  r1.x = log2(abs(r1.x));
  r1.x = flickerPower2 * r1.x;
  r1.x = exp2(r1.x);
  r1.y = flickerRange2.y + -flickerRange2.x;
  r1.x = r1.x * r1.y + flickerRange2.x;
  ...
  r8.x = saturate(dot(r3.xyz, r4.xyz));
  r4.w = dot(-r4.xyz, r3.xyz);
  r4.w = r4.w + r4.w;
  r12.xyz = r3.xyz * -r4.www + -r4.xyz;
  r4.w = 17 * r8.y;
  r4.w = exp2(r4.w);
  r4.w = 2 + r4.w;
  r4.w = 2 / r4.w;
  ...
  r13.z = (uint)r0.y << 4;
  r0.y = (int)r7.z & -32;
  r7.x = (int)-r0.y + (int)r7.z;
  r7.y = numRefProbes & -32;
  r7.w = (int)-r7.y + numRefProbes;
  r14.xy = float2(0,0);
  r15.w = 0;
  r16.yz = float2(0,1);
  r17.xy = float2(0,0);
  ...
  while (true) {
    ...
    bitmask.w = ((~(-1 << r7.x)) << 0) & 0xffffffff;  r10.w = (((uint)0 << 0) & bitmask.w) | ((uint)r8.w & ~bitmask.w);
    r8.w = r9.w ? r10.w : r8.w;
    r9.w = cmp((int)r7.y == (int)r8.z);
  ...
  if (r7.y != 0) {
    ...
    while (true) {
      ...
      r8.w = cmp((int)r0.y == (int)r7.w);
      if (r7.x == 0) r9.w = 0; else if (r7.x+0 < 32) {       r9.w = (uint)r8.z << (32-(r7.x + 0)); r9.w = (uint)r9.w >> (32-r7.x);      } else r9.w = (uint)r8.z >> 0;
      r8.z = r8.w ? r9.w : r8.z;
  ...
  if (r5.z != 0) {
    ...
    r0.y = sunConstants.globalProbeExposure * r5.z + -r3.w;
    r0.y = r8.y * r0.y + r3.w;
    ...
    if (r10.w == 0) {
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          r15.w = r13.w ? sunConstants.splitPinTransform[r6.w].w : sunConstants.splitPinTransform[r10.w].w;
  ...
  if (r5.w != 0) {
    ...
    if (r5.w != 0) {
      ...
      r9.w = cmp(0 < (uint)r6.w);
      r9.w = r2.w ? r9.w : 0;
      if (r9.w != 0) {
        r6.w = (int)r6.w + numLights;
        r6.w = (int)r6.w + -1;
      // Known bad code for instruction (needs manual fix):
            ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r9.w, r6.w, l(52), t12.xxxx
      r9.w = samp0[]..swiz;
      // Known bad code for instruction (needs manual fix):
      ...
      r18.w = samp0[]..swiz;
        ...
        if (r10.w == 0) {
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=240)(mixed,mixed,mixed,mixed) r10.w, r6.w, l(28), t12.xxxx
        r10.w = samp0[]..swiz;
        // Known bad code for instruction (needs manual fix):
        ...
        r15.w = samp0[]..swiz;
          ...
          if (enableDitheredShadow != 0) {
            ...
            r16.z = (uint)r10.w;
            r12.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r16.xyz, r6.w).x;
          }
          r6.w = r12.w * r12.w;
          r6.w = r6.w * r12.w;
        } else {
      ...
      r9.w = abs(r6.w) * r4.w + -abs(r6.w);
      r6.w = abs(r6.w) * r9.w + 1;
      r5.z = r5.z * r0.y + r1.z;
      r6.w = r6.w * r6.w;
      r5.z = r6.w * r5.z;
      r5.z = rcp(r5.z);
