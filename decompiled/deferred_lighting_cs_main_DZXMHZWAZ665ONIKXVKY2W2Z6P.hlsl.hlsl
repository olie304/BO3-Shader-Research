...
r0.y = samplerLinear[]..swiz;
  ...
  r0.y = (uint)r0.y >> 24;
  r6.w = cmp((uint)r0.y >= (uint)r5.w);
  r7.w = cmp((uint)r0.y < numRefProbes);
  r6.w = r6.w ? r7.w : 0;
  if (r6.w != 0) {
    r6.w = (int)r0.y * 14;
    if (r1.z != 0) {
      r12.yzw = refProbeConstantsCB[r6.w].data[0].xyz + eyeOffset.xyz;
      r12.x = 16;
      GBufferDiffuseColor[viewID].880 = u2.xyzw;
    }
    r12.xyz = -refProbeConstantsCB[r6.w].data[0].xyz + r4.xyw;
    ...
    r9.w = (int)r7.w * 6;
    r12.w = dot(refProbeAttenuationConstantsCB[r9.w].data[0].xyz, r12.xyz);
    r12.w = saturate(refProbeAttenuationConstantsCB[r9.w].data[0].w + r12.w);
    r13.x = dot(refProbeAttenuationConstantsCB[r9.w].data[1].xyz, r12.xyz);
    r13.x = saturate(refProbeAttenuationConstantsCB[r9.w].data[1].w + r13.x);
    r12.w = r13.x * r12.w;
    r13.x = dot(refProbeAttenuationConstantsCB[r9.w].data[2].xyz, r12.xyz);
    r13.x = saturate(refProbeAttenuationConstantsCB[r9.w].data[2].w + r13.x);
    r12.w = r13.x * r12.w;
    r13.x = dot(refProbeAttenuationConstantsCB[r9.w].data[3].xyz, r12.xyz);
    r13.x = saturate(refProbeAttenuationConstantsCB[r9.w].data[3].w + r13.x);
    r12.w = r13.x * r12.w;
    r13.x = dot(refProbeAttenuationConstantsCB[r9.w].data[4].xyz, r12.xyz);
    r13.x = saturate(refProbeAttenuationConstantsCB[r9.w].data[4].w + r13.x);
    r12.w = r13.x * r12.w;
    r13.x = dot(refProbeAttenuationConstantsCB[r9.w].data[5].xyz, r12.xyz);
    r9.w = saturate(refProbeAttenuationConstantsCB[r9.w].data[5].w + r13.x);
    r13.x = r12.w * r9.w;
    r9.w = 1 & (int)refProbeConstantsCB[r6.w].data[6].x;
    r13.yz = float2(0,1);
    r13.xy = r9.ww ? r13.xy : r13.zx;
    r14.x = 1;
    r9.w = refProbeConstantsCB[r6.w].data[6].x;
    r15.xy = r13.xy;
    r12.w = 1;
    while (true) {
      r13.z = cmp((int)r12.w >= (int)r8.w);
      if (r13.z != 0) break;
      r13.z = (int)r7.w + (int)r12.w;
      r13.z = (int)r13.z * 6;
      r13.w = dot(refProbeAttenuationConstantsCB[r13.z].data[0].xyz, r12.xyz);
      r13.w = saturate(refProbeAttenuationConstantsCB[r13.z].data[0].w + r13.w);
      r13.w = r15.x * r13.w;
      r14.z = dot(refProbeAttenuationConstantsCB[r13.z].data[1].xyz, r12.xyz);
      r14.z = saturate(refProbeAttenuationConstantsCB[r13.z].data[1].w + r14.z);
      r13.w = r14.z * r13.w;
      r14.z = dot(refProbeAttenuationConstantsCB[r13.z].data[2].xyz, r12.xyz);
      r14.z = saturate(refProbeAttenuationConstantsCB[r13.z].data[2].w + r14.z);
      r13.w = r14.z * r13.w;
      r14.z = dot(refProbeAttenuationConstantsCB[r13.z].data[3].xyz, r12.xyz);
      r14.z = saturate(refProbeAttenuationConstantsCB[r13.z].data[3].w + r14.z);
      r13.w = r14.z * r13.w;
      r14.z = dot(refProbeAttenuationConstantsCB[r13.z].data[4].xyz, r12.xyz);
      r14.z = saturate(refProbeAttenuationConstantsCB[r13.z].data[4].w + r14.z);
      r13.w = r14.z * r13.w;
      r14.z = dot(refProbeAttenuationConstantsCB[r13.z].data[5].xyz, r12.xyz);
      r13.z = saturate(refProbeAttenuationConstantsCB[r13.z].data[5].w + r14.z);
      r15.x = r13.w * r13.z;
      r14.z = (uint)r9.w >> 2;
      if (1 == 0) r14.w = 0; else if (1+2 < 32) {       r14.w = (uint)r9.w << (32-(1 + 2)); r14.w = (uint)r14.w >> (32-1);      } else r14.w = (uint)r9.w >> 2;
      r15.z = (int)r14.z & 2;
      r15.w = max(r15.y, r15.x);
      r13.z = -r13.w * r13.z + 1;
      r13.z = r15.y * r13.z;
      r14.y = r15.z ? r13.z : r15.w;
      r15.xy = r14.ww ? r15.xy : r14.xy;
      r12.w = (int)r12.w + 1;
      r9.w = r14.z;
    }
    r15.y = saturate(r15.y);
    r7.w = refProbeConstantsCB[r6.w].data[6].y * r15.y;
    r8.w = cmp(0 < r7.w);
    if (r8.w != 0) {
      if (r1.z != 0) {
      // Known bad code for instruction (needs manual fix):
      ...
      r13.x = refProbeConstantsCB[r6.w].data[7].w;
      r13.yz = refProbeConstantsCB[r6.w].data[8].xy;
      r9.w = dot(r11.xyz, r13.xyz);
      r12.w = dot(r12.xyz, r13.xyz);
      r12.w = -refProbeConstantsCB[r6.w].data[8].z + r12.w;
      r13.x = cmp(r12.w >= 0);
      ...
      r13.x = refProbeConstantsCB[r6.w].data[8].w;
      r13.yz = refProbeConstantsCB[r6.w].data[9].xy;
      r12.w = dot(r11.xyz, r13.xyz);
      r13.x = dot(r12.xyz, r13.xyz);
      r13.x = -refProbeConstantsCB[r6.w].data[9].z + r13.x;
      r13.y = cmp(r13.x >= 0);
      ...
      r13.x = refProbeConstantsCB[r6.w].data[9].w;
      r13.yz = refProbeConstantsCB[r6.w].data[10].xy;
      r12.w = dot(r11.xyz, r13.xyz);
      r13.x = dot(r12.xyz, r13.xyz);
      r13.x = -refProbeConstantsCB[r6.w].data[10].z + r13.x;
      r13.y = cmp(r13.x >= 0);
      r13.x = max(abs(r13.x), r2.w);
      r13.x = r13.y ? r13.x : -r13.x;
      r12.w = max(1.00000001e-07, -r12.w);
      r12.w = r13.x / r12.w;
      r9.w = min(abs(r12.w), r9.w);
      r13.x = refProbeConstantsCB[r6.w].data[10].w;
      r13.yz = refProbeConstantsCB[r6.w].data[11].xy;
      r12.w = dot(r11.xyz, r13.xyz);
      r13.x = dot(r12.xyz, r13.xyz);
      r13.x = -refProbeConstantsCB[r6.w].data[11].z + r13.x;
      r13.y = cmp(r13.x >= 0);
      r13.x = max(abs(r13.x), r2.w);
      r13.x = r13.y ? r13.x : -r13.x;
      r12.w = max(1.00000001e-07, -r12.w);
      r12.w = r13.x / r12.w;
      r9.w = min(abs(r12.w), r9.w);
      r13.x = refProbeConstantsCB[r6.w].data[11].w;
      r13.yz = refProbeConstantsCB[r6.w].data[12].xy;
      r12.w = dot(r11.xyz, r13.xyz);
      r13.x = dot(r12.xyz, r13.xyz);
      r13.x = -refProbeConstantsCB[r6.w].data[12].z + r13.x;
      r13.y = cmp(r13.x >= 0);
      r13.x = max(abs(r13.x), r2.w);
      r13.x = r13.y ? r13.x : -r13.x;
      r12.w = max(1.00000001e-07, -r12.w);
      r12.w = r13.x / r12.w;
      r9.w = min(abs(r12.w), r9.w);
      r13.x = refProbeConstantsCB[r6.w].data[12].w;
      r13.yz = refProbeConstantsCB[r6.w].data[13].xy;
      r12.w = dot(r11.xyz, r13.xyz);
      r13.x = dot(r12.xyz, r13.xyz);
      r13.x = -refProbeConstantsCB[r6.w].data[13].z + r13.x;
      r13.y = cmp(r13.x >= 0);
      r13.x = max(abs(r13.x), r2.w);
      r13.x = r13.y ? r13.x : -r13.x;
      r12.w = max(1.00000001e-07, -r12.w);
      r12.w = r13.x / r12.w;
      r9.w = min(abs(r12.w), r9.w);
      r13.x = refProbeConstantsCB[r6.w].data[3].w + r12.x;
      r13.yz = refProbeConstantsCB[r6.w].data[4].xy + r12.yz;
      r13.xyz = r11.xyz * r9.www + r13.xyz;
      ...
      r14.x = refProbeConstantsCB[r6.w].data[0].w;
      r14.y = refProbeConstantsCB[r6.w].data[1].z;
      r14.z = refProbeConstantsCB[r6.w].data[2].y;
      r15.x = dot(r13.xyz, r14.xyz);
      r16.xy = refProbeConstantsCB[r6.w].data[1].xw;
      r16.z = refProbeConstantsCB[r6.w].data[2].z;
      r15.y = dot(r13.xyz, r16.xyz);
      r17.x = refProbeConstantsCB[r6.w].data[1].y;
      r17.yz = refProbeConstantsCB[r6.w].data[2].xw;
      r15.z = dot(r13.xyz, r17.xyz);
      if (9 == 0) r12.w = 0; else if (9+16 < 32) {       r12.w = (uint)refProbeConstantsCB[r6.w].data[7].z << (32-(9 + 16)); r12.w = (uint)r12.w >> (32-9);      } else r12.w = (uint)refProbeConstantsCB[r6.w].data[7].z >> 16;
      r15.w = (uint)r12.w;
      r13.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r15.xyzw, r9.w).xyz;
      ...
      r13.xyz = r9.www ? float3(1,1,0) : r13.xyz;
      r18.x = dot(r12.xyz, r14.xyz);
      r18.y = dot(r12.xyz, r16.xyz);
      r18.z = dot(r12.xyz, r17.xyz);
      r12.xyz = saturate(r18.xyz * refProbeConstantsCB[r6.w].data[3].xyz + float3(0.5,0.5,0.5));
      r18.xy = refProbeConstantsCB[r6.w].data[4].zw * r12.xy;
      r18.z = refProbeConstantsCB[r6.w].data[5].x * r12.z;
      r12.xyz = refProbeConstantsCB[r6.w].data[5].yzw + r18.xyz;
      ...
      r8.w = dot(r13.xyz, float3(0.212599993,0.715200007,0.0722000003));
      r6.w = r3.z * r6.w + r8.w;
      r6.w = r9.w / r6.w;
  ...
  r5.w = cmp((uint)r0.y < (uint)r5.w);
  if (r5.w != 0) {
    r0.y = (int)r0.y * 14;
    if (r1.z != 0) {
      r5.w = (int)r6.w & 1;
      r5.w = mad((int)r5.w, 20, 880);
      r14.yzw = refProbeConstantsCB[r0.y].data[0].xyz + eyeOffset.xyz;
      r14.x = 16;
      GBufferDiffuseColor[viewID].r5.w = u2.xyzw;
    }
    r5.w = (int)r6.w + 1;
    r14.xyz = -refProbeConstantsCB[r0.y].data[0].xyz + r4.xyw;
    r8.w = 0x0000ffff & (int)refProbeConstantsCB[r0.y].data[7].z;
    if (6 == 0) r9.w = 0; else if (6+25 < 32) {     r9.w = (uint)refProbeConstantsCB[r0.y].data[7].z << (32-(6 + 25)); r9.w = (uint)r9.w >> (32-6);    } else r9.w = (uint)refProbeConstantsCB[r0.y].data[7].z >> 25;
    r12.w = (int)r8.w * 6;
    r13.w = dot(refProbeAttenuationConstantsCB[r12.w].data[0].xyz, r14.xyz);
    r13.w = saturate(refProbeAttenuationConstantsCB[r12.w].data[0].w + r13.w);
    r14.w = dot(refProbeAttenuationConstantsCB[r12.w].data[1].xyz, r14.xyz);
    r14.w = saturate(refProbeAttenuationConstantsCB[r12.w].data[1].w + r14.w);
    r13.w = r14.w * r13.w;
    r14.w = dot(refProbeAttenuationConstantsCB[r12.w].data[2].xyz, r14.xyz);
    r14.w = saturate(refProbeAttenuationConstantsCB[r12.w].data[2].w + r14.w);
    r13.w = r14.w * r13.w;
    r14.w = dot(refProbeAttenuationConstantsCB[r12.w].data[3].xyz, r14.xyz);
    r14.w = saturate(refProbeAttenuationConstantsCB[r12.w].data[3].w + r14.w);
    r13.w = r14.w * r13.w;
    r14.w = dot(refProbeAttenuationConstantsCB[r12.w].data[4].xyz, r14.xyz);
    r14.w = saturate(refProbeAttenuationConstantsCB[r12.w].data[4].w + r14.w);
    r13.w = r14.w * r13.w;
    r14.w = dot(refProbeAttenuationConstantsCB[r12.w].data[5].xyz, r14.xyz);
    ...
    r13.w = 1;
    while (true) {
      r14.w = cmp((int)r13.w >= (int)r9.w);
      if (r14.w != 0) break;
      r14.w = (int)r8.w + (int)r13.w;
      r14.w = (int)r14.w * 6;
      r15.z = dot(refProbeAttenuationConstantsCB[r14.w].data[0].xyz, r14.xyz);
      r15.z = saturate(refProbeAttenuationConstantsCB[r14.w].data[0].w + r15.z);
      r15.z = r17.x * r15.z;
      r15.w = dot(refProbeAttenuationConstantsCB[r14.w].data[1].xyz, r14.xyz);
      r15.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[1].w + r15.w);
      r15.z = r15.z * r15.w;
      r15.w = dot(refProbeAttenuationConstantsCB[r14.w].data[2].xyz, r14.xyz);
      r15.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[2].w + r15.w);
      r15.z = r15.z * r15.w;
      r15.w = dot(refProbeAttenuationConstantsCB[r14.w].data[3].xyz, r14.xyz);
      r15.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[3].w + r15.w);
      r15.z = r15.z * r15.w;
      r15.w = dot(refProbeAttenuationConstantsCB[r14.w].data[4].xyz, r14.xyz);
      r15.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[4].w + r15.w);
      r15.z = r15.z * r15.w;
      r15.w = dot(refProbeAttenuationConstantsCB[r14.w].data[5].xyz, r14.xyz);
      r14.w = saturate(refProbeAttenuationConstantsCB[r14.w].data[5].w + r15.w);
      r17.x = r15.z * r14.w;
      r15.w = (uint)r12.w >> 2;
      if (1 == 0) r16.z = 0; else if (1+2 < 32) {       r16.z = (uint)r12.w << (32-(1 + 2)); r16.z = (uint)r16.z >> (32-1);      } else r16.z = (uint)r12.w >> 2;
      r16.w = (int)r15.w & 2;
      r17.z = max(r17.y, r17.x);
      r14.w = -r15.z * r14.w + 1;
      r14.w = r17.y * r14.w;
      r16.y = r16.w ? r14.w : r17.z;
      r17.xy = r16.zz ? r17.xy : r16.xy;
      r13.w = (int)r13.w + 1;
      r12.w = r15.w;
    }
    r8.w = saturate(r17.y + -r7.w);
    r9.w = refProbeConstantsCB[r0.y].data[6].y * r8.w;
    r12.w = cmp(0 < r9.w);
    if (r12.w != 0) {
      r12.w = (int)r5.w & 3;
      r13.w = (int)r12.w + -1;
      ...
      r13.w = r1.z ? r13.w : 0;
      if (r13.w != 0) {
        r15.xy = mad((int2)r12.ww, int2(20,20), int2(860,876));
      // Known bad code for instruction (needs manual fix):
      ...
      r5.w = (int)r6.w + 257;
      r8.w = r8.w * refProbeConstantsCB[r0.y].data[6].y + r7.w;
      r9.w = refProbeConstantsCB[r0.y].data[7].y * r9.w;
      ...
      r15.x = cmp(r14.w >= 0);
      r2.w = max(abs(r14.w), r2.w);
      r2.w = r15.x ? r2.w : -r2.w;
      r13.w = max(1.00000001e-07, -r13.w);
      r2.w = r2.w / r13.w;
      r2.w = min(r12.w, abs(r2.w));
  ...
  r0.y = cmp(r7.w >= 1);
  bitmask.w = ((~(-1 << 8)) << 0) & 0xffffffff;  r1.w = (((uint)r5.w << 0) & bitmask.w) | ((uint)r6.w & ~bitmask.w);
  r0.y = r0.y ? r1.w : r5.w;
  r1.w = max(1, r8.w);
  r1.w = rcp(r1.w);
  r8.w = saturate(r8.w);
  ...
  if (r2.w != 0) {
    ...
    r1.w = sunConstants.globalProbeExposure * r2.w + -r3.z;
    r1.w = r2.y * r1.w + r3.z;
