...
r0.z = samp0[]..swiz;
  ...
  r1.w = transGlossMap.Sample(transitionSampler_s, r1.xy).x;
  if (r1.z != 0) {
    r4.xyz = float3(-1,-1,-1) + transColorTint.xyz;
    r4.xyz = r3.www * r4.xyz + float3(1,1,1);
    r1.z = transGlossRange.y + -transGlossRange.x;
    r1.z = r1.w * r1.z + transGlossRange.x;
  ...
  r1.z = r4.w * detailScaleHeight + r1.z;
  r3.w = cmp(0 < r1.w);
  r4.xyz = transNormalMap.Sample(transitionSampler_s, r1.xy).xyz;
  if (r3.w != 0) {
  ...
  r1.x = cmp(0 < r0.z);
  if (r1.x != 0) {
    r1.xyw = meltNormalMap.Sample(normalSampler_s, w1.xy).xyz;
    r1.xyw = float3(-0.5,-0.5,-0) + r1.xyw;
    r1.xyw = baseNormalHeight * r1.xyw + float3(0.5,0.5,0);
    r1.xy = r1.xy * float2(1.9921875,1.9921875) + float2(-1,-1);
    r1.w = r1.w * r1.w;
    r1.w = 0.333333343 * r1.w;
    r1.w = min(1, r1.w);
    r3.xy = r1.xy * r0.zz + r3.xy;
    r1.x = dot(r3.xyz, r3.xyz);
    r1.x = rsqrt(r1.x);
    r3.xyz = r3.xyz * r1.xxx;
    r1.z = r1.w * r0.z + r1.z;
  ...
  if (enableGTAO != 0) {
    ...
    r5.y = 1 + -abs(r1.w);
    r5.y = sqrt(r5.y);
    r5.z = abs(r1.w) * -0.0187292993 + 0.0742610022;
    r5.z = r5.z * abs(r1.w) + -0.212114394;
    r5.z = r5.z * abs(r1.w) + 1.57072878;
    r5.w = r5.z * r5.y;
  ...
  r0.y = 1 + -r12.x;
  o2.xyz = r2.xyz * r0.yyy + r7.xzw;
  r0.z = r2.w * r0.y + r12.x;
  r1.xyz = r1.xyz * r0.yyy + r13.xyz;
  r2.x = dot(r1.xyz, r1.xyz);
  r2.x = rsqrt(r2.x);
  r2.xyz = r2.xxx * r1.xyz;
  r1.y = r0.w * r0.y + r12.y;
  r0.y = log2(abs(r1.w));
            ...
            if (r33.w != 0) {
              ...
              if (r31.w != 0) {
                ...
                if (r31.w != 0) {
                  ...
                  r30.w = abs(r29.w) * r1.w + -abs(r29.w);
            ...
            r61.w = samp0[]..swiz;
              ...
              if (r23.x != 0) {
                ...
                if (r23.x != 0) {
                  ...
                  r25.y = abs(r25.x) * r1.w + -abs(r25.x);
  ...
  r10.z = rcp(r10.z);
  r10.xy = r1.zw * r10.zz + float2(0.5,0.5);
  r12.xyz = -r8.xyz;
  ...
  r1.z = rcp(r1.z);
  r0.w = r1.z * r0.w;
  r1.zw = r0.yy * float2(0.5,0.5) + float2(0.333333343,1);
  r1.zw = float2(0.117647059,0.117647059) * r1.zw;
  r1.zw = r1.zw * r1.zw;
  x1[0].x = r1.z;
  r6.xyz = r10.xyz * r1.zzz + r8.xyz;
  r7.xy = cmp(r0.ww < r1.zw);
  ...
  if (r6.y != 0) {
    ...
    r6.yz = r6.yz * r6.yz + -r1.zw;
    r1.z = r4.w * r6.y + r1.z;
    x1[0].x = r1.z;
    r7.xyw = r10.xyz * r1.zzz + r8.xyz;
    r1.z = cmp(r0.w < r1.z);
  ...
  if (r1.z == 0) {
    r1.zw = r0.yy * float2(0.5,0.5) + float2(2.33333325,3);
    r1.zw = float2(0.117647059,0.117647059) * r1.zw;
    r3.w = x1[0].x;
    r4.w = x0[0].x;
    r1.z = r1.z * r1.z + -r3.w;
  ...
  if (r1.z == 0) {
    r1.zw = r0.yy * float2(0.5,0.5) + float2(3.33333325,4);
    r1.zw = float2(0.117647059,0.117647059) * r1.zw;
    r3.w = x1[0].x;
    r4.w = x0[0].x;
    r1.z = r1.z * r1.z + -r3.w;
  ...
  if (r1.z == 0) {
    r1.zw = r0.yy * float2(0.5,0.5) + float2(4.33333349,5);
    r1.zw = float2(0.117647059,0.117647059) * r1.zw;
    r3.w = x1[0].x;
    r4.w = x0[0].x;
    r1.z = r1.z * r1.z + -r3.w;
  ...
  if (r1.z == 0) {
    r1.zw = r0.yy * float2(0.5,0.5) + float2(5.33333349,6);
    r1.zw = float2(0.117647059,0.117647059) * r1.zw;
    r3.w = x1[0].x;
    r4.w = x0[0].x;
    r1.z = r1.z * r1.z + -r3.w;
  ...
  if (r1.z == 0) {
    r1.zw = r0.yy * float2(0.5,0.5) + float2(6.33333349,7);
    r1.zw = float2(0.117647059,0.117647059) * r1.zw;
    r3.w = x1[0].x;
    r4.w = x0[0].x;
    r1.z = r1.z * r1.z + -r3.w;
  ...
  if (r1.z == 0) {
    r1.zw = r0.yy * float2(0.5,0.5) + float2(7.33333349,8);
    r1.zw = float2(0.117647059,0.117647059) * r1.zw;
    r0.y = x1[0].x;
    r3.w = x0[0].x;
    r1.z = r1.z * r1.z + -r0.y;
    ...
    r9.xy = (int2)r6.xy;
    r9.zw = float2(0,0);
    r1.z = floatZSampler.Load(r9.xyz).x;
        ...
        r24.y = samp0[]..swiz;
          ...
          r31.w = samp0[]..swiz;
            ...
            r33.w = samp0[]..swiz;
              ...
              r21.w = -r21.w * r23.w + 1;
              r21.w = r27.y * r21.w;
              r14.y = r26.w ? r21.w : r27.z;
              r27.xy = r26.zz ? r27.xy : r14.xy;
              r17.w = (int)r17.w + 1;
              r12.x = r25.w;
            }
            r12.x = saturate(r27.y + -r9.w);
            r14.y = r12.x * r14.w;
            r14.z = cmp(0 < r14.y);
            if (r14.z != 0) {
            // Known bad code for instruction (needs manual fix):
  ...
  r9.xyz = r18.xyz * r0.yyy;
  r10.xyz = r19.xyz * r0.yyy;
  ...
  if (r1.z != 0) {
    ...
    r9.xyz = r18.xyz * r0.yyy + r2.xyz;
    r11.w = 0;
    r2.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r11.xyzw, r0.w).xyz;
    r0.y = sunConstants.globalProbeExposure * r1.z + -r1.w;
    r0.y = r1.y * r0.y + r1.w;
    r10.xyz = r2.xyz * r0.yyy + r10.xyz;
  }
  r2.xyz = r9.xyz * r5.xyz + r6.xyz;
  r5.xyz = r9.xyz * r5.xyz + r7.xyz;
  r0.yw = r1.xy * float2(0.984375,0.984375) + float2(0.0078125,0.0078125);
  r0.yw = gEnvBRDFGeneric.SampleLevel(samplerLinear_s, r0.yw, 0).xy;
  r1.xyz = r10.xyz * r0.yyy + r4.xyz;
  r4.xyz = r10.xyz * r0.www + r8.xyz;
  r2.xyz = r5.xyz * r3.xyz + r2.xyz;
  ...
  if (r0.w != 0) {
    ...
    r1.w = r2.w * r1.w;
    r4.xyz = r1.www * -r2.xyz + r2.xyz;
  }
  r2.xyz = relHDRExposure.yyy * r4.xyz;
  r4.xyz = cmp(r2.xyz >= float3(6.10351563e-05,6.10351563e-05,6.10351563e-05));
  r2.xyz = r4.xyz ? r2.xyz : 0;
  o1.xyz = min(float3(65024,65024,64512), r2.xyz);
  if (r0.w != 0) {
    r0.w = dot(v6.xyz, v6.xyz);
    r1.w = rsqrt(r0.w);
