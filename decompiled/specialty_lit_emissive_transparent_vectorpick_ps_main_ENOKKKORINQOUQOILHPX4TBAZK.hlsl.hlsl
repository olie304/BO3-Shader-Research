...
// unknown dcl_: dcl_resource_structured t36, 128
  ...
  if (r1.z != 0) {
    ...
    r1.w = cmp(r1.w < r2.x);
    r2.x = cmp(0 < r2.x);
    r7.xyz = (int3)r1.zzz & int3(1,2,4);
    r8.xyz = r7.xxx ? float3(1,0,1) : r0.xyz;
    r7.xyw = r7.yyy ? float3(0,1,1) : r0.xyz;
    r2.xyw = r2.xxx ? r8.xyz : r7.xyw;
    r7.xyz = r7.zzz ? float3(0,1,0) : r0.xyz;
    r0.xyz = r1.www ? r2.xyw : r7.xyz;
  }
...
r3.w = samp0[]..swiz;
            ...
            r29.w = samp0[]..swiz;
              ...
              r26.w = samp0[]..swiz;
                ...
                if (r25.y != 0) {
                  ...
                  r27.xyz = r28.xyz * r2.zzz;
                  r25.xyz = r25.xyz * r2.zzz;
                  r26.xyz = r26.xyz * r2.zzz;
                  r17.w = -17 * r14.z;
                  r17.w = exp2(r17.w);
                  r16.w = r17.w + r16.w;
                  r16.w = log2(r16.w);
  ...
  r8.x = saturate(dot(r6.xyz, r10.xyz));
  r1.w = dot(-r10.xyz, r6.xyz);
  r1.w = r1.w + r1.w;
  r12.xyz = r6.xyz * -r1.www + -r10.xyz;
  r1.w = 17 * r8.y;
  r1.w = exp2(r1.w);
  r1.w = 2 + r1.w;
  r1.w = 2 / r1.w;
  ...
  if (r1.z == 0) {
    ...
    if (r4.z != 0) {
      ...
      r13.xyz = cmp(float3(0,0,0) < r6.xyz);
      ...
      r6.w = 0;
      r13.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r6.xyzw, 6).xyz;
      ...
      r1.z = sunConstants.globalProbeExposure * r4.z + -r5.z;
      r1.z = r8.y * r1.z + r5.z;
  ...
  r4.z = r8.x * r1.y + r1.z;
  r1.yz = r4.zz * r1.yz;
  r4.z = dot(r6.xyz, sunConstants.wldDir.xyz);
  r4.w = saturate(r4.z);
  r5.z = cmp(0 >= r4.w);
  if (r5.z != 0) {
    r5.w = 0;
  ...
  if (r5.z == 0) {
    ...
    if (r9.w == 0) {
      if (enableDitheredShadow == 0) {
        ...
        r15.z = r9.w + r6.w;
        r9.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r15.xyz, r5.z).x;
  ...
  if (r5.z != 0) {
    ...
    if (r5.z != 0) {
      ...
      r2.w = dot(r16.xyz, r10.xyz);
      r6.w = dot(r6.xyz, r16.xyz);
      ...
      r4.w = r5.w * r4.w;
      r4.w = 0.25 * r4.w;
      r16.xyz = r4.www * r11.yzw + r8.yzw;
      r2.w = saturate(1 + -r2.w);
      r5.z = r2.w * r2.w;
      r5.z = r5.z * r5.z;
      r2.w = r5.z * r2.w;
      r2.w = r4.w * r2.w;
      r17.xyz = r2.www * r11.zwy + r14.xyz;
      r15.w = r17.z;
      r13.w = r14.z;
            ...
            if (r16.w != 0) {
              ...
              if (r16.w != 0) {
                ...
                if (r16.w != 0) {
                  ...
                  r10.w = saturate(dot(r6.xyz, r40.xyz));
