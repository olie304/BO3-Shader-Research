...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:44:26 2021
//
//
// Buffer Definitions: 
//
...
//   float3 Glow_Color;                 // Offset:  160 Size:    12
//   float Noise_Scale;                 // Offset:  172 Size:     4
//   float Color_Map_Scale;             // Offset:  176 Size:     4 [unused]
//   float Glow_Falloff;                // Offset:  180 Size:     4
//   float Color_Map_Noise;             // Offset:  184 Size:     4
//   float Background;                  // Offset:  188 Size:     4
//   float3 Reticle_Color;              // Offset:  192 Size:    12
//   float Reticle_Color_Multiplier;    // Offset:  204 Size:     4
//   float Glow_Color_Multiplier;       // Offset:  208 Size:     4
//
// }
//
...
// ------------------------------ ---------- ------- ----------- -------------- ------
// Detail_Map_Sampler                sampler      NA          NA             s1      1 
// Color_Map_Sampler                 sampler      NA          NA             s2      1 
// shaderConstantSetBuffer           texture  struct         r/o             t0      1 
// modelInstanceBuffer               texture  struct         r/o             t4      1 
// Detail_Map                        texture  float4          2d             t6      1 
// Color_Map                         texture  float4          2d             t7      1 
...
dcl_output o0.xyzw
dcl_temps 4
lt r0.xy, v1.zwzz, l(0.000000, 0.000000, 0.000000, 0.000000)
lt r0.zw, l(0.000000, 0.000000, 1.000000, 1.000000), v1.zzzw
or r0.x, r0.z, r0.x
or r0.x, r0.y, r0.x
or r0.x, r0.w, r0.x
sample_indexable(texture2d)(float,float,float,float) r0.yzw, v1.zwzz, t7.wxyz, s2
...
mul r0.yw, v1.xxxy, cb0[10].wwww
sample_aoffimmi_indexable(0,0,0)(texture2d)(float,float,float,float) r0.y, r0.ywyy, t6.yxzw, s1
mul r1.xyz, r0.yyyy, r1.xyzx
mad r0.y, -cb0[11].z, r0.y, l(1.000000)
mul r2.xyz, r0.xxxx, cb0[12].xyzx
mul r3.w, r0.z, cb0[11].w
mul r0.xzw, r2.xxyz, cb0[12].wwww
mad r3.xyz, r0.xzwx, r0.yyyy, r1.xyzx
...
mul r1.xyzw, r0.yyyy, r3.xyzw
mul r0.xyzw, r0.xxxx, r1.xyzw
mov_sat r1.xyz, r0.xyzx
mul r1.xyz, r1.xyzx, l(32768.000000, 32768.000000, 32768.000000, 0.000000)
lt r1.w, l(0.000000), cb1[85].w
