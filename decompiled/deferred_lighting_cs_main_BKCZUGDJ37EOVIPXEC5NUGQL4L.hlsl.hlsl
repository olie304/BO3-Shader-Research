...
r0.y = samp0[]..swiz;
  ...
  r14.w = 0;
  r15.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r14.xyzw, r4.z).xyz;
  ...
  r15.xyz = r15.xyz * r4.zzz;
  r17.xyz = r15.yzx * r13.yyy;
  r13.yzw = r15.xyz * r13.zzz;
  r2.y = sqrt(r2.z);
  r2.y = r2.y * 0.5 + 0.5;
  r2.y = r2.y * r2.y;
  r4.z = 0.5 * r2.y;
  ...
  if (r5.x != 0) {
    ...
    if (r5.x != 0) {
      ...
      r6.w = r6.w * r4.w;
      r3.z = cmp(0 < r3.z);
      r18.xyz = r6.www * r15.xyz + r16.xyz;
      ...
      r4.y = r4.w * r4.y;
      r4.y = 0.25 * r4.y;
      r19.xyz = r4.yyy * r15.xyz + r13.yzw;
      r0.w = saturate(1 + -r0.w);
      r5.x = r0.w * r0.w;
      r5.x = r5.x * r5.x;
      r0.w = r5.x * r0.w;
      r0.w = r4.y * r0.w;
      r15.xyz = r0.www * r15.yzx + r17.xyz;
      r18.w = r15.z;
      r16.w = r17.z;
      r16.xyzw = r3.zzzz ? r18.xyzw : r16.xyzw;
      r15.zw = r19.xy;
      r17.zw = r13.yz;
      r15.xyzw = r3.zzzz ? r15.xyzw : r17.xyzw;
  ...
  switch (r3.z) {
    ...
    r18.xyz = -r15.xyz * float3(0.5,0.5,0.5) + lightConstantsCB[r0.x].data[0].xyz;
    r19.xyz = r18.xyz + -r11.xyz;
    r4.w = dot(r15.xyz, r19.xyz);
    r5.x = saturate(-r4.w / lightConstantsCB[r0.x].data[6].y);
    r20.xyz = r5.xxx * r15.xyz + r18.xyz;
    ...
    if (r9.w != 0) {
      ...
      if (r9.w != 0) {
        ...
        if (r9.w != 0) {
          ...
          if (r5.x != 0) {
            ...
            if (r14.w == 0) {
              ...
              if (r15.w == 0) {
                ...
                r16.w = lightConstantsCB[r4.w].data[10].z * r12.w;
                r5.x = lightConstantsCB[r4.w].data[10].y * r12.w + r5.x;
                r5.x = r5.x / r16.w;
              }
            } else {
              r15.w = -1;
            ...
            if (r12.w == 0) {
              ...
              if (enableDitheredShadow != 0) {
                ...
                while (true) {
                  ...
                  r16.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r20.xyz, r5.x).x;
                  r14.w = r16.w * 0.125 + r14.w;
                  r15.w = (int)r15.w + 1;
                }
              } else {
                r19.z = (uint)r12.w;
                r14.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r19.xyz, r5.x).x;
              }
              r4.w = r14.w * r14.w;
              r4.w = r4.w * r14.w;
            } else {
          ...
          r5.x = cmp(0 < r7.w);
          r19.xyz = r4.www * r18.xyz + r16.xyz;
          ...
          r4.y = r7.w * r4.y;
          r4.y = r4.w * r4.y;
          r15.xyz = r4.yyy * r18.xyz + r17.zxy;
          r16.xyz = r5.xxx ? r19.xyz : r16.xyz;
          r17.xyz = r5.xxx ? r15.yzx : r17.xyz;
      ...
      if (r6.w != 0) {
        ...
        if (r6.w != 0) {
          ...
          if (r10.w != 0) {
            ...
            r20.xyz = lightConstantsCB[r0.x].data[5].yzw;
            r20.w = lightConstantsCB[r0.x].data[6].x;
            r15.y = dot(r20.xyzw, r19.xyzw);
            r15.xy = r15.xy / r9.ww;
            r15.xy = saturate(r15.xy * float2(0.5,-0.5) + float2(0.5,0.5));
            r19.x = r15.x * lightConstantsCB[r0.x].data[8].y + lightConstantsCB[r0.x].data[8].z;
            r19.y = r15.y * lightConstantsCB[r0.x].data[8].w + lightConstantsCB[r0.x].data[9].x;
            r6.w = r6.w / r9.w;
            ...
            if (enableDitheredShadow != 0) {
              ...
              while (true) {
                ...
                if (r12.w != 0) break;
                r21.x = dot(icb[r11.w+0].yx, r15.xy);
                r21.y = dot(icb[r11.w+0].yx, r15.yz);
        ...
        if (r7.w != 0) {
          ...
          if (r10.w != 0) {
            ...
            r15.xyz = r12.xyz * r10.www + r11.xyz;
            r19.xyz = lightConstantsCB[r9.w].data[6].yzw;
            r19.w = lightConstantsCB[r9.w].data[7].x;
            r15.w = 1;
            r10.w = dot(r19.xyzw, r15.xyzw);
            r19.xyz = lightConstantsCB[r9.w].data[7].yzw;
            r19.w = lightConstantsCB[r9.w].data[8].x;
            r11.w = dot(r19.xyzw, r15.xyzw);
            r12.w = cmp(r11.w < r10.w);
            if (r12.w == 0) {
              r19.xyz = lightConstantsCB[r9.w].data[4].yzw;
              r19.w = lightConstantsCB[r9.w].data[5].x;
              r19.x = dot(r19.xyzw, r15.xyzw);
              r20.xyz = lightConstantsCB[r9.w].data[5].yzw;
              r20.w = lightConstantsCB[r9.w].data[6].x;
              r19.y = dot(r20.xyzw, r15.xyzw);
              r15.xy = r19.xy / r11.ww;
              r15.xy = r15.xy * float2(0.5,-0.5) + float2(0.5,0.5);
              r19.x = lightConstantsCB[r9.w].data[9].w + r15.x;
              r19.y = lightConstantsCB[r9.w].data[10].x + r15.y;
              r15.xy = lightConstantsCB[r9.w].data[9].yz * r19.xy;
              r15.zw = lightConstantsCB[r9.w].data[3].yy / lightConstantsCB[r9.w].data[8].yw;
              r19.xy = float2(1,1) + -r15.zw;
              r19.xy = cmp(r15.xy >= r19.xy);
              r15.zw = cmp(r15.zw >= r15.xy);
              r15.zw = (int2)r15.zw | (int2)r19.xy;
              r14.w = (int)r15.w | (int)r15.z;
              if (r14.w == 0) {
                r15.xy = saturate(r15.xy);
                r19.x = r15.x * lightConstantsCB[r9.w].data[8].y + lightConstantsCB[r9.w].data[8].z;
                r19.y = r15.y * lightConstantsCB[r9.w].data[8].w + lightConstantsCB[r9.w].data[9].x;
                r15.x = lightConstantsCB[r9.w].data[10].z * r11.w;
            ...
            if (r11.w == 0) {
              ...
              if (enableDitheredShadow != 0) {
                ...
                while (true) {
                  ...
                  if (r15.w != 0) break;
                  r21.x = dot(icb[r14.w+0].yx, r15.xy);
                  r21.y = dot(icb[r14.w+0].yx, r15.yz);
            ...
            if (r1.z != 0) {
              ...
              if (r10.w == 0) {
                ...
                r15.xy = r19.xy / r9.ww;
                r15.xy = r15.xy * float2(0.5,-0.5) + float2(0.5,0.5);
                r19.x = lightConstantsCB[r0.x].data[9].w + r15.x;
                r19.y = lightConstantsCB[r0.x].data[10].x + r15.y;
                r15.xy = lightConstantsCB[r0.x].data[9].yz * r19.xy;
                r15.zw = lightConstantsCB[r0.x].data[3].yy / lightConstantsCB[r0.x].data[8].yw;
                r19.xy = float2(1,1) + -r15.zw;
                r19.xy = cmp(r15.xy >= r19.xy);
                r15.zw = cmp(r15.zw >= r15.xy);
                r15.zw = (int2)r15.zw | (int2)r19.xy;
                ...
                if (r11.w == 0) {
                  ...
                  r1.z = lightConstantsCB[r0.x].data[10].y * r9.w + r1.z;
                  r1.z = r1.z / r12.w;
                }
              } else {
                r11.w = -1;
              ...
              if (r9.w == 0) {
                ...
                if (enableDitheredShadow != 0) {
                  ...
                  while (true) {
                    ...
                    if (r11.w != 0) break;
                    r21.x = dot(icb[r10.w+0].yx, r15.xy);
                    r21.y = dot(icb[r10.w+0].yx, r15.yz);
                    r20.xy = r21.xy * lightConstantsCB[r0.x].data[3].yy + r19.xy;
                    r11.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r20.xyz, r1.z).x;
          ...
          r0.x = r0.x * r6.w;
          r1.z = cmp(0 < r4.w);
          r15.xyz = r0.xxx * r18.xyz + r16.xyz;
          ...
          r16.xyz = r1.zzz ? r15.xyz : r16.xyz;
