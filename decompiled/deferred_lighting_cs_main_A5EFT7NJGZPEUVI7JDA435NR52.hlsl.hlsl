...
r0.y = samplerLinear[]..swiz;
  ...
  r9.xyzw = r19.xyzw + -r0.wwww;
  r2.z = min(abs(r9.z), abs(r9.w));
  r2.z = min(abs(r9.y), r2.z);
  r2.z = min(abs(r9.x), r2.z);
  r2.w = max(abs(r9.z), abs(r9.w));
  r2.w = max(abs(r9.y), r2.w);
  r2.w = max(abs(r9.x), r2.w);
  r9.xyz = cmp(r2.zzz == abs(r9.yzw));
  r2.z = r9.x ? r18.y : r18.x;
  r2.z = r9.y ? r18.z : r2.z;
  r2.z = r9.z ? r18.w : r2.z;
  ...
  while (true) {
    ...
    switch (r7.w) {
      ...
      r30.xy = lightConstantsCB[r6.w].data[5].zw;
      r30.z = lightConstantsCB[r6.w].data[6].x;
      r31.xyz = -r30.xyz * float3(0.5,0.5,0.5) + lightConstantsCB[r6.w].data[0].xyz;
      r32.xyz = r31.xyz + -r10.xyz;
      r8.w = dot(r30.xyz, r32.xyz);
      r9.w = saturate(-r8.w / lightConstantsCB[r6.w].data[6].y);
      r33.xyz = r9.www * r30.xyz + r31.xyz;
      ...
      if (r13.w != 0) {
        ...
        r11.w = r14.w / r11.w;
        r11.w = min(1, r11.w);
        r33.xy = saturate(r13.ww * lightConstantsCB[r6.w].data[2].xz + lightConstantsCB[r6.w].data[2].yw);
        ...
        r13.w = cmp(0 < r11.w);
        if (r13.w != 0) {
          if (3 == 0) r13.w = 0; else if (3+27 < 32) {           r13.w = (uint)lightConstantsCB[r6.w].data[1].w << (32-(3 + 27)); r13.w = (uint)r13.w >> (32-3);          } else r13.w = (uint)lightConstantsCB[r6.w].data[1].w >> 27;
          r13.w = cmp((int)r13.w != 1);
          if (r13.w != 0) {
            r13.w = abs(r12.w) * -0.200000003 + 0.400000006;
            r33.xyz = r11.xyz * r13.www + r10.xyz;
            r33.xyz = -lightConstantsCB[r6.w].data[4].yzw + r33.xyz;
            r13.w = max(abs(r33.y), abs(r33.z));
            r13.w = max(abs(r33.x), r13.w);
            r13.w = lightConstantsCB[r6.w].data[5].x / r13.w;
            r13.w = lightConstantsCB[r6.w].data[5].y + r13.w;
            ...
            while (true) {
              ...
              r35.yz = lightConstantsCB[r6.w].data[3].yy * r35.yz;
              r35.x = r35.y * r16.x;
              r35.w = r35.y * r15.x;
          ...
          r13.w = cmp(0 < r11.w);
          if (r13.w != 0) {
            r13.w = lightConstantsCB[r6.w].data[1].z * r0.z;
            r13.w = 0.25 * r13.w;
            r14.w = dot(r30.xyz, r17.xyz);
            r20.w = dot(r17.xyz, r32.xyz);
            r25.w = -r14.w * r14.w + lightConstantsCB[r6.w].data[6].y;
            r8.w = r14.w * r20.w + -r8.w;
            r8.w = saturate(r8.w / r25.w);
            r14.w = r25.w / lightConstantsCB[r6.w].data[6].y;
            r14.w = 10 * r14.w;
            r14.w = min(1, r14.w);
            r8.w = r8.w + -r9.w;
            r8.w = r14.w * r8.w + r9.w;
            r30.xyz = r8.www * r30.xyz + r31.xyz;
            r30.xyz = r7.www ? r30.xyz : lightConstantsCB[r6.w].data[0].xyz;
            r30.xyz = r30.xyz + -r10.xyz;
            r7.w = dot(r30.xyz, r30.xyz);
            r7.w = rsqrt(r7.w);
            r31.xyz = r30.xyz * r7.www;
            ...
            if (r9.w != 0) {
              ...
              r32.xyz = lightConstantsCB[r8.w].data[6].yzw;
              r32.w = lightConstantsCB[r8.w].data[7].x;
              r9.w = dot(r32.xyzw, r19.xyzw);
              r32.xyz = lightConstantsCB[r8.w].data[7].yzw;
              r32.w = lightConstantsCB[r8.w].data[8].x;
              r14.w = dot(r32.xyzw, r19.xyzw);
              r20.w = cmp(r14.w < r9.w);
              if (r20.w == 0) {
                r32.xyz = lightConstantsCB[r8.w].data[4].yzw;
                r32.w = lightConstantsCB[r8.w].data[5].x;
                r32.x = dot(r32.xyzw, r19.xyzw);
                r33.xyz = lightConstantsCB[r8.w].data[5].yzw;
                r33.w = lightConstantsCB[r8.w].data[6].x;
                r32.y = dot(r33.xyzw, r19.xyzw);
                r19.xy = r32.xy / r14.ww;
                r19.xy = r19.xy * float2(0.5,-0.5) + float2(0.5,0.5);
                r32.x = lightConstantsCB[r8.w].data[9].w + r19.x;
                r32.y = lightConstantsCB[r8.w].data[10].x + r19.y;
                r19.xy = lightConstantsCB[r8.w].data[9].yz * r32.xy;
                r32.xy = lightConstantsCB[r8.w].data[3].yy / lightConstantsCB[r8.w].data[8].yw;
                ...
                if (r19.z == 0) {
                  ...
                  r32.x = r19.x * lightConstantsCB[r8.w].data[8].y + lightConstantsCB[r8.w].data[8].z;
                  r32.y = r19.y * lightConstantsCB[r8.w].data[8].w + lightConstantsCB[r8.w].data[9].x;
                  r19.x = lightConstantsCB[r8.w].data[10].z * r14.w;
                  r9.w = lightConstantsCB[r8.w].data[10].y * r14.w + r9.w;
                  r9.w = r9.w / r19.x;
                }
              } else {
                r19.z = -1;
              }
              r14.w = (int)r20.w | (int)r19.z;
              if (r14.w == 0) {
                r9.w = max(6.10351563e-05, r9.w);
                r14.w = 0x0000ffff & (int)lightConstantsCB[r8.w].data[1].w;
                if (enableDitheredShadow != 0) {
                  ...
                  while (true) {
                    ...
                    r33.y = dot(icb[r25.w+0].xy, r13.xy);
                    r19.xy = r33.xy * lightConstantsCB[r8.w].data[3].yy + r32.xy;
                    r19.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r19.xyz, r9.w).x;
                    r20.w = r19.x * 0.125 + r20.w;
                    r25.w = (int)r25.w + 1;
                  }
                } else {
                  r32.z = (uint)r14.w;
                  r20.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r32.xyz, r9.w).x;
                }
                r8.w = r20.w * r20.w;
                r8.w = r8.w * r20.w;
              } else {
              ...
              if (r9.w != 0) {
                ...
                r32.xyz = lightConstantsCB[r8.w].data[6].yzw;
                r32.w = lightConstantsCB[r8.w].data[7].x;
                r9.w = dot(r32.xyzw, r21.xyzw);
                r32.xyz = lightConstantsCB[r8.w].data[7].yzw;
                r32.w = lightConstantsCB[r8.w].data[8].x;
                r14.w = dot(r32.xyzw, r21.xyzw);
                r19.x = cmp(r14.w < r9.w);
                if (r19.x == 0) {
                  r32.xyz = lightConstantsCB[r8.w].data[4].yzw;
                  r32.w = lightConstantsCB[r8.w].data[5].x;
                  ...
                  r19.yz = r32.xy / r14.ww;
                  r19.yz = r19.yz * float2(0.5,-0.5) + float2(0.5,0.5);
                  r21.x = lightConstantsCB[r8.w].data[9].w + r19.y;
                  r21.y = lightConstantsCB[r8.w].data[10].x + r19.z;
                  r19.yz = lightConstantsCB[r8.w].data[9].yz * r21.xy;
                  r21.xy = lightConstantsCB[r8.w].data[3].yy / lightConstantsCB[r8.w].data[8].yw;
                  ...
                  if (r21.x == 0) {
                    ...
                    r32.x = r19.y * lightConstantsCB[r8.w].data[8].y + lightConstantsCB[r8.w].data[8].z;
                    r32.y = r19.z * lightConstantsCB[r8.w].data[8].w + lightConstantsCB[r8.w].data[9].x;
                    r19.y = lightConstantsCB[r8.w].data[10].z * r14.w;
                    r9.w = lightConstantsCB[r8.w].data[10].y * r14.w + r9.w;
                    r9.w = r9.w / r19.y;
                  }
                } else {
                ...
                if (r14.w == 0) {
                  ...
                  if (enableDitheredShadow != 0) {
                    ...
                    while (true) {
                      ...
                      if (r21.z != 0) break;
                      r33.x = dot(icb[r21.y+0].xy, r14.xy);
                      r33.y = dot(icb[r21.y+0].yx, r14.xz);
                      r19.xy = r33.xy * lightConstantsCB[r8.w].data[3].yy + r32.xy;
                      r19.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r19.xyz, r9.w).x;
                    ...
                    r32.z = (uint)r14.w;
                    r21.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r32.xyz, r9.w).x;
                  }
                  r8.w = r21.x * r21.x;
                  r8.w = r8.w * r21.x;
                } else {
            ...
            r8.w = r8.w + -r13.z;
            r8.w = r1.z * r8.w + r13.z;
            r8.w = r8.w * r11.w;
            r19.x = lightConstantsCB[r6.w].data[0].w;
            r19.yz = lightConstantsCB[r6.w].data[1].xy;
            r9.w = cmp(0 < r12.w);
            r32.xyz = r8.www * r19.xyz + r15.yzw;
            r8.w = saturate(dot(r11.xyz, r31.xyz));
            r30.xyz = r30.xyz * r7.www + r12.xyz;
            r7.w = dot(r30.xyz, r30.xyz);
            r7.w = rsqrt(r7.w);
            r30.xyz = r30.xyz * r7.www;
            r7.w = dot(r30.xyz, r12.xyz);
            r12.w = dot(r11.xyz, r30.xyz);
            r13.z = abs(r12.w) * r0.z + -abs(r12.w);
            r12.w = abs(r12.w) * r13.z + 1;
            r13.z = r8.w * r0.w + r1.w;
            r12.w = r12.w * r12.w;
            r12.w = r12.w * r13.z;
            r12.w = rcp(r12.w);
            r8.w = r8.w * r13.w;
            r8.w = r12.w * r8.w;
            r8.w = r8.w * r11.w;
            r30.xyz = r8.www * r19.xyz + r29.xyz;
            r7.w = saturate(1 + -r7.w);
            r11.w = r7.w * r7.w;
            r11.w = r11.w * r11.w;
            r7.w = r11.w * r7.w;
            r7.w = r8.w * r7.w;
            r19.xyz = r7.www * r19.xyz + r28.xyz;
            r15.yzw = r9.www ? r32.xyz : r15.yzw;
            r28.xyz = r9.www ? r19.xyz : r28.xyz;
            r29.xyz = r9.www ? r30.xyz : r29.xyz;
          }
        }
      }
      break;
      case 2 :      r19.xy = lightConstantsCB[r6.w].data[3].zw + -r10.xy;
      r19.z = lightConstantsCB[r6.w].data[4].x + -r10.z;
      r7.w = dot(r19.xyz, r19.xyz);
      r7.w = rsqrt(r7.w);
      r30.xyz = r19.xyz * r7.www;
      r8.w = dot(r11.xyz, r30.xyz);
      r9.w = saturate(r8.w);
      r11.w = cmp(0 < r9.w);
      if (r11.w != 0) {
        r30.xyz = lightConstantsCB[r6.w].data[7].yzw;
        r30.w = lightConstantsCB[r6.w].data[8].x;
        r11.w = dot(r30.xyzw, r10.xyzw);
        r12.w = cmp(r11.w < 1);
        if (r12.w != 0) {
          r31.xyz = float3(1,1,1);
          r12.w = 0;
        } else {
          r32.xyz = lightConstantsCB[r6.w].data[0].xyz + -r10.xyz;
          r13.z = lightConstantsCB[r6.w].data[3].x * lightConstantsCB[r6.w].data[3].x;
          r13.w = dot(r32.xyz, r32.xyz);
          r13.z = r13.z / r13.w;
          r13.z = min(1, r13.z);
          r21.yz = saturate(r11.ww * lightConstantsCB[r6.w].data[2].xz + lightConstantsCB[r6.w].data[2].yw);
          ...
          r20.xy = r32.xy / r11.ww;
          r11.w = cmp(lightConstantsCB[r6.w].data[10].w < 0.00048828125);
          if (r11.w != 0) {
            r21.yz = saturate(abs(r20.xy) * lightConstantsCB[r6.w].data[12].xy + lightConstantsCB[r6.w].data[12].zw);
            r32.xy = r21.yz * r21.yz;
            r21.yz = r21.yz * float2(-2,-2) + float2(3,3);
            r21.yz = r32.xy * r21.yz;
            r11.w = r21.y * r21.z;
          } else {
            r32.xyzw = saturate(lightConstantsCB[r6.w].data[11].xyzw * abs(r20.yyxx));
            r32.xyzw = log2(r32.xyzw);
            r32.xyzw = lightConstantsCB[r6.w].data[12].zzzz * r32.xyzw;
            r32.xyzw = exp2(r32.xyzw);
            r21.yz = r32.xy + r32.zw;
            r21.yz = log2(r21.yz);
            r21.yz = lightConstantsCB[r6.w].data[12].ww * r21.yz;
            r21.yz = exp2(r21.yz);
            r13.w = lightConstantsCB[r6.w].data[12].x * r21.y;
            r14.w = lightConstantsCB[r6.w].data[12].y * r21.z + -1;
            r13.w = lightConstantsCB[r6.w].data[12].y * r21.z + -r13.w;
          ...
          if (r11.w != 0) {
            r13.z = dot(lightConstantsCB[r6.w].data[13].xyz, r20.xyz);
            r32.x = lightConstantsCB[r6.w].data[13].w;
            r32.yz = lightConstantsCB[r6.w].data[14].xy;
        ...
        r32.x = lightConstantsCB[r6.w].data[0].w;
        r32.yz = lightConstantsCB[r6.w].data[1].xy;
        ...
        if (r11.w != 0) {
          ...
          if (r11.w != 0) {
            ...
            r11.w = dot(r32.xyzw, r22.xyzw);
            r13.z = dot(r30.xyzw, r22.xyzw);
            r13.w = cmp(r13.z >= r11.w);
            if (r13.w != 0) {
              r30.xyz = lightConstantsCB[r6.w].data[4].yzw;
              r30.w = lightConstantsCB[r6.w].data[5].x;
              r20.x = dot(r30.xyzw, r22.xyzw);
              r30.xyz = lightConstantsCB[r6.w].data[5].yzw;
              r30.w = lightConstantsCB[r6.w].data[6].x;
              r20.y = dot(r30.xyzw, r22.xyzw);
              r20.xy = r20.xy / r13.zz;
              r20.xy = saturate(r20.xy * float2(0.5,-0.5) + float2(0.5,0.5));
              r22.x = r20.x * lightConstantsCB[r6.w].data[8].y + lightConstantsCB[r6.w].data[8].z;
              r22.y = r20.y * lightConstantsCB[r6.w].data[8].w + lightConstantsCB[r6.w].data[9].x;
              r11.w = r11.w / r13.z;
              ...
              if (enableDitheredShadow != 0) {
                ...
                r14.w = 0;
                while (true) {
                  r20.x = cmp((int)r14.w >= 8);
                  if (r20.x != 0) break;
                  r20.x = dot(icb[r14.w+0].xy, r25.xy);
                  r20.y = dot(icb[r14.w+0].yx, r25.xz);
                  r30.xy = r20.xy * lightConstantsCB[r6.w].data[3].yy + r22.xy;
                  r20.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r30.xyz, r11.w).x;
          ...
          if (r12.w != 0) {
            ...
            r14.w = cmp(0 < (uint)r13.z);
            r14.w = r0.y ? r14.w : 0;
            if (r14.w != 0) {
              r13.z = (int)r13.z + numLights;
              r13.z = mad((int)r13.z, 15, -15);
              r14.w = abs(r8.w) * -0.200000003 + 0.400000006;
              r23.xyz = r11.xyz * r14.www + r10.xyz;
              r30.xyz = lightConstantsCB[r13.z].data[6].yzw;
              r30.w = lightConstantsCB[r13.z].data[7].x;
              r14.w = dot(r30.xyzw, r23.xyzw);
              r30.xyz = lightConstantsCB[r13.z].data[7].yzw;
              r30.w = lightConstantsCB[r13.z].data[8].x;
              r20.x = dot(r30.xyzw, r23.xyzw);
              r20.y = cmp(r20.x < r14.w);
              if (r20.y == 0) {
                r30.xyz = lightConstantsCB[r13.z].data[4].yzw;
                r30.w = lightConstantsCB[r13.z].data[5].x;
                r22.x = dot(r30.xyzw, r23.xyzw);
                r30.xyz = lightConstantsCB[r13.z].data[5].yzw;
                r30.w = lightConstantsCB[r13.z].data[6].x;
                r22.y = dot(r30.xyzw, r23.xyzw);
                r21.yz = r22.xy / r20.xx;
                r21.yz = r21.yz * float2(0.5,-0.5) + float2(0.5,0.5);
                r22.x = lightConstantsCB[r13.z].data[9].w + r21.y;
                r22.y = lightConstantsCB[r13.z].data[10].x + r21.z;
                r21.yz = lightConstantsCB[r13.z].data[9].yz * r22.xy;
                r22.xy = lightConstantsCB[r13.z].data[3].yy / lightConstantsCB[r13.z].data[8].yw;
                ...
                if (r22.x == 0) {
                  ...
                  r23.x = r21.y * lightConstantsCB[r13.z].data[8].y + lightConstantsCB[r13.z].data[8].z;
                  r23.y = r21.z * lightConstantsCB[r13.z].data[8].w + lightConstantsCB[r13.z].data[9].x;
                  r21.y = lightConstantsCB[r13.z].data[10].z * r20.x;
                  r14.w = lightConstantsCB[r13.z].data[10].y * r20.x + r14.w;
                  r14.w = r14.w / r21.y;
                }
              } else {
                r22.x = -1;
              ...
              if (r20.x == 0) {
                ...
                r20.x = 0x0000ffff & (int)lightConstantsCB[r13.z].data[1].w;
                if (enableDitheredShadow != 0) {
                  r22.z = (uint)r20.x;
                  r20.y = 0;
                  r21.y = 0;
                  while (true) {
                    ...
                    r22.xy = r30.xy * lightConstantsCB[r13.z].data[3].yy + r23.xy;
                    r21.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r22.xyz, r14.w).x;
                    r20.y = r21.z * 0.125 + r20.y;
                    r21.y = (int)r21.y + 1;
                  }
                } else {
                  r23.z = (uint)r20.x;
                  r20.y = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r23.xyz, r14.w).x;
                }
                r13.z = r20.y * r20.y;
                r13.z = r13.z * r20.y;
              } else {
              ...
              if (r13.z != 0) {
                ...
                r24.xyz = r11.xyz * r13.zzz + r10.xyz;
                r30.xyz = lightConstantsCB[r6.w].data[6].yzw;
                r30.w = lightConstantsCB[r6.w].data[7].x;
                r13.z = dot(r30.xyzw, r24.xyzw);
                r30.xyz = lightConstantsCB[r6.w].data[7].yzw;
                r30.w = lightConstantsCB[r6.w].data[8].x;
                r14.w = dot(r30.xyzw, r24.xyzw);
                r20.x = cmp(r14.w < r13.z);
                if (r20.x == 0) {
                  r30.xyz = lightConstantsCB[r6.w].data[4].yzw;
                  r30.w = lightConstantsCB[r6.w].data[5].x;
                  ...
                  r21.yz = r22.xy / r14.ww;
                  r21.yz = r21.yz * float2(0.5,-0.5) + float2(0.5,0.5);
                  r22.x = lightConstantsCB[r6.w].data[9].w + r21.y;
                  r22.y = lightConstantsCB[r6.w].data[10].x + r21.z;
                  r21.yz = lightConstantsCB[r6.w].data[9].yz * r22.xy;
                  ...
                  if (r22.x == 0) {
                    r21.yz = saturate(r21.yz);
                    r23.x = r21.y * lightConstantsCB[r6.w].data[8].y + lightConstantsCB[r6.w].data[8].z;
                    r23.y = r21.z * lightConstantsCB[r6.w].data[8].w + lightConstantsCB[r6.w].data[9].x;
                    r21.y = lightConstantsCB[r6.w].data[10].z * r14.w;
                    r13.z = lightConstantsCB[r6.w].data[10].y * r14.w + r13.z;
                    r13.z = r13.z / r21.y;
                  }
                } else {
                  r22.x = -1;
                }
                r14.w = (int)r20.x | (int)r22.x;
                if (r14.w == 0) {
                  ...
                  if (enableDitheredShadow != 0) {
                    ...
                    while (true) {
                      ...
                      r22.xy = r24.xy * lightConstantsCB[r6.w].data[3].yy + r23.xy;
                      r21.z = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r22.xyz, r13.z).x;
                      r20.x = r21.z * 0.125 + r20.x;
                      r21.y = (int)r21.y + 1;
                    }
                  } else {
                    r23.z = (uint)r14.w;
                    r20.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r23.xyz, r13.z).x;
                  }
                  r6.w = r20.x * r20.x;
                  r6.w = r6.w * r20.x;
                } else {
            ...
            r6.w = r6.w * r11.w;
            r8.w = cmp(0 < r8.w);
            r22.xyz = r6.www * r31.xyz + r15.yzw;
            r19.xyz = r19.xyz * r7.www + r12.xyz;
            r6.w = dot(r19.xyz, r19.xyz);
            r6.w = rsqrt(r6.w);
            r19.xyz = r19.xyz * r6.www;
            r6.w = dot(r19.xyz, r12.xyz);
            r7.w = dot(r11.xyz, r19.xyz);
            r13.z = abs(r7.w) * r0.z + -abs(r7.w);
            r7.w = abs(r7.w) * r13.z + 1;
            r9.w = r9.w * r0.w + r1.w;
            r7.w = r7.w * r7.w;
            r7.w = r7.w * r9.w;
            r7.w = rcp(r7.w);
            ...
            r7.w = r11.w * r7.w;
            r7.w = 0.25 * r7.w;
            r19.xyz = r7.www * r31.xyz + r29.xyz;
            r6.w = saturate(1 + -r6.w);
            r9.w = r6.w * r6.w;
            r9.w = r9.w * r9.w;
            r6.w = r9.w * r6.w;
            r6.w = r7.w * r6.w;
            r23.xyz = r6.www * r31.xyz + r28.xyz;
            r15.yzw = r8.www ? r22.xyz : r15.yzw;
            r28.xyz = r8.www ? r23.xyz : r28.xyz;
