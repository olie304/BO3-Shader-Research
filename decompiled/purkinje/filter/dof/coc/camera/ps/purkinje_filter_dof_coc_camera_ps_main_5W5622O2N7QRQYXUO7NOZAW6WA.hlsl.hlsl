  ...
  out float o1 : SV_TARGET1)
{
  ...
  r0.xyz = lensFilter.Sample(bilinearClamp_s, v1.xy).xyz;
  r1.xy = (int2)v0.xy;
  r1.zw = float2(0,0);
  r2.xyz = codeTexture0.Load(r1.xyw).xyz;
  r0.w = codeTexture1.Load(r1.xyz).x;
  o0.xyz = r2.xyz * r0.xyz;
  r0.x = r0.w * 64 + -63;
  r0.xy = max(float2(9.99999994e-09,9.99999994e-09), r0.xw);
  r0.z = cmp(r0.w >= 0.984375);
