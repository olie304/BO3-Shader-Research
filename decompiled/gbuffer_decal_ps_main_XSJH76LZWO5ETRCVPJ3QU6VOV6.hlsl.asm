...
mul r0.x, r0.x, r2.w
sample_indexable(texture2d)(float,float,float,float) r3.z, r0.yzyy, t12.yzxw, s4
...
mad r1.yzw, r5.xxyz, r0.zzzz, r1.yyzw
...
mul r4.xy, r2.xzxx, l(-1.22474492, 1.22474492, 0.000000, 0.000000)
mul r5.xyz, r2.xyzx, l(0.70710677, -1.41421354, 0.70710677, 0.000000)
dp3 r5.x, r1.xyzx, r5.xyzx
dp2 r5.y, r1.xzxx, r4.xyxx
dp3 r0.w, r1.xyzx, r2.xyzx
add r0.w, |r0.w|, l(1.000000)
rsq r0.w, r0.w
mul r1.xy, r0.wwww, r5.xyxx
...
mov r3.xyw, l(0.040000,0.500000,0,1.000000)
