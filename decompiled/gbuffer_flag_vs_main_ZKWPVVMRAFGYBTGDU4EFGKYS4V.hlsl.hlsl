...
r0.x = modelInstanceBuffer[]..swiz;
  ...
  r5.w = r6.y;
  r2.x = dot(r1.xyzw, r5.xyzw);
  r7.w = r6.z;
  r1.x = dot(r1.xyzw, r7.xyzw);
  r6.x = dot(r0.yzw, r4.xyz);
  r6.y = dot(r0.yzw, r5.xyz);
  r6.z = dot(r0.yzw, r7.xyz);
  r0.y = dot(r6.xyz, r6.xyz);
  r0.y = rsqrt(r0.y);
  o3.xyz = r6.xyz * r0.yyy;
  r6.x = dot(r2.yzw, r4.xyz);
  r6.y = dot(r2.yzw, r5.xyz);
  r6.z = dot(r2.yzw, r7.xyz);
  r0.y = dot(r6.xyz, r6.xyz);
  r0.y = rsqrt(r0.y);
  o4.xyz = r6.xyz * r0.yyy;
  r4.x = dot(r3.xyz, r4.xyz);
  r4.y = dot(r3.xyz, r5.xyz);
  r4.z = dot(r3.xyz, r7.xyz);
  r0.y = dot(r4.xyz, r4.xyz);
  r0.y = rsqrt(r0.y);
  o5.xyz = r4.xyz * r0.yyy;
  r2.xyzw = viewProjectionMatrix._m10_m11_m12_m13 * r2.xxxx;
  r0.xyzw = r0.xxxx * viewProjectionMatrix._m00_m01_m02_m03 + r2.xyzw;
