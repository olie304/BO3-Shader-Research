...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r1.w = tintMask.Sample(colorSampler_s, w1.xy).x;
  ...
  while (true) {
    ...
    r10.z = cmp((int)r3.x == (int)r9.w);
    bitmask.w = ((~(-1 << r3.y)) << 0) & 0xffffffff;  r10.w = (((uint)0 << 0) & bitmask.w) | ((uint)r10.y & ~bitmask.w);
    r10.y = r10.z ? r10.w : r10.y;
    r10.z = cmp((int)r3.z == (int)r9.w);
  ...
  if (r3.z != 0) {
    ...
    while (true) {
      ...
      r12.w = cmp((int)r3.x == (int)r8.w);
      if (r3.y == 0) r13.z = 0; else if (r3.y+0 < 32) {       r13.z = (uint)r9.w << (32-(r3.y + 0)); r13.z = (uint)r13.z >> (32-r3.y);      } else r13.z = (uint)r9.w >> 0;
  ...
  r13.xyz = r7.zwy * r3.xxx;
  r3.xyz = r7.yzw * r3.yyy;
  r1.w = sqrt(r6.y);
  r1.w = r1.w * 0.5 + 0.5;
  r1.w = r1.w * r1.w;
  r2.w = 0.5 * r1.w;
  ...
  if (r7.y == 0) {
    ...
    r7.y = -sunConstants.splitDepthOffset + r10.w;
    ...
    if (r8.w == 0) {
      if (enableDitheredShadow == 0) {
        ...
        r15.z = r8.w + r7.w;
        r8.w = gSunShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r15.xyz, r7.y).x;
      ...
      if (enableDitheredShadow != 0) {
        ...
        while (true) {
          ...
          r12.w = r11.w ? sunConstants.splitPinTransform[r7.w].w : sunConstants.splitPinTransform[r8.w].w;
          r11.w = r11.w ? r7.w : r8.w;
  ...
  if (r7.y != 0) {
    r7.y = cmp(0 < r7.z);
    if (r7.y != 0) {
      r7.y = sunConstants.specScale * r5.w;
      r7.y = r7.y * r6.w;
      ...
      r18.z = samp0[]..swiz;
      r18.w = samp0[]..swiz;
        r8.w = abs(r6.z) * -0.200000003 + 0.400000006;
      ...
      r16.xyz = -v5.xyz * r3.www + sunConstants.wldDir.xyz;
      r3.w = dot(r16.xyz, r16.xyz);
      r3.w = rsqrt(r3.w);
      r16.xyz = r16.xyz * r3.www;
      r3.w = dot(r16.xyz, r5.xyz);
      r7.w = dot(r2.xyz, r16.xyz);
      r8.z = abs(r7.w) * r5.w + -abs(r7.w);
      r7.w = abs(r7.w) * r8.z + 1;
      r6.w = r6.w * r1.w + r2.w;
      r7.w = r7.w * r7.w;
      r6.w = r7.w * r6.w;
      r6.w = rcp(r6.w);
      ...
      r15.w = r16.z;
      r14.w = r13.z;
      r14.xyzw = r6.zzzz ? r15.xyzw : r14.xyzw;
      r16.zw = r7.yz;
      r13.zw = r3.xy;
      r15.xyzw = r6.zzzz ? r16.xyzw : r13.xyzw;
      r3.z = r6.z ? r7.w : r3.z;
      r13.z = r14.w;
      r13.xy = r15.xy;
      r3.xy = r15.zw;
  ...
  while (true) {
    ...
    if (r8.z != 0) break;
    r7.z = (uint)r7.w >> 5;
    r16.xyz = (int3)r7.xyz + (int3)r12.xyz;
            ...
            if (r25.w != 0) {
              ...
              if (r25.w != 0) {
                ...
                if (r25.w != 0) {
                  ...
                  r20.w = abs(r18.x) * r5.w + -abs(r18.x);
                  r18.x = abs(r18.x) * r20.w + 1;
                  r20.w = r12.w * r1.w + r2.w;
                  r18.x = r18.x * r18.x;
                  r18.x = r18.x * r20.w;
                  r18.x = rcp(r18.x);
                  r12.w = r12.w * r25.w;
            ...
            r39.w = samp0[]..swiz;
              ...
              if (r14.w != 0) {
                ...
                if (r14.w != 0) {
                  ...
                  r39.y = samp0[]..swiz;
                    ...
                    if (r8.z != 0) {
                      ...
                      r21.z = (uint)r14.w;
                      r24.w = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r21.xyz, r9.w).x;
                    }
                    r9.w = r24.w * r24.w;
                    r9.w = r9.w * r24.w;
                  } else {
                ...
                if (r14.w != 0) {
                  ...
                  r18.x = dot(r2.xyz, r19.xyz);
                  r19.x = abs(r18.x) * r5.w + -abs(r18.x);
