...
// pixelTexture                      texture  float4          2d             t0      1 
// blurTexture                       texture  float4          2d             t6      1 
// fireTexture                       texture  float4          2d             t7      1 
...
mov x0[1].xy, l(0.250000,0,0,0)
mov x0[2].xy, l(0.500000,0,0,0)
mov x0[3].xy, l(0.750000,0,0,0)
mov x0[4].xy, l(0,0.250000,0,0)
mov x0[5].xy, l(0.250000,0.250000,0,0)
mov x0[6].xy, l(0.500000,0.250000,0,0)
mov x0[7].xy, l(0.750000,0.250000,0,0)
mov x0[8].xy, l(0,0.500000,0,0)
mov x0[9].xy, l(0.250000,0.500000,0,0)
mov x0[10].xy, l(0.500000,0.500000,0,0)
mov x0[11].xy, l(0.750000,0.500000,0,0)
mov x0[12].xy, l(0,0.750000,0,0)
mov x0[13].xy, l(0.250000,0.750000,0,0)
mov x0[14].xy, l(0.500000,0.750000,0,0)
mov x0[15].xy, l(0.750000,0.750000,0,0)
mul r0.x, cb8[0].y, cb1[69].w
frc r0.x, r0.x
mul r0.x, r0.x, l(16.000000)
ftoi r0.x, r0.x
mov r0.xy, x0[r0.x + 0].xyxx
mad r0.xy, v1.xyxx, l(0.250000, 0.250000, 0.000000, 0.000000), r0.xyxx
sample_indexable(texture2d)(float,float,float,float) r0.xyzw, r0.xyxx, t7.xyzw, s1
add r1.xy, v1.xyxx, l(-0.500000, -0.500000, 0.000000, 0.000000)
mul r1.xy, r1.xyxx, l(2.000000, 1.125000, 0.000000, 0.000000)
dp2 r1.x, r1.xyxx, r1.xyxx
sqrt r1.x, r1.x
mad_sat r1.x, -cb8[0].x, r1.x, l(1.000000)
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, v1.xyxx, t0.xyzw, s1
sample_indexable(texture2d)(float,float,float,float) r3.xyzw, v1.xyxx, t6.xyzw, s1
mul r3.xyzw, r3.xyzw, l(0.00003052, 0.00003052, 0.00003052, 1.000000)
mad r2.xyzw, r2.xyzw, l(0.00003052, 0.00003052, 0.00003052, 1.000000), -r3.xyzw
mad r1.xyzw, r1.xxxx, r2.xyzw, r3.xyzw
mul r2.x, cb8[0].z, l(4.000000)
