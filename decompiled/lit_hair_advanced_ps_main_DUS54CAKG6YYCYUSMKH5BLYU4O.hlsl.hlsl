...
// unknown dcl_: dcl_uav_typed_texture2darray (uint,uint,uint,uint) u7
  ...
  r2.y = aoMap.Sample(aoSampler_s, v2.xy).x;
  ...
  r3.y = max(0, r0.w);
  r2.xzw = -eyeOffset.yyy * viewProjectionMatrix._m10_m11_m13;
  r2.xzw = -eyeOffset.xxx * viewProjectionMatrix._m00_m01_m03 + r2.xzw;
  r2.xzw = -eyeOffset.zzz * viewProjectionMatrix._m20_m21_m23 + r2.xzw;
  r2.xzw = viewProjectionMatrix._m30_m31_m33 + r2.xzw;
  r4.xyz = eyeOffset.xyz + v6.xyz;
  r0.w = cavityMap.Sample(LinearSampler_s, v2.xy).x;
  ...
  r5.w = rcp(r5.w);
  r6.w = dot(-v6.xyz, -v6.xyz);
  r6.w = rsqrt(r6.w);
  r10.xyz = -v6.xyz * r6.www;
  r9.zw = (uint2)r9.yx;
  ...
  r9.w = r8.w * r3.w;
  r9.w = sqrt(r9.w);
  r13.yzw = sunConstants.sstLightingConstants.offToPinTransform._m10_m11_m12 * v6.yyy;
  r13.yzw = v6.xxx * sunConstants.sstLightingConstants.offToPinTransform._m00_m01_m02 + r13.yzw;
  r13.yzw = v6.zzz * sunConstants.sstLightingConstants.offToPinTransform._m20_m21_m22 + r13.yzw;
  ...
  if (r10.w != 0) {
    ...
    r4.w = -r4.w * r4.w + 1;
    r18.xyz = sqrt(r4.www);
    r19.xyz = -v6.xyz * r6.www + sunConstants.wldDir.xyz;
  ...
  r4.z = rcp(r2.w);
  r4.xy = r2.xz * r4.zz + r13.xy;
  r13.w = 0.5;
  r2.xzw = r4.xyz + r13.wwz;
  ...
  if (r4.x == 0) {
    ...
    r4.y = r4.y * r4.y + -r3.z;
    r3.z = r4.x * r4.y + r3.z;
    r2.xzw = r2.xzw * r3.zzz + r11.xyz;
    r3.z = cmp(r3.w < r3.z);
    r2.xz = renderTargetSize.xy * r2.xz;
    r8.xy = (int2)r2.xz;
    r8.zw = float2(0,0);
  ...
  r2.x = min(r38.y, r2.x);
  r2.x = r38.x * r2.x;
  r2.xzw = r2.xxx * r33.xyz;
  r4.xyz = r2.xzw * r35.xyz + r30.xyz;
  r5.xyz = r2.xzw * r36.xyz + r32.xyz;
  r2.xzw = r2.xzw * r37.xyz + r31.xyz;
  r3.z = 1 + -r3.y;
  r3.w = 5 * r3.z;
  r4.w = r3.z * 5 + -2.5;
  ...
  r9.x = numRefProbes + -numOverrideProbes;
  r9.y = (int)r9.x & -32;
  r9.z = (int)-r9.y + (int)r9.x;
  r9.w = numRefProbes & -32;
  r10.w = (int)-r9.w + numRefProbes;
  r11.xyz = r15.xyz * r15.xyz;
  r12.xy = float2(0,0);
  r13.w = 0;
  r14.yz = float2(0,1);
  r15.x = 1;
  ...
  while (true) {
    ...
    r12.w = cmp((int)r9.y == (int)r11.w);
    bitmask.x = ((~(-1 << r9.z)) << 0) & 0xffffffff;  r13.x = (((uint)0 << 0) & bitmask.x) | ((uint)r12.z & ~bitmask.x);
    r12.z = r12.w ? r13.x : r12.z;
    r12.w = cmp((int)r9.w == (int)r11.w);
    if (r10.w == 0) r13.x = 0; else if (r10.w+0 < 32) {     r13.x = (uint)r12.z << (32-(r10.w + 0)); r13.x = (uint)r13.x >> (32-r10.w);    } else r13.x = (uint)r12.z >> 0;
    r12.z = r12.w ? r13.x : r12.z;
    ...
    while (true) {
      ...
      r22.y = samp0[]..swiz;
        ...
        r22.w = samp0[]..swiz;
          ...
          r13.z = (int)r22.w & 0x0000ffff;
          if (6 == 0) r14.w = 0; else if (6+25 < 32) {           r14.w = (uint)r22.w << (32-(6 + 25)); r14.w = (uint)r14.w >> (32-6);          } else r14.w = (uint)r22.w >> 25;
        // Known bad code for instruction (needs manual fix):
        ...
        r29.w = samp0[]..swiz;
          ...
          r31.w = samp0[]..swiz;
            ...
            r25.x = r23.w * r21.w;
            r24.z = (uint)r14.x >> 2;
            if (1 == 0) r24.w = 0; else if (1+2 < 32) {             r24.w = (uint)r14.x << (32-(1 + 2)); r24.w = (uint)r24.w >> (32-1);            } else r24.w = (uint)r14.x >> 2;
            r25.z = (int)r24.z & 2;
            r25.w = max(r25.y, r25.x);
            r21.w = -r21.w * r23.w + 1;
            r21.w = r25.y * r21.w;
            r15.y = r25.z ? r21.w : r25.w;
            r25.xy = r24.ww ? r25.xy : r15.xy;
            r20.w = (int)r20.w + 1;
            r14.x = r24.z;
          }
          ...
          r35.x = samp0[]..swiz;
          r35.y = samp0[]..swiz;
            r19.z = r25.y * r15.w + r19.z;
            r13.y = r13.z * r22.z;
            r22.z = r30.z;
            r13.z = dot(r8.xyz, r22.xyz);
            r14.x = dot(r23.xyz, r22.xyz);
            r14.x = r14.x + -r30.w;
            r14.w = cmp(r14.x >= 0);
            ...
            r30.z = r31.z;
            r14.x = dot(r8.xyz, r30.xyz);
            r14.w = dot(r23.xyz, r30.xyz);
            r14.w = r14.w + -r31.w;
            r15.y = cmp(r14.w >= 0);
            ...
            r31.z = r32.z;
            r14.x = dot(r8.xyz, r31.xyz);
            r14.w = dot(r23.xyz, r31.xyz);
            r14.w = r14.w + -r32.w;
            r15.y = cmp(r14.w >= 0);
            r14.w = max(abs(r14.w), r4.w);
            r14.w = r15.y ? r14.w : -r14.w;
            ...
            r13.z = min(abs(r14.x), r13.z);
            r35.zw = r34.zw;
            r14.x = dot(r8.zxy, r35.xzw);
            r14.w = dot(r23.zxy, r35.xzw);
            r14.w = r14.w + -r35.y;
            r15.y = cmp(r14.w >= 0);
            r14.w = max(abs(r14.w), r4.w);
            r14.w = r15.y ? r14.w : -r14.w;
            ...
            r22.x = r27.w;
            r22.yz = r28.zw;
            r15.yzw = r22.xyz + r23.xyz;
            r15.yzw = r8.xyz * r13.zzz + r15.yzw;
            r14.x = dot(r15.yzw, r15.yzw);
            r14.x = sqrt(r14.x);
            r13.z = r13.z / r14.x;
            r13.z = r13.z + r13.z;
            r13.z = sqrt(r13.z);
            ...
            r21.y = r24.z;
            r21.z = r26.x;
            r30.x = dot(r15.yzw, r21.xyz);
            r22.xy = r24.xw;
            r22.z = r26.w;
            r30.y = dot(r15.yzw, r22.xyz);
            r26.x = r24.y;
            r30.z = dot(r15.yzw, r26.xyz);
            if (9 == 0) r14.x = 0; else if (9+16 < 32) {             r14.x = (uint)r22.w << (32-(9 + 16)); r14.x = (uint)r14.x >> (32-9);            } else r14.x = (uint)r22.w >> 16;
            r30.w = (uint)r14.x;
            r15.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r30.xyzw, r13.z).xyz;
            ...
            r30.x = dot(r7.xyz, r21.xyz);
            r30.y = dot(r7.xyz, r22.xyz);
            r30.z = dot(r7.xyz, r26.xyz);
            r21.xyz = gProbeXArray.SampleLevel(samplerLinearClamp_s, r23.xyz, 0).xyz;
            r22.xyz = float3(0,0,0.5) + r23.xyz;
            r24.xyz = gProbeXArray.SampleLevel(samplerLinearClamp_s, r22.xyz, 0).xyz;
            r25.xzw = gProbeYArray.SampleLevel(samplerLinearClamp_s, r23.xyz, 0).xyz;
            r26.xyz = gProbeYArray.SampleLevel(samplerLinearClamp_s, r22.xyz, 0).xyz;
            ...
            r27.xyz = r26.xyz + r25.xzw;
            r27.xyz = r27.xyz + r23.xyz;
            r27.xyz = r27.xyz + r22.xyz;
            r27.xyz = r27.xyz * r11.xxx;
            r21.xyz = r24.xyz + r21.xyz;
            r23.xyz = r21.xyz + r23.xyz;
            r22.xyz = r23.xyz + r22.xyz;
            r22.xyz = r22.xyz * r11.yyy;
            r21.xyz = r21.xyz + r25.xzw;
            r21.xyz = r21.xyz + r26.xyz;
            r21.xyz = r21.xyz * r11.zzz;
            r22.xyz = float3(0.25,0.25,0.25) * r22.xyz;
            r22.xyz = r27.xyz * float3(0.25,0.25,0.25) + r22.xyz;
            r21.xyz = r21.xyz * float3(0.25,0.25,0.25) + r22.xyz;
            r21.xyz = r21.xyz * r13.yyy;
            r22.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r30.xyzw, 6).xyz;
            r23.xyz = r22.xyz * r21.xyz;
            r13.z = dot(r23.xyz, float3(0.212599993,0.715200007,0.0722000003));
            r18.xyz = r21.xyz * r22.xyz + r18.xyz;
            r14.x = r13.z * r6.w;
            r15.yzw = r15.yzw * r13.yyy;
            r13.y = dot(r15.yzw, float3(0.212599993,0.715200007,0.0722000003));
            r13.y = r6.w * r13.z + r13.y;
            r13.y = r14.x / r13.y;
            r21.x = r18.w;
            r21.yz = r19.xy;
            r19.xyw = r15.zwy * r13.yyy + r21.yzx;
            r18.w = r19.w;
          }
        }
      }
  ...
  if (r9.w != 0) {
    ...
    r10.w = 0;
    while (true) {
      r11.w = cmp((uint)r10.w >= (uint)r9.x);
      if (r11.w != 0) break;
      r12.z = (uint)r10.w >> 5;
      r13.xyz = (int3)r12.xyz + (int3)r20.xyz;
      r11.w = visibleProbes.Load(r13.xyzw).x;
      r12.z = cmp((int)r9.y == (int)r10.w);
      ...
      while (true) {
        ...
        r15.w = 1 << (int)r15.z;
        r19.w = (int)r14.w & (int)r15.w;
        if (r19.w != 0) {
          r14.w = (int)r14.w ^ (int)r15.w;
          r15.w = (int)r12.z + (int)r15.z;
        // Known bad code for instruction (needs manual fix):
        ...
        r23.y = samp0[]..swiz;
          ...
          r31.w = samp0[]..swiz;
            ...
            r32.w = samp0[]..swiz;
              ...
              r22.w = -r22.w * r25.w + 1;
              r22.w = r26.y * r22.w;
              r15.y = r27.x ? r22.w : r27.y;
              r26.xy = r26.ww ? r26.xy : r15.xy;
              r20.w = (int)r20.w + 1;
              r14.x = r26.z;
            }
            r14.x = saturate(r26.y + -r12.w);
            r15.y = r14.x * r23.y;
            r15.w = cmp(0 < r15.y);
            if (r15.w != 0) {
            // Known bad code for instruction (needs manual fix):
            ...
            r37.x = samp0[]..swiz;
            r37.y = samp0[]..swiz;
              r21.w = r14.x * r23.y + r21.w;
              r14.x = r15.y * r24.z;
              r24.z = r32.z;
              r15.y = dot(r8.xyz, r24.xyz);
              ...
              r23.xyz = r8.xyz * r15.yyy + r23.xyz;
              r15.z = dot(r23.xyz, r23.xyz);
              r15.z = sqrt(r15.z);
              r15.y = r15.y / r15.z;
              r15.y = r15.y + r15.y;
              r15.y = sqrt(r15.y);
              ...
              if (9 == 0) r15.z = 0; else if (9+16 < 32) {               r15.z = (uint)r24.w << (32-(9 + 16)); r15.z = (uint)r15.z >> (32-9);              } else r15.z = (uint)r24.w >> 16;
              r32.w = (uint)r15.z;
              r15.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r32.xyzw, r15.y).xyz;
              r23.x = dot(r25.xyz, r22.xyz);
              r23.y = dot(r25.xyz, r24.xyz);
              r23.z = dot(r25.xyz, r28.xyz);
              r23.xyz = saturate(r23.xyz * r29.xyz + float3(0.5,0.5,0.5));
              r30.z = r31.x;
              r23.xyz = r23.xyz * r30.xyz + r31.yzw;
              r32.x = dot(r7.xyz, r22.xyz);
              r32.y = dot(r7.xyz, r24.xyz);
              r32.z = dot(r7.xyz, r28.xyz);
              r22.xyz = gProbeXArray.SampleLevel(samplerLinearClamp_s, r23.xyz, 0).xyz;
              r24.xyz = float3(0,0,0.5) + r23.xyz;
              r25.xyz = gProbeXArray.SampleLevel(samplerLinearClamp_s, r24.xyz, 0).xyz;
              r26.xzw = gProbeYArray.SampleLevel(samplerLinearClamp_s, r23.xyz, 0).xyz;
              r27.xyz = gProbeYArray.SampleLevel(samplerLinearClamp_s, r24.xyz, 0).xyz;
              r23.xyz = gProbeZArray.SampleLevel(samplerLinearClamp_s, r23.xyz, 0).xyz;
              ...
              r22.xyz = r22.xyz * r14.xxx;
              r23.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r32.xyzw, 6).xyz;
              r24.xyz = r23.xyz * r22.xyz;
              r19.w = dot(r24.xyz, float3(0.212599993,0.715200007,0.0722000003));
              r13.xyz = r22.xyz * r23.xyz + r13.xyz;
              r20.w = r19.w * r6.w;
              r15.yzw = r15.yzw * r14.xxx;
              r14.x = dot(r15.yzw, float3(0.212599993,0.715200007,0.0722000003));
              r14.x = r6.w * r19.w + r14.x;
              r14.x = r20.w / r14.x;
              r21.xyz = r15.yzw * r14.xxx + r21.xyz;
            }
          }
        }
      }
  ...
  r9.xyz = r16.xyz * r3.zzz;
  r12.xyz = r17.xyz * r3.zzz;
  ...
  if (r4.w != 0) {
    ...
    r15.xyz = float3(0,0,0.5) + r13.xyz;
    r17.xyz = gProbeXArray.SampleLevel(samplerLinearClamp_s, r15.xyz, 0).xyz;
    r18.xyz = gProbeYArray.SampleLevel(samplerLinearClamp_s, r13.xyz, 0).xyz;
    r19.xyz = gProbeYArray.SampleLevel(samplerLinearClamp_s, r15.xyz, 0).xyz;
    ...
    r20.xyz = r20.xyz + r15.xyz;
    r20.xyz = r20.xyz * r11.xxx;
    r14.xyz = r17.xyz + r14.xyz;
    r13.xyz = r14.xyz + r13.xyz;
    r13.xyz = r13.xyz + r15.xyz;
    r11.xyw = r13.xyz * r11.yyy;
    r13.xyz = r14.xyz + r18.xyz;
    r13.xyz = r13.xyz + r19.xyz;
    r13.xyz = r13.xyz * r11.zzz;
    r11.xyz = float3(0.25,0.25,0.25) * r11.xyw;
    r11.xyz = r20.xyz * float3(0.25,0.25,0.25) + r11.xyz;
    r11.xyz = r13.xyz * float3(0.25,0.25,0.25) + r11.xyz;
  ...
  r7.xyz = r12.xyz * r2.yyy;
  r2.xyz = r7.xyz * r3.xxx + r2.xzw;
  r3.xyz = r7.xyz * r3.yyy + r5.xyz;
  r2.w = 0.0399999991 * r0.w;
  r0.w = -r0.w * 0.0399999991 + 1;
