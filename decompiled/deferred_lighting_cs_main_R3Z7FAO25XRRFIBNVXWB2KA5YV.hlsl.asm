...
loop 
  ...
  bfi r16.y, r10.z, l(0), l(0), r14.w
  movc r14.w, r15.w, r16.y, r14.w
  ieq r15.w, r10.w, r14.z
...
if_nz r0.z
  ...
  dp3 r4.w, r17.yzwy, l(0.212600, 0.715200, 0.072200, 0.000000)
  mad r10.yzw, r24.xxyz, r0.yyyy, r17.yyzw
  mov r18.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r17.yzw, r18.xyzw, t8.wxyz, s2, r7.w
...
if_nz r2.y
  ...
  if_nz r2.y
    ...
    if_nz r4.w
      ...
      add r23.x, r14.z, cb9[r2.z + 9].w
      add r23.y, r14.w, cb9[r2.z + 10].x
      mul r14.zw, r23.xxxy, cb9[r2.z + 9].yyyz
      ...
      if_z r4.w
        ...
        mad r22.x, r14.z, cb9[r2.z + 8].y, cb9[r2.z + 8].z
        mad r22.y, r14.w, cb9[r2.z + 8].w, cb9[r2.z + 9].x
    ...
    mad r22.xyz, r10.yzwy, r2.wwww, r22.xyzx
    mad r10.yzw, -r11.xxyz, r0.wwww, cb2[17].xxyz
    dp3 r0.w, r10.yzwy, r10.yzwy
    rsq r0.w, r0.w
    mul r10.yzw, r0.wwww, r10.yyzw
    dp3 r0.w, r10.yzwy, r13.xyzx
    dp3 r2.w, r12.xyzx, r10.yzwy
    ...
    mul r0.w, r0.w, r2.w
    mul r0.w, r0.w, r2.y
    mad r10.yzw, r0.wwww, r16.yyzw, r17.yyzw
    mad r2.yzw, r2.zzzz, r16.yyzw, r20.zzxy
    and r24.xyz, r2.zwyz, r3.xxxx
    mov r22.w, r20.z
    mov r19.w, r24.z
    movc r19.xyzw, r3.yyyy, r22.xyzw, r19.xyzw
    mov r20.zw, r10.yyyz
    mov r24.zw, r17.yyyz
    movc r22.xyzw, r3.yyyy, r20.xyzw, r24.xyzw
    mov r23.x, r10.w
    mov r21.w, r17.w
...
loop 
  ...
  switch r4.w
    ...
    if_nz r12.w
      sqrt r12.w, r7.w
      mul r13.w, cb9[r2.w + 3].x, cb9[r2.w + 3].x
      div r7.w, r13.w, r7.w
      min r7.w, r7.w, l(1.000000)
      mad_sat r14.zw, r12.wwww, cb9[r2.w + 2].xxxz, cb9[r2.w + 2].yyyw
      mul r36.xy, r14.zwzz, r14.zwzz
      mad r14.zw, r14.zzzw, l(0.000000, 0.000000, -2.000000, -2.000000), l(0.000000, 0.000000, 3.000000, 3.000000)
      mul r14.zw, r14.zzzw, r36.xxxy
      mul r7.w, r7.w, r14.z
      mul r7.w, r14.w, r7.w
      ...
      if_nz r12.w
        ...
        if_nz r12.w
          ...
          and r14.z, l(0x0000ffff), cb9[r2.w + 1].w
          utof r37.w, r14.z
          ...
          loop 
            ...
            sample_c_lz_indexable(texturecubearray)(float,float,float,float) r15.w, r37.xyzw, t10.xxxx, s13, r12.w
        ...
        if_nz r12.w
          ...
          dp3 r13.w, r34.xyzx, r18.xyzx
          dp3 r14.w, r18.xyzx, r35.xyzx
          mad r15.w, -r13.w, r13.w, cb9[r2.w + 6].y
          mad r5.z, r13.w, r14.w, -r5.z
          div_sat r5.z, r5.z, r15.w
          div r13.w, r15.w, cb9[r2.w + 6].y
          mul r13.w, r13.w, l(10.000000)
          min r13.w, r13.w, l(1.000000)
          add r5.z, -r6.w, r5.z
          mad r5.z, r13.w, r5.z, r6.w
          ...
          if_nz r6.w
            ...
            if_z r14.w
              ...
              or r15.w, r35.y, r35.x
              if_z r15.w
                mov_sat r23.xy, r23.xyxx
                mad r35.x, r23.x, cb9[r5.z + 8].y, cb9[r5.z + 8].z
                mad r35.y, r23.y, cb9[r5.z + 8].w, cb9[r5.z + 9].x
                mul r18.w, r13.w, cb9[r5.z + 10].z
                mad r6.w, cb9[r5.z + 10].y, r13.w, r6.w
                div r6.w, r6.w, r18.w
              endif 
            else 
              mov r15.w, l(-1)
            endif 
            or r13.w, r14.w, r15.w
            if_z r13.w
              max r6.w, r6.w, l(0.00006104)
              and r13.w, l(0x0000ffff), cb9[r5.z + 1].w
              if_nz cb2[58].y
                utof r23.z, r13.w
                mov r14.w, l(0)
                mov r15.w, l(0)
                loop 
                  ige r18.w, r15.w, l(8)
                  breakc_nz r18.w
                  dp2 r36.x, icb[r15.w + 0].yxyy, r22.xwxx
                  dp2 r36.y, icb[r15.w + 0].xyxx, r14.xyxx
              ...
              if_z r13.w
                ...
                if_nz cb2[58].y
                  ...
                  loop 
                    ige r19.w, r18.w, l(8)
                    breakc_nz r19.w
                    dp2 r35.x, icb[r18.w + 0].xyxx, r15.xyxx
                    dp2 r35.y, icb[r18.w + 0].yxyy, r15.xzxx
                  ...
                  utof r25.z, r13.w
                  sample_c_lz_indexable(texture2darray)(float,float,float,float) r15.w, r25.xyzx, t9.xxxx, s13, r6.w
                endif 
                mul r5.z, r15.w, r15.w
                mul r5.z, r15.w, r5.z
              else 
                mov r5.z, l(1.000000)
              endif 
          ...
          mad r16.yzw, r16.yyzw, r4.wwww, r13.xxyz
          dp3 r4.w, r16.yzwy, r16.yzwy
          rsq r4.w, r4.w
          mul r16.yzw, r4.wwww, r16.yyzw
          dp3 r4.w, r16.yzwy, r13.xyzx
          dp3 r9.w, r12.xyzx, r16.yzwy
          mad r13.w, |r9.w|, r1.z, -|r9.w|
          mad r9.w, |r9.w|, r13.w, l(1.000000)
          mad r13.w, r8.w, r0.y, r0.z
          mul r9.w, r9.w, r9.w
          mul r9.w, r13.w, r9.w
          rcp r9.w, r9.w
          mul r8.w, r12.w, r8.w
          mul r8.w, r8.w, r9.w
          mul r7.w, r7.w, r8.w
          mad r16.yzw, r7.wwww, r23.xxyz, r10.yyzw
          ...
          movc r10.yzw, r6.wwww, r16.yyzw, r10.yyzw
        endif 
      endif 
    endif 
    break 
    ...
    if_nz r8.w
      ...
      if_nz r9.w
        ...
        if_nz r8.w
          ...
          exp r25.xy, r25.xyxx
          mul r13.w, r25.x, cb9[r2.w + 12].x
          mad r18.w, cb9[r2.w + 12].y, r25.y, l(-1.000000)
          mad r13.w, cb9[r2.w + 12].y, r25.y, -r13.w
          div_sat r13.w, r18.w, r13.w
          mul r18.w, r13.w, r13.w
          mad r13.w, r13.w, l(-2.000000), l(3.000000)
          mul r8.w, r13.w, r18.w
        endif 
        mul r9.w, r8.w, r12.w
      ...
      if_nz r8.w
          ...
          if_nz r13.w
            ...
            if_nz cb2[58].y
              ...
              loop 
                ...
                mad r13.w, r19.w, l(0.125000), r13.w
                iadd r18.w, r18.w, l(1)
              endloop 
            else 
              utof r25.z, r12.w
              sample_c_lz_indexable(texture2darray)(float,float,float,float) r13.w, r25.xyzx, t9.xxxx, s13, r8.w
            endif 
        ...
        if_nz r9.w
          ...
          mad r23.xyz, r23.xyzx, r4.wwww, r13.xyzx
          dp3 r4.w, r23.xyzx, r23.xyzx
          rsq r4.w, r4.w
          mul r23.xyz, r4.wwww, r23.xyzx
          dp3 r4.w, r23.xyzx, r13.xyzx
          ...
          mad r23.xyz, r6.wwww, r16.yzwy, r10.yzwy
          add_sat r4.w, -r4.w, l(1.000000)
          mul r7.w, r4.w, r4.w
          mul r7.w, r7.w, r7.w
          mul r4.w, r4.w, r7.w
          ...
          movc r10.yzw, r5.zzzz, r23.xxyz, r10.yyzw
        endif 
      endif 
    endif 
    break 
...
ret 
// Approximately 1917 instruction slots used
