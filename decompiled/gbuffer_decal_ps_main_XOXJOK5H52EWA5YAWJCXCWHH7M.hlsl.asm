...
mul r1.w, r0.y, r1.w
sample_indexable(texture2d)(float,float,float,float) r2.z, r0.zwzz, t11.yzxw, s4
sample_indexable(texture2d)(float,float,float,float) r3.x, r0.zwzz, t10.xyzw, s2
add r3.y, -cb0[10].y, cb0[10].z
mad r3.x, r3.x, r3.y, cb0[10].y
mul_sat r3.x, r3.x, l(0.05882353)
sample_indexable(texture2d)(float,float,float,float) r3.yzw, r0.zwzz, t9.wxyz, s3
...
mad r0.zw, r3.yyyz, l(0.000000, 0.000000, 1.99218750, 1.99218750), l(0.000000, 0.000000, -1.000000, -1.000000)
