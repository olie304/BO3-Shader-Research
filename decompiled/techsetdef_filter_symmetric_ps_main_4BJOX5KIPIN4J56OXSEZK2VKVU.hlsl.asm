...
dcl_constantbuffer CB8[110], immediateIndexed
...
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, v6.xyxx, t0.xyzw, s0
add r1.xyzw, r1.xyzw, r2.xyzw
mad r0.xyzw, cb8[108].wwww, r1.xyzw, r0.xyzw
sample_indexable(texture2d)(float,float,float,float) r1.xyzw, v7.xyxx, t0.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, v8.xyxx, t0.xyzw, s0
add r1.xyzw, r1.xyzw, r2.xyzw
mad o0.xyzw, cb8[109].wwww, r1.xyzw, r0.xyzw
ret 
