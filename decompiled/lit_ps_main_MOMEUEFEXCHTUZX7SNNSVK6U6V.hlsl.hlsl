...
// unknown dcl_: dcl_resource_structured t23, 4
  ...
  r2.yzw = r5.xyz * r3.xxx + r2.yzw;
  r2.yzw = r4.xyz * r3.zzz + r2.yzw;
  ...
  r1.xyz = debugNormalOverride.www * r1.xyz + r2.yzw;
  r2.xy = (uint2)v0.xy;
  ...
  if (r8.y == 0) {
    ...
    while (true) {
      ...
      bitmask.w = ((~(-1 << r2.z)) << 0) & 0xffffffff;  r9.w = (((uint)0 << 0) & bitmask.w) | ((uint)r9.y & ~bitmask.w);
      r9.y = r9.z ? r9.w : r9.y;
    ...
    if (r8.y != 0) {
      ...
      r9.z = 0;
      while (true) {
        r9.w = cmp((uint)r9.z >= (uint)r2.x);
        if (r9.w != 0) break;
        r12.z = (uint)r9.z >> 5;
        r13.xyz = (int3)r11.xyz + (int3)r12.xyz;
        r9.w = visibleProbes.Load(r13.xyzw).x;
        r11.w = cmp((int)r2.y == (int)r9.z);
        if (r2.z == 0) r12.z = 0; else if (r2.z+0 < 32) {         r12.z = (uint)r9.w << (32-(r2.z + 0)); r12.z = (uint)r12.z >> (32-r2.z);        } else r12.z = (uint)r9.w >> 0;
  ...
  r2.xy = r4.xy * float2(0.984375,0.984375) + float2(0.0078125,0.0078125);
  r2.xy = gEnvBRDFGeneric.SampleLevel(samplerLinear_s, r2.xy, 0).xy;
  r8.yzw = r19.xyz * r1.www;
  r13.xyz = r8.zwy * r2.xxx;
  r2.xyz = r8.yzw * r2.yyy;
  r0.w = sqrt(r4.w);
  r0.w = r0.w * 0.5 + 0.5;
  r0.w = r0.w * r0.w;
  r1.w = 0.5 * r0.w;
