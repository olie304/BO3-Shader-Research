...
//
//   using 3Dmigoto v1.2.45 on Thu Jul 15 15:35:46 2021
//
//
// Buffer Definitions: 
//
...
//   bool forceIsolateHack;             // Offset:  312 Size:     4
//   float2 vertexColorScale;           // Offset:  320 Size:     8
//   uint zFeatherComputeSprites;       // Offset:  328 Size:     4 [unused]
//   float hdrScale;                    // Offset:  332 Size:     4 [unused]
//   float emissiveFalloffPower;        // Offset:  336 Size:     4 [unused]
//   float3 emissiveTint1;              // Offset:  340 Size:    12 [unused]
//   bool relativeHDR;                  // Offset:  352 Size:     4 [unused]
//   bool invertFalloff;                // Offset:  356 Size:     4 [unused]
//   float uvMotionToggle1;             // Offset:  360 Size:     4 [unused]
//
// }
//
...
mul r1.xyz, r0.xyzx, l(0.100000, 0.100000, 0.100000, 0.000000)
frc o3.xyz, r1.xyzx
if_nz cb0[19].z
  mul r1.xy, v1.xyxx, cb0[20].xyxx
  add r2.xyz, r8.xyzx, cb1[24].xyzx
  mul r0.z, cb1[69].w, cb2[38].y
  mad r0.w, cb1[69].w, cb2[38].y, l(0.500000)
  mad r2.w, r0.z, l(0.900000), r2.x
  mul r2.w, r2.w, l(0.700000)
  sincos r2.w, null, r2.w
  mad r3.x, r0.w, l(0.700000), r2.x
  mul r3.x, r3.x, l(0.700000)
  sincos null, r3.x, r3.x
  mul r3.y, v0.z, l(0.010000)
  mul r3.zw, cb2[38].zzzw, cb2[38].yyyy
  mul r3.z, r2.w, r3.z
  mul r4.x, r1.y, r3.z
  mul r3.z, r3.x, r3.w
  mul r4.y, r1.y, r3.z
