// ---- Created with 3Dmigoto v1.2.45 on Thu Jul 15 15:23:12 2021
...
// unknown dcl_: dcl_thread_group 8, 8, 1
  ...
  r0.x = mad(permuteStride, 26, (int)vThreadGroupID.x);
...
r0.y = samplerLinear[]..swiz;
  ...
  r9.w = cmp((uint)r0.x >= (uint)r8.w);
  r10.w = cmp((uint)r0.x < numRefProbes);
  r9.w = r9.w ? r10.w : 0;
  if (r9.w != 0) {
    r9.w = (int)r0.x * 14;
    if (r2.w != 0) {
    ...
    r13.yzw = -refProbeConstantsCB[r9.w].data[0].xyz + r5.xyz;
    ...
    r15.x = (int)r10.w * 6;
    r15.y = dot(refProbeAttenuationConstantsCB[r15.x].data[0].xyz, r13.yzw);
    r15.y = saturate(refProbeAttenuationConstantsCB[r15.x].data[0].w + r15.y);
    r15.z = dot(refProbeAttenuationConstantsCB[r15.x].data[1].xyz, r13.yzw);
    r15.z = saturate(refProbeAttenuationConstantsCB[r15.x].data[1].w + r15.z);
    r15.y = r15.y * r15.z;
    r15.z = dot(refProbeAttenuationConstantsCB[r15.x].data[2].xyz, r13.yzw);
    r15.z = saturate(refProbeAttenuationConstantsCB[r15.x].data[2].w + r15.z);
    r15.y = r15.y * r15.z;
    r15.z = dot(refProbeAttenuationConstantsCB[r15.x].data[3].xyz, r13.yzw);
    r15.z = saturate(refProbeAttenuationConstantsCB[r15.x].data[3].w + r15.z);
    r15.y = r15.y * r15.z;
    r15.z = dot(refProbeAttenuationConstantsCB[r15.x].data[4].xyz, r13.yzw);
    r15.z = saturate(refProbeAttenuationConstantsCB[r15.x].data[4].w + r15.z);
    r15.y = r15.y * r15.z;
    r15.z = dot(refProbeAttenuationConstantsCB[r15.x].data[5].xyz, r13.yzw);
    r15.x = saturate(refProbeAttenuationConstantsCB[r15.x].data[5].w + r15.z);
    r15.x = r15.y * r15.x;
    r15.w = 1 & (int)refProbeConstantsCB[r9.w].data[6].x;
    r15.yz = float2(0,1);
    r15.xy = r15.ww ? r15.xy : r15.zx;
    r16.x = 1;
    r15.z = refProbeConstantsCB[r9.w].data[6].x;
    r17.xy = r15.xy;
    r15.w = 1;
    while (true) {
      r16.z = cmp((int)r15.w >= (int)r12.w);
      if (r16.z != 0) break;
      r16.z = (int)r10.w + (int)r15.w;
      r16.z = (int)r16.z * 6;
      r16.w = dot(refProbeAttenuationConstantsCB[r16.z].data[0].xyz, r13.yzw);
      r16.w = saturate(refProbeAttenuationConstantsCB[r16.z].data[0].w + r16.w);
      r16.w = r17.x * r16.w;
      r17.z = dot(refProbeAttenuationConstantsCB[r16.z].data[1].xyz, r13.yzw);
      r17.z = saturate(refProbeAttenuationConstantsCB[r16.z].data[1].w + r17.z);
      r16.w = r17.z * r16.w;
      r17.z = dot(refProbeAttenuationConstantsCB[r16.z].data[2].xyz, r13.yzw);
      r17.z = saturate(refProbeAttenuationConstantsCB[r16.z].data[2].w + r17.z);
      r16.w = r17.z * r16.w;
      r17.z = dot(refProbeAttenuationConstantsCB[r16.z].data[3].xyz, r13.yzw);
      r17.z = saturate(refProbeAttenuationConstantsCB[r16.z].data[3].w + r17.z);
      r16.w = r17.z * r16.w;
      r17.z = dot(refProbeAttenuationConstantsCB[r16.z].data[4].xyz, r13.yzw);
      r17.z = saturate(refProbeAttenuationConstantsCB[r16.z].data[4].w + r17.z);
      r16.w = r17.z * r16.w;
      r17.z = dot(refProbeAttenuationConstantsCB[r16.z].data[5].xyz, r13.yzw);
      r16.z = saturate(refProbeAttenuationConstantsCB[r16.z].data[5].w + r17.z);
      r17.x = r16.w * r16.z;
      r17.z = (uint)r15.z >> 2;
      if (1 == 0) r17.w = 0; else if (1+2 < 32) {       r17.w = (uint)r15.z << (32-(1 + 2)); r17.w = (uint)r17.w >> (32-1);      } else r17.w = (uint)r15.z >> 2;
      r18.x = (int)r17.z & 2;
      r18.y = max(r17.y, r17.x);
      r16.z = -r16.w * r16.z + 1;
      r16.z = r17.y * r16.z;
      r16.y = r18.x ? r16.z : r18.y;
      r17.xy = r17.ww ? r17.xy : r16.xy;
      r15.w = (int)r15.w + 1;
      r15.z = r17.z;
    }
    r17.y = saturate(r17.y);
    r10.w = refProbeConstantsCB[r9.w].data[6].y * r17.y;
    r12.w = cmp(0 < r10.w);
    if (r12.w != 0) {
      if (r2.w != 0) {
      // Known bad code for instruction (needs manual fix):
      ...
      r12.w = refProbeConstantsCB[r9.w].data[7].y * r10.w;
      r15.x = refProbeConstantsCB[r9.w].data[7].w;
      r15.yz = refProbeConstantsCB[r9.w].data[8].xy;
      r15.w = dot(r14.xyz, r15.xyz);
      r15.x = dot(r13.yzw, r15.xyz);
      r15.x = -refProbeConstantsCB[r9.w].data[8].z + r15.x;
      r15.y = cmp(r15.x >= 0);
      ...
      r16.x = refProbeConstantsCB[r9.w].data[8].w;
      r16.yz = refProbeConstantsCB[r9.w].data[9].xy;
      r15.y = dot(r14.xyz, r16.xyz);
      r15.z = dot(r13.yzw, r16.xyz);
      ...
      r16.x = refProbeConstantsCB[r9.w].data[9].w;
      r16.yz = refProbeConstantsCB[r9.w].data[10].xy;
      r15.y = dot(r14.xyz, r16.xyz);
      r15.z = dot(r13.yzw, r16.xyz);
      ...
      r15.y = r15.z / r15.y;
      r15.x = min(r15.x, abs(r15.y));
      r16.x = refProbeConstantsCB[r9.w].data[10].w;
      r16.yz = refProbeConstantsCB[r9.w].data[11].xy;
      r15.y = dot(r14.xyz, r16.xyz);
      r15.z = dot(r13.yzw, r16.xyz);
      ...
      r15.y = r15.z / r15.y;
      r15.x = min(r15.x, abs(r15.y));
      r16.x = refProbeConstantsCB[r9.w].data[11].w;
      r16.yz = refProbeConstantsCB[r9.w].data[12].xy;
      r15.y = dot(r14.xyz, r16.xyz);
      r15.z = dot(r13.yzw, r16.xyz);
      ...
      r15.y = r15.z / r15.y;
      r15.x = min(r15.x, abs(r15.y));
      r16.x = refProbeConstantsCB[r9.w].data[12].w;
      r16.yz = refProbeConstantsCB[r9.w].data[13].xy;
      r15.y = dot(r14.xyz, r16.xyz);
      r15.z = dot(r13.yzw, r16.xyz);
      ...
      r15.y = r15.z / r15.y;
      r15.x = min(r15.x, abs(r15.y));
      r16.x = refProbeConstantsCB[r9.w].data[3].w + r13.y;
      r16.yz = refProbeConstantsCB[r9.w].data[4].xy + r13.zw;
      r15.yzw = r14.xyz * r15.xxx + r16.xyz;
      ...
      r16.x = refProbeConstantsCB[r9.w].data[0].w;
      r16.y = refProbeConstantsCB[r9.w].data[1].z;
      r16.z = refProbeConstantsCB[r9.w].data[2].y;
      r17.x = dot(r15.yzw, r16.xyz);
      r18.xy = refProbeConstantsCB[r9.w].data[1].xw;
      r18.z = refProbeConstantsCB[r9.w].data[2].z;
      r17.y = dot(r15.yzw, r18.xyz);
      r19.x = refProbeConstantsCB[r9.w].data[1].y;
      r19.yz = refProbeConstantsCB[r9.w].data[2].xw;
      r17.z = dot(r15.yzw, r19.xyz);
      ...
      r17.w = (uint)r15.y;
      r15.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r17.xyzw, r15.x).xyz;
      ...
      r13.yzw = saturate(r20.xyz * refProbeConstantsCB[r9.w].data[3].xyz + float3(0.5,0.5,0.5));
      r20.xy = refProbeConstantsCB[r9.w].data[4].zw * r13.yz;
      r20.z = refProbeConstantsCB[r9.w].data[5].x * r13.w;
      r13.yzw = refProbeConstantsCB[r9.w].data[5].yzw + r20.xyz;
  ...
  if (r8.w != 0) {
    ...
    r12.w = 0x0000ffff & (int)refProbeConstantsCB[r0.x].data[7].z;
    ...
    r16.w = (int)r12.w * 6;
    r17.x = dot(refProbeAttenuationConstantsCB[r16.w].data[0].xyz, r16.xyz);
    r17.x = saturate(refProbeAttenuationConstantsCB[r16.w].data[0].w + r17.x);
    r17.y = dot(refProbeAttenuationConstantsCB[r16.w].data[1].xyz, r16.xyz);
    r17.y = saturate(refProbeAttenuationConstantsCB[r16.w].data[1].w + r17.y);
    r17.x = r17.x * r17.y;
    r17.y = dot(refProbeAttenuationConstantsCB[r16.w].data[2].xyz, r16.xyz);
    r17.y = saturate(refProbeAttenuationConstantsCB[r16.w].data[2].w + r17.y);
    r17.x = r17.x * r17.y;
    r17.y = dot(refProbeAttenuationConstantsCB[r16.w].data[3].xyz, r16.xyz);
    r17.y = saturate(refProbeAttenuationConstantsCB[r16.w].data[3].w + r17.y);
    r17.x = r17.x * r17.y;
    r17.y = dot(refProbeAttenuationConstantsCB[r16.w].data[4].xyz, r16.xyz);
    r17.y = saturate(refProbeAttenuationConstantsCB[r16.w].data[4].w + r17.y);
    r17.x = r17.x * r17.y;
    r17.y = dot(refProbeAttenuationConstantsCB[r16.w].data[5].xyz, r16.xyz);
    r16.w = saturate(refProbeAttenuationConstantsCB[r16.w].data[5].w + r17.y);
    r17.x = r17.x * r16.w;
    r16.w = 1 & (int)refProbeConstantsCB[r0.x].data[6].x;
    r17.yz = float2(0,1);
    r17.xy = r16.ww ? r17.xy : r17.zx;
    r18.x = 1;
    r16.w = refProbeConstantsCB[r0.x].data[6].x;
    r19.xy = r17.xy;
    r17.z = 1;
    while (true) {
      r17.w = cmp((int)r17.z >= (int)r15.w);
      if (r17.w != 0) break;
      r17.w = (int)r12.w + (int)r17.z;
      r17.w = (int)r17.w * 6;
      r18.z = dot(refProbeAttenuationConstantsCB[r17.w].data[0].xyz, r16.xyz);
      r18.z = saturate(refProbeAttenuationConstantsCB[r17.w].data[0].w + r18.z);
      r18.z = r19.x * r18.z;
      r18.w = dot(refProbeAttenuationConstantsCB[r17.w].data[1].xyz, r16.xyz);
      r18.w = saturate(refProbeAttenuationConstantsCB[r17.w].data[1].w + r18.w);
      r18.z = r18.z * r18.w;
      r18.w = dot(refProbeAttenuationConstantsCB[r17.w].data[2].xyz, r16.xyz);
      r18.w = saturate(refProbeAttenuationConstantsCB[r17.w].data[2].w + r18.w);
      r18.z = r18.z * r18.w;
      r18.w = dot(refProbeAttenuationConstantsCB[r17.w].data[3].xyz, r16.xyz);
      r18.w = saturate(refProbeAttenuationConstantsCB[r17.w].data[3].w + r18.w);
      r18.z = r18.z * r18.w;
      r18.w = dot(refProbeAttenuationConstantsCB[r17.w].data[4].xyz, r16.xyz);
      r18.w = saturate(refProbeAttenuationConstantsCB[r17.w].data[4].w + r18.w);
      r18.z = r18.z * r18.w;
      r18.w = dot(refProbeAttenuationConstantsCB[r17.w].data[5].xyz, r16.xyz);
      ...
      r17.w = -r18.z * r17.w + 1;
      r17.w = r19.y * r17.w;
      r18.y = r19.w ? r17.w : r20.x;
      r19.xy = r19.zz ? r19.xy : r18.xy;
      r17.z = (int)r17.z + 1;
      r16.w = r18.w;
    }
    r12.w = saturate(r19.y + -r10.w);
    r15.w = refProbeConstantsCB[r0.x].data[6].y * r12.w;
    r16.w = cmp(0 < r15.w);
    if (r16.w != 0) {
      r16.w = (int)r8.w & 3;
      r17.x = (int)r16.w + -1;
      ...
      r17.x = r17.x ? r2.w : 0;
      if (r17.x != 0) {
        r17.xy = mad((int2)r16.ww, int2(20,20), int2(860,876));
      // Known bad code for instruction (needs manual fix):
      ...
      r8.w = (int)r9.w + 257;
      r12.w = r12.w * refProbeConstantsCB[r0.x].data[6].y + r10.w;
      ...
      r17.x = -refProbeConstantsCB[r0.x].data[8].z + r17.x;
      r17.y = cmp(r17.x >= 0);
      r17.x = max(abs(r17.x), r6.w);
      ...
      r17.y = cmp(r17.x >= 0);
      r6.w = max(abs(r17.x), r6.w);
      r6.w = r17.y ? r6.w : -r6.w;
      r17.x = max(1.00000001e-07, -r17.w);
      r6.w = r6.w / r17.x;
      r6.w = min(r16.w, abs(r6.w));
      r17.x = refProbeConstantsCB[r0.x].data[3].w + r16.x;
      r17.yz = refProbeConstantsCB[r0.x].data[4].xy + r16.yz;
      r17.xyz = r14.xyz * r6.www + r17.xyz;
      ...
      if (9 == 0) r6.w = 0; else if (9+16 < 32) {       r6.w = (uint)refProbeConstantsCB[r0.x].data[7].z << (32-(9 + 16)); r6.w = (uint)r6.w >> (32-9);      } else r6.w = (uint)refProbeConstantsCB[r0.x].data[7].z >> 16;
      r19.w = (uint)r6.w;
  ...
  r0.x = cmp(r10.w >= 1);
  bitmask.y = ((~(-1 << 8)) << 0) & 0xffffffff;  r3.y = (((uint)r8.w << 0) & bitmask.y) | ((uint)r9.w & ~bitmask.y);
  r0.x = r0.x ? r3.y : r8.w;
  r3.y = max(1, r12.w);
  r3.y = rcp(r3.y);
  ...
  if (r6.w != 0) {
    ...
    r7.w = dot(r17.xyz, float3(0.212599993,0.715200007,0.0722000003));
    r16.xyz = r13.yzw * r3.yyy + r17.xyz;
    r14.w = 0;
    r13.yzw = gReflectionProbeArray.SampleLevel(samplerLinear_s, r14.xyzw, r3.z).xyz;
    r3.y = sunConstants.globalProbeExposure * r6.w + -r7.w;
    r3.y = r2.y * r3.y + r7.w;
  ...
  r15.xyz = r15.xyz * r3.yyy;
  r18.xzw = r15.xyz * r18.xxx;
  r15.xyz = r15.xyz * r18.yyy;
  r2.y = sqrt(r2.z);
  r2.y = r2.y * 0.5 + 0.5;
  r2.y = r2.y * r2.y;
  r3.y = 0.5 * r2.y;
  ...
  switch (r3.z) {
    ...
    r6.w = cmp(0 < lightConstantsCB[r0.y].data[6].y);
    r19.xy = lightConstantsCB[r0.y].data[5].zw;
    r19.z = lightConstantsCB[r0.y].data[6].x;
    r20.xyz = -r19.xyz * float3(0.5,0.5,0.5) + lightConstantsCB[r0.y].data[0].xyz;
    r21.xyz = r20.xyz + -r5.xyz;
    r7.w = dot(r19.xyz, r21.xyz);
    r8.w = saturate(-r7.w / lightConstantsCB[r0.y].data[6].y);
    r22.xyz = r8.www * r19.xyz + r20.xyz;
    r22.xyz = r6.www ? r22.xyz : lightConstantsCB[r0.y].data[0].xyz;
    ...
    if (r12.w != 0) {
      ...
      r9.w = r14.w / r9.w;
      r9.w = min(1, r9.w);
      r22.xy = saturate(r12.ww * lightConstantsCB[r0.y].data[2].xz + lightConstantsCB[r0.y].data[2].yw);
      ...
      if (r12.w != 0) {
        ...
        if (r12.w != 0) {
          ...
          r22.yzw = -lightConstantsCB[r0.y].data[4].yzw + r22.yzw;
          ...
          while (true) {
            ...
            r26.yz = lightConstantsCB[r0.y].data[3].yy * r23.yz;
            r26.x = r26.y * r23.x;
            r26.w = r26.y * r22.x;
        ...
        r12.w = cmp(0 < r9.w);
        if (r12.w != 0) {
          r12.w = lightConstantsCB[r0.y].data[1].z * r1.w;
          r12.w = 0.25 * r12.w;
          ...
          r14.xyz = r7.www * r19.xyz + r20.xyz;
          r14.xyz = r6.www ? r14.xyz : lightConstantsCB[r0.y].data[0].xyz;
          r14.xyz = r14.xyz + -r5.xyz;
          r6.w = dot(r14.xyz, r14.xyz);
          r6.w = rsqrt(r6.w);
          r19.xyz = r14.xyz * r6.www;
          ...
          if (r8.w != 0) {
            ...
            if (4 == 0) r7.w = 0; else if (4+20 < 32) {             r7.w = (uint)lightConstantsCB[r0.y].data[1].w << (32-(4 + 20)); r7.w = (uint)r7.w >> (32-4);            } else r7.w = (uint)lightConstantsCB[r0.y].data[1].w >> 20;
            r8.w = cmp(0 < (uint)r7.w);
            r14.w = ~(int)r1.z;
            r8.w = r8.w ? r14.w : 0;
            if (r8.w != 0) {
          ...
          r8.w = cmp(0 < r10.w);
          r21.xyz = r16.xyz * r4.zzz + r21.xyz;
          r10.w = saturate(dot(r11.xyz, r19.xyz));
          r14.xyz = r14.xyz * r6.www + r12.xyz;
          r6.w = dot(r14.xyz, r14.xyz);
          r6.w = rsqrt(r6.w);
          r14.xyz = r14.xyz * r6.www;
          r6.w = dot(r14.xyz, r12.xyz);
          r11.w = dot(r11.xyz, r14.xyz);
          r14.x = abs(r11.w) * r1.w + -abs(r11.w);
          r11.w = abs(r11.w) * r14.x + 1;
          r14.x = r10.w * r2.y + r3.y;
          r11.w = r11.w * r11.w;
          r11.w = r11.w * r14.x;
          r11.w = rcp(r11.w);
          r10.w = r10.w * r12.w;
          r10.w = r11.w * r10.w;
          r10.w = r10.w * r9.w;
          r14.xyz = r10.www * r20.xyz + r15.xyz;
          r6.w = saturate(1 + -r6.w);
          r11.w = r6.w * r6.w;
          r11.w = r11.w * r11.w;
          r6.w = r11.w * r6.w;
          r6.w = r10.w * r6.w;
          r19.xyz = r6.www * r20.xyz + r18.xzw;
          r20.xyz = r7.www * r20.xyz + r17.xyz;
          r20.xyz = r3.www ? r20.xyz : 0;
          r13.yzw = r8.www ? r21.xyz : r13.yzw;
          r17.xyz = r8.www ? r17.xyz : r20.xyz;
          r18.xzw = r8.www ? r19.xyz : r18.xzw;
    ...
    if (r10.w != 0) {
      ...
      if (r11.w != 0) {
        ...
        r21.xyz = lightConstantsCB[r0.y].data[0].xyz + -r5.xyz;
        ...
        if (r5.w != 0) {
          r22.xy = saturate(abs(r21.xy) * lightConstantsCB[r0.y].data[12].xy + lightConstantsCB[r0.y].data[12].zw);
          r22.zw = r22.xy * r22.xy;
          r22.xy = r22.xy * float2(-2,-2) + float2(3,3);
          r22.xy = r22.zw * r22.xy;
          r5.w = r22.x * r22.y;
          ...
          r22.xy = log2(r22.xy);
          r22.xy = lightConstantsCB[r0.y].data[12].ww * r22.xy;
          r22.xy = exp2(r22.xy);
          r10.w = lightConstantsCB[r0.y].data[12].x * r22.x;
          r14.w = lightConstantsCB[r0.y].data[12].y * r22.y + -1;
          r10.w = lightConstantsCB[r0.y].data[12].y * r22.y + -r10.w;
      ...
      if (r5.w != 0) {
        ...
        if (r5.w != 0) {
          ...
          r10.w = dot(r19.xyzw, r21.xyzw);
          r12.w = cmp(r10.w >= r5.w);
          if (r12.w != 0) {
            r19.xyz = lightConstantsCB[r0.y].data[4].yzw;
            r19.w = lightConstantsCB[r0.y].data[5].x;
            r19.x = dot(r19.xyzw, r21.xyzw);
            r22.xyz = lightConstantsCB[r0.y].data[5].yzw;
            r22.w = lightConstantsCB[r0.y].data[6].x;
            r19.y = dot(r22.xyzw, r21.xyzw);
            r19.xy = r19.xy / r10.ww;
            r19.xy = saturate(r19.xy * float2(0.5,-0.5) + float2(0.5,0.5));
            r21.x = r19.x * lightConstantsCB[r0.y].data[8].y + lightConstantsCB[r0.y].data[8].z;
            r21.y = r19.y * lightConstantsCB[r0.y].data[8].w + lightConstantsCB[r0.y].data[9].x;
            r5.w = r5.w / r10.w;
            ...
            if (enableDitheredShadow != 0) {
              ...
              while (true) {
                ...
                if (r15.w != 0) break;
                r23.x = dot(icb[r14.w+0].yx, r19.xy);
                r23.y = dot(icb[r14.w+0].yx, r19.yz);
                r22.xy = r23.xy * lightConstantsCB[r0.y].data[3].yy + r21.xy;
        ...
        if (r10.w != 0) {
          ...
          if (r12.w != 0) {
            ...
            r14.w = r3.w ? r14.w : 0;
            r12.w = r14.w ? -r12.w : r12.w;
            r19.xyz = r11.xyz * r12.www + r5.xyz;
            r21.xyz = lightConstantsCB[r11.w].data[6].yzw;
            r21.w = lightConstantsCB[r11.w].data[7].x;
            r19.w = 1;
            r12.w = dot(r21.xyzw, r19.xyzw);
            r21.xyz = lightConstantsCB[r11.w].data[7].yzw;
            r21.w = lightConstantsCB[r11.w].data[8].x;
            r14.w = dot(r21.xyzw, r19.xyzw);
            r15.w = cmp(r14.w < r12.w);
            if (r15.w == 0) {
              r21.xyz = lightConstantsCB[r11.w].data[4].yzw;
              r21.w = lightConstantsCB[r11.w].data[5].x;
              r21.x = dot(r21.xyzw, r19.xyzw);
              r22.xyz = lightConstantsCB[r11.w].data[5].yzw;
              r22.w = lightConstantsCB[r11.w].data[6].x;
              r21.y = dot(r22.xyzw, r19.xyzw);
              r19.xy = r21.xy / r14.ww;
              r19.xy = r19.xy * float2(0.5,-0.5) + float2(0.5,0.5);
              r21.x = lightConstantsCB[r11.w].data[9].w + r19.x;
              r21.y = lightConstantsCB[r11.w].data[10].x + r19.y;
              r19.xy = lightConstantsCB[r11.w].data[9].yz * r21.xy;
              r19.zw = lightConstantsCB[r11.w].data[3].yy / lightConstantsCB[r11.w].data[8].yw;
              r21.xy = float2(1,1) + -r19.zw;
              r21.xy = cmp(r19.xy >= r21.xy);
              r19.zw = cmp(r19.zw >= r19.xy);
              r19.zw = (int2)r19.zw | (int2)r21.xy;
              r16.w = (int)r19.w | (int)r19.z;
              if (r16.w == 0) {
                r19.xy = saturate(r19.xy);
                r21.x = r19.x * lightConstantsCB[r11.w].data[8].y + lightConstantsCB[r11.w].data[8].z;
                r21.y = r19.y * lightConstantsCB[r11.w].data[8].w + lightConstantsCB[r11.w].data[9].x;
            ...
            if (r14.w == 0) {
              ...
              if (enableDitheredShadow != 0) {
                ...
                while (true) {
                  r17.w = cmp((int)r16.w >= 8);
                  if (r17.w != 0) break;
                  r23.x = dot(icb[r16.w+0].yx, r19.xy);
                  r23.y = dot(icb[r16.w+0].yx, r19.yz);
            ...
            if (r1.z != 0) {
              ...
              r1.z = abs(r7.w) * -0.200000003 + 0.400000006;
              r11.w = cmp(r7.w < 0);
              r11.w = r3.w ? r11.w : 0;
              ...
              if (r12.w == 0) {
                ...
                r22.w = lightConstantsCB[r0.y].data[6].x;
                r21.y = dot(r22.xyzw, r19.xyzw);
                r19.xy = r21.xy / r11.ww;
                r19.xy = r19.xy * float2(0.5,-0.5) + float2(0.5,0.5);
                r21.x = lightConstantsCB[r0.y].data[9].w + r19.x;
                r21.y = lightConstantsCB[r0.y].data[10].x + r19.y;
                r19.xy = lightConstantsCB[r0.y].data[9].yz * r21.xy;
                ...
                if (r14.w == 0) {
                  ...
                  r21.x = r19.x * lightConstantsCB[r0.y].data[8].y + lightConstantsCB[r0.y].data[8].z;
                  r21.y = r19.y * lightConstantsCB[r0.y].data[8].w + lightConstantsCB[r0.y].data[9].x;
                  r15.w = lightConstantsCB[r0.y].data[10].z * r11.w;
              ...
              if (r11.w == 0) {
                ...
                if (enableDitheredShadow != 0) {
                  ...
                  while (true) {
                    ...
                    if (r13.x != 0) break;
                    r23.x = dot(icb[r12.w+0].yx, r19.xy);
                    r23.y = dot(icb[r12.w+0].yx, r19.yz);
                    r22.xy = r23.xy * lightConstantsCB[r0.y].data[3].yy + r21.xy;
                  ...
                  r21.z = (uint)r11.w;
                  r3.x = gSpotShadowmapArray.SampleCmpLevelZero(ShadowSamplerComparisonState_s, r21.xyz, r1.z).x;
                }
                r0.y = r3.x * r3.x;
                r0.y = r0.y * r3.x;
              } else {
          ...
          r0.y = r2.z * r0.y + r9.w;
          r0.y = r0.y * r5.w;
          r19.xyz = r0.yyy * r20.xyz;
          r1.z = cmp(0 < r7.w);
          r16.xyz = r16.xyz * r4.zzz + r19.xyz;
          r14.xyz = r14.xyz * r6.www + r12.xyz;
          ...
          r1.w = r5.w * r1.w;
          r1.w = 0.25 * r1.w;
          r11.xyz = r1.www * r20.xyz + r15.xyz;
          r2.x = saturate(1 + -r2.x);
          r2.y = r2.x * r2.x;
          r2.y = r2.y * r2.y;
          r2.x = r2.x * r2.y;
          r1.w = r2.x * r1.w;
          r2.xyz = r1.www * r20.xyz + r18.xzw;
          r12.xyz = r0.yyy * r20.xyz + r17.xyz;
          r12.xyz = r3.www ? r12.xyz : 0;
          r13.yzw = r1.zzz ? r16.xyz : r13.yzw;
          r17.xyz = r1.zzz ? r17.xyz : r12.xyz;
          r18.xzw = r1.zzz ? r2.xyz : r18.xzw;
          r15.xyz = r1.zzz ? r11.xyz : r15.xyz;
          if (r2.w != 0) {
          // Known bad code for instruction (needs manual fix):
  ...
  r7.xyz = r15.xyz * float3(0.0399999991,0.0399999991,0.0399999991) + r7.xyz;
  r2.xyz = r7.xyz + r2.xyz;
  r7.xyz = float3(1,1,1) + -r4.xyz;
  r7.xyz = r18.xzw * r7.xyz;
  r4.xyz = r15.xyz * r4.xyz + r7.xyz;
  r4.xyz = r13.yzw * r6.xyz + r4.xyz;
