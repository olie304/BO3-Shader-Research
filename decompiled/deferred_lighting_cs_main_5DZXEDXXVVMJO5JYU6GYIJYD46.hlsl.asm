...
uge r0.y, r17.x, r15.w
ult r17.z, r17.x, cb2[0].y
and r0.y, r0.y, r17.z
if_nz r0.y
  imul null, r0.y, r17.x, l(14)
  add r18.xyz, r10.xyzx, -cb10[r0.y + 0].xyzx
  and r17.z, l(0x0000ffff), cb10[r0.y + 7].z
  ...
  endloop 
  mov_sat r21.y, r21.y
  mul r17.z, r21.y, cb10[r0.y + 6].y
  lt r17.w, l(0.000000), r17.z
  if_nz r17.w
    mul r17.w, r17.z, cb10[r0.y + 7].y
    ...
    mad r19.xyz, r16.xyzx, r18.wwww, r19.xyzx
    ...
    ubfe r19.x, l(9), l(16), cb10[r0.y + 7].z
    utof r21.w, r19.x
    sample_l_indexable(texturecubearray)(float,float,float,float) r19.xyz, r21.xyzw, t8.xyzw, s2, r18.w
    ...
    mul r18.w, r0.y, r15.z
    mul r19.xyz, r17.wwww, r19.xyzx
    dp3 r17.w, r19.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
    mad r0.y, r15.z, r0.y, r17.w
    div r0.y, r18.w, r0.y
...
if_nz r0.y
  ...
  if_nz r0.y
    ...
    if_nz r17.w
      ...
      movc r15.y, r19.w, r15.y, -r15.y
      max r17.w, -r17.w, l(0.00000010)
      div r15.y, r15.y, r17.w
      min r15.y, |r15.y|, r17.x
      add r21.x, r20.x, cb10[r0.y + 3].w
      add r21.yz, r20.yyzy, cb10[r0.y + 4].xxyx
      mad r21.xyz, r16.xyzx, r15.yyyy, r21.xyzx
      dp3 r17.x, r21.xyzx, r21.xyzx
      sqrt r17.x, r17.x
      div r15.y, r15.y, r17.x
      add r15.y, r15.y, r15.y
      sqrt r15.y, r15.y
      mad r13.z, r13.z, l(5.000000), r15.y
      ...
      utof r23.w, r15.y
      sample_l_indexable(texturecubearray)(float,float,float,float) r21.xyz, r23.xyzw, t8.xyzw, s2, r13.z
      ...
      mul r13.z, r0.y, r15.z
      mul r20.xyz, r15.wwww, r21.xyzx
      dp3 r15.y, r20.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
...
max r0.y, r17.z, l(1.000000)
rcp r0.y, r0.y
mov_sat r17.z, r17.z
mul r15.yzw, r0.yyyy, r18.xxyz
mul r19.xyz, r0.yyyy, r19.xyzx
lt r13.z, r17.z, l(0.990000)
if_nz r13.z
  add r13.z, -r17.z, l(1.000000)
  mul r17.x, r13.z, cb2[19].x
  ...
  mad r15.yzw, r18.xxyz, r0.yyyy, r17.xxzw
  mov r16.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r17.xzw, r16.xyzw, t8.xwyz, s2, r14.w
  mad r0.y, cb2[19].x, r13.z, -r11.w
  mad r0.y, r2.y, r0.y, r11.w
  mad r19.xyz, r17.xzwx, r0.yyyy, r19.xyzx
endif 
add r0.y, -r5.w, l(1.000000)
mad r9.xyw, r19.xyxz, r0.yyyy, r9.xyxw
