...
r4.w = shaderConstantSetBuffer[]..swiz;
  ...
  if (r2.w != 0) {
    ...
    r8.w = shaderConstantSetBuffer[]..swiz;
      ...
      r5.yz = v4.xx * r3.zy;
      r3.y = cmp(v4.y != 0.000000);
      if (r3.y != 0) {
        r3.y = (int)r2.w + (int)v5.y;
      // Known bad code for instruction (needs manual fix):
      ...
      r8.w = shaderConstantSetBuffer[]..swiz;
        ...
        r3.y = dot(r8.xyz, r2.xyz);
        r5.z = r3.y * v4.y + r5.z;
        r3.y = cmp(v4.z != 0.000000);
        if (r3.y != 0) {
          r3.y = (int)r2.w + (int)v5.z;
        // Known bad code for instruction (needs manual fix):
                ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r8.xyzw, r3.y, l(0), t5.xyzw
        r8.x = shaderConstantSetBuffer[]..swiz;
        r8.y = shaderConstantSetBuffer[]..swiz;
        ...
        r8.w = shaderConstantSetBuffer[]..swiz;
          ...
          r3.y = dot(r8.xyz, r2.xyz);
          r5.z = r3.y * v4.z + r5.z;
          r3.y = cmp(v4.w != 0.000000);
          if (r3.y != 0) {
            r2.w = (int)r2.w + (int)v5.w;
          // Known bad code for instruction (needs manual fix):
    ...
    r6.xyz = v4.xxx * r3.yzw;
    r3.yzw = v4.xxx * r7.xyz;
    r4.xyw = v4.xxx * r10.xyz;
    ...
    if (r2.w != 0) {
      ...
      r6.xyz = r8.xyz * v4.yyy + r6.xyz;
      r3.yzw = r7.xyz * v4.yyy + r3.yzw;
      r4.xyw = r9.xyz * v4.yyy + r4.xyw;
      ...
      if (r2.w != 0) {
        ...
        r10.xyz = r10.xyz + r11.xyz;
        r8.xyz = r10.xyz + r8.xyz;
        r6.xyz = r8.xyz * v4.zzz + r6.xyz;
        r3.yzw = r7.xyz * v4.zzz + r3.yzw;
        r4.xyw = r9.xyz * v4.zzz + r4.xyw;
        ...
        if (r2.w != 0) {
          ...
          r6.xyz = r1.yzw * v4.www + r6.xyz;
          r3.yzw = r7.xyz * v4.www + r3.yzw;
          r4.xyw = r10.xyz * v4.www + r4.xyw;
        }
      }
    }
