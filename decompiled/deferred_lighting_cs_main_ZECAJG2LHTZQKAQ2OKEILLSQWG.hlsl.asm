...
loop 
  ieq r16.z, r0.y, l(2)
  breakc_nz r16.z
  movc r16.z, r0.y, r0.x, r16.x
  uge r16.w, r16.z, r15.w
  ult r18.w, r16.z, cb2[0].y
  ...
  if_nz r16.w
    ...
    if_nz r3.z
      ...
      add r17.yzw, cb1[24].xxyz, cb10[r16.z + 0].xxyz
      store_structured u2.xyzw, cb2[52].x, r16.w, r17.xyzw
    endif 
    iadd r25.w, r24.w, l(1)
    add r17.yzw, r5.xxyz, -cb10[r16.z + 0].xxyz
    ...
    movc r26.xy, r19.wwww, r18.xyxx, r18.zxzz
    ...
    loop 
      ...
      dp3 r26.z, cb11[r21.w + 1].xyzx, r17.yzwy
      add_sat r26.z, r26.z, cb11[r21.w + 1].w
      mul r22.w, r22.w, r26.z
      dp3 r26.z, cb11[r21.w + 2].xyzx, r17.yzwy
      add_sat r26.z, r26.z, cb11[r21.w + 2].w
      mul r22.w, r22.w, r26.z
      dp3 r26.z, cb11[r21.w + 3].xyzx, r17.yzwy
      add_sat r26.z, r26.z, cb11[r21.w + 3].w
      mul r22.w, r22.w, r26.z
      dp3 r26.z, cb11[r21.w + 4].xyzx, r17.yzwy
      add_sat r26.z, r26.z, cb11[r21.w + 4].w
      mul r22.w, r22.w, r26.z
      dp3 r26.z, cb11[r21.w + 5].xyzx, r17.yzwy
      add_sat r21.w, r26.z, cb11[r21.w + 5].w
      mul r27.x, r21.w, r22.w
      ...
      movc r20.y, r27.z, r21.w, r27.w
      movc r27.xy, r26.wwww, r27.xyxx, r20.xyxx
      iadd r19.w, r19.w, l(1)
      mov r18.x, r26.z
    endloop 
    mov_sat r27.y, r27.y
    mul r16.w, r27.y, cb10[r16.z + 6].y
    ...
    if_nz r18.x
      ...
      if_nz r18.w
        ...
        store_structured u2.x, cb2[52].x, r18.w, r16.w
      endif 
      iadd r24.w, r24.w, l(257)
      mad r24.z, r27.y, cb10[r16.z + 6].y, r24.z
      mul r16.w, r16.w, cb10[r16.z + 7].y
      mov r26.x, cb10[r16.z + 7].w
      mov r26.yz, cb10[r16.z + 8].xxyx
      dp3 r18.x, r14.xyzx, r26.xyzx
      dp3 r18.w, r17.yzwy, r26.xyzx
      ...
      mov r26.x, cb10[r16.z + 8].w
      mov r26.yz, cb10[r16.z + 9].xxyx
      ...
      mov r26.x, cb10[r16.z + 9].w
      mov r26.yz, cb10[r16.z + 10].xxyx
      dp3 r18.w, r14.xyzx, r26.xyzx
      dp3 r19.w, r17.yzwy, r26.xyzx
      ...
      div r18.w, r19.w, r18.w
      min r18.x, |r18.w|, r18.x
      mov r26.x, cb10[r16.z + 10].w
      mov r26.yz, cb10[r16.z + 11].xxyx
      dp3 r18.w, r14.xyzx, r26.xyzx
      dp3 r19.w, r17.yzwy, r26.xyzx
      ...
      div r18.w, r19.w, r18.w
      min r18.x, |r18.w|, r18.x
      mov r26.x, cb10[r16.z + 11].w
      mov r26.yz, cb10[r16.z + 12].xxyx
      dp3 r18.w, r14.xyzx, r26.xyzx
      dp3 r19.w, r17.yzwy, r26.xyzx
      ...
      div r18.w, r19.w, r18.w
      min r18.x, |r18.w|, r18.x
      mov r26.x, cb10[r16.z + 12].w
      mov r26.yz, cb10[r16.z + 13].xxyx
      dp3 r18.w, r14.xyzx, r26.xyzx
      dp3 r19.w, r17.yzwy, r26.xyzx
      ...
      div r18.w, r19.w, r18.w
      min r18.x, |r18.w|, r18.x
      add r26.x, r17.y, cb10[r16.z + 3].w
      add r26.yz, r17.zzwz, cb10[r16.z + 4].xxyx
      mad r26.xyz, r14.xyzx, r18.xxxx, r26.xyzx
      dp3 r18.w, r26.xyzx, r26.xyzx
      sqrt r18.w, r18.w
      div r18.x, r18.x, r18.w
      add r18.x, r18.x, r18.x
      sqrt r18.x, r18.x
      mad r18.x, r10.w, l(5.000000), r18.x
      add r18.x, r18.x, l(-0.844800)
      mov r28.x, cb10[r16.z + 0].w
      mov r28.y, cb10[r16.z + 1].z
      mov r28.z, cb10[r16.z + 2].y
      dp3 r29.x, r26.xyzx, r28.xyzx
      mov r30.xy, cb10[r16.z + 1].xwxx
      mov r30.z, cb10[r16.z + 2].z
      dp3 r29.y, r26.xyzx, r30.xyzx
      mov r31.x, cb10[r16.z + 1].y
      mov r31.yz, cb10[r16.z + 2].xxwx
      dp3 r29.z, r26.xyzx, r31.xyzx
      ubfe r18.w, l(9), l(16), cb10[r16.z + 7].z
      utof r29.w, r18.w
      sample_l_indexable(texturecubearray)(float,float,float,float) r26.xyz, r29.xyzw, t8.xyzw, s2, r18.x
      and r27.xzw, r26.xxyz, l(0x7fffffff, 0, 0x7fffffff, 0x7fffffff)
      ieq r27.xzw, r27.xxzw, l(0x7f800000, 0, 0x7f800000, 0x7f800000)
      or r18.x, r27.z, r27.x
      or r18.x, r27.w, r18.x
      movc r26.xyz, r18.xxxx, l(1.000000,1.000000,0,0), r26.xyzx
      dp3 r32.x, r17.yzwy, r28.xyzx
      dp3 r32.y, r17.yzwy, r30.xyzx
      dp3 r32.z, r17.yzwy, r31.xyzx
      mad_sat r17.yzw, r32.xxyz, cb10[r16.z + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
      mul r32.xy, r17.yzyy, cb10[r16.z + 4].zwzz
      mul r32.z, r17.w, cb10[r16.z + 5].x
      add r17.yzw, r32.xxyz, cb10[r16.z + 5].yyzw
      ...
      movc r27.xzw, r16.zzzz, l(1.000000,0,1.000000,0), r27.xxzw
      ...
      mul r17.y, r15.z, r16.z
      mul r26.xyz, r16.wwww, r26.xyzx
      dp3 r16.w, r26.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r16.z, r15.z, r16.z, r16.w
      div r16.z, r17.y, r16.z
      mov r28.x, r23.w
      mov r28.yz, r24.xxyx
      mad r17.yzw, r26.xxyz, r16.zzzz, r28.xxyz
      mov r23.w, r17.y
      mov r24.xy, r17.zwzz
    else 
...
loop 
  ...
  if_nz r19.w
    ...
    movc r27.xy, r22.wwww, r18.xyxx, r18.zxzz
    ...
    loop 
      ...
      dp3 r27.z, cb11[r25.w + 1].xyzx, r17.yzwy
      add_sat r27.z, r27.z, cb11[r25.w + 1].w
      mul r26.w, r26.w, r27.z
      dp3 r27.z, cb11[r25.w + 2].xyzx, r17.yzwy
      add_sat r27.z, r27.z, cb11[r25.w + 2].w
      mul r26.w, r26.w, r27.z
      dp3 r27.z, cb11[r25.w + 3].xyzx, r17.yzwy
      add_sat r27.z, r27.z, cb11[r25.w + 3].w
      mul r26.w, r26.w, r27.z
      dp3 r27.z, cb11[r25.w + 4].xyzx, r17.yzwy
      add_sat r27.z, r27.z, cb11[r25.w + 4].w
      mul r26.w, r26.w, r27.z
      dp3 r27.z, cb11[r25.w + 5].xyzx, r17.yzwy
      add_sat r25.w, r27.z, cb11[r25.w + 5].w
      mul r28.x, r25.w, r26.w
      ushr r27.z, r18.x, l(2)
      ubfe r27.w, l(1), l(2), r18.x
      and r28.z, r27.z, l(2)
      max r28.w, r28.x, r28.y
      mad r25.w, -r26.w, r25.w, l(1.000000)
      mul r25.w, r25.w, r28.y
      movc r20.w, r28.z, r25.w, r28.w
      movc r28.xy, r27.wwww, r28.xyxx, r20.zwzz
    ...
    if_nz r20.w
      and r20.w, r20.y, l(31)
      iadd r21.w, r20.w, l(-1)
      ult r21.w, r21.w, l(32)
      and r21.w, r3.z, r21.w
      if_nz r21.w
        imad r27.xy, r20.wwww, l(20, 20, 0, 0), l(860, 876, 0, 0)
        ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r20.w, cb2[52].x, r27.x, u2.xxxx
        or r20.w, r20.w, l(32)
        store_structured u2.x, cb2[52].x, r27.x, r20.w
        store_structured u2.x, cb2[52].x, r27.y, r19.w
      endif 
      iadd r16.w, r16.w, l(257)
      mad r16.z, r18.x, cb10[r18.w + 6].y, r16.z
      mul r18.x, r19.w, cb10[r18.w + 7].y
      mov r27.x, cb10[r18.w + 7].w
      mov r27.yz, cb10[r18.w + 8].xxyx
      dp3 r19.w, r14.xyzx, r27.xyzx
      ...
      div r20.w, r21.w, r20.w
      min r19.w, r19.w, |r20.w|
      add r27.x, r17.y, cb10[r18.w + 3].w
      add r27.yz, r17.zzwz, cb10[r18.w + 4].xxyx
      mad r27.xyz, r14.xyzx, r19.wwww, r27.xyzx
      dp3 r20.w, r27.xyzx, r27.xyzx
      sqrt r20.w, r20.w
      div r19.w, r19.w, r20.w
      add r19.w, r19.w, r19.w
      sqrt r19.w, r19.w
      mad r19.w, r10.w, l(5.000000), r19.w
      ...
      utof r30.w, r20.w
      sample_l_indexable(texturecubearray)(float,float,float,float) r27.xyz, r30.xyzw, t8.xyzw, s2, r19.w
      and r28.xzw, r27.xxyz, l(0x7fffffff, 0, 0x7fffffff, 0x7fffffff)
      ieq r28.xzw, r28.xxzw, l(0x7f800000, 0, 0x7f800000, 0x7f800000)
      or r19.w, r28.z, r28.x
      or r19.w, r28.w, r19.w
      movc r27.xyz, r19.wwww, l(1.000000,1.000000,0,0), r27.xyzx
      dp3 r33.x, r17.yzwy, r29.xyzx
      dp3 r33.y, r17.yzwy, r31.xyzx
      dp3 r33.z, r17.yzwy, r32.xyzx
      mad_sat r17.yzw, r33.xxyz, cb10[r18.w + 3].xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)
      mul r33.xy, r17.yzyy, cb10[r18.w + 4].zwzz
      mul r33.z, r17.w, cb10[r18.w + 5].x
      add r17.yzw, r33.xxyz, cb10[r18.w + 5].yyzw
      ...
      mad r25.xyz, r17.yzwy, r28.xzwx, r25.xyzx
      mul r17.y, r15.z, r18.w
      mul r27.xyz, r18.xxxx, r27.xyzx
      dp3 r17.z, r27.xyzx, l(0.212600, 0.715200, 0.072200, 0.000000)
      mad r17.z, r15.z, r18.w, r17.z
      div r17.y, r17.y, r17.z
      mad r26.xyz, r27.xyzx, r17.yyyy, r26.xyzx
    else 
      mov r20.x, r16.z
      mov r16.zw, r20.xxxy
    endif 
...
bfi r0.y, l(8), l(0), r16.w, r24.w
movc r0.x, r0.x, r0.y, r16.w
max r0.y, r16.z, l(1.000000)
rcp r0.y, r0.y
mov_sat r16.z, r16.z
mul r15.yzw, r0.yyyy, r25.xxyz
mul r17.xyz, r0.yyyy, r26.xyzx
lt r10.w, r16.z, l(0.990000)
if_nz r10.w
  iadd r0.x, r0.x, l(256)
  add r10.w, -r16.z, l(1.000000)
  mul r16.x, r10.w, cb2[19].x
  ...
  mul r21.xyz, r16.zzzz, r21.xyzx
  mad r20.xyz, r20.xyzx, r16.xxxx, r21.xyzx
  ...
  mad r16.xzw, r18.xxyz, r16.wwww, r20.xxyz
  mov r11.w, l(0)
  ...
  dp3 r11.w, r16.xzwx, l(0.212600, 0.715200, 0.072200, 0.000000)
  mad r15.yzw, r25.xxyz, r0.yyyy, r16.xxzw
  mov r14.w, l(0)
  sample_l_indexable(texturecubearray)(float,float,float,float) r16.xzw, r14.xyzw, t8.xwyz, s2, r15.x
  mad r0.y, cb2[19].x, r10.w, -r11.w
  mad r0.y, r2.y, r0.y, r11.w
  mad r17.xyz, r16.xzwx, r0.yyyy, r17.xyzx
endif 
...
mad r16.xz, r2.xxyx, l(0.984375, 0.000000, 0.984375, 0.000000), l(0.00781250, 0.000000, 0.00781250, 0.000000)
sample_l_indexable(texture2d)(float,float,float,float) r16.xz, r16.xzxx, t5.xzyw, s2, l(0.000000)
mul r13.yzw, r0.yyyy, r13.yyzw
mul r19.xyz, r16.xxxx, r13.yzwy
mul r20.xyz, r16.zzzz, r13.yzwy
sqrt r0.y, r3.y
...
if_nz r2.y
  ...
  if_nz r2.y
    ...
    if_nz cb2[23].x
      ...
      dp4 r6.w, cb2[24].xyzw, r21.xyzw
      dp4 r10.w, cb2[25].xyzw, r21.xyzw
      frc r21.x, r6.w
      frc r21.y, r10.w
    ...
    if_nz r10.w
      ...
      mad r21.xyz, r11.xyzx, r10.wwww, r5.xyzx
      mov r22.xyz, cb9[r6.w + 4].yzwy
      mov r22.w, cb9[r6.w + 5].x
      mov r21.w, l(1.000000)
      dp4 r22.x, r22.xyzw, r21.xyzw
      mov r23.xyz, cb9[r6.w + 5].yzwy
      mov r23.w, cb9[r6.w + 6].x
      dp4 r22.y, r23.xyzw, r21.xyzw
      mad r16.xz, r22.xxyx, l(0.500000, 0.000000, -0.500000, 0.000000), l(0.500000, 0.000000, 0.500000, 0.000000)
      add r22.x, r16.x, cb9[r6.w + 9].w
      add r22.y, r16.z, cb9[r6.w + 10].x
      mul r16.xz, r22.xxyx, cb9[r6.w + 9].yyzy
      div r22.xy, cb9[r6.w + 3].yyyy, cb9[r6.w + 8].ywyy
      add r22.zw, -r22.xxxy, l(0.000000, 0.000000, 1.000000, 1.000000)
      ge r22.zw, r16.xxxz, r22.zzzw
      ge r22.xy, r22.xyxx, r16.xzxx
      ...
      if_z r10.w
        ...
        mov_sat r16.xz, r16.xxzx
        mad r21.x, r16.x, cb9[r6.w + 8].y, cb9[r6.w + 8].z
        mad r21.y, r16.z, cb9[r6.w + 8].w, cb9[r6.w + 9].x
        add r10.w, r10.w, cb9[r6.w + 10].y
        div r10.w, r10.w, cb9[r6.w + 10].z
        ...
        if_nz cb2[58].y
          ...
          loop 
            ige r16.x, r15.x, l(8)
            breakc_nz r16.x
            dp2 r24.x, icb[r15.x + 0].yxyy, r22.xyxx
            dp2 r24.y, icb[r15.x + 0].yxyy, r22.yzyy
            mad r23.xy, r24.xyxx, cb9[r6.w + 3].yyyy, r21.xyxx
            sample_c_lz_indexable(texture2darray)(float,float,float,float) r16.x, r23.xyzx, t9.xxxx, s13, r10.w
    ...
    add r6.w, -r9.w, r6.w
    mad r6.w, r3.y, r6.w, r9.w
    mul r6.w, r12.w, r6.w
    mul r16.xzw, r13.yyzw, r6.wwww
    lt r7.w, l(0.000000), r7.w
    mad r15.xyz, r15.yzwy, r4.zzzz, r16.xzwx
    mad r16.xzw, -r5.xxyz, r2.zzzz, cb2[17].xxyz
    dp3 r2.z, r16.xzwx, r16.xzwx
    rsq r2.z, r2.z
    mul r16.xzw, r2.zzzz, r16.xxzw
    dp3 r2.z, r16.xzwx, r12.xyzx
    dp3 r4.z, r11.xyzx, r16.xzwx
    mad r9.w, |r4.z|, r2.w, -|r4.z|
    ...
    mad r21.yzw, r2.yyyy, r13.yyzw, r20.xxyz
    add_sat r2.z, -r2.z, l(1.000000)
    mul r4.z, r2.z, r2.z
    mul r4.z, r4.z, r4.z
    mul r2.z, r2.z, r4.z
    mul r2.y, r2.z, r2.y
    mad r16.xzw, r2.yyyy, r13.yyzw, r19.xxyz
    mad r13.yzw, r6.wwww, r13.yyzw, r18.zzxy
    and r22.xyz, r3.wwww, r13.zwyz
    mov r15.w, r18.z
    mov r17.w, r22.z
    movc r17.xyzw, r7.wwww, r15.xyzw, r17.xyzw
    mov r18.zw, r16.xxxz
    mov r22.zw, r19.xxxy
    movc r15.xyzw, r7.wwww, r18.xyzw, r22.xyzw
    mov r21.x, r16.w
    mov r20.w, r19.z
    movc r20.xyzw, r7.wwww, r21.yzwx, r20.xyzw
    if_nz r3.z
      ld_structured_indexable(structured_buffer, stride=1792)(mixed,mixed,mixed,mixed) r2.y, cb2[52].x, l(112), u2.xxxx
      or r2.y, r2.y, l(8)
      store_structured u2.x, cb2[52].x, l(112), r2.y
...
imul null, r2.z, r16.y, l(15)
ubfe r4.z, l(3), l(24), cb9[r2.z + 1].w
switch r4.z
  case l(4)
  if_nz r3.z
  ...
  iadd r4.z, r2.y, l(1)
  lt r6.w, l(0.000000), cb9[r2.z + 6].y
  mov r15.xy, cb9[r2.z + 5].zwzz
  mov r15.z, cb9[r2.z + 6].x
  mad r13.yzw, -r15.xxyz, l(0.000000, 0.500000, 0.500000, 0.500000), cb9[r2.z + 0].xxyz
  add r16.xyz, -r5.xyzx, r13.yzwy
  dp3 r7.w, r15.xyzx, r16.xyzx
  div_sat r8.w, -r7.w, cb9[r2.z + 6].y
  mad r21.xyz, r8.wwww, r15.xyzx, r13.yzwy
  movc r21.xyz, r6.wwww, r21.xyzx, cb9[r2.z + 0].xyzx
  ...
  if_nz r12.w
    sqrt r12.w, r9.w
    mul r14.w, cb9[r2.z + 3].x, cb9[r2.z + 3].x
    div r9.w, r14.w, r9.w
    min r9.w, r9.w, l(1.000000)
    mad_sat r21.xy, r12.wwww, cb9[r2.z + 2].xzxx, cb9[r2.z + 2].ywyy
    ...
    if_nz r12.w
      ubfe r12.w, l(3), l(27), cb9[r2.z + 1].w
      if_nz r3.z
      ...
      if_nz r12.w
        ...
        add r21.yzw, r21.yyzw, -cb9[r2.z + 4].yyzw
        max r12.w, |r21.w|, |r21.z|
        max r12.w, r12.w, |r21.y|
        div r12.w, cb9[r2.z + 5].x, r12.w
        add r12.w, r12.w, cb9[r2.z + 5].y
        dp3 r15.w, r21.yzwy, r21.yzwy
        rsq r15.w, r15.w
        max r12.w, r12.w, l(0.00006104)
        and r16.w, l(0x0000ffff), cb9[r2.z + 1].w
        mov r23.x, -r3.x
        utof r24.w, r16.w
        mov r23.y, r13.x
        mov r23.z, r3.x
        ...
        loop 
          ...
          mul r25.yz, r22.yyzy, cb9[r2.z + 3].yyyy
          mul r25.x, r22.x, r25.y
          mul r25.w, r21.x, r25.y
          mad r24.xyz, r21.yzwy, r15.wwww, r25.xzwx
          sample_c_lz_indexable(texturecubearray)(float,float,float,float) r18.w, r24.xyzw, t10.xxxx, s13, r12.w
      ...
      lt r12.w, l(0.000000), r9.w
      if_nz r12.w
        mul r12.w, r2.w, cb9[r2.z + 1].z
        mul r12.w, r12.w, l(0.250000)
        dp3 r15.w, r15.xyzx, r14.xyzx
        dp3 r14.x, r14.xyzx, r16.xyzx
        mad r14.y, -r15.w, r15.w, cb9[r2.z + 6].y
        ...
        if_nz r8.w
          ...
          mov r16.xyz, cb9[r7.w + 6].yzwy
          mov r16.w, cb9[r7.w + 7].x
          mov r15.w, l(1.000000)
          dp4 r8.w, r16.xyzw, r15.xyzw
          mov r16.xyz, cb9[r7.w + 7].yzwy
          mov r16.w, cb9[r7.w + 8].x
          ...
          if_z r16.y
            ...
            mad r15.xy, r15.xyxx, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
            add r21.x, r15.x, cb9[r7.w + 9].w
            add r21.y, r15.y, cb9[r7.w + 10].x
            mul r15.xy, r21.xyxx, cb9[r7.w + 9].yzyy
            ...
            if_z r15.z
              ...
              mad r21.x, r15.x, cb9[r7.w + 8].y, cb9[r7.w + 8].z
              mad r21.y, r15.y, cb9[r7.w + 8].w, cb9[r7.w + 9].x
              mul r15.x, r16.x, cb9[r7.w + 10].z
              mad r8.w, cb9[r7.w + 10].y, r16.x, r8.w
              div r8.w, r8.w, r15.x
            endif 
          else 
            mov r15.z, l(-1)
          ...
          ubfe r7.w, l(4), l(20), cb9[r2.z + 1].w
          ult r8.w, l(0), r7.w
          not r15.x, r1.z
          and r8.w, r8.w, r15.x
          if_nz r8.w
        ...
        mul r7.w, r9.w, r7.w
        mov r15.x, cb9[r2.z + 0].w
        mov r15.yz, cb9[r2.z + 1].xxyx
        lt r8.w, l(0.000000), r10.w
        mad r16.xyz, r7.wwww, r15.xyzx, r17.xyzx
        ...
        mad r13.yzw, r10.wwww, r15.xxyz, r20.xxyz
        add_sat r6.w, -r6.w, l(1.000000)
        mul r11.w, r6.w, r6.w
        mul r11.w, r11.w, r11.w
        mul r6.w, r6.w, r11.w
        mul r6.w, r6.w, r10.w
        mad r14.xyz, r6.wwww, r15.xyzx, r19.xyzx
        mad r15.xyz, r7.wwww, r15.xyzx, r18.zxyz
        movc r15.xyz, r3.wwww, r15.xyzx, r18.zxyz
        movc r17.xyz, r8.wwww, r16.xyzx, r17.xyzx
        movc r18.xyz, r8.wwww, r18.xyzx, r15.yzxy
        movc r19.xyz, r8.wwww, r14.xyzx, r19.xyzx
        movc r20.xyz, r8.wwww, r13.yzwy, r20.xyzx
        if_nz r3.z
  ...
  if_nz r10.w
    ...
    if_nz r11.w
      ...
      mov r16.xyz, cb9[r2.z + 4].yzwy
      mov r16.w, cb9[r2.z + 5].x
      dp4 r16.x, r16.xyzw, r5.xyzw
      mov r21.xyz, cb9[r2.z + 5].yzwy
      mov r21.w, cb9[r2.z + 6].x
      dp4 r16.y, r21.xyzw, r5.xyzw
      div r16.xy, r16.xyxx, r10.wwww
      lt r5.w, cb9[r2.z + 10].w, l(0.00048828)
      if_nz r5.w
        mad_sat r21.xy, |r16.xyxx|, cb9[r2.z + 12].xyxx, cb9[r2.z + 12].zwzz
        mul r21.zw, r21.xxxy, r21.xxxy
        mad r21.xy, r21.xyxx, l(-2.000000, -2.000000, 0.000000, 0.000000), l(3.000000, 3.000000, 0.000000, 0.000000)
        mul r21.xy, r21.xyxx, r21.zwzz
        mul r5.w, r21.y, r21.x
      else 
        mul_sat r21.xyzw, |r16.yyxx|, cb9[r2.z + 11].xyzw
        log r21.xyzw, r21.xyzw
        mul r21.xyzw, r21.xyzw, cb9[r2.z + 12].zzzz
        exp r21.xyzw, r21.xyzw
        add r21.xy, r21.zwzz, r21.xyxx
        log r21.xy, r21.xyxx
        mul r21.xy, r21.xyxx, cb9[r2.z + 12].wwww
        exp r21.xy, r21.xyxx
        mul r10.w, r21.x, cb9[r2.z + 12].x
        mad r14.w, cb9[r2.z + 12].y, r21.y, l(-1.000000)
        mad r10.w, cb9[r2.z + 12].y, r21.y, -r10.w
      ...
      if_nz r5.w
        ...
        dp3 r10.w, cb9[r2.z + 13].xyzx, r16.xyzx
        mov r21.x, cb9[r2.z + 13].w
        mov r21.yz, cb9[r2.z + 14].xxyx
        dp3 r12.w, r21.xyzx, r16.xyzx
        frc r16.x, r10.w
        frc r16.y, r12.w
        iadd r5.w, r5.w, l(-1)
        utof r16.z, r5.w
        sample_l_indexable(texture2darray)(float,float,float,float) r13.yzw, r16.xyzx, t20.wxyz, s2, l(0.000000)
      else 
        mov r13.yzw, l(0,1.000000,1.000000,1.000000)
      endif 
    endif 
    mov r16.x, cb9[r2.z + 0].w
    mov r16.yz, cb9[r2.z + 1].xxyx
    ...
    if_nz r5.w
      ...
      if_nz r5.w
        ...
        mad r16.xyz, r11.xyzx, r5.wwww, r5.xyzx
        mov r21.xyz, cb9[r2.z + 6].yzwy
        mov r21.w, cb9[r2.z + 7].x
        mov r16.w, l(1.000000)
        dp4 r5.w, r21.xyzw, r16.xyzw
        dp4 r12.w, r15.xyzw, r16.xyzw
        ge r14.w, r12.w, r5.w
        if_nz r14.w
          mov r15.xyz, cb9[r2.z + 4].yzwy
          mov r15.w, cb9[r2.z + 5].x
          dp4 r15.x, r15.xyzw, r16.xyzw
          mov r21.xyz, cb9[r2.z + 5].yzwy
          mov r21.w, cb9[r2.z + 6].x
          dp4 r15.y, r21.xyzw, r16.xyzw
          ...
          mad r16.x, r15.x, cb9[r2.z + 8].y, cb9[r2.z + 8].z
          mad r16.y, r15.y, cb9[r2.z + 8].w, cb9[r2.z + 9].x
          div r5.w, r5.w, r12.w
          max r5.w, r5.w, l(0.00006104)
          and r12.w, l(0x0000ffff), cb9[r2.z + 1].w
          if_nz cb2[58].y
            mov r15.x, -r3.x
            utof r21.z, r12.w
            mov r15.y, r13.x
            ...
            loop 
              ...
              mad r21.xy, r22.xyxx, cb9[r2.z + 3].yyyy, r16.xyxx
            ...
            utof r16.z, r12.w
            sample_c_lz_indexable(texture2darray)(float,float,float,float) r14.w, r16.xyzx, t9.xxxx, s13, r5.w
          endif 
      ...
      if_nz r11.w
        ...
        ubfe r12.w, l(4), l(16), cb9[r2.z + 1].w
        ult r14.w, l(0), r12.w
        ...
        if_nz r14.w
          ...
          mov r16.xyz, cb9[r12.w + 6].yzwy
          mov r16.w, cb9[r12.w + 7].x
          mov r15.w, l(1.000000)
          dp4 r14.w, r16.xyzw, r15.xyzw
          mov r16.xyz, cb9[r12.w + 7].yzwy
          mov r16.w, cb9[r12.w + 8].x
          dp4 r16.x, r16.xyzw, r15.xyzw
          lt r16.y, r16.x, r14.w
          if_z r16.y
            mov r21.xyz, cb9[r12.w + 4].yzwy
            mov r21.w, cb9[r12.w + 5].x
            dp4 r21.x, r21.xyzw, r15.xyzw
            mov r22.xyz, cb9[r12.w + 5].yzwy
            mov r22.w, cb9[r12.w + 6].x
            dp4 r21.y, r22.xyzw, r15.xyzw
            div r15.xy, r21.xyxx, r16.xxxx
            mad r15.xy, r15.xyxx, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
            add r21.x, r15.x, cb9[r12.w + 9].w
            add r21.y, r15.y, cb9[r12.w + 10].x
            mul r15.xy, r21.xyxx, cb9[r12.w + 9].yzyy
            ...
            if_z r15.z
              mov_sat r15.xy, r15.xyxx
              mad r21.x, r15.x, cb9[r12.w + 8].y, cb9[r12.w + 8].z
              mad r21.y, r15.y, cb9[r12.w + 8].w, cb9[r12.w + 9].x
              mul r15.x, r16.x, cb9[r12.w + 10].z
              mad r14.w, cb9[r12.w + 10].y, r16.x, r14.w
          ...
          if_z r15.x
            ...
            if_nz cb2[58].y
              ...
              loop 
                ...
                dp2 r23.x, icb[r15.z + 0].yxyy, r16.xyxx
                dp2 r23.y, icb[r15.z + 0].yxyy, r16.yzyy
                mad r22.xy, r23.xyxx, cb9[r12.w + 3].yyyy, r21.xyxx
              ...
              utof r21.z, r15.x
              sample_c_lz_indexable(texture2darray)(float,float,float,float) r15.y, r21.xyzx, t9.xxxx, s13, r14.w
            endif 
          ...
          if_nz r1.z
            ...
            mad r2.z, |r7.w|, l(-0.200000), l(0.400000)
            lt r12.w, r7.w, l(0.000000)
            and r12.w, r3.w, r12.w
            movc r2.z, r12.w, -r2.z, r2.z
            mad r15.xyz, r11.xyzx, r2.zzzz, r5.xyzx
            mov r16.xyz, cb9[r1.z + 6].yzwy
            mov r16.w, cb9[r1.z + 7].x
            mov r15.w, l(1.000000)
            dp4 r2.z, r16.xyzw, r15.xyzw
            mov r16.xyz, cb9[r1.z + 7].yzwy
            mov r16.w, cb9[r1.z + 8].x
            dp4 r12.w, r16.xyzw, r15.xyzw
            lt r14.w, r12.w, r2.z
            if_z r14.w
              ...
              dp4 r16.y, r21.xyzw, r15.xyzw
              div r15.xy, r16.xyxx, r12.wwww
              mad r15.xy, r15.xyxx, l(0.500000, -0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
              add r16.x, r15.x, cb9[r1.z + 9].w
              add r16.y, r15.y, cb9[r1.z + 10].x
              mul r15.xy, r16.xyxx, cb9[r1.z + 9].yzyy
              ...
              if_z r15.z
                mov_sat r15.xy, r15.xyxx
                mad r16.x, r15.x, cb9[r1.z + 8].y, cb9[r1.z + 8].z
                mad r16.y, r15.y, cb9[r1.z + 8].w, cb9[r1.z + 9].x
                mul r15.x, r12.w, cb9[r1.z + 10].z
                mad r2.z, cb9[r1.z + 10].y, r12.w, r2.z
                div r2.z, r2.z, r15.x
              endif 
            else 
              mov r15.z, l(-1)
            ...
            if_z r12.w
              ...
              and r12.w, l(0x0000ffff), cb9[r1.z + 1].w
              if_nz cb2[58].y
                mov r15.x, -r3.x
                utof r21.z, r12.w
                mov r15.y, r13.x
                ...
                loop 
                  ...
                  mad r21.xy, r22.xyxx, cb9[r1.z + 3].yyyy, r16.xyxx
                  sample_c_lz_indexable(texture2darray)(float,float,float,float) r14.w, r21.xyzx, t9.xxxx, s13, r2.z
                  mad r3.x, r14.w, l(0.125000), r3.x
                  iadd r13.x, r13.x, l(1)
                endloop 
              else 
                utof r16.z, r12.w
                sample_c_lz_indexable(texture2darray)(float,float,float,float) r3.x, r16.xyzx, t9.xxxx, s13, r2.z
              endif 
              mul r1.z, r3.x, r3.x
              mul r1.z, r3.x, r1.z
            else 
        ...
        add r1.z, -r9.w, r1.z
        mad r1.z, r3.y, r1.z, r9.w
        mul r1.z, r5.w, r1.z
        lt r2.x, l(0.000000), r7.w
        mad r15.xyz, r1.zzzz, r13.yzwy, r17.xyzx
        mad r14.xyz, r14.xyzx, r6.wwww, r12.xyzx
        dp3 r2.z, r14.xyzx, r14.xyzx
        rsq r2.z, r2.z
        mul r14.xyz, r2.zzzz, r14.xyzx
        dp3 r2.z, r14.xyzx, r12.xyzx
        ...
        mad r11.xyz, r0.yyyy, r13.yzwy, r20.xyzx
        add_sat r1.w, -r2.z, l(1.000000)
        mul r2.z, r1.w, r1.w
        mul r2.z, r2.z, r2.z
        mul r1.w, r1.w, r2.z
        mul r0.y, r0.y, r1.w
        mad r12.xyz, r0.yyyy, r13.yzwy, r19.xyzx
        mad r13.xyz, r1.zzzz, r13.yzwy, r18.zxyz
        movc r13.xyz, r3.wwww, r13.xyzx, r18.zxyz
        movc r17.xyz, r2.xxxx, r15.xyzx, r17.xyzx
        movc r18.xyz, r2.xxxx, r18.xyzx, r13.yzxy
        movc r19.xyz, r2.xxxx, r12.xyzx, r19.xyzx
        movc r20.xyz, r2.xxxx, r11.xyzx, r20.xyzx
        if_nz r3.z
...
ieq r0.y, r1.w, r1.z
movc r2.xzw, r0.yyyy, r4.xxyz, r4.xxzy
mad r0.y, -r2.w, l(0.500000), r2.x
add r4.y, r0.y, r2.w
mad r4.z, -r2.z, l(0.500000), r0.y
add r4.x, r2.z, r4.z
mul r2.xzw, r6.xxyz, r17.xxyz
mad r2.xzw, r18.zzxy, r4.xxyz, r2.xxzw
mul r7.xyz, r19.xyzx, l(0.960000, 0.960000, 0.960000, 0.000000)
mad r7.xyz, r20.xyzx, l(0.040000, 0.040000, 0.040000, 0.000000), r7.xyzx
add r2.xzw, r2.xxzw, r7.xxyz
add r7.xyz, -r4.xyzx, l(1.000000, 1.000000, 1.000000, 0.000000)
mul r7.xyz, r7.xyzx, r19.xyzx
mad r4.xyz, r20.xyzx, r4.xyzx, r7.xyzx
mad r4.xyz, r17.xyzx, r6.xyzx, r4.xyzx
movc r2.xzw, r3.wwww, r2.xxzw, r4.xxyz
...
if_nz r0.y
  ...
  mad r3.xyw, r2.xzxw, r4.xyxz, r3.xyxw
else 
  ...
  mad r3.xyw, r0.yyyy, r4.xyxz, r2.xzxw
endif 
mul r2.xzw, r3.xxyw, cb1[85].yyyy
ge r3.xyw, r2.xzxw, l(0.00006104, 0.00006104, 0.000000, 0.00006104)
and r2.xzw, r2.xxzw, r3.xxyw
...
mad r3.xyw, r4.xyxz, cb1[85].xxxx, -r2.xzxw
mad r3.xyw, r3.xyxw, l(0.500000, 0.500000, 0.000000, 0.500000), r2.xzxw
movc r2.xzw, r0.yyyy, r3.xxyw, r2.xxzw
if_nz cb2[52].y
  if_nz cb2[53].y
    switch cb2[53].y
      case l(1)
    ...
    mad r3.xyw, r0.yyyy, l(0.500000, 0.500000, 0.000000, 0.500000), -r2.xzxw
    mad r2.xzw, cb2[53].wwww, r3.xxyw, r2.xxzw
  endif 
endif 
...
ret 
// Approximately 2550 instruction slots used
