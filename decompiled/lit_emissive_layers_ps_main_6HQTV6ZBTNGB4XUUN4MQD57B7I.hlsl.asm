...
and r10.xy, r7.wwww, l(0x10000000, 0x20000000, 0, 0)
if_nz r10.x
            ...
            if_nz r12.w
              ...
              if_nz r22.x
                ...
                if_nz r16.w
                  ...
                  ieq r16.w, r22.x, l(6)
                  movc r9.w, r16.w, l(0), l(1.000000)
                endif 
              else 
                mov r9.w, l(1.000000)
              endif 
              ...
              if_nz r22.y
                ...
                mul r19.w, r9.w, l(-17.000000)
                exp r19.w, r19.w
                add r17.w, r17.w, r19.w
                log r17.w, r17.w
                mul r17.w, r17.w, l(-0.05882353)
                max r9.w, r17.w, l(0.000000)
              ...
              mad r14.xyz, r21.xyzx, r12.wwww, r22.xyzx
              mov r20.z, r18.y
              mul r21.xyz, r13.zzzz, r20.xyzx
              mad r20.xyz, r29.xyzx, r12.wwww, r21.xyzx
              mul r13.w, r13.z, r18.w
              mad r18.z, r18.z, r13.z, r12.w
              mad r18.w, r9.w, r12.w, r13.w
              mov r18.y, r20.z
            endif 
          endif 
        endif 
...
if_nz r10.y
  ...
  loop 
    ...
    ushr r13.z, r8.w, l(5)
    iadd r14.xyz, r12.xyzx, r13.xyzx
    ld_indexable(texture2darray)(uint,uint,uint,uint) r9.w, r14.xyzw, t35.yzwx
    ieq r10.y, r4.w, r8.w
    bfi r12.w, r5.w, l(0), l(0), r9.w
    movc r9.w, r10.y, r12.w, r9.w
    ieq r10.y, r6.w, r8.w
    ubfe r12.w, r7.w, l(0), r9.w
    movc r9.w, r10.y, r12.w, r9.w
    iadd r10.y, r1.w, r8.w
    ...
    loop 
      ...
      if_nz r16.w
        ...
        if_nz r15.w
          ...
          rsq r15.w, r15.w
          mul r28.xyz, r15.wwww, r27.xyzx
          dp3 r15.w, r28.xyzx, r3.xyzx
          ...
          if_nz r15.w
            ...
            if_nz r15.w
              ...
              if_nz r32.x
                ubfe r15.w, l(4), l(24), r25.w
                ishl r15.w, l(1), r15.w
                ushr r16.w, r25.w, l(28)
                ishl r16.w, l(1), r16.w
                ieq r17.w, r32.x, l(4)
                if_nz r17.w
                  and r17.w, r25.w, l(4095)
                  ubfe r18.w, l(12), l(12), r25.w
                  and r19.w, r26.w, l(1023)
                ...
                mul r15.w, r24.w, r33.w
              else 
                mov r24.xyz, l(0,0,0,0)
                mov r15.w, l(0)
              endif 
              ne r16.w, r25.x, l(1.000000)
              add r17.w, r24.w, r15.w
              mad_sat r17.w, r17.w, r25.x, -r25.x
              movc r15.w, r16.w, r17.w, r15.w
              if_nz r32.y
                ubfe r16.w, l(4), l(24), r26.y
                ishl r16.w, l(1), r16.w
                ushr r17.w, r26.y, l(28)
                ishl r17.w, l(1), r17.w
                ieq r18.w, r32.y, l(2)
                if_nz r18.w
                  ...
                  sample_d_indexable(texture2darray)(float,float,float,float) r18.w, r34.xyzx, t45.yzwx, s4, r32.xzwx, r33.xyzx
                else 
                  ieq r19.w, r32.y, l(4)
                  if_nz r19.w
                    ...
                    sample_d_indexable(texture2darray)(float,float,float,float) r18.w, r33.xyzx, t42.yzwx, s4, r34.xyzx, r32.xyzx
                  else 
                    and r19.w, r26.y, l(4095)
                    ubfe r25.xw, l(12, 0, 0, 10), l(12, 0, 0, 20), r26.yyyw
                    utof r32.xz, r16.wwww
                    ...
                    mul r32.xyz, r32.xyzx, r35.xyzx
                    sample_d_indexable(texture2darray)(float,float,float,float) r18.w, r33.xyzx, t43.yzwx, s4, r34.xyzx, r32.xyzx
                  endif 
                endif 
                mad r32.xyz, r18.wwww, l(0.960000, 0.960000, 0.960000, 0.000000), l(0.040000, 0.040000, 0.040000, 0.000000)
              ...
              if_nz r25.x
                ...
                if_nz r16.w
                  ...
                  ishl r16.w, l(1), r25.z
                  ushr r17.w, r26.z, l(28)
                  ishl r17.w, l(1), r17.w
                  and r18.w, r26.z, l(4095)
                  ...
                  mul r33.xyz, r33.xyzx, r36.xyzx
                  sample_d_indexable(texture2darray)(float,float,float,float) r15.z, r34.xyzx, t45.yzxw, s4, r35.xyzx, r33.xyzx
                else 
                  ieq r16.w, r25.x, l(6)
                  movc r15.z, r16.w, l(0), l(1.000000)
                endif 
              else 
                mov r15.z, l(1.000000)
              endif 
              mul_sat r15.z, r15.z, l(0.76470590)
              if_nz r25.y
                ieq r16.w, r25.y, l(3)
                if_nz r16.w
                  ubfe r25.xyz, l(4, 12, 10, 0), l(24, 12, 10, 0), r26.xxwx
                  ishl r16.w, l(1), r25.x
                  ushr r17.w, r26.x, l(28)
                  ishl r17.w, l(1), r17.w
                  and r18.w, r26.x, l(4095)
                ...
                dp2 r16.w, r21.zwzz, r21.zwzz
                add r16.w, -r16.w, l(1.000000)
                max r16.w, r16.w, l(0.000000)
                sqrt r16.w, r16.w
                mul r17.w, r25.z, r25.z
                mul r17.w, r17.w, l(0.33333334)
                min r17.w, r17.w, l(1.000000)
                dp3 r18.w, r30.xyzx, r30.xyzx
                rsq r18.w, r18.w
                mul r25.xyz, r18.wwww, r30.xyzx
                dp3 r18.w, -r29.xyzx, -r29.xyzx
                rsq r18.w, r18.w
                mul r26.xyz, r18.wwww, -r29.xyzx
                mul r27.xyz, r2.wwww, r28.xyzx
                mul r25.xyz, r2.wwww, r25.xyzx
                mul r26.xyz, r2.wwww, r26.xyzx
                mul r18.w, r15.z, l(-17.000000)
                exp r18.w, r18.w
                add r17.w, r17.w, r18.w
                log r17.w, r17.w
                mul r17.w, r17.w, l(-0.05882353)
                max r15.z, r17.w, l(0.000000)
                mul r26.xyz, r21.wwww, r26.xyzx
                mad r25.xyz, r25.xyzx, r21.zzzz, r26.xyzx
                mad r25.xyz, r27.xyzx, r16.wwww, r25.xyzx
                dp3 r16.w, r25.xyzx, r25.xyzx
                rsq r16.w, r16.w
                mul r25.xyz, r16.wwww, r25.xyzx
                add r16.w, -r15.w, l(1.000000)
                mul r26.xyz, r16.wwww, r22.xyzx
                mad r22.xyz, r25.xyzx, r15.wwww, r26.xyzx
              endif 
              add r16.w, -r15.w, l(1.000000)
              mul r25.xyz, r14.xyzx, r16.wwww
              mad r14.xyz, r24.xyzx, r15.wwww, r25.xyzx
              mul r24.xyz, r16.wwww, r23.xyzx
              mad r23.xyz, r32.xyzx, r15.wwww, r24.xyzx
              mul r17.w, r13.w, r16.w
              mad r13.z, r13.z, r16.w, r15.w
              mad r13.w, r15.z, r15.w, r17.w
            endif 
          endif 
        endif 
      endif 
...
mad r0.xyz, r0.xyzx, r1.wwww, r10.xzwx
mad r0.w, r0.w, r1.w, r15.x
mad r6.xyz, r6.xyzx, r1.wwww, r16.xyzx
dp3 r2.w, r6.xyzx, r6.xyzx
rsq r2.w, r2.w
mul r6.xyz, r2.wwww, r6.xyzx
mad r8.y, r1.x, r1.w, r15.y
...
lt r2.w, l(0.500000), cb0[19].x
if_nz r2.w
  mul r2.w, cb0[11].w, cb0[11].z
  mul r3.w, r2.w, cb0[12].x
  ...
  mul r2.w, r2.w, r3.w
  round_ne r2.w, r2.w
  div r3.w, r2.w, cb0[11].w
  mul r4.w, r2.w, cb0[11].w
  ge r4.w, r4.w, -r4.w
...
mul r9.xyz, r9.xyzx, cb0[18].xyzx
mul r2.w, r1.x, r9.w
mul r9.xyz, r2.wwww, r9.xyzx
add r2.w, v2.y, v2.x
add r2.w, r2.w, v2.z
add r3.w, r2.w, cb0[16].y
frc r3.w, r3.w
mad r10.y, cb1[69].w, cb0[16].z, r3.w
mov r10.x, cb0[16].x
sample_l_indexable(texture2d)(float,float,float,float) r3.w, r10.xyxx, t24.yzwx, s5, l(0.000000)
log r3.w, |r3.w|
...
ret 
// Approximately 3076 instruction slots used
