...
r0.y = samp0[]..swiz;
  ...
  while (true) {
    ...
    if (r14.w != 0) break;
    r14.w = r13.w ? r0.y : r13.z;
    r15.y = cmp((uint)r14.w >= (uint)r12.w);
    ...
    if (r15.y != 0) {
      ...
      r26.w = (int)r25.w + 1;
      r15.yzw = -refProbeConstantsCB[r14.w].data[0].xyz + r5.xyz;
  ...
  while (true) {
    ...
    if (r14.w != 0) break;
    r14.w = r13.w ? r0.y : r13.z;
    r16.w = cmp((uint)r14.w < (uint)r12.w);
    if (r16.w != 0) {
      r14.w = (int)r14.w * 14;
      if (r2.w != 0) {
        r16.w = (int)r16.z & 15;
  ...
  r0.y = cmp(r25.z >= 1);
  bitmask.w = ((~(-1 << 8)) << 0) & 0xffffffff;  r6.w = (((uint)r16.z << 0) & bitmask.w) | ((uint)r25.w & ~bitmask.w);
  r0.y = r0.y ? r6.w : r16.z;
  r6.w = max(1, r16.y);
  r6.w = rcp(r6.w);
  r16.y = saturate(r16.y);
  r18.xyz = r15.yzw * r6.www;
  r19.xyz = r26.xyz * r6.www;
  r9.w = cmp(r16.y < 0.99000001);
  if (r9.w != 0) {
    r0.y = (int)r0.y + 256;
    r9.w = 1 + -r16.y;
    ...
    r18.xyz = r15.yzw * r6.www + r16.yzw;
    r17.w = 0;
    ...
    r19.xyz = r15.yzw * r6.www + r19.xyz;
  }
  r6.w = r2.x + r4.z;
  r6.w = log2(abs(r6.w));
  r6.w = r6.w * r2.z;
  ...
  if (r8.w != 0) {
    ...
    if (r8.w != 0) {
      ...
      r3.z = r7.w * r3.z;
      r3.z = 0.25 * r3.z;
      r22.yzw = r3.zzz * r15.yzw + r19.xyz;
      ...
      r15.yzw = r3.www * r15.yzw + r21.zxy;
      r24.xyz = r0.www ? r15.zwy : 0;
      r18.w = r21.z;
      r20.w = r24.z;
      r20.xyzw = r3.yyyy ? r18.xyzw : r20.xyzw;
      r21.zw = r23.xy;
      r24.zw = r16.yz;
      r18.xyzw = r3.yyyy ? r21.xyzw : r24.xyzw;
      r22.x = r23.z;
      r19.w = r16.w;
      r19.xyzw = r3.yyyy ? r22.yzwx : r19.xyzw;
      if (r2.w != 0) {
      // Known bad code for instruction (needs manual fix):
