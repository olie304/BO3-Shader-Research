...
if_nz r1.x
  ftoi r1.x, cb1[64].w
  lod r1.y, v2.xyxx, t21.y, s1
  lod r1.z, v2.xyxx, t21.x, s1
  lt r1.y, r1.y, r1.z
...
sample_indexable(texture2d)(float,float,float,float) r2.w, v2.xyxx, t26.yzwx, s6
add r3.x, -cb0[11].x, cb0[11].y
mad r0.w, r0.w, r3.x, cb0[11].x
...
mad r2.x, cb1[62].x, r3.x, cb0[11].x
...
add r2.x, -r0.w, r2.x
mad r2.y, cb1[62].w, r2.x, r0.w
add r0.w, -r2.w, cb1[63].x
mad r0.w, cb1[63].w, r0.w, r2.w
movc r4.xyz, v7.xxxx, v3.xyzx, -v3.xyzx
dp3 r2.z, r4.xyzx, r4.xyzx
rsq r2.z, r2.z
mad r4.xyz, r4.xyzx, r2.zzzz, -r3.yzwy
mad r3.xyz, cb1[60].wwww, r4.xyzx, r3.yzwy
sample_indexable(texture2d)(float,float,float,float) r2.z, v2.xyxx, t29.yzxw, s1
mul r4.xyz, r0.xyzx, cb0[17].xyzx
...
if_nz cb0[17].w
  ...
  rcp r4.w, r4.w
  eq r5.x, cb0[18].x, l(0.000000)
  div r5.y, l(1.000000, 1.000000, 1.000000, 1.000000), cb0[18].x
