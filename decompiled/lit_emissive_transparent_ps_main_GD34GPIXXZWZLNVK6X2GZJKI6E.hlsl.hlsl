...
SamplerState ySampler_s : register(s5);
SamplerState cbcrSampler_s : register(s6);
...
Texture2D<float4> yTexture : register(t22);
StructuredBuffer<gSunShadowTree> gSunShadowTree : register(t23);
Texture2D<float4> cbcrTexture : register(t24);
...
r4.w = samp0[]..swiz;
  ...
  r1.z = rsqrt(r1.z);
  r8.xyz = -v6.xyz * r1.zzz;
  r1.w = dot(r8.xyz, r3.xyz);
  r3.x = dot(r8.xyz, r4.xyz);
  ...
  r3.z = yTexture.Sample(ySampler_s, r3.xy).x;
  r4.x = -0.0625 + r3.z;
  r3.xy = cbcrTexture.Sample(cbcrSampler_s, r3.xy).xy;
  r4.yz = float2(-0.5,-0.5) + r3.xy;
  r3.x = dot(float2(1.16439998,1.79270005), r4.xz);
  r3.y = dot(float3(1.16439998,-0.213300005,-0.532899976), r4.xyz);
  r3.z = dot(float2(1.16439998,2.11240005), r4.xy);
  ...
  r4.xy = (uint2)r2.wz;
  r2.y = dot(r4.yx, float2(0.0671105608,0.00583714992));
  r2.y = frac(r2.y);
  r2.xy = float2(0.0078125,52.9829178) * r2.xy;
  r2.y = frac(r2.y);
  r2.y = r2.y * 6.28318548 + gameTick.w;
  sincos(r2.y, r5.x, r9.x);
  r2.y = dot(r4.xy, float2(0.0671105608,0.00583714992));
  r2.y = frac(r2.y);
  r2.y = 52.9829178 * r2.y;
  r2.y = frac(r2.y);
  r2.y = r2.y * 6.28318548 + gameTick.w;
  sincos(r2.y, r4.x, r10.x);
  r1.x = saturate(dot(r6.xyz, r8.xyz));
  r2.y = dot(-r8.xyz, r6.xyz);
  r2.y = r2.y + r2.y;
  r11.xyz = r6.xyz * -r2.yyy + -r8.xyz;
  r2.y = 17 * r1.y;
  r2.y = exp2(r2.y);
  r2.y = 2 + r2.y;
  r2.y = 2 / r2.y;
  ...
  r5.z = 100 * r5.z;
  r10.yz = -r4.zz * float2(10,5) + float2(6.85740995,7.08500004);
  r5.w = exp2(r10.y);
  r5.w = r5.w * r1.x;
  r5.w = 9.1368103 * r5.w;
  r7.w = r4.w * r4.z;
  ...
  if (r2.z != 0) {
    ...
    r11.w = 0;
    r14.xyz = gReflectionProbeArray.SampleLevel(samplerLinear_s, r11.xyzw, r4.w).xyz;
    r2.x = sunConstants.globalProbeExposure * r2.z + -r2.w;
    r2.x = r1.y * r2.x + r2.w;
    r10.yzw = r14.xyz * r2.xxx + r10.yzw;
  }
  ...
  r1.y = r4.w * r1.y;
  r4.z = r4.z * r4.w;
  r4.w = dot(r6.xyz, sunConstants.wldDir.xyz);
  r5.z = saturate(r4.w);
  r5.w = cmp(0 >= r5.z);
  if (r5.w != 0) {
    r6.w = 0;
