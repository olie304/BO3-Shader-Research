...
rcp r3.y, r3.y
add r3.z, cb0[14].y, -cb1[24].z
mul r3.z, r3.z, cb0[14].z
mul r4.x, v5.z, cb0[14].z
lt r4.y, r3.z, r4.x
mul r3.z, r3.z, r3.y
div r3.z, r3.z, r4.x
ne r4.x, v6.y, l(1.000000)
div r5.xyz, r2.xyzx, r3.wwww
add r3.w, r2.w, v1.w
mad_sat r6.y, r3.w, v6.y, -v6.y
mul r6.xzw, r5.xxyz, r6.yyyy
movc r2.xyzw, r4.xxxx, r6.xzwy, r2.xyzw
mov r6.x, l(1.000000)
movc r4.xz, r4.xxxx, r6.xxyx, v1.wwww
lt r3.w, r3.y, r1.w
add r1.w, r1.w, -r3.y
...
mul r2.xyzw, r4.xxxx, r2.xyzw
mul r2.xyzw, r1.zzzz, r2.xyzw
and r2.xyz, r2.xyzx, r4.yyyy
mov r3.x, r2.w
and r1.zw, r3.xxxy, r4.yyyy
...
mul r1.xyw, r1.zzzz, v3.xyxz
mul r3.xyz, r1.zzzz, v11.xyzx
mad r0.xyz, r2.xyzx, r0.xyzx, -r1.xywx
mad r0.xyz, v3.wwww, r0.xyzx, r1.xywx
...
and r1.x, r1.z, l(0x7f800000)
ieq r1.x, r1.x, l(0x7f800000)
mov r2.w, r1.z
eq r3.xyzw, r2.xyzw, l(0.000000, 0.000000, 0.000000, 0.000000)
and r1.yw, r3.zzzw, r3.xxxy
and r1.y, r1.w, r1.y
or r1.x, r1.y, r1.x
if_z r1.x
  ftou r3.xy, v0.xyxx
  bfi r1.x, l(1), l(16), cb0[12].y, l(0)
  iadd r1.x, r1.x, l(1)
  imm_atomic_iadd r4.x, u6, r3.xyxx, r1.x
  and r3.zw, r4.xxxx, l(0, 0, 0x0000ffff, 0x0000ffff)
  ult r1.x, r3.w, cb2[58].z
  if_nz r1.x
    max r1.x, r2.z, r2.y
    max r1.x, r1.x, r2.x
    and r1.x, r1.x, l(0x7f800000)
    iadd r1.x, r1.x, l(0x00800000)
    add r2.xyz, r1.xxxx, r2.xyzx
    ubfe r1.y, l(8), l(15), r2.x
    ushr r2.xy, r2.yzyy, l(15, 15, 0, 0)
    bfi r2.xy, l(8, 8, 0, 0), l(8, 16, 0, 0), r2.xyxx, l(0, 0, 0, 0)
    iadd r1.y, r1.y, r2.x
    iadd r1.y, r2.y, r1.y
    ishl r1.x, r1.x, l(1)
    iadd r4.xzw, r1.xxxx, r1.yyyy
    mov_sat r1.z, r1.z
    mul r1.x, r1.z, l(2046.000000)
    ftou r1.x, r1.x
    ishl r1.y, v0.z, l(2)
    and r1.x, r1.x, l(2046)
    bfi r1.x, l(11), l(0), r1.x, r1.y
    bfi r4.y, l(1), l(0), cb0[12].y, r1.x
